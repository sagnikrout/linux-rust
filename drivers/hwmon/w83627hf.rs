...
//! Source: drivers/hwmon/w83627hf.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w83627hf_sio_data {
    pub type: enum chips,
    pub sioaddr: c_int,
}

    let mut force_i2c: static u8 = 0x1f;
    module_param(force_i2c, byte, 0);
    MODULE_PARM_DESC(force_i2c,
    "Initialize the i2c address of the sensors");
    let mut init: static bool = 1;
...
pub const W83627HF_LD_FDC: c_uint = 0x00;
pub const W83627HF_LD_PRT: c_uint = 0x01;
pub const W83627HF_LD_UART1: c_uint = 0x02;
pub const W83627HF_LD_UART2: c_uint = 0x03;
pub const W83627HF_LD_KBC: c_uint = 0x05;
pub const W83627HF_LD_CIR: c_uint = 0x06 /* w83627hf only */;
pub const W83627HF_LD_GAME: c_uint = 0x07;
pub const W83627HF_LD_MIDI: c_uint = 0x07;
pub const W83627HF_LD_GPIO1: c_uint = 0x07;
pub const W83627HF_LD_GPIO5: c_uint = 0x07 /* w83627thf only */;
pub const W83627HF_LD_GPIO2: c_uint = 0x08;
pub const W83627HF_LD_GPIO3: c_uint = 0x09;
pub const W83627HF_LD_GPIO4: c_uint = 0x09 /* w83627thf only */;
pub const W83627HF_LD_ACPI: c_uint = 0x0a;
pub const W83627HF_LD_HWM: c_uint = 0x0b;
pub const DEVID: c_uint = 0x20 /* Register: Device ID */;
pub const W83627THF_GPIO5_EN: c_uint = 0x30 /* w83627thf only */;
pub const W83627THF_GPIO5_IOSR: c_uint = 0xf3 /* w83627thf only */;
pub const W83627THF_GPIO5_DR: c_uint = 0xf4 /* w83627thf only */;
pub const W83687THF_VID_EN: c_uint = 0x29 /* w83687thf only */;
pub const W83687THF_VID_CFG: c_uint = 0xF0 /* w83687thf only */;
pub const W83687THF_VID_DATA: c_uint = 0xF1 /* w83687thf only */;
    static inline void
...
pub const W627_DEVID: c_uint = 0x52;
pub const W627THF_DEVID: c_uint = 0x82;
pub const W697_DEVID: c_uint = 0x60;
pub const W637_DEVID: c_uint = 0x70;
pub const W687THF_DEVID: c_uint = 0x85;
pub const WINB_ACT_REG: c_uint = 0x30;
pub const WINB_BASE_REG: c_uint = 0x60;
// Constants specified below
// Alignment of the base address

// Offset & size of I/O region we are interested in
pub const WINB_REGION_OFFSET: c_int = 5;
pub const WINB_REGION_SIZE: c_int = 2;
// Where are the sensors address/data registers relative to the region offset
pub const W83781D_ADDR_REG_OFFSET: c_int = 0;
pub const W83781D_DATA_REG_OFFSET: c_int = 1;
...
pub const W83627HF_REG_TEMP2_CONFIG: c_uint = 0x152;
pub const W83627HF_REG_TEMP3_CONFIG: c_uint = 0x252;
...
pub const W83781D_REG_BANK: c_uint = 0x4E;
pub const W83781D_REG_CONFIG: c_uint = 0x40;
pub const W83781D_REG_ALARM1: c_uint = 0x459;
pub const W83781D_REG_ALARM2: c_uint = 0x45A;
pub const W83781D_REG_ALARM3: c_uint = 0x45B;
pub const W83781D_REG_BEEP_CONFIG: c_uint = 0x4D;
pub const W83781D_REG_BEEP_INTS1: c_uint = 0x56;
pub const W83781D_REG_BEEP_INTS2: c_uint = 0x57;
pub const W83781D_REG_BEEP_INTS3: c_uint = 0x453;
pub const W83781D_REG_VID_FANDIV: c_uint = 0x47;
pub const W83781D_REG_CHIPID: c_uint = 0x49;
pub const W83781D_REG_WCHIPID: c_uint = 0x58;
pub const W83781D_REG_CHIPMAN: c_uint = 0x4F;
pub const W83781D_REG_PIN: c_uint = 0x4B;
pub const W83781D_REG_VBAT: c_uint = 0x5D;
pub const W83627HF_REG_PWM1: c_uint = 0x5A;
pub const W83627HF_REG_PWM2: c_uint = 0x5B;
...
pub const W83627THF_REG_PWM1: c_uint = 0x01	/* 697HF/637HF/687THF too */;
pub const W83627THF_REG_PWM2: c_uint = 0x03	/* 697HF/637HF/687THF too */;
pub const W83627THF_REG_PWM3: c_uint = 0x11	/* 637HF/687THF too */;
pub const W83627THF_REG_VRM_OVT_CFG: c_uint = 0x18	/* 637HF/687THF too */;
    static const u8 regpwm_627hf[] = { W83627HF_REG_PWM1, W83627HF_REG_PWM2 };
    static const u8 regpwm[] = { W83627THF_REG_PWM1, W83627THF_REG_PWM2,
    W83627THF_REG_PWM3 };

    regpwm_627hf[nr] : regpwm[nr])
pub const W83627HF_REG_PWM_FREQ: c_uint = 0x5C	/* Only for the 627HF */;
pub const W83637HF_REG_PWM_FREQ1: c_uint = 0x00	/* 697HF/687THF too */;
pub const W83637HF_REG_PWM_FREQ2: c_uint = 0x02	/* 697HF/687THF too */;
pub const W83637HF_REG_PWM_FREQ3: c_uint = 0x10	/* 687THF too */;
    static const u8 W83637HF_REG_PWM_FREQ[] = { W83637HF_REG_PWM_FREQ1,
    W83637HF_REG_PWM_FREQ2,
    W83637HF_REG_PWM_FREQ3 };
pub const W83627HF_BASE_PWM_FREQ: c_int = 46870;
pub const W83781D_REG_I2C_ADDR: c_uint = 0x48;
pub const W83781D_REG_I2C_SUBADDR: c_uint = 0x4A;
// Sensor selection
pub const W83781D_REG_SCFG1: c_uint = 0x5D;
    static const u8 BIT_SCFG1[] = { 0x02, 0x04, 0x08 };
pub const W83781D_REG_SCFG2: c_uint = 0x59;
    static const u8 BIT_SCFG2[] = { 0x10, 0x20, 0x40 };
pub const W83781D_DEFAULT_BETA: c_int = 3435;
//
...
unsafe extern "C" fn TEMP_TO_REG(temp: c_long) -> u8 {
    ...
    {
    let mut ntemp: c_int = clamp_val(temp, TEMP_MIN, TEMP_MAX);
...
#[no_mangle]
pub unsafe extern "C" fn pwm_freq_from_reg_627hf(reg: u8) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn pwm_freq_to_reg_627hf(val: c_ulong) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn pwm_freq_from_reg(reg: u8) -> c_ulong {
    static inline unsigned long pwm_freq_from_reg(u8 reg)
    {
// Clock bit 8 -> 180 kHz or 24 MHz
    let mut clock: c_ulong = (reg & 0x80) ? 180000UL : 24000000UL;
    reg &= 0x7f;
...
#[no_mangle]
pub unsafe extern "C" fn pwm_freq_to_reg(val: c_ulong) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn DIV_TO_REG(val: c_long) -> u8 {
...
pub struct w83627hf_data {
    ...
    pub /: *mut *mut u8 in[9]; / Register value,
    pub /: *mut *mut u8 in_max[9]; / Register value,
    pub /: *mut *mut u8 in_min[9]; / Register value,
    pub /: *mut *mut u8 fan[3]; / Register value,
    pub /: *mut *mut u8 fan_min[3]; / Register value,
    pub /: *mut *mut u16 temp[3]; / Register value,
    pub /: *mut *mut u16 temp_max[3]; / Register value,
    pub /: *mut *mut u16 temp_max_hyst[3]; / Register value,
    ...
    pub /: *mut *mut u32 beep_mask; / Register encoding, combined,
    pub /: *mut *mut u8 pwm[3]; / Register value,
    pub manual: *mut *mut u8 pwm_enable[3]; / 1 =,
// 2 = thermal cruise (also called SmartFan I)
// 3 = fan speed cruise
//
    pub /: *mut *mut u8 pwm_freq[3]; / Register value,
    pub diode: *mut *mut u16 sens[3]; / 1 = pentium diode; 2 = 3904,
// 4 = thermistor
//
    pub vrm: u8,
    pub /: *mut *mut u8 vrm_ovt; / Register value, 627THF/637HF/687THF only,
...
#[no_mangle]
pub unsafe extern "C" fn w83627hf_set_bank(data: *mut w83627hf_data, reg: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn w83627hf_reset_bank(data: *mut w83627hf_data, reg: u16) {
...
#[no_mangle]
unsafe extern "C" fn w83627hf_read_value(data: *mut w83627hf_data, reg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83627hf_write_value(data: *mut w83627hf_data, reg: u16, value: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83627hf_update_fan_div(data: *mut w83627hf_data) {
    ...
    let mut num_pwms: c_int = (data.type == w83697hf) ? 2 : 3;
...
#[no_mangle]
unsafe extern "C" fn w83627hf_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83627hf_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83627thf_read_gpio5(pdev: *mut platform_device) -> c_int {
    static int w83627thf_read_gpio5(struct platform_device *pdev)
    {
    struct w83627hf_sio_data *sio_data = dev_get_platdata(&pdev.dev);
    let mut res: c_int = 0xff, sel;
...
#[no_mangle]
unsafe extern "C" fn w83687thf_read_vid(pdev: *mut platform_device) -> c_int {
    static int w83687thf_read_vid(struct platform_device *pdev)
    {
    struct w83627hf_sio_data *sio_data = dev_get_platdata(&pdev.dev);
    let mut res: c_int = 0xff;
    if (superio_enter(sio_data)) {
//
// Some other driver reserved the address space for itself.
// We don't want to fail driver instantiation because of that,
...
#[no_mangle]
unsafe extern "C" fn w83627hf_init_device(pdev: *mut platform_device) {
    static void w83627hf_init_device(struct platform_device *pdev)
    {
    struct w83627hf_data *data = platform_get_drvdata(pdev);
    int i;
    let mut type: enum chips = data.type;
    u8 tmp;
...
// Read VID only once
    ...
    let mut lo: c_int = w83627hf_read_value(data, W83781D_REG_VID_FANDIV);
    let mut hi: c_int = w83627hf_read_value(data, W83781D_REG_CHIPID);
...
#[no_mangle]
unsafe extern "C" fn show_in_0(data: *mut w83627hf_data, buf: *mut c_char, reg: u8) -> isize {
...
// Restore fan_min
    ...
    let mut nr: c_int = to_sensor_dev_attr(devattr).index;
    struct w83627hf_data *data = w83627hf_update_device(dev);
    let mut tmp: u16 = data.temp[nr];
#[no_mangle]
pub unsafe extern "C" fn sprintf(_arg: buf, _arg: "%ld\n", LM75_TEMP_FROM_REG(tmp: (nr) ? (long)) -> return {
    ...
    let mut nr: c_int = to_sensor_dev_attr(devattr).index;
    struct w83627hf_data *data = w83627hf_update_device(dev);
    let mut tmp: u16 = data.temp_max[nr];
#[no_mangle]
pub unsafe extern "C" fn sprintf(_arg: buf, _arg: "%ld\n", LM75_TEMP_FROM_REG(tmp: (nr) ? (long)) -> return {
    return sprintf(buf, "%ld\n", (nr) ? (long) LM75_TEMP_FROM_REG(tmp)
    : (long) TEMP_FROM_REG(tmp));
    ...
    let mut nr: c_int = to_sensor_dev_attr(devattr).index;
    struct w83627hf_data *data = w83627hf_update_device(dev);
    let mut tmp: u16 = data.temp_max_hyst[nr];
#[no_mangle]
pub unsafe extern "C" fn sprintf(_arg: buf, _arg: "%ld\n", LM75_TEMP_FROM_REG(tmp: (nr) ? (long)) -> return {
    return sprintf(buf, "%ld\n", (nr) ? (long) LM75_TEMP_FROM_REG(tmp)
    : (long) TEMP_FROM_REG(tmp));
...
#[no_mangle]
unsafe extern "C" fn w83627hf_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83627hf_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sensors_w83627hf_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sensors_w83627hf_exit() -> void __exit {
