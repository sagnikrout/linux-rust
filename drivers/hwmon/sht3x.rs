...
pub const SHT3X_SINGLE_WAIT_TIME_HPM: c_int = 15000;
pub const SHT3X_SINGLE_WAIT_TIME_MPM: c_int = 6000;
pub const SHT3X_SINGLE_WAIT_TIME_LPM: c_int = 4000;
pub const SHT3X_WORD_LEN: c_int = 2;
pub const SHT3X_CMD_LENGTH: c_int = 2;
pub const SHT3X_CRC8_LEN: c_int = 1;
pub const SHT3X_RESPONSE_LENGTH: c_int = 6;
pub const SHT3X_CRC8_POLYNOMIAL: c_uint = 0x31;
pub const SHT3X_CRC8_INIT: c_uint = 0xFF;

pub const SHT3X_MAX_TEMPERATURE: c_int = 130000;
pub const SHT3X_MIN_HUMIDITY: c_int = 0;
pub const SHT3X_MAX_HUMIDITY: c_int = 100000;
    enum sht3x_chips {
    sht3x = 1,
    sts3x,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sht3x_limit_commands {
    pub read_command: [c_char; SHT3X_CMD_LENGTH],
    pub write_command: [c_char; SHT3X_CMD_LENGTH],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sht3x_data {
    pub client: *mut i2c_client,
    pub chip_id: enum sht3x_chips,
    pub /: *mut *mut mutex i2c_lock; / lock for sending i2c commands,
    pub /: *mut *mut mutex data_lock; / lock for updating driver data,
    pub mode: u8,
    pub command: *const c_uchar,
    pub us*/: *mut *mut u32 wait_time; / in,
    pub mode*/: *mut *mut unsigned long last_update; / last update in periodic,
    pub repeatability: enum sht3x_repeatability,
...
//
    ...
    pub temperature_limits: [c_int; SHT3X_NUM_LIMIT_CMD],
    pub humidity: u32,
    pub humidity_limits: [u32; SHT3X_NUM_LIMIT_CMD],
}

#[no_mangle]
unsafe extern "C" fn get_mode_from_update_interval(value: u16) -> u8 {
    static u8 get_mode_from_update_interval(u16 value)
    {
    size_t index;
    let mut number_of_modes: u8 = ARRAY_SIZE(mode_to_update_interval);
    if (value == 0)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn sht3x_extract_temperature(raw: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sht3x_extract_humidity(raw: u16) -> u32 {
...
//
    ...
    let mut interval_ms: u16 = mode_to_update_interval[data.mode];
    let mut interval_jiffies: c_ulong = msecs_to_jiffies(interval_ms);
...
#[no_mangle]
unsafe extern "C" fn temp1_input_read(dev: *mut device, temp: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn humidity1_input_read(dev: *mut device, humidity: *mut c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn limits_update(data: *mut sht3x_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn temp1_limit_read(dev: *mut device, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn humidity1_limit_read(dev: *mut device, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn temp1_limit_write(dev: *mut device, index: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn humidity1_limit_write(dev: *mut device, index: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sht3x_select_command(data: *mut sht3x_data) {
...
#[no_mangle]
unsafe extern "C" fn temp1_alarm_read(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn humidity1_alarm_read(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_interval_read(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_interval_write(dev: *mut device, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(medium_repeatability: data->repeatability ==) -> else {
    else if (data.repeatability == medium_repeatability)
...
#[no_mangle]
unsafe extern "C" fn sht3x_serial_number_read(data: *mut sht3x_data) {
...
#[no_mangle]
unsafe extern "C" fn sht3x_probe(client: *mut i2c_client) -> c_int {
