...
//! Source: drivers/hwmon/aquacomputer_d5next.c
#![no_std]
...
pub const USB_VENDOR_ID_AQUACOMPUTER: c_uint = 0x0c70;
pub const USB_PRODUCT_ID_AQUAERO: c_uint = 0xf001;
pub const USB_PRODUCT_ID_FARBWERK: c_uint = 0xf00a;
pub const USB_PRODUCT_ID_QUADRO: c_uint = 0xf00d;
pub const USB_PRODUCT_ID_D5NEXT: c_uint = 0xf00e;
pub const USB_PRODUCT_ID_FARBWERK360: c_uint = 0xf010;
pub const USB_PRODUCT_ID_OCTO: c_uint = 0xf011;
pub const USB_PRODUCT_ID_HIGHFLOWNEXT: c_uint = 0xf012;
pub const USB_PRODUCT_ID_LEAKSHIELD: c_uint = 0xf014;
pub const USB_PRODUCT_ID_AQUASTREAMXT: c_uint = 0xf0b6;
pub const USB_PRODUCT_ID_AQUASTREAMULT: c_uint = 0xf00b;
pub const USB_PRODUCT_ID_POWERADJUST3: c_uint = 0xf0bd;
pub const USB_PRODUCT_ID_HIGHFLOW: c_uint = 0xf003;
    enum kinds {
...
pub const STATUS_REPORT_ID: c_uint = 0x01;

pub const SERIAL_PART_OFFSET: c_int = 2;
pub const CTRL_REPORT_ID: c_uint = 0x03;
pub const AQUAERO_CTRL_REPORT_ID: c_uint = 0x0b;

// The HID report that the official software always sends
// after writing values, currently same for all devices
//
pub const SECONDARY_CTRL_REPORT_ID: c_uint = 0x02;
pub const SECONDARY_CTRL_REPORT_SIZE: c_uint = 0x0B;
    static u8 secondary_ctrl_report[] = {
    0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x34, 0xC6
    };
// Secondary HID report values for Aquaero
pub const AQUAERO_SECONDARY_CTRL_REPORT_ID: c_uint = 0x06;
pub const AQUAERO_SECONDARY_CTRL_REPORT_SIZE: c_uint = 0x07;
    static u8 aquaero_secondary_ctrl_report[] = {
    0x06, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00
    };
// Report IDs for legacy devices
pub const AQUASTREAMXT_STATUS_REPORT_ID: c_uint = 0x04;
pub const POWERADJUST3_STATUS_REPORT_ID: c_uint = 0x03;
pub const HIGHFLOW_STATUS_REPORT_ID: c_uint = 0x02;
// Data types for reading and writing control reports
pub const AQC_8: c_int = 0;
pub const AQC_BE16: c_int = 1;
// Info, sensor sizes and offsets for most Aquacomputer devices
pub const AQC_SERIAL_START: c_uint = 0x3;
pub const AQC_FIRMWARE_VERSION: c_uint = 0xD;
pub const AQC_SENSOR_SIZE: c_uint = 0x02;
pub const AQC_SENSOR_NA: c_uint = 0x7FFF;
pub const AQC_FAN_PERCENT_OFFSET: c_uint = 0x00;
pub const AQC_FAN_VOLTAGE_OFFSET: c_uint = 0x02;
pub const AQC_FAN_CURRENT_OFFSET: c_uint = 0x04;
pub const AQC_FAN_POWER_OFFSET: c_uint = 0x06;
pub const AQC_FAN_SPEED_OFFSET: c_uint = 0x08;
// Specs of the Aquaero fan controllers
pub const AQUAERO_SERIAL_START: c_uint = 0x07;
pub const AQUAERO_FIRMWARE_VERSION: c_uint = 0x0B;
pub const AQUAERO_NUM_FANS: c_int = 4;
pub const AQUAERO_NUM_SENSORS: c_int = 8;
pub const AQUAERO_NUM_VIRTUAL_SENSORS: c_int = 8;
pub const AQUAERO_NUM_CALC_VIRTUAL_SENSORS: c_int = 4;
pub const AQUAERO_NUM_FLOW_SENSORS: c_int = 2;
pub const AQUAERO_CTRL_REPORT_SIZE: c_uint = 0xa93;
pub const AQUAERO_CTRL_PRESET_ID: c_uint = 0x5c;
pub const AQUAERO_CTRL_PRESET_SIZE: c_uint = 0x02;
pub const AQUAERO_CTRL_PRESET_START: c_uint = 0x55c;
// Sensor report offsets for Aquaero fan controllers
pub const AQUAERO_SENSOR_START: c_uint = 0x65;
pub const AQUAERO_VIRTUAL_SENSOR_START: c_uint = 0x85;
pub const AQUAERO_CALC_VIRTUAL_SENSOR_START: c_uint = 0x95;
pub const AQUAERO_FLOW_SENSORS_START: c_uint = 0xF9;
pub const AQUAERO_FAN_VOLTAGE_OFFSET: c_uint = 0x04;
pub const AQUAERO_FAN_CURRENT_OFFSET: c_uint = 0x06;
pub const AQUAERO_FAN_POWER_OFFSET: c_uint = 0x08;
pub const AQUAERO_FAN_SPEED_OFFSET: c_uint = 0x00;
    static u16 aquaero_sensor_fan_offsets[] = { 0x167, 0x173, 0x17f, 0x18B };
// Control report offsets for the Aquaero fan controllers
pub const AQUAERO_TEMP_CTRL_OFFSET: c_uint = 0xdb;
pub const AQUAERO_FAN_CTRL_MIN_PWR_OFFSET: c_uint = 0x04;
pub const AQUAERO_FAN_CTRL_MAX_PWR_OFFSET: c_uint = 0x06;
pub const AQUAERO_FAN_CTRL_SRC_OFFSET: c_uint = 0x10;
    static u16 aquaero_ctrl_fan_offsets[] = { 0x20c, 0x220, 0x234, 0x248 };
// Specs of the D5 Next pump
pub const D5NEXT_NUM_FANS: c_int = 2;
pub const D5NEXT_NUM_SENSORS: c_int = 1;
pub const D5NEXT_NUM_VIRTUAL_SENSORS: c_int = 8;
pub const D5NEXT_CTRL_REPORT_SIZE: c_uint = 0x329;
// Sensor report offsets for the D5 Next pump
pub const D5NEXT_POWER_CYCLES: c_uint = 0x18;
pub const D5NEXT_COOLANT_TEMP: c_uint = 0x57;
pub const D5NEXT_PUMP_OFFSET: c_uint = 0x6c;
pub const D5NEXT_FAN_OFFSET: c_uint = 0x5f;
pub const D5NEXT_5V_VOLTAGE: c_uint = 0x39;
pub const D5NEXT_12V_VOLTAGE: c_uint = 0x37;
pub const D5NEXT_VIRTUAL_SENSORS_START: c_uint = 0x3f;
    static u16 d5next_sensor_fan_offsets[] = { D5NEXT_PUMP_OFFSET, D5NEXT_FAN_OFFSET };
// Control report offsets for the D5 Next pump
pub const D5NEXT_TEMP_CTRL_OFFSET: c_uint = 0x2D	/* Temperature sensor offsets location */;
...
pub const AQUASTREAMULT_NUM_FANS: c_int = 1;
pub const AQUASTREAMULT_NUM_SENSORS: c_int = 2;
// Sensor report offsets for the Aquastream Ultimate pump
pub const AQUASTREAMULT_SENSOR_START: c_uint = 0x2D;
pub const AQUASTREAMULT_PUMP_OFFSET: c_uint = 0x51;
pub const AQUASTREAMULT_PUMP_VOLTAGE: c_uint = 0x3D;
pub const AQUASTREAMULT_PUMP_CURRENT: c_uint = 0x53;
pub const AQUASTREAMULT_PUMP_POWER: c_uint = 0x55;
pub const AQUASTREAMULT_FAN_OFFSET: c_uint = 0x41;
pub const AQUASTREAMULT_PRESSURE_OFFSET: c_uint = 0x57;
pub const AQUASTREAMULT_FLOW_SENSOR_OFFSET: c_uint = 0x37;
pub const AQUASTREAMULT_FAN_VOLTAGE_OFFSET: c_uint = 0x02;
pub const AQUASTREAMULT_FAN_CURRENT_OFFSET: c_uint = 0x00;
pub const AQUASTREAMULT_FAN_POWER_OFFSET: c_uint = 0x04;
pub const AQUASTREAMULT_FAN_SPEED_OFFSET: c_uint = 0x06;
...
pub const FARBWERK_NUM_SENSORS: c_int = 4;
pub const FARBWERK_SENSOR_START: c_uint = 0x2f;
// Specs of the Farbwerk 360 RGB controller
pub const FARBWERK360_NUM_SENSORS: c_int = 4;
pub const FARBWERK360_NUM_VIRTUAL_SENSORS: c_int = 16;
pub const FARBWERK360_CTRL_REPORT_SIZE: c_uint = 0x682;
// Sensor report offsets for the Farbwerk 360
pub const FARBWERK360_SENSOR_START: c_uint = 0x32;
pub const FARBWERK360_VIRTUAL_SENSORS_START: c_uint = 0x3a;
// Control report offsets for the Farbwerk 360
pub const FARBWERK360_TEMP_CTRL_OFFSET: c_uint = 0x8;
// Specs of the Octo fan controller
pub const OCTO_NUM_FANS: c_int = 8;
pub const OCTO_NUM_SENSORS: c_int = 4;
pub const OCTO_NUM_VIRTUAL_SENSORS: c_int = 16;
pub const OCTO_NUM_FLOW_SENSORS: c_int = 1;
pub const OCTO_CTRL_REPORT_SIZE: c_uint = 0x65F;
// Sensor report offsets for the Octo
pub const OCTO_POWER_CYCLES: c_uint = 0x18;
pub const OCTO_SENSOR_START: c_uint = 0x3D;
pub const OCTO_VIRTUAL_SENSORS_START: c_uint = 0x45;
pub const OCTO_FLOW_SENSOR_OFFSET: c_uint = 0x7B;
    static u16 octo_sensor_fan_offsets[] = { 0x7D, 0x8A, 0x97, 0xA4, 0xB1, 0xBE, 0xCB, 0xD8 };
// Control report offsets for the Octo
pub const OCTO_TEMP_CTRL_OFFSET: c_uint = 0xA;
pub const OCTO_FLOW_PULSES_CTRL_OFFSET: c_uint = 0x6;
// Fan speed offsets (0-100%)
    static u16 octo_ctrl_fan_offsets[] = { 0x5B, 0xB0, 0x105, 0x15A, 0x1AF, 0x204, 0x259, 0x2AE };
// Specs of Quadro fan controller
pub const QUADRO_NUM_FANS: c_int = 4;
pub const QUADRO_NUM_SENSORS: c_int = 4;
pub const QUADRO_NUM_VIRTUAL_SENSORS: c_int = 16;
pub const QUADRO_NUM_FLOW_SENSORS: c_int = 1;
pub const QUADRO_CTRL_REPORT_SIZE: c_uint = 0x3c1;
// Sensor report offsets for the Quadro
pub const QUADRO_POWER_CYCLES: c_uint = 0x18;
pub const QUADRO_SENSOR_START: c_uint = 0x34;
pub const QUADRO_VIRTUAL_SENSORS_START: c_uint = 0x3c;
pub const QUADRO_FLOW_SENSOR_OFFSET: c_uint = 0x6e;
    static u16 quadro_sensor_fan_offsets[] = { 0x70, 0x7D, 0x8A, 0x97 };
// Control report offsets for the Quadro
pub const QUADRO_TEMP_CTRL_OFFSET: c_uint = 0xA;
pub const QUADRO_FLOW_PULSES_CTRL_OFFSET: c_uint = 0x6;
    static u16 quadro_ctrl_fan_offsets[] = { 0x37, 0x8c, 0xe1, 0x136 }; /* Fan speed offsets (0-100%) */
// Specs of High Flow Next flow sensor
pub const HIGHFLOWNEXT_NUM_SENSORS: c_int = 2;
pub const HIGHFLOWNEXT_NUM_FLOW_SENSORS: c_int = 1;
// Sensor report offsets for the High Flow Next
pub const HIGHFLOWNEXT_SENSOR_START: c_int = 85;
pub const HIGHFLOWNEXT_FLOW: c_int = 81;
pub const HIGHFLOWNEXT_WATER_QUALITY: c_int = 89;
pub const HIGHFLOWNEXT_POWER: c_int = 91;
pub const HIGHFLOWNEXT_CONDUCTIVITY: c_int = 95;
pub const HIGHFLOWNEXT_5V_VOLTAGE: c_int = 97;
pub const HIGHFLOWNEXT_5V_VOLTAGE_USB: c_int = 99;
// Specs of the Leakshield
pub const LEAKSHIELD_NUM_SENSORS: c_int = 2;
// Sensor report offsets for Leakshield
pub const LEAKSHIELD_PRESSURE_ADJUSTED: c_int = 285;
pub const LEAKSHIELD_TEMPERATURE_1: c_int = 265;
pub const LEAKSHIELD_TEMPERATURE_2: c_int = 287;
pub const LEAKSHIELD_PRESSURE_MIN: c_int = 291;
pub const LEAKSHIELD_PRESSURE_TARGET: c_int = 293;
pub const LEAKSHIELD_PRESSURE_MAX: c_int = 295;
pub const LEAKSHIELD_PUMP_RPM_IN: c_int = 101;
pub const LEAKSHIELD_FLOW_IN: c_int = 111;
pub const LEAKSHIELD_RESERVOIR_VOLUME: c_int = 313;
pub const LEAKSHIELD_RESERVOIR_FILLED: c_int = 311;
// Specs of the Aquastream XT pump
pub const AQUASTREAMXT_SERIAL_START: c_uint = 0x3a;
pub const AQUASTREAMXT_FIRMWARE_VERSION: c_uint = 0x32;
pub const AQUASTREAMXT_NUM_FANS: c_int = 2;
pub const AQUASTREAMXT_NUM_SENSORS: c_int = 3;
pub const AQUASTREAMXT_FAN_STOPPED: c_uint = 0x4;
pub const AQUASTREAMXT_PUMP_CONVERSION_CONST: c_int = 45000000;
pub const AQUASTREAMXT_FAN_CONVERSION_CONST: c_int = 5646000;
pub const AQUASTREAMXT_SENSOR_REPORT_SIZE: c_uint = 0x42;
// Sensor report offsets and info for Aquastream XT
pub const AQUASTREAMXT_SENSOR_START: c_uint = 0xd;
pub const AQUASTREAMXT_FAN_VOLTAGE_OFFSET: c_uint = 0x7;
pub const AQUASTREAMXT_FAN_STATUS_OFFSET: c_uint = 0x1d;
pub const AQUASTREAMXT_PUMP_VOLTAGE_OFFSET: c_uint = 0x9;
pub const AQUASTREAMXT_PUMP_CURR_OFFSET: c_uint = 0xb;
    static u16 aquastreamxt_sensor_fan_offsets[] = { 0x13, 0x1b };
// Specs of the Poweradjust 3
pub const POWERADJUST3_NUM_SENSORS: c_int = 1;
pub const POWERADJUST3_SENSOR_REPORT_SIZE: c_uint = 0x32;
// Sensor report offsets for the Poweradjust 3
pub const POWERADJUST3_SENSOR_START: c_uint = 0x03;
// Specs of the High Flow USB
pub const HIGHFLOW_NUM_SENSORS: c_int = 2;
pub const HIGHFLOW_NUM_FLOW_SENSORS: c_int = 1;
pub const HIGHFLOW_SENSOR_REPORT_SIZE: c_uint = 0x76;
// Sensor report offsets for the High Flow USB
pub const HIGHFLOW_FIRMWARE_VERSION: c_uint = 0x3;
pub const HIGHFLOW_SERIAL_START: c_uint = 0x9;
pub const HIGHFLOW_FLOW_SENSOR_OFFSET: c_uint = 0x23;
pub const HIGHFLOW_SENSOR_START: c_uint = 0x2b;
// Labels for D5 Next
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aqc_fan_structure_offsets {
    pub voltage: u8,
    pub curr: u8,
    pub power: u8,
    pub speed: u8,
...
pub struct aqc_data {
    ...
    pub /: *mut *mut int status_report_id; / Used for legacy devices, report is stored in buffer,
    pub ctrl_report_id: c_int,
    pub secondary_ctrl_report_id: c_int,
    pub secondary_ctrl_report_size: c_int,
    pub secondary_ctrl_report: *mut u8,
    pub last_ctrl_report_op: ktime_t,
    pub /: *mut *mut int ctrl_report_delay; / Delay between two ctrl report operations, in ms,
    pub buffer_size: c_int,
    pub buffer: *mut u8,
    pub checksum_start: c_int,
    pub checksum_length: c_int,
    pub checksum_offset: c_int,
    pub num_fans: c_int,
    pub fan_sensor_offsets: *mut u16,
    pub fan_ctrl_offsets: *mut u16,
    pub num_temp_sensors: c_int,
    pub temp_sensor_start_offset: c_int,
    pub num_virtual_temp_sensors: c_int,
    pub virtual_temp_sensor_start_offset: c_int,
    pub num_calc_virt_temp_sensors: c_int,
    pub calc_virt_temp_sensor_start_offset: c_int,
    pub temp_ctrl_offset: u16,
    pub power_cycle_count_offset: u16,
    pub num_flow_sensors: c_int,
    pub flow_sensors_start_offset: u8,
    pub flow_pulses_ctrl_offset: u8,
    pub fan_structure: *mut aqc_fan_structure_offsets,
// General info, same across all devices
    pub serial_number_start_offset: u8,
    pub serial_number: [u32; 2],
    pub firmware_version_offset: u8,
    pub firmware_version: u16,
// How many times the device was powered on, if available
    pub power_cycles: u32,
// Sensor values
    pub /: *mut *mut s32 temp_input[20]; / Max 4 physical and 16 virtual or 8 physical and 12 virtual,
    pub speed_input: [i32; 9],
    pub speed_input_min: [u32; 1],
    pub speed_input_target: [u32; 1],
    pub speed_input_max: [u32; 1],
    pub power_input: [u32; 8],
    pub voltage_input: [u16; 8],
    pub current_input: [u16; 8],
// Label values
    pub temp_label: *const *const c_char,
    pub virtual_temp_label: *const *const c_char,
    pub /: *const *const *const *const char calc_virt_temp_label; / For Aquaero,
    pub speed_label: *const *const c_char,
    pub power_label: *const *const c_char,
    pub voltage_label: *const *const c_char,
    pub current_label: *const *const c_char,
    pub updated: c_ulong,
}

// Converts from centi-percent
#[no_mangle]
unsafe extern "C" fn aqc_percent_to_pwm(val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_pwm_to_percent(val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_aquastreamxt_convert_pump_rpm(val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_aquastreamxt_convert_fan_rpm(val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_delay_ctrl_report(priv: *mut aqc_data) {
...
//
    ...
    let mut delta: i64 = ktime_ms_delta(ktime_get(), priv.last_ctrl_report_op);
    if (delta < priv.ctrl_report_delay)
    msleep(priv.ctrl_report_delay - delta);
    }
    }
#[no_mangle]
unsafe extern "C" fn aqc_get_ctrl_data(priv: *mut aqc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_send_ctrl_data(priv: *mut aqc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_get_ctrl_val(priv: *mut aqc_data, offset: c_int, val: *mut c_long, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_set_ctrl_vals(priv: *mut aqc_data, offsets: *mut c_int, vals: *mut c_long, types: *mut c_int, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_set_ctrl_val(priv: *mut aqc_data, offset: c_int, val: c_long, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_is_visible(data: *const c_void, type: enum hwmon_sensor_types, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn aqc_legacy_read(priv: *mut aqc_data) -> c_int {
...
// Number of sensors that are not calculated
    let mut num_non_calc_sensors: c_int = priv.num_temp_sensors + priv.num_virtual_temp_sensors;
    switch (type) {
    case hwmon_temp:
    if (channel < priv.num_temp_sensors) {
...
#[no_mangle]
unsafe extern "C" fn aqc_raw_event(hdev: *mut hid_device, report: *mut hid_report, data: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_number_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_cycles_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aqc_debugfs_init(priv: *mut aqc_data) {
...
#[no_mangle]
unsafe extern "C" fn aqc_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
//
    ...
    &aqc_chip_info, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn aqc_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn aqc_init() -> int __init {
    static int __init aqc_init(void)
    {
    return hid_register_driver(&aqc_driver);
    }
#[no_mangle]
unsafe extern "C" fn aqc_exit() -> void __exit {
