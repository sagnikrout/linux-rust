...
//! Source: drivers/hwmon/max1619.c
#![no_std]
...
pub const MAX1619_REG_LOCAL_TEMP: c_uint = 0x00;
pub const MAX1619_REG_REMOTE_TEMP: c_uint = 0x01;
pub const MAX1619_REG_STATUS: c_uint = 0x02;
pub const MAX1619_REG_CONFIG: c_uint = 0x03;
pub const MAX1619_REG_CONVRATE: c_uint = 0x04;
pub const MAX1619_REG_REMOTE_HIGH: c_uint = 0x07;
pub const MAX1619_REG_REMOTE_LOW: c_uint = 0x08;
pub const MAX1619_REG_REMOTE_CRIT: c_uint = 0x10;
pub const MAX1619_REG_REMOTE_CRIT_HYST: c_uint = 0x11;
pub const MAX1619_REG_MAN_ID: c_uint = 0xFE;
pub const MAX1619_REG_CHIP_ID: c_uint = 0xFF;
#[no_mangle]
unsafe extern "C" fn get_alarms(regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1619_temp_read(regmap: *mut regmap, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
    static int max1619_temp_read(struct regmap *regmap, u32 attr, int channel, long *val)
    {
    let mut reg: c_int = -1, alarm_bit = 0;
    u32 temp;
    int ret;
    switch (attr) {
...
#[no_mangle]
unsafe extern "C" fn max1619_chip_read(regmap: *mut regmap, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1619_chip_write(regmap: *mut regmap, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1619_init_chip(regmap: *mut regmap) -> c_int {
...
// regmap
#[no_mangle]
unsafe extern "C" fn max1619_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1619_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
    static int max1619_reg_write(void *context, unsigned int reg, unsigned int val)
    {
    let mut offset: c_int = reg < MAX1619_REG_REMOTE_CRIT ? 6 : 2;
    return i2c_smbus_write_byte_data(context, reg + offset, val);
    }
#[no_mangle]
unsafe extern "C" fn max1619_regmap_is_volatile(dev: *mut device, reg: c_uint) -> bool {
    static bool max1619_regmap_is_volatile(struct device *dev, unsigned int reg)
    {
    return reg <= MAX1619_REG_STATUS;
    }
#[no_mangle]
unsafe extern "C" fn max1619_regmap_is_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max1619_probe(client: *mut i2c_client) -> c_int {
    ...
    regmap, &max1619_chip_info, core::ptr::null_mut());
