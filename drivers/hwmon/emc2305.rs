...
//! Source: drivers/hwmon/emc2305.c
#![no_std]
...
pub const EMC2305_REG_DRIVE_FAIL_STATUS: c_uint = 0x27;
pub const EMC2305_REG_VENDOR: c_uint = 0xfe;
pub const EMC2305_FAN_MAX: c_uint = 0xff;
pub const EMC2305_FAN_MIN: c_uint = 0x00;
pub const EMC2305_FAN_MAX_STATE: c_int = 10;
pub const EMC2305_DEVICE: c_uint = 0x34;
pub const EMC2305_VENDOR: c_uint = 0x5d;
pub const EMC2305_REG_PRODUCT_ID: c_uint = 0xfd;
pub const EMC2305_TACH_REGS_UNUSE_BITS: c_int = 3;
pub const EMC2305_TACH_CNT_MULTIPLIER: c_uint = 0x02;
pub const EMC2305_TACH_RANGE_MIN: c_int = 480;
pub const EMC2305_DEFAULT_OUTPUT: c_uint = 0x0;
pub const EMC2305_DEFAULT_POLARITY: c_uint = 0x0;
pub const EMC2305_REG_POLARITY: c_uint = 0x2a;
pub const EMC2305_REG_DRIVE_PWM_OUT: c_uint = 0x2b;
pub const EMC2305_OPEN_DRAIN: c_uint = 0x0;
pub const EMC2305_PUSH_PULL: c_uint = 0x1;
...
// equal (poles * 2 + 1).
//
pub const EMC2305_RPM_FACTOR: c_int = 3932160;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct emc2305_cdev_data {
    pub cdev: *mut thermal_cooling_device,
    pub cur_state: c_uint,
    pub last_hwmon_state: c_ulong,
    pub last_thermal_state: c_ulong,
}
...
pub struct emc2305_data {
    ...
    pub pwm_shutdown: [i16; EMC2305_PWM_MAX],
    pub pwm_min: [u8; EMC2305_PWM_MAX],
    pub pwm_freq: [u16; EMC2305_PWM_MAX],
    pub cdev_data: [emc2305_cdev_data; EMC2305_PWM_MAX],
}
...
#[no_mangle]
unsafe extern "C" fn emc2305_get_max_channel(data: *const emc2305_data) -> c_int {
    static int emc2305_get_max_channel(const struct emc2305_data *data)
    {
    return data.pwm_num;
    }
#[no_mangle]
unsafe extern "C" fn emc2305_get_cdev_idx(cdev: *mut thermal_cooling_device) -> c_int {
    static int emc2305_get_cdev_idx(struct thermal_cooling_device *cdev)
    {
    struct emc2305_data *data = cdev.devdata;
    let mut len: usize = strlen(cdev.type);
    int ret;
    if (len <= 0)
    return -EINVAL;
//
...
#[no_mangle]
unsafe extern "C" fn emc2305_get_cur_state(cdev: *mut thermal_cooling_device, state: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_get_max_state(cdev: *mut thermal_cooling_device, state: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __emc2305_set_cur_state(data: *mut emc2305_data, cdev_idx: c_int, state: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_set_cur_state(cdev: *mut thermal_cooling_device, state: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_show_fault(dev: *mut device, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_show_fan(dev: *mut device, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_show_pwm(dev: *mut device, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_set_pwm(dev: *mut device, val: c_long, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_set_single_tz(dev: *mut device, fan_node: *mut device_node, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_set_tz(dev: *mut device) -> c_int {
    ...
    {
    let mut max_channel: c_int = emc2305_get_max_channel(data);
...
#[no_mangle]
unsafe extern "C" fn emc2305_identify(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_probe_childs_from_dt(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc2305_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    &emc2305_chip_info, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn emc2305_shutdown(client: *mut i2c_client) {
