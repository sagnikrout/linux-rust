...
//! Source: drivers/hwmon/adt7470.c
#![no_std]
...
// ADT7470 registers
pub const ADT7470_REG_BASE_ADDR: c_uint = 0x20;
pub const ADT7470_REG_TEMP_BASE_ADDR: c_uint = 0x20;
pub const ADT7470_REG_TEMP_MAX_ADDR: c_uint = 0x29;
pub const ADT7470_REG_FAN_BASE_ADDR: c_uint = 0x2A;
pub const ADT7470_REG_FAN_MAX_ADDR: c_uint = 0x31;
pub const ADT7470_REG_PWM_BASE_ADDR: c_uint = 0x32;
pub const ADT7470_REG_PWM_MAX_ADDR: c_uint = 0x35;
pub const ADT7470_REG_PWM_MAX_BASE_ADDR: c_uint = 0x38;
pub const ADT7470_REG_PWM_MAX_MAX_ADDR: c_uint = 0x3B;
pub const ADT7470_REG_CFG: c_uint = 0x40;
pub const ADT7470_STRT_MASK: c_uint = 0x01;
pub const ADT7470_TEST_MASK: c_uint = 0x02;
pub const ADT7470_FSPD_MASK: c_uint = 0x04;
pub const ADT7470_T05_STB_MASK: c_uint = 0x80;
pub const ADT7470_REG_ALARM1: c_uint = 0x41;
pub const ADT7470_R1T_ALARM: c_uint = 0x01;
pub const ADT7470_R2T_ALARM: c_uint = 0x02;
pub const ADT7470_R3T_ALARM: c_uint = 0x04;
pub const ADT7470_R4T_ALARM: c_uint = 0x08;
pub const ADT7470_R5T_ALARM: c_uint = 0x10;
pub const ADT7470_R6T_ALARM: c_uint = 0x20;
pub const ADT7470_R7T_ALARM: c_uint = 0x40;
pub const ADT7470_OOL_ALARM: c_uint = 0x80;
pub const ADT7470_REG_ALARM2: c_uint = 0x42;
pub const ADT7470_R8T_ALARM: c_uint = 0x01;
pub const ADT7470_R9T_ALARM: c_uint = 0x02;
pub const ADT7470_R10T_ALARM: c_uint = 0x04;
pub const ADT7470_FAN1_ALARM: c_uint = 0x10;
pub const ADT7470_FAN2_ALARM: c_uint = 0x20;
pub const ADT7470_FAN3_ALARM: c_uint = 0x40;
pub const ADT7470_FAN4_ALARM: c_uint = 0x80;
pub const ADT7470_REG_TEMP_LIMITS_BASE_ADDR: c_uint = 0x44;
pub const ADT7470_REG_TEMP_LIMITS_MAX_ADDR: c_uint = 0x57;
pub const ADT7470_REG_FAN_MIN_BASE_ADDR: c_uint = 0x58;
pub const ADT7470_REG_FAN_MIN_MAX_ADDR: c_uint = 0x5F;
pub const ADT7470_REG_FAN_MAX_BASE_ADDR: c_uint = 0x60;
pub const ADT7470_REG_FAN_MAX_MAX_ADDR: c_uint = 0x67;
pub const ADT7470_REG_PWM_CFG_BASE_ADDR: c_uint = 0x68;
pub const ADT7470_REG_PWM12_CFG: c_uint = 0x68;
pub const ADT7470_PWM2_AUTO_MASK: c_uint = 0x40;
pub const ADT7470_PWM1_AUTO_MASK: c_uint = 0x80;
pub const ADT7470_PWM_AUTO_MASK: c_uint = 0xC0;
pub const ADT7470_REG_PWM34_CFG: c_uint = 0x69;
pub const ADT7470_PWM4_AUTO_MASK: c_uint = 0x40;
pub const ADT7470_PWM3_AUTO_MASK: c_uint = 0x80;
pub const ADT7470_REG_PWM_MIN_BASE_ADDR: c_uint = 0x6A;
pub const ADT7470_REG_PWM_MIN_MAX_ADDR: c_uint = 0x6D;
pub const ADT7470_REG_PWM_TEMP_MIN_BASE_ADDR: c_uint = 0x6E;
pub const ADT7470_REG_PWM_TEMP_MIN_MAX_ADDR: c_uint = 0x71;
pub const ADT7470_REG_CFG_2: c_uint = 0x74;
pub const ADT7470_REG_ACOUSTICS12: c_uint = 0x75;
pub const ADT7470_REG_ACOUSTICS34: c_uint = 0x76;
pub const ADT7470_REG_DEVICE: c_uint = 0x3D;
pub const ADT7470_REG_VENDOR: c_uint = 0x3E;
pub const ADT7470_REG_REVISION: c_uint = 0x3F;
pub const ADT7470_REG_ALARM1_MASK: c_uint = 0x72;
pub const ADT7470_REG_ALARM2_MASK: c_uint = 0x73;
pub const ADT7470_REG_PWM_AUTO_TEMP_BASE_ADDR: c_uint = 0x7C;
pub const ADT7470_REG_PWM_AUTO_TEMP_MAX_ADDR: c_uint = 0x7D;
pub const ADT7470_REG_MAX_ADDR: c_uint = 0x81;
pub const ADT7470_TEMP_COUNT: c_int = 10;

    ((x) * 2) + 1)
pub const ADT7470_FAN_COUNT: c_int = 4;

pub const ADT7470_PWM_COUNT: c_int = 4;
pub const ADT7470_PWM_MAX: c_int = 255;
...
pub const ADT7470_VENDOR: c_uint = 0x41;
pub const ADT7470_DEVICE: c_uint = 0x70;
// datasheet only mentions a revision 2
pub const ADT7470_REVISION: c_uint = 0x02;
// "all temps" according to hwmon sysfs interface spec
pub const ADT7470_PWM_ALL_TEMPS: c_uint = 0x3FF;
// How often do we reread sensors values? (In jiffies)

// How often do we reread sensor limit values? (In jiffies)

// Wait at least 200ms per sensor for 10 sensors
pub const TEMP_COLLECTION_TIME: c_int = 2000;
// auto update thing won't fire more than every 2s
pub const AUTO_UPDATE_INTERVAL: c_int = 2000;
...
pub const ADT7470_CFG_LF: c_uint = 0x40;
pub const ADT7470_FREQ_MASK: c_uint = 0x70;
pub const ADT7470_FREQ_SHIFT: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adt7470_data {
    ...
    pub use_pwm_framework: bool,
    pub /: *mut *mut int num_temp_sensors; / -1 = probe,
    pub temperatures_probed: c_int,
    pub temp: [i8; ADT7470_TEMP_COUNT],
    pub temp_min: [i8; ADT7470_TEMP_COUNT],
    pub temp_max: [i8; ADT7470_TEMP_COUNT],
    pub fan: [u16; ADT7470_FAN_COUNT],
    pub fan_min: [u16; ADT7470_FAN_COUNT],
    pub fan_max: [u16; ADT7470_FAN_COUNT],
    pub alarm: u16,
    pub alarms_mask: u16,
    pub force_pwm_max: u8,
    pub pwm: [u8; ADT7470_PWM_COUNT],
    pub pwm_max: [u8; ADT7470_PWM_COUNT],
    pub pwm_automatic: [u8; ADT7470_PWM_COUNT],
    pub pwm_min: [u8; ADT7470_PWM_COUNT],
    pub pwm_tmin: [i8; ADT7470_PWM_COUNT],
    pub pwm_auto_temp: [u8; ADT7470_PWM_COUNT],
    pub pwm_freq: u32,
    pub auto_update: *mut task_struct,
    pub auto_update_interval: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn adt7470_read_temperatures(data: *mut adt7470_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_update_thread(p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_update_sensors(data: *mut adt7470_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_update_limits(data: *mut adt7470_data) -> c_int {
    ...
    let mut need_sensors: c_int = 1;
    let mut need_limits: c_int = 1;
    int err;
//
...
#[no_mangle]
unsafe extern "C" fn adt7470_temp_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_temp_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_fan_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_fan_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm1_freq_get(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_pwm_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm1_freq_set(dev: *mut device, freq: c_long) -> c_int {
    static int pwm1_freq_set(struct device *dev, long freq)
    {
    struct adt7470_data *data = dev_get_drvdata(dev);
    let mut low_freq: c_uint = ADT7470_CFG_LF;
    u32 closest_freq;
    int index;
    int err;
...
#[no_mangle]
unsafe extern "C" fn adt7470_pwm_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
unsafe extern "C" fn cvt_auto_temp(input: c_int) -> c_int {
    ...
    struct sensor_device_attribute *attr = to_sensor_dev_attr(devattr);
    struct adt7470_data *data = dev_get_drvdata(dev);
    let mut pwm_auto_reg: c_int = ADT7470_REG_PWM_AUTO_TEMP(attr.index);
...
#[no_mangle]
unsafe extern "C" fn adt7470_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7470_remove(client: *mut i2c_client) {
