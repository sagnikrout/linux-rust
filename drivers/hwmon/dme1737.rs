...
//! Source: drivers/hwmon/dme1737.c
#![no_std]
...
//
pub const DME1737_REG_ALARM1: c_uint = 0x41;
pub const DME1737_REG_ALARM2: c_uint = 0x42;
pub const DME1737_REG_ALARM3: c_uint = 0x83;
    static const u8 DME1737_BIT_ALARM_IN[] = {0, 1, 2, 3, 8, 16, 17, 18};
    static const u8 DME1737_BIT_ALARM_TEMP[] = {4, 5, 6};
    static const u8 DME1737_BIT_ALARM_FAN[] = {10, 11, 12, 13, 22, 23};
// Miscellaneous registers
pub const DME1737_REG_DEVICE: c_uint = 0x3d;
pub const DME1737_REG_COMPANY: c_uint = 0x3e;
pub const DME1737_REG_VERSTEP: c_uint = 0x3f;
pub const DME1737_REG_CONFIG: c_uint = 0x40;
pub const DME1737_REG_CONFIG2: c_uint = 0x7f;
pub const DME1737_REG_VID: c_uint = 0x43;
pub const DME1737_REG_TACH_PWM: c_uint = 0x81;
// ---------------------------------------------------------------------
// Misc defines
// ---------------------------------------------------------------------
// Chip identification
pub const DME1737_COMPANY_SMSC: c_uint = 0x5c;
pub const DME1737_VERSTEP: c_uint = 0x88;
pub const DME1737_VERSTEP_MASK: c_uint = 0xf8;
pub const SCH311X_DEVICE: c_uint = 0x8c;
pub const SCH5027_VERSTEP: c_uint = 0x69;
pub const SCH5127_DEVICE: c_uint = 0x8e;
// Device ID values (global configuration register index 0x20)
pub const DME1737_ID_1: c_uint = 0x77;
pub const DME1737_ID_2: c_uint = 0x78;
pub const SCH3112_ID: c_uint = 0x7c;
pub const SCH3114_ID: c_uint = 0x7d;
pub const SCH3116_ID: c_uint = 0x7f;
pub const SCH5027_ID: c_uint = 0x89;
pub const SCH5127_ID: c_uint = 0x86;
// Length of ISA address segment
pub const DME1737_EXTENT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dme1737_data {
    pub /: *mut *mut *mut i2c_client client; / for I2C devices only,
    pub hwmon_dev: *mut device,
    pub name: *const c_char,
    pub /: *mut *mut unsigned int addr; / for ISA devices only,
    pub update_lock: mutex,
    pub /: *mut *mut bool valid; / true if following fields are valid,
    pub /: *mut *mut unsigned long last_update; / in jiffies,
    pub /: *mut *mut unsigned long last_vbat; / in jiffies,
    pub type: enum chips,
    pub /: *const *const *const int in_nominal; / pointer to IN_NOMINAL array,
    pub vid: u8,
    pub pwm_rr_en: u8,
    pub has_features: u32,
// Register values
    pub in: [u16; 8],
    pub in_min: [u8; 8],
    pub in_max: [u8; 8],
...
//
#[no_mangle]
pub unsafe extern "C" fn IN_FROM_REG(reg: c_int, nominal: c_int, res: c_int) -> c_int {
    static inline int IN_FROM_REG(int reg, int nominal, int res)
    {
    return (reg * nominal + (3 << (res - 3))) / (3 << (res - 2));
    }
#[no_mangle]
pub unsafe extern "C" fn IN_TO_REG(val: c_long, nominal: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn TEMP_FROM_REG(reg: c_int, res: c_int) -> c_int {
    static inline int TEMP_FROM_REG(int reg, int res)
    {
    return (reg * 1000) >> (res - 8);
    }
#[no_mangle]
pub unsafe extern "C" fn TEMP_TO_REG(val: c_long) -> c_int {
...
// Temperature range
    ...
    40000, 53333, 80000};
#[no_mangle]
pub unsafe extern "C" fn TEMP_RANGE_FROM_REG(reg: c_int) -> c_int {
    static inline int TEMP_RANGE_FROM_REG(int reg)
    {
    return TEMP_RANGE[(reg >> 4) & 0x0f];
    }
#[no_mangle]
unsafe extern "C" fn TEMP_RANGE_TO_REG(val: c_long, reg: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn TEMP_HYST_FROM_REG(reg: c_int, ix: c_int) -> c_int {
    static inline int TEMP_HYST_FROM_REG(int reg, int ix)
    {
    return (((ix == 1) ? reg : reg >> 4) & 0x0f) * 1000;
    }
#[no_mangle]
pub unsafe extern "C" fn TEMP_HYST_TO_REG(temp: c_int, hyst: c_long, ix: c_int, reg: c_int) -> c_int {
...
// Fan input RPM
#[no_mangle]
pub unsafe extern "C" fn FAN_FROM_REG(reg: c_int, tpc: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn FAN_TO_REG(val: c_long, tpc: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn FAN_TPC_FROM_REG(reg: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn FAN_TYPE_FROM_REG(reg: c_int) -> c_int {
    static inline int FAN_TYPE_FROM_REG(int reg)
    {
    let mut edge: c_int = (reg >> 1) & 0x03;
    return (edge > 0) ? 1 << (edge - 1) : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn FAN_TYPE_TO_REG(val: c_long, reg: c_int) -> c_int {
    static inline int FAN_TYPE_TO_REG(long val, int reg)
    {
    let mut edge: c_int = (val == 4) ? 3 : val;
...
// Fan max RPM
    ...
    0x11, 0x0f, 0x0e};
#[no_mangle]
unsafe extern "C" fn FAN_MAX_FROM_REG(reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn FAN_MAX_TO_REG(val: c_long) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn PWM_EN_FROM_REG(reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn PWM_EN_TO_REG(val: c_int, reg: c_int) -> c_int {
    static inline int PWM_EN_TO_REG(int val, int reg)
    {
    let mut en: c_int = (val == 1) ? 7 : 3;
...
//
#[no_mangle]
pub unsafe extern "C" fn PWM_ACZ_FROM_REG(reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn PWM_ACZ_TO_REG(val: c_long, reg: c_int) -> c_int {
    static inline int PWM_ACZ_TO_REG(long val, int reg)
    {
    let mut acz: c_int = (val == 4) ? 2 : val - 1;
...
#[no_mangle]
pub unsafe extern "C" fn PWM_FREQ_FROM_REG(reg: c_int) -> c_int {
    static inline int PWM_FREQ_FROM_REG(int reg)
    {
    return PWM_FREQ[reg & 0x0f];
    }
#[no_mangle]
unsafe extern "C" fn PWM_FREQ_TO_REG(val: c_long, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn PWM_RR_FROM_REG(reg: c_int, ix: c_int) -> c_int {
    static inline int PWM_RR_FROM_REG(int reg, int ix)
    {
    let mut rr: c_int = (ix == 1) ? reg >> 4 : reg;
    return (rr & 0x08) ? PWM_RR[rr & 0x07] : 0;
    }
#[no_mangle]
unsafe extern "C" fn PWM_RR_TO_REG(val: c_long, ix: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn PWM_RR_EN_FROM_REG(reg: c_int, ix: c_int) -> c_int {
    static inline int PWM_RR_EN_FROM_REG(int reg, int ix)
    {
    return PWM_RR_FROM_REG(reg, ix) ? 1 : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn PWM_RR_EN_TO_REG(val: c_long, ix: c_int, reg: c_int) -> c_int {
    static inline int PWM_RR_EN_TO_REG(long val, int ix, int reg)
    {
    let mut en: c_int = (ix == 1) ? 0x80 : 0x08;
...
//
#[no_mangle]
pub unsafe extern "C" fn PWM_OFF_FROM_REG(reg: c_int, ix: c_int) -> c_int {
    static inline int PWM_OFF_FROM_REG(int reg, int ix)
    {
    return (reg >> (ix + 5)) & 0x01;
    }
#[no_mangle]
pub unsafe extern "C" fn PWM_OFF_TO_REG(val: c_int, ix: c_int, reg: c_int) -> c_int {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dme1737_read(data: *const dme1737_data, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn dme1737_write(data: *const dme1737_data, reg: u8, val: u8) -> i32 {
...
// ix = [0-7]
// ---------------------------------------------------------------------
pub const SYS_IN_INPUT: c_int = 0;
pub const SYS_IN_MIN: c_int = 1;
pub const SYS_IN_MAX: c_int = 2;
pub const SYS_IN_ALARM: c_int = 3;
...
// sensor_attr_2 = to_sensor_dev_attr_2(attr);
    let mut ix: c_int = sensor_attr_2.index;
    let mut fn: c_int = sensor_attr_2.nr;
    int res;
    switch (fn) {
    case SYS_IN_INPUT:
...
// ix = [0-2]
// ---------------------------------------------------------------------
pub const SYS_TEMP_INPUT: c_int = 0;
pub const SYS_TEMP_MIN: c_int = 1;
pub const SYS_TEMP_MAX: c_int = 2;
pub const SYS_TEMP_OFFSET: c_int = 3;
pub const SYS_TEMP_ALARM: c_int = 4;
pub const SYS_TEMP_FAULT: c_int = 5;
...
// ix = [0-2]
// ---------------------------------------------------------------------
pub const SYS_ZONE_AUTO_CHANNELS_TEMP: c_int = 0;
pub const SYS_ZONE_AUTO_POINT1_TEMP_HYST: c_int = 1;
pub const SYS_ZONE_AUTO_POINT1_TEMP: c_int = 2;
pub const SYS_ZONE_AUTO_POINT2_TEMP: c_int = 3;
pub const SYS_ZONE_AUTO_POINT3_TEMP: c_int = 4;
...
// ix = [0-5]
// ---------------------------------------------------------------------
pub const SYS_FAN_INPUT: c_int = 0;
pub const SYS_FAN_MIN: c_int = 1;
pub const SYS_FAN_MAX: c_int = 2;
pub const SYS_FAN_ALARM: c_int = 3;
pub const SYS_FAN_TYPE: c_int = 4;
...
// ix = [0-4]
// ---------------------------------------------------------------------
pub const SYS_PWM: c_int = 0;
pub const SYS_PWM_FREQ: c_int = 1;
pub const SYS_PWM_ENABLE: c_int = 2;
pub const SYS_PWM_RAMP_RATE: c_int = 3;
pub const SYS_PWM_AUTO_CHANNELS_ZONE: c_int = 4;
pub const SYS_PWM_AUTO_PWM_MIN: c_int = 5;
pub const SYS_PWM_AUTO_POINT1_PWM: c_int = 6;
pub const SYS_PWM_AUTO_POINT2_PWM: c_int = 7;
...
// Voltages 0-7
    ...
    show_in, core::ptr::null_mut(), SYS_IN_INPUT, ix); \
    ...
    show_in, core::ptr::null_mut(), SYS_IN_ALARM, ix)
...
// Temperatures 1-3
    ...
    show_temp, core::ptr::null_mut(), SYS_TEMP_INPUT, ix-1); \
    ...
    show_temp, core::ptr::null_mut(), SYS_TEMP_ALARM, ix-1); \
    static SENSOR_DEVICE_ATTR_2(temp##ix##_fault, S_IRUGO, \
    show_temp, core::ptr::null_mut(), SYS_TEMP_FAULT, ix-1)
...
// Zones 1-3
    ...
    show_zone, core::ptr::null_mut(), SYS_ZONE_AUTO_CHANNELS_TEMP, ix-1); \
...
// Fans 1-4
    ...
    show_fan, core::ptr::null_mut(), SYS_FAN_INPUT, ix-1); \
    ...
    show_fan, core::ptr::null_mut(), SYS_FAN_ALARM, ix-1); \
...
// PWMs 1-3
    ...
    show_pwm, core::ptr::null_mut(), SYS_PWM_AUTO_POINT2_PWM, ix-1)
...
// PWMs 5-6
    ...
    show_pwm, set_pwm, SYS_PWM_FREQ, ix-1); \
    static SENSOR_DEVICE_ATTR_2(pwm##ix##_enable, S_IRUGO, \
    show_pwm, core::ptr::null_mut(), SYS_PWM_ENABLE, ix-1)
...
// ---------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn dme1737_sio_enter(sio_cip: c_int) {
    static inline void dme1737_sio_enter(int sio_cip)
    {
    outb(0x55, sio_cip);
    }
#[no_mangle]
pub unsafe extern "C" fn dme1737_sio_exit(sio_cip: c_int) {
    static inline void dme1737_sio_exit(int sio_cip)
    {
    outb(0xaa, sio_cip);
    }
#[no_mangle]
pub unsafe extern "C" fn dme1737_sio_inb(sio_cip: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dme1737_sio_outb(sio_cip: c_int, reg: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dme1737_remove_files(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn dme1737_create_files(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dme1737_init_device(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dme1737_i2c_get_features(sio_cip: c_int, data: *mut dme1737_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dme1737_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dme1737_i2c_remove(client: *mut i2c_client) {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dme1737_isa_detect(sio_cip: c_int, addr: *mut c_ushort) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dme1737_isa_device_add(addr: c_ushort) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dme1737_isa_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dme1737_isa_remove(pdev: *mut platform_device) {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dme1737_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dme1737_exit() -> void __exit {
