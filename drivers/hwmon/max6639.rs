...
//! Source: drivers/hwmon/max6639.c
#![no_std]
...
pub const MAX6639_REG_STATUS: c_uint = 0x02;
pub const MAX6639_REG_OUTPUT_MASK: c_uint = 0x03;
pub const MAX6639_REG_GCONFIG: c_uint = 0x04;

pub const MAX6639_REG_DEVID: c_uint = 0x3D;
pub const MAX6639_REG_MANUID: c_uint = 0x3E;
pub const MAX6639_REG_DEVREV: c_uint = 0x3F;
// Register bits
pub const MAX6639_GCONFIG_STANDBY: c_uint = 0x80;
pub const MAX6639_GCONFIG_POR: c_uint = 0x40;
pub const MAX6639_GCONFIG_DISABLE_TIMEOUT: c_uint = 0x20;
pub const MAX6639_GCONFIG_CH2_LOCAL: c_uint = 0x10;
pub const MAX6639_GCONFIG_PWM_FREQ_HI: c_uint = 0x08;
pub const MAX6639_FAN_CONFIG1_PWM: c_uint = 0x80;
pub const MAX6639_FAN_CONFIG3_FREQ_MASK: c_uint = 0x03;
pub const MAX6639_FAN_CONFIG3_THERM_FULL_SPEED: c_uint = 0x40;
pub const MAX6639_NUM_CHANNELS: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max6639_data {
    pub regmap: *mut regmap,
// Register values initialized only once
    pub /: *mut *mut u8 ppr[MAX6639_NUM_CHANNELS]; / Pulses per rotation 0..3 for 1..4 ppr,
    pub /: *mut *mut u8 rpm_range[MAX6639_NUM_CHANNELS]; / Index in above rpm_ranges table,
    pub target_rpm: [u32; MAX6639_NUM_CHANNELS],
// Optional regulator for FAN supply
    pub reg: *mut regulator,
}

#[no_mangle]
unsafe extern "C" fn max6639_temp_read_input(dev: *mut device, channel: c_int, temp: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_read_fault(dev: *mut device, channel: c_int, fault: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_read_max(dev: *mut device, channel: c_int, max: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_read_crit(dev: *mut device, channel: c_int, crit: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_read_emergency(dev: *mut device, channel: c_int, emerg: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_get_status(dev: *mut device, status: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_set_max(data: *mut max6639_data, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_set_crit(data: *mut max6639_data, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_set_emergency(data: *mut max6639_data, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_set_ppr(data: *mut max6639_data, channel: c_int, ppr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_fan_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn max6639_pwm_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn max6639_temp_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
//
#[no_mangle]
unsafe extern "C" fn rpm_range_to_reg(range: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_regulator_disable(data: *mut c_void) {
    static void max6639_regulator_disable(void *data)
    {
    regulator_disable(data);
    }
#[no_mangle]
unsafe extern "C" fn max6639_regmap_is_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max6639_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6639_resume(dev: *mut device) -> c_int {
