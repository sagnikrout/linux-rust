...
//! Source: drivers/hwmon/max77705-hwmon.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct channel_desc {
    pub reg: u8,
    pub avg_reg: u8,
    pub label: *const *const c_char,
...
#[no_mangle]
unsafe extern "C" fn max77705_hwmon_probe(pdev: *mut platform_device) -> c_int {
    ...
    &max77705_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon_dev))
