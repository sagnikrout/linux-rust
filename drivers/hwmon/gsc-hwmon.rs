...
//! Source: drivers/hwmon/gsc-hwmon.c
#![no_std]
...
pub const GSC_HWMON_MAX_TEMP_CH: c_int = 16;
pub const GSC_HWMON_MAX_IN_CH: c_int = 16;
pub const GSC_HWMON_MAX_FAN_CH: c_int = 16;
pub const GSC_HWMON_RESOLUTION: c_int = 12;
pub const GSC_HWMON_VREF: c_int = 2500;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gsc_hwmon_data {
    pub gsc: *mut gsc_dev,
    pub pdata: *mut gsc_hwmon_platform_data,
    pub regmap: *mut regmap,
    pub temp_ch: [*const gsc_hwmon_channel; GSC_HWMON_MAX_TEMP_CH],
    pub in_ch: [*const gsc_hwmon_channel; GSC_HWMON_MAX_IN_CH],
    pub fan_ch: [*const gsc_hwmon_channel; GSC_HWMON_MAX_FAN_CH],
    pub 1]: u32 temp_config[GSC_HWMON_MAX_TEMP_CH +,
    pub 1]: u32 in_config[GSC_HWMON_MAX_IN_CH +,
    pub 1]: u32 fan_config[GSC_HWMON_MAX_FAN_CH +,
    pub temp_info: hwmon_channel_info,
    pub in_info: hwmon_channel_info,
    pub fan_info: hwmon_channel_info,
    pub info: [*const hwmon_channel_info; 4],
    ...
    let mut reg: u8 = hwmon.pdata.fan_base + (2 * attr.index);
    u8 regs[2];
    int ret;
...
// fan controller base address
    ...
    fan = of_find_compatible_node(dev.parent.of_node, core::ptr::null_mut(), "gw,gsc-fan");
...
#[no_mangle]
unsafe extern "C" fn gsc_hwmon_probe(pdev: *mut platform_device) -> c_int {
...
// setup config structures
    ...
    groups = pdata.fan_base ? gsc_hwmon_groups : core::ptr::null_mut();
