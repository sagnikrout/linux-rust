...
//! Source: drivers/hwmon/gpio-fan.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_fan_data {
    pub dev: *mut device,
    pub hwmon_dev: *mut device,
// Cooling device if any
    pub cdev: *mut thermal_cooling_device,
    pub /: *mut *mut mutex lock; / lock GPIOs operations.,
    pub num_gpios: c_int,
    pub gpios: *mut gpio_desc,
    pub num_speed: c_int,
    pub speed: *mut gpio_fan_speed,
    pub speed_index: c_int,
    pub resume_speed: c_int,
    pub pwm_enable: bool,
    pub alarm_gpio: *mut gpio_desc,
    pub alarm_work: work_struct,
...
//
#[no_mangle]
unsafe extern "C" fn fan_alarm_notify(ws: *mut work_struct) {
    static void fan_alarm_notify(struct work_struct *ws)
    {
    struct gpio_fan_data *fan_data =
    container_of(ws, struct gpio_fan_data, alarm_work);
    sysfs_notify(&fan_data.hwmon_dev.kobj, core::ptr::null_mut(), "fan1_alarm");
    kobject_uevent(&fan_data.hwmon_dev.kobj, KOBJ_CHANGE);
    }
#[no_mangle]
unsafe extern "C" fn fan_alarm_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fan_alarm_init(fan_data: *mut gpio_fan_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __set_fan_ctrl(fan_data: *mut gpio_fan_data, ctrl_val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __get_fan_ctrl(fan_data: *mut gpio_fan_data) -> c_int {
...
// Must be called with fan_data->lock held, except during initialization.
#[no_mangle]
unsafe extern "C" fn set_fan_speed(fan_data: *mut gpio_fan_data, speed_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_fan_speed_index(fan_data: *mut gpio_fan_data) -> c_int {
    static int get_fan_speed_index(struct gpio_fan_data *fan_data)
    {
    let mut ctrl_val: c_int = __get_fan_ctrl(fan_data);
    int i;
...
#[no_mangle]
unsafe extern "C" fn rpm_to_speed_index(fan_data: *mut gpio_fan_data, rpm: c_ulong) -> c_int {
    ...
    {
    struct gpio_fan_data *fan_data = dev_get_drvdata(dev);
    let mut pwm: u8 = fan_data.speed_index * 255 / (fan_data.num_speed - 1);
    return sprintf(buf, "%d\n", pwm);
    }
...
#[no_mangle]
unsafe extern "C" fn fan_ctrl_init(fan_data: *mut gpio_fan_data) -> c_int {
    static int fan_ctrl_init(struct gpio_fan_data *fan_data)
    {
    let mut num_gpios: c_int = fan_data.num_gpios;
...
//
#[no_mangle]
unsafe extern "C" fn gpio_fan_get_of_data(fan_data: *mut gpio_fan_data) -> c_int {
...
// Fill GPIO pin array
    fan_data.num_gpios = gpiod_count(dev, core::ptr::null_mut());
    ...
    return -ENOMEM;
    for (i = 0; i < fan_data.num_gpios; i++) {
    gpios[i] = devm_gpiod_get_index(dev, core::ptr::null_mut(), i, GPIOD_ASIS);
    if (IS_ERR(gpios[i]))
...
#[no_mangle]
unsafe extern "C" fn gpio_fan_stop(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_fan_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_fan_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gpio_fan_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_fan_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_fan_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_fan_resume(dev: *mut device) -> c_int {
    ...
    gpio_fan_runtime_resume, core::ptr::null_mut())
