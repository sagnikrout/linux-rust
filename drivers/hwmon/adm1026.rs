...
//! Source: drivers/hwmon/adm1026.c
#![no_std]
...
// Addresses to scan
    ...
    module_param_array(gpio_input, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(gpio_input, "List of GPIO pins (0-16) to program as inputs");
    module_param_array(gpio_output, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(gpio_output,
    "List of GPIO pins (0-16) to program as outputs");
    module_param_array(gpio_inverted, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(gpio_inverted,
    "List of GPIO pins (0-16) to program as inverted");
    module_param_array(gpio_normal, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(gpio_normal,
    "List of GPIO pins (0-16) to program as normal/non-inverted");
    module_param_array(gpio_fan, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(gpio_fan, "List of GPIO pins (0-7) to program as fan tachs");
// Many ADM1026 constants specified below
// The ADM1026 registers
pub const ADM1026_REG_CONFIG1: c_uint = 0x00;
pub const CFG1_MONITOR: c_uint = 0x01;
pub const CFG1_INT_ENABLE: c_uint = 0x02;
pub const CFG1_INT_CLEAR: c_uint = 0x04;
pub const CFG1_AIN8_9: c_uint = 0x08;
pub const CFG1_THERM_HOT: c_uint = 0x10;
pub const CFG1_DAC_AFC: c_uint = 0x20;
pub const CFG1_PWM_AFC: c_uint = 0x40;
pub const CFG1_RESET: c_uint = 0x80;
pub const ADM1026_REG_CONFIG2: c_uint = 0x01;
// CONFIG2 controls FAN0/GPIO0 through FAN7/GPIO7
pub const ADM1026_REG_CONFIG3: c_uint = 0x07;
pub const CFG3_GPIO16_ENABLE: c_uint = 0x01;
pub const CFG3_CI_CLEAR: c_uint = 0x02;
pub const CFG3_VREF_250: c_uint = 0x04;
pub const CFG3_GPIO16_DIR: c_uint = 0x40;
pub const CFG3_GPIO16_POL: c_uint = 0x80;
pub const ADM1026_REG_E2CONFIG: c_uint = 0x13;
pub const E2CFG_READ: c_uint = 0x01;
pub const E2CFG_WRITE: c_uint = 0x02;
pub const E2CFG_ERASE: c_uint = 0x04;
pub const E2CFG_ROM: c_uint = 0x08;
pub const E2CFG_CLK_EXT: c_uint = 0x80;
//
...
pub const ADM1026_REG_FAN_DIV_0_3: c_uint = 0x02;
pub const ADM1026_REG_FAN_DIV_4_7: c_uint = 0x03;
pub const ADM1026_REG_DAC: c_uint = 0x04;
pub const ADM1026_REG_PWM: c_uint = 0x05;
pub const ADM1026_REG_GPIO_CFG_0_3: c_uint = 0x08;
pub const ADM1026_REG_GPIO_CFG_4_7: c_uint = 0x09;
pub const ADM1026_REG_GPIO_CFG_8_11: c_uint = 0x0a;
pub const ADM1026_REG_GPIO_CFG_12_15: c_uint = 0x0b;
// CFG_16 in REG_CFG3
pub const ADM1026_REG_GPIO_STATUS_0_7: c_uint = 0x24;
pub const ADM1026_REG_GPIO_STATUS_8_15: c_uint = 0x25;
// STATUS_16 in REG_STATUS4
pub const ADM1026_REG_GPIO_MASK_0_7: c_uint = 0x1c;
pub const ADM1026_REG_GPIO_MASK_8_15: c_uint = 0x1d;
// MASK_16 in REG_MASK4
pub const ADM1026_REG_COMPANY: c_uint = 0x16;
pub const ADM1026_REG_VERSTEP: c_uint = 0x17;
// These are the recognized values for the above regs
pub const ADM1026_COMPANY_ANALOG_DEV: c_uint = 0x41;
pub const ADM1026_VERSTEP_GENERIC: c_uint = 0x40;
pub const ADM1026_VERSTEP_ADM1026: c_uint = 0x44;
pub const ADM1026_REG_MASK1: c_uint = 0x18;
pub const ADM1026_REG_MASK2: c_uint = 0x19;
pub const ADM1026_REG_MASK3: c_uint = 0x1a;
pub const ADM1026_REG_MASK4: c_uint = 0x1b;
pub const ADM1026_REG_STATUS1: c_uint = 0x20;
pub const ADM1026_REG_STATUS2: c_uint = 0x21;
pub const ADM1026_REG_STATUS3: c_uint = 0x22;
pub const ADM1026_REG_STATUS4: c_uint = 0x23;

pub const ADM1026_FAN_CONTROL_TEMP_RANGE: c_int = 20;
pub const ADM1026_PWM_MAX: c_int = 255;
//
...
pub const NEG12_OFFSET: c_int = 16000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adm1026_data {
    pub client: *mut i2c_client,
    pub groups: [*const attribute_group; 3],
    pub update_lock: mutex,
    pub /: *mut *mut bool valid; / true if following fields are valid,
    pub /: *mut *mut unsigned long last_reading; / In jiffies,
    pub /: *mut *mut unsigned long last_config; / In jiffies,
    pub /: *mut *mut u8 in[17]; / Register value,
    pub /: *mut *mut u8 in_max[17]; / Register value,
    pub /: *mut *mut u8 in_min[17]; / Register value,
    pub /: *mut *mut s8 temp[3]; / Register value,
    pub /: *mut *mut s8 temp_min[3]; / Register value,
    pub /: *mut *mut s8 temp_max[3]; / Register value,
    pub /: *mut *mut s8 temp_tmin[3]; / Register value,
    pub /: *mut *mut s8 temp_crit[3]; / Register value,
    pub /: *mut *mut s8 temp_offset[3]; / Register value,
    pub /: *mut *mut u8 fan[8]; / Register value,
    pub /: *mut *mut u8 fan_min[8]; / Register value,
    pub /: *mut *mut u8 fan_div[8]; / Decoded value,
    pub /: *mut *mut pwm_data pwm1; / Pwm control values,
    pub /: *mut *mut u8 vrm; / VRM version,
    pub /: *mut *mut u8 analog_out; / Register value (DAC),
    pub /: *mut *mut long alarms; / Register encoding, combined,
    pub /: *mut *mut long alarm_mask; / Register encoding, combined,
    pub /: *mut *mut long gpio; / Register encoding, combined,
    pub /: *mut *mut long gpio_mask; / Register encoding, combined,
    pub /: *mut *mut u8 gpio_config[17]; / Decoded value,
    pub /: *mut *mut u8 config1; / Register value,
    pub /: *mut *mut u8 config2; / Register value,
    pub /: *mut *mut u8 config3; / Register value,
}

#[no_mangle]
unsafe extern "C" fn adm1026_read_value(client: *mut i2c_client, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm1026_write_value(client: *mut i2c_client, reg: u8, value: c_int) -> c_int {
...
// Read the GPIO config
    ...
    struct adm1026_data *data = adm1026_update_device(dev);
#[no_mangle]
pub unsafe extern "C" fn sprintf(_arg: buf, _arg: "%d\n", _arg: INS_FROM_REG(16, _arg: data->in_min[16]) -> return {
    ...
    struct adm1026_data *data = adm1026_update_device(dev);
#[no_mangle]
pub unsafe extern "C" fn sprintf(_arg: buf, _arg: "%d\n", _arg: INS_FROM_REG(16, _arg: data->in_max[16]) -> return {
...
#[no_mangle]
unsafe extern "C" fn fixup_fan_min(dev: *mut device, fan: c_int, old_div: c_int) {
    static void fixup_fan_min(struct device *dev, int fan, int old_div)
    {
    struct adm1026_data *data = dev_get_drvdata(dev);
    struct i2c_client *client = data.client;
    int new_min;
    let mut new_div: c_int = data.fan_div[fan];
...
// Temps
    ...
    {
    struct adm1026_data *data = adm1026_update_device(dev);
    let mut vid: c_int = (data.gpio >> 11) & 0x1f;
...
#[no_mangle]
unsafe extern "C" fn adm1026_print_gpio(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn adm1026_fixup_gpio(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn adm1026_init_client(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn adm1026_probe(client: *mut i2c_client) -> c_int {
