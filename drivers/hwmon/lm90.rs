...
pub const MAX_CHANNELS: c_int = 3;
//
// Addresses to scan
...
// The LM90 registers
//
pub const LM90_REG_MAN_ID: c_uint = 0xFE;
pub const LM90_REG_CHIP_ID: c_uint = 0xFF;
pub const LM90_REG_CONFIG1: c_uint = 0x03;
pub const LM90_REG_CONFIG2: c_uint = 0xBF;
pub const LM90_REG_CONVRATE: c_uint = 0x04;
pub const LM90_REG_STATUS: c_uint = 0x02;
pub const LM90_REG_LOCAL_TEMP: c_uint = 0x00;
pub const LM90_REG_LOCAL_HIGH: c_uint = 0x05;
pub const LM90_REG_LOCAL_LOW: c_uint = 0x06;
pub const LM90_REG_LOCAL_CRIT: c_uint = 0x20;
pub const LM90_REG_REMOTE_TEMPH: c_uint = 0x01;
pub const LM90_REG_REMOTE_TEMPL: c_uint = 0x10;
pub const LM90_REG_REMOTE_OFFSH: c_uint = 0x11;
pub const LM90_REG_REMOTE_OFFSL: c_uint = 0x12;
pub const LM90_REG_REMOTE_HIGHH: c_uint = 0x07;
pub const LM90_REG_REMOTE_HIGHL: c_uint = 0x13;
pub const LM90_REG_REMOTE_LOWH: c_uint = 0x08;
pub const LM90_REG_REMOTE_LOWL: c_uint = 0x14;
pub const LM90_REG_REMOTE_CRIT: c_uint = 0x19;
pub const LM90_REG_TCRIT_HYST: c_uint = 0x21;
// MAX6646/6647/6649/6654/6657/6658/6659/6695/6696 registers
pub const MAX6657_REG_LOCAL_TEMPL: c_uint = 0x11;
pub const MAX6696_REG_STATUS2: c_uint = 0x12;
pub const MAX6659_REG_REMOTE_EMERG: c_uint = 0x16;
pub const MAX6659_REG_LOCAL_EMERG: c_uint = 0x17;
// SA56004 registers
pub const SA56004_REG_LOCAL_TEMPL: c_uint = 0x22;

// TMP451/TMP461 registers
pub const TMP451_REG_LOCAL_TEMPL: c_uint = 0x15;
pub const TMP451_REG_CONALERT: c_uint = 0x22;
pub const TMP461_REG_CHEN: c_uint = 0x16;
pub const TMP461_REG_DFC: c_uint = 0x24;
// ADT7481 registers
pub const ADT7481_REG_STATUS2: c_uint = 0x23;
pub const ADT7481_REG_CONFIG2: c_uint = 0x24;
pub const ADT7481_REG_MAN_ID: c_uint = 0x3e;
pub const ADT7481_REG_CHIP_ID: c_uint = 0x3d;
// NCT7716/7717/7718 registers
pub const NCT7716_REG_CHIP_ID: c_uint = 0xFD;
// Device features
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm90_params {
    pub /: *mut *mut u32 flags; / Capabilities,
    pub /: *mut *mut u16 alert_alarms; / Which alarm bits trigger ALERT#,
// Upper 8 bits for max6695/96
    pub /: *mut *mut u8 max_convrate; / Maximum conversion rate register value,
    pub /: *mut *mut u8 resolution; / 16-bit resolution (default 11 bit),
    pub /: *mut *mut u8 reg_status2; / 2nd status register (optional),
    pub /: *mut *mut u8 reg_local_ext; / Extended local temp register (optional),
    pub /: *mut *mut u8 faultqueue_mask; / fault queue bit mask,
    pub /: *mut *mut u8 faultqueue_depth; / fault queue depth if mask is used,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm90_data {
    pub client: *mut i2c_client,
    pub hwmon_dev: *mut device,
    pub chip_config: [u32; 2],
    pub 1]: u32 channel_config[MAX_CHANNELS +,
    pub channel_label: [*const c_char; MAX_CHANNELS],
    ...
    pub alert_work: delayed_work,
    pub report_work: work_struct,
    pub /: *mut *mut bool shutdown; / true if shutting down,
    pub /: *mut *mut bool valid; / true if register values are valid,
    pub /: *mut *mut bool alarms_valid; / true if status register values are valid,
    pub /: *mut *mut unsigned long last_updated; / in jiffies,
    pub /: *mut *mut unsigned long alarms_updated; / in jiffies,
    pub kind: c_int,
    pub flags: u32,
    pub /: *mut *mut unsigned int update_interval; / in milliseconds,
    pub /: *mut *mut u8 config; / Current configuration register value,
    pub /: *mut *mut u8 config_orig; / Original configuration register value,
    pub /: *mut *mut u8 convrate_orig; / Original conversion rate register value,
    pub /: *mut *mut u8 resolution; / temperature resolution in bit,
    pub /: *mut *mut u16 alert_alarms; / Which alarm bits trigger ALERT#,
// Upper 8 bits for max6695/96
    pub /: *mut *mut u8 max_convrate; / Maximum conversion rate,
    pub /: *mut *mut u8 reg_status2; / 2nd status register (optional),
    pub /: *mut *mut u8 reg_local_ext; / local extension register offset,
    pub /: *mut *mut u8 reg_remote_ext; / remote temperature low byte,
    pub /: *mut *mut u8 faultqueue_mask; / fault queue mask,
    pub /: *mut *mut u8 faultqueue_depth; / fault queue mask,
// registers values
    pub temp: [u16; TEMP_REG_NUM],
    pub temp_hyst: u8,
    pub conalert: u8,
    pub /: *mut *mut u16 reported_alarms; / alarms reported as sysfs/udev events,
    pub /: *mut *mut u16 current_alarms; / current alarms, reported by chip,
    pub /: *mut *mut u16 alarms; / alarms not yet reported to user,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn lm90_write_no_pec(client: *mut i2c_client, value: u8) -> i32 {
    static inline s32 lm90_write_no_pec(struct i2c_client *client, u8 value)
    {
    return i2c_smbus_xfer(client.adapter, client.addr,
    client.flags & ~I2C_CLIENT_PEC,
    I2C_SMBUS_WRITE, value, I2C_SMBUS_BYTE, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn lm90_read_reg(client: *mut i2c_client, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lm90_write_reg_addr(reg: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn lm90_write_reg(client: *mut i2c_client, reg: u8, val: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lm90_write16(client: *mut i2c_client, regh: u8, regl: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_update_confreg(data: *mut lm90_data, config: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lm90_select_remote_channel(data: *mut lm90_data, second: bool) -> c_int {
    static int lm90_select_remote_channel(struct lm90_data *data, bool second)
    {
    let mut config: u8 = data.config & ~0x08;
    if (second)
    config |= 0x08;
    return lm90_update_confreg(data, config);
    }
#[no_mangle]
unsafe extern "C" fn lm90_write_convrate(data: *mut lm90_data, val: c_int) -> c_int {
    static int lm90_write_convrate(struct lm90_data *data, int val)
    {
    let mut config: u8 = data.config;
    int err;
...
#[no_mangle]
unsafe extern "C" fn lm90_update_limits(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_report_alarms(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn lm90_update_alarms_locked(data: *mut lm90_data, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_update_alarms(data: *mut lm90_data, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_alert_work(__work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn lm90_update_device(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_temp_get_resolution(data: *mut lm90_data, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_temp_from_reg(flags: u32, regval: u16, resolution: u8) -> c_int {
    ...
    val = regval - 0x4000;
#[no_mangle]
pub unsafe extern "C" fn if(LM90_HAVE_EXT_UNSIGNED): flags & (LM90_HAVE_UNSIGNED_TEMP |) -> else {
...
#[no_mangle]
unsafe extern "C" fn lm90_get_temp(data: *mut lm90_data, index: c_int, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_temp_to_reg(flags: u32, val: c_long, resolution: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn lm90_set_temp(data: *mut lm90_data, index: c_int, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(REMOTE2_HIGH: index == REMOTE_HIGH || index ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lm90_get_temphyst(data: *mut lm90_data, index: c_int, channel: c_int) -> c_int {
    static int lm90_get_temphyst(struct lm90_data *data, int index, int channel)
    {
    let mut temp: c_int = lm90_get_temp(data, index, channel);
    return temp - data.temp_hyst * 1000;
    }
#[no_mangle]
unsafe extern "C" fn lm90_set_temphyst(data: *mut lm90_data, val: c_long) -> c_int {
    static int lm90_set_temphyst(struct lm90_data *data, long val)
    {
    let mut temp: c_int = lm90_get_temp(data, LOCAL_CRIT, 0);
...
#[no_mangle]
unsafe extern "C" fn lm90_get_temp_offset(data: *mut lm90_data, index: c_int) -> c_int {
    static int lm90_get_temp_offset(struct lm90_data *data, int index)
    {
    let mut res: c_int = lm90_temp_get_resolution(data, index);
    return lm90_temp_from_reg(0, data.temp[index], res);
    }
#[no_mangle]
unsafe extern "C" fn lm90_set_temp_offset(data: *mut lm90_data, index: c_int, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_temp_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_temp_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_temp_is_visible(data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn lm90_chip_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_chip_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_chip_is_visible(data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
// str = data->channel_label[channel];
    ...
    let mut status: c_int = i2c_smbus_read_byte_data(client, LM90_REG_STATUS);
...
//
    return nonzero && ff != 0xff ? "lm84" : core::ptr::null_mut();
    }
...
//
    ...
    {
    let mut config2: c_int = i2c_smbus_read_byte_data(client, LM90_REG_CONFIG2);
    ...
    {
    let mut status: c_int = i2c_smbus_read_byte_data(client, LM90_REG_STATUS);
    let mut config2: c_int = i2c_smbus_read_byte_data(client, ADT7481_REG_CONFIG2);
    let mut man_id2: c_int = i2c_smbus_read_byte_data(client, ADT7481_REG_MAN_ID);
    let mut chip_id2: c_int = i2c_smbus_read_byte_data(client, ADT7481_REG_CHIP_ID);
    let mut address: c_int = client.addr;
    const char *name = core::ptr::null_mut();
...
// W83L771AWG/ASG
    ...
    int config1, int convrate)
    {
    let mut chip_id2: c_int = i2c_smbus_read_byte_data(client, NCT7716_REG_CHIP_ID);
    let mut config2: c_int = i2c_smbus_read_byte_data(client, LM90_REG_CONFIG2);
    let mut address: c_int = client.addr;
    const char *name = core::ptr::null_mut();
    ...
    name = "nct7716";
#[no_mangle]
pub unsafe extern "C" fn if(0xf8): address == 0x4c && !(config1 & 0x38) && !(config2 &) -> else {
...
// THMC10: Unsupported registers return 0xff
    ...
    name = "tmp451";
#[no_mangle]
pub unsafe extern "C" fn if(0x4f: address >= 0x48 && address <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn lm90_detect(client: *mut i2c_client, info: *mut i2c_board_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_restore_conf(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lm90_stop_work(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lm90_init_client(client: *mut i2c_client, data: *mut lm90_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_is_tripped(client: *mut i2c_client) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lm90_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lm90_probe(client: *mut i2c_client) -> c_int {
...
// Initialize the LM90 chip
    ...
    core::ptr::null_mut(), lm90_irq_thread,
...
#[no_mangle]
unsafe extern "C" fn lm90_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm90_resume(dev: *mut device) -> c_int {
