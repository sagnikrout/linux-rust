...
//! Source: drivers/hwmon/hwmon-vid.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn vid_from_reg(val: c_int, vrm: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_via_model_d_vrm() -> u8 {
...
// Enable quirk for Eden
    let mut brand: return = = 2 ? 131 : 13;
    }
    }
#[no_mangle]
unsafe extern "C" fn find_vrm(family: u8, model: u8, stepping: u8, vendor: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn vid_which_vrm() -> u8 {
