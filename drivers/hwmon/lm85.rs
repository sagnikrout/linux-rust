...
pub const LM85_REG_COMPANY: c_uint = 0x3e;
pub const LM85_REG_VERSTEP: c_uint = 0x3f;
pub const ADT7468_REG_CFG5: c_uint = 0x7c;

    ((data).type == adt7468 && !((data).cfg5 & ADT7468_OFF64))

    ((data).type == adt7468 && !((data).cfg5 & ADT7468_HFPWM))
// These are the recognized values for the above regs
pub const LM85_COMPANY_NATIONAL: c_uint = 0x01;
pub const LM85_COMPANY_ANALOG_DEV: c_uint = 0x41;
pub const LM85_COMPANY_SMSC: c_uint = 0x5c;
pub const LM85_VERSTEP_LM85C: c_uint = 0x60;
pub const LM85_VERSTEP_LM85B: c_uint = 0x62;
pub const LM85_VERSTEP_LM96000_1: c_uint = 0x68;
pub const LM85_VERSTEP_LM96000_2: c_uint = 0x69;
pub const LM85_VERSTEP_ADM1027: c_uint = 0x60;
pub const LM85_VERSTEP_ADT7463: c_uint = 0x62;
pub const LM85_VERSTEP_ADT7463C: c_uint = 0x6A;
pub const LM85_VERSTEP_ADT7468_1: c_uint = 0x71;
pub const LM85_VERSTEP_ADT7468_2: c_uint = 0x72;
pub const LM85_VERSTEP_EMC6D100_A0: c_uint = 0x60;
pub const LM85_VERSTEP_EMC6D100_A1: c_uint = 0x61;
pub const LM85_VERSTEP_EMC6D102: c_uint = 0x65;
pub const LM85_VERSTEP_EMC6D103_A0: c_uint = 0x68;
pub const LM85_VERSTEP_EMC6D103_A1: c_uint = 0x69;
pub const LM85_VERSTEP_EMC6D103S: c_uint = 0x6A	/* Also known as EMC6D103:A2 */;
pub const LM85_REG_CONFIG: c_uint = 0x40;
pub const LM85_REG_ALARM1: c_uint = 0x41;
pub const LM85_REG_ALARM2: c_uint = 0x42;
pub const LM85_REG_VID: c_uint = 0x43;
// Automated FAN control

pub const LM85_REG_AFAN_SPIKE1: c_uint = 0x62;

pub const LM85_REG_AFAN_HYST1: c_uint = 0x6d;
pub const LM85_REG_AFAN_HYST2: c_uint = 0x6e;
pub const ADM1027_REG_EXTEND_ADC1: c_uint = 0x76;
pub const ADM1027_REG_EXTEND_ADC2: c_uint = 0x77;
pub const EMC6D100_REG_ALARM3: c_uint = 0x7d;
// IN5, IN6 and IN7

pub const EMC6D102_REG_EXTEND_ADC1: c_uint = 0x85;
pub const EMC6D102_REG_EXTEND_ADC2: c_uint = 0x86;
pub const EMC6D102_REG_EXTEND_ADC3: c_uint = 0x87;
pub const EMC6D102_REG_EXTEND_ADC4: c_uint = 0x88;
//
...
#[no_mangle]
unsafe extern "C" fn RANGE_TO_REG(range: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn FREQ_FROM_REG(map: *const c_int, map_size: c_uint, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ZONE_TO_REG(zone: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm85_zone {
    pub /: *mut *mut s8 limit; / Low temp limit,
    pub /: *mut *mut u8 hyst; / Low limit hysteresis. (0-15),
    pub /: *mut *mut u8 range; / Temp range, encoded,
    pub /: *mut *mut s8 critical; / "All fans ON" temp limit,
    pub /*: *mut u8 max_desired;,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm85_autofan {
    pub /: *mut *mut u8 config; / Register value,
    pub /: *mut *mut u8 min_pwm; / Minimum PWM value, encoded,
    pub /: *mut *mut u8 min_off; / Min PWM or OFF below "limit", flag,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm85_data {
    pub client: *mut i2c_client,
    pub groups: [*const attribute_group; 6],
    pub freq_map: *const c_int,
    pub freq_map_size: c_uint,
    pub type: enum chips,
    pub /: *mut *mut bool has_vid5; / true if VID5 is configured for ADT7463 or ADT7468,
    ...
    pub /: *mut *mut u8 in[8]; / Register value,
    pub /: *mut *mut u8 in_max[8]; / Register value,
    pub /: *mut *mut u8 in_min[8]; / Register value,
    pub /: *mut *mut s8 temp[3]; / Register value,
    pub /: *mut *mut s8 temp_min[3]; / Register value,
    pub /: *mut *mut s8 temp_max[3]; / Register value,
    pub /: *mut *mut u16 fan[4]; / Register value,
    pub /: *mut *mut u16 fan_min[4]; / Register value,
    pub /: *mut *mut u8 pwm[3]; / Register value,
    pub /: *mut *mut u8 pwm_freq[3]; / Register encoding,
    pub /: *mut *mut u8 temp_ext[3]; / Decoded values,
    pub /: *mut *mut u8 in_ext[8]; / Decoded values,
    pub /: *mut *mut u8 vid; / Register value,
    pub /: *mut *mut u8 vrm; / VRM version,
    pub /: *mut *mut u32 alarms; / Register encoding, combined,
    pub /: *mut *mut u8 cfg5; / Config Register 5 on ADT7468,
    pub autofan: [lm85_autofan; 3],
    pub zone: [lm85_zone; 3],
}

#[no_mangle]
unsafe extern "C" fn lm85_read_value(client: *mut i2c_client, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm85_write_value(client: *mut i2c_client, reg: u8, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lm85_init_client(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn lm85_is_fake(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm85_detect(client: *mut i2c_client, info: *mut i2c_board_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm85_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    let mut vid: u8 = lm85_read_value(client, LM85_REG_VID);
    if (vid & 0x80)
    data.has_vid5 = true;
    }
    if (!data.has_vid5)
