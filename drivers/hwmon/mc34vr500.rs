...
//! Source: drivers/hwmon/mc34vr500.c
#![no_std]
...
pub const MC34VR500_I2C_ADDR: c_uint = 0x08;
pub const MC34VR500_DEVICEID_VALUE: c_uint = 0x14;
// INTSENSE0

pub const MC34VR500_DEVICEID: c_uint = 0x00;
pub const MC34VR500_SILICONREVID: c_uint = 0x03;
pub const MC34VR500_FABID: c_uint = 0x04;
pub const MC34VR500_INTSTAT0: c_uint = 0x05;
pub const MC34VR500_INTMASK0: c_uint = 0x06;
pub const MC34VR500_INTSENSE0: c_uint = 0x07;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc34vr500_data {
    pub hwmon_dev: *mut device,
    pub regmap: *mut regmap,
}

#[no_mangle]
unsafe extern "C" fn mc34vr500_process_interrupt(irq: c_int, userdata: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mc34vr500_probe(client: *mut i2c_client) -> c_int {
