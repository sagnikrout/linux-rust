...
pub const REG_2E: c_uint = 0x2e	/* The register to read/write */;
pub const REG_4E: c_uint = 0x4e	/* Secondary register to read/write */;
pub const DEV: c_uint = 0x07	/* Register: Logical device select */;
pub const PME: c_uint = 0x04	/* The device with the fan registers in it */;
// The device with the IT8718F/IT8720F VID value in it
pub const GPIO: c_uint = 0x07;
pub const DEVID: c_uint = 0x20	/* Register: Device ID */;
pub const DEVREV: c_uint = 0x22	/* Register: Device Revision */;
#[no_mangle]
pub unsafe extern "C" fn __superio_enter(ioreg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn superio_inw(ioreg: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn superio_select(ioreg: c_int, ldn: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn superio_enter(ioreg: c_int, noentry: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn superio_exit(ioreg: c_int, noexit: bool) {
...
pub const IT8712F_DEVID: c_uint = 0x8712;
pub const IT8705F_DEVID: c_uint = 0x8705;
pub const IT8716F_DEVID: c_uint = 0x8716;
pub const IT8718F_DEVID: c_uint = 0x8718;
pub const IT8720F_DEVID: c_uint = 0x8720;
pub const IT8721F_DEVID: c_uint = 0x8721;
pub const IT8726F_DEVID: c_uint = 0x8726;
pub const IT8728F_DEVID: c_uint = 0x8728;
pub const IT8732F_DEVID: c_uint = 0x8732;
pub const IT8792E_DEVID: c_uint = 0x8733;
pub const IT8771E_DEVID: c_uint = 0x8771;
pub const IT8772E_DEVID: c_uint = 0x8772;
pub const IT8781F_DEVID: c_uint = 0x8781;
pub const IT8782F_DEVID: c_uint = 0x8782;
pub const IT8783E_DEVID: c_uint = 0x8783;
pub const IT8786E_DEVID: c_uint = 0x8786;
pub const IT8790E_DEVID: c_uint = 0x8790;
pub const IT8603E_DEVID: c_uint = 0x8603;
pub const IT8620E_DEVID: c_uint = 0x8620;
pub const IT8622E_DEVID: c_uint = 0x8622;
pub const IT8623E_DEVID: c_uint = 0x8623;
pub const IT8628E_DEVID: c_uint = 0x8628;
pub const IT8689E_DEVID: c_uint = 0x8689;
pub const IT87952E_DEVID: c_uint = 0x8695;
// Logical device 4 (Environmental Monitor) registers
pub const IT87_ACT_REG: c_uint = 0x30;
pub const IT87_BASE_REG: c_uint = 0x60;
pub const IT87_SPECIAL_CFG_REG: c_uint = 0xf3	/* special configuration register */;
// Logical device 7 registers (IT8712F and later)
pub const IT87_SIO_GPIO1_REG: c_uint = 0x25;
pub const IT87_SIO_GPIO2_REG: c_uint = 0x26;
pub const IT87_SIO_GPIO3_REG: c_uint = 0x27;
pub const IT87_SIO_GPIO4_REG: c_uint = 0x28;
pub const IT87_SIO_GPIO5_REG: c_uint = 0x29;
pub const IT87_SIO_PINX1_REG: c_uint = 0x2a	/* Pin selection */;
pub const IT87_SIO_PINX2_REG: c_uint = 0x2c	/* Pin selection */;
pub const IT87_SIO_SPI_REG: c_uint = 0xef	/* SPI function pin select */;
pub const IT87_SIO_VID_REG: c_uint = 0xfc	/* VID value */;
pub const IT87_SIO_BEEP_PIN_REG: c_uint = 0xf6	/* Beep pin mapping */;
...
pub const IT87_EXTENT: c_int = 8;
// Length of ISA address segment for Environmental Controller
pub const IT87_EC_EXTENT: c_int = 2;
// Offset of EC registers from ISA base address
pub const IT87_EC_OFFSET: c_int = 5;
// Where are the ISA address/data registers relative to the EC base address
pub const IT87_ADDR_REG_OFFSET: c_int = 0;
pub const IT87_DATA_REG_OFFSET: c_int = 1;
// ----- The IT87 registers -----
pub const IT87_REG_CONFIG: c_uint = 0x00;
pub const IT87_REG_ALARM1: c_uint = 0x01;
pub const IT87_REG_ALARM2: c_uint = 0x02;
pub const IT87_REG_ALARM3: c_uint = 0x03;
//
// The IT8718F and IT8720F have the VID value in a different register, in
// Super-I/O configuration space.
//
pub const IT87_REG_VID: c_uint = 0x0a;
// Interface Selection register on other chips
pub const IT87_REG_IFSEL: c_uint = 0x0a;
//
// The IT8705F and IT8712F earlier than revision 0x08 use register 0x0b
// for fan divisors. Later IT8712F revisions must use 16-bit tachometer
// mode.
//
pub const IT87_REG_FAN_DIV: c_uint = 0x0b;
pub const IT87_REG_FAN_16BIT: c_uint = 0x0c;
//
// Monitors:
...
pub const IT87_REG_FAN_MAIN_CTRL: c_uint = 0x13;
pub const IT87_REG_FAN_CTL: c_uint = 0x14;
    static const u8 IT87_REG_PWM[]         = { 0x15, 0x16, 0x17, 0x7f, 0xa7, 0xaf };
    static const u8 IT87_REG_PWM_DUTY[]    = { 0x63, 0x6b, 0x73, 0x7b, 0xa3, 0xab };
    static const u8 IT87_REG_VIN[]	= { 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26,
    0x27, 0x28, 0x2f, 0x2c, 0x2d, 0x2e };

pub const IT87_REG_VIN_ENABLE: c_uint = 0x50;
pub const IT87_REG_TEMP_ENABLE: c_uint = 0x51;
pub const IT87_REG_TEMP_EXTRA: c_uint = 0x55;
pub const IT87_REG_BEEP_ENABLE: c_uint = 0x5c;
pub const IT87_REG_CHIPID: c_uint = 0x58;
    static const u8 IT87_REG_AUTO_BASE[] = { 0x60, 0x68, 0x70, 0x78, 0xa0, 0xa8 };

pub const IT87_REG_TEMP456_ENABLE: c_uint = 0x77;

pub const NUM_VIN_LIMIT: c_int = 8;
pub const NUM_TEMP: c_int = 6;

pub const NUM_TEMP_LIMIT: c_int = 3;

pub const NUM_FAN_DIV: c_int = 3;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct it87_devices {
    pub name: *const c_char,
    pub model: *const *const c_char,
    pub features: u32,
    pub peci_mask: u8,
    pub old_peci_mask: u8,
    pub /: *mut *mut u8 smbus_bitmap; / SMBus enable bits in extra config register,
    pub ec_special_config: u8,
}
...
// Values read from Super-I/O config space
    ...
    pub vid_value: u8,
    pub beep_pin: u8,
    pub /: *mut *mut u8 internal; / Internal sensors can be labeled,
    pub need_in7_reroute: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct it87_data {
    pub groups: [*const attribute_group; 7],
    pub sioaddr: c_int,
    pub type: enum chips,
    pub features: u32,
    pub peci_mask: u8,
    pub old_peci_mask: u8,
    pub /: *mut *mut u8 smbus_bitmap; / !=0 if SMBus needs to be disabled,
    pub /: *mut *mut u8 ec_special_config; / EC special config register restore value,
    pub addr: c_ushort,
    pub name: *const c_char,
    ...
    pub /: *mut *mut u16 in_scaled; / Internal voltage sensors are scaled,
    pub /: *mut *mut u16 in_internal; / Bitfield, internal sensors (for labels),
    pub /: *mut *mut u16 has_in; / Bitfield, voltage sensors enabled,
    pub /: *mut *mut u8 in[NUM_VIN][3]; / [nr][0]=in, [1]=min, [2]=max,
    pub need_in7_reroute: bool,
    pub /: *mut *mut u8 has_fan; / Bitfield, fans enabled,
    pub /: *mut *mut u16 fan[NUM_FAN][2]; / Register values, [nr][0]=fan, [1]=min,
    pub /: *mut *mut u8 has_temp; / Bitfield, temp sensors enabled,
    pub /: *mut *mut s8 temp[NUM_TEMP][4]; / [nr][0]=temp, [1]=min, [2]=max, [3]=offset,
    pub /: *mut *mut u8 sensor; / Register value (IT87_REG_TEMP_ENABLE),
    pub /: *mut *mut u8 extra; / Register value (IT87_REG_TEMP_EXTRA),
    pub /: *mut *mut u8 fan_div[NUM_FAN_DIV];/ Register encoding, shifted right,
    pub /: *mut *mut bool has_vid; / True if VID supported,
    pub /: *mut *mut u8 vid; / Register encoding, combined,
    pub vrm: u8,
    pub /: *mut *mut u32 alarms; / Register encoding, combined,
    pub /: *mut *mut bool has_beep; / true if beep supported,
    pub /: *mut *mut u8 beeps; / Register encoding,
    pub /: *mut *mut u8 fan_main_ctrl; / Register value,
    pub /: *mut *mut u8 fan_ctl; / Register value,
//
...
// simple.
//
    pub /: *mut *mut u8 has_pwm; / Bitfield, pwm control enabled,
    pub /: *mut *mut u8 pwm_ctrl[NUM_PWM]; / Register value,
    pub /: *mut *mut u8 pwm_duty[NUM_PWM]; / Manual PWM value set by user,
    pub /: *mut *mut u8 pwm_temp_map[NUM_PWM];/ PWM to temp. chan. mapping (bits 1-0),
// Automatic fan speed control registers
    pub /: *mut *mut u8 auto_pwm[NUM_AUTO_PWM][4]; / [nr][3] is hard-coded,
    pub /: *mut *mut s8 auto_temp[NUM_AUTO_PWM][5]; / [nr][0] is point1_temp_hyst,
}

// Board specific settings from DMI matching
#[repr(C)]
#[derive(Copy, Clone)]
pub struct it87_dmi_data {
    pub /: *mut *mut u8 skip_pwm; / pwm channels to skip for this board,
}

// Global for results from DMI matching, if needed
    static struct it87_dmi_data *dmi_data;
#[no_mangle]
unsafe extern "C" fn adc_lsb(data: *const it87_data, nr: c_int) -> c_int {
    ...
    lsb = 120;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_10_9mv_adc(data)) -> else {
...
#[no_mangle]
unsafe extern "C" fn in_to_reg(data: *const it87_data, nr: c_int, val: c_long) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn in_from_reg(data: *const it87_data, nr: c_int, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn FAN16_TO_REG(rpm: c_long) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn pwm_to_reg(data: *const it87_data, val: c_long) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn pwm_from_reg(data: *const it87_data, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn DIV_TO_REG(val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbus_disable(data: *mut it87_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbus_enable(data: *mut it87_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn it87_read_value(data: *mut it87_data, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn it87_write_value(data: *mut it87_data, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn it87_update_pwm_ctrl(data: *mut it87_data, nr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn it87_lock(data: *mut it87_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it87_unlock(data: *mut it87_data) {
...
//
    ...
    static SENSOR_DEVICE_ATTR_2(in0_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 0);
    static SENSOR_DEVICE_ATTR_2(in0_min, S_IRUGO | S_IWUSR, show_in, set_in,
    0, 1);
    static SENSOR_DEVICE_ATTR_2(in0_max, S_IRUGO | S_IWUSR, show_in, set_in,
    0, 2);
    static SENSOR_DEVICE_ATTR_2(in1_input, S_IRUGO, show_in, core::ptr::null_mut(), 1, 0);
    static SENSOR_DEVICE_ATTR_2(in1_min, S_IRUGO | S_IWUSR, show_in, set_in,
    1, 1);
    static SENSOR_DEVICE_ATTR_2(in1_max, S_IRUGO | S_IWUSR, show_in, set_in,
    1, 2);
    static SENSOR_DEVICE_ATTR_2(in2_input, S_IRUGO, show_in, core::ptr::null_mut(), 2, 0);
    static SENSOR_DEVICE_ATTR_2(in2_min, S_IRUGO | S_IWUSR, show_in, set_in,
    2, 1);
    static SENSOR_DEVICE_ATTR_2(in2_max, S_IRUGO | S_IWUSR, show_in, set_in,
    2, 2);
    static SENSOR_DEVICE_ATTR_2(in3_input, S_IRUGO, show_in, core::ptr::null_mut(), 3, 0);
    static SENSOR_DEVICE_ATTR_2(in3_min, S_IRUGO | S_IWUSR, show_in, set_in,
    3, 1);
    static SENSOR_DEVICE_ATTR_2(in3_max, S_IRUGO | S_IWUSR, show_in, set_in,
    3, 2);
    static SENSOR_DEVICE_ATTR_2(in4_input, S_IRUGO, show_in, core::ptr::null_mut(), 4, 0);
    static SENSOR_DEVICE_ATTR_2(in4_min, S_IRUGO | S_IWUSR, show_in, set_in,
    4, 1);
    static SENSOR_DEVICE_ATTR_2(in4_max, S_IRUGO | S_IWUSR, show_in, set_in,
    4, 2);
    static SENSOR_DEVICE_ATTR_2(in5_input, S_IRUGO, show_in, core::ptr::null_mut(), 5, 0);
    static SENSOR_DEVICE_ATTR_2(in5_min, S_IRUGO | S_IWUSR, show_in, set_in,
    5, 1);
    static SENSOR_DEVICE_ATTR_2(in5_max, S_IRUGO | S_IWUSR, show_in, set_in,
    5, 2);
    static SENSOR_DEVICE_ATTR_2(in6_input, S_IRUGO, show_in, core::ptr::null_mut(), 6, 0);
    static SENSOR_DEVICE_ATTR_2(in6_min, S_IRUGO | S_IWUSR, show_in, set_in,
    6, 1);
    static SENSOR_DEVICE_ATTR_2(in6_max, S_IRUGO | S_IWUSR, show_in, set_in,
    6, 2);
    static SENSOR_DEVICE_ATTR_2(in7_input, S_IRUGO, show_in, core::ptr::null_mut(), 7, 0);
    static SENSOR_DEVICE_ATTR_2(in7_min, S_IRUGO | S_IWUSR, show_in, set_in,
    7, 1);
    static SENSOR_DEVICE_ATTR_2(in7_max, S_IRUGO | S_IWUSR, show_in, set_in,
    7, 2);
    static SENSOR_DEVICE_ATTR_2(in8_input, S_IRUGO, show_in, core::ptr::null_mut(), 8, 0);
    static SENSOR_DEVICE_ATTR_2(in9_input, S_IRUGO, show_in, core::ptr::null_mut(), 9, 0);
    static SENSOR_DEVICE_ATTR_2(in10_input, S_IRUGO, show_in, core::ptr::null_mut(), 10, 0);
    static SENSOR_DEVICE_ATTR_2(in11_input, S_IRUGO, show_in, core::ptr::null_mut(), 11, 0);
    static SENSOR_DEVICE_ATTR_2(in12_input, S_IRUGO, show_in, core::ptr::null_mut(), 12, 0);
// Up to 6 temperatures
    ...
    static SENSOR_DEVICE_ATTR_2(temp1_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 0);
    ...
    set_temp, 0, 3);
    static SENSOR_DEVICE_ATTR_2(temp2_input, S_IRUGO, show_temp, core::ptr::null_mut(), 1, 0);
    ...
    set_temp, 1, 3);
    static SENSOR_DEVICE_ATTR_2(temp3_input, S_IRUGO, show_temp, core::ptr::null_mut(), 2, 0);
    ...
    set_temp, 2, 3);
    static SENSOR_DEVICE_ATTR_2(temp4_input, S_IRUGO, show_temp, core::ptr::null_mut(), 3, 0);
    static SENSOR_DEVICE_ATTR_2(temp5_input, S_IRUGO, show_temp, core::ptr::null_mut(), 4, 0);
    static SENSOR_DEVICE_ATTR_2(temp6_input, S_IRUGO, show_temp, core::ptr::null_mut(), 5, 0);
#[no_mangle]
unsafe extern "C" fn get_temp_type(data: *mut it87_data, index: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT(index): reg &) -> else {
    else if (reg & BIT(index))
    type = 3;	/* thermal diode */
#[no_mangle]
pub unsafe extern "C" fn if(3): reg & BIT(index +) -> else {
    ...
    {
    struct sensor_device_attribute *sensor_attr = to_sensor_dev_attr(attr);
    let mut nr: c_int = sensor_attr.index;
    struct it87_data *data = dev_get_drvdata(dev);
    long val;
    u8 reg, extra;
    int err;
...
pub unsafe extern "C" fn if(4: val ==) -> else {
    ...
    reg |= 8 << nr;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_temp_peci(data, 6: nr) && val ==) -> else {
    else if (has_temp_peci(data, nr) && val == 6)
    reg |= (nr + 1) << 6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_temp_old_peci(data, 6: nr) && val ==) -> else {
...
// 6 Fans
#[no_mangle]
unsafe extern "C" fn pwm_mode(data: *const it87_data, nr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_trip_points(dev: *mut device, nr: c_int) -> c_int {
...
//
    ...
    let mut nr: c_int = sensor_attr.nr;
    let mut point: c_int = sensor_attr.index;
    if (IS_ERR(data))
    return PTR_ERR(data);
    return sprintf(buf, "%d\n",
    ...
    static SENSOR_DEVICE_ATTR_2(fan1_input, S_IRUGO, show_fan, core::ptr::null_mut(), 0, 0);
    static SENSOR_DEVICE_ATTR_2(fan1_min, S_IRUGO | S_IWUSR, show_fan, set_fan,
    0, 1);
    static SENSOR_DEVICE_ATTR(fan1_div, S_IRUGO | S_IWUSR, show_fan_div,
    set_fan_div, 0);
    static SENSOR_DEVICE_ATTR_2(fan2_input, S_IRUGO, show_fan, core::ptr::null_mut(), 1, 0);
    static SENSOR_DEVICE_ATTR_2(fan2_min, S_IRUGO | S_IWUSR, show_fan, set_fan,
    1, 1);
    static SENSOR_DEVICE_ATTR(fan2_div, S_IRUGO | S_IWUSR, show_fan_div,
    set_fan_div, 1);
    static SENSOR_DEVICE_ATTR_2(fan3_input, S_IRUGO, show_fan, core::ptr::null_mut(), 2, 0);
    static SENSOR_DEVICE_ATTR_2(fan3_min, S_IRUGO | S_IWUSR, show_fan, set_fan,
    2, 1);
    static SENSOR_DEVICE_ATTR(fan3_div, S_IRUGO | S_IWUSR, show_fan_div,
    set_fan_div, 2);
    static SENSOR_DEVICE_ATTR_2(fan4_input, S_IRUGO, show_fan, core::ptr::null_mut(), 3, 0);
    static SENSOR_DEVICE_ATTR_2(fan4_min, S_IRUGO | S_IWUSR, show_fan, set_fan,
    3, 1);
    static SENSOR_DEVICE_ATTR_2(fan5_input, S_IRUGO, show_fan, core::ptr::null_mut(), 4, 0);
    static SENSOR_DEVICE_ATTR_2(fan5_min, S_IRUGO | S_IWUSR, show_fan, set_fan,
    4, 1);
    static SENSOR_DEVICE_ATTR_2(fan6_input, S_IRUGO, show_fan, core::ptr::null_mut(), 5, 0);
    ...
    show_auto_pwm, core::ptr::null_mut(), 0, 3);
    ...
    show_auto_pwm, core::ptr::null_mut(), 1, 3);
    ...
    static SENSOR_DEVICE_ATTR(pwm3_freq, S_IRUGO, show_pwm_freq, core::ptr::null_mut(), 2);
    ...
    show_auto_pwm, core::ptr::null_mut(), 2, 3);
    ...
    static SENSOR_DEVICE_ATTR(pwm4_freq, S_IRUGO, show_pwm_freq, core::ptr::null_mut(), 3);
    ...
    static SENSOR_DEVICE_ATTR(pwm5_freq, S_IRUGO, show_pwm_freq, core::ptr::null_mut(), 4);
    ...
    static SENSOR_DEVICE_ATTR(pwm6_freq, S_IRUGO, show_pwm_freq, core::ptr::null_mut(), 5);
...
// Invalidate cache to force re-read
    ...
    static SENSOR_DEVICE_ATTR(in0_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 8);
    static SENSOR_DEVICE_ATTR(in1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 9);
    static SENSOR_DEVICE_ATTR(in2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 10);
    static SENSOR_DEVICE_ATTR(in3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 11);
    static SENSOR_DEVICE_ATTR(in4_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 12);
    static SENSOR_DEVICE_ATTR(in5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 13);
    static SENSOR_DEVICE_ATTR(in6_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 14);
    static SENSOR_DEVICE_ATTR(in7_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 15);
    static SENSOR_DEVICE_ATTR(fan1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 0);
    static SENSOR_DEVICE_ATTR(fan2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(fan3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 2);
    static SENSOR_DEVICE_ATTR(fan4_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 3);
    static SENSOR_DEVICE_ATTR(fan5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 6);
    static SENSOR_DEVICE_ATTR(fan6_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 7);
    static SENSOR_DEVICE_ATTR(temp1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 16);
    static SENSOR_DEVICE_ATTR(temp2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 17);
    static SENSOR_DEVICE_ATTR(temp3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 18);
    ...
    static SENSOR_DEVICE_ATTR(in1_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(in2_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(in3_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(in4_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(in5_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(in6_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(in7_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 1);
// fanX_beep writability is set later
    ...
    static SENSOR_DEVICE_ATTR(temp2_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 2);
    static SENSOR_DEVICE_ATTR(temp3_beep, S_IRUGO, show_beep, core::ptr::null_mut(), 2);
    ...
    label = labels[0];
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_scaling(data)) -> else {
    ...
    static SENSOR_DEVICE_ATTR(in3_label, S_IRUGO, show_label, core::ptr::null_mut(), 0);
    static SENSOR_DEVICE_ATTR(in7_label, S_IRUGO, show_label, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(in8_label, S_IRUGO, show_label, core::ptr::null_mut(), 2);
// AVCC3
    static SENSOR_DEVICE_ATTR(in9_label, S_IRUGO, show_label, core::ptr::null_mut(), 3);
...
// SuperIO detection - will change isa_address if a chip is found
    ...
    int err;
    u16 chip_type;
    const struct it87_devices *config = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !has_five_pwm(config)) -> else {
    else if (!has_five_pwm(config))
    sio_data.skip_pwm |= BIT(4) | BIT(5);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !has_six_pwm(config)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn it87_check_limit_regs(data: *mut it87_data) {
...
#[no_mangle]
unsafe extern "C" fn it87_check_voltage_monitors_reset(data: *mut it87_data) {
...
#[no_mangle]
unsafe extern "C" fn it87_check_tachometers_reset(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn it87_check_tachometers_16bit_mode(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn it87_start_monitoring(data: *mut it87_data) {
...
#[no_mangle]
unsafe extern "C" fn it87_init_device(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn it87_check_pwm(dev: *mut device) -> c_int {
...
//
    let mut tmp: c_int = it87_read_value(data, IT87_REG_FAN_CTL);
    if ((tmp & 0x87) == 0) {
    if (fix_pwm_polarity) {
//
...
#[no_mangle]
unsafe extern "C" fn it87_probe(pdev: *mut platform_device) -> c_int {
...
// Starting with IT8721F, we handle scaling of internal voltages
    ...
    let mut reg: u8 = it87_read_value(data, IT87_REG_TEMP456_ENABLE);
...
#[no_mangle]
unsafe extern "C" fn it87_resume_sio(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn it87_resume(dev: *mut device) -> c_int {
...
// force update
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(it87_dev_pm_ops, core::ptr::null_mut(), it87_resume);
...
#[no_mangle]
unsafe extern "C" fn it87_dmi_cb(dmi_entry: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm_it87_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sm_it87_exit() -> void __exit {
