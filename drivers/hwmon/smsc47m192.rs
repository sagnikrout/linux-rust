...
//! Source: drivers/hwmon/smsc47m192.c
#![no_std]
...
pub const SMSC47M192_REG_ALARM1: c_uint = 0x41;
pub const SMSC47M192_REG_ALARM2: c_uint = 0x42;
pub const SMSC47M192_REG_VID: c_uint = 0x47;
pub const SMSC47M192_REG_VID4: c_uint = 0x49;
pub const SMSC47M192_REG_CONFIG: c_uint = 0x40;
pub const SMSC47M192_REG_SFR: c_uint = 0x4f;
pub const SMSC47M192_REG_COMPANY_ID: c_uint = 0x3e;
pub const SMSC47M192_REG_VERSION: c_uint = 0x3f;
...
pub struct smsc47m192_data {
    ...
    || !data.valid) {
    let mut sfr: u8 = i2c_smbus_read_byte_data(client, SMSC47M192_REG_SFR);
...
#[no_mangle]
pub unsafe extern "C" fn if(0: data->temp_offset[nr] !=) -> else {
//
...
#[no_mangle]
unsafe extern "C" fn smsc47m192_init_client(client: *mut i2c_client) {
    static void smsc47m192_init_client(struct i2c_client *client)
    {
    int i;
    let mut config: u8 = i2c_smbus_read_byte_data(client, SMSC47M192_REG_CONFIG);
    let mut sfr: u8 = i2c_smbus_read_byte_data(client, SMSC47M192_REG_SFR);
...
#[no_mangle]
unsafe extern "C" fn smsc47m192_probe(client: *mut i2c_client) -> c_int {
