...
//! Source: drivers/hwmon/npcm750-pwm-fan.c
#![no_std]
...
pub const NPCM7XX_PWM_MAX_CHN_NUM: c_int = 12;
pub const NPCM7XX_PWM_MAX_CHN_NUM_IN_A_MODULE: c_int = 4;
pub const NPCM7XX_PWM_MAX_MODULES: c_int = 3;
// Define the Counter Register, value = 100 for match 100%
pub const NPCM7XX_PWM_COUNTER_DEFAULT_NUM: c_int = 255;
pub const NPCM7XX_PWM_CMR_DEFAULT_NUM: c_int = 255;
pub const NPCM7XX_PWM_CMR_MAX: c_int = 255;
// default all PWM channels PRESCALE2 = 1
pub const NPCM7XX_PWM_PRESCALE2_DEFAULT_CH0: c_uint = 0x4;
pub const NPCM7XX_PWM_PRESCALE2_DEFAULT_CH1: c_uint = 0x40;
pub const NPCM7XX_PWM_PRESCALE2_DEFAULT_CH2: c_uint = 0x400;
pub const NPCM7XX_PWM_PRESCALE2_DEFAULT_CH3: c_uint = 0x4000;
pub const PWM_OUTPUT_FREQ_25KHZ: c_int = 25000;
pub const PWN_CNT_DEFAULT: c_int = 256;
pub const MIN_PRESCALE1: c_int = 2;
pub const NPCM7XX_PWM_PRESCALE_SHIFT_CH01: c_int = 8;
...
pub const NPCM7XX_FAN_TCKC_CLKX_NONE: c_int = 0;

// FAN General Definition
// Define the maximum FAN channel number
pub const NPCM7XX_FAN_MAX_MODULE: c_int = 8;
pub const NPCM7XX_FAN_MAX_CHN_NUM_IN_A_MODULE: c_int = 2;
pub const NPCM7XX_FAN_MAX_CHN_NUM: c_int = 16;
//
...
//
pub const NPCM7XX_FAN_TIMEOUT: c_uint = 0x5000;
pub const NPCM7XX_FAN_TCNT: c_uint = 0xFFFF;

pub const NPCM7XX_FAN_POLL_TIMER_200MS: c_int = 200;
pub const NPCM7XX_FAN_DEFAULT_PULSE_PER_REVOLUTION: c_int = 2;
pub const NPCM7XX_FAN_TINASEL_FANIN_DEFAULT: c_int = 0;
pub const NPCM7XX_FAN_CLK_PRESCALE: c_int = 255;
pub const NPCM7XX_FAN_CMPA: c_int = 0;
pub const NPCM7XX_FAN_CMPB: c_int = 1;
// Obtain the fan number

// fan sample status
pub const FAN_DISABLE: c_uint = 0xFF;
pub const FAN_INIT: c_uint = 0x00;
pub const FAN_PREPARE_TO_GET_FIRST_CAPTURE: c_uint = 0x01;
pub const FAN_ENOUGH_SAMPLE: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm_hwmon_info {
    pub pwm_max_channel: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_fan_dev {
    pub fan_st_flg: u8,
    pub fan_pls_per_rev: u8,
    pub fan_cnt: u16,
    pub fan_cnt_tmp: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_cooling_device {
    pub name: [c_char; THERMAL_NAME_LENGTH],
    pub data: *mut npcm7xx_pwm_fan_data,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_pwm_fan_data {
    pub pwm_base: *mut void __iomem,
    pub fan_base: *mut void __iomem,
    pub pwm_modules: c_int,
    pub pwm_clk: *mut clk,
    pub fan_clk: *mut clk,
    pub fan_lock: [spinlock_t; NPCM7XX_FAN_MAX_MODULE],
    pub fan_irq: [c_int; NPCM7XX_FAN_MAX_MODULE],
    pub pwm_present: [bool; NPCM7XX_PWM_MAX_CHN_NUM],
    pub fan_present: [bool; NPCM7XX_FAN_MAX_CHN_NUM],
    pub input_clk_freq: u32,
    pub fan_timer: timer_list,
    pub fan_dev: [npcm7xx_fan_dev; NPCM7XX_FAN_MAX_CHN_NUM],
    pub cdev: [*mut npcm7xx_cooling_device; NPCM7XX_PWM_MAX_CHN_NUM],
    pub info: *const npcm_hwmon_info,
    pub fan_select: u8,
}
    ...
    int channel, u16 val)
    {
    let mut pwm_ch: u32 = (channel % NPCM7XX_PWM_MAX_CHN_NUM_IN_A_MODULE);
    let mut module: u32 = (channel / NPCM7XX_PWM_MAX_CHN_NUM_IN_A_MODULE);
...
//
#[no_mangle]
unsafe extern "C" fn npcm7xx_fan_polling(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_fan_cleanup(timer: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_fan_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    let mut pmw_ch: u32 = (channel % NPCM7XX_PWM_MAX_CHN_NUM_IN_A_MODULE);
    let mut module: u32 = (channel / NPCM7XX_PWM_MAX_CHN_NUM_IN_A_MODULE);
    switch (attr) {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_pwm_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_fan_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_pwm_init(data: *mut npcm7xx_pwm_fan_data) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_fan_init(data: *mut npcm7xx_pwm_fan_data) {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_pwm_fan_probe(pdev: *mut platform_device) -> c_int {
