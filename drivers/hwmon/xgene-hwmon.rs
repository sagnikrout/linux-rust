...
//! Source: drivers/hwmon/xgene-hwmon.c
#![no_std]
...
pub const MSG_TYPE_DBG: c_int = 0;
pub const MSG_TYPE_ERR: c_int = 7;
pub const MSG_TYPE_PWRMGMT: c_int = 9;

pub const DBG_SUBTYPE_SENSOR_READ: c_int = 4;
pub const SENSOR_RD_MSG: c_uint = 0x04FFE902;

pub const PMD_PWR_REG: c_uint = 0x20;
pub const PMD_PWR_MW_REG: c_uint = 0x26;
pub const SOC_PWR_REG: c_uint = 0x21;
pub const SOC_PWR_MW_REG: c_uint = 0x27;
pub const SOC_TEMP_REG: c_uint = 0x10;
pub const TEMP_NEGATIVE_BIT: c_int = 8;

pub const PWRMGMT_SUBTYPE_TPC: c_int = 1;
pub const TPC_ALARM: c_int = 2;
pub const TPC_GET_ALARM: c_int = 3;
...
// to PCC commands
//
pub const PCC_NUM_RETRIES: c_int = 500;
pub const ASYNC_MSG_FIFO_SIZE: c_int = 16;
pub const MBOX_OP_TIMEOUTMS: c_int = 1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_hwmon_dev {
    pub dev: *mut device,
    pub mbox_chan: *mut mbox_chan,
    pub pcc_chan: *mut pcc_mbox_chan,
    pub mbox_client: mbox_client,
    pub mbox_idx: c_int,
    pub kfifo_lock: spinlock_t,
    pub rd_mutex: mutex,
    pub rd_complete: completion,
    pub resp_pending: c_int,
    pub sync_msg: slimpro_resp_msg,
    pub workq: work_struct,
    pub async_msg_fifo: kfifo_rec_ptr_1,
    pub hwmon_dev: *mut device,
    pub temp_critical_alarm: bool,
    pub usecs_lat: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_pcc_rd(ctx: *mut xgene_hwmon_dev, msg: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_rd(ctx: *mut xgene_hwmon_dev, msg: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_get_cpu_pwr(ctx: *mut xgene_hwmon_dev, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_get_io_pwr(ctx: *mut xgene_hwmon_dev, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_get_temp(ctx: *mut xgene_hwmon_dev, val: *mut u32) -> c_int {
...
//
    ...
    sysfs_notify(&ctx.dev.kobj, core::ptr::null_mut(), "temp1_critical_alarm");
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_evt_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_rx_ready(ctx: *mut xgene_hwmon_dev, msg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_rx_cb(cl: *mut mbox_client, msg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_pcc_rx_cb(cl: *mut mbox_client, msg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_tx_done(cl: *mut mbox_client, msg: *mut c_void, ret: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_hwmon_remove(pdev: *mut platform_device) {
