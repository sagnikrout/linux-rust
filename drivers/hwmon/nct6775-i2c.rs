...
//! Source: drivers/hwmon/nct6775-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nct6775_i2c_read(ctx: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nct6775_i2c_write(ctx: *mut c_void, reg: c_uint, value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6775_i2c_probe_init(data: *mut nct6775_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6775_i2c_probe(client: *mut i2c_client) -> c_int {
