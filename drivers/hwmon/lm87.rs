...
pub const LM87_REG_AOUT: c_uint = 0x19;
pub const LM87_REG_CONFIG: c_uint = 0x40;
pub const LM87_REG_CHANNEL_MODE: c_uint = 0x16;
pub const LM87_REG_VID_FAN_DIV: c_uint = 0x47;
pub const LM87_REG_VID4: c_uint = 0x49;
pub const LM87_REG_ALARMS1: c_uint = 0x41;
pub const LM87_REG_ALARMS2: c_uint = 0x42;
pub const LM87_REG_COMPANY_ID: c_uint = 0x3E;
pub const LM87_REG_REVISION: c_uint = 0x3F;
//
...
//
    ...
    (val) + 500) / 1000))
#[no_mangle]
unsafe extern "C" fn fan_from_reg(reg: c_int, div: c_int) -> c_int {
...
pub struct lm87_data {
    ...
    pub /: *mut *mut u8 channel; / register value,
    pub /: *mut *mut u8 config; / original register value,
    ...
    pub /: *mut *mut s8 temp_high[3]; / register value,
    pub /: *mut *mut s8 temp_low[3]; / register value,
    pub /: *mut *mut s8 temp_crit_int; / min of two register values,
    pub /: *mut *mut s8 temp_crit_ext; / min of two register values,
    pub /: *mut *mut u8 fan[2]; / register value,
    pub /: *mut *mut u8 fan_min[2]; / register value,
    pub /: *mut *mut u8 fan_div[2]; / register value, shifted right,
    pub /: *mut *mut u8 aout; / register value,
    pub /: *mut *mut u16 alarms; / register values, combined,
    pub /: *mut *mut u8 vid; / register values, combined,
    pub vrm: u8,
    pub attr_groups: [*const attribute_group; 6],
}

#[no_mangle]
pub unsafe extern "C" fn lm87_read_value(client: *mut i2c_client, reg: u8) -> c_int {
    static inline int lm87_read_value(struct i2c_client *client, u8 reg)
    {
    return i2c_smbus_read_byte_data(client, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn lm87_write_value(client: *mut i2c_client, reg: u8, value: u8) -> c_int {
...
//
    ...
    static DEVICE_ATTR(temp3_crit, 0444, temp2_crit_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn lm87_detect(client: *mut i2c_client, info: *mut i2c_board_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm87_restore_config(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lm87_init_client(client: *mut i2c_client) -> c_int {
    ...
    let mut val: u8 = 0;
    struct regulator *vcc = core::ptr::null_mut();
    if (of_node) {
...
#[no_mangle]
unsafe extern "C" fn lm87_probe(client: *mut i2c_client) -> c_int {
    static int lm87_probe(struct i2c_client *client)
    {
    struct lm87_data *data;
    struct device *hwmon_dev;
    int err;
    let mut group_tail: c_uint = 0;
