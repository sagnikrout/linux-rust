...
// AD7418 registers
pub const AD7418_REG_TEMP_IN: c_uint = 0x00;
pub const AD7418_REG_CONF: c_uint = 0x01;
pub const AD7418_REG_TEMP_HYST: c_uint = 0x02;
pub const AD7418_REG_TEMP_OS: c_uint = 0x03;
pub const AD7418_REG_ADC: c_uint = 0x04;
pub const AD7418_REG_CONF2: c_uint = 0x05;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7418_data {
    pub client: *mut i2c_client,
    pub type: enum chips,
    pub lock: mutex,
    pub /: *mut *mut int adc_max; / number of ADC channels,
    pub valid: bool,
    pub /: *mut *mut unsigned long last_updated; / In jiffies,
    pub /: *mut *mut s16 temp[3]; / Register values,
    pub in: [u16; 4],
}

#[no_mangle]
unsafe extern "C" fn ad7418_update_device(dev: *mut device) -> c_int {
...
// restore old configuration value
    ...
    struct i2c_client *client = data.client;
    long temp;
    let mut ret: c_int = kstrtol(buf, 10, &temp);
    if (ret < 0)
    return ret;
    mutex_lock(&data.lock);
...
#[no_mangle]
unsafe extern "C" fn ad7418_init_client(client: *mut i2c_client) {
    static void ad7418_init_client(struct i2c_client *client)
    {
    struct ad7418_data *data = i2c_get_clientdata(client);
    let mut reg: c_int = i2c_smbus_read_byte_data(client, AD7418_REG_CONF);
    if (reg < 0) {
...
#[no_mangle]
unsafe extern "C" fn ad7418_probe(client: *mut i2c_client) -> c_int {
    ...
    const struct attribute_group **attr_groups = core::ptr::null_mut();
