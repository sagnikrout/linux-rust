...
//! Source: drivers/hwmon/gl518sm.c
#![no_std]
...
// The GL518 registers
pub const GL518_REG_CHIP_ID: c_uint = 0x00;
pub const GL518_REG_REVISION: c_uint = 0x01;
pub const GL518_REG_VENDOR_ID: c_uint = 0x02;
pub const GL518_REG_CONF: c_uint = 0x03;
pub const GL518_REG_TEMP_IN: c_uint = 0x04;
pub const GL518_REG_TEMP_MAX: c_uint = 0x05;
pub const GL518_REG_TEMP_HYST: c_uint = 0x06;
pub const GL518_REG_FAN_COUNT: c_uint = 0x07;
pub const GL518_REG_FAN_LIMIT: c_uint = 0x08;
pub const GL518_REG_VIN1_LIMIT: c_uint = 0x09;
pub const GL518_REG_VIN2_LIMIT: c_uint = 0x0a;
pub const GL518_REG_VIN3_LIMIT: c_uint = 0x0b;
pub const GL518_REG_VDD_LIMIT: c_uint = 0x0c;
pub const GL518_REG_VIN3: c_uint = 0x0d;
pub const GL518_REG_MISC: c_uint = 0x0f;
pub const GL518_REG_ALARM: c_uint = 0x10;
pub const GL518_REG_MASK: c_uint = 0x11;
pub const GL518_REG_INT: c_uint = 0x12;
pub const GL518_REG_VIN2: c_uint = 0x13;
pub const GL518_REG_VIN1: c_uint = 0x14;
pub const GL518_REG_VDD: c_uint = 0x15;
//
...
pub struct gl518_data {
    ...
    pub /: *mut *mut u8 voltage_in[4]; / Register values; [0] = VDD,
    pub /: *mut *mut u8 voltage_min[4]; / Register values; [0] = VDD,
    pub /: *mut *mut u8 voltage_max[4]; / Register values; [0] = VDD,
    pub fan_in: [u8; 2],
    pub fan_min: [u8; 2],
    pub /: *mut *mut u8 fan_div[2]; / Register encoding, shifted right,
    pub /: *mut *mut u8 fan_auto1; / Boolean,
    pub /: *mut *mut u8 temp_in; / Register values,
    pub /: *mut *mut u8 temp_max; / Register values,
    pub /: *mut *mut u8 temp_hyst; / Register values,
    pub /: *mut *mut u8 alarms; / Register value,
    pub alarm_mask: u8,
    pub /: *mut *mut u8 beep_mask; / Register value,
    pub /: *mut *mut u8 beep_enable; / Boolean,
}
...
//
#[no_mangle]
unsafe extern "C" fn gl518_read_value(client: *mut i2c_client, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl518_write_value(client: *mut i2c_client, reg: u8, value: u16) -> c_int {
...
//
    ...
    static DEVICE_ATTR(temp1_input, 0444, show_temp_input1, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(in0_input, 0444, show_in_input0, core::ptr::null_mut());
    static DEVICE_ATTR(in1_input, 0444, show_in_input1, core::ptr::null_mut());
    static DEVICE_ATTR(in2_input, 0444, show_in_input2, core::ptr::null_mut());
    static DEVICE_ATTR(in3_input, 0444, show_in_input3, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(alarms, 0444, show_alarms, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gl518_detect(client: *mut i2c_client, info: *mut i2c_board_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gl518_init_client(client: *mut i2c_client) {
    static void gl518_init_client(struct i2c_client *client)
    {
// Make sure we leave D7:Reset untouched
    let mut regvalue: u8 = gl518_read_value(client, GL518_REG_CONF) & 0x7f;
...
#[no_mangle]
unsafe extern "C" fn gl518_probe(client: *mut i2c_client) -> c_int {
