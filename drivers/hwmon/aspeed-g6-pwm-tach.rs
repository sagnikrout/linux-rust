...
//! Source: drivers/hwmon/aspeed-g6-pwm-tach.c
#![no_std]
...
pub const PWM_ASPEED_NR_PWMS: c_int = 16;
...
pub const TACH_ASPEED_NR_TACHS: c_int = 16;
// TACH Control Register

pub const TACH_ASPEED_DEBOUNCE_BIT: c_int = 26;

pub const TACH_ASPEED_IO_EDGE_BIT: c_int = 24;

pub const TACH_ASPEED_CLK_DIV_BIT: c_int = 20;

// [27:26]
pub const DEBOUNCE_3_CLK: c_uint = 0x00;
pub const DEBOUNCE_2_CLK: c_uint = 0x01;
pub const DEBOUNCE_1_CLK: c_uint = 0x02;
pub const DEBOUNCE_0_CLK: c_uint = 0x03;
// [25:24]
pub const F2F_EDGES: c_uint = 0x00;
pub const R2R_EDGES: c_uint = 0x01;
pub const BOTH_EDGES: c_uint = 0x02;
// [23:20]
// divisor = 4 to the nth power, n = register value
pub const DEFAULT_TACH_DIV: c_int = 1024;
...
// Software setting
//
pub const DEFAULT_FAN_PULSE_PR: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_pwm_tach_data {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub reset: *mut reset_control,
    pub clk_rate: c_ulong,
    pub tach_present: [bool; TACH_ASPEED_NR_TACHS],
    pub tach_divisor: u32,
}
...
//
    ...
    {
    struct aspeed_pwm_tach_data *priv = aspeed_pwm_chip_to_data(chip);
    let mut hwpwm: u32 = pwm.hwpwm, duty_pt, val;
...
#[no_mangle]
unsafe extern "C" fn aspeed_tach_val_to_rpm(priv: *mut aspeed_pwm_tach_data, tach_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_present_fan_tach(priv: *mut aspeed_pwm_tach_data, tach_ch: *mut u8, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_pwm_tach_reset_assert(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_pwm_tach_probe(pdev: *mut platform_device) -> c_int {
    ...
    &aspeed_tach_chip_info, core::ptr::null_mut());
