...
//! Source: drivers/hwmon/prom21-xhci.c
#![no_std]
...
pub const PROM21_XHCI_INDEX_OFFSET: c_uint = 0x3000;
pub const PROM21_XHCI_DATA_OFFSET: c_uint = 0x3008;
pub const PROM21_XHCI_TEMP_SELECTOR: c_uint = 0x0001e520;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prom21_xhci {
...
#[no_mangle]
unsafe extern "C" fn prom21_xhci_pm_get(hwmon: *mut prom21_xhci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prom21_xhci_raw_to_millicelsius(raw: u8) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn prom21_xhci_remove(auxdev: *mut auxiliary_device) {
