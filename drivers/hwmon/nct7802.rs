...
//! Source: drivers/hwmon/nct7802.c
#![no_std]
...
pub const REG_BANK: c_uint = 0x00;
pub const REG_TEMP_LSB: c_uint = 0x05;
pub const REG_TEMP_PECI_LSB: c_uint = 0x08;
pub const REG_VOLTAGE_LOW: c_uint = 0x0f;
pub const REG_FANCOUNT_LOW: c_uint = 0x13;
pub const REG_START: c_uint = 0x21;
pub const REG_MODE: c_uint = 0x22 /* 7.2.32 Mode Selection Register */;
pub const REG_PECI_ENABLE: c_uint = 0x23;
pub const REG_FAN_ENABLE: c_uint = 0x24;
pub const REG_VMON_ENABLE: c_uint = 0x25;

pub const REG_SMARTFAN_STEP_UP_TIME: c_uint = 0x6e;
pub const REG_SMARTFAN_STEP_DOWN_TIME: c_uint = 0x6f;
pub const REG_VENDOR_ID: c_uint = 0xfd;
pub const REG_CHIP_ID: c_uint = 0xfe;
pub const REG_VERSION_ID: c_uint = 0xff;
//
// Resistance temperature detector (RTD) modes according to 7.2.32 Mode
// Selection Register
//
pub const RTD_MODE_CURRENT: c_uint = 0x1;
pub const RTD_MODE_THERMISTOR: c_uint = 0x2;
pub const RTD_MODE_VOLTAGE: c_uint = 0x3;
pub const MODE_RTD_MASK: c_uint = 0x3;
pub const MODE_LTD_EN: c_uint = 0x40;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nct7802_data {
    pub regmap: *mut regmap,
    pub /: *mut *mut mutex access_lock; / for multi-byte read and write operations,
    pub in_status: u8,
    pub in_alarm_lock: mutex,
}
...
#[no_mangle]
unsafe extern "C" fn nct7802_read_fan(data: *mut nct7802_data, reg_fan: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct7802_read_voltage(data: *mut nct7802_data, nr: c_int, index: c_int) -> c_int {
    ...
    let mut shift: c_int = 8 - REG_VOLTAGE_LIMIT_MSB_SHIFT[index - 1][nr];
...
#[no_mangle]
unsafe extern "C" fn nct7802_regmap_is_volatile(dev: *mut device, reg: c_uint) -> bool {
...
// RTD3 only supports thermistor mode
    ...
    md = RTD_MODE_CURRENT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(md_str, _arg: "thermistor")) -> else {
...
// Enable local temperature sensor by default
    let mut mode_mask: u8 = MODE_LTD_EN, mode_val = MODE_LTD_EN;
    int err;
    if (dev.of_node) {
...
#[no_mangle]
unsafe extern "C" fn nct7802_init_chip(dev: *mut device, data: *mut nct7802_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct7802_probe(client: *mut i2c_client) -> c_int {
