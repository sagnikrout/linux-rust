...
//! Source: drivers/hwmon/ads7828.c
#![no_std]
...
pub const ADS7828_CMD_SD_SE: c_uint = 0x80	/* Single ended inputs */;
pub const ADS7828_CMD_PD1: c_uint = 0x04	/* Internal vref OFF && A/D ON */;
pub const ADS7828_CMD_PD3: c_uint = 0x0C	/* Internal vref ON && A/D ON */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads7828_data {
    pub regmap: *mut regmap,
    pub /: *mut *mut u8 cmd_byte; / Command byte without channel bits,
    pub /: *mut *mut unsigned int lsb_resol; / Resolution of the ADC sample LSB,
}

// Command byte C2,C1,C0 - see datasheet
#[no_mangle]
pub unsafe extern "C" fn ads7828_cmd_byte(cmd: u8, ch: c_int) -> u8 {
...
// sysfs callback function
    ...
    let mut cmd: u8 = ads7828_cmd_byte(data.cmd_byte, attr.index);
    unsigned int regval;
    int err;
...
#[no_mangle]
unsafe extern "C" fn ads7828_probe(client: *mut i2c_client) -> c_int {
    ...
    let mut vref_mv: c_uint = ADS7828_INT_VREF_MV;
    int vref_uv;
    let mut diff_input: bool = false;
    let mut ext_vref: bool = false;
    unsigned int regval;
