...
//! Source: drivers/hwmon/adm1025.c
#![no_std]
...
//
pub const ADM1025_REG_MAN_ID: c_uint = 0x3E;
pub const ADM1025_REG_CHIP_ID: c_uint = 0x3F;
pub const ADM1025_REG_CONFIG: c_uint = 0x40;
pub const ADM1025_REG_STATUS1: c_uint = 0x41;
pub const ADM1025_REG_STATUS2: c_uint = 0x42;

pub const ADM1025_REG_VID: c_uint = 0x47;
pub const ADM1025_REG_VID4: c_uint = 0x49;
//
...
pub struct adm1025_data {
    ...
    pub /: *mut *mut s8 temp[2]; / register value,
    pub /: *mut *mut s8 temp_min[2]; / register value,
    pub /: *mut *mut s8 temp_max[2]; / register value,
...
// Identification
    ...
    name = "adm1025";
#[no_mangle]
pub unsafe extern "C" fn if(0x2E: man_id == 0xA1 && client->addr !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn adm1025_init_client(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn adm1025_probe(client: *mut i2c_client) -> c_int {
