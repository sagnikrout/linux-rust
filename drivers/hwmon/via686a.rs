...
//! Source: drivers/hwmon/via686a.c
#![no_std]
...
pub const VIA686A_EXTENT: c_uint = 0x80;
pub const VIA686A_BASE_REG: c_uint = 0x70;
pub const VIA686A_ENABLE_REG: c_uint = 0x74;
...
// bits 7-6
pub const VIA686A_REG_TEMP_LOW1: c_uint = 0x4b;
// 2 = bits 5-4, 3 = bits 7-6
pub const VIA686A_REG_TEMP_LOW23: c_uint = 0x49;
pub const VIA686A_REG_ALARM1: c_uint = 0x41;
pub const VIA686A_REG_ALARM2: c_uint = 0x42;
pub const VIA686A_REG_FANDIV: c_uint = 0x47;
pub const VIA686A_REG_CONFIG: c_uint = 0x40;
//
...
// 11 same as 00
//
pub const VIA686A_REG_TEMP_MODE: c_uint = 0x4b;
// We'll just assume that you want to set all 3 simultaneously:
pub const VIA686A_TEMP_MODE_MASK: c_uint = 0x3F;
pub const VIA686A_TEMP_MODE_CONTINUOUS: c_uint = 0x00;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn IN_TO_REG(val: c_long, in_num: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: in_num ==) -> else {
    else if (in_num == 2)
    return (u8) clamp_val((val * 15737 - 1205000) / 250000, 0, 255);
#[no_mangle]
pub unsafe extern "C" fn if(3: in_num ==) -> else {
    else if (in_num == 3)
...
#[no_mangle]
pub unsafe extern "C" fn IN_FROM_REG(val: u8, in_num: c_int) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn TEMP_FROM_REG10(val: u16) -> c_long {
    static inline long TEMP_FROM_REG10(u16 val)
    {
    let mut eight_bits: u16 = val >> 2;
    let mut two_bits: u16 = val & 3;
...
pub struct via686a_data {
    ...
    pub /: *mut *mut u8 in[5]; / Register value,
    pub /: *mut *mut u8 in_max[5]; / Register value,
    pub /: *mut *mut u8 in_min[5]; / Register value,
    pub /: *mut *mut u8 fan[2]; / Register value,
    pub /: *mut *mut u8 fan_min[2]; / Register value,
    pub /: *mut *mut u16 temp[3]; / Register value 10 bit,
    pub /: *mut *mut u8 temp_over[3]; / Register value,
    pub /: *mut *mut u8 temp_hyst[3]; / Register value,
...
#[no_mangle]
pub unsafe extern "C" fn via686a_read_value(data: *mut via686a_data, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn via686a_update_fan_div(data: *mut via686a_data) {
    static void via686a_update_fan_div(struct via686a_data *data)
    {
    let mut reg: c_int = via686a_read_value(data, VIA686A_REG_FANDIV);
...
#[no_mangle]
unsafe extern "C" fn via686a_init_device(data: *mut via686a_data) {
...
#[no_mangle]
unsafe extern "C" fn via686a_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn via686a_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn via686a_device_add(address: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm_via686a_init() -> int __init {
    static int __init sm_via686a_init(void)
    {
    return pci_register_driver(&via686a_pci_driver);
    }
#[no_mangle]
unsafe extern "C" fn sm_via686a_exit() -> void __exit {
    static void __exit sm_via686a_exit(void)
    {
    pci_unregister_driver(&via686a_pci_driver);
    if (s_bridge != core::ptr::null_mut()) {
    platform_device_unregister(pdev);
    platform_driver_unregister(&via686a_driver);
    pci_dev_put(s_bridge);
    s_bridge = core::ptr::null_mut();
    }
    }
