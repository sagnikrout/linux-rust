...
//! Source: drivers/hwmon/w83627ehf.c
#![no_std]
...
//
pub const W83627EHF_LD_HWM: c_uint = 0x0b;
pub const W83667HG_LD_VID: c_uint = 0x0d;
pub const SIO_REG_LDSEL: c_uint = 0x07	/* Logical device select */;
pub const SIO_REG_DEVID: c_uint = 0x20	/* Device ID (2 bytes) */;
pub const SIO_REG_EN_VRM10: c_uint = 0x2C	/* GPIO3, GPIO4 selection */;
...
pub const SIO_REG_VID_CTRL: c_uint = 0xF0	/* VID control */;
pub const SIO_REG_VID_DATA: c_uint = 0xF1	/* VID data */;
pub const SIO_W83627EHF_ID: c_uint = 0x8850;
pub const SIO_W83627EHG_ID: c_uint = 0x8860;
pub const SIO_W83627DHG_ID: c_uint = 0xa020;
pub const SIO_W83627DHG_P_ID: c_uint = 0xb070;
pub const SIO_W83627UHG_ID: c_uint = 0xa230;
pub const SIO_W83667HG_ID: c_uint = 0xa510;
pub const SIO_W83667HG_B_ID: c_uint = 0xb350;
...
pub const W83627EHF_REG_BANK: c_uint = 0x4E;
pub const W83627EHF_REG_CONFIG: c_uint = 0x40;
//
// Not currently used:
...
pub const W83627EHF_REG_FANDIV1: c_uint = 0x47;
pub const W83627EHF_REG_FANDIV2: c_uint = 0x4B;
pub const W83627EHF_REG_VBAT: c_uint = 0x5D;
pub const W83627EHF_REG_DIODE: c_uint = 0x59;
pub const W83627EHF_REG_SMI_OVT: c_uint = 0x4C;
pub const W83627EHF_REG_ALARM1: c_uint = 0x459;
pub const W83627EHF_REG_ALARM2: c_uint = 0x45A;
pub const W83627EHF_REG_ALARM3: c_uint = 0x45B;
pub const W83627EHF_REG_CASEOPEN_DET: c_uint = 0x42 /* SMI STATUS #2 */;
pub const W83627EHF_REG_CASEOPEN_CLR: c_uint = 0x46 /* SMI MASK #3 */;
// SmartFan registers
pub const W83627EHF_REG_FAN_STEPUP_TIME: c_uint = 0x0f;
pub const W83627EHF_REG_FAN_STEPDOWN_TIME: c_uint = 0x0e;
...
#[no_mangle]
unsafe extern "C" fn is_word_sized(reg: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn step_time_from_reg(reg: u8, mode: u8) -> c_uint {
    static inline unsigned int step_time_from_reg(u8 reg, u8 mode)
    {
    return mode ? 100 * reg : 400 * reg;
    }
#[no_mangle]
pub unsafe extern "C" fn step_time_to_reg(msec: c_uint, mode: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn in_from_reg(reg: u8, nr: u8, scale_in: *const u16) -> c_long {
    static inline long in_from_reg(u8 reg, u8 nr, const u16 *scale_in)
    {
    return DIV_ROUND_CLOSEST(reg * scale_in[nr], 100);
    }
#[no_mangle]
pub unsafe extern "C" fn in_to_reg(val: u32, nr: u8, scale_in: *const u16) -> u8 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w83627ehf_data {
    pub /: *mut *mut int addr; / IO base of hw monitor block,
    pub name: *const c_char,
    pub lock: mutex,
    pub reg_temp: [u16; NUM_REG_TEMP],
    pub reg_temp_over: [u16; NUM_REG_TEMP],
    pub reg_temp_hyst: [u16; NUM_REG_TEMP],
    pub reg_temp_config: [u16; NUM_REG_TEMP],
    pub temp_src: [u8; NUM_REG_TEMP],
    pub temp_label: *const *const c_char,
    pub REG_FAN_MAX_OUTPUT: *const u16,
    pub REG_FAN_STEP_OUTPUT: *const u16,
    pub scale_in: *const u16,
...
// Register values
    pub /: *mut *mut u8 bank; / current register bank,
    pub /: *mut *mut u8 in_num; / number of in inputs we have,
    pub /: *mut *mut u8 in[10]; / Register value,
    pub /: *mut *mut u8 in_max[10]; / Register value,
    pub /: *mut *mut u8 in_min[10]; / Register value,
    pub rpm: [c_uint; 5],
    pub fan_min: [u16; 5],
    pub fan_div: [u8; 5],
    pub /: *mut *mut u8 has_fan; / some fan inputs can be disabled,
    pub /: *mut *mut u8 has_fan_min; / some fans don't have min register,
    pub temp_type: [u8; 3],
    pub temp_offset: [i8; 3],
    pub temp: [i16; 9],
    pub temp_max: [i16; 9],
    pub temp_max_hyst: [i16; 9],
    pub alarms: u32,
    pub caseopen: u8,
    pub /: *mut *mut u8 pwm_mode[4]; / 0->DC variable voltage, 1->PWM variable duty cycle,
    pub 1->manual: *mut *mut u8 pwm_enable[4]; /,
...
// SmartFan IV)
//
    pub /: *mut *mut u8 pwm_enable_orig[4]; / original value of pwm_enable,
    pub /: *mut *mut u8 pwm_num; / number of pwm,
    pub pwm: [u8; 4],
    pub target_temp: [u8; 4],
    pub tolerance: [u8; 4],
    pub /: *mut *mut u8 fan_start_output[4]; / minimum fan speed when spinning up,
    pub /: *mut *mut u8 fan_stop_output[4]; / minimum fan speed when spinning down,
    pub /: *mut *mut u8 fan_stop_time[4]; / time at minimum before disabling fan,
    pub /: *mut *mut u8 fan_max_output[4]; / maximum fan speed,
    pub /: *mut *mut u8 fan_step_output[4]; / rate of change output value,
    pub vid: u8,
    pub vrm: u8,
    pub have_temp: u16,
    pub have_temp_offset: u16,
    pub in6_skip:1: u8,
    pub temp3_val_only:1: u8,
    pub have_vid:1: u8,
...
//
#[no_mangle]
pub unsafe extern "C" fn w83627ehf_set_bank(data: *mut w83627ehf_data, reg: u16) {
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_read_value(data: *mut w83627ehf_data, reg: u16) -> u16 {
    ...
    u16 value)
    {
    let mut word_sized: c_int = is_word_sized(reg);
    mutex_lock(&data.lock);
    w83627ehf_set_bank(data, reg);
    outb_p(reg & 0xff, data.addr + ADDR_REG_OFFSET);
    if (word_sized) {
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_read_temp(data: *mut w83627ehf_data, reg: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_write_fan_div(data: *mut w83627ehf_data, nr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_update_fan_div(data: *mut w83627ehf_data) {
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_update_pwm(data: *mut w83627ehf_data) {
...
// Get thermal sensor types
    ...
    for (i = 0; i < 3; i++) {
    const char *label = core::ptr::null_mut();
    if (data.temp_label)
...
// Digital source overrides analog type
    ...
    data.temp_type[i] = 6;
#[no_mangle]
pub unsafe extern "C" fn if(strncmp(label: label &&, _arg: "AMD", 0: 3) ==) -> else {
    else if (label && strncmp(label, "AMD", 3) == 0)
    data.temp_type[i] = 5;
#[no_mangle]
pub unsafe extern "C" fn if(i)): (tmp & (0x02 <<) -> else {
    else if ((tmp & (0x02 << i)))
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_probe(pdev: *mut platform_device) -> int __init {
...
// Adjust to have the same mapping as other source registers
    ...
    data.temp_src[1] = 1;
#[no_mangle]
pub unsafe extern "C" fn if(5: reg >= 2 && reg <=) -> else {
    else if (reg >= 2 && reg <= 5)
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83627ehf_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sensors_w83627ehf_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sensors_w83627ehf_exit() -> void __exit {
