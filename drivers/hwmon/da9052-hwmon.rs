...
//! Source: drivers/hwmon/da9052-hwmon.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9052_hwmon {
    pub da9052: *mut da9052,
    pub hwmon_lock: mutex,
    pub tsi_as_adc: bool,
    pub tsiref_mv: c_int,
    pub tsidone: completion,
}
...
#[no_mangle]
pub unsafe extern "C" fn input_reg_to_mv(value: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vbbat_reg_to_mv(value: c_int) -> c_int {
    static inline int vbbat_reg_to_mv(int value)
    {
    return DIV_ROUND_CLOSEST(value * 5000, 1023);
    }
#[no_mangle]
pub unsafe extern "C" fn input_tsireg_to_mv(hwmon: *mut da9052_hwmon, value: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9052_enable_vddout_channel(da9052: *mut da9052) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9052_disable_vddout_channel(da9052: *mut da9052) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_request_tsi_read(hwmon: *mut da9052_hwmon, channel: c_int) -> c_int {
    static int da9052_request_tsi_read(struct da9052_hwmon *hwmon, int channel)
    {
    let mut val: u8 = DA9052_TSICONTB_TSIMAN;
    switch (channel) {
...
#[no_mangle]
unsafe extern "C" fn da9052_get_tsi_result(hwmon: *mut da9052_hwmon, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __da9052_read_tsi(dev: *mut device, channel: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn da9052_tsi_datardy_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9052_hwmon_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_hwmon_remove(pdev: *mut platform_device) {
