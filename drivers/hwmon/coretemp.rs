...
//! Source: drivers/hwmon/coretemp.c
#![no_std]
...
pub struct temp_data {
    ...
    pub status_reg: u32,
    pub attr_size: c_int,
    pub sd_attrs: [device_attribute; TOTAL_ATTRS],
    pub attr_name: [c_char; TOTAL_ATTRS][CORETEMP_NAME_LENGTH],
    pub 1]: *mut *mut attribute attrs[TOTAL_ATTRS +,
...
pub struct platform_data {
    ...
    pub ida: ida,
    pub cpumask: cpumask,
    pub pkg_data: *mut temp_data,
    pub core_data: *mut temp_data,
    pub name_attr: device_attribute,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tjmax_pci {
    pub device: c_uint,
    pub tjmax: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tjmax_model {
    pub vfm: u32,
    pub stepping_mask: u8,
    pub tjmax: c_int,
}

pub const ANY: c_uint = 0xff;
...
#[no_mangle]
unsafe extern "C" fn is_pkg_temp_data(tdata: *mut temp_data) -> bool {
    static bool is_pkg_temp_data(struct temp_data *tdata)
    {
    return tdata.index < 0;
    }
#[no_mangle]
unsafe extern "C" fn adjust_tjmax(c: *mut cpuinfo_x86, id: u32, dev: *mut device) -> c_int {
    static int adjust_tjmax(struct cpuinfo_x86 *c, u32 id, struct device *dev)
    {
// The 100C is default for both mobile and non mobile CPUs
    let mut tjmax: c_int = 100000;
    let mut tjmax_ee: c_int = 85000;
    let mut usemsr_ee: c_int = 1;
    int err;
    u64 val;
    int i;
    let mut devfn: u16 = PCI_DEVFN(0, 0);
...
#[no_mangle]
unsafe extern "C" fn get_tjmax(tdata: *mut temp_data, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ttarget(tdata: *mut temp_data, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_core_attrs(tdata: *mut temp_data, dev: *mut device) -> c_int {
...
//
    let mut attr_no: c_int = is_pkg_temp_data(tdata) ? 1 : tdata.cpu_core_id + 2;
...
#[no_mangle]
unsafe extern "C" fn chk_ucode_version(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_temp_data(pdata: *mut platform_data, tdata: *mut temp_data) {
    static void destroy_temp_data(struct platform_data *pdata, struct temp_data *tdata)
    {
    if (is_pkg_temp_data(tdata)) {
    pdata.pkg_data = core::ptr::null_mut();
    kfree(pdata.core_data);
    pdata.core_data = core::ptr::null_mut();
    pdata.nr_cores = 0;
    } else {
    pdata.core_data[tdata.index] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn coretemp_remove_core(pdata: *mut platform_data, tdata: *mut temp_data) {
...
#[no_mangle]
unsafe extern "C" fn coretemp_device_add(zoneid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coretemp_device_remove(zoneid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn coretemp_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coretemp_cpu_offline(cpu: c_uint) -> c_int {
...
//
    ...
    pd.hwmon_dev = core::ptr::null_mut();
    return 0;
    }
//
...
//
    ...
    X86_MATCH_VENDOR_FEATURE(INTEL, X86_FEATURE_DTHERM, core::ptr::null_mut()),
    {}
    };
    MODULE_DEVICE_TABLE(x86cpu, coretemp_ids);
    static enum cpuhp_state coretemp_hp_online;
#[no_mangle]
unsafe extern "C" fn coretemp_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn coretemp_exit() -> void __exit {
