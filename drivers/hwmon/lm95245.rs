...
//! Source: drivers/hwmon/lm95245.c
#![no_std]
...
// LM95245 registers
// general registers
pub const LM95245_REG_RW_CONFIG1: c_uint = 0x03;
pub const LM95245_REG_RW_CONVERS_RATE: c_uint = 0x04;
pub const LM95245_REG_W_ONE_SHOT: c_uint = 0x0F;
// diode configuration
pub const LM95245_REG_RW_CONFIG2: c_uint = 0xBF;
pub const LM95245_REG_RW_REMOTE_OFFH: c_uint = 0x11;
pub const LM95245_REG_RW_REMOTE_OFFL: c_uint = 0x12;
// status registers
pub const LM95245_REG_R_STATUS1: c_uint = 0x02;
pub const LM95245_REG_R_STATUS2: c_uint = 0x33;
// limit registers
pub const LM95245_REG_RW_REMOTE_OS_LIMIT: c_uint = 0x07;
pub const LM95245_REG_RW_LOCAL_OS_TCRIT_LIMIT: c_uint = 0x20;
pub const LM95245_REG_RW_REMOTE_TCRIT_LIMIT: c_uint = 0x19;
pub const LM95245_REG_RW_COMMON_HYSTERESIS: c_uint = 0x21;
// temperature signed
pub const LM95245_REG_R_LOCAL_TEMPH_S: c_uint = 0x00;
pub const LM95245_REG_R_LOCAL_TEMPL_S: c_uint = 0x30;
pub const LM95245_REG_R_REMOTE_TEMPH_S: c_uint = 0x01;
pub const LM95245_REG_R_REMOTE_TEMPL_S: c_uint = 0x10;
// temperature unsigned
pub const LM95245_REG_R_REMOTE_TEMPH_U: c_uint = 0x31;
pub const LM95245_REG_R_REMOTE_TEMPL_U: c_uint = 0x32;
// id registers
pub const LM95245_REG_R_MAN_ID: c_uint = 0xFE;
pub const LM95245_REG_R_CHIP_ID: c_uint = 0xFF;
// LM95245 specific bitfields
pub const CFG_STOP: c_uint = 0x40;
pub const CFG_REMOTE_TCRIT_MASK: c_uint = 0x10;
pub const CFG_REMOTE_OS_MASK: c_uint = 0x08;
pub const CFG_LOCAL_TCRIT_MASK: c_uint = 0x04;
pub const CFG_LOCAL_OS_MASK: c_uint = 0x02;
pub const CFG2_OS_A0: c_uint = 0x40;
pub const CFG2_DIODE_FAULT_OS: c_uint = 0x20;
pub const CFG2_DIODE_FAULT_TCRIT: c_uint = 0x10;
pub const CFG2_REMOTE_TT: c_uint = 0x08;
pub const CFG2_REMOTE_FILTER_DIS: c_uint = 0x00;
pub const CFG2_REMOTE_FILTER_EN: c_uint = 0x06;
// conversation rate in ms
pub const RATE_CR0063: c_uint = 0x00;
pub const RATE_CR0364: c_uint = 0x01;
pub const RATE_CR1000: c_uint = 0x02;
pub const RATE_CR2500: c_uint = 0x03;
pub const STATUS1_ROS: c_uint = 0x10;
pub const STATUS1_DIODE_FAULT: c_uint = 0x04;
pub const STATUS1_RTCRIT: c_uint = 0x02;
pub const STATUS1_LOC: c_uint = 0x01;
pub const MANUFACTURER_ID: c_uint = 0x01;
pub const LM95235_REVISION: c_uint = 0xB1;
pub const LM95245_REVISION: c_uint = 0xB3;
// Client data (each client gets its own)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm95245_data {
    pub regmap: *mut regmap,
    pub /: *mut *mut int interval; / in msecs,
}
...
#[no_mangle]
unsafe extern "C" fn lm95245_read_conversion_rate(data: *mut lm95245_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm95245_set_conversion_rate(data: *mut lm95245_data, interval: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm95245_temp_is_visible(data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn lm95245_init_client(data: *mut lm95245_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm95245_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lm95245_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lm95245_probe(client: *mut i2c_client) -> c_int {
