...
//! Source: drivers/hwmon/w83792d.c
#![no_std]
...
pub const W83792D_REG_LOW_BITS1: c_uint = 0x3E  /* Low Bits I in DataSheet */;
pub const W83792D_REG_LOW_BITS2: c_uint = 0x3F  /* Low Bits II in DataSheet */;
...
pub const W83792D_REG_FAN_CFG: c_uint = 0x84	/* FAN Configuration in DataSheet */;
...
pub const W83792D_REG_BANK: c_uint = 0x4E;
pub const W83792D_REG_TEMP2_CONFIG: c_uint = 0xC2;
pub const W83792D_REG_TEMP3_CONFIG: c_uint = 0xCA;
...
pub const W83792D_REG_GPIO_EN: c_uint = 0x1A;
pub const W83792D_REG_CONFIG: c_uint = 0x40;
pub const W83792D_REG_VID_FANDIV: c_uint = 0x47;
pub const W83792D_REG_CHIPID: c_uint = 0x49;
pub const W83792D_REG_WCHIPID: c_uint = 0x58;
pub const W83792D_REG_CHIPMAN: c_uint = 0x4F;
pub const W83792D_REG_PIN: c_uint = 0x4B;
pub const W83792D_REG_I2C_SUBADDR: c_uint = 0x4A;
pub const W83792D_REG_ALARM1: c_uint = 0xA9		/* realtime status register1 */;
pub const W83792D_REG_ALARM2: c_uint = 0xAA		/* realtime status register2 */;
pub const W83792D_REG_ALARM3: c_uint = 0xAB		/* realtime status register3 */;
pub const W83792D_REG_CHASSIS: c_uint = 0x42	/* Bit 5: Case Open status bit */;
pub const W83792D_REG_CHASSIS_CLR: c_uint = 0x44	/* Bit 7: Case Open CLR_CHS/Reset bit */;
// control in0/in1 's limit modifiability
pub const W83792D_REG_VID_IN_B: c_uint = 0x17;
pub const W83792D_REG_VBAT: c_uint = 0x5D;
pub const W83792D_REG_I2C_ADDR: c_uint = 0x48;
//
...
pub struct w83792d_data {
    ...
    pub /: *mut *mut u16 low_bits; / Additional resolution to voltage in6-0,
    pub /: *mut *mut u8 fan[7]; / Register value,
    pub /: *mut *mut u8 fan_min[7]; / Register value,
    pub /: *mut *mut u8 temp1[3]; / current, over, thyst,
    pub /: *mut *mut u8 temp_add[2][6]; / Register value,
    pub /: *mut *mut u8 fan_div[7]; / Register encoding, shifted right,
    pub /: *mut *mut u8 pwm[7]; / The 7 PWM outputs,
    pub pwmenable: [u8; 3],
    pub /: *mut *mut u32 alarms; / realtime status register encoding,combined,
    pub /: *mut *mut u8 chassis; / Chassis status,
    pub /: *mut *mut u8 thermal_cruise[3]; / Smart FanI: Fan1,2,3 target value,
    pub /: *mut *mut u8 tolerance[3]; / Fan1,2,3 tolerance(Smart Fan I/II),
    pub /: *mut *mut u8 sf2_points[3][4]; / Smart FanII: Fan1,2,3 temperature points,
    pub /: *mut *mut u8 sf2_levels[3][4]; / Smart FanII: Fan1,2,3 duty cycle levels,
}
...
#[no_mangle]
pub unsafe extern "C" fn in_count_from_reg(nr: c_int, data: *mut w83792d_data) -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn w83792d_read_value(client: *mut i2c_client, reg: u8) -> c_int {
...
// following are the sysfs callback functions
    ...
    {
    struct sensor_device_attribute *sensor_attr = to_sensor_dev_attr(attr);
    let mut nr: c_int = sensor_attr.index - 1;
    struct i2c_client *client = to_i2c_client(dev);
    struct w83792d_data *data = i2c_get_clientdata(client);
    unsigned long val;
    int err;
...
// get realtime status of all sensors items: voltage, temp, fan
    ...
    let mut nr: c_int = sensor_attr.index - 1;
    struct w83792d_data *data = w83792d_update_device(dev);
    let mut pwm_enable_tmp: c_long = 1;
...
// For Smart Fan I / Thermal Cruise
    ...
    struct i2c_client *client = to_i2c_client(dev);
    struct w83792d_data *data = i2c_get_clientdata(client);
    let mut target_tmp: u8 = 0, target_mask = 0;
    unsigned long val;
    int err;
    err = kstrtoul(buf, 10, &val);
    if (err)
...
// For Smart Fan II
    ...
    struct sensor_device_attribute_2 *sensor_attr
    = to_sensor_dev_attr_2(attr);
    let mut nr: c_int = sensor_attr.nr - 1;
    let mut index: c_int = sensor_attr.index - 1;
    struct i2c_client *client = to_i2c_client(dev);
    struct w83792d_data *data = i2c_get_clientdata(client);
    let mut mask_tmp: u8 = 0;
    unsigned long val;
    int err;
    err = kstrtoul(buf, 10, &val);
    if (err)
    ...
    struct i2c_client *client = to_i2c_client(dev);
    struct w83792d_data *data = i2c_get_clientdata(client);
    let mut mask_tmp: u8 = 0, level_tmp = 0;
    unsigned long val;
    int err;
    err = kstrtoul(buf, 10, &val);
    if (err)
    ...
    {
    int i, id;
    let mut address: c_int = new_client.addr;
    u8 val;
    ...
    static SENSOR_DEVICE_ATTR(in4_input, S_IRUGO, show_in, core::ptr::null_mut(), 4);
    static SENSOR_DEVICE_ATTR(in5_input, S_IRUGO, show_in, core::ptr::null_mut(), 5);
    static SENSOR_DEVICE_ATTR(in6_input, S_IRUGO, show_in, core::ptr::null_mut(), 6);
    static SENSOR_DEVICE_ATTR(in7_input, S_IRUGO, show_in, core::ptr::null_mut(), 7);
    static SENSOR_DEVICE_ATTR(in8_input, S_IRUGO, show_in, core::ptr::null_mut(), 8);
    ...
    static SENSOR_DEVICE_ATTR_2(temp1_input, S_IRUGO, show_temp1, core::ptr::null_mut(), 0, 0);
    static SENSOR_DEVICE_ATTR_2(temp2_input, S_IRUGO, show_temp23, core::ptr::null_mut(), 0, 0);
    static SENSOR_DEVICE_ATTR_2(temp3_input, S_IRUGO, show_temp23, core::ptr::null_mut(), 1, 0);
    ...
    static SENSOR_DEVICE_ATTR(temp1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 2);
    static SENSOR_DEVICE_ATTR(temp2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 3);
    static SENSOR_DEVICE_ATTR(temp3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 4);
    static SENSOR_DEVICE_ATTR(fan1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 5);
    static SENSOR_DEVICE_ATTR(fan2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 6);
    static SENSOR_DEVICE_ATTR(fan3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 7);
    static SENSOR_DEVICE_ATTR(in2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 8);
    static SENSOR_DEVICE_ATTR(in3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 9);
    static SENSOR_DEVICE_ATTR(in4_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 10);
    static SENSOR_DEVICE_ATTR(in5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 11);
    static SENSOR_DEVICE_ATTR(in6_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 12);
    static SENSOR_DEVICE_ATTR(fan7_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 15);
    static SENSOR_DEVICE_ATTR(in7_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 19);
    static SENSOR_DEVICE_ATTR(in8_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 20);
    static SENSOR_DEVICE_ATTR(fan4_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 21);
    static SENSOR_DEVICE_ATTR(fan5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 22);
    static SENSOR_DEVICE_ATTR(fan6_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 23);
    ...
    static SENSOR_DEVICE_ATTR(fan1_input, S_IRUGO, show_fan, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(fan2_input, S_IRUGO, show_fan, core::ptr::null_mut(), 2);
    static SENSOR_DEVICE_ATTR(fan3_input, S_IRUGO, show_fan, core::ptr::null_mut(), 3);
    static SENSOR_DEVICE_ATTR(fan4_input, S_IRUGO, show_fan, core::ptr::null_mut(), 4);
    static SENSOR_DEVICE_ATTR(fan5_input, S_IRUGO, show_fan, core::ptr::null_mut(), 5);
    static SENSOR_DEVICE_ATTR(fan6_input, S_IRUGO, show_fan, core::ptr::null_mut(), 6);
    static SENSOR_DEVICE_ATTR(fan7_input, S_IRUGO, show_fan, core::ptr::null_mut(), 7);
...
#[no_mangle]
unsafe extern "C" fn w83792d_print_debug(data: *mut w83792d_data, dev: *mut device) {
    static void w83792d_print_debug(struct w83792d_data *data, struct device *dev)
    {
