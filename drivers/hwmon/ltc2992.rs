...
//! Source: drivers/hwmon/ltc2992.c
#![no_std]
...
pub const LTC2992_CTRLB: c_uint = 0x01;
pub const LTC2992_FAULT1: c_uint = 0x03;
pub const LTC2992_POWER1: c_uint = 0x05;
pub const LTC2992_POWER1_MAX: c_uint = 0x08;
pub const LTC2992_POWER1_MIN: c_uint = 0x0B;
pub const LTC2992_POWER1_MAX_THRESH: c_uint = 0x0E;
pub const LTC2992_POWER1_MIN_THRESH: c_uint = 0x11;
pub const LTC2992_DSENSE1: c_uint = 0x14;
pub const LTC2992_DSENSE1_MAX: c_uint = 0x16;
pub const LTC2992_DSENSE1_MIN: c_uint = 0x18;
pub const LTC2992_DSENSE1_MAX_THRESH: c_uint = 0x1A;
pub const LTC2992_DSENSE1_MIN_THRESH: c_uint = 0x1C;
pub const LTC2992_SENSE1: c_uint = 0x1E;
pub const LTC2992_SENSE1_MAX: c_uint = 0x20;
pub const LTC2992_SENSE1_MIN: c_uint = 0x22;
pub const LTC2992_SENSE1_MAX_THRESH: c_uint = 0x24;
pub const LTC2992_SENSE1_MIN_THRESH: c_uint = 0x26;
pub const LTC2992_G1: c_uint = 0x28;
pub const LTC2992_G1_MAX: c_uint = 0x2A;
pub const LTC2992_G1_MIN: c_uint = 0x2C;
pub const LTC2992_G1_MAX_THRESH: c_uint = 0x2E;
pub const LTC2992_G1_MIN_THRESH: c_uint = 0x30;
pub const LTC2992_FAULT2: c_uint = 0x35;
pub const LTC2992_G2: c_uint = 0x5A;
pub const LTC2992_G2_MAX: c_uint = 0x5C;
pub const LTC2992_G2_MIN: c_uint = 0x5E;
pub const LTC2992_G2_MAX_THRESH: c_uint = 0x60;
pub const LTC2992_G2_MIN_THRESH: c_uint = 0x62;
pub const LTC2992_G3: c_uint = 0x64;
pub const LTC2992_G3_MAX: c_uint = 0x66;
pub const LTC2992_G3_MIN: c_uint = 0x68;
pub const LTC2992_G3_MAX_THRESH: c_uint = 0x6A;
pub const LTC2992_G3_MIN_THRESH: c_uint = 0x6C;
pub const LTC2992_G4: c_uint = 0x6E;
pub const LTC2992_G4_MAX: c_uint = 0x70;
pub const LTC2992_G4_MIN: c_uint = 0x72;
pub const LTC2992_G4_MAX_THRESH: c_uint = 0x74;
pub const LTC2992_G4_MIN_THRESH: c_uint = 0x76;
pub const LTC2992_FAULT3: c_uint = 0x92;
pub const LTC2992_GPIO_STATUS: c_uint = 0x95;
pub const LTC2992_GPIO_IO_CTRL: c_uint = 0x96;
pub const LTC2992_GPIO_CTRL: c_uint = 0x97;
...
pub const LTC2992_IADC_NANOV_LSB: c_int = 12500;
pub const LTC2992_VADC_UV_LSB: c_int = 25000;
pub const LTC2992_VADC_GPIO_UV_LSB: c_int = 500;
pub const LTC2992_GPIO_NR: c_int = 4;
pub const LTC2992_GPIO1_BIT: c_int = 7;
pub const LTC2992_GPIO2_BIT: c_int = 6;
pub const LTC2992_GPIO3_BIT: c_int = 0;
pub const LTC2992_GPIO4_BIT: c_int = 6;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2992_state {
    pub client: *mut i2c_client,
    pub gc: gpio_chip,
    pub /: *mut *mut mutex gpio_mutex; / lock for gpio access,
    pub gpio_names: [*const c_char; LTC2992_GPIO_NR],
    pub regmap: *mut regmap,
    pub r_sense_uohm: [u32; 2],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2992_gpio_regs {
    pub data: u8,
    pub max: u8,
    pub min: u8,
    pub max_thresh: u8,
    pub min_thresh: u8,
    pub alarm: u8,
    pub min_alarm_msk: u8,
    pub max_alarm_msk: u8,
    pub ctrl: u8,
    pub ctrl_bit: u8,
}
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_reg(st: *mut ltc2992_state, addr: u8, reg_len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_write_reg(st: *mut ltc2992_state, addr: u8, reg_len: u8, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    {
    struct ltc2992_state *st = gpiochip_get_data(chip);
    let mut gpio_ctrl_io: c_ulong = 0;
    let mut gpio_ctrl: c_ulong = 0;
    unsigned int gpio_nr;
    int ret;
    for_each_set_bit(gpio_nr, mask, LTC2992_GPIO_NR) {
    if (gpio_nr < 3)
...
#[no_mangle]
unsafe extern "C" fn ltc2992_config_gpio(st: *mut ltc2992_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_get_voltage(st: *mut ltc2992_state, reg: u32, scale: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_set_voltage(st: *mut ltc2992_state, reg: u32, scale: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_gpio_alarm(st: *mut ltc2992_state, nr_gpio: c_int, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_gpios_in(dev: *mut device, attr: u32, nr_gpio: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_in_alarm(st: *mut ltc2992_state, channel: c_int, val: *mut c_long, attr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_in(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_get_current(st: *mut ltc2992_state, reg: u32, channel: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_set_current(st: *mut ltc2992_state, reg: u32, channel: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_curr_alarm(st: *mut ltc2992_state, channel: c_int, val: *mut c_long, attr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_curr(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_get_power(st: *mut ltc2992_state, reg: u32, channel: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_set_power(st: *mut ltc2992_state, reg: u32, channel: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_power_alarm(st: *mut ltc2992_state, channel: c_int, val: *mut c_long, attr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_read_power(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_write_curr(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_write_gpios_in(dev: *mut device, attr: u32, nr_gpio: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_write_in(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_write_power(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_write_chip(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_parse_dt(st: *mut ltc2992_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2992_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    &ltc2992_chip_info, core::ptr::null_mut());
