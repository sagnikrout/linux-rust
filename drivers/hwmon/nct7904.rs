...
//! Source: drivers/hwmon/nct7904.c
#![no_std]
...
pub const VENDOR_ID_REG: c_uint = 0x7A	/* Any bank */;
pub const NUVOTON_ID: c_uint = 0x50;
pub const CHIP_ID_REG: c_uint = 0x7B	/* Any bank */;
pub const NCT7904_ID: c_uint = 0xC5;
pub const DEVICE_ID_REG: c_uint = 0x7C	/* Any bank */;
pub const BANK_SEL_REG: c_uint = 0xFF;
pub const BANK_0: c_uint = 0x00;
pub const BANK_1: c_uint = 0x01;
pub const BANK_2: c_uint = 0x02;
pub const BANK_3: c_uint = 0x03;
pub const BANK_4: c_uint = 0x04;
pub const BANK_MAX: c_uint = 0x04;

    LTD (not a voltage), VSEN17..19 */

pub const VT_ADC_CTRL0_REG: c_uint = 0x20	/* Bank 0 */;
pub const VT_ADC_CTRL1_REG: c_uint = 0x21	/* Bank 0 */;
pub const VT_ADC_CTRL2_REG: c_uint = 0x22	/* Bank 0 */;
pub const FANIN_CTRL0_REG: c_uint = 0x24;
pub const FANIN_CTRL1_REG: c_uint = 0x25;
pub const DTS_T_CTRL0_REG: c_uint = 0x26;
pub const DTS_T_CTRL1_REG: c_uint = 0x27;
pub const VT_ADC_MD_REG: c_uint = 0x2E;
pub const VSEN1_HV_LL_REG: c_uint = 0x02	/* Bank 1; 2 regs (HV/LV) per sensor */;
pub const VSEN1_LV_LL_REG: c_uint = 0x03	/* Bank 1; 2 regs (HV/LV) per sensor */;
pub const VSEN1_HV_HL_REG: c_uint = 0x00	/* Bank 1; 2 regs (HV/LV) per sensor */;
pub const VSEN1_LV_HL_REG: c_uint = 0x01	/* Bank 1; 2 regs (HV/LV) per sensor */;
pub const SMI_STS1_REG: c_uint = 0xC1	/* Bank 0; SMI Status Register */;
pub const SMI_STS3_REG: c_uint = 0xC3	/* Bank 0; SMI Status Register */;
pub const SMI_STS5_REG: c_uint = 0xC5	/* Bank 0; SMI Status Register */;
pub const SMI_STS7_REG: c_uint = 0xC7	/* Bank 0; SMI Status Register */;
pub const SMI_STS8_REG: c_uint = 0xC8	/* Bank 0; SMI Status Register */;
pub const VSEN1_HV_REG: c_uint = 0x40	/* Bank 0; 2 regs (HV/LV) per sensor */;
pub const TEMP_CH1_HV_REG: c_uint = 0x42	/* Bank 0; same as VSEN2_HV */;
pub const LTD_HV_REG: c_uint = 0x62	/* Bank 0; 2 regs in VSEN range */;
pub const LTD_HV_HL_REG: c_uint = 0x44	/* Bank 1; 1 reg for LTD */;
pub const LTD_LV_HL_REG: c_uint = 0x45	/* Bank 1; 1 reg for LTD */;
pub const LTD_HV_LL_REG: c_uint = 0x46	/* Bank 1; 1 reg for LTD */;
pub const LTD_LV_LL_REG: c_uint = 0x47	/* Bank 1; 1 reg for LTD */;
pub const TEMP_CH1_CH_REG: c_uint = 0x05	/* Bank 1; 1 reg for LTD */;
pub const TEMP_CH1_W_REG: c_uint = 0x06	/* Bank 1; 1 reg for LTD */;
pub const TEMP_CH1_WH_REG: c_uint = 0x07	/* Bank 1; 1 reg for LTD */;
pub const TEMP_CH1_C_REG: c_uint = 0x04	/* Bank 1; 1 reg per sensor */;
pub const DTS_T_CPU1_C_REG: c_uint = 0x90	/* Bank 1; 1 reg per sensor */;
pub const DTS_T_CPU1_CH_REG: c_uint = 0x91	/* Bank 1; 1 reg per sensor */;
pub const DTS_T_CPU1_W_REG: c_uint = 0x92	/* Bank 1; 1 reg per sensor */;
pub const DTS_T_CPU1_WH_REG: c_uint = 0x93	/* Bank 1; 1 reg per sensor */;
pub const FANIN1_HV_REG: c_uint = 0x80	/* Bank 0; 2 regs (HV/LV) per sensor */;
pub const FANIN1_HV_HL_REG: c_uint = 0x60	/* Bank 1; 2 regs (HV/LV) per sensor */;
pub const FANIN1_LV_HL_REG: c_uint = 0x61	/* Bank 1; 2 regs (HV/LV) per sensor */;
pub const T_CPU1_HV_REG: c_uint = 0xA0	/* Bank 0; 2 regs (HV/LV) per sensor */;
pub const PRTS_REG: c_uint = 0x03	/* Bank 2 */;
pub const PFE_REG: c_uint = 0x00	/* Bank 2; PECI Function Enable */;
pub const TSI_CTRL_REG: c_uint = 0x50	/* Bank 2; TSI Control Register */;
pub const FANCTL1_FMR_REG: c_uint = 0x00	/* Bank 3; 1 reg per channel */;
pub const FANCTL1_OUT_REG: c_uint = 0x10	/* Bank 3; 1 reg per channel */;
pub const WDT_LOCK_REG: c_uint = 0xE0	/* W/O Lock Watchdog Register */;
pub const WDT_EN_REG: c_uint = 0xE1	/* R/O Watchdog Enable Register */;
pub const WDT_STS_REG: c_uint = 0xE2	/* R/O Watchdog Status Register */;
pub const WDT_TIMER_REG: c_uint = 0xE3	/* R/W Watchdog Timer Register */;
pub const WDT_SOFT_EN: c_uint = 0x55	/* Enable soft watchdog timer */;
pub const WDT_SOFT_DIS: c_uint = 0xAA	/* Disable soft watchdog timer */;
pub const VOLT_MONITOR_MODE: c_uint = 0x0;
pub const THERMAL_DIODE_MODE: c_uint = 0x1;
pub const THERMISTOR_MODE: c_uint = 0x3;
...
pub struct nct7904_data {
    ...
    pub vsen_mask: u32,
    pub tcpu_mask: u32,
    pub fan_mode: [u8; FANCTL_MAX],
    pub enable_dts: u8,
    pub has_dts: u8,
    pub /: *mut *mut u8 temp_mode; / 0: TR mode, 1: TD mode,
    pub fan_alarm: [u8; 2],
    pub vsen_alarm: [u8; 3],
}
...
// Access functions
#[no_mangle]
unsafe extern "C" fn nct7904_bank_select(data: *mut nct7904_data, bank: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct7904_fan_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn nct7904_in_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
    static umode_t nct7904_in_is_visible(const void *_data, u32 attr, int channel)
    {
    const struct nct7904_data *data = _data;
    let mut index: c_int = nct7904_chan_to_index[channel];
    switch (attr) {
    case hwmon_in_input:
    case hwmon_in_alarm:
...
#[no_mangle]
unsafe extern "C" fn nct7904_temp_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn nct7904_pwm_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
//
#[no_mangle]
unsafe extern "C" fn nct7904_wdt_start(wdt: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct7904_wdt_stop(wdt: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct7904_wdt_ping(wdt: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct7904_wdt_get_timeleft(wdt: *mut watchdog_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nct7904_probe(client: *mut i2c_client) -> c_int {
...
// Read all of SMI status register to clear alarms
    ...
    &nct7904_chip_info, core::ptr::null_mut());
