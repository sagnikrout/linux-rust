...
//! Source: drivers/hwmon/ltc2945.c
#![no_std]
...
// chip registers
pub const LTC2945_CONTROL: c_uint = 0x00;
pub const LTC2945_ALERT: c_uint = 0x01;
pub const LTC2945_STATUS: c_uint = 0x02;
pub const LTC2945_FAULT: c_uint = 0x03;
pub const LTC2945_POWER_H: c_uint = 0x05;
pub const LTC2945_MAX_POWER_H: c_uint = 0x08;
pub const LTC2945_MIN_POWER_H: c_uint = 0x0b;
pub const LTC2945_MAX_POWER_THRES_H: c_uint = 0x0e;
pub const LTC2945_MIN_POWER_THRES_H: c_uint = 0x11;
pub const LTC2945_SENSE_H: c_uint = 0x14;
pub const LTC2945_MAX_SENSE_H: c_uint = 0x16;
pub const LTC2945_MIN_SENSE_H: c_uint = 0x18;
pub const LTC2945_MAX_SENSE_THRES_H: c_uint = 0x1a;
pub const LTC2945_MIN_SENSE_THRES_H: c_uint = 0x1c;
pub const LTC2945_VIN_H: c_uint = 0x1e;
pub const LTC2945_MAX_VIN_H: c_uint = 0x20;
pub const LTC2945_MIN_VIN_H: c_uint = 0x22;
pub const LTC2945_MAX_VIN_THRES_H: c_uint = 0x24;
pub const LTC2945_MIN_VIN_THRES_H: c_uint = 0x26;
pub const LTC2945_ADIN_H: c_uint = 0x28;
pub const LTC2945_MAX_ADIN_H: c_uint = 0x2a;
pub const LTC2945_MIN_ADIN_H: c_uint = 0x2c;
pub const LTC2945_MAX_ADIN_THRES_H: c_uint = 0x2e;
pub const LTC2945_MIN_ADIN_THRES_H: c_uint = 0x30;
pub const LTC2945_MIN_ADIN_THRES_L: c_uint = 0x31;
// Fault register bits
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2945_data {
    pub regmap: *mut regmap,
    pub shunt_resistor: u32,
}

#[no_mangle]
pub unsafe extern "C" fn is_power_reg(reg: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc2945_reg_to_val(dev: *mut device, reg: u8) -> c_longlong {
    static long long ltc2945_reg_to_val(struct device *dev, u8 reg)
    {
    struct ltc2945_data *data = dev_get_drvdata(dev);
    struct regmap *regmap = data.regmap;
    let mut shunt_resistor: u32 = data.shunt_resistor;
...
// convert to register value, then clamp and write result
    ...
    struct regmap *regmap = data.regmap;
    let mut reg: u8 = attr.index;
    let mut num_regs: c_int = is_power_reg(reg) ? 3 : 2;
...
#[no_mangle]
unsafe extern "C" fn ltc2945_probe(client: *mut i2c_client) -> c_int {
