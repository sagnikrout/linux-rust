...
//! Source: drivers/hwmon/adm9240.c
#![no_std]
...
// ADM9240 registers
pub const ADM9240_REG_MAN_ID: c_uint = 0x3e;
pub const ADM9240_REG_DIE_REV: c_uint = 0x3f;
pub const ADM9240_REG_CONFIG: c_uint = 0x40;

pub const ADM9240_REG_TEMP: c_uint = 0x27;

pub const ADM9240_REG_ANALOG_OUT: c_uint = 0x19;
pub const ADM9240_REG_CHASSIS_CLEAR: c_uint = 0x46;
pub const ADM9240_REG_VID_FAN_DIV: c_uint = 0x47;
pub const ADM9240_REG_I2C_ADDR: c_uint = 0x48;
pub const ADM9240_REG_VID4: c_uint = 0x49;
pub const ADM9240_REG_TEMP_CONF: c_uint = 0x4b;
// generalised scaling with integer rounding
#[no_mangle]
pub unsafe extern "C" fn SCALE(val: c_long, mul: c_int, div: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn IN_FROM_REG(reg: u8, n: c_int) -> c_uint {
    static inline unsigned int IN_FROM_REG(u8 reg, int n)
    {
    return SCALE(reg, nom_mv[n], 192);
    }
#[no_mangle]
pub unsafe extern "C" fn IN_TO_REG(val: c_ulong, n: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn FAN_FROM_REG(reg: u8, div: u8) -> c_uint {
...
// analog out 0..1250mV
#[no_mangle]
pub unsafe extern "C" fn AOUT_TO_REG(val: c_ulong) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn AOUT_FROM_REG(reg: u8) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adm9240_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub /: *mut *mut u8 fan_div[2]; / rw fan1_div, read-only accessor,
    pub /: *mut *mut u8 vrm; / -- vrm set on startup, no accessor,
}

// write new fan div, callers must hold data->update_lock
#[no_mangle]
unsafe extern "C" fn adm9240_write_fan_div(data: *mut adm9240_data, channel: c_int, fan_div: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adm9240_fan_min_write(data: *mut adm9240_data, channel: c_int, val: c_long) -> c_int {
    ...
    let mut new_min: c_uint = 1350000 / val;
    new_div = 0;
...
// check known chip manufacturer
    ...
    name = "adm9240";
#[no_mangle]
pub unsafe extern "C" fn if(0xda: man_id ==) -> else {
    else if (man_id == 0xda)
    name = "ds1780";
#[no_mangle]
pub unsafe extern "C" fn if(0x01: man_id ==) -> else {
    else if (man_id == 0x01)
    name = "lm81";
    else
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn adm9240_init_client(data: *mut adm9240_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_chip_read(dev: *mut device, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_intrusion_read(dev: *mut device, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_intrusion_write(dev: *mut device, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_in_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_in_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_fan_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_fan_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_temp_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_temp_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm9240_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adm9240_probe(client: *mut i2c_client) -> c_int {
