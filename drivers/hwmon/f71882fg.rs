...
//! Source: drivers/hwmon/f71882fg.c
#![no_std]
...
pub const SIO_F71858FG_LD_HWM: c_uint = 0x02	/* Hardware monitor logical device */;
pub const SIO_F71882FG_LD_HWM: c_uint = 0x04	/* Hardware monitor logical device */;
...
pub const SIO_F71808E_ID: c_uint = 0x0901	/* Chipset ID */;
pub const SIO_F71808A_ID: c_uint = 0x1001	/* Chipset ID */;
...
pub const SIO_F71889E_ID: c_uint = 0x0909	/* Chipset ID */;
pub const SIO_F71889A_ID: c_uint = 0x1005	/* Chipset ID */;
pub const SIO_F8000_ID: c_uint = 0x0581	/* Chipset ID */;
pub const SIO_F81768D_ID: c_uint = 0x1210	/* Chipset ID */;
pub const SIO_F81865_ID: c_uint = 0x0704	/* Chipset ID */;
pub const SIO_F81866_ID: c_uint = 0x1010	/* Chipset ID */;
pub const SIO_F71858AD_ID: c_uint = 0x0903	/* Chipset ID */;
pub const SIO_F81966_ID: c_uint = 0x1502	/* Chipset ID */;
pub const SIO_F81968_ID: c_uint = 0x1806	/* Chipset ID */;
pub const REGION_LENGTH: c_int = 8;
pub const ADDR_REG_OFFSET: c_int = 5;
pub const DATA_REG_OFFSET: c_int = 6;
pub const F71882FG_REG_IN_STATUS: c_uint = 0x12 /* f7188x only */;
pub const F71882FG_REG_IN_BEEP: c_uint = 0x13 /* f7188x only */;

pub const F71882FG_REG_IN1_HIGH: c_uint = 0x32 /* f7188x only */;
pub const F81866_REG_IN_STATUS: c_uint = 0x16 /* F81866 only */;
pub const F81866_REG_IN_BEEP: c_uint = 0x17 /* F81866 only */;
pub const F81866_REG_IN1_HIGH: c_uint = 0x3a /* F81866 only */;

pub const F71882FG_REG_FAN_STATUS: c_uint = 0x92;
pub const F71882FG_REG_FAN_BEEP: c_uint = 0x93;

pub const F71882FG_REG_TEMP_STATUS: c_uint = 0x62;
pub const F71882FG_REG_TEMP_BEEP: c_uint = 0x63;
pub const F71882FG_REG_TEMP_CONFIG: c_uint = 0x69;

pub const F71882FG_REG_TEMP_TYPE: c_uint = 0x6B;
pub const F71882FG_REG_TEMP_DIODE_OPEN: c_uint = 0x6F;

pub const F71882FG_REG_PWM_TYPE: c_uint = 0x94;
pub const F71882FG_REG_PWM_ENABLE: c_uint = 0x96;

pub const F71882FG_REG_FAN_FAULT_T: c_uint = 0x9F;
pub const F71882FG_FAN_NEG_TEMP_EN: c_uint = 0x20;
pub const F71882FG_FAN_PROG_SEL: c_uint = 0x80;

pub const F71882FG_REG_START: c_uint = 0x01;
pub const F71882FG_MAX_INS: c_int = 11;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f71882fg_sio_data {
    pub type: enum chips,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct f71882fg_data {
    pub addr: c_ushort,
    pub type: enum chips,
    pub hwmon_dev: *mut device,
    pub update_lock: mutex,
    pub /: *mut *mut int temp_start; / temp numbering start (0 or 1),
    pub /: *mut *mut bool valid; / true if following fields are valid,
    pub auto_point_temp_signed: c_char,
    pub /: *mut *mut unsigned long last_updated; / In jiffies,
    pub /: *mut *mut unsigned long last_limits; / In jiffies,
// Register Values
    pub in: [u8; F71882FG_MAX_INS],
    pub in1_max: u8,
    pub in_status: u8,
    pub in_beep: u8,
    pub fan: [u16; 4],
    pub fan_target: [u16; 4],
    pub fan_full_speed: [u16; 4],
    pub fan_status: u8,
    pub fan_beep: u8,
//
...
//
    ...
    pub temp_ovt: [u8; 4],
    pub temp_high: [u8; 4],
    pub /: *mut *mut u8 temp_hyst[2]; / 2 hysts stored per reg,
    pub temp_type: [u8; 4],
    pub temp_status: u8,
    pub temp_beep: u8,
    pub temp_diode_open: u8,
    pub temp_config: u8,
    pub pwm: [u8; 4],
    pub pwm_enable: u8,
    pub pwm_auto_point_hyst: [u8; 2],
    pub pwm_auto_point_mapping: [u8; 4],
    pub pwm_auto_point_pwm: [u8; 4][5],
    pub pwm_auto_point_temp: [i8; 4][4],
}

#[no_mangle]
unsafe extern "C" fn f71882fg_read8(data: *mut f71882fg_data, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn f71882fg_read16(data: *mut f71882fg_data, reg: u8) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn fan_from_reg(reg: u16) -> c_int {
    static inline int fan_from_reg(u16 reg)
    {
    return reg ? (1500000 / reg) : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn fan_to_reg(fan: c_int) -> u16 {
    static inline u16 fan_to_reg(int fan)
    {
    return fan ? (1500000 / fan) : 0;
    }
#[no_mangle]
unsafe extern "C" fn f71882fg_write8(data: *mut f71882fg_data, reg: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn f71882fg_write16(data: *mut f71882fg_data, reg: u8, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn f71882fg_read_temp(data: *mut f71882fg_data, nr: c_int) -> u16 {
    ...
    let mut nr_fans: c_int = f71882fg_nr_fans[data.type];
    let mut nr_temps: c_int = f71882fg_nr_temps[data.type];
    int nr, reg, point;
...
// Some models have 1 more fan with limited capabilities
    ...
    let mut nr: c_int = to_sensor_dev_attr_2(devattr).index;
    int sign, temp;
    if (data.type == f71858fg) {
...
//
    ...
    SENSOR_ATTR_2(temp1_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp1_max, S_IRUGO|S_IWUSR, show_temp_max,
    store_temp_max, 0, 0),
    SENSOR_ATTR_2(temp1_max_hyst, S_IRUGO|S_IWUSR, show_temp_max_hyst,
    store_temp_max_hyst, 0, 0),
    SENSOR_ATTR_2(temp1_max_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp1_crit, S_IRUGO|S_IWUSR, show_temp_crit,
    store_temp_crit, 0, 0),
    SENSOR_ATTR_2(temp1_crit_hyst, S_IRUGO, show_temp_crit_hyst, core::ptr::null_mut(),
    0, 0),
    SENSOR_ATTR_2(temp1_crit_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 4),
    SENSOR_ATTR_2(temp1_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp2_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(temp2_max, S_IRUGO|S_IWUSR, show_temp_max,
    store_temp_max, 0, 1),
    SENSOR_ATTR_2(temp2_max_hyst, S_IRUGO|S_IWUSR, show_temp_max_hyst,
    store_temp_max_hyst, 0, 1),
    SENSOR_ATTR_2(temp2_max_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(temp2_crit, S_IRUGO|S_IWUSR, show_temp_crit,
    store_temp_crit, 0, 1),
    SENSOR_ATTR_2(temp2_crit_hyst, S_IRUGO, show_temp_crit_hyst, core::ptr::null_mut(),
    0, 1),
    SENSOR_ATTR_2(temp2_crit_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 5),
    SENSOR_ATTR_2(temp2_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(temp3_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 2),
    SENSOR_ATTR_2(temp3_max, S_IRUGO|S_IWUSR, show_temp_max,
    store_temp_max, 0, 2),
    SENSOR_ATTR_2(temp3_max_hyst, S_IRUGO|S_IWUSR, show_temp_max_hyst,
    store_temp_max_hyst, 0, 2),
    SENSOR_ATTR_2(temp3_max_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 2),
    SENSOR_ATTR_2(temp3_crit, S_IRUGO|S_IWUSR, show_temp_crit,
    store_temp_crit, 0, 2),
    SENSOR_ATTR_2(temp3_crit_hyst, S_IRUGO, show_temp_crit_hyst, core::ptr::null_mut(),
    0, 2),
    SENSOR_ATTR_2(temp3_crit_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 6),
    SENSOR_ATTR_2(temp3_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 2),
    };
...
// Temp attr for the standard models
    ...
    SENSOR_ATTR_2(temp1_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(temp1_max, S_IRUGO|S_IWUSR, show_temp_max,
    store_temp_max, 0, 1),
    SENSOR_ATTR_2(temp1_max_hyst, S_IRUGO|S_IWUSR, show_temp_max_hyst,
    store_temp_max_hyst, 0, 1),
...
//
    SENSOR_ATTR_2(temp1_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(temp1_crit, S_IRUGO|S_IWUSR, show_temp_crit,
    store_temp_crit, 0, 1),
    SENSOR_ATTR_2(temp1_crit_hyst, S_IRUGO, show_temp_crit_hyst, core::ptr::null_mut(),
    0, 1),
    SENSOR_ATTR_2(temp1_crit_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 5),
    SENSOR_ATTR_2(temp1_type, S_IRUGO, show_temp_type, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(temp1_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 1),
    }, {
    SENSOR_ATTR_2(temp2_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 2),
    SENSOR_ATTR_2(temp2_max, S_IRUGO|S_IWUSR, show_temp_max,
    store_temp_max, 0, 2),
    SENSOR_ATTR_2(temp2_max_hyst, S_IRUGO|S_IWUSR, show_temp_max_hyst,
    store_temp_max_hyst, 0, 2),
// Should be temp2_max_alarm, see temp1_alarm note
    SENSOR_ATTR_2(temp2_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 2),
    SENSOR_ATTR_2(temp2_crit, S_IRUGO|S_IWUSR, show_temp_crit,
    store_temp_crit, 0, 2),
    SENSOR_ATTR_2(temp2_crit_hyst, S_IRUGO, show_temp_crit_hyst, core::ptr::null_mut(),
    0, 2),
    SENSOR_ATTR_2(temp2_crit_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 6),
    SENSOR_ATTR_2(temp2_type, S_IRUGO, show_temp_type, core::ptr::null_mut(), 0, 2),
    SENSOR_ATTR_2(temp2_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 2),
    }, {
    SENSOR_ATTR_2(temp3_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 3),
    SENSOR_ATTR_2(temp3_max, S_IRUGO|S_IWUSR, show_temp_max,
    store_temp_max, 0, 3),
    SENSOR_ATTR_2(temp3_max_hyst, S_IRUGO|S_IWUSR, show_temp_max_hyst,
    store_temp_max_hyst, 0, 3),
// Should be temp3_max_alarm, see temp1_alarm note
    SENSOR_ATTR_2(temp3_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 3),
    SENSOR_ATTR_2(temp3_crit, S_IRUGO|S_IWUSR, show_temp_crit,
    store_temp_crit, 0, 3),
    SENSOR_ATTR_2(temp3_crit_hyst, S_IRUGO, show_temp_crit_hyst, core::ptr::null_mut(),
    0, 3),
    SENSOR_ATTR_2(temp3_crit_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 7),
    SENSOR_ATTR_2(temp3_type, S_IRUGO, show_temp_type, core::ptr::null_mut(), 0, 3),
    SENSOR_ATTR_2(temp3_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 3),
    } };
...
//
    ...
    store_temp_max, 0, 0),
    SENSOR_ATTR_2(temp1_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 4),
    SENSOR_ATTR_2(temp1_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp2_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 1),
    ...
    store_temp_max, 0, 1),
    SENSOR_ATTR_2(temp2_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 5),
    SENSOR_ATTR_2(temp2_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(temp3_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0, 2),
    ...
    store_temp_max, 0, 2),
    SENSOR_ATTR_2(temp3_alarm, S_IRUGO, show_temp_alarm, core::ptr::null_mut(), 0, 6),
    SENSOR_ATTR_2(temp3_fault, S_IRUGO, show_temp_fault, core::ptr::null_mut(), 0, 2),
    };
...
// in attr for all models
    ...
    SENSOR_ATTR_2(in0_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(in1_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(in2_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 2),
    SENSOR_ATTR_2(in3_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 3),
    SENSOR_ATTR_2(in4_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 4),
    SENSOR_ATTR_2(in5_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 5),
    SENSOR_ATTR_2(in6_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 6),
    SENSOR_ATTR_2(in7_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 7),
    SENSOR_ATTR_2(in8_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 8),
    SENSOR_ATTR_2(in9_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 9),
    SENSOR_ATTR_2(in10_input, S_IRUGO, show_in, core::ptr::null_mut(), 0, 10),
    };
...
// For models with in1 alarm capability
    ...
    0, 1),
    SENSOR_ATTR_2(in1_alarm, S_IRUGO, show_in_alarm, core::ptr::null_mut(), 0, 1),
    };
    ...
    struct f71882fg_data *data = f71882fg_update_device(dev);
    let mut nr: c_int = to_sensor_dev_attr_2(devattr).index;
    let mut speed: c_int = fan_from_reg(data.fan[nr]);
    ...
    struct f71882fg_data *data = f71882fg_update_device(dev);
    let mut nr: c_int = to_sensor_dev_attr_2(devattr).index;
    let mut speed: c_int = fan_from_reg(data.fan_full_speed[nr]);
    return sprintf(buf, "%d\n", speed);
    }
...
// Fan / PWM attr common to all models
    ...
    SENSOR_ATTR_2(fan1_input, S_IRUGO, show_fan, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(fan1_full_speed, S_IRUGO|S_IWUSR,
    show_fan_full_speed,
    store_fan_full_speed, 0, 0),
    SENSOR_ATTR_2(fan1_alarm, S_IRUGO, show_fan_alarm, core::ptr::null_mut(), 0, 0),
    ...
    SENSOR_ATTR_2(fan2_input, S_IRUGO, show_fan, core::ptr::null_mut(), 0, 1),
    SENSOR_ATTR_2(fan2_full_speed, S_IRUGO|S_IWUSR,
    show_fan_full_speed,
    store_fan_full_speed, 0, 1),
    SENSOR_ATTR_2(fan2_alarm, S_IRUGO, show_fan_alarm, core::ptr::null_mut(), 0, 1),
    ...
    SENSOR_ATTR_2(fan3_input, S_IRUGO, show_fan, core::ptr::null_mut(), 0, 2),
    SENSOR_ATTR_2(fan3_full_speed, S_IRUGO|S_IWUSR,
    show_fan_full_speed,
    store_fan_full_speed, 0, 2),
    SENSOR_ATTR_2(fan3_alarm, S_IRUGO, show_fan_alarm, core::ptr::null_mut(), 0, 2),
    ...
    SENSOR_ATTR_2(fan4_input, S_IRUGO, show_fan, core::ptr::null_mut(), 0, 3),
    SENSOR_ATTR_2(fan4_full_speed, S_IRUGO|S_IWUSR,
    show_fan_full_speed,
    store_fan_full_speed, 0, 3),
    SENSOR_ATTR_2(fan4_alarm, S_IRUGO, show_fan_alarm, core::ptr::null_mut(), 0, 3),
...
// Attr for models which can beep on Fan alarm
    ...
    int result;
    struct f71882fg_data *data = f71882fg_update_device(dev);
    let mut pwm: c_int = to_sensor_dev_attr_2(devattr).index;
    let mut point: c_int = to_sensor_dev_attr_2(devattr).nr;
    mutex_lock(&data.update_lock);
...
//
    ...
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 3, 0),
    }, {
    ...
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 3, 1),
    }, {
    ...
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 3, 2),
    } };
//
...
// PWM attr for the standard models
    ...
    0, 0),
    SENSOR_ATTR_2(pwm1_auto_point2_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 1, 0),
    SENSOR_ATTR_2(pwm1_auto_point3_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 2, 0),
    ...
    0, 1),
    SENSOR_ATTR_2(pwm2_auto_point2_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 1, 1),
    SENSOR_ATTR_2(pwm2_auto_point3_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 2, 1),
    ...
    0, 2),
    SENSOR_ATTR_2(pwm3_auto_point2_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 1, 2),
    SENSOR_ATTR_2(pwm3_auto_point3_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 2, 2),
    ...
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 1, 3),
    SENSOR_ATTR_2(pwm4_auto_point3_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 2, 3),
    SENSOR_ATTR_2(pwm4_auto_point4_temp_hyst, S_IRUGO,
    show_pwm_auto_point_temp_hyst, core::ptr::null_mut(), 3, 3),
    } };
...
#[no_mangle]
unsafe extern "C" fn f71882fg_remove(pdev: *mut platform_device) {
    ...
    let mut nr_temps: c_int = f71882fg_nr_temps[data.type];
    int i;
    let mut start_reg: u8 = f71882fg_read8(data, F71882FG_REG_START);
    if (data.hwmon_dev)
...
#[no_mangle]
unsafe extern "C" fn f71882fg_probe(pdev: *mut platform_device) -> c_int {
    static int f71882fg_probe(struct platform_device *pdev)
    {
    struct f71882fg_data *data;
    struct f71882fg_sio_data *sio_data = dev_get_platdata(&pdev.dev);
    let mut nr_fans: c_int = f71882fg_nr_fans[sio_data.type];
    let mut nr_temps: c_int = f71882fg_nr_temps[sio_data.type];
    int err, i;
    int size;
    u8 start_reg, reg;
...
// Some types have 1 extra fan with limited functionality
    ...
    data.hwmon_dev = core::ptr::null_mut();
    goto exit_unregister_sysfs;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn f71882fg_find(sioaddr: c_int, sio_data: *mut f71882fg_sio_data) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn f71882fg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn f71882fg_exit() -> void __exit {
