...
pub const TMP51X_SHUNT_CONFIG: c_uint = 0x00;
pub const TMP51X_TEMP_CONFIG: c_uint = 0x01;
pub const TMP51X_STATUS: c_uint = 0x02;
pub const TMP51X_SMBUS_ALERT: c_uint = 0x03;
pub const TMP51X_SHUNT_CURRENT_RESULT: c_uint = 0x04;
pub const TMP51X_BUS_VOLTAGE_RESULT: c_uint = 0x05;
pub const TMP51X_POWER_RESULT: c_uint = 0x06;
pub const TMP51X_BUS_CURRENT_RESULT: c_uint = 0x07;
pub const TMP51X_LOCAL_TEMP_RESULT: c_uint = 0x08;
pub const TMP51X_REMOTE_TEMP_RESULT_1: c_uint = 0x09;
pub const TMP51X_REMOTE_TEMP_RESULT_2: c_uint = 0x0A;
pub const TMP51X_SHUNT_CURRENT_H_LIMIT: c_uint = 0x0C;
pub const TMP51X_SHUNT_CURRENT_L_LIMIT: c_uint = 0x0D;
pub const TMP51X_BUS_VOLTAGE_H_LIMIT: c_uint = 0x0E;
pub const TMP51X_BUS_VOLTAGE_L_LIMIT: c_uint = 0x0F;
pub const TMP51X_POWER_LIMIT: c_uint = 0x10;
pub const TMP51X_LOCAL_TEMP_LIMIT: c_uint = 0x11;
pub const TMP51X_REMOTE_TEMP_LIMIT_1: c_uint = 0x12;
pub const TMP51X_REMOTE_TEMP_LIMIT_2: c_uint = 0x13;
pub const TMP51X_SHUNT_CALIBRATION: c_uint = 0x15;
pub const TMP51X_N_FACTOR_AND_HYST_1: c_uint = 0x16;
pub const TMP51X_N_FACTOR_2: c_uint = 0x17;
pub const TMP51X_MAN_ID_REG: c_uint = 0xFE;
pub const TMP51X_DEVICE_ID_REG: c_uint = 0xFF;
// TMP513 specific register definition
pub const TMP513_REMOTE_TEMP_RESULT_3: c_uint = 0x0B;
pub const TMP513_REMOTE_TEMP_LIMIT_3: c_uint = 0x14;
pub const TMP513_N_FACTOR_3: c_uint = 0x18;
// Common attrs, and NULL
pub const TMP51X_MANUFACTURER_ID: c_uint = 0x55FF;
pub const TMP512_DEVICE_ID: c_uint = 0x22FF;
pub const TMP513_DEVICE_ID: c_uint = 0x23FF;
// Default config
pub const TMP51X_SHUNT_CONFIG_DEFAULT: c_uint = 0x399F;
pub const TMP51X_SHUNT_VALUE_DEFAULT: c_int = 1000;

pub const TMP51X_PGA_DEFAULT: c_int = 8;
pub const TMP51X_MAX_REGISTER_ADDR: c_uint = 0xFF;
// Mask and shift
pub const CURRENT_SENSE_VOLTAGE_320_MASK: c_uint = 0x1800;
pub const CURRENT_SENSE_VOLTAGE_160_MASK: c_uint = 0x1000;
pub const CURRENT_SENSE_VOLTAGE_80_MASK: c_uint = 0x0800;
pub const CURRENT_SENSE_VOLTAGE_40_MASK: c_int = 0;
pub const TMP51X_BUS_VOLTAGE_MASK: c_uint = 0x2000;
pub const TMP51X_NFACTOR_MASK: c_uint = 0xFF00;
pub const TMP51X_HYST_MASK: c_uint = 0x00FF;
pub const TMP51X_BUS_VOLTAGE_SHIFT: c_int = 3;
pub const TMP51X_TEMP_SHIFT: c_int = 3;
// Alarms
pub const TMP51X_SHUNT_CURRENT_H_LIMIT_POS: c_int = 15;
pub const TMP51X_SHUNT_CURRENT_L_LIMIT_POS: c_int = 14;
pub const TMP51X_BUS_VOLTAGE_H_LIMIT_POS: c_int = 13;
pub const TMP51X_BUS_VOLTAGE_L_LIMIT_POS: c_int = 12;
pub const TMP51X_POWER_LIMIT_POS: c_int = 11;
pub const TMP51X_LOCAL_TEMP_LIMIT_POS: c_int = 10;
pub const TMP51X_REMOTE_TEMP_LIMIT_1_POS: c_int = 9;
pub const TMP51X_REMOTE_TEMP_LIMIT_2_POS: c_int = 8;
pub const TMP513_REMOTE_TEMP_LIMIT_3_POS: c_int = 7;

// Max and Min value
pub const MAX_BUS_VOLTAGE_32_LIMIT: c_int = 32764;
pub const MAX_BUS_VOLTAGE_16_LIMIT: c_int = 16382;
// Max possible value is -256 to +256 but datasheet indicated -40 to 125.
pub const MAX_TEMP_LIMIT: c_int = 125000;

pub const MAX_TEMP_HYST: c_int = 127500;
pub const TMP512_MAX_CHANNELS: c_int = 3;
pub const TMP513_MAX_CHANNELS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tmp51x_data {
    pub shunt_config: u16,
    pub pga_gain: u16,
    pub vbus_range_uvolt: u32,
    pub temp_config: u16,
    pub nfactor: [u32; 3],
    pub shunt_uohms: u32,
    pub curr_lsb_ua: u32,
...
#[no_mangle]
pub unsafe extern "C" fn tmp51x_get_pga_shift(data: *mut tmp51x_data) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn tmp51x_set_value(data: *mut tmp51x_data, reg: u8, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmp51x_get_reg(type: enum hwmon_sensor_types, attr: u32, channel: c_int) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn tmp51x_calibrate(data: *mut tmp51x_data) -> c_int {
    static int tmp51x_calibrate(struct tmp51x_data *data)
    {
    let mut vshunt_max: c_int = data.pga_gain * 40;
    u64 max_curr_ma;
    u32 div;
//
...
//
#[no_mangle]
unsafe extern "C" fn tmp51x_init(data: *mut tmp51x_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmp51x_pga_gain_to_reg(dev: *mut device, data: *mut tmp51x_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmp51x_read_properties(dev: *mut device, data: *mut tmp51x_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmp51x_use_default(data: *mut tmp51x_data) {
...
#[no_mangle]
unsafe extern "C" fn tmp51x_configure(dev: *mut device, data: *mut tmp51x_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmp51x_probe(client: *mut i2c_client) -> c_int {
