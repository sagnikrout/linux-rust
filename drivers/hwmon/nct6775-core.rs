...
//! Source: drivers/hwmon/nct6775-core.c
#![no_std]
...
// Macro flag: #define USE_ALTERNATE
...
pub const NCT6775_REG_VBAT: c_uint = 0x5D;
pub const NCT6775_REG_DIODE: c_uint = 0x5E;
pub const NCT6775_DIODE_MASK: c_uint = 0x02;
...
pub const NCT6775_TEMP_MASK: c_uint = 0x001ffffe;
pub const NCT6775_VIRT_TEMP_MASK: c_uint = 0x00000000;
...
pub const NCT6776_TEMP_MASK: c_uint = 0x007ffffe;
pub const NCT6776_VIRT_TEMP_MASK: c_uint = 0x00000000;
...
pub const NCT6779_CRITICAL_PWM_ENABLE_MASK: c_uint = 0x01;
...
pub const NCT6779_TEMP_MASK: c_uint = 0x07ffff7e;
pub const NCT6779_VIRT_TEMP_MASK: c_uint = 0x00000000;
pub const NCT6791_TEMP_MASK: c_uint = 0x87ffff7e;
pub const NCT6791_VIRT_TEMP_MASK: c_uint = 0x80000000;
...
pub const NCT6792_TEMP_MASK: c_uint = 0x9fffff7e;
pub const NCT6792_VIRT_TEMP_MASK: c_uint = 0x80000000;
...
pub const NCT6793_TEMP_MASK: c_uint = 0xbfff037e;
pub const NCT6793_VIRT_TEMP_MASK: c_uint = 0x80000000;
...
pub const NCT6795_TEMP_MASK: c_uint = 0xbfffff7e;
pub const NCT6795_VIRT_TEMP_MASK: c_uint = 0x80000000;
...
pub const NCT6796_TEMP_MASK: c_uint = 0xbfff0ffe;
pub const NCT6796_VIRT_TEMP_MASK: c_uint = 0x80000c00;
...
pub const NCT6798_TEMP_MASK: c_uint = 0xbfff0ffe;
pub const NCT6798_VIRT_TEMP_MASK: c_uint = 0x80000c00;
...
pub const NCT6799_TEMP_MASK: c_uint = 0xbfff2ffe;
pub const NCT6799_VIRT_TEMP_MASK: c_uint = 0x80000c00;
// NCT6102D/NCT6106D specific data
pub const NCT6106_REG_VBAT: c_uint = 0x318;
pub const NCT6106_REG_DIODE: c_uint = 0x319;
pub const NCT6106_DIODE_MASK: c_uint = 0x01;
...
pub const NCT6106_CRITICAL_PWM_ENABLE_MASK: c_uint = 0x10;
...
#[no_mangle]
unsafe extern "C" fn reg_to_pwm_enable(pwm: c_int, mode: c_int) -> enum pwm_enable {
...
#[no_mangle]
unsafe extern "C" fn pwm_enable_to_reg(mode: enum pwm_enable) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn step_time_from_reg(reg: u8, mode: u8) -> c_uint {
    static unsigned int step_time_from_reg(u8 reg, u8 mode)
    {
    return mode ? 400 * reg : 100 * reg;
    }
#[no_mangle]
unsafe extern "C" fn step_time_to_reg(msec: c_uint, mode: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn fan_from_reg8(reg: u16, divreg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn fan_from_reg13(reg: u16, divreg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn fan_from_reg16(reg: u16, divreg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn fan_from_reg_rpm(reg: u16, divreg: c_uint) -> c_uint {
    static unsigned int fan_from_reg_rpm(u16 reg, unsigned int divreg)
    {
    return reg;
    }
#[no_mangle]
unsafe extern "C" fn fan_to_reg(fan: u32, divreg: c_uint) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn in_from_reg(reg: u8, nr: u8, scales: *const u16) -> c_long {
    static inline long in_from_reg(u8 reg, u8 nr, const u16 *scales)
    {
    return DIV_ROUND_CLOSEST(reg * scales[nr], 100);
    }
#[no_mangle]
pub unsafe extern "C" fn in_to_reg(val: u32, nr: u8, scales: *const u16) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn tsi_temp_from_reg(reg: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nct6775_reg_is_word_sized(data: *mut nct6775_data, reg: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nct6775_read_temp(data: *mut nct6775_data, reg: u16, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6775_write_fan_div(data: *mut nct6775_data, nr: c_int) -> c_int {
    static int nct6775_write_fan_div(struct nct6775_data *data, int nr)
    {
    u16 reg;
    int err;
    let mut fandiv_reg: u16 = nr < 2 ? NCT6775_REG_FANDIV1 : NCT6775_REG_FANDIV2;
...
#[no_mangle]
unsafe extern "C" fn nct6775_write_fan_div_common(data: *mut nct6775_data, nr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6775_update_fan_div(data: *mut nct6775_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6775_update_fan_div_common(data: *mut nct6775_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6775_init_fan_div(data: *mut nct6775_data) -> c_int {
...
//
    ...
    {
    int err;
    let mut fan_div: u8 = data.fan_div[nr];
    u16 fan_min;
    if (!data.has_fan_div)
    return 0;
//
...
//
    ...
    fan_div++;
#[no_mangle]
pub unsafe extern "C" fn if(0: reg != 0x00 && reg < 0x30 && fan_div >) -> else {
...
#[no_mangle]
unsafe extern "C" fn nct6775_update_pwm(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6775_update_pwm_limits(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_temp_source(data: *mut nct6775_data, index: c_int, count: c_int) -> c_int {
    static int find_temp_source(struct nct6775_data *data, int index, int count)
    {
    let mut source: c_int = data.temp_src[index];
    int nr, err;
...
//
    ...
    if (nr >= 0) {
    let mut bit: c_int = data.ALARM_BITS[nr + TEMP_ALARM_BASE];
    ...
    struct sensor_device_attribute_2 *sattr = to_sensor_dev_attr_2(attr);
    struct nct6775_data *data = dev_get_drvdata(dev);
    let mut nr: c_int = data.BEEP_BITS[sattr.index];
    let mut regindex: c_int = nr >> 3;
    unsigned long val;
    int err;
    err = kstrtoul(buf, 10, &val);
    if (err < 0)
...
//
    ...
    if (nr >= 0) {
    let mut bit: c_int = data.BEEP_BITS[nr + TEMP_ALARM_BASE];
    ...
    SENSOR_TEMPLATE_2(in_input, "in%d_input", 0444, show_in_reg, core::ptr::null_mut(), 0, 0);
    SENSOR_TEMPLATE(in_alarm, "in%d_alarm", 0444, nct6775_show_alarm, core::ptr::null_mut(), 0);
...
// Give the chip time to sample a new speed value
    ...
    SENSOR_TEMPLATE(fan_input, "fan%d_input", 0444, show_fan, core::ptr::null_mut(), 0);
    SENSOR_TEMPLATE(fan_alarm, "fan%d_alarm", 0444, nct6775_show_alarm, core::ptr::null_mut(), FAN_ALARM_BASE);
    ...
    SENSOR_TEMPLATE(fan_div, "fan%d_div", 0444, show_fan_div, core::ptr::null_mut(), 0);
//
...
// offset and type only apply to fixed sensors
    ...
    SENSOR_TEMPLATE_2(temp_input, "temp%d_input", 0444, show_temp, core::ptr::null_mut(), 0, 0);
    SENSOR_TEMPLATE(temp_label, "temp%d_label", 0444, show_temp_label, core::ptr::null_mut(), 0);
    ...
    SENSOR_TEMPLATE(temp_alarm, "temp%d_alarm", 0444, show_temp_alarm, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn show_tsi_temp(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_tsi_temp_label(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    SENSOR_TEMPLATE(tsi_temp_input, "temp%d_input", 0444, show_tsi_temp, core::ptr::null_mut(), 0);
    SENSOR_TEMPLATE(tsi_temp_label, "temp%d_label", 0444, show_tsi_temp_label, core::ptr::null_mut(), 0);
    static umode_t nct6775_tsi_temp_is_visible(struct kobject *kobj, struct attribute *attr,
    int index)
    {
    struct device *dev = kobj_to_dev(kobj);
    struct nct6775_data *data = dev_get_drvdata(dev);
    let mut temp: c_int = index / 2;
...
#[no_mangle]
unsafe extern "C" fn check_trip_points(data: *mut nct6775_data, nr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_update_registers(data: *mut nct6775_data, nr: c_int) -> c_int {
...
//
    ...
    if (target) {
    let mut low: c_int = target - data.target_speed_tolerance[nr];
    let mut high: c_int = target + data.target_speed_tolerance[nr];
    if (low <= 0)
    low = 1;
    if (high > 0xffff)
    high = 0xffff;
...
// Smart Fan registers
    ...
    struct sensor_device_attribute_2 *sattr = to_sensor_dev_attr_2(attr);
    let mut nr: c_int = sattr.nr;
    let mut point: c_int = sattr.index;
    unsigned long val;
    int err;
    u16 reg;
    err = kstrtoul(buf, 10, &val);
...
//
    ...
    return 0;
    if (nr == 19 && data.REG_PWM[3] == core::ptr::null_mut()) /* pwm_max */
    return 0;
    if (nr == 20 && data.REG_PWM[4] == core::ptr::null_mut()) /* pwm_step */
    return 0;
    if (nr == 21 && data.REG_PWM[6] == core::ptr::null_mut()) /* weight_duty_base */
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn nct6775_init_device(data: *mut nct6775_data) -> c_int {
...
// mask |= BIT(src);
    ...
    const u16 *reg_temp_crit_l = core::ptr::null_mut(), *reg_temp_crit_h = core::ptr::null_mut();
    int num_reg_temp, num_reg_temp_mon, num_reg_tsi_temp;
    int num_reg_temp_config;
    struct device *hwmon_dev;
    struct sensor_template_group tsi_temp_tg;
    data.regmap = devm_regmap_init(dev, core::ptr::null_mut(), data, regmapcfg);
...
#[no_mangle]
pub unsafe extern "C" fn if(1]: reg_temp_crit[src -) -> else {
