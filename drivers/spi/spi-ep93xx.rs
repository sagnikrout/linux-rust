...
//! Source: drivers/spi/spi-ep93xx.c
#![no_std]
...
pub const SSPCR0: c_uint = 0x0000;

pub const SSPCR0_SCR_SHIFT: c_int = 8;
pub const SSPCR1: c_uint = 0x0004;

pub const SSPDR: c_uint = 0x0008;
pub const SSPSR: c_uint = 0x000c;

pub const SSPCPSR: c_uint = 0x0010;
pub const SSPIIR: c_uint = 0x0014;

// timeout in milliseconds
pub const SPI_TIMEOUT: c_int = 5;
// maximum depth of RX/TX FIFO
pub const SPI_FIFO_SIZE: c_int = 8;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ep93xx_spi {
    pub clk: *mut clk,
    pub mmio: *mut void __iomem,
    pub sspdr_phys: c_ulong,
    pub tx: usize,
    pub rx: usize,
...
//
    ...
    let mut spi_clk_rate: c_ulong = clk_get_rate(espi.clk);
    int cpsr, scr;
//
...
// div_cpsr = (u8)cpsr;
    ...
    {
    struct ep93xx_spi *espi = spi_controller_get_devdata(host);
    let mut dss: u8 = bits_per_word_to_dss(xfer.bits_per_word);
    let mut div_cpsr: u8 = 0;
    let mut div_scr: u8 = 0;
    u16 cr0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn ep93xx_do_write(host: *mut spi_controller) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_do_read(host: *mut spi_controller) {
...
//
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_read_write(host: *mut spi_controller) -> c_int {
...
//
    ...
    let mut bytes: usize = min_t(size_t, len, PAGE_SIZE);
    if (buf) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_dma_callback(callback_param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_dma_transfer(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_prepare_hardware(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_unprepare_hardware(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_setup_dma(dev: *mut device, espi: *mut ep93xx_spi) -> c_int {
    ...
    espi.zeropage = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_release_dma(espi: *mut ep93xx_spi) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    espi.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(espi.clk)) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_spi_remove(pdev: *mut platform_device) {
