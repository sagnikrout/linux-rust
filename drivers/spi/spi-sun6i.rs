...
//! Source: drivers/spi/spi-sun6i.c
#![no_std]
...
pub const SUN6I_AUTOSUSPEND_TIMEOUT: c_int = 2000;
pub const SUN6I_FIFO_DEPTH: c_int = 128;
pub const SUN8I_FIFO_DEPTH: c_int = 64;
pub const SUN6I_GBL_CTL_REG: c_uint = 0x04;

pub const SUN6I_TFR_CTL_REG: c_uint = 0x08;

pub const SUN6I_TFR_CTL_CS_MASK: c_uint = 0x30;

pub const SUN6I_INT_CTL_REG: c_uint = 0x10;

pub const SUN6I_INT_STA_REG: c_uint = 0x14;
pub const SUN6I_FIFO_CTL_REG: c_uint = 0x18;
pub const SUN6I_FIFO_CTL_RF_RDY_TRIG_LEVEL_MASK: c_uint = 0xff;

pub const SUN6I_FIFO_CTL_RF_RDY_TRIG_LEVEL_BITS: c_int = 0;

pub const SUN6I_FIFO_CTL_TF_ERQ_TRIG_LEVEL_MASK: c_uint = 0xff;
pub const SUN6I_FIFO_CTL_TF_ERQ_TRIG_LEVEL_BITS: c_int = 16;

pub const SUN6I_FIFO_STA_REG: c_uint = 0x1c;

pub const SUN6I_CLK_CTL_REG: c_uint = 0x24;
pub const SUN6I_CLK_CTL_CDR2_MASK: c_uint = 0xff;

pub const SUN6I_CLK_CTL_CDR1_MASK: c_uint = 0xf;

pub const SUN6I_MAX_XFER_SIZE: c_uint = 0xffffff;
pub const SUN6I_BURST_CNT_REG: c_uint = 0x30;
pub const SUN6I_XMIT_CNT_REG: c_uint = 0x34;
pub const SUN6I_BURST_CTL_CNT_REG: c_uint = 0x38;

pub const SUN6I_TXDATA_REG: c_uint = 0x200;
pub const SUN6I_RXDATA_REG: c_uint = 0x300;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun6i_spi_cfg {
    pub fifo_depth: c_ulong,
    pub has_clk_ctl: bool,
    pub mode_bits: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun6i_spi {
    ...
    pub done: completion,
    pub dma_rx_done: completion,
    pub tx_buf: *const u8,
    pub rx_buf: *mut u8,
    pub len: c_int,
    pub cfg: *const sun6i_spi_cfg,
}

#[no_mangle]
pub unsafe extern "C" fn sun6i_spi_read(sspi: *mut sun6i_spi, reg: u32) -> u32 {
    static inline u32 sun6i_spi_read(struct sun6i_spi *sspi, u32 reg)
    {
    return readl(sspi.base_addr + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn sun6i_spi_write(sspi: *mut sun6i_spi, reg: u32, value: u32) {
    static inline void sun6i_spi_write(struct sun6i_spi *sspi, u32 reg, u32 value)
    {
    writel(value, sspi.base_addr + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn sun6i_spi_get_rx_fifo_count(sspi: *mut sun6i_spi) -> u32 {
    static inline u32 sun6i_spi_get_rx_fifo_count(struct sun6i_spi *sspi)
    {
    let mut reg: u32 = sun6i_spi_read(sspi, SUN6I_FIFO_STA_REG);
    return FIELD_GET(SUN6I_FIFO_STA_RF_CNT_MASK, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn sun6i_spi_get_tx_fifo_count(sspi: *mut sun6i_spi) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sun6i_spi_disable_interrupt(sspi: *mut sun6i_spi, mask: u32) {
    static inline void sun6i_spi_disable_interrupt(struct sun6i_spi *sspi, u32 mask)
    {
    let mut reg: u32 = sun6i_spi_read(sspi, SUN6I_INT_CTL_REG);
    reg &= ~mask;
    sun6i_spi_write(sspi, SUN6I_INT_CTL_REG, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn sun6i_spi_drain_fifo(sspi: *mut sun6i_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn sun6i_spi_fill_fifo(sspi: *mut sun6i_spi) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_spi_set_cs(spi: *mut spi_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_spi_max_transfer_size(spi: *mut spi_device) -> usize {
    static size_t sun6i_spi_max_transfer_size(struct spi_device *spi)
    {
    return SUN6I_MAX_XFER_SIZE - 1;
    }
#[no_mangle]
unsafe extern "C" fn sun6i_spi_dma_rx_cb(param: *mut c_void) {
    ...
    let mut tx_len: c_uint = 0, rx_len = 0, nbits = 0;
    bool use_dma;
    let mut ret: c_int = 0;
    u32 reg;
...
// We want to control the chip select manually
    ...
    let mut mclk_rate: c_uint = clk_get_rate(sspi.mclk);
...
#[no_mangle]
pub unsafe extern "C" fn if(80000000: tfr->effective_speed_hz >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn sun6i_spi_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t sun6i_spi_handler(int irq, void *dev_id)
    {
    struct sun6i_spi *sspi = dev_id;
    let mut status: u32 = sun6i_spi_read(sspi, SUN6I_INT_STA_REG);
// Transfer complete
...
#[no_mangle]
unsafe extern "C" fn sun6i_spi_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun6i_spi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun6i_spi_probe(pdev: *mut platform_device) -> c_int {
    ...
    sspi.rstc = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(sspi.rstc)) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_spi_remove(pdev: *mut platform_device) {
