...
//! Source: drivers/spi/spi-aspeed-smc.c
#![no_std]
...
pub const CONFIG_REG: c_uint = 0x0;
pub const CONFIG_TYPE_SPI: c_uint = 0x2;
// CE Control Register
pub const CE_CTRL_REG: c_uint = 0x4;
// CEx Control Register
pub const CE0_CTRL_REG: c_uint = 0x10;

pub const CTRL_IO_SINGLE_DATA: c_uint = 0x0;

pub const CTRL_COMMAND_SHIFT: c_int = 16;

    (((((dummy) >> 2) & 0x1) << 14) | (((dummy) & 0x3) << 6))
pub const CTRL_FREQ_SEL_SHIFT: c_int = 8;

pub const CTRL_IO_MODE_NORMAL: c_uint = 0x0;
pub const CTRL_IO_MODE_READ: c_uint = 0x1;
pub const CTRL_IO_MODE_WRITE: c_uint = 0x2;
pub const CTRL_IO_MODE_USER: c_uint = 0x3;
pub const CTRL_IO_CMD_MASK: c_uint = 0xf0ff40c3;
// CEx Address Decoding Range Register
pub const CE0_SEGMENT_ADDR_REG: c_uint = 0x30;
pub const FULL_DUPLEX_RX_DATA: c_uint = 0x1e4;
// CEx Read timing compensation register
pub const CE0_TIMING_COMPENSATION_REG: c_uint = 0x94;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_spi_chip {
    pub aspi: *mut aspeed_spi,
    pub cs: u32,
    pub ctl: *mut void __iomem,
    pub ahb_base: *mut void __iomem,
    pub ahb_window_size: u32,
    pub ctl_val: [u32; ASPEED_SPI_MAX],
    pub clk_freq: u32,
...
pub struct aspeed_spi_data {
    ...
    pub reg): *mut *mut *mut phys_addr_t (segment_start)(struct aspeed_spi aspi, u32,
    pub reg): *mut *mut *mut phys_addr_t (segment_end)(struct aspeed_spi aspi, u32,
    u32 (*segment_reg)(struct aspeed_spi *aspi, phys_addr_t start,
    pub end): phys_addr_t,
    pub aspi): *mut *mut int (adjust_window)(struct aspeed_spi,
    pub hz): *mut *mut *mut u32 (get_clk_div)(struct aspeed_spi_chip chip, u32,
    int (*calibrate)(struct aspeed_spi_chip *chip, u32 hdiv,
    pub test_buf): *const *const u8 golden_buf, u8,
}

pub const ASPEED_SPI_MAX_NUM_CS: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_spi {
    pub data: *const aspeed_spi_data,
    pub regs: *mut void __iomem,
    pub ahb_base_phy: phys_addr_t,
    pub ahb_window_size: u32,
    pub num_cs: u32,
    pub dev: *mut device,
    pub clk: *mut clk,
    pub clk_freq: u32,
    pub cs_change: u8,
    pub chips: [aspeed_spi_chip; ASPEED_SPI_MAX_NUM_CS],
}

#[no_mangle]
unsafe extern "C" fn aspeed_spi_get_io_mode(op: *const spi_mem_op) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_set_io_mode(chip: *mut aspeed_spi_chip, io_mode: u32) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_start_user(chip: *mut aspeed_spi_chip) {
    static void aspeed_spi_start_user(struct aspeed_spi_chip *chip)
    {
    let mut ctl: u32 = chip.ctl_val[ASPEED_SPI_BASE];
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_stop_user(chip: *mut aspeed_spi_chip) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_read_from_ahb(buf: *mut c_void, src: *mut void __iomem, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_write_to_ahb(dst: *mut void __iomem, buf: *const c_void, len: usize) -> c_int {
    ...
    {
    let mut io_mode: c_int = aspeed_spi_get_io_mode(op);
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_set_window(aspi: *mut aspeed_spi) -> c_int {
    ...
    aspi.chips[cs].ahb_base = core::ptr::null_mut();
    }
    }
    for (cs = 0; cs < aspi.data.max_cs; cs++) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_chip_set_default_window(aspi: *mut aspeed_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aspeed_spi_trim_window_size(aspi: *mut aspeed_spi) -> c_int {
    static int aspeed_spi_trim_window_size(struct aspeed_spi *aspi)
    {
    struct aspeed_spi_chip *chips = aspi.chips;
    size_t total_sz;
    let mut cs: c_int = aspi.data.max_cs - 1;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn aspeed_adjust_window_ast2400(aspi: *mut aspeed_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aspeed_adjust_window_ast2500(aspi: *mut aspeed_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adjust_window_ast2600(aspi: *mut aspeed_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_dirmap_create(desc: *mut spi_mem_dirmap_desc) -> c_int {
...
// Tune 4BYTE address mode
    if (op.addr.nbytes) {
    let mut addr_mode: u32 = readl(aspi.regs + CE_CTRL_REG);
    if (op.addr.nbytes == 4)
    addr_mode |= (0x11 << chip.cs);
    else
    addr_mode &= ~(0x11 << chip.cs);
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_chip_set_type(aspi: *mut aspeed_spi, cs: c_uint, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_chip_enable(aspi: *mut aspeed_spi, cs: c_uint, enable: bool) {
    static void aspeed_spi_chip_enable(struct aspeed_spi *aspi, unsigned int cs, bool enable)
    {
    let mut we_bit: u32 = BIT(aspi.data.we0 + cs);
    let mut reg: u32 = readl(aspi.regs + CONFIG_REG);
    if (enable)
    reg |= we_bit;
    else
    reg &= ~we_bit;
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_cleanup(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_enable(aspi: *mut aspeed_spi, enable: bool) {
    ...
    struct aspeed_spi_chip *chip = &aspi.chips[cs];
    u32 ctrl_val;
    let mut clk_div: u32 = data.get_clk_div(chip, spi.max_speed_hz);
    ...
    {
    const struct aspeed_spi_data *data = aspi.data;
    let mut full_duplex_transfer: bool = data.full_duplex && tx_buf == rx_buf;
    u32 i;
...
#[no_mangle]
pub unsafe extern "C" fn if(SPI_TX_QUAD: spi->mode &) -> else {
    ...
    aspeed_spi_set_io_mode(chip, CTRL_IO_DUAL_DATA);
#[no_mangle]
pub unsafe extern "C" fn if(SPI_RX_QUAD: spi->mode &) -> else {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_probe(pdev: *mut platform_device) -> c_int {
    ...
    aspi.clk = devm_clk_get_enabled(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(aspi.clk)) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_remove(pdev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn aspeed_spi_segment_start(aspi: *mut aspeed_spi, reg: u32) -> phys_addr_t {
    static phys_addr_t aspeed_spi_segment_start(struct aspeed_spi *aspi, u32 reg)
    {
    return ((reg >> 16) & 0xFF) << 23;
    }
#[no_mangle]
unsafe extern "C" fn aspeed_spi_segment_end(aspi: *mut aspeed_spi, reg: u32) -> phys_addr_t {
...
pub const AST2700_SEG_ADDR_MASK: c_uint = 0x7fff0000;
    static phys_addr_t aspeed_spi_segment_ast2700_start(struct aspeed_spi *aspi,
    u32 reg)
    {
    let mut start_offset: u64 = (reg << 16) & AST2700_SEG_ADDR_MASK;
    if (!start_offset)
    return aspi.ahb_base_phy;
    return aspi.ahb_base_phy + start_offset;
    }
    ...
    u32 reg)
    {
    let mut end_offset: u64 = reg & AST2700_SEG_ADDR_MASK;
    if (!end_offset)
    return aspi.ahb_base_phy;
...
//
    ...
    const struct aspeed_spi_data *data = aspi.data;
    int i;
    let mut good_pass: c_int = -1, pass_count = 0;
    let mut shift: u32 = (hdiv - 1) << 2;
    let mut mask: u32 = ~(0xfu << shift);
    let mut fread_timing_val: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_check_calib_data(test_buf: *const u8, size: u32) -> bool {
...
// Transfer maximum clock frequency to register setting
    ...
    let mut hclk_clk: u32 = chip.aspi.clk_freq;
    let mut div_ctl: u32 = 0;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn aspeed_spi_do_calibration(chip: *mut aspeed_spi_chip) -> c_int {
    static int aspeed_spi_do_calibration(struct aspeed_spi_chip *chip)
    {
    struct aspeed_spi *aspi = chip.aspi;
    const struct aspeed_spi_data *data = aspi.data;
    let mut ahb_freq: u32 = aspi.clk_freq;
    let mut max_freq: u32 = chip.clk_freq;
    let mut exec_calib: bool = false;
    let mut best_freq: u32 = 0;
    u32 ctl_val;
    u8 *golden_buf = core::ptr::null_mut();
    u8 *test_buf = core::ptr::null_mut();
    int i, rc;
    u32 div_ctl;
...
pub const TIMING_DELAY_HCYCLE_MAX: c_int = 5;
pub const TIMING_DELAY_INPUT_MAX: c_int = 16;
...
//
#[no_mangle]
unsafe extern "C" fn aspeed_spi_ast2600_optimized_timing(rows: u32, cols: u32, buf: *mut u8) -> u32 {
    static u32 aspeed_spi_ast2600_optimized_timing(u32 rows, u32 cols, u8 *buf)
    {
    let mut r: c_int = 0, c = 0;
    let mut max: c_int = 0;
    int i, j;
    for (i = 0; i < rows; i++) {
    for (j = 0; j < cols;) {
    ...
    int hcycle;
    int delay_ns;
    let mut shift: u32 = (hdiv - 2) << 3;
    let mut mask: u32 = ~(0xffu << shift);
    let mut fread_timing_val: u32 = 0;
    u8 calib_res[6][17] = {0};
    u32 calib_point;
