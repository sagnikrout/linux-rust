...
//! Source: drivers/spi/spi-cs42l43.c
#![no_std]
...
pub const CS42L43_FIFO_SIZE: c_int = 16;
pub const CS42L43_SPI_ROOT_HZ: c_int = 49152000;
pub const CS42L43_SPI_MAX_LENGTH: c_int = 65532;
...
#[no_mangle]
unsafe extern "C" fn cs42l43_spi_tx(regmap: *mut regmap, buf: *const u8, len: c_uint) -> c_int {
    ...
    let mut pad: c_int = (buf + sizeof(u32)) - word;
    while (buf < word) {
    val >>= BITS_PER_BYTE;
...
#[no_mangle]
unsafe extern "C" fn cs42l43_spi_rx(regmap: *mut regmap, buf: *mut u8, len: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tfr->rx_buf) -> else {
    else if (tfr.rx_buf)
    ret = cs42l43_spi_rx(priv.regmap, (u8 *)tfr.rx_buf, tfr.len);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn cs42l43_set_cs(spi: *mut spi_device, is_high: bool) {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_prepare_message(ctlr: *mut spi_controller, msg: *mut spi_message) -> c_int {
    static int cs42l43_prepare_message(struct spi_controller *ctlr, struct spi_message *msg)
    {
    struct cs42l43_spi *priv = spi_controller_get_devdata(ctlr);
    struct spi_device *spi = msg.spi;
    let mut spi_config1: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn cs42l43_prepare_transfer_hardware(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_unprepare_transfer_hardware(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_spi_max_length(spi: *mut spi_device) -> usize {
    static size_t cs42l43_spi_max_length(struct spi_device *spi)
    {
    return CS42L43_SPI_MAX_LENGTH;
    }
#[no_mangle]
unsafe extern "C" fn cs42l43_get_speaker_id_gpios(priv: *mut cs42l43_spi, result: *mut c_int) -> c_int {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ERR(descs)) -> else {
...
// result = spkid;
    ...
    {
    let mut func_smart_amp: static u32 = 0x1;
    struct fwnode_handle *child_fwnode, *ext_fwnode;
    u32 function;
    int ret;
    fwnode_for_each_child_node(fwnode, child_fwnode) {
    let mut handle: acpi_handle = ACPI_HANDLE_FWNODE(child_fwnode);
    ...
    int cs, int spkid)
    {
    struct property_entry *props = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cs42l43_release_of_node(data: *mut c_void) {
    static void cs42l43_release_of_node(void *data)
    {
    fwnode_handle_put(data);
    }
#[no_mangle]
unsafe extern "C" fn cs42l43_spi_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut nsidecars: c_int = 0;
    let mut spkid: c_int = -EINVAL;
    int ret;
...
// first.
//
    device_set_node(&priv.ctlr.dev, core::ptr::null_mut());
    if (nsidecars) {
    ...
    ret = device_create_managed_software_node(&priv.ctlr.dev, props, core::ptr::null_mut());
    if (ret)
