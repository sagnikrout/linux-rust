...
//! Source: drivers/spi/spi-pxa2xx-platform.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_spi_idma_filter(chan: *mut dma_chan, param: *mut c_void) -> bool {
    ...
    ssp.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(ssp.clk))
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_spi_ssp_release(ssp: *mut c_void) {
    ...
    let mut type: enum pxa_ssp_type = SSP_UNDEFINED;
    struct ssp_device *ssp;
    bool is_lpss_priv;
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_spi_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_spi_platform_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_spi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_spi_exit() -> void __exit {
