...
//! Source: drivers/spi/spi-mpc52xx-psc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpc52xx_psc_spi {
// driver internal data
    pub psc: *mut mpc52xx_psc __iomem,
    pub fifo: *mut mpc52xx_psc_fifo __iomem,
    pub irq: c_int,
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_spi_activate_cs(spi: *mut spi_device) {
...
// wake up when 80% fifo full
    ...
    unsigned rfalarm;
    let mut send_at_once: unsigned = MPC52xx_PSC_BUFSIZE;
    unsigned recv_at_once;
    let mut last_block: c_int = 0;
...
// disable transmiter/receiver
    ...
    m.status = status;
    mpc52xx_psc_spi_transfer_setup(spi, core::ptr::null_mut());
    spi_finalize_current_message(ctlr);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_spi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_spi_cleanup(spi: *mut spi_device) {
    static void mpc52xx_psc_spi_cleanup(struct spi_device *spi)
    {
    kfree(spi.controller_state);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_spi_port_config(psc_id: c_int, mps: *mut mpc52xx_psc_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_spi_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_spi_of_probe(pdev: *mut platform_device) -> c_int {
...
// the spi->mode bits understood by this driver:
    ...
    mps.psc = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(mps.psc))
