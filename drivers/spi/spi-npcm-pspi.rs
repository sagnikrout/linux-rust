...
//! Source: drivers/spi/spi-npcm-pspi.c
#![no_std]
...
pub const NPCM_PSPI_DATA: c_uint = 0x00;
pub const NPCM_PSPI_CTL1: c_uint = 0x02;
pub const NPCM_PSPI_STAT: c_uint = 0x04;
// definitions for control and status register

// general definitions
pub const NPCM_PSPI_TIMEOUT_MS: c_int = 2000;
pub const NPCM_PSPI_MAX_CLK_DIVIDER: c_int = 256;
pub const NPCM_PSPI_MIN_CLK_DIVIDER: c_int = 4;
pub const NPCM_PSPI_DEFAULT_CLK: c_int = 25000000;
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn npcm_pspi_irq_enable(priv: *mut npcm_pspi, mask: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_pspi_irq_disable(priv: *mut npcm_pspi, mask: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_pspi_enable(priv: *mut npcm_pspi) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_pspi_disable(priv: *mut npcm_pspi) {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_set_mode(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_set_transfer_size(priv: *mut npcm_pspi, size: c_int) {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_set_baudrate(priv: *mut npcm_pspi, speed: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_send(priv: *mut npcm_pspi) {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_recv(priv: *mut npcm_pspi) {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_prepare_transfer_hardware(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_unprepare_transfer_hardware(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_reset_hw(priv: *mut npcm_pspi) {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_probe(pdev: *mut platform_device) -> c_int {
    ...
    priv.reset = devm_reset_control_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn npcm_pspi_remove(pdev: *mut platform_device) {
    ...
    { .compatible = "nuvoton,npcm750-pspi", .data = core::ptr::null_mut() },
    { .compatible = "nuvoton,npcm845-pspi", .data = core::ptr::null_mut() },
    {}
    };
