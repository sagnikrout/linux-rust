...
//! Source: drivers/spi/spi-sh-msiof.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sh_msiof_spi_priv {
    pub ctlr: *mut spi_controller,
    pub mapbase: *mut void __iomem,
    pub clk: *mut clk,
    pub pdev: *mut platform_device,
    pub info: *mut sh_msiof_spi_info,
    pub done: completion,
    pub done_txdma: completion,
    pub tx_fifo_size: c_uint,
    pub rx_fifo_size: c_uint,
    pub min_div_pow: c_uint,
    pub tx_dma_page: *mut c_void,
    pub rx_dma_page: *mut c_void,
    pub tx_dma_addr: dma_addr_t,
    pub rx_dma_addr: dma_addr_t,
    pub native_cs_inited: bool,
    pub native_cs_high: bool,
    pub target_aborted: bool,
}

#[no_mangle]
unsafe extern "C" fn sh_msiof_read(p: *mut sh_msiof_spi_priv, reg_offs: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_reset_regs(p: *mut sh_msiof_spi_priv) -> c_int {
    static int sh_msiof_spi_reset_regs(struct sh_msiof_spi_priv *p)
    {
    let mut mask: u32 = SICTR_TXRST | SICTR_RXRST;
    u32 data;
    data = sh_msiof_read(p, SICTR);
    data |= mask;
    sh_msiof_write(p, SICTR, data);
    ...
    {
    let mut parent_rate: c_ulong = clk_get_rate(p.clk);
    let mut div_pow: c_uint = p.min_div_pow;
    let mut spi_hz: u32 = t.speed_hz;
    unsigned long div;
    u32 brps, scr;
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_get_delay_bit(dtdl_or_syncdl: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_get_dtdl_and_syncdl(p: *mut sh_msiof_spi_priv) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_reset_str(p: *mut sh_msiof_spi_priv) {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_start(p: *mut sh_msiof_spi_priv, rx_buf: *mut c_void) -> c_int {
    static int sh_msiof_spi_start(struct sh_msiof_spi_priv *p, void *rx_buf)
    {
    let mut target: bool = spi_controller_is_target(p.ctlr);
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_stop(p: *mut sh_msiof_spi_priv, rx_buf: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_target_abort(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_dma_complete(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn copy_bswap32(dst: *mut u32, src: *const u32, words: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn copy_wswap32(dst: *mut u32, src: *const u32, words: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn copy_plain32(dst: *mut u32, src: *const u32, words: c_uint) {
    ...
    {
    struct sh_msiof_spi_priv *p = spi_controller_get_devdata(ctlr);
    let mut max_wdlen: c_uint = FIELD_MAX(SIMDR2_WDLEN1) + 1;
...
//
    let mut l: c_uint = min(round_down(len, 4), 2 * max_wdlen * 4);
    if (bits <= 8) {
    copy32 = copy_bswap32;
    } else if (bits <= 16) {
    copy32 = copy_wswap32;
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_request_dma(p: *mut sh_msiof_spi_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_release_dma(p: *mut sh_msiof_spi_priv) {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_probe(pdev: *mut platform_device) -> c_int {
...
// Check whether MSIOF is used as I2S mode or SPI mode by checking "port" node
    ...
    p.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(p.clk)) {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_msiof_spi_resume(dev: *mut device) -> c_int {
