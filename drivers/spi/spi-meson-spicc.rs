...
//! Source: drivers/spi/spi-meson-spicc.c
#![no_std]
...
//
pub const SPICC_MAX_BURST: c_int = 128;
// Register Map
pub const SPICC_RXDATA: c_uint = 0x00;
pub const SPICC_TXDATA: c_uint = 0x04;
pub const SPICC_CONREG: c_uint = 0x08;

pub const SPICC_DRCTL_IGNORE: c_int = 0;
pub const SPICC_DRCTL_FALLING: c_int = 1;
pub const SPICC_DRCTL_LOWLEVEL: c_int = 2;

pub const SPICC_DATARATE_DIV4: c_int = 0;
pub const SPICC_DATARATE_DIV8: c_int = 1;
pub const SPICC_DATARATE_DIV16: c_int = 2;
pub const SPICC_DATARATE_DIV32: c_int = 3;

pub const SPICC_INTREG: c_uint = 0x0c;

pub const SPICC_DMAREG: c_uint = 0x10;

pub const SPICC_STATREG: c_uint = 0x14;

pub const SPICC_PERIODREG: c_uint = 0x18;

pub const SPICC_TESTREG: c_uint = 0x1c;

pub const SPICC_MO_NO_DELAY: c_int = 0;
pub const SPICC_MO_DELAY_1_CYCLE: c_int = 1;
pub const SPICC_MO_DELAY_2_CYCLE: c_int = 2;
pub const SPICC_MO_DELAY_3_CYCLE: c_int = 3;

pub const SPICC_MI_NO_DELAY: c_int = 0;
pub const SPICC_MI_DELAY_1_CYCLE: c_int = 1;
pub const SPICC_MI_DELAY_2_CYCLE: c_int = 2;
pub const SPICC_MI_DELAY_3_CYCLE: c_int = 3;

pub const SPICC_CAP_AHEAD_2_CYCLE: c_int = 0;
pub const SPICC_CAP_AHEAD_1_CYCLE: c_int = 1;
pub const SPICC_CAP_NO_DELAY: c_int = 2;
pub const SPICC_CAP_DELAY_1_CYCLE: c_int = 3;

pub const SPICC_DRADDR: c_uint = 0x20	/* Read Address of DMA */;
pub const SPICC_DWADDR: c_uint = 0x24	/* Write Address of DMA */;
pub const SPICC_LD_CNTL0: c_uint = 0x28;

pub const SPICC_LD_CNTL1: c_uint = 0x2c;

pub const DMA_BURST_LEN_DEFAULT: c_int = 8;
pub const DMA_BURST_COUNT_MAX: c_uint = 0xffff;

pub const SPICC_ENH_CTL0: c_uint = 0x38	/* Enhanced Feature */;

    writel_relaxed((readl_relaxed(addr) & ~(mask)) | (val), addr)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_spicc_data {
    pub max_speed_hz: c_uint,
    pub min_speed_hz: c_uint,
    pub fifo_size: c_uint,
    pub has_oen: bool,
    pub has_enhance_clk_div: bool,
    pub has_pclk: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_spicc_device {
    pub host: *mut spi_controller,
    pub pdev: *mut platform_device,
    pub base: *mut void __iomem,
    pub core: *mut clk,
    pub pclk: *mut clk,
    pub pow2_div: clk_divider,
    pub clk: *mut clk,
    pub message: *mut spi_message,
    pub xfer: *mut spi_transfer,
    pub done: completion,
    pub data: *const meson_spicc_data,
    pub tx_buf: *mut u8,
    pub rx_buf: *mut u8,
    pub bytes_per_word: c_uint,
    pub tx_remain: c_ulong,
    pub rx_remain: c_ulong,
    pub xfer_remain: c_ulong,
    pub pinctrl: *mut pinctrl,
    pub pins_idle_high: *mut pinctrl_state,
    pub pins_idle_low: *mut pinctrl_state,
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_oen_enable(spicc: *mut meson_spicc_device) {
...
// Try to get pinctrl states for idle high/low
    ...
    spicc.pins_idle_high = core::ptr::null_mut();
    }
    ...
    spicc.pins_idle_low = core::ptr::null_mut();
    }
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_setup_dma(spicc: *mut meson_spicc_device) {
    static void meson_spicc_setup_dma(struct meson_spicc_device *spicc)
    {
    unsigned int len;
    unsigned int dma_burst_len, dma_burst_count;
    let mut count_en: c_uint = 0;
    let mut txfifo_thres: c_uint = 0;
    let mut read_req: c_uint = 0;
    let mut rxfifo_thres: c_uint = 31;
    let mut write_req: c_uint = 0;
    let mut ld_ctr1: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_dma_irq(spicc: *mut meson_spicc_device) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn meson_spicc_txfull(spicc: *mut meson_spicc_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn meson_spicc_rxready(spicc: *mut meson_spicc_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn meson_spicc_pull_data(spicc: *mut meson_spicc_device) -> u32 {
    static inline u32 meson_spicc_pull_data(struct meson_spicc_device *spicc)
    {
    let mut bytes: c_uint = spicc.bytes_per_word;
    let mut byte_shift: c_uint = 0;
    let mut data: u32 = 0;
    u8 byte;
    while (bytes--) {
    byte = *spicc.tx_buf++;
...
#[no_mangle]
pub unsafe extern "C" fn meson_spicc_rx(spicc: *mut meson_spicc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn meson_spicc_tx(spicc: *mut meson_spicc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn meson_spicc_setup_burst(spicc: *mut meson_spicc_device) {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_auto_io_delay(spicc: *mut meson_spicc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(80000000: hz >=) -> else {
    else if (hz >= 80000000)
    cap_delay = SPICC_CAP_NO_DELAY;
#[no_mangle]
pub unsafe extern "C" fn if(40000000: hz >=) -> else {
    else if (hz >= 40000000)
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_reset_fifo(spicc: *mut meson_spicc_device) {
...
// Enable interrupts
    ...
    let mut conf: u32 = readl_relaxed(spicc.base + SPICC_CONREG) & SPICC_DATARATE_MASK;
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_unprepare_transfer(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_cleanup(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_pow2_clk_init(spicc: *mut meson_spicc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_enh_clk_init(spicc: *mut meson_spicc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_spicc_remove(pdev: *mut platform_device) {
