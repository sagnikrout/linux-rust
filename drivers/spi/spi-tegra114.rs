...
//! Source: drivers/spi/spi-tegra114.c
#![no_std]
...
pub const SPI_COMMAND1: c_uint = 0x000;

// SPI_CS_POL_INACTIVE bits are default high
// n from 0 to 3

pub const SPI_COMMAND2: c_uint = 0x004;

pub const SPI_CS_TIMING1: c_uint = 0x008;

    ((((val) & 0xFFu) << ((cs) * 8)) |	\
    ((reg) & ~(0xFFu << ((cs) * 8))))
pub const SPI_CS_TIMING2: c_uint = 0x00C;
    ...
    (reg = (((val) & 0x1F) << ((cs) * 8)) |		\
    ((reg) & ~(0x1F << ((cs) * 8))))
pub const MAX_SETUP_HOLD_CYCLES: c_int = 16;
pub const MAX_INACTIVE_CYCLES: c_int = 32;
pub const SPI_TRANS_STATUS: c_uint = 0x010;

pub const SPI_FIFO_STATUS: c_uint = 0x014;

    SPI_RX_FIFO_OVF | SPI_TX_FIFO_UNF | SPI_TX_FIFO_OVF)

pub const SPI_TX_DATA: c_uint = 0x018;
pub const SPI_RX_DATA: c_uint = 0x01C;
pub const SPI_DMA_CTL: c_uint = 0x020;

pub const SPI_DMA_BLK: c_uint = 0x024;

pub const SPI_TX_FIFO: c_uint = 0x108;
pub const SPI_RX_FIFO: c_uint = 0x188;
pub const SPI_INTR_MASK: c_uint = 0x18c;

pub const MAX_CHIP_SELECT: c_int = 4;
pub const SPI_FIFO_DEPTH: c_int = 64;

pub const MAX_HOLD_CYCLES: c_int = 16;
pub const SPI_DEFAULT_SPEED: c_int = 25000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_spi_soc_data {
    pub has_intr_mask_reg: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_spi_client_data {
...
pub struct tegra_spi_data {
    ...
    pub soc_data: *const tegra_spi_soc_data,
}
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_clear_status(tspi: *mut tegra_spi_data) {
...
// Clear fifo status error if any
    ...
    unsigned max_word;
    let mut bits_per_word: unsigned = t.bits_per_word;
    unsigned max_len;
    ...
    let mut x: u32 = tegra_spi_readl(tspi, SPI_RX_FIFO);
...
// rx_buf++ = (x >> i*8) & 0xFF;
    ...
    let mut bytes_per_word: u8 = tspi.bytes_per_word;
    ...
    read_bytes = len;
    for (count = 0; count < rx_full_count; count++) {
    let mut x: u32 = tegra_spi_readl(tspi, SPI_RX_FIFO) & rx_mask;
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_dma_complete(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_start_tx_dma(tspi: *mut tegra_spi_data, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_start_rx_dma(tspi: *mut tegra_spi_data, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_flush_fifos(tspi: *mut tegra_spi_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_set_hw_cs_timing(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SPI_MODE_1: req_mode ==) -> else {
    else if (req_mode == SPI_MODE_1)
    command1 |= SPI_CONTROL_MODE_1;
#[no_mangle]
pub unsafe extern "C" fn if(SPI_MODE_2: req_mode ==) -> else {
    else if (req_mode == SPI_MODE_2)
    command1 |= SPI_CONTROL_MODE_2;
#[no_mangle]
pub unsafe extern "C" fn if(SPI_MODE_3: req_mode ==) -> else {
    ...
    tspi.cs_control = core::ptr::null_mut();
    } else
    tegra_spi_writel(tspi, command1, SPI_COMMAND1);
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_cleanup(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_transfer_end(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_dump_regs(tspi: *mut tegra_spi_data) {
...
#[no_mangle]
unsafe extern "C" fn handle_cpu_based_xfer(tspi: *mut tegra_spi_data) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn handle_dma_based_xfer(tspi: *mut tegra_spi_data) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_isr_thread(irq: c_int, context_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_isr(irq: c_int, context_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_runtime_suspend(dev: *mut device) -> c_int {
    static int tegra_spi_runtime_suspend(struct device *dev)
    {
    struct spi_controller *host = dev_get_drvdata(dev);
    struct tegra_spi_data *tspi = spi_controller_get_devdata(host);
...
#[no_mangle]
unsafe extern "C" fn tegra_spi_runtime_resume(dev: *mut device) -> c_int {
    static int tegra_spi_runtime_resume(struct device *dev)
    {
    struct spi_controller *host = dev_get_drvdata(dev);
    struct tegra_spi_data *tspi = spi_controller_get_devdata(host);
    ...
    tegra_spi_runtime_resume, core::ptr::null_mut())
