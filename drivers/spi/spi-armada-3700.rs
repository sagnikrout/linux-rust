...
//! Source: drivers/spi/spi-armada-3700.c
#![no_std]
...
pub const A3700_SPI_MAX_SPEED_HZ: c_int = 100000000;
pub const A3700_SPI_MAX_PRESCALE: c_int = 30;
pub const A3700_SPI_TIMEOUT: c_int = 10;
// SPI Register Offest
pub const A3700_SPI_IF_CTRL_REG: c_uint = 0x00;
pub const A3700_SPI_IF_CFG_REG: c_uint = 0x04;
pub const A3700_SPI_DATA_OUT_REG: c_uint = 0x08;
pub const A3700_SPI_DATA_IN_REG: c_uint = 0x0C;
pub const A3700_SPI_IF_INST_REG: c_uint = 0x10;
pub const A3700_SPI_IF_ADDR_REG: c_uint = 0x14;
pub const A3700_SPI_IF_RMODE_REG: c_uint = 0x18;
pub const A3700_SPI_IF_HDR_CNT_REG: c_uint = 0x1C;
pub const A3700_SPI_IF_DIN_CNT_REG: c_uint = 0x20;
pub const A3700_SPI_IF_TIME_REG: c_uint = 0x24;
pub const A3700_SPI_INT_STAT_REG: c_uint = 0x28;
pub const A3700_SPI_INT_MASK_REG: c_uint = 0x2C;
// A3700_SPI_IF_CTRL_REG

// A3700_SPI_IF_CFG_REG

pub const A3700_SPI_WFIFO_THRS_BIT: c_int = 28;
pub const A3700_SPI_RFIFO_THRS_BIT: c_int = 24;
pub const A3700_SPI_FIFO_THRS_MASK: c_uint = 0x7;
pub const A3700_SPI_DATA_PIN_MASK: c_uint = 0x3;
// A3700_SPI_IF_HDR_CNT_REG
pub const A3700_SPI_DUMMY_CNT_BIT: c_int = 12;
pub const A3700_SPI_DUMMY_CNT_MASK: c_uint = 0x7;
pub const A3700_SPI_RMODE_CNT_BIT: c_int = 8;
pub const A3700_SPI_RMODE_CNT_MASK: c_uint = 0x3;
pub const A3700_SPI_ADDR_CNT_BIT: c_int = 4;
pub const A3700_SPI_ADDR_CNT_MASK: c_uint = 0x7;
pub const A3700_SPI_INSTR_CNT_BIT: c_int = 0;
pub const A3700_SPI_INSTR_CNT_MASK: c_uint = 0x3;
// A3700_SPI_IF_TIME_REG

#[repr(C)]
#[derive(Copy, Clone)]
pub struct a3700_spi {
...
#[no_mangle]
unsafe extern "C" fn spireg_read(a3700_spi: *mut a3700_spi, offset: u32) -> u32 {
    static u32 spireg_read(struct a3700_spi *a3700_spi, u32 offset)
    {
    return readl(a3700_spi.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn spireg_write(a3700_spi: *mut a3700_spi, offset: u32, data: u32) {
    static void spireg_write(struct a3700_spi *a3700_spi, u32 offset, u32 data)
    {
    writel(data, a3700_spi.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn a3700_spi_auto_cs_unset(a3700_spi: *mut a3700_spi) {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_activate_cs(a3700_spi: *mut a3700_spi, cs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_fifo_mode_set(a3700_spi: *mut a3700_spi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_bytelen_set(a3700_spi: *mut a3700_spi, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_fifo_flush(a3700_spi: *mut a3700_spi) -> c_int {
    static int a3700_spi_fifo_flush(struct a3700_spi *a3700_spi)
    {
    let mut timeout: c_int = A3700_SPI_TIMEOUT;
    u32 val;
    val = spireg_read(a3700_spi, A3700_SPI_IF_CFG_REG);
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_init(a3700_spi: *mut a3700_spi) {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_wait_completion(spi: *mut spi_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_set_cs(spi: *mut spi_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_header_set(a3700_spi: *mut a3700_spi) {
...
#[no_mangle]
unsafe extern "C" fn a3700_is_wfifo_full(a3700_spi: *mut a3700_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_fifo_write(a3700_spi: *mut a3700_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a3700_is_rfifo_empty(a3700_spi: *mut a3700_spi) -> c_int {
    static int a3700_is_rfifo_empty(struct a3700_spi *a3700_spi)
    {
    let mut val: u32 = spireg_read(a3700_spi, A3700_SPI_IF_CTRL_REG);
    return (val & A3700_SPI_RFIFO_EMPTY);
    }
#[no_mangle]
unsafe extern "C" fn a3700_spi_fifo_read(a3700_spi: *mut a3700_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a3700_spi_transfer_abort_fifo(a3700_spi: *mut a3700_spi) {
...
// Flush the FIFOs
    ...
    {
    struct a3700_spi *a3700_spi = spi_controller_get_devdata(host);
    let mut ret: c_int = 0, timeout = A3700_SPI_TIMEOUT;
    let mut nbits: c_uint = 0, byte_len;
    u32 val;
...
// Wait for all the data to be shifted in / out
    ...
    { .compatible = "marvell,armada-3700-spi", .data = core::ptr::null_mut() },
    {},
    };
    MODULE_DEVICE_TABLE(of, a3700_spi_dt_ids);
#[no_mangle]
unsafe extern "C" fn a3700_spi_probe(pdev: *mut platform_device) -> c_int {
    static int a3700_spi_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct spi_controller *host;
    struct a3700_spi *spi;
    let mut num_cs: u32 = 0;
    int irq, ret = 0;
    ...
    spi.clk = devm_clk_get_prepared(dev, core::ptr::null_mut());
    if (IS_ERR(spi.clk))
