...
//! Source: drivers/spi/spi-sunplus-sp7021.c
#![no_std]
...
pub const SP7021_DATA_RDY_REG: c_uint = 0x0044;
pub const SP7021_SLAVE_DMA_CTRL_REG: c_uint = 0x0048;
pub const SP7021_SLAVE_DMA_LENGTH_REG: c_uint = 0x004c;
pub const SP7021_SLAVE_DMA_ADDR_REG: c_uint = 0x004c;

pub const SP7021_FIFO_REG: c_uint = 0x0034;
pub const SP7021_SPI_STATUS_REG: c_uint = 0x0038;
pub const SP7021_SPI_CONFIG_REG: c_uint = 0x003c;
pub const SP7021_INT_BUSY_REG: c_uint = 0x004c;
pub const SP7021_DMA_CTRL_REG: c_uint = 0x0050;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sp7021_spi_ctlr {
    pub dev: *mut device,
    pub ctlr: *mut spi_controller,
    pub m_base: *mut void __iomem,
    pub s_base: *mut void __iomem,
    pub xfer_conf: u32,
    pub mode: c_int,
    pub m_irq: c_int,
    pub s_irq: c_int,
...
// data xfer lock
    pub buf_lock: mutex,
    pub isr_done: completion,
    pub target_isr: completion,
    pub rx_cur_len: c_uint,
    pub tx_cur_len: c_uint,
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_target_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_target_abort(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_target_tx(spi: *mut spi_device, xfer: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_target_rx(spi: *mut spi_device, xfer: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_host_rb(pspim: *mut sp7021_spi_ctlr, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_host_wb(pspim: *mut sp7021_spi_ctlr, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_host_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sp7021_prep_transfer(ctlr: *mut spi_controller, spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_setup_clk(ctlr: *mut spi_controller, xfer: *mut spi_transfer) {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_reset_control_assert(data: *mut c_void) {
    static void sp7021_spi_reset_control_assert(void *data)
    {
    reset_control_assert(data);
    }
#[no_mangle]
unsafe extern "C" fn sp7021_spi_controller_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (pspim.s_irq < 0)
    return pspim.s_irq;
    pspim.spi_clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(pspim.spi_clk))
    return dev_err_probe(dev, PTR_ERR(pspim.spi_clk), "clk get fail\n");
    pspim.rstc = devm_reset_control_get_exclusive(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_controller_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_controller_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_controller_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp7021_spi_runtime_resume(dev: *mut device) -> c_int {
    ...
    sp7021_spi_runtime_resume, core::ptr::null_mut())
