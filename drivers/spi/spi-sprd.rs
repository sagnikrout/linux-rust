...
pub const SPRD_SPI_TXD: c_uint = 0x0;
pub const SPRD_SPI_CLKD: c_uint = 0x4;
pub const SPRD_SPI_CTL0: c_uint = 0x8;
pub const SPRD_SPI_CTL1: c_uint = 0xc;
pub const SPRD_SPI_CTL2: c_uint = 0x10;
pub const SPRD_SPI_CTL3: c_uint = 0x14;
pub const SPRD_SPI_CTL4: c_uint = 0x18;
pub const SPRD_SPI_CTL5: c_uint = 0x1c;
pub const SPRD_SPI_INT_EN: c_uint = 0x20;
pub const SPRD_SPI_INT_CLR: c_uint = 0x24;
pub const SPRD_SPI_INT_RAW_STS: c_uint = 0x28;
pub const SPRD_SPI_INT_MASK_STS: c_uint = 0x2c;
pub const SPRD_SPI_STS1: c_uint = 0x30;
pub const SPRD_SPI_STS2: c_uint = 0x34;
pub const SPRD_SPI_DSP_WAIT: c_uint = 0x38;
pub const SPRD_SPI_STS3: c_uint = 0x3c;
pub const SPRD_SPI_CTL6: c_uint = 0x40;
pub const SPRD_SPI_STS4: c_uint = 0x44;
pub const SPRD_SPI_FIFO_RST: c_uint = 0x48;
pub const SPRD_SPI_CTL7: c_uint = 0x4c;
pub const SPRD_SPI_STS5: c_uint = 0x50;
pub const SPRD_SPI_CTL8: c_uint = 0x54;
pub const SPRD_SPI_CTL9: c_uint = 0x58;
pub const SPRD_SPI_CTL10: c_uint = 0x5c;
pub const SPRD_SPI_CTL11: c_uint = 0x60;
pub const SPRD_SPI_CTL12: c_uint = 0x64;
pub const SPRD_SPI_STS6: c_uint = 0x68;
pub const SPRD_SPI_STS7: c_uint = 0x6c;
pub const SPRD_SPI_STS8: c_uint = 0x70;
pub const SPRD_SPI_STS9: c_uint = 0x74;
...
pub const SPRD_SPI_MODE_OFFSET: c_int = 3;
pub const SPRD_SPI_3WIRE_MODE: c_int = 4;
pub const SPRD_SPI_4WIRE_MODE: c_int = 0;
// Bits & mask definition for register CTL8

pub const SPRD_SPI_TX_LEN_H_OFFSET: c_int = 16;
// Bits & mask definition for register CTL9

// Bits & mask definition for register CTL10

pub const SPRD_SPI_RX_LEN_H_OFFSET: c_int = 16;
// Bits & mask definition for register CTL11

// Default & maximum word delay cycles
pub const SPRD_SPI_MIN_DELAY_CYCLE: c_int = 14;
pub const SPRD_SPI_MAX_DELAY_CYCLE: c_int = 130;
pub const SPRD_SPI_FIFO_SIZE: c_int = 32;
pub const SPRD_SPI_CHIP_CS_NUM: c_uint = 0x4;
pub const SPRD_SPI_CHNL_LEN: c_int = 2;
pub const SPRD_SPI_DEFAULT_SOURCE: c_int = 26000000;
pub const SPRD_SPI_MAX_SPEED_HZ: c_int = 48000000;
pub const SPRD_SPI_AUTOSUSPEND_DELAY: c_int = 100;
pub const SPRD_SPI_DMA_STEP: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_spi_dma {
    pub enable: bool,
    pub dma_chan: [*mut dma_chan; SPRD_SPI_MAX],
    pub width: enum dma_slave_buswidth,
    pub fragmens_len: u32,
    pub rx_len: u32,
}
...
pub struct sprd_spi {
    ...
    pub len: u32,
    pub status: c_int,
    pub dma: sprd_spi_dma,
    pub xfer_completion: completion,
    pub tx_buf: *const c_void,
    pub rx_buf: *mut c_void,
    pub len): *mut *mut *mut int (read_bufs)(struct sprd_spi ss, u32,
    pub len): *mut *mut *mut int (write_bufs)(struct sprd_spi ss, u32,
}
...
//
    let mut size: u32 = t.bits_per_word * SPRD_SPI_FIFO_SIZE;
    let mut bit_time_us: u32 = DIV_ROUND_UP(USEC_PER_SEC, ss.hw_speed_hz);
    let mut total_time_us: u32 = size * bit_time_us;
//
...
//
    let mut interval_cycle: u32 = SPRD_SPI_FIFO_SIZE * ss.word_delay;
    u32 interval_time_us = DIV_ROUND_UP(interval_cycle * USEC_PER_SEC,
    ss.src_clk);
    return total_time_us + interval_time_us;
    }
#[no_mangle]
unsafe extern "C" fn sprd_spi_wait_for_tx_end(ss: *mut sprd_spi, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_wait_for_rx_end(ss: *mut sprd_spi, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_set_tx_length(ss: *mut sprd_spi, length: u32) {
    static void sprd_spi_set_tx_length(struct sprd_spi *ss, u32 length)
    {
    let mut val: u32 = readl_relaxed(ss.base + SPRD_SPI_CTL8);
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_set_rx_length(ss: *mut sprd_spi, length: u32) {
    static void sprd_spi_set_rx_length(struct sprd_spi *ss, u32 length)
    {
    let mut val: u32 = readl_relaxed(ss.base + SPRD_SPI_CTL10);
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_chipselect(sdev: *mut spi_device, cs: bool) {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_write_only_receive(ss: *mut sprd_spi, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_write_bufs_u8(ss: *mut sprd_spi, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_write_bufs_u16(ss: *mut sprd_spi, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_write_bufs_u32(ss: *mut sprd_spi, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_read_bufs_u8(ss: *mut sprd_spi, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_read_bufs_u16(ss: *mut sprd_spi, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_read_bufs_u32(ss: *mut sprd_spi, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_txrx_bufs(sdev: *mut spi_device, t: *mut spi_transfer) -> c_int {
    static int sprd_spi_txrx_bufs(struct spi_device *sdev, struct spi_transfer *t)
    {
    struct sprd_spi *ss = spi_controller_get_devdata(sdev.controller);
    let mut trans_len: u32 = ss.trans_len, len;
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_irq_enable(ss: *mut sprd_spi) {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_irq_disable(ss: *mut sprd_spi) {
    static void sprd_spi_irq_disable(struct sprd_spi *ss)
    {
    writel_relaxed(0, ss.base + SPRD_SPI_INT_EN);
    }
#[no_mangle]
unsafe extern "C" fn sprd_spi_dma_enable(ss: *mut sprd_spi, enable: bool) {
    static void sprd_spi_dma_enable(struct sprd_spi *ss, bool enable)
    {
    let mut val: u32 = readl_relaxed(ss.base + SPRD_SPI_CTL2);
    if (enable)
    val |= SPRD_SPI_DMA_EN;
    else
    val &= ~SPRD_SPI_DMA_EN;
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_dma_rx_config(ss: *mut sprd_spi, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_dma_tx_config(ss: *mut sprd_spi, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_dma_request(ss: *mut sprd_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_dma_release(ss: *mut sprd_spi) {
    ...
    {
    struct sprd_spi *ss = spi_controller_get_devdata(sdev.controller);
    let mut trans_len: u32 = ss.trans_len;
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_set_speed(ss: *mut sprd_spi, speed_hz: u32) {
...
//
    let mut clk_div: u32 = DIV_ROUND_UP(ss.src_clk, speed_hz << 1) - 1;
// Save the real hardware speed
    ss.hw_speed_hz = (ss.src_clk >> 1) / (clk_div + 1);
    writel_relaxed(clk_div, ss.base + SPRD_SPI_CLKD);
    }
#[no_mangle]
unsafe extern "C" fn sprd_spi_init_hw(ss: *mut sprd_spi, t: *mut spi_transfer) -> c_int {
...
// Set SPI work mode
    ...
    {
    struct sprd_spi *ss = spi_controller_get_devdata(sdev.controller);
    let mut bits_per_word: u8 = t.bits_per_word;
    u32 val, mode = 0;
    int ret;
    ss.len = t.len;
    ss.tx_buf = t.tx_buf;
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_handle_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t sprd_spi_handle_irq(int irq, void *data)
    {
    struct sprd_spi *ss = (struct sprd_spi *)data;
    let mut val: u32 = readl_relaxed(ss.base + SPRD_SPI_INT_MASK_STS);
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_irq_init(pdev: *mut platform_device, ss: *mut sprd_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_clk_init(pdev: *mut platform_device, ss: *mut sprd_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_dma_init(pdev: *mut platform_device, ss: *mut sprd_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_spi_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(sprd_spi_runtime_suspend, sprd_spi_runtime_resume, core::ptr::null_mut())
    };
