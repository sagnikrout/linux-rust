...
pub const FSPI_MCR0: c_uint = 0x00;

pub const FSPI_MCR1: c_uint = 0x04;

pub const FSPI_MCR2: c_uint = 0x08;

pub const FSPI_AHBCR: c_uint = 0x0c;

pub const FSPI_INTEN: c_uint = 0x10;

pub const FSPI_INTR: c_uint = 0x14;

pub const FSPI_LUTKEY: c_uint = 0x18;
pub const FSPI_LUTKEY_VALUE: c_uint = 0x5AF05AF0;
pub const FSPI_LCKCR: c_uint = 0x1C;
pub const FSPI_LCKER_LOCK: c_uint = 0x1;
pub const FSPI_LCKER_UNLOCK: c_uint = 0x2;
pub const FSPI_BUFXCR_INVALID_MSTRID: c_uint = 0xE;
pub const FSPI_AHBRX_BUF0CR0: c_uint = 0x20;
pub const FSPI_AHBRX_BUF1CR0: c_uint = 0x24;
pub const FSPI_AHBRX_BUF2CR0: c_uint = 0x28;
pub const FSPI_AHBRX_BUF3CR0: c_uint = 0x2C;
pub const FSPI_AHBRX_BUF4CR0: c_uint = 0x30;
pub const FSPI_AHBRX_BUF5CR0: c_uint = 0x34;
pub const FSPI_AHBRX_BUF6CR0: c_uint = 0x38;
pub const FSPI_AHBRX_BUF7CR0: c_uint = 0x3C;

pub const FSPI_AHBRX_BUF0CR1: c_uint = 0x40;
pub const FSPI_AHBRX_BUF1CR1: c_uint = 0x44;
pub const FSPI_AHBRX_BUF2CR1: c_uint = 0x48;
pub const FSPI_AHBRX_BUF3CR1: c_uint = 0x4C;
pub const FSPI_AHBRX_BUF4CR1: c_uint = 0x50;
pub const FSPI_AHBRX_BUF5CR1: c_uint = 0x54;
pub const FSPI_AHBRX_BUF6CR1: c_uint = 0x58;
pub const FSPI_AHBRX_BUF7CR1: c_uint = 0x5C;
pub const FSPI_FLSHA1CR0: c_uint = 0x60;
pub const FSPI_FLSHA2CR0: c_uint = 0x64;
pub const FSPI_FLSHB1CR0: c_uint = 0x68;
pub const FSPI_FLSHB2CR0: c_uint = 0x6C;
pub const FSPI_FLSHXCR0_SZ_KB: c_int = 10;

pub const FSPI_FLSHA1CR1: c_uint = 0x70;
pub const FSPI_FLSHA2CR1: c_uint = 0x74;
pub const FSPI_FLSHB1CR1: c_uint = 0x78;
pub const FSPI_FLSHB2CR1: c_uint = 0x7C;

pub const FSPI_FLSHA1CR2: c_uint = 0x80;
pub const FSPI_FLSHA2CR2: c_uint = 0x84;
pub const FSPI_FLSHB1CR2: c_uint = 0x88;
pub const FSPI_FLSHB2CR2: c_uint = 0x8C;

pub const FSPI_FLSHXCR2_AWRSEQN_SHIFT: c_int = 13;
pub const FSPI_FLSHXCR2_AWRSEQI_SHIFT: c_int = 8;
pub const FSPI_FLSHXCR2_ARDSEQN_SHIFT: c_int = 5;
pub const FSPI_FLSHXCR2_ARDSEQI_SHIFT: c_int = 0;
pub const FSPI_IPCR0: c_uint = 0xA0;
pub const FSPI_IPCR1: c_uint = 0xA4;

pub const FSPI_IPCR1_SEQNUM_SHIFT: c_int = 24;
pub const FSPI_IPCR1_SEQID_SHIFT: c_int = 16;

pub const FSPI_IPCMD: c_uint = 0xB0;

pub const FSPI_DLPR: c_uint = 0xB4;
pub const FSPI_IPRXFCR: c_uint = 0xB8;

pub const FSPI_IPTXFCR: c_uint = 0xBC;

pub const FSPI_DLLACR: c_uint = 0xC0;

pub const FSPI_DLLBCR: c_uint = 0xC4;

pub const FSPI_STS0: c_uint = 0xE0;

pub const FSPI_STS1: c_uint = 0xE4;

pub const FSPI_STS2: c_uint = 0xE8;

    FSPI_STS2_BSLVLOCK | \
    FSPI_STS2_AREFLOCK | \
    FSPI_STS2_ASLVLOCK)
pub const FSPI_AHBSPNST: c_uint = 0xEC;

pub const FSPI_IPRXFSTS: c_uint = 0xF0;

pub const FSPI_IPTXFSTS: c_uint = 0xF4;

pub const FSPI_RFDR: c_uint = 0x100;
pub const FSPI_TFDR: c_uint = 0x180;
pub const FSPI_LUT_BASE: c_uint = 0x200;
// register map end
// Instruction set for the LUT register.
pub const LUT_STOP: c_uint = 0x00;
pub const LUT_CMD: c_uint = 0x01;
pub const LUT_ADDR: c_uint = 0x02;
pub const LUT_CADDR_SDR: c_uint = 0x03;
pub const LUT_MODE: c_uint = 0x04;
pub const LUT_MODE2: c_uint = 0x05;
pub const LUT_MODE4: c_uint = 0x06;
pub const LUT_MODE8: c_uint = 0x07;
pub const LUT_NXP_WRITE: c_uint = 0x08;
pub const LUT_NXP_READ: c_uint = 0x09;
pub const LUT_LEARN_SDR: c_uint = 0x0A;
pub const LUT_DATSZ_SDR: c_uint = 0x0B;
pub const LUT_DUMMY: c_uint = 0x0C;
pub const LUT_DUMMY_RWDS_SDR: c_uint = 0x0D;
pub const LUT_JMP_ON_CS: c_uint = 0x1F;
pub const LUT_CMD_DDR: c_uint = 0x21;
pub const LUT_ADDR_DDR: c_uint = 0x22;
pub const LUT_CADDR_DDR: c_uint = 0x23;
pub const LUT_MODE_DDR: c_uint = 0x24;
pub const LUT_MODE2_DDR: c_uint = 0x25;
pub const LUT_MODE4_DDR: c_uint = 0x26;
pub const LUT_MODE8_DDR: c_uint = 0x27;
pub const LUT_WRITE_DDR: c_uint = 0x28;
pub const LUT_READ_DDR: c_uint = 0x29;
pub const LUT_LEARN_DDR: c_uint = 0x2A;
pub const LUT_DATSZ_DDR: c_uint = 0x2B;
pub const LUT_DUMMY_DDR: c_uint = 0x2C;
pub const LUT_DUMMY_RWDS_DDR: c_uint = 0x2D;
//
...
// ---------------------------------------------------
//
pub const PAD_SHIFT: c_int = 8;
pub const INSTR_SHIFT: c_int = 10;
pub const OPRND_SHIFT: c_int = 16;
// Macros for constructing the LUT register.

    ((((ins) << INSTR_SHIFT) | ((pad) << PAD_SHIFT) | \
    (opr)) << (((idx) % 2) * OPRND_SHIFT))
pub const POLL_TOUT: c_int = 5000;
pub const NXP_FSPI_MAX_CHIPSELECT: c_int = 4;

pub const DCFG_RCWSR1: c_uint = 0x100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxp_fspi_devtype_data {
    pub rxfifo: c_uint,
    pub txfifo: c_uint,
...
pub struct nxp_fspi {
    ...
    pub memmap_phy: u32,
    pub memmap_phy_size: u32,
    pub memmap_start: u32,
    pub memmap_len: u32,
    pub clk_en: *mut *mut clk clk,,
    pub dev: *mut device,
    pub c: completion,
    pub devtype_data: *mut nxp_fspi_devtype_data,
    pub lock: mutex,
...
// save the previous operation clock rate
    pub pre_op_rate: c_ulong,
// the max clock rate fspi output to device
    pub max_rate: c_ulong,
}

#[no_mangle]
pub unsafe extern "C" fn needs_ip_only(f: *mut nxp_fspi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fspi_writel(f: *mut nxp_fspi, val: u32, addr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn fspi_readl(f: *mut nxp_fspi, addr: *mut void __iomem) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_check_buswidth(f: *mut nxp_fspi, width: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nxp_fspi_invalid(f: *mut nxp_fspi) {
...
// w1c register, wait unit clear
    ...
    let mut lut_offset: u32 = (f.devtype_data.lut_num - 1) * 4 * 4;
    u32 target_lut_reg;
// cmd
    if (op.cmd.dtr) {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_clk_prep_enable(f: *mut nxp_fspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_clk_disable_unprep(f: *mut nxp_fspi) {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_dll_calibration(f: *mut nxp_fspi) {
...
//
#[no_mangle]
unsafe extern "C" fn nxp_fspi_dll_override(f: *mut nxp_fspi) {
...
// flexspi only support one DTR mode: 8D-8D-8D
    let mut op_is_dtr: bool = op.cmd.dtr && op.addr.dtr && op.dummy.dtr && op.data.dtr;
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_read_ahb(f: *mut nxp_fspi, op: *const spi_mem_op) -> c_int {
    static int nxp_fspi_read_ahb(struct nxp_fspi *f, const struct spi_mem_op *op)
    {
    let mut start: u32 = op.addr.val;
...
// Wait for TXFIFO empty
    ...
    let mut data: u32 = 0;
    int j;
    let mut remaining: c_int = op.data.nbytes - i;
// Wait for TXFIFO empty
    ret = fspi_readl_poll_tout(f, f.iobase + FSPI_INTR,
    FSPI_INTR_IPTXWE, 0,
    POLL_TOUT, true);
    ...
    void __iomem *base = f.iobase;
    int i, ret;
    let mut len: c_int = op.data.nbytes;
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_do_op(f: *mut nxp_fspi, op: *const spi_mem_op) -> c_int {
    static int nxp_fspi_do_op(struct nxp_fspi *f, const struct spi_mem_op *op)
    {
    void __iomem *base = f.iobase;
    let mut seqnum: c_int = 0;
    let mut err: c_int = 0;
    u32 reg, seqid_lut;
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_exec_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_adjust_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
    ...
    op.data.nbytes = f.devtype_data.ahb_buf_size;
#[no_mangle]
pub unsafe extern "C" fn if(4): op->data.nbytes > (f->devtype_data->rxfifo -) -> else {
...
#[no_mangle]
unsafe extern "C" fn erratum_err050568(f: *mut nxp_fspi) {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_default_setup(f: *mut nxp_fspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_fspi_suspend(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(nxp_fspi_runtime_suspend, nxp_fspi_runtime_resume, core::ptr::null_mut())
