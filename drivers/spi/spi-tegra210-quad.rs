...
//! Source: drivers/spi/spi-tegra210-quad.c
#![no_std]
...
pub const QSPI_COMMAND1: c_uint = 0x000;

pub const QSPI_COMMAND2: c_uint = 0x004;

pub const QSPI_CS_TIMING1: c_uint = 0x008;

pub const QSPI_CS_TIMING2: c_uint = 0x00c;

pub const QSPI_TRANS_STATUS: c_uint = 0x010;

pub const QSPI_FIFO_STATUS: c_uint = 0x014;
    ...
    QSPI_TX_FIFO_EMPTY)
pub const QSPI_TX_DATA: c_uint = 0x018;
pub const QSPI_RX_DATA: c_uint = 0x01c;
pub const QSPI_DMA_CTL: c_uint = 0x020;

pub const QSPI_DMA_BLK: c_uint = 0x024;

pub const QSPI_DMA_MEM_ADDRESS: c_uint = 0x028;
pub const QSPI_DMA_HI_ADDRESS: c_uint = 0x02c;
pub const QSPI_TX_FIFO: c_uint = 0x108;
pub const QSPI_RX_FIFO: c_uint = 0x188;
pub const QSPI_FIFO_DEPTH: c_int = 64;
pub const QSPI_INTR_MASK: c_uint = 0x18c;

    QSPI_INTR_RX_FIFO_OVF_MASK | \
    QSPI_INTR_TX_FIFO_UNF_MASK | \
    QSPI_INTR_TX_FIFO_OVF_MASK)
pub const QSPI_MISC_REG: c_uint = 0x194;

pub const QSPI_DUMMY_CYCLES_MAX: c_uint = 0xff;
pub const QSPI_CMB_SEQ_CMD: c_uint = 0x19c;

pub const QSPI_CMB_SEQ_CMD_CFG: c_uint = 0x1a0;

pub const QSPI_CMB_SEQ_ADDR: c_uint = 0x1a8;

pub const QSPI_CMB_SEQ_ADDR_CFG: c_uint = 0x1ac;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_qspi_soc_data {
    pub cmb_xfer_capable: bool,
    pub supports_tpm: bool,
    pub has_ext_dma: bool,
    pub cs_count: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_qspi_client_data {
    pub tx_clk_tap_delay: c_int,
    pub rx_clk_tap_delay: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_qspi {
    pub dev: *mut device,
...
// lock to protect data accessed by irq
    ...
    pub cur_speed: u32,
    pub cur_pos: c_uint,
    pub words_per_32bit: c_uint,
    pub bytes_per_word: c_uint,
    pub curr_dma_words: c_uint,
    pub cur_direction: c_uint,
    pub cur_rx_pos: c_uint,
    pub cur_tx_pos: c_uint,
    ...
    pub is_packed: bool,
    pub use_dma: bool,
    pub command1_reg: u32,
    pub dma_control_reg: u32,
    pub def_command1_reg: u32,
    pub def_command2_reg: u32,
    pub spi_cs_timing1: u32,
    pub spi_cs_timing2: u32,
    pub dummy_cycles: u8,
    ...
    pub soc_data: *const tegra_qspi_soc_data,
}

#[no_mangle]
pub unsafe extern "C" fn tegra_qspi_readl(tqspi: *mut tegra_qspi, offset: c_ulong) -> u32 {
    static inline u32 tegra_qspi_readl(struct tegra_qspi *tqspi, unsigned long offset)
    {
    return readl(tqspi.base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_qspi_writel(tqspi: *mut tegra_qspi, value: u32, offset: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_mask_clear_irq(tqspi: *mut tegra_qspi) {
...
// clear fifo status error if any
    ...
    let mut remain_len: c_uint = t.len - tqspi.cur_pos;
...
//
    ...
    let mut bytes_per_word: u8 = tqspi.bytes_per_word;
...
//
    ...
    read_bytes = consume;
    for (count = 0; count < tqspi.curr_dma_words; count++) {
    let mut x: u32 = tqspi.rx_dma_buf[count] & rx_mask;
    for (i = 0; consume && (i < tqspi.bytes_per_word); i++, consume--)
// rx_buf++ = (x >> (i * 8)) & 0xff;
    }
    tqspi.cur_rx_pos += read_bytes;
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_dma_complete(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_start_tx_dma(tqspi: *mut tegra_qspi, t: *mut spi_transfer, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_start_rx_dma(tqspi: *mut tegra_qspi, t: *mut spi_transfer, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_flush_fifos(tqspi: *mut tegra_qspi, atomic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_unmask_irq(tqspi: *mut tegra_qspi) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_dma_map_xfer(tqspi: *mut tegra_qspi, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_dma_unmap_xfer(tqspi: *mut tegra_qspi, t: *mut spi_transfer) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_start_dma_based_transfer(tqspi: *mut tegra_qspi, t: *mut spi_transfer) -> c_int {
    static int tegra_qspi_start_dma_based_transfer(struct tegra_qspi *tqspi, struct spi_transfer *t)
    {
    let mut dma_sconfig: dma_slave_config = { 0 };
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_start_cpu_based_transfer(qspi: *mut tegra_qspi, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_deinit_dma(tqspi: *mut tegra_qspi) {
    static void tegra_qspi_deinit_dma(struct tegra_qspi *tqspi)
    {
    if (tqspi.tx_dma_buf) {
    dma_free_coherent(tqspi.tx_dma_dev, tqspi.dma_buf_size,
    tqspi.tx_dma_buf, tqspi.tx_dma_phys);
    tqspi.tx_dma_buf = core::ptr::null_mut();
    }
    if (tqspi.tx_dma_chan) {
    dma_release_channel(tqspi.tx_dma_chan);
    tqspi.tx_dma_chan = core::ptr::null_mut();
    }
    if (tqspi.rx_dma_buf) {
    dma_free_coherent(tqspi.rx_dma_dev, tqspi.dma_buf_size,
    tqspi.rx_dma_buf, tqspi.rx_dma_phys);
    tqspi.rx_dma_buf = core::ptr::null_mut();
    }
    if (tqspi.rx_dma_chan) {
    dma_release_channel(tqspi.rx_dma_chan);
    tqspi.rx_dma_chan = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn tegra_qspi_init_dma(tqspi: *mut tegra_qspi) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SPI_NBITS_DUAL: bus_width ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_dump_regs(tqspi: *mut tegra_qspi) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_reset(tqspi: *mut tegra_qspi) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_handle_error(tqspi: *mut tegra_qspi) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_transfer_end(spi: *mut spi_device) {
    static void tegra_qspi_transfer_end(struct spi_device *spi)
    {
    struct tegra_qspi *tqspi = spi_controller_get_devdata(spi.controller);
    let mut cs_val: c_int = (spi.mode & SPI_CS_HIGH) ? 0 : 1;
    if (cs_val)
...
//
#[no_mangle]
unsafe extern "C" fn tegra_qspi_handle_timeout(tqspi: *mut tegra_qspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_cmd_config(is_ddr: bool, bus_width: u8, len: u8) -> u32 {
    static u32 tegra_qspi_cmd_config(bool is_ddr, u8 bus_width, u8 len)
    {
    let mut cmd_config: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_addr_config(is_ddr: bool, bus_width: u8, len: u8) -> u32 {
    static u32 tegra_qspi_addr_config(bool is_ddr, u8 bus_width, u8 len)
    {
    let mut addr_config: u32 = 0;
    if (is_ddr)
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_dma_stop(tqspi: *mut tegra_qspi) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_pio_stop(tqspi: *mut tegra_qspi) {
    ...
    let mut transfer_phase: u8 = 0;
    let mut cmd1: u32 = 0;
    let mut ret: c_int = 0;
    let mut address_value: u32 = 0;
    let mut cmd_config: u32 = 0, addr_config = 0;
    let mut cmd_value: u8 = 0, val = 0;
    unsigned long flags;
...
// Reset controller if timeout happens
    ...
    spin_lock_irqsave(&tqspi.lock, flags);
    tqspi.curr_xfer = core::ptr::null_mut();
    spin_unlock_irqrestore(&tqspi.lock, flags);
    transfer_phase++;
    }
    ret = 0;
...
//
    ...
    let mut dummy_cycles: u32 = next_xfer.len * 8 / next_xfer.tx_nbits;
...
// de-activated CS between the transfers only when cs_change is set
    ...
    struct spi_message *msg)
    {
    let mut transfer_count: c_int = 0;
    struct spi_transfer *xfer;
    list_for_each_entry(xfer, &msg.transfers, transfer_list) {
    transfer_count++;
    }
...
#[no_mangle]
unsafe extern "C" fn handle_cpu_based_xfer(tqspi: *mut tegra_qspi) -> irqreturn_t {
    static irqreturn_t handle_cpu_based_xfer(struct tegra_qspi *tqspi)
    {
...
#[no_mangle]
unsafe extern "C" fn handle_dma_based_xfer(tqspi: *mut tegra_qspi) -> irqreturn_t {
    static irqreturn_t handle_dma_based_xfer(struct tegra_qspi *tqspi)
    {
    struct spi_transfer *t;
    unsigned int total_fifo_words;
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_isr_thread(irq: c_int, context_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    ret = request_threaded_irq(tqspi.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_qspi_runtime_resume(dev: *mut device) -> c_int {
...
// Runtime pm disabled with ACPI
    ...
    RUNTIME_PM_OPS(tegra_qspi_runtime_suspend, tegra_qspi_runtime_resume, core::ptr::null_mut())
