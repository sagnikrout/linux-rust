...
//! Source: drivers/spi/spi-atcspi200.c
#![no_std]
...
pub const ATCSPI_TRANS_FMT: c_uint = 0x10	/* SPI transfer format register */;
pub const ATCSPI_TRANS_CTRL: c_uint = 0x20	/* SPI transfer control register */;
pub const ATCSPI_CMD: c_uint = 0x24	/* SPI command register */;
pub const ATCSPI_ADDR: c_uint = 0x28	/* SPI address register */;
pub const ATCSPI_DATA: c_uint = 0x2C	/* SPI data register */;
pub const ATCSPI_CTRL: c_uint = 0x30	/* SPI control register */;
pub const ATCSPI_STATUS: c_uint = 0x34	/* SPI status register */;
pub const ATCSPI_TIMING: c_uint = 0x40	/* SPI interface timing register */;
pub const ATCSPI_CONFIG: c_uint = 0x7C	/* SPI configuration register */;
...
pub const TIMING_SCLK_DIV_MAX: c_uint = 0xFE;
// Configuration register

// driver configurations
pub const ATCSPI_MAX_TRANS_LEN: c_int = 512;
pub const ATCSPI_MAX_SPEED_HZ: c_int = 50000000;
pub const ATCSPI_RDY_TIMEOUT_US: c_int = 1000000;

pub const ATCSPI_MAX_CS_NUM: c_int = 1;
pub const ATCSPI_DMA_THRESHOLD: c_int = 256;
pub const ATCSPI_BITS_PER_UINT: c_int = 8;
pub const ATCSPI_DATA_MERGE_EN: c_int = 1;
pub const ATCSPI_DMA_SUPPORT: c_int = 1;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atcspi_dev {
    pub host: *mut spi_controller,
    pub mutex_lock: mutex,
    ...
    unsigned int val;
    let mut trans_bytes: c_int = op.data.nbytes;
    int num_byte;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn atcspi_adjust_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcspi_dma_config(spi: *mut atcspi_dev, is_rx: bool) -> c_int {
    static int atcspi_dma_config(struct atcspi_dev *spi, bool is_rx)
    {
    let mut conf: dma_slave_config = { 0 };
...
#[no_mangle]
unsafe extern "C" fn atcspi_dma_callback(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn atcspi_exec_mem_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcspi_setup(spi: *mut atcspi_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcspi_configure_dma(spi: *mut atcspi_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcspi_enable_clk(spi: *mut atcspi_dev) -> c_int {
    static int atcspi_enable_clk(struct atcspi_dev *spi)
    {
    spi.clk = devm_clk_get_enabled(spi.dev, core::ptr::null_mut());
    if (IS_ERR(spi.clk))
...
#[no_mangle]
unsafe extern "C" fn atcspi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcspi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcspi_resume(dev: *mut device) -> c_int {
