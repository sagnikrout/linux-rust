...
//! Source: drivers/spi/spi-nxp-xspi.c
#![no_std]
...
//
pub const XSPI_SEQID_LUT: c_int = 15;
pub const XSPI_MCR: c_uint = 0x0;

pub const XSPI_IPCR: c_uint = 0x8;
pub const XSPI_FLSHCR: c_uint = 0xC;

pub const XSPI_BUF0CR: c_uint = 0x10;
pub const XSPI_BUF1CR: c_uint = 0x14;
pub const XSPI_BUF2CR: c_uint = 0x18;
pub const XSPI_BUF3CR: c_uint = 0x1C;

pub const XSPI_BFGENCR: c_uint = 0x20;

pub const XSPI_BUF0IND: c_uint = 0x30;
pub const XSPI_BUF1IND: c_uint = 0x34;
pub const XSPI_BUF2IND: c_uint = 0x38;
pub const XSPI_DLLCRA: c_uint = 0x60;

pub const XSPI_SFAR: c_uint = 0x100;
pub const XSPI_SFACR: c_uint = 0x104;

pub const XSPI_SMPR: c_uint = 0x108;

pub const XSPI_RBSR: c_uint = 0x10C;
pub const XSPI_RBCT: c_uint = 0x110;

pub const XSPI_DLLSR: c_uint = 0x12C;

pub const XSPI_TBSR: c_uint = 0x150;
pub const XSPI_TBDR: c_uint = 0x154;
pub const XSPI_TBCT: c_uint = 0x158;

pub const XSPI_SR: c_uint = 0x15C;

pub const XSPI_FR: c_uint = 0x160;

pub const XSPI_RSER: c_uint = 0x164;

pub const XSPI_SFA1AD: c_uint = 0x180;
pub const XSPI_SFA2AD: c_uint = 0x184;
pub const XSPI_RBDR0: c_uint = 0x200;
pub const XSPI_LUTKEY: c_uint = 0x300;

pub const XSPI_LCKCR: c_uint = 0x304;

pub const XSPI_LUT: c_uint = 0x310;

    (XSPI_LUT + XSPI_LUT_OFFSET + (idx) * 4)
pub const XSPI_MCREXT: c_uint = 0x4FC;

pub const XSPI_FRAD0_WORD2: c_uint = 0x808;

pub const XSPI_FRAD0_WORD3: c_uint = 0x80C;

pub const XSPI_TG0MDAD: c_uint = 0x900;

pub const XSPI_TG1MDAD: c_uint = 0x910;
pub const XSPI_MGC: c_uint = 0x920;

pub const XSPI_MTO: c_uint = 0x928;
pub const XSPI_ERRSTAT: c_uint = 0x938;
pub const XSPI_INT_EN: c_uint = 0x93C;
pub const XSPI_SFP_TG_IPCR: c_uint = 0x958;

pub const XSPI_SFP_TG_SFAR: c_uint = 0x95C;
// Register map end
// XSPI CMD definitions
pub const LUT_STOP: c_uint = 0x00;
pub const LUT_CMD_SDR: c_uint = 0x01;
pub const LUT_ADDR_SDR: c_uint = 0x02;
pub const LUT_DUMMY: c_uint = 0x03;
pub const LUT_MODE8_SDR: c_uint = 0x04;
pub const LUT_MODE2_SDR: c_uint = 0x05;
pub const LUT_MODE4_SDR: c_uint = 0x06;
pub const LUT_READ_SDR: c_uint = 0x07;
pub const LUT_WRITE_SDR: c_uint = 0x08;
pub const LUT_JMP_ON_CS: c_uint = 0x09;
pub const LUT_ADDR_DDR: c_uint = 0x0A;
pub const LUT_MODE8_DDR: c_uint = 0x0B;
pub const LUT_MODE2_DDR: c_uint = 0x0C;
pub const LUT_MODE4_DDR: c_uint = 0x0D;
pub const LUT_READ_DDR: c_uint = 0x0E;
pub const LUT_WRITE_DDR: c_uint = 0x0F;
pub const LUT_DATA_LEARN: c_uint = 0x10;
pub const LUT_CMD_DDR: c_uint = 0x11;
pub const LUT_CADDR_SDR: c_uint = 0x12;
pub const LUT_CADDR_DDR: c_uint = 0x13;
pub const JMP_TO_SEQ: c_uint = 0x14;
pub const XSPI_64BIT_LE: c_uint = 0x3;
//
...
//
pub const NXP_XSPI_DMA_TOUT_MS: c_int = 5000;

pub const NXP_XSPI_MAX_CHIPSELECT: c_int = 2;
pub const POLL_TOUT_US: c_int = 5000;
// Access flash memory using IP bus only

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxp_xspi_devtype_data {
    pub rxfifo: c_uint,
    pub txfifo: c_uint,
...
pub struct nxp_xspi {
    ...
    pub dev: *mut device,
    pub c: completion,
    pub devtype_data: *const nxp_xspi_devtype_data,
// mutex lock for each operation
    pub lock: mutex,
    pub selected: c_int,
    pub dma_copy_align: c_int,
    pub dma_rx: *mut dma_chan,
    pub dma_rx_c: completion,

    pub flags: c_int,
// Save the previous operation clock rate
    pub pre_op_rate: c_ulong,
// The max clock rate xspi supported output to device
    pub support_max_rate: c_ulong,
}

#[no_mangle]
pub unsafe extern "C" fn needs_ip_only(xspi: *mut nxp_xspi) -> c_int {
    static inline int needs_ip_only(struct nxp_xspi *xspi)
    {
    return xspi.devtype_data.quirks & XSPI_QUIRK_USE_IP_ONLY;
    }
#[no_mangle]
unsafe extern "C" fn nxp_xspi_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_check_buswidth(xspi: *mut nxp_xspi, width: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_disable_ddr(xspi: *mut nxp_xspi) {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_enable_ddr(xspi: *mut nxp_xspi) {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_sw_reset(xspi: *mut nxp_xspi) {
    static void nxp_xspi_sw_reset(struct nxp_xspi *xspi)
    {
    void __iomem *base = xspi.iobase;
    let mut mdis_flag: bool = false;
    u32 reg;
    int ret;
    reg = readl(base + XSPI_MCR);
//
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_dll_bypass(xspi: *mut nxp_xspi) {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_dll_auto(xspi: *mut nxp_xspi, rate: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_ahb_read(xspi: *mut nxp_xspi, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_dma_init(dev: *mut device, xspi: *mut nxp_xspi) -> c_int {
    static int nxp_xspi_dma_init(struct device *dev, struct nxp_xspi *xspi)
    {
    struct dma_chan *rx;
    rx = dma_request_chan(dev, "rx");
    if (IS_ERR(rx)) {
    let mut ret: c_int = PTR_ERR(rx);
    if (ret == -EPROBE_DEFER)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_dma_rx_callback(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_do_op(xspi: *mut nxp_xspi, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_exec_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_adjust_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
    static int nxp_xspi_adjust_op_size(struct spi_mem *mem, struct spi_mem_op *op)
    {
    struct nxp_xspi *xspi = spi_controller_get_devdata(mem.spi.controller);
    let mut alignment: c_int = xspi.dma_copy_align;
    if (op.data.dir == SPI_MEM_DATA_OUT) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1): op->data.nbytes & (alignment -) -> else {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_config_ahb_buffer(xspi: *mut nxp_xspi) {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_default_setup(xspi: *mut nxp_xspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_xspi_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(nxp_xspi_runtime_suspend, nxp_xspi_runtime_resume, core::ptr::null_mut())
