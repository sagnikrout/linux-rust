...
//! Source: drivers/spi/spi-offload.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spi_controller_and_offload {
...
#[no_mangle]
unsafe extern "C" fn spi_offload_put(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn spi_offload_trigger_free(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn spi_offload_trigger_put(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn spi_offload_release_dma_chan(chan: *mut c_void) {
...
// Triggers providers
#[no_mangle]
unsafe extern "C" fn spi_offload_trigger_unregister(data: *mut c_void) {
    ...
    scoped_guard(mutex, &trigger.lock) {
    trigger.priv = core::ptr::null_mut();
    trigger.ops = core::ptr::null_mut();
    }
    kref_put(&trigger.ref, spi_offload_trigger_free);
    }
//
