...
//! Source: drivers/spi/spi-synquacer.c
#![no_std]
...
pub const SYNQUACER_HSSPI_REG_MCTRL: c_uint = 0x00;
pub const SYNQUACER_HSSPI_REG_PCC0: c_uint = 0x04;

pub const SYNQUACER_HSSPI_REG_TXF: c_uint = 0x14;
pub const SYNQUACER_HSSPI_REG_TXE: c_uint = 0x18;
pub const SYNQUACER_HSSPI_REG_TXC: c_uint = 0x1C;
pub const SYNQUACER_HSSPI_REG_RXF: c_uint = 0x20;
pub const SYNQUACER_HSSPI_REG_RXE: c_uint = 0x24;
pub const SYNQUACER_HSSPI_REG_RXC: c_uint = 0x28;
pub const SYNQUACER_HSSPI_REG_FAULTF: c_uint = 0x2C;
pub const SYNQUACER_HSSPI_REG_FAULTC: c_uint = 0x30;
pub const SYNQUACER_HSSPI_REG_DMCFG: c_uint = 0x34;
pub const SYNQUACER_HSSPI_REG_DMSTART: c_uint = 0x38;
pub const SYNQUACER_HSSPI_REG_DMBCC: c_uint = 0x3C;
pub const SYNQUACER_HSSPI_REG_DMSTATUS: c_uint = 0x40;
pub const SYNQUACER_HSSPI_REG_FIFOCFG: c_uint = 0x4C;
pub const SYNQUACER_HSSPI_REG_TX_FIFO: c_uint = 0x50;
pub const SYNQUACER_HSSPI_REG_RX_FIFO: c_uint = 0x90;
pub const SYNQUACER_HSSPI_REG_MID: c_uint = 0xFC;
// HSSPI register bit definitions

pub const SYNQUACER_HSSPI_PCC_CDRS_MASK: c_uint = 0x7f;

pub const SYNQUACER_HSSPI_DMPSEL_CS_MASK: c_uint = 0x3;

pub const SYNQUACER_HSSPI_DMTRP_DATA_MASK: c_uint = 0x3;

pub const SYNQUACER_HSSPI_DMTRP_DATA_TXRX: c_int = 0;
pub const SYNQUACER_HSSPI_DMTRP_DATA_RX: c_int = 1;
pub const SYNQUACER_HSSPI_DMTRP_DATA_TX: c_int = 2;
pub const SYNQUACER_HSSPI_DMSTATUS_RX_DATA_MASK: c_uint = 0x1f;

pub const SYNQUACER_HSSPI_DMSTATUS_TX_DATA_MASK: c_uint = 0x1f;

pub const SYNQUACER_HSSPI_FIFOCFG_RX_THRESHOLD_MASK: c_uint = 0xf;

pub const SYNQUACER_HSSPI_FIFOCFG_TX_THRESHOLD_MASK: c_uint = 0xf;

pub const SYNQUACER_HSSPI_FIFOCFG_FIFO_WIDTH_MASK: c_uint = 0x3;

    (SYNQUACER_HSSPI_FIFO_DEPTH - SYNQUACER_HSSPI_FIFO_TX_THRESHOLD)

pub const SYNQUACER_HSSPI_CLOCK_SRC_IHCLK: c_int = 0;
pub const SYNQUACER_HSSPI_CLOCK_SRC_IPCLK: c_int = 1;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct synquacer_spi {
    pub dev: *mut device,
    pub transfer_done: completion,
    pub cs: c_uint,
    pub bpw: c_uint,
    pub mode: c_uint,
    pub speed: c_uint,
    ...
    pub clk: *mut clk,
    pub clk_src_type: c_int,
    pub regs: *mut void __iomem,
    pub rx_words: u32 tx_words,,
    pub bus_width: c_uint,
    pub transfer_mode: c_uint,
    pub rx_irq_name: [c_char; SYNQUACER_HSSPI_IRQ_NAME_MAX],
    pub tx_irq_name: [c_char; SYNQUACER_HSSPI_IRQ_NAME_MAX],
}

#[no_mangle]
unsafe extern "C" fn read_fifo(sspi: *mut synquacer_spi) -> c_int {
    static int read_fifo(struct synquacer_spi *sspi)
    {
    let mut len: u32 = readl(sspi.regs + SYNQUACER_HSSPI_REG_DMSTATUS);
...
#[no_mangle]
unsafe extern "C" fn write_fifo(sspi: *mut synquacer_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn synquacer_spi_set_cs(spi: *mut spi_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn synquacer_spi_enable(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sq_spi_rx_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sq_spi_tx_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn synquacer_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn synquacer_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn synquacer_spi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn synquacer_spi_resume(dev: *mut device) -> c_int {
