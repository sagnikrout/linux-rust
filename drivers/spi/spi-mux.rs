...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spi_mux_priv {
    pub spi: *mut spi_device,
    pub current_cs: c_uint,
    pub context): *mut *mut void (child_msg_complete)(void,
    pub child_msg_context: *mut c_void,
    pub child_msg_dev: *mut spi_device,
    pub mux: *mut mux_control,
}

// should not get called when the parent controller is doing a transfer
#[no_mangle]
unsafe extern "C" fn spi_mux_select(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_mux_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_mux_complete_cb(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn spi_mux_probe(spi: *mut spi_device) -> c_int {
...
//
    ...
    priv.mux = devm_mux_control_get(&spi.dev, core::ptr::null_mut());
    if (IS_ERR(priv.mux)) {
