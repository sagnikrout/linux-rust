...
pub const SPI_MCR: c_uint = 0x00;

pub const SPI_TCR: c_uint = 0x08;

pub const SPI_CTAR_SCALE_BITS: c_uint = 0xf;
pub const SPI_CTAR0_SLAVE: c_uint = 0x0c;
pub const SPI_SR: c_uint = 0x2c;
...
pub const SPI_RSER: c_uint = 0x30;

pub const SPI_PUSHR: c_uint = 0x34;

pub const SPI_PUSHR_SLAVE: c_uint = 0x34;
pub const SPI_POPR: c_uint = 0x38;
pub const SPI_TXFR0: c_uint = 0x3c;
pub const SPI_TXFR1: c_uint = 0x40;
pub const SPI_TXFR2: c_uint = 0x44;
pub const SPI_TXFR3: c_uint = 0x48;
pub const SPI_TXFR4: c_uint = 0x4C;
pub const SPI_RXFR0: c_uint = 0x7c;
pub const SPI_RXFR1: c_uint = 0x80;
pub const SPI_RXFR2: c_uint = 0x84;
pub const SPI_RXFR3: c_uint = 0x88;
pub const SPI_RXFR4: c_uint = 0x8C;

pub const SPI_SREX: c_uint = 0x13c;

pub const SPI_25MHZ: c_int = 25000000;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_dspi_devtype_data {
    pub trans_mode: enum dspi_trans_mode,
    pub max_clock_factor: u8,
    pub fifo_size: c_int,
...
pub struct fsl_dspi {
    ...
    pub regmap_pushr: *mut regmap,
    pub irq: c_int,
    pub clk: *mut clk,
    pub cur_transfer: *mut spi_transfer,
    pub cur_msg: *mut spi_message,
    ...
    pub devtype_data: *const fsl_dspi_devtype_data,
    pub xfer_done: completion,
    pub dma: *mut fsl_dspi_dma,
    pub oper_word_size: c_int,
    pub oper_bits_per_word: c_int,
    pub words_in_flight: c_int,
//
...
//
    pub pushr_cmd: c_int,
    pub pushr_tx: c_int,
    pub txdata): *mut *mut *mut void (host_to_dev)(struct fsl_dspi dspi, u32,
    pub rxdata): *mut *mut *mut void (dev_to_host)(struct fsl_dspi dspi, u32,
}

    static void dspi_setup_accel(struct fsl_dspi *dspi);
#[no_mangle]
unsafe extern "C" fn is_s32g_dspi(data: *mut fsl_dspi) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dspi_native_host_to_dev(dspi: *mut fsl_dspi, txdata: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn dspi_native_dev_to_host(dspi: *mut fsl_dspi, rxdata: u32) {
...
#[no_mangle]
unsafe extern "C" fn dspi_8on32_host_to_dev(dspi: *mut fsl_dspi, txdata: *mut u32) {
    static void dspi_8on32_host_to_dev(struct fsl_dspi *dspi, u32 *txdata)
    {
// txdata = ( u32)cpu_to_be32(*(u32 *)dspi->tx);
    dspi.tx += sizeof(u32);
    }
#[no_mangle]
unsafe extern "C" fn dspi_8on32_dev_to_host(dspi: *mut fsl_dspi, rxdata: u32) {
    static void dspi_8on32_dev_to_host(struct fsl_dspi *dspi, u32 rxdata)
    {
// (u32 *)dspi->rx = be32_to_cpu(( __be32)rxdata);
    dspi.rx += sizeof(u32);
    }
#[no_mangle]
unsafe extern "C" fn dspi_8on16_host_to_dev(dspi: *mut fsl_dspi, txdata: *mut u32) {
    static void dspi_8on16_host_to_dev(struct fsl_dspi *dspi, u32 *txdata)
    {
// txdata = ( u32)cpu_to_be16(*(u16 *)dspi->tx);
    dspi.tx += sizeof(u16);
    }
#[no_mangle]
unsafe extern "C" fn dspi_8on16_dev_to_host(dspi: *mut fsl_dspi, rxdata: u32) {
    static void dspi_8on16_dev_to_host(struct fsl_dspi *dspi, u32 rxdata)
    {
// (u16 *)dspi->rx = be16_to_cpu(( __be16)rxdata);
    dspi.rx += sizeof(u16);
    }
#[no_mangle]
unsafe extern "C" fn dspi_16on32_host_to_dev(dspi: *mut fsl_dspi, txdata: *mut u32) {
    static void dspi_16on32_host_to_dev(struct fsl_dspi *dspi, u32 *txdata)
    {
    let mut hi: u16 = *(u16 *)dspi.tx;
    let mut lo: u16 = *(u16 *)(dspi.tx + 2);
// txdata = (u32)hi << 16 | lo;
    dspi.tx += sizeof(u32);
    }
#[no_mangle]
unsafe extern "C" fn dspi_16on32_dev_to_host(dspi: *mut fsl_dspi, rxdata: u32) {
    static void dspi_16on32_dev_to_host(struct fsl_dspi *dspi, u32 rxdata)
    {
    let mut hi: u16 = rxdata & 0xffff;
    let mut lo: u16 = rxdata >> 16;
// (u16 *)dspi->rx = lo;
// (u16 *)(dspi->rx + 2) = hi;
    dspi.rx += sizeof(u32);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dspi_pop_tx(dspi: *mut fsl_dspi) -> u32 {
    static u32 dspi_pop_tx(struct fsl_dspi *dspi)
    {
    let mut txdata: u32 = 0;
    if (dspi.tx)
...
#[no_mangle]
unsafe extern "C" fn dspi_push_rx(dspi: *mut fsl_dspi, rxdata: u32) {
...
#[no_mangle]
unsafe extern "C" fn dspi_fifo_error(dspi: *mut fsl_dspi, spi_sr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dspi_pop_tx_pushr(dspi: *mut fsl_dspi) -> u32 {
    static u32 dspi_pop_tx_pushr(struct fsl_dspi *dspi)
    {
    let mut cmd: u16 = dspi.tx_cmd, data = dspi_pop_tx(dspi);
...
#[no_mangle]
unsafe extern "C" fn dspi_dma_max_datawords(dspi: *mut fsl_dspi) -> usize {
...
#[no_mangle]
unsafe extern "C" fn dspi_dma_transfer_size(dspi: *mut fsl_dspi) -> usize {
    static size_t dspi_dma_transfer_size(struct fsl_dspi *dspi)
    {
    return dspi.words_in_flight * DMA_SLAVE_BUSWIDTH_4_BYTES;
    }
#[no_mangle]
unsafe extern "C" fn dspi_tx_dma_callback(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dspi_rx_dma_callback(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dspi_next_xfer_dma_submit(dspi: *mut fsl_dspi) -> c_int {
    static int dspi_next_xfer_dma_submit(struct fsl_dspi *dspi)
    {
    let mut size: usize = dspi_dma_transfer_size(dspi);
    struct device *dev = &dspi.pdev.dev;
    struct fsl_dspi_dma *dma = dspi.dma;
    int time_left;
    u32 spi_sr;
...
#[no_mangle]
unsafe extern "C" fn dspi_dma_xfer(dspi: *mut fsl_dspi) {
...
#[no_mangle]
unsafe extern "C" fn dspi_request_dma(dspi: *mut fsl_dspi, phy_addr: phys_addr_t) -> c_int {
...
//
    ...
    devm_kfree(dev, dma);
    dspi.dma = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn dspi_release_dma(dspi: *mut fsl_dspi) {
...
#[no_mangle]
unsafe extern "C" fn dspi_pushr_cmd_write(dspi: *mut fsl_dspi, cmd: u16) {
...
#[no_mangle]
unsafe extern "C" fn dspi_pushr_txdata_write(dspi: *mut fsl_dspi, txdata: u16) {
    static void dspi_pushr_txdata_write(struct fsl_dspi *dspi, u16 txdata)
    {
    regmap_write(dspi.regmap_pushr, dspi.pushr_tx, txdata);
    }
#[no_mangle]
unsafe extern "C" fn dspi_xspi_fifo_write(dspi: *mut fsl_dspi, num_words: c_int) {
    static void dspi_xspi_fifo_write(struct fsl_dspi *dspi, int num_words)
    {
    let mut num_bytes: c_int = num_words * dspi.oper_word_size;
    let mut tx_cmd: u16 = dspi.tx_cmd;
//
...
// Fill TX FIFO with as many transfers as possible
    while (num_words--) {
    let mut data: u32 = dspi_pop_tx(dspi);
...
#[no_mangle]
unsafe extern "C" fn dspi_popr_read(dspi: *mut fsl_dspi) -> u32 {
    static u32 dspi_popr_read(struct fsl_dspi *dspi)
    {
    let mut rxdata: u32 = 0;
    regmap_read(dspi.regmap, SPI_POPR, &rxdata);
    return rxdata;
    }
#[no_mangle]
unsafe extern "C" fn dspi_fifo_read(dspi: *mut fsl_dspi) {
    static void dspi_fifo_read(struct fsl_dspi *dspi)
    {
    let mut num_fifo_entries: c_int = dspi.words_in_flight;
// Read one FIFO entry and push to rx buffer
    while (num_fifo_entries--)
    dspi_push_rx(dspi, dspi_popr_read(dspi));
    }
#[no_mangle]
unsafe extern "C" fn dspi_setup_accel(dspi: *mut fsl_dspi) {
    static void dspi_setup_accel(struct fsl_dspi *dspi)
    {
    struct spi_transfer *xfer = dspi.cur_transfer;
    let mut odd: bool = !!(dspi.len & 1);
//
...
#[no_mangle]
unsafe extern "C" fn dspi_fifo_write(dspi: *mut fsl_dspi) {
    static void dspi_fifo_write(struct fsl_dspi *dspi)
    {
    let mut num_fifo_entries: c_int = dspi.devtype_data.fifo_size;
    struct spi_transfer *xfer = dspi.cur_transfer;
...
//
#[no_mangle]
unsafe extern "C" fn dspi_rxtx(dspi: *mut fsl_dspi) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dspi_poll(dspi: *mut fsl_dspi) {
...
#[no_mangle]
unsafe extern "C" fn dspi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dspi_assert_cs(spi: *mut spi_device, cs: *mut bool) {
...
#[no_mangle]
unsafe extern "C" fn dspi_deassert_cs(spi: *mut spi_device, cs: *mut bool) {
...
//
    ...
    dspi.cur_msg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dspi_set_mtf(dspi: *mut fsl_dspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dspi_setup(spi: *mut spi_device) -> c_int {
    static int dspi_setup(struct spi_device *spi)
    {
    struct fsl_dspi *dspi = spi_controller_get_devdata(spi.controller);
    let mut period_ns: u32 = DIV_ROUND_UP(NSEC_PER_SEC, spi.max_speed_hz);
    let mut br: c_uchar = 0, pbr = 0, pcssck = 0, cssck = 0;
    let mut quarter_period_ns: u32 = DIV_ROUND_UP(period_ns, 4);
    let mut cs_sck_delay: u32 = 0, sck_cs_delay = 0;
    struct fsl_dspi_platform_data *pdata;
    let mut pasc: c_uchar = 0, asc = 0;
    struct gpio_desc *gpio_cs;
    struct chip_data *chip;
    unsigned long clkrate;
    let mut cs: bool = true;
    int val;
// Only alloc on first setup
    ...
    if (!pdata) {
    val = spi_delay_to_ns(&spi.cs_setup, core::ptr::null_mut());
    cs_sck_delay = val >= 0 ? val : 0;
    if (!cs_sck_delay)
    of_property_read_u32(spi.dev.of_node,
    "fsl,spi-cs-sck-delay",
    &cs_sck_delay);
    val = spi_delay_to_ns(&spi.cs_hold, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dspi_cleanup(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn dspi_init(dspi: *mut fsl_dspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dspi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dspi_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dspi_target_abort(host: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dspi_probe(pdev: *mut platform_device) -> c_int {
...
// Only Coldfire uses platform data
    ...
    ret = request_threaded_irq(dspi.irq, dspi_interrupt, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn dspi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dspi_shutdown(pdev: *mut platform_device) {
