...
//! Source: drivers/spi/spi-geni-qcom.c
#![no_std]
...
pub const SE_SPI_CPHA: c_uint = 0x224;

pub const SE_SPI_LOOPBACK: c_uint = 0x22c;
pub const LOOPBACK_ENABLE: c_uint = 0x1;
pub const NORMAL_MODE: c_uint = 0x0;

pub const SE_SPI_CPOL: c_uint = 0x230;

pub const SE_SPI_DEMUX_OUTPUT_INV: c_uint = 0x24c;

pub const SE_SPI_DEMUX_SEL: c_uint = 0x250;

pub const SE_SPI_TRANS_CFG: c_uint = 0x25c;

pub const SE_SPI_WORD_LEN: c_uint = 0x268;

pub const MIN_WORD_LEN: c_int = 4;
pub const SE_SPI_TX_TRANS_LEN: c_uint = 0x26c;
pub const SE_SPI_RX_TRANS_LEN: c_uint = 0x270;

pub const SE_SPI_PRE_POST_CMD_DLY: c_uint = 0x274;
pub const SE_SPI_DELAY_COUNTERS: c_uint = 0x278;

pub const SPI_CS_CLK_DELAY_SHFT: c_int = 10;

// M_CMD OP codes for SPI
pub const SPI_TX_ONLY: c_int = 1;
pub const SPI_RX_ONLY: c_int = 2;
pub const SPI_TX_RX: c_int = 7;
pub const SPI_CS_ASSERT: c_int = 8;
pub const SPI_CS_DEASSERT: c_int = 9;
pub const SPI_SCK_ONLY: c_int = 10;
// M_CMD params for SPI

#[repr(C)]
#[derive(Copy, Clone)]
pub struct geni_spi_desc {
    pub se): *mut *mut int (resources_init)(struct geni_se,
    pub clk_freq): *mut *mut *mut int (set_rate)(struct geni_se se, unsigned long,
...
pub struct spi_geni_master {
    ...
    pub last_mode: u32,
    pub last_cs: u8,
    pub cur_speed_hz: c_ulong,
    pub cur_sclk_hz: c_ulong,
    pub cur_bits_per_word: c_uint,
    pub tx_rem_bytes: c_uint,
    pub rx_rem_bytes: c_uint,
    pub cur_xfer: *const spi_transfer,
    pub cs_done: completion,
    ...
    pub tx: *mut dma_chan,
    pub rx: *mut dma_chan,
    pub cur_xfer_mode: c_int,
    pub dev_data: *const geni_spi_desc,
}

#[no_mangle]
unsafe extern "C" fn spi_slv_setup(mas: *mut spi_geni_master) {
...
#[no_mangle]
unsafe extern "C" fn handle_se_timeout(spi: *mut spi_controller) {
    ...
    xfer = mas.cur_xfer;
    mas.cur_xfer = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn handle_gpi_timeout(spi: *mut spi_controller) {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_handle_err(spi: *mut spi_controller, msg: *mut spi_message) {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_is_abort_still_pending(mas: *mut spi_geni_master) -> bool {
...
//
    ...
    let mut msb_first: bool = (mode & SPI_LSB_FIRST) ? false : true;
    struct geni_se *se = &mas.se;
    u32 word_len;
//
...
// Set BW quota for CPU as driver supports FIFO mode only.
    ...
    struct spi_geni_master *mas = spi_controller_get_devdata(spi);
    struct geni_se *se = &mas.se;
    let mut chipselect: u8 = spi_get_chipselect(spi_slv, 0);
    let mut cs_changed: bool = (mas.last_cs != chipselect);
    let mut mode_changed: u32 = mas.last_mode ^ spi_slv.mode;
    ...
    let mut peripheral: gpi_spi_config = {};
    ...
    let mut bytes_per_word: c_int = (mas.cur_bits_per_word / BITS_PER_BYTE) + 1;
...
#[no_mangle]
unsafe extern "C" fn spi_geni_release_dma_chan(data: *mut c_void) {
    static void spi_geni_release_dma_chan(void *data)
    {
    struct spi_geni_master *mas = data;
    if (mas.rx) {
    dma_release_channel(mas.rx);
    mas.rx = core::ptr::null_mut();
    }
    if (mas.tx) {
    dma_release_channel(mas.tx);
    mas.tx = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn spi_geni_grab_gpi_chan(mas: *mut spi_geni_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_init(mas: *mut spi_geni_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn geni_byte_per_fifo_word(mas: *mut spi_geni_master) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn geni_spi_handle_tx(mas: *mut spi_geni_master) -> bool {
    static bool geni_spi_handle_tx(struct spi_geni_master *mas)
    {
    struct geni_se *se = &mas.se;
    unsigned int max_bytes;
    const u8 *tx_buf;
    let mut bytes_per_fifo_word: c_uint = geni_byte_per_fifo_word(mas);
    let mut i: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn geni_spi_handle_rx(mas: *mut spi_geni_master) {
...
//
    ...
    mas.cur_xfer_mode = GENI_SE_FIFO;
#[no_mangle]
pub unsafe extern "C" fn if(1: xfer->tx_sg.nents > 1 || xfer->rx_sg.nents >) -> else {
...
#[no_mangle]
unsafe extern "C" fn geni_spi_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_target_abort(spi: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_geni_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(spi_geni_runtime_suspend, spi_geni_runtime_resume, core::ptr::null_mut())
