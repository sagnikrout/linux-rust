...
//! Source: drivers/spi/spi-virtio.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_spi_req {
    pub completion: completion,
    pub tx_buf: *const u8,
    pub rx_buf: *mut u8,
    pub ____cacheline_aligned: spi_transfer_head transfer_head,
    pub result: spi_transfer_result,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_spi_priv {
...
#[no_mangle]
unsafe extern "C" fn virtio_spi_msg_done(vq: *mut virtqueue) {
...
//
    ...
    let mut outcnt: c_uint = 0;
    let mut incnt: c_uint = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn virtio_spi_read_config(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_spi_find_vqs(priv: *mut virtio_spi_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_spi_del_vq(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn virtio_spi_probe(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_spi_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_spi_restore(dev: *mut device) -> c_int {
