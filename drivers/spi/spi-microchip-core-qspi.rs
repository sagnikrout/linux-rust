...
//! Source: drivers/spi/spi-microchip-core-qspi.c
#![no_std]
...
pub const CONTROL_CLKRATE_SHIFT: c_int = 24;
//
// QSPI Frames register mask defines
//

pub const FRAMES_CMDBYTES_SHIFT: c_int = 16;
pub const FRAMES_SHIFT: c_int = 25;

pub const FRAMES_IDLE_SHIFT: c_int = 26;
...
pub const DIRECT_ACCESS_OP_SSEL_SHIFT: c_int = 1;

pub const MAX_DIVIDER: c_int = 16;
pub const MIN_DIVIDER: c_int = 0;
pub const MAX_DATA_CMD_LEN: c_int = 256;
// QSPI ready time out value
pub const TIMEOUT_MS: c_int = 500;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp_coreqspi {
    pub regs: *mut void __iomem,
    pub clk: *mut clk,
    pub data_completion: completion,
    pub /: *mut *mut mutex op_lock; / lock access to the device,
    pub txbuf: *mut u8,
    pub rxbuf: *mut u8,
    pub irq: c_int,
    pub tx_len: c_int,
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_set_mode(qspi: *mut mchp_coreqspi, op: *const spi_mem_op) -> c_int {
    static int mchp_coreqspi_set_mode(struct mchp_coreqspi *qspi, const struct spi_mem_op *op)
    {
    let mut control: u32 = readl_relaxed(qspi.regs + REG_CONTROL);
//
...
#[no_mangle]
pub unsafe extern "C" fn if(1: op->cmd.buswidth ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_set_cs(spi: *mut spi_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_read_op(qspi: *mut mchp_coreqspi) {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_write_op(qspi: *mut mchp_coreqspi) {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_write_read_op(qspi: *mut mchp_coreqspi) {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_enable_ints(qspi: *mut mchp_coreqspi) {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_disable_ints(qspi: *mut mchp_coreqspi) {
    static void mchp_coreqspi_disable_ints(struct mchp_coreqspi *qspi)
    {
    writel_relaxed(0, qspi.regs + REG_IEN);
    }
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    let mut intfield: c_int = readl_relaxed(qspi.regs + REG_STATUS) & STATUS_MASK;
    if (intfield == 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_config_op(qspi: *mut mchp_coreqspi, op: *const spi_mem_op) {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_wait_for_ready(qspi: *mut mchp_coreqspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_exec_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
    ...
    (mem.spi.controller);
    let mut address: u32 = op.addr.val;
    let mut opcode: u8 = op.cmd.opcode;
    u8 opaddr[5];
    int err, i;
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_supports_op(mem: *mut spi_mem, op: *const spi_mem_op) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_adjust_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_unprepare_message(ctlr: *mut spi_controller, m: *mut spi_message) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_prepare_message(ctlr: *mut spi_controller, m: *mut spi_message) -> c_int {
    ...
    u32 control, frames;
    let mut total_bytes: u32 = 0, cmd_bytes = 0, idle_cycles = 0;
    int ret;
    let mut quad: bool = false, dual = false;
    mutex_lock(&qspi.op_lock);
    ...
    quad = true;
#[no_mangle]
pub unsafe extern "C" fn if(SPI_NBITS_DUAL: t->tx_nbits == SPI_NBITS_DUAL || t->rx_nbits ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_probe(pdev: *mut platform_device) -> c_int {
    ...
    qspi.clk = devm_clk_get_enabled(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(qspi.clk))
...
#[no_mangle]
unsafe extern "C" fn mchp_coreqspi_remove(pdev: *mut platform_device) {
