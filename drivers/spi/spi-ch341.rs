...
//! Source: drivers/spi/spi-ch341.c
#![no_std]
...
pub const CH341_PACKET_LENGTH: c_int = 32;
pub const CH341_DEFAULT_TIMEOUT: c_int = 1000;
pub const CH341A_CMD_UIO_STREAM: c_uint = 0xab;
pub const CH341A_CMD_UIO_STM_END: c_uint = 0x20;
pub const CH341A_CMD_UIO_STM_DIR: c_uint = 0x40;
pub const CH341A_CMD_UIO_STM_OUT: c_uint = 0x80;
pub const CH341A_CMD_I2C_STREAM: c_uint = 0xaa;
pub const CH341A_CMD_I2C_STM_SET: c_uint = 0x60;
pub const CH341A_CMD_I2C_STM_END: c_uint = 0x00;
pub const CH341A_CMD_SPI_STREAM: c_uint = 0xa8;
pub const CH341A_STM_I2C_100K: c_uint = 0x01;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ch341_spi_dev {
    pub ctrl: *mut spi_controller,
    pub udev: *mut usb_device,
    pub write_pipe: c_uint,
    pub read_pipe: c_uint,
    pub rx_len: c_int,
...
#[no_mangle]
unsafe extern "C" fn ch341_set_cs(spi: *mut spi_device, is_high: bool) {
    ...
    (is_high ? 4 : 3), core::ptr::null_mut(), CH341_DEFAULT_TIMEOUT);
    if (err)
    dev_err(&spi.dev,
    ...
    core::ptr::null_mut(), CH341_DEFAULT_TIMEOUT);
    if (ret)
    return ret;
    return usb_bulk_msg(ch341.udev, ch341.read_pipe, trans.rx_buf,
    len - 1, core::ptr::null_mut(), CH341_DEFAULT_TIMEOUT);
    }
#[no_mangle]
unsafe extern "C" fn ch341_recv(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ch341_config_stream(ch341: *mut ch341_spi_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ch341_enable_pins(ch341: *mut ch341_spi_dev, enable: bool) -> c_int {
    ...
    int ret;
    ret = usb_find_common_endpoints(intf.cur_altsetting, &in, &out, core::ptr::null_mut(),
    core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ch341_disconnect(intf: *mut usb_interface) {
