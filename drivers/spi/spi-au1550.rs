...
//! Source: drivers/spi/spi-au1550.c
#![no_std]
...
//
    ...
    let mut usedma: static unsigned int = 1;
    module_param(usedma, uint, 0644);
//
// Macro flag: #define AU1550_SPI_DEBUG_LOOPBACK
//
pub const AU1550_SPI_DBDMA_DESCRIPTORS: c_int = 1;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct au1550_spi {
    pub bitbang: spi_bitbang,
    pub regs: *mut volatile psc_spi_t __iomem,
    pub irq: c_int,
    pub len: c_uint,
    pub tx_count: c_uint,
    pub rx_count: c_uint,
    pub tx: *const u8,
    pub rx: *mut u8,
    pub hw): *mut *mut void (rx_word)(struct au1550_spi,
    pub hw): *mut *mut void (tx_word)(struct au1550_spi,
    pub t): *mut *mut *mut int (txrx_bufs)(struct spi_device spi, struct spi_transfer,
    pub hw): *mut *mut irqreturn_t (irq_callback)(struct au1550_spi,
    pub host_done: completion,
    pub usedma: c_uint,
    pub dma_tx_id: u32,
    pub dma_rx_id: u32,
    pub dma_tx_ch: u32,
    pub dma_rx_ch: u32,
    pub dma_rx_tmpbuf: *mut u8,
    pub dma_rx_tmpbuf_size: c_uint,
    pub dma_rx_tmpbuf_addr: u32,
    pub host: *mut spi_controller,
    pub dev: *mut device,
    pub pdata: *mut au1550_spi_info,
...
//
#[no_mangle]
unsafe extern "C" fn au1550_spi_baudcfg(hw: *mut au1550_spi, speed_hz: c_uint) -> u32 {
    static u32 au1550_spi_baudcfg(struct au1550_spi *hw, unsigned int speed_hz)
    {
    let mut mainclk_hz: u32 = hw.pdata.mainclk_hz;
    u32 div, brg;
    for (div = 0; div < 4; div++) {
...
#[no_mangle]
pub unsafe extern "C" fn au1550_spi_mask_ack_all(hw: *mut au1550_spi) {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_reset_fifos(hw: *mut au1550_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn au1550_spi_chipsel(spi: *mut spi_device, value: c_int) {
    static void au1550_spi_chipsel(struct spi_device *spi, int value)
    {
    struct au1550_spi *hw = spi_controller_get_devdata(spi.controller);
    let mut cspol: c_uint = spi.mode & SPI_CS_HIGH ? 1 : 0;
    u32 cfg, stat;
    switch (value) {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_setupxfer(spi: *mut spi_device, t: *mut spi_transfer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn au1550_spi_dma_rxtmp_alloc(hw: *mut au1550_spi, size: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_dma_rxtmp_free(hw: *mut au1550_spi) {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_dma_txrxb(spi: *mut spi_device, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_dma_irq_callback(hw: *mut au1550_spi) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_pio_txrxb(spi: *mut spi_device, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_pio_irq_callback(hw: *mut au1550_spi) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_txrx_bufs(spi: *mut spi_device, t: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_bits_handlers_set(hw: *mut au1550_spi, bpw: c_int) {
    static void au1550_spi_bits_handlers_set(struct au1550_spi *hw, int bpw)
    {
    if (bpw <= 8) {
    if (hw.usedma) {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_setup_psc_as_spi(hw: *mut au1550_spi) {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_probe(pdev: *mut platform_device) -> c_int {
...
// the spi->mode bits understood by this driver:
    ...
    if (pdev.dev.dma_mask == core::ptr::null_mut())
    ...
    hw.dma_tx_id, core::ptr::null_mut(), (void *)hw);
    if (hw.dma_tx_ch == 0) {
    dev_err(&pdev.dev,
    ...
    ddma_memid, core::ptr::null_mut(), (void *)hw);
    if (hw.dma_rx_ch == 0) {
    dev_err(&pdev.dev,
...
//
    {
    let mut min_div: c_int = (2 << 0) * (2 * (4 + 1));
    let mut max_div: c_int = (2 << 3) * (2 * (63 + 1));
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn au1550_spi_exit() -> void __exit {
