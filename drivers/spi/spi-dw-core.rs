...
//! Source: drivers/spi/spi-dw-core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_spi_chip_data {
    pub cr0: u32,
    pub /: *mut *mut u32 rx_sample_dly; / RX sample delay,
}
...
#[no_mangle]
unsafe extern "C" fn dw_spi_debugfs_init(dws: *mut dw_spi) {
    static void dw_spi_debugfs_init(struct dw_spi *dws)
    {
    char name[32];
    snprintf(name, 32, "dw_spi%d", dws.ctlr.bus_num);
    dws.debugfs = debugfs_create_dir(name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dw_spi_debugfs_remove(dws: *mut dw_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_debugfs_init(dws: *mut dw_spi) {
    static inline void dw_spi_debugfs_init(struct dw_spi *dws)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn dw_spi_debugfs_remove(dws: *mut dw_spi) {
    static inline void dw_spi_debugfs_remove(struct dw_spi *dws)
    {
    }

#[no_mangle]
pub unsafe extern "C" fn dw_spi_set_cs(spi: *mut spi_device, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_tx_max(dws: *mut dw_spi) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_rx_max(dws: *mut dw_spi) -> u32 {
    static inline u32 dw_spi_rx_max(struct dw_spi *dws)
    {
    return min_t(u32, dws.rx_len, dw_readl(dws, DW_SPI_RXFLR));
    }
#[no_mangle]
unsafe extern "C" fn dw_writer(dws: *mut dw_spi) {
    static void dw_writer(struct dw_spi *dws)
    {
    let mut max: u32 = dw_spi_tx_max(dws);
    let mut txw: u32 = 0;
    while (max--) {
    if (dws.tx) {
    if (dws.n_bytes == 1)
    txw = *(u8 *)(dws.tx);
#[no_mangle]
pub unsafe extern "C" fn if(2: dws->n_bytes ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dw_reader(dws: *mut dw_spi) {
    static void dw_reader(struct dw_spi *dws)
    {
    let mut max: u32 = dw_spi_rx_max(dws);
    u32 rxw;
    while (max--) {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_check_status(dws: *mut dw_spi, raw: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_transfer_handler(dws: *mut dw_spi) -> irqreturn_t {
    static irqreturn_t dw_spi_transfer_handler(struct dw_spi *dws)
    {
    let mut irq_status: u16 = dw_readl(dws, DW_SPI_ISR);
...
#[no_mangle]
unsafe extern "C" fn dw_spi_enh_handler(dws: *mut dw_spi) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t dw_spi_irq(int irq, void *dev_id)
    {
    struct spi_controller *ctlr = dev_id;
    struct dw_spi *dws = spi_controller_get_devdata(ctlr);
    let mut irq_status: u16 = dw_readl(dws, DW_SPI_ISR) & DW_SPI_INT_MASK;
    if (!irq_status)
    return IRQ_NONE;
...
#[no_mangle]
unsafe extern "C" fn dw_spi_prepare_cr0(dws: *mut dw_spi, spi: *mut spi_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_irq_setup(dws: *mut dw_spi) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_enh_irq_setup(dws: *mut dw_spi) {
...
// Ensure the data above is visible for all CPUs
    ...
    dw_spi_update_config(dws, spi, &cfg, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(IRQ_NOTCONNECTED: dws->irq ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_abort(ctlr: *mut spi_controller) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_target_abort(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_adjust_enh_mem_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_adjust_mem_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_init_mem_buf(dws: *mut dw_spi, op: *const spi_mem_op) -> c_int {
...
//
    ...
    dws.rx = core::ptr::null_mut();
    dws.rx_len = 0;
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dw_spi_free_mem_buf(dws: *mut dw_spi) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_write_then_read(dws: *mut dw_spi, spi: *mut spi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_ctlr_busy(dws: *mut dw_spi) -> bool {
    static inline bool dw_spi_ctlr_busy(struct dw_spi *dws)
    {
    return dw_readl(dws, DW_SPI_SR) & DW_SPI_SR_BUSY;
    }
#[no_mangle]
unsafe extern "C" fn dw_spi_wait_mem_op_done(dws: *mut dw_spi) -> c_int {
    static int dw_spi_wait_mem_op_done(struct dw_spi *dws)
    {
    let mut retry: c_int = DW_SPI_WAIT_RETRIES;
    struct spi_delay delay;
    unsigned long ns, us;
    u32 nents;
    ...
    spi_delay_exec(&delay, core::ptr::null_mut());
    if (retry < 0) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_stop_mem_op(dws: *mut dw_spi, spi: *mut spi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dw_spi_exec_mem_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
    static int dw_spi_exec_mem_op(struct spi_mem *mem, const struct spi_mem_op *op)
    {
    struct dw_spi *dws = spi_controller_get_devdata(mem.spi.controller);
    let mut cfg: dw_spi_cfg = {0};
    unsigned long flags;
    int ret;
//
...
//
    ...
    dw_spi_enable_chip(dws, 0);
    dw_spi_update_config(dws, mem.spi, &cfg, core::ptr::null_mut());
    dw_spi_mask_intr(dws, 0xff);
    dw_spi_enable_chip(dws, 1);
//
...
#[no_mangle]
unsafe extern "C" fn dw_spi_init_enh_mem_buf(dws: *mut dw_spi, op: *const spi_mem_op) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_exec_enh_mem_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
    static int dw_spi_exec_enh_mem_op(struct spi_mem *mem, const struct spi_mem_op *op)
    {
    struct spi_controller *ctlr = mem.spi.controller;
    struct dw_spi *dws = spi_controller_get_devdata(ctlr);
    let mut enh_cfg: dw_spi_enh_cfg = {0};
    let mut cfg: dw_spi_cfg = {0};
...
#[no_mangle]
pub unsafe extern "C" fn if(op->addr.buswidth: op->data.buswidth ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: op->cmd.nbytes ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_can_use_mem_ops(dws: *mut dw_spi) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dw_spi_init_mem_ops(dws: *mut dw_spi) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_cleanup(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn detect_enh_mode(dws: *mut dw_spi) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dw_spi_ver_is_ge(dws, _arg: PSSI, _arg: 400A)) -> else {
    else if (dw_spi_ver_is_ge(dws, PSSI, 400A))
...
#[no_mangle]
unsafe extern "C" fn dw_spi_hw_init(dev: *mut device, dws: *mut dw_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_add_controller(dev: *mut device, dws: *mut dw_spi) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_remove_controller(dws: *mut dw_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_suspend_controller(dws: *mut dw_spi) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_resume_controller(dws: *mut dw_spi) -> c_int {
