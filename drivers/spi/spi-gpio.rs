...
pub struct spi_gpio {
    ...
    pub miso: *mut gpio_desc,
    pub mosi: *mut gpio_desc,
    pub cs_gpios: *mut gpio_desc,
}
...
#[no_mangle]
pub unsafe extern "C" fn setsck(spi: *const spi_device, is_on: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn setmosi(spi: *const spi_device, is_on: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn getmiso(spi: *const spi_device) -> c_int {
...
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn spi_gpio_chipselect(spi: *mut spi_device, is_active: c_int) {
...
#[no_mangle]
unsafe extern "C" fn spi_gpio_set_mosi_idle(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn spi_gpio_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_gpio_set_direction(spi: *mut spi_device, output: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_gpio_cleanup(spi: *mut spi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn spi_gpio_request(dev: *mut device, spi_gpio: *mut spi_gpio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_gpio_probe(pdev: *mut platform_device) -> c_int {
