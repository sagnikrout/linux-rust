...
//! Source: drivers/spi/spi-bcm2835.c
#![no_std]
...
pub const BCM2835_SPI_CS: c_uint = 0x00;
pub const BCM2835_SPI_FIFO: c_uint = 0x04;
pub const BCM2835_SPI_CLK: c_uint = 0x08;
pub const BCM2835_SPI_DLEN: c_uint = 0x0c;
pub const BCM2835_SPI_LTOH: c_uint = 0x10;
pub const BCM2835_SPI_DC: c_uint = 0x14;
// Bitfields in CS
pub const BCM2835_SPI_CS_LEN_LONG: c_uint = 0x02000000;
pub const BCM2835_SPI_CS_DMA_LEN: c_uint = 0x01000000;
pub const BCM2835_SPI_CS_CSPOL2: c_uint = 0x00800000;
pub const BCM2835_SPI_CS_CSPOL1: c_uint = 0x00400000;
pub const BCM2835_SPI_CS_CSPOL0: c_uint = 0x00200000;
pub const BCM2835_SPI_CS_RXF: c_uint = 0x00100000;
pub const BCM2835_SPI_CS_RXR: c_uint = 0x00080000;
pub const BCM2835_SPI_CS_TXD: c_uint = 0x00040000;
pub const BCM2835_SPI_CS_RXD: c_uint = 0x00020000;
pub const BCM2835_SPI_CS_DONE: c_uint = 0x00010000;
pub const BCM2835_SPI_CS_LEN: c_uint = 0x00002000;
pub const BCM2835_SPI_CS_REN: c_uint = 0x00001000;
pub const BCM2835_SPI_CS_ADCS: c_uint = 0x00000800;
pub const BCM2835_SPI_CS_INTR: c_uint = 0x00000400;
pub const BCM2835_SPI_CS_INTD: c_uint = 0x00000200;
pub const BCM2835_SPI_CS_DMAEN: c_uint = 0x00000100;
pub const BCM2835_SPI_CS_TA: c_uint = 0x00000080;
pub const BCM2835_SPI_CS_CSPOL: c_uint = 0x00000040;
pub const BCM2835_SPI_CS_CLEAR_RX: c_uint = 0x00000020;
pub const BCM2835_SPI_CS_CLEAR_TX: c_uint = 0x00000010;
pub const BCM2835_SPI_CS_CPOL: c_uint = 0x00000008;
pub const BCM2835_SPI_CS_CPHA: c_uint = 0x00000004;
pub const BCM2835_SPI_CS_CS_10: c_uint = 0x00000002;
pub const BCM2835_SPI_CS_CS_01: c_uint = 0x00000001;
pub const BCM2835_SPI_FIFO_SIZE: c_int = 64;
pub const BCM2835_SPI_FIFO_SIZE_3_4: c_int = 48;
pub const BCM2835_SPI_DMA_MIN_LENGTH: c_int = 96;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm2835_spi {
    pub regs: *mut void __iomem,
    pub clk: *mut clk,
    pub cs_gpio: *mut gpio_desc,
    pub clk_hz: c_ulong,
    pub irq: c_int,
    pub tfr: *mut spi_transfer,
    pub ctlr: *mut spi_controller,
    pub tx_buf: *const u8,
    pub rx_buf: *mut u8,
    pub tx_len: c_int,
    pub rx_len: c_int,
    pub tx_prologue: c_int,
    pub rx_prologue: c_int,
    pub tx_spillover: c_uint,
    pub debugfs_dir: *mut dentry,
    pub count_transfer_polling: u64,
    pub count_transfer_irq: u64,
    pub count_transfer_irq_after_polling: u64,
    pub count_transfer_dma: u64,
    pub target: *mut bcm2835_spidev,
    pub tx_dma_active: c_uint,
    pub rx_dma_active: c_uint,
    pub fill_tx_desc: *mut dma_async_tx_descriptor,
    pub fill_tx_addr: dma_addr_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm2835_spidev {
    pub prepare_cs: u32,
    pub clear_rx_desc: *mut dma_async_tx_descriptor,
    pub clear_rx_addr: dma_addr_t,
    pub ____cacheline_aligned: u32 clear_rx_cs,
}
...
#[no_mangle]
unsafe extern "C" fn bcm2835_debugfs_remove(bs: *mut bcm2835_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn bcm2835_rd(bs: *mut bcm2835_spi, reg: c_uint) -> u32 {
    static inline u32 bcm2835_rd(struct bcm2835_spi *bs, unsigned int reg)
    {
    return readl(bs.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn bcm2835_wr(bs: *mut bcm2835_spi, reg: c_uint, val: u32) {
    static inline void bcm2835_wr(struct bcm2835_spi *bs, unsigned int reg, u32 val)
    {
    writel(val, bs.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn bcm2835_rd_fifo(bs: *mut bcm2835_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn bcm2835_wr_fifo(bs: *mut bcm2835_spi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bcm2835_rd_fifo_count(bs: *mut bcm2835_spi, count: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bcm2835_wr_fifo_count(bs: *mut bcm2835_spi, count: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bcm2835_wait_tx_fifo_empty(bs: *mut bcm2835_spi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bcm2835_rd_fifo_blind(bs: *mut bcm2835_spi, count: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bcm2835_wr_fifo_blind(bs: *mut bcm2835_spi, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_reset_hw(bs: *mut bcm2835_spi) {
    static void bcm2835_spi_reset_hw(struct bcm2835_spi *bs)
    {
    let mut cs: u32 = bcm2835_rd(bs, BCM2835_SPI_CS);
...
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(BCM2835_SPI_CS_RXR: cs &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_undo_prologue(bs: *mut bcm2835_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_dma_rx_done(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_dma_tx_done(data: *mut c_void) {
...
// base address in dma-space
    addr = of_get_address(ctlr.dev.of_node, 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (!addr) {
...
// and return without waiting for completion
    ...
    let mut cs: u32 = target.prepare_cs;
// set clock
    spi_hz = tfr.speed_hz;
...
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_cleanup(spi: *mut spi_device) {
    ...
    spi_set_csgpiod(spi, 0, core::ptr::null_mut());
    kfree(target);
    }
...
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_max_transfer_size(spi: *mut spi_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_setup(spi: *mut spi_device) -> c_int {
    static int bcm2835_spi_setup(struct spi_device *spi)
    {
    struct spi_controller *ctlr = spi.controller;
    struct bcm2835_spi *bs = spi_controller_get_devdata(ctlr);
    struct bcm2835_spidev *target = spi_get_ctldata(spi);
    struct gpiod_lookup_table *lookup __free(kfree) = core::ptr::null_mut();
...
//
    ...
    if (of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), pinctrl_compats[i]))
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_spi_remove(pdev: *mut platform_device) {
