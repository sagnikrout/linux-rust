...
//! Source: drivers/spi/spi-mtk-nor.c
#![no_std]
...
pub const MTK_NOR_REG_CMD: c_uint = 0x00;

pub const MTK_NOR_REG_PRG_CNT: c_uint = 0x04;
pub const MTK_NOR_PRG_CNT_MAX: c_int = 56;
pub const MTK_NOR_REG_RDATA: c_uint = 0x0c;
pub const MTK_NOR_REG_RADR0: c_uint = 0x10;

pub const MTK_NOR_REG_RADR3: c_uint = 0xc8;
pub const MTK_NOR_REG_WDATA: c_uint = 0x1c;
pub const MTK_NOR_REG_PRGDATA0: c_uint = 0x20;

pub const MTK_NOR_REG_PRGDATA_MAX: c_int = 5;
pub const MTK_NOR_REG_SHIFT0: c_uint = 0x38;

pub const MTK_NOR_REG_SHIFT_MAX: c_int = 9;
pub const MTK_NOR_REG_CFG1: c_uint = 0x60;

pub const MTK_NOR_REG_CFG2: c_uint = 0x64;

pub const MTK_NOR_REG_PP_DATA: c_uint = 0x98;
pub const MTK_NOR_REG_IRQ_STAT: c_uint = 0xa8;
pub const MTK_NOR_REG_IRQ_EN: c_uint = 0xac;

pub const MTK_NOR_REG_CFG3: c_uint = 0xb4;

pub const MTK_NOR_REG_WP: c_uint = 0xc4;
pub const MTK_NOR_ENABLE_SF_CMD: c_uint = 0x30;
pub const MTK_NOR_REG_BUSCFG: c_uint = 0xcc;

pub const MTK_NOR_REG_DMA_CTL: c_uint = 0x718;

pub const MTK_NOR_REG_DMA_FADR: c_uint = 0x71c;
pub const MTK_NOR_REG_DMA_DADR: c_uint = 0x720;
pub const MTK_NOR_REG_DMA_END_DADR: c_uint = 0x724;
pub const MTK_NOR_REG_CG_DIS: c_uint = 0x728;

pub const MTK_NOR_REG_DMA_DADR_HB: c_uint = 0x738;
pub const MTK_NOR_REG_DMA_END_DADR_HB: c_uint = 0x73c;
pub const MTK_NOR_PRG_MAX_SIZE: c_int = 6;
// Reading DMA src/dst addresses have to be 16-byte aligned
pub const MTK_NOR_DMA_ALIGN: c_int = 16;

// and we allocate a bounce buffer if destination address isn't aligned.

// Buffered page program can do one 128-byte transfer
pub const MTK_NOR_PP_SIZE: c_int = 128;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_nor_caps {
    pub dma_bits: u8,
...
pub struct mtk_nor {
    ...
    pub spi_clk: *mut clk,
    pub ctlr_clk: *mut clk,
    pub axi_clk: *mut clk,
    pub axi_s_clk: *mut clk,
    pub spi_freq: c_uint,
    pub wbuf_en: bool,
    pub has_irq: bool,
    pub high_dma: bool,
    pub op_done: completion,
    pub caps: *const mtk_nor_caps,
}

#[no_mangle]
pub unsafe extern "C" fn mtk_nor_rmw(sp: *mut mtk_nor, reg: u32, set: u32, clr: u32) {
    static inline void mtk_nor_rmw(struct mtk_nor *sp, u32 reg, u32 set, u32 clr)
    {
    let mut val: u32 = readl(sp.base + reg);
    val &= ~clr;
    val |= set;
    writel(val, sp.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn mtk_nor_cmd_exec(sp: *mut mtk_nor, cmd: u32, clk: c_ulong) -> c_int {
    static inline int mtk_nor_cmd_exec(struct mtk_nor *sp, u32 cmd, ulong clk)
    {
    let mut delay: c_ulong = CLK_TO_US(sp, clk);
    u32 reg;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_reset(sp: *mut mtk_nor) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_set_addr(sp: *mut mtk_nor, op: *const spi_mem_op) {
...
#[no_mangle]
unsafe extern "C" fn need_bounce(sp: *mut mtk_nor, op: *const spi_mem_op) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_match_read(op: *const spi_mem_op) -> bool {
    ...
    let mut dummy: return = = 8;
#[no_mangle]
pub unsafe extern "C" fn if(2: op->addr.buswidth ==) -> else {
    else if (op.addr.buswidth == 2)
    let mut dummy: return = = 4;
#[no_mangle]
pub unsafe extern "C" fn if(4: op->addr.buswidth ==) -> else {
    else if (op.addr.buswidth == 4)
    let mut dummy: return = = 6;
    } else if ((op.addr.buswidth == 1) && (op.data.buswidth == 1)) {
    if (op.cmd.opcode == 0x03)
    let mut dummy: return = = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0x0b: op->cmd.opcode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_match_prg(op: *const spi_mem_op) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_adj_prg_size(op: *mut spi_mem_op) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_adjust_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
...
// limit size to prevent timeout calculation overflow
    ...
    op.data.nbytes = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !need_bounce(sp, _arg: op)) -> else {
    else if (!need_bounce(sp, op))
    op.data.nbytes &= ~MTK_NOR_DMA_ALIGN_MASK;
#[no_mangle]
pub unsafe extern "C" fn if(MTK_NOR_BOUNCE_BUF_SIZE: op->data.nbytes >) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_setup_bus(sp: *mut mtk_nor, op: *const spi_mem_op) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_read_bounce(sp: *mut mtk_nor, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_read_dma(sp: *mut mtk_nor, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_read_pio(sp: *mut mtk_nor, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_setup_write_buffer(sp: *mut mtk_nor, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_pp_buffered(sp: *mut mtk_nor, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_spi_mem_prg(sp: *mut mtk_nor, op: *const spi_mem_op) -> c_int {
    static int mtk_nor_spi_mem_prg(struct mtk_nor *sp, const struct spi_mem_op *op)
    {
    let mut rx_len: c_int = 0;
    let mut reg_offset: c_int = MTK_NOR_REG_PRGDATA_MAX;
    int tx_len, prg_len;
    int i, ret;
    void __iomem *reg;
    u8 bufbyte;
...
#[no_mangle]
pub unsafe extern "C" fn if(SPI_MEM_DATA_IN: op->data.dir ==) -> else {
    else if (op.data.dir == SPI_MEM_DATA_IN)
    rx_len = op.data.nbytes;
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_exec_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_disable_clk(sp: *mut mtk_nor) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_enable_clk(sp: *mut mtk_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_init(sp: *mut mtk_nor) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_max_msg_size(spi: *mut spi_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nor_suspend(dev: *mut device) -> c_int {
    static int mtk_nor_suspend(struct device *dev)
    {
    return pm_runtime_force_suspend(dev);
    }
#[no_mangle]
unsafe extern "C" fn mtk_nor_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(mtk_nor_runtime_suspend, mtk_nor_runtime_resume, core::ptr::null_mut())
