...
#[no_mangle]
unsafe extern "C" fn spidev_release(dev: *mut device) {
...
//
    ...
    status = __spi_add_device(spi, core::ptr::null_mut());
    if (status) {
    ...
    static DEVICE_ATTR_IGNORE_LOCKDEP(new_device, 0200, core::ptr::null_mut(), new_device_store);
    static ssize_t
    ...
    static DEVICE_ATTR_IGNORE_LOCKDEP(delete_device, 0200, core::ptr::null_mut(),
    delete_device_store);
...
//
    ...
    {
    let mut l2len: c_int = min(fls(xfer.len), SPI_STATISTICS_HISTO_SIZE) - 1;
...
#[no_mangle]
unsafe extern "C" fn spi_match_device(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: is_acpi_device_node(fwnode) && spi->irq <) -> else {
...
#[no_mangle]
unsafe extern "C" fn spi_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn spi_shutdown(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __spi_register_driver(owner: *mut module, sdrv: *mut spi_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_dev_set_name(spi: *mut spi_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spi_dev_check_info {
    pub new_spi: *mut spi_device,
    pub /: *mut *mut *mut spi_device parent; / set for ancillary devices,
}

#[no_mangle]
unsafe extern "C" fn spi_dev_check(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_cleanup(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn __spi_add_device(spi: *mut spi_device, parent: *mut spi_device) -> c_int {
    static int __spi_add_device(struct spi_device *spi, struct spi_device *parent)
    {
...
//
    ...
    status = bus_for_each_dev(&spi_bus_type, core::ptr::null_mut(), &check_info, spi_dev_check);
    if (status)
    return status;
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_add_device(spi: *mut spi_device) -> c_int {
...
// Use provided chip-select for proxy device
    ...
    proxy.controller_state = core::ptr::null_mut();
//
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_unregister_device(spi: *mut spi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_register_board_info(info: *const spi_board_info, n: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spi_res_free(res: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn spi_res_add(message: *mut spi_message, res: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn spi_res_release(ctlr: *mut spi_controller, message: *mut spi_message) {
...
#[no_mangle]
pub unsafe extern "C" fn spi_is_last_cs(spi: *mut spi_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn spi_toggle_csgpiod(spi: *mut spi_device, idx: u8, enable: bool, activate: bool) {
...
// Polarity handled by GPIO library
    ...
    if (activate)
    spi_delay_exec(&spi.cs_setup, core::ptr::null_mut());
    else
    spi_delay_exec(&spi.cs_inactive, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn spi_set_cs(spi: *mut spi_device, enable: bool, force: bool) {
    static void spi_set_cs(struct spi_device *spi, bool enable, bool force)
    {
    let mut activate: bool = enable;
    u8 idx;
//
...
//
    ...
    spi_delay_exec(&spi.cs_hold, core::ptr::null_mut());
...
// Some SPI controllers need both GPIO CS & ->set_cs()
    ...
    {
    let mut vmalloced_buf: bool = is_vmalloc_addr(buf);
    let mut max_seg_size: c_uint = dma_get_max_seg_size(dev);

    const bool kmap_buf = ((unsigned long)buf >= PKMAP_BASE &&
    (unsigned long)buf < (PKMAP_BASE +
    (LAST_PKMAP * PAGE_SIZE)));

    let mut kmap_buf: bool = false;
...
//
    ...
    VISIBLE_IF_KUNIT
#[no_mangle]
pub unsafe extern "C" fn __spi_unmap_msg(ctlr: *mut spi_controller, msg: *mut spi_message) -> c_int {
...
// The sync has already been done after each transfer.
    let mut attrs: c_ulong = DMA_ATTR_SKIP_CPU_SYNC;
    ...
    VISIBLE_IF_KUNIT
#[no_mangle]
pub unsafe extern "C" fn __spi_map_msg(ctlr: *mut spi_controller, msg: *mut spi_message) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ctlr->dma_map_dev) -> else {
...
// The sync is done before each transfer.
    ...
    continue;
    if (xfer.tx_buf != core::ptr::null_mut()) {
...
//
    ...
    ctlr.cur_rx_dma_dev = core::ptr::null_mut();
    ctlr.cur_tx_dma_dev = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn spi_map_msg(ctlr: *mut spi_controller, msg: *mut spi_message) -> c_int {
    ...
    let mut speed_hz: u32 = xfer.speed_hz;
...
#[no_mangle]
unsafe extern "C" fn _spi_transfer_delay_ns(ns: u32) {
    ...
    let mut us: u32 = DIV_ROUND_UP(ns, NSEC_PER_USEC);
    fsleep(us);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn spi_delay_to_ns(_delay: *mut spi_delay, xfer: *mut spi_transfer) -> c_int {
    int spi_delay_to_ns(struct spi_delay *_delay, struct spi_transfer *xfer)
    {
    let mut delay: u32 = _delay.value;
    let mut unit: u32 = _delay.unit;
    u32 hz;
    if (!delay)
    return 0;
    switch (unit) {
...
#[no_mangle]
pub unsafe extern "C" fn spi_delay_exec(_delay: *mut spi_delay, xfer: *mut spi_transfer) -> c_int {
    ...
    struct spi_transfer *xfer)
    {
    let mut default_delay_ns: u32 = 10 * NSEC_PER_USEC;
    let mut delay: u32 = xfer.cs_change_delay.value;
    let mut unit: u32 = xfer.cs_change_delay.unit;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_finalize_current_transfer(ctlr: *mut spi_controller) {
...
#[no_mangle]
unsafe extern "C" fn spi_idle_runtime_pm(ctlr: *mut spi_controller) {
...
//
#[no_mangle]
unsafe extern "C" fn __spi_pump_messages(ctlr: *mut spi_controller, in_kthread: bool) {
    static void __spi_pump_messages(struct spi_controller *ctlr, bool in_kthread)
    {
    struct spi_message *msg;
    let mut was_busy: bool = false;
    unsigned long flags;
    int ret;
// Take the I/O mutex
...
// Defer any non-atomic teardown to the thread
    ...
    kfree(ctlr.dummy_rx);
    ctlr.dummy_rx = core::ptr::null_mut();
    kfree(ctlr.dummy_tx);
    ctlr.dummy_tx = core::ptr::null_mut();
...
// Extract head of queue
    ...
    ctlr.cur_msg = core::ptr::null_mut();
    ctlr.fallback = false;
...
//
#[no_mangle]
unsafe extern "C" fn spi_pump_messages(work: *mut kthread_work) {
...
//
#[no_mangle]
unsafe extern "C" fn spi_set_thread_rt(ctlr: *mut spi_controller) {
...
#[no_mangle]
unsafe extern "C" fn spi_init_queue(ctlr: *mut spi_controller) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __spi_unoptimize_message(msg: *mut spi_message) {
...
//
#[no_mangle]
unsafe extern "C" fn spi_maybe_unoptimize_message(msg: *mut spi_message) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_finalize_current_message(ctlr: *mut spi_controller) {
    ...
    mesg.state = core::ptr::null_mut();
    if (mesg.complete)
    mesg.complete(mesg.context);
    }
    EXPORT_SYMBOL_GPL(spi_finalize_current_message);
#[no_mangle]
unsafe extern "C" fn spi_start_queue(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_stop_queue(ctlr: *mut spi_controller) -> c_int {
    static int spi_stop_queue(struct spi_controller *ctlr)
    {
    let mut limit: c_uint = 500;
    unsigned long flags;
//
...
#[no_mangle]
unsafe extern "C" fn spi_destroy_queue(ctlr: *mut spi_controller) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spi_queued_transfer(spi: *mut spi_device, msg: *mut spi_message) -> c_int {
    static int spi_queued_transfer(struct spi_device *spi, struct spi_message *msg)
    {
    return __spi_queued_transfer(spi, msg, true);
    }
#[no_mangle]
unsafe extern "C" fn spi_controller_initialize_queue(ctlr: *mut spi_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_flush_queue(ctlr: *mut spi_controller) {
...
//
    ...
    first_value = value;
#[no_mangle]
pub unsafe extern "C" fn if(value: first_value !=) -> else {
    dev_err(&ctlr.dev,
...
//
#[no_mangle]
unsafe extern "C" fn of_register_spi_devices(ctlr: *mut spi_controller) {
...
#[no_mangle]
unsafe extern "C" fn devm_spi_unregister_device(spi: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_spi_count(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_spi_count_resources(adev: *mut acpi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_spi_add_resource(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
    ...
    return 1;
    status = acpi_get_handle(core::ptr::null_mut(),
...
//
    ...
    int index)
    {
    let mut parent_handle: acpi_handle = core::ptr::null_mut();
    struct list_head resource_list;
    let mut lookup: acpi_spi_lookup = {};
    struct spi_device *spi;
    int ret;
    if (!ctlr && index == -1)
...
pub const SPI_ACPI_ENUMERATE_MAX_DEPTH: c_int = 32;
#[no_mangle]
unsafe extern "C" fn acpi_register_spi_devices(ctlr: *mut spi_controller) {
    ...
    acpi_spi_add_device, core::ptr::null_mut(), ctlr, core::ptr::null_mut());
    if (ACPI_FAILURE(status))
...
#[no_mangle]
unsafe extern "C" fn spi_controller_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_target_abort(spi: *mut spi_device) -> c_int {
    ...
    ret = sysfs_emit(buf, "%s\n", child ? to_spi_device(child).modalias : core::ptr::null_mut());
    put_device(child);
    return ret;
    }
...
//
    ...
    {
    struct spi_controller	*ctlr;
    let mut ctlr_size: usize = ALIGN(sizeof(*ctlr), dma_get_cache_alignment());
    if (!dev)
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn devm_spi_release_controller(ctlr: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn spi_get_gpio_descs(ctlr: *mut spi_controller) -> c_int {
    static int spi_get_gpio_descs(struct spi_controller *ctlr)
    {
    int nb, i;
    struct gpio_desc **cs;
    struct device *dev = &ctlr.dev;
    let mut native_cs_mask: c_ulong = 0;
    let mut num_cs_gpios: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn spi_controller_check_ops(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_controller_id_alloc(ctlr: *mut spi_controller, start: c_int, end: c_int) -> c_int {
    ...
    let mut id: return = = -ENOSPC ? -EBUSY : id;
    ctlr.bus_num = id;
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_register_controller(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_spi_unregister_controller(ctlr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __unregister(dev: *mut device, null: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_unregister_controller(ctlr: *mut spi_controller) {
    void spi_unregister_controller(struct spi_controller *ctlr)
    {
    struct spi_controller *found;
    let mut id: c_int = ctlr.bus_num;
//
...
//
    ...
    device_for_each_child(&ctlr.dev, core::ptr::null_mut(), __unregister);
...
#[no_mangle]
pub unsafe extern "C" fn __spi_check_suspended(ctlr: *const spi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __spi_mark_suspended(ctlr: *mut spi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn __spi_mark_resumed(ctlr: *mut spi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn spi_controller_suspend(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn spi_controller_resume(ctlr: *mut spi_controller) -> c_int {
...
// Create replacement
    srt = spi_replace_transfers(msg, xfer, 1, count, core::ptr::null_mut(), 0, GFP_KERNEL);
    if (IS_ERR(srt))
    return PTR_ERR(srt);
...
//
#[no_mangle]
unsafe extern "C" fn spi_set_cs_timing(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __spi_setup(spi: *mut spi_device, initial_setup: bool) -> c_int {
    static int __spi_setup(struct spi_device *spi, bool initial_setup)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __spi_validate(spi: *mut spi_device, message: *mut spi_message) -> c_int {
...
//
    ...
    (spi.mode & SPI_3WIRE)) {
    let mut flags: unsigned = ctlr.flags;
...
//
#[no_mangle]
unsafe extern "C" fn spi_split_transfers(msg: *mut spi_message) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_optimize_message(spi: *mut spi_device, msg: *mut spi_message) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_unoptimize_message(msg: *mut spi_message) {
...
#[no_mangle]
unsafe extern "C" fn __spi_async(spi: *mut spi_device, message: *mut spi_message) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_spi_unoptimize_message(msg: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_async(spi: *mut spi_device, message: *mut spi_message) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __spi_transfer_message_noqueue(ctlr: *mut spi_controller, msg: *mut spi_message) {
...
//
#[no_mangle]
unsafe extern "C" fn spi_complete(arg: *mut c_void) {
    static void spi_complete(void *arg)
    {
    complete(arg);
    }
#[no_mangle]
unsafe extern "C" fn __spi_sync(spi: *mut spi_device, message: *mut spi_message) -> c_int {
...
//
    ...
    message.complete = core::ptr::null_mut();
    message.context = core::ptr::null_mut();
    return status;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_sync(spi: *mut spi_device, message: *mut spi_message) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_sync_locked(spi: *mut spi_device, message: *mut spi_message) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_bus_lock(ctlr: *mut spi_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_bus_unlock(ctlr: *mut spi_controller) -> c_int {
...
// Must call put_device() when done with returned spi_device device
    ...
    return dev ? to_spi_device(dev) : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn spi_acpi_controller_match(dev: *mut device, data: *const c_void) -> c_int {
    ...
    {
    struct device *dev;
    dev = class_find_device(&spi_controller_class, core::ptr::null_mut(), adev,
    spi_acpi_controller_match);
    if (!dev && IS_ENABLED(CONFIG_SPI_SLAVE))
    dev = class_find_device(&spi_target_class, core::ptr::null_mut(), adev,
    spi_acpi_controller_match);
    if (!dev)
    return core::ptr::null_mut();
    return container_of(dev, struct spi_controller, dev);
...
#[no_mangle]
unsafe extern "C" fn spi_init() -> int __init {
