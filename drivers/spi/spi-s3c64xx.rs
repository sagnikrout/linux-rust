...
//! Source: drivers/spi/spi-s3c64xx.c
#![no_std]
...
pub const MAX_SPI_PORTS: c_int = 12;

pub const AUTOSUSPEND_TIMEOUT: c_int = 2000;
// Registers and bit-fields
pub const S3C64XX_SPI_CH_CFG: c_uint = 0x00;
pub const S3C64XX_SPI_CLK_CFG: c_uint = 0x04;
pub const S3C64XX_SPI_MODE_CFG: c_uint = 0x08;
pub const S3C64XX_SPI_CS_REG: c_uint = 0x0C;
pub const S3C64XX_SPI_INT_EN: c_uint = 0x10;
pub const S3C64XX_SPI_STATUS: c_uint = 0x14;
pub const S3C64XX_SPI_TX_DATA: c_uint = 0x18;
pub const S3C64XX_SPI_RX_DATA: c_uint = 0x1C;
pub const S3C64XX_SPI_PACKET_CNT: c_uint = 0x20;
pub const S3C64XX_SPI_PENDING_CLR: c_uint = 0x24;
pub const S3C64XX_SPI_SWAP_CFG: c_uint = 0x28;
pub const S3C64XX_SPI_FB_CLK: c_uint = 0x2C;

pub const S3C64XX_SPI_CLKSEL_SRCSHFT: c_int = 9;

pub const S3C64XX_SPI_PSR_MASK: c_uint = 0xff;

pub const S3C64XX_SPI_MODE_RX_RDY_LVL_SHIFT: c_int = 11;

pub const S3C64XX_SPI_ST_TX_FIFO_LVL_SHIFT: c_int = 6;
...
pub const S3C64XX_SPI_MAX_TRAILCNT: c_uint = 0x3ff;
pub const S3C64XX_SPI_TRAILCNT_OFF: c_int = 19;
pub const S3C64XX_SPI_POLLING_SIZE: c_int = 32;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c64xx_spi_dma_data {
    pub ch: *mut dma_chan,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c64xx_spi_port_config {
    pub fifo_lvl_mask: [c_int; MAX_SPI_PORTS],
    pub rx_lvl_offset: c_int,
    pub fifo_depth: c_uint,
    pub rx_fifomask: u32,
    pub tx_fifomask: u32,
    pub tx_st_done: c_int,
    pub quirks: c_int,
    pub clk_div: c_int,
    pub high_speed: bool,
    pub clk_from_cmu: bool,
    pub clk_ioclk: bool,
    pub has_loopback: bool,
    pub use_32bit_io: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c64xx_spi_driver_data {
    ...
    pub cntrlr_info: *mut s3c64xx_spi_info,
    pub lock: spinlock_t,
    pub sfr_start: c_ulong,
    pub xfer_completion: completion,
    pub state: unsigned,
    pub cur_bpw: unsigned cur_mode,,
    pub cur_speed: unsigned,
    pub rx_dma: s3c64xx_spi_dma_data,
    pub tx_dma: s3c64xx_spi_dma_data,
    pub port_conf: *const s3c64xx_spi_port_config,
    pub port_id: c_uint,
    pub fifo_depth: c_uint,
    pub rx_fifomask: u32,
    pub tx_fifomask: u32,
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_flush_fifo(sdd: *mut s3c64xx_spi_driver_data) {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_dmacb(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_set_cs(spi: *mut spi_device, enable: bool) {
    ...
    let mut ssel: u32 = readl(sdd.regs + S3C64XX_SPI_CS_REG);
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_prepare_transfer(spi: *mut spi_controller) -> c_int {
...
// Requests DMA channels
    ...
    sdd.rx_dma.ch = core::ptr::null_mut();
    return 0;
    }
    ...
    sdd.tx_dma.ch = core::ptr::null_mut();
    sdd.rx_dma.ch = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_unprepare_transfer(spi: *mut spi_controller) -> c_int {
...
//
    ...
    {
    void __iomem *regs = sdd.regs;
    let mut val: c_ulong = 1;
    u32 status;
    let mut max_fifo: u32 = sdd.fifo_depth;
    if (timeout_ms)
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_config(sdd: *mut s3c64xx_spi_driver_data) -> c_int {
    static int s3c64xx_spi_config(struct s3c64xx_spi_driver_data *sdd)
    {
    void __iomem *regs = sdd.regs;
    int ret;
    u32 val;
    let mut div: c_int = sdd.port_conf.clk_div;
// Disable Clock
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_max_transfer_size(spi: *mut spi_device) -> usize {
    ...
    {
    struct s3c64xx_spi_driver_data *sdd = spi_controller_get_devdata(host);
    let mut fifo_len: c_uint = sdd.fifo_depth;
    const void *tx_buf = core::ptr::null_mut();
    void *rx_buf = core::ptr::null_mut();
    let mut target_len: c_int = 0, origin_len = 0;
...
//
    ...
    rdy_lv /= 2;
#[no_mangle]
pub unsafe extern "C" fn if(256: fifo_len ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_cleanup(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_hwinit(sdd: *mut s3c64xx_spi_driver_data) {
    ...
    writel(0, sdd.regs + S3C64XX_SPI_CS_REG);
#[no_mangle]
pub unsafe extern "C" fn if(S3C64XX_SPI_QUIRK_CS_AUTO): !(sdd->port_conf->quirks &) -> else {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_set_fifomask(sdd: *mut s3c64xx_spi_driver_data) {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_spi_runtime_resume(dev: *mut device) -> c_int {
    ...
    s3c64xx_spi_runtime_resume, core::ptr::null_mut())
    };
