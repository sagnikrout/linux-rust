...
//! Source: drivers/spi/spi-hisi-sfc-v3xx.c
#![no_std]
...
pub const HISI_SFC_V3XX_CMD_CFG_DATA_CNT_OFF: c_int = 9;

pub const HISI_SFC_V3XX_CMD_CFG_DUMMY_CNT_OFF: c_int = 4;

pub const HISI_SFC_V3XX_CMD_CFG_CS_SEL_OFF: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_sfc_v3xx_host {
    pub dev: *mut device,
    pub regbase: *mut void __iomem,
    pub max_cmd_dword: c_int,
...
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_disable_int(host: *mut hisi_sfc_v3xx_host) {
    static void hisi_sfc_v3xx_disable_int(struct hisi_sfc_v3xx_host *host)
    {
    writel(0, host.regbase + HISI_SFC_V3XX_INT_MASK);
    }
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_enable_int(host: *mut hisi_sfc_v3xx_host) {
...
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_clear_int(host: *mut hisi_sfc_v3xx_host) {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_handle_completion(host: *mut hisi_sfc_v3xx_host) -> c_int {
...
pub const HISI_SFC_V3XX_WAIT_TIMEOUT_US: c_int = 1000000;
pub const HISI_SFC_V3XX_WAIT_POLL_INTERVAL_US: c_int = 10;
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_wait_cmd_idle(host: *mut hisi_sfc_v3xx_host) -> c_int {
    ...
    let mut addr: uintptr_t = (uintptr_t)op.data.buf.in;
    int max_byte_count;
...
#[no_mangle]
pub unsafe extern "C" fn if(max_byte_count: op->data.nbytes >) -> else {
...
// to = (u8)val;
    ...
    let mut val: u32 = __raw_readl(from);
    int j;
...
// to = (u8)val;
    ...
    u8 chip_select)
    {
    let mut len: c_int = op.data.nbytes, buswidth_mode;
    ...
    host.completion = core::ptr::null_mut();
    } else {
    ...
    struct hisi_sfc_v3xx_host *host;
    struct spi_device *spi = mem.spi;
    let mut chip_select: u8 = spi_get_chipselect(spi, 0);
    host = spi_controller_get_devdata(spi.controller);
...
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_dmi_quirk(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_spi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_sfc_v3xx_spi_exit() -> void __exit {
