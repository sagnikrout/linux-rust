...
//! Source: drivers/spi/spi-lm70llp.c
#![no_std]
...
pub const lm70_INIT: c_uint = 0xBE;
pub const SIO: c_uint = 0x10;
pub const nCS: c_uint = 0x20;
pub const SCLK: c_uint = 0x40;
// -------------------------------------------------------------------------
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spi_lm70llp {
    pub bitbang: spi_bitbang,
    pub port: *mut parport,
    pub pd: *mut pardevice,
    pub spidev_lm70: *mut spi_device,
    pub info: spi_board_info,
// struct device		*dev;
}
...
//
#[no_mangle]
pub unsafe extern "C" fn deassertCS(pp: *mut spi_lm70llp) {
    static inline void deassertCS(struct spi_lm70llp *pp)
    {
    let mut data: u8 = parport_read_data(pp.port);
    data &= ~0x80;		/* pull D7/SI-out low while de-asserted */
    parport_write_data(pp.port, data | nCS);
    }
#[no_mangle]
pub unsafe extern "C" fn assertCS(pp: *mut spi_lm70llp) {
...
#[no_mangle]
pub unsafe extern "C" fn clkHigh(pp: *mut spi_lm70llp) {
...
#[no_mangle]
pub unsafe extern "C" fn clkLow(pp: *mut spi_lm70llp) {
...
#[no_mangle]
pub unsafe extern "C" fn spidelay(d: unsigned) {
    static inline void spidelay(unsigned d)
    {
    udelay(d);
    }
#[no_mangle]
pub unsafe extern "C" fn setsck(s: *mut spi_device, is_on: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn setmosi(s: *mut spi_device, is_on: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn getmiso(s: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm70_chipselect(spi: *mut spi_device, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn spi_lm70llp_attach(p: *mut parport) {
...
#[no_mangle]
unsafe extern "C" fn spi_lm70llp_detach(p: *mut parport) {
