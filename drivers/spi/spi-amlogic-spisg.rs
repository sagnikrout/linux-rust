...
//! Source: drivers/spi/spi-amlogic-spisg.c
#![no_std]
...
// Register Map
pub const SPISG_REG_CFG_READY: c_uint = 0x00;
pub const SPISG_REG_CFG_SPI: c_uint = 0x04;

// start on vsync rising

// start on vsync falling

pub const SPISG_REG_CFG_START: c_uint = 0x08;

pub const SPISG_REG_CFG_BUS: c_uint = 0x0C;

pub const CLK_DIV_WIDTH: c_int = 8;

pub const SPISG_REG_PIO_TX_DATA_L: c_uint = 0x10;
pub const SPISG_REG_PIO_TX_DATA_H: c_uint = 0x14;
pub const SPISG_REG_PIO_RX_DATA_L: c_uint = 0x18;
pub const SPISG_REG_PIO_RX_DATA_H: c_uint = 0x1C;
pub const SPISG_REG_MEM_TX_ADDR_L: c_uint = 0x10;
pub const SPISG_REG_MEM_TX_ADDR_H: c_uint = 0x14;
pub const SPISG_REG_MEM_RX_ADDR_L: c_uint = 0x18;
pub const SPISG_REG_MEM_RX_ADDR_H: c_uint = 0x1C;
pub const SPISG_REG_DESC_LIST_L: c_uint = 0x20;
pub const SPISG_REG_DESC_LIST_H: c_uint = 0x24;

pub const SPISG_REG_DESC_CURRENT_L: c_uint = 0x28;
pub const SPISG_REG_DESC_CURRENT_H: c_uint = 0x2c;
pub const SPISG_REG_IRQ_STS: c_uint = 0x30;
pub const SPISG_REG_IRQ_ENABLE: c_uint = 0x34;

pub const SPISG_MAX_REG: c_uint = 0x40;
pub const SPISG_BLOCK_MAX: c_uint = 0x100000;
pub const SPISG_OP_MODE_WRITE_CMD: c_int = 0;
pub const SPISG_OP_MODE_READ_STS: c_int = 1;
pub const SPISG_OP_MODE_WRITE: c_int = 2;
pub const SPISG_OP_MODE_READ: c_int = 3;
pub const SPISG_DATA_MODE_NONE: c_int = 0;
pub const SPISG_DATA_MODE_PIO: c_int = 1;
pub const SPISG_DATA_MODE_MEM: c_int = 2;
pub const SPISG_DATA_MODE_SG: c_int = 3;
pub const SPISG_CLK_DIV_MAX: c_int = 256;
// recommended by specification
pub const SPISG_CLK_DIV_MIN: c_int = 4;

pub const SPISG_PCLK_RATE_MIN: c_int = 24000000;
pub const SPISG_SINGLE_SPI: c_int = 0;
pub const SPISG_DUAL_SPI: c_int = 1;
pub const SPISG_QUAD_SPI: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spisg_sg_link {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spisg_descriptor_extra {
    pub tx_ccsg: *mut spisg_sg_link,
    pub rx_ccsg: *mut spisg_sg_link,
    pub tx_ccsg_len: c_int,
    pub rx_ccsg_len: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct spisg_device {
...
#[no_mangle]
unsafe extern "C" fn spi_delay_to_sclk(slck_speed_hz: u32, delay: *mut spi_delay) -> c_int {
    ...
    return delay.value;
    ns = spi_delay_to_ns(delay, core::ptr::null_mut());
    if (ns < 0)
    return 0;
    return DIV_ROUND_UP_ULL(slck_speed_hz * ns, NSEC_PER_SEC);
    }
#[no_mangle]
pub unsafe extern "C" fn aml_spisg_sem_down_read(spisg: *mut spisg_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn aml_spisg_sem_up_write(spisg: *mut spisg_device) {
    static inline void aml_spisg_sem_up_write(struct spisg_device *spisg)
    {
    regmap_write(spisg.map, SPISG_REG_CFG_READY, 1);
    }
#[no_mangle]
unsafe extern "C" fn aml_spisg_set_speed(spisg: *mut spisg_device, speed_hz: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aml_spisg_sg_xlate(sgt: *mut sg_table, ccsg: *mut spisg_sg_link) {
...
#[no_mangle]
unsafe extern "C" fn aml_spisg_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    spisg.status = sts;
#[no_mangle]
pub unsafe extern "C" fn if(IRQ_DESC_CHAIN_DONE: sts &) -> else {
...
#[no_mangle]
unsafe extern "C" fn aml_spisg_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aml_spisg_cleanup(spi: *mut spi_device) {
    static void aml_spisg_cleanup(struct spi_device *spi)
    {
    spi.controller_state = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn aml_spisg_target_abort(ctlr: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aml_spisg_clk_init(spisg: *mut spisg_device, base: *mut void __iomem) -> c_int {
...
// Register clk-divider
    ...
    spisg.sclk = devm_clk_hw_get_clk(dev, &div.hw, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn aml_spisg_probe(pdev: *mut platform_device) -> c_int {
...
// default pending
    ...
    ret = devm_request_irq(&pdev.dev, irq, aml_spisg_irq, 0, core::ptr::null_mut(), spisg);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn aml_spisg_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn spisg_suspend_runtime(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spisg_resume_runtime(dev: *mut device) -> c_int {
