...
//! Source: drivers/spi/spi-rb4xx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rb4xx_spi {
    pub base: *mut void __iomem,
    pub clk: *mut clk,
}

#[no_mangle]
pub unsafe extern "C" fn rb4xx_read(rbspi: *mut rb4xx_spi, reg: u32) -> u32 {
    static inline u32 rb4xx_read(struct rb4xx_spi *rbspi, u32 reg)
    {
    return __raw_readl(rbspi.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn rb4xx_write(rbspi: *mut rb4xx_spi, reg: u32, value: u32) {
    static inline void rb4xx_write(struct rb4xx_spi *rbspi, u32 reg, u32 value)
    {
    __raw_writel(value, rbspi.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn do_spi_clk(rbspi: *mut rb4xx_spi, spi_ioc: u32, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_spi_byte(rbspi: *mut rb4xx_spi, spi_ioc: u32, byte: u8) {
...
#[no_mangle]
unsafe extern "C" fn do_spi_byte_two(rbspi: *mut rb4xx_spi, spi_ioc: u32, byte: u8) {
...
#[no_mangle]
unsafe extern "C" fn rb4xx_set_cs(spi: *mut spi_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn rb4xx_spi_probe(pdev: *mut platform_device) -> c_int {
