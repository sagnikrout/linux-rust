...
//! Source: drivers/spi/spi-orion.c
#![no_std]
...
pub const SPI_AUTOSUSPEND_TIMEOUT: c_int = 200;
// Some SoCs using this driver support up to 8 chip selects.
// It is up to the implementer to only use the chip selects
// that are available.
//
pub const ORION_NUM_CHIPSELECTS: c_int = 8;

pub const ORION_SPI_IF_CTRL_REG: c_uint = 0x00;
pub const ORION_SPI_IF_CONFIG_REG: c_uint = 0x04;

pub const ORION_SPI_DATA_OUT_REG: c_uint = 0x08;
pub const ORION_SPI_DATA_IN_REG: c_uint = 0x0c;
pub const ORION_SPI_INT_CAUSE_REG: c_uint = 0x10;
pub const ORION_SPI_TIMING_PARAMS_REG: c_uint = 0x18;
// Register for the "Direct Mode"
pub const SPI_DIRECT_WRITE_CONFIG_REG: c_uint = 0x20;

pub const ORION_SPI_CLK_PRESCALE_MASK: c_uint = 0x1F;
pub const ARMADA_SPI_CLK_PRESCALE_MASK: c_uint = 0xDF;

    ORION_SPI_MODE_CPHA)
pub const ORION_SPI_CS_MASK: c_uint = 0x1C;
pub const ORION_SPI_CS_SHIFT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct orion_spi_dev {
    pub typ: enum orion_spi_type,
//
...
//
    pub max_hz: c_ulong,
    pub min_divisor: c_uint,
    pub max_divisor: c_uint,
    pub prescale_mask: u32,
    pub is_errata_50mhz_ac: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct orion_direct_acc {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct orion_child_options {
    pub direct_access: orion_direct_acc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct orion_spi {
    pub host: *mut spi_controller,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub axi_clk: *mut clk,
    pub devdata: *const orion_spi_dev,
    pub dev: *mut device,
    pub child: [orion_child_options; ORION_NUM_CHIPSELECTS],
}
...
#[no_mangle]
unsafe extern "C" fn orion_spi_baudrate_set(spi: *mut spi_device, speed: c_uint) -> c_int {
...
// best integer divider:
    let mut divider: unsigned = DIV_ROUND_UP(tclk_hz, speed);
    unsigned spr, sppr;
    if (divider < 16) {
...
//
    ...
    let mut bits_per_word: c_uint = spi.bits_per_word;
    int	rc;
    orion_spi = spi_controller_get_devdata(spi.controller);
    if ((t != core::ptr::null_mut()) && t.speed_hz)
    speed = t.speed_hz;
...
#[no_mangle]
unsafe extern "C" fn orion_spi_set_cs(spi: *mut spi_device, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn orion_spi_wait_till_ready(orion_spi: *mut orion_spi) -> c_int {
...
//
    ...
    let mut cnt: c_uint = count / 4;
    let mut rem: c_uint = count % 4;
//
...
#[no_mangle]
unsafe extern "C" fn orion_spi_setup(spi: *mut spi_device) -> c_int {
    ...
    ret = orion_spi_setup_transfer(spi, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn orion_spi_reset(orion_spi: *mut orion_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: devdata->min_divisor) -> else {
...
#[no_mangle]
unsafe extern "C" fn orion_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn orion_spi_runtime_suspend(dev: *mut device) -> c_int {
    static int orion_spi_runtime_suspend(struct device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn orion_spi_runtime_resume(dev: *mut device) -> c_int {
    static int orion_spi_runtime_resume(struct device *dev)
    {
    struct spi_controller *host = dev_get_drvdata(dev);
    struct orion_spi *spi = spi_controller_get_devdata(host);
