...
//! Source: drivers/spi/spi-ti-qspi.c
#![no_std]
...
// list synchronization
    ...
    pub mmap_base: *mut void __iomem,
    pub mmap_size: usize,
    pub ctrl_base: *mut regmap,
    pub ctrl_reg: c_uint,
    pub fclk: *mut clk,
    pub dev: *mut device,
    pub ctx_reg: ti_qspi_regs,
    pub mmap_phys_base: dma_addr_t,
    pub rx_bb_dma_addr: dma_addr_t,
    pub rx_bb_addr: *mut c_void,
...
pub const QSPI_CLK_DIV_MAX: c_uint = 0xffff;
// Command

pub const QSPI_WLEN_MAX_BITS: c_int = 128;
pub const QSPI_WLEN_MAX_BYTES: c_int = 16;

// STATUS REGISTER
pub const BUSY: c_uint = 0x01;
pub const WC: c_uint = 0x02;
// Device Control

pub const QSPI_FRAME: c_int = 4096;
pub const QSPI_AUTOSUSPEND_TIMEOUT: c_int = 2000;

pub const MM_SWITCH: c_uint = 0x1;

pub const QSPI_SETUP_ADDR_SHIFT: c_int = 8;
pub const QSPI_SETUP_DUMMY_SHIFT: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_setup_clk(qspi: *mut ti_qspi, speed_hz: u32) {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_restore_ctx(qspi: *mut ti_qspi) {
...
#[no_mangle]
pub unsafe extern "C" fn qspi_is_busy(qspi: *mut ti_qspi) -> u32 {
    static inline u32 qspi_is_busy(struct ti_qspi *qspi)
    {
    u32 stat;
    let mut timeout: c_ulong = jiffies + QSPI_COMPLETION_TIMEOUT;
...
#[no_mangle]
pub unsafe extern "C" fn ti_qspi_poll_wc(qspi: *mut ti_qspi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_dma_callback(param: *mut c_void) {
    ...
    {
    let mut dma_src: dma_addr_t = qspi.mmap_phys_base + offs;
    let mut ret: c_int = 0;
//
...
//
    ...
    let mut dma_src: dma_addr_t = qspi.mmap_phys_base + from;
    dma_addr_t dma_dst;
    int i, len, ret;
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_enable_memory_map(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_disable_memory_map(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_adjust_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_dma_cleanup(qspi: *mut ti_qspi) {
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_probe(pdev: *mut platform_device) -> c_int {
    ...
    u32 max_freq;
    let mut ret: c_int = 0, num_cs, irq;
    dma_cap_mask_t mask;
    ...
    qspi.rx_chan = core::ptr::null_mut();
    goto no_dma;
    }
    ...
    qspi.mmap_base = core::ptr::null_mut();
    host.mem_ops = core::ptr::null_mut();
    }
    }
    qspi.mmap_enabled = false;
    qspi.current_cs = -1;
...
#[no_mangle]
unsafe extern "C" fn ti_qspi_remove(pdev: *mut platform_device) {
