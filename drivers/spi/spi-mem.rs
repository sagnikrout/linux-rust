...
pub const SPI_MEM_MAX_BUSWIDTH: c_int = 8;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(ctlr->dma_rx: op->data.dir == SPI_MEM_DATA_IN &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn spi_check_buswidth_req(mem: *mut spi_mem, buswidth: u8, tx: bool) -> c_int {
    static int spi_check_buswidth_req(struct spi_mem *mem, u8 buswidth, bool tx)
    {
    let mut mode: u32 = mem.spi.mode;
    switch (buswidth) {
    case 1:
    return 0;
    case 2:
...
#[no_mangle]
unsafe extern "C" fn spi_mem_buswidth_is_valid(buswidth: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn spi_mem_check_op(op: *const spi_mem_op) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_supports_op(mem: *mut spi_mem, op: *const spi_mem_op) -> bool {
    bool spi_mem_supports_op(struct spi_mem *mem, const struct spi_mem_op *op)
    {
    let mut eval_op: spi_mem_op = *op;
//
...
#[no_mangle]
unsafe extern "C" fn spi_mem_access_start(mem: *mut spi_mem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_mem_access_end(mem: *mut spi_mem) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: exec_op_ret) -> else {
    else if (exec_op_ret)
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_exec_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_set_dqs(mem: *mut spi_mem) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_has_dqs(mem: *mut spi_mem) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_adjust_op_size(mem: *mut spi_mem, op: *mut spi_mem_op) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_adjust_op_freq(mem: *mut spi_mem, op: *mut spi_mem_op) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_calc_op_duration(mem: *mut spi_mem, op: *mut spi_mem_op) -> u64 {
    u64 spi_mem_calc_op_duration(struct spi_mem *mem, struct spi_mem_op *op)
    {
    let mut ncycles: u64 = 0;
...
// Convert into ns
    ...
    {
    let mut op: spi_mem_op = *desc.info.op_tmpl;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_dirmap_destroy(desc: *mut spi_mem_dirmap_desc) {
...
#[no_mangle]
unsafe extern "C" fn devm_spi_mem_dirmap_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_spi_mem_dirmap_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_mem_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_mem_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn spi_mem_shutdown(spi: *mut spi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spi_mem_driver_unregister(memdrv: *mut spi_mem_driver) {
