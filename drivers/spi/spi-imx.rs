...
// Copyright (C) 2008 Juergen Beisert
    ...
    let mut use_dma: static bool = true;
...
pub const MXC_CSPIRXDATA: c_uint = 0x00;
pub const MXC_CSPITXDATA: c_uint = 0x04;
pub const MXC_CSPICTRL: c_uint = 0x08;
pub const MXC_CSPIINT: c_uint = 0x0c;
pub const MXC_RESET: c_uint = 0x1c;
// generic defines to abstract from the different register layouts

// The maximum bytes that a sdma BD can transfer.

pub const MX51_ECSPI_CTRL_MAX_BURST: c_int = 512;
// The maximum bytes that IMX53_ECSPI can transfer in target mode.
pub const MX53_MAX_TRANSFER_BYTES: c_int = 512;
pub const BYTES_PER_32BITS_WORD: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spi_imx_devtype_data {
    pub enable): *mut *mut *mut void (intctrl)(struct spi_imx_data spi_imx, int,
    pub msg): *mut *mut *mut int (prepare_message)(struct spi_imx_data spi_imx, struct spi_message,
    int (*prepare_transfer)(struct spi_imx_data *spi_imx, struct spi_device *spi,
    pub t): *mut spi_transfer,
    pub spi_imx): *mut *mut void (trigger)(struct spi_imx_data,
    pub spi_imx): *mut *mut int (rx_available)(struct spi_imx_data,
    pub spi_imx): *mut *mut void (reset)(struct spi_imx_data,
    pub spi_imx): *mut *mut void (setup_wml)(struct spi_imx_data,
    pub spi_imx): *mut *mut void (disable)(struct spi_imx_data,
    pub has_dmamode: bool,
    pub has_targetmode: bool,
    pub fifo_size: c_uint,
    pub dynamic_burst: bool,
//
// ERR009165 fixed or not:
// https://www.nxp.com/docs/en/errata/IMX6DQCE.pdf
//
    pub tx_glitch_fixed: bool,
    pub devtype: enum spi_imx_devtype,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dma_data_package {
    pub cmd_word: u32,
    pub dma_rx_buf: *mut c_void,
    pub dma_tx_buf: *mut c_void,
...
pub struct spi_imx_data {
    ...
    pub clk_ipg: *mut clk,
    pub spi_clk: c_ulong,
    pub spi_bus_clk: c_uint,
    pub bits_per_word: c_uint,
    pub spi_drctl: c_uint,
    pub remainder: unsigned int count,,
    pub spi_imx): *mut *mut void (tx)(struct spi_imx_data,
    pub spi_imx): *mut *mut void (rx)(struct spi_imx_data,
    pub rx_buf: *mut c_void,
    pub tx_buf: *const c_void,
    pub /: *mut *mut unsigned int txfifo; / number of words pushed in tx FIFO,
    pub dynamic_burst: c_uint,
    pub rx_only: bool,
// Target mode
    pub target_mode: bool,
    pub target_aborted: bool,
    pub target_burst: c_uint,
// DMA
    pub usedma: bool,
    pub wml: u32,
    pub dma_rx_completion: completion,
    pub dma_tx_completion: completion,
    pub dma_package_num: usize,
    pub dma_data: *mut dma_data_package,
    pub rx_offset: c_int,
    pub devtype_data: *const spi_imx_devtype_data,
}

#[no_mangle]
pub unsafe extern "C" fn is_imx27_cspi(d: *mut spi_imx_data) -> c_int {
    static inline int is_imx27_cspi(struct spi_imx_data *d)
    {
    return d.devtype_data.devtype == IMX27_CSPI;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx35_cspi(d: *mut spi_imx_data) -> c_int {
    static inline int is_imx35_cspi(struct spi_imx_data *d)
    {
    return d.devtype_data.devtype == IMX35_CSPI;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx51_ecspi(d: *mut spi_imx_data) -> c_int {
    static inline int is_imx51_ecspi(struct spi_imx_data *d)
    {
    return d.devtype_data.devtype == IMX51_ECSPI;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx53_ecspi(d: *mut spi_imx_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_bytes_per_word(bits_per_word: c_int) -> c_int {
...
//
pub const MX51_ECSPI_CTRL: c_uint = 0x08;

pub const MX51_ECSPI_CTRL_POSTDIV_OFFSET: c_int = 8;
pub const MX51_ECSPI_CTRL_PREDIV_OFFSET: c_int = 12;

pub const MX51_ECSPI_CTRL_BL_OFFSET: c_int = 20;

pub const MX51_ECSPI_CONFIG: c_uint = 0x0c;

pub const MX51_ECSPI_INT: c_uint = 0x10;

pub const MX51_ECSPI_DMA: c_uint = 0x14;

pub const MX51_ECSPI_STAT: c_uint = 0x18;

pub const MX51_ECSPI_PERIOD: c_uint = 0x1c;
pub const MX51_ECSPI_PERIOD_MASK: c_uint = 0x7fff;
//
...
//
pub const MX51_ECSPI_PERIOD_MIN_DELAY_SCK: c_int = 4;
pub const MX51_ECSPI_TESTREG: c_uint = 0x20;

#[no_mangle]
unsafe extern "C" fn spi_imx_buf_rx_swap_u32(spi_imx: *mut spi_imx_data) {
    static void spi_imx_buf_rx_swap_u32(struct spi_imx_data *spi_imx)
    {
    let mut val: c_uint = readl(spi_imx.base + MXC_CSPIRXDATA);
    if (spi_imx.rx_buf) {
    ...
    swab32s(&val);
#[no_mangle]
pub unsafe extern "C" fn if(2: bytes_per_word ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_buf_rx_swap(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_buf_tx_swap_u32(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_buf_tx_swap(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn mx53_ecspi_rx_target(spi_imx: *mut spi_imx_data) {
    static void mx53_ecspi_rx_target(struct spi_imx_data *spi_imx)
    {
    let mut val: u32 = readl(spi_imx.base + MXC_CSPIRXDATA);

    let mut bytes_per_word: c_uint = spi_imx_bytes_per_word(spi_imx.bits_per_word);
    if (bytes_per_word == 1)
    swab32s(&val);
#[no_mangle]
pub unsafe extern "C" fn if(2: bytes_per_word ==) -> else {
    ...
    if (spi_imx.rx_buf) {
    let mut n_bytes: c_int = spi_imx.target_burst % sizeof(val);
    if (!n_bytes)
    n_bytes = sizeof(val);
...
#[no_mangle]
unsafe extern "C" fn mx53_ecspi_tx_target(spi_imx: *mut spi_imx_data) {
    static void mx53_ecspi_tx_target(struct spi_imx_data *spi_imx)
    {
    let mut val: u32 = 0;
    let mut n_bytes: c_int = spi_imx.count % sizeof(val);
...
//
    ...
    let mut fin: c_uint = spi_imx.spi_clk;
    fspi = min(fspi, fin);
...
#[no_mangle]
unsafe extern "C" fn mx51_ecspi_intctrl(spi_imx: *mut spi_imx_data, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mx51_ecspi_trigger(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn mx51_ecspi_disable(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn mx51_ecspi_channel(spi: *const spi_device) -> c_int {
    ...
    let mut ctrl: u32 = MX51_ECSPI_CTRL_ENABLE;
    let mut min_speed_hz: u32 = ~0U;
    u32 testreg, delay;
    let mut cfg: u32 = readl(spi_imx.base + MX51_ECSPI_CONFIG);
    let mut current_cfg: u32 = cfg;
    let mut channel: c_int = mx51_ecspi_channel(spi);
...
//
    ...
    {
    let mut cpha: bool = (spi.mode & SPI_CPHA);
    let mut flip_cpha: bool = (spi.mode & SPI_RX_CPHA_FLIP) && spi_imx.rx_only;
    let mut cfg: u32 = readl(spi_imx.base + MX51_ECSPI_CONFIG);
    let mut channel: c_int = mx51_ecspi_channel(spi);
// Flip cpha logical value iff flip_cpha
    ...
    {
    let mut ctrl: u32 = readl(spi_imx.base + MX51_ECSPI_CTRL);
    u64 word_delay_sck;
    u32 clk;
...
// calculate word delay in SPI Clock (SCLK) cycles
    ...
    word_delay_sck = 0;
#[no_mangle]
pub unsafe extern "C" fn if(1: word_delay_sck <= MX51_ECSPI_PERIOD_MIN_DELAY_SCK +) -> else {
...
#[no_mangle]
unsafe extern "C" fn mx51_setup_wml(spi_imx: *mut spi_imx_data) {
    static void mx51_setup_wml(struct spi_imx_data *spi_imx)
    {
    let mut tx_wml: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn mx51_ecspi_rx_available(spi_imx: *mut spi_imx_data) -> c_int {
    static int mx51_ecspi_rx_available(struct spi_imx_data *spi_imx)
    {
    return readl(spi_imx.base + MX51_ECSPI_STAT) & MX51_ECSPI_STAT_RR;
    }
#[no_mangle]
unsafe extern "C" fn mx51_ecspi_reset(spi_imx: *mut spi_imx_data) {
...
pub const MX31_CSPICTRL_BC_SHIFT: c_int = 8;
pub const MX35_CSPICTRL_BL_SHIFT: c_int = 20;
pub const MX31_CSPICTRL_CS_SHIFT: c_int = 24;
pub const MX35_CSPICTRL_CS_SHIFT: c_int = 12;
pub const MX31_CSPICTRL_DR_SHIFT: c_int = 16;
pub const MX31_CSPI_DMAREG: c_uint = 0x10;

pub const MX31_CSPISTATUS: c_uint = 0x14;

pub const MX31_CSPI_TESTREG: c_uint = 0x1C;
...
//
#[no_mangle]
unsafe extern "C" fn mx31_intctrl(spi_imx: *mut spi_imx_data, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mx31_trigger(spi_imx: *mut spi_imx_data) {
    ...
    struct spi_device *spi, struct spi_transfer *t)
    {
    let mut reg: c_uint = MX31_CSPICTRL_ENABLE | MX31_CSPICTRL_HOST;
    unsigned int clk;
...
#[no_mangle]
unsafe extern "C" fn mx31_rx_available(spi_imx: *mut spi_imx_data) -> c_int {
    static int mx31_rx_available(struct spi_imx_data *spi_imx)
    {
    return readl(spi_imx.base + MX31_CSPISTATUS) & MX31_STATUS_RR;
    }
#[no_mangle]
unsafe extern "C" fn mx31_reset(spi_imx: *mut spi_imx_data) {
...
pub const MX21_CSPICTRL_DR_SHIFT: c_int = 14;
pub const MX21_CSPICTRL_CS_SHIFT: c_int = 19;
#[no_mangle]
unsafe extern "C" fn mx21_intctrl(spi_imx: *mut spi_imx_data, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mx21_trigger(spi_imx: *mut spi_imx_data) {
    ...
    struct spi_device *spi, struct spi_transfer *t)
    {
    let mut reg: c_uint = MX21_CSPICTRL_ENABLE | MX21_CSPICTRL_HOST;
    let mut max: c_uint = is_imx27_cspi(spi_imx) ? 16 : 18;
    unsigned int clk;
...
#[no_mangle]
unsafe extern "C" fn mx21_rx_available(spi_imx: *mut spi_imx_data) -> c_int {
    static int mx21_rx_available(struct spi_imx_data *spi_imx)
    {
    return readl(spi_imx.base + MXC_CSPIINT) & MX21_INTREG_RR;
    }
#[no_mangle]
unsafe extern "C" fn mx21_reset(spi_imx: *mut spi_imx_data) {
    static void mx21_reset(struct spi_imx_data *spi_imx)
    {
    writel(1, spi_imx.base + MXC_RESET);
    }

pub const MX1_CSPICTRL_DR_SHIFT: c_int = 13;
#[no_mangle]
unsafe extern "C" fn mx1_intctrl(spi_imx: *mut spi_imx_data, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mx1_trigger(spi_imx: *mut spi_imx_data) {
    ...
    struct spi_device *spi, struct spi_transfer *t)
    {
    let mut reg: c_uint = MX1_CSPICTRL_ENABLE | MX1_CSPICTRL_HOST;
    unsigned int clk;
    reg |= spi_imx_clkdiv_2(spi_imx.spi_clk, spi_imx.spi_bus_clk, &clk) <<
...
#[no_mangle]
unsafe extern "C" fn mx1_rx_available(spi_imx: *mut spi_imx_data) -> c_int {
    static int mx1_rx_available(struct spi_imx_data *spi_imx)
    {
    return readl(spi_imx.base + MXC_CSPIINT) & MX1_INTREG_RR;
    }
#[no_mangle]
unsafe extern "C" fn mx1_reset(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_set_burst_len(spi_imx: *mut spi_imx_data, n_bits: c_int) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_push(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    spi_imx.rx_only = ((t.tx_buf == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn spi_imx_sdma_exit(spi_imx: *mut spi_imx_data) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_dma_rx_callback(cookie: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_dma_tx_callback(cookie: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_calculate_timeout(spi_imx: *mut spi_imx_data, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_dma_configure(controller: *mut spi_controller, word_delay: bool) -> c_int {
...
// fallback to pio
    ...
    struct spi_transfer *transfer)
    {
    let mut word_delay: bool = transfer.word_delay.value != 0 && !spi_imx.target_mode;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn spi_imx_transfer_estimate_time_us(transfer: *mut spi_transfer) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_setup(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_target_abort(controller: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    device_property_read_u32(&pdev.dev, "cs-gpios", core::ptr::null_mut()))
//
...
#[no_mangle]
unsafe extern "C" fn spi_imx_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spi_imx_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(spi_imx_runtime_suspend,	spi_imx_runtime_resume, core::ptr::null_mut())
