...
//! Source: drivers/spi/spi-realtek-rtl-snand.c
#![no_std]
...
pub const SNAFCFR: c_uint = 0x00;

pub const SNAFCCR: c_uint = 0x04;
pub const SNAFWCMR: c_uint = 0x08;
pub const SNAFRCMR: c_uint = 0x0c;
pub const SNAFRDR: c_uint = 0x10;
pub const SNAFWDR: c_uint = 0x14;
pub const SNAFDTR: c_uint = 0x18;
pub const SNAFDRSAR: c_uint = 0x1c;
pub const SNAFDIR: c_uint = 0x20;

pub const SNAFDLR: c_uint = 0x24;
pub const SNAFSR: c_uint = 0x40;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl_snand {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_set_cs(snand: *mut rtl_snand, cs: c_int, active: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_wait_ready(snand: *mut rtl_snand) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_xfer_head(snand: *mut rtl_snand, cs: c_int, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_xfer_tail(snand: *mut rtl_snand, cs: c_int) {
    static void rtl_snand_xfer_tail(struct rtl_snand *snand, int cs)
    {
    rtl_snand_set_cs(snand, cs, false);
    }
#[no_mangle]
unsafe extern "C" fn rtl_snand_xfer(snand: *mut rtl_snand, cs: c_int, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_dma_xfer(snand: *mut rtl_snand, cs: c_int, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_dma_op(op: *const spi_mem_op) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_exec_op(mem: *mut spi_mem, op: *const spi_mem_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_snand_probe(pdev: *mut platform_device) -> c_int {
