...
//! Source: drivers/spi/spi-dw-dma.c
#![no_std]
...
pub const DW_SPI_RX_BUSY: c_int = 0;
pub const DW_SPI_RX_BURST_LEVEL: c_int = 16;
pub const DW_SPI_TX_BUSY: c_int = 1;
pub const DW_SPI_TX_BURST_LEVEL: c_int = 16;
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_chan_filter(chan: *mut dma_chan, param: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_maxburst_init(dws: *mut dw_spi) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_caps_init(dws: *mut dw_spi) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: tx.max_sg_burst >) -> else {
    else if (tx.max_sg_burst > 0)
    dws.dma_sg_burst = tx.max_sg_burst;
#[no_mangle]
pub unsafe extern "C" fn if(0: rx.max_sg_burst >) -> else {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_init_mfld(dev: *mut device, dws: *mut dw_spi) -> c_int {
    static int dw_spi_dma_init_mfld(struct device *dev, struct dw_spi *dws)
    {
    let mut dma_tx: dw_dma_slave = { .dst_id = 1 }, *tx = &dma_tx;
    let mut dma_rx: dw_dma_slave = { .src_id = 0 }, *rx = &dma_rx;
...
//
    dma_dev = pci_get_device(PCI_VENDOR_ID_INTEL, 0x0827, core::ptr::null_mut());
    if (!dma_dev)
    return -ENODEV;
    dma_cap_zero(mask);
...
// 2. Init tx channel
    ...
    dws.txchan = core::ptr::null_mut();
    free_rxchan:
    dma_release_channel(dws.rxchan);
    dws.rxchan = core::ptr::null_mut();
    err_exit:
    pci_dev_put(dma_dev);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_init_generic(dev: *mut device, dws: *mut dw_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_exit(dws: *mut dw_spi) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_transfer_handler(dws: *mut dw_spi) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_convert_width(n_bytes: u8) -> enum dma_slave_buswidth {
    ...
    let mut n_bytes: u8 = roundup_pow_of_two(BITS_TO_BYTES(xfer.bits_per_word));
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_wait(dws: *mut dw_spi, len: c_uint, speed: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_dma_tx_busy(dws: *mut dw_spi) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_tx_done(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_config_tx(dws: *mut dw_spi) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_dma_rx_busy(dws: *mut dw_spi) -> bool {
    static inline bool dw_spi_dma_rx_busy(struct dw_spi *dws)
    {
    return !!(dw_readl(dws, DW_SPI_SR) & DW_SPI_SR_RF_NOT_EMPT);
    }
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_wait_rx_done(dws: *mut dw_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_rx_done(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_config_rx(dws: *mut dw_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_setup(dws: *mut dw_spi, xfer: *mut spi_transfer) -> c_int {
...
//
    ...
    struct spi_transfer *xfer)
    {
    struct scatterlist *tx_sg = core::ptr::null_mut(), *rx_sg = core::ptr::null_mut(), tx_tmp, rx_tmp;
    let mut tx_len: c_uint = 0, rx_len = 0;
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_transfer(dws: *mut dw_spi, xfer: *mut spi_transfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_spi_dma_stop(dws: *mut dw_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_dma_setup_mfld(dws: *mut dw_spi) {
...
#[no_mangle]
pub unsafe extern "C" fn dw_spi_dma_setup_generic(dws: *mut dw_spi) {
