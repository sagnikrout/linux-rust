...
//! Source: drivers/spi/spi-stm32.c
#![no_std]
...
pub const STM32FX_SPI_CR1: c_uint = 0x00;
pub const STM32FX_SPI_CR2: c_uint = 0x04;
pub const STM32FX_SPI_SR: c_uint = 0x08;
pub const STM32FX_SPI_DR: c_uint = 0x0C;
pub const STM32FX_SPI_I2SCFGR: c_uint = 0x1C;
// STM32FX_SPI_CR1 bit fields

pub const STM32FX_SPI_CR1_BR_SHIFT: c_int = 3;

pub const STM32FX_SPI_CR1_BR_MIN: c_int = 0;
...
pub const STM32H7_SPI_CR1: c_uint = 0x00;
pub const STM32H7_SPI_CR2: c_uint = 0x04;
pub const STM32H7_SPI_CFG1: c_uint = 0x08;
pub const STM32H7_SPI_CFG2: c_uint = 0x0C;
pub const STM32H7_SPI_IER: c_uint = 0x10;
pub const STM32H7_SPI_SR: c_uint = 0x14;
pub const STM32H7_SPI_IFCR: c_uint = 0x18;
pub const STM32H7_SPI_TXDR: c_uint = 0x20;
pub const STM32H7_SPI_RXDR: c_uint = 0x30;
pub const STM32H7_SPI_I2SCFGR: c_uint = 0x50;
...
pub const STM32H7_SPI_CFG1_MBR_SHIFT: c_int = 28;
pub const STM32H7_SPI_CFG1_MBR_MIN: c_int = 0;
...
pub const STM32MP25_SPI_HWCFGR1: c_uint = 0x3F0;
// STM32MP25_SPI_CR2 bit fields

// STM32MP25_SPI_HWCFGR1

pub const STM32MP25_SPI_HWCFGR1_FULLCFG_LIMITED: c_uint = 0x0;
pub const STM32MP25_SPI_HWCFGR1_FULLCFG_FULL: c_uint = 0x1;

pub const STM32MP25_SPI_HWCFGR1_DSCFG_16_B: c_uint = 0x0;
pub const STM32MP25_SPI_HWCFGR1_DSCFG_32_B: c_uint = 0x1;
// STM32H7 SPI Master Baud Rate min/max divisor

// STM32H7 SPI Communication mode
pub const STM32H7_SPI_FULL_DUPLEX: c_int = 0;
pub const STM32H7_SPI_SIMPLEX_TX: c_int = 1;
pub const STM32H7_SPI_SIMPLEX_RX: c_int = 2;
pub const STM32H7_SPI_HALF_DUPLEX: c_int = 3;
// SPI Communication type
pub const SPI_FULL_DUPLEX: c_int = 0;
pub const SPI_SIMPLEX_TX: c_int = 1;
pub const SPI_SIMPLEX_RX: c_int = 2;
pub const SPI_3WIRE_TX: c_int = 3;
pub const SPI_3WIRE_RX: c_int = 4;

//
// use PIO for small transfers, avoiding DMA setup/teardown overhead for drivers
// without fifo buffers.
//
pub const SPI_DMA_MIN_BYTES: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_spi_regspec {
    pub en: stm32_spi_reg,
    pub dma_rx_en: stm32_spi_reg,
    pub dma_tx_en: stm32_spi_reg,
    pub cpol: stm32_spi_reg,
    pub cpha: stm32_spi_reg,
    pub lsb_first: stm32_spi_reg,
    pub cs_high: stm32_spi_reg,
    pub br: stm32_spi_reg,
    pub rx: stm32_spi_reg,
    pub tx: stm32_spi_reg,
    pub fullcfg: stm32_spi_reg,
    pub rdy_en: stm32_spi_reg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_spi_cfg {
    pub regs: *const stm32_spi_regspec,
    pub spi): *mut *mut int (get_fifo_size)(struct stm32_spi,
    pub spi): *mut *mut int (get_bpw_mask)(struct stm32_spi,
    pub spi): *mut *mut void (disable)(struct stm32_spi,
    pub spi): *mut *mut int (config)(struct stm32_spi,
    pub spi): *mut *mut void (set_bpw)(struct stm32_spi,
    pub comm_type): *mut *mut *mut int (set_mode)(struct stm32_spi spi, unsigned int,
    pub xfer): *mut *mut *mut void (set_data_idleness)(struct stm32_spi spi, struct spi_transfer,
    pub length): *mut *mut *mut int (set_number_of_data)(struct stm32_spi spi, u32,
    pub spi): *mut *mut void (write_tx)(struct stm32_spi,
    pub spi): *mut *mut void (read_rx)(struct stm32_spi,
    pub spi): *mut *mut void (transfer_one_dma_start)(struct stm32_spi,
    pub data): *mut *mut void (dma_rx_cb)(void,
    pub data): *mut *mut void (dma_tx_cb)(void,
    pub spi): *mut *mut int (transfer_one_irq)(struct stm32_spi,
    pub spi): *mut *mut int (transfer_one_poll)(struct stm32_spi,
    pub dev_id): *mut *mut irqreturn_t (irq_handler_event)(int irq, void,
    pub dev_id): *mut *mut irqreturn_t (irq_handler_thread)(int irq, void,
    pub baud_rate_div_min: c_uint,
    pub baud_rate_div_max: c_uint,
    pub has_fifo: bool,
    pub has_device_mode: bool,
    pub flags: u16,
    pub prevent_dma_burst: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_spi {
    pub dev: *mut device,
    pub ctrl: *mut spi_controller,
    pub cfg: *const stm32_spi_cfg,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub clk_rate: u32,
    pub /: *mut *mut spinlock_t lock; / prevent I/O concurrent access,
    pub irq: c_int,
    pub fifo_size: c_uint,
    pub t_size_max: c_uint,
    pub feature_set: c_uint,

    pub cur_midi: c_uint,
    pub cur_speed: c_uint,
    pub cur_half_period: c_uint,
    pub cur_bpw: c_uint,
    pub cur_fthlv: c_uint,
    pub cur_comm: c_uint,
    pub cur_xferlen: c_uint,
    pub cur_usedma: bool,
    ...
    pub sram_rx_buf_size: usize,
    pub sram_rx_buf: *mut c_void,
    pub sram_dma_rx_buf: dma_addr_t,
    pub mdma_rx: *mut dma_chan,
}
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_get_fifo_size(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_spi_get_bpw_mask(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f7_spi_get_bpw_mask(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_get_bpw_mask(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32mp25_spi_get_bpw_mask(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_prepare_fthlv(spi: *mut stm32_spi, xfer_len: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f7_spi_write_tx(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_write_txfifo(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f7_spi_read_rx(spi: *mut stm32_spi) {
    static void stm32f7_spi_read_rx(struct stm32_spi *spi)
    {
    let mut sr: u32 = readl_relaxed(spi.base + STM32FX_SPI_SR);
    let mut frlvl: u32 = FIELD_GET(STM32F7_SPI_SR_FRLVL, sr);
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_read_rxfifo(spi: *mut stm32_spi) {
    static void stm32h7_spi_read_rxfifo(struct stm32_spi *spi)
    {
    let mut sr: u32 = readl_relaxed(spi.base + STM32H7_SPI_SR);
    let mut rxplvl: u32 = FIELD_GET(STM32H7_SPI_SR_RXPLVL, sr);
    while ((spi.rx_len > 0) &&
...
//
#[no_mangle]
unsafe extern "C" fn stm32_spi_enable(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_disable(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_disable(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_irq_event(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_spi_optimize_message(msg: *mut spi_message) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_dma_tx_cb(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_spi_dma_rx_cb(data: *mut c_void) {
...
//
    ...
    let mut maxburst: u32 = 1;
    int ret;
    if (spi.cur_bpw <= 8)
    buswidth = DMA_SLAVE_BUSWIDTH_1_BYTE;
#[no_mangle]
pub unsafe extern "C" fn if(16: spi->cur_bpw <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_transfer_one_irq(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_transfer_one_poll(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_transfer_one_irq(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_transfer_one_dma_start(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f7_spi_transfer_one_dma_start(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_transfer_one_dma_start(spi: *mut stm32_spi) {
    static void stm32h7_spi_transfer_one_dma_start(struct stm32_spi *spi)
    {
    let mut ier: u32 = STM32H7_SPI_IER_OVRIE | STM32H7_SPI_IER_MODFIE;
...
//
    ...
    let mut rx_mdma_conf: dma_slave_config = {0};
...
// Prepare DMA slave_sg DBM transfer DEV_TO_MEM (RX>MEM=SRAM)
    ...
    let mut bytes: usize = min_t(size_t, spi_s_len, sram_period);
    sg_dma_len(s) = bytes;
...
//
    ...
    struct spi_transfer *xfer)
    {
    struct dma_async_tx_descriptor *rx_mdma_desc = core::ptr::null_mut(), *rx_dma_desc = core::ptr::null_mut();
    struct dma_async_tx_descriptor *tx_dma_desc = core::ptr::null_mut();
    ...
    rx_dma_conf.peripheral_config = core::ptr::null_mut();
    rx_dma_desc = core::ptr::null_mut();
    }
    }
    if (!rx_dma_desc) {
    dmaengine_slave_config(spi.dma_rx, &rx_dma_conf);
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_spi_set_bpw(spi: *mut stm32_spi) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f7_spi_set_bpw(spi: *mut stm32_spi) {
    static void stm32f7_spi_set_bpw(struct stm32_spi *spi)
    {
    u32 bpw;
    let mut cr2_clrb: u32 = 0, cr2_setb = 0;
    bpw = spi.cur_bpw - 1;
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_set_bpw(spi: *mut stm32_spi) {
    static void stm32h7_spi_set_bpw(struct stm32_spi *spi)
    {
    u32 bpw, fthlv;
    let mut cfg1_clrb: u32 = 0, cfg1_setb = 0;
    bpw = spi.cur_bpw - 1;
...
//
#[no_mangle]
unsafe extern "C" fn stm32_spi_set_mbr(spi: *mut stm32_spi, mbrdiv: u32) {
...
//
    ...
    struct spi_transfer *transfer)
    {
    let mut type: c_uint = SPI_FULL_DUPLEX;
...
//
    ...
    type = SPI_SIMPLEX_RX;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !transfer->rx_buf) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_set_mode(spi: *mut stm32_spi, comm_type: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_set_mode(spi: *mut stm32_spi, comm_type: c_uint) -> c_int {
    static int stm32h7_spi_set_mode(struct stm32_spi *spi, unsigned int comm_type)
    {
    u32 mode;
    let mut cfg2_clrb: u32 = 0, cfg2_setb = 0;
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_data_idleness(spi: *mut stm32_spi, xfer: *mut spi_transfer) {
    static void stm32h7_spi_data_idleness(struct stm32_spi *spi, struct spi_transfer *xfer)
    {
    let mut cfg2_clrb: u32 = 0, cfg2_setb = 0;
    let mut len: u32 = xfer.len;
    u32 spi_delay_ns;
    ...
    let mut sck_period_ns: u32 = DIV_ROUND_UP(NSEC_PER_SEC, spi.cur_speed);
    let mut midi: u32 = DIV_ROUND_UP(spi.cur_midi, sck_period_ns);
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_number_of_data(spi: *mut stm32_spi, nb_words: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_spi_can_poll(spi: *mut stm32_spi) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(stm32_spi_can_poll(spi): spi->cfg->transfer_one_poll &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn stm32fx_spi_config(spi: *mut stm32_spi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_config(spi: *mut stm32_spi) -> c_int {
    static int stm32h7_spi_config(struct stm32_spi *spi)
    {
    unsigned long flags;
    let mut cr1: u32 = 0, cfg2 = 0;
    spin_lock_irqsave(&spi.lock, flags);
// Ensure I2SMOD bit is kept cleared
...
#[no_mangle]
unsafe extern "C" fn stm32h7_spi_device_abort(ctrl: *mut spi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_spi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_spi_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_spi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_spi_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(stm32_spi_runtime_suspend, stm32_spi_runtime_resume, core::ptr::null_mut())
    };
