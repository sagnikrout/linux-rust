...
//! Source: drivers/spi/spi-ath79.c
#![no_std]
...
pub const ATH79_SPI_RRW_DELAY_FACTOR: c_int = 12000;

pub const AR71XX_SPI_REG_FS: c_uint = 0x00	/* Function Select */;
pub const AR71XX_SPI_REG_CTRL: c_uint = 0x04	/* SPI Control */;
pub const AR71XX_SPI_REG_IOC: c_uint = 0x08	/* SPI I/O Control */;
pub const AR71XX_SPI_REG_RDS: c_uint = 0x0c	/* Read Data Shift */;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ath79_spi {
    pub bitbang: spi_bitbang,
    pub ioc_base: u32,
    pub reg_ctrl: u32,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub rrw_delay: c_uint,
}

#[no_mangle]
pub unsafe extern "C" fn ath79_spi_rr(sp: *mut ath79_spi, reg: c_uint) -> u32 {
    static inline u32 ath79_spi_rr(struct ath79_spi *sp, unsigned int reg)
    {
    return ioread32(sp.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn ath79_spi_wr(sp: *mut ath79_spi, reg: c_uint, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ath79_spi_delay(sp: *mut ath79_spi, nsecs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ath79_spi_chipselect(spi: *mut spi_device, is_active: c_int) {
    static void ath79_spi_chipselect(struct spi_device *spi, int is_active)
    {
    struct ath79_spi *sp = ath79_spidev_to_sp(spi);
    let mut cs_high: c_int = (spi.mode & SPI_CS_HIGH) ? is_active : !is_active;
    let mut cs_bit: u32 = AR71XX_SPI_IOC_CS(spi_get_chipselect(spi, 0));
    if (cs_high)
    sp.ioc_base |= cs_bit;
    else
    sp.ioc_base &= ~cs_bit;
...
#[no_mangle]
unsafe extern "C" fn ath79_spi_enable(sp: *mut ath79_spi) {
...
#[no_mangle]
unsafe extern "C" fn ath79_spi_disable(sp: *mut ath79_spi) {
...
#[no_mangle]
unsafe extern "C" fn ath79_spi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath79_spi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ath79_spi_shutdown(pdev: *mut platform_device) {
