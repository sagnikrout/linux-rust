...
//! Source: drivers/watchdog/tqmx86_wdt.c
#![no_std]
...
pub const WDT_TIMEOUT: c_int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tqmx86_wdt {
    pub wdd: watchdog_device,
    pub io_base: *mut void __iomem,
}

pub const TQMX86_WDCFG: c_uint = 0x00 /* Watchdog Configuration Register */;
pub const TQMX86_WDCS: c_uint = 0x01 /* Watchdog Config/Status Register */;
#[no_mangle]
unsafe extern "C" fn tqmx86_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tqmx86_wdt_set_timeout(wdd: *mut watchdog_device, t: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tqmx86_wdt_probe(pdev: *mut platform_device) -> c_int {
