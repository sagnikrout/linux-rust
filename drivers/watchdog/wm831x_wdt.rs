...
//! Source: drivers/watchdog/wm831x_wdt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm831x_wdt_drvdata {
    pub wdt: watchdog_device,
    pub wm831x: *mut wm831x,
    pub lock: mutex,
    pub update_state: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn wm831x_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_wdt_probe(pdev: *mut platform_device) -> c_int {
