...
//! Source: drivers/watchdog/kempld_wdt.c
#![no_std]
...
pub const STAGE_CFG_PRESCALER_MASK: c_uint = 0x30;
pub const STAGE_CFG_ACTION_MASK: c_uint = 0x7;

pub const KEMPLD_WDT_MAX_STAGES: c_int = 2;
pub const KEMPLD_WDT_KICK: c_uint = 0x16;
pub const KEMPLD_WDT_CFG: c_uint = 0x17;
pub const KEMPLD_WDT_CFG_ENABLE: c_uint = 0x10;
pub const KEMPLD_WDT_CFG_ENABLE_LOCK: c_uint = 0x8;
pub const KEMPLD_WDT_CFG_GLOBAL_LOCK: c_uint = 0x80;
    enum {
    ACTION_NONE = 0,
    ACTION_RESET,
    ACTION_NMI,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kempld_wdt_data {
    pub pld: *mut kempld_device_data,
    pub wdd: watchdog_device,
    pub pretimeout: c_uint,
    pub stage: [kempld_wdt_stage; KEMPLD_WDT_MAX_STAGES],
    pub pm_status_store: u8,
}

pub const DEFAULT_PRETIMEOUT: c_int = 0;
    let mut timeout: static unsigned int = DEFAULT_TIMEOUT;
    module_param(timeout, uint, 0);
    MODULE_PARM_DESC(timeout,
    "Watchdog timeout in seconds. (>=0, default="
    __MODULE_STRING(DEFAULT_TIMEOUT) ")");
    let mut pretimeout: static unsigned int = DEFAULT_PRETIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn kempld_wdt_update_timeouts(wdt_data: *mut kempld_wdt_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_wdt_keepalive(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_wdt_probe_stages(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_wdt_resume(pdev: *mut platform_device) -> c_int {
