...
//! Source: drivers/watchdog/s3c2410_wdt.c
#![no_std]
...
pub const S3C2410_WTCON: c_uint = 0x00;
pub const S3C2410_WTDAT: c_uint = 0x04;
pub const S3C2410_WTCNT: c_uint = 0x08;
pub const S3C2410_WTCLRINT: c_uint = 0x0c;
pub const S3C2410_WTCNT_MAXCNT_16: c_uint = 0xffff;
pub const S3C2410_WTCNT_MAXCNT_32: c_uint = 0xffffffff;

pub const S3C2410_WTCON_MAXDIV: c_uint = 0x80;

pub const S3C2410_WTCON_PRESCALE_MAX: c_uint = 0xff;

pub const EXYNOS5_RST_STAT_REG_OFFSET: c_uint = 0x0404;
pub const EXYNOS5_WDT_DISABLE_REG_OFFSET: c_uint = 0x0408;
pub const EXYNOS5_WDT_MASK_RESET_REG_OFFSET: c_uint = 0x040c;
pub const EXYNOS850_CLUSTER0_NONCPU_OUT: c_uint = 0x1220;
pub const EXYNOS850_CLUSTER0_NONCPU_INT_EN: c_uint = 0x1244;
pub const EXYNOS850_CLUSTER1_NONCPU_OUT: c_uint = 0x1620;
pub const EXYNOS850_CLUSTER1_NONCPU_INT_EN: c_uint = 0x1644;
pub const EXYNOSAUTOV9_CLUSTER1_NONCPU_OUT: c_uint = 0x1520;
pub const EXYNOSAUTOV9_CLUSTER1_NONCPU_INT_EN: c_uint = 0x1544;
pub const EXYNOSAUTOV920_CLUSTER0_NONCPU_OUT: c_uint = 0x1420;
pub const EXYNOSAUTOV920_CLUSTER0_NONCPU_INT_EN: c_uint = 0x1444;
pub const EXYNOSAUTOV920_CLUSTER1_NONCPU_OUT: c_uint = 0x1720;
pub const EXYNOSAUTOV920_CLUSTER1_NONCPU_INT_EN: c_uint = 0x1744;
pub const EXYNOS850_CLUSTER0_WDTRESET_BIT: c_int = 24;
pub const EXYNOS850_CLUSTER1_WDTRESET_BIT: c_int = 23;
pub const EXYNOSAUTOV9_CLUSTER0_WDTRESET_BIT: c_int = 25;
pub const EXYNOSAUTOV9_CLUSTER1_WDTRESET_BIT: c_int = 24;
pub const EXYNOSAUTOV920_CLUSTER0_WDTRESET_BIT: c_int = 0;
pub const EXYNOSAUTOV920_CLUSTER1_WDTRESET_BIT: c_int = 1;
pub const GS_CLUSTER0_NONCPU_OUT: c_uint = 0x1220;
pub const GS_CLUSTER1_NONCPU_OUT: c_uint = 0x1420;
pub const GS_CLUSTER0_NONCPU_INT_EN: c_uint = 0x1244;
pub const GS_CLUSTER1_NONCPU_INT_EN: c_uint = 0x1444;
pub const GS_CLUSTER2_NONCPU_INT_EN: c_uint = 0x1644;
pub const GS_RST_STAT_REG_OFFSET: c_uint = 0x3B44;
pub const EXYNOS990_CLUSTER2_NONCPU_OUT: c_uint = 0x1620;
pub const EXYNOS990_CLUSTER2_NONCPU_INT_EN: c_uint = 0x1644;
pub const EXYNOS990_CLUSTER2_WDTRESET_BIT: c_int = 23;
//
...
// These quirks require that we have a PMU register map
    ...
    let mut tmr_atboot: static int = S3C2410_WATCHDOG_ATBOOT;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c2410_wdt_variant {
    pub disable_reg: c_int,
    pub mask_reset_reg: c_int,
    pub mask_reset_inv: bool,
    pub mask_bit: c_int,
    pub rst_stat_reg: c_int,
    pub rst_stat_bit: c_int,
    pub cnt_en_reg: c_int,
    pub cnt_en_bit: c_int,
    pub quirks: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c2410_wdt {
    pub dev: *mut device,
    pub /: *mut *mut *mut clk bus_clk; / for register interface (PCLK),
    pub /: *mut *mut *mut clk src_clk; / for WDT counter,
    pub reg_base: *mut void __iomem,
    pub count: c_uint,
    pub lock: spinlock_t,
    pub wtcon_save: c_ulong,
    pub wtdat_save: c_ulong,
    pub wdt_device: watchdog_device,
    pub freq_transition: notifier_block,
    pub drv_data: *const s3c2410_wdt_variant,
...
// functions
#[no_mangle]
pub unsafe extern "C" fn s3c2410wdt_get_freq(wdt: *mut s3c2410_wdt) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn s3c2410wdt_max_timeout(wdt: *mut s3c2410_wdt) -> c_uint {
    static inline unsigned int s3c2410wdt_max_timeout(struct s3c2410_wdt *wdt)
    {
    let mut freq: c_ulong = s3c2410wdt_get_freq(wdt);
    const u64 n_max = (u64)(S3C2410_WTCON_PRESCALE_MAX + 1) *
    S3C2410_WTCON_MAXDIV * wdt.max_cnt;
    let mut t_max: u64 = div64_ul(n_max, freq);
    if (t_max > UINT_MAX)
    t_max = UINT_MAX;
    return t_max;
    }
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_disable_wdt_reset(wdt: *mut s3c2410_wdt, mask: bool) -> c_int {
    static int s3c2410wdt_disable_wdt_reset(struct s3c2410_wdt *wdt, bool mask)
    {
    let mut mask_val: u32 = BIT(wdt.drv_data.mask_bit);
    let mut val: u32 = mask ? mask_val : 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_mask_wdt_reset(wdt: *mut s3c2410_wdt, mask: bool) -> c_int {
    static int s3c2410wdt_mask_wdt_reset(struct s3c2410_wdt *wdt, bool mask)
    {
    let mut mask_val: u32 = BIT(wdt.drv_data.mask_bit);
    let mut val_inv: bool = wdt.drv_data.mask_reset_inv;
    let mut val: u32 = (mask ^ val_inv) ? mask_val : 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_enable_counter(wdt: *mut s3c2410_wdt, en: bool) -> c_int {
    static int s3c2410wdt_enable_counter(struct s3c2410_wdt *wdt, bool en)
    {
    let mut mask_val: u32 = BIT(wdt.drv_data.cnt_en_bit);
    let mut val: u32 = en ? mask_val : 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_enable(wdt: *mut s3c2410_wdt, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_mask_dbgack(wdt: *mut s3c2410_wdt) {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_keepalive(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __s3c2410wdt_stop(wdt: *mut s3c2410_wdt) {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_irq(irqno: c_int, param: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn s3c2410wdt_get_bootstatus(wdt: *mut s3c2410_wdt) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT(wdt->drv_data->rst_stat_bit): rst_stat &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&drv_data_exynosautov9_cl0: variant ==) -> else {
    else if (variant == &drv_data_exynosautov9_cl0)
    variant = &drv_data_exynosautov9_cl1;
#[no_mangle]
pub unsafe extern "C" fn if(&drv_data_gs101_cl0: variant ==) -> else {
    else if (variant == &drv_data_gs101_cl0)
    variant = &drv_data_gs101_cl1;
#[no_mangle]
pub unsafe extern "C" fn if(&drv_data_exynosautov920_cl0: variant ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_wdt_disable_action(data: *mut c_void) {
    static void s3c2410wdt_wdt_disable_action(void *data)
    {
    s3c2410wdt_enable(data, false);
    }
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_shutdown(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c2410wdt_resume(dev: *mut device) -> c_int {
