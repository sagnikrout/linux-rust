...
//! Source: drivers/watchdog/atcwdt200_wdt.c
#![no_std]
...
pub const REG_CTRL: c_uint = 0x10;
pub const REG_RESTART: c_uint = 0x14;
pub const REG_WRITE_EN: c_uint = 0x18;
pub const REG_STATUS: c_uint = 0x1C;
// Control Register

pub const CTRL_CLK_SEL_PCLK: c_int = 1;

// Restart Register
pub const RESTART_MAGIC: c_uint = 0xCAFE;
// Write Enable Register
pub const WRITE_EN_MAGIC: c_uint = 0x5AA5;
// Status Register

// The default timeout value in seconds
pub const ATCWDT_TIMEOUT: c_int = 4;
// Define the array size for each timer type
pub const TMR_SZ_RST: c_int = 8;
pub const TMR_SZ_INT_16: c_int = 8;
pub const TMR_SZ_INT_32: c_int = 16;
...
//
    ...
    let mut timeout: static unsigned int = ATCWDT_TIMEOUT;
...
//
    ...
    size = TMR_SZ_RST;
#[no_mangle]
pub unsafe extern "C" fn if(TMR_INT_32: timer_type ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn atcwdt_get_int_timer_type(drv_data: *mut atcwdt_drv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcwdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcwdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcwdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcwdt_enable_clk(drv_data: *mut atcwdt_drv) -> c_int {
    static int atcwdt_enable_clk(struct atcwdt_drv *drv_data)
    {
    struct device *dev = drv_data.wdt_dev.parent;
    unsigned int val;
    int clk_src;
    drv_data.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn atcwdt_calc_max_timeout(drv_data: *mut atcwdt_drv) {
    static void atcwdt_calc_max_timeout(struct atcwdt_drv *drv_data)
    {
    let mut rst_idx: c_uchar = atcwdt_get_index(0xFF, TMR_RST);
...
#[no_mangle]
unsafe extern "C" fn atcwdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcwdt_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcwdt_resume(dev: *mut device) -> c_int {
