...
//! Source: drivers/watchdog/txx9wdt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn txx9wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txx9wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txx9wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txx9wdt_probe(dev: *mut platform_device) -> c_int {
    static int txx9wdt_probe(struct platform_device *dev)
    {
    int ret;
    txx9_imclk = clk_get(core::ptr::null_mut(), "imbus_clk");
    if (IS_ERR(txx9_imclk)) {
    ret = PTR_ERR(txx9_imclk);
    txx9_imclk = core::ptr::null_mut();
    goto exit;
    }
...
#[no_mangle]
unsafe extern "C" fn txx9wdt_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn txx9wdt_shutdown(dev: *mut platform_device) {
