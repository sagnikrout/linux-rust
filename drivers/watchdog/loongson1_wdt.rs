...
//! Source: drivers/watchdog/loongson1_wdt.c
#![no_std]
...
pub const WDT_EN: c_uint = 0x0;
pub const DEFAULT_HEARTBEAT: c_int = 30;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ls1x_wdt_drvdata {
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub clk_rate: c_ulong,
    pub wdt: watchdog_device,
    pub pdata: *const ls1x_wdt_pdata,
}

#[no_mangle]
unsafe extern "C" fn ls1x_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
    ...
    {
    struct ls1x_wdt_drvdata *drvdata = watchdog_get_drvdata(wdt_dev);
    let mut max_hw_heartbeat: c_uint = wdt_dev.max_hw_heartbeat_ms / 1000;
    unsigned int counts;
...
#[no_mangle]
unsafe extern "C" fn ls1x_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ls1x_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
    static int ls1x_wdt_stop(struct watchdog_device *wdt_dev)
    {
    struct ls1x_wdt_drvdata *drvdata = watchdog_get_drvdata(wdt_dev);
    let mut val: u32 = readl(drvdata.base + WDT_EN);
...
#[no_mangle]
unsafe extern "C" fn ls1x_wdt_probe(pdev: *mut platform_device) -> c_int {
    ...
    drvdata.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ls1x_wdt_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ls1x_wdt_suspend(dev: *mut device) -> c_int {
