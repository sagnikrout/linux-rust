...
#[no_mangle]
unsafe extern "C" fn reboot_kthread_fn(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reboot_work_fn(unused: *mut work_struct) {
    static void reboot_work_fn(struct work_struct *unused)
    {
    kthread_run(reboot_kthread_fn, core::ptr::null_mut(), "softdog_reboot");
    }
#[no_mangle]
unsafe extern "C" fn softdog_fire(timer: *mut hrtimer) -> enum hrtimer_restart {
    ...
    if (!soft_reboot_fired && soft_reboot_cmd != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn softdog_pretimeout(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn softdog_ping(w: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softdog_stop(w: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softdog_init() -> int __init {
    static int __init softdog_init(void)
    {
    int ret;
    watchdog_init_timeout(&softdog_dev, soft_margin, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn softdog_exit() -> void __exit {
