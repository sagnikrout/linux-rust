...
//! Source: drivers/watchdog/da9055_wdt.c
#![no_std]
...
pub const DA9055_DEF_TIMEOUT: c_int = 4;
pub const DA9055_TWDMIN: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9055_wdt_data {
...
#[no_mangle]
unsafe extern "C" fn da9055_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
    static int da9055_wdt_start(struct watchdog_device *wdt_dev)
    {
    return da9055_wdt_set_timeout(wdt_dev, wdt_dev.timeout);
    }
#[no_mangle]
unsafe extern "C" fn da9055_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_wdt_probe(pdev: *mut platform_device) -> c_int {
