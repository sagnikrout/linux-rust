...
//! Source: drivers/watchdog/pc87413_wdt.c
#![no_std]
...
pub const SWC_LDN: c_uint = 0x04;
pub const SIOCFG2: c_uint = 0x22	/* Serial IO register */;
pub const WDCTL: c_uint = 0x10	/* Watchdog-Timer-Control-Register */;
pub const WDTO: c_uint = 0x11	/* Watchdog timeout register */;
pub const WDCFG: c_uint = 0x12	/* Watchdog config register */;
pub const IO_DEFAULT: c_uint = 0x2E		/* Address used on Portwell Boards */;
    let mut io: static int = IO_DEFAULT;
    let mut swc_base_addr: static int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn pc87413_select_wdt_out() {
    static inline void pc87413_select_wdt_out(void)
    {
    let mut cr_data: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn pc87413_enable_swc() {
...
#[no_mangle]
unsafe extern "C" fn pc87413_get_swc_base_addr() {
...
#[no_mangle]
pub unsafe extern "C" fn pc87413_swc_bank3() {
...
#[no_mangle]
pub unsafe extern "C" fn pc87413_programm_wdto(pc87413_time: c_char) {
...
// Enable WDEN
#[no_mangle]
pub unsafe extern "C" fn pc87413_enable_wden() {
...
// Enable SW_WD_TREN
#[no_mangle]
pub unsafe extern "C" fn pc87413_enable_sw_wd_tren() {
...
// Disable SW_WD_TREN
#[no_mangle]
pub unsafe extern "C" fn pc87413_disable_sw_wd_tren() {
...
// Enable SW_WD_TRG
#[no_mangle]
pub unsafe extern "C" fn pc87413_enable_sw_wd_trg() {
...
// Disable SW_WD_TRG
#[no_mangle]
pub unsafe extern "C" fn pc87413_disable_sw_wd_trg() {
...
// Enable the watchdog
#[no_mangle]
unsafe extern "C" fn pc87413_enable() {
...
#[no_mangle]
unsafe extern "C" fn pc87413_disable() {
...
#[no_mangle]
unsafe extern "C" fn pc87413_refresh() {
...
//
#[no_mangle]
unsafe extern "C" fn pc87413_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pc87413_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pc87413_status() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pc87413_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn pc87413_exit() -> void __exit {
