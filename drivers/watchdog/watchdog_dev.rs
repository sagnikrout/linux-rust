...
//! Source: drivers/watchdog/watchdog_dev.c
#![no_std]
...
// Reference to watchdog device behind /dev/watchdog
    ...
    let mut open_timeout: static unsigned = CONFIG_WATCHDOG_OPEN_TIMEOUT;
#[no_mangle]
unsafe extern "C" fn watchdog_past_open_deadline(data: *mut watchdog_core_data) -> bool {
    static bool watchdog_past_open_deadline(struct watchdog_core_data *data)
    {
    return ktime_after(ktime_get(), data.open_deadline);
    }
#[no_mangle]
unsafe extern "C" fn watchdog_set_open_deadline(data: *mut watchdog_core_data) {
...
#[no_mangle]
pub unsafe extern "C" fn watchdog_need_worker(wdd: *mut watchdog_device) -> bool {
    static inline bool watchdog_need_worker(struct watchdog_device *wdd)
    {
// All variables in milli-seconds
    let mut hm: c_uint = wdd.max_hw_heartbeat_ms;
    let mut t: c_uint = wdd.timeout * 1000;
//
...
#[no_mangle]
unsafe extern "C" fn watchdog_next_keepalive(wdd: *mut watchdog_device) -> ktime_t {
    static ktime_t watchdog_next_keepalive(struct watchdog_device *wdd)
    {
    struct watchdog_core_data *wd_data = wdd.wd_data;
    let mut timeout_ms: c_uint = wdd.timeout * 1000;
...
#[no_mangle]
pub unsafe extern "C" fn watchdog_update_worker(wdd: *mut watchdog_device) {
    static inline void watchdog_update_worker(struct watchdog_device *wdd)
    {
    struct watchdog_core_data *wd_data = wdd.wd_data;
    if (watchdog_need_worker(wdd)) {
    let mut t: ktime_t = watchdog_next_keepalive(wdd);
    if (t > 0)
...
#[no_mangle]
unsafe extern "C" fn __watchdog_ping(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn watchdog_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn watchdog_worker_should_ping(wd_data: *mut watchdog_core_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn watchdog_ping_work(work: *mut kthread_work) {
...
#[no_mangle]
unsafe extern "C" fn watchdog_timer_expired(timer: *mut hrtimer) -> enum hrtimer_restart {
...
//
#[no_mangle]
unsafe extern "C" fn watchdog_start(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn watchdog_stop(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn watchdog_get_status(wdd: *mut watchdog_device) -> c_uint {
...
// timeleft = wdd->ops->get_timeleft(wdd);
    ...
    struct watchdog_core_data *wd_data = wdd.wd_data;
    let mut last_keepalive_ms: i64 = ktime_ms_delta(ktime_get(), wd_data.last_keepalive);
    let mut last_keepalive: i64 = DIV_ROUND_UP_ULL(last_keepalive_ms, 1000);
...
// nowayout cannot be disabled once set
    ...
    {
    struct watchdog_device *wdd = dev_get_drvdata(dev);
    let mut ret: c_int = watchdog_pretimeout_governor_set(wdd, buf);
    if (!ret)
    ret = count;
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn watchdog_core_data_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn watchdog_cdev_register(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn watchdog_cdev_unregister(wdd: *mut watchdog_device) {
    ...
    watchdog_hrtimer_pretimeout_stop(wdd);
    mutex_lock(&wd_data.lock);
    wd_data.wdd = core::ptr::null_mut();
    wdd.wd_data = core::ptr::null_mut();
    mutex_unlock(&wd_data.lock);
    hrtimer_cancel(&wd_data.timer);
...
//
#[no_mangle]
pub unsafe extern "C" fn watchdog_dev_register(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn watchdog_dev_unregister(wdd: *mut watchdog_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn watchdog_dev_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn watchdog_dev_exit() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn watchdog_dev_suspend(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn watchdog_dev_resume(wdd: *mut watchdog_device) -> c_int {
