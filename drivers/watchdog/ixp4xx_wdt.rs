...
//! Source: drivers/watchdog/ixp4xx_wdt.c
#![no_std]
...
pub const IXP4XX_TIMER_FREQ: c_int = 66666000;
// Registers after the timer registers
pub const IXP4XX_OSWT_OFFSET: c_uint = 0x14  /* Watchdog Timer */;
pub const IXP4XX_OSWE_OFFSET: c_uint = 0x18  /* Watchdog Enable */;
pub const IXP4XX_OSWK_OFFSET: c_uint = 0x1C  /* Watchdog Key */;
pub const IXP4XX_OSST_OFFSET: c_uint = 0x20  /* Timer Status */;
pub const IXP4XX_OSST_TIMER_WDOG_PEND: c_uint = 0x00000008;
pub const IXP4XX_OSST_TIMER_WARM_RESET: c_uint = 0x00000010;
pub const IXP4XX_WDT_KEY: c_uint = 0x0000482E;
pub const IXP4XX_WDT_RESET_ENABLE: c_uint = 0x00000001;
pub const IXP4XX_WDT_IRQ_ENABLE: c_uint = 0x00000002;
pub const IXP4XX_WDT_COUNT_ENABLE: c_uint = 0x00000004;
    static inline
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixp4xx_wdt_dummy(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_wdt_probe(pdev: *mut platform_device) -> c_int {
...
//
    clk = devm_clk_get_enabled(dev.parent, core::ptr::null_mut());
    if (!IS_ERR(clk))
