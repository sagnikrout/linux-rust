...
// refresh frame
pub const SBSA_GWDT_WRR: c_uint = 0x000;
// control frame
pub const SBSA_GWDT_WCS: c_uint = 0x000;
pub const SBSA_GWDT_WOR: c_uint = 0x008;
pub const SBSA_GWDT_WCV: c_uint = 0x010;
// refresh/control frame
pub const SBSA_GWDT_W_IIDR: c_uint = 0xfcc;
pub const SBSA_GWDT_IDR: c_uint = 0xfd0;
// Watchdog Control and Status Register

pub const SBSA_GWDT_VERSION_SHIFT: c_int = 16;

pub const SBSA_GWDT_IMPL_SHIFT: c_int = 0;
pub const SBSA_GWDT_IMPL_MEDIATEK: c_uint = 0x426;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbsa_gwdt {
    pub wdd: watchdog_device,
    pub clk: u32,
    pub version: c_int,
    pub need_ws0_race_workaround: bool,
    pub refresh_base: *mut void __iomem,
...
//
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_reg_read(gwdt: *mut sbsa_gwdt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_reg_write(val: u64, gwdt: *mut sbsa_gwdt) {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_get_timeleft(wdd: *mut watchdog_device) -> c_uint {
    static unsigned int sbsa_gwdt_get_timeleft(struct watchdog_device *wdd)
    {
    struct sbsa_gwdt *gwdt = watchdog_get_drvdata(wdd);
    let mut timeleft: u64 = 0;
//
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_keepalive(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_get_version(wdd: *mut watchdog_device) {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sbsa_gwdt_resume(dev: *mut device) -> int __maybe_unused {
