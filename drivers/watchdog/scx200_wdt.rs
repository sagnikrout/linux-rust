...
//! Source: drivers/watchdog/scx200_wdt.c
#![no_std]
...
pub const W_ENABLE: c_uint = 0x00fa		/* Enable watchdog */;
pub const W_DISABLE: c_uint = 0x0000	/* Disable watchdog */;
// The scaling factor for the timer, this depends on the value of W_ENABLE

#[no_mangle]
unsafe extern "C" fn scx200_wdt_ping() {
...
#[no_mangle]
unsafe extern "C" fn scx200_wdt_update_margin() {
...
#[no_mangle]
unsafe extern "C" fn scx200_wdt_enable() {
...
#[no_mangle]
unsafe extern "C" fn scx200_wdt_disable() {
...
#[no_mangle]
unsafe extern "C" fn scx200_wdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scx200_wdt_release(inode: *mut inode, file: *mut file) -> c_int {
    static int scx200_wdt_release(struct inode *inode, struct file *file)
    {
    if (expect_close != 42)
    pr_warn("watchdog device closed unexpectedly, will not disable the watchdog timer\n");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !nowayout) -> else {
    else if (!nowayout)
    scx200_wdt_disable();
    expect_close = 0;
...
#[no_mangle]
unsafe extern "C" fn scx200_wdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn scx200_wdt_cleanup() -> void __exit {
