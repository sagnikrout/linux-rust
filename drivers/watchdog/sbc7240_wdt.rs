...
//! Source: drivers/watchdog/sbc7240_wdt.c
#![no_std]
...
pub const SBC7240_ENABLE_PORT: c_uint = 0x443;
pub const SBC7240_DISABLE_PORT: c_uint = 0x043;

pub const SBC7240_TIMEOUT: c_int = 30;
pub const SBC7240_MAX_TIMEOUT: c_int = 255;
...
pub const SBC7240_OPEN_STATUS_BIT: c_int = 0;
pub const SBC7240_ENABLED_STATUS_BIT: c_int = 1;
pub const SBC7240_EXPECT_CLOSE_STATUS_BIT: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn wdt_set_timeout(t: c_int) -> c_int {
...
// Whack the dog
#[no_mangle]
pub unsafe extern "C" fn wdt_keepalive() {
...
#[no_mangle]
pub unsafe extern "C" fn copy_to_user()arg: *mut (void __user, _arg: &ident, _arg: sizeof(ident)) -> return {
...
#[no_mangle]
unsafe extern "C" fn sbc7240_wdt_unload() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn sbc7240_wdt_init() -> int __init {
