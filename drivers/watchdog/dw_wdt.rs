...
//! Source: drivers/watchdog/dw_wdt.c
#![no_std]
...
pub const WDOG_CONTROL_REG_OFFSET: c_uint = 0x00;
pub const WDOG_CONTROL_REG_WDT_EN_MASK: c_uint = 0x01;
pub const WDOG_CONTROL_REG_RESP_MODE_MASK: c_uint = 0x02;
pub const WDOG_TIMEOUT_RANGE_REG_OFFSET: c_uint = 0x04;
pub const WDOG_TIMEOUT_RANGE_TOPINIT_SHIFT: c_int = 4;
pub const WDOG_CURRENT_COUNT_REG_OFFSET: c_uint = 0x08;
pub const WDOG_COUNTER_RESTART_REG_OFFSET: c_uint = 0x0c;
pub const WDOG_COUNTER_RESTART_KICK_VALUE: c_uint = 0x76;
pub const WDOG_INTERRUPT_STATUS_REG_OFFSET: c_uint = 0x10;
pub const WDOG_INTERRUPT_CLEAR_REG_OFFSET: c_uint = 0x14;
pub const WDOG_COMP_PARAMS_5_REG_OFFSET: c_uint = 0xe4;
pub const WDOG_COMP_PARAMS_4_REG_OFFSET: c_uint = 0xe8;
pub const WDOG_COMP_PARAMS_3_REG_OFFSET: c_uint = 0xec;
pub const WDOG_COMP_PARAMS_2_REG_OFFSET: c_uint = 0xf0;
pub const WDOG_COMP_PARAMS_1_REG_OFFSET: c_uint = 0xf4;

pub const WDOG_COMP_VERSION_REG_OFFSET: c_uint = 0xf8;
pub const WDOG_COMP_TYPE_REG_OFFSET: c_uint = 0xfc;
// There are sixteen TOPs (timeout periods) that can be set in the watchdog.
pub const DW_WDT_NUM_TOPS: c_int = 16;

pub const DW_WDT_DEFAULT_SECONDS: c_int = 30;
...
pub struct dw_wdt {
    ...
    pub pclk: *mut clk,
    pub rate: c_ulong,
    pub rmod: enum dw_wdt_rmod,
    pub timeouts: [dw_wdt_timeout; DW_WDT_NUM_TOPS],
...
#[no_mangle]
pub unsafe extern "C" fn dw_wdt_is_enabled(dw_wdt: *mut dw_wdt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_update_mode(dw_wdt: *mut dw_wdt, rmod: enum dw_wdt_rmod) {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_get_min_timeout(dw_wdt: *mut dw_wdt) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_get_max_timeout_ms(dw_wdt: *mut dw_wdt) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_get_timeout(dw_wdt: *mut dw_wdt) -> c_uint {
    static unsigned int dw_wdt_get_timeout(struct dw_wdt *dw_wdt)
    {
    let mut top_val: c_int = readl(dw_wdt.regs + WDOG_TIMEOUT_RANGE_REG_OFFSET) & 0xF;
    int idx;
    for (idx = 0; idx < DW_WDT_NUM_TOPS; ++idx) {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_set_timeout(wdd: *mut watchdog_device, top_s: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_set_pretimeout(wdd: *mut watchdog_device, req: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_arm_system_reset(dw_wdt: *mut dw_wdt) {
    static void dw_wdt_arm_system_reset(struct dw_wdt *dw_wdt)
    {
    let mut val: u32 = readl(dw_wdt.regs + WDOG_CONTROL_REG_OFFSET);
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_get_timeleft(wdd: *mut watchdog_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_resume(dev: *mut device) -> c_int {
    static int dw_wdt_resume(struct device *dev)
    {
    struct dw_wdt *dw_wdt = dev_get_drvdata(dev);
    let mut err: c_int = clk_prepare_enable(dw_wdt.clk);
    if (err)
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn dw_wdt_handle_tops(dw_wdt: *mut dw_wdt, tops: *const u32) {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_init_timeouts(dw_wdt: *mut dw_wdt, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_dbgfs_init(dw_wdt: *mut dw_wdt) {
    ...
    dw_wdt.dbgfs_dir = debugfs_create_dir(dev_name(dev), core::ptr::null_mut());
    debugfs_create_regset32("registers", 0444, dw_wdt.dbgfs_dir, regset);
    }
#[no_mangle]
unsafe extern "C" fn dw_wdt_dbgfs_clear(dw_wdt: *mut dw_wdt) {
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_drv_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    dw_wdt.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(dw_wdt.clk))
...
//
    ...
    dw_wdt.rst = devm_reset_control_get_optional_shared(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dw_wdt_drv_remove(pdev: *mut platform_device) {
