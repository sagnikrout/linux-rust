...
//! Source: drivers/watchdog/mixcomwd.c
#![no_std]
...
//
pub const MIXCOM_ID: c_uint = 0x11;
pub const FLASHCOM_ID: c_uint = 0x18;
    static struct {
    int ioport;
    int id;
    } mixcomwd_io_info[] = {
...
#[no_mangle]
unsafe extern "C" fn mixcomwd_ping() {
...
#[no_mangle]
unsafe extern "C" fn mixcomwd_timerfun(unused: *mut timer_list) {
    static void mixcomwd_timerfun(struct timer_list *unused)
    {
    mixcomwd_ping();
...
//
#[no_mangle]
unsafe extern "C" fn mixcomwd_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixcomwd_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn checkcard(port: c_int, card_id: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mixcomwd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mixcomwd_exit() -> void __exit {
