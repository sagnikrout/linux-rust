...
//! Source: drivers/watchdog/iTCO_wdt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iTCO_wdt_private {
    pub wddev: watchdog_device,
// TCO version/generation
    pub iTCO_version: c_uint,
    pub tco_res: *mut resource,
    pub smi_res: *mut resource,
//
// NO_REBOOT flag is Memory-Mapped GCS register bit 5 (TCO version 2),
// or memory-mapped PMC register bit 4 (TCO version 3).
//
    pub gcs_pmc: *mut unsigned long __iomem,
// the PCI-device
    pub pci_dev: *mut pci_dev,
// whether or not the watchdog has been suspended
    pub suspended: bool,
// no reboot API private data
    pub no_reboot_priv: *mut c_void,
// no reboot update function pointer
    pub set): *mut *mut *mut int (update_no_reboot_bit)(void p, bool,
}
...
// module parameters
    ...
    let mut turn_SMI_watchdog_clear_off: static int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn no_reboot_bit(p: *mut iTCO_wdt_private) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn update_no_reboot_bit_def(priv: *mut c_void, set: bool) -> c_int {
    static int update_no_reboot_bit_def(void *priv, bool set)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn update_no_reboot_bit_pci(priv: *mut c_void, set: bool) -> c_int {
    static int update_no_reboot_bit_pci(void *priv, bool set)
    {
    struct iTCO_wdt_private *p = priv;
    let mut val32: u32 = 0, newval32 = 0;
...
#[no_mangle]
unsafe extern "C" fn update_no_reboot_bit_mem(priv: *mut c_void, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_no_reboot_bit_cnt(priv: *mut c_void, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_no_reboot_bit_pmc(priv: *mut c_void, set: bool) -> c_int {
    static int update_no_reboot_bit_pmc(void *priv, bool set)
    {
    struct intel_pmc_dev *pmc = priv;
    let mut bits: u32 = PMC_CFG_NO_REBOOT_EN;
    let mut value: u32 = set ? bits : 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(2: p->iTCO_version >=) -> else {
    else if (p.iTCO_version >= 2)
    p.update_no_reboot_bit = update_no_reboot_bit_mem;
#[no_mangle]
pub unsafe extern "C" fn if(1: p->iTCO_version ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_start(wd_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_stop(wd_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_ping(wd_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_set_timeout(wd_dev: *mut watchdog_device, t: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_get_timeleft(wd_dev: *mut watchdog_device) -> c_uint {
    static unsigned int iTCO_wdt_get_timeleft(struct watchdog_device *wd_dev)
    {
    struct iTCO_wdt_private *p = watchdog_get_drvdata(wd_dev);
    unsigned int val16;
    unsigned char val8;
    let mut time_left: c_uint = 0;
// read the TCO Timer
    if (p.iTCO_version >= 2) {
    val16 = inw(TCO_RLD(p));
    val16 &= 0x3ff;
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_set_running(p: *mut iTCO_wdt_private) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn need_suspend() -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_suspend_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn iTCO_wdt_resume_noirq(dev: *mut device) -> int __maybe_unused {
