...
//! Source: drivers/watchdog/rc32434_wdt.c
#![no_std]
...
// ((2 ^ 32) - 1) / (400MHz / 2) = 21s.
pub const WATCHDOG_TIMEOUT: c_int = 20;
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_set(new_timeout: c_int) -> c_int {
    static int rc32434_wdt_set(int new_timeout)
    {
    let mut max_to: c_int = WTCOMP2SEC((u32)-1);
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_start() {
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_stop() {
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_ping() {
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_remove(pdev: *mut platform_device) {
    static void rc32434_wdt_remove(struct platform_device *pdev)
    {
    misc_deregister(&rc32434_wdt_miscdev);
    }
#[no_mangle]
unsafe extern "C" fn rc32434_wdt_shutdown(pdev: *mut platform_device) {
