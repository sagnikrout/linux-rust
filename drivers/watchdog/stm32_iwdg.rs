...
//! Source: drivers/watchdog/stm32_iwdg.c
#![no_std]
...
pub const DEFAULT_TIMEOUT: c_int = 10;
// IWDG registers
pub const IWDG_KR: c_uint = 0x00 /* Key register */;
pub const IWDG_PR: c_uint = 0x04 /* Prescaler Register */;
pub const IWDG_RLR: c_uint = 0x08 /* ReLoad Register */;
pub const IWDG_SR: c_uint = 0x0C /* Status Register */;
pub const IWDG_WINR: c_uint = 0x10 /* Windows Register */;
pub const IWDG_EWCR: c_uint = 0x14 /* Early Wake-up Register */;
// IWDG_KR register bit mask
pub const KR_KEY_RELOAD: c_uint = 0xAAAA /* reload counter enable */;
pub const KR_KEY_ENABLE: c_uint = 0xCCCC /* peripheral enable */;
pub const KR_KEY_EWA: c_uint = 0x5555 /* write access enable */;
pub const KR_KEY_DWA: c_uint = 0x0000 /* write access disable */;
// IWDG_PR register
pub const PR_SHIFT: c_int = 2;

// IWDG_RLR register values
pub const RLR_MIN: c_uint = 0x2		/* min value recommended */;

// IWDG_SR register bit mask

// set timeout to 100000 us
pub const TIMEOUT_US: c_int = 100000;
pub const SLEEP_US: c_int = 1000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_iwdg_data {
    pub has_pclk: bool,
    pub has_early_wakeup: bool,
    pub max_prescaler: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_iwdg {
    pub wdd: watchdog_device,
    pub data: *const stm32_iwdg_data,
    pub regs: *mut void __iomem,
    pub clk_lsi: *mut clk,
    pub clk_pclk: *mut clk,
    pub rate: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn stm32_iwdg_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_iwdg_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_iwdg_isr(irq: c_int, wdog_arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_clk_disable_unprepare(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stm32_iwdg_probe(pdev: *mut platform_device) -> c_int {
