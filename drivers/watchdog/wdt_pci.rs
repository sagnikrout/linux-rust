...
//! Source: drivers/watchdog/wdt_pci.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_ctr_mode(ctr: c_int, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wdtpci_ctr_load(ctr: c_int, val: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_start() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_stop() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_ping() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_set_heartbeat(t: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_get_status(status: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_get_temperature(temperature: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_temp_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdtpci_temp_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wdtpci_remove_one(pdev: *mut pci_dev) {
