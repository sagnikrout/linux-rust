...
//! Source: drivers/watchdog/octeon-wdt-main.c
#![no_std]
...
pub const WD_BLOCK_NUMBER: c_uint = 0x01;
    static int divisor;
...
#[no_mangle]
unsafe extern "C" fn cpu2core(cpu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_wdt_poke_irq(cpl: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t octeon_wdt_poke_irq(int cpl, void *dev_id)
    {
    let mut cpu: c_int = raw_smp_processor_id();
    let mut core: c_uint = cpu2core(cpu);
...
//
#[no_mangle]
unsafe extern "C" fn octeon_wdt_write_string(str: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_wdt_write_hex(value: u64, digits: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn octeon_wdt_nmi_stage3(reg[32]: u64) {
    void octeon_wdt_nmi_stage3(u64 reg[32])
    {
    u64 i;
    let mut coreid: c_uint = cvmx_get_core_num();
//
// Save status and cause early to get them before any changes
// might happen.
//
    let mut cp0_cause: u64 = read_c0_cause();
    let mut cp0_status: u64 = read_c0_status();
    let mut cp0_error_epc: u64 = read_c0_errorepc();
    let mut cp0_epc: u64 = read_c0_epc();
...
//
    ...
    u64 scr;
    let mut node: c_uint = cvmx_get_node_num();
    let mut lcore: c_uint = cvmx_get_local_core_num();
...
#[no_mangle]
unsafe extern "C" fn octeon_wdt_cpu_to_irq(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_wdt_cpu_pre_down(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_wdt_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_wdt_ping(wdog: *mut watchdog_device __always_unused) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_wdt_calc_parameters(t: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octeon_wdt_start(wdog: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_wdt_stop(wdog: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_wdt_init() -> int __init {
    ...
    divisor = 0x200;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: OCTEON_IS_MODEL(OCTEON_CN78XX)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_wdt_cleanup() -> void __exit {
