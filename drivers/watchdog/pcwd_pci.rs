...
//! Source: drivers/watchdog/pcwd_pci.c
#![no_std]
...
pub const PCI_VENDOR_ID_QUICKLOGIC: c_uint = 0x11e3;

pub const PCI_DEVICE_ID_WATCHDOG_PCIPCWD: c_uint = 0x5030;
...
pub const WD_PCI_WTRP: c_uint = 0x01	/* Watchdog Trip status */;
pub const WD_PCI_HRBT: c_uint = 0x02	/* Watchdog Heartbeat */;
pub const WD_PCI_TTRP: c_uint = 0x04	/* Temperature Trip status */;
pub const WD_PCI_RL2A: c_uint = 0x08	/* Relay 2 Active */;
pub const WD_PCI_RL1A: c_uint = 0x10	/* Relay 1 Active */;
pub const WD_PCI_R2DS: c_uint = 0x40	/* Relay 2 Disable Temperature-trip /;
    reset */
pub const WD_PCI_RLY2: c_uint = 0x80	/* Activate Relay 2 on the board */;
// Port 2 : Control Status #2
pub const WD_PCI_WDIS: c_uint = 0x10	/* Watchdog Disable */;
pub const WD_PCI_ENTP: c_uint = 0x20	/* Enable Temperature Trip Reset */;
pub const WD_PCI_WRSP: c_uint = 0x40	/* Watchdog wrote response */;
pub const WD_PCI_PCMD: c_uint = 0x80	/* PC has sent command */;
// according to documentation max. time to process a command for the pci
// watchdog card is 100 ms, so we give it 150 ms to do it's job
pub const PCI_COMMAND_TIMEOUT: c_int = 150;
// Watchdog's internal commands
pub const CMD_GET_STATUS: c_uint = 0x04;
pub const CMD_GET_FIRMWARE_VERSION: c_uint = 0x08;
pub const CMD_READ_WATCHDOG_TIMEOUT: c_uint = 0x18;
pub const CMD_WRITE_WATCHDOG_TIMEOUT: c_uint = 0x19;
pub const CMD_GET_CLEAR_RESET_COUNT: c_uint = 0x84;
...
//
#[no_mangle]
unsafe extern "C" fn send_command(cmd: c_int, msb: *mut c_int, lsb: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcipcwd_check_temperature_support() {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_get_option_switches() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_show_card_info() {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_start() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_stop() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_keepalive() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_set_heartbeat(t: c_int) -> c_int {
    static int pcipcwd_set_heartbeat(int t)
    {
    let mut t_msb: c_int = t / 256;
    let mut t_lsb: c_int = t % 256;
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_get_status(status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_clear_status() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_get_temperature(temperature: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_get_timeleft(time_left: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_temp_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_temp_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcipcwd_card_exit(pdev: *mut pci_dev) {
