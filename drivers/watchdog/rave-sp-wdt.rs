...
//! Source: drivers/watchdog/rave-sp-wdt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_wdt_variant {
    pub max_timeout: c_uint,
    pub min_timeout: c_uint,
    pub bool): *mut *mut *mut int (configure)(struct watchdog_device ,,
    pub ): *mut *mut int (restart)(struct watchdog_device,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_wdt {
    pub wdd: watchdog_device,
    pub sp: *mut rave_sp,
    pub variant: *const rave_sp_wdt_variant,
    ...
    data, data_size, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_legacy_configure(wdd: *mut watchdog_device, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_rdu_configure(wdd: *mut watchdog_device, on: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_configure(wdd: *mut watchdog_device, on: bool) -> c_int {
    static int rave_sp_wdt_configure(struct watchdog_device *wdd, bool on)
    {
    return to_rave_sp_wdt(wdd).variant.configure(wdd, on);
    }
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_legacy_restart(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_rdu_restart(wdd: *mut watchdog_device) -> c_int {
...
//
    ...
    let mut ret: c_int = sp_wd.variant.restart(&sp_wd.wdd);
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_wdt_probe(pdev: *mut platform_device) -> c_int {
