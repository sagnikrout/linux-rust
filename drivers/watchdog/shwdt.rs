...
//! Source: drivers/watchdog/shwdt.c
#![no_std]
...
//
    let mut clock_division_ratio: static int = WTCSR_CKS_4096;
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_keepalive(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_set_heartbeat(wdt_dev: *mut watchdog_device, t: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_ping(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    return -ENOMEM;
    wdt.dev = &pdev.dev;
    wdt.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(wdt.clk)) {
//
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sh_wdt_exit() -> void __exit {
