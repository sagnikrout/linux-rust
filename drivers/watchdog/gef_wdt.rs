...
//! Source: drivers/watchdog/gef_wdt.c
#![no_std]
...
//
pub const GEF_WDC_ENABLE_SHIFT: c_int = 24;
pub const GEF_WDC_SERVICE_SHIFT: c_int = 26;
pub const GEF_WDC_ENABLED_SHIFT: c_int = 31;
pub const GEF_WDC_ENABLED_TRUE: c_int = 1;
pub const GEF_WDC_ENABLED_FALSE: c_int = 0;
// Flags bits
pub const GEF_WDOG_FLAG_OPENED: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_toggle_wdc(enabled_predicate: c_int, field_shift: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_service() {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_handler_enable() {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_handler_disable() {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_set_timeout(timeout: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_probe(dev: *mut platform_device) -> c_int {
...
// Map devices registers into memory
    ...
    if (gef_wdt_regs == core::ptr::null_mut())
    return -ENOMEM;
    gef_wdt_set_timeout(timeout);
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gef_wdt_exit() -> void __exit {
