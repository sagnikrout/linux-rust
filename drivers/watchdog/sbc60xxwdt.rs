...
//! Source: drivers/watchdog/sbc60xxwdt.c
#![no_std]
...
//
    let mut wdt_stop: static int = 0x45;
...
#[no_mangle]
unsafe extern "C" fn sbc60xxwdt_unload() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn sbc60xxwdt_init() -> int __init {
