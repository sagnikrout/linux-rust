...
//! Source: drivers/watchdog/w83877f_wdt.c
#![no_std]
...
pub const ENABLE_W83877F_PORT: c_uint = 0x3F0;
pub const ENABLE_W83877F: c_uint = 0x87;
pub const DISABLE_W83877F: c_uint = 0xAA;
pub const WDT_PING: c_uint = 0x443;
pub const WDT_REGISTER: c_uint = 0x14;
...
#[no_mangle]
unsafe extern "C" fn w83877f_wdt_unload() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn w83877f_wdt_init() -> int __init {
