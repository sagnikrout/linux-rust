...
//! Source: drivers/watchdog/alim1535_wdt.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ali_keepalive() {
...
//
#[no_mangle]
unsafe extern "C" fn ali_settimer(t: c_int) -> c_int {
    static int ali_settimer(int t)
    {
    if (t < 0)
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(60: t <) -> else {
    else if (t < 60)
    ali_timeout_bits = t|(1 << 6);
#[no_mangle]
pub unsafe extern "C" fn if(3600: t <) -> else {
    else if (t < 3600)
    ali_timeout_bits = (t / 60)|(1 << 7);
#[no_mangle]
pub unsafe extern "C" fn if(18000: t <) -> else {
    else if (t < 18000)
...
//
#[no_mangle]
unsafe extern "C" fn ali_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn ali_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ali_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ali_find_watchdog() -> int __init {
    static int __init ali_find_watchdog(void)
    {
    struct pci_dev *pdev;
    u32 wdog;
// Check for a 1533/1535 series bridge
    pdev = pci_get_device(PCI_VENDOR_ID_AL, 0x1535, core::ptr::null_mut());
    if (pdev == core::ptr::null_mut())
    pdev = pci_get_device(PCI_VENDOR_ID_AL, 0x1533, core::ptr::null_mut());
    if (pdev == core::ptr::null_mut())
    return -ENODEV;
    pci_dev_put(pdev);
// Check for the a 7101 PMU
    pdev = pci_get_device(PCI_VENDOR_ID_AL, 0x7101, core::ptr::null_mut());
    if (pdev == core::ptr::null_mut())
    return -ENODEV;
