...
//! Source: drivers/watchdog/sb_wdog.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn sbwdog_set(wdog: *mut char __iomem, t: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn sbwdog_pet(wdog: *mut char __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn sbwdog_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sbwdog_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sbwdog_interrupt(irq: c_int, addr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sbwdog_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sbwdog_exit() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn platform_wd_setup() {
