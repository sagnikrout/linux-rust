...
//! Source: drivers/watchdog/eurotechwdt.c
#![no_std]
...
//
    let mut io: static int = 0x3f0;
    let mut irq: static int = 10;
    static char *ev = "int";
...
// Some symbolic names
//
pub const WDT_CTRL_REG: c_uint = 0x30;
pub const WDT_OUTPIN_CFG: c_uint = 0xe2;
pub const WDT_EVENT_INT: c_uint = 0x00;
pub const WDT_EVENT_REBOOT: c_uint = 0x08;
pub const WDT_UNIT_SEL: c_uint = 0xf1;
pub const WDT_UNIT_SECS: c_uint = 0x80;
pub const WDT_TIMEOUT_VAL: c_uint = 0xf2;
pub const WDT_TIMER_CFG: c_uint = 0xf3;
...
//
#[no_mangle]
pub unsafe extern "C" fn eurwdt_write_reg(index: u8, data: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn eurwdt_lock_chip() {
    static inline void eurwdt_lock_chip(void)
    {
    outb(0xaa, io);
    }
#[no_mangle]
pub unsafe extern "C" fn eurwdt_unlock_chip() {
...
//
#[no_mangle]
unsafe extern "C" fn eurwdt_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn eurwdt_ping() {
...
//
#[no_mangle]
unsafe extern "C" fn eurwdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn eurwdt_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn eurwdt_exit() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn eurwdt_init() -> int __init {
    static int __init eurwdt_init(void)
    {
    int ret;
    ret = request_irq(irq, eurwdt_interrupt, 0, "eurwdt", core::ptr::null_mut());
    if (ret) {
