...
//! Source: drivers/watchdog/w83977f_wdt.c
#![no_std]
...
pub const IO_INDEX_PORT: c_uint = 0x3F0;
...
//
#[no_mangle]
unsafe extern "C" fn wdt_keepalive() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdt_get_status(status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83977f_wdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn w83977f_wdt_exit() -> void __exit {
