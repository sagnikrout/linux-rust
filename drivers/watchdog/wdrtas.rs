...
//! Source: drivers/watchdog/wdrtas.c
#![no_std]
...
pub const WDRTAS_MAGIC_CHAR: c_int = 42;

    WDIOF_MAGICCLOSE)
    MODULE_AUTHOR("Utz Bacher <utz.bacher@de.ibm.com>");
    MODULE_DESCRIPTION("RTAS watchdog driver");
    MODULE_LICENSE("GPL");
    let mut wdrtas_nowayout: static bool = WATCHDOG_NOWAYOUT;
    let mut wdrtas_miscdev_open: static atomic_t = ATOMIC_INIT(0);
    static char wdrtas_expect_close;
    static int wdrtas_interval;
pub const WDRTAS_THERMAL_SENSOR: c_int = 3;
    static int wdrtas_token_get_sensor_state;
pub const WDRTAS_SURVEILLANCE_IND: c_int = 9000;
    static int wdrtas_token_set_indicator;
pub const WDRTAS_SP_SPI: c_int = 28;
    static int wdrtas_token_get_sp;
    static int wdrtas_token_event_scan;
pub const WDRTAS_DEFAULT_INTERVAL: c_int = 300;
pub const WDRTAS_LOGBUFFER_LEN: c_int = 128;
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_set_interval(interval: c_int) -> c_int {
    static int wdrtas_set_interval(int interval)
    {
    long result;
    let mut print_msg: static int = 10;
// rtas uses minutes
    interval = (interval + 59) / 60;
    result = rtas_call(wdrtas_token_set_indicator, 3, 1, core::ptr::null_mut(),
...
pub const WDRTAS_SP_SPI_LEN: c_int = 4;
//
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_get_interval(fallback_value: c_int) -> c_int {
    ...
    result = rtas_call(wdrtas_token_get_sp, 3, 1, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_timer_start() {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_timer_stop() {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_timer_keepalive() {
    static void wdrtas_timer_keepalive(void)
    {
    long result;
    do {
    result = rtas_call(wdrtas_token_event_scan, 4, 1, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_get_temperature() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_get_status() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_get_boot_status() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_close(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_temp_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_temp_close(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_get_tokens() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_unregister_devs() {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_register_devs() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn wdrtas_exit() -> void __exit {
