...
//! Source: drivers/watchdog/da9062_wdt.c
#![no_std]
...
pub const DA9062_TWDSCALE_DISABLE: c_int = 0;
pub const DA9062_TWDSCALE_MIN: c_int = 1;

pub const DA9062_RESET_PROTECTION_MS: c_int = 300;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9062_watchdog {
    pub hw: *mut da9062,
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_read_timeout(wdt: *mut da9062_watchdog) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_timeout_to_sel(secs: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn da9062_reset_watchdog_timer(wdt: *mut da9062_watchdog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn da9062_wdt_resume(dev: *mut device) -> int __maybe_unused {
