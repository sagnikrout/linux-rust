...
//! Source: drivers/watchdog/aspeed_wdt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_wdt_scu {
    pub compatible: *const c_char,
    pub reset_status_reg: u32,
    pub wdt_reset_mask: u32,
    pub wdt_reset_mask_shift: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_wdt_config {
    pub ext_pulse_width_mask: u32,
    pub irq_shift: u32,
    pub irq_mask: u32,
    pub scu: aspeed_wdt_scu,
    pub num_reset_masks: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_wdt {
    pub wdd: watchdog_device,
    pub base: *mut void __iomem,
    pub ctrl: u32,
    pub cfg: *const aspeed_wdt_config,
}
...
pub const WDT_STATUS: c_uint = 0x00;
pub const WDT_RELOAD_VALUE: c_uint = 0x04;
pub const WDT_RESTART: c_uint = 0x08;
pub const WDT_CTRL: c_uint = 0x0C;

pub const WDT_TIMEOUT_STATUS: c_uint = 0x10;

pub const WDT_CLEAR_TIMEOUT_STATUS: c_uint = 0x14;

pub const WDT_RESET_MASK1: c_uint = 0x1c;
pub const WDT_RESET_MASK2: c_uint = 0x20;
//
...
//
pub const WDT_RESET_WIDTH: c_uint = 0x18;

pub const WDT_RESTART_MAGIC: c_uint = 0x4755;
// 32 bits at 1MHz, in milliseconds
pub const WDT_MAX_TIMEOUT_MS: c_int = 4294967;
pub const WDT_DEFAULT_TIMEOUT: c_int = 30;
pub const WDT_RATE_1MHZ: c_int = 1000000;
    static struct aspeed_wdt *to_aspeed_wdt(struct watchdog_device *wdd)
    {
    return container_of(wdd, struct aspeed_wdt, wdd);
    }
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_enable(wdt: *mut aspeed_wdt, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_ping(wdd: *mut watchdog_device) -> c_int {
    ...
    {
    struct aspeed_wdt *wdt = to_aspeed_wdt(wdd);
    let mut actual: u32 = pretimeout * WDT_RATE_1MHZ;
    let mut s: u32 = wdt.cfg.irq_shift;
    let mut m: u32 = wdt.cfg.irq_mask;
    ...
    let mut scu: aspeed_wdt_scu = wdt.cfg.scu;
...
// access_cs0 shows if cs0 is accessible, hence the reverted bit
    ...
    let mut status: u32 = readl(wdt.base + WDT_TIMEOUT_STATUS);
...
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_irq(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(reset_type, _arg: "soc")) -> else {
    else if (!strcmp(reset_type, "soc"))
    wdt.ctrl |= WDT_CTRL_RESET_MODE_SOC |
    WDT_CTRL_RESET_SYSTEM;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(reset_type, _arg: "system")) -> else {
    else if (!strcmp(reset_type, "system"))
    wdt.ctrl |= WDT_CTRL_RESET_MODE_FULL_CHIP |
    WDT_CTRL_RESET_SYSTEM;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(reset_type, _arg: "none")) -> else {
...
//
    ...
    if (!of_device_is_compatible(np, "aspeed,ast2400-wdt")) {
    u32 reset_mask[5];
    let mut nrstmask: usize = wdt.cfg.num_reset_masks;
    let mut reg: u32 = readl(wdt.base + WDT_RESET_WIDTH);
    int i;
    ...
    let mut max_duration: u32 = wdt.cfg.ext_pulse_width_mask + 1;
...
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aspeed_wdt_exit() -> void __exit {
