...
//! Source: drivers/watchdog/acquirewdt.c
#![no_std]
...
// You must set this - there is no sane way to probe for this board.
    let mut wdt_stop: static int = 0x43;
...
//
#[no_mangle]
unsafe extern "C" fn acq_keepalive() {
...
#[no_mangle]
unsafe extern "C" fn acq_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn acq_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acq_close(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn acq_probe(dev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acq_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn acq_shutdown(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn acq_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acq_exit() -> void __exit {
