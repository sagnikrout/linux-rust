...
//! Source: drivers/watchdog/intel_oc_wdt.c
#![no_std]
...
pub const INTEL_OC_WDT_MIN_TOV: c_int = 1;
pub const INTEL_OC_WDT_MAX_TOV: c_int = 1024;
pub const INTEL_OC_WDT_DEF_TOV: c_int = 60;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_oc_wdt {
    pub wdd: watchdog_device,
    pub ctrl_res: *mut resource,
    pub info: watchdog_info,
    pub locked: bool,
}
...
#[no_mangle]
unsafe extern "C" fn intel_oc_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_oc_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_oc_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_oc_wdt_setup(oc_wdt: *mut intel_oc_wdt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_oc_wdt_probe(pdev: *mut platform_device) -> c_int {
