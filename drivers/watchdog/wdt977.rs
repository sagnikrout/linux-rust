...
//! Source: drivers/watchdog/wdt977.c
#![no_std]
...
pub const IO_INDEX_PORT: c_uint = 0x370		/* on some systems it can be 0x3F0 */;

pub const UNLOCK_DATA: c_uint = 0x87;
pub const LOCK_DATA: c_uint = 0xAA;
pub const DEVICE_REGISTER: c_uint = 0x07;

    let mut timeout: static	int = DEFAULT_TIMEOUT;
...
//
#[no_mangle]
unsafe extern "C" fn wdt977_start() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdt977_stop() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdt977_keepalive() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdt977_set_timeout(t: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdt977_get_status(status: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wdt977_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wdt977_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wd977_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wd977_exit() -> void __exit {
