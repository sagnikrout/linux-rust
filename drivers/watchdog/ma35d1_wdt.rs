...
//! Source: drivers/watchdog/ma35d1_wdt.c
#![no_std]
...
pub const REG_WDT_CTL: c_uint = 0x00;
pub const REG_WDT_RSTCNT: c_uint = 0x08;

pub const WDT_DEFAULT_TIMEOUT: c_int = 32;
pub const RESET_COUNTER: c_uint = 0x00005AA5;
    let mut nowayout: static bool = WATCHDOG_NOWAYOUT;
    static unsigned int timeout;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ma35d1_wdt_dev {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_wait_sync(ma35d1_wdt: *mut ma35d1_wdt_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_probe(pdev: *mut platform_device) -> c_int {
    ...
    ma35d1_wdt.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_wdt_resume(dev: *mut device) -> c_int {
