...
//! Source: drivers/watchdog/nct6694_wdt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nct6694_wdt_data {
    pub wdev: watchdog_device,
    pub dev: *mut device,
    pub nct6694: *mut nct6694,
    pub msg: *mut union nct6694_wdt_msg,
    pub wdev_idx: c_uchar,
}
...
#[no_mangle]
unsafe extern "C" fn nct6694_wdt_start(wdev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_wdt_stop(wdev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_wdt_ping(wdev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_wdt_get_time(wdev: *mut watchdog_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nct6694_wdt_ida_free(d: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_wdt_probe(pdev: *mut platform_device) -> c_int {
