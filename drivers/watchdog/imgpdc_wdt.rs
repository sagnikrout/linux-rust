...
//! Source: drivers/watchdog/imgpdc_wdt.c
#![no_std]
...
// registers
pub const PDC_WDT_SOFT_RESET: c_uint = 0x00;
pub const PDC_WDT_CONFIG: c_uint = 0x04;

pub const PDC_WDT_CONFIG_DELAY_MASK: c_uint = 0x1f;
pub const PDC_WDT_TICKLE1: c_uint = 0x08;
pub const PDC_WDT_TICKLE1_MAGIC: c_uint = 0xabcd1234;
pub const PDC_WDT_TICKLE2: c_uint = 0x0c;
pub const PDC_WDT_TICKLE2_MAGIC: c_uint = 0x4321dcba;
pub const PDC_WDT_TICKLE_STATUS_MASK: c_uint = 0x7;
pub const PDC_WDT_TICKLE_STATUS_SHIFT: c_int = 0;
pub const PDC_WDT_TICKLE_STATUS_HRESET: c_uint = 0x0  /* Hard reset */;
pub const PDC_WDT_TICKLE_STATUS_TIMEOUT: c_uint = 0x1  /* Timeout */;
pub const PDC_WDT_TICKLE_STATUS_TICKLE: c_uint = 0x2  /* Tickled incorrectly */;
pub const PDC_WDT_TICKLE_STATUS_SRESET: c_uint = 0x3  /* Soft reset */;
pub const PDC_WDT_TICKLE_STATUS_USER: c_uint = 0x4  /* User reset */;
// Timeout values are in seconds
pub const PDC_WDT_MIN_TIMEOUT: c_int = 1;
pub const PDC_WDT_DEF_TIMEOUT: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn pdc_wdt_keepalive(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdc_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pdc_wdt_set_timeout(wdt: *mut pdc_wdt_dev) {
    static void __pdc_wdt_set_timeout(struct pdc_wdt_dev *wdt)
    {
    let mut clk_rate: c_ulong = clk_get_rate(wdt.wdt_clk);
    unsigned int val;
...
#[no_mangle]
unsafe extern "C" fn pdc_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdc_wdt_probe(pdev: *mut platform_device) -> c_int {
