...
//! Source: drivers/watchdog/sunxi_wdt.c
#![no_std]
...
pub const WDT_MAX_TIMEOUT: c_int = 16;
pub const WDT_MIN_TIMEOUT: c_int = 1;
pub const WDT_TIMEOUT_MASK: c_uint = 0x0F;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_wdt_reg {
    pub wdt_ctrl: u8,
    pub wdt_cfg: u8,
    pub wdt_mode: u8,
    pub wdt_timeout_shift: u8,
    pub wdt_reset_mask: u8,
    pub wdt_reset_val: u8,
    pub wdt_key_val: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_wdt_dev {
    pub wdt_dev: watchdog_device,
    pub wdt_base: *mut void __iomem,
    pub wdt_regs: *const sunxi_wdt_reg,
}
...
#[no_mangle]
unsafe extern "C" fn sunxi_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_wdt_probe(pdev: *mut platform_device) -> c_int {
