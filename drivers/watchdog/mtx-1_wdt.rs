...
//! Source: drivers/watchdog/mtx-1_wdt.c
#![no_std]
...
//
    ...
    let mut ticks: static int = 100 * HZ;
    static struct {
...
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_trigger(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_reset() {
    static void mtx1_wdt_reset(void)
    {
    ticks = mtx1_wdt_device.default_ticks;
    }
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_start() {
...
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_stop() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_release(inode: *mut inode, file: *mut file) -> c_int {
    ...
    mtx1_wdt_start();
#[no_mangle]
pub unsafe extern "C" fn if(WDIOS_DISABLECARD: value &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_probe(pdev: *mut platform_device) -> c_int {
    static int mtx1_wdt_probe(struct platform_device *pdev)
    {
    int ret;
    mtx1_wdt_device.gpiod = devm_gpiod_get(&pdev.dev,
    core::ptr::null_mut(), GPIOD_OUT_HIGH);
...
#[no_mangle]
unsafe extern "C" fn mtx1_wdt_remove(pdev: *mut platform_device) {
