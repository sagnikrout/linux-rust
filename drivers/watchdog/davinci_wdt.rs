...
//! Source: drivers/watchdog/davinci_wdt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn davinci_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_wdt_get_timeleft(wdd: *mut watchdog_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn davinci_wdt_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!davinci_wdt)
    return -ENOMEM;
    davinci_wdt.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
