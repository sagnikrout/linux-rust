...
//! Source: drivers/watchdog/rn5t618_wdt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rn5t618_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RN5T618_POFFHIS_WDG: val &) -> else {
