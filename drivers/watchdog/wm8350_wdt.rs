...
//! Source: drivers/watchdog/wm8350_wdt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wm8350_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_wdt_probe(pdev: *mut platform_device) -> c_int {
