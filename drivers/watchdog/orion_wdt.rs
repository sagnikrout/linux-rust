...
//! Source: drivers/watchdog/orion_wdt.c
#![no_std]
...
pub const ORION_RSTOUT_MASK_OFFSET: c_uint = 0x20108;
// Internal registers can be configured at any 1 MiB aligned address

//
// Watchdog timer block registers.
//
pub const TIMER_CTRL: c_uint = 0x0000;

pub const TIMER_A370_STATUS: c_uint = 0x0004;

pub const TIMER1_VAL_OFF: c_uint = 0x001c;
pub const WDT_MAX_CYCLE_COUNT: c_uint = 0xffffffff;

pub const WDT_A370_RATIO_SHIFT: c_int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct orion_watchdog_data {
    pub wdt_counter_offset: c_int,
    pub wdt_enable_bit: c_int,
    pub rstout_enable_bit: c_int,
    pub rstout_mask_bit: c_int,
    int (*clock_init)(struct platform_device *,
    pub ): *mut orion_watchdog,
    pub ): *mut *mut int (enabled)(struct orion_watchdog,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct orion_watchdog {
    pub wdt: watchdog_device,
    pub reg: *mut void __iomem,
    pub rstout: *mut void __iomem,
    pub rstout_mask: *mut void __iomem,
    pub clk_rate: c_ulong,
    pub clk: *mut clk,
    pub data: *const orion_watchdog_data,
}
    ...
    {
    int ret;
    dev.clk = clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(dev.clk))
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada375_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada370_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada375_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada370_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_enabled(dev: *mut orion_watchdog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada375_enabled(dev: *mut orion_watchdog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_enabled(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_get_timeleft(wdt_dev: *mut watchdog_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_pre_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn orion_wdt_shutdown(pdev: *mut platform_device) {
