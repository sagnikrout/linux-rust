...
//! Source: drivers/watchdog/simatic-ipc-wdt.c
#![no_std]
...
pub const WD_ENABLE_IOADR: c_uint = 0x62;
pub const WD_TRIGGER_IOADR: c_uint = 0x66;
pub const GPIO_COMMUNITY0_PORT_ID: c_uint = 0xaf;
pub const PAD_CFG_DW0_GPP_A_23: c_uint = 0x4b8;
pub const SAFE_EN_N_427E: c_uint = 0x01;
pub const SAFE_EN_N_227E: c_uint = 0x04;
pub const WD_ENABLED: c_uint = 0x01;
pub const WD_TRIGGERED: c_uint = 0x80;
pub const WD_MACROMODE: c_uint = 0x02;
pub const TIMEOUT_MIN: c_int = 2;
pub const TIMEOUT_DEF: c_int = 64;
pub const TIMEOUT_MAX: c_int = 64;
pub const GP_STATUS_REG_227E: c_uint = 0x404D	/* IO PORT for SAFE_EN_N on 227E */;
...
#[no_mangle]
unsafe extern "C" fn wd_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wd_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wd_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wd_set_timeout(wdd: *mut watchdog_device, t: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wd_secondary_enable(wdtmode: u32) {
...
#[no_mangle]
unsafe extern "C" fn wd_setup(wdtmode: u32) -> c_int {
    static int wd_setup(u32 wdtmode)
    {
    let mut bootstatus: c_uint = 0;
    int timeout_idx;
...
#[no_mangle]
unsafe extern "C" fn simatic_ipc_wdt_probe(pdev: *mut platform_device) -> c_int {
    ...
    res = &mem_resource;
    ret = p2sb_bar(core::ptr::null_mut(), 0, res);
    if (ret)
    return ret;
