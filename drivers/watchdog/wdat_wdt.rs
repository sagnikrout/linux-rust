...
//! Source: drivers/watchdog/wdat_wdt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wdat_instruction {
    pub entry: acpi_wdat_entry,
...
pub struct wdat_wdt {
    ...
    pub period: c_uint,
    pub stopped_in_sleep: bool,
    pub stopped: bool,
    pub instructions: [*mut list_head; MAX_WDAT_ACTIONS],
}
...
pub const WDAT_DEFAULT_TIMEOUT: c_int = 30;
    let mut timeout: static int = WDAT_DEFAULT_TIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn wdat_wdt_enable_reboot(wdat: *mut wdat_wdt) -> c_int {
...
//
    ret = wdat_wdt_run_action(wdat, ACPI_WDAT_SET_REBOOT, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn wdat_wdt_boot_status(wdat: *mut wdat_wdt) {
    static void wdat_wdt_boot_status(struct wdat_wdt *wdat)
    {
    let mut boot_status: u32 = 0;
    int ret;
...
// Clear the boot status in case BIOS did not do it
    ret = wdat_wdt_run_action(wdat, ACPI_WDAT_SET_STATUS, 0, core::ptr::null_mut());
    if (ret && ret != -EOPNOTSUPP)
    dev_err(&wdat.pdev.dev, "Failed to clear boot status\n");
    }
#[no_mangle]
unsafe extern "C" fn wdat_wdt_set_running(wdat: *mut wdat_wdt) {
...
#[no_mangle]
unsafe extern "C" fn wdat_wdt_start(wdd: *mut watchdog_device) -> c_int {
    static int wdat_wdt_start(struct watchdog_device *wdd)
    {
    return wdat_wdt_run_action(to_wdat_wdt(wdd),
    ACPI_WDAT_SET_RUNNING_STATE, 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn wdat_wdt_stop(wdd: *mut watchdog_device) -> c_int {
    static int wdat_wdt_stop(struct watchdog_device *wdd)
    {
    return wdat_wdt_run_action(to_wdat_wdt(wdd),
    ACPI_WDAT_SET_STOPPED_STATE, 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn wdat_wdt_ping(wdd: *mut watchdog_device) -> c_int {
    static int wdat_wdt_ping(struct watchdog_device *wdd)
    {
    return wdat_wdt_run_action(to_wdat_wdt(wdd), ACPI_WDAT_RESET, wdd.timeout, core::ptr::null_mut());
    }
    ...
    ret = wdat_wdt_run_action(wdat, ACPI_WDAT_SET_COUNTDOWN, periods, core::ptr::null_mut());
    if (!ret)
    wdd.timeout = timeout;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn wdat_wdt_get_timeleft(wdd: *mut watchdog_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn wdat_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wdat_wdt_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wdat_wdt_resume_noirq(dev: *mut device) -> c_int {
