...
//! Source: drivers/watchdog/sbc8360.c
#![no_std]
...
pub const SBC8360_ENABLE: c_uint = 0x120;
pub const SBC8360_BASETIME: c_uint = 0x121;
    let mut timeout: static int = 27;
    let mut wd_margin: static int = 0xB;
    let mut wd_multiplier: static int = 2;
...
#[no_mangle]
unsafe extern "C" fn sbc8360_activate() {
...
#[no_mangle]
unsafe extern "C" fn sbc8360_ping() {
...
// stop watchdog
#[no_mangle]
unsafe extern "C" fn sbc8360_stop() {
...
#[no_mangle]
unsafe extern "C" fn sbc8360_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbc8360_close(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbc8360_init() -> int __init {
    static int __init sbc8360_init(void)
    {
    int res;
    let mut mseconds: unsigned long int = 60000;
...
#[no_mangle]
pub unsafe extern "C" fn if(2: wd_multiplier ==) -> else {
    else if (wd_multiplier == 2)
    mseconds = (wd_margin + 1) * 5000;
#[no_mangle]
pub unsafe extern "C" fn if(3: wd_multiplier ==) -> else {
    else if (wd_multiplier == 3)
    mseconds = (wd_margin + 1) * 50000;
#[no_mangle]
pub unsafe extern "C" fn if(4: wd_multiplier ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sbc8360_exit() -> void __exit {
