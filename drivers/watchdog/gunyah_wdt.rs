...
//! Source: drivers/watchdog/gunyah_wdt.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn gunyah_error_remap(gunyah_error: enum gunyah_error) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_start(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_stop(wdd: *mut watchdog_device) -> c_int {
    static int gunyah_wdt_stop(struct watchdog_device *wdd)
    {
    return gunyah_wdt_call(GUNYAH_WDT_CONTROL, WDT_CTRL_DISABLE, 0);
    }
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_get_time_since_last_ping() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_get_timeleft(wdd: *mut watchdog_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gunyah_wdt_resume(dev: *mut device) -> c_int {
