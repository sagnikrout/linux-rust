...
//! Source: drivers/watchdog/sch311x_wdt.c
#![no_std]
...
// Runtime registers
pub const GP60: c_uint = 0x47;
pub const WDT_TIME_OUT: c_uint = 0x65;
pub const WDT_VAL: c_uint = 0x66;
pub const WDT_CFG: c_uint = 0x67;
pub const WDT_CTRL: c_uint = 0x68;
// internal variables
...
//
#[no_mangle]
pub unsafe extern "C" fn sch311x_sio_enter(sio_config_port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_set_timeout(t: c_int) {
    static void sch311x_wdt_set_timeout(int t)
    {
    let mut timeout_unit: c_uchar = 0x80;
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_start() {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_stop() {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_keepalive() {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_set_heartbeat(t: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_get_status(status: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_close(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_shutdown(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sch311x_wdt_exit() -> void __exit {
