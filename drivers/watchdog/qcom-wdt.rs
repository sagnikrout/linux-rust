...
//! Source: drivers/watchdog/qcom-wdt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_wdt_match_data {
    pub offset: *const u32,
    pub pretimeout: bool,
    pub max_tick_count: u32,
    pub wdt_reason_val: u32,
    pub powerunder_reason_val: u32,
}
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_isr(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_start(wdd: *mut watchdog_device) -> c_int {
    static int qcom_wdt_start(struct watchdog_device *wdd)
    {
    struct qcom_wdt *wdt = to_qcom_wdt(wdd);
    let mut bark: c_uint = wdd.timeout - wdd.pretimeout;
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_is_running(wdd: *mut watchdog_device) -> c_int {
...
// Read the EXPIRED_STATUS bit as a fallback
    ...
    wdt.wdd.bootstatus = WDIOF_CARDRESET;
#[no_mangle]
pub unsafe extern "C" fn if(data->powerunder_reason_val: val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qcom_wdt_resume(dev: *mut device) -> int __maybe_unused {
