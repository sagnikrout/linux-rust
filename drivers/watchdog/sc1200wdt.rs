...
//! Source: drivers/watchdog/sc1200wdt.c
#![no_std]
...
pub const FER1: c_uint = 0x00	/* Function enable register 1 */;
pub const FER2: c_uint = 0x01	/* Function enable register 2 */;
pub const PMC1: c_uint = 0x02	/* Power Management Ctrl 1 */;
pub const PMC2: c_uint = 0x03	/* Power Management Ctrl 2 */;
pub const PMC3: c_uint = 0x04	/* Power Management Ctrl 3 */;
pub const WDTO: c_uint = 0x05	/* Watchdog timeout register */;
pub const WDCF: c_uint = 0x06	/* Watchdog config register */;
pub const WDST: c_uint = 0x07	/* Watchdog status register */;
// WDCF bitfields - which devices assert WDO
pub const KBC_IRQ: c_uint = 0x01	/* Keyboard Controller */;
pub const MSE_IRQ: c_uint = 0x02	/* Mouse */;
pub const UART1_IRQ: c_uint = 0x03	/* Serial0 */;
pub const UART2_IRQ: c_uint = 0x04	/* Serial1 */;
// 5 -7 are reserved
    let mut timeout: static int = 1;
    let mut io: static int = -1;
    static int io_len = 2;		/* for non plug and play */
    static unsigned long open_flag;
    static char expect_close;
    static DEFINE_SPINLOCK(sc1200wdt_lock);	/* io port access serialisation */

    let mut isapnp: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_read_data(index: c_uchar, data: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_start() {
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_stop() {
...
#[no_mangle]
pub unsafe extern "C" fn sc1200wdt_status() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_probe() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn scl200wdt_pnp_remove(dev: *mut pnp_dev) {
    static void scl200wdt_pnp_remove(struct pnp_dev *dev)
    {
    if (wdt_dev) {
    release_region(io, io_len);
    wdt_dev = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sc1200wdt_exit() -> void __exit {
