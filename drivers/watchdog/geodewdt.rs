...
//! Source: drivers/watchdog/geodewdt.c
#![no_std]
...
pub const GEODEWDT_HZ: c_int = 500;
pub const GEODEWDT_SCALE: c_int = 6;
pub const GEODEWDT_MAX_SECONDS: c_int = 131;
pub const WDT_FLAGS_OPEN: c_int = 1;
pub const WDT_FLAGS_ORPHAN: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn geodewdt_ping() {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_disable() {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_set_heartbeat(val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_probe(dev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_remove(dev: *mut platform_device) {
    static void geodewdt_remove(struct platform_device *dev)
    {
    misc_deregister(&geodewdt_miscdev);
    }
#[no_mangle]
unsafe extern "C" fn geodewdt_shutdown(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn geodewdt_exit() -> void __exit {
