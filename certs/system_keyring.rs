...
//
#[no_mangle]
pub unsafe extern "C" fn add_to_secondary_keyring(source: *const c_char, data: *const c_void, len: usize) -> void __init {
    ...
    "asymmetric",
    core::ptr::null_mut(), data, len, perm,
...
#[no_mangle]
pub unsafe extern "C" fn set_machine_trusted_keys(keyring: *mut key) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn system_trusted_keyring_init() -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn load_module_cert(keyring: *mut key) -> __init int {
...
//
#[no_mangle]
unsafe extern "C" fn load_system_certificate_list() -> __init int {
...
// The data should be detached - so we need to supply it.
    ...
    trusted_keys = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn set_platform_trusted_keys(keyring: *mut key) -> void __init {
