...
pub static linux_proc_banner: &[u8] = b"linux";
...
// They are compiled with  first, and without  later.
//
pub static mut init_uts_ns: usize = 0;
pub static mut linux_banner: usize = 0;
