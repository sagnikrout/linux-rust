...
//! Source: include/drm/intel/i915_hdcp_interface.h
#![no_std]
...
//
    ...
    pub ake_data): *mut hdcp2_ake_init,
// rx_cert,
// ek_pub_km,
    pub msg_sz): *mut usize,
    pub rx_hprime): *mut hdcp2_ake_send_hprime,
// pairing_info);
    pub lc_init_data): *mut hdcp2_lc_init,
    pub rx_lprime): *mut hdcp2_lc_send_lprime,
    pub ske_data): *mut hdcp2_ske_send_eks,
// rep_topology,
// rep_send_ack);
    pub stream_ready): *mut hdcp2_rep_stream_ready,
    pub data): *mut hdcp_port_data,
    pub data): *mut hdcp_port_data,
}
...
pub const HDCP_API_VERSION: c_uint = 0x00010000;
pub const HDCP_M_LEN: c_int = 16;
pub const HDCP_KH_LEN: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdcp_cmd_header {
    pub api_version: u32,
    pub command_id: u32,
    pub status: fw_hdcp_status,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdcp_cmd_no_data {
    pub header: hdcp_cmd_header,
    pub __packed: },
// Uniquely identifies the hdcp port being addressed for a given command.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdcp_port_id {
    pub integrated_port_type: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_initiate_hdcp2_session_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub /: *mut *mut u8 protocol; / for HDMI vs DP,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_initiate_hdcp2_session_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_close_session_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_close_session_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_verify_receiver_cert_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_verify_receiver_cert_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub km_stored: u8,
    pub reserved: [u8; 3],
    pub ekm_buff: encrypted_buff,
    pub __packed: },
// HECI struct for verification of Rx's Hprime in a HDCP Tx session
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_ake_send_hprime_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_ake_send_hprime_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_ake_send_pairing_info_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_ake_send_pairing_info_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_init_locality_check_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_init_locality_check_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_validate_locality_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_validate_locality_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_get_session_key_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_get_session_key_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub e_dkey_ks: [u8; HDCP_2_2_E_DKEY_KS_LEN],
    pub r_iv: [u8; HDCP_2_2_RIV_LEN],
    pub __packed: },
// HECI struct for the Tx enable authentication command
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_enable_auth_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub stream_type: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_enable_auth_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_verify_repeater_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_verify_repeater_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub content_type_supported: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_repeater_auth_stream_req_in {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub seq_num_m: [u8; HDCP_2_2_SEQ_NUM_LEN],
    pub m_prime: [u8; HDCP_2_2_MPRIME_LEN],
    pub k: __be16,
    pub streams: [hdcp2_streamid_type; ],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wired_cmd_repeater_auth_stream_req_out {
    pub header: hdcp_cmd_header,
    pub port: hdcp_port_id,
    pub __packed: },
