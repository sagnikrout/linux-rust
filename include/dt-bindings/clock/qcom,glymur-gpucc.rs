...
//! Source: include/dt-bindings/clock/qcom,glymur-gpucc.h
#![no_std]
...
pub const GPU_CC_GPU_SMMU_VOTE_CLK: c_int = 12;
pub const GPU_CC_GX_ACCU_SHIFT_CLK: c_int = 13;
pub const GPU_CC_GX_ACD_AHB_FF_CLK: c_int = 14;
pub const GPU_CC_GX_AHB_FF_CLK: c_int = 15;
pub const GPU_CC_GX_GMU_CLK: c_int = 16;
pub const GPU_CC_GX_RCG_AHB_FF_CLK: c_int = 17;
