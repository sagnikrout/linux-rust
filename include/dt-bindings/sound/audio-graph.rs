...
//! Source: include/dt-bindings/sound/audio-graph.h
#![no_std]
...
// SND_SOC_TRIGGER_DAI>;
//
pub const SND_SOC_TRIGGER_LINK: c_int = 0;
pub const SND_SOC_TRIGGER_COMPONENT: c_int = 1;
pub const SND_SOC_TRIGGER_DAI: c_int = 2;
