...
//! Source: include/dt-bindings/regulator/active-semi,8945a-regulator.h
#![no_std]
...
// mode.
//
pub const ACT8945A_REGULATOR_MODE_FIXED: c_int = 1;
pub const ACT8945A_REGULATOR_MODE_NORMAL: c_int = 2;
pub const ACT8945A_REGULATOR_MODE_LOWPOWER: c_int = 3;
