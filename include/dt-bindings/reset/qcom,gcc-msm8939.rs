...
//! Source: include/dt-bindings/reset/qcom,gcc-msm8939.h
#![no_std]
...
pub const GCC_BLSP1_UART3_BCR: c_int = 90;
pub const GCC_CAMSS_CSI2_BCR: c_int = 91;
pub const GCC_CAMSS_CSI2PHY_BCR: c_int = 92;
pub const GCC_CAMSS_CSI2RDI_BCR: c_int = 93;
pub const GCC_CAMSS_CSI2PIX_BCR: c_int = 94;
pub const GCC_USB_FS_BCR: c_int = 95;
pub const GCC_BLSP1_QUP4_SPI_APPS_CBCR: c_int = 96;
pub const GCC_CAMSS_MCLK2_BCR: c_int = 97;
pub const GCC_CPP_TBU_BCR: c_int = 98;
pub const GCC_MDP_RT_TBU_BCR: c_int = 99;
