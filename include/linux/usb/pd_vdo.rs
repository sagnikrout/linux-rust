...
//! Source: include/linux/usb/pd_vdo.h
#![no_std]
...
//
pub const VDO_MAX_OBJECTS: c_int = 6;
...
pub const CMDT_INIT: c_int = 0;
pub const CMDT_RSP_ACK: c_int = 1;
pub const CMDT_RSP_NAK: c_int = 2;
pub const CMDT_RSP_BUSY: c_int = 3;
// reserved for SVDM ... for Google UVDM

pub const CMD_DISCOVER_IDENT: c_int = 1;
pub const CMD_DISCOVER_SVID: c_int = 2;
pub const CMD_DISCOVER_MODES: c_int = 3;
pub const CMD_ENTER_MODE: c_int = 4;
pub const CMD_EXIT_MODE: c_int = 5;
pub const CMD_ATTENTION: c_int = 6;
...
// [5] :: Cable VDO 2
//
pub const VDO_INDEX_HDR: c_int = 0;
pub const VDO_INDEX_IDH: c_int = 1;
pub const VDO_INDEX_CSTAT: c_int = 2;
pub const VDO_INDEX_CABLE: c_int = 3;
pub const VDO_INDEX_PRODUCT: c_int = 3;
pub const VDO_INDEX_AMA: c_int = 4;
pub const VDO_INDEX_CABLE_1: c_int = 4;
pub const VDO_INDEX_CABLE_2: c_int = 5;
//
...
// USB-IF SIDs
pub const USB_SID_PD: c_uint = 0xff00 /* power delivery */;
pub const USB_SID_DISPLAYPORT: c_uint = 0xff01;
pub const USB_SID_MHL: c_uint = 0xff02	/* Mobile High-Definition Link */;
// VDM command timeouts (in ms)
pub const PD_T_VDM_UNSTRUCTURED: c_int = 500;
pub const PD_T_VDM_BUSY: c_int = 100;
pub const PD_T_VDM_WAIT_MODE_E: c_int = 100;
pub const PD_T_VDM_SNDR_RSP: c_int = 30;
pub const PD_T_VDM_E_MODE: c_int = 25;
pub const PD_T_VDM_RCVR_RSP: c_int = 15;
