...
//! Source: include/linux/cpuhotplug.h
#![no_std]
...
//
extern "C" {
    pub fn __cpuhp_setup_state(_arg: state, _arg: name, _arg: true, _arg: startup, _arg: teardown, _arg: false) -> return;
}
//
...
//
extern "C" {
    pub fn __cpuhp_state_add_instance(_arg: state, _arg: node, _arg: true) -> return;
}
//
...
//
extern "C" {
    pub fn __cpuhp_state_add_instance(_arg: state, _arg: node, _arg: false) -> return;
}
//
...
//
extern "C" {
    pub fn __cpuhp_state_add_instance_cpuslocked(_arg: state, _arg: node, _arg: false) -> return;
}
extern "C" {
...
//
extern "C" {
    pub fn __cpuhp_state_remove_instance(_arg: state, _arg: node, _arg: true) -> return;
}
//
...
//
extern "C" {
    pub fn __cpuhp_state_remove_instance(_arg: state, _arg: node, _arg: false) -> return;
}
...
extern "C" {
    pub fn arch_cpuhp_cleanup_kick_cpu(cpu: c_uint);
}
extern "C" {
    pub fn arch_cpuhp_kick_ap_alive(cpu: c_uint, tidle: *mut task_struct) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn arch_cpuhp_cleanup_dead_cpu(cpu: c_uint);
}
