...
//! Source: include/linux/pinctrl/pinconf-generic.h
#![no_std]
...
//
extern "C" {
    pub fn PIN_CONF_PACKED(_arg: param, _arg: argument) -> return;
}
...
pub struct pin_config_item {
    ...
    pub display: *const *const c_char,
    pub format: *const *const c_char,
    pub has_arg: bool,
...
pub struct pinconf_generic_params {
    pub property: *const *const c_char,
    pub param: pin_config_param,
