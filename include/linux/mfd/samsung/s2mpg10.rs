...
//! Source: include/linux/mfd/samsung/s2mpg10.h
#![no_std]
...
pub const S2MPG10_PCTRLSEL_PWREN: c_uint = 0x1 /* PWREN pin */;
pub const S2MPG10_PCTRLSEL_PWREN_TRG: c_uint = 0x2 /* PWREN_TRG bit in MIMICKING_CTRL */;
pub const S2MPG10_PCTRLSEL_PWREN_MIF: c_uint = 0x3 /* PWREN_MIF pin */;
pub const S2MPG10_PCTRLSEL_PWREN_MIF_TRG: c_uint = 0x4 /* PWREN_MIF_TRG bit in MIMICKING_CTRL */;
pub const S2MPG10_PCTRLSEL_AP_ACTIVE_N: c_uint = 0x5 /* ~AP_ACTIVE_N pin */;
pub const S2MPG10_PCTRLSEL_AP_ACTIVE_N_TRG: c_uint = 0x6 /* ~AP_ACTIVE_N_TRG bit in MIMICKING_CTRL */;
pub const S2MPG10_PCTRLSEL_CPUCL1_EN: c_uint = 0x7 /* CPUCL1_EN pin */;
pub const S2MPG10_PCTRLSEL_CPUCL1_EN2: c_uint = 0x8 /* CPUCL1_EN & PWREN pins */;
pub const S2MPG10_PCTRLSEL_CPUCL2_EN: c_uint = 0x9 /* CPUCL2_EN pin */;
pub const S2MPG10_PCTRLSEL_CPUCL2_EN2: c_uint = 0xa /* CPUCL2_E2 & PWREN pins */;
pub const S2MPG10_PCTRLSEL_TPU_EN: c_uint = 0xb /* TPU_EN pin */;
pub const S2MPG10_PCTRLSEL_TPU_EN2: c_uint = 0xc /* TPU_EN & ~AP_ACTIVE_N pins */;
pub const S2MPG10_PCTRLSEL_TCXO_ON: c_uint = 0xd /* TCXO_ON pin */;
pub const S2MPG10_PCTRLSEL_TCXO_ON2: c_uint = 0xe /* TCXO_ON & ~AP_ACTIVE_N pins */;
// For S2MPG10_PMIC_PCTRLSELx of LDO20M
pub const S2MPG10_PCTRLSEL_LDO20M_EN2: c_uint = 0x1 /* VLDO20M_EN & LDO20M_SFR */;
pub const S2MPG10_PCTRLSEL_LDO20M_EN: c_uint = 0x2 /* VLDO20M_EN pin */;
pub const S2MPG10_PCTRLSEL_LDO20M_SFR: c_uint = 0x3 /* LDO20M_SFR bit in LDO_CTRL1 register */;
// Meter registers (type 0xa00)
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum s2mpg10_meter_reg {
    S2MPG10_METER_CTRL1,
    S2MPG10_METER_CTRL2,
    S2MPG10_METER_CTRL3,
    S2MPG10_METER_CTRL4,
