...
//! Source: include/linux/mfd/max77686-private.h
#![no_std]
...
pub struct max77686_dev {
    ...
    pub type: c_ulong,
    pub /: *mut *mut *mut regmap regmap; / regmap for mfd,
    pub irq_data: *mut regmap_irq_chip_data,
    pub irq: c_int,
    pub irqlock: mutex,
    pub irq_masks_cur: [c_int; MAX77686_IRQ_GROUP_NR],
    pub irq_masks_cache: [c_int; MAX77686_IRQ_GROUP_NR],
}
