...
//
    pub ): *mut *mut *mut int (attach)(struct dma_buf , struct dma_buf_attachment,
//
// @detach:
//
...
// This callback is optional.
//
    pub ): *mut *mut *mut void (detach)(struct dma_buf , struct dma_buf_attachment,
//
// @pin:
//
...
//
    pub attach): *mut *mut int (pin)(struct dma_buf_attachment,
//
// @unpin:
//
...
// This callback is optional.
//
    pub attach): *mut *mut void (unpin)(struct dma_buf_attachment,
//
// @map_dma_buf:
//
...
// mandatory.
//
    pub ): *mut *mut void (release)(struct dma_buf,
//
// @begin_cpu_access:
//
...
//
    pub dma_data_direction): *mut *mut *mut int (begin_cpu_access)(struct dma_buf , enum,
//
// @end_cpu_access:
//
...
// to be restarted.
//
    pub dma_data_direction): *mut *mut *mut int (end_cpu_access)(struct dma_buf , enum,
//
// @mmap:
//
...
//
    pub vma): *mut *mut *mut int (mmap)(struct dma_buf , struct vm_area_struct,
    pub map): *mut *mut *mut int (vmap)(struct dma_buf dmabuf, struct iosys_map,
    pub map): *mut *mut *mut void (vunmap)(struct dma_buf dmabuf, struct iosys_map,
}
...
// required behavior.
//
    pub attach): *mut *mut void (invalidate_mappings)(struct dma_buf_attachment,
}
...
//
extern "C" {
    pub fn dma_buf_pin(attach: *mut dma_buf_attachment) -> c_int;
}
extern "C" {
    pub fn dma_buf_unpin(attach: *mut dma_buf_attachment);
}
extern "C" {
    pub fn dma_buf_fd(dmabuf: *mut dma_buf, flags: c_int) -> c_int;
}
extern "C" {
    pub fn dma_buf_fd_install(dmabuf: *mut dma_buf, fd: c_int);
}
extern "C" {
...
extern "C" {
    pub fn dma_buf_vmap(dmabuf: *mut dma_buf, map: *mut iosys_map) -> c_int;
}
extern "C" {
    pub fn dma_buf_vunmap(dmabuf: *mut dma_buf, map: *mut iosys_map);
}
extern "C" {
    pub fn dma_buf_vmap_unlocked(dmabuf: *mut dma_buf, map: *mut iosys_map) -> c_int;
}
extern "C" {
