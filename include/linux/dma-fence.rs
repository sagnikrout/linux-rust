...
//! Source: include/linux/dma-fence.h
#![no_std]
...
//
    pub fence): *const *const *const char  (get_driver_name)(struct dma_fence,
//
// @get_timeline_name:
//
...
// This callback is mandatory.
//
    pub fence): *const *const *const char  (get_timeline_name)(struct dma_fence,
//
// @enable_signaling:
//
...
//
    pub fence): *mut *mut bool (enable_signaling)(struct dma_fence,
//
// @signaled:
//
...
//
    pub fence): *mut *mut bool (signaled)(struct dma_fence,
//
// @wait:
//
...
//
    pub timeout): bool intr, signed long,
//
// @release:
//
...
//
    pub fence): *mut *mut void (release)(struct dma_fence,
//
// @set_deadline:
//
...
// This callback is optional.
//
    pub deadline): *mut *mut *mut void (set_deadline)(struct dma_fence fence, ktime_t,
}
...
//
extern "C" {
    pub fn rcu_pointer_handoff(_arg: fence) -> return;
}
//
...
extern "C" {
    pub fn dma_fence_begin_signalling() -> bool;
}
extern "C" {
    pub fn dma_fence_end_signalling(cookie: bool);
}
extern "C" {
    pub fn __dma_fence_might_wait();
}
...
//
extern "C" {
    pub fn test_bit(_arg: DMA_FENCE_FLAG_SIGNALED_BIT, _arg: &fence->flags) -> return;
}
//
...
//
extern "C" {
    pub fn __dma_fence_is_later(_arg: f1, _arg: f1->seqno, _arg: f2->seqno) -> return;
}
//
...
extern "C" {
    pub fn dma_fence_context_alloc(num: unsigned) -> u64;
}
//
...
//
extern "C" {
    pub fn dma_fence_is_array(dma_fence_is_chain(fence: fence) ||) -> return;
}
