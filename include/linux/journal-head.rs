...
// Macro flag: #define JOURNAL_HEAD_H_INCLUDED
...
//
    pub b_jlist: unsigned,
//
// This flag signals the buffer has been modified by
// the currently running transaction
// [b_state_lock]
//
    pub b_modified: unsigned,
//
// Copy of the buffer data frozen for writing to the log.
// [b_state_lock]
//
    pub b_frozen_data: *mut c_char,
//
// Pointer to a saved copy of the buffer containing no uncommitted
// deallocation references, so that allocations can avoid overwriting
// uncommitted deletes. [b_state_lock]
//
    pub b_committed_data: *mut c_char,
//
...
//
    pub b_tprev: *mut *mut journal_head b_tnext,,
//
...
// [j_list_lock]
//
    pub b_cpprev: *mut *mut journal_head b_cpnext,,
// Trigger type
