...
pub const RCU_SEQ_CTR_SHIFT: c_int = 2;
...
extern "C" {
    pub fn get_completed_synchronize_rcu() -> c_ulong;
}
extern "C" {
...
pub const NUM_ACTIVE_RCU_POLL_OLDSTATE: c_int = 2;
//
...
extern "C" {
    pub fn call_rcu_hurry(head: *mut rcu_head, func: rcu_callback_t);
}
...
extern "C" {
    pub fn rcu_sched_clock_irq(user: c_int);
}
...
extern "C" {
    pub fn rcu_nocb_cpu_offload(cpu: c_int) -> c_int;
}
extern "C" {
    pub fn rcu_nocb_cpu_deoffload(cpu: c_int) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn call_rcu_tasks(head: *mut rcu_head, func: rcu_callback_t);
}
extern "C" {
    pub fn synchronize_rcu_tasks();
}
extern "C" {
    pub fn rcu_tasks_torture_stats_print(tt: *mut c_char, tf: *mut c_char);
}
...
extern "C" {
    pub fn rcu_tasks_rude_torture_stats_print(tt: *mut c_char, tf: *mut c_char);
}
...
extern "C" {
    pub fn init_rcu_head(head: *mut rcu_head);
}
extern "C" {
    pub fn destroy_rcu_head(head: *mut rcu_head);
}
extern "C" {
    pub fn init_rcu_head_on_stack(head: *mut rcu_head);
}
extern "C" {
    pub fn destroy_rcu_head_on_stack(head: *mut rcu_head);
}

extern "C" {
    pub fn rcu_lockdep_current_cpu_online() -> bool;
}

extern "C" {
    pub fn debug_lockdep_rcu_enabled() -> c_int;
}
extern "C" {
    pub fn rcu_read_lock_held() -> c_int;
}
extern "C" {
    pub fn rcu_read_lock_bh_held() -> c_int;
}
extern "C" {
    pub fn rcu_read_lock_sched_held() -> c_int;
}
extern "C" {
    pub fn rcu_read_lock_any_held() -> c_int;
}
...
//
extern "C" {
    pub fn kvfree_call_rcu(head: *mut kvfree_rcu_head, ptr: *mut c_void);
}
extern "C" {
    pub fn kfree_call_rcu_nolock(head: *mut kvfree_rcu_head, ptr: *mut c_void);
}
//
