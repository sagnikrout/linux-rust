...
//! Source: include/linux/oid_registry.h
#![no_std]
...
extern "C" {
    pub fn look_up_OID(data: *const c_void, datasize: usize) -> OID;
}
extern "C" {
    pub fn parse_OID(data: *const c_void, datasize: usize, oid: *mut OID) -> c_int;
}
extern "C" {
    pub fn sprint_oid(: *const c_void, _arg: usize, : *mut c_char, _arg: usize) -> c_int;
}
