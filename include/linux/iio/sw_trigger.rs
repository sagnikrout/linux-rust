...
//! Source: include/linux/iio/sw_trigger.h
#![no_std]
...
pub struct iio_sw_trigger_ops {
    pub ): *const *const *const iio_sw_trigger (probe)(char,
    pub ): *mut *mut int (remove)(struct iio_sw_trigger,
}

extern "C" {
    pub fn iio_register_sw_trigger_type(tt: *mut iio_sw_trigger_type) -> c_int;
}
extern "C" {
    pub fn iio_unregister_sw_trigger_type(tt: *mut iio_sw_trigger_type);
}
extern "C" {
    pub fn iio_sw_trigger_destroy(: *mut iio_sw_trigger);
}
