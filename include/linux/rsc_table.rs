...
//! Source: include/linux/rsc_table.h
#![no_std]
...
//
    pub ret: int i,,
    pub {: for (i = 0; i < table->num; i++),
    pub table->offset[i]: u32 offset =,
    pub hdr: *mut fw_rsc_hdr,
    pub rsc_offset: int avail,,
    pub rsc: *mut c_void,
    pub truncated\n"): dev_err(dev, "rsc table is,
    pub -EINVAL: return,
    pub offset: *mut *mut hdr = (void )table +,
    pub sizeof(*hdr): *mut avail = table_sz - offset -,
    pub sizeof(*hdr): *mut rsc_offset = offset +,
    pub sizeof(*hdr): *mut *mut rsc = (void )hdr +,
    pub data): ret = cb(hdr->type, rsc, rsc_offset, avail,,
    pub ret: return,
    pub 0: return,
