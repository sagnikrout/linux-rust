...
//! Source: include/linux/turris-omnia-mcu-interface.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum omnia_flashing_commands_e {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum omnia_ext_sts_dword_e {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum omnia_cmd_led_state_e {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum omnia_cmd_usb_ovc_prot_e {
...
extern "C" {
    pub fn omnia_cmd_write_read(_arg: client, _arg: cmd, _arg: len, _arg: NULL, _arg: 0) -> return;
}
extern "C" {
    pub fn omnia_cmd_write(_arg: client, _arg: buf, _arg: sizeof(buf)) -> return;
}
extern "C" {
    pub fn omnia_cmd_write(_arg: client, _arg: buf, _arg: sizeof(buf)) -> return;
}
...
extern "C" {
    pub fn omnia_cmd_write_read(_arg: client, _arg: &cmd, _arg: 1, _arg: reply, _arg: len) -> return;
}
...
extern "C" {
    pub fn omnia_cmd_read(_arg: client, _arg: cmd, _arg: reply, _arg: *mut sizeof(reply)) -> return;
}
