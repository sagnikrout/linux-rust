...
//! Source: include/linux/nvme-fc-driver.h
#![no_std]
...
//
pub const _NVME_FC_DRIVER_H: c_int = 1;
...
pub struct nvmefc_ls_req {
    pub rqstaddr: *mut c_void,
    pub rqstdma: dma_addr_t,
    pub rqstlen: u32,
    pub rspaddr: *mut c_void,
    pub rspdma: dma_addr_t,
    pub rsplen: u32,
    pub timeout: u32,
    pub private: *mut c_void,
    pub status): *mut *mut *mut void (done)(struct nvmefc_ls_req req, int,
    pub /: *mut *mut } __aligned(sizeof(u64)); / alignment for other things alloc'd with,
//
...
pub struct nvmefc_ls_rsp {
    pub rspbuf: *mut c_void,
    pub rspdma: dma_addr_t,
    pub rsplen: u16,
    pub rsp): *mut *mut void (done)(struct nvmefc_ls_rsp,
    pub /: *mut *mut *mut void nvme_fc_private; / LLDD is not to access !!,
}
...
pub struct nvmefc_fcp_req {
    pub cmdaddr: *mut c_void,
    pub rspaddr: *mut c_void,
    pub cmddma: dma_addr_t,
    pub rspdma: dma_addr_t,
    pub cmdlen: u16,
    pub rsplen: u16,
    pub payload_length: u32,
    pub sg_table: sg_table,
    pub first_sgl: *mut scatterlist,
    pub sg_cnt: c_int,
    pub io_dir: nvmefc_fcp_datadir,
    pub req): *mut *mut void (done)(struct nvmefc_fcp_req,
    pub private: *mut c_void,
    pub sqid: __le16,
    pub rcv_rsplen: u16,
...
// dynamic fields
    pub port_id: u32,
    pub port_state: nvme_fc_obj_state,
    pub /: *mut *mut } __aligned(sizeof(u64)); / alignment for other things alloc'd with,
//
...
// initiator-based functions
    pub ): *mut *mut void (localport_delete)(struct nvme_fc_local_port,
    pub ): *mut *mut void (remoteport_delete)(struct nvme_fc_remote_port,
    pub handle): *mut c_void,
    pub handle): *mut unsigned int qidx, void,
    pub ): *mut nvmefc_ls_req,
    pub ): *mut nvmefc_fcp_req,
    pub ): *mut nvmefc_ls_req,
    pub ): *mut nvmefc_fcp_req,
    pub ls_rsp): *mut nvmefc_ls_rsp,
    pub map): *mut blk_mq_queue_map,
    pub max_hw_queues: u32,
    pub max_sgl_segments: u16,
    pub max_dif_sgl_segments: u16,
    pub dma_boundary: u64,
// sizes of additional private data for data structures
    pub local_priv_sz: u32,
    pub remote_priv_sz: u32,
    pub lsrqst_priv_sz: u32,
    pub fcprqst_priv_sz: u32,
}
...
//
extern "C" {
    pub fn nvme_fc_unregister_localport(localport: *mut nvme_fc_local_port) -> c_int;
}
extern "C" {
    pub fn nvme_fc_unregister_remoteport(remoteport: *mut nvme_fc_remote_port) -> c_int;
}
extern "C" {
...
pub struct nvmefc_tgt_fcp_req {
    ...
    pub ba_rjt: fc_ba_rjt,
    pub sg: *mut scatterlist,
    pub sg_cnt: c_int,
    pub rspaddr: *mut c_void,
    pub rspdma: dma_addr_t,
    pub rsplen: u16,
    pub ): *mut *mut void (done)(struct nvmefc_tgt_fcp_req,
    pub /: *mut *mut *mut void nvmet_fc_private; / LLDD is not to access !!,
    pub transferred_length: u32,
    pub fcp_error: c_int,
}
...
pub struct nvmet_fc_target_template {
    pub tgtport): *mut *mut void (targetport_delete)(struct nvmet_fc_target_port,
    pub ls_rsp): *mut nvmefc_ls_rsp,
    pub fcpreq): *mut nvmefc_tgt_fcp_req,
    pub fcpreq): *mut nvmefc_tgt_fcp_req,
    pub fcpreq): *mut nvmefc_tgt_fcp_req,
    pub fcpreq): *mut nvmefc_tgt_fcp_req,
    pub tgtport): *mut *mut void (discovery_event)(struct nvmet_fc_target_port,
    pub lsreq): *mut *mut void hosthandle, struct nvmefc_ls_req,
    pub lsreq): *mut *mut void hosthandle, struct nvmefc_ls_req,
    pub hosthandle): *mut *mut void (host_release)(void,
    pub wwpn): *mut *mut *mut *mut int (host_traddr)(void hosthandle, u64 wwnn, u64,
    pub max_hw_queues: u32,
    pub max_sgl_segments: u16,
    pub max_dif_sgl_segments: u16,
    pub dma_boundary: u64,
...
// sizes of additional private data for data structures
    pub target_priv_sz: u32,
    pub lsrqst_priv_sz: u32,
}

extern "C" {
    pub fn nvmet_fc_unregister_targetport(tgtport: *mut nvmet_fc_target_port) -> c_int;
}
//
// Routine called to pass a NVME-FC LS request, received by the lldd,
...
//
pub const NVME_FC_FEAT_UUID: c_uint = 0x0001;
