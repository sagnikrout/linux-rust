...
//! Source: include/media/videobuf2-core.h
#![no_std]
...
pub struct vb2_mem_ops {
    pub size): c_ulong,
    pub buf_priv): *mut *mut void (put)(void,
    pub flags): c_ulong,
    pub size): c_ulong,
    pub buf_priv): *mut *mut void (put_userptr)(void,
    pub buf_priv): *mut *mut void (prepare)(void,
    pub buf_priv): *mut *mut void (finish)(void,
    pub size): c_ulong,
    pub buf_priv): *mut *mut void (detach_dmabuf)(void,
    pub buf_priv): *mut *mut int (map_dmabuf)(void,
    pub buf_priv): *mut *mut void (unmap_dmabuf)(void,
    pub buf_priv): *mut *mut *mut *mut void (vaddr)(struct vb2_buffer vb, void,
    pub buf_priv): *mut *mut *mut *mut void (cookie)(struct vb2_buffer vb, void,
    pub buf_priv): *mut *mut unsigned int (num_users)(void,
    pub vma): *mut *mut *mut int (mmap)(void buf_priv, struct vm_area_struct,
}
...
pub struct vb2_plane {
    pub mem_priv: *mut c_void,
    pub dbuf: *mut dma_buf,
    pub dbuf_mapped: c_uint,
    pub dbuf_duplicated: bool,
    pub bytesused: c_uint,
    pub length: c_uint,
    pub min_length: c_uint,
    pub offset: c_uint,
    pub userptr: c_ulong,
    pub fd: c_int,
    pub m: },
    pub data_offset: c_uint,
}
...
pub struct vb2_buffer {
    pub vb2_queue: *mut vb2_queue,
    pub index: c_uint,
    pub type: c_uint,
    pub memory: c_uint,
    pub num_planes: c_uint,
    pub timestamp: u64,
    pub request: *mut media_request,
...
//
    ...
    pub copied_timestamp:1: c_uint,
    pub skip_cache_sync_on_prepare:1: c_uint,
    pub skip_cache_sync_on_finish:1: c_uint,
    pub planes: [vb2_plane; VB2_MAX_PLANES],
    pub queued_entry: list_head,
...
//
    pub cnt_mem_alloc: u32,
    pub cnt_mem_put: u32,
    pub cnt_mem_get_dmabuf: u32,
    pub cnt_mem_get_userptr: u32,
    pub cnt_mem_put_userptr: u32,
    pub cnt_mem_prepare: u32,
    pub cnt_mem_finish: u32,
    pub cnt_mem_attach_dmabuf: u32,
    pub cnt_mem_detach_dmabuf: u32,
    pub cnt_mem_map_dmabuf: u32,
    pub cnt_mem_unmap_dmabuf: u32,
    pub cnt_mem_vaddr: u32,
    pub cnt_mem_cookie: u32,
    pub cnt_mem_num_users: u32,
    pub cnt_mem_mmap: u32,
    pub cnt_buf_out_validate: u32,
    pub cnt_buf_init: u32,
    pub cnt_buf_prepare: u32,
    pub cnt_buf_finish: u32,
    pub cnt_buf_cleanup: u32,
    pub cnt_buf_queue: u32,
    pub cnt_buf_request_complete: u32,
// This counts the number of calls to vb2_buffer_done()
    pub cnt_buf_done: u32,
...
#[derive(Copy, Clone)]
pub struct vb2_ops {
    pub alloc_devs[]): *mut unsigned int sizes[], struct device,
    pub vb): *mut *mut int (buf_out_validate)(struct vb2_buffer,
    pub vb): *mut *mut int (buf_init)(struct vb2_buffer,
    pub vb): *mut *mut int (buf_prepare)(struct vb2_buffer,
    pub vb): *mut *mut void (buf_finish)(struct vb2_buffer,
    pub vb): *mut *mut void (buf_cleanup)(struct vb2_buffer,
    pub q): *mut *mut int (prepare_streaming)(struct vb2_queue,
    pub count): *mut *mut *mut int (start_streaming)(struct vb2_queue q, unsigned int,
    pub q): *mut *mut void (stop_streaming)(struct vb2_queue,
    pub q): *mut *mut void (unprepare_streaming)(struct vb2_queue,
    pub vb): *mut *mut void (buf_queue)(struct vb2_buffer,
    pub vb): *mut *mut void (buf_request_complete)(struct vb2_buffer,
}
...
pub struct vb2_buf_ops {
    pub pb): *const *const *const int (verify_planes_array)(struct vb2_buffer vb, void,
    pub vb): *mut *mut void (init_buffer)(struct vb2_buffer,
    pub pb): *mut *mut *mut void (fill_user_buffer)(struct vb2_buffer vb, void,
    pub planes): *mut *mut *mut int (fill_vb2_buffer)(struct vb2_buffer vb, struct vb2_plane,
    pub pb): *const *const *const void (copy_timestamp)(struct vb2_buffer vb, void,
}
...
pub struct vb2_queue {
    ...
    pub bidirectional:1: c_uint,
    pub fileio_read_once:1: c_uint,
    pub fileio_write_immediately:1: c_uint,
    pub allow_zero_bytesused:1: c_uint,
    pub quirk_poll_must_check_waiting_for_buffers:1: c_uint,
    pub supports_requests:1: c_uint,
    pub requires_requests:1: c_uint,
    pub uses_qbuf:1: c_uint,
    pub uses_requests:1: c_uint,
    pub allow_cache_hints:1: c_uint,
    pub non_coherent_mem:1: c_uint,
    pub lock: *mut mutex,
    pub owner: *mut c_void,
    pub ops: *const vb2_ops,
    pub mem_ops: *const vb2_mem_ops,
    pub buf_ops: *const vb2_buf_ops,
    pub drv_priv: *mut c_void,
    pub subsystem_flags: u32,
    pub buf_struct_size: c_uint,
    pub timestamp_flags: u32,
    pub gfp_flags: gfp_t,
    pub min_queued_buffers: u32,
    pub min_reqbufs_allocation: u32,
    pub alloc_devs: [*mut device; VB2_MAX_PLANES],
// private: internal use only
    pub mmap_lock: mutex,
    pub memory: c_uint,
    pub dma_dir: dma_data_direction,
    pub bufs: *mut vb2_buffer,
    pub bufs_bitmap: *mut c_ulong,
    pub max_num_buffers: c_uint,
    pub queued_list: list_head,
    pub queued_count: c_uint,
    pub owned_by_drv_count: core::sync::atomic::AtomicI32,
    pub done_list: list_head,
    pub done_lock: spinlock_t,
    pub done_wq: wait_queue_head_t,
    pub streaming:1: c_uint,
    pub start_streaming_called:1: c_uint,
    pub error:1: c_uint,
    pub waiting_for_buffers:1: c_uint,
    pub waiting_in_dqbuf:1: c_uint,
    pub is_multiplanar:1: c_uint,
    pub is_output:1: c_uint,
    pub is_busy:1: c_uint,
    pub copy_timestamp:1: c_uint,
    pub last_buffer_dequeued:1: c_uint,
    pub fileio: *mut vb2_fileio_data,
    pub threadio: *mut vb2_threadio_data,
    pub name: [c_char; 32],
//
// Counters for how often these queue-related ops are
// called. Used to check for unbalanced ops.
//
    pub cnt_queue_setup: u32,
    pub cnt_prepare_streaming: u32,
    pub cnt_start_streaming: u32,
    pub cnt_stop_streaming: u32,
    pub cnt_unprepare_streaming: u32,
...
//
extern "C" {
    pub fn vb2_core_querybuf(q: *mut vb2_queue, vb: *mut vb2_buffer, pb: *mut c_void);
}
//
...
//
extern "C" {
    pub fn vb2_core_prepare_buf(q: *mut vb2_queue, vb: *mut vb2_buffer, pb: *mut c_void) -> c_int;
}
//
...
//
extern "C" {
    pub fn vb2_core_streamon(q: *mut vb2_queue, type: c_uint) -> c_int;
}
//
...
//
extern "C" {
    pub fn vb2_core_streamoff(q: *mut vb2_queue, type: c_uint) -> c_int;
}
//
...
//
extern "C" {
    pub fn int(vb: *mut *mut vb2_thread_fnc)(struct vb2_buffer, priv: *mut c_void) -> typedef;
}
//
...
//
extern "C" {
    pub fn bitmap_weight(_arg: q->bufs_bitmap, _arg: q->max_num_buffers) -> return;
}
//
