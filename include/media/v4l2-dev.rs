...
//! Source: include/media/v4l2-dev.h
#![no_std]
...
pub const VIDEO_MAJOR: c_int = 81;
//
...
pub struct v4l2_prio_state {
    pub prios: [core::sync::atomic::AtomicI32; 4],
}
...
pub struct v4l2_file_operations {
    ...
    pub long): *mut *mut *mut long (compat_ioctl32) (struct file , unsigned int, unsigned,

    pub long): unsigned long, unsigned long, unsigned,
...
// callbacks
    pub vdev): *mut *mut void (release)(struct video_device,
    pub ioctl_ops: *const v4l2_ioctl_ops,
    pub BASE_VIDIOC_PRIVATE): DECLARE_BITMAP(valid_ioctls,,
    pub lock: *mut mutex,
}
...
//
extern "C" {
    pub fn __video_register_device(_arg: vdev, _arg: type, _arg: nr, _arg: 1, _arg: vdev->fops->owner) -> return;
}
//
...
//
extern "C" {
    pub fn __video_register_device(_arg: vdev, _arg: type, _arg: nr, _arg: 0, _arg: vdev->fops->owner) -> return;
}
//
...
//
extern "C" {
    pub fn video_device_alloc() -> *mut video_device  __must_check;
}
//
...
//
extern "C" {
    pub fn video_get_drvdata(_arg: video_devdata(file)) -> return;
}
//
...
//
extern "C" {
    pub fn dev_name(_arg: &vdev->dev) -> return;
}
//
...
//
extern "C" {
    pub fn test_bit(_arg: V4L2_FL_REGISTERED, _arg: &vdev->flags) -> return;
}
//
...
//
extern "C" {
    pub fn video_device_pipeline_alloc_start(vdev: *mut video_device) -> __must_check int;
}
//
