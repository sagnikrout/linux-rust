...
//! Source: include/media/v4l2-async.h
#![no_std]
...
pub struct v4l2_async_match_desc {
    pub type: v4l2_async_match_type,
    pub fwnode: *mut fwnode_handle,
    pub adapter_id: c_int,
...
pub struct v4l2_async_connection {
    pub match: v4l2_async_match_desc,
...
pub struct v4l2_async_notifier_operations {
    ...
    pub notifier): *mut *mut int (complete)(struct v4l2_async_notifier,
    pub asc): *mut v4l2_async_connection,
    pub asc): *mut *mut void (destroy)(struct v4l2_async_connection,
}
...
//
extern "C" {
    pub fn v4l2_async_nf_register(notifier: *mut v4l2_async_notifier) -> c_int;
}
//
...
extern "C" {
    pub fn __v4l2_async_register_subdev(sd: *mut v4l2_subdev, module: *mut module) -> c_int;
}
//
