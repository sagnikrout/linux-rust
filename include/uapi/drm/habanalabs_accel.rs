...
//! Source: include/uapi/drm/habanalabs_accel.h
#![no_std]
...
// and userspace
//
pub const GOYA_KMD_SRAM_RESERVED_SIZE_FROM_START: c_uint = 0x8000	/* 32KB */;
pub const GAUDI_DRIVER_SRAM_RESERVED_SIZE_FROM_START: c_uint = 0x80	/* 128 bytes */;
//
// 128 SOBs reserved for collective wait
// 16 SOBs reserved for sync stream
//
pub const GAUDI_FIRST_AVAILABLE_W_S_SYNC_OBJECT: c_int = 144;
//
// 64 monitors reserved for collective wait
// 8 monitors reserved for sync stream
//
pub const GAUDI_FIRST_AVAILABLE_W_S_MONITOR: c_int = 72;
...
//
pub const HL_INFO_HW_IP_INFO: c_int = 0;
pub const HL_INFO_HW_EVENTS: c_int = 1;
pub const HL_INFO_DRAM_USAGE: c_int = 2;
pub const HL_INFO_HW_IDLE: c_int = 3;
pub const HL_INFO_DEVICE_STATUS: c_int = 4;
pub const HL_INFO_DEVICE_UTILIZATION: c_int = 6;
pub const HL_INFO_HW_EVENTS_AGGREGATE: c_int = 7;
pub const HL_INFO_CLK_RATE: c_int = 8;
pub const HL_INFO_RESET_COUNT: c_int = 9;
pub const HL_INFO_TIME_SYNC: c_int = 10;
pub const HL_INFO_CS_COUNTERS: c_int = 11;
pub const HL_INFO_PCI_COUNTERS: c_int = 12;
pub const HL_INFO_CLK_THROTTLE_REASON: c_int = 13;
pub const HL_INFO_SYNC_MANAGER: c_int = 14;
pub const HL_INFO_TOTAL_ENERGY: c_int = 15;
pub const HL_INFO_PLL_FREQUENCY: c_int = 16;
pub const HL_INFO_POWER: c_int = 17;
pub const HL_INFO_OPEN_STATS: c_int = 18;
pub const HL_INFO_DRAM_REPLACED_ROWS: c_int = 21;
pub const HL_INFO_DRAM_PENDING_ROWS: c_int = 22;
pub const HL_INFO_LAST_ERR_OPEN_DEV_TIME: c_int = 23;
pub const HL_INFO_CS_TIMEOUT_EVENT: c_int = 24;
pub const HL_INFO_RAZWI_EVENT: c_int = 25;
pub const HL_INFO_DEV_MEM_ALLOC_PAGE_SIZES: c_int = 26;
pub const HL_INFO_SECURED_ATTESTATION: c_int = 27;
pub const HL_INFO_REGISTER_EVENTFD: c_int = 28;
pub const HL_INFO_UNREGISTER_EVENTFD: c_int = 29;
pub const HL_INFO_GET_EVENTS: c_int = 30;
pub const HL_INFO_UNDEFINED_OPCODE_EVENT: c_int = 31;
pub const HL_INFO_ENGINE_STATUS: c_int = 32;
pub const HL_INFO_PAGE_FAULT_EVENT: c_int = 33;
pub const HL_INFO_USER_MAPPINGS: c_int = 34;
pub const HL_INFO_FW_GENERIC_REQ: c_int = 35;
pub const HL_INFO_HW_ERR_EVENT: c_int = 36;
pub const HL_INFO_FW_ERR_EVENT: c_int = 37;
pub const HL_INFO_USER_ENGINE_ERR_EVENT: c_int = 38;
pub const HL_INFO_DEV_SIGNED: c_int = 40;
pub const HL_INFO_VERSION_MAX_LEN: c_int = 128;
pub const HL_INFO_CARD_NAME_MAX_LEN: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_hw_ip_info {
    pub sram_base_address: __u64,
    pub dram_base_address: __u64,
    pub dram_size: __u64,
    pub sram_size: __u32,
    pub num_of_events: __u32,
    pub device_id: __u32,
    pub module_id: __u32,
    pub decoder_enabled_mask: __u32,
    pub first_available_interrupt_id: __u16,
    pub server_type: __u16,
    pub cpld_version: __u32,
    pub psoc_pci_pll_nr: __u32,
    pub psoc_pci_pll_nf: __u32,
    pub psoc_pci_pll_od: __u32,
    pub psoc_pci_pll_div_factor: __u32,
    pub tpc_enabled_mask: __u8,
    pub dram_enabled: __u8,
    pub security_enabled: __u8,
    pub mme_master_slave_mode: __u8,
    pub cpucp_version: [__u8; HL_INFO_VERSION_MAX_LEN],
    pub card_name: [__u8; HL_INFO_CARD_NAME_MAX_LEN],
    pub tpc_enabled_mask_ext: __u64,
    pub dram_page_size: __u64,
    pub edma_enabled_mask: __u32,
    pub number_of_user_interrupts: __u16,
    pub reserved1: __u8,
    pub reserved2: __u8,
    pub reserved3: __u64,
    pub device_mem_alloc_default_page_size: __u64,
    pub reserved4: __u64,
    pub reserved5: __u64,
    pub reserved6: __u32,
    pub reserved7: __u8,
    pub revision_id: __u8,
    pub tpc_interrupt_id: __u16,
    pub rotator_enabled_mask: __u32,
    pub reserved9: __u32,
    pub engine_core_interrupt_reg_addr: __u64,
    pub reserved_dram_size: __u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_dram_usage {
    pub dram_free_mem: __u64,
    pub ctx_dram_mem: __u64,
}

pub const HL_BUSY_ENGINES_MASK_EXT_SIZE: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_hw_idle {
    pub is_idle: __u32,
//
// Bitmask of busy engines.
// Bits definition is according to `enum <chip>_engine_id'.
//
    pub busy_engines_mask: __u32,
//
// Extended Bitmask of busy engines.
// Bits definition is according to `enum <chip>_engine_id'.
//
    pub busy_engines_mask_ext: [__u64; HL_BUSY_ENGINES_MASK_EXT_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_device_status {
    pub status: __u32,
    pub pad: __u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_device_utilization {
    pub utilization: __u32,
    pub pad: __u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_clk_rate {
    pub cur_clk_rate_mhz: __u32,
    pub max_clk_rate_mhz: __u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_reset_count {
    pub hard_reset_cnt: __u32,
    pub soft_reset_cnt: __u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_time_sync {
    pub device_time: __u64,
    pub host_time: __u64,
    pub tsc_time: __u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_pci_counters {
    pub rx_throughput: __u64,
    pub tx_throughput: __u64,
    pub replay_cnt: __u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_clk_throttle {
    pub clk_throttling_reason: __u32,
    pub pad: __u32,
    pub clk_throttling_timestamp_us: [__u64; HL_CLK_THROTTLE_TYPE_MAX],
    pub clk_throttling_duration_ns: [__u64; HL_CLK_THROTTLE_TYPE_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_energy {
    pub total_energy_consumption: __u64,
}

pub const HL_PLL_NUM_OUTPUTS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_pll_frequency_info {
    pub output: [__u16; HL_PLL_NUM_OUTPUTS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_open_stats_info {
    pub open_counter: __u64,
    pub last_open_period_ms: __u64,
    pub is_compute_ctx_active: __u8,
    pub compute_ctx_in_release: __u8,
    pub pad: [__u8; 6],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_sync_manager {
    pub first_available_sync_object: __u32,
    pub first_available_monitor: __u32,
    pub first_available_cq: __u32,
    pub reserved: __u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_cs_counters {
    pub total_out_of_mem_drop_cnt: __u64,
    pub ctx_out_of_mem_drop_cnt: __u64,
    pub total_parsing_drop_cnt: __u64,
    pub ctx_parsing_drop_cnt: __u64,
    pub total_queue_full_drop_cnt: __u64,
    pub ctx_queue_full_drop_cnt: __u64,
    pub total_device_in_reset_drop_cnt: __u64,
    pub ctx_device_in_reset_drop_cnt: __u64,
    pub total_max_cs_in_flight_drop_cnt: __u64,
    pub ctx_max_cs_in_flight_drop_cnt: __u64,
    pub total_validation_drop_cnt: __u64,
    pub ctx_validation_drop_cnt: __u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_last_err_open_dev_time {
    pub timestamp: __s64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_cs_timeout_event {
    pub timestamp: __s64,
    pub seq: __u64,
}

pub const HL_RAZWI_MAX_NUM_OF_ENGINES_PER_RTR: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_razwi_event {
    pub timestamp: __s64,
    pub addr: __u64,
    pub engine_id: [__u16; HL_RAZWI_MAX_NUM_OF_ENGINES_PER_RTR],
    pub num_of_possible_engines: __u16,
    pub flags: __u8,
    pub pad: [__u8; 5],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_undefined_opcode_event {
    pub timestamp: __s64,
    pub cb_addr_streams: [__u64; MAX_QMAN_STREAMS_INFO][OPCODE_INFO_MAX_ADDR_SIZE],
    pub cq_addr: __u64,
    pub cq_size: __u32,
    pub cb_addr_streams_len: __u32,
    pub engine_id: __u32,
    pub stream_id: __u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_hw_err_event {
    pub timestamp: __s64,
    pub event_id: __u16,
    pub pad: [__u16; 3],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_fw_err_event {
    pub timestamp: __s64,
    pub err_type: __u16,
    pub event_id: __u16,
    pub pad: __u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_engine_err_event {
    pub timestamp: __s64,
    pub engine_id: __u16,
    pub error_count: __u16,
    pub pad: __u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_dev_memalloc_page_sizes {
    pub page_order_bitmask: __u64,
}

pub const SEC_PCR_DATA_BUF_SZ: c_int = 256;

pub const SEC_DEV_INFO_BUF_SZ: c_int = 5120;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_info_sec_attest {
    pub nonce: __u32,
    pub pcr_quote_len: __u16,
    pub pub_data_len: __u16,
    pub certificate_len: __u16,
...
pub struct hl_info_signed {
    ...
    pub dev_info_len: __u16,
    pub dev_info: [__u8; SEC_DEV_INFO_BUF_SZ],
    pub pad: [__u8; 2],
}
...
pub struct hl_info_args {
    ...
    pub pll_index: __u32,
    pub eventfd: __u32,
    pub user_buffer_actual_size: __u32,
    pub sec_attest_nonce: __u32,
    pub array_size: __u32,
    pub fw_sub_opcode: __u32,
}

// Opcode to create a new command buffer
pub const HL_CB_OP_CREATE: c_int = 0;
// Opcode to destroy previously created command buffer
pub const HL_CB_OP_DESTROY: c_int = 1;
// Opcode to retrieve information about a command buffer
pub const HL_CB_OP_INFO: c_int = 2;
// 2MB minus 32 bytes for 2xMSG_PROT

// Indicates whether the command buffer should be mapped to the device's MMU
pub const HL_CB_FLAGS_MAP: c_uint = 0x1;
// Used with HL_CB_OP_INFO opcode to get the device va address for kernel mapped CB
pub const HL_CB_FLAGS_GET_DEVICE_VA: c_uint = 0x2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_cb_in {
...
//
pub const HL_CS_CHUNK_FLAGS_USER_ALLOC_CB: c_uint = 0x1;
//
...
pub const HL_CS_FLAGS_FORCE_RESTORE: c_uint = 0x1;
pub const HL_CS_FLAGS_SIGNAL: c_uint = 0x2;
pub const HL_CS_FLAGS_WAIT: c_uint = 0x4;
pub const HL_CS_FLAGS_COLLECTIVE_WAIT: c_uint = 0x8;
pub const HL_CS_FLAGS_TIMESTAMP: c_uint = 0x20;
pub const HL_CS_FLAGS_STAGED_SUBMISSION: c_uint = 0x40;
pub const HL_CS_FLAGS_STAGED_SUBMISSION_FIRST: c_uint = 0x80;
pub const HL_CS_FLAGS_STAGED_SUBMISSION_LAST: c_uint = 0x100;
pub const HL_CS_FLAGS_CUSTOM_TIMEOUT: c_uint = 0x200;
pub const HL_CS_FLAGS_SKIP_RESET_ON_TIMEOUT: c_uint = 0x400;
//
...
//
pub const HL_CS_FLAGS_ENCAP_SIGNALS: c_uint = 0x800;
pub const HL_CS_FLAGS_RESERVE_SIGNALS_ONLY: c_uint = 0x1000;
pub const HL_CS_FLAGS_UNRESERVE_SIGNALS_ONLY: c_uint = 0x2000;
//
// The engine cores CS is merged into the existing CS ioctls.
// Use it to control the engine cores mode.
//
pub const HL_CS_FLAGS_ENGINE_CORE_COMMAND: c_uint = 0x4000;
//
...
//
pub const HL_CS_FLAGS_FLUSH_PCI_HBW_WRITES: c_uint = 0x8000;
//
// The engines CS is merged into the existing CS ioctls.
// Use it to control engines modes.
//
pub const HL_CS_FLAGS_ENGINES_COMMAND: c_uint = 0x10000;
pub const HL_CS_STATUS_SUCCESS: c_int = 0;
pub const HL_MAX_JOBS_PER_CS: c_int = 512;
//
...
// this holds address of array of hl_cs_chunk for restore phase
    pub chunks_restore: __u64,
// holds address of array of hl_cs_chunk for execution phase
    pub chunks_execute: __u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union hl_cs_args {
    pub in: hl_cs_in,
    pub out: hl_cs_out,
}

pub const HL_WAIT_CS_FLAGS_INTERRUPT: c_uint = 0x2;
pub const HL_WAIT_CS_FLAGS_INTERRUPT_MASK: c_uint = 0xFFF00000;
pub const HL_WAIT_CS_FLAGS_ANY_CQ_INTERRUPT: c_uint = 0xFFF00000;
pub const HL_WAIT_CS_FLAGS_ANY_DEC_INTERRUPT: c_uint = 0xFFE00000;
pub const HL_WAIT_CS_FLAGS_MULTI_CS: c_uint = 0x4;
pub const HL_WAIT_CS_FLAGS_INTERRUPT_KERNEL_CQ: c_uint = 0x10;
pub const HL_WAIT_CS_FLAGS_REGISTER_INTERRUPT: c_uint = 0x20;
pub const HL_WAIT_MULTI_CS_LIST_MAX_LEN: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_wait_cs_in {
//
...
// relevant only when HL_WAIT_CS_FLAGS_REGISTER_INTERRUPT is set
//
pub const HL_WAIT_CS_STATUS_COMPLETED: c_int = 0;
pub const HL_WAIT_CS_STATUS_BUSY: c_int = 1;
pub const HL_WAIT_CS_STATUS_TIMEDOUT: c_int = 2;
pub const HL_WAIT_CS_STATUS_ABORTED: c_int = 3;
pub const HL_WAIT_CS_STATUS_FLAG_GONE: c_uint = 0x1;
pub const HL_WAIT_CS_STATUS_FLAG_TIMESTAMP_VLD: c_uint = 0x2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_wait_cs_out {
// HL_WAIT_CS_STATUS_*
    pub status: __u32,
...
//
    pub timestamp_nsec: __s64,
// multi CS completion bitmap
    pub cs_completion_map: __u32,
    pub pad: __u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub union hl_wait_cs_args {
    pub in: hl_wait_cs_in,
    pub out: hl_wait_cs_out,
}

// Opcode to allocate device memory
pub const HL_MEM_OP_ALLOC: c_int = 0;
// Opcode to free previously allocated device memory
pub const HL_MEM_OP_FREE: c_int = 1;
// Opcode to map host and device memory
pub const HL_MEM_OP_MAP: c_int = 2;
// Opcode to unmap previously mapped host and device memory
pub const HL_MEM_OP_UNMAP: c_int = 3;
// Opcode to map a hw block
pub const HL_MEM_OP_MAP_BLOCK: c_int = 4;
// Opcode to create DMA-BUF object for an existing device memory allocation
// and to export an FD of that DMA-BUF back to the caller
//
pub const HL_MEM_OP_EXPORT_DMABUF_FD: c_int = 5;
...
//
pub const HL_MEM_OP_TS_ALLOC: c_int = 6;
// Memory flags
pub const HL_MEM_CONTIGUOUS: c_uint = 0x1;
pub const HL_MEM_SHARED: c_uint = 0x2;
pub const HL_MEM_USERPTR: c_uint = 0x4;
pub const HL_MEM_FORCE_HINT: c_uint = 0x8;
pub const HL_MEM_PREFETCH: c_uint = 0x40;
//
...
//
    ...
    pub mem_size: __u64,
    pub offset: __u64,
    pub export_dmabuf_fd: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_mem_out {
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union hl_mem_args {
    pub in: hl_mem_in,
    pub out: hl_mem_out,
}

pub const HL_DEBUG_MAX_AUX_VALUES: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_debug_params_etr {
// Address in memory to allocate buffer
    pub buffer_address: __u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_debug_params_etf {
// Address in memory to allocate buffer
    pub buffer_address: __u64,
// Size of buffer to allocate
    pub buffer_size: __u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_debug_params_stm {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_debug_params_bmon {
// Two address ranges that the user can request to filter
    pub start_addr0: __u64,
    pub addr_mask0: __u64,
    pub start_addr1: __u64,
    pub addr_mask1: __u64,
// Capture window configuration
    pub bw_win: __u32,
    pub win_capture: __u32,
// Trace source ID
    pub id: __u32,
// Control register
    pub control: __u32,
// Two more address ranges that the user can request to filter
    pub start_addr2: __u64,
    pub end_addr2: __u64,
    pub start_addr3: __u64,
    pub end_addr3: __u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_debug_params_spmu {
// Event types selection
    pub event_types: [__u64; HL_DEBUG_MAX_AUX_VALUES],
// Number of event types selection
    pub event_types_num: __u32,
// TRC configuration register values
    pub pmtrc_val: __u32,
    pub trc_ctrl_host_val: __u32,
    pub trc_en_host_val: __u32,
}

// Opcode for ETR component
pub const HL_DEBUG_OP_ETR: c_int = 0;
// Opcode for ETF component
pub const HL_DEBUG_OP_ETF: c_int = 1;
// Opcode for STM component
pub const HL_DEBUG_OP_STM: c_int = 2;
// Opcode for FUNNEL component
pub const HL_DEBUG_OP_FUNNEL: c_int = 3;
// Opcode for BMON component
pub const HL_DEBUG_OP_BMON: c_int = 4;
// Opcode for SPMU component
pub const HL_DEBUG_OP_SPMU: c_int = 5;
// Opcode for timestamp (deprecated)
pub const HL_DEBUG_OP_TIMESTAMP: c_int = 6;
// Opcode for setting the device into or out of debug mode. The enable
// variable should be 1 for enabling debug mode and 0 for disabling it
//
pub const HL_DEBUG_OP_SET_MODE: c_int = 7;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_debug_args {
//
...
// Pointer to user output structure
    pub output_ptr: __u64,
// Size of user input structure
    pub input_size: __u32,
...
pub const HL_IOCTL_INFO: c_uint = 0x00;
pub const HL_IOCTL_CB: c_uint = 0x01;
pub const HL_IOCTL_CS: c_uint = 0x02;
pub const HL_IOCTL_WAIT_CS: c_uint = 0x03;
pub const HL_IOCTL_MEMORY: c_uint = 0x04;
pub const HL_IOCTL_DEBUG: c_uint = 0x05;
//
