...
//! Source: include/uapi/misc/xilinx_sdfec.h
#![no_std]
...
pub struct xsdfec_ldpc_params {
    ...
    pub nm: __u32,
    pub norm_type: __u32,
    pub no_packing: __u32,
    pub special_qc: __u32,
    pub no_final_parity: __u32,
    pub max_schedule: __u32,
    pub sc_off: __u32,
    pub la_off: __u32,
    pub qc_off: __u32,
    pub sc_table: *mut __u32,
    pub la_table: *mut __u32,
    pub qc_table: *mut __u32,
    pub code_id: __u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xsdfec_irq {
    pub enable_isr: __s8,
    pub enable_ecc_isr: __s8,
}
...
pub struct xsdfec_config {
    ...
    pub order: __u32,
    pub din_width: __u32,
    pub din_word_include: __u32,
    pub dout_width: __u32,
    pub dout_word_include: __u32,
    pub irq: xsdfec_irq,
    pub bypass: __s8,
    pub code_wr_protect: __s8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xsdfec_stats {
    pub isr_err_count: __u32,
    pub cecc_count: __u32,
    pub uecc_count: __u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xsdfec_ldpc_param_table_sizes {
    pub sc_size: __u32,
    pub la_size: __u32,
    pub qc_size: __u32,
}
