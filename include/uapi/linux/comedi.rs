...
//! Source: include/uapi/linux/comedi.h
#![no_std]
...
//
pub const COMEDI_MAJORVERSION: c_int = 0;
pub const COMEDI_MINORVERSION: c_int = 7;
pub const COMEDI_MICROVERSION: c_int = 76;

// comedi's major device number
pub const COMEDI_MAJOR: c_int = 98;
//
// maximum number of minor devices.  This can be increased, although
// kernel structures are currently statically allocated, thus you
// don't want this to be much more than you actually use.
//
pub const COMEDI_NDEVICES: c_int = 16;
// number of config options in the config structure
pub const COMEDI_NDEVCONFOPTS: c_int = 32;
//
...
pub const COMEDI_DEVCONF_AUX_DATA3_LENGTH: c_int = 25;
pub const COMEDI_DEVCONF_AUX_DATA2_LENGTH: c_int = 26;
pub const COMEDI_DEVCONF_AUX_DATA1_LENGTH: c_int = 27;
pub const COMEDI_DEVCONF_AUX_DATA0_LENGTH: c_int = 28;
// most significant 32 bits of pointer address (if needed)
pub const COMEDI_DEVCONF_AUX_DATA_HI: c_int = 29;
// least significant 32 bits of pointer address
pub const COMEDI_DEVCONF_AUX_DATA_LO: c_int = 30;

// max length of device and driver names
pub const COMEDI_NAMELEN: c_int = 20;
// packs and unpacks a channel/range number

pub const CR_FLAGS_MASK: c_uint = 0xfc000000;
pub const CR_ALT_FILTER: c_uint = 0x04000000;

pub const CR_ALT_SOURCE: c_uint = 0x08000000;
pub const CR_EDGE: c_uint = 0x40000000;
pub const CR_INVERT: c_uint = 0x80000000;
pub const AREF_GROUND: c_uint = 0x00	/* analog ref = analog ground */;
pub const AREF_COMMON: c_uint = 0x01	/* analog ref = analog common */;
pub const AREF_DIFF: c_uint = 0x02	/* analog ref = differential */;
pub const AREF_OTHER: c_uint = 0x03	/* analog ref = other (undefined) */;
// counters -- these are arbitrary values
pub const GPCT_RESET: c_uint = 0x0001;
pub const GPCT_SET_SOURCE: c_uint = 0x0002;
pub const GPCT_SET_GATE: c_uint = 0x0004;
pub const GPCT_SET_DIRECTION: c_uint = 0x0008;
pub const GPCT_SET_OPERATION: c_uint = 0x0010;
pub const GPCT_ARM: c_uint = 0x0020;
pub const GPCT_DISARM: c_uint = 0x0040;
pub const GPCT_GET_INT_CLK_FRQ: c_uint = 0x0080;
pub const GPCT_INT_CLOCK: c_uint = 0x0001;
pub const GPCT_EXT_PIN: c_uint = 0x0002;
pub const GPCT_NO_GATE: c_uint = 0x0004;
pub const GPCT_UP: c_uint = 0x0008;
pub const GPCT_DOWN: c_uint = 0x0010;
pub const GPCT_HWUD: c_uint = 0x0020;
pub const GPCT_SIMPLE_EVENT: c_uint = 0x0040;
pub const GPCT_SINGLE_PERIOD: c_uint = 0x0080;
pub const GPCT_SINGLE_PW: c_uint = 0x0100;
pub const GPCT_CONT_PULSE_OUT: c_uint = 0x0200;
pub const GPCT_SINGLE_PULSE_OUT: c_uint = 0x0400;
// instructions
pub const INSN_MASK_WRITE: c_uint = 0x8000000;
pub const INSN_MASK_READ: c_uint = 0x4000000;
pub const INSN_MASK_SPECIAL: c_uint = 0x2000000;

// command flags
// These flags are used in comedi_cmd structures
pub const CMDF_BOGUS: c_uint = 0x00000001	/* do the motions */;
// try to use a real-time interrupt while performing command
pub const CMDF_PRIORITY: c_uint = 0x00000008;
// wake up on end-of-scan events
pub const CMDF_WAKE_EOS: c_uint = 0x00000020;
pub const CMDF_WRITE: c_uint = 0x00000040;
pub const CMDF_RAWDATA: c_uint = 0x00000080;
// timer rounding definitions
pub const CMDF_ROUND_MASK: c_uint = 0x00030000;
pub const CMDF_ROUND_NEAREST: c_uint = 0x00000000;
pub const CMDF_ROUND_DOWN: c_uint = 0x00010000;
pub const CMDF_ROUND_UP: c_uint = 0x00020000;
pub const CMDF_ROUND_UP_NEXT: c_uint = 0x00030000;
pub const COMEDI_EV_START: c_uint = 0x00040000;
pub const COMEDI_EV_SCAN_BEGIN: c_uint = 0x00080000;
pub const COMEDI_EV_CONVERT: c_uint = 0x00100000;
pub const COMEDI_EV_SCAN_END: c_uint = 0x00200000;
pub const COMEDI_EV_STOP: c_uint = 0x00400000;
// compatibility definitions

// trigger sources
pub const TRIG_ANY: c_uint = 0xffffffff;
pub const TRIG_INVALID: c_uint = 0x00000000;
pub const TRIG_NONE: c_uint = 0x00000001 /* never trigger */;
pub const TRIG_NOW: c_uint = 0x00000002 /* trigger now + N ns */;
pub const TRIG_FOLLOW: c_uint = 0x00000004 /* trigger on next lower level trig */;
pub const TRIG_TIME: c_uint = 0x00000008 /* trigger at time N ns */;
pub const TRIG_TIMER: c_uint = 0x00000010 /* trigger at rate N ns */;
pub const TRIG_COUNT: c_uint = 0x00000020 /* trigger when count reaches N */;
pub const TRIG_EXT: c_uint = 0x00000040 /* trigger on external signal N */;
pub const TRIG_INT: c_uint = 0x00000080 /* trigger on comedi-internal signal N */;
pub const TRIG_OTHER: c_uint = 0x00000100 /* driver defined */;
// subdevice flags
pub const SDF_BUSY: c_uint = 0x0001	/* device is busy */;
pub const SDF_BUSY_OWNER: c_uint = 0x0002	/* device is busy with your job */;
pub const SDF_LOCKED: c_uint = 0x0004	/* subdevice is locked */;
pub const SDF_LOCK_OWNER: c_uint = 0x0008	/* you own lock */;
pub const SDF_MAXDATA: c_uint = 0x0010	/* maxdata depends on channel */;
pub const SDF_FLAGS: c_uint = 0x0020	/* flags depend on channel */;
pub const SDF_RANGETYPE: c_uint = 0x0040	/* range type depends on channel */;
pub const SDF_PWM_COUNTER: c_uint = 0x0080	/* PWM can automatically switch off */;
pub const SDF_PWM_HBRIDGE: c_uint = 0x0100	/* PWM is signed (H-bridge) */;
pub const SDF_CMD: c_uint = 0x1000	/* can do commands (deprecated) */;
pub const SDF_SOFT_CALIBRATED: c_uint = 0x2000 /* subdevice uses software calibration */;
pub const SDF_CMD_WRITE: c_uint = 0x4000 /* can do output commands */;
pub const SDF_CMD_READ: c_uint = 0x8000 /* can do input commands */;
...
pub const SDF_GROUND: c_uint = 0x00100000	/* can do aref=ground */;
pub const SDF_COMMON: c_uint = 0x00200000	/* can do aref=common */;
pub const SDF_DIFF: c_uint = 0x00400000	/* can do aref=diff */;
pub const SDF_OTHER: c_uint = 0x00800000	/* can do aref=other */;
pub const SDF_DITHER: c_uint = 0x01000000	/* can do dithering */;
pub const SDF_DEGLITCH: c_uint = 0x02000000	/* can do deglitching */;
pub const SDF_MMAP: c_uint = 0x04000000	/* can do mmap() */;
pub const SDF_RUNNING: c_uint = 0x08000000	/* subdevice is acquiring data */;
pub const SDF_LSAMPL: c_uint = 0x10000000	/* subdevice uses 32-bit samples */;
pub const SDF_PACKED: c_uint = 0x20000000	/* subdevice can do packed DIO */;
// subdevice types
//
...
pub enum comedi_subdevice_type {
    COMEDI_SUBD_UNUSED,
    COMEDI_SUBD_AI,
    COMEDI_SUBD_AO,
    COMEDI_SUBD_DI,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum device_config_route_ids {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum comedi_digital_trig_op {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum comedi_counter_status_flags {
...
pub struct comedi_insn {
    pub insn: c_uint,
    pub n: c_uint,
    pub data: *mut unsigned int __user,
    pub subdev: c_uint,
    pub chanspec: c_uint,
    pub unused: [c_uint; 3],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct comedi_insnlist {
    pub n_insns: c_uint,
    pub insns: *mut comedi_insn __user,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct comedi_chaninfo {
    pub subdev: c_uint,
    pub maxdata_list: *mut unsigned int __user,
    pub flaglist: *mut unsigned int __user,
    pub rangelist: *mut unsigned int __user,
    pub unused: [c_uint; 4],
}
...
pub struct comedi_rangeinfo {
    pub range_type: c_uint,
    pub range_ptr: *mut void __user,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct comedi_subdinfo {
    pub type: c_uint,
    pub n_chan: c_uint,
    pub subd_flags: c_uint,
    pub timer_type: c_uint,
    pub len_chanlist: c_uint,
    pub maxdata: c_uint,
    pub flags: c_uint,
    pub range_type: c_uint,
    pub settling_time_0: c_uint,
    pub insn_bits_support: c_uint,
    pub unused: [c_uint; 8],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct comedi_devinfo {
    pub version_code: c_uint,
    pub n_subdevs: c_uint,
    pub driver_name: [c_char; COMEDI_NAMELEN],
    pub board_name: [c_char; COMEDI_NAMELEN],
    pub read_subdevice: c_int,
    pub write_subdevice: c_int,
    pub unused: [c_int; 30],
}
...
pub struct comedi_devconfig {
    pub board_name: [c_char; COMEDI_NAMELEN],
    pub options: [c_int; COMEDI_NDEVCONFOPTS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct comedi_bufconfig {
    pub subdevice: c_uint,
    pub flags: c_uint,
    pub maximum_size: c_uint,
    pub size: c_uint,
    pub unused: [c_uint; 4],
}
...
pub struct comedi_bufinfo {
    ...
    pub bytes_written: c_uint,
    pub unused: [c_uint; 4],
}

// range stuff

pub const RF_EXTERNAL: c_uint = 0x100;
pub const UNIT_volt: c_int = 0;
pub const UNIT_mA: c_int = 1;
pub const UNIT_none: c_int = 2;
pub const COMEDI_MIN_SPEED: c_uint = 0xffffffffu;
//
...
//
pub const NI_NAMES_BASE: c_uint = 0x8000u;
...
pub const NI_MAX_COUNTERS: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ni_common_signal_names {
...
// INSN_CONFIG_SET_COUNTER_MODE
//
pub const NI_GPCT_COUNTING_MODE_SHIFT: c_int = 16;
pub const NI_GPCT_INDEX_PHASE_BITSHIFT: c_int = 20;
pub const NI_GPCT_COUNTING_DIRECTION_SHIFT: c_int = 24;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ni_gpct_mode_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ni_gpct_clock_source_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ni_gpct_filter_select {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ni_m_series_cdio_scan_begin_src {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ni_freq_out_clock_source_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum amplc_dio_clock_source {
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum amplc_dio_ts_clock_src {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum amplc_dio_gate_source {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ke_counter_clock_source {
