...
//! Source: include/uapi/linux/batman_adv.h
#![no_std]
...
pub enum batadv_tt_client_flags {
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum batadv_mcast_flags_priv {
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum batadv_tp_meter_reason {
//
