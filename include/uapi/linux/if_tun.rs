...
//! Source: include/uapi/linux/if_tun.h
#![no_std]
...
pub const IFF_NO_CARRIER: c_uint = 0x0040;
...
pub const TUN_F_USO4: c_uint = 0x20	/* I can handle USO for IPv4 packets */;
pub const TUN_F_USO6: c_uint = 0x40	/* I can handle USO for IPv6 packets */;
// I can handle TSO/USO for UDP tunneled packets
pub const TUN_F_UDP_TUNNEL_GSO: c_uint = 0x080;
//
// I can handle TSO/USO for UDP tunneled packets requiring csum offload for
// the outer header
//
pub const TUN_F_UDP_TUNNEL_GSO_CSUM: c_uint = 0x100;
