...
//! Source: include/uapi/linux/dm-log-userspace.h
#![no_std]
...
// 'data_size' appropriately.
//
pub const DM_ULOG_PRESUSPEND: c_int = 3;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_POSTSUSPEND: c_int = 4;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_RESUME: c_int = 5;
//
...
//
pub const DM_ULOG_GET_REGION_SIZE: c_int = 6;
//
...
//
pub const DM_ULOG_IS_CLEAN: c_int = 7;
//
...
//
pub const DM_ULOG_IN_SYNC: c_int = 8;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_FLUSH: c_int = 9;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_MARK_REGION: c_int = 10;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_CLEAR_REGION: c_int = 11;
//
...
// dm_ulog_request to the kernel - setting the 'error' field appropriately.
//
pub const DM_ULOG_GET_RESYNC_WORK: c_int = 12;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_SET_REGION_SYNC: c_int = 13;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_GET_SYNC_COUNT: c_int = 14;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_STATUS_INFO: c_int = 15;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_STATUS_TABLE: c_int = 16;
//
...
// 'data_size' appropriately.
//
pub const DM_ULOG_IS_REMOTE_RECOVERING: c_int = 17;
//
...
//
pub const DM_ULOG_REQUEST_MASK: c_uint = 0xFF;
...
// userspace versions.
//
pub const DM_ULOG_REQUEST_VERSION: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
...
//
    ...
    pub /: *mut *mut char padding[3]; / Padding because DM_UUID_LEN = 129,
    pub /: *mut *mut __u32 version; / See DM_ULOG_REQUEST_VERSION,
    pub /: *mut *mut __s32 error; / Used to report back processing errors,
    pub /: *mut *mut __u32 seq; / Sequence number for request,
    pub /: *mut *mut *mut __u32 request_type; / DM_ULOG_ defined above,
    pub /: *mut *mut __u32 data_size; / How much data (not including this struct),
    pub data: [c_char; ],
}
