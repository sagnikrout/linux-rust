...
//! Source: include/uapi/linux/iommufd.h
#![no_std]
...
pub struct iommu_ioas_iova_ranges {
    ...
    pub allowed_iovas: __aligned_u64,
    pub out_iova_alignment: __aligned_u64,
}
...
pub enum iommufd_ioas_map_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iommu_ioas_noiommu_get_pa {
    pub size: __u32,
    pub flags: __u32,
    pub ioas_id: __u32,
    pub __reserved: __u32,
...
pub struct iommu_ioas_copy {
    ...
    pub length: __aligned_u64,
    pub dst_iova: __aligned_u64,
    pub src_iova: __aligned_u64,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommufd_hwpt_alloc_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommu_hwpt_vtd_s1_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommu_hw_info_vtd_flags {
...
pub struct iommu_hw_info_vtd {
    pub flags: __u32,
    pub __reserved: __u32,
    pub cap_reg: __aligned_u64,
    pub ecap_reg: __aligned_u64,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommu_hw_info_arm_smmuv3_flags {
...
pub struct iommu_hw_info_amd {
    pub efr: __aligned_u64,
    pub efr2: __aligned_u64,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommufd_hw_capabilities {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommufd_hw_info_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommufd_hwpt_set_dirty_tracking_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommufd_hwpt_get_dirty_bitmap_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommu_hwpt_invalidate_data_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommu_hwpt_vtd_s1_invalidate_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommu_hwpt_pgfault_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommu_hwpt_pgfault_perm {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iommufd_page_response_code {
...
pub struct iommu_viommu_tegra241_cmdqv {
    pub out_vintf_mmap_offset: __aligned_u64,
    pub out_vintf_mmap_length: __aligned_u64,
}
...
pub struct iommu_vevent_tegra241_cmdqv {
    pub lvcmdq_err_map: [__aligned_le64; 2],
}
...
pub struct iommu_hw_queue_alloc {
    ...
    pub nesting_parent_iova: __aligned_u64,
    pub length: __aligned_u64,
}
