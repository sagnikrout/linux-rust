...
//! Source: include/uapi/linux/media/arm/mali-c55-config.h
#![no_std]
...
pub const MALI_C55_NUM_GAMMA_LUT_ELEMENTS: c_int = 129;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mali_c55_ae_1024bin_hist {
    pub bins: [__u16; 1024],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mali_c55_ae_5bin_hist {
    pub hist0: __u16,
    pub hist1: __u16,
    pub hist3: __u16,
    pub hist4: __u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mali_c55_awb_average_ratios {
    pub avg_rg_gr: __u16,
    pub avg_bg_br: __u16,
    pub num_pixels: __u32,
    pub __attribute__((packed)): },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mali_c55_af_statistics {
    pub intensity_stats: __u16,
    pub edge_stats: __u16,
    pub __attribute__((packed)): },
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mali_c55_aexp_hist_tap_points {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mali_c55_aexp_row_column_offset {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mali_c55_aexp_hist_plane_mode {
...
pub struct mali_c55_params_aexp_weights {
    pub header: v4l2_isp_params_block_header,
    pub nodes_used_horiz: __u8,
    pub nodes_used_vert: __u8,
    pub zone_weights: [__u8; MALI_C55_MAX_ZONES],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mali_c55_params_digital_gain {
    pub header: v4l2_isp_params_block_header,
    pub gain: __u16,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mali_c55_awb_stats_mode {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mali_c55_params_awb_tap_points {
...
pub const MALI_C55_NUM_MESH_SHADING_ELEMENTS: c_int = 3072;
//
...
pub struct mali_c55_params_mesh_shading_config {
    ...
    pub mesh_show: __u8,
    pub mesh_scale: __u8,
    pub mesh_page_r: __u8,
    pub mesh_page_g: __u8,
    pub mesh_page_b: __u8,
    pub mesh_width: __u8,
    pub mesh_height: __u8,
    pub mesh: [__u32; MALI_C55_NUM_MESH_SHADING_ELEMENTS],
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mali_c55_params_mesh_alpha_bank {
...
pub struct mali_c55_params_mesh_shading_selection {
    pub header: v4l2_isp_params_block_header,
    pub mesh_alpha_bank_r: __u8,
    pub mesh_alpha_bank_g: __u8,
    pub mesh_alpha_bank_b: __u8,
    pub mesh_alpha_r: __u8,
    pub mesh_alpha_g: __u8,
    pub mesh_alpha_b: __u8,
    pub mesh_strength: __u16,
}
...
pub struct mali_c55_params_gamma {
    ...
    pub gains: [__u16; 3],
    pub offs: [__u16; 3],
    pub lut: [__u32; MALI_C55_NUM_GAMMA_LUT_ELEMENTS],
}
