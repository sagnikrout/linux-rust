...
//! Source: include/uapi/linux/media/dreamchip/rppx1-config.h
#![no_std]
...
pub struct rppx1_wbmeas_params {
    ...
    pub frames: __u8,
    pub reserved: __u8,
    pub ref_cr_max_r: __u32,
    pub ref_cb_max_b: __u32,
    pub min_y_max_g: __u32,
    pub max_y: __u32,
    pub max_csum: __u32,
    pub min_c: __u32,
    pub ccor_coeff: [__u16; 3][3],
    pub reserved2: __u16,
    pub ccor_offs: [__u32; 3],
    pub reserved3: __u32,
}
...
pub struct rppx1_awbg_params {
    pub header: v4l2_isp_params_block_header,
    pub gain_red: __u32,
    pub gain_green_r: __u32,
    pub gain_blue: __u32,
    pub gain_green_b: __u32,
}
...
// Histogram
pub const RPPX1_HIST_WEIGHT_GRIDS_SIZE: c_int = 25;
//
...
pub struct rppx1_hist_params {
    ...
    pub wnd: rppx1_window,
    pub last_line: __u32,
    pub v_stepsize: __u32,
    pub h_step_inc: __u32,
    pub sample_offs: __u32,
    pub mode: __u8,
    pub channel_sel: __u8,
    pub weights: [__u8; RPPX1_HIST_WEIGHT_GRIDS_SIZE],
    pub coeff: [__u8; 3],
    pub sample_shift: __u8,
    pub reserved: __u8,
}
...
pub const RPPX1_LSC_SAMPLES_MAX: c_int = 17;
pub const RPPX1_LSC_NUM_SECTORS: c_int = 16;
//
...
pub struct rppx1_lsc_params {
    pub header: v4l2_isp_params_block_header,
    pub r_data: [__u16; RPPX1_LSC_SAMPLES_MAX][RPPX1_LSC_SAMPLES_MAX],
    pub gr_data: [__u16; RPPX1_LSC_SAMPLES_MAX][RPPX1_LSC_SAMPLES_MAX],
    pub gb_data: [__u16; RPPX1_LSC_SAMPLES_MAX][RPPX1_LSC_SAMPLES_MAX],
    pub b_data: [__u16; RPPX1_LSC_SAMPLES_MAX][RPPX1_LSC_SAMPLES_MAX],
    pub x_grad: [__u16; RPPX1_LSC_NUM_SECTORS],
    pub y_grad: [__u16; RPPX1_LSC_NUM_SECTORS],
    pub x_sect_size: [__u16; RPPX1_LSC_NUM_SECTORS],
    pub y_sect_size: [__u16; RPPX1_LSC_NUM_SECTORS],
}

// Gamma Out
pub const RPPX1_GA_MAX_SAMPLES: c_int = 17;
//
...
pub struct rppx1_ga_params {
    pub header: v4l2_isp_params_block_header,
    pub gamma_y: [__u32; RPPX1_GA_MAX_SAMPLES],
    pub mode: __u8,
    pub reserved: [__u8; 3],
}

// Linearization (Sensor De-gamma)
pub const RPPX1_LIN_SAMPLE_POINTS_NUM: c_int = 16;
pub const RPPX1_LIN_DEGAMMA_CURVE_NUM: c_int = 17;
//
...
pub struct rppx1_lin_params {
    pub header: v4l2_isp_params_block_header,
    pub curve_r: [__u32; RPPX1_LIN_DEGAMMA_CURVE_NUM],
    pub curve_g: [__u32; RPPX1_LIN_DEGAMMA_CURVE_NUM],
    pub curve_b: [__u32; RPPX1_LIN_DEGAMMA_CURVE_NUM],
    pub dx: [__u8; RPPX1_LIN_SAMPLE_POINTS_NUM],
    pub reserved: __u32,
}
...
pub struct rppx1_wbmeas_stats {
    ...
    pub cnt: __u32,
    pub mean_y_or_g: __u32,
    pub mean_cb_or_b: __u32,
    pub mean_cr_or_r: __u32,
}

// Exposure Measurement
pub const RPPX1_EXM_NUM_WIN: c_int = 25;
//
...
pub struct rppx1_exm_stats {
    pub header: v4l2_isp_block_header,
    pub exp_mean: [__u32; RPPX1_EXM_NUM_WIN],
    pub reserved: __u32,
}

// Histogram
pub const RPPX1_HIST_NUM_BINS: c_int = 32;
//
...
pub struct rppx1_hist_stats {
    pub header: v4l2_isp_block_header,
    pub hist_bins: [__u32; RPPX1_HIST_NUM_BINS],
}
