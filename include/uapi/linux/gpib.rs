...
//! Source: include/uapi/linux/gpib.h
#![no_std]
...
pub const GPIB_MAX_NUM_DESCRIPTORS: c_uint = 0x1000;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ibsta_bit_numbers {
    DCAS_NUM = 0,
    DTAS_NUM = 1,
    LACS_NUM = 2,
    TACS_NUM = 3,
