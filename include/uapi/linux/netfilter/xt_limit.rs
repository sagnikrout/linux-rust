...
//! Source: include/uapi/linux/netfilter/xt_limit.h
#![no_std]
...
pub const XT_LIMIT_SCALE: c_int = 10000;
...
// Used internally by the kernel
    pub /: *mut *mut unsigned long prev; / moved to xt_limit_priv,
    pub /: *mut *mut __u32 credit; / moved to xt_limit_priv,
