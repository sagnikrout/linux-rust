...
//! Source: include/uapi/linux/netfilter/nf_conntrack_common.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ip_conntrack_expect_events {
    IPEXP_NEW,		/* new expectation */
    IPEXP_DESTROY,		/* destroyed expectation */
}

// expectation flags
pub const NF_CT_EXPECT_PERMANENT: c_uint = 0x1;
pub const NF_CT_EXPECT_INACTIVE: c_uint = 0x2;
pub const NF_CT_EXPECT_USERSPACE: c_uint = 0x4;

pub const NF_CT_EXPECT_DEAD: c_uint = 0x8;
