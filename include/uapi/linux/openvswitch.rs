...
//! Source: include/uapi/linux/openvswitch.h
#![no_std]
...
// 02110-1301, USA
//
pub const _UAPI__LINUX_OPENVSWITCH_H: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_header {
    pub dp_ifindex: c_int,
}
...
//
pub const OVS_DATAPATH_VERSION: c_int = 2;
// First OVS datapath version to support features
pub const OVS_DP_VER_FEATURES: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_datapath_cmd {
    OVS_DP_CMD_UNSPEC,
    OVS_DP_CMD_NEW,
    OVS_DP_CMD_DEL,
    OVS_DP_CMD_GET,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_dp_stats {
    pub /: *mut *mut __u64 n_hit; / Number of flow table matches.,
    pub /: *mut *mut __u64 n_missed; / Number of flow table misses.,
    pub /: *mut *mut __u64 n_lost; / Number of misses not sent to userspace.,
    pub /: *mut *mut __u64 n_flows; / Number of flows present,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_dp_megaflow_stats {
    pub /: *mut *mut __u64 n_mask_hit; / Number of masks used for flow lookups.,
    pub /: *mut *mut __u32 n_masks; / Number of masks for the datapath.,
    pub /: *mut *mut __u32 pad0; / Pad for future expension.,
    pub /: *mut *mut __u64 n_cache_hit; / Number of cache matches for flow lookups.,
    pub /: *mut *mut __u64 pad1; / Pad for future expension.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_vport_stats {
    ...
    pub /: *mut *mut __u64 rx_dropped; / no space in linux buffers,
    pub /: *mut *mut __u64 tx_dropped; / no space available in linux,
}
...
pub const OVS_PACKET_VERSION: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_packet_cmd {
...
pub const OVS_VPORT_VERSION: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_vport_cmd {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_vport_upcall_attr {
...
pub const OVS_FLOW_VERSION: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_flow_cmd {
    OVS_FLOW_CMD_UNSPEC,
    OVS_FLOW_CMD_NEW,
    OVS_FLOW_CMD_DEL,
    OVS_FLOW_CMD_GET,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_flow_stats {
    pub /: *mut *mut __u64 n_packets; / Number of matched packets.,
    pub /: *mut *mut __u64 n_bytes; / Number of matched bytes.,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_ethernet {
    pub eth_src: [__u8; ETH_ALEN],
    pub eth_dst: [__u8; ETH_ALEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_mpls {
    pub mpls_lse: __be32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_ipv4 {
    pub ipv4_src: __be32,
    pub ipv4_dst: __be32,
    pub ipv4_proto: __u8,
    pub ipv4_tos: __u8,
    pub ipv4_ttl: __u8,
    pub /: *mut *mut *mut __u8 ipv4_frag; / One of OVS_FRAG_TYPE_.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_ipv6 {
    pub ipv6_src: [__be32; 4],
    pub ipv6_dst: [__be32; 4],
    pub /: *mut *mut __be32 ipv6_label; / 20-bits in least-significant bits.,
    pub ipv6_proto: __u8,
    pub ipv6_tclass: __u8,
    pub ipv6_hlimit: __u8,
    pub /: *mut *mut *mut __u8 ipv6_frag; / One of OVS_FRAG_TYPE_.,
}

// separate structure to support backward compatibility with older user space
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_ipv6_exthdrs {
    pub hdrs: __u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_tcp {
    pub tcp_src: __be16,
    pub tcp_dst: __be16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_icmpv6 {
    pub icmpv6_type: __u8,
    pub icmpv6_code: __u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_arp {
    pub arp_sip: __be32,
    pub arp_tip: __be32,
    pub arp_op: __be16,
    pub arp_sha: [__u8; ETH_ALEN],
    pub arp_tha: [__u8; ETH_ALEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_nd {
    pub nd_target: [__be32; 4],
    pub nd_sll: [__u8; ETH_ALEN],
    pub nd_tll: [__u8; ETH_ALEN],
}

pub const OVS_CT_LABELS_LEN_32: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_key_ct_labels {
    pub ct_labels: [__u8; OVS_CT_LABELS_LEN],
    pub ct_labels_32: [__u32; OVS_CT_LABELS_LEN_32],
}

// OVS_KEY_ATTR_CT_STATE flags
pub const OVS_CS_F_NEW: c_uint = 0x01 /* Beginning of a new connection. */;
pub const OVS_CS_F_ESTABLISHED: c_uint = 0x02 /* Part of an existing connection. */;
pub const OVS_CS_F_RELATED: c_uint = 0x04 /* Related to an established;
// connection.
pub const OVS_CS_F_REPLY_DIR: c_uint = 0x08 /* Flow is in the reply direction. */;
pub const OVS_CS_F_INVALID: c_uint = 0x10 /* Could not track connection. */;
pub const OVS_CS_F_TRACKED: c_uint = 0x20 /* Conntrack has occurred. */;
pub const OVS_CS_F_SRC_NAT: c_uint = 0x40 /* Packet's source address/port was;
// mangled by NAT.
//
pub const OVS_CS_F_DST_NAT: c_uint = 0x80 /* Packet's destination address/port;
// was mangled by NAT.
//
...
pub const NSH_MD1_CONTEXT_SIZE: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_nsh_key_md1 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sample_arg {
    pub not: *mut *mut bool exec; / When true, actions in sample will,
// change flow keys. False otherwise.
//
    pub as: *mut *mut u32 probability; / Same value,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_action_trunc {
    pub /: *mut *mut __u32 max_len; / Max packet size in bytes.,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_action_push_mpls {
    pub mpls_lse: __be32,
    pub /: *mut *mut __be16 mpls_ethertype; / Either %ETH_P_MPLS_UC or %ETH_P_MPLS_MC,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_action_add_mpls {
    pub mpls_lse: __be32,
    pub /: *mut *mut __be16 mpls_ethertype; / Either %ETH_P_MPLS_UC or %ETH_P_MPLS_MC,
    pub tun_flags: __u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_action_push_vlan {
    pub /: *mut *mut __be16 vlan_tpid; / 802.1Q or 802.1ad TPID.,
    pub /: *mut *mut __be16 vlan_tci; / 802.1Q TCI (VLAN ID and priority).,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_action_hash {
    pub /: *mut *mut __u32 hash_alg; / One of ovs_hash_alg.,
    pub hash_basis: __u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovs_action_push_eth {
    pub addresses: ovs_key_ethernet,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_check_pkt_len_attr {
// private:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct check_pkt_len_arg {
    pub /: *mut *mut u16 pkt_len; / Same value as OVS_CHECK_PKT_LEN_ATTR_PKT_LEN'.,
    pub will: *mut *mut bool exec_for_greater; / When true, actions in IF_GREATER,
// not change flow keys. False otherwise.
//
    pub IF_LESS_EQUAL: *mut *mut bool exec_for_lesser_equal; / When true, actions in,
// will not change flow keys. False
// otherwise.
//
}

pub const OVS_PSAMPLE_COOKIE_MAX_SIZE: c_int = 16;
//
...
pub const OVS_METER_VERSION: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_meter_cmd {
...
pub const OVS_CT_LIMIT_VERSION: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ovs_ct_limit_cmd {
