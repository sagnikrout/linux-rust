...
//! Source: include/uapi/linux/um_timetravel.h
#![no_std]
...
pub const UM_TIMETRAVEL_MAX_FDS: c_int = 2;
//
...
pub const UM_TIMETRAVEL_SCHEDSHM_VERSION: c_int = 2;
//
...
pub struct um_timetravel_schedshm {
    pub version: __u32,
    pub len: __u32,
    pub free_until: __u64,
    pub current_time: __u64,
    pub running_id: __u16,
    pub max_clients: __u16,
}
