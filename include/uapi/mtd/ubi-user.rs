...
//! Source: include/uapi/mtd/ubi-user.h
#![no_std]
...
pub const UBI_MAX_VOLUME_NAME: c_int = 127;
...
pub const MAX_UBI_MTD_NAME_LEN: c_int = 127;
// Maximum amount of UBI volumes that can be re-named at one go
pub const UBI_MAX_RNVOL: c_int = 32;
//
...
pub struct ubi_mkvol_req {
    ...
    pub name_len: __s16,
    pub padding2: [__s8; 4],
    pub 1]: char name[UBI_MAX_VOLUME_NAME +,
    pub __packed: },
//
...
pub struct ubi_leb_change_req {
    pub lnum: __s32,
    pub bytes: __s32,
    pub /: *mut *mut __s8 dtype; / obsolete, do not use!,
    pub padding: [__s8; 7],
    pub __packed: },
//
