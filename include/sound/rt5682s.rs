...
//! Source: include/sound/rt5682s.h
#![no_std]
...
pub struct rt5682s_platform_data {
    ...
    pub dmic_clk_rate: c_uint,
    pub dmic_delay: c_uint,
    pub amic_delay: c_uint,
    pub ldo_dacref: c_uint,
    pub dmic_clk_driving_high: bool,
    pub dai_clk_names: [*const c_char; RT5682S_DAI_NUM_CLKS],
}
