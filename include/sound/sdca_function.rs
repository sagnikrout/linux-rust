...
//! Source: include/sound/sdca_function.h
#![no_std]
...
//
pub const SDCA_MAX_ENTITY_COUNT: c_int = 128;
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_messageoffset_range {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_dataport_selector_range {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_fdl_set_index_range {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_samplerateindex_range {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_requested_ps_range {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_selected_mode_range {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_detected_mode_values {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_entity0_controls {
...
pub struct sdca_control {
    ...
    pub type: sdca_control_datatype,
    pub range: sdca_control_range,
    pub mode: sdca_access_mode,
    pub layers: u8,
    pub deferrable: bool,
...
pub struct sdca_entity_iot {
    ...
    pub type: sdca_terminal_type,
    pub connector: sdca_connector_type,
    pub reference: c_int,
    pub num_transducer: c_int,
    pub is_dataport: bool,
}
...
pub struct sdca_entity_hide {
    pub hidtx_ids: *mut c_uint,
    pub hidrx_ids: *mut c_uint,
    pub num_hidtx_ids: c_int,
    pub num_hidrx_ids: c_int,
    pub af_number_list: [c_uint; SDCA_MAX_FUNCTION_COUNT],
    pub hide_reside_function_num: c_uint,
    pub max_delay: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_xu_reset_mechanism {
...
pub struct sdca_entity_xu {
    pub max_delay: c_uint,
    pub reset_mechanism: sdca_xu_reset_mechanism,
}
...
pub struct sdca_entity {
    pub label: *const c_char,
    pub id: c_int,
    pub type: sdca_entity_type,
    pub group: *mut sdca_entity,
    pub sources: *mut sdca_entity,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sdca_channel_relationship {
// Table 206 - Streaming
...
pub struct sdca_channel {
    pub id: c_int,
    pub purpose: sdca_channel_purpose,
    pub relationship: sdca_channel_relationship,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdca_function_hid {
    pub report_desc: *mut c_uchar,
    pub desc: hid_descriptor,
}
...
pub struct sdca_function_data {
    ...
    pub hid: sdca_function_hid,
}

extern "C" {
    pub fn sdca_range(_arg: range, _arg: result_col, _arg: i) -> return;
}
extern "C" {
    pub fn sdca_parse_function(dev: *mut device, function: *mut sdca_function_data) -> c_int;
}
