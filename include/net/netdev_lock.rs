...
//! Source: include/net/netdev_lock.h
#![no_std]
...
extern "C" {
    pub fn mutex_trylock(_arg: &dev->lock) -> return;
}

// Matching "ops protected" category from netdevice.h
extern "C" {
    pub fn lockdep_is_held(_arg: &dev->lock) -> return;
}
extern "C" {
    pub fn lockdep_rtnl_is_held() -> return;
}
