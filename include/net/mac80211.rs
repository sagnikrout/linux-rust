...
pub const IEEE80211_INVAL_HW_QUEUE: c_uint = 0xff;
//
...
pub struct ieee80211_tx_queue_params {
    ...
    pub uapsd: bool,
    pub mu_edca: bool,
    pub mu_edca_param_rec: ieee80211_he_mu_edca_param_ac_rec,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ieee80211_low_level_stats {
    pub dot11ACKFailureCount: c_uint,
    pub dot11RTSFailureCount: c_uint,
    pub dot11FCSErrorCount: c_uint,
    pub dot11RTSSuccessCount: c_uint,
}
...
pub struct ieee80211_chan_req {
    pub oper: cfg80211_chan_def,
    pub ap: cfg80211_chan_def,
    pub require_npca: bool,
}
...
pub struct ieee80211_chanctx_conf {
    pub def: cfg80211_chan_def,
    pub min_def: cfg80211_chan_def,
    pub ap: cfg80211_chan_def,
    pub radio_idx: c_int,
    pub rx_chains_dynamic: u8 rx_chains_static,,
...
pub struct ieee80211_vif_chanctx_switch {
    ...
    pub old_ctx: *mut ieee80211_chanctx_conf,
    pub new_ctx: *mut ieee80211_chanctx_conf,
}
...
//
pub const IEEE80211_BSS_ARP_ADDR_LIST_LEN: c_int = 4;
//
...
pub struct ieee80211_rssi_event {
    pub data: ieee80211_rssi_event_data,
}
...
pub struct ieee80211_mlme_event {
    pub data: ieee80211_mlme_event_data,
    pub status: ieee80211_mlme_event_status,
    pub reason: u16,
}
...
pub struct ieee80211_event {
    pub type: ieee80211_event_type,
    pub rssi: ieee80211_rssi_event,
    pub mlme: ieee80211_mlme_event,
    pub ba: ieee80211_ba_event,
    pub u: },
}
...
pub const IEEE80211_TPE_EIRP_ENTRIES_320MHZ: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ieee80211_parsed_tpe_eirp {
    pub valid: bool,
    pub power: [i8; IEEE80211_TPE_EIRP_ENTRIES_320MHZ],
    pub count: u8,
}

pub const IEEE80211_TPE_PSD_ENTRIES_320MHZ: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ieee80211_parsed_tpe_psd {
    pub valid: bool,
    pub power: [i8; IEEE80211_TPE_PSD_ENTRIES_320MHZ],
    pub n: u8 count,,
}
...
pub struct ieee80211_parsed_tpe {
    pub max_reg_client: [ieee80211_parsed_tpe_eirp max_local[2],; 2],
    pub psd_reg_client: [ieee80211_parsed_tpe_psd psd_local[2],; 2],
}
...
pub struct ieee80211_bss_conf {
    ...
    pub uora_exists: bool,
    pub uora_ocw_range: u8,
    pub frame_time_rts_th: u16,
    pub he_support: bool,
...
// erp related data
    ...
    pub mu_group: ieee80211_mu_group_data,
    pub qos: bool,
    pub hidden_ssid: bool,
    pub txpower: c_int,
    pub txpower_type: nl80211_tx_power_setting,
    pub p2p_noa_attr: ieee80211_p2p_noa_attr,
    pub allow_p2p_go_ps: bool,
    pub max_idle_period: u16,
    pub protected_keep_alive: bool,
    pub ftm_responder: bool,
    pub ftmr_params: *mut ieee80211_ftm_responder_params,
// Multiple BSSID data
    pub nontransmitted: bool,
    pub tx_bss_conf: *mut ieee80211_bss_conf __rcu,
    pub transmitter_bssid: [u8; ETH_ALEN],
    pub bssid_index: u8,
    ...
    pub fils_discovery: ieee80211_fils_discovery,
    pub unsol_bcast_probe_resp_interval: u32,
    pub beacon_tx_rate: cfg80211_bitrate_mask,
    pub power_type: ieee80211_ap_reg_power,
    pub tpe: ieee80211_parsed_tpe,
    pub pwr_reduction: u8,
    pub eht_support: bool,
    pub epcs_support: bool,
    pub uhr_support: bool,
    pub csa_active: bool,
    pub mu_mimo_owner: bool,
    pub chanctx_conf: *mut ieee80211_chanctx_conf __rcu,
    pub color_change_active: bool,
    pub color_change_color: u8,
    pub ht_ldpc: bool,
    pub vht_ldpc: bool,
    pub he_ldpc: bool,
    pub vht_su_beamformer: bool,
    pub vht_su_beamformee: bool,
    pub vht_mu_beamformer: bool,
    pub vht_mu_beamformee: bool,
    pub he_su_beamformer: bool,
    pub he_su_beamformee: bool,
    pub he_mu_beamformer: bool,
    pub he_full_ul_mumimo: bool,
    pub eht_su_beamformer: bool,
    pub eht_su_beamformee: bool,
    pub eht_mu_beamformer: bool,
    pub eht_80mhz_full_bw_ul_mumimo: bool,
    pub eht_disable_mcs15: bool,
    pub bss_param_ch_cnt: u8,
    pub bss_param_ch_cnt_link_id: u8,
    pub enh_bss_param_ch_cnt: u8,
    pub enh_bss_param_ch_cnt_link_id: u8,
    pub s1g_long_beacon_period: u8,
    pub npca: ieee80211_bss_npca_params,
}

pub const IEEE80211_NAN_MAX_CHANNELS: c_int = 3;
//
...
pub struct ieee80211_nan_peer_map {
    pub map_id: u8,
    pub slots: [*mut ieee80211_nan_channel; CFG80211_NAN_SCHED_NUM_TIME_SLOTS],
}
...
pub struct ieee80211_nan_peer_sched {
    ...
    pub ulw_size: u16,
    pub maps: [ieee80211_nan_peer_map; CFG80211_NAN_MAX_PEER_MAPS],
    pub n_channels: u8,
    pub __counted_by(n_channels): ieee80211_nan_channel channels[],
}
...
pub const IEEE80211_TX_CTL_STBC_SHIFT: c_int = 23;
...
pub const IEEE80211_LINK_UNSPECIFIED: c_uint = 0xf;
...
pub const IEEE80211_TX_INFO_DRIVER_DATA_SIZE: c_int = 40;
// if you do need the rateset, then you have less space
pub const IEEE80211_TX_INFO_RATE_DRIVER_DATA_SIZE: c_int = 24;
// maximum number of rate stages
pub const IEEE80211_TX_MAX_RATES: c_int = 4;
// maximum number of rate table entries
pub const IEEE80211_TX_RATE_TABLE_SIZE: c_int = 4;
//
...
pub struct ieee80211_tx_rate {
    pub idx: i8,
    pub __packed: },
pub const IEEE80211_MAX_TX_RETRY: c_int = 31;
    pub 0: return rate->idx >= 0 && rate->count >,
    pub ~0xF): WARN_ON(mcs &,
    pub ~0x7): WARN_ON((nss - 1) &,
    pub mcs: rate->idx = ((nss - 1) << 4) |,
    pub 0xF: return rate->idx &,
    pub 1: return (rate->idx >> 4) +,
//
...
pub struct ieee80211_tx_status {
    ...
    pub skb: *mut sk_buff,
    pub rates: *mut ieee80211_rate_status,
    pub ack_hwtstamp: ktime_t,
    pub n_rates: u8,
...
pub struct ieee80211_scan_ies {
    pub ies: [*const u8; NUM_NL80211_BANDS],
    pub len: [usize; NUM_NL80211_BANDS],
    pub common_ies: *const u8,
    pub common_ie_len: usize,
}
...
pub const RX_ENC_FLAG_STBC_SHIFT: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
...
pub struct ieee80211_conf {
    pub flags: u32,
    pub dynamic_ps_timeout: int power_level,,
    pub listen_interval: u16,
    pub ps_dtim_period: u8,
    pub short_frame_max_tx_count: u8 long_frame_max_tx_count,,
...
pub const IEEE80211_NAN_AVAIL_BLOB_MAX_LEN: c_int = 54;
//
...
pub struct ieee80211_eml_params {
    ...
    pub control: u8,
    pub link_bitmap: u16,
    pub emlmr_mcs_map_count: u8,
    pub emlmr_mcs_map_bw: [u8; 9],
}
...
pub struct ieee80211_nan_sched_cfg {
    pub channels: [ieee80211_nan_channel; IEEE80211_NAN_MAX_CHANNELS],
    pub schedule: [*mut ieee80211_nan_channel; CFG80211_NAN_SCHED_NUM_TIME_SLOTS],
    pub avail_blob: [u8; IEEE80211_NAN_AVAIL_BLOB_MAX_LEN],
    pub avail_blob_len: u16,
    pub deferred: bool,
}
...
// association related data
    pub ibss_joined: bool assoc,,
    pub ibss_creator: bool,
    pub ps: bool,
    pub aid: u16,
    pub eml_cap: u16,
    pub eml_med_sync_delay: u16,
    pub mld_capa_op: u16,
    pub arp_addr_list: [__be32; IEEE80211_BSS_ARP_ADDR_LIST_LEN],
    pub arp_addr_cnt: c_int,
...
// Protected by the wiphy mutex
    pub nan_sched: ieee80211_nan_sched_cfg,
}

pub const IEEE80211_TTLM_NUM_TIDS: c_int = 8;
//
...
pub struct ieee80211_neg_ttlm {
    pub downlink: [u16; IEEE80211_TTLM_NUM_TIDS],
    pub uplink: [u16; IEEE80211_TTLM_NUM_TIDS],
    pub valid: bool,
}
...
pub struct ieee80211_vif {
    ...
    pub cfg: ieee80211_vif_cfg,
    pub bss_conf: ieee80211_bss_conf,
    pub link_conf: [*mut ieee80211_bss_conf __rcu; IEEE80211_MLD_MAX_NUM_LINKS],
    pub suspended_links: u16 valid_links, active_links, dormant_links,,
    pub neg_ttlm: ieee80211_neg_ttlm,
    pub __aligned(2): u8 addr[ETH_ALEN],
    pub addr_valid: bool,
    pub p2p: bool,
    pub cab_queue: u8,
    pub hw_queue: [u8; IEEE80211_NUM_ACS],
    pub txq: *mut ieee80211_txq,
    pub txq_mgmt: *mut ieee80211_txq,
...
//
extern "C" {
    pub fn lockdep_is_held(_arg: &ieee80211_vif_to_wdev(vif)->wiphy->mtx) -> return;
}
...
pub struct ieee80211_key_conf {
    pub tx_pn: core::sync::atomic::AtomicI64,
    pub cipher: u32,
    pub icv_len: u8,
    pub iv_len: u8,
    pub hw_key_idx: u8,
...
pub const IEEE80211_MAX_PN_LEN: c_int = 16;
...
pub struct ieee80211_key_seq {
    ...
    pub pn: [u8; 6],
    pub gcmp: },
    pub seq: [u8; IEEE80211_MAX_PN_LEN],
    pub seq_len: u8,
    pub hw: },
}
...
pub struct ieee80211_sta_rates {
    ...
    pub count_rts: u8,
    pub flags: u16,
    pub rate: [}; IEEE80211_TX_RATE_TABLE_SIZE],
}
...
pub struct ieee80211_sta_aggregates {
    ...
    pub max_tid_amsdu_len: [u16; IEEE80211_NUM_TIDS],
}
...
pub struct ieee80211_link_sta {
    ...
    pub link_id: u8,
    pub smps_mode: ieee80211_smps_mode,
    pub supp_rates: [u32; NUM_NL80211_BANDS],
    ...
    pub agg: ieee80211_sta_aggregates,
    pub rx_nss: u8,
    pub bandwidth: ieee80211_sta_rx_bandwidth,
    pub txpwr: ieee80211_sta_txpwr,
}
...
pub struct ieee80211_sta {
    ...
    pub uapsd_queues: u8,
    pub max_sp: u8,
    pub rates: *mut ieee80211_sta_rates __rcu,
    pub tdls: bool,
    ...
    pub eml_cap: u16,
    pub cur: *mut ieee80211_sta_aggregates,
    pub support_p2p_ps: bool,
    pub 1]: *mut *mut ieee80211_txq txq[IEEE80211_NUM_TIDS +,
    pub valid_links: u16,
    pub ext_mld_capa_ops: u16,
    pub epp_peer: bool,
    pub deflink: ieee80211_link_sta,
    pub link: [*mut ieee80211_link_sta __rcu; IEEE80211_MLD_MAX_NUM_LINKS],
    pub nmi: *mut ieee80211_sta __rcu,
// should only be accessed with the wiphy mutex held
    pub nan_sched: *mut ieee80211_nan_peer_sched,
// must be last
    pub )): *mut u8 drv_priv[] __aligned(sizeof(void,
}

extern "C" {
    pub fn lockdep_sta_mutex_held(pubsta: *mut ieee80211_sta) -> bool;
}
...
pub struct ieee80211_hw {
    pub conf: ieee80211_conf,
    pub wiphy: *mut wiphy,
    pub rate_control_algorithm: *const c_char,
    pub priv: *mut c_void,
    pub flags: [c_ulong; BITS_TO_LONGS(NUM_IEEE80211_HW_FLAGS)],
    pub extra_tx_headroom: c_uint,
    pub extra_beacon_tailroom: c_uint,
    pub vif_data_size: c_int,
    pub sta_data_size: c_int,
    pub chanctx_data_size: c_int,
    pub txq_data_size: c_int,
    pub queues: u16,
    ...
    pub units_pos: c_int,
    pub accuracy: i16,
    pub radiotap_timestamp: },
    pub netdev_features: netdev_features_t,
    pub uapsd_queues: u8,
    pub uapsd_max_sp_len: u8,
    pub max_nan_de_entries: u8,
    pub tx_sk_pacing_shift: u8,
    pub weight_multiplier: u8,
    pub max_mtu: u32,
    pub tx_power_levels: *const i8,
    pub max_txpwr_levels_idx: u8,
}

extern "C" {
    pub fn test_bit(_arg: flg, _arg: hw->flags) -> return;
}

extern "C" {
    pub fn __set_bit(_arg: flg, _arg: hw->flags) -> return;
}
...
pub struct ieee80211_tdls_ch_sw_params {
    ...
    pub timestamp: u32,
    pub switch_time: u16,
    pub switch_timeout: u16,
    pub tmpl_skb: *mut sk_buff,
    pub ch_sw_tm_ie: u32,
}
...
//
extern "C" {
    pub fn ieee80211_free_txskb(hw: *mut ieee80211_hw, skb: *mut sk_buff);
}
//
...
pub const IEEE80211_AMPDU_TX_START_IMMEDIATE: c_int = 1;
pub const IEEE80211_AMPDU_TX_START_DELAY_ADDBA: c_int = 2;
//
...
pub struct ieee80211_ampdu_params {
    pub action: ieee80211_ampdu_mlme_action,
    pub sta: *mut ieee80211_sta,
    pub tid: u16,
    pub ssn: u16,
    pub buf_size: u16,
...
pub struct ieee80211_ops {
    pub skb): *mut sk_buff,
    pub hw): *mut *mut int (start)(struct ieee80211_hw,
    pub suspend): *mut *mut *mut void (stop)(struct ieee80211_hw hw, bool,

    pub wowlan): *mut *mut *mut int (suspend)(struct ieee80211_hw hw, struct cfg80211_wowlan,
    pub hw): *mut *mut int (resume)(struct ieee80211_hw,
    pub enabled): *mut *mut *mut void (set_wakeup)(struct ieee80211_hw hw, bool,

    pub vif): *mut ieee80211_vif,
    pub p2p): nl80211_iftype new_type, bool,
    pub vif): *mut ieee80211_vif,
    pub changed): *mut *mut *mut int (config)(struct ieee80211_hw hw, int radio_idx, u32,
    pub changed): u64,
    pub changed): u64,
    pub changed): u64,
    pub link_conf): *mut ieee80211_bss_conf,
    pub link_conf): *mut ieee80211_bss_conf,
    pub mc_list): *mut netdev_hw_addr_list,
    pub multicast): u64,
    pub changed_flags): c_uint,
    pub set): bool,
    pub key): *mut ieee80211_key_conf,
    pub phase1key): *mut u32 iv32, u16,
    pub data): *mut cfg80211_gtk_rekey_data,
    pub idx): *mut *mut ieee80211_vif vif, int,
    ...
    pub vif): *mut ieee80211_vif,
    pub stats): *mut ieee80211_low_level_stats,
    pub seq): *mut ieee80211_key_seq,
    pub value): u32,
    pub value): u32,
    pub sta): *mut ieee80211_sta,
    pub sta): *mut ieee80211_sta,
    ...
    pub sta): *mut sta_notify_cmd, struct ieee80211_sta,
    pub sta): *mut ieee80211_sta,
    pub new_state): ieee80211_sta_state,
    pub sta): *mut ieee80211_sta,
    pub changed): u32,
    pub sta): *mut ieee80211_sta,
    pub sinfo): *mut station_info,
    pub params): *const ieee80211_tx_queue_params,
    pub vif): *mut *mut *mut u64 (get_tsf)(struct ieee80211_hw hw, struct ieee80211_vif,
    pub tsf): u64,
    pub offset): i64,
    pub vif): *mut *mut *mut void (reset_tsf)(struct ieee80211_hw hw, struct ieee80211_vif,
    pub hw): *mut *mut int (tx_last_beacon)(struct ieee80211_hw,
    pub link_sinfo): *mut link_station_info,
//
// @ampdu_action:
...
//
    ...
    pub hw): *mut *mut void (rfkill_poll)(struct ieee80211_hw,
    pub coverage_class): i16,

    pub len): *mut *mut void data, int,
    pub len): *mut *mut void data, int,

    pub drop): u32 queues, bool,
    pub sta): *mut ieee80211_sta,
    ...
    pub vif): *mut ieee80211_vif,
    pub rx): *mut *mut *mut int (set_ringparam)(struct ieee80211_hw hw, u32 tx, u32,
    pub rx_max): *mut *mut *mut *mut u32 tx, u32 tx_max, u32 rx, u32,
    pub hw): *mut *mut bool (tx_frames_pending)(struct ieee80211_hw,
    pub mask): *const cfg80211_bitrate_mask,
    pub event): *const ieee80211_event,
    pub more_data): bool,
    pub more_data): bool,
    pub sset): *mut *mut ieee80211_vif vif, int,
    pub data): *mut *mut ethtool_stats stats, u64,
    pub data): *mut u32 sset, u8,
    pub info): *mut ieee80211_prep_tx_info,
    pub info): *mut ieee80211_prep_tx_info,
    pub link_id): c_uint,
    ...
    pub ctx): *mut ieee80211_chanctx_conf,
    pub ctx): *mut ieee80211_chanctx_conf,
    pub mode): ieee80211_chanctx_switch_mode,
    pub reconfig_type): ieee80211_reconfig_type,
    ...
    pub link_conf): *mut ieee80211_bss_conf,
    pub ch_switch): *mut ieee80211_channel_switch,
    pub vif): *mut *mut *mut int (join_ibss)(struct ieee80211_hw hw, struct ieee80211_vif,
    pub vif): *mut *mut *mut void (leave_ibss)(struct ieee80211_hw hw, struct ieee80211_vif,
    pub sta): *mut ieee80211_sta,
    pub dbm): *mut unsigned int link_id, int,
    pub ch_sw_tm_ie): *mut *mut sk_buff tmpl_skb, u32,
    pub sta): *mut ieee80211_sta,
    pub params): *mut ieee80211_tdls_ch_sw_params,
    pub txq): *mut ieee80211_txq,
    pub hw): *mut *mut void (sync_rx_queues)(struct ieee80211_hw,
    pub conf): *mut cfg80211_nan_conf,
    pub vif): *mut ieee80211_vif,
    pub changes): *mut *mut cfg80211_nan_conf conf, u32,
    pub nan_func): *const cfg80211_nan_func,
    pub instance_id): u8,
    pub sta): *mut ieee80211_sta,
    pub skb): *mut sk_buff,
    ...
    pub tids): *mut *mut ieee80211_sta sta, u8,
    pub vif): *mut ieee80211_vif,
    pub enabled): *mut *mut ieee80211_sta sta, bool,
    pub sar): *const cfg80211_sar_specs,
    pub enabled): *mut *mut ieee80211_sta sta, bool,
    pub twt): *mut ieee80211_twt_setup,
    pub flowid): *mut *mut ieee80211_sta sta, u8,
    pub chandef): *mut cfg80211_chan_def,
    pub path): *mut net_device_path,
    pub active_links): u16,
    pub old[IEEE80211_MLD_MAX_NUM_LINKS]): *mut ieee80211_bss_conf,
    pub new_links): u16 old_links, u16,
    pub hwts): *mut cfg80211_set_hw_timestamp,
    pub type_data): *mut c_void,
    pub ttlm): *mut ieee80211_neg_ttlm,
    pub type): nl80211_iftype,
    pub eml_params): *mut ieee80211_eml_params,
}
...
//
extern "C" {
    pub fn ieee80211_alloc_hw_nm(_arg: priv_data_len, _arg: ops, _arg: NULL) -> return;
}
//
...
//
extern "C" {
    pub fn ieee80211_register_hw(hw: *mut ieee80211_hw) -> c_int;
}
//
...
extern "C" {
    pub fn __ieee80211_get_tx_led_name(_arg: hw) -> return;
}
...
extern "C" {
    pub fn __ieee80211_get_rx_led_name(_arg: hw) -> return;
}
...
extern "C" {
    pub fn __ieee80211_get_assoc_led_name(_arg: hw) -> return;
}
...
extern "C" {
    pub fn __ieee80211_get_radio_led_name(_arg: hw) -> return;
}
...
//
extern "C" {
    pub fn ieee80211_unregister_hw(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_free_hw(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_restart_hw(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_rx_irqsafe(hw: *mut ieee80211_hw, skb: *mut sk_buff);
}
//
...
//
extern "C" {
    pub fn ieee80211_sta_ps_transition(sta: *mut ieee80211_sta, start: bool) -> c_int;
}
//
...
//
extern "C" {
    pub fn ieee80211_sta_pspoll(sta: *mut ieee80211_sta);
}
//
...
//
extern "C" {
    pub fn ieee80211_sta_uapsd_trigger(sta: *mut ieee80211_sta, tid: u8);
}
//
...
//
extern "C" {
    pub fn ieee80211_report_low_ack(sta: *mut ieee80211_sta, num_packets: u32);
}
pub const IEEE80211_MAX_CNTDWN_COUNTERS_NUM: c_int = 2;
//
...
pub struct ieee80211_mutable_offsets {
    pub tim_offset: u16,
    pub tim_length: u16,
    pub cntdwn_counter_offs: [u16; IEEE80211_MAX_CNTDWN_COUNTERS_NUM],
    pub mbssid_off: u16,
}
...
pub struct ieee80211_ema_beacons {
    pub cnt: u8,
    pub skb: *mut sk_buff,
    pub offs: ieee80211_mutable_offsets,
    pub bcn: [}; ],
}
...
//
extern "C" {
    pub fn ieee80211_beacon_free_ema_list(ema_beacons: *mut ieee80211_ema_beacons);
}
//
...
//
extern "C" {
    pub fn ieee80211_beacon_get_tim(_arg: hw, _arg: vif, _arg: NULL, _arg: NULL, _arg: link_id) -> return;
}
//
...
//
extern "C" {
    pub fn ieee80211_beacon_set_cntdwn(vif: *mut ieee80211_vif, counter: u8);
}
//
...
//
extern "C" {
    pub fn ieee80211_csa_finish(vif: *mut ieee80211_vif, link_id: c_uint);
}
//
...
//
extern "C" {
    pub fn ieee80211_color_change_finish(vif: *mut ieee80211_vif, link_id: u8);
}
//
...
//
extern "C" {
    pub fn ieee80211_key_mic_failure(keyconf: *mut ieee80211_key_conf);
}
//
...
//
extern "C" {
    pub fn ieee80211_key_replay(keyconf: *mut ieee80211_key_conf);
}
//
...
//
extern "C" {
    pub fn ieee80211_wake_queue(hw: *mut ieee80211_hw, queue: c_int);
}
//
...
//
extern "C" {
    pub fn ieee80211_stop_queue(hw: *mut ieee80211_hw, queue: c_int);
}
//
...
//
extern "C" {
    pub fn ieee80211_queue_stopped(hw: *mut ieee80211_hw, queue: c_int) -> c_int;
}
//
...
//
extern "C" {
    pub fn ieee80211_stop_queues(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_wake_queues(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_sched_scan_results(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_sched_scan_stopped(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_queue_work(hw: *mut ieee80211_hw, work: *mut work_struct);
}
//
...
//
extern "C" {
    pub fn ieee80211_stop_tx_ba_session(sta: *mut ieee80211_sta, tid: u16) -> c_int;
}
//
...
//
extern "C" {
    pub fn ieee80211_sta_eosp(pubsta: *mut ieee80211_sta);
}
//
...
//
extern "C" {
    pub fn ieee80211_send_eosp_nullfunc(pubsta: *mut ieee80211_sta, tid: c_int);
}
//
...
//
extern "C" {
    pub fn ieee80211_sta_recalc_aggregates(pubsta: *mut ieee80211_sta);
}
//
...
//
extern "C" {
    pub fn ieee80211_beacon_loss(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_connection_loss(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_disconnect(vif: *mut ieee80211_vif, reconnect: bool);
}
//
...
//
extern "C" {
    pub fn ieee80211_resume_disconnect(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_hw_restart_disconnect(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_cqm_beacon_loss_notify(vif: *mut ieee80211_vif, gfp: gfp_t);
}
//
...
//
extern "C" {
    pub fn ieee80211_channel_switch_disconnect(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_ready_on_channel(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_remain_on_channel_expired(hw: *mut ieee80211_hw);
}
//
...
//
extern "C" {
    pub fn ieee80211_send_bar(vif: *mut ieee80211_vif, ra: *mut u8, tid: u16, ssn: u16);
}
//
...
pub struct ieee80211_tx_rate_control {
    ...
    pub bss_conf: *mut ieee80211_bss_conf,
    pub skb: *mut sk_buff,
    pub reported_rate: ieee80211_tx_rate,
    pub short_preamble: bool rts,,
    pub rate_idx_mask: u32,
    pub rate_idx_mcs_mask: *mut u8,
    pub bss: bool,
}
...
pub struct rate_control_ops {
    ...
    pub hw): *mut *mut *mut void (alloc)(struct ieee80211_hw,
    pub debugfsdir): *mut dentry,
    pub priv): *mut *mut void (free)(void,
    pub gfp): *mut *mut *mut *mut *mut void (alloc_sta)(void priv, struct ieee80211_sta sta, gfp_t,
    pub priv_sta): *mut *mut ieee80211_sta sta, void,
    pub changed): u32,
    pub priv_sta): *mut c_void,
    pub st): *mut *mut void priv_sta, struct ieee80211_tx_status,
    pub skb): *mut sk_buff,
    pub txrc): *mut ieee80211_tx_rate_control,
    pub dir): *mut dentry,
    pub priv_sta): *mut *mut u32 (get_expected_throughput)(void,
}
...
//
extern "C" {
    pub fn ieee80211_rate_control_register(ops: *const rate_control_ops) -> c_int;
}
extern "C" {
    pub fn ieee80211_rate_control_unregister(ops: *const rate_control_ops);
}
extern "C" {
    pub fn ieee80211_iftype_p2p(_arg: vif->type, _arg: vif->p2p) -> return;
}
//
...
//
extern "C" {
    pub fn ieee80211_get_he_iftype_cap(_arg: sband, _arg: ieee80211_vif_type_p2p(vif)) -> return;
}
//
...
//
extern "C" {
    pub fn ieee80211_get_he_6ghz_capa(_arg: sband, _arg: ieee80211_vif_type_p2p(vif)) -> return;
}
//
...
//
extern "C" {
    pub fn ieee80211_get_eht_iftype_cap(_arg: sband, _arg: ieee80211_vif_type_p2p(vif)) -> return;
}
//
...
//
extern "C" {
    pub fn ieee80211_get_uhr_iftype_cap(_arg: sband, _arg: ieee80211_vif_type_p2p(vif)) -> return;
}
//
...
//
extern "C" {
    pub fn ieee80211_disable_rssi_reports(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_ave_rssi(vif: *mut ieee80211_vif, link_id: c_int) -> c_int;
}
//
...
pub struct ieee80211_noa_data {
    pub next_tsf: u32,
    pub has_next_tsf: bool,
    pub absent: u8,
    pub count: [u8; IEEE80211_P2P_NOA_DESC_MAX],
    pub start: u32,
    pub duration: u32,
    pub interval: u32,
    pub desc: [}; IEEE80211_P2P_NOA_DESC_MAX],
}
...
//
extern "C" {
    pub fn ieee80211_update_p2p_noa(data: *mut ieee80211_noa_data, tsf: u32);
}
//
...
//
extern "C" {
    pub fn ieee80211_reserve_tid(sta: *mut ieee80211_sta, tid: u8) -> c_int;
}
//
...
//
extern "C" {
    pub fn ieee80211_unreserve_tid(sta: *mut ieee80211_sta, tid: u8);
}
//
...
//
extern "C" {
    pub fn ieee80211_txq_schedule_start(hw: *mut ieee80211_hw, ac: u8);
}
// (deprecated)
//
...
//
extern "C" {
    pub fn ieee80211_nan_sched_update_done(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_set_active_links(vif: *mut ieee80211_vif, active_links: u16) -> c_int;
}
//
...
//
extern "C" {
    pub fn ieee80211_send_teardown_neg_ttlm(vif: *mut ieee80211_vif);
}
//
...
//
extern "C" {
    pub fn ieee80211_finalize_rx_omi_bw(link_sta: *mut ieee80211_link_sta);
}
...
//
extern "C" {
    pub fn ieee80211_vif_nan_started(vif: *mut ieee80211_vif) -> bool;
}
//
...
//
extern "C" {
    pub fn ieee80211_encrypt_tx_skb(skb: *mut sk_buff) -> c_int;
}
