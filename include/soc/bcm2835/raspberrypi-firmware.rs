...
//! Source: include/soc/bcm2835/raspberrypi-firmware.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpi_firmware_get_voltage_request {
    pub id: __le32,
    pub value: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpi_firmware_clk_rate_request {
    pub id: __le32,
    pub rate: __le32,
    pub __packed: },

    pub len): *mut *mut u32 tag, void data, size_t,
    pub tag_size): *mut *mut void data, size_t,
    pub fw): *mut void rpi_firmware_put(struct rpi_firmware,
    pub id): c_uint,
    pub rpi_firmware_find_node(void): *mut device_node,
    pub firmware_node): *mut *mut rpi_firmware rpi_firmware_get(device_node,
    pub firmware_node): *mut device_node,
