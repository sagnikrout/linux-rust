...
pub const CRYPTO_AHASH_REQ_VIRT: c_uint = 0x00000001;
...
pub struct ahash_alg {
    pub req): *mut *mut int (init)(struct ahash_request,
    ...
    pub req): *mut *mut int (digest)(struct ahash_request,
    pub out): *mut *mut *mut int (export)(struct ahash_request req, void,
    pub in): *const *const *const int (import)(struct ahash_request req, void,
    pub out): *mut *mut *mut int (export_core)(struct ahash_request req, void,
    pub in): *const *const *const int (import_core)(struct ahash_request req, void,
    pub keylen): c_uint,
    pub tfm): *mut *mut int (init_tfm)(struct crypto_ahash,
    pub tfm): *mut *mut void (exit_tfm)(struct crypto_ahash,
...
pub struct shash_desc {
    ...
    pub __aligned(ARCH_SLAB_MINALIGN): *mut *mut void __ctx[],
}

pub const HASH_MAX_DIGESTSIZE: c_int = 64;
//
...
pub const S390_SHA_CTX_SIZE: c_int = 216;
//
...
pub struct shash_alg {
    pub desc): *mut *mut int (init)(struct shash_desc,
    pub len): c_uint,
    pub out): *mut *mut *mut int (final)(struct shash_desc desc, u8,
    pub out): *mut unsigned int len, u8,
    pub out): *mut unsigned int len, u8,
    pub out): *mut *mut *mut int (export)(struct shash_desc desc, void,
    pub in): *const *const *const int (import)(struct shash_desc desc, void,
    pub out): *mut *mut *mut int (export_core)(struct shash_desc desc, void,
    pub in): *const *const *const int (import_core)(struct shash_desc desc, void,
    pub keylen): c_uint,
    pub tfm): *mut *mut int (init_tfm)(struct crypto_shash,
    pub tfm): *mut *mut void (exit_tfm)(struct crypto_shash,
    pub descsize: c_uint,
    pub HASH_ALG_COMMON: struct,
    pub halg: hash_alg_common,
}
...
pub struct crypto_ahash {
    pub /: *mut *mut bool using_shash; / Underlying algorithm is shash, not ahash,
    pub statesize: c_uint,
    pub reqsize: c_uint,
    pub base: crypto_tfm,
}
...
extern "C" {
    pub fn container_of(_arg: tfm, crypto_ahash: struct, _arg: base) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_has_ahash(alg_name: *const c_char, type: u32, mask: u32) -> c_int;
}
extern "C" {
    pub fn crypto_tfm_alg_name(_arg: crypto_ahash_tfm(tfm)) -> return;
}
extern "C" {
    pub fn crypto_tfm_alg_driver_name(_arg: crypto_ahash_tfm(tfm)) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_tfm_alg_blocksize(_arg: crypto_ahash_tfm(tfm)) -> return;
}
extern "C" {
    pub fn container_of(_arg: alg, hash_alg_common: struct, _arg: base) -> return;
}
extern "C" {
    pub fn __crypto_hash_alg_common(_arg: crypto_ahash_tfm(tfm)->__crt_alg) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_tfm_get_flags(_arg: crypto_ahash_tfm(tfm)) -> return;
}
//
...
//
extern "C" {
    pub fn __crypto_ahash_cast(_arg: req->base.tfm) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_ahash_finup(req: *mut ahash_request) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_ahash_finup(_arg: req) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_ahash_digest(req: *mut ahash_request) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_ahash_export(req: *mut ahash_request, out: *mut c_void) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_ahash_import(req: *mut ahash_request, in: *const c_void) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_ahash_init(req: *mut ahash_request) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_ahash_update(req: *mut ahash_request) -> c_int;
}
//
...
extern "C" {
    pub fn container_of(_arg: req, ahash_request: struct, _arg: base) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_has_shash(alg_name: *const c_char, type: u32, mask: u32) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_tfm_alg_name(_arg: crypto_shash_tfm(tfm)) -> return;
}
extern "C" {
    pub fn crypto_tfm_alg_driver_name(_arg: crypto_shash_tfm(tfm)) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_tfm_alg_blocksize(_arg: crypto_shash_tfm(tfm)) -> return;
}
extern "C" {
    pub fn container_of(_arg: alg, shash_alg: struct, _arg: base) -> return;
}
extern "C" {
    pub fn __crypto_shash_alg(_arg: crypto_shash_tfm(tfm)->__crt_alg) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_tfm_get_flags(_arg: crypto_shash_tfm(tfm)) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_shash_export(desc: *mut shash_desc, out: *mut c_void) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_shash_import(desc: *mut shash_desc, in: *const c_void) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_shash_init(desc: *mut shash_desc) -> c_int;
}
//
...
//
extern "C" {
    pub fn crypto_shash_finup(_arg: desc, _arg: data, _arg: len, _arg: NULL) -> return;
}
//
...
//
extern "C" {
    pub fn crypto_shash_finup(_arg: desc, _arg: NULL, _arg: 0, _arg: out) -> return;
}
extern "C" {
    pub fn crypto_tfm_is_async(_arg: &tfm->base) -> return;
}
