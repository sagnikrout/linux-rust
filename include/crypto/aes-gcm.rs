...
//! Source: include/crypto/aes-gcm.h
#![no_std]
...
//
    ...
    pub 4]: __be32 ctr32[AES_BLOCK_SIZE /,
    pub __aligned(__alignof__(long)): },
// Buffered keystream for partial block updates
    pub __aligned(__alignof__(long)): u8 keystream[AES_BLOCK_SIZE],
// Encrypted counter of 1.  This gets XOR'ed with the tag at the end.
    pub __aligned(__alignof__(long)): u8 j0_enc[AES_BLOCK_SIZE],
