...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_cs5530 {
    pub card: *mut snd_card,
    pub pci: *mut pci_dev,
    pub sb: *mut snd_sb,
    pub pci_base: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn snd_cs5530_mixer_read(io: c_ulong, reg: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if((1<<6): map &) -> else {
    else if (map & (1<<6))
    ...
    dma16 = 5;
#[no_mangle]
pub unsafe extern "C" fn if(0x40: dma8 &) -> else {
    else if (dma8 & 0x40)
    dma16 = 6;
#[no_mangle]
pub unsafe extern "C" fn if(0x80: dma8 &) -> else {
    else if (dma8 & 0x80)
    dma16 = 7;
    else {
    ...
    dma8 = 0;
#[no_mangle]
pub unsafe extern "C" fn if(02: dma8 &) -> else {
    else if (dma8 & 02)
    dma8 = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0x08: dma8 &) -> else {
    else if (dma8 & 0x08)
    dma8 = 3;
    else {
    ...
    irq = 9;
#[no_mangle]
pub unsafe extern "C" fn if(2: irq &) -> else {
    else if (irq & 2)
    irq = 5;
#[no_mangle]
pub unsafe extern "C" fn if(4: irq &) -> else {
    else if (irq & 4)
    irq = 7;
#[no_mangle]
pub unsafe extern "C" fn if(8: irq &) -> else {
    else if (irq & 8)
    irq = 10;
    else {
