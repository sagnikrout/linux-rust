...
//! Source: sound/pci/aw2/aw2-alsa.c
#![no_std]
...
// DEFINES
//
pub const CTL_ROUTE_ANALOG: c_int = 0;
pub const CTL_ROUTE_DIGITAL: c_int = 1;
//
// TYPEDEFS
//
// hardware definition
...
pub struct aw2 {
    ...
    pub iobase_virt: *mut void __iomem,
...
// close callback
#[no_mangle]
unsafe extern "C" fn snd_aw2_pcm_playback_close(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_aw2_pcm_playback_close(struct snd_pcm_substream *substream)
    {
    return 0;
    }
...
// close callback
#[no_mangle]
unsafe extern "C" fn snd_aw2_pcm_capture_close(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_aw2_pcm_capture_close(struct snd_pcm_substream *substream)
    {
