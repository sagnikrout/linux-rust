...
//! Source: sound/pci/riptide/riptide.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn Linuxant(_arg: riptide-0.6lnxtbeta03111100) -> This Driver is based on the OSS Driver version from {
...
pub const SUPPORT_JOYSTICK: c_int = 1;
    ...
    module_param_hw_array(mpu_port, int, ioport, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(mpu_port, "MPU401 port # for Riptide driver.");
    module_param_hw_array(opl3_port, int, ioport, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(opl3_port, "OPL3 port # for Riptide driver.");
//

pub const PCI_EXT_CapId: c_uint = 0x40;
pub const PCI_EXT_NextCapPrt: c_uint = 0x41;
pub const PCI_EXT_PWMC: c_uint = 0x42;
pub const PCI_EXT_PWSCR: c_uint = 0x44;
pub const PCI_EXT_Data00: c_uint = 0x46;
pub const PCI_EXT_PMSCR_BSE: c_uint = 0x47;
pub const PCI_EXT_SB_Base: c_uint = 0x48;
pub const PCI_EXT_FM_Base: c_uint = 0x4a;
pub const PCI_EXT_MPU_Base: c_uint = 0x4C;
pub const PCI_EXT_Game_Base: c_uint = 0x4E;
pub const PCI_EXT_Legacy_Mask: c_uint = 0x50;
pub const PCI_EXT_AsicRev: c_uint = 0x52;
pub const PCI_EXT_Reserved3: c_uint = 0x53;
pub const LEGACY_ENABLE_ALL: c_uint = 0x8000	/* legacy device options */;
pub const LEGACY_ENABLE_SB: c_uint = 0x4000;
pub const LEGACY_ENABLE_FM: c_uint = 0x2000;
pub const LEGACY_ENABLE_MPU_INT: c_uint = 0x1000;
pub const LEGACY_ENABLE_MPU: c_uint = 0x0800;
pub const LEGACY_ENABLE_GAMEPORT: c_uint = 0x0400;

pub const MAX_ERROR_COUNT: c_int = 10;
pub const CMDIF_TIMEOUT: c_int = 50000;
pub const RESET_TRIES: c_int = 5;

pub const RESP: c_uint = 0x00000001		/* command flags */;
pub const PARM: c_uint = 0x00000002;
pub const CMDA: c_uint = 0x00000004;
pub const CMDB: c_uint = 0x00000008;
pub const NILL: c_uint = 0x00000000;

pub const EOB_STATUS: c_uint = 0x80000000	/* status flags : block boundary */;
pub const EOS_STATUS: c_uint = 0x40000000	/*              : stoppped */;
pub const EOC_STATUS: c_uint = 0x20000000	/*              : stream end */;
pub const ERR_STATUS: c_uint = 0x10000000;
pub const EMPTY_STATUS: c_uint = 0x08000000;
pub const IEOB_ENABLE: c_uint = 0x1	/* enable interrupts for status notification above */;
pub const IEOS_ENABLE: c_uint = 0x2;
pub const IEOC_ENABLE: c_uint = 0x4;
pub const RDONCE: c_uint = 0x8;
pub const DESC_MAX_MASK: c_uint = 0xff;
pub const ST_PLAY: c_uint = 0x1		/* stream states */;
pub const ST_STOP: c_uint = 0x2;
pub const ST_PAUSE: c_uint = 0x4;

pub const I2S_MERGER: c_int = 0;
pub const I2S_SPLITTER: c_int = 0;
pub const I2S_MIXER: c_int = 7;
pub const I2S_RATE: c_int = 44100;

pub const MODEM_MERGER: c_int = 3;
pub const MODEM_SPLITTER: c_int = 0;
pub const MODEM_MIXER: c_int = 11;

pub const FM_MERGER: c_int = 0;
pub const FM_SPLITTER: c_int = 0;
pub const FM_MIXER: c_int = 9;
pub const SPLIT_PATH: c_uint = 0x80	/* path splitting flag */;
    enum FIRMWARE {
...
#[derive(Copy, Clone)]
pub struct lbuspath {
    pub noconv: *const c_uchar,
    pub stereo: *const c_uchar,
    pub mono: *const c_uchar,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmdport {
    pub /: *mut *mut u32 data1; / cmd,param,
    pub /: *mut *mut u32 data2; / param,
    pub /: *mut *mut u32 stat; / status,
    pub pad: [u32; 5],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct riptideport {
    pub /: *mut *mut u32 audio_control; / status registers,
    pub audio_status: u32,
    pub pad: [u32; 2],
    pub /: *mut *mut cmdport port[2]; / command ports,
}
...
pub struct cmdif {
    pub dev: *mut device,
    pub hwport: *mut riptideport,
    pub lock: spinlock_t,
    pub /: *mut *mut unsigned int cmdcnt; / cmd statistics,
    pub cmdtime: c_uint,
    pub cmdtimemax: c_uint,
    pub cmdtimemin: c_uint,
    pub errcnt: c_uint,
    pub is_reset: c_int,
}
...
pub const PLAYBACK_SUBSTREAMS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_riptide {
    pub card: *mut snd_card,
    pub pci: *mut pci_dev,
    pub fw_entry: *const firmware,
    pub cif: *mut cmdif,
    pub pcm: *mut snd_pcm,
    pub pcm_i2s: *mut snd_pcm,
    pub rmidi: *mut snd_rawmidi,
    pub opl3: *mut snd_opl3,
    pub ac97: *mut snd_ac97,
    pub ac97_bus: *mut snd_ac97_bus,
    pub playback_substream: [*mut snd_pcm_substream; PLAYBACK_SUBSTREAMS],
    pub capture_substream: *mut snd_pcm_substream,
    pub openstreams: c_int,
    pub irq: c_int,
    pub port: c_ulong,
    pub mpuaddr: c_ushort,
    pub opladdr: c_ushort,

    pub gameaddr: c_ushort,

    pub res_port: *mut resource,
    pub device_id: c_ushort,
    pub firmware: union firmware_version,
    pub lock: spinlock_t,
    pub proc_entry: *mut snd_info_entry,
    pub received_irqs: c_ulong,
    pub handled_irqs: c_ulong,
...
#[derive(Copy, Clone)]
pub struct sgd {
    pub dwNextLink: __le32,
    pub dwSegPtrPhys: __le32,
    pub dwSegLen: __le32,
    pub dwStat_Ctl: __le32,
}
...
pub struct pcmhw {
    pub paths: lbuspath,
    pub lbuspath: *const c_uchar,
    pub source: c_uchar,
    pub intdec: [c_uchar; 2],
    pub mixer: c_uchar,
    pub id: c_uchar,
    pub state: c_uchar,
    pub rate: c_uint,
...
pub const FIRMWARE_VERSIONS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn atoh(in: *const c_uchar, len: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn senddata(cif: *mut cmdif, in: *const c_uchar, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn writearm(cif: *mut cmdif, addr: u32, data: u32, mask: u32) -> c_int {
    static int writearm(struct cmdif *cif, u32 addr, u32 data, u32 mask)
    {
    let mut rptr: union cmdret = CMDRET_ZERO;
    let mut i: c_uint = MAX_WRITE_RETRY;
    ...
    int i, j;
    int err;
    let mut time: c_uint = 0;
    unsigned long irqflags;
    struct riptideport *hwport;
    struct cmdport *cmdport = core::ptr::null_mut();
    if (snd_BUG_ON(!cif))
    return -EINVAL;
    hwport = cif.hwport;
    ...
    if (riptide_reset(cif, core::ptr::null_mut()) == 0) {
    cif.errcnt = 0;
    return -EIO;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn getpaths(cif: *mut cmdif, o: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riptide_handleirq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    struct pcmhw *data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn try_to_load_firmware(cif: *mut cmdif, chip: *mut snd_riptide) -> c_int {
    static int try_to_load_firmware(struct cmdif *cif, struct snd_riptide *chip)
    {
    let mut firmware: union firmware_version = { .ret = CMDRET_ZERO };
    int i, timeout, err;
    for (i = 0; i < 2; i++) {
...
#[no_mangle]
unsafe extern "C" fn riptide_reset(cif: *mut cmdif, chip: *mut snd_riptide) -> c_int {
    static int riptide_reset(struct cmdif *cif, struct snd_riptide *chip)
    {
    let mut rptr: union cmdret = CMDRET_ZERO;
    int err, tries;
    ...
    alloclbuspath(cif, ARM2LBUS_FIFO13, lbus_play_modem, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    alloclbuspath(cif, OPL3_SAMPLE, lbus_play_opl3, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    I2S_MIXER);
    SEND_SI2S(cif, 1);
    alloclbuspath(cif, ARM2LBUS_FIFO0, lbus_play_i2s, core::ptr::null_mut(), core::ptr::null_mut());
    alloclbuspath(cif, DIGITAL_MIXER_OUT0, lbus_play_out, core::ptr::null_mut(), core::ptr::null_mut());
    alloclbuspath(cif, DIGITAL_MIXER_OUT0, lbus_play_outhp, core::ptr::null_mut(), core::ptr::null_mut());
...
unsafe extern "C" fn snd_riptide_prepare(substream: *mut snd_pcm_substream) -> c_int {
    ...
    struct pcmhw *data = get_pcmhwdev(substream);
    struct cmdif *cif = chip.cif;
    const unsigned char *lbuspath = core::ptr::null_mut();
    ...
    struct sgd *c, *p = core::ptr::null_mut();
...
unsafe extern "C" fn snd_riptide_hw_free(substream: *mut snd_pcm_substream) -> c_int {
    ...
    if (data.lbuspath)
    freelbuspath(cif, data.source, data.lbuspath);
    data.lbuspath = core::ptr::null_mut();
    data.source = 0xff;
    data.intdec[0] = 0xff;
    data.intdec[1] = 0xff;
    if (data.sgdlist.area) {
    snd_dma_free_pages(&data.sgdlist);
    data.sgdlist.area = core::ptr::null_mut();
    }
    }
    return 0;
    }
...
unsafe extern "C" fn snd_riptide_playback_open(substream: *mut snd_pcm_substream) -> c_int {
    ...
    struct snd_pcm_runtime *runtime = substream.runtime;
    struct pcmhw *data;
    let mut sub_num: c_int = substream.number;
...
unsafe extern "C" fn snd_riptide_playback_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    chip.playback_substream[sub_num] = core::ptr::null_mut();
    kfree(data);
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn snd_riptide_pcm(chip: *mut snd_riptide, device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_riptide_initialize(chip: *mut snd_riptide) -> c_int {
    static int snd_riptide_initialize(struct snd_riptide *chip)
    {
    struct cmdif *cif;
...
unsafe extern "C" fn snd_riptide_free(card: *mut snd_card) {
    ...
    struct pcmhw *data;
    int i;
    struct cmdif *cif = core::ptr::null_mut();
    unsigned char p[256];
    let mut rval: c_ushort = 0, lval = 0;
    unsigned int rate;
    if (!chip)
    return;
...
#[no_mangle]
unsafe extern "C" fn snd_riptide_proc_init(chip: *mut snd_riptide) {
...
#[no_mangle]
unsafe extern "C" fn snd_riptide_mixer(chip: *mut snd_riptide) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_riptide_joystick_remove(pci: *mut pci_dev) {
    ...
    chip.opladdr = val;
    err = snd_opl3_hwdep_new(chip.opl3, 0, 1, core::ptr::null_mut());
    if (err < 0)
    dev_warn(&pci.dev,
...
#[no_mangle]
unsafe extern "C" fn alsa_card_riptide_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alsa_card_riptide_exit() -> void __exit {
