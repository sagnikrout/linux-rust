...
//
    ...
    module_param_array(digital_rate, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(digital_rate, "Digital input rate for Bt87x soundcard");
    module_param(load_all, bool, 0444);
    MODULE_PARM_DESC(load_all, "Allow to load cards not on the allowlist");
// register offsets
pub const REG_INT_STAT: c_uint = 0x100	/* interrupt status */;
pub const REG_INT_MASK: c_uint = 0x104	/* interrupt mask */;
pub const REG_GPIO_DMA_CTL: c_uint = 0x10c	/* audio control */;
pub const REG_PACKET_LEN: c_uint = 0x110	/* audio packet lengths */;
pub const REG_RISC_STRT_ADD: c_uint = 0x114	/* RISC program start address */;
pub const REG_RISC_COUNT: c_uint = 0x120	/* RISC program counter */;
// interrupt bits

// audio control bits

pub const CTL_A_SEL_SHIFT: c_int = 24;
...
pub const RISC_SYNC_FM1: c_uint = 0x6;
pub const RISC_SYNC_VRO: c_uint = 0xc;
pub const ANALOG_CLOCK: c_int = 1792000;

pub const CLOCK_DIV_MIN: c_int = 1;

pub const CLOCK_DIV_MIN: c_int = 4;

pub const CLOCK_DIV_MAX: c_int = 15;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_bt87x_board {
    pub /: *mut *mut int dig_rate; / Digital input sampling rate,
    pub /: *mut *mut u32 digital_fmt; / Register settings for digital input,
    pub /: *mut *mut unsigned no_analog:1; / No analog input,
    pub /: *mut *mut unsigned no_digital:1; / No digital input,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_bt87x {
    pub card: *mut snd_card,
    pub pci: *mut pci_dev,
    pub board: snd_bt87x_board,
    pub mmio: *mut void __iomem,
    pub irq: c_int,
    pub reg_lock: spinlock_t,
    pub opened: c_ulong,
    pub substream: *mut snd_pcm_substream,
    pub dma_risc: snd_dma_buffer,
    pub line_bytes: c_uint,
    pub lines: c_uint,
    pub reg_control: u32,
    pub interrupt_mask: u32,
    pub current_line: c_int,
    pub pci_parity_errors: c_int,
}

    enum { DEVICE_DIGITAL, DEVICE_ANALOG };
#[no_mangle]
pub unsafe extern "C" fn snd_bt87x_readl(chip: *mut snd_bt87x, reg: u32) -> u32 {
    static inline u32 snd_bt87x_readl(struct snd_bt87x *chip, u32 reg)
    {
    return readl(chip.mmio + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_bt87x_writel(chip: *mut snd_bt87x, reg: u32, value: u32) {
    ...
    __le32 *risc;
    if (chip.dma_risc.area == core::ptr::null_mut()) {
...
// risc++ = cpu_to_le32(0);
    ...
    let mut block: u32 = i * 16 / periods;
    cmd |= RISC_SOL;
...
unsafe extern "C" fn snd_bt87x_free_risc(chip: *mut snd_bt87x) {
    ...
    chip.dma_risc.area = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn snd_bt87x_pci_error(chip: *mut snd_bt87x, status: c_uint) {
    ...
    {
    let mut pci_status: c_int = pci_status_get_and_clear_errors(chip.pci);
...
#[no_mangle]
unsafe extern "C" fn snd_bt87x_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn alsa_card_bt87x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alsa_card_bt87x_exit() -> void __exit {
