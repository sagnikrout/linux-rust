...
//! Source: sound/pci/echoaudio/echoaudio_3g.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_asic_status(chip: *mut echoaudio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_frq_reg(chip: *mut echoaudio) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn set_digital_mode(chip: *mut echoaudio, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_spdif_bits(chip: *mut echoaudio, control_reg: u32, rate: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dsp_set_digital_mode(chip: *mut echoaudio, mode: u8) -> c_int {
