...
//! Source: sound/pci/echoaudio/darla24.c
#![no_std]
...
// Macro flag: #define ECHOCARD_DARLA24
...
pub const PX_NUM: c_int = 10;
// Bus indexes

pub const BX_NUM: c_int = 10;

    MODULE_FIRMWARE("ea/darla24_dsp.fw");
pub const FW_DARLA24_DSP: c_int = 0;
