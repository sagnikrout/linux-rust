...
//! Source: sound/pci/echoaudio/midi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enable_midi_input(chip: *mut echoaudio, enable: c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_midi(chip: *mut echoaudio, data: *mut u8, bytes: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtc_process_data(chip: *mut echoaudio, midi_byte: c_short) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn midi_service_irq(chip: *mut echoaudio) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_echo_midi_input_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_echo_midi_input_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_echo_midi_output_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_echo_midi_output_write(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn snd_echo_midi_output_close(substream: *mut snd_rawmidi_substream) -> c_int {
