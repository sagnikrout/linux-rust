...
//! Source: sound/pci/echoaudio/layla20_dsp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_input_clock(chip: *mut echoaudio, clock_source: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_output_clock(chip: *mut echoaudio, clock: u16) -> c_int {
