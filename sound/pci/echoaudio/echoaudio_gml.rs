...
//! Source: sound/pci/echoaudio/echoaudio_gml.c
#![no_std]
...
// Most configuration of Gina24, Layla24, or Mona is accomplished by writing
    ...
    value to the DSP. */
#[no_mangle]
unsafe extern "C" fn write_control_reg(chip: *mut echoaudio, value: u32, force: c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_input_auto_mute(chip: *mut echoaudio, automute: c_int) -> c_int {
