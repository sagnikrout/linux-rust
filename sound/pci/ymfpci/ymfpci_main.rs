...
//! Source: sound/pci/ymfpci/ymfpci_main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_writeb(chip: *mut snd_ymfpci, offset: u32, val: u8) {
    static inline void snd_ymfpci_writeb(struct snd_ymfpci *chip, u32 offset, u8 val)
    {
    writeb(val, chip.reg_area_virt + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_readw(chip: *mut snd_ymfpci, offset: u32) -> u16 {
    static inline u16 snd_ymfpci_readw(struct snd_ymfpci *chip, u32 offset)
    {
    return readw(chip.reg_area_virt + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_writew(chip: *mut snd_ymfpci, offset: u32, val: u16) {
    static inline void snd_ymfpci_writew(struct snd_ymfpci *chip, u32 offset, u16 val)
    {
    writew(val, chip.reg_area_virt + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_readl(chip: *mut snd_ymfpci, offset: u32) -> u32 {
    static inline u32 snd_ymfpci_readl(struct snd_ymfpci *chip, u32 offset)
    {
    return readl(chip.reg_area_virt + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_writel(chip: *mut snd_ymfpci, offset: u32, val: u32) {
...
unsafe extern "C" fn snd_ymfpci_codec_ready(chip: *mut snd_ymfpci, secondary: c_int) -> c_int {
    ...
    let mut reg: u32 = secondary ? YDSXGR_SECSTATUSADR : YDSXGR_PRISTATUSADR;
...
//
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_calc_delta(rate: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_calc_lpfK(rate: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_calc_lpfQ(rate: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_hw_start(chip: *mut snd_ymfpci) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_hw_stop(chip: *mut snd_ymfpci) {
...
// rvoice = NULL;
    ...
    voice2 = pair ? &chip.voices[idx+1] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_voice_free(chip: *mut snd_ymfpci, pvoice: *mut snd_ymfpci_voice) -> c_int {
...
unsafe extern "C" fn snd_ymfpci_pcm_interrupt(chip: *mut snd_ymfpci, voice: *mut snd_ymfpci_voice) {
    ...
    if (!ypcm)
    return;
    if (ypcm.substream == core::ptr::null_mut())
    return;
...
//
    ...
    let mut subs: c_uint = ypcm.substream.number;
    let mut next_bank: c_uint = 1 - chip.active_bank;
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_pcm_capture_interrupt(substream: *mut snd_pcm_substream) {
...
//
    ...
    struct snd_kcontrol *kctl = core::ptr::null_mut();
    let mut result: c_int = 0;
    guard(spinlock)(&chip.reg_lock);
    if (ypcm.voices[0] == core::ptr::null_mut())
    return -EINVAL;
    switch (cmd) {
    ...
    if (ypcm.voices[1] != core::ptr::null_mut() && !ypcm.use_441_slot)
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_pcm_voice_alloc(ypcm: *mut snd_ymfpci_pcm, voices: c_int) -> c_int {
    static int snd_ymfpci_pcm_voice_alloc(struct snd_ymfpci_pcm *ypcm, int voices)
    {
    int err;
    if (ypcm.voices[1] != core::ptr::null_mut() && voices < 2) {
    snd_ymfpci_voice_free(ypcm.chip, ypcm.voices[1]);
    ypcm.voices[1] = core::ptr::null_mut();
    }
    if (voices == 1 && ypcm.voices[0] != core::ptr::null_mut())
    return 0;		/* already allocated */
    if (voices == 2 && ypcm.voices[0] != core::ptr::null_mut() && ypcm.voices[1] != core::ptr::null_mut())
    return 0;		/* already allocated */
    if (voices > 1) {
    if (ypcm.voices[0] != core::ptr::null_mut() && ypcm.voices[1] == core::ptr::null_mut()) {
    snd_ymfpci_voice_free(ypcm.chip, ypcm.voices[0]);
    ypcm.voices[0] = core::ptr::null_mut();
    }
    }
    ...
    u32 format;
    let mut delta: u32 = snd_ymfpci_calc_delta(runtime.rate);
    let mut lpfQ: u32 = snd_ymfpci_calc_lpfQ(runtime.rate);
    let mut lpfK: u32 = snd_ymfpci_calc_lpfK(runtime.rate);
    struct snd_ymfpci_playback_bank *bank;
    unsigned int nbank;
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_ac3_init(chip: *mut snd_ymfpci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_ac3_done(chip: *mut snd_ymfpci) -> c_int {
...
// snd_ymfpci_irq_wait(chip);
    ...
    chip.ac3_tmp_base.area = core::ptr::null_mut();
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_capture_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_capture_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_capture_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_irq_wait(chip: *mut snd_ymfpci) {
    static void snd_ymfpci_irq_wait(struct snd_ymfpci *chip)
    {
    wait_queue_entry_t wait;
    let mut loops: c_int = 4;
    while (loops-- > 0) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_pcm_free_substream(runtime: *mut snd_pcm_runtime) {
    static void snd_ymfpci_pcm_free_substream(struct snd_pcm_runtime *runtime)
    {
    kfree(runtime.private_data);
    }
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_open_1(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ymfpci_open_extension(chip: *mut snd_ymfpci) {
...
// call with spinlock held
#[no_mangle]
unsafe extern "C" fn ymfpci_close_extension(chip: *mut snd_ymfpci) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_spdif_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_4ch_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_capture_rec_open(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_ymfpci_capture_rec_open(struct snd_pcm_substream *substream)
    {
    return snd_ymfpci_capture_open(substream, 0);
    }
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_capture_ac97_open(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_ymfpci_capture_ac97_open(struct snd_pcm_substream *substream)
    {
    return snd_ymfpci_capture_open(substream, 1);
    }
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_close_1(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_ymfpci_playback_close_1(struct snd_pcm_substream *substream)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_spdif_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_playback_4ch_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_capture_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    struct snd_ymfpci_pcm *ypcm = runtime.private_data;
    if (ypcm != core::ptr::null_mut()) {
    chip.capture_substream[ypcm.capture_bank_number] = core::ptr::null_mut();
    snd_ymfpci_hw_stop(chip);
    }
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_pcm(chip: *mut snd_ymfpci, device: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_pcm2(chip: *mut snd_ymfpci, device: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_pcm_spdif(chip: *mut snd_ymfpci, device: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_pcm_4ch(chip: *mut snd_ymfpci, device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_spdif_default_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
    ...
    chip.spdif_bits = val;
    if ((snd_ymfpci_readw(chip, YDSXGR_SPDIFOUTCTRL) & 1) && chip.pcm_spdif == core::ptr::null_mut())
    snd_ymfpci_writew(chip, YDSXGR_SPDIFOUTSTATUS, chip.spdif_bits);
    return change;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_spdif_mask_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_spdif_stream_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_drec_source_info(kcontrol: *mut snd_kcontrol, info: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_drec_source_get(kcontrol: *mut snd_kcontrol, value: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_drec_source_put(kcontrol: *mut snd_kcontrol, value: *mut snd_ctl_elem_value) -> c_int {
...
//
    ...
    let mut shift: c_uint = (kcontrol.private_value >> 16) & 0xff;
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_info_double(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
    static int snd_ymfpci_info_double(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_info *uinfo)
    {
    let mut reg: c_uint = kcontrol.private_value;
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_get_double(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int snd_ymfpci_get_double(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct snd_ymfpci *chip = snd_kcontrol_chip(kcontrol);
    let mut reg: c_uint = kcontrol.private_value;
    let mut shift_left: c_uint = 0, shift_right = 16, mask = 16383;
    unsigned int val;
    if (reg < 0x80 || reg >= 0xc0)
    return -EINVAL;
    guard(spinlock_irq)(&chip.reg_lock);
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_put_double(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    ...
    {
    struct snd_ymfpci *chip = snd_kcontrol_chip(kcontrol);
    let mut reg: c_uint = YDSXGR_NATIVEDACOUTVOL;
    let mut reg2: c_uint = YDSXGR_BUF441OUTVOL;
    int change;
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_get_dup4ch(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_put_dup4ch(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_get_gpio_out(chip: *mut snd_ymfpci, pin: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_set_gpio_out(chip: *mut snd_ymfpci, pin: c_int, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_gpio_sw_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int snd_ymfpci_gpio_sw_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct snd_ymfpci *chip = snd_kcontrol_chip(kcontrol);
    let mut pin: c_int = (int)kcontrol.private_value;
    ucontrol.value.integer.value[0] = snd_ymfpci_get_gpio_out(chip, pin);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_gpio_sw_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
//
    ...
    {
    struct snd_ymfpci *chip = snd_kcontrol_chip(kcontrol);
    let mut subs: c_uint = kcontrol.id.subdevice;
...
//
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_mixer_free_ac97_bus(bus: *mut snd_ac97_bus) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_mixer_free_ac97(ac97: *mut snd_ac97) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_mixer(chip: *mut snd_ymfpci, rear_switch: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_timer_start(timer: *mut snd_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_timer_stop(timer: *mut snd_timer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ymfpci_timer(chip: *mut snd_ymfpci, device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_proc_init(card: *mut snd_card, chip: *mut snd_ymfpci) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_aclink_reset(pci: *mut *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_enable_dsp(chip: *mut snd_ymfpci) {
    static void snd_ymfpci_enable_dsp(struct snd_ymfpci *chip)
    {
    snd_ymfpci_writel(chip, YDSXGR_CONFIG, 0x00000001);
    }
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_disable_dsp(chip: *mut snd_ymfpci) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_request_firmware(chip: *mut snd_ymfpci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_download_image(chip: *mut snd_ymfpci) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_memalloc(chip: *mut snd_ymfpci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_free(card: *mut snd_card) {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ymfpci_resume(dev: *mut device) -> c_int {
