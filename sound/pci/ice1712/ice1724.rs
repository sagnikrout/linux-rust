...
//! Source: sound/pci/ice1712/ice1724.c
#![no_std]
...
// Both VT1720 and VT1724 have the same PCI IDs
    ...
    let mut PRO_RATE_RESET: static int = 1;
    let mut PRO_RATE_DEFAULT: static unsigned int = 44100;
...
#[no_mangle]
pub unsafe extern "C" fn stdclock_is_spdif_master(ice: *mut snd_ice1712) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_pro_rate_locked(ice: *mut snd_ice1712) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_vt1724_ac97_ready(ice: *mut snd_ice1712) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_ac97_wait_bit(ice: *mut snd_ice1712, bit: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_ac97_read(ac97: *mut snd_ac97, reg: c_ushort) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_set_gpio_dir(ice: *mut snd_ice1712, data: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_get_gpio_dir(ice: *mut snd_ice1712) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_set_gpio_mask(ice: *mut snd_ice1712, data: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_get_gpio_mask(ice: *mut snd_ice1712) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_set_gpio_data(ice: *mut snd_ice1712, data: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_get_gpio_data(ice: *mut snd_ice1712) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn vt1724_midi_clear_rx(ice: *mut snd_ice1712) {
...
#[no_mangle]
unsafe extern "C" fn vt1724_midi_write(ice: *mut snd_ice1712) {
...
#[no_mangle]
unsafe extern "C" fn vt1724_midi_read(ice: *mut snd_ice1712) {
...
#[no_mangle]
unsafe extern "C" fn enable_midi_irq(ice: *mut snd_ice1712, flag: u8, enable: c_int) {
    static void enable_midi_irq(struct snd_ice1712 *ice, u8 flag, int enable)
    {
    let mut mask: u8 = inb(ICEREG1724(ice, IRQMASK));
    if (enable)
    mask &= ~flag;
    else
    mask |= flag;
...
#[no_mangle]
unsafe extern "C" fn vt1724_midi_output_open(s: *mut snd_rawmidi_substream) -> c_int {
    static int vt1724_midi_output_open(struct snd_rawmidi_substream *s)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vt1724_midi_output_close(s: *mut snd_rawmidi_substream) -> c_int {
    static int vt1724_midi_output_close(struct snd_rawmidi_substream *s)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vt1724_midi_output_trigger(s: *mut snd_rawmidi_substream, up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vt1724_midi_output_drain(s: *mut snd_rawmidi_substream) {
...
#[no_mangle]
unsafe extern "C" fn vt1724_midi_input_open(s: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt1724_midi_input_close(s: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt1724_midi_input_trigger(s: *mut snd_rawmidi_substream, up: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_vt1724_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    let mut mtstat: c_uchar = inb(ICEMT1724(ice, IRQ));
...
// ought to really handle this properly
    ...
    let mut fstat: c_uchar = inb(ICEMT1724(ice, DMA_FIFO_ERR));
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vt1724_pcm_reg {
    pub /: *mut *mut unsigned int addr; / ADDR register offset,
    pub /: *mut *mut unsigned int size; / SIZE register offset,
    pub /: *mut *mut unsigned int count; / COUNT register offset,
    pub /: *mut *mut unsigned int start; / start & pause bit,
}

#[no_mangle]
unsafe extern "C" fn snd_vt1724_pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stdclock_get_rate(ice: *mut snd_ice1712) -> c_uint {
    static unsigned int stdclock_get_rate(struct snd_ice1712 *ice)
    {
    return stdclock_rate_list[inb(ICEMT1724(ice, RATE)) & 15];
    }
#[no_mangle]
unsafe extern "C" fn stdclock_set_rate(ice: *mut snd_ice1712, rate: c_uint) {
...
// no change in master clock
    ...
    let mut call_set_rate: bool = false;
...
// setting clock rate for internal clock mode
    ...
    call_set_rate = true;
#[no_mangle]
pub unsafe extern "C" fn if(ice->cur_rate: rate ==) -> else {
    return 0;
    }
    }
    ice.cur_rate = rate;
...
// PDMA0 can be multi-channel up to 8
    ...
    ice.pcm_reserved[i] = core::ptr::null_mut();
    }
    } else {
    for (i = 0; i < 3; i++) {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_pcm_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_pro_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_pro_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
    ...
    ;
#[no_mangle]
pub unsafe extern "C" fn if(substream->runtime->buffer_size: ptr <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_pcm_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_pcm_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
//
#[no_mangle]
unsafe extern "C" fn set_std_hw_rates(ice: *mut snd_ice1712) {
...
//
#[no_mangle]
unsafe extern "C" fn constrain_rate_if_locked(substream: *mut snd_pcm_substream) {
...
// actually used
//
pub const VT1724_BUFFER_ALIGN: c_uint = 0x20;
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_pro_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_capture_pro_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_pro_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    ice.playback_pro_substream = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_vt1724_capture_pro_close(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_vt1724_capture_pro_close(struct snd_pcm_substream *substream)
    {
    struct snd_ice1712 *ice = snd_pcm_substream_chip(substream);
    if (PRO_RATE_RESET)
    snd_vt1724_set_pro_rate(ice, ice.pro_rate_default, 0);
    ice.capture_pro_substream = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_pcm_profi(ice: *mut snd_ice1712, device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_spdif_bits(ice: *mut snd_ice1712, val: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn update_spdif_rate(ice: *mut snd_ice1712, rate: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_spdif_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_spdif_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_spdif_close(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_vt1724_playback_spdif_close(struct snd_pcm_substream *substream)
    {
    struct snd_ice1712 *ice = snd_pcm_substream_chip(substream);
    if (PRO_RATE_RESET)
    snd_vt1724_set_pro_rate(ice, ice.pro_rate_default, 0);
    ice.playback_con_substream = core::ptr::null_mut();
    if (ice.spdif.ops.close)
    ice.spdif.ops.close(ice, substream);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_vt1724_capture_spdif_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_capture_spdif_close(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_vt1724_capture_spdif_close(struct snd_pcm_substream *substream)
    {
    struct snd_ice1712 *ice = snd_pcm_substream_chip(substream);
    if (PRO_RATE_RESET)
    snd_vt1724_set_pro_rate(ice, ice.pro_rate_default, 0);
    ice.capture_con_substream = core::ptr::null_mut();
    if (ice.spdif.ops.close)
    ice.spdif.ops.close(ice, substream);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_pcm_spdif(ice: *mut snd_ice1712, device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_indep_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_indep_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_playback_indep_close(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_vt1724_playback_indep_close(struct snd_pcm_substream *substream)
    {
    struct snd_ice1712 *ice = snd_pcm_substream_chip(substream);
    if (PRO_RATE_RESET)
    snd_vt1724_set_pro_rate(ice, ice.pro_rate_default, 0);
    ice.playback_con_substream_ds[substream.number] = core::ptr::null_mut();
    ice.pcm_reserved[substream.number] = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_pcm_indep(ice: *mut snd_ice1712, device: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_vt1724_ac97_mixer(ice: *mut snd_ice1712) -> c_int {
...
// cold reset
    ...
    mdelay(5); /* FIXME */
    outb(inb(ICEMT1724(ice, AC97_CMD)) & ~0x80, ICEMT1724(ice, AC97_CMD));
    err = snd_ac97_bus(ice.card, 0, &ops, core::ptr::null_mut(), &pbus);
    if (err < 0)
    return err;
...
//
#[no_mangle]
pub unsafe extern "C" fn eeprom_triple(ice: *mut snd_ice1712, idx: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_proc_init(ice: *mut snd_ice1712) {
...
#[no_mangle]
unsafe extern "C" fn encode_spdif_bits(diga: *mut snd_aes_iec958) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn decode_spdif_bits(diga: *mut snd_aes_iec958, val: c_uint) {
...
//
    ...
    {
    struct snd_ice1712 *ice = snd_kcontrol_chip(kcontrol);
    let mut shift: c_int = kcontrol.private_value & 0xff;
    let mut invert: c_int = (kcontrol.private_value & (1<<24)) ? 1 : 0;
    ...
    struct snd_ice1712 *ice = snd_kcontrol_chip(kcontrol);
    let mut shift: c_int = kcontrol.private_value & 0xff;
    let mut invert: c_int = (kcontrol.private_value & (1<<24)) ? mask : 0;
    unsigned int val, nval;
...
//
    ...
    {
    struct snd_ice1712 *ice = snd_kcontrol_chip(kcontrol);
    let mut hw_rates_count: c_int = ice.hw_rates.count;
...
#[no_mangle]
unsafe extern "C" fn stdclock_get_spdif_master_type(ice: *mut snd_ice1712) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stdclock_set_spdif_clock(ice: *mut snd_ice1712, type: c_int) -> c_int {
...
// setting 256fs
    ...
    let mut item: c_uint = ucontrol.value.enumerated.item[0];
    let mut first_ext_clock: c_uint = ice.hw_rates.count;
    let mut set_pro_rate: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn analog_route_shift(idx: c_int) -> c_int {
    static inline int analog_route_shift(int idx)
    {
    return (idx % 2) * 12 + ((idx / 2) * 3) + 8;
    }
#[no_mangle]
pub unsafe extern "C" fn digital_route_shift(idx: c_int) -> c_int {
    static inline int digital_route_shift(int idx)
    {
    return idx * 3;
    }
#[no_mangle]
pub unsafe extern "C" fn snd_ice1724_get_route_val(ice: *mut snd_ice1712, shift: c_int) -> c_int {
    ...
    {
    struct snd_ice1712 *ice = snd_kcontrol_chip(kcontrol);
    let mut idx: c_int = snd_ctl_get_ioffidx(kcontrol, &ucontrol.id);
...
//
#[no_mangle]
unsafe extern "C" fn wait_i2c_busy(ice: *mut snd_ice1712) {
    static void wait_i2c_busy(struct snd_ice1712 *ice)
    {
    let mut t: c_int = 0x10000;
...
// assume AC97-only card which can suspend without additional code
    ...
    ice.eeprom.size = 32;
#[no_mangle]
pub unsafe extern "C" fn if(32: ice->eeprom.size >) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_chip_reset(ice: *mut snd_ice1712) {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_chip_init(ice: *mut snd_ice1712) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_spdif_build_controls(ice: *mut snd_ice1712) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_build_controls(ice: *mut snd_ice1712) -> c_int {
    ...
    let mut tmp: snd_kcontrol_new = snd_vt1724_mixer_pro_analog_route;
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_free(card: *mut snd_card) {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vt1724_resume(dev: *mut device) -> c_int {
