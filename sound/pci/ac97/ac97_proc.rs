...
//! Source: sound/pci/ac97/ac97_proc.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn snd_ac97_proc_read_functions(ac97: *mut snd_ac97, buffer: *mut snd_info_buffer) {
    static void snd_ac97_proc_read_functions(struct snd_ac97 *ac97, struct snd_info_buffer *buffer)
    {
    let mut header: c_int = 0, function;
...
#[no_mangle]
unsafe extern "C" fn snd_ac97_proc_read_main(ac97: *mut snd_ac97, buffer: *mut snd_info_buffer, subidx: c_int) {
    ...
    snd_ac97_get_name(core::ptr::null_mut(), ac97.id, name, sizeof(name), 0);
...
#[no_mangle]
pub unsafe extern "C" fn if(AC97_ID_YMF743: ac97->id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_ac97_proc_regs_read_main(ac97: *mut snd_ac97, buffer: *mut snd_info_buffer, subidx: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ac97_proc_init(ac97: *mut *mut snd_ac97) {
    void snd_ac97_proc_init(struct snd_ac97 * ac97)
    {
    struct snd_info_entry *entry;
    char name[32];
    const char *prefix;
    if (ac97.bus.proc == core::ptr::null_mut())
    return;
...
#[no_mangle]
pub unsafe extern "C" fn snd_ac97_proc_done(ac97: *mut *mut snd_ac97) {
    void snd_ac97_proc_done(struct snd_ac97 * ac97)
    {
    snd_info_free_entry(ac97.proc_regs);
    ac97.proc_regs = core::ptr::null_mut();
    snd_info_free_entry(ac97.proc);
    ac97.proc = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn snd_ac97_bus_proc_init(bus: *mut *mut snd_ac97_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ac97_bus_proc_done(bus: *mut *mut snd_ac97_bus) {
    void snd_ac97_bus_proc_done(struct snd_ac97_bus * bus)
    {
    snd_info_free_entry(bus.proc);
    bus.proc = core::ptr::null_mut();
    }
