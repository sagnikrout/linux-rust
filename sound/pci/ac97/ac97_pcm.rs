...
//! Source: sound/pci/ac97/ac97_pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_spdif_rate(ac97: *mut snd_ac97, rate: c_ushort) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_ac97_set_rate(ac97: *mut snd_ac97, reg: c_int, rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_pslots(ac97: *mut snd_ac97, rate_table: *mut c_uchar, spdif_slots: *mut c_ushort) -> c_ushort {
...
#[no_mangle]
pub unsafe extern "C" fn if(AC97_SCAP_CENTER_LFE_DAC): !(ac97->scaps &) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_cslots(ac97: *mut snd_ac97) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn get_rates(pcm: *mut ac97_pcm, cidx: c_uint, slots: c_ushort, dbl: c_int) -> c_uint {
...
pub unsafe extern "C" fn snd_ac97_pcm_close(pcm: *mut ac97_pcm) -> c_int {
    ...
    {
    struct snd_ac97_bus *bus;
    let mut slots: c_ushort = pcm.aslots;
    int i, cidx;

    let mut r: c_int = pcm.cur_dbl;
    for (i = 3; i < 12; i++) {
    if (!(slots & (1 << i)))
    continue;
    for (cidx = 0; cidx < 4; cidx++) {
    if (pcm.r[r].rslots[cidx] & (1 << i)) {
    let mut reg: c_int = get_slot_reg(pcm, cidx, i, r);
...
pub unsafe extern "C" fn snd_ac97_pcm_double_rate_rules(runtime: *mut snd_pcm_runtime) -> c_int {
    ...
    double_rate_hw_constraint_rate, core::ptr::null_mut(),
    SNDRV_PCM_HW_PARAM_CHANNELS, -1);
    if (err < 0)
    return err;
    err = snd_pcm_hw_rule_add(runtime, 0, SNDRV_PCM_HW_PARAM_CHANNELS,
    double_rate_hw_constraint_channels, core::ptr::null_mut(),
