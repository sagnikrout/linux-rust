...
//! Source: sound/pci/ak4531_codec.c
#![no_std]
...
//
    ...
    .tlv = { .p = (xtlv) } }
#[no_mangle]
unsafe extern "C" fn snd_ak4531_info_single(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4531_get_single(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    ...
    let mut shift: c_int = (kcontrol.private_value >> 16) & 0x07;
    let mut mask: c_int = (kcontrol.private_value >> 24) & 0xff;
...
#[no_mangle]
unsafe extern "C" fn snd_ak4531_put_single(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    ...
    .tlv = { .p = (xtlv) } }
#[no_mangle]
unsafe extern "C" fn snd_ak4531_info_double(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4531_get_double(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    ...
    let mut left_shift: c_int = (kcontrol.private_value >> 16) & 0x07;
    let mut right_shift: c_int = (kcontrol.private_value >> 19) & 0x07;
    let mut mask: c_int = (kcontrol.private_value >> 24) & 0xff;
    let mut invert: c_int = (kcontrol.private_value >> 22) & 1;
    int left, right;
    guard(mutex)(&ak4531.reg_mutex);
...
#[no_mangle]
unsafe extern "C" fn snd_ak4531_put_double(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4531_info_input_sw(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4531_get_input_sw(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int snd_ak4531_get_input_sw(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct snd_ak4531 *ak4531 = snd_kcontrol_chip(kcontrol);
    let mut reg1: c_int = kcontrol.private_value & 0xff;
    let mut reg2: c_int = (kcontrol.private_value >> 8) & 0xff;
    let mut left_shift: c_int = (kcontrol.private_value >> 16) & 0x0f;
    let mut right_shift: c_int = (kcontrol.private_value >> 24) & 0x0f;
    guard(mutex)(&ak4531.reg_mutex);
...
#[no_mangle]
unsafe extern "C" fn snd_ak4531_put_input_sw(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
