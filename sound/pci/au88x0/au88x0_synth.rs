...
#[no_mangle]
unsafe extern "C" fn vortex_wt_setstereo(vortex: *mut *mut vortex_t, wt: u32, stereo: u32) {
...
#[no_mangle]
unsafe extern "C" fn vortex_wt_setdsout(vortex: *mut *mut vortex_t, wt: u32, en: c_int) {
...
// Setup WT route.
#[no_mangle]
unsafe extern "C" fn vortex_wt_allocroute(vortex: *mut *mut vortex_t, wt: c_int, nr_ch: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_wt_connect(vortex: *mut *mut vortex_t, en: c_int) {
    static void vortex_wt_connect(vortex_t * vortex, int en)
    {
    int i, ii, mix;
pub const NR_WTROUTES: c_int = 6;

pub const NR_WTBLOCKS: c_int = 2;

pub const NR_WTBLOCKS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn vortex_wt_GetReg(vortex: *mut *mut vortex_t, reg: c_char, wt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_wt_init(vortex: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_wt_SetVolume(vortex: *mut *mut vortex_t, wt: c_int, vol[]: c_int) {
    static void vortex_wt_SetVolume(vortex_t * vortex, int wt, int vol[])
    {
    wt_voice_t *voice = &(vortex.wt_voice[wt]);
    let mut ecx: c_int = vol[1], eax = vol[0];
// This is pure guess
...
#[no_mangle]
unsafe extern "C" fn vortex_wt_SetFrequency(vortex: *mut *mut vortex_t, wt: c_int, sr: c_uint) {
