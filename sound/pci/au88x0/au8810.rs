...
//! Source: sound/pci/au88x0/au8810.h
#![no_std]
...
//
// Macro flag: #define CHIP_AU8810

pub const NR_ADB: c_uint = 0x10;
pub const NR_WT: c_uint = 0x00;
...
pub const VORTEX_ADBDMA_CTRL: c_uint = 0x27180	/* write only; format, flags, DMA pos */;
...
pub const VORTEX_ADBDMA_BUFCFG0: c_uint = 0x27100;
pub const VORTEX_ADBDMA_BUFCFG1: c_uint = 0x27104;
pub const VORTEX_ADBDMA_BUFBASE: c_uint = 0x27000;
...
// WTDMA
pub const VORTEX_WTDMA_CTRL: c_uint = 0x27fd8	/* format, DMA pos */;
pub const VORTEX_WTDMA_STAT: c_uint = 0x27fe8	/* DMA subbuf, DMA pos */;
pub const WT_SUBBUF_MASK: c_uint = 0x3;
pub const WT_SUBBUF_SHIFT: c_uint = 0xc;
pub const VORTEX_WTDMA_BUFBASE: c_uint = 0x27fc0;
pub const VORTEX_WTDMA_BUFCFG0: c_uint = 0x27fd0;
pub const VORTEX_WTDMA_BUFCFG1: c_uint = 0x27fd4;
pub const VORTEX_WTDMA_START: c_uint = 0x27fe4	/* which subbuffer is first */;
// ADB
...
pub const OFFSET_SRCOUT: c_uint = 0x20;
pub const OFFSET_MIXIN: c_uint = 0x50;
pub const OFFSET_MIXOUT: c_uint = 0x30;
pub const OFFSET_CODECIN: c_uint = 0x70;
pub const OFFSET_CODECOUT: c_uint = 0x88;
pub const OFFSET_SPORTIN: c_uint = 0x78	/* ch 0x13 */;
pub const OFFSET_SPORTOUT: c_uint = 0x90;
pub const OFFSET_SPDIFOUT: c_uint = 0x92	/* ch 0x14 check this! */;
pub const OFFSET_EQIN: c_uint = 0xa0;
pub const OFFSET_EQOUT: c_uint = 0x7e	/* 2 routes on ch 0x11 */;
pub const OFFSET_XTALKOUT: c_uint = 0x66	/* crosstalk canceller (source) */;
pub const OFFSET_XTALKIN: c_uint = 0x96	/* crosstalk canceller (sink) */;
pub const OFFSET_A3DIN: c_uint = 0x70	/* ADB sink. */;
pub const OFFSET_A3DOUT: c_uint = 0xA6	/* ADB source. 2 routes per slice = 8 */;
pub const OFFSET_EFXIN: c_uint = 0x80	/* ADB sink. */;
pub const OFFSET_EFXOUT: c_uint = 0x68	/* ADB source. */;
// ADB route translate helper

pub const MIX_OUTL: c_uint = 0xe;
pub const MIX_OUTR: c_uint = 0xf;
pub const MIX_INL: c_uint = 0x1e;
pub const MIX_INR: c_uint = 0x1f;
...
pub const VORTEX_MIX_SMP: c_uint = 0x21c00	/* AU8820: 0x9c00 */;
// MIX
pub const VORTEX_MIX_INVOL_A: c_uint = 0x21000	/* in? */;
pub const VORTEX_MIX_INVOL_B: c_uint = 0x20000	/* out? */;
pub const VORTEX_MIX_VOL_A: c_uint = 0x21800;
pub const VORTEX_MIX_VOL_B: c_uint = 0x20800;
...
pub const FIFO_BITS: c_uint = 0x03880000;
...
pub const EN_CODEC0: c_uint = 0x00000300;
pub const EN_AC98: c_uint = 0x00000c00 /* Modem AC98 slots. */;
pub const EN_CODEC1: c_uint = 0x00003000;

pub const EN_SPORT: c_uint = 0x00030000;
pub const EN_SPDIF: c_uint = 0x000c0000;
pub const VORTEX_CODEC_CHN: c_uint = 0x29080;
pub const VORTEX_CODEC_IO: c_uint = 0x29188;
// SPDIF
pub const VORTEX_SPDIF_FLAGS: c_uint = 0x2205c;
pub const VORTEX_SPDIF_CFG0: c_uint = 0x291D0;
pub const VORTEX_SPDIF_CFG1: c_uint = 0x291D4;
pub const VORTEX_SPDIF_SMPRATE: c_uint = 0x29194;
// Sample timer
pub const VORTEX_SMP_TIME: c_uint = 0x29198;
...
pub const VORTEX_STAT: c_uint = 0x2a008	/* Status */;
...
pub const VORTEX_GAME_AXIS: c_uint = 0x28810;
