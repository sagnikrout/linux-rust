...
//! Source: sound/pci/au88x0/au88x0_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vortex_mixer_en_sr(vortex: *mut *mut vortex_t, channel: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_mixer_dis_sr(vortex: *mut *mut vortex_t, channel: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_mix_getvolume(vortex: *mut *mut vortex_t, mix: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_mix_boost6db(vol: c_uchar) -> c_uint {
    static unsigned int vortex_mix_boost6db(unsigned char vol)
    {
    return (vol + 8);	/* WOW! what a complex function! */
    }
#[no_mangle]
unsafe extern "C" fn vortex_mix_rampvolume(vortex: *mut *mut vortex_t, mix: c_int) {
...
// printk(KERN_INFO "vortex: mixAddWTD: while addr=%x, val=%x\n", prev, temp);
    ...
    {
    let mut esp14: c_int = -1, esp18, eax, ebx, edx, ebp, esi = 0;
...
#[no_mangle]
unsafe extern "C" fn vortex_mixer_init(vortex: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_src_en_sr(vortex: *mut *mut vortex_t, channel: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_src_dis_sr(vortex: *mut *mut vortex_t, channel: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_src_flushbuffers(vortex: *mut *mut vortex_t, src: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn vortex_src_cleardrift(vortex: *mut *mut vortex_t, src: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn vortex_src_slowlock(vortex: *mut *mut vortex_t, src: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn vortex_srcblock_init(vortex: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_fifo_adbinitialize(vortex: *mut *mut vortex_t, fifo: c_int, j: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_fifo_setadbvalid(vortex: *mut *mut vortex_t, fifo: c_int, en: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_fifo_clearwtdata(vortex: *mut *mut vortex_t, fifo: c_int, x: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_fifo_wtinitialize(vortex: *mut *mut vortex_t, fifo: c_int, j: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_fifo_setwtvalid(vortex: *mut *mut vortex_t, fifo: c_int, en: c_int) {
    ...
    int empty, int valid, int f)
    {
    let mut temp: c_int = 0, lifeboat = 0;
    let mut this_4: c_int = 2;
    do {
...
#[no_mangle]
unsafe extern "C" fn vortex_fifo_init(vortex: *mut *mut vortex_t) {
...
// ADBDMA
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_init(vortex: *mut *mut vortex_t) {
    static void vortex_adbdma_init(vortex_t * vortex)
    {
    }
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_setfirstbuffer(vortex: *mut *mut vortex_t, adbdma: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_setstartbuffer(vortex: *mut *mut vortex_t, adbdma: c_int, sb: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_bufshift(vortex: *mut *mut vortex_t, adbdma: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_resetup(vortex: *mut vortex_t, adbdma: c_int) {
    stream_t *dma = &vortex.dma_adb[adbdma];
    int p, pp, i;
// refresh hw page table
...
#[no_mangle]
pub unsafe extern "C" fn vortex_adbdma_getlinearpos(vortex: *mut *mut vortex_t, adbdma: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_startfifo(vortex: *mut *mut vortex_t, adbdma: c_int) {
    static void vortex_adbdma_startfifo(vortex_t * vortex, int adbdma)
    {
    let mut this_8: c_int = 0 /*empty */ , this_4 = 0 /*priority */ ;
    stream_t *dma = &vortex.dma_adb[adbdma];
...
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_resumefifo(vortex: *mut *mut vortex_t, adbdma: c_int) {
    static void vortex_adbdma_resumefifo(vortex_t * vortex, int adbdma)
    {
    stream_t *dma = &vortex.dma_adb[adbdma];
    let mut this_8: c_int = 1, this_4 = 0;
    switch (dma.fifo_status) {
    case FIFO_STOP:
    hwwrite(vortex.mmio, VORTEX_ADBDMA_CTRL + (adbdma << 2),
    dma.dma_ctrl);
...
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_pausefifo(vortex: *mut *mut vortex_t, adbdma: c_int) {
    static void vortex_adbdma_pausefifo(vortex_t * vortex, int adbdma)
    {
    stream_t *dma = &vortex.dma_adb[adbdma];
    let mut this_8: c_int = 0, this_4 = 0;
    switch (dma.fifo_status) {
    case FIFO_START:
    vortex_fifo_setadbctrl(vortex, adbdma, dma.dma_unknown,
    this_4, this_8, 0, 0);
...
#[no_mangle]
unsafe extern "C" fn vortex_adbdma_stopfifo(vortex: *mut *mut vortex_t, adbdma: c_int) {
    static void vortex_adbdma_stopfifo(vortex_t * vortex, int adbdma)
    {
    stream_t *dma = &vortex.dma_adb[adbdma];
    let mut this_4: c_int = 0, this_8 = 0;
    if (dma.fifo_status == FIFO_START)
    vortex_fifo_setadbctrl(vortex, adbdma, dma.dma_unknown,
    this_4, this_8, 0, 0);
#[no_mangle]
pub unsafe extern "C" fn if(FIFO_STOP: dma->fifo_status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_setfirstbuffer(vortex: *mut *mut vortex_t, wtdma: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_setstartbuffer(vortex: *mut *mut vortex_t, wtdma: c_int, sb: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_bufshift(vortex: *mut *mut vortex_t, wtdma: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_getcursubuffer(vortex: *mut *mut vortex_t, wtdma: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vortex_wtdma_getlinearpos(vortex: *mut *mut vortex_t, wtdma: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_startfifo(vortex: *mut *mut vortex_t, wtdma: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_resumefifo(vortex: *mut *mut vortex_t, wtdma: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_pausefifo(vortex: *mut *mut vortex_t, wtdma: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_wtdma_stopfifo(vortex: *mut *mut vortex_t, wtdma: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_adb_init(vortex: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_adb_en_sr(vortex: *mut *mut vortex_t, channel: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_adb_dis_sr(vortex: *mut *mut vortex_t, channel: c_int) {
    ...
    if ((rnum <= 0) || (route == core::ptr::null_mut()))
    return;
// Write last routes.
    rnum--;
    hwwrite(vortex.mmio,
...
// Make bridge over deleted route.
    ...
    channel);
#[no_mangle]
pub unsafe extern "C" fn if(NR_MIXOUT): (source < (OFFSET_MIXOUT +) -> else {
...
//
    ...
    resmap: resource map to be used. If core::ptr::null_mut() means that we want to allocate
...
// Default Connections
#[no_mangle]
unsafe extern "C" fn vortex_connect_default(vortex: *mut *mut vortex_t, en: c_int) {
...
//
    ...
    en = 1;
    dma = vortex_adb_checkinout(vortex, core::ptr::null_mut(), en,
    VORTEX_RESOURCE_DMA);
    if (dma < 0)
    return -EBUSY;
    }
...
#[no_mangle]
unsafe extern "C" fn vortex_settimer(vortex: *mut *mut vortex_t, period: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vortex_enable_timer_int(card: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_disable_timer_int(card: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_enable_int(card: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_disable_int(card: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Codec
pub const POLL_COUNT: c_int = 1000;
#[no_mangle]
unsafe extern "C" fn vortex_codec_init(vortex: *mut *mut vortex_t) {
...
#[no_mangle]
unsafe extern "C" fn vortex_codec_read(codec: *mut *mut snd_ac97, addr: c_ushort) -> c_ushort {
    static unsigned short vortex_codec_read(struct snd_ac97 * codec, unsigned short addr)
    {
    vortex_t *card = (vortex_t *) codec.private_data;
    u32 read_addr, data;
    let mut lifeboat: unsigned = 0;
// wait for transactions to clear
    while (!(hwread(card.mmio, VORTEX_CODEC_CTRL) & 0x100)) {
    udelay(100);
    if (lifeboat++ > POLL_COUNT) {
...
// SPDIF support
#[no_mangle]
unsafe extern "C" fn vortex_spdif_init(vortex: *mut *mut vortex_t, spdif_sr: c_int, spdif_mode: c_int) {
...
// Initialization
#[no_mangle]
unsafe extern "C" fn vortex_core_init(vortex: *mut vortex_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_core_shutdown(vortex: *mut *mut vortex_t) -> c_int {
...
// Alsa support.
#[no_mangle]
unsafe extern "C" fn vortex_alsafmt_aspfmt(alsafmt: snd_pcm_format_t, v: *mut vortex_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vortex_cdmacore_setformat(vortex: *mut *mut vortex_t, bits: c_int, nch: c_int) {
