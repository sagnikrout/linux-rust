...
//! Source: sound/pci/rme9652/rme9652.c
#![no_std]
...
//
    ...
    module_param_array(precise_ptr, bool, core::ptr::null_mut(), 0444);
...
//
pub const RME9652_NCHANNELS: c_int = 26;
pub const RME9636_NCHANNELS: c_int = 18;
// Preferred sync source choices - used by "sync_pref" control switch
pub const RME9652_SYNC_FROM_SPDIF: c_int = 0;
pub const RME9652_SYNC_FROM_ADAT1: c_int = 1;
pub const RME9652_SYNC_FROM_ADAT2: c_int = 2;
pub const RME9652_SYNC_FROM_ADAT3: c_int = 3;
...
pub const RME9652_buf_pos: c_uint = 0x000FFC0;
...
//
pub const RME9652_IO_EXTENT: c_int = 1024;
pub const RME9652_init_buffer: c_int = 0;

pub const RME9652_control_register: c_int = 64;
pub const RME9652_irq_clear: c_int = 96;
...
//
pub const RME9652_status_register: c_int = 0;
// --------- Control-Register Bits ----------------

// bits 1-3 encode buffersize/latency

// buffersize = 512Bytes * 2^n, where n is made from Bit2 ... Bit0
pub const RME9652_latency: c_uint = 0x0e;

pub const RME9652_SyncPref_ADAT1: c_int = 0;
...
pub struct snd_rme9652 {
    ...
    pub /: *mut *mut u32 thru_bits; / thru 1=on, 0=off channel 1=Bit1... channel 26= Bit26,
    pub creg_spdif: u32,
    pub creg_spdif_stream: u32,
    pub /: *mut *mut *mut char card_name; / hammerfall or hammerfall light names,
    pub /: *mut *mut size_t hw_offsetmask; / &-with status register to get real hw_offset,
    pub /: *mut *mut size_t prev_hw_offset; / previous hw offset,
    pub for: *mut *mut size_t max_jitter; / maximum jitter in frames,
    hw pointer */
    pub /: *mut *mut size_t period_bytes; / guess what this is,
    pub ds_channels: c_uchar,
    pub /: *mut *mut unsigned char ss_channels; / different for hammerfall/hammerfall-light,
...
//
    ...
    pub running: c_int,
    pub /: *mut *mut int passthru; / non-zero if doing pass-thru,
    pub /: *mut *mut *mut int hw_rev; / h/w rev  10 (i.e. 1.5 has hw_rev = 15),
    pub /: *mut *mut int last_spdif_sample_rate; / so that we can catch externally ...,
    pub /: *mut *mut int last_adat_sample_rate; / ... induced rate changes,
...
#[no_mangle]
pub unsafe extern "C" fn rme9652_write(rme9652: *mut snd_rme9652, reg: c_int, val: c_int) {
    static inline void rme9652_write(struct snd_rme9652 *rme9652, int reg, int val)
    {
    writel(val, rme9652.iobase + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn rme9652_read(rme9652: *mut snd_rme9652, reg: c_int) -> c_uint {
    static inline unsigned int rme9652_read(struct snd_rme9652 *rme9652, int reg)
    {
    return readl(rme9652.iobase + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_rme9652_use_is_exclusive(rme9652: *mut snd_rme9652) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rme9652_adat_sample_rate(rme9652: *mut snd_rme9652) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rme9652_compute_period_size(rme9652: *mut snd_rme9652) {
...
#[no_mangle]
unsafe extern "C" fn rme9652_hw_pointer(rme9652: *mut snd_rme9652) -> snd_pcm_uframes_t {
    static snd_pcm_uframes_t rme9652_hw_pointer(struct snd_rme9652 *rme9652)
    {
    int status;
    unsigned int offset, frag;
    let mut period_size: snd_pcm_uframes_t = rme9652.period_bytes / 4;
...
#[no_mangle]
pub unsafe extern "C" fn rme9652_reset_hw_pointer(rme9652: *mut snd_rme9652) {
...
#[no_mangle]
pub unsafe extern "C" fn rme9652_start(s: *mut snd_rme9652) {
...
#[no_mangle]
pub unsafe extern "C" fn rme9652_stop(s: *mut snd_rme9652) {
...
#[no_mangle]
unsafe extern "C" fn rme9652_set_rate(rme9652: *mut snd_rme9652, rate: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_set_thru(rme9652: *mut snd_rme9652, channel: c_int, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rme9652_set_passthru(rme9652: *mut snd_rme9652, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_spdif_set_bit(rme9652: *mut snd_rme9652, mask: c_int, onoff: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rme9652_spdif_write_byte(rme9652: *mut snd_rme9652, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rme9652_spdif_read_byte(rme9652: *mut snd_rme9652) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_write_spdif_codec(rme9652: *mut snd_rme9652, address: c_int, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rme9652_spdif_read_codec(rme9652: *mut snd_rme9652, address: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_initialize_spdif_receiver(rme9652: *mut snd_rme9652) {
...
#[no_mangle]
pub unsafe extern "C" fn rme9652_spdif_sample_rate(s: *mut snd_rme9652) -> c_int {
...
// -----------------------------------------------------------------------------
    ...
    ----------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn snd_rme9652_convert_from_aes(aes: *mut snd_aes_iec958) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_convert_to_aes(aes: *mut snd_aes_iec958, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_stream_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_stream_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_stream_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_mask_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_control_spdif_mask_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_adat1_in(rme9652: *mut snd_rme9652) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rme9652_set_adat1_input(rme9652: *mut snd_rme9652, internal: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_info_adat1_in(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_adat1_in(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_put_adat1_in(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_spdif_in(rme9652: *mut snd_rme9652) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rme9652_set_spdif_input(rme9652: *mut snd_rme9652, in: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_info_spdif_in(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_spdif_in(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_put_spdif_in(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_spdif_out(rme9652: *mut snd_rme9652) -> c_int {
    static int rme9652_spdif_out(struct snd_rme9652 *rme9652)
    {
    return (rme9652.control_register & RME9652_opt_out) ? 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn rme9652_set_spdif_output(rme9652: *mut snd_rme9652, out: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_spdif_out(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_put_spdif_out(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_sync_mode(rme9652: *mut snd_rme9652) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_set_sync_mode(rme9652: *mut snd_rme9652, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_info_sync_mode(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_sync_mode(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_put_sync_mode(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_sync_pref(rme9652: *mut snd_rme9652) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_set_sync_pref(rme9652: *mut snd_rme9652, pref: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_info_sync_pref(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_sync_pref(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_put_sync_pref(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_info_thru(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_thru(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int snd_rme9652_get_thru(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct snd_rme9652 *rme9652 = snd_kcontrol_chip(kcontrol);
    unsigned int k;
    let mut thru_bits: u32 = rme9652.thru_bits;
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_put_thru(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int snd_rme9652_put_thru(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct snd_rme9652 *rme9652 = snd_kcontrol_chip(kcontrol);
    int change;
    unsigned int chn;
    let mut thru_bits: u32 = 0;
    if (!snd_rme9652_use_is_exclusive(rme9652))
    return -EBUSY;
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_passthru(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_put_passthru(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_info_spdif_rate(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_spdif_rate(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_info_adat_sync(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_adat_sync(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_get_tc_valid(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_create_controls(card: *mut snd_card, rme9652: *mut snd_rme9652) -> c_int {
...
// ------------------------------------------------------------
    ...
    let mut thru_bits: u32 = rme9652.thru_bits;
    let mut show_auto_sync_source: c_int = 0;
    int i;
    unsigned int status;
    int x;
    status = rme9652_read(rme9652, RME9652_status_register);
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_proc_init(rme9652: *mut snd_rme9652) {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_card_free(card: *mut snd_card) {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_initialize_memory(rme9652: *mut snd_rme9652) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_set_defaults(rme9652: *mut snd_rme9652) {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_hw_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_reset(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rme9652_silence_playback(rme9652: *mut snd_rme9652) {
    ...
    rme9652_start(rme9652);
#[no_mangle]
pub unsafe extern "C" fn if(!running: rme9652->running &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_playback_open(substream: *mut snd_pcm_substream) -> c_int {
    ...
    if (rme9652.capture_substream == core::ptr::null_mut()) {
    rme9652_stop(rme9652);
    rme9652_set_thru(rme9652, -1, 0);
    }
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_playback_release(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_rme9652_playback_release(struct snd_pcm_substream *substream)
    {
    struct snd_rme9652 *rme9652 = snd_pcm_substream_chip(substream);
    scoped_guard(spinlock_irq, &rme9652.lock) {
    rme9652.playback_pid = -1;
    rme9652.playback_substream = core::ptr::null_mut();
    }
    rme9652.spdif_ctl.vd[0].access |= SNDRV_CTL_ELEM_ACCESS_INACTIVE;
    snd_ctl_notify(rme9652.card, SNDRV_CTL_EVENT_MASK_VALUE |
    SNDRV_CTL_EVENT_MASK_INFO, &rme9652.spdif_ctl.id);
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_capture_open(substream: *mut snd_pcm_substream) -> c_int {
    ...
    if (rme9652.playback_substream == core::ptr::null_mut()) {
    rme9652_stop(rme9652);
    rme9652_set_thru(rme9652, -1, 0);
    }
...
#[no_mangle]
unsafe extern "C" fn snd_rme9652_capture_release(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_rme9652_capture_release(struct snd_pcm_substream *substream)
    {
    struct snd_rme9652 *rme9652 = snd_pcm_substream_chip(substream);
    guard(spinlock_irq)(&rme9652.lock);
    rme9652.capture_pid = -1;
    rme9652.capture_substream = core::ptr::null_mut();
    return 0;
    }
...
// who knows?
    ...
    if (rme9652.iobase == core::ptr::null_mut()) {
