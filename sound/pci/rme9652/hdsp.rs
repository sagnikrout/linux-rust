...
//! Source: sound/pci/rme9652/hdsp.c
#![no_std]
...
pub const HDSP_MAX_CHANNELS: c_int = 26;
pub const HDSP_MAX_DS_CHANNELS: c_int = 14;
pub const HDSP_MAX_QS_CHANNELS: c_int = 8;
pub const DIGIFACE_SS_CHANNELS: c_int = 26;
pub const DIGIFACE_DS_CHANNELS: c_int = 14;
pub const MULTIFACE_SS_CHANNELS: c_int = 18;
pub const MULTIFACE_DS_CHANNELS: c_int = 14;
pub const H9652_SS_CHANNELS: c_int = 26;
pub const H9652_DS_CHANNELS: c_int = 14;
// This does not include possible Analog Extension Boards
    AEBs are detected at card initialization
//
pub const H9632_SS_CHANNELS: c_int = 12;
pub const H9632_DS_CHANNELS: c_int = 8;
pub const H9632_QS_CHANNELS: c_int = 4;
pub const RPM_CHANNELS: c_int = 6;
// Write registers. These are defined as byte-offsets from the iobase value.
//
pub const HDSP_resetPointer: c_int = 0;
pub const HDSP_freqReg: c_int = 0;
pub const HDSP_outputBufferAddress: c_int = 32;
pub const HDSP_inputBufferAddress: c_int = 36;
pub const HDSP_controlRegister: c_int = 64;
pub const HDSP_interruptConfirmation: c_int = 96;
pub const HDSP_outputEnable: c_int = 128;
pub const HDSP_control2Reg: c_int = 256;
pub const HDSP_midiDataOut0: c_int = 352;
pub const HDSP_midiDataOut1: c_int = 356;
pub const HDSP_fifoData: c_int = 368;
pub const HDSP_inputEnable: c_int = 384;
// Read registers. These are defined as byte-offsets from the iobase value
//
pub const HDSP_statusRegister: c_int = 0;
pub const HDSP_timecode: c_int = 128;
pub const HDSP_status2Register: c_int = 192;
pub const HDSP_midiDataIn0: c_int = 360;
pub const HDSP_midiDataIn1: c_int = 364;
pub const HDSP_midiStatusOut0: c_int = 384;
pub const HDSP_midiStatusOut1: c_int = 388;
pub const HDSP_midiStatusIn0: c_int = 392;
pub const HDSP_midiStatusIn1: c_int = 396;
pub const HDSP_fifoStatus: c_int = 400;
...
//
pub const HDSP_9652_peakBase: c_int = 7164;
pub const HDSP_9652_rmsBase: c_int = 4096;
// c.f. the hdsp_9632_meters_t struct
pub const HDSP_9632_metersBase: c_int = 4096;
pub const HDSP_IO_EXTENT: c_int = 7168;
// control2 register bits
pub const HDSP_TMS: c_uint = 0x01;
pub const HDSP_TCK: c_uint = 0x02;
pub const HDSP_TDI: c_uint = 0x04;
pub const HDSP_JTAG: c_uint = 0x08;
pub const HDSP_PWDN: c_uint = 0x10;
pub const HDSP_PROGRAM: c_uint = 0x020;
pub const HDSP_CONFIG_MODE_0: c_uint = 0x040;
pub const HDSP_CONFIG_MODE_1: c_uint = 0x080;

pub const HDSP_BIGENDIAN_MODE: c_uint = 0x200;
pub const HDSP_RD_MULTIPLE: c_uint = 0x400;
pub const HDSP_9652_ENABLE_MIXER: c_uint = 0x800;
pub const HDSP_S200: c_uint = 0x800;

pub const HDSP_CYCLIC_MODE: c_uint = 0x1000;
pub const HDSP_TDO: c_uint = 0x10000000;

// Control Register bits

// RPM uses some of the registers for special purposes
pub const HDSP_RPM_Inp12: c_uint = 0x04A00;
pub const HDSP_RPM_Inp12_Phon_6dB: c_uint = 0x00800  /* Dolby */;
pub const HDSP_RPM_Inp12_Phon_0dB: c_uint = 0x00000  /* .. */;
pub const HDSP_RPM_Inp12_Phon_n6dB: c_uint = 0x04000  /* inp_0 */;
pub const HDSP_RPM_Inp12_Line_0dB: c_uint = 0x04200  /* Dolby+PRO */;
pub const HDSP_RPM_Inp12_Line_n6dB: c_uint = 0x00200  /* PRO */;
pub const HDSP_RPM_Inp34: c_uint = 0x32000;
pub const HDSP_RPM_Inp34_Phon_6dB: c_uint = 0x20000  /* SyncRef1 */;
pub const HDSP_RPM_Inp34_Phon_0dB: c_uint = 0x00000  /* .. */;
pub const HDSP_RPM_Inp34_Phon_n6dB: c_uint = 0x02000  /* SyncRef2 */;
pub const HDSP_RPM_Inp34_Line_0dB: c_uint = 0x30000  /* SyncRef1+SyncRef0 */;
pub const HDSP_RPM_Inp34_Line_n6dB: c_uint = 0x10000  /* SyncRef0 */;
pub const HDSP_RPM_Bypass: c_uint = 0x01000;
pub const HDSP_RPM_Disconnect: c_uint = 0x00001;

pub const HDSP_ADGainLowGain: c_int = 0;

pub const HDSP_DAGainMinus10dBV: c_int = 0;

pub const HDSP_PhoneGainMinus12dB: c_int = 0;

pub const HDSP_SPDIFInputADAT1: c_int = 0;

pub const HDSP_SyncRef_ADAT1: c_int = 0;

// Sample Clock Sources
pub const HDSP_CLOCK_SOURCE_AUTOSYNC: c_int = 0;
pub const HDSP_CLOCK_SOURCE_INTERNAL_32KHZ: c_int = 1;
pub const HDSP_CLOCK_SOURCE_INTERNAL_44_1KHZ: c_int = 2;
pub const HDSP_CLOCK_SOURCE_INTERNAL_48KHZ: c_int = 3;
pub const HDSP_CLOCK_SOURCE_INTERNAL_64KHZ: c_int = 4;
pub const HDSP_CLOCK_SOURCE_INTERNAL_88_2KHZ: c_int = 5;
pub const HDSP_CLOCK_SOURCE_INTERNAL_96KHZ: c_int = 6;
pub const HDSP_CLOCK_SOURCE_INTERNAL_128KHZ: c_int = 7;
pub const HDSP_CLOCK_SOURCE_INTERNAL_176_4KHZ: c_int = 8;
pub const HDSP_CLOCK_SOURCE_INTERNAL_192KHZ: c_int = 9;
// Preferred sync reference choices - used by "pref_sync_ref" control switch
pub const HDSP_SYNC_FROM_WORD: c_int = 0;
pub const HDSP_SYNC_FROM_SPDIF: c_int = 1;
pub const HDSP_SYNC_FROM_ADAT1: c_int = 2;
pub const HDSP_SYNC_FROM_ADAT_SYNC: c_int = 3;
pub const HDSP_SYNC_FROM_ADAT2: c_int = 4;
pub const HDSP_SYNC_FROM_ADAT3: c_int = 5;
// SyncCheck status
pub const HDSP_SYNC_CHECK_NO_LOCK: c_int = 0;
pub const HDSP_SYNC_CHECK_LOCK: c_int = 1;
pub const HDSP_SYNC_CHECK_SYNC: c_int = 2;
// AutoSync references - used by "autosync_ref" control switch
pub const HDSP_AUTOSYNC_FROM_WORD: c_int = 0;
pub const HDSP_AUTOSYNC_FROM_ADAT_SYNC: c_int = 1;
pub const HDSP_AUTOSYNC_FROM_SPDIF: c_int = 2;
pub const HDSP_AUTOSYNC_FROM_NONE: c_int = 3;
pub const HDSP_AUTOSYNC_FROM_ADAT1: c_int = 4;
pub const HDSP_AUTOSYNC_FROM_ADAT2: c_int = 5;
pub const HDSP_AUTOSYNC_FROM_ADAT3: c_int = 6;
...
pub const HDSP_BufferPositionMask: c_uint = 0x000FFC0 /* Bit 6..15 : h/w buffer pointer */;
...
pub const HDSP_SelSyncRef_ADAT1: c_int = 0;

// Card state flags

// FIFO wait times, defined in terms of 1/10ths of msecs
pub const HDSP_LONG_WAIT: c_int = 5000;
pub const HDSP_SHORT_WAIT: c_int = 30;
pub const UNITY_GAIN: c_int = 32768;
pub const MINUS_INFINITY_GAIN: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdsp_9632_meters {
    pub input_peak: [u32; 16],
    pub playback_peak: [u32; 16],
    pub output_peak: [u32; 16],
    pub xxx_peak: [u32; 16],
    pub padding: [u32; 64],
    pub input_rms_low: [u32; 16],
    pub playback_rms_low: [u32; 16],
    pub output_rms_low: [u32; 16],
    pub xxx_rms_low: [u32; 16],
    pub input_rms_high: [u32; 16],
    pub playback_rms_high: [u32; 16],
    pub output_rms_high: [u32; 16],
    pub xxx_rms_high: [u32; 16],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdsp_midi {
    pub hdsp: *mut hdsp,
    pub id: c_int,
    pub rmidi: *mut snd_rawmidi,
    pub input: *mut snd_rawmidi_substream,
    pub output: *mut snd_rawmidi_substream,
    pub /: *mut *mut signed char istimer; / timer in use,
...
pub struct hdsp {
    ...
    pub midi: [hdsp_midi; 2],
    pub midi_work: work_struct,
    pub use_midi_work: c_int,
    pub precise_ptr: c_int,
    pub /: *mut *mut u32 control_register; / cached value,
    pub /: *mut *mut u32 control2_register; / cached value,
    pub creg_spdif: u32,
    pub creg_spdif_stream: u32,
    pub clock_source_locked: c_int,
    pub /: *mut *mut *mut char card_name; / digiface/multiface/rpm,
    pub /: *mut *mut enum HDSP_IO_Type io_type; / ditto, but for code use,
    pub firmware_rev: c_ushort,
    pub /: *mut *mut unsigned short state; / stores state bits,
    pub firmware: *const firmware,
    pub fw_uploaded: *mut u32,
    pub /: *mut *mut size_t period_bytes; / guess what this is,
    pub max_channels: c_uchar,
    pub /: *mut *mut unsigned char qs_in_channels; / quad speed mode for H9632,
    pub ds_in_channels: c_uchar,
    pub /: *mut *mut unsigned char ss_in_channels; / different for multiface/digiface,
    pub qs_out_channels: c_uchar,
    pub ds_out_channels: c_uchar,
    pub ss_out_channels: c_uchar,
    pub states*/: *mut *mut u32 io_loopback; / output loopback channel,
...
//
    ...
    pub /: *mut *mut *mut unsigned char capture_buffer; / suitably aligned address,
    pub /: *mut *mut *mut unsigned char playback_buffer; / suitably aligned address,
    pub capture_pid: pid_t,
    pub playback_pid: pid_t,
    pub running: c_int,
    pub system_sample_rate: c_int,
    pub channel_map: *const signed char,
    pub dev: c_int,
    pub irq: c_int,
    pub port: c_ulong,
    ...
    pub mixer_matrix: [c_ushort; HDSP_MATRIX_MIXER_SIZE],
    pub /: *mut *mut unsigned int dds_value; / last value written to freq register,
}
...
#[no_mangle]
pub unsafe extern "C" fn channel(number: i.e. channel buffer) -> and the value is the DMA {
...
#[no_mangle]
unsafe extern "C" fn hdsp_playback_to_output_key(hdsp: *mut hdsp, in: c_int, out: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_input_to_output_key(hdsp: *mut hdsp, in: c_int, out: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_write(hdsp: *mut hdsp, reg: c_int, val: c_int) {
    static void hdsp_write(struct hdsp *hdsp, int reg, int val)
    {
    writel(val, hdsp.iobase + reg);
    }
#[no_mangle]
unsafe extern "C" fn hdsp_read(hdsp: *mut hdsp, reg: c_int) -> c_uint {
    static unsigned int hdsp_read(struct hdsp *hdsp, int reg)
    {
    return readl (hdsp.iobase + reg);
    }
#[no_mangle]
unsafe extern "C" fn hdsp_check_for_iobox(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_load_firmware_from_cache(hdsp: *mut hdsp) -> c_int {
    int i;
    const u32 *cache;
    if (hdsp.fw_uploaded)
...
#[no_mangle]
unsafe extern "C" fn hdsp_get_iobox_version(hdsp: *mut hdsp) -> c_int {
...
// firmware was already loaded, get iobox type
    ...
    hdsp.io_type = RPM;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hdsp_read(hdsp, HDSP_version1: HDSP_status2Register) &) -> else {
...
#[no_mangle]
unsafe extern "C" fn hdsp_check_for_firmware(hdsp: *mut hdsp, load_on_demand: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_fifo_wait(hdsp: *mut hdsp, count: c_int, timeout: c_int) -> c_int {
    static int hdsp_fifo_wait(struct hdsp *hdsp, int count, int timeout)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn hdsp_read_gain(hdsp: *mut hdsp, addr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_write_gain(hdsp: *mut hdsp, addr: c_uint, data: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_use_is_exclusive(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_spdif_sample_rate(hdsp: *mut hdsp) -> c_int {
    static int hdsp_spdif_sample_rate(struct hdsp *hdsp)
    {
    let mut status: c_uint = hdsp_read(hdsp, HDSP_statusRegister);
    let mut rate_bits: c_uint = (status & HDSP_spdifFrequencyMask);
...
#[no_mangle]
unsafe extern "C" fn hdsp_external_sample_rate(hdsp: *mut hdsp) -> c_int {
    static int hdsp_external_sample_rate(struct hdsp *hdsp)
    {
    let mut status2: c_uint = hdsp_read(hdsp, HDSP_status2Register);
    let mut rate_bits: c_uint = status2 & HDSP_systemFrequencyMask;
...
#[no_mangle]
unsafe extern "C" fn hdsp_compute_period_size(hdsp: *mut hdsp) {
    static void hdsp_compute_period_size(struct hdsp *hdsp)
    {
    hdsp.period_bytes = 1 << ((hdsp_decode_latency(hdsp.control_register) + 8));
    }
#[no_mangle]
unsafe extern "C" fn hdsp_hw_pointer(hdsp: *mut hdsp) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn hdsp_reset_hw_pointer(hdsp: *mut hdsp) {
...
#[no_mangle]
unsafe extern "C" fn hdsp_start_audio(s: *mut hdsp) {
...
#[no_mangle]
unsafe extern "C" fn hdsp_stop_audio(s: *mut hdsp) {
...
#[no_mangle]
unsafe extern "C" fn hdsp_silence_playback(hdsp: *mut hdsp) {
    static void hdsp_silence_playback(struct hdsp *hdsp)
    {
    memset(hdsp.playback_buffer, 0, HDSP_DMA_AREA_BYTES);
    }
#[no_mangle]
unsafe extern "C" fn hdsp_set_interrupt_interval(s: *mut hdsp, frames: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_dds_value(hdsp: *mut hdsp, rate: c_int) {
    ...
    rate /= 4;
#[no_mangle]
pub unsafe extern "C" fn if(56000: rate >=) -> else {
    else if (rate >= 56000)
    rate /= 2;
    n = DDS_NUMERATOR;
    n = div_u64(n, rate);
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_rate(hdsp: *mut hdsp, rate: c_int, called_internally: c_int) -> c_int {
    static int hdsp_set_rate(struct hdsp *hdsp, int rate, int called_internally)
    {
    let mut reject_if_open: c_int = 0;
    int current_rate;
    int rate_bits;
...
// hw_param request while in AutoSync mode
    let mut external_freq: c_int = hdsp_external_sample_rate(hdsp);
    let mut spdif_freq: c_int = hdsp_spdif_sample_rate(hdsp);
    if ((spdif_freq == external_freq*2) && (hdsp_autosync_ref(hdsp) >= HDSP_AUTOSYNC_FROM_ADAT1))
    dev_info(hdsp.card.dev,
    "Detected ADAT in double speed mode\n");
#[no_mangle]
pub unsafe extern "C" fn if(HDSP_AUTOSYNC_FROM_ADAT1): *mut *mut hdsp->io_type == H9632 && (spdif_freq == external_freq4) && (hdsp_autosync_ref(hdsp) >=) -> else {
    else if (hdsp.io_type == H9632 && (spdif_freq == external_freq*4) && (hdsp_autosync_ref(hdsp) >= HDSP_AUTOSYNC_FROM_ADAT1))
    dev_info(hdsp.card.dev,
    "Detected ADAT in quad speed mode\n");
#[no_mangle]
pub unsafe extern "C" fn if(external_freq: rate !=) -> else {
    dev_info(hdsp.card.dev,
...
// ----------------------------------------------------------------------------
    ...
    ----------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_read_byte(hdsp: *mut hdsp, id: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_write_byte(hdsp: *mut hdsp, id: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_input_available(hdsp: *mut hdsp, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_output_possible(hdsp: *mut hdsp, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_flush_midi_input(hdsp: *mut hdsp, id: c_int) {
    static void snd_hdsp_flush_midi_input (struct hdsp *hdsp, int id)
    {
    let mut count: c_int = 256;
    while (snd_hdsp_midi_input_available(hdsp, id) && --count)
    snd_hdsp_midi_read_byte(hdsp, id);
    }
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_output_write(hmidi: *mut hdsp_midi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_input_read(hmidi: *mut hdsp_midi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_input_trigger(substream: *mut snd_rawmidi_substream, up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_output_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_output_trigger(substream: *mut snd_rawmidi_substream, up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_input_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_output_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_input_close(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    hmidi = (struct hdsp_midi *) substream.rmidi.private_data;
    guard(spinlock_irq)(&hmidi.lock);
    hmidi.input = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_hdsp_midi_output_close(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    hmidi = (struct hdsp_midi *) substream.rmidi.private_data;
    guard(spinlock_irq)(&hmidi.lock);
    hmidi.output = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_create_midi(card: *mut snd_card, hdsp: *mut hdsp, id: c_int) -> c_int {
    static int snd_hdsp_create_midi (struct snd_card *card, struct hdsp *hdsp, int id)
    {
    char buf[40];
    hdsp.midi[id].id = id;
    hdsp.midi[id].rmidi = core::ptr::null_mut();
    hdsp.midi[id].input = core::ptr::null_mut();
    hdsp.midi[id].output = core::ptr::null_mut();
...
// -----------------------------------------------------------------------------
    ...
    ----------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn snd_hdsp_convert_from_aes(aes: *mut snd_aes_iec958) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_convert_to_aes(aes: *mut snd_aes_iec958, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_stream_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_stream_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_stream_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_mask_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_control_spdif_mask_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_spdif_in(hdsp: *mut hdsp) -> c_uint {
    static unsigned int hdsp_spdif_in(struct hdsp *hdsp)
    {
    return hdsp_decode_spdif_in(hdsp.control_register & HDSP_SPDIFInputMask);
    }
#[no_mangle]
unsafe extern "C" fn hdsp_set_spdif_input(hdsp: *mut hdsp, in: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_spdif_in(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_spdif_in(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_spdif_in(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_toggle_setting(hdsp: *mut hdsp, regmask: u32) -> c_int {
    static int hdsp_toggle_setting(struct hdsp *hdsp, u32 regmask)
    {
    return (hdsp.control_register & regmask) ? 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn hdsp_set_toggle_setting(hdsp: *mut hdsp, regmask: u32, out: c_int) -> c_int {
    ...
    {
    struct hdsp *hdsp = snd_kcontrol_chip(kcontrol);
    let mut regmask: u32 = kcontrol.private_value;
    guard(spinlock_irq)(&hdsp.lock);
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_spdif_sample_rate(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_spdif_sample_rate(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_system_sample_rate(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_system_sample_rate(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_autosync_sample_rate(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_autosync_sample_rate(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_system_clock_mode(hdsp: *mut hdsp) -> c_int {
    static int hdsp_system_clock_mode(struct hdsp *hdsp)
    {
    if (hdsp.control_register & HDSP_ClockModeMaster)
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(hdsp->system_sample_rate: hdsp_external_sample_rate(hdsp) !=) -> else {
    else if (hdsp_external_sample_rate(hdsp) != hdsp.system_sample_rate)
    return 0;
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_system_clock_mode(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_system_clock_mode(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_clock_source(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_clock_source(hdsp: *mut hdsp, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_clock_source(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_clock_source(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_clock_source(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_clock_source_lock(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_clock_source_lock(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_da_gain(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_da_gain(hdsp: *mut hdsp, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_da_gain(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_da_gain(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_da_gain(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_ad_gain(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_ad_gain(hdsp: *mut hdsp, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_ad_gain(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_ad_gain(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_ad_gain(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_phone_gain(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_phone_gain(hdsp: *mut hdsp, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_phone_gain(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_phone_gain(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_phone_gain(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_pref_sync_ref(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_pref_sync_ref(hdsp: *mut hdsp, pref: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_pref_sync_ref(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_pref_sync_ref(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_pref_sync_ref(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_autosync_ref(hdsp: *mut hdsp) -> c_int {
    static int hdsp_autosync_ref(struct hdsp *hdsp)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_autosync_ref(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_autosync_ref(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_precise_pointer(hdsp: *mut hdsp, precise: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_precise_pointer(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_precise_pointer(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_use_midi_work(hdsp: *mut hdsp, use_work: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_use_midi_work(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_use_midi_work(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_mixer(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_mixer(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_mixer(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_sync_check(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_wc_sync_check(hdsp: *mut hdsp) -> c_int {
    static int hdsp_wc_sync_check(struct hdsp *hdsp)
    {
    let mut status2: c_int = hdsp_read(hdsp, HDSP_status2Register);
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_wc_sync_check(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_spdif_sync_check(hdsp: *mut hdsp) -> c_int {
    static int hdsp_spdif_sync_check(struct hdsp *hdsp)
    {
    let mut status: c_int = hdsp_read(hdsp, HDSP_statusRegister);
    if (status & HDSP_SPDIFErrorFlag)
    return 0;
    else {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_spdif_sync_check(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_adatsync_sync_check(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_adatsync_sync_check(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_adat_sync_check(hdsp: *mut hdsp, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_adat_sync_check(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_dds_offset(hdsp: *mut hdsp) -> c_int {
    static int hdsp_dds_offset(struct hdsp *hdsp)
    {
    u64 n;
    let mut dds_value: c_uint = hdsp.dds_value;
    let mut system_sample_rate: c_int = hdsp.system_sample_rate;
    if (!dds_value)
    return 0;
    n = DDS_NUMERATOR;
//
...
//
    ...
    n *= 4;
#[no_mangle]
pub unsafe extern "C" fn if(56000: system_sample_rate >=) -> else {
    else if (system_sample_rate >= 56000)
    n *= 2;
    return ((int)n) - system_sample_rate;
    }
#[no_mangle]
unsafe extern "C" fn hdsp_set_dds_offset(hdsp: *mut hdsp, offset_hz: c_int) -> c_int {
    static int hdsp_set_dds_offset(struct hdsp *hdsp, int offset_hz)
    {
    let mut rate: c_int = hdsp.system_sample_rate + offset_hz;
    hdsp_set_dds_value(hdsp, rate);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_dds_offset(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_dds_offset(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_dds_offset(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_rpm_input12(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_rpm_input12(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_rpm_input12(hdsp: *mut hdsp, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_rpm_input12(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_rpm_input(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_rpm_input34(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_rpm_input34(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_rpm_input34(hdsp: *mut hdsp, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_rpm_input34(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
// RPM Bypass switch
#[no_mangle]
unsafe extern "C" fn hdsp_rpm_bypass(hdsp: *mut hdsp) -> c_int {
    static int hdsp_rpm_bypass(struct hdsp *hdsp)
    {
    return (hdsp.control_register & HDSP_RPM_Bypass) ? 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_rpm_bypass(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_rpm_bypass(hdsp: *mut hdsp, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_rpm_bypass(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_rpm_bypass(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_rpm_disconnect(hdsp: *mut hdsp) -> c_int {
    static int hdsp_rpm_disconnect(struct hdsp *hdsp)
    {
    return (hdsp.control_register & HDSP_RPM_Disconnect) ? 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_hdsp_get_rpm_disconnect(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_set_rpm_disconnect(hdsp: *mut hdsp, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_put_rpm_disconnect(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_info_rpm_disconnect(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
    ...
    let mut snd_hdsp_adat_sync_check: static struct snd_kcontrol_new = HDSP_ADAT_SYNC_CHECK;
#[no_mangle]
unsafe extern "C" fn hdsp_loopback_get(hdsp: *const *const hdsp, channel: u8) -> bool {
    static bool hdsp_loopback_get(struct hdsp *const hdsp, const u8 channel)
    {
    return hdsp.io_loopback & (1 << channel);
    }
#[no_mangle]
unsafe extern "C" fn hdsp_loopback_set(hdsp: *const *const hdsp, channel: u8, enable: bool) -> c_int {
    ...
    {
    let mut hdsp: *mut hdsp const = snd_kcontrol_chip(kcontrol);
    let mut channel: u8 = snd_ctl_get_ioff(kcontrol, &ucontrol.id);
    ...
    let mut hdsp: *mut hdsp const = snd_kcontrol_chip(kcontrol);
    let mut channel: u8 = snd_ctl_get_ioff(kcontrol, &ucontrol.id);
    let mut enable: bool = ucontrol.value.integer.value[0] & 1;
    if (channel >= hdsp.max_channels)
    return -ENOENT;
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_create_controls(card: *mut snd_card, hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_proc_init(hdsp: *mut hdsp) {
    static void snd_hdsp_proc_init(struct hdsp *hdsp)
    {
    snd_card_ro_proc_new(hdsp.card, "hdsp", hdsp, snd_hdsp_proc_read);
    }
#[no_mangle]
unsafe extern "C" fn snd_hdsp_initialize_memory(hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_set_defaults(hdsp: *mut hdsp) -> c_int {
    static int snd_hdsp_set_defaults(struct hdsp *hdsp)
    {
    unsigned int i;
// ASSUMPTION: hdsp->lock is either held, or
...
#[no_mangle]
unsafe extern "C" fn hdsp_midi_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_hw_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_reset(substream: *mut snd_pcm_substream) -> c_int {
...
//
    ...
    {
    struct hdsp *hdsp = snd_pcm_substream_chip(substream);
    let mut channel: c_uint = info.channel;
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(!running: hdsp->running &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_playback_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_playback_release(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_hdsp_playback_release(struct snd_pcm_substream *substream)
    {
    struct hdsp *hdsp = snd_pcm_substream_chip(substream);
    scoped_guard(spinlock_irq, &hdsp.lock) {
    hdsp.playback_pid = -1;
    hdsp.playback_substream = core::ptr::null_mut();
    }
    if (RPM != hdsp.io_type) {
    hdsp.spdif_ctl.vd[0].access |= SNDRV_CTL_ELEM_ACCESS_INACTIVE;
    snd_ctl_notify(hdsp.card, SNDRV_CTL_EVENT_MASK_VALUE |
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_capture_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_capture_release(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_hdsp_capture_release(struct snd_pcm_substream *substream)
    {
    struct hdsp *hdsp = snd_pcm_substream_chip(substream);
    guard(spinlock_irq)(&hdsp.lock);
    hdsp.capture_pid = -1;
    hdsp.capture_substream = core::ptr::null_mut();
    return 0;
    }
// helper functions for copying meter values
#[no_mangle]
pub unsafe extern "C" fn copy_u32_le(dest: *mut void __user, src: *mut void __iomem) -> c_int {
    static inline int copy_u32_le(void __user *dest, void __iomem *src)
    {
    let mut val: u32 = readl(src);
    return copy_to_user(dest, &val, 4);
    }
#[no_mangle]
pub unsafe extern "C" fn copy_u64_le(dest: *mut void __user, src_low: *mut void __iomem, src_high: *mut void __iomem) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn copy_u48_le(dest: *mut void __user, src_low: *mut void __iomem, src_high: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_9652_get_peak(hdsp: *mut hdsp, peak_rms: *mut hdsp_peak_rms __user) -> c_int {
    static int hdsp_9652_get_peak(struct hdsp *hdsp, struct hdsp_peak_rms __user *peak_rms)
    {
    let mut doublespeed: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn hdsp_9632_get_peak(hdsp: *mut hdsp, peak_rms: *mut hdsp_peak_rms __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdsp_get_peak(hdsp: *mut hdsp, peak_rms: *mut hdsp_peak_rms __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_hwdep_ioctl(hw: *mut snd_hwdep, file: *mut file, cmd: c_uint, arg: c_ulong) -> c_int {
...
// SNDRV_HDSP_IOCTL_GET_VERSION must have been called
    ...
    hdsp.fw_uploaded = core::ptr::null_mut();
    return -EFAULT;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_create_hwdep(card: *mut snd_card, hdsp: *mut hdsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_create_pcm(card: *mut snd_card, hdsp: *mut hdsp) -> c_int {
    static int snd_hdsp_create_pcm(struct snd_card *card, struct hdsp *hdsp)
    {
    struct snd_pcm *pcm;
    int err;
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_9652_enable_mixer(hdsp: *mut hdsp) {
    static void snd_hdsp_9652_enable_mixer (struct hdsp *hdsp)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_enable_io(hdsp: *mut hdsp) -> c_int {
    static int snd_hdsp_enable_io (struct hdsp *hdsp)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_initialize_channels(hdsp: *mut hdsp) {
    static void snd_hdsp_initialize_channels(struct hdsp *hdsp)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_initialize_midi_flush(hdsp: *mut hdsp) {
    static void snd_hdsp_initialize_midi_flush (struct hdsp *hdsp)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_create_alsa_devices(card: *mut snd_card, hdsp: *mut hdsp) -> c_int {
    static int snd_hdsp_create_alsa_devices(struct snd_card *card, struct hdsp *hdsp)
    {
    int err;
...
#[no_mangle]
unsafe extern "C" fn hdsp_request_fw_loader(hdsp: *mut hdsp) -> c_int {
    static int hdsp_request_fw_loader(struct hdsp *hdsp)
    {
    const char *fwfile;
...
// caution: max length of firmware filename is 30!
    ...
    int err;
    let mut is_9652: c_int = 0;
    let mut is_9632: c_int = 0;
    hdsp.irq = -1;
    hdsp.state = 0;
    hdsp.midi[0].rmidi = core::ptr::null_mut();
    hdsp.midi[1].rmidi = core::ptr::null_mut();
    hdsp.midi[0].input = core::ptr::null_mut();
    hdsp.midi[1].input = core::ptr::null_mut();
    hdsp.midi[0].output = core::ptr::null_mut();
    hdsp.midi[1].output = core::ptr::null_mut();
    hdsp.midi[0].pending = 0;
    hdsp.midi[1].pending = 0;
    spin_lock_init(&hdsp.midi[0].lock);
    spin_lock_init(&hdsp.midi[1].lock);
    hdsp.iobase = core::ptr::null_mut();
...
//
    ...
    return -ENODEV;
#[no_mangle]
pub unsafe extern "C" fn if(0x64: hdsp->firmware_rev <) -> else {
    else if (hdsp.firmware_rev < 0x64)
    hdsp.card_name = "RME Hammerfall DSP";
#[no_mangle]
pub unsafe extern "C" fn if(0x96: hdsp->firmware_rev <) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_hdsp_card_free(card: *mut snd_card) {
