...
//! Source: sound/pci/cs46xx/dsp_spos_scb_lib.c
#![no_std]
...
pub struct proc_scb_info {
    pub scb_desc: *mut *mut dsp_scb_descriptor,
    pub chip: *mut snd_cs46xx,
}

#[no_mangle]
unsafe extern "C" fn remove_symbol(chip: *mut *mut snd_cs46xx, symbol: *mut *mut dsp_symbol_entry) {
    static void remove_symbol (struct snd_cs46xx * chip, struct dsp_symbol_entry * symbol)
    {
    let mut ins: *mut dsp_spos_instance = chip.dsp_spos_instance;
    let mut symbol_index: c_int = (int)(symbol - ins.symbol_table.symbols);
    ...
    {
    let mut scb_info: *mut proc_scb_info = entry.private_data;
    let mut scb: *mut dsp_scb_descriptor = scb_info.scb_desc;
    ...
    snd_iprintf(buffer,"\n");
    if (scb.parent_scb_ptr != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn _dsp_unlink_scb(chip: *mut snd_cs46xx, scb: *mut *mut dsp_scb_descriptor) {
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_dsp_remove_scb(chip: *mut snd_cs46xx, scb: *mut *mut dsp_scb_descriptor) {
...
// can't remove a SCB with childs before
    ...
    ins.scbs[scb.index].data = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_dsp_proc_free_scb_desc(scb: *mut *mut dsp_scb_descriptor) {
    void cs46xx_dsp_proc_free_scb_desc (struct dsp_scb_descriptor * scb)
    {
    if (scb.proc_info) {
    let mut scb_info: *mut proc_scb_info = scb.proc_info.private_data;
    struct snd_cs46xx *chip = scb_info.chip;
...
// register to proc
    if (ins.snd_card != core::ptr::null_mut() && ins.proc_dsp_dir != core::ptr::null_mut() &&
    scb.proc_info == core::ptr::null_mut()) {
...
// update entry in DSP RAM
    ...
    SYMBOL_CODE);
    if (task_entry == core::ptr::null_mut()) {
    ...
    "TIMINGMASTER",core::ptr::null_mut(),SCB_NO_PARENT);
    return scb;
    }
    struct dsp_scb_descriptor *
...
// Standard stereo volume control
    ...
    if (ins.null_algorithm == core::ptr::null_mut()) {
...
pub const GOF_PER_SEC: c_int = 200;
    struct dsp_scb_descriptor *
...
//
    ...
    if (ins.s16_up == core::ptr::null_mut()) {
...
// F */   0xffff,0xffff
    ...
    {
    let mut ins: *mut dsp_spos_instance = chip.dsp_spos_instance;
    let mut scb: *mut dsp_scb_descriptor = from;
    ...
    {
    let mut ins: *mut dsp_spos_instance = chip.dsp_spos_instance;
    let mut src_scb: *mut dsp_scb_descriptor = core::ptr::null_mut(), * pcm_scb, * mixer_scb = core::ptr::null_mut();
    let mut src_parent_scb: *mut dsp_scb_descriptor = core::ptr::null_mut();
...
// search for a already created SRC SCB with the same sample rate
    ...
    (pcm_index == -1 || src_scb == core::ptr::null_mut()); ++i) {
...
// 0x200 - 400 PCMreader SCBs
    ...
    core::ptr::null_mut(),         /* parent SCB ptr */
    0             /* insert point */
    );
    if (!pcm_scb) {
    dev_err(chip.card.dev,
    ...
    int period_size)
    {
    let mut temp: u32 = snd_cs46xx_peek (chip,pcm_channel.pcm_reader_scb.address << 2);
    ...
    int period_size)
    {
    let mut temp: u32 = snd_cs46xx_peek (chip,WRITEBACK_SCB_ADDR << 2);
    ...
    let mut ins: *mut dsp_spos_instance = chip.dsp_spos_instance;
    struct dsp_scb_descriptor * parent_scb;
    let mut src_scb: *mut dsp_scb_descriptor = pcm_channel.src_scb;
    guard(spinlock_irqsave)(&chip.reg_lock);
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_src_unlink(chip: *mut snd_cs46xx, src: *mut *mut dsp_scb_descriptor) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_src_link(chip: *mut snd_cs46xx, src: *mut *mut dsp_scb_descriptor) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_dsp_enable_spdif_out(chip: *mut snd_cs46xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_dsp_disable_spdif_out(chip: *mut snd_cs46xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_iec958_pre_open(chip: *mut snd_cs46xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs46xx_iec958_post_close(chip: *mut snd_cs46xx) -> c_int {
...
// deallocate stuff
    if (ins.spdif_pcm_input_scb != core::ptr::null_mut()) {
    cs46xx_dsp_remove_scb (chip,ins.spdif_pcm_input_scb);
    ins.spdif_pcm_input_scb = core::ptr::null_mut();
    }
    cs46xx_dsp_remove_scb (chip,ins.asynch_tx_scb);
