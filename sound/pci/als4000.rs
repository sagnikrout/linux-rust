...
#[no_mangle]
pub unsafe extern "C" fn snd_als4k_gcr_read(sb: *mut snd_sb, reg: enum als4k_gcr_t) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn snd_als4000_set_rate(chip: *mut snd_sb, rate: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn snd_als4000_get_format(runtime: *mut snd_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_als4000_pcm(chip: *mut snd_sb, device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_als4000_configure(chip: *mut snd_sb) {
...
#[no_mangle]
unsafe extern "C" fn snd_als4000_create_gameport(acard: *mut snd_card_als4000, dev: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_als4000_free_gameport(acard: *mut snd_card_als4000) {
