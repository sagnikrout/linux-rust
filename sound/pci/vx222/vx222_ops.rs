...
//! Source: sound/pci/vx222/vx222_ops.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn vx2_reg_addr(_chip: *mut vx_core, reg: c_int) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_inb(chip: *mut vx_core, offset: c_int) -> c_uchar {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_outb(chip: *mut vx_core, offset: c_int, val: c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_inl(chip: *mut vx_core, offset: c_int) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_outl(chip: *mut vx_core, offset: c_int, val: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn vx2_test_xilinx(_chip: *mut vx_core) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_setup_pseudo_dma(chip: *mut vx_core, do_write: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vx2_release_pseudo_dma(chip: *mut vx_core) {
...
// pseudo-dma write
    ...
    {
    let mut port: c_ulong = vx2_reg_addr(chip, VX_DMA);
    let mut offset: c_int = pipe.hw_ptr;
...
pub const VX_XILINX_RESET_MASK: c_uint = 0x40000000;
pub const VX_USERBIT0_MASK: c_uint = 0x00000004;
pub const VX_USERBIT1_MASK: c_uint = 0x00000020;
pub const VX_CNTRL_REGISTER_VALUE: c_uint = 0x00172012;
//
// transfer counts bits to PLX
//
#[no_mangle]
unsafe extern "C" fn put_xilinx_data(chip: *mut vx_core, port: c_uint, counts: c_uint, data: c_uchar) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_load_xilinx_binary(chip: *mut vx_core, xilinx: *const firmware) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_load_dsp(vx: *mut vx_core, index: c_int, dsp: *const firmware) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_test_and_ack(chip: *mut vx_core) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_validate_irq(_chip: *mut vx_core, enable: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_write_codec_reg(chip: *mut vx_core, data: c_uint) {
...
pub const AKM_CODEC_POWER_CONTROL_CMD: c_uint = 0xA007;
pub const AKM_CODEC_RESET_ON_CMD: c_uint = 0xA100;
pub const AKM_CODEC_RESET_OFF_CMD: c_uint = 0xA103;
pub const AKM_CODEC_CLOCK_FORMAT_CMD: c_uint = 0xA240;
pub const AKM_CODEC_MUTE_CMD: c_uint = 0xA38D;
pub const AKM_CODEC_UNMUTE_CMD: c_uint = 0xA30D;
pub const AKM_CODEC_LEFT_LEVEL_CMD: c_uint = 0xA400;
pub const AKM_CODEC_RIGHT_LEVEL_CMD: c_uint = 0xA500;
...
//
#[no_mangle]
unsafe extern "C" fn vx2_write_akm(chip: *mut vx_core, reg: c_int, data: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_old_write_codec_bit(chip: *mut vx_core, codec: c_int, data: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_change_audio_source(_chip: *mut vx_core, src: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_set_clock_source(_chip: *mut vx_core, source: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_reset_board(_chip: *mut vx_core, cold_reset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vx2_set_input_level(chip: *mut snd_vx222) {
...
pub const MIC_LEVEL_MAX: c_uint = 0xff;
...
// input levels
#[no_mangle]
unsafe extern "C" fn vx_input_level_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vx_input_level_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vx_input_level_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
// mic level
#[no_mangle]
unsafe extern "C" fn vx_mic_level_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vx_mic_level_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vx_mic_level_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx2_add_mic_controls(_chip: *mut vx_core) -> c_int {
