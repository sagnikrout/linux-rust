...
//
    ...
    let mut spdif_aclink: static bool = 1;
    let mut ac97_codec: static int = -1;
...
pub const ATI_REG_CMD_SPDF_THRESHOLD_SHIFT: c_int = 6;
...
pub const ATI_REG_IN_DMA_LINKPTR: c_uint = 0x20;
pub const ATI_REG_IN_DMA_DT_START: c_uint = 0x24	/* RO */;
pub const ATI_REG_IN_DMA_DT_NEXT: c_uint = 0x28	/* RO */;
pub const ATI_REG_IN_DMA_DT_CUR: c_uint = 0x2c	/* RO */;
pub const ATI_REG_IN_DMA_DT_SIZE: c_uint = 0x30;
pub const ATI_REG_OUT_DMA_SLOT: c_uint = 0x34;

pub const ATI_REG_OUT_DMA_SLOT_MASK: c_uint = 0x1ff;
pub const ATI_REG_OUT_DMA_THRESHOLD_MASK: c_uint = 0xf800;
pub const ATI_REG_OUT_DMA_THRESHOLD_SHIFT: c_int = 11;
pub const ATI_REG_OUT_DMA_LINKPTR: c_uint = 0x38;
pub const ATI_REG_OUT_DMA_DT_START: c_uint = 0x3c	/* RO */;
pub const ATI_REG_OUT_DMA_DT_NEXT: c_uint = 0x40	/* RO */;
pub const ATI_REG_OUT_DMA_DT_CUR: c_uint = 0x44	/* RO */;
pub const ATI_REG_OUT_DMA_DT_SIZE: c_uint = 0x48;
pub const ATI_REG_SPDF_CMD: c_uint = 0x4c;

pub const ATI_REG_SPDF_DMA_LINKPTR: c_uint = 0x50;
pub const ATI_REG_SPDF_DMA_DT_START: c_uint = 0x54	/* RO */;
pub const ATI_REG_SPDF_DMA_DT_NEXT: c_uint = 0x58	/* RO */;
pub const ATI_REG_SPDF_DMA_DT_CUR: c_uint = 0x5c	/* RO */;
pub const ATI_REG_SPDF_DMA_DT_SIZE: c_uint = 0x60;
pub const ATI_REG_MODEM_MIRROR: c_uint = 0x7c;
pub const ATI_REG_AUDIO_MIRROR: c_uint = 0x80;
pub const ATI_REG_6CH_REORDER: c_uint = 0x84	/* reorder slots for 6ch */;

pub const ATI_REG_FIFO_FLUSH: c_uint = 0x88;
...
// called from open callback
    pub on): *mut *mut *mut void (enable_dma)(struct atiixp chip, int,
// called from trigger (START/STOP)
    pub on): *mut *mut *mut void (enable_transfer)(struct atiixp chip, int,
// called from trigger (STOP only)
    pub chip): *mut *mut void (flush_dma)(struct atiixp,
}
...
//
#[no_mangle]
unsafe extern "C" fn snd_atiixp_update_dma(chip: *mut atiixp, dma: *mut atiixp_dma) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATI_REG_ISR_OUT_STATUS: status &) -> else {
    else if (status & ATI_REG_ISR_OUT_STATUS)
    snd_atiixp_update_dma(chip, &chip.dmas[ATI_DMA_PLAYBACK]);
    if (status & ATI_REG_ISR_IN_XRUN)
    snd_atiixp_xrun_dma(chip,  &chip.dmas[ATI_DMA_CAPTURE]);
#[no_mangle]
pub unsafe extern "C" fn if(ATI_REG_ISR_IN_STATUS: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATI_REG_ISR_SPDF_STATUS: status &) -> else {
