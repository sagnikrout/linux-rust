...
//! Source: sound/pci/ca0106/ca0106_mixer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ca0106_spdif_enable(emu: *mut snd_ca0106) {
...
#[no_mangle]
unsafe extern "C" fn ca0106_set_capture_source(emu: *mut snd_ca0106) {
    static void ca0106_set_capture_source(struct snd_ca0106 *emu)
    {
    let mut val: c_uint = emu.capture_source;
...
#[no_mangle]
unsafe extern "C" fn ca0106_set_capture_mic_line_in(emu: *mut snd_ca0106) {
...
#[no_mangle]
unsafe extern "C" fn ca0106_set_spdif_bits(emu: *mut snd_ca0106, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn decode_spdif_bits(status: *mut c_uchar, bits: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn encode_spdif_bits(status: *mut c_uchar) -> c_uint {
...
//
    ...
    {
    struct snd_ca0106 *emu = snd_kcontrol_chip(kcontrol);
    let mut reg: c_uint = kcontrol.private_value >> SPI_REG_SHIFT;
    let mut bit: c_uint = kcontrol.private_value & SPI_REG_MASK;
    ...
    int channel_id)
    {
    let mut spi_switch: snd_kcontrol_new = {0};
    int reg, bit;
    int dac_id;
    ...
    default:
// Unused channel
    spi_switch.name = core::ptr::null_mut();
    dac_id = 0;
    }
