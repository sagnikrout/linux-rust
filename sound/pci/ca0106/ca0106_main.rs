...
//! Source: sound/pci/ca0106/ca0106_main.c
#![no_std]
...
// module parameters (see "Module Parameters")
    ...
    module_param_array(subsystem, uint, core::ptr::null_mut(), 0444);
...
#[no_mangle]
unsafe extern "C" fn restore_spdif_bits(chip: *mut snd_ca0106, idx: c_int) {
    ...
    channel_id);
    let mut reg: c_int = spi_dacd_reg[dac];
    let mut bit: c_int = spi_dacd_bit[dac];
    if (power)
// Power up
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_playback_front(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_playback_center_lfe(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_playback_unknown(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_playback_rear(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_0_capture(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_1_capture(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_2_capture(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm_open_3_capture(substream: *mut snd_pcm_substream) -> c_int {
...
unsafe extern "C" fn snd_ca0106_pcm_prepare_playback(substream: *mut snd_pcm_substream) -> c_int {
    ...
    struct snd_pcm_runtime *runtime = substream.runtime;
    struct snd_ca0106_pcm *epcm = runtime.private_data;
    let mut channel: c_int = epcm.channel_id;
    u32 *table_base = (u32 *)(emu.buffer.area+(8*16*channel));
    let mut period_size_bytes: u32 = frames_to_bytes(runtime, runtime.period_size);
    let mut hcfg_mask: u32 = HCFG_PLAYBACK_S32_LE;
    let mut hcfg_set: u32 = 0x00000000;
    u32 hcfg;
    let mut reg40_mask: u32 = 0x30000 << (channel<<1);
    let mut reg40_set: u32 = 0;
    u32 reg40;
...
unsafe extern "C" fn snd_ca0106_pcm_prepare_capture(substream: *mut snd_pcm_substream) -> c_int {
    ...
    struct snd_ca0106_pcm *epcm = runtime.private_data;
    let mut channel: c_int = epcm.channel_id;
    let mut hcfg_mask: u32 = HCFG_CAPTURE_S32_LE;
    let mut hcfg_set: u32 = 0x00000000;
    u32 hcfg;
    let mut over_sampling: u32 = 0x2;
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_ac97(chip: *mut snd_ca0106) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_pcm(emu: *mut snd_ca0106, device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0106_init_chip(chip: *mut snd_ca0106, resume: c_int) {
...
// The SB0570 use SPI to control DAC.
    ...
    for (n = 0; n < size; n++) {
    let mut reg: c_int = spi_dac_init[n] >> SPI_REG_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn ca0106_stop_chip(chip: *mut snd_ca0106) {
    static void ca0106_stop_chip(struct snd_ca0106 *chip)
    {
// disable interrupts
...
#[no_mangle]
unsafe extern "C" fn ca0106_midi_read(midi: *mut snd_ca_midi, idx: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn snd_ca0106_midi(chip: *mut snd_ca0106, channel: c_uint) -> c_int {
