...
//! Source: sound/pci/cs5535audio/cs5535audio_pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_playback_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_playback_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs5535audio_playback_enable_dma(cs5535au: *mut cs5535audio) {
    static void cs5535audio_playback_enable_dma(struct cs5535audio *cs5535au)
    {
    cs_writeb(cs5535au, ACC_BM0_CMD, BM_CTL_EN);
    }
#[no_mangle]
unsafe extern "C" fn cs5535audio_playback_disable_dma(cs5535au: *mut cs5535audio) {
    static void cs5535audio_playback_disable_dma(struct cs5535audio *cs5535au)
    {
    cs_writeb(cs5535au, ACC_BM0_CMD, 0);
    }
#[no_mangle]
unsafe extern "C" fn cs5535audio_playback_pause_dma(cs5535au: *mut cs5535audio) {
...
#[no_mangle]
unsafe extern "C" fn cs5535audio_capture_read_prd(cs5535au: *mut cs5535audio) -> u32 {
    static u32 cs5535audio_capture_read_prd(struct cs5535audio *cs5535au)
    {
    return cs_readl(cs5535au, ACC_BM1_PRD);
    }
#[no_mangle]
unsafe extern "C" fn cs5535audio_capture_read_dma_pntr(cs5535au: *mut cs5535audio) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_playback_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_capture_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_capture_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cs5535audio_capture_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_cs5535audio_pcm(cs5535au: *mut cs5535audio) -> c_int {
