...
//! Source: sound/pci/oxygen/xonar_wm87x6.c
#![no_std]
...
pub const GPIO_DS_HP_DETECT: c_uint = 0x0010;
pub const GPIO_DS_INPUT_ROUTE: c_uint = 0x0040;
pub const GPIO_DS_OUTPUT_FRONTLR: c_uint = 0x0080;
pub const GPIO_DS_OUTPUT_ENABLE: c_uint = 0x0100;
pub const GPIO_SLIM_HDMI_DISABLE: c_uint = 0x0001;
pub const GPIO_SLIM_OUTPUT_ENABLE: c_uint = 0x0002;
pub const GPIO_SLIM_FIRMWARE_CLK: c_uint = 0x0040;
pub const GPIO_SLIM_FIRMWARE_DATA: c_uint = 0x0080;
pub const I2C_DEVICE_WM8776: c_uint = 0x34	/* 001101, 0, /W=0 */;
pub const LC_CONTROL_LIMITER: c_uint = 0x40000000;
pub const LC_CONTROL_ALC: c_uint = 0x20000000;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn wm8776_registers_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn wm8766_registers_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn wm8776_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn wm8766_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_ds_handle_hp_jack(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_ds_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_hdav_slim_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_ds_cleanup(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_hdav_slim_cleanup(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_ds_suspend(chip: *mut oxygen) {
    static void xonar_ds_suspend(struct oxygen *chip)
    {
    xonar_ds_cleanup(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_hdav_slim_suspend(chip: *mut oxygen) {
    static void xonar_hdav_slim_suspend(struct oxygen *chip)
    {
    xonar_hdav_slim_cleanup(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_ds_resume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_hdav_slim_resume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_wm8776_volume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_wm87x6_volume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_wm8776_mute(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_wm87x6_mute(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_wm8766_center_lfe_mix(chip: *mut oxygen, mixed: bool) {
...
#[no_mangle]
unsafe extern "C" fn xonar_ds_gpio_changed(chip: *mut oxygen) {
    ...
    struct xonar_wm87x6 *data = chip.model_data;
    let mut bit: u16 = ctl.private_value & 0xffff;
    let mut reg_index: c_uint = (ctl.private_value >> 16) & 0xff;
    let mut invert: bool = (ctl.private_value >> 24) & 1;
...
#[no_mangle]
unsafe extern "C" fn wm8776_field_set_from_ctl(ctl: *mut snd_kcontrol) {
...
#[no_mangle]
unsafe extern "C" fn wm8776_field_set(ctl: *mut snd_kcontrol, value: c_uint) -> c_int {
    ...
    struct oxygen *chip = ctl.private_data;
    struct xonar_wm87x6 *data = chip.model_data;
    let mut mux_bit: c_uint = ctl.private_value;
    value.value.integer.value[0] =
...
#[no_mangle]
unsafe extern "C" fn add_lc_controls(chip: *mut oxygen) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xonar_ds_mixer_init(chip: *mut oxygen) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(ctl->id.name, Switch"): "Mic Capture) -> else {
...
#[no_mangle]
unsafe extern "C" fn xonar_hdav_slim_mixer_init(chip: *mut oxygen) -> c_int {
