...
//! Source: sound/pci/oxygen/xonar_cs43xx.c
#![no_std]
...
pub const GPIO_D1_OUTPUT_ENABLE: c_uint = 0x0001;
pub const GPIO_D1_FRONT_PANEL: c_uint = 0x0002;
pub const GPIO_D1_MAGIC: c_uint = 0x00c0;
pub const GPIO_D1_INPUT_ROUTE: c_uint = 0x0100;
pub const I2C_DEVICE_CS4398: c_uint = 0x9e	/* 10011, AD1=1, AD0=1, /W=0 */;
pub const I2C_DEVICE_CS4362A: c_uint = 0x30	/* 001100, AD0=0, /W=0 */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xonar_cs43xx {
    pub generic: xonar_generic,
    pub cs4398_regs: [u8; 8],
    pub cs4362a_regs: [u8; 15],
}

#[no_mangle]
unsafe extern "C" fn cs4398_write(chip: *mut oxygen, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn cs4398_write_cached(chip: *mut oxygen, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn cs4362a_write(chip: *mut oxygen, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn cs4362a_write_cached(chip: *mut oxygen, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn cs43xx_registers_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_d1_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_dx_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_d1_cleanup(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_d1_suspend(chip: *mut oxygen) {
    static void xonar_d1_suspend(struct oxygen *chip)
    {
    xonar_d1_cleanup(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_d1_resume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_cs4362a_volumes(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_cs43xx_volume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_cs43xx_mute(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_cs43xx_center_lfe_mix(chip: *mut oxygen, mixed: bool) {
...
#[no_mangle]
unsafe extern "C" fn xonar_d1_mixer_init(chip: *mut oxygen) -> c_int {
