...
//! Source: sound/pci/oxygen/oxygen_lib.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_uart_input_ready(chip: *mut oxygen) -> c_int {
...
// no data, but read it anyway to clear the interrupt
    ...
    do {
    let mut data: u8 = oxygen_read8(chip, OXYGEN_MPU401);
    if (data == MPU401_ACK)
    continue;
...
#[no_mangle]
unsafe extern "C" fn oxygen_interrupt(dummy: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn configure_pcie_bridge(pci: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn oxygen_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn oxygen_shutdown(chip: *mut oxygen) {
...
#[no_mangle]
pub unsafe extern "C" fn is_bit_set(bitmap: *const u32, bit: c_uint) -> c_int {
    static inline int is_bit_set(const u32 *bitmap, unsigned int bit)
    {
    return bitmap[bit / 32] & (1 << (bit & 31));
    }
#[no_mangle]
unsafe extern "C" fn oxygen_restore_ac97(chip: *mut oxygen, codec: c_uint) {
