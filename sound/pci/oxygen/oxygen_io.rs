...
//! Source: sound/pci/oxygen/oxygen_io.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_read8(chip: *mut oxygen, reg: c_uint) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_read16(chip: *mut oxygen, reg: c_uint) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_read32(chip: *mut oxygen, reg: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_write8(chip: *mut oxygen, reg: c_uint, value: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_write16(chip: *mut oxygen, reg: c_uint, value: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_write32(chip: *mut oxygen, reg: c_uint, value: u32) {
    ...
    u8 value, u8 mask)
    {
    let mut tmp: u8 = inb(chip.addr + reg);
    tmp &= ~mask;
    tmp |= value & mask;
    ...
    u16 value, u16 mask)
    {
    let mut tmp: u16 = inw(chip.addr + reg);
    tmp &= ~mask;
    tmp |= value & mask;
    ...
    u32 value, u32 mask)
    {
    let mut tmp: u32 = inl(chip.addr + reg);
    tmp &= ~mask;
    tmp |= value & mask;
...
#[no_mangle]
unsafe extern "C" fn oxygen_ac97_wait(chip: *mut oxygen, mask: c_uint) -> c_int {
...
// require two "completed" writes, just to be sure
    ...
    {
    unsigned int count;
    let mut last_read: c_uint = UINT_MAX;
    u32 reg;
    reg = index << OXYGEN_AC97_REG_ADDR_SHIFT;
    ...
    let mut value: u16 = oxygen_read16(chip, OXYGEN_AC97_REGS);
...
#[no_mangle]
unsafe extern "C" fn oxygen_wait_spi(chip: *mut oxygen) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_write_spi(chip: *mut oxygen, control: u8, data: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _write_uart(chip: *mut oxygen, port: c_uint, data: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_read_eeprom(chip: *mut oxygen, index: c_uint) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn oxygen_write_eeprom(chip: *mut oxygen, index: c_uint, value: u16) {
