...
//! Source: sound/pci/oxygen/se6x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn se6x_cleanup(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn se6x_probe(pci: *mut pci_dev, pci_id: *const pci_device_id) -> c_int {
