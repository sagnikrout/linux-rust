...
//! Source: sound/pci/oxygen/xonar_pcm179x.c
#![no_std]
...
pub const GPIO_D2X_EXT_POWER: c_uint = 0x0020;
pub const GPIO_D2_ALT: c_uint = 0x0080;
pub const GPIO_D2_OUTPUT_ENABLE: c_uint = 0x0100;
pub const GPI_EXT_POWER: c_uint = 0x01;
pub const GPIO_INPUT_ROUTE: c_uint = 0x0100;
pub const GPIO_HDAV_OUTPUT_ENABLE: c_uint = 0x0001;
pub const GPIO_HDAV_MAGIC: c_uint = 0x00c0;
pub const GPIO_DB_MASK: c_uint = 0x0030;
pub const GPIO_DB_H6: c_uint = 0x0000;
pub const GPIO_ST_OUTPUT_ENABLE: c_uint = 0x0001;
pub const GPIO_ST_HP_REAR: c_uint = 0x0002;
pub const GPIO_ST_MAGIC: c_uint = 0x0040;
pub const GPIO_ST_HP: c_uint = 0x0080;

pub const GPIO_XENSE_SPEAKERS: c_uint = 0x0080;

pub const I2C_DEVICE_CS2000: c_uint = 0x9c			/* 100111, 0, /W=0 */;
pub const PCM1796_REG_BASE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xonar_pcm179x {
    pub generic: xonar_generic,
    pub dacs: c_uint,
    pub pcm1796_regs: [u8; 4][5],
    pub current_rate: c_uint,
    pub h6: bool,
    pub hp_active: bool,
...
#[no_mangle]
unsafe extern "C" fn cs2000_write(chip: *mut oxygen, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn cs2000_write_cached(chip: *mut oxygen, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn pcm1796_registers_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn pcm1796_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_d2_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_d2x_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_hdav_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_st_init_i2c(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_st_init_common(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn cs2000_registers_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_st_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_stx_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_xense_init(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_d2_cleanup(chip: *mut oxygen) {
    static void xonar_d2_cleanup(struct oxygen *chip)
    {
    xonar_disable_output(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_hdav_cleanup(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_st_cleanup(chip: *mut oxygen) {
    static void xonar_st_cleanup(struct oxygen *chip)
    {
    xonar_disable_output(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_d2_suspend(chip: *mut oxygen) {
    static void xonar_d2_suspend(struct oxygen *chip)
    {
    xonar_d2_cleanup(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_hdav_suspend(chip: *mut oxygen) {
    static void xonar_hdav_suspend(struct oxygen *chip)
    {
    xonar_hdav_cleanup(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_st_suspend(chip: *mut oxygen) {
    static void xonar_st_suspend(struct oxygen *chip)
    {
    xonar_st_cleanup(chip);
    }
#[no_mangle]
unsafe extern "C" fn xonar_d2_resume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_hdav_resume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_stx_resume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn xonar_st_resume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_pcm1796_oversampling(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_pcm1796_deemph(chip: *mut oxygen) {
    ...
    reg |= PCM1796_DMF_48;
#[no_mangle]
pub unsafe extern "C" fn if(44100: data->current_rate ==) -> else {
    else if (data.current_rate == 44100)
    reg |= PCM1796_DMF_441;
#[no_mangle]
pub unsafe extern "C" fn if(32000: data->current_rate ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn update_pcm1796_volume(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_pcm1796_mute(chip: *mut oxygen) {
...
#[no_mangle]
unsafe extern "C" fn update_cs2000_rate(chip: *mut oxygen, rate: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn if(GPIO_ST_HP_REAR: gpio &) -> else {
    ...
    value.value.enumerated.item[0] = 0;
#[no_mangle]
pub unsafe extern "C" fn if(2*-6: *mut data->hp_gain_offset <) -> else {
    else if (data.hp_gain_offset < 2*-6)
    value.value.enumerated.item[0] = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0: data->hp_gain_offset <) -> else {
    ...
    value.value.enumerated.item[0] = 0;
#[no_mangle]
pub unsafe extern "C" fn if(GPIO_ST_HP_REAR): !(gpio & GPIO_XENSE_SPEAKERS) && (gpio &) -> else {
...
#[no_mangle]
unsafe extern "C" fn xonar_d2_control_filter(template: *mut snd_kcontrol_new) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xonar_st_h6_control_filter(template: *mut snd_kcontrol_new) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_pcm1796_controls(chip: *mut oxygen) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xonar_d2_mixer_init(chip: *mut oxygen) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xonar_hdav_mixer_init(chip: *mut oxygen) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xonar_st_mixer_init(chip: *mut oxygen) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xonar_xense_mixer_init(chip: *mut oxygen) -> c_int {
