...
#[no_mangle]
pub unsafe extern "C" fn check_ptr_reg(emu: *mut snd_emu10k1, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_ptr_read(emu: *mut *mut snd_emu10k1, reg: c_uint, chn: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_ptr_write(emu: *mut snd_emu10k1, reg: c_uint, chn: c_uint, data: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_ptr_write_multiple(emu: *mut snd_emu10k1, chn: c_uint, ...) {
...
#[no_mangle]
unsafe extern "C" fn snd_emu1010_fpga_write_locked(emu: *mut snd_emu10k1, reg: u32, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu1010_fpga_read(emu: *mut snd_emu10k1, reg: u32, value: *mut u32) {
...
// so using this function often causes an IRQ as a side effect.
    let mut mask: u32 = emu.card_capabilities.ca0108_chip ? 0x1f : 0x7f;
    if (snd_BUG_ON(!mutex_is_locked(&emu.emu1010.lock)))
    return;
    if (snd_BUG_ON(reg > 0x3f))
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_emu1010_fpga_link_dst_src_write(emu: *mut snd_emu10k1, dst: u32, src: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu1010_fpga_link_dst_src_read(emu: *mut snd_emu10k1, dst: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu1010_get_raw_rate(emu: *mut snd_emu10k1, src: u8) -> c_int {
...
// Upload the netlist. Keep reset line high!
    ...
    let mut value: u8 = fw_entry.data[n];
    for (int i = 0; i < 8; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_intr_enable(emu: *mut snd_emu10k1, intrenb: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_intr_disable(emu: *mut snd_emu10k1, intrenb: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_intr_enable(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_intr_disable(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_intr_ack(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_half_loop_intr_enable(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_half_loop_intr_disable(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_half_loop_intr_ack(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_set_loop_stop(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_clear_loop_stop(emu: *mut snd_emu10k1, voicenum: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_set_loop_stop_multiple(emu: *mut snd_emu10k1, voices: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_clear_loop_stop_multiple(emu: *mut snd_emu10k1, voices: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_clear_loop_stop_multiple_atomic(emu: *mut snd_emu10k1, voices: u64) -> c_int {
    ...
    let mut quart: u32 = 1U << (REG_SIZE(WC_CURRENTCHANNEL) - 2);
// First we wait for the third quarter of the sample cycle ...
    let mut wc: u32 = inl(emu.port + WC);
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_wait(emu: *mut snd_emu10k1, wait: c_uint) {
    void snd_emu10k1_wait(struct snd_emu10k1 *emu, unsigned int wait)
    {
    volatile unsigned count;
    let mut newtime: c_uint = 0, curtime;
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_ac97_read(ac97: *mut snd_ac97, reg: c_ushort) -> c_ushort {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_ac97_write(ac97: *mut snd_ac97, reg: c_ushort, data: c_ushort) {
