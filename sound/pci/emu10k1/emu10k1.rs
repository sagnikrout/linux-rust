...
//! Source: sound/pci/emu10k1/emu10k1.c
#![no_std]
...
// Macro flag: #define ENABLE_SYNTH
    ...
    module_param_array(extin, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(extin, "Available external inputs for FX8010. Zero=default.");
    module_param_array(extout, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(extout, "Available external outputs for FX8010. Zero=default.");
    module_param_array(seq_ports, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(seq_ports, "Allocated sequencer ports for internal synthesizer.");
    module_param_array(max_synth_voices, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(max_synth_voices, "Maximum number of voices for WaveTable.");
    module_param_array(max_buffer_size, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(max_buffer_size, "Maximum sample buffer size in MB.");
    module_param_array(enable_ir, bool, core::ptr::null_mut(), 0444);
...
//
    ...
    struct snd_seq_device *wave = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(1024: max_buffer_size[dev] >) -> else {
