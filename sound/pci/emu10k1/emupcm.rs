...
//! Source: sound/pci/emu10k1/emupcm.c
#![no_std]
...
unsafe extern "C" fn snd_emu10k1_pcm_free_voices(epcm: *mut snd_emu10k1_pcm) {
    ...
    if (err < 0)
    return err;
    if (epcm.extra == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_capture_rate_reg(rate: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_audigy_capture_rate_reg(rate: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn emu10k1_calc_pitch_target(rate: c_uint) -> c_uint {
...
pub const PITCH_48000: c_uint = 0x00004000;
pub const PITCH_96000: c_uint = 0x00008000;
pub const PITCH_85000: c_uint = 0x00007155;
pub const PITCH_80726: c_uint = 0x00006ba2;
pub const PITCH_67882: c_uint = 0x00005a82;
pub const PITCH_57081: c_uint = 0x00004c1c;
#[no_mangle]
unsafe extern "C" fn emu10k1_select_interprom(pitch_target: c_uint) -> c_uint {
    static unsigned int emu10k1_select_interprom(unsigned int pitch_target)
    {
    if (pitch_target == PITCH_48000)
    return CCCA_INTERPROM_0;
#[no_mangle]
pub unsafe extern "C" fn if(PITCH_48000: pitch_target <) -> else {
    else if (pitch_target < PITCH_48000)
    return CCCA_INTERPROM_1;
#[no_mangle]
pub unsafe extern "C" fn if(PITCH_96000: pitch_target >=) -> else {
    else if (pitch_target >= PITCH_96000)
    return CCCA_INTERPROM_0;
#[no_mangle]
pub unsafe extern "C" fn if(PITCH_85000: pitch_target >=) -> else {
    else if (pitch_target >= PITCH_85000)
    return CCCA_INTERPROM_6;
#[no_mangle]
pub unsafe extern "C" fn if(PITCH_80726: pitch_target >=) -> else {
    else if (pitch_target >= PITCH_80726)
    return CCCA_INTERPROM_5;
#[no_mangle]
pub unsafe extern "C" fn if(PITCH_67882: pitch_target >=) -> else {
    else if (pitch_target >= PITCH_67882)
    return CCCA_INTERPROM_4;
#[no_mangle]
pub unsafe extern "C" fn if(PITCH_57081: pitch_target >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn emu10k1_send_target_from_amount(amount: u8) -> u16 {
...
// Setup routing
    ...
    REGLIST_END);
    for (int i = 0; i < 4; i++) {
    let mut aml: u32 = emu10k1_send_target_from_amount(send_amount[2 * i]);
    let mut amh: u32 = emu10k1_send_target_from_amount(send_amount[2 * i + 1]);
    ...
    if (err > 0) {	/* change */
    int mapped;
    if (epcm.memblk != core::ptr::null_mut())
...
unsafe extern "C" fn snd_emu10k1_playback_hw_free(substream: *mut snd_pcm_substream) -> c_int {
    ...
    epcm.extra = core::ptr::null_mut();
    }
    snd_emu10k1_pcm_free_voices(epcm);
    if (epcm.memblk) {
    snd_emu10k1_free_pages(emu, epcm.memblk);
    epcm.memblk = core::ptr::null_mut();
    epcm.start_addr = 0;
    }
...
unsafe extern "C" fn snd_emu10k1_playback_prepare(substream: *mut snd_pcm_substream) -> c_int {
    ...
    struct snd_pcm_runtime *runtime = substream.runtime;
    struct snd_emu10k1_pcm *epcm = runtime.private_data;
    let mut w_16: bool = snd_pcm_format_width(runtime.format) == 16;
    let mut stereo: bool = runtime.channels == 2;
...
// The lower voices are occupied by A_EXTOUT_*_CAP*.
    ...
    let mut rate: unsigned = runtime.rate;
...
// The engine goes haywire if CCR_READADDRESS is out of sync
    ...
    struct snd_pcm_runtime *runtime = substream.runtime;
    let mut eloop_start: unsigned = epcm.start_addr >> w_16;
    let mut loop_start: unsigned = eloop_start >> stereo;
    let mut eloop_size: unsigned = runtime.period_size;
    let mut loop_size: unsigned = runtime.buffer_size;
    let mut sample: u32 = w_16 ? 0 : 0x80808080;
...
// - The interpolator is centered around the 4th frame
    ...
    let mut voice: unsigned = epcm.voices[i].number;
...
// but the unmuting takes long enough for that.
    ...
    {
    let mut ptrx: u32 = snd_emu10k1_ptr_read(emu, PTRX, voice);
    let mut cpf: u32 = snd_emu10k1_ptr_read(emu, CPF, voice);
    snd_emu10k1_ptr_write_multiple(emu, voice,
...
//
    ...
    let mut mask: u64 = 0;
    for (int i = 0; i < channels; i++) {
    let mut voice: c_int = epcm.voices[i].number;
    mask |= 1ULL << voice;
    }
    return mask;
    }
...
//
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_pcm_mixer_notify1(emu: *mut snd_emu10k1, kctl: *mut snd_kcontrol, idx: c_int, activate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_pcm_mixer_notify(emu: *mut snd_emu10k1, idx: c_int, activate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_pcm_efx_mixer_notify(emu: *mut snd_emu10k1, idx: c_int, activate: c_int) {
...
unsafe extern "C" fn snd_emu10k1_efx_playback_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    mix.epcm = core::ptr::null_mut();
    snd_emu10k1_pcm_efx_mixer_notify(emu, i, 0);
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_playback_set_constraints(runtime: *mut snd_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_efx_playback_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_playback_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_capture_open(substream: *mut snd_pcm_substream) -> c_int {
...
unsafe extern "C" fn snd_emu10k1_capture_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    {
    struct snd_emu10k1 *emu = snd_pcm_substream_chip(substream);
    emu.capture_interrupt = core::ptr::null_mut();
    emu.pcm_capture_substream = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_capture_mic_open(substream: *mut snd_pcm_substream) -> c_int {
...
unsafe extern "C" fn snd_emu10k1_capture_mic_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    {
    struct snd_emu10k1 *emu = snd_pcm_substream_chip(substream);
    emu.capture_mic_interrupt = core::ptr::null_mut();
    emu.pcm_capture_mic_substream = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_capture_efx_open(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_emu10k1_capture_efx_open(struct snd_pcm_substream *substream)
    {
    struct snd_emu10k1 *emu = snd_pcm_substream_chip(substream);
    struct snd_emu10k1_pcm *epcm;
    struct snd_pcm_runtime *runtime = substream.runtime;
    let mut nefx: c_int = emu.audigy ? 64 : 32;
    int idx, err;
    epcm = kzalloc_obj(*epcm);
    if (epcm == core::ptr::null_mut())
    return -ENOMEM;
...
unsafe extern "C" fn snd_emu10k1_capture_efx_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    {
    struct snd_emu10k1 *emu = snd_pcm_substream_chip(substream);
    emu.capture_efx_interrupt = core::ptr::null_mut();
    emu.pcm_capture_efx_substream = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_pcm_efx_voices_mask_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_pcm_efx_voices_mask_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_pcm_efx_voices_mask_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
// EFX playback
pub const INITIAL_TRAM_SHIFT: c_int = 14;
...
// dst_left-- = *src++;
    ...
    let mut tram_size: c_uint = pcm.buffer_size;
    unsigned short *src = (unsigned short *)(substream.runtime.dma_area + rec.sw_data);
    let mut frames: c_uint = bytes >> 2, count;
    let mut tram_pos: c_uint = pcm.tram_pos;
    let mut tram_shift: c_uint = pcm.tram_shift;
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_fx8010_playback_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_fx8010_playback_close(substream: *mut snd_pcm_substream) -> c_int {
