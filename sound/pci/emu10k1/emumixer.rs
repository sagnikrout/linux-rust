...
//! Source: sound/pci/emu10k1/emumixer.c
#![no_std]
...
pub const AC97_ID_STAC9758: c_uint = 0x83847658;
    ...
    {
    let mut kctl: snd_kcontrol_new = *tpl;
    int err;
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_spdif_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_emu1010_routing_info {
    pub src_texts: *const *const c_char,
    pub out_texts: *const *const c_char,
    pub src_regs: *const c_ushort,
    pub out_regs: *const c_ushort,
    pub in_regs: *const c_ushort,
    pub out_dflts: *const c_ushort,
    pub in_dflts: *const c_ushort,
    pub n_srcs: unsigned,
    pub n_outs: unsigned,
    pub n_ins: unsigned,
}
...
#[no_mangle]
unsafe extern "C" fn emu1010_idx(emu: *mut snd_emu10k1) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn snd_emu1010_apply_sources(emu: *mut snd_emu10k1) {
    ...
    const struct snd_emu1010_routing_info *emu_ri =
    &emu1010_routing_info[emu1010_idx(emu)];
    let mut channel: unsigned = kcontrol.private_value;
    ...
    const struct snd_emu1010_routing_info *emu_ri =
    &emu1010_routing_info[emu1010_idx(emu)];
    let mut val: unsigned = ucontrol.value.enumerated.item[0];
    let mut channel: unsigned = kcontrol.private_value;
    int change;
...
#[no_mangle]
unsafe extern "C" fn add_emu1010_source_mixers(emu: *mut snd_emu10k1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu1010_adc_pads_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int snd_emu1010_adc_pads_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct snd_emu10k1 *emu = snd_kcontrol_chip(kcontrol);
    let mut mask: c_uint = snd_emu1010_adc_pad_regs[kcontrol.private_value];
    ucontrol.value.integer.value[0] = (emu.emu1010.adc_pads & mask) ? 1 : 0;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_emu1010_adc_pads_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu1010_dac_pads_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int snd_emu1010_dac_pads_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct snd_emu10k1 *emu = snd_kcontrol_chip(kcontrol);
    let mut mask: c_uint = snd_emu1010_dac_regs[kcontrol.private_value];
    ucontrol.value.integer.value[0] = (emu.emu1010.dac_pads & mask) ? 1 : 0;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_emu1010_dac_pads_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_emu1010_pads_info {
    pub dac_ctls: *const *const *const *const char  adc_ctls,,
    pub n_dac_ctls: unsigned n_adc_ctls,,
}
...
// 1616(m) cardbus
    ...
    {
// 0404
    .adc_ctls = core::ptr::null_mut(),
    .n_adc_ctls = 0,
    .dac_ctls = core::ptr::null_mut(),
    .n_dac_ctls = 0,
    },
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_emu1010_clock_info {
...
// 0404
    ...
    {
    struct snd_emu10k1 *emu = snd_kcontrol_chip(kcontrol);
    let mut val: c_uint = ucontrol.value.enumerated.item[0];
    int change;
    if (val >= 2)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn snd_audigy_spdif_output_rate_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_emu10k1_fxrt(emu: *mut snd_emu10k1, voice: c_int, route: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn update_emu10k1_send_volume(emu: *mut snd_emu10k1, voice: c_int, volume: *mut c_uchar) {
...
// PCM stream controls
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_send_routing_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
    ...
    int voice, idx;
    let mut num_efx: c_int = emu.audigy ? 8 : 4;
    let mut mask: c_int = emu.audigy ? 0x3f : 0x0f;
    ...
    struct snd_emu10k1_pcm_mixer *mix =
    &emu.pcm_mixer[snd_ctl_get_ioffidx(kcontrol, &ucontrol.id)];
    let mut change: c_int = 0, voice, idx, val;
    let mut num_efx: c_int = emu.audigy ? 8 : 4;
    let mut mask: c_int = emu.audigy ? 0x3f : 0x0f;
    guard(spinlock_irq)(&emu.reg_lock);
    for (voice = 0; voice < 3; voice++)
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_send_volume_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
    ...
    struct snd_emu10k1_pcm_mixer *mix =
    &emu.pcm_mixer[snd_ctl_get_ioffidx(kcontrol, &ucontrol.id)];
    let mut change: c_int = 0, idx, val;
    let mut num_efx: c_int = emu.audigy ? 8 : 4;
    guard(spinlock_irq)(&emu.reg_lock);
    for (idx = 0; idx < 3*num_efx; idx++) {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_attn_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
    ...
    guard(spinlock_irq)(&emu.reg_lock);
    for (idx = 0; idx < 3; idx++) {
    let mut uval: unsigned = ucontrol.value.integer.value[idx] & 0x1ffff;
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_efx_send_routing_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
    ...
    {
    struct snd_emu10k1 *emu = snd_kcontrol_chip(kcontrol);
    let mut ch: c_int = snd_ctl_get_ioffidx(kcontrol, &ucontrol.id);
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_efx_send_volume_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_efx_attn_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_mixer_free_ac97(ac97: *mut snd_ac97) {
    static void snd_emu10k1_mixer_free_ac97(struct snd_ac97 *ac97)
    {
    struct snd_emu10k1 *emu = ac97.private_data;
    emu.ac97 = core::ptr::null_mut();
    }
//
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn rename_ctl(card: *mut snd_card, src: *const c_char, dst: *const c_char) -> c_int {
...
// the Philips ADC for 24bit capture
    ...
    err = snd_ac97_bus(emu.card, 0, &ops, core::ptr::null_mut(), &pbus);
    if (err < 0)
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: emu->audigy) -> else {
    else if (emu.audigy)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: emu->card_capabilities->i2c_adc) -> else {
    else if (emu.card_capabilities.i2c_adc)
