...
//! Source: sound/pci/emu10k1/emu10k1_main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_voice_init(emu: *mut snd_emu10k1, ch: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_init(emu: *mut snd_emu10k1, enable_ir: c_int) -> c_int {
...
// With on-chip joystick
    ...
    let mut reg: u16 = inw(emu.port + A_IOCFG);
    ...
    let mut reg: c_uint = inl(emu.port + HCFG);
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_audio_enable(emu: *mut snd_emu10k1) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_done(emu: *mut snd_emu10k1) -> c_int {
...
pub const EC_NUM_CONTROL_BITS: c_int = 20;
pub const EC_AC3_DATA_SELN: c_uint = 0x0001L;
pub const EC_EE_DATA_SEL: c_uint = 0x0002L;
pub const EC_EE_CNTRL_SELN: c_uint = 0x0004L;
pub const EC_EECLK: c_uint = 0x0008L;
pub const EC_EECS: c_uint = 0x0010L;
pub const EC_EESDO: c_uint = 0x0020L;
pub const EC_TRIM_CSN: c_uint = 0x0040L;
pub const EC_TRIM_SCLK: c_uint = 0x0080L;
pub const EC_TRIM_SDATA: c_uint = 0x0100L;
pub const EC_TRIM_MUTEN: c_uint = 0x0200L;
pub const EC_ADCCAL: c_uint = 0x0400L;
pub const EC_ADCRSTN: c_uint = 0x0800L;
pub const EC_DACCAL: c_uint = 0x1000L;
pub const EC_DACMUTEN: c_uint = 0x2000L;
pub const EC_LEDN: c_uint = 0x4000L;
pub const EC_SPDIF0_SEL_SHIFT: c_int = 15;
pub const EC_SPDIF1_SEL_SHIFT: c_int = 17;

pub const EC_CURRENT_PROM_VERSION: c_uint = 0x01	/* Self-explanatory.  This should;
// be incremented any time the EEPROM's
// format is changed.
pub const EC_EEPROM_SIZE: c_uint = 0x40	/* ECARD EEPROM has 64 16-bit words */;
// Addresses for special values stored in to EEPROM
pub const EC_PROM_VERSION_ADDR: c_uint = 0x20	/* Address of the current prom version */;
pub const EC_BOARDREV0_ADDR: c_uint = 0x21	/* LSW of board rev */;
pub const EC_BOARDREV1_ADDR: c_uint = 0x22	/* MSW of board rev */;
pub const EC_LAST_PROMFILE_ADDR: c_uint = 0x2f;
pub const EC_SERIALNUM_ADDR: c_uint = 0x30	/* First word of serial number.  The;
// can be up to 30 characters in length
// and is stored as a NULL-terminated
// ASCII string.  Any unused bytes must be
// filled with zeros
pub const EC_CHECKSUM_ADDR: c_uint = 0x3f	/* Location at which checksum is stored */;
...
//
    ...
    EC_TRIM_CSN)
pub const EC_DEFAULT_ADC_GAIN: c_uint = 0xC4C4;
pub const EC_DEFAULT_SPDIF0_SEL: c_uint = 0x0;
pub const EC_DEFAULT_SPDIF1_SEL: c_uint = 0x4;
//
...
//
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_ecard_write(emu: *mut snd_emu10k1, value: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_ecard_init(emu: *mut snd_emu10k1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_cardbus_init(emu: *mut snd_emu10k1) -> c_int {
...
// firmware file names, per model, init-fw and dock-fw (optional)
    ...
    [EMU_MODEL_EMU0404] = {
    EMU0404_FILENAME, core::ptr::null_mut()
    },
    };
...
#[no_mangle]
unsafe extern "C" fn snd_emu1010_load_dock_firmware(emu: *mut snd_emu10k1) {
...
#[no_mangle]
unsafe extern "C" fn emu1010_dock_event(emu: *mut snd_emu10k1) {
...
#[no_mangle]
unsafe extern "C" fn emu1010_clock_event(emu: *mut snd_emu10k1) {
...
#[no_mangle]
unsafe extern "C" fn emu1010_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn emu1010_interrupt(emu: *mut snd_emu10k1) {
...
// care only about the ones triggered by the dedicated pin.
    let mut sts: u16 = inw(emu.port + A_GPIO);
    let mut bit: u16 = emu.card_capabilities.ca0108_chip ? 0x2000 : 0x8000;
    if (!(sts & bit))
    return;
...
//
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_emu1010_init(emu: *mut snd_emu10k1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_free(card: *mut snd_card) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_emu10k1_detect_iommu(emu: *mut snd_emu10k1) {
...
// enable PCI device
    ...
    emu.pci = pci;
    emu.irq = -1;
    emu.synth = core::ptr::null_mut();
    emu.get_synth_voice = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: subsystem) -> else {
    else if (subsystem)
    dev_dbg(card.dev, "Sound card name = %s, "
...
#[no_mangle]
unsafe extern "C" fn alloc_pm_buffer(emu: *mut snd_emu10k1) -> c_int {
    static int alloc_pm_buffer(struct snd_emu10k1 *emu)
    {
    int size;
...
#[no_mangle]
unsafe extern "C" fn free_pm_buffer(emu: *mut snd_emu10k1) {
    static void free_pm_buffer(struct snd_emu10k1 *emu)
    {
    vfree(emu.saved_ptr);
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_suspend_regs(emu: *mut snd_emu10k1) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_resume_init(emu: *mut snd_emu10k1) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: emu->card_capabilities->emu_model) -> else {
    else if (emu.card_capabilities.emu_model)
...
#[no_mangle]
pub unsafe extern "C" fn snd_emu10k1_resume_regs(emu: *mut snd_emu10k1) {
