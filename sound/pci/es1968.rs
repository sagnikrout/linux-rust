...
pub const SUPPORT_JOYSTICK: c_int = 1;
    ...
    module_param_array(total_bufsize, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(total_bufsize, "Total buffer size in kB.");
    module_param_array(pcm_substreams_p, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(pcm_substreams_p, "PCM Playback substreams for " CARD_NAME " soundcard.");
    module_param_array(pcm_substreams_c, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(pcm_substreams_c, "PCM Capture substreams for " CARD_NAME " soundcard.");
    module_param_array(clock, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(clock, "Clock on " CARD_NAME " soundcard.  (0 = auto-detect)");
    module_param_array(use_pm, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(use_pm, "Toggle power-management.  (0 = off, 1 = on, 2 = auto)");
    module_param_array(enable_mpu, int, core::ptr::null_mut(), 0444);
...
pub const NR_APUS: c_int = 64;
pub const NR_APU_REGS: c_int = 16;
// NEC Versas ?
pub const NEC_VERSA_SUBID1: c_uint = 0x80581033;
pub const NEC_VERSA_SUBID2: c_uint = 0x803c1033;
// Mode Flags
pub const ESS_FMT_STEREO: c_uint = 0x01;
pub const ESS_FMT_16BIT: c_uint = 0x02;
pub const DAC_RUNNING: c_int = 1;
pub const ADC_RUNNING: c_int = 2;
// Values for the ESM_LEGACY_AUDIO_CONTROL
pub const ESS_DISABLE_AUDIO: c_uint = 0x8000;
pub const ESS_ENABLE_SERIAL_IRQ: c_uint = 0x4000;
pub const IO_ADRESS_ALIAS: c_uint = 0x0020;
pub const MPU401_IRQ_ENABLE: c_uint = 0x0010;
pub const MPU401_IO_ENABLE: c_uint = 0x0008;
pub const GAME_IO_ENABLE: c_uint = 0x0004;
pub const FM_IO_ENABLE: c_uint = 0x0002;
pub const SB_IO_ENABLE: c_uint = 0x0001;
// Values for the ESM_CONFIG_A
pub const PIC_SNOOP1: c_uint = 0x4000;
pub const PIC_SNOOP2: c_uint = 0x2000;
pub const SAFEGUARD: c_uint = 0x0800;
pub const DMA_CLEAR: c_uint = 0x0700;
pub const DMA_DDMA: c_uint = 0x0000;
pub const DMA_TDMA: c_uint = 0x0100;
pub const DMA_PCPCI: c_uint = 0x0200;
pub const POST_WRITE: c_uint = 0x0080;
pub const PCI_TIMING: c_uint = 0x0040;
pub const SWAP_LR: c_uint = 0x0020;
pub const SUBTR_DECODE: c_uint = 0x0002;
// Values for the ESM_CONFIG_B
pub const SPDIF_CONFB: c_uint = 0x0100;
pub const HWV_CONFB: c_uint = 0x0080;
pub const DEBOUNCE: c_uint = 0x0040;
pub const GPIO_CONFB: c_uint = 0x0020;
pub const CHI_CONFB: c_uint = 0x0010;
pub const IDMA_CONFB: c_uint = 0x0008	/*undoc */;
pub const MIDI_FIX: c_uint = 0x0004	/*undoc */;
pub const IRQ_TO_ISA: c_uint = 0x0001	/*undoc */;
// Values for Ring Bus Control B
pub const RINGB_2CODEC_ID_MASK: c_uint = 0x0003;
pub const RINGB_DIS_VALIDATION: c_uint = 0x0008;
pub const RINGB_EN_SPDIF: c_uint = 0x0010;
pub const RINGB_EN_2CODEC: c_uint = 0x0020;
pub const RINGB_SING_BIT_DUAL: c_uint = 0x0040;
// ****Port Addresses****
// Write & Read
pub const ESM_INDEX: c_uint = 0x02;
pub const ESM_DATA: c_uint = 0x00;
// AC97 + RingBus
pub const ESM_AC97_INDEX: c_uint = 0x30;
pub const ESM_AC97_DATA: c_uint = 0x32;
pub const ESM_RING_BUS_DEST: c_uint = 0x34;
pub const ESM_RING_BUS_CONTR_A: c_uint = 0x36;
pub const ESM_RING_BUS_CONTR_B: c_uint = 0x38;
pub const ESM_RING_BUS_SDO: c_uint = 0x3A;
// WaveCache
pub const WC_INDEX: c_uint = 0x10;
pub const WC_DATA: c_uint = 0x12;
pub const WC_CONTROL: c_uint = 0x14;
// ASSP
pub const ASSP_INDEX: c_uint = 0x80;
pub const ASSP_MEMORY: c_uint = 0x82;
pub const ASSP_DATA: c_uint = 0x84;
pub const ASSP_CONTROL_A: c_uint = 0xA2;
pub const ASSP_CONTROL_B: c_uint = 0xA4;
pub const ASSP_CONTROL_C: c_uint = 0xA6;
pub const ASSP_HOSTW_INDEX: c_uint = 0xA8;
pub const ASSP_HOSTW_DATA: c_uint = 0xAA;
pub const ASSP_HOSTW_IRQ: c_uint = 0xAC;
// Midi
pub const ESM_MPU401_PORT: c_uint = 0x98;
// Others
pub const ESM_PORT_HOST_IRQ: c_uint = 0x18;
pub const IDR0_DATA_PORT: c_uint = 0x00;
pub const IDR1_CRAM_POINTER: c_uint = 0x01;
pub const IDR2_CRAM_DATA: c_uint = 0x02;
pub const IDR3_WAVE_DATA: c_uint = 0x03;
pub const IDR4_WAVE_PTR_LOW: c_uint = 0x04;
pub const IDR5_WAVE_PTR_HI: c_uint = 0x05;
pub const IDR6_TIMER_CTRL: c_uint = 0x06;
pub const IDR7_WAVE_ROMRAM: c_uint = 0x07;
pub const WRITEABLE_MAP: c_uint = 0xEFFFFF;
pub const READABLE_MAP: c_uint = 0x64003F;
// PCI Register
pub const ESM_LEGACY_AUDIO_CONTROL: c_uint = 0x40;
pub const ESM_ACPI_COMMAND: c_uint = 0x54;
pub const ESM_CONFIG_A: c_uint = 0x50;
pub const ESM_CONFIG_B: c_uint = 0x52;
pub const ESM_DDMA: c_uint = 0x60;
// Bob Bits
pub const ESM_BOB_ENABLE: c_uint = 0x0001;
pub const ESM_BOB_START: c_uint = 0x0001;
// Host IRQ Control Bits
pub const ESM_RESET_MAESTRO: c_uint = 0x8000;
pub const ESM_RESET_DIRECTSOUND: c_uint = 0x4000;
pub const ESM_HIRQ_ClkRun: c_uint = 0x0100;
pub const ESM_HIRQ_HW_VOLUME: c_uint = 0x0040;
pub const ESM_HIRQ_HARPO: c_uint = 0x0030	/* What's that? */;
pub const ESM_HIRQ_ASSP: c_uint = 0x0010;
pub const ESM_HIRQ_DSIE: c_uint = 0x0004;
pub const ESM_HIRQ_MPU401: c_uint = 0x0002;
pub const ESM_HIRQ_SB: c_uint = 0x0001;
// Host IRQ Status Bits
pub const ESM_MPU401_IRQ: c_uint = 0x02;
pub const ESM_SB_IRQ: c_uint = 0x01;
pub const ESM_SOUND_IRQ: c_uint = 0x04;
pub const ESM_ASSP_IRQ: c_uint = 0x10;
pub const ESM_HWVOL_IRQ: c_uint = 0x40;
pub const ESS_SYSCLK: c_int = 50000000;
pub const ESM_BOB_FREQ: c_int = 200;
pub const ESM_BOB_FREQ_MAX: c_int = 800;

// APU Modes: reg 0x00, bit 4-7
pub const ESM_APU_MODE_SHIFT: c_int = 4;

pub const ESM_APU_OFF: c_uint = 0x00;
pub const ESM_APU_16BITLINEAR: c_uint = 0x01	/* 16-Bit Linear Sample Player */;
pub const ESM_APU_16BITSTEREO: c_uint = 0x02	/* 16-Bit Stereo Sample Player */;
pub const ESM_APU_8BITLINEAR: c_uint = 0x03	/* 8-Bit Linear Sample Player */;
pub const ESM_APU_8BITSTEREO: c_uint = 0x04	/* 8-Bit Stereo Sample Player */;
pub const ESM_APU_8BITDIFF: c_uint = 0x05	/* 8-Bit Differential Sample Playrer */;
pub const ESM_APU_DIGITALDELAY: c_uint = 0x06	/* Digital Delay Line */;
pub const ESM_APU_DUALTAP: c_uint = 0x07	/* Dual Tap Reader */;
pub const ESM_APU_CORRELATOR: c_uint = 0x08	/* Correlator */;
pub const ESM_APU_INPUTMIXER: c_uint = 0x09	/* Input Mixer */;
pub const ESM_APU_WAVETABLE: c_uint = 0x0A	/* Wave Table Mode */;
pub const ESM_APU_SRCONVERTOR: c_uint = 0x0B	/* Sample Rate Convertor */;
pub const ESM_APU_16BITPINGPONG: c_uint = 0x0C	/* 16-Bit Ping-Pong Sample Player */;
pub const ESM_APU_RESERVED1: c_uint = 0x0D	/* Reserved 1 */;
pub const ESM_APU_RESERVED2: c_uint = 0x0E	/* Reserved 2 */;
pub const ESM_APU_RESERVED3: c_uint = 0x0F	/* Reserved 3 */;
// reg 0x00
pub const ESM_APU_FILTER_Q_SHIFT: c_int = 0;

// APU Filtey Q Control
pub const ESM_APU_FILTER_LESSQ: c_uint = 0x00;
pub const ESM_APU_FILTER_MOREQ: c_uint = 0x03;
pub const ESM_APU_FILTER_TYPE_SHIFT: c_int = 2;

pub const ESM_APU_ENV_TYPE_SHIFT: c_int = 8;

pub const ESM_APU_ENV_STATE_SHIFT: c_int = 10;

// reg 0x02
pub const ESM_APU_SUBMIX_GROUP_SHIRT: c_int = 0;

pub const ESM_APU_EFFECT_CHANNELS_SHIFT: c_int = 6;

// reg 0x03
pub const ESM_APU_STEP_SIZE_MASK: c_uint = 0x0fff;
// reg 0x04
pub const ESM_APU_PHASE_SHIFT: c_int = 0;

// reg 0x05 - wave start offset
// reg 0x06 - wave end offset
// reg 0x07 - wave loop length
// reg 0x08
pub const ESM_APU_EFFECT_GAIN_SHIFT: c_int = 0;

pub const ESM_APU_TREMOLO_DEPTH_SHIFT: c_int = 8;

pub const ESM_APU_TREMOLO_RATE_SHIFT: c_int = 12;

// reg 0x09
// bit 0-7 amplitude dest?
pub const ESM_APU_AMPLITUDE_NOW_SHIFT: c_int = 8;

// reg 0x0a
pub const ESM_APU_POLAR_PAN_SHIFT: c_int = 0;

// Polar Pan Control
pub const ESM_APU_PAN_CENTER_CIRCLE: c_uint = 0x00;
pub const ESM_APU_PAN_MIDDLE_RADIUS: c_uint = 0x01;
pub const ESM_APU_PAN_OUTSIDE_RADIUS: c_uint = 0x02;
pub const ESM_APU_FILTER_TUNING_SHIFT: c_int = 8;

// reg 0x0b
pub const ESM_APU_DATA_SRC_A_SHIFT: c_int = 0;

pub const ESM_APU_DATA_SRC_B_SHIFT: c_int = 8;

pub const ESM_APU_VIBRATO_RATE_SHIFT: c_int = 0;

pub const ESM_APU_VIBRATO_DEPTH_SHIFT: c_int = 4;

pub const ESM_APU_VIBRATO_PHASE_SHIFT: c_int = 8;

// reg 0x0c

// APU Filter Control
pub const ESM_APU_FILTER_2POLE_LOPASS: c_uint = 0x00;
pub const ESM_APU_FILTER_2POLE_BANDPASS: c_uint = 0x01;
pub const ESM_APU_FILTER_2POLE_HIPASS: c_uint = 0x02;
pub const ESM_APU_FILTER_1POLE_LOPASS: c_uint = 0x03;
pub const ESM_APU_FILTER_1POLE_HIPASS: c_uint = 0x04;
pub const ESM_APU_FILTER_OFF: c_uint = 0x05;
// APU ATFP Type
pub const ESM_APU_ATFP_AMPLITUDE: c_uint = 0x00;
pub const ESM_APU_ATFP_TREMELO: c_uint = 0x01;
pub const ESM_APU_ATFP_FILTER: c_uint = 0x02;
pub const ESM_APU_ATFP_PAN: c_uint = 0x03;
// APU ATFP Flags
pub const ESM_APU_ATFP_FLG_OFF: c_uint = 0x00;
pub const ESM_APU_ATFP_FLG_WAIT: c_uint = 0x01;
pub const ESM_APU_ATFP_FLG_DONE: c_uint = 0x02;
pub const ESM_APU_ATFP_FLG_INPROCESS: c_uint = 0x03;
// capture mixing buffer size
pub const ESM_MEM_ALIGN: c_uint = 0x1000;
pub const ESM_MIXBUF_SIZE: c_uint = 0x400;
pub const ESM_MODE_PLAY: c_int = 0;
pub const ESM_MODE_CAPTURE: c_int = 1;
...
pub struct esm_memory {
    pub buf: snd_dma_buffer,
    pub /: *mut *mut int empty; / status,
    pub list: list_head,
}
...
// playback/capture pcm buffer
    pub memory: *mut esm_memory,
// capture mixer buffer
    pub mixbuf: *mut esm_memory,
    pub /: *mut *mut unsigned int hwptr; / current hw pointer in bytes,
    pub /: *mut *mut unsigned int count; / sample counter in bytes,
    pub /: *mut *mut unsigned int dma_size; / total buffer size in bytes,
    pub /: *mut *mut unsigned int frag_size; / period size in bytes,
    pub wav_shift: c_uint,
    pub /: *mut *mut u16 base[4]; / offset for ptr,
// stereo/16bit flag
    pub fmt: c_uchar,
    pub /: *mut *mut int mode; / playback / capture,
    pub /: *mut *mut int bob_freq; / required timer frequency,
...
pub struct es1968 {
// Module Config
    pub /: *mut *mut int total_bufsize; / in bytes,
    pub capture_streams: int playback_streams,,
    pub /: *mut *mut unsigned int clock; / clock,
// for clock measurement
    pub 1: unsigned int in_measurement:,
    pub measure_apu: c_uint,
    pub measure_lastpos: c_uint,
    pub measure_count: c_uint,
// buffer
    pub dma: snd_dma_buffer,
// Resources...
    pub irq: c_int,
    pub io_port: c_ulong,
    pub type: c_int,
    ...
    pub pcm: *mut snd_pcm,
    pub /: *mut *mut int do_pm; / power-management enabled,
// DMA memory block
...
// Maestro Stuff
    pub maestro_map: [u16; 32],
    pub /: *mut *mut int bobclient; / active timer instancs,
    pub /: *mut *mut int bob_freq; / timer frequency,
    pub /: *mut *mut mutex memory_mutex; / memory lock,
// APU states
    pub apu: [c_uchar; NR_APUS],
// active substreams
    pub substream_list: list_head,
    pub substream_lock: spinlock_t,
    pub apu_map: [u16; NR_APUS][NR_APU_REGS],
    pub gameport: *mut gameport,

    pub input_dev: *mut input_dev,
    pub /: *mut *mut char phys[64]; / physical device path,

    pub /: *mut *mut *mut snd_kcontrol master_switch; / for h/w volume control,
...
// no spinlock
#[no_mangle]
unsafe extern "C" fn __maestro_write(chip: *mut es1968, reg: u16, data: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn maestro_write(chip: *mut es1968, reg: u16, data: u16) {
...
// no spinlock
#[no_mangle]
unsafe extern "C" fn __maestro_read(chip: *mut es1968, reg: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn maestro_read(chip: *mut es1968, reg: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_ac97_wait(chip: *mut es1968) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_ac97_wait_poll(chip: *mut es1968) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_ac97_write(ac97: *mut snd_ac97, reg: c_ushort, val: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_ac97_read(ac97: *mut snd_ac97, reg: c_ushort) -> c_ushort {
...
// no spinlock
#[no_mangle]
unsafe extern "C" fn apu_index_set(chip: *mut es1968, index: u16) {
...
// no spinlock
#[no_mangle]
unsafe extern "C" fn apu_data_set(chip: *mut es1968, data: u16) {
...
// no spinlock
#[no_mangle]
unsafe extern "C" fn __apu_set_register(chip: *mut es1968, channel: u16, reg: u8, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn apu_set_register(chip: *mut es1968, channel: u16, reg: u8, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn __apu_get_register(chip: *mut es1968, channel: u16, reg: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn apu_get_register(chip: *mut es1968, channel: u16, reg: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn assp_set_register(chip: *mut es1968, reg: u32, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn assp_get_register(chip: *mut es1968, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn wave_set_register(chip: *mut es1968, reg: u16, value: u16) {
...
#[no_mangle]
unsafe extern "C" fn wave_get_register(chip: *mut es1968, reg: u16) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn snd_es1968_bob_stop(chip: *mut es1968) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_bob_start(chip: *mut es1968) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_bob_inc(chip: *mut es1968, freq: c_int) {
...
// call with substream spinlock
#[no_mangle]
unsafe extern "C" fn snd_es1968_bob_dec(chip: *mut es1968) {
    ...
    snd_es1968_bob_stop(chip);
#[no_mangle]
pub unsafe extern "C" fn if(ESM_BOB_FREQ: chip->bob_freq >) -> else {
// check reduction of timer frequency
    let mut max_freq: c_int = ESM_BOB_FREQ;
    struct esschan *es;
...
// we acquire 4 interrupts per period for precise control..
    let mut freq: c_int = runtime.rate * 4;
    ...
    freq = ESM_BOB_FREQ;
#[no_mangle]
pub unsafe extern "C" fn if(ESM_BOB_FREQ_MAX: freq >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn snd_es1968_compute_rate(chip: *mut es1968, freq: u32) -> u32 {
    static u32 snd_es1968_compute_rate(struct es1968 *chip, u32 freq)
    {
    let mut rate: u32 = (freq << 16) / chip.clock;
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_apu_set_freq(chip: *mut es1968, apu: c_int, freq: c_int) {
...
// spin lock held
#[no_mangle]
pub unsafe extern "C" fn snd_es1968_trigger_apu(esm: *mut es1968, apu: c_int, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_pcm_start(chip: *mut es1968, es: *mut esschan) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_pcm_stop(chip: *mut es1968, es: *mut esschan) {
...
// set the wavecache control reg
    ...
    {
    let mut tmpval: u32 = (addr - 0x10) & 0xFFF8;
    if (! capture) {
    if (!(es.fmt & ESS_FMT_16BIT))
    tmpval |= 4;	/* 8bit */
    if (es.fmt & ESS_FMT_STEREO)
...
// Because the Maestro can only take addresses relative to the PCM base address
    register :( */
#[no_mangle]
unsafe extern "C" fn calc_available_memory_size(chip: *mut es1968) -> c_int {
...
// free a memory chunk
#[no_mangle]
unsafe extern "C" fn snd_es1968_free_memory(chip: *mut es1968, buf: *mut esm_memory) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_free_dmabuf(chip: *mut es1968) {
...
// buffer is extracted from the pre-allocated memory chunk
    ...
    let mut size: c_int = params_buffer_bytes(hw_params);
    if (chan.memory) {
    ...
    if (chan.memory == core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_es1968_alloc_apu_pair(chip: *mut es1968, type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_es1968_free_apu_pair(chip: *mut es1968, apu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn es1968_measure_clock(chip: *mut es1968) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_es1968_suppress_jitter(chip: *mut es1968, es: *mut esschan) {
...
// else ack 'em all, i imagine
    ...
    let mut curp: c_uint = __apu_get_register(chip, chip.measure_apu, 5);
...
//
#[no_mangle]
unsafe extern "C" fn snd_es1968_ac97_reset(chip: *mut es1968) {
    static void snd_es1968_ac97_reset(struct es1968 *chip)
    {
    let mut ioaddr: c_ulong = chip.io_port;
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_reset(chip: *mut es1968) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_es1968_chip_init(chip: *mut es1968) {
    static void snd_es1968_chip_init(struct es1968 *chip)
    {
    struct pci_dev *pci = chip.pci;
    int i;
    let mut iobase: c_ulong = chip.io_port;
    u16 w;
    u32 n;
...
// Enable IRQ's
#[no_mangle]
unsafe extern "C" fn snd_es1968_start_irq(chip: *mut es1968) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_create_gameport(chip: *mut es1968, dev: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_free_gameport(chip: *mut es1968) {
...
#[no_mangle]
unsafe extern "C" fn snd_es1968_input_register(chip: *mut es1968) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_es1968_tea575x_gpio {
...
unsafe extern "C" fn snd_es1968_tea575x_set_pins(tea: *mut snd_tea575x, pins: u8) {
    ...
    let mut gpio: snd_es1968_tea575x_gpio = *get_tea575x_gpio(chip);
    let mut val: u16 = 0;
...
unsafe extern "C" fn snd_es1968_tea575x_get_pins(tea: *mut snd_tea575x) -> u8 {
    ...
    struct es1968 *chip = tea.private_data;
    let mut gpio: snd_es1968_tea575x_gpio = *get_tea575x_gpio(chip);
    let mut val: u16 = inw(chip.io_port + GPIO_DATA);
    let mut ret: u8 = 0;
    if (val & (1 << gpio.data))
    ret |= TEA575X_DATA;
    if (val & (1 << gpio.most))
...
unsafe extern "C" fn snd_es1968_tea575x_set_direction(tea: *mut snd_tea575x, output: bool) {
    ...
    {
    struct es1968 *chip = tea.private_data;
    let mut io: c_ulong = chip.io_port + GPIO_DATA;
    let mut odir: u16 = inw(io + IO_DIR);
    let mut gpio: snd_es1968_tea575x_gpio = *get_tea575x_gpio(chip);
    if (output) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ess_device_list {
    pub /: *mut *mut unsigned short type; / chip type,
    pub /: *mut *mut unsigned short vendor; / subsystem vendor id,
}
