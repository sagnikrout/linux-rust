...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HPI_ADAPTER_PROPERTIES {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HPI_ADAPTER_MODE_CMDS {
...
pub const HPI_CAPABILITY_MAX: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HPI_ISTREAM_MPEG_ANC_ALIGNS {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HPI_MIXER_STORE_COMMAND {
...
//
pub const HPI_UNITS_PER_dB: c_int = 100;
...
pub const HPI_PAD_CHANNEL_NAME_LEN: c_int = 16;
// The text string containing the artist.
pub const HPI_PAD_ARTIST_LEN: c_int = 64;
// The text string containing the title.
pub const HPI_PAD_TITLE_LEN: c_int = 64;
// The text string containing the comment.
pub const HPI_PAD_COMMENT_LEN: c_int = 256;
// The PTY when the tuner has not received any PTY.
pub const HPI_PAD_PROGRAM_TYPE_INVALID: c_uint = 0xffff;
// \}
// Data types for PTY string translation.
//
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum eHPI_RDS_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HPI_TUNER_MODE_VALUES {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HPI_TUNER_STATUS_BITS {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HPI_SAMPLECLOCK_SOURCES {
...
pub const HPI_MAX_ADAPTERS: c_int = 20;
// Maximum number of in or out streams per adapter
pub const HPI_MAX_STREAMS: c_int = 16;

// maximum number of ancillary bytes per MPEG frame

pub const HPI_STRING_LEN: c_int = 16;
// Networked adapters have index >= 100
pub const HPI_MIN_NETWORK_ADAPTER_IDX: c_int = 100;
// Velocity units
pub const HPI_OSTREAM_VELOCITY_UNITS: c_int = 4096;
// OutStream timescale units
pub const HPI_OSTREAM_TIMESCALE_UNITS: c_int = 10000;
// OutStream timescale passthrough - turns timescaling on in passthough mode
pub const HPI_OSTREAM_TIMESCALE_PASSTHROUGH: c_int = 99999;
// \}
//
// STRUCTURES
...
// < Legacy ancillary mode or idle bit
    pub /: *mut *mut *mut u16 unused; /< Unused,
    pub /: *mut *mut *mut u16 channels; /< 1,2..., (or ancillary mode or idle bit,
    pub /: *mut *mut *mut u16 format; /< HPI_FORMAT_PCM16, _MPEG etc. see #HPI_FORMATS.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpi_anc_frame {
    pub valid_bits_in_this_frame: u32,
    pub b_data: [u8; HPI_MAX_ANC_BYTES_PER_FRAME],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpi_async_event {
    pub /: *mut *mut *mut u16 event_type; /< type of event. \sa async_event,
    pub /: *mut *mut *mut u16 sequence; /< Sequence number, allows lost event detection,
    pub /: *mut *mut *mut u32 state; /< New state,
    pub /: *mut *mut *mut u32 h_object; /< handle to the object returning the event.,
    pub /: *mut *mut *mut u16 index; /< GPIO bit index.,
    pub gpio: },
    pub /: *mut *mut *mut u16 node_index; /< what node is the control on ?,
    pub /: *mut *mut *mut u16 node_type; /< what type of node is the control on ?,
    pub control: },
    pub u: },
}
...
//
extern "C" {
    pub fn hpi_subsys_get_version_ex(pversion_ex: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_subsys_get_num_adapters(pn_num_adapters: *mut c_int) -> u16;
}
//
// Adapter
//
extern "C" {
    pub fn hpi_adapter_open(adapter_index: u16) -> u16;
}
extern "C" {
    pub fn hpi_adapter_close(adapter_index: u16) -> u16;
}
extern "C" {
    pub fn hpi_adapter_set_mode(adapter_index: u16, adapter_mode: u32) -> u16;
}
extern "C" {
    pub fn hpi_adapter_get_mode(adapter_index: u16, padapter_mode: *mut u32) -> u16;
}
//
// OutStream
//
extern "C" {
    pub fn hpi_outstream_close(h_outstream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_start(h_outstream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_wait_start(h_outstream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_stop(h_outstream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_sinegen(h_outstream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_reset(h_outstream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_query_format(h_outstream: u32, p_format: *mut hpi_format) -> u16;
}
extern "C" {
    pub fn hpi_outstream_set_format(h_outstream: u32, p_format: *mut hpi_format) -> u16;
}
extern "C" {
    pub fn hpi_outstream_set_velocity(h_outstream: u32, velocity: c_short) -> u16;
}
extern "C" {
    pub fn hpi_outstream_ancillary_reset(h_outstream: u32, mode: u16) -> u16;
}
extern "C" {
    pub fn hpi_outstream_ancillary_get_info(h_outstream: u32, pframes_available: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_set_time_scale(h_outstream: u32, time_scaleX10000: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_host_buffer_allocate(h_outstream: u32, size_in_bytes: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_host_buffer_free(h_outstream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_group_add(h_outstream: u32, h_stream: u32) -> u16;
}
extern "C" {
    pub fn hpi_outstream_group_reset(h_outstream: u32) -> u16;
}
//
// InStream
//
extern "C" {
    pub fn hpi_instream_close(h_instream: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_read_buf(h_instream: u32, pb_read_buf: *mut u8, bytes_to_read: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_start(h_instream: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_wait_start(h_instream: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_stop(h_instream: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_reset(h_instream: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_ancillary_get_info(h_instream: u32, pframe_space: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_host_buffer_allocate(h_instream: u32, size_in_bytes: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_host_buffer_free(h_instream: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_group_add(h_instream: u32, h_stream: u32) -> u16;
}
extern "C" {
    pub fn hpi_instream_group_reset(h_instream: u32) -> u16;
}
//
// Mixer
//
extern "C" {
    pub fn hpi_mixer_open(adapter_index: u16, ph_mixer: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_mixer_close(h_mixer: u32) -> u16;
}
//
// Controls
//
...
//
extern "C" {
    pub fn hpi_volume_set_mute(h_control: u32, mute: u32) -> u16;
}
extern "C" {
    pub fn hpi_volume_get_mute(h_control: u32, mute: *mut u32) -> u16;
}

extern "C" {
    pub fn hpi_volume_query_channels(h_control: u32, p_channels: *mut u32) -> u16;
}
//
// Level control
//
...
//
extern "C" {
    pub fn hpi_meter_query_channels(h_meter: u32, p_channels: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_meter_set_peak_ballistics(h_control: u32, attack: u16, decay: u16) -> u16;
}
extern "C" {
    pub fn hpi_meter_set_rms_ballistics(h_control: u32, attack: u16, decay: u16) -> u16;
}
extern "C" {
    pub fn hpi_meter_get_peak_ballistics(h_control: u32, attack: *mut u16, decay: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_meter_get_rms_ballistics(h_control: u32, attack: *mut u16, decay: *mut u16) -> u16;
}
//
// ChannelMode control
//
extern "C" {
    pub fn hpi_channel_mode_set(h_control: u32, mode: u16) -> u16;
}
extern "C" {
    pub fn hpi_channel_mode_get(h_control: u32, mode: *mut u16) -> u16;
}
//
// Tuner control
//
extern "C" {
    pub fn hpi_tuner_query_band(h_tuner: u32, index: u32, pw_band: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_tuner_set_band(h_control: u32, band: u16) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_band(h_control: u32, pw_band: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_tuner_set_frequency(h_control: u32, freq_ink_hz: u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_frequency(h_control: u32, pw_freq_ink_hz: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_rf_level(h_control: u32, pw_level: *mut c_short) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_raw_rf_level(h_control: u32, pw_level: *mut c_short) -> u16;
}
extern "C" {
    pub fn hpi_tuner_query_gain(h_tuner: u32, index: u32, pw_gain: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_tuner_set_gain(h_control: u32, gain: c_short) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_gain(h_control: u32, pn_gain: *mut c_short) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_status(h_control: u32, pw_status_mask: *mut u16, pw_status: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_tuner_set_mode(h_control: u32, mode: u32, value: u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_mode(h_control: u32, mode: u32, pn_value: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_rds(h_control: u32, p_rds_data: *mut c_char) -> u16;
}
extern "C" {
    pub fn hpi_tuner_set_deemphasis(h_control: u32, deemphasis: u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_deemphasis(h_control: u32, pdeemphasis: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_query_program(h_tuner: u32, pbitmap_program: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_set_program(h_control: u32, program: u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_program(h_control: u32, pprogram: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_hd_radio_signal_quality(h_control: u32, pquality: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_get_hd_radio_signal_blend(h_control: u32, pblend: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tuner_set_hd_radio_signal_blend(h_control: u32, blend: u32) -> u16;
}
//
// PAD control
//
extern "C" {
    pub fn hpi_pad_get_program_type(h_control: u32, ppTY: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_pad_get_rdsPI(h_control: u32, ppI: *mut u32) -> u16;
}
//
// AES/EBU Receiver control
//
extern "C" {
    pub fn hpi_aesebu_receiver_set_format(h_control: u32, source: u16) -> u16;
}
extern "C" {
    pub fn hpi_aesebu_receiver_get_format(h_control: u32, pw_source: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_aesebu_receiver_get_sample_rate(h_control: u32, psample_rate: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_aesebu_receiver_get_user_data(h_control: u32, index: u16, pw_data: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_aesebu_receiver_get_error_status(h_control: u32, pw_error_data: *mut u16) -> u16;
}
//
// AES/EBU Transmitter control
//
extern "C" {
    pub fn hpi_aesebu_transmitter_set_sample_rate(h_control: u32, sample_rate: u32) -> u16;
}
extern "C" {
    pub fn hpi_aesebu_transmitter_set_user_data(h_control: u32, index: u16, data: u16) -> u16;
}
extern "C" {
    pub fn hpi_aesebu_transmitter_set_format(h_control: u32, output_format: u16) -> u16;
}
extern "C" {
    pub fn hpi_aesebu_transmitter_get_format(h_control: u32, pw_output_format: *mut u16) -> u16;
}
//
// Multiplexer control
//
...
//
extern "C" {
    pub fn hpi_vox_set_threshold(h_control: u32, an_gain0_01dB: c_short) -> u16;
}
extern "C" {
    pub fn hpi_vox_get_threshold(h_control: u32, an_gain0_01dB: *mut c_short) -> u16;
}
//
// Bitstream control
//
extern "C" {
    pub fn hpi_bitstream_set_clock_edge(h_control: u32, edge_type: u16) -> u16;
}
extern "C" {
    pub fn hpi_bitstream_set_data_polarity(h_control: u32, polarity: u16) -> u16;
}
//
// SampleClock control
//
extern "C" {
    pub fn hpi_sample_clock_set_source(h_control: u32, source: u16) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_get_source(h_control: u32, pw_source: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_set_source_index(h_control: u32, source_index: u16) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_get_source_index(h_control: u32, pw_source_index: *mut u16) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_get_sample_rate(h_control: u32, psample_rate: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_set_local_rate(h_control: u32, sample_rate: u32) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_get_local_rate(h_control: u32, psample_rate: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_set_auto(h_control: u32, enable: u32) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_get_auto(h_control: u32, penable: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_set_local_rate_lock(h_control: u32, lock: u32) -> u16;
}
extern "C" {
    pub fn hpi_sample_clock_get_local_rate_lock(h_control: u32, plock: *mut u32) -> u16;
}
//
// Microphone control
//
extern "C" {
    pub fn hpi_microphone_set_phantom_power(h_control: u32, on_off: u16) -> u16;
}
extern "C" {
    pub fn hpi_microphone_get_phantom_power(h_control: u32, pw_on_off: *mut u16) -> u16;
}
//
// Parametric Equalizer control
//
extern "C" {
    pub fn hpi_parametric_eq_set_state(h_control: u32, on_off: u16) -> u16;
}
//
// Compressor Expander control
//
extern "C" {
    pub fn hpi_compander_set_enable(h_control: u32, on: u32) -> u16;
}
extern "C" {
    pub fn hpi_compander_get_enable(h_control: u32, pon: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_compander_set_makeup_gain(h_control: u32, makeup_gain0_01dB: c_short) -> u16;
}
extern "C" {
    pub fn hpi_compander_get_makeup_gain(h_control: u32, pn_makeup_gain0_01dB: *mut c_short) -> u16;
}
extern "C" {
    pub fn hpi_compander_set_ratio(h_control: u32, index: u32, ratio100: u32) -> u16;
}
extern "C" {
    pub fn hpi_compander_get_ratio(h_control: u32, index: u32, pw_ratio100: *mut u32) -> u16;
}
//
// Cobranet control
//
extern "C" {
    pub fn hpi_cobranet_get_ip_address(h_control: u32, pdw_ip_address: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_cobranet_set_ip_address(h_control: u32, dw_ip_address: u32) -> u16;
}
extern "C" {
    pub fn hpi_cobranet_get_static_ip_address(h_control: u32, pdw_ip_address: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_cobranet_set_static_ip_address(h_control: u32, dw_ip_address: u32) -> u16;
}
//
// Tone Detector control
//
extern "C" {
    pub fn hpi_tone_detector_get_state(hC: u32, state: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tone_detector_set_enable(hC: u32, enable: u32) -> u16;
}
extern "C" {
    pub fn hpi_tone_detector_get_enable(hC: u32, enable: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tone_detector_set_event_enable(hC: u32, event_enable: u32) -> u16;
}
extern "C" {
    pub fn hpi_tone_detector_get_event_enable(hC: u32, event_enable: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_tone_detector_set_threshold(hC: u32, threshold: c_int) -> u16;
}
extern "C" {
    pub fn hpi_tone_detector_get_threshold(hC: u32, threshold: *mut c_int) -> u16;
}
extern "C" {
    pub fn hpi_tone_detector_get_frequency(hC: u32, index: u32, frequency: *mut u32) -> u16;
}
//
// Silence Detector control
//
extern "C" {
    pub fn hpi_silence_detector_get_state(hC: u32, state: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_set_enable(hC: u32, enable: u32) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_get_enable(hC: u32, enable: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_set_event_enable(hC: u32, event_enable: u32) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_get_event_enable(hC: u32, event_enable: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_set_delay(hC: u32, delay: u32) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_get_delay(hC: u32, delay: *mut u32) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_set_threshold(hC: u32, threshold: c_int) -> u16;
}
extern "C" {
    pub fn hpi_silence_detector_get_threshold(hC: u32, threshold: *mut c_int) -> u16;
}
//
// Utility functions
//
