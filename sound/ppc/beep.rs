...
pub struct pmac_beep {
    ...
    pub /: *mut *mut int volume; / mixer volume: 0-100,
    pub /: *mut *mut int volume_play; / currently playing volume,
    pub hz: c_int,
    pub nsamples: c_int,
    pub /: *mut *mut *mut short buf; / allocated wave buffer,
    pub /: *mut *mut dma_addr_t addr; / physical address of buffer,
