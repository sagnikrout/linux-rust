...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad1843_gain {
    pub /: *mut *mut int negative; / nonzero if gain is negative.,
    pub lfield: *const ad1843_bitfield,
    pub rfield: *const ad1843_bitfield,
    pub lmute: *const ad1843_bitfield,
    pub rmute: *const ad1843_bitfield,
}
...
//
#[no_mangle]
unsafe extern "C" fn ad1843_read_multi(ad1843: *mut snd_ad1843, argcount: c_int, ...) {
    static void ad1843_read_multi(struct snd_ad1843 *ad1843, int argcount, ...)
    {
    va_list ap;
    const struct ad1843_bitfield *fp;
    let mut w: c_int = 0, mask, *value, reg = -1;
...
//
#[no_mangle]
unsafe extern "C" fn ad1843_write_multi(ad1843: *mut snd_ad1843, argcount: c_int, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn ad1843_get_gain_max(ad1843: *mut snd_ad1843, id: c_int) -> c_int {
...
pub unsafe extern "C" fn ad1843_get_gain(ad1843: *mut snd_ad1843, id: c_int) -> c_int {
    ...
    int lg, rg, lm, rm;
    const struct ad1843_gain *gp = ad1843_gain[id];
    let mut mask: c_ushort = (1 << gp.lfield.nbits) - 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn ad1843_set_gain(ad1843: *mut snd_ad1843, id: c_int, newval: c_int) -> c_int {
    int ad1843_set_gain(struct snd_ad1843 *ad1843, int id, int newval)
    {
    const struct ad1843_gain *gp = ad1843_gain[id];
    let mut mask: c_ushort = (1 << gp.lfield.nbits) - 1;
    let mut lg: c_int = (newval >> 0) & mask;
    let mut rg: c_int = (newval >> 8) & mask;
    let mut lm: c_int = (lg == 0) ? 1 : 0;
    let mut rm: c_int = (rg == 0) ? 1 : 0;
    if (gp.negative) {
    lg = mask - lg;
    rg = mask - rg;
    }
...
pub unsafe extern "C" fn ad1843_get_recsrc(ad1843: *mut snd_ad1843) -> c_int {
    ...
    {
    let mut val: c_int = ad1843_read_bits(ad1843, &ad1843_LSS);
    if (val < 0 || val > 2) {
    val = 2;
...
// Setup ad1843 for D/A conversion.
    ...
    {
    let mut ad_fmt: c_int = 0, ad_mode = 0;
    switch (fmt) {
...
#[no_mangle]
pub unsafe extern "C" fn ad1843_shutdown_adc(ad1843: *mut snd_ad1843) {
