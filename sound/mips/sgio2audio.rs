...
//! Source: sound/mips/sgio2audio.c
#![no_std]
...
// Macro flag: #define SNDRV_GET_ID
...
pub const CODEC_CONTROL_WORD_SHIFT: c_int = 0;

pub const CODEC_CONTROL_ADDRESS_SHIFT: c_int = 17;

pub const CHANNEL_RING_SHIFT: c_int = 12;

pub const CHANNEL_LEFT_SHIFT: c_int = 40;
pub const CHANNEL_RIGHT_SHIFT: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
...
// codec
    pub ad1843: snd_ad1843,
    pub ad1843_lock: spinlock_t,
// channels
    pub channel: [snd_sgio2audio_chan; 3],
// resources
...
//
#[no_mangle]
unsafe extern "C" fn read_ad1843_reg(priv: *mut c_void, reg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn write_ad1843_reg(priv: *mut c_void, reg: c_int, word: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_sgio2audio_dma_in_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snd_sgio2audio_dma_out_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snd_sgio2audio_error_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// (Audio or Audio/Video board present)
    ...
    if (chip.ring_base == core::ptr::null_mut()) {
    printk(KERN_ERR
