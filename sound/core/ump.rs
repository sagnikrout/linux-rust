...
#[no_mangle]
pub unsafe extern "C" fn ump_legacy_set_rawmidi_name(ump: *mut snd_ump_endpoint) {
    static inline void ump_legacy_set_rawmidi_name(struct snd_ump_endpoint *ump)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn update_legacy_names(ump: *mut snd_ump_endpoint) {
...
//
    ...
    {
    let mut info_flags: c_uint = SNDRV_RAWMIDI_INFO_UMP;
...
#[no_mangle]
unsafe extern "C" fn snd_ump_dev_unregister(rmidi: *mut snd_rawmidi) -> c_int {
    static int snd_ump_dev_unregister(struct snd_rawmidi *rmidi)
    {
    return 0;
    }
...
unsafe extern "C" fn snd_ump_rawmidi_close(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    struct snd_ump_endpoint *ump = rawmidi_to_ump(substream.rmidi);
    let mut dir: c_int = substream.stream;
    ump.substreams[dir] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ump_request_open(ump: *mut snd_ump_endpoint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ump_request_close(ump: *mut snd_ump_endpoint) {
...
#[no_mangle]
unsafe extern "C" fn choose_default_protocol(ump: *mut snd_ump_endpoint) {
...
#[no_mangle]
unsafe extern "C" fn seq_notify_ep_change(ump: *mut snd_ump_endpoint) {
...
#[no_mangle]
unsafe extern "C" fn ump_set_rawmidi_name(ump: *mut snd_ump_endpoint) {
...
#[no_mangle]
unsafe extern "C" fn seq_notify_protocol(ump: *mut snd_ump_endpoint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_ump_switch_protocol(ump: *mut snd_ump_endpoint, protocol: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_block_from_fb_info(ump: *mut snd_ump_endpoint, blk: c_int) -> c_int {
...
unsafe extern "C" fn snd_ump_legacy_open(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    let mut dir: c_int = substream.stream;
    let mut group: c_int = ump.legacy_mapping[substream.number];
    int err;
...
unsafe extern "C" fn snd_ump_legacy_close(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    ump.legacy_substreams[dir][group] = core::ptr::null_mut();
    if (dir == SNDRV_RAWMIDI_STREAM_OUTPUT) {
    if (!--ump.legacy_out_opens)
...
#[no_mangle]
unsafe extern "C" fn snd_ump_legacy_dev_register(rmidi: *mut snd_rawmidi) -> c_int {
...
// dummy, just for avoiding create superfluous seq clients
    ...
    let mut dir: c_int = SNDRV_RAWMIDI_STREAM_OUTPUT;
    unsigned int protocol;
    unsigned char c;
    int group, size = 0;
    ...
    unsigned char buf[16];
    unsigned char group;
    let mut dir: c_int = SNDRV_RAWMIDI_STREAM_INPUT;
    int size;
...
#[no_mangle]
unsafe extern "C" fn fill_legacy_mapping(ump: *mut snd_ump_endpoint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_legacy_names(ump: *mut snd_ump_endpoint) {
    static void update_legacy_names(struct snd_ump_endpoint *ump)
    {
...
#[no_mangle]
unsafe extern "C" fn ump_legacy_set_rawmidi_name(ump: *mut snd_ump_endpoint) {
    static void ump_legacy_set_rawmidi_name(struct snd_ump_endpoint *ump)
    {
    struct snd_rawmidi *rmidi = ump.legacy_rmidi;
    if (!rmidi)
    ...
    if (err < 0) {
    kfree(ump.out_cvts);
    ump.out_cvts = core::ptr::null_mut();
    return err;
    }
    if (input)
