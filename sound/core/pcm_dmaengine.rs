...
//! Source: sound/core/pcm_dmaengine.c
#![no_std]
...
//
    ...
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(8: bits ==) -> else {
    else if (bits == 8)
...
#[no_mangle]
unsafe extern "C" fn dmaengine_pcm_prepare_and_submit(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_dmaengine_pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_dmaengine_pcm_pointer_no_residue(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_dmaengine_pcm_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
pub unsafe extern "C" fn snd_dmaengine_pcm_sync_stop(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_dmaengine_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_dmaengine_pcm_close_release_chan(substream: *mut snd_pcm_substream) -> c_int {
...
//
    ...
    let mut bits: c_int = snd_pcm_format_physical_width(i);
//
