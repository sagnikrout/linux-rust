...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_llseek(file: *mut *mut file, offset: loff_t, orig: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_open(inode: *mut inode, file: *mut *mut file) -> c_int {
    static int snd_hwdep_open(struct inode *inode, struct file * file)
    {
    let mut major: c_int = imajor(inode);
    struct snd_hwdep *hw;
    int err;
...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_release(inode: *mut inode, file: *mut *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_poll(file: *mut *mut file, wait: *mut *mut poll_table) -> __poll_t {
...
// check whether the dsp was already loaded
    ...
    {
    let mut info: snd_hwdep_dsp_image = {};
...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_mmap(file: *mut *mut file, vma: *mut *mut vm_area_struct) -> c_int {
    ...
    device = 0;
#[no_mangle]
pub unsafe extern "C" fn if(SNDRV_MINOR_HWDEPS: device <) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_free(hwdep: *mut snd_hwdep) {
...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_proc_init() -> void __init {
    static void __init snd_hwdep_proc_init(void)
    {
    struct snd_info_entry *entry;
    entry = snd_info_create_module_entry(THIS_MODULE, "hwdep", core::ptr::null_mut());
    if (entry) {
...
#[no_mangle]
unsafe extern "C" fn snd_hwdep_proc_done() -> void __exit {
    static void __exit snd_hwdep_proc_done(void)
    {
    snd_info_free_entry(snd_hwdep_proc_entry);
    }

// Macro flag: #define snd_hwdep_proc_init()
// Macro flag: #define snd_hwdep_proc_done()

//
// ENTRY functions
//
#[no_mangle]
unsafe extern "C" fn alsa_hwdep_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alsa_hwdep_exit() -> void __exit {
