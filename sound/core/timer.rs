...
// internal flags
pub const SNDRV_TIMER_IFLG_PAUSED: c_uint = 0x00010000;
pub const SNDRV_TIMER_IFLG_DEAD: c_uint = 0x00020000;

pub const DEFAULT_TIMER_LIMIT: c_int = 4;

pub const DEFAULT_TIMER_LIMIT: c_int = 1;

    let mut timer_limit: static int = DEFAULT_TIMER_LIMIT;
    let mut timer_tstamp_monotonic: static int = 1;
...
pub struct snd_timer_user {
    ...
    pub /: *mut *mut int tread; / enhanced read with timestamps and events,
    pub ticks: c_ulong,
    pub overrun: c_ulong,
    pub qhead: c_int,
    pub qtail: c_int,
    ...
    pub queue: *mut snd_timer_read,
    pub tqueue: *mut snd_timer_tread64,
    pub qlock: spinlock_t,
    pub last_resolution: c_ulong,
    pub filter: c_uint,
    pub /: *mut *mut timespec64 tstamp; / trigger tstamp,
    pub qchange_sleep: wait_queue_head_t,
...
pub struct snd_timer_status32 {
    pub /: *mut *mut s32 tstamp_sec; / Timestamp - last update,
    pub tstamp_nsec: i32,
...
pub struct snd_timer_status64 {
    pub /: *mut *mut s64 tstamp_sec; / Timestamp - last update,
    pub tstamp_nsec: i64,
    pub /: *mut *mut unsigned int resolution; / current period resolution in ns,
    pub /: *mut *mut unsigned int lost; / counter of master tick lost,
    pub /: *mut *mut unsigned int overrun; / count of read queue overruns,
...
pub const MAX_SLAVE_INSTANCES: c_int = 1000;
...
#[no_mangle]
pub unsafe extern "C" fn snd_timer_instance_free(timeri: *mut snd_timer_instance) {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_request(tid: *mut snd_timer_id) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_timer_ref_get(timer: *mut snd_timer) {
    static inline void snd_timer_ref_get(struct snd_timer *timer)
    {
    kref_get(&timer.kref);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_timer_ref_put(timer: *mut snd_timer) {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_has_slave_key(timeri: *const snd_timer_instance) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn snd_timer_check_slave(slave: *mut snd_timer_instance) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_timer_check_master(master: *mut snd_timer_instance) -> c_int {
...
//
    ...
    {
    struct snd_timer *timer;
    struct device *card_dev_to_put = core::ptr::null_mut();
    int err;
...
// remove slave links, called from snd_timer_close_locked() below
    ...
    timeri.timer = core::ptr::null_mut();
    list_for_each_entry_safe(slave, tmp, &timeri.slave_list_head, open_list) {
    list_move_tail(&slave.open_list, &snd_timer_slave_list);
    timer.num_instances--;
    snd_timer_ref_put(timer);
    slave.master = core::ptr::null_mut();
    slave.timer = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_timer_close(timeri: *mut snd_timer_instance) {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_hw_resolution(timer: *mut snd_timer) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn snd_timer_resolution(timeri: *mut snd_timer_instance) -> c_ulong {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn __free(_arg: snd_timeri_timer) -> *mut snd_timer timer {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_notify1(ti: *mut snd_timer_instance, event: c_int) {
    static void snd_timer_notify1(struct snd_timer_instance *ti, int event)
    {
    struct snd_timer *timer = ti.timer;
    let mut resolution: c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !timeri->cticks) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_stop1(timeri: *mut snd_timer_instance, stop: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_stop_slave(timeri: *mut snd_timer_instance, stop: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_timer_start(timeri: *mut snd_timer_instance, ticks: c_uint) -> c_int {
    int snd_timer_start(struct snd_timer_instance *timeri, unsigned int ticks)
    {
    if (timeri == core::ptr::null_mut() || ticks < 1)
    return -EINVAL;
    guard(read_lock_irqsave)(&timeri_lock);
    if (timeri.flags & SNDRV_TIMER_IFLG_SLAVE)
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_timer_stop(timeri: *mut snd_timer_instance) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_timer_continue(timeri: *mut snd_timer_instance) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_timer_pause(timeri: *mut *mut snd_timer_instance) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_timer_reschedule(timer: *mut *mut snd_timer, ticks_left: c_ulong) {
    static void snd_timer_reschedule(struct snd_timer * timer, unsigned long ticks_left)
    {
    struct snd_timer_instance *ti;
    let mut ticks: c_ulong = ~0UL;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_timer_interrupt(timer: *mut *mut snd_timer, ticks_left: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_kref_release(kref: *mut kref) {
    static void snd_timer_kref_release(struct kref *kref)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_free(timer: *mut snd_timer) -> c_int {
    static int snd_timer_free(struct snd_timer *timer)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_dev_free(device: *mut snd_device) -> c_int {
    static int snd_timer_dev_free(struct snd_device *device)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_dev_register(dev: *mut snd_device) -> c_int {
    ...
    return -ENXIO;
    if (!(timer.hw.flags & SNDRV_TIMER_HW_SLAVE) &&
    !timer.hw.resolution && timer.hw.c_resolution == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn snd_timer_dev_disconnect(device: *mut snd_device) -> c_int {
    static int snd_timer_dev_disconnect(struct snd_device *device)
    {
    struct snd_timer *timer = device.device_data;
    struct snd_timer_instance *ti;
...
#[no_mangle]
pub unsafe extern "C" fn snd_timer_notify(timer: *mut snd_timer, event: c_int, tstamp: *mut timespec64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_timer_global_new(id: *mut c_char, device: c_int, rtimer: *mut snd_timer) -> c_int {
    ...
    tid.device = device;
    tid.subdevice = 0;
    return snd_timer_new(core::ptr::null_mut(), id, &tid, rtimer);
    }
...
#[no_mangle]
pub unsafe extern "C" fn snd_timer_global_register(timer: *mut snd_timer) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_timer_system_private {
    pub tlist: timer_list,
    pub snd_timer: *mut snd_timer,
    pub last_expires: c_ulong,
    pub last_jiffies: c_ulong,
    pub correction: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn snd_timer_s_function(t: *mut timer_list) {
    static void snd_timer_s_function(struct timer_list *t)
    {
    struct snd_timer_system_private *priv = timer_container_of(priv, t,
    tlist);
    struct snd_timer *timer = priv.snd_timer;
    let mut jiff: c_ulong = jiffies;
    if (time_after(jiff, priv.last_expires))
    priv.correction += (long)jiff - (long)priv.last_expires;
    snd_timer_interrupt(timer, (long)jiff - (long)priv.last_jiffies);
    }
#[no_mangle]
unsafe extern "C" fn snd_timer_s_start(timer: *mut *mut snd_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_s_stop(timer: *mut *mut snd_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_s_close(timer: *mut snd_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_free_system(timer: *mut snd_timer) {
    static void snd_timer_free_system(struct snd_timer *timer)
    {
    kfree(timer.private_data);
    }
#[no_mangle]
unsafe extern "C" fn snd_timer_register_system() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_proc_init() -> void __init {
    static void __init snd_timer_proc_init(void)
    {
    struct snd_info_entry *entry;
    entry = snd_info_create_module_entry(THIS_MODULE, "timers", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn snd_timer_proc_done() -> void __exit {
    static void __exit snd_timer_proc_done(void)
    {
    snd_info_free_entry(snd_timer_proc_entry);
    }

// Macro flag: #define snd_timer_proc_init()
// Macro flag: #define snd_timer_proc_done()
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_disconnect(timeri: *mut snd_timer_instance) {
...
#[no_mangle]
unsafe extern "C" fn realloc_user_queue(tu: *mut snd_timer_user, size: c_int) -> c_int {
    static int realloc_user_queue(struct snd_timer_user *tu, int size)
    {
    struct snd_timer_read *queue = core::ptr::null_mut();
    struct snd_timer_tread64 *tqueue = core::ptr::null_mut();
    if (tu.tread) {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_zero_id(id: *mut snd_timer_id) {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_copy_id(id: *mut snd_timer_id, timer: *mut snd_timer) {
...
#[no_mangle]
unsafe extern "C" fn get_next_device(id: *mut snd_timer_id) {
    ...
    id.subdevice = 0;
#[no_mangle]
pub unsafe extern "C" fn if(INT_MAX: id->subdevice <) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_next_device(_tid: *mut snd_timer_id __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn timer_set_gparams(gparams: *mut snd_timer_gparams) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_start(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_stop(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_continue(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_pause(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_utimer_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_utimer_trigger(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_utimer_ioctl(file: *mut file, ioctl: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn snd_utimer_start(t: *mut snd_timer) -> c_int {
    static int snd_utimer_start(struct snd_timer *t)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_utimer_stop(t: *mut snd_timer) -> c_int {
    static int snd_utimer_stop(struct snd_timer *t)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_utimer_open(t: *mut snd_timer) -> c_int {
    static int snd_utimer_open(struct snd_timer *t)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_utimer_close(t: *mut snd_timer) -> c_int {
...
// We hold the ioctl lock here so we won't get a race condition when allocating id
    ...
    err = snd_timer_new(core::ptr::null_mut(), utimer.name, &tid, &timer);
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_fasync(fd: c_int, file: *mut *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_user_poll(file: *mut file, wait: *mut *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn snd_timer_free_all() {
...
//
#[no_mangle]
unsafe extern "C" fn alsa_timer_init() -> int __init {
    static int __init alsa_timer_init(void)
    {
    int err;
    err = snd_device_alloc(&timer_dev, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    err = snd_register_device(SNDRV_DEVICE_TYPE_TIMER, core::ptr::null_mut(), 0,
    &snd_timer_f_ops, core::ptr::null_mut(), timer_dev);
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn alsa_timer_exit() -> void __exit {
