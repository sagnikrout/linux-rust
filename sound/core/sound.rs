...
//
    ...
    let mut major: static int = CONFIG_SND_MAJOR;
    int snd_major;
    EXPORT_SYMBOL(snd_major);
    let mut cards_limit: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn snd_request_other(minor: c_int) {
...
// /dev/aloadC?
    let mut card: c_int = SNDRV_MINOR_CARD(minor);
...
unsafe extern "C" fn snd_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    struct snd_minor *mptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn snd_find_free_minor(type: c_int, card: *mut snd_card, dev: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_minor_info_read(entry: *mut snd_info_entry, buffer: *mut snd_info_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_minor_info_init() -> int __init {
    int __init snd_minor_info_init(void)
    {
    struct snd_info_entry *entry;
    entry = snd_info_create_module_entry(THIS_MODULE, "devices", core::ptr::null_mut());
    if (!entry)
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn alsa_sound_init() -> int __init {
    ...
    sound_debugfs_root = debugfs_create_dir("sound", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn alsa_sound_exit() -> void __exit {
