...
//! Source: sound/core/pcm_native.c
#![no_std]
...
pub const trace_hw_mask_param_enabled(): c_int = 0;
pub const trace_hw_interval_param_enabled(): c_int = 0;
...
pub struct snd_pcm_hw_params_old {
    ...
    pub 1]: SNDRV_PCM_HW_PARAM_ACCESS +,
    struct snd_interval intervals[SNDRV_PCM_HW_PARAM_TICK_TIME -
    pub 1]: SNDRV_PCM_HW_PARAM_SAMPLE_BITS +,
    pub rmask: c_uint,
    pub cmask: c_uint,
    pub info: c_uint,
    pub msbits: c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_group_init(group: *mut snd_pcm_group) {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_stream_lock_nested(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn hw_support_mmap(substream: *mut snd_pcm_substream) -> bool {
...
// Iterate to evaluate all rules till no parameters are changed.
    ...
    let mut format: snd_pcm_format_t = snd_mask_min(m);
...
#[no_mangle]
unsafe extern "C" fn period_to_usecs(runtime: *mut snd_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_state_open_or_disconnected(substream: *mut snd_pcm_substream) -> bool {
    static bool snd_pcm_state_open_or_disconnected(struct snd_pcm_substream *substream)
    {
    let mut state: snd_pcm_state_t = snd_pcm_get_state(substream);
...
#[no_mangle]
pub unsafe extern "C" fn if(0: sync_irq && substream->pcm->card->sync_irq >) -> else {
...
// Keep old parameter to trace.
    ...
    changed = snd_pcm_hw_param_first(pcm, params, *v, core::ptr::null_mut());
    else
    changed = snd_pcm_hw_param_last(pcm, params, *v, core::ptr::null_mut());
    if (changed < 0)
    return changed;
    if (changed == 0)
    continue;
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_buffer_access_lock(runtime: *mut snd_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_buffer_access_unlock(runtime: *mut snd_pcm_runtime) {
...
pub unsafe extern "C" fn snd_pcm_runtime_buffer_set_silence(runtime: *mut snd_pcm_runtime) -> c_int {
    ...
    if (substream.ops.hw_params != core::ptr::null_mut()) {
...
// clear the buffer for avoiding possible kernel info leaks
    ...
    let mut size: usize = runtime.dma_bytes;
...
//
    ...
    if (substream.ops.hw_free != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn do_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_trigger_tstamp(substream: *mut snd_pcm_substream) {
    static void snd_pcm_trigger_tstamp(struct snd_pcm_substream *substream)
    {
    struct snd_pcm_runtime *runtime = substream.runtime;
    if (runtime.trigger_master == core::ptr::null_mut())
    return;
    ...
    runtime.trigger_master = core::ptr::null_mut();
    }
pub const ACTION_ARG_IGNORE: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
...
//
    ...
    bool stream_lock)
    {
    struct snd_pcm_substream *s = core::ptr::null_mut();
    struct snd_pcm_substream *s1;
    let mut res: c_int = 0, depth = 1;
    snd_pcm_group_for_each_entry(s, substream) {
    if (s != substream) {
    if (!stream_lock)
    mutex_lock_nested(&s.runtime.buffer_mutex, depth);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: s->pcm->nonatomic) -> else {
    ...
    s = core::ptr::null_mut(); /* unlock all */
    goto _unlock;
    }
    }
    snd_pcm_group_for_each_entry(s, substream) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: s1->pcm->nonatomic) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ops->undo_action) -> else {
...
//
    ...
    {
    let mut nonatomic: bool = substream.pcm.nonatomic;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_start(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_start_lock_irq(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_stop(substream: *mut snd_pcm_substream, state: snd_pcm_state_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_drain_done(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_stop_xrun(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_pause(substream: *mut snd_pcm_substream, push: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_suspend(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_suspend_all(pcm: *mut snd_pcm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_resume(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_xrun(substream: *mut snd_pcm_substream) -> c_int {
...
// reset callbacks:  state argument ignored
    ...
    {
    struct snd_pcm_runtime *runtime = substream.runtime;
    let mut err: c_int = snd_pcm_ops_ioctl(substream, SNDRV_PCM_IOCTL1_RESET, core::ptr::null_mut());
    if (err < 0)
    return err;
    guard(pcm_stream_lock_irq)(substream);
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_reset(substream: *mut snd_pcm_substream) -> c_int {
...
// pass f_flags as state argument
    ...
    snd_pcm_state_t state)
    {
    let mut cur_state: snd_pcm_state_t = snd_pcm_get_state(substream);
    let mut f_flags: c_int = state;
...
//
    ...
    tout = 100;
    if (drain_rate) {
    let mut t: c_long = drain_bufsz * 1100 / drain_rate;
    tout = max(t, tout);
    }
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_drop(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_pcm_file(file: *mut file) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_link(substream: *mut snd_pcm_substream, fd: c_int) -> c_int {
    ...
    group = core::ptr::null_mut(); /* assigned, don't free this one below */
    }
...
#[no_mangle]
unsafe extern "C" fn relink_to_local(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_unlink(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_pcm_unlink(struct snd_pcm_substream *substream)
    {
    struct snd_pcm_substream *s;
    struct snd_pcm_group *group;
    let mut nonatomic: bool = substream.pcm.nonatomic;
    let mut do_free: bool = false;
    guard(rwsem_write)(&snd_pcm_link_rwsem);
    if (!snd_pcm_stream_linked(substream))
    return -EALREADY;
    group = substream.group;
...
// All PCMs support at least the default STD subformat.
    ...
    m.bits[0] |= *subformats;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: snd_pcm_format_linear(f)) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_hw_constraints_init(substream: *mut snd_pcm_substream) -> c_int {
    ...
    snd_pcm_hw_rule_format, core::ptr::null_mut(),
    SNDRV_PCM_HW_PARAM_SAMPLE_BITS, -1);
    if (err < 0)
    return err;
    err = snd_pcm_hw_rule_add(runtime, 0, SNDRV_PCM_HW_PARAM_SAMPLE_BITS,
    snd_pcm_hw_rule_sample_bits, core::ptr::null_mut(),
    SNDRV_PCM_HW_PARAM_FORMAT,
    SNDRV_PCM_HW_PARAM_SAMPLE_BITS, -1);
    if (err < 0)
    return err;
    err = snd_pcm_hw_rule_add(runtime, 0, SNDRV_PCM_HW_PARAM_SAMPLE_BITS,
    snd_pcm_hw_rule_div, core::ptr::null_mut(),
    SNDRV_PCM_HW_PARAM_FRAME_BITS, SNDRV_PCM_HW_PARAM_CHANNELS, -1);
    if (err < 0)
    return err;
    err = snd_pcm_hw_rule_add(runtime, 0, SNDRV_PCM_HW_PARAM_FRAME_BITS,
    snd_pcm_hw_rule_mul, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_hw_constraints_complete(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcm_release_private(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_release_substream(substream: *mut snd_pcm_substream) {
    ...
    substream.pcm_release = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_playback_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_capture_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_open(file: *mut file, pcm: *mut snd_pcm, stream: c_int) -> c_int {
    static int snd_pcm_open(struct file *file, struct snd_pcm *pcm, int stream)
    {
    int err;
    wait_queue_entry_t wait;
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn do_pcm_hwsync(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_pcm_hwsync(substream: *mut snd_pcm_substream) -> c_int {
    static inline int snd_pcm_hwsync(struct snd_pcm_substream *substream)
    {
    return snd_pcm_delay(substream, core::ptr::null_mut());
    }
...
pub struct snd_pcm_sync_ptr32 {
    pub flags: u32,
    union {
    pub status: snd_pcm_mmap_status32,
    pub reserved: [c_uchar; 64],
    pub s: },
    union {
    pub control: snd_pcm_mmap_control32,
    pub reserved: [c_uchar; 64],
    pub c: },
    pub __packed: },
// recalculate the boundary within 32bit
#[no_mangle]
unsafe extern "C" fn recalculate_boundary(runtime: *mut snd_pcm_runtime) -> snd_pcm_uframes_t {
    static snd_pcm_uframes_t recalculate_boundary(struct snd_pcm_runtime *runtime)
    {
    pub boundary: snd_pcm_uframes_t,
    pub border: snd_pcm_uframes_t,
    pub order: c_int,
    if (! runtime.buffer_size)
    pub 0: return,
    pub runtime->buffer_size: border = 0x7fffffffUL -,
    if (runtime.buffer_size > border)
    pub runtime->buffer_size: return,
    pub __fls(runtime->buffer_size): order = __fls(border) -,
    pub order: boundary = runtime->buffer_size <<,
    if (boundary <= border)
    pub boundary: return,
    else
    pub 2: return boundary /,
    }
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_tstamp(substream: *mut snd_pcm_substream, _arg: *mut int __user) -> c_int {
    ...
    pub -EFAULT: return,
    if (substream.stream == SNDRV_PCM_STREAM_PLAYBACK)
    pub xferi.frames): result = snd_pcm_lib_write(substream, xferi.buf,,
    else
    pub xferi.frames): result = snd_pcm_lib_read(substream, xferi.buf,,
    if (put_user(result, &_xferi.result))
    pub -EFAULT: return,
    pub 0: return result < 0 ? result :,
    }
    ...
    pub xfern: snd_xfern,
    pub substream->runtime: *mut *mut snd_pcm_runtime runtime =,
    pub NULL: *mut *mut void bufs __free(kfree) =,
    pub result: snd_pcm_sframes_t,
    if (snd_pcm_get_state(substream) == SNDRV_PCM_STATE_OPEN)
    pub -EBADFD: return,
    ...
    pub -EFAULT: return,
    pub )): *mut bufs = memdup_array_user(xfern.bufs, runtime->channels, sizeof(void,
    if (IS_ERR(bufs))
    pub PTR_ERR(bufs): return,
    if (substream.stream == SNDRV_PCM_STREAM_PLAYBACK)
    pub xfern.frames): result = snd_pcm_lib_writev(substream, bufs,,
    else
    pub xfern.frames): result = snd_pcm_lib_readv(substream, bufs,,
    ...
    pub -EFAULT: return,
    pub frames): result = snd_pcm_rewind(substream,,
    ...
    if (put_user(0, _frames))
    pub -EFAULT: return,
    pub frames): result = snd_pcm_forward(substream,,
    if (put_user(result, _frames))
    pub -EFAULT: return,
    pub 0: return result < 0 ? result :,
    }
    ...
    {
    pub file->private_data: *mut *mut snd_pcm_file pcm_file =,
    pub res: c_int,
    if (PCM_RUNTIME_CHECK(substream))
    pub -ENXIO: return,
    if (snd_pcm_get_state(substream) == SNDRV_PCM_STATE_DISCONNECTED)
    pub -EBADFD: return,
    pub snd_power_wait(substream->pcm->card): res =,
    if (res < 0)
    pub res: return,
    switch (cmd) {
    case SNDRV_PCM_IOCTL_PVERSION:
    pub 0: *mut *mut return put_user(SNDRV_PCM_VERSION, (int __user )arg) ? -EFAULT :,
    case SNDRV_PCM_IOCTL_INFO:
    pub arg): return snd_pcm_info_user(substream,,
    case SNDRV_PCM_IOCTL_TSTAMP:	/* just for compatibility */
    pub 0: return,
    case SNDRV_PCM_IOCTL_TTSTAMP:
    pub arg): return snd_pcm_tstamp(substream,,
    ...
    pub arg): return snd_pcm_hw_refine_user(substream,,
    case SNDRV_PCM_IOCTL_HW_PARAMS:
    pub arg): return snd_pcm_hw_params_user(substream,,
    case SNDRV_PCM_IOCTL_HW_FREE:
    pub snd_pcm_hw_free(substream): return,
    case SNDRV_PCM_IOCTL_SW_PARAMS:
    pub arg): return snd_pcm_sw_params_user(substream,,
    case SNDRV_PCM_IOCTL_STATUS32:
    pub false): return snd_pcm_status_user32(substream, arg,,
    case SNDRV_PCM_IOCTL_STATUS_EXT32:
    pub true): return snd_pcm_status_user32(substream, arg,,
    case SNDRV_PCM_IOCTL_STATUS64:
    pub false): return snd_pcm_status_user64(substream, arg,,
    case SNDRV_PCM_IOCTL_STATUS_EXT64:
    pub true): return snd_pcm_status_user64(substream, arg,,
    case SNDRV_PCM_IOCTL_CHANNEL_INFO:
    pub arg): return snd_pcm_channel_info_user(substream,,
    case SNDRV_PCM_IOCTL_PREPARE:
    pub file): return snd_pcm_prepare(substream,,
    case SNDRV_PCM_IOCTL_RESET:
    pub snd_pcm_reset(substream): return,
    case SNDRV_PCM_IOCTL_START:
    pub snd_pcm_start_lock_irq(substream): return,
    case SNDRV_PCM_IOCTL_LINK:
    pub arg): return snd_pcm_link(substream, (int)(unsigned long),
    case SNDRV_PCM_IOCTL_UNLINK:
    pub snd_pcm_unlink(substream): return,
    case SNDRV_PCM_IOCTL_RESUME:
    pub snd_pcm_resume(substream): return,
    case SNDRV_PCM_IOCTL_XRUN:
    pub snd_pcm_xrun(substream): return,
    case SNDRV_PCM_IOCTL_HWSYNC:
    pub snd_pcm_hwsync(substream): return,
    case SNDRV_PCM_IOCTL_DELAY:
    {
    pub 0: snd_pcm_sframes_t delay =,
    pub arg: *mut *mut snd_pcm_sframes_t __user res =,
    pub err: c_int,
    pub &delay): err = snd_pcm_delay(substream,,
    if (err)
    pub err: return,
    ...
    pub arg): return snd_pcm_ioctl_sync_ptr_compat(substream,,
    case __SNDRV_PCM_IOCTL_SYNC_PTR64:
    pub arg): return snd_pcm_sync_ptr(substream,,

    case SNDRV_PCM_IOCTL_HW_REFINE_OLD:
    pub arg): return snd_pcm_hw_refine_old_user(substream,,
    case SNDRV_PCM_IOCTL_HW_PARAMS_OLD:
    pub arg): return snd_pcm_hw_params_old_user(substream,,

    case SNDRV_PCM_IOCTL_DRAIN:
    pub file): return snd_pcm_drain(substream,,
    case SNDRV_PCM_IOCTL_DROP:
    pub snd_pcm_drop(substream): return,
    case SNDRV_PCM_IOCTL_PAUSE:
    pub long)arg): return snd_pcm_pause_lock_irq(substream, (unsigned,
    case SNDRV_PCM_IOCTL_WRITEI_FRAMES:
    case SNDRV_PCM_IOCTL_READI_FRAMES:
    pub arg): return snd_pcm_xferi_frames_ioctl(substream,,
    case SNDRV_PCM_IOCTL_WRITEN_FRAMES:
    case SNDRV_PCM_IOCTL_READN_FRAMES:
    pub arg): return snd_pcm_xfern_frames_ioctl(substream,,
    case SNDRV_PCM_IOCTL_REWIND:
    pub arg): return snd_pcm_rewind_ioctl(substream,,
    case SNDRV_PCM_IOCTL_FORWARD:
    pub arg): return snd_pcm_forward_ioctl(substream,,
    }
    pub cmd): pcm_dbg(substream->pcm, "unknown ioctl = 0x%x\n",,
    pub -ENOTTY: return,
    }
    static long snd_pcm_ioctl(struct file *file, unsigned int cmd,
    unsigned long arg)
    {
    pub pcm_file: *mut snd_pcm_file,
    pub file->private_data: pcm_file =,
    if (((cmd >> 8) & 0xff) != 'A')
    pub -ENOTTY: return,
...
//
    ...
    {
    pub arg: *mut *mut snd_pcm_uframes_t frames =,
    pub result: snd_pcm_sframes_t,
    if (snd_pcm_get_state(substream) == SNDRV_PCM_STATE_DISCONNECTED)
    pub -EBADFD: return,
    switch (cmd) {
...
// provided only for OSS; capture-only and no value returned
    if (substream.stream != SNDRV_PCM_STREAM_CAPTURE)
    pub -EINVAL: return,
    pub frames): *mut result = snd_pcm_forward(substream,,
    pub 0: return result < 0 ? result :,
    }
    case SNDRV_PCM_IOCTL_HW_PARAMS:
    pub arg): return snd_pcm_hw_params(substream,,
    case SNDRV_PCM_IOCTL_SW_PARAMS:
    pub arg): return snd_pcm_sw_params(substream,,
    case SNDRV_PCM_IOCTL_PREPARE:
    pub NULL): return snd_pcm_prepare(substream,,
    case SNDRV_PCM_IOCTL_START:
    pub snd_pcm_start_lock_irq(substream): return,
    case SNDRV_PCM_IOCTL_DRAIN:
    pub NULL): return snd_pcm_drain(substream,,
    case SNDRV_PCM_IOCTL_DROP:
    pub snd_pcm_drop(substream): return,
    case SNDRV_PCM_IOCTL_DELAY:
    pub frames): return snd_pcm_delay(substream,,
    default:
    pub -EINVAL: return,
    }
    }
    ...
    pub result: snd_pcm_sframes_t,
    pub file->private_data: pcm_file =,
    pub pcm_file->substream: substream =,
    if (PCM_RUNTIME_CHECK(substream))
    pub -ENXIO: return,
    pub substream->runtime: runtime =,
    if (snd_pcm_state_open_or_disconnected(substream))
    pub -EBADFD: return,
    if (!frame_aligned(runtime, count))
    pub -EINVAL: return,
    pub count): count = bytes_to_frames(runtime,,
    pub count): result = snd_pcm_lib_read(substream, buf,,
    if (result > 0)
    pub result): result = frames_to_bytes(runtime,,
    pub result: return,
    }
    ...
    pub -EINVAL: return,
    pub count): count = bytes_to_frames(runtime,,
    pub count): result = snd_pcm_lib_write(substream, buf,,
    if (result > 0)
    pub result): result = frames_to_bytes(runtime,,
    pub result: return,
    }
#[no_mangle]
unsafe extern "C" fn snd_pcm_readv(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    ...
    pub i: c_ulong,
    pub frames: snd_pcm_uframes_t,
    pub iter_iov(to): *const *const iovec iov =,
    pub iocb->ki_filp->private_data: pcm_file =,
    pub pcm_file->substream: substream =,
    if (PCM_RUNTIME_CHECK(substream))
    pub -ENXIO: return,
    pub substream->runtime: runtime =,
    ...
    pub -EINVAL: return,
    pub iov->iov_len): frames = bytes_to_samples(runtime,,
    void __user **bufs __free(kfree) =
    pub GFP_KERNEL): *mut *mut kmalloc_array(to->nr_segs, sizeof(void ),,
    if (bufs == core::ptr::null_mut())
    pub -ENOMEM: return,
    pub {: for (i = 0; i < to->nr_segs; ++i),
    pub iov->iov_base: bufs[i] =,
    }
    pub frames): result = snd_pcm_lib_readv(substream, bufs,,
    if (result > 0)
    pub result): result = frames_to_bytes(runtime,,
    pub result: return,
    }
#[no_mangle]
unsafe extern "C" fn snd_pcm_writev(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
    ...
    pub i: c_ulong,
    pub frames: snd_pcm_uframes_t,
    pub iter_iov(from): *const *const iovec iov =,
    pub iocb->ki_filp->private_data: pcm_file =,
    pub pcm_file->substream: substream =,
    if (PCM_RUNTIME_CHECK(substream))
    pub -ENXIO: return,
    ...
    pub iov->iov_len): frames = bytes_to_samples(runtime,,
    void __user **bufs __free(kfree) =
    pub GFP_KERNEL): *mut *mut kmalloc_array(from->nr_segs, sizeof(void ),,
    if (bufs == core::ptr::null_mut())
    pub -ENOMEM: return,
    pub {: for (i = 0; i < from->nr_segs; ++i),
    pub iov->iov_base: bufs[i] =,
    }
    pub frames): result = snd_pcm_lib_writev(substream, bufs,,
    if (result > 0)
    pub result): result = frames_to_bytes(runtime,,
    pub result: return,
    }
#[no_mangle]
unsafe extern "C" fn snd_pcm_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
    static __poll_t snd_pcm_poll(struct file *file, poll_table *wait)
    {
    pub pcm_file: *mut snd_pcm_file,
    pub substream: *mut snd_pcm_substream,
    pub runtime: *mut snd_pcm_runtime,
    pub ok: __poll_t mask,,
    pub avail: snd_pcm_uframes_t,
    pub file->private_data: pcm_file =,
    pub pcm_file->substream: substream =,
    if (substream.stream == SNDRV_PCM_STREAM_PLAYBACK)
    pub EPOLLWRNORM: ok = EPOLLOUT |,
    else
    pub EPOLLRDNORM: ok = EPOLLIN |,
    if (PCM_RUNTIME_CHECK(substream))
    pub EPOLLERR: return ok |,
    pub substream->runtime: runtime =,
    if (runtime.state == SNDRV_PCM_STATE_DISCONNECTED)
    pub EPOLLERR: return ok |,
    pub wait): poll_wait(file, &runtime->sleep,,
    pub 0: mask =,
    pub snd_pcm_avail(substream): avail =,
    switch (runtime.state) {
    case SNDRV_PCM_STATE_RUNNING:
    case SNDRV_PCM_STATE_PREPARED:
    case SNDRV_PCM_STATE_PAUSED:
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_mmap_status_fault(vmf: *mut vm_fault) -> vm_fault_t {
    static vm_fault_t snd_pcm_mmap_status_fault(struct vm_fault *vmf)
    {
    pub vmf->vma->vm_private_data: *mut *mut snd_pcm_substream substream =,
    pub runtime: *mut snd_pcm_runtime,
    if (substream == core::ptr::null_mut())
    pub VM_FAULT_SIGBUS: return,
    pub substream->runtime: runtime =,
    pub virt_to_page(runtime->status): vmf->page =,
    pub 0: return,
    }
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_mmap_control_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn pcm_status_mmap_allowed(pcm_file: *mut snd_pcm_file) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pcm_control_mmap_allowed(pcm_file: *mut snd_pcm_file) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_mmap_data_open(area: *mut vm_area_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_mmap_data_close(area: *mut vm_area_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_pcm_mmap_data_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !snd_pcm_get_dma_buf(substream)) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_mmap(file: *mut file, area: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_pcm_fasync(fd: c_int, file: *mut *mut file, on: c_int) -> c_int {
...
//
    ...
    struct snd_pcm_runtime *runtime = substream.runtime;
    let mut offset: c_ulong = pgoff << PAGE_SHIFT;
    switch (offset) {
    case SNDRV_PCM_MMAP_OFFSET_STATUS_NEW:
