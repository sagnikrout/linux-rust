...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rate_channel {
    pub last_S1: signed short,
    pub last_S2: signed short,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rate_priv {
    pub pitch: c_uint,
    pub pos: c_uint,
    pub func: rate_f,
    pub old_dst_frames: snd_pcm_sframes_t old_src_frames,,
    pub channels: [rate_channel; ],
}
...
unsafe extern "C" fn rate_init(plugin: *mut snd_pcm_plugin) {
    ...
    val = -32768;
#[no_mangle]
pub unsafe extern "C" fn if(32767: val >) -> else {
    else if (val > 32767)
    val = 32767;
// dst = val;
    dst += dst_step;
...
#[no_mangle]
unsafe extern "C" fn rate_src_frames(plugin: *mut snd_pcm_plugin, frames: snd_pcm_uframes_t) -> snd_pcm_sframes_t {
    ...
    let mut frames1: snd_pcm_sframes_t = frames, res1 = data.old_dst_frames;
...
#[no_mangle]
unsafe extern "C" fn rate_dst_frames(plugin: *mut snd_pcm_plugin, frames: snd_pcm_uframes_t) -> snd_pcm_sframes_t {
    ...
    let mut frames1: snd_pcm_sframes_t = frames, res1 = data.old_src_frames;
