...
//! Source: sound/core/oss/mixer_oss.c
#![no_std]
...
unsafe extern "C" fn snd_mixer_oss_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    return -ENODEV;
    if (card.mixer_oss == core::ptr::null_mut()) {
    snd_card_unref(card);
    return -ENODEV;
    }
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_caps(fmixer: *mut snd_mixer_oss_file) -> c_int {
    static int snd_mixer_oss_caps(struct snd_mixer_oss_file *fmixer)
    {
    struct snd_mixer_oss *mixer = fmixer.mixer;
    let mut result: c_int = 0;
    if (mixer == core::ptr::null_mut())
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_devmask(fmixer: *mut snd_mixer_oss_file) -> c_int {
    static int snd_mixer_oss_devmask(struct snd_mixer_oss_file *fmixer)
    {
    struct snd_mixer_oss *mixer = fmixer.mixer;
    struct snd_mixer_oss_slot *pslot;
    let mut result: c_int = 0, chn;
    if (mixer == core::ptr::null_mut())
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_stereodevs(fmixer: *mut snd_mixer_oss_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_recmask(fmixer: *mut snd_mixer_oss_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_get_recsrc(fmixer: *mut snd_mixer_oss_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_set_recsrc(fmixer: *mut snd_mixer_oss_file, recsrc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_get_volume(fmixer: *mut snd_mixer_oss_file, slot: c_int) -> c_int {
    static int snd_mixer_oss_get_volume(struct snd_mixer_oss_file *fmixer, int slot)
    {
    struct snd_mixer_oss *mixer = fmixer.mixer;
    struct snd_mixer_oss_slot *pslot;
    let mut result: c_int = 0, left, right;
    if (mixer == core::ptr::null_mut() || slot > 30)
    return -EIO;
    guard(mutex)(&mixer.reg_mutex);
    ...
    struct snd_mixer_oss *mixer = fmixer.mixer;
    struct snd_mixer_oss_slot *pslot;
    let mut result: c_int = 0, left = volume & 0xff, right = (volume >> 8) & 0xff;
    if (mixer == core::ptr::null_mut() || slot > 30)
    return -EIO;
    guard(mutex)(&mixer.reg_mutex);
    pslot = &mixer.slots[slot];
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_ioctl1(fmixer: *mut snd_mixer_oss_file, cmd: c_uint, arg: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_conv(val: c_long, omin: c_long, omax: c_long, nmin: c_long, nmax: c_long) -> c_long {
    static long snd_mixer_oss_conv(long val, long omin, long omax, long nmin, long nmax)
    {
    let mut orange: c_long = omax - omin, nrange = nmax - nmin;
    if (orange == 0)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_conv1(val: c_long, min: c_long, max: c_long, old: *mut c_int) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_conv2(val: c_long, min: c_long, max: c_long) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_recsrce_set(card: *mut snd_card, slot: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_recsrce_get(card: *mut snd_card, slot: c_int) -> c_int {
...
pub const SNDRV_MIXER_OSS_SIGNATURE: c_uint = 0x65999250;
pub const SNDRV_MIXER_OSS_ITEM_GLOBAL: c_int = 0;
pub const SNDRV_MIXER_OSS_ITEM_GSWITCH: c_int = 1;
pub const SNDRV_MIXER_OSS_ITEM_GROUTE: c_int = 2;
pub const SNDRV_MIXER_OSS_ITEM_GVOLUME: c_int = 3;
pub const SNDRV_MIXER_OSS_ITEM_PSWITCH: c_int = 4;
pub const SNDRV_MIXER_OSS_ITEM_PROUTE: c_int = 5;
pub const SNDRV_MIXER_OSS_ITEM_PVOLUME: c_int = 6;
pub const SNDRV_MIXER_OSS_ITEM_CSWITCH: c_int = 7;
pub const SNDRV_MIXER_OSS_ITEM_CROUTE: c_int = 8;
pub const SNDRV_MIXER_OSS_ITEM_CVOLUME: c_int = 9;
pub const SNDRV_MIXER_OSS_ITEM_CAPTURE: c_int = 10;
pub const SNDRV_MIXER_OSS_ITEM_COUNT: c_int = 11;
...
pub struct slot {
    ...
    kzalloc_obj(*uctl);
    if (uinfo == core::ptr::null_mut() || uctl == core::ptr::null_mut())
    return;
...
unsafe extern "C" fn snd_mixer_oss_put_recsrc2(fmixer: *mut snd_mixer_oss_file, active_index: c_uint) -> c_int {
    ...
    struct snd_kcontrol *kctl;
    struct snd_mixer_oss_slot *pslot;
    struct slot *slot = core::ptr::null_mut();
    int err;
    unsigned int idx;
    struct snd_ctl_elem_info *uinfo __free(kfree) =
    kzalloc_obj(*uinfo);
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_build_test(mixer: *mut snd_mixer_oss, slot: *mut slot, name: *const c_char, index: c_int, item: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixer_slot_clear(rslot: *mut snd_mixer_oss_slot) {
...
// check if already assigned
    ...
    str = "Mix";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, Mono"): "Master) -> else {
...
// remove the entry
    ...
    idx = simple_strtoul(idxstr, core::ptr::null_mut(), 10);
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_proc_init(mixer: *mut snd_mixer_oss) {
...
#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_proc_done(mixer: *mut snd_mixer_oss) {
    static void snd_mixer_oss_proc_done(struct snd_mixer_oss *mixer)
    {
    snd_info_free_entry(mixer.proc_entry);
    mixer.proc_entry = core::ptr::null_mut();
    }

// Macro flag: #define snd_mixer_oss_proc_init(mix)
// Macro flag: #define snd_mixer_oss_proc_done(mix)

#[no_mangle]
unsafe extern "C" fn snd_mixer_oss_build(mixer: *mut snd_mixer_oss) {
...
unsafe extern "C" fn snd_mixer_oss_free1(private: *mut c_void) -> c_int {
    ...
    return -ENXIO;
    card.mixer_oss = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn alsa_mixer_oss_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alsa_mixer_oss_exit() -> void __exit {
    static void __exit alsa_mixer_oss_exit(void)
    {
    struct snd_card *card;
    int idx;
    snd_mixer_oss_notify_callback = core::ptr::null_mut();
    for (idx = 0; idx < SNDRV_CARDS; idx++) {
    card = snd_card_ref(idx);
    if (card) {
