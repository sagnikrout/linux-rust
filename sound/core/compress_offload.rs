...
//! Source: sound/core/compress_offload.c
#![no_std]
...
// Macro flag: #define COMPR_CODEC_CAPS_OVERFLOW
...
#[no_mangle]
pub unsafe extern "C" fn if(O_RDONLY: (f->f_flags & O_ACCMODE) ==) -> else {
    else if ((f.f_flags & O_ACCMODE) == O_RDONLY)
    dirn = SND_COMPRESS_CAPTURE;
#[no_mangle]
pub unsafe extern "C" fn if(O_RDWR: (f->f_flags & O_ACCMODE) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_free(inode: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_compr_get_avail(stream: *mut snd_compr_stream) -> usize {
    ...
    let mut copy_size: usize = sizeof(ioctl_avail64);
...
// calculate how much we can write to buffer
    ...
    avail = count;
    if (stream.ops.copy) {
    let mut cbuf: *mut char __user = (char __user*)buf;
...
#[no_mangle]
unsafe extern "C" fn snd_compr_mmap(f: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int snd_compr_mmap(struct file *f, struct vm_area_struct *vma)
    {
    return -ENXIO;
    }
#[no_mangle]
unsafe extern "C" fn snd_compr_get_poll(stream: *mut snd_compr_stream) -> __poll_t {
...
#[no_mangle]
pub unsafe extern "C" fn snd_compr_malloc_pages(stream: *mut snd_compr_stream, size: usize) -> c_int {
...
pub unsafe extern "C" fn snd_compr_free_pages(stream: *mut snd_compr_stream) -> c_int {
    ...
    return -EINVAL;
    runtime = stream.runtime;
    if (runtime.dma_area == core::ptr::null_mut())
    return 0;
...
// It's a newly allocated buffer. Release it now.
    ...
    snd_compr_set_runtime_buffer(stream, core::ptr::null_mut());
    return 0;
    }
...
//
    ...
    unsigned long arg, bool is_32bit)
    {
    let mut tstamp64: snd_compr_tstamp64 = { 0 };
    let mut tstamp32: snd_compr_tstamp = { 0 };
    const void *copy_from = &tstamp64;
    let mut copy_size: usize = sizeof(tstamp64);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn snd_compr_pause(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_resume(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_start(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_stop(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compress_wait_for_drain(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_drain(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_next_track(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_partial_drain(stream: *mut snd_compr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_task_free(task: *mut snd_compr_task_runtime) {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_seqno_next(stream: *mut snd_compr_stream) -> u64 {
    static u64 snd_compr_seqno_next(struct snd_compr_stream *stream)
    {
    let mut seqno: u64 = ++stream.runtime.task_seqno;
    if (seqno == 0)
    seqno = ++stream.runtime.task_seqno;
    return seqno;
    }
#[no_mangle]
unsafe extern "C" fn snd_compr_task_new(stream: *mut snd_compr_stream, utask: *mut snd_compr_task) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_task_create(stream: *mut snd_compr_stream, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_task_start(stream: *mut snd_compr_stream, utask: *mut snd_compr_task) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_task_start_ioctl(stream: *mut snd_compr_stream, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_task_free_all(stream: *mut snd_compr_stream) {
    static void snd_compr_task_free_all(struct snd_compr_stream *stream)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_compr_task_status_ioctl(stream: *mut snd_compr_stream, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compress_proc_init(compr: *mut snd_compr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_compress_proc_done(compr: *mut snd_compr) {
    static void snd_compress_proc_done(struct snd_compr *compr)
    {
    snd_info_free_entry(compr.proc_info_entry);
    compr.proc_info_entry = core::ptr::null_mut();
    snd_info_free_entry(compr.proc_root);
    compr.proc_root = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn snd_compress_set_id(compr: *mut snd_compr, id: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_compress_proc_init(compr: *mut snd_compr) -> c_int {
    static inline int snd_compress_proc_init(struct snd_compr *compr)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn snd_compress_proc_done(compr: *mut snd_compr) {
