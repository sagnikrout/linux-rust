...
//! Source: sound/core/sound_kunit.c
#![no_std]
...
pub const SILENCE_BUFFER_MAX_FRAMES: c_int = 260;
...
unsafe extern "C" fn test_format_endianness(test: *mut kunit) {
    ...
    {
    let mut sample_bytes: usize = data.physical_bits >> 3;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn calculate_boundary(buffer_size: snd_pcm_uframes_t) -> snd_pcm_uframes_t {
