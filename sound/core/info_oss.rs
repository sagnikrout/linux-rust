...
#[no_mangle]
pub unsafe extern "C" fn snd_oss_info_register(dev: c_int, num: c_int, string: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_sndstat_show_strings(buf: *mut snd_info_buffer, id: *mut c_char, dev: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_info_minor_register() -> int __init {
