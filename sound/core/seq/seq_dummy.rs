...
//! Source: sound/core/seq/seq_dummy.c
#![no_std]
...
pub struct snd_seq_dummy_port {
    ...
    let mut __ro_after_init: static int my_client = -1;
//
...
// create client
    my_client = snd_seq_create_kernel_client(core::ptr::null_mut(), SNDRV_SEQ_CLIENT_DUMMY,
    "Midi Through");
    if (my_client < 0)
    return my_client;
...
//
#[no_mangle]
unsafe extern "C" fn alsa_seq_dummy_init() -> int __init {
    static int __init alsa_seq_dummy_init(void)
    {
    return register_client();
    }
#[no_mangle]
unsafe extern "C" fn alsa_seq_dummy_exit() -> void __exit {
