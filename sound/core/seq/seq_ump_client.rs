...
//! Source: sound/core/seq/seq_ump_client.c
#![no_std]
...
pub struct seq_ump_input_buffer {
    pub /: *mut *mut unsigned char len; / total length in words,
    pub /: *mut *mut unsigned char pending; / pending words,
    pub /: *mut *mut unsigned char type; / parsed UMP packet type,
    pub /: *mut *mut unsigned char group; / parsed UMP packet group,
    pub /: *mut *mut u32 buf[4]; / incoming UMP packet,
}
...
pub struct seq_ump_client {
    pub /: *mut *mut *mut snd_ump_endpoint ump; / assigned endpoint,
    pub /: *mut *mut int seq_client; / sequencer client id,
    pub /: *mut *mut int opened[2]; / current opens for each direction,
    pub /: *mut *mut snd_rawmidi_file out_rfile; / rawmidi for output,
...
//
    pub out_substream: *mut snd_rawmidi_substream __rcu,
    pub /: *mut *mut seq_ump_input_buffer input; / input parser context,
    pub /: *mut *mut *mut void ump_info[SNDRV_UMP_MAX_BLOCKS + 1]; / shadow of seq client ump_info,
    pub /: *mut *mut work_group_notify_work; / FB change notification,
}
...
//
#[no_mangle]
unsafe extern "C" fn ump_group_to_seq_port(group: c_uchar) -> c_uchar {
...
// open the rawmidi
#[no_mangle]
unsafe extern "C" fn seq_ump_client_open(client: *mut seq_ump_client, dir: c_int) -> c_int {
...
// close the rawmidi
#[no_mangle]
unsafe extern "C" fn seq_ump_client_close(client: *mut seq_ump_client, dir: c_int) -> c_int {
    ...
    rcu_assign_pointer(client.out_substream, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn seq_ump_subscribe(pdata: *mut c_void, info: *mut snd_seq_port_subscribe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ump_unsubscribe(pdata: *mut c_void, info: *mut snd_seq_port_subscribe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ump_use(pdata: *mut c_void, info: *mut snd_seq_port_subscribe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ump_unuse(pdata: *mut c_void, info: *mut snd_seq_port_subscribe) -> c_int {
...
// fill port_info from the given UMP EP and group info
    ...
    {
    let mut rawmidi_info: c_uint = client.ump.core.info_flags;
...
#[no_mangle]
unsafe extern "C" fn skip_group(client: *mut seq_ump_client, group: *mut snd_ump_group) -> bool {
...
#[no_mangle]
unsafe extern "C" fn seq_ump_group_init(client: *mut seq_ump_client, group_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_port_infos(client: *mut seq_ump_client) {
...
#[no_mangle]
unsafe extern "C" fn create_ump_endpoint_port(client: *mut seq_ump_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ump_client_free(client: *mut seq_ump_client) {
    static void seq_ump_client_free(struct seq_ump_client *client)
    {
    cancel_work_sync(&client.group_notify_work);
    if (client.seq_client >= 0)
    snd_seq_delete_kernel_client(client.seq_client);
    client.ump.seq_ops = core::ptr::null_mut();
    client.ump.seq_client = core::ptr::null_mut();
    kfree(client);
    }
// update the MIDI version for the given client
#[no_mangle]
unsafe extern "C" fn setup_client_midi_version(client: *mut seq_ump_client) {
...
#[no_mangle]
unsafe extern "C" fn setup_client_group_filter(client: *mut seq_ump_client) {
