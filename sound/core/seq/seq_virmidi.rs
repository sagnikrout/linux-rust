...
//! Source: sound/core/seq/seq_virmidi.c
#![no_std]
...
// exported
#[no_mangle]
pub unsafe extern "C" fn snd_virmidi_new(card: *mut snd_card, device: c_int, rrmidi: *mut snd_rawmidi) -> c_int {
