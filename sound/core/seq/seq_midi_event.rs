...
//! Source: sound/core/seq/seq_midi_event.c
#![no_std]
...
pub const ST_INVALID: c_int = 7;
pub const ST_SPECIAL: c_int = 8;
...
// invalid
    {SNDRV_SEQ_EVENT_NONE,		-1, core::ptr::null_mut(), core::ptr::null_mut()},
// 0xf0 - 0xff
    {SNDRV_SEQ_EVENT_SYSEX,		 1, core::ptr::null_mut(), core::ptr::null_mut()}, /* sysex: 0xf0 */
    ...
    {SNDRV_SEQ_EVENT_NONE,		-1, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xf4 */
    {SNDRV_SEQ_EVENT_NONE,		-1, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xf5 */
    {SNDRV_SEQ_EVENT_TUNE_REQUEST,	 0, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xf6 */
    {SNDRV_SEQ_EVENT_NONE,		-1, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xf7 */
    {SNDRV_SEQ_EVENT_CLOCK,		 0, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xf8 */
    {SNDRV_SEQ_EVENT_NONE,		-1, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xf9 */
    {SNDRV_SEQ_EVENT_START,		 0, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xfa */
    {SNDRV_SEQ_EVENT_CONTINUE,	 0, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xfb */
    {SNDRV_SEQ_EVENT_STOP, 		 0, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xfc */
    {SNDRV_SEQ_EVENT_NONE, 		-1, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xfd */
    {SNDRV_SEQ_EVENT_SENSING, 	 0, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xfe */
    {SNDRV_SEQ_EVENT_RESET, 	 0, core::ptr::null_mut(), core::ptr::null_mut()}, /* 0xff */
    };
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_midi_event_new(bufsize: c_int, rdev: *mut snd_midi_event) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_encode(dev: *mut snd_midi_event) {
...
// encode note event
#[no_mangle]
unsafe extern "C" fn note_event(dev: *mut snd_midi_event, ev: *mut snd_seq_event) {
    static void note_event(struct snd_midi_event *dev, struct snd_seq_event *ev)
    {
...
#[no_mangle]
unsafe extern "C" fn one_param_ctrl_event(dev: *mut snd_midi_event, ev: *mut snd_seq_event) {
    static void one_param_ctrl_event(struct snd_midi_event *dev, struct snd_seq_event *ev)
    {
...
#[no_mangle]
unsafe extern "C" fn pitchbend_ctrl_event(dev: *mut snd_midi_event, ev: *mut snd_seq_event) {
    static void pitchbend_ctrl_event(struct snd_midi_event *dev, struct snd_seq_event *ev)
    {
    ev.data.control.channel = dev.buf[0] & 0x0f;
...
#[no_mangle]
unsafe extern "C" fn two_param_ctrl_event(dev: *mut snd_midi_event, ev: *mut snd_seq_event) {
    static void two_param_ctrl_event(struct snd_midi_event *dev, struct snd_seq_event *ev)
    {
    ev.data.control.channel = dev.buf[0] & 0x0f;
...
#[no_mangle]
unsafe extern "C" fn one_param_event(dev: *mut snd_midi_event, ev: *mut snd_seq_event) {
    static void one_param_event(struct snd_midi_event *dev, struct snd_seq_event *ev)
    {
    ev.data.control.value = dev.buf[1];
    }
...
#[no_mangle]
unsafe extern "C" fn songpos_event(dev: *mut snd_midi_event, ev: *mut snd_seq_event) {
    static void songpos_event(struct snd_midi_event *dev, struct snd_seq_event *ev)
    {
...
// decode note event
#[no_mangle]
unsafe extern "C" fn note_decode(ev: *mut snd_seq_event, buf: *mut c_uchar) {
    static void note_decode(struct snd_seq_event *ev, unsigned char *buf)
    {
...
#[no_mangle]
unsafe extern "C" fn one_param_decode(ev: *mut snd_seq_event, buf: *mut c_uchar) {
    static void one_param_decode(struct snd_seq_event *ev, unsigned char *buf)
    {
...
#[no_mangle]
unsafe extern "C" fn pitchbend_decode(ev: *mut snd_seq_event, buf: *mut c_uchar) {
    static void pitchbend_decode(struct snd_seq_event *ev, unsigned char *buf)
    {
    let mut value: c_int = ev.data.control.value + 8192;
    buf[0] = value & 0x7f;
    buf[1] = (value >> 7) & 0x7f;
    }
// decode midi control change
#[no_mangle]
unsafe extern "C" fn two_param_decode(ev: *mut snd_seq_event, buf: *mut c_uchar) {
    static void two_param_decode(struct snd_seq_event *ev, unsigned char *buf)
    {
...
#[no_mangle]
unsafe extern "C" fn songpos_decode(ev: *mut snd_seq_event, buf: *mut c_uchar) {
    static void songpos_decode(struct snd_seq_event *ev, unsigned char *buf)
    {
    buf[0] = ev.data.control.value & 0x7f;
