...
//
    ...
    module_param_array(midi_map, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(midi_map, "Raw MIDI device number assigned to 1st OSS device.");
    module_param_array(amidi_map, int, core::ptr::null_mut(), 0444);
...
pub struct snd_rawmidi_status32 {
    pub stream: i32,
    pub /: *mut *mut s32 tstamp_sec; / Timestamp,
    pub tstamp_nsec: i32,
    pub /: *mut *mut u32 avail; / available bytes,
    pub /: *mut *mut u32 xruns; / count of overruns since last status (in bytes),
...
pub struct snd_rawmidi_status64 {
    ...
    pub /: *mut *mut s64 tstamp_sec; / Timestamp,
    pub tstamp_nsec: i64,
...
#[no_mangle]
pub unsafe extern "C" fn snd_rawmidi_file_flags(file: *mut file) -> c_ushort {
...
#[no_mangle]
pub unsafe extern "C" fn __snd_rawmidi_ready(runtime: *mut snd_rawmidi_runtime) -> bool {
    static inline bool __snd_rawmidi_ready(struct snd_rawmidi_runtime *runtime)
    {
    return runtime.avail >= runtime.avail_min;
    }
#[no_mangle]
unsafe extern "C" fn snd_rawmidi_ready(substream: *mut snd_rawmidi_substream) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn snd_rawmidi_buffer_ref(runtime: *mut snd_rawmidi_runtime) {
    static inline void snd_rawmidi_buffer_ref(struct snd_rawmidi_runtime *runtime)
    {
    runtime.buffer_ref++;
    }
#[no_mangle]
pub unsafe extern "C" fn snd_rawmidi_buffer_unref(runtime: *mut snd_rawmidi_runtime) {
    static inline void snd_rawmidi_buffer_unref(struct snd_rawmidi_runtime *runtime)
    {
    runtime.buffer_ref--;
    }
#[no_mangle]
unsafe extern "C" fn snd_rawmidi_buffer_ref_sync(substream: *mut snd_rawmidi_substream) {
    static void snd_rawmidi_buffer_ref_sync(struct snd_rawmidi_substream *substream)
    {
    let mut loop: c_int = HZ;
...
#[no_mangle]
unsafe extern "C" fn snd_rawmidi_runtime_create(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    runtime.event = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn get_align(runtime: *mut snd_rawmidi_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_rawmidi_runtime_free(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_rawmidi_output_trigger(substream: *mut snd_rawmidi_substream, up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_rawmidi_input_trigger(substream: *mut snd_rawmidi_substream, up: c_int) {
...
// open and do ref-counting for the given substream
    ...
    {
    struct snd_rawmidi_substream *sinput = core::ptr::null_mut(), *soutput = core::ptr::null_mut();
    int err;
    rfile.input = rfile.output = core::ptr::null_mut();
...
unsafe extern "C" fn snd_rawmidi_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    {
    let mut maj: c_int = imajor(inode);
    struct snd_card *card;
    int subdevice;
    unsigned short fflags;
    int err;
    struct snd_rawmidi *rmidi;
    struct snd_rawmidi_file *rawmidi_file = core::ptr::null_mut();
    ...
    if (rawmidi_file == core::ptr::null_mut()) {
    err = -ENOMEM;
    goto __error;
    }
...
//
    ...
    substream.pid = core::ptr::null_mut();
    rmidi.streams[substream.stream].substream_opened--;
    }
#[no_mangle]
unsafe extern "C" fn rawmidi_release_priv(rfile: *mut snd_rawmidi_file) {
    ...
    rfile.input = core::ptr::null_mut();
    }
    if (rfile.output) {
    close_substream(rmidi, rfile.output, 1);
    rfile.output = core::ptr::null_mut();
    }
    rfile.rmidi = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn snd_rawmidi_release(inode: *mut inode, file: *mut file) -> c_int {
...
pub unsafe extern "C" fn snd_rawmidi_info_select(card: *mut snd_card, info: *mut snd_rawmidi_info) -> c_int {
    ...
    struct snd_rawmidi_runtime *runtime = substream.runtime;
    char *newbuf, *oldbuf;
    let mut framing: c_uint = params.mode & SNDRV_RAWMIDI_MODE_FRAMING_MASK;
    ...
    {
    let mut framing: c_uint = params.mode & SNDRV_RAWMIDI_MODE_FRAMING_MASK;
    let mut clock_type: c_uint = params.mode & SNDRV_RAWMIDI_MODE_CLOCK_MASK;
    int err;
    ...
    err = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(SNDRV_RAWMIDI_MODE_CLOCK_MONOTONIC_RAW: clock_type >) -> else {
    else if (clock_type > SNDRV_RAWMIDI_MODE_CLOCK_MONOTONIC_RAW)
    err = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(SNDRV_RAWMIDI_MODE_FRAMING_TSTAMP: framing >) -> else {
    ...
    if (rfile.output == core::ptr::null_mut())
    return -EINVAL;
    err = snd_rawmidi_output_status(rfile.output, &status64);
    break;
    case SNDRV_RAWMIDI_STREAM_INPUT:
    if (rfile.input == core::ptr::null_mut())
    return -EINVAL;
...
// inquiry of UMP endpoint and block info via control API
    ...
    let mut frame: snd_rawmidi_framing_tstamp = { .tv_sec = tstamp.tv_sec, .tv_nsec = tstamp.tv_nsec };
    let mut orig_count: c_int = src_count;
    let mut frame_size: c_int = sizeof(struct snd_rawmidi_framing_tstamp);
    let mut align: c_int = get_align(runtime);
...
#[no_mangle]
unsafe extern "C" fn get_framing_tstamp(substream: *mut snd_rawmidi_substream) -> timespec64 {
    static struct timespec64 get_framing_tstamp(struct snd_rawmidi_substream *substream)
    {
    let mut ts64: timespec64 = {0, 0};
...
//
    ...
    {
    let mut ts64: timespec64 = get_framing_tstamp(substream);
    let mut result: c_int = 0, count1;
    struct snd_rawmidi_runtime *runtime;
    guard(spinlock_irqsave)(&substream.lock);
    if (!substream.opened)
    return -EBADFD;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: __snd_rawmidi_ready(runtime)) -> else {
    ...
    {
    unsigned long flags;
    let mut result: c_long = 0, count1;
    struct snd_rawmidi_runtime *runtime = substream.runtime;
...
// update runtime->appl_ptr before unlocking for userbuf
    ...
    return snd_rawmidi_kernel_read1(substream, core::ptr::null_mut()/*userbuf*/, buf, count);
    }
...
//
    ...
    int result, count1;
    struct snd_rawmidi_runtime *runtime = substream.runtime;
    if (runtime.buffer == core::ptr::null_mut()) {
    rmidi_dbg(substream.rmidi,
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: userbuf) -> else {
    spin_unlock_irqrestore(&substream.lock, flags);
    ...
    {
    return snd_rawmidi_kernel_write1(substream, core::ptr::null_mut(), buf, count);
    }
...
// we cannot put an atomic message to our buffer
    ...
    spin_unlock_irq(&substream.lock);
    count1 = snd_rawmidi_kernel_write1(substream, buf, core::ptr::null_mut(), count);
    if (count1 < 0)
    return result > 0 ? result : count1;
    result += count1;
    buf += count1;
    ...
    wait_queue_entry_t wait;
    let mut last_avail: c_uint = runtime.avail;
    init_waitqueue_entry(&wait, current);
    add_wait_queue(&runtime.sleep, &wait);
    set_current_state(TASK_INTERRUPTIBLE);
    spin_unlock_irq(&substream.lock);
...
#[no_mangle]
unsafe extern "C" fn snd_rawmidi_free_substreams(stream: *mut snd_rawmidi_str) {
...
pub unsafe extern "C" fn snd_rawmidi_free(rmidi: *mut snd_rawmidi) -> c_int {
    ...
    rmidi.proc_entry = core::ptr::null_mut();
...
unsafe extern "C" fn snd_rawmidi_dev_seq_free(device: *mut snd_seq_device) {
    ...
    rmidi.seq_dev = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn alsa_rawmidi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alsa_rawmidi_exit() -> void __exit {
