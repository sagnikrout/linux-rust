...
//! Source: sound/soc/soc-ops-test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct soc_ops_test_priv {
    pub test: *mut kunit,
    pub component: snd_soc_component,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct info_test_param {
    pub name: *const *const c_char,
    pub func_name: *const *const c_char,
    pub layout: enum soc_ops_test_control_layout,
    pub mc: soc_mixer_control,
    pub info): *mut *mut *mut int (info)(struct snd_kcontrol kctl, struct snd_ctl_elem_info,
    pub uinfo: snd_ctl_elem_info,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct access_test_param {
    pub func_name: *const *const c_char,
    pub layout: enum soc_ops_test_control_layout,
    pub mc: soc_mixer_control,
    pub value): *mut *mut *mut int (put)(struct snd_kcontrol kctl, struct snd_ctl_elem_value,
    pub value): *mut *mut *mut int (get)(struct snd_kcontrol kctl, struct snd_ctl_elem_value,
    pub init: c_uint,
    pub lmask: c_uint,
    pub rmask: c_uint,
    pub lreg: c_uint,
