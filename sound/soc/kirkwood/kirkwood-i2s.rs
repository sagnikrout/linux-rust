...
//! Source: sound/soc/kirkwood/kirkwood-i2s.c
#![no_std]
...
//
pub const A38X_PLL_CONF_REG0: c_uint = 0x0;
pub const A38X_PLL_FB_CLK_DIV_OFFSET: c_int = 10;
pub const A38X_PLL_FB_CLK_DIV_MASK: c_uint = 0x7fc00;
pub const A38X_PLL_CONF_REG1: c_uint = 0x4;
pub const A38X_PLL_FREQ_OFFSET_MASK: c_uint = 0xffff;

pub const A38X_PLL_CONF_REG2: c_uint = 0x8;
pub const A38X_PLL_AUDIO_POSTDIV_MASK: c_uint = 0x7f;
...
#[no_mangle]
pub unsafe extern "C" fn armada_38x_set_pll(base: *mut void __iomem, rate: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn kirkwood_set_dco(io: *mut void __iomem, rate: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn kirkwood_i2s_play_mute(ctl: unsigned) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn kirkwood_i2s_init(priv: *mut kirkwood_dma_data) -> c_int {
...
// Set initial pll frequency
    ...
    priv.clk = devm_clk_get(&pdev.dev, np ? "internal" : core::ptr::null_mut());
    if (IS_ERR(priv.clk)) {
