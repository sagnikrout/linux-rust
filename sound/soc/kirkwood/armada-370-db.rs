...
//! Source: sound/soc/kirkwood/armada-370-db.c
#![no_std]
...
//
    ...
    SND_SOC_DAPM_HP("Out Jack", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("In Jack", core::ptr::null_mut()),
    };
    static const struct snd_soc_dapm_route a370db_route[] = {
    { "Out Jack",	core::ptr::null_mut(),	"HPL" },
    { "Out Jack",	core::ptr::null_mut(),	"HPR" },
    { "AIN1L",	core::ptr::null_mut(),	"In Jack" },
    { "AIN1L",	core::ptr::null_mut(),	"In Jack" },
    };
    SND_SOC_DAILINK_DEFS(analog,
    DAILINK_COMP_ARRAY(COMP_CPU("i2s")),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "cs42l51-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    SND_SOC_DAILINK_DEFS(spdif_out,
    DAILINK_COMP_ARRAY(COMP_CPU("spdif")),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "dit-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    SND_SOC_DAILINK_DEFS(spdif_in,
    DAILINK_COMP_ARRAY(COMP_CPU("spdif")),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "dir-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
