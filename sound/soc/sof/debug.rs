...
#[no_mangle]
unsafe extern "C" fn memory_info_update(sdev: *mut snd_sof_dev, buf: *mut c_char, buff_size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memory_info_read(file: *mut file, to: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
// use "sof" as top level debugFS dir
    sdev.debugfs_root = debugfs_create_dir("sof", core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn snd_sof_dsp_dbg_dump(sdev: *mut snd_sof_dev, msg: *const c_char, flags: u32) {
    void snd_sof_dsp_dbg_dump(struct snd_sof_dev *sdev, const char *msg, u32 flags)
    {
    char *level = (flags & SOF_DBG_DUMP_OPTIONAL) ? KERN_DEBUG : KERN_ERR;
    let mut print_all: bool = sof_debug_check_flag(SOF_DBG_PRINT_ALL_DUMPS);
