...
//! Source: sound/soc/sof/topology.c
#![no_std]
...
pub const MAX_FEATURE_TPLG_COUNT: c_int = 16;
...
pub const COMP_ID_UNASSIGNED: c_uint = 0xffffffff;
//
// Constants used in the computation of linear volume gain
// from dB gain 20th root of 10 in Q1.16 fixed-point notation
//
pub const VOL_TWENTIETH_ROOT_OF_TEN: c_int = 73533;
// 40th root of 10 in Q1.16 fixed-point notation
pub const VOL_FORTIETH_ROOT_OF_TEN: c_int = 69419;
// 0.5 dB step value in topology TLV
pub const VOL_HALF_DB_STEP: c_int = 50;
// TLV data items
pub const TLV_MIN: c_int = 0;
pub const TLV_STEP: c_int = 1;
pub const TLV_MUTE: c_int = 2;
//
...
//
    ...
    int i, j;
    token_list = tplg_ops ? tplg_ops.token_list : core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn get_tlv_data(p: *const c_int, tlv[SOF_TLV_ITEMS]: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vol_shift_64(i: u64, x: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn vol_pow32(a: u32, exp: c_int, fwl: u32) -> u32 {
    static u32 vol_pow32(u32 a, int exp, u32 fwl)
    {
    int i, iter;
    let mut power: u32 = 1 << fwl;
    u64 numerator;
...
//
#[no_mangle]
pub unsafe extern "C" fn vol_compute_gain(value: u32, tlv: *mut c_int) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sof_dai_types {
    pub name: *const c_char,
    pub type: enum sof_ipc_dai_type,
}
...
#[no_mangle]
unsafe extern "C" fn find_dai(name: *const c_char) -> enum sof_ipc_dai_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sof_frame_types {
    pub name: *const c_char,
    pub frame: enum sof_ipc_frame,
}
...
#[no_mangle]
unsafe extern "C" fn find_format(name: *const c_char) -> enum sof_ipc_frame {
...
#[no_mangle]
pub unsafe extern "C" fn get_token_u32(elem: *mut c_void, object: *mut c_void, offset: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_token_u16(elem: *mut c_void, object: *mut c_void, offset: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_token_uuid(elem: *mut c_void, object: *mut c_void, offset: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_token_string(elem: *mut c_void, object: *mut c_void, offset: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_token_comp_format(elem: *mut c_void, object: *mut c_void, offset: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_token_dai_type(elem: *mut c_void, object: *mut c_void, offset: u32) -> c_int {
...
// validate topology data
    ...
    let mut priv_size: usize = le32_to_cpu(control.priv.size);
...
#[no_mangle]
pub unsafe extern "C" fn if(snd_soc_dapm_dai_in: w->id ==) -> else {
...
// does stream match DAI link ?
    ...
    snd_soc_dai_set_widget(cpu_dai, stream, core::ptr::null_mut());
    break;
    }
    }
    }
...
#[no_mangle]
unsafe extern "C" fn sof_get_token_value(token_id: u32, tuples: *mut snd_sof_tuple, num_tuples: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_w_no_wname_in_long_name(elem: *mut c_void, object: *mut c_void, offset: u32) -> c_int {
...
// external widget init - used for any driver specific init
    ...
    enum sof_tokens *token_list = core::ptr::null_mut();
    struct snd_sof_widget *swidget;
    struct snd_sof_dai *dai;
    let mut token_list_size: c_int = 0;
    let mut ret: c_int = 0;
...
// on parsing error, pin binding is not allocated, nothing to free.
    ...
    widget_ops = tplg_ops ? tplg_ops.widget : core::ptr::null_mut();
    if (widget_ops) {
...
// free sroute and its private data
    ...
    list_del(&spipe.list);
    kfree(spipe);
    swidget.spipe = core::ptr::null_mut();
    break;
    }
    default:
    break;
...
#[no_mangle]
unsafe extern "C" fn sof_link_unload(scomp: *mut snd_soc_component, dobj: *mut snd_soc_dobj) -> c_int {
    ...
    if (!slink)
    return 0;
    slink.link.platforms.name = core::ptr::null_mut();
    kfree(slink.tuples);
    list_del(&slink.list);
    kfree(slink);
    dobj.private = core::ptr::null_mut();
    return 0;
    }
// DAI link - used for any driver specific init
...
#[no_mangle]
unsafe extern "C" fn sof_complete(scomp: *mut snd_soc_component) -> c_int {
...
//
    let mut no_fallback: bool = strstr(file, "dummy");
