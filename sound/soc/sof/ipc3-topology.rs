...
//! Source: sound/soc/sof/ipc3-topology.c
#![no_std]
...
pub const SOF_IPC3_TPLG_ABI_SIZE: c_int = 3;
// Base of SOF_DAI_INTEL_ALH, this should be aligned with SOC_SDW_INTEL_BIDIR_PDI_BASE
pub const INTEL_ALH_DAI_INDEX_BASE: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sof_widget_data {
    pub ctrl_type: c_int,
    pub ipc_cmd: c_int,
    pub pdata: *mut c_void,
    pub pdata_size: usize,
    pub control: *mut snd_sof_control,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sof_process_types {
    pub name: *const c_char,
    pub type: enum sof_ipc_process_type,
    pub comp_type: enum sof_comp_type,
}
...
#[no_mangle]
unsafe extern "C" fn find_process(name: *const c_char) -> enum sof_ipc_process_type {
...
//
    ...
    let mut total_size: usize = *ipc_size;
    let mut ext_size: usize = sizeof(swidget.uuid);
...
#[no_mangle]
unsafe extern "C" fn sof_dbg_comp_config(scomp: *mut snd_soc_component, config: *mut sof_ipc_comp_config) {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_host(swidget: *mut snd_sof_widget) -> c_int {
    static int sof_ipc3_widget_setup_comp_host(struct snd_sof_widget *swidget)
    {
    struct snd_soc_component *scomp = swidget.scomp;
    struct sof_ipc_comp_host *host;
    let mut ipc_size: usize = sizeof(*host);
    int ret;
...
// parse one set of comp_tokens
    ...
    swidget.private = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_free_comp(swidget: *mut snd_sof_widget) {
    static void sof_ipc3_widget_free_comp(struct snd_sof_widget *swidget)
    {
    kfree(swidget.private);
    }
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_tone(swidget: *mut snd_sof_widget) -> c_int {
    static int sof_ipc3_widget_setup_comp_tone(struct snd_sof_widget *swidget)
    {
    struct snd_soc_component *scomp = swidget.scomp;
    struct sof_ipc_comp_tone *tone;
    let mut ipc_size: usize = sizeof(*tone);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_mixer(swidget: *mut snd_sof_widget) -> c_int {
    static int sof_ipc3_widget_setup_comp_mixer(struct snd_sof_widget *swidget)
    {
    struct snd_soc_component *scomp = swidget.scomp;
    struct sof_ipc_comp_mixer *mixer;
    let mut ipc_size: usize = sizeof(*mixer);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_pipeline(swidget: *mut snd_sof_widget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_buffer(swidget: *mut snd_sof_widget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_src(swidget: *mut snd_sof_widget) -> c_int {
    static int sof_ipc3_widget_setup_comp_src(struct snd_sof_widget *swidget)
    {
    struct snd_soc_component *scomp = swidget.scomp;
    struct sof_ipc_comp_src *src;
    let mut ipc_size: usize = sizeof(*src);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_asrc(swidget: *mut snd_sof_widget) -> c_int {
    static int sof_ipc3_widget_setup_comp_asrc(struct snd_sof_widget *swidget)
    {
    struct snd_soc_component *scomp = swidget.scomp;
    struct sof_ipc_comp_asrc *asrc;
    let mut ipc_size: usize = sizeof(*asrc);
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_mux(swidget: *mut snd_sof_widget) -> c_int {
    static int sof_ipc3_widget_setup_comp_mux(struct snd_sof_widget *swidget)
    {
    struct snd_soc_component *scomp = swidget.scomp;
    struct sof_ipc_comp_mux *mux;
    let mut ipc_size: usize = sizeof(*mux);
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_pga(swidget: *mut snd_sof_widget) -> c_int {
    ...
    let mut ipc_size: usize = sizeof(*volume);
...
// get data type
    ...
    struct sof_widget_data *wdata = core::ptr::null_mut();
    let mut ipc_data_size: usize = 0;
    size_t ipc_size;
...
#[no_mangle]
unsafe extern "C" fn find_process_comp_type(type: enum sof_ipc_process_type) -> enum sof_comp_type {
...
//
#[no_mangle]
unsafe extern "C" fn sof_widget_update_ipc_comp_process(swidget: *mut snd_sof_widget) -> c_int {
...
// now load process specific data and send IPC
    ...
    let mut size: u32 = sizeof(*config);
    int ret;
// init IPC
...
// parse the required set of AFE tokens based on num_hw_cfgs
    ...
    struct sof_dai_private_data *private = dai.private;
    let mut size: u32 = sizeof(*config);
    let mut current_config: c_int = 0;
    int i, ret;
//
...
// validate SSP fsync rate and channel count
    ...
    let mut size: usize = sizeof(*config);
    int i, ret;
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup_comp_dai(swidget: *mut snd_sof_widget) -> c_int {
    ...
    let mut ipc_size: usize = sizeof(*comp_dai);
    struct sof_ipc_dai_config *config;
...
// parse one set of DAI link tokens
    ...
    free:
    kfree(private);
    dai.private = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_free_comp_dai(swidget: *mut snd_sof_widget) {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_route_setup(sdev: *mut snd_sof_dev, sroute: *mut snd_sof_route) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_control_load_bytes(sdev: *mut snd_sof_dev, scontrol: *mut snd_sof_control) -> c_int {
    ...
    kfree(scontrol.priv);
    scontrol.priv = core::ptr::null_mut();
    if (cdata.data.magic != SOF_ABI_MAGIC) {
    ...
    scontrol.ipc_control_data = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn sof_ipc3_control_load_volume(sdev: *mut snd_sof_dev, scontrol: *mut snd_sof_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_control_load_enum(sdev: *mut snd_sof_dev, scontrol: *mut snd_sof_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_control_setup(sdev: *mut snd_sof_dev, scontrol: *mut snd_sof_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_control_free(sdev: *mut snd_sof_dev, scontrol: *mut snd_sof_control) -> c_int {
...
// send pcm params ipc
#[no_mangle]
unsafe extern "C" fn sof_ipc3_keyword_detect_pcm_params(swidget: *mut snd_sof_widget, dir: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_keyword_detect_trigger(swidget: *mut snd_sof_widget, cmd: c_int) -> c_int {
...
// send IPC to the DSP
    ...
    let mut stream: c_int = SNDRV_PCM_STREAM_CAPTURE;
    struct snd_sof_pcm *spcm;
    let mut ret: c_int = 0;
    if (!swidget)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_complete_pipeline(sdev: *mut snd_sof_dev, swidget: *mut snd_sof_widget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_free(sdev: *mut snd_sof_dev, swidget: *mut snd_sof_widget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_widget_setup(sdev: *mut snd_sof_dev, swidget: *mut snd_sof_widget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_set_up_all_pipelines(sdev: *mut snd_sof_dev, verify: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sof_tear_down_left_over_pipelines(sdev: *mut snd_sof_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sof_ipc3_tear_down_all_pipelines(sdev: *mut snd_sof_dev, verify: bool) -> c_int {
    static int sof_ipc3_tear_down_all_pipelines(struct snd_sof_dev *sdev, bool verify)
    {
    struct sof_ipc_fw_version *v = &sdev.fw_ready.version;
    struct snd_sof_widget *swidget;
    struct snd_sof_route *sroute;
    let mut dyn_widgets: bool = false;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_dai_get_param(sdev: *mut snd_sof_dev, dai: *mut snd_sof_dai, param_type: c_int) -> c_int {
...
// not yet implemented for platforms other than the above
    ...
    {
    let mut size: u32 = le32_to_cpu(man.priv.size);
    u32 abi_version;
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_link_setup(sdev: *mut snd_sof_dev, link: *mut snd_soc_dai_link) -> c_int {
...
// token list for each topology object
    ...
    host_token_list, ARRAY_SIZE(host_token_list), core::ptr::null_mut()},
    ...
    dai_token_list, ARRAY_SIZE(dai_token_list), core::ptr::null_mut()},
    ...
    buffer_token_list, ARRAY_SIZE(buffer_token_list), core::ptr::null_mut()},
    ...
    src_token_list, ARRAY_SIZE(src_token_list), core::ptr::null_mut()},
    [snd_soc_dapm_asrc] = {sof_ipc3_widget_setup_comp_asrc, sof_ipc3_widget_free_comp,
    asrc_token_list, ARRAY_SIZE(asrc_token_list), core::ptr::null_mut()},
    ...
    pipeline_token_list, ARRAY_SIZE(pipeline_token_list), core::ptr::null_mut()},
    [snd_soc_dapm_pga] = {sof_ipc3_widget_setup_comp_pga, sof_ipc3_widget_free_comp,
    pga_token_list, ARRAY_SIZE(pga_token_list), core::ptr::null_mut()},
    [snd_soc_dapm_mux] = {sof_ipc3_widget_setup_comp_mux, sof_ipc3_widget_free_comp,
    comp_generic_token_list, ARRAY_SIZE(comp_generic_token_list), core::ptr::null_mut()},
