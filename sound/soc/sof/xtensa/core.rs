...
//! Source: sound/soc/sof/xtensa/core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xtensa_exception_cause {
    pub id: u32,
...
#[no_mangle]
unsafe extern "C" fn xtensa_dsp_oops(sdev: *mut snd_sof_dev, level: *const c_char, oops: *mut c_void) {
    ...
    {
    struct sof_ipc_dsp_oops_xtensa *xoops = oops;
    let mut stack_ptr: u32 = xoops.plat_hdr.stackptr;
