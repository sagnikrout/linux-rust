...
//! Source: sound/soc/sof/sof-client-ipc-flood-test.c
#![no_std]
...
pub const MAX_IPC_FLOOD_DURATION_MS: c_int = 1000;
pub const MAX_IPC_FLOOD_COUNT: c_int = 10000;
pub const IPC_FLOOD_TEST_RESULT_LEN: c_int = 512;
pub const SOF_IPC_CLIENT_SUSPEND_DELAY_MS: c_int = 3000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sof_ipc_flood_priv {
    pub dfs_root: *mut dentry,
    pub dfs_link: [*mut dentry; 2],
    pub buf: *mut c_char,
}
...
//
    ...
    let mut min_response_time: u64 = U64_MAX;
    ktime_t start, end, test_end;
    let mut avg_response_time: u64 = 0;
    let mut max_response_time: u64 = 0;
...
//
    ...
    let mut flood_duration_test: bool = false;
...
#[no_mangle]
unsafe extern "C" fn sof_ipc_flood_dfs_release(inode: *mut inode, file: *mut file) -> c_int {
