...
// Module parameters for firmware, topology and IPC type override
    ...
    let mut override_ipc_type: static int = -1;
    module_param_named(ipc_type, override_ipc_type, int, 0444);
    MODULE_PARM_DESC(ipc_type, "Force SOF IPC type. 0 - IPC3, 1 - IPC4");
// see SOF_DBG_ flags
    let mut sof_core_debug: static int = IS_ENABLED(CONFIG_SND_SOC_SOF_DEBUG_ENABLE_FIRMWARE_TRACE);
...
pub const TIMEOUT_DEFAULT_IPC_MS: c_int = 500;
pub const TIMEOUT_DEFAULT_BOOT_MS: c_int = 2000;
//
...
#[no_mangle]
pub unsafe extern "C" fn sof_set_fw_state(sdev: *mut snd_sof_dev, new_state: enum sof_fw_state) {
...
#[no_mangle]
unsafe extern "C" fn sof_machine_check(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_select_ipc_and_paths(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: base_profile->fw_path_postfix) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: base_profile->fw_lib_path_postfix) -> else {
...
#[no_mangle]
unsafe extern "C" fn validate_sof_ops(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_init_sof_ops(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_init_environment(sdev: *mut snd_sof_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sof_probe_continue(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_sof_device_probe(dev: *mut device, plat_data: *mut snd_sof_pdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sof_machine_register(sdev: *mut snd_sof_dev, pdata: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sof_machine_unregister(sdev: *mut snd_sof_dev, pdata: *mut c_void) {
