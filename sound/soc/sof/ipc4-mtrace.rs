...
//! Source: sound/soc/sof/ipc4-mtrace.c
#![no_std]
...
pub const MAX_ALLOWED_LIBRARIES: c_int = 16;
pub const SOF_IPC4_INVALID_SLOT_OFFSET: c_uint = 0xffffffff;
// for debug and critical types

pub const DEFAULT_AGING_TIMER_PERIOD_MS: c_uint = 0x100;
pub const DEFAULT_FIFO_FULL_TIMER_PERIOD_MS: c_uint = 0x1000;
...
pub struct sof_mtrace_priv {
    pub sdev: *mut snd_sof_dev,
    pub mtrace_state: enum sof_mtrace_state,
    pub state_info: sof_log_state_info,
    pub cores: [sof_mtrace_core_data; ],
}
...
#[no_mangle]
unsafe extern "C" fn sof_wait_mtrace_avail(core_data: *mut sof_mtrace_core_data) -> bool {
...
unsafe extern "C" fn sof_ipc4_mtrace_dfs_release(inode: *mut inode, file: *mut file) -> c_int {
    ...
    kfree(core_data.log_buffer);
    core_data.log_buffer = core::ptr::null_mut();
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn mtrace_debugfs_create(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc4_mtrace_enable(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc4_mtrace_disable(sdev: *mut snd_sof_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn sof_mtrace_find_core_slots(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
unsafe extern "C" fn ipc4_mtrace_init(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc4_mtrace_free(sdev: *mut snd_sof_dev) {
    static void ipc4_mtrace_free(struct snd_sof_dev *sdev)
    {
    ipc4_mtrace_disable(sdev);
    }
#[no_mangle]
unsafe extern "C" fn sof_ipc4_mtrace_update_pos_all_cores(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc4_mtrace_fw_crashed(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
unsafe extern "C" fn ipc4_mtrace_resume(sdev: *mut snd_sof_dev) -> c_int {
    static int ipc4_mtrace_resume(struct snd_sof_dev *sdev)
    {
    return ipc4_mtrace_enable(sdev);
    }
#[no_mangle]
unsafe extern "C" fn ipc4_mtrace_suspend(sdev: *mut snd_sof_dev, pm_state: pm_message_t) {
