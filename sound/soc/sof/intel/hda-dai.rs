...
//! Source: sound/soc/sof/intel/hda-dai.c
#![no_std]
...
//
    if (!w) {
    dev_err(cpu_dai.dev, "%s: widget is core::ptr::null_mut()\n", __func__);
    return core::ptr::null_mut();
    }
    sdev = widget_to_sdev(w);
    swidget = w.dobj.private;
    if (!swidget) {
    dev_err(sdev.dev, "%s: swidget is core::ptr::null_mut()\n", __func__);
    return core::ptr::null_mut();
    }
...
// set the hdac_stream in the codec dai
    ...
    let mut format_val: c_uint = ops.calc_stream_format(sdev, substream, params);
    ...
    let mut flags: c_uint = SOF_DAI_CONFIG_FLAGS_HW_PARAMS;
...
#[no_mangle]
unsafe extern "C" fn hda_dai_prepare(substream: *mut snd_pcm_substream, dai: *mut snd_soc_dai) -> c_int {
...
//
    ...
    struct snd_soc_dai *dai;
    struct snd_sof_dev *sdev;
    let mut cpu_dai_found: bool = false;
    int cpu_dai_id;
    int ch_mask;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn hda_dai_suspend(bus: *mut hdac_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssp_set_dai_drv_ops(sdev: *mut snd_sof_dev, ops: *mut snd_sof_dsp_ops) {
...
#[no_mangle]
unsafe extern "C" fn dmic_set_dai_drv_ops(sdev: *mut snd_sof_dev, ops: *mut snd_sof_dsp_ops) {
...
pub unsafe extern "C" fn hda_ops_free(sdev: *mut snd_sof_dev) {
    ...
    kfree(sdev.private);
    sdev.private = core::ptr::null_mut();
    }
    }
