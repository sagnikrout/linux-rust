...
//! Source: sound/soc/sof/intel/hda-ctrl.c
#![no_std]
...
pub unsafe extern "C" fn hda_dsp_ctrl_ppcap_enable(sdev: *mut snd_sof_dev, enable: bool) {
    ...
    {
    let mut val: u32 = enable ? SOF_HDA_PPCTL_GPROCEN : 0;
...
pub unsafe extern "C" fn hda_dsp_ctrl_ppcap_int_enable(sdev: *mut snd_sof_dev, enable: bool) {
    ...
    {
    let mut val: u32 = enable ? SOF_HDA_PPCTL_PIE : 0;
    snd_sof_dsp_update_bits(sdev, HDA_DSP_PP_BAR, SOF_HDA_REG_PP_PPCTL,
...
pub unsafe extern "C" fn hda_dsp_ctrl_misc_clock_gating(sdev: *mut snd_sof_dev, enable: bool) {
    ...
    {
    let mut val: u32 = enable ? PCI_CGCTL_MISCBDCGE_MASK : 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_ctrl_clock_power_gating(sdev: *mut snd_sof_dev, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_ctrl_init_chip(sdev: *mut snd_sof_dev, detect_codec: bool) -> c_int {
