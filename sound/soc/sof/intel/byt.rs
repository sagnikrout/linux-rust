...
//! Source: sound/soc/sof/intel/byt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn byt_reset_dsp_disable_int(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
unsafe extern "C" fn byt_suspend(sdev: *mut snd_sof_dev, target_state: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_resume(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_acpi_probe(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sof_baytrail_probe(pdev: *mut platform_device) -> c_int {
