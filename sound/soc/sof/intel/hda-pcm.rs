...
//! Source: sound/soc/sof/intel/hda-pcm.c
#![no_std]
...
pub const HDA_MAX_PERIOD_TIME_HEADROOM: c_int = 10;
    ...
    let mut hda_force_pause_support: static int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_get_mult_div(sdev: *mut snd_sof_dev, rate: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_get_bits(sdev: *mut snd_sof_dev, sample_bits: c_int) -> u32 {
...
//
    ...
    let mut rate: u32 = hda_dsp_get_mult_div(sdev, params_rate(params));
    let mut bits: u32 = hda_dsp_get_bits(sdev, params_width(params));
...
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_pcm_ack(sdev: *mut snd_sof_dev, substream: *mut snd_pcm_substream) -> c_int {
...
//
    ...
    let mut period_time: c_uint = spcm.stream[direction].dsp_max_burst_size_in_ms;
//
