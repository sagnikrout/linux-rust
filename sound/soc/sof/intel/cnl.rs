...
//! Source: sound/soc/sof/intel/cnl.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cnl_ipc4_irq_thread(irq: c_int, context: *mut c_void) -> irqreturn_t {
    irqreturn_t cnl_ipc4_irq_thread(int irq, void *context)
    {
    let mut notification_data: sof_ipc4_msg = {{ 0 }};
...
// Message from DSP (reply or notification)
    ...
    CNL_DSP_REG_HIPCTDD);
    let mut primary: u32 = hipctdr & CNL_DSP_REG_HIPCTDR_MSG_MASK;
    let mut extension: u32 = hipctdd & CNL_DSP_REG_HIPCTDD_MSG_MASK;
...
// Notification received
    ...
    sdev.ipc.msg.rx_data = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cnl_ipc_irq_thread(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
// handle messages from DSP
    ...
    let mut non_recoverable: bool = true;
//
...
#[no_mangle]
unsafe extern "C" fn cnl_ipc_host_done(sdev: *mut snd_sof_dev) {
    static void cnl_ipc_host_done(struct snd_sof_dev *sdev)
    {
//
...
#[no_mangle]
unsafe extern "C" fn cnl_ipc_dsp_done(sdev: *mut snd_sof_dev) {
    static void cnl_ipc_dsp_done(struct snd_sof_dev *sdev)
    {
//
...
#[no_mangle]
pub unsafe extern "C" fn cnl_ipc4_send_msg(sdev: *mut snd_sof_dev, msg: *mut snd_sof_ipc_msg) -> c_int {
    ...
    hdev.delayed_ipc_tx_msg = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cnl_ipc_send_msg(sdev: *mut snd_sof_dev, msg: *mut snd_sof_ipc_msg) -> c_int {
