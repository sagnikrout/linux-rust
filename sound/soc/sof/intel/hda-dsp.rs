...
//! Source: sound/soc/sof/intel/hda-dsp.c
#![no_std]
...
pub const HDA_EXT_ROM_STATUS_SIZE: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn hda_get_interfaces(sdev: *mut snd_sof_dev, interface_mask: *mut u32) {
...
//
#[no_mangle]
unsafe extern "C" fn hda_dsp_core_reset_enter(sdev: *mut snd_sof_dev, core_mask: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_core_reset_leave(sdev: *mut snd_sof_dev, core_mask: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_core_power_up(sdev: *mut snd_sof_dev, core_mask: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_core_power_down(sdev: *mut snd_sof_dev, core_mask: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_enable_core(sdev: *mut snd_sof_dev, core_mask: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_wait_d0i3c_done(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_send_pm_gate_ipc(sdev: *mut snd_sof_dev, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_update_d0i3c_register(sdev: *mut snd_sof_dev, value: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hda_dsp_d0i3_streaming_applicable(sdev: *mut snd_sof_dev) -> bool {
    static bool hda_dsp_d0i3_streaming_applicable(struct snd_sof_dev *sdev)
    {
    struct snd_pcm_substream *substream;
    struct snd_sof_pcm *spcm;
    let mut playback_active: bool = false;
    int dir;
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_state_log(sdev: *mut snd_sof_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn hda_suspend(sdev: *mut snd_sof_dev, runtime_suspend: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_resume(sdev: *mut snd_sof_dev, runtime_resume: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_check_for_dma_streams(sdev: *mut snd_sof_dev) -> c_uint {
    static unsigned int hda_dsp_check_for_dma_streams(struct snd_sof_dev *sdev)
    {
    struct hdac_bus *bus = sof_to_bus(sdev);
    struct hdac_stream *s;
    let mut active_streams: c_uint = 0;
    int sd_offset;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_s5_quirk(sdev: *mut snd_sof_dev) -> c_int {
...
pub unsafe extern "C" fn hda_sdw_int_enable(sdev: *mut snd_sof_dev, enable: bool) {
    ...
    {
    let mut interface_mask: u32 = hda_get_interface_mask(sdev);
    const struct sof_intel_dsp_desc *chip;
...
// The firmware register dump only available with IPC3
    ...
    let mut status: u32 = snd_sof_dsp_read(sdev, HDA_DSP_BAR, HDA_DSP_SRAM_REG_FW_STATUS);
    let mut panic: u32 = snd_sof_dsp_read(sdev, HDA_DSP_BAR, HDA_DSP_SRAM_REG_FW_TRACEP);
