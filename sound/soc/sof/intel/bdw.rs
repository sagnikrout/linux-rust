...
//! Source: sound/soc/sof/intel/bdw.c
#![no_std]
...
// BARs
pub const BDW_DSP_BAR: c_int = 0;
pub const BDW_PCI_BAR: c_int = 1;
//
// Debug
//
// DSP memories for BDW
pub const IRAM_OFFSET: c_uint = 0xA0000;

pub const DRAM_OFFSET: c_uint = 0x00000;

pub const SHIM_OFFSET: c_uint = 0xFB000;
pub const SHIM_SIZE: c_uint = 0x100;
pub const MBOX_OFFSET: c_uint = 0x9E000;
...
// DSP peripherals
pub const DMAC0_OFFSET: c_uint = 0xFE000;
pub const DMAC1_OFFSET: c_uint = 0xFF000;
pub const DMAC_SIZE: c_uint = 0x420;
pub const SSP0_OFFSET: c_uint = 0xFC000;
pub const SSP1_OFFSET: c_uint = 0xFD000;
pub const SSP_SIZE: c_uint = 0x100;
pub const BDW_STACK_DUMP_SIZE: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn bdw_dump(sdev: *mut snd_sof_dev, flags: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn bdw_irq_handler(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bdw_irq_thread(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bdw_get_mailbox_offset(sdev: *mut snd_sof_dev) -> c_int {
    static int bdw_get_mailbox_offset(struct snd_sof_dev *sdev)
    {
    return MBOX_OFFSET;
    }
#[no_mangle]
unsafe extern "C" fn bdw_get_window_offset(sdev: *mut snd_sof_dev, id: u32) -> c_int {
