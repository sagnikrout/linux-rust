...
//! Source: sound/soc/sof/intel/hda-loader.c
#![no_std]
...
//
    ...
    let mut persistent_cl_buffer: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn hda_ssp_set_cbp_cfp(sdev: *mut snd_sof_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cl_dsp_init(sdev: *mut snd_sof_dev, stream_tag: c_int, imr_boot: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hda_cl_trigger(dev: *mut device, hext_stream: *mut hdac_ext_stream, cmd: c_int) -> c_int {
...
pub const HDA_CL_DMA_IOC_TIMEOUT_MS: c_int = 500;
#[no_mangle]
pub unsafe extern "C" fn hda_cl_copy_fw(sdev: *mut snd_sof_dev, hext_stream: *mut hdac_ext_stream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_cl_boot_firmware_iccmax(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_dsp_boot_imr(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hda_dsp_cl_boot_firmware(sdev: *mut snd_sof_dev) -> c_int {
...
//
    ...
    if (!ret) {
    let mut sd_offset: c_int = SOF_STREAM_SD_OFFSET(&hext_stream.hstream);
    unsigned int status;
//
