...
//! Source: sound/soc/sof/amd/acp-stream.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn acp_dsp_stream_config(sdev: *mut snd_sof_dev, stream: *mut acp_dsp_stream) -> c_int {
    ...
    let mut stream_tag: c_int = stream.stream_tag;
