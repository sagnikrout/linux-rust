...
//! Source: sound/soc/sof/amd/pci-vangogh.c
#![no_std]
...
pub const ACP5X_FUTURE_REG_ACLK_0: c_uint = 0x1864;
...
#[no_mangle]
unsafe extern "C" fn acp_pci_vgh_probe(pci: *mut pci_dev, pci_id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp_pci_vgh_remove(pci: *mut pci_dev) {
