...
//! Source: sound/soc/sof/amd/acp-ipc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn acp_mailbox_write(sdev: *mut snd_sof_dev, offset: u32, message: *mut c_void, bytes: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn acp_mailbox_read(sdev: *mut snd_sof_dev, offset: u32, message: *mut c_void, bytes: usize) {
...
#[no_mangle]
unsafe extern "C" fn acpbus_trigger_host_to_dsp_swintr(adata: *mut acp_dev_data) {
...
#[no_mangle]
unsafe extern "C" fn acp_ipc_host_msg_set(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
unsafe extern "C" fn acp_dsp_ipc_host_done(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
unsafe extern "C" fn acp_dsp_ipc_dsp_done(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn acp_sof_ipc_send_msg(sdev: *mut snd_sof_dev, msg: *mut snd_sof_ipc_msg) -> c_int {
    int acp_sof_ipc_send_msg(struct snd_sof_dev *sdev, struct snd_sof_ipc_msg *msg)
    {
    struct acp_dev_data *adata = sdev.pdata.hw_pdata;
    const struct sof_amd_acp_desc *desc = get_chip_info(sdev.pdata);
    let mut offset: c_uint = sdev.host_box.offset;
...
#[no_mangle]
unsafe extern "C" fn acp_dsp_ipc_get_reply(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn acp_sof_ipc_irq_thread(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
//
    ...
    void *p, size_t sz)
    {
    let mut offset: c_uint = sdev.dsp_box.offset;
...
#[no_mangle]
pub unsafe extern "C" fn acp_sof_ipc_get_window_offset(sdev: *mut snd_sof_dev, id: u32) -> c_int {
