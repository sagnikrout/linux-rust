...
//! Source: sound/soc/sof/amd/pci-acp63.c
#![no_std]
...
pub const ACP6X_FUTURE_REG_ACLK_0: c_uint = 0x1854;
pub const ACP6x_REG_START: c_uint = 0x1240000;
pub const ACP6x_REG_END: c_uint = 0x125C000;
...
#[no_mangle]
unsafe extern "C" fn acp63_pci_probe(pci: *mut pci_dev, pci_id: *const pci_device_id) -> c_int {
