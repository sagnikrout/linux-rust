...
//! Source: sound/soc/sof/amd/pci-acp70.c
#![no_std]
...
pub const ACP70_FUTURE_REG_ACLK_0: c_uint = 0x1854;
pub const ACP70_REG_START: c_uint = 0x1240000;
pub const ACP70_REG_END: c_uint = 0x125C000;
...
#[no_mangle]
unsafe extern "C" fn acp70_pci_probe(pci: *mut pci_dev, pci_id: *const pci_device_id) -> c_int {
