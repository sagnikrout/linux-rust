...
//! Source: sound/soc/sof/amd/acp-common.c
#![no_std]
...
pub unsafe extern "C" fn amd_sof_ipc_dump(sdev: *mut snd_sof_dev) {
    ...
    let mut base: u32 = desc.dsp_intr_base;
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_sof_dump(sdev: *mut snd_sof_dev, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn amd_sof_sdw_get_slave_info(sdev: *mut snd_sof_dev) -> c_int {
    ...
    struct snd_soc_acpi_mach *mach = core::ptr::null_mut();
    if (desc.machines)
