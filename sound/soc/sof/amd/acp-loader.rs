...
//! Source: sound/soc/sof/amd/acp-loader.c
#![no_std]
...
pub const FW_BIN: c_int = 0;
pub const FW_DATA_BIN: c_int = 1;
pub const FW_SRAM_DATA_BIN: c_int = 2;
pub const FW_BIN_PTE_OFFSET: c_uint = 0x00;
pub const FW_DATA_BIN_PTE_OFFSET: c_uint = 0x08;
pub const ACP_DSP_RUN: c_uint = 0x00;
...
#[no_mangle]
pub unsafe extern "C" fn acp_get_bar_index(sdev: *mut snd_sof_dev, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configure_pte_for_fw_loading(type: c_int, num_pages: c_int, adata: *mut acp_dev_data) {
