...
//! Source: sound/soc/sof/amd/renoir.c
#![no_std]
...
pub const I2S_BT_INSTANCE: c_int = 0;
pub const I2S_SP_INSTANCE: c_int = 1;
pub const PDM_DMIC_INSTANCE: c_int = 2;
pub const I2S_SP_VIRTUAL_INSTANCE: c_int = 3;
...
#[no_mangle]
pub unsafe extern "C" fn sof_renoir_ops_init(sdev: *mut snd_sof_dev) -> c_int {
