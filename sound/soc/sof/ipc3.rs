...
#[no_mangle]
unsafe extern "C" fn ipc3_log_header(dev: *mut device, text: *mut u8, cmd: u32) {
    static void ipc3_log_header(struct device *dev, u8 *text, u32 cmd)
    {
    u8 *str;
    u8 *str2 = core::ptr::null_mut();
    u32 glb;
    u32 type;
    let mut is_sof_ipc_stream_position: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn ipc3_log_header(dev: *mut device, text: *mut u8, cmd: u32) {
...
#[no_mangle]
unsafe extern "C" fn ipc3_wait_tx_done(ipc: *mut snd_sof_ipc, reply_data: *mut c_void) -> c_int {
...
// copy the payload data in a loop
    ...
    if (sof_debug_check_flag(SOF_DBG_DUMP_IPC_MESSAGE_PAYLOAD)) {
    let mut header_bytes: usize = sizeof(struct sof_ipc_reply);
...
#[no_mangle]
unsafe extern "C" fn ipc3_fw_parse_ext_data(sdev: *mut snd_sof_dev, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc3_get_windows(sdev: *mut snd_sof_dev) {
...
#[no_mangle]
unsafe extern "C" fn ipc3_init_reply_data_buffer(sdev: *mut snd_sof_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc3_fw_ready(sdev: *mut snd_sof_dev, cmd: u32) -> c_int {
...
// IPC stream position.
#[no_mangle]
unsafe extern "C" fn ipc3_period_elapsed(sdev: *mut snd_sof_dev, msg_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn ipc3_xrun(sdev: *mut snd_sof_dev, msg_id: u32) {
...
unsafe extern "C" fn ipc3_stream_message(sdev: *mut snd_sof_dev, msg_buf: *mut c_void) {
    ...
    let mut msg_type: u32 = hdr.cmd & SOF_CMD_TYPE_MASK;
    let mut msg_id: u32 = SOF_IPC_MESSAGE_ID(hdr.cmd);
    switch (msg_type) {
    case SOF_IPC_STREAM_POSITION:
...
pub unsafe extern "C" fn sof_ipc3_do_rx_work(sdev: *mut snd_sof_dev, hdr: *mut sof_ipc_cmd_hdr, msg_buf: *mut c_void) {
    ...
    {
    let mut rx_callback: ipc3_rx_callback = core::ptr::null_mut();
    u32 cmd;
    int err;
...
unsafe extern "C" fn sof_ipc3_rx_msg(sdev: *mut snd_sof_dev) {
    ...
    int err;
// read back header
    err = snd_sof_ipc_msg_data(sdev, core::ptr::null_mut(), &hdr, sizeof(hdr));
    if (err < 0) {
...
// read the full message
    ...
    if (!msg_buf)
    return;
    err = snd_sof_ipc_msg_data(sdev, core::ptr::null_mut(), msg_buf, hdr.size);
    if (err < 0) {
...
unsafe extern "C" fn sof_ipc3_set_core_state(sdev: *mut snd_sof_dev, core_idx: c_int, on: bool) -> c_int {
    ...
    core_cfg.enable_mask = sdev.enabled_cores_mask & ~BIT(core_idx);
    return sof_ipc3_tx_msg(sdev, &core_cfg, sizeof(core_cfg), core::ptr::null_mut(), 0, false);
    }
#[no_mangle]
unsafe extern "C" fn sof_ipc3_ctx_ipc(sdev: *mut snd_sof_dev, cmd: c_int) -> c_int {
...
// send ctx save ipc to dsp
    return sof_ipc3_tx_msg(sdev, &pm_ctx, sizeof(pm_ctx), core::ptr::null_mut(), 0, false);
    }
#[no_mangle]
