...
//! Source: sound/soc/sof/ipc3-loader.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipc3_fw_ext_man_size(sdev: *mut snd_sof_dev, fw: *const firmware) -> isize {
...
#[no_mangle]
unsafe extern "C" fn sof_ipc3_fw_parse_ext_man(sdev: *mut snd_sof_dev) -> usize {
...
unsafe extern "C" fn sof_ipc3_load_fw_to_dsp(sdev: *mut snd_sof_dev) -> c_int {
    ...
    {
    let mut payload_offset: u32 = sdev.basefw.payload_offset;
    const struct firmware *fw = sdev.basefw.fw;
...
unsafe extern "C" fn sof_ipc3_validate_firmware(sdev: *mut snd_sof_dev) -> c_int {
    ...
    const struct firmware *fw = sdev.basefw.fw;
    struct snd_sof_fw_header *header;
    let mut fw_size: usize = fw.size - payload_offset;
