...
pub struct snd_ac97_reset_cfg {
    ...
    .ops = core::ptr::null_mut(), /* Gets initialized in snd_soc_set_ac97_ops() */
    };
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn snd_soc_ac97_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_soc_ac97_free_gpio(ac97: *mut snd_ac97) {
...
pub unsafe extern "C" fn snd_soc_free_ac97_component(ac97: *mut snd_ac97) {
    ...
    device_del(&ac97.dev);
    ac97.bus = core::ptr::null_mut();
    put_device(&ac97.dev);
    }
    EXPORT_SYMBOL_GPL(snd_soc_free_ac97_component);
    static struct snd_ac97_reset_cfg snd_ac97_rst_cfg;
#[no_mangle]
unsafe extern "C" fn snd_soc_ac97_warm_reset(ac97: *mut snd_ac97) {
...
#[no_mangle]
unsafe extern "C" fn snd_soc_ac97_reset(ac97: *mut snd_ac97) {
