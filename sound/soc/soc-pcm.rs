...
#[no_mangle]
unsafe extern "C" fn snd_soc_dpcm_can_fe_update(fe: *mut snd_soc_pcm_runtime, stream: c_int) -> c_int {
...
// BEs state
    ...
    let mut out_count: isize = PAGE_SIZE, offset = 0, ret = 0;
    int stream;
    char *buf;
...
#[no_mangle]
pub unsafe extern "C" fn soc_dpcm_debugfs_add(rtd: *mut snd_soc_pcm_runtime) {
...
#[no_mangle]
unsafe extern "C" fn dpcm_create_debugfs_state(dpcm: *mut snd_soc_dpcm, stream: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dpcm_remove_debugfs_state(dpcm: *mut snd_soc_dpcm) {
...
#[no_mangle]
pub unsafe extern "C" fn dpcm_remove_debugfs_state(dpcm: *mut snd_soc_dpcm) {
...
//
    ...
    let mut active_bclk_rate: c_ulong = 0;
    struct snd_interval *rate = hw_param_interval(params, SNDRV_PCM_HW_PARAM_RATE);
    let mut constraint: snd_interval = { .empty = 1 };
...
#[no_mangle]
unsafe extern "C" fn soc_pcm_update_symmetry(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn soc_pcm_set_msb(substream: *mut snd_pcm_substream, bits: c_int) {
...
#[no_mangle]
unsafe extern "C" fn soc_pcm_apply_msb(substream: *mut snd_pcm_substream) {
    static void soc_pcm_apply_msb(struct snd_pcm_substream *substream)
    {
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd(substream);
    struct snd_soc_dai *cpu_dai;
    struct snd_soc_dai *codec_dai;
    let mut stream: c_int = substream.stream;
    int i;
    let mut bits: c_uint = 0, cpu_bits = 0;
...
#[no_mangle]
unsafe extern "C" fn soc_pcm_hw_init(hw: *mut snd_pcm_hardware, force: bool) {
...
//
    ...
    let mut cpu_chan_min: c_uint = 0, cpu_chan_max = UINT_MAX;
    int i;
...
#[no_mangle]
unsafe extern "C" fn soc_pcm_init_runtime_hw(substream: *mut snd_pcm_substream) {
    static void soc_pcm_init_runtime_hw(struct snd_pcm_substream *substream)
    {
    struct snd_pcm_hardware *hw = &substream.runtime.hw;
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd(substream);
    let mut formats: u64 = hw.formats;
//
...
#[no_mangle]
unsafe extern "C" fn soc_pcm_components_open(substream: *mut snd_pcm_substream) -> c_int {
    ...
    int i, ret = 0;
    for_each_rtd_components(rtd, i, component) {
    let mut r: c_int = snd_soc_component_close(component, substream, rollback);
    if (r < 0)
    ret = r; /* use last ret */
...
// Make sure DAI parameters cleared if the DAI becomes inactive
    ...
    soc_pcm_set_dai_params(dai, core::ptr::null_mut());
    }
    }
...
#[no_mangle]
unsafe extern "C" fn soc_hw_sanity_check(substream: *mut snd_pcm_substream) -> c_int {
...
//
    ...
    let mut channels: c_int = hweight_long(mask);
...
//
    ...
    goto out;
    for_each_rtd_codec_dais(rtd, i, codec_dai) {
    let mut tdm_mask: c_uint = snd_soc_dai_tdm_mask_get(codec_dai, substream.stream);
//
// Skip CODECs which don't support the current stream type,
...
#[no_mangle]
unsafe extern "C" fn soc_pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
    static int soc_pcm_trigger(struct snd_pcm_substream *substream, int cmd)
    {
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd(substream);
    struct snd_soc_component *component;
    let mut ret: c_int = 0, r = 0, i;
    let mut rollback: c_int = 0;
    let mut start: c_int = 0, stop = 0;
//
...
#[no_mangle]
pub unsafe extern "C" fn dpcm_end_walk_at_be(widget: *mut snd_soc_dapm_widget, dir: enum snd_soc_dapm_direction) -> bool {
...
// get number of valid DAI paths and their widgets
    ...
    core::ptr::null_mut() : dpcm_end_walk_at_be);
    if (paths > 0)
    dev_dbg(fe.dev, "ASoC: found %d audio %s paths\n", paths,
    snd_pcm_direction_name(stream));
#[no_mangle]
pub unsafe extern "C" fn if(0: paths ==) -> else {
    else if (paths == 0)
...
#[no_mangle]
pub unsafe extern "C" fn dpcm_path_put(list: *mut snd_soc_dapm_widget_list) {
...
#[no_mangle]
pub unsafe extern "C" fn dpcm_clear_pending_state(fe: *mut snd_soc_pcm_runtime, stream: c_int) {
...
// is this op for this BE ?
    ...
    be_substream.runtime = core::ptr::null_mut();
    be.dpcm[stream].state = SND_SOC_DPCM_STATE_CLOSE;
    }
    }
#[no_mangle]
pub unsafe extern "C" fn dpcm_be_dai_startup(fe: *mut snd_soc_pcm_runtime, stream: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpcm_runtime_setup_fe(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn dpcm_runtime_setup_be_format(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn dpcm_runtime_setup_be_chan(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn dpcm_runtime_setup_be_rate(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn dpcm_fe_dai_startup(fe_substream: *mut snd_pcm_substream) -> c_int {
    static int dpcm_fe_dai_startup(struct snd_pcm_substream *fe_substream)
    {
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd(fe_substream);
    let mut stream: c_int = fe_substream.stream, ret = 0;
...
#[no_mangle]
unsafe extern "C" fn dpcm_fe_dai_shutdown(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dpcm_be_dai_hw_free(fe: *mut snd_soc_pcm_runtime, stream: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn dpcm_be_dai_hw_params(fe: *mut snd_soc_pcm_runtime, stream: c_int) -> c_int {
...
unsafe extern "C" fn dpcm_fe_dai_do_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
    ...
    let mut ret: c_int = 0;
    int fe_first;
    let mut trigger: enum snd_soc_dpcm_trigger = fe.dai_link.trigger[stream];
...
#[no_mangle]
pub unsafe extern "C" fn dpcm_be_dai_prepare(fe: *mut snd_soc_pcm_runtime, stream: c_int) -> c_int {
...
unsafe extern "C" fn dpcm_fe_dai_prepare(substream: *mut snd_pcm_substream) -> c_int {
    ...
    {
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd(substream);
    let mut stream: c_int = substream.stream, ret = 0;
    snd_soc_dpcm_mutex_lock(fe);
...
#[no_mangle]
unsafe extern "C" fn dpcm_run_update_shutdown(fe: *mut snd_soc_pcm_runtime, stream: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpcm_run_update_startup(fe: *mut snd_soc_pcm_runtime, stream: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_dpcm_fe_runtime_update(fe: *mut snd_soc_pcm_runtime, new: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpcm_fe_dai_cleanup(fe_substream: *mut snd_pcm_substream) {
    static void dpcm_fe_dai_cleanup(struct snd_pcm_substream *fe_substream)
    {
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd(fe_substream);
    struct snd_soc_dpcm *dpcm;
    let mut stream: c_int = fe_substream.stream;
    snd_soc_dpcm_mutex_assert_held(fe);
...
// dev_err_once() for visibility, dev_dbg() for debugging UCM profiles.
    ...
    int cpu_capture;
    int cpu_playback;
    let mut has_playback: c_int = 0;
    let mut has_capture: c_int = 0;
    int i;
...
pub unsafe extern "C" fn soc_new_pcm(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    struct snd_soc_component *component;
    struct snd_pcm *pcm;
    let mut ret: c_int = 0, playback = 0, capture = 0;
    int i;
