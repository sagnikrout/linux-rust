...
//! Source: sound/soc/amd/yc/acp6x-pdm-dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acp6x_enable_pdm_clock(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn acp6x_enable_pdm_interrupts(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn acp6x_disable_pdm_interrupts(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn acp6x_check_pdm_dma_status(acp_base: *mut void __iomem) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acp6x_start_pdm_dma(acp_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp6x_stop_pdm_dma(acp_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp6x_config_dma(rtd: *mut pdm_stream_instance, direction: c_int) {
...
unsafe extern "C" fn acp6x_pdm_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(acp6x_pdm_suspend, acp6x_pdm_runtime_resume, core::ptr::null_mut())
