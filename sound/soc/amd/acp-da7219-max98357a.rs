...
//! Source: sound/soc/amd/acp-da7219-max98357a.c
#![no_std]
...
pub const CZ_PLAT_CLK: c_int = 48000000;
...
unsafe extern "C" fn cz_da7219_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    snd_soc_component_set_jack(component, &cz_jack, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
...
// set codec PLL
    ...
    snd_jack_set_key(cz_jack.jack, SND_JACK_BTN_2, KEY_VOLUMEDOWN);
    snd_jack_set_key(cz_jack.jack, SND_JACK_BTN_3, KEY_VOICECOMMAND);
    ret = snd_soc_component_set_jack(component, &cz_jack, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn cz_da7219_shutdown(substream: *mut snd_pcm_substream) {
...
#[no_mangle]
unsafe extern "C" fn cz_rt5682_shutdown(substream: *mut snd_pcm_substream) {
...
// A/B panel DMIC
    ...
    {"PDM_DAT", core::ptr::null_mut(), "Int Mic"},
    };
