...
//! Source: sound/soc/amd/acp-pcm-dma.c
#![no_std]
...
pub const PLAYBACK_MAX_NUM_PERIODS: c_int = 2;
pub const PLAYBACK_MAX_PERIOD_SIZE: c_int = 16384;
pub const PLAYBACK_MIN_PERIOD_SIZE: c_int = 1024;
pub const CAPTURE_MIN_NUM_PERIODS: c_int = 2;
pub const CAPTURE_MAX_NUM_PERIODS: c_int = 2;
pub const CAPTURE_MAX_PERIOD_SIZE: c_int = 16384;
pub const CAPTURE_MIN_PERIOD_SIZE: c_int = 1024;

pub const ST_PLAYBACK_MAX_PERIOD_SIZE: c_int = 4096;

    let mut acp_bt_uart_enable: bool = true;
...
#[no_mangle]
unsafe extern "C" fn acp_reg_read(acp_mmio: *mut void __iomem, reg: u32) -> u32 {
    static u32 acp_reg_read(void __iomem *acp_mmio, u32 reg)
    {
    return readl(acp_mmio + (reg * 4));
    }
#[no_mangle]
unsafe extern "C" fn acp_reg_write(val: u32, acp_mmio: *mut void __iomem, reg: u32) {
...
#[no_mangle]
unsafe extern "C" fn pre_config_reset(acp_mmio: *mut void __iomem, ch_num: u16) {
...
#[no_mangle]
unsafe extern "C" fn acp_dma_start(acp_mmio: *mut void __iomem, ch_num: u16, is_circular: bool) {
...
#[no_mangle]
unsafe extern "C" fn acp_dma_stop(acp_mmio: *mut void __iomem, ch_num: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp_init(acp_mmio: *mut void __iomem, asic_type: u32) -> c_int {
...
// Deinitialize ACP
#[no_mangle]
unsafe extern "C" fn acp_deinit(acp_mmio: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_irq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn acp_get_byte_count(rtd: *mut audio_substream_data) -> u64 {
    ...
    {
    struct audio_drv_data *adata = dev_get_drvdata(component.dev);
    let mut delay: snd_pcm_sframes_t = adata.delay;
    adata.delay = 0;
    return delay;
    }
    ...
    switch (rtd.i2s_instance) {
    case I2S_BT_INSTANCE:
    adata.play_i2sbt_stream = core::ptr::null_mut();
    break;
    case I2S_MICSP_INSTANCE:
    adata.play_i2s_micsp_stream = core::ptr::null_mut();
    break;
    case I2S_SP_INSTANCE:
    default:
    adata.play_i2ssp_stream = core::ptr::null_mut();
//
// For Stoney, Memory gating is disabled,i.e SRAM Banks
...
//
    ...
    switch (rtd.i2s_instance) {
    case I2S_BT_INSTANCE:
    adata.capture_i2sbt_stream = core::ptr::null_mut();
    break;
    case I2S_MICSP_INSTANCE:
    case I2S_SP_INSTANCE:
    default:
    adata.capture_i2ssp_stream = core::ptr::null_mut();
    if (adata.asic_type != CHIP_STONEY) {
    for (bank = 5; bank <= 8; bank++)
    acp_set_sram_bank_state(adata.acp_mmio,
    bank, false);
...
//
    audio_drv_data.play_i2ssp_stream = core::ptr::null_mut();
    audio_drv_data.capture_i2ssp_stream = core::ptr::null_mut();
    audio_drv_data.play_i2sbt_stream = core::ptr::null_mut();
    audio_drv_data.capture_i2sbt_stream = core::ptr::null_mut();
    audio_drv_data.play_i2s_micsp_stream = core::ptr::null_mut();
...
// Initialize the ACP
    ...
    &acp_asoc_platform, core::ptr::null_mut(), 0);
    if (status != 0) {
