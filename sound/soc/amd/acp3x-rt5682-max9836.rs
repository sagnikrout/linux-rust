...
//! Source: sound/soc/amd/acp3x-rt5682-max9836.c
#![no_std]
...
// Set tdm/i2s1 master bclk ratio
    ...
    ret = snd_soc_component_set_jack(component, &pco_jack, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn rt5682_shutdown(substream: *mut snd_pcm_substream) {
