...
//! Source: sound/soc/amd/acp/acp-platform.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn config_pte_for_stream(chip: *mut acp_chip_info, stream: *mut acp_stream) {
...
#[no_mangle]
pub unsafe extern "C" fn config_acp_dma(chip: *mut acp_chip_info, stream: *mut acp_stream, size: c_int) {
    ...
    let mut num_pages: c_int = (PAGE_ALIGN(size) >> PAGE_SHIFT);
    u32 low, high, val;
    u16 page_idx;
    switch (chip.acp_rev) {
    case ACP70_PCI_ID:
...
unsafe extern "C" fn acp_dma_open(component: *mut snd_soc_component, substream: *mut snd_pcm_substream) -> c_int {
    ...
    let mut size: u64 = params_buffer_bytes(params);
...
#[no_mangle]
pub unsafe extern "C" fn acp_platform_register(dev: *mut device) -> c_int {
    ...
    if (!chip || !chip.base) {
    dev_err(dev, "ACP chip data is core::ptr::null_mut()\n");
    return -ENODEV;
    }
...
#[no_mangle]
pub unsafe extern "C" fn acp_platform_unregister(dev: *mut device) -> c_int {
