...
//! Source: sound/soc/amd/acp/acp-legacy-common.c
#![no_std]
...
pub const ACP_RENOIR_PDM_ADDR: c_uint = 0x02;
pub const ACP_REMBRANDT_PDM_ADDR: c_uint = 0x03;
pub const ACP63_PDM_ADDR: c_uint = 0x02;
pub const ACP70_PDM_ADDR: c_uint = 0x02;
...
#[no_mangle]
unsafe extern "C" fn acp_power_on(chip: *mut acp_chip_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp_reset(base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_acp3x_config(chip: *mut acp_chip_info) {
...
#[no_mangle]
unsafe extern "C" fn check_acp6x_config(chip: *mut acp_chip_info) {
...
#[no_mangle]
unsafe extern "C" fn check_acp70_config(chip: *mut acp_chip_info) {
