...
//! Source: sound/soc/amd/acp/acp-renoir.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn renoir_audio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rn_pcm_resume(dev: *mut device) -> c_int {
    ...
    SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), rn_pcm_resume)
    };
