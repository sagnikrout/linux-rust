...
//! Source: sound/soc/amd/acp/acp-sdw-legacy-mach.c
#![no_std]
...
//
    ...
    let mut soc_sdw_quirk: static unsigned long = RT711_JD1;
...
unsafe extern "C" fn soc_sdw_quirk_cb(id: *const dmi_system_id) -> c_int {
    ...
    let mut num_cpus: c_int = hweight32(soc_dai.link_mask[stream]);
    let mut num_codecs: c_int = soc_dai.num_devs[stream];
...
// create stream name according to first link id
    ...
    continue;
    let mut link_num: c_int = ffs(soc_end.link_mask) - 1;
...
#[no_mangle]
unsafe extern "C" fn soc_card_dai_links_create(card: *mut snd_soc_card) -> c_int {
