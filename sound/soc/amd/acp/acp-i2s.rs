...
//! Source: sound/soc/amd/acp/acp-i2s.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn acp_set_i2s_clk(chip: *mut acp_chip_info, dai_id: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(SNDRV_PCM_STREAM_CAPTURE: rx_mask && stream->dir ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn acp_i2s_trigger(substream: *mut snd_pcm_substream, cmd: c_int, dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp_i2s_prepare(substream: *mut snd_pcm_substream, dai: *mut snd_soc_dai) -> c_int {
    ...
    struct acp_resource *rsrc = chip.rsrc;
    struct acp_stream *stream = substream.runtime.private_data;
    let mut reg_dma_size: u32 = 0, reg_fifo_size = 0, reg_fifo_addr = 0;
    let mut phy_addr: u32 = 0, acp_fifo_addr = 0, ext_int_ctrl;
    let mut dir: c_uint = substream.stream;
    switch (dai.driver.id) {
    case I2S_SP_INSTANCE:
...
#[no_mangle]
unsafe extern "C" fn acp_i2s_startup(substream: *mut snd_pcm_substream, dai: *mut snd_soc_dai) -> c_int {
