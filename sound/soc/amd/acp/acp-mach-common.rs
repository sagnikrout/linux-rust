...
//! Source: sound/soc/amd/acp/acp-mach-common.c
#![no_std]
...
pub const PCO_PLAT_CLK: c_int = 48000000;

pub const DUAL_CHANNEL: c_int = 2;
pub const FOUR_CHANNEL: c_int = 4;

pub const NAU8821_BCLK: c_int = 1536000;
pub const NAU8821_FREQ_OUT: c_int = 12288000;
...
unsafe extern "C" fn acp_card_rt5682_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    ret = snd_soc_component_set_jack(component, &rt5682_jack, core::ptr::null_mut());
    if (ret) {
...
unsafe extern "C" fn acp_card_rt5682s_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    ret = snd_soc_component_set_jack(component, &rt5682s_jack, core::ptr::null_mut());
    if (ret) {
    dev_err(rtd.dev, "Headset Jack call-back failed: %d\n", ret);
    return ret;
    }
...
unsafe extern "C" fn acp_card_nau8825_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    ret = snd_soc_component_set_jack(component, &nau8825_jack, core::ptr::null_mut());
    if (ret) {
    dev_err(rtd.dev, "Headset Jack call-back failed: %d\n", ret);
    return ret;
    }
...
// HP jack connectors - unknown if we have jack detection
    { "Headphone Jack", core::ptr::null_mut(), "HPOL" },
    { "Headphone Jack", core::ptr::null_mut(), "HPOR" },
    { "MICL", core::ptr::null_mut(), "Headset Mic" },
    { "MICR", core::ptr::null_mut(), "Headset Mic" },
    { "DMIC", core::ptr::null_mut(), "Int Mic" },
    { "Headphone Jack", core::ptr::null_mut(), "Platform Clock" },
