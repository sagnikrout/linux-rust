...
//! Source: sound/soc/amd/renoir/acp3x-pdm-dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enable_pdm_clock(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn enable_pdm_interrupts(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn disable_pdm_interrupts(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn check_pdm_dma_status(acp_base: *mut void __iomem) -> bool {
...
#[no_mangle]
unsafe extern "C" fn start_pdm_dma(acp_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_pdm_dma(acp_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn config_acp_dma(rtd: *mut pdm_stream_instance, direction: c_int) {
