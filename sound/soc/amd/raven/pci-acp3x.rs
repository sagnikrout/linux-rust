...
//! Source: sound/soc/amd/raven/pci-acp3x.c
#![no_std]
...
pub struct acp3x_dev_data {
    ...
    pub acp3x_audio_mode: bool,
    pub res: *mut resource,
    pub pdev: [*mut platform_device; ACP3x_DEVS],
    pub pme_en: u32,
}
...
#[no_mangle]
unsafe extern "C" fn acp3x_reset(acp3x_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp3x_enable_interrupts(acp_base: *mut void __iomem) {
    static void acp3x_enable_interrupts(void __iomem *acp_base)
    {
    rv_writel(0x01, acp_base + mmACP_EXTERNAL_INTR_ENB);
    }
#[no_mangle]
unsafe extern "C" fn acp3x_disable_interrupts(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn acp3x_deinit(acp3x_base: *mut void __iomem) -> c_int {
