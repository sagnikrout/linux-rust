...
//! Source: sound/soc/amd/raven/acp3x-pcm-dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn config_acp3x_dma(rtd: *mut i2s_stream_instance, direction: c_int) {
...
#[no_mangle]
unsafe extern "C" fn acp3x_audio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp3x_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp3x_pcm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp3x_pcm_runtime_resume(dev: *mut device) -> c_int {
