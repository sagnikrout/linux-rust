...
//! Source: sound/soc/amd/acp-config.c
#![no_std]
...
pub const ACP_7_0_REV: c_uint = 0x70;
...
#[no_mangle]
unsafe extern "C" fn snd_amd_acp_acpi_find_config(pci: *mut pci_dev) -> c_int {
...
//
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(ACP_7_0_REV: pci->revision >=) -> else {
