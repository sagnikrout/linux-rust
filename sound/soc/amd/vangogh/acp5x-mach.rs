...
//! Source: sound/soc/amd/vangogh/acp5x-mach.c
#![no_std]
...
pub const ACP5X_NAU8821_BCLK: c_int = 3072000;
pub const ACP5X_NAU8821_FREQ_OUT: c_int = 12288000;
...
unsafe extern "C" fn acp5x_max98388_startup(substream: *mut snd_pcm_substream) -> c_int {
    ...
    { "Headset Mic", core::ptr::null_mut(), "Platform Clock" },
    { "Int Mic", core::ptr::null_mut(), "Platform Clock" },
    { "SPK", core::ptr::null_mut(), "Left BE_OUT" },
    { "SPK", core::ptr::null_mut(), "Right BE_OUT" },
    };
