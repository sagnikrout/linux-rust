...
//! Source: sound/soc/amd/vangogh/pci-acp5x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acp5x_dev_data {
    pub acp5x_base: *mut void __iomem,
    pub acp5x_audio_mode: bool,
    pub res: *mut resource,
    pub pdev: [*mut platform_device; ACP5x_DEVS],
}

#[no_mangle]
unsafe extern "C" fn acp5x_power_on(acp5x_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp5x_reset(acp5x_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp5x_enable_interrupts(acp5x_base: *mut void __iomem) {
    static void acp5x_enable_interrupts(void __iomem *acp5x_base)
    {
    acp_writel(0x01, acp5x_base + ACP_EXTERNAL_INTR_ENB);
    }
#[no_mangle]
unsafe extern "C" fn acp5x_disable_interrupts(acp5x_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn acp5x_init(acp5x_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp5x_deinit(acp5x_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_acp5x_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_acp5x_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(snd_acp5x_suspend, snd_acp5x_resume, core::ptr::null_mut())
    SYSTEM_SLEEP_PM_OPS(snd_acp5x_suspend, snd_acp5x_resume)
    };
#[no_mangle]
unsafe extern "C" fn snd_acp5x_remove(pci: *mut pci_dev) {
