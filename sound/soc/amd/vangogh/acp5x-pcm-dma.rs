...
//! Source: sound/soc/amd/vangogh/acp5x-pcm-dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn config_acp5x_dma(rtd: *mut i2s_stream_instance, direction: c_int) {
...
unsafe extern "C" fn acp5x_pcm_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(acp5x_pcm_suspend, acp5x_pcm_runtime_resume, core::ptr::null_mut())
