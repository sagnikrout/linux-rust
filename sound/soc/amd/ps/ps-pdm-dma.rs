...
//! Source: sound/soc/amd/ps/ps-pdm-dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acp63_enable_pdm_clock(acp_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn acp63_enable_pdm_interrupts(adata: *mut pdm_dev_data) {
...
#[no_mangle]
unsafe extern "C" fn acp63_disable_pdm_interrupts(adata: *mut pdm_dev_data) {
...
#[no_mangle]
unsafe extern "C" fn acp63_check_pdm_dma_status(acp_base: *mut void __iomem) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acp63_start_pdm_dma(acp_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp63_stop_pdm_dma(acp_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp63_config_dma(rtd: *mut pdm_stream_instance, direction: c_int) {
...
#[no_mangle]
unsafe extern "C" fn acp63_pdm_audio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp63_pdm_audio_remove(pdev: *mut platform_device) {
    static void acp63_pdm_audio_remove(struct platform_device *pdev)
    {
    pm_runtime_disable(&pdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn acp63_pdm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp63_pdm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp63_pdm_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(acp63_pdm_suspend, acp63_pdm_runtime_resume, core::ptr::null_mut())
