...
//! Source: sound/soc/amd/ps/ps-sdw-dma.c
#![no_std]
...
// Load the low address of page int ACP SRAM through SRBM
    ...
    switch (stream.instance) {
    case ACP_SDW0:
    sdw_data.acp63_sdw0_dma_stream[stream.stream_id] = core::ptr::null_mut();
    break;
    case ACP_SDW1:
    sdw_data.acp63_sdw1_dma_stream[stream.stream_id] = core::ptr::null_mut();
    break;
    default:
    return -EINVAL;
    }
    ...
    switch (stream.instance) {
    case ACP_SDW0:
    sdw_data.acp70_sdw0_dma_stream[stream.stream_id] = core::ptr::null_mut();
    break;
    case ACP_SDW1:
    sdw_data.acp70_sdw1_dma_stream[stream.stream_id] = core::ptr::null_mut();
    break;
    default:
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn acp63_sdw_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp63_sdw_platform_remove(pdev: *mut platform_device) {
    static void acp63_sdw_platform_remove(struct platform_device *pdev)
    {
    pm_runtime_disable(&pdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn acp63_restore_sdw_dma_config(sdw_data: *mut sdw_dma_dev_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp70_restore_sdw_dma_config(sdw_data: *mut sdw_dma_dev_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp63_sdw_pcm_resume(dev: *mut device) -> c_int {
    ...
    SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), acp63_sdw_pcm_resume)
    };
