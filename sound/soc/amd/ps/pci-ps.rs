...
//! Source: sound/soc/amd/ps/pci-ps.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn handle_acp70_sdw_wake_event(adata: *mut acp63_dev_data) {
...
#[no_mangle]
unsafe extern "C" fn check_and_handle_acp70_sdw_wake_irq(adata: *mut acp63_dev_data) -> short int {
...
#[no_mangle]
unsafe extern "C" fn acp63_irq_thread(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn acp63_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn acp_scan_sdw_devices(dev: *mut device, addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_sdw_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_sdw_exit(acp_data: *mut acp63_dev_data) -> c_int {
    static int amd_sdw_exit(struct acp63_dev_data *acp_data)
    {
    if (acp_data.sdw)
    sdw_amd_exit(acp_data.sdw);
    acp_data.sdw = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn acp63_machine_register(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_acp63_device_config(pci: *mut pci_dev, acp_data: *mut acp63_dev_data) -> c_int {
    ...
    let mut is_dmic_dev: bool = false;
    let mut is_sdw_dev: bool = false;
    bool wov_en, dmic_en;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn create_acp63_platform_devs(pci: *mut pci_dev, adata: *mut acp63_dev_data, addr: u32) -> c_int {
    ...
    acp63_fill_platform_dev_info(&pdevinfo, parent, core::ptr::null_mut(), "acp_ps_pdm_dma",
    0, adata.res, 1, core::ptr::null_mut(), 0);
    ...
    memset(&pdevinfo, 0, sizeof(pdevinfo));
    acp63_fill_platform_dev_info(&pdevinfo, parent, core::ptr::null_mut(), "dmic-codec",
    0, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    ...
    memset(&pdevinfo, 0, sizeof(pdevinfo));
    acp63_fill_platform_dev_info(&pdevinfo, parent, core::ptr::null_mut(), "amd_ps_sdw_dma",
    0, adata.res, 1, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn acp_hw_init_ops(adata: *mut acp63_dev_data, pci: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acp_disable_msi_on_resume(pdev: *mut pci_dev) {
...
//
    ...
    RUNTIME_PM_OPS(snd_acp_suspend, snd_acp_runtime_resume, core::ptr::null_mut())
