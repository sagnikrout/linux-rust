...
//! Source: sound/soc/atmel/mchp-spdiftx.c
#![no_std]
...
//
pub const SPDIFTX_CR: c_uint = 0x00	/* Control Register */;
pub const SPDIFTX_MR: c_uint = 0x04	/* Mode Register */;
pub const SPDIFTX_CDR: c_uint = 0x0C	/* Common Data Register */;
pub const SPDIFTX_IER: c_uint = 0x14	/* Interrupt Enable Register */;
pub const SPDIFTX_IDR: c_uint = 0x18	/* Interrupt Disable Register */;
pub const SPDIFTX_IMR: c_uint = 0x1C	/* Interrupt Mask Register */;
pub const SPDIFTX_ISR: c_uint = 0x20	/* Interrupt Status Register */;

pub const SPDIFTX_VERSION: c_uint = 0xF0;
//
...
#[no_mangle]
unsafe extern "C" fn mchp_spdiftx_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mchp_spdiftx_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mchp_spdiftx_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
pub const SPDIFTX_GCLK_RATIO: c_int = 128;
pub const SPDIFTX_CS_BITS: c_int = 192;
pub const SPDIFTX_UD_BITS: c_int = 192;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp_spdiftx_mixer_control {
    pub 8]: unsigned char ch_stat[SPDIFTX_CS_BITS /,
    pub 8]: unsigned char user_data[SPDIFTX_UD_BITS /,
    pub /: *mut *mut spinlock_t lock; / exclusive access to control data,
}
...
#[no_mangle]
pub unsafe extern "C" fn mchp_spdiftx_is_running(dev: *mut mchp_spdiftx_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_spdiftx_channel_status_write(dev: *mut mchp_spdiftx_dev) {
...
#[no_mangle]
unsafe extern "C" fn mchp_spdiftx_user_data_write(dev: *mut mchp_spdiftx_dev) {
...
#[no_mangle]
unsafe extern "C" fn mchp_spdiftx_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// do not start/stop while channel status or user data is updated
    ...
    struct mchp_spdiftx_mixer_control *ctrl = &dev.control;
    u32 mr;
    let mut bps: c_uint = params_physical_width(params) / 8;
    unsigned char aes3;
    int ret;
...
unsafe extern "C" fn mchp_spdiftx_dai_probe(dai: *mut snd_soc_dai) -> c_int {
    ...
    {
    struct mchp_spdiftx_dev *dev = snd_soc_dai_get_drvdata(dai);
    snd_soc_dai_init_dma_data(dai, &dev.playback, core::ptr::null_mut());
// Add controls
