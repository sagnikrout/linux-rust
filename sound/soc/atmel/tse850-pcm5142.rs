...
//! Source: sound/soc/atmel/tse850-pcm5142.c
#![no_std]
...
pub struct tse850_priv {
    ...
    struct snd_soc_card *card = snd_soc_dapm_to_card(dapm);
    struct tse850_priv *tse850 = snd_soc_card_get_drvdata(card);
    let mut connect: c_int = !!ucontrol.value.integer.value[0];
...
//
    ...
    snd_soc_dapm_mixer_update_power(dapm, kctrl, connect, core::ptr::null_mut());
    return 1;
    }
...
//
    ...
    ret = 11000000;
#[no_mangle]
pub unsafe extern "C" fn if(20000000: ret >) -> else {
    ...
    struct tse850_priv *tse850 = snd_soc_card_get_drvdata(card);
    struct soc_enum *e = (struct soc_enum *)kctrl.private_value;
    let mut uV: c_uint = ucontrol.value.enumerated.item[0];
    int ret;
    if (uV >= e.items)
    return -EINVAL;
//
...
//
    ...
    SND_SOC_DAPM_LINE("OUT1", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("OUT2", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("IN1", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("IN2", core::ptr::null_mut()),
...
//
    ...
    { "OUT1", core::ptr::null_mut(), "MUX1" },
    { "OUT2", core::ptr::null_mut(), "MUX2" },
    { "MUX1", "Loop",  "IN1" },
    { "MUX1", "Mixer", "OUT" },
    { "MUX2", "Loop",  "IN2" },
    { "MUX2", "Mixer", "OUT" },
    { "OUT", core::ptr::null_mut(), "MIX" },
    { "MIX", core::ptr::null_mut(), "DAC" },
    { "MIX", "IN Switch", "IN1" },
    { "MIX", "IN Switch", "IN2" },
// connect board input to the codec left channel output pin
    { "DAC", core::ptr::null_mut(), "OUTL" },
    };
    SND_SOC_DAILINK_DEFS(pcm,
    DAILINK_COMP_ARRAY(COMP_EMPTY()),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "pcm512x-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
