...
//! Source: sound/soc/meson/g12a-toacodec.c
#![no_std]
...
pub const TOACODEC_CTRL0: c_uint = 0x0;
pub const CTRL0_ENABLE_SHIFT: c_int = 31;
pub const CTRL0_DAT_SEL_SM1_MSB: c_int = 19;
pub const CTRL0_DAT_SEL_SM1_LSB: c_int = 18;
pub const CTRL0_DAT_SEL_MSB: c_int = 15;
pub const CTRL0_DAT_SEL_LSB: c_int = 14;
pub const CTRL0_LANE_SEL_SM1: c_int = 16;
pub const CTRL0_LANE_SEL: c_int = 12;
pub const CTRL0_LRCLK_SEL_SM1_MSB: c_int = 14;
pub const CTRL0_LRCLK_SEL_SM1_LSB: c_int = 12;
pub const CTRL0_LRCLK_SEL_MSB: c_int = 9;
pub const CTRL0_LRCLK_SEL_LSB: c_int = 8;

pub const CTRL0_BCLK_SEL_SM1_MSB: c_int = 6;
pub const CTRL0_BCLK_SEL_MSB: c_int = 5;
pub const CTRL0_BCLK_SEL_LSB: c_int = 4;

pub const TOACODEC_OUT_CHMAX: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct g12a_toacodec {
    pub field_dat_sel: *mut regmap_field,
    pub field_lrclk_sel: *mut regmap_field,
    pub field_bclk_sel: *mut regmap_field,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct g12a_toacodec_match_data {
    pub component_drv: *const snd_soc_component_driver,
    pub field_dat_sel: reg_field,
    pub field_lrclk_sel: reg_field,
    pub field_bclk_sel: reg_field,
}
...
// Initialize the static clock parameters
    ...
    { "OUT EN", "Switch", "SRC" },
    { "OUT Capture", core::ptr::null_mut(), "OUT EN" },
    };
