...
//! Source: sound/soc/meson/g12a-tohdmitx.c
#![no_std]
...
pub const TOHDMITX_CTRL0: c_uint = 0x0;
pub const CTRL0_ENABLE_SHIFT: c_int = 31;
pub const CTRL0_I2S_DAT_SEL_SHIFT: c_int = 12;

pub const CTRL0_SPDIF_SEL_SHIFT: c_int = 1;
