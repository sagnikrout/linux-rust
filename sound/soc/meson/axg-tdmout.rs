...
//! Source: sound/soc/meson/axg-tdmout.c
#![no_std]
...
pub const TDMOUT_CTRL0: c_uint = 0x00;

pub const TDMOUT_CTRL1: c_uint = 0x04;

pub const SM1_TDMOUT_CTRL1_GAIN_EN: c_int = 7;

pub const TDMOUT_CTRL1_SEL_SHIFT: c_int = 24;
pub const TDMOUT_CTRL1_GAIN_EN: c_int = 26;

pub const TDMOUT_SWAP: c_uint = 0x08;
pub const TDMOUT_MASK0: c_uint = 0x0c;
pub const TDMOUT_MASK1: c_uint = 0x10;
pub const TDMOUT_MASK2: c_uint = 0x14;
pub const TDMOUT_MASK3: c_uint = 0x18;
pub const TDMOUT_STAT: c_uint = 0x1c;
pub const TDMOUT_GAIN0: c_uint = 0x20;
pub const TDMOUT_GAIN1: c_uint = 0x24;
pub const TDMOUT_MUTE_VAL: c_uint = 0x28;
pub const TDMOUT_MUTE0: c_uint = 0x2c;
pub const TDMOUT_MUTE1: c_uint = 0x30;
pub const TDMOUT_MUTE2: c_uint = 0x34;
pub const TDMOUT_MUTE3: c_uint = 0x38;
pub const TDMOUT_MASK_VAL: c_uint = 0x3c;
...
#[no_mangle]
unsafe extern "C" fn axg_tdmout_enable(map: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn axg_tdmout_disable(map: *mut regmap) {
...
// Set static swap mask configuration
    ...
    SND_SOC_DAPM_PGA_E("ENC", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0,
    ...
    { "SRC SEL", "IN 1", "IN 1" },
    { "SRC SEL", "IN 2", "IN 2" },
    { "ENC", core::ptr::null_mut(), "SRC SEL" },
    { "OUT", core::ptr::null_mut(), "ENC" },
    };
