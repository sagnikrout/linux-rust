...
//! Source: sound/soc/meson/axg-tdm-interface.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn axg_tdm_slots_total(mask: *mut u32) -> c_uint {
    static unsigned int axg_tdm_slots_total(u32 *mask)
    {
    let mut slots: c_uint = 0;
    int i;
    if (!mask)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn axg_tdm_iface_set_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axg_tdm_iface_remove_dai(dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axg_tdm_iface_probe_dai(dai: *mut snd_soc_dai) -> c_int {
...
// TDM Backend DAIs
    ...
    { "Loopback", core::ptr::null_mut(), "Playback Signal" },
    };
...
#[no_mangle]
unsafe extern "C" fn axg_tdm_iface_probe(pdev: *mut platform_device) -> c_int {
