...
//! Source: sound/soc/sti/uniperif_player.c
#![no_std]
...
pub const SYS_CFG_AUDIO_GLUE: c_uint = 0xA4;
//
// Driver specific types.
//

pub const UNIPERIF_PLAYER_CLK_ADJ_MAX: c_int = 1000000;
...
//
#[no_mangle]
unsafe extern "C" fn uni_player_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn uni_player_clk_set_rate(player: *mut uniperif, rate: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uni_player_start(player: *mut uniperif) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uni_player_stop(player: *mut uniperif) -> c_int {
