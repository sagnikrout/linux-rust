...
//! Source: sound/soc/codecs/peb2466.c
#![no_std]
...
pub const PEB2466_NB_CHANNEL: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct peb2466 {
    ...
    pub /: *mut *mut u8 spi_tx_buf[2 + 8]; / Cannot use stack area for SPI (dma-safe memory),
    pub /: *mut *mut u8 spi_rx_buf[2 + 8]; / Cannot use stack area for SPI (dma-safe memory),
...
pub const PEB2466_CMD_MASK: c_uint = 0x18;
pub const PEB2466_CMD_XOP: c_uint = 0x18  /* XOP is 0bxxx11xxx */;
pub const PEB2466_CMD_SOP: c_uint = 0x10  /* SOP is 0bxxx10xxx */;
pub const PEB2466_CMD_COP: c_uint = 0x00  /* COP is 0bxxx0xxxx, handle 0bxxx00xxx */;
pub const PEB2466_CMD_COP1: c_uint = 0x08  /* COP is 0bxxx0xxxx, handle 0bxxx01xxx */;
...
// val = tmp;
    ...
    let mut control: snd_kcontrol_new = {0};
...
// Tone generators
    ...
    SND_SOC_DAPM_SUPPLY("CH0 PWR", PEB2466_CR1(0), 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CH1 PWR", PEB2466_CR1(1), 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CH2 PWR", PEB2466_CR1(2), 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CH3 PWR", PEB2466_CR1(3), 0, 0, core::ptr::null_mut(), 0),
    ...
    SND_SOC_DAPM_PGA("DAC0 PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DAC1 PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DAC2 PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DAC3 PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    { "CH0 DIN", core::ptr::null_mut(), "CH0 PWR" },
    { "CH1 DIN", core::ptr::null_mut(), "CH1 PWR" },
    { "CH2 DIN", core::ptr::null_mut(), "CH2 PWR" },
    { "CH3 DIN", core::ptr::null_mut(), "CH3 PWR" },
    { "CH0 TG1", core::ptr::null_mut(), "CH0 PWR" },
    { "CH1 TG1", core::ptr::null_mut(), "CH1 PWR" },
    { "CH2 TG1", core::ptr::null_mut(), "CH2 PWR" },
    { "CH3 TG1", core::ptr::null_mut(), "CH3 PWR" },
    { "CH0 TG2", core::ptr::null_mut(), "CH0 PWR" },
    { "CH1 TG2", core::ptr::null_mut(), "CH1 PWR" },
    { "CH2 TG2", core::ptr::null_mut(), "CH2 PWR" },
    { "CH3 TG2", core::ptr::null_mut(), "CH3 PWR" },
    { "DAC0 Mixer", "TG1 Switch", "CH0 TG1" },
    { "DAC0 Mixer", "TG2 Switch", "CH0 TG2" },
    { "DAC0 Mixer", "Voice Switch", "CH0 DIN" },
    { "DAC0 Mixer", core::ptr::null_mut(), "CH0 DIN" },
    { "DAC1 Mixer", "TG1 Switch", "CH1 TG1" },
    { "DAC1 Mixer", "TG2 Switch", "CH1 TG2" },
    { "DAC1 Mixer", "Voice Switch", "CH1 DIN" },
    { "DAC1 Mixer", core::ptr::null_mut(), "CH1 DIN" },
    { "DAC2 Mixer", "TG1 Switch", "CH2 TG1" },
    { "DAC2 Mixer", "TG2 Switch", "CH2 TG2" },
    { "DAC2 Mixer", "Voice Switch", "CH2 DIN" },
    { "DAC2 Mixer", core::ptr::null_mut(), "CH2 DIN" },
    { "DAC3 Mixer", "TG1 Switch", "CH3 TG1" },
    { "DAC3 Mixer", "TG2 Switch", "CH3 TG2" },
    { "DAC3 Mixer", "Voice Switch", "CH3 DIN" },
    { "DAC3 Mixer", core::ptr::null_mut(), "CH3 DIN" },
    { "DAC0 PGA", core::ptr::null_mut(), "DAC0 Mixer" },
    { "DAC1 PGA", core::ptr::null_mut(), "DAC1 Mixer" },
    { "DAC2 PGA", core::ptr::null_mut(), "DAC2 Mixer" },
    { "DAC3 PGA", core::ptr::null_mut(), "DAC3 Mixer" },
    { "OUT0", core::ptr::null_mut(), "DAC0 PGA" },
    { "OUT1", core::ptr::null_mut(), "DAC1 PGA" },
    { "OUT2", core::ptr::null_mut(), "DAC2 PGA" },
    { "OUT3", core::ptr::null_mut(), "DAC3 PGA" },
    { "ADC0", core::ptr::null_mut(), "IN0" },
    { "ADC1", core::ptr::null_mut(), "IN1" },
    { "ADC2", core::ptr::null_mut(), "IN2" },
    { "ADC3", core::ptr::null_mut(), "IN3" },
    { "ADC0", core::ptr::null_mut(), "CH0 PWR" },
    { "ADC1", core::ptr::null_mut(), "CH1 PWR" },
    { "ADC2", core::ptr::null_mut(), "CH2 PWR" },
    { "ADC3", core::ptr::null_mut(), "CH3 PWR" },
    };
...
pub struct peb2466_fw_tag_def {
    ...
    pub data): *const u16 tag, u32 lng, u8,
}
...
unsafe extern "C" fn peb2466_spi_probe(spi: *mut spi_device) -> c_int {
    ...
    return -ENOMEM;
    peb2466.spi = spi;
    peb2466.regmap = devm_regmap_init(&peb2466.spi.dev, core::ptr::null_mut(), peb2466,
