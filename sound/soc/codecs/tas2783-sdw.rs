...
//! Source: sound/soc/codecs/tas2783-sdw.c
#![no_std]
...
pub const TAS2783_PROBE_TIMEOUT: c_int = 5000;
...
pub struct calibration_data {
    pub is_valid: u32,
    pub read_sz: c_ulong,
    pub data: [u8; TAS2783_CALIB_DATA_SZ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tas2783_prv {
    pub component: *mut snd_soc_component,
    pub cali_data: calibration_data,
    pub sdw_peripheral: *mut sdw_slave,
    pub sa_func_data: *mut sdca_function_data,
    pub status: enum sdw_slave_status,
// calibration
    pub calib_lock: mutex,
// pde and firmware download
    pub pde_lock: mutex,
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub class: *mut class,
    pub cal_attr_groups: *mut attribute_group,
    pub tm: tm,
    pub rca_binaryname: [u8; 64],
    pub dev_name: [u8; 32],
    pub hw_init: bool,
// wq for firmware download
    pub fw_wait: wait_queue_head_t,
    pub fw_dl_task_done: bool,
    pub fw_dl_success: bool,
// use fallback fw name
    pub fw_use_fallback: bool,
}
...
#[no_mangle]
unsafe extern "C" fn tas2783_sdca_mbq_size(dev: *mut device, reg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tas2783_readable_register(dev: *mut device, reg: c_uint) -> bool {
    static bool tas2783_readable_register(struct device *dev, unsigned int reg)
    {
    return tas2783_sdca_mbq_size(dev, reg) > 0;
    }
#[no_mangle]
unsafe extern "C" fn tas2783_writeable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tas2783_volatile_register(dev: *mut device, reg: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tas2783_set_calib_params_to_device(tas_dev: *mut tas2783_prv, cali_data: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn tas2783_update_calibdata(tas_dev: *mut tas2783_prv) -> i32 {
    static s32 tas2783_update_calibdata(struct tas2783_prv *tas_dev)
    {
    let mut efi_guid: efi_guid_t = TAS2783_CALI_GUID;
    u32 attr, i, *tmp_val;
    unsigned long size;
    s32 ret;
    efi_status_t status;
...
#[no_mangle]
unsafe extern "C" fn tas_fw_read_hdr(data: *const u8, hdr: *mut tas_fw_hdr) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tas_fw_get_next_file(data: *const u8, file: *mut tas_fw_file) -> i32 {
...
unsafe extern "C" fn tas2783_fw_ready(fmw: *const firmware, context: *mut c_void) {
    ...
    const u8 *buf = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn tas_clear_latch(priv: *mut tas2783_prv) -> i32 {
    ...
    0, 0),
    SND_SOC_DAPM_DAC_E("FU21", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0, tas_fu21_event,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
    SND_SOC_DAPM_DAC_E("FU23", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0, tas_fu23_event,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
    SND_SOC_DAPM_OUTPUT("SPK"),
    SND_SOC_DAPM_INPUT("DMIC"),
    };
    static const struct snd_soc_dapm_route tas_audio_map[] = {
    {"FU21", core::ptr::null_mut(), "ASI"},
    {"SPK", core::ptr::null_mut(), "FU21"},
    {"FU23", core::ptr::null_mut(), "ASI"},
    {"SPK", core::ptr::null_mut(), "FU23"},
    {"ASI OUT", core::ptr::null_mut(), "DMIC"},
    };
...
#[no_mangle]
unsafe extern "C" fn tas_component_probe(component: *mut snd_soc_component) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tas_component_remove(codec: *mut snd_soc_component) {
    static void tas_component_remove(struct snd_soc_component *codec)
    {
    struct tas2783_prv *tas_dev =
    snd_soc_component_get_drvdata(codec);
    tas_dev.component = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tas_init(tas_dev: *mut tas2783_prv) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tas2783_sdca_dev_suspend(dev: *mut device) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tas2783_sdca_dev_system_suspend(dev: *mut device) -> i32 {
    static s32 tas2783_sdca_dev_system_suspend(struct device *dev)
    {
    return tas2783_sdca_dev_suspend(dev);
    }
#[no_mangle]
unsafe extern "C" fn tas2783_sdca_dev_resume(dev: *mut device) -> i32 {
    ...
    RUNTIME_PM_OPS(tas2783_sdca_dev_suspend, tas2783_sdca_dev_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn tas_generate_fw_name(slave: *mut sdw_slave, name: *mut c_char, size: usize) {
    ...
    struct pci_dev *pci = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tas_fw_load(tas_dev: *mut tas2783_prv, slave: *mut sdw_slave) -> i32 {
    static s32 tas_fw_load(struct tas2783_prv *tas_dev, struct sdw_slave *slave)
    {
    s32 ret;
    let mut unique_id: u8 = tas_dev.sdw_peripheral.id.unique_id;
...
#[no_mangle]
unsafe extern "C" fn tas_io_init(dev: *mut device, slave: *mut sdw_slave) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tas_remove(tas_dev: *mut tas2783_prv) {
...
#[no_mangle]
unsafe extern "C" fn tas_sdw_remove(peripheral: *mut sdw_slave) {
