...
//! Source: sound/soc/codecs/rtq9128.c
#![no_std]
...
pub const RTQ9128_REG_SDI_SEL: c_uint = 0x00;
pub const RTQ9128_REG_SDO_SEL: c_uint = 0x01;
pub const RTQ9128_REG_I2S_OPT: c_uint = 0x02;
pub const RTQ9128_REG_MISC: c_uint = 0x03;
pub const RTQ9128_REG_STATE_CTRL: c_uint = 0x04;
pub const RTQ9128_REG_PLLTRI_GEN1: c_uint = 0x05;
pub const RTQ9128_REG_PLLTRI_GEN2: c_uint = 0x06;
pub const RTQ9128_REG_PWM_SS_OPT: c_uint = 0x07;
pub const RTQ9128_REG_DSP_EN: c_uint = 0x08;
pub const RTQ9128_REG_TDM_TX_CH1: c_uint = 0x21;
pub const RTQ9128_REG_TDM_RX_CH1: c_uint = 0x25;
pub const RTQ9128_REG_MS_VOL: c_uint = 0x30;
pub const RTQ9128_REG_CH1_VOL: c_uint = 0x31;
pub const RTQ9128_REG_CH2_VOL: c_uint = 0x32;
pub const RTQ9128_REG_CH3_VOL: c_uint = 0x33;
pub const RTQ9128_REG_CH4_VOL: c_uint = 0x34;
pub const RTQ9128_REG_PROT_OPT: c_uint = 0x71;
pub const RTQ9128_REG_EFUSE_DATA: c_uint = 0xE0;
pub const RTQ9128_REG_VENDOR_ID: c_uint = 0xF9;
pub const RTQ9154_REG_CH1_VOL: c_uint = 0x34;
pub const RTQ9154_REG_CH2_VOL: c_uint = 0x33;
pub const RTQ9154_REG_CH3_VOL: c_uint = 0x32;
pub const RTQ9154_REG_CH4_VOL: c_uint = 0x31;
pub const RTQ9154_REG_AUTOULQM: c_uint = 0xAD;

pub const RTQ9128_SOFT_RESET_VAL: c_uint = 0x80;
pub const RTQ9128_VENDOR_ID_VAL: c_uint = 0x470;
pub const RTQ9128_ALLCH_HIZ_VAL: c_uint = 0x55;
pub const RTQ9128_ALLCH_ULQM_VAL: c_uint = 0xFF;
pub const RTQ9128_TKA470B_VAL: c_int = 0;
pub const RTQ9128_RTQ9128DH_VAL: c_uint = 0x0F;
pub const RTQ9128_RTQ9128DL_VAL: c_uint = 0x10;
pub const RTQ9154_MODEL_ID: c_uint = 0x08;
pub const RTQ9154_AUTOULQM_VAL: c_uint = 0x82;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtq9128_data {
    pub enable: *mut gpio_desc,
    pub daifmt: c_uint,
    pub tdm_slots: c_int,
    pub tdm_slot_width: c_int,
    pub tdm_input_data2_select: bool,
    pub chip_model: enum rtq9128_chip_model,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtq9128_init_reg {
    pub reg: c_uint,
    pub val: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn rtq9128_i2c_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
    static int rtq9128_i2c_write(void *context, const void *data, size_t count)
    {
    struct device *dev = context;
    struct i2c_client *i2c = to_i2c_client(dev);
    let mut reg: u8 = *(u8 *)data;
    int rg_size;
    if (count != 5) {
    ...
    return ret;
#[no_mangle]
pub unsafe extern "C" fn if(rg_size: ret !=) -> else {
    else if (ret != rg_size)
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn rtq9128_is_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtq9128_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtq9128_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
//
    ...
    shift = 6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: snd_soc_dapm_widget_name_cmp(w, 0: "DAC2") ==) -> else {
    else if (snd_soc_dapm_widget_name_cmp(w, "DAC2") == 0)
    shift = 4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: snd_soc_dapm_widget_name_cmp(w, 0: "DAC3") ==) -> else {
...
//
    ...
    SND_SOC_DAPM_DAC_E("DAC1", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0, rtq9128_dac_power_event,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_DAC_E("DAC2", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0, rtq9128_dac_power_event,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_DAC_E("DAC3", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0, rtq9128_dac_power_event,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_DAC_E("DAC4", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0, rtq9128_dac_power_event,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
    ...
    { "OUT4", core::ptr::null_mut(), "DAC4" },
    { "Capture", core::ptr::null_mut(), "DAC1" },
    { "Capture", core::ptr::null_mut(), "DAC2" },
    { "Capture", core::ptr::null_mut(), "DAC3" },
    { "Capture", core::ptr::null_mut(), "DAC4" },
    };
...
#[no_mangle]
unsafe extern "C" fn rtq9128_dai_mute_stream(dai: *mut snd_soc_dai, mute: c_int, stream: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: data->enable) -> else {
    else if (data.enable)
...
// Wait digital block to be ready
    ...
    RUNTIME_PM_OPS(rtq9128_pm_runtime_suspend, rtq9128_pm_runtime_resume, core::ptr::null_mut())
    };
