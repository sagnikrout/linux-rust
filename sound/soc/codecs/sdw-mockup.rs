...
//! Source: sound/soc/codecs/sdw-mockup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sdw_mockup_component_probe(component: *mut snd_soc_component) -> c_int {
    static int sdw_mockup_component_probe(struct snd_soc_component *component)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn sdw_mockup_component_remove(component: *mut snd_soc_component) {
