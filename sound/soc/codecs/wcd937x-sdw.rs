...
//! Source: sound/soc/codecs/wcd937x-sdw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wcd937x_rdwr_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd937x_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
unsafe extern "C" fn wcd937x_sdw_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(wcd937x_sdw_runtime_suspend, wcd937x_sdw_runtime_resume, core::ptr::null_mut())
    };
