...
//! Source: sound/soc/codecs/pm4125-sdw.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn pm4125_interrupt_callback(slave: *mut sdw_slave, status: *mut sdw_slave_intr_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm4125_rdwr_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pm4125_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pm4125_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pm4125_probe(pdev: *mut sdw_slave, id: *const sdw_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm4125_sdw_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pm4125_sdw_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(pm4125_sdw_runtime_suspend, pm4125_sdw_runtime_resume, core::ptr::null_mut())
    };
