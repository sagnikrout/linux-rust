...
//! Source: sound/soc/codecs/zl38060.c
#![no_std]
...
pub const HBI_FIRMWARE_PAGE: c_uint = 0xFF;
pub const ZL38_MAX_RAW_XFER: c_uint = 0x100;
pub const REG_TDMA_CFG_CLK: c_uint = 0x0262;
pub const CFG_CLK_PCLK_SHIFT: c_int = 4;

pub const CFG_CLK_FSRATE_MASK: c_uint = 0x7;
pub const CFG_CLK_FSRATE_8KHZ: c_uint = 0x1;
pub const CFG_CLK_FSRATE_16KHZ: c_uint = 0x2;
pub const CFG_CLK_FSRATE_48KHZ: c_uint = 0x6;
pub const REG_CLK_CFG: c_uint = 0x0016;

pub const REG_CLK_STATUS: c_uint = 0x0014;

pub const REG_PARAM_RESULT: c_uint = 0x0034;
pub const PARAM_RESULT_READY: c_uint = 0xD3D3;
pub const REG_PG255_BASE_HI: c_uint = 0x000C;

pub const REG_FWR_EXEC: c_uint = 0x012C;
pub const REG_CMD: c_uint = 0x0032;
pub const REG_HW_REV: c_uint = 0x0020;
pub const REG_FW_PROD: c_uint = 0x0022;
pub const REG_FW_REV: c_uint = 0x0024;
pub const REG_SEMA_FLAGS: c_uint = 0x0006;

pub const REG_HW_REV: c_uint = 0x0020;
pub const REG_FW_PROD: c_uint = 0x0022;
pub const REG_FW_REV: c_uint = 0x0024;
pub const REG_GPIO_DIR: c_uint = 0x02DC;
pub const REG_GPIO_DAT: c_uint = 0x02DA;
pub const BOOTCMD_LOAD_COMPLETE: c_uint = 0x000D;
pub const BOOTCMD_FW_GO: c_uint = 0x0008;
pub const FIRMWARE_MAJOR: c_int = 2;
pub const FIRMWARE_MINOR: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zl38_codec_priv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub is_stream_in_use: [bool; 2],
...
unsafe extern "C" fn zl38_fw_enter_boot_mode(regmap: *mut regmap) -> c_int {
    ...
    {
    let mut addr_base: __be32 = cpu_to_be32(addr & ~0xFF);
    int err;
...
//
    let mut addr: u32 = le32_to_cpup(data);
    let mut baddr: __be32 = cpu_to_be32(addr);
...
// output enables must be programmed next
    ...
    { "Capture",  core::ptr::null_mut(), "DMICL" },
    };
...
unsafe extern "C" fn chip_gpio_set(c: *mut gpio_chip, offset: c_uint, val: c_int) -> c_int {
    ...
    let mut mask: c_uint = BIT(offset);
...
#[no_mangle]
unsafe extern "C" fn zl38_bus_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
