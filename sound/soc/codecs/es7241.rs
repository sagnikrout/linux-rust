...
//! Source: sound/soc/codecs/es7241.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct es7241_clock_mode {
    pub rate_min: c_uint,
    pub rate_max: c_uint,
    pub slv_mfs: *mut c_uint,
    pub slv_mfs_num: c_uint,
    pub mst_mfs: c_uint,
    pub mst_m0:1: c_uint,
    pub mst_m1:1: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct es7241_chip {
    pub modes: *const es7241_clock_mode,
    pub mode_num: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct es7241_data {
    pub reset: *mut gpio_desc,
    pub m0: *mut gpio_desc,
    pub m1: *mut gpio_desc,
    pub fmt: c_uint,
    pub mclk: c_uint,
    pub is_consumer: bool,
    pub chip: *const es7241_chip,
}

#[no_mangle]
unsafe extern "C" fn es7241_set_mode(priv: *mut es7241_data, m0: c_int, m1: c_int) {
...
// Quad speed mode
    ...
    { "ADC", core::ptr::null_mut(), "AINL", },
    { "ADC", core::ptr::null_mut(), "AINR", },
    { "ADC", core::ptr::null_mut(), "VDDA", },
    { "Capture", core::ptr::null_mut(), "VDDP", },
    { "Capture", core::ptr::null_mut(), "VDDD", },
    };
...
#[no_mangle]
unsafe extern "C" fn es7241_parse_fmt(dev: *mut device, priv: *mut es7241_data) {
