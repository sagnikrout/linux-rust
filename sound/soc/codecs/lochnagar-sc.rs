...
//! Source: sound/soc/codecs/lochnagar-sc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lochnagar_sc_priv {
    pub mclk: *mut clk,
}

    static const struct snd_soc_dapm_widget lochnagar_sc_widgets[] = {
    SND_SOC_DAPM_LINE("Line Jack", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("USB Audio", core::ptr::null_mut()),
    };
    static const struct snd_soc_dapm_route lochnagar_sc_routes[] = {
    { "Line Jack", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1 Capture", core::ptr::null_mut(), "Line Jack" },
    { "USB Audio", core::ptr::null_mut(), "USB1 Playback" },
    { "USB Audio", core::ptr::null_mut(), "USB2 Playback" },
    { "USB1 Capture", core::ptr::null_mut(), "USB Audio" },
    { "USB2 Capture", core::ptr::null_mut(), "USB Audio" },
    };
...
#[no_mangle]
unsafe extern "C" fn lochnagar_sc_set_line_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lochnagar_sc_set_usb_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
