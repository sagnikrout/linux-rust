...
//! Source: sound/soc/codecs/cs42l42-sdw.c
#![no_std]
...
pub const CS42L42_SDW_CAPTURE_PORT: c_int = 1;
pub const CS42L42_SDW_PLAYBACK_PORT: c_int = 2;
// Register addresses are offset when sent over SoundWire
pub const CS42L42_SDW_ADDR_OFFSET: c_uint = 0x8000;
pub const CS42L42_SDW_MEM_ACCESS_STATUS: c_uint = 0xd0;
pub const CS42L42_SDW_MEM_READ_DATA: c_uint = 0xd8;

pub const CS42L42_DELAYED_READ_POLL_US: c_int = 1;
pub const CS42L42_DELAYED_READ_TIMEOUT_US: c_int = 100;
    static const struct snd_soc_dapm_route cs42l42_sdw_audio_map[] = {
// Playback Path
    { "HP", core::ptr::null_mut(), "MIXER" },
    { "MIXER", core::ptr::null_mut(), "DACSRC" },
    { "DACSRC", core::ptr::null_mut(), "Playback" },
// Capture Path
    { "ADCSRC", core::ptr::null_mut(), "HS" },
    { "Capture", core::ptr::null_mut(), "ADCSRC" },
    };
...
#[no_mangle]
unsafe extern "C" fn cs42l42_sdw_poll_status(peripheral: *mut sdw_slave, mask: u8, match: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l42_sdw_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l42_sdw_init(peripheral: *mut sdw_slave) {
...
//
    ...
    {
    struct cs42l42_private *cs42l42 = dev_get_drvdata(&peripheral.dev);
    let mut new_sclk: c_uint = params.curr_dr_freq / 2;
...
#[no_mangle]
unsafe extern "C" fn cs42l42_sdw_handle_unattach(cs42l42: *mut cs42l42_private) -> c_int {
...
pub unsafe extern "C" fn if(0: irq <) -> else {
    ...
    regmap = devm_regmap_init(dev, core::ptr::null_mut(), peripheral, regmap_conf);
    if (IS_ERR(regmap))
...
unsafe extern "C" fn cs42l42_sdw_remove(peripheral: *mut sdw_slave) {
    ...
    RUNTIME_PM_OPS(cs42l42_sdw_runtime_suspend, cs42l42_sdw_runtime_resume, core::ptr::null_mut())
    };
