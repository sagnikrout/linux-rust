...
//! Source: sound/soc/codecs/rtq9124.c
#![no_std]
...
pub const RTQ9124_REG_SDI_SEL: c_uint = 0x00;
pub const RTQ9124_REG_SDO_SEL: c_uint = 0x01;
pub const RTQ9124_REG_I2S_OPT: c_uint = 0x02;
pub const RTQ9124_REG_AMP_OPT: c_uint = 0x03;
pub const RTQ9124_REG_STATE_CTRL: c_uint = 0x04;
pub const RTQ9124_REG_PWM_PHASE: c_uint = 0x05;
pub const RTQ9124_REG_SIL_CTRL: c_uint = 0x06;
pub const RTQ9124_REG_PWM_SS_OPT: c_uint = 0x07;
pub const RTQ9124_REG_ERR_INT_0: c_uint = 0x10;
pub const RTQ9124_REG_ERR_MASK6: c_uint = 0x26;
pub const RTQ9124_REG_TDM_TX_CH0: c_uint = 0x32;
pub const RTQ9124_REG_TDM_RX_CH0: c_uint = 0x34;
pub const RTQ9124_REG_VOL_OPT: c_uint = 0x38;
pub const RTQ9124_REG_DCR_TH: c_uint = 0x4B;
pub const RTQ9124_REG_ERR_TH: c_uint = 0x4C;
pub const RTQ9124_REG_PROT_EN: c_uint = 0x5B;
pub const RTQ9124_REG_PRJ_CODE: c_uint = 0xF9;

pub const RTQ9124_FIXED_VENID: c_uint = 0x9124;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtq9124_priv {
...
// Before amp turn on, clear old events first
    ...
    SND_SOC_DAPM_OUT_DRV_E("Amp Drv", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0, rtq9124_enable_event,
...
#[no_mangle]
unsafe extern "C" fn rtq9124_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtq9124_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtq9124_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rtq9124_get_reg_len(reg: c_uint) -> u8 {
    ...
    let mut size: u8 = rtq9124_get_reg_len(reg);
    u32 *val = val_buf;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rtq9124_regmap_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
    static int rtq9124_regmap_write(void *context, const void *data, size_t count)
    {
    struct i2c_client *i2c = context;
    let mut reg: u8 = *(u8 *)data, *vbuf;
    let mut size: u8 = rtq9124_get_reg_len(reg);
    let mut val16: __be16 = cpu_to_be16p(data + 1);
    let mut val32: __be32 = cpu_to_be32p(data + 1);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rtq9124->enable) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(RTQ9124_FIXED_VENID: ret !=) -> else {
...
// Need to wait 10ms for the reset to complete
    ...
    regmap = devm_regmap_init(dev, core::ptr::null_mut(), i2c, &rtq9124_regmap_config);
    if (IS_ERR(regmap))
...
unsafe extern "C" fn rtq9124_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(rtq9124_runtime_suspend, rtq9124_runtime_resume, core::ptr::null_mut())
    };
