...
//! Source: sound/soc/codecs/cs47l90.c
#![no_std]
...
pub const CS47L90_NUM_ADSP: c_int = 7;
...
pub struct cs47l90 {
    ...
    { widget, core::ptr::null_mut(), name " NG Mux" }, \
    { name " NG Internal", core::ptr::null_mut(), "RXANC NG Clock" }, \
    { name " NG Internal", core::ptr::null_mut(), name " Channel" }, \
    { name " NG External", core::ptr::null_mut(), "RXANC NG External Clock" }, \
    { name " NG External", core::ptr::null_mut(), name " Channel" }, \
    ...
    { widget, core::ptr::null_mut(), name " ANC Source" }, \
    ...
    MADERA_MICB2C_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("MICBIAS2D", MADERA_MIC_BIAS_CTRL_6,
    MADERA_MICB2D_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    0, core::ptr::null_mut(), 0, madera_anc_ev,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
    ...
    SND_SOC_DAPM_AIF_OUT("AIF4TX1", core::ptr::null_mut(), 0,
    MADERA_AIF4_TX_ENABLES, MADERA_AIF4TX1_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_OUT("AIF4TX2", core::ptr::null_mut(), 1,
    ...
    MADERA_OUT3L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT3R", SND_SOC_NOPM,
    MADERA_OUT3R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
...
//
    ...
    SND_SOC_DAPM_AIF_IN("AIF4RX1", core::ptr::null_mut(), 0,
    MADERA_AIF4_RX_ENABLES, MADERA_AIF4RX1_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("AIF4RX2", core::ptr::null_mut(), 1,
    ...
    MADERA_ASRC2_IN1L_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ASRC2IN1R", MADERA_ASRC2_ENABLE,
    MADERA_ASRC2_IN1R_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ASRC2IN2L", MADERA_ASRC2_ENABLE,
    MADERA_ASRC2_IN2L_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ASRC2IN2R", MADERA_ASRC2_ENABLE,
    MADERA_ASRC2_IN2R_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    MADERA_ISRC3_DEC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC3DEC2", MADERA_ISRC_3_CTRL_3,
    MADERA_ISRC3_DEC2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC3INT1", MADERA_ISRC_3_CTRL_3,
    MADERA_ISRC3_INT1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC3INT2", MADERA_ISRC_3_CTRL_3,
    MADERA_ISRC3_INT2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC4DEC1", MADERA_ISRC_4_CTRL_3,
    MADERA_ISRC4_DEC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC4DEC2", MADERA_ISRC_4_CTRL_3,
    MADERA_ISRC4_DEC2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC4INT1", MADERA_ISRC_4_CTRL_3,
    MADERA_ISRC4_INT1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC4INT2", MADERA_ISRC_4_CTRL_3,
    MADERA_ISRC4_INT2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
...
// Internal clock domains
    ...
    { "AIF4TX1", core::ptr::null_mut(), "AIF4TXCLK" },
    { "AIF4TX2", core::ptr::null_mut(), "AIF4TXCLK" },
    ...
    { "DSP2", core::ptr::null_mut(), "DSP2CLK" },
    { "DSP3", core::ptr::null_mut(), "DSP3CLK" },
    { "DSP4", core::ptr::null_mut(), "DSP4CLK" },
    { "DSP5", core::ptr::null_mut(), "DSP5CLK" },
    { "DSP6", core::ptr::null_mut(), "DSP6CLK" },
    { "DSP7", core::ptr::null_mut(), "DSP7CLK" },
    ...
    { "ISRC3DEC1", core::ptr::null_mut(), "ISRC3CLK" },
    { "ISRC3DEC2", core::ptr::null_mut(), "ISRC3CLK" },
    { "ISRC3INT1", core::ptr::null_mut(), "ISRC3CLK" },
    { "ISRC3INT2", core::ptr::null_mut(), "ISRC3CLK" },
    { "ISRC4DEC1", core::ptr::null_mut(), "ISRC4CLK" },
    { "ISRC4DEC2", core::ptr::null_mut(), "ISRC4CLK" },
    { "ISRC4INT1", core::ptr::null_mut(), "ISRC4CLK" },
    { "ISRC4INT2", core::ptr::null_mut(), "ISRC4CLK" },
    ...
    { "ASRC2IN1L", core::ptr::null_mut(), "ASRC2CLK" },
    { "ASRC2IN1R", core::ptr::null_mut(), "ASRC2CLK" },
    { "ASRC2IN2L", core::ptr::null_mut(), "ASRC2CLK" },
    { "ASRC2IN2R", core::ptr::null_mut(), "ASRC2CLK" },
    ...
    { "AIF2 Capture", core::ptr::null_mut(), "DBVDD2" },
    { "AIF2 Playback", core::ptr::null_mut(), "DBVDD2" },
    { "AIF3 Capture", core::ptr::null_mut(), "DBVDD3" },
    { "AIF3 Playback", core::ptr::null_mut(), "DBVDD3" },
    { "AIF4 Capture", core::ptr::null_mut(), "DBVDD3" },
    { "AIF4 Playback", core::ptr::null_mut(), "DBVDD3" },
    ...
    { "IN5L", core::ptr::null_mut(), "SYSCLK" },
    { "IN5R", core::ptr::null_mut(), "SYSCLK" },
    { "IN3L", core::ptr::null_mut(), "DBVDD4" },
    { "IN3R", core::ptr::null_mut(), "DBVDD4" },
    { "IN4L", core::ptr::null_mut(), "DBVDD4" },
    { "IN4R", core::ptr::null_mut(), "DBVDD4" },
    { "IN5L", core::ptr::null_mut(), "DBVDD4" },
    { "IN5R", core::ptr::null_mut(), "DBVDD4" },
    ...
    { "ASRC2IN1L", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC2IN1R", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC2IN2L", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC2IN2R", core::ptr::null_mut(), "SYSCLK" },
    ...
    { "ASRC2IN1L", core::ptr::null_mut(), "ASYNCCLK" },
    { "ASRC2IN1R", core::ptr::null_mut(), "ASYNCCLK" },
    { "ASRC2IN2L", core::ptr::null_mut(), "ASYNCCLK" },
    { "ASRC2IN2R", core::ptr::null_mut(), "ASYNCCLK" },
    ...
    { "MICBIAS2C", core::ptr::null_mut(), "MICBIAS2" },
    { "MICBIAS2D", core::ptr::null_mut(), "MICBIAS2" },
    ...
    { "AIF4 Capture", core::ptr::null_mut(), "AIF4TX1" },
    { "AIF4 Capture", core::ptr::null_mut(), "AIF4TX2" },
    { "AIF4RX1", core::ptr::null_mut(), "AIF4 Playback" },
    { "AIF4RX2", core::ptr::null_mut(), "AIF4 Playback" },
    ...
    { "AIF4 Playback", core::ptr::null_mut(), "SYSCLK" },
    ...
    { "IN3L", core::ptr::null_mut(), "DMICCLK3" },
    { "IN3L", core::ptr::null_mut(), "DMICDAT3" },
    { "IN3R", core::ptr::null_mut(), "DMICCLK3" },
    { "IN3R", core::ptr::null_mut(), "DMICDAT3" },
    { "IN4L", core::ptr::null_mut(), "DMICCLK4" },
    { "IN4L", core::ptr::null_mut(), "DMICDAT4" },
    { "IN4R", core::ptr::null_mut(), "DMICCLK4" },
    { "IN4R", core::ptr::null_mut(), "DMICDAT4" },
    { "IN5L", core::ptr::null_mut(), "DMICCLK5" },
    { "IN5L", core::ptr::null_mut(), "DMICDAT5" },
    { "IN5R", core::ptr::null_mut(), "DMICCLK5" },
    { "IN5R", core::ptr::null_mut(), "DMICDAT5" },
    ...
    { "DSP Trigger Out", core::ptr::null_mut(), "DSP2 Trigger Output" },
    { "DSP Trigger Out", core::ptr::null_mut(), "DSP3 Trigger Output" },
    { "DSP Trigger Out", core::ptr::null_mut(), "DSP4 Trigger Output" },
    { "DSP Trigger Out", core::ptr::null_mut(), "DSP5 Trigger Output" },
    { "DSP Trigger Out", core::ptr::null_mut(), "DSP6 Trigger Output" },
    { "DSP Trigger Out", core::ptr::null_mut(), "DSP7 Trigger Output" },
    ...
    { "HPOUT3L", core::ptr::null_mut(), "OUT3L" },
    { "HPOUT3R", core::ptr::null_mut(), "OUT3R" },
...
#[no_mangle]
unsafe extern "C" fn cs47l90_adsp2_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn cs47l90_component_probe(component: *mut snd_soc_component) -> c_int {
    ...
    if (ret)
    return ret;
    ret = madera_init_outputs(component, core::ptr::null_mut(), CS47L90_MONO_OUTPUTS,
