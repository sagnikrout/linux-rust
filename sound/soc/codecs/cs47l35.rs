...
//! Source: sound/soc/codecs/cs47l35.c
#![no_std]
...
pub const CS47L35_NUM_ADSP: c_int = 3;
pub const CS47L35_MONO_OUTPUTS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn cs47l35_hp_post_enable(w: *mut snd_soc_dapm_widget) {
...
#[no_mangle]
unsafe extern "C" fn cs47l35_hp_post_disable(w: *mut snd_soc_dapm_widget) {
...
// Only get to here for OUT1L and OUT1R
    ...
    MADERA_OUT1L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, cs47l35_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT1R", SND_SOC_NOPM,
    MADERA_OUT1R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, cs47l35_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
...
// Internal clock domains
    ...
    { "AIF3 Capture", core::ptr::null_mut(), "DBVDD2" },
    { "AIF3 Playback", core::ptr::null_mut(), "DBVDD2" },
    ...
    { "Voice Control DSP", core::ptr::null_mut(), "DSP3" },
...
#[no_mangle]
unsafe extern "C" fn cs47l35_adsp2_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cs47l35_component_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l35_component_remove(component: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn cs47l35_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l35_remove(pdev: *mut platform_device) {
