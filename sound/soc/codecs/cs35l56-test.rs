...
//! Source: sound/soc/codecs/cs35l56-test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs35l56_test_priv {
    pub amp_dev: *mut faux_device,
    pub cs35l56_priv: *mut cs35l56_private,
    pub ssidexv2: *const c_char,
    pub read_onchip_spkid_called: bool,
    pub configure_onchip_spkid_pads_called: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs35l56_test_param {
    pub type: u8,
    pub rev: u8,
    pub spkid_gpios: [i32; 4],
    pub spkid_pulls: [i32; 4],
}

    static const struct software_node cs35l56_test_dev_sw_node =
    SOFTWARE_NODE("SWD1", core::ptr::null_mut(), core::ptr::null_mut());
    static const struct software_node cs35l56_test_af01_sw_node =
    SOFTWARE_NODE("AF01", core::ptr::null_mut(), &cs35l56_test_dev_sw_node);
...
#[no_mangle]
unsafe extern "C" fn cs35l56_test_dummy_read_onchip_spkid(cs35l56_base: *mut cs35l56_base) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_test_dummy_configure_onchip_spkid_pads(cs35l56_base: *mut cs35l56_base) -> c_int {
...
// Create dummy amp driver dev
    priv.amp_dev = faux_device_create("cs35l56_test_drv", core::ptr::null_mut(), core::ptr::null_mut());
