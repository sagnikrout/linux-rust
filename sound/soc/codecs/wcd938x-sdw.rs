...
//! Source: sound/soc/codecs/wcd938x-sdw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wcd938x_rdwr_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd938x_readonly_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd938x_writeable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd9380_remove(pdev: *mut sdw_slave) {
...
unsafe extern "C" fn wcd938x_sdw_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(wcd938x_sdw_runtime_suspend, wcd938x_sdw_runtime_resume, core::ptr::null_mut())
    };
