...
//! Source: sound/soc/codecs/jz4770.c
#![no_std]
...
pub const REG_AICR_DAC_ADWL_OFFSET: c_int = 6;

pub const REG_AICR_ADC_ADWL_OFFSET: c_int = 6;

pub const REG_CR_LO_MUTE_OFFSET: c_int = 7;
pub const REG_CR_LO_SB_OFFSET: c_int = 4;
pub const REG_CR_LO_SEL_OFFSET: c_int = 0;

pub const REG_CR_HP_SB_OFFSET: c_int = 4;
pub const REG_CR_HP_SB_HPCM_OFFSET: c_int = 3;
pub const REG_CR_HP_SEL_OFFSET: c_int = 0;

pub const REG_CR_DAC_SB_OFFSET: c_int = 4;

pub const REG_CR_MIC_STEREO_OFFSET: c_int = 7;
pub const REG_CR_MIC_IDIFF_OFFSET: c_int = 6;
pub const REG_CR_MIC_SB_MIC2_OFFSET: c_int = 5;
pub const REG_CR_MIC_SB_MIC1_OFFSET: c_int = 4;
pub const REG_CR_MIC_BIAS_V0_OFFSET: c_int = 1;
pub const REG_CR_MIC_BIAS_SB_OFFSET: c_int = 0;
pub const REG_CR_LI_LIBY_OFFSET: c_int = 4;
pub const REG_CR_LI_SB_OFFSET: c_int = 0;

pub const REG_CR_ADC_SB_OFFSET: c_int = 4;

pub const REG_CR_ADC_IN_SEL_OFFSET: c_int = 0;

pub const REG_CCR_CRYSTAL_OFFSET: c_int = 0;

pub const REG_FCR_DAC_FREQ_OFFSET: c_int = 0;

pub const REG_FCR_ADC_FREQ_OFFSET: c_int = 0;

pub const REG_ICR_INT_FORM_OFFSET: c_int = 6;

pub const REG_GCR_GAIN_OFFSET: c_int = 0;
pub const REG_GCR_GAIN_MAX: c_uint = 0x1f;
pub const REG_GCR_MIC_GAIN_OFFSET: c_int = 0;
pub const REG_GCR_MIC_GAIN_MAX: c_int = 5;
pub const REG_GCR_ADC_GAIN_OFFSET: c_int = 0;
pub const REG_GCR_ADC_GAIN_MAX: c_int = 23;
...
#[no_mangle]
unsafe extern "C" fn jz4770_codec_mute_stream(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
    static int jz4770_codec_mute_stream(struct snd_soc_dai *dai, int mute, int direction)
    {
    struct snd_soc_component *codec = dai.component;
    struct jz_codec *jz_codec = snd_soc_component_get_drvdata(codec);
    let mut gain_bit: c_uint = mute ? REG_IFR_GDO : REG_IFR_GUP;
    unsigned int val;
    int change, err;
...
// clear RDO flag
    ...
    REG_CR_HP_SB_OFFSET, 1, core::ptr::null_mut(), 0, hpout_event,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_PGA("Line Out", JZ4770_CODEC_REG_CR_LO,
    REG_CR_LO_SB_OFFSET, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Line Out Switch 2", JZ4770_CODEC_REG_CR_LO,
    REG_CR_LO_MUTE_OFFSET, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Line In", JZ4770_CODEC_REG_CR_LI,
    REG_CR_LI_SB_OFFSET, 1, core::ptr::null_mut(), 0),
    ...
    REG_CR_MIC_SB_MIC1_OFFSET, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic 2", JZ4770_CODEC_REG_CR_MIC,
    REG_CR_MIC_SB_MIC2_OFFSET, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic Diff", JZ4770_CODEC_REG_CR_MIC,
    REG_CR_MIC_IDIFF_OFFSET, 0, core::ptr::null_mut(), 0),
    ...
    REG_CR_LI_LIBY_OFFSET, 1, core::ptr::null_mut(), 0),
    ...
    REG_CR_MIC_BIAS_SB_OFFSET, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("Cap-less", JZ4770_CODEC_REG_CR_HP,
    REG_CR_HP_SB_HPCM_OFFSET, 1, core::ptr::null_mut(), 0),
...
// Unconditional routes.
    ...
    { "Mic Diff", core::ptr::null_mut(), "MIC1N" },
    { "Mic 1", core::ptr::null_mut(), "Mic Diff" },
    { "Mic 2", core::ptr::null_mut(), "MIC2P" },
    { "Mic Diff", core::ptr::null_mut(), "MIC2N" },
    { "Mic 2", core::ptr::null_mut(), "Mic Diff" },
    ...
    { "HP Out", core::ptr::null_mut(), "Headphones Source" },
    { "Capture Source", "Line In", "Line In" },
    { "Capture Source", "Mic 1", "Mic 1" },
    { "Capture Source", "Mic 2", "Mic 2" },
    { "ADC", core::ptr::null_mut(), "Capture Source" },
    { "Line In Bypass", core::ptr::null_mut(), "Line In" },
    ...
    { "Line Out", core::ptr::null_mut(), "Line Out Source" },
    { "Line Out Switch 2", core::ptr::null_mut(), "Line Out" },
    { "LOUT", core::ptr::null_mut(), "Line Out Switch 2"},
    { "ROUT", core::ptr::null_mut(), "Line Out Switch 2"},
    { "PCM Playback", "Volume", "DAC" },
    { "Headphones Playback", "Volume", "PCM Playback" },
    { "SYSCLK", core::ptr::null_mut(), "DAC" },
    };
#[no_mangle]
unsafe extern "C" fn jz4770_codec_codec_init_regs(codec: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn jz4770_codec_volatile(dev: *mut device, reg: c_uint) -> bool {
    static bool jz4770_codec_volatile(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = JZ4770_CODEC_REG_SR || reg == JZ4770_CODEC_REG_IFR;
    }
#[no_mangle]
unsafe extern "C" fn jz4770_codec_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn jz4770_codec_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn jz4770_codec_io_wait(codec: *mut jz_codec) -> c_int {
...
unsafe extern "C" fn jz4770_codec_probe(pdev: *mut platform_device) -> c_int {
    ...
    codec.regmap = devm_regmap_init(dev, core::ptr::null_mut(), codec,
