...
//! Source: sound/soc/codecs/tas5805m.c
#![no_std]
...
pub const REG_PAGE: c_uint = 0x00;
pub const REG_DEVICE_CTRL_1: c_uint = 0x02;
pub const REG_DEVICE_CTRL_2: c_uint = 0x03;
pub const REG_SIG_CH_CTRL: c_uint = 0x28;
pub const REG_SAP_CTRL_1: c_uint = 0x33;
pub const REG_FS_MON: c_uint = 0x37;
pub const REG_BCK_MON: c_uint = 0x38;
pub const REG_CLKDET_STATUS: c_uint = 0x39;
pub const REG_VOL_CTL: c_uint = 0x4c;
pub const REG_AGAIN: c_uint = 0x54;
pub const REG_ADR_PIN_CTRL: c_uint = 0x60;
pub const REG_ADR_PIN_CONFIG: c_uint = 0x61;
pub const REG_CHAN_FAULT: c_uint = 0x70;
pub const REG_GLOBAL_FAULT1: c_uint = 0x71;
pub const REG_GLOBAL_FAULT2: c_uint = 0x72;
pub const REG_FAULT: c_uint = 0x78;
pub const REG_BOOK: c_uint = 0x7f;
// DEVICE_CTRL_2 register values
pub const DCTRL2_MODE_DEEP_SLEEP: c_uint = 0x00;
pub const DCTRL2_MODE_SLEEP: c_uint = 0x01;
pub const DCTRL2_MODE_HIZ: c_uint = 0x02;
pub const DCTRL2_MODE_PLAY: c_uint = 0x03;
pub const DCTRL2_MUTE: c_uint = 0x08;
pub const DCTRL2_DIS_DSP: c_uint = 0x10;
...
pub const TAS5805M_VOLUME_MIN: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tas5805m_priv {
    pub i2c: *mut i2c_client,
    pub pvdd: *mut regulator,
    pub gpio_pdn_n: *mut gpio_desc,
    pub dsp_cfg_data: *mut u8,
    pub dsp_cfg_len: c_int,
...
#[no_mangle]
unsafe extern "C" fn set_dsp_scale(rm: *mut regmap, offset: c_int, vol: c_int) {
    static void set_dsp_scale(struct regmap *rm, int offset, int vol)
    {
    uint8_t v[4];
    let mut x: u32 = tas5805m_volume[vol];
    int i;
    for (i = 0; i < 4; i++) {
    v[3 - i] = x;
    x >>= 8;
...
#[no_mangle]
unsafe extern "C" fn tas5805m_refresh(tas5805m: *mut tas5805m_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn volume_is_valid(v: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tas5805m_mute(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
