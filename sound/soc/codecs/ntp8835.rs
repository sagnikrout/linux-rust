...
//! Source: sound/soc/codecs/ntp8835.c
#![no_std]
...
pub const NTP8835_INPUT_FMT: c_uint = 0x0;

pub const NTP8835_GSA_FMT: c_uint = 0x1;

pub const NTP8835_MCLK_FREQ_CTRL: c_uint = 0x2;

pub const NTP8835_SOFT_MUTE: c_uint = 0x26;

pub const NTP8835_PWM_SWITCH: c_uint = 0x27;

pub const NTP8835_PWM_MASK_CTRL0: c_uint = 0x28;

pub const NTP8835_MASTER_VOL: c_uint = 0x2e;
pub const NTP8835_CHNL_A_VOL: c_uint = 0x2f;
pub const NTP8835_CHNL_B_VOL: c_uint = 0x30;
pub const NTP8835_CHNL_C_VOL: c_uint = 0x31;

pub const NTP8835_FW_MAGIC: c_uint = 0x38383335	/* "8835" */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ntp8835_priv {
...
#[no_mangle]
unsafe extern "C" fn ntp8835_reset_gpio(ntp8835: *mut ntp8835_priv) {
...
#[no_mangle]
unsafe extern "C" fn ntp8835_load_firmware(ntp8835: *mut ntp8835_priv) -> c_int {
...
unsafe extern "C" fn ntp8835_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    return -ENOMEM;
    ntp8835.i2c = i2c;
    ntp8835.reset = devm_reset_control_get_shared(&i2c.dev, core::ptr::null_mut());
