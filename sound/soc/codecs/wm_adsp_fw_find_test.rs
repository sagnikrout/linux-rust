...
//! Source: sound/soc/codecs/wm_adsp_fw_find_test.c
#![no_std]
...
//
    ...
    fw.wmfw.firmware = core::ptr::null_mut();
    fw.coeff.firmware = core::ptr::null_mut();
    fw.wmfw.filename = core::ptr::null_mut();
    fw.coeff.filename = core::ptr::null_mut();
    }
#[no_mangle]
