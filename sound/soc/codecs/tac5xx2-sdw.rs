...
//! Source: sound/soc/codecs/tac5xx2-sdw.c
#![no_std]
...
pub const TAC5XX2_PROBE_TIMEOUT_MS: c_int = 3000;
pub const TAC5XX2_FW_CACHE_TIMEOUT_MS: c_int = 300;
...
pub const TAC_CHANNEL_LEFT: c_int = 1;
pub const TAC_CHANNEL_RIGHT: c_int = 2;
pub const TAC_JACK_MONO_CS: c_int = 2;
...
pub const TAC_DSP_ALGO_STATUS_RUNNING: c_uint = 0x20;
pub const TAC_FW_HDR_SIZE: c_int = 88;
pub const TAC_FW_FILE_HDR: c_int = 20;
pub const TAC_MAX_FW_CHUNKS: c_int = 512;
pub const TAC_UAJ_PREP_CONNECTED: c_uint = 0xff;
pub const TAC_UAJ_PREP_DISCONNECTED: c_uint = 0xdf;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tac_fw_hdr {
    pub size: u32,
...
pub struct tac5xx2_prv {
    ...
    pub status: enum sdw_slave_status,
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub hw_init: bool,
    pub first_hw_init_done: bool,
    pub part_id: u32,
    pub rev_id: u32,
    pub hs_jack: *mut snd_soc_jack,
    pub jack_type: c_int,
// Custom fw binary. UMP File Download is not used.
    pub fw_file_cnt: c_uint,
    pub fw_files: *mut tac_fw_file,
    pub fw_caching_complete: completion,
    pub fw_dl_success: bool,
    pub fw_binaryname: [u8; 64],
}
...
#[no_mangle]
unsafe extern "C" fn tac_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tac_sdca_mbq_size(dev: *mut device, reg: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tac_has_uaj_support(tac_dev: *mut tac5xx2_prv) -> bool {
...
// Port 1: Speaker Playback Path
    ...
    SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_PGA("FU21_L", FU21_L_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU21_R", FU21_R_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU23_L", FU23_L_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU23_R", FU23_R_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
...
// Port 3: Smart Mic (DMIC) Capture Path
    ...
    SND_SOC_DAPM_PGA("IT11", IT11_USAGE_REG, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CS113", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU11_L", FU11_L_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU11_R", FU11_R_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("PPU11", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("XU12", XU12_BYPASS_REG, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU113_L", FU113_L_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU113_R", FU113_R_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("OT113", OT113_USAGE_REG, 0, 0, core::ptr::null_mut(), 0),
    };
...
// Port 4: UAJ (Headphone) Playback Path
    ...
    SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_PGA("IT41", IT41_USAGE_REG, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU41_L", FU41_L_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("FU41_R", FU41_R_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("XU42", XU42_BYPASS_REG, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CS41", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
...
// Port 7: UAJ (Headset Mic) Capture Path
    ...
    SND_SOC_DAPM_PGA("FU36", FU36_MUTE_REG, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CS36", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("OT36", OT36_USAGE_REG, 0, 0, core::ptr::null_mut(), 0),
    };
    static const struct snd_soc_dapm_route tac5xx2_common_routes[] = {
// Speaker Playback Path
    {"FU21_L", core::ptr::null_mut(), "AIF1 Playback"},
    {"FU21_R", core::ptr::null_mut(), "AIF1 Playback"},
    {"FU23_L", core::ptr::null_mut(), "FU21_L"},
    {"FU23_R", core::ptr::null_mut(), "FU21_R"},
    {"SPK_L", core::ptr::null_mut(), "FU23_L"},
    {"SPK_R", core::ptr::null_mut(), "FU23_R"},
// Smart Mic DAPM Routes
    {"IT11", core::ptr::null_mut(), "DMIC_L"},
    {"IT11", core::ptr::null_mut(), "DMIC_R"},
    {"FU11_L", core::ptr::null_mut(), "IT11"},
    {"FU11_R", core::ptr::null_mut(), "IT11"},
    {"PPU11", core::ptr::null_mut(), "FU11_L"},
    {"PPU11", core::ptr::null_mut(), "FU11_R"},
    {"XU12", core::ptr::null_mut(), "PPU11"},
    {"FU113_L", core::ptr::null_mut(), "XU12"},
    {"FU113_R", core::ptr::null_mut(), "XU12"},
    {"FU113_L", core::ptr::null_mut(), "CS113"},
    {"FU113_R", core::ptr::null_mut(), "CS113"},
    {"OT113", core::ptr::null_mut(), "FU113_L"},
    {"OT113", core::ptr::null_mut(), "FU113_R"},
    {"OT113", core::ptr::null_mut(), "CS113"},
    {"AIF3 Capture", core::ptr::null_mut(), "OT113"},
    };
    static const struct snd_soc_dapm_route tac_uaj_routes[] = {
// UAJ Playback routes
    {"IT41", core::ptr::null_mut(), "AIF4 Playback"},
    {"IT41", core::ptr::null_mut(), "CS41"},
    {"FU41_L", core::ptr::null_mut(), "IT41"},
    {"FU41_R", core::ptr::null_mut(), "IT41"},
    {"XU42", core::ptr::null_mut(), "FU41_L"},
    {"XU42", core::ptr::null_mut(), "FU41_R"},
    {"OT45", core::ptr::null_mut(), "XU42"},
    {"OT45", core::ptr::null_mut(), "CS41"},
    {"HP_L", core::ptr::null_mut(), "OT45"},
    {"HP_R", core::ptr::null_mut(), "OT45"},
// UAJ Capture routes
    {"IT33", core::ptr::null_mut(), "UAJ_MIC"},
    {"IT33", core::ptr::null_mut(), "CS36"},
    {"FU36", core::ptr::null_mut(), "IT33"},
    {"OT36", core::ptr::null_mut(), "FU36"},
    {"OT36", core::ptr::null_mut(), "CS36"},
    {"AIF7 Capture", core::ptr::null_mut(), "OT36"},
    };
...
#[no_mangle]
unsafe extern "C" fn tac_clear_latch(priv: *mut tac5xx2_prv) -> c_int {
...
// CLR_REG is a self-clearing bit
    ...
    let mut stream_config: sdw_stream_config = {0};
    let mut port_config: sdw_port_config = {0};
...
// SmartAmp: no additional sample rate configuration needed
    ...
    SDCA_PDE_PS3, SDCA_PDE_PS0, core::ptr::null_mut(), 0);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn tac5xx2_sdca_btn_type(buffer: *mut c_uchar, tac_dev: *mut tac5xx2_prv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tac5xx2_sdca_button_detect(tac_dev: *mut tac5xx2_prv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tac5xx2_jack_init(tac_dev: *mut tac5xx2_prv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tac_component_probe(component: *mut snd_soc_component) -> i32 {
...
unsafe extern "C" fn tac_component_remove(codec: *mut snd_soc_component) {
    ...
    tac_dev.component = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tac_init(tac_dev: *mut tac5xx2_prv) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tac5xx2_sdca_dev_suspend(dev: *mut device) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tac5xx2_sdca_dev_system_suspend(dev: *mut device) -> i32 {
    static s32 tac5xx2_sdca_dev_system_suspend(struct device *dev)
    {
    return tac5xx2_sdca_dev_suspend(dev);
    }
#[no_mangle]
unsafe extern "C" fn tac5xx2_sdca_dev_resume(dev: *mut device) -> i32 {
...
//
    ...
    RUNTIME_PM_OPS(tac5xx2_sdca_dev_suspend, tac5xx2_sdca_dev_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn tac_fw_read_hdr(data: *const u8, hdr: *mut tac_fw_hdr) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tac_fw_get_next_file(data: *const u8, data_size: usize, file: *mut tac_fw_file) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tac_load_and_cache_firmware_async(tac_dev: *mut tac5xx2_prv) -> c_int {
    static int tac_load_and_cache_firmware_async(struct tac5xx2_prv *tac_dev)
    {
    tac_dev.fw_file_cnt = 0;
    tac_dev.fw_files = core::ptr::null_mut(); /* ready to download files */
...
#[no_mangle]
unsafe extern "C" fn tac_download(tac_dev: *mut tac5xx2_prv) -> c_int {
    static int tac_download(struct tac5xx2_prv *tac_dev)
    {
    struct tac_fw_file *files = tac_dev.fw_files;
    let mut num_files: u32 = tac_dev.fw_file_cnt;
    u32 i;
    let mut ret: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn tac_download_fw_to_hw(tac_dev: *mut tac5xx2_prv) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tac_generate_fw_name(slave: *mut sdw_slave, name: *mut c_char, size: usize) {
    static void tac_generate_fw_name(struct sdw_slave *slave, char *name, size_t size)
    {
    struct sdw_bus *bus = slave.bus;
    let mut part_id: u16 = slave.id.part_id;
    let mut unique_id: u8 = slave.id.unique_id;
...
#[no_mangle]
unsafe extern "C" fn tac_io_init(dev: *mut device, slave: *mut sdw_slave, first: bool) -> c_int {
...
unsafe extern "C" fn tac5xx2_sdw_read_prop(peripheral: *mut sdw_slave) -> c_int {
    ...
    {
    struct sdca_function_data *function_data = core::ptr::null_mut();
    struct device *dev = &peripheral.dev;
...
unsafe extern "C" fn tac_sdw_remove(peripheral: *mut sdw_slave) {
    ...
    dev_set_drvdata(&peripheral.dev, core::ptr::null_mut());
    }
