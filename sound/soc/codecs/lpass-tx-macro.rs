...
//! Source: sound/soc/codecs/lpass-tx-macro.c
#![no_std]
...
pub const CDC_TX_SWR_MIC_CLK_DEFAULT: c_int = 0;
...
pub const TX_ADC_MAX: c_int = 5;

pub const NUM_DECIMATORS: c_int = 8;
pub const TX_NUM_CLKS_MAX: c_int = 5;
pub const TX_MACRO_DMIC_UNMUTE_DELAY_MS: c_int = 40;
pub const TX_MACRO_AMIC_UNMUTE_DELAY_MS: c_int = 100;
pub const TX_MACRO_DMIC_HPF_DELAY_MS: c_int = 300;
pub const TX_MACRO_AMIC_HPF_DELAY_MS: c_int = 300;
...
pub struct hpf_work {
    pub tx: *mut tx_macro,
    pub decimator: u8,
    pub hpf_cut_off_freq: u8,
    pub dwork: delayed_work,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tx_macro_data {
    pub flags: c_uint,
    pub ver: c_uint,
    pub extra_widgets: *const snd_soc_dapm_widget,
    pub extra_widgets_num: usize,
    pub extra_routes: *const snd_soc_dapm_route,
    pub extra_routes_num: usize,
}
...
pub struct tx_macro {
    pub dev: *mut device,
    pub data: *const tx_macro_data,
    pub component: *mut snd_soc_component,
    pub tx_hpf_work: [hpf_work; NUM_DECIMATORS],
    pub tx_mute_dwork: [tx_mute_work; NUM_DECIMATORS],
    pub active_ch_mask: [c_ulong; TX_MACRO_MAX_DAIS],
    pub active_ch_cnt: [c_ulong; TX_MACRO_MAX_DAIS],
    pub active_decimator: [c_int; TX_MACRO_MAX_DAIS],
    ...
    pub fsgen: *mut clk,
    pub hw: clk_hw,
    pub dec_active: [bool; NUM_DECIMATORS],
    pub tx_mclk_users: c_int,
    pub bcs_enable: bool,
    pub dec_mode: [c_int; NUM_DECIMATORS],
...
#[no_mangle]
unsafe extern "C" fn tx_is_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tx_is_rw_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_tx_hpf_corner_freq_callback(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_mute_update_callback(work: *mut work_struct) {
...
// MSM DMIC
    ...
    CDC_TXn_ADC_DMIC_SEL_MASK, 1);
#[no_mangle]
pub unsafe extern "C" fn if(LPASS_VER_9_0_0: tx->data->ver <=) -> else {
    ...
    let mut dai_id: u32 = widget.shift;
    let mut dec_id: u32 = mc.shift;
    struct tx_macro *tx = snd_soc_component_get_drvdata(component);
    ...
    let mut dai_id: u32 = widget.shift;
    let mut dec_id: u32 = mc.shift;
    let mut enable: u32 = ucontrol.value.integer.value[0];
    struct tx_macro *tx = snd_soc_component_get_drvdata(component);
    if (enable) {
    ...
    u8 hpf_cut_off_freq;
    let mut hpf_delay: c_int = TX_MACRO_DMIC_HPF_DELAY_MS;
    let mut unmute_delay: c_int = TX_MACRO_DMIC_UNMUTE_DELAY_MS;
...
//
    ...
    {
    struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
    let mut value: c_int = ucontrol.value.enumerated.item[0];
    struct soc_enum *e = (struct soc_enum *)kcontrol.private_value;
    let mut path: c_int = e.shift_l;
    struct tx_macro *tx = snd_soc_component_get_drvdata(component);
...
#[no_mangle]
unsafe extern "C" fn tx_macro_digital_mute(dai: *mut snd_soc_dai, mute: c_int, stream: c_int) -> c_int {
...
// active decimator not set yet
    ...
    0, adc_mux_text);
    let mut tx_dec0_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec0", tx_dec0_enum);
    let mut tx_dec1_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec1", tx_dec1_enum);
    let mut tx_dec2_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec2", tx_dec2_enum);
    let mut tx_dec3_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec3", tx_dec3_enum);
    let mut tx_dec4_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec4", tx_dec4_enum);
    let mut tx_dec5_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec5", tx_dec5_enum);
    let mut tx_dec6_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec6", tx_dec6_enum);
    let mut tx_dec7_mux: static struct snd_kcontrol_new = SOC_DAPM_ENUM("tx_dec7", tx_dec7_enum);
    ...
    SND_SOC_DAPM_SUPPLY_S("TX_SWR_CLK", 0, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY_S("VA_SWR_CLK", 0, SND_SOC_NOPM, 0, 0,
    core::ptr::null_mut(), 0),
    };
    static const struct snd_soc_dapm_route tx_audio_map[] = {
    {"TX_AIF1 CAP", core::ptr::null_mut(), "TX_MCLK"},
    {"TX_AIF2 CAP", core::ptr::null_mut(), "TX_MCLK"},
    {"TX_AIF3 CAP", core::ptr::null_mut(), "TX_MCLK"},
    {"TX_AIF1 CAP", core::ptr::null_mut(), "TX_AIF1_CAP Mixer"},
    {"TX_AIF2 CAP", core::ptr::null_mut(), "TX_AIF2_CAP Mixer"},
    {"TX_AIF3 CAP", core::ptr::null_mut(), "TX_AIF3_CAP Mixer"},
    ...
    {"TX DEC0 MUX", core::ptr::null_mut(), "TX_MCLK"},
    {"TX DEC1 MUX", core::ptr::null_mut(), "TX_MCLK"},
    {"TX DEC2 MUX", core::ptr::null_mut(), "TX_MCLK"},
    {"TX DEC3 MUX", core::ptr::null_mut(), "TX_MCLK"},
    {"TX DEC4 MUX", core::ptr::null_mut(), "TX_MCLK"},
    {"TX DEC5 MUX", core::ptr::null_mut(), "TX_MCLK"},
    {"TX DEC6 MUX", core::ptr::null_mut(), "TX_MCLK"},
    {"TX DEC7 MUX", core::ptr::null_mut(), "TX_MCLK"},
...
// Controls and routes specific to LPASS <= v9.0.0
    ...
    {"TX SMIC MUX0", core::ptr::null_mut(), "TX_SWR_CLK"},
    ...
    {"TX SMIC MUX1", core::ptr::null_mut(), "TX_SWR_CLK"},
    ...
    {"TX SMIC MUX2", core::ptr::null_mut(), "TX_SWR_CLK"},
    ...
    {"TX SMIC MUX3", core::ptr::null_mut(), "TX_SWR_CLK"},
    ...
    {"TX SMIC MUX4", core::ptr::null_mut(), "TX_SWR_CLK"},
    ...
    {"TX SMIC MUX5", core::ptr::null_mut(), "TX_SWR_CLK"},
    ...
    {"TX SMIC MUX6", core::ptr::null_mut(), "TX_SWR_CLK"},
    ...
    {"TX SMIC MUX7", core::ptr::null_mut(), "TX_SWR_CLK"},
...
#[no_mangle]
unsafe extern "C" fn tx_macro_component_extend(comp: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_component_probe(comp: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_register_mclk_output(tx: *mut tx_macro) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_macro_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(tx_macro_runtime_suspend, tx_macro_runtime_resume, core::ptr::null_mut())
    };
