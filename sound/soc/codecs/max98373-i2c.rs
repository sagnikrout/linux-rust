...
//! Source: sound/soc/codecs/max98373-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn max98373_get_bclk_sel(bclk: c_int) -> c_int {
...
// BCLK/LRCLK ratio calculation
    let mut blr_clk_ratio: c_int = params_channels(params) * max98373.ch_size;
    int value;
...
#[no_mangle]
unsafe extern "C" fn max98373_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max98373_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
unsafe extern "C" fn max98373_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    let mut reg: c_int = 0;
    int i;
    struct max98373_priv *max98373 = core::ptr::null_mut();
