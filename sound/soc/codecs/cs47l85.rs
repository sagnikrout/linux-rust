...
//! Source: sound/soc/codecs/cs47l85.c
#![no_std]
...
pub const CS47L85_NUM_ADSP: c_int = 7;
pub const CS47L85_MONO_OUTPUTS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs47l85 {
...
#[no_mangle]
unsafe extern "C" fn cs47l85_hp_post_enable(w: *mut snd_soc_dapm_widget) {
...
#[no_mangle]
unsafe extern "C" fn cs47l85_hp_post_disable(w: *mut snd_soc_dapm_widget) {
...
// Only get to here for OUT1L and OUT1R
    ...
    MADERA_OUT1L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, cs47l85_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT1R", SND_SOC_NOPM,
    MADERA_OUT1R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, cs47l85_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT2L", MADERA_OUTPUT_ENABLES_1,
    MADERA_OUT2L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT2R", MADERA_OUTPUT_ENABLES_1,
    MADERA_OUT2R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    ...
    MADERA_OUT4R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_spk_ev,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
    ...
    MADERA_OUT6L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT6R", MADERA_OUTPUT_ENABLES_1,
    MADERA_OUT6R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
...
// Internal clock domains
    ...
    { "OUT4R", core::ptr::null_mut(), "OUTCLK" },
    { "OUT5L", core::ptr::null_mut(), "OUTCLK" },
    { "OUT5R", core::ptr::null_mut(), "OUTCLK" },
    { "OUT6L", core::ptr::null_mut(), "OUTCLK" },
    { "OUT6R", core::ptr::null_mut(), "OUTCLK" },
    ...
    { "OUT4L", core::ptr::null_mut(), "SPKVDDL" },
    { "OUT4R", core::ptr::null_mut(), "SPKVDDR" },
    ...
    { "OUT4R", core::ptr::null_mut(), "SYSCLK" },
    { "OUT5L", core::ptr::null_mut(), "SYSCLK" },
    { "OUT5R", core::ptr::null_mut(), "SYSCLK" },
    { "OUT6L", core::ptr::null_mut(), "SYSCLK" },
    { "OUT6R", core::ptr::null_mut(), "SYSCLK" },
    ...
    { "IN6L", core::ptr::null_mut(), "SYSCLK" },
    { "IN6R", core::ptr::null_mut(), "SYSCLK" },
    { "IN4L", core::ptr::null_mut(), "DBVDD4" },
    { "IN4R", core::ptr::null_mut(), "DBVDD4" },
    { "IN5L", core::ptr::null_mut(), "DBVDD4" },
    { "IN5R", core::ptr::null_mut(), "DBVDD4" },
    { "IN6L", core::ptr::null_mut(), "DBVDD4" },
    { "IN6R", core::ptr::null_mut(), "DBVDD4" },
    ...
    { "MICBIAS3", core::ptr::null_mut(), "MICVDD" },
    { "MICBIAS4", core::ptr::null_mut(), "MICVDD" },
    ...
    { "IN3L", core::ptr::null_mut(), "IN3L Mode" },
    { "IN3R", core::ptr::null_mut(), "IN3R Mode" },
    ...
    { "IN6L", core::ptr::null_mut(), "DMICCLK6" },
    { "IN6L", core::ptr::null_mut(), "DMICDAT6" },
    { "IN6R", core::ptr::null_mut(), "DMICCLK6" },
    { "IN6R", core::ptr::null_mut(), "DMICDAT6" },
    ...
    { "SPKOUTLN", core::ptr::null_mut(), "OUT4L" },
    { "SPKOUTLP", core::ptr::null_mut(), "OUT4L" },
    { "AEC1 Loopback", "SPKOUTR", "OUT4R" },
    { "AEC2 Loopback", "SPKOUTR", "OUT4R" },
    { "SPKOUTRN", core::ptr::null_mut(), "OUT4R" },
    { "SPKOUTRP", core::ptr::null_mut(), "OUT4R" },
    ...
    { "SPKDAT2L", core::ptr::null_mut(), "OUT6L" },
    { "SPKDAT2R", core::ptr::null_mut(), "OUT6R" },
...
#[no_mangle]
unsafe extern "C" fn cs47l85_adsp2_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cs47l85_component_probe(component: *mut snd_soc_component) -> c_int {
    ...
    if (ret)
    return ret;
    ret = madera_init_outputs(component, core::ptr::null_mut(), CS47L85_MONO_OUTPUTS,
...
#[no_mangle]
unsafe extern "C" fn cs47l85_component_remove(component: *mut snd_soc_component) {
...
pub const MADERA_DIG_VU: c_uint = 0x0200;
...
#[no_mangle]
unsafe extern "C" fn cs47l85_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l85_remove(pdev: *mut platform_device) {
