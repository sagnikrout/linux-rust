...
//! Source: sound/soc/codecs/cs42l83-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cs42l83_i2c_probe(i2c_client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l83_i2c_resume(dev: *mut device) -> c_int {
