...
//! Source: sound/soc/codecs/wm8958-dsp2.c
#![no_std]
...
pub const WM_FW_BLOCK_INFO: c_uint = 0xff;
pub const WM_FW_BLOCK_PM: c_uint = 0x00;
pub const WM_FW_BLOCK_X: c_uint = 0x01;
pub const WM_FW_BLOCK_Y: c_uint = 0x02;
pub const WM_FW_BLOCK_Z: c_uint = 0x03;
pub const WM_FW_BLOCK_I: c_uint = 0x06;
pub const WM_FW_BLOCK_A: c_uint = 0x08;
pub const WM_FW_BLOCK_C: c_uint = 0x0c;
...
#[no_mangle]
unsafe extern "C" fn wm8958_dsp_start_mbc(component: *mut snd_soc_component, path: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wm8958_dsp_start_vss(component: *mut snd_soc_component, path: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wm8958_dsp_start_enh_eq(component: *mut snd_soc_component, path: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wm8958_dsp_apply(component: *mut snd_soc_component, path: c_int, start: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: wm8994->mbc_ena[path]) -> else {
...
#[no_mangle]
unsafe extern "C" fn wm8958_dsp2_busy(wm8994: *mut wm8994_priv, aif: c_int) -> c_int {
...
// Don't allow on the fly reconfiguration
    ...
    struct snd_ctl_elem_value *ucontrol)
    {
    let mut mbc: c_int = kcontrol.private_value;
    struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
    struct wm8994_priv *wm8994 = snd_soc_component_get_drvdata(component);
...
// Don't allow on the fly reconfiguration
    ...
    struct snd_ctl_elem_value *ucontrol)
    {
    let mut vss: c_int = kcontrol.private_value;
    struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
    struct wm8994_priv *wm8994 = snd_soc_component_get_drvdata(component);
    ...
    struct snd_ctl_elem_value *ucontrol)
    {
    let mut hpf: c_int = kcontrol.private_value;
    struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
    struct wm8994_priv *wm8994 = snd_soc_component_get_drvdata(component);
    if (hpf < 3)
...
// Don't allow on the fly reconfiguration
    ...
    struct snd_ctl_elem_value *ucontrol)
    {
    let mut eq: c_int = kcontrol.private_value;
    struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
    struct wm8994_priv *wm8994 = snd_soc_component_get_drvdata(component);
