...
//! Source: sound/soc/codecs/wm1250-ev1.c
#![no_std]
...
pub struct wm1250_priv {
    pub clk_ena: *mut gpio_desc,
    pub clk_sel0: *mut gpio_desc,
    pub clk_sel1: *mut gpio_desc,
    pub osr: *mut gpio_desc,
    pub master: *mut gpio_desc,
}
    ...
    { "ADC", core::ptr::null_mut(), "WM1250 Input" },
    { "WM1250 Output", core::ptr::null_mut(), "DAC" },
    };
...
unsafe extern "C" fn wm1250_ev1_probe(i2c: *mut i2c_client) -> c_int {
    ...
    dev_set_drvdata(&i2c.dev, core::ptr::null_mut());
