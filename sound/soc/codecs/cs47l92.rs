...
//! Source: sound/soc/codecs/cs47l92.c
#![no_std]
...
pub const CS47L92_NUM_ADSP: c_int = 1;
pub const CS47L92_MONO_OUTPUTS: c_int = 3;
...
// wait for wseq
    ...
    ret = snd_soc_dapm_mux_update_power(dapm, kcontrol, mux, e, core::ptr::null_mut());
    if (ret < 0) {
    ...
    MADERA_OPCLK_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("ASYNCOPCLK", MADERA_OUTPUT_ASYNC_CLOCK,
    MADERA_OPCLK_ASYNC_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    SND_SOC_DAPM_AIF_OUT("AIF2TX7", core::ptr::null_mut(), 6,
    MADERA_AIF2_TX_ENABLES, MADERA_AIF2TX7_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_OUT("AIF2TX8", core::ptr::null_mut(), 7,
    ...
    SND_SOC_DAPM_AIF_OUT("AIF3TX3", core::ptr::null_mut(), 2,
    MADERA_AIF3_TX_ENABLES, MADERA_AIF3TX3_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_OUT("AIF3TX4", core::ptr::null_mut(), 3,
    MADERA_AIF3_TX_ENABLES, MADERA_AIF3TX4_ENA_SHIFT, 0),
    SND_SOC_DAPM_PGA_E("OUT1L", SND_SOC_NOPM,
    MADERA_OUT1L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT1R", SND_SOC_NOPM,
    MADERA_OUT1R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT2L", SND_SOC_NOPM,
    MADERA_OUT2L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT2R", SND_SOC_NOPM,
    MADERA_OUT2R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_hp_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT3L", MADERA_OUTPUT_ENABLES_1,
    MADERA_OUT3L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT3R", MADERA_OUTPUT_ENABLES_1,
    MADERA_OUT3R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT5L", MADERA_OUTPUT_ENABLES_1,
    MADERA_OUT5L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("OUT5R", MADERA_OUTPUT_ENABLES_1,
    MADERA_OUT5R_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_out_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA("SPD1TX1", MADERA_SPD1_TX_CONTROL,
    MADERA_SPD1_VAL1_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("SPD1TX2", MADERA_SPD1_TX_CONTROL,
    MADERA_SPD1_VAL2_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_OUT_DRV("SPD1", MADERA_SPD1_TX_CONTROL,
    MADERA_SPD1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
//
// mux_in widgets : arranged in the order of sources
// specified in MADERA_MIXER_INPUT_ROUTES
//
    SND_SOC_DAPM_PGA("Noise Generator", MADERA_COMFORT_NOISE_GENERATOR,
    MADERA_NOISE_GEN_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Tone Generator 1", MADERA_TONE_GENERATOR_1,
    MADERA_TONE1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Tone Generator 2", MADERA_TONE_GENERATOR_1,
    MADERA_TONE2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    0, core::ptr::null_mut(), 0, madera_in_ev,
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD |
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU),
    ...
    SND_SOC_DAPM_AIF_IN("AIF2RX7", core::ptr::null_mut(), 6,
    MADERA_AIF2_RX_ENABLES, MADERA_AIF2RX7_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("AIF2RX8", core::ptr::null_mut(), 7,
    ...
    SND_SOC_DAPM_AIF_IN("AIF3RX3", core::ptr::null_mut(), 2,
    MADERA_AIF3_RX_ENABLES, MADERA_AIF3RX3_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("AIF3RX4", core::ptr::null_mut(), 3,
    MADERA_AIF3_RX_ENABLES, MADERA_AIF3RX4_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX1", core::ptr::null_mut(), 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX1_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX2", core::ptr::null_mut(), 1, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX2_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX3", core::ptr::null_mut(), 2, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX3_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX4", core::ptr::null_mut(), 3, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX4_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX5", core::ptr::null_mut(), 4, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX5_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX6", core::ptr::null_mut(), 5, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX6_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX7", core::ptr::null_mut(), 6, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX7_ENA_SHIFT, 0),
    SND_SOC_DAPM_AIF_IN("SLIMRX8", core::ptr::null_mut(), 7, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
    MADERA_SLIMRX8_ENA_SHIFT, 0),
    SND_SOC_DAPM_PGA("EQ1", MADERA_EQ1_1, MADERA_EQ1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("EQ2", MADERA_EQ2_1, MADERA_EQ2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("EQ3", MADERA_EQ3_1, MADERA_EQ3_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("EQ4", MADERA_EQ4_1, MADERA_EQ4_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    MADERA_ASRC1_IN1L_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ASRC1IN1R", MADERA_ASRC1_ENABLE,
    MADERA_ASRC1_IN1R_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ASRC1IN2L", MADERA_ASRC1_ENABLE,
    MADERA_ASRC1_IN2L_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ASRC1IN2R", MADERA_ASRC1_ENABLE,
    MADERA_ASRC1_IN2R_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC1DEC1", MADERA_ISRC_1_CTRL_3,
    MADERA_ISRC1_DEC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC1DEC2", MADERA_ISRC_1_CTRL_3,
    MADERA_ISRC1_DEC2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC1INT1", MADERA_ISRC_1_CTRL_3,
    MADERA_ISRC1_INT1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC1INT2", MADERA_ISRC_1_CTRL_3,
    MADERA_ISRC1_INT2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC2DEC1", MADERA_ISRC_2_CTRL_3,
    MADERA_ISRC2_DEC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC2DEC2", MADERA_ISRC_2_CTRL_3,
    MADERA_ISRC2_DEC2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC2INT1", MADERA_ISRC_2_CTRL_3,
    MADERA_ISRC2_INT1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC2INT2", MADERA_ISRC_2_CTRL_3,
    MADERA_ISRC2_INT2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    WM_ADSP2("DSP1", 0, cs47l92_adsp_power_ev),
// end of ordered widget list
    SND_SOC_DAPM_PGA("DFC1", MADERA_DFC1_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DFC2", MADERA_DFC2_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DFC3", MADERA_DFC3_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DFC4", MADERA_DFC4_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DFC5", MADERA_DFC5_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DFC6", MADERA_DFC6_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DFC7", MADERA_DFC7_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("DFC8", MADERA_DFC8_CTRL, MADERA_DFC1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
...
// Internal clock domains
    { "EQ1", core::ptr::null_mut(), "FXCLK" },
    { "EQ2", core::ptr::null_mut(), "FXCLK" },
    { "EQ3", core::ptr::null_mut(), "FXCLK" },
    { "EQ4", core::ptr::null_mut(), "FXCLK" },
    { "DRC1L", core::ptr::null_mut(), "FXCLK" },
    { "DRC1R", core::ptr::null_mut(), "FXCLK" },
    { "DRC2L", core::ptr::null_mut(), "FXCLK" },
    { "DRC2R", core::ptr::null_mut(), "FXCLK" },
    { "LHPF1", core::ptr::null_mut(), "FXCLK" },
    { "LHPF2", core::ptr::null_mut(), "FXCLK" },
    { "LHPF3", core::ptr::null_mut(), "FXCLK" },
    { "LHPF4", core::ptr::null_mut(), "FXCLK" },
    { "PWM1 Mixer", core::ptr::null_mut(), "PWMCLK" },
    { "PWM2 Mixer", core::ptr::null_mut(), "PWMCLK" },
    { "OUT1L", core::ptr::null_mut(), "OUTCLK" },
    { "OUT1R", core::ptr::null_mut(), "OUTCLK" },
    { "OUT2L", core::ptr::null_mut(), "OUTCLK" },
    { "OUT2R", core::ptr::null_mut(), "OUTCLK" },
    { "OUT3L", core::ptr::null_mut(), "OUTCLK" },
    { "OUT3R", core::ptr::null_mut(), "OUTCLK" },
    { "OUT5L", core::ptr::null_mut(), "OUTCLK" },
    { "OUT5R", core::ptr::null_mut(), "OUTCLK" },
    { "AIF1TX1", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF1TX2", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF1TX3", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF1TX4", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF1TX5", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF1TX6", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF1TX7", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF1TX8", core::ptr::null_mut(), "AIF1TXCLK" },
    { "AIF2TX1", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF2TX2", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF2TX3", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF2TX4", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF2TX5", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF2TX6", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF2TX7", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF2TX8", core::ptr::null_mut(), "AIF2TXCLK" },
    { "AIF3TX1", core::ptr::null_mut(), "AIF3TXCLK" },
    { "AIF3TX2", core::ptr::null_mut(), "AIF3TXCLK" },
    { "AIF3TX3", core::ptr::null_mut(), "AIF3TXCLK" },
    { "AIF3TX4", core::ptr::null_mut(), "AIF3TXCLK" },
    { "SLIMTX1", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SLIMTX2", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SLIMTX3", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SLIMTX4", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SLIMTX5", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SLIMTX6", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SLIMTX7", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SLIMTX8", core::ptr::null_mut(), "SLIMBUSCLK" },
    { "SPD1TX1", core::ptr::null_mut(), "SPDCLK" },
    { "SPD1TX2", core::ptr::null_mut(), "SPDCLK" },
    { "DSP1", core::ptr::null_mut(), "DSP1CLK" },
    { "ISRC1DEC1", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1DEC2", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1INT1", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1INT2", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC2DEC1", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2DEC2", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2INT1", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2INT2", core::ptr::null_mut(), "ISRC2CLK" },
    { "ASRC1IN1L", core::ptr::null_mut(), "ASRC1CLK" },
    { "ASRC1IN1R", core::ptr::null_mut(), "ASRC1CLK" },
    { "ASRC1IN2L", core::ptr::null_mut(), "ASRC1CLK" },
    { "ASRC1IN2R", core::ptr::null_mut(), "ASRC1CLK" },
    { "DFC1", core::ptr::null_mut(), "DFCCLK" },
    { "DFC2", core::ptr::null_mut(), "DFCCLK" },
    { "DFC3", core::ptr::null_mut(), "DFCCLK" },
    { "DFC4", core::ptr::null_mut(), "DFCCLK" },
    { "DFC5", core::ptr::null_mut(), "DFCCLK" },
    { "DFC6", core::ptr::null_mut(), "DFCCLK" },
    { "DFC7", core::ptr::null_mut(), "DFCCLK" },
    { "DFC8", core::ptr::null_mut(), "DFCCLK" },
    { "OUT1L", core::ptr::null_mut(), "CPVDD1" },
    { "OUT1L", core::ptr::null_mut(), "CPVDD2" },
    { "OUT1R", core::ptr::null_mut(), "CPVDD1" },
    { "OUT1R", core::ptr::null_mut(), "CPVDD2" },
    { "OUT2L", core::ptr::null_mut(), "CPVDD1" },
    { "OUT2L", core::ptr::null_mut(), "CPVDD2" },
    { "OUT2R", core::ptr::null_mut(), "CPVDD1" },
    { "OUT2R", core::ptr::null_mut(), "CPVDD2" },
    { "OUT3L", core::ptr::null_mut(), "CPVDD1" },
    { "OUT3L", core::ptr::null_mut(), "CPVDD2" },
    { "OUT3R", core::ptr::null_mut(), "CPVDD1" },
    { "OUT3R", core::ptr::null_mut(), "CPVDD2" },
    { "OUT1L", core::ptr::null_mut(), "SYSCLK" },
    { "OUT1R", core::ptr::null_mut(), "SYSCLK" },
    { "OUT2L", core::ptr::null_mut(), "SYSCLK" },
    { "OUT2R", core::ptr::null_mut(), "SYSCLK" },
    { "OUT3L", core::ptr::null_mut(), "SYSCLK" },
    { "OUT3R", core::ptr::null_mut(), "SYSCLK" },
    { "OUT5L", core::ptr::null_mut(), "SYSCLK" },
    { "OUT5R", core::ptr::null_mut(), "SYSCLK" },
    { "SPD1", core::ptr::null_mut(), "SYSCLK" },
    { "SPD1", core::ptr::null_mut(), "SPD1TX1" },
    { "SPD1", core::ptr::null_mut(), "SPD1TX2" },
    { "IN1L", core::ptr::null_mut(), "SYSCLK" },
    { "IN1R", core::ptr::null_mut(), "SYSCLK" },
    { "IN2L", core::ptr::null_mut(), "SYSCLK" },
    { "IN2R", core::ptr::null_mut(), "SYSCLK" },
    { "IN3L", core::ptr::null_mut(), "SYSCLK" },
    { "IN3R", core::ptr::null_mut(), "SYSCLK" },
    { "IN4L", core::ptr::null_mut(), "SYSCLK" },
    { "IN4R", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC1IN1L", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC1IN1R", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC1IN2L", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC1IN2R", core::ptr::null_mut(), "SYSCLK" },
    { "ASRC1IN1L", core::ptr::null_mut(), "ASYNCCLK" },
    { "ASRC1IN1R", core::ptr::null_mut(), "ASYNCCLK" },
    { "ASRC1IN2L", core::ptr::null_mut(), "ASYNCCLK" },
    { "ASRC1IN2R", core::ptr::null_mut(), "ASYNCCLK" },
    { "MICBIAS1", core::ptr::null_mut(), "MICVDD" },
    { "MICBIAS2", core::ptr::null_mut(), "MICVDD" },
    { "MICBIAS1A", core::ptr::null_mut(), "MICBIAS1" },
    { "MICBIAS1B", core::ptr::null_mut(), "MICBIAS1" },
    { "MICBIAS1C", core::ptr::null_mut(), "MICBIAS1" },
    { "MICBIAS1D", core::ptr::null_mut(), "MICBIAS1" },
    { "MICBIAS2A", core::ptr::null_mut(), "MICBIAS2" },
    { "MICBIAS2B", core::ptr::null_mut(), "MICBIAS2" },
    { "Noise Generator", core::ptr::null_mut(), "SYSCLK" },
    { "Tone Generator 1", core::ptr::null_mut(), "SYSCLK" },
    { "Tone Generator 2", core::ptr::null_mut(), "SYSCLK" },
    { "Noise Generator", core::ptr::null_mut(), "NOISE" },
    { "Tone Generator 1", core::ptr::null_mut(), "TONE" },
    { "Tone Generator 2", core::ptr::null_mut(), "TONE" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX1" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX2" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX3" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX4" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX5" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX6" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX7" },
    { "AIF1 Capture", core::ptr::null_mut(), "AIF1TX8" },
    { "AIF1RX1", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1RX2", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1RX3", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1RX4", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1RX5", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1RX6", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1RX7", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF1RX8", core::ptr::null_mut(), "AIF1 Playback" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX1" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX2" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX3" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX4" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX5" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX6" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX7" },
    { "AIF2 Capture", core::ptr::null_mut(), "AIF2TX8" },
    { "AIF2RX1", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF2RX2", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF2RX3", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF2RX4", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF2RX5", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF2RX6", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF2RX7", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF2RX8", core::ptr::null_mut(), "AIF2 Playback" },
    { "AIF3 Capture", core::ptr::null_mut(), "AIF3TX1" },
    { "AIF3 Capture", core::ptr::null_mut(), "AIF3TX2" },
    { "AIF3 Capture", core::ptr::null_mut(), "AIF3TX3" },
    { "AIF3 Capture", core::ptr::null_mut(), "AIF3TX4" },
    { "AIF3RX1", core::ptr::null_mut(), "AIF3 Playback" },
    { "AIF3RX2", core::ptr::null_mut(), "AIF3 Playback" },
    { "AIF3RX3", core::ptr::null_mut(), "AIF3 Playback" },
    { "AIF3RX4", core::ptr::null_mut(), "AIF3 Playback" },
    { "Slim1 Capture", core::ptr::null_mut(), "SLIMTX1" },
    { "Slim1 Capture", core::ptr::null_mut(), "SLIMTX2" },
    { "Slim1 Capture", core::ptr::null_mut(), "SLIMTX3" },
    { "Slim1 Capture", core::ptr::null_mut(), "SLIMTX4" },
    { "SLIMRX1", core::ptr::null_mut(), "Slim1 Playback" },
    { "SLIMRX2", core::ptr::null_mut(), "Slim1 Playback" },
    { "SLIMRX3", core::ptr::null_mut(), "Slim1 Playback" },
    { "SLIMRX4", core::ptr::null_mut(), "Slim1 Playback" },
    { "Slim2 Capture", core::ptr::null_mut(), "SLIMTX5" },
    { "Slim2 Capture", core::ptr::null_mut(), "SLIMTX6" },
    { "SLIMRX5", core::ptr::null_mut(), "Slim2 Playback" },
    { "SLIMRX6", core::ptr::null_mut(), "Slim2 Playback" },
    { "Slim3 Capture", core::ptr::null_mut(), "SLIMTX7" },
    { "Slim3 Capture", core::ptr::null_mut(), "SLIMTX8" },
    { "SLIMRX7", core::ptr::null_mut(), "Slim3 Playback" },
    { "SLIMRX8", core::ptr::null_mut(), "Slim3 Playback" },
    { "AIF1 Playback", core::ptr::null_mut(), "SYSCLK" },
    { "AIF2 Playback", core::ptr::null_mut(), "SYSCLK" },
    { "AIF3 Playback", core::ptr::null_mut(), "SYSCLK" },
    { "Slim1 Playback", core::ptr::null_mut(), "SYSCLK" },
    { "Slim2 Playback", core::ptr::null_mut(), "SYSCLK" },
    { "Slim3 Playback", core::ptr::null_mut(), "SYSCLK" },
    { "AIF1 Capture", core::ptr::null_mut(), "SYSCLK" },
    { "AIF2 Capture", core::ptr::null_mut(), "SYSCLK" },
    { "AIF3 Capture", core::ptr::null_mut(), "SYSCLK" },
    { "Slim1 Capture", core::ptr::null_mut(), "SYSCLK" },
    { "Slim2 Capture", core::ptr::null_mut(), "SYSCLK" },
    { "Slim3 Capture", core::ptr::null_mut(), "SYSCLK" },
    { "Audio Trace DSP", core::ptr::null_mut(), "DSP1" },
    ...
    { "IN1L", core::ptr::null_mut(), "IN1L Mode" },
    { "IN1R", core::ptr::null_mut(), "IN1R Mode" },
    ...
    { "IN2L", core::ptr::null_mut(), "IN2L Mode" },
    { "IN2R", core::ptr::null_mut(), "IN2R Mode" },
    { "IN3L", core::ptr::null_mut(), "IN1ARN" },
    { "IN3L", core::ptr::null_mut(), "IN1ARP" },
    { "IN3R", core::ptr::null_mut(), "IN1ARN" },
    { "IN3R", core::ptr::null_mut(), "IN1ARP" },
    { "IN4L", core::ptr::null_mut(), "IN2ARN" },
    { "IN4L", core::ptr::null_mut(), "IN2ARP" },
    { "IN4R", core::ptr::null_mut(), "IN2ARN" },
    { "IN4R", core::ptr::null_mut(), "IN2ARP" },
    ...
    { "HPOUT1L", core::ptr::null_mut(), "OUT1L" },
    { "HPOUT1R", core::ptr::null_mut(), "OUT1R" },
    { "AEC1 Loopback", "HPOUT2L", "OUT2L" },
    { "AEC1 Loopback", "HPOUT2R", "OUT2R" },
    { "HPOUT2L", core::ptr::null_mut(), "OUT2L" },
    { "HPOUT2R", core::ptr::null_mut(), "OUT2R" },
    { "AEC1 Loopback", "HPOUT3L", "OUT3L" },
    { "AEC1 Loopback", "HPOUT3R", "OUT3R" },
    { "OUT3 Demux", core::ptr::null_mut(), "OUT3L" },
    { "OUT3 Demux", core::ptr::null_mut(), "OUT3R" },
    { "OUT3R", core::ptr::null_mut(), "OUT3 Mono Mux" },
    ...
    { "SPKDAT1L", core::ptr::null_mut(), "OUT5L" },
    { "SPKDAT1R", core::ptr::null_mut(), "OUT5R" },
    { "SPDIF1", core::ptr::null_mut(), "SPD1" },
    { "MICSUPP", core::ptr::null_mut(), "SYSCLK" },
    { "DRC1 Signal Activity", core::ptr::null_mut(), "DRC1 Activity Output" },
    { "DRC2 Signal Activity", core::ptr::null_mut(), "DRC2 Activity Output" },
...
#[no_mangle]
unsafe extern "C" fn cs47l92_adsp2_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    { "OUT1R", core::ptr::null_mut(), "OUT1L" },
    { "OUT2R", core::ptr::null_mut(), "OUT2L" },
    { "OUT3 Mono Mux", "HPOUT3", "OUT3L" },
    { "OUT3 Mono Mux", "HPOUT4", "OUT3L" },
    };
#[no_mangle]
unsafe extern "C" fn cs47l92_component_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l92_component_remove(component: *mut snd_soc_component) {
...
pub const CS47L92_DIG_VU: c_uint = 0x0200;
...
#[no_mangle]
unsafe extern "C" fn cs47l92_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l92_remove(pdev: *mut platform_device) {
