...
//! Source: sound/soc/codecs/bd28623.c
#![no_std]
...
pub const BD28623_NUM_SUPPLIES: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd28623_priv {
    pub dev: *mut device,
    pub supplies: [regulator_bulk_data; BD28623_NUM_SUPPLIES],
    pub reset_gpio: *mut gpio_desc,
    pub mute_gpio: *mut gpio_desc,
    pub switch_spk: c_int,
}
    ...
    { "OUT1P", core::ptr::null_mut(), "DAC" },
    { "OUT1N", core::ptr::null_mut(), "DAC" },
    { "OUT2P", core::ptr::null_mut(), "DAC" },
    { "OUT2N", core::ptr::null_mut(), "DAC" },
    };
#[no_mangle]
