...
//! Source: sound/soc/codecs/aw88399-lib.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aw_dev_get_int_status(aw_dev: *mut aw_device, int_status: *mut c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn aw_dev_check_sysst(aw88399: *mut aw88399) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw88399_dev_get_icalk(aw88399: *mut aw88399, icalk: *mut i16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw88399_dev_get_vcalk(aw88399: *mut aw88399, vcalk: *mut i16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw88399_dev_get_internal_vcalk(aw88399: *mut aw88399, vcalk: *mut i16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw_dev_set_vcalb(aw88399: *mut aw88399) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw_dev_hw_crc_check(aw88399: *mut aw88399) -> c_int {
...
unsafe extern "C" fn aw_dev_fade_in(aw_dev: *mut aw_device) {
    ...
    let mut fade_in_vol: u16 = desc.ctl_volume;
    let mut fade_step: c_int = aw_dev.fade_step;
    int i;
...
#[no_mangle]
unsafe extern "C" fn aw88399_dev_set_dither(aw88399: *mut aw88399, dither: bool) {
...
#[no_mangle]
unsafe extern "C" fn aw88399_dev_start(aw88399: *mut aw88399) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw_dev_get_cur_mode_st(aw_dev: *mut aw_device) {
...
#[no_mangle]
pub unsafe extern "C" fn aw88399_dev_get_prof_name(aw_dev: *mut aw_device, index: c_int, prof_name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw88399_dev_fw_update(aw88399: *mut aw88399, up_dsp_fw_en: bool, force_up_en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw88399_start_pa(aw88399: *mut aw88399) {
...
#[no_mangle]
unsafe extern "C" fn aw88399_dev_init(aw88399: *mut aw88399, aw_cfg: *mut aw_container) -> c_int {
...
pub unsafe extern "C" fn aw88399_request_firmware_file(aw88399: *mut aw88399) -> c_int {
    ...
    {
    const struct firmware *cont __free(firmware) = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn aw88399_parse_channel_dt(aw_dev: *mut aw_device) {
