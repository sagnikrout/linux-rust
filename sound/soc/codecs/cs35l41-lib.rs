...
//! Source: sound/soc/codecs/cs35l41-lib.c
#![no_std]
...
pub const CS35L41_FIRMWARE_OLD_VERSION: c_uint = 0x001C00 /* v0.28.0 */;
...
#[no_mangle]
unsafe extern "C" fn cs35l41_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l41_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l41_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cs35l41_safe_reset(regmap: *mut regmap, b_type: enum cs35l41_boost_type) -> bool {
...
pub unsafe extern "C" fn cs35l41_gpio_config(regmap: *mut regmap, hw_cfg: *mut cs35l41_hw_cfg) -> c_int {
    ...
    let mut irq_pol: c_int = IRQF_TRIGGER_NONE;
...
#[no_mangle]
unsafe extern "C" fn cs35l41_wait_for_pwrmgt_sts(dev: *mut device, regmap: *mut regmap) {
    static void cs35l41_wait_for_pwrmgt_sts(struct device *dev, struct regmap *regmap)
    {
    let mut pwrmgt_retries: c_int = 10;
    unsigned int sts;
    int i, ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(CS35L41_WR_PEND_STS_MASK): !(sts &) -> else {
...
pub unsafe extern "C" fn cs35l41_exit_hibernate(dev: *mut device, regmap: *mut regmap) -> c_int {
    ...
    {
    let mut wake_retries: c_int = 20;
    let mut sleep_retries: c_int = 5;
    int ret, i, j;
