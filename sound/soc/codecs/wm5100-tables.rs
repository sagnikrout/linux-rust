...
//! Source: sound/soc/codecs/wm5100-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn wm5100_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn wm5100_readable_register(dev: *mut device, reg: c_uint) -> bool {
