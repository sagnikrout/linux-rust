...
//! Source: sound/soc/codecs/wsa881x.c
#![no_std]
...
pub const WSA881X_DIGITAL_BASE: c_uint = 0x3000;
pub const WSA881X_ANALOG_BASE: c_uint = 0x3100;
// Digital register address space

// Analog Register address space

pub const WSA881X_PA_GAIN_SEL_DRE: c_int = 0;

pub const SWR_SLV_MAX_REG_ADDR: c_uint = 0x390;
pub const SWR_SLV_START_REG_ADDR: c_uint = 0x40;
pub const SWR_SLV_MAX_BUF_LEN: c_int = 20;
pub const BYTES_PER_LINE: c_int = 12;
pub const SWR_SLV_RD_BUF_LEN: c_int = 8;
pub const SWR_SLV_WR_BUF_LEN: c_int = 32;
pub const SWR_SLV_MAX_DEVICES: c_int = 2;
pub const WSA881X_MAX_SWR_PORTS: c_int = 4;
pub const WSA881X_VERSION_ENTRY_SIZE: c_int = 27;
pub const WSA881X_OCP_CTL_TIMER_SEC: c_int = 2;
pub const WSA881X_OCP_CTL_TEMP_CELSIUS: c_int = 25;
pub const WSA881X_OCP_CTL_POLL_TIMER_SEC: c_int = 60;
pub const WSA881X_PROBE_TIMEOUT: c_int = 1000;
...
#[no_mangle]
unsafe extern "C" fn wsa881x_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wsa881x_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wsa881x_init(wsa881x: *mut wsa881x_priv) {
...
#[no_mangle]
unsafe extern "C" fn wsa881x_boost_ctrl(comp: *mut snd_soc_component, enable: bool) -> c_int {
...
//
    ...
    { "RDAC", core::ptr::null_mut(), "IN" },
    { "RDAC", core::ptr::null_mut(), "DCLK" },
    { "RDAC", core::ptr::null_mut(), "ACLK" },
    { "RDAC", core::ptr::null_mut(), "Bandgap" },
    { "SPKR PGA", core::ptr::null_mut(), "RDAC" },
    { "SPKR", core::ptr::null_mut(), "SPKR PGA" },
    };
...
//
    ...
    SND_SOC_DAPM_DAC_E("RDAC", core::ptr::null_mut(), WSA881X_SPKR_DAC_CTL, 7, 0,
    core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_PGA_E("SPKR PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0,
    wsa881x_spkr_pa_event, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_SUPPLY("DCLK", WSA881X_CDC_DIG_CLK_CTL, 0, 0, core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_SUPPLY("ACLK", WSA881X_CDC_ANA_CLK_CTL, 0, 0, core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
...
#[no_mangle]
unsafe extern "C" fn wsa881x_digital_mute(dai: *mut snd_soc_dai, mute: c_int, stream: c_int) -> c_int {
...
unsafe extern "C" fn wsa881x_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(wsa881x_runtime_suspend, wsa881x_runtime_resume, core::ptr::null_mut())
    };
