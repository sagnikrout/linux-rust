...
//! Source: sound/soc/codecs/wsa883x.c
#![no_std]
...
pub const WSA883X_BASE: c_uint = 0x3000;

pub const WSA883X_SPKR_PWM_FREQ_F300KHZ: c_int = 0;
pub const WSA883X_SPKR_PWM_FREQ_F600KHZ: c_int = 1;

pub const WSA883X_RXD_MODE_NORMAL: c_int = 0;
pub const WSA883X_RXD_MODE_HIFI: c_int = 1;

pub const WSA883X_GLOBAL_PA_ENABLE: c_int = 1;

pub const WSA883X_PA_FSM_BYP_DC_CAL_EN_MASK: c_uint = 0x01;
pub const WSA883X_PA_FSM_BYP_DC_CAL_EN_SHIFT: c_int = 0;
pub const WSA883X_PA_FSM_BYP_CLK_WD_EN_MASK: c_uint = 0x02;
pub const WSA883X_PA_FSM_BYP_CLK_WD_EN_SHIFT: c_int = 1;
pub const WSA883X_PA_FSM_BYP_BG_EN_MASK: c_uint = 0x04;
pub const WSA883X_PA_FSM_BYP_BG_EN_SHIFT: c_int = 2;
pub const WSA883X_PA_FSM_BYP_BOOST_EN_MASK: c_uint = 0x08;
pub const WSA883X_PA_FSM_BYP_BOOST_EN_SHIFT: c_int = 3;
pub const WSA883X_PA_FSM_BYP_PA_EN_MASK: c_uint = 0x10;
pub const WSA883X_PA_FSM_BYP_PA_EN_SHIFT: c_int = 4;
pub const WSA883X_PA_FSM_BYP_D_UNMUTE_MASK: c_uint = 0x20;
pub const WSA883X_PA_FSM_BYP_D_UNMUTE_SHIFT: c_int = 5;
pub const WSA883X_PA_FSM_BYP_SPKR_PROT_EN_MASK: c_uint = 0x40;
pub const WSA883X_PA_FSM_BYP_SPKR_PROT_EN_SHIFT: c_int = 6;
pub const WSA883X_PA_FSM_BYP_TSADC_EN_MASK: c_uint = 0x80;
pub const WSA883X_PA_FSM_BYP_TSADC_EN_SHIFT: c_int = 7;

pub const WSA883X_TADC_VALUE_CTL_TEMP_VALUE_RD_EN_MASK: c_uint = 0x01;
pub const WSA883X_TADC_VALUE_CTL_TEMP_VALUE_RD_EN_SHIFT: c_int = 0;
pub const WSA883X_TADC_VALUE_CTL_VBAT_VALUE_RD_EN_MASK: c_uint = 0x02;
pub const WSA883X_TADC_VALUE_CTL_VBAT_VALUE_RD_EN_SHIFT: c_int = 1;

pub const WSA883X_VBAT_ADC_COEF_F_1DIV2: c_uint = 0x0;
pub const WSA883X_VBAT_ADC_COEF_F_1DIV16: c_uint = 0x3;

pub const WSA883X_DRE_GAIN_FROM_CSR: c_int = 1;

pub const WSA883X_VERSION_1_0: c_int = 0;
pub const WSA883X_VERSION_1_1: c_int = 1;
pub const WSA883X_MAX_SWR_PORTS: c_int = 4;
...
//
pub const WSA883X_LOW_TEMP_THRESHOLD: c_int = 5;
pub const WSA883X_HIGH_TEMP_THRESHOLD: c_int = 45;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wsa883x_priv {
    ...
    pub port_config: [sdw_port_config; WSA883X_MAX_SWR_PORTS],
    pub sd_n: *mut gpio_desc,
    pub sd_reset: *mut reset_control,
    pub port_prepared: [bool; WSA883X_MAX_SWR_PORTS],
    pub port_enable: [bool; WSA883X_MAX_SWR_PORTS],
...
#[no_mangle]
unsafe extern "C" fn wsa883x_codec_probe(comp: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wsa883x_digital_mute(dai: *mut snd_soc_dai, mute: c_int, stream: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wsa883x_get_temp(wsa883x: *mut wsa883x_priv, temp: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wsa883x_get_reset(dev: *mut device, wsa883x: *mut wsa883x_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wsa883x_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wsa883x_runtime_resume(dev: *mut device) -> c_int {
