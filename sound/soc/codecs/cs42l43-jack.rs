...
//! Source: sound/soc/codecs/cs42l43-jack.c
#![no_std]
...
// This tip sense invert is always set, HW wants an inverted signal
    ...
    let mut autocontrol: c_uint = 0, pdncntl = 0;
    int ret;
...
// HW wants an inverted signal, so invert the invert
    ...
    core::ptr::null_mut(), cs42l43_accdet_db_ms,
    ARRAY_SIZE(cs42l43_accdet_db_ms));
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn cs42l43_start_hs_bias(priv: *mut cs42l43_codec, type_detect: bool) {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_stop_hs_bias(priv: *mut cs42l43_codec) {
...
#[no_mangle]
pub unsafe extern "C" fn cs42l43_bias_detect_clamp(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
pub const CS42L43_JACK_PRESENT: c_uint = 0x3;
pub const CS42L43_JACK_ABSENT: c_uint = 0x0;

    SND_JACK_BTN_3 | SND_JACK_BTN_4 | SND_JACK_BTN_5)
#[no_mangle]
pub unsafe extern "C" fn cs42l43_jack_present(priv: *mut cs42l43_codec) -> bool {
    ...
    let mut sts: return = = CS42L43_JACK_PRESENT;
    }
#[no_mangle]
unsafe extern "C" fn cs42l43_start_button_detect(priv: *mut cs42l43_codec) {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_stop_button_detect(priv: *mut cs42l43_codec) {
...
pub const CS42L43_BUTTON_COMB_US: c_int = 11000;
pub const CS42L43_BUTTON_COMB_MAX: c_int = 512;
pub const CS42L43_BUTTON_ROUT: c_int = 2210;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn cs42l43_start_load_detect(priv: *mut cs42l43_codec, mic: bool) {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_stop_load_detect(priv: *mut cs42l43_codec) {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_run_load_detect(priv: *mut cs42l43_codec, mic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_run_type_detect(priv: *mut cs42l43_codec) -> c_int {
    static int cs42l43_run_type_detect(struct cs42l43_codec *priv)
    {
    struct cs42l43 *cs42l43 = priv.core;
    let mut timeout_ms: c_int = ((2 * priv.detect_us) / USEC_PER_MSEC) + 200;
    let mut type: c_uint = 0xff;
    unsigned long time_left;
...
#[no_mangle]
pub unsafe extern "C" fn cs42l43_clear_jack(priv: *mut cs42l43_codec) {
...
pub unsafe extern "C" fn cs42l43_tip_sense(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    {
    struct cs42l43_codec *priv = data;
    let mut db_delay: c_uint = priv.tip_debounce_ms;
...
#[no_mangle]
pub unsafe extern "C" fn cs42l43_jack_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs42l43_jack_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    ...
    let mut override: c_uint = ucontrol.value.integer.value[0];
    if (override >= e.items)
    return -EINVAL;
    guard(mutex)(&priv.jack_lock);
    if (!cs42l43_jack_present(priv))
