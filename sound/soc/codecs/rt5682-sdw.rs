...
//! Source: sound/soc/codecs/rt5682-sdw.c
#![no_std]
...
pub const RT5682_SDW_ADDR_L: c_uint = 0x3000;
pub const RT5682_SDW_ADDR_H: c_uint = 0x3001;
pub const RT5682_SDW_DATA_L: c_uint = 0x3004;
pub const RT5682_SDW_DATA_H: c_uint = 0x3005;
pub const RT5682_SDW_CMD: c_uint = 0x3008;
#[no_mangle]
...
unsafe extern "C" fn rt5682_sdw_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
    ...
    int retval;
    let mut val_p: c_uint = 0, val_c = 0, osr_p = 0, osr_c = 0;
...
// SoundWire specific configuration
    ...
    rt5682.regmap = devm_regmap_init(dev, core::ptr::null_mut(), dev,
...
#[no_mangle]
unsafe extern "C" fn rt5682_sdw_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
// Bus clock frequency
pub const RT5682_CLK_FREQ_9600000HZ: c_int = 9600000;
pub const RT5682_CLK_FREQ_12000000HZ: c_int = 12000000;
pub const RT5682_CLK_FREQ_6000000HZ: c_int = 6000000;
pub const RT5682_CLK_FREQ_4800000HZ: c_int = 4800000;
pub const RT5682_CLK_FREQ_2400000HZ: c_int = 2400000;
pub const RT5682_CLK_FREQ_12288000HZ: c_int = 12288000;
#[no_mangle]
...
unsafe extern "C" fn rt5682_dev_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rt5682_dev_suspend, rt5682_dev_resume, core::ptr::null_mut())
    };
