...
//! Source: sound/soc/codecs/rt9123.c
#![no_std]
...
pub const RT9123_REG_AMPCTRL: c_uint = 0x01;
pub const RT9123_REG_I2SOPT: c_uint = 0x02;
pub const RT9123_REG_TDMRX: c_uint = 0x03;
pub const RT9123_REG_SILVOLEN: c_uint = 0x04;
pub const RT9123_REG_VOLGAIN: c_uint = 0x12;
pub const RT9123_REG_ANAFLAG: c_uint = 0x36;
pub const RT9123_REG_COMBOID: c_uint = 0xF7;

pub const RT9123_FIXED_VENID: c_uint = 0x340;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt9123_priv {
...
// AMPON bit is located in volatile RG, use pm_runtime to guarantee the RG access
    ...
    SND_SOC_DAPM_OUT_DRV_E("Amp Drv", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0, rt9123_enable_event,
...
#[no_mangle]
unsafe extern "C" fn rt9123_kcontrol_name_comp(kcontrol: *mut snd_kcontrol, s: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9123_xhandler_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9123_xhandler_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9123_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt9123_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt9123_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rt9123->enable) -> else {
...
unsafe extern "C" fn rt9123_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(rt9123_runtime_suspend, rt9123_runtime_resume, core::ptr::null_mut())
    };
