...
//! Source: sound/soc/codecs/twl4030.c
#![no_std]
...
pub const TWL4030_PMBR1_REG: c_uint = 0x0D;
...
// Output (with associated amp) states
    pub hsr_enabled: u8 hsl_enabled,,
    pub earpiece_enabled: u8,
    pub predriver_enabled: u8 predrivel_enabled,,
    pub carkitr_enabled: u8 carkitl_enabled,,
    pub 1]: u8 ctl_cache[TWL4030_REG_PRECKR_CTL - TWL4030_REG_EAR_CTL +,
    pub board_params: *mut twl4030_board_params,
}

#[no_mangle]
unsafe extern "C" fn tw4030_init_ctl_cache(twl4030: *mut twl4030_priv) {
...
#[no_mangle]
unsafe extern "C" fn twl4030_read(component: *mut snd_soc_component, reg: c_uint) -> c_uint {
    ...
    unsigned int reg)
    {
    let mut write_to_reg: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn twl4030_wait_ms(time: c_int) {
...
#[no_mangle]
unsafe extern "C" fn twl4030_codec_enable(component: *mut snd_soc_component, enable: c_int) {
...
// but there seems to be no TRM requirement for it
    ...
    {
    struct twl4030_board_params *board_params = core::ptr::null_mut();
    struct device_node *twl4030_codec_node = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn twl4030_init_chip(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_apll_enable(component: *mut snd_soc_component, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn handsfree_ramp(component: *mut snd_soc_component, reg: c_int, ramp: c_int) {
...
#[no_mangle]
unsafe extern "C" fn headset_ramp(component: *mut snd_soc_component, ramp: c_int) {
...
//
    ...
    let mut reg: c_uint = mc.reg;
    let mut shift: c_uint = mc.shift;
    let mut rshift: c_uint = mc.rshift;
    let mut max: c_int = mc.max;
    let mut mask: c_int = (1 << fls(max)) - 1;
...
// DACs
    SND_SOC_DAPM_DAC("DAC Right1", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("DAC Left1", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("DAC Right2", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("DAC Left2", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("DAC Voice", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
...
// Digital mixers, power control for the physical DACs
    ...
    TWL4030_REG_AVDAC_CTL, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Digital L1 Playback Mixer",
    TWL4030_REG_AVDAC_CTL, 1, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Digital R2 Playback Mixer",
    TWL4030_REG_AVDAC_CTL, 2, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Digital L2 Playback Mixer",
    TWL4030_REG_AVDAC_CTL, 3, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Digital Voice Playback Mixer",
    TWL4030_REG_AVDAC_CTL, 4, 0, core::ptr::null_mut(), 0),
// Analog mixers, power control for the physical PGAs
    SND_SOC_DAPM_MIXER("Analog R1 Playback Mixer",
    TWL4030_REG_ARXR1_APGA_CTL, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Analog L1 Playback Mixer",
    TWL4030_REG_ARXL1_APGA_CTL, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Analog R2 Playback Mixer",
    TWL4030_REG_ARXR2_APGA_CTL, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Analog L2 Playback Mixer",
    TWL4030_REG_ARXL2_APGA_CTL, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("Analog Voice Playback Mixer",
    TWL4030_REG_VDL_APGA_CTL, 0, 0, core::ptr::null_mut(), 0),
...
// Earpiece
    ...
    0, 0, core::ptr::null_mut(), 0, earpiecepga_event,
...
// PreDrivL/R
    ...
    0, 0, core::ptr::null_mut(), 0, predrivelpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_MIXER("PredriveR Mixer", SND_SOC_NOPM, 0, 0,
    &twl4030_dapm_predriver_controls[0],
    ARRAY_SIZE(twl4030_dapm_predriver_controls)),
    SND_SOC_DAPM_PGA_E("PredriveR PGA", SND_SOC_NOPM,
    0, 0, core::ptr::null_mut(), 0, predriverpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
// HeadsetL/R
    ...
    0, 0, core::ptr::null_mut(), 0, headsetlpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_MIXER("HeadsetR Mixer", SND_SOC_NOPM, 0, 0,
    &twl4030_dapm_hsor_controls[0],
    ARRAY_SIZE(twl4030_dapm_hsor_controls)),
    SND_SOC_DAPM_PGA_E("HeadsetR PGA", SND_SOC_NOPM,
    0, 0, core::ptr::null_mut(), 0, headsetrpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
// CarkitL/R
    ...
    0, 0, core::ptr::null_mut(), 0, carkitlpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_MIXER("CarkitR Mixer", SND_SOC_NOPM, 0, 0,
    &twl4030_dapm_carkitr_controls[0],
    ARRAY_SIZE(twl4030_dapm_carkitr_controls)),
    SND_SOC_DAPM_PGA_E("CarkitR PGA", SND_SOC_NOPM,
    0, 0, core::ptr::null_mut(), 0, carkitrpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
// Output MUX controls
// HandsfreeL/R
    ...
    0, 0, core::ptr::null_mut(), 0, handsfreelpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
    ...
    0, 0, core::ptr::null_mut(), 0, handsfreerpga_event,
    SND_SOC_DAPM_POST_PMU|SND_SOC_DAPM_POST_PMD),
// Vibra
...
// Introducing four virtual ADC, since TWL4030 have four channel for
    capture */
    SND_SOC_DAPM_ADC("ADC Virtual Left1", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_ADC("ADC Virtual Right1", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_ADC("ADC Virtual Left2", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_ADC("ADC Virtual Right2", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
...
// Analog input mixers for the capture amplifiers
    ...
    TWL4030_REG_AVADC_CTL, 3, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ADC Physical Right",
    TWL4030_REG_AVADC_CTL, 1, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA_E("Digimic0 Enable",
    TWL4030_REG_ADCMICSEL, 1, 0, core::ptr::null_mut(), 0,
    digimic_event, SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("Digimic1 Enable",
    TWL4030_REG_ADCMICSEL, 3, 0, core::ptr::null_mut(), 0,
    digimic_event, SND_SOC_DAPM_POST_PMU),
...
// Microphone bias
    ...
    TWL4030_REG_MICBIAS_CTL, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("Mic Bias 2",
    TWL4030_REG_MICBIAS_CTL, 1, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("Headset Mic Bias",
    TWL4030_REG_MICBIAS_CTL, 2, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("VIF Enable", TWL4030_REG_VOICE_IF, 0, 0, core::ptr::null_mut(), 0),
    };
    static const struct snd_soc_dapm_route intercon[] = {
// Stream -> DAC mapping
    {"DAC Right1", core::ptr::null_mut(), "HiFi Playback"},
    {"DAC Left1", core::ptr::null_mut(), "HiFi Playback"},
    {"DAC Right2", core::ptr::null_mut(), "HiFi Playback"},
    {"DAC Left2", core::ptr::null_mut(), "HiFi Playback"},
    {"DAC Voice", core::ptr::null_mut(), "VAIFIN"},
// ADC -> Stream mapping
    {"HiFi Capture", core::ptr::null_mut(), "ADC Virtual Left1"},
    {"HiFi Capture", core::ptr::null_mut(), "ADC Virtual Right1"},
    {"HiFi Capture", core::ptr::null_mut(), "ADC Virtual Left2"},
    {"HiFi Capture", core::ptr::null_mut(), "ADC Virtual Right2"},
    {"VAIFOUT", core::ptr::null_mut(), "ADC Virtual Left2"},
    {"VAIFOUT", core::ptr::null_mut(), "ADC Virtual Right2"},
    {"VAIFOUT", core::ptr::null_mut(), "VIF Enable"},
    {"Digital L1 Playback Mixer", core::ptr::null_mut(), "DAC Left1"},
    {"Digital R1 Playback Mixer", core::ptr::null_mut(), "DAC Right1"},
    {"Digital L2 Playback Mixer", core::ptr::null_mut(), "DAC Left2"},
    {"Digital R2 Playback Mixer", core::ptr::null_mut(), "DAC Right2"},
    {"Digital Voice Playback Mixer", core::ptr::null_mut(), "DAC Voice"},
// Supply for the digital part (APLL)
    {"Digital Voice Playback Mixer", core::ptr::null_mut(), "APLL Enable"},
    {"DAC Left1", core::ptr::null_mut(), "AIF Enable"},
    {"DAC Right1", core::ptr::null_mut(), "AIF Enable"},
    {"DAC Left2", core::ptr::null_mut(), "AIF Enable"},
    {"DAC Right1", core::ptr::null_mut(), "AIF Enable"},
    {"DAC Voice", core::ptr::null_mut(), "VIF Enable"},
    {"Digital R2 Playback Mixer", core::ptr::null_mut(), "AIF Enable"},
    {"Digital L2 Playback Mixer", core::ptr::null_mut(), "AIF Enable"},
    {"Analog L1 Playback Mixer", core::ptr::null_mut(), "Digital L1 Playback Mixer"},
    {"Analog R1 Playback Mixer", core::ptr::null_mut(), "Digital R1 Playback Mixer"},
    {"Analog L2 Playback Mixer", core::ptr::null_mut(), "Digital L2 Playback Mixer"},
    {"Analog R2 Playback Mixer", core::ptr::null_mut(), "Digital R2 Playback Mixer"},
    {"Analog Voice Playback Mixer", core::ptr::null_mut(), "Digital Voice Playback Mixer"},
...
// Earpiece
    ...
    {"Earpiece PGA", core::ptr::null_mut(), "Earpiece Mixer"},
// PreDrivL
    {"PredriveL Mixer", "Voice", "Analog Voice Playback Mixer"},
    {"PredriveL Mixer", "AudioL1", "Analog L1 Playback Mixer"},
    {"PredriveL Mixer", "AudioL2", "Analog L2 Playback Mixer"},
    {"PredriveL Mixer", "AudioR2", "Analog R2 Playback Mixer"},
    {"PredriveL PGA", core::ptr::null_mut(), "PredriveL Mixer"},
// PreDrivR
    {"PredriveR Mixer", "Voice", "Analog Voice Playback Mixer"},
    {"PredriveR Mixer", "AudioR1", "Analog R1 Playback Mixer"},
    {"PredriveR Mixer", "AudioR2", "Analog R2 Playback Mixer"},
    {"PredriveR Mixer", "AudioL2", "Analog L2 Playback Mixer"},
    {"PredriveR PGA", core::ptr::null_mut(), "PredriveR Mixer"},
// HeadsetL
    {"HeadsetL Mixer", "Voice", "Analog Voice Playback Mixer"},
    {"HeadsetL Mixer", "AudioL1", "Analog L1 Playback Mixer"},
    {"HeadsetL Mixer", "AudioL2", "Analog L2 Playback Mixer"},
    {"HeadsetL PGA", core::ptr::null_mut(), "HeadsetL Mixer"},
// HeadsetR
    {"HeadsetR Mixer", "Voice", "Analog Voice Playback Mixer"},
    {"HeadsetR Mixer", "AudioR1", "Analog R1 Playback Mixer"},
    {"HeadsetR Mixer", "AudioR2", "Analog R2 Playback Mixer"},
    {"HeadsetR PGA", core::ptr::null_mut(), "HeadsetR Mixer"},
// CarkitL
    {"CarkitL Mixer", "Voice", "Analog Voice Playback Mixer"},
    {"CarkitL Mixer", "AudioL1", "Analog L1 Playback Mixer"},
    {"CarkitL Mixer", "AudioL2", "Analog L2 Playback Mixer"},
    {"CarkitL PGA", core::ptr::null_mut(), "CarkitL Mixer"},
// CarkitR
    {"CarkitR Mixer", "Voice", "Analog Voice Playback Mixer"},
    {"CarkitR Mixer", "AudioR1", "Analog R1 Playback Mixer"},
    {"CarkitR Mixer", "AudioR2", "Analog R2 Playback Mixer"},
    {"CarkitR PGA", core::ptr::null_mut(), "CarkitR Mixer"},
// HandsfreeL
    ...
    {"HandsfreeL PGA", core::ptr::null_mut(), "HandsfreeL"},
// HandsfreeR
    ...
    {"HandsfreeR PGA", core::ptr::null_mut(), "HandsfreeR"},
// Vibra
...
// Must be always connected (for AIF and APLL)
    {"Virtual HiFi OUT", core::ptr::null_mut(), "DAC Left1"},
    {"Virtual HiFi OUT", core::ptr::null_mut(), "DAC Right1"},
    {"Virtual HiFi OUT", core::ptr::null_mut(), "DAC Left2"},
    {"Virtual HiFi OUT", core::ptr::null_mut(), "DAC Right2"},
// Must be always connected (for APLL)
    {"Virtual Voice OUT", core::ptr::null_mut(), "Digital Voice Playback Mixer"},
// Physical outputs
    {"EARPIECE", core::ptr::null_mut(), "Earpiece PGA"},
    {"PREDRIVEL", core::ptr::null_mut(), "PredriveL PGA"},
    {"PREDRIVER", core::ptr::null_mut(), "PredriveR PGA"},
    {"HSOL", core::ptr::null_mut(), "HeadsetL PGA"},
    {"HSOR", core::ptr::null_mut(), "HeadsetR PGA"},
    {"CARKITL", core::ptr::null_mut(), "CarkitL PGA"},
    {"CARKITR", core::ptr::null_mut(), "CarkitR PGA"},
    {"HFL", core::ptr::null_mut(), "HandsfreeL PGA"},
    {"HFR", core::ptr::null_mut(), "HandsfreeR PGA"},
    {"Vibra Route", "Audio", "Vibra Mux"},
    {"VIBRA", core::ptr::null_mut(), "Vibra Route"},
// Capture path
// Must be always connected (for AIF and APLL)
    {"ADC Virtual Left1", core::ptr::null_mut(), "Virtual HiFi IN"},
    {"ADC Virtual Right1", core::ptr::null_mut(), "Virtual HiFi IN"},
    {"ADC Virtual Left2", core::ptr::null_mut(), "Virtual HiFi IN"},
    {"ADC Virtual Right2", core::ptr::null_mut(), "Virtual HiFi IN"},
// Physical inputs
    ...
    {"ADC Physical Left", core::ptr::null_mut(), "Analog Left"},
    {"ADC Physical Right", core::ptr::null_mut(), "Analog Right"},
    {"Digimic0 Enable", core::ptr::null_mut(), "DIGIMIC0"},
    {"Digimic1 Enable", core::ptr::null_mut(), "DIGIMIC1"},
    {"DIGIMIC0", core::ptr::null_mut(), "micbias1 select"},
    {"DIGIMIC1", core::ptr::null_mut(), "micbias2 select"},
...
// TX2 Right capture path
    ...
    {"TX2 Capture Route", "Digimic1", "Digimic1 Enable"},
    {"ADC Virtual Left1", core::ptr::null_mut(), "TX1 Capture Route"},
    {"ADC Virtual Right1", core::ptr::null_mut(), "TX1 Capture Route"},
    {"ADC Virtual Left2", core::ptr::null_mut(), "TX2 Capture Route"},
    {"ADC Virtual Right2", core::ptr::null_mut(), "TX2 Capture Route"},
    {"ADC Virtual Left1", core::ptr::null_mut(), "AIF Enable"},
    {"ADC Virtual Right1", core::ptr::null_mut(), "AIF Enable"},
    {"ADC Virtual Left2", core::ptr::null_mut(), "AIF Enable"},
    {"ADC Virtual Right2", core::ptr::null_mut(), "AIF Enable"},
...
// Supply for the Analog loopbacks
    {"Right1 Analog Loopback", core::ptr::null_mut(), "FM Loop Enable"},
    {"Left1 Analog Loopback", core::ptr::null_mut(), "FM Loop Enable"},
    {"Right2 Analog Loopback", core::ptr::null_mut(), "FM Loop Enable"},
    {"Left2 Analog Loopback", core::ptr::null_mut(), "FM Loop Enable"},
    {"Voice Analog Loopback", core::ptr::null_mut(), "FM Loop Enable"},
    {"Analog R1 Playback Mixer", core::ptr::null_mut(), "Right1 Analog Loopback"},
    {"Analog L1 Playback Mixer", core::ptr::null_mut(), "Left1 Analog Loopback"},
    {"Analog R2 Playback Mixer", core::ptr::null_mut(), "Right2 Analog Loopback"},
    {"Analog L2 Playback Mixer", core::ptr::null_mut(), "Left2 Analog Loopback"},
    {"Analog Voice Playback Mixer", core::ptr::null_mut(), "Voice Analog Loopback"},
// Digital bypass routes
    {"Right Digital Loopback", "Volume", "TX1 Capture Route"},
    {"Left Digital Loopback", "Volume", "TX1 Capture Route"},
    {"Voice Digital Loopback", "Volume", "TX2 Capture Route"},
    {"Digital R2 Playback Mixer", core::ptr::null_mut(), "Right Digital Loopback"},
    {"Digital L2 Playback Mixer", core::ptr::null_mut(), "Left Digital Loopback"},
    {"Digital Voice Playback Mixer", core::ptr::null_mut(), "Voice Digital Loopback"},
    };
...
#[no_mangle]
pub unsafe extern "C" fn if(twl4030->slave_substream: mst_substream ==) -> else {
...
// second stream will 'inherit' this cosntraint
    ...
    twl4030.slave_substream = core::ptr::null_mut();
// If all streams are closed, or the remaining stream has not yet
// been configured than set the DAI as not configured.
    if (!twl4030.master_substream)
    twl4030.configured = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !twl4030->master_substream->runtime->channels) -> else {
...
#[no_mangle]
unsafe extern "C" fn twl4030_set_dai_fmt(codec_dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_set_tristate(dai: *mut snd_soc_dai, tristate: c_int) -> c_int {
    static int twl4030_set_tristate(struct snd_soc_dai *dai, int tristate)
    {
    struct snd_soc_component *component = dai.component;
    let mut reg: u8 = twl4030_read(component, TWL4030_REG_AUDIO_IF);
    if (tristate)
...
#[no_mangle]
unsafe extern "C" fn twl4030_voice_set_tristate(dai: *mut snd_soc_dai, tristate: c_int) -> c_int {
    static int twl4030_voice_set_tristate(struct snd_soc_dai *dai, int tristate)
    {
    struct snd_soc_component *component = dai.component;
    let mut reg: u8 = twl4030_read(component, TWL4030_REG_VOICE_IF);
    if (tristate)
...
#[no_mangle]
unsafe extern "C" fn twl4030_soc_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_codec_probe(pdev: *mut platform_device) -> c_int {
