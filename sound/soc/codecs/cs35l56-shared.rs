...
//! Source: sound/soc/codecs/cs35l56-shared.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cs35l56_is_dsp_memory(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_common_volatile_reg(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l63_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_set_fw_reg_table(cs35l56_base: *mut cs35l56_base) {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_spi_system_reset(cs35l56_base: *mut cs35l56_base) {
...
#[no_mangle]
pub unsafe extern "C" fn cs35l56_system_reset(cs35l56_base: *mut cs35l56_base, is_soundwire: bool) {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t cs35l56_irq(int irq, void *data)
    {
    struct cs35l56_base *cs35l56_base = data;
    let mut status1: c_uint = 0, status8 = 0, status20 = 0;
...
pub unsafe extern "C" fn cs35l56_irq_request(cs35l56_base: *mut cs35l56_base, irq: c_int) -> c_int {
    ...
    if (irq < 1)
    return 0;
    ret = devm_request_threaded_irq(cs35l56_base.dev, irq, core::ptr::null_mut(), cs35l56_irq,
...
#[no_mangle]
unsafe extern "C" fn cs35l56_issue_wake_event(cs35l56_base: *mut cs35l56_base) {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_wait_for_ps3(cs35l56_base: *mut cs35l56_base) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs35l56_runtime_resume_common(cs35l56_base: *mut cs35l56_base, is_soundwire: bool) -> c_int {
...
pub struct cs35l56_pte {
    ...
    pub dvs: u8,
    pub __packed: },
    pub 0): static_assert((sizeof(struct cs35l56_pte) % sizeof(u32)) ==,
#[no_mangle]
unsafe extern "C" fn cs35l56_read_silicon_uid(cs35l56_base: *mut cs35l56_base) -> c_int {
    static int cs35l56_read_silicon_uid(struct cs35l56_base *cs35l56_base)
    {
    pub pte: cs35l56_pte,
    pub unique_id: u64,
    pub ret: c_int,
    pub sizeof(pte)): ret = regmap_raw_read(cs35l56_base->regmap, CS35L56_OTP_MEM_53, &pte,,
    if (ret) {
    pub ret): dev_err(cs35l56_base->dev, "Failed to read OTP: %d\n",,
    pub ret: return,
    }
    pub 16): unique_id = (u32)pte.lot[2] | ((u32)pte.lot[1] << 8) | ((u32)pte.lot[0] <<,
    pub 32: unique_id <<=,
    unique_id |= (u32)pte.x | ((u32)pte.y << 8) | ((u32)pte.wafer_id << 16) |
    pub 24): ((u32)pte.dvs <<,
    pub unique_id: cs35l56_base->silicon_uid =,
    pub 0: return,
    }
#[no_mangle]
unsafe extern "C" fn cs35l63_read_silicon_uid(cs35l56_base: *mut cs35l56_base) -> c_int {
    static int cs35l63_read_silicon_uid(struct cs35l56_base *cs35l56_base)
    {
    pub tmp: [u32; 2],
    pub unique_id: u64,
    pub ret: c_int,
    pub ARRAY_SIZE(tmp)): ret = regmap_bulk_read(cs35l56_base->regmap, CS35L56_DIE_STS1, tmp,,
    if (ret) {
    pub ret): dev_err(cs35l56_base->dev, "Cannot obtain CS35L56_DIE_STS: %d\n",,
    pub ret: return,
    }
    pub tmp: [unique_id =; 1],
    pub 32: unique_id <<=,
...
#[no_mangle]
unsafe extern "C" fn cs35l56_perform_calibration(cs35l56_base: *mut cs35l56_base) -> c_int {
    ...
    let mut ngate_ch1_was_enabled: bool = false;
    let mut ngate_ch2_was_enabled: bool = false;
