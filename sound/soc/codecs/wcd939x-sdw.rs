...
//! Source: sound/soc/codecs/wcd939x-sdw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wcd939x_rdwr_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd939x_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd939x_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd939x_writeable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd9390_probe(pdev: *mut sdw_slave, id: *const sdw_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd9390_remove(pdev: *mut sdw_slave) {
...
#[no_mangle]
unsafe extern "C" fn wcd939x_sdw_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd939x_sdw_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(wcd939x_sdw_runtime_suspend, wcd939x_sdw_runtime_resume, core::ptr::null_mut())
    };
