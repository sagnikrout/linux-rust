...
//! Source: sound/soc/codecs/dmic.c
#![no_std]
...
pub const MAX_MODESWITCH_DELAY: c_int = 70;
...
unsafe extern "C" fn dmic_component_probe(component: *mut snd_soc_component) -> c_int {
    ...
    {"DMIC AIF", core::ptr::null_mut(), "DMic"},
    };
