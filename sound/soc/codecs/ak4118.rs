...
//! Source: sound/soc/codecs/ak4118.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ak4118_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn ak4118_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), ak4118_irq_handler,
