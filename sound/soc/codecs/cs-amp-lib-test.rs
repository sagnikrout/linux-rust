...
//! Source: sound/soc/codecs/cs-amp-lib-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_init_dummy_cal_blob(test: *mut kunit, num_amps: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_target_uid(test: *mut kunit) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_data_too_short_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_count_too_big_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_no_cal_data_test(test: *mut kunit) {
...
// Redirected get_efi_variable to simulate reading a cal data blob
    ...
    let mut expected_guid: static efi_guid_t = CIRRUS_LOGIC_CALIBRATION_EFI_GUID;
    struct kunit *test = kunit_get_current_test();
    struct cs_amp_lib_test_priv *priv = test.priv;
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_hp_efi_cal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_by_uid_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_by_index_unchecked_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_by_index_checked_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_by_index_uid_mismatch_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_by_index_fallback_test(test: *mut kunit) {
    static void cs_amp_lib_test_get_efi_cal_by_index_fallback_test(struct kunit *test)
    {
    struct cs_amp_lib_test_priv *priv = test.priv;
    const struct cs_amp_lib_test_param *param = test.param_value;
    struct cirrus_amp_cal_data result_data;
    let mut bad_target_uid: static u64 = 0xBADCA100BABABABAULL;
    int i, ret;
    cs_amp_lib_test_init_dummy_cal_blob(test, param.num_amps);
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_uid_not_found_noindex_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_uid_not_found_index_not_found_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_no_uid_index_not_found_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_no_uid_no_index_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_zero_not_matched_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_get_efi_cal_empty_entry_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_write_cal_data_test(test: *mut kunit) {
...
// val = 19;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ctl_name, 0: controls->calr) ==) -> else {
    else if (strcmp(ctl_name, controls.calr) == 0)
// val = 1077;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ctl_name, 0: controls->status) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_read_cal_data_test(test: *mut kunit) {
    static void cs_amp_lib_test_read_cal_data_test(struct kunit *test)
    {
    struct cs_amp_lib_test_priv *priv = test.priv;
    let mut data: cirrus_amp_cal_data = { 0 };
    struct cs_dsp *dsp;
    int ret;
    dsp = kunit_kzalloc(test, sizeof(*dsp), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, dsp);
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_write_ambient_test(test: *mut kunit) {
...
// Redirect calls to write firmware controls
    ...
    EFI_VARIABLE_RUNTIME_ACCESS)
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_create_new_cal_efi(test: *mut kunit) {
...
// For 2 amps
    priv.cal_blob = core::ptr::null_mut();
    get_random_bytes(&data, sizeof(data));
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_create_new_cal_efi_indexed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_create_new_cal_efi_indexed_no_max(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_grow_append_cal_efi(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_grow_append_cal_efi_indexed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_all_zeros_add_first(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_all_zeros_add_first_no_shrink(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_all_zeros_add_first_indexed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_all_zeros_add_first_indexed_no_shrink(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_grow_append_cal_efi_indexed_no_max(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_grow_cal_efi_replace_indexed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_grow_cal_efi_replace_by_uid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_replace_by_uid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_replace_by_index(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_deduplicate(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_find_free(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_bad_cal_target(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_write_denied(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_attr_preserved(test: *mut kunit) {
...
// Set a non-standard attr to return from get_efi_variable()
    ...
    let mut expected_guid: static efi_guid_t = HP_CALIBRATION_EFI_GUID;
    struct kunit *test = kunit_get_current_test();
    struct cs_amp_lib_test_priv *priv = test.priv;
    KUNIT_ASSERT_NOT_NULL(test, name);
    KUNIT_ASSERT_NOT_NULL(test, guid);
...
//
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_cal_efi_update_hp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_spkid_lenovo_not_present(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_spkid_lenovo_d0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_spkid_lenovo_d1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_spkid_lenovo_illegal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_spkid_lenovo_oversize(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_spkid_hp_30(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_spkid_hp_31(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_ssidexv2_fetch(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_ssidexv2_fetch_invalid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_ssidexv2_not_dell(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_vendor_variant_id_not_found(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_amp_lib_test_case_init(test: *mut kunit) -> c_int {
...
// Create dummy amp driver dev
    priv.amp_dev = faux_device_create("cs_amp_lib_test_drv", core::ptr::null_mut(), core::ptr::null_mut());
