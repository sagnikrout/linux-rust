...
//! Source: sound/soc/codecs/da9055.c
#![no_std]
...
// Status Registers
pub const DA9055_STATUS1: c_uint = 0x02;
pub const DA9055_PLL_STATUS: c_uint = 0x03;
pub const DA9055_AUX_L_GAIN_STATUS: c_uint = 0x04;
pub const DA9055_AUX_R_GAIN_STATUS: c_uint = 0x05;
pub const DA9055_MIC_L_GAIN_STATUS: c_uint = 0x06;
pub const DA9055_MIC_R_GAIN_STATUS: c_uint = 0x07;
pub const DA9055_MIXIN_L_GAIN_STATUS: c_uint = 0x08;
pub const DA9055_MIXIN_R_GAIN_STATUS: c_uint = 0x09;
pub const DA9055_ADC_L_GAIN_STATUS: c_uint = 0x0A;
pub const DA9055_ADC_R_GAIN_STATUS: c_uint = 0x0B;
pub const DA9055_DAC_L_GAIN_STATUS: c_uint = 0x0C;
pub const DA9055_DAC_R_GAIN_STATUS: c_uint = 0x0D;
pub const DA9055_HP_L_GAIN_STATUS: c_uint = 0x0E;
pub const DA9055_HP_R_GAIN_STATUS: c_uint = 0x0F;
pub const DA9055_LINE_GAIN_STATUS: c_uint = 0x10;
// System Initialisation Registers
pub const DA9055_CIF_CTRL: c_uint = 0x20;

pub const DA9055_SR: c_uint = 0x22;
pub const DA9055_REFERENCES: c_uint = 0x23;
pub const DA9055_PLL_FRAC_TOP: c_uint = 0x24;
pub const DA9055_PLL_FRAC_BOT: c_uint = 0x25;
pub const DA9055_PLL_INTEGER: c_uint = 0x26;
pub const DA9055_PLL_CTRL: c_uint = 0x27;
pub const DA9055_AIF_CLK_MODE: c_uint = 0x28;
pub const DA9055_AIF_CTRL: c_uint = 0x29;
pub const DA9055_DIG_ROUTING_DAC: c_uint = 0x2A;
pub const DA9055_ALC_CTRL1: c_uint = 0x2B;
// Input - Gain, Select and Filter Registers
pub const DA9055_AUX_L_GAIN: c_uint = 0x30;
pub const DA9055_AUX_R_GAIN: c_uint = 0x31;
pub const DA9055_MIXIN_L_SELECT: c_uint = 0x32;
pub const DA9055_MIXIN_R_SELECT: c_uint = 0x33;
pub const DA9055_MIXIN_L_GAIN: c_uint = 0x34;
pub const DA9055_MIXIN_R_GAIN: c_uint = 0x35;
pub const DA9055_ADC_L_GAIN: c_uint = 0x36;
pub const DA9055_ADC_R_GAIN: c_uint = 0x37;
pub const DA9055_ADC_FILTERS1: c_uint = 0x38;
pub const DA9055_MIC_L_GAIN: c_uint = 0x39;
pub const DA9055_MIC_R_GAIN: c_uint = 0x3A;
// Output - Gain, Select and Filter Registers
pub const DA9055_DAC_FILTERS5: c_uint = 0x40;
pub const DA9055_DAC_FILTERS2: c_uint = 0x41;
pub const DA9055_DAC_FILTERS3: c_uint = 0x42;
pub const DA9055_DAC_FILTERS4: c_uint = 0x43;
pub const DA9055_DAC_FILTERS1: c_uint = 0x44;
pub const DA9055_DAC_L_GAIN: c_uint = 0x45;
pub const DA9055_DAC_R_GAIN: c_uint = 0x46;
pub const DA9055_CP_CTRL: c_uint = 0x47;
pub const DA9055_HP_L_GAIN: c_uint = 0x48;
pub const DA9055_HP_R_GAIN: c_uint = 0x49;
pub const DA9055_LINE_GAIN: c_uint = 0x4A;
pub const DA9055_MIXOUT_L_SELECT: c_uint = 0x4B;
pub const DA9055_MIXOUT_R_SELECT: c_uint = 0x4C;
// System Controller Registers
pub const DA9055_SYSTEM_MODES_INPUT: c_uint = 0x50;
pub const DA9055_SYSTEM_MODES_OUTPUT: c_uint = 0x51;
// Control Registers
pub const DA9055_AUX_L_CTRL: c_uint = 0x60;
pub const DA9055_AUX_R_CTRL: c_uint = 0x61;
pub const DA9055_MIC_BIAS_CTRL: c_uint = 0x62;
pub const DA9055_MIC_L_CTRL: c_uint = 0x63;
pub const DA9055_MIC_R_CTRL: c_uint = 0x64;
pub const DA9055_MIXIN_L_CTRL: c_uint = 0x65;
pub const DA9055_MIXIN_R_CTRL: c_uint = 0x66;
pub const DA9055_ADC_L_CTRL: c_uint = 0x67;
pub const DA9055_ADC_R_CTRL: c_uint = 0x68;
pub const DA9055_DAC_L_CTRL: c_uint = 0x69;
pub const DA9055_DAC_R_CTRL: c_uint = 0x6A;
pub const DA9055_HP_L_CTRL: c_uint = 0x6B;
pub const DA9055_HP_R_CTRL: c_uint = 0x6C;
pub const DA9055_LINE_CTRL: c_uint = 0x6D;
pub const DA9055_MIXOUT_L_CTRL: c_uint = 0x6E;
pub const DA9055_MIXOUT_R_CTRL: c_uint = 0x6F;
// Configuration Registers
pub const DA9055_LDO_CTRL: c_uint = 0x90;
pub const DA9055_IO_CTRL: c_uint = 0x91;
pub const DA9055_GAIN_RAMP_CTRL: c_uint = 0x92;
pub const DA9055_MIC_CONFIG: c_uint = 0x93;
pub const DA9055_PC_COUNT: c_uint = 0x94;
pub const DA9055_CP_VOL_THRESHOLD1: c_uint = 0x95;
pub const DA9055_CP_DELAY: c_uint = 0x96;
pub const DA9055_CP_DETECTOR: c_uint = 0x97;
pub const DA9055_AIF_OFFSET: c_uint = 0x98;
pub const DA9055_DIG_CTRL: c_uint = 0x99;
pub const DA9055_ALC_CTRL2: c_uint = 0x9A;
pub const DA9055_ALC_CTRL3: c_uint = 0x9B;
pub const DA9055_ALC_NOISE: c_uint = 0x9C;
pub const DA9055_ALC_TARGET_MIN: c_uint = 0x9D;
pub const DA9055_ALC_TARGET_MAX: c_uint = 0x9E;
pub const DA9055_ALC_GAIN_LIMITS: c_uint = 0x9F;
pub const DA9055_ALC_ANA_GAIN_LIMITS: c_uint = 0xA0;
pub const DA9055_ALC_ANTICLIP_CTRL: c_uint = 0xA1;
pub const DA9055_ALC_ANTICLIP_LEVEL: c_uint = 0xA2;
pub const DA9055_ALC_OFFSET_OP2M_L: c_uint = 0xA6;
pub const DA9055_ALC_OFFSET_OP2U_L: c_uint = 0xA7;
pub const DA9055_ALC_OFFSET_OP2M_R: c_uint = 0xAB;
pub const DA9055_ALC_OFFSET_OP2U_R: c_uint = 0xAC;
pub const DA9055_ALC_CIC_OP_LVL_CTRL: c_uint = 0xAD;
pub const DA9055_ALC_CIC_OP_LVL_DATA: c_uint = 0xAE;
pub const DA9055_DAC_NG_SETUP_TIME: c_uint = 0xAF;
pub const DA9055_DAC_NG_OFF_THRESHOLD: c_uint = 0xB0;
pub const DA9055_DAC_NG_ON_THRESHOLD: c_uint = 0xB1;
pub const DA9055_DAC_NG_CTRL: c_uint = 0xB2;
// SR bit fields
...
pub const DA9055_ALC_OFFSET_15_8: c_uint = 0x00FF00;
pub const DA9055_ALC_OFFSET_17_16: c_uint = 0x030000;
pub const DA9055_ALC_AVG_ITERATIONS: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pll_div {
    pub fref: c_int,
    ...
    pub frac_bot: u8,
    pub integer: u8,
    pub /: *mut *mut u8 mode; / 0 = slave, 1 = master,
}
...
// Input PGAs
    SND_SOC_DAPM_PGA("Mic Left", DA9055_MIC_L_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic Right", DA9055_MIC_R_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Aux Left", DA9055_AUX_L_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Aux Right", DA9055_AUX_R_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("MIXIN Left", DA9055_MIXIN_L_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("MIXIN Right", DA9055_MIXIN_R_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("Mic Bias", DA9055_MIC_BIAS_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("AIF", DA9055_AIF_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("Charge Pump", DA9055_CP_CTRL, 7, 0, core::ptr::null_mut(), 0),
// Input Mixers
...
// Output PGAs
    SND_SOC_DAPM_PGA("MIXOUT Left", DA9055_MIXOUT_L_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("MIXOUT Right", DA9055_MIXOUT_R_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Lineout", DA9055_LINE_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Headphone Left", DA9055_HP_L_CTRL, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Headphone Right", DA9055_HP_R_CTRL, 7, 0, core::ptr::null_mut(), 0),
// Output Lines
...
// Input path
    ...
    {"Mic Left", core::ptr::null_mut(), "Mic Left Source"},
    {"Mic Right", core::ptr::null_mut(), "Mic Right Source"},
    {"Aux Left", core::ptr::null_mut(), "AUXL"},
    {"Aux Right", core::ptr::null_mut(), "AUXR"},
    ...
    {"MIXIN Left", core::ptr::null_mut(), "In Mixer Left"},
    {"ADC Left", core::ptr::null_mut(), "MIXIN Left"},
    {"MIXIN Right", core::ptr::null_mut(), "In Mixer Right"},
    {"ADC Right", core::ptr::null_mut(), "MIXIN Right"},
    {"ADC Left", core::ptr::null_mut(), "AIF"},
    {"ADC Right", core::ptr::null_mut(), "AIF"},
// Output path
    {"AIFIN Left", core::ptr::null_mut(), "AIF"},
    {"AIFIN Right", core::ptr::null_mut(), "AIF"},
    ...
    {"DAC Left", core::ptr::null_mut(), "DAC Left Source"},
    {"DAC Right", core::ptr::null_mut(), "DAC Right Source"},
    ...
    {"MIXOUT Left", core::ptr::null_mut(), "Out Mixer Left"},
    {"Headphone Left Enable", "Switch", "MIXOUT Left"},
    {"Headphone Left", core::ptr::null_mut(), "Headphone Left Enable"},
    {"Headphone Left", core::ptr::null_mut(), "Charge Pump"},
    {"HPL", core::ptr::null_mut(), "Headphone Left"},
    {"MIXOUT Right", core::ptr::null_mut(), "Out Mixer Right"},
    {"Headphone Right Enable", "Switch", "MIXOUT Right"},
    {"Headphone Right", core::ptr::null_mut(), "Headphone Right Enable"},
    {"Headphone Right", core::ptr::null_mut(), "Charge Pump"},
    {"HPR", core::ptr::null_mut(), "Headphone Right"},
    {"MIXOUT Right", core::ptr::null_mut(), "Out Mixer Right"},
    {"Lineout Enable", "Switch", "MIXOUT Right"},
    {"Lineout", core::ptr::null_mut(), "Lineout Enable"},
    {"LINE", core::ptr::null_mut(), "Lineout"},
    };
// Codec private data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9055_priv {
    pub regmap: *mut regmap,
    pub mclk_rate: c_uint,
    pub master: c_int,
    pub pdata: *mut da9055_platform_data,
}
...
#[no_mangle]
unsafe extern "C" fn da9055_mute(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
