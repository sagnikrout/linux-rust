...
//! Source: sound/soc/codecs/cs35l56-shared-test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs35l56_shared_test_mock_gpio {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs35l56_shared_test_priv {
    pub test: *mut kunit,
    pub amp_dev: *mut faux_device,
    pub gpio_dev: *mut faux_device,
    pub gpio_priv: *mut cs35l56_shared_test_mock_gpio,
    pub registers: *mut regmap,
    pub reg_offset: c_uint,
    pub cs35l56_base: *mut cs35l56_base,
    pub applied_pad_pull_state: [u8; CS35L56_MAX_GPIO],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs35l56_shared_test_param {
    pub spkid_gpios: [c_int; 4],
    pub spkid_pulls: [c_int; 4],
    pub gpio_status: c_ulong,
    pub spkid: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn cs35l56_shared_test_mock_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _cs35l56_shared_test_create_dummy_gpio(test: *mut kunit) {
    static void _cs35l56_shared_test_create_dummy_gpio(struct kunit *test)
    {
    struct cs35l56_shared_test_priv *priv = test.priv;
    priv.gpio_dev = faux_device_create("cs35l56_shared_test_mock_gpio", core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn cs35l56_shared_test_read_gpio_status(priv: *mut cs35l56_shared_test_priv) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_shared_test_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_shared_test_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs35l56_shared_test_get_vendor_spkid_1(dev: *mut device) -> c_int {
...
unsafe extern "C" fn cs35l56_shared_test_get_speaker_id_property(test: *mut kunit) {
    ...
    let mut dev_node: software_node = SOFTWARE_NODE("SPK1", dev_props, core::ptr::null_mut());
...
// Create dummy amp driver dev
    priv.amp_dev = faux_device_create("cs35l56_shared_test_drv", core::ptr::null_mut(), core::ptr::null_mut());
