...
//! Source: sound/soc/codecs/wm8524.c
#![no_std]
...
pub const WM8524_NUM_RATES: c_int = 12;
// codec private data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm8524_priv {
    pub mute: *mut gpio_desc,
    pub sysclk: c_uint,
    pub rate_constraint_list: [c_uint; WM8524_NUM_RATES],
...
#[no_mangle]
unsafe extern "C" fn wm8524_set_fmt(codec_dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8524_mute_stream(dai: *mut snd_soc_dai, mute: c_int, stream: c_int) -> c_int {
