...
//! Source: sound/soc/codecs/jz4760.c
#![no_std]
...
pub const REG_CR1_LO_MUTE_OFFSET: c_int = 4;
pub const REG_CR1_BTL_MUTE_OFFSET: c_int = 3;
pub const REG_CR1_OUTSEL_OFFSET: c_int = 0;

pub const REG_CR3_ADC_INSEL_OFFSET: c_int = 2;

pub const REG_CR3_MICSTEREO_OFFSET: c_int = 1;
pub const REG_CR3_MICDIFF_OFFSET: c_int = 0;
pub const REG_CR4_ADC_HPF_OFFSET: c_int = 7;

pub const REG_PMR1_SB_AIP_OFFSET: c_int = 5;
pub const REG_PMR1_SB_LINE_OFFSET: c_int = 4;
pub const REG_PMR1_SB_MIC1_OFFSET: c_int = 3;
pub const REG_PMR1_SB_MIC2_OFFSET: c_int = 2;
pub const REG_PMR1_SB_BYPASS_OFFSET: c_int = 1;
pub const REG_PMR1_SB_MICBIAS_OFFSET: c_int = 0;
pub const REG_PMR2_SB_ADC_OFFSET: c_int = 4;
pub const REG_PMR2_SB_HP_OFFSET: c_int = 3;
pub const REG_PMR2_SB_BTL_OFFSET: c_int = 2;
pub const REG_PMR2_SB_LOUT_OFFSET: c_int = 1;
pub const REG_PMR2_SB_DAC_OFFSET: c_int = 0;

pub const REG_GCR_GAIN_OFFSET: c_int = 0;
pub const REG_GCR_GAIN_MAX: c_uint = 0x1f;

pub const REG_GCR_GIM_GAIN_MAX: c_int = 7;
...
#[no_mangle]
unsafe extern "C" fn jz4760_codec_mute_stream(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
...
// clear RDO flag
    ...
    REG_PMR2_SB_HP_OFFSET, 1, core::ptr::null_mut(), 0, hpout_event,
    ...
    REG_PMR1_SB_LINE_OFFSET, 1, core::ptr::null_mut(), 0),
    ...
    REG_PMR1_SB_MIC1_OFFSET, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic 2", JZ4760_CODEC_REG_PMR1,
    REG_PMR1_SB_MIC2_OFFSET, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic Diff", JZ4760_CODEC_REG_CR3,
    REG_CR3_MICDIFF_OFFSET, 0, core::ptr::null_mut(), 0),
    ...
    REG_PMR1_SB_BYPASS_OFFSET, 1, core::ptr::null_mut(), 0),
    ...
    REG_PMR1_SB_MICBIAS_OFFSET, 1, core::ptr::null_mut(), 0),
...
// Unconditional routes.
    ...
    { "LOUT", core::ptr::null_mut(), "Line Out" },
    { "ROUT", core::ptr::null_mut(), "Line Out" },
    { "BTL Out", "Switch", "Line Out" },
    { "BTLP", core::ptr::null_mut(), "BTL Out"},
    { "BTLN", core::ptr::null_mut(), "BTL Out"},
    { "PCM Playback", "Volume", "DAC" },
    { "Headphones Playback", "Volume", "PCM Playback" },
    { "SYSCLK", core::ptr::null_mut(), "DAC" },
    };
#[no_mangle]
unsafe extern "C" fn jz4760_codec_codec_init_regs(codec: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn jz4760_codec_volatile(dev: *mut device, reg: c_uint) -> bool {
    static bool jz4760_codec_volatile(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = JZ4760_CODEC_REG_SR || reg == JZ4760_CODEC_REG_IFR;
    }
#[no_mangle]
unsafe extern "C" fn jz4760_codec_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn jz4760_codec_io_wait(codec: *mut jz_codec) -> c_int {
