...
//! Source: sound/soc/codecs/simple-mux.c
#![no_std]
...
pub const MUX_TEXT_SIZE: c_int = 2;
pub const MUX_WIDGET_SIZE: c_int = 4;
pub const MUX_ROUTE_SIZE: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
...
// switch to use priv data instead of default
    ...
    return devm_snd_soc_register_component(dev, &priv.mux_driver, core::ptr::null_mut(), 0);
    }
