...
//! Source: sound/soc/codecs/cs47l15.c
#![no_std]
...
pub const CS47L15_NUM_ADSP: c_int = 1;
pub const CS47L15_MONO_OUTPUTS: c_int = 1;
// Mid-mode registers
pub const CS47L15_ADC_INT_BIAS_MASK: c_uint = 0x3800;
pub const CS47L15_ADC_INT_BIAS_SHIFT: c_int = 11;
pub const CS47L15_PGA_BIAS_SEL_MASK: c_uint = 0x03;
pub const CS47L15_PGA_BIAS_SEL_SHIFT: c_int = 0;
...
// Set IN1 to LP mode
    ...
    MADERA_OUT4L_ENA_SHIFT, 0, core::ptr::null_mut(), 0, madera_spk_ev,
...
//
    ...
    core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("LHPF1", MADERA_HPLPF1_1, MADERA_LHPF1_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("LHPF2", MADERA_HPLPF2_1, MADERA_LHPF2_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("LHPF3", MADERA_HPLPF3_1, MADERA_LHPF3_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("LHPF4", MADERA_HPLPF4_1, MADERA_LHPF4_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    MADERA_ISRC1_DEC3_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC1DEC4", MADERA_ISRC_1_CTRL_3,
    MADERA_ISRC1_DEC4_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    MADERA_ISRC1_INT3_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC1INT4", MADERA_ISRC_1_CTRL_3,
    MADERA_ISRC1_INT4_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    MADERA_ISRC2_DEC3_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC2DEC4", MADERA_ISRC_2_CTRL_3,
    MADERA_ISRC2_DEC4_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    MADERA_ISRC2_INT3_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ISRC2INT4", MADERA_ISRC_2_CTRL_3,
    MADERA_ISRC2_INT4_ENA_SHIFT, 0, core::ptr::null_mut(), 0),
...
// Internal clock domains
    ...
    { "OUT4L", core::ptr::null_mut(), "OUTCLK" },
    ...
    { "ISRC1DEC3", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1DEC4", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1INT1", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1INT2", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1INT3", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC1INT4", core::ptr::null_mut(), "ISRC1CLK" },
    { "ISRC2DEC1", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2DEC2", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2DEC3", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2DEC4", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2INT1", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2INT2", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2INT3", core::ptr::null_mut(), "ISRC2CLK" },
    { "ISRC2INT4", core::ptr::null_mut(), "ISRC2CLK" },
    { "OUT1L", core::ptr::null_mut(), "CPVDD1" },
    { "OUT1R", core::ptr::null_mut(), "CPVDD1" },
    { "OUT4L", core::ptr::null_mut(), "SPKVDD" },
    { "OUT1L", core::ptr::null_mut(), "SYSCLK" },
    { "OUT1R", core::ptr::null_mut(), "SYSCLK" },
    { "OUT4L", core::ptr::null_mut(), "SYSCLK" },
    ...
    { "DSP Trigger Out", core::ptr::null_mut(), "DSP1 Trigger Output" },
    ...
    { "HPOUT1 Demux", core::ptr::null_mut(), "OUT1L" },
    { "HPOUT1 Demux", core::ptr::null_mut(), "OUT1R" },
    { "OUT1R", core::ptr::null_mut(), "HPOUT1 Mono Mux" },
    ...
    { "SPKOUTN", core::ptr::null_mut(), "OUT4L" },
    { "SPKOUTP", core::ptr::null_mut(), "OUT4L" },
...
pub const CS47L15_DIG_VU: c_uint = 0x0200;
