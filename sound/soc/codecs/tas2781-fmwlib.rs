...
//! Source: sound/soc/codecs/tas2781-fmwlib.c
#![no_std]
...
pub const ERROR_PRAM_CRCCHK: c_uint = 0x0000000;
pub const ERROR_YRAM_CRCCHK: c_uint = 0x0000001;
pub const PPC_DRIVER_CRCCHK: c_uint = 0x00000200;

pub const TAS2781_YRAM_BOOK1: c_int = 140;
pub const TAS2781_YRAM1_PAGE: c_int = 42;
pub const TAS2781_YRAM1_START_REG: c_int = 88;

pub const TAS2781_PG_1_0: c_uint = 0xA0;
pub const TAS2781_PG_2_0: c_uint = 0xA8;
pub const TAS2781_YRAM2_START_PAGE: c_int = 43;
pub const TAS2781_YRAM2_END_PAGE: c_int = 49;
pub const TAS2781_YRAM2_START_REG: c_int = 8;
pub const TAS2781_YRAM2_END_REG: c_int = 127;
pub const TAS2781_YRAM3_PAGE: c_int = 50;
pub const TAS2781_YRAM3_START_REG: c_int = 8;
pub const TAS2781_YRAM3_END_REG: c_int = 27;
// should not include B0_P53_R44-R47
pub const TAS2781_YRAM_BOOK2: c_int = 0;
pub const TAS2781_YRAM4_START_PAGE: c_int = 50;
pub const TAS2781_YRAM4_END_PAGE: c_int = 60;
pub const TAS2781_YRAM5_PAGE: c_int = 61;

pub const TASDEVICE_CMD_SING_W: c_uint = 0x1;
pub const TASDEVICE_CMD_BURST: c_uint = 0x2;
pub const TASDEVICE_CMD_DELAY: c_uint = 0x3;
pub const TASDEVICE_CMD_FIELD_W: c_uint = 0x4;
pub const TASDEVICE_MAXPROGRAM_NUM_KERNEL: c_int = 5;
pub const TASDEVICE_MAXCONFIG_NUM_KERNEL_MULTIPLE_AMPS: c_int = 64;
pub const TASDEVICE_MAXCONFIG_NUM_KERNEL: c_int = 10;
pub const MAIN_ALL_DEVICES_1X: c_uint = 0x01;
pub const MAIN_DEVICE_A_1X: c_uint = 0x02;
pub const MAIN_DEVICE_B_1X: c_uint = 0x03;
pub const MAIN_DEVICE_C_1X: c_uint = 0x04;
pub const MAIN_DEVICE_D_1X: c_uint = 0x05;
pub const COEFF_DEVICE_A_1X: c_uint = 0x12;
pub const COEFF_DEVICE_B_1X: c_uint = 0x13;
pub const COEFF_DEVICE_C_1X: c_uint = 0x14;
pub const COEFF_DEVICE_D_1X: c_uint = 0x15;
pub const PRE_DEVICE_A_1X: c_uint = 0x22;
pub const PRE_DEVICE_B_1X: c_uint = 0x23;
pub const PRE_DEVICE_C_1X: c_uint = 0x24;
pub const PRE_DEVICE_D_1X: c_uint = 0x25;
pub const PRE_SOFTWARE_RESET_DEVICE_A: c_uint = 0x41;
pub const PRE_SOFTWARE_RESET_DEVICE_B: c_uint = 0x42;
pub const PRE_SOFTWARE_RESET_DEVICE_C: c_uint = 0x43;
pub const PRE_SOFTWARE_RESET_DEVICE_D: c_uint = 0x44;
pub const POST_SOFTWARE_RESET_DEVICE_A: c_uint = 0x45;
pub const POST_SOFTWARE_RESET_DEVICE_B: c_uint = 0x46;
pub const POST_SOFTWARE_RESET_DEVICE_C: c_uint = 0x47;
pub const POST_SOFTWARE_RESET_DEVICE_D: c_uint = 0x48;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tas2781_cali_specific {
    pub sin_gni: [c_uchar; 4],
    pub sin_gni_reg: c_int,
    pub is_sin_gn_flush: bool,
}
...
// Skip the unused configs
    ...
    let mut subblk_typ: c_uchar = data[1];
    let mut blktyp: c_int = dev_idx & 0xC0;
    let mut idx: c_int = dev_idx & 0x3F;
    ...
    int i;
    let mut len: c_ushort = get_unaligned_be16(&data[2]);
    subblk_offset += 2;
    ...
    {
    let mut blk_size: c_uint = block.blk_size;
...
#[no_mangle]
unsafe extern "C" fn tasdevice_fw_strnlen(fmw: *const firmware, offset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_err_prg_cfg(type: c_uint, dev: *mut tasdevice) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PPC3_VERSION_TAS2781_BASIC_MIN: ppcver >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn tas2781_clear_calfirmware(tas_fmw: *mut tasdevice_fw) {
...
pub unsafe extern "C" fn tasdevice_calbin_remove(context: *mut c_void) {
    ...
    tasdev.cali_data_fmw = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn tas2781_cali_preproc(priv: *mut tasdevice_priv, i: c_int) -> c_int {
...
//
    ...
    let mut k: c_int = i * (cali_data.cali_dat_sz_per_dev + 1);
...
#[no_mangle]
unsafe extern "C" fn tasdev_load_calibrated_data(priv: *mut tasdevice_priv, i: c_int) {
    ...
    let mut prog_status: c_int = 0;
    int status, i;
    if (!tas_fmw) {
    dev_err(tas_priv.dev, "%s: Firmware is core::ptr::null_mut()\n", __func__);
    goto out;
    }
