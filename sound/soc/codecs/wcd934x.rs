...
//! Source: sound/soc/codecs/wcd934x.c
#![no_std]
...
//
pub const SLAVE_PORT_WATER_MARK_6BYTES: c_int = 0;
pub const SLAVE_PORT_WATER_MARK_9BYTES: c_int = 1;
pub const SLAVE_PORT_WATER_MARK_12BYTES: c_int = 2;
pub const SLAVE_PORT_WATER_MARK_15BYTES: c_int = 3;
pub const SLAVE_PORT_WATER_MARK_SHIFT: c_int = 1;
pub const SLAVE_PORT_ENABLE: c_int = 1;
pub const SLAVE_PORT_DISABLE: c_int = 0;

    ((SLAVE_PORT_WATER_MARK_12BYTES << SLAVE_PORT_WATER_MARK_SHIFT) | \
    (SLAVE_PORT_ENABLE))
pub const WCD934X_SLIM_NUM_PORT_REG: c_int = 3;

pub const WCD934X_MCLK_CLK_12P288MHZ: c_int = 12288000;
pub const WCD934X_MCLK_CLK_9P6MHZ: c_int = 9600000;
// Only valid for 9.6 MHz mclk
pub const WCD9XXX_DMIC_SAMPLE_RATE_2P4MHZ: c_int = 2400000;
pub const WCD9XXX_DMIC_SAMPLE_RATE_4P8MHZ: c_int = 4800000;
// Only valid for 12.288 MHz mclk
pub const WCD9XXX_DMIC_SAMPLE_RATE_4P096MHZ: c_int = 4096000;
pub const WCD934X_DMIC_CLK_DIV_2: c_uint = 0x0;
pub const WCD934X_DMIC_CLK_DIV_3: c_uint = 0x1;
pub const WCD934X_DMIC_CLK_DIV_4: c_uint = 0x2;
pub const WCD934X_DMIC_CLK_DIV_6: c_uint = 0x3;
pub const WCD934X_DMIC_CLK_DIV_8: c_uint = 0x4;
pub const WCD934X_DMIC_CLK_DIV_16: c_uint = 0x5;
pub const WCD934X_DMIC_CLK_DRIVE_DEFAULT: c_uint = 0x02;
pub const TX_HPF_CUT_OFF_FREQ_MASK: c_uint = 0x60;
pub const CF_MIN_3DB_4HZ: c_uint = 0x0;
pub const CF_MIN_3DB_75HZ: c_uint = 0x1;
pub const CF_MIN_3DB_150HZ: c_uint = 0x2;
pub const WCD934X_RX_START: c_int = 16;
pub const WCD934X_NUM_INTERPOLATORS: c_int = 9;
pub const WCD934X_RX_PATH_CTL_OFFSET: c_int = 20;
pub const WCD934X_MAX_VALID_ADC_MUX: c_int = 13;
pub const WCD934X_INVALID_ADC_MUX: c_int = 9;

    {.port = p + WCD934X_RX_START, .shift = p,}

    {.port = p, .shift = p,}
// Feature masks to distinguish codec version
pub const DSD_DISABLED_MASK: c_int = 0;
pub const SLNQ_DISABLED_MASK: c_int = 1;
...
//
pub const WCD_VERSION_WCD9340_1_0: c_uint = 0x400;
pub const WCD_VERSION_WCD9341_1_0: c_uint = 0x410;
pub const WCD_VERSION_WCD9340_1_1: c_uint = 0x401;
pub const WCD_VERSION_WCD9341_1_1: c_uint = 0x411;
pub const WCD934X_AMIC_PWR_LEVEL_LP: c_int = 0;
pub const WCD934X_AMIC_PWR_LEVEL_DEFAULT: c_int = 1;
pub const WCD934X_AMIC_PWR_LEVEL_HP: c_int = 2;
pub const WCD934X_AMIC_PWR_LEVEL_HYBRID: c_int = 3;
pub const WCD934X_AMIC_PWR_LVL_MASK: c_uint = 0x60;
pub const WCD934X_AMIC_PWR_LVL_SHIFT: c_uint = 0x5;
pub const WCD934X_DEC_PWR_LVL_MASK: c_uint = 0x06;
pub const WCD934X_DEC_PWR_LVL_LP: c_uint = 0x02;
pub const WCD934X_DEC_PWR_LVL_HP: c_uint = 0x04;
pub const WCD934X_DEC_PWR_LVL_DF: c_uint = 0x00;
...
pub const WCD934X_ZDET_VAL_32: c_int = 32000;
pub const WCD934X_ZDET_VAL_400: c_int = 400000;
pub const WCD934X_ZDET_VAL_1200: c_int = 1200000;
pub const WCD934X_ZDET_VAL_100K: c_int = 100000000;
// Z floating defined in ohms
pub const WCD934X_ZDET_FLOATING_IMPEDANCE: c_uint = 0x0FFFFFFE;
pub const WCD934X_ZDET_NUM_MEASUREMENTS: c_int = 900;

// Z value compared in milliOhm

pub const WCD_MBHC_HS_V_MAX: c_int = 1600;
    ...
    {"RX INT" #id "_1 MIX1", core::ptr::null_mut(), "RX INT" #id "_1 MIX1 INP0"}, \
    {"RX INT" #id "_1 MIX1", core::ptr::null_mut(), "RX INT" #id "_1 MIX1 INP1"}, \
    {"RX INT" #id "_1 MIX1", core::ptr::null_mut(), "RX INT" #id "_1 MIX1 INP2"}, \
    ...
    {"RX INT" #id "_2 MUX", core::ptr::null_mut(), "INT" #id "_CLK"}, \
    {"RX INT" #id "_2 MUX", core::ptr::null_mut(), "DSMDEM" #id "_CLK"}, \
    {"RX INT" #id "_2 INTERP", core::ptr::null_mut(), "RX INT" #id "_2 MUX"},	\
    {"RX INT" #id " SEC MIX", core::ptr::null_mut(), "RX INT" #id "_2 INTERP"},	\
    {"RX INT" #id "_1 INTERP", core::ptr::null_mut(), "RX INT" #id "_1 MIX1"},	\
    {"RX INT" #id "_1 INTERP", core::ptr::null_mut(), "INT" #id "_CLK"},	\
    {"RX INT" #id "_1 INTERP", core::ptr::null_mut(), "DSMDEM" #id "_CLK"},	\
    {"RX INT" #id " SEC MIX", core::ptr::null_mut(), "RX INT" #id "_1 INTERP"}

    {"RX INT" #id " MIX2", core::ptr::null_mut(), "RX INT" #id " SEC MIX"}, \
    {"RX INT" #id " MIX2", core::ptr::null_mut(), "RX INT" #id " MIX2 INP"}

    {"SLIM RX"#id" MUX", "AIF1_PB", "AIF1 PB"},	\
    {"SLIM RX"#id" MUX", "AIF2_PB", "AIF2 PB"},	\
    {"SLIM RX"#id" MUX", "AIF3_PB", "AIF3 PB"},	\
    {"SLIM RX"#id" MUX", "AIF4_PB", "AIF4 PB"},   \
    {"SLIM RX"#id, core::ptr::null_mut(), "SLIM RX"#id" MUX"}
    ...
    {"IIR" #id, core::ptr::null_mut(), "IIR" #id " INP0 MUX"},	\
    ...
    {"IIR" #id, core::ptr::null_mut(), "IIR" #id " INP1 MUX"},	\
    ...
    {"IIR" #id, core::ptr::null_mut(), "IIR" #id " INP2 MUX"},	\
    ...
    {"IIR" #id, core::ptr::null_mut(), "IIR" #id " INP3 MUX"},	\
    ...
    {"SLIM TX" #id, core::ptr::null_mut(), "CDC_IF TX" #id " MUX"}

pub const NUM_CODEC_DAIS: c_int = 9;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wcd934x_mbhc_zdet_param {
    pub ldo_ctl: u16,
    pub noff: u16,
    pub nshift: u16,
    pub btn5: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wcd_slim_codec_dai_data {
    pub slim_ch_list: list_head,
    pub sconfig: slim_stream_config,
    pub sruntime: *mut slim_stream_runtime,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wcd934x_codec {
    pub dev: *mut device,
    pub hw: clk_hw,
    pub extclk: *mut clk,
    pub regmap: *mut regmap,
    pub if_regmap: *mut regmap,
    pub sdev: *mut slim_device,
    pub sidev: *mut slim_device,
    pub clsh_ctrl: *mut wcd_clsh_ctrl,
    pub common: wcd_common,
    pub component: *mut snd_soc_component,
    pub rx_chs: [wcd934x_slim_ch; WCD934X_RX_MAX],
    pub tx_chs: [wcd934x_slim_ch; WCD934X_TX_MAX],
    pub dai: [wcd_slim_codec_dai_data; NUM_CODEC_DAIS],
    pub rate: c_int,
    pub version: u32,
    pub hph_mode: u32,
    pub tx_port_value: [u32; WCD934X_TX_MAX],
    pub rx_port_value: [u32; WCD934X_RX_MAX],
    pub sido_input_src: c_int,
    pub dmic_0_1_clk_cnt: c_int,
    pub dmic_2_3_clk_cnt: c_int,
    pub dmic_4_5_clk_cnt: c_int,
    pub dmic_sample_rate: c_int,
    pub comp_enabled: [c_int; COMPANDER_MAX],
    pub sysclk_users: c_int,
    pub sysclk_mutex: mutex,
// mbhc module
    pub mbhc: *mut wcd_mbhc,
    pub mbhc_cfg: wcd_mbhc_config,
    pub intr_ids: wcd_mbhc_intr,
    pub mbhc_started: bool,
    pub micb_lock: mutex,
    pub micb_ref: [u32; WCD934X_MAX_MICBIAS],
    pub pullup_ref: [u32; WCD934X_MAX_MICBIAS],
}
...
#[no_mangle]
unsafe extern "C" fn wcd934x_set_sido_input_src(wcd: *mut wcd934x_codec, sido_src: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_enable_ana_bias_and_sysclk(wcd: *mut wcd934x_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_disable_ana_bias_and_syclk(wcd: *mut wcd934x_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __wcd934x_cdc_mclk_enable(wcd: *mut wcd934x_codec, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_get_version(wcd: *mut wcd934x_codec) -> c_int {
    static int wcd934x_get_version(struct wcd934x_codec *wcd)
    {
    int val1, val2, ver, ret;
    struct regmap *regmap;
    u16 id_minor;
    let mut version_mask: u32 = 0;
    regmap = wcd.regmap;
    ver = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(0x01: id_minor ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_enable_efuse_sensing(wcd: *mut wcd934x_codec) {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_swrm_clock(wcd: *mut wcd934x_codec, enable: bool) -> c_int {
...
//
    ...
    let mut shift: u8 = 0, shift_val = 0, tx_mux_sel;
    struct wcd934x_slim_ch *ch;
    int tx_port, tx_port_reg;
    let mut decimator: c_int = -1;
    list_for_each_entry(ch, &wcd.dai[dai.id].slim_ch_list, list) {
    tx_port = ch.port;
...
#[no_mangle]
unsafe extern "C" fn wcd934x_init_dmic(comp: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_hw_init(wcd: *mut wcd934x_codec) {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_comp_init(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_slim_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_mbhc_micb_en_status(component: *mut snd_soc_component, micb_num: c_int) -> bool {
...
// Default pull up current to 2uA
    ...
    let mut micb_index: c_int = micb_num - 1;
    u16 micb_reg;
    switch (micb_num) {
    case MIC_BIAS_1:
...
#[no_mangle]
pub unsafe extern "C" fn if(minCode_param[noff]: x1 <) -> else {
...
// z_val = ((*z_val) * 10000) / q1_cal;
    ...
    let mut is_fsm_disable: bool = false;
    struct wcd934x_mbhc_zdet_param zdet_param[] = {
    ...
    struct wcd934x_mbhc_zdet_param *zdet_param_ptr = core::ptr::null_mut();
    s16 d1_a[][4] = {
    {0, 30, 90, 30},
    {0, 30, 30, 5},
    {0, 30, 30, 5},
...
// First get impedance on Left
    ...
    wcd934x_mbhc_zdet_ramp(component, zdet_param_ptr, &z1L, core::ptr::null_mut(), d1);
...
// Start of right impedance ramp and calculation
    wcd934x_mbhc_zdet_ramp(component, zdet_param_ptr, core::ptr::null_mut(), &z1R, d1);
...
// Mono/stereo detection
    ...
    wcd934x_mbhc_zdet_ramp(component, &zdet_param[0], &z1Ls, core::ptr::null_mut(), d1);
    else
    wcd934x_mbhc_zdet_ramp(component, &zdet_param[1], &z1Ls, core::ptr::null_mut(), d1);
    snd_soc_component_write_field(component, WCD934X_HPH_PA_CTL2,
...
// For NO-jack, re-enable L_DET_EN after Z-det measurements
    ...
    wcd934x_get_hph_type, core::ptr::null_mut()),
    };
    static const struct snd_kcontrol_new impedance_detect_controls[] = {
    SOC_SINGLE_EXT("HPHL Impedance", 0, 0, INT_MAX, 0,
    wcd934x_hph_impedance_get, core::ptr::null_mut()),
    SOC_SINGLE_EXT("HPHR Impedance", 0, 1, INT_MAX, 0,
    wcd934x_hph_impedance_get, core::ptr::null_mut()),
    };
#[no_mangle]
unsafe extern "C" fn wcd934x_mbhc_init(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_mbhc_deinit(component: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_comp_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_comp_remove(comp: *mut snd_soc_component) {
    ...
    {
    struct wcd934x_codec *wcd = dev_get_drvdata(comp.dev);
    let mut val: c_int = WCD934X_CODEC_RPM_CLK_MCLK_CFG_9P6MHZ;
    wcd.rate = freq;
...
// Mask bits top 2 bits since they are reserved
    ...
    {
    let mut reg: c_int = WCD934X_CDC_SIDETONE_IIR0_IIR_COEF_B2_CTL + 16 * iir_idx;
...
// Mask top 2 bits, 7-8 are reserved
    ...
    u32 coeff[BAND_MAX];
    let mut reg: c_int = WCD934X_CDC_SIDETONE_IIR0_IIR_COEF_B1_CTL + 16 * iir_idx;
...
// Updates addr automatically for each B2 write
    ...
    let mut comp: c_int = ((struct soc_mixer_control *)kc.private_value).shift;
    struct wcd934x_codec *wcd = dev_get_drvdata(component.dev);
...
#[no_mangle]
unsafe extern "C" fn slim_rx_mux_to_dai_id(mux: c_int) -> c_int {
    ...
    let mut port_id: u32 = w.shift;
    let mut found: bool = false;
    int mux_idx;
    let mut prev_mux_idx: c_int = wcd.rx_port_value[port_id];
    int aif_id;
...
#[no_mangle]
pub unsafe extern "C" fn if(WCD934X_CDC_RX1_RX_PATH_SEC0: e->reg ==) -> else {
    else if (e.reg == WCD934X_CDC_RX1_RX_PATH_SEC0)
    reg = WCD934X_CDC_RX1_RX_PATH_CFG0;
#[no_mangle]
pub unsafe extern "C" fn if(WCD934X_CDC_RX2_RX_PATH_SEC0: e->reg ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: e->shift_l ==) -> else {
    else if (e.shift_l == 2)
    mic_sel_reg = WCD934X_CDC_TX4_TX_PATH_CFG0;
#[no_mangle]
pub unsafe extern "C" fn if(4: e->shift_l ==) -> else {
    else if (e.shift_l == 4)
...
// ADC: 0, DMIC: 1
    ...
    let mut port_id: c_int = mixer.shift;
    ...
    struct soc_mixer_control *mixer =
    (struct soc_mixer_control *)kc.private_value;
    let mut enable: c_int = ucontrol.value.integer.value[0];
    struct wcd934x_slim_ch *ch, *c;
    let mut dai_id: c_int = widget.shift;
    let mut port_id: c_int = mixer.shift;
...
// Gain Controls
    ...
    {
    u8 hph_dly_mask;
    let mut hph_lut_bypass_reg: u16 = 0;
    switch (interp_idx) {
    case INTERP_HPHL:
    hph_dly_mask = 1;
...
// Enable Compander Clock
    ...
    {
    struct snd_soc_component *comp = snd_soc_dapm_to_component(w.dapm);
    let mut interp_idx: c_int = w.shift;
    let mut main_reg: u16 = WCD934X_CDC_RX0_RX_PATH_CTL + (interp_idx * 20);
    switch (event) {
    case SND_SOC_DAPM_PRE_PMU:
// Clk enable
...
// Disable AutoChop timer during power up
    ...
    struct snd_soc_component *comp = snd_soc_dapm_to_component(w.dapm);
    struct wcd934x_codec *wcd = dev_get_drvdata(comp.dev);
    let mut hph_mode: c_int = wcd.hph_mode;
    u8 dem_inp;
    switch (event) {
    case SND_SOC_DAPM_PRE_PMU:
// Read DEM INP Select
...
//
    ...
    {
    u8 tx_stream_fs;
    let mut adc_mux_index: u8 = 0, adc_mux_sel = 0;
    let mut dec_found: bool = false;
...
// Default value to return in case of error
    ...
    char *dec_adc_mux_name = core::ptr::null_mut();
    char *widget_name;
    let mut ret: c_int = 0, amic_n;
...
//
    ...
    let mut micb_num: c_int = w.shift;
    switch (event) {
    case SND_SOC_DAPM_PRE_PMU:
...
// Analog Outputs
    ...
    SND_SOC_DAPM_MIXER("SLIM RX0", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM RX1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM RX2", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM RX3", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM RX4", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM RX5", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM RX6", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM RX7", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    SND_SOC_DAPM_MIXER("RX INT3_1 MIX1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT3 SEC MIX", SND_SOC_NOPM, 0, 0,
    rx_int3_asrc_switch,
    ARRAY_SIZE(rx_int3_asrc_switch)),
    SND_SOC_DAPM_MIXER("RX INT4_1 MIX1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT4 SEC MIX", SND_SOC_NOPM, 0, 0,
    rx_int4_asrc_switch,
    ARRAY_SIZE(rx_int4_asrc_switch)),
    SND_SOC_DAPM_MIXER("RX INT7_1 MIX1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT7 SEC MIX", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT8_1 MIX1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT8 SEC MIX", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    SND_SOC_DAPM_MIXER("RX INT1 MIX3", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT2 MIX2", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT2 MIX3", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT3 MIX2", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT3 MIX3", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT4 MIX2", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT4 MIX3", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("RX INT7 MIX2", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    0, 0, core::ptr::null_mut(), 0, wcd934x_codec_set_iir_gain,
    SND_SOC_DAPM_POST_PMU),
    SND_SOC_DAPM_PGA_E("IIR1", WCD934X_CDC_SIDETONE_IIR1_IIR_GAIN_B1_CTL,
    1, 0, core::ptr::null_mut(), 0, wcd934x_codec_set_iir_gain,
    SND_SOC_DAPM_POST_PMU),
    ...
    SND_SOC_DAPM_DAC_E("RX INT0 DAC", core::ptr::null_mut(), SND_SOC_NOPM,
    0, 0, wcd934x_codec_ear_dac_event,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_DAC_E("RX INT1 DAC", core::ptr::null_mut(), WCD934X_ANA_HPH,
    5, 0, wcd934x_codec_hphl_dac_event,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_DAC_E("RX INT2 DAC", core::ptr::null_mut(), WCD934X_ANA_HPH,
    4, 0, wcd934x_codec_hphr_dac_event,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_DAC_E("RX INT3 DAC", core::ptr::null_mut(), SND_SOC_NOPM,
    0, 0, wcd934x_codec_lineout_dac_event,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_DAC_E("RX INT4 DAC", core::ptr::null_mut(), SND_SOC_NOPM,
    0, 0, wcd934x_codec_lineout_dac_event,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_PGA_E("EAR PA", WCD934X_ANA_EAR, 7, 0, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA_E("HPHL PA", WCD934X_ANA_HPH, 7, 0, core::ptr::null_mut(), 0,
    wcd934x_codec_enable_hphl_pa,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_PGA_E("HPHR PA", WCD934X_ANA_HPH, 6, 0, core::ptr::null_mut(), 0,
    wcd934x_codec_enable_hphr_pa,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_PGA_E("LINEOUT1 PA", WCD934X_ANA_LO_1_2, 7, 0, core::ptr::null_mut(), 0,
    core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA_E("LINEOUT2 PA", WCD934X_ANA_LO_1_2, 6, 0, core::ptr::null_mut(), 0,
    core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("RX_BIAS", WCD934X_ANA_RX_SUPPLIES, 0, 0, core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
...
// TX
    ...
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_MIXER("SLIM TX0", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX2", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX3", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX4", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX5", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX6", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX7", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX8", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX9", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX10", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX11", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SLIM TX13", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// Digital Mic Inputs
    SND_SOC_DAPM_ADC_E("DMIC0", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0,
    ...
    wcd934x_codec_enable_dmic,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("DMIC3", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0,
    wcd934x_codec_enable_dmic,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("DMIC4", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0,
    wcd934x_codec_enable_dmic,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("DMIC5", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0,
    wcd934x_codec_enable_dmic,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    ...
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMU |
    SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("ADC1", core::ptr::null_mut(), WCD934X_ANA_AMIC1, 7, 0,
    wcd934x_codec_enable_adc, SND_SOC_DAPM_PRE_PMU),
    SND_SOC_DAPM_ADC_E("ADC2", core::ptr::null_mut(), WCD934X_ANA_AMIC2, 7, 0,
    wcd934x_codec_enable_adc, SND_SOC_DAPM_PRE_PMU),
    SND_SOC_DAPM_ADC_E("ADC3", core::ptr::null_mut(), WCD934X_ANA_AMIC3, 7, 0,
    wcd934x_codec_enable_adc, SND_SOC_DAPM_PRE_PMU),
    SND_SOC_DAPM_ADC_E("ADC4", core::ptr::null_mut(), WCD934X_ANA_AMIC4, 7, 0,
    wcd934x_codec_enable_adc, SND_SOC_DAPM_PRE_PMU),
...
// RX0 Ear out
    ...
    {"RX INT0 DAC", core::ptr::null_mut(), "RX INT0 DEM MUX"},
    {"RX INT0 DAC", core::ptr::null_mut(), "RX_BIAS"},
    {"EAR PA", core::ptr::null_mut(), "RX INT0 DAC"},
    {"EAR", core::ptr::null_mut(), "EAR PA"},
// RX1 Headphone left
    WCD934X_INTERPOLATOR_PATH(1),
    WCD934X_INTERPOLATOR_MIX2(1),
    {"RX INT1 MIX3", core::ptr::null_mut(), "RX INT1 MIX2"},
    {"RX INT1 DEM MUX", "CLSH_DSM_OUT", "RX INT1 MIX3"},
    {"RX INT1 DAC", core::ptr::null_mut(), "RX INT1 DEM MUX"},
    {"RX INT1 DAC", core::ptr::null_mut(), "RX_BIAS"},
    {"HPHL PA", core::ptr::null_mut(), "RX INT1 DAC"},
    {"HPHL", core::ptr::null_mut(), "HPHL PA"},
// RX2 Headphone right
    WCD934X_INTERPOLATOR_PATH(2),
    WCD934X_INTERPOLATOR_MIX2(2),
    {"RX INT2 MIX3", core::ptr::null_mut(), "RX INT2 MIX2"},
    {"RX INT2 DEM MUX", "CLSH_DSM_OUT", "RX INT2 MIX3"},
    {"RX INT2 DAC", core::ptr::null_mut(), "RX INT2 DEM MUX"},
    {"RX INT2 DAC", core::ptr::null_mut(), "RX_BIAS"},
    {"HPHR PA", core::ptr::null_mut(), "RX INT2 DAC"},
    {"HPHR", core::ptr::null_mut(), "HPHR PA"},
// RX3 HIFi LineOut1
    WCD934X_INTERPOLATOR_PATH(3),
    WCD934X_INTERPOLATOR_MIX2(3),
    {"RX INT3 MIX3", core::ptr::null_mut(), "RX INT3 MIX2"},
    {"RX INT3 DAC", core::ptr::null_mut(), "RX INT3 MIX3"},
    {"RX INT3 DAC", core::ptr::null_mut(), "RX_BIAS"},
    {"LINEOUT1 PA", core::ptr::null_mut(), "RX INT3 DAC"},
    {"LINEOUT1", core::ptr::null_mut(), "LINEOUT1 PA"},
// RX4 HIFi LineOut2
    WCD934X_INTERPOLATOR_PATH(4),
    WCD934X_INTERPOLATOR_MIX2(4),
    {"RX INT4 MIX3", core::ptr::null_mut(), "RX INT4 MIX2"},
    {"RX INT4 DAC", core::ptr::null_mut(), "RX INT4 MIX3"},
    {"RX INT4 DAC", core::ptr::null_mut(), "RX_BIAS"},
    {"LINEOUT2 PA", core::ptr::null_mut(), "RX INT4 DAC"},
    {"LINEOUT2", core::ptr::null_mut(), "LINEOUT2 PA"},
// RX7 Speaker Left Out PA
    WCD934X_INTERPOLATOR_PATH(7),
    WCD934X_INTERPOLATOR_MIX2(7),
    {"RX INT7 CHAIN", core::ptr::null_mut(), "RX INT7 MIX2"},
    {"RX INT7 CHAIN", core::ptr::null_mut(), "RX_BIAS"},
    {"RX INT7 CHAIN", core::ptr::null_mut(), "SBOOST0"},
    {"RX INT7 CHAIN", core::ptr::null_mut(), "SBOOST0_CLK"},
    {"SPK1 OUT", core::ptr::null_mut(), "RX INT7 CHAIN"},
// RX8 Speaker Right Out PA
    WCD934X_INTERPOLATOR_PATH(8),
    {"RX INT8 CHAIN", core::ptr::null_mut(), "RX INT8 SEC MIX"},
    {"RX INT8 CHAIN", core::ptr::null_mut(), "RX_BIAS"},
    {"RX INT8 CHAIN", core::ptr::null_mut(), "SBOOST1"},
    {"RX INT8 CHAIN", core::ptr::null_mut(), "SBOOST1_CLK"},
    {"SPK2 OUT", core::ptr::null_mut(), "RX INT8 CHAIN"},
// Tx
    {"AIF1 CAP", core::ptr::null_mut(), "AIF1_CAP Mixer"},
    {"AIF2 CAP", core::ptr::null_mut(), "AIF2_CAP Mixer"},
    {"AIF3 CAP", core::ptr::null_mut(), "AIF3_CAP Mixer"},
    ...
    { "DMIC0", core::ptr::null_mut(), "DMIC0 Pin" },
    { "DMIC1", core::ptr::null_mut(), "DMIC1 Pin" },
    { "DMIC2", core::ptr::null_mut(), "DMIC2 Pin" },
    { "DMIC3", core::ptr::null_mut(), "DMIC3 Pin" },
    { "DMIC4", core::ptr::null_mut(), "DMIC4 Pin" },
    { "DMIC5", core::ptr::null_mut(), "DMIC5 Pin" },
    {"ADC1", core::ptr::null_mut(), "AMIC1"},
    {"ADC2", core::ptr::null_mut(), "AMIC2"},
    {"ADC3", core::ptr::null_mut(), "AMIC3"},
    {"ADC4", core::ptr::null_mut(), "AMIC4_5 SEL"},
...
#[no_mangle]
unsafe extern "C" fn wcd934x_put_device_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_codec_parse_data(wcd: *mut wcd934x_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_codec_probe(pdev: *mut platform_device) -> c_int {
