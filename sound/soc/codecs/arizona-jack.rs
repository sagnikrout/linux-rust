...
//! Source: sound/soc/codecs/arizona-jack.c
#![no_std]
...
pub const ARIZONA_MAX_MICD_RANGE: c_int = 8;
//
// The hardware supports 8 ranges / buttons, but the snd-jack interface
// only supports 6 buttons (button 0-5).
//
pub const ARIZONA_MAX_MICD_BUTTONS: c_int = 6;
pub const ARIZONA_MICD_CLAMP_MODE_JDL: c_uint = 0x4;
pub const ARIZONA_MICD_CLAMP_MODE_JDH: c_uint = 0x5;
pub const ARIZONA_MICD_CLAMP_MODE_JDL_GP5H: c_uint = 0x9;
pub const ARIZONA_MICD_CLAMP_MODE_JDH_GP5H: c_uint = 0xb;
pub const ARIZONA_TST_CAP_DEFAULT: c_uint = 0x3;
pub const ARIZONA_TST_CAP_CLAMP: c_uint = 0x1;
pub const ARIZONA_HPDET_MAX: c_int = 10000;
pub const HPDET_DEBOUNCE: c_int = 500;
pub const DEFAULT_MICD_TIMEOUT: c_int = 2000;
pub const ARIZONA_HPDET_WAIT_COUNT: c_int = 15;
pub const ARIZONA_HPDET_WAIT_DELAY_MS: c_int = 20;
pub const QUICK_HEADPHONE_MAX_OHM: c_int = 3;
pub const MICROPHONE_MIN_OHM: c_int = 1257;
pub const MICROPHONE_MAX_OHM: c_int = 30000;
pub const MICD_DBTIME_TWO_READINGS: c_int = 2;
pub const MICD_DBTIME_FOUR_READINGS: c_int = 4;
...
pub const ARIZONA_NUM_MICD_BUTTON_LEVELS: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn arizona_extcon_set_mode(info: *mut arizona_priv, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn arizona_extcon_pulse_micbias(info: *mut arizona_priv) {
...
#[no_mangle]
unsafe extern "C" fn arizona_start_mic(info: *mut arizona_priv) {
...
#[no_mangle]
unsafe extern "C" fn arizona_stop_mic(info: *mut arizona_priv) {
...
pub const ARIZONA_HPDET_B_RANGE_MAX: c_uint = 0x3fb;
    static struct {
    int min;
    int max;
...
#[no_mangle]
unsafe extern "C" fn arizona_hpdet_read(info: *mut arizona_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_hpdet_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn arizona_identify_headphone(info: *mut arizona_priv) {
...
#[no_mangle]
unsafe extern "C" fn arizona_start_hpdet_acc_id(info: *mut arizona_priv) {
    static void arizona_start_hpdet_acc_id(struct arizona_priv *info)
    {
    struct arizona *arizona = info.arizona;
    let mut hp_reading: c_int = 32;
    bool mic;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn arizona_micd_adc_read(info: *mut arizona_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MICROPHONE_MIN_OHM: val <=) -> else {
    else if (val <= MICROPHONE_MIN_OHM)
    val = ARIZONA_MICD_STS | ARIZONA_MICD_LVL_1;
#[no_mangle]
pub unsafe extern "C" fn if(MICROPHONE_MAX_OHM: val <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn arizona_micd_read(info: *mut arizona_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_micdet_reading(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_button_reading(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_micdet(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t arizona_micdet(int irq, void *data)
    {
    struct arizona_priv *info = data;
    struct arizona *arizona = info.arizona;
    let mut debounce: c_int = arizona.pdata.micd_detect_debounce;
...
#[no_mangle]
unsafe extern "C" fn arizona_hpdet_wait(info: *mut arizona_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_jackdet(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    if (cancelled_mic) {
    let mut micd_timeout: c_int = arizona.pdata.micd_timeout;
    queue_delayed_work(system_power_efficient_wq,
    &info.micd_timeout_work,
...
// Program the level itself
    ...
    {
    let mut prop: *const char  const = "wlf,micd-configs";
    let mut entries_per_config: c_int = 3;
    ...
    let mut val: c_uint = ARIZONA_ACCDET_MODE_HPL;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn arizona_jack_codec_dev_probe(info: *mut arizona_priv, dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arizona_jack_codec_dev_remove(info: *mut arizona_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_jack_disable_jack_detect(info: *mut arizona_priv) -> c_int {
