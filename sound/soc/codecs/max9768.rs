...
//! Source: sound/soc/codecs/max9768.c
#![no_std]
...
// "Registers"
pub const MAX9768_VOL: c_int = 0;
pub const MAX9768_CTRL: c_int = 3;
// Commands
pub const MAX9768_CTRL_PWM: c_uint = 0x15;
pub const MAX9768_CTRL_FILTERLESS: c_uint = 0x16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max9768 {
    pub regmap: *mut regmap,
    pub mute: *mut gpio_desc,
    pub shdn: *mut gpio_desc,
    pub flags: u32,
}
    ...
    let mut val: c_int = gpiod_get_value_cansleep(max9768.mute);
...
// Activate chip by releasing shutdown, enables I2C
    ...
    &max9768_component_driver, core::ptr::null_mut(), 0);
    }
