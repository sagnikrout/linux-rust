...
//! Source: sound/soc/codecs/ad1980.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ad1980_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad1980_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
    ...
    { "Capture", core::ptr::null_mut(), "MIC1" },
    { "Capture", core::ptr::null_mut(), "MIC2" },
    { "Capture", core::ptr::null_mut(), "CD_L" },
    { "Capture", core::ptr::null_mut(), "CD_R" },
    { "Capture", core::ptr::null_mut(), "AUX_L" },
    { "Capture", core::ptr::null_mut(), "AUX_R" },
    { "Capture", core::ptr::null_mut(), "LINE_IN_L" },
    { "Capture", core::ptr::null_mut(), "LINE_IN_R" },
    { "LFE_OUT", core::ptr::null_mut(), "Playback" },
    { "CENTER_OUT", core::ptr::null_mut(), "Playback" },
    { "LINE_OUT_L", core::ptr::null_mut(), "Playback" },
    { "LINE_OUT_R", core::ptr::null_mut(), "Playback" },
    { "MONO_OUT", core::ptr::null_mut(), "Playback" },
    { "HP_OUT_L", core::ptr::null_mut(), "Playback" },
    { "HP_OUT_R", core::ptr::null_mut(), "Playback" },
    };
...
pub const AD1980_VENDOR_ID: c_uint = 0x41445300;
pub const AD1980_VENDOR_MASK: c_uint = 0xffffff00;
#[no_mangle]
unsafe extern "C" fn ad1980_reset(component: *mut snd_soc_component, try_warm: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad1980_soc_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad1980_soc_remove(component: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn ad1980_probe(pdev: *mut platform_device) -> c_int {
