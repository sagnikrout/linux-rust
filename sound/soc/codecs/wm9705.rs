...
//! Source: sound/soc/codecs/wm9705.c
#![no_std]
...
pub const WM9705_VENDOR_ID: c_uint = 0x574d4c05;
pub const WM9705_VENDOR_ID_MASK: c_uint = 0xffffffff;
#[repr(C)]
#[derive(Copy, Clone)]
...
// DAPM widgets
    ...
    SND_SOC_DAPM_PGA("Headphone PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Speaker PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Line PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Line out PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mono PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Phone PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("PCBEEP PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("CD PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("ADC PGA", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
...
// HP mixer
    ...
    {"HP Mixer", core::ptr::null_mut(), "Left DAC"},
    {"HP Mixer", core::ptr::null_mut(), "Right DAC"},
// mono mixer
    {"Mono Mixer", core::ptr::null_mut(), "HP Mixer"},
// outputs
    {"Headphone PGA", core::ptr::null_mut(), "HP Mixer"},
    {"HPOUTL", core::ptr::null_mut(), "Headphone PGA"},
    {"HPOUTR", core::ptr::null_mut(), "Headphone PGA"},
    {"Line out PGA", core::ptr::null_mut(), "HP Mixer"},
    {"LOUT", core::ptr::null_mut(), "Line out PGA"},
    {"ROUT", core::ptr::null_mut(), "Line out PGA"},
    {"Mono PGA", core::ptr::null_mut(), "Mono Mixer"},
    {"MONOOUT", core::ptr::null_mut(), "Mono PGA"},
// inputs
    {"CD PGA", core::ptr::null_mut(), "CDINL"},
    {"CD PGA", core::ptr::null_mut(), "CDINR"},
    ...
    {"Mic PGA", core::ptr::null_mut(), "Mic Source"},
    {"PCBEEP PGA", core::ptr::null_mut(), "PCBEEP"},
...
// Right capture source
    ...
    {"ADC PGA", core::ptr::null_mut(), "Left Capture Source"},
    {"ADC PGA", core::ptr::null_mut(), "Right Capture Source"},
// ADC's
    {"Left ADC",  core::ptr::null_mut(), "ADC PGA"},
    {"Right ADC", core::ptr::null_mut(), "ADC PGA"},
    };
...
#[no_mangle]
unsafe extern "C" fn wm9705_soc_suspend(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm9705_soc_resume(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm9705_soc_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm9705_probe(pdev: *mut platform_device) -> c_int {
    static int wm9705_probe(struct platform_device *pdev)
    {
    struct wm9705_priv *wm9705;
    wm9705 = devm_kzalloc(&pdev.dev, sizeof(*wm9705), GFP_KERNEL);
    if (wm9705 == core::ptr::null_mut())
    return -ENOMEM;
