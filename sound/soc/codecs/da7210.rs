...
//! Source: sound/soc/codecs/da7210.c
#![no_std]
...
pub const DA7210_PAGE_CONTROL: c_uint = 0x00;
pub const DA7210_CONTROL: c_uint = 0x01;
pub const DA7210_STATUS: c_uint = 0x02;
pub const DA7210_STARTUP1: c_uint = 0x03;
pub const DA7210_STARTUP2: c_uint = 0x04;
pub const DA7210_STARTUP3: c_uint = 0x05;
pub const DA7210_MIC_L: c_uint = 0x07;
pub const DA7210_MIC_R: c_uint = 0x08;
pub const DA7210_AUX1_L: c_uint = 0x09;
pub const DA7210_AUX1_R: c_uint = 0x0A;
pub const DA7210_AUX2: c_uint = 0x0B;
pub const DA7210_IN_GAIN: c_uint = 0x0C;
pub const DA7210_INMIX_L: c_uint = 0x0D;
pub const DA7210_INMIX_R: c_uint = 0x0E;
pub const DA7210_ADC_HPF: c_uint = 0x0F;
pub const DA7210_ADC: c_uint = 0x10;

pub const DA7210_ADC_EQ3_4: c_uint = 0x12;
pub const DA7210_ADC_EQ5: c_uint = 0x13;
pub const DA7210_DAC_HPF: c_uint = 0x14;
pub const DA7210_DAC_L: c_uint = 0x15;
pub const DA7210_DAC_R: c_uint = 0x16;
pub const DA7210_DAC_SEL: c_uint = 0x17;
pub const DA7210_SOFTMUTE: c_uint = 0x18;
pub const DA7210_DAC_EQ1_2: c_uint = 0x19;
pub const DA7210_DAC_EQ3_4: c_uint = 0x1A;
pub const DA7210_DAC_EQ5: c_uint = 0x1B;
pub const DA7210_OUTMIX_L: c_uint = 0x1C;
pub const DA7210_OUTMIX_R: c_uint = 0x1D;
pub const DA7210_OUT1_L: c_uint = 0x1E;
pub const DA7210_OUT1_R: c_uint = 0x1F;
pub const DA7210_OUT2: c_uint = 0x20;
pub const DA7210_HP_L_VOL: c_uint = 0x21;
pub const DA7210_HP_R_VOL: c_uint = 0x22;
pub const DA7210_HP_CFG: c_uint = 0x23;
pub const DA7210_ZERO_CROSS: c_uint = 0x24;
pub const DA7210_DAI_SRC_SEL: c_uint = 0x25;
pub const DA7210_DAI_CFG1: c_uint = 0x26;
pub const DA7210_DAI_CFG3: c_uint = 0x28;
pub const DA7210_PLL_DIV1: c_uint = 0x29;
pub const DA7210_PLL_DIV2: c_uint = 0x2A;
pub const DA7210_PLL_DIV3: c_uint = 0x2B;
pub const DA7210_PLL: c_uint = 0x2C;
pub const DA7210_ALC_MAX: c_uint = 0x83;
pub const DA7210_ALC_MIN: c_uint = 0x84;
pub const DA7210_ALC_NOIS: c_uint = 0x85;
pub const DA7210_ALC_ATT: c_uint = 0x86;
pub const DA7210_ALC_REL: c_uint = 0x87;
pub const DA7210_ALC_DEL: c_uint = 0x88;
pub const DA7210_A_HID_UNLOCK: c_uint = 0x8A;
pub const DA7210_A_TEST_UNLOCK: c_uint = 0x8B;
pub const DA7210_A_PLL1: c_uint = 0x90;
pub const DA7210_A_CP_MODE: c_uint = 0xA7;
// STARTUP1 bit fields
...
pub const DA7210_INPGA_MIN_VOL_NS: c_uint = 0x0A  /* 10.5dB */;
pub const DA7210_AUX1_MIN_VOL_NS: c_uint = 0x35  /* 6dB */;
// OUT1_L bit fields
...
// Input PGAs
    SND_SOC_DAPM_PGA("Mic Left", DA7210_STARTUP3, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic Right", DA7210_STARTUP3, 1, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Aux1 Left", DA7210_STARTUP3, 2, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Aux1 Right", DA7210_STARTUP3, 3, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Aux2 Mono", DA7210_STARTUP3, 4, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("INPGA Left", DA7210_INMIX_L, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("INPGA Right", DA7210_INMIX_R, 7, 0, core::ptr::null_mut(), 0),
// MICBIAS
    SND_SOC_DAPM_SUPPLY("Mic Bias", DA7210_MIC_L, 6, 0, core::ptr::null_mut(), 0),
// Input Mixers
...
// Output PGAs
    SND_SOC_DAPM_PGA("OUTPGA Left Enable", DA7210_OUTMIX_L, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("OUTPGA Right Enable", DA7210_OUTMIX_R, 7, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Out1 Left", DA7210_STARTUP2, 0, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Out1 Right", DA7210_STARTUP2, 1, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Out2 Mono", DA7210_STARTUP2, 2, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Headphone Left", DA7210_STARTUP2, 3, 1, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Headphone Right", DA7210_STARTUP2, 4, 1, core::ptr::null_mut(), 0),
// Output Lines
...
// Input path
    {"Mic Left", core::ptr::null_mut(), "MICL"},
    {"Mic Right", core::ptr::null_mut(), "MICR"},
    {"Aux1 Left", core::ptr::null_mut(), "AUX1L"},
    {"Aux1 Right", core::ptr::null_mut(), "AUX1R"},
    {"Aux2 Mono", core::ptr::null_mut(), "AUX2"},
    ...
    {"INPGA Left", core::ptr::null_mut(), "In Mixer Left"},
    {"ADC Left", core::ptr::null_mut(), "INPGA Left"},
    {"INPGA Right", core::ptr::null_mut(), "In Mixer Right"},
    {"ADC Right", core::ptr::null_mut(), "INPGA Right"},
// Output path
    ...
    {"OUTPGA Left Enable", core::ptr::null_mut(), "Out Mixer Left"},
    {"OUTPGA Right Enable", core::ptr::null_mut(), "Out Mixer Right"},
    {"Out1 Left", core::ptr::null_mut(), "OUTPGA Left Enable"},
    {"OUT1L", core::ptr::null_mut(), "Out1 Left"},
    {"Out1 Right", core::ptr::null_mut(), "OUTPGA Right Enable"},
    {"OUT1R", core::ptr::null_mut(), "Out1 Right"},
    {"Headphone Left", core::ptr::null_mut(), "OUTPGA Left Enable"},
    {"HPL", core::ptr::null_mut(), "Headphone Left"},
    {"Headphone Right", core::ptr::null_mut(), "OUTPGA Right Enable"},
    {"HPR", core::ptr::null_mut(), "Headphone Right"},
    {"Out2 Mono", core::ptr::null_mut(), "Mono Mixer"},
    {"OUT2", core::ptr::null_mut(), "Out2 Mono"},
    };
// Codec private data
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn da7210_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn da7210_mute(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
    static int da7210_mute(struct snd_soc_dai *dai, int mute, int direction)
    {
    struct snd_soc_component *component = dai.component;
    let mut mute_reg: u8 = snd_soc_component_read(component, DA7210_DAC_HPF) & 0xFB;
    if (mute)
...
#[no_mangle]
unsafe extern "C" fn da7210_modinit() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn da7210_exit() -> void __exit {
