...
//! Source: sound/soc/codecs/hdmi-codec.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmi_codec_cea_spk_alloc {
    pub ca_id: c_int,
    pub n_ch: c_uint,
    pub mask: c_ulong,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmi_codec_priv {
    pub hcd: hdmi_codec_pdata,
    pub eld: [u8; MAX_ELD_BYTES],
    pub eld_parsed: snd_parsed_hdmi_eld,
    pub chmap_info: *mut snd_pcm_chmap,
    pub chmap_idx: c_uint,
    pub lock: mutex,
    pub busy: bool,
    pub jack: *mut snd_soc_jack,
    pub jack_status: c_uint,
    pub iec_status: [u8; AES_IEC958_STATUS_SIZE],
...
#[no_mangle]
unsafe extern "C" fn hdmi_codec_spk_mask_from_alloc(spk_alloc: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn hdmi_codec_eld_chmap(hcp: *mut hdmi_codec_priv) {
...
// If spk_alloc == 0, HDMI is unplugged return stereo config
    ...
    let mut has_capture: bool = !hcp.hcd.no_i2s_capture;
    let mut has_playback: bool = !hcp.hcd.no_i2s_playback;
    let mut ret: c_int = 0;
...
// Select chmap supported
    ...
    let mut ca_id: u8 = 0;
    let mut pcm_audio: bool = !(hcp.iec_status[0] & IEC958_AES0_NONAUDIO);
    if (pcm_audio) {
// Select a channel allocation that matches with ELD and pcm channels
    ...
    let mut width: c_uint = snd_pcm_format_width(runtime.format);
...
#[no_mangle]
unsafe extern "C" fn hdmi_codec_mute(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
...
//
    ...
    core::ptr::null_mut(), drv.playback.channels_max, 0,
    &hcp.chmap_info);
    if (ret < 0)
    return ret;
// override handlers
...
#[no_mangle]
unsafe extern "C" fn hdmi_dai_proc_free(hcp: *mut hdmi_codec_priv) {
...
unsafe extern "C" fn hdmi_remove(component: *mut snd_soc_component) {
    ...
    hcp.hcd.data, core::ptr::null_mut(), core::ptr::null_mut());
    }
