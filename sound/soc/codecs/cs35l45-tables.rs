...
//! Source: sound/soc/codecs/cs35l45-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs35l45_apply_patch(cs35l45: *mut cs35l45_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs35l45_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs35l45_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cs35l45_get_clk_freq_id(freq: c_uint) -> c_int {
