...
//! Source: sound/soc/codecs/hdac_hdmi.c
#![no_std]
...
pub const HDA_MAX_CVTS: c_int = 3;
pub const HDA_MAX_PORTS: c_int = 3;
pub const ELD_MAX_SIZE: c_int = 256;
pub const ELD_FIXED_BYTES: c_int = 20;
pub const ELD_VER_CEA_861D: c_int = 2;
pub const ELD_VER_PARTIAL: c_int = 31;
pub const ELD_MAX_MNL: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_cvt_params {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_cvt {
    pub head: list_head,
    pub nid: hda_nid_t,
    pub name: *const c_char,
    pub params: hdac_hdmi_cvt_params,
}

// Currently only spk_alloc, more to be added
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_parsed_eld {
    pub spk_alloc: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_eld {
    pub monitor_present: bool,
    pub eld_valid: bool,
    pub eld_size: c_int,
    pub eld_buffer: [c_char; ELD_MAX_SIZE],
    pub info: hdac_hdmi_parsed_eld,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_pin {
    pub head: list_head,
    pub nid: hda_nid_t,
    pub mst_capable: bool,
    pub ports: *mut hdac_hdmi_port,
    pub num_ports: c_int,
    pub hdev: *mut hdac_device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_port {
    pub head: list_head,
    pub id: c_int,
    pub pin: *mut hdac_hdmi_pin,
    pub num_mux_nids: c_int,
    pub mux_nids: [hda_nid_t; HDA_MAX_CONNECTIONS],
    pub eld: hdac_hdmi_eld,
    pub jack_pin: *const c_char,
    pub is_connect: bool,
    pub dapm: *mut snd_soc_dapm_context,
    pub output_pin: *const c_char,
    pub dapm_work: work_struct,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_pcm {
    pub head: list_head,
    pub pcm_id: c_int,
    pub port_list: list_head,
    pub cvt: *mut hdac_hdmi_cvt,
    ...
    pub lock: mutex,
    pub jack_event: c_int,
    pub eld_ctl: *mut snd_kcontrol,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_dai_port_map {
    pub dai_id: c_int,
    pub port: *mut hdac_hdmi_port,
    pub cvt: *mut hdac_hdmi_cvt,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_drv_data {
    pub vendor_nid: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdac_hdmi_priv {
    pub hdev: *mut hdac_device,
    pub component: *mut snd_soc_component,
    pub card: *mut snd_card,
    pub dai_map: [hdac_hdmi_dai_port_map; HDA_MAX_CVTS],
    pub pin_list: list_head,
    pub cvt_list: list_head,
    ...
    pub drv_data: *mut hdac_hdmi_drv_data,
...
unsafe extern "C" fn sad_sample_bits_lpcm(sad: *const u8) -> c_uint {
    ...
    void *eld)
    {
    let mut formats: u64 = SNDRV_PCM_FMTBIT_S16;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_verify_connect_sel_all_pins(hdev: *mut hdac_device) {
    static void hdac_hdmi_verify_connect_sel_all_pins(struct hdac_device *hdev)
    {
    struct hdac_hdmi_priv *hdmi = hdev_to_hdmi_priv(hdev);
    struct hdac_hdmi_port *port;
    struct hdac_hdmi_cvt *cvt;
    let mut cvt_idx: c_int = 0;
...
//
    ...
    if (dai_map.port)
    dai_map.port = core::ptr::null_mut();
    }
    static int
...
// To hold inputs to the Pin mux
    ...
    let mut i: c_int = 0;
    let mut num_items: c_int = hdmi.num_cvt + 1;
...
// enum texts: ["NONE", "cvt #", "cvt #", ...]
    ...
    snd_soc_dapm_mux, port, widget_name, core::ptr::null_mut(), kc, 1,
...
// Add cvt <- input <- mux route map
    ...
    struct soc_enum *se;
    let mut mux_index: c_int = hdmi.num_cvt + hdmi.num_ports;
    int i, j;
    ...
    se.texts[j + 1],
    widgets[j].name, core::ptr::null_mut());
    rindex++;
    }
    mux_index++;
    }
...
//
#[no_mangle]
unsafe extern "C" fn create_fill_widget_route_map(dapm: *mut snd_soc_dapm_context) -> c_int {
...
// DAPM widgets to represent each converter widget
    ...
    widget_name, dai_drv[i].playback.stream_name, core::ptr::null_mut(), 0,
    ...
    widget_name, core::ptr::null_mut(), core::ptr::null_mut(), 0,
...
// Add pin <- NULL <- mux route map
    list_for_each_entry(pin, &hdmi.pin_list, head) {
    for (j = 0; j < pin.num_ports; j++) {
    let mut sink_index: c_int = i + hdmi.num_cvt;
    int src_index = sink_index + pin.num_ports *
    hdmi.num_pin;
    hdac_hdmi_fill_route(&route[i],
    widgets[sink_index].name, core::ptr::null_mut(),
    widgets[src_index].name, core::ptr::null_mut());
    i++;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_init_dai_map(hdev: *mut hdac_device) -> c_int {
    static int hdac_hdmi_init_dai_map(struct hdac_device *hdev)
    {
    struct hdac_hdmi_priv *hdmi = hdev_to_hdmi_priv(hdev);
    struct hdac_hdmi_dai_port_map *dai_map;
    struct hdac_hdmi_cvt *cvt;
    let mut dai_id: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_add_cvt(hdev: *mut hdac_device, nid: hda_nid_t) -> c_int {
...
//
    ...
    let mut max_ports: c_int = HDA_MAX_PORTS;
    int i;
//
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_add_pin(hdev: *mut hdac_device, nid: hda_nid_t) -> c_int {
...
pub const INTEL_VENDOR_NID: c_uint = 0x08;
pub const INTEL_GLK_VENDOR_NID: c_uint = 0x0b;
pub const INTEL_GET_VENDOR_VERB: c_uint = 0xf81;
pub const INTEL_SET_VENDOR_VERB: c_uint = 0x781;
pub const INTEL_EN_DP12: c_uint = 0x02 /* enable DP 1.2 features */;
pub const INTEL_EN_ALL_PIN_CVTS: c_uint = 0x01 /* enable 2nd & 3rd pins and convertors */;
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_skl_enable_all_pins(hdev: *mut hdac_device) {
    static void hdac_hdmi_skl_enable_all_pins(struct hdac_device *hdev)
    {
    unsigned int vendor_param;
    struct hdac_hdmi_priv *hdmi = hdev_to_hdmi_priv(hdev);
    let mut vendor_nid: c_uint = hdmi.drv_data.vendor_nid;
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_skl_enable_dp12(hdev: *mut hdac_device) {
...
//
    ...
    let mut i: c_int = 0;
    u32 rates, bps;
    let mut rate_max: c_uint = 384000, rate_min = 8000;
    u64 formats;
    int ret;
    ...
    &rates,	&formats, core::ptr::null_mut(), &bps);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_pin2port(aptr: *mut c_void, pin: c_int) -> c_int {
    static int hdac_hdmi_pin2port(void *aptr, int pin)
    {
    return pin - 4; /* map NID 0x05 . port #1 */
    }
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_eld_notify_cb(aptr: *mut c_void, port: c_int, pipe: c_int) {
    static void hdac_hdmi_eld_notify_cb(void *aptr, int port, int pipe)
    {
    struct hdac_device *hdev = aptr;
    struct hdac_hdmi_priv *hdmi = hdev_to_hdmi_priv(hdev);
    struct hdac_hdmi_pin *pin;
    struct hdac_hdmi_port *hport = core::ptr::null_mut();
    struct snd_soc_component *component = hdmi.component;
    int i;
// Don't know how this mapping is derived
    let mut pin_nid: hda_nid_t = port + 0x04;
...
#[no_mangle]
unsafe extern "C" fn hdmi_codec_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_codec_remove(component: *mut snd_soc_component) {
    static void hdmi_codec_remove(struct snd_soc_component *component)
    {
    struct hdac_hdmi_priv *hdmi = snd_soc_component_get_drvdata(component);
    struct hdac_device *hdev = hdmi.hdev;
    int ret;
    ret = snd_hdac_acomp_register_notifier(hdev.bus, core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn hdmi_codec_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_hdac_hdmi_pcm_attached(hdev: *mut hdac_device, pcm_idx: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_get_spk_alloc(hdev: *mut hdac_device, pcm_idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_dev_probe(hdev: *mut hdac_device) -> c_int {
    static int hdac_hdmi_dev_probe(struct hdac_device *hdev)
    {
    struct hdac_hdmi_priv *hdmi_priv;
    struct snd_soc_dai_driver *hdmi_dais = core::ptr::null_mut();
    struct hdac_ext_link *hlink;
...
// hold the ref while we probe
    ...
    if (hdmi_priv == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn clear_dapm_works(hdev: *mut hdac_device) {
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_dev_remove(hdev: *mut hdac_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdac_hdmi_runtime_resume(dev: *mut device) -> c_int {
...
// Power up afg
    ...
    RUNTIME_PM_OPS(hdac_hdmi_runtime_suspend, hdac_hdmi_runtime_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn hdmi_init() -> int __init {
    static int __init hdmi_init(void)
    {
    return snd_hda_ext_driver_register(&hdmi_driver);
    }
#[no_mangle]
unsafe extern "C" fn hdmi_exit() -> void __exit {
