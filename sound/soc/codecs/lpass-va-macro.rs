...
//! Source: sound/soc/codecs/lpass-va-macro.c
#![no_std]
...
pub const CDC_VA_DMIC_CLK_SEL_SHFT: c_int = 1;
pub const CDC_VA_DMIC_CLK_SEL_DIV0: c_uint = 0x0;
pub const CDC_VA_DMIC_CLK_SEL_DIV1: c_uint = 0x2;
pub const CDC_VA_DMIC_CLK_SEL_DIV2: c_uint = 0x4;
pub const CDC_VA_DMIC_CLK_SEL_DIV3: c_uint = 0x6;
pub const CDC_VA_DMIC_CLK_SEL_DIV4: c_uint = 0x8;
pub const CDC_VA_DMIC_CLK_SEL_DIV5: c_uint = 0xa;

pub const CDC_VA_RESET_ALL_DMICS_DISABLE: c_int = 0;

pub const CDC_VA_DMIC_FREQ_CHANGE_DISABLE: c_int = 0;

pub const CDC_VA_TX_PATH_CLK_DISABLE: c_int = 0;

pub const CDC_VA_TX_PATH_PGA_MUTE_DISABLE: c_int = 0;

pub const CDC_VA_ADC_MODE_SHIFT: c_int = 1;

pub const CF_MIN_3DB_4HZ: c_uint = 0x0;
pub const CF_MIN_3DB_75HZ: c_uint = 0x1;
pub const CF_MIN_3DB_150HZ: c_uint = 0x2;

pub const CDC_VA_TX_HPF_ZERO_GATE: c_int = 0;

pub const CDC_VA_TX_PATH_ADC_DMIC_SEL_ADC: c_int = 0;

pub const VA_MACRO_NUM_DECIMATORS: c_int = 4;
...
pub const VA_MACRO_MCLK_FREQ: c_int = 9600000;
pub const VA_MACRO_TX_PATH_OFFSET: c_uint = 0x80;
pub const VA_MACRO_SWR_MIC_MUX_SEL_MASK: c_uint = 0xF;
pub const VA_MACRO_ADC_MUX_CFG_OFFSET: c_uint = 0x8;
...
pub const VA_NUM_CLKS_MAX: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct va_macro {
    pub dev: *mut device,
    pub active_ch_mask: [c_ulong; VA_MACRO_MAX_DAIS],
    pub active_ch_cnt: [c_ulong; VA_MACRO_MAX_DAIS],
    pub dmic_clk_div: u16,
    pub has_swr_master: bool,
    pub has_npl_clk: bool,
    pub dec_mode: [c_int; VA_MACRO_NUM_DECIMATORS],
    ...
    pub dmic_0_1_clk_cnt: i32,
    pub dmic_2_3_clk_cnt: i32,
    pub dmic_4_5_clk_cnt: i32,
    pub dmic_6_7_clk_cnt: i32,
    pub dmic_0_1_clk_div: u8,
    pub dmic_2_3_clk_div: u8,
    pub dmic_4_5_clk_div: u8,
    pub dmic_6_7_clk_div: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct va_macro_data {
    pub has_swr_master: bool,
    pub has_npl_clk: bool,
    pub version: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn va_is_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn va_is_rw_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn va_macro_digital_mute(dai: *mut snd_soc_dai, mute: c_int, stream: c_int) -> c_int {
    ...
    SND_SOC_DAPM_ADC_E("VA DMIC0", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("VA DMIC1", core::ptr::null_mut(), SND_SOC_NOPM, 1, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("VA DMIC2", core::ptr::null_mut(), SND_SOC_NOPM, 2, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("VA DMIC3", core::ptr::null_mut(), SND_SOC_NOPM, 3, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("VA DMIC4", core::ptr::null_mut(), SND_SOC_NOPM, 4, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("VA DMIC5", core::ptr::null_mut(), SND_SOC_NOPM, 5, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("VA DMIC6", core::ptr::null_mut(), SND_SOC_NOPM, 6, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_ADC_E("VA DMIC7", core::ptr::null_mut(), SND_SOC_NOPM, 7, 0,
    va_macro_enable_dmic, SND_SOC_DAPM_PRE_PMU |
    SND_SOC_DAPM_POST_PMD),
    ...
    {"VA_AIF1 CAP", core::ptr::null_mut(), "VA_MCLK"},
    {"VA_AIF2 CAP", core::ptr::null_mut(), "VA_MCLK"},
    {"VA_AIF3 CAP", core::ptr::null_mut(), "VA_MCLK"},
    {"VA_AIF1 CAP", core::ptr::null_mut(), "VA_AIF1_CAP Mixer"},
    {"VA_AIF2 CAP", core::ptr::null_mut(), "VA_AIF2_CAP Mixer"},
    {"VA_AIF3 CAP", core::ptr::null_mut(), "VA_AIF3_CAP Mixer"},
    ...
    { "VA DMIC0", core::ptr::null_mut(), "DMIC0 Pin" },
    { "VA DMIC1", core::ptr::null_mut(), "DMIC1 Pin" },
    { "VA DMIC2", core::ptr::null_mut(), "DMIC2 Pin" },
    { "VA DMIC3", core::ptr::null_mut(), "DMIC3 Pin" },
    { "VA DMIC4", core::ptr::null_mut(), "DMIC4 Pin" },
    { "VA DMIC5", core::ptr::null_mut(), "DMIC5 Pin" },
    { "VA DMIC6", core::ptr::null_mut(), "DMIC6 Pin" },
    { "VA DMIC7", core::ptr::null_mut(), "DMIC7 Pin" },
    };
...
unsafe extern "C" fn va_macro_register_fsgen_output(va: *mut va_macro) -> c_int {
    ...
    {
    u32 div_factor;
    let mut mclk_rate: u32 = VA_MACRO_MCLK_FREQ;
...
unsafe extern "C" fn va_macro_set_lpass_codec_version(va: *mut va_macro) -> c_int {
    ...
    {
    let mut version: c_int = LPASS_CODEC_VERSION_UNKNOWN;
    u32 maj, min, step;
    u32 val;
...
unsafe extern "C" fn va_macro_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(va_macro_runtime_suspend, va_macro_runtime_resume, core::ptr::null_mut())
    };
