...
//! Source: sound/soc/codecs/framer-codec.c
#![no_std]
...
pub const FRAMER_NB_CHANNEL: c_int = 32;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct framer_codec {
    pub framer: *mut framer,
    pub dev: *mut device,
    pub jack: snd_soc_jack,
    pub nb: notifier_block,
    pub carrier_work: work_struct,
...
#[no_mangle]
unsafe extern "C" fn framer_formats(nb_ts: u8) -> u64 {
...
//
    ...
    let mut framer_dai_formats: static u64 = SND_SOC_POSSIBLE_DAIFMT_DSP_B;
...
// Get framer from parents node
    framer.framer = devm_framer_get(&pdev.dev, core::ptr::null_mut());
