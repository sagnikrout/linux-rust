...
//! Source: sound/soc/jz4740/jz4740-i2s.c
#![no_std]
...
pub const JZ_REG_AIC_CONF: c_uint = 0x00;
pub const JZ_REG_AIC_CTRL: c_uint = 0x04;
pub const JZ_REG_AIC_I2S_FMT: c_uint = 0x10;
pub const JZ_REG_AIC_FIFO_STATUS: c_uint = 0x14;
pub const JZ_REG_AIC_I2S_STATUS: c_uint = 0x1c;
pub const JZ_REG_AIC_CLK_DIV: c_uint = 0x30;
pub const JZ_REG_AIC_FIFO: c_uint = 0x34;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2s_soc_info {
    pub dai: *mut snd_soc_dai_driver,
    pub field_rx_fifo_thresh: reg_field,
    pub field_tx_fifo_thresh: reg_field,
    pub field_i2sdiv_capture: reg_field,
    pub field_i2sdiv_playback: reg_field,
    pub shared_fifo_flush: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct jz4740_i2s {
    pub regmap: *mut regmap,
    pub field_rx_fifo_thresh: *mut regmap_field,
    pub field_tx_fifo_thresh: *mut regmap_field,
    pub field_i2sdiv_capture: *mut regmap_field,
    pub field_i2sdiv_playback: *mut regmap_field,
    pub clk_aic: *mut clk,
    pub clk_i2s: *mut clk,
    pub playback_dma_data: snd_dmaengine_dai_dma_data,
    pub capture_dma_data: snd_dmaengine_dai_dma_data,
    pub soc_info: *const i2s_soc_info,
}
...
#[no_mangle]
unsafe extern "C" fn jz4740_i2s_set_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
    static int jz4740_i2s_set_fmt(struct snd_soc_dai *dai, unsigned int fmt)
    {
    struct jz4740_i2s *i2s = snd_soc_dai_get_drvdata(dai);
    const unsigned int conf_mask = JZ_AIC_CONF_BIT_CLK_MASTER |
    JZ_AIC_CONF_SYNC_CLK_MASTER;
    let mut conf: c_uint = 0, format = 0;
...
#[no_mangle]
unsafe extern "C" fn jz4740_i2s_dai_probe(dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_i2s_suspend(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_i2s_resume(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_i2s_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_i2s_remove(component: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_i2s_dev_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    return ret;
    return devm_snd_dmaengine_pcm_register(dev, core::ptr::null_mut(),
