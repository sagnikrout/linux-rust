...
//! Source: sound/soc/renesas/siu_pcm.c
#![no_std]
...
pub const RWF_STM_RD: c_uint = 0x01		/* Read in progress */;
pub const RWF_STM_WT: c_uint = 0x02		/* Write in progress */;
...
#[no_mangle]
unsafe extern "C" fn filter(chan: *mut dma_chan, secondary: *mut c_void) -> bool {
