...
//! Source: sound/soc/renesas/siu_dai.c
#![no_std]
...
pub const PRAM_SIZE: c_uint = 0x2000;
pub const XRAM_SIZE: c_uint = 0x800;
pub const YRAM_SIZE: c_uint = 0x800;
pub const XRAM_OFFSET: c_uint = 0x4000;
pub const YRAM_OFFSET: c_uint = 0x6000;
pub const REG_OFFSET: c_uint = 0xc000;
pub const PLAYBACK_ENABLED: c_int = 1;
pub const CAPTURE_ENABLED: c_int = 2;
pub const VOLUME_CAPTURE: c_int = 0;
pub const VOLUME_PLAYBACK: c_int = 1;
pub const DFLT_VOLUME_LEVEL: c_uint = 0x08000800;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct port_flag {
    pub playback: format_flag,
    pub capture: format_flag,
}
...
#[no_mangle]
unsafe extern "C" fn siu_dai_stop(port_info: *mut siu_port) {
...
#[no_mangle]
unsafe extern "C" fn siu_dai_open(siu_stream: *mut siu_stream) {
...
//
#[no_mangle]
unsafe extern "C" fn siu_dai_pcmdatapack(siu_stream: *mut siu_stream) {
...
#[no_mangle]
pub unsafe extern "C" fn siu_init_port(port: c_int, port_info: *mut siu_port, card: *mut snd_card) -> c_int {
