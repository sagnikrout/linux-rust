...
//! Source: sound/soc/renesas/rcar/cmd.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_cmd_attach(io: *mut rsnd_dai_stream, id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_cmd_probe(priv: *mut rsnd_priv) -> c_int {
...
// same number as DVC
    ...
    &rsnd_cmd_ops, core::ptr::null_mut(), core::ptr::null_mut(),
    RSND_MOD_CMD, i);
    if (ret)
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_cmd_remove(priv: *mut rsnd_priv) {
