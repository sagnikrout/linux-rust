...
//! Source: sound/soc/renesas/rcar/ssi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rsnd_ssi_status_clear(mod: *mut rsnd_mod) {
    static void rsnd_ssi_status_clear(struct rsnd_mod *mod)
    {
    rsnd_mod_write(mod, SSISR, 0);
    }
#[no_mangle]
unsafe extern "C" fn rsnd_ssi_status_get(mod: *mut rsnd_mod) -> u32 {
...
unsafe extern "C" fn rsnd_rdai_width_to_swl(rdai: *mut rsnd_dai) -> u32 {
    ...
    struct device *dev = rsnd_priv_to_dev(priv);
    let mut width: c_int = rsnd_rdai_width_get(rdai);
    switch (width) {
...
// idx = j;
    ...
    struct rsnd_ssi *ssi = rsnd_mod_to_ssi(mod);
    let mut chan: c_int = rsnd_runtime_channel_for_ssi(io);
    int idx, ret;
    unsigned int main_rate;
...
//
    ...
    struct rsnd_ssi *ssi = rsnd_mod_to_ssi(mod);
    let mut cr_own: u32 = ssi.cr_own;
    let mut cr_mode: u32 = ssi.cr_mode;
    let mut wsr: u32 = ssi.wsr;
    int width;
...
#[no_mangle]
unsafe extern "C" fn rsnd_ssi_register_setup(mod: *mut rsnd_mod) {
...
// clear error status
    ...
    {
    struct rsnd_dai *rdai = rsnd_io_to_rdai(io);
    let mut fmt_width: c_uint = snd_pcm_format_width(params_format(params));
...
//
    ...
    struct rsnd_priv *priv = rsnd_mod_to_priv(mod);
    struct device *dev = rsnd_priv_to_dev(priv);
    let mut is_dma: c_int = rsnd_ssi_is_dma_mode(mod);
    u32 status;
    let mut elapsed: bool = false;
...
#[no_mangle]
unsafe extern "C" fn rsnd_ssi_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// buf = (rsnd_mod_read(mod, SSIRDR) >> shift);
    ...
    let mut period_pos: c_int = byte_pos / ssi.byte_per_period;
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_ssi_is_dma_mode(mod: *mut rsnd_mod) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __rsnd_ssi_is_pin_sharing(mod: *mut rsnd_mod) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_ssi_probe(priv: *mut rsnd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_ssi_remove(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_ssi_suspend(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_ssi_resume(priv: *mut rsnd_priv) {
