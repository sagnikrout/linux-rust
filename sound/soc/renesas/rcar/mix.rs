...
//! Source: sound/soc/renesas/rcar/mix.c
#![no_std]
...
pub struct rsnd_mix {
    pub mod: rsnd_mod,
    pub /: *mut *mut rsnd_kctrl_cfg_s volumeA; / MDBAR,
    pub /: *mut *mut rsnd_kctrl_cfg_s volumeB; / MDBBR,
    pub /: *mut *mut rsnd_kctrl_cfg_s volumeC; / MDBCR,
    pub /: *mut *mut rsnd_kctrl_cfg_s volumeD; / MDBDR,
    pub /: *mut *mut rsnd_kctrl_cfg_s ren; / Ramp Enable,
    pub /: *mut *mut rsnd_kctrl_cfg_s rup; / Ramp Rate Up,
    pub /: *mut *mut rsnd_kctrl_cfg_s rdw; / Ramp Rate Down,
    pub flags: u32,
}

pub const VOL_MAX: c_uint = 0x3ff;
    ...
    i++)
#[no_mangle]
unsafe extern "C" fn rsnd_mix_activation(mod: *mut rsnd_mod) {
...
#[no_mangle]
unsafe extern "C" fn rsnd_mix_halt(mod: *mut rsnd_mod) {
    ...
    let mut volA: u32 = rsnd_mix_get_vol(mix, A);
    let mut volB: u32 = rsnd_mix_get_vol(mix, B);
    let mut volC: u32 = rsnd_mix_get_vol(mix, C);
    let mut volD: u32 = rsnd_mix_get_vol(mix, D);
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_mix_probe(priv: *mut rsnd_priv) -> c_int {
    ...
    clk, core::ptr::null_mut(), RSND_MOD_MIX, i);
    if (ret)
    goto rsnd_mix_probe_done;
    i++;
    }
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_mix_remove(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_mix_suspend(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_mix_resume(priv: *mut rsnd_priv) {
