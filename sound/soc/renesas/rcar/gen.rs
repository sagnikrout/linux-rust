...
//! Source: sound/soc/renesas/rcar/gen.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct rsnd_gen {
    pub ops: *mut rsnd_gen_ops,
// RSND_BASE_MAX base
    pub base: [*mut void __iomem; RSND_BASE_MAX],
    pub res: [phys_addr_t; RSND_BASE_MAX],
    pub regmap: [*mut regmap; RSND_BASE_MAX],
// RSND_REG_MAX base
    pub regs: [*mut regmap_field; REG_MAX],
    pub reg_name: [*const c_char; REG_MAX],
}
...
#[no_mangle]
unsafe extern "C" fn rsnd_mod_id_cmd(mod: *mut rsnd_mod) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_mod_read(mod: *mut rsnd_mod, reg: enum rsnd_reg) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_gen_get_phy_addr(priv: *mut rsnd_priv, reg_id: c_int) -> phys_addr_t {
...
//
#[no_mangle]
unsafe extern "C" fn rsnd_gen4_probe(priv: *mut rsnd_priv) -> c_int {
...
// ssi : SSI0
//
    let mut ret_ssiu: c_int = rsnd_gen_regmap_init(priv, 1, RSND_BASE_SSIU, "ssiu", conf_common_ssiu);
    let mut ret_ssi: c_int = rsnd_gen_regmap_init(priv, 1, RSND_BASE_SSI,  "ssi",  conf_common_ssi);
    let mut ret_adg: c_int = rsnd_gen_regmap_init(priv, 1, RSND_BASE_ADG,  "adg",  conf_common_adg);
    let mut ret_sdmc: c_int = rsnd_gen_regmap_init(priv, 1, RSND_BASE_SDMC, "sdmc", conf_null);
...
//
#[no_mangle]
unsafe extern "C" fn rsnd_gen2_probe(priv: *mut rsnd_priv) -> c_int {
...
// scu : SRC0  - SRC9 etc
//
    let mut ret_ssi: c_int = rsnd_gen_regmap_init(priv, 10, RSND_BASE_SSI,  "ssi",  conf_common_ssi);
    let mut ret_ssiu: c_int = rsnd_gen_regmap_init(priv, 10, RSND_BASE_SSIU, "ssiu", conf_common_ssiu);
    let mut ret_scu: c_int = rsnd_gen_regmap_init(priv, 10, RSND_BASE_SCU,  "scu",  conf_common_scu);
    let mut ret_adg: c_int = rsnd_gen_regmap_init(priv,  1, RSND_BASE_ADG,  "adg",  conf_common_adg);
...
//
#[no_mangle]
unsafe extern "C" fn rsnd_gen1_probe(priv: *mut rsnd_priv) -> c_int {
    static int rsnd_gen1_probe(struct rsnd_priv *priv)
    {
//
// ssi : SSI0 - SSI8
//
    let mut ret_ssi: c_int = rsnd_gen_regmap_init(priv, 9, RSND_BASE_SSI, "ssi", conf_common_ssi);
    let mut ret_adg: c_int = rsnd_gen_regmap_init(priv, 1, RSND_BASE_ADG, "adg", conf_common_adg);
...
//
#[no_mangle]
unsafe extern "C" fn rsnd_rzg3e_probe(priv: *mut rsnd_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rsnd_gen_probe(priv: *mut rsnd_priv) -> c_int {
