...
//! Source: sound/soc/renesas/rcar/src.c
#![no_std]
...
pub struct rsnd_src {
    ...
    pub /: *mut *mut rsnd_kctrl_cfg_s sen; / sync convert enable,
    pub /: *mut *mut rsnd_kctrl_cfg_s sync; / sync convert,
...
//
#[no_mangle]
unsafe extern "C" fn rsnd_src_activation(mod: *mut rsnd_mod) {
...
#[no_mangle]
unsafe extern "C" fn rsnd_src_halt(mod: *mut rsnd_mod) {
...
// 6 - 1/6 are very enough ratio for SRC_BSDSR
    ...
    ratio = 0;
#[no_mangle]
pub unsafe extern "C" fn if(fout: fin >) -> else {
    else if (fin > fout)
    ratio = 100 * fin / fout;
    else
    ratio = 100 * fout / fin;
...
#[no_mangle]
unsafe extern "C" fn rsnd_src_status_clear(mod: *mut rsnd_mod) {
    static void rsnd_src_status_clear(struct rsnd_mod *mod)
    {
    let mut val: u32 = OUF_SRC(rsnd_mod_id(mod));
    rsnd_mod_write(mod, SCU_SYS_STATUS0, val);
    rsnd_mod_write(mod, SCU_SYS_STATUS1, val);
    }
#[no_mangle]
unsafe extern "C" fn rsnd_src_error_occurred(mod: *mut rsnd_mod) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rsnd_src_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_src_probe(priv: *mut rsnd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_src_remove(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_src_suspend(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_src_resume(priv: *mut rsnd_priv) {
