...
//! Source: sound/soc/renesas/rcar/adg.c
#![no_std]
...
pub const CLKA: c_int = 0;
pub const CLKB: c_int = 1;
pub const CLKC: c_int = 2;
pub const CLKI: c_int = 3;
pub const CLKINMAX: c_int = 4;
pub const CLKOUT: c_int = 0;
pub const CLKOUT1: c_int = 1;
pub const CLKOUT2: c_int = 2;
pub const CLKOUT3: c_int = 3;
pub const CLKOUTMAX: c_int = 4;
// Maximum SSI count for per-SSI clocks
pub const ADG_SSI_MAX: c_int = 10;

    static struct rsnd_mod_ops adg_ops = {
    .name = "adg",
    };
pub const ADG_HZ_441: c_int = 0;
pub const ADG_HZ_48: c_int = 1;
pub const ADG_HZ_SIZE: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rsnd_adg {
    pub adg: *mut clk,
...
// RZ/G3E: per-SSI ADG clocks (adg-ssi-0 through adg-ssi-9)
    ...
    pub brga: u32,
    pub brgb: u32,
    pub /: *mut *mut int brg_rate[ADG_HZ_SIZE]; / BRGA / BRGB,
}
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_calculate_brgx(div: c_ulong) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_ssi_ws_timing_gen2(io: *mut rsnd_dai_stream) -> u32 {
    static u32 rsnd_adg_ssi_ws_timing_gen2(struct rsnd_dai_stream *io)
    {
    struct rsnd_mod *ssi_mod = rsnd_io_to_mod_ssi(io);
    let mut id: c_int = rsnd_mod_id(ssi_mod);
    let mut ws: c_int = id;
...
// en = _en;
    ...
    let mut id: c_int = rsnd_mod_id(cmd_mod);
    let mut shift: c_int = (id % 2) ? 16 : 0;
    u32 mask, val;
    rsnd_adg_get_timesel_ratio(priv, io,
    rsnd_src_get_in_rate(priv, io),
    rsnd_src_get_out_rate(priv, io),
    core::ptr::null_mut(), &val, core::ptr::null_mut());
    val  = val	<< shift;
    mask = 0x0f1f	<< shift;
    ...
    u32 in, out;
    u32 mask, en;
    let mut id: c_int = rsnd_mod_id(src_mod);
    let mut shift: c_int = (id % 2) ? 16 : 0;
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_set_ssi_clk(ssi_mod: *mut rsnd_mod, val: u32) {
    ...
    struct device *dev = rsnd_priv_to_dev(priv);
    let mut id: c_int = rsnd_mod_id(ssi_mod);
    let mut shift: c_int = (id % 4) * 8;
    let mut mask: u32 = 0xFF << shift;
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_clk_query(priv: *mut rsnd_priv, rate: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_ssi_clk_try_start(ssi_mod: *mut rsnd_mod, rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_ssi_clk_prepare(adg: *mut rsnd_adg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_ssi_clk_unprepare(adg: *mut rsnd_adg) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_clk_control(priv: *mut rsnd_priv, enable: c_int) -> c_int {
...
//
    if (enable) {
    let mut sub_ret: c_int = rsnd_adg_ssi_clk_prepare(adg);
...
// disable adg
    ...
    if (!adg.null_clk) {
    let mut name: *const static char  const = "rsnd_adg_null";
    adg.null_clk = rsnd_adg_create_null_clk(priv, name, core::ptr::null_mut());
    }
    return adg.null_clk;
    }
#[no_mangle]
unsafe extern "C" fn rsnd_adg_null_clk_clean(priv: *mut rsnd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_get_clkin(priv: *mut rsnd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_unregister_clkout(priv: *mut rsnd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_get_clkout(priv: *mut rsnd_priv) -> c_int {
...
//
    prop = of_find_property(np, "clock-frequency", core::ptr::null_mut());
    if (!prop)
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_clk_dbg_info(priv: *mut rsnd_priv, m: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn rsnd_adg_get_ssi_clks(priv: *mut rsnd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_probe(priv: *mut rsnd_priv) -> c_int {
    ...
    ret = rsnd_mod_init(priv, &adg.mod, &adg_ops, core::ptr::null_mut(), rstc, 0, 0);
    if (ret)
    return ret;
    priv.adg = adg;
...
// RZ/G3E-specific: per-SSI ADG and SSIF supply clocks
    ...
    if (ret)
    return ret;
    rsnd_adg_clk_dbg_info(priv, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_remove(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_suspend(priv: *mut rsnd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rsnd_adg_resume(priv: *mut rsnd_priv) {
