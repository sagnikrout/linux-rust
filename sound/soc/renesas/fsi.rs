...
//! Source: sound/soc/renesas/fsi.c
#![no_std]
...
pub const REG_DO_FMT: c_uint = 0x0000;
pub const REG_DOFF_CTL: c_uint = 0x0004;
pub const REG_DOFF_ST: c_uint = 0x0008;
pub const REG_DI_FMT: c_uint = 0x000C;
pub const REG_DIFF_CTL: c_uint = 0x0010;
pub const REG_DIFF_ST: c_uint = 0x0014;
pub const REG_CKG1: c_uint = 0x0018;
pub const REG_CKG2: c_uint = 0x001C;
pub const REG_DIDT: c_uint = 0x0020;
pub const REG_DODT: c_uint = 0x0024;
pub const REG_MUTE_ST: c_uint = 0x0028;
pub const REG_OUT_DMAC: c_uint = 0x002C;
pub const REG_OUT_SEL: c_uint = 0x0030;
pub const REG_IN_DMAC: c_uint = 0x0038;
// master register
pub const MST_CLK_RST: c_uint = 0x0210;
pub const MST_SOFT_RST: c_uint = 0x0214;
pub const MST_FIFO_SZ: c_uint = 0x0218;
// core register (depend on FSI version)
pub const A_MST_CTLR: c_uint = 0x0180;
pub const B_MST_CTLR: c_uint = 0x01A0;
pub const CPU_INT_ST: c_uint = 0x01F4;
pub const CPU_IEMSK: c_uint = 0x01F8;
pub const CPU_IMSK: c_uint = 0x01FC;
pub const INT_ST: c_uint = 0x0200;
pub const IEMSK: c_uint = 0x0204;
pub const IMSK: c_uint = 0x0208;
// DO_FMT
// DI_FMT
...
// DOFF_CTL
// DIFF_CTL
pub const IRQ_HALF: c_uint = 0x00100000;
pub const FIFO_CLR: c_uint = 0x00000001;
// DOFF_ST
pub const ERR_OVER: c_uint = 0x00000010;
pub const ERR_UNDER: c_uint = 0x00000001;

// CKG1
pub const ACKMD_MASK: c_uint = 0x00007000;
pub const BPFMD_MASK: c_uint = 0x00000700;
...
// IO SHIFT / MACRO
pub const BI_SHIFT: c_int = 12;
pub const BO_SHIFT: c_int = 8;
pub const AI_SHIFT: c_int = 4;
pub const AO_SHIFT: c_int = 0;
...
// FIFO_SZ
pub const FIFO_SZ_MASK: c_uint = 0x7;
...
//
pub const SHIFT_16DATA: c_int = 0;
pub const SHIFT_24DATA: c_int = 4;
pub const PACKAGE_24BITBUS_BACK: c_int = 0;
pub const PACKAGE_24BITBUS_FRONT: c_int = 1;
pub const PACKAGE_16BITBUS_STREAM: c_int = 2;
...
//
    ...
    pub /: *mut *mut int fifo_sample_capa; / sample capacity of FSI FIFO,
    pub /: *mut *mut int buff_sample_capa; / sample capacity of ALSA buffer,
    pub /: *mut *mut int buff_sample_pos; / sample position of ALSA buffer,
    pub /: *mut *mut int period_samples; / sample number / 1 period,
    pub /: *mut *mut int period_pos; / current period position,
    pub /: *mut *mut int sample_width; / sample width,
    pub uerr_num: c_int,
    pub oerr_num: c_int,
//
// bus options
...
pub struct fsi_priv {
    ...
    pub clock: fsi_clk,
    pub fmt: u32,
    pub chan_num:16: c_int,
    pub clk_master:1: c_uint,
    pub clk_cpg:1: c_uint,
    pub spdif:1: c_uint,
    pub enable_stream:1: c_uint,
    pub bit_clk_inv:1: c_uint,
    pub lr_clk_inv:1: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsi_stream_handler {
    pub io): *mut *mut *mut int (init)(struct fsi_priv fsi, struct fsi_stream,
    pub io): *mut *mut *mut int (quit)(struct fsi_priv fsi, struct fsi_stream,
    pub dev): *mut *mut *mut *mut int (probe)(struct fsi_priv fsi, struct fsi_stream io, struct device,
    pub io): *mut *mut *mut int (transfer)(struct fsi_priv fsi, struct fsi_stream,
    pub io): *mut *mut *mut int (remove)(struct fsi_priv fsi, struct fsi_stream,
...
//
#[no_mangle]
unsafe extern "C" fn __fsi_reg_write(reg: *mut u32 __iomem, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn __fsi_reg_read(reg: *mut u32 __iomem) -> u32 {
    static u32 __fsi_reg_read(u32 __iomem *reg)
    {
    return __raw_readl(reg);
    }
#[no_mangle]
unsafe extern "C" fn __fsi_reg_mask_set(reg: *mut u32 __iomem, mask: u32, data: u32) {
    static void __fsi_reg_mask_set(u32 __iomem *reg, u32 mask, u32 data)
    {
    let mut val: u32 = __fsi_reg_read(reg);
    val &= ~mask;
    val |= data & mask;
...
#[no_mangle]
unsafe extern "C" fn _fsi_master_read(master: *mut fsi_master, reg: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn fsi_version(master: *mut fsi_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_is_clk_master(fsi: *mut fsi_priv) -> c_int {
    static int fsi_is_clk_master(struct fsi_priv *fsi)
    {
    return fsi.clk_master;
    }
#[no_mangle]
unsafe extern "C" fn fsi_is_port_a(fsi: *mut fsi_priv) -> c_int {
    static int fsi_is_port_a(struct fsi_priv *fsi)
    {
    return fsi.master.base == fsi.base;
    }
#[no_mangle]
unsafe extern "C" fn fsi_is_spdif(fsi: *mut fsi_priv) -> c_int {
    static int fsi_is_spdif(struct fsi_priv *fsi)
    {
    return fsi.spdif;
    }
#[no_mangle]
unsafe extern "C" fn fsi_is_enable_stream(fsi: *mut fsi_priv) -> c_int {
    static int fsi_is_enable_stream(struct fsi_priv *fsi)
    {
    return fsi.enable_stream;
    }
#[no_mangle]
unsafe extern "C" fn fsi_is_play(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_get_port_shift(fsi: *mut fsi_priv, io: *mut fsi_stream) -> u32 {
    static u32 fsi_get_port_shift(struct fsi_priv *fsi, struct fsi_stream *io)
    {
    let mut is_play: c_int = fsi_stream_is_play(fsi, io);
    let mut is_porta: c_int = fsi_is_port_a(fsi);
    u32 shift;
    if (is_porta)
...
#[no_mangle]
unsafe extern "C" fn fsi_frame2sample(fsi: *mut fsi_priv, frames: c_int) -> c_int {
    static int fsi_frame2sample(struct fsi_priv *fsi, int frames)
    {
    return frames * fsi.chan_num;
    }
#[no_mangle]
unsafe extern "C" fn fsi_sample2frame(fsi: *mut fsi_priv, samples: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_count_fifo_err(fsi: *mut fsi_priv) {
    static void fsi_count_fifo_err(struct fsi_priv *fsi)
    {
    if (!fsi_stream_is_working(fsi, &fsi.playback) &&
    !fsi_stream_is_working(fsi, &fsi.capture))
    return;
    let mut ostatus: u32 = fsi_reg_read(fsi, DOFF_ST);
    let mut istatus: u32 = fsi_reg_read(fsi, DIFF_ST);
    if (ostatus & ERR_OVER)
...
#[no_mangle]
unsafe extern "C" fn fsi_stream_quit(fsi: *mut fsi_priv, io: *mut fsi_stream) {
    ...
    io.substream	= core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fsi_stream_transfer(io: *mut fsi_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_stream_probe(fsi: *mut fsi_priv, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_stream_remove(fsi: *mut fsi_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsi_irq_enable(fsi: *mut fsi_priv, io: *mut fsi_stream) {
    static void fsi_irq_enable(struct fsi_priv *fsi, struct fsi_stream *io)
    {
    let mut data: u32 = AB_IO(1, fsi_get_port_shift(fsi, io));
    struct fsi_master *master = fsi_get_master(fsi);
    fsi_core_mask_set(master, imsk,  data, data);
    fsi_core_mask_set(master, iemsk, data, data);
    }
#[no_mangle]
unsafe extern "C" fn fsi_irq_disable(fsi: *mut fsi_priv, io: *mut fsi_stream) {
...
#[no_mangle]
unsafe extern "C" fn fsi_irq_get_status(master: *mut fsi_master) -> u32 {
    static u32 fsi_irq_get_status(struct fsi_master *master)
    {
    return fsi_core_read(master, int_st);
    }
#[no_mangle]
unsafe extern "C" fn fsi_irq_clear_status(fsi: *mut fsi_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn fsi_spdif_clk_ctrl(fsi: *mut fsi_priv, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fsi_clk_valid(fsi: *mut fsi_priv, rate: c_ulong) {
    static void fsi_clk_valid(struct fsi_priv *fsi, unsigned long rate)
    {
    fsi.clock.rate = rate;
    }
#[no_mangle]
unsafe extern "C" fn fsi_clk_is_valid(fsi: *mut fsi_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_clk_prepare(fsi: *mut fsi_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_clk_unprepare(fsi: *mut fsi_priv) {
...
// BPFMD
    ...
    let mut rate: c_ulong = fsi.clock.rate;
    unsigned long xrate;
    int ackmd, bpfmd;
    let mut ret: c_int = 0;
    if (!xck || !ick) {
...
#[no_mangle]
unsafe extern "C" fn fsi_clk_init(dev: *mut device, fsi: *mut fsi_priv) -> c_int {
    ...
    clock.xck	= core::ptr::null_mut();
    clock.ick	= core::ptr::null_mut();
    clock.div	= core::ptr::null_mut();
    clock.rate	= 0;
    clock.count	= 0;
    clock.own = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(clock.own))
...
#[no_mangle]
unsafe extern "C" fn fsi_pointer_update(io: *mut fsi_stream, size: c_int) {
...
unsafe extern "C" fn fsi_pio_push(fsi: *mut fsi_priv, io: *mut fsi_stream) -> c_int {
    ...
    {
    struct fsi_master *master = fsi_get_master(fsi);
    let mut clk: u32 = fsi_is_port_a(fsi) ? CRA  : CRB;
    if (enable)
...
#[no_mangle]
unsafe extern "C" fn fsi_pio_pop_init(fsi: *mut fsi_priv, io: *mut fsi_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t fsi_interrupt(int irq, void *data)
    {
    struct fsi_master *master = data;
    let mut int_st: u32 = fsi_irq_get_status(master);
// clear irq status
...
//
#[no_mangle]
unsafe extern "C" fn fsi_dma_init(fsi: *mut fsi_priv, io: *mut fsi_stream) -> c_int {
...
//
    ...
    struct fsi_master *master = fsi_get_master(fsi);
    let mut clk: u32 = fsi_is_port_a(fsi) ? CRA  : CRB;
    let mut enable: u32 = start ? DMA_ON : 0;
...
#[no_mangle]
unsafe extern "C" fn fsi_set_fmt_dai(fsi: *mut fsi_priv, fmt: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_set_fmt_spdif(fsi: *mut fsi_priv) -> c_int {
