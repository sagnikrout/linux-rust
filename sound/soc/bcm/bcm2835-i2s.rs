...
//! Source: sound/soc/bcm/bcm2835-i2s.c
#![no_std]
...
// I2S registers
pub const BCM2835_I2S_CS_A_REG: c_uint = 0x00;
pub const BCM2835_I2S_FIFO_A_REG: c_uint = 0x04;
pub const BCM2835_I2S_MODE_A_REG: c_uint = 0x08;
pub const BCM2835_I2S_RXC_A_REG: c_uint = 0x0c;
pub const BCM2835_I2S_TXC_A_REG: c_uint = 0x10;
pub const BCM2835_I2S_DREQ_A_REG: c_uint = 0x14;
pub const BCM2835_I2S_INTEN_A_REG: c_uint = 0x18;
pub const BCM2835_I2S_INTSTC_A_REG: c_uint = 0x1c;
pub const BCM2835_I2S_GRAY_REG: c_uint = 0x20;
// I2S register settings

// Frame length register is 10 bit, maximum length 1024
pub const BCM2835_I2S_MAX_FRAME_LENGTH: c_int = 1024;
...
unsafe extern "C" fn bcm2835_i2s_start_clock(dev: *mut bcm2835_i2s_dev) {
    ...
    {
    let mut provider: c_uint = dev.fmt & SND_SOC_DAIFMT_CLOCK_PROVIDER_MASK;
    if (dev.clk_prepared)
    return;
    switch (provider) {
...
// width + bit_offset;
    ...
    let mut bit_clock_provider: bool = false;
    let mut frame_sync_provider: bool = false;
    let mut frame_start_falling_edge: bool = false;
    uint32_t csreg;
    let mut ret: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn bcm2835_i2s_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_i2s_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
// Set the DMA address - we have to parse DT ourselves
    addr = of_get_address(pdev.dev.of_node, 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (!addr) {
