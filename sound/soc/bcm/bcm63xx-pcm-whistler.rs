...
//! Source: sound/soc/bcm/bcm63xx-pcm-whistler.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm63xx_runtime_data {
    pub dma_len: c_int,
    pub dma_addr: dma_addr_t,
    pub dma_addr_next: dma_addr_t,
}
    ...
    prtd.dma_addr_next - substream.runtime.dma_addr);
    let mut x: return = = substream.runtime.buffer_size ? 0 : x;
    }
...
#[no_mangle]
unsafe extern "C" fn i2s_dma_isr(irq: c_int, bcm_i2s_priv: *mut c_void) -> irqreturn_t {
...
// Clear interrupt by writing 0
    ...
    &bcm63xx_soc_platform, core::ptr::null_mut(), 0);
    }
#[no_mangle]
pub unsafe extern "C" fn bcm63xx_soc_platform_remove(pdev: *mut platform_device) -> c_int {
