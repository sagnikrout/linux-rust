...
//! Source: sound/soc/au1x/psc-i2s.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn au1xpsc_i2s_configure(pscdata: *mut au1xpsc_audio_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xpsc_i2s_start(pscdata: *mut au1xpsc_audio_data, stype: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xpsc_i2s_stop(pscdata: *mut au1xpsc_audio_data, stype: c_int) -> c_int {
