...
//! Source: sound/soc/tegra/tegra_audio_graph_card.c
#![no_std]
...
pub const MAX_PLLA_OUT0_DIV: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_audio_priv {
    pub simple: simple_util_priv,
    pub clk_plla_out0: *mut clk,
    pub clk_plla: *mut clk,
}

// Tegra audio chip data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_audio_cdata {
    pub plla_rates: [c_uint; NUM_RATE_TYPE],
    pub plla_out0_rates: [c_uint; NUM_RATE_TYPE],
}

#[no_mangle]
unsafe extern "C" fn need_clk_update(dai: *mut snd_soc_dai) -> bool {
...
// Setup PLL clock as per the given sample rate
    ...
    let mut srate: c_uint = params_rate(params);
    int err;
    switch (srate) {
    case 11025:
    case 22050:
