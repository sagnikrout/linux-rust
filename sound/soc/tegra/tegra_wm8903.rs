...
//! Source: sound/soc/tegra/tegra_wm8903.c
#![no_std]
...
//
    ...
    let mut active_low: bool = gpiod_is_active_low(machine.gpiod_hp_det);
...
unsafe extern "C" fn tegra_wm8903_remove(card: *mut snd_soc_card) -> c_int {
    ...
    struct snd_soc_dai *codec_dai = snd_soc_rtd_to_codec(rtd, 0);
    struct snd_soc_component *component = codec_dai.component;
    wm8903_mic_detect(component, core::ptr::null_mut(), 0, 0);
    return 0;
    }
    SND_SOC_DAILINK_DEFS(hifi,
    DAILINK_COMP_ARRAY(COMP_EMPTY()),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "wm8903-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
