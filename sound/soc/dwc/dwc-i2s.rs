...
//! Source: sound/soc/dwc/dwc-i2s.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn i2s_write_reg(io_base: *mut void __iomem, reg: c_int, val: u32) {
    static inline void i2s_write_reg(void __iomem *io_base, int reg, u32 val)
    {
    writel(val, io_base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn i2s_read_reg(io_base: *mut void __iomem, reg: c_int) -> u32 {
    static inline u32 i2s_read_reg(void __iomem *io_base, int reg)
    {
    return readl(io_base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn i2s_disable_channels(dev: *mut dw_i2s_dev, stream: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn i2s_clear_irqs(dev: *mut dw_i2s_dev, stream: u32) {
...
#[no_mangle]
unsafe extern "C" fn i2s_enable_dma(dev: *mut dw_i2s_dev, stream: u32) {
...
#[no_mangle]
unsafe extern "C" fn i2s_disable_dma(dev: *mut dw_i2s_dev, stream: u32) {
...
#[no_mangle]
unsafe extern "C" fn dw_i2s_config(dev: *mut dw_i2s_dev, stream: c_int) {
...
//
    ...
    let mut comp2: u32 = i2s_read_reg(dev.i2s_base, dev.i2s_reg_comp2);
    let mut fifo_depth: u32 = 1 << (1 + COMP1_FIFO_DEPTH_GLOBAL(comp1));
    u32 idx;
...
// Use platform data and snd_dmaengine_dai_dma_data struct at the same time
    let mut comp2: u32 = i2s_read_reg(dev.i2s_base, I2S_COMP_PARAM_2);
    u32 idx2;
    if (COMP1_TX_ENABLED(comp1)) {
...
// Set DMA slaves info
    ...
    struct resource *res)
    {
    let mut comp1: u32 = i2s_read_reg(dev.i2s_base, I2S_COMP_PARAM_1);
    let mut comp2: u32 = i2s_read_reg(dev.i2s_base, I2S_COMP_PARAM_2);
    let mut fifo_depth: u32 = 1 << (1 + COMP1_FIFO_DEPTH_GLOBAL(comp1));
    u32 idx2;
    int ret;
...
unsafe extern "C" fn jh7110_i2stx0_clk_cfg(config: *mut i2s_clk_config_data) -> c_int {
    ...
    let mut bclk_rate: u32 = config.sample_rate * 64;
...
unsafe extern "C" fn dw_i2s_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = devm_snd_dmaengine_pcm_register(&pdev.dev, core::ptr::null_mut(),
    0);
    dev.use_pio = false;
    }
    if (ret) {
...
unsafe extern "C" fn dw_i2s_remove(pdev: *mut platform_device) {
    ...
    RUNTIME_PM_OPS(dw_i2s_runtime_suspend, dw_i2s_runtime_resume, core::ptr::null_mut())
    };
