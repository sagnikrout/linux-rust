...
//! Source: sound/soc/img/img-i2s-out.c
#![no_std]
...
pub const IMG_I2S_OUT_TX_FIFO: c_uint = 0x0;
pub const IMG_I2S_OUT_CTL: c_uint = 0x4;

pub const IMG_I2S_OUT_CTL_ACTIVE_CHAN_MASK: c_uint = 0xffe000;
pub const IMG_I2S_OUT_CTL_ACTIVE_CHAN_SHIFT: c_int = 13;

pub const IMG_I2S_OUT_CH_CTL: c_uint = 0x4;

pub const IMG_I2S_OUT_CHAN_CTL_FMT_MASK: c_uint = 0xf0;
pub const IMG_I2S_OUT_CHAN_CTL_FMT_SHIFT: c_int = 4;

pub const IMG_I2S_OUT_CH_STRIDE: c_uint = 0x20;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
pub unsafe extern "C" fn img_i2s_out_readl(i2s: *mut img_i2s_out, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn img_i2s_out_ch_disable(i2s: *mut img_i2s_out, chan: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn img_i2s_out_ch_enable(i2s: *mut img_i2s_out, chan: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn img_i2s_out_disable(i2s: *mut img_i2s_out) {
...
#[no_mangle]
pub unsafe extern "C" fn img_i2s_out_enable(i2s: *mut img_i2s_out) {
...
#[no_mangle]
unsafe extern "C" fn img_i2s_out_reset(i2s: *mut img_i2s_out) {
...
unsafe extern "C" fn img_i2s_out_dai_probe(dai: *mut snd_soc_dai) -> c_int {
    ...
    {
    struct img_i2s_out *i2s = snd_soc_dai_get_drvdata(dai);
    snd_soc_dai_init_dma_data(dai, &i2s.dma_data, core::ptr::null_mut());
    return 0;
    }
...
unsafe extern "C" fn img_i2s_out_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(img_i2s_out_runtime_suspend, img_i2s_out_runtime_resume, core::ptr::null_mut())
