...
//! Source: sound/soc/img/img-spdif-in.c
#![no_std]
...
pub const IMG_SPDIF_IN_RX_FIFO_OFFSET: c_int = 0;
pub const IMG_SPDIF_IN_CTL: c_uint = 0x4;
pub const IMG_SPDIF_IN_CTL_LOCKLO_MASK: c_uint = 0xff;
pub const IMG_SPDIF_IN_CTL_LOCKLO_SHIFT: c_int = 0;
pub const IMG_SPDIF_IN_CTL_LOCKHI_MASK: c_uint = 0xff00;
pub const IMG_SPDIF_IN_CTL_LOCKHI_SHIFT: c_int = 8;
pub const IMG_SPDIF_IN_CTL_TRK_MASK: c_uint = 0xff0000;
pub const IMG_SPDIF_IN_CTL_TRK_SHIFT: c_int = 16;
pub const IMG_SPDIF_IN_CTL_SRD_MASK: c_uint = 0x70000000;
pub const IMG_SPDIF_IN_CTL_SRD_SHIFT: c_int = 28;

pub const IMG_SPDIF_IN_STATUS: c_uint = 0x8;
pub const IMG_SPDIF_IN_STATUS_SAM_MASK: c_uint = 0x7000;
pub const IMG_SPDIF_IN_STATUS_SAM_SHIFT: c_int = 12;

pub const IMG_SPDIF_IN_STATUS_LOCK_SHIFT: c_int = 15;
pub const IMG_SPDIF_IN_CLKGEN: c_uint = 0x1c;
pub const IMG_SPDIF_IN_CLKGEN_NOM_MASK: c_uint = 0x3ff;
pub const IMG_SPDIF_IN_CLKGEN_NOM_SHIFT: c_int = 0;
pub const IMG_SPDIF_IN_CLKGEN_HLD_MASK: c_uint = 0x3ff0000;
pub const IMG_SPDIF_IN_CLKGEN_HLD_SHIFT: c_int = 16;
pub const IMG_SPDIF_IN_CSL: c_uint = 0x20;
pub const IMG_SPDIF_IN_CSH: c_uint = 0x24;
pub const IMG_SPDIF_IN_CSH_MASK: c_uint = 0xff;
pub const IMG_SPDIF_IN_CSH_SHIFT: c_int = 0;
pub const IMG_SPDIF_IN_SOFT_RESET: c_uint = 0x28;

pub const IMG_SPDIF_IN_ACLKGEN_START: c_uint = 0x2c;
pub const IMG_SPDIF_IN_ACLKGEN_NOM_MASK: c_uint = 0x3ff;
pub const IMG_SPDIF_IN_ACLKGEN_NOM_SHIFT: c_int = 0;
pub const IMG_SPDIF_IN_ACLKGEN_HLD_MASK: c_uint = 0xffc00;
pub const IMG_SPDIF_IN_ACLKGEN_HLD_SHIFT: c_int = 10;
pub const IMG_SPDIF_IN_ACLKGEN_TRK_MASK: c_uint = 0xff00000;
pub const IMG_SPDIF_IN_ACLKGEN_TRK_SHIFT: c_int = 20;
pub const IMG_SPDIF_IN_NUM_ACLKGEN: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct img_spdif_in {
    pub lock: spinlock_t,
    ...
    pub trk: c_uint,
    pub multi_freq: bool,
    pub lock_acquire: c_int,
    pub lock_release: c_int,
    pub single_freq: c_uint,
    pub multi_freqs: [c_uint; IMG_SPDIF_IN_NUM_ACLKGEN],
    pub active: bool,
    pub suspend_clkgen: u32,
    pub suspend_ctl: u32,
// Write-only registers
    pub aclkgen_regs: [c_uint; IMG_SPDIF_IN_NUM_ACLKGEN],
}

#[no_mangle]
unsafe extern "C" fn img_spdif_in_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn img_spdif_in_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn img_spdif_in_readl(spdif: *mut img_spdif_in, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn img_spdif_in_dai_probe(dai: *mut snd_soc_dai) -> c_int {
    static int img_spdif_in_dai_probe(struct snd_soc_dai *dai)
    {
    struct img_spdif_in *spdif = snd_soc_dai_get_drvdata(dai);
    snd_soc_dai_init_dma_data(dai, core::ptr::null_mut(), &spdif.dma_data);
...
#[no_mangle]
unsafe extern "C" fn img_spdif_in_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn img_spdif_in_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn img_spdif_in_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(img_spdif_in_runtime_suspend, img_spdif_in_runtime_resume, core::ptr::null_mut())
