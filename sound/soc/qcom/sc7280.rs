...
//! Source: sound/soc/qcom/sc7280.c
#![no_std]
...
unsafe extern "C" fn sc7280_headset_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    rval = snd_soc_component_set_jack(component, &pdata.hs_jack, core::ptr::null_mut());
...
unsafe extern "C" fn sc7280_snd_startup(substream: *mut snd_pcm_substream) -> c_int {
    ...
    {
    let mut fmt: c_uint = SND_SOC_DAIFMT_CBC_CFC;
