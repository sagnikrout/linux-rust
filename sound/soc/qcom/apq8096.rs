...
//! Source: sound/soc/qcom/apq8096.c
#![no_std]
...
pub const SLIM_MAX_RX_PORTS: c_int = 16;
pub const WCD9335_DEFAULT_MCLK_RATE: c_int = 9600000;
...
#[no_mangle]
pub unsafe extern "C" fn if(-ENOTSUPP: ret ==) -> else {
    else if (ret == -ENOTSUPP)
    ret = 0;
    end:
    return ret;
...
#[no_mangle]
unsafe extern "C" fn apq8096_add_be_ops(card: *mut snd_soc_card) {
