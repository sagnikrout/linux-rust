...
//! Source: sound/soc/qcom/lpass-cdc-dma.c
#![no_std]
...
pub const CODEC_MEM_HZ_NORMAL: c_int = 153600000;
...
#[no_mangle]
unsafe extern "C" fn __lpass_get_codec_dma_intf_type(dai_id: c_int) -> c_int {
