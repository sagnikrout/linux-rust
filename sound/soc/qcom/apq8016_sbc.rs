...
//! Source: sound/soc/qcom/apq8016_sbc.c
#![no_std]
...
pub struct apq8016_sbc_data {
    ...
    pub mic_iomux: *mut void __iomem,
    pub spkr_iomux: *mut void __iomem,
    pub jack: snd_soc_jack,
    pub jack_setup: bool,
    pub mi2s_clk_count: [c_int; MI2S_COUNT],
}

pub const DEFAULT_MCLK_RATE: c_int = 9600000;
...
// Set default mclk for internal codec
    ...
    rval = snd_soc_component_set_jack(component, &pdata.jack, core::ptr::null_mut());
    if (rval != 0 && rval != -ENOTSUPP) {
...
// Make it obvious to userspace that QDSP6 is used
    ...
    SND_SOC_DAPM_MIC("Handset Mic", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("Headset Mic", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("Secondary Mic", core::ptr::null_mut()),
