...
//! Source: sound/soc/qcom/lpass-cpu.c
#![no_std]
...
pub const LPASS_CPU_MAX_MI2S_LINES: c_int = 4;

pub const LPASS_REG_READ: c_int = 1;
pub const LPASS_REG_WRITE: c_int = 0;
//
...
//
    ...
    let mut id: c_uint = dai.driver.id;
    clk_disable_unprepare(drvdata.mi2s_osr_clk[dai.driver.id]);
//
...
#[no_mangle]
unsafe extern "C" fn lpass_cpu_daiops_pcm_new(rtd: *mut snd_soc_pcm_runtime, dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_cpu_daiops_probe(dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_cpu_regmap_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpass_cpu_regmap_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpass_cpu_regmap_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpass_hdmi_init_bitfields(dev: *mut device, map: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_hdmi_regmap_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpass_hdmi_regmap_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpass_hdmi_regmap_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __lpass_rxtx_regmap_accessible(dev: *mut device, reg: c_uint, rw: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpass_rxtx_regmap_writeable(dev: *mut device, reg: c_uint) -> bool {
    static bool lpass_rxtx_regmap_writeable(struct device *dev, unsigned int reg)
    {
    return __lpass_rxtx_regmap_accessible(dev, reg, LPASS_REG_WRITE);
    }
#[no_mangle]
unsafe extern "C" fn lpass_rxtx_regmap_readable(dev: *mut device, reg: c_uint) -> bool {
    static bool lpass_rxtx_regmap_readable(struct device *dev, unsigned int reg)
    {
    return __lpass_rxtx_regmap_accessible(dev, reg, LPASS_REG_READ);
    }
#[no_mangle]
unsafe extern "C" fn lpass_rxtx_regmap_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __lpass_va_regmap_accessible(dev: *mut device, reg: c_uint, rw: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpass_va_regmap_writeable(dev: *mut device, reg: c_uint) -> bool {
    static bool lpass_va_regmap_writeable(struct device *dev, unsigned int reg)
    {
    return __lpass_va_regmap_accessible(dev, reg, LPASS_REG_WRITE);
    }
#[no_mangle]
unsafe extern "C" fn lpass_va_regmap_readable(dev: *mut device, reg: c_uint) -> bool {
    static bool lpass_va_regmap_readable(struct device *dev, unsigned int reg)
    {
    return __lpass_va_regmap_accessible(dev, reg, LPASS_REG_READ);
    }
#[no_mangle]
unsafe extern "C" fn lpass_va_regmap_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn asoc_qcom_lpass_cpu_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn asoc_qcom_lpass_cpu_platform_remove(pdev: *mut platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn asoc_qcom_lpass_cpu_platform_shutdown(pdev: *mut platform_device) {
