...
//! Source: sound/soc/qcom/qdsp6/q6usb.c
#![no_std]
...
pub const Q6_USB_SID_MASK: c_uint = 0xF;
#[repr(C)]
#[derive(Copy, Clone)]
...
// Protects against operations between SOC USB and ASoC
    ...
    SND_SOC_DAPM_HP("USB_RX_BE", core::ptr::null_mut()),
    };
    static const struct snd_soc_dapm_route q6usb_dapm_routes[] = {
    {"USB Playback", core::ptr::null_mut(), "USB_RX_BE"},
    };
...
#[no_mangle]
unsafe extern "C" fn q6usb_get_pcm_id_from_widget(w: *mut snd_soc_dapm_widget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn q6usb_usb_mixer_enabled(w: *mut snd_soc_dapm_widget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn q6usb_get_pcm_id(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn q6usb_component_disable_jack(data: *mut q6usb_port_data) {
...
// Offload jack has already been disabled
    ...
    return;
    snd_jack_report(data.hs_jack.jack, 0);
    data.hs_jack = core::ptr::null_mut();
    }
