...
//! Source: sound/soc/qcom/sc7180.c
#![no_std]
...
pub const DEFAULT_MCLK_RATE: c_int = 19200000;
...
#[no_mangle]
unsafe extern "C" fn sc7180_headset_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    return snd_soc_component_set_jack(component, &pdata.hs_jack, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn sc7180_hdmi_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    jack.private_data = component;
    jack.private_free = sc7180_jack_free;
    return snd_soc_component_set_jack(component, &pdata.hdmi_jack, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn sc7180_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_qdsp_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_startup_realtek_codec(rtd: *mut snd_soc_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_snd_startup(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_qdsp_snd_startup(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_adau7002_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_adau7002_snd_startup(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_snd_platform_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    int i;
    let mut qdsp: bool = false, no_headphone = false;
