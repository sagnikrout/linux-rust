...
//! Source: sound/soc/qcom/lpass-ipq806x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipq806x_lpass_alloc_dma_channel(drvdata: *mut lpass_data, dir: c_int, dai_id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq806x_lpass_free_dma_channel(drvdata: *mut lpass_data, chan: c_int, dai_id: c_uint) -> c_int {
