...
//! Source: sound/soc/stm/stm32_sai_sub.c
#![no_std]
...
pub const SAI_FREE_PROTOCOL: c_uint = 0x0;
pub const SAI_SPDIF_PROTOCOL: c_uint = 0x1;
pub const SAI_SLOT_SIZE_AUTO: c_uint = 0x0;
pub const SAI_SLOT_SIZE_16: c_uint = 0x1;
pub const SAI_SLOT_SIZE_32: c_uint = 0x2;
pub const SAI_DATASIZE_8: c_uint = 0x2;
pub const SAI_DATASIZE_10: c_uint = 0x3;
pub const SAI_DATASIZE_16: c_uint = 0x4;
pub const SAI_DATASIZE_20: c_uint = 0x5;
pub const SAI_DATASIZE_24: c_uint = 0x6;
pub const SAI_DATASIZE_32: c_uint = 0x7;
pub const STM_SAI_DAI_NAME_SIZE: c_int = 15;

pub const STM_SAI_A_ID: c_uint = 0x0;
pub const STM_SAI_B_ID: c_uint = 0x1;

pub const SAI_SYNC_NONE: c_uint = 0x0;
pub const SAI_SYNC_INTERNAL: c_uint = 0x1;
pub const SAI_SYNC_EXTERNAL: c_uint = 0x2;

pub const SAI_IEC60958_BLOCK_FRAMES: c_int = 192;
pub const SAI_IEC60958_STATUS_BYTES: c_int = 24;
pub const SAI_MCLK_NAME_LEN: c_int = 32;
pub const SAI_RATE_11K: c_int = 11025;
pub const SAI_MAX_SAMPLE_RATE_8K: c_int = 192000;
pub const SAI_MAX_SAMPLE_RATE_11K: c_int = 176400;
...
pub struct stm32_sai_sub_data {
    ...
    pub /: *mut *mut mutex ctrl_lock; / protect resources accessed by controls,
    pub /: *mut *mut spinlock_t irq_lock; / used to prevent race condition with IRQ,
    pub rate): *mut *mut *mut int (set_sai_ck_rate)(struct stm32_sai_sub_data sai, unsigned int,
    pub sai): *mut *mut void (put_sai_ck_rate)(struct stm32_sai_sub_data,
}
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_sub_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_sub_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_sub_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
pub const STM32_SAI_MAX_CLKS: c_int = 1;
    static int stm32_sai_get_clk_div(struct stm32_sai_sub_data *sai,
    unsigned long input_rate,
    unsigned long output_rate)
    {
    let mut version: c_int = sai.pdata.conf.version;
    int div;
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_rate_accurate(max_rate: c_uint, rate: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_add_mclk_provider(sai: *mut stm32_sai_sub_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_isr(irq: c_int, devid: *mut c_void) -> irqreturn_t {
    static irqreturn_t stm32_sai_isr(int irq, void *devid)
    {
    struct stm32_sai_sub_data *sai = (struct stm32_sai_sub_data *)devid;
    struct platform_device *pdev = sai.pdev;
    unsigned int sr, imr, flags;
    let mut status: snd_pcm_state_t = SNDRV_PCM_STATE_RUNNING;
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_set_slots(cpu_dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_set_frame(cpu_dai: *mut snd_soc_dai) {
...
#[no_mangle]
unsafe extern "C" fn stm32_sai_init_iec958_status(sai: *mut stm32_sai_sub_data) {
...
//
    ...
    sai.put_sai_ck_rate(sai);
    scoped_guard(spinlock_irqsave, &sai.irq_lock)
    sai.substream = core::ptr::null_mut();
    }
    static int stm32_sai_pcm_new(struct snd_soc_pcm_runtime *rtd,
    struct snd_soc_dai *cpu_dai)
    {
    struct stm32_sai_sub_data *sai = dev_get_drvdata(cpu_dai.dev);
    let mut knew: snd_kcontrol_new = iec958_ctls;
    if (STM_SAI_PROTOCOL_IS_SPDIF(sai)) {
...
unsafe extern "C" fn stm32_sai_dai_probe(cpu_dai: *mut snd_soc_dai) -> c_int {
    ...
    {
    struct stm32_sai_sub_data *sai = dev_get_drvdata(cpu_dai.dev);
    let mut cr1: c_int = 0, cr1_mask, ret;
    sai.cpu_dai = cpu_dai;
...
// Buswidth will be set by framework at runtime
    ...
    if (STM_SAI_IS_PLAYBACK(sai))
    snd_soc_dai_init_dma_data(cpu_dai, &sai.dma_params, core::ptr::null_mut());
    else
    snd_soc_dai_init_dma_data(cpu_dai, core::ptr::null_mut(), &sai.dma_params);
...
// Configure synchro client and provider
    ...
    let mut cnt: isize = bytes_to_samples(runtime, bytes);
    let mut frm_cnt: c_uint = sai.spdif_frm_cnt;
    unsigned int byte;
    unsigned int mask;
    do {
