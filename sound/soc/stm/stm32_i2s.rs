...
//! Source: sound/soc/stm/stm32_i2s.c
#![no_std]
...
pub const STM32_I2S_CR1_REG: c_uint = 0x0;
pub const STM32_I2S_CFG1_REG: c_uint = 0x08;
pub const STM32_I2S_CFG2_REG: c_uint = 0x0C;
pub const STM32_I2S_IER_REG: c_uint = 0x10;
pub const STM32_I2S_SR_REG: c_uint = 0x14;
pub const STM32_I2S_IFCR_REG: c_uint = 0x18;

pub const STM32_I2S_RXDR_REG: c_uint = 0x30;

pub const STM32_I2S_HWCFGR_REG: c_uint = 0x3F0;
pub const STM32_I2S_VERR_REG: c_uint = 0x3F4;
pub const STM32_I2S_IPIDR_REG: c_uint = 0x3F8;
pub const STM32_I2S_SIDR_REG: c_uint = 0x3FC;
// Bit definition for SPI2S_CR1 register

// Bit definition for SPI_CFG2 register
pub const I2S_CFG2_IOSWP_SHIFT: c_int = 15;

// Bit definition for SPI_CFG1 register
pub const I2S_CFG1_FTHVL_SHIFT: c_int = 5;
...
pub const I2S_CGFR_I2SCFG_SHIFT: c_int = 1;

pub const I2S_CGFR_I2SSTD_SHIFT: c_int = 4;

pub const I2S_CGFR_DATLEN_SHIFT: c_int = 8;

pub const I2S_CGFR_CHLEN_SHIFT: c_int = 10;

pub const I2S_CGFR_I2SDIV_SHIFT: c_int = 16;
pub const I2S_CGFR_I2SDIV_BIT_H: c_int = 23;

    I2S_CGFR_I2SDIV_SHIFT)

    I2S_CGFR_I2SDIV_SHIFT)) - 1)
pub const I2S_CGFR_ODD_SHIFT: c_int = 24;
...
pub const I2S_IPIDR_NUMBER: c_uint = 0x00130022;
...
pub const STM32_I2S_FIFO_SIZE: c_int = 16;

pub const STM32_I2S_NAME_LEN: c_int = 32;
pub const STM32_I2S_RATE_11K: c_int = 11025;
pub const STM32_I2S_MAX_SAMPLE_RATE_8K: c_int = 192000;
pub const STM32_I2S_MAX_SAMPLE_RATE_11K: c_int = 176400;
...
pub struct stm32_i2s_data {
    ...
    pub /: *mut *mut spinlock_t lock_fd; / Manage race conditions for full duplex,
    ...
    pub refcount: c_int,
    pub ms_flg: c_int,
    pub rate): *mut *mut *mut int (set_i2s_clk_rate)(struct stm32_i2s_data i2s, unsigned int,
    pub i2s): *mut *mut void (put_i2s_clk_rate)(struct stm32_i2s_data,
}
...
pub struct stm32_i2s_conf {
    ...
    pub i2s): *mut *mut int (get_i2s_clk_parent)(struct stm32_i2s_data,
}
...
#[no_mangle]
unsafe extern "C" fn stm32_i2s_isr(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_i2s_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32_i2s_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32_i2s_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
// Set bitclock and frameclock to their inactive state
    ...
    {
    struct stm32_i2s_data *i2s = snd_soc_dai_get_drvdata(cpu_dai);
    let mut format: c_int = params_width(params);
...
// As data length is either 16 or 32 bits, fixch always set
    ...
    {
    struct stm32_i2s_data *i2s = snd_soc_dai_get_drvdata(cpu_dai);
    let mut playback_flg: bool = (substream.stream == SNDRV_PCM_STREAM_PLAYBACK);
    u32 cfg1_mask, ier;
    int ret;
    switch (cmd) {
...
//
    ...
    i2s.put_i2s_clk_rate(i2s);
    scoped_guard(spinlock_irqsave, &i2s.irq_lock)
    i2s.substream = core::ptr::null_mut();
    }
#[no_mangle]
