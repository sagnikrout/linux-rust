...
#[no_mangle]
unsafe extern "C" fn osk_startup(substream: *mut snd_pcm_substream) -> c_int {
    static int osk_startup(struct snd_pcm_substream *substream)
    {
    return clk_prepare_enable(tlv320aic23_mclk);
    }
#[no_mangle]
unsafe extern "C" fn osk_shutdown(substream: *mut snd_pcm_substream) {
...
// Set the codec system clock for DAC and ADC
    ...
    {"LLINEIN", core::ptr::null_mut(), "Line In"},
    {"RLINEIN", core::ptr::null_mut(), "Line In"},
    {"MICIN", core::ptr::null_mut(), "Mic Jack"},
    };
...
#[no_mangle]
unsafe extern "C" fn osk_soc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn osk_soc_exit() -> void __exit {
