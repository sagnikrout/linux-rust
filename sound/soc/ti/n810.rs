...
#[no_mangle]
unsafe extern "C" fn n810_shutdown(substream: *mut snd_pcm_substream) {
...
// Set the codec system clock for DAC and ADC
    ...
    {"Ext Spk", core::ptr::null_mut(), "LLOUT"},
    {"Ext Spk", core::ptr::null_mut(), "RLOUT"},
...
#[no_mangle]
unsafe extern "C" fn n810_soc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn n810_soc_exit() -> void __exit {
