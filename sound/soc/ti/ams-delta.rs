...
//! Source: sound/soc/ti/ams-delta.c
#![no_std]
...
// Handset
    SND_SOC_DAPM_MIC("Mouthpiece", core::ptr::null_mut()),
...
// How they are connected to codec pins
    ...
    {"TELIN", core::ptr::null_mut(), "Mouthpiece"},
    {"Earpiece", core::ptr::null_mut(), "TELOUT"},
    {"MIC", core::ptr::null_mut(), "Microphone"},
    {"Speaker", core::ptr::null_mut(), "SPKOUT"},
    };
//
...
pub const AMS_DELTA_MOUTHPIECE: c_int = 0;
pub const AMS_DELTA_EARPIECE: c_int = 1;
pub const AMS_DELTA_MICROPHONE: c_int = 2;
pub const AMS_DELTA_SPEAKER: c_int = 3;
pub const AMS_DELTA_AGC: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn cx81801_timeout(unused: *mut timer_list) {
...
// Shares hardware with codec config pulse generation
    let mut ams_delta_muted: static bool = 1;
#[no_mangle]
unsafe extern "C" fn ams_delta_mute(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
...
unsafe extern "C" fn ams_delta_startup(substream: *mut snd_pcm_substream) -> c_int {
    ...
    {
    return ams_delta_mute(core::ptr::null_mut(), 0, substream.stream);
    }
#[no_mangle]
...
// even if line discipline fails
    ...
    &ams_delta_hook_switch, core::ptr::null_mut(), 0);
    if (ret)
    dev_warn(card.dev,
