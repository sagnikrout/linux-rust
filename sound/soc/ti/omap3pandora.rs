...
//! Source: sound/soc/ti/omap3pandora.c
#![no_std]
...
//
    ...
    0, 0, core::ptr::null_mut(), 0, omap3pandora_hp_event,
    SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
    SND_SOC_DAPM_HP("Headphone Jack", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("Line Out", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("Mic (internal)", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("Mic (external)", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("Line In", core::ptr::null_mut()),
    };
    static const struct snd_soc_dapm_route omap3pandora_map[] = {
    {"PCM DAC", core::ptr::null_mut(), "APLL Enable"},
    {"Headphone Amplifier", core::ptr::null_mut(), "PCM DAC"},
    {"Line Out", core::ptr::null_mut(), "PCM DAC"},
    {"Headphone Jack", core::ptr::null_mut(), "Headphone Amplifier"},
    {"AUXL", core::ptr::null_mut(), "Line In"},
    {"AUXR", core::ptr::null_mut(), "Line In"},
    {"MAINMIC", core::ptr::null_mut(), "Mic (internal)"},
    {"Mic (internal)", core::ptr::null_mut(), "Mic Bias 1"},
    {"SUBMIC", core::ptr::null_mut(), "Mic (external)"},
    {"Mic (external)", core::ptr::null_mut(), "Mic Bias 2"},
    };
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn omap3pandora_soc_init() -> int __init {
    ...
    if (omap3pandora_snd_device == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn omap3pandora_soc_exit() -> void __exit {
