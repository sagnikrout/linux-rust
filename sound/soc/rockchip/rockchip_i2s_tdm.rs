...
//! Source: sound/soc/rockchip/rockchip_i2s_tdm.h
#![no_std]
...
pub const TDM_FSYNC_WIDTH_HALF_FRAME: c_int = 0;

//
// CLKDIV
// Mclk div register
//
pub const I2S_CLKDIV_TXM_SHIFT: c_int = 0;

pub const I2S_CLKDIV_RXM_SHIFT: c_int = 8;
