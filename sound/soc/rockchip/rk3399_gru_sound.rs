...
//! Source: sound/soc/rockchip/rk3399_gru_sound.c
#![no_std]
...
// Enable jack detection.
    ...
    return snd_soc_component_set_jack(component, &cdn_dp_card_jack, core::ptr::null_mut());
    }
#[no_mangle]
...
// Enable Headset and 4 Buttons Jack detection
    ...
    snd_soc_component_set_jack(component, &rockchip_sound_jack, core::ptr::null_mut());
    return 0;
    }
...
unsafe extern "C" fn rockchip_sound_startup(substream: *mut snd_pcm_substream) -> c_int {
    ...
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "spdif-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    SND_SOC_DAILINK_DEFS(da7219,
    DAILINK_COMP_ARRAY(COMP_EMPTY()),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "da7219-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    SND_SOC_DAILINK_DEFS(dmic,
    DAILINK_COMP_ARRAY(COMP_EMPTY()),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "dmic-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    ...
    DAILINK_COMP_ARRAY(COMP_EMPTY()),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "rt5514-aif1")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
...
// Output
    {"Headphones", core::ptr::null_mut(), "HPL"},
    {"Headphones", core::ptr::null_mut(), "HPR"},
// Input
    {"MIC", core::ptr::null_mut(), "Headset Mic"},
    };
    static const struct snd_soc_dapm_route rockchip_sound_dmic_routes[] = {
// Input
    {"DMic", core::ptr::null_mut(), "Int Mic"},
    };
...
// Input
    {"DMIC1L", core::ptr::null_mut(), "Int Mic"},
    {"DMIC1R", core::ptr::null_mut(), "Int Mic"},
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_sound_route {
    pub routes: *const snd_soc_dapm_route,
