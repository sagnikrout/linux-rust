...
//! Source: sound/soc/pxa/pxa2xx-ac97.c
#![no_std]
...
pub const PCDR: c_uint = 0x0040  /* PCM FIFO Data Register */;
pub const MODR: c_uint = 0x0140  /* Modem FIFO Data Register */;
pub const MCDR: c_uint = 0x0060  /* Mic-in FIFO Data Register */;
#[no_mangle]
unsafe extern "C" fn pxa2xx_ac97_warm_reset(adrv: *mut ac97_controller) {
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_ac97_cold_reset(adrv: *mut ac97_controller) {
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_ac97_dev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa2xx_ac97_dev_suspend(dev: *mut device) -> c_int {
    static int pxa2xx_ac97_dev_suspend(struct device *dev)
    {
    return pxa2xx_ac97_hw_suspend();
    }
#[no_mangle]
unsafe extern "C" fn pxa2xx_ac97_dev_resume(dev: *mut device) -> c_int {
