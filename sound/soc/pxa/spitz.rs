...
pub const SPITZ_HP: c_int = 0;
pub const SPITZ_MIC: c_int = 1;
pub const SPITZ_LINE: c_int = 2;
pub const SPITZ_HEADSET: c_int = 3;
pub const SPITZ_HP_OFF: c_int = 4;
pub const SPITZ_SPK_ON: c_int = 0;
pub const SPITZ_SPK_OFF: c_int = 1;
// audio clock in Hz - rounded from 12.235MHz
pub const SPITZ_AUDIO_CLOCK: c_int = 12288000;
...
// headset is a mic and mono headphone
    SND_SOC_DAPM_HP("Headset Jack", core::ptr::null_mut()),
    };
// Spitz machine audio_map
    static const struct snd_soc_dapm_route spitz_audio_map[] = {
// headphone connected to LOUT1, ROUT1
    {"Headphone Jack", core::ptr::null_mut(), "LOUT1"},
    {"Headphone Jack", core::ptr::null_mut(), "ROUT1"},
// headset connected to ROUT1 and LINPUT1 with bias (def below)
    {"Headset Jack", core::ptr::null_mut(), "ROUT1"},
// ext speaker connected to LOUT2, ROUT2
    {"Ext Spk", core::ptr::null_mut(), "ROUT2"},
    {"Ext Spk", core::ptr::null_mut(), "LOUT2"},
// mic is connected to input 1 - with bias
    {"LINPUT1", core::ptr::null_mut(), "Mic Bias"},
    {"Mic Bias", core::ptr::null_mut(), "Mic Jack"},
// line is connected to input 1 - no bias
    {"LINPUT1", core::ptr::null_mut(), "Line Jack"},
    };
