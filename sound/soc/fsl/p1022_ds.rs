...
//! Source: sound/soc/fsl/p1022_ds.c
#![no_std]
...
pub const CCSR_GUTS_PMUXCR_UART0_I2C1_MASK: c_uint = 0x0001c000;
pub const CCSR_GUTS_PMUXCR_UART0_I2C1_UART0_SSI: c_uint = 0x00010000;
pub const CCSR_GUTS_PMUXCR_UART0_I2C1_SSI: c_uint = 0x00018000;
pub const CCSR_GUTS_PMUXCR_SSI_DMA_TDM_MASK: c_uint = 0x00000c00;
pub const CCSR_GUTS_PMUXCR_SSI_DMA_TDM_SSI: c_uint = 0x00000000;
...
//
    ...
    {
    let mut shift: c_uint = 16 + (8 * (1 - co) + 2 * (3 - ch));
...
pub struct machine_data {
    ...
    pub /: *mut *mut unsigned int ssi_id; / 0 = SSI1, 1 = SSI2, etc,
    pub /: *mut *mut unsigned int dma_id[2]; / 0 = DMA1, 1 = DMA2, etc,
    pub etc*/: *mut *mut unsigned int dma_channel_id[2]; / 0 = ch 0, 1 = ch 1,,
    pub /: *mut *mut char platform_name[2][DAI_NAME_SIZE]; / One for each DMA channel,
}
...
// ssi_pdev is the platform device for the SSI node that probed us
    ...
    struct device_node *codec_np = core::ptr::null_mut();
...
// Get the serial format and clock direction.
    sprop = of_get_property(np, "fsl,mode", core::ptr::null_mut());
    if (!sprop) {
...
// the codec driver.
//
    iprop = of_get_property(codec_np, "clock-frequency", core::ptr::null_mut());
    if (!iprop || !*iprop) {
...
//
#[no_mangle]
unsafe extern "C" fn p1022_ds_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn p1022_ds_exit() -> void __exit {
