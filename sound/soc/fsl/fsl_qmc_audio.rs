...
//! Source: sound/soc/fsl/fsl_qmc_audio.c
#![no_std]
...
pub struct qmc_dai {
    ...
    pub nb_tx_ts: c_uint,
    pub nb_rx_ts: c_uint,
    pub nb_chans_avail: c_uint,
    pub nb_chans_used_tx: c_uint,
    pub nb_chans_used_rx: c_uint,
    pub qmc_chans: *mut qmc_chan,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmc_audio {
    pub dev: *mut device,
    pub num_dais: c_uint,
    pub dais: *mut qmc_dai,
    pub dai_drivers: *mut snd_soc_dai_driver,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmc_dai_prtd {
    pub qmc_dai: *mut qmc_dai,
    pub buffer_ended: snd_pcm_uframes_t,
    pub buffer_size: snd_pcm_uframes_t,
    pub period_size: snd_pcm_uframes_t,
    pub ch_dma_addr_start: dma_addr_t,
    pub ch_dma_addr_current: dma_addr_t,
    pub ch_dma_addr_end: dma_addr_t,
    pub ch_dma_size: usize,
    pub ch_dma_offset: usize,
    pub channels: c_uint,
...
#[no_mangle]
unsafe extern "C" fn qmc_audio_access_is_interleaved(access: snd_pcm_access_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qmc_audio_pcm_read_complete(context: *mut c_void, length: usize, flags: c_uint) {
    static void qmc_audio_pcm_read_complete(void *context, size_t length, unsigned int flags)
    {
    struct qmc_dai_prtd *prtd = context;
...
//
    ...
    struct snd_soc_dai *dai)
    {
    let mut chan_param: qmc_chan_param = {0};
...
#[no_mangle]
unsafe extern "C" fn qmc_audio_formats(nb_ts: u8, is_noninterleaved: bool) -> u64 {
