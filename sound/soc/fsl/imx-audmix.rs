...
//! Source: sound/soc/fsl/imx-audmix.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx_audmix_fe_startup(substream: *mut snd_pcm_substream) -> c_int {
    ...
    let mut channels: u32 = params_channels(params);
    int ret, dir;
...
#[no_mangle]
unsafe extern "C" fn imx_audmix_probe(pdev: *mut platform_device) -> c_int {
    static int imx_audmix_probe(struct platform_device *pdev)
    {
    struct device_node *np = pdev.dev.of_node;
    struct device_node *audmix_np = core::ptr::null_mut(), *out_cpu_np = core::ptr::null_mut();
    struct platform_device *audmix_pdev = core::ptr::null_mut();
    ...
    num_dai = of_count_phandle_with_args(audmix_np, "dais", core::ptr::null_mut());
...
// for CPU x 2
    ...
    return -ENOMEM;
    if (i == num_dai - 1)
    ret = of_parse_phandle_with_args(audmix_np, "dais", core::ptr::null_mut(), 0,
    &args);
    else
    ret = of_parse_phandle_with_args(audmix_np, "dais", core::ptr::null_mut(), i,
    &args);
    if (ret < 0) {
