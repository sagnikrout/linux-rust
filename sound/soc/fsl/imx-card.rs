...
//! Source: sound/soc/fsl/imx-card.c
#![no_std]
...
pub const IMX_CARD_MCLK_22P5792MHZ: c_int = 22579200;
pub const IMX_CARD_MCLK_24P576MHZ: c_int = 24576000;
    enum codec_type {
    CODEC_DUMMY = 0,
    CODEC_AK5558 = 1,
    CODEC_AK4458,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_akcodec_tdm_fs_mul {
    pub min: c_uint,
    pub max: c_uint,
    pub mul: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_card_plat_data {
    pub fs_mul: *mut imx_akcodec_fs_mul,
    pub tdm_fs_mul: *mut imx_akcodec_tdm_fs_mul,
    pub support_rates: *const u32,
    pub support_tdm_rates: *const u32,
    pub support_channels: *const u32,
    pub support_tdm_channels: *const u32,
    pub num_fs_mul: c_uint,
    pub num_tdm_fs_mul: c_uint,
    pub num_rates: c_uint,
    pub num_tdm_rates: c_uint,
    pub num_channels: c_uint,
    pub num_tdm_channels: c_uint,
    pub num_codecs: c_uint,
    pub type: enum codec_type,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dai_link_data {
    pub slots: c_uint,
    pub slot_width: c_uint,
    pub cpu_sysclk_id: c_uint,
    pub one2one_ratio: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_card_data {
    pub plat_data: *mut imx_card_plat_data,
    pub dapm_routes: *mut snd_soc_dapm_route,
    pub link_data: *mut dai_link_data,
...
#[no_mangle]
unsafe extern "C" fn format_is_dsd(params: *mut snd_pcm_hw_params) -> bool {
...
#[no_mangle]
unsafe extern "C" fn format_is_tdm(link_data: *mut dai_link_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn codec_is_akcodec(type: c_uint) -> bool {
    ...
    let mut width: c_uint = slots * slot_width;
...
unsafe extern "C" fn imx_card_parse_of(data: *mut imx_card_data) -> c_int {
    ...
    struct device_node *platform = core::ptr::null_mut();
    struct device_node *codec = core::ptr::null_mut();
    struct device_node *cpu = core::ptr::null_mut();
    struct device *dev = card.dev;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(link->codecs->dai_name, _arg: "ak4497-aif")) -> else {
    else if (!strcmp(link.codecs.dai_name, "ak4497-aif"))
    plat_data.type = CODEC_AK4497;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(link->codecs->dai_name, _arg: "ak5558-aif")) -> else {
    else if (!strcmp(link.codecs.dai_name, "ak5558-aif"))
    plat_data.type = CODEC_AK5558;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(link->codecs->dai_name, _arg: "ak5552-aif")) -> else {
    else if (!strcmp(link.codecs.dai_name, "ak5552-aif"))
    plat_data.type = CODEC_AK5552;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(link->codecs->dai_name, _arg: "cs42888")) -> else {
    else if (!strcmp(link.codecs.dai_name, "cs42888"))
    plat_data.type = CODEC_CS42888;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(link->codecs->dai_name, _arg: "wm8524-hifi")) -> else {
...
//
    link.no_pcm = 1;
    link.platforms = core::ptr::null_mut();
...
// Get dai fmt
    ...
    core::ptr::null_mut(), &link.dai_fmt);
    if (ret)
    link.dai_fmt = SND_SOC_DAIFMT_NB_NF |
    SND_SOC_DAIFMT_CBC_CFC |
    SND_SOC_DAIFMT_I2S;
// Get tdm slot
    snd_soc_of_parse_tdm_slot(np, core::ptr::null_mut(), core::ptr::null_mut(),
    &link_data.slots,
...
unsafe extern "C" fn imx_card_probe(pdev: *mut platform_device) -> c_int {
    ...
    {
    struct snd_soc_dai_link *link_be = core::ptr::null_mut(), *link;
