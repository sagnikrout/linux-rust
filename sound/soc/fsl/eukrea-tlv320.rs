...
//! Source: sound/soc/fsl/eukrea-tlv320.c
#![no_std]
...
pub const CODEC_CLOCK: c_int = 12000000;
...
// fsl_ssi lacks the set_sysclk ops
    ...
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "tlv320aic23-hifi")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
...
unsafe extern "C" fn eukrea_tlv320_probe(pdev: *mut platform_device) -> c_int {
    ...
    {
    int ret;
    let mut int_port: c_int = 0, ext_port;
    struct device_node *np = pdev.dev.of_node;
    struct device_node *ssi_np = core::ptr::null_mut(), *codec_np = core::ptr::null_mut(), *tmp_np = core::ptr::null_mut();
...
//
    ...
    (tmp_np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx21-audmux"))) {
    ...
    (tmp_np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx31-audmux"))) {
    if (!np)
