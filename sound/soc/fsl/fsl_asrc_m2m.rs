...
//! Source: sound/soc/fsl/fsl_asrc_m2m.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn asrc_read_last_fifo(pair: *mut fsl_asrc_pair, dma_vaddr: *mut c_void, length: *mut u32) {
    ...
    u32 *reg32 = core::ptr::null_mut();
    u16 *reg16 = core::ptr::null_mut();
    u8  *reg24 = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: reg16) -> else {
    else if (reg16)
...
#[no_mangle]
unsafe extern "C" fn asrc_m2m_device_run(pair: *mut fsl_asrc_pair, task: *mut snd_compr_task_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_asrc_m2m_release(dmabuf: *mut dma_buf) {
