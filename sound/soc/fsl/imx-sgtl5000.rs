...
//! Source: sound/soc/fsl/imx-sgtl5000.c
#![no_std]
...
unsafe extern "C" fn imx_sgtl5000_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct imx_sgtl5000_data *data = core::ptr::null_mut();
...
//
    ...
    data.codec_clk = clk_get(&codec_dev.dev, core::ptr::null_mut());
