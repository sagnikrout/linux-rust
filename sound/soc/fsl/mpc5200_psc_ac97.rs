...
//! Source: sound/soc/fsl/mpc5200_psc_ac97.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn psc_ac97_read(ac97: *mut snd_ac97, reg: c_ushort) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn psc_ac97_warm_reset(ac97: *mut snd_ac97) {
...
#[no_mangle]
unsafe extern "C" fn psc_ac97_probe(cpu_dai: *mut snd_soc_dai) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn psc_ac97_of_probe(op: *mut platform_device) -> c_int {
