...
//! Source: sound/soc/xilinx/xlnx_formatter_pcm.c
#![no_std]
...
pub const XLNX_S2MM_OFFSET: c_int = 0;
pub const XLNX_MM2S_OFFSET: c_uint = 0x100;
pub const XLNX_AUD_CORE_CONFIG: c_uint = 0x4;
pub const XLNX_AUD_CTRL: c_uint = 0x10;
pub const XLNX_AUD_STS: c_uint = 0x14;

pub const XLNX_AUD_FS_MULTIPLIER: c_uint = 0x18;
pub const XLNX_AUD_PERIOD_CONFIG: c_uint = 0x1C;
pub const XLNX_AUD_BUFF_ADDR_LSB: c_uint = 0x20;
pub const XLNX_AUD_BUFF_ADDR_MSB: c_uint = 0x24;
pub const XLNX_AUD_XFER_COUNT: c_uint = 0x28;
pub const XLNX_AUD_CH_STS_START: c_uint = 0x2C;
pub const XLNX_BYTES_PER_CH: c_uint = 0x44;
pub const XLNX_AUD_ALIGN_BYTES: c_int = 64;

pub const CFG_MM2S_CH_SHIFT: c_int = 8;

pub const CFG_MM2S_XFER_SHIFT: c_int = 13;

pub const CFG_S2MM_CH_SHIFT: c_int = 24;

pub const CFG_S2MM_XFER_SHIFT: c_int = 29;

pub const AUD_CTRL_DATA_WIDTH_SHIFT: c_int = 16;
pub const AUD_CTRL_ACTIVE_CH_SHIFT: c_int = 19;
pub const PERIOD_CFG_PERIODS_SHIFT: c_int = 16;
pub const PERIODS_MIN: c_int = 2;
pub const PERIODS_MAX: c_int = 6;
pub const PERIOD_BYTES_MIN: c_int = 192;

pub const XLNX_PARAM_UNKNOWN: c_int = 0;
    enum bit_depth {
    BIT_DEPTH_8,
    BIT_DEPTH_16,
    BIT_DEPTH_20,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xlnx_pcm_stream_param {
    pub mmio: *mut void __iomem,
...
#[no_mangle]
unsafe extern "C" fn xlnx_formatter_pcm_reset(mmio_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlnx_formatter_disable_irqs(mmio_base: *mut void __iomem, stream: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xlnx_mm2s_irq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xlnx_s2mm_irq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
// enable DMA IOC irq
    ...
    if (substream.stream == SNDRV_PCM_STREAM_PLAYBACK &&
    adata.sysclk) {
    let mut mclk_fs: c_uint = adata.sysclk / params_rate(params);
...
#[no_mangle]
unsafe extern "C" fn xlnx_formatter_pcm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlnx_formatter_pcm_remove(pdev: *mut platform_device) {
