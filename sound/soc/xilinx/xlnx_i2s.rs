...
//! Source: sound/soc/xilinx/xlnx_i2s.c
#![no_std]
...
pub const I2S_CORE_CTRL_OFFSET: c_uint = 0x08;

pub const I2S_I2STIM_OFFSET: c_uint = 0x20;
pub const I2S_CH0_OFFSET: c_uint = 0x30;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xlnx_i2s_drv_data {
...
#[no_mangle]
unsafe extern "C" fn xlnx_i2s_probe(pdev: *mut platform_device) -> c_int {
