...
//! Source: sound/soc/uniphier/evea.c
#![no_std]
...
pub const ALINSW1: c_uint = 0x0088;
pub const ALINSW1_SEL1_SHIFT: c_int = 3;
pub const AHPOUTPOW: c_uint = 0x0098;

pub const ALINEPOW: c_uint = 0x009c;

pub const ALO1OUTPOW: c_uint = 0x00a8;

pub const ALO2OUTPOW: c_uint = 0x00ac;

pub const AANAPOW: c_uint = 0x00b8;

pub const ADAC1ODC: c_uint = 0x0200;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct evea_priv {
    pub clk_exiv: *mut *mut clk clk,,
    pub rst_adamv: *mut *mut *mut reset_control rst, rst_exiv,,
    pub regmap: *mut regmap,
    pub switch_lin: c_int,
    pub switch_lo: c_int,
    pub switch_hp: c_int,
}
    ...
    SND_SOC_DAPM_ADC("ADC", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    ...
    SND_SOC_DAPM_DAC("DAC HP", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("DAC LO1", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("DAC LO2", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    ...
    { "Line In 1", core::ptr::null_mut(), "ADC" },
    { "ADC", core::ptr::null_mut(), "Line In 1 Mux" },
    ...
    { "DAC HP", core::ptr::null_mut(), "Headphone 1" },
    { "DAC LO1", core::ptr::null_mut(), "Line Out 1" },
    { "DAC LO2", core::ptr::null_mut(), "Line Out 2" },
    { "HP1_L", core::ptr::null_mut(), "DAC HP" },
    { "HP1_R", core::ptr::null_mut(), "DAC HP" },
    { "LO2_L", core::ptr::null_mut(), "DAC LO2" },
    { "LO2_R", core::ptr::null_mut(), "DAC LO2" },
    };
#[no_mangle]
unsafe extern "C" fn evea_set_power_state_on(evea: *mut evea_priv) {
...
#[no_mangle]
unsafe extern "C" fn evea_set_power_state_off(evea: *mut evea_priv) {
...
#[no_mangle]
unsafe extern "C" fn evea_update_switch_lin(evea: *mut evea_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evea_update_switch_lo(evea: *mut evea_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evea_update_switch_hp(evea: *mut evea_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evea_update_switch_all(evea: *mut evea_priv) {
...
#[no_mangle]
unsafe extern "C" fn evea_codec_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evea_codec_suspend(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evea_codec_resume(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evea_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evea_remove(pdev: *mut platform_device) {
