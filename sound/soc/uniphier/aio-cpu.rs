...
//! Source: sound/soc/uniphier/aio-cpu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_valid_pll(chip: *mut uniphier_aio_chip, pll_id: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn find_divider(aio: *mut uniphier_aio, pll_id: c_int, freq: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_aio_set_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
    ...
    struct uniphier_aio *aio = uniphier_priv(dai);
    struct uniphier_aio_sub *sub = &aio.sub[substream.stream];
    sub.substream = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn uniphier_aio_dai_suspend(dai: *mut snd_soc_dai) {
...
unsafe extern "C" fn uniphier_aio_resume(component: *mut snd_soc_component) -> c_int {
    ...
    let mut oport_hw: c_int = kcontrol.private_value;
...
pub unsafe extern "C" fn uniphier_aio_probe(pdev: *mut platform_device) -> c_int {
    ...
    return -EPROBE_DEFER;
    chip.regmap_sg = core::ptr::null_mut();
    }
