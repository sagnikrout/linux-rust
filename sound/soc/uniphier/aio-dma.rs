...
//! Source: sound/soc/uniphier/aio-dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aiodma_pcm_irq(sub: *mut uniphier_aio_sub) {
...
#[no_mangle]
unsafe extern "C" fn aiodma_compr_irq(sub: *mut uniphier_aio_sub) {
...
#[no_mangle]
unsafe extern "C" fn aiodma_irq(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn uniphier_aiodma_soc_register_platform(pdev: *mut platform_device) -> c_int {
