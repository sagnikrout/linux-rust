...
//! Source: sound/soc/uniphier/aio-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rb_cnt(wr: u64, rd: u64, len: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn rb_cnt_to_end(wr: u64, rd: u64, len: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn rb_space(wr: u64, rd: u64, len: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn rb_space_to_end(wr: u64, rd: u64, len: u64) -> u64 {
    static u64 rb_space_to_end(u64 wr, u64 rd, u64 len)
    {
    if (rd > wr)
    return rd - wr - 8;
#[no_mangle]
pub unsafe extern "C" fn if(0: rd >) -> else {
    else if (rd > 0)
    return len - wr;
    else
    return len - wr - 8;
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_iecout_set_enable(chip: *mut uniphier_aio_chip, enable: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_chip_init(chip: *mut uniphier_aio_chip) {
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_init(sub: *mut uniphier_aio_sub) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_port_reset(sub: *mut uniphier_aio_sub) {
...
//
#[no_mangle]
unsafe extern "C" fn aio_port_set_ch(sub: *mut uniphier_aio_sub) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aio_port_set_rate(sub: *mut uniphier_aio_sub, rate: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aio_port_set_fmt(sub: *mut uniphier_aio_sub) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aio_port_set_clk(sub: *mut uniphier_aio_sub) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_port_set_enable(sub: *mut uniphier_aio_sub, enable: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_port_get_volume(sub: *mut uniphier_aio_sub) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_port_set_volume(sub: *mut uniphier_aio_sub, vol: c_int) {
    void aio_port_set_volume(struct uniphier_aio_sub *sub, int vol)
    {
    struct regmap *r = sub.aio.chip.regmap;
    let mut oport_map: c_int = sub.swm.oport.map;
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_if_set_param(sub: *mut uniphier_aio_sub, pass_through: c_int) -> c_int {
...
//
    ...
    {
    struct regmap *r = sub.aio.chip.regmap;
    let mut repet: u32 = 0, pause = OPORTMXPAUDAT_PAUSEPC_CMN;
    int ret;
    switch (pc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn aio_src_reset(sub: *mut uniphier_aio_sub) {
...
#[no_mangle]
pub unsafe extern "C" fn aio_srcif_set_param(sub: *mut uniphier_aio_sub) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aio_srcch_set_param(sub: *mut uniphier_aio_sub) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aio_srcch_set_enable(sub: *mut uniphier_aio_sub, enable: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn aiodma_ch_set_param(sub: *mut uniphier_aio_sub) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aiodma_ch_set_enable(sub: *mut uniphier_aio_sub, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aiodma_rb_get_rp(sub: *mut uniphier_aio_sub) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn aiodma_rb_set_rp(sub: *mut uniphier_aio_sub, pos: u64) {
...
#[no_mangle]
unsafe extern "C" fn aiodma_rb_get_wp(sub: *mut uniphier_aio_sub) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn aiodma_rb_set_wp(sub: *mut uniphier_aio_sub, pos: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn aiodma_rb_set_threshold(sub: *mut uniphier_aio_sub, size: u64, th: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aiodma_rb_is_irq(sub: *mut uniphier_aio_sub) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn aiodma_rb_clear_irq(sub: *mut uniphier_aio_sub) {
