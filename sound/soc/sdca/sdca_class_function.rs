...
//! Source: sound/soc/sdca/sdca_class_function.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct class_function_drv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub core: *mut sdca_class_drv,
...
#[no_mangle]
unsafe extern "C" fn class_function_component_fixup_controls(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn class_function_boot(drv: *mut class_function_drv) -> c_int {
...
unsafe extern "C" fn class_function_resume(dev: *mut device) -> c_int {
    ...
    class_function_runtime_resume, core::ptr::null_mut())
    };
