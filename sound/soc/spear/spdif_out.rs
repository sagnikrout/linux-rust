...
//! Source: sound/soc/spear/spdif_out.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spdif_out_dev {
    pub clk: *mut clk,
    pub dma_params: spear_dma_data,
    pub saved_params: spdif_out_params,
    pub running: u32,
...
#[no_mangle]
unsafe extern "C" fn spdif_mute(dai: *mut snd_soc_dai, mute: c_int, direction: c_int) -> c_int {
