...
//! Source: sound/soc/samsung/tm2_wm5110.c
#![no_std]
...
pub const TM2_DAI_AIF1: c_int = 0;
pub const TM2_DAI_AIF2: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tm2_machine_priv {
    pub component: *mut snd_soc_component,
    pub sysclk_rate: c_uint,
    pub gpio_mic_bias: *mut gpio_desc,
}
...
// Set the MAX98504 V/I sense PDM Tx DAI channel mapping
    ...
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "wm5110-aif1")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    SND_SOC_DAILINK_DEFS(voice,
    DAILINK_COMP_ARRAY(COMP_CPU(SAMSUNG_I2S_DAI)),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "wm5110-aif2")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    SND_SOC_DAILINK_DEFS(bt,
    DAILINK_COMP_ARRAY(COMP_CPU(SAMSUNG_I2S_DAI)),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "wm5110-aif3")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
...
unsafe extern "C" fn tm2_probe(pdev: *mut platform_device) -> c_int {
    ...
    const char *cells_name = core::ptr::null_mut();
...
// Initialize WM5110 - I2S and HDMI - I2S1 DAI links
    ...
    dai_link.cpus.name = core::ptr::null_mut();
    dai_link.platforms.name = core::ptr::null_mut();
