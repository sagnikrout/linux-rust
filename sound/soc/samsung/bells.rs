...
//! Source: sound/soc/samsung/bells.c
#![no_std]
...
//
pub const MCLK_RATE: c_int = 24576000;
pub const SYS_AUDIO_RATE: c_int = 44100;

pub const DAI_AP_DSP: c_int = 0;
pub const DAI_DSP_CODEC: c_int = 1;
pub const DAI_CODEC_CP: c_int = 2;
pub const DAI_CODEC_SUB: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bells_drvdata {
    pub sysclk_rate: c_int,
    pub asyncclk_rate: c_int,
}
...
unsafe extern "C" fn bells_late_probe(card: *mut snd_soc_card) -> c_int {
    ...
    { "Sub CLK_SYS", core::ptr::null_mut(), "OPCLK" },
    { "CLKIN", core::ptr::null_mut(), "OPCLK" },
    { "DMIC", core::ptr::null_mut(), "MICBIAS2" },
    { "IN2L", core::ptr::null_mut(), "DMIC" },
    { "IN2R", core::ptr::null_mut(), "DMIC" },
    };
