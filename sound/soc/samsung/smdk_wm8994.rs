...
//! Source: sound/soc/samsung/smdk_wm8994.c
#![no_std]
...
pub const SMDK_WM8994_FREQ: c_int = 16934000;
...
unsafe extern "C" fn smdk_audio_probe(pdev: *mut platform_device) -> c_int {
    ...
    card.dev = &pdev.dev;
    if (np) {
    smdk_dai[0].cpus.dai_name = core::ptr::null_mut();
    ...
    smdk_dai[0].platforms.name = core::ptr::null_mut();
