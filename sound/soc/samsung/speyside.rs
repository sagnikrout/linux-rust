...
//! Source: sound/soc/samsung/speyside.c
#![no_std]
...
// At any time the WM9081 is active it will have this clock
    ...
    { "IN1RN", core::ptr::null_mut(), "MICB1" },
    { "IN1RP", core::ptr::null_mut(), "MICB1" },
    { "IN1RN", core::ptr::null_mut(), "MICB2" },
    { "IN1RP", core::ptr::null_mut(), "MICB2" },
    { "MICB1", core::ptr::null_mut(), "Headset Mic", speyside_get_micbias },
    { "MICB2", core::ptr::null_mut(), "Headset Mic", speyside_get_micbias },
    { "IN1LP", core::ptr::null_mut(), "MICB2" },
    { "IN1RN", core::ptr::null_mut(), "MICB1" },
    { "MICB2", core::ptr::null_mut(), "Main AMIC" },
    { "DMIC1DAT", core::ptr::null_mut(), "MICB1" },
    { "DMIC2DAT", core::ptr::null_mut(), "MICB1" },
    { "MICB1", core::ptr::null_mut(), "Main DMIC" },
    ...
    { "Main Speaker", core::ptr::null_mut(), "SPKDAT" },
    };
...
#[no_mangle]
unsafe extern "C" fn speyside_gpiod_table_action(data: *mut c_void) {
