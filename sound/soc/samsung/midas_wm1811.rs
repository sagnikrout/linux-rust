...
//! Source: sound/soc/samsung/midas_wm1811.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct midas_priv {
    pub gpio_fm_sel: *mut gpio_desc,
    pub gpio_lineout_sel: *mut gpio_desc,
    pub gpio_headset_detect: *mut gpio_desc,
    pub gpio_headset_key: *mut gpio_desc,
    pub adc_headset_detect: *mut iio_channel,
    pub fll1_rate: c_uint,
...
#[no_mangle]
unsafe extern "C" fn midas_start_fll1(rtd: *mut snd_soc_pcm_runtime, rate: c_uint) -> c_int {
...
// Bind microphones with their respective regulator supplies
    {"Main Mic", core::ptr::null_mut(), "mic-bias"},
    {"Sub Mic", core::ptr::null_mut(), "submic-bias"},
...
unsafe extern "C" fn midas_probe(pdev: *mut platform_device) -> c_int {
    ...
    {
    struct device_node *cpu_dai_node = core::ptr::null_mut(), *codec_dai_node = core::ptr::null_mut();
    struct device_node *cpu = core::ptr::null_mut(), *codec = core::ptr::null_mut();
