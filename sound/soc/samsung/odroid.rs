...
//! Source: sound/soc/samsung/odroid.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn odroid_card_be_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
// DAPM routes for backward compatibility with old DTS
    ...
    { "I2S Playback", core::ptr::null_mut(), "Mixer DAI TX" },
    { "HiFi Playback", core::ptr::null_mut(), "Mixer DAI TX" },
    };
...
unsafe extern "C" fn odroid_audio_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct device_node *cpu_dai = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_property_present(dev->of_node, _arg: "samsung, _arg: audio-routing")) -> else {
