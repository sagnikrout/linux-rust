...
//
    let mut pmdown_time: static int = 5000;
...
#[no_mangle]
unsafe extern "C" fn soc_init_component_debugfs(component: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn soc_cleanup_component_debugfs(component: *mut snd_soc_component) {
    static void soc_cleanup_component_debugfs(struct snd_soc_component *component)
    {
    if (!component.debugfs_root)
    return;
    debugfs_remove_recursive(component.debugfs_root);
    component.debugfs_root = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dai_list_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn component_list_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_init_card_debugfs(card: *mut snd_soc_card) {
...
#[no_mangle]
unsafe extern "C" fn soc_cleanup_card_debugfs(card: *mut snd_soc_card) {
    static void soc_cleanup_card_debugfs(struct snd_soc_card *card)
    {
    debugfs_remove_recursive(card.debugfs_card_root);
    card.debugfs_card_root = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn snd_soc_debugfs_init() {
    static void snd_soc_debugfs_init(void)
    {
    snd_soc_debugfs_root = debugfs_create_dir("asoc", core::ptr::null_mut());
    debugfs_create_file("dais", 0444, snd_soc_debugfs_root, core::ptr::null_mut(),
    &dai_list_fops);
    debugfs_create_file("components", 0444, snd_soc_debugfs_root, core::ptr::null_mut(),
    &component_list_fops);
    snd_soc_dapm_debugfs_pop_time(snd_soc_debugfs_root);
    }
#[no_mangle]
unsafe extern "C" fn snd_soc_debugfs_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_dlc_component_is_empty(dlc: *mut snd_soc_dai_link_component) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_dlc_component_is_invalid(dlc: *mut snd_soc_dai_link_component) -> c_int {
    static inline int snd_soc_dlc_component_is_invalid(struct snd_soc_dai_link_component *dlc)
    {
    return (dlc.name && dlc.of_node);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_soc_dlc_dai_is_empty(dlc: *mut snd_soc_dai_link_component) -> c_int {
...
pub unsafe extern "C" fn snd_soc_close_delayed_work(rtd: *mut snd_soc_pcm_runtime) {
    ...
    let mut playback: c_int = SNDRV_PCM_STREAM_PLAYBACK;
...
#[no_mangle]
unsafe extern "C" fn soc_release_rtd_dev(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn soc_free_pcm_runtime(rtd: *mut snd_soc_pcm_runtime) {
...
#[no_mangle]
unsafe extern "C" fn close_delayed_work(work: *mut work_struct) {
    struct snd_soc_pcm_runtime *rtd =
...
#[no_mangle]
unsafe extern "C" fn snd_soc_fill_dummy_dai(card: *mut snd_soc_card) {
...
#[no_mangle]
unsafe extern "C" fn snd_soc_flush_all_delayed_work(card: *mut snd_soc_card) {
...
#[no_mangle]
unsafe extern "C" fn soc_playback_digital_mute(card: *mut snd_soc_card, mute: c_int) {
...
#[no_mangle]
unsafe extern "C" fn soc_dapm_suspend_resume(card: *mut snd_soc_card, event: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn soc_resume_deferred(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_resume_init(card: *mut snd_soc_card) {
...
pub const MAX_DEFAULT_CH_MAP_SIZE: c_int = 8;
...
#[no_mangle]
pub unsafe extern "C" fn if(dai_link->num_codecs: dai_link->num_cpus <) -> else {
...
//
    ...
    component.card = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn soc_remove_link_dais(card: *mut snd_soc_card) {
...
#[no_mangle]
unsafe extern "C" fn soc_probe_link_dais(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_remove_link_components(card: *mut snd_soc_card) {
...
#[no_mangle]
unsafe extern "C" fn soc_probe_link_components(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_unbind_aux_dev(card: *mut snd_soc_card) {
    static void soc_unbind_aux_dev(struct snd_soc_card *card)
    {
    struct snd_soc_component *component, *_component;
    for_each_card_auxs_safe(card, component, _component) {
// for snd_soc_component_init()
    snd_soc_component_set_aux(component, core::ptr::null_mut());
    list_del(&component.card_aux_list);
    }
    }
#[no_mangle]
unsafe extern "C" fn soc_bind_aux_dev(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_probe_aux_devices(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_remove_aux_devices(card: *mut snd_soc_card) {
...
//
#[no_mangle]
unsafe extern "C" fn cleanup_dmi_name(name: *mut c_char) {
    ...
    name[j++] = name[i];
#[no_mangle]
pub unsafe extern "C" fn if('-': name[i] ==) -> else {
    else if (name[i] == '-')
    name[j++] = '_';
    }
    name[j] = '\0';
...
//
#[no_mangle]
unsafe extern "C" fn is_dmi_valid(field: *const c_char) -> c_int {
...
//
pub const DMI_LONGNAME_LEN: c_int = 80;
#[no_mangle]
unsafe extern "C" fn append_dmi_string(dst: *mut c_char, str: *const c_char) {
    static void append_dmi_string(char *dst, const char *str)
    {
    let mut dst_len: usize = DMI_LONGNAME_LEN;
    size_t len;
    len = strlen(dst);
...
//
#[no_mangle]
unsafe extern "C" fn snd_soc_set_dmi_name(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_set_dmi_name(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_check_tplg_fes(card: *mut snd_soc_card) {
...
#[no_mangle]
unsafe extern "C" fn soc_cleanup_card_resources(card: *mut snd_soc_card) {
...
// remove the card
    ...
    card.snd_card = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn snd_soc_remove_device_links(card: *mut snd_soc_card) {
    ...
    component.card_device_link = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn snd_soc_unbind_card(card: *mut snd_soc_card) {
...
#[no_mangle]
unsafe extern "C" fn snd_soc_bind_card(card: *mut snd_soc_card) -> c_int {
    ...
    snd_soc_dapm_init(dapm, card, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn devm_card_bind_release(dev: *mut device, res: *mut c_void) {
    static void devm_card_bind_release(struct device *dev, void *res)
    {
    snd_soc_unregister_card(*(struct snd_soc_card **)res);
    }
#[no_mangle]
unsafe extern "C" fn devm_snd_soc_bind_card(dev: *mut device, card: *mut snd_soc_card) -> c_int {
...
// The procedure may be called many times during the lifetime of the card.
    devres_destroy(dev, devm_card_bind_release, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn call_soc_bind_card(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_poweroff(dev: *mut device) -> c_int {
...
//
    ...
    {
    if (dai_drv.name == core::ptr::null_mut()) {
    dev_err(dev,
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_unregister_dai(dai: *mut snd_soc_dai) {
...
//
    ...
    (dai_drv.id == 0 || dai_drv.name == core::ptr::null_mut())) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_soc_unregister_dais(component: *mut snd_soc_component) {
...
//
#[no_mangle]
unsafe extern "C" fn convert_endianness_formats(stream: *mut snd_soc_pcm_stream) {
...
#[no_mangle]
unsafe extern "C" fn snd_soc_del_component_unlocked(component: *mut snd_soc_component) {
    ...
    if (!component.name) {
    component.name = fmt_single_name(dev, core::ptr::null_mut());
    if (!component.name) {
...
//
    ...
    const struct snd_soc_component_driver *component_driver)
    {
    const char *driver_name = core::ptr::null_mut();
    if (component_driver)
...
//
    ...
    SND_SOC_DAPM_MIC("Microphone", core::ptr::null_mut()),
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_of_parse_pin_switches(card: *mut snd_soc_card, prop: *const c_char) -> c_int {
    int snd_soc_of_parse_pin_switches(struct snd_soc_card *card, const char *prop)
    {
    let mut nb_controls_max: c_uint = 16;
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_of_parse_aux_devs(card: *mut snd_soc_card, propname: *const c_char) -> c_int {
    int snd_soc_of_parse_aux_devs(struct snd_soc_card *card, const char *propname)
    {
    struct device_node *node = card.dev.of_node;
    struct snd_soc_aux_dev *aux;
    int num, i;
    num = of_count_phandle_with_args(node, propname, core::ptr::null_mut());
    if (num == -ENOENT) {
    return 0;
    } else if (num < 0) {
    ...
    for (i = 0; i < num_widgets; i++) {
    const char *name;
    let mut ret: c_int = of_property_read_string_index(np, propname, i, &name);
    if (ret) {
    dev_err(card.dev,
    "ASoC: Property '%s' could not be read: %d\n",
    propname, ret);
...
pub unsafe extern "C" fn snd_soc_daifmt_clock_provider_flipped(dai_fmt: c_uint) -> c_uint {
    ...
    {
    let mut inv_dai_fmt: c_uint = dai_fmt & ~SND_SOC_DAIFMT_CLOCK_PROVIDER_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_get_dai_id(ep: *mut device_node) -> c_int {
...
pub unsafe extern "C" fn snd_soc_get_dlc(args: *const of_phandle_args, dlc: *mut snd_soc_dai_link_component) -> c_int {
    ...
    let mut ret: c_int = -EPROBE_DEFER;
    guard(mutex)(&client_mutex);
...
//
    ...
    {
    struct snd_soc_dai_link_component dlc;
    let mut ret: c_int = snd_soc_get_dlc(args, &dlc);
    if (ret == 0)
// dai_name = dlc.dai_name;
    ...
    {
    struct snd_soc_dai_link_component dlc;
    let mut ret: c_int = snd_soc_of_get_dlc(of_node, core::ptr::null_mut(), &dlc, index);
    if (ret == 0)
// dai_name = dlc.dai_name;
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn __snd_soc_of_put_component(component: *mut snd_soc_dai_link_component) {
    static void __snd_soc_of_put_component(struct snd_soc_dai_link_component *component)
    {
    if (component.of_node) {
    of_node_put(component.of_node);
    component.of_node = core::ptr::null_mut();
    }
    }
...
// Parse the list
    for_each_link_codecs(dai_link, index, component) {
    ret = snd_soc_of_get_dlc(of_node, core::ptr::null_mut(), component, index);
    if (ret)
    goto err;
    }
    return 0;
    ...
    dai_link.codecs = core::ptr::null_mut();
...
// Parse the list
    ...
    dai_link.cpus = core::ptr::null_mut();
    dai_link.num_cpus = 0;
    return ret;
    }
    EXPORT_SYMBOL_GPL(snd_soc_of_get_dai_link_cpus);
#[no_mangle]
unsafe extern "C" fn snd_soc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn snd_soc_exit() -> void __exit {
