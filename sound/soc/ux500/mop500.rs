...
//! Source: sound/soc/ux500/mop500.c
#![no_std]
...
// Define the whole MOP500 soundcard, linking platform to the codec-drivers
    ...
    .name = "MOP500-card",
    .owner = THIS_MODULE,
    .probe = core::ptr::null_mut(),
    .dai_link = mop500_dai_links,
    .num_links = ARRAY_SIZE(mop500_dai_links),
    };
#[no_mangle]
unsafe extern "C" fn mop500_of_node_put() {
...
#[no_mangle]
unsafe extern "C" fn mop500_of_probe(card: *mut snd_soc_card) -> c_int {
    ...
    mop500_dai_links[i].cpus.dai_name = core::ptr::null_mut();
    mop500_dai_links[i].platforms.of_node = msp_np[i];
    mop500_dai_links[i].platforms.name = core::ptr::null_mut();
    mop500_dai_links[i].codecs.of_node = codec_np;
    mop500_dai_links[i].codecs.name = core::ptr::null_mut();
    }
    snd_soc_of_parse_card_name(card, "stericsson,card-name");
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mop500_probe(pdev: *mut platform_device) -> c_int {
    ...
    snd_soc_card_set_drvdata(&mop500_card, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mop500_remove(pdev: *mut platform_device) {
