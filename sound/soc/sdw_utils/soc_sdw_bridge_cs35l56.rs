...
//! Source: sound/soc/sdw_utils/soc_sdw_bridge_cs35l56.c
#![no_std]
...
//
    ...
    SND_SOC_DAPM_SPK("Bridge Speaker", core::ptr::null_mut()),
    };
    static const struct snd_soc_dapm_route bridge_map[] = {
    {"Bridge Speaker", core::ptr::null_mut(), "AMPL SPK"},
    {"Bridge Speaker", core::ptr::null_mut(), "AMPR SPK"},
    };
...
#[no_mangle]
unsafe extern "C" fn asoc_sdw_bridge_cs35l56_asp_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
