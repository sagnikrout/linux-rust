...
//! Source: sound/soc/sdw_utils/soc_sdw_cs47l47.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn asoc_sdw_cs47l47_hs_rtd_init(rtd: *mut snd_soc_pcm_runtime, dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn asoc_sdw_cs47l47_dmic_rtd_init(rtd: *mut snd_soc_pcm_runtime, dai: *mut snd_soc_dai) -> c_int {
