...
//! Source: sound/soc/sdw_utils/soc_sdw_rt_sdca_jack_common.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn rt_sdca_jack_add_codec_device_props(sdw_dev: *mut device, quirk: c_ulong) -> c_int {
    ...
    { "Headphone", core::ptr::null_mut(), "rt712 HP" },
    { "rt712 MIC2", core::ptr::null_mut(), "Headset Mic" },
    };
    static const struct snd_soc_dapm_route rt713_sdca_map[] = {
    { "Headphone", core::ptr::null_mut(), "rt713 HP" },
    { "rt713 MIC2", core::ptr::null_mut(), "Headset Mic" },
    };
    static const struct snd_soc_dapm_route rt721_sdca_map[] = {
    { "Headphone", core::ptr::null_mut(), "rt721 HP" },
    { "rt721 MIC2", core::ptr::null_mut(), "Headset Mic" },
    };
    static const struct snd_soc_dapm_route rt722_sdca_map[] = {
    { "Headphone", core::ptr::null_mut(), "rt722 HP" },
    { "rt722 MIC2", core::ptr::null_mut(), "Headset Mic" },
    };
...
#[no_mangle]
pub unsafe extern "C" fn asoc_sdw_rt_sdca_jack_rtd_init(rtd: *mut snd_soc_pcm_runtime, dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn asoc_sdw_rt_sdca_jack_exit(card: *mut snd_soc_card, dai_link: *mut snd_soc_dai_link) -> c_int {
    ...
    ctx.headset_codec_dev = core::ptr::null_mut();
    return 0;
    }
