...
//! Source: sound/soc/sdw_utils/soc_sdw_cs42l42.c
#![no_std]
...
// HP jack connectors - unknown if we have jack detection
    {"Headphone", core::ptr::null_mut(), "cs42l42 HP"},
// other jacks
    {"cs42l42 HS", core::ptr::null_mut(), "Headset Mic"},
    };
...
#[no_mangle]
pub unsafe extern "C" fn asoc_sdw_cs42l42_rtd_init(rtd: *mut snd_soc_pcm_runtime, dai: *mut snd_soc_dai) -> c_int {
