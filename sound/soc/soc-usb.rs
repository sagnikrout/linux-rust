...
//
    ...
    return ctx ? ctx : core::ptr::null_mut();
    }
...
//
    ...
    mutex_unlock(&ctx_mutex);
    return ctx ? ctx.priv_data : core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_soc_usb_connect(usbdev: *mut device, sdev: *mut snd_soc_usb_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_soc_usb_disconnect(usbdev: *mut device, sdev: *mut snd_soc_usb_device) -> c_int {
