...
//! Source: sound/soc/google/chv3-i2s.c
#![no_std]
...
// are wait-free.
//
pub const I2S_TX_ENABLE: c_uint = 0x00;
pub const I2S_TX_BASE_ADDR: c_uint = 0x04;
pub const I2S_TX_BUFFER_SIZE: c_uint = 0x08;
pub const I2S_TX_PRODUCER_IDX: c_uint = 0x0c;
pub const I2S_TX_CONSUMER_IDX: c_uint = 0x10;
pub const I2S_RX_ENABLE: c_uint = 0x14;
pub const I2S_RX_BASE_ADDR: c_uint = 0x18;
pub const I2S_RX_BUFFER_SIZE: c_uint = 0x1c;
pub const I2S_RX_PRODUCER_IDX: c_uint = 0x20;
pub const I2S_RX_CONSUMER_IDX: c_uint = 0x24;
pub const I2S_SOFT_RESET: c_uint = 0x2c;
pub const I2S_SOFT_RESET_RX_BIT: c_uint = 0x1;
pub const I2S_SOFT_RESET_TX_BIT: c_uint = 0x2;
pub const I2S_RX_IRQ: c_uint = 0x4c;
pub const I2S_RX_IRQ_CONST: c_uint = 0x50;
pub const I2S_TX_IRQ: c_uint = 0x54;
pub const I2S_TX_IRQ_CONST: c_uint = 0x58;
pub const I2S_IRQ_MASK: c_uint = 0x8;
pub const I2S_IRQ_CLR: c_uint = 0xc;
pub const I2S_IRQ_RX_BIT: c_uint = 0x1;
pub const I2S_IRQ_TX_BIT: c_uint = 0x2;
pub const I2S_MAX_BUFFER_SIZE: c_uint = 0x200000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct chv3_i2s_dev {
    pub dev: *mut device,
    pub iobase: *mut void __iomem,
    pub iobase_irq: *mut void __iomem,
    pub rx_substream: *mut snd_pcm_substream,
    pub tx_substream: *mut snd_pcm_substream,
    pub tx_bytes_to_fetch: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn chv3_i2s_wr(i2s: *mut chv3_i2s_dev, offset: c_int, val: u32) {
    static inline void chv3_i2s_wr(struct chv3_i2s_dev *i2s, int offset, u32 val)
    {
    writel(val, i2s.iobase + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn chv3_i2s_rd(i2s: *mut chv3_i2s_dev, offset: c_int) -> u32 {
    static inline u32 chv3_i2s_rd(struct chv3_i2s_dev *i2s, int offset)
    {
    return readl(i2s.iobase + offset);
    }
#[no_mangle]
unsafe extern "C" fn chv3_i2s_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn chv3_i2s_probe(pdev: *mut platform_device) -> c_int {
