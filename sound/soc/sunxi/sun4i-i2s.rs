...
//! Source: sound/soc/sunxi/sun4i-i2s.c
#![no_std]
...
pub const SUN4I_I2S_CTRL_REG: c_uint = 0x00;

pub const SUN4I_I2S_FMT0_REG: c_uint = 0x04;

pub const SUN4I_I2S_FMT1_REG: c_uint = 0x08;

pub const SUN4I_I2S_FIFO_TX_REG: c_uint = 0x0c;
pub const SUN4I_I2S_FIFO_RX_REG: c_uint = 0x10;
pub const SUN4I_I2S_FIFO_CTRL_REG: c_uint = 0x14;

pub const SUN4I_I2S_FIFO_STA_REG: c_uint = 0x18;
pub const SUN4I_I2S_DMA_INT_CTRL_REG: c_uint = 0x1c;

pub const SUN4I_I2S_INT_STA_REG: c_uint = 0x20;
pub const SUN4I_I2S_CLK_DIV_REG: c_uint = 0x24;

pub const SUN4I_I2S_TX_CNT_REG: c_uint = 0x28;
pub const SUN4I_I2S_RX_CNT_REG: c_uint = 0x2c;
pub const SUN4I_I2S_TX_CHAN_SEL_REG: c_uint = 0x30;

pub const SUN4I_I2S_TX_CHAN_MAP_REG: c_uint = 0x34;

pub const SUN4I_I2S_RX_CHAN_SEL_REG: c_uint = 0x38;
pub const SUN4I_I2S_RX_CHAN_MAP_REG: c_uint = 0x3c;
// Defines required for sun8i-h3 support

pub const SUN8I_I2S_INT_STA_REG: c_uint = 0x0c;
pub const SUN8I_I2S_FIFO_TX_REG: c_uint = 0x20;
pub const SUN8I_I2S_CHAN_CFG_REG: c_uint = 0x30;

pub const SUN8I_I2S_TX_CHAN_MAP_REG: c_uint = 0x44;
pub const SUN8I_I2S_TX_CHAN_SEL_REG: c_uint = 0x34;

pub const SUN8I_I2S_RX_CHAN_SEL_REG: c_uint = 0x54;
pub const SUN8I_I2S_RX_CHAN_MAP_REG: c_uint = 0x58;
// Defines required for sun50i-h6 support

pub const SUN50I_H6_I2S_RX_CHAN_SEL_REG: c_uint = 0x64;
pub const SUN50I_H6_I2S_RX_CHAN_MAP0_REG: c_uint = 0x68;
pub const SUN50I_H6_I2S_RX_CHAN_MAP1_REG: c_uint = 0x6C;
pub const SUN50I_R329_I2S_RX_CHAN_MAP0_REG: c_uint = 0x68;
pub const SUN50I_R329_I2S_RX_CHAN_MAP1_REG: c_uint = 0x6c;
pub const SUN50I_R329_I2S_RX_CHAN_MAP2_REG: c_uint = 0x70;
pub const SUN50I_R329_I2S_RX_CHAN_MAP3_REG: c_uint = 0x74;
    struct sun4i_i2s;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_i2s_quirks {
    pub has_reset: bool,
    pub pcm_formats: u64,
    pub /: *mut *mut unsigned int reg_offset_txdata; / TX FIFO,
    pub sun4i_i2s_regmap: *const regmap_config,
// Register fields for i2s
    pub field_clkdiv_mclk_en: reg_field,
    pub field_fmt_wss: reg_field,
    pub field_fmt_sr: reg_field,
    pub num_din_pins: c_uint,
    pub num_dout_pins: c_uint,
    pub bclk_dividers: *const sun4i_i2s_clk_div,
    pub num_bclk_dividers: c_uint,
    pub mclk_dividers: *const sun4i_i2s_clk_div,
    pub num_mclk_dividers: c_uint,
    pub i2s): *const *const unsigned long (get_bclk_parent_rate)(struct sun4i_i2s,
    pub width): *mut *mut int (get_sr)(unsigned int,
    pub width): *mut *mut int (get_wss)(unsigned int,
//
...
//
    ...
    pub fmt): *const *const *const int (set_fmt)(struct sun4i_i2s i2s, unsigned int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_i2s {
    pub bus_clk: *mut clk,
    pub mod_clk: *mut clk,
...
// Register fields for i2s
    pub field_clkdiv_mclk_en: *mut regmap_field,
    pub field_fmt_wss: *mut regmap_field,
    pub field_fmt_sr: *mut regmap_field,
    pub variant: *const sun4i_i2s_quirks,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_i2s_clk_div {
    pub div: u8,
    pub val: u8,
}
...
unsafe extern "C" fn sun8i_i2s_get_bclk_parent_rate(i2s: *const sun4i_i2s) -> c_ulong {
    ...
    let mut div: c_int = parent_rate / sampling_rate / word_size / channels;
    int i;
    ...
    let mut div: c_int = parent_rate / mclk_rate;
    int i;
...
#[no_mangle]
unsafe extern "C" fn sun4i_i2s_oversample_is_valid(oversample: c_uint) -> bool {
...
// Configure the channels
    ...
    {
    struct sun4i_i2s *i2s = snd_soc_dai_get_drvdata(dai);
    let mut word_size: c_uint = params_width(params);
    let mut slot_width: c_uint = params_physical_width(params);
    let mut channels: c_uint = params_channels(params);
    let mut slots: c_uint = channels;
    int ret, sr, wss;
    u32 width;
    if (i2s.slots)
    slots = i2s.slots;
...
#[no_mangle]
unsafe extern "C" fn sun4i_i2s_rd_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sun4i_i2s_wr_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sun4i_i2s_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sun8i_i2s_rd_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sun8i_i2s_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
unsafe extern "C" fn sun4i_i2s_probe(pdev: *mut platform_device) -> c_int {
    ...
    i2s.rst = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(i2s.rst))
