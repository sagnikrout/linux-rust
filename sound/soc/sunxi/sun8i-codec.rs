...
//! Source: sound/soc/sunxi/sun8i-codec.c
#![no_std]
...
pub const SUN8I_SYSCLK_CTL: c_uint = 0x00c;
pub const SUN8I_SYSCLK_CTL_AIF1CLK_ENA: c_int = 11;

pub const SUN8I_SYSCLK_CTL_AIF2CLK_ENA: c_int = 7;

pub const SUN8I_SYSCLK_CTL_SYSCLK_ENA: c_int = 3;
pub const SUN8I_SYSCLK_CTL_SYSCLK_SRC: c_int = 0;

pub const SUN8I_MOD_CLK_ENA: c_uint = 0x010;
pub const SUN8I_MOD_CLK_ENA_AIF1: c_int = 15;
pub const SUN8I_MOD_CLK_ENA_AIF2: c_int = 14;
pub const SUN8I_MOD_CLK_ENA_AIF3: c_int = 13;
pub const SUN8I_MOD_CLK_ENA_ADC: c_int = 3;
pub const SUN8I_MOD_CLK_ENA_DAC: c_int = 2;
pub const SUN8I_MOD_RST_CTL: c_uint = 0x014;
pub const SUN8I_MOD_RST_CTL_AIF1: c_int = 15;
pub const SUN8I_MOD_RST_CTL_AIF2: c_int = 14;
pub const SUN8I_MOD_RST_CTL_AIF3: c_int = 13;
pub const SUN8I_MOD_RST_CTL_ADC: c_int = 3;
pub const SUN8I_MOD_RST_CTL_DAC: c_int = 2;
pub const SUN8I_SYS_SR_CTRL: c_uint = 0x018;
pub const SUN8I_SYS_SR_CTRL_AIF1_FS: c_int = 12;
pub const SUN8I_SYS_SR_CTRL_AIF2_FS: c_int = 8;

pub const SUN8I_AIF_CLK_CTRL_MSTR_MOD: c_int = 15;
pub const SUN8I_AIF_CLK_CTRL_CLK_INV: c_int = 13;
pub const SUN8I_AIF_CLK_CTRL_BCLK_DIV: c_int = 9;
pub const SUN8I_AIF_CLK_CTRL_LRCK_DIV: c_int = 6;
pub const SUN8I_AIF_CLK_CTRL_WORD_SIZ: c_int = 4;
pub const SUN8I_AIF_CLK_CTRL_DATA_FMT: c_int = 2;
pub const SUN8I_AIF1_ADCDAT_CTRL: c_uint = 0x044;
pub const SUN8I_AIF1_ADCDAT_CTRL_AIF1_AD0L_ENA: c_int = 15;
pub const SUN8I_AIF1_ADCDAT_CTRL_AIF1_AD0R_ENA: c_int = 14;
pub const SUN8I_AIF1_ADCDAT_CTRL_AIF1_AD0L_SRC: c_int = 10;
pub const SUN8I_AIF1_ADCDAT_CTRL_AIF1_AD0R_SRC: c_int = 8;
pub const SUN8I_AIF1_DACDAT_CTRL: c_uint = 0x048;
pub const SUN8I_AIF1_DACDAT_CTRL_AIF1_DA0L_ENA: c_int = 15;
pub const SUN8I_AIF1_DACDAT_CTRL_AIF1_DA0R_ENA: c_int = 14;
pub const SUN8I_AIF1_DACDAT_CTRL_AIF1_DA0L_SRC: c_int = 10;
pub const SUN8I_AIF1_DACDAT_CTRL_AIF1_DA0R_SRC: c_int = 8;
pub const SUN8I_AIF1_MXR_SRC: c_uint = 0x04c;
pub const SUN8I_AIF1_MXR_SRC_AD0L_MXR_SRC_AIF1DA0L: c_int = 15;
pub const SUN8I_AIF1_MXR_SRC_AD0L_MXR_SRC_AIF2DACL: c_int = 14;
pub const SUN8I_AIF1_MXR_SRC_AD0L_MXR_SRC_ADCL: c_int = 13;
pub const SUN8I_AIF1_MXR_SRC_AD0L_MXR_SRC_AIF2DACR: c_int = 12;
pub const SUN8I_AIF1_MXR_SRC_AD0R_MXR_SRC_AIF1DA0R: c_int = 11;
pub const SUN8I_AIF1_MXR_SRC_AD0R_MXR_SRC_AIF2DACR: c_int = 10;
pub const SUN8I_AIF1_MXR_SRC_AD0R_MXR_SRC_ADCR: c_int = 9;
pub const SUN8I_AIF1_MXR_SRC_AD0R_MXR_SRC_AIF2DACL: c_int = 8;
pub const SUN8I_AIF1_VOL_CTRL1: c_uint = 0x050;
pub const SUN8I_AIF1_VOL_CTRL1_AD0L_VOL: c_int = 8;
pub const SUN8I_AIF1_VOL_CTRL1_AD0R_VOL: c_int = 0;
pub const SUN8I_AIF1_VOL_CTRL3: c_uint = 0x058;
pub const SUN8I_AIF1_VOL_CTRL3_DA0L_VOL: c_int = 8;
pub const SUN8I_AIF1_VOL_CTRL3_DA0R_VOL: c_int = 0;
pub const SUN8I_AIF2_ADCDAT_CTRL: c_uint = 0x084;
pub const SUN8I_AIF2_ADCDAT_CTRL_AIF2_ADCL_ENA: c_int = 15;
pub const SUN8I_AIF2_ADCDAT_CTRL_AIF2_ADCR_ENA: c_int = 14;
pub const SUN8I_AIF2_ADCDAT_CTRL_AIF2_ADCL_SRC: c_int = 10;
pub const SUN8I_AIF2_ADCDAT_CTRL_AIF2_ADCR_SRC: c_int = 8;
pub const SUN8I_AIF2_DACDAT_CTRL: c_uint = 0x088;
pub const SUN8I_AIF2_DACDAT_CTRL_AIF2_DACL_ENA: c_int = 15;
pub const SUN8I_AIF2_DACDAT_CTRL_AIF2_DACR_ENA: c_int = 14;
pub const SUN8I_AIF2_DACDAT_CTRL_AIF2_DACL_SRC: c_int = 10;
pub const SUN8I_AIF2_DACDAT_CTRL_AIF2_DACR_SRC: c_int = 8;
pub const SUN8I_AIF2_MXR_SRC: c_uint = 0x08c;
pub const SUN8I_AIF2_MXR_SRC_ADCL_MXR_SRC_AIF1DA0L: c_int = 15;
pub const SUN8I_AIF2_MXR_SRC_ADCL_MXR_SRC_AIF1DA1L: c_int = 14;
pub const SUN8I_AIF2_MXR_SRC_ADCL_MXR_SRC_AIF2DACR: c_int = 13;
pub const SUN8I_AIF2_MXR_SRC_ADCL_MXR_SRC_ADCL: c_int = 12;
pub const SUN8I_AIF2_MXR_SRC_ADCR_MXR_SRC_AIF1DA0R: c_int = 11;
pub const SUN8I_AIF2_MXR_SRC_ADCR_MXR_SRC_AIF1DA1R: c_int = 10;
pub const SUN8I_AIF2_MXR_SRC_ADCR_MXR_SRC_AIF2DACL: c_int = 9;
pub const SUN8I_AIF2_MXR_SRC_ADCR_MXR_SRC_ADCR: c_int = 8;
pub const SUN8I_AIF2_VOL_CTRL1: c_uint = 0x090;
pub const SUN8I_AIF2_VOL_CTRL1_ADCL_VOL: c_int = 8;
pub const SUN8I_AIF2_VOL_CTRL1_ADCR_VOL: c_int = 0;
pub const SUN8I_AIF2_VOL_CTRL2: c_uint = 0x098;
pub const SUN8I_AIF2_VOL_CTRL2_DACL_VOL: c_int = 8;
pub const SUN8I_AIF2_VOL_CTRL2_DACR_VOL: c_int = 0;

pub const SUN8I_AIF3_PATH_CTRL: c_uint = 0x0cc;
pub const SUN8I_AIF3_PATH_CTRL_AIF3_ADC_SRC: c_int = 10;
pub const SUN8I_AIF3_PATH_CTRL_AIF2_DAC_SRC: c_int = 8;
pub const SUN8I_AIF3_PATH_CTRL_AIF3_PINS_TRI: c_int = 7;
pub const SUN8I_ADC_DIG_CTRL: c_uint = 0x100;
pub const SUN8I_ADC_DIG_CTRL_ENAD: c_int = 15;
pub const SUN8I_ADC_DIG_CTRL_ADOUT_DTS: c_int = 2;
pub const SUN8I_ADC_DIG_CTRL_ADOUT_DLY: c_int = 1;
pub const SUN8I_ADC_VOL_CTRL: c_uint = 0x104;
pub const SUN8I_ADC_VOL_CTRL_ADCL_VOL: c_int = 8;
pub const SUN8I_ADC_VOL_CTRL_ADCR_VOL: c_int = 0;
pub const SUN8I_HMIC_CTRL1: c_uint = 0x110;
pub const SUN8I_HMIC_CTRL1_HMIC_M: c_int = 12;
pub const SUN8I_HMIC_CTRL1_HMIC_N: c_int = 8;
pub const SUN8I_HMIC_CTRL1_MDATA_THRESHOLD_DB: c_int = 5;
pub const SUN8I_HMIC_CTRL1_JACK_OUT_IRQ_EN: c_int = 4;
pub const SUN8I_HMIC_CTRL1_JACK_IN_IRQ_EN: c_int = 3;
pub const SUN8I_HMIC_CTRL1_HMIC_DATA_IRQ_EN: c_int = 0;
pub const SUN8I_HMIC_CTRL2: c_uint = 0x114;
pub const SUN8I_HMIC_CTRL2_HMIC_SAMPLE: c_int = 14;
pub const SUN8I_HMIC_CTRL2_HMIC_MDATA_THRESHOLD: c_int = 8;
pub const SUN8I_HMIC_CTRL2_HMIC_SF: c_int = 6;
pub const SUN8I_HMIC_STS: c_uint = 0x118;
pub const SUN8I_HMIC_STS_MDATA_DISCARD: c_int = 13;
pub const SUN8I_HMIC_STS_HMIC_DATA: c_int = 8;
pub const SUN8I_HMIC_STS_JACK_OUT_IRQ_ST: c_int = 4;
pub const SUN8I_HMIC_STS_JACK_IN_IRQ_ST: c_int = 3;
pub const SUN8I_HMIC_STS_HMIC_DATA_IRQ_ST: c_int = 0;
pub const SUN8I_DAC_DIG_CTRL: c_uint = 0x120;
pub const SUN8I_DAC_DIG_CTRL_ENDA: c_int = 15;
pub const SUN8I_DAC_VOL_CTRL: c_uint = 0x124;
pub const SUN8I_DAC_VOL_CTRL_DACL_VOL: c_int = 8;
pub const SUN8I_DAC_VOL_CTRL_DACR_VOL: c_int = 0;
pub const SUN8I_DAC_MXR_SRC: c_uint = 0x130;
pub const SUN8I_DAC_MXR_SRC_DACL_MXR_SRC_AIF1DA0L: c_int = 15;
pub const SUN8I_DAC_MXR_SRC_DACL_MXR_SRC_AIF1DA1L: c_int = 14;
pub const SUN8I_DAC_MXR_SRC_DACL_MXR_SRC_AIF2DACL: c_int = 13;
pub const SUN8I_DAC_MXR_SRC_DACL_MXR_SRC_ADCL: c_int = 12;
pub const SUN8I_DAC_MXR_SRC_DACR_MXR_SRC_AIF1DA0R: c_int = 11;
pub const SUN8I_DAC_MXR_SRC_DACR_MXR_SRC_AIF1DA1R: c_int = 10;
pub const SUN8I_DAC_MXR_SRC_DACR_MXR_SRC_AIF2DACR: c_int = 9;
pub const SUN8I_DAC_MXR_SRC_DACR_MXR_SRC_ADCR: c_int = 8;

    SND_JACK_BTN_1|\
    SND_JACK_BTN_2|\
    SND_JACK_BTN_3)
pub const SUN8I_CODEC_PASSTHROUGH_SAMPLE_RATE: c_int = 48000;
...
pub struct sun8i_codec_aif {
    ...
    pub 2: unsigned int active_streams :,
    pub 2: unsigned int open_streams :,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun8i_codec_quirks {
    pub 1: bool bus_clock :,
    pub 1: bool jack_detection :,
    pub 1: bool legacy_widgets :,
    pub 1: bool lrck_inversion :,
}
...
#[no_mangle]
unsafe extern "C" fn sun8i_codec_get_hw_rate(sample_rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_codec_update_sample_rate(scodec: *mut sun8i_codec) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(22579200: scodec->sysclk_rate ==) -> else {
    else if (scodec.sysclk_rate == 22579200)
    list = &sun8i_codec_22M_rates;
#[no_mangle]
pub unsafe extern "C" fn if(24576000: scodec->sysclk_rate ==) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun8i_codec_clk_div {
    pub div: u8,
    pub val: u8,
}
    ...
    {
    let mut div: c_uint = sysclk_rate / sample_rate >> lrck_div_order;
    int i;
    ...
    {
    let mut div: c_uint = slots * slot_width;
    if (div < 16 || div > 256)
    return -EINVAL;
    return order_base_2(div);
    }
#[no_mangle]
unsafe extern "C" fn sun8i_codec_get_sysclk_rate(sample_rate: c_uint) -> c_uint {
    ...
    struct sun8i_codec *scodec = snd_soc_dai_get_drvdata(dai);
    struct sun8i_codec_aif *aif = &scodec.aifs[dai.id];
    let mut sample_rate: c_uint = params_rate(params);
    let mut slots: c_uint = aif.slots ?: params_channels(params);
    let mut slot_width: c_uint = aif.slot_width ?: params_width(params);
    let mut sysclk_rate: c_uint = sun8i_codec_get_sysclk_rate(sample_rate);
...
// AIF2 and AIF3 share AIF2's BCLK and LRCK generation circuitry.
    let mut partner: c_int = (SUN8I_CODEC_AIF2 + SUN8I_CODEC_AIF3) - dai.id;
...
// playback capabilities
    ...
    let mut stream: c_int = w.id == snd_soc_dapm_aif_out;
...
// System Clocks
    ...
    SUN8I_SYSCLK_CTL,
    SUN8I_SYSCLK_CTL_AIF1CLK_ENA, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("AIF2CLK",
    SUN8I_SYSCLK_CTL,
    SUN8I_SYSCLK_CTL_AIF2CLK_ENA, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("SYSCLK",
    SUN8I_SYSCLK_CTL,
    SUN8I_SYSCLK_CTL_SYSCLK_ENA, 0, core::ptr::null_mut(), 0),
// Module Clocks
    SND_SOC_DAPM_SUPPLY("CLK AIF1",
    SUN8I_MOD_CLK_ENA,
    SUN8I_MOD_CLK_ENA_AIF1, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CLK AIF2",
    SUN8I_MOD_CLK_ENA,
    SUN8I_MOD_CLK_ENA_AIF2, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CLK AIF3",
    SUN8I_MOD_CLK_ENA,
    SUN8I_MOD_CLK_ENA_AIF3, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CLK ADC",
    SUN8I_MOD_CLK_ENA,
    SUN8I_MOD_CLK_ENA_ADC, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("CLK DAC",
    SUN8I_MOD_CLK_ENA,
    SUN8I_MOD_CLK_ENA_DAC, 0, core::ptr::null_mut(), 0),
// Module Resets
    SND_SOC_DAPM_SUPPLY("RST AIF1",
    SUN8I_MOD_RST_CTL,
    SUN8I_MOD_RST_CTL_AIF1, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("RST AIF2",
    SUN8I_MOD_RST_CTL,
    SUN8I_MOD_RST_CTL_AIF2, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("RST AIF3",
    SUN8I_MOD_RST_CTL,
    SUN8I_MOD_RST_CTL_AIF3, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("RST ADC",
    SUN8I_MOD_RST_CTL,
    SUN8I_MOD_RST_CTL_ADC, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("RST DAC",
    SUN8I_MOD_RST_CTL,
    SUN8I_MOD_RST_CTL_DAC, 0, core::ptr::null_mut(), 0),
// Module Supplies
    SND_SOC_DAPM_SUPPLY("ADC",
    SUN8I_ADC_DIG_CTRL,
    SUN8I_ADC_DIG_CTRL_ENAD, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("DAC",
    SUN8I_DAC_DIG_CTRL,
    SUN8I_DAC_DIG_CTRL_ENDA, 0, core::ptr::null_mut(), 0),
// AIF "ADC" Outputs
...
// ADC Inputs (connected to analog codec DAPM context)
    SND_SOC_DAPM_ADC("ADCL", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_ADC("ADCR", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
// DAC Outputs (connected to analog codec DAPM context)
    SND_SOC_DAPM_DAC("DACL", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("DACR", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
// DAC Mixers
...
// Clock Routes
    { "AIF1CLK", core::ptr::null_mut(), "mod" },
    { "SYSCLK", core::ptr::null_mut(), "AIF1CLK" },
    { "CLK AIF1", core::ptr::null_mut(), "AIF1CLK" },
    { "CLK AIF1", core::ptr::null_mut(), "SYSCLK" },
    { "RST AIF1", core::ptr::null_mut(), "CLK AIF1" },
    { "AIF1 AD0L", core::ptr::null_mut(), "RST AIF1" },
    { "AIF1 AD0R", core::ptr::null_mut(), "RST AIF1" },
    { "AIF1 DA0L", core::ptr::null_mut(), "RST AIF1" },
    { "AIF1 DA0R", core::ptr::null_mut(), "RST AIF1" },
    { "CLK AIF2", core::ptr::null_mut(), "AIF2CLK" },
    { "CLK AIF2", core::ptr::null_mut(), "SYSCLK" },
    { "RST AIF2", core::ptr::null_mut(), "CLK AIF2" },
    { "AIF2 ADCL", core::ptr::null_mut(), "RST AIF2" },
    { "AIF2 ADCR", core::ptr::null_mut(), "RST AIF2" },
    { "AIF2 DACL", core::ptr::null_mut(), "RST AIF2" },
    { "AIF2 DACR", core::ptr::null_mut(), "RST AIF2" },
    { "CLK AIF3", core::ptr::null_mut(), "AIF1CLK" },
    { "CLK AIF3", core::ptr::null_mut(), "SYSCLK" },
    { "RST AIF3", core::ptr::null_mut(), "CLK AIF3" },
    { "AIF3 ADC", core::ptr::null_mut(), "RST AIF3" },
    { "AIF3 DAC", core::ptr::null_mut(), "RST AIF3" },
    { "CLK ADC", core::ptr::null_mut(), "SYSCLK" },
    { "RST ADC", core::ptr::null_mut(), "CLK ADC" },
    { "ADC", core::ptr::null_mut(), "RST ADC" },
    { "ADCL", core::ptr::null_mut(), "ADC" },
    { "ADCR", core::ptr::null_mut(), "ADC" },
    { "CLK DAC", core::ptr::null_mut(), "SYSCLK" },
    { "RST DAC", core::ptr::null_mut(), "CLK DAC" },
    { "DAC", core::ptr::null_mut(), "RST DAC" },
    { "DACL", core::ptr::null_mut(), "DAC" },
    { "DACR", core::ptr::null_mut(), "DAC" },
// AIF "ADC" Output Routes
    { "AIF1 AD0L", core::ptr::null_mut(), "AIF1 AD0L Stereo Mux" },
    { "AIF1 AD0R", core::ptr::null_mut(), "AIF1 AD0R Stereo Mux" },
    { "AIF2 ADCL", core::ptr::null_mut(), "AIF2 ADCL Stereo Mux" },
    { "AIF2 ADCR", core::ptr::null_mut(), "AIF2 ADCR Stereo Mux" },
    { "AIF3 ADC", core::ptr::null_mut(), "AIF3 ADC Source Capture Route" },
...
// DAC Output Routes
    { "DACL", core::ptr::null_mut(), "DACL Mixer" },
    { "DACR", core::ptr::null_mut(), "DACR Mixer" },
// DAC Mixer Routes
...
// Legacy ADC Inputs (connected to analog codec DAPM context)
    SND_SOC_DAPM_ADC("AIF1 Slot 0 Left ADC", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_ADC("AIF1 Slot 0 Right ADC", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
// Legacy DAC Outputs (connected to analog codec DAPM context)
    SND_SOC_DAPM_DAC("AIF1 Slot 0 Left", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_DAC("AIF1 Slot 0 Right", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
    };
    static const struct snd_soc_dapm_route sun8i_codec_legacy_routes[] = {
// Legacy ADC Routes
    { "ADCL", core::ptr::null_mut(), "AIF1 Slot 0 Left ADC" },
    { "ADCR", core::ptr::null_mut(), "AIF1 Slot 0 Right ADC" },
// Legacy DAC Routes
    { "AIF1 Slot 0 Left", core::ptr::null_mut(), "DACL" },
    { "AIF1 Slot 0 Right", core::ptr::null_mut(), "DACR" },
    };
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn sun8i_codec_set_hmic_bias(scodec: *mut sun8i_codec, enable: bool) {
    ...
    let mut irq_mask: c_int = BIT(SUN8I_HMIC_CTRL1_HMIC_DATA_IRQ_EN);
    if (enable)
...
#[no_mangle]
unsafe extern "C" fn sun8i_codec_jack_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t sun8i_codec_jack_irq(int irq, void *dev_id)
    {
    struct sun8i_codec *scodec = dev_id;
    let mut type: c_int = SND_JACK_HEADSET;
...
//
    ...
    type |= SND_JACK_BTN_0;
#[no_mangle]
pub unsafe extern "C" fn if(1: value ==) -> else {
    else if (value == 1)
    type |= SND_JACK_BTN_3;
#[no_mangle]
pub unsafe extern "C" fn if(3: value <=) -> else {
    else if (value <= 3)
    type |= SND_JACK_BTN_1;
#[no_mangle]
pub unsafe extern "C" fn if(8: value <=) -> else {
    else if (value <= 8)
    type |= SND_JACK_BTN_2;
//
...
// Do not discard any MDATA, enable user written MDATA threshold.
    ...
    core::ptr::null_mut(), sun8i_codec_jack_irq,
    IRQF_ONESHOT,
...
#[no_mangle]
unsafe extern "C" fn sun8i_codec_disable_jack_detect(component: *mut snd_soc_component) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_codec_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool sun8i_codec_volatile_reg(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = SUN8I_HMIC_STS;
    }
...
unsafe extern "C" fn sun8i_codec_remove(pdev: *mut platform_device) {
    ...
    sun8i_codec_runtime_resume, core::ptr::null_mut())
    };
