...
//! Source: sound/soc/sunxi/sun4i-codec.c
#![no_std]
...
// Global Mixer Enable
    ...
    SUN4I_CODEC_DAC_ACTL_MIXEN, 0, core::ptr::null_mut(), 0),
// VMIC
    SND_SOC_DAPM_SUPPLY("VMIC", SUN4I_CODEC_ADC_ACTL,
    SUN4I_CODEC_ADC_ACTL_VMICEN, 0, core::ptr::null_mut(), 0),
// Mic Pre-Amplifiers
    SND_SOC_DAPM_PGA("MIC1 Pre-Amplifier", SUN4I_CODEC_ADC_ACTL,
    SUN4I_CODEC_ADC_ACTL_PREG1EN, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("MIC2 Pre-Amplifier", SUN4I_CODEC_ADC_ACTL,
    SUN4I_CODEC_ADC_ACTL_PREG2EN, 0, core::ptr::null_mut(), 0),
// Power Amplifier
...
// Left ADC / DAC Routes
    { "Left ADC", core::ptr::null_mut(), "ADC" },
    { "Left DAC", core::ptr::null_mut(), "DAC" },
// Right ADC / DAC Routes
    { "Right ADC", core::ptr::null_mut(), "ADC" },
    { "Right DAC", core::ptr::null_mut(), "DAC" },
// Right Mixer Routes
    { "Right Mixer", core::ptr::null_mut(), "Mixer Enable" },
...
// Left Mixer Routes
    { "Left Mixer", core::ptr::null_mut(), "Mixer Enable" },
...
// Headphone Output Routes
    ...
    { "HP Right", core::ptr::null_mut(), "Power Amplifier Mute" },
    { "HP Left", core::ptr::null_mut(), "Power Amplifier Mute" },
// Mic1 Routes
    { "Left ADC", core::ptr::null_mut(), "MIC1 Pre-Amplifier" },
    { "Right ADC", core::ptr::null_mut(), "MIC1 Pre-Amplifier" },
    { "MIC1 Pre-Amplifier", core::ptr::null_mut(), "Mic1"},
    { "Mic1", core::ptr::null_mut(), "VMIC" },
// Mic2 Routes
    { "Left ADC", core::ptr::null_mut(), "MIC2 Pre-Amplifier" },
    { "Right ADC", core::ptr::null_mut(), "MIC2 Pre-Amplifier" },
    { "MIC2 Pre-Amplifier", core::ptr::null_mut(), "Mic2"},
    { "Mic2", core::ptr::null_mut(), "VMIC" },
    };
...
// Microphone Bias
    ...
    SUN6I_CODEC_MIC_CTRL_HBIASEN, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("MBIAS", SUN6I_CODEC_MIC_CTRL,
    SUN6I_CODEC_MIC_CTRL_MBIASEN, 0, core::ptr::null_mut(), 0),
// Mic input path
    ...
    SUN6I_CODEC_MIC_CTRL_MIC1AMPEN, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_PGA("Mic2 Amplifier", SUN6I_CODEC_MIC_CTRL,
    SUN6I_CODEC_MIC_CTRL_MIC2AMPEN, 0, core::ptr::null_mut(), 0),
// Line In
...
// Headphone output path
    ...
    SUN6I_CODEC_OM_PA_CTRL_HPPAEN, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("HPCOM Protection", SUN6I_CODEC_OM_PA_CTRL,
    SUN6I_CODEC_OM_PA_CTRL_COMPTEN, 0, core::ptr::null_mut(), 0),
...
// DAC Routes
    { "Left DAC", core::ptr::null_mut(), "DAC Enable" },
    { "Right DAC", core::ptr::null_mut(), "DAC Enable" },
// Microphone Routes
    { "Mic1 Amplifier", core::ptr::null_mut(), "MIC1"},
    { "Mic2 Amplifier Source Route", "Mic2", "MIC2" },
    { "Mic2 Amplifier Source Route", "Mic3", "MIC3" },
    { "Mic2 Amplifier", core::ptr::null_mut(), "Mic2 Amplifier Source Route"},
// Left Mixer Routes
...
// ADC Routes
    { "Left ADC", core::ptr::null_mut(), "ADC Enable" },
    { "Right ADC", core::ptr::null_mut(), "ADC Enable" },
...
// Digital parts of the ADCs
    SND_SOC_DAPM_SUPPLY("ADC Enable", SUN6I_CODEC_ADC_FIFOC,
    SUN6I_CODEC_ADC_FIFOC_EN_AD, 0, core::ptr::null_mut(), 0),
// Digital parts of the DACs
    SND_SOC_DAPM_SUPPLY("DAC Enable", SUN4I_CODEC_DAC_DPC,
    SUN4I_CODEC_DAC_DPC_EN_DA, 0, core::ptr::null_mut(), 0),
    };
...
// Mic input path
    ...
    SUNIV_CODEC_ADC_MICAMPEN, 0, core::ptr::null_mut(), 0),
// Line In
    SND_SOC_DAPM_INPUT("LINEIN"),
// FM In
...
// Headphone output path
    ...
    SUNIV_CODEC_OM_DACA_CTRL_HPPAEN, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY("HPCOM Protection", SUNIV_CODEC_OM_DACA_CTRL,
    SUNIV_CODEC_OM_DACA_CTRL_COMPTEN, 0, core::ptr::null_mut(), 0),
...
// DAC Routes
    ...
    { "Right DAC", core::ptr::null_mut(), "DAC Enable" },
// Microphone Routes
    { "Mic Amplifier", core::ptr::null_mut(), "MIC"},
// Left Mixer Routes
...
// Headphone Routes
    ...
    { "HPCOM", core::ptr::null_mut(), "HPCOM Protection" },
// ADC Routes
    { "ADC", core::ptr::null_mut(), "ADC Mixer" },
    { "ADC", core::ptr::null_mut(), "ADC Enable" },
    };
...
//
    ...
    { "Speaker", core::ptr::null_mut(), "HP Right" },
    { "Speaker", core::ptr::null_mut(), "HP Left" },
    };
...
// ADC Routes
    { "Left ADC", core::ptr::null_mut(), "ADC Enable" },
    { "Right ADC", core::ptr::null_mut(), "ADC Enable" },
    { "Codec Capture", core::ptr::null_mut(), "Left ADC" },
    { "Codec Capture", core::ptr::null_mut(), "Right ADC" },
// DAC Routes
    { "Left DAC", core::ptr::null_mut(), "DAC Enable" },
    { "Right DAC", core::ptr::null_mut(), "DAC Enable" },
    { "Left DAC", core::ptr::null_mut(), "Codec Playback" },
    { "Right DAC", core::ptr::null_mut(), "Codec Playback" },
    };
...
// Line Out path
    ...
    SUN50I_H616_RDEN, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_OUTPUT("LINEOUT"),
    };
...
// Line Out Routes
    ...
    { "Line Out Source Playback Route", "Mono Differential", "Left Mixer" },
    { "Line Out Source Playback Route", "Mono Differential", "Right Mixer" },
    { "Line Out Ramp Controller", core::ptr::null_mut(), "Line Out Source Playback Route" },
    { "LINEOUT", core::ptr::null_mut(), "Line Out Ramp Controller" },
    };
    ...
    SND_SOC_DAPM_HP("Headphone", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("Line In", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("Right FM In", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("Left FM In", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("Mic", core::ptr::null_mut()),
    SND_SOC_DAPM_SPK("Speaker", sun4i_codec_spk_event),
    };
// Connect digital side enables to analog side widgets
...
// ADC Routes
    { "ADC", core::ptr::null_mut(), "ADC Enable" },
    { "Codec Capture", core::ptr::null_mut(), "ADC" },
// DAC Routes
    { "Left DAC", core::ptr::null_mut(), "DAC Enable" },
    { "Right DAC", core::ptr::null_mut(), "DAC Enable" },
    { "Left DAC", core::ptr::null_mut(), "Codec Playback" },
...
pub struct sun4i_codec_quirks {
    ...
    pub dev): *mut *mut *mut snd_soc_card  (create_card)(device,
    pub /: *mut *mut reg_field reg_adc_fifoc; / used for regmap_field,
    pub /: *mut *mut reg_field reg_dac_fifoc; / used for regmap_field,
    pub /: *mut *mut unsigned int reg_dac_txdata; / TX FIFO offset for DMA config,
    pub /: *mut *mut unsigned int reg_adc_rxdata; / RX FIFO offset for DMA config,
    pub has_reset: bool,
...
// Get the clocks from the DT
    ...
    if (quirks.has_reset) {
    scodec.rst = devm_reset_control_get_exclusive_deasserted(&pdev.dev, core::ptr::null_mut());
