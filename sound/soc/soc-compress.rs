...
//! Source: sound/soc/soc-compress.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn soc_compr_clean(cstream: *mut snd_compr_stream, rollback: c_int) -> c_int {
    ...
    soc_pcm_set_dai_params(cpu_dai, core::ptr::null_mut());
    if (!snd_soc_dai_active(codec_dai))
    soc_pcm_set_dai_params(codec_dai, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn soc_compr_trigger_fe(cstream: *mut snd_compr_stream, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soc_compr_ack(cstream: *mut snd_compr_stream, bytes: usize) -> c_int {
...
pub unsafe extern "C" fn snd_soc_new_compress(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    char new_name[64];
    let mut ret: c_int = 0, direction = 0;
    let mut playback: c_int = 0, capture = 0;
    int i;
//
