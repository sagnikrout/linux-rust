...
//! Source: sound/soc/intel/avs/core.c
#![no_std]
...
//
    ...
    let mut pgctl_mask: static u32 = AZX_PGCTL_LSRMD_MASK;
    module_param(pgctl_mask, uint, 0444);
    MODULE_PARM_DESC(pgctl_mask, "PCI PGCTL policy override");
    let mut cgctl_mask: static u32 = AZX_CGCTL_MISCBDCGE_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn avs_hda_power_gating_enable(adev: *mut avs_dev, enable: bool) {
    void avs_hda_power_gating_enable(struct avs_dev *adev, bool enable)
    {
    let mut value: u32 = enable ? 0 : pgctl_mask;
    if (!avs_platattr_test(adev, ACE))
    avs_hda_update_config_dword(&adev.base.core, AZX_PCIREG_PGCTL, pgctl_mask, value);
    }
#[no_mangle]
unsafe extern "C" fn avs_hdac_clock_gating_enable(bus: *mut hdac_bus, enable: bool) {
    static void avs_hdac_clock_gating_enable(struct hdac_bus *bus, bool enable)
    {
    struct avs_dev *adev = hdac_to_avs(bus);
    let mut value: u32 = enable ? cgctl_mask : 0;
    if (!avs_platattr_test(adev, ACE))
    avs_hda_update_config_dword(bus, AZX_PCIREG_CGCTL, cgctl_mask, value);
    }
#[no_mangle]
pub unsafe extern "C" fn avs_hda_clock_gating_enable(adev: *mut avs_dev, enable: bool) {
    void avs_hda_clock_gating_enable(struct avs_dev *adev, bool enable)
    {
    avs_hdac_clock_gating_enable(&adev.base.core, enable);
    }
#[no_mangle]
pub unsafe extern "C" fn avs_hda_l1sen_enable(adev: *mut avs_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn avs_hdac_bus_init_streams(bus: *mut hdac_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_hdac_bus_init_chip(bus: *mut hdac_bus, full_reset: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn probe_codec(bus: *mut hdac_bus, addr: c_int) -> c_int {
    static int probe_codec(struct hdac_bus *bus, int addr)
    {
    struct hda_codec *codec;
    unsigned int cmd = (addr << 28) | (AC_NODE_ROOT << 20) |
    (AC_VERB_PARAMETERS << 8) | AC_PAR_VENDOR_ID;
    let mut res: c_uint = -1;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn avs_hdac_bus_probe_codecs(bus: *mut hdac_bus) {
...
#[no_mangle]
unsafe extern "C" fn avs_hda_probe_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hdac_stream_update_pos(stream: *mut hdac_stream, buffer_size: u64) {
...
// called from IRQ
#[no_mangle]
unsafe extern "C" fn hdac_update_stream(bus: *mut hdac_bus, stream: *mut hdac_stream) {
    ...
    let mut buffer_size: u64 = stream.cstream.runtime.buffer_size;
    hdac_stream_update_pos(stream, buffer_size);
    snd_compr_fragment_elapsed(stream.cstream);
    }
    }
#[no_mangle]
unsafe extern "C" fn avs_hda_interrupt(bus: *mut hdac_bus) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn avs_hda_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn avs_hda_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn avs_hdac_acquire_irq(adev: *mut avs_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_bus_init(adev: *mut avs_dev, pci: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    int ret;
    ret = snd_hdac_ext_bus_init(&bus.core, dev, core::ptr::null_mut(), &soc_hda_ext_bus_ops);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn avs_pci_probe(pci: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_pci_shutdown(pci: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn avs_pci_remove(pci: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn avs_suspend_standby(adev: *mut avs_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_suspend_common(adev: *mut avs_dev, low_power: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_resume_standby(adev: *mut avs_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_resume_common(adev: *mut avs_dev, low_power: bool, purge: bool) -> c_int {
...
unsafe extern "C" fn avs_restore(dev: *mut device) -> c_int {
    ...
    .restore = avs_restore,
    RUNTIME_PM_OPS(avs_runtime_suspend, avs_runtime_resume, core::ptr::null_mut())
    };
