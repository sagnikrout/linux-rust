...
//! Source: sound/soc/intel/avs/ptl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn avs_ptl_core_power_on(adev: *mut avs_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_ptl_core_power_off(adev: *mut avs_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_ptl_core_power(adev: *mut avs_dev, core_mask: u32, power: bool) -> c_int {
