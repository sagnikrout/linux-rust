...
//! Source: sound/soc/intel/avs/skl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn avs_skl_log_buffer_status(adev: *mut avs_dev, msg: *mut union avs_notify_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_skl_coredump(adev: *mut avs_dev, msg: *mut union avs_notify_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_skl_d0ix_toggle(adev: *mut avs_dev, tx: *mut avs_ipc_msg, wake: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn avs_skl_set_d0ix(adev: *mut avs_dev, enable: bool) -> c_int {
