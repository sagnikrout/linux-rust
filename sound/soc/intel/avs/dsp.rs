...
//! Source: sound/soc/intel/avs/dsp.c
#![no_std]
...
pub const AVS_ADSPCS_DELAY_US: c_int = 1000;
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_core_power(adev: *mut avs_dev, core_mask: u32, power: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_core_reset(adev: *mut avs_dev, core_mask: u32, reset: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_core_stall(adev: *mut avs_dev, core_mask: u32, stall: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_enable(adev: *mut avs_dev, core_mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_disable(adev: *mut avs_dev, core_mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_get_core(adev: *mut avs_dev, core_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_put_core(adev: *mut avs_dev, core_id: u32) -> c_int {
