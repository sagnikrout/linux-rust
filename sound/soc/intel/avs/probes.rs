...
//! Source: sound/soc/intel/avs/probes.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_delete_probe(adev: *mut avs_dev) {
...
#[no_mangle]
unsafe extern "C" fn avs_probe_compr_open(cstream: *mut snd_compr_stream, dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_probe_compr_free(cstream: *mut snd_compr_stream, dai: *mut snd_soc_dai) -> c_int {
...
// Extractor node identifier.
    let mut vindex: c_uint = INVALID_NODE_ID.vindex;
    size_t num_desc;
    int i, ret;
...
#[no_mangle]
pub unsafe extern "C" fn avs_register_probe_component(adev: *mut avs_dev, name: *const c_char) -> c_int {
