...
//! Source: sound/soc/intel/avs/ipc.c
#![no_std]
...
pub const AVS_IPC_TIMEOUT_MS: c_int = 300;
pub const AVS_D0IX_DELAY_MS: c_int = 300;
    static int
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_schedule_d0ix(adev: *mut avs_dev, tx: *mut avs_ipc_msg) {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_d0ix_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_wake_d0i0(adev: *mut avs_dev, tx: *mut avs_ipc_msg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_disable_d0ix(adev: *mut avs_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_enable_d0ix(adev: *mut avs_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_recovery(adev: *mut avs_dev) {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_recovery_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_exception_caught(adev: *mut avs_dev, msg: *mut union avs_notify_msg) {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_receive_rx(adev: *mut avs_dev, header: u64) {
    static void avs_dsp_receive_rx(struct avs_dev *adev, u64 header)
    {
    struct avs_ipc *ipc = adev.ipc;
    let mut msg: union avs_reply_msg = AVS_MSG(header);
    u32 sts, lec;
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_process_notification(adev: *mut avs_dev, header: u64) {
    static void avs_dsp_process_notification(struct avs_dev *adev, u64 header)
    {
    struct avs_notify_mod_data mod_data;
    let mut msg: union avs_notify_msg = AVS_MSG(header);
...
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_process_response(adev: *mut avs_dev, header: u64) {
...
#[no_mangle]
unsafe extern "C" fn avs_ipc_is_busy(ipc: *mut avs_ipc) -> bool {
    static bool avs_ipc_is_busy(struct avs_ipc *ipc)
    {
    struct avs_dev *adev = to_avs_dev(ipc.dev);
    let mut spec: *const avs_spec const = adev.spec;
    u32 hipc_rsp;
    hipc_rsp = snd_hdac_adsp_readl(adev, spec.hipc.rsp_offset);
    return hipc_rsp & spec.hipc.rsp_busy_mask;
    }
#[no_mangle]
unsafe extern "C" fn avs_ipc_wait_busy_completion(ipc: *mut avs_ipc, timeout: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avs_ipc_msg_init(ipc: *mut avs_ipc, reply: *mut avs_ipc_msg) {
...
#[no_mangle]
unsafe extern "C" fn avs_dsp_send_tx(adev: *mut avs_dev, tx: *mut avs_ipc_msg, read_fwregs: bool) {
    ...
    if (ret) {
    if (ret == -ETIMEDOUT) {
    let mut msg: union avs_notify_msg = AVS_NOTIFICATION(EXCEPTION_CAUGHT);
...
pub unsafe extern "C" fn if(_arg: ret) -> else {
    ...
    struct avs_ipc_msg *reply, int timeout, const char *name)
    {
    let mut wake_d0i0: bool = avs_dsp_op(adev, d0ix_toggle, request, true);
    let mut schedule_d0ix: bool = avs_dsp_op(adev, d0ix_toggle, request, false);
...
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_send_rom_msg(adev: *mut avs_dev, request: *mut avs_ipc_msg, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avs_dsp_interrupt_control(adev: *mut avs_dev, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn avs_ipc_init(ipc: *mut avs_ipc, dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avs_ipc_block(ipc: *mut avs_ipc) {
