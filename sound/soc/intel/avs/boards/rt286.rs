...
//! Source: sound/soc/intel/avs/boards/rt286.c
#![no_std]
...
unsafe extern "C" fn avs_rt286_codec_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    if (ret)
    return ret;
    return snd_soc_component_set_jack(snd_soc_rtd_to_codec(runtime, 0).component, jack, core::ptr::null_mut());
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn avs_rt286_be_fixup(runtime: *mut snd_soc_pcm_runtime, params: *mut snd_pcm_hw_params) -> c_int {
