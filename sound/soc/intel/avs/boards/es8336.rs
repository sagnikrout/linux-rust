...
//! Source: sound/soc/intel/avs/boards/es8336.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct avs_card_drvdata {
    pub jack: snd_soc_jack,
    pub gpiod: *mut gpio_desc,
}

    let mut enable_gpio: static struct acpi_gpio_params = { 0, 0, true };
...
unsafe extern "C" fn avs_es8336_codec_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    snd_soc_component_set_jack(component, &data.jack, core::ptr::null_mut());
...
unsafe extern "C" fn avs_es8336_codec_exit(runtime: *mut snd_soc_pcm_runtime) {
    ...
    struct snd_soc_dai *codec_dai = snd_soc_rtd_to_codec(runtime, 0);
    snd_soc_component_set_jack(codec_dai.component, core::ptr::null_mut(), core::ptr::null_mut());
...
unsafe extern "C" fn avs_card_resume_post(card: *mut snd_soc_card) -> c_int {
    ...
    return snd_soc_component_set_jack(codec_dai.component, &data.jack, core::ptr::null_mut());
    }
#[no_mangle]
