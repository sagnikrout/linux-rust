...
//! Source: sound/soc/intel/avs/boards/rt5640.c
#![no_std]
...
pub const AVS_RT5640_MCLK_HZ: c_int = 19200000;
    ...
    { "IN2P", core::ptr::null_mut(), "Mic Jack" },
    { "IN2P", core::ptr::null_mut(), "MICBIAS1" },
...
unsafe extern "C" fn avs_rt5640_codec_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    if (ret)
    return ret;
    snd_soc_component_set_jack(codec_dai.component, jack, core::ptr::null_mut());
