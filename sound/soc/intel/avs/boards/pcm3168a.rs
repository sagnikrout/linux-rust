...
//! Source: sound/soc/intel/avs/boards/pcm3168a.c
#![no_std]
...
//
    ...
    { "CPB Stereo HP 1", core::ptr::null_mut(), "AOUT1L" },
    { "CPB Stereo HP 1", core::ptr::null_mut(), "AOUT1R" },
    { "CPB Stereo HP 2", core::ptr::null_mut(), "AOUT2L" },
    { "CPB Stereo HP 2", core::ptr::null_mut(), "AOUT2R" },
    { "CPB Stereo HP 3", core::ptr::null_mut(), "AOUT3L" },
    { "CPB Stereo HP 3", core::ptr::null_mut(), "AOUT3R" },
    { "CPB Line Out", core::ptr::null_mut(), "AOUT4L" },
    { "CPB Line Out", core::ptr::null_mut(), "AOUT4R" },
    { "AIN1L", core::ptr::null_mut(), "CPB Stereo Mic 1" },
    { "AIN1R", core::ptr::null_mut(), "CPB Stereo Mic 1" },
    { "AIN2L", core::ptr::null_mut(), "CPB Stereo Mic 2" },
    { "AIN2R", core::ptr::null_mut(), "CPB Stereo Mic 2" },
    { "AIN3L", core::ptr::null_mut(), "CPB Line In" },
    { "AIN3R", core::ptr::null_mut(), "CPB Line In" },
    };
