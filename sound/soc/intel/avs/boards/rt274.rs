...
//! Source: sound/soc/intel/avs/boards/rt274.c
#![no_std]
...
pub const AVS_RT274_FREQ_OUT: c_int = 24000000;
pub const AVS_RT274_BE_FIXUP_RATE: c_int = 48000;
...
// Codec needs clock for Jack detection and button press
    ...
    {"MIC", core::ptr::null_mut(), "Mic Jack"},
    {"Headphone Jack", core::ptr::null_mut(), "Platform Clock"},
    {"MIC", core::ptr::null_mut(), "Platform Clock"},
    };
...
unsafe extern "C" fn avs_rt274_codec_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    if (ret)
    return ret;
    snd_soc_component_set_jack(component, jack, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn avs_rt274_be_fixup(runtime: *mut snd_soc_pcm_runtime, params: *mut snd_pcm_hw_params) -> c_int {
