...
//! Source: sound/soc/intel/avs/debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __kfifo_fromio(fifo: *mut kfifo, src: *const void __iomem, len: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn avs_dump_fw_log(adev: *mut avs_dev, src: *const void __iomem, len: c_uint) {
    void avs_dump_fw_log(struct avs_dev *adev, const void __iomem *src, unsigned int len)
    {
    __kfifo_fromio(&adev.trace_fifo, src, len);
    }
#[no_mangle]
pub unsafe extern "C" fn avs_dump_fw_log_wakeup(adev: *mut avs_dev, src: *const void __iomem, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fw_regs_read(file: *mut file, to: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn debug_window_read(file: *mut file, to: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn probe_points_read(file: *mut file, to: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn strace_read(file: *mut file, to: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn strace_release(inode: *mut inode, file: *mut file) -> c_int {
    static int strace_release(struct inode *inode, struct file *file)
    {
    let mut msg: union avs_notify_msg = AVS_NOTIFICATION(LOG_BUFFER_STATUS);
    struct avs_dev *adev = file.private_data;
...
#[no_mangle]
unsafe extern "C" fn enable_logs(adev: *mut avs_dev, resource_mask: u32, priorities: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disable_logs(adev: *mut avs_dev, resource_mask: u32) -> c_int {
...
// Check if there's anything to do.
    ...
    resource_mask, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn trace_control_read(file: *mut file, to: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
