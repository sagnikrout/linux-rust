...
//! Source: sound/soc/intel/common/soc-acpi-intel-byt-match.c
#![no_std]
...
pub const BYT_RT5672: c_int = 1;
pub const BYT_POV_P1006W: c_int = 2;
#[no_mangle]
unsafe extern "C" fn byt_rt5672_quirk_cb(id: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_pov_p1006w_quirk_cb(id: *const dmi_system_id) -> c_int {
