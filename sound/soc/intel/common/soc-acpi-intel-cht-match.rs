...
//! Source: sound/soc/intel/common/soc-acpi-intel-cht-match.c
#![no_std]
...
pub const CHT_SURFACE_MACH: c_int = 1;
#[no_mangle]
unsafe extern "C" fn cht_surface_quirk_cb(id: *const dmi_system_id) -> c_int {
