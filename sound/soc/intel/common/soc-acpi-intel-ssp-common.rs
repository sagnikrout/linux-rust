...
//! Source: sound/soc/intel/common/soc-acpi-intel-ssp-common.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct codec_map {
    pub name: *const c_char,
    pub tplg_suffix: *const c_char,
    pub acpi_hid: *const c_char,
    pub codec_type: enum snd_soc_acpi_intel_codec,
}
...
//
    ...
    if (!acpi_dev_present(codecs[i].acpi_hid, core::ptr::null_mut(), -1))
    continue;
    ...
    if (!acpi_dev_present(amps[i].acpi_hid, core::ptr::null_mut(), -1))
    continue;
