...
//! Source: sound/soc/intel/catpt/device.c
#![no_std]
...
unsafe extern "C" fn catpt_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(catpt_runtime_suspend, catpt_runtime_resume, core::ptr::null_mut())
    };
...
unsafe extern "C" fn catpt_register_board(cdev: *mut catpt_dev) -> c_int {
    ...
    board = platform_device_register_data(core::ptr::null_mut(), mach.drv_name,
    PLATFORM_DEVID_NONE,
