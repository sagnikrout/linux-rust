...
//! Source: sound/soc/intel/catpt/pcm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct catpt_stream_template {
    pub path_id: enum catpt_path_id,
    pub type: enum catpt_stream_type,
...
// Caller responsible for holding ->stream_mutex.
#[no_mangle]
unsafe extern "C" fn catpt_stream_hw_id(cdev: *mut catpt_dev, pin_id: enum catpt_pin_id) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn catpt_get_channel_map(config: enum catpt_channel_config) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn catpt_get_channel_config(num_channels: u32) -> enum catpt_channel_config {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct catpt_control_data {
    pub pin_id: enum catpt_pin_id,
    pub volumes: [c_long; CATPT_CHANNELS_MAX],
}

#[no_mangle]
unsafe extern "C" fn catpt_apply_volume(cdev: *mut catpt_dev, card: *mut snd_soc_card, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catpt_apply_mute(cdev: *mut catpt_dev, card: *mut snd_soc_card) -> c_int {
...
pub const CATPT_BUFFER_MAX_SIZE: c_int = 76800;
pub const CATPT_PCM_PERIODS_MAX: c_int = 4;
pub const CATPT_PCM_PERIODS_MIN: c_int = 2;
...
pub const DSP_VOLUME_STEP_MAX: c_int = 30;
#[no_mangle]
unsafe extern "C" fn ctlvol_to_dspvol(value: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dspvol_to_ctlvol(volume: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn catpt_set_dspvol(cdev: *mut catpt_dev, stream_id: u8, ctlvol: *mut c_long) -> c_int {
    static int catpt_set_dspvol(struct catpt_dev *cdev, u8 stream_id, long *ctlvol)
    {
    u32 dspvol;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn catpt_volume_info(kctl: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catpt_volume_get(kctl: *mut snd_kcontrol, uctl: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catpt_volume_put(kctl: *mut snd_kcontrol, uctl: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catpt_loopback_mute_get(kctl: *mut snd_kcontrol, uctl: *mut snd_ctl_elem_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catpt_loopback_mute_put(kctl: *mut snd_kcontrol, uctl: *mut snd_ctl_elem_value) -> c_int {
...
// kmute = cmute;
    ...
    SND_SOC_DAPM_AIF_IN("SSP0 CODEC IN", core::ptr::null_mut(), 0, SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_AIF_OUT("SSP0 CODEC OUT", core::ptr::null_mut(), 0, SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_AIF_IN("SSP1 BT IN", core::ptr::null_mut(), 0, SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_AIF_OUT("SSP1 BT OUT", core::ptr::null_mut(), 0, SND_SOC_NOPM, 0, 0),
    SND_SOC_DAPM_MIXER("Playback VMixer", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    };
    static const struct snd_soc_dapm_route component_routes[] = {
    {"Playback VMixer", core::ptr::null_mut(), "System Playback"},
    {"Playback VMixer", core::ptr::null_mut(), "Offload0 Playback"},
    {"Playback VMixer", core::ptr::null_mut(), "Offload1 Playback"},
    {"SSP0 CODEC OUT", core::ptr::null_mut(), "Playback VMixer"},
    {"Analog Capture", core::ptr::null_mut(), "SSP0 CODEC IN"},
    {"Loopback Capture", core::ptr::null_mut(), "SSP0 CODEC IN"},
    {"SSP1 BT OUT", core::ptr::null_mut(), "Bluetooth Playback"},
    {"Bluetooth Capture", core::ptr::null_mut(), "SSP1 BT IN"},
    };
