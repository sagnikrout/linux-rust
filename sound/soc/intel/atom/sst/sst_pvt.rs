...
//! Source: sound/soc/intel/atom/sst/sst_pvt.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn sst_shim_write(addr: *mut void __iomem, offset: c_int, value: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sst_shim_read(addr: *mut void __iomem, offset: c_int) -> u32 {
    u32 sst_shim_read(void __iomem *addr, int offset)
    {
    return readl(addr + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn sst_reg_read64(addr: *mut void __iomem, offset: c_int) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn sst_shim_write64(addr: *mut void __iomem, offset: c_int, value: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sst_shim_read64(addr: *mut void __iomem, offset: c_int) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_wait_timeout(sst_drv_ctx: *mut intel_sst_drv, block: *mut sst_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_create_ipc_msg(arg: *mut ipc_post, large: bool) -> c_int {
    ...
    msg.mailbox_data = core::ptr::null_mut();
    }
    msg.is_large = large;
// arg = msg;
    return 0;
...
pub const SST_MAX_BLOCKS: c_int = 15;
//
...
#[no_mangle]
pub unsafe extern "C" fn relocate_imr_addr_mrfld(base_addr: u32) -> u32 {
...
// relocate the base
    ...
    sst.ops.post_message(sst, core::ptr::null_mut(), false);
    }
