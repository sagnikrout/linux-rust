...
//! Source: sound/soc/intel/atom/sst/sst_stream.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn sst_alloc_stream_mrfld(sst_drv_ctx: *mut intel_sst_drv, params: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_realloc_stream(sst_drv_ctx: *mut intel_sst_drv, str_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_start_stream(sst_drv_ctx: *mut intel_sst_drv, str_id: c_int) -> c_int {
    ...
    sizeof(u16), &data, core::ptr::null_mut(), true, true, true, false);
    return retval;
    }
    int sst_send_byte_stream_mrfld(struct intel_sst_drv *sst_drv_ctx,
    struct snd_sst_bytes_v2 *bytes)
    {	struct ipc_post *msg = core::ptr::null_mut();
    u32 length;
    int pvt_id, ret = 0;
    struct sst_block *block = core::ptr::null_mut();
    let mut bytes_block: u8 = bytes.block;
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_pause_stream(sst_drv_ctx: *mut intel_sst_drv, str_id: c_int) -> c_int {
    ...
    0, core::ptr::null_mut(), core::ptr::null_mut(), true, true, false, true);
    if (retval == 0) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_resume_stream(sst_drv_ctx: *mut intel_sst_drv, str_id: c_int) -> c_int {
...
//
    ...
    str_info.pipe_id, 0, core::ptr::null_mut(), core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_drop_stream(sst_drv_ctx: *mut intel_sst_drv, str_id: c_int) -> c_int {
...
//
    ...
    sizeof(u8), &partial_drain, core::ptr::null_mut(), true, true, false, false);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn sst_free_stream(sst_drv_ctx: *mut intel_sst_drv, str_id: c_int) -> c_int {
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), true, true, false, true);
