...
//! Source: sound/soc/intel/atom/sst/sst_loader.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn memcpy32_toio(dst: *mut void __iomem, src: *const c_void, count: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn memcpy32_fromio(dst: *mut c_void, src: *const void __iomem, count: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sst_do_memcpy(memcpy_list: *mut list_head) {
...
// Free the list
    ...
    kfree(sst.fw_in_mem);
    sst.fw_in_mem = core::ptr::null_mut();
    }
    end_release:
    release_firmware(fw);
    return retval;
...
pub unsafe extern "C" fn sst_firmware_load_cb(fw: *const firmware, context: *mut c_void) {
    ...
    ctx.fw_in_mem != core::ptr::null_mut()) {
    release_firmware(fw);
...
//
#[no_mangle]
unsafe extern "C" fn sst_request_fw(sst: *mut intel_sst_drv) -> c_int {
