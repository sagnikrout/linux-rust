...
//! Source: sound/soc/intel/atom/sst-mfld-platform-compress.c
#![no_std]
...
// fill the device type and stream id to pass to SST driver
    ...
    AAC_BIT_STREAM_ADTS;
#[no_mangle]
pub unsafe extern "C" fn if(SND_AUDIOSTREAMFORMAT_RAW: params->codec.format ==) -> else {
    ...
    {
    struct sst_runtime_stream *stream;
    let mut temp_copied_total: u64 = tstamp.copied_total;
    stream = cstream.runtime.private_data;
