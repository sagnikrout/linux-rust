...
//! Source: sound/soc/intel/boards/sof_wm8804.c
#![no_std]
...
pub struct sof_card_private {
    pub gpio_44: *mut gpio_desc,
    pub gpio_48: *mut gpio_desc,
...
#[no_mangle]
unsafe extern "C" fn sof_wm8804_remove(pdev: *mut platform_device) {
