...
//! Source: sound/soc/intel/boards/sof_es8336.c
#![no_std]
...
pub const MAX_NO_PROPS: c_int = 2;

// HDMI capture

pub const SOF_NO_OF_HDMI_CAPTURE_SSP_SHIFT: c_int = 15;

    (((quirk) << SOF_NO_OF_HDMI_CAPTURE_SSP_SHIFT) & SOF_NO_OF_HDMI_CAPTURE_SSP_MASK)
pub const SOF_HDMI_CAPTURE_1_SSP_SHIFT: c_int = 7;

    (((quirk) << SOF_HDMI_CAPTURE_1_SSP_SHIFT) & SOF_HDMI_CAPTURE_1_SSP_MASK)
pub const SOF_HDMI_CAPTURE_2_SSP_SHIFT: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sof_es8336_private {
    pub codec_dev: *mut device,
    pub gpio_headphone: *mut *mut gpio_desc gpio_speakers,,
    pub jack: snd_soc_jack,
    pub hdmi_pcm_list: list_head,
    pub speaker_en: bool,
    pub pcm_pop_work: delayed_work,
}
...
pub struct sof_hdmi_pcm {
    ...
    let mut enable_gpio0: static struct acpi_gpio_params = { 0, 0, true };
    let mut enable_gpio1: static struct acpi_gpio_params = { 1, 0, true };
...
//
    {"Speaker", core::ptr::null_mut(), "HPOL"},
    {"Speaker", core::ptr::null_mut(), "HPOR"},
    {"Speaker", core::ptr::null_mut(), "Speaker Power"},
    };
    static const struct snd_soc_dapm_route sof_es8316_headset_mic2_map[] = {
    {"MIC1", core::ptr::null_mut(), "Internal Mic"},
    {"MIC2", core::ptr::null_mut(), "Headset Mic"},
    };
    static const struct snd_soc_dapm_route sof_es8316_headset_mic1_map[] = {
    {"MIC2", core::ptr::null_mut(), "Internal Mic"},
...
unsafe extern "C" fn sof_es8316_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    snd_soc_component_set_jack(codec, &priv.jack, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
