...
//! Source: sound/soc/intel/boards/cht_bsw_max98090_ti.c
#![no_std]
...
pub const QUIRK_PMC_PLT_CLK_0: c_uint = 0x01;
#[repr(C)]
#[derive(Copy, Clone)]
...
// See the comment in snd_cht_mc_probe()
    ...
    {"Ext Spk", core::ptr::null_mut(), "SPKL"},
    {"Ext Spk", core::ptr::null_mut(), "SPKR"},
    {"HiFi Playback", core::ptr::null_mut(), "ssp2 Tx"},
    ...
    {"ssp2 Rx", core::ptr::null_mut(), "HiFi Capture"},
    ...
    let mut hp_gpios: static struct acpi_gpio_params = { 0, 0, false };
    let mut mic_gpios: static struct acpi_gpio_params = { 1, 0, false };
...
// no need probe TI jack detection chip
    snd_soc_card_cht.aux_dev = core::ptr::null_mut();
