...
//! Source: sound/soc/intel/boards/cht_bsw_rt5672.c
#![no_std]
...
pub struct cht_mc_private {
    pub headset: snd_soc_jack,
    pub codec_name: [c_char; SND_ACPI_I2C_ID_LEN],
    pub mclk: *mut clk,
    pub use_ssp0: bool,
}
...
//
    ...
    {"Ext Spk", core::ptr::null_mut(), "SPOLP"},
    {"Ext Spk", core::ptr::null_mut(), "SPOLN"},
    {"Ext Spk", core::ptr::null_mut(), "SPORP"},
    {"Ext Spk", core::ptr::null_mut(), "SPORN"},
...
// set codec sysclk source to PLL
    ...
    let mut headset_gpios: static struct acpi_gpio_params = { 0, 0, false };
