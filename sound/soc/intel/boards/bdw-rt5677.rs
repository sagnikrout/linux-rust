...
//! Source: sound/soc/intel/boards/bdw-rt5677.c
#![no_std]
...
pub struct bdw_rt5677_priv {
    ...
    SND_SOC_DAPM_MIC("Local DMICs", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("Remote DMICs", core::ptr::null_mut()),
    };
    static const struct snd_soc_dapm_route bdw_rt5677_map[] = {
// Speakers
    {"Speaker", core::ptr::null_mut(), "PDM1L"},
    {"Speaker", core::ptr::null_mut(), "PDM1R"},
// Headset jack connectors
    {"Headphone", core::ptr::null_mut(), "LOUT1"},
    {"Headphone", core::ptr::null_mut(), "LOUT2"},
...
//
    {"DMIC L1", core::ptr::null_mut(), "Remote DMICs"},
    {"DMIC R1", core::ptr::null_mut(), "Remote DMICs"},
    {"DMIC L2", core::ptr::null_mut(), "Local DMICs"},
    {"DMIC R2", core::ptr::null_mut(), "Local DMICs"},
// CODEC BE connections
    {"SSP0 CODEC IN", core::ptr::null_mut(), "AIF1 Capture"},
    {"AIF1 Playback", core::ptr::null_mut(), "SSP0 CODEC OUT"},
    {"DSP Capture", core::ptr::null_mut(), "DSP Buffer"},
// DSP Clock Connections
    { "DSP Buffer", core::ptr::null_mut(), "SSP0 CODEC IN" },
    { "SSP0 CODEC IN", core::ptr::null_mut(), "DSPTX" },
    };
...
// GPIO indexes defined by ACPI
    ...
    let mut plug_det_gpio: static struct acpi_gpio_params = { RT5677_GPIO_PLUG_DET, 0, false };
    let mut mic_present_gpio: static struct acpi_gpio_params = { RT5677_GPIO_MIC_PRESENT_L, 0, false };
    let mut headphone_enable_gpio: static struct acpi_gpio_params = { RT5677_GPIO_HP_AMP_SHDN_L, 0, false };
