...
//! Source: sound/soc/intel/boards/bytcr_wm5102.c
#![no_std]
...
pub struct byt_wm5102_private {
    ...
    pub mclk: *mut clk,
    pub spkvdd_en_gpio: *mut gpio_desc,
    pub mclk_freq: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn byt_wm5102_prepare_and_enable_pll1(codec_dai: *mut snd_soc_dai, rate: c_int) -> c_int {
...
//
    ...
    {"Speaker", core::ptr::null_mut(), "Speaker VDD"},
    {"Headphone", core::ptr::null_mut(), "HPOUT1L"},
    {"Headphone", core::ptr::null_mut(), "HPOUT1R"},
//
...
//
    ...
    {"Headset Mic", core::ptr::null_mut(), "MICBIAS2"},
    {"Internal Mic", core::ptr::null_mut(), "MICBIAS3"},
    };
    ...
    {"Speaker", core::ptr::null_mut(), "SPKOUTLP"},
    {"Speaker", core::ptr::null_mut(), "SPKOUTLN"},
    {"Speaker", core::ptr::null_mut(), "SPKOUTRP"},
    {"Speaker", core::ptr::null_mut(), "SPKOUTRN"},
    };
    static const struct snd_soc_dapm_route byt_wm5102_spk_hpout2_map[] = {
    {"Speaker", core::ptr::null_mut(), "HPOUT2L"},
    {"Speaker", core::ptr::null_mut(), "HPOUT2R"},
    };
    static const struct snd_soc_dapm_route byt_wm5102_intmic_in3l_hsmic_in1l_map[] = {
    {"IN3L", core::ptr::null_mut(), "Internal Mic"},
    {"IN1L", core::ptr::null_mut(), "Headset Mic"},
    };
    static const struct snd_soc_dapm_route byt_wm5102_intmic_in1l_hsmic_in2l_map[] = {
    {"IN1L", core::ptr::null_mut(), "Internal Mic"},
    {"IN2L", core::ptr::null_mut(), "Headset Mic"},
    };
...
//
    ...
    snd_soc_component_set_jack(component, &priv.jack, core::ptr::null_mut());
    return 0;
    }
...
// Special case for when the codec is missing from the DSTD
    ...
    codec_dev = bus_find_device_by_name(&spi_bus_type, core::ptr::null_mut(), codec_name);
    if (!codec_dev)
    return -EPROBE_DEFER;
