...
//! Source: sound/soc/intel/boards/bytcht_es8316.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct byt_cht_es8316_private {
    pub mclk: *mut clk,
    pub jack: snd_soc_jack,
    pub speaker_en_gpio: *mut gpio_desc,
    pub codec_dev: *mut device,
    pub speaker_en: bool,
    pub mclk_enabled: bool,
}
...
#[no_mangle]
unsafe extern "C" fn byt_cht_es8316_disable_mclk(priv: *mut byt_cht_es8316_private) {
