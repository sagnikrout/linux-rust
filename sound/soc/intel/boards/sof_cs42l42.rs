...
//! Source: sound/soc/intel/boards/sof_cs42l42.c
#![no_std]
...
// Default: SSP2
    let mut sof_cs42l42_quirk: static unsigned long = SOF_SSP_PORT_CODEC(2);
#[no_mangle]
...
// HP jack connectors - unknown if we have jack detection
    {"Headphone Jack", core::ptr::null_mut(), "HP"},
// other jacks
    {"HS", core::ptr::null_mut(), "Headset Mic"},
    };
