...
//! Source: sound/soc/intel/boards/bdw_rt286.c
#![no_std]
...
//
    ...
    SND_SOC_DAPM_MIC("DMIC1", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("DMIC2", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("Line Jack", core::ptr::null_mut()),
    };
    static const struct snd_soc_dapm_route card_routes[] = {
    {"Speaker", core::ptr::null_mut(), "SPOR"},
    {"Speaker", core::ptr::null_mut(), "SPOL"},
    {"Headphone Jack", core::ptr::null_mut(), "HPO Pin"},
    {"MIC1", core::ptr::null_mut(), "Mic Jack"},
    {"LINE1", core::ptr::null_mut(), "Line Jack"},
    {"DMIC1 Pin", core::ptr::null_mut(), "DMIC1"},
    {"DMIC2 Pin", core::ptr::null_mut(), "DMIC2"},
...
unsafe extern "C" fn codec_link_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    if (ret)
    return ret;
    return snd_soc_component_set_jack(codec, &card_headset, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn codec_link_exit(rtd: *mut snd_soc_pcm_runtime) {
    ...
    {
    struct snd_soc_component *codec = snd_soc_rtd_to_codec(rtd, 0).component;
    snd_soc_component_set_jack(codec, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
unsafe extern "C" fn card_resume_post(card: *mut snd_soc_card) -> c_int {
    ...
    if (!codec_dai)
    return 0;
    return snd_soc_component_set_jack(codec_dai.component, &card_headset, core::ptr::null_mut());
    }
