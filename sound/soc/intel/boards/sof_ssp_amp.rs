...
//! Source: sound/soc/intel/boards/sof_ssp_amp.c
#![no_std]
...
// Default: SSP2
    let mut sof_ssp_amp_quirk: static unsigned long = SOF_SSP_PORT_AMP(2);
...
pub const HDMI_IN_BE_ID: c_int = 0;
pub const SPK_BE_ID: c_int = 2;
pub const DMIC01_BE_ID: c_int = 3;
pub const INTEL_HDMI_BE_ID: c_int = 5;
// extra BE links to support no-hdmi-in boards
pub const DMIC16K_BE_ID: c_int = 4;
