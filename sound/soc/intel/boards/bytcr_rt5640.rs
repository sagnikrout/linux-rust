...
//! Source: sound/soc/intel/boards/bytcr_rt5640.c
#![no_std]
...
pub const RT5640_JD_SRC_EXT_GPIO: c_uint = 0x0f;
    enum {
...
pub const MAX_NO_PROPS: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct byt_rt5640_private {
    pub jack: snd_soc_jack,
    pub jack2: snd_soc_jack,
    pub jack_data: rt5640_set_jack_data,
    pub hsmic_detect: *mut gpio_desc,
    pub mclk: *mut clk,
    pub codec_dev: *mut device,
}

    static bool is_bytcr;
    let mut byt_rt5640_quirk: static unsigned long = BYT_RT5640_MCLK_EN;
...
unsafe extern "C" fn log_quirks(dev: *mut device) {
    ...
    {
    int map;
    let mut has_mclk: bool = false;
    let mut has_ssp0: bool = false;
    let mut has_ssp0_aif1: bool = false;
    let mut has_ssp0_aif2: bool = false;
    let mut has_ssp2_aif2: bool = false;
...
//
    ...
    struct snd_kcontrol *k, int event)
    {
    let mut gpio_ctrl3_val: c_uint = RT5640_GP1_PF_OUT;
    struct snd_soc_dai *codec_dai;
    if (!(byt_rt5640_quirk & BYT_RT5640_LINEOUT_AS_HP2))
    return 0;
//
...
//
    ...
    SND_SOC_DAPM_MIC("Headset Mic 2", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("Internal Mic", core::ptr::null_mut()),
    ...
    {"IN2P", core::ptr::null_mut(), "Headset Mic"},
    {"Headphone", core::ptr::null_mut(), "HPOL"},
    {"Headphone", core::ptr::null_mut(), "HPOR"},
    };
    static const struct snd_soc_dapm_route byt_rt5640_intmic_dmic1_map[] = {
    {"Internal Mic", core::ptr::null_mut(), "Platform Clock"},
    {"DMIC1", core::ptr::null_mut(), "Internal Mic"},
    };
    static const struct snd_soc_dapm_route byt_rt5640_intmic_dmic2_map[] = {
    {"Internal Mic", core::ptr::null_mut(), "Platform Clock"},
    {"DMIC2", core::ptr::null_mut(), "Internal Mic"},
    };
    static const struct snd_soc_dapm_route byt_rt5640_intmic_in1_map[] = {
    {"Internal Mic", core::ptr::null_mut(), "Platform Clock"},
    {"Internal Mic", core::ptr::null_mut(), "MICBIAS1"},
    {"IN1P", core::ptr::null_mut(), "Internal Mic"},
    };
    static const struct snd_soc_dapm_route byt_rt5640_intmic_in3_map[] = {
    {"Internal Mic", core::ptr::null_mut(), "Platform Clock"},
    {"Internal Mic", core::ptr::null_mut(), "MICBIAS1"},
    {"IN3P", core::ptr::null_mut(), "Internal Mic"},
    };
    static const struct snd_soc_dapm_route byt_rt5640_hsmic2_in1_map[] = {
    {"Headset Mic 2", core::ptr::null_mut(), "Platform Clock"},
    {"Headset Mic 2", core::ptr::null_mut(), "MICBIAS1"},
    {"IN1P", core::ptr::null_mut(), "Headset Mic 2"},
    };
    ...
    {"Speaker", core::ptr::null_mut(), "Platform Clock"},
    {"Speaker", core::ptr::null_mut(), "SPOLP"},
    {"Speaker", core::ptr::null_mut(), "SPOLN"},
    {"Speaker", core::ptr::null_mut(), "SPORP"},
    {"Speaker", core::ptr::null_mut(), "SPORN"},
    };
    ...
    {"Line Out", core::ptr::null_mut(), "Platform Clock"},
...
// The 2nd headset jack uses lineout with an external HP-amp
    ...
    let mut acpi_gpio0: static struct acpi_gpio_params = { 0, 0, false };
    let mut acpi_gpio1: static struct acpi_gpio_params = { 1, 0, false };
    let mut acpi_gpio2: static struct acpi_gpio_params = { 2, 0, false };
...
#[no_mangle]
unsafe extern "C" fn byt_rt5640_hp_elitepad_1000g2_jack1_check(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5640_hp_elitepad_1000g2_jack2_check(data: *mut c_void) -> c_int {
...
// Some Android devs specify IRQs/GPIOS in a special AMCR0F28 ACPI device
    let mut amcr0f28_jd_gpio: static struct acpi_gpio_params = { 1, 0, false };
    static const struct acpi_gpio_mapping amcr0f28_gpios[] = {
    { "rt5640-jd-gpios", &amcr0f28_jd_gpio, 1 },
    { }
    };
#[no_mangle]
unsafe extern "C" fn byt_rt5640_get_amcr0f28_settings(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5640_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    const struct snd_soc_dapm_route *custom_map = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn byt_rt5640_exit(runtime: *mut snd_soc_pcm_runtime) {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5640_aif1_startup(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5640_suspend(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5640_resume(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_byt_rt5640_mc_probe(pdev: *mut platform_device) -> c_int {
...
// to a broken DSDT.
//
    codec_dev = bus_find_device_by_name(&i2c_bus_type, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn snd_byt_rt5640_mc_remove(pdev: *mut platform_device) {
