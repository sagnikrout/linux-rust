...
//! Source: sound/soc/intel/boards/bytcht_cx2072x.c
#![no_std]
...
// External Speakers: HFL, HFR
    {"Headphone", core::ptr::null_mut(), "PORTA"},
    {"Ext Spk", core::ptr::null_mut(), "PORTG"},
    {"PORTC", core::ptr::null_mut(), "Int Mic"},
    {"PORTD", core::ptr::null_mut(), "Headset Mic"},
...
// set the default PLL rate, the clock is handled by the codec driver
    ...
    if (ret)
    return ret;
    snd_soc_component_set_jack(codec, &byt_cht_cx2072x_headset, core::ptr::null_mut());
