...
//! Source: sound/soc/intel/boards/bdw-rt5650.c
#![no_std]
...
pub struct bdw_rt5650_priv {
    ...
    SND_SOC_DAPM_MIC("DMIC Pair1", core::ptr::null_mut()),
    SND_SOC_DAPM_MIC("DMIC Pair2", core::ptr::null_mut()),
    };
...
//
    {"DMIC L1", core::ptr::null_mut(), "DMIC Pair1"},
    {"DMIC R1", core::ptr::null_mut(), "DMIC Pair1"},
    {"DMIC L2", core::ptr::null_mut(), "DMIC Pair2"},
    {"DMIC R2", core::ptr::null_mut(), "DMIC Pair2"},
...
// Create and initialize mic jack
    ...
    rt5645_set_jack_detect(component, &headphone_jack, &mic_jack, core::ptr::null_mut());
