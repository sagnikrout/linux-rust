...
//! Source: sound/soc/intel/boards/bytcr_rt5651.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct byt_rt5651_private {
    pub mclk: *mut clk,
    pub ext_amp_gpio: *mut gpio_desc,
    pub hp_detect: *mut gpio_desc,
...
//
    ...
    {"Speaker", core::ptr::null_mut(), "Ext Amp Power"},
    {"Line In", core::ptr::null_mut(), "Platform Clock"},
    {"Headset Mic", core::ptr::null_mut(), "micbias1"}, /* lowercase for rt5651 */
    {"Headphone", core::ptr::null_mut(), "HPOL"},
    {"Headphone", core::ptr::null_mut(), "HPOR"},
    {"Speaker", core::ptr::null_mut(), "LOUTL"},
    {"Speaker", core::ptr::null_mut(), "LOUTR"},
    {"IN2P", core::ptr::null_mut(), "Line In"},
    {"IN2N", core::ptr::null_mut(), "Line In"},
    };
    static const struct snd_soc_dapm_route byt_rt5651_intmic_dmic_map[] = {
    {"DMIC L1", core::ptr::null_mut(), "Internal Mic"},
    {"DMIC R1", core::ptr::null_mut(), "Internal Mic"},
    {"IN2P", core::ptr::null_mut(), "Headset Mic"},
    };
    static const struct snd_soc_dapm_route byt_rt5651_intmic_in1_map[] = {
    {"Internal Mic", core::ptr::null_mut(), "micbias1"},
    {"IN1P", core::ptr::null_mut(), "Internal Mic"},
    {"IN3P", core::ptr::null_mut(), "Headset Mic"},
    };
    static const struct snd_soc_dapm_route byt_rt5651_intmic_in2_map[] = {
    {"Internal Mic", core::ptr::null_mut(), "micbias1"},
    {"IN2P", core::ptr::null_mut(), "Internal Mic"},
    {"IN3P", core::ptr::null_mut(), "Headset Mic"},
    };
    ...
    let mut pov_p1006w_hp_detect: static struct acpi_gpio_params = { 1, 0, false };
    let mut pov_p1006w_ext_amp_en: static struct acpi_gpio_params = { 2, 0, true };
...
#[no_mangle]
unsafe extern "C" fn byt_rt5651_pov_p1006w_quirk_cb(id: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5651_quirk_cb(id: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5651_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->hp_detect) -> else {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5651_aif1_startup(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5651_suspend(card: *mut snd_soc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn byt_rt5651_resume(card: *mut snd_soc_card) -> c_int {
...
// use space before codec name to simplify card ID, and simplify driver name
    ...
    let mut ext_amp_enable_gpios: static struct acpi_gpio_params = { 0, 0, false };
...
#[no_mangle]
unsafe extern "C" fn snd_byt_rt5651_mc_probe(pdev: *mut platform_device) -> c_int {
...
// Cherry Trail devices use an external amplifier enable gpio
    ...
    switch (ret_val) {
    case -ENOENT:
    priv.ext_amp_gpio = core::ptr::null_mut();
    break;
    default:
    ...
    switch (ret_val) {
    case -ENOENT:
    priv.hp_detect = core::ptr::null_mut();
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn snd_byt_rt5651_mc_remove(pdev: *mut platform_device) {
