...
//! Source: sound/soc/mxs/mxs-sgtl5000.c
#![no_std]
...
// The SAIF MCLK should be the same as SGTL5000_SYSCLK
    ...
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "sgtl5000")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    ...
    SND_SOC_DAPM_SPK("Line Out Jack", core::ptr::null_mut()),
...
unsafe extern "C" fn mxs_sgtl5000_probe(pdev: *mut platform_device) -> c_int {
    ...
    for (i = 0; i < 2; i++) {
    mxs_sgtl5000_dai[i].codecs.name = core::ptr::null_mut();
    mxs_sgtl5000_dai[i].codecs.of_node = codec_np;
    mxs_sgtl5000_dai[i].cpus.dai_name = core::ptr::null_mut();
    mxs_sgtl5000_dai[i].cpus.of_node = saif_np[i];
    mxs_sgtl5000_dai[i].platforms.name = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mxs_sgtl5000_remove(pdev: *mut platform_device) {
