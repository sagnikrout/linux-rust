...
//! Source: sound/soc/soc-component.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn _soc_component_ret(component: *mut snd_soc_component, func: *const c_char, ret: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_set_name(component: *mut snd_soc_component, name: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_set_priv(component: *mut snd_soc_component, priv: *mut c_void) {
...
//
    ...
    {
    component.init = (aux) ? aux.init : core::ptr::null_mut();
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_suspend(component: *mut snd_soc_component) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_resume(component: *mut snd_soc_component) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_is_suspended(component: *mut snd_soc_component) -> c_int {
    int snd_soc_component_is_suspended(struct snd_soc_component *component)
    {
    return component.suspended;
    }
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_fixup_controls(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_remove(component: *mut snd_soc_component) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_exit_regmap(component: *mut snd_soc_component) {
    void snd_soc_component_exit_regmap(struct snd_soc_component *component)
    {
    regmap_exit(component.regmap);
    component.regmap = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_compr_ack(cstream: *mut snd_compr_stream, bytes: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: component->driver->read) -> else {
    ret = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: component->driver->write) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_soc_component_async_complete(component: *mut snd_soc_component) {
...
// remove marked substream
    ...
    int i;
    for_each_rtd_components(rtd, i, component) {
    let mut ret: c_int = pm_runtime_get_sync(component.dev);
    if (ret < 0 && ret != -EACCES) {
