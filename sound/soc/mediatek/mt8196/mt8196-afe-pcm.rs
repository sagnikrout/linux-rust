...
//! Source: sound/soc/mediatek/mt8196/mt8196-afe-pcm.c
#![no_std]
...
// not support 260K
    ...
    let mut rate: c_uint = afe_priv.cm_rate[id];
    let mut rate_val: c_uint = mt8196_rate_transform(afe.dev, rate);
    let mut ch_pair: c_uint = ch / 2;
    unsigned int update_val;
    let mut reg: c_int = AFE_CM0_CON0 + 0x10 * id;
    if (update && ch_pair)
...
unsafe extern "C" fn mt8196_enable_cm_bypass(afe: *mut mtk_base_afe, id: c_int, en: bool) -> c_int {
    ...
    let mut memif_num: c_int = cpu_dai.id;
...
// dynamic allocate irq to memif
    ...
    let mut irq_id: c_int = mtk_dynamic_irq_acquire(afe);
...
// link
    ...
    let mut memif_num: c_int = cpu_dai.id;
    struct mtk_base_afe_memif *memif = &afe.memif[memif_num];
    let mut irq_id: c_int = memif.irq_usage;
    dev_dbg(afe.dev, "memif_num: %d.\n", memif_num);
    ...
    struct mt8196_afe_private *afe_priv = afe.platform_priv;
    let mut id: c_int = snd_soc_rtd_to_cpu(rtd, 0).id;
...
// set channels
    ...
    {
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd(substream);
    let mut runtime: *mut snd_pcm_runtime const = substream.runtime;
    struct mtk_base_afe *afe = snd_soc_dai_get_drvdata(dai);
    let mut id: c_int = snd_soc_rtd_to_cpu(rtd, 0).id;
    struct mtk_base_afe_memif *memif = &afe.memif[id];
    let mut irq_id: c_int = memif.irq_usage;
    ...
    let mut counter: c_uint = runtime.period_size;
    let mut rate: c_uint = runtime.rate;
...
// Capture
    ...
    struct mt8196_afe_private *afe_priv = afe.platform_priv;
    let mut channels: c_uint = afe_priv.cm_channels;
...
// Normal record
    ...
    {"UL_CM0", core::ptr::null_mut(), "CM0_Enable"},
// UL9
    {"UL9", core::ptr::null_mut(), "CM1_UL_MUX"},
    ...
    {"UL_CM1", core::ptr::null_mut(), "CM1_Enable"},
    {"UL9_CH1", "ADDA_UL_CH1", "ADDA_UL_Mux"},
    {"UL9_CH2", "ADDA_UL_CH2", "ADDA_UL_Mux"},
    {"UL10", core::ptr::null_mut(), "CM2_UL_MUX"},
    ...
    {"UL_CM2", core::ptr::null_mut(), "CM2_Enable"},
    {"UL10_CH1", "ADDA_UL_CH1", "ADDA_UL_Mux"},
    {"UL10_CH2", "ADDA_UL_CH2", "ADDA_UL_Mux"},
    {"UL24", core::ptr::null_mut(), "UL24_CH1"},
    {"UL24", core::ptr::null_mut(), "UL24_CH2"},
    {"UL24_CH1", "I2SIN6_CH1", "I2SIN6"},
    {"UL24_CH2", "I2SIN6_CH2", "I2SIN6"},
    {"UL24_CH1", "I2SIN0_CH1", "I2SIN0"},
    {"UL24_CH2", "I2SIN0_CH2", "I2SIN0"},
    {"UL25", core::ptr::null_mut(), "UL25_CH1"},
    {"UL25", core::ptr::null_mut(), "UL25_CH2"},
    {"UL25_CH1", "I2SIN6_CH1", "I2SIN6"},
    {"UL25_CH2", "I2SIN6_CH2", "I2SIN6"},
    {"UL25_CH1", "I2SIN0_CH1", "I2SIN0"},
    {"UL25_CH2", "I2SIN0_CH2", "I2SIN0"},
    {"UL26", core::ptr::null_mut(), "UL26_CH1"},
    {"UL26", core::ptr::null_mut(), "UL26_CH2"},
    {"UL26_CH1", "I2SIN6_CH1", "I2SIN6"},
    {"UL26_CH2", "I2SIN6_CH2", "I2SIN6"},
    {"UL26_CH1", "I2SIN0_CH1", "I2SIN0"},
    {"UL26_CH2", "I2SIN0_CH2", "I2SIN0"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH1"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH2"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH3"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH4"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH5"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH6"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH7"},
    {"UL_CM0", core::ptr::null_mut(), "UL_CM0_CH8"},
    ...
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH1"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH2"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH3"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH4"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH5"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH6"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH7"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH8"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH9"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH10"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH11"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH12"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH13"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH14"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH15"},
    {"UL_CM1", core::ptr::null_mut(), "UL_CM1_CH16"},
    ...
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH1"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH2"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH3"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH4"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH5"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH6"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH7"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH8"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH9"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH10"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH11"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH12"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH13"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH14"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH15"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH16"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH17"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH18"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH19"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH20"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH21"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH22"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH23"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH24"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH25"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH26"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH27"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH28"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH29"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH30"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH31"},
    {"UL_CM2", core::ptr::null_mut(), "UL_CM2_CH32"},
...
// Audio Pin
    {"I2SOUT4", core::ptr::null_mut(), "I2S4_PIN"},
    {"I2SIN4", core::ptr::null_mut(), "I2S4_PIN"},
    {"I2SOUT6", core::ptr::null_mut(), "I2S6_PIN"},
    {"I2SIN6", core::ptr::null_mut(), "I2S6_PIN"},
    {"I2SOUT3", core::ptr::null_mut(), "I2S3_PIN"},
    {"I2SIN3", core::ptr::null_mut(), "I2S3_PIN"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC0_PIN"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC1_PIN"},
    };
...
#[no_mangle]
unsafe extern "C" fn mt8196_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8196_afe_irq_handler(irq_id: c_int, dev: *mut c_void) -> irqreturn_t {
...
// one interrupt period = 5ms
    let mut timeout_limit: u64 = 5000000;
...
#[no_mangle]
unsafe extern "C" fn mt8196_afe_pcm_free(component: *mut snd_soc_component, pcm: *mut snd_pcm) {
...
// disable afe clock
    ...
    mt8196_afe_runtime_resume, core::ptr::null_mut())
    };
