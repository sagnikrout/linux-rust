...
//! Source: sound/soc/mediatek/mt8196/mt8196-dai-i2s.c
#![no_std]
...
pub const ETDM_22M_CLOCK_THRES: c_int = 11289600;
    enum {
...
#[no_mangle]
unsafe extern "C" fn get_etdm_wlen(format: snd_pcm_format_t) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_etdm_lrck_width(format: snd_pcm_format_t) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_etdm_rate(rate: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_etdm_inconn_rate(rate: c_uint) -> c_uint {
...
pub struct mtk_afe_i2s_priv {
    pub id: u8,
    pub /: *mut *mut u32 rate; / for determine which apll to use,
    pub low_jitter_en: c_int,
    pub share_property_name: *const c_char,
...
#[no_mangle]
unsafe extern "C" fn is_etdm_in_pad_top(dai_num: c_uint) -> bool {
...
pub struct mtk_base_etdm_data {
    ...
    pub ch_shift: u8,
    pub ip_mode_reg: u16,
    pub ip_mode_mask: u16,
    pub ip_mode_shift: u8,
    pub init_count_reg: u16,
    pub init_count_mask: u16,
    pub init_count_shift: u8,
    pub init_point_reg: u16,
    pub init_point_mask: u16,
    pub init_point_shift: u8,
    pub lrck_reset_reg: u16,
    pub lrck_reset_mask: u16,
    pub lrck_reset_shift: u8,
    pub clk_source_reg: u16,
    pub clk_source_mask: u16,
    pub clk_source_shift: u8,
    pub ck_en_sel_reg: u16,
    pub ck_en_sel_mask: u16,
    pub ck_en_sel_shift: u8,
    pub fs_timing_reg: u16,
    pub fs_timing_mask: u16,
    pub fs_timing_shift: u8,
    pub relatch_en_sel_reg: u16,
    pub relatch_en_sel_mask: u16,
    pub relatch_en_sel_shift: u8,
    pub use_afifo_reg: u16,
    pub use_afifo_mask: u16,
    pub use_afifo_shift: u8,
    pub afifo_mode_reg: u16,
    pub afifo_mode_mask: u16,
    pub afifo_mode_shift: u8,
    pub almost_end_ch_reg: u16,
    pub almost_end_ch_mask: u16,
    pub almost_end_ch_shift: u8,
    pub almost_end_bit_reg: u16,
    pub almost_end_bit_mask: u16,
    pub almost_end_bit_shift: u8,
    pub out2latch_time_reg: u16,
    pub out2latch_time_mask: u16,
    pub out2latch_time_shift: u8,
    pub tdm_mode_reg: u16,
    pub tdm_mode_mask: u16,
    pub tdm_mode_shift: u8,
    pub relatch_domain_sel_reg: u16,
    pub relatch_domain_sel_mask: u16,
    pub relatch_domain_sel_shift: u8,
    pub bit_length_reg: u16,
    pub bit_length_mask: u16,
    pub bit_length_shift: u8,
    pub word_length_reg: u16,
    pub word_length_mask: u16,
    pub word_length_shift: u8,
    pub cowork_reg: u16,
    pub cowork_mask: u16,
    pub cowork_shift: u8,
    pub cowork_val: u32,
    pub in2latch_time_reg: u16,
    pub in2latch_time_mask: u16,
    pub in2latch_time_shift: u8,
    pub pad_top_ck_en_reg: u16,
    pub pad_top_ck_en_mask: u16,
    pub pad_top_ck_en_shift: u8,
    pub master_latch_reg: u16,
    pub master_latch_mask: u16,
    pub master_latch_shift: u8,
}
...
#[no_mangle]
unsafe extern "C" fn get_i2s_wlen(format: snd_pcm_format_t) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SIN1", 0: 6) ==) -> else {
    else if (strncmp(name, "I2SIN1", 6) == 0)
    return MT8196_DAI_I2S_IN1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SIN2", 0: 6) ==) -> else {
    else if (strncmp(name, "I2SIN2", 6) == 0)
    return MT8196_DAI_I2S_IN2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SIN3", 0: 6) ==) -> else {
    else if (strncmp(name, "I2SIN3", 6) == 0)
    return MT8196_DAI_I2S_IN3;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SIN4", 0: 6) ==) -> else {
    else if (strncmp(name, "I2SIN4", 6) == 0)
    return MT8196_DAI_I2S_IN4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SIN6", 0: 6) ==) -> else {
    else if (strncmp(name, "I2SIN6", 6) == 0)
    return MT8196_DAI_I2S_IN6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SOUT0", 0: 7) ==) -> else {
    else if (strncmp(name, "I2SOUT0", 7) == 0)
    return MT8196_DAI_I2S_OUT0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SOUT1", 0: 7) ==) -> else {
    else if (strncmp(name, "I2SOUT1", 7) == 0)
    return MT8196_DAI_I2S_OUT1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SOUT2", 0: 7) ==) -> else {
    else if (strncmp(name, "I2SOUT2", 7) == 0)
    return MT8196_DAI_I2S_OUT2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SOUT3", 0: 7) ==) -> else {
    else if (strncmp(name, "I2SOUT3", 7) == 0)
    return MT8196_DAI_I2S_OUT3;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SOUT4", 0: 7) ==) -> else {
    else if (strncmp(name, "I2SOUT4", 7) == 0)
    return MT8196_DAI_I2S_OUT4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2SOUT6", 0: 7) ==) -> else {
    else if (strncmp(name, "I2SOUT6", 7) == 0)
    return MT8196_DAI_I2S_OUT6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "FMI2S_MASTER", 0: 12) ==) -> else {
    ...
    let mut dai_id: c_int = get_i2s_id_by_name(afe, name);
    if (dai_id < 0)
...
// apll
    ...
    mtk_apll_event,
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_MIXER("SOF_DMA_DL_24CH", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("SOF_DMA_DL1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    };
...
// choose APLL from i2s rate
    ...
    let mut needed_apll: return = = cur_apll;
    }
...
// i2sin0
    {"I2SIN0", core::ptr::null_mut(), "I2SIN0_EN"},
    {"I2SIN0", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SIN0", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN0", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN0", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SIN0_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SIN0_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SIN0", core::ptr::null_mut(), "I2SIN0_CG"},
// i2sin1
    {"I2SIN1", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SIN1_EN"},
    {"I2SIN1", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SIN1", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN1", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN1", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SIN1_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SIN1_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SIN1", core::ptr::null_mut(), "I2SIN1_CG"},
// i2sin2
    {"I2SIN2", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SIN2_EN"},
    {"I2SIN2", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SIN2", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN2", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN2", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SIN2_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SIN2_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SIN2", core::ptr::null_mut(), "I2SIN2_CG"},
// i2sin3
    {"I2SIN3", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SIN3_EN"},
    {"I2SIN3", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SIN3", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN3", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN3", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SIN3_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SIN3_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SIN3", core::ptr::null_mut(), "I2SIN3_CG"},
// i2sin4
    {"I2SIN4", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SIN4_EN"},
    {"I2SIN4", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SIN4", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN4", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN4", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SIN4_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SIN4_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SIN4", core::ptr::null_mut(), "I2SIN4_CG"},
// i2sin6
    {"I2SIN6", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SIN6_EN"},
    {"I2SIN6", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SIN6", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN6", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SIN6", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SIN6_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SIN6_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SIN6", core::ptr::null_mut(), "I2SIN6_CG"},
    {"I2SIN6", core::ptr::null_mut(), "I2SOUT6_CG"},
// i2sout0
    ...
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT0_CH1"},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT0_CH2"},
    {"I2SOUT0", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT0_EN"},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT0", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT0", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT0", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SOUT0_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SOUT0_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SOUT0", core::ptr::null_mut(), "I2SOUT0_CG"},
    {"I2SOUT0", core::ptr::null_mut(), "I2SIN0_CG"},
// i2sout1
    ...
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT1_CH1"},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT1_CH2"},
    {"I2SOUT1", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT1_EN"},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT1", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT1", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT1", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SOUT1_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SOUT1_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SOUT1", core::ptr::null_mut(), "I2SOUT1_CG"},
    {"I2SOUT1", core::ptr::null_mut(), "I2SIN1_CG"},
// i2sout2
    ...
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT2_CH1"},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT2_CH2"},
    {"I2SOUT2", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT2_EN"},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT2", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT2", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT2", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SOUT2_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SOUT2_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SOUT2", core::ptr::null_mut(), "I2SOUT2_CG"},
    {"I2SOUT2", core::ptr::null_mut(), "I2SIN2_CG"},
// i2sout3
    ...
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT3_CH1"},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT3_CH2"},
    {"I2SOUT3", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT3_EN"},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT3", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT3", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT3", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SOUT3_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SOUT3_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"I2SOUT3", core::ptr::null_mut(), "I2SOUT3_CG"},
    {"I2SOUT3", core::ptr::null_mut(), "I2SIN3_CG"},
// i2sout4
...
// SOF Downlink
    ...
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH1"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH2"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH3"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH4"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH5"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH6"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH7"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CH8"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_EN"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT4", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT4", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT4", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SOUT4_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SOUT4_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// CG
    {"I2SOUT4", core::ptr::null_mut(), "I2SOUT4_CG"},
    {"I2SOUT4", core::ptr::null_mut(), "I2SIN4_CG"},
// i2sout6
...
// SOF Downlink
    ...
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT6_CH1"},
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT6_CH2"},
    {"I2SOUT6", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT6_EN"},
    {"I2SOUT6", core::ptr::null_mut(), "FMI2S_MASTER_EN", mtk_afe_i2s_share_connect},
    {"I2SOUT6", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT6", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2SOUT6", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2SOUT6_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2SOUT6_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// CG
    {"I2SOUT6", core::ptr::null_mut(), "I2SOUT6_CG"},
    {"I2SOUT6", core::ptr::null_mut(), "I2SIN6_CG"},
// fmi2s
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SIN0_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SIN1_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SIN2_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SIN3_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SIN4_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SIN6_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SOUT0_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SOUT1_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SOUT2_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SOUT3_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SOUT4_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "I2SOUT6_EN", mtk_afe_i2s_share_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), "FMI2S_MASTER_EN"},
    {"FMI2S_MASTER", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SIN0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SIN1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SIN2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SIN3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SIN4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SIN6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SOUT0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SOUT1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SOUT2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SOUT3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SOUT4_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), I2SOUT6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"FMI2S_MASTER", core::ptr::null_mut(), FMI2S_MASTER_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {FMI2S_MASTER_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {FMI2S_MASTER_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// CG
    {"FMI2S_MASTER", core::ptr::null_mut(), "FMI2S_MASTER_CG"},
    };
// i2s dai ops
    ...
    struct mt8196_afe_private *afe_priv = afe.platform_priv;
    struct mtk_afe_i2s_priv *i2s_priv;
    struct mtk_afe_i2s_priv *i2sin_priv = core::ptr::null_mut();
    let mut id: c_int = i2s_id - MT8196_DAI_I2S_IN0;
    struct mtk_base_etdm_data etdm_data;
    let mut rate: c_uint = params_rate(params);
    let mut rate_reg: c_uint = get_etdm_inconn_rate(rate);
...
#[no_mangle]
unsafe extern "C" fn mt8196_dai_i2s_get_share(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_i2s_priv_data(afe: *mut mtk_base_afe) -> c_int {
    static int init_i2s_priv_data(struct mtk_base_afe *afe)
    {
    struct mt8196_afe_private *afe_priv = afe.platform_priv;
    struct mtk_afe_i2s_priv *i2s_priv;
    for (int i = 0; i < DAI_I2S_NUM; i++) {
    let mut id: c_int = mt8196_i2s_priv[i].id;
    let mut size: usize = sizeof(struct mtk_afe_i2s_priv);
...
#[no_mangle]
pub unsafe extern "C" fn mt8196_dai_i2s_register(afe: *mut mtk_base_afe) -> c_int {
