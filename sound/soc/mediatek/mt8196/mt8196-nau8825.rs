...
//! Source: sound/soc/mediatek/mt8196/mt8196-nau8825.c
#![no_std]
...
// SOF Uplink
    SND_SOC_DAPM_MIXER("SOF_DMA_UL0", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
...
// SOF Uplink
    {"SOF_DMA_UL0", core::ptr::null_mut(), "UL0_CH1"},
    {"SOF_DMA_UL0", core::ptr::null_mut(), "UL0_CH2"},
// SOF Uplink
...
#[no_mangle]
unsafe extern "C" fn mt8196_nau8825_soc_card_probe(soc_card_data: *mut mtk_soc_card_data, legacy: bool) -> c_int {
    ...
    let mut init_rt5650: bool = false;
