...
//! Source: sound/soc/mediatek/mt8196/mt8196-dai-tdm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_dptx_ch_enable_mask(dev: *mut device, ch: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_dptx_ch(ch: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_dptx_wlen(format: snd_pcm_format_t) -> c_uint {
...
// cg
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8196_afe_private *afe_priv = afe.platform_priv;
    let mut dai_id: c_int = get_tdm_id_by_name(sink.name);
    struct mtk_afe_tdm_priv *tdm_priv = afe_priv.dai_priv[dai_id];
    int cur_apll;
// which apll
    ...
    {"TDM_DEMUX", core::ptr::null_mut(), "HDMI"},
    {"TDM", "TDMOUT", "TDM_DEMUX"},
    {"TDM", core::ptr::null_mut(), "TDM_BCK"},
    {"TDM", core::ptr::null_mut(), "TDM_CG"},
    {"TDM_DPTX", "DPTXOUT", "TDM_DEMUX"},
    {"TDM_DPTX", core::ptr::null_mut(), "TDM_DPTX_BCK"},
    {"TDM_DPTX", core::ptr::null_mut(), "TDM_CG"},
    {"TDM_BCK", core::ptr::null_mut(), "TDM_MCK"},
    {"TDM_DPTX_BCK", core::ptr::null_mut(), "TDM_DPTX_MCK"},
    ...
    {"TDM_DPTX_MCK", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_tdm_apll_connect},
    {"TDM_DPTX_MCK", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_tdm_apll_connect},
    };
// dai ops
