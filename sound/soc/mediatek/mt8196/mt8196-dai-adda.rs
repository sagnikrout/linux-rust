...
//! Source: sound/soc/mediatek/mt8196/mt8196-dai-adda.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtk_adda_ul_src_set_dmic_phase_sync(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_adda_ul_src_set_dmic_phase_sync_clock(afe: *mut mtk_base_afe) -> c_int {
...
unsafe extern "C" fn mtk_adda_ul_src_enable_dmic(afe: *mut mtk_base_afe, id: c_int) -> c_int {
    ...
    {
    let mut reg_con0: c_uint = 0, reg_con1 = 0;
...
// ADDA UL MUX
pub const ADDA_UL_MUX_MASK: c_uint = 0x3;
    enum {
...
// capture
    ...
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "ADDA Capture Enable"},
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "ADDA CH34 Capture Enable"},
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "ADDA_FIFO"},
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "ADDA_CH34_FIFO"},
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "AP_DMIC_EN"},
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "AP_DMIC_CH34_EN"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC_INPUT"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC_INPUT"},
    {"AP DMIC MULTICH Capture", core::ptr::null_mut(), "AP_DMIC_INPUT"},
    };
// dai ops
...
#[no_mangle]
pub unsafe extern "C" fn mt8196_dai_adda_register(afe: *mut mtk_base_afe) -> c_int {
