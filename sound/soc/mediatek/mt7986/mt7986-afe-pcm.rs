...
//! Source: sound/soc/mediatek/mt7986/mt7986-afe-pcm.c
#![no_std]
...
// UL
    ...
    {"I032", core::ptr::null_mut(), "DL1"},
    {"I033", core::ptr::null_mut(), "DL1"},
    {"UL1", core::ptr::null_mut(), "O018"},
    {"UL1", core::ptr::null_mut(), "O019"},
...
#[no_mangle]
unsafe extern "C" fn mt7986_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
unsafe extern "C" fn mt7986_afe_pcm_dev_remove(pdev: *mut platform_device) {
    ...
    mt7986_afe_runtime_resume, core::ptr::null_mut())
    };
