...
//! Source: sound/soc/mediatek/mt8173/mt8173-afe-pcm.c
#![no_std]
...
pub const AFE_CONN7: c_uint = 0x0460;
pub const AFE_CONN8: c_uint = 0x0464;
...
pub const AFE_MOD_PCM_BASE: c_uint = 0x0330;
pub const AFE_MOD_PCM_CUR: c_uint = 0x033c;
...
pub const AFE_IRQ_STATUS: c_uint = 0x03a4;
pub const AFE_IRQ_CLR: c_uint = 0x03a8;
pub const AFE_IRQ_CNT1: c_uint = 0x03ac;
pub const AFE_IRQ_CNT2: c_uint = 0x03b0;
pub const AFE_IRQ_MCU_EN: c_uint = 0x03b4;
pub const AFE_IRQ_CNT5: c_uint = 0x03bc;
pub const AFE_IRQ_CNT7: c_uint = 0x03dc;
pub const AFE_TDM_CON1: c_uint = 0x0548;
pub const AFE_TDM_CON2: c_uint = 0x054c;
pub const AFE_IRQ_STATUS_BITS: c_uint = 0xff;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt8173_afe_private {
    pub clocks: [*mut clk; MT8173_CLK_NUM],
}
...
unsafe extern "C" fn mt8173_afe_set_i2s(afe: *mut mtk_base_afe, rate: c_uint) -> c_int {
    ...
    {
    unsigned int val;
    let mut fs: c_int = mt8173_afe_i2s_fs(rate);
    if (fs < 0)
    return -EINVAL;
// from external ADC
...
#[no_mangle]
unsafe extern "C" fn mt8173_afe_set_i2s_enable(afe: *mut mtk_base_afe, enable: bool) {
...
// output
    ...
    runtime.rate * 256, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn mt8173_irq_fs(substream: *mut snd_pcm_substream, rate: c_uint) -> c_int {
...
// inter-connections
    ...
    {"I2S Playback", core::ptr::null_mut(), "O03"},
    {"I2S Playback", core::ptr::null_mut(), "O04"},
    {"VUL", core::ptr::null_mut(), "O09"},
    {"VUL", core::ptr::null_mut(), "O10"},
    {"I03", core::ptr::null_mut(), "I2S Capture"},
    {"I04", core::ptr::null_mut(), "I2S Capture"},
    {"I17", core::ptr::null_mut(), "I2S Capture"},
    {"I18", core::ptr::null_mut(), "I2S Capture"},
    { "O03", "I05 Switch", "I05" },
    { "O04", "I06 Switch", "I06" },
    { "O09", "I17 Switch", "I17" },
    { "O09", "I03 Switch", "I03" },
    ...
    {"HDMIO Playback", core::ptr::null_mut(), "HDMI"},
    };
...
#[no_mangle]
unsafe extern "C" fn mt8173_afe_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn mt8173_afe_pcm_dev_remove(pdev: *mut platform_device) {
    ...
    mt8173_afe_runtime_resume, core::ptr::null_mut())
    };
