...
//! Source: sound/soc/mediatek/mt8173/mt8173-rt5650-rt5514.c
#![no_std]
...
pub const MCLK_FOR_CODECS: c_int = 12288000;
    ...
    {"Sub DMIC1L", core::ptr::null_mut(), "Int Mic"},
    {"Sub DMIC1R", core::ptr::null_mut(), "Int Mic"},
...
#[no_mangle]
unsafe extern "C" fn mt8173_rt5650_rt5514_init(runtime: *mut snd_soc_pcm_runtime) -> c_int {
...
// enable jack detection
    ...
    COMP_CODEC(core::ptr::null_mut(), "rt5514-aif1")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
...
#[no_mangle]
unsafe extern "C" fn mt8173_rt5650_rt5514_dev_probe(pdev: *mut platform_device) -> c_int {
