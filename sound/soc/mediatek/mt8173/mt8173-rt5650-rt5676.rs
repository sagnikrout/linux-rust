...
//! Source: sound/soc/mediatek/mt8173/mt8173-rt5650-rt5676.c
#![no_std]
...
pub const MCLK_FOR_CODECS: c_int = 12288000;
    ...
    {"Speaker", core::ptr::null_mut(), "Sub AIF2TX"}, /* IF2 ADC to 5650  */
    {"Sub DMIC L1", core::ptr::null_mut(), "Int Mic"}, /* DMIC from 5676 */
    {"Sub DMIC R1", core::ptr::null_mut(), "Int Mic"},
    {"Headphone", core::ptr::null_mut(), "HPOL"},
    {"Headphone", core::ptr::null_mut(), "HPOR"},
    {"Headphone", core::ptr::null_mut(), "Sub AIF2TX"}, /* IF2 ADC to 5650  */
    {"IN1P", core::ptr::null_mut(), "Headset Mic"},
    {"IN1N", core::ptr::null_mut(), "Headset Mic"},
    {"Sub AIF2RX", core::ptr::null_mut(), "Headset Mic"}, /* IF2 DAC from 5650  */
    };
...
// enable jack detection
    ...
    COMP_CODEC(core::ptr::null_mut(), "rt5677-aif1")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    ...
    DAILINK_COMP_ARRAY(COMP_DUMMY()),
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "rt5677-aif2")),
    DAILINK_COMP_ARRAY(COMP_DUMMY()));
