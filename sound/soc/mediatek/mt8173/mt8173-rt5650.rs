...
//! Source: sound/soc/mediatek/mt8173/mt8173-rt5650.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt8173_rt5650_platform_data {
    pub pll_from: enum mt8173_rt5650_mclk,
...
unsafe extern "C" fn mt8173_rt5650_hdmi_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    &mt8173_rt5650_hdmi_jack, core::ptr::null_mut());
    }
    enum {
    DAI_LINK_PLAYBACK,
    DAI_LINK_CAPTURE,
    ...
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "rt5645-aif1"), /* Playback */
    COMP_CODEC(core::ptr::null_mut(), "rt5645-aif1")),/* Capture */
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
