...
//! Source: sound/soc/mediatek/mt8192/mt8192-mt6359-rt1015-rt5682.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt8192_mt6359_mtkaif_calibration(rtd: *mut snd_soc_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_mt6359_legacy_probe(soc_card_data: *mut mtk_soc_card_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_mt6359_soc_card_probe(soc_card_data: *mut mtk_soc_card_data, legacy: bool) -> c_int {
