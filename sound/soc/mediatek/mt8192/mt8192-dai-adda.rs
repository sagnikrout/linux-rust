...
//! Source: sound/soc/mediatek/mt8192/mt8192-dai-adda.c
#![no_std]
...
pub const SDM_AUTO_RESET_THRESHOLD: c_uint = 0x190000;
// dai component
...
#[no_mangle]
unsafe extern "C" fn mtk_adda_ul_src_dmic(afe: *mut mtk_base_afe, id: c_int) -> c_int {
...
// turn on dmic, ch1, ch2
    ...
    let mut mtkaif_dmic: c_int = afe_priv.mtkaif_dmic;
    switch (event) {
...
// should delayed 1/fs(smallest is 8k) = 125us before afe off
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8192_afe_private *afe_priv = afe.platform_priv;
    let mut mtkaif_dmic: c_int = afe_priv.mtkaif_dmic_ch34;
    let mut mtkaif_adda6_only: c_int = afe_priv.mtkaif_adda6_only;
    switch (event) {
    case SND_SOC_DAPM_PRE_PMU:
...
// stf
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8192_afe_private *afe_priv = afe.platform_priv;
    let mut gain_db: c_int = ucontrol.value.integer.value[0];
...
// set side tone coefficient
    ...
    let mut old_w_ready: bool = (reg_value >> W_RDY_SFT) & 0x1;
    let mut new_w_ready: bool = 0;
    let mut try_cnt: c_int = 0;
    regmap_update_bits(afe.regmap,
    AFE_SIDETONE_CON0,
    0x39FFFFF,
    (1 << R_W_EN_SFT) |
...
// playback
    ...
    {"ADDA Playback", core::ptr::null_mut(), "ADDA_DL_CH1"},
    {"ADDA Playback", core::ptr::null_mut(), "ADDA_DL_CH2"},
    {"ADDA Playback", core::ptr::null_mut(), "ADDA Enable"},
    {"ADDA Playback", core::ptr::null_mut(), "ADDA Playback Enable"},
    ...
    {"ADDA CH34 Playback", core::ptr::null_mut(), "ADDA_DL_CH3"},
    {"ADDA CH34 Playback", core::ptr::null_mut(), "ADDA_DL_CH4"},
    {"ADDA CH34 Playback", core::ptr::null_mut(), "ADDA Enable"},
    {"ADDA CH34 Playback", core::ptr::null_mut(), "ADDA CH34 Playback Enable"},
// capture
    {"ADDA_UL_Mux", "MTKAIF", "ADDA Capture"},
    {"ADDA_UL_Mux", "AP_DMIC", "AP DMIC Capture"},
    {"ADDA_CH34_UL_Mux", "MTKAIF", "ADDA CH34 Capture"},
    {"ADDA_CH34_UL_Mux", "AP_DMIC", "AP DMIC CH34 Capture"},
    {"ADDA Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"ADDA Capture", core::ptr::null_mut(), "ADDA Capture Enable"},
    {"ADDA Capture", core::ptr::null_mut(), "AUD_PAD_TOP"},
    {"ADDA Capture", core::ptr::null_mut(), "ADDA_MTKAIF_CFG"},
    {"AP DMIC Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"AP DMIC Capture", core::ptr::null_mut(), "ADDA Capture Enable"},
    {"AP DMIC Capture", core::ptr::null_mut(), "ADDA_FIFO"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC_EN"},
    {"ADDA CH34 Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"ADDA CH34 Capture", core::ptr::null_mut(), "ADDA CH34 Capture Enable"},
    {"ADDA CH34 Capture", core::ptr::null_mut(), "AUD_PAD_TOP"},
    {"ADDA CH34 Capture", core::ptr::null_mut(), "ADDA6_MTKAIF_CFG"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "ADDA CH34 Capture Enable"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "ADDA_CH34_FIFO"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC_CH34_EN"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC_INPUT"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC_CH34_INPUT"},
// sidetone filter
    ...
    {"STF_OUTPUT", core::ptr::null_mut(), "Sidetone Filter"},
    {"ADDA Playback", core::ptr::null_mut(), "Sidetone Filter"},
    {"ADDA CH34 Playback", core::ptr::null_mut(), "Sidetone Filter"},
// clk
    {"ADDA Playback", core::ptr::null_mut(), "aud_dac_clk"},
    {"ADDA Playback", core::ptr::null_mut(), "aud_dac_predis_clk"},
    {"ADDA CH34 Playback", core::ptr::null_mut(), "aud_3rd_dac_clk"},
    {"ADDA CH34 Playback", core::ptr::null_mut(), "aud_3rd_dac_predis_clk"},
    {"ADDA Capture Enable", core::ptr::null_mut(), "aud_adc_clk"},
    {"ADDA CH34 Capture Enable", core::ptr::null_mut(), "aud_adda6_adc_clk"},
    };
// dai ops
...
#[no_mangle]
pub unsafe extern "C" fn mt8192_dai_adda_register(afe: *mut mtk_base_afe) -> c_int {
