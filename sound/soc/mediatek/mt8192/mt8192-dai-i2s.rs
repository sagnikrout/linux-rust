...
//! Source: sound/soc/mediatek/mt8192/mt8192-dai-i2s.c
#![no_std]
...
pub struct mtk_afe_i2s_priv {
    pub id: c_int,
    pub /: *mut *mut int rate; / for determine which apll to use,
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S1", 0: 4) ==) -> else {
    else if (strncmp(name, "I2S1", 4) == 0)
    return MT8192_DAI_I2S_1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S2", 0: 4) ==) -> else {
    else if (strncmp(name, "I2S2", 4) == 0)
    return MT8192_DAI_I2S_2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S3", 0: 4) ==) -> else {
    else if (strncmp(name, "I2S3", 4) == 0)
    return MT8192_DAI_I2S_3;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S5", 0: 4) ==) -> else {
    else if (strncmp(name, "I2S5", 4) == 0)
    return MT8192_DAI_I2S_5;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S6", 0: 4) ==) -> else {
    else if (strncmp(name, "I2S6", 4) == 0)
    return MT8192_DAI_I2S_6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S7", 0: 4) ==) -> else {
    else if (strncmp(name, "I2S7", 4) == 0)
    return MT8192_DAI_I2S_7;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S8", 0: 4) ==) -> else {
    else if (strncmp(name, "I2S8", 4) == 0)
    return MT8192_DAI_I2S_8;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(name, _arg: "I2S9", 0: 4) ==) -> else {
...
// low jitter control
    ...
    if (!i2s_priv) {
    dev_warn(afe.dev, "%s(), i2s_priv == core::ptr::null_mut()", __func__);
    return -EINVAL;
    }
...
// which apll
    ...
    {"Connsys I2S", core::ptr::null_mut(), "CONNSYS"},
// i2s0
    {"I2S0", core::ptr::null_mut(), "I2S0_EN"},
    {"I2S0", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S0", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S0", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S0_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S0_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S0", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S0", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S0_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S0_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s1
    ...
    {"I2S1", core::ptr::null_mut(), "I2S1_CH1"},
    {"I2S1", core::ptr::null_mut(), "I2S1_CH2"},
    {"I2S1", core::ptr::null_mut(), "I2S3_TINYCONN_CH1_MUX"},
    {"I2S1", core::ptr::null_mut(), "I2S3_TINYCONN_CH2_MUX"},
    {"I2S1", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), "I2S1_EN"},
    {"I2S1", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S1", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S1", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S1_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S1_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S1", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S1", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S1_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S1_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s2
    {"I2S2", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), "I2S2_EN"},
    {"I2S2", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S2", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S2", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S2_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S2_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S2", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S2", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S2_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S2_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s3
    ...
    {"I2S3", core::ptr::null_mut(), "I2S3_CH1"},
    {"I2S3", core::ptr::null_mut(), "I2S3_CH2"},
    {"I2S3", core::ptr::null_mut(), "I2S3_TINYCONN_CH1_MUX"},
    {"I2S3", core::ptr::null_mut(), "I2S3_TINYCONN_CH2_MUX"},
    {"I2S3", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), "I2S3_EN"},
    {"I2S3", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S3", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S3", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S3_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S3_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S3", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S3", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S3_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S3_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s5
    ...
    {"I2S5", core::ptr::null_mut(), "I2S5_CH1"},
    {"I2S5", core::ptr::null_mut(), "I2S5_CH2"},
    {"I2S5", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), "I2S5_EN"},
    {"I2S5", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S5", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S5", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S5_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S5_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S5", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S5", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S5_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S5_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s6
    {"I2S6", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), "I2S6_EN"},
    {"I2S6", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S6", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S6", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S6_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S6_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S6", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S6", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S6_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S6_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s7
    {"I2S7", core::ptr::null_mut(), "I2S7_CH1"},
    {"I2S7", core::ptr::null_mut(), "I2S7_CH2"},
    {"I2S7", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), "I2S7_EN"},
    {"I2S7", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S7", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S7", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S7_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S7_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S7", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S7", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S7_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S7_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s8
    {"I2S8", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), "I2S8_EN"},
    {"I2S8", core::ptr::null_mut(), "I2S9_EN", mtk_afe_i2s_share_connect},
    {"I2S8", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S8", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S8_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S8_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S8", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S8", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S8_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S8_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// i2s9
    ...
    {"I2S9", core::ptr::null_mut(), "I2S9_CH1"},
    {"I2S9", core::ptr::null_mut(), "I2S9_CH2"},
    {"I2S9", core::ptr::null_mut(), "I2S0_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S1_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S2_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S3_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S5_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S6_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S7_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S8_EN", mtk_afe_i2s_share_connect},
    {"I2S9", core::ptr::null_mut(), "I2S9_EN"},
    {"I2S9", core::ptr::null_mut(), I2S0_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S1_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S2_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S3_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S5_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S6_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S7_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S8_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {"I2S9", core::ptr::null_mut(), I2S9_HD_EN_W_NAME, mtk_afe_i2s_hd_connect},
    {I2S9_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_i2s_apll_connect},
    {I2S9_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_i2s_apll_connect},
    {"I2S9", core::ptr::null_mut(), I2S0_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S1_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S2_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S3_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S5_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S6_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S7_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S8_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {"I2S9", core::ptr::null_mut(), I2S9_MCLK_EN_W_NAME, mtk_afe_i2s_mclk_connect},
    {I2S9_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {I2S9_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// allow i2s on without codec on
    {"I2S0", core::ptr::null_mut(), "I2S0_In_Mux"},
    {"I2S0_In_Mux", "Dummy_Widget", "I2S_DUMMY_IN"},
    {"I2S8", core::ptr::null_mut(), "I2S8_In_Mux"},
    {"I2S8_In_Mux", "Dummy_Widget", "I2S_DUMMY_IN"},
    {"I2S1_Out_Mux", "Dummy_Widget", "I2S1"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S1_Out_Mux"},
    {"I2S3_Out_Mux", "Dummy_Widget", "I2S3"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S3_Out_Mux"},
    {"I2S5_Out_Mux", "Dummy_Widget", "I2S5"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S5_Out_Mux"},
    {"I2S7_Out_Mux", "Dummy_Widget", "I2S7"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S7_Out_Mux"},
    {"I2S9_Out_Mux", "Dummy_Widget", "I2S9"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S9_Out_Mux"},
// i2s in lpbk
    {"I2S0_Lpbk_Mux", "Lpbk", "I2S3"},
    {"I2S2_Lpbk_Mux", "Lpbk", "I2S1"},
    {"I2S0", core::ptr::null_mut(), "I2S0_Lpbk_Mux"},
    {"I2S2", core::ptr::null_mut(), "I2S2_Lpbk_Mux"},
    };
// dai ops
...
// set share i2s
    ...
    if (!share_i2s_priv) {
    dev_warn(afe.dev, "%s(), share_i2s_priv = core::ptr::null_mut()",
    __func__);
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn mt8192_dai_i2s_set_priv(afe: *mut mtk_base_afe) -> c_int {
