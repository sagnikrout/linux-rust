...
//! Source: sound/soc/mediatek/mt8192/mt8192-dai-tdm.c
#![no_std]
...
pub struct mtk_afe_tdm_priv {
    ...
    pub bck_id: c_int,
    pub bck_rate: c_int,
    pub tdm_out_mode: c_int,
    pub bck_invert: c_int,
    pub lck_invert: c_int,
    pub mclk_id: c_int,
    pub /: *mut *mut int mclk_multiple; / according to sample rate,
    pub mclk_rate: c_int,
    pub mclk_apll: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn get_tdm_wlen(format: snd_pcm_format_t) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_tdm_channel_bck(format: snd_pcm_format_t) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_tdm_lrck_width(format: snd_pcm_format_t) -> c_uint {
    static unsigned int get_tdm_lrck_width(snd_pcm_format_t format)
    {
    return snd_pcm_format_physical_width(format) - 1;
    }
#[no_mangle]
unsafe extern "C" fn get_tdm_ch(ch: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_tdm_ch_fixup(channels: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_tdm_id_by_name(name: *const c_char) -> c_int {
    ...
    let mut dai_id: c_int = get_tdm_id_by_name(w.name);
    struct mtk_afe_tdm_priv *tdm_priv = afe_priv.dai_priv[dai_id];
    if (!tdm_priv) {
    dev_warn(afe.dev, "%s(), tdm_priv == core::ptr::null_mut()", __func__);
    return -EINVAL;
    }
...
// which apll
    ...
    {"TDM", core::ptr::null_mut(), "HDMI_CH0_MUX"},
    {"TDM", core::ptr::null_mut(), "HDMI_CH1_MUX"},
    {"TDM", core::ptr::null_mut(), "HDMI_CH2_MUX"},
    {"TDM", core::ptr::null_mut(), "HDMI_CH3_MUX"},
    {"TDM", core::ptr::null_mut(), "HDMI_CH4_MUX"},
    {"TDM", core::ptr::null_mut(), "HDMI_CH5_MUX"},
    {"TDM", core::ptr::null_mut(), "HDMI_CH6_MUX"},
    {"TDM", core::ptr::null_mut(), "HDMI_CH7_MUX"},
    {"TDM", core::ptr::null_mut(), "aud_tdm_clk"},
    {"TDM", core::ptr::null_mut(), "TDM_BCK"},
    {"TDM", core::ptr::null_mut(), "TDM_EN"},
    {"TDM_BCK", core::ptr::null_mut(), "TDM_MCK"},
    {"TDM_MCK", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_tdm_apll_connect},
    {"TDM_MCK", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_tdm_apll_connect},
    };
// dai ops
    ...
    struct mt8192_afe_private *afe_priv = afe.platform_priv;
    let mut tdm_id: c_int = dai.id;
    struct mtk_afe_tdm_priv *tdm_priv = afe_priv.dai_priv[tdm_id];
    let mut tdm_out_mode: c_uint = tdm_priv.tdm_out_mode;
...
#[no_mangle]
pub unsafe extern "C" fn mt8192_dai_tdm_register(afe: *mut mtk_base_afe) -> c_int {
