...
//! Source: sound/soc/mediatek/mt8192/mt8192-afe-pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt8192_irq_fs(substream: *mut snd_pcm_substream, rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_get_memif_pbuf_size(substream: *mut snd_pcm_substream) -> c_int {
...
// inter-connections
    ...
    {"UL_MONO_1", core::ptr::null_mut(), "UL_MONO_1_CH1"},
    {"UL_MONO_1_CH1", "PCM_1_CAP_CH1", "PCM 1 Capture"},
    {"UL_MONO_1_CH1", "PCM_2_CAP_CH1", "PCM 2 Capture"},
    {"UL_MONO_2", core::ptr::null_mut(), "UL_MONO_2_CH1"},
    {"UL_MONO_2_CH1", "ADDA_UL_CH1", "ADDA_UL_Mux"},
    {"UL_MONO_3", core::ptr::null_mut(), "UL_MONO_3_CH1"},
    ...
    {"UL4", core::ptr::null_mut(), "UL4_TINYCONN_CH1_MUX"},
    {"UL4", core::ptr::null_mut(), "UL4_TINYCONN_CH2_MUX"},
...
#[no_mangle]
unsafe extern "C" fn mt8192_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8192_afe_irq_handler(irq_id: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt8192_afe_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_afe_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_dai_memif_register(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_afe_release_reserved_mem(data: *mut c_void) {
    static void mt8192_afe_release_reserved_mem(void *data)
    {
    of_reserved_mem_device_release(data);
    }
#[no_mangle]
unsafe extern "C" fn mt8192_afe_pcm_dev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_afe_pcm_dev_remove(pdev: *mut platform_device) {
...
// disable afe clock
    ...
    mt8192_afe_runtime_resume, core::ptr::null_mut())
    };
