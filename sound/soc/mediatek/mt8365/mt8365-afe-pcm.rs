...
//! Source: sound/soc/mediatek/mt8365/mt8365-afe-pcm.c
#![no_std]
...
pub const AFE_BASE_END_OFFSET: c_int = 8;
...
#[no_mangle]
pub unsafe extern "C" fn mt8365_afe_fs_timing(rate: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt8365_afe_rate_supported(rate: c_uint, id: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mt8365_afe_channel_supported(channel: c_uint, id: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_clk_group_44k(sample_rate: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_clk_group_48k(sample_rate: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_cm2_mux_conn(afe: *mut mtk_base_afe) -> c_int {
    static int mt8365_afe_cm2_mux_conn(struct mtk_base_afe *afe)
    {
    struct mt8365_afe_private *afe_priv = afe.platform_priv;
    let mut input: c_uint = afe_priv.cm2_mux_input;
...
//
    ...
    let mut fs: c_uint = mt8365_afe_fs_timing(rate);
    ...
    let mut memif_num: c_int = snd_soc_rtd_to_cpu(rtd, 0).id;
...
// set channel
    ...
    let mut mono: c_uint = (params_channels(params) == 1) ? 1 : 0;
    if (memif.data.mono_reg < 0)
    dev_info(afe.dev, "%s mono_reg is core::ptr::null_mut()\n", __func__);
    else
...
// set rate
    ...
    dev_info(afe.dev, "%s fs_reg is core::ptr::null_mut()\n", __func__);
    else
...
// inter-connections
    SND_SOC_DAPM_MIXER("I00", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I01", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I03", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I04", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I05", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I06", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I07", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I08", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I05L", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I06L", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I07L", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I08L", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I09", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I10", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I11", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I10L", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I11L", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I12", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I13", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I14", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I15", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I16", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I17", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I18", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I19", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I20", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I21", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I22", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I23", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I24", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I25", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I26", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I27", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I28", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I29", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I30", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I31", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I32", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I33", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I34", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    SND_SOC_DAPM_MIXER("CM2_Mux IO", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("CM1_IO", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("O17O18", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// inter-connections
...
// downlink
    {"I00", core::ptr::null_mut(), "2ND I2S Capture"},
    {"I01", core::ptr::null_mut(), "2ND I2S Capture"},
    {"I05", core::ptr::null_mut(), "DL1"},
    {"I06", core::ptr::null_mut(), "DL1"},
    {"I07", core::ptr::null_mut(), "DL2"},
    {"I08", core::ptr::null_mut(), "DL2"},
    {"O03", "I05 Switch", "I05"},
    {"O04", "I06 Switch", "I06"},
    {"O00", "I05 Switch", "I05"},
    {"O01", "I06 Switch", "I06"},
    ...
    {"O08", "I08 Switch", "I08"},
// uplink
    {"AWB", core::ptr::null_mut(), "O05"},
    {"AWB", core::ptr::null_mut(), "O06"},
    {"VUL", core::ptr::null_mut(), "O09"},
    {"VUL", core::ptr::null_mut(), "O10"},
    {"VUL3", core::ptr::null_mut(), "O11"},
    {"VUL3", core::ptr::null_mut(), "O12"},
    {"AIN Mux", "EXT ADC", "I2S Capture"},
    {"I03", core::ptr::null_mut(), "AIN Mux"},
    {"I04", core::ptr::null_mut(), "AIN Mux"},
    {"HW_GAIN1_IN_CH1", "CONNSYS_I2S_CH1", "Hostless FM DL"},
    {"HW_GAIN1_IN_CH2", "CONNSYS_I2S_CH2", "Hostless FM DL"},
    {"HW Gain 1 In Endpoint", core::ptr::null_mut(), "HW Gain 1 In"},
    {"HW Gain 1 Out", core::ptr::null_mut(), "HW Gain 1 Out Endpoint"},
    {"HW Gain 1 In", core::ptr::null_mut(), "HW_GAIN1_IN_CH1"},
    {"HW Gain 1 In", core::ptr::null_mut(), "HW_GAIN1_IN_CH2"},
    {"FM HW Gain Mux", "FM_HW_GAIN_IO", "HW Gain 1 Out"},
    {"Hostless FM UL", core::ptr::null_mut(), "FM HW Gain Mux"},
    {"Hostless FM UL", core::ptr::null_mut(), "FM 2ND I2S Mux"},
    {"O05", "I05 Switch", "I05L"},
    {"O06", "I06 Switch", "I06L"},
    {"O05", "I07 Switch", "I07L"},
    {"O06", "I08 Switch", "I08L"},
    ...
    {"O12", "I21 Switch", "I21"},
// CM2_Mux
    {"CM2_Mux IO", core::ptr::null_mut(), "CM2_Mux_IO Input Mux"},
// VUL2
    {"VUL2", core::ptr::null_mut(), "VUL2 Input Mux"},
    {"VUL2 Input Mux", "VUL2_IN_FROM_O17O18", "O17O18"},
    {"VUL2 Input Mux", "VUL2_IN_FROM_CM1", "CM1_IO"},
    {"O17O18", core::ptr::null_mut(), "O17"},
    {"O17O18", core::ptr::null_mut(), "O18"},
    {"CM1_IO", core::ptr::null_mut(), "O17"},
    {"CM1_IO", core::ptr::null_mut(), "O18"},
    {"CM1_IO", core::ptr::null_mut(), "O19"},
    {"CM1_IO", core::ptr::null_mut(), "O20"},
    {"CM1_IO", core::ptr::null_mut(), "O21"},
    {"CM1_IO", core::ptr::null_mut(), "O22"},
    {"CM1_IO", core::ptr::null_mut(), "O23"},
    {"CM1_IO", core::ptr::null_mut(), "O24"},
    {"CM1_IO", core::ptr::null_mut(), "O25"},
    {"CM1_IO", core::ptr::null_mut(), "O26"},
    {"CM1_IO", core::ptr::null_mut(), "O31"},
    {"CM1_IO", core::ptr::null_mut(), "O32"},
    {"CM1_IO", core::ptr::null_mut(), "O33"},
    {"CM1_IO", core::ptr::null_mut(), "O34"},
    {"CM1_IO", core::ptr::null_mut(), "O35"},
    {"CM1_IO", core::ptr::null_mut(), "O36"},
    {"O17", "I14 Switch", "I14"},
    {"O18", "I15 Switch", "I15"},
    {"O19", "I16 Switch", "I16"},
    {"O20", "I17 Switch", "I17"},
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_runtime_suspend(dev: *mut device) -> c_int {
    static int mt8365_afe_runtime_suspend(struct device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mt8365_afe_runtime_resume(dev: *mut device) -> c_int {
    static int mt8365_afe_runtime_resume(struct device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mt8365_afe_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_dev_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_dev_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_init_registers(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_dai_memif_register(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_pcm_dev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_afe_pcm_dev_remove(pdev: *mut platform_device) {
    ...
    mt8365_afe_dev_runtime_resume, core::ptr::null_mut())
