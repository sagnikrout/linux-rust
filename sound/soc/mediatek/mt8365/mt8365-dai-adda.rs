...
//! Source: sound/soc/mediatek/mt8365/mt8365-dai-adda.c
#![no_std]
...
pub unsafe extern "C" fn mt8365_dai_disable_adda_on(afe: *mut mtk_base_afe) -> c_int {
    ...
    ~AFE_ADDA_UL_DL_ADDA_AFE_ON);
#[no_mangle]
pub unsafe extern "C" fn if(0: adda_afe_on_ref_cnt <) -> else {
...
// de suggest disable ADDA_UL_SRC at least wait 125us
    ...
    let mut stream: c_uint = substream.stream;
...
// DAI route
    ...
    {"INT ADDA Playback", core::ptr::null_mut(), "INT ADDA O03_O04"},
    {"INT ADDA Playback", core::ptr::null_mut(), "ADDA_DL_CH1"},
    {"INT ADDA Playback", core::ptr::null_mut(), "ADDA_DL_CH2"},
