...
//! Source: sound/soc/mediatek/mt8365/mt8365-mt6357.c
#![no_std]
...
// BE
    ...
    {"HDMI Out", core::ptr::null_mut(), "2ND I2S Playback"},
    {"DMIC In", core::ptr::null_mut(), "MICBIAS0"},
    };
#[no_mangle]
unsafe extern "C" fn mt8365_mt6357_int_adda_startup(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8365_mt6357_dev_probe(soc_card_data: *mut mtk_soc_card_data, legacy: bool) -> c_int {
