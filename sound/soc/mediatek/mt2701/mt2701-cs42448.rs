...
//! Source: sound/soc/mediatek/mt2701/mt2701-cs42448.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt2701_cs42448_private {
    pub i2s1_in_mux: c_int,
    pub i2s1_in_mux_sel_1: *mut gpio_desc,
    pub i2s1_in_mux_sel_2: *mut gpio_desc,
}
    ...
    SND_SOC_DAPM_LINE("Tuner In", core::ptr::null_mut()),
    SND_SOC_DAPM_LINE("Satellite Tuner In", core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn mt2701_cs42448_fe_ops_startup(substream: *mut snd_pcm_substream) -> c_int {
    ...
    let mut div_mclk_over_bck: c_uint = rate > 192000 ? 2 : 4;
    let mut div_bck_over_lrck: c_uint = 64;
...
// codec mclk
    ...
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "cs42448")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
    ...
    DAILINK_COMP_ARRAY(COMP_CODEC(core::ptr::null_mut(), "bt-sco-pcm-wb")),
    DAILINK_COMP_ARRAY(COMP_EMPTY()));
