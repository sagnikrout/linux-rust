...
//! Source: sound/soc/mediatek/mt2701/mt2701-afe-pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt2701_dai_num_to_i2s(afe: *mut mtk_base_afe, num: c_int) -> c_int {
    static int mt2701_dai_num_to_i2s(struct mtk_base_afe *afe, int num)
    {
    struct mt2701_afe_private *afe_priv = afe.platform_priv;
    let mut val: c_int = num - MT2701_IO_I2S;
...
#[no_mangle]
unsafe extern "C" fn mt2701_afe_i2s_fs(sample_rate: c_uint) -> c_int {
    ...
    struct mt2701_afe_private *afe_priv = afe.platform_priv;
    let mut i2s_num: c_int = mt2701_dai_num_to_i2s(afe, dai.id);
    let mut mode: bool = afe_priv.soc.has_one_heart_mode;
    if (i2s_num < 0)
    return i2s_num;
...
// if the other direction stream is not occupied
    ...
    let mut stream_dir: c_int = substream.stream;
...
#[no_mangle]
unsafe extern "C" fn mt2701_irq_fs(substream: *mut snd_pcm_substream, rate: c_uint) -> c_int {
...
//
pub const MT2701_HDMI_I2S_PATH: c_int = 3;
...
// inter-connections
    ...
    SND_SOC_DAPM_MIXER("I35", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    {"I12", core::ptr::null_mut(), "DL1"},
    {"I13", core::ptr::null_mut(), "DL1"},
    {"I35", core::ptr::null_mut(), "DLBT"},
    {"I2S0 Playback", core::ptr::null_mut(), "O15"},
    {"I2S0 Playback", core::ptr::null_mut(), "O16"},
    {"I2S1 Playback", core::ptr::null_mut(), "O17"},
    {"I2S1 Playback", core::ptr::null_mut(), "O18"},
    {"I2S2 Playback", core::ptr::null_mut(), "O19"},
    {"I2S2 Playback", core::ptr::null_mut(), "O20"},
    {"I2S3 Playback", core::ptr::null_mut(), "O21"},
    {"I2S3 Playback", core::ptr::null_mut(), "O22"},
    {"BT Playback", core::ptr::null_mut(), "O31"},
    {"UL1", core::ptr::null_mut(), "O00"},
    {"UL1", core::ptr::null_mut(), "O01"},
    {"UL2", core::ptr::null_mut(), "O02"},
    {"UL2", core::ptr::null_mut(), "O03"},
    {"ULBT", core::ptr::null_mut(), "O14"},
    {"I00", core::ptr::null_mut(), "I2S0 Capture"},
    {"I01", core::ptr::null_mut(), "I2S0 Capture"},
    {"I02", core::ptr::null_mut(), "I2S1 Capture"},
    {"I03", core::ptr::null_mut(), "I2S1 Capture"},
// I02,03 link to UL2, also need to open I2S0
    {"I02", "I2S0 Switch", "I2S0 Capture"},
    {"I26", core::ptr::null_mut(), "BT Capture"},
...
// to the user.
//
    {"HDMI 8CH I2S Playback", core::ptr::null_mut(), "HDMI Multich"},
    { "I12", core::ptr::null_mut(), "I12I13" },
    { "I13", core::ptr::null_mut(), "I12I13" },
    { "I14", core::ptr::null_mut(), "I14I15" },
    { "I15", core::ptr::null_mut(), "I14I15" },
    { "I16", core::ptr::null_mut(), "I16I17" },
    { "I17", core::ptr::null_mut(), "I16I17" },
    { "I18", core::ptr::null_mut(), "I18I19" },
    { "I19", core::ptr::null_mut(), "I18I19" },
    { "O00", "I00 Switch", "I00" },
    { "O01", "I01 Switch", "I01" },
    { "O02", "I02 Switch", "I02" },
    { "O03", "I03 Switch", "I03" },
...
#[no_mangle]
unsafe extern "C" fn mt2701_afe_pcm_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt2701_asys_isr(irq_id: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt2701_afe_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt2701_afe_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt2701_afe_pcm_dev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt2701_afe_pcm_dev_remove(pdev: *mut platform_device) {
    ...
    mt2701_afe_runtime_resume, core::ptr::null_mut())
    };
