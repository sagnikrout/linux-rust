...
//! Source: sound/soc/mediatek/mt8186/mt8186-dai-i2s.c
#![no_std]
...
pub struct mtk_afe_i2s_priv {
    ...
    pub mode*/: *mut *mut int master; / only i2s0 has slave,
...
// i2s hd en
    ...
    AFE_I2S_CON, I2S1_HD_EN_SFT, 0, core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_SUPPLY_S(I2S1_HD_EN_W_NAME, SUPPLY_SEQ_I2S_HD_EN,
    AFE_I2S_CON1, I2S2_HD_EN_SFT, 0, core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_SUPPLY_S(I2S2_HD_EN_W_NAME, SUPPLY_SEQ_I2S_HD_EN,
    AFE_I2S_CON2, I2S3_HD_EN_SFT, 0, core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
    SND_SOC_DAPM_SUPPLY_S(I2S3_HD_EN_W_NAME, SUPPLY_SEQ_I2S_HD_EN,
    AFE_I2S_CON3, I2S4_HD_EN_SFT, 0, core::ptr::null_mut(),
    SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
// i2s mclk en
...
// allow i2s on without codec on
    ...
    {"I2S2", core::ptr::null_mut(), "I2S2_In_Mux"},
...
// set share i2s
    ...
    if (!share_i2s_priv) {
    dev_err(afe.dev, "%s(), share_i2s_priv == core::ptr::null_mut()", __func__);
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn mt8186_dai_i2s_set_priv(afe: *mut mtk_base_afe) -> c_int {
