...
//! Source: sound/soc/mediatek/mt8186/mt8186-dai-hw-gain.c
#![no_std]
...
// inter-connections
    ...
    {"HW Gain 2 In", core::ptr::null_mut(), "HW_GAIN2_IN_CH1"},
    {"HW Gain 2 In", core::ptr::null_mut(), "HW_GAIN2_IN_CH2"},
    {"HW Gain 1 In", core::ptr::null_mut(), HW_GAIN_1_EN_W_NAME},
    {"HW Gain 1 Out", core::ptr::null_mut(), HW_GAIN_1_EN_W_NAME},
    {"HW Gain 2 In", core::ptr::null_mut(), HW_GAIN_2_EN_W_NAME},
    {"HW Gain 2 Out", core::ptr::null_mut(), HW_GAIN_2_EN_W_NAME},
    {"HW Gain 1 In Endpoint", core::ptr::null_mut(), "HW Gain 1 In"},
    {"HW Gain 1 Out", core::ptr::null_mut(), "HW Gain 1 Out Endpoint"},
    {"HW Gain 2 Out", core::ptr::null_mut(), "HW Gain 2 Out Endpoint"},
    };
...
// dai ops
    ...
    let mut rate_reg: c_uint = mt8186_rate_transform(afe.dev, rate, dai.id);
...
#[no_mangle]
pub unsafe extern "C" fn mt8186_dai_hw_gain_register(afe: *mut mtk_base_afe) -> c_int {
