...
//! Source: sound/soc/mediatek/mt8186/mt8186-dai-adda.c
#![no_std]
...
pub const HIRES_THRESHOLD: c_int = 48000;
    ...
    if (!adda_priv) {
    dev_err(afe.dev, "%s(), adda_priv == core::ptr::null_mut()", __func__);
    return 0;
    }
...
// clk
    ...
    {"ADDA Playback", core::ptr::null_mut(), "aud_dac_hires_clk", mtk_afe_dac_hires_connect},
    {"ADDA Capture Enable", core::ptr::null_mut(), "aud_adc_clk"},
    {"ADDA Capture Enable", core::ptr::null_mut(), "aud_adc_hires_clk",
    mtk_afe_adc_hires_connect},
// hires source from apll1
    {"top_mux_audio_h", core::ptr::null_mut(), APLL2_W_NAME},
    {"aud_dac_hires_clk", core::ptr::null_mut(), "top_mux_audio_h"},
    {"aud_adc_hires_clk", core::ptr::null_mut(), "top_mux_audio_h"},
    };
// dai ops
...
// sdm auto reset
    ...
    let mut voice_mode: c_uint = mtk_adda_ul_rate_transform(afe, rate);
...
// set dai priv
    ...
    sizeof(struct mtk_afe_adda_priv), core::ptr::null_mut());
    if (ret)
    return ret;
