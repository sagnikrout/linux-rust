...
//! Source: sound/soc/mediatek/mt8186/mt8186-mt6366.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt8186_mt6366_rt1019_rt5682s_priv {
    pub dmic_sel: *mut gpio_desc,
    pub dmic_switch: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn primary_codec_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8186_headset_codec_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    let mut mclk_fs_ratio: c_uint = 256;
    let mut mclk_fs: c_uint = rate * mclk_fs_ratio;
    unsigned int freq;
    int ret, j;
...
#[no_mangle]
unsafe extern "C" fn mt8186_da7219_i2s_hw_free(substream: *mut snd_pcm_substream) -> c_int {
    ...
    let mut rate: c_uint = params_rate(params);
    let mut mclk_fs_ratio: c_uint = 128;
    let mut mclk_fs: c_uint = rate * mclk_fs_ratio;
    int bitwidth;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mt8186_mt6366_rt1019_rt5682s_hdmi_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    return snd_soc_component_set_jack(cmpnt_codec, jack, core::ptr::null_mut());
    }
...
// SOF BE
    ...
    SND_SOC_DAPM_LINE("HDMI1", core::ptr::null_mut()),
    SND_SOC_DAPM_MIXER(SOF_DMA_DL1, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER(SOF_DMA_DL2, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER(SOF_DMA_UL1, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER(SOF_DMA_UL2, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    };
    static const struct snd_soc_dapm_widget
...
// SPK
    { "Speakers", core::ptr::null_mut(), "Speaker" },
// Headset
    { "Headphone", core::ptr::null_mut(), "HPOL" },
    { "Headphone", core::ptr::null_mut(), "HPOR" },
    { "IN1P", core::ptr::null_mut(), "Headset Mic" },
// HDMI
    { "HDMI1", core::ptr::null_mut(), "TX" },
// SOF Uplink
    {SOF_DMA_UL1, core::ptr::null_mut(), "UL1_CH1"},
    {SOF_DMA_UL1, core::ptr::null_mut(), "UL1_CH2"},
    {SOF_DMA_UL2, core::ptr::null_mut(), "UL2_CH1"},
    {SOF_DMA_UL2, core::ptr::null_mut(), "UL2_CH2"},
// SOF Downlink
    {"DSP_DL1_VIRT", core::ptr::null_mut(), SOF_DMA_DL1},
    {"DSP_DL2_VIRT", core::ptr::null_mut(), SOF_DMA_DL2},
    };
...
#[no_mangle]
unsafe extern "C" fn mt8186_mt6366_legacy_probe(soc_card_data: *mut mtk_soc_card_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8186_mt6366_soc_card_probe(soc_card_data: *mut mtk_soc_card_data, legacy: bool) -> c_int {
