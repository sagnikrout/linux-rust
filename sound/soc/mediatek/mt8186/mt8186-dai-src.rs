...
//! Source: sound/soc/mediatek/mt8186/mt8186-dai-src.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtk_get_src_freq_mode(afe: *mut mtk_base_afe, rate: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_set_src_1_param(afe: *mut mtk_base_afe, id: c_int) -> c_int {
    ...
    let mut rate_in: c_int = src_priv.dl_rate;
    let mut rate_out: c_int = src_priv.ul_rate;
    let mut out_freq_mode: c_uint = mtk_get_src_freq_mode(afe, rate_out);
    let mut in_freq_mode: c_uint = mtk_get_src_freq_mode(afe, rate_in);
// set out freq mode
...
#[no_mangle]
unsafe extern "C" fn mtk_set_src_2_param(afe: *mut mtk_base_afe, id: c_int) -> c_int {
...
// inter-connections
    ...
    {"HW_SRC_1_In", core::ptr::null_mut(), "HW_SRC_1_IN_CH1"},
    {"HW_SRC_1_In", core::ptr::null_mut(), "HW_SRC_1_IN_CH2"},
    {"HW_SRC_2_In", core::ptr::null_mut(), "HW_SRC_2_IN_CH1"},
    {"HW_SRC_2_In", core::ptr::null_mut(), "HW_SRC_2_IN_CH2"},
    {"HW_SRC_1_In", core::ptr::null_mut(), HW_SRC_1_EN_W_NAME, mtk_afe_src_en_connect},
    {"HW_SRC_1_Out", core::ptr::null_mut(), HW_SRC_1_EN_W_NAME, mtk_afe_src_en_connect},
    {"HW_SRC_2_In", core::ptr::null_mut(), HW_SRC_2_EN_W_NAME, mtk_afe_src_en_connect},
    {"HW_SRC_2_Out", core::ptr::null_mut(), HW_SRC_2_EN_W_NAME, mtk_afe_src_en_connect},
    {"HW SRC 1 In Endpoint", core::ptr::null_mut(), "HW_SRC_1_In"},
    {"HW SRC 2 In Endpoint", core::ptr::null_mut(), "HW_SRC_2_In"},
    {"HW_SRC_1_Out", core::ptr::null_mut(), "HW SRC 1 Out Endpoint"},
    {"HW_SRC_2_Out", core::ptr::null_mut(), "HW SRC 2 Out Endpoint"},
    };
// dai ops
    ...
    let mut rate_reg: c_uint = mt8186_rate_transform(afe.dev, rate, id);
...
#[no_mangle]
pub unsafe extern "C" fn mt8186_dai_src_register(afe: *mut mtk_base_afe) -> c_int {
...
// set dai priv
    ...
    sizeof(struct mtk_afe_src_priv), core::ptr::null_mut());
    if (ret)
    return ret;
