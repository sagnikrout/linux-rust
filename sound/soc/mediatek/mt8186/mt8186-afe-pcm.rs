...
//! Source: sound/soc/mediatek/mt8186/mt8186-afe-pcm.c
#![no_std]
...
// channel merge configuration, enable control is in UL5_IN_MUX
    ...
    let mut update_cnt: c_int = 8;
    let mut val: c_uint = 0;
    let mut mask: c_uint = 0;
    let mut fs_mode: c_int = mt8186_rate_transform(afe.dev, rate, id);
...
// enable interrupt
    ...
    if (substream.stream == SNDRV_PCM_STREAM_CAPTURE) {
    let mut avail: c_int = snd_pcm_capture_avail(runtime);
...
#[no_mangle]
unsafe extern "C" fn mt8186_irq_fs(substream: *mut snd_pcm_substream, rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8186_get_memif_pbuf_size(substream: *mut snd_pcm_substream) -> c_int {
...
// kcontrol
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8186_afe_private *afe_priv = afe.platform_priv;
    let mut memif_num: c_int = MT8186_PRIMARY_MEMIF;
    struct mtk_base_afe_memif *memif = &afe.memif[memif_num];
    let mut irq_id: c_int = memif.irq_usage;
    let mut irq_cnt: c_int = afe_priv.irq_cnt[memif_num];
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8186_afe_private *afe_priv = afe.platform_priv;
    let mut memif_num: c_int = MT8186_RECORD_MEMIF;
    struct mtk_base_afe_memif *memif = &afe.memif[memif_num];
    let mut irq_id: c_int = memif.irq_usage;
    let mut irq_cnt: c_int = afe_priv.irq_cnt[memif_num];
    dev_dbg(afe.dev, "%s(), irq_id %d, irq_cnt = %d, value = %ld\n",
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8186_afe_private *afe_priv = afe.platform_priv;
    let mut xrun_assert: c_int = afe_priv.xrun_assert[MT8186_RECORD_MEMIF];
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8186_afe_private *afe_priv = afe.platform_priv;
    let mut xrun_assert: c_int = ucontrol.value.integer.value[0];
...
// inter-connections
    ...
    SND_SOC_DAPM_MIXER("UL5_2CH", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("HW_CM1", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// CM1 en
    SND_SOC_DAPM_SUPPLY_S("CM1_EN", 0, AFE_CM1_CON,
    CHANNEL_MERGE0_EN_SFT, 0, core::ptr::null_mut(),
    ...
    &ul5_in_mux_control),
    SND_SOC_DAPM_MIXER("DSP_DL1_VIRT", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("DSP_DL2_VIRT", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    {"UL1", core::ptr::null_mut(), "UL1_CH3"},
    {"UL1", core::ptr::null_mut(), "UL1_CH4"},
...
// cannot connect FE to FE directly
    ...
    {"Hostless_UL2 UL", core::ptr::null_mut(), "UL2_VIRTUAL_INPUT"},
    ...
    {"UL5", core::ptr::null_mut(), "UL5_IN_MUX"},
    {"UL5_IN_MUX", "UL5_IN_FROM_Normal", "UL5_2CH"},
    {"UL5_IN_MUX", "UL5_IN_FROM_CM1", "HW_CM1"},
    {"UL5_2CH", core::ptr::null_mut(), "UL5_CH1"},
    {"UL5_2CH", core::ptr::null_mut(), "UL5_CH2"},
    {"UL5_CH1", "ADDA_UL_CH1 Switch", "ADDA_UL_Mux"},
    {"UL5_CH2", "ADDA_UL_CH2 Switch", "ADDA_UL_Mux"},
    {"HW_CM1", core::ptr::null_mut(), "CM1_EN"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH1"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH2"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH3"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH4"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH5"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH6"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH7"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH8"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH9"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH10"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH11"},
    {"HW_CM1", core::ptr::null_mut(), "HW_CM1_CH12"},
    ...
    {"Hostless_UL5 UL", core::ptr::null_mut(), "UL5_VIRTUAL_INPUT"},
    ...
    {"Hostless_UL6 UL", core::ptr::null_mut(), "UL6_VIRTUAL_INPUT"},
    ...
    {"UL8", core::ptr::null_mut(), "UL8_CH1"},
    {"UL8", core::ptr::null_mut(), "UL8_CH2"},
...
#[no_mangle]
unsafe extern "C" fn mt8186_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8186_afe_irq_handler(irq_id: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt8186_afe_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8186_afe_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8186_afe_component_probe(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8186_dai_memif_register(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8186_afe_pcm_dev_probe(pdev: *mut platform_device) -> c_int {
...
// register platform
    ...
    mt8186_afe_runtime_resume, core::ptr::null_mut())
    };
