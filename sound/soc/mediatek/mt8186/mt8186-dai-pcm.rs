...
//! Source: sound/soc/mediatek/mt8186/mt8186-dai-pcm.c
#![no_std]
...
// pcm out lpbk
    ...
    {"I2S0", core::ptr::null_mut(), "PCM_Out_Lpbk_Mux"},
// pcm in lpbk
    {"PCM_In_Lpbk_Mux", "Lpbk", "PCM 1 Capture"},
    {"I2S3", core::ptr::null_mut(), "PCM_In_Lpbk_Mux"},
    };
// dai ops
...
#[no_mangle]
pub unsafe extern "C" fn mt8186_dai_pcm_register(afe: *mut mtk_base_afe) -> c_int {
