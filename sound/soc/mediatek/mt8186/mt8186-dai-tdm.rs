...
//! Source: sound/soc/mediatek/mt8186/mt8186-dai-tdm.c
#![no_std]
...
pub struct mtk_afe_tdm_priv {
    pub id: c_uint,
    pub /: *mut *mut unsigned int rate; / for determine which apll to use,
    pub bck_invert: c_uint,
    pub lck_invert: c_uint,
    pub lrck_width: c_uint,
    pub mclk_id: c_uint,
    pub /: *mut *mut unsigned int mclk_multiple; / according to sample rate,
...
// low jitter control
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8186_afe_private *afe_priv = afe.platform_priv;
    let mut dai_id: c_int = get_tdm_id_by_name(kcontrol.id.name);
    struct mtk_afe_tdm_priv *tdm_priv = afe_priv.dai_priv[dai_id];
    ...
    {"TDM IN", core::ptr::null_mut(), "aud_tdm_clk"},
    {"TDM IN", core::ptr::null_mut(), "TDM_EN"},
    {"TDM IN", core::ptr::null_mut(), TDM_HD_EN_W_NAME, mtk_afe_tdm_hd_connect},
    {TDM_HD_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_tdm_apll_connect},
    {TDM_HD_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_tdm_apll_connect},
    {"TDM IN", core::ptr::null_mut(), TDM_MCLK_EN_W_NAME, mtk_afe_tdm_mclk_connect},
    {TDM_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_tdm_mclk_apll_connect},
    {TDM_MCLK_EN_W_NAME, core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_tdm_mclk_apll_connect},
// allow tdm on without codec on
    {"TDM IN", core::ptr::null_mut(), "TDM_In_Mux"},
...
// dai ops
    ...
    let mut tdm_mode: c_uint = tdm_priv.tdm_mode;
    let mut data_mode: c_uint = tdm_priv.data_mode;
    ...
    let mut slave_mode: bool = tdm_priv.slave_mode;
    let mut lrck_inv: bool = tdm_priv.lck_invert;
    let mut bck_inv: bool = tdm_priv.bck_invert;
