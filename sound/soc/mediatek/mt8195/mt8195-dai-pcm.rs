...
//! Source: sound/soc/mediatek/mt8195/mt8195-dai-pcm.c
#![no_std]
...
unsafe extern "C" fn mtk_dai_pcm_mode(rate: c_uint) -> c_int {
    ...
    PCM_INTF_CON1_PCM_EN_SHIFT, 0, core::ptr::null_mut(), 0),
...
#[no_mangle]
pub unsafe extern "C" fn mt8195_dai_pcm_register(afe: *mut mtk_base_afe) -> c_int {
