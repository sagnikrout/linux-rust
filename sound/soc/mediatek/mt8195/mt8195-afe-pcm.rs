...
//! Source: sound/soc/mediatek/mt8195/mt8195-afe-pcm.c
#![no_std]
...
pub unsafe extern "C" fn mt8195_afe_fs_timing(rate: c_uint) -> c_int {
    ...
    let mut fs: c_int = mt8195_afe_fs_timing(rate);
    ...
    unsigned int rate)
    {
    let mut fs: c_int = mt8195_memif_fs(substream, rate);
    switch (fs) {
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_memif_is_ul(id: c_int) -> c_int {
...
// DL8_DL10_MEM
    ...
    let mut ch_num: c_uint = params_channels(params);
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_fe_set_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
...
// DL11
    ...
    SND_SOC_DAPM_MIXER("I038", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I039", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I040", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I041", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I042", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I043", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I044", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I045", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// DL11/DL8
    ...
    SND_SOC_DAPM_MIXER("I062", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I063", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I064", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I065", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I066", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I067", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I068", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I069", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// DL2
...
// UL2
    ...
    {"I038", core::ptr::null_mut(), "DL11"},
    {"I039", core::ptr::null_mut(), "DL11"},
    {"I040", core::ptr::null_mut(), "DL11"},
    {"I041", core::ptr::null_mut(), "DL11"},
    {"I042", core::ptr::null_mut(), "DL11"},
    {"I043", core::ptr::null_mut(), "DL11"},
    {"I044", core::ptr::null_mut(), "DL11"},
    {"I045", core::ptr::null_mut(), "DL11"},
    ...
    {"I062", core::ptr::null_mut(), "DL8_DL11 Mux"},
    {"I063", core::ptr::null_mut(), "DL8_DL11 Mux"},
    {"I064", core::ptr::null_mut(), "DL8_DL11 Mux"},
    {"I065", core::ptr::null_mut(), "DL8_DL11 Mux"},
    {"I066", core::ptr::null_mut(), "DL8_DL11 Mux"},
    {"I067", core::ptr::null_mut(), "DL8_DL11 Mux"},
    {"I068", core::ptr::null_mut(), "DL8_DL11 Mux"},
    {"I069", core::ptr::null_mut(), "DL8_DL11 Mux"},
    ...
    let mut dai_id: c_uint = kcontrol.id.device;
    let mut val: c_long = ucontrol.value.integer.value[0];
    let mut ret: c_int = 0;
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
    struct mt8195_afe_private *afe_priv = afe.platform_priv;
    let mut id: c_uint = kcontrol.id.device;
    let mut val: c_long = ucontrol.value.integer.value[0];
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn mt8195_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_irq_handler(irq_id: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t mt8195_afe_irq_handler(int irq_id, void *dev_id)
    {
    struct mtk_base_afe *afe = dev_id;
    let mut val: c_uint = 0;
    let mut asys_irq_clr_bits: c_uint = 0;
    let mut afe_irq_clr_bits: c_uint = 0;
    let mut irq_status_bits: c_uint = 0;
    let mut irq_clr_bits: c_uint = 0;
    let mut mcu_irq_mask: c_uint = 0;
    let mut i: c_int = 0;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_memif_priv_data(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_dai_memif_register(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_pcm_dev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_pcm_dev_remove(pdev: *mut platform_device) {
    ...
    mt8195_afe_runtime_resume, core::ptr::null_mut())
    };
