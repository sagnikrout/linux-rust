...
//! Source: sound/soc/mediatek/mt8195/mt8195-dai-adda.c
#![no_std]
...
pub const ADDA_DL_GAIN_LOOPBACK: c_uint = 0x1800;
pub const ADDA_HIRES_THRES: c_int = 48000;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dai_adda_priv {
    pub hires_required: bool,
}

#[no_mangle]
unsafe extern "C" fn mt8195_adda_mtkaif_init(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_adda_ul_mictype(afe: *mut mtk_base_afe, adda: c_int, dmic: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstr(name, _arg: "aud_adda6_adc_hires")) -> else {
    else if (strstr(name, "aud_adda6_adc_hires"))
    dai_id = MT8195_AFE_IO_UL_SRC2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstr(name, _arg: "aud_dac_hires")) -> else {
    ...
    if (!adda_priv) {
    dev_info(afe.dev, "adda_priv == core::ptr::null_mut()");
    return 0;
    }
    ...
    SND_SOC_DAPM_MIXER("I168", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I169", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I170", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I171", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    DL_2_GAIN_ON_CTL_PRE_SHIFT, 0, core::ptr::null_mut(), 0),
    ...
    {"ADDA Capture", core::ptr::null_mut(), "aud_adc"},
    {"ADDA Capture", core::ptr::null_mut(), "aud_adc_hires", mtk_afe_adda_hires_connect},
    {"aud_adc_hires", core::ptr::null_mut(), "AUDIO_HIRES"},
    {"ADDA6 Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"ADDA6 Capture", core::ptr::null_mut(), "ADDA6 Capture Enable"},
    {"ADDA6 Capture", core::ptr::null_mut(), "ADDA_MTKAIF_CFG"},
    {"ADDA6 Capture", core::ptr::null_mut(), "aud_adda6_adc"},
    {"ADDA6 Capture", core::ptr::null_mut(), "aud_adda6_adc_hires",
    mtk_afe_adda_hires_connect},
    {"aud_adda6_adc_hires", core::ptr::null_mut(), "AUDIO_HIRES"},
    {"I168", core::ptr::null_mut(), "ADDA Capture"},
    {"I169", core::ptr::null_mut(), "ADDA Capture"},
    {"I170", core::ptr::null_mut(), "ADDA6 Capture"},
    {"I171", core::ptr::null_mut(), "ADDA6 Capture"},
    {"ADDA Playback", core::ptr::null_mut(), "ADDA Enable"},
    {"ADDA Playback", core::ptr::null_mut(), "ADDA Playback Enable"},
    {"ADDA Playback", core::ptr::null_mut(), "aud_dac"},
    {"ADDA Playback", core::ptr::null_mut(), "aud_dac_hires", mtk_afe_adda_hires_connect},
    {"aud_dac_hires", core::ptr::null_mut(), "AUDIO_HIRES"},
    {"DL_GAIN", core::ptr::null_mut(), "O176"},
    {"DL_GAIN", core::ptr::null_mut(), "O177"},
    {"DL_GAIN_MUX", "Bypass", "O176"},
    {"DL_GAIN_MUX", "Bypass", "O177"},
    {"DL_GAIN_MUX", "Connect", "DL_GAIN"},
    {"ADDA Playback", core::ptr::null_mut(), "DL_GAIN_MUX"},
    ...
    {"ADDA Capture", core::ptr::null_mut(), "ADDA_INPUT"},
    {"ADDA6 Capture", core::ptr::null_mut(), "ADDA_INPUT"},
    {"ADDA_OUTPUT", core::ptr::null_mut(), "ADDA Playback"},
    };
    ...
    let mut reg: c_uint = AFE_ADDA_DL_SRC2_CON1;
    let mut mask: c_uint = DL_2_GAIN_CTL_PRE_MASK;
    let mut value: c_uint = (unsigned int)(ucontrol.value.integer.value[0]);
...
#[no_mangle]
unsafe extern "C" fn init_adda_priv_data(afe: *mut mtk_base_afe) -> c_int {
