...
//! Source: sound/soc/mediatek/mt8195/mt8195-dai-etdm.c
#![no_std]
...
pub const MT8195_ETDM_MAX_CHANNELS: c_int = 24;
pub const MT8195_ETDM_NORMAL_MAX_BCK_RATE: c_int = 24576000;
...
pub struct mtk_dai_etdm_priv {
    ...
    pub //dai_id: int cowork_slv_id[MT8195_AFE_IO_ETDM_NUM - 1];,
    pub in_disable_ch: [bool; MT8195_ETDM_MAX_CHANNELS],
    pub en_ref_cnt: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_etdm_is_valid(id: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_hdmitx_dptx_is_valid(id: c_int) -> bool {
...
// eTDM_IN1
    ...
    SND_SOC_DAPM_MIXER("I088", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I089", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I090", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I091", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I092", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I093", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I094", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I095", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// eTDM_OUT2
...
// eTDM_OUT3
    ...
    {"I012", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I013", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I014", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I015", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I016", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I017", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I018", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I019", core::ptr::null_mut(), "ETDM2 Capture"},
    {"I072", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I073", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I074", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I075", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I076", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I077", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I078", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I079", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I080", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I081", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I082", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I083", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I084", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I085", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I086", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I087", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I088", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I089", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I090", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I091", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I092", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I093", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I094", core::ptr::null_mut(), "ETDM1 Capture"},
    {"I095", core::ptr::null_mut(), "ETDM1 Capture"},
    {"UL8", core::ptr::null_mut(), "ETDM1 Capture"},
    {"UL3", core::ptr::null_mut(), "ETDM2 Capture"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O048"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O049"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O050"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O051"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O052"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O053"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O054"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O055"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O056"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O057"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O058"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O059"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O060"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O061"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O062"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O063"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O064"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O065"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O066"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O067"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O068"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O069"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O070"},
    {"ETDM2 Playback", core::ptr::null_mut(), "O071"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O072"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O073"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O074"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O075"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O076"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O077"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O078"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O079"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O080"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O081"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O082"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O083"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O084"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O085"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O086"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O087"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O088"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O089"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O090"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O091"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O092"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O093"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O094"},
    {"ETDM1 Playback", core::ptr::null_mut(), "O095"},
    ...
    {"ETDM3 Playback", core::ptr::null_mut(), "HDMI_OUT_MUX"},
    {"DPTX Playback", core::ptr::null_mut(), "DPTX_OUT_MUX"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "DPTX Playback"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "ETDM1 Playback"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "ETDM2 Playback"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "ETDM3 Playback"},
    {"ETDM1 Capture", core::ptr::null_mut(), "ETDM_INPUT"},
    {"ETDM2 Capture", core::ptr::null_mut(), "ETDM_INPUT"},
    };
#[no_mangle]
unsafe extern "C" fn mt8195_afe_enable_etdm(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_afe_disable_etdm(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_etdm_sync_mode_configure(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MT8195_AFE_IO_ETDM2_OUT: dai_id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_mclk_configure(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
    static int mtk_dai_etdm_mclk_configure(struct mtk_base_afe *afe, int dai_id)
    {
    struct mt8195_afe_private *afe_priv = afe.platform_priv;
    struct mtk_dai_etdm_priv *etdm_data;
    let mut clk_id: c_int = mtk_dai_etdm_get_clk_id_by_dai_id(dai_id);
    let mut clkdiv_id: c_int = mtk_dai_etdm_get_clkdiv_id_by_dai_id(dai_id);
    int apll;
    int apll_clk_id;
    struct etdm_con_reg etdm_reg;
...
unsafe extern "C" fn mtk_dai_etdm_set_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
    ...
    struct mtk_base_afe *afe = snd_soc_dai_get_drvdata(dai);
    struct mt8195_afe_private *afe_priv = afe.platform_priv;
    let mut cg_id: c_int = mtk_dai_etdm_get_cg_id_by_dai_id(dai.id);
    if (cg_id >= 0)
    mt8195_afe_enable_clk(afe, afe_priv.clk[cg_id]);
    mtk_dai_etdm_enable_mclk(afe, dai.id);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_probe(dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_etdm_update_sync_info(afe: *mut mtk_base_afe) {
...
#[no_mangle]
unsafe extern "C" fn mt8195_dai_etdm_parse_of(afe: *mut mtk_base_afe) {
    ...
    let mut max_chn: c_int = MT8195_ETDM_MAX_CHANNELS;
    u32 sel;
    int ret;
    int dai_id;
...
#[no_mangle]
pub unsafe extern "C" fn mt8195_dai_etdm_register(afe: *mut mtk_base_afe) -> c_int {
