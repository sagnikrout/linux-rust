...
//! Source: sound/soc/mediatek/mt8195/mt8195-mt6359.c
#![no_std]
...
// headset
    ...
    { "Left Spk", core::ptr::null_mut(), "Left SPO" },
    { "Right Spk", core::ptr::null_mut(), "Right SPO" },
    };
    static const struct snd_soc_dapm_route mt8195_rt1019_routes[] = {
    { "Ext Spk", core::ptr::null_mut(), "Speaker" },
    };
...
unsafe extern "C" fn mt8195_rt5682_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    ret = snd_soc_component_set_jack(cmpnt_codec, jack, core::ptr::null_mut());
    if (ret) {
...
unsafe extern "C" fn mt8195_mt6359_legacy_probe(soc_card_data: *mut mtk_soc_card_data) -> c_int {
    ...
    codec_node = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "realtek,rt5682s");
    is5682s = true;
    } else {
    codec_node = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "realtek,rt5682i");
    is5682s = false;
    }
    ...
    dai_link.codecs.name = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mt8195_mt6359_soc_card_probe(soc_card_data: *mut mtk_soc_card_data, legacy: bool) -> c_int {
