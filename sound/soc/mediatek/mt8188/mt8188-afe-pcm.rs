...
//! Source: sound/soc/mediatek/mt8188/mt8188-afe-pcm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt8188_afe_fs_timing(rate: c_uint) -> c_int {
    ...
    let mut fs: c_int = mt8188_afe_fs_timing(rate);
    ...
    unsigned int rate)
    {
    let mut fs: c_int = mt8188_memif_fs(substream, rate);
    switch (fs) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt8188_afe_channel_merge {
    pub id: c_int,
    pub reg: c_int,
...
#[no_mangle]
unsafe extern "C" fn mt8188_afe_memif_is_ul(id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8188_afe_irq_handler(irq_id: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt8188_afe_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_afe_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_dai_memif_register(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_afe_init_registers(afe: *mut mtk_base_afe) -> c_int {
...
pub const MT8188_DELAY_US: c_int = 10;

#[no_mangle]
unsafe extern "C" fn bus_protect_enable(regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bus_protect_disable(regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_afe_pcm_dev_probe(pdev: *mut platform_device) -> c_int {
