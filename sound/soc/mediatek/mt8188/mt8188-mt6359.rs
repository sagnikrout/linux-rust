...
//! Source: sound/soc/mediatek/mt8188/mt8188-mt6359.c
#![no_std]
...
// BE
    ...
    SND_SOC_DAPM_SPK("Rear Left Spk", core::ptr::null_mut()),
    SND_SOC_DAPM_SPK("Rear Right Spk", core::ptr::null_mut()),
    };
    ...
    SND_SOC_DAPM_MIC("AP DMIC", core::ptr::null_mut()),
    SND_SOC_DAPM_SINK("HDMI"),
    SND_SOC_DAPM_SINK("DP"),
    SND_SOC_DAPM_MIXER(SOF_DMA_DL2, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER(SOF_DMA_DL3, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER(SOF_DMA_UL4, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER(SOF_DMA_UL5, SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// dynamic pinctrl
...
// SOF Uplink
    {SOF_DMA_UL4, core::ptr::null_mut(), "O034"},
    {SOF_DMA_UL4, core::ptr::null_mut(), "O035"},
    {SOF_DMA_UL5, core::ptr::null_mut(), "O036"},
    {SOF_DMA_UL5, core::ptr::null_mut(), "O037"},
// SOF Downlink
    {"I070", core::ptr::null_mut(), SOF_DMA_DL2},
    {"I071", core::ptr::null_mut(), SOF_DMA_DL2},
    {"I020", core::ptr::null_mut(), SOF_DMA_DL3},
    {"I021", core::ptr::null_mut(), SOF_DMA_DL3},
    };
#[no_mangle]
unsafe extern "C" fn mt8188_mt6359_mtkaif_calibration(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    struct snd_soc_dapm_widget *pin_w = core::ptr::null_mut(), *w;
    ...
    if (pin_w)
    snd_soc_dapm_pinctrl_event(pin_w, core::ptr::null_mut(), SND_SOC_DAPM_PRE_PMU);
    else
...
// handle if never test done
    ...
    if (pin_w)
    snd_soc_dapm_pinctrl_event(pin_w, core::ptr::null_mut(), SND_SOC_DAPM_POST_PMD);
...
// Configure pll for codec
    ...
    {
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd(substream);
    struct snd_soc_component *cmpnt_afe = core::ptr::null_mut();
...
unsafe extern "C" fn mt8188_mt6359_soc_card_probe(soc_card_data: *mut mtk_soc_card_data, legacy: bool) -> c_int {
    ...
    let mut init_mt6359: bool = false;
    let mut init_es8326: bool = false;
    let mut init_nau8825: bool = false;
    let mut init_rt5682s: bool = false;
    let mut init_max98390: bool = false;
    let mut init_dumb: bool = false;
    int i;
    if (legacy)
    return -EINVAL;
