...
//! Source: sound/soc/mediatek/mt8188/mt8188-dai-etdm.c
#![no_std]
...
pub const MT8188_ETDM_MAX_CHANNELS: c_int = 16;
pub const MT8188_ETDM_NORMAL_MAX_BCK_RATE: c_int = 24576000;
...
pub struct mtk_dai_etdm_priv {
    ...
    pub mclk_fixed_apll: c_uint,
    pub mclk_apll: c_uint,
    pub mclk_dir: c_uint,
    pub id: int cowork_source_id; //dai,
    pub cowork_slv_count: c_uint,
    pub //dai_id: int cowork_slv_id[MT8188_AFE_IO_ETDM_NUM - 1];,
    pub in_disable_ch: [bool; MT8188_ETDM_MAX_CHANNELS],
}
...
#[no_mangle]
unsafe extern "C" fn get_etdm_fs_timing(rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_etdm_reg(dai_id: c_uint, etdm_reg: *mut etdm_con_reg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_etdm_dir(dai_id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_valid_etdm_dai(dai_id: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_cowork_mode(dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sync_to_dai_id(source_sel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_etdm_cowork_master_id(dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_get_cg_id_by_dai_id(dai_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_get_clk_id_by_dai_id(dai_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_get_clkdiv_id_by_dai_id(dai_id: c_int) -> c_int {
    ...
    return MT8188_AFE_IO_ETDM1_IN;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "ETDM2_IN", _arg: strlen("ETDM2_IN"))) -> else {
    else if (!strncmp(name, "ETDM2_IN", strlen("ETDM2_IN")))
    return MT8188_AFE_IO_ETDM2_IN;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "ETDM1_OUT", _arg: strlen("ETDM1_OUT"))) -> else {
    else if (!strncmp(name, "ETDM1_OUT", strlen("ETDM1_OUT")))
    return MT8188_AFE_IO_ETDM1_OUT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "ETDM2_OUT", _arg: strlen("ETDM2_OUT"))) -> else {
    else if (!strncmp(name, "ETDM2_OUT", strlen("ETDM2_OUT")))
    return MT8188_AFE_IO_ETDM2_OUT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "ETDM3_OUT", _arg: strlen("ETDM3_OUT"))) -> else {
    else if (!strncmp(name, "ETDM3_OUT", strlen("ETDM3_OUT")))
    return MT8188_AFE_IO_ETDM3_OUT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "DPTX", _arg: strlen("DPTX"))) -> else {
    ...
    {
    struct mt8188_afe_private *afe_priv = afe.platform_priv;
    let mut dai_id: c_int = get_etdm_id_by_name(afe, name);
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_enable_mclk(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
    ...
    unsigned int mask;
    let mut clkmux_id: c_int = mtk_dai_etdm_get_clk_id_by_dai_id(dai_id);
    let mut clkdiv_id: c_int = mtk_dai_etdm_get_clkdiv_id_by_dai_id(dai_id);
    int apll_clk_id;
    int apll;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_disable_mclk(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
    ...
    if (!etdm_priv) {
    dev_dbg(afe.dev, "etdm_priv == core::ptr::null_mut()\n");
    return 0;
    }
    ...
    etdm_priv = get_etdm_priv_by_name(afe, w.name);
    if (!etdm_priv) {
    dev_dbg(afe.dev, "%s() etdm_priv == core::ptr::null_mut()\n", __func__);
    return 0;
    }
    ...
    struct snd_soc_component *cmpnt = snd_soc_dapm_to_component(w.dapm);
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    let mut mclk_id: c_int = get_etdm_id_by_name(afe, w.name);
    if (mclk_id < 0) {
...
// HDMI_CH0_MUX ~ HDMI_CH7_MUX
    ...
    let mut source: c_uint = ucontrol.value.enumerated.item[0];
    unsigned int val;
...
// eTDM_IN2
    SND_SOC_DAPM_MIXER("I012", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I013", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I014", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I015", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I016", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I017", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I018", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I019", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I188", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I189", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I190", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I191", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I192", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I193", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I194", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I195", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// eTDM_IN1
    SND_SOC_DAPM_MIXER("I072", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I073", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I074", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I075", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I076", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I077", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I078", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I079", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I080", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I081", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I082", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I083", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I084", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I085", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I086", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I087", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
// eTDM_OUT2
...
// en
    ...
    ETDM_IN1_CON0, ETDM_CON0_EN_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY_S("ETDM2_IN_EN", SUPPLY_SEQ_ETDM_EN,
    ETDM_IN2_CON0, ETDM_CON0_EN_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY_S("ETDM1_OUT_EN", SUPPLY_SEQ_ETDM_EN,
    ETDM_OUT1_CON0, ETDM_CON0_EN_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY_S("ETDM2_OUT_EN", SUPPLY_SEQ_ETDM_EN,
    ETDM_OUT2_CON0, ETDM_CON0_EN_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY_S("ETDM3_OUT_EN", SUPPLY_SEQ_ETDM_EN,
    ETDM_OUT3_CON0, ETDM_CON0_EN_SHIFT, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_SUPPLY_S("DPTX_EN", SUPPLY_SEQ_DPTX_EN,
    AFE_DPTX_CON, AFE_DPTX_CON_ON_SHIFT, 0, core::ptr::null_mut(), 0),
// apll
...
// mclk
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM1_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM2_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM1_OUT_MCLK", mtk_etdm_mclk_connect},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM2_OUT_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM1_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM2_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM1_OUT_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM2_OUT_MCLK", mtk_etdm_mclk_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM1_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM2_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM1_OUT_MCLK", mtk_etdm_mclk_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM2_OUT_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM1_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM2_IN_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM1_OUT_MCLK", mtk_etdm_mclk_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM2_OUT_MCLK", mtk_etdm_mclk_connect},
    {"DPTX", core::ptr::null_mut(), "DPTX_MCLK"},
    {"ETDM1_IN_MCLK", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {"ETDM1_IN_MCLK", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"ETDM2_IN_MCLK", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {"ETDM2_IN_MCLK", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"ETDM1_OUT_MCLK", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {"ETDM1_OUT_MCLK", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"ETDM2_OUT_MCLK", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {"ETDM2_OUT_MCLK", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
    {"DPTX_MCLK", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_mclk_apll_connect},
    {"DPTX_MCLK", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_mclk_apll_connect},
// cg
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM1_IN_CG"},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM2_IN_CG", mtk_etdm_cowork_connect},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM1_OUT_CG", mtk_etdm_cowork_connect},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM2_OUT_CG", mtk_etdm_cowork_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM1_IN_CG", mtk_etdm_cowork_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM2_IN_CG"},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM1_OUT_CG", mtk_etdm_cowork_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM2_OUT_CG", mtk_etdm_cowork_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM1_IN_CG", mtk_etdm_cowork_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM2_IN_CG", mtk_etdm_cowork_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM1_OUT_CG"},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM2_OUT_CG", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM1_IN_CG", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM2_IN_CG", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM1_OUT_CG", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM2_OUT_CG"},
    {"ETDM3_OUT", core::ptr::null_mut(), "ETDM3_OUT_CG"},
    {"DPTX", core::ptr::null_mut(), "ETDM3_OUT_CG"},
// en
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM1_IN_EN"},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM2_IN_EN", mtk_etdm_cowork_connect},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM1_OUT_EN", mtk_etdm_cowork_connect},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM2_OUT_EN", mtk_etdm_cowork_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM1_IN_EN", mtk_etdm_cowork_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM2_IN_EN"},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM1_OUT_EN", mtk_etdm_cowork_connect},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM2_OUT_EN", mtk_etdm_cowork_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM1_IN_EN", mtk_etdm_cowork_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM2_IN_EN", mtk_etdm_cowork_connect},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM1_OUT_EN"},
    {"ETDM1_OUT", core::ptr::null_mut(), "ETDM2_OUT_EN", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM1_IN_EN", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM2_IN_EN", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM1_OUT_EN", mtk_etdm_cowork_connect},
    {"ETDM2_OUT", core::ptr::null_mut(), "ETDM2_OUT_EN"},
    {"ETDM3_OUT", core::ptr::null_mut(), "ETDM3_OUT_EN"},
    {"DPTX", core::ptr::null_mut(), "ETDM3_OUT_EN"},
    {"DPTX", core::ptr::null_mut(), "DPTX_EN"},
    {"ETDM1_IN_EN", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM1_IN_EN", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM2_IN_EN", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM2_IN_EN", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM1_OUT_EN", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM1_OUT_EN", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM2_OUT_EN", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM2_OUT_EN", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM3_OUT_EN", core::ptr::null_mut(), APLL1_W_NAME, mtk_afe_etdm_apll_connect},
    {"ETDM3_OUT_EN", core::ptr::null_mut(), APLL2_W_NAME, mtk_afe_etdm_apll_connect},
    {"I012", core::ptr::null_mut(), "ETDM2_IN"},
    {"I013", core::ptr::null_mut(), "ETDM2_IN"},
    {"I014", core::ptr::null_mut(), "ETDM2_IN"},
    {"I015", core::ptr::null_mut(), "ETDM2_IN"},
    {"I016", core::ptr::null_mut(), "ETDM2_IN"},
    {"I017", core::ptr::null_mut(), "ETDM2_IN"},
    {"I018", core::ptr::null_mut(), "ETDM2_IN"},
    {"I019", core::ptr::null_mut(), "ETDM2_IN"},
    {"I188", core::ptr::null_mut(), "ETDM2_IN"},
    {"I189", core::ptr::null_mut(), "ETDM2_IN"},
    {"I190", core::ptr::null_mut(), "ETDM2_IN"},
    {"I191", core::ptr::null_mut(), "ETDM2_IN"},
    {"I192", core::ptr::null_mut(), "ETDM2_IN"},
    {"I193", core::ptr::null_mut(), "ETDM2_IN"},
    {"I194", core::ptr::null_mut(), "ETDM2_IN"},
    {"I195", core::ptr::null_mut(), "ETDM2_IN"},
    {"I072", core::ptr::null_mut(), "ETDM1_IN"},
    {"I073", core::ptr::null_mut(), "ETDM1_IN"},
    {"I074", core::ptr::null_mut(), "ETDM1_IN"},
    {"I075", core::ptr::null_mut(), "ETDM1_IN"},
    {"I076", core::ptr::null_mut(), "ETDM1_IN"},
    {"I077", core::ptr::null_mut(), "ETDM1_IN"},
    {"I078", core::ptr::null_mut(), "ETDM1_IN"},
    {"I079", core::ptr::null_mut(), "ETDM1_IN"},
    {"I080", core::ptr::null_mut(), "ETDM1_IN"},
    {"I081", core::ptr::null_mut(), "ETDM1_IN"},
    {"I082", core::ptr::null_mut(), "ETDM1_IN"},
    {"I083", core::ptr::null_mut(), "ETDM1_IN"},
    {"I084", core::ptr::null_mut(), "ETDM1_IN"},
    {"I085", core::ptr::null_mut(), "ETDM1_IN"},
    {"I086", core::ptr::null_mut(), "ETDM1_IN"},
    {"I087", core::ptr::null_mut(), "ETDM1_IN"},
    {"UL8", core::ptr::null_mut(), "ETDM1_IN"},
    {"UL3", core::ptr::null_mut(), "ETDM2_IN"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O048"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O049"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O050"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O051"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O052"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O053"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O054"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O055"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O056"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O057"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O058"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O059"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O060"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O061"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O062"},
    {"ETDM2_OUT", core::ptr::null_mut(), "O063"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O072"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O073"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O074"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O075"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O076"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O077"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O078"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O079"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O080"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O081"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O082"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O083"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O084"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O085"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O086"},
    {"ETDM1_OUT", core::ptr::null_mut(), "O087"},
    ...
    {"ETDM3_OUT", core::ptr::null_mut(), "HDMI_OUT_MUX"},
    {"DPTX", core::ptr::null_mut(), "DPTX_OUT_MUX"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "DPTX"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "ETDM1_OUT"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "ETDM2_OUT"},
    {"ETDM_OUTPUT", core::ptr::null_mut(), "ETDM3_OUT"},
    {"ETDM1_IN", core::ptr::null_mut(), "ETDM_INPUT"},
    {"ETDM2_IN", core::ptr::null_mut(), "ETDM_INPUT"},
    };
#[no_mangle]
unsafe extern "C" fn etdm_cowork_slv_sel(id: c_int, slave_mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etdm_cowork_sync_sel(id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_etdm_sync_mode_slv(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_etdm_sync_mode_mst(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_etdm_sync_mode_configure(afe: *mut mtk_base_afe, dai_id: c_int) -> c_int {
...
// dai ops
    ...
    let mut reg: c_uint = 0;
    let mut val: c_uint = 0;
    let mut mask: c_uint = (ETDM_IN_AFIFO_MODE_MASK | ETDM_IN_USE_AFIFO);
    if (rate != 0)
...
#[no_mangle]
pub unsafe extern "C" fn if(MT8188_AFE_IO_ETDM2_OUT: dai_id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_etdm_cal_mclk(afe: *mut mtk_base_afe, freq: c_int, dai_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_get_dptx_ch_en(channel: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_get_dptx_ch(ch: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_get_dptx_wlen(format: snd_pcm_format_t) -> c_uint {
    ...
    let mut width: c_int = snd_pcm_format_physical_width(format);
    if (!is_valid_etdm_dai(dai.id))
    return -EINVAL;
    etdm_data = afe_priv.dai_priv[dai.id];
// dptx configure
...
#[no_mangle]
unsafe extern "C" fn mt8188_etdm_update_sync_info(afe: *mut mtk_base_afe) {
...
#[no_mangle]
unsafe extern "C" fn mt8188_dai_etdm_parse_of(afe: *mut mtk_base_afe) {
    ...
    let mut max_chn: c_int = MT8188_ETDM_MAX_CHANNELS;
...
#[no_mangle]
unsafe extern "C" fn init_etdm_priv_data(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt8188_dai_etdm_register(afe: *mut mtk_base_afe) -> c_int {
