...
//! Source: sound/soc/mediatek/mt8188/mt8188-dai-adda.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtk_adda_ul_mictype(afe: *mut mtk_base_afe, dmic: bool) {
    static void mtk_adda_ul_mictype(struct mtk_base_afe *afe, bool dmic)
    {
    let mut reg: c_uint = AFE_ADDA_UL_SRC_CON0;
    unsigned int val;
...
pub unsafe extern "C" fn if(_arg: strstr(name, _arg: "aud_dac_hires")) -> else {
    ...
    if (!adda_priv) {
    dev_dbg(afe.dev, "adda_priv == core::ptr::null_mut()");
    return 0;
    }
