...
//! Source: sound/soc/mediatek/mt8188/mt8188-dai-dmic.c
#![no_std]
...
pub const CLK_PHASE_SEL_CH1: c_int = 0;

pub const DMIC1_SRC_SEL: c_int = 0;
pub const DMIC2_SRC_SEL: c_int = 0;
pub const DMIC3_SRC_SEL: c_int = 2;
pub const DMIC4_SRC_SEL: c_int = 0;
pub const DMIC5_SRC_SEL: c_int = 4;
pub const DMIC6_SRC_SEL: c_int = 0;
pub const DMIC7_SRC_SEL: c_int = 6;
pub const DMIC8_SRC_SEL: c_int = 0;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dai_dmic_ctrl_reg {
    pub con0: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dai_dmic_hw_gain_ctrl_reg {
    pub bypass: c_uint,
    pub con0: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dai_dmic_priv {
    pub gain_on: [c_uint; DMIC_NUM],
    pub channels: c_uint,
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_dmic_load_iir_coeff_table(afe: *mut mtk_base_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_dmic_configure_array(dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dmic_channels_to_dmic_number(channels: c_uint) -> u8 {
    ...
    struct mt8188_afe_private *afe_priv = afe.platform_priv;
    struct mtk_dai_dmic_priv *dmic_priv = afe_priv.dai_priv[MT8188_AFE_IO_DMIC_IN];
    let mut channels: c_uint = dmic_priv.channels;
    ...
    struct mt8188_afe_private *afe_priv = afe.platform_priv;
    struct mtk_dai_dmic_priv *dmic_priv = afe_priv.dai_priv[MT8188_AFE_IO_DMIC_IN];
    const struct mtk_dai_dmic_ctrl_reg *reg = core::ptr::null_mut();
    let mut channels: c_uint = dmic_priv.channels;
    unsigned int msk;
    u8 dmic_num;
    int i;
...
// should delayed 1/fs(smallest is 8k) = 125us before afe off
    ...
    SND_SOC_DAPM_MIXER("I004", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I005", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I006", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I007", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I008", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I009", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I010", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I011", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    {"I004", core::ptr::null_mut(), "DMIC Capture"},
    {"I005", core::ptr::null_mut(), "DMIC Capture"},
    {"I006", core::ptr::null_mut(), "DMIC Capture"},
    {"I007", core::ptr::null_mut(), "DMIC Capture"},
    {"I008", core::ptr::null_mut(), "DMIC Capture"},
    {"I009", core::ptr::null_mut(), "DMIC Capture"},
    {"I010", core::ptr::null_mut(), "DMIC Capture"},
    {"I011", core::ptr::null_mut(), "DMIC Capture"},
    {"DMIC Capture", core::ptr::null_mut(), "DMIC_CK_ON"},
    {"DMIC Capture", core::ptr::null_mut(), "DMIC_GAIN_ON"},
    {"DMIC Capture", core::ptr::null_mut(), "DMIC_INPUT"},
    };
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(kcontrol->id.name, _arg: "DMIC2_HW_GAIN_EN")) -> else {
    else if (!strcmp(kcontrol.id.name, "DMIC2_HW_GAIN_EN"))
    cached = &dmic_priv.gain_on[1];
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(kcontrol->id.name, _arg: "DMIC3_HW_GAIN_EN")) -> else {
    else if (!strcmp(kcontrol.id.name, "DMIC3_HW_GAIN_EN"))
    cached = &dmic_priv.gain_on[2];
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(kcontrol->id.name, _arg: "DMIC4_HW_GAIN_EN")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mt8188_dai_dmic_register(afe: *mut mtk_base_afe) -> c_int {
