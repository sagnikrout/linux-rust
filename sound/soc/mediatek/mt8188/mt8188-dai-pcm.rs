...
//! Source: sound/soc/mediatek/mt8188/mt8188-dai-pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_pcm_mode(rate: c_uint) -> c_int {
    ...
    SND_SOC_DAPM_MIXER("I002", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    SND_SOC_DAPM_MIXER("I003", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
    ...
    SND_SOC_DAPM_SUPPLY("PCM_1_EN", PCM_INTF_CON1, 0, 0, core::ptr::null_mut(), 0),
    ...
    {"I002", core::ptr::null_mut(), "PCM1 Capture"},
    {"I003", core::ptr::null_mut(), "PCM1 Capture"},
    {"O000", "I000 Switch", "I000"},
    {"O001", "I001 Switch", "I001"},
    {"O000", "I070 Switch", "I070"},
    {"O001", "I071 Switch", "I071"},
    {"PCM1 Playback", core::ptr::null_mut(), "O000"},
    {"PCM1 Playback", core::ptr::null_mut(), "O001"},
    {"PCM1 Playback", core::ptr::null_mut(), "PCM_1_EN"},
    {"PCM1 Playback", core::ptr::null_mut(), "aud_asrc12"},
    {"PCM1 Playback", core::ptr::null_mut(), "aud_pcmif"},
    {"PCM1 Capture", core::ptr::null_mut(), "PCM_1_EN"},
    {"PCM1 Capture", core::ptr::null_mut(), "aud_asrc11"},
    {"PCM1 Capture", core::ptr::null_mut(), "aud_pcmif"},
    {"PCM1_OUTPUT", core::ptr::null_mut(), "PCM1 Playback"},
    {"PCM1 Capture", core::ptr::null_mut(), "PCM1_INPUT"},
    };
    ...
    struct mtk_dai_pcmif_priv *pcmif_priv = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtk_dai_pcm_set_fmt(dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt8188_dai_pcm_register(afe: *mut mtk_base_afe) -> c_int {
