...
//! Source: sound/soc/mediatek/mt8189/mt8189-dai-pcm.c
#![no_std]
...
// inter-connections
    ...
    {"PCM 0 Playback", core::ptr::null_mut(), "PCM_0_PB_CH1"},
    {"PCM 0 Playback", core::ptr::null_mut(), "PCM_0_PB_CH2"},
    {"PCM 0 Playback", core::ptr::null_mut(), "PCM_0_PB_CH4"},
    {"PCM 0 Playback", core::ptr::null_mut(), "PCM_0_EN"},
    {"PCM 0 Capture", core::ptr::null_mut(), "PCM_0_EN"},
    {"PCM 0 Playback", core::ptr::null_mut(), "PCM0_CG"},
    {"PCM 0 Capture", core::ptr::null_mut(), "PCM0_CG"},
    {"AFE_PCM_OUTPUT", core::ptr::null_mut(), "PCM 0 Playback"},
    {"PCM 0 Capture", core::ptr::null_mut(), "AFE_PCM_INPUT"},
...
// dai ops
    ...
    let mut rate_reg: c_uint = pcm_rate_transform(afe.dev, rate);
    let mut x_rate_reg: c_uint = pcm_1x_rate_transform(afe.dev, rate);
