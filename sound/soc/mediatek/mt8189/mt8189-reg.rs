...
//! Source: sound/soc/mediatek/mt8189/mt8189-reg.h
#![no_std]
...
pub const PDN_DL0_NLE_SFT: c_int = 11;
pub const PDN_DL0_NLE_MASK: c_uint = 0x1;

pub const PDN_DL0_PREDIS_SFT: c_int = 10;
pub const PDN_DL0_PREDIS_MASK: c_uint = 0x1;

pub const PDN_DL0_DAC_SFT: c_int = 9;
pub const PDN_DL0_DAC_MASK: c_uint = 0x1;

pub const PDN_DL0_DAC_HIRES_SFT: c_int = 8;
pub const PDN_DL0_DAC_HIRES_MASK: c_uint = 0x1;

pub const PDN_DL0_DAC_TML_SFT: c_int = 7;
pub const PDN_DL0_DAC_TML_MASK: c_uint = 0x1;
...
pub const PDN_DMIC0_ADC_SFT: c_int = 7;
pub const PDN_DMIC0_ADC_MASK: c_uint = 0x1;

pub const PDN_DMIC1_ADC_SFT: c_int = 3;
pub const PDN_DMIC1_ADC_MASK: c_uint = 0x1;
...
// AFE_GAIN2_CON2
// AFE_GAIN3_CON2
pub const GAIN_DOWN_STEP_SFT: c_int = 0;
pub const GAIN_DOWN_STEP_MASK: c_uint = 0x3fffff;

// AFE_GAIN0_CON3
// AFE_GAIN1_CON3
// AFE_GAIN2_CON3
// AFE_GAIN3_CON3
pub const GAIN_UP_STEP_SFT: c_int = 0;
pub const GAIN_UP_STEP_MASK: c_uint = 0x3fffff;
...
pub const RG_DL_IPM_VER_MON_SFT: c_int = 0;
pub const RG_DL_IPM_VER_MON_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_SRC_CON0
pub const AFE_DL_INPUT_MODE_CTL_SFT: c_int = 24;
pub const AFE_DL_INPUT_MODE_CTL_MASK: c_uint = 0x1f;

pub const AFE_DL_CH1_SATURATION_EN_CTL_SFT: c_int = 21;
pub const AFE_DL_CH1_SATURATION_EN_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_CH2_SATURATION_EN_CTL_SFT: c_int = 20;
pub const AFE_DL_CH2_SATURATION_EN_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_OUTPUT_SEL_CTL_SFT: c_int = 18;
pub const AFE_DL_OUTPUT_SEL_CTL_MASK: c_uint = 0x3;

pub const AFE_DL_FADEIN_0START_EN_SFT: c_int = 16;
pub const AFE_DL_FADEIN_0START_EN_MASK: c_uint = 0x3;

pub const AFE_DL_DISABLE_HW_CG_CTL_SFT: c_int = 15;
pub const AFE_DL_DISABLE_HW_CG_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_MUTE_CH1_OFF_CTL_PRE_SFT: c_int = 12;
pub const AFE_DL_MUTE_CH1_OFF_CTL_PRE_MASK: c_uint = 0x1;

pub const AFE_DL_MUTE_CH2_OFF_CTL_PRE_SFT: c_int = 11;
pub const AFE_DL_MUTE_CH2_OFF_CTL_PRE_MASK: c_uint = 0x1;

pub const AFE_DL_ARAMPSP_CTL_PRE_SFT: c_int = 9;
pub const AFE_DL_ARAMPSP_CTL_PRE_MASK: c_uint = 0x3;

pub const AFE_DL_VOICE_MODE_CTL_PRE_SFT: c_int = 5;
pub const AFE_DL_VOICE_MODE_CTL_PRE_MASK: c_uint = 0x1;

pub const AFE_DL_MUTE_CH1_ON_CTL_PRE_SFT: c_int = 4;
pub const AFE_DL_MUTE_CH1_ON_CTL_PRE_MASK: c_uint = 0x1;

pub const AFE_DL_MUTE_CH2_ON_CTL_PRE_SFT: c_int = 3;
pub const AFE_DL_MUTE_CH2_ON_CTL_PRE_MASK: c_uint = 0x1;

pub const AFE_DL_GAIN_ON_CTL_PRE_SFT: c_int = 1;
pub const AFE_DL_GAIN_ON_CTL_PRE_MASK: c_uint = 0x1;

pub const AFE_DL_SRC_ON_TMP_CTL_PRE_SFT: c_int = 0;
pub const AFE_DL_SRC_ON_TMP_CTL_PRE_MASK: c_uint = 0x1;

// AFE_ADDA_DL_SRC_CON1
pub const AFE_DL_GAIN1_CTL_PRE_SFT: c_int = 16;
pub const AFE_DL_GAIN1_CTL_PRE_MASK: c_uint = 0xffff;

pub const AFE_DL_GAIN2_CTL_PRE_SFT: c_int = 0;
pub const AFE_DL_GAIN2_CTL_PRE_MASK: c_uint = 0xffff;

// AFE_ADDA_DL_SRC_DEBUG_MON0
pub const AFE_DL_SLT_CNT_FLAG_CTL_SFT: c_int = 15;
pub const AFE_DL_SLT_CNT_FLAG_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_INI_SRAM_FINISH_CTL_SFT: c_int = 12;
pub const AFE_DL_INI_SRAM_FINISH_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_SLT_COUNTER_CTL_SFT: c_int = 0;
pub const AFE_DL_SLT_COUNTER_CTL_MASK: c_uint = 0xfff;

// AFE_ADDA_DL_PREDIS_CON0
pub const AFE_DL_PREDIS_ON_CH1_CTL_SFT: c_int = 31;
pub const AFE_DL_PREDIS_ON_CH1_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_PREDIS_A2_CH1_CTL_SFT: c_int = 16;
pub const AFE_DL_PREDIS_A2_CH1_CTL_MASK: c_uint = 0xfff;

pub const AFE_DL_PREDIS_A3_CH1_CTL_SFT: c_int = 0;
pub const AFE_DL_PREDIS_A3_CH1_CTL_MASK: c_uint = 0xfff;

// AFE_ADDA_DL_PREDIS_CON1
pub const AFE_DL_PREDIS_ON_CH2_CTL_SFT: c_int = 31;
pub const AFE_DL_PREDIS_ON_CH2_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_PREDIS_A2_CH2_CTL_SFT: c_int = 16;
pub const AFE_DL_PREDIS_A2_CH2_CTL_MASK: c_uint = 0xfff;

pub const AFE_DL_PREDIS_A3_CH2_CTL_SFT: c_int = 0;
pub const AFE_DL_PREDIS_A3_CH2_CTL_MASK: c_uint = 0xfff;

// AFE_ADDA_DL_PREDIS_CON2
pub const AFE_DL_PREDIS_A4_CH1_CTL_SFT: c_int = 16;
pub const AFE_DL_PREDIS_A4_CH1_CTL_MASK: c_uint = 0xfff;

pub const AFE_DL_PREDIS_A5_CH1_CTL_SFT: c_int = 0;
pub const AFE_DL_PREDIS_A5_CH1_CTL_MASK: c_uint = 0xfff;

// AFE_ADDA_DL_PREDIS_CON3
pub const AFE_DL_PREDIS_A4_CH2_CTL_SFT: c_int = 16;
pub const AFE_DL_PREDIS_A4_CH2_CTL_MASK: c_uint = 0xfff;

pub const AFE_DL_PREDIS_A5_CH2_CTL_SFT: c_int = 0;
pub const AFE_DL_PREDIS_A5_CH2_CTL_MASK: c_uint = 0xfff;

// AFE_ADDA_DL_SDM_DCCOMP_CON
pub const AFE_DL_USE_NEW_2ND_12BIT_SDM_SFT: c_int = 31;
pub const AFE_DL_USE_NEW_2ND_12BIT_SDM_MASK: c_uint = 0x1;

pub const AFE_DL_USE_NEW_2ND_SDM_SFT: c_int = 30;
pub const AFE_DL_USE_NEW_2ND_SDM_MASK: c_uint = 0x1;

pub const AFE_DL_USE_3RD_SDM_SFT: c_int = 28;
pub const AFE_DL_USE_3RD_SDM_MASK: c_uint = 0x1;

pub const AFE_DL_DCM_AUTO_IDLE_EN_SFT: c_int = 14;
pub const AFE_DL_DCM_AUTO_IDLE_EN_MASK: c_uint = 0x1;
...
pub const AFE_DL_DCCOMP_SYNC_TOGGLE_SFT: c_int = 11;
pub const AFE_DL_DCCOMP_SYNC_TOGGLE_MASK: c_uint = 0x1;

pub const AFE_DL_AUD_SDM_MONO_SFT: c_int = 9;
pub const AFE_DL_AUD_SDM_MONO_MASK: c_uint = 0x1;

pub const AFE_DL_AUD_DC_COMP_EN_SFT: c_int = 8;
pub const AFE_DL_AUD_DC_COMP_EN_MASK: c_uint = 0x1;

pub const AFE_DL_ATTGAIN_CTL_SFT: c_int = 0;
pub const AFE_DL_ATTGAIN_CTL_MASK: c_uint = 0x3f;

// AFE_ADDA_DL_SDM_TEST
pub const AFE_DL_TRI_AMP_DIV_SFT: c_int = 12;
pub const AFE_DL_TRI_AMP_DIV_MASK: c_uint = 0x7;

pub const AFE_DL_TRI_FREQ_DIV_SFT: c_int = 4;
pub const AFE_DL_TRI_FREQ_DIV_MASK: c_uint = 0x3f;

pub const AFE_DL_RG_DL_LEFT_SAT_RSTN_SFT: c_int = 3;
pub const AFE_DL_RG_DL_LEFT_SAT_RSTN_MASK: c_uint = 0x1;

pub const AFE_DL_RG_DL_RIGHT_SAT_RSTN_SFT: c_int = 2;
pub const AFE_DL_RG_DL_RIGHT_SAT_RSTN_MASK: c_uint = 0x1;

pub const AFE_DL_TRI_MUTE_SW_SFT: c_int = 1;
pub const AFE_DL_TRI_MUTE_SW_MASK: c_uint = 0x1;

pub const AFE_DL_TRI_DAC_EN_SFT: c_int = 0;
pub const AFE_DL_TRI_DAC_EN_MASK: c_uint = 0x1;

// AFE_ADDA_DL_DC_COMP_CFG0
pub const AFE_DL_AUD_DC_COMP_LCH_H_SFT: c_int = 16;
pub const AFE_DL_AUD_DC_COMP_LCH_H_MASK: c_uint = 0xffff;

pub const AFE_DL_AUD_DC_COMP_LCH_L_SFT: c_int = 0;
pub const AFE_DL_AUD_DC_COMP_LCH_L_MASK: c_uint = 0xffff;

// AFE_ADDA_DL_DC_COMP_CFG1
pub const AFE_DL_AUD_DC_COMP_RCH_H_SFT: c_int = 16;
pub const AFE_DL_AUD_DC_COMP_RCH_H_MASK: c_uint = 0xffff;

pub const AFE_DL_AUD_DC_COMP_RCH_L_SFT: c_int = 0;
pub const AFE_DL_AUD_DC_COMP_RCH_L_MASK: c_uint = 0xffff;

// AFE_ADDA_DL_SDM_OUT_MON
pub const AFE_DL_SDM_DITHER_MON_SFT: c_int = 28;
pub const AFE_DL_SDM_DITHER_MON_MASK: c_uint = 0x3;

pub const AFE_DL_BF_SDM_LEFT_SAT_SFT: c_int = 21;
pub const AFE_DL_BF_SDM_LEFT_SAT_MASK: c_uint = 0x1;

pub const AFE_DL_BF_SDM_RIGHT_SAT_SFT: c_int = 20;
pub const AFE_DL_BF_SDM_RIGHT_SAT_MASK: c_uint = 0x1;

pub const AFE_DL_3RD_SDM_AUTO_RESET_R_SFT: c_int = 19;
pub const AFE_DL_3RD_SDM_AUTO_RESET_R_MASK: c_uint = 0x1;

pub const AFE_DL_3RD_SDM_AUTO_RESET_L_SFT: c_int = 18;
pub const AFE_DL_3RD_SDM_AUTO_RESET_L_MASK: c_uint = 0x1;

pub const AFE_DL_2ND_SDM_AUTO_RESET_R_SFT: c_int = 17;
pub const AFE_DL_2ND_SDM_AUTO_RESET_R_MASK: c_uint = 0x1;

pub const AFE_DL_2ND_SDM_AUTO_RESET_L_SFT: c_int = 16;
pub const AFE_DL_2ND_SDM_AUTO_RESET_L_MASK: c_uint = 0x1;

pub const AFE_DL_AUD_SDM_OUT_L_SFT: c_int = 8;
pub const AFE_DL_AUD_SDM_OUT_L_MASK: c_uint = 0xff;

pub const AFE_DL_AUD_SDM_OUT_R_SFT: c_int = 0;
pub const AFE_DL_AUD_SDM_OUT_R_MASK: c_uint = 0xff;

// AFE_ADDA_DL_SRC_LCH_MON
pub const AFE_DL_ASDM_LEFT_SFT: c_int = 0;
pub const AFE_DL_ASDM_LEFT_MASK: c_uint = 0xffffff;

// AFE_ADDA_DL_SRC_RCH_MON
pub const AFE_DL_ASDM_RIGHT_SFT: c_int = 0;
pub const AFE_DL_ASDM_RIGHT_MASK: c_uint = 0xffffff;

// AFE_ADDA_DL_SRC_DEBUG
pub const AFE_DL_SLT_CNT_FLAG_RESET_CTL_SFT: c_int = 12;
pub const AFE_DL_SLT_CNT_FLAG_RESET_CTL_MASK: c_uint = 0x1;

pub const AFE_DL_SLT_CNT_THD_CTL_SFT: c_int = 0;
pub const AFE_DL_SLT_CNT_THD_CTL_MASK: c_uint = 0xfff;

// AFE_ADDA_DL_SDM_DITHER_CON
pub const AFE_DL_SDM_DITHER_64TAP_EN_SFT: c_int = 20;
pub const AFE_DL_SDM_DITHER_64TAP_EN_MASK: c_uint = 0x1;

pub const AFE_DL_SDM_DITHER_EN_SFT: c_int = 16;
pub const AFE_DL_SDM_DITHER_EN_MASK: c_uint = 0x1;

pub const AFE_DL_SDM_DITHER_GAIN_SFT: c_int = 0;
pub const AFE_DL_SDM_DITHER_GAIN_MASK: c_uint = 0xff;

// AFE_ADDA_DL_SDM_AUTO_RESET_CON
pub const AFE_DL_SDM_AUTO_RESET_TEST_ON_SFT: c_int = 31;
pub const AFE_DL_SDM_AUTO_RESET_TEST_ON_MASK: c_uint = 0x1;

pub const AFE_DL_SDM_AUTO_RESET_SOURCE_SEL_SFT: c_int = 24;
pub const AFE_DL_SDM_AUTO_RESET_SOURCE_SEL_MASK: c_uint = 0x1;

pub const AFE_DL_SDM_AUTO_RESET_COUNT_TH_SFT: c_int = 0;
pub const AFE_DL_SDM_AUTO_RESET_COUNT_TH_MASK: c_uint = 0xffffff;

// AFE_ADDA_DL_HBF1_SCF1_CONFIG
pub const AFE_DL_HBF1_SW_CONFIG_SFT: c_int = 31;
pub const AFE_DL_HBF1_SW_CONFIG_MASK: c_uint = 0x1;

pub const AFE_DL_HBF1_TAPNUM_CONFIG_SFT: c_int = 16;
pub const AFE_DL_HBF1_TAPNUM_CONFIG_MASK: c_uint = 0x7f;

pub const AFE_DL_SCF1_SW_CONFIG_SFT: c_int = 8;
pub const AFE_DL_SCF1_SW_CONFIG_MASK: c_uint = 0x1;

pub const AFE_DL_SCF1_TAPNUM_CONFIG_SFT: c_int = 0;
pub const AFE_DL_SCF1_TAPNUM_CONFIG_MASK: c_uint = 0xff;

// AFE_ADDA_DL_HBF1_SCF1_TAP1_TAP2_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP1_TAP2_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP1_TAP2_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP3_TAP4_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP3_TAP4_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP3_TAP4_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP5_TAP6_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP5_TAP6_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP5_TAP6_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP7_TAP8_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP7_TAP8_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP7_TAP8_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP9_TAP10_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP9_TAP10_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP9_TAP10_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP11_TAP12_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP11_TAP12_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP11_TAP12_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP13_TAP14_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP13_TAP14_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP13_TAP14_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP15_TAP16_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP15_TAP16_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP15_TAP16_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP17_TAP18_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP17_TAP18_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP17_TAP18_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP19_TAP20_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP19_TAP20_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP19_TAP20_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP21_TAP22_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP21_TAP22_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP21_TAP22_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP23_TAP24_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP23_TAP24_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP23_TAP24_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP25_TAP26_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP25_TAP26_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP25_TAP26_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP27_TAP28_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP27_TAP28_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP27_TAP28_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP29_TAP30_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP29_TAP30_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP29_TAP30_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP31_TAP32_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP31_TAP32_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP31_TAP32_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP33_TAP34_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP33_TAP34_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP33_TAP34_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP35_TAP36_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP35_TAP36_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP35_TAP36_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP37_TAP38_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP37_TAP38_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP37_TAP38_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP39_TAP40_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP39_TAP40_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP39_TAP40_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP41_TAP42_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP41_TAP42_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP41_TAP42_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP43_TAP44_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP43_TAP44_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP43_TAP44_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP45_TAP46_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP45_TAP46_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP45_TAP46_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP47_TAP48_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP47_TAP48_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP47_TAP48_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP49_TAP50_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP49_TAP50_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP49_TAP50_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP51_TAP52_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP51_TAP52_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP51_TAP52_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP53_TAP54_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP53_TAP54_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP53_TAP54_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_ADDA_DL_HBF1_SCF1_TAP55_TAP56_CONFIG
pub const AFE_DL_HBF1_SCF1_TAP55_TAP56_CONFIG_SFT: c_int = 0;
pub const AFE_DL_HBF1_SCF1_TAP55_TAP56_CONFIG_MASK: c_uint = 0xffffffff;

// AFE_DL_NLE_R_CFG0
pub const RG_NLE_R_GAIN_DIG_TAR_SFT: c_int = 24;
pub const RG_NLE_R_GAIN_DIG_TAR_MASK: c_uint = 0x3f;

pub const RG_NLE_R_GAIN_ANA_TAR_SFT: c_int = 16;
pub const RG_NLE_R_GAIN_ANA_TAR_MASK: c_uint = 0x3f;

pub const RG_NLE_R_NO_ZCE_SFT: c_int = 15;
pub const RG_NLE_R_NO_ZCE_MASK: c_uint = 0x1;

pub const RG_NLE_R_HP_MODE_SFT: c_int = 14;
pub const RG_NLE_R_HP_MODE_MASK: c_uint = 0x1;

pub const RG_NLE_R_GAIN_STEP_SFT: c_int = 8;
pub const RG_NLE_R_GAIN_STEP_MASK: c_uint = 0x7;

pub const RG_NLE_R_TOGGLE_NUM_SFT: c_int = 0;
pub const RG_NLE_R_TOGGLE_NUM_MASK: c_uint = 0x3f;

// AFE_DL_NLE_R_CFG1
pub const RG_NLE_R_INITIATE_SFT: c_int = 24;
pub const RG_NLE_R_INITIATE_MASK: c_uint = 0x1;

pub const RG_NLE_R_READY_SFT: c_int = 16;
pub const RG_NLE_R_READY_MASK: c_uint = 0x1;

pub const RG_NLE_R_TIMEOUT_SCALE_SFT: c_int = 12;
pub const RG_NLE_R_TIMEOUT_SCALE_MASK: c_uint = 0x7;

pub const RG_NLE_R_ANC_ON_SFT: c_int = 11;
pub const RG_NLE_R_ANC_ON_MASK: c_uint = 0x1;

pub const RG_NLE_R_GTIME_SFT: c_int = 8;
pub const RG_NLE_R_GTIME_MASK: c_uint = 0x7;

pub const RG_NLE_R_ON_SFT: c_int = 7;
pub const RG_NLE_R_ON_MASK: c_uint = 0x1;

pub const RG_PDN_NLE_CTL_SFT: c_int = 6;
pub const RG_PDN_NLE_CTL_MASK: c_uint = 0x1;

pub const RG_NLE_R_DELAY_ANA_SFT: c_int = 0;
pub const RG_NLE_R_DELAY_ANA_MASK: c_uint = 0x3f;

// AFE_DL_NLE_L_CFG0
pub const RG_NLE_L_GAIN_DIG_TAR_SFT: c_int = 24;
pub const RG_NLE_L_GAIN_DIG_TAR_MASK: c_uint = 0x3f;

pub const RG_NLE_L_GAIN_ANA_TAR_SFT: c_int = 16;
pub const RG_NLE_L_GAIN_ANA_TAR_MASK: c_uint = 0x3f;

pub const RG_NLE_L_NO_ZCE_SFT: c_int = 15;
pub const RG_NLE_L_NO_ZCE_MASK: c_uint = 0x1;

pub const RG_NLE_L_HP_MODE_SFT: c_int = 14;
pub const RG_NLE_L_HP_MODE_MASK: c_uint = 0x1;

pub const RG_NLE_L_GAIN_STEP_SFT: c_int = 8;
pub const RG_NLE_L_GAIN_STEP_MASK: c_uint = 0x7;

pub const RG_NLE_L_TOGGLE_NUM_SFT: c_int = 0;
pub const RG_NLE_L_TOGGLE_NUM_MASK: c_uint = 0x3f;

// AFE_DL_NLE_L_CFG1
pub const RG_NLE_L_INITIATE_SFT: c_int = 24;
pub const RG_NLE_L_INITIATE_MASK: c_uint = 0x1;

pub const RG_NLE_L_READY_SFT: c_int = 16;
pub const RG_NLE_L_READY_MASK: c_uint = 0x1;

pub const RG_NLE_L_TIMEOUT_SCALE_SFT: c_int = 12;
pub const RG_NLE_L_TIMEOUT_SCALE_MASK: c_uint = 0x7;

pub const RG_NLE_L_ANC_ON_SFT: c_int = 11;
pub const RG_NLE_L_ANC_ON_MASK: c_uint = 0x1;

pub const RG_NLE_L_GTIME_SFT: c_int = 8;
pub const RG_NLE_L_GTIME_MASK: c_uint = 0x7;

pub const RG_NLE_L_ON_SFT: c_int = 7;
pub const RG_NLE_L_ON_MASK: c_uint = 0x1;

pub const RG_PDN_NLE_CTL_SFT: c_int = 6;
pub const RG_PDN_NLE_CTL_MASK: c_uint = 0x1;

pub const RG_NLE_L_DELAY_ANA_SFT: c_int = 0;
pub const RG_NLE_L_DELAY_ANA_MASK: c_uint = 0x3f;

// AFE_DL_NLE_R_MON0
pub const NLE_R_GAIN_DIG_CUR_SFT: c_int = 24;
pub const NLE_R_GAIN_DIG_CUR_MASK: c_uint = 0x3f;

pub const NLE_R_ANC_MASK_SFT: c_int = 23;
pub const NLE_R_ANC_MASK_MASK: c_uint = 0x1;

pub const NLE_R_GAIN_ANA_CUR_SFT: c_int = 16;
pub const NLE_R_GAIN_ANA_CUR_MASK: c_uint = 0x3f;

pub const NLE_R_GAIN_DIG_TAR_CUR_SFT: c_int = 8;
pub const NLE_R_GAIN_DIG_TAR_CUR_MASK: c_uint = 0x3f;

pub const NLE_R_GAIN_ANA_TAR_CUR_SFT: c_int = 0;
pub const NLE_R_GAIN_ANA_TAR_CUR_MASK: c_uint = 0x3f;

// AFE_DL_NLE_R_MON1
pub const NLE_R_STATE_CUR_SFT: c_int = 28;
pub const NLE_R_STATE_CUR_MASK: c_uint = 0x7;

pub const NLE_R_GAIN_STEP_CUR_SFT: c_int = 24;
pub const NLE_R_GAIN_STEP_CUR_MASK: c_uint = 0xf;

pub const NLE_R_TOGGLE_NUM_CUR_SFT: c_int = 16;
pub const NLE_R_TOGGLE_NUM_CUR_MASK: c_uint = 0x3f;

pub const NLE_R_DIG_GAIN_TARGETED_SFT: c_int = 15;
pub const NLE_R_DIG_GAIN_TARGETED_MASK: c_uint = 0x1;

pub const NLE_R_DIG_GAIN_INCREASE_SFT: c_int = 14;
pub const NLE_R_DIG_GAIN_INCREASE_MASK: c_uint = 0x1;

pub const NLE_R_DIG_GAIN_DECREASE_SFT: c_int = 13;
pub const NLE_R_DIG_GAIN_DECREASE_MASK: c_uint = 0x1;

pub const NLE_R_ANA_GAIN_TARGETED_SFT: c_int = 12;
pub const NLE_R_ANA_GAIN_TARGETED_MASK: c_uint = 0x1;

pub const NLE_R_ANA_GAIN_INCREASE_SFT: c_int = 11;
pub const NLE_R_ANA_GAIN_INCREASE_MASK: c_uint = 0x1;

pub const NLE_R_ANA_GAIN_DECREASE_SFT: c_int = 10;
pub const NLE_R_ANA_GAIN_DECREASE_MASK: c_uint = 0x1;

pub const NLE_R_TIME_COUNTER_CUR_SFT: c_int = 0;
pub const NLE_R_TIME_COUNTER_CUR_MASK: c_uint = 0x1ff;

// AFE_DL_NLE_R_MON2
pub const NLE_R_ANA_GAIN_SFT: c_int = 8;
pub const NLE_R_ANA_GAIN_MASK: c_uint = 0x1f;

pub const NLE_MOSI2_ANA_GAIN_SFT: c_int = 0;
pub const NLE_MOSI2_ANA_GAIN_MASK: c_uint = 0x7f;

// AFE_DL_NLE_L_MON0
pub const NLE_L_GAIN_DIG_CUR_SFT: c_int = 24;
pub const NLE_L_GAIN_DIG_CUR_MASK: c_uint = 0x3f;

pub const NLE_L_ANC_MASK_SFT: c_int = 23;
pub const NLE_L_ANC_MASK_MASK: c_uint = 0x1;

pub const NLE_L_GAIN_ANA_CUR_SFT: c_int = 16;
pub const NLE_L_GAIN_ANA_CUR_MASK: c_uint = 0x3f;

pub const NLE_L_GAIN_DIG_TAR_CUR_SFT: c_int = 8;
pub const NLE_L_GAIN_DIG_TAR_CUR_MASK: c_uint = 0x3f;

pub const NLE_L_GAIN_ANA_TAR_CUR_SFT: c_int = 0;
pub const NLE_L_GAIN_ANA_TAR_CUR_MASK: c_uint = 0x3f;

// AFE_DL_NLE_L_MON1
pub const NLE_L_STATE_CUR_SFT: c_int = 28;
pub const NLE_L_STATE_CUR_MASK: c_uint = 0x7;

pub const NLE_L_GAIN_STEP_CUR_SFT: c_int = 24;
pub const NLE_L_GAIN_STEP_CUR_MASK: c_uint = 0xf;

pub const NLE_L_TOGGLE_NUM_CUR_SFT: c_int = 16;
pub const NLE_L_TOGGLE_NUM_CUR_MASK: c_uint = 0x3f;

pub const NLE_L_DIG_GAIN_TARGETED_SFT: c_int = 15;
pub const NLE_L_DIG_GAIN_TARGETED_MASK: c_uint = 0x1;

pub const NLE_L_DIG_GAIN_INCREASE_SFT: c_int = 14;
pub const NLE_L_DIG_GAIN_INCREASE_MASK: c_uint = 0x1;

pub const NLE_L_DIG_GAIN_DECREASE_SFT: c_int = 13;
pub const NLE_L_DIG_GAIN_DECREASE_MASK: c_uint = 0x1;

pub const NLE_L_ANA_GAIN_TARGETED_SFT: c_int = 12;
pub const NLE_L_ANA_GAIN_TARGETED_MASK: c_uint = 0x1;

pub const NLE_L_ANA_GAIN_INCREASE_SFT: c_int = 11;
pub const NLE_L_ANA_GAIN_INCREASE_MASK: c_uint = 0x1;

pub const NLE_L_ANA_GAIN_DECREASE_SFT: c_int = 10;
pub const NLE_L_ANA_GAIN_DECREASE_MASK: c_uint = 0x1;

pub const NLE_L_TIME_COUNTER_CUR_SFT: c_int = 0;
pub const NLE_L_TIME_COUNTER_CUR_MASK: c_uint = 0x1ff;

// AFE_DL_NLE_L_MON2
pub const NLE_L_ANA_GAIN_SFT: c_int = 8;
pub const NLE_L_ANA_GAIN_MASK: c_uint = 0x1f;

pub const NLE_MOSI1_ANA_GAIN_SFT: c_int = 0;
pub const NLE_MOSI1_ANA_GAIN_MASK: c_uint = 0x7f;

// AFE_DL_NLE_GAIN_CFG0
pub const MISO2_SEL_SFT: c_int = 4;
pub const MISO2_SEL_MASK: c_uint = 0x3;

pub const MISO1_SEL_SFT: c_int = 0;
pub const MISO1_SEL_MASK: c_uint = 0x3;

// AFE_DEM_IDWA_CON0
pub const RG_IDWA_SDM_MAV_EN_SFT: c_int = 31;
pub const RG_IDWA_SDM_MAV_EN_MASK: c_uint = 0x1;

pub const RG_IDWA_SDM_ADITHON_SFT: c_int = 30;
pub const RG_IDWA_SDM_ADITHON_MASK: c_uint = 0x1;

pub const RG_IDWA_SDM_ADITHVAL_SFT: c_int = 28;
pub const RG_IDWA_SDM_ADITHVAL_MASK: c_uint = 0x3;

pub const RG_IDWA_SDM_LOOPBACK_SFT: c_int = 27;
pub const RG_IDWA_SDM_LOOPBACK_MASK: c_uint = 0x1;

pub const RG_IDWA_SEL_SFT: c_int = 26;
pub const RG_IDWA_SEL_MASK: c_uint = 0x1;

pub const RG_IDWA_ON_SFT: c_int = 25;
pub const RG_IDWA_ON_MASK: c_uint = 0x1;

pub const RG_DEM_IN_LR_SWAP_SFT: c_int = 24;
pub const RG_DEM_IN_LR_SWAP_MASK: c_uint = 0x1;

pub const RG_DEM_IN_L_INV_SFT: c_int = 23;
pub const RG_DEM_IN_L_INV_MASK: c_uint = 0x1;

pub const RG_DEM_IN_R_EQ_L_SFT: c_int = 22;
pub const RG_DEM_IN_R_EQ_L_MASK: c_uint = 0x1;

pub const RG_DEM_IN_L_MUTE_SFT: c_int = 21;
pub const RG_DEM_IN_L_MUTE_MASK: c_uint = 0x1;

pub const RG_DEM_IN_R_MUTE_SFT: c_int = 20;
pub const RG_DEM_IN_R_MUTE_MASK: c_uint = 0x1;

pub const RG_DEM_IN_SOURCE_SFT: c_int = 19;
pub const RG_DEM_IN_SOURCE_MASK: c_uint = 0x1;

pub const RG_DEM_SPLITTER_TRUNC_RND_SFT: c_int = 18;
pub const RG_DEM_SPLITTER_TRUNC_RND_MASK: c_uint = 0x1;

pub const RG_DEM_SCRAMBLER_CG_EN_SFT: c_int = 17;
pub const RG_DEM_SCRAMBLER_CG_EN_MASK: c_uint = 0x1;

pub const RG_DEM_SCRAMBLER_EN_SFT: c_int = 16;
pub const RG_DEM_SCRAMBLER_EN_MASK: c_uint = 0x1;

pub const RG_DEM_AUD_SDM_7BIT_SEL_SFT: c_int = 15;
pub const RG_DEM_AUD_SDM_7BIT_SEL_MASK: c_uint = 0x1;

pub const RG_DEM_ZERO_PAD_DISABLE_SFT: c_int = 14;
pub const RG_DEM_ZERO_PAD_DISABLE_MASK: c_uint = 0x1;

pub const RG_DEM_SPLITTER_TEST_EN_SFT: c_int = 13;
pub const RG_DEM_SPLITTER_TEST_EN_MASK: c_uint = 0x1;

pub const RG_DEM_IDAC_TEST_EN_SFT: c_int = 12;
pub const RG_DEM_IDAC_TEST_EN_MASK: c_uint = 0x1;

pub const RG_DEM_SPLIT_SCRAM_ON_SFT: c_int = 11;
pub const RG_DEM_SPLIT_SCRAM_ON_MASK: c_uint = 0x1;

pub const RG_DEM_RAND_EN_SFT: c_int = 10;
pub const RG_DEM_RAND_EN_MASK: c_uint = 0x1;

pub const RG_DEM_SPLITTER2_DITHER_EN_SFT: c_int = 9;
pub const RG_DEM_SPLITTER2_DITHER_EN_MASK: c_uint = 0x1;

pub const RG_DEM_SPLITTER1_DITHER_EN_SFT: c_int = 8;
pub const RG_DEM_SPLITTER1_DITHER_EN_MASK: c_uint = 0x1;

pub const RG_DEM_SPLITTER2_DITHER_GAIN_SFT: c_int = 4;
pub const RG_DEM_SPLITTER2_DITHER_GAIN_MASK: c_uint = 0xf;

pub const RG_DEM_SPLITTER1_DITHER_GAIN_SFT: c_int = 0;
pub const RG_DEM_SPLITTER1_DITHER_GAIN_MASK: c_uint = 0xf;

// DEM_RECONSTRUCT_MON
pub const DEM_RECONSTRUCT_L_MON_SFT: c_int = 8;
pub const DEM_RECONSTRUCT_L_MON_MASK: c_uint = 0xff;

pub const DEM_RECONSTRUCT_R_MON_SFT: c_int = 0;
pub const DEM_RECONSTRUCT_R_MON_MASK: c_uint = 0xff;
...
pub const UL_VOICE_MODE_CTL_SFT: c_int = 29;
pub const UL_VOICE_MODE_CTL_MASK: c_uint = 0x7;

pub const DATA_COMB_IN_CH2_SFT: c_int = 24;
pub const DATA_COMB_IN_CH2_MASK: c_uint = 0x1f;

pub const DATA_COMB_OUT_CH2_SFT: c_int = 0;
pub const DATA_COMB_OUT_CH2_MASK: c_uint = 0xffffff;
...
// AFE_DL0_MON0
pub const RESERVED_01_SFT: c_int = 20;
pub const RESERVED_01_MASK: c_uint = 0xfff;

pub const MEM_REQ_PENDING_SFT: c_int = 19;
pub const MEM_REQ_PENDING_MASK: c_uint = 0x1;

pub const BUF_EMPTY_SFT: c_int = 18;
pub const BUF_EMPTY_MASK: c_uint = 0x1;

pub const ENABLE_SYNC_MEM_SFT: c_int = 17;
pub const ENABLE_SYNC_MEM_MASK: c_uint = 0x1;

pub const ENABLE_SYNC_AGENT_SFT: c_int = 16;
pub const ENABLE_SYNC_AGENT_MASK: c_uint = 0x1;

pub const RESERVED_02_SFT: c_int = 6;
pub const RESERVED_02_MASK: c_uint = 0x3ff;

pub const MEM_ADDR_DIFF_SFT: c_int = 0;
pub const MEM_ADDR_DIFF_MASK: c_uint = 0x3f;
...
// AFE_VUL1_MON0
pub const MEM_HW_WEN_SFT: c_int = 20;
pub const MEM_HW_WEN_MASK: c_uint = 0xf;

pub const MEM_REQ_PENDING_SFT: c_int = 19;
pub const MEM_REQ_PENDING_MASK: c_uint = 0x1;

pub const BUF_FULL_SFT: c_int = 18;
pub const BUF_FULL_MASK: c_uint = 0x1;
...
pub const ETDM1_4_7_COWORK_CON1_MASK_S_0_SFT: c_int = 24;
pub const ETDM1_4_7_COWORK_CON1_MASK_S_0_MASK: c_uint = 0xff;

pub const ETDM1_4_7_COWORK_CON0_MASK_S_0_SFT: c_int = 20;
pub const ETDM1_4_7_COWORK_CON0_MASK_S_0_MASK: c_uint = 0xf;

pub const ETDM1_4_7_COWORK_CON0_MASK_S_1_SFT: c_int = 16;
pub const ETDM1_4_7_COWORK_CON0_MASK_S_1_MASK: c_uint = 0xf;

pub const ETDM1_0_3_COWORK_CON3_MASK_S_0_SFT: c_int = 8;
pub const ETDM1_0_3_COWORK_CON3_MASK_S_0_MASK: c_uint = 0xff;

pub const ETDM1_0_3_COWORK_CON3_MASK_S_1_SFT: c_int = 0;
pub const ETDM1_0_3_COWORK_CON3_MASK_S_1_MASK: c_uint = 0xff;

// AFE_SECURE_CONN_ETDM2
pub const ETDM2_4_7_COWORK_CON3_MASK_S_0_SFT: c_int = 24;
pub const ETDM2_4_7_COWORK_CON3_MASK_S_0_MASK: c_uint = 0xff;

pub const ETDM2_4_7_COWORK_CON3_MASK_S_1_SFT: c_int = 16;
pub const ETDM2_4_7_COWORK_CON3_MASK_S_1_MASK: c_uint = 0xff;

pub const ETDM2_4_7_COWORK_CON2_MASK_S_0_SFT: c_int = 12;
pub const ETDM2_4_7_COWORK_CON2_MASK_S_0_MASK: c_uint = 0xf;

pub const ETDM2_4_7_COWORK_CON2_MASK_S_1_SFT: c_int = 8;
pub const ETDM2_4_7_COWORK_CON2_MASK_S_1_MASK: c_uint = 0xf;

pub const ETDM2_4_7_COWORK_CON1_MASK_S_0_SFT: c_int = 0;
pub const ETDM2_4_7_COWORK_CON1_MASK_S_0_MASK: c_uint = 0xff;
...
pub const AUDIO_PROJECT_MON: c_uint = 0x80;
...
pub const AFE_GAIN_0_1_IP_VERSION: c_uint = 0x474;
pub const AFE_GAIN_2_3_IP_VERSION: c_uint = 0x478;
pub const AFE_ADDA_DL_IPM_VER_MON: c_uint = 0x4c0;
pub const AFE_ADDA_DL_SRC_CON0: c_uint = 0x4d0;
pub const AFE_ADDA_DL_SRC_CON1: c_uint = 0x4d4;
pub const AFE_ADDA_DL_SRC_DEBUG_MON0: c_uint = 0x4d8;
pub const AFE_ADDA_DL_PREDIS_CON0: c_uint = 0x4dc;
pub const AFE_ADDA_DL_PREDIS_CON1: c_uint = 0x4e0;
pub const AFE_ADDA_DL_PREDIS_CON2: c_uint = 0x4e4;
pub const AFE_ADDA_DL_PREDIS_CON3: c_uint = 0x4e8;
pub const AFE_ADDA_DL_SDM_DCCOMP_CON: c_uint = 0x4ec;
pub const AFE_ADDA_DL_SDM_TEST: c_uint = 0x4f0;
pub const AFE_ADDA_DL_DC_COMP_CFG0: c_uint = 0x4f4;
pub const AFE_ADDA_DL_DC_COMP_CFG1: c_uint = 0x4f8;
pub const AFE_ADDA_DL_SDM_OUT_MON: c_uint = 0x4fc;
pub const AFE_ADDA_DL_SRC_LCH_MON: c_uint = 0x500;
pub const AFE_ADDA_DL_SRC_RCH_MON: c_uint = 0x504;
pub const AFE_ADDA_DL_SRC_DEBUG: c_uint = 0x508;
pub const AFE_ADDA_DL_SDM_DITHER_CON: c_uint = 0x50c;
pub const AFE_ADDA_DL_SDM_AUTO_RESET_CON: c_uint = 0x510;
pub const AFE_ADDA_DL_HBF1_SCF1_CONFIG: c_uint = 0x514;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP1_TAP2_CONFIG: c_uint = 0x518;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP3_TAP4_CONFIG: c_uint = 0x51c;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP5_TAP6_CONFIG: c_uint = 0x520;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP7_TAP8_CONFIG: c_uint = 0x524;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP9_TAP10_CONFIG: c_uint = 0x528;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP11_TAP12_CONFIG: c_uint = 0x52c;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP13_TAP14_CONFIG: c_uint = 0x530;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP15_TAP16_CONFIG: c_uint = 0x534;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP17_TAP18_CONFIG: c_uint = 0x538;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP19_TAP20_CONFIG: c_uint = 0x53c;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP21_TAP22_CONFIG: c_uint = 0x540;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP23_TAP24_CONFIG: c_uint = 0x544;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP25_TAP26_CONFIG: c_uint = 0x548;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP27_TAP28_CONFIG: c_uint = 0x54c;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP29_TAP30_CONFIG: c_uint = 0x550;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP31_TAP32_CONFIG: c_uint = 0x554;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP33_TAP34_CONFIG: c_uint = 0x558;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP35_TAP36_CONFIG: c_uint = 0x55c;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP37_TAP38_CONFIG: c_uint = 0x560;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP39_TAP40_CONFIG: c_uint = 0x564;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP41_TAP42_CONFIG: c_uint = 0x568;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP43_TAP44_CONFIG: c_uint = 0x56c;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP45_TAP46_CONFIG: c_uint = 0x570;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP47_TAP48_CONFIG: c_uint = 0x574;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP49_TAP50_CONFIG: c_uint = 0x578;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP51_TAP52_CONFIG: c_uint = 0x57c;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP53_TAP54_CONFIG: c_uint = 0x580;
pub const AFE_ADDA_DL_HBF1_SCF1_TAP55_TAP56_CONFIG: c_uint = 0x584;
pub const AFE_DEM_IDWA_CON0: c_uint = 0xa1c;
pub const DEM_RECONSTRUCT_MON: c_uint = 0xa20;
...
pub const AFE_ADDA_DMIC0_SRC_CON0: c_uint = 0xdd0;
pub const AFE_ADDA_DMIC0_SRC_CON1: c_uint = 0xdd4;
pub const AFE_ADDA_DMIC0_SRC_CON2: c_uint = 0xdd8;
pub const AFE_ADDA_DMIC0_SRC_DEBUG: c_uint = 0xddc;
pub const AFE_ADDA_DMIC0_SRC_DEBUG_MON0: c_uint = 0xde0;
pub const AFE_ADDA_DMIC0_SRC_MON0: c_uint = 0xde4;
pub const AFE_ADDA_DMIC0_SRC_MON1: c_uint = 0xde8;
pub const AFE_ADDA_DMIC0_IIR_COEF_02_01: c_uint = 0xdec;
pub const AFE_ADDA_DMIC0_IIR_COEF_04_03: c_uint = 0xdf0;
pub const AFE_ADDA_DMIC0_IIR_COEF_06_05: c_uint = 0xdf4;
pub const AFE_ADDA_DMIC0_IIR_COEF_08_07: c_uint = 0xdf8;
pub const AFE_ADDA_DMIC0_IIR_COEF_10_09: c_uint = 0xdfc;
pub const AFE_ADDA_DMIC0_ULCF_CFG_02_01: c_uint = 0xe00;
pub const AFE_ADDA_DMIC0_ULCF_CFG_04_03: c_uint = 0xe04;
pub const AFE_ADDA_DMIC0_ULCF_CFG_06_05: c_uint = 0xe08;
pub const AFE_ADDA_DMIC0_ULCF_CFG_08_07: c_uint = 0xe0c;
pub const AFE_ADDA_DMIC0_ULCF_CFG_10_09: c_uint = 0xe10;
pub const AFE_ADDA_DMIC0_ULCF_CFG_12_11: c_uint = 0xe14;
pub const AFE_ADDA_DMIC0_ULCF_CFG_14_13: c_uint = 0xe18;
pub const AFE_ADDA_DMIC0_ULCF_CFG_16_15: c_uint = 0xe1c;
pub const AFE_ADDA_DMIC0_ULCF_CFG_18_17: c_uint = 0xe20;
pub const AFE_ADDA_DMIC0_ULCF_CFG_20_19: c_uint = 0xe24;
pub const AFE_ADDA_DMIC0_ULCF_CFG_22_21: c_uint = 0xe28;
pub const AFE_ADDA_DMIC0_ULCF_CFG_24_23: c_uint = 0xe2c;
pub const AFE_ADDA_DMIC0_ULCF_CFG_26_25: c_uint = 0xe30;
pub const AFE_ADDA_DMIC0_ULCF_CFG_28_27: c_uint = 0xe34;
pub const AFE_ADDA_DMIC0_ULCF_CFG_30_29: c_uint = 0xe38;
pub const AFE_ADDA_DMIC0_ULCF_CFG_32_31: c_uint = 0xe3c;
pub const AFE_ADDA_DMIC0_IP_VERSION: c_uint = 0xe4c;
pub const AFE_ADDA_DMIC1_SRC_CON0: c_uint = 0xe50;
pub const AFE_ADDA_DMIC1_SRC_CON1: c_uint = 0xe54;
pub const AFE_ADDA_DMIC1_SRC_CON2: c_uint = 0xe58;
pub const AFE_ADDA_DMIC1_SRC_DEBUG: c_uint = 0xe5c;
pub const AFE_ADDA_DMIC1_SRC_DEBUG_MON0: c_uint = 0xe60;
pub const AFE_ADDA_DMIC1_SRC_MON0: c_uint = 0xe64;
pub const AFE_ADDA_DMIC1_SRC_MON1: c_uint = 0xe68;
pub const AFE_ADDA_DMIC1_IIR_COEF_02_01: c_uint = 0xe6c;
pub const AFE_ADDA_DMIC1_IIR_COEF_04_03: c_uint = 0xe70;
pub const AFE_ADDA_DMIC1_IIR_COEF_06_05: c_uint = 0xe74;
pub const AFE_ADDA_DMIC1_IIR_COEF_08_07: c_uint = 0xe78;
pub const AFE_ADDA_DMIC1_IIR_COEF_10_09: c_uint = 0xe7c;
pub const AFE_ADDA_DMIC1_ULCF_CFG_02_01: c_uint = 0xe80;
pub const AFE_ADDA_DMIC1_ULCF_CFG_04_03: c_uint = 0xe84;
pub const AFE_ADDA_DMIC1_ULCF_CFG_06_05: c_uint = 0xe88;
pub const AFE_ADDA_DMIC1_ULCF_CFG_08_07: c_uint = 0xe8c;
pub const AFE_ADDA_DMIC1_ULCF_CFG_10_09: c_uint = 0xe90;
pub const AFE_ADDA_DMIC1_ULCF_CFG_12_11: c_uint = 0xe94;
pub const AFE_ADDA_DMIC1_ULCF_CFG_14_13: c_uint = 0xe98;
pub const AFE_ADDA_DMIC1_ULCF_CFG_16_15: c_uint = 0xe9c;
pub const AFE_ADDA_DMIC1_ULCF_CFG_18_17: c_uint = 0xea0;
pub const AFE_ADDA_DMIC1_ULCF_CFG_20_19: c_uint = 0xea4;
pub const AFE_ADDA_DMIC1_ULCF_CFG_22_21: c_uint = 0xea8;
pub const AFE_ADDA_DMIC1_ULCF_CFG_24_23: c_uint = 0xeac;
pub const AFE_ADDA_DMIC1_ULCF_CFG_26_25: c_uint = 0xeb0;
pub const AFE_ADDA_DMIC1_ULCF_CFG_28_27: c_uint = 0xeb4;
pub const AFE_ADDA_DMIC1_ULCF_CFG_30_29: c_uint = 0xeb8;
pub const AFE_ADDA_DMIC1_ULCF_CFG_32_31: c_uint = 0xebc;
pub const AFE_ADDA_DMIC1_IP_VERSION: c_uint = 0xecc;
pub const AFE_ADDA_ULSRC_PHASE_CLK_CON0: c_uint = 0xf00;
pub const AFE_ADDA_ULSRC_PHASE_CLK_CON1: c_uint = 0xf04;
pub const AFE_ADDA_ULSRC_PHASE_CLK_CON2: c_uint = 0xf08;
pub const AFE_ADDA_ULSRC_PHASE_CLK_CON3: c_uint = 0xf0c;
pub const AFE_ADDA_ULSRC_PHASE_CLK_CON4: c_uint = 0xf10;
pub const AFE_ADDA_ULSRC_PHASE_ENGEN_CON0: c_uint = 0xf14;
pub const AFE_ADDA_ULSRC_PHASE_ENGEN_CON1: c_uint = 0xf18;
pub const AFE_ADDA_ULSRC_PHASE_RST_CON0: c_uint = 0xf1c;
...
pub const ETDM_IP_VERSION: c_uint = 0x1c4c;
...
pub const AFE_CONN_TOP_IP_VERSION: c_uint = 0x4120;
...
pub const AFE_MEMIF_IP_VERSION: c_uint = 0x4398;
pub const AFE_MEMIF_CON0: c_uint = 0x4400;
pub const AFE_MEMIF_RD_MON: c_uint = 0x4408;
pub const AFE_MEMIF_WR_MON: c_uint = 0x440c;
pub const AFE_MEMIF_CFG_MON0: c_uint = 0x4410;
pub const AFE_BUS_CFG0: c_uint = 0x4414;
pub const AFE_BUS_MON1: c_uint = 0x4418;
pub const AFE_BUS_MON2: c_uint = 0x441c;
...
pub const AFE_DL0_MEM_UP_MSB: c_uint = 0x4468;
pub const AFE_DL0_MEM_UP: c_uint = 0x446c;
...
pub const AFE_DL1_MEM_UP_MSB: c_uint = 0x4498;
pub const AFE_DL1_MEM_UP: c_uint = 0x449c;
...
pub const AFE_DL2_MEM_UP_MSB: c_uint = 0x44c8;
pub const AFE_DL2_MEM_UP: c_uint = 0x44cc;
...
pub const AFE_DL3_MEM_UP_MSB: c_uint = 0x44f8;
pub const AFE_DL3_MEM_UP: c_uint = 0x44fc;
...
pub const AFE_DL4_MEM_UP_MSB: c_uint = 0x4528;
pub const AFE_DL4_MEM_UP: c_uint = 0x452c;
...
pub const AFE_DL5_MEM_UP_MSB: c_uint = 0x4558;
pub const AFE_DL5_MEM_UP: c_uint = 0x455c;
...
pub const AFE_DL6_MEM_UP_MSB: c_uint = 0x4588;
pub const AFE_DL6_MEM_UP: c_uint = 0x458c;
...
pub const AFE_DL7_MEM_UP_MSB: c_uint = 0x45b8;
pub const AFE_DL7_MEM_UP: c_uint = 0x45bc;
...
pub const AFE_DL8_MEM_UP_MSB: c_uint = 0x45e8;
pub const AFE_DL8_MEM_UP: c_uint = 0x45ec;
...
pub const AFE_DL_24CH_MON0: c_uint = 0x4644;
pub const AFE_DL_24CH_MEM_UP_MSB: c_uint = 0x4648;
pub const AFE_DL_24CH_MEM_UP: c_uint = 0x464c;
...
pub const AFE_DL23_MEM_UP_MSB: c_uint = 0x46a8;
pub const AFE_DL23_MEM_UP: c_uint = 0x46ac;
...
pub const AFE_DL24_MEM_UP_MSB: c_uint = 0x46d8;
pub const AFE_DL24_MEM_UP: c_uint = 0x46dc;
...
pub const AFE_DL25_MEM_UP_MSB: c_uint = 0x4708;
pub const AFE_DL25_MEM_UP: c_uint = 0x470c;
...
pub const AFE_VUL_CM0_MON0: c_uint = 0x51dc;
...
pub const AFE_VUL_CM1_MON0: c_uint = 0x51fc;
...
pub const AFE_HDMI_OUT_MON0: c_uint = 0x537c;
...
pub const AFE_HDMI_OUT_MEM_UP_MSB: c_uint = 0x55b0;
pub const AFE_HDMI_OUT_MEM_UP: c_uint = 0x55b4;
...
pub const AFE_ADDA_DMIC0_SRC_CON0_MASK_MON: c_uint = 0x5764;
pub const AFE_ADDA_DMIC1_SRC_CON0_MASK_MON: c_uint = 0x5768;
pub const AFE_MON_SECURE_CON0: c_uint = 0x5840;
pub const AFE_SECURE_CONN_ETDM3: c_uint = 0x5850;
...
pub const AFE_SOUNDWIRE_ULSRC_PHASE_CLK_CON0: c_uint = 0x9400;
pub const AFE_SOUNDWIRE_ULSRC_PHASE_CLK_CON1: c_uint = 0x9404;
pub const AFE_SOUNDWIRE_ULSRC_PHASE_CLK_CON2: c_uint = 0x9408;
pub const AFE_SOUNDWIRE_ULSRC_PHASE_CLK_CON3: c_uint = 0x940c;
pub const AFE_SOUNDWIRE_ULSRC_PHASE_CLK_CON4: c_uint = 0x9410;
pub const AFE_SOUNDWIRE_ULSRC_PHASE_ENGEN_CON0: c_uint = 0x9414;
pub const AFE_SOUNDWIRE_ULSRC_PHASE_ENGEN_CON1: c_uint = 0x9418;
pub const AFE_SOUNDWIRE_ULSRC_PHASE_RST_CON0: c_uint = 0x941c;
pub const AFE_IRQ_MCU_EN: c_uint = 0x9d00;
pub const AFE_IRQ_MCU_DSP_EN: c_uint = 0x9d04;
pub const AFE_IRQ_MCU_DSP2_EN: c_uint = 0x9d08;
pub const AFE_IRQ_MCU_SCP_EN: c_uint = 0x9d0c;
pub const AFE_CUSTOM_IRQ_MCU_EN: c_uint = 0x9d10;
pub const AFE_CUSTOM_IRQ_MCU_DSP_EN: c_uint = 0x9d14;
pub const AFE_CUSTOM_IRQ_MCU_DSP2_EN: c_uint = 0x9d18;
pub const AFE_CUSTOM_IRQ_MCU_SCP_EN: c_uint = 0x9d1c;
pub const AFE_IRQ_MCU_STATUS: c_uint = 0x9d20;
pub const AFE_CUSTOM_IRQ_MCU_STATUS: c_uint = 0x9d24;
pub const AFE_IRQ0_MCU_CFG0: c_uint = 0x9d40;
pub const AFE_IRQ0_MCU_CFG1: c_uint = 0x9d44;
pub const AFE_IRQ1_MCU_CFG0: c_uint = 0x9d48;
pub const AFE_IRQ1_MCU_CFG1: c_uint = 0x9d4c;
pub const AFE_IRQ2_MCU_CFG0: c_uint = 0x9d50;
pub const AFE_IRQ2_MCU_CFG1: c_uint = 0x9d54;
pub const AFE_IRQ3_MCU_CFG0: c_uint = 0x9d58;
pub const AFE_IRQ3_MCU_CFG1: c_uint = 0x9d5c;
pub const AFE_IRQ4_MCU_CFG0: c_uint = 0x9d60;
pub const AFE_IRQ4_MCU_CFG1: c_uint = 0x9d64;
pub const AFE_IRQ5_MCU_CFG0: c_uint = 0x9d68;
pub const AFE_IRQ5_MCU_CFG1: c_uint = 0x9d6c;
pub const AFE_IRQ6_MCU_CFG0: c_uint = 0x9d70;
pub const AFE_IRQ6_MCU_CFG1: c_uint = 0x9d74;
pub const AFE_IRQ7_MCU_CFG0: c_uint = 0x9d78;
pub const AFE_IRQ7_MCU_CFG1: c_uint = 0x9d7c;
pub const AFE_IRQ8_MCU_CFG0: c_uint = 0x9d80;
pub const AFE_IRQ8_MCU_CFG1: c_uint = 0x9d84;
pub const AFE_IRQ9_MCU_CFG0: c_uint = 0x9d88;
pub const AFE_IRQ9_MCU_CFG1: c_uint = 0x9d8c;
pub const AFE_IRQ10_MCU_CFG0: c_uint = 0x9d90;
pub const AFE_IRQ10_MCU_CFG1: c_uint = 0x9d94;
pub const AFE_IRQ11_MCU_CFG0: c_uint = 0x9d98;
pub const AFE_IRQ11_MCU_CFG1: c_uint = 0x9d9c;
pub const AFE_IRQ12_MCU_CFG0: c_uint = 0x9da0;
pub const AFE_IRQ12_MCU_CFG1: c_uint = 0x9da4;
pub const AFE_IRQ13_MCU_CFG0: c_uint = 0x9da8;
pub const AFE_IRQ13_MCU_CFG1: c_uint = 0x9dac;
pub const AFE_IRQ14_MCU_CFG0: c_uint = 0x9db0;
pub const AFE_IRQ14_MCU_CFG1: c_uint = 0x9db4;
pub const AFE_IRQ15_MCU_CFG0: c_uint = 0x9db8;
pub const AFE_IRQ15_MCU_CFG1: c_uint = 0x9dbc;
pub const AFE_IRQ16_MCU_CFG0: c_uint = 0x9dc0;
pub const AFE_IRQ16_MCU_CFG1: c_uint = 0x9dc4;
pub const AFE_IRQ17_MCU_CFG0: c_uint = 0x9dc8;
pub const AFE_IRQ17_MCU_CFG1: c_uint = 0x9dcc;
pub const AFE_IRQ18_MCU_CFG0: c_uint = 0x9dd0;
pub const AFE_IRQ18_MCU_CFG1: c_uint = 0x9dd4;
pub const AFE_IRQ19_MCU_CFG0: c_uint = 0x9dd8;
pub const AFE_IRQ19_MCU_CFG1: c_uint = 0x9ddc;
pub const AFE_IRQ20_MCU_CFG0: c_uint = 0x9de0;
pub const AFE_IRQ20_MCU_CFG1: c_uint = 0x9de4;
pub const AFE_IRQ21_MCU_CFG0: c_uint = 0x9de8;
pub const AFE_IRQ21_MCU_CFG1: c_uint = 0x9dec;
pub const AFE_IRQ22_MCU_CFG0: c_uint = 0x9df0;
pub const AFE_IRQ22_MCU_CFG1: c_uint = 0x9df4;
pub const AFE_IRQ23_MCU_CFG0: c_uint = 0x9df8;
pub const AFE_IRQ23_MCU_CFG1: c_uint = 0x9dfc;
pub const AFE_IRQ24_MCU_CFG0: c_uint = 0x9e00;
pub const AFE_IRQ24_MCU_CFG1: c_uint = 0x9e04;
pub const AFE_IRQ25_MCU_CFG0: c_uint = 0x9e08;
pub const AFE_IRQ25_MCU_CFG1: c_uint = 0x9e0c;
pub const AFE_IRQ26_MCU_CFG0: c_uint = 0x9e10;
pub const AFE_IRQ26_MCU_CFG1: c_uint = 0x9e14;
pub const AFE_CUSTOM_IRQ0_MCU_CFG0: c_uint = 0x9e68;
pub const AFE_CUSTOM_IRQ22_MCU_CFG0: c_uint = 0x9ec8;
pub const AFE_CUSTOM_IRQ22_MCU_CFG1: c_uint = 0x9ecc;
pub const AFE_CUSTOM_IRQ23_MCU_CFG0: c_uint = 0x9ed0;
pub const AFE_CUSTOM_IRQ23_MCU_CFG1: c_uint = 0x9ed4;
pub const AFE_IRQ0_CNT_MON: c_uint = 0x9f10;
pub const AFE_IRQ1_CNT_MON: c_uint = 0x9f14;
pub const AFE_IRQ2_CNT_MON: c_uint = 0x9f18;
pub const AFE_IRQ3_CNT_MON: c_uint = 0x9f1c;
pub const AFE_IRQ4_CNT_MON: c_uint = 0x9f20;
pub const AFE_IRQ5_CNT_MON: c_uint = 0x9f24;
pub const AFE_IRQ6_CNT_MON: c_uint = 0x9f28;
pub const AFE_IRQ7_CNT_MON: c_uint = 0x9f2c;
pub const AFE_IRQ8_CNT_MON: c_uint = 0x9f30;
pub const AFE_IRQ9_CNT_MON: c_uint = 0x9f34;
pub const AFE_IRQ10_CNT_MON: c_uint = 0x9f38;
pub const AFE_IRQ11_CNT_MON: c_uint = 0x9f3c;
pub const AFE_IRQ12_CNT_MON: c_uint = 0x9f40;
pub const AFE_IRQ13_CNT_MON: c_uint = 0x9f44;
pub const AFE_IRQ14_CNT_MON: c_uint = 0x9f48;
pub const AFE_IRQ15_CNT_MON: c_uint = 0x9f4c;
pub const AFE_IRQ16_CNT_MON: c_uint = 0x9f50;
pub const AFE_IRQ17_CNT_MON: c_uint = 0x9f54;
pub const AFE_IRQ18_CNT_MON: c_uint = 0x9f58;
pub const AFE_IRQ19_CNT_MON: c_uint = 0x9f5c;
pub const AFE_IRQ20_CNT_MON: c_uint = 0x9f60;
pub const AFE_IRQ21_CNT_MON: c_uint = 0x9f64;
pub const AFE_IRQ22_CNT_MON: c_uint = 0x9f68;
pub const AFE_IRQ23_CNT_MON: c_uint = 0x9f6c;
pub const AFE_IRQ24_CNT_MON: c_uint = 0x9f70;
pub const AFE_IRQ25_CNT_MON: c_uint = 0x9f74;
pub const AFE_IRQ26_CNT_MON: c_uint = 0x9f78;
pub const AFE_CUSTOM_IRQ0_CNT_MON: c_uint = 0x9f90;
pub const AFE_CUSTOM_IRQ0_MCU_CFG1: c_uint = 0x9fdc;
pub const AFE_IRQ_MCU_DSP3_EN: c_uint = 0xa000;
pub const AFE_CUSTOM_IRQ_MCU_DSP3_EN: c_uint = 0xa004;
pub const AFE_CUSTOM2_IRQ_MCU_EN: c_uint = 0xa008;
pub const AFE_CUSTOM2_IRQ_MCU_DSP_EN: c_uint = 0xa00c;
pub const AFE_CUSTOM2_IRQ_MCU_DSP2_EN: c_uint = 0xa010;
pub const AFE_CUSTOM2_IRQ_MCU_DSP3_EN: c_uint = 0xa014;
pub const AFE_CUSTOM2_IRQ_MCU_SCP_EN: c_uint = 0xa018;
pub const AFE_IRQ_MCU_MON3: c_uint = 0xa01c;
pub const AFE_IRQ_MCU_MON0: c_uint = 0xa024;
pub const AFE_IRQ_MCU_MON1: c_uint = 0xa028;
pub const AFE_IRQ_MCU_MON2: c_uint = 0xa02c;
pub const AFE_CUSTOM2_IRQ_MISS_FLAG_MCU_MON: c_uint = 0xa034;
pub const AFE_CUSTOM2_IRQ_DELAY_EN: c_uint = 0xa038;
pub const AFE_CUSTOM2_IRQ_MCU_STATUS: c_uint = 0xa03c;
pub const AFE_CUSTOM2_IRQ0_MCU_CFG0: c_uint = 0xa040;
pub const AFE_CUSTOM2_IRQ0_MCU_CFG1: c_uint = 0xa044;
pub const AFE_CUSTOM2_IRQ0_CNT_MON: c_uint = 0xa048;
pub const AFE_CUSTOM2_IRQ0_MCU_DELAY_CNT_CFG0: c_uint = 0xa04c;
pub const AFE_CUSTOM2_IRQ1_MCU_CFG0: c_uint = 0xa050;
pub const AFE_CUSTOM2_IRQ1_MCU_CFG1: c_uint = 0xa054;
pub const AFE_CUSTOM2_IRQ1_CNT_MON: c_uint = 0xa058;
pub const AFE_CUSTOM2_IRQ1_MCU_DELAY_CNT_CFG0: c_uint = 0xa05c;
pub const AFE_CUSTOM2_IRQ2_MCU_CFG0: c_uint = 0xa060;
pub const AFE_CUSTOM2_IRQ2_MCU_CFG1: c_uint = 0xa064;
pub const AFE_CUSTOM2_IRQ2_CNT_MON: c_uint = 0xa068;
pub const AFE_CUSTOM2_IRQ2_MCU_DELAY_CNT_CFG0: c_uint = 0xa06c;
pub const AFE_CUSTOM2_IRQ3_MCU_CFG0: c_uint = 0xa070;
pub const AFE_CUSTOM2_IRQ3_MCU_CFG1: c_uint = 0xa074;
pub const AFE_CUSTOM2_IRQ3_CNT_MON: c_uint = 0xa078;
pub const AFE_CUSTOM2_IRQ3_MCU_DELAY_CNT_CFG0: c_uint = 0xa07c;
pub const AFE_CUSTOM2_IRQ4_MCU_CFG0: c_uint = 0xa080;
pub const AFE_CUSTOM2_IRQ4_MCU_CFG1: c_uint = 0xa084;
pub const AFE_CUSTOM2_IRQ4_CNT_MON: c_uint = 0xa088;
pub const AFE_CUSTOM2_IRQ4_MCU_DELAY_CNT_CFG0: c_uint = 0xa08c;
pub const AFE_CUSTOM2_IRQ5_MCU_CFG0: c_uint = 0xa090;
pub const AFE_CUSTOM2_IRQ5_MCU_CFG1: c_uint = 0xa094;
pub const AFE_CUSTOM2_IRQ5_CNT_MON: c_uint = 0xa098;
pub const AFE_CUSTOM2_IRQ5_MCU_DELAY_CNT_CFG0: c_uint = 0xa09c;
pub const AFE_CUSTOM2_IRQ6_MCU_CFG0: c_uint = 0xa0a0;
pub const AFE_CUSTOM2_IRQ6_MCU_CFG1: c_uint = 0xa0a4;
pub const AFE_CUSTOM2_IRQ6_CNT_MON: c_uint = 0xa0a8;
pub const AFE_CUSTOM2_IRQ6_MCU_DELAY_CNT_CFG0: c_uint = 0xa0ac;
pub const AFE_CUSTOM2_IRQ7_MCU_CFG0: c_uint = 0xa0b0;
pub const AFE_CUSTOM2_IRQ7_MCU_CFG1: c_uint = 0xa0b4;
pub const AFE_CUSTOM2_IRQ7_CNT_MON: c_uint = 0xa0b8;
pub const AFE_CUSTOM2_IRQ7_MCU_DELAY_CNT_CFG0: c_uint = 0xa0bc;
pub const AFE_CUSTOM2_IRQ8_MCU_CFG0: c_uint = 0xa0c0;
pub const AFE_CUSTOM2_IRQ8_MCU_CFG1: c_uint = 0xa0c4;
pub const AFE_CUSTOM2_IRQ8_CNT_MON: c_uint = 0xa0c8;
pub const AFE_CUSTOM2_IRQ8_MCU_DELAY_CNT_CFG0: c_uint = 0xa0cc;
pub const AFE_CUSTOM2_IRQ9_MCU_CFG0: c_uint = 0xa0d0;
pub const AFE_CUSTOM2_IRQ9_MCU_CFG1: c_uint = 0xa0d4;
pub const AFE_CUSTOM2_IRQ9_CNT_MON: c_uint = 0xa0d8;
pub const AFE_CUSTOM2_IRQ9_MCU_DELAY_CNT_CFG0: c_uint = 0xa0dc;
pub const AFE_CUSTOM2_IRQ10_MCU_CFG0: c_uint = 0xa0e0;
pub const AFE_CUSTOM2_IRQ10_MCU_CFG1: c_uint = 0xa0e4;
pub const AFE_CUSTOM2_IRQ10_CNT_MON: c_uint = 0xa0e8;
pub const AFE_CUSTOM2_IRQ10_MCU_DELAY_CNT_CFG0: c_uint = 0xa0ec;
pub const AFE_CUSTOM2_IRQ11_MCU_CFG0: c_uint = 0xa0f0;
pub const AFE_CUSTOM2_IRQ11_MCU_CFG1: c_uint = 0xa0f4;
pub const AFE_CUSTOM2_IRQ11_CNT_MON: c_uint = 0xa0f8;
pub const AFE_CUSTOM2_IRQ11_MCU_DELAY_CNT_CFG0: c_uint = 0xa0fc;
pub const AFE_CUSTOM2_IRQ12_MCU_CFG0: c_uint = 0xa100;
pub const AFE_CUSTOM2_IRQ12_MCU_CFG1: c_uint = 0xa104;
pub const AFE_CUSTOM2_IRQ12_CNT_MON: c_uint = 0xa108;
pub const AFE_CUSTOM2_IRQ12_MCU_DELAY_CNT_CFG0: c_uint = 0xa10c;
pub const AFE_CUSTOM2_IRQ30_MCU_CFG0: c_uint = 0xa220;
pub const AFE_CUSTOM2_IRQ30_MCU_CFG1: c_uint = 0xa224;
pub const AFE_CUSTOM2_IRQ30_CNT_MON: c_uint = 0xa228;
pub const AFE_CUSTOM2_IRQ30_MCU_DELAY_CNT_CFG0: c_uint = 0xa22c;
pub const AFE_CUSTOM2_IRQ31_MCU_CFG0: c_uint = 0xa230;
pub const AFE_CUSTOM2_IRQ31_MCU_CFG1: c_uint = 0xa234;
pub const AFE_CUSTOM2_IRQ31_CNT_MON: c_uint = 0xa238;
pub const AFE_CUSTOM2_IRQ31_MCU_DELAY_CNT_CFG0: c_uint = 0xa23c;
pub const AFE_CUSTOM3_IRQ8_MCU_CFG0: c_uint = 0xa2c0;
pub const AFE_CUSTOM3_IRQ8_MCU_CFG1: c_uint = 0xa2c4;
pub const AFE_CUSTOM3_IRQ8_CNT_MON: c_uint = 0xa2c8;
pub const AFE_CUSTOM3_IRQ8_MCU_DELAY_CNT_CFG0: c_uint = 0xa2cc;
pub const AFE_CUSTOM3_IRQ9_MCU_CFG0: c_uint = 0xa2d0;
pub const AFE_CUSTOM3_IRQ9_MCU_CFG1: c_uint = 0xa2d4;
pub const AFE_CUSTOM3_IRQ9_CNT_MON: c_uint = 0xa2d8;
pub const AFE_CUSTOM3_IRQ9_MCU_DELAY_CNT_CFG0: c_uint = 0xa2dc;
pub const AFE_CUSTOM3_IRQ_MISS_FLAG_MCU_MON: c_uint = 0xa440;
pub const AFE_CUSTOM3_IRQ_DELAY_EN: c_uint = 0xa444;
pub const AFE_CUSTOM3_IRQ_MCU_STATUS: c_uint = 0xa448;
pub const AFE_CUSTOM3_IRQ_MCU_EN: c_uint = 0xa44c;
pub const AFE_CUSTOM3_IRQ_MCU_DSP_EN: c_uint = 0xa450;
pub const AFE_CUSTOM3_IRQ_MCU_DSP2_EN: c_uint = 0xa454;
pub const AFE_CUSTOM3_IRQ_MCU_DSP3_EN: c_uint = 0xa458;
pub const AFE_CUSTOM3_IRQ_MCU_DSP_WLA_EN: c_uint = 0xa45c;
pub const AFE_CUSTOM3_IRQ_MCU_SCP_EN: c_uint = 0xa460;
pub const AFE_CUSTOM2_IRQ_MCU_DSP_WLA_EN: c_uint = 0xa464;
pub const AFE_IRQ_MCU_DSP_WLA_EN: c_uint = 0xa468;
pub const AFE_COMMON2_IRQ_MCU_STATUS: c_uint = 0xa46c;
pub const AFE_COMMON2_IRQ_MCU_EN: c_uint = 0xa470;
pub const AFE_COMMON2_IRQ_MCU_DSP_EN: c_uint = 0xa474;
pub const AFE_COMMON2_IRQ_MCU_DSP2_EN: c_uint = 0xa478;
pub const AFE_COMMON2_IRQ_MCU_DSP3_EN: c_uint = 0xa47c;
pub const AFE_COMMON2_IRQ_MCU_DSP_WLA_EN: c_uint = 0xa480;
pub const AFE_COMMON2_IRQ_MCU_SCP_EN: c_uint = 0xa484;
pub const AFE_CUSTOM_IRQ_MCU_DSP_WLA_EN: c_uint = 0xa508;

pub const AFE_IRQ_STATUS_BITS: c_uint = 0x7FFFFFF;
