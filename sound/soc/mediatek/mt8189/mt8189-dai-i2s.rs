...
//! Source: sound/soc/mediatek/mt8189/mt8189-dai-i2s.c
#![no_std]
...
// I2SIN0
    ...
    {"I2SIN0", core::ptr::null_mut(), "I2SOUT0_CG"},
...
// i2sin1
    ...
    {"I2SIN1", core::ptr::null_mut(), "I2SOUT1_CG"},
// i2sout0
...
// allow i2s on without codec on
    {"I2SIN0", core::ptr::null_mut(), "I2S_IN0_Mux"},
    {"I2S_IN0_Mux", "Dummy_Widget", "I2S_DUMMY_IN"},
    {"I2SIN1", core::ptr::null_mut(), "I2S_IN1_Mux"},
    {"I2S_IN1_Mux", "Dummy_Widget", "I2S_DUMMY_IN"},
    {"I2S_OUT0_Mux", "Dummy_Widget", "I2SOUT0"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S_OUT0_Mux"},
    {"I2S_OUT1_Mux", "Dummy_Widget", "I2SOUT1"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S_OUT1_Mux"},
    {"I2S_OUT4_Mux", "Dummy_Widget", "I2SOUT4"},
    {"I2S_DUMMY_OUT", core::ptr::null_mut(), "I2S_OUT4_Mux"},
    };
// i2s dai ops
...
#[no_mangle]
unsafe extern "C" fn mt8189_dai_i2s_get_share(afe: *mut mtk_base_afe) -> c_int {
...
unsafe extern "C" fn init_i2s_priv_data(afe: *mut mtk_base_afe) -> c_int {
    ...
    struct mtk_afe_i2s_priv *i2s_priv;
    for (int i = 0; i < DAI_I2S_NUM; i++) {
    let mut id: c_int = mt8189_i2s_priv[i].id;
