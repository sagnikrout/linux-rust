...
//! Source: sound/soc/mediatek/mt8189/mt8189-afe-pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt8189_rate_transform(dev: *mut device, rate: c_uint) -> c_uint {
...
// not support 260K
    ...
    let mut rate_val: c_uint = mt8189_rate_transform(afe.dev, rate);
    let mut update_val: c_uint = update ? calculate_cm_update(rate, ch) : 0x64;
...
#[no_mangle]
unsafe extern "C" fn mt8189_enable_cm_bypass(afe: *mut mtk_base_afe, id: c_int, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8189_irq_fs(substream: *mut snd_pcm_substream, rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8189_get_memif_pbuf_size(substream: *mut snd_pcm_substream) -> c_int {
...
// Audio Pin
    {"I2SOUT0", core::ptr::null_mut(), "I2S0_PIN"},
    {"I2SIN0", core::ptr::null_mut(), "I2S0_PIN"},
    {"I2SOUT1", core::ptr::null_mut(), "I2S1_PIN"},
    {"I2SIN1", core::ptr::null_mut(), "I2S1_PIN"},
    {"PCM 0 Playback", core::ptr::null_mut(), "PCM0_PIN"},
...
#[no_mangle]
unsafe extern "C" fn mt8189_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8189_afe_irq_handler(irq_id: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt8189_dai_memif_register(afe: *mut mtk_base_afe) -> c_int {
...
// disable afe clock
    ...
    mt8189_afe_runtime_resume, core::ptr::null_mut())
    };
