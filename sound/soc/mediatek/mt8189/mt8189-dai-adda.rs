...
//! Source: sound/soc/mediatek/mt8189/mt8189-dai-adda.c
#![no_std]
...
// mt6363 vs1 voter
pub const VS1_MT6338_MASK_SFT: c_uint = 0x1;
pub const RG_BUCK_VS1_VOTER_EN_LO: c_uint = 0x189a;
pub const RG_BUCK_VS1_VOTER_EN_LO_SET: c_uint = 0x189b;
pub const RG_BUCK_VS1_VOTER_EN_LO_CLR: c_uint = 0x189c;
pub const AUDIO_SDM_LEVEL_NORMAL: c_uint = 0x1d;
pub const MTK_AFE_ADDA_DL_GAIN_NORMAL: c_uint = 0xf74f;
...
#[no_mangle]
unsafe extern "C" fn mtk_adda_ul_src_enable_dmic(afe: *mut mtk_base_afe, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_adda_mtkaif_need_phase_delay(afe_priv: *mut mt8189_afe_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt6363_vs1_vote(afe: *mut mtk_base_afe) {
    static void mt6363_vs1_vote(struct mtk_base_afe *afe)
    {
    struct mt8189_afe_private *afe_priv = afe.platform_priv;
    let mut pre_enable: bool = afe_priv.is_mt6363_vote;
    bool enable;
    ...
    struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
    struct mt8189_afe_private *afe_priv = afe.platform_priv;
    let mut is_adda_dl_max_vol: bool = ucontrol.value.integer.value[0];
...
// playback
    ...
    {"ADDA Playback", core::ptr::null_mut(), "AUD_PAD_TOP"},
    {"ADDA Playback", core::ptr::null_mut(), "VS1_VOTER_DL"},
    {"ADDA Playback", core::ptr::null_mut(), "ADDA_DL0_CG"},
    ...
    {"ADDA Capture", core::ptr::null_mut(), "VS1_VOTER_UL"},
    {"ADDA Capture", core::ptr::null_mut(), "ADDA_UL0_CG"},
// capture
    {"ADDA_UL_Mux", "MTKAIF", "ADDA Capture"},
    {"ADDA_UL_Mux", "AP_DMIC", "AP DMIC Capture"},
    {"ADDA_CH34_UL_Mux", "AP_DMIC", "AP DMIC CH34 Capture"},
    {"AP DMIC Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP DMIC Capture Enable"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC_FIFO"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC_EN"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC0_CG"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "ADDA Enable"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP DMIC CH34 Capture Enable"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC_CH34_FIFO"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC_CH34_EN"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC1_CG"},
    {"AP DMIC Capture", core::ptr::null_mut(), "AP_DMIC_INPUT"},
    {"AP DMIC CH34 Capture", core::ptr::null_mut(), "AP_DMIC_INPUT"},
    };
// dai ops
...
#[no_mangle]
pub unsafe extern "C" fn mt8189_dai_adda_register(afe: *mut mtk_base_afe) -> c_int {
