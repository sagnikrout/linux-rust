...
//! Source: sound/soc/mediatek/mt8183/mt8183-dai-adda.c
#![no_std]
...
// clk
    {"ADDA Playback", core::ptr::null_mut(), "mtkaif_26m_clk"},
    {"ADDA Playback", core::ptr::null_mut(), "aud_dac_clk"},
    {"ADDA Playback", core::ptr::null_mut(), "aud_dac_predis_clk"},
    {"ADDA Capture", core::ptr::null_mut(), "mtkaif_26m_clk"},
    {"ADDA Capture", core::ptr::null_mut(), "aud_adc_clk"},
    };
#[no_mangle]
unsafe extern "C" fn set_mtkaif_rx(afe: *mut mtk_base_afe) -> c_int {
