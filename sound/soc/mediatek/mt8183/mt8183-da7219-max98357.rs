...
//! Source: sound/soc/mediatek/mt8183/mt8183-da7219-max98357.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt8183_da7219_max98357_priv {
    pub hdmi_jack: snd_soc_jack headset_jack,,
}
...
unsafe extern "C" fn mt8183_da7219_max98357_hdmi_init(rtd: *mut snd_soc_pcm_runtime) -> c_int {
    ...
    &priv.hdmi_jack, core::ptr::null_mut());
    }
#[no_mangle]
...
// Enable Headset and 4 Buttons Jack detection
    ...
    snd_soc_component_set_jack(component, &priv.headset_jack, core::ptr::null_mut());
    return 0;
    }
