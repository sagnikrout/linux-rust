...
//! Source: sound/soc/mediatek/mt8183/mt8183-dai-i2s.c
#![no_std]
...
// dai ops
    ...
    let mut i2s_con: c_uint = 0, fmt_con = I2S_FMT_I2S << I2S_FMT_SFT;
    let mut ret: c_int = 0;
    if (i2s_priv) {
    i2s_priv.rate = rate;
...
#[no_mangle]
unsafe extern "C" fn mt8183_dai_i2s_set_priv(afe: *mut mtk_base_afe) -> c_int {
