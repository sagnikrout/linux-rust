...
//! Source: sound/soc/mediatek/mt8183/mt8183-afe-pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt8183_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt8183_afe_irq_handler(irq_id: c_int, dev: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn mt8183_afe_pcm_dev_remove(pdev: *mut platform_device) {
    ...
    mt8183_afe_runtime_resume, core::ptr::null_mut())
    };
