...
//! Source: sound/soc/mediatek/mt8183/mt8183-mt6358-ts3a227-max98357.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt8183_mt6358_ts3a227_max98357_priv {
    pub pinctrl: *mut pinctrl,
    pub pin_states: [*mut pinctrl_state; PIN_STATE_MAX],
...
// Enable Headset and 4 Buttons Jack detection
    ...
    dai_link.cpus[0].name = core::ptr::null_mut();
    dai_link.cpus[0].of_node = ec_codec;
    dai_link.cpus[0].dai_name = core::ptr::null_mut();
    dai_link.codecs[0].name = core::ptr::null_mut();
