...
//! Source: sound/soc/sophgo/cv1800b-sound-adc.c
#![no_std]
...
pub const CV1800B_RXADC_WORD_LEN: c_int = 16;
pub const CV1800B_RXADC_CHANNELS: c_int = 2;
pub const CV1800B_RXADC_CTRL0: c_uint = 0x00;
pub const CV1800B_RXADCC_CTRL1: c_uint = 0x04;
pub const CV1800B_RXADC_STATUS: c_uint = 0x08;
pub const CV1800B_RXADC_CLK: c_uint = 0x0c;
pub const CV1800B_RXADC_ANA0: c_uint = 0x10;
pub const CV1800B_RXADC_ANA1: c_uint = 0x14;
pub const CV1800B_RXADC_ANA2: c_uint = 0x18;
pub const CV1800B_RXADC_ANA3: c_uint = 0x1c;
pub const CV1800B_RXADC_ANA4: c_uint = 0x20;
// CV1800B_RXADC_CTRL0
...
#[no_mangle]
unsafe extern "C" fn cv1800b_adc_setbclk_div(priv: *mut cv1800b_priv, rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cv1800b_adc_enable(priv: *mut cv1800b_priv, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn cv1800b_adc_calc_db(ana0: u32, right: bool) -> c_uint {
    ...
    let mut step: u32 = step_mask ? __ffs(step_mask) : 0;
    step = min(step, 12U);
...
// init adc
    ...
    let mut ana0: u32 = readl(priv.regs + CV1800B_RXADC_ANA0);
    let mut left: c_uint = cv1800b_adc_calc_db(ana0, false);
    let mut right: c_uint = cv1800b_adc_calc_db(ana0, true);
    ...
    struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
    struct cv1800b_priv *priv = snd_soc_component_get_drvdata(component);
    let mut v_left: u32 = clamp_t(u32, ucontrol.value.integer.value[0], 0, 24);
    let mut v_right: u32 = clamp_t(u32, ucontrol.value.integer.value[1], 0, 24);
    u32 val, old_val;
