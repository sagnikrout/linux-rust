...
//! Source: sound/drivers/pcsp/pcsp_lib.c
#![no_std]
...
//
    ...
    "(expect bad sound)");
pub const DMIX_WANTS_S16: c_int = 1;
//
// Call snd_pcm_period_elapsed in a work
// This avoids spinlock messes and long-running irq contexts
//
#[no_mangle]
unsafe extern "C" fn pcsp_call_pcm_elapsed(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn pcsp_timer_update(chip: *mut snd_pcsp) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn pcsp_pointer_update(chip: *mut snd_pcsp) {
...
#[no_mangle]
pub unsafe extern "C" fn pcsp_do_timer(handle: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn pcsp_start_playing(chip: *mut snd_pcsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcsp_stop_playing(chip: *mut snd_pcsp) {
