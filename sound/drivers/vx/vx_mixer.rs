...
//! Source: sound/drivers/vx/vx_mixer.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn vx_write_codec_reg(chip: *mut vx_core, codec: c_int, data: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn vx_set_codec_reg(chip: *mut vx_core, codec: c_int, reg: c_int, val: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn vx_set_analog_output_level(chip: *mut vx_core, codec: c_int, left: c_int, right: c_int) {
...
//
pub const DAC_ATTEN_MIN: c_uint = 0x08;
pub const DAC_ATTEN_MAX: c_uint = 0x38;
#[no_mangle]
...
//
#[no_mangle]
pub unsafe extern "C" fn vx_reset_codec(chip: *mut vx_core, cold_reset: c_int) {
    void vx_reset_codec(struct vx_core *chip, int cold_reset)
    {
    unsigned int i;
    let mut port: c_int = chip.type >= VX_TYPE_VXPOCKET ? 0x75 : 0x65;
...
//
#[no_mangle]
unsafe extern "C" fn vx_change_audio_source(chip: *mut vx_core, src: c_int) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vx_audio_level {
    pub 1: unsigned int has_level:,
    pub 1: unsigned int has_monitor_level:,
    pub 1: unsigned int has_mute:,
    pub 1: unsigned int has_monitor_mute:,
    pub mute: c_uint,
    pub monitor_mute: c_uint,
    pub level: c_short,
    pub monitor_level: c_short,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn vx_set_monitor_level(chip: *mut vx_core, audio: c_int, level: c_int, active: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_set_audio_switch(chip: *mut vx_core, audio: c_int, active: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_set_audio_gain(chip: *mut vx_core, audio: c_int, capture: c_int, level: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_reset_audio_levels(chip: *mut vx_core) {
...
//
pub const VU_METER_CHANNELS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vx_vu_meter {
    pub saturated: c_int,
    pub vu_level: c_int,
    pub peak_level: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn vx_get_audio_vu_meter(chip: *mut vx_core, audio: c_int, capture: c_int, info: *mut vx_vu_meter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_output_level_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vx_output_level_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    static int vx_output_level_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
    {
    struct vx_core *chip = snd_kcontrol_chip(kcontrol);
    let mut codec: c_int = kcontrol.id.index;
...
#[no_mangle]
unsafe extern "C" fn vx_output_level_put(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_clock_mode_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_audio_gain_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
unsafe extern "C" fn vx_audio_gain_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
    ...
    {
    struct vx_core *chip = snd_kcontrol_chip(kcontrol);
    let mut audio: c_int = kcontrol.private_value & 0xff;
    let mut capture: c_int = (kcontrol.private_value >> 8) & 1;
    guard(mutex)(&chip.mixer_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn vx_iec958_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vx_iec958_mask_get(kcontrol: *mut snd_kcontrol, ucontrol: *mut snd_ctl_elem_value) -> c_int {
...
// VU meter
//
pub const METER_MAX: c_uint = 0xff;
pub const METER_SHIFT: c_int = 16;
#[no_mangle]
unsafe extern "C" fn vx_vu_meter_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
