...
//! Source: sound/drivers/vx/vx_core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_check_reg_bit(chip: *mut vx_core, reg: c_int, mask: c_int, bit: c_int, time: c_int) -> c_int {
    int snd_vx_check_reg_bit(struct vx_core *chip, int reg, int mask, int bit, int time)
    {
    let mut end_time: c_ulong = jiffies + (time * HZ + 999) / 1000;
...
//
#[no_mangle]
unsafe extern "C" fn vx_send_irq_dsp(chip: *mut vx_core, num: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_reset_chk(chip: *mut vx_core) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_transfer_end(chip: *mut vx_core, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_read_status(chip: *mut vx_core, rmh: *mut vx_rmh) -> c_int {
...
pub const MASK_MORE_THAN_1_WORD_COMMAND: c_uint = 0x00008000;
pub const MASK_1_WORD_COMMAND: c_uint = 0x00ff7fff;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn vx_send_msg_nolock(chip: *mut vx_core, rmh: *mut vx_rmh) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vx_send_msg(chip: *mut vx_core, rmh: *mut vx_rmh) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vx_send_rih_nolock(chip: *mut vx_core, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vx_send_rih(chip: *mut vx_core, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_load_boot_image(chip: *mut vx_core, boot: *const firmware) -> c_int {
    int snd_vx_load_boot_image(struct vx_core *chip, const struct firmware *boot)
    {
    unsigned int i;
    let mut no_fillup: c_int = vx_has_new_dsp(chip);
// check the length of boot image
    ...
    {
// more strict check
    let mut c: c_uint = ((u32)boot.data[0] << 16) | ((u32)boot.data[1] << 8) | boot.data[2];
    if (boot.size != (c + 2) * 3)
    return -EINVAL;
    }
...
//
#[no_mangle]
unsafe extern "C" fn vx_test_irq_src(chip: *mut vx_core, ret: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_threaded_irq_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_irq_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn vx_reset_board(chip: *mut vx_core, cold_reset: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_dsp_boot(chip: *mut vx_core, boot: *const firmware) -> c_int {
    int snd_vx_dsp_boot(struct vx_core *chip, const struct firmware *boot)
    {
    int err;
    let mut cold_reset: c_int = !(chip.chip_status & VX_STAT_DEVICE_INIT);
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_dsp_load(chip: *mut vx_core, dsp: *const firmware) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_suspend(chip: *mut vx_core) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_resume(chip: *mut vx_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_vx_release(dev: *mut device, data: *mut c_void) {
