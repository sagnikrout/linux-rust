...
//! Source: sound/drivers/vx/vx_uer.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn vx_modify_board_clock(chip: *mut vx_core, sync: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_modify_board_inputs(chip: *mut vx_core) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_read_one_cbit(chip: *mut vx_core, index: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_write_one_cbit(chip: *mut vx_core, index: c_int, val: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn vx_read_uer_status(chip: *mut vx_core, mode: *mut c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_calc_clock_from_freq(chip: *mut vx_core, freq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_change_clock_source(chip: *mut vx_core, source: c_int) {
