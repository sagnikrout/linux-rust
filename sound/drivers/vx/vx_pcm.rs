...
//! Source: sound/drivers/vx/vx_pcm.c
#![no_std]
...
//
    ...
    {
    let mut header: c_uint = HEADER_FMT_BASE;
...
#[no_mangle]
pub unsafe extern "C" fn if(11025: runtime->rate <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn vx_set_ibl(chip: *mut vx_core, info: *mut vx_ibl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_get_pipe_state(chip: *mut vx_core, pipe: *mut vx_pipe, state: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_query_hbuffer_size(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_pipe_can_start(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_conf_pipe(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_send_irqa(chip: *mut vx_core) -> c_int {
...
pub const MAX_WAIT_FOR_DSP: c_int = 250;
//
...
//
#[no_mangle]
unsafe extern "C" fn vx_toggle_pipe(chip: *mut vx_core, pipe: *mut vx_pipe, state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_stop_pipe(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_free_pipe(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_start_stream(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_stop_stream(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_pcm_playback_close(subs: *mut snd_pcm_substream) -> c_int {
    ...
    chip.playback_pipes[pipe.number] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn vx_notify_end_of_buffer(chip: *mut vx_core, pipe: *mut vx_pipe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_pcm_trigger(subs: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_pcm_playback_pointer(subs: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
//
#[no_mangle]
unsafe extern "C" fn vx_pcm_prepare(subs: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vx_pcm_capture_open(subs: *mut snd_pcm_substream) -> c_int {
    static int vx_pcm_capture_open(struct snd_pcm_substream *subs)
    {
    struct snd_pcm_runtime *runtime = subs.runtime;
    struct vx_core *chip = snd_pcm_substream_chip(subs);
    struct vx_pipe *pipe;
    struct vx_pipe *pipe_out_monitoring = core::ptr::null_mut();
    unsigned int audio;
    int err;
    if (chip.chip_status & VX_STAT_IS_STALE)
    return -EBUSY;
...
// assuming stereo
    ...
    pipe.monitoring_pipe = pipe_out_monitoring; /* default value core::ptr::null_mut() */
...
//
#[no_mangle]
unsafe extern "C" fn vx_pcm_capture_close(subs: *mut snd_pcm_substream) -> c_int {
    ...
    return -EINVAL;
    pipe = subs.runtime.private_data;
    chip.capture_pipes[pipe.number] = core::ptr::null_mut();
...
//
    ...
    if (count > 0) {
// ok, let's accelerate!
    let mut align: c_int = pipe.align * 3;
...
//
#[no_mangle]
unsafe extern "C" fn vx_pcm_capture_pointer(subs: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn vx_pcm_update_intr(chip: *mut vx_core, events: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn vx_init_audio_io(chip: *mut vx_core) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_vx_pcm_free(pcm: *mut snd_pcm) {
    static void snd_vx_pcm_free(struct snd_pcm *pcm)
    {
    struct vx_core *chip = pcm.private_data;
    chip.pcm[pcm.device] = core::ptr::null_mut();
    kfree(chip.playback_pipes);
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_vx_pcm_new(chip: *mut vx_core) -> c_int {
