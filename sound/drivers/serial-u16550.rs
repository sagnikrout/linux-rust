...
//! Source: sound/drivers/serial-u16550.c
#![no_std]
...
//
    ...
    module_param_hw_array(port, long, ioport, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(port, "Port # for UART16550A chip.");
    module_param_hw_array(irq, int, irq, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(irq, "IRQ # for UART16550A chip.");
    module_param_array(speed, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(speed, "Speed in bauds.");
    module_param_array(base, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(base, "Base for divisor in bauds.");
    module_param_array(outs, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(outs, "Number of MIDI outputs.");
    module_param_array(ins, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(ins, "Number of MIDI inputs.");
    module_param_array(droponfull, bool, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(droponfull, "Flag to enable drop-on-full buffer mode");
    module_param_array(adaptor, int, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(adaptor, "Type of adaptor.");
// #define SNDRV_SERIAL_MS124W_MB_NOCOMBO 1*/  /* Address outs as 0-3 instead of bitmap

#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_uart16550 {
    pub card: *mut snd_card,
    pub rmidi: *mut snd_rawmidi,
    pub midi_output: [*mut snd_rawmidi_substream; SNDRV_SERIAL_MAX_OUTS],
    pub midi_input: [*mut snd_rawmidi_substream; SNDRV_SERIAL_MAX_INS],
    pub /: *mut *mut int filemode; / open status of file,
    pub open_lock: spinlock_t,
    pub irq: c_int,
    pub base: c_ulong,
    pub speed: c_uint,
    pub speed_base: c_uint,
    pub divisor: c_uchar,
    pub old_divisor_lsb: c_uchar,
    pub old_divisor_msb: c_uchar,
    pub old_line_ctrl_reg: c_uchar,
// parameter for using of write loop
    pub /: *mut *mut short int fifo_limit; / used in uart16550,
    pub /: *mut *mut short int fifo_count; / used in uart16550,
// type of adaptor
    pub adaptor: c_int,
// inputs
    pub prev_in: c_int,
...
// outputs
    pub prev_out: c_int,
    pub prev_status: [c_uchar; SNDRV_SERIAL_MAX_OUTS],
// write buffer and its writing/reading position
    pub tx_buff: [c_uchar; TX_BUFF_SIZE],
    pub buff_in_count: c_int,
    pub buff_in: c_int,
    pub buff_out: c_int,
    pub drop_on_full: c_int,
// wait timer
    pub timer_running:1: c_uint,
    pub buffer_timer: timer_list,
}

    static struct platform_device *devices[SNDRV_CARDS];
#[no_mangle]
pub unsafe extern "C" fn snd_uart16550_add_timer(uart: *mut snd_uart16550) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_uart16550_del_timer(uart: *mut snd_uart16550) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_uart16550_buffer_output(uart: *mut snd_uart16550) {
    static inline void snd_uart16550_buffer_output(struct snd_uart16550 *uart)
    {
    let mut buff_out: c_ushort = uart.buff_out;
...
//
#[no_mangle]
unsafe extern "C" fn snd_uart16550_io_loop(uart: *mut *mut snd_uart16550) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_uart16550_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn snd_uart16550_detect(uart: *mut snd_uart16550) -> c_int {
    static int snd_uart16550_detect(struct snd_uart16550 *uart)
    {
    let mut io_base: c_ulong = uart.base;
    int ok;
    unsigned char c;
...
#[no_mangle]
unsafe extern "C" fn snd_uart16550_do_open(uart: *mut *mut snd_uart16550) {
...
#[no_mangle]
unsafe extern "C" fn snd_uart16550_do_close(uart: *mut *mut snd_uart16550) {
...
unsafe extern "C" fn snd_uart16550_input_close(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    guard(spinlock_irqsave)(&uart.open_lock);
    uart.filemode &= ~SERIAL_MODE_INPUT_OPEN;
    uart.midi_input[substream.number] = core::ptr::null_mut();
    if (uart.filemode == SERIAL_MODE_NOT_OPENED)
...
unsafe extern "C" fn snd_uart16550_output_close(substream: *mut snd_rawmidi_substream) -> c_int {
    ...
    guard(spinlock_irqsave)(&uart.open_lock);
    uart.filemode &= ~SERIAL_MODE_OUTPUT_OPEN;
    uart.midi_output[substream.number] = core::ptr::null_mut();
    if (uart.filemode == SERIAL_MODE_NOT_OPENED)
    snd_uart16550_do_close(uart);
    return 0;
    };
    ...
    unsigned char byte)
    {
    let mut buff_in: c_ushort = uart.buff_in;
...
unsafe extern "C" fn snd_uart16550_output_write(substream: *mut snd_rawmidi_substream) {
    ...
    struct snd_uart16550 *uart = substream.rmidi.private_data;
    char first;
    let mut lasttime: static unsigned long = 0;
...
#[no_mangle]
unsafe extern "C" fn snd_uart16550_substreams(stream: *mut snd_rawmidi_str) {
...
#[no_mangle]
unsafe extern "C" fn snd_serial_unregister_all() {
...
#[no_mangle]
unsafe extern "C" fn alsa_card_serial_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alsa_card_serial_exit() -> void __exit {
