...
//! Source: sound/drivers/mpu401/mpu401.c
#![no_std]
...
//
    ...
    module_param_array(pnp, bool, core::ptr::null_mut(), 0444);
    ...
    module_param_array(uart_enter, bool, core::ptr::null_mut(), 0444);
...
#[no_mangle]
unsafe extern "C" fn alsa_card_mpu401_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alsa_card_mpu401_exit() -> void __exit {
