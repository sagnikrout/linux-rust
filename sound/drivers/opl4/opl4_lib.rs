...
//! Source: sound/drivers/opl4/opl4_lib.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
pub unsafe extern "C" fn snd_opl4_wait(opl4: *mut snd_opl4) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_opl4_read_memory(opl4: *mut snd_opl4, buf: *mut c_char, offset: c_int, size: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_opl4_write_memory(opl4: *mut snd_opl4, buf: *const c_char, offset: c_int, size: c_int) {
...
#[no_mangle]
unsafe extern "C" fn snd_opl4_enable_opl4(opl4: *mut snd_opl4) {
...
#[no_mangle]
unsafe extern "C" fn snd_opl4_detect(opl4: *mut snd_opl4) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl4_seq_dev_free(seq_dev: *mut snd_seq_device) {
...
#[no_mangle]
unsafe extern "C" fn snd_opl4_create_seq_dev(opl4: *mut snd_opl4, seq_device: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl4_free(opl4: *mut snd_opl4) {
