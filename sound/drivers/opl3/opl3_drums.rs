...
//! Source: sound/drivers/opl3/opl3_drums.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_opl3_drum_voice {
    pub voice: c_int,
    pub op: c_int,
    pub am_vib: c_uchar,
    ...
    pub feedback_connection: c_uchar,
    pub wave_select: c_uchar,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct snd_opl3_drum_note {
    pub voice: c_int,
    pub fnum: c_uchar,
    pub octave_f: c_uchar,
    pub feedback_connection: c_uchar,
}

    let mut bass_op0: static struct snd_opl3_drum_voice = {6, 0, 0x00, 0x32, 0xf8, 0x66, 0x30, 0x00};
    let mut bass_op1: static struct snd_opl3_drum_voice = {6, 1, 0x00, 0x03, 0xf6, 0x57, 0x30, 0x00};
    let mut bass_note: static struct snd_opl3_drum_note = {6, 0x90, 0x09};
    let mut hihat: static struct snd_opl3_drum_voice = {7, 0, 0x00, 0x03, 0xf0, 0x06, 0x20, 0x00};
    let mut snare: static struct snd_opl3_drum_voice = {7, 1, 0x00, 0x03, 0xf0, 0x07, 0x20, 0x02};
    let mut snare_note: static struct snd_opl3_drum_note = {7, 0xf4, 0x0d};
    let mut tomtom: static struct snd_opl3_drum_voice = {8, 0, 0x02, 0x03, 0xf0, 0x06, 0x10, 0x00};
    let mut tomtom_note: static struct snd_opl3_drum_note = {8, 0xf4, 0x09};
    let mut cymbal: static struct snd_opl3_drum_voice = {8, 1, 0x04, 0x03, 0xf0, 0x06, 0x10, 0x00};
//
...
//
    ...
    {
    let mut op_offset: c_uchar = snd_opl3_regmap[data.voice][data.op];
    let mut voice_offset: c_uchar = data.voice;
