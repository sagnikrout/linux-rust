...
//! Source: sound/drivers/opl3/opl3_synth.c
#![no_std]
...
// Macro flag: #define OPL3_SUPPORT_SYNTH
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_open(hw: *mut *mut snd_hwdep, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_release(hw: *mut *mut snd_hwdep, file: *mut file) -> c_int {
...
//
    ...
    type = FM_PATCH_OPL2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !memcmp(inst.key, _arg: FM_KEY_4OP, _arg: 4)) -> else {
...
pub const AM_VIB: c_int = 0;
pub const KSL_LEVEL: c_int = 2;
pub const ATTACK_DECAY: c_int = 4;
pub const SUSTAIN_RELEASE: c_int = 6;
pub const WAVE_SELECT: c_int = 8;
// offset for SBI instrument
pub const CONNECTION: c_int = 10;
pub const OFFSET_4OP: c_int = 11;
//
...
// pretty dumb hash key
    let mut key: c_uint = (prog + bank) % OPL3_PATCH_HASH_SIZE;
    struct fm_patch *patch;
...
// ------------------------------
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_reset(opl3: *mut *mut snd_opl3) {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_play_note(opl3: *mut *mut snd_opl3, note: *mut *mut snd_dm_fm_note) -> c_int {
    static int snd_opl3_play_note(struct snd_opl3 * opl3, struct snd_dm_fm_note * note)
    {
    unsigned short reg_side;
    unsigned char voice_offset;
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_set_voice(opl3: *mut *mut snd_opl3, voice: *mut *mut snd_dm_fm_voice) -> c_int {
    static int snd_opl3_set_voice(struct snd_opl3 * opl3, struct snd_dm_fm_voice * voice)
    {
    unsigned short reg_side;
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_set_params(opl3: *mut *mut snd_opl3, params: *mut *mut snd_dm_fm_params) -> c_int {
    static int snd_opl3_set_params(struct snd_opl3 * opl3, struct snd_dm_fm_params * params)
    {
    unsigned char reg_val;
    reg_val = 0x00;
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_set_mode(opl3: *mut *mut snd_opl3, mode: c_int) -> c_int {
    static int snd_opl3_set_mode(struct snd_opl3 * opl3, int mode)
    {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_set_connection(opl3: *mut *mut snd_opl3, connection: c_int) -> c_int {
    static int snd_opl3_set_connection(struct snd_opl3 * opl3, int connection)
    {
    unsigned char reg_val;
// OPL-3 only
