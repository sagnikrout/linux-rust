...
//! Source: sound/drivers/opl3/opl3_lib.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn snd_opl2_command(opl3: *mut *mut snd_opl3, cmd: c_ushort, val: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_command(opl3: *mut *mut snd_opl3, cmd: c_ushort, val: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_detect(opl3: *mut *mut snd_opl3) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_opl3_timer1_start(timer: *mut *mut snd_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_timer1_stop(timer: *mut *mut snd_timer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_opl3_timer2_start(timer: *mut *mut snd_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_timer2_stop(timer: *mut *mut snd_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_timer1_init(opl3: *mut *mut snd_opl3, timer_no: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_timer2_init(opl3: *mut *mut snd_opl3, timer_no: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_interrupt(hw: *mut *mut snd_hwdep) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_timer_new(opl3: *mut *mut snd_opl3, timer1_dev: c_int, timer2_dev: c_int) -> c_int {
