...
//! Source: sound/drivers/opl3/opl3_seq.c
#![no_std]
...
//
    ...
    let mut use_internal_drums: bool = 0;
    module_param(use_internal_drums, bool, 0444);
    MODULE_PARM_DESC(use_internal_drums, "Enable internal OPL2/3 drums.");
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_synth_use_inc(opl3: *mut *mut snd_opl3) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_synth_use_dec(opl3: *mut *mut snd_opl3) {
    void snd_opl3_synth_use_dec(struct snd_opl3 * opl3)
    {
    module_put(opl3.card.module);
    }
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_synth_setup(opl3: *mut *mut snd_opl3) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_opl3_synth_cleanup(opl3: *mut *mut snd_opl3) {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_synth_use(private_data: *mut c_void, info: *mut *mut snd_seq_port_subscribe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_synth_unuse(private_data: *mut c_void, info: *mut *mut snd_seq_port_subscribe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_opl3_synth_create_port(opl3: *mut *mut snd_opl3) -> c_int {
    ...
    if (opl3.chset == core::ptr::null_mut())
    return -ENOMEM;
