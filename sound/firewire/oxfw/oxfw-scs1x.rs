...
//! Source: sound/firewire/oxfw/oxfw-scs1x.c
#![no_std]
...
pub const HSS1394_ADDRESS: c_uint = 0xc007dedadadaULL;
pub const HSS1394_MAX_PACKET_SIZE: c_int = 64;
pub const HSS1394_TAG_USER_DATA: c_uint = 0x00;
pub const HSS1394_TAG_CHANGE_ADDRESS: c_uint = 0xf1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fw_scs1x {
...
// For MIDI playback.
    ...
    pub output_bytes: u8,
    pub output_escaped: bool,
    pub output_escape_high_nibble: bool,
    pub work: work_struct,
    pub idle_wait: wait_queue_head_t,
    pub buffer: [u8; HSS1394_MAX_PACKET_SIZE],
    pub transaction_running: bool,
...
#[no_mangle]
unsafe extern "C" fn is_valid_running_status(status: u8) -> bool {
    static bool is_valid_running_status(u8 status)
    {
    return status >= 0x80 && status <= 0xef;
    }
#[no_mangle]
unsafe extern "C" fn is_one_byte_cmd(status: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_two_bytes_cmd(status: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_three_bytes_cmd(status: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_invalid_cmd(status: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn midi_capture_open(stream: *mut snd_rawmidi_substream) -> c_int {
    static int midi_capture_open(struct snd_rawmidi_substream *stream)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn midi_capture_close(stream: *mut snd_rawmidi_substream) -> c_int {
...
unsafe extern "C" fn midi_capture_trigger(stream: *mut snd_rawmidi_substream, up: c_int) {
    ...
    WRITE_ONCE(scs.input, core::ptr::null_mut());
    }
    }
#[no_mangle]
unsafe extern "C" fn midi_playback_open(stream: *mut snd_rawmidi_substream) -> c_int {
    static int midi_playback_open(struct snd_rawmidi_substream *stream)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn midi_playback_close(stream: *mut snd_rawmidi_substream) -> c_int {
...
unsafe extern "C" fn midi_playback_trigger(stream: *mut snd_rawmidi_substream, up: c_int) {
    ...
    WRITE_ONCE(scs.output, core::ptr::null_mut());
    }
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn register_address(oxfw: *mut snd_oxfw) -> c_int {
