...
//! Source: sound/firewire/oxfw/oxfw-stream.c
#![no_std]
...
pub const AVC_GENERIC_FRAME_MAXIMUM_BYTES: c_int = 512;
pub const READY_TIMEOUT_MS: c_int = 600;
//
...
#[no_mangle]
unsafe extern "C" fn set_rate(oxfw: *mut snd_oxfw, rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_stream(oxfw: *mut snd_oxfw, stream: *mut amdtp_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_stream(oxfw: *mut snd_oxfw, stream: *mut amdtp_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keep_resources(oxfw: *mut snd_oxfw, stream: *mut amdtp_stream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_start_duplex(oxfw: *mut snd_oxfw) -> c_int {
    ...
    let mut tx_init_skip_cycles: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_stop_duplex(oxfw: *mut snd_oxfw) {
...
#[no_mangle]
unsafe extern "C" fn destroy_stream(oxfw: *mut snd_oxfw, stream: *mut amdtp_stream) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_init_duplex(oxfw: *mut snd_oxfw) -> c_int {
...
// the streams.
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_destroy_duplex(oxfw: *mut snd_oxfw) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_update_duplex(oxfw: *mut snd_oxfw) {
...
// apply the format for each available sampling rate
    ...
    formats[eid] = devm_kmemdup(&oxfw.card.card_dev, buf, *len,
    GFP_KERNEL);
    if (formats[eid] == core::ptr::null_mut()) {
    err = -ENOMEM;
    goto end;
    }
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_discover(oxfw: *mut snd_oxfw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_lock_changed(oxfw: *mut snd_oxfw) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_lock_try(oxfw: *mut snd_oxfw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_stream_lock_release(oxfw: *mut snd_oxfw) {
