...
//! Source: sound/firewire/oxfw/oxfw-spkr.c
#![no_std]
...
// value = (buf[10] << 8) | buf[11];
    ...
    let mut equal_values: bool = true;
    s16 volume;
    int err;
    for (i = 0; i < spkr.mixer_channels; ++i) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_oxfw_add_spkr(oxfw: *mut snd_oxfw, is_lacie: bool) -> c_int {
