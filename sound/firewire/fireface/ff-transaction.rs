...
//! Source: sound/firewire/fireface/ff-transaction.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn transmit_midi_msg(ff: *mut snd_ff, port: c_uint) {
...
unsafe extern "C" fn transmit_midi1_msg(work: *mut work_struct) {
    ...
    __le32 *buf = data;
    let mut tstamp: u32 = fw_request_get_timestamp(request);
...
#[no_mangle]
unsafe extern "C" fn allocate_own_address(ff: *mut snd_ff, i: c_int) -> c_int {
...
pub unsafe extern "C" fn snd_ff_transaction_unregister(ff: *mut snd_ff) {
    ...
    {
    __le32 reg;
    if (ff.async_handler.callback_data == core::ptr::null_mut())
    return;
