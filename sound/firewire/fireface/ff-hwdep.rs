...
//! Source: sound/firewire/fireface/ff-hwdep.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn has_msg(ff: *mut snd_ff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hwdep_get_info(ff: *mut snd_ff, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_lock(ff: *mut snd_ff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_unlock(ff: *mut snd_ff) -> c_int {
