...
//! Source: sound/firewire/fireface/ff-protocol-latter.c
#![no_std]
...
pub const LATTER_STF: c_uint = 0xffff00000004ULL;
pub const LATTER_ISOC_CHANNELS: c_uint = 0xffff00000008ULL;
pub const LATTER_ISOC_START: c_uint = 0xffff0000000cULL;
pub const LATTER_FETCH_MODE: c_uint = 0xffff00000010ULL;
pub const LATTER_SYNC_STATUS: c_uint = 0x0000801c0000ULL;
...
// Set the number of data blocks transferred in a second.
    ...
    code = 0x04;
#[no_mangle]
pub unsafe extern "C" fn if(0: rate % 44100 ==) -> else {
    else if (rate % 44100 == 0)
    code = 0x02;
#[no_mangle]
pub unsafe extern "C" fn if(0: rate % 32000 ==) -> else {
    ...
    code |= 0x08;
#[no_mangle]
pub unsafe extern "C" fn if(128000: rate >=) -> else {
    else if (rate >= 128000)
    code |= 0x10;
...
// register for it.
    ...
    {
    let mut data: u32 = le32_to_cpu(*buf);
    let mut index: c_uint = (data & 0x000000f0) >> 4;
    u8 byte[3];
...
//
#[no_mangle]
pub unsafe extern "C" fn calculate_message_bytes(status: u8) -> c_int {
