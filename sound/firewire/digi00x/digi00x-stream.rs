...
//! Source: sound/firewire/digi00x/digi00x-stream.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn snd_dg00x_stream_get_local_rate(dg00x: *mut snd_dg00x, rate: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_dg00x_stream_set_local_rate(dg00x: *mut snd_dg00x, rate: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_dg00x_stream_check_external_clock(dg00x: *mut snd_dg00x, detect: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn finish_session(dg00x: *mut snd_dg00x) {
...
#[no_mangle]
unsafe extern "C" fn begin_session(dg00x: *mut snd_dg00x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_stream(dg00x: *mut snd_dg00x, s: *mut amdtp_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_stream(dg00x: *mut snd_dg00x, s: *mut amdtp_stream) {
...
pub unsafe extern "C" fn snd_dg00x_stream_start_duplex(dg00x: *mut snd_dg00x) -> c_int {
    ...
    {
    let mut generation: c_uint = dg00x.rx_resources.generation;
    let mut err: c_int = 0;
...
//
    ...
    let mut spd: c_int = fw_parent_device(dg00x.unit).max_speed;
