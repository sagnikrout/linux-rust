...
//! Source: sound/firewire/dice/dice-transaction.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_clock_info(dice: *mut snd_dice, info: *mut __be32) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn snd_dice_transaction_get_rate(dice: *mut snd_dice, rate: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_dice_transaction_set_enable(dice: *mut snd_dice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_notification_address(dice: *mut snd_dice, retry: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unregister_notification_address(dice: *mut snd_dice) {
...
pub unsafe extern "C" fn snd_dice_transaction_destroy(dice: *mut snd_dice) {
    ...
    if (handler.callback_data == core::ptr::null_mut())
    return;
...
#[no_mangle]
pub unsafe extern "C" fn snd_dice_transaction_reinit(dice: *mut snd_dice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_subaddrs(dice: *mut snd_dice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_dice_transaction_init(dice: *mut snd_dice) -> c_int {
