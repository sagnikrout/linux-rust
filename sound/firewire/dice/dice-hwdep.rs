...
//! Source: sound/firewire/dice/dice-hwdep.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hwdep_get_info(dice: *mut snd_dice, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_lock(dice: *mut snd_dice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_unlock(dice: *mut snd_dice) -> c_int {
