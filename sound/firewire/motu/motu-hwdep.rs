...
//! Source: sound/firewire/motu/motu-hwdep.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn has_dsp_event(motu: *mut snd_motu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hwdep_get_info(motu: *mut snd_motu, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_lock(motu: *mut snd_motu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_unlock(motu: *mut snd_motu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_motu_create_hwdep_device(motu: *mut snd_motu) -> c_int {
