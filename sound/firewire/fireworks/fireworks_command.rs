...
//! Source: sound/firewire/fireworks/fireworks_command.c
#![no_std]
...
// check transaction header fields
    ...
    let mut st: u32 = be32_to_cpu(header.status);
...
//
    ...
    addr, sizeof(addr), core::ptr::null_mut(), 0);
    }
//
...
//
    ...
    {
    let mut param: __be32 = cpu_to_be32(mode);
    return efw_transaction(efw, EFC_CAT_TRANSPORT,
    EFC_CMD_TRANSPORT_SET_TX_MODE,
    &param, sizeof(param), core::ptr::null_mut(), 0);
    }
    ...
    core::ptr::null_mut(), 0, (__be32 *)hwinfo, sizeof(*hwinfo));
    if (err < 0)
    goto end;
...
// ensure terminated
    ...
    core::ptr::null_mut(), 0, (__be32 *)meters, len);
    if (err >= 0)
...
#[no_mangle]
pub unsafe extern "C" fn snd_efw_command_get_sampling_rate(efw: *mut snd_efw, rate: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_efw_command_set_sampling_rate(efw: *mut snd_efw, rate: c_uint) -> c_int {
