...
//! Source: sound/firewire/fireworks/fireworks_pcm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn snd_efw_get_multiplier_mode(sampling_rate: c_uint, mode: *mut c_uint) -> c_int {
...
unsafe extern "C" fn pcm_capture_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
    ...
    amdtp_stream_pcm_trigger(&efw.tx_stream, core::ptr::null_mut());
    break;
    default:
    return -EINVAL;
    }
...
unsafe extern "C" fn pcm_playback_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
    ...
    break;
    case SNDRV_PCM_TRIGGER_STOP:
    amdtp_stream_pcm_trigger(&efw.rx_stream, core::ptr::null_mut());
    break;
    default:
    return -EINVAL;
    }
