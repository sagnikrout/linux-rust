...
//! Source: sound/firewire/fireworks/fireworks_stream.c
#![no_std]
...
pub const READY_TIMEOUT_MS: c_int = 1000;
#[no_mangle]
unsafe extern "C" fn init_stream(efw: *mut snd_efw, stream: *mut amdtp_stream) -> c_int {
...
// the streams.
#[no_mangle]
unsafe extern "C" fn destroy_stream(efw: *mut snd_efw, stream: *mut amdtp_stream) {
