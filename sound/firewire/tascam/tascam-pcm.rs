...
//! Source: sound/firewire/tascam/tascam-pcm.c
#![no_std]
...
unsafe extern "C" fn pcm_capture_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
    ...
    amdtp_stream_pcm_trigger(&tscm.tx_stream, core::ptr::null_mut());
    break;
    default:
    return -EINVAL;
    }
...
unsafe extern "C" fn pcm_playback_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
    ...
    break;
    case SNDRV_PCM_TRIGGER_STOP:
    amdtp_stream_pcm_trigger(&tscm.rx_stream, core::ptr::null_mut());
    break;
    default:
    return -EINVAL;
    }
...
#[no_mangle]
pub unsafe extern "C" fn snd_tscm_create_pcm_devices(tscm: *mut snd_tscm) -> c_int {
