...
//! Source: sound/firewire/tascam/tascam-transaction.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !rcode_is_permanent_error(rcode)) -> else {
...
// Under transacting or error state.
    ...
    return;
// Nothing to do.
    if (substream == core::ptr::null_mut() || snd_rawmidi_transmit_empty(substream))
    return;
...
#[no_mangle]
pub unsafe extern "C" fn snd_tscm_transaction_register(tscm: *mut snd_tscm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_tscm_transaction_reregister(tscm: *mut snd_tscm) -> c_int {
...
pub unsafe extern "C" fn snd_tscm_transaction_unregister(tscm: *mut snd_tscm) {
    ...
    {
    __be32 reg;
    if (tscm.async_handler.callback_data == core::ptr::null_mut())
    return;
