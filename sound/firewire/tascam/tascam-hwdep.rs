...
//! Source: sound/firewire/tascam/tascam-hwdep.c
#![no_std]
...
//
    ...
    {
    char __user *pos = buf;
    let mut type: c_uint = SNDRV_FIREWIRE_EVENT_TASCAM_CONTROL;
...
// Copy the type field later.
    ...
    break;
#[no_mangle]
pub unsafe extern "C" fn if(tscm->push_pos: tscm->pull_pos <) -> else {
...
#[no_mangle]
unsafe extern "C" fn hwdep_get_info(tscm: *mut snd_tscm, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_lock(tscm: *mut snd_tscm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwdep_unlock(tscm: *mut snd_tscm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tscm_hwdep_state(tscm: *mut snd_tscm, arg: *mut void __user) -> c_int {
