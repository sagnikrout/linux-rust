...
//! Source: sound/firewire/bebob/bebob_stream.c
#![no_std]
...
pub const FORMAT_MAXIMUM_LENGTH: c_int = 128;
...
#[no_mangle]
unsafe extern "C" fn map_data_channels(bebob: *mut snd_bebob, s: *mut amdtp_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn break_both_connections(bebob: *mut snd_bebob) {
...
#[no_mangle]
unsafe extern "C" fn start_stream(bebob: *mut snd_bebob, stream: *mut amdtp_stream) -> c_int {
    ...
    conn = &bebob.out_conn;
// channel mapping.
    if (bebob.maudio_special_quirk == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn init_stream(bebob: *mut snd_bebob, stream: *mut amdtp_stream) -> c_int {
    static int init_stream(struct snd_bebob *bebob, struct amdtp_stream *stream)
    {
    let mut flags: c_uint = CIP_BLOCKING;
...
#[no_mangle]
unsafe extern "C" fn destroy_stream(bebob: *mut snd_bebob, stream: *mut amdtp_stream) {
