...
//! Source: sound/firewire/bebob/bebob_maudio.c
#![no_std]
...
pub const INFO_OFFSET_SW_DATE: c_uint = 0x20;
// Bootloader Protocol Version 1
pub const MAUDIO_BOOTLOADER_CUE1: c_uint = 0x00000001;
//
...
//
pub const MAUDIO_BOOTLOADER_CUE2: c_uint = 0x01110000;
// padding
pub const MAUDIO_BOOTLOADER_CUE3: c_uint = 0x00000000;
pub const MAUDIO_SPECIFIC_ADDRESS: c_uint = 0xffc700000000ULL;
pub const METER_OFFSET: c_uint = 0x00600000;
// some device has sync info after metering data

pub const METER_SIZE_OZONIC: c_int = 48;
pub const METER_SIZE_NRV10: c_int = 80;
// labels for metering
...
pub struct special_params {
    pub is1814: bool,
    pub clk_src: c_uint,
    pub dig_in_fmt: c_uint,
    pub dig_out_fmt: c_uint,
    pub clk_lock: c_uint,
    pub ctl_id_sync: *mut snd_ctl_elem_id,
}
...
#[no_mangle]
unsafe extern "C" fn add_special_controls(bebob: *mut snd_bebob) -> c_int {
    static int add_special_controls(struct snd_bebob *bebob)
    {
