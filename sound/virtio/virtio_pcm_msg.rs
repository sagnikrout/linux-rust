...
//! Source: sound/virtio/virtio_pcm_msg.c
#![no_std]
...
pub struct virtio_pcm_msg {
    pub substream: *mut virtio_pcm_substream,
    pub xfer: virtio_snd_pcm_xfer,
    pub status: virtio_snd_pcm_status,
    pub length: usize,
    pub sgs: [scatterlist; ],
}
...
//
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_sg_num(data: *mut u8, length: c_uint) -> c_int {
    ...
    let mut pg_address: phys_addr_t = page_to_phys(pg);
    size_t pg_length;
...
//
    ...
    let mut sg_num: c_int = virtsnd_pcm_sg_num(data, period_bytes);
...
//
#[no_mangle]
pub unsafe extern "C" fn virtsnd_pcm_msg_free(vss: *mut virtio_pcm_substream) {
...
//
    ...
    let mut period_bytes: c_ulong = snd_pcm_lib_period_bytes(vss.substream);
    unsigned long start, end, i;
    let mut msg_count: c_uint = vss.msg_count;
...
//
#[no_mangle]
pub unsafe extern "C" fn virtsnd_pcm_msg_pending_num(vss: *mut virtio_pcm_substream) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtsnd_pcm_notify_cb(queue: *mut virtio_snd_queue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtsnd_pcm_tx_notify_cb(vqueue: *mut virtqueue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtsnd_pcm_rx_notify_cb(vqueue: *mut virtqueue) {
...
//
    ...
    {
    let mut request_size: usize = sizeof(struct virtio_snd_pcm_hdr);
