...
//! Source: sound/virtio/virtio_pcm_ops.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtsnd_a2v_format {
    pub alsa_bit: snd_pcm_format_t,
    pub vio_bit: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_open(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
...
//
    ...
    unsigned int i;
    let mut vformat: c_int = -1;
    let mut vrate: c_int = -1;
...
//
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_prepare(substream: *mut snd_pcm_substream) -> c_int {
    ...
    let mut buffer_bytes: c_uint = snd_pcm_lib_buffer_bytes(substream);
    let mut period_bytes: c_uint = snd_pcm_lib_period_bytes(substream);
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_trigger(substream: *mut snd_pcm_substream, command: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_sync_stop(substream: *mut snd_pcm_substream) -> c_int {
    static int virtsnd_pcm_sync_stop(struct snd_pcm_substream *substream)
    {
    struct virtio_pcm_substream *vss = snd_pcm_substream_chip(substream);
    struct virtio_snd *snd = vss.snd;
    struct virtio_snd_msg *msg;
    let mut js: c_uint = msecs_to_jiffies(virtsnd_msg_timeout_ms);
    int rc;
...
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_pb_ack(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtsnd_pcm_cp_ack(substream: *mut snd_pcm_substream) -> c_int {
