...
//! Source: sound/aoa/soundbus/i2sbus/pcm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clock_and_divisors(mclk: c_int, sclk: c_int, rate: c_int, out: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2sbus_pcm_close(i2sdev: *mut i2sbus_dev, in: c_int) -> c_int {
    ...
    guard(mutex)(&i2sdev.lock);
    get_pcm_info(i2sdev, in, &pi, core::ptr::null_mut());
    ...
    pi.substream = core::ptr::null_mut();
    pi.active = 0;
    return err;
    }
    ...
    spin_lock_irqsave(&i2sdev.low_lock, flags);
    pi.stop_completion = core::ptr::null_mut();
    if (time_left == 0) {
...
pub unsafe extern "C" fn i2sbus_wait_for_stop_both(i2sdev: *mut i2sbus_dev) {
    ...
    {
    struct pcm_info *pi;
    get_pcm_info(i2sdev, 0, &pi, core::ptr::null_mut());
    i2sbus_wait_for_stop(i2sdev, pi);
    get_pcm_info(i2sdev, 1, &pi, core::ptr::null_mut());
    i2sbus_wait_for_stop(i2sdev, pi);
    }

#[no_mangle]
unsafe extern "C" fn i2sbus_pcm_clear_active(i2sdev: *mut i2sbus_dev, in: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn i2sbus_hw_free(substream: *mut snd_pcm_substream, in: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2sbus_pcm_prepare(i2sdev: *mut i2sbus_dev, in: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2sbus_pcm_trigger(i2sdev: *mut i2sbus_dev, in: c_int, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2sbus_pcm_pointer(i2sdev: *mut i2sbus_dev, in: c_int) -> snd_pcm_uframes_t {
...
#[no_mangle]
pub unsafe extern "C" fn handle_interrupt(i2sdev: *mut i2sbus_dev, in: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn i2sbus_tx_intr(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn i2sbus_rx_intr(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn i2sbus_playback_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    if (!err)
    i2sdev.out.substream = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
...
unsafe extern "C" fn i2sbus_record_close(substream: *mut snd_pcm_substream) -> c_int {
    ...
    if (!err)
    i2sdev.in.substream = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
...
unsafe extern "C" fn i2sbus_private_free(pcm: *mut snd_pcm) {
    ...
    i2sdev.sound.pcm = core::ptr::null_mut();
...
pub unsafe extern "C" fn i2sbus_detach_codec(dev: *mut soundbus_dev, data: *mut c_void) {
    ...
    {
    struct codec_info_item *cii = core::ptr::null_mut(), *i;
