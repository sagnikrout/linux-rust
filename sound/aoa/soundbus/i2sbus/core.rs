...
//! Source: sound/aoa/soundbus/i2sbus/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn i2sbus_bus_intr(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
// Returns 1 if added, 0 for otherwise; don't return a negative value!
    ...
    struct device_node *child, *sound = core::ptr::null_mut();
    struct resource *r;
    ...
    if (i == 1) {
    const u32 *id = of_get_property(sound, "layout-id", core::ptr::null_mut());
    if (id) {
    layout = *id;
...
#[no_mangle]
unsafe extern "C" fn i2sbus_probe(dev: *mut *mut macio_dev, match: *const of_device_id) -> c_int {
    static int i2sbus_probe(struct macio_dev* dev, const struct of_device_id *match)
    {
    struct device_node *np;
    let mut got: c_int = 0, err;
    struct i2sbus_control *control = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn i2sbus_remove(dev: *mut macio_dev) {
...
#[no_mangle]
unsafe extern "C" fn i2sbus_suspend(dev: *mut *mut macio_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2sbus_resume(dev: *mut *mut macio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2sbus_shutdown(dev: *mut *mut macio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soundbus_i2sbus_init() -> int __init {
    static int __init soundbus_i2sbus_init(void)
    {
    return macio_register_driver(&i2sbus_drv);
    }
#[no_mangle]
unsafe extern "C" fn soundbus_i2sbus_exit() -> void __exit {
