...
//! Source: sound/usb/usx2y/us144mkii_playback.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn tascam_playback_open(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tascam_playback_close(substream: *mut snd_pcm_substream) -> c_int {
    static int tascam_playback_close(struct snd_pcm_substream *substream)
    {
    struct tascam_card *tascam = snd_pcm_substream_chip(substream);
    tascam.playback_substream = core::ptr::null_mut();
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn tascam_playback_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
pub unsafe extern "C" fn feedback_urb_complete(urb: *mut urb) {
    ...
    capture_rt = capture_ss ? capture_ss.runtime : core::ptr::null_mut();
    scoped_guard(spinlock_irqsave, &tascam.lock) {
...
// ((u8 *)urb->transfer_buffer +
    ...
    if (!tascam.feedback_synced) {
    let mut out_idx: c_uint = tascam.feedback_pattern_out_idx;
...
#[no_mangle]
pub unsafe extern "C" fn tascam_stop_pcm_work_handler(work: *mut work_struct) {
