...
//! Source: sound/usb/usx2y/usbusx2yaudio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn usx2y_urb_capt_retire(subs: *mut snd_usx2y_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usx2y_urb_play_retire(subs: *mut snd_usx2y_substream, urb: *mut urb) {
    static void usx2y_urb_play_retire(struct snd_usx2y_substream *subs, struct urb *urb)
    {
    struct snd_pcm_runtime *runtime = subs.pcm_substream.runtime;
    let mut len: c_int = urb.actual_length / subs.usx2y.stride;
...
#[no_mangle]
unsafe extern "C" fn usx2y_urb_submit(subs: *mut snd_usx2y_substream, urb: *mut urb, frame: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(STATE_PRERUNNING: state >=) -> else {
    ...
    playbacksubs.completed_urb = core::ptr::null_mut();
    ...
    capsubs.completed_urb = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn usx2y_clients_stop(usx2y: *mut usx2ydev) {
    ...
    usx2y.prepare_subs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn i_usx2y_urb_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usx2y_subs_startup_finish(usx2y: *mut usx2ydev) {
...
#[no_mangle]
unsafe extern "C" fn i_usx2y_subs_startup(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usx2y_subs_prepare(subs: *mut snd_usx2y_substream) {
...
#[no_mangle]
unsafe extern "C" fn usx2y_urb_release(urb: *mut urb, free_tb: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn usx2y_urbs_release(subs: *mut snd_usx2y_substream) {
    ...
    kfree(subs.tmpbuf);
    subs.tmpbuf = core::ptr::null_mut();
    }
//
// initialize a substream's urbs
//
#[no_mangle]
unsafe extern "C" fn usx2y_urbs_allocate(subs: *mut snd_usx2y_substream) -> c_int {
    static int usx2y_urbs_allocate(struct snd_usx2y_substream *subs)
    {
    int i;
    unsigned int pipe;
    let mut is_playback: c_int = subs == subs.usx2y.subs[SNDRV_PCM_STREAM_PLAYBACK];
...
#[no_mangle]
unsafe extern "C" fn usx2y_subs_startup(subs: *mut snd_usx2y_substream) {
...
#[no_mangle]
unsafe extern "C" fn usx2y_urbs_start(subs: *mut snd_usx2y_substream) -> c_int {
    ...
    if (err < 0)
    return err;
    subs.completed_urb = core::ptr::null_mut();
    for (i = 0; i < 4; i++) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_usx2y_pcm_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
//
#[no_mangle]
unsafe extern "C" fn snd_usx2y_pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i_usx2y_04int(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usx2y_rate_set(usx2y: *mut usx2ydev, rate: c_int) -> c_int {
    static int usx2y_rate_set(struct usx2ydev *usx2y, int rate)
    {
    let mut err: c_int = 0, i;
    struct snd_usx2y_urb_seq *us = core::ptr::null_mut();
    int *usbdata = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn usx2y_format_set(usx2y: *mut usx2ydev, format: snd_pcm_format_t) -> c_int {
    ...
    let mut format: snd_pcm_format_t = params_format(hw_params);
...
//
#[no_mangle]
unsafe extern "C" fn snd_usx2y_pcm_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_usx2y_pcm_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_usx2y_pcm_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_usx2y_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_usx2y_pcm_close(struct snd_pcm_substream *substream)
    {
    struct snd_pcm_runtime *runtime = substream.runtime;
    struct snd_usx2y_substream *subs = runtime.private_data;
    subs.pcm_substream = core::ptr::null_mut();
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn usx2y_audio_stream_free(usx2y_substream: *mut snd_usx2y_substream) {
    static void usx2y_audio_stream_free(struct snd_usx2y_substream **usx2y_substream)
    {
    int stream;
    for_each_pcm_streams(stream) {
    kfree(usx2y_substream[stream]);
    usx2y_substream[stream] = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn snd_usx2y_pcm_private_free(pcm: *mut snd_pcm) {
...
#[no_mangle]
unsafe extern "C" fn usx2y_audio_stream_new(card: *mut snd_card, playback_endpoint: c_int, capture_endpoint: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usx2y_audio_create(card: *mut snd_card) -> c_int {
