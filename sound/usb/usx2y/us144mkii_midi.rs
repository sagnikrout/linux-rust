...
//! Source: sound/usb/usx2y/us144mkii_midi.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn tascam_midi_in_work_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tascam_midi_in_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tascam_midi_in_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tascam_midi_out_work_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tascam_midi_out_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tascam_midi_out_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tascam_create_midi(tascam: *mut tascam_card) -> c_int {
