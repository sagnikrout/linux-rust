...
//! Source: sound/usb/bcd2000/bcd2000.c
#![no_std]
...
pub struct bcd2000 {
    ...
    pub midi_in_buf: [c_uchar; BUFSIZE],
    pub midi_out_buf: [c_uchar; BUFSIZE],
...
#[no_mangle]
unsafe extern "C" fn bcd2000_dump_buffer(prefix: *const c_char, buf: *const c_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bcd2000_midi_input_open(substream: *mut snd_rawmidi_substream) -> c_int {
    static int bcd2000_midi_input_open(struct snd_rawmidi_substream *substream)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bcd2000_midi_input_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
// (de)register midi substream from client
    ...
    bcd2k.midi_receive_substream = up ? substream : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn bcd2000_midi_send(bcd2k: *mut bcd2000) {
...
#[no_mangle]
unsafe extern "C" fn bcd2000_midi_output_open(substream: *mut snd_rawmidi_substream) -> c_int {
    static int bcd2000_midi_output_open(struct snd_rawmidi_substream *substream)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bcd2000_midi_output_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcd2000_init_device(bcd2k: *mut bcd2000) {
...
#[no_mangle]
unsafe extern "C" fn bcd2000_init_midi(bcd2k: *mut bcd2000) -> c_int {
