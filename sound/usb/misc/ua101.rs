...
//
pub const MIN_QUEUE_LENGTH: c_int = 12;
// Somewhat random.
pub const MAX_QUEUE_LENGTH: c_int = 30;
//
// This magic value optimizes memory usage efficiency for the UA-101's packet
// sizes at all sample rates, taking into account the stupid cache pool sizes
// that usb_alloc_coherent() uses.
//
pub const DEFAULT_QUEUE_LENGTH: c_int = 21;

    PAGE_SIZE / MAX_PACKET_SIZE)
    static int index[SNDRV_CARDS] = SNDRV_DEFAULT_IDX;
    static char *id[SNDRV_CARDS] = SNDRV_DEFAULT_STR;
    static bool enable[SNDRV_CARDS] = SNDRV_DEFAULT_ENABLE_PNP;
    let mut queue_length: static unsigned int = 21;
...
pub struct ua101 {
    ...
    pub intf: [*mut usb_interface; INTF_COUNT],
    pub card_index: c_int,
    pub pcm: *mut snd_pcm,
    pub midi_list: list_head,
    pub format_bit: u64,
    pub rate: c_uint,
    pub packets_per_second: c_uint,
    pub lock: spinlock_t,
    pub mutex: mutex,
    pub states: c_ulong,
// FIFO to synchronize playback rate to capture rate
    pub rate_feedback_start: c_uint,
    pub rate_feedback_count: c_uint,
    pub rate_feedback: [u8; MAX_QUEUE_LENGTH],
    pub ready_playback_urbs: list_head,
    pub playback_work: work_struct,
    pub alsa_capture_wait: wait_queue_head_t,
    pub rate_feedback_wait: wait_queue_head_t,
    pub alsa_playback_wait: wait_queue_head_t,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ua101_stream {
    pub substream: *mut snd_pcm_substream,
    pub usb_pipe: c_uint,
    pub channels: c_uint,
    pub frame_bytes: c_uint,
    pub max_packet_bytes: c_uint,
    pub period_pos: c_uint,
    pub buffer_pos: c_uint,
    pub queue_length: c_uint,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ua101_urb {
    pub urb: urb,
    pub iso_frame_desc: [usb_iso_packet_descriptor; 1],
    pub ready_list: list_head,
    pub urbs: [*mut }; MAX_QUEUE_LENGTH],
    struct {
    pub size: c_uint,
    pub addr: *mut c_void,
    pub dma: dma_addr_t,
    pub buffers: [}; MAX_MEMORY_BUFFERS],
    pub playback: } capture,,
}
...
#[no_mangle]
unsafe extern "C" fn abort_usb_capture(ua: *mut ua101) {
...
#[no_mangle]
unsafe extern "C" fn abort_usb_playback(ua: *mut ua101) {
...
#[no_mangle]
unsafe extern "C" fn playback_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn submit_stream_urbs(ua: *mut ua101, stream: *mut ua101_stream) -> c_int {
    static int submit_stream_urbs(struct ua101 *ua, struct ua101_stream *stream)
    {
    unsigned int i;
    for (i = 0; i < stream.queue_length; ++i) {
    let mut err: c_int = usb_submit_urb(&stream.urbs[i].urb, GFP_KERNEL);
    if (err < 0) {
    dev_err(&ua.dev.dev, "USB request error %d: %s\n",
    err, usb_error_string(err));
    return err;
...
#[no_mangle]
unsafe extern "C" fn kill_stream_urbs(stream: *mut ua101_stream) {
...
#[no_mangle]
unsafe extern "C" fn enable_iso_interface(ua: *mut ua101, intf_index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disable_iso_interface(ua: *mut ua101, intf_index: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn stop_usb_capture(ua: *mut ua101) {
...
#[no_mangle]
unsafe extern "C" fn start_usb_capture(ua: *mut ua101) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_usb_playback(ua: *mut ua101) {
...
#[no_mangle]
unsafe extern "C" fn start_usb_playback(ua: *mut ua101) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abort_alsa_capture(ua: *mut ua101) {
    static void abort_alsa_capture(struct ua101 *ua)
    {
...
#[no_mangle]
unsafe extern "C" fn abort_alsa_playback(ua: *mut ua101) {
    static void abort_alsa_playback(struct ua101 *ua)
    {
    if (test_bit(ALSA_PLAYBACK_RUNNING, &ua.states))
...
#[no_mangle]
unsafe extern "C" fn capture_pcm_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn playback_pcm_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn capture_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn playback_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn capture_pcm_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn playback_pcm_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn capture_pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn playback_pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn capture_pcm_pointer(subs: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn playback_pcm_pointer(subs: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn detect_usb_format(ua: *mut ua101) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_stream_buffers(ua: *mut ua101, stream: *mut ua101_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_stream_buffers(ua: *mut ua101, stream: *mut ua101_stream) {
    ...
    {
    let mut max_packet_size: unsigned = stream.max_packet_bytes;
    struct ua101_urb *urb;
    unsigned int b, u = 0;
    for (b = 0; b < ARRAY_SIZE(stream.buffers); ++b) {
    let mut size: c_uint = stream.buffers[b].size;
    u8 *addr = stream.buffers[b].addr;
    let mut dma: dma_addr_t = stream.buffers[b].dma;
...
#[no_mangle]
unsafe extern "C" fn free_stream_urbs(stream: *mut ua101_stream) {
    static void free_stream_urbs(struct ua101_stream *stream)
    {
    unsigned int i;
    for (i = 0; i < stream.queue_length; ++i) {
    kfree(stream.urbs[i]);
    stream.urbs[i] = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn ua101_card_free(card: *mut snd_card) {
...
#[no_mangle]
unsafe extern "C" fn ua101_disconnect(interface: *mut usb_interface) {
