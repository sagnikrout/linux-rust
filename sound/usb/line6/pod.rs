...
//
pub const POD_NAME_OFFSET: c_int = 0;
pub const POD_NAME_LENGTH: c_int = 16;
//
    Other constants
//
pub const POD_CONTROL_SIZE: c_uint = 0x80;
pub const POD_BUFSIZE_DUMPREQ: c_int = 7;
pub const POD_STARTUP_DELAY: c_int = 1000;
//
...
pub const POD_SYSEX_CODE: c_int = 3;
// *INDENT-OFF*
    enum {
    POD_SYSEX_SAVE      = 0x24,
...
//
#[no_mangle]
unsafe extern "C" fn line6_pod_process_message(line6: *mut usb_line6) {
...
//
#[no_mangle]
unsafe extern "C" fn pod_startup(line6: *mut usb_line6) {
