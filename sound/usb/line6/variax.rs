...
//! Source: sound/usb/line6/variax.c
#![no_std]
...
pub const VARIAX_STARTUP_DELAY1: c_int = 1000;
pub const VARIAX_STARTUP_DELAY3: c_int = 100;
pub const VARIAX_STARTUP_DELAY4: c_int = 100;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usb_line6_variax {
// Generic Line 6 USB data
    pub line6: usb_line6,
// Buffer for activation code
    pub buffer_activate: *mut c_uchar,
// Current progress in startup procedure
    pub startup_progress: c_int,
}

pub const VARIAX_OFFSET_ACTIVATE: c_int = 7;
//
...
#[no_mangle]
unsafe extern "C" fn variax_activate_async(variax: *mut usb_line6_variax, a: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn variax_startup(line6: *mut usb_line6) {
...
//
#[no_mangle]
unsafe extern "C" fn line6_variax_process_message(line6: *mut usb_line6) {
...
//
#[no_mangle]
unsafe extern "C" fn line6_variax_disconnect(line6: *mut usb_line6) {
...
// initialize USB buffers:
    ...
    if (variax.buffer_activate == core::ptr::null_mut())
    return -ENOMEM;
