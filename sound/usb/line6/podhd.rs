...
//! Source: sound/usb/line6/podhd.c
#![no_std]
...
pub const PODHD_STARTUP_DELAY: c_int = 500;
    enum {
    LINE6_PODHD300,
    LINE6_PODHD400,
    LINE6_PODHD500,
...
//
#[no_mangle]
unsafe extern "C" fn podhd_dev_start(pod: *mut usb_line6_podhd) -> c_int {
    ...
    0x11, 0,
    core::ptr::null_mut(), 0, LINE6_TIMEOUT, GFP_KERNEL);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn podhd_set_monitor_level(podhd: *mut usb_line6_podhd, value: c_int) {
...
// claim the data interface
    ...
    err = usb_driver_claim_interface(&podhd_driver, intf, core::ptr::null_mut());
    if (err != 0) {
