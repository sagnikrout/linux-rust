...
//! Source: sound/usb/qcom/qc_audio_offload.c
#![no_std]
...
pub const MAX_BINTERVAL_ISOC_EP: c_int = 16;
pub const QMI_STREAM_REQ_CARD_NUM_MASK: c_uint = 0xffff0000;
pub const QMI_STREAM_REQ_DEV_NUM_MASK: c_uint = 0xff00;
pub const QMI_STREAM_REQ_DIRECTION: c_uint = 0xff;
// iommu resource parameters and management

    (((u64)sid) << 32)))

pub const IOVA_BASE: c_uint = 0x1000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iova_info {
    pub list: list_head,
    pub start_iova: c_ulong,
    pub size: usize,
    pub in_use: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intf_info {
// IOMMU ring/buffer mapping information
    pub data_xfer_ring_va: c_ulong,
    pub data_xfer_ring_size: usize,
    pub sync_xfer_ring_va: c_ulong,
    pub sync_xfer_ring_size: usize,
    pub xfer_buf_iova: dma_addr_t,
    pub xfer_buf_size: usize,
    pub xfer_buf_dma: dma_addr_t,
    pub xfer_buf_cpu: *mut u8,
// USB endpoint information
    pub data_ep_pipe: c_uint,
    pub sync_ep_pipe: c_uint,
    pub data_ep_idx: c_uint,
    pub sync_ep_idx: c_uint,
    pub intf_num: u8,
    pub pcm_card_num: u8,
    pub pcm_dev_num: u8,
    pub direction: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uaudio_qmi_dev {
    pub dev: *mut device,
    pub data: *mut q6usb_offload,
    pub auxdev: *mut auxiliary_device,
// list to keep track of available iova
    pub xfer_ring_list: list_head,
    pub xfer_ring_iova_size: usize,
    pub curr_xfer_ring_iova: c_ulong,
    pub xfer_buf_list: list_head,
    pub xfer_buf_iova_size: usize,
    pub curr_xfer_buf_iova: c_ulong,
// bit fields representing pcm card enabled
    pub card_slot: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uaudio_dev {
    pub udev: *mut usb_device,
// audio control interface
    pub ctrl_intf: *mut usb_host_interface,
    pub usb_core_id: c_uint,
    pub in_use: core::sync::atomic::AtomicI32,
    pub kref: kref,
    pub disconnect_wq: wait_queue_head_t,
// interface specific
    pub num_intf: c_int,
    pub info: *mut intf_info,
    pub chip: *mut snd_usb_audio,
// xhci sideband
    pub sb: *mut xhci_sideband,
// SoC USB device
    pub sdev: *mut snd_soc_usb_device,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uaudio_qmi_svc {
    pub uaudio_svc_hdl: *mut qmi_handle,
    pub client_sq: sockaddr_qrtr,
...
#[no_mangle]
unsafe extern "C" fn usb_qmi_get_pcm_num(chip: *mut snd_usb_audio, direction: c_int) -> c_int {
    static int usb_qmi_get_pcm_num(struct snd_usb_audio *chip, int direction)
    {
    struct snd_usb_substream *subs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn info_idx_from_ifnum(card_num: c_int, intf_num: c_int, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn map_pcm_format(fmt_received: enum usb_qmi_audio_format) -> snd_pcm_format_t {
...
// snd_pcm_format_t value due to the  attribute; so
...
//
#[no_mangle]
unsafe extern "C" fn uaudio_send_disconnect_ind(chip: *mut snd_usb_audio) -> c_int {
    static int uaudio_send_disconnect_ind(struct snd_usb_audio *chip)
    {
    let mut disconnect_ind: qmi_uaudio_stream_ind_msg_v01 = {0};
...
// Offloading IOMMU management
    ...
    {
    struct iova_info *info, *new_info = core::ptr::null_mut();
    struct list_head *curr_head;
    let mut tmp_size: usize = size;
    let mut iova: c_ulong = 0;
    if (size % PAGE_SIZE)
    goto done;
...
#[no_mangle]
unsafe extern "C" fn uaudio_iommu_map_prot(dma_coherent: bool) -> c_int {
...
//
    ...
    {
    let mut iova: c_ulong = 0;
    let mut map: bool = true;
    let mut prot: c_int = uaudio_iommu_map_prot(dma_coherent);
    int ret;
    switch (mtype) {
    case MEM_EVENT_RING:
    iova = IOVA_BASE;
...
#[no_mangle]
unsafe extern "C" fn usb_get_controller_id(udev: *mut usb_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uaudio_dev_intf_cleanup(udev: *mut usb_device, info: *mut intf_info) {
    ...
    info.xfer_buf_cpu = core::ptr::null_mut();
    info.xfer_buf_dma = 0;
    info.in_use = false;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn uaudio_event_ring_cleanup_free(dev: *mut uaudio_dev) {
...
#[no_mangle]
unsafe extern "C" fn uaudio_dev_cleanup(dev: *mut uaudio_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn disable_audio_stream(subs: *mut snd_usb_substream) {
...
#[no_mangle]
unsafe extern "C" fn qmi_stop_session() {
...
//
#[no_mangle]
unsafe extern "C" fn qmi_bye_cb(handle: *mut qmi_handle, node: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn uaudio_dev_release(kref: *mut kref) {
...
//
    ...
    as = snd_usb_find_csint_desc(alts.extra, alts.extralen, core::ptr::null_mut(),
    UAC_AS_GENERAL);
    if (!as) {
    dev_err(&subs.dev.dev,
    ...
    resp.usb_audio_spec_revision = le16_to_cpu(( __le16)0x0100);
    resp.usb_audio_spec_revision_valid = 1;
    } else if (protocol == UAC_VERSION_2) {
    resp.usb_audio_subslot_size = subs.cur_audiofmt.fmt_sz;
    resp.usb_audio_subslot_size_valid = 1;
    resp.usb_audio_spec_revision = le16_to_cpu(( __le16)0x0200);
    resp.usb_audio_spec_revision_valid = 1;
...
//
    ...
    {
    struct qmi_uaudio_stream_req_msg_v01 *req_msg;
    let mut resp: qmi_uaudio_stream_resp_msg_v01 = {{0}, 0};
    struct uaudio_qmi_svc *svc = uaudio_svc;
    struct snd_usb_audio *chip = core::ptr::null_mut();
    struct snd_usb_substream *subs;
    struct usb_host_endpoint *ep;
    let mut datainterval: c_int = -EINVAL;
    let mut info_idx: c_int = -EINVAL;
    struct intf_info *info;
    u8 pcm_card_num;
    u8 pcm_dev_num;
    u8 direction;
...
//
#[no_mangle]
unsafe extern "C" fn qc_usb_audio_offload_init_qmi_dev() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qc_usb_audio_offload_probe(chip: *mut snd_usb_audio) {
...
//
    ...
    uadev[chip.card.number].sb = core::ptr::null_mut();
    free_sdev:
    kfree(sdev);
    uadev[chip.card.number].sdev = core::ptr::null_mut();
    uadev[chip.card.number].chip = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn qc_usb_audio_cleanup_qmi_dev() {
    static void qc_usb_audio_cleanup_qmi_dev(void)
    {
    kfree(uaudio_qdev);
    uaudio_qdev = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn qc_usb_audio_offload_disconnect(chip: *mut snd_usb_audio) {
...
#[no_mangle]
unsafe extern "C" fn qc_usb_audio_remove(auxdev: *mut auxiliary_device) {
