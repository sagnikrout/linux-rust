...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usb_desc_validator {
    pub protocol: c_uchar,
    pub type: c_uchar,
    pub v): *const *const *const bool (func)(void p, struct usb_desc_validator,
    pub size: usize,
}
...
#[no_mangle]
pub unsafe extern "C" fn snd_usb_validate_audio_desc(p: *mut c_void, protocol: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn snd_usb_validate_midi_desc(p: *mut c_void) -> bool {
