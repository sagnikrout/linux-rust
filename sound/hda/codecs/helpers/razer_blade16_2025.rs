...
//! Source: sound/hda/codecs/helpers/razer_blade16_2025.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alc298_razer_blade16_2025_op {
    pub /: *mut *mut u16 bank; / mailbox bank (port 0x89); unused for a plain coef,
    pub /: *mut *mut u16 addr; / mailbox register, or plain coef index,
    pub /: *mut *mut u16 hi; / mailbox high word; unused for a plain coef,
    pub /: *mut *mut u16 lo; / mailbox low word, or plain coef value,
    pub /: *mut *mut u16 strobe; / mailbox commit opcode; 0 marks a plain coef write,
}
