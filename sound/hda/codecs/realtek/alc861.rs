...
//! Source: sound/hda/codecs/realtek/alc861.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn alc861_parse_auto_config(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn alc861_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
    ...
    alc_pre_init(codec);
    snd_hda_pick_fixup(codec, core::ptr::null_mut(), alc861_fixup_tbl, alc861_fixups);
