...
//! Source: sound/hda/codecs/realtek/alc662.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn alc662_parse_auto_config(codec: *mut hda_codec) -> c_int {
...
//
    alc662_aspire_ethos_mute_speakers(codec, core::ptr::null_mut());
    break;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn alc668_restore_default_value(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn alc662_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
