...
//! Source: sound/hda/codecs/realtek/alc268.c
#![no_std]
...
unsafe extern "C" fn alc268_parse_auto_config(codec: *mut hda_codec) -> c_int {
    ...
    return alc_parse_auto_config(codec, core::ptr::null_mut(), alc268_ssids);
    }
//
#[no_mangle]
unsafe extern "C" fn alc268_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
