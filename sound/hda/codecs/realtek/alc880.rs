...
//! Source: sound/hda/codecs/realtek/alc880.c
#![no_std]
...
//
    ...
    SND_PCI_QUIRK(0x1039, 0x1234, core::ptr::null_mut(), ALC880_FIXUP_6ST_DIG),
    ...
    SND_PCI_QUIRK(0x2668, 0x8086, core::ptr::null_mut(), ALC880_FIXUP_6ST_DIG), /* broken BIOS */
    SND_PCI_QUIRK(0x8086, 0x2668, core::ptr::null_mut(), ALC880_FIXUP_6ST_DIG),
...
// default Intel
    ...
    SND_PCI_QUIRK(0xe803, 0x1019, core::ptr::null_mut(), ALC880_FIXUP_6ST_DIG),
    {}
    };
...
//
#[no_mangle]
unsafe extern "C" fn alc880_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
