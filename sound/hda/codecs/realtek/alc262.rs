...
//! Source: sound/hda/codecs/realtek/alc262.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn alc262_parse_auto_config(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn alc262_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
