...
//! Source: sound/hda/codecs/realtek/alc882.c
#![no_std]
...
// Set VREF on HP pin
    ...
    let mut val: c_uint = snd_hda_codec_get_pincfg(codec, nids[i]);
...
//
#[no_mangle]
unsafe extern "C" fn alc882_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
