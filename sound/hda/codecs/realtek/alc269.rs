...
//! Source: sound/hda/codecs/realtek/alc269.c
#![no_std]
...
// Macro flag: #define HALT_REALTEK_ALC5505
...
//
#[no_mangle]
unsafe extern "C" fn alc269_parse_auto_config(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alc_disable_headset_jack_key(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc_enable_headset_jack_key(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc269vb_toggle_power_output(codec: *mut hda_codec, power_up: c_int) {
    static void alc269vb_toggle_power_output(struct hda_codec *codec, int power_up)
    {
    alc_update_coef_idx(codec, 0x04, 1 << 11, power_up ? (1 << 11) : 0);
    }
#[no_mangle]
unsafe extern "C" fn alc269_shutup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc282_restore_default_value(codec: *mut hda_codec) {
    static void alc282_restore_default_value(struct hda_codec *codec)
    {
    alc_process_coef_fw(codec, alc282_coefs);
    }
#[no_mangle]
unsafe extern "C" fn alc282_init(codec: *mut hda_codec) {
    static void alc282_init(struct hda_codec *codec)
    {
    struct alc_spec *spec = codec.spec;
    let mut hp_pin: hda_nid_t = alc_get_hp_pin(spec);
    bool hp_pin_sense;
    int coef78;
...
#[no_mangle]
unsafe extern "C" fn alc282_shutup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc283_restore_default_value(codec: *mut hda_codec) {
    static void alc283_restore_default_value(struct hda_codec *codec)
    {
    alc_process_coef_fw(codec, alc283_coefs);
    }
#[no_mangle]
unsafe extern "C" fn alc283_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc283_shutup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc256_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc256_shutup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc285_hp_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc225_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc225_shutup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc222_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc222_shutup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc_default_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc_default_shutup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc294_hp_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc294_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc5505_coef_get(codec: *mut hda_codec, index_reg: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alc5505_dsp_halt(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc5505_dsp_back_from_halt(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc5505_dsp_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc269_suspend(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alc269_resume(codec: *mut hda_codec) -> c_int {
...
pub const ALC233_STARFIGHTER_SPK_PIN: c_uint = 0x1b;
pub const ALC233_STARFIGHTER_GPIO2: c_uint = 0x04;
#[no_mangle]
unsafe extern "C" fn alc233_starfighter_update_amp(codec: *mut hda_codec, on: bool) {
    ...
    int action)
    {
    let mut cfg_headphone: c_uint = snd_hda_codec_get_pincfg(codec, 0x21);
    let mut cfg_headset_mic: c_uint = snd_hda_codec_get_pincfg(codec, 0x19);
...
#[no_mangle]
unsafe extern "C" fn alc269_quanta_automute(codec: *mut hda_codec) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hda_alc298_mbxinit {
    pub value_0x23: c_uchar,
    pub value_0x25: c_uchar,
}
...
//
    ...
    {
    struct hda_codec *codec = dev_to_hda_codec(led_cdev.dev.parent);
    let mut val: c_uint = (brightness == LED_OFF) ? PIN_IN : PIN_VREF100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alc298_samsung_amp_desc {
    pub nid: c_uchar,
    pub init_seq: [c_ushort; 2][2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alc298_samsung_v2_amp_desc {
    pub nid: c_ushort,
    pub init_seq_size: c_int,
    pub init_seq: [c_ushort; 18][2],
}
...
#[no_mangle]
unsafe extern "C" fn alc298_samsung_v2_enable_amps(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc298_samsung_v2_disable_amps(codec: *mut hda_codec) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alc298_lg_gram_style_seq {
    pub verb: c_ushort,
    pub idx: c_ushort,
    pub val: c_ushort,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alc298_lg_gram_style_amp_desc {
    pub nid: c_uchar,
    pub init_seq: *const alc298_lg_gram_style_seq,
    pub init_seq_size: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn alc298_lg_gram_style_enable_amps(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc298_lg_gram_style_disable_amps(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc298_lg_gram_style_init_amps(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc_register_micmute_input_device(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alc255_set_default_jack_type(codec: *mut hda_codec) {
...
//
    ...
    struct alc_spec *spec = codec.spec;
    if (action == HDA_FIXUP_ACT_PROBE) {
    let mut mic_pin: c_int = alc_find_ext_mic_pin(codec);
    let mut hp_pin: c_int = alc_get_hp_pin(spec);
...
// The mic boosts on level 2 and 3 are too noisy
    ...
    let mut nid: hda_nid_t = cfg.inputs[i].pin;
    unsigned int defcfg;
...
#[no_mangle]
unsafe extern "C" fn asus_tx300_automute(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc_combo_jack_hp_jd_restart(codec: *mut hda_codec) {
...
//
    alc294_gx502_toggle_output(codec, core::ptr::null_mut());
    break;
    }
    }
...
//
    ...
    break;
    case HDA_FIXUP_ACT_INIT:
    alc294_gu502_toggle_output(codec, core::ptr::null_mut());
    break;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn comp_acpi_device_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn comp_bind(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comp_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn find_cirrus_companion_amps(cdc: *mut hda_codec) {
    static void find_cirrus_companion_amps(struct hda_codec *cdc)
    {
    struct device *dev = hda_codec_dev(cdc);
    struct acpi_device *adev;
    const char *bus = core::ptr::null_mut();
    static const struct {
    const char *hid;
    const char *name;
    ...
    adev = acpi_dev_get_first_match_dev(acpi_ids[i].hid, core::ptr::null_mut(), -1);
    if (adev)
    break;
    }
    if (!adev) {
...
#[no_mangle]
unsafe extern "C" fn aw88399_fixup_i2c_two(cdc: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cs35l41_fixup_i2c_two(cdc: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
    static void cs35l41_fixup_i2c_two(struct hda_codec *cdc, const struct hda_fixup *fix, int action)
    {
    comp_generic_fixup(cdc, action, "i2c", "CSC3551", "-%s:00-cs35l41-hda.%d", 2);
    }
#[no_mangle]
unsafe extern "C" fn cs35l41_fixup_i2c_four(cdc: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
    static void cs35l41_fixup_i2c_four(struct hda_codec *cdc, const struct hda_fixup *fix, int action)
    {
    comp_generic_fixup(cdc, action, "i2c", "CSC3551", "-%s:00-cs35l41-hda.%d", 4);
    }
#[no_mangle]
unsafe extern "C" fn cs35l41_fixup_spi_two(codec: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
    static void cs35l41_fixup_spi_two(struct hda_codec *codec, const struct hda_fixup *fix, int action)
    {
    comp_generic_fixup(codec, action, "spi", "CSC3551", "-%s:00-cs35l41-hda.%d", 2);
    }
#[no_mangle]
unsafe extern "C" fn cs35l41_fixup_spi_one(codec: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cs35l41_fixup_spi_four(codec: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
...
#[no_mangle]
unsafe extern "C" fn alc285_fixup_asus_ga403u(cdc: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tas2781_fixup_spi(cdc: *mut hda_codec, fix: *const hda_fixup, action: c_int) {
...
#[no_mangle]
unsafe extern "C" fn alc287_s4_power_gpio3_default(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc245_hp_spk_mute_led_update(private_data: *mut c_void, enabled: c_int) {
...
#[no_mangle]
unsafe extern "C" fn alc245_hp_spk_mute_led_update_inverted(private_data: *mut c_void, enabled: c_int) {
...
#[no_mangle]
unsafe extern "C" fn alc269_fill_coef(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn alc269_remove(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn alc269_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
...
//
    ...
    snd_hda_pick_fixup(codec, core::ptr::null_mut(),	alc269_fixup_vendor_tbl,
    alc269_fixups);
//
