...
//! Source: sound/hda/codecs/analog.c
#![no_std]
...
pub struct ad198x_spec {
    ...
    pub model: c_int,
// for auto parser
    pub smux_paths: [c_int; 4],
    pub cur_smux: c_uint,
    pub eapd_nid: hda_nid_t,
    pub /: *mut *mut unsigned int beep_amp; / beep amp value, set via set_beep_amp(),
    pub num_smux_conns: c_int,
...
#[no_mangle]
unsafe extern "C" fn create_beep_ctls(codec: *mut hda_codec) -> c_int {
...
pub const create_beep_ctls(codec): c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ad198x_power_eapd(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ad_codec_suspend(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad_vmaster_eapd_hook(private_data: *mut c_void, enabled: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ad_codec_build_controls(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad198x_parse_auto_config(codec: *mut hda_codec, indep_hp: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn alloc_ad_spec(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ad1986a_probe(codec: *mut hda_codec) -> c_int {
...
//
    ...
    let mut num_conns: c_int = spec.num_smux_conns;
    if (num_conns == 2)
    return snd_hda_enum_helper_info(kcontrol, uinfo, 2, texts2);
#[no_mangle]
pub unsafe extern "C" fn if(3: num_conns ==) -> else {
    else if (num_conns == 3)
    ...
    let mut dig_out: hda_nid_t = spec.gen.multiout.dig_out_nid;
    let mut num_conns: c_int = spec.num_smux_conns;
    if (val >= num_conns)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ad1983_add_spdif_mux_ctl(codec: *mut hda_codec) -> c_int {
    ...
    if (!snd_hda_gen_add_kctl(&spec.gen, core::ptr::null_mut(), &ad1983_auto_smux_mixer))
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ad1983_probe(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad1981_probe(codec: *mut hda_codec) -> c_int {
    ...
    snd_hda_pick_fixup(codec, core::ptr::null_mut(), ad1981_fixup_tbl, ad1981_fixups);
    snd_hda_apply_fixup(codec, HDA_FIXUP_ACT_PRE_PROBE);
    err = ad198x_parse_auto_config(codec, false);
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn ad_codec_init(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad1988_add_spdif_mux_ctl(codec: *mut hda_codec) -> c_int {
...
// path = fake_paths[i];
    ...
    if (!snd_hda_gen_add_kctl(&spec.gen, core::ptr::null_mut(), &ad1988_auto_smux_mixer))
    return -ENOMEM;
    return 0;
    }
//
...
#[no_mangle]
unsafe extern "C" fn ad1988_probe(codec: *mut hda_codec) -> c_int {
    ...
    spec.gen.beep_nid = 0x10;
    set_beep_amp(spec, 0x10, 0, HDA_OUTPUT);
    snd_hda_pick_fixup(codec, ad1988_fixup_models, core::ptr::null_mut(), ad1988_fixups);
    snd_hda_apply_fixup(codec, HDA_FIXUP_ACT_PRE_PROBE);
...
#[no_mangle]
unsafe extern "C" fn ad1884_vmaster_hp_gpio_hook(private_data: *mut c_void, enabled: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ad1884_probe(codec: *mut hda_codec) -> c_int {
    ...
    spec.gen.beep_nid = 0x10;
    set_beep_amp(spec, 0x10, 0, HDA_OUTPUT);
    snd_hda_pick_fixup(codec, core::ptr::null_mut(), ad1884_fixup_tbl, ad1884_fixups);
    snd_hda_apply_fixup(codec, HDA_FIXUP_ACT_PRE_PROBE);
    err = ad198x_parse_auto_config(codec, true);
    if (err < 0)
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn ad1882_probe(codec: *mut hda_codec) -> c_int {
