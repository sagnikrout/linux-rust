...
//! Source: sound/hda/codecs/sigmatel.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sigmatel_spec {
    pub gen: hda_gen_spec,
    pub 1: unsigned int eapd_switch:,
    pub linear_tone_beep:1: c_uint,
    pub /: *mut *mut unsigned int headset_jack:1; / 4-pin headset jack (hp + mono mic),
    pub /: *mut *mut unsigned int volknob_init:1; / special volume-knob initialization,
    pub powerdown_adcs:1: c_uint,
    pub have_spdif_mux:1: c_uint,
// gpio lines
    pub eapd_mask: c_uint,
    pub gpio_mask: c_uint,
    pub gpio_dir: c_uint,
    pub gpio_data: c_uint,
    pub gpio_mute: c_uint,
    pub gpio_led: c_uint,
    pub gpio_led_polarity: c_uint,
    pub /: *mut *mut unsigned int vref_mute_led_nid; / pin NID for mute-LED vref control,
    pub vref_led: c_uint,
    pub default_polarity: c_int,
    pub /: *mut *mut unsigned int mic_mute_led_gpio; / capture mute LED GPIO,
    pub /: *mut *mut unsigned int mic_enabled; / current mic mute state (bitmask),
// stream
    pub stream_delay: c_uint,
// analog loopback
    pub aloopback_ctl: *const snd_kcontrol_new,
    pub aloopback: c_uint,
    pub aloopback_mask: c_uchar,
    pub aloopback_shift: c_uchar,
// power management
    pub power_map_bits: c_uint,
    pub num_pwrs: c_uint,
    pub pwr_nids: *const hda_nid_t,
    pub active_adcs: c_uint,
// beep widgets
    pub anabeep_nid: hda_nid_t,
    pub beep_power_on: bool,
// SPDIF-out mux
    pub spdif_labels: *const *const c_char,
    pub spdif_mux: hda_input_mux,
    pub cur_smux: [c_uint; 2],
}

pub const AC_VERB_IDT_SET_POWER_MAP: c_uint = 0x7ec;
pub const AC_VERB_IDT_GET_POWER_MAP: c_uint = 0xfec;
...
//
    ...
    let mut fg: hda_nid_t = codec.core.afg;
...
#[no_mangle]
unsafe extern "C" fn stac_update_led_status(codec: *mut hda_codec, muted: bool) {
...
#[no_mangle]
unsafe extern "C" fn stac_update_outputs(codec: *mut hda_codec) {
    ...
    let mut val: c_uint = spec.gpio_data;
...
// update all jacks
    ...
    let mut nid: hda_nid_t = spec.pwr_nids[i];
...
//
#[no_mangle]
unsafe extern "C" fn stac_init_power_map(codec: *mut hda_codec) {
    ...
    for (i = 0; i < spec.num_pwrs; i++)  {
    let mut nid: hda_nid_t = spec.pwr_nids[i];
    let mut def_conf: c_uint = snd_hda_codec_get_pincfg(codec, nid);
...
#[no_mangle]
unsafe extern "C" fn stac_store_hints(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn hp_bnb2011_with_dock(codec: *mut hda_codec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hp_blike_system(subsystem_id: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn set_hp_led_gpio(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn find_mute_led_cfg(codec: *mut hda_codec, default_polarity: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn has_builtin_speaker(codec: *mut hda_codec) -> bool {
    ...
    for (i = 0; i < nids; i++) {
    let mut def_conf: c_uint = snd_hda_codec_get_pincfg(codec, nid_pin[i]);
...
// create PC beep volume controls
    ...
    {
    struct sigmatel_spec *spec = codec.spec;
    let mut caps: u32 = query_amp_caps(codec, nid, HDA_OUTPUT);
...
#[no_mangle]
unsafe extern "C" fn stac_beep_switch_ctl(codec: *mut hda_codec) -> c_int {
...
//
    ...
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    struct sigmatel_spec *spec = codec.spec;
    let mut smux_idx: c_uint = snd_ctl_get_ioffidx(kcontrol, &ucontrol.id);
...
#[no_mangle]
unsafe extern "C" fn stac_create_spdif_mux_ctls(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stac92hd73xx_fixup_dell(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn stac_add_hp_bass_switch(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_hp_output(codec: *mut hda_codec, pin: hda_nid_t) -> bool {
    static bool is_hp_output(struct hda_codec *codec, hda_nid_t pin)
    {
    let mut pin_cfg: c_uint = snd_hda_codec_get_pincfg(codec, pin);
...
#[no_mangle]
unsafe extern "C" fn fixup_hp_headphone(codec: *mut hda_codec, pin: hda_nid_t) {
...
#[no_mangle]
unsafe extern "C" fn stac_parse_auto_config(codec: *mut hda_codec) -> c_int {
...
// setup digital beep controls and input device
    ...
    let mut nid: hda_nid_t = spec.gen.beep_nid;
    unsigned int caps;
...
#[no_mangle]
unsafe extern "C" fn stac_init(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stac_suspend(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_stac_spec(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac9200(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac925x(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac92hd73xx(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stac_setup_gpio(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn probe_stac92hd83xxx(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac92hd95(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac92hd71bxx(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac922x(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac927x(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac9205(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_stac9872(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stac_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
