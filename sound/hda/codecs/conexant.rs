...
//! Source: sound/hda/codecs/conexant.c
#![no_std]
...
// OLPC XO specific
    pub recording: bool,
    pub dc_enable: bool,
    pub /: *mut *mut unsigned int dc_input_bias; / offset into olpc_xo_dc_bias,
    pub dc_mode_path: *mut nid_path,
    pub mute_led_polarity: c_int,
    pub gpio_led: c_uint,
    pub gpio_mute_led_mask: c_uint,
    pub gpio_mic_led_mask: c_uint,
    pub is_cx11880_sn6140: bool,
}
...
#[no_mangle]
unsafe extern "C" fn cx_auto_parse_beep(codec: *mut hda_codec) -> c_int {
...
pub const cx_auto_parse_beep(codec): c_int = 0;
...
// parse EAPDs
#[no_mangle]
unsafe extern "C" fn cx_auto_parse_eapd(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cx_auto_vmaster_hook(private_data: *mut c_void, enabled: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cxt_init_gpio_led(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cx_fixup_headset_recog(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cx_init(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx_auto_shutdown(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cx_remove(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cx_process_headset_detect_plug_type(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cx_update_headset_mic_vref(codec: *mut hda_codec, event: *mut hda_jack_callback) {
...
pub const SN6140_S3_AFG_D0_DELAY_MS: c_int = 1000;
...
#[no_mangle]
unsafe extern "C" fn cx_suspend(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxt_update_headset_mode(codec: *mut hda_codec) {
    static void cxt_update_headset_mode(struct hda_codec *codec)
    {
// The verbs used in this function were tested on a Conexant CX20751/2 codec.
    int i;
    let mut mic_mode: bool = false;
    struct conexant_spec *spec = codec.spec;
    struct auto_pin_cfg *cfg = &spec.gen.autocfg;
    let mut mux_pin: hda_nid_t = spec.gen.imux_pins[spec.gen.cur_mux[0]];
...
#[no_mangle]
unsafe extern "C" fn olpc_xo_update_mic_boost(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn olpc_xo_update_mic_pins(codec: *mut hda_codec) {
...
//
    ...
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    struct conexant_spec *spec = codec.spec;
    let mut dc_enable: c_int = !!ucontrol.value.integer.value[0];
...
//
    ...
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    struct conexant_spec *spec = codec.spec;
    let mut ret: c_int = snd_hda_mixer_amp_volume_put(kcontrol, ucontrol);
...
// update LED status via GPIO
    ...
    {
    struct conexant_spec *spec = codec.spec;
    let mut oldval: c_uint = spec.gpio_led;
...
//
#[no_mangle]
unsafe extern "C" fn add_cx5051_fake_mutes(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cx_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
