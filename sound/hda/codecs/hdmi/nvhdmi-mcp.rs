...
//! Source: sound/hda/codecs/hdmi/nvhdmi-mcp.c
#![no_std]
...
pub const Nv_VERB_SET_Channel_Allocation: c_uint = 0xF79;
pub const Nv_VERB_SET_Info_Frame_Checksum: c_uint = 0xF7A;
pub const Nv_VERB_SET_Audio_Protection_On: c_uint = 0xF98;
pub const Nv_VERB_SET_Audio_Protection_Off: c_uint = 0xF99;
pub const nvhdmi_master_con_nid_7x: c_uint = 0x04;
pub const nvhdmi_master_pin_nid_7x: c_uint = 0x05;
...
#[no_mangle]
unsafe extern "C" fn nvhdmi_mcp_init(codec: *mut hda_codec) -> c_int {
    ...
    let mut chan: c_int = channels ? (channels - 1) : 1;
    switch (channels) {
    default:
    case 0:
    case 2:
...
#[no_mangle]
unsafe extern "C" fn nvhdmi_mcp_build_pcms(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvhdmi_mcp_build_controls(codec: *mut hda_codec) -> c_int {
