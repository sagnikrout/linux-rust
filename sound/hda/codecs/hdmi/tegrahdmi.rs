...
//! Source: sound/hda/codecs/hdmi/tegrahdmi.c
#![no_std]
...
pub const NVIDIA_AFG_NID: c_uint = 0x01;
//
...
// trigger to hdmi.
//
pub const NVIDIA_SET_HOST_INTR: c_uint = 0xf80;
pub const NVIDIA_GET_SCRATCH0: c_uint = 0xfa6;
pub const NVIDIA_SET_SCRATCH0_BYTE0: c_uint = 0xfa7;
pub const NVIDIA_SET_SCRATCH0_BYTE1: c_uint = 0xfa8;
pub const NVIDIA_SET_SCRATCH0_BYTE2: c_uint = 0xfa9;
pub const NVIDIA_SET_SCRATCH0_BYTE3: c_uint = 0xfaa;

pub const NVIDIA_GET_SCRATCH1: c_uint = 0xfab;
pub const NVIDIA_SET_SCRATCH1_BYTE0: c_uint = 0xfac;
pub const NVIDIA_SET_SCRATCH1_BYTE1: c_uint = 0xfad;
pub const NVIDIA_SET_SCRATCH1_BYTE2: c_uint = 0xfae;
pub const NVIDIA_SET_SCRATCH1_BYTE3: c_uint = 0xfaf;
//
