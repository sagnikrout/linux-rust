...
//! Source: sound/hda/codecs/hdmi/nvhdmi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nvhdmi_pin2port(audio_ptr: *mut c_void, pin_nid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvhdmi_port2pin(codec: *mut hda_codec, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_generic(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn probe_legacy(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvhdmi_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
