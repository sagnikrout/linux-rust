...
//! Source: sound/hda/codecs/hdmi/intelhdmi.c
#![no_std]
...
pub const I915_SILENT_RATE: c_int = 48000;
pub const I915_SILENT_CHANNELS: c_int = 2;
pub const I915_SILENT_FORMAT_BITS: c_int = 16;
pub const I915_SILENT_FMT_MASK: c_uint = 0xf;
...
// setup_stream ops override for HSW+
    ...
    {
    struct hdmi_spec *spec = codec.spec;
    let mut pin_idx: c_int = pin_id_to_pin_index(codec, pin_nid, dev_id);
    struct hdmi_spec_per_pin *per_pin;
    int res;
    if (pin_idx < 0)
...
unsafe extern "C" fn probe_i915_hsw_hdmi(codec: *mut hda_codec) -> c_int {
    ...
    {
    return intel_hsw_common_init(codec, 0x08, core::ptr::null_mut(), 0, 3,
...
//
    return intel_hsw_common_init(codec, 0x0b, core::ptr::null_mut(), 0, 3, false);
    }
#[no_mangle]
...
//
#[no_mangle]
unsafe extern "C" fn intelhdmi_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
