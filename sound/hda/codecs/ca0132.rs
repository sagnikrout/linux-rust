...
//! Source: sound/hda/codecs/ca0132.c
#![no_std]
...
// Macro flag: #define ENABLE_TUNING_CONTROLS
...
pub const DMA_TRANSFER_FRAME_SIZE_NWORDS: c_int = 8;
pub const DMA_TRANSFER_MAX_FRAME_SIZE_NWORDS: c_int = 32;
pub const DMA_OVERLAY_FRAME_SIZE_NWORDS: c_int = 2;
pub const MASTERCONTROL: c_uint = 0x80;
pub const MASTERCONTROL_ALLOC_DMA_CHAN: c_int = 10;
pub const MASTERCONTROL_QUERY_SPEAKER_EQ_ADDRESS: c_int = 60;
pub const WIDGET_CHIP_CTRL: c_uint = 0x15;
pub const WIDGET_DSP_CTRL: c_uint = 0x16;
pub const MEM_CONNID_MICIN1: c_int = 3;
pub const MEM_CONNID_MICIN2: c_int = 5;
pub const MEM_CONNID_MICOUT1: c_int = 12;
pub const MEM_CONNID_MICOUT2: c_int = 14;
pub const MEM_CONNID_WUH: c_int = 10;
pub const MEM_CONNID_DSP: c_int = 16;
pub const MEM_CONNID_DMIC: c_int = 100;
...
pub const NUM_OF_OUTPUTS: c_int = 2;
...
pub const IN_SRC_NUM_OF_INPUTS: c_int = 3;
    enum {
    REAR_MIC,
    REAR_LINE_IN,
    FRONT_MIC,
    ...
    enum {
pub const VNODE_START_NID: c_uint = 0x80;
...
pub const EFFECT_START_NID: c_uint = 0x90;
...
// Effects values size
pub const EFFECT_VALS_MAX_COUNT: c_int = 12;
//
...
pub const EFFECT_LEVEL_SLIDERS: c_int = 5;
// Latency introduced by DSP blocks in milliseconds.
pub const DSP_CAPTURE_INIT_LATENCY: c_int = 0;
pub const DSP_CRYSTAL_VOICE_LATENCY: c_int = 124;
pub const DSP_PLAYBACK_INIT_LATENCY: c_int = 13;
pub const DSP_PLAY_ENHANCEMENT_LATENCY: c_int = 30;
pub const DSP_SPEAKER_OUT_LATENCY: c_int = 7;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_effect {
    pub name: *const c_char,
    pub nid: hda_nid_t,
    pub ID*/: *mut *mut int mid; /effect module,
    pub request*/: *mut *mut int reqs[EFFECT_VALS_MAX_COUNT]; /effect module,
    pub 1:input*/: *mut *mut int direct; / 0:output;,
    pub /: *mut *mut int params; / number of default non-on/off params,
// effect default values, 1st is on/off.
    pub def_vals: [c_uint; EFFECT_VALS_MAX_COUNT],
}

pub const EFX_DIR_OUT: c_int = 0;
pub const EFX_DIR_IN: c_int = 1;
...
// Tuning controls
    ...
    enum {
pub const TUNING_CTL_START_NID: c_uint = 0xC0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_tuning_ctl {
    pub name: *const c_char,
    pub parent_nid: hda_nid_t,
    pub nid: hda_nid_t,
    pub ID*/: *mut *mut int mid; /effect module,
    pub request*/: *mut *mut int req; /effect module,
    pub 1:input*/: *mut *mut int direct; / 0:output;,
    pub values*/: *mut *mut unsigned int def_val;/effect default,
}
...
// Voice FX Presets
pub const VOICEFX_MAX_PARAM_COUNT: c_int = 9;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_voicefx {
    pub name: *const c_char,
    pub nid: hda_nid_t,
    pub mid: c_int,
    pub request*/: *mut *mut int reqs[VOICEFX_MAX_PARAM_COUNT]; /effect module,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_voicefx_preset {
    pub name*/: *const *const *const char name; /preset,
    pub vals: [c_uint; VOICEFX_MAX_PARAM_COUNT],
}
...
pub const EQ_PRESET_MAX_PARAM_COUNT: c_int = 11;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_eq {
    pub name: *const c_char,
    pub nid: hda_nid_t,
    pub mid: c_int,
    pub request*/: *mut *mut int reqs[EQ_PRESET_MAX_PARAM_COUNT]; /effect module,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_eq_preset {
    pub name*/: *const *const *const char name; /preset,
    pub vals: [c_uint; EQ_PRESET_MAX_PARAM_COUNT],
}
...
pub const SPEAKER_CHANNEL_CFG_COUNT: c_int = 5;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ca0132_alt_speaker_channel_cfg {
    pub name: *const c_char,
    pub val: c_uint,
}
...
//
pub const DSP_VOL_OUT: c_int = 0;
pub const DSP_VOL_IN: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_dsp_volume_ctl {
    pub vnid: hda_nid_t,
    pub ID*/: *mut *mut int mid; / module,
    pub /: *mut *mut unsigned int reqs[3]; / scp req ID,
}
...
pub const AE_CA0113_OUT_SET_COMMANDS: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ae_ca0113_output_set {
    pub group: [c_uint; AE_CA0113_OUT_SET_COMMANDS],
    pub target: [c_uint; AE_CA0113_OUT_SET_COMMANDS],
    pub vals: [c_uint; NUM_OF_OUTPUTS][AE_CA0113_OUT_SET_COMMANDS],
}
...
pub const AE5_HEADPHONE_GAIN_PRESET_MAX_COMMANDS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ae5_headphone_gain_set {
    pub name: *const c_char,
    pub vals: [c_uint; AE5_HEADPHONE_GAIN_PRESET_MAX_COMMANDS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct chipio_stream_remap_data {
    pub stream_id: c_uint,
    pub count: c_uint,
    pub offset: [c_uint; 16],
    pub value: [c_uint; 16],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ca0132_spec {
    pub gen: hda_gen_spec,
    pub mixers: [*const snd_kcontrol_new; 5],
    pub num_mixers: c_uint,
    pub base_init_verbs: *const hda_verb,
    pub base_exit_verbs: *const hda_verb,
    pub chip_init_verbs: *const hda_verb,
    pub desktop_init_verbs: *const hda_verb,
    pub spec_init_verbs: *mut hda_verb,
    pub autocfg: auto_pin_cfg,
// Nodes configurations
    pub multiout: hda_multi_out,
    pub out_pins: [hda_nid_t; AUTO_CFG_MAX_OUTS],
    pub dacs: [hda_nid_t; AUTO_CFG_MAX_OUTS],
    pub num_outputs: c_uint,
    pub input_pins: [hda_nid_t; AUTO_PIN_LAST],
    pub adcs: [hda_nid_t; AUTO_PIN_LAST],
    pub dig_out: hda_nid_t,
    pub dig_in: hda_nid_t,
    pub num_inputs: c_uint,
    pub shared_mic_nid: hda_nid_t,
    pub shared_out_nid: hda_nid_t,
    pub unsol_tag_hp: hda_nid_t,
    pub /: *mut *mut hda_nid_t unsol_tag_front_hp; / for desktop ca0132 codecs,
    pub unsol_tag_amic1: hda_nid_t,
// chip access
    pub /: *mut *mut mutex chipio_mutex; / chip access mutex,
    pub curr_chip_addx: u32,
// DSP download related
    pub dsp_state: enum dsp_download_state,
    pub dsp_stream_id: c_uint,
    pub wait_scp: c_uint,
    pub wait_scp_header: c_uint,
    pub wait_num_data: c_uint,
    pub scp_resp_header: c_uint,
    pub scp_resp_data: [c_uint; 4],
    pub scp_resp_count: c_uint,
    pub startup_check_entered: bool,
    pub dsp_reload: bool,
// mixer and effects related
    pub dmic_ctl: c_uchar,
    pub cur_out_type: c_int,
    pub cur_mic_type: c_int,
    pub vnode_lvol: [c_long; VNODES_COUNT],
    pub vnode_rvol: [c_long; VNODES_COUNT],
    pub vnode_lswitch: [c_long; VNODES_COUNT],
    pub vnode_rswitch: [c_long; VNODES_COUNT],
    pub effects_switch: [c_long; EFFECTS_COUNT],
    pub voicefx_val: c_long,
    pub cur_mic_boost: c_long,
// ca0132_alt control related values
    pub in_enum_val: c_uchar,
    pub out_enum_val: c_uchar,
    pub channel_cfg_val: c_uchar,
    pub speaker_range_val: [c_uchar; 2],
    pub mic_boost_enum_val: c_uchar,
    pub smart_volume_setting: c_uchar,
    pub bass_redirection_val: c_uchar,
    pub bass_redirect_xover_freq: c_long,
    pub fx_ctl_val: [c_long; EFFECT_LEVEL_SLIDERS],
    pub xbass_xover_freq: c_long,
    pub eq_preset_val: c_long,
    pub tlv: [c_uint; 4],
    pub vmaster_mute: hda_vmaster_mute_hook,
// AE-5 Control values
    pub ae5_headphone_gain_val: c_uchar,
    pub ae5_filter_val: c_uchar,
// ZxR Control Values
    pub zxr_gain_set: c_uchar,
    pub codec: *mut hda_codec,
    pub unsol_hp_work: delayed_work,
    pub cur_ctl_vals: [c_long; TUNING_CTLS_COUNT],
//
...
pub const MAX_QUIRK_MMIO_GPIO_SET_VALS: c_int = 3;
pub const MAX_QUIRK_SCP_SET_VALS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ca0132_alt_out_set_info {
    pub /: *mut *mut unsigned int dac2port; / ParamID 0x0d value.,
    pub has_hda_gpio: bool,
    pub hda_gpio_pin: c_char,
    pub hda_gpio_set: c_char,
    pub mmio_gpio_count: c_uint,
    pub mmio_gpio_pin: [c_char; MAX_QUIRK_MMIO_GPIO_SET_VALS],
    pub mmio_gpio_set: [c_char; MAX_QUIRK_MMIO_GPIO_SET_VALS],
    pub scp_cmds_count: c_uint,
    pub scp_cmd_mid: [c_uint; MAX_QUIRK_SCP_SET_VALS],
    pub scp_cmd_req: [c_uint; MAX_QUIRK_SCP_SET_VALS],
    pub scp_cmd_val: [c_uint; MAX_QUIRK_SCP_SET_VALS],
    pub has_chipio_write: bool,
    pub chipio_write_addr: c_uint,
    pub chipio_write_data: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ca0132_alt_out_set_quirk_data {
    pub quirk_id: c_int,
    pub has_headphone_gain: bool,
    pub is_ae_series: bool,
    pub out_set_info: [ca0132_alt_out_set_info; NUM_OF_OUTPUTS],
}
...
// res = response;
    ...
    {
    let mut converter_stream_channel: c_uchar = 0;
...
//
#[no_mangle]
unsafe extern "C" fn chipio_write_data(codec: *mut hda_codec, data: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn chipio_read_data(codec: *mut hda_codec, data: *mut c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn chipio_8051_set_address(codec: *mut hda_codec, addr: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn chipio_8051_set_data(codec: *mut hda_codec, data: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn chipio_8051_get_data(codec: *mut hda_codec) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn chipio_8051_set_data_pll(codec: *mut hda_codec, data: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn chipio_enable_clocks(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn dspio_write_wait(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn dspio_write(codec: *mut hda_codec, scp_data: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dspio_read(codec: *mut hda_codec, data: *mut c_uint) -> c_int {
...
pub struct scp_msg {
    pub hdr: c_uint,
    pub data: [c_uint; SCP_MAX_DATA_WORDS],
}

#[no_mangle]
unsafe extern "C" fn dspio_clear_response_queue(codec: *mut hda_codec) {
    static void dspio_clear_response_queue(struct hda_codec *codec)
    {
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(1000);
    let mut dummy: c_uint = 0;
    int status;
...
#[no_mangle]
unsafe extern "C" fn dspio_get_response_data(codec: *mut hda_codec) -> c_int {
...
//
    ...
    struct ca0132_spec *spec = codec.spec;
    int status;
    let mut scp_send_size: c_uint = 0;
    unsigned int total_size;
    let mut waiting_for_resp: bool = false;
    unsigned int header;
...
// get scp header from buffer
    ...
    extract_scp_header(header, &target_id, &src_id, &get_flag, core::ptr::null_mut(),
    &device_flag, core::ptr::null_mut(), core::ptr::null_mut(), &data_size);
...
//
    ...
    if ((len != 0 && data == core::ptr::null_mut()) || (len > SCP_MAX_DATA_WORDS))
    return -EINVAL;
    if (dir == SCP_GET && reply == core::ptr::null_mut()) {
    codec_dbg(codec, "dspio_scp get but has no buffer\n");
    return -EINVAL;
    }
    if (reply != core::ptr::null_mut() && (reply_len == core::ptr::null_mut() || (*reply_len == 0))) {
    codec_dbg(codec, "dspio_scp bad resp buf len parms\n");
    return -EINVAL;
    }
    scp_send.hdr = make_scp_header(mod_id, src_id, (dir == SCP_GET), req,
    0, 0, 0, len/sizeof(unsigned int));
    if (data != core::ptr::null_mut() && len > 0) {
...
// extract send and reply headers members
    extract_scp_header(scp_send.hdr, core::ptr::null_mut(), core::ptr::null_mut(), &send_get_flag,
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    extract_scp_header(scp_reply.hdr, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    ...
    codec_dbg(codec, "core::ptr::null_mut() reply\n");
    return -EINVAL;
    } else {
...
//
    ...
    {
    return dspio_scp(codec, mod_id, src_id, req, SCP_SET, data, len, core::ptr::null_mut(),
    core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn dspio_alloc_dma_chan(codec: *mut hda_codec, dma_chan: *mut c_uint) -> c_int {
    static int dspio_alloc_dma_chan(struct hda_codec *codec, unsigned int *dma_chan)
    {
    let mut status: c_int = 0;
    let mut size: c_uint = sizeof(*dma_chan);
    codec_dbg(codec, "     dspio_alloc_dma_chan() -- begin\n");
    status = dspio_scp(codec, MASTERCONTROL, 0x20,
    MASTERCONTROL_ALLOC_DMA_CHAN, SCP_GET, core::ptr::null_mut(), 0,
    dma_chan, &size);
    if (status < 0) {
...
//
#[no_mangle]
unsafe extern "C" fn dspio_free_dma_chan(codec: *mut hda_codec, dma_chan: c_uint) -> c_int {
    ...
    sizeof(dma_chan), core::ptr::null_mut(), &dummy);
    if (status < 0) {
...
//
#[no_mangle]
unsafe extern "C" fn dsp_set_run_state(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dsp_reset(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dsp_is_dma_active(codec: *mut hda_codec, dma_chan: c_uint) -> bool {
...
//
    ...
    let mut dma_cfg: c_uint = 0;
    let mut adr_ofs: c_uint = 0;
    let mut xfr_cnt: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn dsp_free_router_ports(codec: *mut hda_codec) -> c_int {
...
//
    ...
    {
    unsigned int num_chans;
    let mut sample_rate_div: c_uint = ((get_hdafmt_rate(fmt) >> 0) & 3) + 1;
    let mut sample_rate_mul: c_uint = ((get_hdafmt_rate(fmt) >> 3) & 3) + 1;
    let mut rate_multi: c_uint = sample_rate_mul / sample_rate_div;
    if ((rate_multi != 1) && (rate_multi != 2) && (rate_multi != 4)) {
    codec_dbg(codec, "bad rate multiple\n");
    return -EINVAL;
    }
...
//
#[no_mangle]
unsafe extern "C" fn dsp_free_ports(codec: *mut hda_codec) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dma_engine {
    pub codec: *mut hda_codec,
    pub m_converter_format: c_ushort,
...
//
#[no_mangle]
unsafe extern "C" fn dma_reset(dma: *mut dma_engine) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_set_state(dma: *mut dma_engine, state: enum dma_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_get_buffer_size(dma: *mut dma_engine) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dma_get_stream_id(dma: *mut dma_engine) -> c_uint {
...
pub struct dsp_image_seg {
    ...
    let mut g_magic_value: static u32 = 0x4c46584d;
    let mut g_chip_addr_magic_value: static u32 = 0xFFFFFF01;
#[no_mangle]
unsafe extern "C" fn is_valid(p: *const dsp_image_seg) -> bool {
    static bool is_valid(const struct dsp_image_seg *p)
    {
    return p.magic == g_magic_value;
    }
#[no_mangle]
unsafe extern "C" fn is_hci_prog_list_seg(p: *const dsp_image_seg) -> bool {
    static bool is_hci_prog_list_seg(const struct dsp_image_seg *p)
    {
    let mut g_chip_addr_magic_value: return = = p.chip_addr;
    }
#[no_mangle]
unsafe extern "C" fn is_last(p: *const dsp_image_seg) -> bool {
    static bool is_last(const struct dsp_image_seg *p)
    {
    return p.count == 0;
    }
#[no_mangle]
unsafe extern "C" fn dsp_sizeof(p: *const dsp_image_seg) -> usize {
...
//
    ...
    const u32 *data;
    unsigned int count;
    if (fls == core::ptr::null_mut() || fls.chip_addr != g_chip_addr_magic_value) {
...
//
    ...
    {
    let mut status: c_int = 0;
    let mut comm_dma_setup_done: bool = false;
    const unsigned int *data;
    unsigned int chip_addx;
    ...
    const struct dsp_image_seg *hci_write = core::ptr::null_mut();
    unsigned long timeout;
    bool dma_active;
    if (fls == core::ptr::null_mut())
    return -EINVAL;
    ...
    if (fls == core::ptr::null_mut() || dma_engine == core::ptr::null_mut() || port_map_mask == 0) {
    ...
    if (buffer_addx == core::ptr::null_mut()) {
    codec_dbg(codec, "dma_engine buffer core::ptr::null_mut()\n");
    return -EINVAL;
    }
...
//
    ...
    struct ca0132_spec *spec = codec.spec;
    int status;
    let mut hda_format: c_ushort = 0;
    unsigned int response;
    let mut stream_id: c_uchar = 0;
    struct dma_engine *dma_engine;
    unsigned int dma_chan;
    unsigned int port_map_mask;
    if (fls_data == core::ptr::null_mut())
    return -EINVAL;
    ...
    while ((fls_data != core::ptr::null_mut()) && !is_last(fls_data)) {
    ...
    if ((fls_data != core::ptr::null_mut()) && !is_last(fls_data))
    fls_data = get_next_seg_ptr(fls_data);
    }
    if (port_map_mask != 0)
...
//
#[no_mangle]
unsafe extern "C" fn dspload_post_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn dspload_is_loaded(codec: *mut hda_codec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dspload_wait_loaded(codec: *mut hda_codec) -> bool {
    static bool dspload_wait_loaded(struct hda_codec *codec)
    {
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(2000);
    do {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_gpio_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_gpio_setup(codec: *mut hda_codec) {
...
// effects tail
    ...
    {
    struct ca0132_spec *spec = codec.spec;
    let mut latency: c_uint = DSP_PLAYBACK_INIT_LATENCY;
...
//
    ...
    {
    struct ca0132_spec *spec = codec.spec;
    let mut latency: c_uint = DSP_CAPTURE_INIT_LATENCY;
    struct snd_pcm_runtime *runtime = substream.runtime;
    if (spec.dsp_state != DSP_DOWNLOADED)
    return 0;
...
// The following are for tuning of products
    ...
    struct ca0132_spec *spec = codec.spec;
    let mut nid: hda_nid_t = get_amp_nid(kcontrol);
    long *valp = ucontrol.value.integer.value;
    let mut idx: c_int = nid - TUNING_CTL_START_NID;
// valp = spec->cur_ctl_vals[idx];
    ...
    {
    let mut chs: c_int = get_amp_channels(kcontrol);
...
// any change?
    ...
    let mut type: c_int = dir ? HDA_INPUT : HDA_OUTPUT;
    struct snd_kcontrol_new knew =
    HDA_CODEC_VOLUME_MONO(namestr, nid, 1, 0, type);
    knew.access = SNDRV_CTL_ELEM_ACCESS_READWRITE |
    SNDRV_CTL_ELEM_ACCESS_TLV_READ;
    knew.tlv.c = core::ptr::null_mut();
    knew.tlv.p = core::ptr::null_mut();
    switch (pnid) {
    case VOICE_FOCUS:
...
#[no_mangle]
unsafe extern "C" fn add_tuning_ctls(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_init_tuning_defaults(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_select_out(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ae5_mmio_select_out(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_set_full_range_speaker(codec: *mut hda_codec) -> c_int {
    static int ca0132_alt_set_full_range_speaker(struct hda_codec *codec)
    {
    struct ca0132_spec *spec = codec.spec;
    let mut quirk: c_int = ca0132_quirk(spec);
    unsigned int tmp;
    int err;
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_select_out_quirk_set(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_select_out(codec: *mut hda_codec) -> c_int {
...
// Default Headphone is rear headphone
    let mut headphone_nid: hda_nid_t = spec.out_pins[1];
    codec_dbg(codec, "%s\n", __func__);
    CLASS(snd_hda_power_pm, pm)(codec);
    auto_jack = spec.vnode_lswitch[VNID_HP_ASEL - VNODE_START_NID];
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: snd_hda_jack_detect(codec, _arg: spec->unsol_tag_hp)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ca0132_unsol_hp_delayed(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_set_vipsource(codec: *mut hda_codec, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_set_vipsource(codec: *mut hda_codec, val: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_select_mic(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_select_in(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_voicefx_set(codec: *mut hda_codec, enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_effects_set(codec: *mut hda_codec, nid: hda_nid_t, val: c_long) -> c_int {
    static int ca0132_effects_set(struct hda_codec *codec, hda_nid_t nid, long val)
    {
    struct ca0132_spec *spec = codec.spec;
    unsigned int on, tmp, channel_cfg;
    let mut num_fx: c_int = OUT_EFFECTS_COUNT + IN_EFFECTS_COUNT;
    let mut err: c_int = 0;
    let mut idx: c_int = nid - EFFECT_START_NID;
    if ((idx < 0) || (idx >= num_fx))
    return 0; /* no changed */
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_pe_switch_set(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_mic1(codec: *mut hda_codec) -> c_int {
    static int stop_mic1(struct hda_codec *codec)
    {
    struct ca0132_spec *spec = codec.spec;
...
#[no_mangle]
unsafe extern "C" fn resume_mic1(codec: *mut hda_codec, oldval: c_uint) {
    static void resume_mic1(struct hda_codec *codec, unsigned int oldval)
    {
    struct ca0132_spec *spec = codec.spec;
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_cvoice_switch_set(codec: *mut hda_codec) -> c_int {
    static int ca0132_cvoice_switch_set(struct hda_codec *codec)
    {
    struct ca0132_spec *spec = codec.spec;
    hda_nid_t nid;
...
#[no_mangle]
unsafe extern "C" fn ca0132_mic_boost_set(codec: *mut hda_codec, val: c_long) -> c_int {
    static int ca0132_mic_boost_set(struct hda_codec *codec, long val)
    {
    struct ca0132_spec *spec = codec.spec;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_mic_boost_set(codec: *mut hda_codec, val: c_long) -> c_int {
    static int ca0132_alt_mic_boost_set(struct hda_codec *codec, long val)
    {
    struct ca0132_spec *spec = codec.spec;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ae5_headphone_gain_set(codec: *mut hda_codec, val: c_long) -> c_int {
    static int ae5_headphone_gain_set(struct hda_codec *codec, long val)
    {
    unsigned int i;
    for (i = 0; i < 4; i++)
...
//
#[no_mangle]
unsafe extern "C" fn zxr_headphone_gain_set(codec: *mut hda_codec, val: c_long) -> c_int {
    static int zxr_headphone_gain_set(struct hda_codec *codec, long val)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_disable_hp_auto_detect(codec: *mut hda_codec) {
    ...
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    let mut nid: hda_nid_t = get_amp_nid(kcontrol);
    let mut shared_nid: hda_nid_t = 0;
    bool effective;
    let mut ret: c_int = 0;
    struct ca0132_spec *spec = codec.spec;
    int auto_jack;
...
// if effective conditions, then update hw immediately.
    ...
    if (effective) {
    let mut dir: c_int = get_amp_direction(kcontrol);
    let mut ch: c_int = get_amp_channels(kcontrol);
    unsigned long pval;
...
// valp = spec->xbass_xover_freq;
    ...
    let mut nid: hda_nid_t = get_amp_nid(kcontrol);
    long *valp = ucontrol.value.integer.value;
    let mut idx: c_int = nid - OUT_EFFECT_START_NID;
...
//
pub const MIC_BOOST_NUM_OF_STEPS: c_int = 4;
pub const MIC_BOOST_ENUM_MAX_STRLEN: c_int = 10;
    ...
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    struct ca0132_spec *spec = codec.spec;
    let mut sel: c_int = ucontrol.value.enumerated.item[0];
    let mut items: c_uint = MIC_BOOST_NUM_OF_STEPS;
    if (sel >= items)
    return 0;
...
//
pub const AE5_HEADPHONE_GAIN_MAX: c_int = 3;
    ...
    struct ca0132_spec *spec = codec.spec;
    let mut sel: c_int = ucontrol.value.enumerated.item[0];
    let mut items: c_uint = AE5_HEADPHONE_GAIN_MAX;
    if (sel >= items)
    return 0;
...
//
pub const AE5_SOUND_FILTER_MAX: c_int = 3;
    ...
    struct ca0132_spec *spec = codec.spec;
    let mut sel: c_int = ucontrol.value.enumerated.item[0];
    let mut items: c_uint = AE5_SOUND_FILTER_MAX;
    if (sel >= items)
    return 0;
...
//
    ...
    struct ca0132_spec *spec = codec.spec;
    let mut sel: c_int = ucontrol.value.enumerated.item[0];
    let mut items: c_uint = IN_SRC_NUM_OF_INPUTS;
//
...
// Sound Blaster Z Output Select Control
    ...
    struct ca0132_spec *spec = codec.spec;
    let mut sel: c_int = ucontrol.value.enumerated.item[0];
    let mut items: c_uint = NUM_OF_OUTPUTS;
    if (sel >= items)
    return 0;
...
// Select surround output type: 2.1, 4.0, 4.1, or 5.1.
    ...
    struct snd_ctl_elem_info *uinfo)
    {
    let mut items: c_uint = SPEAKER_CHANNEL_CFG_COUNT;
    uinfo.type = SNDRV_CTL_ELEM_TYPE_ENUMERATED;
    uinfo.count = 1;
...
//
pub const NUM_OF_SVM_SETTINGS: c_int = 3;
    ...
    struct ca0132_spec *spec = codec.spec;
    let mut sel: c_int = ucontrol.value.enumerated.item[0];
    let mut items: c_uint = NUM_OF_SVM_SETTINGS;
    let mut idx: c_uint = SMART_VOLUME - EFFECT_START_NID;
    unsigned int tmp;
    if (sel >= items)
    return 0;
...
// Sound Blaster Z EQ preset controls
    ...
    struct snd_ctl_elem_info *uinfo)
    {
    let mut items: c_uint = ARRAY_SIZE(ca0132_alt_eq_presets);
    uinfo.type = SNDRV_CTL_ELEM_TYPE_ENUMERATED;
    uinfo.count = 1;
    uinfo.value.enumerated.items = items;
    if (uinfo.value.enumerated.item >= items)
...
//
    ...
    struct snd_ctl_elem_info *uinfo)
    {
    let mut items: c_uint = ARRAY_SIZE(ca0132_voicefx_presets);
    uinfo.type = SNDRV_CTL_ELEM_TYPE_ENUMERATED;
    uinfo.count = 1;
    uinfo.value.enumerated.items = items;
    if (uinfo.value.enumerated.item >= items)
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_dsp_volume_put(codec: *mut hda_codec, nid: hda_nid_t) {
...
#[no_mangle]
unsafe extern "C" fn add_voicefx(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_ca0132_alt_eq_presets(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_svm_enum(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_output_enum(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_speaker_channel_cfg_enum(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_front_full_range_switch(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_rear_full_range_switch(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_bass_redirection_crossover(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_bass_redirection_switch(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_input_enum(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_mic_boost_enum(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ae5_add_headphone_gain_enum(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ae5_add_sound_filter_enum(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zxr_add_headphone_gain_switch(codec: *mut hda_codec) -> c_int {
...
//
    ...
    "Front", "Surround", "Center", "LFE", core::ptr::null_mut(),
    };
//
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_add_chmap_ctls(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_build_controls(codec: *mut hda_codec) -> c_int {
...
// Setup vmaster with surround followers for desktop ca0132 devices
    ...
    core::ptr::null_mut(), ca0132_alt_follower_pfxs,
    "Playback Switch",
...
#[no_mangle]
unsafe extern "C" fn dbpro_build_controls(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_build_pcms(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbpro_build_pcms(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_output(codec: *mut hda_codec, pin: hda_nid_t, dac: hda_nid_t) {
...
#[no_mangle]
unsafe extern "C" fn init_input(codec: *mut hda_codec, pin: hda_nid_t, adc: hda_nid_t) {
...
#[no_mangle]
unsafe extern "C" fn refresh_amp_caps(codec: *mut hda_codec, nid: hda_nid_t, dir: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_set_dmic(codec: *mut hda_codec, enable: c_int) {
    static void ca0132_set_dmic(struct hda_codec *codec, int enable)
    {
    struct ca0132_spec *spec = codec.spec;
    unsigned int tmp;
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_init_dmic(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_init_analog_mic2(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_refresh_widget_caps(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_free_active_dma_channels(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_start_dsp_audio_streams(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_init_speaker_tuning(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_init_analog_mics(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn sbz_connect_streams(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn sbz_chipio_startup_data(codec: *mut hda_codec) {
...
// Remap DSP audio output stream ports.
    ...
    break;
    default:
    dsp_out_remap_data = core::ptr::null_mut();
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn ca0132_alt_dsp_initial_mic_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae5_post_dsp_register_set(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae5_post_dsp_param_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae5_post_dsp_pll_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae5_post_dsp_stream_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae5_post_dsp_startup_data(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae7_post_dsp_setup_ports(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae7_post_dsp_asi_stream_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae7_post_dsp_pll_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae7_post_dsp_asi_setup_ports(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ae7_post_dsp_asi_setup(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_setup_defaults(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn r3d_setup_defaults(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn sbz_setup_defaults(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ae5_setup_defaults(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ae7_setup_defaults(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_init_flags(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_init_params(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_set_dsp_msr(codec: *mut hda_codec, is96k: bool) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_download_dsp_images(codec: *mut hda_codec) -> bool {
    static bool ca0132_download_dsp_images(struct hda_codec *codec)
    {
    struct ca0132_spec *spec = codec.spec;
    const struct dsp_image_seg *dsp_os_image;
    const struct firmware *fw_entry __free(firmware) = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn ca0132_download_dsp(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn amic_callback(codec: *mut hda_codec, cb: *mut hda_jack_callback) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_setup_unsol(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_init_chip(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn r3di_gpio_shutdown(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn sbz_region2_exit(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn sbz_set_pin_ctl_default(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_clear_unsolicited(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn zxr_dbpro_power_state_shutdown(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn sbz_exit_chip(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn r3d_exit_chip(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae5_exit_chip(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ae7_exit_chip(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn zxr_exit_chip(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_exit_chip(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn sbz_dsp_startup_check(codec: *mut hda_codec) {
    static void sbz_dsp_startup_check(struct hda_codec *codec)
    {
    struct ca0132_spec *spec = codec.spec;
    unsigned int dsp_data_check[4];
    let mut cur_address: c_uint = 0x390;
    unsigned int i;
    let mut failure: c_uint = 0;
    let mut reload: c_uint = 3;
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_vol_setup(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn sbz_pre_dsp_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn r3d_pre_dsp_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn r3di_pre_dsp_setup(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn zxr_pre_dsp_setup(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_mmio_init_sbz(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_mmio_init_ae5(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_mmio_init(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn ae5_register_set(codec: *mut hda_codec) {
    static void ae5_register_set(struct hda_codec *codec)
    {
    struct ca0132_spec *spec = codec.spec;
    let mut count: c_uint = ARRAY_SIZE(ca0132_ae5_register_set_addresses);
...
//
#[no_mangle]
unsafe extern "C" fn ca0132_alt_init(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_init(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbpro_init(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_free(codec: *mut hda_codec) {
    ...
    kfree(codec.spec);
    codec.spec = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dbpro_free(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_config(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_prepare_verbs(codec: *mut hda_codec) -> c_int {
    static int ca0132_prepare_verbs(struct hda_codec *codec)
    {
// Verbs + terminator (an empty element)
pub const NUM_SPEC_VERBS: c_int = 2;
    struct ca0132_spec *spec = codec.spec;
...
//
#[no_mangle]
unsafe extern "C" fn sbz_detect_quirk(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_generic_init_hook(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn ca0132_generic_probe(codec: *mut hda_codec) -> c_int {
    ...
    if (err < 0)
    return err;
    err = snd_hda_parse_pin_def_config(codec, cfg, core::ptr::null_mut());
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn ca0132_codec_remove(codec: *mut hda_codec) {
...
// Detect codec quirk
    snd_hda_pick_fixup(codec, ca0132_quirk_models, ca0132_quirks, core::ptr::null_mut());
    switch (ca0132_quirk(spec)) {
    case QUIRK_SBZ:
...
// Setup whether or not to use alt functions/controls/pci_mmio
    ...
    if (spec.mem_base == core::ptr::null_mut()) {
    ...
    if (err < 0)
    goto error;
    err = snd_hda_parse_pin_def_config(codec, &spec.autocfg, core::ptr::null_mut());
    if (err < 0)
    goto error;
...
#[no_mangle]
unsafe extern "C" fn ca0132_codec_build_controls(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_codec_build_pcms(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_codec_init(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ca0132_codec_suspend(codec: *mut hda_codec) -> c_int {
