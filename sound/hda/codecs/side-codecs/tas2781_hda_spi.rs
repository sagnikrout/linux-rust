...
//! Source: sound/hda/codecs/side-codecs/tas2781_hda_spi.c
#![no_std]
...
pub const TASDEVICE_WIN_LEN: c_int = 128;

// System Reset Check Register

pub const TAS2781_REG_CLK_CONFIG_RESET: c_uint = 0x19;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tas2781_hda_spi_priv {
    pub snd_ctls: [*mut snd_kcontrol; 3],
}
...
//
    ...
    ACARD_SINGLE_RANGE_EXT_TLV(core::ptr::null_mut(), TAS2781_AMP_LEVEL, 1, 0, 20, 0,
    tas2781_amp_getvol, tas2781_amp_putvol,
    tas2781_amp_tlv),
    ACARD_SINGLE_RANGE_EXT_TLV(core::ptr::null_mut(), TAS2781_DVC_LVL, 0, 0, 200, 1,
    tas2781_digital_getvol, tas2781_digital_putvol,
    tas2781_dvc_tlv),
    ACARD_SINGLE_BOOL_EXT(core::ptr::null_mut(), 0, tas2781_force_fwload_get,
