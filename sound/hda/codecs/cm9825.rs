...
//! Source: sound/hda/codecs/cm9825.c
#![no_std]
...
pub const CM9825_VERB_SET_HPF_1: c_uint = 0x781;
pub const CM9825_VERB_SET_HPF_2: c_uint = 0x785;
pub const CM9825_VERB_SET_PLL: c_uint = 0x7a0;
pub const CM9825_VERB_SET_NEG: c_uint = 0x7a1;
pub const CM9825_VERB_SET_ADCL: c_uint = 0x7a2;
pub const CM9825_VERB_SET_DACL: c_uint = 0x7a3;
pub const CM9825_VERB_SET_MBIAS: c_uint = 0x7a4;
pub const CM9825_VERB_SET_VNEG: c_uint = 0x7a8;
pub const CM9825_VERB_SET_D2S: c_uint = 0x7a9;
pub const CM9825_VERB_SET_DACTRL: c_uint = 0x7aa;
pub const CM9825_VERB_SET_P3BCP: c_uint = 0x7ab;
pub const CM9825_VERB_SET_PDNEG: c_uint = 0x7ac;
pub const CM9825_VERB_SET_VDO: c_uint = 0x7ad;
pub const CM9825_VERB_SET_CDALR: c_uint = 0x7b0;
pub const CM9825_VERB_SET_MTCBA: c_uint = 0x7b1;
pub const CM9825_VERB_SET_OTP: c_uint = 0x7b2;
pub const CM9825_VERB_SET_OCP: c_uint = 0x7b3;
pub const CM9825_VERB_SET_GAD: c_uint = 0x7b4;
pub const CM9825_VERB_SET_TMOD: c_uint = 0x7b5;
pub const CM9825_VERB_SET_SNR: c_uint = 0x7b6;
pub const CM9825_VERB_SET_OMTP: c_uint = 0x7ef;
pub const CM9825_VERB_READ_OMTP: c_uint = 0xfec;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmi_spec {
...
unsafe extern "C" fn cm9825_unsol_lineout_delayed(work: *mut work_struct) {
    ...
    container_of(to_delayed_work(work), struct cmi_spec,
    unsol_lineout_work);
    let mut line_out_pin: hda_nid_t = spec.gen.autocfg.line_out_pins[0];
    let mut line_out_jack_plugin: bool = false;
...
unsafe extern "C" fn cm9825_unsol_hp_delayed(work: *mut work_struct) {
    ...
    struct hda_jack_tbl *jack;
    let mut hp_pin: hda_nid_t = spec.gen.autocfg.hp_pins[0];
    let mut hp_jack_plugin: bool = false;
    let mut err: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(spec->jd_cap_lineout: cb->nid ==) -> else {
...
unsafe extern "C" fn cm9825_setup_unsol(codec: *mut hda_codec) {
    ...
    int i;
    let mut hp_pin: hda_nid_t = spec.gen.autocfg.hp_pins[0];
    let mut lineout_pin: hda_nid_t = spec.gen.autocfg.line_out_pins[0];
    if (hp_pin != 0) {
...
#[no_mangle]
unsafe extern "C" fn cm9825_probe(codec: *mut hda_codec, id: *const hda_device_id) -> c_int {
