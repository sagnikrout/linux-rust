...
//! Source: sound/hda/codecs/cirrus/cs420x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_input_coef(codec: *mut hda_codec) {
...
// SPDIF setup
#[no_mangle]
unsafe extern "C" fn init_digital_coef(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn cs_parse_auto_config(codec: *mut hda_codec) -> c_int {
...
// keep the ADCs powered up when it's dynamically switchable
    ...
    let mut idx: c_int = spec.gen.dyn_adc_idx[i];
    if (done & (1 << idx))
    continue;
...
#[no_mangle]
unsafe extern "C" fn cs420x_probe(codec: *mut hda_codec) -> c_int {
...
// remap the fixup from codec SSID and apply it
    ...
    snd_hda_pick_fixup(codec, core::ptr::null_mut(), cs4208_mac_fixup_tbl, cs4208_fixups);
...
// disable the bogus Mic and SPDIF jack detections
    ...
    struct cs_spec *spec = codec.spec;
    let mut pin: hda_nid_t = spec.gen.autocfg.dig_out_pins[0];
    let mut pinctl: c_int = ucontrol.value.integer.value[0] ? PIN_OUT : 0;
...
#[no_mangle]
unsafe extern "C" fn cs4208_fix_amp_caps(codec: *mut hda_codec, adc: hda_nid_t) {
...
#[no_mangle]
unsafe extern "C" fn cs4208_probe(codec: *mut hda_codec) -> c_int {
