...
//! Source: sound/hda/controllers/acpi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hda_acpi_dev_disconnect(device: *mut snd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_acpi_dev_free(device: *mut snd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_acpi_init(hda: *mut hda_acpi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_acpi_create(hda: *mut hda_acpi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_acpi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_acpi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_acpi_resume(dev: *mut device) -> c_int {
