...
//! Source: sound/hda/controllers/tegra.c
#![no_std]
...
pub const HDA_BAR0: c_uint = 0x8000;
pub const HDA_CFG_CMD: c_uint = 0x1004;
pub const HDA_CFG_BAR0: c_uint = 0x1010;

pub const HDA_BAR0_INIT_PROGRAM: c_uint = 0xFFFFFFFF;

// IPFS
pub const HDA_IPFS_CONFIG: c_uint = 0x180;
pub const HDA_IPFS_EN_FPCI: c_uint = 0x1;
pub const HDA_IPFS_FPCI_BAR0: c_uint = 0x80;
pub const HDA_FPCI_BAR0_START: c_uint = 0x40;
pub const HDA_IPFS_INTR_MASK: c_uint = 0x188;

// FPCI
pub const FPCI_DBG_CFG_2: c_uint = 0x10F4;
pub const FPCI_GCAP_NSDO_SHIFT: c_int = 18;

// max number of SDs
pub const NUM_CAPTURE_SD: c_int = 1;
pub const NUM_PLAYBACK_SD: c_int = 1;
//
...
//
pub const TEGRA194_NUM_SDO_LINES: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct hda_tegra {
    ...
    let mut power_save: static int = CONFIG_SND_HDA_POWER_SAVE_DEFAULT;
    module_param(power_save, bint, 0644);
    MODULE_PARM_DESC(power_save,
    "Automatic power-saving timeout (in seconds, 0 = disable).");

pub const power_save: c_int = 0;
...
// disable controller wake up event
    ...
    RUNTIME_PM_OPS(hda_tegra_runtime_suspend, hda_tegra_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
...
unsafe extern "C" fn hda_tegra_first_init(chip: *mut azx, pdev: *mut platform_device) -> c_int {
    ...
    int err;
    unsigned short gcap;
    let mut irq_id: c_int = platform_get_irq(pdev, 0);
...
// shortname for card
    sname = of_get_property(np, "nvidia,model", core::ptr::null_mut());
    if (!sname)
    sname = drv_name;
...
//
    ...
    err = azx_bus_init(chip, core::ptr::null_mut());
    if (err < 0)
    return err;
