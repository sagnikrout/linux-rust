...
//! Source: sound/hda/common/bind.c
#![no_std]
...
// check probe_id instead of vendor_id if set
    let mut id: u32 = codec.probe_id ? codec.probe_id : codec.core.vendor_id;
    let mut rev_id: u32 = codec.core.revision_id;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_set_name(codec: *mut hda_codec, name: *const c_char) -> c_int {
...
// only register after the bus probe finished; otherwise it's racy
    ...
    codec.preset = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn codec_probed(codec: *mut hda_codec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn request_codec_module(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn codec_bind_module(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn is_likely_hdmi_codec(codec: *mut hda_codec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn codec_bind_generic(codec: *mut hda_codec) -> c_int {
...
pub const is_generic_config(codec): c_int = 0;
