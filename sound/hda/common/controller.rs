...
//! Source: sound/hda/common/controller.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn azx_release_device(azx_dev: *mut azx_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn azx_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn azx_pcm_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn azx_pcm_prepare(substream: *mut snd_pcm_substream) -> c_int {
    ...
    let mut ctls: c_ushort = spdif ? spdif.ctls : 0;
...
#[no_mangle]
unsafe extern "C" fn azx_pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn azx_get_pos_lpib(chip: *mut azx, azx_dev: *mut azx_dev) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn azx_get_pos_posbuf(chip: *mut azx, azx_dev: *mut azx_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn azx_pcm_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn azx_scale64(base: u64, num: u32, den: u32) -> u64 {
...
// device = ktime_add_ns(*device, (wallclk_cycles * NSEC_PER_SEC)
    ...
    substream, core::ptr::null_mut(), xtstamp);
    }
    ...
    {
    let mut xtstamp: system_device_crosststamp = { .clock_id = CLOCK_REALTIME };
    struct azx_dev *azx_dev = get_azx_dev(substream);
    struct snd_pcm_runtime *runtime = substream.runtime;
    int ret;
    u64 nsec;
...
#[no_mangle]
unsafe extern "C" fn azx_pcm_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn azx_pcm_free(pcm: *mut snd_pcm) {
    ...
    struct snd_pcm *pcm;
    struct azx_pcm *apcm;
    let mut pcm_dev: c_int = cpcm.device;
    unsigned int size;
    int s, err;
    let mut type: c_int = SNDRV_DMA_TYPE_DEV_SG;
...
#[no_mangle]
unsafe extern "C" fn azx_command_addr(cmd: u32) -> c_uint {
...
// receive a response
#[no_mangle]
unsafe extern "C" fn azx_single_wait_for_response(chip: *mut azx, addr: c_uint) -> c_int {
...
// send a command
#[no_mangle]
unsafe extern "C" fn azx_single_send_cmd(bus: *mut hdac_bus, val: u32) -> c_int {
    static int azx_single_send_cmd(struct hdac_bus *bus, u32 val)
    {
    struct azx *chip = bus_to_azx(bus);
    let mut addr: c_uint = azx_command_addr(val);
    let mut timeout: c_int = 50;
...
// send a command
#[no_mangle]
unsafe extern "C" fn azx_send_cmd(bus: *mut hdac_bus, val: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stream_update(bus: *mut hdac_bus, s: *mut hdac_stream) {
...
#[no_mangle]
pub unsafe extern "C" fn azx_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn probe_codec(chip: *mut azx, addr: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn azx_bus_init(chip: *mut azx, model: *const c_char) -> c_int {
...
// Probe codecs
#[no_mangle]
pub unsafe extern "C" fn azx_probe_codecs(chip: *mut azx, max_slots: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn azx_codec_configure(chip: *mut azx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn azx_add_stream(chip: *mut azx, azx_dev: *mut azx_dev, idx: c_int, tag: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn azx_init_streams(chip: *mut azx) -> c_int {
