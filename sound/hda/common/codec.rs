...
//! Source: sound/hda/common/codec.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_sequence_write(codec: *mut hda_codec, seq: *const hda_verb) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hda_conn_list {
    pub list: list_head,
    pub len: c_int,
    pub nid: hda_nid_t,
    pub __counted_by(len): hda_nid_t conns[],
}
...
#[no_mangle]
unsafe extern "C" fn remove_conn_list(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn read_and_add_raw_conns(codec: *mut hda_codec, nid: hda_nid_t) -> c_int {
...
//
    ...
    {
    const hda_nid_t *list;
    let mut len: c_int = snd_hda_get_conn_list(codec, nid, &list);
    if (len > 0 && conn_list) {
    if (len > max_conns) {
...
//
    ...
    recursive++;
    for (i = 0; i < nums; i++) {
    let mut type: c_uint = get_wcaps_type(get_wcaps(codec, conn[i]));
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_get_num_devices(codec: *mut hda_codec, nid: hda_nid_t) -> c_uint {
    unsigned int snd_hda_get_num_devices(struct hda_codec *codec, hda_nid_t nid)
    {
    let mut wcaps: c_uint = get_wcaps(codec, nid);
    int parm;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_get_dev_select(codec: *mut hda_codec, nid: hda_nid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_set_dev_select(codec: *mut hda_codec, nid: hda_nid_t, dev_id: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn read_widget_caps(codec: *mut hda_codec, fg_node: hda_nid_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_pin_defaults(codec: *mut hda_codec) -> c_int {
    ...
    let mut wcaps: c_uint = get_wcaps(codec, nid);
    let mut wid_type: c_uint = get_wcaps_type(wcaps);
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_get_pincfg(codec: *mut hda_codec, nid: hda_nid_t) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_get_pin_target(codec: *mut hda_codec, nid: hda_nid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_shutup_pins(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn restore_shutup_pins(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn hda_jackpoll_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn free_init_pincfgs(codec: *mut hda_codec) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hda_cvt_setup {
    pub nid: hda_nid_t,
    pub stream_tag: u8,
    pub channel_id: u8,
    pub format_id: u16,
    pub /: *mut *mut unsigned char active; / cvt is currently used,
    pub /: *mut *mut unsigned char dirty; / setups should be cleared,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_disconnect_pcms(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn codec_release_pcms(codec: *mut hda_codec) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_cleanup_for_unbind(codec: *mut hda_codec) {
...
// pm_runtime_put() is called in snd_hdac_device_exit()
    ...
    codec.proc_widget_hook = core::ptr::null_mut();
...
// free only driver_pins so that init_pins + user_pins are restored
    ...
    codec.follower_dig_outs = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_display_power(codec: *mut hda_codec, enable: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_register(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn snd_hda_codec_dev_register(device: *mut snd_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_unregister(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn snd_hda_codec_dev_free(device: *mut snd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_hda_codec_dev_release(dev: *mut device) {
...
pub const DEV_NAME_LEN: c_int = 31;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_update_widgets(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn purify_inactive_streams(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn hda_cleanup_all_streams(codec: *mut hda_codec) {
...
//
#[no_mangle]
pub unsafe extern "C" fn query_amp_caps(codec: *mut hda_codec, nid: hda_nid_t, direction: c_int) -> u32 {
...
//
    ...
    {
    let mut cmd: c_uint = snd_hdac_regmap_encode_amp(nid, ch, dir, idx);
...
//
    ...
    {
    let mut cmd: c_uint = encode_amp(codec, nid, ch, dir, idx);
...
//
    ...
    unsigned int ofs)
    {
    let mut caps: u32 = query_amp_caps(codec, nid, dir);
// get num steps
...
//
    ...
    let mut nid: u16 = get_amp_nid(kcontrol);
    let mut chs: u8 = get_amp_channels(kcontrol);
    let mut dir: c_int = get_amp_direction(kcontrol);
    let mut ofs: c_uint = get_amp_offset(kcontrol);
...
//
    ...
    let mut dir: c_int = get_amp_direction(kcontrol);
    let mut idx: c_int = get_amp_index(kcontrol);
    let mut ofs: c_uint = get_amp_offset(kcontrol);
...
#[no_mangle]
unsafe extern "C" fn get_ctl_amp_tlv(kcontrol: *mut snd_kcontrol, tlv: *mut c_uint) {
    ...
    let mut dir: c_int = get_amp_direction(kcontrol);
    let mut ofs: c_uint = get_amp_offset(kcontrol);
    let mut min_mute: bool = get_amp_min_mute(kcontrol);
    u32 caps, val1, val2;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_ctls_clear(codec: *mut hda_codec) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_lock_devices(bus: *mut hda_bus) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_unlock_devices(bus: *mut hda_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_reset(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn put_kctl_with_value(kctl: *mut snd_kcontrol, val: c_int) -> c_int {
...
// initialize the follower volume with 0dB via snd_ctl_apply_vmaster_followers()
    ...
    int _tlv[4];
    const int *tlv = core::ptr::null_mut();
    int step;
    int val;
...
//
    ...
    if (ctl_ret)
// ctl_ret = NULL;
    err = map_followers(codec, followers, suffix, check_follower_present, core::ptr::null_mut());
    if (err != 1) {
...
#[no_mangle]
unsafe extern "C" fn vmaster_hook(private_data: *mut c_void, enabled: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_sync_vmaster_hook(hook: *mut hda_vmaster_mute_hook) {
...
//
    ...
    {
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    let mut idx: c_int = kcontrol.private_value;
...
//
#[no_mangle]
unsafe extern "C" fn convert_from_spdif_status(sbits: c_uint) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn convert_to_spdif_status(val: c_ushort) -> c_uint {
    static unsigned int convert_to_spdif_status(unsigned short val)
    {
    let mut sbits: c_uint = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_spdif_ctls_unassign(codec: *mut hda_codec, idx: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_spdif_ctls_assign(codec: *mut hda_codec, idx: c_int, nid: hda_nid_t) {
...
//
    ...
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    struct hda_multi_out *mout = (void *)kcontrol.private_value;
    let mut val: bool = !!ucontrol.value.integer.value[0];
    int change;
    guard(mutex)(&codec.spdif_mutex);
...
//
    ...
    {
    struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
    let mut nid: hda_nid_t = kcontrol.private_value;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_create_spdif_in_ctls(codec: *mut hda_codec, nid: hda_nid_t) -> c_int {
...
//
    ...
    for_each_hda_codec_node(nid, codec) {
    let mut wcaps: c_uint = get_wcaps(codec, nid);
    let mut state: c_uint = power_state;
...
//
    ...
    {
    struct hda_codec_driver *driver = hda_codec_to_driver(codec);
    let mut fg: hda_nid_t = codec.core.afg ? codec.core.afg : codec.core.mfg;
    int count;
    unsigned int state;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: codec->depop_delay >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn sync_power_up_states(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn hda_exec_init_verbs(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn update_power_acct(codec: *mut hda_codec, on: bool) {
    static void update_power_acct(struct hda_codec *codec, bool on)
    {
    let mut delta: c_ulong = jiffies - codec.power_jiffies;
    if (on)
...
#[no_mangle]
pub unsafe extern "C" fn snd_hda_update_power_acct(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn hda_call_codec_suspend(codec: *mut hda_codec) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn hda_call_codec_resume(codec: *mut hda_codec) {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_runtime_idle(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_pm_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_pm_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_pm_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_pm_thaw(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hda_codec_pm_restore(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_shutdown(codec: *mut hda_codec) {
...
//
#[no_mangle]
unsafe extern "C" fn add_std_chmaps(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_build_controls(codec: *mut hda_codec) -> c_int {
...
// query support PCM information from the given NID
    ...
    info.rates ? core::ptr::null_mut() : &info.rates,
    info.formats ? core::ptr::null_mut() : &info.formats,
    info.subformats ? core::ptr::null_mut() : &info.subformats,
    info.maxbps ? core::ptr::null_mut() : &info.maxbps);
    if (err < 0)
    return err;
    }
    if (info.ops.open == core::ptr::null_mut())
    info.ops.open = hda_pcm_default_open_close;
    if (info.ops.close == core::ptr::null_mut())
    info.ops.close = hda_pcm_default_open_close;
    if (info.ops.prepare == core::ptr::null_mut()) {
    if (snd_BUG_ON(!info.nid))
    return -EINVAL;
    info.ops.prepare = hda_pcm_default_prepare;
    }
    if (info.ops.cleanup == core::ptr::null_mut()) {
    if (snd_BUG_ON(!info.nid))
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn get_empty_pcm_device(bus: *mut hda_bus, type: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_parse_pcms(codec: *mut hda_codec) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_build_pcms(codec: *mut hda_codec) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_codec_set_power_save(codec: *mut hda_codec, delay: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_set_power_save(bus: *mut hda_bus, delay: c_int) {
...
//
    if (WARN_ON(spdif == core::ptr::null_mut()))
    return;
...
#[no_mangle]
unsafe extern "C" fn cleanup_dig_out_stream(codec: *mut hda_codec, nid: hda_nid_t) {
...
//
    ...
    let mut notify_share_sw: bool = false;
...
//
    ...
    let mut chs: c_int = substream.runtime.channels;
    struct hda_spdif_out *spdif;
    int i;
    ...
    mout.dig_out_used != HDA_DIG_EXCLUSIVE) {
    if (chs == 2 && spdif != core::ptr::null_mut() &&
...
// extra surrounds
    ...
    ch = i * 2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mout->no_share_stream) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_get_default_vref(codec: *mut hda_codec, pin: hda_nid_t) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(AC_PINCAP_VREF_50: pincap &) -> else {
    else if (pincap & AC_PINCAP_VREF_50)
    return AC_PINCTL_VREF_50;
#[no_mangle]
pub unsafe extern "C" fn if(AC_PINCAP_VREF_100: pincap &) -> else {
    else if (pincap & AC_PINCAP_VREF_100)
    return AC_PINCTL_VREF_100;
#[no_mangle]
pub unsafe extern "C" fn if(AC_PINCAP_VREF_GRD: pincap &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(AC_PINCAP_HP_DRV): (val & AC_PINCTL_HP_EN) && !(cap &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_bus_reset_codecs(bus: *mut hda_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_print_pcm_bits(pcm: c_int, buf: *mut c_char, buflen: c_int) {
