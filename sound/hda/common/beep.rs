...
//! Source: sound/hda/common/beep.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn generate_tone(beep: *mut hda_beep, tone: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn beep_linear_tone(beep: *mut hda_beep, hz: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DIGBEEP_HZ_MIN): hz >= (DIGBEEP_HZ_MAX -) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn beep_standard_tone(beep: *mut hda_beep, hz: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn turn_on_beep(beep: *mut hda_beep) {
...
#[no_mangle]
unsafe extern "C" fn turn_off_beep(beep: *mut hda_beep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_enable_beep_device(codec: *mut hda_codec, enable: c_int) -> c_int {
...
unsafe extern "C" fn beep_dev_free(device: *mut snd_device) -> c_int {
    ...
    {
    struct hda_beep *beep = device.device_data;
    beep.codec.beep = core::ptr::null_mut();
    kfree(beep);
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hda_attach_beep_device(codec: *mut hda_codec, nid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ctl_has_mute(kcontrol: *mut snd_kcontrol) -> bool {
