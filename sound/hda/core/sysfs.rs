...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RO(_arg: type) -> static {
...
pub struct widget_attribute {
    ...
    pub buf): *mut *mut widget_attribute attr, char,
...
#[no_mangle]
unsafe extern "C" fn get_codec_nid(kobj: *mut kobject, codecp: *mut hdac_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn has_pcm_cap(codec: *mut hdac_device, nid: hda_nid_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn widget_tree_free(codec: *mut hdac_device) {
    ...
    kfree(tree);
    codec.widgets = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn widget_tree_create(codec: *mut hdac_device) -> c_int {
...
// call with codec->widget_lock held
    ...
    {
    struct hdac_widget_tree *tree;
    let mut end_nid: hda_nid_t = start_nid + num_nodes;
    hda_nid_t nid;
    int i;
    if (!codec.widgets)
    return 0;
