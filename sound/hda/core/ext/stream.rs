...
//! Source: sound/hda/core/ext/stream.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_ext_host_stream_setup(hext_stream: *mut hdac_ext_stream, code_loading: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_hdac_apl_host_stream_setup(hstream: *mut hdac_stream, code_loading: bool) -> c_int {
...
pub unsafe extern "C" fn snd_hdac_ext_stream_free_all(bus: *mut hdac_bus) {
    ...
    u32 val;
    let mut mask: c_int = AZX_PPCTL_PROCEN(hstream.index);
    val = readw(bus.ppcap + AZX_REG_PP_PPCTL) & mask;
    if (decouple && !val)
    snd_hdac_updatel(bus.ppcap, AZX_REG_PP_PPCTL, mask, mask);
#[no_mangle]
pub unsafe extern "C" fn if(val: !decouple &&) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_ext_stream_setup(hext_stream: *mut hdac_ext_stream, fmt: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_ext_stream_release(hext_stream: *mut hdac_ext_stream, type: c_int) {
...
// couple host only if not in use
    ...
    hext_stream.link_substream = core::ptr::null_mut();
    }
    break;
    default:
