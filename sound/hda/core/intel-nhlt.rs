...
//! Source: sound/hda/core/intel-nhlt.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn intel_nhlt_get_dmic_geo(dev: *mut device, nhlt: *mut nhlt_acpi_table) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_nhlt_has_endpoint_type(nhlt: *mut nhlt_acpi_table, link_type: u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_nhlt_ssp_endpoint_mask(nhlt: *mut nhlt_acpi_table, device_type: u8) -> c_int {
...
pub const SSP_BLOB_V1_0_SIZE: c_int = 84;

pub const SSP_BLOB_V1_5_SIZE: c_int = 96;

pub const SSP_BLOB_VER_1_5: c_uint = 0xEE000105;
pub const SSP_BLOB_V2_0_SIZE: c_int = 88;

pub const SSP_BLOB_VER_2_0: c_uint = 0xEE000200;
#[no_mangle]
pub unsafe extern "C" fn intel_nhlt_ssp_mclk_mask(nhlt: *mut nhlt_acpi_table, ssp_num: c_int) -> c_int {
