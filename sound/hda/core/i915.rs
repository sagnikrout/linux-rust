...
#[no_mangle]
unsafe extern "C" fn connectivity_check(i915: *mut pci_dev, hdac: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i915_gfx_present(hdac_pci: *mut pci_dev) -> c_int {
...
// LKF
    ...
    struct pci_dev *display_dev = core::ptr::null_mut();
...
pub unsafe extern "C" fn snd_hdac_i915_init(bus: *mut hdac_bus) -> c_int {
    ...
    return -ENODEV;
    err = snd_hdac_acomp_init(bus, core::ptr::null_mut(),
