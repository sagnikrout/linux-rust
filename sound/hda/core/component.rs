...
//! Source: sound/hda/core/component.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hdac_acomp_release(dev: *mut device, res: *mut c_void) {
    ...
    {
    return devres_find(dev, hdac_acomp_release, core::ptr::null_mut(), core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_set_codec_wakeup(bus: *mut hdac_bus, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_display_power(bus: *mut hdac_bus, idx: c_uint, enable: bool) {
    ...
    if (bus.display_power_active) {
    let mut cookie: c_ulong = bus.display_power_active;
...
//
    ...
    return 0;
    out_err:
    bus.audio_component = core::ptr::null_mut();
    devres_destroy(dev, hdac_acomp_release, core::ptr::null_mut(), core::ptr::null_mut());
