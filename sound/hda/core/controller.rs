...
//! Source: sound/hda/core/controller.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn azx_clear_corbrp(bus: *mut hdac_bus) {
...
#[no_mangle]
unsafe extern "C" fn hdac_wait_for_cmd_dmas(bus: *mut hdac_bus) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_hdac_bus_send_cmd_pio(bus: *mut hdac_bus, val: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_hdac_bus_send_cmd_corb(bus: *mut hdac_bus, val: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bus->rirb.cmds[addr]) -> else {
...
// res = bus->rirb.res[addr]; /* the last value
    ...
    break;
pub const LOOP_COUNT_MAX: c_int = 3000;
    if (!bus.polling_mode) {
...
pub const HDAC_MAX_CAPS: c_int = 10;
//
...
// reset codec link
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_bus_reset_link(bus: *mut hdac_bus, full_reset: bool) -> c_int {
...
// enable interrupts
#[no_mangle]
unsafe extern "C" fn azx_int_enable(bus: *mut hdac_bus) {
...
// disable interrupts
#[no_mangle]
unsafe extern "C" fn azx_int_disable(bus: *mut hdac_bus) {
...
// clear interrupts
#[no_mangle]
unsafe extern "C" fn azx_int_clear(bus: *mut hdac_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_bus_init_chip(bus: *mut hdac_bus, full_reset: bool) -> bool {
...
pub unsafe extern "C" fn snd_hdac_bus_alloc_stream_pages(bus: *mut hdac_bus) -> c_int {
    ...
    let mut dma_type: c_int = bus.dma_type ? bus.dma_type : SNDRV_DMA_TYPE_DEV;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_hdac_bus_link_power(codec: *mut hdac_device, enable: bool) {
