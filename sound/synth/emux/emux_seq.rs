...
//! Source: sound/synth/emux/emux_seq.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn snd_emux_inc_count(emu: *mut snd_emux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snd_emux_init_virmidi(emu: *mut snd_emux, card: *mut snd_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_emux_delete_virmidi(emu: *mut snd_emux) -> c_int {
