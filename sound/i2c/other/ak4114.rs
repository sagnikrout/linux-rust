...
//! Source: sound/i2c/other/ak4114.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const AK4114_ADDR: c_uint = 0x00 /* fixed address */;
    static void ak4114_stats(struct work_struct *work);
    static void ak4114_init_regs(struct ak4114 *chip);
#[no_mangle]
unsafe extern "C" fn reg_write(ak4114: *mut ak4114, reg: c_uchar, val: c_uchar) {
...
#[no_mangle]
pub unsafe extern "C" fn if(AK4114_REG_TXCSB4: reg >= AK4114_REG_TXCSB0 && reg <=) -> else {
    else if (reg >= AK4114_REG_TXCSB0 && reg <= AK4114_REG_TXCSB4)
    ak4114.txcsb[reg-AK4114_REG_TXCSB0] = val;
    }
#[no_mangle]
pub unsafe extern "C" fn reg_read(ak4114: *mut ak4114, reg: c_uchar) -> c_uchar {
    static inline unsigned char reg_read(struct ak4114 *ak4114, unsigned char reg)
    {
    return ak4114.read(ak4114.private_data, reg);
    }
#[no_mangle]
unsafe extern "C" fn snd_ak4114_free(chip: *mut ak4114) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ak4114_reg_write(chip: *mut ak4114, reg: c_uchar, mask: c_uchar, val: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn ak4114_init_regs(chip: *mut ak4114) {
    static void ak4114_init_regs(struct ak4114 *chip)
    {
    let mut old: c_uchar = chip.regmap[AK4114_REG_PWRDN], reg;
...
#[no_mangle]
unsafe extern "C" fn snd_ak4114_spdif_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4114_spdif_mask_info(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4114_spdif_pinfo(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4114_spdif_qinfo(kcontrol: *mut snd_kcontrol, uinfo: *mut snd_ctl_elem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4114_proc_init(ak4114: *mut ak4114) {
    ...
    if (ply_substream == core::ptr::null_mut()) {
    snd_ctl_free_one(kctl);
    ak4114.kctls[idx] = core::ptr::null_mut();
    continue;
    }
...
pub unsafe extern "C" fn snd_ak4114_check_rate_and_errors(ak4114: *mut ak4114, flags: c_uint) -> c_int {
    ...
    {
    struct snd_pcm_runtime *runtime = ak4114.capture_substream ? ak4114.capture_substream.runtime : core::ptr::null_mut();
