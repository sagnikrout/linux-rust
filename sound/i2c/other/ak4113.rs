...
//! Source: sound/i2c/other/ak4113.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const AK4113_ADDR: c_uint = 0x00 /* fixed address */;
...
#[no_mangle]
pub unsafe extern "C" fn reg_read(ak4113: *mut ak4113, reg: c_uchar) -> c_uchar {
    static inline unsigned char reg_read(struct ak4113 *ak4113, unsigned char reg)
    {
    return ak4113.read(ak4113.private_data, reg);
    }
#[no_mangle]
unsafe extern "C" fn snd_ak4113_free(chip: *mut ak4113) {
...
#[no_mangle]
unsafe extern "C" fn snd_ak4113_dev_free(device: *mut snd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ak4113_init_regs(chip: *mut ak4113) {
    static void ak4113_init_regs(struct ak4113 *chip)
    {
    let mut old: c_uchar = chip.regmap[AK4113_REG_PWRDN], reg;
...
#[no_mangle]
unsafe extern "C" fn snd_ak4113_proc_init(ak4113: *mut ak4113) {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ak4113_external_rate(ak4113: *mut ak4113) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snd_ak4113_check_rate_and_errors(ak4113: *mut ak4113, flags: c_uint) -> c_int {
    int snd_ak4113_check_rate_and_errors(struct ak4113 *ak4113, unsigned int flags)
    {
    struct snd_pcm_runtime *runtime =
    ak4113.substream ? ak4113.substream.runtime : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ak4113_stats(work: *mut work_struct) {
    static void ak4113_stats(struct work_struct *work)
    {
