...
pub const TEA6330T_SADDR_VOLUME_LEFT: c_uint = 0x00	/* volume left */;
pub const TEA6330T_SADDR_VOLUME_RIGHT: c_uint = 0x01	/* volume right */;
pub const TEA6330T_SADDR_BASS: c_uint = 0x02	/* bass control */;
pub const TEA6330T_SADDR_TREBLE: c_uint = 0x03	/* treble control */;
pub const TEA6330T_SADDR_FADER: c_uint = 0x04	/* fader control */;
pub const TEA6330T_MFN: c_uint = 0x20	/* mute control for selected channels */;
pub const TEA6330T_FCH: c_uint = 0x10	/* select fader channels - front or rear */;
pub const TEA6330T_SADDR_AUDIO_SWITCH: c_uint = 0x05	/* audio switch */;
pub const TEA6330T_GMU: c_uint = 0x80	/* mute control, general mute */;
pub const TEA6330T_EQN: c_uint = 0x40	/* equalizer switchover (0=equalizer-on) */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tea6330t {
    pub device: *mut snd_i2c_device,
    pub bus: *mut snd_i2c_bus,
    pub equalizer: c_int,
    pub fader: c_int,
    pub regs: [c_uchar; 8],
    pub mright: unsigned char mleft,,
    pub treble: unsigned char bass,,
    pub max_treble: unsigned char max_bass,,
}
