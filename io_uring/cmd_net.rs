...
#[no_mangle]
unsafe extern "C" fn io_uring_cmd_get_sock_ioctl(sock: *mut socket, op: c_int) -> c_int {
    ...
    let mut compat: bool = !!(issue_flags & IO_URING_F_COMPAT);
...
#[no_mangle]
pub unsafe extern "C" fn io_uring_cmd_sock(cmd: *mut io_uring_cmd, issue_flags: c_uint) -> c_int {
