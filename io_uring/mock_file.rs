...
#[no_mangle]
unsafe extern "C" fn io_copy_regbuf(reg_iter: *mut iov_iter, ubuf: *mut void __user) -> c_int {
    static int io_copy_regbuf(struct iov_iter *reg_iter, void __user *ubuf)
    {
    size_t ret, copied = 0;
    let mut buflen: usize = PAGE_SIZE;
    void *tmp_buf;
    tmp_buf = kzalloc(buflen, GFP_KERNEL);
    if (!tmp_buf)
    return -ENOMEM;
    while (iov_iter_count(reg_iter)) {
    let mut len: usize = min(iov_iter_count(reg_iter), buflen);
...
#[no_mangle]
unsafe extern "C" fn io_cmd_copy_regbuf(cmd: *mut io_uring_cmd, issue_flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_mock_cmd(cmd: *mut io_uring_cmd, issue_flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_mock_rw_timer_expired(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn io_mock_delay_rw(iocb: *mut kiocb, len: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn io_mock_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn io_mock_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn io_mock_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn io_mock_poll(file: *mut file, pt: *mut poll_table_struct) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn io_mock_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_create_mock_file(cmd: *mut io_uring_cmd, issue_flags: c_uint) -> c_int {
    ...
    struct file *file;
    struct io_mock_file *mf __free(kfree) = core::ptr::null_mut();
    size_t uarg_size;
//
...
//
    ...
    O_RDWR | O_CLOEXEC, core::ptr::null_mut()));
    if (fdf.err)
    return fdf.err;
...
#[no_mangle]
unsafe extern "C" fn io_probe_mock(cmd: *mut io_uring_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iou_mock_mgr_cmd(cmd: *mut io_uring_cmd, issue_flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_mock_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn io_mock_exit() -> void __exit {
