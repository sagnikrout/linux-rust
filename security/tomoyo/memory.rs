...
//! Source: security/tomoyo/memory.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn tomoyo_warn_oom(function: *const c_char) {
    void tomoyo_warn_oom(const char *function)
    {
// Reduce error messages.
    static pid_t tomoyo_last_pid;
    let mut pid: pid_t = current.pid;
...
//
#[no_mangle]
pub unsafe extern "C" fn tomoyo_memory_ok(ptr: *mut c_void) -> bool {
    bool tomoyo_memory_ok(void *ptr)
    {
    if (ptr) {
    let mut s: usize = ksize(ptr);
...
//
    ...
    const u8 idx)
    {
    let mut e: tomoyo_group = { };
    struct tomoyo_group *group = core::ptr::null_mut();
    ...
    return found ? group : core::ptr::null_mut();
    }
//
...
//
    ...
    return core::ptr::null_mut();
    len = strlen(name) + 1;
    hash = full_name_hash(core::ptr::null_mut(), (const unsigned char *) name, len - 1);
    ...
    out:
    mutex_unlock(&tomoyo_policy_lock);
    return ptr ? &ptr.entry : core::ptr::null_mut();
    }
// Initial namespace.
...
//
#[no_mangle]
pub unsafe extern "C" fn tomoyo_mm_init() -> void __init {
