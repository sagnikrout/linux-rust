...
#[no_mangle]
unsafe extern "C" fn dh_data_from_key(keyid: key_serial_t, data: *const c_void) -> isize {
...
#[no_mangle]
unsafe extern "C" fn dh_free_data(dh: *mut dh) {
...
#[no_mangle]
unsafe extern "C" fn kdf_alloc(hash: *mut crypto_shash, hashname: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kdf_dealloc(hash: *mut crypto_shash) {
    ...
    {
    let mut kbuf_iov: kvec = { .iov_base = kbuf, .iov_len = kbuflen };
    uint8_t *outbuf = core::ptr::null_mut();
    int ret;
    let mut outbuf_len: usize = roundup(buflen, crypto_shash_digestsize(hash));
    ...
    uint8_t *secret;
    uint8_t *outbuf;
    struct crypto_shash *hash = core::ptr::null_mut();
