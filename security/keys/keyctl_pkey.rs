...
//! Source: security/keys/keyctl_pkey.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn keyctl_pkey_params_free(params: *mut kernel_pkey_params) {
...
//
#[no_mangle]
unsafe extern "C" fn keyctl_pkey_params_parse(params: *mut kernel_pkey_params) -> c_int {
