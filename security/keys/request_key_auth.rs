...
//! Source: security/keys/request_key_auth.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn request_key_auth_preparse(prep: *mut key_preparsed_payload) -> c_int {
    static int request_key_auth_preparse(struct key_preparsed_payload *prep)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn request_key_auth_free_preparse(prep: *mut key_preparsed_payload) {
...
#[no_mangle]
unsafe extern "C" fn free_request_key_auth(rka: *mut request_key_auth) {
...
//
    ...
    struct key *authkey = core::ptr::null_mut();
    char desc[20];
...
// allocate the auth key
    ...
    KEY_USR_VIEW, KEY_ALLOC_NOT_IN_QUOTA, core::ptr::null_mut());
    if (IS_ERR(authkey)) {
    ret = PTR_ERR(authkey);
    goto error_free_rka;
    }
// construct the auth key
    ret = key_instantiate_and_link(authkey, rka, 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret < 0)
