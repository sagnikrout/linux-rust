...
//! Source: security/keys/persistent.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn key_create_persistent_register(ns: *mut user_namespace) -> c_int {
...
//
    ...
    let mut err: c_long = key_create_persistent_register(ns);
    if (err < 0)
    return ERR_PTR(err);
    } else {
