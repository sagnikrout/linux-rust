...
//! Source: security/keys/trusted-keys/trusted_pkwm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn getoptions(datablob: *mut c_char, opt: *mut trusted_key_options) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn trusted_pkwm_seal(p: *mut trusted_key_payload, datablob: *mut c_char) -> c_int {
    ...
    struct trusted_pkwm_options *pkwm = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn trusted_pkwm_unseal(p: *mut trusted_key_payload, datablob: *mut c_char) -> c_int {
