...
//! Source: security/keys/trusted-keys/trusted_tpm1.c
#![no_std]
...
pub const TPM_SIZE_OFFSET: c_int = 2;
pub const TPM_RETURN_OFFSET: c_int = 6;
pub const TPM_DATA_OFFSET: c_int = 10;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct osapsess {
    pub handle: u32,
    pub secret: [c_uchar; SHA1_DIGEST_SIZE],
    pub enonce: [c_uchar; TPM_NONCE_SIZE],
}
...
#[no_mangle]
pub unsafe extern "C" fn dump_options(o: *mut trusted_key_options) {
...
#[no_mangle]
pub unsafe extern "C" fn dump_sess(s: *mut osapsess) {
...
#[no_mangle]
pub unsafe extern "C" fn dump_tpm_buf(buf: *mut c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn trusted_tpm_send(buf: *mut tpm_buf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcrlock(pcrnum: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oiap(tb: *mut tpm_buf, handle: *mut u32, nonce: *mut c_uchar) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpm_digests {
    pub encauth: [c_uchar; SHA1_DIGEST_SIZE],
    pub pubauth: [c_uchar; SHA1_DIGEST_SIZE],
    pub 2]: *mut *mut unsigned char xorwork[SHA1_DIGEST_SIZE,
    pub xorhash: [c_uchar; SHA1_DIGEST_SIZE],
    pub nonceodd: [c_uchar; TPM_NONCE_SIZE],
}
...
//
    ...
    let mut authhandle1: u32 = 0;
    let mut authhandle2: u32 = 0;
    let mut cont: c_uchar = 0;
    uint32_t ordinal;
    int ret;
...
//
    ...
    pay.migratable = 0;
#[no_mangle]
pub unsafe extern "C" fn if('1': *mut *mut args[0].from !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn trusted_tpm_seal(p: *mut trusted_key_payload, datablob: *mut c_char) -> c_int {
    static int trusted_tpm_seal(struct trusted_key_payload *p, char *datablob)
    {
    struct trusted_key_options *options = core::ptr::null_mut();
    let mut ret: c_int = 0;
    int tpm2;
    tpm2 = tpm_is_tpm2(chip);
    if (tpm2 < 0)
...
#[no_mangle]
unsafe extern "C" fn trusted_tpm_unseal(p: *mut trusted_key_payload, datablob: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn trusted_tpm_get_random(key: *mut c_uchar, key_len: usize) -> c_int {
    static int trusted_tpm_get_random(unsigned char *key, size_t key_len)
    {
    return tpm_get_random(chip, key, key_len);
    }
#[no_mangle]
unsafe extern "C" fn init_digests() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn trusted_tpm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn trusted_tpm_exit() {
