...
//! Source: security/commoncap_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn test_vfsuid_root_in_currentns_init_ns(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_vfsuid_root_in_currentns_invalid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_vfsuid_root_in_currentns_nonzero(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_kuid_root_in_ns_init_ns_uid0(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_kuid_root_in_ns_init_ns_nonzero(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_kuid_root_in_ns_with_mapping(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_kuid_root_in_ns_with_different_mappings(test: *mut kunit) {
