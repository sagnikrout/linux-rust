...
//! Source: security/smack/smackfs.c
#![no_std]
...
//
    let mut smack_ptrace_rule: c_int = SMACK_PTRACE_DEFAULT;
//
...
pub struct smack_parsed_rule {
    ...
    let mut smk_cipso_doi_value: static u32 = CIPSO_V4_DOI_UNKNOWN;
//
...
//
pub const SMK_DIGITLEN: c_int = 4;
...
//
#[no_mangle]
pub unsafe extern "C" fn smack_catset_bit(cat: c_uint, catsetp: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn smk_netlabel_audit_set(nap: *mut netlbl_audit) {
...
// "1.2.3.4 X"
//
pub const SMK_NETLBLADDRMIN: c_int = 9;
//
...
//
#[no_mangle]
unsafe extern "C" fn smk_perm_from_str(string: *const c_char) -> c_int {
...
//
    ...
    data + SMK_LABELLEN + SMK_LABELLEN, core::ptr::null_mut(), rule,
    import, SMK_LABELLEN);
    return rc;
    }
//
...
//
    ...
    if (rule_list == core::ptr::null_mut())
...
//
    ...
    ++*pos;
    list = rcu_dereference(list_next_rcu(list));
    return (list == head) ? core::ptr::null_mut() : list;
    }
#[no_mangle]
unsafe extern "C" fn smk_seq_stop(s: *mut seq_file, v: *mut c_void) {
    static void smk_seq_stop(struct seq_file *s, void *v)
    {
    rcu_read_unlock();
    }
#[no_mangle]
unsafe extern "C" fn smk_rule_show(s: *mut seq_file, srp: *mut smack_rule, max: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_load(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    return -EPERM;
    return smk_write_rules_list(file, buf, count, ppos, core::ptr::null_mut(), core::ptr::null_mut(),
    SMK_FIXED24_FMT);
    }
...
//
    ...
    doip.map.std = core::ptr::null_mut();
    doip.doi = ndoi;
    ...
    rc = netlbl_cfg_map_del(core::ptr::null_mut(), PF_INET, core::ptr::null_mut(), core::ptr::null_mut(), &nai);
    if (rc && rc != -ENOENT)
    goto clr_ndoi_def;
    netlbl_cfg_cipsov4_del(smk_cipso_doi_value, &nai);
    }
    rc = netlbl_cfg_cipsov4_map_add(ndoi, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), &nai);
    if (rc) {
...
//
#[no_mangle]
unsafe extern "C" fn smk_unlbl_ambient(oldambient: *mut c_char) {
    static void smk_unlbl_ambient(char *oldambient)
    {
    int rc;
    struct netlbl_audit nai;
    smk_netlabel_audit_set(&nai);
    if (oldambient != core::ptr::null_mut()) {
    rc = netlbl_cfg_map_del(oldambient, PF_INET, core::ptr::null_mut(), core::ptr::null_mut(), &nai);
    if (rc != 0)
    printk(KERN_WARNING "%s:%d remove rc = %d\n",
    __func__, __LINE__, rc);
    }
    if (smack_net_ambient == core::ptr::null_mut())
    smack_net_ambient = &smack_known_floor;
    rc = netlbl_cfg_unlbl_map_add(smack_net_ambient.smk_known, PF_INET,
    core::ptr::null_mut(), core::ptr::null_mut(), &nai);
    if (rc != 0)
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_cipso(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_cipso2(inode: *mut inode, file: *mut file) -> c_int {
...
unsafe extern "C" fn net4addr_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    if (skp.smk_label != core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_net4addr(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_net4addr_insert(new: *mut smk_net4addr) {
...
//
    ...
    rc = netlbl_cfg_unlbl_static_del(&init_net, core::ptr::null_mut(),
...
//
    if (rc == 0 && skp != core::ptr::null_mut())
    rc = netlbl_cfg_unlbl_static_add(&init_net, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn net6addr_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_net6addr(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_net6addr_insert(new: *mut smk_net6addr) {
...
#[no_mangle]
unsafe extern "C" fn smk_open_onlycap(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_parse_label_list(data: *mut c_char, list: *mut list_head) -> c_int {
    static int smk_parse_label_list(char *data, struct list_head *list)
    {
    char *tok;
    struct smack_known *skp;
    struct smack_known_list_elem *sklep;
    while ((tok = strsep(&data, " ")) != core::ptr::null_mut()) {
    if (!*tok)
    continue;
...
//
#[no_mangle]
pub unsafe extern "C" fn smk_destroy_label_list(list: *mut list_head) {
...
//
    ...
    if (*ppos != 0)
    return 0;
    if (smack_unconfined != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ERR(skp)) -> else {
    rc = PTR_ERR(skp);
    goto freeout;
    }
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_load_self(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    rule.smk_access1, core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn if(-ENOENT: res !=) -> else {
    else if (res != -ENOENT)
    return res;
//
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_load2(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_load_self2(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_init_sysfs() -> c_int {
...
//
    ...
    if (*ppos != 0)
    return 0;
    if (smack_syslog_label == core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn smk_open_relabel_self(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_smk_fs() -> int __init {
    ...
    smackfs_mount = core::ptr::null_mut();
    }
    }
    smk_netlabel_audit_set(&nai);
    (void) netlbl_cfg_map_del(core::ptr::null_mut(), PF_INET, core::ptr::null_mut(), core::ptr::null_mut(), &nai);
    (void) smk_cipso_doi(SMACK_CIPSO_DOI_DEFAULT,
    GFP_KERNEL | __GFP_NOFAIL);
    smk_unlbl_ambient(core::ptr::null_mut());
