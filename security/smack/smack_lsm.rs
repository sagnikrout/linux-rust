...
//! Source: security/smack/smack_lsm.c
#![no_std]
...
pub const TRANS_TRUE_SIZE: c_int = 4;
pub const SMK_CONNECTING: c_int = 0;
pub const SMK_RECEIVING: c_int = 1;
pub const SMK_SENDING: c_int = 2;
//
...
//
pub const SMACK_INODE_INIT_XATTRS: c_int = 2;
...
unsafe extern "C" fn match_opt_prefix(s: *mut c_char, l: c_int, arg: *mut c_char) -> c_int {
    ...
    let mut len: usize = smk_mount_opts[i].len;
...
#[no_mangle]
unsafe extern "C" fn smk_bu_mode(mode: c_int, s: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn smk_bu_task(otp: *mut task_struct, mode: c_int, rc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smk_bu_inode(inode: *mut inode, mode: c_int, rc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smk_bu_file(file: *mut file, mode: c_int, rc: c_int) -> c_int {
...
//
    ...
    int rc;
    char *buffer;
    struct smack_known *skp = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn init_inode_smack(inode: *mut inode, skp: *mut smack_known) {
...
//
#[no_mangle]
pub unsafe extern "C" fn smk_ptrace_mode(mode: c_uint) -> c_uint {
...
//
    ...
    {
    int rc;
    struct smk_audit_info ad, *saip = core::ptr::null_mut();
    ...
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(SMACK_PTRACE_DRACONIAN: smack_ptrace_rule ==) -> else {
    else if (smack_ptrace_rule == SMACK_PTRACE_DRACONIAN)
    rc = -EACCES;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: smack_privileged_cred(CAP_SYS_PTRACE, _arg: tracercred)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn smack_ptrace_access_check(ctp: *mut task_struct, mode: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_ptrace_traceme(ptp: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_syslog(typefrom_file: c_int) -> c_int {
    ...
    return 0;
    if (smack_syslog_label != core::ptr::null_mut() && smack_syslog_label != skp)
    rc = -EACCES;
    return rc;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn smack_sb_alloc_security(sb: *mut super_block) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smack_mnt_opts {
    pub fsdefault: *const c_char,
    pub fsfloor: *const c_char,
    pub fshat: *const c_char,
    pub fsroot: *const c_char,
    pub fstransmute: *const c_char,
}

#[no_mangle]
unsafe extern "C" fn smack_free_mnt_opts(mnt_opts: *mut c_void) {
    static void smack_free_mnt_opts(void *mnt_opts)
    {
    kfree(mnt_opts);
    }
#[no_mangle]
unsafe extern "C" fn smack_add_opt(token: c_int, s: *const c_char, mnt_opts: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smack_sb_eat_lsm_opts(options: *mut c_char, mnt_opts: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_sb_statfs(dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_bprm_creds_for_exec(bprm: *mut linux_binprm) -> c_int {
    ...
    int rc;
    isp = smack_inode(inode);
    if (isp.smk_task == core::ptr::null_mut() || isp.smk_task == bsp.smk_task)
    return 0;
    ...
    if (likely(tracer != core::ptr::null_mut()))
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_alloc_security(inode: *mut inode) -> c_int {
...
//
    ...
    {
    let mut xattr: *mut xattr  const = lsm_get_xattr_slot(xattrs, xattr_count);
    if (!xattr)
    return 0;
...
//
    ...
    {
    struct task_smack *tsp = smack_cred(current_cred());
    let mut issp: *mut inode_smack  const = smack_inode(inode);
    struct smack_known *dsp = smk_of_inode(dir);
    let mut rc: c_int = 0;
    let mut transflag: c_int = 0;
    bool trans_cred;
    bool trans_rule;
//
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_permission(inode: *mut inode, mask: c_int) -> c_int {
    static int smack_inode_permission(struct inode *inode, int mask)
    {
    struct superblock_smack *sbsp = smack_superblock(inode.i_sb);
    struct smk_audit_info ad;
    let mut no_block: c_int = mask & MAY_NOT_BLOCK;
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_getattr(path: *const path) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_xattr_skipcap(name: *const c_char) -> c_int {
...
//
    ...
    struct smk_audit_info ad;
    struct smack_known *skp;
    let mut check_priv: c_int = 0;
    let mut check_import: c_int = 0;
    let mut check_star: c_int = 0;
    let mut rc: c_int = 0;
    let mut i_mode: umode_t const = d_backing_inode(dentry).i_mode;
//
...
//
    ...
    skp = size ? smk_import_entry(value, size) : core::ptr::null_mut();
    if (IS_ERR(skp))
    rc = PTR_ERR(skp);
    else if (skp == core::ptr::null_mut() || (check_star &&
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_getxattr(dentry: *mut dentry, name: *const c_char) -> c_int {
...
//
    ...
    isp.smk_task = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(name, 0: XATTR_NAME_SMACKMMAP) ==) -> else {
    else if (strcmp(name, XATTR_NAME_SMACKMMAP) == 0)
    isp.smk_mmap = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(name, 0: XATTR_NAME_SMACKTRANSMUTE) ==) -> else {
    else if (strcmp(name, XATTR_NAME_SMACKTRANSMUTE) == 0)
    isp.smk_flags &= ~SMK_INODE_TRANSMUTE;
    return 0;
    }
...
//
    ...
    return -EOPNOTSUPP;
    sock = SOCKET_I(ip);
    if (sock == core::ptr::null_mut() || sock.sk == core::ptr::null_mut())
    return -EOPNOTSUPP;
    ssp = smack_sock(sock.sk);
    if (strcmp(name, XATTR_SMACK_IPIN) == 0)
    isp = ssp.smk_in;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(name, 0: XATTR_SMACK_IPOUT) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_getlsmprop(inode: *mut inode, prop: *mut lsm_prop) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_file_alloc_security(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_file_lock(file: *mut file, cmd: c_uint) -> c_int {
...
//
    ...
    if (isp.smk_mmap == core::ptr::null_mut())
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn smack_file_set_fowner(file: *mut file) {
...
// we don't log here as rc can be overridden
    ...
    skp = *blob;
    rc = smk_access(skp, tkp, MAY_DELIVER, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn smack_file_receive(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_file_open(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_cred_alloc_blank(cred: *mut cred, gfp: gfp_t) -> c_int {
    static int smack_cred_alloc_blank(struct cred *cred, gfp_t gfp)
    {
    init_task_smack(smack_cred(cred), core::ptr::null_mut(), core::ptr::null_mut());
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn smack_cred_free(cred: *mut cred) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_cred_transfer(new: *mut cred, old: *const cred) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_cred_getsecid(cred: *const cred, secid: *mut u32) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_kernel_act_as(new: *mut cred, secid: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_setpgid(p: *mut task_struct, pgid: pid_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_getpgid(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_getsid(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_current_getlsmprop_subj(prop: *mut lsm_prop) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_setnice(p: *mut task_struct, nice: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_setioprio(p: *mut task_struct, ioprio: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_getioprio(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_setscheduler(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_getscheduler(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_movememory(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_task_to_inode(p: *mut task_struct, inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_sk_alloc_security(sk: *mut sock, family: c_int, gfp_flags: gfp_t) -> c_int {
...
//
    ...
    ssp.smk_packet = core::ptr::null_mut();
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn smack_sk_free_security(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_sk_clone_security(sk: *const sock, newsk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn smk_ipv6_localhost(sip: *mut sockaddr_in6) -> bool {
...
//
    if (snp.smk_label == core::ptr::null_mut())
    continue;
//
// we break after finding the first match because
// the list is sorted from longest to shortest mask
...
//
#[no_mangle]
unsafe extern "C" fn smack_netlbl_add(sk: *mut sock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_netlbl_delete(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn smk_ipv4_check(sk: *mut sock, sap: *mut sockaddr_in) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_ipv6_port_label(sock: *mut socket, address: *mut sockaddr) {
...
//
    if (skp != core::ptr::null_mut() && object != core::ptr::null_mut())
    return smk_ipv6_check(skp, object, address, act);
    if (skp == core::ptr::null_mut())
...
//
    ...
    struct socket *sock;
    let mut rc: c_int = 0;
    if (value == core::ptr::null_mut() || size > SMK_LONGLABEL || size == 0)
    return -EINVAL;
...
pub unsafe extern "C" fn if(_arg: strcmp(name, 0: XATTR_SMACK_IPOUT) ==) -> else {
    ...
    smk_ipv6_port_label(sock, core::ptr::null_mut());
...
//
    ...
    int addrlen)
    {
    if (sock.sk != core::ptr::null_mut() && sock.sk.sk_family == PF_INET6) {
...
//
    ...
    struct smack_known *rsp = core::ptr::null_mut();
    if (addrlen < SIN6_LEN_RFC2133)
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn smack_flags_to_may(flags: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_msg_msg_alloc_security(msg: *mut msg_msg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_ipc_alloc_security(isp: *mut kern_ipc_perm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_curacc_shm(isp: *mut kern_ipc_perm, access: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_shm_associate(isp: *mut kern_ipc_perm, shmflg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_shm_shmctl(isp: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smk_curacc_sem(isp: *mut kern_ipc_perm, access: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_sem_associate(isp: *mut kern_ipc_perm, semflg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_sem_semctl(isp: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
//
    ...
    {
    let mut tsk_is_current: bool = (tsk == current);
    const struct cred * const tsk_cred =
    (tsk_is_current ? current_cred() : get_task_cred(tsk));
    let mut tsp: *mut task_smack  const = smack_cred(tsk_cred);
...
//
#[no_mangle]
unsafe extern "C" fn smk_curacc_msq(isp: *mut kern_ipc_perm, access: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_msg_queue_associate(isp: *mut kern_ipc_perm, msqflg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_msg_queue_msgctl(isp: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_ipc_permission(ipp: *mut kern_ipc_perm, flag: c_short) -> c_int {
    static int smack_ipc_permission(struct kern_ipc_perm *ipp, short flag)
    {
    struct smack_known **blob = smack_ipc(ipp);
    struct smack_known *iskp = *blob;
    let mut may: c_int = smack_flags_to_may(flag);
    struct smk_audit_info ad;
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn smack_ipc_getlsmprop(ipp: *mut kern_ipc_perm, prop: *mut lsm_prop) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_d_instantiate(opt_dentry: *mut dentry, inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_getprocattr(p: *mut task_struct, name: *const c_char, value: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn do_setattr(attr: c_uint, value: *mut c_void, size: usize) -> c_int {
...
//
    if (value == core::ptr::null_mut() || size == 0 || size >= SMK_LONGLABEL)
    return -EINVAL;
...
//
    if (label_len == 1 /* '@', '*' */) {
    let mut c: c_char = *(const char *)value;
...
//
#[no_mangle]
unsafe extern "C" fn smack_setprocattr(name: *const c_char, value: *mut c_void, size: usize) -> c_int {
    static int smack_setprocattr(const char *name, void *value, size_t size)
    {
    let mut realsize: usize = size;
...
//
#[no_mangle]
unsafe extern "C" fn smack_unix_may_send(sock: *mut socket, other: *mut socket) -> c_int {
...
//
    ...
    if (found)
    return skp;
    if (ssp != core::ptr::null_mut() && ssp.smk_in == &smack_known_star)
...
#[no_mangle]
unsafe extern "C" fn smk_skb_to_addr_ipv6(skb: *mut sk_buff, sip: *mut sockaddr_in6) -> c_int {
    static int smk_skb_to_addr_ipv6(struct sk_buff *skb, struct sockaddr_in6 *sip)
    {
    u8 nexthdr;
    int offset;
    let mut proto: c_int = -EINVAL;
...
//
    ...
    {
    if (skb == core::ptr::null_mut() || skb.secmark == 0)
    return core::ptr::null_mut();
...
//
    ...
    struct socket_smack *ssp = core::ptr::null_mut();
    struct smack_known *skp = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn smack_socket_sock_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
    ...
    ipv4_skb_to_auditdata(skb, &ad.a, core::ptr::null_mut());
...
//
    ...
    ad.a.u.net.family = family;
    ad.a.u.net.netif = skb.skb_iif;
    ipv6_skb_to_auditdata(skb, &ad.a, core::ptr::null_mut());
...
//
    ...
    let mut rc: c_int = 0;
    ssp = smack_sock(sock.sk);
    if (ssp.smk_packet != core::ptr::null_mut()) {
...
//
    ...
    let mut family: c_int = PF_UNSPEC;
...
pub unsafe extern "C" fn if(htons(ETH_P_IPV6): skb->protocol ==) -> else {
    ...
    if (family == PF_UNSPEC && sock != core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn smack_key_getsecurity(key: *mut key, _buffer: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_watch_key(key: *mut key) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_audit_rule_known(krule: *mut audit_krule) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_ismaclabel(name: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_to_secctx(skp: *mut smack_known, cp: *mut lsm_context) -> c_int {
    static int smack_to_secctx(struct smack_known *skp, struct lsm_context *cp)
    {
    let mut len: c_int = strlen(skp.smk_known);
    if (cp) {
...
//
#[no_mangle]
unsafe extern "C" fn smack_secid_to_secctx(secid: u32, cp: *mut lsm_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_secctx_to_secid(secdata: *const c_char, seclen: u32, secid: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_inode_notifysecctx(inode: *mut inode, ctx: *mut c_void, ctxlen: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smack_inode_setsecctx(dentry: *mut dentry, ctx: *mut c_void, ctxlen: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smack_inode_getsecctx(inode: *mut inode, cp: *mut lsm_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smack_inode_copy_up(dentry: *mut dentry, new: *mut cred) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smack_inode_copy_up_xattr(src: *mut dentry, name: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_uring_override_creds(new: *const cred) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_uring_sqpoll() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smack_uring_cmd(ioucmd: *mut io_uring_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_smack_known_list() -> __init void {
...
//
#[no_mangle]
unsafe extern "C" fn smack_init() -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn smack_initcall() -> int __init {
    int __init smack_initcall(void)
    {
    let mut rc_fs: c_int = init_smk_fs();
    let mut rc_nf: c_int = smack_nf_ip_init();
