...
//! Source: security/apparmor/task.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_replace_current_label(label: *mut aa_label) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_set_current_hat(label: *mut aa_label, token: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_restore_previous_label(token: u64) -> c_int {
...
//
    ...
    {
    struct aa_profile *profile;
    let mut xrequest: u32 = request << PTRACE_PERM_SHIFT;
    ...
    p = exe_file.f_path;
    path_get(&p);
    if (aa_path_name(&p, FLAG_VIEW_SUBNS, buffer, &path_str, core::ptr::null_mut(), core::ptr::null_mut()))
