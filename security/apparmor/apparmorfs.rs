...
//! Source: security/apparmor/apparmorfs.c
#![no_std]
...
//
pub const IREF_POISON: c_int = 101;
//
// support fns
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rawdata_f_data {
    pub loaddata: *mut aa_loaddata,
    pub data): DECLARE_FLEX_ARRAY(char,,
}
...
//
#[no_mangle]
unsafe extern "C" fn mangle_name(name: *const c_char, target: *mut c_char) -> c_int {
...
// (t)++ = '.';
#[no_mangle]
pub unsafe extern "C" fn if(_arg: *mut isspace(name)) -> else {
    else if (isspace(*name))
// (t)++ = '_';
#[no_mangle]
pub unsafe extern "C" fn if(strchr("._-": *mut *mut isalnum(name) ||, _arg: *mut name)) -> else {
...
#[no_mangle]
unsafe extern "C" fn aa_put_common_ref(ref: *mut aa_common_ref) {
...
#[no_mangle]
unsafe extern "C" fn aa_get_common_ref(ref: *mut aa_common_ref) {
...
#[no_mangle]
unsafe extern "C" fn apparmorfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apparmorfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apparmorfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
    ...
    const struct file_operations *fops)
    {
    return aafs_create(name, mode, parent, data, core::ptr::null_mut(), fops, core::ptr::null_mut());
    }
//
...
//
    ...
    {
    return aafs_create(name, S_IFDIR | 0755, parent, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn aafs_remove(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn decompress_zstd(src: *mut c_char, slen: usize, dst: *mut c_char, dlen: usize) -> c_int {
    static int decompress_zstd(char *src, size_t slen, char *dst, size_t dlen)
    {
    if (slen < dlen) {
    let mut wksp_len: usize = zstd_dctx_workspace_bound();
    zstd_dctx *ctx;
    void *wksp;
    size_t out_len;
    let mut ret: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aa_user_hdr {
    pub version: u8,
    pub compress_level: u8,
    pub /: *mut *mut uint8_t padding[6]; / force 8-byte alignment,
    pub __aligned(8): } __packed,

pub const aa_hdr_magic_size: c_int = 12;
    static ssize_t policy_update(u32 mask, const char __user *buf, size_t size,
    loff_t *pos, struct aa_ns *ns,
    const struct cred *ocred)
    {
    pub data: *mut aa_loaddata,
    pub label: *mut aa_label,
    pub error: isize,
    pub NULL: *mut *mut char compressed_data =,
    pub magic_le: __le32,
    pub is_compressed: bool,
    pub aahdr: [u8; aa_hdr_magic_size],
    pub needput: bool,
    pub begin_current_label_crit_section(&needput): label =,
// high level check about policy management - fine grained in
// below after unpack
//
    pub mask): error = aa_may_manage_policy(current_cred(), label, ns, ocred,,
    if (error)
    pub end_section: goto,
...
// skip the userspace header if present
    pub aa_user_hdr): buf += sizeof(struct,
    pub aa_user_hdr): size -= sizeof(struct,
...
// uncompressed blob with user hdr
    pub aa_user_hdr): buf += sizeof(struct,
    pub aa_user_hdr): size -= sizeof(struct,
    pub false: is_compressed =,
    } else {
    pub false: is_compressed =,
    }
    if (is_compressed) {
    pub &compressed_data): data = aa_get_data_from_compressed(buf, size, pos,,
    pub PTR_ERR(data): error =,
    } else {
    pub pos): data = aa_simple_write_to_buffer(buf, size, size,,
    pub PTR_ERR(data): error =,
    }
    if (!IS_ERR(data)) {
    error = aa_replace_profiles(ns, label, mask, data,
    pub size): compressed_data,,
// put pcount, which will put count and free if no
// profiles referencing it.
//
    }
    end_section:
    pub needput): end_current_label_crit_section(label,,
    pub error: return,
    }
// .load file hook fn to load policy
    ...
    loff_t *pos)
    {
    pub get_ns_common_ref(f->f_inode->i_private): *mut *mut aa_ns ns =,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aa_revision {
    pub ns: *mut aa_ns,
    pub last_read: c_long,
}

// revision file hook fn for policy loads
#[no_mangle]
unsafe extern "C" fn ns_revision_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn multi_transaction_kref(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn multi_transaction_release(inode: *mut inode, file: *mut file) -> c_int {
...
pub const QUERY_CMD_LABEL_LEN: c_int = 6;

pub const QUERY_CMD_PROFILE_LEN: c_int = 8;

pub const QUERY_CMD_LABELALL_LEN: c_int = 9;

pub const QUERY_CMD_DATA_LEN: c_int = 5;
//
...
#[no_mangle]
unsafe extern "C" fn aa_sfs_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
    ...
    let mut error: c_int = single_open(file, show, proxy);
    if (error) {
...
#[no_mangle]
unsafe extern "C" fn seq_profile_name_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_profile_mode_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_profile_attach_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: profile->attach.xmatch->dfa) -> else {
...
#[no_mangle]
unsafe extern "C" fn seq_profile_hash_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ns_stacked_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ns_nsstacked_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ns_level_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ns_name_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ns_compress_min_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_ns_compress_max_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_rawdata_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_rawdata_abi_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_rawdata_revision_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_rawdata_hash_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_rawdata_compressed_size_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rawdata_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rawdata_open(inode: *mut inode, file: *mut file) -> c_int {
    static int rawdata_open(struct inode *inode, struct file *file)
    {
    int error;
    struct aa_loaddata *loaddata;
    struct rawdata_f_data *private;
    if (!aa_current_policy_view_capable(core::ptr::null_mut()))
    return -EACCES;
...
unsafe extern "C" fn remove_rawdata_dents(rawdata: *mut aa_loaddata) {
    ...
    rawdata.dents[i] = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
...
pub unsafe extern "C" fn __aafs_profile_rmdir(profile: *mut aa_profile) {
    ...
    profile.dents[i] = core::ptr::null_mut();
    }
    }
//
...
#[no_mangle]
unsafe extern "C" fn profile_depth(profile: *mut aa_profile) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __aa_remove_rawdata_symlink_dents(profile: *mut aa_profile) {
    void __aa_remove_rawdata_symlink_dents(struct aa_profile *profile)
    {
    aafs_remove(profile.dents[AAFS_PROF_RAW_HASH]);
    profile.dents[AAFS_PROF_RAW_HASH] = core::ptr::null_mut();
    aafs_remove(profile.dents[AAFS_PROF_RAW_ABI]);
    profile.dents[AAFS_PROF_RAW_ABI] = core::ptr::null_mut();
    aafs_remove(profile.dents[AAFS_PROF_RAW_DATA]);
    profile.dents[AAFS_PROF_RAW_DATA] = core::ptr::null_mut();
    }
    ...
    const struct inode_operations *iops)
    {
    struct dentry *dent = core::ptr::null_mut();
    struct dentry *dir = prof_dir(profile);
    if (profile.dents[type])
    return 0;
    dent = aafs_create(name, S_IFLNK | 0444, dir,
    &profile.label.proxy.count, core::ptr::null_mut(), core::ptr::null_mut(), iops);
    if (IS_ERR(dent))
    return PTR_ERR(dent);
...
//
#[no_mangle]
pub unsafe extern "C" fn __aa_create_rawdata_symlink_dents(profile: *mut aa_profile) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __aafs_profile_mkdir(profile: *mut aa_profile, parent: *mut dentry) -> c_int {
    int __aafs_profile_mkdir(struct aa_profile *profile, struct dentry *parent)
    {
    struct aa_profile *child;
    struct dentry *dent = core::ptr::null_mut(), *dir;
    int error;
    AA_BUG(!profile);
...
// adding to parent that previously didn't have children
    ...
    if (!profile.dirname) {
    int len, id_len;
    len = mangle_name(profile.base.name, core::ptr::null_mut());
    id_len = snprintf(core::ptr::null_mut(), 0, ".%ld", profile.ns.uniq_id);
...
// TODO: improve permission check
    ...
    bool needput;
    label = begin_current_label_crit_section(&needput);
    error = aa_may_manage_policy(current_cred(), label, core::ptr::null_mut(), core::ptr::null_mut(),
    AA_MAY_LOAD_POLICY);
    end_current_label_crit_section(label, needput);
    if (error)
    return ERR_PTR(error);
...
//
    ...
    if (error)
    goto out;
    error = __aafs_setup_d_inode(dir, dentry, mode | S_IFDIR,  core::ptr::null_mut(),
    ...
    aa_put_ns(parent);
    return error ? ERR_PTR(error) : core::ptr::null_mut();
    }
#[no_mangle]
...
// use create_dentry so we can supply private data
    ...
    &ns.unconfined.label.count,
    core::ptr::null_mut(), core::ptr::null_mut(), &ns_dir_inode_operations);
    if (IS_ERR(dent))
    return PTR_ERR(dent);
...
// subnamespaces
    list_for_each_entry(sub, &ns.sub_ns, base.list) {
    mutex_lock_nested(&sub.lock, sub.level);
    error = __aafs_ns_mkdir(sub, ns_subns_dir(ns), core::ptr::null_mut(), core::ptr::null_mut());
    mutex_unlock(&sub.lock);
    if (error)
    goto fail2;
    }
...
#[no_mangle]
unsafe extern "C" fn profiles_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn profiles_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    fs_file.dentry = core::ptr::null_mut();
    }
    return error;
    }
...
//
#[no_mangle]
unsafe extern "C" fn entry_remove_file(fs_file: *mut aa_sfs_entry) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn entry_remove_dir(fs_dir: *mut aa_sfs_entry) -> void __init {
    static void __init entry_remove_dir(struct aa_sfs_entry *fs_dir)
    {
    struct aa_sfs_entry *fs_file;
    for (fs_file = fs_dir.v.files; fs_file && fs_file.name; ++fs_file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_destroy_aafs() -> void __init {
...
unsafe extern "C" fn aa_mk_null_file(parent: *mut dentry) -> c_int {
    ...
    {
    struct vfsmount *mount = core::ptr::null_mut();
    struct dentry *dentry;
    struct inode *inode;
    let mut count: c_int = 0;
    let mut error: c_int = simple_pin_fs(parent.d_sb.s_type, &mount, &count);
    if (error)
    return error;
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_create_aafs() -> int __init {
...
// magic symlink similar to nsfs redirects based on task policy
    ...
    core::ptr::null_mut(), &policy_link_iops);
    if (IS_ERR(dent))
    goto dent_error;
