...
//! Source: security/apparmor/mount.c
#![no_std]
...
//
    ...
    NAME.subj_cred = (CRED)
#[no_mangle]
unsafe extern "C" fn audit_mnt_flags(ab: *mut audit_buffer, flags: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn path_flags(profile: *const aa_profile, path: *const path) -> c_int {
...
//
    ...
    const char *mntpnt = core::ptr::null_mut();
...
//
    ...
    {
    const char *devname = core::ptr::null_mut(), *info = core::ptr::null_mut();
    struct aa_ruleset *rules = profile.label.rules[0];
    ...
    match_mnt(profile, path, buffer, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    ...
    {
    struct aa_profile *profile;
    char *buffer = core::ptr::null_mut(), *old_buffer = core::ptr::null_mut();
    ...
    old_buffer, core::ptr::null_mut(), flags, core::ptr::null_mut(), false, &ad));
    out:
    aa_put_buffer(buffer);
...
// These are the flags allowed by do_change_type()
    ...
    error = fn_for_each(label, profile,
    match_mnt(profile, path, buffer, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    flags, core::ptr::null_mut(), false, &ad));
    aa_put_buffer(buffer);
    return error;
    }
    ...
    {
    struct aa_profile *profile;
    char *to_buffer = core::ptr::null_mut(), *from_buffer = core::ptr::null_mut();
    int error;
    DEFINE_AUDIT_MOUNT(ad, OP_MOUNT, subj_cred);
...
// moving a mount detached from the namespace
    from_path = core::ptr::null_mut();
    error = fn_for_each(label, profile,
    match_mnt(profile, to_path, to_buffer, from_path,
    from_buffer, core::ptr::null_mut(), MS_MOVE, core::ptr::null_mut(), false,
    &ad));
    out:
    ...
    {
    struct aa_profile *profile;
    char *buffer = core::ptr::null_mut(), *dev_buffer = core::ptr::null_mut();
    let mut binary: bool = true;
    int error;
    let mut requires_dev: c_int = 0;
    struct path tmp_path, *dev_path = core::ptr::null_mut();
    DEFINE_AUDIT_MOUNT(ad, OP_MOUNT, subj_cred);
    ad.mnt.flags = flags;
    AA_BUG(!label);
    AA_BUG(!path);
...
//
    ...
    {
    struct aa_ruleset *rules = profile.label.rules[0];
    const char *old_name, *new_name = core::ptr::null_mut();
    let mut perms: aa_perms = { };
    aa_state_t state;
    int error;
    AA_BUG(!profile);
...
// todo: allow pivotroot to specify a transition other than profile
    ...
    {
    struct aa_profile *profile;
    struct aa_label *target = core::ptr::null_mut();
    char *old_buffer = core::ptr::null_mut(), *new_buffer = core::ptr::null_mut();
    int error;
