...
//! Source: security/apparmor/policy_unpack.c
#![no_std]
...
//
    ...
    DEFINE_AUDIT_DATA(ad, LSM_AUDIT_DATA_NONE, AA_CLASS_NONE, core::ptr::null_mut());
    if (e)
...
#[no_mangle]
unsafe extern "C" fn do_loaddata_free(d: *mut aa_loaddata) {
...
#[no_mangle]
pub unsafe extern "C" fn aa_inbounds(e: *mut aa_ext, size: usize) -> VISIBLE_IF_KUNIT bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_u16_chunk(e: *mut aa_ext, chunk: *mut c_char) -> VISIBLE_IF_KUNIT size_t {
...
// unpack control byte
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_X(e: *mut aa_ext, code: enum aa_code) -> VISIBLE_IF_KUNIT bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_nameX(e: *mut aa_ext, code: enum aa_code, name: *const c_char) -> VISIBLE_IF_KUNIT bool {
...
//
    ...
    char *tag = core::ptr::null_mut();
    let mut size: usize = aa_unpack_u16_chunk(e, &tag);
...
#[no_mangle]
unsafe extern "C" fn unpack_u8(e: *mut aa_ext, data: *mut u8, name: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_u32(e: *mut aa_ext, data: *mut u32, name: *const c_char) -> VISIBLE_IF_KUNIT bool {
...
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_u64(e: *mut aa_ext, data: *mut u64, name: *const c_char) -> VISIBLE_IF_KUNIT bool {
...
#[no_mangle]
unsafe extern "C" fn aa_unpack_cap_low(e: *mut aa_ext, data: *mut kernel_cap_t, name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aa_unpack_cap_high(e: *mut aa_ext, data: *mut kernel_cap_t, name: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_array(e: *mut aa_ext, name: *const c_char, size: *mut u16) -> VISIBLE_IF_KUNIT bool {
...
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_blob(e: *mut aa_ext, blob: *mut c_char, name: *const c_char) -> VISIBLE_IF_KUNIT size_t {
...
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_str(e: *mut aa_ext, string: *const c_char, name: *const c_char) -> VISIBLE_IF_KUNIT int {
...
#[no_mangle]
pub unsafe extern "C" fn aa_unpack_strdup(e: *mut aa_ext, string: *mut c_char, name: *const c_char) -> VISIBLE_IF_KUNIT int {
    VISIBLE_IF_KUNIT int aa_unpack_strdup(struct aa_ext *e, char **string, const char *name)
    {
    const char *tmp;
    void *pos = e.pos;
    let mut res: c_int = aa_unpack_str(e, &tmp, name);
// string = NULL;
    if (!res)
    return 0;
...
//
    ...
    size_t size;
    struct aa_dfa *dfa = core::ptr::null_mut();
...
//
    ...
    ((e.pos - e.start) & 7);
    let mut pad: usize = ALIGN(sz, 8) - sz;
...
#[no_mangle]
unsafe extern "C" fn process_strs_entry(str: *mut c_char, size: c_int, multi: bool) -> c_int {
...
//
    ...
    struct aa_str_table_ent *table = core::ptr::null_mut();
    let mut error: c_int = -EPROTO;
// exec table is optional
    if (aa_unpack_nameX(e, AA_STRUCT, name)) {
    u16 size;
    int i;
    if (!aa_unpack_array(e, core::ptr::null_mut(), &size))
//
...
//
    ...
    for (i = 0; i < size; i++) {
    char *str;
    int c, size2 = aa_unpack_strdup(e, &str, core::ptr::null_mut());
...
// fail - all other cases with embedded \0
    ...
    if (!aa_unpack_nameX(e, AA_ARRAYEND, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_nameX(e, AA_STRUCTEND, core::ptr::null_mut()))
    goto fail;
    }
    return 0;
    fail:
...
#[no_mangle]
unsafe extern "C" fn unpack_xattrs(e: *mut aa_ext, profile: *mut aa_profile) -> bool {
    ...
    goto fail;
    for (i = 0; i < size; i++) {
    if (!aa_unpack_strdup(e, &profile.attach.xattrs[i], core::ptr::null_mut()))
    goto fail;
    }
    if (!aa_unpack_nameX(e, AA_ARRAYEND, core::ptr::null_mut()))
    goto fail;
...
#[no_mangle]
unsafe extern "C" fn unpack_secmark(e: *mut aa_ext, rules: *mut aa_ruleset) -> bool {
    ...
    for (i = 0; i < size; i++) {
    if (!unpack_u8(e, &rules.secmark[i].audit, core::ptr::null_mut()))
    goto fail;
    if (!unpack_u8(e, &rules.secmark[i].deny, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_strdup(e, &rules.secmark[i].label, core::ptr::null_mut()))
    goto fail;
    }
    if (!aa_unpack_nameX(e, AA_ARRAYEND, core::ptr::null_mut()))
    goto fail;
    ...
    rules.secmark = core::ptr::null_mut();
    }
    e.pos = pos;
    return false;
    }
#[no_mangle]
unsafe extern "C" fn unpack_rlimits(e: *mut aa_ext, rules: *mut aa_ruleset) -> bool {
...
// rlimits are optional
    ...
    int i;
    let mut tmp: u32 = 0;
    if (!aa_unpack_u32(e, &tmp, core::ptr::null_mut()))
    goto fail;
    ...
    for (i = 0; i < size; i++) {
    let mut tmp2: u64 = 0;
    let mut a: c_int = aa_map_resource(i);
    if (!aa_unpack_u64(e, &tmp2, core::ptr::null_mut()))
    goto fail;
...
#[no_mangle]
unsafe extern "C" fn verify_tags(tags: *mut aa_tags_struct, info: *const c_char) -> bool {
...
// count followed by count indexes into hdrs
    let mut cnt: u32 = tags.sets.table[i];
...
// info = "failed verification tagsets idx out of bounds";
    ...
    let mut idx: u32 = tags.hdrs.table[i].tags;
...
#[no_mangle]
unsafe extern "C" fn unpack_tagsets(e: *mut aa_ext, tags: *mut aa_tags_struct) -> c_int {
    ...
    for (i = 0; i < size; i++) {
    if (!aa_unpack_u32(e, &sets[i], core::ptr::null_mut()))
    goto fail;
    }
    if (!aa_unpack_nameX(e, AA_ARRAYEND, core::ptr::null_mut()))
    goto fail;
...
#[no_mangle]
unsafe extern "C" fn unpack_tag_header_ent(e: *mut aa_ext, h: *mut aa_tags_header) -> bool {
    static bool unpack_tag_header_ent(struct aa_ext *e, struct aa_tags_header *h)
    {
    return aa_unpack_u32(e, &h.mask, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &h.count, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &h.size, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &h.tags, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn unpack_tag_headers(e: *mut aa_ext, tags: *mut aa_tags_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unpack_perm(e: *mut aa_ext, version: u32, perm: *mut aa_perms) -> bool {
...
// reserved entry is for later expansion, discard for now
    return	aa_unpack_u32(e, &reserved, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.allow, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.deny, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.subtree, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.cond, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.kill, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.complain, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.prompt, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.audit, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.quiet, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.hide, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.xindex, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.tag, core::ptr::null_mut()) &&
    aa_unpack_u32(e, &perm.label, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn unpack_perms_table(e: *mut aa_ext, perms: *mut aa_perms) -> isize {
...
// default start state for xmatch and file dfa
    ...
    let mut state_count: usize = pdb.dfa.tables[YYTD_ID_BASE].td_lolen;
...
// add dfa flags table missing in v2
    let mut noents: u32 = pdb.dfa.tables[YYTD_ID_ACCEPT].td_lolen;
    let mut tdflags: u16 = pdb.dfa.tables[YYTD_ID_ACCEPT].td_flags;
    let mut tsize: usize = table_size(noents, tdflags);
...
#[no_mangle]
unsafe extern "C" fn strhash(data: *const c_void, len: u32, seed: u32) -> u32 {
...
//
    ...
    struct aa_profile *profile = core::ptr::null_mut();
    const char *tmpname, *tmpns = core::ptr::null_mut(), *name = core::ptr::null_mut();
    const char *info = "failed to unpack profile";
    size_t ns_len;
    let mut params: rhashtable_params = { 0 };
    char *key = core::ptr::null_mut(), *disconnected = core::ptr::null_mut();
    struct aa_data *data;
    let mut error: c_int = -EPROTO;
    kernel_cap_t tmpcap;
    u32 tmp;
...
// check that we have the right struct being passed
    ...
    goto fail;
    if (!aa_unpack_str(e, &name, core::ptr::null_mut()))
    goto fail;
    if (*name == '\0')
    goto fail;
...
// ns_name = kstrndup(tmpns, ns_len, GFP_KERNEL);
    ...
    profile = aa_alloc_profile(name, core::ptr::null_mut(), GFP_KERNEL);
    if (!profile) {
    info = "out of memory";
    error = -ENOMEM;
    goto fail;
...
// set a default value if path_flags field is not present
    ...
    if (!aa_unpack_cap_low(e, &rules.caps.allow, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_cap_low(e, &rules.caps.audit, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_cap_low(e, &rules.caps.quiet, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_cap_low(e, &tmpcap, core::ptr::null_mut()))
    goto fail;
    info = "failed to unpack upper profile capabilities";
    if (aa_unpack_nameX(e, AA_STRUCT, "caps64")) {
// optional upper half of 64 bit caps
    if (!aa_unpack_cap_high(e, &rules.caps.allow, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_cap_high(e, &rules.caps.audit, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_cap_high(e, &rules.caps.quiet, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_cap_high(e, &tmpcap, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_nameX(e, AA_STRUCTEND, core::ptr::null_mut()))
    goto fail;
    }
...
// optional extended caps mediation mask
    if (!aa_unpack_cap_low(e, &rules.caps.extended, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_cap_high(e, &rules.caps.extended, core::ptr::null_mut()))
    goto fail;
    if (!aa_unpack_nameX(e, AA_STRUCTEND, core::ptr::null_mut()))
    goto fail;
    }
...
// get file rules
    ...
    while (aa_unpack_strdup(e, &key, core::ptr::null_mut())) {
    ...
    data.key = key;
    data.size = aa_unpack_blob(e, &data.data, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !name) -> else {
    else if (!name)
    name = "unknown";
    audit_iface(profile, core::ptr::null_mut(), name, info, e, error);
...
//
#[no_mangle]
unsafe extern "C" fn verify_header(e: *mut aa_ext, required: c_int, ns: *const c_char) -> c_int {
    static int verify_header(struct aa_ext *e, int required, const char **ns)
    {
    let mut error: c_int = -EPROTONOSUPPORT;
    const char *name = core::ptr::null_mut();
// get the interface version
    if (!aa_unpack_u32(e, &e.version, "version")) {
    if (required) {
    audit_iface(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), "invalid profile format",
    e, error);
    return error;
    }
    }
...
//
    ...
    audit_iface(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), "unsupported interface version",
    e, error);
    return error;
    }
// read the namespace if present
    ...
    if (*name == '\0') {
    audit_iface(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), "invalid namespace name",
    e, error);
    return error;
    }
    if (*ns && strcmp(*ns, name)) {
    audit_iface(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), "invalid ns change", e,
    error);
    return error;
    } else if (!*ns) {
...
//
#[no_mangle]
unsafe extern "C" fn verify_dfa_accept_index(dfa: *const aa_dfa, table_size: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn verify_perm(perm: *const aa_perms) -> bool {
...
#[no_mangle]
unsafe extern "C" fn verify_perms(pdb: *mut aa_policydb) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn verify_profile(profile: *mut aa_profile) -> c_int {
    ...
    rules.file.size)) {
    audit_iface(profile, core::ptr::null_mut(), core::ptr::null_mut(),
    "Unpack: file Invalid named transition", core::ptr::null_mut(),
    -EPROTO);
    return -EPROTO;
    }
    if (rules.policy.dfa &&
    ...
    audit_iface(profile, core::ptr::null_mut(), core::ptr::null_mut(),
    "Unpack: policy Invalid named transition", core::ptr::null_mut(),
    -EPROTO);
    return -EPROTO;
    }
    if (!verify_perms(rules.file)) {
    audit_iface(profile, core::ptr::null_mut(), core::ptr::null_mut(),
    "Unpack: Invalid perm index", core::ptr::null_mut(), -EPROTO);
    return -EPROTO;
    }
...
#[no_mangle]
unsafe extern "C" fn compress_zstd(src: *const c_char, slen: usize, dst: *mut c_char, dlen: *mut usize) -> c_int {
    ...
    let mut wksp_len: usize = zstd_cctx_workspace_bound(&params.cParams);
    void *wksp = core::ptr::null_mut();
    zstd_cctx *ctx = core::ptr::null_mut();
    let mut out_len: usize = zstd_compress_bound(slen);
    void *out = core::ptr::null_mut();
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn compress_loaddata(data: *mut aa_loaddata) -> c_int {
...
//
    ...
    struct aa_profile *profile = core::ptr::null_mut();
    char *ns_name = core::ptr::null_mut();
...
// Do we have userspace-compressed data?
    ...
    compressed_data = core::ptr::null_mut(); /* consumed */
    } else
    ...
    compressed_data = core::ptr::null_mut();
    }
    return 0;
    fail_profile:
    kfree(ns_name);
