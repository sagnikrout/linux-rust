...
//! Source: security/apparmor/capability.c
#![no_std]
...
// Capabilities go from 0 to CAP_LAST_CAP
    pub ktime_ns_expiration: [u64; CAP_LAST_CAP+1],
}
...
#[no_mangle]
pub unsafe extern "C" fn aa_profile_capget(profile: *const aa_profile) -> kernel_cap_t {
    ...
    if (state) {
    let mut caps: kernel_cap_t = CAP_EMPTY_SET;
    int i;
