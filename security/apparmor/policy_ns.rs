...
//! Source: security/apparmor/policy_ns.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_ns_visible(curr: *mut aa_ns, view: *mut aa_ns, subns: bool) -> bool {
...
//
    ...
    profile = aa_alloc_null(core::ptr::null_mut(), name, GFP_KERNEL);
    if (!profile)
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_free_ns(ns: *mut aa_ns) {
    ...
    aa_put_ns(ns.parent);
    ns.unconfined.ns = core::ptr::null_mut();
...
// released by caller
    ns = aa_get_ns(__aa_find_ns(&parent.sub_ns, name));
    if (!ns)
    ns = __aa_create_ns(parent, name, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn destroy_ns(ns: *mut aa_ns) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __aa_remove_ns(ns: *mut aa_ns) {
...
//
#[no_mangle]
unsafe extern "C" fn __ns_list_release(head: *mut list_head) {
    static void __ns_list_release(struct list_head *head)
    {
    struct aa_ns *ns, *tmp;
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_alloc_root_ns() -> int __init {
    int __init aa_alloc_root_ns(void)
    {
    struct aa_profile *kernel_p;
// released by aa_free_root_ns - used as list ref
    root_ns = alloc_ns(core::ptr::null_mut(), "root");
    if (!root_ns)
    return -ENOMEM;
...
//
#[no_mangle]
pub unsafe extern "C" fn aa_free_root_ns() -> void __init {
    void __init aa_free_root_ns(void)
    {
    struct aa_ns *ns = root_ns;
    root_ns = core::ptr::null_mut();
