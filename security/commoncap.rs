...
//
#[no_mangle]
unsafe extern "C" fn warn_setuid_and_fcaps_mixed(fname: *const c_char) {
...
//
    ...
    let mut ret: c_int = cap_capable_helper(cred, target_ns, cred_ns, cap);
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_settime(ts: *const timespec64, tz: *const timezone) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_ptrace_access_check(child: *mut task_struct, mode: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_ptrace_traceme(parent: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_inh_is_capped() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_inode_need_killpriv(dentry: *mut dentry) -> c_int {
    int cap_inode_need_killpriv(struct dentry *dentry)
    {
    struct inode *inode = d_backing_inode(dentry);
    int error;
    error = __vfs_getxattr(dentry, inode, XATTR_NAME_CAPS, core::ptr::null_mut(), 0);
    return error > 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_inode_killpriv(idmap: *mut mnt_idmap, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kuid_root_in_ns(kuid: kuid_t, ns: *mut user_namespace) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfsuid_root_in_currentns(vfsuid: vfsuid_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sansflags(m: __u32) -> __u32 {
    static __u32 sansflags(__u32 m)
    {
    return m & ~VFS_CAP_FLAGS_EFFECTIVE;
    }
#[no_mangle]
unsafe extern "C" fn is_v2header(size: c_int, cap: *const vfs_cap_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_v3header(size: c_int, cap: *const vfs_cap_data) -> bool {
...
//
    ...
    char *tmpbuf = core::ptr::null_mut();
    struct vfs_cap_data *cap;
    struct vfs_ns_cap_data *nscap = core::ptr::null_mut();
...
//
    ...
    let mut rootid: uid_t = 0;
    if (size == XATTR_CAPS_SZ_3)
    rootid = le32_to_cpu(nscap.rootid);
    return VFSUIDT_INIT(make_kuid(task_ns, rootid));
    }
#[no_mangle]
unsafe extern "C" fn validheader(size: usize, cap: *const vfs_cap_data) -> bool {
...
//
    ...
    bprm.filename);
#[no_mangle]
pub unsafe extern "C" fn if(-ENODATA: rc ==) -> else {
    else if (rc == -ENODATA)
    rc = 0;
    goto out;
    }
...
#[no_mangle]
pub unsafe extern "C" fn __is_real(uid: kuid_t, cred: *mut cred) -> bool {
    static inline bool __is_real(kuid_t uid, struct cred *cred)
    { return uid_eq(cred.uid, uid); }
#[no_mangle]
pub unsafe extern "C" fn __is_eff(uid: kuid_t, cred: *mut cred) -> bool {
    static inline bool __is_eff(kuid_t uid, struct cred *cred)
    { return uid_eq(cred.euid, uid); }
#[no_mangle]
pub unsafe extern "C" fn __is_suid(uid: kuid_t, cred: *mut cred) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_bprm_creds_from_file(bprm: *mut linux_binprm, file: *const file) -> c_int {
    int cap_bprm_creds_from_file(struct linux_binprm *bprm, const struct file *file)
    {
// Process setpcap binaries and capabilities for uid 0
    const struct cred *old = current_cred();
    struct cred *new = bprm.cred;
    let mut effective: bool = false, has_fcap = false, id_changed;
    int ret;
    kuid_t root_uid;
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_emulate_setxuid(new: *mut cred, old: *const cred) {
    static inline void cap_emulate_setxuid(struct cred *new, const struct cred *old)
    {
    let mut root_uid: kuid_t = make_kuid(old.user_ns, 0);
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_task_fix_setuid(new: *mut cred, old: *const cred, flags: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cap_safe_nice(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_task_setscheduler(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_task_setioprio(p: *mut task_struct, ioprio: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_task_setnice(p: *mut task_struct, nice: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cap_prctl_drop(cap: c_ulong) -> c_int {
...
//
    ...
    let mut changed: c_ulong = old.securebits ^ arg2;
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_vm_enough_memory(mm: *mut mm_struct, pages: c_long) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cap_mmap_addr(addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn capability_init() -> int __init {
