...
//
#[no_mangle]
unsafe extern "C" fn lsm_file_alloc(file: *mut file) -> c_int {
    static int lsm_file_alloc(struct file *file)
    {
    if (!lsm_file_cache) {
    file.f_security = core::ptr::null_mut();
    return 0;
    }
    file.f_security = kmem_cache_zalloc(lsm_file_cache, GFP_KERNEL);
    if (file.f_security == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn lsm_backing_file_alloc(backing_file: *mut file) -> c_int {
    static int lsm_backing_file_alloc(struct file *backing_file)
    {
    void *blob;
    if (!lsm_backing_file_cache) {
    backing_file_set_security(backing_file, core::ptr::null_mut());
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn lsm_blob_alloc(dest: *mut c_void, size: usize, gfp: gfp_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lsm_cred_alloc(cred: *mut cred, gfp: gfp_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_inode_alloc(inode: *mut inode, gfp: gfp_t) -> c_int {
    static int lsm_inode_alloc(struct inode *inode, gfp_t gfp)
    {
    if (!lsm_inode_cache) {
    inode.i_security = core::ptr::null_mut();
    return 0;
    }
    inode.i_security = kmem_cache_zalloc(lsm_inode_cache, gfp);
    if (inode.i_security == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn lsm_task_alloc(task: *mut task_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_ipc_alloc(kip: *mut kern_ipc_perm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_key_alloc(key: *mut key) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_msg_msg_alloc(mp: *mut msg_msg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_bdev_alloc(bdev: *mut block_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_bpf_map_alloc(map: *mut bpf_map) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_bpf_prog_alloc(prog: *mut bpf_prog) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_bpf_token_alloc(token: *mut bpf_token) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_superblock_alloc(sb: *mut super_block) -> c_int {
...
//
    ...
    u64 id, u64 flags)
    {
    struct lsm_ctx *nctx = core::ptr::null_mut();
    size_t nctx_len;
    let mut rc: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_binder_set_context_mgr(mgr: *const cred) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ptrace_access_check(child: *mut task_struct, mode: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ptrace_traceme(parent: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_quotactl(cmds: c_int, type: c_int, id: c_int, sb: *const super_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_quota_on(dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_syslog(type: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_settime64(ts: *const timespec64, tz: *const timezone) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_vm_enough_memory_mm(mm: *mut mm_struct, pages: c_long) -> c_int {
    int security_vm_enough_memory_mm(struct mm_struct *mm, long pages)
    {
    struct lsm_static_call *scall;
    let mut cap_sys_admin: c_int = 1;
    int rc;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bprm_creds_for_exec(bprm: *mut linux_binprm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bprm_creds_from_file(bprm: *mut linux_binprm, file: *const file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bprm_check(bprm: *mut linux_binprm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bprm_committing_creds(bprm: *const linux_binprm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bprm_committed_creds(bprm: *const linux_binprm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_fs_context_submount(fc: *mut fs_context, reference: *mut super_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_fs_context_dup(fc: *mut fs_context, src_fc: *mut fs_context) -> c_int {
...
//
    ...
    struct lsm_static_call *scall;
    int trc;
    let mut rc: c_int = -ENOPARAM;
    lsm_for_each_hook(scall, fs_context_parse_param) {
    trc = scall.hl.hook.fs_context_parse_param(fc, param);
    if (trc == 0)
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(-ENOPARAM: trc !=) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_alloc(sb: *mut super_block) -> c_int {
    int security_sb_alloc(struct super_block *sb)
    {
    let mut rc: c_int = lsm_superblock_alloc(sb);
    if (unlikely(rc))
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_delete(sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_free(sb: *mut super_block) {
    void security_sb_free(struct super_block *sb)
    {
    call_void_hook(sb_free_security, sb);
    kfree(sb.s_security);
    sb.s_security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_free_mnt_opts(mnt_opts: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_eat_lsm_opts(options: *mut c_char, mnt_opts: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_kern_mount(sb: *const super_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_show_options(m: *mut seq_file, sb: *mut super_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_statfs(dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sb_umount(mnt: *mut vfsmount, flags: c_int) -> c_int {
...
//
    ...
    {
    struct lsm_static_call *scall;
    let mut rc: c_int = mnt_opts ? -EOPNOTSUPP : LSM_RET_DEFAULT(sb_set_mnt_opts);
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_alloc(inode: *mut inode, gfp: gfp_t) -> c_int {
    int security_inode_alloc(struct inode *inode, gfp_t gfp)
    {
    let mut rc: c_int = lsm_inode_alloc(inode, gfp);
    if (unlikely(rc))
    return rc;
...
#[no_mangle]
unsafe extern "C" fn inode_free_by_rcu(head: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_free(inode: *mut inode) {
...
//
    ...
    {
    struct lsm_static_call *scall;
    struct xattr *new_xattrs = core::ptr::null_mut();
    let mut ret: c_int = -EOPNOTSUPP, xattr_count = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_path_post_mknod(idmap: *mut mnt_idmap, dentry: *mut dentry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_path_rmdir(dir: *const path, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_path_unlink(dir: *const path, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_path_truncate(path: *const path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_path_chmod(path: *const path, mode: umode_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_path_chown(path: *const path, uid: kuid_t, gid: kgid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_path_chroot(path: *const path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_mkdir(dir: *mut inode, dentry: *mut dentry, mode: umode_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_readlink(dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_permission(inode: *mut inode, mask: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_getattr(path: *const path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_getxattr(dentry: *mut dentry, name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_listxattr(dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_post_removexattr(dentry: *mut dentry, name: *const c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_file_setattr(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_file_getattr(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_need_killpriv(dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_getlsmprop(inode: *mut inode, prop: *mut lsm_prop) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_copy_up(src: *mut dentry, new: *mut cred) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_copy_up_xattr(src: *mut dentry, name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_permission(file: *mut file, mask: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_alloc(file: *mut file) -> c_int {
    int security_file_alloc(struct file *file)
    {
    let mut rc: c_int = lsm_file_alloc(file);
    if (rc)
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_release(file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_free(file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_backing_file_free(backing_file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mmap_prot(file: *mut file, prot: c_ulong) -> c_ulong {
...
//
    ...
    let mut caps: unsigned = file.f_op.mmap_capabilities(file);
...
//
#[no_mangle]
pub unsafe extern "C" fn security_mmap_addr(addr: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_lock(file: *mut file, cmd: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_fcntl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_set_fowner(file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_receive(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_open(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_post_open(file: *mut file, mask: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_file_truncate(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_alloc(task: *mut task_struct, clone_flags: u64) -> c_int {
    int security_task_alloc(struct task_struct *task, u64 clone_flags)
    {
    let mut rc: c_int = lsm_task_alloc(task);
    if (rc)
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_free(task: *mut task_struct) {
    void security_task_free(struct task_struct *task)
    {
    call_void_hook(task_free, task);
    kfree(task.security);
    task.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_cred_alloc_blank(cred: *mut cred, gfp: gfp_t) -> c_int {
    int security_cred_alloc_blank(struct cred *cred, gfp_t gfp)
    {
    let mut rc: c_int = lsm_cred_alloc(cred, gfp);
    if (rc)
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_cred_free(cred: *mut cred) {
...
//
    if (unlikely(cred.security == core::ptr::null_mut()))
    return;
    call_void_hook(cred_free, cred);
    kfree(cred.security);
    cred.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_prepare_creds(new: *mut cred, old: *const cred, gfp: gfp_t) -> c_int {
    int security_prepare_creds(struct cred *new, const struct cred *old, gfp_t gfp)
    {
    let mut rc: c_int = lsm_cred_alloc(new, gfp);
    if (rc)
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_transfer_creds(new: *mut cred, old: *const cred) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_cred_getsecid(c: *const cred, secid: *mut u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_cred_getlsmprop(c: *const cred, prop: *mut lsm_prop) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_kernel_act_as(new: *mut cred, secid: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_kernel_create_files_as(new: *mut cred, inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_kernel_module_request(kmod_name: *mut c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_kernel_load_data(id: enum kernel_load_data_id, contents: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_fix_setgroups(new: *mut cred, old: *const cred) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_setpgid(p: *mut task_struct, pgid: pid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_getpgid(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_getsid(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_current_getlsmprop_subj(prop: *mut lsm_prop) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_getlsmprop_obj(p: *mut task_struct, prop: *mut lsm_prop) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_setnice(p: *mut task_struct, nice: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_setioprio(p: *mut task_struct, ioprio: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_getioprio(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_setscheduler(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_getscheduler(p: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_movememory(p: *mut task_struct) -> c_int {
...
//
    ...
    {
    int thisrc;
    let mut rc: c_int = LSM_RET_DEFAULT(task_prctl);
    struct lsm_static_call *scall;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_task_to_inode(p: *mut task_struct, inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_create_user_ns(cred: *const cred) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ipc_permission(ipcp: *mut kern_ipc_perm, flag: c_short) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ipc_getlsmprop(ipcp: *mut kern_ipc_perm, prop: *mut lsm_prop) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_msg_msg_alloc(msg: *mut msg_msg) -> c_int {
    int security_msg_msg_alloc(struct msg_msg *msg)
    {
    let mut rc: c_int = lsm_msg_msg_alloc(msg);
    if (unlikely(rc))
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_msg_msg_free(msg: *mut msg_msg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_msg_queue_alloc(msq: *mut kern_ipc_perm) -> c_int {
    int security_msg_queue_alloc(struct kern_ipc_perm *msq)
    {
    let mut rc: c_int = lsm_ipc_alloc(msq);
    if (unlikely(rc))
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_msg_queue_free(msq: *mut kern_ipc_perm) {
    void security_msg_queue_free(struct kern_ipc_perm *msq)
    {
    call_void_hook(msg_queue_free_security, msq);
    kfree(msq.security);
    msq.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_msg_queue_associate(msq: *mut kern_ipc_perm, msqflg: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_msg_queue_msgctl(msq: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_shm_alloc(shp: *mut kern_ipc_perm) -> c_int {
    int security_shm_alloc(struct kern_ipc_perm *shp)
    {
    let mut rc: c_int = lsm_ipc_alloc(shp);
    if (unlikely(rc))
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_shm_free(shp: *mut kern_ipc_perm) {
    void security_shm_free(struct kern_ipc_perm *shp)
    {
    call_void_hook(shm_free_security, shp);
    kfree(shp.security);
    shp.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_shm_associate(shp: *mut kern_ipc_perm, shmflg: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_shm_shmctl(shp: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sem_alloc(sma: *mut kern_ipc_perm) -> c_int {
    int security_sem_alloc(struct kern_ipc_perm *sma)
    {
    let mut rc: c_int = lsm_ipc_alloc(sma);
    if (unlikely(rc))
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sem_free(sma: *mut kern_ipc_perm) {
    void security_sem_free(struct kern_ipc_perm *sma)
    {
    call_void_hook(sem_free_security, sma);
    kfree(sma.security);
    sma.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sem_associate(sma: *mut kern_ipc_perm, semflg: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sem_semctl(sma: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_d_instantiate(dentry: *mut dentry, inode: *mut inode) {
...
//
    ...
    {
    struct lsm_static_call *scall;
    let mut lctx: lsm_ctx = { .id = LSM_ID_UNDEF, };
    u8 __user *base = (u8 __user *)uctx;
    u32 entrysize;
    let mut total: u32 = 0;
    u32 left;
    let mut toobig: bool = false;
    let mut single: bool = false;
    let mut count: c_int = 0;
    int rc;
    if (attr == LSM_ATTR_UNDEF)
    return -EINVAL;
    if (size == core::ptr::null_mut())
    return -EINVAL;
...
//
    ...
    struct lsm_static_call *scall;
    struct lsm_ctx *lctx;
    let mut rc: c_int = LSM_RET_DEFAULT(setselfattr);
    u64 required_len;
    if (flags)
    return -EINVAL;
    if (size < sizeof(*lctx))
...
//
#[no_mangle]
pub unsafe extern "C" fn security_setprocattr(lsmid: c_int, name: *const c_char, value: *mut c_void, size: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ismaclabel(name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_secid_to_secctx(secid: u32, cp: *mut lsm_context) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_secctx_to_secid(secdata: *const c_char, seclen: u32, secid: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_release_secctx(cp: *mut lsm_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_invalidate_secctx(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_notifysecctx(inode: *mut inode, ctx: *mut c_void, ctxlen: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_setsecctx(dentry: *mut dentry, ctx: *mut c_void, ctxlen: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_inode_getsecctx(inode: *mut inode, cp: *mut lsm_context) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_watch_key(key: *mut key) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_netlink_send(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_unix_may_send(sock: *mut socket, other: *mut socket) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_create(family: c_int, type: c_int, protocol: c_int, kern: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_socketpair(socka: *mut socket, sockb: *mut socket) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_accept(sock: *mut socket, newsock: *mut socket) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_sendmsg(sock: *mut socket, msg: *mut msghdr, size: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_getsockname(sock: *mut socket) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_getpeername(sock: *mut socket) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_getsockopt(sock: *mut socket, level: c_int, optname: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_setsockopt(sock: *mut socket, level: c_int, optname: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_socket_shutdown(sock: *mut socket, how: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sock_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lsm_sock_alloc(sock: *mut sock, gfp: gfp_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sk_alloc(sk: *mut sock, family: c_int, priority: gfp_t) -> c_int {
    int security_sk_alloc(struct sock *sk, int family, gfp_t priority)
    {
    let mut rc: c_int = lsm_sock_alloc(sk, priority);
    if (unlikely(rc))
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sk_free(sk: *mut sock) {
    void security_sk_free(struct sock *sk)
    {
    call_void_hook(sk_free_security, sk);
    kfree(sk.sk_security);
    sk.sk_security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sk_clone(sk: *const sock, newsk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sk_classify_flow(sk: *const sock, flic: *mut flowi_common) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_sock_graft(sk: *mut sock, parent: *mut socket) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_secmark_relabel_packet(secid: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_secmark_refcount_inc() {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_secmark_refcount_dec() {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_tun_dev_alloc_security(security: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_tun_dev_free_security(security: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_tun_dev_create() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_tun_dev_attach_queue(security: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_tun_dev_attach(sk: *mut sock, security: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_tun_dev_open(security: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_mptcp_add_subflow(sk: *mut sock, ssk: *mut sock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_unix_find(path: *const path, other: *mut sock, flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ib_pkey_access(sec: *mut c_void, subnet_prefix: u64, pkey: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ib_alloc_security(sec: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_ib_free_security(sec: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_xfrm_policy_free(ctx: *mut xfrm_sec_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_xfrm_policy_delete(ctx: *mut xfrm_sec_ctx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_xfrm_state_delete(x: *mut xfrm_state) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_xfrm_state_free(x: *mut xfrm_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_xfrm_policy_lookup(ctx: *mut xfrm_sec_ctx, fl_secid: u32) -> c_int {
...
//
    ...
    {
    struct lsm_static_call *scall;
    let mut rc: c_int = LSM_RET_DEFAULT(xfrm_state_pol_flow_match);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_xfrm_decode_session(skb: *mut sk_buff, secid: *mut u32) -> c_int {
    int security_xfrm_decode_session(struct sk_buff *skb, u32 *secid)
    {
    return call_int_hook(xfrm_decode_session, skb, secid, 1);
    }
#[no_mangle]
pub unsafe extern "C" fn security_skb_classify_flow(skb: *mut sk_buff, flic: *mut flowi_common) {
...
//
    ...
    unsigned long flags)
    {
    let mut rc: c_int = lsm_key_alloc(key);
    if (unlikely(rc))
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn security_key_free(key: *mut key) {
    void security_key_free(struct key *key)
    {
    kfree(key.security);
    key.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_key_getsecurity(key: *mut key, buffer: *mut c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_audit_rule_known(krule: *mut audit_krule) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_audit_rule_free(lsmrule: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf(cmd: c_int, attr: *mut union bpf_attr, size: c_uint, kernel: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf_map(map: *mut bpf_map, fmode: fmode_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf_prog(prog: *mut bpf_prog) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf_token_cmd(token: *const bpf_token, cmd: enum bpf_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf_token_capable(token: *const bpf_token, cap: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf_map_free(map: *mut bpf_map) {
    void security_bpf_map_free(struct bpf_map *map)
    {
    call_void_hook(bpf_map_free, map);
    kfree(map.security);
    map.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf_prog_free(prog: *mut bpf_prog) {
    void security_bpf_prog_free(struct bpf_prog *prog)
    {
    call_void_hook(bpf_prog_free, prog);
    kfree(prog.aux.security);
    prog.aux.security = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bpf_token_free(token: *mut bpf_token) {
    void security_bpf_token_free(struct bpf_token *token)
    {
    call_void_hook(bpf_token_free, token);
    kfree(token.security);
    token.security = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn security_locked_down(what: enum lockdown_reason) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bdev_alloc(bdev: *mut block_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_bdev_free(bdev: *mut block_device) {
    ...
    bdev.bd_security = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn security_perf_event_open(type: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_perf_event_alloc(event: *mut perf_event) -> c_int {
    ...
    event.security = core::ptr::null_mut();
    }
    return rc;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn security_perf_event_free(event: *mut perf_event) {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_perf_event_read(event: *mut perf_event) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_perf_event_write(event: *mut perf_event) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_uring_override_creds(new: *const cred) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_uring_sqpoll() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_uring_cmd(ioucmd: *mut io_uring_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_uring_allowed() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn security_initramfs_populated() {
