...
//! Source: security/selinux/hooks.c
#![no_std]
...
pub const SELINUX_INODE_INIT_XATTRS: c_int = 1;
    struct selinux_state selinux_state;
// SECMARK reference count
    let mut selinux_secmark_refcount: static atomic_t = ATOMIC_INIT(0);

    static int selinux_enforcing_boot __initdata;
#[no_mangle]
unsafe extern "C" fn enforcing_setup(str: *mut c_char) -> int __init {
...
pub const selinux_enforcing_boot: c_int = 1;

    let mut __initdata: int selinux_enabled_boot = 1;

#[no_mangle]
unsafe extern "C" fn selinux_enabled_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn checkreqprot_setup(str: *mut c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_secmark_enabled() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_peerlbl_enabled() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_netcache_avc_callback(event: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_lsm_notifier_avc_callback(event: u32) -> c_int {
    static int selinux_lsm_notifier_avc_callback(u32 event)
    {
    if (event == AVC_CALLBACK_RESET) {
    sel_ib_pkey_flush();
    call_blocking_lsm_notifier(LSM_POLICY_CHANGE, core::ptr::null_mut());
    }
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn cred_init_security() {
...
//
#[no_mangle]
pub unsafe extern "C" fn cred_sid(cred: *const cred) -> u32 {
    ...
    {
    __ad_net_init(ad, net, ifindex, core::ptr::null_mut(), family);
    }
//
// get the objective security ID of a task
//
#[no_mangle]
pub unsafe extern "C" fn task_sid_obj(task: *const task_struct) -> u32 {
...
// check below is racy, but revalidate will recheck with lock held
    ...
    return isec;
    rc = __inode_security_revalidate(inode, core::ptr::null_mut(), !rcu);
    if (rc)
    return ERR_PTR(rc);
    return isec;
    }
...
// check below is racy, but revalidate will recheck with lock held
    if (data_race(likely(isec.initialized == LABEL_INITIALIZED)))
    return isec;
    __inode_security_revalidate(inode, core::ptr::null_mut(), true);
    return isec;
    }
...
#[no_mangle]
unsafe extern "C" fn inode_free_security(inode: *mut inode) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct selinux_mnt_opts {
    pub fscontext_sid: u32,
    pub context_sid: u32,
    pub rootcontext_sid: u32,
    pub defcontext_sid: u32,
}

#[no_mangle]
unsafe extern "C" fn selinux_free_mnt_opts(mnt_opts: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn match_opt_prefix(s: *mut c_char, l: c_int, arg: *mut c_char) -> c_int {
    static int match_opt_prefix(char *s, int l, char **arg)
    {
    unsigned int i;
    for (i = 0; i < ARRAY_SIZE(tokens); i++) {
    let mut len: usize = tokens[i].len;
...
// arg = s + len + 1;
    ...
    FILESYSTEM__RELABELFROM, core::ptr::null_mut());
    if (rc)
    return rc;
    rc = avc_has_perm(crsec.sid, sid, SECCLASS_FILESYSTEM,
    FILESYSTEM__RELABELTO, core::ptr::null_mut());
    return rc;
    }
    ...
    FILESYSTEM__ASSOCIATE, core::ptr::null_mut());
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn selinux_is_genfs_special_handling(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_is_sblabel_mnt(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sb_check_xattr_support(sb: *mut super_block) -> c_int {
...
//
    ...
    rc = __vfs_getxattr(root, root_inode, XATTR_NAME_SELINUX, core::ptr::null_mut(), 0);
    if (rc < 0 && rc != -ENODATA) {
    if (rc == -EOPNOTSUPP) {
...
#[no_mangle]
unsafe extern "C" fn sb_finish_set_opts(sb: *mut super_block) -> c_int {
...
// Initialize any other inodes associated with the superblock, e.g.
    ...
    if (inode) {
    if (!IS_PRIVATE(inode))
    inode_doinit_with_dentry(inode, core::ptr::null_mut());
    iput(inode);
    }
    spin_lock(&sbsec.isec_lock);
    }
    ...
    {
    let mut mnt_flags: c_char = sbsec.flags & SE_MNTMASK;
...
//
    ...
    let mut fscontext_sid: u32 = 0, context_sid = 0, rootcontext_sid = 0;
    let mut defcontext_sid: u32 = 0;
    let mut rc: c_int = 0;
//
...
//
    ...
    current_sid(),
    SECCLASS_FILE, core::ptr::null_mut(),
    &sbsec.mntpoint_sid);
    if (rc)
    goto out;
    }
...
// set_kern_flags |= SECURITY_LSM_NATIVE_LABELS;
    ...
    let mut oldflags: c_char = old.flags & SE_MNTMASK;
    let mut newflags: c_char = new.flags & SE_MNTMASK;
    ...
    let mut set_fscontext: c_int = (oldsbsec.flags & FSCONTEXT_MNT);
    let mut set_context: c_int = (oldsbsec.flags & CONTEXT_MNT);
    let mut set_rootcontext: c_int = (oldsbsec.flags & ROOTCONTEXT_MNT);
//
// Specifying internal flags without providing a place to
// place the results is not allowed.
//
...
// set_kern_flags |= SECURITY_LSM_NATIVE_LABELS;
    ...
    if (set_context) {
    let mut sid: u32 = oldsbsec.mntpoint_sid;
    if (!set_fscontext)
    newsbsec.sid = sid;
    if (!set_rootcontext) {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_add_opt(token: c_int, s: *const c_char, mnt_opts: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_sid(m: *mut seq_file, sid: u32) -> c_int {
    static int show_sid(struct seq_file *m, u32 sid)
    {
    char *context = core::ptr::null_mut();
    u32 len;
    int rc;
    rc = security_sid_to_context(sid, &context, &len);
    if (!rc) {
    let mut has_comma: bool = strchr(context, ',');
    seq_putc(m, '=');
    if (has_comma)
    seq_putc(m, '\"');
...
#[no_mangle]
unsafe extern "C" fn selinux_sb_show_options(m: *mut seq_file, sb: *mut super_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inode_mode_to_security_class(mode: umode_t) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn default_protocol_stream(protocol: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn default_protocol_dgram(protocol: c_int) -> c_int {
    static inline int default_protocol_dgram(int protocol)
    {
    return (protocol == IPPROTO_IP || protocol == IPPROTO_UDP);
    }
#[no_mangle]
pub unsafe extern "C" fn socket_type_to_security_class(family: c_int, type: c_int, protocol: c_int) -> u16 {
    static inline u16 socket_type_to_security_class(int family, int type, int protocol)
    {
    let mut extsockclass: bool = selinux_policycap_extsockclass();
    switch (family) {
    case PF_UNIX:
    switch (type) {
    case SOCK_STREAM:
...
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_SCTP: extsockclass && protocol ==) -> else {
...
// sid = SECINITSID_UNLABELED;
    ...
    u32 def_sid, u32 *sid)
    {
pub const INITCONTEXTLEN: c_int = 255;
    char *context;
    unsigned int len;
    int rc;
    len = INITCONTEXTLEN;
...
// Need a larger buffer.  Query for the right size.
    rc = __vfs_getxattr(dentry, inode, XATTR_NAME_SELINUX, core::ptr::null_mut(), 0);
    if (rc < 0)
    return rc;
    len = rc;
    context = kmalloc(len + 1, GFP_NOFS);
...
#[no_mangle]
unsafe extern "C" fn inode_doinit_with_dentry(inode: *mut inode, opt_dentry: *mut dentry) -> c_int {
    static int inode_doinit_with_dentry(struct inode *inode, struct dentry *opt_dentry)
    {
    struct superblock_security_struct *sbsec = core::ptr::null_mut();
    struct inode_security_struct *isec = selinux_inode(inode);
    u32 task_sid, sid = 0;
    u16 sclass;
    struct dentry *dentry;
...
#[no_mangle]
pub unsafe extern "C" fn signal_to_av(sig: c_int) -> u32 {
...
// Check whether a task is allowed to use a capability.
    ...
    u16 sclass;
    let mut sid: u32 = cred_sid(cred);
    let mut av: u32 = CAP_TO_MASK(cap);
    int rc;
    ...
    let mut rc2: c_int = avc_audit(sid, sid, sclass, av, &avd, rc, &ad);
    if (rc2)
    return rc2;
    }
    return rc;
...
// Same as path_has_perm, but uses the inode from the file struct.
    ...
    struct common_audit_data ad;
    struct inode *inode;
    let mut ssid: u32 = cred_sid(cred);
    u32 tsid_fd;
    int rc;
    if (bf_user_file) {
...
pub const MAY_LINK: c_int = 0;
pub const MAY_UNLINK: c_int = 1;
pub const MAY_RMDIR: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn file_mask_to_av(mode: c_int, mask: c_int) -> u32 {
    ...
    av |= FILE__APPEND;
#[no_mangle]
pub unsafe extern "C" fn if(MAY_WRITE: mask &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn file_to_av(file: *const file) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn open_file_to_av(file: *mut file) -> u32 {
    static inline u32 open_file_to_av(struct file *file)
    {
    let mut av: u32 = file_to_av(file);
...
#[no_mangle]
unsafe extern "C" fn selinux_binder_set_context_mgr(mgr: *const cred) -> c_int {
    static int selinux_binder_set_context_mgr(const struct cred *mgr)
    {
    return avc_has_perm(current_sid(), cred_sid(mgr), SECCLASS_BINDER,
    BINDER__SET_CONTEXT_MGR, core::ptr::null_mut());
    }
    static int selinux_binder_transaction(const struct cred *from,
    const struct cred *to)
    {
    let mut mysid: u32 = current_sid();
    let mut fromsid: u32 = cred_sid(from);
    let mut tosid: u32 = cred_sid(to);
    int rc;
    if (mysid != fromsid) {
    rc = avc_has_perm(mysid, fromsid, SECCLASS_BINDER,
    BINDER__IMPERSONATE, core::ptr::null_mut());
    if (rc)
    return rc;
    }
    return avc_has_perm(fromsid, tosid,
    SECCLASS_BINDER, BINDER__CALL, core::ptr::null_mut());
    }
    ...
    {
    let mut sid: u32 = current_sid();
    let mut csid: u32 = task_sid_obj(child);
...
#[no_mangle]
unsafe extern "C" fn selinux_ptrace_traceme(parent: *mut task_struct) -> c_int {
    static int selinux_ptrace_traceme(struct task_struct *parent)
    {
    return avc_has_perm(task_sid_obj(parent), task_sid_obj(current),
    SECCLASS_PROCESS, PROCESS__PTRACE, core::ptr::null_mut());
    }
    static int selinux_capget(const struct task_struct *target, kernel_cap_t *effective,
    kernel_cap_t *inheritable, kernel_cap_t *permitted)
    {
    return avc_has_perm(current_sid(), task_sid_obj(target),
    SECCLASS_PROCESS, PROCESS__GETCAP, core::ptr::null_mut());
    }
    ...
    PROCESS__SETCAP, core::ptr::null_mut());
    }
//
...
#[no_mangle]
unsafe extern "C" fn selinux_quotactl(cmds: c_int, type: c_int, id: c_int, sb: *const super_block) -> c_int {
    ...
    case Q_XQUOTAON:
    case Q_XSETQLIM:
    rc = superblock_has_perm(cred, sb, FILESYSTEM__QUOTAMOD, core::ptr::null_mut());
    break;
    case Q_GETFMT:
    case Q_GETINFO:
    case Q_GETQUOTA:
    ...
    rc = superblock_has_perm(cred, sb, FILESYSTEM__QUOTAGET, core::ptr::null_mut());
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn selinux_quota_on(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_syslog(type: c_int) -> c_int {
    ...
    SECCLASS_SYSTEM, SYSTEM__SYSLOG_READ, core::ptr::null_mut());
...
// All other syslog types
    return avc_has_perm(current_sid(), SECINITSID_KERNEL,
    SECCLASS_SYSTEM, SYSTEM__SYSLOG_MOD, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn selinux_vm_enough_memory(mm: *mut mm_struct, pages: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ptrace_parent_sid() -> u32 {
    ...
    {
    let mut nnp: c_int = (bprm.unsafe & LSM_UNSAFE_NO_NEW_PRIVS);
    let mut nosuid: c_int = !mnt_may_suid(bprm.file.f_path.mnt);
    int rc;
    u32 av;
    if (!nnp && !nosuid)
...
//
    ...
    SECCLASS_PROCESS2, av, core::ptr::null_mut());
    if (!rc)
    return 0;
    }
//
...
#[no_mangle]
unsafe extern "C" fn selinux_bprm_creds_for_exec(bprm: *mut linux_binprm) -> c_int {
...
// Check for a default transition on this program.
    ...
    isec.sid, SECCLASS_PROCESS, core::ptr::null_mut(),
    &new_crsec.sid);
    if (rc)
    return rc;
//
...
// changes its SID has the appropriate permit
    ...
    let mut ptsid: u32 = ptrace_parent_sid();
    if (ptsid != 0) {
    rc = avc_has_perm(ptsid, new_crsec.sid,
    SECCLASS_PROCESS,
    PROCESS__PTRACE, core::ptr::null_mut());
    if (rc)
    return -EPERM;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn match_file(p: *const c_void, file: *mut file, fd: unsigned) -> c_int {
...
// Derived from fs/exec.c:flush_old_files.
    ...
    {
    struct file *file, *devnull = core::ptr::null_mut();
    struct tty_struct *tty;
    let mut drop_tty: c_int = 0;
    unsigned n;
    tty = get_current_tty();
    if (tty) {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_bprm_committing_creds(bprm: *const linux_binprm) {
...
//
    ...
    PROCESS__RLIMITINH, core::ptr::null_mut());
    if (rc) {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_bprm_committed_creds(bprm: *const linux_binprm) {
...
//
    rc = avc_has_perm(osid, sid, SECCLASS_PROCESS, PROCESS__SIGINH, core::ptr::null_mut());
    if (rc) {
    clear_itimer();
...
#[no_mangle]
unsafe extern "C" fn selinux_sb_alloc_security(sb: *mut super_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opt_len(s: *const c_char) -> c_int {
    static inline int opt_len(const char *s)
    {
    let mut open_quote: bool = false;
    int len;
    char c;
...
#[no_mangle]
unsafe extern "C" fn selinux_sb_eat_lsm_opts(options: *mut c_char, mnt_opts: *mut c_void) -> c_int {
    ...
    int rc;
    while (1) {
    let mut len: c_int = opt_len(from);
    int token;
    char *arg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn selinux_sb_mnt_opts_compat(sb: *mut super_block, mnt_opts: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_sb_remount(sb: *mut super_block, mnt_opts: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_sb_kern_mount(sb: *const super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_sb_statfs(dentry: *mut dentry) -> c_int {
    ...
    FILESYSTEM__REMOUNT, core::ptr::null_mut());
    else
...
#[no_mangle]
unsafe extern "C" fn selinux_umount(mnt: *mut vfsmount, flags: c_int) -> c_int {
    static int selinux_umount(struct vfsmount *mnt, int flags)
    {
    const struct cred *cred = current_cred();
    return superblock_has_perm(cred, mnt.mnt_sb,
    FILESYSTEM__UNMOUNT, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_alloc_security(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_free_security(inode: *mut inode) {
...
// Possibly defer initialization to selinux_complete_init.
    ...
    struct inode_security_struct *isec;
    int rc;
    let mut is_memfd: bool = false;
    if (unlikely(!selinux_initialized()))
    return 0;
    if (name != core::ptr::null_mut() && name.name != core::ptr::null_mut() &&
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_create(dir: *mut inode, dentry: *mut dentry, mode: umode_t) -> c_int {
    static int selinux_inode_create(struct inode *dir, struct dentry *dentry, umode_t mode)
    {
    return may_create(dir, dentry, SECCLASS_FILE);
    }
#[no_mangle]
unsafe extern "C" fn selinux_inode_link(old_dentry: *mut dentry, dir: *mut inode, new_dentry: *mut dentry) -> c_int {
    static int selinux_inode_link(struct dentry *old_dentry, struct inode *dir, struct dentry *new_dentry)
    {
    return may_link(dir, old_dentry, MAY_LINK);
    }
#[no_mangle]
unsafe extern "C" fn selinux_inode_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
    static int selinux_inode_unlink(struct inode *dir, struct dentry *dentry)
    {
    return may_link(dir, dentry, MAY_UNLINK);
    }
#[no_mangle]
unsafe extern "C" fn selinux_inode_symlink(dir: *mut inode, dentry: *mut dentry, name: *const c_char) -> c_int {
    static int selinux_inode_symlink(struct inode *dir, struct dentry *dentry, const char *name)
    {
    return may_create(dir, dentry, SECCLASS_LNK_FILE);
    }
#[no_mangle]
unsafe extern "C" fn selinux_inode_mkdir(dir: *mut inode, dentry: *mut dentry, mask: umode_t) -> c_int {
    static int selinux_inode_mkdir(struct inode *dir, struct dentry *dentry, umode_t mask)
    {
    return may_create(dir, dentry, SECCLASS_DIR);
    }
#[no_mangle]
unsafe extern "C" fn selinux_inode_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
    static int selinux_inode_rmdir(struct inode *dir, struct dentry *dentry)
    {
    return may_link(dir, dentry, MAY_RMDIR);
    }
#[no_mangle]
unsafe extern "C" fn selinux_inode_mknod(dir: *mut inode, dentry: *mut dentry, mode: umode_t, dev: dev_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_readlink(dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn task_avdcache_reset(tsec: *mut task_security_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_inode_permission(inode: *mut inode, requested: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_getattr(path: *const path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn has_cap_mac_admin(audit: bool) -> bool {
    static bool has_cap_mac_admin(bool audit)
    {
    const struct cred *cred = current_cred();
    let mut opts: c_uint = audit ? CAP_OPT_NONE : CAP_OPT_NOAUDIT;
...
//
#[no_mangle]
unsafe extern "C" fn selinux_inode_xattr_skipcap(name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_getxattr(dentry: *mut dentry, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_listxattr(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_getlsmprop(inode: *mut inode, prop: *mut lsm_prop) {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_copy_up(src: *mut dentry, new: *mut cred) -> c_int {
    static int selinux_inode_copy_up(struct dentry *src, struct cred **new)
    {
    struct lsm_prop prop;
    struct cred_security_struct *crsec;
    struct cred *new_creds = *new;
    if (new_creds == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_copy_up_xattr(dentry: *mut dentry, name: *const c_char) -> c_int {
...
// kernfs node operations
    ...
    int rc;
    char *context;
    rc = kernfs_xattr_get(kn_dir, XATTR_NAME_SELINUX, core::ptr::null_mut(), 0);
    if (rc == -ENODATA)
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: rc <) -> else {
    ...
    let mut secclass: u16 = inode_mode_to_security_class(kn.mode);
    const char *kn_name;
    struct qstr q;
...
#[no_mangle]
unsafe extern "C" fn selinux_revalidate_file_permission(file: *mut file, mask: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_file_permission(file: *mut file, mask: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_file_alloc_security(file: *mut file) -> c_int {
...
//
    ...
    let mut ssid: u32 = cred_sid(cred);
    int rc;
    let mut driver: u8 = cmd >> 8;
    let mut xperm: u8 = cmd & 0xff;
...
//
    ...
    let mut prot_exec: bool = prot & PROT_EXEC;
    let mut prot_write: bool = prot & PROT_WRITE;
    if (file) {
    if (bf_user_file)
...
#[no_mangle]
unsafe extern "C" fn selinux_mmap_addr(addr: c_ulong) -> c_int {
    ...
    MEMPROTECT__MMAP_ZERO, core::ptr::null_mut());
    }
    return rc;
    }
...
// translate vma->vm_flags perms into PROT perms
    ...
    bool backing_file;
    let mut shared: bool = vma.vm_flags & VM_SHARED;
...
//
    ...
    PROCESS__EXECHEAP, core::ptr::null_mut());
    if (rc)
    return rc;
    } else if (!file && (vma_is_initial_stack(vma) ||
    vma_is_stack_for_current(vma))) {
    rc = avc_has_perm(sid, sid, SECCLASS_PROCESS,
    PROCESS__EXECSTACK, core::ptr::null_mut());
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn selinux_file_lock(file: *mut file, cmd: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_file_set_fowner(file: *mut file) {
    ...
    {
    struct file *file;
    let mut sid: u32 = task_sid_obj(tsk);
    u32 perm;
    struct file_security_struct *fsec;
// struct fown_struct is never outside the context of a struct file
    ...
    SECCLASS_PROCESS, perm, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_file_receive(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_file_open(file: *mut file) -> c_int {
...
// new_tsec = *old_tsec;
    return avc_has_perm(sid, sid, SECCLASS_PROCESS, PROCESS__FORK, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn selinux_cred_transfer(new: *mut cred, old: *const cred) {
...
#[no_mangle]
unsafe extern "C" fn selinux_cred_getsecid(c: *const cred, secid: *mut u32) {
    static void selinux_cred_getsecid(const struct cred *c, u32 *secid)
    {
// secid = cred_sid(c);
    }
#[no_mangle]
unsafe extern "C" fn selinux_cred_getlsmprop(c: *const cred, prop: *mut lsm_prop) {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_kernel_act_as(new: *mut cred, secid: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_kernel_create_files_as(new: *mut cred, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_kernel_module_request(kmod_name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_kernel_load_from_file(file: *mut file, requested: u32) -> c_int {
    ...
    return avc_has_perm(sid, sid, SECCLASS_SYSTEM, requested, core::ptr::null_mut());
    ad.type = LSM_AUDIT_DATA_FILE;
    ad.u.file = file;
    fsec = selinux_file(file);
    if (sid != fsec.sid) {
...
#[no_mangle]
unsafe extern "C" fn selinux_kernel_load_data(id: enum kernel_load_data_id, contents: bool) -> c_int {
    ...
    rc = selinux_kernel_load_from_file(core::ptr::null_mut(), SYSTEM__FIRMWARE_LOAD);
    break;
    case LOADING_MODULE:
    rc = selinux_kernel_load_from_file(core::ptr::null_mut(), SYSTEM__MODULE_LOAD);
    break;
    case LOADING_KEXEC_IMAGE:
    rc = selinux_kernel_load_from_file(core::ptr::null_mut(),
    SYSTEM__KEXEC_IMAGE_LOAD);
    break;
...
#[no_mangle]
unsafe extern "C" fn selinux_task_setpgid(p: *mut task_struct, pgid: pid_t) -> c_int {
    static int selinux_task_setpgid(struct task_struct *p, pid_t pgid)
    {
    return avc_has_perm(current_sid(), task_sid_obj(p), SECCLASS_PROCESS,
    PROCESS__SETPGID, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_task_getpgid(p: *mut task_struct) -> c_int {
    static int selinux_task_getpgid(struct task_struct *p)
    {
    return avc_has_perm(current_sid(), task_sid_obj(p), SECCLASS_PROCESS,
    PROCESS__GETPGID, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_task_getsid(p: *mut task_struct) -> c_int {
    static int selinux_task_getsid(struct task_struct *p)
    {
    return avc_has_perm(current_sid(), task_sid_obj(p), SECCLASS_PROCESS,
    PROCESS__GETSESSION, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_current_getlsmprop_subj(prop: *mut lsm_prop) {
...
#[no_mangle]
unsafe extern "C" fn selinux_task_setnice(p: *mut task_struct, nice: c_int) -> c_int {
    static int selinux_task_setnice(struct task_struct *p, int nice)
    {
    return avc_has_perm(current_sid(), task_sid_obj(p), SECCLASS_PROCESS,
    PROCESS__SETSCHED, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_task_setioprio(p: *mut task_struct, ioprio: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_task_getioprio(p: *mut task_struct) -> c_int {
    static int selinux_task_getioprio(struct task_struct *p)
    {
    return avc_has_perm(current_sid(), task_sid_obj(p), SECCLASS_PROCESS,
    PROCESS__GETSCHED, core::ptr::null_mut());
    }
    ...
    SECCLASS_PROCESS, av, core::ptr::null_mut());
    }
...
// Control the ability to change the hard limit (whether
    ...
    SECCLASS_PROCESS, PROCESS__SETRLIMIT, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn selinux_task_setscheduler(p: *mut task_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_task_getscheduler(p: *mut task_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_task_movememory(p: *mut task_struct) -> c_int {
    ...
    secid = cred_sid(cred);
    return avc_has_perm(secid, task_sid_obj(p), SECCLASS_PROCESS, perm, core::ptr::null_mut());
    }
    static void selinux_task_to_inode(struct task_struct *p,
    struct inode *inode)
    {
    struct inode_security_struct *isec = selinux_inode(inode);
    let mut sid: u32 = task_sid_obj(p);
    spin_lock(&isec.lock);
    isec.sclass = inode_mode_to_security_class(inode.i_mode);
    isec.sid = sid;
    isec.initialized = LABEL_INITIALIZED;
...
#[no_mangle]
unsafe extern "C" fn selinux_userns_create(cred: *const cred) -> c_int {
    static int selinux_userns_create(const struct cred *cred)
    {
    let mut sid: u32 = current_sid();
    return avc_has_perm(sid, sid, SECCLASS_USER_NAMESPACE,
    USER_NAMESPACE__CREATE, core::ptr::null_mut());
    }
...
// Returns error only if unable to parse addresses
    ...
    {
    u8 nexthdr;
    let mut ret: c_int = -EINVAL, offset;
    struct ipv6hdr _ipv6h, *ip6;
    __be16 frag_off;
    offset = skb_network_offset(skb);
    ip6 = skb_header_pointer(skb, offset, sizeof(_ipv6h), &_ipv6h);
    if (ip6 == core::ptr::null_mut())
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn selinux_skb_peerlbl_sid(skb: *mut sk_buff, family: u16, sid: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_conn_sid(sk_sid: u32, skb_sid: u32, conn_sid: *mut u32) -> c_int {
...
// socksid = crsec->sockcreate_sid;
    ...
    secclass, core::ptr::null_mut(), socksid);
    }
#[no_mangle]
unsafe extern "C" fn sock_skip_has_perm(sid: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sock_has_perm(sk: *mut sock, perms: u32) -> c_int {
    ...
    if (rc)
    return rc;
    return avc_has_perm(crsec.sid, newsid, secclass, SOCKET__CREATE, core::ptr::null_mut());
    }
    ...
    let mut sclass: u16 = socket_type_to_security_class(family, type, protocol);
    let mut sid: u32 = SECINITSID_KERNEL;
    let mut err: c_int = 0;
    if (!kern) {
...
#[no_mangle]
unsafe extern "C" fn __selinux_socket_bind(sk: *mut sock, address: *mut sockaddr, addrlen: c_int) -> c_int {
...
// If PF_INET or PF_INET6, check name_bind permission for the port.
    ...
    char *addrp;
    struct common_audit_data ad;
    let mut net: lsm_network_audit = {0,};
    struct sockaddr_in *addr4 = core::ptr::null_mut();
    struct sockaddr_in6 *addr6 = core::ptr::null_mut();
    u16 family_sa;
    unsigned short snum;
    u32 sid, node_perm;
//
...
#[no_mangle]
unsafe extern "C" fn selinux_socket_bind(sock: *mut socket, address: *mut sockaddr, addrlen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_socket_listen(sock: *mut socket, backlog: c_int) -> c_int {
    static int selinux_socket_listen(struct socket *sock, int backlog)
    {
    return sock_has_perm(sock.sk, SOCKET__LISTEN);
    }
#[no_mangle]
unsafe extern "C" fn selinux_socket_accept(sock: *mut socket, newsock: *mut socket) -> c_int {
    ...
    {
    int rc;
    let mut addr: *mut sockaddr const = msg.msg_name;
    let mut addrlen: c_int = msg.msg_namelen;
...
#[no_mangle]
unsafe extern "C" fn selinux_socket_getsockname(sock: *mut socket) -> c_int {
    static int selinux_socket_getsockname(struct socket *sock)
    {
    return sock_has_perm(sock.sk, SOCKET__GETATTR);
    }
#[no_mangle]
unsafe extern "C" fn selinux_socket_getpeername(sock: *mut socket) -> c_int {
    static int selinux_socket_getpeername(struct socket *sock)
    {
    return sock_has_perm(sock.sk, SOCKET__GETATTR);
    }
#[no_mangle]
unsafe extern "C" fn selinux_socket_setsockopt(sock: *mut socket, level: c_int, optname: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_socket_shutdown(sock: *mut socket, how: c_int) -> c_int {
...
// connecting socket
    ...
    let mut err: c_int = 0;
    struct sk_security_struct *sksec = selinux_sock(sk);
    let mut sk_sid: u32 = sksec.sid;
    struct common_audit_data ad;
    struct lsm_network_audit net;
    char *addrp;
    ad_net_init_from_iif(&ad, &net, skb.skb_iif, family);
    err = selinux_parse_skb(skb, &ad, &addrp, 1, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn selinux_socket_sock_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int selinux_socket_sock_rcv_skb(struct sock *sk, struct sk_buff *skb)
    {
    int err, peerlbl_active, secmark_active;
    struct sk_security_struct *sksec = selinux_sock(sk);
    let mut family: u16 = sk.sk_family;
    let mut sk_sid: u32 = sksec.sid;
    struct common_audit_data ad;
    struct lsm_network_audit net;
    char *addrp;
...
// as fast and as clean as possible.
    ...
    {
    let mut err: c_int = 0;
    char *scontext = core::ptr::null_mut();
    u32 scontext_len;
    struct sk_security_struct *sksec = selinux_sock(sock.sk);
    let mut peer_sid: u32 = SECSID_NULL;
    ...
    {
    let mut peer_secid: u32 = SECSID_NULL;
    u16 family;
    if (skb && skb.protocol == htons(ETH_P_IP))
    family = PF_INET;
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_IPV6): skb && skb->protocol ==) -> else {
    else if (skb && skb.protocol == htons(ETH_P_IPV6))
    family = PF_INET6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sock) -> else {
    else if (sock)
...
#[no_mangle]
unsafe extern "C" fn selinux_sk_alloc_security(sk: *mut sock, family: c_int, priority: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_sk_free_security(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn selinux_sk_clone_security(sk: *const sock, newsk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn selinux_sk_getsecid(sk: *const sock, secid: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn selinux_sock_graft(sk: *mut sock, parent: *mut socket) {
...
#[no_mangle]
unsafe extern "C" fn selinux_mptcp_add_subflow(sk: *mut sock, ssk: *mut sock) -> c_int {
...
//
    ...
    struct sk_security_struct *sksec = selinux_sock(sk);
    int err;
    let mut family: u16 = req.rsk_ops.family;
    u32 connsid;
    u32 peersid;
...
#[no_mangle]
unsafe extern "C" fn selinux_inet_conn_established(sk: *mut sock, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn selinux_secmark_relabel_packet(sid: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_secmark_refcount_inc() {
    static void selinux_secmark_refcount_inc(void)
    {
    atomic_inc(&selinux_secmark_refcount);
    }
#[no_mangle]
unsafe extern "C" fn selinux_secmark_refcount_dec() {
...
#[no_mangle]
unsafe extern "C" fn selinux_tun_dev_alloc_security(security: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_tun_dev_create() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_tun_dev_attach_queue(security: *mut c_void) -> c_int {
    static int selinux_tun_dev_attach_queue(void *security)
    {
    struct tun_security_struct *tunsec = selinux_tun_dev(security);
    return avc_has_perm(current_sid(), tunsec.sid, SECCLASS_TUN_SOCKET,
    TUN_SOCKET__ATTACH_QUEUE, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_tun_dev_attach(sk: *mut sock, security: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_tun_dev_open(security: *mut c_void) -> c_int {
    ...
    TUN_SOCKET__RELABELFROM, core::ptr::null_mut());
    if (err)
    return err;
    err = avc_has_perm(sid, sid, SECCLASS_TUN_SOCKET,
    TUN_SOCKET__RELABELTO, core::ptr::null_mut());
    if (err)
    return err;
    tunsec.sid = sid;
    return 0;
    ...
    if (selinux_parse_skb(skb, &ad, &addrp, 1, core::ptr::null_mut()) != 0)
    return NF_DROP;
    if (peerlbl_active) {
    int err;
...
// standard practice, label using the parent socket
    ...
    if (selinux_parse_skb(skb, &ad, core::ptr::null_mut(), 0, &proto))
    return NF_DROP;
    if (selinux_secmark_enabled())
...
// connection.
    if (skb_dst(skb) != core::ptr::null_mut() && skb_dst(skb).xfrm != core::ptr::null_mut() &&
    !(sk && sk_listener(sk)))
    return NF_ACCEPT;
...
// associated socket.
    ...
    ad_net_init_from_iif(&ad, &net, ifindex, family);
    if (selinux_parse_skb(skb, &ad, &addrp, 0, core::ptr::null_mut()))
    return NF_DROP;
    if (secmark_active)
    if (avc_has_perm(peer_sid, skb.secmark,
...
#[no_mangle]
unsafe extern "C" fn nlmsg_sock_has_extended_perms(sk: *mut sock, perms: u32, nlmsg_type: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_netlink_send(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int selinux_netlink_send(struct sock *sk, struct sk_buff *skb)
    {
    let mut rc: c_int = 0;
    unsigned int msg_len;
    let mut data_len: c_uint = skb.len;
    unsigned char *data = skb.data;
    struct nlmsghdr *nlh;
    struct sk_security_struct *sksec = selinux_sock(sk);
    let mut sclass: u16 = sksec.sclass;
    u32 perm;
...
#[no_mangle]
unsafe extern "C" fn ipc_init_security(isec: *mut ipc_security_struct, sclass: u16) {
...
#[no_mangle]
unsafe extern "C" fn selinux_msg_msg_alloc_security(msg: *mut msg_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_msg_queue_alloc_security(msq: *mut kern_ipc_perm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_msg_queue_associate(msq: *mut kern_ipc_perm, msqflg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_msg_queue_msgctl(msq: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
// No specific object, just general system-wide information.
    return avc_has_perm(current_sid(), SECINITSID_KERNEL,
    SECCLASS_SYSTEM, SYSTEM__IPC_INFO, core::ptr::null_mut());
    case IPC_STAT:
    case MSG_STAT:
    case MSG_STAT_ANY:
...
#[no_mangle]
unsafe extern "C" fn selinux_msg_queue_msgsnd(msq: *mut kern_ipc_perm, msg: *mut msg_msg, msqflg: c_int) -> c_int {
...
//
    ...
    SECCLASS_MSG, core::ptr::null_mut(), &msec.sid);
    if (rc)
    return rc;
    }
    ad.type = LSM_AUDIT_DATA_IPC;
...
// Can the message be put in the queue?
    ...
    struct msg_security_struct *msec;
    struct common_audit_data ad;
    let mut sid: u32 = task_sid_obj(target);
    int rc;
    isec = selinux_ipc(msq);
    msec = selinux_msg_msg(msg);
    ad.type = LSM_AUDIT_DATA_IPC;
...
#[no_mangle]
unsafe extern "C" fn selinux_shm_alloc_security(shp: *mut kern_ipc_perm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_shm_associate(shp: *mut kern_ipc_perm, shmflg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_shm_shmctl(shp: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_sem_alloc_security(sma: *mut kern_ipc_perm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_sem_associate(sma: *mut kern_ipc_perm, semflg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_sem_semctl(sma: *mut kern_ipc_perm, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_ipc_permission(ipcp: *mut kern_ipc_perm, flag: c_short) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_d_instantiate(dentry: *mut dentry, inode: *mut inode) {
    ...
    SECCLASS_PROCESS, PROCESS__GETATTR, core::ptr::null_mut());
    if (error)
    goto err_unlock;
    }
    switch (attr) {
...
#[no_mangle]
unsafe extern "C" fn selinux_lsm_setattr(attr: u64, value: *mut c_void, size: usize) -> c_int {
    static int selinux_lsm_setattr(u64 attr, void *value, size_t size)
    {
    struct cred_security_struct *crsec;
    struct cred *new;
    let mut mysid: u32 = current_sid(), sid = 0, ptsid;
    int error;
    char *str = value;
//
...
//
    ...
    PROCESS__SETEXEC, core::ptr::null_mut());
    break;
    case LSM_ATTR_FSCREATE:
    error = avc_has_perm(mysid, mysid, SECCLASS_PROCESS,
    PROCESS__SETFSCREATE, core::ptr::null_mut());
    break;
    case LSM_ATTR_KEYCREATE:
    error = avc_has_perm(mysid, mysid, SECCLASS_PROCESS,
    PROCESS__SETKEYCREATE, core::ptr::null_mut());
    break;
    case LSM_ATTR_SOCKCREATE:
    error = avc_has_perm(mysid, mysid, SECCLASS_PROCESS,
    PROCESS__SETSOCKCREATE, core::ptr::null_mut());
    break;
    case LSM_ATTR_CURRENT:
    error = avc_has_perm(mysid, mysid, SECCLASS_PROCESS,
    PROCESS__SETCURRENT, core::ptr::null_mut());
    break;
    default:
    error = -EOPNOTSUPP;
    break;
...
// Permission checking based on the specified context is
    ...
    SECCLASS_KEY, KEY__CREATE, core::ptr::null_mut());
    if (error)
    goto abort_change;
    }
...
// Check permissions for the transition.
    ...
    PROCESS__DYNTRANSITION, core::ptr::null_mut());
    if (error)
    goto abort_change;
...
//
    ...
    {
    let mut attr: c_uint = lsm_name_to_attr(name);
    int rc;
    if (attr) {
...
#[no_mangle]
unsafe extern "C" fn selinux_setprocattr(name: *const c_char, value: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_ismaclabel(name: *const c_char) -> c_int {
    static int selinux_ismaclabel(const char *name)
    {
    return (strcmp(name, XATTR_SELINUX_SUFFIX) == 0);
    }
#[no_mangle]
unsafe extern "C" fn selinux_secid_to_secctx(secid: u32, cp: *mut lsm_context) -> c_int {
    ...
    ret = security_sid_to_context(secid, core::ptr::null_mut(), &seclen);
    if (ret < 0)
    return ret;
    return seclen;
    }
...
#[no_mangle]
unsafe extern "C" fn selinux_secctx_to_secid(secdata: *const c_char, seclen: u32, secid: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_release_secctx(cp: *mut lsm_context) {
...
#[no_mangle]
unsafe extern "C" fn selinux_inode_invalidate_secctx(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_inode_notifysecctx(inode: *mut inode, ctx: *mut c_void, ctxlen: u32) -> c_int {
    static int selinux_inode_notifysecctx(struct inode *inode, void *ctx, u32 ctxlen)
    {
    int rc = selinux_inode_setsecurity(inode, XATTR_SELINUX_SUFFIX,
    ctx, ctxlen, 0);
// Do not return error when suppressing label (SBLABEL_MNT not set).
    let mut rc: return = = -EOPNOTSUPP ? 0 : rc;
    }
//
// called with inode->i_mutex locked
//
#[no_mangle]
unsafe extern "C" fn selinux_inode_setsecctx(dentry: *mut dentry, ctx: *mut c_void, ctxlen: u32) -> c_int {
    static int selinux_inode_setsecctx(struct dentry *dentry, void *ctx, u32 ctxlen)
    {
    return __vfs_setxattr_locked(&nop_mnt_idmap, dentry, XATTR_NAME_SELINUX,
    ctx, ctxlen, 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_inode_getsecctx(inode: *mut inode, cp: *mut lsm_context) -> c_int {
    ...
    return avc_has_perm(sid, ksec.sid, SECCLASS_KEY, perm, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_key_getsecurity(key: *mut key, _buffer: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_watch_key(key: *mut key) -> c_int {
    static int selinux_watch_key(struct key *key)
    {
    struct key_security_struct *ksec = selinux_key(key);
    let mut sid: u32 = current_sid();
    return avc_has_perm(sid, ksec.sid, SECCLASS_KEY, KEY__VIEW, core::ptr::null_mut());
    }

#[no_mangle]
unsafe extern "C" fn selinux_ib_pkey_access(ib_sec: *mut c_void, subnet_prefix: u64, pkey_val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_ib_alloc_security(ib_sec: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_map_fmode_to_av(fmode: fmode_t) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn bpf_fd_pass(file: *const file, sid: u32) -> c_int {
    static int bpf_fd_pass(const struct file *file, u32 sid)
    {
    ...
    bpf_map_fmode_to_av(file.f_mode), core::ptr::null_mut());
    if (ret)
    return ret;
    ...
    ret = avc_has_perm(sid, bpfsec.sid, SECCLASS_BPF,
    BPF__PROG_RUN, core::ptr::null_mut());
    if (ret)
    return ret;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn selinux_bpf_map(map: *mut bpf_map, fmode: fmode_t) -> c_int {
    ...
    bpf_map_fmode_to_av(fmode), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_bpf_prog(prog: *mut bpf_prog) -> c_int {
...
//
    ...
    SECCLASS_BPF, BPF__MAP_CREATE_AS, core::ptr::null_mut());
    if (err)
    return err;
    ...
    err = avc_has_perm(bpfsec.sid, bpfsec.grantor_sid,
    SECCLASS_BPF, BPF__PROG_LOAD_AS, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn selinux_bpf_token_capable(token: *const bpf_token, cap: c_int) -> c_int {
    static int selinux_bpf_token_capable(const struct bpf_token *token, int cap)
    {
    u16 sclass;
    struct bpf_security_struct *bpfsec = token.security;
    let mut initns: bool = (token.userns == &init_user_ns);
    let mut av: u32 = CAP_TO_MASK(cap);
    switch (CAP_TO_INDEX(cap)) {
    case 0:
    sclass = initns ? SECCLASS_CAPABILITY : SECCLASS_CAP_USERNS;
...
#[no_mangle]
unsafe extern "C" fn selinux_perf_event_open(type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PERF_SECURITY_CPU: type ==) -> else {
    else if (type == PERF_SECURITY_CPU)
    requested = PERF_EVENT__CPU;
#[no_mangle]
pub unsafe extern "C" fn if(PERF_SECURITY_KERNEL: type ==) -> else {
    else if (type == PERF_SECURITY_KERNEL)
    requested = PERF_EVENT__KERNEL;
#[no_mangle]
pub unsafe extern "C" fn if(PERF_SECURITY_TRACEPOINT: type ==) -> else {
    else if (type == PERF_SECURITY_TRACEPOINT)
    requested = PERF_EVENT__TRACEPOINT;
    else
    return -EINVAL;
    return avc_has_perm(sid, sid, SECCLASS_PERF_EVENT,
    requested, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_perf_event_alloc(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_perf_event_read(event: *mut perf_event) -> c_int {
    static int selinux_perf_event_read(struct perf_event *event)
    {
    struct perf_event_security_struct *perfsec = event.security;
    let mut sid: u32 = current_sid();
    return avc_has_perm(sid, perfsec.sid,
    SECCLASS_PERF_EVENT, PERF_EVENT__READ, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn selinux_perf_event_write(event: *mut perf_event) -> c_int {
    static int selinux_perf_event_write(struct perf_event *event)
    {
    struct perf_event_security_struct *perfsec = event.security;
    let mut sid: u32 = current_sid();
    return avc_has_perm(sid, perfsec.sid,
    SECCLASS_PERF_EVENT, PERF_EVENT__WRITE, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn selinux_uring_override_creds(new: *const cred) -> c_int {
    static int selinux_uring_override_creds(const struct cred *new)
    {
    return avc_has_perm(current_sid(), cred_sid(new),
    SECCLASS_IO_URING, IO_URING__OVERRIDE_CREDS, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn selinux_uring_sqpoll() -> c_int {
    static int selinux_uring_sqpoll(void)
    {
    let mut sid: u32 = current_sid();
    return avc_has_perm(sid, sid,
    SECCLASS_IO_URING, IO_URING__SQPOLL, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn selinux_uring_cmd(ioucmd: *mut io_uring_cmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_uring_allowed() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn selinux_init() -> __init int {
    static __init int selinux_init(void)
    {
    let mut data_default_flags: vma_flags_t = VMA_DATA_DEFAULT_FLAGS;
...
#[no_mangle]
unsafe extern "C" fn delayed_superblock_init(sb: *mut super_block, unused: *mut c_void) {
    static void delayed_superblock_init(struct super_block *sb, void *unused)
    {
    selinux_set_mnt_opts(sb, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn selinux_complete_init() {
    void selinux_complete_init(void)
    {
    pr_debug("SELinux:  Completing initialization.\n");
// Set up any superblocks initialized prior to the policy load.
    pr_debug("SELinux:  Setting up existing superblocks.\n");
    iterate_supers(delayed_superblock_init, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn selinux_nf_register(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn selinux_nf_unregister(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn selinux_nf_ip_init() -> int __init {
