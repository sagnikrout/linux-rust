...
//! Source: security/selinux/xfrm.c
#![no_std]
...
// Labeled XFRM instance counter
    let mut __read_mostly: atomic_t selinux_xfrm_refcount = ATOMIC_INIT(0);
//
// Returns true if the context is an LSM/SELinux context.
//
#[no_mangle]
pub unsafe extern "C" fn selinux_authorizable_ctx(ctx: *mut xfrm_sec_ctx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn selinux_authorizable_xfrm(x: *mut xfrm_state) -> c_int {
...
//
    ...
    {
    int rc;
    struct xfrm_sec_ctx *ctx = core::ptr::null_mut();
    u32 str_len;
    if (ctxp == core::ptr::null_mut() || uctx == core::ptr::null_mut() ||
    ...
    SECCLASS_ASSOCIATION, ASSOCIATION__SETCONTEXT, core::ptr::null_mut());
    if (rc)
    goto err;
// ctxp = ctx;
...
//
#[no_mangle]
unsafe extern "C" fn selinux_xfrm_free(ctx: *mut xfrm_sec_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn selinux_xfrm_delete(ctx: *mut xfrm_sec_ctx) -> c_int {
...
// Context sid is either set to label or ANY_ASSOC
    ...
    SECCLASS_ASSOCIATION, ASSOCIATION__POLMATCH, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn selinux_xfrm_skb_sid_egress(skb: *mut sk_buff) -> u32 {
    ...
    return SECSID_NULL;
    x = dst.xfrm;
    if (x == core::ptr::null_mut() || !selinux_authorizable_xfrm(x))
    return SECSID_NULL;
...
//
#[no_mangle]
pub unsafe extern "C" fn selinux_xfrm_decode_session(skb: *mut sk_buff, sid: *mut u32, ckall: c_int) -> c_int {
...
//
    ...
    char *ctx_str = core::ptr::null_mut();
    u32 str_len;
    if (!polsec)
    return 0;
    if (secid == 0)
...
// check.
    ...
    for (iter = dst; iter != core::ptr::null_mut(); iter = xfrm_dst_child(iter)) {
