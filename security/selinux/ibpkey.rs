...
//! Source: security/selinux/ibpkey.c
#![no_std]
...
pub const SEL_PKEY_HASH_SIZE: c_int = 256;
pub const SEL_PKEY_HASH_BKT_LIMIT: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
...
//
#[no_mangle]
unsafe extern "C" fn sel_ib_pkey_hashfn(pkey: u16) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn sel_ib_pkey_insert(pkey: *mut sel_ib_pkey) {
...
//
#[no_mangle]
unsafe extern "C" fn sel_ib_pkey_sid_slow(subnet_prefix: u64, pkey_num: u16, sid: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sel_ib_pkey_sid(subnet_prefix: u64, pkey_num: u16, sid: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sel_ib_pkey_init() -> int __init {
