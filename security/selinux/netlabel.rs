...
//! Source: security/selinux/netlabel.c
#![no_std]
...
//
    ...
    struct netlbl_lsm_secattr *secattr;
    if (sksec.nlbl_secattr != core::ptr::null_mut())
    return sksec.nlbl_secattr;
    secattr = netlbl_secattr_alloc(GFP_ATOMIC);
    if (secattr == core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn selinux_netlbl_err(skb: *mut sk_buff, family: u16, error: c_int, gateway: c_int) {
...
//
    ...
    struct netlbl_lsm_secattr *secattr = core::ptr::null_mut();
    struct sock *sk;
...
//
#[no_mangle]
pub unsafe extern "C" fn selinux_netlbl_inet_conn_request(req: *mut request_sock, family: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn selinux_netlbl_option(level: c_int, optname: c_int) -> c_int {
...
// and not the cached netlabel/lsm attributes
    ...
    rc = -EACCES;
#[no_mangle]
pub unsafe extern "C" fn if(-ENOMSG: rc ==) -> else {
    else if (rc == -ENOMSG)
    rc = 0;
    netlbl_secattr_destroy(&secattr);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn selinux_netlbl_socket_connect(sk: *mut sock, addr: *mut sockaddr) -> c_int {
