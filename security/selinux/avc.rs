...
pub const AVC_CACHE_RECLAIM: c_int = 16;
...
pub struct avc_entry {
    ...
    pub tclass: u16,
    pub avd: av_decision,
    pub xp_node: *mut avc_xperms_node,
}
...
pub struct avc_node {
    pub ae: avc_entry,
    pub /: *mut *mut hlist_node list; / anchored in avc_cache->slots[i],
    pub rhead: rcu_head,
}
...
pub struct avc_xperms_decision_node {
    pub xpd: extended_perms_decision,
    pub /: *mut *mut list_head xpd_list; / list of extended_perms_decision,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct avc_xperms_node {
    pub xp: extended_perms,
    pub /: *mut *mut list_head xpd_head; / list head of extended_perms_decision,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct avc_cache {
    pub /: *mut *mut hlist_head slots[AVC_CACHE_SLOTS]; / head for avc_node->list,
    pub /: *mut *mut spinlock_t slots_lock[AVC_CACHE_SLOTS]; / lock for writes,
    pub /: *mut *mut atomic_t lru_hint; / LRU hint for reclaim scan,
    pub active_nodes: core::sync::atomic::AtomicI32,
    pub /: *mut *mut u32 latest_notif; / latest revocation notification,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct avc_callback_node {
    pub event): *mut *mut int (callback) (u32,
    pub events: u32,
    pub next: *mut avc_callback_node,
}
...
pub struct selinux_avc {
    pub avc_cache_threshold: c_uint,
    pub avc_cache: avc_cache,
}
...
#[no_mangle]
pub unsafe extern "C" fn avc_hash(ssid: u32, tsid: u32, tclass: u16) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn avc_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn avc_xperms_decision_free(xpd_node: *mut avc_xperms_decision_node) {
...
#[no_mangle]
unsafe extern "C" fn avc_xperms_free(xp_node: *mut avc_xperms_node) {
...
#[no_mangle]
unsafe extern "C" fn avc_node_delete(node: *mut avc_node) {
...
#[no_mangle]
unsafe extern "C" fn avc_node_kill(node: *mut avc_node) {
...
#[no_mangle]
unsafe extern "C" fn avc_node_replace(new: *mut avc_node, old: *mut avc_node) {
...
#[no_mangle]
pub unsafe extern "C" fn avc_reclaim_node() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avc_node_populate(node: *mut avc_node, ssid: u32, tsid: u32, tclass: u16, avd: *mut av_decision) {
    ...
    {
    struct avc_node *node, *ret = core::ptr::null_mut();
    u32 hvalue;
    struct hlist_head *head;
...
#[no_mangle]
unsafe extern "C" fn avc_latest_notif_update(seqno: u32, is_insert: c_int) -> c_int {
...
//
    ...
    {
    struct avc_node *pos, *node = core::ptr::null_mut();
    u32 hvalue;
    unsigned long flag;
    spinlock_t *lock;
    struct hlist_head *head;
...
unsafe extern "C" fn avc_audit_pre_callback(ab: *mut audit_buffer, a: *mut c_void) {
    ...
    let mut av: u32 = sad.audited, perm;
...
unsafe extern "C" fn avc_audit_post_callback(ab: *mut audit_buffer, a: *mut c_void) {
    ...
    char *tcontext = core::ptr::null_mut();
    const char *tclass = core::ptr::null_mut();
    u32 scontext_len;
    u32 tcontext_len;
    int rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn avc_add_callback(event): *mut *mut int (callback)(u32, events: u32) -> int __init {
...
//
    ...
    let mut rc: c_int = 0;
    unsigned long flag;
    struct avc_node *pos, *node, *orig = core::ptr::null_mut();
    struct hlist_head *head;
    spinlock_t *lock;
    node = avc_alloc_node();
    if (!node) {
...
//
    ...
    xperm, ssid, tsid, tclass, avd.seqno, core::ptr::null_mut(), flags);
    return 0;
    }
//
...
//
    ...
    struct extended_perms_decision *xpd = core::ptr::null_mut();
    struct extended_perms_data allowed;
    struct extended_perms_data auditallow;
    struct extended_perms_data dontaudit;
    struct avc_xperms_node local_xp_node;
    struct avc_xperms_node *xp_node;
    let mut rc: c_int = 0, rc2;
