...
//! Source: security/integrity/ima/ima_crypto.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ima_init_ima_crypto() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ima_init_crypto() -> int __init {
...
// unknown TPM algorithm
    ...
    ima_algo_array[i].tfm = core::ptr::null_mut();
    goto out_array;
    }
    ima_algo_array[i].tfm = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ima_free_tfm(tfm: *mut crypto_shash) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_calc_file_hash(file: *mut file, hash: *mut ima_digest_data) -> c_int {
...
//
    ...
    let mut num_fields: c_int = entry.template_desc.num_fields;
    int rc, i;
    ...
    let mut datalen: u32 = field_data[i].len;
    u32 datalen_to_hash = !ima_canonical_fmt ?
    datalen : ( u32)cpu_to_le32(datalen);
...
#[no_mangle]
unsafe extern "C" fn ima_pcrread(idx: u32, d: *mut tpm_digest) {
...
//
    ...
    struct crypto_shash *tfm)
    {
    let mut d: tpm_digest = { .alg_id = alg_id, .digest = {0} };
    int rc;
    u32 i;
    SHASH_DESC_ON_STACK(shash, tfm);
    shash.tfm = tfm;
...
#[no_mangle]
pub unsafe extern "C" fn ima_calc_boot_aggregate(hash: *mut ima_digest_data) -> c_int {
