...
//! Source: security/integrity/ima/ima_queue.c
#![no_std]
...
pub const AUDIT_CAUSE_LEN_MAX: c_int = 32;
    bool ima_flush_htable;
#[no_mangle]
unsafe extern "C" fn ima_flush_htable_setup(str: *mut c_char) -> int __init {
...
// pre-allocated array of tpm_digest structures to extend a PCR
    ...
    let mut ima_num_violations: atomic_long_t = ATOMIC_LONG_INIT(0);
...
#[no_mangle]
pub unsafe extern "C" fn ima_init_htable() -> int __init {
...
// lookup up the digest value in the hash table, and return the entry
    ...
    int pcr)
    {
    struct ima_queue_entry *qe, *ret = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn get_binary_runtime_size(entry: *mut ima_template_entry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_get_binary_runtime_size(binary_list: enum binary_lists) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn ima_pcr_extend(digests_arg: *mut tpm_digest, pcr: c_int) -> c_int {
...
//
    ...
    let mut result: c_int = 0, tpmresult = 0;
    mutex_lock(&ima_extend_list_mutex);
//
...
pub unsafe extern "C" fn ima_queue_staged_delete_all() -> c_int {
    ...
    {
    struct hlist_head *old_queue = core::ptr::null_mut();
...
pub unsafe extern "C" fn ima_queue_delete_partial(req_value: c_ulong) -> c_int {
    ...
    let mut size_to_remove: c_ulong = 0, num_to_remove = 0;
    LIST_HEAD(ima_measurements_trim);
    struct ima_queue_entry *qe;
    let mut ret: c_int = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn ima_queue_delete(head: *mut list_head, flush_htable: bool) {
    static void ima_queue_delete(struct list_head *head, bool flush_htable)
    {
...
//
    ...
    qe.entry.template_data[i].data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ima_measurements_suspend() {
...
#[no_mangle]
pub unsafe extern "C" fn ima_init_reboot_notifier() -> void __init {
    void __init ima_init_reboot_notifier(void)
    {
    register_reboot_notifier(&ima_reboot_nb);
    }
#[no_mangle]
pub unsafe extern "C" fn ima_init_digests() -> int __init {
