...
//! Source: security/integrity/ima/ima_main.c
#![no_std]
...
//
    ...
    let mut ima_appraise: c_int = IMA_APPRAISE_ENFORCE;

    int ima_appraise;

    let mut ima_hash_algo: int __ro_after_init = HASH_ALGO_SHA1;
...
#[no_mangle]
unsafe extern "C" fn ima_setup(str: *mut c_char) -> int __init {
    ...
    ima_disabled = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(str, _arg: "on", 0: 2) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn hash_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ima_get_current_hash_algo() -> enum hash_algo {
...
//
    ...
    let mut mode: fmode_t = file.f_mode;
    let mut send_tomtou: bool = false, send_writers = false;
    if (mode & FMODE_WRITE) {
...
//
#[no_mangle]
unsafe extern "C" fn ima_file_free(file: *mut file) {
    ...
    struct ima_iint_cache *iint = core::ptr::null_mut();
    struct ima_template_desc *template_desc = core::ptr::null_mut();
    struct inode *metadata_inode;
    char *pathbuf = core::ptr::null_mut();
    char filename[NAME_MAX];
    const char *pathname = core::ptr::null_mut();
    let mut rc: c_int = 0, action, must_appraise = 0;
    let mut pcr: c_int = CONFIG_IMA_MEASURE_PCR_IDX;
    struct evm_ima_xattr_data *xattr_value = core::ptr::null_mut();
    struct modsig *modsig = core::ptr::null_mut();
    let mut xattr_len: c_int = 0;
    bool violation_check;
    enum hash_algo hash_algo;
    let mut allowed_algos: c_uint = 0;
    if (!ima_policy_flag || !S_ISREG(inode.i_mode))
    return 0;
...
//
    ...
    mask, func, &pcr, &template_desc, core::ptr::null_mut(),
    &allowed_algos);
...
//
    ...
    ret = process_measurement(file, current_cred(), &prop, core::ptr::null_mut(),
    ...
    if (prot & PROT_EXEC)
    return process_measurement(file, current_cred(), &prop, core::ptr::null_mut(),
...
//
    ...
    unsigned long prot)
    {
    struct ima_template_desc *template = core::ptr::null_mut();
    struct file *file;
    char filename[NAME_MAX];
    char *pathbuf = core::ptr::null_mut();
    const char *pathname = core::ptr::null_mut();
...
// Is mprotect making an mmap'ed file executable?
    ...
    &pcr, &template, core::ptr::null_mut(), core::ptr::null_mut());
    action |= ima_get_action(file_mnt_idmap(vma.vm_file), inode,
    current_cred(), &prop, MAY_EXEC,
    MMAP_CHECK_REQPROT, &pcr, &template, core::ptr::null_mut(),
    core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ima_bprm_check(bprm: *mut linux_binprm) -> c_int {
    static int ima_bprm_check(struct linux_binprm *bprm)
    {
    struct lsm_prop prop;
    security_current_getlsmprop_subj(&prop);
    return process_measurement(bprm.file, current_cred(),
    &prop, core::ptr::null_mut(), 0, MAY_EXEC, BPRM_CHECK, 0,
    bprm.is_check);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ima_creds_check(bprm: *mut linux_binprm, file: *const file) -> c_int {
    static int ima_creds_check(struct linux_binprm *bprm, const struct file *file)
    {
    struct lsm_prop prop;
    security_current_getlsmprop_subj(&prop);
    return process_measurement((struct file *)file, bprm.cred, &prop, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn ima_bprm_creds_for_exec(bprm: *mut linux_binprm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ima_file_check(file: *mut file, mask: c_int) -> c_int {
    static int ima_file_check(struct file *file, int mask)
    {
    struct lsm_prop prop;
    security_current_getlsmprop_subj(&prop);
    return process_measurement(file, current_cred(), &prop, core::ptr::null_mut(), 0,
...
//
#[no_mangle]
unsafe extern "C" fn ima_reset_action_flags(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn ima_path_truncate(path: *const path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ima_file_truncate(file: *mut file) -> c_int {
    ...
    size_t buf_size)
    {
    struct ima_iint_cache *iint = core::ptr::null_mut(), tmp_iint;
    int rc, hash_algo;
    if (ima_policy_flag) {
    iint = ima_iint_find(inode);
    if (iint)
    ...
    rc = ima_collect_measurement(&tmp_iint, file, core::ptr::null_mut(), 0,
    ima_hash_algo, core::ptr::null_mut());
    if (rc < 0) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_file_hash(file: *mut file, buf: *mut c_char, buf_size: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_inode_hash(inode: *mut inode, buf: *mut c_char, buf_size: usize) -> c_int {
    int ima_inode_hash(struct inode *inode, char *buf, size_t buf_size)
    {
    if (!inode)
    return -EINVAL;
    return __ima_inode_hash(inode, core::ptr::null_mut(), buf, buf_size);
    }
...
//
#[no_mangle]
unsafe extern "C" fn ima_post_path_mknod(idmap: *mut mnt_idmap, dentry: *mut dentry) {
...
//
#[no_mangle]
unsafe extern "C" fn ima_load_data(id: enum kernel_load_data_id, contents: bool) -> c_int {
...
//
    ...
    buf, size, true, core::ptr::null_mut(), 0);
    return 0;
    }
//
...
//
    ...
    struct ima_template_entry *entry = core::ptr::null_mut();
    let mut iint: ima_iint_cache = {};
    ...
    let mut digest_hash_len: c_int = hash_digest_size[ima_hash_algo];
    let mut violation: c_int = 0;
...
//
    ...
    ret = ima_store_template(entry, violation, core::ptr::null_mut(), event_data.buf, pcr);
    if (ret < 0) {
    ...
    out:
    if (ret < 0)
    integrity_audit_message(AUDIT_INTEGRITY_PCR, core::ptr::null_mut(), eventname,
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_kexec_cmdline(kernel_fd: c_int, buf: *const c_void, size: c_int) {
    ...
    core::ptr::null_mut(), false, core::ptr::null_mut(), 0);
    }
//
...
//
    ...
    return -ENOPARAM;
    return process_buffer_measurement(&nop_mnt_idmap, core::ptr::null_mut(), buf, buf_len,
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_measure_raw_policy(buf: *const c_char, buf_len: usize) -> c_int {
    ...
    0, core::ptr::null_mut(), false, core::ptr::null_mut(), 0);
    }
...
//
#[no_mangle]
unsafe extern "C" fn ima_kernel_module_request(kmod_name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_ima() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_ima_lsm() -> int __init {
