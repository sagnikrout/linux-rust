...
//! Source: security/integrity/ima/ima_api.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_free_template_entry(entry: *mut ima_template_entry) {
...
//
    ...
    {
    let mut flags: c_int = IMA_MEASURE | IMA_AUDIT | IMA_APPRAISE | IMA_HASH;
...
// hash containing 0's.
//
    digest_len = fsverity_get_digest(inode, hash.digest, core::ptr::null_mut(), &alg);
    if (digest_len == 0)
    return false;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_I_VERSION(real_inode)) -> else {
