...
//! Source: security/integrity/ima/ima_policy.c
#![no_std]
...
// flags definitions
pub const IMA_FUNC: c_uint = 0x0001;
pub const IMA_MASK: c_uint = 0x0002;
pub const IMA_FSMAGIC: c_uint = 0x0004;
pub const IMA_UID: c_uint = 0x0008;
pub const IMA_FOWNER: c_uint = 0x0010;
pub const IMA_FSUUID: c_uint = 0x0020;
pub const IMA_INMASK: c_uint = 0x0040;
pub const IMA_EUID: c_uint = 0x0080;
pub const IMA_PCR: c_uint = 0x0100;
pub const IMA_FSNAME: c_uint = 0x0200;
pub const IMA_KEYRINGS: c_uint = 0x0400;
pub const IMA_LABEL: c_uint = 0x0800;
pub const IMA_VALIDATE_ALGOS: c_uint = 0x1000;
pub const IMA_GID: c_uint = 0x2000;
pub const IMA_EGID: c_uint = 0x4000;
pub const IMA_FGROUP: c_uint = 0x8000;
pub const IMA_FS_SUBTYPE: c_uint = 0x10000;
pub const UNKNOWN: c_int = 0;
pub const MEASURE: c_uint = 0x0001	/* same as IMA_MEASURE */;
pub const DONT_MEASURE: c_uint = 0x0002;
pub const APPRAISE: c_uint = 0x0004	/* same as IMA_APPRAISE */;
pub const DONT_APPRAISE: c_uint = 0x0008;
pub const AUDIT: c_uint = 0x0040;
pub const DONT_AUDIT: c_uint = 0x0080;
pub const HASH: c_uint = 0x0100;
pub const DONT_HASH: c_uint = 0x0200;
...
pub const MAX_LSM_RULES: c_int = 6;
...
pub struct ima_rule_opt_list {
    pub count: usize,
    pub __counted_by(count): *mut *mut char items[],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn vfsuid_gt_kuid(vfsuid: vfsuid_t, kuid: kuid_t) -> bool {
    static inline bool vfsuid_gt_kuid(vfsuid_t vfsuid, kuid_t kuid)
    {
    return __vfsuid_val(vfsuid) > __kuid_val(kuid);
    }
#[no_mangle]
pub unsafe extern "C" fn vfsgid_gt_kgid(vfsgid: vfsgid_t, kgid: kgid_t) -> bool {
    static inline bool vfsgid_gt_kgid(vfsgid_t vfsgid, kgid_t kgid)
    {
    return __vfsgid_val(vfsgid) > __kgid_val(kgid);
    }
#[no_mangle]
pub unsafe extern "C" fn vfsuid_lt_kuid(vfsuid: vfsuid_t, kuid: kuid_t) -> bool {
    static inline bool vfsuid_lt_kuid(vfsuid_t vfsuid, kuid_t kuid)
    {
    return __vfsuid_val(vfsuid) < __kuid_val(kuid);
    }
#[no_mangle]
pub unsafe extern "C" fn vfsgid_lt_kgid(vfsgid: vfsgid_t, kgid: kgid_t) -> bool {
...
pub struct ima_rule_entry {
    ...
    pub fowner: kuid_t,
    pub fgroup: kgid_t,
    pub /: *mut *mut *mut bool (uid_op)(kuid_t cred_uid, kuid_t rule_uid); / Handlers for operators,
    pub rule_gid): *mut *mut bool (gid_op)(kgid_t cred_gid, kgid_t,
    pub /: *mut *mut *mut bool (fowner_op)(vfsuid_t vfsuid, kuid_t rule_uid); / vfsuid_eq_kuid(), vfsuid_gt_kuid(), vfsuid_lt_kuid(),
    pub /: *mut *mut *mut bool (fgroup_op)(vfsgid_t vfsgid, kgid_t rule_gid); / vfsgid_eq_kgid(), vfsgid_gt_kgid(), vfsgid_lt_kgid(),
    pub pcr: c_int,
    pub /: *mut *mut unsigned int allowed_algos; / bitfield of allowed hash algorithms,
    struct {
    pub /: *mut *mut *mut void rule; / LSM file metadata specific,
    pub /: *mut *mut *mut char args_p; / audit value,
    pub /: *mut *mut int type; / audit type,
    pub lsm: [}; MAX_LSM_RULES],
    pub fsname: *mut c_char,
    pub fs_subtype: *mut c_char,
    pub /: *mut *mut *mut ima_rule_opt_list keyrings; / Measure keys added to these keyrings,
    pub /: *mut *mut *mut ima_rule_opt_list label; / Measure data grouped under this label,
...
#[no_mangle]
unsafe extern "C" fn default_measure_policy_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn policy_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(p, 0: "appraise_tcb") ==) -> else {
    else if (strcmp(p, "appraise_tcb") == 0)
    ima_use_appraise_tcb = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(p, 0: "secure_boot") ==) -> else {
    else if (strcmp(p, "secure_boot") == 0)
    ima_use_secure_boot = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(p, 0: "critical_data") ==) -> else {
    else if (strcmp(p, "critical_data") == 0)
    ima_use_critical_data = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(p, 0: "fail_securely") ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn default_appraise_policy_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ima_free_rule_opt_list(opt_list: *mut ima_rule_opt_list) {
...
#[no_mangle]
unsafe extern "C" fn ima_lsm_free_rule(entry: *mut ima_rule_entry) {
...
#[no_mangle]
unsafe extern "C" fn ima_free_rule(entry: *mut ima_rule_entry) {
...
#[no_mangle]
unsafe extern "C" fn ima_lsm_update_rule(entry: *mut ima_rule_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ima_rule_contains_lsm_cond(entry: *mut ima_rule_entry) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ima_lsm_update_rules() {
...
//
    ...
    {
    const struct ima_rule_opt_list *opt_list = core::ptr::null_mut();
...
//
    ...
    let mut rule_reinitialized: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn get_subaction(rule: *mut ima_rule_entry, func: enum ima_hooks) -> c_int {
...
//
    ...
    let mut action: c_int = 0, actmask = flags | (flags << 1);
...
pub unsafe extern "C" fn ima_update_policy_flags() {
    ...
    {
    struct ima_rule_entry *entry;
    let mut new_policy_flag: c_int = 0;
    struct list_head *ima_rules_tmp;
    rcu_read_lock();
    ima_rules_tmp = rcu_dereference(ima_rules);
    list_for_each_entry_rcu(entry, ima_rules_tmp, list) {
...
#[no_mangle]
unsafe extern "C" fn ima_appraise_flag(func: enum ima_hooks) -> c_int {
    static int ima_appraise_flag(enum ima_hooks func)
    {
    if (func == MODULE_CHECK)
    return IMA_APPRAISE_MODULES;
#[no_mangle]
pub unsafe extern "C" fn if(FIRMWARE_CHECK: func ==) -> else {
    else if (func == FIRMWARE_CHECK)
    return IMA_APPRAISE_FIRMWARE;
#[no_mangle]
pub unsafe extern "C" fn if(POLICY_CHECK: func ==) -> else {
    else if (func == POLICY_CHECK)
    return IMA_APPRAISE_POLICY;
#[no_mangle]
pub unsafe extern "C" fn if(KEXEC_KERNEL_CHECK: func ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ima_init_arch_policy() -> int __init {
    static int __init ima_init_arch_policy(void)
    {
    const char * const *arch_rules;
    const char * const *rules;
    let mut arch_entries: c_int = 0;
    let mut i: c_int = 0;
    arch_rules = arch_get_ima_policy();
    if (!arch_rules)
    return arch_entries;
// Get number of rules
    for (rules = arch_rules; *rules != core::ptr::null_mut(); rules++)
    arch_entries++;
    arch_policy_entry = kzalloc_objs(*arch_policy_entry, arch_entries + 1);
    if (!arch_policy_entry)
    return 0;
// Convert each policy string rules to struct ima_rule_entry format
    for (rules = arch_rules, i = 0; *rules != core::ptr::null_mut(); rules++) {
    char rule[255];
    int result;
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_init_policy() -> void __init {
...
// Keep the enumeration in sync with the policy_tokens!
    ...
    entry.lsm[lsm_rule].args_p = core::ptr::null_mut();
    result = -EINVAL;
    } else
    result = 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ima_log_string(ab: *mut audit_buffer, key: *mut c_char, value: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn check_template_modsig(template: *const ima_template_desc) {
...
// We only need to notify the user once.
    ...
    has_modsig = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(template->fields[i]->field_id, _arg: "d-modsig")) -> else {
...
#[no_mangle]
unsafe extern "C" fn ima_validate_rule(entry: *mut ima_rule_entry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ima_parse_appraise_algos(arg: *mut c_char) -> c_uint {
    static unsigned int ima_parse_appraise_algos(char *arg)
    {
    let mut res: c_uint = 0;
    int idx;
    char *token;
    while ((token = strsep(&arg, ",")) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ima_parse_rule(rule: *mut c_char, entry: *mut ima_rule_entry) -> c_int {
    static int ima_parse_rule(char *rule, struct ima_rule_entry *entry)
    {
    ...
    while ((p = strsep(&rule, " \t")) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "PATH_CHECK") ==) -> else {
    else if (strcmp(args[0].from, "PATH_CHECK") == 0)
    entry.func = FILE_CHECK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "MODULE_CHECK") ==) -> else {
    else if (strcmp(args[0].from, "MODULE_CHECK") == 0)
    entry.func = MODULE_CHECK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "FIRMWARE_CHECK") ==) -> else {
    else if (strcmp(args[0].from, "FIRMWARE_CHECK") == 0)
    entry.func = FIRMWARE_CHECK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: (strcmp(args[0].from, 0: "FILE_MMAP") ==) -> else {
    else if ((strcmp(args[0].from, "FILE_MMAP") == 0)
    || (strcmp(args[0].from, "MMAP_CHECK") == 0))
    entry.func = MMAP_CHECK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: (strcmp(args[0].from, 0): "MMAP_CHECK_REQPROT") ==) -> else {
    else if ((strcmp(args[0].from, "MMAP_CHECK_REQPROT") == 0))
    entry.func = MMAP_CHECK_REQPROT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "BPRM_CHECK") ==) -> else {
    else if (strcmp(args[0].from, "BPRM_CHECK") == 0)
    entry.func = BPRM_CHECK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "CREDS_CHECK") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, _arg: "KEXEC_INITRAMFS_CHECK") -> else {
    else if (strcmp(args[0].from, "KEXEC_INITRAMFS_CHECK")
    == 0)
    entry.func = KEXEC_INITRAMFS_CHECK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "POLICY_CHECK") ==) -> else {
    else if (strcmp(args[0].from, "POLICY_CHECK") == 0)
    entry.func = POLICY_CHECK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "KEXEC_CMDLINE") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "CRITICAL_DATA") ==) -> else {
    else if (strcmp(args[0].from, "CRITICAL_DATA") == 0)
    entry.func = CRITICAL_DATA;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(args[0].from, 0: "SETXATTR_CHECK") ==) -> else {
    ...
    entry.mask = MAY_EXEC;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(from, 0: "MAY_WRITE") ==) -> else {
    else if (strcmp(from, "MAY_WRITE") == 0)
    entry.mask = MAY_WRITE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(from, 0: "MAY_READ") ==) -> else {
    else if (strcmp(from, "MAY_READ") == 0)
    entry.mask = MAY_READ;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(from, 0: "MAY_APPEND") ==) -> else {
    ...
    entry.keyrings = core::ptr::null_mut();
    break;
    }
...
//
    ...
    result = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(APPRAISE: entry->action ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_parse_add_rule(rule: *mut c_char) -> isize {
    ...
    if (!entry) {
    integrity_audit_msg(AUDIT_INTEGRITY_STATUS, core::ptr::null_mut(),
    core::ptr::null_mut(), op, "-ENOMEM", -ENOMEM, audit_info);
    return -ENOMEM;
    }
    ...
    ima_free_rule(entry);
    integrity_audit_msg(AUDIT_INTEGRITY_STATUS, core::ptr::null_mut(),
    core::ptr::null_mut(), op, "invalid-policy", result,
    audit_info);
    return result;
    }
...
pub unsafe extern "C" fn ima_delete_rules() {
    ...
    &entry.list == &ima_policy_rules) ? core::ptr::null_mut() : entry;
    }
#[no_mangle]
pub unsafe extern "C" fn ima_policy_stop(m: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn policy_func_show(m: *mut seq_file, func: enum ima_hooks) {
...
#[no_mangle]
pub unsafe extern "C" fn if(&uid_lt: entry->uid_op ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&gid_lt: entry->gid_op ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&vfsuid_lt_kuid: entry->fowner_op ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&vfsgid_lt_kgid: entry->fgroup_op ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(IMA_MODSIG_ALLOWED: entry->flags &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ima_appraise_signature(id: enum kernel_read_file_id) -> bool {
...
pub unsafe extern "C" fn ima_measure_loaded_policy() {
    ...
    let mut rule_len: usize = max_rule_len + 2;
    struct ima_rule_entry *rule_entry;
    struct list_head *ima_rules_tmp;
    let mut file: seq_file = { 0 };
    ...
    if (!rule) {
    integrity_audit_msg(AUDIT_INTEGRITY_PCR, core::ptr::null_mut(), event_name,
    op, "ENOMEM", result, 0);
    return;
    }
// calculate IMA policy rules memory size
    ...
    result = -E2BIG;
    integrity_audit_msg(AUDIT_INTEGRITY_PCR, core::ptr::null_mut(),
...
// copy IMA policy rules to a buffer for measuring
    ...
    file.count, false, core::ptr::null_mut(), 0);
    kfree(file.buf);
    free_rule:
    kfree(rule);
    }
