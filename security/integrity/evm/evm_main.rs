...
//! Source: security/integrity/evm/evm_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn evm_set_fixmode() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn evm_init_config() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn evm_key_loaded() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn evm_hmac_disabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn evm_sigv3_required() -> bool {
...
#[no_mangle]
unsafe extern "C" fn evm_find_protected_xattrs(dentry: *mut dentry) -> c_int {
    ...
    error = __vfs_getxattr(dentry, inode, xattr.name, core::ptr::null_mut(), 0);
    if (error < 0) {
    if (error == -ENODATA)
    continue;
    return error;
...
#[no_mangle]
unsafe extern "C" fn is_unsupported_hmac_fs(dentry: *mut dentry) -> c_int {
...
//
    ...
    {
    struct evm_ima_xattr_data *xattr_data = core::ptr::null_mut();
    struct signature_v2_hdr *hdr;
    let mut evm_status: enum integrity_status = INTEGRITY_PASS;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: evm_immutable) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn evm_protected_xattr(req_xattr_name: *const c_char) -> c_int {
    int evm_protected_xattr(const char *req_xattr_name)
    {
    return evm_protected_xattr_common(req_xattr_name, false);
    }
#[no_mangle]
pub unsafe extern "C" fn evm_protected_xattr_if_enabled(req_xattr_name: *const c_char) -> c_int {
...
//
    ...
    xattr.name, core::ptr::null_mut(), 0);
    if (rc < 0 && rc == -ENODATA)
    continue;
#[no_mangle]
pub unsafe extern "C" fn if(0: rc <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn evm_verify_current_integrity(dentry: *mut dentry) -> enum integrity_status {
    static enum integrity_status evm_verify_current_integrity(struct dentry *dentry)
    {
    struct inode *inode = d_backing_inode(dentry);
    if (!evm_key_loaded() || !S_ISREG(inode.i_mode) || evm_fixmode)
    return INTEGRITY_PASS;
    return evm_verify_hmac(dentry, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    }
//
...
//
    ...
    {
    char *xattr_data = core::ptr::null_mut();
    let mut rc: c_int = 0;
...
//
    ...
    integrity_status_msg[evm_status],
    -EPERM, 0);
    let mut evm_status: return = = INTEGRITY_PASS ? 0 : -EPERM;
    }
//
...
//
    if (evm_initialized & EVM_ALLOW_METADATA_WRITES)
    return 0;
    return evm_protect_xattr(idmap, dentry, xattr_name, core::ptr::null_mut(), 0);
    }
...
//
    ...
    const char *acl_name)
    {
    return evm_inode_set_acl(idmap, dentry, acl_name, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn evm_reset_status(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn evm_metadata_changed(inode: *mut inode, metadata_inode: *mut inode) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn evm_revalidate_status(xattr_name: *const c_char) -> bool {
...
//
    ...
    struct posix_acl *kacl)
    {
    return evm_inode_post_setxattr(dentry, acl_name, core::ptr::null_mut(), 0, 0);
    }
//
...
//
    ...
    if (!(evm_initialized & EVM_INIT_HMAC))
    return;
    evm_update_evmxattr(dentry, xattr_name, core::ptr::null_mut(), 0);
    }
//
...
//
    ...
    {
    if (!evm_revalidate_status(core::ptr::null_mut()))
    return;
    evm_reset_status(dentry.d_inode);
    if (!(evm_initialized & EVM_INIT_HMAC))
    return;
    ...
    return;
    if (ia_valid & (ATTR_MODE | ATTR_UID | ATTR_GID))
    evm_update_evmxattr(dentry, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn evm_inode_copy_up_xattr(src: *mut dentry, name: *const c_char) -> c_int {
...
//
    ...
    let mut evm_protected_xattrs: bool = false;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn evm_inode_alloc_security(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evm_file_release(file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn evm_post_path_mknod(idmap: *mut mnt_idmap, dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn evm_load_x509() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_evm() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_evm_lsm() -> int __init {
