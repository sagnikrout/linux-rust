...
//! Source: security/integrity/evm/evm_secfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn evm_init_xattrs() -> c_int {
    static int evm_init_xattrs(void)
    {
    evm_xattrs = securityfs_create_file("evm_xattrs", 0660, evm_dir, core::ptr::null_mut(),
    &evm_xattr_ops);
...
#[no_mangle]
pub unsafe extern "C" fn evm_init_secfs() -> int __init {
    ...
    evm_dir, core::ptr::null_mut(), &evm_key_ops);
    if (IS_ERR(dentry)) {
    error = -EFAULT;
    goto out;
    }
    evm_symlink = securityfs_create_symlink("evm", core::ptr::null_mut(),
    "integrity/evm/evm", core::ptr::null_mut());
