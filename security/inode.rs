...
#[no_mangle]
unsafe extern "C" fn securityfs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn securityfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn securityfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn securityfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
    ...
    const struct file_operations *fops)
    {
    return securityfs_create_dentry(name, mode, parent, data, fops, core::ptr::null_mut());
    }
...
//
    ...
    {
    return securityfs_create_file(name, S_IFDIR | 0755, parent, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
//
    ...
    {
    struct dentry *dent;
    const char *link = core::ptr::null_mut();
    if (target) {
    ...
    (void *)link, core::ptr::null_mut(), iops);
    if (IS_ERR(dent))
    kfree_const(link);
    return dent;
    }
...
#[no_mangle]
pub unsafe extern "C" fn securityfs_init() -> int __init {
    ...
    lsm_dentry = securityfs_create_file("lsm", 0444, core::ptr::null_mut(), core::ptr::null_mut(),
    &lsm_ops);
