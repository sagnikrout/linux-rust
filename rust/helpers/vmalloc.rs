...
#[no_mangle]
pub unsafe extern "C" fn __realloc_size(_arg: 2) -> *mut __rust_helper void __must_check {
...
#[no_mangle]
pub unsafe extern "C" fn rust_helper_is_vmalloc_addr(x: *const c_void) -> __rust_helper bool {
