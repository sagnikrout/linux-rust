...
//! Source: rust/helpers/regulator.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rust_helper_regulator_put(regulator: *mut regulator) -> __rust_helper void {
...
#[no_mangle]
pub unsafe extern "C" fn rust_helper_regulator_get_voltage(regulator: *mut regulator) -> __rust_helper int {
...
#[no_mangle]
pub unsafe extern "C" fn rust_helper_regulator_enable(regulator: *mut regulator) -> __rust_helper int {
    __rust_helper int rust_helper_regulator_enable(struct regulator *regulator)
    {
    return regulator_enable(regulator);
    }
#[no_mangle]
pub unsafe extern "C" fn rust_helper_regulator_disable(regulator: *mut regulator) -> __rust_helper int {
    __rust_helper int rust_helper_regulator_disable(struct regulator *regulator)
    {
    return regulator_disable(regulator);
    }
#[no_mangle]
pub unsafe extern "C" fn rust_helper_regulator_is_enabled(regulator: *mut regulator) -> __rust_helper int {
