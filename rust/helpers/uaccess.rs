...
// SPDX-License-Identifier: GPL-2.0
    ...
    __rust_helper
#[no_mangle]
pub unsafe extern "C" fn rust_helper__copy_from_user(to: *mut c_void, from: *const void __user, n: c_ulong) -> c_ulong {
    ...
    __rust_helper
#[no_mangle]
pub unsafe extern "C" fn rust_helper__copy_to_user(to: *mut void __user, from: *const c_void, n: c_ulong) -> c_ulong {
