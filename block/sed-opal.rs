...
pub const IO_BUFFER_LENGTH: c_int = 2048;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct parsed_resp {
    pub num: c_int,
    pub toks: [opal_resp_tok; MAX_TOKS],
}
...
pub struct opal_dev {
    pub flags: u32,
    pub data: *mut c_void,
    pub send_recv: *mut sec_send_recv,
    pub dev_lock: mutex,
    pub comid: u16,
    pub hsn: u32,
    pub tsn: u32,
    ...
    pub cmd: *mut u8,
    pub resp: *mut u8,
    pub parsed: parsed_resp,
    pub prev_d_len: usize,
    pub prev_data: *mut c_void,
    pub unlk_lst: list_head,
}
