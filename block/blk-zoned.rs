...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct blk_zone_wplug {
    pub node: hlist_node,
    pub entry: list_head,
    pub bio_list: bio_list,
    pub bio_work: work_struct,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct blk_revalidate_zone_args {
    pub disk: *mut gendisk,
    pub zones_cond: *mut u8,
    pub nr_zones: c_uint,
...
//
    ...
    args.zones_cond = core::ptr::null_mut();
//
