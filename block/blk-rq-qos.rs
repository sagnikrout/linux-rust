...
extern "C" {
    pub fn bool(rqw: *mut acquire_inflight_cb_t)(rq_wait, private_data: *mut c_void) -> typedef;
}
extern "C" {
    pub fn void(rqw: *mut cleanup_cb_t)(rq_wait, private_data: *mut c_void) -> typedef;
}
extern "C" {
