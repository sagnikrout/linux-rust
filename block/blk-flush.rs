...
// and push the waiting requests to the next stage
    ...
    let mut seq: c_uint = blk_flush_cur_seq(rq);
...
pub unsafe extern "C" fn blk_insert_flush(rq: *mut request) -> bool {
    ...
    let mut supports_fua: bool = q.limits.features & BLK_FEAT_FUA;
    let mut policy: c_uint = 0;
...
pub unsafe extern "C" fn blkdev_issue_flush(bdev: *mut block_device) -> c_int {
    ...
    {
    struct blk_flush_queue *fq;
    let mut rq_sz: c_int = sizeof(struct request);
