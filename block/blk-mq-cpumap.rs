...
#[no_mangle]
pub unsafe extern "C" fn blk_mq_num_queues(mask: *mut cpumask, max_queues: c_uint) -> c_uint {
    let mut num = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn blk_mq_map_hw_queues(qmap: *mut blk_mq_queue_map, dev: *mut device, offset: c_uint) {
