...
pub static mut fs_bio_integrity_cache: *mut c_void = core::ptr::null_mut();
    static mempool_t fs_bio_integrity_pool;
#[no_mangle]
pub unsafe extern "C" fn fs_bio_integrity_alloc(bio: *mut bio) -> c_uint {
pub static mut iib: *mut c_void = core::ptr::null_mut();
    let mut action = 0;
...
pub unsafe extern "C" fn fs_bio_integrity_free(bio: *mut bio) {
    ...
    mempool_free(container_of!(bip, fs_bio_integrity_buf, bip),
...
pub unsafe extern "C" fn fs_bio_integrity_verify(bio: *mut bio, sector: sector_t, size: c_uint) -> c_int {
    ...
    let mut bip = bio_integrity(bio);
pub static mut bvec_iter: usize = 0;
...
#[no_mangle]
unsafe extern "C" fn fs_bio_integrity_init() -> c_int {
    fs_bio_integrity_cache = kmem_cache_create("fs_bio_integrity",
    sizeof!(fs_bio_integrity_buf), 0,
