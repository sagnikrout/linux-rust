...
pub static mut fail_io_timeout: usize = 0;
#[no_mangle]
unsafe extern "C" fn setup_fail_io_timeout(str: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fail_io_timeout_debugfs() -> c_int {
    let mut dir = fault_create_debugfs_attr("fail_io_timeout",
    core::ptr::null_mut(), &fail_io_timeout);
    return PTR_ERR_OR_ZERO(dir);
    }
    late_initcall!(fail_io_timeout_debugfs);
#[no_mangle]
pub unsafe extern "C" fn part_timeout_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> ssize_t {
    let mut disk = dev_to_disk(dev);
pub static mut set: c_int = 0;
    return sprintf(buf, "%d\n", set != 0);
    }
#[no_mangle]
pub unsafe extern "C" fn part_timeout_store(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char, count: size_t) -> ssize_t {
    let mut disk = dev_to_disk(dev);
    let mut val = 0;
    if (count) {
...
//
    ...
    static unsigned long blk_timeout_mask ;
#[no_mangle]
unsafe extern "C" fn blk_timeout_init() -> c_int {
