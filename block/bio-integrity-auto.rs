...
pub static mut bid_slab: *mut c_void = core::ptr::null_mut();
    static mempool_t bid_pool;
pub static mut kintegrityd_wq: *mut c_void = core::ptr::null_mut();
#[no_mangle]
...
unsafe extern "C" fn bio_integrity_verify_fn(work: *mut work_struct) {
    let mut bid = container_of!(work, bio_integrity_data, work);
    let mut bio = bid.bio;
...
pub unsafe extern "C" fn __bio_integrity_endio(bio: *mut bio) -> bool {
    ...
    let mut bid = container_of!(bip, bio_integrity_data, bip);
...
pub static mut bid: *mut c_void = core::ptr::null_mut();
