...
#[no_mangle]
unsafe extern "C" fn ext4_hash_init_fake_dir(dir: *mut inode, sb: *mut super_block) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ext4_dirhash_test_case {
...
#[no_mangle]
unsafe extern "C" fn test_ext4fs_dirhash_vectors(test: *mut kunit) {
    ...
    hinfo.seed = tc.use_seed ? (u32 *)tc.seed : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_ext4fs_dirhash_seed_changes_result(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_ext4fs_dirhash_invalid_version_returns_einval(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_ext4fs_dirhash_siphash_without_key_returns_einval(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_ext4fs_dirhash_signed_unsigned_differ_on_nonascii(test: *mut kunit) {
    ...
    struct unicode_map *);
#[no_mangle]
unsafe extern "C" fn test_ext4fs_dirhash_casefolded_names_hash_consistently(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_ext4fs_dirhash_casefold_fallback(test: *mut kunit) {
