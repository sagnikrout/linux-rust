...
//
#[no_mangle]
unsafe extern "C" fn ext4_should_use_dio(iocb: *mut kiocb, iter: *mut iov_iter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ext4_dio_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
//
    ...
    if (ret == -ENOTBLK)
    ret = iomap_dio_rw(iocb, to, &ext4_iomap_ops, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    inode_unlock_shared(inode);
...
#[no_mangle]
unsafe extern "C" fn ext4_dax_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ext4_file_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_release_file(inode: *mut inode, filp: *mut file) -> c_int {
...
//
    ...
    let mut blockmask: c_ulong = sb.s_blocksize - 1;
...
//
#[no_mangle]
unsafe extern "C" fn ext4_dio_needs_zeroing(inode: *mut inode, pos: loff_t, len: loff_t) -> bool {
    static bool ext4_dio_needs_zeroing(struct inode *inode, loff_t pos, loff_t len)
    {
    struct ext4_map_blocks map;
    let mut blkbits: c_uint = inode.i_blkbits;
    let mut blockmask: c_ulong = inode.i_sb.s_blocksize - 1;
...
#[no_mangle]
unsafe extern "C" fn ext4_write_checks(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
//
    ...
    let mut ret: c_int = ext4_mark_inode_dirty(handle, inode);
    if (unlikely(ret)) {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_inode_extension_cleanup(inode: *mut inode, need_trunc: bool) {
...
//
    ...
    error = ext4_convert_unwritten_extents_atomic(core::ptr::null_mut(), inode, pos,
    size);
#[no_mangle]
pub unsafe extern "C" fn if(IOMAP_DIO_UNWRITTEN: !error && size && flags &) -> else {
    else if (!error && size && flags & IOMAP_DIO_UNWRITTEN)
    error = ext4_convert_unwritten_extents(core::ptr::null_mut(), inode, pos, size,
    core::ptr::null_mut());
    if (error)
    return error;
//
...
//
    ...
    size_t count;
    ssize_t ret;
    let mut needs_zeroing: bool = false;
    restart:
...
#[no_mangle]
unsafe extern "C" fn ext4_dio_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
    ...
    let mut ilock_shared: bool = true;
    let mut dio_flags: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn ext4_dax_huge_fault(vmf: *mut vm_fault, order: c_uint) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn ext4_dax_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn ext4_file_mmap_prepare(desc: *mut vm_area_desc) -> c_int {
...
//
    ...
    ext4_handle_dirty_metadata(handle, core::ptr::null_mut(), sbi.s_sbh);
    out_journal:
    ext4_journal_stop(handle);
    out:
    sb_end_intwrite(sb);
...
#[no_mangle]
unsafe extern "C" fn ext4_file_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
    loff_t ext4_llseek(struct file *file, loff_t offset, int whence)
    {
    struct inode *inode = file.f_mapping.host;
    let mut maxbytes: loff_t = ext4_get_maxbytes(inode);
    switch (whence) {
    default:
