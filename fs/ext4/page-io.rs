...
#[no_mangle]
pub unsafe extern "C" fn ext4_init_pageio() -> int __init {
    int __init ext4_init_pageio(void)
    {
    io_end_cachep = KMEM_CACHE(ext4_io_end, SLAB_RECLAIM_ACCOUNT);
    if (io_end_cachep == core::ptr::null_mut())
    return -ENOMEM;
    io_end_vec_cachep = KMEM_CACHE(ext4_io_end_vec, 0);
    if (io_end_vec_cachep == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_exit_pageio() {
...
#[no_mangle]
unsafe extern "C" fn ext4_free_io_end_vec(io_end: *mut ext4_io_end_t) {
...
//
#[no_mangle]
unsafe extern "C" fn buffer_io_error(bh: *mut buffer_head) {
...
#[no_mangle]
unsafe extern "C" fn ext4_finish_bio(bio: *mut bio) {
    ...
    let mut bio_start: usize = fi.offset;
    let mut bio_end: usize = bio_start + fi.length;
    let mut under_io: unsigned = 0;
    unsigned long flags;
    if (bio.bi_status) {
...
#[no_mangle]
unsafe extern "C" fn ext4_release_io_end(io_end: *mut ext4_io_end_t) {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_end_io_end(io_end: *mut ext4_io_end_t) -> c_int {
...
//
    io_end.handle = core::ptr::null_mut();  /* Following call will use up the handle */
...
#[no_mangle]
unsafe extern "C" fn dump_completed_IO(inode: *mut inode, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn ext4_io_end_defer_completion(io_end: *mut ext4_io_end_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ext4_add_complete_io(io_end: *mut ext4_io_end_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_end_io_rsv_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_put_io_end_defer(io_end: *mut ext4_io_end_t) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_put_io_end(io_end: *mut ext4_io_end_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_end_bio(bio: *mut bio) {
    static void ext4_end_bio(struct bio *bio)
    {
    ext4_io_end_t *io_end = bio.bi_private;
    let mut bi_sector: sector_t = bio.bi_iter.bi_sector;
    if (WARN_ONCE(!io_end, "io_end is core::ptr::null_mut(): %pg: sector %Lu len %u err %d\n",
    bio.bi_bdev,
...
#[no_mangle]
pub unsafe extern "C" fn ext4_io_submit(io: *mut ext4_io_submit) {
...
//
    ...
    if (io.io_bio == core::ptr::null_mut())
    ...
    struct buffer_head *bh, *head;
    let mut nr_to_submit: c_int = 0;
    struct writeback_control *wbc = io.io_wbc;
    let mut keep_towrite: bool = false;
