...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ext4_attr {
    pub attr: attribute,
    pub attr_id: c_short,
    pub attr_ptr: c_short,
    pub attr_size: c_ushort,
    union {
    pub offset: c_int,
    pub explicit_ptr: *mut c_void,
    pub u: },
}

#[no_mangle]
unsafe extern "C" fn session_write_kbytes_show(sbi: *mut ext4_sb_info, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn lifetime_write_kbytes_show(sbi: *mut ext4_sb_info, buf: *mut c_char) -> isize {
...
// the maximum time interval must not exceed one year.
    ...
    goto out;
#[no_mangle]
pub unsafe extern "C" fn if(t: !sbi->s_err_report_sec &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn journal_task_show(sbi: *mut ext4_sb_info, buf: *mut c_char) -> isize {
    ...
    let mut old_bump_val: static unsigned int = 128;
...
#[no_mangle]
unsafe extern "C" fn __print_tstamp(buf: *mut c_char, lo: __le32, hi: __u8) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ext4_sb_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn ext4_feat_release(kobj: *mut kobject) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_notify_error_sysfs(sbi: *mut ext4_sb_info) {
    void ext4_notify_error_sysfs(struct ext4_sb_info *sbi)
    {
    mutex_lock(&sbi.s_error_notify_mutex);
    if (sbi.s_kobj.state_in_sysfs)
    sysfs_notify(&sbi.s_kobj, core::ptr::null_mut(), "errors_count");
    mutex_unlock(&sbi.s_error_notify_mutex);
    }
    static struct kobject *ext4_root;
    static struct kobject *ext4_feat;
#[no_mangle]
pub unsafe extern "C" fn ext4_register_sysfs(sb: *mut super_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_unregister_sysfs(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_init_sysfs() -> int __init {
    ...
    if (ret)
    goto feat_err;
    ext4_proc_root = proc_mkdir(proc_dirname, core::ptr::null_mut());
    return ret;
    feat_err:
    kobject_put(ext4_feat);
    ext4_feat = core::ptr::null_mut();
    root_err:
    kobject_put(ext4_root);
    ext4_root = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn ext4_exit_sysfs() {
    ...
    kobject_put(ext4_root);
    ext4_root = core::ptr::null_mut();
    remove_proc_entry(proc_dirname, core::ptr::null_mut());
    ext4_proc_root = core::ptr::null_mut();
    }
