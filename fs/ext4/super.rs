...
#[no_mangle]
pub unsafe extern "C" fn ext4_read_bh_lock(bh: *mut buffer_head, op_flags: blk_opf_t, wait: bool) -> c_int {
    int ext4_read_bh_lock(struct buffer_head *bh, blk_opf_t op_flags, bool wait)
    {
    lock_buffer(bh);
    if (!wait) {
    ext4_read_bh_nowait(bh, op_flags, core::ptr::null_mut(), false);
    return 0;
    }
    return ext4_read_bh(bh, op_flags, core::ptr::null_mut(), false);
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn ext4_sb_breadahead_unmovable(sb: *mut super_block, block: sector_t) {
    ...
    ext4_read_bh_nowait(bh, REQ_RAHEAD, core::ptr::null_mut(), false);
    brelse(bh);
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn ext4_superblock_csum(es: *mut ext4_super_block) -> __le32 {
    __le32 ext4_superblock_csum(struct ext4_super_block *es)
    {
    let mut offset: c_int = offsetof(struct ext4_super_block, s_checksum);
    __u32 csum;
...
#[no_mangle]
pub unsafe extern "C" fn ext4_superblock_csum_set(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn __ext4_update_tstamp(lo: *mut __le32, hi: *mut __u8, now: time64_t) {
...
#[no_mangle]
unsafe extern "C" fn __ext4_get_tstamp(lo: *mut __le32, hi: *mut __u8) -> time64_t {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_maybe_update_superblock(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ext4_journal_commit_callback(journal: *mut journal_t, txn: *mut transaction_t) {
...
#[no_mangle]
unsafe extern "C" fn ext4_journalled_submit_inode_data_buffers(jinode: *mut jbd2_inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_journal_submit_inode_data_buffers(jinode: *mut jbd2_inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_journal_finish_inode_data_buffers(jinode: *mut jbd2_inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn system_going_down() -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ext4_err_translation {
    pub code: c_int,
    pub errno: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn ext4_errno_to_code(errno: c_int) -> c_int {
...
//
    ...
    let mut continue_fs: bool = !force_ro && test_opt(sb, ERRORS_CONT);
...
#[no_mangle]
unsafe extern "C" fn update_super_work(work: *mut work_struct) {
...
//
    ...
    let mut call_notify_err: bool = false;
...
// an error.
    if (errno == -EROFS && journal_current_handle() == core::ptr::null_mut() && sb_rdonly(sb))
    return;
    if (ext4_error_ratelimit(sb)) {
...
#[no_mangle]
unsafe extern "C" fn ext4_warning_ratelimit(sb: *mut super_block) -> c_int {
...
//
    ...
    struct ext4_group_desc *gdp = ext4_get_group_desc(sb, group, core::ptr::null_mut());
    int ret;
    if (!grp || !gdp)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn ext4_update_dynamic_rev(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn dump_orphan_list(sb: *mut super_block, sbi: *mut ext4_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_quotas_off(sb: *mut super_block, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ext4_percpu_param_init(sbi: *mut ext4_sb_info) -> c_int {
    ...
    GFP_KERNEL);
    if (!err) {
    let mut freei: c_ulong = ext4_count_free_inodes(sbi.s_sb);
...
#[no_mangle]
unsafe extern "C" fn ext4_percpu_param_destroy(sbi: *mut ext4_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn ext4_group_desc_free(sbi: *mut ext4_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn ext4_flex_groups_free(sbi: *mut ext4_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn ext4_put_super(sb: *mut super_block) {
    static void ext4_put_super(struct super_block *sb)
    {
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct ext4_super_block *es = sbi.s_es;
    let mut aborted: c_int = 0;
    int err;
//
...
//
    ...
    sbi.s_ea_inode_cache = core::ptr::null_mut();
    ext4_xattr_destroy_cache(sbi.s_ea_block_cache);
    sbi.s_ea_block_cache = core::ptr::null_mut();
    ext4_stop_mmpd(sbi);
    brelse(sbi.s_sbh);
...
//
    ...
    fs_put_dax(sbi.s_daxdev, core::ptr::null_mut());
...
//
    ...
    ei.i_metadata_bhs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ext4_drop_inode(inode: *mut inode) -> c_int {
    static int ext4_drop_inode(struct inode *inode)
    {
    let mut drop: c_int = inode_generic_drop(inode);
    if (!drop)
...
#[no_mangle]
unsafe extern "C" fn ext4_free_in_core_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn ext4_destroy_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn ext4_shutdown(sb: *mut super_block) {
...
unsafe extern "C" fn init_once(foo: *mut c_void) {
    ...
    ei.i_crypt_info = core::ptr::null_mut();
...
unsafe extern "C" fn init_inodecache() -> int __init {
    ...
    if (ext4_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn ext4_clear_inode(inode: *mut inode) {
...
//
    ...
    EXT4_I(inode).jinode = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ext4_nfs_commit_metadata(inode: *mut inode) -> c_int {
...
pub const MOPT_SET: c_uint = 0x0001;
pub const MOPT_CLEAR: c_uint = 0x0002;
pub const MOPT_NOSUPPORT: c_uint = 0x0004;
pub const MOPT_EXPLICIT: c_uint = 0x0008;

pub const MOPT_Q: c_int = 0;
pub const MOPT_QFMT: c_uint = 0x0010;

pub const MOPT_NO_EXT2: c_uint = 0x0020;
pub const MOPT_NO_EXT3: c_uint = 0x0040;

pub const MOPT_SKIP: c_uint = 0x0080;
pub const MOPT_2: c_uint = 0x0100;
    ...
    {
    let mut magic: __u16 = le16_to_cpu(es.s_encoding);
    int i;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ext4_fs_context {
    pub s_qf_names: [*mut c_char; EXT4_MAXQUOTAS],
    ...
    pub qname_spec: c_ushort,
    pub /: *mut *mut unsigned long vals_s_flags; / Bits to set in s_flags,
    pub /: *mut *mut unsigned long mask_s_flags; / Bits changed in s_flags,
    pub journal_devnum: c_ulong,
    pub s_commit_interval: c_ulong,
    pub s_stripe: c_ulong,
    pub s_inode_readahead_blks: c_uint,
    pub s_want_extra_isize: c_uint,
    pub s_li_wait_mult: c_uint,
    pub s_max_dir_size_kb: c_uint,
    pub journal_ioprio: c_uint,
    pub vals_s_mount_opt: c_uint,
    pub mask_s_mount_opt: c_uint,
    pub vals_s_mount_opt2: c_uint,
    pub mask_s_mount_opt2: c_uint,
    pub /: *mut *mut unsigned int opt_flags; / MOPT flags,
    pub spec: c_uint,
...
#[no_mangle]
unsafe extern "C" fn ext4_fc_free(fc: *mut fs_context) {
    static void ext4_fc_free(struct fs_context *fc)
    {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
    ...
    char *qname;
    if (param.size < 1) {
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "Missing quota name");
    return -EINVAL;
    }
    if (strchr(param.string, '/')) {
    ext4_msg(core::ptr::null_mut(), KERN_ERR,
...
//
#[no_mangle]
unsafe extern "C" fn unnote_qf_name(fc: *mut fs_context, qtype: c_int) -> c_int {
    static int unnote_qf_name(struct fs_context *fc, int qtype)
    {
    struct ext4_fs_context *ctx = fc.fs_private;
    kfree(ctx.s_qf_names[qtype]);
    ctx.s_qf_names[qtype] = core::ptr::null_mut();
    ctx.qname_spec |= 1 << qtype;
    ctx.spec |= EXT4_SPEC_JQUOTA;
    return 0;
    }
    ...
    ext4_msg(core::ptr::null_mut(), KERN_WARNING,
...
#[no_mangle]
unsafe extern "C" fn ext4_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
    static int ext4_parse_param(struct fs_context *fc, struct fs_parameter *param)
    {
    struct ext4_fs_context *ctx = fc.fs_private;
    ...
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "%s option not supported",
    param.key);
    return 0;
    }
    switch (token) {
    ...
    return 0;
    case Opt_removed:
    ext4_msg(core::ptr::null_mut(), KERN_WARNING, "Ignoring removed %s option",
    param.key);
    return 0;
    ...
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "inline encryption not supported");
...
#[no_mangle]
pub unsafe extern "C" fn if(HZ: result.uint_32 > INT_MAX /) -> else {
    ext4_msg(core::ptr::null_mut(), KERN_ERR,
    ...
    if (error) {
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "error: could not find "
    "journal device path");
    return -EINVAL;
    }
    ...
    if (result.uint_32 > 7) {
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "Invalid journal IO priority"
    " (must be 0-7)");
    return -EINVAL;
    }
    ctx.journal_ioprio =
...
// Strictly for printing options
    ...
    ext4_msg(core::ptr::null_mut(), KERN_INFO, "dax option not supported");
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn if(Opt_data_err_ignore: result.uint_32 ==) -> else {
...
//
    if (m.token == Opt_err) {
    ext4_msg(core::ptr::null_mut(), KERN_WARNING, "buggy handling of option %s",
    param.key);
    WARN_ON(1);
    return -EINVAL;
    }
    ...
    set = !set;
#[no_mangle]
pub unsafe extern "C" fn if(MOPT_SET)): unlikely(!(m->flags &) -> else {
    ext4_msg(core::ptr::null_mut(), KERN_WARNING,
...
#[no_mangle]
unsafe extern "C" fn parse_options(fc: *mut fs_context, options: *mut c_char) -> c_int {
...
// value++ = 0;
    ...
    struct ext4_fs_context *s_ctx = core::ptr::null_mut();
    struct fs_context *fc = core::ptr::null_mut();
    ...
    let mut quota_feature: bool = ext4_has_feature_quota(sb);
    struct ext4_fs_context *ctx = fc.fs_private;
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    char *qname;
    int i;
    ...
    continue;
    qname = ctx.s_qf_names[i]; /* May be core::ptr::null_mut() */
    if (qname)
    set_opt(sb, QUOTA);
    ctx.s_qf_names[i] = core::ptr::null_mut();
...
//
    ...
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    let mut quota_feature: bool = ext4_has_feature_quota(sb);
    let mut quota_loaded: bool = sb_any_quota_loaded(sb);
...
//
    ...
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "Project quota feature not enabled. "
    ...
    if (quota_feature) {
    ext4_msg(core::ptr::null_mut(), KERN_INFO,
    ...
    goto err_jquota_change;
    if (quota_feature) {
    ext4_msg(core::ptr::null_mut(), KERN_INFO, "Quota format mount options "
...
// Make sure we don't mix old and new quota format
    ...
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "old and new quota "
    "format mixing");
    return -EINVAL;
    }
    if (!(ctx.spec & EXT4_SPEC_JQFMT || sbi.s_jquota_fmt)) {
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "journaled quota format "
    "not specified");
    return -EINVAL;
    }
    }
    ...
    return -EINVAL;
    err_jquota_change:
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "Cannot change journaled quota "
    "options when quota turned on");
    return -EINVAL;
    err_jquota_specified:
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "%s quota file already specified",
    QTYPE2NAME(i));
    return -EINVAL;
...
// if already set, it was already verified to be the same
    ...
    let mut is_remount: c_int = fc.purpose == FS_CONTEXT_FOR_RECONFIGURE;
    int err;
    ...
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "Cannot change data mode "
    "on remount");
    return -EINVAL;
    }
    }
    ...
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "can't mount with "
    ...
    ext4_msg(core::ptr::null_mut(), KERN_ERR, "can't change "
...
#[no_mangle]
unsafe extern "C" fn ext4_apply_options(fc: *mut fs_context, sb: *mut super_block) {
    static void ext4_apply_options(struct fs_context *fc, struct super_block *sb)
    {
    struct ext4_fs_context *ctx = fc.fs_private;
    struct ext4_sb_info *sbi = fc.s_fs_info;
...
#[no_mangle]
unsafe extern "C" fn ext4_validate_options(fc: *mut fs_context) -> c_int {
    static int ext4_validate_options(struct fs_context *fc)
    {
    ...
    for (spec = ext4_param_specs; spec.name != core::ptr::null_mut(); spec++)
...
//
    ...
    int def_errors;
    const struct mount_opts *m;
    let mut sep: c_char = nodefs ? '\n' : ',';

    if (sbi.s_sb_block != 1)
    SEQ_OPTS_PRINT("sb=%llu", sbi.s_sb_block);
    for (m = ext4_mount_opts; m.token != Opt_err; m++) {
    let mut want_set: c_int = m.flags & MOPT_SET;
    let mut opt_2: c_int = m.flags & MOPT_2;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_opt(sb, EXT4_MOUNT_ORDERED_DATA: DATA_FLAGS) ==) -> else {
    else if (test_opt(sb, DATA_FLAGS) == EXT4_MOUNT_ORDERED_DATA)
    SEQ_OPTS_PUTS("data=ordered");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_opt(sb, EXT4_MOUNT_WRITEBACK_DATA: DATA_FLAGS) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ext4_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
    static int ext4_show_options(struct seq_file *seq, struct dentry *root)
    {
    return _ext4_show_options(seq, root.d_sb, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn ext4_seq_options_show(seq: *mut seq_file, offset: *mut c_void) -> c_int {
    ...
    "running e2fsck is recommended");
#[no_mangle]
pub unsafe extern "C" fn if(EXT4_ERROR_FS: sbi->s_mount_state &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_alloc_flex_bg_array(sb: *mut super_block, ngroup: ext4_group_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_fill_flex_info(sb: *mut super_block) -> c_int {
    static int ext4_fill_flex_info(struct super_block *sb)
    {
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct ext4_group_desc *gdp = core::ptr::null_mut();
    ...
    {
    let mut offset: c_int = offsetof(struct ext4_group_desc, bg_checksum);
    let mut crc: __u16 = 0;
    let mut le_group: __le32 = cpu_to_le32(block_group);
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    if (ext4_has_feature_metadata_csum(sbi.s_sb)) {
// Use new metadata_csum algorithm
    __u32 csum32;
    let mut dummy_csum: __u16 = 0;
...
// Called at mount-time, super-block is locked
    ...
    {
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    let mut first_block: ext4_fsblk_t = le32_to_cpu(sbi.s_es.s_first_data_block);
    ext4_fsblk_t last_block;
    let mut last_bg_block: ext4_fsblk_t = sb_block + ext4_bg_num_gdb(sb, 0);
    ext4_fsblk_t block_bitmap;
    ext4_fsblk_t inode_bitmap;
    ext4_fsblk_t inode_table;
    let mut flexbg_flag: c_int = 0;
    ext4_group_t i, grp = sbi.s_groups_count;
    if (ext4_has_feature_flex_bg(sb))
    flexbg_flag = 1;
    ext4_debug("Checking group descriptors");
    for (i = 0; i < sbi.s_groups_count; i++) {
    struct ext4_group_desc *gdp = ext4_get_group_desc(sb, i, core::ptr::null_mut());
    ...
    if (core::ptr::null_mut() != first_not_zeroed)
...
//
#[no_mangle]
unsafe extern "C" fn ext4_max_size(blkbits: c_int, has_huge_files: c_int) -> loff_t {
    static loff_t ext4_max_size(int blkbits, int has_huge_files)
    {
    loff_t res;
    let mut upper_limit: loff_t = MAX_LFS_FILESIZE;
...
//
#[no_mangle]
unsafe extern "C" fn ext4_max_bitmap_size(bits: c_int, has_huge_files: c_int) -> loff_t {
    static loff_t ext4_max_bitmap_size(int bits, int has_huge_files)
    {
    loff_t upper_limit, res = EXT4_NDIR_BLOCKS;
    int meta_blocks;
    let mut ppb: c_uint = 1 << (bits - 2);
//
...
//
#[no_mangle]
unsafe extern "C" fn ext4_get_stripe_size(sbi: *mut ext4_sb_info) -> c_ulong {
    static unsigned long ext4_get_stripe_size(struct ext4_sb_info *sbi)
    {
    let mut stride: c_ulong = le16_to_cpu(sbi.s_es.s_raid_stride);
    ...
    ret = sbi.s_stripe;
#[no_mangle]
pub unsafe extern "C" fn if(sbi->s_blocks_per_group: stripe_width && stripe_width <=) -> else {
    else if (stripe_width && stripe_width <= sbi.s_blocks_per_group)
    ret = stripe_width;
#[no_mangle]
pub unsafe extern "C" fn if(sbi->s_blocks_per_group: stride && stride <=) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_feature_set_ok(sb: *mut super_block, readonly: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn print_daily_error_info(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn ext4_run_li_request(elr: *mut ext4_li_request) -> c_int {
    static int ext4_run_li_request(struct ext4_li_request *elr)
    {
    struct ext4_group_desc *gdp = core::ptr::null_mut();
    struct super_block *sb = elr.lr_super;
    let mut ngroups: ext4_group_t = EXT4_SB(sb).s_groups_count;
    let mut group: ext4_group_t = elr.lr_next_group;
    let mut prefetch_ios: c_uint = 0;
    let mut ret: c_int = 0;
    let mut nr: c_int = EXT4_SB(sb).s_mb_prefetch;
    u64 start_time;
    ...
    gdp = ext4_get_group_desc(sb, group, core::ptr::null_mut());
    if (!gdp) {
    ret = 1;
    break;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ext4_remove_li_request(elr: *mut ext4_li_request) {
    static void ext4_remove_li_request(struct ext4_li_request *elr)
    {
    if (!elr)
    return;
    list_del(&elr.lr_request);
    EXT4_SB(elr.lr_super).s_li_request = core::ptr::null_mut();
    kfree(elr);
    }
#[no_mangle]
unsafe extern "C" fn ext4_unregister_li_request(sb: *mut super_block) {
    static void ext4_unregister_li_request(struct super_block *sb)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_lazyinit_thread(arg: *mut c_void) -> c_int {
    ...
    BUG_ON(core::ptr::null_mut() == eli);
    set_freezable();
    cont_thread:
    while (true) {
    let mut next_wakeup_initialized: bool = false;
    next_wakeup = 0;
...
//
    ...
    mutex_unlock(&eli.li_list_mtx);
    kfree(ext4_li_info);
    ext4_li_info = core::ptr::null_mut();
    mutex_unlock(&ext4_li_mtx);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ext4_clear_request_list() {
    static void ext4_clear_request_list(void)
    {
    struct list_head *pos, *n;
    struct ext4_li_request *elr;
...
#[no_mangle]
unsafe extern "C" fn ext4_run_lazyinit_thread() -> c_int {
    static int ext4_run_lazyinit_thread(void)
    {
    ext4_lazyinit_task = kthread_run(ext4_lazyinit_thread,
    ext4_li_info, "ext4lazyinit");
    if (IS_ERR(ext4_lazyinit_task)) {
    let mut err: c_int = PTR_ERR(ext4_lazyinit_task);
    ext4_clear_request_list();
    kfree(ext4_li_info);
    ext4_li_info = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ext4_has_uninit_itable(sb: *mut super_block) -> ext4_group_t {
...
#[no_mangle]
unsafe extern "C" fn ext4_li_info_new() -> c_int {
    static int ext4_li_info_new(void)
    {
    struct ext4_lazy_init *eli = core::ptr::null_mut();
    eli = kzalloc_obj(*eli);
    if (!eli)
    return -ENOMEM;
...
//
    ...
    {
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct ext4_li_request *elr = core::ptr::null_mut();
    let mut ngroups: ext4_group_t = sbi.s_groups_count;
    let mut ret: c_int = 0;
    mutex_lock(&ext4_li_mtx);
    if (sbi.s_li_request != core::ptr::null_mut()) {
//
...
//
    ...
    if (core::ptr::null_mut() == ext4_li_info) {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_destroy_lazyinit_thread() {
...
#[no_mangle]
unsafe extern "C" fn set_journal_csum_feature_set(sb: *mut super_block) -> c_int {
...
//
    ...
    int			s, j, count = 0;
    let mut has_super: c_int = ext4_bg_has_super(sb, grp);
    if (!ext4_has_feature_bigalloc(sb))
    ...
    let mut c: c_int = EXT4_B2C(sbi, b - first_block);
    ext4_set_bit(c, buf);
    count++;
    }
    if (i != grp)
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_calculate_overhead(sb: *mut super_block) -> c_int {
    ...
    ext4_group_t i, ngroups = ext4_get_groups_count(sb);
    let mut overhead: ext4_fsblk_t = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(j_inum: ext4_has_feature_journal(sb) && !sbi->s_journal &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn ext4_set_resv_clusters(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ext4_free_sbi(sbi: *mut ext4_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(EXT4_DEFM_JMODE_ORDERED: (def_mount_opts & EXT4_DEFM_JMODE) ==) -> else {
    else if ((def_mount_opts & EXT4_DEFM_JMODE) == EXT4_DEFM_JMODE_ORDERED)
    set_opt(sb, ORDERED_DATA);
#[no_mangle]
pub unsafe extern "C" fn if(EXT4_DEFM_JMODE_WBACK: (def_mount_opts & EXT4_DEFM_JMODE) ==) -> else {
    else if ((def_mount_opts & EXT4_DEFM_JMODE) == EXT4_DEFM_JMODE_WBACK)
    set_opt(sb, WRITEBACK_DATA);
    if (le16_to_cpu(es.s_errors) == EXT4_ERRORS_PANIC)
    set_opt(sb, ERRORS_PANIC);
#[no_mangle]
pub unsafe extern "C" fn if(EXT4_ERRORS_CONTINUE: le16_to_cpu(es->s_errors) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ext4_handle_clustersize(sb: *mut super_block) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_atomic_write_init(sb: *mut super_block) {
    static void ext4_atomic_write_init(struct super_block *sb)
    {
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct block_device *bdev = sb.s_bdev;
    let mut clustersize: c_uint = EXT4_CLUSTER_SIZE(sb);
...
#[no_mangle]
unsafe extern "C" fn ext4_fast_commit_init(sb: *mut super_block) {
...
// Initialize fast commit stuff
    ...
    sbi.s_fc_replay_state.fc_regions = core::ptr::null_mut();
    sbi.s_fc_replay_state.fc_regions_size = 0;
    sbi.s_fc_replay_state.fc_regions_used = 0;
    sbi.s_fc_replay_state.fc_regions_valid = 0;
    sbi.s_fc_replay_state.fc_modified_inodes = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ext4_encoding_init(sb: *mut super_block, es: *mut ext4_super_block) -> c_int {
    static int ext4_encoding_init(struct super_block *sb, struct ext4_super_block *es)
    {
    const struct ext4_sb_encodings *encoding_info;
    struct unicode_map *encoding;
    let mut encoding_flags: __u16 = le16_to_cpu(es.s_encoding_flags);
...
#[no_mangle]
pub unsafe extern "C" fn ext4_encoding_init(sb: *mut super_block, es: *mut ext4_super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_init_metadata_csum(sb: *mut super_block, es: *mut ext4_super_block) -> c_int {
...
//
    ...
    if (sbi.s_group_desc == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ext4_check_journal_data_mode(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_set_max_mapping_order(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ext4_check_large_folio(sb: *mut super_block) -> c_int {
    static int ext4_check_large_folio(struct super_block *sb)
    {
    const char *err_str = core::ptr::null_mut();
    if (ext4_has_feature_encrypt(sb))
    err_str = "encrypt";
    if (!err_str) {
...
#[no_mangle]
unsafe extern "C" fn ext4_hash_info_init(sb: *mut super_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: (i & EXT2_FLAGS_SIGNED_HASH) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ext4_block_group_meta_init(sb: *mut super_block, silent: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_is_stripe_incompatible(sb: *mut super_block, stripe: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __ext4_fill_super(fc: *mut fs_context, sb: *mut super_block) -> c_int {
    static int __ext4_fill_super(struct fs_context *fc, struct super_block *sb)
    {
    struct ext4_super_block *es = core::ptr::null_mut();
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    ext4_fsblk_t logical_sb_block;
    struct inode *root;
    int needs_recovery;
...
// Nojournal mode, all journal mount options are illegal
    ...
    if (journal_option != core::ptr::null_mut()) {
    ext4_msg(sb, KERN_ERR,
    ...
    clear_opt2(sb, JOURNAL_FAST_COMMIT);
    sbi.s_journal = core::ptr::null_mut();
    needs_recovery = 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ext4_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
// Update the s_overhead_clusters if necessary
    ...
    free_sbi:
    ext4_free_sbi(sbi);
    fc.s_fs_info = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ext4_get_tree(fc: *mut fs_context) -> c_int {
    static int ext4_get_tree(struct fs_context *fc)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_init_journal_params(sb: *mut super_block, journal: *mut journal_t) {
...
#[no_mangle]
unsafe extern "C" fn ext4_journal_bmap(journal: *mut journal_t, block: *mut sector_t) -> c_int {
    static int ext4_journal_bmap(journal_t *journal, sector_t *block)
    {
    struct ext4_map_blocks map;
    int ret;
    if (journal.j_inode == core::ptr::null_mut())
    return 0;
    map.m_lblk = *block;
    map.m_len = 1;
    ret = ext4_map_blocks(core::ptr::null_mut(), journal.j_inode, &map, 0);
    if (ret <= 0) {
...
// j_len = ext4_blocks_count(es);
    ...
    {
    journal_t *journal;
    let mut journal_inum: c_uint = le32_to_cpu(es.s_journal_inum);
    dev_t journal_dev;
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ext4_update_super(sb: *mut super_block) {
    static void ext4_update_super(struct super_block *sb)
    {
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct ext4_super_block *es = sbi.s_es;
...
#[no_mangle]
unsafe extern "C" fn ext4_commit_super(sb: *mut super_block) -> c_int {
    static int ext4_commit_super(struct super_block *sb)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_force_commit(sb: *mut super_block) -> c_int {
    int ext4_force_commit(struct super_block *sb)
    {
    return ext4_journal_force_commit(EXT4_SB(sb).s_journal);
    }
#[no_mangle]
unsafe extern "C" fn ext4_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
    static int ext4_sync_fs(struct super_block *sb, int wait)
    {
    let mut ret: c_int = 0;
    tid_t target;
...
//
#[no_mangle]
unsafe extern "C" fn ext4_freeze(sb: *mut super_block) -> c_int {
    static int ext4_freeze(struct super_block *sb)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ext4_unfreeze(sb: *mut super_block) -> c_int {
    static int ext4_unfreeze(struct super_block *sb)
    {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ext4_mount_options {
    pub s_mount_opt: c_ulong,
    pub s_mount_opt2: c_ulong,
    pub s_resuid: kuid_t,
    pub s_resgid: kgid_t,
    pub s_commit_interval: c_ulong,
    pub s_max_batch_time: u32 s_min_batch_time,,

    pub s_jquota_fmt: c_int,
    pub s_qf_names: [*mut c_char; EXT4_MAXQUOTAS],
}

#[no_mangle]
unsafe extern "C" fn __ext4_remount(fc: *mut fs_context, sb: *mut super_block) -> c_int {
...
// Store the original options
    ...
    old_opts.s_qf_names[i] = core::ptr::null_mut();
...
//
    ...
    struct ext4_group_desc *gdp =
    ext4_get_group_desc(sb, g, core::ptr::null_mut());
...
//
    ...
    if (sbi.s_journal == core::ptr::null_mut() && !(old_sb_flags & SB_RDONLY)) {
    err = ext4_commit_super(sb);
    if (err)
    goto restore_opts;
    }
    ...
    dquot_resume(sb, -1);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ext4_has_feature_quota(sb)) -> else {
    err = ext4_enable_quotas(sb);
    if (err)
    goto restore_opts;
    }
...
#[no_mangle]
unsafe extern "C" fn ext4_reconfigure(fc: *mut fs_context) -> c_int {
    static int ext4_reconfigure(struct fs_context *fc)
    {
    struct super_block *sb = fc.root.d_sb;
    int ret;
    let mut old_ro: bool = sb_rdonly(sb);
...
#[no_mangle]
unsafe extern "C" fn ext4_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    static int ext4_statfs(struct dentry *dentry, struct kstatfs *buf)
    {
    struct super_block *sb = dentry.d_sb;
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct ext4_super_block *es = sbi.s_es;
    let mut overhead: ext4_fsblk_t = 0, resv_blocks;
    s64 bfree;
...
#[no_mangle]
unsafe extern "C" fn ext4_write_dquot(dquot: *mut dquot) -> c_int {
    static int ext4_write_dquot(struct dquot *dquot)
    {
    int ret, err;
    handle_t *handle;
...
#[no_mangle]
unsafe extern "C" fn ext4_acquire_dquot(dquot: *mut dquot) -> c_int {
    static int ext4_acquire_dquot(struct dquot *dquot)
    {
    int ret, err;
    handle_t *handle;
...
#[no_mangle]
unsafe extern "C" fn ext4_release_dquot(dquot: *mut dquot) -> c_int {
    static int ext4_release_dquot(struct dquot *dquot)
    {
    int ret, err;
    handle_t *handle;
    let mut freeze_protected: bool = false;
//
...
#[no_mangle]
unsafe extern "C" fn ext4_mark_dquot_dirty(dquot: *mut dquot) -> c_int {
    static int ext4_mark_dquot_dirty(struct dquot *dquot)
    {
...
#[no_mangle]
unsafe extern "C" fn ext4_write_info(sb: *mut super_block, type: c_int) -> c_int {
    static int ext4_write_info(struct super_block *sb, int type)
    {
    int ret, err;
    handle_t *handle;
...
#[no_mangle]
unsafe extern "C" fn lockdep_set_quota_inode(inode: *mut inode, subclass: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_check_quota_inum(type: c_int, qf_inum: c_ulong) -> bool {
    static inline bool ext4_check_quota_inum(int type, unsigned long qf_inum)
    {
    switch (type) {
    case USRQUOTA:
    let mut qf_inum: return = = EXT4_USR_QUOTA_INO;
    case GRPQUOTA:
    let mut qf_inum: return = = EXT4_GRP_QUOTA_INO;
    case PRJQUOTA:
...
#[no_mangle]
pub unsafe extern "C" fn ext4_enable_quotas(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_quota_off(sb: *mut super_block, type: c_int) -> c_int {
    static int ext4_quota_off(struct super_block *sb, int type)
    {
...
// we don't have to be afraid of races
    ...
    {
    struct inode *inode = sb_dqopt(sb).files[type];
    let mut blk: ext4_lblk_t = off >> EXT4_BLOCK_SIZE_BITS(sb);
    ...
    bh = ext4_bread(core::ptr::null_mut(), inode, blk, 0);
    if (IS_ERR(bh))
    return PTR_ERR(bh);
    if (!bh)	/* A hole? */
...
// enough credits)
    ...
    struct inode *inode = sb_dqopt(sb).files[type];
    let mut blk: ext4_lblk_t = off >> EXT4_BLOCK_SIZE_BITS(sb);
    let mut err: c_int = 0, err2 = 0, offset = off & (sb.s_blocksize - 1);
...
//
    ...
    unlock_buffer(bh);
    err = ext4_handle_dirty_metadata(handle, core::ptr::null_mut(), bh);
    brelse(bh);
    out:
...
#[no_mangle]
pub unsafe extern "C" fn register_as_ext2() {
    static inline void register_as_ext2(void)
    {
    let mut err: c_int = register_filesystem(&ext2_fs_type);
    if (err)
    printk(KERN_WARNING
    "EXT4-fs: Unable to register as ext2 (%d)\n", err);
    }
#[no_mangle]
pub unsafe extern "C" fn unregister_as_ext2() {
    static inline void unregister_as_ext2(void)
    {
    unregister_filesystem(&ext2_fs_type);
    }
#[no_mangle]
pub unsafe extern "C" fn ext2_feature_set_ok(sb: *mut super_block) -> c_int {
    static inline int ext2_feature_set_ok(struct super_block *sb)
    {
...
#[no_mangle]
pub unsafe extern "C" fn register_as_ext3() {
    static inline void register_as_ext3(void)
    {
    let mut err: c_int = register_filesystem(&ext3_fs_type);
    if (err)
    printk(KERN_WARNING
    "EXT4-fs: Unable to register as ext3 (%d)\n", err);
    }
#[no_mangle]
pub unsafe extern "C" fn unregister_as_ext3() {
    static inline void unregister_as_ext3(void)
    {
    unregister_filesystem(&ext3_fs_type);
    }
#[no_mangle]
pub unsafe extern "C" fn ext3_feature_set_ok(sb: *mut super_block) -> c_int {
    static inline int ext3_feature_set_ok(struct super_block *sb)
    {
...
#[no_mangle]
unsafe extern "C" fn ext4_kill_sb(sb: *mut super_block) {
    static void ext4_kill_sb(struct super_block *sb)
    {
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct file *bdev_file = sbi ? sbi.s_journal_bdev_file : core::ptr::null_mut();
    kill_block_super(sb);
    if (bdev_file)
    fs_bdev_file_release(bdev_file, sb);
    }
...
#[no_mangle]
unsafe extern "C" fn ext4_init_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ext4_exit_fs() -> void __exit {
