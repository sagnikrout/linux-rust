...
//
    ...
    let mut three: c_uint = 1;
    let mut five: c_uint = 5;
    let mut seven: c_uint = 7;
    let mut err: c_int = 0, ret, i;
...
//
#[no_mangle]
unsafe extern "C" fn memswap(a: *mut c_void, b: *mut c_void, len: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn swap_inode_data(inode1: *mut inode, inode2: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_reset_inode_seed(inode: *mut inode) {
...
//
    ...
    {
    struct ext4_inode_info *ei = EXT4_I(inode);
    let mut oldflags: c_uint = ei.i_flags;
...
#[no_mangle]
unsafe extern "C" fn ext4_dax_dontcache(inode: *mut inode, flags: c_uint) {
...
// Allow the DAX flag to be changed on inline directories
    ...
    let mut err: c_int = -EPERM, migrate = 0;
...
#[no_mangle]
unsafe extern "C" fn ext4_ioctl_setproject(inode: *mut inode, projid: __u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_force_shutdown(sb: *mut super_block, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_ioctl_shutdown(sb: *mut super_block, arg: c_ulong) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct getfsmap_info {
    pub gi_sb: *mut super_block,
    pub gi_data: *mut fsmap_head __user,
    pub gi_idx: c_uint,
    pub gi_last_flags: __u32,
}

#[no_mangle]
unsafe extern "C" fn ext4_getfsmap_format(xfm: *mut ext4_fsmap, priv: *mut c_void) -> c_int {
    ...
    {
    let mut info: getfsmap_info = { core::ptr::null_mut() };
    let mut xhead: ext4_fsmap_head = {0};
...
// copy back header
    ...
    ext4_fc_mark_ineligible(sb, EXT4_FC_REASON_RESIZE, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ext4_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
    int ext4_fileattr_get(struct dentry *dentry, struct file_kattr *fa)
    {
    struct inode *inode = d_inode(dentry);
    struct ext4_inode_info *ei = EXT4_I(inode);
    let mut flags: u32 = ei.i_flags & EXT4_FL_USER_VISIBLE;
...
#[no_mangle]
unsafe extern "C" fn ext4_ioctl_get_es_cache(filp: *mut file, arg: c_ulong) -> c_int {
    static int ext4_ioctl_get_es_cache(struct file *filp, unsigned long arg)
    {
    struct fiemap fiemap;
    struct fiemap __user *ufiemap = (struct fiemap __user *) arg;
    let mut fieinfo: fiemap_extent_info = { 0, };
...
#[no_mangle]
unsafe extern "C" fn ext4_ioctl_checkpoint(filp: *mut file, arg: c_ulong) -> c_int {
    static int ext4_ioctl_checkpoint(struct file *filp, unsigned long arg)
    {
    let mut err: c_int = 0;
    let mut flags: __u32 = 0;
    let mut flush_flags: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn ext4_ioctl_setlabel(filp: *mut file, user_label: *const char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_ioctl_getlabel(sbi: *mut ext4_sb_info, user_label: *mut char __user) -> c_int {
...
//
    ...
    struct ext4_sb_info *sbi = EXT4_SB(sb);
    struct ext4_super_block *es = sbi.s_es;
    let mut enabling_casefold: c_int = 0;
    int ret;
    if (!capable(CAP_SYS_ADMIN))
    return -EPERM;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: sbi->s_def_hash_version ==) -> else {
    ...
    params.encoding = EXT4_ENC_UTF8_12_1;
#[no_mangle]
pub unsafe extern "C" fn if(EXT4_ENC_UTF8_12_1: params.encoding !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn __ext4_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
    ...
    ext4_fsblk_t n_blocks_count;
    let mut err: c_int = 0, err2 = 0;
    let mut o_group: ext4_group_t = EXT4_SB(sb).s_groups_count;
...
#[no_mangle]
pub unsafe extern "C" fn ext4_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_compat_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_update_overhead(sb: *mut super_block, force: bool) -> c_int {
