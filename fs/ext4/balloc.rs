...
//
    ...
    ext4_get_group_no_and_offset(sb, block, &group, core::ptr::null_mut());
    return group;
    }
//
...
//
    ...
    let mut block_cluster: c_int = -1, inode_cluster;
    let mut itbl_cluster_start: c_int = -1, itbl_cluster_end = -1;
    let mut start: ext4_fsblk_t = ext4_group_first_block_no(sb, block_group);
    let mut end: ext4_fsblk_t = start + EXT4_BLOCKS_PER_GROUP(sb) - 1;
...
//
    ...
    unsigned int offset;
    let mut ngroups: ext4_group_t = ext4_get_groups_count(sb);
...
// bh = bh_p;
    ...
    let mut bitmap_size: c_ulong = sb.s_blocksize * 8;
    let mut offset: c_uint = num_clusters_in_group(sb, block_group);
...
//
    ...
    ext4_grpblk_t offset;
    ext4_grpblk_t next_zero_bit;
    let mut max_bit: ext4_grpblk_t = EXT4_CLUSTERS_PER_GROUP(sb);
    ext4_fsblk_t blk;
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_should_retry_alloc(sb: *mut super_block, retries: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_count_free_clusters(sb: *mut super_block) -> ext4_fsblk_t {
...
#[no_mangle]
pub unsafe extern "C" fn test_root(a: ext4_group_t, b: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_bg_has_super(sb: *mut super_block, group: ext4_group_t) -> c_int {
    ...
    ext4_group_t group)
    {
    let mut metagroup: c_ulong = group / EXT4_DESC_PER_BLOCK(sb);
    let mut first: ext4_group_t = metagroup * EXT4_DESC_PER_BLOCK(sb);
    let mut last: ext4_group_t = first + EXT4_DESC_PER_BLOCK(sb) - 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_bg_num_gdb(sb: *mut super_block, group: ext4_group_t) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_inode_to_goal_block(inode: *mut inode) -> ext4_fsblk_t {
    ext4_fsblk_t ext4_inode_to_goal_block(struct inode *inode)
    {
    struct ext4_inode_info *ei = EXT4_I(inode);
    ext4_group_t block_group;
    ext4_grpblk_t colour;
    let mut flex_size: c_int = ext4_flex_bg_size(EXT4_SB(inode.i_sb));
