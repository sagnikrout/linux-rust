...
pub const EXT4_INLINE_DOTDOT_OFFSET: c_int = 2;
pub const EXT4_INLINE_DOTDOT_SIZE: c_int = 4;
    static int ext4_da_convert_inline_data_to_extent(struct address_space *mapping,
    struct inode *inode);
#[no_mangle]
unsafe extern "C" fn ext4_get_inline_size(inode: *mut inode) -> c_int {
...
// Compute min_offs.
    ...
    let mut offs: usize = le16_to_cpu(entry.e_value_offs);
    if (offs < min_offs)
    min_offs = offs;
    }
    entry = next;
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_get_max_inline_size(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_find_inline_data_nolock(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_read_inline_folio(inode: *mut inode, folio: *mut folio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_readpage_inline(inode: *mut inode, folio: *mut folio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !folio_test_uptodate(folio)) -> else {
    ...
    let mut retries: c_int = 0, sem_held = 0;
...
//
    ...
    struct inode *inode)
    {
    let mut ret: c_int = 0, inline_size;
    struct folio *folio;
    ...
    ret = ext4_block_write_begin(core::ptr::null_mut(), folio, 0, inline_size,
...
#[no_mangle]
pub unsafe extern "C" fn ext4_update_final_de(de_buf: *mut c_void, old_size: c_int, new_size: c_int) {
...
// this is just created, so create an empty entry.
    ...
    {
    int ret;
    let mut old_size: c_int = EXT4_I(dir).i_inline_size - EXT4_MIN_INLINE_DATA_SIZE;
    let mut new_size: c_int = get_max_inline_xattr_value_size(dir, iloc);
    if (new_size - old_size <= ext4_dir_rec_len(1, core::ptr::null_mut()))
    return -ENOSPC;
    ...
    struct buffer_head *data_bh = core::ptr::null_mut();
...
//
    ...
    struct ext4_iloc iloc;
    void *dir_buf = core::ptr::null_mut();
...
//
    ...
    ext4_dir_rec_len(fake.name_len, core::ptr::null_mut()),
    inline_size);
...
//
    dotdot_offset = ext4_dir_rec_len(1, core::ptr::null_mut());
    dotdot_size = dotdot_offset + ext4_dir_rec_len(2, core::ptr::null_mut());
...
//
    if (i + ext4_dir_rec_len(1, core::ptr::null_mut()) > extra_size)
    break;
...
//
    if (ctx.pos + ext4_dir_rec_len(1, core::ptr::null_mut()) > extra_size)
    goto out;
    de = (struct ext4_dir_entry_2 *)
...
#[no_mangle]
pub unsafe extern "C" fn empty_inline_dir(dir: *mut inode, has_inline_data: *mut c_int) -> bool {
...
// has_inline_data = 0;
    ...
    if (ext4_check_dir_entry(dir, core::ptr::null_mut(), de,
    iloc.bh, inline_pos,
    inline_size, offset)) {
    ext4_warning(dir.i_sb,
...
#[no_mangle]
pub unsafe extern "C" fn ext4_destroy_inline_data(handle: *mut handle_t, inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_inline_data_iomap(inode: *mut inode, iomap: *mut iomap) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_inline_data_truncate(inode: *mut inode, has_inline: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_convert_inline_data(inode: *mut inode) -> c_int {
