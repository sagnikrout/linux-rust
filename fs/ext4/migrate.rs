...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct migrate_struct {
    pub curr_block: ext4_lblk_t first_block, last_block,,
    pub last_pblock: ext4_fsblk_t first_pblock,,
}

    static int finish_range(handle_t *handle, struct inode *inode,
    struct migrate_struct *lb)
    {
    let mut retval: c_int = 0, needed;
...
//
    ...
    __le32 *i_data;
    int i, retval = 0;
    let mut max_entries: c_ulong = inode.i_sb.s_blocksize >> 2;
...
// Only update the file block number
    ...
    if (err < 0)
    return err;
    ext4_free_blocks(handle, inode, core::ptr::null_mut(), le32_to_cpu(i_data), 1,
    EXT4_FREE_BLOCKS_METADATA |
    EXT4_FREE_BLOCKS_FORGET);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn free_ind_block(handle: *mut handle_t, inode: *mut inode, i_data: *mut __le32) -> c_int {
...
//
    ...
    if (retval < 0)
    return retval;
    ext4_free_blocks(handle, inode, core::ptr::null_mut(), block, 1,
...
//
#[no_mangle]
unsafe extern "C" fn free_ext_block(handle: *mut handle_t, inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_ext_migrate(inode: *mut inode) -> c_int {
    ...
    struct inode *tmp_inode = core::ptr::null_mut();
    struct migrate_struct lb;
...
//
    ...
    S_IFREG, core::ptr::null_mut(), goal, owner, 0);
    if (IS_ERR(tmp_inode)) {
    retval = PTR_ERR(tmp_inode);
    ext4_journal_stop(handle);
    tmp_inode = core::ptr::null_mut();
    goto out_unlock;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ext4_ind_migrate(inode: *mut inode) -> c_int {
