...
#[no_mangle]
unsafe extern "C" fn __read_end_io(bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn verity_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn mpage_end_io(bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn ext4_set_verity_work(bio: *mut bio, vi: *mut fsverity_info) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_readpage_limit(inode: *mut inode) -> loff_t {
    ...
    int length;
    let mut relative_block: unsigned = 0;
...
//
    ...
    let mut map_offset: unsigned = block_in_file - map.m_lblk;
    let mut last: unsigned = map.m_len - map_offset;
...
//
    ...
    if (ext4_map_blocks(core::ptr::null_mut(), inode, &map, 0) < 0) {
    set_error_page:
...
#[no_mangle]
pub unsafe extern "C" fn if(map.m_pblk: first_block + page_block !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    ...
    return ext4_mpage_readpages(inode, vi, core::ptr::null_mut(), folio);
    }
#[no_mangle]
pub unsafe extern "C" fn ext4_readahead(rac: *mut readahead_control) {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_init_verity_caches() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_exit_verity_caches() {
