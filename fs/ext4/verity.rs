...
#[no_mangle]
pub unsafe extern "C" fn ext4_verity_metadata_pos(inode: *const inode) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn ext4_begin_enable_verity(filp: *mut file) -> c_int {
...
//
    ...
    let mut desc_end: u64 = desc_pos + desc_size;
    let mut desc_size_disk: __le32 = cpu_to_le32(desc_size);
...
//
    ...
    path = ext4_find_extent(inode, EXT_MAX_BLOCKS - 1, core::ptr::null_mut(), 0);
    if (IS_ERR(path))
    return PTR_ERR(path);
