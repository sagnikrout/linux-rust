...
#[no_mangle]
pub unsafe extern "C" fn ext4_fname_free_filename(fname: *mut ext4_filename) {
...
#[no_mangle]
unsafe extern "C" fn uuid_is_zero(u[16]: __u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ext4_ioctl_get_encryption_pwsalt(filp: *mut file, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_get_context(inode: *mut inode, ctx: *mut c_void, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext4_has_stable_inodes(sb: *mut super_block) -> bool {
