...
#[no_mangle]
pub unsafe extern "C" fn jffs2_erase_pending_blocks(c: *mut jffs2_sb_info, count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jffs2_erase_succeeded(c: *mut jffs2_sb_info, jeb: *mut jffs2_eraseblock) {
    static void jffs2_erase_succeeded(struct jffs2_sb_info *c, struct jffs2_eraseblock *jeb)
    {
...
#[no_mangle]
unsafe extern "C" fn jffs2_erase_failed(c: *mut jffs2_sb_info, jeb: *mut jffs2_eraseblock, bad_offset: u32) {
    static void jffs2_erase_failed(struct jffs2_sb_info *c, struct jffs2_eraseblock *jeb, uint32_t bad_offset)
    {
...
// Hmmm. Maybe we should accept the extra space it takes and make
    ...
    {
    struct jffs2_inode_cache *ic = core::ptr::null_mut();
...
// prev = this->next_in_ino;
    this.next_in_ino = core::ptr::null_mut();
    if (this == ref)
    break;
    continue;
    }
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_free_jeb_node_refs(c: *mut jffs2_sb_info, jeb: *mut jffs2_eraseblock) {
...
// else it was a non-inode node or already removed, so don't bother
    ...
    jeb.first_node = jeb.last_node = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn jffs2_block_check_erase(c: *mut jffs2_sb_info, jeb: *mut jffs2_eraseblock, bad_offset: *mut u32) -> c_int {
...
// wordebuf, *bad_offset);
    ...
    let mut readlen: u32 = min((uint32_t)PAGE_SIZE, jeb.offset + c.sector_size - ofs);
    int i;
// bad_offset = ofs;
...
#[no_mangle]
unsafe extern "C" fn jffs2_mark_erased_block(c: *mut jffs2_sb_info, jeb: *mut jffs2_eraseblock) {
    static void jffs2_mark_erased_block(struct jffs2_sb_info *c, struct jffs2_eraseblock *jeb)
    {
    size_t retlen;
    int ret;
...
// Account for cleanmarker now, if it's in-band
    ...
    jffs2_link_node_ref(c, jeb, jeb.offset | REF_NORMAL, c.cleanmarker_size, core::ptr::null_mut());
