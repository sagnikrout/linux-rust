...
//
#[no_mangle]
unsafe extern "C" fn jffs2_rp_can_write(c: *mut jffs2_sb_info) -> c_int {
...
//
    ...
    let mut blocksneeded: c_int = c.resv_blocks_write;
// align it
    minsize = PAD(minsize);
...
#[no_mangle]
unsafe extern "C" fn jffs2_close_nextblock(c: *mut jffs2_sb_info, jeb: *mut jffs2_eraseblock) {
    static void jffs2_close_nextblock(struct jffs2_sb_info *c, struct jffs2_eraseblock *jeb)
    {
    if (c.nextblock == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn jffs2_find_nextblock(c: *mut jffs2_sb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_complete_reservation(c: *mut jffs2_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn on_list(obj: *mut list_head, head: *mut list_head) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_mark_node_obsolete(c: *mut jffs2_sb_info, ref: *mut jffs2_raw_node_ref) {
    ...
    uint32_t freed_len;
    if(unlikely(!ref)) {
    pr_notice("EEEEEK. jffs2_mark_node_obsolete called with core::ptr::null_mut() node\n");
    return;
    }
    if (ref_obsolete(ref)) {
...
// Nodes which have been marked obsolete no longer need to be
    ...
    ;
// p = ref->next_in_ino;
    ref.next_in_ino = core::ptr::null_mut();
    switch (ic.class) {
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_thread_should_wake(c: *mut jffs2_sb_info) -> c_int {
    int jffs2_thread_should_wake(struct jffs2_sb_info *c)
    {
    let mut ret: c_int = 0;
    uint32_t dirty;
    let mut nr_very_dirty: c_int = 0;
    struct jffs2_eraseblock *jeb;
