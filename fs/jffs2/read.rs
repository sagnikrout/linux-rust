...
//
    ...
    size_t readlen;
    uint32_t crc;
    unsigned char *decomprbuf = core::ptr::null_mut();
    unsigned char *readbuf = core::ptr::null_mut();
    let mut ret: c_int = 0;
...
// end of the file).
    ...
    let mut holesize: u32 = end - offset;
    ...
    let mut holeend: u32 = min(end, frag.ofs + frag.size);
