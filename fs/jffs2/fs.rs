...
#[no_mangle]
pub unsafe extern "C" fn jffs2_do_setattr(inode: *mut inode, iattr: *mut iattr) -> c_int {
    ...
    unsigned char *mdata = core::ptr::null_mut();
    let mut mdatalen: c_int = 0;
    unsigned int ivalid;
    uint32_t alloclen;
    int ret;
    let mut alloc_type: c_int = ALLOC_NORMAL;
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_evict_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_dirty_inode(inode: *mut inode, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_do_remount_fs(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calculate_inocache_hashsize(flash_size: u32) -> c_int {
...
// to sensible bounds.
//
    let mut size_mb: c_int = flash_size / 1024 / 1024;
    let mut hashsize: c_int = (size_mb * 2) & ~0x3f;
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_do_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jffs2_flash_setup(c: *mut jffs2_sb_info) -> c_int {
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_flash_cleanup(c: *mut jffs2_sb_info) {
    if (jffs2_cleanmarker_oob(c)) {
