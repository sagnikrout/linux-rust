...
#[no_mangle]
pub unsafe extern "C" fn jffs2_fsync(filp: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jffs2_do_readpage_nolock(inode: *mut inode, folio: *mut folio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __jffs2_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    int __jffs2_read_folio(struct file *file, struct folio *folio)
    {
    let mut ret: c_int = jffs2_do_readpage_nolock(folio.mapping.host, folio);
    folio_unlock(folio);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn jffs2_read_folio(file: *mut file, folio: *mut folio) -> c_int {
...
//
    ...
    struct jffs2_sb_info *c = JFFS2_SB_INFO(inode.i_sb);
    struct jffs2_raw_inode *ri;
    let mut start: unsigned = pos & (PAGE_SIZE - 1);
    let mut end: unsigned = start + copied;
    let mut aligned_start: unsigned = start & ~3;
    let mut ret: c_int = 0;
