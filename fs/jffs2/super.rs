...
#[no_mangle]
unsafe extern "C" fn jffs2_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn jffs2_i_init_once(foo: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn jffs2_show_options(s: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jffs2_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jffs2_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jffs2_update_mount_opts(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn jffs2_reconfigure(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn jffs2_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jffs2_get_tree(fc: *mut fs_context) -> c_int {
    static int jffs2_get_tree(struct fs_context *fc)
    {
    return get_tree_mtd(fc, jffs2_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn jffs2_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn jffs2_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jffs2_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn jffs2_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn init_jffs2_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_jffs2_fs() -> void __exit {
