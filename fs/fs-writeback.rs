...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wb_writeback_work {
    pub nr_pages: c_long,
    pub sb: *mut super_block,
    pub sync_mode: enum writeback_sync_modes,
    pub tagged_writepages:1: c_uint,
    pub for_kupdate:1: c_uint,
    pub range_cyclic:1: c_uint,
    pub for_background:1: c_uint,
    pub /: *mut *mut unsigned int for_sync:1; / sync(2) WB_SYNC_ALL writeback,
    pub /: *mut *mut unsigned int auto_free:1; / free on completion,
    pub /: *mut *mut enum wb_reason reason; / why was writeback initiated?,
    pub /: *mut *mut list_head list; / pending work list,
    pub /: *mut *mut *mut wb_completion done; / set if the caller waits,
}
...
//
    let mut dirtytime_expire_interval: static unsigned int = 12 * 60 * 60;
...
#[no_mangle]
unsafe extern "C" fn wb_io_lists_populated(wb: *mut bdi_writeback) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wb_io_lists_depopulated(wb: *mut bdi_writeback) {
...
#[no_mangle]
unsafe extern "C" fn wb_wakeup(wb: *mut bdi_writeback) {
...
//
#[no_mangle]
unsafe extern "C" fn wb_wakeup_delayed(wb: *mut bdi_writeback) {
...
#[no_mangle]
unsafe extern "C" fn finish_writeback_work(work: *mut wb_writeback_work) {
...
#[no_mangle]
unsafe extern "C" fn wb_wait_for_completion_cb(done: *mut wb_completion) -> bool {
    static bool wb_wait_for_completion_cb(struct wb_completion *done)
    {
    let mut timeout: c_ulong = sysctl_hung_task_timeout_secs;
    let mut waited_secs: c_ulong = (jiffies - done.wait_start) / HZ;
...
//
#[no_mangle]
pub unsafe extern "C" fn wb_wait_for_completion(done: *mut wb_completion) {
...
//
    ...
    / sizeof(struct inode *))
    let mut isw_nr_in_flight: static atomic_t = ATOMIC_INIT(0);
    static struct workqueue_struct *isw_wq;
#[no_mangle]
pub unsafe extern "C" fn __inode_attach_wb(inode: *mut inode, folio: *mut folio) {
...
//
    if (unlikely(cmpxchg(&inode.i_wb, core::ptr::null_mut(), wb)))
    wb_put(wb);
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inode_switch_wbs_context {
...
#[no_mangle]
unsafe extern "C" fn bdi_down_write_wb_switch_rwsem(bdi: *mut backing_dev_info) {
    static void bdi_down_write_wb_switch_rwsem(struct backing_dev_info *bdi)
    {
    down_write(&bdi.wb_switch_rwsem);
    }
#[no_mangle]
unsafe extern "C" fn bdi_up_write_wb_switch_rwsem(bdi: *mut backing_dev_info) {
...
#[no_mangle]
pub unsafe extern "C" fn cgroup_writeback_pin(sb: *mut super_block) {
    static inline void cgroup_writeback_pin(struct super_block *sb)
    {
    atomic_inc(&sb.s_isw_nr_in_flight);
    }
#[no_mangle]
pub unsafe extern "C" fn cgroup_writeback_unpin(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn cgroup_writeback_drain(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_switch_wbs_work_fn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn inode_switch_wbs(inode: *mut inode, new_wb_id: c_int) {
    static void inode_switch_wbs(struct inode *inode, int new_wb_id)
    {
    struct backing_dev_info *bdi = inode_to_bdi(inode);
    struct cgroup_subsys_state *memcg_css;
    struct inode_switch_wbs_context *isw;
    struct bdi_writeback *new_wb = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn cleanup_offline_cgwb(wb: *mut bdi_writeback) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn wbc_detach_inode(wbc: *mut writeback_control) {
...
//
#[no_mangle]
unsafe extern "C" fn wb_split_bdi_pages(wb: *mut bdi_writeback, nr_pages: c_long) -> c_long {
    static long wb_split_bdi_pages(struct bdi_writeback *wb, long nr_pages)
    {
    let mut this_bw: c_ulong = wb.avg_write_bandwidth;
...
//
    ...
    bool skip_if_busy)
    {
    struct bdi_writeback *last_wb = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn cgroup_writeback_umount(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn cgroup_writeback_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn get_nr_dirty_pages() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn wb_start_writeback(wb: *mut bdi_writeback, reason: enum wb_reason) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wb_start_background_writeback(wb: *mut bdi_writeback) {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_io_list_del(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sb_mark_inode_writeback(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sb_clear_inode_writeback(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn redirty_tail_locked(inode: *mut inode, wb: *mut bdi_writeback) {
...
#[no_mangle]
unsafe extern "C" fn redirty_tail(inode: *mut inode, wb: *mut bdi_writeback) {
...
//
#[no_mangle]
unsafe extern "C" fn requeue_io(inode: *mut inode, wb: *mut bdi_writeback) {
    static void requeue_io(struct inode *inode, struct bdi_writeback *wb)
    {
    inode_io_list_move_locked(inode, wb, &wb.b_more_io);
    }
#[no_mangle]
unsafe extern "C" fn inode_sync_complete(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn inode_dirtied_after(inode: *mut inode, t: c_ulong) -> bool {
    static bool inode_dirtied_after(struct inode *inode, unsigned long t)
    {
    let mut ret: bool = time_after(inode.dirtied_when, t);
...
//
    ...
    {
    int moved;
    let mut time_expire_jif: c_ulong = dirtied_before;
    assert_spin_locked(&wb.list_lock);
...
#[no_mangle]
unsafe extern "C" fn write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_wait_for_writeback(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn inode_sleep_on_writeback(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn __sync_lazytime(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sync_lazytime(inode: *mut inode) -> bool {
...
//
    ...
    let mut err: c_int = filemap_fdatawait(mapping);
    if (ret == 0)
    ret = err;
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn if(I_PINNING_NETFS_WB): unlikely(inode_state_read(inode) &) -> else {
...
// Don't write the inode if only I_DIRTY_PAGES was set
    ...
    let mut err: c_int = write_inode(inode, wbc);
    if (ret == 0)
    ret = err;
    }
//
...
//
    ...
    inode_cgwb_move_to_attached(inode, wb);
#[no_mangle]
pub unsafe extern "C" fn if(I_SYNC_QUEUED): !(inode_state_read(inode) &) -> else {
    if ((inode_state_read(inode) & I_DIRTY))
    redirty_tail_locked(inode, wb);
#[no_mangle]
pub unsafe extern "C" fn if(I_DIRTY_TIME: inode_state_read(inode) &) -> else {
    inode.dirtied_when = jiffies;
...
//
    ...
    let mut dirtied_before: c_ulong = jiffies;
    if (work.for_kupdate)
...
//
    ...
    struct wb_writeback_work *work)
    {
    let mut nr_pages: c_long = work.nr_pages;
    let mut dirtied_before: c_ulong = jiffies;
    struct inode *inode;
    long progress;
    struct blk_plug plug;
...
//
    ...
    {
    struct wb_writeback_work *work = core::ptr::null_mut();
    spin_lock_irq(&wb.work_lock);
...
#[no_mangle]
unsafe extern "C" fn wb_check_background_flush(wb: *mut bdi_writeback) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn wb_check_old_data_flush(wb: *mut bdi_writeback) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn wb_check_start_all(wb: *mut bdi_writeback) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn wb_check_start_dontcache(wb: *mut bdi_writeback) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn wb_do_writeback(wb: *mut bdi_writeback) -> c_long {
    static long wb_do_writeback(struct bdi_writeback *wb)
    {
    struct wb_writeback_work *work;
    let mut wrote: c_long = 0;
    set_bit(WB_writeback_running, &wb.state);
    while ((work = get_next_work_item(wb)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wb_workfn(work: *mut work_struct) {
...
//
    ...
    wb_wakeup(wb);
#[no_mangle]
pub unsafe extern "C" fn if(dirty_writeback_interval: wb_has_dirty_io(wb) &&) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn filemap_dontcache_kick_writeback(mapping: *mut address_space) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wakeup_flusher_threads(reason: enum wb_reason) {
...
#[no_mangle]
unsafe extern "C" fn wakeup_dirtytime_writeback(w: *mut work_struct) {
    static void wakeup_dirtytime_writeback(struct work_struct *w)
    {
    struct backing_dev_info *bdi;
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn start_dirtytime_writeback() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn __mark_inode_dirty(inode: *mut inode, flags: c_int) {
    void __mark_inode_dirty(struct inode *inode, int flags)
    {
    struct super_block *sb = inode.i_sb;
    let mut dirtytime: c_int = 0;
    struct bdi_writeback *wb = core::ptr::null_mut();
    trace_writeback_mark_inode_dirty(inode, flags);
    if (flags & I_DIRTY_INODE) {
    let mut was_dirty_time: bool = false;
//
...
//
    ...
    let mut was_dirty: c_int = inode_state_read(inode) & I_DIRTY;
    inode_attach_wb(inode, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn wait_sb_inodes(sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn writeback_inodes_sb(sb: *mut super_block, reason: enum wb_reason) {
...
//
#[no_mangle]
pub unsafe extern "C" fn try_to_writeback_inodes_sb(sb: *mut super_block, reason: enum wb_reason) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sync_inodes_sb(sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn write_inode_now(inode: *mut inode, sync: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sync_inode_metadata(inode: *mut inode, wait: c_int) -> c_int {
