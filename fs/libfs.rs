...
#[no_mangle]
pub unsafe extern "C" fn simple_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    int simple_statfs(struct dentry *dentry, struct kstatfs *buf)
    {
    let mut id: u64 = huge_encode_dev(dentry.d_sb.s_dev);
...
//
#[no_mangle]
pub unsafe extern "C" fn always_delete_dentry(dentry: *const dentry) -> c_int {
...
//
    ...
    return d_splice_alias(core::ptr::null_mut(), dentry);
    }
    EXPORT_SYMBOL(simple_lookup);
#[no_mangle]
pub unsafe extern "C" fn dcache_dir_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dcache_dir_close(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    struct dentry *last)
    {
    struct dentry *dentry = cursor.d_parent, *found = core::ptr::null_mut();
    spin_lock(&dentry.d_lock);
    while (*p) {
...
#[no_mangle]
pub unsafe extern "C" fn dcache_dir_lseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
    ...
    struct dentry *to = core::ptr::null_mut();
    inode_lock_shared(dentry.d_inode);
    if (offset > 2)
    to = scan_positives(cursor, &dentry.d_children.first,
    offset - 2, core::ptr::null_mut());
    spin_lock(&dentry.d_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn dcache_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
    int dcache_readdir(struct file *file, struct dir_context *ctx)
    {
    struct dentry *dentry = file.f_path.dentry;
    struct dentry *cursor = file.private_data;
    struct dentry *next = core::ptr::null_mut();
    struct hlist_node **p;
    ...
    p = &cursor.d_sib.next;
    while ((next = scan_positives(cursor, p, 1, next)) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn generic_read_dir(filp: *mut file, buf: *mut char __user, siz: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn offset_set(dentry: *mut dentry, offset: c_long) {
    static void offset_set(struct dentry *dentry, long offset)
    {
    dentry.d_fsdata = (void *)offset;
    }
#[no_mangle]
unsafe extern "C" fn dentry2offset(dentry: *mut dentry) -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn simple_offset_init(octx: *mut offset_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn simple_offset_add(octx: *mut offset_ctx, dentry: *mut dentry) -> c_int {
    ...
    GFP_KERNEL);
    if (unlikely(ret < 0))
    let mut ret: return = = -EBUSY ? -ENOSPC : ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn simple_offset_remove(octx: *mut offset_ctx, dentry: *mut dentry) {
...
//
    ...
    let mut new_offset: c_long = dentry2offset(new_dentry);
...
//
    ...
    struct offset_ctx *old_ctx = old_dir.i_op.get_offset_ctx(old_dir);
    struct offset_ctx *new_ctx = new_dir.i_op.get_offset_ctx(new_dir);
    let mut old_index: c_long = dentry2offset(old_dentry);
    let mut new_index: c_long = dentry2offset(new_dentry);
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn simple_offset_destroy(octx: *mut offset_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn offset_dir_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !dentry) -> else {
    else if (!dentry)
    ...
    struct dentry *child, *found = core::ptr::null_mut();
    MA_STATE(mas, &octx.mt, offset, offset);
    if (offset == DIR_OFFSET_FIRST)
    found = find_positive_dentry(parent, core::ptr::null_mut(), false);
    else {
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn offset_dir_emit(ctx: *mut dir_context, dentry: *mut dentry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn offset_iterate_dir(file: *mut file, ctx: *mut dir_context) {
...
//
#[no_mangle]
unsafe extern "C" fn offset_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
    ...
    {
    struct dentry *child = core::ptr::null_mut(), *d;
    spin_lock(&parent.d_lock);
    ...
    while (true) {
    struct dentry *victim = core::ptr::null_mut(), *child;
    struct inode *inode = this.d_inode;
    inode_lock_nested(inode, I_MUTEX_CHILD);
    if (d_is_dir(this))
    inode.i_flags |= S_DEAD;
    while ((child = find_next_child(this, victim)) == core::ptr::null_mut()) {
// kill and ascend
...
#[no_mangle]
unsafe extern "C" fn pseudo_fs_fill_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseudo_fs_get_tree(fc: *mut fs_context) -> c_int {
    static int pseudo_fs_get_tree(struct fs_context *fc)
    {
    return get_tree_nodev(fc, pseudo_fs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn pseudo_fs_free(fc: *mut fs_context) {
...
#[no_mangle]
pub unsafe extern "C" fn simple_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn simple_link(old_dentry: *mut dentry, dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn simple_empty(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __simple_unlink(dir: *mut inode, dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn __simple_rmdir(dir: *mut inode, dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn simple_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn simple_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
    ...
    struct inode *new_dir, struct dentry *new_dentry)
    {
    let mut old_is_dir: bool = d_is_dir(old_dentry);
    let mut new_is_dir: bool = d_is_dir(new_dentry);
    ...
    {
    let mut they_are_dirs: c_int = d_is_dir(old_dentry);
...
#[no_mangle]
unsafe extern "C" fn simple_read_folio(file: *mut file, folio: *mut folio) -> c_int {
...
//
    ...
    let mut last_pos: loff_t = pos + copied;
...
#[no_mangle]
pub unsafe extern "C" fn simple_pin_fs(type: *mut file_system_type, mount: *mut vfsmount, count: *mut c_int) -> c_int {
    int simple_pin_fs(struct file_system_type *type, struct vfsmount **mount, int *count)
    {
    struct vfsmount *mnt = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn simple_release_fs(mount: *mut vfsmount, count: *mut c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn simple_transaction_set(file: *mut file, n: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn simple_transaction_read(file: *mut file, buf: *mut char __user, size: usize, pos: *mut loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn simple_transaction_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn simple_attr_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    let mut type: c_int = FILEID_INO32_GEN;
    if (parent && (len < 4)) {
// max_len = 4;
...
//
#[no_mangle]
pub unsafe extern "C" fn simple_fsync(file: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_check_addressable(blocksize_bits: unsigned, num_blocks: u64) -> c_int {
    int generic_check_addressable(unsigned blocksize_bits, u64 num_blocks)
    {
    let mut last_fs_block: u64 = num_blocks - 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn noop_fsync(file: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn noop_direct_IO(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn kfree_link(p: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn empty_dir_listxattr(dentry: *mut dentry, list: *mut c_char, size: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn empty_dir_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn empty_dir_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn make_empty_dir_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn is_empty_dir_inode(inode: *mut inode) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_ci_d_hash(dentry: *const dentry, str: *mut qstr) -> c_int {
...
//
    ...
    const struct unicode_map *um = sb.s_encoding;
    let mut decrypted_name: fscrypt_str = FSTR_INIT(core::ptr::null_mut(), de_name_len);
    let mut dirent: qstr = QSTR_INIT(de_name, de_name_len);
    let mut res: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_set_sb_d_ops(sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_maybe_inc_iversion(inode: *mut inode, force: bool) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_query_iversion(inode: *mut inode) -> u64 {
    u64 inode_query_iversion(struct inode *inode)
    {
    u64 cur, new;
    let mut fenced: bool = false;
//
...
// If flag is already set, then no need to swap
    ...
    let mut pos: loff_t = iocb.ki_pos - buffered_written;
    let mut end: loff_t = iocb.ki_pos - 1;
    int err;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn simple_inode_init_ts(inode: *mut inode) -> timespec64 {
...
// Assume any old dentry was cleared out.
    old = cmpxchg(stashed, core::ptr::null_mut(), dentry);
    if (likely(!old))
    return dentry;
...
#[no_mangle]
pub unsafe extern "C" fn stashed_dentry_prune(dentry: *mut dentry) {
...
// dentry in there.
//
    cmpxchg(stashed, dentry, core::ptr::null_mut());
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn simple_done_creating(child: *mut dentry) {
