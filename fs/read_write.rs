...
#[no_mangle]
pub unsafe extern "C" fn unsigned_offsets(file: *mut file) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_setpos(file: *mut file, offset: loff_t, maxsize: loff_t) -> loff_t {
    loff_t vfs_setpos(struct file *file, loff_t offset, loff_t maxsize)
    {
    return vfs_setpos_cookie(file, offset, maxsize, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn must_set_pos(file: *mut file, offset: *mut loff_t, whence: c_int, eof: loff_t) -> c_int {
...
//
    ...
    let mut maxsize: loff_t = inode.i_sb.s_maxbytes;
    let mut eof: loff_t = i_size_read(inode);
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_file_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn fixed_size_llseek(file: *mut file, offset: loff_t, whence: c_int, size: loff_t) -> loff_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn no_seek_end_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn no_seek_end_llseek_size(file: *mut file, offset: loff_t, whence: c_int, size: loff_t) -> loff_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn noop_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
pub unsafe extern "C" fn default_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
pub unsafe extern "C" fn vfs_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn ksys_lseek(fd: c_uint, offset: off_t, whence: c_uint) -> off_t {
    ...
    retval = -EINVAL;
    if (whence <= SEEK_MAX) {
    let mut res: loff_t = vfs_llseek(fd_file(f), offset, whence);
    retval = res;
...
#[no_mangle]
pub unsafe extern "C" fn rw_verify_area(read_write: c_int, file: *mut file, ppos: *const loff_t, count: usize) -> c_int {
    int rw_verify_area(int read_write, struct file *file, const loff_t *ppos, size_t count)
    {
    let mut mask: c_int = read_write == READ ? MAY_READ : MAY_WRITE;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn new_sync_read(filp: *mut file, buf: *mut char __user, len: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn warn_unsupported(file: *mut file, op: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __kernel_read(file: *mut file, buf: *mut c_void, count: usize, pos: *mut loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn kernel_read(file: *mut file, buf: *mut c_void, count: usize, pos: *mut loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn vfs_read(file: *mut file, buf: *mut char __user, count: usize, pos: *mut loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: file->f_op->read_iter) -> else {
...
#[no_mangle]
unsafe extern "C" fn new_sync_write(filp: *mut file, buf: *const char __user, len: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn __kernel_write_iter(file: *mut file, from: *mut iov_iter, pos: *mut loff_t) -> isize {
...
// caller is responsible for file_start_write/file_end_write
#[no_mangle]
pub unsafe extern "C" fn __kernel_write(file: *mut file, buf: *const c_void, count: usize, pos: *mut loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn vfs_write(file: *mut file, buf: *const char __user, count: usize, pos: *mut loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: file->f_op->write_iter) -> else {
...
// file_ppos returns &file->f_pos or NULL if file is stream
    ...
    {
    return file.f_mode & FMODE_STREAM ? core::ptr::null_mut() : &file.f_pos;
    }
#[no_mangle]
pub unsafe extern "C" fn ksys_read(fd: c_uint, buf: *mut char __user, count: usize) -> isize {
    ssize_t ksys_read(unsigned int fd, char __user *buf, size_t count)
    {
    CLASS(fd_pos, f)(fd);
    let mut ret: isize = -EBADF;
    if (!fd_empty(f)) {
...
#[no_mangle]
pub unsafe extern "C" fn ksys_write(fd: c_uint, buf: *const char __user, count: usize) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn pos_from_hilo(high: c_ulong, low: c_ulong) -> loff_t {
    ...
    {
    let mut pos: loff_t = pos_from_hilo(pos_h, pos_l);
...
//
    ...
    {
    let mut pos: loff_t = ((loff_t)pos_high << 32) | pos_low;
    return do_preadv(fd, vec, vlen, pos, 0);
    }
...
// ppos = pos;
    ...
    return do_sendfile(out_fd, in_fd, core::ptr::null_mut(), count, 0);
    }
...
//
    ...
    {
    ssize_t ret;
    let mut splice: bool = flags & COPY_FILE_SPLICE;
    let mut samesb: bool = file_inode(file_in).i_sb == file_inode(file_out).i_sb;
    if (flags & ~COPY_FILE_SPLICE)
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_write_check_limits(file: *mut file, pos: loff_t, count: *mut loff_t) -> c_int {
    int generic_write_check_limits(struct file *file, loff_t pos, loff_t *count)
    {
    struct inode *inode = file.f_mapping.host;
    let mut max_size: loff_t = inode.i_sb.s_maxbytes;
    let mut limit: loff_t = rlimit(RLIMIT_FSIZE);
...
#[no_mangle]
pub unsafe extern "C" fn generic_write_checks_count(iocb: *mut kiocb, count: *mut loff_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_write_checks(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_file_rw_checks(file_in: *mut file, file_out: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn generic_atomic_write_valid(iocb: *mut kiocb, iter: *mut iov_iter) -> c_int {
