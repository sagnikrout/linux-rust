...
#[no_mangle]
unsafe extern "C" fn __adfs_dir_cleanup(dir: *mut adfs_dir) {
    static void __adfs_dir_cleanup(struct adfs_dir *dir)
    {
    dir.nr_buffers = 0;
    if (dir.bhs != dir.bh)
    kfree(dir.bhs);
    dir.bhs = core::ptr::null_mut();
    dir.sb = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn adfs_dir_relse(dir: *mut adfs_dir) {
...
#[no_mangle]
unsafe extern "C" fn adfs_dir_forget(dir: *mut adfs_dir) {
...
#[no_mangle]
unsafe extern "C" fn adfs_dir_mark_dirty(dir: *mut adfs_dir) {
...
#[no_mangle]
unsafe extern "C" fn adfs_dir_sync(dir: *mut adfs_dir) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adfs_object_fixup(dir: *mut adfs_dir, obj: *mut object_info) {
...
//
    ...
    let mut filetype: u16 = adfs_filetype(obj.loadaddr);
...
#[no_mangle]
unsafe extern "C" fn adfs_iterate(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adfs_tolower(c: c_uchar) -> c_uchar {
