...
#[no_mangle]
unsafe extern "C" fn adfs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int adfs_read_folio(struct file *file, struct folio *folio)
    {
    return block_read_full_folio(folio, adfs_get_block);
    }
#[no_mangle]
unsafe extern "C" fn adfs_write_failed(mapping: *mut address_space, to: loff_t) {
...
#[no_mangle]
unsafe extern "C" fn _adfs_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
...
//
    ...
    {
    let mut attr: c_uint = ADFS_I(inode).attr;
    umode_t mode, rmask;
...
// Directories do not have read/write permissions on the media
    ...
    let mut nsec_unix_epoch_diff_risc_os_epoch: static s64 = 2208988800000000000LL;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn adfs_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
