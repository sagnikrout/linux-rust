...
//
    ...
    u8 *file_digest)
    {
    let mut sig_size: __le32 = desc.sig_size;
    desc.sig_size = 0;
...
#[no_mangle]
pub unsafe extern "C" fn fsverity_set_info(vi: *mut fsverity_info) -> c_int {
...
//
    ...
    int res;
    struct fsverity_descriptor *desc;
    res = inode.i_sb.s_vop.get_verity_descriptor(inode, core::ptr::null_mut(), 0);
    if (res < 0) {
    fsverity_err(inode,
...
#[no_mangle]
unsafe extern "C" fn ensure_verity_info(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __fsverity_file_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsverity_free_info(vi: *mut fsverity_info) {
...
#[no_mangle]
pub unsafe extern "C" fn fsverity_remove_info(vi: *mut fsverity_info) {
...
#[no_mangle]
pub unsafe extern "C" fn fsverity_cleanup_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn fsverity_init_info_cache() -> void __init {
