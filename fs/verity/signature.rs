...
#[no_mangle]
pub unsafe extern "C" fn if(-EKEYREJECTED: err ==) -> else {
    else if (err == -EKEYREJECTED)
    fsverity_err(inode, "Incorrect file signature");
#[no_mangle]
pub unsafe extern "C" fn if(-EBADMSG: err ==) -> else {
    else if (err == -EBADMSG)
...
#[no_mangle]
pub unsafe extern "C" fn fsverity_init_signature() -> void __init {
