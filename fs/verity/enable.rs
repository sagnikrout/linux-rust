...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct block_buffer {
    pub filled: u32,
    pub is_root_hash: bool,
    pub data: *mut u8,
}
...
// Zero-pad the block if it's shorter than the block size.
    ...
    let mut pos: u64 = (u64)index << params.log_blocksize;
    int err;
...
//
    ...
    let mut data_size: u64 = inode.i_size;
    let mut num_levels: c_int = params.num_levels;
...
// The root hash was filled by the last call to hash_one_block().
    ...
    let mut params: merkle_tree_params = { };
    struct fsverity_descriptor *desc;
    let mut desc_size: usize = struct_size(desc, signature, arg.sig_size);
...
//
    ...
    rollback:
    inode_lock(inode);
    (void)vops.end_enable_verity(filp, core::ptr::null_mut(), 0, params.tree_size);
    inode_unlock(inode);
    goto out;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fsverity_ioctl_enable(filp: *mut file, uarg: *const void __user) -> c_int {
