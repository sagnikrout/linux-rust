...
//
    ...
    {
    struct folio *folio;
    folio = read_mapping_folio(inode.i_mapping, index, core::ptr::null_mut());
    if (IS_ERR(folio))
...
//
    ...
    DEFINE_READAHEAD(ractl, core::ptr::null_mut(), core::ptr::null_mut(), inode.i_mapping, index);
