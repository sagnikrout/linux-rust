...
//
#[no_mangle]
pub unsafe extern "C" fn fsverity_ioctl_measure(filp: *mut file, _uarg: *mut void __user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_get_fsverity_digest(file: *mut file, digest_p: *const bpf_dynptr) -> __bpf_kfunc int {
    ...
    let mut dynptr_sz: u64 = __bpf_dynptr_size(digest_ptr);
    struct fsverity_digest *arg;
    const struct fsverity_info *vi;
    const struct fsverity_hash_alg *hash_alg;
    u64 out_digest_sz;
...
#[no_mangle]
unsafe extern "C" fn bpf_get_fsverity_digest_filter(prog: *const bpf_prog, kfunc_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsverity_init_bpf() -> void __init {
