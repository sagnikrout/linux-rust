...
//! Source: fs/erofs/decompressor_zstd.c
#![no_std]
...
pub struct z_erofs_zstd {
    ...
    z_erofs_zstd_head = all ? core::ptr::null_mut() : strm.next;
    spin_unlock(&z_erofs_zstd_lock);
    return strm;
    }
#[no_mangle]
unsafe extern "C" fn z_erofs_zstd_exit() {
...
#[no_mangle]
unsafe extern "C" fn z_erofs_zstd_init() -> int __init {
...
// by default, use # of possible CPUs instead
    ...
    struct z_erofs_zstd *strm, *head = core::ptr::null_mut();
    void *wksp;
...
// 3. multi-call decompress
    ...
    rq.fillgaps = true;	/* ZSTD doesn't support core::ptr::null_mut() output buffer */
