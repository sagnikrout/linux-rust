...
#[no_mangle]
unsafe extern "C" fn erofs_ishare_iget5_eq(inode: *mut inode, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erofs_ishare_iget5_set(inode: *mut inode, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erofs_ishare_fill_inode(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn erofs_ishare_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn erofs_ishare_file_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erofs_ishare_file_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erofs_ishare_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erofs_init_ishare() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn erofs_exit_ishare() {
