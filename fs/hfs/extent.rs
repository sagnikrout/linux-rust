...
//
#[no_mangle]
unsafe extern "C" fn hfs_ext_build_key(key: *mut hfs_btree_key, cnid: u32, block: u16, type: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_ext_keycmp(key1: *const btree_key, key2: *const btree_key) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_ext_find_block(ext: *mut hfs_extent, off: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn hfs_ext_block_count(ext: *mut hfs_extent) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_ext_lastblock(ext: *mut hfs_extent) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn __hfs_ext_write_extent(inode: *mut inode, fd: *mut hfs_find_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_ext_write_extent(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __hfs_ext_cache_extent(fd: *mut hfs_find_data, inode: *mut inode, block: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_ext_read_extent(inode: *mut inode, block: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_dump_extent(extent: *mut hfs_extent) {
...
// panic?
    ...
    goto found;
#[no_mangle]
pub unsafe extern "C" fn if(count: offset <) -> else {
    else if (offset < count)
    break;
    offset -= count;
    }
...
#[no_mangle]
pub unsafe extern "C" fn hfs_free_fork(sb: *mut super_block, file: *mut hfs_cat_file, type: c_int) -> c_int {
    int hfs_free_fork(struct super_block *sb, struct hfs_cat_file *file, int type)
    {
    struct hfs_find_data fd;
    u32 total_blocks, blocks, start;
    let mut cnid: u32 = be32_to_cpu(file.FlNum);
...
#[no_mangle]
pub unsafe extern "C" fn hfs_extend_file(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_file_truncate(inode: *mut inode) {
...
// XXX: Can use generic_cont_expand?
    size = inode.i_size - 1;
    res = hfs_write_begin(core::ptr::null_mut(), mapping, size + 1, 0, &folio,
    &fsdata);
    if (!res) {
    res = generic_write_end(core::ptr::null_mut(), mapping, size + 1, 0, 0,
    folio, fsdata);
    }
    if (res)
