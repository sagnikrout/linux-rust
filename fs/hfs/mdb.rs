...
#[no_mangle]
pub unsafe extern "C" fn is_hfs_cnid_counts_valid(sb: *mut super_block) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_sect_offset(sb: *mut super_block, sec: sector_t) -> c_uint {
    static unsigned int hfs_sect_offset(struct super_block *sb, sector_t sec)
    {
    let mut start: loff_t = (loff_t)sec << HFS_SECTOR_SIZE_BITS;
...
//
#[no_mangle]
unsafe extern "C" fn hfs_mdb_publish(sbi: *mut hfs_sb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_alt_mdb_publish(sbi: *mut hfs_sb_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_mdb_get(sb: *mut super_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_mdb_commit(sb: *mut super_block) -> c_int {
...
// These parameters may have been modified, so write them back
    ...
    &mdb.drXTFlSize, core::ptr::null_mut());
    hfs_inode_write_fork(HFS_SB(sb).cat_tree.inode, mdb.drCTExtRec,
    &mdb.drCTFlSize, core::ptr::null_mut());
// write MDB to disk
    hfs_mdb_publish(HFS_SB(sb));
    sync_dirty_buffer(HFS_SB(sb).mdb_bh);
    }
...
#[no_mangle]
pub unsafe extern "C" fn hfs_mdb_close(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_mdb_put(sb: *mut super_block) {
