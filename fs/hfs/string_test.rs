...
#[no_mangle]
unsafe extern "C" fn hfs_strcmp_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hfs_hash_dentry_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hfs_compare_dentry_test(test: *mut kunit) {
