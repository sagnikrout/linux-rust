...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_cat_build_key(sb: *mut super_block, key: *mut btree_key, parent: u32, name: *const qstr) {
...
#[no_mangle]
unsafe extern "C" fn hfs_cat_build_record(rec: *mut hfs_cat_rec, cnid: u32, inode: *mut inode) -> c_int {
    static int hfs_cat_build_record(hfs_cat_rec *rec, u32 cnid, struct inode *inode)
    {
    let mut mtime: __be32 = hfs_mtime();
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_cat_create(cnid: u32, dir: *mut inode, str: *const qstr, inode: *mut inode) -> c_int {
...
//
    ...
    if (err)
    goto err2;
    hfs_cat_build_key(sb, fd.search_key, cnid, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_cat_keycmp(key1: *const btree_key, key2: *const btree_key) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_cat_validate_found_cnid(fd: *mut hfs_find_data, cnid: u32) -> c_int {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn hfs_correct_next_unused_CNID(sb: *mut super_block, cnid: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_cat_delete(cnid: u32, dir: *mut inode, str: *const qstr) -> c_int {
    int hfs_cat_delete(u32 cnid, struct inode *dir, const struct qstr *str)
    {
    struct super_block *sb;
    struct hfs_find_data fd;
    int res, type;
    hfs_dbg("name %s, cnid %u\n", str ? str.name : core::ptr::null_mut(), cnid);
    sb = dir.i_sb;
...
// remove old thread entry
    hfs_cat_build_key(sb, src_fd.search_key, cnid, core::ptr::null_mut());
    err = hfs_brec_find(&src_fd);
    if (err)
    goto out;
    err = hfs_brec_remove(&src_fd);
...
// create new thread entry
    hfs_cat_build_key(sb, dst_fd.search_key, cnid, core::ptr::null_mut());
