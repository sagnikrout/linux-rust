...
//
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn hfs_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn flush_mdb(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_mark_mdb_dirty(sb: *mut super_block) {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_get_tree(fc: *mut fs_context) -> c_int {
    static int hfs_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, hfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn hfs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn hfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfs_kill_super(sb: *mut super_block) {
    ...
    MODULE_ALIAS_FS("hfs");
#[no_mangle]
unsafe extern "C" fn hfs_init_once(p: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn init_hfs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_hfs_fs() -> void __exit {
