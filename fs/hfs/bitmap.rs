...
//
#[no_mangle]
unsafe extern "C" fn hfs_find_set_zero_bits(bitmap: *mut __be32, size: u32, offset: u32, max: *mut u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_vbm_search_free(sb: *mut super_block, goal: u32, num_bits: *mut u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_clear_vbm_bits(sb: *mut super_block, start: u16, count: u16) -> c_int {
