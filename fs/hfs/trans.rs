...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_mac2asc(sb: *mut super_block, out: *mut c_char, in: *const hfs_name) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_asc2mac(sb: *mut super_block, out: *mut hfs_name, in: *const qstr) {
