...
//
#[no_mangle]
unsafe extern "C" fn hfs_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
    ...
    if (err)
    return err;
    hfs_cat_build_key(sb, fd.search_key, inode.i_ino, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hfs_dir_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_remove(dir: *mut inode, dentry: *mut dentry) -> c_int {
