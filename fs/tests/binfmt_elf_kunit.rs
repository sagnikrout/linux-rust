...
//! Source: fs/tests/binfmt_elf_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn total_mapping_size_test(test: *mut kunit) {
...
//
    ...
    let mut mount_size: usize = 0xE070;
...
// No headers, no size.
    KUNIT_EXPECT_EQ(test, total_mapping_size(core::ptr::null_mut(), 0), 0);
