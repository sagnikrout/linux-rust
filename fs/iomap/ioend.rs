...
//
#[no_mangle]
unsafe extern "C" fn iomap_finish_ioend_buffered_write(ioend: *mut iomap_ioend) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iomap_fail_ioend_buffered(ioend: *mut iomap_ioend) {
...
#[no_mangle]
unsafe extern "C" fn ioend_writeback_end_bio(bio: *mut bio) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iomap_ioend_writeback_submit(wpc: *mut iomap_writepage_ctx, error: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iomap_finish_ioend(ioend: *mut iomap_ioend, error: c_int) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn iomap_finish_ioends(ioend: *mut iomap_ioend, error: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn iomap_sort_ioends(ioend_list: *mut list_head) {
    void iomap_sort_ioends(struct list_head *ioend_list)
    {
    list_sort(core::ptr::null_mut(), ioend_list, iomap_ioend_compare);
    }
...
#[no_mangle]
unsafe extern "C" fn iomap_ioend_init() -> int __init {
    static int __init iomap_ioend_init(void)
    {
    let mut nr_mempool_entries: c_uint = 4 * (PAGE_SIZE / SECTOR_SIZE);
    int error;
