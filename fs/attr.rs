...
//
#[no_mangle]
pub unsafe extern "C" fn inode_newsize_ok(inode: *const inode, offset: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn setattr_copy_mgtime(inode: *mut inode, attr: *const iattr) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_CTIME: ia_valid &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_ATIME: ia_valid &) -> else {
    else if (ia_valid & ATTR_ATIME)
    inode_set_atime_to_ts(inode, now);
    if (ia_valid & ATTR_MTIME_SET)
    inode_set_mtime_to_ts(inode, attr.ia_mtime);
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_MTIME: ia_valid &) -> else {
