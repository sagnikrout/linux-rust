...
#[no_mangle]
pub unsafe extern "C" fn set_cached_acl(inode: *mut inode, type: c_int, acl: *mut posix_acl) {
...
#[no_mangle]
unsafe extern "C" fn __forget_cached_acl(p: *mut posix_acl) {
...
#[no_mangle]
pub unsafe extern "C" fn forget_cached_acl(inode: *mut inode, type: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn forget_all_cached_acls(inode: *mut inode) {
...
//
    ...
    set_cached_acl(inode, type, core::ptr::null_mut());
    return core::ptr::null_mut();
    }
    if (IS_ERR(acl)) {
//
...
//
    ...
    {
    return __get_acl(&nop_mnt_idmap, core::ptr::null_mut(), inode, type);
    }
...
//
    ...
    {
    struct posix_acl *clone = core::ptr::null_mut();
    if (acl) {
...
//
    ...
    let mut state: c_int = ACL_USER_OBJ;
    let mut needs_mask: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn posix_acl_create_masq(acl: *mut posix_acl, mode_p: *mut umode_t) -> c_int {
    static int posix_acl_create_masq(struct posix_acl *acl, umode_t *mode_p)
    {
    struct posix_acl_entry *pa, *pe;
    struct posix_acl_entry *group_obj = core::ptr::null_mut(), *mask_obj = core::ptr::null_mut();
    let mut mode: umode_t = *mode_p;
    let mut not_equiv: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn __posix_acl_chmod_masq(acl: *mut posix_acl, mode: umode_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn posix_acl_fix_xattr_common(value: *const c_void, size: usize) -> c_int {
...
//
    ...
    return -EPERM;
    if (acl) {
    let mut ret: c_int = posix_acl_valid(inode.i_sb.s_user_ns, acl);
    if (ret)
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn simple_acl_create(dir: *mut inode, inode: *mut inode) -> c_int {
...
//
    ...
    goto out_inode_unlock;
    if (likely(!is_bad_inode(inode)))
    error = set_posix_acl(idmap, dentry, acl_type, core::ptr::null_mut());
    else
    error = -EIO;
    if (!error) {
    fsnotify_xattr(dentry);
    ...
    {
    int error;
    struct posix_acl *acl = core::ptr::null_mut();
    if (size) {
//
