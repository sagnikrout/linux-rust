...
//
#[no_mangle]
unsafe extern "C" fn ceph_dirty_folio(mapping: *mut address_space, folio: *mut folio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ceph_netfs_expand_readahead(rreq: *mut netfs_io_request) {
    static void ceph_netfs_expand_readahead(struct netfs_io_request *rreq)
    {
    struct inode *inode = rreq.inode;
    struct ceph_inode_info *ci = ceph_inode(inode);
    struct ceph_file_layout *lo = &ci.i_layout;
    let mut max_pages: c_ulong = inode.i_sb.s_bdi.ra_pages;
    let mut end: loff_t = rreq.start + rreq.len, new_end;
...
#[no_mangle]
unsafe extern "C" fn finish_netfs_read(req: *mut ceph_osd_request) {
    ...
    let mut err: c_int = req.r_result;
...
#[no_mangle]
unsafe extern "C" fn ceph_netfs_issue_op_inline(subreq: *mut netfs_io_subrequest) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ceph_netfs_prepare_read(subreq: *mut netfs_io_subrequest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceph_netfs_issue_read(subreq: *mut netfs_io_subrequest) {
    ...
    struct ceph_fs_client *fsc = ceph_inode_to_fs_client(inode);
    struct ceph_client *cl = fsc.client;
    struct ceph_osd_request *req = core::ptr::null_mut();
    let mut vino: ceph_vino = ceph_vino(inode);
    int err;
    u64 len;
    let mut sparse: bool = IS_ENCRYPTED(inode) || ceph_test_mount_opt(fsc, SPARSEREAD);
    let mut off: u64 = subreq.start;
    int extent_cnt;
...
// data in the cache also to be stored encrypted.
    ...
    CEPH_OSD_FLAG_READ, core::ptr::null_mut(), ci.i_truncate_seq,
...
#[no_mangle]
unsafe extern "C" fn ceph_init_request(rreq: *mut netfs_io_request, file: *mut file) -> c_int {
    static int ceph_init_request(struct netfs_io_request *rreq, struct file *file)
    {
    struct inode *inode = rreq.inode;
    struct ceph_fs_client *fsc = ceph_inode_to_fs_client(inode);
    struct ceph_client *cl = ceph_inode_to_client(inode);
    let mut got: c_int = 0, want = CEPH_CAP_FILE_CACHE;
...
#[no_mangle]
unsafe extern "C" fn ceph_netfs_free_request(rreq: *mut netfs_io_request) {
    ...
    kfree(priv);
    rreq.netfs_priv = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ceph_set_page_fscache(page: *mut page) {
    static void ceph_set_page_fscache(struct page *page)
    {
    folio_start_private_2(page_folio(page)); /* [DEPRECATED] */
    }
#[no_mangle]
unsafe extern "C" fn ceph_fscache_write_terminated(priv: *mut c_void, error: isize) {
...
#[no_mangle]
unsafe extern "C" fn ceph_fscache_write_to_cache(inode: *mut inode, off: u64, len: u64, caching: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_set_page_fscache(page: *mut page) {
    static inline void ceph_set_page_fscache(struct page *page)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn ceph_fscache_write_to_cache(inode: *mut inode, off: u64, len: u64, caching: bool) {
...
//
    ...
    struct ceph_inode_info *ci = ceph_inode(inode);
    struct ceph_client *cl = ceph_inode_to_client(inode);
    struct ceph_snap_context *snapc = core::ptr::null_mut();
    struct ceph_cap_snap *capsnap = core::ptr::null_mut();
    spin_lock(&ci.i_ceph_lock);
...
// get i_size, truncate_{seq,size} for page_snapc?
    ...
    struct ceph_snap_context *snapc;
    struct ceph_cap_snap *capsnap = core::ptr::null_mut();
    let mut end: u64 = i_size_read(inode);
    u64 ret;
...
//
    ...
    let mut page_off: loff_t = folio_pos(folio);
    int err;
    let mut len: loff_t = folio_size(folio);
    loff_t wlen;
    struct ceph_writeback_ctl ceph_wbc;
    struct ceph_osd_client *osdc = &fsc.client.osdc;
    struct ceph_osd_request *req;
    let mut caching: bool = ceph_is_cache_enabled(inode);
    struct page *bounce_page = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn writepages_finish(req: *mut ceph_osd_request) {
...
// clean all pages
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn is_forced_umount(mapping: *mut address_space) -> bool {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn ceph_define_write_size(mapping: *mut address_space) -> c_uint {
    unsigned int ceph_define_write_size(struct address_space *mapping)
    {
    struct inode *inode = mapping.host;
    struct ceph_fs_client *fsc = ceph_inode_to_fs_client(inode);
    struct ceph_inode_info *ci = ceph_inode(inode);
    let mut wsize: c_uint = ci.i_layout.stripe_unit;
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn ceph_folio_batch_init(ceph_wbc: *mut ceph_writeback_ctl) {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn ceph_folio_batch_reinit(ceph_wbc: *mut ceph_writeback_ctl) {
    ...
    struct ceph_writeback_ctl *ceph_wbc)
    {
    ceph_wbc.snapc = core::ptr::null_mut();
    ceph_wbc.last_snapc = core::ptr::null_mut();
    ...
    ceph_folio_batch_init(ceph_wbc);
    ceph_wbc.pages = core::ptr::null_mut();
    ceph_wbc.data_pages = core::ptr::null_mut();
    }
    static inline
...
// find oldest snap context with dirty data
    ceph_wbc.snapc = get_oldest_context(inode, ceph_wbc, core::ptr::null_mut());
    if (!ceph_wbc.snapc) {
...
// associated with 'snapc' get written
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn has_writeback_done(ceph_wbc: *mut ceph_writeback_ctl) -> bool {
...
// prepare async write request
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn is_num_ops_too_big(ceph_wbc: *mut ceph_writeback_ctl) -> bool {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn is_write_congestion_happened(fsc: *mut ceph_fs_client) -> bool {
    ...
    let mut index: c_uint = ceph_wbc.locked_pages;
    let mut gfp_flags: gfp_t = ceph_wbc.locked_pages ? GFP_NOWAIT : GFP_NOFS;
    if (IS_ENCRYPTED(inode)) {
    ...
    let mut err: c_int = PTR_ERR(pages[index]);
    if (err == -EINVAL) {
...
// better not fail on first page!
    ...
    folio_lock(folio);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !folio_trylock(folio)) -> else {
    ...
    folio_unlock(folio);
    folio_put(folio);
    ceph_wbc.fbatch.folios[i] = core::ptr::null_mut();
    continue;
    } else if (rc == -E2BIG) {
    folio_unlock(folio);
    break;
...
// Did we just begin a new contiguous op? Nevermind!
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn ceph_shift_unused_folios_left(fbatch: *mut folio_batch) {
...
#[no_mangle]
unsafe extern "C" fn ceph_undo_wrbuffer_claim(inode: *mut inode, folio: *mut folio) {
...
// data length covers all locked pages
    let mut min_len: u64 = len + 1 - thp_size(page);
...
//
    ...
    ceph_wbc.fbatch.nr ? ceph_wbc.fbatch.folios[0] : core::ptr::null_mut());
    folio_batch_release(&ceph_wbc.fbatch);
    }
...
//
    ...
    struct ceph_snap_context *snapc)
    {
    struct ceph_snap_context *oldest = get_oldest_context(inode, core::ptr::null_mut(), core::ptr::null_mut());
    let mut ret: c_int = !oldest || snapc.seq <= oldest.seq;
    ceph_put_snap_context(oldest);
    return ret;
    }
//
...
//
    oldest = get_oldest_context(inode, core::ptr::null_mut(), core::ptr::null_mut());
    if (snapc.seq > oldest.seq) {
...
// yay, writeable, do it now (without dropping folio lock)
    ...
    ceph_vinop(inode), folio, snapc);
    if (folio_clear_dirty_for_io(folio)) {
    let mut r: c_int = write_folio_nounlock(folio, core::ptr::null_mut());
    if (r < 0)
    return ERR_PTR(r);
    }
    }
...
//
    ...
    struct ceph_inode_info *ci = ceph_inode(inode);
    int r;
    r = netfs_write_begin(&ci.netfs, file, inode.i_mapping, pos, len, foliop, core::ptr::null_mut());
    if (r < 0)
    return r;
...
#[no_mangle]
unsafe extern "C" fn ceph_block_sigs(oldset: *mut sigset_t) {
...
#[no_mangle]
unsafe extern "C" fn ceph_restore_sigs(oldset: *mut sigset_t) {
...
//
#[no_mangle]
unsafe extern "C" fn ceph_filemap_fault(vmf: *mut vm_fault) -> vm_fault_t {
    ...
    let mut off: loff_t = (loff_t)vmf.pgoff << PAGE_SHIFT;
    int want, got, err;
    sigset_t oldset;
...
#[no_mangle]
unsafe extern "C" fn ceph_page_mkwrite(vmf: *mut vm_fault) -> vm_fault_t {
    ...
    let mut off: loff_t = folio_pos(folio);
...
#[no_mangle]
pub unsafe extern "C" fn ceph_uninline_data(file: *mut file) -> c_int {
    ...
    struct ceph_client *cl = fsc.client;
    struct ceph_osd_request *req = core::ptr::null_mut();
    struct ceph_cap_flush *prealloc_cf = core::ptr::null_mut();
    struct folio *folio = core::ptr::null_mut();
    struct ceph_snap_context *snapc = core::ptr::null_mut();
    let mut inline_version: u64 = CEPH_INLINE_NONE;
    struct page *pages[1];
    let mut err: c_int = 0;
    u64 len;
    spin_lock(&ci.i_ceph_lock);
    ...
    {
    let mut xattr_buf: __le64 = cpu_to_le64(inline_version);
...
#[no_mangle]
pub unsafe extern "C" fn ceph_mmap_prepare(desc: *mut vm_area_desc) -> c_int {
    ...
    struct ceph_client *cl = fsc.client;
    struct ceph_osd_request *rd_req = core::ptr::null_mut(), *wr_req = core::ptr::null_mut();
    struct rb_node **p, *parent;
    struct ceph_pool_perm *perm;
    struct page **pages;
    size_t pool_ns_len;
    let mut err: c_int = 0, err2 = 0, have = 0;
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(perm->pool: pool >) -> else {
...
pub unsafe extern "C" fn if(0: ret >) -> else {
    ...
    rd_req = ceph_osdc_alloc_request(&fsc.client.osdc, core::ptr::null_mut(),
    1, false, GFP_KERNEL);
    if (!rd_req) {
    err = -ENOMEM;
    goto out_unlock;
    ...
    if (err)
    goto out_unlock;
    wr_req = ceph_osdc_alloc_request(&fsc.client.osdc, core::ptr::null_mut(),
    1, false, GFP_KERNEL);
    if (!wr_req) {
    err = -ENOMEM;
    goto out_unlock;
...
// one page should be large enough for STAT data
    ...
    have |= POOL_READ;
#[no_mangle]
pub unsafe extern "C" fn if(-EPERM: err !=) -> else {
    if (err == -EBLOCKLISTED)
    fsc.blocklisted = true;
    goto out_unlock;
    }
    ...
    have |= POOL_WRITE;
#[no_mangle]
pub unsafe extern "C" fn if(-EPERM: err2 !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_pool_perm_check(inode: *mut inode, need: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_pool_perm_destroy(mdsc: *mut ceph_mds_client) {
