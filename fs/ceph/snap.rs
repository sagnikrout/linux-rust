...
//
    ...
    struct ceph_snap_realm *r = core::ptr::null_mut();
    while (*p) {
    parent = *p;
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(r->ino: new->ino >) -> else {
...
//
    ...
    n = n.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(r->ino: ino >) -> else {
    else if (ino > r.ino)
    n = n.rb_right;
    else {
    doutc(cl, "%llx %p\n", r.ino, r);
...
//
#[no_mangle]
unsafe extern "C" fn __cleanup_empty_realms(mdsc: *mut ceph_mds_client) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_cleanup_global_and_empty_realms(mdsc: *mut ceph_mds_client) {
...
#[no_mangle]
unsafe extern "C" fn cmpu64_rev(a: *const c_void, b: *const c_void) -> c_int {
...
//
    ...
    let mut err: c_int = 0;
    let mut num: u32 = realm.num_prior_parent_snaps + realm.num_snaps;
//
...
// include any of parent's snaps occurring _after_ my
    ...
    sort(snapc.snaps, num, sizeof(u64), cmpu64_rev, core::ptr::null_mut());
    snapc.num_snaps = num;
...
//
    if (realm.cached_context) {
    ceph_put_snap_context(realm.cached_context);
    realm.cached_context = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn dup_array(dst: *mut u64, src: *mut __le64, num: u32) -> c_int {
...
//
    ...
    capsnap.issued = __ceph_caps_issued(ci, core::ptr::null_mut());
    capsnap.dirty = dirty;
    ...
    capsnap.xattr_blob = core::ptr::null_mut();
...
//
    ...
    struct inode *lastinode = core::ptr::null_mut();
...
//
    ...
    struct ceph_snap_realm *realm;
    struct ceph_snap_realm *first_realm = core::ptr::null_mut();
    struct ceph_snap_realm *realm_to_rebuild = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn flush_snaps(mdsc: *mut ceph_mds_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_change_snap_realm(inode: *mut inode, realm: *mut ceph_snap_realm) {
    ...
    oldrealm.inode = core::ptr::null_mut();
...
//
    ...
    __le64 *split_inos = core::ptr::null_mut(), *split_realms = core::ptr::null_mut();
    int i;
    let mut locked_rwsem: c_int = 0;
...
// we took a reference when we created the realm, above
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(exist->snap: snap <) -> else {
    else if (snap < exist.snap)
    p = &(*p).rb_right;
    else
    break;
...
#[no_mangle]
pub unsafe extern "C" fn ceph_trim_snapid_map(mdsc: *mut ceph_mds_client) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_cleanup_snapid_map(mdsc: *mut ceph_mds_client) {
