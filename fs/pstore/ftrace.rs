...
#[no_mangle]
pub unsafe extern "C" fn adjust_ip(ip: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn decode_ip(ip: c_ulong) -> c_ulong {
    ...
    int bit;
    unsigned long flags;
    let mut rec: pstore_ftrace_record = {};
...
#[no_mangle]
unsafe extern "C" fn pstore_set_ftrace_enabled(on: bool) -> c_int {
...
pub unsafe extern "C" fn pstore_register_ftrace() {
    ...
    if (!psinfo.write)
    return;
    pstore_ftrace_dir = debugfs_create_dir("pstore", core::ptr::null_mut());
    pstore_set_ftrace_enabled(record_ftrace);
    debugfs_create_file("record_ftrace", 0600, pstore_ftrace_dir, core::ptr::null_mut(),
    &pstore_knob_fops);
    }
#[no_mangle]
pub unsafe extern "C" fn pstore_unregister_ftrace() {
    ...
    let mut dest_idx: usize = 0, src_idx = 0, merged_idx = 0;
    void *merged_buf;
    struct pstore_ftrace_record *drec, *srec, *mrec;
    let mut record_size: usize = sizeof(struct pstore_ftrace_record);
