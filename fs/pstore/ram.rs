...
//
    ...
    let mut record_size: static ulong = MIN_MEM_SIZE;
    module_param(record_size, ulong, 0400);
    MODULE_PARM_DESC(record_size,
    "size of each dump done on oops/panic");
    let mut ramoops_console_size: static ulong = MIN_MEM_SIZE;
    module_param_named(console_size, ramoops_console_size, ulong, 0400);
    MODULE_PARM_DESC(console_size, "size of kernel console log");
    let mut ramoops_ftrace_size: static ulong = MIN_MEM_SIZE;
    module_param_named(ftrace_size, ramoops_ftrace_size, ulong, 0400);
    MODULE_PARM_DESC(ftrace_size, "size of ftrace log");
    let mut ramoops_pmsg_size: static ulong = MIN_MEM_SIZE;
    ...
    let mut ramoops_max_reason: static int = -1;
    ...
    "bytes ECC)");
    let mut ramoops_dump_oops: static int = -1;
...
pub struct ramoops_context {
    pub /: *mut *mut *mut *mut persistent_ram_zone dprzs; / Oops dump zones,
    pub /: *mut *mut *mut persistent_ram_zone cprz; / Console zone,
    pub /: *mut *mut *mut *mut persistent_ram_zone fprzs; / Ftrace zones,
    pub /: *mut *mut *mut persistent_ram_zone mprz; / PMSG zone,
    ...
    pub max_dump_cnt: c_uint,
    pub dump_write_cnt: c_uint,
// _read_cnt need clear on ramoops_pstore_open
    pub dump_read_cnt: c_uint,
    pub console_read_cnt: c_uint,
    pub max_ftrace_cnt: c_uint,
...
#[no_mangle]
unsafe extern "C" fn ramoops_pstore_open(psi: *mut pstore_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prz_ok(prz: *mut persistent_ram_zone) -> bool {
    static bool prz_ok(struct persistent_ram_zone *prz)
    {
    return !!prz && !!(persistent_ram_old_size(prz) +
    persistent_ram_ecc_string(prz, core::ptr::null_mut(), 0));
    }
#[no_mangle]
unsafe extern "C" fn ramoops_pstore_read(record: *mut pstore_record) -> isize {
    static ssize_t ramoops_pstore_read(struct pstore_record *record)
    {
    let mut size: isize = 0;
    struct ramoops_context *cxt = record.psi.data;
    struct persistent_ram_zone *prz = core::ptr::null_mut();
    let mut header_length: c_int = 0;
    let mut free_prz: bool = false;
//
...
// ECC correction notice
    record.ecc_notice_size = persistent_ram_ecc_string(prz, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn ramoops_pstore_write(record: *mut pstore_record) -> int notrace {
...
#[no_mangle]
unsafe extern "C" fn ramoops_pstore_erase(record: *mut pstore_record) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ramoops_free_przs(cxt: *mut ramoops_context) {
...
#[no_mangle]
unsafe extern "C" fn ramoops_probe(pdev: *mut platform_device) -> c_int {
...
// Make sure we didn't get bogus platform data pointer.
    if (!pdata) {
    pr_err("core::ptr::null_mut() platform data\n");
    err = -EINVAL;
    goto fail_out;
    }
...
#[no_mangle]
unsafe extern "C" fn ramoops_remove(pdev: *mut platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ramoops_unregister_dummy() {
...
#[no_mangle]
unsafe extern "C" fn ramoops_register_dummy() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(-1: ramoops_dump_oops !=) -> else {
...
//
    ...
    dummy = platform_device_register_data(core::ptr::null_mut(), "ramoops", -1,
    &pdata, sizeof(pdata));
    if (IS_ERR(dummy)) {
...
#[no_mangle]
unsafe extern "C" fn ramoops_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ramoops_exit() -> void __exit {
