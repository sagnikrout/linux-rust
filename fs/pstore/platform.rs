...
//
    let mut pstore_update_ms: static int = -1;
...
// How much of the kernel log to snapshot
    let mut kmsg_bytes: c_uint = CONFIG_PSTORE_DEFAULT_KMSG_BYTES;
...
//
pub const DMESG_COMP_PERCENT: c_int = 60;
    static char *big_oops_buf;
    static size_t max_compressed_size;
#[no_mangle]
pub unsafe extern "C" fn pstore_set_kmsg_bytes(bytes: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn pstore_name_to_type(name: *const c_char) -> enum pstore_type_id {
...
#[no_mangle]
unsafe extern "C" fn pstore_timer_kick() {
...
#[no_mangle]
unsafe extern "C" fn pstore_cannot_block_path(reason: enum kmsg_dump_reason) -> bool {
...
#[no_mangle]
unsafe extern "C" fn allocate_buf_for_compression() {
...
//
    ...
    let mut remaining: c_uint = READ_ONCE(kmsg_bytes);
    let mut total: c_ulong = 0;
    const char	*why;
    let mut part: c_uint = 1;
    let mut flags: c_ulong = 0;
    let mut saved_ret: c_int = 0;
    int		ret;
...
//
#[no_mangle]
unsafe extern "C" fn pstore_register_kmsg() {
    static void pstore_register_kmsg(void)
    {
    kmsg_dump_register(&pstore_dumper);
    }
#[no_mangle]
unsafe extern "C" fn pstore_unregister_kmsg() {
...
#[no_mangle]
unsafe extern "C" fn pstore_console_write(con: *mut console, s: *const c_char, c: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn pstore_register_console() {
...
#[no_mangle]
unsafe extern "C" fn pstore_unregister_console() {
...
//
#[no_mangle]
pub unsafe extern "C" fn pstore_register(psi: *mut pstore_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pstore_unregister(psi: *mut pstore_info) {
...
//
    ...
    let mut stop_loop: c_uint = 65536;
    let mut zstream: z_stream_s = {};
    if (!psi || !root)
    return;
    if (IS_ENABLED(CONFIG_PSTORE_COMPRESS) && compress) {
...
#[no_mangle]
unsafe extern "C" fn pstore_dowork(work: *mut work_struct) {
    static void pstore_dowork(struct work_struct *work)
    {
    pstore_get_records(1);
    }
#[no_mangle]
unsafe extern "C" fn pstore_timefunc(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn pstore_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pstore_exit() -> void __exit {
