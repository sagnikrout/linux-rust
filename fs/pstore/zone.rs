...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psz_buffer {

    pub sig: u32,
    pub datalen: core::sync::atomic::AtomicI32,
    pub start: core::sync::atomic::AtomicI32,
    pub data: [u8; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psz_kmsg_header {
pub const PSTORE_KMSG_HEADER_MAGIC: c_uint = 0x4dfc3ae5 /* Just a random number */;
    pub magic: u32,
    pub time: timespec64,
    pub compressed: bool,
    pub counter: u32,
    pub reason: enum kmsg_dump_reason,
    pub data: [u8; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pstore_zone {
    pub off: loff_t,
    pub name: *const c_char,
    pub type: enum pstore_type_id,
    pub buffer: *mut psz_buffer,
    pub oldbuf: *mut psz_buffer,
    pub buffer_size: usize,
    pub should_recover: bool,
    pub dirty: core::sync::atomic::AtomicI32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psz_context {
    pub kpszs: *mut pstore_zone,
    pub ppsz: *mut pstore_zone,
    pub cpsz: *mut pstore_zone,
    pub fpszs: *mut pstore_zone,
    pub kmsg_max_cnt: c_uint,
    pub kmsg_read_cnt: c_uint,
    pub kmsg_write_cnt: c_uint,
    pub pmsg_read_cnt: c_uint,
    pub console_read_cnt: c_uint,
    pub ftrace_max_cnt: c_uint,
    pub ftrace_read_cnt: c_uint,
//
// These counters should be calculated during recovery.
// It records the oops/panic times after crashes rather than boots.
//
    pub oops_counter: c_uint,
    pub panic_counter: c_uint,
    pub recovered: core::sync::atomic::AtomicI32,
    pub on_panic: core::sync::atomic::AtomicI32,
//
// pstore_zone_info_lock protects this entire structure during calls
// to register_pstore_zone()/unregister_pstore_zone().
//
    pub pstore_zone_info_lock: mutex,
    pub pstore_zone_info: *mut pstore_zone_info,
...
#[no_mangle]
pub unsafe extern "C" fn buffer_datalen(zone: *mut pstore_zone) -> c_int {
    static inline int buffer_datalen(struct pstore_zone *zone)
    {
    return atomic_read(&zone.buffer.datalen);
    }
#[no_mangle]
pub unsafe extern "C" fn buffer_start(zone: *mut pstore_zone) -> c_int {
    static inline int buffer_start(struct pstore_zone *zone)
    {
    return atomic_read(&zone.buffer.start);
    }
#[no_mangle]
pub unsafe extern "C" fn is_on_panic() -> bool {
...
#[no_mangle]
unsafe extern "C" fn psz_flush_dirty_zone(zone: *mut pstore_zone) -> c_int {
    ...
    return 0;
    ret = psz_zone_write(zone, FLUSH_ALL, core::ptr::null_mut(), 0, 0);
    if (ret)
    atomic_set(&zone.dirty, true);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn psz_flush_dirty_zones(zones: *mut pstore_zone, cnt: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psz_move_zone(old: *mut pstore_zone, new: *mut pstore_zone) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psz_flush_all_dirty_zones(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn psz_kmsg_recover_data(cxt: *mut psz_context) -> c_int {
    static int psz_kmsg_recover_data(struct psz_context *cxt)
    {
    struct pstore_zone_info *info = cxt.pstore_zone_info;
    struct pstore_zone *zone = core::ptr::null_mut();
    ...
    let mut wcnt: c_uint = cxt.kmsg_write_cnt;
...
#[no_mangle]
unsafe extern "C" fn psz_kmsg_recover_meta(cxt: *mut psz_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(KMSG_DUMP_PANIC: hdr->reason ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn psz_kmsg_recover(cxt: *mut psz_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psz_recover_zone(cxt: *mut psz_context, zone: *mut pstore_zone) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn psz_recovery(cxt: *mut psz_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psz_pstore_open(psi: *mut pstore_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psz_old_ok(zone: *mut pstore_zone) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn psz_ok(zone: *mut pstore_zone) -> bool {
...
// this zone is already updated, no need to erase
    ...
    return psz_zone_write(zone, FLUSH_META, core::ptr::null_mut(), 0, 0);
    }
...
#[no_mangle]
unsafe extern "C" fn psz_pstore_erase(record: *mut pstore_record) -> c_int {
...
// ensure all data are flushed to storage when panic
    ...
    psz_flush_all_dirty_zones(core::ptr::null_mut());
    }
// always return 0 as we had handled it on buffer
    ...
    {
    size_t start, rem;
    let mut is_full_data: bool = false;
    char *buf;
    int cnt;
    if (!zone || !record)
    return -ENOSPC;
...
//
    ...
    psz_zone_write(zone, FLUSH_META, core::ptr::null_mut(), 0, 0);
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn psz_pstore_write(record: *mut pstore_record) -> int notrace {
...
//
    ...
    case PSTORE_TYPE_FTRACE: {
    let mut zonenum: c_int = smp_processor_id();
    if (!cxt.fpszs)
    return -ENOSPC;
...
#[no_mangle]
unsafe extern "C" fn psz_pstore_read(record: *mut pstore_record) -> isize {
...
#[no_mangle]
unsafe extern "C" fn psz_free_zone(pszone: *mut pstore_zone) {
...
#[no_mangle]
unsafe extern "C" fn psz_free_zones(pszones: *mut pstore_zone, cnt: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn psz_free_all_zones(cxt: *mut psz_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn register_pstore_zone(info: *mut pstore_zone_info) -> c_int {
...
//
    ...
    cxt.pstore.buf = core::ptr::null_mut();
    cxt.pstore.bufsize = 0;
    psz_free_all_zones(cxt);
    fail_out:
    pstore_zone_cxt.pstore_zone_info = core::ptr::null_mut();
    mutex_unlock(&pstore_zone_cxt.pstore_zone_info_lock);
    return err;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_pstore_zone(info: *mut pstore_zone_info) {
...
// Clean up allocations.
    ...
    cxt.pstore.buf = core::ptr::null_mut();
    cxt.pstore.bufsize = 0;
    cxt.pstore_zone_info = core::ptr::null_mut();
    psz_free_all_zones(cxt);
