...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cramfs_sb_info {
    pub magic: c_ulong,
    pub size: c_ulong,
    pub blocks: c_ulong,
    pub files: c_ulong,
    pub flags: c_ulong,
    pub linear_virt_addr: *mut c_void,
    pub linear_phys_addr: resource_size_t,
    pub mtd_point_size: usize,
}
...
#[no_mangle]
unsafe extern "C" fn cramino(cino: *const cramfs_inode, offset: c_uint) -> c_ulong {
...
// Ok, read in BLKS_PER_BUF pages completely first.
    ...
    page_cache_sync_readahead(mapping, &ra, core::ptr::null_mut(), blocknr, BLKS_PER_BUF);
    for (i = 0; i < BLKS_PER_BUF; i++) {
    struct page *page = core::ptr::null_mut();
    if (blocknr + i < devsize) {
    page = read_mapping_page(mapping, blocknr + i, core::ptr::null_mut());
// synchronous error?
    if (IS_ERR(page))
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ENABLED(CONFIG_CRAMFS_BLOCKDEV)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn cramfs_get_block_range(inode: *mut inode, pgoff: u32, pages: *mut u32) -> u32 {
...
//
    ...
    i = 0;
    do {
    let mut block_off: u32 = i * (PAGE_SIZE >> CRAMFS_BLK_DIRECT_PTR_SHIFT);
...
//
#[no_mangle]
unsafe extern "C" fn cramfs_last_page_is_shared(inode: *mut inode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cramfs_physmem_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
//
    ...
    vm_fault_t vmf;
    let mut off: c_ulong = i * PAGE_SIZE;
...
#[no_mangle]
unsafe extern "C" fn cramfs_physmem_mmap_capabilities(file: *mut file) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cramfs_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn cramfs_reconfigure(fc: *mut fs_context) -> c_int {
    ...
    let mut silent: bool = fc.sb_flags & SB_SILENT;
...
// check at 512 byte offset
    ...
    errorfc(fc, "wrong endianness");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !silent) -> else {
    else if (!silent)
...
#[no_mangle]
unsafe extern "C" fn cramfs_blkdev_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cramfs_mtd_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cramfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sb->s_dev) -> else {
    else if (sb.s_dev)
...
//
#[no_mangle]
unsafe extern "C" fn cramfs_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
//
    ...
    char *name;
    int namelen, retval;
    let mut dir_off: c_int = OFFSET(dir) + offset;
...
#[no_mangle]
unsafe extern "C" fn cramfs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    ...
    struct super_block *sb = inode.i_sb;
    let mut blkptr_offset: u32 = OFFSET(inode) + folio.index * 4;
...
// See comments on earlier code.
    let mut prev_start: u32 = block_start;
...
#[no_mangle]
unsafe extern "C" fn cramfs_get_tree(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cramfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_cramfs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_cramfs_fs() -> void __exit {
