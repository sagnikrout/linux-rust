...
#[no_mangle]
unsafe extern "C" fn anon_inodefs_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
    ...
    void *priv, int flags)
    {
    return __anon_inode_getfile(name, fops, priv, flags, core::ptr::null_mut(), false);
    }
...
//
    ...
    {
    struct file *file;
    file = __anon_inode_getfile(name, fops, priv, flags, core::ptr::null_mut(), false);
    if (!IS_ERR(file))
    file.f_mode |= f_mode;
    return file;
    }
...
//
    ...
    void *priv, int flags)
    {
    return __anon_inode_getfd(name, fops, priv, flags, core::ptr::null_mut(), false);
    }
...
#[no_mangle]
unsafe extern "C" fn anon_inode_init() -> int __init {
