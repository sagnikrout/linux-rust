...
#[no_mangle]
pub unsafe extern "C" fn hpfs_add_sector_to_btree(s: *mut super_block, node: secno, fnod: c_int, fsecno: unsigned) -> secno {
    secno hpfs_add_sector_to_btree(struct super_block *s, secno node, int fnod, unsigned fsecno)
    {
    struct bplus_header *btree;
    struct anode *anode = core::ptr::null_mut(), *ranode = core::ptr::null_mut();
    struct fnode *fnode;
...
//
#[no_mangle]
pub unsafe extern "C" fn hpfs_remove_btree(s: *mut super_block, btree: *mut bplus_header) {
    void hpfs_remove_btree(struct super_block *s, struct bplus_header *btree)
    {
    struct bplus_header *btree1 = btree;
    struct anode *anode = core::ptr::null_mut();
    let mut ano: anode_secno = 0, oano;
    struct buffer_head *bh;
...
#[no_mangle]
unsafe extern "C" fn anode_lookup(s: *mut super_block, a: anode_secno, sec: unsigned) -> secno {
    static secno anode_lookup(struct super_block *s, anode_secno a, unsigned sec)
    {
    struct anode *anode;
    struct buffer_head *bh;
    if (!(anode = hpfs_map_anode(s, a, &bh))) return -1;
    return hpfs_bplus_lookup(s, core::ptr::null_mut(), GET_BTREE_PTR(&anode.btree), sec, bh);
    }
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_ea_remove(s: *mut super_block, a: secno, ano: c_int, len: unsigned) {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_truncate_btree(s: *mut super_block, f: secno, fno: c_int, secs: unsigned) {
...
#[no_mangle]
pub unsafe extern "C" fn if(secs: le32_to_cpu(btree->u.external[i].file_secno) + le32_to_cpu(btree->u.external[i].length) >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_remove_fnode(s: *mut super_block, fno: fnode_secno) {
