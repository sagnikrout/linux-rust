...
#[no_mangle]
unsafe extern "C" fn hpfs_file_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_file_fsync(file: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpfs_bmap(inode: *mut inode, file_secno: unsigned, n_secs: *mut unsigned) -> secno {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_truncate(i: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn hpfs_get_block(inode: *mut inode, iblock: sector_t, bh_result: *mut buffer_head, create: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpfs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int hpfs_read_folio(struct file *file, struct folio *folio)
    {
    return mpage_read_folio(folio, hpfs_get_block);
    }
#[no_mangle]
unsafe extern "C" fn hpfs_readahead(rac: *mut readahead_control) {
...
#[no_mangle]
unsafe extern "C" fn hpfs_write_failed(mapping: *mut address_space, to: loff_t) {
...
#[no_mangle]
unsafe extern "C" fn _hpfs_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
    static sector_t _hpfs_bmap(struct address_space *mapping, sector_t block)
    {
    return generic_block_bmap(mapping, block, hpfs_get_block);
    }
#[no_mangle]
unsafe extern "C" fn hpfs_fiemap(inode: *mut inode, fieinfo: *mut fiemap_extent_info, start: u64, len: u64) -> c_int {
