...
#[no_mangle]
unsafe extern "C" fn mark_dirty(s: *mut super_block, remount: c_int) {
...
// Mark the filesystem clean (mark it dirty for chkdsk if chkdsk==2 or if there
    were errors) */
#[no_mangle]
unsafe extern "C" fn unmark_dirty(s: *mut super_block) {
...
// Filesystem error...
#[no_mangle]
pub unsafe extern "C" fn hpfs_error(s: *mut super_block, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn free_sbi(sbi: *mut hpfs_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn lazy_free_sbi(rcu: *mut rcu_head) {
    static void lazy_free_sbi(struct rcu_head *rcu)
    {
    free_sbi(container_of(rcu, struct hpfs_sb_info, rcu));
    }
#[no_mangle]
unsafe extern "C" fn hpfs_put_super(s: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn hpfs_count_one_bitmap(s: *mut super_block, secno: secno) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn count_bitmaps(s: *mut super_block) -> unsigned {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_get_free_dnodes(s: *mut super_block) -> unsigned {
    unsigned hpfs_get_free_dnodes(struct super_block *s)
    {
    struct hpfs_sb_info *sbi = hpfs_sb(s);
    if (sbi.sb_n_free_dnodes == (unsigned)-1) {
    let mut c: unsigned = hpfs_count_one_bitmap(s, sbi.sb_dmap);
    if (c == (unsigned)-1)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn hpfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    static int hpfs_statfs(struct dentry *dentry, struct kstatfs *buf)
    {
    struct super_block *s = dentry.d_sb;
    struct hpfs_sb_info *sbi = hpfs_sb(s);
    let mut id: u64 = huge_encode_dev(s.s_bdev.bd_dev);
    hpfs_lock(s);
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_ioctl(file: *mut file, cmd: unsigned, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn hpfs_free_inode(inode: *mut inode) {
...
unsafe extern "C" fn init_inodecache() -> c_int {
    ...
    SLAB_ACCOUNT),
    init_once);
    if (hpfs_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_help() {
...
#[no_mangle]
unsafe extern "C" fn hpfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpfs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpfs_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpfs_fill_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
    ...
    struct hpfs_dirent *de = core::ptr::null_mut();
    struct quad_buffer_head qbh;
    sbi = kzalloc_obj(*sbi);
    if (!sbi) {
    return -ENOMEM;
...
// Fill superblock stuff
    ...
    sbi.sb_was_error = 0;
    sbi.sb_cp_table = core::ptr::null_mut();
    sbi.sb_c_bitmap = -1;
...
//
    ...
    if (root_dno)
    de = map_dirent(root, root_dno, "\001\001", 2, core::ptr::null_mut(), &qbh);
    if (!de)
...
#[no_mangle]
unsafe extern "C" fn hpfs_get_tree(fc: *mut fs_context) -> c_int {
    static int hpfs_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, hpfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn hpfs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn hpfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_hpfs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_hpfs_fs() -> void __exit {
