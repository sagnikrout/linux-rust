...
#[no_mangle]
pub unsafe extern "C" fn hpfs_search_hotfix_map(s: *mut super_block, sec: secno) -> secno {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_search_hotfix_map_for_range(s: *mut super_block, sec: secno, n: unsigned) -> unsigned {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_prefetch_sectors(s: *mut super_block, secno: unsigned, n: c_int) {
...
// return hpfs_map_sector(s, secno, bhp, 0);
    hpfs_lock_assert(s);
    cond_resched();
    if ((*bhp = bh = sb_getblk(s, hpfs_search_hotfix_map(s, secno))) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_brelse4(qbh: *mut quad_buffer_head) {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_mark_4buffers_dirty(qbh: *mut quad_buffer_head) {
