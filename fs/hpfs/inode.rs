...
#[no_mangle]
pub unsafe extern "C" fn hpfs_init_inode(i: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_read_inode(i: *mut inode) {
...
// i->i_mode |= S_IFREG;
    ...
    let mut rdev: c_int = 0;
    let mut mode: umode_t = hpfs_sb(sb).sb_mode;
    if (ea_size == 2) {
    ...
    hpfs_count_dnodes(i.i_sb, hpfs_inode.i_dno, &n_dnodes, &n_subdirs, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hpfs_write_inode_ea(i: *mut inode, fnode: *mut fnode) {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_write_inode(i: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_write_inode_nolock(i: *mut inode) {
    ...
    if (S_ISDIR(i.i_mode)) {
    if ((de = map_dirent(i, hpfs_inode.i_dno, "\001\001", 2, core::ptr::null_mut(), &qbh))) {
    de.write_date = cpu_to_le32(gmt_to_local(i.i_sb, inode_get_mtime_sec(i)));
    de.read_date = cpu_to_le32(gmt_to_local(i.i_sb, inode_get_atime_sec(i)));
    de.creation_date = cpu_to_le32(gmt_to_local(i.i_sb, inode_get_ctime_sec(i)));
    de.read_only = !(i.i_mode & 0222);
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_write_if_changed(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn hpfs_evict_inode(inode: *mut inode) {
