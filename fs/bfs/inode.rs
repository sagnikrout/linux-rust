...
#[no_mangle]
unsafe extern "C" fn bfs_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
    static int bfs_write_inode(struct inode *inode, struct writeback_control *wbc)
    {
    struct bfs_sb_info *info = BFS_SB(inode.i_sb);
    let mut ino: c_uint = (u16)inode.i_ino;
...
#[no_mangle]
unsafe extern "C" fn bfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn bfs_put_super(s: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn bfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bfs_free_inode(inode: *mut inode) {
...
unsafe extern "C" fn init_inodecache() -> int __init {
    ...
    SLAB_ACCOUNT),
    init_once);
    if (bfs_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn bfs_dump_imap(prefix: *const c_char, s: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn bfs_fill_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(BFS_MAX_LASTI: info->si_lasti >) -> else {
...
// can we read the last block?
    ...
    struct bfs_inode *di;
    let mut block: c_int = (i - BFS_ROOT_INO) / BFS_INODES_PER_BLOCK + 1;
    let mut off: c_int = (i - BFS_ROOT_INO) % BFS_INODES_PER_BLOCK;
...
#[no_mangle]
unsafe extern "C" fn bfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bfs_init_fs_context(fc: *mut fs_context) -> c_int {
    ...
    MODULE_ALIAS_FS("bfs");
#[no_mangle]
unsafe extern "C" fn init_bfs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_bfs_fs() -> void __exit {
