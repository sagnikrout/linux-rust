...
//
#[no_mangle]
unsafe extern "C" fn configfs_init_dirent_depth(sd: *mut configfs_dirent) {
    ...
    {
    let mut parent_depth: c_int = parent_sd.s_depth;
    if (parent_depth >= 0)
...
#[no_mangle]
pub unsafe extern "C" fn put_fragment(frag: *mut configfs_fragment) {
...
//
#[no_mangle]
unsafe extern "C" fn configfs_dirent_exists(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configfs_remove_dirent(dentry: *mut dentry) {
...
//
    ...
    {
    int error;
    let mut mode: umode_t = S_IFDIR| S_IRWXU | S_IRUGO | S_IXUGO;
...
//
#[no_mangle]
unsafe extern "C" fn configfs_dir_set_ready(sd: *mut configfs_dirent) {
...
//
#[no_mangle]
pub unsafe extern "C" fn configfs_dirent_is_ready(sd: *mut configfs_dirent) -> c_int {
    ...
    {
    let mut err: c_int = 0;
    let mut mode: umode_t = S_IFLNK | S_IRWXUGO;
...
//
#[no_mangle]
unsafe extern "C" fn configfs_remove_dir(d: *mut dentry) {
    static void configfs_remove_dir(struct dentry *d)
    {
    let mut parent: *mut dentry = dget(d.d_parent);
    ...
    unsigned int flags)
    {
    let mut parent_sd: *mut configfs_dirent = dentry.d_parent.d_fsdata;
    struct configfs_dirent * sd;
...
//
    ...
    let mut mode: umode_t = (attr.ca_mode & S_IALLUGO) | S_IFREG;
    dentry.d_fsdata = configfs_get(sd);
    sd.s_dentry = dentry;
    spin_unlock(&configfs_dirent_lock);
    inode = configfs_create(dentry, mode);
...
//
#[no_mangle]
unsafe extern "C" fn configfs_detach_prep(parent_sd: *mut configfs_dirent, wait: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn configfs_detach_rollback(parent_sd: *mut configfs_dirent) {
...
#[no_mangle]
unsafe extern "C" fn detach_attrs(dentry: *mut dentry) {
    ...
    spin_lock(&configfs_dirent_lock);
    for (sd = next_dirent(parent_sd, core::ptr::null_mut()); sd; sd = next) {
    struct dentry *child;
...
#[no_mangle]
unsafe extern "C" fn populate_attrs(item: *mut config_item) -> c_int {
    ...
    ops = t.ct_group_ops;
    if (t.ct_attrs) {
    for (i = 0; (attr = t.ct_attrs[i]) != core::ptr::null_mut(); i++) {
    ...
    if (t.ct_bin_attrs) {
    for (i = 0; (bin_attr = t.ct_bin_attrs[i]) != core::ptr::null_mut(); i++) {
...
#[no_mangle]
unsafe extern "C" fn detach_groups(dentry: *mut dentry) {
...
// We trust the caller holds a reference to parent
    ...
    let mut ret: c_int = create_default_group(parent, new_group, frag);
    if (ret)
    return ret;
    }
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn configfs_remove_default_groups(group: *mut config_group) {
...
//
#[no_mangle]
unsafe extern "C" fn unlink_obj(item: *mut config_item) {
    ...
    item.ci_group = core::ptr::null_mut();
    item.ci_parent = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn link_obj(parent_item: *mut config_item, item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn unlink_group(group: *mut config_group) {
    static void unlink_group(struct config_group *group)
    {
    struct config_group *new_group;
    list_for_each_entry(new_group, &group.default_groups, group_entry)
    unlink_group(new_group);
    group.cg_subsys = core::ptr::null_mut();
    unlink_obj(&group.cg_item);
    }
#[no_mangle]
unsafe extern "C" fn link_group(parent_group: *mut config_group, group: *mut config_group) {
    static void link_group(struct config_group *parent_group, struct config_group *group)
    {
    struct config_group *new_group;
    struct configfs_subsystem *subsys = core::ptr::null_mut(); /* gcc is a turd */
    link_obj(&parent_group.cg_item, &group.cg_item);
    if (parent_group.cg_subsys)
    subsys = parent_group.cg_subsys;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: configfs_is_root(&parent_group->cg_item)) -> else {
...
// Caller holds the mutex of the item's inode
#[no_mangle]
unsafe extern "C" fn configfs_detach_item(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn configfs_detach_group(dentry: *mut dentry) {
    static void configfs_detach_group(struct dentry *dentry)
    {
...
#[no_mangle]
unsafe extern "C" fn configfs_dump_one(sd: *mut configfs_dirent, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn configfs_dump(sd: *mut configfs_dirent, level: c_int) -> c_int {
...
//
    ...
    {
    struct configfs_dirent *p;
    struct configfs_dirent *ret = core::ptr::null_mut();
    spin_lock(&configfs_dirent_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn configfs_undepend_item(target: *mut config_item) {
...
//
    ...
    {
    let mut ret: c_int = 0;
    let mut module_got: c_int = 0;
    struct config_group *group = core::ptr::null_mut();
    struct config_item *item = core::ptr::null_mut();
    struct config_item *parent_item;
    struct configfs_subsystem *subsys;
    struct configfs_dirent *sd;
    const struct config_item_type *type;
    struct module *subsys_owner = core::ptr::null_mut(), *new_item_owner = core::ptr::null_mut();
    struct configfs_fragment *frag;
...
#[no_mangle]
unsafe extern "C" fn configfs_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
    ...
    struct configfs_dirent *sd;
    struct configfs_fragment *frag;
    struct module *subsys_owner = core::ptr::null_mut(), *dead_item_owner = core::ptr::null_mut();
    int ret;
    sd = dentry.d_fsdata;
    if (sd.s_type & CONFIGFS_USET_DEFAULT)
    return -EPERM;
...
#[no_mangle]
unsafe extern "C" fn configfs_dir_open(inode: *mut inode, file: *mut file) -> c_int {
    static int configfs_dir_open(struct inode *inode, struct file *file)
    {
    let mut dentry: *mut dentry = file.f_path.dentry;
    let mut parent_sd: *mut configfs_dirent = dentry.d_fsdata;
    int err;
    inode_lock(d_inode(dentry));
//
// Fake invisibility if dir belongs to a group/default groups hierarchy
...
//
    err = -ENOENT;
    if (configfs_dirent_is_ready(parent_sd)) {
    file.private_data = configfs_new_dirent(parent_sd, core::ptr::null_mut(), 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn configfs_dir_close(inode: *mut inode, file: *mut file) -> c_int {
    static int configfs_dir_close(struct inode *inode, struct file *file)
    {
    let mut dentry: *mut dentry = file.f_path.dentry;
    let mut cursor: *mut configfs_dirent = file.private_data;
    inode_lock(d_inode(dentry));
    spin_lock(&configfs_dirent_lock);
...
#[no_mangle]
unsafe extern "C" fn configfs_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configfs_dir_lseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn configfs_unregister_group(group: *mut config_group) {
    ...
    inode_lock_nested(d_inode(parent), I_MUTEX_PARENT);
    spin_lock(&configfs_dirent_lock);
    configfs_detach_prep(sd, core::ptr::null_mut());
    spin_unlock(&configfs_dirent_lock);
    configfs_detach_group(dentry);
    d_inode(dentry).i_flags |= S_DEAD;
    dont_mount(dentry);
...
//
#[no_mangle]
pub unsafe extern "C" fn configfs_unregister_default_group(group: *mut config_group) {
...
#[no_mangle]
pub unsafe extern "C" fn configfs_register_subsystem(subsys: *mut configfs_subsystem) -> c_int {
    ...
    if (dentry) {
    d_add(dentry, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn configfs_unregister_subsystem(subsys: *mut configfs_subsystem) {
    ...
    mutex_lock(&configfs_symlink_mutex);
    spin_lock(&configfs_dirent_lock);
    if (configfs_detach_prep(sd, core::ptr::null_mut())) {
