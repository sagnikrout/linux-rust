...
#[no_mangle]
unsafe extern "C" fn eventfd_free_ctx(ctx: *mut eventfd_ctx) {
...
#[no_mangle]
unsafe extern "C" fn eventfd_free(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn eventfd_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eventfd_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn eventfd_read(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    ...
    res = sizeof(ucnt);
#[no_mangle]
pub unsafe extern "C" fn if(O_NONBLOCK): !(file->f_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn eventfd_show_fdinfo(m: *mut seq_file, f: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn do_eventfd(count: c_uint, flags: c_int) -> c_int {
    static int do_eventfd(unsigned int count, int flags)
    {
    struct eventfd_ctx *ctx __free(kfree) = core::ptr::null_mut();
