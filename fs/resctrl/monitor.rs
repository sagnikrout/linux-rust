...
#[no_mangle]
unsafe extern "C" fn limbo_release_entry(entry: *mut rmid_entry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __check_limbo(d: *mut rdt_l3_mon_domain, force_free: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn has_busy_rmid(d: *mut rdt_l3_mon_domain) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_find_cleanest_closid() -> c_int {
    int resctrl_find_cleanest_closid(void)
    {
    let mut cleanest_closid: u32 = ~0;
    let mut i: c_int = 0;
    lockdep_assert_held(&rdtgroup_mutex);
    if (!IS_ENABLED(CONFIG_RESCTRL_RMID_DEPENDS_ON_CLOSID))
    return -EIO;
...
//
#[no_mangle]
pub unsafe extern "C" fn alloc_rmid(closid: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_rmid_to_limbo(entry: *mut rmid_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn free_rmid(closid: u32, rmid: u32) {
    void free_rmid(u32 closid, u32 rmid)
    {
    let mut idx: u32 = resctrl_arch_rmid_idx_encode(closid, rmid);
    struct rmid_entry *entry;
    lockdep_assert_held(&rdtgroup_mutex);
//
...
//
    ...
    return state ? &state[idx] : core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mbm_cntr_free(d: *mut rdt_l3_mon_domain, cntr_id: c_int) {
    static void mbm_cntr_free(struct rdt_l3_mon_domain *d, int cntr_id)
    {
    memset(&d.cntr_cfg[cntr_id], 0, sizeof(*d.cntr_cfg));
    }
#[no_mangle]
unsafe extern "C" fn __l3_mon_event_count(rdtgrp: *mut rdtgroup, rr: *mut rmid_read) -> c_int {
    static int __l3_mon_event_count(struct rdtgroup *rdtgrp, struct rmid_read *rr)
    {
    let mut cpu: c_int = smp_processor_id();
    let mut closid: u32 = rdtgrp.closid;
    let mut rmid: u32 = rdtgrp.mon.rmid;
    struct rdt_l3_mon_domain *d;
    let mut cntr_id: c_int = -ENOENT;
    struct mbm_state *m;
    let mut tval: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn __l3_mon_event_count_sum(rdtgrp: *mut rdtgroup, rr: *mut rmid_read) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mon_event_count(rdtgrp: *mut rdtgroup, rr: *mut rmid_read) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mbm_bw_count(rdtgrp: *mut rdtgroup, rr: *mut rmid_read) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mon_event_count(info: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn update_mba_bw(rgrp: *mut rdtgroup, dom_mbm: *mut rdt_l3_mon_domain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cqm_handle_limbo(work: *mut work_struct) {
    void cqm_handle_limbo(struct work_struct *work)
    {
    let mut delay: c_ulong = msecs_to_jiffies(CQM_LIMBOCHECK_INTERVAL);
    struct rdt_l3_mon_domain *d;
//
...
//
    ...
    int exclude_cpu)
    {
    let mut delay: c_ulong = msecs_to_jiffies(delay_ms);
    int cpu;
...
#[no_mangle]
pub unsafe extern "C" fn mbm_handle_overflow(work: *mut work_struct) {
    void mbm_handle_overflow(struct work_struct *work)
    {
    let mut delay: c_ulong = msecs_to_jiffies(MBM_OVERFLOW_INTERVAL);
...
#[no_mangle]
pub unsafe extern "C" fn setup_rmid_lru_list() -> c_int {
    int setup_rmid_lru_list(void)
    {
    struct rmid_entry *entry = core::ptr::null_mut();
    u32 idx_limit;
    u32 idx;
    int i;
    if (!resctrl_arch_mon_capable())
...
#[no_mangle]
pub unsafe extern "C" fn free_rmid_lru_list() {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_is_mon_event_enabled(eventid: enum resctrl_event_id) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_get_mon_evt_cfg(evtid: enum resctrl_event_id) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn event_filter_show(of: *mut kernfs_open_file, seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mbm_cntr_free_all(r: *mut rdt_resource, d: *mut rdt_l3_mon_domain) {
...
//
#[no_mangle]
unsafe extern "C" fn resctrl_reset_rmid_all(r: *mut rdt_resource, d: *mut rdt_l3_mon_domain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_assign_cntrs(rdtgrp: *mut rdtgroup) {
    ...
    return;
    if (resctrl_is_mon_event_enabled(QOS_L3_MBM_TOTAL_EVENT_ID))
    rdtgroup_assign_cntr_event(core::ptr::null_mut(), rdtgrp,
...
//
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_unassign_cntrs(rdtgrp: *mut rdtgroup) {
    ...
    return;
    if (resctrl_is_mon_event_enabled(QOS_L3_MBM_TOTAL_EVENT_ID))
    rdtgroup_unassign_cntr_event(core::ptr::null_mut(), rdtgrp,
    &mon_event_all[QOS_L3_MBM_TOTAL_EVENT_ID]);
    if (resctrl_is_mon_event_enabled(QOS_L3_MBM_LOCAL_EVENT_ID))
    rdtgroup_unassign_cntr_event(core::ptr::null_mut(), rdtgrp,
    &mon_event_all[QOS_L3_MBM_LOCAL_EVENT_ID]);
...
#[no_mangle]
unsafe extern "C" fn resctrl_parse_mem_transactions(tok: *mut c_char, val: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn resctrl_update_cntr_allrdtgrp(mevt: *mut mon_evt) {
...
// Update the visibility of BMEC related files
    resctrl_bmec_files_show(r, core::ptr::null_mut(), !enable);
//
...
#[no_mangle]
pub unsafe extern "C" fn mbm_L3_assignments_show(of: *mut kernfs_open_file, s: *mut seq_file, v: *mut c_void) -> c_int {
...
// Check for domain id '*' which means all domains
    if (id_str && *id_str == '*') {
    ret = rdtgroup_modify_assign_state(dom_str, core::ptr::null_mut(), rdtgrp, mevt);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn closid_num_dirty_rmid_alloc(r: *mut rdt_resource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn closid_num_dirty_rmid_free() {
    static void closid_num_dirty_rmid_free(void)
    {
    if (IS_ENABLED(CONFIG_RESCTRL_RMID_DEPENDS_ON_CLOSID)) {
    mutex_lock(&rdtgroup_mutex);
    kfree(closid_num_dirty_rmid);
    closid_num_dirty_rmid = core::ptr::null_mut();
    mutex_unlock(&rdtgroup_mutex);
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_l3_mon_resource_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: resctrl_is_mon_event_enabled(QOS_L3_MBM_TOTAL_EVENT_ID)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_l3_mon_resource_exit() {
