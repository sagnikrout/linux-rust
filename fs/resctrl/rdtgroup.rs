...
#[no_mangle]
pub unsafe extern "C" fn rdt_last_cmd_clear() {
...
#[no_mangle]
pub unsafe extern "C" fn rdt_last_cmd_puts(s: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn rdt_last_cmd_printf(fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn rdt_staged_configs_clear() {
...
#[no_mangle]
unsafe extern "C" fn resctrl_is_mbm_enabled() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn closids_supported() -> c_int {
    int closids_supported(void)
    {
    return closid_free_map_len;
    }
#[no_mangle]
unsafe extern "C" fn closid_init() -> c_int {
    static int closid_init(void)
    {
    struct resctrl_schema *s;
    let mut rdt_min_closid: u32 = ~0;
...
#[no_mangle]
unsafe extern "C" fn closid_exit() {
    static void closid_exit(void)
    {
    bitmap_free(closid_free_map);
    closid_free_map = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn closid_alloc() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn closid_free(closid: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn closid_allocated(closid: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn closid_alloc_fixed(closid: u32) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_mode_by_closid(closid: c_int) -> enum rdtgrp_mode {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_kn_set_ugid(kn: *mut kernfs_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_add_file(parent_kn: *mut kernfs_node, rft: *mut rftype) -> c_int {
    ...
    0, rft.kf_ops, rft, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(kn))
    return PTR_ERR(kn);
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_seqfile_show(m: *mut seq_file, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_cpu_list(of: *mut kernfs_open_file) -> bool {
...
//
    ...
    {
    struct resctrl_cpu_defaults defaults, *p = core::ptr::null_mut();
    if (r) {
...
#[no_mangle]
unsafe extern "C" fn cpumask_rdtgrp_clear(r: *mut rdtgroup, m: *mut cpumask) {
...
//
    ...
    {
    let mut tmpmask: cpumask_var_t = CPUMASK_VAR_NULL, newmask = CPUMASK_VAR_NULL;
    let mut tmpmask1: cpumask_var_t = CPUMASK_VAR_NULL;
    struct rdtgroup *rdtgrp;
    int ret;
    rdtgrp = rdtgroup_kn_lock_live(of.kn);
    if (!rdtgrp) {
...
#[no_mangle]
pub unsafe extern "C" fn if(RDTMON_GROUP: rdtgrp->type ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn rdtgroup_remove(rdtgrp: *mut rdtgroup) {
...
#[no_mangle]
unsafe extern "C" fn _update_task_closid_rmid(task: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn update_task_closid_rmid(t: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn task_in_rdtgroup(tsk: *mut task_struct, rdtgrp: *mut rdtgroup) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_closid_match(t: *mut task_struct, r: *mut rdtgroup) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_rmid_match(t: *mut task_struct, r: *mut rdtgroup) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_tasks_assigned(r: *mut rdtgroup) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_rdt_tasks(r: *mut rdtgroup, s: *mut seq_file) {
...
//
    let mut sw_shareable: c_ulong = 0, hw_shareable = 0;
    let mut exclusive: c_ulong = 0, pseudo_locked = 0;
    struct rdt_ctrl_domain *dom;
...
//
    ...
    seq_putc(seq, 'X');
#[no_mangle]
pub unsafe extern "C" fn if(!swb: hwb &&) -> else {
    else if (hwb && !swb)
    seq_putc(seq, 'H');
#[no_mangle]
pub unsafe extern "C" fn if(swb: !hwb &&) -> else {
    ...
    seq_putc(seq, 'S');
#[no_mangle]
pub unsafe extern "C" fn if(_arg: excl) -> else {
    else if (excl)
    seq_putc(seq, 'E');
#[no_mangle]
pub unsafe extern "C" fn if(_arg: psl) -> else {
    else if (psl)
    seq_putc(seq, 'P');
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_peer_type(my_type: enum resctrl_conf_type) -> enum resctrl_conf_type {
...
//
    ...
    {
    let mut peer_type: enum resctrl_conf_type = resctrl_peer_type(s.conf_type);
...
//
#[no_mangle]
unsafe extern "C" fn rdtgroup_mode_test_exclusive(rdtgrp: *mut rdtgroup) -> bool {
    static bool rdtgroup_mode_test_exclusive(struct rdtgroup *rdtgrp)
    {
    let mut closid: c_int = rdtgrp.closid;
    struct rdt_ctrl_domain *d;
    struct resctrl_schema *s;
    struct rdt_resource *r;
    let mut has_cache: bool = false;
    u32 ctrl;
...
#[no_mangle]
pub unsafe extern "C" fn is_mba_sc(r: *mut rdt_resource) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mondata_config_read(mon_info: *mut resctrl_mon_config_info) {
...
#[no_mangle]
unsafe extern "C" fn mbm_config_show(s: *mut seq_file, r: *mut rdt_resource, evtid: u32) -> c_int {
    ...
    {
    let mut mon_info: resctrl_mon_config_info = {0};
//
...
#[no_mangle]
unsafe extern "C" fn mon_config_write(r: *mut rdt_resource, tok: *mut c_char, evtid: u32) -> c_int {
    static int mon_config_write(struct rdt_resource *r, char *tok, u32 evtid)
    {
    char *dom_str = core::ptr::null_mut(), *id_str;
...
//
    ...
    bool show)
    {
    struct kernfs_node *kn_config, *mon_kn = core::ptr::null_mut();
    char name[32];
    if (!l3_mon_kn) {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_add_files(kn: *mut kernfs_node, fflags: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thread_throttle_mode_init() {
    static void thread_throttle_mode_init(void)
    {
    let mut throttle_mode: enum membw_throttle_mode = THREAD_THROTTLE_UNDEFINED;
...
//
#[no_mangle]
unsafe extern "C" fn io_alloc_init() {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_file_fflags_init(config: *const c_char, fflags: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_file_mode_init(config: *const c_char, mode: umode_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_kn_mode_restrict(r: *mut rdtgroup, name: *const c_char) -> c_int {
    int rdtgroup_kn_mode_restrict(struct rdtgroup *r, const char *name)
    {
    let mut iattr: iattr = {.ia_valid = ATTR_MODE,};
    struct kernfs_node *kn;
    let mut ret: c_int = 0;
    kn = kernfs_find_and_get_ns(r.kn, name, core::ptr::null_mut());
    if (!kn)
    return -ENOENT;
...
#[no_mangle]
unsafe extern "C" fn resctrl_mkdir_event_configs(r: *mut rdt_resource, l3_mon_kn: *mut kernfs_node) -> c_int {
    ...
    struct mon_evt *mevt;
    int ret;
    kn_subdir = kernfs_create_dir(l3_mon_kn, "event_configs", l3_mon_kn.mode, core::ptr::null_mut());
    if (IS_ERR(kn_subdir))
...
#[no_mangle]
unsafe extern "C" fn fflags_from_resource(r: *mut rdt_resource) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_create_info_dir(parent_kn: *mut kernfs_node) -> c_int {
...
// create the directory
    kn_info = kernfs_create_dir(parent_kn, "info", parent_kn.mode, core::ptr::null_mut());
    if (IS_ERR(kn_info))
...
#[no_mangle]
pub unsafe extern "C" fn is_mba_linear() -> bool {
    static inline bool is_mba_linear(void)
    {
    return resctrl_arch_get_resource(RDT_RESOURCE_MBA).membw.delay_linear;
    }
#[no_mangle]
unsafe extern "C" fn mba_sc_domain_allocate(r: *mut rdt_resource, d: *mut rdt_ctrl_domain) -> c_int {
    static int mba_sc_domain_allocate(struct rdt_resource *r, struct rdt_ctrl_domain *d)
    {
    let mut num_closid: u32 = resctrl_arch_get_num_closid(r);
    let mut cpu: c_int = cpumask_any(&d.hdr.cpu_mask);
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn supports_mba_mbps() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn set_mba_sc(mba_sc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_kn_get(rdtgrp: *mut rdtgroup, kn: *mut kernfs_node) {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_kn_put(rdtgrp: *mut rdtgroup, kn: *mut kernfs_node) {
...
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_kn_unlock(kn: *mut kernfs_node) {
...
//
#[no_mangle]
unsafe extern "C" fn is_active_resctrl_node(kn: *mut kernfs_node) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn info_kn_lock(kn: *mut kernfs_node) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn info_kn_unlock(kn: *mut kernfs_node) {
...
#[no_mangle]
unsafe extern "C" fn rdt_disable_ctx() {
...
#[no_mangle]
unsafe extern "C" fn rdt_enable_ctx(ctx: *mut rdt_fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn schemata_list_add(r: *mut rdt_resource, type: enum resctrl_conf_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn schemata_list_create() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn schemata_list_destroy() {
...
#[no_mangle]
unsafe extern "C" fn free_all_child_rdtgrp(rdtgrp: *mut rdtgroup) {
...
//
#[no_mangle]
unsafe extern "C" fn rmdir_all_sub() {
    static void rmdir_all_sub(void)
    {
    struct rdtgroup *rdtgrp, *tmp;
// Move all tasks to the default resource group
    rdt_move_group_tasks(core::ptr::null_mut(), &rdtgroup_default, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn mon_put_kn_priv() {
...
#[no_mangle]
unsafe extern "C" fn resctrl_fs_teardown() {
...
#[no_mangle]
unsafe extern "C" fn resctrl_unmount() {
...
#[no_mangle]
unsafe extern "C" fn rdt_get_tree(fc: *mut fs_context) -> c_int {
    static int rdt_get_tree(struct fs_context *fc)
    {
    struct rdt_fs_context *ctx = rdt_fc2context(fc);
    let mut flags: c_ulong = RFTYPE_CTRL_BASE;
...
#[no_mangle]
unsafe extern "C" fn rdt_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdt_fs_context_free(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn rdt_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdt_kill_sb(sb: *mut super_block) {
    ...
    &kf_mondata_ops, priv, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(kn))
    return PTR_ERR(kn);
    ret = rdtgroup_kn_set_ugid(kn);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn mon_rmdir_one_subdir(pkn: *mut kernfs_node, name: *mut c_char, subname: *mut c_char) {
...
//
    ...
    kn = _mkdir_mondata_subdir(parent_kn, name, core::ptr::null_mut(), r, prgrp, d.ci_id);
    if (IS_ERR(kn))
    return PTR_ERR(kn);
    }
...
//
#[no_mangle]
unsafe extern "C" fn cbm_ensure_valid(_val: u32, r: *mut rdt_resource) -> u32 {
    static u32 cbm_ensure_valid(u32 _val, struct rdt_resource *r)
    {
    let mut cbm_len: c_uint = r.cache.cbm_len;
...
//
    ...
    {
    let mut peer_type: enum resctrl_conf_type = resctrl_peer_type(s.conf_type);
    let mut t: enum resctrl_conf_type = s.conf_type;
    struct resctrl_staged_config *cfg;
    struct rdt_resource *r = s.res;
    let mut used_b: u32 = 0, unused_b = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_init_cat(s: *mut resctrl_schema, closid: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_init_mba(r: *mut rdt_resource, closid: u32) {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_init_alloc(rdtgrp: *mut rdtgroup) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mkdir_rdt_prepare_rmid_alloc(rdtgrp: *mut rdtgroup) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mkdir_rdt_prepare_rmid_free(rgrp: *mut rdtgroup) {
...
//
#[no_mangle]
unsafe extern "C" fn is_mon_groups(kn: *mut kernfs_node, name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mkdir_rdt_prepare_clean(rgrp: *mut rdtgroup) {
...
//
    ret = mongroup_create_dir(kn, rdtgrp, "mon_groups", core::ptr::null_mut());
    if (ret) {
    rdt_last_cmd_puts("kernfs subdir error\n");
    goto out_del_list;
    }
    if (is_mba_sc(core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_rmdir_mon(rdtgrp: *mut rdtgroup, tmpmask: cpumask_var_t) -> c_int {
...
//
    ...
    update_closid_rmid(tmpmask, core::ptr::null_mut());
    rdtgrp.flags = RDT_DELETED;
    rdtgroup_unassign_cntrs(rdtgrp);
    free_rmid(rdtgrp.closid, rdtgrp.mon.rmid);
//
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_ctrl_remove(rdtgrp: *mut rdtgroup) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_rmdir_ctrl(rdtgrp: *mut rdtgroup, tmpmask: cpumask_var_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_rmdir(kn: *mut kernfs_node) -> c_int {
...
// Propagate updated closid to all tasks in this group.
    ...
    update_closid_rmid(cpus, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_show_options(seq: *mut seq_file, kf: *mut kernfs_root) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_setup_root(ctx: *mut rdt_fs_context) -> c_int {
    static int rdtgroup_setup_root(struct rdt_fs_context *ctx)
    {
...
#[no_mangle]
unsafe extern "C" fn rdtgroup_destroy_root() {
    static void rdtgroup_destroy_root(void)
    {
    lockdep_assert_held(&rdtgroup_mutex);
    kernfs_destroy_root(rdt_root);
    rdtgroup_default.kn = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn rdtgroup_setup_default() {
...
#[no_mangle]
unsafe extern "C" fn domain_destroy_l3_mon_state(d: *mut rdt_l3_mon_domain) {
    ...
    d.mbm_states[idx] = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_offline_ctrl_domain(r: *mut rdt_resource, d: *mut rdt_ctrl_domain) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_offline_mon_domain(r: *mut rdt_resource, hdr: *mut rdt_domain_hdr) {
...
//
#[no_mangle]
unsafe extern "C" fn domain_setup_l3_mon_state(r: *mut rdt_resource, d: *mut rdt_l3_mon_domain) -> c_int {
    static int domain_setup_l3_mon_state(struct rdt_resource *r, struct rdt_l3_mon_domain *d)
    {
    let mut idx_limit: u32 = resctrl_arch_system_num_rmid_idx();
    let mut tsize: usize = sizeof(*d.mbm_states[0]);
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_online_ctrl_domain(r: *mut rdt_resource, d: *mut rdt_ctrl_domain) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_online_mon_domain(r: *mut rdt_resource, hdr: *mut rdt_domain_hdr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_online_cpu(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn clear_childcpus(r: *mut rdtgroup, cpu: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_offline_cpu(cpu: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_init() -> c_int {
...
// tell lockdep that).
//
    debugfs_resctrl = debugfs_create_dir("resctrl", core::ptr::null_mut());
    return 0;
    cleanup_mountpoint:
...
#[no_mangle]
unsafe extern "C" fn resctrl_online_domains_exist() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_exit() {
    ...
    debugfs_resctrl = core::ptr::null_mut();
