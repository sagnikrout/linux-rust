...
//! Source: fs/resctrl/ctrlmondata.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rdt_parse_data {
    pub closid: u32,
    pub mode: enum rdtgrp_mode,
    pub buf: *mut c_char,
}
...
//
#[no_mangle]
unsafe extern "C" fn bw_validate(buf: *mut c_char, data: *mut u32, r: *mut rdt_resource) -> bool {
...
// data = roundup(bw, (unsigned long)r->membw.bw_gran);
    ...
    let mut closid: u32 = data.closid;
    u32 bw_val;
...
//
#[no_mangle]
unsafe extern "C" fn cbm_validate(buf: *mut c_char, data: *mut u32, r: *mut rdt_resource) -> bool {
    static bool cbm_validate(char *buf, u32 *data, struct rdt_resource *r)
    {
    let mut supported_bits: u32 = BIT_MASK(r.cache.cbm_len) - 1;
...
//
    ...
    struct rdt_ctrl_domain *d)
    {
    let mut mode: enum rdtgrp_mode = data.mode;
    struct resctrl_staged_config *cfg;
    struct rdt_resource *r = s.res;
    let mut closid: u32 = data.closid;
    u32 cbm_val;
...
//
    ...
    ctrlval_parser_t *parse_ctrlval = core::ptr::null_mut();
    struct resctrl_staged_config *cfg;
    struct rdt_resource *r = s.res;
    struct rdt_parse_data data;
    struct rdt_ctrl_domain *d;
    char *dom = core::ptr::null_mut(), *id;
...
#[no_mangle]
unsafe extern "C" fn smp_mon_event_count(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_event_value(m: *mut seq_file, binary_bits: c_uint, val: u64) {
    static void print_event_value(struct seq_file *m, unsigned int binary_bits, u64 val)
    {
    let mut frac: c_ulonglong = 0;
    if (binary_bits) {
...
#[no_mangle]
pub unsafe extern "C" fn rdtgroup_mondata_show(m: *mut seq_file, arg: *mut c_void) -> c_int {
...
//
    ...
    continue;
    rr.ci = ci;
    mon_event_read(&rr, r, core::ptr::null_mut(), rdtgrp,
...
//
    hdr = resctrl_find_domain(&r.mon_domains, domid, core::ptr::null_mut());
    if (!hdr) {
    ret = -ENOENT;
    goto out;
    }
...
//
    ...
    seq_puts(m, "Error\n");
#[no_mangle]
pub unsafe extern "C" fn if(-EINVAL: rr.err ==) -> else {
    else if (rr.err == -EINVAL)
    seq_puts(m, "Unavailable\n");
#[no_mangle]
pub unsafe extern "C" fn if(-ENOENT: rr.err ==) -> else {
    else if (rr.err == -ENOENT)
    seq_puts(m, "Unassigned\n");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: evt->is_floating_point) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_io_alloc_show(of: *mut kernfs_open_file, seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn resctrl_io_alloc_closid_supported(io_alloc_closid: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn resctrl_io_alloc_init_cbm(s: *mut resctrl_schema, closid: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_io_alloc_closid(r: *mut rdt_resource) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_io_alloc_cbm_show(of: *mut kernfs_open_file, seq: *mut seq_file, v: *mut c_void) -> c_int {
...
// used for I/O.
//
    show_doms(seq, s, core::ptr::null_mut(), resctrl_io_alloc_closid(r));
    out_unlock:
    info_kn_unlock(of.kn);
    return ret;
    }
    ...
    {
    enum resctrl_conf_type peer_type;
    let mut dom_id: c_ulong = ULONG_MAX;
    struct rdt_parse_data data;
    struct rdt_ctrl_domain *d;
    let mut update_all: bool = false;
    char *dom = core::ptr::null_mut(), *id;
    next:
    if (!line || line[0] == '\0')
    return 0;
