...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct squashfs_mount_opts {
    pub errors: enum Opt_errors,
    pub thread_ops: *const squashfs_decompressor_thread_ops,
    pub thread_num: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn squashfs_parse_param_threads_str(str: *const c_char, opts: *mut squashfs_mount_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn squashfs_parse_param_threads_num(str: *const c_char, opts: *mut squashfs_mount_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn squashfs_parse_param_threads(str: *const c_char, opts: *mut squashfs_mount_opts) -> c_int {
    static int squashfs_parse_param_threads(const char *str, struct squashfs_mount_opts *opts)
    {
    let mut ret: c_int = squashfs_parse_param_threads_str(str, opts);
    if (ret == 0)
    return ret;
    return squashfs_parse_param_threads_num(str, opts);
    }
#[no_mangle]
unsafe extern "C" fn squashfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn squashfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    static int squashfs_fill_super(struct super_block *sb, struct fs_context *fc)
    {
    struct squashfs_mount_opts *opts = fc.fs_private;
    struct squashfs_sb_info *msblk;
    struct squashfs_super_block *sblk = core::ptr::null_mut();
    struct inode *root;
    ...
    if (sb.s_fs_info == core::ptr::null_mut()) {
...
// Check the MAJOR & MINOR versions and lookup compression type
    ...
    if (msblk.decompressor == core::ptr::null_mut())
    goto failed_mount;
...
// Allocate read_page block
    ...
    msblk.stream = core::ptr::null_mut();
    goto insanity;
    }
// Handle xattrs
...
// Allocate and read xattr id lookup table
    ...
    msblk.xattr_id_table = core::ptr::null_mut();
    if (err != -ENOTSUPP)
    goto failed_mount;
    }
...
// Allocate and read id index table
    ...
    msblk.id_table = core::ptr::null_mut();
    goto failed_mount;
    }
...
// Allocate and read inode lookup table
    ...
    msblk.inode_lookup_table = core::ptr::null_mut();
    goto failed_mount;
    }
...
// Allocate and read fragment index table
    ...
    msblk.fragment_index = core::ptr::null_mut();
    goto failed_mount;
    }
...
#[no_mangle]
unsafe extern "C" fn squashfs_get_tree(fc: *mut fs_context) -> c_int {
    static int squashfs_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, squashfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn squashfs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn squashfs_free_fs_context(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn squashfs_show_options(s: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn squashfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn squashfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    static int squashfs_statfs(struct dentry *dentry, struct kstatfs *buf)
    {
    struct squashfs_sb_info *msblk = dentry.d_sb.s_fs_info;
    let mut id: u64 = huge_encode_dev(dentry.d_sb.s_bdev.bd_dev);
...
#[no_mangle]
unsafe extern "C" fn squashfs_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn init_squashfs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_squashfs_fs() -> void __exit {
    ...
    return ei ? &ei.vfs_inode : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn squashfs_free_inode(inode: *mut inode) {
