...
pub const QNX4_VERSION: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn qnx4_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnx4_get_block(inode: *mut inode, iblock: sector_t, bh: *mut buffer_head, create: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn try_extent(extent: *mut qnx4_xtnt_t, offset: *mut u32) -> u32 {
    static inline u32 try_extent(qnx4_xtnt_t *extent, u32 *offset)
    {
    let mut size: u32 = le32_to_cpu(extent.xtnt_size);
    if (*offset < size)
...
#[no_mangle]
pub unsafe extern "C" fn qnx4_block_map(inode: *mut inode, iblock: c_long) -> c_ulong {
    unsigned long qnx4_block_map( struct inode *inode, long iblock )
    {
    int ix;
    long i_xblk;
    struct buffer_head *bh = core::ptr::null_mut();
    struct qnx4_xblk *xblk = core::ptr::null_mut();
    struct qnx4_inode_entry *qnx4_inode = qnx4_raw_inode(inode);
    let mut nxtnt: u16 = le16_to_cpu(qnx4_inode.di_num_xtnts);
    let mut offset: u32 = iblock;
    let mut block: u32 = try_extent(&qnx4_inode.di_first_xtnt, &offset);
    if (block) {
...
#[no_mangle]
unsafe extern "C" fn qnx4_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnx4_fill_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnx4_get_tree(fc: *mut fs_context) -> c_int {
    static int qnx4_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, qnx4_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn qnx4_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnx4_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn qnx4_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int qnx4_read_folio(struct file *file, struct folio *folio)
    {
    return block_read_full_folio(folio, qnx4_get_block);
    }
#[no_mangle]
unsafe extern "C" fn qnx4_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn qnx4_free_inode(inode: *mut inode) {
    static void qnx4_free_inode(struct inode *inode)
    {
...
unsafe extern "C" fn init_inodecache() -> c_int {
    ...
    SLAB_ACCOUNT),
    init_once);
    if (qnx4_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn init_qnx4_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_qnx4_fs() -> void __exit {
