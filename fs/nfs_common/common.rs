...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_stat_to_errno(status: enum nfs_stat) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs4_stat_to_errno(stat: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_localio_errno_to_nfs4_stat(errno: c_int) -> __u32 {
