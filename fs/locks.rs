...
#[no_mangle]
unsafe extern "C" fn lease_breaking(fl: *mut file_lease) -> bool {
    static bool lease_breaking(struct file_lease *fl)
    {
    return fl.c.flc_flags & (FL_UNLOCK_PENDING | FL_DOWNGRADE_PENDING);
    }
#[no_mangle]
unsafe extern "C" fn target_leasetype(fl: *mut file_lease) -> c_int {
    ...
    let mut leases_enable: static int = 1;
    let mut lease_break_time: static int = 45;
...
#[no_mangle]
unsafe extern "C" fn init_fs_locks_sysctls() -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct file_lock_list_struct {
    pub lock: spinlock_t,
...
//
pub const BLOCKED_HASH_BITS: c_int = 7;
...
#[no_mangle]
unsafe extern "C" fn locks_init_lock_heads(flc: *mut file_lock_core) {
...
#[no_mangle]
pub unsafe extern "C" fn locks_release_private(fl: *mut file_lock) {
    ...
    fl.fl_ops = core::ptr::null_mut();
    }
    if (fl.fl_lmops) {
    if (fl.fl_lmops.lm_put_owner) {
    fl.fl_lmops.lm_put_owner(flc.flc_owner);
    flc.flc_owner = core::ptr::null_mut();
    }
    fl.fl_lmops = core::ptr::null_mut();
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn locks_owner_has_blockers(flctx: *mut file_lock_context, owner: fl_owner_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn locks_free_lock(fl: *mut file_lock) {
...
#[no_mangle]
pub unsafe extern "C" fn locks_free_lease(fl: *mut file_lease) {
...
#[no_mangle]
pub unsafe extern "C" fn locks_init_lock(fl: *mut file_lock) {
...
#[no_mangle]
pub unsafe extern "C" fn locks_init_lease(fl: *mut file_lease) {
...
#[no_mangle]
pub unsafe extern "C" fn locks_copy_lock(new: *mut file_lock, fl: *mut file_lock) {
...
#[no_mangle]
unsafe extern "C" fn locks_move_blocks(new: *mut file_lock, fl: *mut file_lock) {
...
#[no_mangle]
pub unsafe extern "C" fn flock_translate_cmd(cmd: c_int) -> c_int {
    switch (cmd) {
    case LOCK_SH:
    return F_RDLCK;
    case LOCK_EX:
...
#[no_mangle]
unsafe extern "C" fn flock_make_lock(filp: *mut file, fl: *mut file_lock, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn assign_type(flc: *mut file_lock_core, type: c_int) -> c_int {
...
//
    ...
    {
    struct inode *inode = file_inode(filp);
    let mut self_wcount: c_int = 0, self_rcount = 0;
    if (arg == F_RDLCK)
    return inode_is_open_for_write(inode) ? -EAGAIN : 0;
#[no_mangle]
pub unsafe extern "C" fn if(F_WRLCK: arg !=) -> else {
    else if (arg != F_WRLCK)
    return 0;
//
...
//
    ...
    self_wcount = 1;
#[no_mangle]
pub unsafe extern "C" fn if(FMODE_READ: filp->f_mode &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn lease_init(filp: *mut file, flags: c_uint, type: c_int, fl: *mut file_lease) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn locks_overlap(fl1: *mut file_lock, fl2: *mut file_lock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn posix_same_owner(fl1: *mut file_lock_core, fl2: *mut file_lock_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn locks_insert_global_locks(flc: *mut file_lock_core) {
...
// Must be called with the flc_lock held!
#[no_mangle]
unsafe extern "C" fn locks_delete_global_locks(flc: *mut file_lock_core) {
...
#[no_mangle]
unsafe extern "C" fn locks_insert_global_blocked(waiter: *mut file_lock_core) {
...
#[no_mangle]
unsafe extern "C" fn locks_delete_global_blocked(waiter: *mut file_lock_core) {
...
//
#[no_mangle]
unsafe extern "C" fn __locks_unlink_block(waiter: *mut file_lock_core) {
...
#[no_mangle]
unsafe extern "C" fn __locks_wake_up_blocks(blocker: *mut file_lock_core) {
...
//
    smp_store_release(&waiter.flc_blocker, core::ptr::null_mut());
    }
    }
#[no_mangle]
unsafe extern "C" fn __locks_delete_block(waiter: *mut file_lock_core) -> c_int {
    static int __locks_delete_block(struct file_lock_core *waiter)
    {
    let mut status: c_int = -ENOENT;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn locks_delete_block(waiter: *mut file_lock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn locks_wake_up_blocks(blocker: *mut file_lock_core) {
...
//
pub const MAX_DEADLK_ITERATIONS: c_int = 10;
...
//
#[no_mangle]
unsafe extern "C" fn flock_lock_inode(inode: *mut inode, request: *mut file_lock) -> c_int {
    static int flock_lock_inode(struct inode *inode, struct file_lock *request)
    {
    struct file_lock *new_fl = core::ptr::null_mut();
    struct file_lock *fl;
    struct file_lock_context *ctx;
    ...
    struct file_lock *new_fl = core::ptr::null_mut();
    struct file_lock *new_fl2 = core::ptr::null_mut();
    struct file_lock *left = core::ptr::null_mut();
    struct file_lock *right = core::ptr::null_mut();
    struct file_lock_context *ctx;
    int error;
...
//
#[no_mangle]
unsafe extern "C" fn posix_lock_inode_wait(inode: *mut inode, fl: *mut file_lock) -> c_int {
    static int posix_lock_inode_wait(struct inode *inode, struct file_lock *fl)
    {
    int error;
    might_sleep ();
    for (;;) {
    error = posix_lock_inode(inode, fl, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn lease_clear_pending(fl: *mut file_lease, arg: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn lease_modify(fl: *mut file_lease, arg: c_int, dispose: *mut list_head) -> c_int {
    int lease_modify(struct file_lease *fl, int arg, struct list_head *dispose)
    {
    let mut error: c_int = assign_type(&fl.c, arg);
    if (error)
    return error;
    ...
    if (fl.fl_fasync != core::ptr::null_mut()) {
    printk(KERN_ERR "locks_delete_lock: fasync == %p\n", fl.fl_fasync);
    fl.fl_fasync = core::ptr::null_mut();
    }
    locks_delete_lock_ctx(&fl.c, dispose);
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn past_time(then: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn time_out_leases(inode: *mut inode, dispose: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn leases_conflict(lc: *mut file_lock_core, bc: *mut file_lock_core) -> bool {
...
// If we already have everything, we can stop
    ...
    return FL_LEASE;
#[no_mangle]
pub unsafe extern "C" fn if(LEASE_BREAK_DELEG: flags &) -> else {
    else if (flags & LEASE_BREAK_DELEG)
    return FL_DELEG;
#[no_mangle]
pub unsafe extern "C" fn if(LEASE_BREAK_LAYOUT: flags &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn __break_lease(inode: *mut inode, flags: c_uint) -> c_int {
    ...
    unsigned int type;
    LIST_HEAD(dispose);
    let mut want_write: bool = !(flags & LEASE_BREAK_OPEN_RDONLY);
    let mut error: c_int = 0;
    trace_break_lease(inode, flags);
    type = break_lease_flags_to_type(flags);
    if (!type)
    return -EINVAL;
    new_fl = lease_alloc(core::ptr::null_mut(), type, want_write ? F_WRLCK : F_RDLCK);
    if (IS_ERR(new_fl))
...
// typically we will check that ctx is non-NULL before calling
    ...
    percpu_down_read(&file_rwsem);
    spin_lock(&ctx.flc_lock);
    trace_break_lease_unblock(inode, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn lease_get_mtime(inode: *mut inode, time: *mut timespec64) {
    void lease_get_mtime(struct inode *inode, struct timespec64 *time)
    {
    let mut has_lease: bool = false;
    struct file_lock_context *ctx;
    struct file_lock_core *flc;
    ctx = locks_inode_context(inode);
...
//
#[no_mangle]
unsafe extern "C" fn __fcntl_getlease(filp: *mut file, flavor: c_uint) -> c_int {
    static int __fcntl_getlease(struct file *filp, unsigned int flavor)
    {
    struct file_lease *fl;
    struct inode *inode = file_inode(filp);
    struct file_lock_context *ctx;
    let mut type: c_int = F_UNLCK;
    LIST_HEAD(dispose);
    ctx = locks_inode_context(inode);
    if (ctx && !list_empty_careful(&ctx.flc_lease)) {
    percpu_down_read(&file_rwsem);
...
#[no_mangle]
pub unsafe extern "C" fn fcntl_getlease(filp: *mut file) -> c_int {
    int fcntl_getlease(struct file *filp)
    {
    return __fcntl_getlease(filp, FL_LEASE);
    }
#[no_mangle]
pub unsafe extern "C" fn fcntl_getdeleg(filp: *mut file, deleg: *mut delegation) -> c_int {
    ...
    {
    struct file_lease *fl, *my_fl = core::ptr::null_mut(), *lease;
    struct inode *inode = file_inode(filp);
    struct file_lock_context *ctx;
    let mut is_deleg: bool = (*flp).c.flc_flags & FL_DELEG;
    int error;
    LIST_HEAD(dispose);
    lease = *flp;
...
#[no_mangle]
unsafe extern "C" fn generic_delete_lease(filp: *mut file, owner: *mut c_void) -> c_int {
    static int generic_delete_lease(struct file *filp, void *owner)
    {
    let mut error: c_int = -EAGAIN;
    struct file_lease *fl, *victim = core::ptr::null_mut();
    struct inode *inode = file_inode(filp);
    struct file_lock_context *ctx;
    LIST_HEAD(dispose);
    ctx = locks_inode_context(inode);
    if (!ctx) {
    trace_generic_delete_lease(inode, core::ptr::null_mut());
    return error;
    }
    percpu_down_read(&file_rwsem);
    spin_lock(&ctx.flc_lock);
...
#[no_mangle]
pub unsafe extern "C" fn lease_register_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lease_unregister_notifier(nb: *mut notifier_block) {
...
//
    ...
    {
    struct inode *inode = file_inode(filp);
    let mut vfsuid: vfsuid_t = i_uid_into_vfsuid(file_mnt_idmap(filp), inode);
    int error;
...
#[no_mangle]
unsafe extern "C" fn do_fcntl_add_lease(fd: c_uint, filp: *mut file, flavor: c_uint, arg: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcntl_setlease(fd: c_uint, filp: *mut file, arg: c_int) -> c_int {
    int fcntl_setlease(unsigned int fd, struct file *filp, int arg)
    {
    if (S_ISDIR(file_inode(filp).i_mode))
    return -EINVAL;
    if (arg == F_UNLCK)
    return vfs_setlease(filp, F_UNLCK, core::ptr::null_mut(), (void **)&filp);
...
//
#[no_mangle]
pub unsafe extern "C" fn fcntl_setdeleg(fd: c_uint, filp: *mut file, deleg: *mut delegation) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flock_lock_inode_wait(inode: *mut inode, fl: *mut file_lock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn locks_lock_inode_wait(inode: *mut inode, fl: *mut file_lock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_test_lock(filp: *mut file, fl: *mut file_lock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn locks_translate_pid(fl: *mut file_lock_core, ns: *mut pid_namespace) -> pid_t {
...
#[no_mangle]
unsafe extern "C" fn posix_lock_to_flock(flock: *mut flock, fl: *mut file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn posix_lock_to_flock64(flock: *mut flock64, fl: *mut file_lock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcntl_getlk(filp: *mut file, cmd: c_uint, flock: *mut flock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_lock_file(filp: *mut file, cmd: c_uint, fl: *mut file_lock, conf: *mut file_lock) -> c_int {
    ...
    return error;
    for (;;) {
    error = vfs_lock_file(filp, cmd, fl, core::ptr::null_mut());
    if (error != FILE_LOCK_DEFERRED)
    break;
    error = wait_event_interruptible(fl.c.flc_wait,
    list_empty(&fl.c.flc_blocked_member));
...
//
    ...
    struct file *f;
    int error;
    if (file_lock == core::ptr::null_mut())
    return -ENOLCK;
...
//
#[no_mangle]
pub unsafe extern "C" fn fcntl_getlk64(filp: *mut file, cmd: c_uint, flock: *mut flock64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn locks_remove_posix(filp: *mut file, owner: fl_owner_t) {
...
//
    ...
    lock.fl_ops = core::ptr::null_mut();
    lock.fl_lmops = core::ptr::null_mut();
    error = vfs_lock_file(filp, F_SETLK, &lock, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn locks_remove_file(filp: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_cancel_lock(filp: *mut file, fl: *mut file_lock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_inode_has_locks(inode: *mut inode) -> bool {
...
pub struct locks_iterator {
    ...
    let mut type: c_int = flc.flc_type;
...
//
    if (flc.flc_file != core::ptr::null_mut())
    ...
    seq_puts(f, "ACCESS");
#[no_mangle]
pub unsafe extern "C" fn if(FL_OFDLCK: flc->flc_flags &) -> else {
    else if (flc.flc_flags & FL_OFDLCK)
    seq_puts(f, "OFDLCK");
    else
    seq_puts(f, "POSIX ");
    seq_printf(f, " %s ",
    (inode == core::ptr::null_mut()) ? "*NOINODE*" : "ADVISORY ");
    ...
    seq_puts(f, "BREAKING  ");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: flc->flc_file) -> else {
...
// NULL node or root node
    if (node == core::ptr::null_mut() || node.flc_blocker == core::ptr::null_mut())
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn locks_show(f: *mut seq_file, v: *mut c_void) -> c_int {
...
// Fall back to parent node
    while (tmp == core::ptr::null_mut() && cur.flc_blocker != core::ptr::null_mut()) {
    cur = cur.flc_blocker;
    level--;
    tmp = get_next_blocked_member(cur);
    }
...
#[no_mangle]
unsafe extern "C" fn locks_stop(f: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn proc_locks_init() -> int __init {
    static int __init proc_locks_init(void)
    {
    proc_create_seq_private("locks", 0, core::ptr::null_mut(), &locks_seq_operations,
    sizeof(struct locks_iterator), core::ptr::null_mut());
    return 0;
    }
    fs_initcall(proc_locks_init);

#[no_mangle]
unsafe extern "C" fn filelock_init() -> int __init {
    static int __init filelock_init(void)
    {
    int i;
    flctx_cache = kmem_cache_create("file_lock_ctx",
    sizeof(struct file_lock_context), 0, SLAB_PANIC, core::ptr::null_mut());
    filelock_cache = kmem_cache_create("file_lock_cache",
    sizeof(struct file_lock), 0, SLAB_PANIC, core::ptr::null_mut());
    filelease_cache = kmem_cache_create("file_lease_cache",
    sizeof(struct file_lease), 0, SLAB_PANIC, core::ptr::null_mut());
