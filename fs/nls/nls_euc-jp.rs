...
// JIS X 0208 (include NEC special characters)
    ...
    out[1] = out[1] + 0x61;
#[no_mangle]
pub unsafe extern "C" fn if(0x9F: out[1] <) -> else {
    else if (out[1] < 0x9F)
    out[1] = out[1] + 0x60;
    else
    out[1] = out[1] + 0x02;
...
#[no_mangle]
pub unsafe extern "C" fn if(0xE0: rawstring[1] <) -> else {
...
#[no_mangle]
unsafe extern "C" fn init_nls_euc_jp() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_nls_euc_jp() -> void __exit {
