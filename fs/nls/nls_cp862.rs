...
// 0xf0
    ...
    page00, page01, core::ptr::null_mut(),   page03, core::ptr::null_mut(),   page05, core::ptr::null_mut(),   core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn init_nls_cp862() -> int __init {
    static int __init init_nls_cp862(void)
    {
    return register_nls(&table);
    }
#[no_mangle]
unsafe extern "C" fn exit_nls_cp862() -> void __exit {
