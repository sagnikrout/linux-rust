...
pub const UNICODE_MAX: c_uint = 0x0010ffff;
...
#[no_mangle]
pub unsafe extern "C" fn utf8_to_utf32(s: *const u8, inlen: c_int, pu: *mut unicode_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn utf32_to_utf8(u: unicode_t, s: *mut u8, maxout: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn put_utf16(s: *mut wchar_t, c: unsigned, endian: enum utf16_endian) {
...
#[no_mangle]
pub unsafe extern "C" fn get_utf16(c: unsigned, endian: enum utf16_endian) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn __register_nls(nls: *mut nls_table, owner: *mut module) -> c_int {
    int __register_nls(struct nls_table *nls, struct module *owner)
    {
    let mut tmp: *mut *mut nls_table = &tables;
    if (nls.next)
    return -EBUSY;
    nls.owner = owner;
    spin_lock(&nls_lock);
...
#[no_mangle]
pub unsafe extern "C" fn unregister_nls(nls: *mut *mut nls_table) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unload_nls(nls: *mut nls_table) {
...
unsafe extern "C" fn uni2char(uni: wchar_t, out: *mut c_uchar, boundlen: c_int) -> c_int {
    ...
    let mut cl: c_uchar = uni & 0x00ff;
    let mut ch: c_uchar = (uni & 0xff00) >> 8;
    if (boundlen <= 0)
    return -ENAMETOOLONG;
...
// Returns a simple default translation table
    ...
    if (default_nls != core::ptr::null_mut())
    return default_nls;
    else
