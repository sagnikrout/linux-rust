...
#[no_mangle]
unsafe extern "C" fn ovl_whatisit(inode: *mut inode, realinode: *mut inode) -> c_char {
...
#[no_mangle]
unsafe extern "C" fn ovl_change_flags(file: *mut file, flags: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_file_free(of: *mut ovl_file) {
...
// Store the upperfile for later
    old = cmpxchg_release(&of.upperfile, core::ptr::null_mut(), upperfile);
...
// Did the flags change since open?
    ...
    let mut err: c_int = ovl_change_flags(realfile, file.f_flags);
    if (err)
    return ERR_PTR(err);
    }
    return realfile;
...
#[no_mangle]
unsafe extern "C" fn ovl_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn ovl_file_modified(file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn ovl_file_end_write(iocb: *mut kiocb, ret: isize) {
    static void ovl_file_end_write(struct kiocb *iocb, ssize_t ret)
    {
    ovl_file_modified(iocb.ki_filp);
    }
#[no_mangle]
unsafe extern "C" fn ovl_file_accessed(file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn ovl_read_iter(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ovl_write_iter(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    ...
    struct file *realfile;
    ssize_t ret;
    let mut ifl: c_int = iocb.ki_flags;
    struct backing_file_ctx ctx = {
...
#[no_mangle]
unsafe extern "C" fn ovl_fsync(file: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_fallocate(file: *mut file, mode: c_int, offset: loff_t, len: loff_t) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ovl_fadvise(file: *mut file, offset: loff_t, len: loff_t, advice: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_flush(file: *mut file, id: fl_owner_t) -> c_int {
