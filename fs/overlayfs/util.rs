...
#[no_mangle]
pub unsafe extern "C" fn ovl_get_write_access(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_start_write(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_want_write(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_put_write_access(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_end_write(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_drop_write(dentry: *mut dentry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_can_decode_fh(sb: *mut super_block) -> c_int {
    ...
    {
    struct ovl_fs *ofs = OVL_FS(sb);
    return ofs.config.index ? ofs.workdir : core::ptr::null_mut();
    }
// Index all files on copy up. For now only enabled for NFS export
#[no_mangle]
pub unsafe extern "C" fn ovl_index_all(sb: *mut super_block) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_verify_lower(sb: *mut super_block) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_stack_cpy(dst: *mut ovl_path, src: *mut ovl_path, n: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_stack_put(stack: *mut ovl_path, n: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_stack_free(stack: *mut ovl_path, n: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_free_entry(oe: *mut ovl_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_remote(dentry: *mut dentry) -> bool {
    bool ovl_dentry_remote(struct dentry *dentry)
    {
    return dentry.d_flags & OVL_D_REVALIDATE;
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_update_reval(dentry: *mut dentry, realdentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_weird(dentry: *mut dentry) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_type(dentry: *mut dentry) -> enum ovl_path_type {
    enum ovl_path_type ovl_path_type(struct dentry *dentry)
    {
    struct ovl_entry *oe = OVL_E(dentry);
    let mut type: enum ovl_path_type = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_upper(dentry: *mut dentry, path: *mut path) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_lower(dentry: *mut dentry, path: *mut path) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_lowerdata(dentry: *mut dentry, path: *mut path) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_real(dentry: *mut dentry, path: *mut path) -> enum ovl_path_type {
    enum ovl_path_type ovl_path_real(struct dentry *dentry, struct path *path)
    {
    let mut type: enum ovl_path_type = ovl_path_type(dentry);
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_realdata(dentry: *mut dentry, path: *mut path) -> enum ovl_path_type {
    ...
    return inode ? ovl_upperdentry_dereference(OVL_I(inode)) : core::ptr::null_mut();
    }
    struct dentry *ovl_dentry_lower(struct dentry *dentry)
    {
    struct ovl_entry *oe = OVL_E(dentry);
    return ovl_numlower(oe) ? ovl_lowerstack(oe).dentry : core::ptr::null_mut();
    }
    const struct ovl_layer *ovl_layer_lower(struct dentry *dentry)
    {
    struct ovl_entry *oe = OVL_E(dentry);
    return ovl_numlower(oe) ? ovl_lowerstack(oe).layer : core::ptr::null_mut();
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_set_lowerdata(dentry: *mut dentry, datapath: *mut ovl_path) -> c_int {
...
//
    ...
    return path.dentry ? d_inode_rcu(path.dentry) : core::ptr::null_mut();
    }
    struct inode *ovl_inode_upper(struct inode *inode)
    {
    struct dentry *upperdentry = ovl_i_dentry_upper(inode);
    return upperdentry ? d_inode(upperdentry) : core::ptr::null_mut();
    }
    struct inode *ovl_inode_lower(struct inode *inode)
    {
    struct ovl_path *lowerpath = ovl_lowerpath(OVL_I_E(inode));
    return lowerpath ? d_inode(lowerpath.dentry) : core::ptr::null_mut();
    }
...
// Return inode which contains lower data. Do not return metacopy
    ...
    return lowerdata ? d_inode(lowerdata) : core::ptr::null_mut();
    }
// Return real inode which contains data. Does not return metacopy inode
    ...
    OVL_I(inode).lowerdata_redirect : core::ptr::null_mut();
    }
    struct ovl_dir_cache *ovl_dir_cache(struct inode *inode)
    {
    return inode && S_ISDIR(inode.i_mode) ? OVL_I(inode).cache : core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_set_dir_cache(inode: *mut inode, cache: *mut ovl_dir_cache) {
    void ovl_set_dir_cache(struct inode *inode, struct ovl_dir_cache *cache)
    {
    OVL_I(inode).cache = cache;
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_set_flag(flag: c_ulong, dentry: *mut dentry) {
    void ovl_dentry_set_flag(unsigned long flag, struct dentry *dentry)
    {
    set_bit(flag, OVL_E_FLAGS(dentry));
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_clear_flag(flag: c_ulong, dentry: *mut dentry) {
    void ovl_dentry_clear_flag(unsigned long flag, struct dentry *dentry)
    {
    clear_bit(flag, OVL_E_FLAGS(dentry));
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_test_flag(flag: c_ulong, dentry: *mut dentry) -> bool {
    bool ovl_dentry_test_flag(unsigned long flag, struct dentry *dentry)
    {
    return test_bit(flag, OVL_E_FLAGS(dentry));
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_is_opaque(dentry: *mut dentry) -> bool {
    bool ovl_dentry_is_opaque(struct dentry *dentry)
    {
    return ovl_dentry_test_flag(OVL_E_OPAQUE, dentry);
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_is_whiteout(dentry: *mut dentry) -> bool {
    bool ovl_dentry_is_whiteout(struct dentry *dentry)
    {
    return !dentry.d_inode && ovl_dentry_is_opaque(dentry);
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_set_opaque(dentry: *mut dentry) {
    void ovl_dentry_set_opaque(struct dentry *dentry)
    {
    ovl_dentry_set_flag(OVL_E_OPAQUE, dentry);
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_has_xwhiteouts(dentry: *mut dentry) -> bool {
    bool ovl_dentry_has_xwhiteouts(struct dentry *dentry)
    {
    return ovl_dentry_test_flag(OVL_E_XWHITEOUTS, dentry);
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_set_xwhiteouts(dentry: *mut dentry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_has_upper_alias(dentry: *mut dentry) -> bool {
    bool ovl_dentry_has_upper_alias(struct dentry *dentry)
    {
    return ovl_dentry_test_flag(OVL_E_UPPER_ALIAS, dentry);
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_set_upper_alias(dentry: *mut dentry) {
    void ovl_dentry_set_upper_alias(struct dentry *dentry)
    {
    ovl_dentry_set_flag(OVL_E_UPPER_ALIAS, dentry);
    }
#[no_mangle]
unsafe extern "C" fn ovl_should_check_upperdata(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_has_upperdata(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_set_upperdata(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_needs_data_copy_up_locked(dentry: *mut dentry, flags: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_needs_data_copy_up(dentry: *mut dentry, flags: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_dentry_set_redirect(dentry: *mut dentry, redirect: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_inode_update(inode: *mut inode, upperdentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn ovl_dir_version_inc(dentry: *mut dentry, impurity: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_dir_modified(dentry: *mut dentry, impurity: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_inode_version_get(inode: *mut inode) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_is_whiteout(dentry: *mut dentry) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_path_is_whiteout(ofs: *mut ovl_fs, path: *const path) -> bool {
...
// Caller should hold ovl_inode->lock
#[no_mangle]
unsafe extern "C" fn ovl_already_copied_up_locked(dentry: *mut dentry, flags: c_int) -> bool {
    static bool ovl_already_copied_up_locked(struct dentry *dentry, int flags)
    {
    let mut disconnected: bool = dentry.d_flags & DCACHE_DISCONNECTED;
    if (ovl_dentry_upper(dentry) &&
...
#[no_mangle]
pub unsafe extern "C" fn ovl_already_copied_up(dentry: *mut dentry, flags: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_copy_up_start(dentry: *mut dentry, flags: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_copy_up_end(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_check_origin_xattr(ofs: *mut ovl_fs, path: *const path) -> bool {
    bool ovl_path_check_origin_xattr(struct ovl_fs *ofs, const struct path *path)
    {
    int res;
    res = ovl_path_getxattr(ofs, path, OVL_XATTR_ORIGIN, core::ptr::null_mut(), 0);
...
#[no_mangle]
pub unsafe extern "C" fn ovl_path_check_xwhiteout_xattr(ofs: *mut ovl_fs, path: *const path) -> bool {
...
// xattr.whiteout must be a zero size regular file
    ...
    return false;
    res = ovl_path_getxattr(ofs, path, OVL_XATTR_XWHITEOUT, core::ptr::null_mut(), 0);
    return res >= 0;
    }
//
...
//
    ...
    res = ovl_path_getxattr(ofs, upperpath, OVL_XATTR_IMPURE, core::ptr::null_mut(),
    0);
    if (res > 0) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_set_impure(dentry: *mut dentry, upperdentry: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_check_protattr(inode: *mut inode, upper: *mut dentry) {
    void ovl_check_protattr(struct inode *inode, struct dentry *upper)
    {
    struct ovl_fs *ofs = OVL_FS(inode.i_sb);
    let mut iflags: u32 = inode.i_flags & OVL_PROT_I_FLAGS_MASK;
...
//
    ...
    iflags |= S_APPEND;
#[no_mangle]
pub unsafe extern "C" fn if('i': buf[n] ==) -> else {
    else if (buf[n] == 'i')
    iflags |= S_IMMUTABLE;
    else
    break;
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_inuse_trylock(dentry: *mut dentry) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_inuse_unlock(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_is_inuse(dentry: *mut dentry) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_need_index(dentry: *mut dentry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ovl_cleanup_index(dentry: *mut dentry) {
    ...
    struct dentry *index = core::ptr::null_mut();
    struct inode *inode;
    let mut name: qstr = { };
    let mut got_write: bool = false;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_nlink_start(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_nlink_end(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_set_metacopy_xattr(ofs: *mut ovl_fs, d: *mut dentry, metacopy: *mut ovl_metacopy) -> c_int {
    int ovl_set_metacopy_xattr(struct ovl_fs *ofs, struct dentry *d, struct ovl_metacopy *metacopy)
    {
    let mut len: usize = metacopy.len;
...
#[no_mangle]
pub unsafe extern "C" fn ovl_is_metacopy_dentry(dentry: *mut dentry) -> bool {
    ...
    {
    int res;
    char *s, *next, *buf = core::ptr::null_mut();
    res = ovl_path_getxattr(ofs, path, OVL_XATTR_REDIRECT, core::ptr::null_mut(), 0);
    if (res == -ENODATA || res == -EOPNOTSUPP)
    return core::ptr::null_mut();
    if (res < 0)
    goto fail;
    ...
    if (strchr(buf, '/') != core::ptr::null_mut())
    goto invalid;
    }
    return buf;
    invalid:
...
#[no_mangle]
pub unsafe extern "C" fn ovl_ensure_verity_loaded(datapath: *const path) -> c_int {
    int ovl_ensure_verity_loaded(const struct path *datapath)
    {
    struct inode *inode = d_inode(datapath.dentry);
    struct file *filp;
    if (IS_VERITY(inode) && fsverity_get_info(inode) == core::ptr::null_mut()) {
//
...
// Verity only works on regular files
    ...
    metacopy.digest, &metacopy.digest_algo, core::ptr::null_mut());
    if (digest_size == 0 ||
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_sync_status(ofs: *mut ovl_fs) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ovl_copyattr(inode: *mut inode) {
