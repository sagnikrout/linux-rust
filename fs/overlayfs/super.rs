...
#[no_mangle]
unsafe extern "C" fn ovl_revalidate_real(d: *mut dentry, flags: c_uint, weak: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_dentry_weak_revalidate(dentry: *mut dentry, flags: c_uint) -> c_int {
    ...
    oi.cache = core::ptr::null_mut();
    oi.redirect = core::ptr::null_mut();
    oi.version = 0;
    oi.flags = 0;
    oi.__upperdentry = core::ptr::null_mut();
    oi.lowerdata_redirect = core::ptr::null_mut();
    oi.oe = core::ptr::null_mut();
    mutex_init(&oi.lock);
    return &oi.vfs_inode;
    }
#[no_mangle]
unsafe extern "C" fn ovl_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn ovl_destroy_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn ovl_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ovl_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ovl_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
// Clear any inherited mode bits
    ...
    let mut err: c_int = vfs_statfs(path, &statfs);
    if (err)
...
//
#[no_mangle]
unsafe extern "C" fn ovl_workdir_ok(workdir: *mut dentry, upperdir: *mut dentry) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ovl_report_in_use(ofs: *mut ovl_fs, name: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ovl_check_rename_whiteout(ofs: *mut ovl_fs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ovl_create_volatile_dirty(ofs: *mut ovl_fs) -> c_int {
...
// index dir will act also as workdir
    ...
    ofs.workdir_trap = core::ptr::null_mut();
    dput(ofs.workdir);
    ofs.workdir = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ovl_lower_uuid_ok(ofs: *mut ovl_fs, uuid: *const uuid_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ovl_get_fsid(ofs: *mut ovl_fs, path: *const path) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ovl_get_data_fsid(ofs: *mut ovl_fs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ovl_set_encoding(sb: *mut super_block, fs_sb: *mut super_block) -> c_int {
...
//
    ...
    let mut ino: c_ulong = d_inode(lowerpath.dentry).i_ino;
    let mut fsid: c_int = lowerpath.layer.fsid;
...
#[no_mangle]
unsafe extern "C" fn ovl_set_d_op(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ovl_fill_super_creds(fc: *mut fs_context, sb: *mut super_block) -> c_int {
    ...
    struct ovl_layer *layers;
    struct ovl_entry *oe = core::ptr::null_mut();
    int err;
...
//
    ...
    ctx.lowerdir_all = core::ptr::null_mut();
    ofs.numlayer = 1;
    sb.s_stack_depth = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !ofs->nofh) -> else {
    else if (!ofs.nofh)
...
#[no_mangle]
pub unsafe extern "C" fn ovl_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_inode_init_once(foo: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ovl_init() -> int __init {
    ...
    SLAB_ACCOUNT),
    ovl_inode_init_once);
    if (ovl_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn ovl_exit() -> void __exit {
