...
#[no_mangle]
unsafe extern "C" fn ovl_is_escaped_xattr(sb: *mut super_block, name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ovl_is_own_xattr(sb: *mut super_block, name: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_is_private_xattr(sb: *mut super_block, name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ovl_can_list(sb: *mut super_block, s: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_listxattr(dentry: *mut dentry, list: *mut c_char, size: usize) -> isize {
...
// filter out private xattrs
    ...
    let mut slen: usize = strnlen(s, len) + 1;
