...
//
    ...
    let mut full_copy_up: bool = false;
...
// Truncate should trigger data copy up as well
    ...
    if (!err) {
    struct inode *winode = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ovl_map_dev_ino(dentry: *mut dentry, stat: *mut kstat, fsid: c_int) {
    static void ovl_map_dev_ino(struct dentry *dentry, struct kstat *stat, int fsid)
    {
    struct ovl_fs *ofs = OVL_FS(dentry.d_sb);
    let mut samefs: bool = ovl_same_fs(ofs);
    let mut xinobits: c_uint = ovl_xino_bits(ofs);
...
//
    ...
    let mut is_dir: bool = S_ISDIR(inode.i_mode);
    let mut fsid: c_int = 0;
    int err;
    let mut metacopy_blocks: bool = false;
    vfsuid_t vfsuid;
    vfsgid_t vfsgid;
...
//
    ...
    let mut lowermask: u32 = STATX_BLOCKS;
...
//
    ...
    let mut iattr: iattr = { .ia_valid = ATTR_KILL_SGID };
...
#[no_mangle]
pub unsafe extern "C" fn ovl_real_fileattr_set(realpath: *const path, fa: *mut file_kattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_fileattr_prot_flags(inode: *mut inode, fa: *mut file_kattr) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_real_fileattr_get(realpath: *const path, fa: *mut file_kattr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_lockdep_annotate_inode_mutex_key(inode: *mut inode) {
    ...
    let mut depth: c_int = inode.i_sb.s_stack_depth - 1;
...
#[no_mangle]
unsafe extern "C" fn ovl_next_ino(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn ovl_map_ino(inode: *mut inode, ino: c_ulong, fsid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ovl_fill_inode(inode: *mut inode, mode: umode_t, rdev: dev_t) {
...
#[no_mangle]
pub unsafe extern "C" fn ovl_set_nlink_upper(dentry: *mut dentry) -> c_int {
    int ovl_set_nlink_upper(struct dentry *dentry)
    {
    return ovl_set_nlink_common(dentry, ovl_dentry_upper(dentry), "U%+i");
    }
#[no_mangle]
pub unsafe extern "C" fn ovl_set_nlink_lower(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovl_inode_test(inode: *mut inode, data: *mut c_void) -> c_int {
    static int ovl_inode_test(struct inode *inode, void *data)
    {
    return inode.i_private == data;
    }
#[no_mangle]
unsafe extern "C" fn ovl_inode_set(inode: *mut inode, data: *mut c_void) -> c_int {
...
//
    ...
    if (!inode)
    return core::ptr::null_mut();
    if (!ovl_verify_inode(inode, is_upper ? core::ptr::null_mut() : real,
    is_upper ? real : core::ptr::null_mut(), false)) {
    iput(inode);
...
#[no_mangle]
pub unsafe extern "C" fn ovl_lookup_trap_inode(sb: *mut super_block, dir: *mut dentry) -> bool {
...
// Otherwise, hash by lower inode for fsnotify
    ...
    struct inode *realinode = upperdentry ? d_inode(upperdentry) : core::ptr::null_mut();
    struct inode *inode;
    struct dentry *lowerdentry = lowerpath ? lowerpath.dentry : core::ptr::null_mut();
    struct path realpath = {
    ...
    oip.index);
    let mut fsid: c_int = bylower ? lowerpath.layer.fsid : 0;
    bool is_dir;
    let mut ino: c_ulong = 0;
    let mut err: c_int = oip.newinode ? -EEXIST : -ENOMEM;
    if (!realinode)
...
//
    ...
    upperdentry);
    let mut nlink: c_uint = is_dir ? 1 : realinode.i_nlink;
