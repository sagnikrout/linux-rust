...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs_createdata {
    pub arg: nfs_createargs,
    pub res: nfs_diropok,
    pub fhandle: nfs_fh,
    pub fattr: nfs_fattr,
}
...
#[no_mangle]
unsafe extern "C" fn nfs_free_createdata(data: *const nfs_createdata) {
...
#[no_mangle]
unsafe extern "C" fn nfs_proc_unlink_rpc_prepare(task: *mut rpc_task, data: *mut nfs_unlinkdata) {
    static void nfs_proc_unlink_rpc_prepare(struct rpc_task *task, struct nfs_unlinkdata *data)
    {
    rpc_call_start(task);
    }
#[no_mangle]
unsafe extern "C" fn nfs_proc_unlink_done(task: *mut rpc_task, dir: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_proc_rename_rpc_prepare(task: *mut rpc_task, data: *mut nfs_renamedata) {
    ...
    status = -ENOMEM;
    if (fh == core::ptr::null_mut() || fattr == core::ptr::null_mut())
    goto out_free;
    status = rpc_call_sync(NFS_CLIENT(dir), &msg, 0);
    nfs_mark_for_revalidate(dir);
//
...
//
    ...
    struct dentry *alias = core::ptr::null_mut();
    let mut status: c_int = -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn nfs_read_done(task: *mut rpc_task, hdr: *mut nfs_pgio_header) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_write_done(task: *mut rpc_task, hdr: *mut nfs_pgio_header) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_proc_commit_rpc_prepare(task: *mut rpc_task, data: *mut nfs_commit_data) {
    ...
    return nlmclnt_proc(NFS_SERVER(inode).nlm_host, cmd, fl, core::ptr::null_mut());
    }
// Helper functions for NFS lock bounds checking

#[no_mangle]
unsafe extern "C" fn nfs_lock_check_bounds(fl: *const file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_have_delegation(inode: *mut inode, type: fmode_t, flags: c_int) -> c_int {
    static int nfs_have_delegation(struct inode *inode, fmode_t type, int flags)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nfs_return_delegation(inode: *mut inode) {
    ...
    .access		= core::ptr::null_mut(),		       /* access */
