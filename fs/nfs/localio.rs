...
pub const NFSLOCAL_MAX_IOS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs_local_kiocb {
    ...
    pub ): *mut *mut void (aio_complete_work)(struct work_struct,
    pub localio: *mut nfsd_file,
// Begin mostly DIO-specific members
    pub end_len: usize,
    pub end_iter_index: short int,
    pub n_iters: core::sync::atomic::AtomicI32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs_local_fsync_ctx {
    pub localio: *mut nfsd_file,
    pub data: *mut nfs_commit_data,
    pub work: work_struct,
}

    let mut __read_mostly: static bool localio_enabled = true;
    ...
    const struct rpc_call_ops *call_ops);
#[no_mangle]
pub unsafe extern "C" fn nfs_client_is_local(clp: *const nfs_client) -> bool {
    static inline bool nfs_client_is_local(const struct nfs_client *clp)
    {
    return !!rcu_access_pointer(clp.cl_uuid.net);
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_server_is_local(clp: *const nfs_client) -> bool {
...
// void return
    ...
    let mut nfslocalio_rpcstat: static struct rpc_stat = { &nfslocalio_program };
...
#[no_mangle]
unsafe extern "C" fn nfs_server_uuid_is_local(clp: *mut nfs_client) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_local_probe(clp: *mut nfs_client) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_local_probe_async(clp: *mut nfs_client) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_local_file_put(localio: *mut nfsd_file) {
...
//
    ...
    {
    let mut gfp_mask: gfp_t = mapping_gfp_mask(m);
    ...
    if (iocb.bvec == core::ptr::null_mut()) {
    kfree(iocb);
    return core::ptr::null_mut();
    }
    ...
    iocb.kiocb.ki_complete = core::ptr::null_mut();
    iocb.aio_complete_work = core::ptr::null_mut();
    ...
    let mut offset: loff_t = hdr.args.offset;
...
#[no_mangle]
unsafe extern "C" fn nfs_local_pgio_done(iocb: *mut nfs_local_kiocb, status: c_long) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_pgio_release(iocb: *mut nfs_local_kiocb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_local_pgio_aio_complete(iocb: *mut nfs_local_kiocb) {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_read_done(iocb: *mut nfs_local_kiocb) {
    static void nfs_local_read_done(struct nfs_local_kiocb *iocb)
    {
    struct nfs_pgio_header *hdr = iocb.hdr;
    struct file *filp = iocb.kiocb.ki_filp;
    let mut status: c_long = hdr.task.tk_status;
...
#[no_mangle]
pub unsafe extern "C" fn nfs_local_read_iocb_done(iocb: *mut nfs_local_kiocb) {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_read_aio_complete_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_read_aio_complete(kiocb: *mut kiocb, ret: c_long) {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_call_read(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_local_defer_io() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __vfs_getattr(p: *const path, stat: *mut kstat, version: c_int) -> c_int {
    static int __vfs_getattr(const struct path *p, struct kstat *stat, int version)
    {
    let mut request_mask: u32 = STATX_BASIC_STATS;
    if (version == 4)
...
#[no_mangle]
unsafe extern "C" fn nfs_local_vfs_getattr(iocb: *mut nfs_local_kiocb) {
    ...
    let mut version: c_int = NFS_PROTO(hdr.inode).version;
...
#[no_mangle]
unsafe extern "C" fn nfs_local_write_done(iocb: *mut nfs_local_kiocb) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_local_write_iocb_done(iocb: *mut nfs_local_kiocb) {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_write_aio_complete_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_write_aio_complete(kiocb: *mut kiocb, ret: c_long) {
...
#[no_mangle]
unsafe extern "C" fn nfs_local_call_write(work: *mut work_struct) {
...
// Break on completion, errors, or short writes
    ...
    {
    let mut start: loff_t = data.args.offset;
    let mut end: loff_t = LLONG_MAX;
