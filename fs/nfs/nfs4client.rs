...
//
#[no_mangle]
unsafe extern "C" fn nfs_get_cb_ident_idr(clp: *mut nfs_client, minorversion: c_int) -> c_int {
...
pub struct nfs4_ds_server {
    pub /: *mut *mut list_head list; / ds_clp->cl_ds_clients,
...
//
    ...
    let mut flavor: rpc_authflavor_t = NFS_SERVER(inode).client.cl_auth.au_flavor;
...
#[no_mangle]
pub unsafe extern "C" fn nfs41_shutdown_client(clp: *mut nfs_client) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs4_destroy_callback(clp: *mut nfs_client) {
...
#[no_mangle]
unsafe extern "C" fn nfs4_shutdown_client(clp: *mut nfs_client) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs4_free_client(clp: *mut nfs_client) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs4_init_callback(clp: *mut nfs_client) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs41_init_client(clp: *mut nfs_client) -> c_int {
    int nfs41_init_client(struct nfs_client *clp)
    {
    struct nfs4_session *session = core::ptr::null_mut();
//
...
//
#[no_mangle]
unsafe extern "C" fn nfs4_init_client_minor_version(clp: *mut nfs_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs4_add_trunk(clp: *mut nfs_client, old: *mut nfs_client) {
...
//
    ...
    {
    if (clp1.cl_owner_id == core::ptr::null_mut() || clp2.cl_owner_id == core::ptr::null_mut())
    return true;
...
#[no_mangle]
unsafe extern "C" fn nfs4_destroy_server(server: *mut nfs_server) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs4_session_limit_rwsize(server: *mut nfs_server) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs4_session_limit_xasize(server: *mut nfs_server) {
...
// Probe the root fh to retrieve its FSID and filehandle
    ...
    kfree(server.delegation_hash_table);
    server.delegation_hash_table = core::ptr::null_mut();
    return error;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn nfs4_init_server(server: *mut nfs_server, fc: *mut fs_context) -> c_int {
...
// cel: bleh. We might need to pass TLS parameters here
    ...
    nfs_put_client(clp);
    if (server.nfs_client.cl_hostname == core::ptr::null_mut()) {
