...
//
    ...
    let mut nfs_mountpoint_expiry_timeout: c_int = 500 * HZ;
//
...
//
    ...
    let mut s_flags: c_ulong = path.dentry.d_sb.s_flags;
    let mut timeout: c_int = READ_ONCE(nfs_mountpoint_expiry_timeout);
    int ret;
