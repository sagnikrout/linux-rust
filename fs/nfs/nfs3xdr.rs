...
//
#[no_mangle]
unsafe extern "C" fn encode_uint32(xdr: *mut xdr_stream, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn decode_uint32(xdr: *mut xdr_stream, value: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_uint64(xdr: *mut xdr_stream, value: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_fileid3(xdr: *mut xdr_stream, fileid: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_nfspath3(xdr: *mut xdr_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_cookie3(xdr: *mut xdr_stream, cookie: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_cookieverf3(xdr: *mut xdr_stream, verifier: *mut __be32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn encode_createverf3(xdr: *mut xdr_stream, verifier: *const __be32) {
...
#[no_mangle]
unsafe extern "C" fn decode_writeverf3(xdr: *mut xdr_stream, verifier: *mut nfs_write_verifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_nfsstat3(xdr: *mut xdr_stream, status: *mut enum nfs_stat) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn encode_ftype3(xdr: *mut xdr_stream, type: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn encode_specdata3(xdr: *mut xdr_stream, rdev: dev_t) {
...
//
#[no_mangle]
unsafe extern "C" fn encode_nfs_fh3(xdr: *mut xdr_stream, fh: *const nfs_fh) {
...
#[no_mangle]
unsafe extern "C" fn decode_nfs_fh3(xdr: *mut xdr_stream, fh: *mut nfs_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zero_nfs_fh3(fh: *mut nfs_fh) {
...
//
#[no_mangle]
unsafe extern "C" fn decode_wcc_attr(xdr: *mut xdr_stream, fattr: *mut nfs_fattr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn decode_pre_op_attr(xdr: *mut xdr_stream, fattr: *mut nfs_fattr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn decode_post_op_fh3(xdr: *mut xdr_stream, fh: *mut nfs_fh) -> c_int {
...
//
    ...
    const struct nfs3_readdirargs *args)
    {
    let mut dircount: u32 = args.count;
    let mut maxcount: u32 = args.count;
    __be32 *p;
    encode_nfs_fh3(xdr, args.fh);
...
// p = cpu_to_be32(args->count);
    ...
    (args.mask & NFS_ACL) ?
    args.acl_access : core::ptr::null_mut(), 1, 0);
// FIXME: this is just broken
    BUG_ON(error < 0);
    error = nfsacl_encode(xdr.buf, base + error, args.inode,
    (args.mask & NFS_DFACL) ?
    args.acl_default : core::ptr::null_mut(), 1,
    NFS_ACL_DEFAULT);
    BUG_ON(error < 0);
    }
...
//
    ...
    if (unlikely(error))
    let mut error: return = = -ENAMETOOLONG ? -ENAMETOOLONG : -EAGAIN;
...
//
#[no_mangle]
unsafe extern "C" fn decode_dirlist3(xdr: *mut xdr_stream) -> c_int {
