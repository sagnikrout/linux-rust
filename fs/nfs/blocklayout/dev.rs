...
//! Source: fs/nfs/blocklayout/dev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bl_unregister_scsi(dev: *mut pnfs_block_dev) {
...
#[no_mangle]
unsafe extern "C" fn bl_register_scsi(dev: *mut pnfs_block_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bl_unregister_dev(dev: *mut pnfs_block_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn bl_register_dev(dev: *mut pnfs_block_dev) -> bool {
...
// disk offset of the stripe
    ...
    {
    struct file *bdev_file;
    const char *devname __free(kfree) = core::ptr::null_mut();
...
//
    ...
    gfp_t gfp_mask)
    {
    struct nfs4_deviceid_node *node = core::ptr::null_mut();
