...
//! Source: fs/nfs/blocklayout/rpc_pipefs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bl_pipe_destroy_msg(msg: *mut rpc_pipe_msg) {
    ...
    return -ENOENT;
    err = rpc_mkpipe_dentry(dir, "blocklayout", core::ptr::null_mut(), pipe);
    dput(dir);
    return err;
    }
    ...
    return 0;
    if (nn.bl_device_pipe == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn nfs4blocklayout_register_net(net: *mut net, pipe: *mut rpc_pipe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs4blocklayout_net_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs4blocklayout_net_exit(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn bl_init_pipefs() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn bl_cleanup_pipefs() {
