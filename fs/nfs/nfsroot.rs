...
// Address of NFS server
    let mut __initdata: static __be32 servaddr = htonl(INADDR_NONE);
...
//
#[no_mangle]
unsafe extern "C" fn nfs_root_debug(__unused: *mut c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_root_setup(line: *mut c_char) -> int __init {
    ...
    let mut n: usize = strlen(line) + sizeof(NFS_ROOT) - 1;
...
//
    if (incoming != core::ptr::null_mut() && *incoming != '\0')
...
//
#[no_mangle]
unsafe extern "C" fn root_nfs_data(cmdline: *mut c_char) -> int __init {
    static int __init root_nfs_data(char *cmdline)
    {
    char mand_options[sizeof("nolock,addr=") + INET_ADDRSTRLEN + 1];
    int len, retval = -1;
    char *tmp = core::ptr::null_mut();
    let mut tmplen: usize = sizeof(nfs_export_path);
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_root_data(root_device: *mut c_char, root_data: *mut c_char) -> int __init {
