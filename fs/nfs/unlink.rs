...
//
#[no_mangle]
unsafe extern "C" fn nfs_async_unlink_done(task: *mut rpc_task, calldata: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_async_unlink_release(calldata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nfs_unlink_prepare(task: *mut rpc_task, calldata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nfs_do_call_unlink(inode: *mut inode, data: *mut nfs_unlinkdata) {
...
#[no_mangle]
unsafe extern "C" fn nfs_call_unlink(dentry: *mut dentry, inode: *mut inode, data: *mut nfs_unlinkdata) -> c_int {
    ...
    int ret;
    void *devname_garbage = core::ptr::null_mut();
//
...
//
#[no_mangle]
unsafe extern "C" fn nfs_async_rename_done(task: *mut rpc_task, calldata: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_async_rename_release(calldata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nfs_rename_prepare(task: *mut rpc_task, calldata: *mut c_void) {
...
// set up nfs_renameres
    ...
    old_dir == new_dir ? old_dir : core::ptr::null_mut());
...
//
    if (IS_ERR(sdentry))
    goto out;
    } while (d_inode(sdentry) != core::ptr::null_mut()); /* need negative lookup */
    ihold(inode);
