...
#[no_mangle]
unsafe extern "C" fn register_nfs4_fs() -> int __init {
    static int __init register_nfs4_fs(void)
    {
    return register_filesystem(&nfs4_fs_type);
    }
#[no_mangle]
unsafe extern "C" fn unregister_nfs4_fs() {
...
#[no_mangle]
unsafe extern "C" fn nfs_ssc_register_ops() {
    static void nfs_ssc_register_ops(void)
    {
    nfs_ssc_register(&nfs_ssc_clnt_ops_tbl);
    }
#[no_mangle]
unsafe extern "C" fn nfs_ssc_unregister_ops() {
...
//
#[no_mangle]
pub unsafe extern "C" fn register_nfs_fs() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_nfs_fs() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_sb_active(sb: *mut super_block) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_sb_deactive(sb: *mut super_block) {
    ...
    {
    struct nfs_server *server, *last = core::ptr::null_mut();
    let mut ret: c_int = 0;
    rcu_read_lock();
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
    ...
    struct nfs_client *clp = nfss.nfs_client;
    let mut version: u32 = clp.rpc_ops.version;
...
#[no_mangle]
pub unsafe extern "C" fn if(local_fcntl: local_flock &&) -> else {
    else if (local_flock && local_fcntl)
    seq_puts(m, ",local_lock=all");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: local_flock) -> else {
    else if (local_flock)
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_lease(m: *mut seq_file, server: *mut nfs_server) {
...
#[no_mangle]
unsafe extern "C" fn show_sessions(m: *mut seq_file, server: *mut nfs_server) {
...
#[no_mangle]
unsafe extern "C" fn show_pnfs(m: *mut seq_file, server: *mut nfs_server) {
...
#[no_mangle]
unsafe extern "C" fn show_implementation_id(m: *mut seq_file, nfss: *mut nfs_server) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_show_devname(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_show_path(m: *mut seq_file, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_show_stats(m: *mut seq_file, root: *mut dentry) -> c_int {
    int nfs_show_stats(struct seq_file *m, struct dentry *root)
    {
    int i, cpu;
    struct nfs_server *nfss = NFS_SB(root.d_sb);
    struct rpc_auth *auth = nfss.client.cl_auth;
    let mut totals: nfs_iostats = { };
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_umount_begin(sb: *mut super_block) {
...
//
    ...
    let mut found_auth_null: bool = false;
    unsigned int i;
//
...
//
    ...
    int status;
    unsigned int i;
    let mut tried_auth_unix: bool = false;
    let mut auth_null_in_list: bool = false;
    struct nfs_server *server = ERR_PTR(-EACCES);
    rpc_authflavor_t authlist[NFS_MAX_SECFLAVORS];
    let mut authlist_len: c_uint = ARRAY_SIZE(authlist);
...
#[no_mangle]
pub unsafe extern "C" fn nfs_try_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_reconfigure(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_fill_super(sb: *mut super_block, ctx: *mut nfs_fs_context) {
...
#[no_mangle]
unsafe extern "C" fn nfs_set_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_compare_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_get_tree_common(fc: *mut fs_context) -> c_int {
    ...
    int error;
    ctx.server = core::ptr::null_mut();
    if (IS_ERR(server))
    return PTR_ERR(server);
    if (server.flags & NFS_MOUNT_UNSHARED)
    compare_super = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_kill_super(s: *mut super_block) {
...
// Default cache timeout is 10 minutes
    let mut nfs_idmap_cache_timeout: c_uint = 600;
// Turn off NFSv4 uid/gid mapping when using AUTH_SYS
    let mut nfs4_disable_idmapping: bool = true;
    let mut max_session_slots: c_ushort = NFS4_DEF_SLOT_TABLE_SIZE;
    let mut max_session_cb_slots: c_ushort = NFS4_DEF_CB_SLOT_TABLE_SIZE;
    let mut send_implementation_id: c_ushort = 1;
    char nfs4_client_id_uniquifier[NFS4_CLIENT_ID_UNIQ_LEN] = "";
    let mut recover_lost_locks: bool = false;
    let mut nfs_delay_retrans: c_short = -1;
