...
#[no_mangle]
pub unsafe extern "C" fn get_nfs_version(nfs: *mut nfs_subversion) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn put_nfs_version(nfs: *mut nfs_subversion) {
    void put_nfs_version(struct nfs_subversion *nfs)
    {
    module_put(nfs.owner);
    }
#[no_mangle]
pub unsafe extern "C" fn register_nfs_version(nfs: *mut nfs_subversion) {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_nfs_version(nfs: *mut nfs_subversion) {
    void unregister_nfs_version(struct nfs_subversion *nfs)
    {
    write_lock(&nfs_version_lock);
    nfs_version[nfs.rpc_ops.version] = core::ptr::null_mut();
    nfs_version_mods[nfs.rpc_ops.version] = core::ptr::null_mut();
    write_unlock(&nfs_version_lock);
    }
...
//
    ...
    if ((clp = kzalloc_obj(*clp)) == core::ptr::null_mut())
    goto error_0;
...
#[no_mangle]
unsafe extern "C" fn nfs_cleanup_cb_ident_idr(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nfs_cb_idr_remove_locked(clp: *mut nfs_client) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_cb_idr_remove(clp: *mut nfs_client) {
...
#[no_mangle]
unsafe extern "C" fn pnfs_init_server(server: *mut nfs_server) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_free_client(clp: *mut nfs_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_put_client(clp: *mut nfs_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_client_init_is_complete(clp: *const nfs_client) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_client_init_status(clp: *const nfs_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_wait_client_init_complete(clp: *const nfs_client) -> c_int {
...
//
    ...
    {
    struct nfs_client *clp, *new = core::ptr::null_mut();
    struct nfs_net *nn = net_generic(cl_init.net, nfs_net_id);
    const struct nfs_rpc_ops *rpc_ops = cl_init.nfs_mod.rpc_ops;
    if (cl_init.hostname == core::ptr::null_mut()) {
    WARN_ON(1);
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_mark_client_ready(clp: *mut nfs_client, state: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_destroy_server(server: *mut nfs_server) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_start_lockd(server: *mut nfs_server) -> c_int {
    ...
    nfs_sysfs_link_rpc_client(server, nlmclnt_rpc_clnt(host), core::ptr::null_mut());
    return 0;
    }
//
...
//
    ...
    nfs_sysfs_link_rpc_client(server, server.client, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn nfs4_server_set_init_caps(server: *mut nfs_server) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_server_set_init_caps(server: *mut nfs_server) {
...
// Preserve the values of mount_server-related mount options
    ...
    return 0;
    error:
    server.nfs_client = core::ptr::null_mut();
    nfs_put_client(clp);
    return error;
    }
//
...
// Work out a lot of parameters
    ...
    max_rpc_payload = nfs_block_size(raw_max_rpc_payload, core::ptr::null_mut());
    ...
    server.wtmult = nfs_block_bits(fsinfo.wtmult, core::ptr::null_mut());
    server.dtsize = nfs_block_size(fsinfo.dtpref, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn nfs_probe_fsinfo(server: *mut nfs_server, mntfh: *mut nfs_fh, fattr: *mut nfs_fattr) -> c_int {
    static int nfs_probe_fsinfo(struct nfs_server *server, struct nfs_fh *mntfh, struct nfs_fattr *fattr)
    {
    let mut pathinfo: nfs_pathconf = { };
    struct nfs_fsinfo fsinfo;
    struct nfs_client *clp = server.nfs_client;
    int error;
    if (clp.rpc_ops.set_capabilities != core::ptr::null_mut()) {
    ...
    let mut caps: c_uint = server.caps;
    ...
    if (clp.rpc_ops.discover_trunking != core::ptr::null_mut() &&
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_probe_server(server: *mut nfs_server, mntfh: *mut nfs_fh) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_server_copy_userdata(target: *mut nfs_server, source: *mut nfs_server) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_server_insert_lists(server: *mut nfs_server) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_server_remove_lists(server: *mut nfs_server) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_free_server(server: *mut nfs_server) {
    void nfs_free_server(struct nfs_server *server)
    {
    nfs_server_remove_lists(server);
    if (server.destroy != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn nfs_clients_init(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_clients_exit(net: *mut net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_server_list_stop(p: *mut seq_file, v: *mut c_void) {
    static void nfs_server_list_stop(struct seq_file *p, void *v)
...
//
#[no_mangle]
unsafe extern "C" fn nfs_server_list_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    static int nfs_server_list_show(struct seq_file *m, void *v)
    {
    struct nfs_client *clp;
    struct nfs_net *nn = net_generic(seq_file_net(m), nfs_net_id);
...
//
#[no_mangle]
unsafe extern "C" fn nfs_volume_list_stop(p: *mut seq_file, v: *mut c_void) {
    static void nfs_volume_list_stop(struct seq_file *p, void *v)
    __releases(&nn.nfs_client_lock)
    {
    struct nfs_net *nn = net_generic(seq_file_net(p), nfs_net_id);
...
//
#[no_mangle]
unsafe extern "C" fn nfs_volume_list_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    static int nfs_volume_list_show(struct seq_file *m, void *v)
    {
    struct nfs_server *server;
    struct nfs_client *clp;
...
#[no_mangle]
pub unsafe extern "C" fn nfs_fs_proc_net_init(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_fs_proc_net_exit(net: *mut net) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_fs_proc_init() -> int __init {
    int __init nfs_fs_proc_init(void)
    {
    if (!proc_mkdir("fs/nfsfs", core::ptr::null_mut()))
    goto error_0;
// a file of servers with which we're dealing
    if (!proc_symlink("fs/nfsfs/servers", core::ptr::null_mut(), "../../net/nfsfs/servers"))
    goto error_1;
// a file of volumes that we have mounted
    if (!proc_symlink("fs/nfsfs/volumes", core::ptr::null_mut(), "../../net/nfsfs/volumes"))
    goto error_1;
    return 0;
    error_1:
    remove_proc_subtree("fs/nfsfs", core::ptr::null_mut());
    error_0:
    return -ENOMEM;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_fs_proc_exit() {
