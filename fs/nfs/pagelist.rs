...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs_page_iter_page {
    pub req: *const nfs_page,
    pub count: usize,
}
...
#[no_mangle]
unsafe extern "C" fn nfs_page_iter_page_advance(i: *mut nfs_page_iter_page, sz: usize) {
    static void nfs_page_iter_page_advance(struct nfs_page_iter_page *i, size_t sz)
    {
    const struct nfs_page *req = i.req;
    let mut tmp: usize = i.count + sz;
    ...
    let mut base: usize = i.count + req.wb_pgbase;
    let mut len: usize = PAGE_SIZE - offset_in_page(base);
...
#[no_mangle]
pub unsafe extern "C" fn nfs_set_pgio_error(hdr: *mut nfs_pgio_header, error: c_int, pos: loff_t) {
    void nfs_set_pgio_error(struct nfs_pgio_header *hdr, int error, loff_t pos)
    {
    let mut new: c_uint = pos - hdr.io_start;
...
//
    ...
    rpc_sleep_on(&NFS_SERVER(inode).uoc_rpcwaitq, task, core::ptr::null_mut());
    ret = true;
    }
    if (atomic_read(&l_ctx.io_count) == 0) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_page_group_sync_on_bit_locked(req: *mut nfs_page, bit: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_page_group_sync_on_bit(req: *mut nfs_page, bit: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_page_assign_folio(req: *mut nfs_page, folio: *mut folio) {
    static void nfs_page_assign_folio(struct nfs_page *req, struct folio *folio)
    {
    if (folio != core::ptr::null_mut()) {
    req.wb_folio = folio;
    folio_get(folio);
...
#[no_mangle]
unsafe extern "C" fn nfs_page_assign_page(req: *mut nfs_page, page: *mut page) {
...
//
    ...
    nfs_page_group_init(ret, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_unlock_request(req: *mut nfs_page) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_unlock_and_release_request(req: *mut nfs_page) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_clear_request(req: *mut nfs_page) {
    ...
    if (folio != core::ptr::null_mut()) {
    folio_put(folio);
    req.wb_folio = core::ptr::null_mut();
    clear_bit(PG_FOLIO, &req.wb_flags);
    } else if (page != core::ptr::null_mut()) {
    put_page(page);
    req.wb_page = core::ptr::null_mut();
    }
    ...
    nfs_put_lock_context(l_ctx);
    req.wb_lock_context = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_free_request(req: *mut nfs_page) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_release_request(req: *mut nfs_page) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_pgio_data_destroy(hdr: *mut nfs_pgio_header) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_pgio_header_free(hdr: *mut nfs_pgio_header) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_pgio_prepare(task: *mut rpc_task, calldata: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_pgio_error(hdr: *mut nfs_pgio_header) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_pgio_release(calldata: *mut c_void) {
...
//
    ...
    desc.pg_error = 0;
    desc.pg_lseg = core::ptr::null_mut();
    desc.pg_io_completion = core::ptr::null_mut();
    desc.pg_dreq = core::ptr::null_mut();
    nfs_netfs_reset_pageio_descriptor(desc);
    desc.pg_bsize = bsize;
    desc.pg_mirror_count = 1;
    desc.pg_mirror_idx = 0;
    desc.pg_mirrors_dynamic = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn nfs_pgio_result(task: *mut rpc_task, calldata: *mut c_void) {
...
// last_page;
    ...
    let mut pg_base: c_uint = offset_in_page(mirror.pg_base);
    let mut gfp_flags: gfp_t = nfs_io_gfp_mask();
    ...
    while ((page = nfs_page_iter_page_get(&i)) != core::ptr::null_mut()) {
    if (last_page != page) {
    pageused++;
...
#[no_mangle]
unsafe extern "C" fn nfs_generic_pg_pgios(desc: *mut nfs_pageio_descriptor) -> c_int {
...
//
    ...
    if (pgio.pg_mirrors == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn nfs_pageio_cleanup_mirroring(pgio: *mut nfs_pageio_descriptor) {
    ...
    pgio.pg_mirrors_dynamic = core::ptr::null_mut();
    }
    ...
    const struct nfs_page *req)
    {
    let mut prev_end: usize = prev.wb_pgbase + prev.wb_bytes;
    if (req_offset(req) != req_offset(prev) + prev.wb_bytes)
    return false;
    if (req.wb_pgbase == 0)
    let mut prev_end: return = = nfs_page_max_length(prev);
    if (req.wb_pgbase == prev_end) {
    struct folio *folio = nfs_page_to_folio(req);
    if (folio)
    let mut folio: return = = nfs_page_to_folio(prev);
...
//
    ...
    {
    struct nfs_pgio_mirror *mirror = nfs_pgio_current_mirror(desc);
    struct nfs_page *prev = core::ptr::null_mut();
    unsigned int size;
...
//
#[no_mangle]
unsafe extern "C" fn nfs_pageio_doio(desc: *mut nfs_pageio_descriptor) {
    static void nfs_pageio_doio(struct nfs_pageio_descriptor *desc)
    {
    struct nfs_pgio_mirror *mirror = nfs_pgio_current_mirror(desc);
    if (!list_empty(&mirror.pg_list)) {
    let mut error: c_int = desc.pg_ops.pg_doio(desc);
    if (error < 0)
    desc.pg_error = error;
    if (list_empty(&mirror.pg_list))
...
#[no_mangle]
unsafe extern "C" fn nfs_do_recoalesce(desc: *mut nfs_pageio_descriptor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_pageio_error_cleanup(desc: *mut nfs_pageio_descriptor) {
...
//
    ...
    if (!list_empty(&pages)) {
    let mut err: c_int = desc.pg_error < 0 ? desc.pg_error : -EIO;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_pageio_complete(desc: *mut nfs_pageio_descriptor) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_pageio_cond_complete(desc: *mut nfs_pageio_descriptor, index: pgoff_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_pageio_stop_mirroring(pgio: *mut nfs_pageio_descriptor) {
    void nfs_pageio_stop_mirroring(struct nfs_pageio_descriptor *pgio)
    {
    nfs_pageio_complete(pgio);
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_init_nfspagecache() -> int __init {
    ...
    core::ptr::null_mut());
    if (nfs_page_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_destroy_nfspagecache() {
