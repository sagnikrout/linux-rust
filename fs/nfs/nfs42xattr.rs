...
//
pub const NFS4_XATTR_HASH_SIZE: c_int = 64;

    struct nfs4_xattr_cache;
    struct nfs4_xattr_entry;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs4_xattr_bucket {
    pub lock: spinlock_t,
    pub hlist: hlist_head,
    pub cache: *mut nfs4_xattr_cache,
    pub draining: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs4_xattr_cache {
    pub ref: kref,
    pub buckets: [nfs4_xattr_bucket; NFS4_XATTR_HASH_SIZE],
    pub lru: list_head,
    pub dispose: list_head,
    pub nent: atomic_long_t,
    pub listxattr_lock: spinlock_t,
    pub inode: *mut inode,
    pub listxattr: *mut nfs4_xattr_entry,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs4_xattr_entry {
    pub ref: kref,
    pub hnode: hlist_node,
    pub lru: list_head,
    pub dispose: list_head,
    pub xattr_name: *mut c_char,
    pub xattr_value: *mut c_void,
    pub xattr_size: usize,
    pub bucket: *mut nfs4_xattr_bucket,
    pub flags: u32,
}

pub const NFS4_XATTR_ENTRY_EXTVAL: c_uint = 0x0001;
//
...
//
    ...
    namep = core::ptr::null_mut();
    }
    if (flags & NFS4_XATTR_ENTRY_EXTVAL) {
    valp = kvmalloc(len, GFP_KERNEL);
    if (valp == core::ptr::null_mut()) {
    kfree(buf);
    return core::ptr::null_mut();
    }
    } else if (len != 0) {
    ...
    entry.bucket = core::ptr::null_mut();
    ...
    cache.listxattr = core::ptr::null_mut();
...
//
    ...
    cache.listxattr = new;
    if (new != core::ptr::null_mut() && new != ERR_PTR(-ESTALE))
...
//
    ...
    if (oldcache != core::ptr::null_mut()) {
    list_lru_del_obj(&nfs4_xattr_cache_lru, &oldcache.lru);
    oldcache.inode = core::ptr::null_mut();
    }
...
//
    ...
    nfsi = NFS_I(inode);
    cache = oldcache = core::ptr::null_mut();
    ...
    if (add && cache == core::ptr::null_mut()) {
    newcache = core::ptr::null_mut();
...
//
    if (nfsi.xattr_cache != core::ptr::null_mut()) {
...
//
    ...
    {
    struct nfs4_xattr_bucket *bucket;
    struct nfs4_xattr_entry *oldentry = core::ptr::null_mut();
    let mut ret: c_int = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs4_xattr_cache_list(inode: *mut inode, buf: *mut c_char, buflen: isize) -> isize {
    ...
    if (entry != core::ptr::null_mut() && entry != ERR_PTR(-ESTALE)) {
    if (buflen == 0) {
// Length probe only
    ret = entry.xattr_size;
...
//
    ...
    if (entry == core::ptr::null_mut())
    goto out;
    (void)nfs4_xattr_set_listcache(cache, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs4_xattr_cache_remove(inode: *mut inode, name: *const c_char) {
...
//
    ...
    if (cache == core::ptr::null_mut())
    return;
    entry = nfs4_xattr_alloc_entry(core::ptr::null_mut(), buf, core::ptr::null_mut(), buflen);
    if (entry == core::ptr::null_mut())
    goto out;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs4_xattr_cache_zap(inode: *mut inode) {
...
//
    ...
    return LRU_SKIP;
    kref_get(&cache.ref);
    cache.inode = core::ptr::null_mut();
    NFS_I(inode).xattr_cache = core::ptr::null_mut();
...
//
    if (entry.xattr_name != core::ptr::null_mut()) {
// Regular cache entry
...
#[no_mangle]
unsafe extern "C" fn nfs4_xattr_cache_init_once(p: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs4_xattr_cache_init() -> int __init {
    ...
    if (nfs4_xattr_cache_cachep == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn nfs4_xattr_cache_exit() {
