...
//! Source: fs/nfs/flexfilelayout/flexfilelayoutdev.c
#![no_std]
...
//
    ...
    let mut dataserver_timeo: static unsigned int = NFS_DEF_TCP_TIMEO;
    static unsigned int dataserver_retrans;
    static bool ff_layout_has_available_ds(struct pnfs_layout_segment *lseg);
#[no_mangle]
pub unsafe extern "C" fn nfs4_ff_layout_put_deviceid(mirror_ds: *mut nfs4_ff_layout_ds) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs4_ff_layout_free_deviceid(mirror_ds: *mut nfs4_ff_layout_ds) {
...
// Decode opaque device data and construct new_ds using it
    ...
    struct nfs4_ff_layout_ds *new_ds = core::ptr::null_mut();
    struct nfs4_ff_ds_version *ds_versions = core::ptr::null_mut();
...
// FIXME: For now assume there is only 1 version available for the DS
    ...
    u32 dss_id)
    {
    if (mirror == core::ptr::null_mut())
    goto outerr;
    if (mirror.dss[dss_id].mirror_ds == core::ptr::null_mut()) {
...
// check for race with another call to this function
    if (cmpxchg(&mirror.dss[dss_id].mirror_ds, core::ptr::null_mut(), mirror_ds) &&
...
#[no_mangle]
pub unsafe extern "C" fn ff_layout_free_ds_ioerr(head: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn ff_layout_encode_ds_ioerr(xdr: *mut xdr_stream, head: *const list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ff_read_layout_has_available_ds(lseg: *mut pnfs_layout_segment) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ff_rw_layout_has_available_ds(lseg: *mut pnfs_layout_segment) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ff_layout_has_available_ds(lseg: *mut pnfs_layout_segment) -> bool {
    static bool ff_layout_has_available_ds(struct pnfs_layout_segment *lseg)
    {
...
#[no_mangle]
pub unsafe extern "C" fn ff_layout_avoid_mds_available_ds(lseg: *mut pnfs_layout_segment) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ff_layout_avoid_read_on_rw(lseg: *mut pnfs_layout_segment) -> bool {
