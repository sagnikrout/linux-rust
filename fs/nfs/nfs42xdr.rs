...
// Macro flag: #define __LINUX_FS_NFS_NFS4_2XDR_H
...
// Not limited by NFS itself, limited by the generic xattr code
    ...
    2 /* offset */ + \
    2 /* length */)
pub const encode_io_info_maxsz: c_int = 4;
...
// XDR_UNIT);
    ...
    if (args.cp_src == core::ptr::null_mut()) { /* intra-ssc */
...
#[no_mangle]
unsafe extern "C" fn decode_allocate(xdr: *mut xdr_stream, res: *mut nfs42_falloc_res) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_nl4_server(xdr: *mut xdr_stream, ns: *mut nl4_server) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_copy(xdr: *mut xdr_stream, res: *mut nfs42_copy_res) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_deallocate(xdr: *mut xdr_stream, res: *mut nfs42_falloc_res) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct read_plus_segment {
    pub type: enum data_content4,
    pub offset: u64,
    union {
    struct {
    pub length: u64,
...
#[no_mangle]
pub unsafe extern "C" fn read_plus_segment_length(seg: *mut read_plus_segment) -> u64 {
    ...
    struct xdr_buf buf;
    let mut len: u32 = be32_to_cpup(p);
    seg.data.length = len;
    ...
    struct read_plus_segment *seg)
    {
    let mut offset: c_ulong = seg.offset;
    let mut length: c_ulong = read_plus_segment_length(seg);
    unsigned int bufpos;
    if (offset + length < args.offset)
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(args->count: offset > args->offset +) -> else {
    res.eof = 0;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn decode_read_plus(xdr: *mut xdr_stream, res: *mut nfs_pgio_res) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_seek(xdr: *mut xdr_stream, res: *mut nfs42_seek_res) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_layoutstats(xdr: *mut xdr_stream) -> c_int {
    static int decode_layoutstats(struct xdr_stream *xdr)
    {
    return decode_op_hdr(xdr, OP_LAYOUTSTATS);
    }
#[no_mangle]
unsafe extern "C" fn decode_clone(xdr: *mut xdr_stream) -> c_int {
    static int decode_clone(struct xdr_stream *xdr)
    {
    return decode_op_hdr(xdr, OP_CLONE);
    }
#[no_mangle]
unsafe extern "C" fn decode_layouterror(xdr: *mut xdr_stream) -> c_int {
