...
//
#[no_mangle]
unsafe extern "C" fn decode_nfsdata(xdr: *mut xdr_stream, result: *mut nfs_pgio_res) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn decode_stat(xdr: *mut xdr_stream, status: *mut enum nfs_stat) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn encode_fhandle(xdr: *mut xdr_stream, fh: *const nfs_fh) {
...
#[no_mangle]
unsafe extern "C" fn decode_fhandle(xdr: *mut xdr_stream, fh: *mut nfs_fh) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_ATIME: attr->ia_valid &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_MTIME: attr->ia_valid &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn encode_path(xdr: *mut xdr_stream, pages: *mut page, length: u32) {
...
#[no_mangle]
unsafe extern "C" fn decode_path(xdr: *mut xdr_stream) -> c_int {
...
//
    ...
    {
    let mut offset: u32 = args.offset;
    let mut count: u32 = args.count;
    __be32 *p;
    encode_fhandle(xdr, args.fh);
...
//
    ...
    void *result)
    {
    return decode_attrstat(xdr, result, core::ptr::null_mut(), rpc_rqst_userns(req));
    }
...
//
#[no_mangle]
unsafe extern "C" fn decode_readdirok(xdr: *mut xdr_stream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn decode_info(xdr: *mut xdr_stream, result: *mut nfs2_fsstat) -> c_int {
