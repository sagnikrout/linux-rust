...
#[no_mangle]
unsafe extern "C" fn nfs4_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
    static int nfs4_write_inode(struct inode *inode, struct writeback_control *wbc)
    {
    let mut ret: c_int = nfs_write_inode(inode, wbc);
    if (ret == 0)
...
//
#[no_mangle]
unsafe extern "C" fn nfs4_evict_inode(inode: *mut inode) {
    static void nfs4_evict_inode(struct inode *inode)
    {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfs_referral_count {
    pub list: list_head,
    pub task: *const task_struct,
    pub referral_count: c_uint,
}
...
pub const NFS_MAX_NESTED_REFERRALS: c_int = 2;
#[no_mangle]
unsafe extern "C" fn nfs_referral_loop_protect() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_referral_loop_unprotect() {
    ...
    root_fc.source = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nfs4_try_get_tree(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs4_get_referral_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_nfs_v4() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_nfs_v4() -> void __exit {
