...
pub struct nfs_io_completion {
    pub data): *mut *mut void (complete)(void,
    pub data: *mut c_void,
    pub refcount: kref,
}
...
#[no_mangle]
pub unsafe extern "C" fn nfs_commit_free(p: *mut nfs_commit_data) {
...
#[no_mangle]
unsafe extern "C" fn nfs_writehdr_free(hdr: *mut nfs_pgio_header) {
...
#[no_mangle]
unsafe extern "C" fn nfs_io_completion_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn nfs_io_completion_get(ioc: *mut nfs_io_completion) {
...
#[no_mangle]
unsafe extern "C" fn nfs_io_completion_put(ioc: *mut nfs_io_completion) {
...
#[no_mangle]
unsafe extern "C" fn nfs_cancel_remove_inode(req: *mut nfs_page, inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn nfs_set_pageerror(mapping: *mut address_space) {
...
#[no_mangle]
unsafe extern "C" fn nfs_mapping_set_error(folio: *mut folio, error: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_page_group_covers_page(req: *mut nfs_page) -> bool {
    static bool nfs_page_group_covers_page(struct nfs_page *req)
    {
    let mut len: c_uint = nfs_folio_length(nfs_page_to_folio(req));
...
//
#[no_mangle]
unsafe extern "C" fn nfs_mark_uptodate(req: *mut nfs_page) {
...
#[no_mangle]
unsafe extern "C" fn wb_priority(wbc: *mut writeback_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_folio_set_writeback(folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn nfs_folio_end_writeback(folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn nfs_page_end_writeback(req: *mut nfs_page) {
...
//
    ...
    core::ptr::null_mut() : subreq.wb_this_page;
...
//
    ...
    struct nfs_page *destroy_list = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn nfs_wait_on_request(req: *mut nfs_page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_write_error(req: *mut nfs_page, error: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nfs_io_completion_commit(inode: *mut c_void) {
    static void nfs_io_completion_commit(void *inode)
    {
    nfs_commit_inode(inode, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_writepages(mapping: *mut address_space, wbc: *mut writeback_control) -> c_int {
    int nfs_writepages(struct address_space *mapping, struct writeback_control *wbc)
    {
    struct inode *inode = mapping.host;
    struct nfs_pageio_descriptor pgio;
    struct nfs_io_completion *ioc = core::ptr::null_mut();
    let mut mntflags: c_uint = NFS_SERVER(inode).flags;
...
//
#[no_mangle]
unsafe extern "C" fn nfs_inode_add_request(req: *mut nfs_page) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_inode_remove_request(req: *mut nfs_page) {
    static void nfs_inode_remove_request(struct nfs_page *req)
    {
...
#[no_mangle]
unsafe extern "C" fn nfs_mark_request_dirty(req: *mut nfs_page) {
...
#[no_mangle]
unsafe extern "C" fn nfs_folio_clear_commit(req: *mut nfs_page) {
    static void nfs_folio_clear_commit(struct nfs_page *req)
    {
    struct folio *folio = nfs_page_to_folio(req);
    if (folio) {
    let mut nr: c_long = DIV_ROUND_UP(req.wb_bytes, PAGE_SIZE);
...
#[no_mangle]
pub unsafe extern "C" fn nfs_write_need_commit(hdr: *mut nfs_pgio_header) -> c_int {
    int nfs_write_need_commit(struct nfs_pgio_header *hdr)
    {
    if (hdr.verf.committed == NFS_DATA_SYNC)
    return hdr.lseg == core::ptr::null_mut();
    return hdr.verf.committed != NFS_FILE_SYNC;
    }
#[no_mangle]
unsafe extern "C" fn nfs_async_write_init(hdr: *mut nfs_pgio_header) {
    static void nfs_async_write_init(struct nfs_pgio_header *hdr)
    {
    nfs_io_completion_get(hdr.io_completion);
    }
#[no_mangle]
unsafe extern "C" fn nfs_write_completion(hdr: *mut nfs_pgio_header) {
...
//
    ...
    return (error < 0) ? ERR_PTR(error) : core::ptr::null_mut();
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn nfs_flush_incompatible(file: *mut file, folio: *mut folio) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_ctx_key_to_expire(ctx: *mut nfs_open_context, inode: *mut inode) -> bool {
    bool nfs_ctx_key_to_expire(struct nfs_open_context *ctx, struct inode *inode)
    {
    struct rpc_auth *auth = NFS_SERVER(inode).client.cl_auth;
    struct rpc_cred *cred, *new, *old = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn nfs_folio_write_uptodate(folio: *mut folio, pagelen: c_uint) -> bool {
...
//
    ...
    struct address_space *mapping = folio.mapping;
    struct inode *inode = mapping.host;
    let mut pagelen: c_uint = nfs_folio_length(folio);
    ...
    let mut end: c_uint = count + offset;
...
#[no_mangle]
unsafe extern "C" fn flush_task_priority(how: c_int) -> c_int {
    ...
    {
    let mut priority: c_int = flush_task_priority(how);
...
//
#[no_mangle]
unsafe extern "C" fn nfs_redirty_request(req: *mut nfs_page) {
    static void nfs_redirty_request(struct nfs_page *req)
    {
    struct nfs_inode *nfsi = NFS_I(nfs_page_to_inode(req));
...
#[no_mangle]
unsafe extern "C" fn nfs_async_write_error(head: *mut list_head, error: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nfs_async_write_reschedule_io(hdr: *mut nfs_pgio_header) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_pageio_reset_write_mds(pgio: *mut nfs_pageio_descriptor) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_commit_prepare(task: *mut rpc_task, calldata: *mut c_void) {
    ...
    let mut size: u64 = argp.offset + resp.count;
...
#[no_mangle]
pub unsafe extern "C" fn nfs_writeback_update_inode(hdr: *mut nfs_pgio_header) {
...
//
    ...
    if (task.tk_status >= 0) {
    let mut committed: enum nfs3_stable_how = hdr.res.verf.committed;
...
#[no_mangle]
unsafe extern "C" fn wait_on_commit(cinfo: *mut nfs_mds_commit_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_commit_begin(cinfo: *mut nfs_mds_commit_info) {
    void nfs_commit_begin(struct nfs_mds_commit_info *cinfo)
    {
    atomic_inc(&cinfo.rpcs_out);
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_commit_end(cinfo: *mut nfs_mds_commit_info) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_commitdata_release(data: *mut nfs_commit_data) {
...
#[no_mangle]
unsafe extern "C" fn nfs_get_lwb(head: *mut list_head) -> loff_t {
    static loff_t nfs_get_lwb(struct list_head *head)
    {
    let mut lwb: loff_t = 0;
    struct nfs_page *req;
...
// another commit raced with us
    ...
    if (!data) {
    nfs_retry_commit(head, core::ptr::null_mut(), cinfo, -1);
    return -ENOMEM;
    }
// Set up the argument struct
    nfs_init_commit(data, head, core::ptr::null_mut(), cinfo);
...
//
#[no_mangle]
unsafe extern "C" fn nfs_commit_done(task: *mut rpc_task, calldata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nfs_commit_release_pages(data: *mut nfs_commit_data) {
    static void nfs_commit_release_pages(struct nfs_commit_data *data)
    {
    const struct nfs_writeverf *verf = data.res.verf;
    struct nfs_page	*req;
    let mut status: c_int = data.task.tk_status;
    struct nfs_commit_info cinfo;
    struct folio *folio;
...
#[no_mangle]
unsafe extern "C" fn nfs_commit_release(calldata: *mut c_void) {
    ...
    LIST_HEAD(head);
    struct nfs_commit_info cinfo;
    let mut may_wait: c_int = how & FLUSH_SYNC;
    int ret, nscan;
    how &= ~FLUSH_SYNC;
    nfs_init_cinfo_from_inode(&cinfo, inode);
    nfs_commit_begin(cinfo.mds);
...
#[no_mangle]
pub unsafe extern "C" fn nfs_commit_inode(inode: *mut inode, how: c_int) -> c_int {
    int nfs_commit_inode(struct inode *inode, int how)
    {
    return __nfs_commit_inode(inode, how, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(nfs_commit_inode);
#[no_mangle]
pub unsafe extern "C" fn nfs_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
    int nfs_write_inode(struct inode *inode, struct writeback_control *wbc)
    {
    struct nfs_inode *nfsi = NFS_I(inode);
    let mut flags: c_int = FLUSH_SYNC;
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_wb_all(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_wb_folio_cancel(inode: *mut inode, folio: *mut folio) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_wb_folio_reclaim(inode: *mut inode, folio: *mut folio) -> c_int {
    int nfs_wb_folio_reclaim(struct inode *inode, struct folio *folio)
    {
    let mut range_start: loff_t = folio_pos(folio);
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_wb_folio(inode: *mut inode, folio: *mut folio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_init_writepagecache() -> int __init {
    ...
    core::ptr::null_mut());
    if (nfs_wdata_cachep == core::ptr::null_mut())
    return -ENOMEM;
    nfs_wdata_mempool = mempool_create_slab_pool(MIN_POOL_WRITE,
    nfs_wdata_cachep);
    if (nfs_wdata_mempool == core::ptr::null_mut())
    goto out_destroy_write_cache;
    nfs_cdata_cachep = kmem_cache_create("nfs_commit_data",
    sizeof(struct nfs_commit_data),
    0, SLAB_HWCACHE_ALIGN,
    core::ptr::null_mut());
    if (nfs_cdata_cachep == core::ptr::null_mut())
    goto out_destroy_write_mempool;
    nfs_commit_mempool = mempool_create_slab_pool(MIN_POOL_COMMIT,
    nfs_cdata_cachep);
    if (nfs_commit_mempool == core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn nfs_destroy_writepagecache() {
