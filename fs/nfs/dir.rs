...
#[no_mangle]
unsafe extern "C" fn put_nfs_open_dir_context(dir: *mut inode, ctx: *mut nfs_open_dir_context) {
...
pub struct nfs_cache_array {
    ...
    folio_is_eof : 1,
    pub 1: cookies_are_ordered :,
    pub __counted_by(size): nfs_cache_array_entry array[],
}
...
pub struct nfs_readdir_descriptor {
    pub file: *mut file,
    pub folio: *mut folio,
    pub ctx: *mut dir_context,
    pub folio_index: pgoff_t,
    pub folio_index_max: pgoff_t,
    pub dir_cookie: u64,
    pub last_cookie: u64,
    pub current_index: loff_t,
...
#[no_mangle]
unsafe extern "C" fn nfs_set_dtsize(desc: *mut nfs_readdir_descriptor, sz: c_uint) {
    ...
    let mut maxsize: c_uint = server.dtsize;
    if (sz > maxsize)
    sz = maxsize;
...
#[no_mangle]
unsafe extern "C" fn nfs_shrink_dtsize(desc: *mut nfs_readdir_descriptor) {
    static void nfs_shrink_dtsize(struct nfs_readdir_descriptor *desc)
    {
    nfs_set_dtsize(desc, desc.dtsize >> 1);
    }
#[no_mangle]
unsafe extern "C" fn nfs_grow_dtsize(desc: *mut nfs_readdir_descriptor) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_readdir_clear_array(folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_folio_array_free(folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_array_index_cookie(array: *mut nfs_cache_array) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_array_set_eof(array: *mut nfs_cache_array) {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_array_is_full(array: *mut nfs_cache_array) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_array_maxentries() -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_readdir_array_can_expand(array: *mut nfs_cache_array) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_readdir_folio_cookie_hash(cookie: u64) -> pgoff_t {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_folio_unlock_and_put(folio: *mut folio) {
    ...
    {
    let mut index: pgoff_t = nfs_readdir_folio_cookie_hash(cookie);
    struct folio *folio;
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_folio_last_cookie(folio: *mut folio) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_folio_needs_filling(folio: *mut folio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_folio_set_eof(folio: *mut folio) {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn is_32bit_api() -> c_int {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn nfs_readdir_use_cookie(filp: *const file) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_rewind_search(desc: *mut nfs_readdir_descriptor) {
    ...
    struct nfs_readdir_descriptor *desc)
    {
    let mut diff: loff_t = desc.ctx.pos - desc.current_index;
    unsigned int index;
    if (diff < 0)
    goto out_eof;
    if (diff >= array.size) {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_search_array(desc: *mut nfs_readdir_descriptor) -> c_int {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn nfs_same_file(dentry: *mut dentry, entry: *mut nfs_entry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_readdir_record_entry_cache_hit(dir: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_readdir_record_entry_cache_miss(dir: *mut inode) {
    ...
    {
    let mut filename: qstr = QSTR_INIT(entry.name, entry.len);
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_free_pages(pages: *mut page, npages: usize) {
...
//
    ...
    size_t array_size;
    struct inode *inode = file_inode(desc.file);
    let mut dtsize: c_uint = desc.dtsize;
    unsigned int pglen;
    ...
    if (entry.fh == core::ptr::null_mut() || entry.fattr == core::ptr::null_mut())
    goto out;
...
#[no_mangle]
unsafe extern "C" fn nfs_readdir_folio_put(desc: *mut nfs_readdir_descriptor) {
    static void nfs_readdir_folio_put(struct nfs_readdir_descriptor *desc)
    {
    folio_put(desc.folio);
    desc.folio = core::ptr::null_mut();
    }
    static void
    ...
    {
    struct address_space *mapping = desc.file.f_mapping;
    let mut change_attr: u64 = inode_peek_iversion_raw(mapping.host);
    let mut cookie: u64 = desc.last_cookie;
    struct folio *folio;
...
//
#[no_mangle]
unsafe extern "C" fn find_and_lock_cache_page(desc: *mut nfs_readdir_descriptor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn readdir_search_pagecache(desc: *mut nfs_readdir_descriptor) -> c_int {
...
//
    ...
    struct nfs_cache_array *array;
    unsigned int i;
    let mut first_emit: bool = !desc.dir_cookie;
    array = kmap_local_folio(desc.folio, 0);
...
//
#[no_mangle]
unsafe extern "C" fn uncached_readdir(desc: *mut nfs_readdir_descriptor) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_llseek_dir(filp: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_force_lookup_revalidate(dir: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_verify_change_attribute(dir: *mut inode, verf: c_ulong) -> bool {
    static bool nfs_verify_change_attribute(struct inode *dir, unsigned long verf)
    {
    return (verf & ~1UL) == nfs_save_change_attribute(dir);
    }
#[no_mangle]
unsafe extern "C" fn nfs_set_verifier_delegated(verf: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn nfs_unset_verifier_delegated(verf: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn nfs_test_verifier_delegated(verf: c_ulong) -> bool {
    static bool nfs_test_verifier_delegated(unsigned long verf)
    {
    return verf & 1;
    }
#[no_mangle]
unsafe extern "C" fn nfs_verifier_is_delegated(dentry: *mut dentry) -> bool {
    static bool nfs_verifier_is_delegated(struct dentry *dentry)
    {
    return nfs_test_verifier_delegated(dentry.d_time);
    }
#[no_mangle]
unsafe extern "C" fn nfs_set_verifier_locked(dentry: *mut dentry, verf: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_set_verifier(dentry: *mut dentry, verf: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn nfs_clear_verifier_file(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn nfs_clear_verifier_directory(dir: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_clear_verifier_delegated(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: S_ISDIR(inode->i_mode)) -> else {
...
#[no_mangle]
unsafe extern "C" fn nfs_dentry_verify_change(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_is_exclusive_create(dir: *mut inode, flags: c_uint) -> c_int {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn nfs_lookup_verify_inode(inode: *mut inode, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_mark_dir_for_revalidate(inode: *mut inode) {
...
//
    ...
    return nfs_lookup_revalidate_done(dir, dentry, core::ptr::null_mut(), ret);
    }
    static int
    ...
    if (fhandle == core::ptr::null_mut() || fattr == core::ptr::null_mut())
    goto out;
...
#[no_mangle]
unsafe extern "C" fn block_revalidate(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn unblock_revalidate(dentry: *mut dentry) {
    static void unblock_revalidate(struct dentry *dentry)
    {
    store_release_wake_up(&dentry.d_fsdata, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn nfs_weak_revalidate(dentry: *mut dentry, flags: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_dentry_delete(dentry: *const dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_drop_nlink(inode: *mut inode, gencount: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_dentry_iput(dentry: *mut dentry, inode: *mut inode) {
    static void nfs_dentry_iput(struct dentry *dentry, struct inode *inode)
    {
    if (dentry.d_flags & DCACHE_NFSFS_RENAMED) {
    let mut gencount: c_ulong = READ_ONCE(NFS_I(inode).attr_gencount);
...
#[no_mangle]
unsafe extern "C" fn nfs_d_release(dentry: *mut dentry) {
...
// free cached devname value, if it survived that far
    ...
    struct nfs_fh *fhandle = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nfs_d_prune_case_insensitive_aliases(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn do_open(inode: *mut inode, filp: *mut file) -> c_int {
    ...
    struct dentry *res;
    let mut attr: iattr = { .ia_valid = ATTR_OPEN };
    struct inode *inode;
...
// case -EINVAL:
    ...
    res = ERR_PTR(-ENOTDIR);
#[no_mangle]
pub unsafe extern "C" fn if(S_ISREG(inode->i_mode): inode &&) -> else {
...
//
    if (!d_is_reg(dentry))
    return finish_no_open(file, core::ptr::null_mut());
    file.f_mode |= FMODE_CREATED;
    return finish_open(file, dentry, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn nfs_dentry_handle_enoent(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_safe_remove(dentry: *mut dentry) -> c_int {
    static int nfs_safe_remove(struct dentry *dentry)
    {
    struct inode *dir = d_inode(dentry.d_parent);
    struct inode *inode = d_inode(dentry);
    let mut error: c_int = -EBUSY;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
    ...
    char *kaddr;
    struct iattr attr;
    let mut pathlen: c_uint = strlen(symname);
    int error;
...
//
    ...
    let mut new_gencount: c_ulong = 0;
    struct dentry *dentry = core::ptr::null_mut();
    struct rpc_task *task;
    let mut must_unblock: bool = false;
    let mut error: c_int = -EBUSY;
    if (flags)
    return -EINVAL;
...
// silly-rename the existing target ...
    ...
    must_unblock ? nfs_unblock_rename : core::ptr::null_mut());
    if (IS_ERR(task)) {
    if (must_unblock)
    unblock_revalidate(new_dentry);
    error = PTR_ERR(task);
...
// Ensure the inode attributes are revalidated
    ...
    if (!error) {
    if (new_inode != core::ptr::null_mut())
...
// new dentry created?
    ...
    let mut nfs_access_max_cachesize: static unsigned long = 4*1024*1024;
    module_param(nfs_access_max_cachesize, ulong, 0644);
    MODULE_PARM_DESC(nfs_access_max_cachesize, "NFS access maximum total cache length");
#[no_mangle]
unsafe extern "C" fn nfs_access_free_entry(entry: *mut nfs_access_entry) {
...
#[no_mangle]
unsafe extern "C" fn nfs_access_free_list(head: *mut list_head) {
    ...
    {
    let mut nr_to_scan: c_int = sc.nr_to_scan;
    let mut gfp_mask: gfp_t = sc.gfp_mask;
    ...
    {
    let mut nr_entries: c_long = atomic_long_read(&nfs_access_nr_entries);
    unsigned long diff;
...
#[no_mangle]
unsafe extern "C" fn __nfs_access_zap_cache(nfsi: *mut nfs_inode, head: *mut list_head) {
...
// Unhook entries from the cache
    while ((n = rb_first(root_node)) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_access_zap_cache(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn access_cmp(a: *const cred, b: *const nfs_access_entry) -> c_int {
    ...
    while (n != core::ptr::null_mut()) {
    struct nfs_access_entry *entry =
    rb_entry(n, struct nfs_access_entry, rb_node);
    let mut cmp: c_int = access_cmp(cred, entry);
    if (cmp < 0)
    n = n.rb_left;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn nfs_access_get_cached_locked(inode: *mut inode, cred: *const cred, mask: *mut u32, may_block: bool) -> c_int {
    static int nfs_access_get_cached_locked(struct inode *inode, const struct cred *cred, u32 *mask, bool may_block)
    {
    struct nfs_inode *nfsi = NFS_I(inode);
    let mut login_time: u64 = nfs_access_login_time(current, cred);
    struct nfs_access_entry *cache;
...
#[no_mangle]
unsafe extern "C" fn nfs_access_get_cached_rcu(inode: *mut inode, cred: *const cred, mask: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_access_set_mask(entry: *mut nfs_access_entry, access_result: u32) {
...
#[no_mangle]
unsafe extern "C" fn nfs_do_access(inode: *mut inode, cred: *const cred, mask: c_int) -> c_int {
    static int nfs_do_access(struct inode *inode, const struct cred *cred, int mask)
    {
    struct nfs_access_entry cache;
    let mut may_block: bool = (mask & MAY_NOT_BLOCK) == 0;
    let mut cache_mask: c_int = -1;
    int status;
...
#[no_mangle]
unsafe extern "C" fn nfs_open_permission_mask(openflags: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_may_open(inode: *mut inode, cred: *const cred, openflags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_execute_ok(inode: *mut inode, mask: c_int) -> c_int {
