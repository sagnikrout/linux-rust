...
#[no_mangle]
unsafe extern "C" fn param_set_enable_ino64(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_wait_bit_killable(key: *mut wait_bit_key, mode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_drop_inode(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_clear_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_sync_inode(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_sync_mapping(mapping: *mut address_space) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_attribute_timeout(inode: *mut inode) -> c_int {
    ...
    unsigned long flags)
    {
    let mut cache_validity: c_ulong = READ_ONCE(NFS_I(inode).cache_validity);
    return (cache_validity & flags) != 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_check_cache_invalid(inode: *mut inode, flags: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_has_xattr_cache(nfsi: *const nfs_inode) -> bool {
    static bool nfs_has_xattr_cache(const struct nfs_inode *nfsi)
    {
    return nfsi.xattr_cache != core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn nfs_set_cache_invalid(inode: *mut inode, flags: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_zap_caches_locked(inode: *mut inode) {
    static void nfs_zap_caches_locked(struct inode *inode)
    {
    struct nfs_inode *nfsi = NFS_I(inode);
    let mut mode: c_int = inode.i_mode;
...
#[no_mangle]
pub unsafe extern "C" fn nfs_zap_caches(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_zap_mapping(inode: *mut inode, mapping: *mut address_space) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_zap_acl_cache(inode: *mut inode) {
    void nfs_zap_acl_cache(struct inode *inode)
    {
    void (*clear_acl_cache)(struct inode *);
    clear_acl_cache = NFS_PROTO(inode).clear_acl_cache;
    if (clear_acl_cache != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn nfs_invalidate_atime(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_set_inode_stale_locked(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_set_inode_stale(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn nfs_clear_label_invalid(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_setsecurity(inode: *mut inode, fattr: *mut nfs_fattr) {
    void nfs_setsecurity(struct inode *inode, struct nfs_fattr *fattr)
    {
    int error;
    if (fattr.label == core::ptr::null_mut())
    return;
    ...
    if (label.label == core::ptr::null_mut()) {
    kfree(label);
    return ERR_PTR(-ENOMEM);
    }
...
#[no_mangle]
unsafe extern "C" fn nfs_inode_init_regular(nfsi: *mut nfs_inode) {
...
#[no_mangle]
unsafe extern "C" fn nfs_inode_init_dir(nfsi: *mut nfs_inode) {
...
//
    ...
    let mut fattr_supported: u64 = NFS_SB(sb).fattr_valid;
    u64 hash;
    nfs_attr_check_mountpoint(sb, fattr);
    if (nfs_attr_use_mounted_on_fileid(fattr))
    fattr.fileid = fattr.mounted_on_fileid;
#[no_mangle]
pub unsafe extern "C" fn if(0: (fattr->valid & NFS_ATTR_FATTR_FILEID) ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_ATIME: fattr_supported &) -> else {
    else if (fattr_supported & NFS_ATTR_FATTR_ATIME)
    nfs_set_cache_invalid(inode, NFS_INO_INVALID_ATIME);
    if (fattr.valid & NFS_ATTR_FATTR_MTIME)
    inode_set_mtime_to_ts(inode, fattr.mtime);
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_MTIME: fattr_supported &) -> else {
    else if (fattr_supported & NFS_ATTR_FATTR_MTIME)
    nfs_set_cache_invalid(inode, NFS_INO_INVALID_MTIME);
    if (fattr.valid & NFS_ATTR_FATTR_CTIME)
    inode_set_ctime_to_ts(inode, fattr.ctime);
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_CTIME: fattr_supported &) -> else {
    else if (fattr_supported & NFS_ATTR_FATTR_CTIME)
    nfs_set_cache_invalid(inode, NFS_INO_INVALID_CTIME);
    if (fattr.valid & NFS_ATTR_FATTR_BTIME)
    nfsi.btime = fattr.btime;
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_BTIME: fattr_supported &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_NLINK: fattr_supported &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_OWNER: fattr_supported &) -> else {
    else if (fattr_supported & NFS_ATTR_FATTR_OWNER)
    nfs_set_cache_invalid(inode, NFS_INO_INVALID_OTHER);
    if (fattr.valid & NFS_ATTR_FATTR_GROUP)
    inode.i_gid = fattr.gid;
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_GROUP: fattr_supported &) -> else {
...
//
    ...
    let mut err: c_int = nfs_refresh_inode(inode, fattr);
    if (err < 0) {
    iput(inode);
    inode = ERR_PTR(err);
    goto out_no_inode;
    ...
    {
    let mut cache_validity: c_ulong = NFS_I(inode).cache_validity;
...
#[no_mangle]
unsafe extern "C" fn nfs_set_timestamps_to_ts(inode: *mut inode, attr: *mut iattr) {
    static void nfs_set_timestamps_to_ts(struct inode *inode, struct iattr *attr)
    {
    let mut cache_flags: c_uint = 0;
    if (attr.ia_valid & ATTR_MTIME_SET) {
    let mut ctime: timespec64 = inode_get_ctime(inode);
    let mut mtime: timespec64 = inode_get_mtime(inode);
...
#[no_mangle]
unsafe extern "C" fn nfs_update_atime(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn nfs_update_mtime(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_update_delegated_atime(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_update_delegated_mtime_locked(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_update_delegated_mtime(inode: *mut inode) {
    ...
    let mut task_uid: kuid_t = current_fsuid();
    let mut owner_uid: kuid_t = inode.i_uid;
...
//
#[no_mangle]
unsafe extern "C" fn nfs_vmtruncate(inode: *mut *mut inode, offset: loff_t) -> c_int {
...
// Barrier: bump the attribute generation count.
    ...
    let mut mode: c_int = attr.ia_mode & S_IALLUGO;
    ...
    inode_set_atime_to_ts(inode, fattr.atime);
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_ATIME_SET: attr->ia_valid &) -> else {
    ...
    inode_set_mtime_to_ts(inode, fattr.mtime);
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_MTIME_SET: attr->ia_valid &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_getattr_readdirplus_enable(inode: *const inode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdirplus_parent_cache_miss(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn nfs_readdirplus_parent_cache_hit(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn nfs_get_valid_attrmask(inode: *mut inode) -> u32 {
    static u32 nfs_get_valid_attrmask(struct inode *inode)
    {
    let mut fattr_valid: u64 = NFS_SERVER(inode).fattr_valid;
    let mut cache_validity: c_ulong = READ_ONCE(NFS_I(inode).cache_validity);
    let mut reply_mask: u32 = STATX_INO | STATX_TYPE;
    if (!(cache_validity & NFS_INO_INVALID_ATIME))
    ...
    let mut fattr_valid: u64 = server.fattr_valid;
    unsigned long cache_validity;
    let mut err: c_int = 0;
    let mut force_sync: bool = query_flags & AT_STATX_FORCE_SYNC;
    let mut do_update: bool = false;
    let mut readdirplus_enabled: bool = nfs_getattr_readdirplus_enable(inode);
...
#[no_mangle]
pub unsafe extern "C" fn nfs_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_init_lock_context(l_ctx: *mut nfs_lock_context) {
    ...
    {
    struct nfs_lock_context *res, *new = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nfs_put_lock_context(l_ctx: *mut nfs_lock_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_close_context(ctx: *mut nfs_open_context, is_sync: c_int) {
    ...
    rcu_assign_pointer(ctx.ll_cred, core::ptr::null_mut());
    ...
    ctx.mdsthreshold = core::ptr::null_mut();
    ...
    {
    if (ctx != core::ptr::null_mut() && refcount_inc_not_zero(&ctx.lock_context.count))
    return ctx;
    return core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(get_nfs_open_context);
#[no_mangle]
unsafe extern "C" fn __put_nfs_open_context(ctx: *mut nfs_open_context, is_sync: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn put_nfs_open_context(ctx: *mut nfs_open_context) {
...
#[no_mangle]
unsafe extern "C" fn put_nfs_open_context_sync(ctx: *mut nfs_open_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_inode_attach_open_context(ctx: *mut nfs_open_context) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_file_set_open_context(filp: *mut file, ctx: *mut nfs_open_context) {
...
//
    ...
    {
    struct nfs_inode *nfsi = NFS_I(inode);
    struct nfs_open_context *pos, *ctx = core::ptr::null_mut();
    rcu_read_lock();
    list_for_each_entry_rcu(pos, &nfsi.open_files, list) {
    if (cred != core::ptr::null_mut() && cred_fscmp(pos.cred, cred) != 0)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn nfs_file_clear_open_context(filp: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_attribute_cache_expired(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_revalidate_inode(inode: *mut inode, flags: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_invalidate_mapping(inode: *mut inode, mapping: *mut address_space) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_clear_invalid_mapping(mapping: *mut address_space) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_mapping_need_revalidate_inode(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_revalidate_mapping_rcu(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_revalidate_mapping(inode: *mut inode, mapping: *mut address_space) -> c_int {
...
// swapfiles are not supposed to be shared.
    ...
    return 0;
    if (nfs_mapping_need_revalidate_inode(inode)) {
    let mut ret: c_int = __nfs_revalidate_inode(NFS_SERVER(inode), inode);
    if (ret < 0)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn nfs_file_has_writers(nfsi: *mut nfs_inode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfs_file_has_buffered_writers(nfsi: *mut nfs_inode) -> bool {
    static bool nfs_file_has_buffered_writers(struct nfs_inode *nfsi)
    {
    return nfs_file_has_writers(nfsi) && nfs_file_io_is_buffered(nfsi);
    }
#[no_mangle]
unsafe extern "C" fn nfs_wcc_update_inode(inode: *mut inode, fattr: *mut nfs_fattr) {
    ...
    nfs_set_cache_invalid(inode, NFS_INO_INVALID_DATA);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nfs_server_capable(inode, _arg: NFS_CAP_XATTR)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_check_inode_attributes(inode: *mut inode, fattr: *mut nfs_fattr) -> c_int {
    static int nfs_check_inode_attributes(struct inode *inode, struct nfs_fattr *fattr)
    {
    struct nfs_inode *nfsi = NFS_I(inode);
    loff_t cur_size, new_isize;
    let mut invalid: c_ulong = 0;
    struct timespec64 ts;
    if (nfs_have_delegated_attributes(inode))
    return 0;
    if (!(fattr.valid & NFS_ATTR_FATTR_FILEID)) {
...
#[no_mangle]
unsafe extern "C" fn nfs_read_attr_generation_counter() -> c_ulong {
    static unsigned long nfs_read_attr_generation_counter(void)
    {
    return atomic_long_read(&nfs_attr_generation_counter);
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_inc_attr_generation_counter() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_fattr_init(fattr: *mut nfs_fattr) {
    void nfs_fattr_init(struct nfs_fattr *fattr)
    {
    fattr.valid = 0;
    fattr.time_start = jiffies;
    fattr.gencount = nfs_inc_attr_generation_counter();
    fattr.owner_name = core::ptr::null_mut();
    fattr.group_name = core::ptr::null_mut();
    fattr.mdsthreshold = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_fattr_set_barrier(fattr: *mut nfs_fattr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn _nfs_display_fhandle_hash(fh: *const nfs_fh) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn _nfs_display_fhandle(fh: *const nfs_fh, caption: *const c_char) {
    void _nfs_display_fhandle(const struct nfs_fh *fh, const char *caption)
    {
    unsigned short i;
    if (fh == core::ptr::null_mut() || fh.size == 0) {
...
//
    ...
    {
    let mut attr_gencount: c_ulong = NFS_I(inode).attr_gencount;
...
//
    ...
    const struct inode *inode)
    {
    let mut diff: i64 = fattr.change_attr - inode_peek_iversion_raw(inode);
    if (diff > 0)
    return 1;
    let mut diff: return = = 0 ? 0 : -1;
    }
//
...
//
    ...
    let mut cache_validity: c_ulong = NFS_I(inode).cache_validity;
    let mut ctype: enum nfs4_change_attr_type = NFS_SERVER(inode).change_attr_type;
...
#[no_mangle]
pub unsafe extern "C" fn if(nfsi->ooo->gap[i].end: start ==) -> else {
...
//
    ...
    struct nfs_fattr *fattr)
    {
    let mut attr_cmp: c_int = nfs_inode_attrs_cmp(fattr, inode);
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_refresh_inode(inode: *mut inode, fattr: *mut nfs_fattr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_post_op_update_inode(inode: *mut inode, fattr: *mut nfs_fattr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_post_op_update_inode_force_wcc_locked(inode: *mut inode, fattr: *mut nfs_fattr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs_post_op_update_inode_force_wcc(inode: *mut inode, fattr: *mut nfs_fattr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfs_update_inode(inode: *mut inode, fattr: *mut nfs_fattr) -> c_int {
    static int nfs_update_inode(struct inode *inode, struct nfs_fattr *fattr)
    {
    struct nfs_server *server = NFS_SERVER(inode);
    struct nfs_inode *nfsi = NFS_I(inode);
    loff_t cur_isize, new_isize;
    let mut fattr_supported: u64 = server.fattr_valid;
    let mut invalid: c_ulong = 0;
    let mut now: c_ulong = jiffies;
    unsigned long save_cache_validity;
    let mut have_writers: bool = nfs_file_has_buffered_writers(nfsi);
    let mut cache_revalidated: bool = true;
    let mut attr_changed: bool = false;
...
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_ATIME: fattr_supported &) -> else {
    ...
    let mut newmode: umode_t = inode.i_mode & S_IFMT;
...
//
    ...
    inode.i_blocks = fattr.du.nfs2.blocks;
#[no_mangle]
pub unsafe extern "C" fn if(NFS_ATTR_FATTR_BLOCKS_USED: fattr_supported &) -> else {
    else if (fattr_supported & NFS_ATTR_FATTR_BLOCKS_USED)
    nfsi.cache_validity |=
    save_cache_validity & NFS_INO_INVALID_BLOCKS;
    if (fattr.valid & NFS_ATTR_FATTR_UNCACHEABLE_FILE_DATA)
...
//
    ...
    nfsi.nfs4_acl = core::ptr::null_mut();

    nfsi.xattr_cache = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nfs_free_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs4_init_once(nfsi: *mut nfs_inode) {
    static inline void nfs4_init_once(struct nfs_inode *nfsi)
    {

    INIT_LIST_HEAD(&nfsi.open_states);
    nfsi.delegation = core::ptr::null_mut();
    init_rwsem(&nfsi.rwsem);
    nfsi.layout = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nfs_init_inodecache() -> int __init {
    ...
    SLAB_ACCOUNT),
    init_once);
    if (nfs_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nfs_destroy_inodecache() {
...
//
#[no_mangle]
unsafe extern "C" fn nfsiod_stop() {
    static void nfsiod_stop(void)
    {
    struct workqueue_struct *wq;
    wq = nfsiod_workqueue;
    if (wq != core::ptr::null_mut()) {
    nfsiod_workqueue = core::ptr::null_mut();
    destroy_workqueue(wq);
    }

    wq = nfslocaliod_workqueue;
    if (wq != core::ptr::null_mut()) {
    nfslocaliod_workqueue = core::ptr::null_mut();
    destroy_workqueue(wq);
    }
...
//
    ...
    if (unlikely(nfslocaliod_workqueue == core::ptr::null_mut())) {
    nfsiod_stop();
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn nfs_net_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs_net_exit(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nfs_init_keyring() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nfs_exit_keyring() {
...
#[no_mangle]
pub unsafe extern "C" fn nfs_init_keyring() -> c_int {
    static inline int nfs_init_keyring(void)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nfs_exit_keyring() {
...
//
#[no_mangle]
unsafe extern "C" fn init_nfs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_nfs_fs() -> void __exit {
