...
#[no_mangle]
pub unsafe extern "C" fn pnfs_generic_rw_release(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn pnfs_generic_prepare_to_resend_writes(data: *mut nfs_commit_data) {
...
#[no_mangle]
pub unsafe extern "C" fn pnfs_generic_write_commit_done(task: *mut rpc_task, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn pnfs_generic_commit_release(calldata: *mut c_void) {
...
//
    ...
    {
    struct pnfs_commit_bucket *bucket = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn pnfs_generic_scan_commit_lists(cinfo: *mut nfs_commit_info, max: c_int) -> c_int {
...
// This follows nfs_commit_list pretty closely
    ...
    if (!data) {
    nfs_retry_commit(mds_pages, core::ptr::null_mut(), cinfo, -1);
    return -ENOMEM;
    }
    ...
    nfs_init_commit(data, core::ptr::null_mut(), core::ptr::null_mut(), cinfo);
    nfs_initiate_commit(NFS_CLIENT(inode), data,
    NFS_PROTO(data.inode),
    data.mds_ops, how,
    RPC_TASK_CRED_NOREF, core::ptr::null_mut());
    } else {
    nfs_init_commit(data, core::ptr::null_mut(), data.lseg, cinfo);
...
// Debug routines
    ...
    printk(KERN_WARNING "%s core::ptr::null_mut() device\n", __func__);
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn nfs4_pnfs_ds_addr_free(da: *mut nfs4_pnfs_ds_addr) {
...
#[no_mangle]
unsafe extern "C" fn destroy_ds(ds: *mut nfs4_pnfs_ds) {
...
#[no_mangle]
pub unsafe extern "C" fn nfs4_pnfs_ds_put(ds: *mut nfs4_pnfs_ds) {
...
// (p++) = '{';
    len--;
    list_for_each_entry(da, dsaddrs, da_node) {
    let mut ll: usize = strlen(da.da_remotestr);
    if (ll > len)
    goto out_err;
...
//
    ...
    struct nfs4_pnfs_ds *tmp_ds, *ds = core::ptr::null_mut();
    char *remotestr;
...
#[no_mangle]
unsafe extern "C" fn nfs4_wait_ds_connect(ds: *mut nfs4_pnfs_ds) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfs4_clear_ds_conn_bit(ds: *mut nfs4_pnfs_ds) {
...
#[no_mangle]
unsafe extern "C" fn load_v3_ds_connect() -> bool {
    ...
    return(get_v3_ds_connect != core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn nfs4_pnfs_v3_ds_connect_unload() {
    void nfs4_pnfs_v3_ds_connect_unload(void)
    {
    if (get_v3_ds_connect) {
    symbol_put(nfs3_set_ds_client);
    get_v3_ds_connect = core::ptr::null_mut();
    }
    }
    ...
    let mut xprtsec_policy: enum xprtsec_policies = mds_clp.cl_xprtsec.policy;
    struct nfs4_pnfs_ds_addr *da;
    let mut connect_timeout: c_ulong = timeo * (retrans + 1) * HZ / 10;
    int ds_proto;
...
// Add this address as an alias
    ...
    rpc_clnt_test_and_add_xprt, core::ptr::null_mut());
    continue;
    }
...
//
    ...
    {
    struct nfs4_pnfs_ds_addr *da = core::ptr::null_mut();
    char *buf, *portstr;
    __be16 port;
    ssize_t nlen, rlen;
    int tmp[2];
