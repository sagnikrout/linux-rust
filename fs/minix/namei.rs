...
#[no_mangle]
unsafe extern "C" fn add_nondir(dentry: *mut dentry, inode: *mut inode) -> c_int {
    static int add_nondir(struct dentry *dentry, struct inode *inode)
    {
    let mut err: c_int = minix_add_link(dentry, inode);
    if (!err) {
    ...
    {
    let mut i: c_int = strlen(symname)+1;
    struct inode * inode;
    int err;
...
#[no_mangle]
unsafe extern "C" fn minix_unlink(dir: *mut *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn minix_rmdir(dir: *mut *mut inode, dentry: *mut dentry) -> c_int {
