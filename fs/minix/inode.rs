...
#[no_mangle]
unsafe extern "C" fn minix_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn minix_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn minix_free_in_core_inode(inode: *mut inode) {
...
unsafe extern "C" fn init_inodecache() -> int __init {
    ...
    SLAB_ACCOUNT),
    init_once);
    if (minix_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn minix_reconfigure(fc: *mut fs_context) -> c_int {
    static int minix_reconfigure(struct fs_context *fc)
    {
    struct minix_super_block * ms;
    struct super_block *sb = fc.root.d_sb;
    let mut sbi: *mut minix_sb_info = sb.s_fs_info;
    sync_filesystem(sb);
    ms = sbi.s_ms;
...
#[no_mangle]
pub unsafe extern "C" fn if(MINIX_ERROR_FS): (sbi->s_mount_state &) -> else {
...
#[no_mangle]
unsafe extern "C" fn minix_check_superblock(sb: *mut super_block) -> bool {
...
#[no_mangle]
unsafe extern "C" fn minix_fill_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
    static int minix_fill_super(struct super_block *s, struct fs_context *fc)
    {
    struct buffer_head *bh;
    struct buffer_head **map;
    struct minix_super_block *ms;
    struct minix3_super_block *m3s = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn minix_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn minix_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn minix_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    static int minix_statfs(struct dentry *dentry, struct kstatfs *buf)
    {
...
#[no_mangle]
unsafe extern "C" fn minix_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int minix_read_folio(struct file *file, struct folio *folio)
    {
    return block_read_full_folio(folio, minix_get_block);
    }
#[no_mangle]
pub unsafe extern "C" fn minix_prepare_chunk(folio: *mut folio, pos: loff_t, len: unsigned) -> c_int {
    int minix_prepare_chunk(struct folio *folio, loff_t pos, unsigned len)
    {
    return __block_write_begin(folio, pos, len, minix_get_block);
    }
#[no_mangle]
unsafe extern "C" fn minix_write_failed(mapping: *mut address_space, to: loff_t) {
...
#[no_mangle]
unsafe extern "C" fn minix_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
...
#[no_mangle]
pub unsafe extern "C" fn minix_set_inode(inode: *mut inode, rdev: dev_t) {
...
//
#[no_mangle]
unsafe extern "C" fn V1_minix_update_inode(inode: *mut *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn for(i++: i = 0; i < 9;) -> else {
    else for (i = 0; i < 9; i++)
...
//
#[no_mangle]
unsafe extern "C" fn V2_minix_update_inode(inode: *mut *mut inode) -> c_int {
    ...
    raw_inode.i_zone[0] = old_encode_dev(inode.i_rdev);
#[no_mangle]
pub unsafe extern "C" fn for(i++: i = 0; i < 10;) -> else {
    else for (i = 0; i < 10; i++)
...
#[no_mangle]
unsafe extern "C" fn minix_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn minix_truncate(inode: *mut *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn init_minix_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_minix_fs() -> void __exit {
