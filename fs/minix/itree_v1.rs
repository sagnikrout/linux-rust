...
#[no_mangle]
pub unsafe extern "C" fn V1_minix_truncate(inode: *mut *mut inode) {
    void V1_minix_truncate(struct inode * inode)
    {
    truncate(inode);
    }
#[no_mangle]
pub unsafe extern "C" fn V1_minix_blocks(size: loff_t, sb: *mut super_block) -> unsigned {
