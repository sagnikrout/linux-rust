...
pub const NLMCLNT_MAX_RETRIES: c_int = 3;
...
//
    let mut nlm_cookie: static atomic_t = ATOMIC_INIT(0x1234);
#[no_mangle]
pub unsafe extern "C" fn nlmclnt_next_cookie(c: *mut lockd_cookie) {
    void nlmclnt_next_cookie(struct lockd_cookie *c)
    {
    let mut cookie: u32 = atomic_inc_return(&nlm_cookie);
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_put_lockowner(lockowner: *mut nlm_lockowner) {
...
#[no_mangle]
pub unsafe extern "C" fn nlm_pidbusy(host: *mut nlm_host, pid: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __nlm_alloc_pid(host: *mut nlm_host) -> u32 {
    ...
    {
    struct nlm_lockowner *res, *new = core::ptr::null_mut();
    ...
    spin_lock(&host.h_lock);
    res = __nlmclnt_find_lockowner(host, owner);
    if (res == core::ptr::null_mut() && new != core::ptr::null_mut()) {
    res = new;
...
//
#[no_mangle]
unsafe extern "C" fn nlmclnt_setlockargs(req: *mut nlm_rqst, fl: *mut file_lock) {
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_release_lockargs(req: *mut nlm_rqst) {
    static void nlmclnt_release_lockargs(struct nlm_rqst *req)
    {
    WARN_ON_ONCE(req.a_args.lock.fl.fl_ops != core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn nlmclnt_proc(host: *mut nlm_host, cmd: c_int, fl: *mut file_lock, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nlmclnt_release_call(call: *mut nlm_rqst) {
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_rpc_release(data: *mut c_void) {
    static void nlmclnt_rpc_release(void *data)
    {
    nlmclnt_release_call(data);
    }
#[no_mangle]
unsafe extern "C" fn nlm_wait_on_grace(queue: *mut wait_queue_head_t) -> c_int {
    static int nlm_wait_on_grace(wait_queue_head_t *queue)
    {
    DEFINE_WAIT(wait);
    let mut status: c_int = -EINTR;
...
// If we have no RPC client yet, create one.
    if ((clnt = nlm_bind_host(host)) == core::ptr::null_mut())
    return -ENOLCK;
...
#[no_mangle]
unsafe extern "C" fn nlm_do_async_call(req: *mut nlm_rqst, proc: u32, msg: *mut rpc_message, tk_ops: *const rpc_call_ops) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nlm_async_call(req: *mut nlm_rqst, proc: u32, tk_ops: *const rpc_call_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nlm_async_reply(req: *mut nlm_rqst, proc: u32, tk_ops: *const rpc_call_ops) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nlmclnt_async_call(cred: *const cred, req: *mut nlm_rqst, proc: u32, tk_ops: *const rpc_call_ops) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_locks_copy_lock(new: *mut file_lock, fl: *mut file_lock) {
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_locks_release_private(fl: *mut file_lock) {
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_locks_init_private(fl: *mut file_lock, host: *mut nlm_host) {
    static void nlmclnt_locks_init_private(struct file_lock *fl, struct nlm_host *host)
    {
...
#[no_mangle]
unsafe extern "C" fn do_vfs_lock(fl: *mut file_lock) -> c_int {
...
//
    ...
    let mut flags: c_uchar = fl.c.flc_flags;
    unsigned char type;
    __be32 b_status;
    let mut status: c_int = -ENOLCK;
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_unlock_prepare(task: *mut rpc_task, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_unlock_callback(task: *mut rpc_task, data: *mut c_void) {
    static void nlmclnt_unlock_callback(struct rpc_task *task, void *data)
    {
    struct nlm_rqst	*req = data;
    let mut status: u32 = ntohl(req.a_res.status);
...
//
#[no_mangle]
unsafe extern "C" fn nlmclnt_cancel(host: *mut nlm_host, block: c_int, fl: *mut file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nlmclnt_cancel_callback(task: *mut rpc_task, data: *mut c_void) {
