...
#[no_mangle]
unsafe extern "C" fn nlmsvc_insert_block(block: *mut nlm_block, when: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn lockd_cookie_match(a: *mut lockd_cookie, b: *mut lockd_cookie) -> c_int {
...
//
    ...
    {
    struct nlm_block	*block;
    struct nlm_rqst		*call = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_unlink_block(block: *mut nlm_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nlmsvc_free_block(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn nlmsvc_release_block(block: *mut nlm_block) {
    static void nlmsvc_release_block(struct nlm_block *block)
    {
    if (block != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn nlmsvc_put_lockowner(lockowner: *mut nlm_lockowner) {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_setgrantargs(call: *mut nlm_rqst, lock: *mut lockd_lock) -> c_int {
    static int nlmsvc_setgrantargs(struct nlm_rqst *call, struct lockd_lock *lock)
    {
...
#[no_mangle]
unsafe extern "C" fn nlmsvc_freegrantargs(call: *mut nlm_rqst) {
    static void nlmsvc_freegrantargs(struct nlm_rqst *call)
    {
...
//
    ...
    {
    let mut status: __be32 = nlm_lck_denied_nolocks;
    ...
    if (block.b_deferred_req != core::ptr::null_mut())
...
//
    ...
    {
    let mut __maybe_unused: *mut inode		inode = nlmsvc_file_inode(file);
    struct nlm_block	*block = core::ptr::null_mut();
    int			error;
    int			mode;
    let mut async_block: c_int = 0;
    __be32			ret;
...
// Append to list of blocked
    ...
    error = vfs_lock_file(file.f_file[mode], F_SETLK, &lock.fl, core::ptr::null_mut());
    lock.fl.c.flc_flags &= ~FL_SLEEP;
...
#[no_mangle]
unsafe extern "C" fn nlmsvc_grant_deferred(fl: *mut file_lock, result: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nlmsvc_get_owner(owner: fl_owner_t) -> fl_owner_t {
    static fl_owner_t nlmsvc_get_owner(fl_owner_t owner)
    {
    return nlmsvc_get_lockowner(owner);
    }
#[no_mangle]
unsafe extern "C" fn nlmsvc_put_owner(owner: fl_owner_t) {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_grant_callback(task: *mut rpc_task, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_grant_release(data: *mut c_void) {
...
// Client doesn't want it, just unlock it
    ...
    error = vfs_lock_file(fl.c.flc_file, F_SETLK, fl, core::ptr::null_mut());
    if (error)
...
//
    ...
    block.b_deferred_req = core::ptr::null_mut();
    }
    }
//
...
//
    ...
    {
    let mut timeout: c_ulong = MAX_SCHEDULE_TIMEOUT;
    struct nlm_block *block;
    spin_lock(&nlm_blocked_lock);
