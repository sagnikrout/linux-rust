...
#[no_mangle]
unsafe extern "C" fn nlmsvc_request_retry(tl: *mut timer_list) {
...
//
    ...
    let mut nlm_timeout: c_ulong = LOCKD_DFLT_TIMEO;
    static int			nlm_udpport, nlm_tcpport;
//
// Constants needed for the sysctl interface.
//
    let mut nlm_grace_period_min: static unsigned long = 0;
    let mut nlm_grace_period_max: static unsigned long = 240;
    let mut nlm_timeout_min: static unsigned long = 3;
    let mut nlm_timeout_max: static unsigned long = 20;

    let mut nlm_port_min: static int = 0, nlm_port_max = 65535;
    static struct ctl_table_header * nlm_sysctl_table;

#[no_mangle]
unsafe extern "C" fn get_lockd_grace_period(net: *mut net) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn grace_ender(grace: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn set_grace_period(net: *mut net) {
    static void set_grace_period(struct net *net)
    {
    let mut grace_period: c_ulong = get_lockd_grace_period(net);
    struct lockd_net *ln = net_generic(net, lockd_net_id);
...
#[no_mangle]
unsafe extern "C" fn lockd_down_net(serv: *mut svc_serv, net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn lockd_get() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lockd_up(net: *mut net, cred: *const cred) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_callback(proc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lockd_authenticate(rqstp: *mut svc_rqst) -> enum svc_auth_status {
...
#[no_mangle]
unsafe extern "C" fn lockd_init_net(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lockd_exit_net(net: *mut net) {
...
//
#[no_mangle]
unsafe extern "C" fn init_nlm() -> int __init {
    ...
    if (nlm_sysctl_table == core::ptr::null_mut())
    goto err_sysctl;
...
#[no_mangle]
unsafe extern "C" fn exit_nlm() -> void __exit {
...
//
#[no_mangle]
pub unsafe extern "C" fn nlmsvc_dispatch(rqstp: *mut svc_rqst) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lockd_nl_server_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lockd_nl_server_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
