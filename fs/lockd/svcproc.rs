...
//
pub const NLM3_FHSIZE: c_int = 32;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_testargs_wrapper {
    pub xdrgen: nlm_testargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_testres_wrapper {
    pub xdrgen: nlm_testres,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_lockargs_wrapper {
    pub xdrgen: nlm_lockargs,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_cancargs_wrapper {
    pub xdrgen: nlm_cancargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_unlockargs_wrapper {
    pub xdrgen: nlm_unlockargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_notifyargs_wrapper {
    pub xdrgen: nlm_notifyargs,
    pub reboot: lockd_reboot,
}

    static_assert(offsetof(struct nlm_notifyargs_wrapper, xdrgen) == 0);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_shareargs_wrapper {
    pub xdrgen: nlm_shareargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_shareres_wrapper {
    pub xdrgen: nlm_shareres,
}

    static_assert(offsetof(struct nlm_shareres_wrapper, xdrgen) == 0);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm_notify_wrapper {
    pub xdrgen: nlm_notify,
}
    ...
    struct nlm_file *file = core::ptr::null_mut();
    __be32 error;
    int mode;
...
#[no_mangle]
pub unsafe extern "C" fn cast_status(status: __be32) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_null(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_test(rqstp: *mut svc_rqst) -> __be32 {
    static __be32 nlmsvc_proc_test(struct svc_rqst *rqstp)
    {
    struct nlm_testargs_wrapper *argp = rqstp.rq_argp;
    let mut type: c_uchar = argp.xdrgen.exclusive ? F_WRLCK : F_RDLCK;
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_callback_exit(task: *mut rpc_task, data: *mut c_void) {
    static void nlmsvc_callback_exit(struct rpc_task *task, void *data)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn nlmsvc_release_call(call: *mut nlm_rqst) {
...
#[no_mangle]
unsafe extern "C" fn nlmsvc_callback_release(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_test_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_lock_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_cancel_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_unlock_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_granted_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_granted_res(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_sm_notify(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_unused(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_share(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_unshare(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_nm_lock(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlmsvc_proc_free_all(rqstp: *mut svc_rqst) -> __be32 {
