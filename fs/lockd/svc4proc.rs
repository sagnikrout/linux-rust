...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_testargs_wrapper {
    pub xdrgen: nlm4_testargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_lockargs_wrapper {
    pub xdrgen: nlm4_lockargs,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_cancargs_wrapper {
    pub xdrgen: nlm4_cancargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_unlockargs_wrapper {
    pub xdrgen: nlm4_unlockargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_notifyargs_wrapper {
    pub xdrgen: nlm4_notifyargs,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_notify_wrapper {
    pub xdrgen: nlm4_notify,
}

    static_assert(offsetof(struct nlm4_notify_wrapper, xdrgen) == 0);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_testres_wrapper {
    pub xdrgen: nlm4_testres,
    pub lock: lockd_lock,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_shareargs_wrapper {
    pub xdrgen: nlm4_shareargs,
    pub lock: lockd_lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlm4_shareres_wrapper {
    pub xdrgen: nlm4_shareres,
}
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_test(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_callback_exit(task: *mut rpc_task, data: *mut c_void) {
    static void nlm4svc_callback_exit(struct rpc_task *task, void *data)
    {
    }
#[no_mangle]
unsafe extern "C" fn nlm4svc_callback_release(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_test_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_lock_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_cancel_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_unlock_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_granted_msg(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_granted_res(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_sm_notify(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_unused(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_share(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_unshare(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_nm_lock(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nlm4svc_proc_free_all(rqstp: *mut svc_rqst) -> __be32 {
