...
#[no_mangle]
pub unsafe extern "C" fn fserror_mount(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn fserror_unmount(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn fserror_pending_dec(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn fserror_free_event(event: *mut fserror_event) {
...
#[no_mangle]
unsafe extern "C" fn fserror_worker(work: *mut work_struct) {
...
// send positive error number to userspace
    ...
    fsnotify(FS_ERROR, &report, FSNOTIFY_EVENT_ERROR, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut(), 0);
    }
    iput(event.inode);
    ...
    gfp_t gfp_flags)
    {
    struct fserror_event *event = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn fserror_init() -> int __init {
