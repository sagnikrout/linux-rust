...
extern "C" {
    pub fn gfs2_dir_del(dip: *mut gfs2_inode, dentry: *const dentry) -> c_int;
}
extern "C" {
    pub fn gfs2_dir_exhash_dealloc(dip: *mut gfs2_inode) -> c_int;
}
extern "C" {
