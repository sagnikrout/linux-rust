...
pub const DO: c_int = 0;
pub const UNDO: c_int = 1;
//
// gfs2_tune_init - Fill a gfs2_tune structure with default values
// @gt: tune
//
#[no_mangle]
unsafe extern "C" fn gfs2_tune_init(gt: *mut gfs2_tune) {
...
#[no_mangle]
pub unsafe extern "C" fn free_sbd(sdp: *mut gfs2_sbd) {
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_check_sb(sdp: *mut gfs2_sbd, silent: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfs2_sb_in(sdp: *mut gfs2_sbd, str: *const gfs2_sb) {
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_read_super(sdp: *mut gfs2_sbd, sector: sector_t, silent: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_read_sb(sdp: *mut gfs2_sbd, silent: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_names(sdp: *mut gfs2_sbd, silent: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_sb(sdp: *mut gfs2_sbd, silent: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfs2_others_may_mount(sdp: *mut gfs2_sbd) {
    static void gfs2_others_may_mount(struct gfs2_sbd *sdp)
    {
    char *message = "FIRSTMOUNT=Done";
    char *envp[] = { message, core::ptr::null_mut() };
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_jindex_hold(sdp: *mut gfs2_sbd, ji_gh: *mut gfs2_holder) -> c_int {
    ...
    error = gfs2_dir_check(sdp.sd_jindex, &name, core::ptr::null_mut());
    if (error == -ENOENT) {
    error = 0;
    break;
    }
...
//
#[no_mangle]
unsafe extern "C" fn init_statfs(sdp: *mut gfs2_sbd) -> c_int {
    static int init_statfs(struct gfs2_sbd *sdp)
    {
    let mut error: c_int = 0;
    struct inode *master = d_inode(sdp.sd_master_dir);
    struct inode *pn = core::ptr::null_mut();
    char buf[30];
    struct gfs2_jdesc *jd;
...
#[no_mangle]
unsafe extern "C" fn uninit_statfs(sdp: *mut gfs2_sbd) {
...
#[no_mangle]
unsafe extern "C" fn init_journal(sdp: *mut gfs2_sbd, undo: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_inodes(sdp: *mut gfs2_sbd, undo: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_per_node(sdp: *mut gfs2_sbd, undo: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_lm_mount(sdp: *mut gfs2_sbd, silent: c_int) -> c_int {
...
// Obsolete, but left for backward compat purposes
    ...
    if (lm.lm_mount == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn gfs2_lm_unmount(sdp: *mut gfs2_sbd) {
...
#[no_mangle]
unsafe extern "C" fn wait_on_journal(sdp: *mut gfs2_sbd) -> c_int {
    static int wait_on_journal(struct gfs2_sbd *sdp)
    {
    if (sdp.sd_lockstruct.ls_ops.lm_mount == core::ptr::null_mut())
    return 0;
#[no_mangle]
pub unsafe extern "C" fn wait_on_bit(_arg: &sdp->sd_flags, _arg: SDF_NOJOURNALID, _arg: TASK_INTERRUPTIBLE) -> return {
    return wait_on_bit(&sdp.sd_flags, SDF_NOJOURNALID, TASK_INTERRUPTIBLE)
    ? -EINTR : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn gfs2_online_uevent(sdp: *mut gfs2_sbd) {
    void gfs2_online_uevent(struct gfs2_sbd *sdp)
    {
    struct super_block *sb = sdp.sd_vfs;
    char ro[20];
    char spectator[20];
    char *envp[] = { ro, spectator, core::ptr::null_mut() };
    sprintf(ro, "RDONLY=%d", sb_rdonly(sb));
    sprintf(spectator, "SPECTATOR=%d", sdp.sd_args.ar_spectator ? 1 : 0);
    kobject_uevent_env(&sdp.sd_kobj, KOBJ_ONLINE, envp);
    }
#[no_mangle]
unsafe extern "C" fn init_threads(sdp: *mut gfs2_sbd) -> c_int {
    ...
    sdp.sd_logd_process = core::ptr::null_mut();
    return error;
    }
#[no_mangle]
pub unsafe extern "C" fn gfs2_destroy_threads(sdp: *mut gfs2_sbd) {
    ...
    sdp.sd_quotad_process = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfs2_fc_free(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn gfs2_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfs2_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfs2_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_meta_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
    static int set_meta_super(struct super_block *s, struct fs_context *fc)
    {
    return -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn test_meta_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
    static int test_meta_super(struct super_block *s, struct fs_context *fc)
    {
    return (fc.sget_key == s.s_bdev);
    }
#[no_mangle]
unsafe extern "C" fn gfs2_meta_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfs2_meta_init_fs_context(fc: *mut fs_context) -> c_int {
    static int gfs2_meta_init_fs_context(struct fs_context *fc)
    {
    let mut ret: c_int = gfs2_init_fs_context(fc);
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn gfs2_evict_inodes(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn gfs2_kill_sb(sb: *mut super_block) {
    ...
    gfs2_log_flush(sdp, core::ptr::null_mut(), GFS2_LOG_HEAD_FLUSH_SYNC | GFS2_LFC_KILL_SB);
    dput(sdp.sd_root_dir);
    dput(sdp.sd_master_dir);
    sdp.sd_root_dir = core::ptr::null_mut();
    sdp.sd_master_dir = core::ptr::null_mut();
    shrink_dcache_sb(sb);
