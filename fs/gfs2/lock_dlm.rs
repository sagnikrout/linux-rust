...
//
    let mut delta: i64 = sample - s.stats[index];
...
//
    ...
    let mut gltype: unsigned = glock_type(gl);
    let mut index: unsigned = blocking ? GFS2_LKS_SRTTB : GFS2_LKS_SRTT;
    s64 rtt;
    preempt_disable();
...
//
#[no_mangle]
pub unsafe extern "C" fn gfs2_update_request_times(gl: *mut gfs2_glock) {
...
#[no_mangle]
unsafe extern "C" fn gdlm_ast(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gdlm_bast(arg: *mut c_void, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn make_mode(sdp: *mut gfs2_sbd, lmstate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn middle_conversion(cur: c_int, req: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn down_conversion(cur: c_int, req: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gfs2_reverse_hex(c: *mut c_char, value: u64) {
...
#[no_mangle]
unsafe extern "C" fn gdlm_put_lock(gl: *mut gfs2_glock) {
...
#[no_mangle]
unsafe extern "C" fn gdlm_cancel(gl: *mut gfs2_glock) {
    static void gdlm_cancel(struct gfs2_glock *gl)
    {
    struct lm_lockstruct *ls = &glock_sbd(gl).sd_lockstruct;
    down_read(&ls.ls_sem);
    if (likely(ls.ls_dlm != core::ptr::null_mut())) {
    dlm_unlock(ls.ls_dlm, gl.gl_lksb.sb_lkid, DLM_LKF_CANCEL, core::ptr::null_mut(), gl);
    }
    up_read(&ls.ls_sem);
    }
//
...
#[no_mangle]
unsafe extern "C" fn all_jid_bits_clear(lvb: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sync_unlock(sdp: *mut gfs2_sbd, lksb: *mut dlm_lksb, name: *mut c_char) -> c_int {
    ...
    0, sync_wait_cb, ls, core::ptr::null_mut());
    }
    up_read(&ls.ls_sem);
    if (error) {
...
#[no_mangle]
unsafe extern "C" fn mounted_unlock(sdp: *mut gfs2_sbd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mounted_lock(sdp: *mut gfs2_sbd, mode: c_int, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn control_unlock(sdp: *mut gfs2_sbd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn control_lock(sdp: *mut gfs2_sbd, mode: c_int, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfs2_control_func(work: *mut work_struct) {
    static void gfs2_control_func(struct work_struct *work)
    {
    struct gfs2_sbd *sdp = container_of(work, struct gfs2_sbd, sd_control_work.work);
    struct lm_lockstruct *ls = &sdp.sd_lockstruct;
    uint32_t block_gen, start_gen, lvb_gen, flags;
    let mut recover_set: c_int = 0;
    let mut write_lvb: c_int = 0;
    int recover_size;
    int i, error;
...
#[no_mangle]
unsafe extern "C" fn control_mount(sdp: *mut gfs2_sbd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn control_first_done(sdp: *mut gfs2_sbd) -> c_int {
...
//
pub const RECOVER_SIZE_INC: c_int = 16;
    static int set_recover_size(struct gfs2_sbd *sdp, struct dlm_slot *slots,
    int num_slots)
    {
    struct lm_lockstruct *ls = &sdp.sd_lockstruct;
    uint32_t *submit = core::ptr::null_mut();
    uint32_t *result = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn free_recover_size(ls: *mut lm_lockstruct) {
    static void free_recover_size(struct lm_lockstruct *ls)
    {
    kfree(ls.ls_lvb_bits);
    kfree(ls.ls_recover_submit);
    kfree(ls.ls_recover_result);
    ls.ls_recover_submit = core::ptr::null_mut();
    ls.ls_recover_result = core::ptr::null_mut();
    ls.ls_recover_size = 0;
    ls.ls_lvb_bits = core::ptr::null_mut();
    }
// dlm calls before it does lock recovery
#[no_mangle]
unsafe extern "C" fn gdlm_recover_prep(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gdlm_recover_slot(arg: *mut c_void, slot: *mut dlm_slot) {
    static void gdlm_recover_slot(void *arg, struct dlm_slot *slot)
    {
    struct gfs2_sbd *sdp = arg;
    struct lm_lockstruct *ls = &sdp.sd_lockstruct;
    let mut jid: c_int = slot.slot - 1;
    if (gfs2_withdrawn(sdp)) {
...
#[no_mangle]
unsafe extern "C" fn gdlm_mount(sdp: *mut gfs2_sbd, table: *const c_char) -> c_int {
...
//
    ...
    ls.ls_recover_result = core::ptr::null_mut();
    ls.ls_lvb_bits = core::ptr::null_mut();
    error = set_recover_size(sdp, core::ptr::null_mut(), 0);
    if (error)
    goto fail;
//
...
#[no_mangle]
unsafe extern "C" fn gdlm_first_done(sdp: *mut gfs2_sbd) {
...
//
#[no_mangle]
unsafe extern "C" fn gdlm_unmount(sdp: *mut gfs2_sbd, clean: bool) {
