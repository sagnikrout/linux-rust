...
pub const GFS2_SMALL_FH_SIZE: c_int = 4;
pub const GFS2_LARGE_FH_SIZE: c_int = 8;
pub const GFS2_OLD_FH_SIZE: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct get_name_filldir {
    pub ctx: dir_context,
    pub inum: gfs2_inum_host,
    pub name: *mut c_char,
}
    ...
    int error;
    let mut f_ra: file_ra_state = { .start = 0 };
    if (!dir)
    return -EINVAL;
