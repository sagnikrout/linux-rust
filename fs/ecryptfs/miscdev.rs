...
//
    ...
    {
    struct ecryptfs_daemon *daemon = core::ptr::null_mut();
    int rc;
...
//
pub const PKT_TYPE_SIZE: c_int = 1;
pub const PKT_CTR_SIZE: c_int = 4;
...
pub const PKT_TYPE_OFFSET: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_init_ecryptfs_miscdev() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_destroy_ecryptfs_miscdev() {
