...
//
    ...
    struct ecryptfs_crypt_stat *crypt_stat)
    {
    let mut extent_num_in_page: loff_t = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fill_zeros_to_end_of_page(folio: *mut folio, to: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_write_inode_size_to_header(ecryptfs_inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_write_inode_size_to_xattr(ecryptfs_inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_write_inode_size_to_metadata(ecryptfs_inode: *mut inode) -> c_int {
...
//
    ...
    let mut to: unsigned = from + copied;
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
    static sector_t ecryptfs_bmap(struct address_space *mapping, sector_t block)
    {
    struct inode *lower_inode = ecryptfs_inode_to_lower(mapping.host);
    let mut ret: c_int = bmap(lower_inode, &block);
    if (ret)
    return 0;
    return block;
    }
