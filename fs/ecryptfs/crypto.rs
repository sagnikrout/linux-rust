...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_from_hex(dst: *mut c_char, src: *mut c_char, dst_size: c_int) {
    ...
    tmp[0] = src[x * 2];
    tmp[1] = src[x * 2 + 1];
    dst[x] = (unsigned char)simple_strtol(tmp, core::ptr::null_mut(), 16);
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_init_crypt_stat(crypt_stat: *mut ecryptfs_crypt_stat) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_destroy_crypt_stat(crypt_stat: *mut ecryptfs_crypt_stat) {
...
//
    ...
    let mut extent_size: usize = crypt_stat.extent_size;
    int rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_encrypt_page(folio: *mut folio) -> c_int {
    int ecryptfs_encrypt_page(struct folio *folio)
    {
    struct inode *ecryptfs_inode;
    struct ecryptfs_crypt_stat *crypt_stat;
    char *enc_extent_virt;
    struct page *enc_extent_page = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_decrypt_page(folio: *mut folio) -> c_int {
...
pub const ECRYPTFS_MAX_SCATTERLIST_LEN: c_int = 4;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_init_crypt_ctx(crypt_stat: *mut ecryptfs_crypt_stat) -> c_int {
    ...
    crypt_stat.tfm = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn set_extent_mask_and_shift(crypt_stat: *mut ecryptfs_crypt_stat) {
...
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_set_default_sizes(crypt_stat: *mut ecryptfs_crypt_stat) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_compute_root_iv(crypt_stat: *mut ecryptfs_crypt_stat) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_generate_new_key(crypt_stat: *mut ecryptfs_crypt_stat) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_new_file_context(ecryptfs_inode: *mut inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_validate_marker(data: *mut c_char) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecryptfs_flag_map_elem {
    pub file_flag: u32,
    pub local_flag: u32,
}
...
//
#[no_mangle]
unsafe extern "C" fn write_ecryptfs_marker(page_virt: *mut c_char, written: *mut usize) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecryptfs_cipher_code_str_map_elem {
    pub cipher_str: [c_char; 16],
    pub cipher_code: u8,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_code_for_cipher_string(cipher_name: *mut c_char, key_bytes: usize) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_cipher_code_to_string(str: *mut c_char, size: usize, cipher_code: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_read_and_validate_header_region(inode: *mut inode) -> c_int {
    ...
    return rc;
#[no_mangle]
pub unsafe extern "C" fn if(ECRYPTFS_SIZE_AND_MARKER_BYTES: rc <) -> else {
...
pub const ECRYPTFS_DONT_VALIDATE_HEADER_SIZE: c_int = 0;
pub const ECRYPTFS_VALIDATE_HEADER_SIZE: c_int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn set_default_header_data(crypt_stat: *mut ecryptfs_crypt_stat) {
    static void set_default_header_data(struct ecryptfs_crypt_stat *crypt_stat)
    {
    crypt_stat.metadata_size = ECRYPTFS_MINIMUM_HEADER_EXTENT_SIZE;
    }
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_i_size_init(page_virt: *const c_char, inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_read_xattr_region(page_virt: *mut c_char, ecryptfs_inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_read_metadata(ecryptfs_dentry: *mut dentry) -> c_int {
...
//
    ...
    {
    let mut rc: c_int = 0;
    filename.encrypted_filename = core::ptr::null_mut();
    ...
    mount_crypt_stat, core::ptr::null_mut(),
...
//
    ...
    char *full_alg_name = core::ptr::null_mut();
    int rc;
// key_tfm = NULL;
...
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_init_crypto() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_destroy_crypto() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_tfm_exists(cipher_name: *mut c_char, key_tfm: *mut ecryptfs_key_tfm) -> c_int {
...
//
    ...
    let mut rc: c_int = 0;
    (*tfm) = core::ptr::null_mut();
    (*tfm_mutex) = core::ptr::null_mut();
    mutex_lock(&key_tfm_list_mutex);
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_max_decoded_size(encoded_size: usize) -> usize {
...
//
    ...
    let mut rc: c_int = 0;
    (*encoded_name) = core::ptr::null_mut();
    (*encoded_name_size) = 0;
    if (mount_crypt_stat && (mount_crypt_stat.flags
    ...
    ecryptfs_encode_for_filename(
    core::ptr::null_mut(), &encoded_name_no_prefix_size,
    filename.encrypted_filename,
    filename.encrypted_filename_size);
    if (mount_crypt_stat.flags
    & ECRYPTFS_GLOBAL_ENCFN_USE_MOUNT_FNEK)
...
//
    ...
    ecryptfs_decode_from_filename(core::ptr::null_mut(), &decoded_name_size,
    name, name_size);
...
pub const ENC_NAME_MAX_BLOCKLEN_8_OR_16: c_int = 143;
