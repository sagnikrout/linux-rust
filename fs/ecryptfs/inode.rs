...
#[no_mangle]
unsafe extern "C" fn ecryptfs_inode_test(inode: *mut inode, lower_inode: *mut c_void) -> c_int {
    static int ecryptfs_inode_test(struct inode *inode, void *lower_inode)
    {
    return ecryptfs_inode_to_lower(inode) == lower_inode;
    }
#[no_mangle]
unsafe extern "C" fn ecryptfs_inode_set(inode: *mut inode, opaque: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: special_file(inode->i_mode)) -> else {
...
//
    ...
    rc = vfs_unlink(&nop_mnt_idmap, lower_dir, lower_dentry, core::ptr::null_mut());
    if (rc) {
...
//
    ...
    lower_dir = lower_dentry.d_parent.d_inode;
    rc = vfs_create(&nop_mnt_idmap, lower_dentry, mode, core::ptr::null_mut());
    if (rc) {
    ...
    if (IS_ERR(inode)) {
    vfs_unlink(&nop_mnt_idmap, lower_dir, lower_dentry, core::ptr::null_mut());
    goto out_lock;
    }
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_i_size_read(dentry: *mut dentry, inode: *mut inode) -> c_int {
...
//
    ...
    unsigned int flags)
    {
    char *encrypted_and_encoded_name = core::ptr::null_mut();
    ...
    lower_new_dentry, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
    ...
    struct ecryptfs_mount_crypt_stat *mount_crypt_stat = core::ptr::null_mut();
    ...
    encoded_symname, core::ptr::null_mut());
    ...
    lower_dentry, mode, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
    ...
    return PTR_ERR(lower_dentry);
    lower_dir = lower_dentry.d_parent.d_inode;
    rc = vfs_rmdir(&nop_mnt_idmap, lower_dir, lower_dentry, core::ptr::null_mut());
    if (!rc) {
    ...
    return PTR_ERR(lower_dentry);
    lower_dir = lower_dentry.d_parent.d_inode;
    rc = vfs_mknod(&nop_mnt_idmap, lower_dir, lower_dentry, mode, dev, core::ptr::null_mut());
    if (rc || d_really_is_negative(lower_dentry))
    goto out;
    rc = ecryptfs_interpose(lower_dentry, dentry, dir.i_sb);
    if (rc)
...
//
#[no_mangle]
unsafe extern "C" fn __ecryptfs_truncate(dentry: *mut dentry, ia: *const iattr) -> c_int {
...
//
    ...
    rc = notify_change(&nop_mnt_idmap, lower_dentry, &lower_ia, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_truncate(dentry: *mut dentry, new_length: loff_t) -> c_int {
...
//
    ...
    let mut lower_path: path = ecryptfs_lower_path(dentry);
    int rc;
    ...
    rc = __vfs_setxattr_locked(&nop_mnt_idmap, lower_dentry, name, value, size, flags, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ecryptfs_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
