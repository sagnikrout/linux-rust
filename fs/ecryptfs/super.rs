...
#[no_mangle]
unsafe extern "C" fn ecryptfs_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_destroy_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_evict_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
