...
//
#[no_mangle]
unsafe extern "C" fn process_request_key_err(err_code: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_find_global_auth_tok_for_sig_err(err_code: c_int) -> c_int {
    static int process_find_global_auth_tok_for_sig_err(int err_code)
    {
    let mut rc: c_int = err_code;
    switch (err_code) {
    case -ENOENT:
...
// packet_len = i;
    ...
    let mut expected_checksum: u16 = 0;
    int rc;
//
...
//
#[no_mangle]
unsafe extern "C" fn ecryptfs_verify_version(version: u16) -> c_int {
...
// auth_tok = NULL;
    ...
    let mut rc: c_int = 0;
    (*auth_tok_key) = core::ptr::null_mut();
    (*auth_tok) = core::ptr::null_mut();
    ...
    walker.global_auth_tok_key = core::ptr::null_mut();
    out:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecryptfs_write_tag_70_packet_silly_stack {
    pub cipher_code: u8,
    pub max_packet_size: usize,
    pub packet_size_len: usize,
    pub block_aligned_filename_size: usize,
    pub block_size: usize,
    pub i: usize,
    pub j: usize,
    pub num_rand_bytes: usize,
    pub tfm_mutex: *mut mutex,
    pub block_aligned_filename: *mut c_char,
    pub auth_tok: *mut ecryptfs_auth_tok,
    pub src_sg: [scatterlist; 2],
    pub dst_sg: [scatterlist; 2],
    pub skcipher_tfm: *mut crypto_skcipher,
    pub skcipher_req: *mut skcipher_request,
    pub iv: [c_char; ECRYPTFS_MAX_IV_BYTES],
    pub hash: [c_char; MD5_DIGEST_SIZE],
}
...
//
    ...
    struct key *auth_tok_key = core::ptr::null_mut();
    let mut rc: c_int = 0;
    s = kzalloc_obj(*s);
    if (!s)
    return -ENOMEM;
...
// separator, and then the filename
    ...
    CRYPTO_TFM_REQ_MAY_SLEEP, core::ptr::null_mut(), core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecryptfs_parse_tag_70_packet_silly_stack {
    pub cipher_code: u8,
    pub max_packet_size: usize,
    pub packet_size_len: usize,
    pub parsed_tag_70_packet_size: usize,
    pub block_aligned_filename_size: usize,
    pub block_size: usize,
    pub i: usize,
    pub tfm_mutex: *mut mutex,
    pub decrypted_filename: *mut c_char,
    pub auth_tok: *mut ecryptfs_auth_tok,
    pub src_sg: [scatterlist; 2],
    pub dst_sg: [scatterlist; 2],
    pub skcipher_tfm: *mut crypto_skcipher,
    pub skcipher_req: *mut skcipher_request,
    pub 1]: char fnek_sig_hex[ECRYPTFS_SIG_SIZE_HEX +,
    pub iv: [c_char; ECRYPTFS_MAX_IV_BYTES],
    pub 1]: char cipher_string[ECRYPTFS_MAX_CIPHER_NAME_SIZE +,
}
...
//
    ...
    {
    let mut cipher_code: u8 = 0;
    struct ecryptfs_msg_ctx *msg_ctx;
    struct ecryptfs_message *msg = core::ptr::null_mut();
    char *auth_tok_sig;
    char *payload = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn wipe_auth_tok_list(auth_tok_list_head: *mut list_head) {
...
//
    ...
    let mut rc: c_int = 0;
    (*packet_size) = 0;
    (*new_auth_tok) = core::ptr::null_mut();
//
...
//
    ...
    {
    let mut rc: c_int = 0;
    (*auth_tok_key) = request_key(&key_type_user, sig, core::ptr::null_mut());
...
// just one will be sufficient to decrypt to get the FEK.
    ...
    {
    struct ecryptfs_msg_ctx *msg_ctx = core::ptr::null_mut();
    char *payload = core::ptr::null_mut();
    let mut payload_len: usize = 0;
    struct ecryptfs_message *msg;
    int rc;
...
//
    ...
    {
    size_t i;
    let mut encrypted_session_key_valid: usize = 0;
    size_t packet_size_length;
    size_t max_packet_size;
    let mut rc: c_int = 0;
    (*packet_size) = 0;
...
//
    ...
    struct scatterlist dst_sg[2];
    struct scatterlist src_sg[2];
    struct mutex *tfm_mutex = core::ptr::null_mut();
    u8 cipher_code;
    size_t packet_size_length;
    size_t max_packet_size;
    struct ecryptfs_mount_crypt_stat *mount_crypt_stat =
    ...
    crypt_stat.key_size);
    skcipher_request_set_crypt(req, src_sg, dst_sg,
    (*key_rec).enc_key_size, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ecryptfs_add_keysig(crypt_stat: *mut ecryptfs_crypt_stat, sig: *mut c_char) -> c_int {
