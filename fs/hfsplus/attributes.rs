...
//! Source: fs/hfsplus/attributes.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_create_attr_tree_cache() -> int __init {
...
//
    ...
    {
    let mut err: c_int = 0;
    hfs_dbg("name %s, cnid %d\n", name ? name : core::ptr::null_mut(), cnid);
...
// file exists but xattr is absent
    ...
    err = hfsplus_attr_build_key(sb, fd.search_key, cnid, core::ptr::null_mut());
    if (err)
    goto failed_find_attr;
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_attr_exists(inode: *mut inode, name: *const c_char) -> c_int {
    ...
    name ? name : core::ptr::null_mut(), inode.i_ino);
    if (!HFSPLUS_SB(sb).attr_tree)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_delete_attr(inode: *mut inode, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_delete_all_attrs(dir: *mut inode, cnid: u32) -> c_int {
    ...
    return err;
    for (;;) {
    err = hfsplus_find_attr(dir.i_sb, cnid, core::ptr::null_mut(), &fd);
