...
//
pub const CLUMP_ENTRIES: c_int = 15;
...
// 16TB */	512,		512,		32
    ...
    {
    let mut mod: u32 = max(node_size, block_size);
    u32 clump_size;
    int column;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn hfs_bmap_test_bit(node: *mut hfs_bnode, node_bit_idx: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn hfs_bmap_clear_bit(node: *mut hfs_bnode, node_bit_idx: u32) -> c_int {
...
// Get a reference to a B*Tree and do some initial checks
    ...
    page = read_mapping_page(mapping, 0, core::ptr::null_mut());
    if (IS_ERR(page))
    goto free_inode;
// Load the header
...
#[no_mangle]
pub unsafe extern "C" fn hfs_btree_close(tree: *mut hfs_btree) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_btree_write(tree: *mut hfs_btree) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bmap_reserve(tree: *mut hfs_btree, rsvd_nodes: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bmap_free(node: *mut hfs_bnode) {
