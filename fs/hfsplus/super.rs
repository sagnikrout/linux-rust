...
#[no_mangle]
unsafe extern "C" fn hfsplus_system_read_inode(inode: *mut inode) -> c_int {
...
//
    ...
    HFSPLUS_I(inode).rsrc_inode = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hfsplus_system_write_inode(inode: *mut inode) -> c_int {
    static int hfsplus_system_write_inode(struct inode *inode)
    {
    struct hfsplus_sb_info *sbi = HFSPLUS_SB(inode.i_sb);
    struct hfsplus_vh *vhdr = sbi.s_vhdr;
    struct hfsplus_fork_raw *fork;
    struct hfs_btree *tree = core::ptr::null_mut();
    switch (inode.i_ino) {
    case HFSPLUS_EXT_CNID:
    fork = &vhdr.ext_file;
    tree = sbi.ext_tree;
    ...
    let mut err: c_int = hfs_btree_write(tree);
...
#[no_mangle]
unsafe extern "C" fn hfsplus_evict_inode(inode: *mut inode) {
    ...
    HFSPLUS_I(HFSPLUS_I(inode).rsrc_inode).rsrc_inode = core::ptr::null_mut();
    iput(HFSPLUS_I(inode).rsrc_inode);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn hfsplus_commit_superblock(sb: *mut super_block) -> c_int {
    int hfsplus_commit_superblock(struct super_block *sb)
    {
    struct hfsplus_sb_info *sbi = HFSPLUS_SB(sb);
    struct hfsplus_vh *vhdr = sbi.s_vhdr;
    let mut write_backup: c_int = 0;
    let mut error: c_int = 0, error2;
    hfs_dbg("starting...\n");
    ...
    sbi.s_vhdr_buf, core::ptr::null_mut(), REQ_OP_WRITE);
    if (!error)
    error = error2;
    if (!write_backup)
    goto out;
    ...
    sbi.s_backup_vhdr_buf, core::ptr::null_mut(), REQ_OP_WRITE);
    if (!error)
    error = error2;
    out:
...
#[no_mangle]
unsafe extern "C" fn hfsplus_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delayed_sync_fs(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_mark_mdb_dirty(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_prepare_volume_header_for_commit(vhdr: *mut hfsplus_vh) {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
//
    ...
    return i ? &i.vfs_inode : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn hfsplus_free_inode(inode: *mut inode) {
    static void hfsplus_free_inode(struct inode *inode)
    {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_get_tree(fc: *mut fs_context) -> c_int {
    static int hfsplus_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, hfsplus_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn hfsplus_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_kill_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_init_once(p: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn init_hfsplus_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_hfsplus_fs() -> void __exit {
