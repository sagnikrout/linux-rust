...
#[no_mangle]
pub unsafe extern "C" fn hfs_brec_lenoff(node: *mut hfs_bnode, rec: u16, off: *mut u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_brec_keylen(node: *mut hfs_bnode, rec: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_brec_insert(fd: *mut hfs_find_data, entry: *mut c_void, entry_len: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_brec_remove(fd: *mut hfs_find_data) -> c_int {
...
// fill hole
    ...
    let mut node_desc_size: usize = sizeof(struct hfs_bnode_desc);
    let mut rec_size: usize = sizeof(__be16);
    tree = fd.tree;
    node = fd.bnode;
...
#[no_mangle]
unsafe extern "C" fn hfs_brec_update_parent(fd: *mut hfs_find_data) -> c_int {
    static int hfs_brec_update_parent(struct hfs_find_data *fd)
    {
    struct hfs_btree *tree;
...
#[no_mangle]
unsafe extern "C" fn hfs_btree_inc_height(tree: *mut hfs_btree) -> c_int {
