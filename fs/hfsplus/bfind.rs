...
#[no_mangle]
pub unsafe extern "C" fn hfs_find_init(tree: *mut hfs_btree, fd: *mut hfs_find_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_find_exit(fd: *mut hfs_find_data) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_brec_find(fd: *mut hfs_find_data, do_key_compare: search_strategy_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_brec_read(fd: *mut hfs_find_data, rec: *mut c_void, rec_len: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_brec_goto(fd: *mut hfs_find_data, cnt: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfsplus_brec_read_cat(fd: *mut hfs_find_data, entry: *mut hfsplus_cat_entry) -> c_int {
