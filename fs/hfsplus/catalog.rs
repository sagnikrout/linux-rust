...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_cat_set_perms(inode: *mut inode, perms: *mut hfsplus_perm) {
...
#[no_mangle]
pub unsafe extern "C" fn if(S_ISCHR(inode->i_mode): S_ISBLK(inode->i_mode) ||) -> else {
...
// Try to get a catalog entry for given catalog id
    ...
    {
    let mut tmp: hfsplus_cat_entry = {0};
    int err;
    u16 type;
...
#[no_mangle]
unsafe extern "C" fn hfsplus_subfolders_inc(dir: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_subfolders_dec(dir: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_delete_cat(cnid: u32, dir: *mut inode, str: *const qstr) -> c_int {
...
//
    ...
    goto out;
    if (!str) {
    let mut entry: hfsplus_cat_entry = {0};
    hfsplus_cat_build_key_with_cnid(sb, fd.search_key, cnid);
