...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_fill_defaults(opts: *mut hfsplus_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
