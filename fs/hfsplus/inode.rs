...
#[no_mangle]
unsafe extern "C" fn hfsplus_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int hfsplus_read_folio(struct file *file, struct folio *folio)
    {
    return block_read_full_folio(folio, hfsplus_get_block);
    }
#[no_mangle]
unsafe extern "C" fn hfsplus_write_failed(mapping: *mut address_space, to: loff_t) {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
    static sector_t hfsplus_bmap(struct address_space *mapping, sector_t block)
    {
    return generic_block_bmap(mapping, block, hfsplus_get_block);
    }
#[no_mangle]
unsafe extern "C" fn hfsplus_release_folio(folio: *mut folio, mask: gfp_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_direct_IO(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_file_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfsplus_file_release(inode: *mut inode, file: *mut file) -> c_int {
    ...
    HFSPLUS_SB(sb).hidden_dir, core::ptr::null_mut());
...
//
    ...
    hip.phys_size = 0;
    hip.fs_blocks = 0;
    hip.rsrc_inode = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_delete_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_inode_read_fork(inode: *mut inode, fork: *mut hfsplus_fork_raw) {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_cat_read_inode(inode: *mut inode, fd: *mut hfs_find_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_cat_write_inode(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
    ...
    struct hfsplus_inode_info *hip = HFSPLUS_I(inode);
    struct hfsplus_sb_info *sbi = HFSPLUS_SB(inode.i_sb);
    let mut allowed: c_uint = FS_IMMUTABLE_FL | FS_APPEND_FL | FS_NODUMP_FL;
