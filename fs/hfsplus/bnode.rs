...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_read(node: *mut hfs_bnode, buf: *mut c_void, off: u32, len: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_read_u16(node: *mut hfs_bnode, off: u32) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_read_u8(node: *mut hfs_bnode, off: u32) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_read_key(node: *mut hfs_bnode, key: *mut c_void, off: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_write(node: *mut hfs_bnode, buf: *mut c_void, off: u32, len: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_write_u16(node: *mut hfs_bnode, off: u32, data: u16) {
    void hfs_bnode_write_u16(struct hfs_bnode *node, u32 off, u16 data)
    {
    let mut v: __be16 = cpu_to_be16(data);
// TODO: optimize later...
    hfs_bnode_write(node, &v, off, 2);
    }
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_clear(node: *mut hfs_bnode, off: u32, len: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_move(node: *mut hfs_bnode, dst: u32, src: u32, len: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_dump(node: *mut hfs_bnode) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_unlink(node: *mut hfs_bnode) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_hash(num: u32) -> c_int {
    ...
    page = read_mapping_page(mapping, block, core::ptr::null_mut());
    if (IS_ERR(page))
    goto fail;
    node.page[i] = page;
    }
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_unhash(node: *mut hfs_bnode) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_free(node: *mut hfs_bnode) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_get(node: *mut hfs_bnode) {
...
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_put(node: *mut hfs_bnode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfs_bnode_need_zeroout(tree: *mut hfs_btree) -> bool {
    bool hfs_bnode_need_zeroout(struct hfs_btree *tree)
    {
    struct super_block *sb = tree.inode.i_sb;
    struct hfsplus_sb_info *sbi = HFSPLUS_SB(sb);
    let mut volume_attr: u32 = be32_to_cpu(sbi.s_vhdr.attributes);
