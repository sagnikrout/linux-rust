...
//
    ...
    {
    let mut io_size: u64 = hfsplus_min_io_size(sb);
    let mut start: loff_t = (loff_t)sector << HFSPLUS_SECTOR_SHIFT;
    let mut offset: c_int = start & (io_size - 1);
...
#[no_mangle]
unsafe extern "C" fn hfsplus_read_mdb(bufptr: *mut c_void, wd: *mut hfsplus_wd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfsplus_read_wrapper(sb: *mut super_block) -> c_int {
