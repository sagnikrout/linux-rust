...
#[no_mangle]
unsafe extern "C" fn afs_vlserver_rcu(rcu: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn afs_put_vlserver(net: *mut afs_net, vlserver: *mut afs_vlserver) {
...
#[no_mangle]
pub unsafe extern "C" fn afs_put_vlserverlist(net: *mut afs_net, vllist: *mut afs_vlserver_list) {
...
#[no_mangle]
unsafe extern "C" fn afs_extract_le16(_b: *const u8) -> u16 {
...
//
    ...
    let mut ret: c_int = -ENOMEM, nr_servers, i, j;
    _enter("");
