...
#[no_mangle]
unsafe extern "C" fn afs_silly_rename_success(op: *mut afs_operation) {
...
#[no_mangle]
unsafe extern "C" fn afs_silly_rename_edit_dir(op: *mut afs_operation) {
...
#[no_mangle]
unsafe extern "C" fn afs_silly_unlink_success(op: *mut afs_operation) {
...
#[no_mangle]
unsafe extern "C" fn afs_silly_unlink_edit_dir(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_silly_iput(dentry: *mut dentry, inode: *mut inode) -> c_int {
...
// Stop lock-release from complaining.
    ...
    trace_afs_flock_ev(vnode, core::ptr::null_mut(), afs_flock_silly_delete, 0);
