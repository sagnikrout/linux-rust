...
//
#[no_mangle]
pub unsafe extern "C" fn afs_invalidate_mmap_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn afs_volume_init_callback(volume: *mut afs_volume) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_init_callback_state(server: *mut afs_server) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __afs_break_callback(vnode: *mut afs_vnode, reason: enum afs_cb_break_reason) {
...
#[no_mangle]
pub unsafe extern "C" fn afs_break_callback(vnode: *mut afs_vnode, reason: enum afs_cb_break_reason) {
...
//
    ...
    afs_volid_t vid)
    {
    struct afs_volume *volume = core::ptr::null_mut();
    struct rb_node *p;
...
#[no_mangle]
pub unsafe extern "C" fn if(vid: volume->vid >) -> else {
...
//
    ...
    struct afs_volume *volume;
    let mut vid: afs_volid_t = cbb.fid.vid;
    size_t i;
    rcu_read_lock();
...
//
    ...
    ASSERT(server != core::ptr::null_mut());
    while (count > 0)
