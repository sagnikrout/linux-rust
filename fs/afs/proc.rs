...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct afs_vl_seq_net_private {
    pub /: *mut *mut seq_net_private seq; / Must be first,
    pub vllist: *mut afs_vlserver_list,
}
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_cells_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_proc_cells_stop(m: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_cells_write(file: *mut file, buf: *mut c_char, size: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_addr_prefs_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_rootcell_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_rootcell_write(file: *mut file, buf: *mut c_char, size: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_cell_volumes_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_proc_cell_volumes_stop(m: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_cell_vlservers_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_proc_cell_vlservers_stop(m: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_servers_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_proc_servers_stop(m: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_sysname_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    static int afs_proc_sysname_show(struct seq_file *m, void *v)
    {
    struct afs_net *net = afs_seq2net(m);
    struct afs_sysnames *sysnames = net.sysnames;
    let mut i: c_uint = (unsigned long)v - 1;
    if (i < sysnames.nr)
    seq_printf(m, "%s\n", sysnames.subs[i]);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn afs_proc_sysname_stop(m: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_sysname_write(file: *mut file, buf: *mut c_char, size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn afs_put_sysnames(sysnames: *mut afs_sysnames) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_proc_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_proc_cell_setup(cell: *mut afs_cell) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_proc_cell_remove(cell: *mut afs_cell) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_proc_init(net: *mut afs_net) -> c_int {
    ...
    sizeof(struct seq_net_private)) ||
    !proc_create_net_single("stats", 0444, p, afs_proc_stats_show, core::ptr::null_mut()) ||
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_proc_cleanup(net: *mut afs_net) {
    void afs_proc_cleanup(struct afs_net *net)
    {
    proc_remove(net.proc_afs);
    net.proc_afs = core::ptr::null_mut();
    }
