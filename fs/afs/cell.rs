...
//
    ...
    let mut afs_cell_gc_delay: static unsigned __read_mostly = 10;
    let mut afs_cell_min_ttl: static unsigned __read_mostly = 10 * 60;
    let mut afs_cell_max_ttl: static unsigned __read_mostly = 24 * 60 * 60;
...
#[no_mangle]
unsafe extern "C" fn afs_dec_cells_outstanding(net: *mut afs_net) {
...
#[no_mangle]
unsafe extern "C" fn afs_set_cell_state(cell: *mut afs_cell, state: enum afs_cell_state) {
...
//
    ...
    {
    struct afs_vlserver_list *vllist = core::ptr::null_mut();
    struct afs_cell *cell;
    int i, ret;
    ASSERT(name);
    if (namelen == 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_cell_init(net: *mut afs_net, rootcell: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_update_cell(cell: *mut afs_cell) -> c_int {
    static int afs_update_cell(struct afs_cell *cell)
    {
    struct afs_vlserver_list *vllist, *old = core::ptr::null_mut(), *p;
    let mut min_ttl: c_uint = READ_ONCE(afs_cell_min_ttl);
    let mut max_ttl: c_uint = READ_ONCE(afs_cell_max_ttl);
    ...
    expiry = now + min_ttl;
#[no_mangle]
pub unsafe extern "C" fn if(max_ttl: expiry > now +) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn afs_cell_destroy(rcu: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn afs_destroy_cell_work(work: *mut work_struct) {
    static void afs_destroy_cell_work(struct work_struct *work)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_put_cell(cell: *mut afs_cell, reason: enum afs_cell_trace) {
    void afs_put_cell(struct afs_cell *cell, enum afs_cell_trace reason)
    {
    if (cell) {
    let mut debug_id: c_uint = cell.debug_id;
    unsigned int a;
    bool zero;
    int r;
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_unuse_cell(cell: *mut afs_cell, reason: enum afs_cell_trace) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_see_cell(cell: *mut afs_cell, reason: enum afs_cell_trace) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_queue_cell(cell: *mut afs_cell, reason: enum afs_cell_trace) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_cell_timer(timer: *mut timer_list) {
    static void afs_cell_timer(struct timer_list *timer)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_set_cell_timer(cell: *mut afs_cell, delay_secs: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_activate_cell(net: *mut afs_net, cell: *mut afs_cell) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deactivate_cell(net: *mut afs_net, cell: *mut afs_cell) {
...
#[no_mangle]
unsafe extern "C" fn afs_has_cell_expired(cell: *mut afs_cell, _next_manage: *mut time64_t) -> bool {
    static bool afs_has_cell_expired(struct afs_cell *cell, time64_t *_next_manage)
    {
    const struct afs_vlserver_list *vllist;
    let mut expire_at: time64_t = cell.last_inactive;
...
//
#[no_mangle]
unsafe extern "C" fn afs_manage_cell(cell: *mut afs_cell) -> bool {
    static bool afs_manage_cell(struct afs_cell *cell)
    {
    struct afs_net *net = cell.net;
    let mut next_manage: time64_t = TIME64_MAX;
    int ret;
    _enter("%s", cell.name);
...
// The root volume is pinning the cell
    ...
    cell.root_volume = core::ptr::null_mut();
    afs_set_cell_state(cell, AFS_CELL_DEAD);
    return true;
    }
#[no_mangle]
unsafe extern "C" fn afs_manage_cell_work(work: *mut work_struct) {
    static void afs_manage_cell_work(struct work_struct *work)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_cell_purge(net: *mut afs_net) {
    ...
    _enter("");
    down_write(&net.cells_lock);
    ws = rcu_replace_pointer(net.ws_cell, core::ptr::null_mut(),
    lockdep_is_held(&net.cells_lock));
    up_write(&net.cells_lock);
