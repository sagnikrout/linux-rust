...
//
#[no_mangle]
unsafe extern "C" fn afs_start_vl_iteration(vc: *mut afs_vl_cursor) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_select_vlserver(vc: *mut afs_vl_cursor) -> bool {
    ...
    unsigned int rtt;
    let mut abort_code: i32 = vc.call_abort_code;
    let mut error: c_int = vc.call_error, i;
    vc.nr_iterations++;
...
// write_unlock(&vc->cell->vl_servers_lock);
    ...
    alist = vc.alist = core::ptr::null_mut();
    afs_put_vlserverlist(vc.cell.net, vc.server_list);
    vc.server_list = core::ptr::null_mut();
    if (vc.flags & AFS_VL_CURSOR_RETRIED)
    goto failed;
    vc.flags |= AFS_VL_CURSOR_RETRIED;
    start:
    _debug("start");
    ASSERTCMP(alist, ==, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn afs_vl_dump_edestaddrreq(vc: *const afs_vl_cursor) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_end_vlserver_operation(vc: *mut afs_vl_cursor) -> c_int {
