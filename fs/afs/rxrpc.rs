...
//
#[no_mangle]
pub unsafe extern "C" fn afs_open_socket(net: *mut afs_net) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_close_socket(net: *mut afs_net) {
...
// Make sure work items are no longer running.
    ...
    net.spare_incoming_call = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn afs_free_call(call: *mut afs_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_put_call(call: *mut afs_call) {
    void afs_put_call(struct afs_call *call)
    {
    struct afs_net *net = call.net;
    let mut debug_id: c_uint = call.debug_id;
    bool zero;
    int r, o;
...
#[no_mangle]
unsafe extern "C" fn afs_deferred_free_worker(work: *mut work_struct) {
    static void afs_deferred_free_worker(struct work_struct *work)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_deferred_put_call(call: *mut afs_call) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_queue_call_work(call: *mut afs_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_flat_call_destructor(call: *mut afs_call) {
    void afs_flat_call_destructor(struct afs_call *call)
    {
    _enter("");
    kfree(call.request);
    call.request = core::ptr::null_mut();
    kfree(call.buffer);
    call.buffer = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_make_call(call: *mut afs_call, gfp: gfp_t) {
    ...
    ASSERT(call.type != core::ptr::null_mut());
    ASSERT(call.type.name != core::ptr::null_mut());
...
//
    ...
    if (ret == -ECONNABORTED) {
    len = 0;
    iov_iter_kvec(&msg.msg_iter, ITER_DEST, core::ptr::null_mut(), 0, 0);
...
//
#[no_mangle]
unsafe extern "C" fn afs_log_error(call: *mut afs_call, remote_abort: i32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_deliver_to_call(call: *mut afs_call) {
    ...
    len = 0;
    iov_iter_kvec(&call.def_iter, ITER_DEST, core::ptr::null_mut(), 0, 0);
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_wait_for_call_to_complete(call: *mut afs_call) {
    void afs_wait_for_call_to_complete(struct afs_call *call)
    {
    let mut rxrpc_complete: bool = false;
    _enter("");
...
//
#[no_mangle]
unsafe extern "C" fn afs_process_async_call(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn afs_rx_attach(rxcall: *mut rxrpc_call, user_call_ID: c_ulong) {
    static void afs_rx_attach(struct rxrpc_call *rxcall, unsigned long user_call_ID)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_charge_preallocation(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_cm_op_id(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_send_empty_reply(call: *mut afs_call) {
    ...
    msg.msg_name		= core::ptr::null_mut();
    msg.msg_namelen		= 0;
    iov_iter_kvec(&msg.msg_iter, ITER_SOURCE, core::ptr::null_mut(), 0, 0);
    msg.msg_control		= core::ptr::null_mut();
    msg.msg_controllen	= 0;
    msg.msg_flags		= 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_send_simple_reply(call: *mut afs_call, buf: *const c_void, len: usize) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_extract_data(call: *mut afs_call, want_more: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_rx_notify_oob(sk: *mut sock, oob: *mut sk_buff) {
    static void afs_rx_notify_oob(struct sock *sk, struct sk_buff *oob)
    {
