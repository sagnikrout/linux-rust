...
#[no_mangle]
pub unsafe extern "C" fn afs_clear_server_states(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_busy(op: *mut afs_operation, abort_code: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_sleep_and_retry(op: *mut afs_operation) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_select_fileserver(op: *mut afs_operation) -> bool {
    ...
    let mut abort_code: i32 = op.call_abort_code;
    let mut best_prio: c_int = 0;
    let mut error: c_int = op.call_error, addr_index, i, j;
    op.nr_iterations++;
...
// Handle downgrading to an older operation.
    ...
    _debug("restart");
    op.estate = core::ptr::null_mut();
    op.server = core::ptr::null_mut();
    afs_clear_server_states(op);
    op.server_states = core::ptr::null_mut();
    afs_put_serverlist(op.net, op.server_list);
    op.server_list = core::ptr::null_mut();
    start:
    _debug("start");
    ASSERTCMP(op.estate, ==, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_dump_edestaddrreq(op: *const afs_operation) {
