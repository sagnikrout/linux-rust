...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_exit() {
...
unsafe extern "C" fn afs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
    ...
    {
    struct afs_super_info *as = AFS_FS_S(root.d_sb);
    const char *p = core::ptr::null_mut();
    if (as.dyn_root)
    seq_puts(m, ",dyn");
...
// lookup the cell record
    ...
    core::ptr::null_mut(), AFS_LOOKUP_CELL_DIRECT_MOUNT,
...
//
#[no_mangle]
unsafe extern "C" fn afs_validate_fc(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_test_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_dynroot_test_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_set_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_fill_super(sb: *mut super_block, ctx: *mut afs_fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_destroy_sbi(as: *mut afs_super_info) {
...
//
    if (as.volume)
    rcu_assign_pointer(as.volume.sb, core::ptr::null_mut());
    kill_anon_super(sb);
    if (as.volume)
...
// Default to the workstation cell.
    cell = afs_find_cell(ctx.net, core::ptr::null_mut(), 0, afs_cell_trace_use_fc);
    if (IS_ERR(cell))
...
//
#[no_mangle]
unsafe extern "C" fn afs_i_init_once(_vnode: *mut c_void) {
...
// Reset anything that shouldn't leak from one inode to the next.
    ...
    afs_vnode_set_cache(vnode, core::ptr::null_mut());
    vnode.volume		= core::ptr::null_mut();
    vnode.lock_key		= core::ptr::null_mut();
    vnode.permit_cache	= core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn afs_free_inode(inode: *mut inode) {
    static void afs_free_inode(struct inode *inode)
    {
...
//
#[no_mangle]
unsafe extern "C" fn afs_destroy_inode(inode: *mut inode) {
    static void afs_destroy_inode(struct inode *inode)
    {
...
#[no_mangle]
unsafe extern "C" fn afs_get_volume_status_success(op: *mut afs_operation) {
...
unsafe extern "C" fn afs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    ...
    op = afs_alloc_operation(core::ptr::null_mut(), as.volume);
    if (IS_ERR(op))
    return PTR_ERR(op);
