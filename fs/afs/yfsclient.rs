...
#[no_mangle]
unsafe extern "C" fn xdr_decode_YFSFid(_bp: *const __be32, fid: *mut afs_fid) {
...
#[no_mangle]
unsafe extern "C" fn xdr_strlen(len: c_uint) -> usize {
...
#[no_mangle]
unsafe extern "C" fn linux_to_yfs_time(t: *const timespec64) -> i64 {
...
// Convert to 100ns intervals.
    ...
    let mut masked_mode: mode_t = mode ? *mode & S_IALLUGO : 0;
    let mut mtime: i64 = linux_to_yfs_time(t);
    let mut mask: u32 = AFS_SET_MTIME;
...
//
#[no_mangle]
unsafe extern "C" fn yfs_time_to_linux(t: i64) -> timespec64 {
...
#[no_mangle]
unsafe extern "C" fn xdr_to_time(xdr: yfs_xdr_u64) -> timespec64 {
    static struct timespec64 xdr_to_time(const struct yfs_xdr_u64 xdr)
    {
    let mut t: i64 = xdr_to_u64(xdr);
    return yfs_time_to_linux(t);
    }
#[no_mangle]
unsafe extern "C" fn yfs_check_req(call: *mut afs_call, bp: *mut __be32) {
    static void yfs_check_req(struct afs_call *call, __be32 *bp)
    {
    let mut len: usize = (void *)bp - call.request;
    if (len > call.request_size)
    pr_err("kAFS: %s: Request buffer overflow (%zu>%u)\n",
    call.type.name, len, call.request_size);
#[no_mangle]
pub unsafe extern "C" fn if(call->request_size: len <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn xdr_dump_bad(bp: *const __be32) {
...
//
    ...
    {
    struct yfs_xdr_YFSStoreStatus *x = (void *)bp;
    let mut mtime: i64 = 0, owner = 0, group = 0;
    let mut mask: u32 = 0, mode = 0;
    mask = 0;
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_status_and_volsync(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_fetch_data64(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_fetch_data(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_create_vnode(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_create_file(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_make_dir(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_remove_file2(call: *mut afs_call) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yfs_done_fs_remove_file2(call: *mut afs_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_remove_file2(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_remove(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_remove_file(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_remove_dir(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_link(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_link(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_symlink(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_symlink(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_rename(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_rename(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_rename_1(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_rename_2(call: *mut afs_call) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yfs_done_fs_rename_replace(call: *mut afs_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_rename_replace(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_rename_noreplace(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_rename_exchange(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_store_data(op: *mut afs_operation) {
...
// marshall the parameters
    ...
    bp = xdr_encode_u32(bp, 0); /* RPC flags */
    bp = xdr_encode_YFSFid(bp, &vp.fid);
    bp = xdr_encode_YFSStoreStatus(bp, core::ptr::null_mut(), &op.mtime);
...
//
#[no_mangle]
unsafe extern "C" fn yfs_fs_setattr_size(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_setattr(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_get_volume_status(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_get_volume_status(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_set_lock(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_extend_lock(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_release_lock(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_fetch_status(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_fetch_status(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_inline_bulk_status(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_inline_bulk_status(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn yfs_deliver_fs_fetch_opaque_acl(call: *mut afs_call) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn yfs_free_opaque_acl(yacl: *mut yfs_acl) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_fetch_opaque_acl(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn yfs_fs_store_opaque_acl2(op: *mut afs_operation) {
