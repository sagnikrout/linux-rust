...
//
#[no_mangle]
pub unsafe extern "C" fn afs_cache_wb_key(vnode: *mut afs_vnode, af: *mut afs_file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_fetch_data_notify(op: *mut afs_operation) {
...
#[no_mangle]
unsafe extern "C" fn afs_fetch_data_success(op: *mut afs_operation) {
...
#[no_mangle]
unsafe extern "C" fn afs_fetch_data_aborted(op: *mut afs_operation) {
...
#[no_mangle]
unsafe extern "C" fn afs_issue_read_call(op: *mut afs_operation) {
...
#[no_mangle]
unsafe extern "C" fn afs_end_read(op: *mut afs_operation) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: op->cumul_error.aborted) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn afs_read_receive(call: *mut afs_call) {
...
#[no_mangle]
pub unsafe extern "C" fn afs_fetch_data_async_rx(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn afs_fetch_data_immediate_cancel(call: *mut afs_call) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_issue_read(subreq: *mut netfs_io_subrequest) {
...
#[no_mangle]
unsafe extern "C" fn afs_init_request(rreq: *mut netfs_io_request, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_free_request(rreq: *mut netfs_io_request) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_set_i_size(vnode: *mut afs_vnode, new_i_size: loff_t) {
    ...
    fscache_update_cookie(afs_vnode_cache(vnode), core::ptr::null_mut(), &new_i_size);
    }
#[no_mangle]
unsafe extern "C" fn afs_update_i_size(inode: *mut inode, new_i_size: loff_t) {
    static void afs_update_i_size(struct inode *inode, loff_t new_i_size)
    {
    afs_set_i_size(AFS_FS_I(inode), new_i_size);
    }
#[no_mangle]
unsafe extern "C" fn afs_netfs_invalidate_cache(wreq: *mut netfs_io_request) {
...
#[no_mangle]
unsafe extern "C" fn afs_add_open_mmap(vnode: *mut afs_vnode) {
...
#[no_mangle]
unsafe extern "C" fn afs_drop_open_mmap(vnode: *mut afs_vnode) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_file_mmap_prepare(desc: *mut vm_area_desc) -> c_int {
    static int afs_file_mmap_prepare(struct vm_area_desc *desc)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn afs_vm_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn afs_vm_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn afs_vm_map_pages(vmf: *mut vm_fault, start_pgoff: pgoff_t, end_pgoff: pgoff_t) -> vm_fault_t {
    static vm_fault_t afs_vm_map_pages(struct vm_fault *vmf, pgoff_t start_pgoff, pgoff_t end_pgoff)
    {
...
#[no_mangle]
unsafe extern "C" fn afs_file_read_iter(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    static ssize_t afs_file_read_iter(struct kiocb *iocb, struct iov_iter *iter)
    {
