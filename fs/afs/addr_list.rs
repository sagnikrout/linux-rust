...
#[no_mangle]
unsafe extern "C" fn afs_free_addrlist(rcu: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_put_addrlist(alist: *mut afs_addr_list, reason: enum afs_alist_trace) {
...
//
    ...
    {
    let mut data: c_ulong = (unsigned long)server;
    let mut n: c_int = 0, o = 0;
    if (!old_alist) {
