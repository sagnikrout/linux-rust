...
//
#[no_mangle]
unsafe extern "C" fn xdr_decode_AFSFid(_bp: *const __be32, fid: *mut afs_fid) {
...
//
    ...
    let mut inline_error: bool = (call.operation_ID == afs_FS_InlineBulkStatus);
...
#[no_mangle]
unsafe extern "C" fn xdr_decode_expiry(call: *mut afs_call, expiry: u32) -> time64_t {
...
//
#[no_mangle]
unsafe extern "C" fn xdr_encode_AFS_StoreStatus(_bp: *mut __be32, attr: *mut iattr) {
    static void xdr_encode_AFS_StoreStatus(__be32 **_bp, struct iattr *attr)
    {
    __be32 *bp = *_bp;
    let mut mask: u32 = 0, mtime = 0, owner = 0, group = 0, mode = 0;
    mask = 0;
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_fetch_status(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_fetch_status(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_fetch_data(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_fs_fetch_data64(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_fetch_data(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_create_vnode(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_create_file(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_make_dir(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_file_status_and_vol(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_remove_file(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_remove_dir(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_link(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_link(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_symlink(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_symlink(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_rename(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_rename(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_store_data(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_fs_store_data64(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_store_data(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_fs_setattr_size64(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_fs_setattr_size(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_setattr(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_get_volume_status(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_get_volume_status(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_xxxx_lock(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_set_lock(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_extend_lock(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_release_lock(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_give_up_all_callbacks(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_get_capabilities(call: *mut afs_call) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afs_fs_get_capabilities_destructor(call: *mut afs_call) {
...
// bp++ = htonl(FSGETCAPABILITIES);
    trace_afs_make_fs_call(call, core::ptr::null_mut());
    afs_make_call(call, GFP_NOFS);
    afs_put_call(call);
    return true;
    }
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_inline_bulk_status(call: *mut afs_call) -> c_int {
...
// with rubbish.
//
    xdr_decode_AFSVolSync(&bp, core::ptr::null_mut());
    call.unmarshall++;
    fallthrough;
    case 6:
    break;
...
#[no_mangle]
unsafe extern "C" fn afs_done_fs_inline_bulk_status(call: *mut afs_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_inline_bulk_status(op: *mut afs_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn afs_deliver_fs_fetch_acl(call: *mut afs_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_fetch_acl(op: *mut afs_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_fs_store_acl(op: *mut afs_operation) {
