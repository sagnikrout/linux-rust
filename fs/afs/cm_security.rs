...
//
#[no_mangle]
unsafe extern "C" fn afs_respond_to_challenge(challenge: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_process_oob_queue(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afs_create_token_key(net: *mut afs_net, socket: *mut socket) -> c_int {
