...
#[no_mangle]
unsafe extern "C" fn fat_ioctl_get_attributes(inode: *mut inode, user_attr: *mut u32 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_ioctl_set_attributes(file: *mut file, user_attr: *mut u32 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_ioctl_get_volume_id(inode: *mut inode, user_attr: *mut u32 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_ioctl_fitrim(inode: *mut inode, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fat_generic_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn fat_file_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fat_file_fsync(filp: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_cont_expand(inode: *mut inode, size: loff_t) -> c_int {
    static int fat_cont_expand(struct inode *inode, loff_t size)
    {
    struct address_space *mapping = inode.i_mapping;
    let mut start: loff_t = inode.i_size, count = size - inode.i_size;
    int err;
...
#[no_mangle]
unsafe extern "C" fn fat_free(inode: *mut inode, skip: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fat_truncate_blocks(inode: *mut inode, offset: loff_t) {
    void fat_truncate_blocks(struct inode *inode, loff_t offset)
    {
    struct msdos_sb_info *sbi = MSDOS_SB(inode.i_sb);
    let mut cluster_size: c_uint = sbi.cluster_size;
    int nr_clusters;
//
...
#[no_mangle]
pub unsafe extern "C" fn fat_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
...
// mode_ptr &= S_IFMT | perm;
    ...
    {
    let mut allow_utime: umode_t = sbi.options.allow_utime;
