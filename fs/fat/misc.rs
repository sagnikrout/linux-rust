...
//
#[no_mangle]
pub unsafe extern "C" fn __fat_fs_error(sb: *mut super_block, report: c_int, fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn if(!sb_rdonly(sb): opts->errors == FAT_ERRORS_RO &&) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn _fat_msg(sb: *mut super_block, level: *const c_char, fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn fat_clusters_flush(sb: *mut super_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fat_chain_add(inode: *mut inode, new_dclus: c_int, nr_cluster: c_int) -> c_int {
...
// add new one to the last of the cluster chain
    ...
    if (ret >= 0) {
    let mut wait: c_int = inode_needs_sync(inode);
    let mut old: c_int = ret;
...
//
pub const SECS_PER_MIN: c_int = 60;

// days between 1.1.70 and 1.1.80 (2 leap days)

// 120 (2100 - 1980) isn't leap year
pub const YEAR_2100: c_int = 120;
...
#[no_mangle]
pub unsafe extern "C" fn fat_tz_offset(sbi: *const msdos_sb_info) -> c_int {
...
// Convert a FAT time/date pair to a UNIX date (seconds since 1 1 70).
    ...
    {
    let mut time: u16 = le16_to_cpu(__time), date = le16_to_cpu(__date);
    time64_t second;
...
#[no_mangle]
pub unsafe extern "C" fn fat_timespec64_trunc_2secs(ts: timespec64) -> timespec64 {
...
//
    ...
    {
// to localtime
    let mut seconds: time64_t = ts.tv_sec - fat_tz_offset(sbi);
    s32 remainder;
...
// truncate mtime to 2 second granularity
    let mut mtime: timespec64 = fat_timespec64_trunc_2secs(*now);
    ...
    {
    if (inode.i_ino != MSDOS_ROOT_INO) {
    fat_truncate_time(inode, core::ptr::null_mut(), type == FS_UPD_ATIME ?
...
#[no_mangle]
pub unsafe extern "C" fn fat_sync_bhs(bhs: *mut buffer_head, nr_bhs: c_int) -> c_int {
