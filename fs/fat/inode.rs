...
pub const KB_IN_SECTORS: c_int = 2;
...
pub struct fat_bios_param_block {
    ...
    let mut fat_default_codepage: static int = CONFIG_FAT_DEFAULT_CODEPAGE;
...
#[no_mangle]
pub unsafe extern "C" fn fat_add_cluster(inode: *mut inode) -> c_int {
...
// max_blocks = min(mapped_blocks, *max_blocks);
    ...
    {
    struct super_block *sb = inode.i_sb;
    let mut max_blocks: c_ulong = bh_result.b_size >> inode.i_blkbits;
    int err;
...
#[no_mangle]
unsafe extern "C" fn fat_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int fat_read_folio(struct file *file, struct folio *folio)
    {
    return mpage_read_folio(folio, fat_get_block);
    }
#[no_mangle]
unsafe extern "C" fn fat_readahead(rac: *mut readahead_control) {
    static void fat_readahead(struct readahead_control *rac)
    {
    mpage_readahead(rac, fat_get_block);
    }
#[no_mangle]
unsafe extern "C" fn fat_write_failed(mapping: *mut address_space, to: loff_t) {
...
#[no_mangle]
unsafe extern "C" fn fat_direct_IO(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
...
//
    let mut size: loff_t = offset + count;
...
#[no_mangle]
unsafe extern "C" fn _fat_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn fat_block_truncate_page(inode: *mut inode, from: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fat_hash_init(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn fat_hash(i_pos: loff_t) -> c_ulong {
    static inline unsigned long fat_hash(loff_t i_pos)
    {
    return hash_32(i_pos, FAT_HASH_BITS);
    }
#[no_mangle]
unsafe extern "C" fn dir_hash_init(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn fat_attach(inode: *mut inode, i_pos: loff_t) {
...
#[no_mangle]
pub unsafe extern "C" fn fat_detach(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn is_exec(extension: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_calc_dir_size(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_validate_dir(dir: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fat_fill_inode(inode: *mut inode, de: *mut msdos_dir_entry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fat_lock_build_inode(sbi: *mut msdos_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn fat_unlock_build_inode(sbi: *mut msdos_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn fat_free_eofblocks(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fat_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fat_reset_iocharset(opts: *mut fat_mount_options) {
...
#[no_mangle]
unsafe extern "C" fn fat_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn fat_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fat_init_inodecache() -> int __init {
    ...
    SLAB_ACCOUNT),
    init_once);
    if (fat_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn fat_destroy_inodecache() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn fat_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
// If the count of free cluster is still unknown, counts it here.
    ...
    let mut err: c_int = fat_count_free_clusters(dentry.d_sb);
    if (err)
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn __fat_write_inode(inode: *mut inode) -> c_int {
    static int __fat_write_inode(struct inode *inode)
    {
    struct super_block *sb = inode.i_sb;
    struct msdos_sb_info *sbi = MSDOS_SB(sb);
...
// No entry to update but the metadata bh list may need syncing.
    ...
    &raw_entry.date, core::ptr::null_mut());
    if (sbi.options.isvfat) {
    let mut ts: timespec64 = inode_get_atime(inode);
    __le16 atime;
    fat_time_unix2fat(sbi, &ts, &atime, &raw_entry.adate, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fat_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fat_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
    static int fat_show_options(struct seq_file *m, struct dentry *root)
    {
    struct msdos_sb_info *sbi = MSDOS_SB(root.d_sb);
    struct fat_mount_options *opts = &sbi.options;
    let mut isvfat: c_int = opts.isvfat;
...
#[no_mangle]
pub unsafe extern "C" fn if(FAT_ERRORS_PANIC: opts->errors ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: opts->nfs) -> else {
    else if (opts.nfs)
...
// Core options. See below for vfat and msdos extras
    ...
    Opt_obsolete, fs_param_deprecated, core::ptr::null_mut()),
    ...
    Opt_obsolete, fs_param_deprecated, core::ptr::null_mut()),
    __fsparam(core::ptr::null_mut(),			"posix",
    Opt_obsolete, fs_param_deprecated, core::ptr::null_mut()),
    {}
    };
...
// vfat specific
    ...
    param.string = core::ptr::null_mut();	/* Steal string */
    break;
    case Opt_shortname:
...
#[no_mangle]
unsafe extern "C" fn fat_read_root(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_fat_clusters(sb: *mut super_block) -> c_ulong {
    static unsigned long calc_fat_clusters(struct super_block *sb)
    {
    struct msdos_sb_info *sbi = MSDOS_SB(sb);
// Divide first to avoid overflow
    if (!is_fat12(sbi)) {
    let mut ent_per_sec: c_ulong = sb.s_blocksize * 8 / sbi.fat_bits;
    return ent_per_sec * sbi.fat_length;
    }
    return sbi.fat_length * sb.s_blocksize * 8 / sbi.fat_bits;
    }
#[no_mangle]
unsafe extern "C" fn fat_bpb_is_zero(b: *mut fat_boot_sector) -> bool {
...
//
    ...
    let mut bd_sects: sector_t = bdev_nr_sectors(sb.s_bdev);
    struct fat_floppy_defaults *fdefaults = core::ptr::null_mut();
    let mut error: c_int = -EINVAL;
    unsigned i;
...
//
    ...
    if (fdefaults == core::ptr::null_mut()) {
    if (!silent)
...
//
    ...
    struct inode *root_inode = core::ptr::null_mut(), *fat_inode = core::ptr::null_mut();
    struct inode *fsinfo_inode = core::ptr::null_mut();
    struct buffer_head *bh;
    struct fat_bios_param_block bpb;
...
// Transfer ownership of iocharset to sbi->options
    opts.iocharset = core::ptr::null_mut();
...
// Verify that the larger boot sector is fully readable
    ...
    if (bh_resize == core::ptr::null_mut()) {
    fat_msg(sb, KERN_ERR, "unable to read boot sector"
...
// MC - if info_sector is 0, don't multiply by 0
    ...
    if (fsinfo_bh == core::ptr::null_mut()) {
...
// interpret volume ID as a little endian 32 bit integer
    ...
    let mut vol_id_le: __le32 = cpu_to_le32(sbi.vol_id);
...
//
#[no_mangle]
unsafe extern "C" fn writeback_inode(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fat_flush_inodes(sb: *mut super_block, i1: *mut inode, i2: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fat_init_fs_context(fc: *mut fs_context, is_vfat: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fat_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn init_fat_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_fat_fs() -> void __exit {
