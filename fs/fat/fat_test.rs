...
#[no_mangle]
unsafe extern "C" fn fat_checksum_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn fat_clus_to_blknr_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn fat_get_blknr_offset_test(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fat_timestamp_testcase {
    pub name: *const c_char,
    pub ts: timespec64,
    pub time: __le16,
    pub date: __le16,
    pub cs: u8,
    pub time_offset: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fat_unix2fat_clamp_testcase {
    pub name: *const c_char,
    pub ts: timespec64,
    pub time: __le16,
    pub date: __le16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fat_truncate_atime_testcase {
    pub name: *const c_char,
    pub ts: timespec64,
...
#[no_mangle]
unsafe extern "C" fn fat_test_set_time_offset(sbi: *mut msdos_sb_info, time_offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fat_time_fat2unix_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn fat_time_unix2fat_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn fat_time_unix2fat_clamp_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn fat_time_unix2fat_no_csec_test(test: *mut kunit) {
    ...
    fat_time_unix2fat(&fake_sb, &ts, &time, &date, core::ptr::null_mut());
    KUNIT_EXPECT_EQ_MSG(test,
    49021,
    le16_to_cpu(time),
...
#[no_mangle]
unsafe extern "C" fn fat_truncate_atime_test(test: *mut kunit) {
