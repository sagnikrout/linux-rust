...
#[no_mangle]
pub unsafe extern "C" fn vfat_d_version(dentry: *mut dentry) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn vfat_revalidate_shortname(dentry: *mut dentry, dir: *mut inode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __vfat_striptail_len(len: c_uint, name: *const c_char) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vfat_striptail_len(qstr: *const qstr) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn vfat_hash(dentry: *const dentry, qstr: *mut qstr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vfat_hashi(dentry: *const dentry, qstr: *mut qstr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfat_bad_char(w: wchar_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn vfat_replace_char(w: wchar_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfat_skip_char(w: wchar_t) -> wchar_t {
    static wchar_t vfat_skip_char(wchar_t w)
    {
    return (w == '.') || (w == ' ');
    }
#[no_mangle]
pub unsafe extern "C" fn vfat_is_used_badchars(s: *const wchar_t, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfat_find_form(dir: *mut inode, name: *mut c_uchar) -> c_int {
    static int vfat_find_form(struct inode *dir, unsigned char *name)
    {
    struct fat_slot_info sinfo;
    let mut err: c_int = fat_scan(dir, name, &sinfo);
    if (err)
    return -ENOENT;
    brelse(sinfo.bh);
    return 0;
...
//
    ...
    int chl, chi;
    let mut sz: c_int = 0, extlen, baselen, i, numtail_baselen, numtail2_baselen;
    int is_shortname;
...
// outlen = utf8s_to_utf16s(name, len, UTF16_HOST_ENDIAN,
    ...
    return *outlen;
#[no_mangle]
pub unsafe extern "C" fn if(FAT_LFN_LEN: *mut *mut outlen >) -> else {
...
// update timestamp
    ...
    struct fat_slot_info *sinfo)
    {
    let mut len: c_uint = vfat_striptail_len(qname);
    if (len == 0)
    return -ENOENT;
...
#[no_mangle]
unsafe extern "C" fn vfat_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
    ...
    clear_nlink(inode);
    fat_truncate_time(inode, core::ptr::null_mut(), FAT_UPDATE_ATIME | FAT_UPDATE_CMTIME);
    fat_detach(inode);
    vfat_d_version_set(dentry, inode_query_iversion(dir));
    out:
    mutex_unlock(&MSDOS_SB(sb).s_lock);
...
#[no_mangle]
unsafe extern "C" fn vfat_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfat_sync_ipos(dir: *mut inode, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfat_update_dir_metadata(dir: *mut inode, ts: *mut timespec64) {
    ...
    {
    struct buffer_head *dotdot_bh;
    struct msdos_dir_entry *dotdot_de = core::ptr::null_mut();
    ...
    old_sinfo.bh = sinfo.bh = dotdot_bh = core::ptr::null_mut();
    ...
    old_sinfo.bh = core::ptr::null_mut();
    if (err)
    goto error_dotdot;
...
//
    let mut err2: c_int = fat_remove_entries(new_dir, &sinfo);
    if (corrupt)
    corrupt |= err2;
    sinfo.bh = core::ptr::null_mut();
    }
    if (corrupt < 0) {
...
#[no_mangle]
unsafe extern "C" fn vfat_move_nlink(src: *mut inode, dst: *mut inode) {
    ...
    struct inode *new_dir, struct dentry *new_dentry)
    {
    struct buffer_head *old_dotdot_bh = core::ptr::null_mut(), *new_dotdot_bh = core::ptr::null_mut();
    struct msdos_dir_entry *old_dotdot_de = core::ptr::null_mut(), *new_dotdot_de = core::ptr::null_mut();
    struct inode *old_inode, *new_inode;
    let mut ts: timespec64 = current_time(old_dir);
...
#[no_mangle]
unsafe extern "C" fn setup(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn vfat_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    static int vfat_fill_super(struct super_block *sb, struct fs_context *fc)
    {
    return fat_fill_super(sb, fc, setup);
    }
#[no_mangle]
unsafe extern "C" fn vfat_get_tree(fc: *mut fs_context) -> c_int {
    static int vfat_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, vfat_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn vfat_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfat_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_vfat_fs() -> int __init {
    static int __init init_vfat_fs(void)
    {
    return register_filesystem(&vfat_fs_type);
    }
#[no_mangle]
unsafe extern "C" fn exit_vfat_fs() -> void __exit {
