...
//
#[no_mangle]
unsafe extern "C" fn msdos_hash(dentry: *const dentry, qstr: *mut qstr) -> c_int {
...
// Creates a directory entry (name is already formatted).
    ...
    de.attr |= ATTR_HIDDEN;
    de.lcase = 0;
    fat_time_unix2fat(sbi, ts, &time, &date, core::ptr::null_mut());
    de.cdate = de.adate = 0;
    de.ctime = 0;
    de.ctime_cs = 0;
    de.time = time;
...
// Remove a directory
#[no_mangle]
unsafe extern "C" fn msdos_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
// Unlink a file
#[no_mangle]
unsafe extern "C" fn msdos_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
// "foo" -> ".foo" case. just change the ATTR_HIDDEN
    ...
    fat_truncate_time(old_dir, core::ptr::null_mut(), FAT_UPDATE_CMTIME);
...
#[no_mangle]
unsafe extern "C" fn msdos_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    static int msdos_fill_super(struct super_block *sb, struct fs_context *fc)
    {
    return fat_fill_super(sb, fc, setup);
    }
#[no_mangle]
unsafe extern "C" fn msdos_get_tree(fc: *mut fs_context) -> c_int {
    static int msdos_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, msdos_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn msdos_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdos_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_msdos_fs() -> int __init {
    static int __init init_msdos_fs(void)
    {
    return register_filesystem(&msdos_fs_type);
    }
#[no_mangle]
unsafe extern "C" fn exit_msdos_fs() -> void __exit {
