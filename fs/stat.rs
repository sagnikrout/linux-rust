...
//
#[no_mangle]
pub unsafe extern "C" fn fill_mg_cmtime(stat: *mut kstat, request_mask: u32, inode: *mut inode) {
...
//
    ...
    {
    let mut vfsuid: vfsuid_t = i_uid_into_vfsuid(idmap, inode);
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_fill_statx_attr(inode: *mut inode, stat: *mut kstat) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_fstat(fd: c_int, stat: *mut kstat) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn statx_lookup_flags(flags: c_int) -> c_int {
    ...
    u32 request_mask)
    {
    let mut error: c_int = vfs_getattr(path, stat, request_mask, flags);
    if (error)
    return error;
...
//
    ...
    {
    struct path path;
    let mut lookup_flags: c_uint = statx_lookup_flags(flags);
    int error;
...
//
#[no_mangle]
unsafe extern "C" fn cp_old_stat(stat: *mut kstat, statbuf: *mut *mut __old_kernel_stat __user) -> c_int {
    static int cp_old_stat(struct kstat *stat, struct __old_kernel_stat __user * statbuf)
    {
    let mut warncount: static int = 5;
...
#[no_mangle]
unsafe extern "C" fn cp_new_stat(stat: *mut kstat, statbuf: *mut stat __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_new_stat64(stat: *mut kstat, statbuf: *mut stat64 __user) -> c_long {
...
// mips has weird padding, so we don't get 64 bits there
    ...
    {
    struct kstat stat;
    let mut error: c_int = vfs_stat(filename, &stat);
    if (!error)
    ...
    {
    struct kstat stat;
    let mut error: c_int = vfs_lstat(filename, &stat);
    if (!error)
    error = cp_new_stat64(&stat, statbuf);
    return error;
    }
    ...
    {
    struct kstat stat;
    let mut error: c_int = vfs_fstat(fd, &stat);
    if (!error)
    error = cp_new_stat64(&stat, statbuf);
    return error;
    }
...
#[no_mangle]
unsafe extern "C" fn cp_compat_stat(stat: *mut kstat, ubuf: *mut compat_stat __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __inode_add_bytes(inode: *mut inode, bytes: loff_t) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_add_bytes(inode: *mut inode, bytes: loff_t) {
...
#[no_mangle]
pub unsafe extern "C" fn __inode_sub_bytes(inode: *mut inode, bytes: loff_t) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_sub_bytes(inode: *mut inode, bytes: loff_t) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_get_bytes(inode: *mut inode) -> loff_t {
...
#[no_mangle]
pub unsafe extern "C" fn inode_set_bytes(inode: *mut inode, bytes: loff_t) {
