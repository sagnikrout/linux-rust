...
// SPDX-License-Identifier: GPL-2.0
    ...
    let mut pidfs_root_path: static struct path = {};
    static struct simple_xattr_cache pidfs_xa_cache;
#[no_mangle]
pub unsafe extern "C" fn pidfs_get_root(path: *mut path) {
...
pub struct pidfs_attr {
    ...
    let mut pidfs_ino_nr: static u64 = 1;
#[no_mangle]
pub unsafe extern "C" fn pidfs_ino(ino: u64) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn pidfs_gen(ino: u64) -> u32 {
    static inline u32 pidfs_gen(u64 ino)
    {
    return upper_32_bits(ino);
    }
#[no_mangle]
pub unsafe extern "C" fn pidfs_alloc_ino() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn pidfs_alloc_ino() -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn pidfs_prepare_pid(pid: *mut pid) {
    void pidfs_prepare_pid(struct pid *pid)
    {
    pid.stashed = core::ptr::null_mut();
    pid.attr = core::ptr::null_mut();
    pid.ino = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn pidfs_add_pid(pid: *mut pid) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pidfs_remove_pid(pid: *mut pid) {
...
#[no_mangle]
unsafe extern "C" fn pidfs_free_attr_work(work: *mut work_struct) {
    ...
    simple_xattrs_free(&pidfs_xa_cache, &attr.xattrs, core::ptr::null_mut());
    kfree(attr);
    }
    }
    static DECLARE_WORK(pidfs_free_work, pidfs_free_attr_work);
#[no_mangle]
pub unsafe extern "C" fn pidfs_free_pid(pid: *mut pid) {
...
// This never had a pidfd created.
    ...
    kfree(attr);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: llist_add(&attr->pidfs_llist, _arg: &pidfs_free_list)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn pidfd_show_fdinfo(m: *mut seq_file, f: *mut file) {
...
//
#[no_mangle]
unsafe extern "C" fn pidfd_poll(file: *mut file, pts: *mut poll_table_struct) -> __poll_t {
    static __poll_t pidfd_poll(struct file *file, struct poll_table_struct *pts)
    {
    struct pid *pid = pidfd_pid(file);
    struct task_struct *task;
    let mut poll_flags: __poll_t = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(!delay_group_leader(task): task->exit_state &&) -> else {
    else if (task.exit_state && !delay_group_leader(task))
    poll_flags = EPOLLIN | EPOLLRDNORM;
    return poll_flags;
    }
#[no_mangle]
pub unsafe extern "C" fn pid_in_current_pidns(pid: *const pid) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pidfs_coredump_mask(dumpable: enum task_dumpable) -> __u32 {
...
#[no_mangle]
unsafe extern "C" fn pidfd_info(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    static long pidfd_info(struct file *file, unsigned int cmd, unsigned long arg)
    {
    struct pidfd_info __user *uinfo = (struct pidfd_info __user *)arg;
    struct task_struct *task __free(put_task) = core::ptr::null_mut();
    struct pid *pid = pidfd_pid(file);
    let mut usize: usize = _IOC_SIZE(cmd);
    let mut kinfo: pidfd_info = {};
...
//
    return copy_struct_to_user(uinfo, usize, &kinfo, sizeof(kinfo), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn pidfs_ioctl_valid(cmd: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pidfd_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    static long pidfd_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
    {
    struct task_struct *task __free(put_task) = core::ptr::null_mut();
    struct nsproxy *nsp __free(put_nsproxy) = core::ptr::null_mut();
    struct ns_common *ns_common = core::ptr::null_mut();
    int error;
...
#[no_mangle]
unsafe extern "C" fn pidfs_file_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pidfs_exit(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn pidfs_coredump(cprm: *const coredump_params) {
...
#[no_mangle]
unsafe extern "C" fn pidfs_listxattr(dentry: *mut dentry, buf: *mut c_char, size: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn pidfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn pidfs_init_inode(inode: *mut inode, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pidfs_put_data(data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pidfs_register_pid_gfp(pid: *mut pid, gfp: gfp_t) -> c_int {
    int pidfs_register_pid_gfp(struct pid *pid, gfp_t gfp)
    {
    struct pidfs_attr *new_attr __free(kfree) = core::ptr::null_mut();
    struct pidfs_attr *attr;
    might_sleep();
    if (!pid)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn pidfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pidfs_init() -> void __init {
