...
#[no_mangle]
unsafe extern "C" fn zonefs_read_folio(unused: *mut file, folio: *mut folio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_readahead(rac: *mut readahead_control) {
...
#[no_mangle]
pub unsafe extern "C" fn zonefs_file_truncate(inode: *mut inode, isize: loff_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(z->z_capacity: isize ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn zonefs_filemap_page_mkwrite(vmf: *mut vm_fault) -> vm_fault_t {
...
// Serialize against truncates
    ...
    ret = iomap_page_mkwrite(vmf, &zonefs_write_iomap_ops, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn zonefs_file_mmap_prepare(desc: *mut vm_area_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_file_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
    static loff_t zonefs_file_llseek(struct file *file, loff_t offset, int whence)
    {
    let mut isize: loff_t = i_size_read(file_inode(file));
//
...
//
    ...
    let mut max_size: loff_t = z.z_capacity;
...
#[no_mangle]
unsafe extern "C" fn zonefs_write_checks(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn zonefs_file_dio_write(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
//
    ...
    &zonefs_write_dio_ops, 0, core::ptr::null_mut(), 0);
    if (ret == -ENOTBLK)
    ret = -EBUSY;
//
...
#[no_mangle]
unsafe extern "C" fn zonefs_file_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
// Write operations beyond the zone capacity are not allowed
    ...
    let mut ret: isize = zonefs_file_dio_write(iocb, from);
    if (ret != -ENOTBLK)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn zonefs_file_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
// Limit read operations to written data
    ...
    &zonefs_read_dio_ops, 0, core::ptr::null_mut(), 0);
    } else {
...
#[no_mangle]
unsafe extern "C" fn zonefs_seq_file_write_open(inode: *mut inode) -> c_int {
    ...
    let mut wro: c_uint = atomic_inc_return(&sbi.s_wro_seq_files);
...
#[no_mangle]
unsafe extern "C" fn zonefs_file_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_seq_file_write_close(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn zonefs_file_release(inode: *mut inode, file: *mut file) -> c_int {
