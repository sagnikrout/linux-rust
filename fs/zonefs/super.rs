...
//
#[no_mangle]
pub unsafe extern "C" fn zonefs_inode_account_active(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn zonefs_inode_zone_mgmt(inode: *mut inode, op: enum req_op) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zonefs_i_size_write(inode: *mut inode, isize: loff_t) {
...
#[no_mangle]
pub unsafe extern "C" fn zonefs_update_stats(inode: *mut inode, new_isize: loff_t) {
    void zonefs_update_stats(struct inode *inode, loff_t new_isize)
    {
    struct super_block *sb = inode.i_sb;
    struct zonefs_sb_info *sbi = ZONEFS_SB(sb);
    let mut old_isize: loff_t = i_size_read(inode);
    loff_t nr_blocks;
...
//
#[no_mangle]
unsafe extern "C" fn zonefs_inode_update_mode(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __zonefs_io_error(inode: *mut inode, write: bool) {
...
#[no_mangle]
unsafe extern "C" fn zonefs_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn zonefs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_fname_to_fno(fname: *const qstr) -> c_long {
    static long zonefs_fname_to_fno(const struct qstr *fname)
    {
    const char *name = fname.name;
    let mut len: c_uint = fname.len;
    let mut fno: c_long = 0, shift = 1;
    const char *rname;
    let mut c: c_char = *name;
    unsigned int i;
//
...
// Update the inode access rights depending on the zone condition
    ...
    struct zonefs_sb_info *sbi = ZONEFS_SB(sb);
    struct inode *inode;
    let mut ino: ino_t = bdev_nr_zones(sb.s_bdev) + ztype + 1;
    inode = iget_locked(sb, ino);
    if (!inode)
    return ERR_PTR(-ENOMEM);
    if (!(inode_state_read_once(inode) & I_NEW))
...
#[no_mangle]
unsafe extern "C" fn zonefs_readdir_root(file: *mut file, ctx: *mut dir_context) -> c_int {
    static int zonefs_readdir_root(struct file *file, struct dir_context *ctx)
    {
    struct inode *inode = file_inode(file);
    struct super_block *sb = inode.i_sb;
    struct zonefs_sb_info *sbi = ZONEFS_SB(sb);
    let mut ztype: enum zonefs_ztype = ZONEFS_ZTYPE_CNV;
    let mut base_ino: ino_t = bdev_nr_zones(sb.s_bdev) + 1;
...
#[no_mangle]
unsafe extern "C" fn zonefs_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zonefs_zone_data {
    pub sb: *mut super_block,
    pub nr_zones: [c_uint; ZONEFS_ZTYPE_MAX],
    pub cnv_zone_start: sector_t,
...
#[no_mangle]
unsafe extern "C" fn zonefs_get_zone_info(zd: *mut zonefs_zone_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zonefs_free_zone_info(zd: *mut zonefs_zone_data) {
...
#[no_mangle]
pub unsafe extern "C" fn if(BLK_ZONE_COND_OFFLINE: next->cond ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn zonefs_free_zgroups(sb: *mut super_block) {
    ...
    sbi.s_zgroup[ztype].g_zones = core::ptr::null_mut();
    }
    }
//
// Create a zone group and populate it with zone files.
//
#[no_mangle]
unsafe extern "C" fn zonefs_init_zgroups(sb: *mut super_block) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zonefs_read_super(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_get_zgroup_inodes(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_release_zgroup_inodes(sb: *mut super_block) {
    ...
    sbi.s_zgroup[ztype].g_inode = core::ptr::null_mut();
    }
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn zonefs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_kill_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn zonefs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn zonefs_get_tree(fc: *mut fs_context) -> c_int {
    static int zonefs_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, zonefs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn zonefs_reconfigure(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zonefs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zonefs_init_inodecache() -> int __init {
    ...
    core::ptr::null_mut());
    if (zonefs_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn zonefs_destroy_inodecache() {
...
#[no_mangle]
unsafe extern "C" fn zonefs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn zonefs_exit() -> void __exit {
