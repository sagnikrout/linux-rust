...
#[no_mangle]
unsafe extern "C" fn efivarfs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
    ...
    {
    let mut guid: c_int = len - EFI_VARIABLE_GUID_LEN;
...
#[no_mangle]
unsafe extern "C" fn efivarfs_d_hash(dentry: *const dentry, qstr: *mut qstr) -> c_int {
    static int efivarfs_d_hash(const struct dentry *dentry, struct qstr *qstr)
    {
    let mut hash: c_ulong = init_name_hash(dentry);
    const unsigned char *s = qstr.name;
    let mut len: c_uint = qstr.len;
...
//
    ...
    dput(dentry);
    return dentry != core::ptr::null_mut();
    }
...
// length of the variable name itself: remove GUID and separator
    ...
    __efivar_entry_get(entry, core::ptr::null_mut(), &size, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn efivarfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    ...
    inode = efivarfs_get_inode(sb, core::ptr::null_mut(), S_IFDIR | 0755, 0, true);
    if (!inode)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn efivarfs_get_tree(fc: *mut fs_context) -> c_int {
    static int efivarfs_get_tree(struct fs_context *fc)
    {
    return get_tree_single(fc, efivarfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn efivarfs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_free(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_freeze_fs(sb: *mut super_block) -> c_int {
    static int efivarfs_freeze_fs(struct super_block *sb)
    {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_unfreeze_fs(sb: *mut super_block) -> c_int {
    static int efivarfs_unfreeze_fs(struct super_block *sb)
    {
...
// The variable doesn't exist anymore, delete it.
    ...
    simple_recursive_removal(child, core::ptr::null_mut());
    }
    }
...
#[no_mangle]
unsafe extern "C" fn efivarfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn efivarfs_init() -> __init int {
    static __init int efivarfs_init(void)
    {
    return register_filesystem(&efivarfs_type);
    }
#[no_mangle]
unsafe extern "C" fn efivarfs_exit() -> __exit void {
