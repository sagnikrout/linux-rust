...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct variable_validate {
    pub vendor: efi_guid_t,
    pub name: *mut c_char,
...
//
    ...
    { EFI_GLOBAL_VARIABLE_GUID, "OsIndications", core::ptr::null_mut() },
    { EFI_GLOBAL_VARIABLE_GUID, "PlatformLang", validate_ascii_string },
    { EFI_GLOBAL_VARIABLE_GUID, "Timeout", validate_uint16 },
    { LINUX_EFI_CRASH_GUID, "*", core::ptr::null_mut() },
    { NULL_GUID, "", core::ptr::null_mut() },
    };
//
...
//
    ...
    {
    for (*match = 0; ; (*match)++) {
    let mut c: c_char = match_name[*match];
    switch (c) {
    case '*':
...
//
    ...
    {
    let mut len: c_int = ucs2_utf8size(name16);
    char *name;
...
// replace invalid slashes like kobject_set_name_vargs does for /sys/firmware/efi/vars.
    ...
    if (variable_validate[i].validate == core::ptr::null_mut())
    break;
    kfree(utf8_name);
...
//
    ...
    {
    let mut variable_name_size: c_ulong = 512;
...
//
#[no_mangle]
pub unsafe extern "C" fn efivar_entry_delete(entry: *mut efivar_entry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn efivar_entry_size(entry: *mut efivar_entry, size: *mut c_ulong) -> c_int {
...
// size = 0;
    ...
    &entry.var.VendorGuid, core::ptr::null_mut(), size, core::ptr::null_mut());
    efivar_unlock();
...
// size = 0;
    status = efivar_get_variable(entry.var.VariableName,
    &entry.var.VendorGuid,
    core::ptr::null_mut(), size, core::ptr::null_mut());
    efivar_unlock();
