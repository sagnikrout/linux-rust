...
#[no_mangle]
pub unsafe extern "C" fn __super_lock(sb: *mut super_block, excl: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn super_unlock(sb: *mut super_block, excl: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn __super_lock_excl(sb: *mut super_block) {
    static inline void __super_lock_excl(struct super_block *sb)
    {
    __super_lock(sb, true);
    }
#[no_mangle]
pub unsafe extern "C" fn super_unlock_excl(sb: *mut super_block) {
    static inline void super_unlock_excl(struct super_block *sb)
    {
    super_unlock(sb, true);
    }
#[no_mangle]
pub unsafe extern "C" fn super_unlock_shared(sb: *mut super_block) {
    static inline void super_unlock_shared(struct super_block *sb)
    {
    super_unlock(sb, false);
    }
#[no_mangle]
unsafe extern "C" fn super_flags(sb: *const super_block, flags: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn super_lock(sb: *mut super_block, excl: bool) -> __must_check bool {
...
#[no_mangle]
pub unsafe extern "C" fn super_lock_shared(sb: *mut super_block) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn super_lock_excl(sb: *mut super_block) -> bool {
...
#[no_mangle]
unsafe extern "C" fn super_wake(sb: *mut super_block, flag: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn super_fs_objects_eligible(sc: *mut shrink_control) -> bool {
...
//
    ...
    {
    struct super_block *sb;
    let mut total_objects: c_long = 0;
    sb = shrink.private_data;
//
...
#[no_mangle]
unsafe extern "C" fn destroy_super_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn destroy_super_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn destroy_unused_super(s: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn put_super(s: *mut super_block) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct super_dev {
    pub sd_dev: dev_t,
    pub sd_sb: *mut super_block,
    pub sd_ref: refcount_t,
    pub sd_node: rhlist_head,
    pub sd_rcu: rcu_head,
}
...
#[no_mangle]
unsafe extern "C" fn super_dev_put(fsd: *mut super_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn super_dev_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn super_dev_insert(fsd: *mut super_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn super_dev_register(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kill_super_notify(sb: *mut super_block) {
...
// Drop sget_fc()'s claim; a never-registered entry stays with the sb.
    ...
    sb.s_super_dev = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn deactivate_locked_super(s: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn deactivate_super(s: *mut super_block) {
...
//
#[no_mangle]
unsafe extern "C" fn grab_super(sb: *mut super_block) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn super_trylock_shared(sb: *mut super_block) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn retire_super(sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_shutdown_super(sb: *mut super_block) {
...
//
    ...
    sb.s_dio_done_wq = core::ptr::null_mut();
    }
    if (sop.put_super)
    sop.put_super(sb);
//
...
//
    ...
    if (CHECK_DATA_CORRUPTION(!list_empty(&sb.s_inodes), core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn mount_capable(fc: *mut fs_context) -> bool {
...
//
    ...
    {
    struct super_block *s = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn drop_super(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn drop_super_exclusive(sb: *mut super_block) {
    ...
    enum super_iter_flags_t flags)
    {
    struct super_block *sb, *p = core::ptr::null_mut();
    let mut excl: bool = flags & SUPER_ITER_EXCL;
    spin_lock(&sb_lock);
...
#[no_mangle]
pub unsafe extern "C" fn iterate_supers(: *mut *mut void (f)(struct super_block, ): *mut c_void, arg: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn reconfigure_super(fc: *mut fs_context) -> c_int {
    int reconfigure_super(struct fs_context *fc)
    {
    struct super_block *sb = fc.root.d_sb;
    int retval;
    let mut remount_ro: bool = false;
    let mut remount_rw: bool = false;
    let mut force: bool = fc.sb_flags & SB_FORCE;
...
#[no_mangle]
unsafe extern "C" fn do_emergency_remount_callback(sb: *mut super_block, unused: *mut c_void) {
    ...
    if (!IS_ERR(fc)) {
    if (parse_monolithic_mount_data(fc, core::ptr::null_mut()) == 0)
...
#[no_mangle]
unsafe extern "C" fn do_emergency_remount(work: *mut work_struct) {
    static void do_emergency_remount(struct work_struct *work)
    {
    __iterate_supers(do_emergency_remount_callback, core::ptr::null_mut(),
    SUPER_ITER_EXCL | SUPER_ITER_REVERSE);
    kfree(work);
    printk("Emergency Remount complete\n");
    }
#[no_mangle]
pub unsafe extern "C" fn emergency_remount() {
...
#[no_mangle]
pub unsafe extern "C" fn get_active_super(sb: *mut super_block) -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_thaw_all_callback(sb: *mut super_block, unused: *mut c_void) {
...
// fs_bdev_thaw() acquires s_umount so it must not be held here
    ...
    if (super_lock_excl(sb))
    thaw_super_locked(sb, FREEZE_HOLDER_USERSPACE, core::ptr::null_mut());
    deactivate_super(sb);
    }
#[no_mangle]
unsafe extern "C" fn do_thaw_all(work: *mut work_struct) {
    static void do_thaw_all(struct work_struct *work)
    {
    __iterate_supers(do_thaw_all_callback, core::ptr::null_mut(), SUPER_ITER_UNLOCKED);
    kfree(work);
...
//
#[no_mangle]
pub unsafe extern "C" fn emergency_thaw_all() {
...
#[no_mangle]
unsafe extern "C" fn filesystems_freeze_callback(sb: *mut super_block, freeze_all_ptr: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn filesystems_freeze(freeze_all: bool) {
    void filesystems_freeze(bool freeze_all)
    {
    void *freeze_all_ptr = core::ptr::null_mut();
    if (freeze_all)
...
#[no_mangle]
unsafe extern "C" fn filesystems_thaw_callback(sb: *mut super_block, unused: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn filesystems_thaw() {
    void filesystems_thaw(void)
    {
    __iterate_supers(filesystems_thaw_callback, core::ptr::null_mut(), SUPER_ITER_UNLOCKED);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn get_anon_bdev(p: *mut dev_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn free_anon_bdev(dev: dev_t) {
...
#[no_mangle]
pub unsafe extern "C" fn set_anon_super(s: *mut super_block, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kill_anon_super(sb: *mut super_block) {
    void kill_anon_super(struct super_block *sb)
    {
    let mut dev: dev_t = sb.s_dev;
...
#[no_mangle]
pub unsafe extern "C" fn set_anon_super_fc(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    int set_anon_super_fc(struct super_block *sb, struct fs_context *fc)
    {
    return set_anon_super(sb, core::ptr::null_mut());
    }
    EXPORT_SYMBOL(set_anon_super_fc);
#[no_mangle]
unsafe extern "C" fn test_keyed_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    static int test_keyed_super(struct super_block *sb, struct fs_context *fc)
    {
    return sb.s_fs_info == fc.s_fs_info;
    }
#[no_mangle]
unsafe extern "C" fn test_single_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
    ...
    struct fs_context *fc))
    {
    return vfs_get_super(fc, core::ptr::null_mut(), fill_super);
    }
...
#[no_mangle]
unsafe extern "C" fn set_bdev_super(s: *mut super_block, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn super_s_dev_set(s: *mut super_block, fc: *mut fs_context) -> c_int {
    static int super_s_dev_set(struct super_block *s, struct fs_context *fc)
    {
    return set_bdev_super(s, fc.sget_key);
    }
#[no_mangle]
unsafe extern "C" fn super_s_dev_test(s: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs_super_freeze(sb: *mut super_block) -> c_int {
    static int fs_super_freeze(struct super_block *sb)
    {
    if (sb.s_op.freeze_super)
    return sb.s_op.freeze_super(sb,
    FREEZE_MAY_NEST | FREEZE_HOLDER_USERSPACE, core::ptr::null_mut());
    return freeze_super(sb, FREEZE_MAY_NEST | FREEZE_HOLDER_USERSPACE, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn fs_super_thaw(sb: *mut super_block) -> c_int {
    static int fs_super_thaw(struct super_block *sb)
    {
    if (sb.s_op.thaw_super)
    return sb.s_op.thaw_super(sb,
    FREEZE_MAY_NEST | FREEZE_HOLDER_USERSPACE, core::ptr::null_mut());
    return thaw_super(sb, FREEZE_MAY_NEST | FREEZE_HOLDER_USERSPACE, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn fs_bdev_mark_dead(bdev: *mut block_device, surprise: bool) {
    static void fs_bdev_mark_dead(struct block_device *bdev, bool surprise)
    {
    struct super_dev *sb_dev;
    let mut dev: dev_t = bdev.bd_dev;
...
#[no_mangle]
unsafe extern "C" fn fs_bdev_sync(bdev: *mut block_device) {
...
//
#[no_mangle]
unsafe extern "C" fn fs_bdev_freeze(bdev: *mut block_device) -> c_int {
    static int fs_bdev_freeze(struct block_device *bdev)
    {
    let mut dev: dev_t = bdev.bd_dev;
    struct super_dev *sb_dev;
    let mut count: c_uint = 0;
    let mut error: c_int = 0, err;
...
//
#[no_mangle]
unsafe extern "C" fn fs_bdev_thaw(bdev: *mut block_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs_bdev_register(bdev_file: *mut file, sb: *mut super_block) -> c_int {
    static int fs_bdev_register(struct file *bdev_file, struct super_block *sb)
    {
    struct super_dev *sb_dev __free(kfree) = core::ptr::null_mut();
    let mut dev: dev_t = file_bdev(bdev_file).bd_dev;
    int err;
    scoped_guard(rcu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fs_bdev_unregister(bdev_file: *mut file, sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fs_bdev_file_release(bdev_file: *mut file, sb: *mut super_block) {
    ...
    struct fs_context *fc)
    {
    let mut mode: blk_mode_t = sb_open_mode(sb_flags);
    struct file *bdev_file;
...
#[no_mangle]
pub unsafe extern "C" fn kill_block_super(sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_get_tree(fc: *mut fs_context) -> c_int {
...
//
    ...
    error = security_sb_set_mnt_opts(sb, fc.security, 0, core::ptr::null_mut());
    if (unlikely(error)) {
    fc_drop_locked(fc);
    return error;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn super_setup_bdi_name(sb: *mut super_block, fmt: *mut c_char, ...) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn super_setup_bdi(sb: *mut super_block) -> c_int {
    int super_setup_bdi(struct super_block *sb)
    {
    let mut bdi_seq: static atomic_long_t = ATOMIC_LONG_INIT(0);
...
//
#[no_mangle]
unsafe extern "C" fn sb_wait_write(sb: *mut super_block, level: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn lockdep_sb_freeze_release(sb: *mut super_block) {
...
//
#[no_mangle]
unsafe extern "C" fn lockdep_sb_freeze_acquire(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn sb_freeze_unlock(sb: *mut super_block, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wait_for_partially_frozen(sb: *mut super_block) -> c_int {
    static int wait_for_partially_frozen(struct super_block *sb)
    {
    let mut ret: c_int = 0;
    do {
    let mut old: c_ushort = sb.s_writers.frozen;
    up_write(&sb.s_umount);
...
#[no_mangle]
pub unsafe extern "C" fn freeze_inc(sb: *mut super_block, who: enum freeze_holder) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn freeze_dec(sb: *mut super_block, who: enum freeze_holder) -> c_int {
...
//
    ...
    sb.s_writers.freeze_owner = core::ptr::null_mut();
    return true;
    }
    if (who & FREEZE_HOLDER_KERNEL) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn freeze_super(sb: *mut super_block, who: enum freeze_holder, freeze_owner: *const c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sb_init_dio_done_wq(sb: *mut super_block) -> c_int {
