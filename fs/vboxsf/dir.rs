...
#[no_mangle]
unsafe extern "C" fn vboxsf_dir_open(inode: *mut inode, file: *mut file) -> c_int {
    static int vboxsf_dir_open(struct inode *inode, struct file *file)
    {
    struct vboxsf_sbi *sbi = VBOXSF_SBI(inode.i_sb);
    let mut params: shfl_createparms = {};
...
#[no_mangle]
unsafe extern "C" fn vboxsf_dir_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_get_d_type(mode: u32) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_dir_emit(dir: *mut file, ctx: *mut dir_context) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_dir_iterate(dir: *mut file, ctx: *mut dir_context) -> c_int {
...
//
    ...
    return vboxsf_stat_dentry(dentry, core::ptr::null_mut()) == -ENOENT;
    }
...
// iops
    ...
    if (err) {
    inode = (err == -ENOENT) ? core::ptr::null_mut() : ERR_PTR(err);
    } else {
...
// handle_ret = params.handle;
    ...
    umode_t mode)
    {
    return vboxsf_dir_create(parent, dentry, mode, false, true, core::ptr::null_mut());
    }
    static struct dentry *vboxsf_dir_mkdir(struct mnt_idmap *idmap,
    struct inode *parent, struct dentry *dentry,
    umode_t mode)
    {
    return ERR_PTR(vboxsf_dir_create(parent, dentry, mode, true, true, core::ptr::null_mut()));
    }
...
#[no_mangle]
unsafe extern "C" fn vboxsf_dir_unlink(parent: *mut inode, dentry: *mut dentry) -> c_int {
...
// parent directory access/change time changed
    ...
    let mut shfl_flags: u32 = SHFL_RENAME_FILE | SHFL_RENAME_REPLACE_IF_EXISTS;
...
// parent directories access/change time changed
    ...
    struct vboxsf_inode *sf_parent_i = VBOXSF_I(parent);
    struct vboxsf_sbi *sbi = VBOXSF_SBI(parent.i_sb);
    let mut symname_size: c_int = strlen(symname) + 1;
