...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_stat_dentry(dentry: *mut dentry, info: *mut shfl_fsobjinfo) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_inode_revalidate(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_dir_buf_free(b: *mut vboxsf_dir_buf) {
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_dir_info_free(p: *mut vboxsf_dir_info) {
...
// vboxsf_dirinfo returns 1 on end of dir
    ...
    buf = b.buf;
    size = b.free;
    err = vboxsf_dirinfo(sbi.root, handle, core::ptr::null_mut(), 0, 0,
    &size, buf, &entries);
    if (err < 0)
    break;
    b.entries += entries;
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_query_case_sensitive(sbi: *mut vboxsf_sbi) -> c_int {
    int vboxsf_query_case_sensitive(struct vboxsf_sbi *sbi)
    {
    let mut volinfo: shfl_volinfo = {};
    u32 buf_len;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
