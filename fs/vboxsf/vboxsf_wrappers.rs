...
//! Source: fs/vboxsf/vboxsf_wrappers.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_connect() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_disconnect() {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_call(function: u32, parms: *mut c_void, parm_count: u32, status: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_map_folder(folder_name: *mut shfl_string, root: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_unmap_folder(root: u32) -> c_int {
    ...
    SHFL_CPARMS_UNMAP_FOLDER, core::ptr::null_mut());
    }
//
...
//
    ...
    return vboxsf_call(SHFL_FN_CREATE, &parms, SHFL_CPARMS_CREATE, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn vboxsf_close(root: u32, handle: u64) -> c_int {
    ...
    return vboxsf_call(SHFL_FN_CLOSE, &parms, SHFL_CPARMS_CLOSE, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn vboxsf_remove(root: u32, parsed_path: *mut shfl_string, flags: u32) -> c_int {
    ...
    return vboxsf_call(SHFL_FN_REMOVE, &parms, SHFL_CPARMS_REMOVE, core::ptr::null_mut());
    }
    ...
    parms.flags.type = VMMDEV_HGCM_PARM_TYPE_32BIT;
    parms.flags.u.value32 = flags;
    return vboxsf_call(SHFL_FN_RENAME, &parms, SHFL_CPARMS_RENAME, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn vboxsf_read(root: u32, handle: u64, offset: u64, buf_len: *mut u32, buf: *mut u8) -> c_int {
    ...
    err = vboxsf_call(SHFL_FN_READ, &parms, SHFL_CPARMS_READ, core::ptr::null_mut());
// buf_len = parms.cb.u.value32;
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn vboxsf_write(root: u32, handle: u64, offset: u64, buf_len: *mut u32, buf: *mut u8) -> c_int {
    ...
    parms.buffer.u.pointer.size = *buf_len;
    parms.buffer.u.pointer.u.linear_addr = (uintptr_t)buf;
    err = vboxsf_call(SHFL_FN_WRITE, &parms, SHFL_CPARMS_WRITE, core::ptr::null_mut());
// buf_len = parms.cb.u.value32;
    return err;
    }
...
// buf_len = parms.cb.u.value32;
    ...
    parms.info.u.pointer.u.linear_addr = (uintptr_t)buf;
    return vboxsf_call(SHFL_FN_SYMLINK, &parms, SHFL_CPARMS_SYMLINK, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn vboxsf_set_utf8() -> c_int {
    int vboxsf_set_utf8(void)
    {
    return vboxsf_call(SHFL_FN_SET_UTF8, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn vboxsf_set_symlinks() -> c_int {
    int vboxsf_set_symlinks(void)
    {
    return vboxsf_call(SHFL_FN_SET_SYMLINKS, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
