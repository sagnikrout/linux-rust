...
pub const VBOXSF_SUPER_MAGIC: c_uint = 0x786f4256 /* 'VBox' little endian */;
    ...
    let mut vboxsf_default_nls: *mut static char  const = CONFIG_NLS_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn vboxsf_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_inode_init_once(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_statfs(dentry: *mut dentry, stat: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_setup() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_parse_monolithic(fc: *mut fs_context, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_init() -> int __init {
    static int __init vboxsf_init(void)
    {
    return register_filesystem(&vboxsf_fs_type);
    }
#[no_mangle]
unsafe extern "C" fn vboxsf_fini() -> void __exit {
