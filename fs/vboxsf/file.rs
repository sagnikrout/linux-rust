...
#[no_mangle]
unsafe extern "C" fn vboxsf_file_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_handle_release(refcount: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn vboxsf_release_sf_handle(inode: *mut inode, sf_handle: *mut vboxsf_handle) {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_file_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vboxsf_vma_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_file_mmap_prepare(desc: *mut vm_area_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vboxsf_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    ...
    {
    struct vboxsf_handle *h, *sf_handle = core::ptr::null_mut();
    mutex_lock(&sf_i.handle_list_mutex);
    ...
    let mut off: loff_t = folio_pos(folio);
    let mut nwrite: u32 = folio_size(folio);
    u8 *buf;
    if (nwrite > size - off)
    nwrite = size - off;
    buf = kmap_local_folio(folio, 0);
