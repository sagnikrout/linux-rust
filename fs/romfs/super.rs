...
//
#[no_mangle]
unsafe extern "C" fn romfs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
pub const ROMFS_MAX_HARDLINK_DEPTH: c_int = 64;
//
...
//
    ...
    return inode ? &inode.vfs_inode : core::ptr::null_mut();
    }
//
// return a spent inode to the slab cache
//
#[no_mangle]
unsafe extern "C" fn romfs_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_reconfigure(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_checksum(data: *const c_void, size: c_int) -> __u32 {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_get_tree(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_kill_sb(sb: *mut super_block) {
...
//
#[no_mangle]
unsafe extern "C" fn romfs_i_init_once(_inode: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn init_romfs_fs() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn exit_romfs_fs() -> void __exit {
