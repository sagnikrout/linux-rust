...
//! Source: fs/cachefiles/interface.c
#![no_std]
...
//
    ...
    enum cachefiles_obj_ref_trace why)
    {
    let mut object_debug_id: c_uint = object.debug_id;
    let mut cookie_debug_id: c_uint = object.cookie.debug_id;
...
//
#[no_mangle]
unsafe extern "C" fn cachefiles_adjust_size(object: *mut cachefiles_object) -> c_int {
...
// data after it
    ...
    if (ret < 0)
    trace_cachefiles_io_error(core::ptr::null_mut(), file_inode(file), ret,
...
//
#[no_mangle]
unsafe extern "C" fn cachefiles_lookup_cookie(cookie: *mut fscache_cookie) -> bool {
...
//
    ...
    let mut old_size: loff_t = cookie.object_size;
...
//
#[no_mangle]
unsafe extern "C" fn cachefiles_withdraw_cookie(cookie: *mut fscache_cookie) {
    ...
    cookie.cache_priv = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn cachefiles_invalidate_cookie(cookie: *mut fscache_cookie) -> bool {
