...
//
#[no_mangle]
pub unsafe extern "C" fn ntfs_ucsncmp(s1: *const __le16, s2: *const __le16, n: usize) -> c_int {
...
// outs = ucs;
    ...
    ntfs_error(vol.sb, "Received core::ptr::null_mut() pointer.");
    return -EINVAL;
    name_err:
    if (max_name_len > NTFS_MAX_NAME_LEN)
    kvfree(ucs);
...
// We don't trust outside sources.
    ...
    break;
#[no_mangle]
pub unsafe extern "C" fn if(outs: *mut wc == -ENAMETOOLONG && ns !=) -> else {
    unsigned char *tc;
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_ucsnlen(s: *const __le16, maxlen: u32) -> u32 {
