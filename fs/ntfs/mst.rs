...
//
#[no_mangle]
pub unsafe extern "C" fn post_read_mst_fixup(b: *mut ntfs_record, size: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pre_write_mst_fixup(b: *mut ntfs_record, size: u32) -> c_int {
...
pub unsafe extern "C" fn post_write_mst_fixup(b: *mut ntfs_record) {
    ...
    {
    __le16 *usa_pos, *data_pos;
    let mut usa_ofs: u16 = le16_to_cpu(b.usa_ofs);
    let mut usa_count: u16 = le16_to_cpu(b.usa_count) - 1;
// Position of usn in update sequence array.
