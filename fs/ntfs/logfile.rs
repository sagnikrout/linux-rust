...
pub const MinLogRecordPages: c_int = 48;
//
...
pub const LOGFILE_NO_CLIENT_CPU: c_uint = 0xffff;
//
...
pub struct log_client_record {
    ...
    pub __packed: },
    pub rp): *mut restart_page_header,
    pub log_vi): *mut bool ntfs_empty_logfile(struct inode,
