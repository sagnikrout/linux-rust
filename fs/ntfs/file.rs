...
//
#[no_mangle]
unsafe extern "C" fn ntfs_file_open(vi: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_trim_prealloc(vi: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_file_release(vi: *mut inode, filp: *mut file) -> c_int {
...
//
    ...
    while (!(err = ntfs_attr_lookup(AT_UNUSED, core::ptr::null_mut(), 0, 0, 0, core::ptr::null_mut(), 0, ctx))) {
...
#[no_mangle]
unsafe extern "C" fn ntfs_setattr_size(vi: *mut inode, attr: *mut iattr) -> c_int {
    static int ntfs_setattr_size(struct inode *vi, struct iattr *attr)
    {
    struct ntfs_inode *ni = NTFS_I(vi);
    int err;
    let mut old_size: loff_t = vi.i_size;
...
//
    ...
    flags |= NTFS_EA_MODE;
    mutex_lock(&ni.mrec_lock);
    err = ntfs_ea_set_wsl_inode(vi, 0, core::ptr::null_mut(), flags);
    mutex_unlock(&ni.mrec_lock);
    if (err)
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn ntfs_file_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn ntfs_file_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    ...
    ret = iomap_dio_rw(iocb, to, &ntfs_read_iomap_ops, core::ptr::null_mut(), 0,
    core::ptr::null_mut(), 0);
    } else {
...
#[no_mangle]
unsafe extern "C" fn ntfs_expand_for_write(ni: *mut ntfs_inode, end: loff_t) -> c_int {
    static int ntfs_expand_for_write(struct ntfs_inode *ni, loff_t end)
    {
    struct ntfs_volume *vol = ni.vol;
    let mut prealloc_size: loff_t = 0;
    int err;
    if (end <= ni.data_size)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn ntfs_filemap_page_mkwrite(vmf: *mut vm_fault) -> vm_fault_t {
...
//
    ...
    ret = iomap_page_mkwrite(vmf, &ntfs_page_mkwrite_iomap_ops, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ntfs_ioctl_get_volume_label(filp: *mut file, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_ioctl_set_volume_label(filp: *mut file, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_ioctl_fitrim(vol: *mut ntfs_volume, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ntfs_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    ...
    core::ptr::null_mut(), &ntfs_seek_iomap_ops,
    &ntfs_iomap_folio_ops, core::ptr::null_mut());
    if (err < 0)
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn ntfs_collapse_range(ni: *mut ntfs_inode, offset: loff_t, len: loff_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_insert_range(ni: *mut ntfs_inode, offset: loff_t, len: loff_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_fallocate(file: *mut file, mode: c_int, offset: loff_t, len: loff_t) -> c_long {
...
// Take invalidate_lock for all fallocate operations to prevent races
    ...
    let mut ntfs_empty_file_ops: file_operations = {};
    let mut ntfs_empty_inode_ops: inode_operations = {};
