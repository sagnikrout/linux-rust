...
// Compressed data streams are handled in compress.c.
    ...
    iomap_read_folio(&ntfs_read_iomap_ops, &ctx, core::ptr::null_mut());
    return 0;
    }
//
...
//
    ...
    return;
    iomap_readahead(&ntfs_read_iomap_ops, &ctx, core::ptr::null_mut());
    }
