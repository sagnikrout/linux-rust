...
//! Source: fs/ntfs/lib/lzx_decompress.c
#![no_std]
...
// offset blocks.
//
pub const LZX_MIN_ALIGNED_OFFSET_SLOT: c_int = 8;
...
//
pub const LZX_WIM_MAGIC_FILESIZE: c_int = 12000000;
...
pub const LZX_LENCODE_TABLEBITS: c_int = 9;
...
pub struct lzx_decompressor {
    ...
    pub LZX_MAX_MAIN_CODEWORD_LEN): LZX_MAINCODE_TABLEBITS,,
    ...
    pub LZX_MAX_LEN_CODEWORD_LEN): LZX_LENCODE_TABLEBITS,,
...
#[no_mangle]
unsafe extern "C" fn undo_translate_target(target: *mut c_void, input_pos: i32) {
...
// Validate the match and copy it to the current position.
    ...
    let mut may_have_e8_byte: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn lzx_free_decompressor(d: *mut lzx_decompressor) {
    void lzx_free_decompressor(struct lzx_decompressor *d)
    {
    kfree(d);
    }
#[no_mangle]
unsafe extern "C" fn lzx_scratch_size(chunk_size: u32) -> usize {
