...
#[no_mangle]
unsafe extern "C" fn ntfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ntfs_handle_error(sb: *mut super_block) {
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_write_volume_flags(vol: *mut ntfs_volume, flags: __le16) -> c_int {
    ...
    err = ntfs_attr_lookup(AT_VOLUME_INFORMATION, core::ptr::null_mut(), 0, 0, 0, core::ptr::null_mut(), 0,
    ctx);
    if (err)
    goto put_unm_err_out;
...
//
#[no_mangle]
pub unsafe extern "C" fn ntfs_set_volume_flags(vol: *mut ntfs_volume, flags: __le16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntfs_clear_volume_flags(vol: *mut ntfs_volume, flags: __le16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ntfs_write_volume_label(vol: *mut ntfs_volume, label: *mut c_char) -> c_int {
...
//
    ...
    ctx = ntfs_attr_get_search_ctx(vol_ni, core::ptr::null_mut());
    if (!ctx) {
    ret = -ENOMEM;
    goto out;
    }
    ret = ntfs_attr_lookup(AT_VOLUME_NAME, core::ptr::null_mut(), 0, 0, 0, core::ptr::null_mut(), 0,
    ctx);
    if (!ret)
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_setup_allocators(vol: *mut ntfs_volume) {
...
//
#[no_mangle]
unsafe extern "C" fn load_and_init_mft_mirror(vol: *mut ntfs_volume) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn check_mft_mirror(vol: *mut ntfs_volume) -> bool {
    static bool check_mft_mirror(struct ntfs_volume *vol)
    {
    struct super_block *sb = vol.sb;
    struct ntfs_inode *mirr_ni;
    struct folio *mft_folio = core::ptr::null_mut(), *mirr_folio = core::ptr::null_mut();
    u8 *kmft = core::ptr::null_mut(), *kmirr = core::ptr::null_mut();
...
pub const NTFS_HIBERFIL_HEADER_SIZE: c_int = 4096;
//
...
//
#[no_mangle]
unsafe extern "C" fn check_windows_hibernation_status(vol: *mut ntfs_volume) -> c_int {
    ...
    struct inode *vi;
    struct folio *folio;
    u32 *kaddr, *kend, *start_addr = core::ptr::null_mut();
    struct ntfs_name *name = core::ptr::null_mut();
    let mut ret: c_int = 1;
    ntfs_debug("Entering.");
//
...
// Get the inode.
    ...
    folio = read_mapping_folio(vi.i_mapping, 0, core::ptr::null_mut());
    if (IS_ERR(folio)) {
...
//
#[no_mangle]
unsafe extern "C" fn load_and_init_attrdef(vol: *mut ntfs_volume) -> bool {
...
// Read the attrdef table and copy it into the linear buffer.
    ...
    folio = read_mapping_folio(ino.i_mapping, index, core::ptr::null_mut());
    if (IS_ERR(folio))
...
//
#[no_mangle]
unsafe extern "C" fn load_and_init_upcase(vol: *mut ntfs_volume) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(_arg: *mut default_upcase))) -> *mut default_upcase_len {
    kvfree(vol.upcase);
...
//
#[no_mangle]
unsafe extern "C" fn load_system_files(vol: *mut ntfs_volume) -> bool {
...
// Get mft bitmap attribute inode.
    vol.mftbmp_ino = ntfs_attr_iget(vol.mft_ino, AT_BITMAP, core::ptr::null_mut(), 0);
...
//
    ...
    if (!ntfs_attr_lookup(AT_VOLUME_NAME, core::ptr::null_mut(), 0, 0, 0, core::ptr::null_mut(), 0, ctx) &&
    ...
    if (err < 0)
    vol.volume_label = core::ptr::null_mut();
    }
    ntfs_attr_reinit_search_ctx(ctx);
    if (ntfs_attr_lookup(AT_VOLUME_INFORMATION, core::ptr::null_mut(), 0, 0, 0, core::ptr::null_mut(), 0,
...
// Make sure that no unsupported volume flags are set.
    ...
    es1 = es1a;
#[no_mangle]
pub unsafe extern "C" fn if(VOLUME_MODIFIED_BY_CHKDSK: vol->vol_flags &) -> else {
    es1 = es1b;
    es2 = es2b;
    } else {
    es1 = es1c;
...
#[no_mangle]
unsafe extern "C" fn ntfs_volume_free(vol: *mut ntfs_volume) {
...
//
    ...
    default_upcase = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_put_super(sb: *mut super_block) {
...
//
    ...
    iput(vol.vol_ino);
    vol.vol_ino = core::ptr::null_mut();
// NTFS 3.0+ specific clean up.
    if (vol.major_ver >= 3) {
    if (vol.extend_ino) {
    iput(vol.extend_ino);
    vol.extend_ino = core::ptr::null_mut();
    }
    if (vol.secure_ino) {
    iput(vol.secure_ino);
    vol.secure_ino = core::ptr::null_mut();
    }
    }
    iput(vol.root_ino);
    vol.root_ino = core::ptr::null_mut();
    iput(vol.lcnbmp_ino);
    vol.lcnbmp_ino = core::ptr::null_mut();
    iput(vol.mftbmp_ino);
    vol.mftbmp_ino = core::ptr::null_mut();
    if (vol.logfile_ino) {
    iput(vol.logfile_ino);
    vol.logfile_ino = core::ptr::null_mut();
    }
    if (vol.mftmirr_ino) {
// Re-commit the mft mirror and mft just in case.
    ...
    ntfs_commit_inode(vol.mft_ino);
    iput(vol.mftmirr_ino);
    vol.mftmirr_ino = core::ptr::null_mut();
    }
//
...
//
    ...
    iput(vol.mft_ino);
    vol.mft_ino = core::ptr::null_mut();
    blkdev_issue_flush(sb.s_bdev);
    ntfs_volume_free(vol);
    }
#[no_mangle]
pub unsafe extern "C" fn ntfs_force_shutdown(sb: *mut super_block, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_shutdown(sb: *mut super_block) {
    static void ntfs_shutdown(struct super_block *sb)
    {
    ntfs_force_shutdown(sb, FS_SHUTDOWN_FLAGS_NOLOGFLUSH);
    }
#[no_mangle]
unsafe extern "C" fn ntfs_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_nr_free_clusters(vol: *mut ntfs_volume) -> i64 {
    s64 get_nr_free_clusters(struct ntfs_volume *vol)
    {
    let mut nr_free: i64 = vol.nr_clusters;
    u32 nr_used;
    struct address_space *mapping = vol.lcnbmp_ino.i_mapping;
    struct folio *folio;
    pgoff_t index, max_index;
    let mut ra: file_ra_state = { 0 };
    ntfs_debug("Entering.");
...
//
#[no_mangle]
pub unsafe extern "C" fn ntfs_available_clusters_count(vol: *mut ntfs_volume, nr_clusters: i64) -> i64 {
...
// wait event
    ...
    return -ENOSPC;
#[no_mangle]
pub unsafe extern "C" fn if(nr_clusters: free_clusters <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_statfs(dentry: *mut dentry, sfs: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_write_inode(vi: *mut inode, wbc: *mut writeback_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn precalc_free_clusters(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_big_inode_init_once(foo: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ntfs_get_tree(fc: *mut fs_context) -> c_int {
    static int ntfs_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, ntfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn ntfs_free_fs_context(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn ntfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_workqueue_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_workqueue_destroy() {
    static void ntfs_workqueue_destroy(void)
    {
    destroy_workqueue(ntfs_wq);
    ntfs_wq = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn init_ntfs_fs() -> int __init {
    ...
    SLAB_HWCACHE_ALIGN, core::ptr::null_mut() /* ctor */);
    ...
    sizeof(struct ntfs_inode), 0, SLAB_RECLAIM_ACCOUNT, core::ptr::null_mut());
    if (!ntfs_inode_cache) {
...
#[no_mangle]
unsafe extern "C" fn exit_ntfs_fs() -> void __exit {
