...
#[no_mangle]
unsafe extern "C" fn orangefs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_inode_cache_ctor(req: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn orangefs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn orangefs_destroy_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_reconfigure(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn orangefs_remount(orangefs_sb: *mut orangefs_sb_info_s) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsid_key_table_initialize() -> c_int {
    int fsid_key_table_initialize(void)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn fsid_key_table_finalize() {
...
#[no_mangle]
unsafe extern "C" fn orangefs_unmount(id: c_int, fs_id: __s32, devname: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_free_fc(fc: *mut fs_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn orangefs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_kill_sb(sb: *mut super_block) {
...
// not list_del_init
    ...
    ORANGEFS_SB(sb).list.prev = core::ptr::null_mut();
    spin_unlock(&orangefs_superblocks_lock);
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_inode_cache_initialize() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_inode_cache_finalize() -> c_int {
