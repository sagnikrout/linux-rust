...
//! Source: fs/orangefs/waitqueue.c
#![no_std]
...
//
    ...
    __acquires(op.lock);
#[no_mangle]
unsafe extern "C" fn orangefs_clean_up_interrupted_operation(op: *mut orangefs_kernel_op_s) {
...
//
#[no_mangle]
pub unsafe extern "C" fn purge_waiting_ops() {
...
//
    ...
    int flags)
    {
    let mut timeout: c_long = MAX_SCHEDULE_TIMEOUT;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_cancel_op_in_progress(op: *mut orangefs_kernel_op_s) -> bool {
    bool orangefs_cancel_op_in_progress(struct orangefs_kernel_op_s *op)
    {
    let mut tag: u64 = op.tag;
...
#[no_mangle]
pub unsafe extern "C" fn if(interruptible: !writeback &&) -> else {
