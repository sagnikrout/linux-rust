...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct orangefs_dir_part {
    pub next: *mut orangefs_dir_part,
    pub len: usize,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct orangefs_dir {
    pub token: __u64,
    pub part: *mut orangefs_dir_part,
    pub end: loff_t,
    pub error: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn orangefs_dir_more(od: *mut orangefs_dir, inode: *mut inode) -> c_int {
    ...
    {
    let mut offset: c_int = sizeof(struct orangefs_readdir_response_s);
...
#[no_mangle]
unsafe extern "C" fn orangefs_dir_fill(od: *mut orangefs_dir, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_dir_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_dir_release(inode: *mut inode, file: *mut file) -> c_int {
