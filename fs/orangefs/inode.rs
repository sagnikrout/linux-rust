...
//
    ...
    struct orangefs_write_range *wr = core::ptr::null_mut();
    ...
    len, wr, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret < 0) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct orangefs_writepages {
    pub off: loff_t,
    pub len: usize,
    pub uid: kuid_t,
    pub gid: kgid_t,
    ...
    0, &wr, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn orangefs_readahead(rac: *mut readahead_control) {
    ...
    struct folio *folio;
    let mut new_start: loff_t = readahead_pos(rac);
    int ret;
    let mut new_len: usize = 0;
    size_t this_size;
    size_t remaining;
    let mut bytes_remaining: loff_t = inode.i_size - readahead_pos(rac);
    let mut pages_remaining: loff_t = bytes_remaining / PAGE_SIZE;
    if (pages_remaining >= 1024)
    new_len = 4194304;
#[no_mangle]
pub unsafe extern "C" fn if(readahead_count(rac): pages_remaining >) -> else {
...
// read in the pages.
    ...
    inode.i_size, core::ptr::null_mut(), core::ptr::null_mut(), rac.file)) < 0) {
...
#[no_mangle]
unsafe extern "C" fn orangefs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    ...
    folio_size(folio), inode.i_size, core::ptr::null_mut(), core::ptr::null_mut(), file);
...
// zero the stale part of the folio if we did a short copy
    ...
    let mut from: unsigned = pos & (PAGE_SIZE - 1);
    if (copied < len) {
...
#[no_mangle]
unsafe extern "C" fn orangefs_release_folio(folio: *mut folio, foo: gfp_t) -> bool {
    static bool orangefs_release_folio(struct folio *folio, gfp_t foo)
    {
    return !folio_test_private(folio);
    }
#[no_mangle]
unsafe extern "C" fn orangefs_free_folio(folio: *mut folio) {
    static void orangefs_free_folio(struct folio *folio)
    {
    kfree(folio_detach_private(folio));
    }
#[no_mangle]
unsafe extern "C" fn orangefs_launder_folio(folio: *mut folio) -> c_int {
...
//
    ...
    let mut each_count: usize = iov_iter_count(iter);
    size_t amt_complete;
// how much to transfer in this loop iteration
    ...
    each_count, 0, core::ptr::null_mut(), core::ptr::null_mut(), file);
    gossip_debug(GOSSIP_FILE_DEBUG,
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_page_mkwrite(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn orangefs_setattr_size(inode: *mut inode, iattr: *mut iattr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __orangefs_setattr(inode: *mut inode, iattr: *mut iattr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __orangefs_setattr_mode(dentry: *mut dentry, iattr: *mut iattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_init_iops(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn orangefs_handle_hash(ref: *mut orangefs_object_kref) -> ino_t {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_set_inode(inode: *mut inode, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_test_inode(inode: *mut inode, data: *mut c_void) -> c_int {
    static int orangefs_test_inode(struct inode *inode, void *data)
    {
    struct orangefs_object_kref *ref = (struct orangefs_object_kref *) data;
    struct orangefs_inode_s *orangefs_inode = core::ptr::null_mut();
...
//
    ...
    {
    struct posix_acl *acl = core::ptr::null_mut(), *default_acl = core::ptr::null_mut();
    let mut hash: c_ulong = orangefs_handle_hash(ref);
    struct inode *inode;
    int error;
    gossip_debug(GOSSIP_INODE_DEBUG,
