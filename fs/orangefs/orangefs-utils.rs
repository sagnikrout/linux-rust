...
//! Source: fs/orangefs/orangefs-utils.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fsid_of_op(op: *mut orangefs_kernel_op_s) -> __s32 {
...
#[no_mangle]
unsafe extern "C" fn orangefs_inode_flags(attrs: *mut ORANGEFS_sys_attr_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_inode_perms(attrs: *mut ORANGEFS_sys_attr_s) -> c_int {
    static int orangefs_inode_perms(struct ORANGEFS_sys_attr_s *attrs)
    {
    let mut perm_mode: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn orangefs_inode_type(objtype: enum orangefs_ds_type) -> c_int {
    static int orangefs_inode_type(enum orangefs_ds_type objtype)
    {
    if (objtype == ORANGEFS_TYPE_METAFILE)
    return S_IFREG;
#[no_mangle]
pub unsafe extern "C" fn if(ORANGEFS_TYPE_DIRECTORY: objtype ==) -> else {
    else if (objtype == ORANGEFS_TYPE_DIRECTORY)
    return S_IFDIR;
#[no_mangle]
pub unsafe extern "C" fn if(ORANGEFS_TYPE_SYMLINK: objtype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn orangefs_make_bad_inode(inode: *mut inode) {
...
//
    ...
    {
    struct orangefs_inode_s *orangefs_inode = ORANGEFS_I(inode);
    let mut type: c_int = orangefs_inode_type(attrs.objtype);
//
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_inode_getattr(inode: *mut inode, flags: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_inode_check_changed(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn orangefs_inode_setattr(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_normalize_to_errno(error_code: __s32) -> c_int {
...
pub const NUM_MODES: c_int = 11;
#[no_mangle]
pub unsafe extern "C" fn ORANGEFS_util_translate_mode(mode: c_int) -> __s32 {
