...
#[no_mangle]
unsafe extern "C" fn flush_racache(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn orangefs_revalidate_mapping(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orangefs_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_file_mmap_prepare(desc: *mut vm_area_desc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_file_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_file_llseek(file: *mut file, offset: loff_t, origin: c_int) -> loff_t {
...
//
#[no_mangle]
unsafe extern "C" fn orangefs_lock(filp: *mut file, cmd: c_int, fl: *mut file_lock) -> c_int {
    ...
    rc = posix_lock_file(filp, fl, core::ptr::null_mut());
    }
    }
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn orangefs_flush(file: *mut file, id: fl_owner_t) -> c_int {
