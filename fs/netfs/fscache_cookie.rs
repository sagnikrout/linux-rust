...
//! Source: fs/netfs/fscache_cookie.c
#![no_std]
...
pub const fscache_cookie_hash_shift: c_int = 15;
    ...
    let mut fscache_lru_cookie_timeout: static unsigned int = 10 * HZ;
#[no_mangle]
pub unsafe extern "C" fn fscache_print_cookie(cookie: *mut fscache_cookie, prefix: c_char) {
...
#[no_mangle]
unsafe extern "C" fn fscache_free_cookie(cookie: *mut fscache_cookie) {
...
#[no_mangle]
unsafe extern "C" fn __fscache_queue_cookie(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_init_access_gate(cookie: *mut fscache_cookie) {
...
#[no_mangle]
pub unsafe extern "C" fn wake_up_cookie_state(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_cookie_lookup_negative(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_resume_after_invalidation(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_caching_failed(cookie: *mut fscache_cookie) {
...
//
    ...
    let mut fscache_cookie_debug_id: static atomic_t = ATOMIC_INIT(1);
//
// Allocate a cookie.
//
...
#[no_mangle]
pub unsafe extern "C" fn fscache_cookie_is_dropped(cookie: *mut fscache_cookie) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_hash_cookie(candidate: *mut fscache_cookie) -> bool {
    static bool fscache_hash_cookie(struct fscache_cookie *candidate)
    {
    struct fscache_cookie *cursor, *wait_for = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn fscache_prepare_to_write(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_perform_lookup(cookie: *mut fscache_cookie) {
    static void fscache_perform_lookup(struct fscache_cookie *cookie)
    {
    let mut trace: enum fscache_access_trace = fscache_access_lookup_cookie_end_failed;
    let mut need_withdraw: bool = false;
    _enter("");
...
//
#[no_mangle]
unsafe extern "C" fn fscache_begin_lookup(cookie: *mut fscache_cookie, will_modify: bool) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn __fscache_use_cookie(cookie: *mut fscache_cookie, will_modify: bool) {
...
#[no_mangle]
unsafe extern "C" fn fscache_unuse_cookie_locked(cookie: *mut fscache_cookie) {
...
//
    ...
    {
    let mut debug_id: c_uint = cookie.debug_id;
    let mut r: c_uint = refcount_read(&cookie.ref);
    let mut a: c_uint = atomic_read(&cookie.n_accesses);
    unsigned int c;
...
//
#[no_mangle]
unsafe extern "C" fn fscache_cookie_state_machine(cookie: *mut fscache_cookie) {
...
#[no_mangle]
unsafe extern "C" fn fscache_cookie_worker(work: *mut work_struct) {
    static void fscache_cookie_worker(struct work_struct *work)
    {
...
//
#[no_mangle]
unsafe extern "C" fn __fscache_withdraw_cookie(cookie: *mut fscache_cookie) {
...
#[no_mangle]
unsafe extern "C" fn fscache_cookie_lru_do_one(cookie: *mut fscache_cookie) {
...
#[no_mangle]
unsafe extern "C" fn fscache_cookie_lru_worker(work: *mut work_struct) {
    static void fscache_cookie_lru_worker(struct work_struct *work)
    {
    struct fscache_cookie *cookie;
...
#[no_mangle]
unsafe extern "C" fn fscache_cookie_lru_timed_out(timer: *mut timer_list) {
    static void fscache_cookie_lru_timed_out(struct timer_list *timer)
    {
    queue_work(fscache_wq, &fscache_cookie_lru_work);
    }
#[no_mangle]
unsafe extern "C" fn fscache_cookie_drop_from_lru(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_unhash_cookie(cookie: *mut fscache_cookie) {
    static void fscache_unhash_cookie(struct fscache_cookie *cookie)
    {
    struct hlist_bl_head *h;
    unsigned int bucket;
...
#[no_mangle]
unsafe extern "C" fn fscache_drop_withdraw_cookie(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_withdraw_cookie(cookie: *mut fscache_cookie) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __fscache_relinquish_cookie(cookie: *mut fscache_cookie, retire: bool) {
...
//
    ...
    let mut cookie_debug_id: c_uint = cookie.debug_id;
    bool zero;
    int ref;
...
//
#[no_mangle]
unsafe extern "C" fn fscache_perform_invalidation(cookie: *mut fscache_cookie) {
    static void fscache_perform_invalidation(struct fscache_cookie *cookie)
    {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_cookies_seq_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    static int fscache_cookies_seq_show(struct seq_file *m, void *v)
    {
    struct fscache_cookie *cookie;
    let mut keylen: c_uint = 0, auxlen = 0;
    u8 *p;
...
#[no_mangle]
unsafe extern "C" fn fscache_cookies_seq_stop(m: *mut seq_file, v: *mut c_void) {
