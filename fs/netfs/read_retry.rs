...
//
#[no_mangle]
unsafe extern "C" fn netfs_retry_read_subrequests(rreq: *mut netfs_io_request) {
    ...
    rreq.netfs_ops.retry_request(rreq, core::ptr::null_mut());
...
//
    ...
    size_t part;
    let mut boundary: bool = false, subreq_superfluous = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_retry_reads(rreq: *mut netfs_io_request) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_unlock_abandoned_read_pages(rreq: *mut netfs_io_request) {
