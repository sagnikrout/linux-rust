...
//! Source: fs/netfs/fscache_cache.c
#![no_std]
...
//
    ...
    {
    struct fscache_cache *candidate, *cache, *unnamed = core::ptr::null_mut();
...
// write lock, search again and add if still not present
    ...
    candidate.name = core::ptr::null_mut();
    got_cache_w:
    up_write(&fscache_addremove_sem);
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_relinquish_cache(cache: *mut fscache_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_begin_cache_access(cache: *mut fscache_cache, why: enum fscache_access_trace) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_end_cache_access(cache: *mut fscache_cache, why: enum fscache_access_trace) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_io_error(cache: *mut fscache_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_withdraw_cache(cache: *mut fscache_cache) {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_caches_seq_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fscache_caches_seq_stop(m: *mut seq_file, v: *mut c_void) {
