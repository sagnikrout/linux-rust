...
//! Source: fs/netfs/rolling_buffer.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn rolling_buffer_make_space(roll: *mut rolling_buffer, gfp: gfp_t) -> c_int {
...
//
    ...
    {
    let mut size: isize = folio_size(folio);
    int slot;
...
//
#[no_mangle]
pub unsafe extern "C" fn rolling_buffer_clear(roll: *mut rolling_buffer) {
