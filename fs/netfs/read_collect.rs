...
//! Source: fs/netfs/read_collect.c
#![no_std]
...
pub const HIT_PENDING: c_uint = 0x01	/* A front op was still pending */;
pub const MADE_PROGRESS: c_uint = 0x04	/* Made progress cleaning up a stream or the folio set */;
pub const BUFFERED: c_uint = 0x08	/* The pagecache needs cleaning up */;
pub const NEED_RETRY: c_uint = 0x10	/* A front op requests retrying */;
pub const COPY_TO_CACHE: c_uint = 0x40	/* Need to copy subrequest to cache */;
pub const ABANDON_SREQ: c_uint = 0x80	/* Need to abandon untransferred part of subrequest */;
//
// Clear the unread part of an I/O request.
//
#[no_mangle]
unsafe extern "C" fn netfs_clear_unread(subreq: *mut netfs_io_subrequest) {
...
//
    ...
    if (!WARN_ON_ONCE(folio_get_private(folio) != core::ptr::null_mut())) {
...
//
    ...
    let mut collected_to: c_ulonglong = rreq.collected_to;
    let mut slot: c_uint = rreq.buffer.first_tail_slot;
...
//
#[no_mangle]
unsafe extern "C" fn netfs_collect_read_results(rreq: *mut netfs_io_request) {
...
//
    if (notes & BUFFERED) {
    let mut fsize: usize = PAGE_SIZE << rreq.front_folio_order;
...
//
#[no_mangle]
unsafe extern "C" fn netfs_rreq_assess_dio(rreq: *mut netfs_io_request) {
...
//
#[no_mangle]
unsafe extern "C" fn netfs_rreq_assess_single(rreq: *mut netfs_io_request) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_read_collection(rreq: *mut netfs_io_request) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn netfs_read_collection_worker(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_read_subreq_progress(subreq: *mut netfs_io_subrequest) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_read_subreq_terminated(subreq: *mut netfs_io_subrequest) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_cancel_read(subreq: *mut netfs_io_subrequest, error: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_cache_read_terminated(priv: *mut c_void, transferred_or_error: isize) {
