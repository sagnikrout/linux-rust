...
pub unsafe extern "C" fn netfs_single_mark_inode_dirty(inode: *mut inode) {
    ...
    let mut cache_only: bool = test_bit(NETFS_ICTX_SINGLE_NO_UPLOAD, &ictx.flags);
    let mut caching: bool = fscache_cookie_enabled(netfs_i_cookie(netfs_inode(inode)));
...
#[no_mangle]
unsafe extern "C" fn netfs_single_begin_cache_read(rreq: *mut netfs_io_request, ctx: *mut netfs_inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn netfs_single_dispatch_read(rreq: *mut netfs_io_request) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_read_single(inode: *mut inode, file: *mut file, iter: *mut iov_iter) -> isize {
