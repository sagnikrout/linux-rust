...
#[no_mangle]
pub unsafe extern "C" fn netfs_get_request(rreq: *mut netfs_io_request, what: enum netfs_rreq_ref_trace) {
...
#[no_mangle]
pub unsafe extern "C" fn netfs_clear_subrequests(rreq: *mut netfs_io_request) {
...
#[no_mangle]
unsafe extern "C" fn netfs_deinit_request(rreq: *mut netfs_io_request) {
...
#[no_mangle]
unsafe extern "C" fn netfs_free_request(work: *mut work_struct) {
    static void netfs_free_request(struct work_struct *work)
    {
    struct netfs_io_request *rreq =
...
#[no_mangle]
pub unsafe extern "C" fn netfs_put_request(rreq: *mut netfs_io_request, what: enum netfs_rreq_ref_trace) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_put_failed_request(rreq: *mut netfs_io_request) {
    void netfs_put_failed_request(struct netfs_io_request *rreq)
    {
    let mut r: c_int = refcount_read(&rreq.ref);
...
//
    ...
    INIT_WORK(&subreq.work, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn netfs_free_subrequest(subreq: *mut netfs_io_subrequest) {
    ...
    enum netfs_sreq_ref_trace what)
    {
    let mut debug_index: c_uint = subreq.debug_index;
    let mut debug_id: c_uint = subreq.rreq.debug_id;
    bool dead;
    int r;
