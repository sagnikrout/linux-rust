...
//! Source: fs/netfs/fscache_volume.c
#![no_std]
...
pub const fscache_volume_hash_shift: c_int = 10;
    ...
    enum fscache_volume_trace where)
    {
    let mut ref: c_int = refcount_read(&volume.ref);
...
#[no_mangle]
unsafe extern "C" fn fscache_is_acquire_pending(volume: *mut fscache_volume) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_hash_volume(candidate: *mut fscache_volume) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_create_volume_work(work: *mut work_struct) {
    static void fscache_create_volume_work(struct work_struct *work)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_create_volume(volume: *mut fscache_volume, wait: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_unhash_volume(volume: *mut fscache_volume) {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_free_volume(volume: *mut fscache_volume) {
    static void fscache_free_volume(struct fscache_volume *volume)
    {
    struct fscache_cache *cache = volume.cache;
    if (volume.cache_priv) {
    __fscache_begin_volume_access(volume, core::ptr::null_mut(),
    fscache_access_relinquish_volume);
    if (volume.cache_priv)
    cache.ops.free_volume(volume);
    fscache_end_volume_access(volume, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn fscache_withdraw_volume(volume: *mut fscache_volume) {
...
//
#[no_mangle]
unsafe extern "C" fn fscache_volumes_seq_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fscache_volumes_seq_stop(m: *mut seq_file, v: *mut c_void) {
