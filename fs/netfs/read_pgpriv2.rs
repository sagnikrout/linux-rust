...
//! Source: fs/netfs/read_pgpriv2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn netfs_pgpriv2_copy_folio(creq: *mut netfs_io_request, folio: *mut folio) {
    ...
    let mut fsize: usize = folio_size(folio), flen = fsize;
...
//
    ...
    goto cancel;
    creq = netfs_create_write_req(rreq.mapping, core::ptr::null_mut(), folio_pos(folio),
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_pgpriv2_copy_to_cache(rreq: *mut netfs_io_request, folio: *mut folio) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_pgpriv2_end_copy_to_cache(rreq: *mut netfs_io_request) {
    ...
    creq.copy_to_cache = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn netfs_pgpriv2_unlock_copied_folios(creq: *mut netfs_io_request) -> bool {
    bool netfs_pgpriv2_unlock_copied_folios(struct netfs_io_request *creq)
    {
    struct folio_queue *folioq = creq.buffer.tail;
    let mut collected_to: c_ulonglong = creq.collected_to;
    let mut slot: c_uint = creq.buffer.first_tail_slot;
    let mut made_progress: bool = false;
