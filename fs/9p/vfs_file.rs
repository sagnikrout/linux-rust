...
pub unsafe extern "C" fn v9fs_file_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    let mut writeback_omode: c_int = (omode & ~(P9_OWRITE | o_append)) | P9_ORDWR;
...
//
#[no_mangle]
unsafe extern "C" fn v9fs_file_lock(filp: *mut file, cmd: c_int, fl: *mut file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v9fs_file_do_lock(filp: *mut file, cmd: c_int, fl: *mut file_lock) -> c_int {
    static int v9fs_file_do_lock(struct file *filp, int cmd, struct file_lock *fl)
    {
    struct p9_flock flock;
    struct p9_fid *fid;
    let mut status: u8 = P9_LOCK_ERROR;
    let mut res: c_int = 0;
    struct v9fs_session_info *v9ses;
    fid = filp.private_data;
    BUG_ON(fid == core::ptr::null_mut());
...
//
    ...
    let mut type: c_uchar = fl.c.flc_type;
...
#[no_mangle]
unsafe extern "C" fn v9fs_file_getlock(filp: *mut file, fl: *mut file_lock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn v9fs_file_lock_dotl(filp: *mut file, cmd: c_int, fl: *mut file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v9fs_mmap_vm_close(vma: *mut vm_area_struct) {
