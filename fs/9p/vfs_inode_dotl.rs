...
//
#[no_mangle]
unsafe extern "C" fn v9fs_get_fsgid_for_create(dir_inode: *mut inode) -> kgid_t {
    static kgid_t v9fs_get_fsgid_for_create(struct inode *dir_inode)
    {
    BUG_ON(dir_inode == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn v9fs_test_inode_dotl(inode: *mut inode, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v9fs_test_new_inode_dotl(inode: *mut inode, data: *mut c_void) -> c_int {
    static int v9fs_test_new_inode_dotl(struct inode *inode, void *data)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn v9fs_set_inode_dotl(inode: *mut inode, data: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dotl_openflag_map {
    pub open_flag: c_int,
    pub dotl_flag: c_int,
}

#[no_mangle]
unsafe extern "C" fn v9fs_mapped_dotl_flags(flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn v9fs_open_to_dotl_flags(flags: c_int) -> c_int {
...
//
    ...
    kgid_t gid;
    umode_t mode;
    let mut p9_omode: c_int = v9fs_open_to_dotl_flags(flags);
    const unsigned char *name = core::ptr::null_mut();
    struct p9_qid qid;
    struct inode *inode;
    struct p9_fid *fid = core::ptr::null_mut();
    struct p9_fid *dfid = core::ptr::null_mut(), *ofid = core::ptr::null_mut();
    struct v9fs_session_info *v9ses;
    struct posix_acl *pacl = core::ptr::null_mut(), *dacl = core::ptr::null_mut();
...
//
    ...
    let mut err: c_int = 0;
    struct v9fs_session_info *v9ses;
    struct p9_fid *fid = core::ptr::null_mut(), *dfid = core::ptr::null_mut();
    kgid_t gid;
    const unsigned char *name;
    umode_t mode;
    struct inode *inode;
    struct p9_qid qid;
    struct posix_acl *dacl = core::ptr::null_mut(), *pacl = core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dotl_iattr_map {
    pub iattr_valid: c_int,
    pub p9_iattr_valid: c_int,
}

#[no_mangle]
unsafe extern "C" fn v9fs_mapped_iattr_valid(iattr_valid: c_int) -> c_int {
    static int v9fs_mapped_iattr_valid(int iattr_valid)
    {
    int i;
    let mut p9_iattr_valid: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn v9fs_refresh_inode_dotl(fid: *mut p9_fid, inode: *mut inode) -> c_int {
