...
//
#[no_mangle]
unsafe extern "C" fn unixmode2p9mode(v9ses: *mut v9fs_session_info, mode: umode_t) -> u32 {
...
//
    ...
    {
    int res, r;
    let mut mode: u32 = stat.mode;
// rdev = 0;
    res = p9mode2perm(v9ses, stat);
    if ((mode & P9_DMDIR) == P9_DMDIR)
    res |= S_IFDIR;
#[no_mangle]
pub unsafe extern "C" fn if((v9fs_proto_dotu(v9ses)): (mode & P9_DMSYMLINK) &&) -> else {
    else if ((mode & P9_DMSYMLINK) && (v9fs_proto_dotu(v9ses)))
    res |= S_IFLNK;
#[no_mangle]
pub unsafe extern "C" fn if((v9fs_proto_dotu(v9ses): (mode & P9_DMSOCKET) &&) -> else {
    else if ((mode & P9_DMSOCKET) && (v9fs_proto_dotu(v9ses))
    && (v9ses.nodev == 0))
    res |= S_IFSOCK;
#[no_mangle]
pub unsafe extern "C" fn if((v9fs_proto_dotu(v9ses): (mode & P9_DMNAMEDPIPE) &&) -> else {
    else if ((mode & P9_DMNAMEDPIPE) && (v9fs_proto_dotu(v9ses))
    && (v9ses.nodev == 0))
    res |= S_IFIFO;
#[no_mangle]
pub unsafe extern "C" fn if((v9fs_proto_dotu(v9ses): (mode & P9_DMDEVICE) &&) -> else {
    else if ((mode & P9_DMDEVICE) && (v9fs_proto_dotu(v9ses))
    && (v9ses.nodev == 0)) {
    let mut type: c_char = 0;
    let mut major: c_int = -1, minor = -1;
...
//
#[no_mangle]
pub unsafe extern "C" fn v9fs_uflags2omode(uflags: c_int, extended: c_int) -> c_int {
...
// ((long long *)&wstat->qid.path) = ~0;
    ...
    wstat.mtime = ~0;
    wstat.length = ~0;
    wstat.name = core::ptr::null_mut();
    wstat.uid = core::ptr::null_mut();
    wstat.gid = core::ptr::null_mut();
    wstat.muid = core::ptr::null_mut();
    wstat.n_uid = INVALID_UID;
    wstat.n_gid = INVALID_GID;
    wstat.n_muid = INVALID_UID;
    wstat.extension = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn v9fs_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn v9fs_set_netfs_context(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: v9fs_proto_dotu(v9ses)) -> else {
    else if (v9fs_proto_dotu(v9ses))
...
//
#[no_mangle]
pub unsafe extern "C" fn v9fs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn v9fs_test_inode(inode: *mut inode, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v9fs_test_new_inode(inode: *mut inode, data: *mut c_void) -> c_int {
    static int v9fs_test_new_inode(struct inode *inode, void *data)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn v9fs_set_inode(inode: *mut inode, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn v9fs_at_to_dotl_flags(flags: c_int) -> c_int {
    static int v9fs_at_to_dotl_flags(int flags)
    {
    let mut rflags: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn v9fs_dec_count(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn v9fs_remove(dir: *mut inode, dentry: *mut dentry, flags: c_int) -> c_int {
...
//
    ...
    struct p9_fid *dfid, *ofid = core::ptr::null_mut(), *fid = core::ptr::null_mut();
    struct inode *inode;
...
//
    ...
    let mut perm: u32 = unixmode2p9mode(v9ses, mode);
    struct p9_fid *fid;
// P9_OEXCL?
    fid = v9fs_create(v9ses, dir, dentry, core::ptr::null_mut(), perm, P9_ORDWR);
    if (IS_ERR(fid))
    return PTR_ERR(fid);
    v9fs_invalidate_inode_attr(dir);
    p9_fid_put(fid);
...
//
    ...
    fid = v9fs_create(v9ses, dir, dentry, core::ptr::null_mut(), perm, P9_OREAD);
    if (IS_ERR(fid))
    return ERR_CAST(fid);
    inc_nlink(dir);
    v9fs_invalidate_inode_attr(dir);
...
//
    ...
    v9fs_fid_add(dentry, &fid);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !IS_ERR(res)) -> else {
    else if (!IS_ERR(res))
...
// Only creates
    ...
    fid = v9fs_create(v9ses, dir, dentry, core::ptr::null_mut(), perm, p9_omode);
    if (IS_ERR(fid))
    return PTR_ERR(fid);
    v9fs_invalidate_inode_attr(dir);
    inode = d_inode(dentry);
...
//
#[no_mangle]
pub unsafe extern "C" fn v9fs_vfs_unlink(i: *mut inode, d: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn v9fs_vfs_rmdir(i: *mut inode, d: *mut dentry) -> c_int {
...
//
    ...
    struct v9fs_session_info *v9ses;
    struct p9_fid *oldfid = core::ptr::null_mut(), *dfid = core::ptr::null_mut();
    struct p9_fid *olddirfid = core::ptr::null_mut();
    struct p9_fid *newdirfid = core::ptr::null_mut();
...
//
    ...
    let mut retval: c_int = filemap_fdatawrite(inode.i_mapping);
    if (retval)
    p9_debug(P9_DEBUG_ERROR,
...
//
    ...
    struct inode *inode = d_inode(dentry);
    struct v9fs_session_info *v9ses;
    struct p9_fid *fid = core::ptr::null_mut();
    struct p9_wstat wstat;
    p9_debug(P9_DEBUG_VFS, "\n");
...
//
    ...
    res = st.extension;
    st.extension = core::ptr::null_mut();
...
pub const U32_MAX_DIGITS: c_int = 10;
//
...
#[no_mangle]
pub unsafe extern "C" fn v9fs_refresh_inode(fid: *mut p9_fid, inode: *mut inode) -> c_int {
