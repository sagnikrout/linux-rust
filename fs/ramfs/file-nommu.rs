...
#[no_mangle]
unsafe extern "C" fn ramfs_mmap_capabilities(file: *mut file) -> unsigned {
...
//
#[no_mangle]
pub unsafe extern "C" fn ramfs_nommu_expand_for_mapping(inode: *mut inode, newsize: usize) -> c_int {
...
//
    ...
    let mut old_ia_valid: c_uint = ia.ia_valid;
    let mut ret: c_int = 0;
