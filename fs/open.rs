...
// Note any delegations or leases have already been broken:
    ret = notify_change(idmap, dentry, &newattrs, core::ptr::null_mut());
    inode_unlock(dentry.d_inode);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn vfs_truncate(path: *const path, length: loff_t) -> c_int {
...
//
    ...
    if (!error)
    error = do_truncate(idmap, path.dentry, length, 0, core::ptr::null_mut());
    put_write_and_out:
...
#[no_mangle]
pub unsafe extern "C" fn ksys_truncate(pathname: *const char __user, length: loff_t) -> c_int {
    int ksys_truncate(const char __user *pathname, loff_t length)
    {
    let mut lookup_flags: c_uint = LOOKUP_FOLLOW;
    struct path path;
    int error;
    ...
    retry:
    error = filename_lookup(AT_FDCWD, name, lookup_flags, &path, core::ptr::null_mut());
    if (!error) {
...
#[no_mangle]
pub unsafe extern "C" fn do_ftruncate(file: *mut file, length: loff_t, flags: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ksys_ftruncate(fd: c_uint, length: loff_t, flags: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfs_fallocate(file: *mut file, mode: c_int, offset: loff_t, len: loff_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ksys_fallocate(fd: c_int, mode: c_int, offset: loff_t, len: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn access_need_override_creds(flags: c_int) -> bool {
    ...
    let mut root_uid: kuid_t = make_kuid(cred.user_ns, 0);
...
// Clear the capabilities if we switch to a non-root user
    let mut root_uid: kuid_t = make_kuid(override_cred.user_ns, 0);
...
#[no_mangle]
unsafe extern "C" fn do_faccessat(dfd: c_int, filename: *const char __user, mode: c_int, flags: c_int) -> c_int {
    ...
    int res;
    let mut lookup_flags: c_uint = LOOKUP_FOLLOW;
    const struct cred *old_cred = core::ptr::null_mut();
    ...
    retry:
    res = filename_lookup(dfd, name, lookup_flags, &path, core::ptr::null_mut());
    if (res)
    goto out;
...
//
    ...
    struct path path;
    int error;
    let mut lookup_flags: c_uint = LOOKUP_FOLLOW | LOOKUP_DIRECTORY;
...
#[no_mangle]
pub unsafe extern "C" fn chmod_common(path: *const path, mode: umode_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfs_fchmod(file: *mut file, mode: umode_t) -> c_int {
    ...
    CLASS(filename_uflags, name)(filename, flags);
    retry:
    error = filename_lookup(dfd, name, lookup_flags, &path, core::ptr::null_mut());
    if (!error) {
...
//
#[no_mangle]
pub unsafe extern "C" fn setattr_vfsuid(attr: *mut iattr, kuid: kuid_t) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn setattr_vfsgid(attr: *mut iattr, kgid: kgid_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn chown_common(path: *const path, user: uid_t, group: gid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfs_fchown(file: *mut file, user: uid_t, group: gid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ksys_fchown(fd: c_uint, user: uid_t, group: gid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn file_get_write_access(f: *mut file) -> c_int {
    ...
    {
    let mut empty_fops: static struct file_operations = {};
...
// normally all 3 are set; ->open() can clear them if needed
    ...
    cleanup_file:
    path_put(&f.f_path);
    f.__f_path.mnt = core::ptr::null_mut();
    f.__f_path.dentry = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn finish_no_open(file: *mut file, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_open(path: *const path, file: *mut file) -> c_int {
    int vfs_open(const struct path *path, struct file *file)
    {
    int ret;
    file.__f_path = *path;
    ret = do_dentry_open(file, core::ptr::null_mut());
    if (!ret) {
//
...
#[no_mangle]
pub unsafe extern "C" fn build_open_how(flags: c_int, mode: umode_t) -> open_how {
...
#[no_mangle]
pub unsafe extern "C" fn build_open_flags(how: *const open_how, op: *mut open_flags) -> c_int {
    inline int build_open_flags(const struct open_how *how, struct open_flags *op)
    {
    let mut flags: u64 = how.flags;
    let mut strip: u64 = O_CLOEXEC;
    let mut lookup_flags: c_int = 0;
    let mut acc_mode: c_int = ACC_MODE(flags);
...
//
    ...
    let mut how: open_how = build_open_how(flags, mode);
    let mut err: c_int = build_open_flags(&how, &op);
    if (err)
    return ERR_PTR(err);
...
#[no_mangle]
pub unsafe extern "C" fn do_sys_open(dfd: c_int, filename: *const char __user, flags: c_int, mode: umode_t) -> c_int {
...
//
    ...
    {
    let mut flags: c_int = O_CREAT | O_WRONLY | O_TRUNC;
    if (force_o_largefile())
    flags |= O_LARGEFILE;
...
//
#[no_mangle]
unsafe extern "C" fn filp_flush(filp: *mut file, id: fl_owner_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn filp_close(filp: *mut file, id: fl_owner_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_file_open(inode: *mut *mut inode, filp: *mut *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nonseekable_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn stream_open(inode: *mut inode, filp: *mut file) -> c_int {
