...
#[no_mangle]
pub unsafe extern "C" fn sizeof(inode): struct) -> *mut 2 {
    2 * sizeof(struct inode))
// configurable via /proc/sys/fs/inotify/
    static int inotify_max_queued_events __read_mostly;
    struct kmem_cache *inotify_inode_mark_cachep __ro_after_init;

    let mut it_zero: static long = 0;
    let mut it_int_max: static long = INT_MAX;
...
#[no_mangle]
unsafe extern "C" fn inotify_sysctls_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn inotify_arg_to_mask(inode: *mut inode, arg: u32) -> __u32 {
...
#[no_mangle]
pub unsafe extern "C" fn inotify_arg_to_flags(arg: u32) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn inotify_mask_to_arg(mask: __u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn inotify_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn round_event_name_len(fsn_event: *mut fsnotify_event) -> c_int {
...
//
    ...
    size_t count)
    {
    let mut event_size: usize = sizeof(struct inotify_event);
...
#[no_mangle]
unsafe extern "C" fn inotify_release(ignored: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    struct idr *idr = &group.inotify_data.idr;
    spinlock_t *idr_lock = &group.inotify_data.idr_lock;
    struct inotify_inode_mark *found_i_mark = core::ptr::null_mut();
    int wd;
    spin_lock(idr_lock);
    wd = i_mark.wd;
//
...
// Queue ignore event for the watch
    inotify_handle_inode_event(fsn_mark, FS_IN_IGNORED, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    0);
...
// remove this mark from the idr
    ...
    struct inotify_inode_mark *i_mark;
    let mut replace: c_int = !(arg & IN_MASK_ADD);
    let mut create: c_int = (arg & IN_MASK_CREATE);
    int ret;
    fsn_mark = fsnotify_find_inode_mark(inode, group);
    if (!fsn_mark)
    return -ENOENT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: create) -> else {
    ret = -EEXIST;
    goto out;
    }
    i_mark = container_of(fsn_mark, struct inotify_inode_mark, fsn_mark);
...
#[no_mangle]
unsafe extern "C" fn inotify_update_watch(group: *mut fsnotify_group, inode: *mut inode, arg: u32) -> c_int {
...
// inotify syscalls
#[no_mangle]
unsafe extern "C" fn do_inotify_init(flags: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn inotify_user_setup() -> int __init {
