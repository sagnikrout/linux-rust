...
#[no_mangle]
pub unsafe extern "C" fn fsnotify_get_mark(mark: *mut fsnotify_mark) {
...
#[no_mangle]
pub unsafe extern "C" fn if(FSNOTIFY_OBJ_TYPE_VFSMOUNT: conn->type ==) -> else {
    else if (conn.type == FSNOTIFY_OBJ_TYPE_VFSMOUNT)
    return &fsnotify_conn_mount(conn).mnt_fsnotify_mask;
#[no_mangle]
pub unsafe extern "C" fn if(FSNOTIFY_OBJ_TYPE_SB: conn->type ==) -> else {
    else if (conn.type == FSNOTIFY_OBJ_TYPE_SB)
    return &fsnotify_conn_sb(conn).s_fsnotify_mask;
#[no_mangle]
pub unsafe extern "C" fn if(FSNOTIFY_OBJ_TYPE_MNTNS: conn->type ==) -> else {
    else if (conn.type == FSNOTIFY_OBJ_TYPE_MNTNS)
    return &fsnotify_conn_mntns(conn).n_fsnotify_mask;
    return core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn fsnotify_conn_mask(conn: *mut fsnotify_mark_connector) -> __u32 {
...
#[no_mangle]
unsafe extern "C" fn fsnotify_get_sb_watched_objects(sb: *mut super_block) {
    static void fsnotify_get_sb_watched_objects(struct super_block *sb)
    {
    atomic_long_inc(fsnotify_sb_watched_objects(sb));
    }
#[no_mangle]
unsafe extern "C" fn fsnotify_put_sb_watched_objects(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn fsnotify_get_inode_ref(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fsnotify_put_inode_ref(inode: *mut inode) {
...
//
    ...
    let mut is_watched: bool = conn.flags & FSNOTIFY_CONN_FLAG_IS_WATCHED;
    struct fsnotify_mark *first_mark = core::ptr::null_mut();
    let mut highest_prio: c_uint = 0;
    if (conn.obj)
...
//
    ...
    bool want_iref)
    {
    let mut has_iref: bool = conn.flags & FSNOTIFY_CONN_FLAG_HAS_IREF;
...
//
#[no_mangle]
unsafe extern "C" fn __fsnotify_recalc_mask(conn: *mut fsnotify_mark_connector) -> bool {
    static bool __fsnotify_recalc_mask(struct fsnotify_mark_connector *conn)
    {
    let mut new_mask: u32 = 0;
    let mut want_iref: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn fsnotify_recalc_mask_set_iref(conn: *mut fsnotify_mark_connector) {
    static void fsnotify_recalc_mask_set_iref(struct fsnotify_mark_connector *conn)
    {
    let mut has_iref: bool = conn.flags & FSNOTIFY_CONN_FLAG_HAS_IREF;
    let mut want_iref: bool = __fsnotify_recalc_mask(conn) || has_iref;
...
//
    ...
    {
    let mut want_iref: bool = __fsnotify_recalc_mask(conn);
...
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_recalc_mask(conn: *mut fsnotify_mark_connector) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_modify_mark_mask(mark: *mut fsnotify_mark, set: u32, clear: u32) {
...
#[no_mangle]
unsafe extern "C" fn fsnotify_connector_destroy_workfn(work: *mut work_struct) {
    static void fsnotify_connector_destroy_workfn(struct work_struct *work)
    {
    struct fsnotify_mark_connector *conn, *free;
    spin_lock(&destroy_lock);
    conn = connector_destroy_list;
    connector_destroy_list = core::ptr::null_mut();
...
// Unpin inode when detaching from connector
    ...
    rcu_assign_pointer(*connp, core::ptr::null_mut());
    conn.obj = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fsnotify_final_mark_destroy(mark: *mut fsnotify_mark) {
...
#[no_mangle]
unsafe extern "C" fn fsnotify_drop_object(type: c_uint, objp: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn fsnotify_put_mark(mark: *mut fsnotify_mark) {
    void fsnotify_put_mark(struct fsnotify_mark *mark)
    {
    struct fsnotify_mark_connector *conn = READ_ONCE(mark.connector);
    void *objp = core::ptr::null_mut();
    let mut type: c_uint = FSNOTIFY_OBJ_TYPE_DETACHED;
    let mut free_conn: bool = false;
...
// Update watched objects after detaching mark
    ...
    WRITE_ONCE(mark.connector, core::ptr::null_mut());
    spin_unlock(&conn.lock);
...
//
#[no_mangle]
unsafe extern "C" fn fsnotify_get_mark_safe(mark: *mut fsnotify_mark) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fsnotify_put_mark_wake(mark: *mut fsnotify_mark) {
...
#[no_mangle]
pub unsafe extern "C" fn fsnotify_prepare_user_wait(iter_info: *mut fsnotify_iter_info) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fsnotify_finish_user_wait(iter_info: *mut fsnotify_iter_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_detach_mark(mark: *mut fsnotify_mark) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_free_mark(mark: *mut fsnotify_mark) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_compare_groups(a: *mut fsnotify_group, b: *mut fsnotify_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsnotify_attach_info_to_sb(sb: *mut super_block) -> c_int {
...
//
    if (cmpxchg(&sb.s_fsnotify_info, core::ptr::null_mut(), sbinfo)) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsnotify_inode_mark_connector {
    pub common: fsnotify_mark_connector,
    pub conns_list: list_head,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_unmount_inodes(sbinfo: *mut fsnotify_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn fsnotify_untrack_connector(conn: *mut fsnotify_mark_connector) {
    static void fsnotify_untrack_connector(struct fsnotify_mark_connector *conn)
    {
    struct fsnotify_inode_mark_connector *iconn;
    struct fsnotify_sb_info *sbinfo;
...
//
    if (cmpxchg(connp, core::ptr::null_mut(), conn)) {
...
//
    ...
    struct fsnotify_mark *lmark, *last = core::ptr::null_mut();
    struct fsnotify_mark_connector *conn;
    fsnotify_connp_t *connp;
    int cmp;
    let mut err: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn fsnotify_destroy_marks(connp: *mut fsnotify_connp_t) {
    void fsnotify_destroy_marks(fsnotify_connp_t *connp)
    {
    struct fsnotify_mark_connector *conn;
    struct fsnotify_mark *mark, *old_mark = core::ptr::null_mut();
    void *objp;
    unsigned int type;
    conn = fsnotify_grab_connector(connp);
    if (!conn)
...
//
#[no_mangle]
unsafe extern "C" fn fsnotify_mark_destroy_workfn(work: *mut work_struct) {
    static void fsnotify_mark_destroy_workfn(struct work_struct *work)
    {
...
#[no_mangle]
pub unsafe extern "C" fn fsnotify_wait_marks_destroyed() {
...
#[no_mangle]
pub unsafe extern "C" fn fsnotify_init_connector_caches() -> __init void {
