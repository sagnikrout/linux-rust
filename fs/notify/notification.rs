...
//! Source: fs/notify/notification.c
#![no_std]
...
//
    ...
    let mut fsnotify_sync_cookie: static atomic_t = ATOMIC_INIT(0);
//
// fsnotify_get_cookie - return a unique cookie for use in synchronizing events.
// Called from fsnotify_move, which is inlined into filesystem modules.
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_get_cookie() -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsnotify_flush_notify(group: *mut fsnotify_group) {
