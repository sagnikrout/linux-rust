...
//
    ...
    {
    let mut magic: u32 = fs32_to_cpu(sb, usb3.fs_magic);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ufs_fs_context {
    pub on_err: unsigned int flavour,,
}

#[no_mangle]
unsafe extern "C" fn ufs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufs_setup_cstotal(sb: *mut super_block) {
    ...
    struct ufs_super_block_second *usb2;
    struct ufs_super_block_third *usb3;
    let mut mtype: unsigned = sbi.s_flavour;
    UFSD("ENTER, mtype=%u\n", mtype);
    usb1 = ubh_get_usb_first(uspi);
...
//
#[no_mangle]
unsafe extern "C" fn ufs_read_cylinder_structures(sb: *mut super_block) -> c_int {
...
//
    ...
    sbi.s_ucg[i] = core::ptr::null_mut();
    for (i = 0; i < UFS_MAX_GROUP_LOADED; i++) {
    sbi.s_ucpi[i] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ufs_put_cstotal(sb: *mut super_block) {
    static void ufs_put_cstotal(struct super_block *sb)
    {
    let mut mtype: unsigned = UFS_SB(sb).s_flavour;
    struct ufs_sb_private_info *uspi = UFS_SB(sb).s_uspi;
    struct ufs_super_block_first *usb1;
    struct ufs_super_block_second *usb2;
    struct ufs_super_block_third *usb3;
...
//
#[no_mangle]
unsafe extern "C" fn ufs_put_super_internal(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ufs_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufs_mark_sb_dirty(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ufs_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ufs_max_bytes(sb: *mut super_block) -> u64 {
    static u64 ufs_max_bytes(struct super_block *sb)
    {
    struct ufs_sb_private_info *uspi = UFS_SB(sb).s_uspi;
    let mut bits: c_int = uspi.s_apbshift;
    u64 res;
    if (bits > 21)
    res = ~0ULL;
    else
...
#[no_mangle]
unsafe extern "C" fn ufs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    ...
    uspi = core::ptr::null_mut();
    ubh = core::ptr::null_mut();
    flags = 0;
    UFSD("ENTER\n");
...
#[no_mangle]
unsafe extern "C" fn ufs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
    static int ufs_show_options(struct seq_file *seq, struct dentry *root)
    {
    struct ufs_sb_info *sbi = UFS_SB(root.d_sb);
    let mut mval: unsigned = sbi.s_flavour;
...
#[no_mangle]
unsafe extern "C" fn ufs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_free_in_core_inode(inode: *mut inode) {
...
unsafe extern "C" fn init_inodecache() -> int __init {
    ...
    i_u1.i_symlink),
    init_once);
    if (ufs_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn ufs_get_tree(fc: *mut fs_context) -> c_int {
    static int ufs_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, ufs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn ufs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn ufs_init_fs_context(fc: *mut fs_context) -> c_int {
    ...
    MODULE_ALIAS_FS("ufs");
#[no_mangle]
unsafe extern "C" fn init_ufs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_ufs_fs() -> void __exit {
