...
#[no_mangle]
pub unsafe extern "C" fn ufs_add_nondir(dentry: *mut dentry, inode: *mut inode) -> c_int {
    static inline int ufs_add_nondir(struct dentry *dentry, struct inode *inode)
    {
    let mut err: c_int = ufs_add_link(dentry, inode);
    if (!err) {
...
#[no_mangle]
unsafe extern "C" fn ufs_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_rmdir(dir: *mut *mut inode, dentry: *mut dentry) -> c_int {
    ...
    let mut dir_de: *mut ufs_dir_entry = core::ptr::null_mut();
