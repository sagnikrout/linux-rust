...
//
    ...
    let mut cylno: unsigned = ufs_cbtocylno(fragment);
...
//
#[no_mangle]
pub unsafe extern "C" fn ufs_free_fragments(inode: *mut inode, fragment: u64, count: unsigned) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufs_free_blocks(inode: *mut inode, fragment: u64, count: unsigned) {
...
//
    ...
    let mut mask: unsigned = blks_per_page - 1;
    let mut mapping: *mut address_space  const = inode.i_mapping;
...
//
    ...
    newcount - oldcount, locked_folio != core::ptr::null_mut());
// err = 0;
...
#[no_mangle]
unsafe extern "C" fn try_add_frags(inode: *mut inode, frags: unsigned) -> bool {
    static bool try_add_frags(struct inode *inode, unsigned frags)
    {
    let mut size: unsigned = frags * i_blocksize(inode);
...
//
    ...
    {
    let mut uspi: *mut ufs_sb_private_info = UFS_SB(sb).s_uspi;
    int i, start, end, forw, back;
    let mut blkno: unsigned = ufs_fragstoblks(frag);
