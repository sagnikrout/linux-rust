...
//
    ...
    ext2_fsblk_t bitmap_blk;
    int ret;
    desc = ext2_get_group_desc(sb, block_group, core::ptr::null_mut());
    if (!desc)
    return core::ptr::null_mut();
    bitmap_blk = le32_to_cpu(desc.bg_block_bitmap);
...
//
    ...
    n = n.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(rsv->rsv_end: goal >) -> else {
...
//
    ...
    let mut start: ext2_fsblk_t = rsv.rsv_start;
    let mut p: *mut *mut rb_node = &root.rb_node;
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(this->rsv_end: start >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn rsv_is_empty(rsv: *mut ext2_reserve_window) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext2_init_block_alloc_info(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext2_discard_reservation(inode: *mut inode) {
...
//
    ...
    let mut sb: *mut super_block = inode.i_sb;
    let mut sbi: *mut ext2_sb_info = EXT2_SB(sb);
    struct ext2_group_desc * desc;
    let mut es: *mut ext2_super_block = sbi.s_es;
    let mut freed: unsigned = 0, group_freed;
...
//
    let mut end_goal: ext2_grpblk_t = (start + 63) & ~63;
...
//
    ...
    {
    let mut group_first_block: ext2_fsblk_t = ext2_group_first_block_no(sb, group);
    let mut group_last_block: ext2_fsblk_t = ext2_group_last_block_no(sb, group);
...
//
    ...
    struct ext2_reserve_window_node *rsv, *prev;
    ext2_fsblk_t cur;
    let mut size: c_int = my_rsv.rsv_goal_size;
...
//
    ...
    {
    ext2_fsblk_t group_first_block, group_last_block;
    let mut ret: ext2_grpblk_t = 0;
    let mut num: c_ulong = *count;
//
...
//
    if (my_rsv == core::ptr::null_mut()) {
    return ext2_try_to_allocate(sb, group, bitmap_bh,
    grp_goal, count, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ext2_has_free_blocks(sbi: *mut ext2_sb_info) -> c_int {
...
//
    ...
    let mut performed_allocation: c_int = 0;
    ext2_grpblk_t free_blocks;	/* number of free blocks in a group */
    struct super_block *sb;
    struct ext2_group_desc *gdp;
    struct ext2_super_block *es;
    struct ext2_sb_info *sbi;
    struct ext2_reserve_window_node *my_rsv = core::ptr::null_mut();
    struct ext2_block_alloc_info *block_i;
    let mut windowsz: c_ushort = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ext2_count_free(map: *mut buffer_head, numchars: c_uint) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn ext2_count_free_blocks(sb: *mut *mut super_block) -> c_ulong {
    unsigned long ext2_count_free_blocks (struct super_block * sb)
    {
    struct ext2_group_desc * desc;
    let mut desc_count: c_ulong = 0;
    int i;
    ...
    desc = ext2_get_group_desc (sb, i, core::ptr::null_mut());
    if (!desc)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn test_root(a: c_int, b: c_int) -> c_int {
    static inline int test_root(int a, int b)
    {
    let mut num: c_int = b;
    while (a > num)
    num *= b;
    let mut num: return = = a;
    }
#[no_mangle]
unsafe extern "C" fn ext2_group_sparse(group: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext2_bg_has_super(sb: *mut super_block, group: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ext2_bg_num_gdb(sb: *mut super_block, group: c_int) -> c_ulong {
