...
// in cache
//
pub const SYNC_SHRINK_BATCH: c_int = 64;
//
...
//
    ...
    u32 key)
    {
    return __entry_find(cache, core::ptr::null_mut(), key);
    }
...
pub const SHRINK_DIVISOR: c_int = 16;
#[no_mangle]
unsafe extern "C" fn mb_cache_shrink_worker(work: *mut work_struct) {
...
//
    ...
    let mut bucket_count: c_ulong = 1UL << bucket_bits;
    unsigned long i;
...
#[no_mangle]
unsafe extern "C" fn mbcache_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mbcache_exit() -> void __exit {
