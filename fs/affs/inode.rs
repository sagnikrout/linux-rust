...
#[no_mangle]
pub unsafe extern "C" fn if(affs_test_opt(sbi->s_flags: id == 0xFFFF &&, _arg: SF_MUFS)) -> else {
...
//
    ...
    {
    struct super_block *sb = dir.i_sb;
    struct buffer_head *inode_bh = core::ptr::null_mut();
    struct buffer_head *bh;
    let mut block: u32 = 0;
    int retval;
