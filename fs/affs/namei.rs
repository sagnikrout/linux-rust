...
//
    ...
    {
    let mut fn: toupper_t = affs_get_toupper(sb);
    u32 hash;
...
// TODO: move it back to old_dir, if error?
    ...
    {
    struct super_block *sb = old_dir.i_sb;
    struct buffer_head *bh_old = core::ptr::null_mut();
    struct buffer_head *bh_new = core::ptr::null_mut();
    int retval;
