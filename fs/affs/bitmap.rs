...
// (__be32 *)bh->b_data = cpu_to_be32(tmp - mask);
    ...
    sbi.s_bmap_bh = core::ptr::null_mut();
    sbi.s_last_bmap = ~0;
    mutex_unlock(&sbi.s_bmlock);
    return;
    err_range:
...
#[no_mangle]
pub unsafe extern "C" fn affs_init_bitmap(sb: *mut super_block, flags: *mut c_int) -> c_int {
    int affs_init_bitmap(struct super_block *sb, int *flags)
    {
    struct affs_bm_info *bm;
    struct buffer_head *bmap_bh = core::ptr::null_mut(), *bh = core::ptr::null_mut();
    __be32 *bmap_blk;
...
#[no_mangle]
pub unsafe extern "C" fn affs_free_bitmap(sb: *mut super_block) {
    ...
    sbi.s_last_bmap = ~0;
    kfree(sbi.s_bitmap);
    sbi.s_bitmap = core::ptr::null_mut();
    }
