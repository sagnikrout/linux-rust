...
#[no_mangle]
unsafe extern "C" fn affs_dir_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn affs_dir_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn affs_dir_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    struct buffer_head	*dir_bh = core::ptr::null_mut();
    struct buffer_head	*fh_bh = core::ptr::null_mut();
    unsigned char		*name;
    int			 namelen;
    u32			 i;
    int			 hash_pos;
