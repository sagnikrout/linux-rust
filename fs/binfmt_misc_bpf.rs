...
#[no_mangle]
pub unsafe extern "C" fn binfmt_misc_put_ops(ops: *const binfmt_misc_ops) {
...
//
    ...
    if (!interp)
    return -ENOMEM;
    bm_bpf_stage_selection(bprm, interp, core::ptr::null_mut());
    return 0;
    }
//
...
#[no_mangle]
unsafe extern "C" fn bm_bpf_ops__match(bprm: *mut linux_binprm) -> bool {
    static bool bm_bpf_ops__match(struct linux_binprm *bprm)
    {
    return false;
    }
#[no_mangle]
unsafe extern "C" fn bm_bpf_ops__load(bprm: *mut linux_binprm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm_bpf_init(btf: *mut btf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm_bpf_validate(kdata: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm_bpf_reg(kdata: *mut c_void, link: *mut bpf_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm_bpf_unreg(kdata: *mut c_void, link: *mut bpf_link) {
...
#[no_mangle]
unsafe extern "C" fn bm_bpf_struct_ops_init() -> int __init {
