...
#[no_mangle]
pub unsafe extern "C" fn hash(journal: *mut journal_t, block: c_ulonglong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_destroy_revoke_record_cache() {
    void jbd2_journal_destroy_revoke_record_cache(void)
    {
    kmem_cache_destroy(jbd2_revoke_record_cache);
    jbd2_revoke_record_cache = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_destroy_revoke_table_cache() {
    void jbd2_journal_destroy_revoke_table_cache(void)
    {
    kmem_cache_destroy(jbd2_revoke_table_cache);
    jbd2_revoke_table_cache = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_init_revoke_record_cache() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_init_revoke_table_cache() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_init_revoke(journal: *mut journal_t, hash_size: c_int) -> c_int {
    int jbd2_journal_init_revoke(journal_t *journal, int hash_size)
    {
    J_ASSERT(journal.j_revoke_table[0] == core::ptr::null_mut());
    ...
    journal.j_revoke_table[0] = core::ptr::null_mut();
    fail0:
    return -ENOMEM;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_cancel_revoke(handle: *mut handle_t, jh: *mut journal_head) {
...
// There better not be one left behind by now!
    record = find_revoke_record(journal, bh.b_blocknr);
    J_ASSERT_JH(jh, record == core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_clear_buffer_revoked_flags(journal: *mut journal_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_switch_revoke_table(journal: *mut journal_t) {
