...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_init_transaction_cache() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_destroy_transaction_cache() {
    void jbd2_journal_destroy_transaction_cache(void)
    {
    kmem_cache_destroy(transaction_cache);
    transaction_cache = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_free_transaction(transaction: *mut transaction_t) {
...
//
#[no_mangle]
unsafe extern "C" fn wait_transaction_locked(journal: *mut journal_t) {
...
//
#[no_mangle]
unsafe extern "C" fn wait_transaction_switching(journal: *mut journal_t) {
...
#[no_mangle]
unsafe extern "C" fn sub_reserved_credits(journal: *mut journal_t, blocks: c_int) {
...
#[no_mangle]
unsafe extern "C" fn jbd2_max_user_trans_buffers(journal: *mut journal_t) -> c_int {
...
//
    ...
    int needed;
    let mut total: c_int = blocks + rsv_blocks;
//
...
//
    ...
    gfp_t gfp_mask)
    {
    transaction_t	*transaction, *new_transaction = core::ptr::null_mut();
    let mut blocks: c_int = handle.h_total_credits;
    let mut rsv_blocks: c_int = 0;
...
//
    ...
    new_transaction = core::ptr::null_mut();
    }
    write_unlock(&journal.j_state_lock);
    goto repeat;
    }
...
#[no_mangle]
unsafe extern "C" fn __jbd2_journal_unreserve_handle(handle: *mut handle_t, t: *mut transaction_t) {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_free_reserved(handle: *mut handle_t) {
...
//
    ...
    handle.h_journal = core::ptr::null_mut();
//
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_extend(handle: *mut handle_t, nblocks: c_int, revoke_records: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_this_handle(handle: *mut handle_t) {
...
//
    ...
    let mut rr_per_blk: c_int = journal.j_revoke_records_per_block;
...
//
    ...
    handle.h_transaction = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_restart(handle: *mut handle_t, nblocks: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_wait_updates(journal: *mut journal_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_lock_updates(journal: *mut journal_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_unlock_updates(journal: *mut journal_t) {
...
#[no_mangle]
unsafe extern "C" fn warn_dirty_buffer(bh: *mut buffer_head) {
...
#[no_mangle]
unsafe extern "C" fn jbd2_freeze_jh_data(jh: *mut journal_head) {
...
//
    ...
    journal_t *journal;
    int error;
    char *frozen_buffer = core::ptr::null_mut();
...
//
    ...
    frozen_buffer = core::ptr::null_mut();
...
//
    ...
    out:
    if (unlikely(frozen_buffer))	/* It's usually core::ptr::null_mut() */
    kfree(frozen_buffer);
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_get_write_access(handle: *mut handle_t, bh: *mut buffer_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_get_create_access(handle: *mut handle_t, bh: *mut buffer_head) -> c_int {
...
//
    spin_lock(&jh.b_state_lock);
    if (!(jh.b_transaction == transaction || jh.b_transaction == core::ptr::null_mut() ||
    (jh.b_transaction == journal.j_committing_transaction &&
    jh.b_jlist == BJ_Forget)) || jh.b_next_transaction != core::ptr::null_mut()) {
    err = -EROFS;
    spin_unlock(&jh.b_state_lock);
    ...
    if (jh.b_transaction == core::ptr::null_mut()) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_get_undo_access(handle: *mut handle_t, bh: *mut buffer_head) -> c_int {
    int jbd2_journal_get_undo_access(handle_t *handle, struct buffer_head *bh)
    {
    int err;
    struct journal_head *jh;
    char *committed_data = core::ptr::null_mut();
    if (is_handle_aborted(handle))
    return -EROFS;
...
// preserved, committed copy.
    ...
    committed_data = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_dirty_metadata(handle: *mut handle_t, bh: *mut buffer_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_forget(handle: *mut handle_t, bh: *mut buffer_head) -> c_int {
    int jbd2_journal_forget(handle_t *handle, struct buffer_head *bh)
    {
    transaction_t *transaction = handle.h_transaction;
    journal_t *journal;
    struct journal_head *jh;
    let mut drop_reserve: c_int = 0;
    let mut err: c_int = 0;
    let mut was_modified: c_int = 0;
    let mut wait_for_writeback: c_int = 0;
    let mut abort_journal: c_int = 0;
    if (is_handle_aborted(handle))
    return -EROFS;
    journal = transaction.t_journal;
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_stop(handle: *mut handle_t) -> c_int {
    int jbd2_journal_stop(handle_t *handle)
    {
    transaction_t *transaction = handle.h_transaction;
    journal_t *journal;
    let mut err: c_int = 0, wait_for_commit = 0;
    tid_t tid;
    pid_t pid;
    if (--handle.h_ref > 0) {
...
//
#[no_mangle]
unsafe extern "C" fn __jbd2_journal_temp_unlink_buffer(jh: *mut journal_head) {
    static void __jbd2_journal_temp_unlink_buffer(struct journal_head *jh)
    {
    struct journal_head **list = core::ptr::null_mut();
    transaction_t *transaction;
    struct buffer_head *bh = jh2bh(jh);
    ...
    J_ASSERT_JH(jh, transaction != core::ptr::null_mut());
    switch (jh.b_jlist) {
    case BJ_None:
    return;
    case BJ_Metadata:
    ...
    clear_buffer_jbddirty(bh);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_clear_buffer_jbddirty(bh)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_try_to_free_buffers(journal: *mut journal_t, folio: *mut folio) -> bool {
...
// Remove written-back checkpointed metadata buffer
    if (jh.b_cp_transaction != core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn __dispose_buffer(jh: *mut journal_head, transaction: *mut transaction_t) -> c_int {
    static int __dispose_buffer(struct journal_head *jh, transaction_t *transaction)
    {
    let mut may_free: c_int = 1;
    struct buffer_head *bh = jh2bh(jh);
    if (jh.b_cp_transaction) {
...
//
    ...
    let mut stop: c_uint = offset + length;
    let mut curr_off: c_uint = 0;
    let mut partial_page: c_int = (offset || length < folio_size(folio));
    let mut may_free: c_int = 1;
    let mut ret: c_int = 0;
...
// cautious in our locking.
    bh = head;
    do {
    let mut next_off: c_uint = curr_off + bh.b_size;
    next = bh.b_this_page;
    if (next_off > stop)
    return 0;
    if (offset <= curr_off) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __jbd2_journal_refile_buffer(jh: *mut journal_head) -> bool {
...
// If the buffer is now unused, just drop it.
    if (jh.b_next_transaction == core::ptr::null_mut()) {
    __jbd2_journal_unfile_buffer(jh);
    return true;
    }
//
...
//
    ...
    WRITE_ONCE(jh.b_next_transaction, core::ptr::null_mut());
    if (buffer_freed(bh))
    jlist = BJ_Forget;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: jh->b_modified) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_refile_buffer(journal: *mut journal_t, jh: *mut journal_head) {
...
//
    ...
    let mut err: c_int = 0;
    let mut abort_transaction: c_int = 0;
    if (is_handle_aborted(handle))
    return -EROFS;
    journal = transaction.t_journal;
