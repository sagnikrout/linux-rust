...
//
#[no_mangle]
pub unsafe extern "C" fn __buffer_unlink(jh: *mut journal_head) {
    ...
    if (transaction.t_checkpoint_list == jh)
    transaction.t_checkpoint_list = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn __jbd2_log_wait_for_space(journal: *mut journal_t) {
...
//
    ...
    let mut chkpt: c_int = journal.j_checkpoint_transactions != core::ptr::null_mut();
    let mut tid: tid_t = 0;
    let mut has_transaction: bool = false;
...
//
    ...
    __brelse(bh);
    journal.j_chkpt_bhs[i] = core::ptr::null_mut();
    }
// batch_count = 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_log_do_checkpoint(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_cleanup_journal_tail(journal: *mut journal_t) -> c_int {
...
//
    ...
    let mut first_tid: tid_t = 0, last_tid = 0, next_tid = 0;
    let mut tid: tid_t = 0;
    let mut nr_freed: c_ulong = 0;
...
//
    ...
    type, core::ptr::null_mut(), &released);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_destroy_checkpoint(journal: *mut journal_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __jbd2_journal_remove_checkpoint(jh: *mut journal_head) -> c_int {
    ...
    __buffer_unlink(jh);
    jh.b_cp_transaction = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_try_remove_checkpoint(jh: *mut journal_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __jbd2_journal_drop_transaction(journal: *mut journal_t, transaction: *mut transaction_t) {
    ...
    J_ASSERT(transaction.t_buffers == core::ptr::null_mut());
    J_ASSERT(transaction.t_forget == core::ptr::null_mut());
    J_ASSERT(transaction.t_shadow_list == core::ptr::null_mut());
    J_ASSERT(transaction.t_checkpoint_list == core::ptr::null_mut());
