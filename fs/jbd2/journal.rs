...
#[no_mangle]
unsafe extern "C" fn jbd2_superblock_csum(sb: *mut journal_superblock_t) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn commit_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn kjournald2(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_start_thread(journal: *mut journal_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn journal_kill_thread(journal: *mut journal_t) {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_data_needs_escaping(data: *mut c_char) -> bool {
    static inline bool jbd2_data_needs_escaping(char *data)
    {
    return *((__be32 *)data) == cpu_to_be32(JBD2_MAGIC_NUMBER);
    }
#[no_mangle]
pub unsafe extern "C" fn jbd2_data_do_escape(data: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn __jbd2_log_start_commit(journal: *mut journal_t, target: tid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_log_start_commit(journal: *mut journal_t, tid: tid_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __jbd2_journal_force_commit(journal: *mut journal_t) -> c_int {
    static int __jbd2_journal_force_commit(journal_t *journal)
    {
    transaction_t *transaction = core::ptr::null_mut();
    tid_t tid;
    let mut need_to_start: c_int = 0, ret = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_force_commit_nested(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_force_commit(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_start_commit(journal: *mut journal_t, ptid: *mut tid_t) -> c_int {
    int jbd2_journal_start_commit(journal_t *journal, tid_t *ptid)
    {
    let mut ret: c_int = 0;
    write_lock(&journal.j_state_lock);
    if (journal.j_running_transaction) {
    let mut tid: tid_t = journal.j_running_transaction.t_tid;
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_trans_will_send_data_barrier(journal: *mut journal_t, tid: tid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_log_wait_commit(journal: *mut journal_t, tid: tid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_fc_begin_commit(journal: *mut journal_t, tid: tid_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __jbd2_fc_end_commit(journal: *mut journal_t, tid: tid_t, fallback: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_fc_end_commit(journal: *mut journal_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_fc_end_commit_fallback(journal: *mut journal_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_transaction_committed(journal: *mut journal_t, tid: tid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_complete_transaction(journal: *mut journal_t, tid: tid_t) -> c_int {
    int jbd2_complete_transaction(journal_t *journal, tid_t tid)
    {
    let mut need_to_wait: c_int = 1;
    read_lock(&journal.j_state_lock);
    if (journal.j_running_transaction &&
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_next_log_block(journal: *mut journal_t, retp: *mut c_ulonglong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_fc_get_buf(journal: *mut journal_t, bh_out: *mut buffer_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_fc_wait_bufs(journal: *mut journal_t, num_blks: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_fc_release_bufs(journal: *mut journal_t) {
...
//
    ...
    let mut block: sector_t = blocknr;
    if (journal.j_bmap) {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_descriptor_block_csum_set(j: *mut journal_t, bh: *mut buffer_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __jbd2_update_log_tail(journal: *mut journal_t, tid: tid_t, block: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_update_log_tail(journal: *mut journal_t, tid: tid_t, block: c_ulong) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct jbd2_stats_proc_session {
    pub journal: *mut journal_t,
    pub stats: *mut transaction_stats_s,
    pub start: c_int,
    pub max: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn jbd2_seq_info_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jbd2_seq_info_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn jbd2_seq_info_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jbd2_seq_info_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jbd2_stats_proc_init(journal: *mut journal_t) {
...
#[no_mangle]
unsafe extern "C" fn jbd2_stats_proc_exit(journal: *mut journal_t) {
...
#[no_mangle]
unsafe extern "C" fn jbd2_min_tag_size() -> c_int {
...
//
    ...
    let mut nr_to_scan: c_ulong = sc.nr_to_scan;
...
//
#[no_mangle]
unsafe extern "C" fn journal_fail_superblock(journal: *mut journal_t) {
...
//
#[no_mangle]
unsafe extern "C" fn journal_check_superblock(journal: *mut journal_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn journal_revoke_records_per_block(journal: *mut journal_t) -> c_int {
    static int journal_revoke_records_per_block(journal_t *journal)
    {
    int record_size;
    let mut space: c_int = journal.j_blocksize - sizeof(jbd2_journal_revoke_header_t);
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_get_max_txn_bufs(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn jbd2_descriptor_blocks_per_trans(journal: *mut journal_t) -> c_int {
    static int jbd2_descriptor_blocks_per_trans(journal_t *journal)
    {
    let mut tag_space: c_int = journal.j_blocksize - sizeof(journal_header_t);
    int tags_per_block;
// Subtract UUID
    tag_space -= 16;
    if (jbd2_journal_has_csum_v2or3(journal))
...
//
#[no_mangle]
unsafe extern "C" fn jbd2_journal_init_transaction_limits(journal: *mut journal_t) {
...
//
#[no_mangle]
unsafe extern "C" fn journal_load_superblock(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn journal_reset(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn jbd2_write_superblock(journal: *mut journal_t, write_flags: blk_opf_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn jbd2_mark_journal_empty(journal: *mut journal_t, write_flags: blk_opf_t) {
    static void jbd2_mark_journal_empty(journal_t *journal, blk_opf_t write_flags)
    {
    journal_superblock_t *sb = journal.j_superblock;
    let mut had_fast_commit: bool = false;
    BUG_ON(!mutex_is_locked(&journal.j_checkpoint_mutex));
    lock_buffer(journal.j_sb_buffer);
...
//
#[no_mangle]
unsafe extern "C" fn __jbd2_journal_erase(journal: *mut journal_t, flags: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_update_sb_errno(journal: *mut journal_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_load(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_destroy(journal: *mut journal_t) -> c_int {
...
//
    if (!is_journal_aborted(journal)) {
    let mut ret: c_int = jbd2_check_fs_dev_write_error(journal);
    if (ret)
    jbd2_journal_abort(journal, ret);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_flush(journal: *mut journal_t, flags: c_uint) -> c_int {
...
// Wait for the log commit to complete...
    if (transaction) {
    let mut tid: tid_t = transaction.t_tid;
    write_unlock(&journal.j_state_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_wipe(journal: *mut journal_t, write: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_abort(journal: *mut journal_t, errno: c_int) {
...
//
    ...
    let mut old_errno: c_int = journal.j_errno;
    write_unlock(&journal.j_state_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_errno(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_clear_err(journal: *mut journal_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_ack_err(journal: *mut journal_t) {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_blocks_per_folio(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn journal_tag_bytes(journal: *mut journal_t) -> usize {
...
//
    ...
    let mut nr_journal_heads: static atomic_t = ATOMIC_INIT(0);

#[no_mangle]
unsafe extern "C" fn jbd2_journal_init_journal_head_cache() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_destroy_journal_head_cache() {
...
#[no_mangle]
unsafe extern "C" fn journal_free_journal_head(jh: *mut journal_head) {
...
#[no_mangle]
unsafe extern "C" fn __journal_remove_journal_head(bh: *mut buffer_head) {
...
#[no_mangle]
unsafe extern "C" fn journal_release_journal_head(jh: *mut journal_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_put_journal_head(jh: *mut journal_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_init_jbd_inode(jinode: *mut jbd2_inode, inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn jbd2_create_jbd_stats_proc_entry() -> void __init {
    static void __init jbd2_create_jbd_stats_proc_entry(void)
    {
    proc_jbd2_stats = proc_mkdir(JBD2_STATS_PROC_NAME, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn jbd2_remove_jbd_stats_proc_entry() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_init_inode_cache() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_init_handle_cache() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_destroy_inode_cache() {
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_destroy_handle_cache() {
...
//
#[no_mangle]
unsafe extern "C" fn journal_init_caches() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn jbd2_journal_destroy_caches() {
...
#[no_mangle]
unsafe extern "C" fn journal_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn journal_exit() -> void __exit {
    static void __exit journal_exit(void)
    {

    let mut n: c_int = atomic_read(&nr_journal_heads);
    if (n)
