...
//
#[no_mangle]
unsafe extern "C" fn journal_end_buffer_io_sync(bio: *mut bio) {
...
//
#[no_mangle]
unsafe extern "C" fn release_buffer_page(bh: *mut buffer_head) {
...
#[no_mangle]
unsafe extern "C" fn jbd2_commit_block_csum_set(j: *mut journal_t, bh: *mut buffer_head) {
...
//
    ...
    let mut write_flags: blk_opf_t = REQ_OP_WRITE | JBD2_JOURNAL_REQ_FLAGS;
// cbh = NULL;
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_submit_inode_data(journal: *mut journal_t, jinode: *mut jbd2_inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_wait_inode_data(journal: *mut journal_t, jinode: *mut jbd2_inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_finish_inode_data_buffers(jinode: *mut jbd2_inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jbd2_checksum_data(crc32_sum: __u32, bh: *mut buffer_head) -> __u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn jbd2_journal_commit_transaction(journal: *mut journal_t) {
    ...
    ktime_t start_time;
    u64 commit_time;
    char *tagp = core::ptr::null_mut();
    journal_block_tag_t *tag = core::ptr::null_mut();
    let mut space_left: c_int = 0;
    let mut first_tag: c_int = 0;
    int tag_flag;
    int i;
    let mut tag_bytes: c_int = journal_tag_bytes(journal);
    struct buffer_head *cbh = core::ptr::null_mut(); /* For transactional checksums */
    let mut crc32_sum: __u32 = ~0;
...
//
    ...
    write_lock(&journal.j_state_lock);
    if (update_tail) {
    let mut freed: c_long = first_block - journal.j_tail;
