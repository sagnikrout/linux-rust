...
pub struct kernfs_open_node {
    ...
    pub /: *mut *mut list_head files; / goes through kernfs_open_file.list,
...
#[no_mangle]
unsafe extern "C" fn kernfs_put_active_of(of: *mut kernfs_open_file) {
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_seq_stop_active(sf: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kernfs_seq_stop(sf: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kernfs_seq_show(sf: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_file_read_iter(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    static ssize_t kernfs_file_read_iter(struct kiocb *iocb, struct iov_iter *iter)
    {
    struct kernfs_open_file *of = kernfs_of(iocb.ki_filp);
    let mut len: isize = min_t(size_t, iov_iter_count(iter), PAGE_SIZE);
    const struct kernfs_ops *ops;
    char *buf;
    buf = of.prealloc_buf;
    if (buf)
...
#[no_mangle]
unsafe extern "C" fn kernfs_fop_read_iter(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_fop_write_iter(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    static ssize_t kernfs_fop_write_iter(struct kiocb *iocb, struct iov_iter *iter)
    {
    struct kernfs_open_file *of = kernfs_of(iocb.ki_filp);
    let mut len: isize = iov_iter_count(iter);
    const struct kernfs_ops *ops;
    char *buf;
...
#[no_mangle]
unsafe extern "C" fn kernfs_vma_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn kernfs_vma_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn kernfs_vma_page_mkwrite(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn kernfs_fop_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
//
    ...
    rcu_assign_pointer(kn.attr.open, core::ptr::null_mut());
    kfree_rcu(on, rcu_head);
    }
    mutex_unlock(mutex);
    }
#[no_mangle]
unsafe extern "C" fn kernfs_fop_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    mutex_init(&of.mutex);
#[no_mangle]
pub unsafe extern "C" fn if(FMODE_WRITE: file->f_mode &) -> else {
...
//
    ...
    goto err_free;
    if (ops.prealloc) {
    let mut len: c_int = of.atomic_write_len ?: PAGE_SIZE;
...
//
    ...
    error = seq_open(file, core::ptr::null_mut());
    if (error)
    goto err_free;
...
#[no_mangle]
unsafe extern "C" fn kernfs_fop_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kernfs_should_drain_open_files(kn: *mut kernfs_node) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kernfs_drain_open_files(kn: *mut kernfs_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_generic_poll(of: *mut kernfs_open_file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn kernfs_fop_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn kernfs_fop_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn kernfs_notify_workfn(work: *mut work_struct) {
...
// pop one off the notify_list
    ...
    kn.attr.notify_next = core::ptr::null_mut();
    spin_unlock_irq(&kernfs_notify_lock);
    root = kernfs_root(kn);
// kick fsnotify
    ...
    struct inode *p_inode = core::ptr::null_mut();
    const char *kn_name;
    struct inode *inode;
    struct qstr name;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_notify(kn: *mut kernfs_node) {
