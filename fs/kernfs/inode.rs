...
//
    ...
    {
    struct kernfs_iattrs *ret __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn __kernfs_setattr(kn: *mut kernfs_node, iattr: *const iattr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_setattr(kn: *mut kernfs_node, iattr: *const iattr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kernfs_iop_listxattr(dentry: *mut dentry, buf: *mut c_char, size: usize) -> isize {
    ssize_t kernfs_iop_listxattr(struct dentry *dentry, char *buf, size_t size)
    {
    struct kernfs_node *kn = kernfs_dentry_node(dentry);
    struct kernfs_iattrs *attrs;
    attrs = kernfs_iattrs_noalloc(kn);
    return simple_xattr_list(d_inode(dentry), attrs ? &attrs.xattrs : core::ptr::null_mut(), buf, size);
    }
#[no_mangle]
pub unsafe extern "C" fn set_default_inode_attr(inode: *mut inode, mode: umode_t) {
...
#[no_mangle]
unsafe extern "C" fn kernfs_refresh_inode(kn: *mut kernfs_node, inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn kernfs_init_inode(kn: *mut kernfs_node, inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_evict_inode(inode: *mut inode) {
