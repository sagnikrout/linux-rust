...
#[no_mangle]
unsafe extern "C" fn kernfs_sop_show_options(sf: *mut seq_file, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kernfs_sop_show_path(sf: *mut seq_file, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kernfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
    .freeze_fs	= core::ptr::null_mut(),
    .unfreeze_fs	= core::ptr::null_mut(),
    .freeze_super	= core::ptr::null_mut(),
    .thaw_super	= core::ptr::null_mut(),
    };
...
//
    ...
    scoped_guard(rcu) {
    knparent = find_next_ancestor(kn, core::ptr::null_mut());
    }
    if (WARN_ON(!knparent)) {
    dput(dentry);
    return ERR_PTR(-EINVAL);
...
#[no_mangle]
unsafe extern "C" fn kernfs_fill_super(sb: *mut super_block, kfc: *mut kernfs_fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kernfs_test_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kernfs_set_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    static int kernfs_set_super(struct super_block *sb, struct fs_context *fc)
    {
    struct kernfs_fs_context *kfc = fc.fs_private;
    kfc.ns_tag = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kernfs_free_fs_context(fc: *mut fs_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn kernfs_mutex_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn kernfs_lock_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn kernfs_init() -> void __init {
