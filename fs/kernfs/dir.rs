...
#[no_mangle]
unsafe extern "C" fn __kernfs_active(kn: *mut kernfs_node) -> bool {
    static bool __kernfs_active(struct kernfs_node *kn)
    {
    return atomic_read(&kn.active) >= 0;
    }
#[no_mangle]
unsafe extern "C" fn kernfs_active(kn: *mut kernfs_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kernfs_lockdep(kn: *mut kernfs_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kernfs_depth(from: *mut kernfs_node, to: *mut kernfs_node) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_name(kn: *mut kernfs_node, buf: *mut c_char, buflen: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pr_cont_kernfs_name(kn: *mut kernfs_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pr_cont_kernfs_path(kn: *mut kernfs_node) {
    void pr_cont_kernfs_path(struct kernfs_node *kn)
    {
    unsigned long flags;
    int sz;
    spin_lock_irqsave(&kernfs_pr_cont_lock, flags);
    sz = kernfs_path_from_node(kn, core::ptr::null_mut(), kernfs_pr_cont_buf,
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_ns_id(ns: *const ns_common) -> u64 {
...
//
    ...
    {
    let mut hash: c_ulong = init_name_hash(kernfs_ns_id(ns));
    while (*name)
...
// Reserve hash numbers 0, 1 and INT_MAX for magic directory entries
    ...
    {
    let mut ns_id: u64 = kernfs_ns_id(ns);
    let mut kn_ns_id: u64 = kernfs_ns_id(kn.ns);
    if (hash < kn.hash)
    return -1;
    if (hash > kn.hash)
    return 1;
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_link_sibling(kn: *mut kernfs_node) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_unlink_sibling(kn: *mut kernfs_node) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_put_active(kn: *mut kernfs_node) {
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_drain(kn: *mut kernfs_node, drop_supers: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_get(kn: *mut kernfs_node) {
...
#[no_mangle]
unsafe extern "C" fn kernfs_free_rcu(rcu: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_put(kn: *mut kernfs_node) {
...
//
    ...
    if (kn.iattr)
    simple_xattrs_free(&root.xa_cache, &kn.iattr.xattrs, core::ptr::null_mut());
...
//
    ...
    return kn;
    err_out4:
    RCU_INIT_POINTER(kn.__parent, core::ptr::null_mut());
    kernfs_put(parent);
    if (kn.iattr) {
    simple_xattrs_free(&root.xa_cache, &kn.iattr.xattrs, core::ptr::null_mut());
    kmem_cache_free(kernfs_iattrs_cache, kn.iattr);
...
//
    ...
    {
    struct kernfs_node *kn;
    let mut ino: ino_t = kernfs_id_ino(id);
    let mut gen: u32 = kernfs_id_gen(id);
    rcu_read_lock();
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_add_one(kn: *mut kernfs_node) -> c_int {
...
//
    ...
    let mut has_ns: bool = kernfs_ns_enabled(parent);
    unsigned int hash;
...
#[no_mangle]
pub unsafe extern "C" fn kernfs_root_flags(kn: *mut kernfs_node) -> c_uint {
...
//
    ...
    root.id_highbits = 1;
    kn = __kernfs_new_node(root, core::ptr::null_mut(), "", S_IFDIR | S_IRUGO | S_IXUGO,
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_destroy_root(root: *mut kernfs_root) {
...
// allocate
    ...
    kn.dir.root = parent.dir.root;
    kn.ns = core::ptr::null_mut();
    kn.priv = core::ptr::null_mut();
// link in
    rc = kernfs_add_one(kn);
    if (!rc)
    return kn;
...
#[no_mangle]
unsafe extern "C" fn kernfs_iop_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kernfs_activate_one(kn: *mut kernfs_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_activate(kn: *mut kernfs_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_show(kn: *mut kernfs_node, show: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn kernfs_clear_inode_nlink(kn: *mut kernfs_node) {
...
#[no_mangle]
unsafe extern "C" fn __kernfs_remove(kn: *mut kernfs_node) {
...
//
    ...
    struct kernfs_iattrs *ps_iattr =
    parent ? parent.iattr : core::ptr::null_mut();
    down_write(&kernfs_root(kn).kernfs_iattr_rwsem);
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_remove(kn: *mut kernfs_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_break_active_protection(kn: *mut kernfs_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_unbreak_active_protection(kn: *mut kernfs_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernfs_remove_self(kn: *mut kernfs_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kernfs_dir_fop_release(inode: *mut inode, filp: *mut file) -> c_int {
    ...
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(pos->hash: hash >) -> else {
    else if (hash > pos.hash)
    node = node.rb_right;
#[no_mangle]
pub unsafe extern "C" fn if(kernfs_ns_id(pos->ns): ns_id <) -> else {
...
#[no_mangle]
unsafe extern "C" fn kernfs_fop_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
    ...
    let mut type: c_uint = fs_umode_to_dtype(pos.mode);
    let mut len: c_int = strlen(name);
    let mut ino: ino_t = kernfs_ino(pos);
    ctx.pos = pos.hash;
