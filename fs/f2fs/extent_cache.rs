...
#[no_mangle]
pub unsafe extern "C" fn sanity_check_extent_cache(inode: *mut inode, ifolio: *mut folio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __init_may_extent_tree(inode: *mut inode, type: enum extent_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __may_extent_tree(inode: *mut inode, type: enum extent_type) -> bool {
...
// check rb_tree
    ...
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(en->ei.len: fofs >= en->ei.fofs +) -> else {
...
//
    ...
    struct rb_node *parent = core::ptr::null_mut(), *tmp_node;
...
// next_entry = rb_entry_safe(tmp_node,
    ...
    if (et.cached_en == en)
    et.cached_en = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_read_extent_tree(inode: *mut inode, ifolio: *mut folio) {
...
// drop largest read extent
    ...
    en = __attach_extent_node(sbi, et, &ei, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_age_extent_tree(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_extent_tree(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn if(EX_BLOCK_AGE: type ==) -> else {
    else if (type == EX_BLOCK_AGE)
    ...
    {
    struct extent_tree_info *eti = &sbi.extent_tree[et.type];
    struct extent_node *en = core::ptr::null_mut();
...
// update in global extent list
    ...
    struct f2fs_sb_info *sbi = F2FS_I_SB(inode);
    struct extent_tree *et = F2FS_I(inode).extent_tree[type];
    struct extent_node *en = core::ptr::null_mut(), *en1 = core::ptr::null_mut();
    struct extent_node *prev_en = core::ptr::null_mut(), *next_en = core::ptr::null_mut();
    struct extent_info ei, dei, prev;
    struct rb_node **insert_p = core::ptr::null_mut(), *insert_parent = core::ptr::null_mut();
    let mut fofs: c_uint = tei.fofs, len = tei.len;
    let mut end: c_uint = fofs + len;
    let mut updated: bool = false;
    let mut leftmost: bool = false;
    if (!et)
    return;
    if (unlikely(len == 0)) {
...
// 2. invalidate all extent nodes in range [fofs, fofs + len - 1]
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), true);
    next_en = en1;
    } else {
...
//
    if (parts != 1) {
    insert_p = core::ptr::null_mut();
    insert_parent = core::ptr::null_mut();
    }
    en = next_en;
    }
    if (type == EX_BLOCK_AGE)
...
// it is safe here to check FI_NO_EXTENT w/o et->lock in ro image
    ...
    let mut weight: c_uint = sbi.last_age_weight;
...
// This returns a new age and allocated blocks in ei
    ...
    {
    struct f2fs_sb_info *sbi = F2FS_I_SB(inode);
    let mut f_size: loff_t = i_size_read(inode);
...
#[no_mangle]
unsafe extern "C" fn __update_extent_cache(dn: *mut dnode_of_data, type: enum extent_type) {
    ...
    struct extent_node *en;
    let mut node_cnt: c_uint = 0, tree_cnt = 0;
    int remained;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_update_read_extent_cache(dn: *mut dnode_of_data) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_shrink_read_extent_tree(sbi: *mut f2fs_sb_info, nr_shrink: c_int) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_update_age_extent_cache(dn: *mut dnode_of_data) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_shrink_age_extent_tree(sbi: *mut f2fs_sb_info, nr_shrink: c_int) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_extent_node(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn __drop_extent_tree(inode: *mut inode, type: enum extent_type) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_drop_extent_tree(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn __destroy_extent_tree(inode: *mut inode, type: enum extent_type) {
...
// delete extent tree entry in radix tree
    ...
    atomic_dec(&eti.total_ext_tree);
    mutex_unlock(&eti.extent_tree_lock);
    F2FS_I(inode).extent_tree[type] = core::ptr::null_mut();
    trace_f2fs_destroy_extent_tree(inode, node_cnt, type);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_extent_tree(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn __init_extent_tree_info(eti: *mut extent_tree_info) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_extent_cache_info(sbi: *mut f2fs_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_create_extent_cache() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_extent_cache() {
