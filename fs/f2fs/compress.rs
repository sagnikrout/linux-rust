...
//
    ...
    {
    let mut size: c_uint = sizeof(struct page *) * nr;
...
#[no_mangle]
unsafe extern "C" fn page_array_free(sbi: *mut f2fs_sb_info, pages: *mut c_void, nr: c_int) {
...
pub struct f2fs_compress_ops {
    pub cc): *mut *mut int (init_compress_ctx)(struct compress_ctx,
    pub cc): *mut *mut void (destroy_compress_ctx)(struct compress_ctx,
    pub cc): *mut *mut int (compress_pages)(struct compress_ctx,
    pub dic): *mut *mut int (init_decompress_ctx)(struct decompress_io_ctx,
    pub dic): *mut *mut void (destroy_decompress_ctx)(struct decompress_io_ctx,
    pub dic): *mut *mut int (decompress_pages)(struct decompress_io_ctx,
    pub level): *mut *mut bool (is_level_valid)(int,
}

#[no_mangle]
unsafe extern "C" fn offset_in_cluster(cc: *mut compress_ctx, index: pgoff_t) -> c_uint {
    static unsigned int offset_in_cluster(struct compress_ctx *cc, pgoff_t index)
    {
    return index & (cc.cluster_size - 1);
    }
#[no_mangle]
unsafe extern "C" fn cluster_idx(cc: *mut compress_ctx, index: pgoff_t) -> pgoff_t {
    static pgoff_t cluster_idx(struct compress_ctx *cc, pgoff_t index)
    {
    return index >> cc.log_cluster_size;
    }
#[no_mangle]
unsafe extern "C" fn start_idx_of_cluster(cc: *mut compress_ctx) -> pgoff_t {
    static pgoff_t start_idx_of_cluster(struct compress_ctx *cc)
    {
    return cc.cluster_idx << cc.log_cluster_size;
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_is_compressed_page(folio: *mut folio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn f2fs_drop_rpages(cc: *mut compress_ctx, len: c_int, unlock: bool) {
...
#[no_mangle]
unsafe extern "C" fn f2fs_put_rpages(cc: *mut compress_ctx) {
    static void f2fs_put_rpages(struct compress_ctx *cc)
    {
    f2fs_drop_rpages(cc, cc.cluster_size, false);
    }
#[no_mangle]
unsafe extern "C" fn f2fs_unlock_rpages(cc: *mut compress_ctx, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_compress_ctx(cc: *mut compress_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_compress_ctx(cc: *mut compress_ctx, reuse: bool) {
    void f2fs_destroy_compress_ctx(struct compress_ctx *cc, bool reuse)
    {
    page_array_free(F2FS_I_SB(cc.inode), cc.rpages, cc.cluster_size);
    cc.rpages = core::ptr::null_mut();
    cc.nr_rpages = 0;
    cc.nr_cpages = 0;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_compress_ctx_add_page(cc: *mut compress_ctx, folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn lzo_init_compress_ctx(cc: *mut compress_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lzo_destroy_compress_ctx(cc: *mut compress_ctx) {
    static void lzo_destroy_compress_ctx(struct compress_ctx *cc)
    {
    vfree(cc.private);
    cc.private = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn lzo_compress_pages(cc: *mut compress_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lzo_decompress_pages(dic: *mut decompress_io_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lz4_init_compress_ctx(cc: *mut compress_ctx) -> c_int {
    static int lz4_init_compress_ctx(struct compress_ctx *cc)
    {
    let mut size: c_uint = LZ4_MEM_COMPRESS;
...
#[no_mangle]
unsafe extern "C" fn lz4_destroy_compress_ctx(cc: *mut compress_ctx) {
...
#[no_mangle]
unsafe extern "C" fn lz4_compress_pages(cc: *mut compress_ctx) -> c_int {
    static int lz4_compress_pages(struct compress_ctx *cc)
    {
    let mut len: c_int = -EINVAL;
    let mut level: c_uchar = F2FS_I(cc.inode).i_compress_level;
    if (!level)
...
#[no_mangle]
unsafe extern "C" fn lz4_decompress_pages(dic: *mut decompress_io_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zstd_init_compress_ctx(cc: *mut compress_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zstd_destroy_compress_ctx(cc: *mut compress_ctx) {
    static void zstd_destroy_compress_ctx(struct compress_ctx *cc)
    {
    vfree(cc.private);
    cc.private = core::ptr::null_mut();
    cc.private2 = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn zstd_compress_pages(cc: *mut compress_ctx) -> c_int {
    static int zstd_compress_pages(struct compress_ctx *cc)
    {
    zstd_cstream *stream = cc.private2;
    zstd_in_buffer inbuf;
    zstd_out_buffer outbuf;
    let mut src_size: c_int = cc.rlen;
    let mut dst_size: c_int = src_size - PAGE_SIZE - COMPRESS_HEADER_SIZE;
    int ret;
    inbuf.pos = 0;
    inbuf.src = cc.rbuf;
    inbuf.size = src_size;
...
#[no_mangle]
unsafe extern "C" fn zstd_init_decompress_ctx(dic: *mut decompress_io_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zstd_destroy_decompress_ctx(dic: *mut decompress_io_ctx) {
    static void zstd_destroy_decompress_ctx(struct decompress_io_ctx *dic)
    {
    vfree(dic.private);
    dic.private = core::ptr::null_mut();
    dic.private2 = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn zstd_decompress_pages(dic: *mut decompress_io_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zstd_is_level_valid(lvl: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lzorle_compress_pages(cc: *mut compress_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_is_compress_backend_ready(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_is_compress_level_valid(alg: c_int, lvl: c_int) -> bool {
    ...
    let mut num_compress_pages: static int = 512;
    module_param(num_compress_pages, uint, 0444);
    MODULE_PARM_DESC(num_compress_pages,
    "Number of intermediate compress pages to preallocate");
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_compress_mempool() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_compress_mempool() {
...
#[no_mangle]
unsafe extern "C" fn f2fs_compress_free_page(page: *mut page) {
...
pub const MAX_VMAP_RETRIES: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn f2fs_compress_pages(cc: *mut compress_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_decompress_cluster(dic: *mut decompress_io_ctx, in_task: bool) {
    ...
    const struct f2fs_compress_ops *cops =
    f2fs_cops[fi.i_compress_algorithm];
    let mut bypass_callback: bool = false;
    int ret;
...
// Avoid f2fs_commit_super in irq context
    ...
    let mut provided: u32 = le32_to_cpu(dic.cbuf.chksum);
    let mut calculated: u32 = f2fs_crc32(dic.cbuf.cdata, dic.clen);
...
#[no_mangle]
pub unsafe extern "C" fn if(in_task: blkaddr &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn is_page_in_cluster(cc: *mut compress_ctx, index: pgoff_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_cluster_is_empty(cc: *mut compress_ctx) -> bool {
    bool f2fs_cluster_is_empty(struct compress_ctx *cc)
    {
    return cc.nr_rpages == 0;
    }
#[no_mangle]
unsafe extern "C" fn f2fs_cluster_is_full(cc: *mut compress_ctx) -> bool {
    static bool f2fs_cluster_is_full(struct compress_ctx *cc)
    {
    return cc.cluster_size == cc.nr_rpages;
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_cluster_can_merge_page(cc: *mut compress_ctx, index: pgoff_t) -> bool {
    ...
    {
    let mut pgidx: c_ulong = page_folio(pages[index]).index;
    let mut i: c_int = uptodate ? 0 : 1;
//
...
#[no_mangle]
unsafe extern "C" fn cluster_has_invalid_data(cc: *mut compress_ctx) -> bool {
    static bool cluster_has_invalid_data(struct compress_ctx *cc)
    {
    let mut i_size: loff_t = i_size_read(cc.inode);
    let mut nr_pages: unsigned = DIV_ROUND_UP(i_size, PAGE_SIZE);
    int i;
    for (i = 0; i < cc.cluster_size; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_sanity_check_cluster(dn: *mut dnode_of_data) -> bool {
    bool f2fs_sanity_check_cluster(struct dnode_of_data *dn)
    {

    struct f2fs_sb_info *sbi = F2FS_I_SB(dn.inode);
    let mut cluster_size: c_uint = F2FS_I(dn.inode).i_cluster_size;
    let mut cluster_end: c_int = 0;
    unsigned int count;
    int i;
    char *reason = "";
...
#[no_mangle]
pub unsafe extern "C" fn if(CLUSTER_IS_COMPR: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn f2fs_compressed_blocks(cc: *mut compress_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_is_compressed_cluster(inode: *mut inode, index: pgoff_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_is_sparse_cluster(inode: *mut inode, index: pgoff_t) -> bool {
    bool f2fs_is_sparse_cluster(struct inode *inode, pgoff_t index)
    {
    let mut cluster_idx: c_uint = index >> F2FS_I(inode).i_log_cluster_size;
    return f2fs_decompressed_blocks(inode, cluster_idx) !=
    F2FS_I(inode).i_cluster_size;
    }
#[no_mangle]
unsafe extern "C" fn cluster_may_compress(cc: *mut compress_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn set_cluster_writeback(cc: *mut compress_ctx) {
...
#[no_mangle]
unsafe extern "C" fn set_cluster_dirty(cc: *mut compress_ctx) {
    ...
    let mut fgp_flag: fgf_t = FGP_LOCK | FGP_WRITE | FGP_CREAT;
    let mut start_idx: pgoff_t = start_idx_of_cluster(cc);
    int i, ret;
    retry:
...
// keep folio reference to avoid page reclaim
    ...
    &last_block_in_bio, core::ptr::null_mut(), true);
    f2fs_put_rpages(cc);
...
// pagep = cc->rpages[offset_in_cluster(cc, index)];
    ...
    .nr_rpages = 0,
    .vi = core::ptr::null_mut(), /* can't write to fsverity files */
    };
    ...
    let mut first_index: bool = (index == folio.index);
    if (copied)
    set_cluster_dirty(&cc);
    f2fs_put_rpages_wbc(&cc, core::ptr::null_mut(), false, true);
    f2fs_destroy_compress_ctx(&cc, false);
    return first_index;
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_truncate_partial_cluster(inode: *mut inode, from: u64, lock: bool) -> c_int {
    int f2fs_truncate_partial_cluster(struct inode *inode, u64 from, bool lock)
    {
    void *fsdata = core::ptr::null_mut();
    struct page *pagep;
    struct page **rpages;
    let mut log_cluster_size: c_int = F2FS_I(inode).i_log_cluster_size;
...
// should not be a normal cluster
    ...
    let mut start: loff_t = (loff_t)folio.index << PAGE_SHIFT;
    let mut offset: loff_t = from > start ? from - start : 0;
    ...
    .compressed_page = core::ptr::null_mut(),
    .io_type = io_type,
    .io_wbc = wbc,
    };
    struct folio *folio;
    ...
    let mut start_idx: pgoff_t = start_idx_of_cluster(cc);
    let mut last_index: c_uint = cc.cluster_size - 1;
    loff_t psize;
    int i, err;
...
//
    ...
    set_new_dnode(&dn, cc.inode, core::ptr::null_mut(), core::ptr::null_mut(), 0);
...
// cluster header
    ...
    cc.cpages[i - 1] = core::ptr::null_mut();
    fio.submitted = 0;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_compress_write_end_io(bio: *mut bio, folio: *mut folio) {
    void f2fs_compress_write_end_io(struct bio *bio, struct folio *folio)
    {
    struct page *page = &folio.page;
    struct f2fs_sb_info *sbi = bio.bi_private;
    struct compress_io_ctx *cic = folio.private;
    let mut type: enum count_type = WB_DATA_TYPE(folio, true);
    int i;
...
// overwrite compressed cluster w/ normal cluster
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), wbc, io_type,
    compr_blocks, false);
    if (ret) {
    if (ret == 1) {
    ret = 0;
...
#[no_mangle]
unsafe extern "C" fn f2fs_late_free_dic(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn f2fs_put_dic(dic: *mut decompress_io_ctx, in_task: bool) {
...
#[no_mangle]
unsafe extern "C" fn f2fs_verify_cluster(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn f2fs_put_folio_dic(folio: *mut folio, in_task: bool) {
...
//
    ...
    let mut i: c_int = compressed ? 1 : 0;
    ...
    cfolio = filemap_alloc_folio(__GFP_NOWARN | __GFP_IO, 0, core::ptr::null_mut());
    if (!cfolio)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_invalidate_compress_pages(sbi: *mut f2fs_sb_info, ino: nid_t) {
    void f2fs_invalidate_compress_pages(struct f2fs_sb_info *sbi, nid_t ino)
    {
    struct address_space *mapping = COMPRESS_MAPPING(sbi);
    struct folio_batch fbatch;
    let mut index: pgoff_t = 0;
    let mut end: pgoff_t = MAX_BLKADDR(sbi);
    if (!mapping.nrpages)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_compress_inode(sbi: *mut f2fs_sb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_compress_inode(sbi: *mut f2fs_sb_info) {
    void f2fs_destroy_compress_inode(struct f2fs_sb_info *sbi)
    {
    if (!sbi.compress_inode)
    return;
    iput(sbi.compress_inode);
    sbi.compress_inode = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_page_array_cache(sbi: *mut f2fs_sb_info) -> c_int {
    int f2fs_init_page_array_cache(struct f2fs_sb_info *sbi)
    {
    let mut dev: dev_t = sbi.sb.s_bdev.bd_dev;
    char slab_name[35];
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_page_array_cache(sbi: *mut f2fs_sb_info) {
    void f2fs_destroy_page_array_cache(struct f2fs_sb_info *sbi)
    {
    kmem_cache_destroy(sbi.page_array_slab);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_compress_cache() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_compress_cache() {
