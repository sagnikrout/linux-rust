...
#[no_mangle]
pub unsafe extern "C" fn get_lock_elapsed_time(ts: *mut f2fs_time_stat) {
    ...
    let mut running_time: c_ulonglong = 0;
    let mut runnable_time: c_ulonglong = 0;
    let mut io_sleep_time: c_ulonglong = 0;
    let mut other_time: c_ulonglong = 0;
    let mut npm: unsigned = NSEC_PER_MSEC;
    if (!lc.lock_trace)
    return;
...
#[no_mangle]
unsafe extern "C" fn need_uplift_priority(sem: *mut f2fs_rwsem, is_write: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_down_read_trace(sem: *mut f2fs_rwsem, lc: *mut f2fs_lock_context) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_down_read_trylock_trace(sem: *mut f2fs_rwsem, lc: *mut f2fs_lock_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_up_read_trace(sem: *mut f2fs_rwsem, lc: *mut f2fs_lock_context) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_down_write_trace(sem: *mut f2fs_rwsem, lc: *mut f2fs_lock_context) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_down_write_trylock_trace(sem: *mut f2fs_rwsem, lc: *mut f2fs_lock_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_up_write_trace(sem: *mut f2fs_rwsem, lc: *mut f2fs_lock_context) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_lock_op(sbi: *mut f2fs_sb_info, lc: *mut f2fs_lock_context) {
    void f2fs_lock_op(struct f2fs_sb_info *sbi, struct f2fs_lock_context *lc)
    {
    f2fs_down_read_trace(&sbi.cp_rwsem, lc);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_trylock_op(sbi: *mut f2fs_sb_info, lc: *mut f2fs_lock_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_unlock_op(sbi: *mut f2fs_sb_info, lc: *mut f2fs_lock_context) {
    void f2fs_unlock_op(struct f2fs_sb_info *sbi, struct f2fs_lock_context *lc)
    {
    f2fs_up_read_trace(&sbi.cp_rwsem, lc);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_lock_all(sbi: *mut f2fs_sb_info) {
    static inline void f2fs_lock_all(struct f2fs_sb_info *sbi)
    {
    f2fs_down_write(&sbi.cp_rwsem);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_unlock_all(sbi: *mut f2fs_sb_info) {
...
//
    ...
    f2fs_update_iostat(sbi, core::ptr::null_mut(), FS_META_READ_IO, F2FS_BLKSIZE);
    folio_lock(folio);
...
// get sit block addr
    ...
    if (!err)
    f2fs_update_iostat(sbi, core::ptr::null_mut(), FS_META_READ_IO,
    F2FS_BLKSIZE);
    }
    out:
...
// if locked failed, cp will flush dirty pages instead
    ...
    {
    struct address_space *mapping = META_MAPPING(sbi);
    let mut index: pgoff_t = 0, prev = ULONG_MAX;
    struct folio_batch fbatch;
    let mut nwritten: c_long = 0;
    int nr_folios;
    let mut wbc: writeback_control = {};
    struct blk_plug plug;
...
// someone wrote it for us
    ...
    struct ino_entry *e = core::ptr::null_mut(), *new = core::ptr::null_mut();
    int ret;
    if (type == FLUSH_INO) {
    rcu_read_lock();
    ...
    GFP_NOFS, true, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __remove_ino_entry(sbi: *mut f2fs_sb_info, ino: nid_t, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __set_ino_bitmap(sbi: *mut f2fs_sb_info, ino: nid_t, type: c_int) {
    static void __set_ino_bitmap(struct f2fs_sb_info *sbi, nid_t ino, int type)
    {
    struct inode_management *im = &sbi.im[type];
    let mut index: c_ulong = INO_SLOT_INDEX(ino);
    let mut ofs: c_uint = INO_BIT_OFFSET(ino);
    void **slot, *entry;
...
#[no_mangle]
unsafe extern "C" fn __clear_ino_bitmap(sbi: *mut f2fs_sb_info, ino: nid_t, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn f2fs_wait_for_inode_record(sbi: *mut f2fs_sb_info, mode: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_add_ino_entry(sbi: *mut f2fs_sb_info, ino: nid_t, type: c_int) {
    void f2fs_add_ino_entry(struct f2fs_sb_info *sbi, nid_t ino, int type)
    {
    __f2fs_add_ino_entry(sbi, ino, 0, type);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_remove_ino_entry(sbi: *mut f2fs_sb_info, ino: nid_t, type: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_exist_written_data(sbi: *mut f2fs_sb_info, ino: nid_t, mode: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_release_ino_entry(sbi: *mut f2fs_sb_info, all: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_acquire_orphan_inode(sbi: *mut f2fs_sb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_release_orphan_inode(sbi: *mut f2fs_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_add_orphan_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_remove_orphan_inode(sbi: *mut f2fs_sb_info, ino: nid_t) {
...
#[no_mangle]
unsafe extern "C" fn recover_orphan_inode(sbi: *mut f2fs_sb_info, ino: nid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_recover_orphan_inodes(sbi: *mut f2fs_sb_info) -> c_int {
    ...
    let mut ino: nid_t = le32_to_cpu(orphan_blk.ino[j]);
...
#[no_mangle]
unsafe extern "C" fn write_orphan_inodes(sbi: *mut f2fs_sb_info, start_blk: block_t) {
    static void write_orphan_inodes(struct f2fs_sb_info *sbi, block_t start_blk)
    {
    struct list_head *head;
    struct f2fs_orphan_block *orphan_blk = core::ptr::null_mut();
    let mut nentries: c_uint = 0;
    let mut index: c_ushort = 1;
    unsigned short orphan_blocks;
    struct folio *folio = core::ptr::null_mut();
    struct ino_entry *orphan = core::ptr::null_mut();
    struct inode_management *im = &sbi.im[ORPHAN_INO];
...
#[no_mangle]
unsafe extern "C" fn f2fs_checkpoint_chksum(ckpt: *mut f2fs_checkpoint) -> __u32 {
    static __u32 f2fs_checkpoint_chksum(struct f2fs_checkpoint *ckpt)
    {
    let mut chksum_ofs: c_uint = le32_to_cpu(ckpt.checksum_offset);
    __u32 chksum;
...
// version = cur_cp_version(*cp_block);
    ...
    {
    struct folio *cp_folio_1 = core::ptr::null_mut(), *cp_folio_2 = core::ptr::null_mut();
    struct f2fs_checkpoint *cp_block = core::ptr::null_mut();
    let mut cur_version: c_ulonglong = 0, pre_version = 0;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_get_valid_checkpoint(sbi: *mut f2fs_sb_info) -> c_int {
    int f2fs_get_valid_checkpoint(struct f2fs_sb_info *sbi)
    {
    struct f2fs_checkpoint *cp_block;
    struct f2fs_super_block *fsb = sbi.raw_super;
    struct folio *cp1, *cp2, *cur_folio;
    let mut blk_size: c_ulong = sbi.blocksize;
    let mut cp1_version: c_ulonglong = 0, cp2_version = 0;
    unsigned long long cp_start_blk_no;
    let mut cp_blks: c_uint = 1 + __cp_payload(sbi);
    block_t cp_blk_no;
    int i;
    int err;
...
#[no_mangle]
unsafe extern "C" fn __add_dirty_inode(inode: *mut inode, type: enum inode_type) {
    static void __add_dirty_inode(struct inode *inode, enum inode_type type)
    {
    struct f2fs_sb_info *sbi = F2FS_I_SB(inode);
    let mut flag: c_int = (type == DIR_INODE) ? FI_DIRTY_DIR : FI_DIRTY_FILE;
...
#[no_mangle]
unsafe extern "C" fn __remove_dirty_inode(inode: *mut inode, type: enum inode_type) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_update_dirty_folio(inode: *mut inode, folio: *mut folio) {
    void f2fs_update_dirty_folio(struct inode *inode, struct folio *folio)
    {
    struct f2fs_sb_info *sbi = F2FS_I_SB(inode);
    let mut type: enum inode_type = S_ISDIR(inode.i_mode) ? DIR_INODE : FILE_INODE;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_remove_dirty_inode(inode: *mut inode) {
    ...
    let mut is_dir: bool = (type == DIR_INODE);
    ...
    spin_unlock(&sbi.inode_lock[type]);
    if (inode) {
    let mut cur_ino: c_ulong = inode.i_ino;
    if (from_cp)
    F2FS_I(inode).cp_task = current;
    F2FS_I(inode).wb_task = current;
    filemap_fdatawrite(inode.i_mapping);
    F2FS_I(inode).wb_task = core::ptr::null_mut();
    if (from_cp)
    F2FS_I(inode).cp_task = core::ptr::null_mut();
    iput(inode);
...
#[no_mangle]
unsafe extern "C" fn f2fs_sync_inode_meta(sbi: *mut f2fs_sb_info) -> c_int {
    static int f2fs_sync_inode_meta(struct f2fs_sb_info *sbi)
    {
    struct list_head *head = &sbi.inode_list[DIRTY_META];
    struct inode *inode;
    struct f2fs_inode_info *fi;
    let mut total: i64 = get_pages(sbi, F2FS_DIRTY_IMETA);
    while (total--) {
    if (unlikely(f2fs_cp_error(sbi)))
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn __prepare_cp_block(sbi: *mut f2fs_sb_info) {
    static void __prepare_cp_block(struct f2fs_sb_info *sbi)
    {
    struct f2fs_checkpoint *ckpt = F2FS_CKPT(sbi);
    struct f2fs_nm_info *nm_i = NM_I(sbi);
    let mut last_nid: nid_t = nm_i.next_scan_nid;
...
#[no_mangle]
unsafe extern "C" fn __need_flush_quota(sbi: *mut f2fs_sb_info) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn block_operations(sbi: *mut f2fs_sb_info) -> c_int {
...
//
    ...
    let mut need_lock: bool = sbi.umount_lock_holder != current;
...
#[no_mangle]
unsafe extern "C" fn unblock_operations(sbi: *mut f2fs_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_wait_on_all_pages(sbi: *mut f2fs_sb_info, type: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(F2FS_WB_CP_DATA: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn update_ckpt_flags(sbi: *mut f2fs_sb_info, cpc: *mut cp_control) {
    static void update_ckpt_flags(struct f2fs_sb_info *sbi, struct cp_control *cpc)
    {
    let mut orphan_num: c_ulong = sbi.im[ORPHAN_INO].ino_num;
    struct f2fs_checkpoint *ckpt = F2FS_CKPT(sbi);
    unsigned long flags;
...
#[no_mangle]
pub unsafe extern "C" fn get_sectors_written(bdev: *mut block_device) -> u64 {
    static inline u64 get_sectors_written(struct block_device *bdev)
    {
    return (u64)part_stat_read(bdev, sectors[STAT_WRITE]);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_get_sectors_written(sbi: *mut f2fs_sb_info) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn stat_cp_time(cpc: *mut cp_control, type: enum cp_time) {
    static inline void stat_cp_time(struct cp_control *cpc, enum cp_time type)
    {
    cpc.stats.times[type] = ktime_get();
    }
#[no_mangle]
pub unsafe extern "C" fn check_cp_time(sbi: *mut f2fs_sb_info, cpc: *mut cp_control) {
...
#[no_mangle]
unsafe extern "C" fn do_checkpoint(sbi: *mut f2fs_sb_info, cpc: *mut cp_control) -> c_int {
    static int do_checkpoint(struct f2fs_sb_info *sbi, struct cp_control *cpc)
    {
    struct f2fs_checkpoint *ckpt = F2FS_CKPT(sbi);
    struct f2fs_nm_info *nm_i = NM_I(sbi);
    let mut orphan_num: c_ulong = sbi.im[ORPHAN_INO].ino_num, flags;
    block_t start_blk;
    unsigned int data_sum_blocks, orphan_blocks;
    let mut crc32: __u32 = 0;
    int i;
    let mut cp_payload_blks: c_int = __cp_payload(sbi);
...
// write nat bits
    ...
    let mut cp_ver: __u64 = cur_cp_version(ckpt);
    block_t blk;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_write_checkpoint(sbi: *mut f2fs_sb_info, cpc: *mut cp_control) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_ino_entry_info(sbi: *mut f2fs_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_create_checkpoint_caches() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_checkpoint_caches() {
...
#[no_mangle]
unsafe extern "C" fn __write_checkpoint_sync(sbi: *mut f2fs_sb_info) -> c_int {
    static int __write_checkpoint_sync(struct f2fs_sb_info *sbi)
    {
    let mut cpc: cp_control = { .reason = CP_SYNC, };
    struct f2fs_lock_context lc;
    int err;
...
#[no_mangle]
unsafe extern "C" fn __checkpoint_and_complete_reqs(sbi: *mut f2fs_sb_info) {
    static void __checkpoint_and_complete_reqs(struct f2fs_sb_info *sbi)
    {
    struct ckpt_req_control *cprc = &sbi.cprc_info;
    struct ckpt_req *req, *next;
    struct llist_node *dispatch_list;
    let mut sum_diff: u64 = 0, diff, count = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn issue_checkpoint_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_ckpt_req(req: *mut ckpt_req) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_issue_checkpoint(sbi: *mut f2fs_sb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_start_ckpt_thread(sbi: *mut f2fs_sb_info) -> c_int {
    ...
    let mut err: c_int = PTR_ERR(cprc.f2fs_issue_ckpt);
    cprc.f2fs_issue_ckpt = core::ptr::null_mut();
    return err;
    }
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_stop_ckpt_thread(sbi: *mut f2fs_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_flush_ckpt_thread(sbi: *mut f2fs_sb_info) {
    void f2fs_flush_ckpt_thread(struct f2fs_sb_info *sbi)
    {
    struct ckpt_req_control *cprc = &sbi.cprc_info;
    flush_remained_ckpt_reqs(sbi, core::ptr::null_mut());
// Let's wait for the previous dispatched checkpoint.
    while (atomic_read(&cprc.queued_ckpt))
    io_schedule_timeout(DEFAULT_SCHEDULE_TIMEOUT);
    }
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_ckpt_req_control(sbi: *mut f2fs_sb_info) {
