...
#[no_mangle]
unsafe extern "C" fn __count_nat_entries(sbi: *mut f2fs_sb_info) -> c_ulong {
    static unsigned long __count_nat_entries(struct f2fs_sb_info *sbi)
    {
    return NM_I(sbi).nat_cnt[RECLAIMABLE_NAT];
    }
#[no_mangle]
unsafe extern "C" fn __count_free_nids(sbi: *mut f2fs_sb_info) -> c_ulong {
    static unsigned long __count_free_nids(struct f2fs_sb_info *sbi)
    {
    let mut count: c_long = NM_I(sbi).nid_cnt[FREE_NID] - MAX_FREE_NIDS;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_donate_files() -> c_uint {
...
// stop f2fs_put_super
    ...
    let mut nfiles: c_uint = sbi.donate_files;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_reclaim_caches(reclaim_caches_kb: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_join_shrinker(sbi: *mut f2fs_sb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_leave_shrinker(sbi: *mut f2fs_sb_info) {
