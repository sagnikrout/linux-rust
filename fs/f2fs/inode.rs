...
pub const NUM_PREALLOC_EVICT_INODE_WORK: c_int = 8;
    static struct kmem_cache *evict_inode_work_cache;
    static mempool_t *evict_inode_work_pool;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct evict_inode_work {
    pub work: work_struct,
    pub sbi: *mut f2fs_sb_info,
    pub ino: nid_t,
    pub add_ino_entry_bits: c_uint,
}

#[no_mangle]
pub unsafe extern "C" fn f2fs_mark_inode_dirty_sync(inode: *mut inode, sync: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_set_inode_flags(inode: *mut inode) {
    void f2fs_set_inode_flags(struct inode *inode)
    {
    let mut flags: c_uint = F2FS_I(inode).i_flags;
...
#[no_mangle]
unsafe extern "C" fn __get_inode_rdev(inode: *mut inode, node_folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn __set_inode_rdev(inode: *mut inode, node_folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn __recover_inline_status(inode: *mut inode, ifolio: *mut folio) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn f2fs_enable_inode_chksum(sbi: *mut f2fs_sb_info, folio: *mut folio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn f2fs_inode_chksum(sbi: *mut f2fs_sb_info, folio: *mut folio) -> __u32 {
    static __u32 f2fs_inode_chksum(struct f2fs_sb_info *sbi, struct folio *folio)
    {
    struct f2fs_node *node = F2FS_NODE(folio);
    struct f2fs_inode *ri = &node.i;
    let mut ino: __le32 = node.footer.ino;
    let mut gen: __le32 = ri.i_generation;
    __u32 chksum, chksum_seed;
    let mut dummy_cs: __u32 = 0;
    let mut offset: c_uint = offsetof(struct f2fs_inode, i_inode_checksum);
    let mut cs_size: c_uint = sizeof(dummy_cs);
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_inode_chksum_verify(sbi: *mut f2fs_sb_info, folio: *mut folio) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_inode_chksum_set(sbi: *mut f2fs_sb_info, folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn sanity_check_inode(inode: *mut inode, node_folio: *mut folio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn init_idisk_time(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn do_read_inode(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_meta_ino(sbi: *mut f2fs_sb_info, ino: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_update_inode(inode: *mut inode, node_folio: *mut folio) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_update_inode_page(inode: *mut inode) {
    ...
    node_folio = f2fs_get_inode_folio(sbi, inode.i_ino);
    if (IS_ERR(node_folio)) {
    let mut err: c_int = PTR_ERR(node_folio);
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_remove_donate_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn f2fs_evict_inode_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn f2fs_pre_evict_inode(inode: *mut inode) -> bool {
    ...
    F2FS_I(cow_inode).atomic_inode = core::ptr::null_mut();
    fi.cow_inode = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn f2fs_delete_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn f2fs_post_evict_inode(inode: *mut inode) {
    static void f2fs_post_evict_inode(struct inode *inode)
    {
    struct f2fs_sb_info *sbi = F2FS_I_SB(inode);
    struct f2fs_inode_info *fi = F2FS_I(inode);
    let mut xnid: nid_t = fi.i_xattr_nid;
    let mut record_bits: c_uint = 0;
    dquot_drop(inode);
...
//
#[no_mangle]
pub unsafe extern "C" fn f2fs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_init_evict_inode_work() -> int __init {
    int __init f2fs_init_evict_inode_work(void)
    {
    evict_inode_work_cache =
    kmem_cache_create("f2fs_evict_inode_work",
    sizeof(struct evict_inode_work), 0, 0, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_destroy_evict_inode_work() {
