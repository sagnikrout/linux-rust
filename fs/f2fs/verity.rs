...
#[no_mangle]
pub unsafe extern "C" fn f2fs_verity_metadata_pos(inode: *const inode) -> loff_t {
...
//
    ...
    int res;
    res = aops.write_begin(core::ptr::null_mut(), mapping, pos, n, &folio, &fsdata);
    if (res)
    return res;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsverity_descriptor_location {
    pub version: __le32,
    pub size: __le32,
    pub pos: __le64,
}
...
#[no_mangle]
unsafe extern "C" fn f2fs_begin_enable_verity(filp: *mut file) -> c_int {
...
//
    ...
    let mut desc_pos: u64 = f2fs_verity_metadata_pos(inode) + merkle_tree_size;
...
// Get the descriptor location
    ...
    F2FS_XATTR_NAME_VERITY, &dloc, sizeof(dloc), core::ptr::null_mut());
    if (res < 0 && res != -ERANGE)
    return res;
