...
#[no_mangle]
unsafe extern "C" fn support_inline_data(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_may_inline_data(inode: *mut inode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn inode_has_blocks(inode: *mut inode, ifolio: *mut folio) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_sanity_check_inline_data(inode: *mut inode, ifolio: *mut folio) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_may_inline_dentry(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_do_read_inline_data(folio: *mut folio, ifolio: *mut folio) {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_read_inline_data(inode: *mut inode, folio: *mut folio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_convert_inline_folio(dn: *mut dnode_of_data, folio: *mut folio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_convert_inline_inode(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_write_inline_data(inode: *mut inode, folio: *mut folio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_recover_inline_data(inode: *mut inode, nfolio: *mut folio) -> c_int {
...
// res_folio = ifolio;
    ...
    de = f2fs_find_target_dentry(&d, fname, core::ptr::null_mut(), use_hash);
    folio_unlock(ifolio);
    if (IS_ERR(de)) {
...
//
    ...
    set_new_dnode(&dn, dir, ifolio, core::ptr::null_mut(), 0);
    err = f2fs_reserve_block(&dn, 0);
    if (err)
    goto out;
    if (unlikely(dn.data_blkaddr != NEW_ADDR)) {
...
#[no_mangle]
unsafe extern "C" fn f2fs_add_inline_entries(dir: *mut inode, inline_dentry: *mut c_void) -> c_int {
...
//
    ...
    err = f2fs_add_regular_entry(dir, &fname, core::ptr::null_mut(), ino, fake_mode);
    if (err)
    goto punch_dentry_pages;
    bit_pos += GET_DENTRY_SLOTS(le16_to_cpu(de.name_len));
    }
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_try_convert_inline_dir(dir: *mut inode, dentry: *mut dentry) -> c_int {
    ...
    struct f2fs_filename fname;
    struct f2fs_lock_context lc;
    void *inline_dentry = core::ptr::null_mut();
    let mut err: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn f2fs_empty_inline_dir(dir: *mut inode) -> bool {
    bool f2fs_empty_inline_dir(struct inode *dir)
    {
    struct f2fs_sb_info *sbi = F2FS_I_SB(dir);
    struct folio *ifolio;
    let mut bit_pos: c_uint = 2;
    void *inline_dentry;
    struct f2fs_dentry_ptr d;
    ifolio = f2fs_get_inode_folio(sbi, dir.i_ino);
    if (IS_ERR(ifolio))
    ...
    struct folio *ifolio = core::ptr::null_mut();
    struct f2fs_dentry_ptr d;
    void *inline_dentry = core::ptr::null_mut();
    int err;
    make_dentry_ptr_inline(inode, &d, inline_dentry);
