...
#[no_mangle]
unsafe extern "C" fn autofs_del_active(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn autofs_dir_open(inode: *mut inode, file: *mut file) -> c_int {
    static int autofs_dir_open(struct inode *inode, struct file *file)
    {
...
#[no_mangle]
unsafe extern "C" fn autofs_dentry_release(de: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn autofs_mount_wait(path: *const path, rcu_walk: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_expire_wait(path: *const path, rcu_walk: bool) -> c_int {
    ...
    let mut this: path = { .mnt = path.mnt, .dentry = expiring };
//
...
#[no_mangle]
unsafe extern "C" fn autofs_d_manage(path: *const path, rcu_walk: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn autofs_dir_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn autofs_set_leaf_automount_flags(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn autofs_clear_leaf_automount_flags(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn autofs_dir_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn autofs_ask_umount(mnt: *mut vfsmount, p: *mut int __user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_autofs_dentry(dentry: *mut dentry) -> c_int {
