...
#[no_mangle]
pub unsafe extern "C" fn autofs_clean_ino(ino: *mut autofs_info) {
...
#[no_mangle]
pub unsafe extern "C" fn autofs_free_ino(ino: *mut autofs_info) {
    void autofs_free_ino(struct autofs_info *ino)
    {
    kfree_rcu(ino, rcu);
    }
#[no_mangle]
pub unsafe extern "C" fn autofs_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn autofs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
    ...
    seq_puts(m, ",offset");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: autofs_type_direct(sbi->type)) -> else {
...
#[no_mangle]
unsafe extern "C" fn autofs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn autofs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn autofs_validate_protocol(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn autofs_fill_super(s: *mut super_block, fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn autofs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn autofs_free_fc(fc: *mut fs_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn autofs_init_fs_context(fc: *mut fs_context) -> c_int {
