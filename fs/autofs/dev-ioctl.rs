...
//
#[no_mangle]
unsafe extern "C" fn invalid_str(str: *mut c_char, size: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_dev_ioctl_version(cmd: c_int, param: *mut autofs_dev_ioctl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn free_dev_ioctl(param: *mut autofs_dev_ioctl) {
...
//
#[no_mangle]
unsafe extern "C" fn validate_dev_ioctl(cmd: c_int, param: *mut autofs_dev_ioctl) -> c_int {
    static int validate_dev_ioctl(int cmd, struct autofs_dev_ioctl *param)
    {
    let mut inr: c_uint = _IOC_NR(cmd);
    int err;
...
#[no_mangle]
unsafe extern "C" fn test_by_dev(path: *const path, p: *mut c_void) -> c_int {
    static int test_by_dev(const struct path *path, void *p)
    {
    return path.dentry.d_sb.s_dev == *(dev_t *)p;
    }
#[no_mangle]
unsafe extern "C" fn test_by_type(path: *const path, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn autofs_dev_ioctl_open_mountpoint(name: *const c_char, devid: dev_t) -> c_int {
...
//
    ...
    int pipefd;
    let mut err: c_int = 0;
    struct pid *new_pid = core::ptr::null_mut();
...
//
    ...
    struct autofs_dev_ioctl *param)
    {
    let mut timeout: c_ulong = param.timeout.timeout;
...
//
    ...
    let mut path_len: c_int = param.size - AUTOFS_DEV_IOCTL_SIZE - 1;
...
// param->path has been checked in validate_dev_ioctl()
    ...
    let mut dev: dev_t = sbi.sb.s_dev;
...
#[no_mangle]
unsafe extern "C" fn lookup_dev_ioctl(cmd: c_uint) -> ioctl_fn {
    ...
    let mut idx: c_uint = cmd_idx(cmd);
...
#[no_mangle]
pub unsafe extern "C" fn autofs_dev_ioctl_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn autofs_dev_ioctl_exit() {
