...
//
    ...
    {
    struct autofs_sb_info *sbi = autofs_sbi(root.d_sb);
    struct dentry *p = prev, *ret = core::ptr::null_mut(), *d = core::ptr::null_mut();
...
//
    ...
    let mut ino_count: c_uint = READ_ONCE(ino.count);
...
#[no_mangle]
pub unsafe extern "C" fn autofs_expire_wait(path: *const path, rcu_walk: c_int) -> c_int {
