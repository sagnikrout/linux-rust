...
#[no_mangle]
pub unsafe extern "C" fn touch_buffer(bh: *mut buffer_head) {
...
#[no_mangle]
pub unsafe extern "C" fn __lock_buffer(bh: *mut buffer_head) {
...
#[no_mangle]
pub unsafe extern "C" fn unlock_buffer(bh: *mut buffer_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __wait_on_buffer(bh: *mut *mut buffer_head) {
...
#[no_mangle]
unsafe extern "C" fn buffer_io_error(bh: *mut buffer_head, msg: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bio_endio_bh(bio: *mut bio, bhp: *mut buffer_head) -> bool {
    bool bio_endio_bh(struct bio *bio, struct buffer_head **bhp)
    {
    let mut success: bool = bio.bi_status == BLK_STS_OK;
...
//
#[no_mangle]
pub unsafe extern "C" fn end_buffer_read_sync(bh: *mut buffer_head, uptodate: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bh_end_read(bio: *mut bio) {
    void bh_end_read(struct bio *bio)
    {
    struct buffer_head *bh;
    let mut uptodate: bool = bio_endio_bh(bio, &bh);
...
//
#[no_mangle]
pub unsafe extern "C" fn bh_end_write(bio: *mut bio) {
    void bh_end_write(struct bio *bio)
    {
    struct buffer_head *bh;
    let mut success: bool = bio_endio_bh(bio, &bh);
    if (success) {
    set_buffer_uptodate(bh);
    } else {
    ...
    let mut blkbits: c_int = bd_mapping.host.i_blkbits;
    struct buffer_head *ret = core::ptr::null_mut();
    pgoff_t index;
    struct buffer_head *bh;
    struct buffer_head *head;
    struct folio *folio;
    let mut all_mapped: c_int = 1;
...
//
    ...
    all_mapped = 0;
#[no_mangle]
pub unsafe extern "C" fn if(block: bh->b_blocknr ==) -> else {
    ret = bh;
    get_bh(bh);
    goto out_unlock;
    }
...
#[no_mangle]
unsafe extern "C" fn end_buffer_async_read(bh: *mut buffer_head, uptodate: c_int) {
    ...
    struct folio *folio;
    let mut folio_uptodate: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn verify_bh(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn bh_end_async_read(bio: *mut bio) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bh_end_async_write(bio: *mut bio) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmb_init(mmb: *mut mapping_metadata_bhs, mapping: *mut address_space) {
    ...
    WARN_ON(!bh.b_mmb);
    bh.b_mmb = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn remove_assoc_queue(bh: *mut buffer_head) {
...
#[no_mangle]
pub unsafe extern "C" fn mmb_has_buffers(mmb: *mut mapping_metadata_bhs) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmb_sync(mmb: *mut mapping_metadata_bhs) -> c_int {
...
//
    if (cmpxchg(&bh.b_mmb, core::ptr::null_mut(), mmb) != core::ptr::null_mut()) {
    spin_unlock(&mmb.lock);
    return;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn block_dirty_folio(mapping: *mut address_space, folio: *mut folio) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmb_invalidate(mmb: *mut mapping_metadata_bhs) {
...
//
    ...
    {
    let mut gfp: gfp_t = GFP_NOFS | __GFP_ACCOUNT;
...
#[no_mangle]
unsafe extern "C" fn blkdev_max_block(bdev: *mut block_device, size: c_uint) -> sector_t {
    static sector_t blkdev_max_block(struct block_device *bdev, unsigned int size)
    {
    let mut retval: sector_t = ~((sector_t)0);
    let mut sz: loff_t = bdev_nr_bytes(bdev);
    if (sz) {
    let mut sizebits: c_uint = blksize_bits(size);
    retval = (sz >> sizebits);
    }
    return retval;
    }
...
//
    ...
    struct buffer_head *bh = head;
    let mut uptodate: bool = folio_test_uptodate(folio);
    let mut block: sector_t = div_u64(folio_pos(folio), size);
    let mut end_block: sector_t = blkdev_max_block(bdev, size);
    do {
    if (!buffer_mapped(bh)) {
...
// Create a folio with the proper size buffers
    ...
    unsigned size, gfp_t gfp)
    {
    let mut blocking: bool = gfpflags_allow_blocking(gfp);
...
//
#[no_mangle]
pub unsafe extern "C" fn mark_buffer_dirty(bh: *mut buffer_head) {
...
//
    ...
    struct address_space *mapping = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mark_buffer_write_io_error(bh: *mut buffer_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __brelse(bh: *mut buffer_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __bforget(bh: *mut buffer_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bh_submit(bh: *mut buffer_head, opf: blk_opf_t, end_io: bio_end_io_t) {
    void bh_submit(struct buffer_head *bh, blk_opf_t opf, bio_end_io_t end_io)
    {
    __bh_submit(bh, opf, WRITE_LIFE_NOT_SET, core::ptr::null_mut(), end_io);
    }
...
//
pub const BH_LRU_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bh_lru {
    pub bhs: [*mut buffer_head; BH_LRU_SIZE],
}

    static DEFINE_PER_CPU(struct bh_lru, bh_lrus) = {{ core::ptr::null_mut() }};

#[no_mangle]
pub unsafe extern "C" fn check_irqs_on() {
...
//
#[no_mangle]
unsafe extern "C" fn bh_lru_install(bh: *mut buffer_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __breadahead(bdev: *mut block_device, block: sector_t, size: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn __invalidate_bh_lrus(b: *mut bh_lru) {
    static void __invalidate_bh_lrus(struct bh_lru *b)
    {
    int i;
    for (i = 0; i < BH_LRU_SIZE; i++) {
    brelse(b.bhs[i]);
    b.bhs[i] = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn invalidate_bh_lru(arg: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn has_bh_in_lru(cpu: c_int, dummy: *mut c_void) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn invalidate_bh_lrus() {
    void invalidate_bh_lrus(void)
    {
    on_each_cpu_cond(has_bh_in_lru, invalidate_bh_lru, core::ptr::null_mut(), 1);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn invalidate_bh_lrus_cpu() {
...
#[no_mangle]
unsafe extern "C" fn discard_buffer(bh: *mut *mut buffer_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn block_invalidate_folio(folio: *mut folio, offset: usize, length: usize) {
    void block_invalidate_folio(struct folio *folio, size_t offset, size_t length)
    {
    struct buffer_head *head, *bh, *next;
    let mut curr_off: usize = 0;
    let mut stop: usize = length + offset;
    BUG_ON(!folio_test_locked(folio));
//
// Check for overflow
//
    ...
    bh = head;
    do {
    let mut next_off: usize = curr_off + bh.b_size;
    next = bh.b_this_page;
//
...
//
    ...
    let mut gfp: gfp_t = GFP_NOFS | __GFP_ACCOUNT | __GFP_NOFAIL;
...
//
#[no_mangle]
pub unsafe extern "C" fn clean_bdev_aliases(bdev: *mut block_device, block: sector_t, len: sector_t) {
    void clean_bdev_aliases(struct block_device *bdev, sector_t block, sector_t len)
    {
    struct address_space *bd_mapping = bdev.bd_mapping;
    let mut blkbits: c_int = bd_mapping.host.i_blkbits;
    struct folio_batch fbatch;
    let mut index: pgoff_t = ((loff_t)block << blkbits) / PAGE_SIZE;
    pgoff_t end;
    int i, count;
    struct buffer_head *bh;
    struct buffer_head *head;
...
//
#[no_mangle]
pub unsafe extern "C" fn folio_zero_new_buffers(folio: *mut folio, from: usize, to: usize) {
    ...
    {
    let mut offset: loff_t = (loff_t)block << inode.i_blkbits;
...
//
    ...
    {
    let mut from: usize = offset_in_folio(folio, pos);
    let mut to: usize = from + len;
...
//
    ...
    {
    return __block_write_begin_int(folio, pos, len, get_block, core::ptr::null_mut());
    }
    EXPORT_SYMBOL(__block_write_begin);
#[no_mangle]
pub unsafe extern "C" fn block_commit_write(folio: *mut folio, from: usize, to: usize) {
...
//
    ...
    status = __block_write_begin_int(folio, pos, len, get_block, core::ptr::null_mut());
    if (unlikely(status)) {
    folio_unlock(folio);
    folio_put(folio);
...
// foliop = folio;
    ...
    struct folio *folio)
    {
    let mut start: usize = pos - folio_pos(folio);
...
// This could be a short (even 0-length) commit
    ...
    let mut i_size_changed: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn block_is_partially_uptodate(folio: *mut folio, from: usize, count: usize) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn block_read_full_folio(folio: *mut folio, get_block: *mut get_block_t) -> c_int {
    int block_read_full_folio(struct folio *folio, get_block_t *get_block)
    {
    struct inode *inode = folio.mapping.host;
    sector_t iblock, lblock;
    struct buffer_head *bh, *head, *prev = core::ptr::null_mut();
    size_t blocksize;
    let mut fully_mapped: c_int = 1;
    let mut page_error: bool = false;
    let mut limit: loff_t = i_size_read(inode);
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_cont_expand_simple(inode: *mut inode, size: loff_t) -> c_int {
    ...
    if (err)
    goto out;
    err = aops.write_begin(core::ptr::null_mut(), mapping, size, 0, &folio, &fsdata);
    if (err)
    goto out;
    err = aops.write_end(core::ptr::null_mut(), mapping, size, 0, 0, folio, fsdata);
    BUG_ON(err > 0);
    out:
    return err;
    }
...
// folio is wholly or partially inside EOF
    ...
    ret = __block_write_begin_int(folio, 0, end, get_block, core::ptr::null_mut());
    if (unlikely(ret))
    goto out_unlock;
...
//
    ...
    void *get_block)
    {
    let mut inode: *mut inode  const = folio.mapping.host;
...
#[no_mangle]
pub unsafe extern "C" fn write_dirty_buffer(bh: *mut buffer_head, op_flags: blk_opf_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __sync_dirty_buffer(bh: *mut buffer_head, op_flags: blk_opf_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sync_dirty_buffer(bh: *mut buffer_head) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn buffer_busy(bh: *mut buffer_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn try_to_free_buffers(folio: *mut folio) -> bool {
    bool try_to_free_buffers(struct folio *folio)
    {
    let mut mapping: *mut address_space  const = folio.mapping;
    struct buffer_head *buffers_to_free = core::ptr::null_mut();
    let mut ret: bool = 0;
    BUG_ON(!folio_test_locked(folio));
    if (folio_test_writeback(folio))
    return false;
// Misconfigured folio check
    ...
    return true;
    if (mapping == core::ptr::null_mut()) {		/* can this still happen? */
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bh_accounting {
    pub /: *mut *mut int nr; / Number of live bh's,
    pub /: *mut *mut int ratelimit; / Limit cacheline bouncing,
}

    static DEFINE_PER_CPU(struct bh_accounting, bh_accounting) = {0, 0};
#[no_mangle]
unsafe extern "C" fn recalc_bh_state() {
...
#[no_mangle]
pub unsafe extern "C" fn free_buffer_head(bh: *mut buffer_head) {
...
#[no_mangle]
unsafe extern "C" fn buffer_exit_cpu_dead(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bh_uptodate_or_lock(bh: *mut buffer_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __bh_read(bh: *mut buffer_head, op_flags: blk_opf_t, wait: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn buffer_init() -> void __init {
...
//
    ...
    core::ptr::null_mut(), buffer_exit_cpu_dead);
    WARN_ON(ret < 0);
    }
