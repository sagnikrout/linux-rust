...
pub const TRACEFS_DEFAULT_MODE: c_int = 0700;
...
#[no_mangle]
unsafe extern "C" fn tracefs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn tracefs_destroy_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn tracefs_syscall_rmdir(inode: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracefs_inode_owner(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn tracefs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tracefs_apply_options(sb: *mut super_block, remount: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tracefs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tracefs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tracefs_drop_inode(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tracefs_d_release(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn tracefs_d_delete(dentry: *const dentry) -> c_int {
...
//
    return dentry.d_fsdata == core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tracefs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tracefs_get_tree(fc: *mut fs_context) -> c_int {
    static int tracefs_get_tree(struct fs_context *fc)
    {
    let mut err: c_int = get_tree_single(fc, tracefs_fill_super);
    if (err)
    return err;
    return tracefs_reconfigure(fc);
    }
#[no_mangle]
unsafe extern "C" fn tracefs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn tracefs_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tracefs_remove(dentry: *mut dentry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tracefs_initialized() -> bool {
...
#[no_mangle]
unsafe extern "C" fn tracefs_init() -> int __init {
