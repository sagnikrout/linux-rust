...
//! Source: fs/tracefs/event_inode.c
#![no_std]
...
pub const EVENTFS_FILE_INODE_INO: c_uint = 0x12c4e37;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eventfs_root_inode {
    pub ei: eventfs_inode,
...
#[no_mangle]
unsafe extern "C" fn eventfs_dir_ino(ei: *mut eventfs_inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_ei_rcu(rcu: *mut rcu_head) {
...
//
#[no_mangle]
unsafe extern "C" fn release_ei(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn put_ei(ei: *mut eventfs_inode) {
...
#[no_mangle]
pub unsafe extern "C" fn free_ei(ei: *mut eventfs_inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cleanup_ei(ei: *mut eventfs_inode) {
...
#[no_mangle]
unsafe extern "C" fn update_attr(attr: *mut eventfs_attr, iattr: *mut iattr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eventfs_remount(ti: *mut tracefs_inode, update_uid: bool, update_gid: bool) {
...
// Only directories have ti->private set to an ei, not files
    inode = eventfs_get_inode(dentry, attr, mode, core::ptr::null_mut());
    if (unlikely(!inode))
...
//
#[no_mangle]
pub unsafe extern "C" fn eventfs_d_release(dentry: *mut dentry) {
...
//
    ...
    {
    struct eventfs_attr *attr = core::ptr::null_mut();
    if (ei.entry_attrs)
...
//
#[no_mangle]
unsafe extern "C" fn eventfs_iterate(file: *mut file, ctx: *mut dir_context) -> c_int {
    static int eventfs_iterate(struct file *file, struct dir_context *ctx)
    {
    const struct file_operations *fops;
...
//
#[no_mangle]
unsafe extern "C" fn eventfs_remove_rec(ei: *mut eventfs_inode, level: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eventfs_remove_dir(ei: *mut eventfs_inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eventfs_remove_events_dir(ei: *mut eventfs_inode) {
    ...
    if (!dentry)
    return;
    rei.events_dir = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn eventfs_remount_lock() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn eventfs_remount_unlock(srcu_idx: c_int) {
