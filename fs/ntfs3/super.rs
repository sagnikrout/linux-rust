...
//
#[no_mangle]
pub unsafe extern "C" fn ntfs_printk(sb: *const super_block, fmt: *const c_char, ...) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntfs_inode_printk(inode: *mut inode, fmt: *const c_char, ...) {
...
// Use static allocated buffer, if possible.
    ...
    name[0] = 0;
#[no_mangle]
pub unsafe extern "C" fn if(sizeof(s_name_buf): len >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn put_mount_options(options: *mut ntfs_mount_options) {
...
#[no_mangle]
unsafe extern "C" fn ntfs_fs_reconfigure(fc: *mut fs_context) -> c_int {
    ...
    new_opts.nls = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ntfs3_volinfo(m: *mut seq_file, o: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs3_volinfo_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs3_label_show(m: *mut seq_file, o: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs3_label_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_create_procdir(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ntfs_remove_procdir(sb: *mut super_block) {
    ...
    sbi.procdir = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ntfs_create_proc_root() {
    static void ntfs_create_proc_root(void)
    {
    proc_info_root = proc_mkdir("fs/ntfs3", core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ntfs_remove_proc_root() {
    static void ntfs_remove_proc_root(void)
    {
    if (proc_info_root) {
    remove_proc_entry("fs/ntfs3", core::ptr::null_mut());
    proc_info_root = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn ntfs_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn ntfs3_put_sbi(sbi: *mut ntfs_sb_info) -> noinline void {
    ...
    sbi.security.ni = core::ptr::null_mut();
    }
    if (sbi.reparse.ni) {
    iput(&sbi.reparse.ni.vfs_inode);
    sbi.reparse.ni = core::ptr::null_mut();
    }
    if (sbi.objid.ni) {
    iput(&sbi.objid.ni.vfs_inode);
    sbi.objid.ni = core::ptr::null_mut();
    }
    if (sbi.volume.ni) {
    iput(&sbi.volume.ni.vfs_inode);
    sbi.volume.ni = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ntfs3_free_sbi(sbi: *mut ntfs_sb_info) {
...
// Mark rw ntfs as clear, if possible.
    ...
    sbi.options = core::ptr::null_mut();
    }
    ntfs3_put_sbi(sbi);
    }
#[no_mangle]
unsafe extern "C" fn ntfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_nfs_commit_metadata(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn format_size_gb(bytes: u64, mb: *mut u32) -> u32 {
    static u32 format_size_gb(const u64 bytes, u32 *mb)
    {
// Do simple right 30 bit shift of 64 bit value.
    let mut kbytes: u64 = bytes >> 10;
    let mut kbytes32: u32 = kbytes;
...
#[no_mangle]
unsafe extern "C" fn true_sectors_per_clst(boot: *const NTFS_BOOT) -> u32 {
...
//
    ...
    u16 fn, ao;
    u8 cluster_bits;
    let mut boot_off: u32 = 0;
    let mut boot_block: sector_t = 0;
...
// boot2 = kmemdup(boot, sizeof(*boot), GFP_NOFS | __GFP_NOWARN);
    ...
    let mut block_size: u32 = min_t(u32, sector_size, PAGE_SIZE);
    let mut lbo: u64 = dev_size0 - sizeof(*boot);
...
unsafe extern "C" fn ntfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    ...
    struct ntfs_mount_options *options = core::ptr::null_mut();
    struct inode *inode;
    struct ntfs_inode *ni;
    ...
    u16 *shared;
    struct MFT_REF ref;
    let mut ro: bool = sb_rdonly(sb);
    struct NTFS_BOOT *boot2 = core::ptr::null_mut();
    ref.high = 0;
    sbi.sb = sb;
    ...
    set_default_d_op(sb, options.nocase ? &ntfs_dentry_ops : core::ptr::null_mut());
    options.nls = ntfs_load_nls(options.nls_name);
    if (IS_ERR(options.nls)) {
    options.nls = core::ptr::null_mut();
...
// Load and save label (not necessary).
    attr = ni_find_attr(ni, core::ptr::null_mut(), core::ptr::null_mut(), ATTR_LABEL, core::ptr::null_mut(), 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (!attr) {
...
// goto put_inode_out;
    ...
    attr = ni_find_attr(ni, attr, core::ptr::null_mut(), ATTR_VOL_INFO, core::ptr::null_mut(), 0, core::ptr::null_mut(), core::ptr::null_mut());
...
// Merge MFT bitmap runs from extent records loaded by ni_load_all_mi.
    {
    struct ATTRIB *a = core::ptr::null_mut();
    struct ATTR_LIST_ENTRY *le = core::ptr::null_mut();
    while ((a = ni_enum_attr_ex(ni, a, &le, core::ptr::null_mut()))) {
    CLST svcn, evcn;
    u16 roff;
...
// Read the entire file.
    ...
    let mut t32: u32 = le32_to_cpu(t.type);
    let mut sz: u64 = le64_to_cpu(t.max_sz);
    if ((t32 & 0xF) || le32_to_cpu(t[-1].type) >= t32)
    break;
    if (t.type == ATTR_REPARSE)
    sbi.reparse.max_size = sz;
#[no_mangle]
pub unsafe extern "C" fn if(ATTR_EA: t->type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ntfs_unmap_meta(sb: *mut super_block, lcn: CLST, len: CLST) {
    void ntfs_unmap_meta(struct super_block *sb, CLST lcn, CLST len)
    {
    struct ntfs_sb_info *sbi = sb.s_fs_info;
    struct block_device *bdev = sb.s_bdev;
    let mut devblock: sector_t = (u64)lcn * sbi.blocks_per_cluster;
    let mut blocks: c_ulong = (u64)len * sbi.blocks_per_cluster;
    ...
    limit -= 0x1000;
#[no_mangle]
pub unsafe extern "C" fn if(32: limit <) -> else {
    else if (limit < 32)
    limit = 32;
    else
    limit >>= 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn ntfs_discard(sbi: *mut ntfs_sb_info, lcn: CLST, len: CLST) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntfs_fs_get_tree(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ntfs_fs_free(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn ntfs3_kill_sb(sb: *mut super_block) {
