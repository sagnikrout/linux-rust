...
//! Source: fs/ntfs3/lib/lzx_decompress.c
#![no_std]
...
pub const LZX_NUM_CHARS: c_int = 256;
// The smallest and largest allowed match lengths
pub const LZX_MIN_MATCH_LEN: c_int = 2;
pub const LZX_MAX_MATCH_LEN: c_int = 257;
// Number of distinct match lengths that can be represented

// Number of match lengths for which no length symbol is required
pub const LZX_NUM_PRIMARY_LENS: c_int = 7;

// Valid values of the 3-bit block type field
pub const LZX_BLOCKTYPE_VERBATIM: c_int = 1;
pub const LZX_BLOCKTYPE_ALIGNED: c_int = 2;
pub const LZX_BLOCKTYPE_UNCOMPRESSED: c_int = 3;
// Number of offset slots for a window size of 32768
pub const LZX_NUM_OFFSET_SLOTS: c_int = 30;
...
pub const LZX_ALIGNEDCODE_ELEMENT_SIZE: c_int = 3;
// Maximum lengths (in bits) of the codewords in each Huffman code
pub const LZX_MAX_MAIN_CODEWORD_LEN: c_int = 16;
pub const LZX_MAX_LEN_CODEWORD_LEN: c_int = 16;
...
// fixed at 12000000.
//
pub const LZX_DEFAULT_FILESIZE: c_int = 12000000;
// Assumed block size when the encoded block size begins with a 0 bit.
pub const LZX_DEFAULT_BLOCK_SIZE: c_int = 32768;
// Number of offsets in the recent (or "repeat") offsets queue.
pub const LZX_NUM_RECENT_OFFSETS: c_int = 3;
// These values are chosen for fast decompression.
pub const LZX_MAINCODE_TABLEBITS: c_int = 11;
pub const LZX_LENCODE_TABLEBITS: c_int = 10;
pub const LZX_PRECODE_TABLEBITS: c_int = 6;
pub const LZX_ALIGNEDCODE_TABLEBITS: c_int = 7;
pub const LZX_READ_LENS_MAX_OVERRUN: c_int = 50;
...
//
    ...
    pub 2)]: *mut *mut (LZX_MAINCODE_NUM_SYMBOLS,
    pub LZX_READ_LENS_MAX_OVERRUN]: u8 maincode_lens[LZX_MAINCODE_NUM_SYMBOLS +,
    u16 lencode_decode_table[(1 << LZX_LENCODE_TABLEBITS) +
    pub 2)]: *mut *mut (LZX_LENCODE_NUM_SYMBOLS,
    pub LZX_READ_LENS_MAX_OVERRUN]: u8 lencode_lens[LZX_LENCODE_NUM_SYMBOLS +,
    u16 alignedcode_decode_table[(1 << LZX_ALIGNEDCODE_TABLEBITS) +
    pub 2)]: *mut *mut (LZX_ALIGNEDCODE_NUM_SYMBOLS,
    pub alignedcode_lens: [u8; LZX_ALIGNEDCODE_NUM_SYMBOLS],
    u16 precode_decode_table[(1 << LZX_PRECODE_TABLEBITS) +
    pub 2)]: *mut *mut (LZX_PRECODE_NUM_SYMBOLS,
...
#[no_mangle]
unsafe extern "C" fn undo_e8_translation(target: *mut c_void, input_pos: i32) {
...
//
#[no_mangle]
unsafe extern "C" fn lzx_postprocess(data: *mut u8, size: u32) {
...
// Decompress a block of LZX-compressed data.
    ...
    u32 recent_offsets[])
    {
    let mut block_end: *mut u8  const = out_next + block_size;
    let mut ones_if_aligned: u32 = 0U - (block_type == LZX_BLOCKTYPE_ALIGNED);
    do {
    u32 mainsym;
    u32 match_len;
    u32 match_offset;
...
//
#[no_mangle]
pub unsafe extern "C" fn lzx_free_decompressor(decompressor: *mut lzx_decompressor) {
