...
#[no_mangle]
unsafe extern "C" fn exfat_free_iocharset(sbi: *mut exfat_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn exfat_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn exfat_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    static int exfat_statfs(struct dentry *dentry, struct kstatfs *buf)
    {
    struct super_block *sb = dentry.d_sb;
    struct exfat_sb_info *sbi = EXFAT_SB(sb);
    let mut id: c_ulonglong = huge_encode_dev(sb.s_bdev.bd_dev);
...
#[no_mangle]
unsafe extern "C" fn exfat_set_vol_flags(sb: *mut super_block, new_flags: c_ushort) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn exfat_set_volume_dirty(sb: *mut super_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn exfat_clear_volume_dirty(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sbi->nls_io) -> else {
    else if (sbi.nls_io)
    seq_printf(m, ",iocharset=%s", sbi.nls_io.charset);
    if (opts.errors == EXFAT_ERRORS_CONT)
    seq_puts(m, ",errors=continue");
#[no_mangle]
pub unsafe extern "C" fn if(EXFAT_ERRORS_PANIC: opts->errors ==) -> else {
    ...
    seq_puts(m, ",sys_tz");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: opts->time_offset) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn exfat_force_shutdown(sb: *mut super_block, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_shutdown(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn exfat_free_inode(inode: *mut inode) {
...
// Deprecated options
    ...
    __fsparam(core::ptr::null_mut(), "utf8",			Opt_utf8, fs_param_deprecated,
    core::ptr::null_mut()),
    __fsparam(core::ptr::null_mut(), "debug",		Opt_debug, fs_param_deprecated,
    core::ptr::null_mut()),
    __fsparam(fs_param_is_u32, "namecase",	Opt_namecase,
    fs_param_deprecated, core::ptr::null_mut()),
    __fsparam(fs_param_is_u32, "codepage",	Opt_codepage,
    fs_param_deprecated, core::ptr::null_mut()),
    {}
    };
#[no_mangle]
unsafe extern "C" fn exfat_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_hash_init(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn exfat_read_root(inode: *mut inode, root_clu: *mut exfat_chain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_calibrate_blocksize(sb: *mut super_block, logical_sect: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_read_boot_sector(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_verify_boot_region(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_get_tree(fc: *mut fs_context) -> c_int {
    static int exfat_get_tree(struct fs_context *fc)
    {
    return get_tree_bdev(fc, exfat_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn exfat_free_sbi(sbi: *mut exfat_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn exfat_free(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn exfat_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exfat_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn exfat_inode_init_once(foo: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn init_exfat_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_exfat_fs() -> void __exit {
