...
#[no_mangle]
pub unsafe extern "C" fn register_quota_format(fmt: *mut quota_format_type) {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_quota_format(fmt: *mut quota_format_type) {
...
// actqf = (*actqf)->qf_next;
    ...
    ;
    if (actqf && !try_module_get(actqf.qf_owner))
    actqf = core::ptr::null_mut();
    }
    spin_unlock(&dq_list_lock);
    return actqf;
    }
#[no_mangle]
unsafe extern "C" fn put_quota_format(fmt: *mut quota_format_type) {
...
//
    ...
    {
    let mut id: c_uint = from_kqid(&init_user_ns, qid);
    let mut type: c_int = qid.type;
    unsigned long tmp;
...
//
#[no_mangle]
pub unsafe extern "C" fn insert_dquot_hash(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn remove_dquot_hash(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn put_dquot_last(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn put_releasing_dquots(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn remove_free_dquot(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn put_inuse(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn remove_inuse(dquot: *mut dquot) {
...
//
#[no_mangle]
unsafe extern "C" fn wait_on_dquot(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_active(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_dirty(dquot: *mut dquot) -> c_int {
    static inline int dquot_dirty(struct dquot *dquot)
    {
    return test_bit(DQ_MOD_B, &dquot.dq_flags);
    }
#[no_mangle]
pub unsafe extern "C" fn mark_dquot_dirty(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_mark_dquot_dirty(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mark_all_dquot_dirty(dquots: *const *const dquot __rcu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dqput_all(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_dquot_dirty(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mark_info_dirty(sb: *mut super_block, type: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_acquire(dquot: *mut dquot) -> c_int {
    int dquot_acquire(struct dquot *dquot)
    {
    let mut ret: c_int = 0, ret2 = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_commit(dquot: *mut dquot) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_release(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_destroy(dquot: *mut dquot) {
...
#[no_mangle]
pub unsafe extern "C" fn do_destroy_dquot(dquot: *mut dquot) {
...
//
#[no_mangle]
unsafe extern "C" fn invalidate_dquots(sb: *mut super_block, type: c_int) {
...
// Call callback for every active dquot on given filesystem
    ...
    unsigned long priv)
    {
    struct dquot *dquot, *old_dquot = core::ptr::null_mut();
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn dquot_write_dquot(dquot: *mut dquot) -> c_int {
    static inline int dquot_write_dquot(struct dquot *dquot)
    {
    let mut ret: c_int = dquot.dq_sb.dq_op.write_dquot(dquot);
    if (ret < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_writeback_dquots(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_quota_sync(sb: *mut super_block, type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quota_release_workfn(work: *mut work_struct) {
    static void quota_release_workfn(struct work_struct *work)
    {
    struct dquot *dquot;
...
//
#[no_mangle]
pub unsafe extern "C" fn dqput(dquot: *mut dquot) {
...
//
    ...
    {
    let mut hashent: c_uint = hashfn(sb, qid);
    struct dquot *dquot, *empty = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dqinit_needed(inode: *mut inode, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_dquot_ref(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_dquot_ref(sb: *mut super_block, type: c_int) {
...
//
    ...
    rcu_assign_pointer(dquots[type], core::ptr::null_mut());
    if (dquot)
    dqput(dquot);
    }
    spin_unlock(&dq_data_lock);
...
#[no_mangle]
unsafe extern "C" fn drop_dquot_ref(sb: *mut super_block, type: c_int) {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn dquot_free_reserved_space(dquot: *mut dquot, number: qsize_t) {
...
#[no_mangle]
unsafe extern "C" fn dquot_decr_inodes(dquot: *mut dquot, number: qsize_t) {
...
#[no_mangle]
unsafe extern "C" fn dquot_decr_space(dquot: *mut dquot, number: qsize_t) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dquot_warn {
    pub w_sb: *mut super_block,
    pub w_dq_id: kqid,
    pub w_type: c_short,
}

#[no_mangle]
unsafe extern "C" fn warning_issued(dquot: *mut dquot, warntype: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flush_warnings(warn: *mut dquot_warn) {
...
#[no_mangle]
unsafe extern "C" fn ignore_hardlimit(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn info_idq_free(dquot: *mut dquot, inodes: qsize_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn info_bdq_free(dquot: *mut dquot, space: qsize_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inode_quota_active(inode: *const inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __dquot_initialize(inode: *mut inode, type: c_int) -> c_int {
    static int __dquot_initialize(struct inode *inode, int type)
    {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_initialize(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_initialize_needed(inode: *mut inode) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __dquot_drop(inode: *mut inode) {
    ...
    lockdep_is_held(&dq_data_lock));
    rcu_assign_pointer(dquots[cnt], core::ptr::null_mut());
    }
    spin_unlock(&dq_data_lock);
    dqput_all(put);
    }
#[no_mangle]
pub unsafe extern "C" fn dquot_drop(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn __inode_get_rsv_space(inode: *mut inode) -> qsize_t {
    static qsize_t __inode_get_rsv_space(struct inode *inode)
    {
...
#[no_mangle]
unsafe extern "C" fn inode_get_rsv_space(inode: *mut inode) -> qsize_t {
    static qsize_t inode_get_rsv_space(struct inode *inode)
    {
    qsize_t ret;
    if (!inode.i_sb.dq_op.get_reserved_space)
...
//
#[no_mangle]
pub unsafe extern "C" fn __dquot_alloc_space(inode: *mut inode, number: qsize_t, flags: c_int) -> c_int {
    int __dquot_alloc_space(struct inode *inode, qsize_t number, int flags)
    {
    int cnt, ret = 0, index;
    struct dquot_warn warn[MAXQUOTAS];
    let mut reserve: c_int = flags & DQUOT_SPACE_RESERVE;
    struct dquot __rcu **dquots;
    struct dquot *dquot;
    if (!inode_quota_active(inode)) {
    if (reserve) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_alloc_inode(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_claim_space_nodirty(inode: *mut inode, number: qsize_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_reclaim_space_nodirty(inode: *mut inode, number: qsize_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __dquot_free_space(inode: *mut inode, number: qsize_t, flags: c_int) {
    ...
    struct dquot __rcu **dquots;
    struct dquot *dquot;
    let mut reserve: c_int = flags & DQUOT_SPACE_RESERVE, index;
    if (!inode_quota_active(inode)) {
    if (reserve) {
    spin_lock(&inode.i_lock);
// inode_reserved_space(inode) -= number;
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __dquot_transfer(inode: *mut inode, transfer_to: *mut dquot) -> c_int {
    int __dquot_transfer(struct inode *inode, struct dquot **transfer_to)
    {
    qsize_t cur_space;
    let mut rsv_space: qsize_t = 0;
    let mut inode_usage: qsize_t = 1;
    struct dquot __rcu **dquots;
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_commit_info(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_get_next_id(sb: *mut super_block, qid: *mut kqid) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_file_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfs_cleanup_quota_inode(sb: *mut super_block, type: c_int) {
    ...
    dqopt.files[type] = core::ptr::null_mut();
    iput(inode);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn dquot_disable(sb: *mut super_block, type: c_int, flags: c_uint) -> c_int {
...
//
    ...
    dqopt.ops[cnt] = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn dquot_quota_off(sb: *mut super_block, type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vfs_setup_quota_inode(inode: *mut inode, type: c_int) -> c_int {
...
// Just unsuspend quotas?
    ...
    (type == PRJQUOTA && sb.dq_op.get_projid == core::ptr::null_mut())) {
    error = -EINVAL;
    goto out_fmt;
    }
...
#[no_mangle]
pub unsafe extern "C" fn dquot_resume(sb: *mut super_block, type: c_int) -> c_int {
    int dquot_resume(struct super_block *sb, int type)
    {
    struct quota_info *dqopt = sb_dqopt(sb);
    let mut ret: c_int = 0, cnt;
    unsigned int flags;
    rwsem_assert_held_write(&sb.s_umount);
    for (cnt = 0; cnt < MAXQUOTAS; cnt++) {
    if (type != -1 && cnt != type)
    ...
    {
    let mut error: c_int = security_quota_on(path.dentry);
    if (error)
    return error;
...
#[no_mangle]
unsafe extern "C" fn dquot_quota_enable(sb: *mut super_block, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dquot_quota_disable(sb: *mut super_block, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_get_dqblk(dquot: *mut dquot, di: *mut qc_dqblk) {
...
#[no_mangle]
unsafe extern "C" fn do_set_dqblk(dquot: *mut dquot, di: *mut qc_dqblk) -> c_int {
    static int do_set_dqblk(struct dquot *dquot, struct qc_dqblk *di)
    {
    struct mem_dqblk *dm = &dquot.dq_dqb;
    let mut check_blim: c_int = 0, check_ilim = 0;
...
#[no_mangle]
pub unsafe extern "C" fn dquot_get_state(sb: *mut super_block, state: *mut qc_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dquot_set_dqinfo(sb: *mut super_block, type: c_int, ii: *mut qc_info) -> c_int {
...
// Force write to disk
    ...
    {
    let mut type: c_uint = (unsigned long *)table.data - dqstats.stat;
    let mut value: i64 = percpu_counter_sum(&dqstats.counter[type]);
...
#[no_mangle]
unsafe extern "C" fn dquot_init() -> int __init {
