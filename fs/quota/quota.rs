...
#[no_mangle]
unsafe extern "C" fn quota_sync_one(sb: *mut super_block, arg: *mut c_void) {
    static void quota_sync_one(struct super_block *sb, void *arg)
    {
    let mut type: c_int = *(int *)arg;
    if (sb.s_qcop && sb.s_qcop.quota_sync &&
    (sb.s_quota_types & (1 << type)))
    sb.s_qcop.quota_sync(sb, type);
    }
#[no_mangle]
unsafe extern "C" fn quota_sync_all(type: c_int) -> c_int {
    static int quota_sync_all(int type)
    {
    int ret;
    ret = security_quotactl(Q_SYNC, type, 0, core::ptr::null_mut());
    if (!ret)
    iterate_supers(quota_sync_one, &type);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn qtype_enforce_flag(type: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn quota_quotaoff(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quota_getfmt(sb: *mut super_block, type: c_int, addr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quota_getinfo(sb: *mut super_block, type: c_int, addr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quota_setinfo(sb: *mut super_block, type: c_int, addr: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qbtos(blocks: qsize_t) -> qsize_t {
    static inline qsize_t qbtos(qsize_t blocks)
    {
    return blocks << QIF_DQBLKSIZE_BITS;
    }
#[no_mangle]
pub unsafe extern "C" fn stoqb(space: qsize_t) -> qsize_t {
    static inline qsize_t stoqb(qsize_t space)
    {
    return (space + QIF_DQBLKSIZE - 1) >> QIF_DQBLKSIZE_BITS;
    }
#[no_mangle]
unsafe extern "C" fn copy_to_if_dqblk(dst: *mut if_dqblk, src: *mut qc_dqblk) {
...
#[no_mangle]
unsafe extern "C" fn copy_from_if_dqblk(dst: *mut qc_dqblk, src: *mut if_dqblk) {
...
#[no_mangle]
unsafe extern "C" fn quota_enable(sb: *mut super_block, addr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quota_disable(sb: *mut super_block, addr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quota_state_to_flags(state: *mut qc_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quota_getxstate(sb: *mut super_block, type: c_int, addr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quota_getxstatev(sb: *mut super_block, type: c_int, addr: *mut void __user) -> c_int {
...
//
pub const XFS_BB_SHIFT: c_int = 9;
#[no_mangle]
pub unsafe extern "C" fn quota_bbtob(blocks: u64) -> u64 {
    static inline u64 quota_bbtob(u64 blocks)
    {
    return blocks << XFS_BB_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn quota_btobb(bytes: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn copy_from_xfs_dqblk(dst: *mut qc_dqblk, src: *mut fs_disk_quota) {
...
#[no_mangle]
pub unsafe extern "C" fn want_bigtime(timer: i64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(PRJQUOTA: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn quota_rmxquota(sb: *mut super_block, addr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quotactl_cmd_write(cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quotactl_cmd_onoff(cmd: c_int) -> bool {
...
//
    ...
    let mut excl: bool = false, thawed = false;
    int error;
    dev_t dev;
    if (IS_ERR(tmp))
    return ERR_CAST(tmp);
...
//
    ...
    struct path path, *pathp = core::ptr::null_mut();
    int ret;
...
//
    ...
    {
    struct super_block *sb;
    let mut cmds: c_uint = cmd >> SUBCMDSHIFT;
    let mut type: c_uint = cmd & SUBCMDMASK;
    CLASS(fd_raw, f)(fd);
    int ret;
    if (fd_empty(f))
    return -EBADF;
