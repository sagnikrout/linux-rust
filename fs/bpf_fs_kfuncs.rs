...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_put_file(file: *mut file) -> __bpf_kfunc void {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_path_d_path(path: *const path, buf: *mut c_char, buf__sz: usize) -> __bpf_kfunc int {
...
#[no_mangle]
unsafe extern "C" fn match_security_bpf_prefix(name__str: *const c_char) -> bool {
    static bool match_security_bpf_prefix(const char *name__str)
    {
    return !strncmp(name__str, XATTR_NAME_BPF_LSM, XATTR_NAME_BPF_LSM_LEN);
    }
#[no_mangle]
unsafe extern "C" fn bpf_xattr_read_permission(name: *const c_char, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_xattr_write_permission(name: *const c_char, inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_remove_dentry_xattr_locked(dentry: *mut dentry, name__str: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_remove_dentry_xattr(dentry: *mut dentry, name__str: *const c_char) -> __bpf_kfunc int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fs_kfuncs_filter(prog: *const bpf_prog, kfunc_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_lsm_has_d_inode_locked(prog: *const bpf_prog) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bpf_fs_kfuncs_init() -> int __init {
