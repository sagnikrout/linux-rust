...
//
#[no_mangle]
unsafe extern "C" fn vfs_parse_sb_flag(fc: *mut fs_context, key: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_parse_fs_param_source(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_parse_fs_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
//
    ...
    if (ret)
    return ret;
    while ((key = sep(&options)) != core::ptr::null_mut()) {
    if (*key) {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_parse_monolithic(fc: *mut fs_context, data: *mut c_void) -> c_int {
...
//
    ...
    unsigned int sb_flags)
    {
    return alloc_fs_context(fs_type, core::ptr::null_mut(), sb_flags, 0,
...
#[no_mangle]
pub unsafe extern "C" fn fc_drop_locked(fc: *mut fs_context) {
...
//
    ...
    return ERR_PTR(-ENOMEM);
    mutex_init(&fc.uapi_mutex);
    fc.fs_private	= core::ptr::null_mut();
    fc.s_fs_info	= core::ptr::null_mut();
    fc.source	= core::ptr::null_mut();
    fc.security	= core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn logfc(log: *mut fc_log, prefix: *const c_char, level: c_char, fmt: *const c_char, ...) {
    void logfc(struct fc_log *log, const char *prefix, char level, const char *fmt, ...)
    {
    va_list va;
    let mut vaf: va_format = {.fmt = fmt, .va = &va};
    va_start(va, fmt);
    if (!log) {
    switch (level) {
    case 'w':
    ...
    let mut logsize: c_uint = ARRAY_SIZE(log.buffer);
    u8 index;
...
//
#[no_mangle]
unsafe extern "C" fn put_fc_log(fc: *mut fs_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn put_fs_context(fc: *mut fs_context) {
...
#[no_mangle]
pub unsafe extern "C" fn parse_monolithic_mount_data(fc: *mut fs_context, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_clean_context(fc: *mut fs_context) {
...
#[no_mangle]
pub unsafe extern "C" fn finish_clean_context(fc: *mut fs_context) -> c_int {
