...
//
#[no_mangle]
unsafe extern "C" fn get_heap_comp_val(lprops: *mut ubifs_lprops, cat: c_int) -> c_int {
...
//
    ...
    let mut b: c_int = LPT_HEAP_SZ / 2 - 1;
    int cpos, val1, val2;
...
//
    ...
    let mut hpos: c_int = lprops.hpos;
...
//
    ...
    {
    struct ubifs_lpt_heap *heap;
    let mut hpos: c_int = new_lprops.hpos;
    heap = &c.lpt_heap[cat - 1];
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_ensure_cat(c: *mut ubifs_info, lprops: *mut ubifs_lprops) {
    void ubifs_ensure_cat(struct ubifs_info *c, struct ubifs_lprops *lprops)
    {
    let mut cat: c_int = lprops.flags & LPROPS_CAT_MASK;
    if (cat != LPROPS_UNCAT)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn change_category(c: *mut ubifs_info, lprops: *mut ubifs_lprops) {
    static void change_category(struct ubifs_info *c, struct ubifs_lprops *lprops)
    {
    let mut old_cat: c_int = lprops.flags & LPROPS_CAT_MASK;
    let mut new_cat: c_int = ubifs_categorize_lprops(c, lprops);
    if (old_cat == new_cat) {
    struct ubifs_lpt_heap *heap;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_calc_dark(c: *const ubifs_info, spc: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is_lprops_dirty(c: *mut ubifs_info, lprops: *mut ubifs_lprops) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_get_lp_stats(c: *mut ubifs_info, lst: *mut ubifs_lp_stats) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_read_one_lp(c: *mut ubifs_info, lnum: c_int, lp: *mut ubifs_lprops) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dbg_check_cats(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dbg_check_lprops(c: *mut ubifs_info) -> c_int {
