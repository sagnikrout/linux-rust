...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_ro_mode(c: *mut ubifs_info, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_leb_change(c: *mut ubifs_info, lnum: c_int, buf: *const c_void, len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_leb_unmap(c: *mut ubifs_info, lnum: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_leb_map(c: *mut ubifs_info, lnum: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_is_mapped(c: *const ubifs_info, lnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record_magic_error(stats: *mut ubifs_stats_info) {
...
#[no_mangle]
unsafe extern "C" fn record_node_error(stats: *mut ubifs_stats_info) {
...
#[no_mangle]
unsafe extern "C" fn record_crc_error(stats: *mut ubifs_stats_info) {
...
//
    ...
    {
    let mut err: c_int = -EINVAL, type, node_len;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_pad(c: *const ubifs_info, buf: *mut c_void, pad: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn next_sqnum(c: *mut ubifs_info) -> c_ulonglong {
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_init_node(c: *mut ubifs_info, node: *mut c_void, len: c_int, pad: c_int) {
    void ubifs_init_node(struct ubifs_info *c, void *node, int len, int pad)
    {
    struct ubifs_ch *ch = node;
    let mut sqnum: c_ulonglong = next_sqnum(c);
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_crc_node(node: *mut c_void, len: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_prepare_node(c: *mut ubifs_info, node: *mut c_void, len: c_int, pad: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_prep_grp_node(c: *mut ubifs_info, node: *mut c_void, len: c_int, last: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn wbuf_timer_callback_nolock(timer: *mut hrtimer) -> enum hrtimer_restart {
...
//
#[no_mangle]
unsafe extern "C" fn new_wbuf_timer_nolock(c: *mut ubifs_info, wbuf: *mut ubifs_wbuf) {
    static void new_wbuf_timer_nolock(struct ubifs_info *c, struct ubifs_wbuf *wbuf)
    {
    let mut softlimit: ktime_t = ms_to_ktime(dirty_writeback_interval * 10);
    let mut delta: c_ulonglong = dirty_writeback_interval;
...
//
#[no_mangle]
unsafe extern "C" fn cancel_wbuf_timer_nolock(wbuf: *mut ubifs_wbuf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_wbuf_sync_nolock(wbuf: *mut ubifs_wbuf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1): wbuf->offs & (c->max_write_size -) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_wbuf_seek_nolock(wbuf: *mut ubifs_wbuf, lnum: c_int, offs: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_bg_wbufs_sync(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_wbuf_write_nolock(wbuf: *mut ubifs_wbuf, buf: *mut c_void, len: c_int) -> c_int {
...
//
    ...
    exit:
    if (wbuf.sync_callback) {
    let mut free: c_int = c.leb_size - wbuf.offs - wbuf.used;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_wbuf_init(c: *mut ubifs_info, wbuf: *mut ubifs_wbuf) -> c_int {
...
//
    ...
    wbuf.sync_callback = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_wbuf_add_ino_nolock(wbuf: *mut ubifs_wbuf, inum: ino_t) {
...
//
#[no_mangle]
unsafe extern "C" fn wbuf_has_ino(wbuf: *mut ubifs_wbuf, inum: ino_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_sync_wbufs_by_inode(c: *mut ubifs_info, inode: *mut inode) -> c_int {
