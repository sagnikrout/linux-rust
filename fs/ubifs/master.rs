...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_compare_master_node(c: *mut ubifs_info, m1: *mut c_void, m2: *mut c_void) -> c_int {
    int ubifs_compare_master_node(struct ubifs_info *c, void *m1, void *m2)
    {
    int ret;
    int behind;
    let mut hmac_offs: c_int = offsetof(struct ubifs_mst_node, hmac);
//
...
//
#[no_mangle]
unsafe extern "C" fn scan_for_master(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn validate_master(c: *const ubifs_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_read_master(c: *mut ubifs_info) -> c_int {
...
// The file system has been resized
    let mut growth: c_int = c.leb_cnt - old_leb_cnt;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_write_master(c: *mut ubifs_info) -> c_int {
