...
//
    ...
    {
    let mut beg: c_int = 0, end = znode.child_cnt, mid;
    int cmp;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_destroy_tnc_tree(c: *mut ubifs_info) {
...
//
    ...
    struct ubifs_znode *znode)
    {
    let mut lnum: c_int = zzbr.lnum;
    let mut offs: c_int = zzbr.offs;
    let mut len: c_int = zzbr.len;
    int i, err, type, cmp;
