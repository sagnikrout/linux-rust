...
//
#[no_mangle]
unsafe extern "C" fn shrink_tnc(c: *mut ubifs_info, nr: c_int, age: c_int, contention: *mut c_int) -> c_int {
    static int shrink_tnc(struct ubifs_info *c, int nr, int age, int *contention)
    {
    let mut total_freed: c_int = 0;
...
// contention = 1;
    ...
    if (znode.parent)
    znode.parent.zbranch[znode.iip].znode = core::ptr::null_mut();
    else
...
//
#[no_mangle]
unsafe extern "C" fn shrink_tnc_trees(nr: c_int, age: c_int, contention: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kick_a_thread() -> c_int {
...
//
    ...
    {
    let mut clean_zn_cnt: c_long = atomic_long_read(&ubifs_clean_zn_cnt);
//
