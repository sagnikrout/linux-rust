...
#[no_mangle]
unsafe extern "C" fn ubifs_default_version_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int ubifs_default_version_set(const char *val, const struct kernel_param *kp)
    {
    let mut n: c_int = 0, ret;
    ...
    let mut ubifs_default_version: c_int = UBIFS_FORMAT_VERSION;
...
//
#[no_mangle]
unsafe extern "C" fn validate_inode(c: *mut ubifs_info, inode: *const inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(sizeof(dev->huge): ui->data_len ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ubifs_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn ubifs_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubifs_drop_inode(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubifs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn ubifs_dirty_inode(inode: *mut inode, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ubifs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubifs_show_options(s: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: c->mount_opts.unmount_mode ==) -> else {
    else if (c.mount_opts.unmount_mode == 1)
    seq_puts(s, ",norm_unmount");
    if (c.mount_opts.bulk_read == 2)
    seq_puts(s, ",bulk_read");
#[no_mangle]
pub unsafe extern "C" fn if(1: c->mount_opts.bulk_read ==) -> else {
    else if (c.mount_opts.bulk_read == 1)
    seq_puts(s, ",no_bulk_read");
    if (c.mount_opts.chk_data_crc == 2)
    seq_puts(s, ",chk_data_crc");
#[no_mangle]
pub unsafe extern "C" fn if(1: c->mount_opts.chk_data_crc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ubifs_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_constants_early(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bud_wbuf_callback(c: *mut ubifs_info, lnum: c_int, free: c_int, pad: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_constants_sb(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_constants_master(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn take_gc_lnum(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn alloc_wbufs(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn free_wbufs(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn free_orphans(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn free_buds(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn check_volume_empty(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ubifs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
    ...
    let mut is_remount: bool = (fc.purpose & FS_CONTEXT_FOR_RECONFIGURE);
    int opt;
...
//
#[no_mangle]
unsafe extern "C" fn ubifs_release_options(c: *mut ubifs_info) {
    static void ubifs_release_options(struct ubifs_info *c)
    {
    kfree(c.auth_key_name);
    c.auth_key_name = core::ptr::null_mut();
    kfree(c.auth_hash_name);
    c.auth_hash_name = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn destroy_journal(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn bu_init(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn check_free_space(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mount_ubifs(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ubifs_umount(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn ubifs_remount_rw(c: *mut ubifs_info) -> c_int {
...
//
    ...
    kfree(c.write_reserve_buf);
    c.write_reserve_buf = core::ptr::null_mut();
    vfree(c.ileb_buf);
    c.ileb_buf = core::ptr::null_mut();
    ubifs_lpt_free(c, 1);
    c.remounting_rw = 0;
    mutex_unlock(&c.umount_mutex);
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn ubifs_remount_ro(c: *mut ubifs_info) {
...
#[no_mangle]
unsafe extern "C" fn ubifs_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ubifs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubifs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
// ubifs_info owns auth strings now
    ctx.auth_key_name = core::ptr::null_mut();
    ctx.auth_hash_name = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn sb_test(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubifs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kill_ubifs_super(s: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn ubifs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn ubifs_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn inode_slab_ctor(obj: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ubifs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ubifs_exit() -> void __exit {
