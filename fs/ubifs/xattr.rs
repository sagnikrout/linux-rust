...
//
    ...
    let mut nm: fscrypt_name = { .disk_name = FSTR_INIT((char *)name, strlen(name))};
...
#[no_mangle]
unsafe extern "C" fn xattr_visible(name: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_listxattr(dentry: *mut dentry, buffer: *mut c_char, size: usize) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn ubifs_purge_xattrs(host: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubifs_xattr_remove(host: *mut inode, name: *const c_char) -> c_int {
