...
//
    ...
    int lnum, int offs)
    {
    let mut len: c_int = min(c.hash_len, 20);
    let mut cropped: c_int = len != c.hash_len;
...
//
    ...
    core::ptr::null_mut(), VERIFYING_UNSPECIFIED_SIGNATURE,
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_init_authentication(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __ubifs_exit_authentication(c: *mut ubifs_info) {
...
//
    ...
    let mut hmac_len: c_int = c.hmac_desc_len;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_hmac_wkm(c: *mut ubifs_info, hmac: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_hmac_zero(c: *mut ubifs_info, hmac: *const u8) -> bool {
