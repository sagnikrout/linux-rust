...
//
#[no_mangle]
unsafe extern "C" fn valuable(c: *mut ubifs_info, lprops: *const ubifs_lprops) -> c_int {
...
//
    ...
    let mut ret: c_int = LPT_SCAN_CONTINUE;
...
//
    ...
    int min_space, int pick_free)
    {
    let mut err: c_int = 0, sum, exclude_index = pick_free == 2 ? 1 : 0;
    const struct ubifs_lprops *lp = core::ptr::null_mut(), *idx_lp = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_find_free_leb_for_idx(c: *mut ubifs_info) -> c_int {
    int ubifs_find_free_leb_for_idx(struct ubifs_info *c)
    {
    const struct ubifs_lprops *lprops;
    let mut lnum: c_int = -1, err, flags;
    ubifs_get_lprops(c);
    lprops = ubifs_fast_find_empty(c);
    if (!lprops) {
...
#[no_mangle]
unsafe extern "C" fn cmp_dirty_idx(a: *const c_void, b: *const c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_save_dirty_idx_lnums(c: *mut ubifs_info) -> c_int {
...
// Sort it so that the dirtiest is now at the end
    ...
    cmp_dirty_idx, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn find_dirty_idx_leb(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_idx_gc_leb(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn find_dirtiest_idx_leb(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_find_dirty_idx_leb(c: *mut ubifs_info) -> c_int {
