...
// If the input data is small, do not even try to compress it
    ...
    acomp_request_set_callback(req, 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (in_folio)
...
//
    ...
    {
    let mut in_ptr: union ubifs_in_ptr = { .buf = in_buf };
...
//
    ...
    {
    let mut in_ptr: union ubifs_in_ptr = { .folio = in_folio };
...
//
#[no_mangle]
unsafe extern "C" fn compr_init(compr: *mut ubifs_compressor) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn compr_exit(compr: *mut ubifs_compressor) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_compressors_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_compressors_exit() {
