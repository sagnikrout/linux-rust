...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct replay_entry {
    pub lnum: c_int,
    pub offs: c_int,
    pub len: c_int,
    pub hash: [u8; UBIFS_HASH_ARR_SZ],
    pub deletion:1: c_uint,
    pub sqnum: c_ulonglong,
    pub list: list_head,
    pub key: union ubifs_key,
    union {
    pub nm: fscrypt_name,
    struct {
    pub old_size: loff_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bud_entry {
    pub list: list_head,
    pub bud: *mut ubifs_bud,
    pub sqnum: c_ulonglong,
    pub free: c_int,
    pub dirty: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn set_bud_lprops(c: *mut ubifs_info, b: *mut bud_entry) -> c_int {
    static int set_bud_lprops(struct ubifs_info *c, struct bud_entry *b)
    {
    const struct ubifs_lprops *lp;
    let mut err: c_int = 0, dirty;
    ubifs_get_lprops(c);
...
//
#[no_mangle]
unsafe extern "C" fn set_buds_lprops(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn trun_remove_range(c: *mut ubifs_info, r: *mut replay_entry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn inode_still_linked(c: *mut ubifs_info, rino: *mut replay_entry) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn apply_replay_entry(c: *mut ubifs_info, r: *mut replay_entry) -> c_int {
    ...
    case UBIFS_INO_KEY:
    {
    let mut inum: ino_t = key_inum(c, &r.key);
...
//
#[no_mangle]
unsafe extern "C" fn apply_replay_list(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn destroy_replay_list(c: *mut ubifs_info) {
...
//
    ...
    {
    let mut key_type: c_int = key_type_flash(c, dent.key);
    let mut nlen: c_int = le16_to_cpu(dent.nlen);
...
//
#[no_mangle]
unsafe extern "C" fn is_last_bud(c: *mut ubifs_info, bud: *mut ubifs_bud) -> c_int {
...
//
    ...
    if (err)
    return 0;
    let mut data: return = = 0xFFFFFFFF;
    }
...
//
#[no_mangle]
unsafe extern "C" fn replay_bud(c: *mut ubifs_info, b: *mut bud_entry) -> c_int {
    static int replay_bud(struct ubifs_info *c, struct bud_entry *b)
    {
    let mut is_last: c_int = is_last_bud(c, b.bud);
    let mut err: c_int = 0, used = 0, lnum = b.bud.lnum, offs = b.bud.start;
    int n_nodes, n = 0;
...
//
    ...
    let mut new_size: loff_t = le64_to_cpu(ino.size);
    ...
    let mut old_size: loff_t = le64_to_cpu(trun.old_size);
    let mut new_size: loff_t = le64_to_cpu(trun.new_size);
    union ubifs_key key;
...
//
#[no_mangle]
unsafe extern "C" fn replay_buds(c: *mut ubifs_info) -> c_int {
    static int replay_buds(struct ubifs_info *c)
    {
    struct bud_entry *b;
    int err;
    let mut prev_sqnum: c_ulonglong = 0;
    list_for_each_entry(b, &c.replay_buds, list) {
    err = replay_bud(c, b);
    if (err)
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn destroy_bud_list(c: *mut ubifs_info) {
...
//
#[no_mangle]
unsafe extern "C" fn validate_ref(c: *mut ubifs_info, ref: *const ubifs_ref_node) -> c_int {
    static int validate_ref(struct ubifs_info *c, const struct ubifs_ref_node *ref)
    {
    struct ubifs_bud *bud;
    let mut lnum: c_int = le32_to_cpu(ref.lnum);
    let mut offs: c_uint = le32_to_cpu(ref.offs);
    let mut jhead: c_uint = le32_to_cpu(ref.jhead);
//
...
//
#[no_mangle]
unsafe extern "C" fn replay_log_leb(c: *mut ubifs_info, lnum: c_int, offs: c_int, sbuf: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn take_ihead(c: *mut ubifs_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubifs_replay_journal(c: *mut ubifs_info) -> c_int {
