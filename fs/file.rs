...
#[no_mangle]
unsafe extern "C" fn __file_ref_put_badval(ref: *mut file_ref_t, cnt: c_ulong) -> noinline bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn __file_ref_put(ref: *mut file_ref_t, cnt: c_ulong) -> bool {
...
//
    ...
    let mut __read_mostly: unsigned int sysctl_nr_open = 1024*1024;
    let mut sysctl_nr_open_min: c_uint = BITS_PER_LONG;
// our min() is unusable in constant expressions ;-/

    unsigned int sysctl_nr_open_max =
    __const_min(INT_MAX, ~(size_t)0/sizeof(void *)) & -BITS_PER_LONG;
#[no_mangle]
unsafe extern "C" fn __free_fdtable(fdt: *mut fdtable) {
...
#[no_mangle]
unsafe extern "C" fn free_fdtable_rcu(rcu: *mut rcu_head) {
...
//
    ...
    {
    let mut nwords: c_uint = fdt_words(nfdt);
...
//
#[no_mangle]
unsafe extern "C" fn copy_fdtable(nfdt: *mut fdtable, ofdt: *mut fdtable) {
...
//
#[no_mangle]
unsafe extern "C" fn expand_fdtable(files: *mut files_struct, nr: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn expand_files(files: *mut files_struct, nr: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __set_open_fd(fd: c_uint, fdt: *mut fdtable, set: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn __clear_open_fd(fd: c_uint, fdt: *mut fdtable) {
...
#[no_mangle]
pub unsafe extern "C" fn fd_is_open(fd: c_uint, fdt: *const fdtable) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn sane_fdtable_size(fdt: *mut fdtable, punch_hole: *mut fd_range) -> c_uint {
    static unsigned int sane_fdtable_size(struct fdtable *fdt, struct fd_range *punch_hole)
    {
    let mut last: c_uint = find_last_bit(fdt.open_fds, fdt.max_fds);
    if (last == fdt.max_fds)
...
#[no_mangle]
pub unsafe extern "C" fn put_files_struct(files: *mut files_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn exit_files(tsk: *mut task_struct) {
    void exit_files(struct task_struct *tsk)
    {
    let mut files: *mut files_struct = tsk.files;
    if (files) {
    task_lock(tsk);
...
#[no_mangle]
unsafe extern "C" fn find_next_fd(fdt: *mut fdtable, start: c_uint) -> c_uint {
    static unsigned int find_next_fd(struct fdtable *fdt, unsigned int start)
    {
    unsigned int maxfd = fdt.max_fds; /* always multiple of BITS_PER_LONG */
    let mut max_fds_words: c_uint = maxfd / BITS_PER_LONG;
    let mut fds_word_idx: c_uint = start / BITS_PER_LONG;
    unsigned int bit;
//
...
//
#[no_mangle]
unsafe extern "C" fn alloc_fd(start: unsigned, end: unsigned, flags: unsigned) -> c_int {
...
//
    ...
    error = fd;
    VFS_BUG_ON(rcu_access_pointer(fdt.fd[fd]) != core::ptr::null_mut());
    out:
    spin_unlock(&files.file_lock);
    return error;
    }
#[no_mangle]
pub unsafe extern "C" fn __get_unused_fd_flags(flags: unsigned, nofile: c_ulong) -> c_int {
    int __get_unused_fd_flags(unsigned flags, unsigned long nofile)
    {
    return alloc_fd(0, nofile, flags);
    }
#[no_mangle]
pub unsafe extern "C" fn get_unused_fd_flags(flags: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __put_unused_fd(files: *mut files_struct, fd: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn put_unused_fd(fd: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn fd_install_slowpath(fd: c_uint, file: *mut file) -> void noinline {
...
//
#[no_mangle]
pub unsafe extern "C" fn fd_install(fd: c_uint, file: *mut file) {
...
//
    ...
    if (file) {
    rcu_assign_pointer(fdt.fd[fd], core::ptr::null_mut());
    __put_unused_fd(files, fd);
    }
    return file;
    }
#[no_mangle]
pub unsafe extern "C" fn close_fd(fd: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn last_fd(fdt: *mut fdtable) -> unsigned {
...
//
    ...
    struct files_struct *cur_fds = me.files, *fds = core::ptr::null_mut();
    if (flags & ~(CLOSE_RANGE_UNSHARE | CLOSE_RANGE_CLOEXEC))
    return -EINVAL;
    if (fd > max_fd)
    return -EINVAL;
    if ((flags & CLOSE_RANGE_UNSHARE) && atomic_read(&cur_fds.count) > 1) {
    let mut range: fd_range = {fd, max_fd}, *punch_hole = &range;
//
...
#[no_mangle]
pub unsafe extern "C" fn do_close_on_exec(files: *mut files_struct) {
...
// exec unshares first
    ...
    for (i = 0; ; i++) {
    unsigned long set;
    let mut fd: unsigned = i * BITS_PER_LONG;
    fdt = files_fdtable(files);
    if (fd >= fdt.max_fds)
    break;
...
//
    ...
    {
    struct file *file = core::ptr::null_mut();
    task_lock(task);
    if (task.files)
...
//
#[no_mangle]
pub unsafe extern "C" fn __fget_light(fd: c_uint, mask: fmode_t) -> fd {
...
#[no_mangle]
pub unsafe extern "C" fn fdget(fd: c_uint) -> fd {
    ...
    EXPORT_SYMBOL(fdget);
#[no_mangle]
pub unsafe extern "C" fn fdget_raw(fd: c_uint) -> fd {
...
//
#[no_mangle]
pub unsafe extern "C" fn file_needs_f_pos_lock(file: *mut file) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn file_seek_cur_needs_f_lock(file: *mut file) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fdget_pos(fd: c_uint) -> fd {
    struct fd fdget_pos(unsigned int fd)
    {
    let mut f: fd = fdget(fd);
...
#[no_mangle]
pub unsafe extern "C" fn __f_unlock_pos(f: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_close_on_exec(fd: c_uint, flag: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn get_close_on_exec(fd: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn replace_fd(fd: unsigned, file: *mut file, flags: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn receive_fd(file: *mut file, ufd: *mut int __user, o_flags: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn receive_fd_replace(new_fd: c_int, file: *mut file, o_flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksys_dup3(oldfd: c_uint, newfd: c_uint, flags: c_int) -> c_int {
    static int ksys_dup3(unsigned int oldfd, unsigned int newfd, int flags)
    {
    let mut err: c_int = -EBADF;
    struct file *file;
    struct files_struct *files = current.files;
...
#[no_mangle]
pub unsafe extern "C" fn f_dupfd(from: c_uint, file: *mut file, flags: unsigned) -> c_int {
    int f_dupfd(unsigned int from, struct file *file, unsigned flags)
    {
    let mut nofile: c_ulong = rlimit(RLIMIT_NOFILE);
    int err;
    if (from >= nofile)
    return -EINVAL;
