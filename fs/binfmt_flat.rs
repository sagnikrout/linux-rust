...
pub const RELOC_FAILED: c_uint = 0xff00ff01		/* Relocation incorrect somewhere */;
pub const UNLOADED_LIB: c_uint = 0x7ff000ff		/* Placeholder for unused library */;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lib_info {
    struct {
    pub /: *mut *mut unsigned long start_code; / Start of text segment,
    pub /: *mut *mut unsigned long start_data; / Start of data segment,
    pub /: *mut *mut unsigned long start_brk; / End of data segment,
    pub /: *mut *mut unsigned long text_len; / Length of text segment,
    pub /: *mut *mut unsigned long entry; / Start address for this module,
    pub /: *mut *mut unsigned long build_date; / When this one was compiled,
    pub /: *mut *mut bool loaded; / Has this library been loaded?,
    pub lib_list: [}; MAX_SHARED_LIBS],
}
...
//
#[no_mangle]
unsafe extern "C" fn create_flat_tables(bprm: *mut linux_binprm, arg_start: c_ulong) -> c_int {
...
pub const LBUFSIZE: c_int = 4000;
// gzip flag byte
pub const ASCII_FLAG: c_uint = 0x01 /* bit 0 set: file probably ASCII text */;
pub const CONTINUATION: c_uint = 0x02 /* bit 1 set: continuation of multi-part gzip file */;
pub const EXTRA_FIELD: c_uint = 0x04 /* bit 2 set: extra field present */;
pub const ORIG_NAME: c_uint = 0x08 /* bit 3 set: original file name present */;
pub const COMMENT: c_uint = 0x10 /* bit 4 set: file comment present */;
pub const ENCRYPTED: c_uint = 0x20 /* bit 5 set: file is encrypted */;
pub const RESERVED: c_uint = 0xC0 /* bit 6,7:   reserved */;
...
#[no_mangle]
unsafe extern "C" fn old_reloc(rl: c_ulong) {
...
//
    ...
    rp += 4;
#[no_mangle]
pub unsafe extern "C" fn if(0xffffffff: rp_val0 ==) -> else {
...
//
    ...
    len = PAGE_ALIGN(len);
    realdatastart = vm_mmap(core::ptr::null_mut(), 0, len,
    ...
    len = PAGE_ALIGN(len);
    textpos = vm_mmap(core::ptr::null_mut(), 0, len,
...
//
    let mut unz_text_len: c_long = text_len - sizeof(struct flat_hdr);
    let mut unz_len: c_long = unz_text_len + full_data;
...
//
#[no_mangle]
unsafe extern "C" fn init_flat_binfmt() -> int __init {
