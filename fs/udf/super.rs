...
pub const VSD_FIRST_SECTOR_OFFSET: c_int = 32768;
pub const VSD_MAX_SECTOR_OFFSET: c_uint = 0x800000;
//
...
//
pub const UDF_MAX_TD_NESTING: c_int = 64;
pub const UDF_MAX_LVID_NESTING: c_int = 1000;
...
// UDF filesystem type
#[no_mangle]
unsafe extern "C" fn udf_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_free_in_core_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn udf_init_options(fc: *mut fs_context, uopt: *mut udf_options) {
    ...
    uopt.nls_map = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn udf_init_fs_context(fc: *mut fs_context) -> c_int {
    static int udf_init_fs_context(struct fs_context *fc)
    {
...
#[no_mangle]
unsafe extern "C" fn udf_free_fc(fc: *mut fs_context) {
    static void udf_free_fc(struct fs_context *fc)
    {
...
#[no_mangle]
unsafe extern "C" fn init_udf_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_udf_fs() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn udf_sb_alloc_partition_maps(sb: *mut super_block, count: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_sb_free_bitmap(bitmap: *mut udf_bitmap) {
    static void udf_sb_free_bitmap(struct udf_bitmap *bitmap)
    {
    int i;
    let mut nr_groups: c_int = bitmap.s_nr_groups;
...
#[no_mangle]
unsafe extern "C" fn udf_free_partition(map: *mut udf_part_map) {
...
#[no_mangle]
pub unsafe extern "C" fn if(UDF_METADATA_MAP25: map->s_partition_type ==) -> else {
    mdata = &map.s_type_specific.s_metadata;
    iput(mdata.s_metadata_fe);
    mdata.s_metadata_fe = core::ptr::null_mut();
    iput(mdata.s_mirror_fe);
    mdata.s_mirror_fe = core::ptr::null_mut();
    iput(mdata.s_bitmap_fe);
    mdata.s_bitmap_fe = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn udf_sb_free_partitions(sb: *mut super_block) {
    ...
    sbi.s_partmaps = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn udf_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
    static int udf_parse_param(struct fs_context *fc, struct fs_parameter *param)
    {
    unsigned int uv;
    unsigned int n;
    ...
    int token;
    let mut remount: bool = (fc.purpose & FS_CONTEXT_FOR_RECONFIGURE);
    ...
    let mut gid: kgid_t = make_kgid(current_user_ns(), uv);
    if (!gid_valid(gid))
    return -EINVAL;
    uopt.gid = gid;
...
// this option is superseded by gid=<number>
    ...
    case Opt_uid:
    if (kstrtoint(param.string, 10, &uv) == 0) {
    let mut uid: kuid_t = make_kuid(current_user_ns(), uv);
    if (!uid_valid(uid))
    return -EINVAL;
    uopt.uid = uid;
...
#[no_mangle]
unsafe extern "C" fn udf_reconfigure(fc: *mut fs_context) -> c_int {
    static int udf_reconfigure(struct fs_context *fc)
    {
    struct udf_options *uopt = fc.fs_private;
    struct super_block *sb = fc.root.d_sb;
...
//
#[no_mangle]
unsafe extern "C" fn identify_vsd(vsd: *const volStructDesc) -> c_int {
    ...
    ; /* ret = 0 */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !memcmp(vsd->stdIdent, _arg: VSD_STD_ID_NSR02, _arg: VSD_STD_ID_LEN)) -> else {
    else if (!memcmp(vsd.stdIdent, VSD_STD_ID_NSR02, VSD_STD_ID_LEN))
    ret = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !memcmp(vsd->stdIdent, _arg: VSD_STD_ID_NSR03, _arg: VSD_STD_ID_LEN)) -> else {
    else if (!memcmp(vsd.stdIdent, VSD_STD_ID_NSR03, VSD_STD_ID_LEN))
    ret = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !memcmp(vsd->stdIdent, _arg: VSD_STD_ID_BOOT2, _arg: VSD_STD_ID_LEN)) -> else {
    else if (!memcmp(vsd.stdIdent, VSD_STD_ID_BOOT2, VSD_STD_ID_LEN))
    ; /* ret = 0 */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !memcmp(vsd->stdIdent, _arg: VSD_STD_ID_CDW02, _arg: VSD_STD_ID_LEN)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn udf_check_vsd(sb: *mut super_block) -> c_int {
    static int udf_check_vsd(struct super_block *sb)
    {
    struct volStructDesc *vsd = core::ptr::null_mut();
    let mut sector: loff_t = VSD_FIRST_SECTOR_OFFSET;
    int sectorsize;
...
// Ignore unknown IDs...
    ...
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(VSD_FIRST_SECTOR_OFFSET: !bh && sector - session_offset ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn udf_load_pvoldesc(sb: *mut super_block, block: sector_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udf_compute_nr_groups(sb: *mut super_block, partition: u32) -> c_int {
    ...
    let mut nr_groups: c_int = udf_compute_nr_groups(sb, index);
...
#[no_mangle]
unsafe extern "C" fn udf_load_vat(sb: *mut super_block, p_index: c_int, type1_index: c_int) -> c_int {
    ...
    let mut blocks: sector_t = sb_bdev_nr_blocks(sb);
...
//
#[no_mangle]
unsafe extern "C" fn udf_load_partdesc(sb: *mut super_block, block: sector_t) -> c_int {
...
//
    type1_idx = i;
    map = core::ptr::null_mut(); /* supress 'maybe used uninitialized' warning */
    for (i = 0; i < sbi.s_partitions; i++) {
    map = &sbi.s_partmaps[i];
    if (map.s_partition_num == partitionNumber &&
...
// In case loading failed, we handle cleanup in udf_fill_super
    ...
    map.s_partition_func = core::ptr::null_mut();
    } else if (type == 2) {
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(sb->s_blocksize: u32) >) -> *mut *mut 2  parts {
...
//
#[no_mangle]
unsafe extern "C" fn udf_load_logicalvolint(sb: *mut super_block, loc: kernel_extent_ad) {
    ...
    struct udf_sb_info *sbi = UDF_SB(sb);
    struct logicalVolIntegrityDesc *lvid;
    let mut indirections: c_int = 0;
    while (++indirections <= UDF_MAX_LVID_NESTING) {
    final_bh = core::ptr::null_mut();
    ...
    brelse(sbi.s_lvid_bh);
    sbi.s_lvid_bh = core::ptr::null_mut();
    }
//
// Step for reallocation of table of partition descriptor sequence numbers.
// Must be power of 2.
//
pub const PART_DESC_ALLOC_STEP: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct part_desc_seq_scan_data {
    pub rec: udf_vds_record,
    pub partnum: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct desc_seq_scan_data {
    pub vds: [udf_vds_record; VDS_POS_LENGTH],
    pub size_part_descs: c_uint,
    pub num_part_descs: c_uint,
    pub part_descs_loc: *mut part_desc_seq_scan_data,
}
...
#[no_mangle]
unsafe extern "C" fn udf_mark_buffer_dirty(bh: *mut buffer_head) {
...
#[no_mangle]
unsafe extern "C" fn udf_finalize_lvid(lvid: *mut logicalVolIntegrityDesc) {
...
#[no_mangle]
unsafe extern "C" fn udf_open_lvid(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn udf_close_lvid(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn lvid_get_unique_id(sb: *mut super_block) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn udf_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    static int udf_fill_super(struct super_block *sb, struct fs_context *fc)
    {
...
#[no_mangle]
unsafe extern "C" fn udf_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn udf_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
    buf.f_files = (lvidiu != core::ptr::null_mut() ? (le32_to_cpu(lvidiu.numFiles) +
    ...
    {
    struct buffer_head *bh = core::ptr::null_mut();
    let mut accum: c_uint = 0;
    int index;
    let mut block: udf_pblk_t = 0, newblock;
    struct kernel_lb_addr loc;
    uint32_t bytes;
    uint8_t *ptr;
    uint16_t ident;
    ...
    while (bytes > 0) {
    let mut cur_bytes: u32 = min_t(u32, bytes, sb.s_blocksize - index);
...
#[no_mangle]
unsafe extern "C" fn udf_count_free(sb: *mut super_block) -> c_uint {
    static unsigned int udf_count_free(struct super_block *sb)
    {
    let mut accum: c_uint = 0;
    struct udf_sb_info *sbi = UDF_SB(sb);
    struct udf_part_map *map;
    let mut part: c_uint = sbi.s_partition;
    let mut ptype: c_int = sbi.s_partmaps[part].s_partition_type;
