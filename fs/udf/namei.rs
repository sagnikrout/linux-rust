...
//
    ...
    {
    int flen;
    unsigned char *fname = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn udf_expand_dir_adinicb(inode: *mut inode, block: *mut udf_pblk_t) -> c_int {
    static int udf_expand_dir_adinicb(struct inode *inode, udf_pblk_t *block)
    {
    udf_pblk_t newblock;
    struct buffer_head *dbh = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn udf_fiiter_delete_entry(iter: *mut udf_fileident_iter) {
    ...
    udf_fiiter_write_fi(iter, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn udf_add_fid_counter(sb: *mut super_block, dir: bool, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn udf_add_nondir(dentry: *mut dentry, inode: *mut inode) -> c_int {
...
// (__le32 *)((struct allocDescImpUse *)iter.fi.icb.impUse)->impUse =
    ...
    err = udf_fiiter_add_entry(inode, core::ptr::null_mut(), &iter);
    if (err) {
    clear_nlink(inode);
    discard_new_inode(inode);
    return ERR_PTR(err);
...
#[no_mangle]
unsafe extern "C" fn empty_dir(dir: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
    ...
    int err;
    udf_pblk_t block;
    unsigned char *name = core::ptr::null_mut();
    int namelen;
    struct udf_inode_info *iinfo;
    struct super_block *sb = dir.i_sb;
...
//
    ...
    let mut has_diriter: bool = false, is_dir = false;
    int retval;
    struct kernel_lb_addr tloc;
...
//
    ...
    udf_fiiter_write_fi(&niter, core::ptr::null_mut());
    udf_fiiter_release(&niter);
//
...
//
    ...
    udf_fiiter_write_fi(&diriter, core::ptr::null_mut());
    ...
    struct inode *parent)
    {
    let mut len: c_int = *lenp;
    let mut location: kernel_lb_addr = UDF_I(inode).i_location;
    struct fid *fid = (struct fid *)fh;
    let mut type: c_int = FILEID_UDF_WITHOUT_PARENT;
    if (parent && (len < 5)) {
// lenp = 5;
