...
#[no_mangle]
unsafe extern "C" fn udf_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_dir_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_dir_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_dir_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
