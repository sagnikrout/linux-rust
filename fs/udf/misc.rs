...
//
    ...
    {
    uint8_t *ea = core::ptr::null_mut(), *ad = core::ptr::null_mut();
    int offset;
    uint16_t crclen;
...
#[no_mangle]
pub unsafe extern "C" fn if(65536: type <) -> else {
    else if (type < 65536)
...
#[no_mangle]
pub unsafe extern "C" fn udf_update_tag(data: *mut c_char, length: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn udf_tag_checksum(t: *const tag) -> u8 {
