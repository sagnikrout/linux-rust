...
pub const PLANE_SIZE: c_uint = 0x10000;
pub const UNICODE_MAX: c_uint = 0x10ffff;
pub const SURROGATE_MASK: c_uint = 0xfffff800;
pub const SURROGATE_PAIR: c_uint = 0x0000d800;
pub const SURROGATE_LOW: c_uint = 0x00000400;
pub const SURROGATE_CHAR_BITS: c_int = 10;

pub const EXT_SIZE: c_int = 5;
// Number of chars we need to store generated CRC to make filename unique
pub const CRC_LEN: c_int = 5;
    static unicode_t get_utf16_char(const uint8_t *str_i, int str_i_max_len,
    int str_i_idx, int u_ch, unicode_t *ret)
    {
    unicode_t c;
    let mut start_idx: c_int = str_i_idx;
...
// str_o_idx += len;
#[no_mangle]
pub unsafe extern "C" fn if(-ENAMETOOLONG: len ==) -> else {
// needsCRC = 1;
    gotch = 0;
    } else {
