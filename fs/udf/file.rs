...
#[no_mangle]
unsafe extern "C" fn udf_file_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn udf_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn udf_release_file(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udf_file_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
