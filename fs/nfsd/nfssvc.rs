...
//
    ...
    let mut nfsd_th_cnt: core::sync::atomic::AtomicI32 = ATOMIC_INIT(0);
...
pub const NFSD_ACL_MINVERS: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_support_version(vers: c_int) -> bool {
    bool nfsd_support_version(int vers)
    {
    if (vers >= NFSD_MINVERS && vers <= NFSD_MAXVERS)
    return nfsd_version[vers] != core::ptr::null_mut();
    return false;
    }
#[no_mangle]
pub unsafe extern "C" fn nfsd_vers(nn: *mut nfsd_net, vers: c_int, change: enum vers_op) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_minorversion(nn: *mut nfsd_net, minorversion: u32, change: enum vers_op) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_net_try_get(__must_hold(rcu: *mut *mut net net)) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_net_put(__must_hold(rcu: *mut *mut net net)) {
...
#[no_mangle]
unsafe extern "C" fn nfsd_net_done(ref: *mut percpu_ref) {
...
#[no_mangle]
unsafe extern "C" fn nfsd_net_free(ref: *mut percpu_ref) {
...
//
pub const NFSD_MAXSERVS: c_int = 8192;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nrthreads(net: *mut net) -> c_int {
...
// nfsd_mutex keeps nn->nfsd_serv valid across the read.
    ...
    let mut nfsd_users: static int = 0;
#[no_mangle]
unsafe extern "C" fn nfsd_startup_generic() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfsd_shutdown_generic() {
...
#[no_mangle]
unsafe extern "C" fn nfsd_needs_lockd(nn: *mut nfsd_net) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_copy_write_verifier(verf[2]: __be32, nn: *mut nfsd_net) {
...
#[no_mangle]
unsafe extern "C" fn nfsd_reset_write_verifier_locked(nn: *mut nfsd_net) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_reset_write_verifier(nn: *mut nfsd_net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfsd_startup_net(net: *mut net, cred: *const cred) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfsd_shutdown_net(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_reset_versions(nn: *mut nfsd_net) {
...
#[no_mangle]
unsafe extern "C" fn nfsd_get_default_max_blksize() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_shutdown_threads(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_create_serv(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_nrpools(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_get_nrthreads(n: c_int, nthreads: *mut c_int, net: *mut net) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_set_nrthreads(n: c_int, nthreads: *mut c_int, net: *mut net) -> c_int {
    ...
    struct nfsd_net *nn = net_generic(net, nfsd_net_id);
    lockdep_assert_held(&nfsd_mutex);
    if (nn.nfsd_serv == core::ptr::null_mut() || n <= 0)
    return 0;
...
// total too large: scale down requested numbers
    for (i = 0; i < n && tot > 0; i++) {
    let mut new: c_int = nthreads[i] * NFSD_MAXSERVS / tot;
    tot -= (nthreads[i] - new);
    nthreads[i] = new;
    }
    for (i = 0; i < n && tot > 0; i++) {
...
//
    ...
    return nfsd_acl_version[vers] != core::ptr::null_mut();
    return false;
    }
    static int
...
//
    ...
    struct nfsd_net *nn = net_generic(net, nfsd_net_id);
    let mut ntli: nfsd_thread_local_info = { };
    let mut have_mutex: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn nfsd_status_counter_set_idle(rqstp: *mut svc_rqst) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_dispatch(rqstp: *mut svc_rqst) -> c_int {
...
// statp = rpc_garbage_args;
    return 1;
    out_update_drop:
    nfsd_cache_update(rqstp, rp, RC_NOCACHE, core::ptr::null_mut());
    out_dropit:
    nfsd_status_counter_set_idle(rqstp);
    return 0;
    out_encode_err:
...
//
#[no_mangle]
pub unsafe extern "C" fn nfssvc_decode_voidarg(rqstp: *mut svc_rqst, xdr: *mut xdr_stream) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfssvc_encode_voidres(rqstp: *mut svc_rqst, xdr: *mut xdr_stream) -> bool {
