...
#[no_mangle]
unsafe extern "C" fn nfsctl_transaction_write(file: *mut file, buf: *const char __user, size: usize, pos: *mut loff_t) -> isize {
    static ssize_t nfsctl_transaction_write(struct file *file, const char __user *buf, size_t size, loff_t *pos)
    {
    let mut ino: ino_t = file_inode(file).i_ino;
    char *data;
    ssize_t rv;
...
#[no_mangle]
unsafe extern "C" fn nfsctl_transaction_read(file: *mut file, buf: *mut char __user, size: usize, pos: *mut loff_t) -> isize {
...
// state information
//
    let mut rv: isize = nfsctl_transaction_write(file, buf, 0, pos);
    if (rv < 0)
    return rv;
    }
...
#[no_mangle]
unsafe extern "C" fn exports_net_open(net: *mut net, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exports_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exports_nfsd_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn export_features_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfsd_pool_stats_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn write_unlock_ip(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_unlock_ip(struct file *file, char *buf, size_t size)
    {
    struct sockaddr_storage address;
    struct sockaddr *sap = (struct sockaddr *)&address;
    let mut salen: usize = sizeof(address);
    char *fo_path;
...
//
#[no_mangle]
unsafe extern "C" fn write_unlock_fs(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_unlock_fs(struct file *file, char *buf, size_t size)
    {
    struct path path;
    char *fo_path;
...
//
#[no_mangle]
unsafe extern "C" fn write_filehandle(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_filehandle(struct file *file, char *buf, size_t size)
    {
    char *dname, *path;
    int maxsize;
...
//
#[no_mangle]
unsafe extern "C" fn write_threads(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_threads(struct file *file, char *buf, size_t size)
    {
    char *mesg = buf;
    int rv;
    ...
    mutex_lock(&nfsd_mutex);
    if (newthreads > 0 || nn.nfsd_serv != core::ptr::null_mut())
    rv = nfsd_svc(1, &newthreads, net, file.f_cred, core::ptr::null_mut());
    else
    rv = 0;
    mutex_unlock(&nfsd_mutex);
    if (rv < 0)
...
//
#[no_mangle]
unsafe extern "C" fn write_pool_threads(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_pool_threads(struct file *file, char *buf, size_t size)
    {
...
//
    ...
    let mut supported: bool = !!nfsd_vers(nn, vers, NFSD_TEST);
    if (vers == 4 && minor >= 0 &&
...
#[no_mangle]
unsafe extern "C" fn __write_versions(file: *mut file, buf: *mut c_char, size: usize) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn write_versions(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_versions(struct file *file, char *buf, size_t size)
    {
    ssize_t rv;
    mutex_lock(&nfsd_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn __write_ports_names(buf: *mut c_char, net: *mut net) -> isize {
    static ssize_t __write_ports_names(char *buf, struct net *net)
    {
    struct nfsd_net *nn = net_generic(net, nfsd_net_id);
    if (nn.nfsd_serv == core::ptr::null_mut())
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn __write_ports_addfd(buf: *mut c_char, net: *mut net, cred: *const cred) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn __write_ports_addxprt(buf: *mut c_char, net: *mut net, cred: *const cred) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn write_ports(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_ports(struct file *file, char *buf, size_t size)
    {
    ssize_t rv;
    mutex_lock(&nfsd_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn write_maxblksize(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_maxblksize(struct file *file, char *buf, size_t size)
    {
    char *mesg = buf;
    struct nfsd_net *nn = net_generic(netns(file), nfsd_net_id);
    if (size > 0) {
    int bsize;
    let mut rv: c_int = get_int(&mesg, &bsize);
    if (rv)
    return rv;
...
//
#[no_mangle]
unsafe extern "C" fn write_leasetime(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_leasetime(struct file *file, char *buf, size_t size)
    {
    struct nfsd_net *nn = net_generic(netns(file), nfsd_net_id);
...
//
#[no_mangle]
unsafe extern "C" fn write_gracetime(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_gracetime(struct file *file, char *buf, size_t size)
    {
    struct nfsd_net *nn = net_generic(netns(file), nfsd_net_id);
...
//
#[no_mangle]
unsafe extern "C" fn write_recoverydir(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_recoverydir(struct file *file, char *buf, size_t size)
    {
    ssize_t rv;
    struct nfsd_net *nn = net_generic(netns(file), nfsd_net_id);
...
//
#[no_mangle]
unsafe extern "C" fn write_v4_end_grace(file: *mut file, buf: *mut c_char, size: usize) -> isize {
    static ssize_t write_v4_end_grace(struct file *file, char *buf, size_t size)
    {
    struct nfsd_net *nn = net_generic(netns(file), nfsd_net_id);
    if (size > 0) {
...
#[no_mangle]
unsafe extern "C" fn clear_ncl(dentry: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_client_rmdir(dentry: *mut dentry) {
    void nfsd_client_rmdir(struct dentry *dentry)
    {
    simple_recursive_removal(dentry, clear_ncl);
    }
#[no_mangle]
unsafe extern "C" fn nfsd_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
// last one */ {""}
    ...
    dentry = nfsd_mkdir(sb.s_root, core::ptr::null_mut(), "clients");
    if (IS_ERR(dentry))
    return PTR_ERR(dentry);
...
#[no_mangle]
unsafe extern "C" fn nfsd_fs_get_tree(fc: *mut fs_context) -> c_int {
    static int nfsd_fs_get_tree(struct fs_context *fc)
    {
    return get_tree_keyed(fc, nfsd_fill_super, get_net(fc.net_ns));
    }
#[no_mangle]
unsafe extern "C" fn nfsd_fs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn nfsd_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfsd_umount(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn exports_proc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_proc_exports_entry() -> c_int {
    static int create_proc_exports_entry(void)
    {
    struct proc_dir_entry *entry;
    entry = proc_mkdir("fs/nfs", core::ptr::null_mut());
    if (!entry)
    return -ENOMEM;
    entry = proc_create("exports", 0, entry, &exports_proc_ops);
    if (!entry) {
    remove_proc_entry("fs/nfs", core::ptr::null_mut());
    return -ENOMEM;
    }
    return 0;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfsd_genl_rqstp {
    pub rq_daddr: sockaddr_storage,
    pub rq_saddr: sockaddr_storage,
    pub rq_flags: c_ulong,
...
//
    ...
    rq_all) {
    let mut genl_rqstp: nfsd_genl_rqstp = {};
...
//
#[no_mangle]
unsafe extern "C" fn nfsd_nl_fh_key_set(attr: *const nlattr, nn: *mut nfsd_net) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_threads_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    const char *scope = core::ptr::null_mut();
...
// count number of SERVER_THREADS values
    ...
    if (attr) {
    let mut gracetime: u32 = nla_get_u32(attr);
    ...
    if (attr) {
    let mut leasetime: u32 = nla_get_u32(attr);
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_threads_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_version_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_version_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfsd_nl_validate_listeners(info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_listener_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_listener_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_pool_mode_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_pool_mode_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_cache_flush_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
    ...
    let mut cnt: u64 = percpu_counter_sum_positive(&nn.cb_counter[op]);
    if (!cnt)
    continue;
...
//
    ...
    let mut section: c_int = cb.args[0];
    let mut idx: c_int = cb.args[1];
    void *hdr;
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_cache_notify(cd: *mut cache_detail, h: *mut cache_head, cache_type: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_unlock_ip_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_nl_unlock_export_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfsd_net_init(net: *mut net) -> __net_init int {
    ...
    nn.nfsd_serv = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn nfsd_net_pre_exit(net: *mut net) -> __net_exit void {
...
//
#[no_mangle]
unsafe extern "C" fn nfsd_net_exit(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn init_nfsd() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_nfsd() -> void __exit {
    static void __exit exit_nfsd(void)
    {
    remove_proc_entry("fs/nfs/exports", core::ptr::null_mut());
    remove_proc_entry("fs/nfs", core::ptr::null_mut());
    genl_unregister_family(&nfsd_nl_family);
    unregister_filesystem(&nfsd_fs_type);
    nfsd4_destroy_laundry_wq();
