...
// p = status;
    ...
    {
    let mut size: u32 = fhp.fh_handle.fh_size;
    __be32 *p;
...
// symlink_data
    ...
    return args.first.iov_base != core::ptr::null_mut();
    }
    bool
...
// no more entries
    ...
    let mut rv: __be32 = nfserr_noent;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfs3svc_encode_cookie3(resp: *mut nfsd3_readdirres, offset: u64) {
