...
//
    ...
    let mut type: c_int = stat.mode & S_IFMT;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfssvc_encode_nfscookie(resp: *mut nfsd_readdirres, offset: u32) {
    void nfssvc_encode_nfscookie(struct nfsd_readdirres *resp, u32 offset)
    {
    let mut cookie: __be32 = cpu_to_be32(offset);
...
//
    ...
    common);
    let mut starting_length: c_uint = resp.dirlist.len;
...
//
#[no_mangle]
pub unsafe extern "C" fn nfssvc_release_attrstat(rqstp: *mut svc_rqst) {
...
#[no_mangle]
pub unsafe extern "C" fn nfssvc_release_diropres(rqstp: *mut svc_rqst) {
...
#[no_mangle]
pub unsafe extern "C" fn nfssvc_release_readres(rqstp: *mut svc_rqst) {
