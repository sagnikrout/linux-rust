...
//
#[no_mangle]
unsafe extern "C" fn nfsacld_proc_getacl(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nfsacld_proc_setacl(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nfsacld_proc_getattr(rqstp: *mut svc_rqst) -> __be32 {
...
//
#[no_mangle]
unsafe extern "C" fn nfsacld_proc_access(rqstp: *mut svc_rqst) -> __be32 {
    ...
    resp.status = nfsd_access(rqstp, &resp.fh, &resp.access, core::ptr::null_mut());
    if (resp.status != nfs_ok)
    goto out;
    resp.status = fh_getattr(&resp.fh, &resp.stat);
    out:
...
//
#[no_mangle]
unsafe extern "C" fn nfsaclsvc_release_getacl(rqstp: *mut svc_rqst) {
...
#[no_mangle]
unsafe extern "C" fn nfsaclsvc_release_access(rqstp: *mut svc_rqst) {
...
#[no_mangle]
unsafe extern "C" fn nfsaclsvc_release_setacl(rqstp: *mut svc_rqst) {
