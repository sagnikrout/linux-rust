...
//
    ...
    let mut offset: u64 = seg.offset, length = seg.length;
...
#[no_mangle]
pub unsafe extern "C" fn nfsd4_scsi_fence_set(clp: *mut nfs4_client, device: dev_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd4_scsi_fence_clear(clp: *mut nfs4_client, device: dev_t) {
...
pub const NFSD_MDS_PR_KEY: c_uint = 0x0100000000000000ULL;
//
// We use the client ID as a unique key for the reservations.
// This allows us to easily fence a client when recalls fail.
//
#[no_mangle]
unsafe extern "C" fn nfsd4_scsi_pr_key(clp: *mut nfs4_client) -> u64 {
    ...
    let mut type: u8 = designator_types[i];
    ...
    out_free_dev:
    kfree(dev);
    gdp.gd_device = core::ptr::null_mut();
    return ret;
    }
    static __be32
