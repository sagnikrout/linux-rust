...
//
#[no_mangle]
unsafe extern "C" fn nfsd3_time_in_range(iap: *const iattr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfsd3_map_status(status: __be32) -> __be32 {
...
//
    ...
    const struct timespec64 *guardtime = core::ptr::null_mut();
...
//
    ...
    if (status != nfs_ok)
    goto out;
    host_err = vfs_create(&nop_mnt_idmap, child, iap.ia_mode, core::ptr::null_mut());
    if (host_err < 0) {
...
//
    ...
    let mut max_blocksize: u32 = svc_max_payload(rqstp);
