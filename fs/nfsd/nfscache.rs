...
//
pub const TARGET_BUCKET_SIZE: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfsd_drc_bucket {
    pub rb_head: rb_root,
...
//
    ...
    {
    unsigned int limit;
    let mut low_pages: c_ulong = totalram_pages() - totalhigh_pages();
...
#[no_mangle]
unsafe extern "C" fn nfsd_cacherep_free(rp: *mut nfsd_cacherep) {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_drc_slab_create() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_drc_slab_free() {
    void nfsd_drc_slab_free(void)
    {
    kmem_cache_destroy(drc_slab);
    }
#[no_mangle]
pub unsafe extern "C" fn nfsd_reply_cache_init(nn: *mut nfsd_net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfsd_reply_cache_shutdown(nn: *mut nfsd_net) {
    ...
    kvfree(nn.drc_hashtbl);
    nn.drc_hashtbl = core::ptr::null_mut();
    nn.drc_hashsize = 0;
    }
    static void
    ...
    {
    let mut hash: c_uint = hash_32(( u32)xid, nn.maskbits);
...
//
    ...
    {
    let mut expiry: c_ulong = jiffies - RC_EXPIRE;
...
//
    ...
    let mut type: c_int = ntli.ntli_cachetype;
    LIST_HEAD(dispose);
    let mut rtn: c_int = RC_DOIT;
    if (type == RC_NOCACHE) {
...
// We found a matching entry which is either in progress or done.
    nfsd_reply_cache_free_locked(core::ptr::null_mut(), rp, nn);
...
//
#[no_mangle]
pub unsafe extern "C" fn nfsd_reply_cache_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
