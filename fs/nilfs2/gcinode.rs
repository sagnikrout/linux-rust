...
#[no_mangle]
pub unsafe extern "C" fn nilfs_gccache_wait_and_mark_dirty(bh: *mut buffer_head) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_init_gcinode(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nilfs_remove_all_gcinodes(nilfs: *mut the_nilfs) {
