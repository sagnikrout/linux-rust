...
#[no_mangle]
pub unsafe extern "C" fn nilfs_add_nondir(dentry: *mut dentry, inode: *mut inode) -> c_int {
    static inline int nilfs_add_nondir(struct dentry *dentry, struct inode *inode)
    {
    let mut err: c_int = nilfs_add_link(dentry, inode);
    if (!err) {
...
//
    ...
    let mut l: c_uint = strlen(symname) + 1;
    struct inode *inode;
    int err;
    if (l > sb.s_blocksize)
    return -ENAMETOOLONG;
...
#[no_mangle]
unsafe extern "C" fn nilfs_do_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
    ...
    struct nilfs_dir_entry *dir_de = core::ptr::null_mut();
