...
#[no_mangle]
pub unsafe extern "C" fn __nilfs_msg(sb: *mut super_block, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn nilfs_set_error(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn nilfs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn nilfs_sync_super(sb: *mut super_block, flag: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_commit_super(sb: *mut super_block, flag: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nilfs_cleanup_super(sb: *mut super_block) -> c_int {
    int nilfs_cleanup_super(struct super_block *sb)
    {
    struct the_nilfs *nilfs = sb.s_fs_info;
    struct nilfs_super_block **sbp;
    let mut flag: c_int = NILFS_SB_COMMIT;
...
//
#[no_mangle]
unsafe extern "C" fn nilfs_move_2nd_super(sb: *mut super_block, sb2off: loff_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nilfs_resize_fs(sb: *mut super_block, newsize: __u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn nilfs_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_freeze(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_unfreeze(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_show_options(seq: *mut seq_file, dentry: *mut dentry) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nilfs_fs_context {
    pub ns_mount_opt: c_ulong,
    pub cno: __u64,
}

#[no_mangle]
unsafe extern "C" fn nilfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(param->string, 0: "strict") ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nilfs_setup_super(sb: *mut super_block, is_mount: c_int) -> c_int {
    static int nilfs_setup_super(struct super_block *sb, int is_mount)
    {
    struct the_nilfs *nilfs = sb.s_fs_info;
    struct nilfs_super_block **sbp;
...
// synchronize sbp[1] with sbp[0]
    ...
    {
    let mut sb_index: c_ulonglong = pos;
    unsigned long offset;
...
//
#[no_mangle]
unsafe extern "C" fn nilfs_tree_is_busy(root_dentry: *mut dentry) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_checkpoint_is_mounted(sb: *mut super_block, cno: __u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_reconfigure(fc: *mut fs_context) -> c_int {
...
//
    ...
    if (err) {
    dput(fc.root);
    fc.root = core::ptr::null_mut();  /* prevent double release */
    goto failed_super;
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn nilfs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn nilfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nilfs_inode_init_once(obj: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nilfs_segbuf_init_once(obj: *mut c_void) {
    static void nilfs_segbuf_init_once(void *obj)
    {
    memset(obj, 0, sizeof(struct nilfs_segment_buffer));
    }
#[no_mangle]
unsafe extern "C" fn nilfs_destroy_cachep() {
...
#[no_mangle]
unsafe extern "C" fn nilfs_init_cachep() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_nilfs_fs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_nilfs_fs() -> void __exit {
