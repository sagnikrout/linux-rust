...
#[no_mangle]
pub unsafe extern "C" fn nilfs_inode_add_blocks(inode: *mut inode, n: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_inode_sub_blocks(inode: *mut inode, n: c_int) {
...
//
    ...
    let mut blknum: __u64 = 0;
    let mut err: c_int = 0, ret;
    let mut maxblocks: c_uint = bh_result.b_size >> inode.i_blkbits;
...
//
#[no_mangle]
unsafe extern "C" fn nilfs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int nilfs_read_folio(struct file *file, struct folio *folio)
    {
    return mpage_read_folio(folio, nilfs_get_block);
    }
#[no_mangle]
unsafe extern "C" fn nilfs_readahead(rac: *mut readahead_control) {
    ...
    let mut nr_dirty: c_uint = 0;
    let mut ret: bool = filemap_dirty_folio(mapping, folio);
//
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_write_failed(mapping: *mut address_space, to: loff_t) {
    ...
    {
    struct inode *inode = mapping.host;
    let mut err: c_int = nilfs_transaction_begin(inode.i_sb, core::ptr::null_mut(), 1);
    if (unlikely(err))
    return err;
    ...
    {
    struct inode *inode = mapping.host;
    let mut start: c_uint = pos & (PAGE_SIZE - 1);
...
// reference count of i_bh inherits from nilfs_mdt_read_block()
    ...
    err = nilfs_bmap_read(ii.i_bmap, core::ptr::null_mut());
    if (err < 0)
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_set_inode_flags(inode: *mut inode) {
    void nilfs_set_inode_flags(struct inode *inode)
    {
    let mut flags: c_uint = NILFS_I(inode).i_flags;
...
#[no_mangle]
unsafe extern "C" fn nilfs_iget_test(inode: *mut inode, opaque: *mut c_void) -> c_int {
    static int nilfs_iget_test(struct inode *inode, void *opaque)
    {
...
#[no_mangle]
unsafe extern "C" fn nilfs_iget_set(inode: *mut inode, opaque: *mut c_void) -> c_int {
    ...
    {
    struct nilfs_iget_args args = {
    .ino = ino, .root = core::ptr::null_mut(), .cno = cno, .type = NILFS_I_TYPE_GC
    };
    struct inode *inode;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn nilfs_attach_btree_node_cache(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nilfs_detach_btree_node_cache(inode: *mut inode) {
    void nilfs_detach_btree_node_cache(struct inode *inode)
    {
    struct nilfs_inode_info *ii = NILFS_I(inode);
    struct inode *btnc_inode = ii.i_assoc_inode;
    if (btnc_inode) {
    NILFS_I(btnc_inode).i_assoc_inode = core::ptr::null_mut();
    ii.i_assoc_inode = core::ptr::null_mut();
    iput(btnc_inode);
    }
    }
//
...
//
    ...
    {
    struct nilfs_iget_args args = {
    .ino = inode.i_ino, .root = core::ptr::null_mut(), .cno = 0,
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_update_inode(inode: *mut inode, ibh: *mut buffer_head, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_truncate(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn nilfs_clear_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_load_inode_block(inode: *mut inode, pbh: *mut buffer_head) -> c_int {
    ...
    if (ii.i_bh == core::ptr::null_mut() || unlikely(!buffer_uptodate(ii.i_bh))) {
    ...
    return err;
    spin_lock(&nilfs.ns_inode_lock);
    if (ii.i_bh == core::ptr::null_mut())
    ii.i_bh = *pbh;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unlikely(!buffer_uptodate(ii->i_bh))) -> else {
    __brelse(ii.i_bh);
    ii.i_bh = *pbh;
    } else {
    brelse(*pbh);
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_inode_dirty(inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_set_file_dirty(inode: *mut inode, nr_dirty: c_uint) -> c_int {
...
//
    if (list_empty(&ii.i_dirty) && igrab(inode) == core::ptr::null_mut()) {
//
...
#[no_mangle]
pub unsafe extern "C" fn __nilfs_mark_inode_dirty(inode: *mut inode, flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nilfs_dirty_inode(inode: *mut inode, flags: c_int) {
    ...
    {
    struct the_nilfs *nilfs = inode.i_sb.s_fs_info;
    let mut logical: __u64 = 0, phys = 0, size = 0;
