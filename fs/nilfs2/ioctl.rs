...
//
#[no_mangle]
unsafe extern "C" fn nilfs_ioctl_getversion(inode: *mut inode, argp: *mut void __user) -> c_int {
...
//
    ...
    let mut limit_blkidx: __u64 = (__u64)inode.i_sb.s_maxbytes >> inode.i_blkbits;
    int ret;
//
...
//
    ...
    {
    let mut nmembs: usize = argv.v_nmembs;
...
//
#[no_mangle]
unsafe extern "C" fn nilfs_ioctl_trim_fs(inode: *mut inode, argp: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nilfs_ioctl_set_alloc_range(inode: *mut inode, argp: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nilfs_ioctl_get_fslabel(sb: *mut super_block, argp: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nilfs_compat_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
