...
//
    ...
    ASSERT(bp.b_transp == core::ptr::null_mut());
//
...
// bpp = bp;
    ...
    ASSERT(bp.b_ops != core::ptr::null_mut() || ops == core::ptr::null_mut());
// bpp = bp;
    return 0;
    }
