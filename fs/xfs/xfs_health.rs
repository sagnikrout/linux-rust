...
#[no_mangle]
pub unsafe extern "C" fn xfs_inode_report_fserror(ip: *mut xfs_inode) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ioctl_sick_map {
    pub sick_mask: c_uint,
    pub ioctl_mask: c_uint,
}
