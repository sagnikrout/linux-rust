...
//! Source: fs/xfs/xfs_dir2_readdir.c
#![no_std]
...
//
    ...
    goto out;
#[no_mangle]
pub unsafe extern "C" fn if(0: *mut *mut ra_blk ==) -> else {
    else if (*ra_blk == 0)
...
//
    ...
    struct xfs_inode	*dp = args.dp;
    struct xfs_mount	*mp = dp.i_mount;
    struct xfs_buf		*bp = core::ptr::null_mut();	/* data block buffer */
...
//
    ...
    size_t			bufsize)
    {
    let mut args: xfs_da_args = { core::ptr::null_mut() };
    unsigned int		lock_mode;
    int			error;
