...
//! Source: fs/xfs/xfs_refcount_item.h
#![no_std]
...
//
pub const XFS_CUI_MAX_FAST_EXTENTS: c_int = 16;
//
...
pub struct xfs_cui_log_item {
    ...
    pub cui_refcount: core::sync::atomic::AtomicI32,
    pub cui_next_extent: core::sync::atomic::AtomicI32,
...
extern "C" {
    pub fn xfs_cui_log_space(nr: c_uint) -> c_uint;
}
extern "C" {
    pub fn xfs_cud_log_space() -> c_uint;
}
