...
//! Source: fs/xfs/libxfs/xfs_log_rlimit.c
#![no_std]
...
//
    ...
    {
    let mut rmap_maxlevels: c_uint = mp.m_rmap_maxlevels;
//
...
//
    ...
    {
    let mut resv: xfs_trans_resv = {};
    struct xfs_trans_res	*resp;
    struct xfs_trans_res	*end_resp;
    unsigned int		i;
    let mut log_space: c_int = 0;
    int			attr_space;
...
//
    ...
    struct xfs_mount	*mp)
    {
    let mut tres: xfs_trans_res = {0};
    int			max_logres;
    let mut min_logblks: c_int = 0;
    let mut lsunit: c_int = 0;
