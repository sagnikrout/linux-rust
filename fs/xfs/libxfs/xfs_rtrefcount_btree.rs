...
//! Source: fs/xfs/libxfs/xfs_rtrefcount_btree.h
#![no_std]
...
extern "C" {
    pub fn xfs_rtrefcountbt_droot_maxrecs(blocklen: c_uint, leaf: bool) -> c_uint;
}
//
...
//
extern "C" {
    pub fn xfs_rtrefcountbt_maxlevels_ondisk() -> c_uint;
}
extern "C" {
    pub fn xfs_rtrefcountbt_init_cur_cache() -> int __init;
}
extern "C" {
...
//
extern "C" {
    pub fn xfs_iformat_rtrefcount(ip: *mut xfs_inode, dip: *mut xfs_dinode) -> c_int;
}
extern "C" {
