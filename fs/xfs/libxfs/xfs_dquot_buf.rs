...
//! Source: fs/xfs/libxfs/xfs_dquot_buf.c
#![no_std]
...
//
    ...
    xfs_dquot_buf_verify(mp, bp, true) != core::ptr::null_mut())
...
// Convert an on-disk timer value into an incore timer value.
    ...
    __be32			dtimer)
    {
    let mut t: u32 = be32_to_cpu(dtimer);
...
//
    ...
    struct xfs_inode	*ip;
    let mut metafile_type: enum xfs_metafile_type = xfs_dqinode_metafile_type(type);
    int			error;
...
// Create a metadata directory quota inode.
    ...
    return xfs_metadir_create_file(&upd, S_IFREG, xfs_dqinode_init, core::ptr::null_mut(),
    ipp);
    }
