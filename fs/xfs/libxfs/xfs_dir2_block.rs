...
//! Source: fs/xfs/libxfs/xfs_dir2_block.c
#![no_std]
...
// bpp = NULL;
    ...
    __be16				*tagp = core::ptr::null_mut();
    struct xfs_dir2_data_unused	*dup = core::ptr::null_mut();
    struct xfs_dir2_data_unused	*enddup = core::ptr::null_mut();
// compact = 0;
...
//
    ...
    xfs_dir2_data_unused_t	*enddup=core::ptr::null_mut();	/* unused at end of data */
...
//
    ...
    ASSERT(oldsfp != core::ptr::null_mut());
