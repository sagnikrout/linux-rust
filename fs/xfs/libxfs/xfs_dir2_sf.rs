...
//! Source: fs/xfs/libxfs/xfs_dir2_sf.c
#![no_std]
...
// Macro flag: #define	xfs_dir2_sf_check(args)
...
//
    ...
    {
    if (xfs_has_ftype(mp)) {
    let mut ftype: u8 = sfep.name[sfep.namelen];
...
//
    ...
    let mut offset: c_uint = args.geo.data_entry_offset;
    unsigned int		end;
...
//
    ...
    xfs_dir2_sf_entry_t	*sfep = core::ptr::null_mut();	/* shortform entry */
    trace_xfs_dir2_sf_addname(args);
    ASSERT(xfs_dir2_sf_lookup(args) == -ENOENT);
    ASSERT(dp.i_df.if_format == XFS_DINODE_FMT_LOCAL);
    ASSERT(dp.i_disk_size >= offsetof(struct xfs_dir2_sf_hdr, parent));
    ASSERT(dp.i_df.if_bytes == dp.i_disk_size);
    ASSERT(sfp != core::ptr::null_mut());
...
//
    ...
    struct xfs_mount	*mp = dp.i_mount;
    struct xfs_dir2_sf_hdr	*sfp = dp.i_df.if_data;
    let mut byteoff: c_int = (int)((char *)sfep - (char *)sfp);
//
