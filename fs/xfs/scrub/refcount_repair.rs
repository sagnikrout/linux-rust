...
//! Source: fs/xfs/scrub/refcount_repair.c
#![no_std]
...
// Check for any obvious conflicts with this shared/CoW staging extent.
    ...
    int				error;
    if (xfs_refcount_check_irec(sc.sa.pag, rec) != core::ptr::null_mut())
    return -EFSCORRUPTED;
...
// Compute how many blocks we'll need.
    refc_cur = xfs_refcountbt_init_cursor(sc.mp, core::ptr::null_mut(), core::ptr::null_mut(), pag);
