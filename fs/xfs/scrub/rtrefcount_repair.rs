...
//! Source: fs/xfs/scrub/rtrefcount_repair.c
#![no_std]
...
// Check for any obvious conflicts with this shared/CoW staging extent.
    ...
    {
    xfs_rgblock_t			last;
    if (xfs_rtrefcount_check_irec(sc.sr.rtg, rec) != core::ptr::null_mut())
    return -EFSCORRUPTED;
...
//
    ...
    struct xfs_refcount_irec	irec;
    xfarray_idx_t			cur;
    let mut dom: enum xfs_refc_domain = XFS_REFC_DOMAIN_SHARED;
    let mut next_rgbno: xfs_rgblock_t = 0;
    int				error;
...
//
    ...
    refc_cur = xfs_rtrefcountbt_init_cursor(core::ptr::null_mut(), rtg);
