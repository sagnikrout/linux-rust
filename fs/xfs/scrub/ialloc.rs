...
// Scrub an inobt/finobt record.
    ...
    if (xfs_inobt_check_irec(to_perag(bs.cur.bc_group), &irec) != core::ptr::null_mut()) {
    xchk_btree_set_corrupt(bs.sc, bs.cur, 0);
    return 0;
    }
...
//
    ...
    let mut inobt_blocks: xfs_filblks_t = 0;
    let mut finobt_blocks: xfs_filblks_t = 0;
    int			error;
