...
//! Source: fs/xfs/scrub/refcount.c
#![no_std]
...
//
    ...
    struct xfs_rmap_irec	low;
    struct xfs_rmap_irec	high;
    let mut next_bno: xfs_agblock_t = NULLAGBLOCK;
    int			error;
...
// Make sure we have as many refc blocks as the rmap says.
    ...
    {
    let mut refcbt_blocks: xfs_filblks_t = 0;
