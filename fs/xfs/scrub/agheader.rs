...
//! Source: fs/xfs/scrub/agheader.c
#![no_std]
...
// Cross-reference with the other btrees.
    ...
    let mut agno: xfs_agnumber_t = sc.sm.sm_agno;
    xfs_agblock_t		agbno;
    int			error;
...
// Sort entries, check for duplicates.
    ...
    xchk_agblock_cmp, core::ptr::null_mut());
