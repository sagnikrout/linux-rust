...
#[no_mangle]
unsafe extern "C" fn get_nr_inodes() -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn get_nr_inodes_unused() -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn get_nr_dirty_inodes() -> c_long {
    long get_nr_dirty_inodes(void)
    {
// not actually dirty inodes, but a wild approximation
    let mut nr_dirty: c_long = get_nr_inodes() - get_nr_inodes_unused();
...
#[no_mangle]
unsafe extern "C" fn get_mg_ctime_updates() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn get_mg_fine_stamps() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn get_mg_ctime_swaps() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn mgts_show(s: *mut seq_file, p: *mut c_void) -> c_int {
    static int mgts_show(struct seq_file *s, void *p)
    {
    let mut ctime_updates: c_ulong = get_mg_ctime_updates();
    let mut ctime_swaps: c_ulong = get_mg_ctime_swaps();
    let mut fine_stamps: c_ulong = get_mg_fine_stamps();
    let mut floor_swaps: c_ulong = timekeeping_get_mg_floor_swaps();
...
#[no_mangle]
unsafe extern "C" fn mg_debugfs_init() -> int __init {
    static int __init mg_debugfs_init(void)
    {
    debugfs_create_file("multigrain_timestamps", S_IFREG | S_IRUGO, core::ptr::null_mut(), core::ptr::null_mut(), &mgts_fops);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn init_fs_inode_sysctls() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn no_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_init_always_gfp(sb: *mut super_block, inode: *mut inode, gfp: gfp_t) -> c_int {
    int inode_init_always_gfp(struct super_block *sb, struct inode *inode, gfp_t gfp)
    {
    static const struct inode_operations empty_iops;
    let mut no_open_fops: static struct file_operations = {.open = no_open};
    let mut mapping: *mut address_space const = &inode.i_data;
    inode.i_sb = sb;
    ...
    inode.i_pipe = core::ptr::null_mut();
    inode.i_cdev = core::ptr::null_mut();
    inode.i_link = core::ptr::null_mut();
    inode.i_dir_seq = 0;
    inode.i_rdev = 0;
    ...
    inode.i_flctx = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn free_inode_nonrcu(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn i_callback(head: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn __destroy_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn destroy_inode(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drop_nlink(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn clear_nlink(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_nlink(inode: *mut inode, nlink: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn inc_nlink(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn __address_space_init_once(mapping: *mut address_space) {
...
#[no_mangle]
pub unsafe extern "C" fn address_space_init_once(mapping: *mut address_space) {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_init_once(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn wait_on_new_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn __inode_lru_list_add(inode: *mut inode, rotate: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rotate) -> else {
    else if (rotate)
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_lru_list_add(inode: *mut inode) {
    void inode_lru_list_add(struct inode *inode)
    {
    __inode_lru_list_add(inode, false);
    }
#[no_mangle]
unsafe extern "C" fn inode_lru_list_del(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn inode_pin_lru_isolating(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn inode_unpin_lru_isolating(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn inode_wait_for_lru_isolating(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_sb_list_add(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_sb_list_del(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn hash(sb: *mut super_block, hashval: u64) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn __insert_inode_hash(inode: *mut inode, hashval: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __remove_inode_hash(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn dump_mapping(mapping: *const address_space) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn evict(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn dispose_list(head: *mut list_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn evict_inodes(sb: *mut super_block) {
...
//
#[no_mangle]
pub unsafe extern "C" fn prune_icache_sb(sb: *mut super_block, sc: *mut shrink_control) -> c_long {
...
//
pub const LAST_INO_BATCH: c_int = 1024;
    static DEFINE_PER_CPU(unsigned int, last_ino);
#[no_mangle]
pub unsafe extern "C" fn get_next_ino() -> c_uint {
    unsigned int get_next_ino(void)
    {
    unsigned int *p = &get_cpu_var(last_ino);
    let mut res: c_uint = *p;

    if (unlikely((res & (LAST_INO_BATCH-1)) == 0)) {
    static atomic_t shared_last_ino;
    let mut next: c_int = atomic_add_return(LAST_INO_BATCH, &shared_last_ino);
...
#[no_mangle]
pub unsafe extern "C" fn lockdep_annotate_inode_mutex_key(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn unlock_new_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn discard_new_inode(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lock_two_nondirectories(inode1: *mut inode, inode2: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn unlock_two_nondirectories(inode1: *mut inode, inode2: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn test_inode_iunique(sb: *mut super_block, ino: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iunique(sb: *mut super_block, max_reserved: ino_t) -> ino_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn ihold(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn igrab_from_hash(inode: *mut inode) -> bool {
    static bool igrab_from_hash(struct inode *inode)
    {
...
//
    ...
    spin_unlock(&inode_hash_lock);
    return IS_ERR(inode) ? core::ptr::null_mut() : inode;
    }
...
//
    ...
    {
    struct hlist_head *head = inode_hashtable + hash(sb, hashval);
    struct inode *inode, *ret_inode = core::ptr::null_mut();
    int mval;
    spin_lock(&inode_hash_lock);
...
#[no_mangle]
pub unsafe extern "C" fn insert_inode_locked(inode: *mut inode) -> c_int {
    ...
    might_sleep();
    while (1) {
    struct inode *old = core::ptr::null_mut();
    spin_lock(&inode_hash_lock);
    repeat:
    ...
    old = inode_insert5(inode, hashval, test, core::ptr::null_mut(), data);
    if (old != inode) {
    iput(old);
    return -EBUSY;
    }
...
#[no_mangle]
pub unsafe extern "C" fn inode_just_drop(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iput_final(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iput(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iput_not_last(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bmap(inode: *mut inode, block: *mut sector_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inode_update_atime(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inode_update_cmtime(inode: *mut inode, flags: c_uint) -> c_int {
    ...
    let mut now: timespec64 = inode_set_ctime_current(inode);
    let mut dirty: c_uint = 0;
    bool mtime_changed;
...
//
#[no_mangle]
pub unsafe extern "C" fn atime_needs_update(path: *const path, inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn touch_atime(path: *const path) {
...
//
    return notify_change(idmap, dentry, &newattrs, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn file_remove_privs_flags(file: *mut file, flags: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn file_remove_privs(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn current_time(inode: *mut inode) -> timespec64 {
...
#[no_mangle]
pub unsafe extern "C" fn need_cmtime_update(inode: *mut inode) -> bool {
    static inline bool need_cmtime_update(struct inode *inode)
    {
    let mut now: timespec64 = current_time(inode), ts;
...
#[no_mangle]
unsafe extern "C" fn file_update_time_flags(file: *mut file, flags: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn file_update_time(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn file_modified_flags(file: *mut file, flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn file_modified(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kiocb_modified(iocb: *mut kiocb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inode_needs_sync(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __wait_on_freeing_inode(inode: *mut inode, hash_locked: bool, rcu_locked: bool) {
    static void __wait_on_freeing_inode(struct inode *inode, bool hash_locked, bool rcu_locked)
    {
    struct wait_bit_queue_entry wqe;
    struct wait_queue_head *wq_head;
...
#[no_mangle]
unsafe extern "C" fn set_ihash_entries(str: *mut c_char) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_init_early() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn inode_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn init_special_inode(inode: *mut inode, mode: umode_t, rdev: dev_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_dio_finished(inode: *const inode) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_dio_wait(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_dio_wait_interruptible(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_nohighmem(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn inode_set_ctime_to_ts(inode: *mut inode, ts: timespec64) -> timespec64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn timestamp_truncate(t: timespec64, inode: *mut inode) -> timespec64 {
    struct timespec64 timestamp_truncate(struct timespec64 t, struct inode *inode)
    {
    struct super_block *sb = inode.i_sb;
    let mut gran: c_uint = sb.s_time_gran;
...
// Avoid division in the common cases 1 ns and 1 s.
    ...
    ; /* nothing */
#[no_mangle]
pub unsafe extern "C" fn if(NSEC_PER_SEC: gran ==) -> else {
    else if (gran == NSEC_PER_SEC)
    t.tv_nsec = 0;
#[no_mangle]
pub unsafe extern "C" fn if(NSEC_PER_SEC: gran > 1 && gran <) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_set_ctime_current(inode: *mut inode) -> timespec64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn inode_set_ctime_deleg(inode: *mut inode, update: timespec64) -> timespec64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn dump_inode(inode: *mut inode, reason: *const c_char) {
