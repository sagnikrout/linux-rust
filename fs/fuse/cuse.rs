...
pub const CUSE_CONNTBL_LEN: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cuse_conn {
    pub /: *mut *mut list_head list; / linked on cuse_conntbl,
    pub /: *mut *mut fuse_mount fm; / Dummy mount referencing fc,
    pub /: *mut *mut fuse_conn fc; / fuse connection,
    pub /: *mut *mut *mut cdev cdev; / associated character device,
    pub /: *mut *mut *mut device dev; / device representing @cdev,
...
//
#[no_mangle]
unsafe extern "C" fn cuse_read_iter(kiocb: *mut kiocb, to: *mut iov_iter) -> isize {
    static ssize_t cuse_read_iter(struct kiocb *kiocb, struct iov_iter *to)
    {
    let mut io: fuse_io_priv = FUSE_IO_PRIV_SYNC(kiocb);
    let mut pos: loff_t = 0;
    return fuse_direct_io(&io, to, &pos, FUSE_DIO_CUSE);
    }
#[no_mangle]
unsafe extern "C" fn cuse_write_iter(kiocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cuse_open(inode: *mut inode, file: *mut file) -> c_int {
    static int cuse_open(struct inode *inode, struct file *file)
    {
    let mut devt: dev_t = inode.i_cdev.dev;
    struct cuse_conn *cc = core::ptr::null_mut(), *pos;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn cuse_release(inode: *mut inode, file: *mut file) -> c_int {
    ...
    struct fuse_file *ff = file.private_data;
    struct cuse_conn *cc = fc_to_cc(ff.fm.fc);
    let mut flags: c_uint = FUSE_IOCTL_COMPAT;
    if (cc.unrestricted_ioctl)
    flags |= FUSE_IOCTL_UNRESTRICTED;
    return fuse_do_ioctl(file, cmd, arg, flags);
    }
...
//
#[no_mangle]
unsafe extern "C" fn cuse_parse_one(pp: *mut c_char, end: *mut c_char, keyp: *mut c_char, valp: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cuse_parse_devinfo(p: *mut c_char, len: usize, devinfo: *mut cuse_devinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cuse_gendev_release(dev: *mut device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cuse_init_args {
    pub ap: fuse_args_pages,
    pub in: cuse_init_in,
    pub out: cuse_init_out,
    pub folio: *mut folio,
    pub desc: fuse_folio_desc,
...
//
#[no_mangle]
unsafe extern "C" fn cuse_process_init_reply(args: *mut fuse_args, error: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cuse_send_init(cc: *mut cuse_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cuse_fc_release(fc: *mut fuse_conn) {
...
//
#[no_mangle]
unsafe extern "C" fn cuse_channel_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cuse_channel_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    static DEVICE_ATTR(waiting, 0400, cuse_class_waiting_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(abort, 0200, core::ptr::null_mut(), cuse_class_abort_store);
...
#[no_mangle]
unsafe extern "C" fn cuse_init() -> int __init {
...
// CUSE is not prepared for FUSE_DEV_IOC_CLONE
    cuse_channel_fops.unlocked_ioctl	= core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cuse_exit() -> void __exit {
