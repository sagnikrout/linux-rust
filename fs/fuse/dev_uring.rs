...
pub const FUSE_URING_IOV_HEADERS: c_int = 0;
pub const FUSE_URING_IOV_PAYLOAD: c_int = 1;

#[no_mangle]
pub unsafe extern "C" fn fuse_uring_enabled() -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fuse_uring_pdu {
    pub ent: *mut fuse_ring_ent,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fuse_zero_copy_bvs {
    pub nr_bvs: c_uint,
    pub bvs: [bio_vec; ],
}
...
#[no_mangle]
pub unsafe extern "C" fn bufpool_enabled(queue: *mut fuse_ring_queue) -> bool {
    static inline bool bufpool_enabled(struct fuse_ring_queue *queue)
    {
    return queue.payload_mode == FUSE_PAYLOAD_BUFPOOL;
    }
#[no_mangle]
pub unsafe extern "C" fn bufpool_registered(queue: *mut fuse_ring_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_flush_bg(queue: *mut fuse_ring_queue) {
...
#[no_mangle]
unsafe extern "C" fn can_zero_copy_req(ent: *mut fuse_ring_ent, req: *mut fuse_req) -> bool {
    ...
    ent.fuse_req = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_abort_end_queue_requests(queue: *mut fuse_ring_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_abort_end_requests(ring: *mut fuse_ring) {
...
#[no_mangle]
unsafe extern "C" fn ent_list_request_expired(fch: *mut fuse_chan, list: *mut list_head) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_request_expired(fch: *mut fuse_chan) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_destruct(fch: *mut fuse_chan) {
    ...
    kfree(queue.bufpool);
    kfree(queue);
    WRITE_ONCE(ring.queues[qid], core::ptr::null_mut());
    }
    kfree(ring.queues);
    kfree(ring);
    fch.ring = core::ptr::null_mut();
    }
//
...
//
    ...
    let mut nr_queues: usize = num_possible_cpus();
...
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_conn_init(fch: *mut fuse_chan) {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_stop_fuse_req_end(req: *mut fuse_req) {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_uring_entry_teardown(ent: *mut fuse_ring_ent) {
...
//
    ...
    struct fuse_ring *ring = queue.ring;
    struct fuse_ring_ent *ent, *next;
    let mut queue_refs: isize = SSIZE_MAX;
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_teardown_entries(queue: *mut fuse_ring_queue) {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_teardown_all_queues(ring: *mut fuse_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_uring_log_ent_state(ring: *mut fuse_ring) {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_async_stop_queues(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_stop_queues(ring: *mut fuse_ring) {
...
//
    ...
    struct fuse_ring_queue *queue;
    let mut need_cmd_done: bool = false;
//
...
#[no_mangle]
unsafe extern "C" fn ring_header_type_offset(type: enum fuse_uring_header_type) -> c_int {
    ...
    {
    let mut offset: c_int = ring_header_type_offset(type);
    void __user *ring;
    if (offset < 0)
    return offset;
    ...
    let mut len: usize = ent.payload.iov_len;
    let mut err: c_int = 0;
    if (!base) {
...
#[no_mangle]
unsafe extern "C" fn fuse_zero_copy_release(priv: *mut c_void) {
...
//
    ...
    let mut num_args: c_int = args.in_numargs;
    int err;
    struct iov_iter iter;
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_select_buffer(ent: *mut fuse_ring_ent) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_recycle_buffer(ent: *mut fuse_ring_ent) {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_add_to_pq(ent: *mut fuse_ring_ent) {
...
//
    ...
    return req != core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn fuse_ring_ent_set_commit(ent: *mut fuse_ring_ent) -> c_int {
...
// FUSE_URING_CMD_COMMIT_AND_FETCH handler
    ...
    struct fuse_ring *ring = fch.ring;
    struct fuse_ring_queue *queue;
    let mut commit_id: u64 = READ_ONCE(cmd_req.commit_id);
    let mut qid: c_uint = READ_ONCE(cmd_req.qid);
...
//
    ...
    list_del_init(&req.list);
    ent = req.ring_entry;
    req.ring_entry = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn is_ring_ready(ring: *mut fuse_ring, current_qid: c_int) -> bool {
...
// abort teardown path is running or has run
    ...
    let mut ready: bool = is_ring_ready(ring, queue.qid);
    if (ready) {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_add_queue(cmd: *mut io_uring_cmd, fch: *mut fuse_chan) -> c_int {
    ...
    struct fuse_ring *ring = smp_load_acquire(&fch.ring);
    let mut qid: c_uint = READ_ONCE(cmd_req.qid);
    let mut flags: u64 = READ_ONCE(cmd_req.flags);
    struct fuse_ring_queue *queue;
    let mut zero_copy: bool = flags & FUSE_URING_ZERO_COPY;
    if (!ring)
    return -EINVAL;
    if (qid >= ring.nr_queues) {
    pr_info_ratelimited("fuse: Invalid ring qid %u\n", qid);
...
// paired with the smp_store_release() in fuse_uring_create
    ...
    let mut registered: bool = cmd.flags & IORING_URING_CMD_FIXED;
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_cmd(cmd: *mut io_uring_cmd, issue_flags: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_uring_send_in_task(tw_req: io_tw_req, tw: io_tw_token_t) {
...
#[no_mangle]
unsafe extern "C" fn fuse_uring_dispatch_ent(ent: *mut fuse_ring_ent) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_queue_fuse_req(fiq: *mut fuse_iqueue, req: *mut fuse_req) {
    void fuse_uring_queue_fuse_req(struct fuse_iqueue *fiq, struct fuse_req *req)
    {
    struct fuse_ring *ring = req.chan.ring;
    struct fuse_ring_queue *queue;
    struct fuse_ring_ent *ent = core::ptr::null_mut();
    int err;
    err = -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_queue_bq_req(req: *mut fuse_req) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_uring_remove_pending_req(req: *mut fuse_req) -> bool {
