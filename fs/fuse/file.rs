...
#[no_mangle]
pub unsafe extern "C" fn fuse_file_free(ff: *mut fuse_file) {
...
#[no_mangle]
unsafe extern "C" fn fuse_release_end(args: *mut fuse_args, error: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fuse_file_put(ff: *mut fuse_file, sync: bool) {
    static void fuse_file_put(struct fuse_file *ff, bool sync)
    {
    if (refcount_dec_and_test(&ff.count)) {
    struct fuse_release_args *ra = &ff.args.release_args;
    struct fuse_args *args = (ra ? &ra.args : core::ptr::null_mut());
    if (ra && ra.inode)
...
//
    ...
    struct fuse_file *ff;
    let mut opcode: c_int = isdir ? FUSE_OPENDIR : FUSE_OPEN;
    let mut open: bool = isdir ? !fc.no_opendir : !fc.no_open;
    let mut release: bool = !isdir || open;
//
...
#[no_mangle]
unsafe extern "C" fn fuse_link_write_file(file: *mut file) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_finish_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(FOPEN_NONSEEKABLE: ff->open_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn fuse_truncate_update_attr(inode: *mut inode, file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn fuse_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    struct fuse_file *ff;
    int err;
    let mut is_truncate: bool = (file.f_flags & O_TRUNC) && fc.atomic_o_trunc;
    let mut is_wb_truncate: bool = is_truncate && fc.writeback_cache;
    let mut dax_truncate: bool = is_truncate && FUSE_IS_DAX(inode);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_truncate) -> else {
    else if (is_truncate)
...
#[no_mangle]
pub unsafe extern "C" fn if(FOPEN_KEEP_CACHE): !(ff->open_flags &) -> else {
...
//
    ra.inode = sync ? core::ptr::null_mut() : igrab(&fi.inode);
    }
    ...
    struct fuse_inode *fi = get_fuse_inode(inode);
    struct fuse_release_args *ra = &ff.args.release_args;
    let mut opcode: c_int = isdir ? FUSE_RELEASEDIR : FUSE_RELEASE;
...
#[no_mangle]
pub unsafe extern "C" fn fuse_release_common(file: *mut file, isdir: bool) {
...
#[no_mangle]
unsafe extern "C" fn fuse_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_lock_owner_id(fc: *mut fuse_conn, id: fl_owner_t) -> u64 {
    u64 fuse_lock_owner_id(struct fuse_conn *fc, fl_owner_t id)
    {
    u32 *k = fc.scramble_key;
    let mut v: u64 = (unsigned long) id;
    let mut v0: u32 = v;
    let mut v1: u32 = v >> 32;
    let mut sum: u32 = 0;
    int i;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fuse_writepage_args {
    pub ia: fuse_io_args,
    pub queue_entry: list_head,
    pub inode: *mut inode,
    pub bucket: *mut fuse_sync_bucket,
}
...
//
#[no_mangle]
unsafe extern "C" fn fuse_sync_writes(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fuse_flush(file: *mut file, id: fl_owner_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_io_release(kref: *mut kref) {
    static void fuse_io_release(struct kref *kref)
    {
    kfree(container_of(kref, struct fuse_io_priv, refcnt));
    }
#[no_mangle]
unsafe extern "C" fn fuse_get_res_by_io(io: *mut fuse_io_priv) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fuse_aio_invalidate_worker(work: *mut work_struct) {
    ...
    let mut res: isize = fuse_get_res_by_io(io);
    let mut start: pgoff_t = io.offset >> PAGE_SHIFT;
    let mut end: pgoff_t = (io.offset + res - 1) >> PAGE_SHIFT;
...
//
#[no_mangle]
unsafe extern "C" fn fuse_aio_complete(io: *mut fuse_io_priv, err: c_int, pos: isize) {
    ...
    io.err = io.err ? : err;
#[no_mangle]
pub unsafe extern "C" fn if(io->bytes): pos >= 0 && (io->bytes < 0 || pos <) -> else {
...
//
    ...
    if (!ia.ap.folios) {
    kfree(ia);
    ia = core::ptr::null_mut();
    }
    }
    return ia;
    }
#[no_mangle]
unsafe extern "C" fn fuse_io_free(ia: *mut fuse_io_args) {
...
#[no_mangle]
unsafe extern "C" fn fuse_aio_complete_req(args: *mut fuse_args, err: c_int) {
...
// Nothing
    ...
    let mut outsize: u32 = args.out_args[0].size;
    nres = outsize;
...
//
    if (!fc.writeback_cache) {
    let mut pos: loff_t = folio_pos(ap.folios[0]) + num_read;
    ...
    struct fuse_mount *fm = get_fuse_mount(inode);
    let mut pos: loff_t = folio_pos(folio) + off;
...
// forward declarations
    ...
    let mut off: usize = offset_in_folio(folio, pos);
...
//
    ...
    data.ia = fuse_io_alloc(core::ptr::null_mut(), nr_pages);
    if (!data.ia)
    return -ENOMEM;
    ia = data.ia;
    }
...
#[no_mangle]
unsafe extern "C" fn fuse_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    ...
    iomap_read_folio(&fuse_iomap_ops, &ctx, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fuse_readpages_end(args: *mut fuse_args, err: c_int) {
    static void fuse_readpages_end(struct fuse_args *args, int err)
    {
    int i;
    struct fuse_io_args *ia = container_of(args, typeof(*ia), ap.args);
    struct fuse_args_pages *ap = &ia.ap;
    let mut count: usize = ia.read.in.size;
    let mut num_read: usize = args.out_args[0].size;
...
//
    ...
    struct fuse_mount *fm = ff.fm;
    struct fuse_args_pages *ap = &ia.ap;
    let mut pos: loff_t = folio_pos(ap.folios[0]);
    ssize_t res;
    int err;
    ap.args.out_pages = true;
    ap.args.page_zeroing = true;
...
#[no_mangle]
unsafe extern "C" fn fuse_readahead(rac: *mut readahead_control) {
    ...
    if (fuse_is_bad(inode))
    return;
    iomap_readahead(&fuse_iomap_ops, &ctx, core::ptr::null_mut());
    if (data.ia)
    fuse_send_readpages(data.ia, data.file, data.nr_bytes,
    fc.async_read);
    }
#[no_mangle]
unsafe extern "C" fn fuse_cache_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fuse_write_flags(iocb: *mut kiocb) -> c_uint {
    static unsigned int fuse_write_flags(struct kiocb *iocb)
    {
    let mut flags: c_uint = iocb.ki_filp.f_flags;
...
#[no_mangle]
pub unsafe extern "C" fn fuse_write_update_attr(inode: *mut inode, pos: loff_t, written: isize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fuse_perform_write(iocb: *mut kiocb, ii: *mut iov_iter) -> isize {
    ...
    pos, count);
    if (!err) {
    let mut num_written: usize = ia.write.out.size;
    res += num_written;
    pos += num_written;
...
#[no_mangle]
unsafe extern "C" fn fuse_io_past_eof(iocb: *mut kiocb, iter: *mut iov_iter) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_dio_wr_exclusive_lock(iocb: *mut kiocb, from: *mut iov_iter) -> bool {
...
//
    if (fuse_io_past_eof(iocb, from) ||
    fuse_inode_uncached_io_start(fi, core::ptr::null_mut()) != 0) {
...
#[no_mangle]
unsafe extern "C" fn fuse_dio_unlock(iocb: *mut kiocb, exclusive: bool) {
...
#[no_mangle]
unsafe extern "C" fn fuse_cache_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_get_user_addr(ii: *const iov_iter) -> c_ulong {
    ...
    {
    let mut flush_or_invalidate: bool = false;
...
//
    ...
    let mut frag_size: usize = fuse_get_frag_size(ii, *nbytesp);
    if (write)
...
// nbytesp - nbytes,
    ...
    let mut len: c_uint = umin(ret, PAGE_SIZE - start);
...
// nbytesp = nbytes;
    ...
    {
    let mut write: c_int = flags & FUSE_DIO_WRITE;
    let mut cuse: c_int = flags & FUSE_DIO_CUSE;
    struct file *file = io.iocb.ki_filp;
    struct address_space *mapping = file.f_mapping;
    struct inode *inode = mapping.host;
    struct fuse_file *ff = file.private_data;
    struct fuse_conn *fc = ff.fm.fc;
    let mut nmax: usize = write ? fc.max_write : fc.max_read;
    let mut pos: loff_t = *ppos;
    let mut count: usize = iov_iter_count(iter);
    let mut idx_from: pgoff_t = pos >> PAGE_SHIFT;
    let mut idx_to: pgoff_t = (pos + count - 1) >> PAGE_SHIFT;
    let mut res: isize = 0;
    let mut err: c_int = 0;
    struct fuse_io_args *ia;
    unsigned int max_pages;
    let mut fopen_direct_io: bool = ff.open_flags & FOPEN_DIRECT_IO;
    ...
    while (count) {
    ssize_t nres;
    let mut owner: fl_owner_t = current.files;
    let mut nbytes: usize = min(count, nmax);
...
#[no_mangle]
unsafe extern "C" fn fuse_direct_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    ...
    let mut io: fuse_io_priv = FUSE_IO_PRIV_SYNC(iocb);
    res = __fuse_direct_read(&io, to, &iocb.ki_pos);
    }
    return res;
    }
#[no_mangle]
unsafe extern "C" fn fuse_direct_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fuse_file_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fuse_file_passthrough(ff)) -> else {
...
#[no_mangle]
unsafe extern "C" fn fuse_file_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fuse_writepage_free(wpa: *mut fuse_writepage_args) {
...
#[no_mangle]
unsafe extern "C" fn fuse_writepage_finish(wpa: *mut fuse_writepage_args) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_flush_writepages(inode: *mut inode) {
    ...
    struct fuse_mount *fm = get_fuse_mount(inode);
    struct fuse_inode *fi = get_fuse_inode(inode);
    let mut crop: loff_t = i_size_read(inode);
...
#[no_mangle]
unsafe extern "C" fn fuse_writepage_end(args: *mut fuse_args, error: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fuse_fill_wb_data {
    pub wpa: *mut fuse_writepage_args,
    pub ff: *mut fuse_file,
    pub max_folios: c_uint,
//
...
//
    ...
    let mut bytes: unsigned = cur_bytes + len;
    loff_t prev_pos;
    let mut max_bytes: usize = write ? fc.max_write : fc.max_read;
...
// Discontinuity
    ...
    struct fuse_inode *fi = get_fuse_inode(inode);
    struct fuse_conn *fc = get_fuse_conn(inode);
    let mut offset: loff_t = offset_in_folio(folio, pos);
    WARN_ON_ONCE(!data);
    if (!data.ff) {
...
//
    ...
    data.wpa = core::ptr::null_mut();
    data.nr_bytes = 0;
    }
    }
    if (data.wpa == core::ptr::null_mut()) {
    ...
    struct inode *inode = mapping.host;
    struct fuse_conn *fc = get_fuse_conn(inode);
    let mut data: fuse_fill_wb_data = {};
...
#[no_mangle]
unsafe extern "C" fn fuse_launder_folio(folio: *mut folio) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_vma_close(vma: *mut vm_area_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_page_mkwrite(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn fuse_file_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fuse_inode_backing(get_fuse_inode(inode))) -> else {
...
#[no_mangle]
unsafe extern "C" fn fuse_getlk(file: *mut file, fl: *mut file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_setlk(file: *mut file, fl: *mut file_lock, flock: c_int) -> c_int {
    ...
    FUSE_ARGS(args);
    struct fuse_lk_in inarg;
    let mut opcode: c_int = (fl.c.flc_flags & FL_SLEEP) ? FUSE_SETLKW : FUSE_SETLK;
    struct pid *pid = fl.c.flc_type != F_UNLCK ? task_tgid(current) : core::ptr::null_mut();
    let mut pid_nr: pid_t = pid_nr_ns(pid, fm.fc.pid_ns);
    int err;
...
#[no_mangle]
unsafe extern "C" fn fuse_file_lock(file: *mut file, cmd: c_int, fl: *mut file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_file_flock(file: *mut file, cmd: c_int, fl: *mut file_lock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn fuse_lseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn fuse_file_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn fuse_do_truncate(file: *mut file) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_round_up(fc: *mut fuse_conn, off: loff_t) -> loff_t {
    ...
    struct inode *inode;
    loff_t i_size;
    let mut count: usize = iov_iter_count(iter), shortened = 0;
    let mut offset: loff_t = iocb.ki_pos;
    struct fuse_io_priv *io;
    let mut async: bool = ff.fm.fc.async_dio;
    pos = offset;
...
//
    ...
    if (io.async) {
    let mut blocking: bool = io.blocking;
...
#[no_mangle]
unsafe extern "C" fn fuse_writeback_range(inode: *mut inode, start: loff_t, end: loff_t) -> c_int {
    static int fuse_writeback_range(struct inode *inode, loff_t start, loff_t end)
    {
    let mut err: c_int = filemap_write_and_wait_range(inode.i_mapping, start, LLONG_MAX);
    if (!err)
    fuse_sync_writes(inode);
    return err;
    }
    ...
    let mut endbyte: loff_t = offset + length - 1;
...
#[no_mangle]
pub unsafe extern "C" fn fuse_init_file_inode(inode: *mut inode, flags: c_uint) {
