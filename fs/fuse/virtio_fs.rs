...
//
pub const FUSE_HEADER_OVERHEAD: c_int = 4;
...
pub const VQ_NAME_LEN: c_int = 24;
// Per-virtqueue state
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_fs_vq {
    pub lock: spinlock_t,
    pub /: *mut *mut *mut virtqueue vq; / protected by ->lock,
    pub done_work: work_struct,
    pub queued_reqs: list_head,
    pub /: *mut *mut list_head end_reqs; / End these requests,
    pub dispatch_work: work_struct,
    pub fud: *mut fuse_dev,
    pub connected: bool,
    pub in_flight: c_long,
    pub /: *mut *mut completion in_flight_zero; / No inflight requests,
    pub kobj: *mut kobject,
    pub name: [c_char; VQ_NAME_LEN],
    pub ____cacheline_aligned_in_smp: },
// A virtio-fs device instance
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_fs {
    pub kobj: kobject,
    pub mqs_kobj: *mut kobject,
    pub /: *mut *mut list_head list; / on virtio_fs_instances,
    pub tag: *mut c_char,
    pub vqs: *mut virtio_fs_vq,
    pub /: *mut *mut unsigned int nvqs; / number of virtqueues,
    pub /: *mut *mut unsigned int num_request_queues; / number of request queues,
    pub dax_dev: *mut dax_device,
    pub /: *mut *mut *mut unsigned int mq_map; / index = cpu id, value = request vq id,
// DAX memory window where file contents are mapped
    pub window_kaddr: *mut c_void,
    pub window_phys_addr: phys_addr_t,
    pub window_len: usize,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_fs_forget_req {
    pub ih: fuse_in_header,
    pub arg: fuse_forget_in,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_fs_forget {
// This request can be temporarily queued on virt queue
    pub list: list_head,
    pub req: virtio_fs_forget_req,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_fs_req_work {
    pub req: *mut fuse_req,
    pub fsvq: *mut virtio_fs_vq,
    pub done_work: work_struct,
}
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_free_fsc(fsc: *mut fs_context) {
...
#[no_mangle]
pub unsafe extern "C" fn inc_in_flight_req(fsvq: *mut virtio_fs_vq) {
...
// Should be called with fsvq->lock held.
#[no_mangle]
pub unsafe extern "C" fn dec_in_flight_req(fsvq: *mut virtio_fs_vq) {
    ...
    let mut virtio_fs_tag_attr: static struct kobj_attribute = __ATTR_RO(tag);
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_ktype_release(kobj: *mut kobject) {
    ...
    let mut virtio_fs_vq_name_attr: static struct kobj_attribute = __ATTR_RO(name);
    ...
    let mut virtio_fs_vq_cpu_list_attr: static struct kobj_attribute = __ATTR_RO(cpu_list);
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_put_locked(fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_put(fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_fiq_release(fiq: *mut fuse_iqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_drain_queue(fsvq: *mut virtio_fs_vq) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_drain_all_queues_locked(fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_drain_all_queues(fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_start_all_queues(fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_delete_queues_sysfs(fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_add_queues_sysfs(fs: *mut virtio_fs) -> c_int {
...
//
    ...
    ret = kobject_add(&fs.kobj, core::ptr::null_mut(), "%d", vdev.index);
    if (ret < 0)
    goto out_unlock;
...
// Return the virtio_fs with a given tag, or NULL
    ...
    fs = core::ptr::null_mut(); /* not found */
    found:
    mutex_unlock(&virtio_fs_mutex);
    return fs;
    }
#[no_mangle]
unsafe extern "C" fn virtio_fs_free_devs(fs: *mut virtio_fs) {
    ...
    fsvq.fud = core::ptr::null_mut();
    }
    }
// Read filesystem name from virtio config into fs->tag (must kfree()).
#[no_mangle]
unsafe extern "C" fn virtio_fs_read_tag(vdev: *mut virtio_device, fs: *mut virtio_fs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_hiprio_done_work(work: *mut work_struct) {
...
// Free completed FUSE_FORGET requests
    ...
    while ((req = virtqueue_get_buf(vq, &len)) != core::ptr::null_mut()) {
    kfree(req);
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_request_dispatch_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_hiprio_dispatch_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn copy_args_to_argbuf(req: *mut fuse_req, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_args_from_argbuf(args: *mut fuse_args, req: *mut fuse_req) {
    ...
    for (i = 0; i < num_out; i++) {
    let mut argsize: c_uint = args.out_args[i].size;
    if (args.out_argvar &&
...
// Store the actual size of the variable-length arg
    ...
    kfree(req.argbuf);
    req.argbuf = core::ptr::null_mut();
    }
// Verify that the server properly follows the FUSE protocol
#[no_mangle]
unsafe extern "C" fn virtio_fs_verify_response(req: *mut fuse_req, len: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_complete_req_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_requests_done_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_map_queues(vdev: *mut virtio_device, fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_vq_done(vq: *mut virtqueue) {
...
//
    let mut desc: irq_affinity = { .pre_vectors = VQ_REQUEST };
    unsigned int i;
    let mut ret: c_int = 0;
...
// Initialize the requests virtqueues
    ...
    if (ret) {
    kfree(fs.vqs);
    fs.vqs = core::ptr::null_mut();
    kfree(fs.mq_map);
    fs.mq_map = core::ptr::null_mut();
    }
    return ret;
    }
// Free virtqueues (device must already be reset)
#[no_mangle]
unsafe extern "C" fn virtio_fs_cleanup_vqs(vdev: *mut virtio_device) {
...
//
    ...
    let mut offset: phys_addr_t = PFN_PHYS(pgoff);
    let mut max_nr_pages: usize = fs.window_len / PAGE_SIZE - pgoff;
    if (kaddr)
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_cleanup_dax(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_setup_dax(vdev: *mut virtio_device, fs: *mut virtio_fs) -> c_int {
    static int virtio_fs_setup_dax(struct virtio_device *vdev, struct virtio_fs *fs)
    {
    struct dax_device *dax_dev __free(cleanup_dax) = core::ptr::null_mut();
    ...
    if (IS_ERR(dax_dev)) {
    let mut rc: c_int = PTR_ERR(dax_dev);
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_probe(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_stop_all_queues(fs: *mut virtio_fs) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_freeze(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_restore(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_send_forget(fiq: *mut fuse_iqueue, link: *mut fuse_forget_link) {
    ...
    let mut unique: u64 = fuse_get_unique(fiq);
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_send_interrupt(fiq: *mut fuse_iqueue, req: *mut fuse_req) {
...
#[no_mangle]
unsafe extern "C" fn sg_count_fuse_req(req: *mut fuse_req) -> c_uint {
...
// requests need at least 4 elements
    ...
    struct virtqueue *vq;
    struct fuse_args *args = req.args;
    let mut argbuf_used: c_uint = 0;
    let mut out_sgs: c_uint = 0;
    let mut in_sgs: c_uint = 0;
...
// Reply elements
    ...
    args.out_pages,
    req.argbuf + argbuf_used, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_send_req(fiq: *mut fuse_iqueue, req: *mut fuse_req) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_fs_ctx_set_defaults(ctx: *mut fuse_fs_context) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_fill_super(sb: *mut super_block, fsc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_conn_destroy(fm: *mut fuse_mount) {
...
#[no_mangle]
unsafe extern "C" fn virtio_kill_sb(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_get_tree(fsc: *mut fs_context) -> c_int {
    static int virtio_fs_get_tree(struct fs_context *fsc)
    {
    struct virtio_fs *fs;
    struct super_block *sb;
    struct fuse_conn *fc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_init_fs_context(fsc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_uevent(kobj: *const kobject, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_sysfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_sysfs_exit() {
    static void virtio_fs_sysfs_exit(void)
    {
    kset_unregister(virtio_fs_kset);
    virtio_fs_kset = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn virtio_fs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn virtio_fs_exit() -> void __exit {
