...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dentry_bucket {
    pub tree: rb_root,
    pub lock: spinlock_t,
}

pub const FUSE_HASH_BITS: c_int = 5;
...
pub const FUSE_DENTRY_INVAL_FREQ_MIN: c_int = 5;
    unsigned __read_mostly inval_wq;
#[no_mangle]
unsafe extern "C" fn inval_wq_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int inval_wq_set(const char *val, const struct kernel_param *kp)
    {
    unsigned int num;
    let mut old: c_uint = inval_wq;
    int ret;
    if (!val)
    return -EINVAL;
...
// ((unsigned int *)kp->arg) = num;
    ...
    secs_to_jiffies(num));
#[no_mangle]
pub unsafe extern "C" fn if(old: !num &&) -> else {
    else if (!num && old)
    ...
    {
    let mut i: c_int = hash_ptr(dentry, FUSE_HASH_BITS);
    return &dentry_hash[i];
    }
#[no_mangle]
unsafe extern "C" fn fuse_advise_use_readdirplus(dir: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fuse_dentry_tree_del_node(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn fuse_dentry_tree_add_node(dentry: *mut dentry) {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_dentry_tree_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_epoch_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_dentry_tree_init() {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_dentry_tree_cleanup() {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_dentry_set_epoch(dentry: *mut dentry, epoch: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn __fuse_dentry_settime(dentry: *mut dentry, time: u64) {
    static inline void __fuse_dentry_settime(struct dentry *dentry, u64 time)
    {
    ((struct fuse_dentry *) dentry.d_fsdata).time = time;
    }
#[no_mangle]
pub unsafe extern "C" fn fuse_dentry_time(entry: *const dentry) -> u64 {
    static inline u64 fuse_dentry_time(const struct dentry *entry)
    {
    return ((struct fuse_dentry *) entry.d_fsdata).time;
    }
#[no_mangle]
unsafe extern "C" fn fuse_dentry_settime(dentry: *mut dentry, time: u64) {
    static void fuse_dentry_settime(struct dentry *dentry, u64 time)
    {
    struct fuse_conn *fc = get_fuse_conn_super(dentry.d_sb);
    let mut delete: bool = !time && fc.delete_stale;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_time_to_jiffies(sec: u64, nsec: u32) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_change_entry_timeout(entry: *mut dentry, o: *mut fuse_entry_out) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_invalidate_attr_mask(inode: *mut inode, mask: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_invalidate_attr(inode: *mut inode) {
    void fuse_invalidate_attr(struct inode *inode)
    {
    fuse_invalidate_attr_mask(inode, STATX_BASIC_STATS);
    }
#[no_mangle]
unsafe extern "C" fn fuse_dir_changed(dir: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_invalidate_atime(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_invalidate_entry_cache(entry: *mut dentry) {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_invalidate_entry(entry: *mut dentry) {
...
// Zero nodeid is same as -ENOENT
    ...
    fuse_change_attributes(inode, &outarg.attr, core::ptr::null_mut(),
    ATTR_TIMEOUT(&outarg),
    attr_version);
...
#[no_mangle]
unsafe extern "C" fn fuse_dentry_init(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_dentry_release(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn fuse_dentry_delete(dentry: *const dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_valid_type(m: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_valid_size(size: u64) -> bool {
    static bool fuse_valid_size(u64 size)
    {
    return size <= LLONG_MAX;
    }
#[no_mangle]
pub unsafe extern "C" fn fuse_invalid_attr(attr: *mut fuse_attr) -> bool {
...
// inode = fuse_iget(sb, outarg->nodeid, outarg->generation,
    ...
    int err, epoch;
    let mut outarg_valid: bool = true;
    bool locked;
    if (fuse_is_bad(dir))
    return ERR_PTR(-EIO);
    fc = get_fuse_conn_super(dir.i_sb);
    ...
    void *ptr;
    let mut total_len: u32 = sizeof(*header);
    int err, nr_ctx = 0;
...
// If no LSM is supporting this security hook ignore error
    ...
    {
    void *p;
    let mut newlen: u32 = buf.size + bytes;
    p = krealloc(buf.value, newlen, GFP_KERNEL);
    if (!p) {
    kfree(buf.value);
    buf.size = 0;
    buf.value = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fuse_ext_size(size: usize) -> u32 {
...
//
    ...
    let mut kgid: kgid_t = dir.i_gid;
    let mut vfsgid: vfsgid_t = make_vfsgid(idmap, fc.user_ns, kgid);
    let mut parent_gid: gid_t = from_kgid(fc.user_ns, kgid);
    let mut sg_len: u32 = fuse_ext_size(sizeof(*sg) + sizeof(sg.groups[0]));
    ...
    {
    struct fuse_conn *fc = get_fuse_conn_super(dentry.d_sb);
    let mut ext: fuse_in_arg = { .size = 0, .value = core::ptr::null_mut() };
    let mut err: c_int = 0;
    if (fc.init_security)
...
#[no_mangle]
unsafe extern "C" fn free_ext_value(args: *mut fuse_args) {
...
//
    ...
    struct fuse_file *ff;
    int epoch, err;
    let mut trunc: bool = flags & O_TRUNC;
...
// Store outarg for fuse_finish_open()
    ...
    fuse_sync_release(core::ptr::null_mut(), ff, flags);
...
//
    ...
    {
    struct fuse_mount *fm = get_fuse_mount(dir);
    let mut len: unsigned = strlen(link) + 1;
    FUSE_ARGS(args);
...
#[no_mangle]
pub unsafe extern "C" fn fuse_flush_time_update(inode: *mut inode) {
    void fuse_flush_time_update(struct inode *inode)
    {
    let mut err: c_int = sync_inode_metadata(inode, 1);
    mapping_set_error(inode.i_mapping, err);
    }
#[no_mangle]
unsafe extern "C" fn fuse_update_ctime_in_cache(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_update_ctime(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fuse_entry_unlinked(entry: *mut dentry) {
...
//
    ...
    clear_nlink(inode);
#[no_mangle]
pub unsafe extern "C" fn if(0: inode->i_nlink >) -> else {
...
#[no_mangle]
unsafe extern "C" fn fuse_unlink(dir: *mut inode, entry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_rmdir(dir: *mut inode, entry: *mut dentry) -> c_int {
...
// If request was interrupted, DEITY only knows if the
    ...
    fuse_update_ctime_in_cache(inode);
#[no_mangle]
pub unsafe extern "C" fn if(-EINTR: err ==) -> else {
    else if (err == -EINTR)
...
#[no_mangle]
unsafe extern "C" fn fuse_statx_to_attr(sx: *mut fuse_statx, attr: *mut fuse_attr) {
    ...
    struct fuse_mount *fm = get_fuse_mount(inode);
    let mut attr_version: u64 = fuse_get_attr_version(fm.fc);
    FUSE_ARGS(args);
    memset(&inarg, 0, sizeof(inarg));
    memset(&outarg, 0, sizeof(outarg));
...
// Directories have separate file-handle space
    ...
    let mut err: c_int = 0;
    bool sync;
    let mut inval_mask: u32 = READ_ONCE(fi.inval_mask);
    let mut cache_mask: u32 = fuse_get_cache_mask(inode);
// FUSE only supports basic stats and possibly btime
    ...
    sync = false;
#[no_mangle]
pub unsafe extern "C" fn if(AT_STATX_FORCE_SYNC: flags &) -> else {
    else if (flags & AT_STATX_FORCE_SYNC)
    sync = true;
#[no_mangle]
pub unsafe extern "C" fn if(AT_STATX_DONT_SYNC: flags &) -> else {
    else if (flags & AT_STATX_DONT_SYNC)
    sync = false;
#[no_mangle]
pub unsafe extern "C" fn if(~cache_mask: request_mask & inval_mask &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_update_attributes(inode: *mut inode, file: *mut file, mask: u32) -> c_int {
    int fuse_update_attributes(struct inode *inode, struct file *file, u32 mask)
    {
    return fuse_update_get_attr(&nop_mnt_idmap, inode, file, core::ptr::null_mut(), mask, 0);
    }
    int fuse_reverse_inval_entry(struct fuse_conn *fc, u64 parent_nodeid,
    u64 child_nodeid, struct qstr *name, u32 flags)
    {
    let mut err: c_int = -ENOTDIR;
    struct inode *parent;
    struct dentry *dir;
    struct dentry *entry;
    parent = fuse_ilookup(fc, parent_nodeid, core::ptr::null_mut());
    if (!parent)
    return -ENOENT;
...
#[no_mangle]
pub unsafe extern "C" fn fuse_permissible_uidgid(fc: *mut fuse_conn) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_allow_current_process(fc: *mut fuse_conn) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fuse_access(inode: *mut inode, mask: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_perm_getattr(inode: *mut inode, mask: c_int) -> c_int {
    static int fuse_perm_getattr(struct inode *inode, int mask)
    {
    if (mask & MAY_NOT_BLOCK)
    return -ECHILD;
    forget_all_cached_acls(inode);
    return fuse_do_getattr(&nop_mnt_idmap, inode, core::ptr::null_mut(), core::ptr::null_mut());
    }
//
...
//
    ...
    struct fuse_inode *fi = get_fuse_inode(inode);
    let mut perm_mask: u32 = STATX_MODE | STATX_UID | STATX_GID;
...
#[no_mangle]
unsafe extern "C" fn fuse_readlink_folio(inode: *mut inode, folio: *mut folio) -> c_int {
    static int fuse_readlink_folio(struct inode *inode, struct folio *folio)
    {
    struct fuse_mount *fm = get_fuse_mount(inode);
    let mut desc: fuse_folio_desc = { .length = folio_size(folio) - 1 };
...
#[no_mangle]
unsafe extern "C" fn fuse_dir_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_dir_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_mtime(ivalid: unsigned, trust_local_mtime: bool) -> bool {
...
// In all other cases update
    ...
    {
    let mut ivalid: unsigned = iattr.ia_valid;
    if (ivalid & ATTR_MODE)
    arg.valid |= FATTR_MODE,   arg.mode = iattr.ia_mode;
    if (ivalid & ATTR_UID) {
    let mut fsuid: kuid_t = from_vfsuid(idmap, fc.user_ns, iattr.ia_vfsuid);
    arg.valid |= FATTR_UID;
    arg.uid = from_kuid(fc.user_ns, fsuid);
    }
    if (ivalid & ATTR_GID) {
    let mut fsgid: kgid_t = from_vfsgid(idmap, fc.user_ns, iattr.ia_vfsgid);
    arg.valid |= FATTR_GID;
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_set_nowrite(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn __fuse_release_nowrite(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_release_nowrite(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_flush_times(inode: *mut inode, ff: *mut fuse_file) -> c_int {
...
//
    ...
    struct fuse_setattr_in inarg;
    struct fuse_attr_out outarg;
    let mut is_truncate: bool = false;
    let mut is_wb: bool = fc.writeback_cache && S_ISREG(inode.i_mode);
    loff_t oldsize;
    int err;
    let mut trust_local_cmtime: bool = is_wb;
    let mut fault_blocked: bool = false;
    u64 attr_version;
    if (!fc.default_permissions)
...
//
    ...
    fuse_change_attributes_common(inode, &outarg.attr, core::ptr::null_mut(),
    ATTR_TIMEOUT(&outarg),
...
//
    ...
    struct inode *inode = d_inode(entry);
    struct fuse_conn *fc = get_fuse_conn(inode);
    struct file *file = (attr.ia_valid & ATTR_FILE) ? attr.ia_file : core::ptr::null_mut();
    int ret;
    if (fuse_is_bad(inode))
    return -EIO;
...
//
    ret = fuse_do_getattr(idmap, inode, core::ptr::null_mut(), file);
    if (ret)
    return ret;
...
//
    ...
    return fuse_update_get_attr(idmap, inode, core::ptr::null_mut(), stat, request_mask, flags);
    }
...
#[no_mangle]
pub unsafe extern "C" fn fuse_init_common(inode: *mut inode) {
    void fuse_init_common(struct inode *inode)
    {
    inode.i_op = &fuse_common_inode_operations;
    }
#[no_mangle]
pub unsafe extern "C" fn fuse_init_dir(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn fuse_symlink_read_folio(null: *mut file, folio: *mut folio) -> c_int {
    static int fuse_symlink_read_folio(struct file *null, struct folio *folio)
    {
    let mut err: c_int = fuse_readlink_folio(folio.mapping.host, folio);
    if (!err)
...
#[no_mangle]
pub unsafe extern "C" fn fuse_init_symlink(inode: *mut inode) {
