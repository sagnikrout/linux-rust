...
//
    ...
    let mut fuse_max_pages_limit: c_uint = 256;
// default is no timeout
    ...
    "unprivileged user can set");
pub const FUSE_DEFAULT_BLKSIZE: c_int = 512;
...
// Initialize private data (i.e. everything except fi->inode)
    ...
    fuse_inode_backing_set(fi, core::ptr::null_mut());
    return &fi.inode;
    out_free_forget:
    kfree(fi.forget);
    out_free:
...
#[no_mangle]
unsafe extern "C" fn fuse_free_inode(inode: *mut inode) {
    ...
    sl.forget = core::ptr::null_mut();
    kfree(sl);
    }
#[no_mangle]
unsafe extern "C" fn fuse_evict_inode(inode: *mut inode) {
...
// Will write inode on close/munmap and in all other dirtiers
    ...
    fi.forget = core::ptr::null_mut();
    }
    if (fi.submount_lookup) {
    fuse_cleanup_submount_lookup(fc, fi.submount_lookup);
    fi.submount_lookup = core::ptr::null_mut();
    }
//
...
#[no_mangle]
unsafe extern "C" fn fuse_reconfigure(fsc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_squash_ino(ino64: u64) -> ino_t {
    static ino_t fuse_squash_ino(u64 ino64)
    {
    let mut ino: ino_t = (ino_t) ino64;
...
#[no_mangle]
pub unsafe extern "C" fn fuse_get_cache_mask(inode: *mut inode) -> u32 {
...
//
    ...
    fuse_init_dir(inode);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: S_ISLNK(inode->i_mode)) -> else {
...
#[no_mangle]
unsafe extern "C" fn fuse_inode_eq(inode: *mut inode, _nodeidp: *mut c_void) -> c_int {
    static int fuse_inode_eq(struct inode *inode, void *_nodeidp)
    {
    let mut nodeid: u64 = *(u64 *) _nodeidp;
...
#[no_mangle]
unsafe extern "C" fn fuse_inode_set(inode: *mut inode, _nodeidp: *mut c_void) -> c_int {
    ...
    let mut is_new_inode: bool = false;
//
...
// nodeid was reused, any I/O on the old inode should fail
    ...
    fuse_change_attributes_i(inode, attr, core::ptr::null_mut(), attr_valid, attr_version,
    evict_ctr);
    if (is_new_inode)
...
#[no_mangle]
pub unsafe extern "C" fn fuse_try_prune_one_inode(fc: *mut fuse_conn, nodeid: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_lock_inode(inode: *mut inode) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_unlock_inode(inode: *mut inode, locked: bool) {
...
#[no_mangle]
unsafe extern "C" fn fuse_umount_begin(sb: *mut super_block) {
...
// Only retire block-device-based superblocks.
    if (sb.s_bdev != core::ptr::null_mut())
    retire_super(sb);
    }
#[no_mangle]
unsafe extern "C" fn fuse_send_destroy(fm: *mut fuse_mount) {
...
#[no_mangle]
unsafe extern "C" fn convert_fuse_statfs(stbuf: *mut kstatfs, attr: *mut fuse_kstatfs) {
...
#[no_mangle]
unsafe extern "C" fn fuse_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_sync_fs_writes(fc: *mut fuse_conn) {
...
#[no_mangle]
unsafe extern "C" fn fuse_sync_fs(sb: *mut super_block, wait: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_opt_fd(fsc: *mut fs_context, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_parse_param(fsc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_free_fsc(fsc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn fuse_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(FUSE_DAX_NEVER: fc->dax_mode ==) -> else {
    else if (fc.dax_mode == FUSE_DAX_NEVER)
    seq_puts(m, ",dax=never");
#[no_mangle]
pub unsafe extern "C" fn if(FUSE_DAX_INODE_USER: fc->dax_mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn delayed_release(p: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_conn_put(fc: *mut fuse_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_conn_get_id(fc: *mut fuse_conn) -> dev_t {
...
#[no_mangle]
unsafe extern "C" fn sanitize_global_limit(limit: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn set_global_limit(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int set_global_limit(const char *val, const struct kernel_param *kp)
    {
    int rv;
...
#[no_mangle]
unsafe extern "C" fn process_init_limits(fc: *mut fuse_conn, arg: *mut fuse_init_out) {
    static void process_init_limits(struct fuse_conn *fc, struct fuse_init_out *arg)
    {
    let mut cap_sys_admin: c_int = capable(CAP_SYS_ADMIN);
    if (arg.minor < 13)
    return;
    sanitize_global_limit(&max_user_bgreq);
    sanitize_global_limit(&max_user_congthresh);
    if (arg.max_background) {
    let mut max_background: c_uint = arg.max_background;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fuse_init_args {
    pub args: fuse_args,
    pub in: fuse_init_in,
    pub out: fuse_init_out,
    pub fm: *mut fuse_mount,
}

#[no_mangle]
unsafe extern "C" fn process_init_reply(args: *mut fuse_args, error: c_int) {
    ...
    let mut io_uring_enabled: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(FUSE_EXPLICIT_INVAL_DATA: flags &) -> else {
...
//
    ...
    fc.conn_init = 0;
    fc.conn_error = 1;
    fuse_chan_set_initialized(fc.chan, core::ptr::null_mut());
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_send_init(fm: *mut fuse_mount) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_free_conn(fc: *mut fuse_conn) {
...
#[no_mangle]
unsafe extern "C" fn fuse_bdi_init(fc: *mut fuse_conn, sb: *mut super_block) -> c_int {
...
//
    ...
    {
    let mut atime: timespec64 = inode_get_atime(&fi.inode);
    let mut mtime: timespec64 = inode_get_mtime(&fi.inode);
    let mut ctime: timespec64 = inode_get_ctime(&fi.inode);
...
#[no_mangle]
unsafe extern "C" fn fuse_sb_defaults(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn fuse_get_tree_submount(fsc: *mut fs_context) -> c_int {
    ...
    fsc.s_fs_info = fm;
    sb = sget_fc(fsc, core::ptr::null_mut(), set_anon_super_fc);
    if (fsc.s_fs_info)
...
#[no_mangle]
pub unsafe extern "C" fn fuse_init_fs_context_submount(fsc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_fill_super_common(sb: *mut super_block, ctx: *mut fuse_fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_fill_super(sb: *mut super_block, fsc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_set_no_super(sb: *mut super_block, fsc: *mut fs_context) -> c_int {
    static int fuse_set_no_super(struct super_block *sb, struct fs_context *fsc)
    {
    return -ENOTCONN;
    }
#[no_mangle]
unsafe extern "C" fn fuse_test_super(sb: *mut super_block, fsc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_get_tree(fsc: *mut fs_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fuse_init_fs_context(fsc: *mut fs_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_mount_remove(fm: *mut fuse_mount) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_conn_destroy(fm: *mut fuse_mount) {
...
#[no_mangle]
unsafe extern "C" fn fuse_sb_destroy(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_mount_destroy(fm: *mut fuse_mount) {
...
#[no_mangle]
unsafe extern "C" fn fuse_kill_sb_anon(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn fuse_kill_sb_blk(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn register_fuseblk() -> c_int {
    static inline int register_fuseblk(void)
    {
    return register_filesystem(&fuseblk_fs_type);
    }
#[no_mangle]
pub unsafe extern "C" fn unregister_fuseblk() {
...
#[no_mangle]
unsafe extern "C" fn fuse_inode_init_once(foo: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fuse_fs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fuse_fs_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn fuse_sysfs_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fuse_sysfs_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn fuse_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fuse_exit() -> void __exit {
