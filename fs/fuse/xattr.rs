...
#[no_mangle]
unsafe extern "C" fn fuse_verify_xattr_list(list: *mut c_char, size: usize) -> c_int {
    static int fuse_verify_xattr_list(char *list, size_t size)
    {
    let mut origsize: usize = size;
    while (size) {
    let mut thislen: usize = strnlen(list, size);
...
#[no_mangle]
pub unsafe extern "C" fn fuse_listxattr(entry: *mut dentry, list: *mut c_char, size: usize) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_removexattr(inode: *mut inode, name: *const c_char) -> c_int {
