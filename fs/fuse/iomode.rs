...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_is_io_cache_wait(fi: *mut fuse_inode) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fuse_file_cached_io_open(inode: *mut inode, ff: *mut fuse_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_inode_uncached_io_start(fi: *mut fuse_inode, fb: *mut fuse_backing) -> c_int {
...
// fuse inode holds a single refcount of backing file
    ...
    WARN_ON_ONCE(oldfb != core::ptr::null_mut());
    } else {
    fuse_backing_put(fb);
    }
    unlock:
...
#[no_mangle]
pub unsafe extern "C" fn fuse_inode_uncached_io_end(fi: *mut fuse_inode) {
    void fuse_inode_uncached_io_end(struct fuse_inode *fi)
    {
    struct fuse_backing *oldfb = core::ptr::null_mut();
    spin_lock(&fi.lock);
    WARN_ON(fi.iocachectr >= 0);
    fi.iocachectr++;
    if (!fi.iocachectr) {
...
//
    ...
    FOPEN_NOFLUSH)
#[no_mangle]
unsafe extern "C" fn fuse_file_passthrough_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_file_io_open(file: *mut file, inode: *mut inode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fuse_file_io_release(ff: *mut fuse_file, inode: *mut inode) {
