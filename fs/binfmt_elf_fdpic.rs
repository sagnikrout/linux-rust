...
#[no_mangle]
unsafe extern "C" fn init_elf_fdpic_binfmt() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_elf_fdpic_binfmt() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn is_elf(hdr: *mut elfhdr, file: *mut file) -> c_int {
...
pub const elf_check_fdpic(x): c_int = 0;

pub const elf_check_const_displacement(x): c_int = 0;

#[no_mangle]
unsafe extern "C" fn is_constdisp(hdr: *mut elfhdr) -> c_int {
...
//
    ...
    unsigned long size;
    int retval, loop;
    let mut pos: loff_t = params.hdr.e_phoff;
...
//
#[no_mangle]
unsafe extern "C" fn load_elf_fdpic_binary(bprm: *mut linux_binprm) -> c_int {
    ...
    char *interpreter_name = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(ELF_FDPIC_FLAG_NOEXEC_STACK: exec_params.flags &) -> else {
    ...
    executable_stack = EXSTACK_ENABLE_X;
#[no_mangle]
pub unsafe extern "C" fn if(ELF_FDPIC_FLAG_NOEXEC_STACK: interp_params.flags &) -> else {
...
// create a stack area and zero-size brk area
    ...
    current.mm.start_brk = vm_mmap(core::ptr::null_mut(), 0, stack_size, stack_prot,
...
//
    ...
    let mut platform_len: usize = 0, len;
...
pub const DLINFO_ITEMS: c_int = 15;
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(_arg: elf_addr_t))) -> *mut ei_index {
...
// fill in the argv[] array
    ...
    if (put_user(core::ptr::null_mut(), argv))
    return -EFAULT;
...
// fill in the envv[] array
    ...
    if (put_user(core::ptr::null_mut(), envp))
    return -EFAULT;
...
// allocate one big anon block for everything
    maddr = vm_mmap(core::ptr::null_mut(), load_addr, top - base,
...
//
    ...
    if (excess > excess1) {
    let mut xaddr: c_ulong = maddr + phdr.p_filesz + excess1;
    unsigned long xmaddr;
    flags |= MAP_FIXED | MAP_ANONYMOUS;
    xmaddr = vm_mmap(core::ptr::null_mut(), xaddr, excess - excess1,
    prot, flags, 0);
    kdebug("mmap[%d] <anon>"
...
#[no_mangle]
pub unsafe extern "C" fn fill_elf_fdpic_header(elf: *mut elfhdr, segs: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fill_elf_note_phdr(phdr: *mut elf_phdr, sz: c_int, offset: loff_t) {
...
//
#[no_mangle]
unsafe extern "C" fn elf_fdpic_core_dump(cprm: *mut coredump_params) -> c_int {
    static int elf_fdpic_core_dump(struct coredump_params *cprm)
    {
    let mut has_dumped: c_int = 0;
    int segs;
    int i;
    struct elfhdr *elf = core::ptr::null_mut();
    let mut offset: loff_t = 0, dataoff;
    struct memelfnote psinfo_note, auxv_note;
    struct elf_prpsinfo *psinfo = core::ptr::null_mut();	/* NT_PRPSINFO */
    struct elf_thread_status *thread_list = core::ptr::null_mut();
    let mut thread_status_size: c_int = 0;
    elf_addr_t *auxv;
