...
//
#[no_mangle]
pub unsafe extern "C" fn initial_idmapping(ns: *const user_namespace) -> bool {
    static inline bool initial_idmapping(const struct user_namespace *ns)
    {
    let mut ns: return = = &init_user_ns;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn vfsgid_in_group_p(vfsgid: vfsgid_t) -> c_int {
...
pub unsafe extern "C" fn vfsgid_in_group_p(vfsgid: vfsgid_t) -> c_int {
    ...
    let mut nr_extents: u32 = READ_ONCE(map_from.nr_extents);
...
#[no_mangle]
unsafe extern "C" fn free_mnt_idmap(idmap: *mut mnt_idmap) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_idmap_put(idmap: *mut mnt_idmap) {
...
#[no_mangle]
pub unsafe extern "C" fn statmount_mnt_idmap(idmap: *mut mnt_idmap, seq: *mut seq_file, uid_map: bool) -> c_int {
