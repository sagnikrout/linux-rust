...
pub const DEBUGFS_DEFAULT_MODE: c_int = 0700;
    static struct vfsmount *debugfs_mount;
    static int debugfs_mount_count;
    static bool debugfs_registered;
    let mut __ro_after_init: static bool debugfs_enabled = IS_ENABLED(CONFIG_DEBUG_FS_ALLOW_ALL);
//
...
#[no_mangle]
unsafe extern "C" fn debugfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _debugfs_apply_options(sb: *mut super_block, remount: bool) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_apply_options(sb: *mut super_block) {
    static void debugfs_apply_options(struct super_block *sb)
    {
    _debugfs_apply_options(sb, false);
    }
#[no_mangle]
unsafe extern "C" fn debugfs_apply_options_remount(sb: *mut super_block) {
    static void debugfs_apply_options_remount(struct super_block *sb)
    {
    _debugfs_apply_options(sb, true);
    }
#[no_mangle]
unsafe extern "C" fn debugfs_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_release_dentry(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
//
    ...
    const struct file_operations *fops)
    {
    return __debugfs_create_file(name, mode, parent, data, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn __debugfs_file_removed(dentry: *mut dentry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debugfs_remove(dentry: *mut dentry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debugfs_lookup_and_remove(name: *const c_char, parent: *mut dentry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 2, dentry: *mut 3) debugfs_change_name(struct dentry, fmt: *const c_char, ...) -> c_int {
...
// it isn't an error to rename a thing to itself
    ...
    fsnotify_move(dir, dir, &old_name.name, d_is_dir(dentry), core::ptr::null_mut(), dentry);
...
//
#[no_mangle]
pub unsafe extern "C" fn debugfs_initialized() -> bool {
...
#[no_mangle]
unsafe extern "C" fn debugfs_kernel(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "no-mount")) -> else {
...
#[no_mangle]
unsafe extern "C" fn debugfs_init() -> int __init {
    ...
    init_once);
    if (debugfs_inode_cachep == core::ptr::null_mut()) {
