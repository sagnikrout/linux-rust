...
//! Source: fs/smb/client/smb1transport.c
#![no_std]
...
pub const CIFS_MAX_IOV_SIZE: c_int = 8;
...
//
    ...
    bool log_error)
    {
    let mut len: c_uint = mid.response_pdu_len;
...
// BB special case reconnect tid and uid here?
    ...
    let mut resp_iov: kvec = {};
    let mut iov: kvec = { .iov_base = in_buf, .iov_len = in_len };
    let mut rqst: smb_rqst = { .rq_iov = &iov, .rq_nvec = 1 };
    int resp_buf_type;
    let mut rc: c_int = 0;
...
// check for parm and data offset going beyond end of smb
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(data_in_this_rsp: total_data_size <) -> else {
