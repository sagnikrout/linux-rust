...
// if (GlobalTotalActiveXid == 0)
    ...
    {
    struct cifs_server_iface *iface = core::ptr::null_mut(), *niface = core::ptr::null_mut();
    if (buf_to_free == core::ptr::null_mut()) {
...
// else ret_buf->cfids is already set to NULL above
    ...
    cifs_buf_get(void)
    {
    void *ret_buf = core::ptr::null_mut();
//
// SMB2 header is bigger than CIFS one - no problems to clean some
// more bytes for CIFS.
//
    let mut buf_size: usize = sizeof(struct smb2_hdr);
//
...
#[no_mangle]
pub unsafe extern "C" fn if(CIFS_LARGE_BUFFER: resp_buftype ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn cifs_set_oplock_level(cinode: *mut cifsInodeInfo, oplock: __u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cifs_get_writer(cinode: *mut cifsInodeInfo) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cifs_put_writer(cinode: *mut cifsInodeInfo) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cifs_queue_oplock_break(cfile: *mut cifsFileInfo) {
...
#[no_mangle]
pub unsafe extern "C" fn cifs_done_oplock_break(cinode: *mut cifsInodeInfo) {
...
//
    ...
    {
    let mut is_deferred: bool = false;
...
//
    ...
    {
    struct cifsFileInfo *cfile = core::ptr::null_mut(), *failed_cfile = core::ptr::null_mut();
    ...
    {
    struct cifsFileInfo *cfile, *failed_cfile = core::ptr::null_mut();
    struct file_list *tmp_list, *tmp_next_list;
    LIST_HEAD(file_head);
...
#[no_mangle]
pub unsafe extern "C" fn cifs_close_all_deferred_files_sb(cifs_sb: *mut cifs_sb_info) {
...
// target_nodes = kzalloc_objs(struct dfs_info3_param, *num_of_nodes);
    if (*target_nodes == core::ptr::null_mut()) {
    rc = -ENOMEM;
    goto parse_DFS_referrals_exit;
    }
...
// collect necessary data from referrals
    ...
    if (is_unicode) {
    let mut search_name_utf16_len: usize = search_name_len * 2 + 2;
    __le16 *tmp;
...
#[no_mangle]
pub unsafe extern "C" fn extract_unc_hostname(unc: *const c_char, h: *const c_char, len: *mut usize) {
...
//
#[no_mangle]
pub unsafe extern "C" fn copy_path_name(dst: *mut c_char, src: *const c_char) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct super_cb_data {
    pub data: *mut c_void,
    pub sb: *mut super_block,
}

#[no_mangle]
unsafe extern "C" fn tcon_super_cb(sb: *mut super_block, arg: *mut c_void) {
    ...
    &cifs_fs_type, &smb3_fs_type, core::ptr::null_mut(),
    };
    for (; *fs_type; fs_type++) {
...
#[no_mangle]
unsafe extern "C" fn __cifs_put_super(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn cifs_put_tcp_super(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn cifs_update_super_prepath(cifs_sb: *mut cifs_sb_info, prefix: *mut c_char) -> c_int {
    int cifs_update_super_prepath(struct cifs_sb_info *cifs_sb, char *prefix)
    {
    int rc;
    kfree(cifs_sb.prepath);
    cifs_sb.prepath = core::ptr::null_mut();
    if (prefix && *prefix) {
...
//
    ...
    struct dfs_info3_param *refs = core::ptr::null_mut();
    let mut num_refs: c_int = 0;
//
...
#[no_mangle]
pub unsafe extern "C" fn cifs_wait_for_server_reconnect(server: *mut TCP_Server_Info, retry: bool) -> c_int {
