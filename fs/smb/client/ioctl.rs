...
//
    ...
    __le16 *utf16_path = core::ptr::null_mut(), root_path;
    let mut rc: c_int = 0;
    ...
    struct cifsFileInfo *tmp_cfile = core::ptr::null_mut();
    let mut fid: cifs_fid = {};
    const char *full_path;
    let mut oplock: __u32 = 0;
    u64 uniqueid;
    void *page;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn smb_mnt_get_tcon_info(tcon: *mut cifs_tcon, arg: *mut void __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn cifs_shutdown(sb: *mut super_block, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cifs_dump_full_key(tcon: *mut cifs_tcon, in: *mut smb3_full_key_debug_info __user) -> c_int {
...
// otherwise if a session id is given, look for it in all our sessions
    struct cifs_ses *ses_it = core::ptr::null_mut();
    struct TCP_Server_Info *server_it = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cifs_ioctl(filep: *mut file, command: c_uint, arg: c_ulong) -> c_long {
