...
//! Source: fs/smb/client/smb1session.c
#![no_std]
...
// pbcc_area = bcc_ptr;
    ...
    let mut bytes_ret: c_int = 0;
// copy domain
    if (ses.domainName == core::ptr::null_mut()) {
//
...
// 2000 big enough to fit max user, domain, NOS name etc.
    ...
    sess_data.iov[0].iov_base = core::ptr::null_mut();
...
// unicode string area must be word-aligned
    ...
    out:
    sess_data.result = rc;
    sess_data.func = core::ptr::null_mut();
    ...
    __u32 capabilities;
    __u16 bytes_remaining;
    struct key *spnego_key = core::ptr::null_mut();
...
// bcc_ptr = 0;
    ...
    __u16 bytes_remaining;
    char *bcc_ptr;
    unsigned char *ntlmsspblob = core::ptr::null_mut();
    u16 blob_len;
...
#[no_mangle]
unsafe extern "C" fn select_sec(sess_data: *mut sess_data) -> c_int {
    ...
    WARN(1, "%s: ses == core::ptr::null_mut()!", __func__);
    return -EINVAL;
    }
