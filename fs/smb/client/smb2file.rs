...
//! Source: fs/smb/client/smb2file.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn smb2_fix_symlink_target_type(target: *mut c_char, directory: bool, cifs_sb: *mut cifs_sb_info) -> c_int {
...
//
    ...
    let mut retry_without_read_attributes: bool = false;
    smb2_path = cifs_convert_path_to_utf16(oparms.path, oparms.cifs_sb);
    if (smb2_path == core::ptr::null_mut())
    return -ENOMEM;
//
...
//
    ...
    rc = SMB2_open(xid, oparms, smb2_path, &smb2_oplock, data, core::ptr::null_mut(), &err_iov,
    &err_buftype);
...
//
    ...
    if (!rc) {
    let mut directory: bool = le32_to_cpu(data.fi.Attributes) & ATTR_DIRECTORY;
...
// default timeout is 0, servers pick default (120 seconds)
    ...
    CIFSMaxBufSize, core::ptr::null_mut(), core::ptr::null_mut() /* no return info */);
    if (rc == -EOPNOTSUPP) {
    cifs_dbg(VFS,
...
// oplock = smb2_oplock;
    ...
    let mut length: __u64 = 1 + flock.fl_end - flock.fl_start;
    LIST_HEAD(tmp_llist);
//
