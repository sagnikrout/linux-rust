...
//! Source: fs/smb/common/cifs_md4.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cifs_md4_init(mctx: *mut md4_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cifs_md4_update(mctx: *mut md4_ctx, data: *const u8, len: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cifs_md4_final(mctx: *mut md4_ctx, out: *mut u8) -> c_int {
