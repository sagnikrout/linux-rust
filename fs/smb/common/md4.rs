...
extern "C" {
    pub fn cifs_md4_init(mctx: *mut md4_ctx) -> c_int;
}
extern "C" {
    pub fn cifs_md4_update(mctx: *mut md4_ctx, data: *const u8, len: c_uint) -> c_int;
}
extern "C" {
    pub fn cifs_md4_final(mctx: *mut md4_ctx, out: *mut u8) -> c_int;
}
