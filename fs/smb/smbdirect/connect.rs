...
//! Source: fs/smb/smbdirect/connect.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connect(sc: *mut smbdirect_socket, dst: *const sockaddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connect_setup_connection(sc: *mut smbdirect_socket) -> c_int {
    static int smbdirect_connect_setup_connection(struct smbdirect_socket *sc)
    {
    ...
    struct sockaddr *dst_addr = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connect_resolve_route(sc: *mut smbdirect_socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connect_rdma_connect(sc: *mut smbdirect_socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connect_negotiate_start(sc: *mut smbdirect_socket) -> c_int {
    static int smbdirect_connect_negotiate_start(struct smbdirect_socket *sc)
    {
    const struct smbdirect_socket_parameters *sp = &sc.parameters;
    struct smbdirect_recv_io *recv_io = core::ptr::null_mut();
    struct smbdirect_send_io *send_io = core::ptr::null_mut();
    struct smbdirect_negotiate_req *nreq = core::ptr::null_mut();
    int ret;
...
//
    ...
    send_io.wr.next = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connect_negotiate_send_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void smbdirect_connect_negotiate_send_done(struct ib_cq *cq, struct ib_wc *wc)
    {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connect_negotiate_recv_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void smbdirect_connect_negotiate_recv_done(struct ib_cq *cq, struct ib_wc *wc)
    {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connect_negotiate_recv_work(work: *mut work_struct) {
    static void smbdirect_connect_negotiate_recv_work(struct work_struct *work)
    {
