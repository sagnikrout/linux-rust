...
//! Source: fs/smb/smbdirect/accept.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn smbdirect_accept_init_params(sc: *mut smbdirect_socket) -> c_int {
    static int smbdirect_accept_init_params(struct smbdirect_socket *sc)
    {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_accept_negotiate_recv_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void smbdirect_accept_negotiate_recv_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct smbdirect_recv_io *recv_io =
...
#[no_mangle]
unsafe extern "C" fn smbdirect_accept_negotiate_recv_work(work: *mut work_struct) {
    static void smbdirect_accept_negotiate_recv_work(struct work_struct *work)
    {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_accept_negotiate_finish(sc: *mut smbdirect_socket, ntstatus: u32) {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_accept_negotiate_send_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void smbdirect_accept_negotiate_send_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct smbdirect_send_io *send_io =
...
#[no_mangle]
unsafe extern "C" fn smbdirect_socket_wait_for_accept(lsc: *mut smbdirect_socket, timeo: c_long) -> c_long {
    ...
    accept.list);
    if (nsc) {
    nsc.accept.listener = core::ptr::null_mut();
