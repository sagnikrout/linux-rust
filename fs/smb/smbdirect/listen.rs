...
//! Source: fs/smb/smbdirect/listen.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_socket_listen(sc: *mut smbdirect_socket, backlog: c_int) -> c_int {
...
//
    ...
    unsigned long flags;
    let mut backlog: usize = max_t(size_t, 1, lsc.listen.backlog);
    size_t psockets;
    size_t rsockets;
    int ret;
...
//
    nsc.ib.dev = core::ptr::null_mut();
    nsc.rdma.cm_id = core::ptr::null_mut();
