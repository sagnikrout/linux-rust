...
//! Source: fs/smb/smbdirect/connection.c
#![no_std]
...
pub struct smbdirect_map_sges {
    ...
    pub direction: enum dma_data_direction,
}
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_qp_event_handler(event: *mut ib_event, context: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_rdma_established(sc: *mut smbdirect_socket) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_negotiation_done(sc: *mut smbdirect_socket) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_create_qp(sc: *mut smbdirect_socket) -> c_int {
...
//
    ...
    sc.ib.send_cq = core::ptr::null_mut();
    goto err;
    }
    ...
    sc.ib.recv_cq = core::ptr::null_mut();
    goto err;
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_destroy_qp(sc: *mut smbdirect_socket) {
    void smbdirect_connection_destroy_qp(struct smbdirect_socket *sc)
    {
    if (sc.ib.qp) {
    ib_drain_qp(sc.ib.qp);
    sc.ib.qp = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_create_mem_pools(sc: *mut smbdirect_socket) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_destroy_mem_pools(sc: *mut smbdirect_socket) {
...
//
    ...
    sc.recv_io.mem.pool = core::ptr::null_mut();
    kmem_cache_destroy(sc.recv_io.mem.cache);
    sc.recv_io.mem.cache = core::ptr::null_mut();
    mempool_destroy(sc.send_io.mem.pool);
    sc.send_io.mem.pool = core::ptr::null_mut();
    kmem_cache_destroy(sc.send_io.mem.cache);
    sc.send_io.mem.cache = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_free_send_io(msg: *mut smbdirect_send_io) {
...
//
    ...
    {
    struct smbdirect_recv_io *msg = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_put_recv_io(msg: *mut smbdirect_recv_io) {
...
//
    ...
    let mut ird32: u32 = be32_to_cpu(ird_ord_hdr[0]);
    let mut ord32: u32 = be32_to_cpu(ird_ord_hdr[1]);
//
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_is_connected(sc: *mut smbdirect_socket) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_wait_for_connected(sc: *mut smbdirect_socket) -> c_int {
    ...
    const struct sockaddr *src = core::ptr::null_mut();
    const struct sockaddr *dst = core::ptr::null_mut();
...
//
    ...
    smbdirect_socket_schedule_cleanup(sc, ret);
    if (sc.first_error) {
    let mut lvl: c_int = SMBDIRECT_LOG_ERR;
    ret = sc.first_error;
    if (ret == -ENODEV)
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_idle_timer_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_grant_recv_credits(sc: *mut smbdirect_socket) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_request_keep_alive(sc: *mut smbdirect_socket) -> bool {
...
//
    ...
    ret = ib_post_send(sc.ib.qp, wr, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_send_wait_zero_pending(sc: *mut smbdirect_socket) -> c_int {
...
//
    ...
    const struct smbdirect_socket_parameters *sp = &sc.parameters;
    struct smbdirect_send_batch batch;
    let mut total_count: c_int = iov_iter_count(iter);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_send_io_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void smbdirect_connection_send_io_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct smbdirect_send_io *msg =
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_send_immediate_work(work: *mut work_struct) {
    static void smbdirect_connection_send_immediate_work(struct work_struct *work)
    {
    struct smbdirect_socket *sc =
    ...
    ret = smbdirect_connection_send_single_iter(sc, core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    if (ret < 0) {
    smbdirect_log_write(sc, SMBDIRECT_LOG_ERR,
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_post_recv_io(msg: *mut smbdirect_recv_io) -> c_int {
    ...
    ret = ib_post_recv(sc.ib.qp, &recv_wr, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_recv_io_done(cq: *mut ib_cq, wc: *mut ib_wc) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_recv_io_refill(sc: *mut smbdirect_socket) -> c_int {
    int smbdirect_connection_recv_io_refill(struct smbdirect_socket *sc)
    {
    int missing;
    let mut posted: c_int = 0;
    if (unlikely(sc.first_error))
    return sc.first_error;
//
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_recv_io_refill_work(work: *mut work_struct) {
    static void smbdirect_connection_recv_io_refill_work(struct work_struct *work)
    {
    struct smbdirect_socket *sc =
    ...
    struct smbdirect_data_transfer *data_transfer;
    let mut size: usize = iov_iter_count(&msg.msg_iter);
...
//
    ...
    let mut rfc1002_hdr: __be32 = cpu_to_be32(rfc1002_len);
...
//
    ...
    let mut start: c_ulong = iter.iov_offset;
    unsigned int i;
    let mut ret: isize = 0;
...
//
    ...
    let mut ret: isize = 0;
    let mut offset: usize = iter.iov_offset;
    ...
    if (offset < fsize) {
    let mut part: usize = umin(maxsize, fsize - offset);
    bool ok;
    ok = smbdirect_map_sges_single_page(state,
    folio_page(folio, 0),
    offset,
...
//
    ...
    {
    ssize_t ret;
    let mut before: usize = state.num_sge;
    if (WARN_ON_ONCE(iov_iter_rw(iter) != ITER_SOURCE))
    return -EIO;
