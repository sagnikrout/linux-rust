...
//
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_create_mr_list(sc: *mut smbdirect_socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_mr_io_disable_locked(mr: *mut smbdirect_mr_io) {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_mr_io_free_locked(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_destroy_mr_list(sc: *mut smbdirect_socket) {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_mr_io_register_done(cq: *mut ib_cq, wc: *mut ib_wc) {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_mr_io_local_inv_done(cq: *mut ib_cq, wc: *mut ib_wc) {
...
//
    ...
    if (!mr) {
    smbdirect_log_rdma_mr(sc, SMBDIRECT_LOG_ERR,
    "smbdirect_connection_get_mr_io returning core::ptr::null_mut()\n");
    return core::ptr::null_mut();
    }
    mutex_lock(&mr.mutex);
    ...
    ret = ib_map_mr_sg(mr.mr, mr.sgt.sgl, num_mapped, core::ptr::null_mut(), PAGE_SIZE);
    if (ret != num_mapped) {
    smbdirect_log_rdma_mr(sc, SMBDIRECT_LOG_ERR,
...
//
    ret = ib_post_send(sc.ib.qp, &reg_wr.wr, core::ptr::null_mut());
    if (!ret) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn smbdirect_connection_deregister_mr_io(mr: *mut smbdirect_mr_io) {
