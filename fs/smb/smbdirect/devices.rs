...
//! Source: fs/smb/smbdirect/devices.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn smbdirect_ib_device_rdma_capable_node_type(ib_dev: *mut ib_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_ib_client_add(ib_dev: *mut ib_device) -> c_int {
    static int smbdirect_ib_client_add(struct ib_device *ib_dev)
    {
    let mut node_type: u8 = smbdirect_ib_device_rdma_capable_node_type(ib_dev);
    ...
    let mut core_cap_flags: u32 = ib_pi ? ib_pi.core_cap_flags : 0;
...
#[no_mangle]
unsafe extern "C" fn smbdirect_ib_client_remove(ib_dev: *mut ib_device, client_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_ib_client_rename(ib_dev: *mut ib_device, client_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_netdev_find_rdma_capable_node_type(netdev: *mut net_device) -> u8 {
    static u8 smbdirect_netdev_find_rdma_capable_node_type(struct net_device *netdev)
    {
    struct smbdirect_device *sdev;
    let mut node_type: u8 = RDMA_NODE_UNSPECIFIED;
...
//
#[no_mangle]
pub unsafe extern "C" fn smbdirect_netdev_rdma_capable_node_type(netdev: *mut net_device) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_devices_init() -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn smbdirect_devices_exit() -> __exit void {
