...
//
    ...
    size_t nentries)
    {
    let mut high: bool = is_vmalloc_addr(buf);
    struct page *page;
    size_t offset, len;
    let mut i: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_rdma_read_done(cq: *mut ib_cq, wc: *mut ib_wc) {
...
#[no_mangle]
unsafe extern "C" fn smbdirect_connection_rdma_write_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    ...
    let mut direction: enum dma_data_direction = is_read ? DMA_FROM_DEVICE : DMA_TO_DEVICE;
