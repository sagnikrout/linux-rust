...
//! Source: fs/smb/server/smb2ops.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn init_smb2_1_server(conn: *mut ksmbd_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_smb3_0_server(conn: *mut ksmbd_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_smb3_02_server(conn: *mut ksmbd_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_smb3_11_server(conn: *mut ksmbd_conn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn init_smb2_max_read_size(sz: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn init_smb2_max_write_size(sz: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn init_smb2_max_trans_size(sz: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn init_smb2_max_credits(sz: c_uint) {
