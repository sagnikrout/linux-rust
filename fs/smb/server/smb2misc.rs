...
//! Source: fs/smb/server/smb2misc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_smb2_hdr(hdr: *mut smb2_hdr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smb2_calc_size(buf: *mut c_void, len: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smb2_query_info_req_len(h: *mut smb2_query_info_req) -> c_int {
    static inline int smb2_query_info_req_len(struct smb2_query_info_req *h)
    {
    return le32_to_cpu(h.InputBufferLength);
    }
#[no_mangle]
pub unsafe extern "C" fn smb2_query_info_resp_len(h: *mut smb2_query_info_req) -> c_int {
    static inline int smb2_query_info_resp_len(struct smb2_query_info_req *h)
    {
    return le32_to_cpu(h.OutputBufferLength);
    }
#[no_mangle]
pub unsafe extern "C" fn smb2_set_info_req_len(h: *mut smb2_set_info_req) -> c_int {
    static inline int smb2_set_info_req_len(struct smb2_set_info_req *h)
    {
    return le32_to_cpu(h.BufferLength);
    }
#[no_mangle]
pub unsafe extern "C" fn smb2_read_req_len(h: *mut smb2_read_req) -> c_int {
    static inline int smb2_read_req_len(struct smb2_read_req *h)
    {
    return le32_to_cpu(h.Length);
    }
#[no_mangle]
pub unsafe extern "C" fn smb2_write_req_len(h: *mut smb2_write_req) -> c_int {
    static inline int smb2_write_req_len(struct smb2_write_req *h)
    {
    return le32_to_cpu(h.Length);
    }
#[no_mangle]
pub unsafe extern "C" fn smb2_query_dir_req_len(h: *mut smb2_query_directory_req) -> c_int {
    static inline int smb2_query_dir_req_len(struct smb2_query_directory_req *h)
    {
    return le32_to_cpu(h.OutputBufferLength);
    }
#[no_mangle]
pub unsafe extern "C" fn smb2_ioctl_req_len(h: *mut smb2_ioctl_req) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smb2_ioctl_resp_len(h: *mut smb2_ioctl_req) -> c_int {
    ...
    let mut req_len: c_uint = 0, expect_resp_len = 0, calc_credit_num, max_len;
    let mut credit_charge: c_ushort = le16_to_cpu(hdr.CreditCharge);
    void *__hdr = hdr;
    let mut ret: c_int = 0;
    switch (hdr.Command) {
    case SMB2_QUERY_INFO:
...
//
    ...
    {
    struct ksmbd_conn *conn = work.conn;
    let mut mid: u64 = le64_to_cpu(hdr.MessageId);
...
#[no_mangle]
pub unsafe extern "C" fn ksmbd_smb2_check_message(work: *mut ksmbd_work) -> c_int {
    ...
    let mut len: __u32 = get_rfc1002_len(work.request_buf);
    ...
    len = next_cmd;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: work->next_smb2_rcv_hdr_off) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn smb2_negotiate_request(work: *mut ksmbd_work) -> c_int {
