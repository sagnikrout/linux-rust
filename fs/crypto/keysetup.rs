...
#[no_mangle]
unsafe extern "C" fn put_crypt_info(ci: *mut fscrypt_inode_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ci->ci_owns_key) -> else {
...
//
    ...
    struct fscrypt_master_key *mk = core::ptr::null_mut();
    int res;
...
//
    if (cmpxchg_release(fscrypt_inode_info_addr(inode), core::ptr::null_mut(), crypt_info) ==
    core::ptr::null_mut()) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_get_encryption_info(inode: *mut inode, allow_unsupported: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_put_encryption_info(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_free_inode(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_drop_inode(inode: *mut inode) -> c_int {
