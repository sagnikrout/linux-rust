...
//
#[no_mangle]
unsafe extern "C" fn fscrypt_valid_enc_modes_v1(contents_mode: u32, filenames_mode: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fscrypt_valid_enc_modes_v2(contents_mode: u32, filenames_mode: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fscrypt_get_policy(inode: *mut inode, policy: *mut union fscrypt_policy) -> c_int {
...
//
    ...
    return inode.i_sb.s_cop.set_context(inode, &ctx, ctxsize, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_set_policy(filp: *mut file, arg: *const void __user) -> c_int {
    ...
    ret = -ENOTDIR;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_DEADDIR(inode)) -> else {
    else if (IS_DEADDIR(inode))
    ret = -ENOENT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !inode->i_sb->s_cop->empty_dir(inode)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_get_policy(filp: *mut file, arg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_get_policy_ex(filp: *mut file, uarg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_get_nonce(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_has_permitted_context(parent: *mut inode, child: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_context_for_new_inode(ctx: *mut c_void, inode: *mut inode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_set_context(inode: *mut inode, fs_data: *mut c_void) -> c_int {
