...
// Hash table that maps fscrypt_key_specifier to fscrypt_master_key
    pub key_hashtable: [hlist_head; 128],
}

#[no_mangle]
unsafe extern "C" fn wipe_master_key_secret(secret: *mut fscrypt_master_key_secret) {
...
#[no_mangle]
pub unsafe extern "C" fn valid_key_spec(spec: *const fscrypt_key_specifier) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fscrypt_user_key_describe(key: *const key, m: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn allocate_filesystem_keyring(sb: *mut super_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_destroy_keyring(sb: *mut super_block) {
...
//
    ...
    sb.s_master_keys = core::ptr::null_mut();
    }
...
// the key specifier.
//
    let mut i: c_ulong = get_unaligned((unsigned long *)&mk_spec.u);
...
//
    ...
    if (keyring == core::ptr::null_mut())
    return core::ptr::null_mut(); /* No keyring yet, so no keys yet. */
...
//
#[no_mangle]
unsafe extern "C" fn add_master_key_user(mk: *mut fscrypt_master_key) -> c_int {
    ...
    KEY_POS_SEARCH | KEY_USR_VIEW, 0, core::ptr::null_mut());
    if (IS_ERR(quota_key))
    return PTR_ERR(quota_key);
    err = key_instantiate_and_link(quota_key, core::ptr::null_mut(), 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (err) {
    key_put(quota_key);
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn unlink_and_free_mk_user(mk_user: *mut fscrypt_master_key_user) {
...
//
#[no_mangle]
unsafe extern "C" fn remove_master_key_user(mk: *mut fscrypt_master_key) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn clear_mk_users(mk: *mut fscrypt_master_key) {
    static void clear_mk_users(struct fscrypt_master_key *mk)
    {
...
//
    ...
    if (find_master_key_user(mk) != core::ptr::null_mut())
    return 0;
    err = add_master_key_user(mk);
    if (err)
    return err;
...
//
    ...
    let mut kdf_key_size: c_uint = secret.size;
    let mut keyid_kdf_ctx: u8 = HKDF_CONTEXT_KEY_IDENTIFIER_FOR_RAW_KEY;
//
...
// Calculate the key identifier
    fscrypt_hkdf_expand(&secret.hkdf, keyid_kdf_ctx, core::ptr::null_mut(), 0,
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_valid_key_size(size: usize, add_key_flags: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fscrypt_provisioning_key_preparse(prep: *mut key_preparsed_payload) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fscrypt_provisioning_key_destroy(key: *mut key) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_add_key(filp: *mut file, _uarg: *mut void __user) -> c_int {
...
// Return the key identifier to userspace, if applicable
    ...
    HKDF_CONTEXT_KEY_IDENTIFIER_FOR_RAW_KEY, core::ptr::null_mut(), 0,
...
//
#[no_mangle]
unsafe extern "C" fn shrink_dcache_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn evict_dentries_for_decrypted_inodes(mk: *mut fscrypt_master_key) {
    static void evict_dentries_for_decrypted_inodes(struct fscrypt_master_key *mk)
    {
    struct fscrypt_inode_info *ci;
    struct inode *inode;
    struct inode *toput_inode = core::ptr::null_mut();
...
// If the inode is currently being created, ino may still be 0.
    ...
    fscrypt_warn(core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn do_remove_key(filp: *mut file, _uarg: *mut void __user, all_users: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_remove_key(filp: *mut file, uarg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_remove_key_all_users(filp: *mut file, uarg: *mut void __user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_ioctl_get_key_status(filp: *mut file, uarg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fscrypt_init_keyring() -> void __init {
