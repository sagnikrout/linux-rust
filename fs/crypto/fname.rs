...
//
pub const FSCRYPT_FNAME_MIN_MSG_LEN: c_int = 16;
//
...
#[no_mangle]
pub unsafe extern "C" fn fscrypt_is_dot_dotdot(str: *const qstr) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_fname_free_buffer(crypto_str: *mut fscrypt_str) {
...
//
    ...
    struct fscrypt_str *oname)
    {
    let mut qname: qstr = FSTR_TO_QSTR(iname);
...
//
    ...
    if (fname.crypto_buf.name == core::ptr::null_mut())
    return -ENOMEM;
...
//
#[no_mangle]
pub unsafe extern "C" fn fscrypt_fname_siphash(dir: *const inode, name: *const qstr) -> u64 {
