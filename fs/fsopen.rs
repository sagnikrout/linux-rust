...
//
    ...
    log.buffer[index] = core::ptr::null_mut();
...
//
    ...
    ssize_t err;
    const char *p __free(kfree) = core::ptr::null_mut(), *message;
    bool need_free;
    int n;
...
#[no_mangle]
unsafe extern "C" fn fscontext_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fscontext_create_fd(fc: *mut fs_context, o_flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fscontext_alloc_log(fc: *mut fs_context) -> c_int {
...
//
    ...
    ret = filename_lookup(dfd, filename, lookup_flags, &target, core::ptr::null_mut());
    if (ret < 0)
    goto err;
    ret = -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn vfs_cmd_create(fc: *mut fs_context, exclusive: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfs_cmd_reconfigure(fc: *mut fs_context) -> c_int {
