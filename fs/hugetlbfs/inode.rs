...
pub struct hugetlbfs_fs_context {
    ...
    pub max_val_type: enum hugetlbfs_size_type,
    pub min_val_type: enum hugetlbfs_size_type,
    pub uid: kuid_t,
    pub gid: kgid_t,
    pub mode: umode_t,
}
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_file_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hugetlbfs_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    ...
    let mut index: c_ulong = iocb.ki_pos >> huge_page_shift(h);
    let mut offset: c_ulong = iocb.ki_pos & ~huge_page_mask(h);
...
#[no_mangle]
unsafe extern "C" fn hugetlb_delete_from_page_cache(folio: *mut folio) {
...
//
#[no_mangle]
unsafe extern "C" fn vma_offset_start(vma: *mut vm_area_struct, start: pgoff_t) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn vma_offset_end(vma: *mut vm_area_struct, end: pgoff_t) -> c_ulong {
...
//
    ...
    unmap_hugepage_range(vma, v_start, v_end, core::ptr::null_mut(),
...
//
    ...
    v_start = vma_offset_start(vma, start);
    v_end = vma_offset_end(vma, end);
    unmap_hugepage_range(vma, v_start, v_end, core::ptr::null_mut(), zap_flags);
//
...
//
    ...
    let mut end: pgoff_t = lend >> PAGE_SHIFT;
    struct folio_batch fbatch;
    pgoff_t next, index;
    int i, freed = 0;
    let mut truncate_op: bool = (lend == LLONG_MAX);
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn hugetlb_vmtruncate(inode: *mut inode, offset: loff_t) {
    ...
    loff_t end)
    {
    let mut idx: pgoff_t = start >> huge_page_shift(h);
    struct folio *folio;
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_punch_hole(inode: *mut inode, offset: loff_t, len: loff_t) -> c_long {
    static long hugetlbfs_punch_hole(struct inode *inode, loff_t offset, loff_t len)
    {
    struct hugetlbfs_inode_info *info = HUGETLBFS_I(inode);
    struct address_space *mapping = inode.i_mapping;
    struct hstate *h = hstate_inode(inode);
    let mut hpage_size: loff_t = huge_page_size(h);
...
// Remove full pages from the file.
    ...
    let mut hpage_size: loff_t = huge_page_size(h);
    let mut hpage_shift: c_ulong = huge_page_shift(h);
...
// protected by i_rwsem
    ...
    HUGETLBFS_I(inode).resv_map = core::ptr::null_mut();
...
//
    ...
    {
    struct inode *inode;
    struct resv_map *resv_map = core::ptr::null_mut();
//
...
//
    ...
    if (inode) {
    let mut l: c_int = strlen(symname)+1;
    ...
    hugetlb_set_folio_subpool(src, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn hugetlbfs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
    static int hugetlbfs_show_options(struct seq_file *m, struct dentry *root)
    {
    struct hugetlbfs_sb_info *sbinfo = HUGETLBFS_SB(root.d_sb);
    struct hugepage_subpool *spool = sbinfo.spool;
    let mut hpage_size: c_ulong = huge_page_size(sbinfo.hstate);
    let mut hpage_shift: unsigned = huge_page_shift(sbinfo.hstate);
    char mod;
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_put_super(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn hugetlbfs_dec_free_inodes(sbinfo: *mut hugetlbfs_sb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_inc_free_inodes(sbinfo: *mut hugetlbfs_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_destroy_inode(inode: *mut inode) {
...
//
#[no_mangle]
unsafe extern "C" fn hugetlbfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hugetlbfs_validate(fc: *mut fs_context) -> c_int {
...
//
    ...
    sbinfo.spool		= core::ptr::null_mut();
    sbinfo.uid		= ctx.uid;
    sbinfo.gid		= ctx.gid;
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_get_tree(fc: *mut fs_context) -> c_int {
    static int hugetlbfs_get_tree(struct fs_context *fc)
    {
    let mut err: c_int = hugetlbfs_validate(fc);
    if (err)
    return err;
    return get_tree_nodev(fc, hugetlbfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn hugetlbfs_fs_context_free(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn hugetlbfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_do_hugetlb_shm() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_hstate_idx(page_size_log: c_int) -> c_int {
...
// hugetlbfs_vfsmount[] mounts do not use idmapped mounts.
    inode = hugetlbfs_get_inode(mnt.mnt_sb, &nop_mnt_idmap, core::ptr::null_mut(),
    S_IFREG | S_IRWXUGO, 0);
    if (!inode)
    goto out;
    ...
    size >> huge_page_shift(hstate_inode(inode)), core::ptr::null_mut(),
    acctflag) < 0)
    file = ERR_PTR(-ENOMEM);
    else
...
#[no_mangle]
unsafe extern "C" fn mount_one_hugetlbfs(h: *mut hstate) -> *mut vfsmount __init {
...
#[no_mangle]
unsafe extern "C" fn init_hugetlbfs_fs() -> int __init {
    ...
    if (hugetlbfs_inode_cachep == core::ptr::null_mut())
    goto out;
...
// other hstates are optional
    ...
    if (IS_ERR(mnt))
    hugetlbfs_vfsmount[i] = core::ptr::null_mut();
    else
