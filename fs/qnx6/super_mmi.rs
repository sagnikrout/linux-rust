...
// the rest of the superblock is the same
    ...
    {
    struct buffer_head *bh1, *bh2 = core::ptr::null_mut();
    struct qnx6_mmi_super_block *sb1, *sb2;
    struct qnx6_super_block *qsb = core::ptr::null_mut();
...
// success
    return sbi.sb;
    out:
    if (bh1 != core::ptr::null_mut())
    brelse(bh1);
    if (bh2 != core::ptr::null_mut())
    brelse(bh2);
    return core::ptr::null_mut();
    }
