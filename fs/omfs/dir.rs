...
#[no_mangle]
unsafe extern "C" fn omfs_hash(name: *const c_char, namelen: c_int, mod: c_int) -> c_int {
...
//
    ...
    {
    let mut nbuckets: c_int = (dir.i_size - OMFS_DIR_START)/8;
    let mut bucket: c_int = omfs_hash(name, namelen, nbuckets);
...
#[no_mangle]
pub unsafe extern "C" fn omfs_make_empty(inode: *mut inode, sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_add_link(dentry: *mut dentry, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_delete_entry(dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_dir_is_empty(inode: *mut inode) -> c_int {
    static int omfs_dir_is_empty(struct inode *inode)
    {
    let mut nbuckets: c_int = (inode.i_size - OMFS_DIR_START) / 8;
    struct buffer_head *bh;
    u64 *ptr;
    int i;
...
#[no_mangle]
unsafe extern "C" fn omfs_remove(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_add_node(dir: *mut inode, dentry: *mut dentry, mode: umode_t) -> c_int {
    ...
    let mut ino: ino_t = be64_to_cpu(oi.i_head.h_self);
    brelse(bh);
...
// sanity check block's self pointer
    ...
    {
    int is_bad;
    let mut ino: u64 = be64_to_cpu(header.h_self);
...
#[no_mangle]
unsafe extern "C" fn omfs_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
// high 12 bits store bucket + 1 and low 20 bits store hash index
    ...
    let mut fsblock: __u64 = be64_to_cpu(*p++);
