...
#[no_mangle]
unsafe extern "C" fn omfs_max_extents(sbi: *mut omfs_sb_info, offset: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn omfs_make_empty_table(bh: *mut buffer_head, offset: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn omfs_shrink_inode(inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_truncate(inode: *mut inode) {
...
//
    ...
    struct omfs_sb_info *sbi = OMFS_SB(inode.i_sb);
    let mut extent_count: u32 = be32_to_cpu(oe.e_extent_count);
...
// left = numblocks - (block - searched);
    ...
    struct omfs_extent_entry *entry;
    struct omfs_sb_info *sbi = OMFS_SB(inode.i_sb);
    let mut max_blocks: c_int = bh_result.b_size >> inode.i_blkbits;
    int remain;
    ret = -EIO;
...
#[no_mangle]
unsafe extern "C" fn omfs_read_folio(file: *mut file, folio: *mut folio) -> c_int {
    static int omfs_read_folio(struct file *file, struct folio *folio)
    {
    return block_read_full_folio(folio, omfs_get_block);
    }
#[no_mangle]
unsafe extern "C" fn omfs_readahead(rac: *mut readahead_control) {
...
#[no_mangle]
unsafe extern "C" fn omfs_write_failed(mapping: *mut address_space, to: loff_t) {
...
#[no_mangle]
unsafe extern "C" fn omfs_bmap(mapping: *mut address_space, block: sector_t) -> sector_t {
