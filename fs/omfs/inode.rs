...
//
#[no_mangle]
unsafe extern "C" fn omfs_update_checksums(oi: *mut omfs_inode) {
...
#[no_mangle]
unsafe extern "C" fn __omfs_write_inode(inode: *mut inode, wait: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_write_inode(inode: *mut inode, wbc: *mut writeback_control) -> c_int {
    static int omfs_write_inode(struct inode *inode, struct writeback_control *wbc)
    {
    return __omfs_write_inode(inode, wbc.sync_mode == WB_SYNC_ALL);
    }
#[no_mangle]
pub unsafe extern "C" fn omfs_sync_inode(inode: *mut inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn omfs_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn omfs_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omfs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
    static int omfs_show_options(struct seq_file *m, struct dentry *root)
    {
    struct omfs_sb_info *sbi = OMFS_SB(root.d_sb);
    let mut cur_umask: umode_t = current_umask();
...
//
#[no_mangle]
unsafe extern "C" fn omfs_get_imap(sb: *mut super_block) -> c_int {
...
// ptr = kmemdup(bh->b_data, sb->s_blocksize, GFP_KERNEL);
    ...
    kfree(sbi.s_imap);
    nomem:
    sbi.s_imap = core::ptr::null_mut();
    sbi.s_imap_size = 0;
    return -ENOMEM;
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omfs_mount_options {
    pub s_uid: kuid_t,
    pub s_gid: kgid_t,
    pub s_dmask: c_int,
    pub s_fmask: c_int,
...
#[no_mangle]
unsafe extern "C" fn omfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omfs_free_fc(fc: *mut fs_context) {
    static void omfs_free_fc(struct fs_context *fc)
    {
    kfree(fc.fs_private);
    }
...
#[no_mangle]
unsafe extern "C" fn init_omfs_fs() -> int __init {
    static int __init init_omfs_fs(void)
    {
    return register_filesystem(&omfs_fs_type);
    }
#[no_mangle]
unsafe extern "C" fn exit_omfs_fs() -> void __exit {
