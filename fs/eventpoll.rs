...
pub const EP_MAX_NESTS: c_int = 4;
...
//
    ...
    let mut loop_check_gen: static u64 = 0;
pub const PATH_ARR_SIZE: c_int = 5;
//
...
#[no_mangle]
pub unsafe extern "C" fn free_ephead(head: *mut epitems_head) {
...
#[no_mangle]
unsafe extern "C" fn list_file(file: *mut file, ctx: *mut ep_ctl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn unlist_file(head: *mut epitems_head) {
    ...
    to_free = core::ptr::null_mut();
    head.next = core::ptr::null_mut();
    head.file = core::ptr::null_mut();
    ...
    let mut long_max: static long = LONG_MAX;
...
#[no_mangle]
unsafe extern "C" fn epoll_sysctls_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn is_file_epoll(f: *mut file) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ep_cmp_ffd(p1: *mut epoll_key, p2: *mut epoll_key) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ep_is_linked(epi: *mut epitem) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ep_is_scanning(ep: *mut eventpoll) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ep_enter_scan(ep: *mut eventpoll) {
    static inline void ep_enter_scan(struct eventpoll *ep)
    {
    WRITE_ONCE(ep.ovflist, core::ptr::null_mut());
    }
// Called by ep_done_scan(): redirect ep_poll_callback() back to rdllist.
#[no_mangle]
pub unsafe extern "C" fn ep_exit_scan(ep: *mut eventpoll) {
...
#[no_mangle]
pub unsafe extern "C" fn epi_on_ovflist(epi: *const epitem) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn epi_clear_ovflist(epi: *mut epitem) {
...
#[no_mangle]
pub unsafe extern "C" fn ep_events_available(ep: *mut eventpoll) -> bool {
    static inline bool ep_events_available(struct eventpoll *ep)
    {
    let mut seq: c_uint = read_seqcount_begin(&ep.seq);
...
//
    ...
    struct eventpoll *ep)
    {
    let mut bp_usec: c_ulong = READ_ONCE(ep.busy_poll_usecs);
    if (bp_usec) {
    let mut end_time: c_ulong = start_time + bp_usec;
    let mut now: c_ulong = busy_loop_current_time();
...
#[no_mangle]
unsafe extern "C" fn ep_busy_loop_on(ep: *mut eventpoll) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ep_busy_loop_end(p: *mut c_void, start_time: c_ulong) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ep_busy_loop(ep: *mut eventpoll) -> bool {
    static bool ep_busy_loop(struct eventpoll *ep)
    {
    let mut napi_id: c_uint = READ_ONCE(ep.napi_id);
    let mut budget: u16 = READ_ONCE(ep.busy_poll_budget);
    let mut prefer_busy_poll: bool = READ_ONCE(ep.prefer_busy_poll);
    if (!budget)
...
//
#[no_mangle]
pub unsafe extern "C" fn ep_set_busy_poll_napi_id(epi: *mut epitem) {
...
#[no_mangle]
unsafe extern "C" fn ep_suspend_napi_irqs(ep: *mut eventpoll) {
...
#[no_mangle]
unsafe extern "C" fn ep_resume_napi_irqs(ep: *mut eventpoll) {
...
#[no_mangle]
pub unsafe extern "C" fn ep_busy_loop(ep: *mut eventpoll) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ep_remove_wait_queue(pwq: *mut eppoll_entry) {
...
//
#[no_mangle]
unsafe extern "C" fn ep_unregister_pollwait(ep: *mut eventpoll, epi: *mut epitem) {
    static void ep_unregister_pollwait(struct eventpoll *ep, struct epitem *epi)
    {
    struct eppoll_entry **p = &epi.pwqlist;
    struct eppoll_entry *pwq;
    while ((pwq = *p) != core::ptr::null_mut()) {
// p = pwq->next;
...
// call only when ep->mtx is held
#[no_mangle]
pub unsafe extern "C" fn ep_pm_stay_awake(epi: *mut epitem) {
...
#[no_mangle]
pub unsafe extern "C" fn ep_has_wakeup_source(epi: *mut epitem) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ep_pm_stay_awake_rcu(epi: *mut epitem) {
...
//
#[no_mangle]
unsafe extern "C" fn ep_start_scan(ep: *mut eventpoll, scan_batch: *mut list_head) {
...
//
    for (nepi = READ_ONCE(ep.ovflist); (epi = nepi) != core::ptr::null_mut(); ) {
...
#[no_mangle]
unsafe extern "C" fn ep_get(ep: *mut eventpoll) {
...
//
#[no_mangle]
unsafe extern "C" fn ep_put(ep: *mut eventpoll) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ep_free(ep: *mut eventpoll) {
...
//
    ...
    struct file *file)
    {
    struct epitems_head *to_free = core::ptr::null_mut();
...
//
    WRITE_ONCE(file.f_ep, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ep_remove_epi(ep: *mut eventpoll, epi: *mut epitem) {
...
//
#[no_mangle]
unsafe extern "C" fn ep_remove(ep: *mut eventpoll, epi: *mut epitem) {
...
//
#[no_mangle]
unsafe extern "C" fn ep_drain_pollwaits(ep: *mut eventpoll) {
...
//
#[no_mangle]
unsafe extern "C" fn ep_drain_tree(ep: *mut eventpoll) {
...
//
#[no_mangle]
unsafe extern "C" fn ep_clear_and_put(ep: *mut eventpoll) {
    static void ep_clear_and_put(struct eventpoll *ep)
    {
// Release any threads blocked in poll-on-ep.
    if (waitqueue_active(&ep.poll_wait))
    ep_poll_safewake(ep, core::ptr::null_mut(), 0);
    mutex_lock(&ep.mtx);
...
#[no_mangle]
unsafe extern "C" fn ep_eventpoll_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ep_eventpoll_poll(file: *mut file, wait: *mut poll_table, depth: c_int) -> __poll_t {
    ...
    init_poll_funcptr(&pt, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ep_eventpoll_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn ep_show_fdinfo(m: *mut seq_file, f: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eventpoll_release_file(file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn ep_alloc(pep: *mut eventpoll) -> c_int {
...
//
    ...
    int kcmp;
    struct rb_node *rbp;
    struct epitem *epi, *epir = core::ptr::null_mut();
    ...
    rbp = rbp.rb_right;
#[no_mangle]
pub unsafe extern "C" fn if(0: kcmp <) -> else {
    else if (kcmp < 0)
    rbp = rbp.rb_left;
    else {
    epir = epi;
...
//
#[no_mangle]
unsafe extern "C" fn ep_poll_callback(wait: *mut wait_queue_entry_t, mode: unsigned, sync: c_int, key: *mut c_void) -> c_int {
    static int ep_poll_callback(wait_queue_entry_t *wait, unsigned mode, int sync, void *key)
    {
    let mut pwake: c_int = 0;
    struct epitem *epi = ep_item_from_wait(wait);
    struct eventpoll *ep = epi.ep;
    let mut pollflags: __poll_t = key_to_poll(key);
    unsigned long flags;
    let mut ewake: c_int = 0;
...
//
    ...
    smp_store_release(&ep_pwq_from_wait(wait).whead, core::ptr::null_mut());
    }
    return ewake;
    }
//
...
#[no_mangle]
unsafe extern "C" fn ep_rbtree_insert(ep: *mut eventpoll, epi: *mut epitem) {
    static void ep_rbtree_insert(struct eventpoll *ep, struct epitem *epi)
    {
    int kcmp;
    struct rb_node **p = &ep.rbr.rb_root.rb_node, *parent = core::ptr::null_mut();
    struct epitem *epic;
...
#[no_mangle]
unsafe extern "C" fn path_count_inc(ctx: *mut ep_ctl_ctx, nests: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn path_count_init(ctx: *mut ep_ctl_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn reverse_path_check(ctx: *mut ep_ctl_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep_create_wakeup_source(epi: *mut epitem) -> c_int {
    static int ep_create_wakeup_source(struct epitem *epi)
    {
    struct name_snapshot n;
    struct wakeup_source *ws;
    if (!epi.ep.ws) {
    epi.ep.ws = wakeup_source_register(core::ptr::null_mut(), "eventpoll");
    if (!epi.ep.ws)
    return -ENOMEM;
    }
    take_dentry_name_snapshot(&n, epi.ffd.file.f_path.dentry);
    ws = wakeup_source_register(core::ptr::null_mut(), n.name.name);
...
#[no_mangle]
unsafe extern "C" fn ep_destroy_wakeup_source(epi: *mut epitem) -> noinline void {
    static noinline void ep_destroy_wakeup_source(struct epitem *epi)
    {
    struct wakeup_source *ws = ep_wakeup_source(epi);
    RCU_INIT_POINTER(epi.ws, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn ep_attach_file(file: *mut file, epi: *mut epitem) -> c_int {
    static int ep_attach_file(struct file *file, struct epitem *epi)
    {
    struct epitems_head *to_free = core::ptr::null_mut();
    struct hlist_head *head = core::ptr::null_mut();
    struct eventpoll *ep = core::ptr::null_mut();
    if (is_file_epoll(file))
...
//
    ...
    struct eventpoll *tep = core::ptr::null_mut();
...
//
    ...
    {
    let mut ret: c_int = default_wake_function(wq_entry, mode, sync, key);
//
...
#[no_mangle]
unsafe extern "C" fn ep_schedule_timeout(to: *mut ktime_t) -> c_int {
...
//
    ...
    ktime_t expires, *to = core::ptr::null_mut();
    lockdep_assert_irqs_enabled();
...
#[no_mangle]
unsafe extern "C" fn ep_get_upwards_depth_proc(ep: *mut eventpoll, depth: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clear_tfile_check_list(ctx: *mut ep_ctl_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn do_epoll_create(flags: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ep_take_care_of_epollwakeup(epev: *mut epoll_event) {
...
#[no_mangle]
pub unsafe extern "C" fn epoll_mutex_lock(mutex: *mut mutex, nonblock: bool) -> c_int {
...
//
    ...
    const sigset_t __user *, sigmask, size_t, sigsetsize)
    {
    struct timespec64 ts, *to = core::ptr::null_mut();
    if (timeout) {
...
#[no_mangle]
unsafe extern "C" fn eventpoll_init() -> int __init {
...
// Allocates slab cache used to allocate "struct eppoll_entry"
    ...
    sizeof(struct eppoll_entry), 0, SLAB_PANIC|SLAB_ACCOUNT, core::ptr::null_mut());
    epoll_sysctls_init();
    ephead_cache = kmem_cache_create("ep_head",
    sizeof(struct epitems_head), 0, SLAB_PANIC|SLAB_ACCOUNT, core::ptr::null_mut());
    return 0;
    }
