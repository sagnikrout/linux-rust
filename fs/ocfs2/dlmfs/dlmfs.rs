...
//
    ...
    param_get_dlmfs_capabilities, core::ptr::null_mut(), 0444);
...
// flags |= DLM_LKF_NOQUEUE;
    ...
    struct dlmfs_filp_private *fp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dlmfs_file_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn dlmfs_init_once(foo: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dlmfs_free_inode(inode: *mut inode) {
    static void dlmfs_free_inode(struct inode *inode)
    {
    kmem_cache_free(dlmfs_inode_cache, DLMFS_I(inode));
    }
#[no_mangle]
unsafe extern "C" fn dlmfs_evict_inode(inode: *mut inode) {
...
// dlm context now.
    ...
    let mut mode: umode_t = S_IFDIR | 0755;
    if (inode) {
...
#[no_mangle]
unsafe extern "C" fn dlmfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlmfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlmfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_dlmfs_fs() -> int __init {
    static int __init init_dlmfs_fs(void)
    {
    int status;
    let mut cleanup_inode: c_int = 0, cleanup_worker = 0;
...
#[no_mangle]
unsafe extern "C" fn exit_dlmfs_fs() -> void __exit {
