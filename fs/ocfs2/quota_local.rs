...
#[no_mangle]
pub unsafe extern "C" fn ol_quota_entries_per_block(sb: *mut super_block) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn ol_chunk_blocks(sb: *mut super_block) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ol_chunk_entries(sb: *mut super_block) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ol_quota_chunk_block(sb: *mut super_block, c: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ol_dqblk_block(sb: *mut super_block, c: c_int, off: c_int) -> c_uint {
    static unsigned int ol_dqblk_block(struct super_block *sb, int c, int off)
    {
    let mut epb: c_int = ol_quota_entries_per_block(sb);
    return ol_quota_chunk_block(sb, c) + 1 + off / epb;
    }
#[no_mangle]
unsafe extern "C" fn ol_dqblk_block_off(sb: *mut super_block, c: c_int, off: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ol_dqblk_off(sb: *mut super_block, c: c_int, off: c_int) -> loff_t {
...
#[no_mangle]
pub unsafe extern "C" fn ol_dqblk_block_offset(sb: *mut super_block, off: loff_t) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ol_dqblk_chunk_off(sb: *mut super_block, c: c_int, off: loff_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_local_check_quota_file(sb: *mut super_block, type: c_int) -> c_int {
    ...
    struct inode *ginode = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ocfs2_release_local_quota_bitmaps(head: *mut list_head) {
...
// Load quota bitmaps into memory
    ...
    newchunk.qc_num = i;
    newchunk.qc_headerbh = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn olq_update_info(bh: *mut buffer_head, private: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn free_recovery_list(head: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_free_quota_recovery(rec: *mut ocfs2_quota_recovery) {
...
// we can trust metadata and data of the quota file
    ...
    status = ocfs2_inode_lock_full(lqinode, core::ptr::null_mut(), 1,
...
// The function expects local quota file to be already locked.
    ...
    struct dquot *dquot;
    handle_t *handle;
    struct buffer_head *hbh = core::ptr::null_mut(), *qbh = core::ptr::null_mut();
    let mut status: c_int = 0;
    int bit, chunk;
...
#[no_mangle]
unsafe extern "C" fn ocfs2_local_read_info(sb: *mut super_block, type: c_int) -> c_int {
    ...
    struct buffer_head *bh = core::ptr::null_mut();
    struct ocfs2_quota_recovery *rec;
    let mut locked: c_int = 0, global_read = 0;
    ...
    oinfo.dqi_rec = core::ptr::null_mut();
    oinfo.dqi_lqi_bh = core::ptr::null_mut();
    oinfo.dqi_libh = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ocfs2_local_write_info(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_local_free_info(sb: *mut super_block, type: c_int) -> c_int {
    ...
    struct ocfs2_local_disk_chunk *dchunk;
    let mut mark_clean: c_int = 1, len;
    let mut status: c_int = 0;
    iput(oinfo.dqi_gqinode);
    ocfs2_simple_drop_lockres(OCFS2_SB(sb), &oinfo.dqi_gqlock);
    ocfs2_lock_res_free(&oinfo.dqi_gqlock);
...
#[no_mangle]
unsafe extern "C" fn olq_set_dquot(bh: *mut buffer_head, private: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_local_write_dquot(dquot: *mut dquot) -> c_int {
...
// Find free entry in local quota file
    ...
    struct mem_dqinfo *info = sb_dqinfo(sb, type);
    struct ocfs2_mem_dqinfo *oinfo = info.dqi_priv;
    struct ocfs2_quota_chunk *chunk = core::ptr::null_mut(), *iter;
    struct ocfs2_local_disk_chunk *dchunk;
    let mut found: c_int = 0, len;
...
// Add new chunk to the local quota file
    ...
    struct ocfs2_mem_dqinfo *oinfo = info.dqi_priv;
    struct inode *lqinode = sb_dqopt(sb).files[type];
    struct ocfs2_quota_chunk *chunk = core::ptr::null_mut();
    struct ocfs2_local_disk_chunk *dchunk;
    int status;
    handle_t *handle;
    struct buffer_head *bh = core::ptr::null_mut(), *dbh = core::ptr::null_mut();
    u64 p_blkno;
// We are protected by dqio_sem so no locking needed
    status = ocfs2_extend_no_holes(lqinode, core::ptr::null_mut(),
...
// Initialize chunk header
    ...
    &p_blkno, core::ptr::null_mut(), core::ptr::null_mut());
    if (status < 0) {
    mlog_errno(status);
    goto out_trans;
    }
...
#[no_mangle]
unsafe extern "C" fn olq_alloc_dquot(bh: *mut buffer_head, private: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_create_local_dquot(dquot: *mut dquot) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ocfs2_local_release_dquot(handle: *mut handle_t, dquot: *mut dquot) -> c_int {
