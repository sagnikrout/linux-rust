...
pub const OCFS2_CONTROL_PROTO_LEN: c_int = 4;
// Handshake states

// Messages
pub const OCFS2_CONTROL_MESSAGE_OP_LEN: c_int = 4;

pub const OCFS2_CONTROL_MESSAGE_SETNODE_TOTAL_LEN: c_int = 14;

pub const OCFS2_CONTROL_MESSAGE_SETVERSION_TOTAL_LEN: c_int = 11;

pub const OCFS2_CONTROL_MESSAGE_DOWN_TOTAL_LEN: c_int = 47;
pub const OCFS2_TEXT_UUID_LEN: c_int = 32;
pub const OCFS2_CONTROL_MESSAGE_VERNUM_LEN: c_int = 2;
pub const OCFS2_CONTROL_MESSAGE_NODENUM_LEN: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocfs2_live_connection {
    pub oc_list: list_head,
    pub oc_conn: *mut ocfs2_cluster_connection,
    pub oc_type: enum ocfs2_connection_type,
    pub oc_this_node: core::sync::atomic::AtomicI32,
    pub oc_our_slot: c_int,
    pub oc_version_lksb: dlm_lksb,
    pub oc_lvb: [c_char; DLM_LVB_LEN],
    pub oc_sync_wait: completion,
    pub oc_wait: wait_queue_head_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocfs2_control_private {
    pub op_list: list_head,
    pub op_state: c_int,
    pub op_this_node: c_int,
    pub op_proto: ocfs2_protocol_version,
}

// SETN<space><8-char-hex-nodenum><newline>
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocfs2_control_message_setn {
    pub tag: [c_char; OCFS2_CONTROL_MESSAGE_OP_LEN],
    pub space: c_char,
    pub nodestr: [c_char; OCFS2_CONTROL_MESSAGE_NODENUM_LEN],
    pub newline: c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocfs2_control_message_setv {
    pub tag: [c_char; OCFS2_CONTROL_MESSAGE_OP_LEN],
    pub space1: c_char,
    pub major: [c_char; OCFS2_CONTROL_MESSAGE_VERNUM_LEN],
    pub space2: c_char,
    pub minor: [c_char; OCFS2_CONTROL_MESSAGE_VERNUM_LEN],
    pub newline: c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocfs2_control_message_down {
    pub tag: [c_char; OCFS2_CONTROL_MESSAGE_OP_LEN],
    pub space1: c_char,
    pub uuid: [c_char; OCFS2_TEXT_UUID_LEN],
    pub space2: c_char,
    pub nodestr: [c_char; OCFS2_CONTROL_MESSAGE_NODENUM_LEN],
    pub newline: c_char,
}
    ...
    let mut ocfs2_control_this_node: static int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_control_get_handshake_state(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ocfs2_live_connection_drop(c: *mut ocfs2_live_connection) {
    static void ocfs2_live_connection_drop(struct ocfs2_live_connection *c)
    {
    mutex_lock(&ocfs2_control_lock);
    list_del_init(&c.oc_list);
    c.oc_conn = core::ptr::null_mut();
    mutex_unlock(&ocfs2_control_lock);
    kfree(c);
    }
...
// The T01 expects write(2) calls to have exactly one command
    ...
    if (c) {
    BUG_ON(c.oc_conn == core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ocfs2_control_install_private(file: *mut file) -> c_int {
    static int ocfs2_control_install_private(struct file *file)
    {
    let mut rc: c_int = 0;
    let mut set_p: c_int = 1;
    struct ocfs2_control_private *p = file.private_data;
...
#[no_mangle]
unsafe extern "C" fn ocfs2_control_get_this_node() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_control_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_control_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_control_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_control_exit() {
    static void ocfs2_control_exit(void)
    {
    misc_deregister(&ocfs2_control_device);
    }
#[no_mangle]
unsafe extern "C" fn fsdlm_lock_ast_wrapper(astarg: *mut c_void) {
    static void fsdlm_lock_ast_wrapper(void *astarg)
    {
    struct ocfs2_dlm_lksb *lksb = astarg;
    let mut status: c_int = lksb.lksb_fsdlm.sb_status;
//
...
#[no_mangle]
unsafe extern "C" fn fsdlm_blocking_ast_wrapper(astarg: *mut c_void, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn user_dlm_lock_status(lksb: *mut ocfs2_dlm_lksb) -> c_int {
    static int user_dlm_lock_status(struct ocfs2_dlm_lksb *lksb)
    {
    return lksb.lksb_fsdlm.sb_status;
    }
#[no_mangle]
unsafe extern "C" fn user_dlm_lvb_valid(lksb: *mut ocfs2_dlm_lksb) -> c_int {
    static int user_dlm_lvb_valid(struct ocfs2_dlm_lksb *lksb)
    {
    let mut invalid: c_int = lksb.lksb_fsdlm.sb_flags & DLM_SBF_VALNOTVALID;
    return !invalid;
    }
...
#[no_mangle]
unsafe extern "C" fn user_dlm_dump_lksb(lksb: *mut ocfs2_dlm_lksb) {
...
#[no_mangle]
unsafe extern "C" fn lvb_to_version(lvb: *mut c_char, ver: *mut ocfs2_protocol_version) {
...
#[no_mangle]
unsafe extern "C" fn version_to_lvb(ver: *mut ocfs2_protocol_version, lvb: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn sync_wait_cb(arg: *mut c_void) {
    ...
    name, strlen(name),
    0, sync_wait_cb, conn, core::ptr::null_mut());
    if (error) {
...
#[no_mangle]
unsafe extern "C" fn version_unlock(conn: *mut ocfs2_cluster_connection) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_protocol_version(conn: *mut ocfs2_cluster_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn user_recover_prep(arg: *mut c_void) {
    static void user_recover_prep(void *arg)
    {
    }
#[no_mangle]
unsafe extern "C" fn user_recover_slot(arg: *mut c_void, slot: *mut dlm_slot) {
...
#[no_mangle]
unsafe extern "C" fn user_cluster_disconnect(conn: *mut ocfs2_cluster_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn user_cluster_connect(conn: *mut ocfs2_cluster_connection) -> c_int {
    static int user_cluster_connect(struct ocfs2_cluster_connection *conn)
    {
    dlm_lockspace_t *fsdlm;
    struct ocfs2_live_connection *lc;
    int rc, ops_rv;
    BUG_ON(conn == core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(NO_CONTROLD: lc->oc_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_user_plugin_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_user_plugin_exit() -> void __exit {
