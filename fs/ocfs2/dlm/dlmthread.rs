...
//! Source: fs/ocfs2/dlm/dlmthread.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __dlm_wait_on_lockres_flags(res: *mut dlm_lock_resource, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn __dlm_lockres_has_locks(res: *mut dlm_lock_resource) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __dlm_lockres_unused(res: *mut dlm_lock_resource) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_kick_thread(dlm: *mut dlm_ctxt, res: *mut dlm_lock_resource) {
...
#[no_mangle]
pub unsafe extern "C" fn __dlm_dirty_lockres(dlm: *mut dlm_ctxt, res: *mut dlm_lock_resource) {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_launch_thread(dlm: *mut dlm_ctxt) -> c_int {
    ...
    dlm.dlm_thread_task = core::ptr::null_mut();
    return -EINVAL;
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn dlm_complete_thread(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
unsafe extern "C" fn dlm_dirty_list_empty(dlm: *mut dlm_ctxt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlm_flush_asts(dlm: *mut dlm_ctxt) {
    static void dlm_flush_asts(struct dlm_ctxt *dlm)
    {
    int ret;
...
pub const DLM_THREAD_MAX_DIRTY: c_int = 100;
#[no_mangle]
unsafe extern "C" fn dlm_thread(data: *mut c_void) -> c_int {
    static int dlm_thread(void *data)
    {
    struct dlm_lock_resource *res;
    struct dlm_ctxt *dlm = data;
    let mut timeout: c_ulong = msecs_to_jiffies(DLM_THREAD_TIMEOUT_MS);
    mlog(0, "dlm thread running for %s...\n", dlm.name);
    while (!kthread_should_stop()) {
    let mut n: c_int = DLM_THREAD_MAX_DIRTY;
