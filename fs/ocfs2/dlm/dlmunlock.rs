...
//! Source: fs/ocfs2/dlm/dlmunlock.c
#![no_std]
...
pub const DLM_UNLOCK_FREE_LOCK: c_uint = 0x00000001;
pub const DLM_UNLOCK_CALL_AST: c_uint = 0x00000002;
pub const DLM_UNLOCK_REMOVE_LOCK: c_uint = 0x00000004;
pub const DLM_UNLOCK_REGRANT_LOCK: c_uint = 0x00000008;
pub const DLM_UNLOCK_CLEAR_CONVERT_TYPE: c_uint = 0x00000010;
...
//
    ...
    let mut actions: c_int = 0;
    int in_use;
    u8 owner;
    let mut recovery_wait: c_int = 0;
...
//
    ...
    struct dlm_lock *lock = core::ptr::null_mut(), *iter;
