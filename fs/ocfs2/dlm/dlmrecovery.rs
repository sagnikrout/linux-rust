...
//! Source: fs/ocfs2/dlm/dlmrecovery.c
#![no_std]
...
//
    ...
    let mut dlm_mig_cookie: static u64 = 1;
#[no_mangle]
unsafe extern "C" fn dlm_get_next_mig_cookie() -> u64 {
    static u64 dlm_get_next_mig_cookie(void)
    {
    u64 c;
...
#[no_mangle]
pub unsafe extern "C" fn __dlm_reset_recovery(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_dispatch_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dlm_kick_recovery_thread(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_launch_recovery_thread(dlm: *mut dlm_ctxt) -> c_int {
    ...
    dlm.dlm_reco_thread_task = core::ptr::null_mut();
    return -EINVAL;
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn dlm_complete_recovery_thread(dlm: *mut dlm_ctxt) {
...
//
#[no_mangle]
unsafe extern "C" fn dlm_print_reco_node_status(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
unsafe extern "C" fn dlm_recovery_thread(data: *mut c_void) -> c_int {
    static int dlm_recovery_thread(void *data)
    {
    int status;
    struct dlm_ctxt *dlm = data;
    let mut timeout: c_ulong = msecs_to_jiffies(DLM_RECO_THREAD_TIMEOUT_MS);
...
#[no_mangle]
unsafe extern "C" fn dlm_reco_master_ready(dlm: *mut dlm_ctxt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_is_node_dead(dlm: *mut dlm_ctxt, node: u8) -> c_int {
...
// could be dead or just not joined
#[no_mangle]
unsafe extern "C" fn dlm_is_node_recovered(dlm: *mut dlm_ctxt, node: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_wait_for_node_death(dlm: *mut dlm_ctxt, node: u8, timeout: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_wait_for_node_recovery(dlm: *mut dlm_ctxt, node: u8, timeout: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dlm_in_recovery(dlm: *mut dlm_ctxt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_wait_for_recovery(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
unsafe extern "C" fn dlm_begin_recovery(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
unsafe extern "C" fn dlm_end_recovery(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
unsafe extern "C" fn dlm_print_recovery_master(dlm: *mut dlm_ctxt) {
...
#[no_mangle]
unsafe extern "C" fn dlm_do_recovery(dlm: *mut dlm_ctxt) -> c_int {
    static int dlm_do_recovery(struct dlm_ctxt *dlm)
    {
...
#[no_mangle]
unsafe extern "C" fn dlm_remaster_locks(dlm: *mut dlm_ctxt, dead_node: u8) -> c_int {
    static int dlm_remaster_locks(struct dlm_ctxt *dlm, u8 dead_node)
    {
    let mut status: c_int = 0;
    struct dlm_reco_node_data *ndata;
    int all_nodes_done;
    let mut destroy: c_int = 0;
...
// rescan everything marked dirty along the way
    dlm_kick_thread(dlm, core::ptr::null_mut());
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn dlm_init_recovery_area(dlm: *mut dlm_ctxt, dead_node: u8) -> c_int {
    static int dlm_init_recovery_area(struct dlm_ctxt *dlm, u8 dead_node)
    {
    let mut num: c_int = 0;
    struct dlm_reco_node_data *ndata;
...
#[no_mangle]
unsafe extern "C" fn dlm_destroy_recovery_area(dlm: *mut dlm_ctxt) {
    static void dlm_destroy_recovery_area(struct dlm_ctxt *dlm)
    {
...
// sleep until all received or error
    ...
    struct dlm_work_item *item = core::ptr::null_mut();
    if (!dlm_grab(dlm))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dlm_request_all_locks_worker(item: *mut dlm_work_item, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dlm_send_all_done_msg(dlm: *mut dlm_ctxt, dead_node: u8, send_to: u8) -> c_int {
    ...
    struct dlm_reco_node_data *ndata = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn dlm_num_locks_in_lockres(res: *mut dlm_lock_resource) -> c_int {
    static inline int dlm_num_locks_in_lockres(struct dlm_lock_resource *res)
    {
    let mut total_locks: c_int = 0;
    ...
    int total_locks)
    {
    let mut mig_cookie: u64 = be64_to_cpu(mres.mig_cookie);
    let mut mres_total_locks: c_int = be32_to_cpu(mres.total_locks);
    let mut ret: c_int = 0, status = 0;
...
// 0 otherwise
    ...
    let mut lock_num: c_int = mres.num_locks;
    ml = &(mres.ml[lock_num]);
...
//
    ...
    let mut ret: c_int = 0;
    u8 real_master;
    let mut extra_refs: u8 = 0;
    char *buf = core::ptr::null_mut();
    struct dlm_work_item *item = core::ptr::null_mut();
    struct dlm_lock_resource *res = core::ptr::null_mut();
    unsigned int hash;
    if (!dlm_grab(dlm))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dlm_mig_lockres_worker(item: *mut dlm_work_item, data: *mut c_void) {
    static void dlm_mig_lockres_worker(struct dlm_work_item *item, void *data)
    {
    struct dlm_ctxt *dlm;
    struct dlm_migratable_lockres *mres;
...
// DLM_LOCK_RES_OWNER_UNKNOWN.  continue.
    ...
    let mut status: c_int = DLM_LOCK_RES_OWNER_UNKNOWN;
    ...
    dlm.key, nodenum);
#[no_mangle]
pub unsafe extern "C" fn if(-ENOMEM: status ==) -> else {
    mlog_errno(status);
    msleep(50);
    goto resend;
    } else {
...
// be trusted
    ...
    struct dlm_lock_resource *res = core::ptr::null_mut();
    unsigned int hash;
    let mut master: c_int = DLM_LOCK_RES_OWNER_UNKNOWN;
    let mut flags: u32 = DLM_ASSERT_MASTER_REQUERY;
...
//
    ...
    struct list_head *tmpq = core::ptr::null_mut();
    struct dlm_lock *newlock = core::ptr::null_mut();
    struct dlm_lockstatus *lksb = core::ptr::null_mut();
    let mut ret: c_int = 0;
    int i, j, bad;
    struct dlm_lock *lock;
    let mut from: u8 = O2NM_MAX_NODES;
    __be64 c;
...
// placeholder, just need to set the refmap bit
    ...
    newlock = core::ptr::null_mut();
    lksb = core::ptr::null_mut();
    queue = dlm_list_num_to_pointer(res, ml.list);
    tmpq = core::ptr::null_mut();
...
// lock is for another node.
    ...
    be64_to_cpu(ml.cookie), core::ptr::null_mut());
    if (!newlock) {
    ret = -ENOMEM;
    goto leave;
    }
...
#[no_mangle]
pub unsafe extern "C" fn dlm_lvb_needs_invalidation(lock: *mut dlm_lock, local: c_int) -> c_int {
    ...
    struct list_head *queue;
    struct dlm_lock *lock;
    let mut blank_lvb: c_int = 0, local = 0;
    int i;
    u8 search_node;
    assert_spin_locked(&dlm.spinlock);
    assert_spin_locked(&res.spinlock);
...
#[no_mangle]
unsafe extern "C" fn dlm_do_local_recovery_cleanup(dlm: *mut dlm_ctxt, dead_node: u8) {
    static void dlm_do_local_recovery_cleanup(struct dlm_ctxt *dlm, u8 dead_node)
    {
    struct dlm_lock_resource *res;
    int i;
...
#[no_mangle]
unsafe extern "C" fn __dlm_hb_node_down(dlm: *mut dlm_ctxt, idx: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_hb_node_down_cb(node: *mut o2nm_node, idx: c_int, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn dlm_hb_node_up_cb(node: *mut o2nm_node, idx: c_int, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dlm_reco_ast(astdata: *mut c_void) {
    static void dlm_reco_ast(void *astdata)
    {
...
#[no_mangle]
unsafe extern "C" fn dlm_reco_bast(astdata: *mut c_void, blocked_type: c_int) {
    static void dlm_reco_bast(void *astdata, int blocked_type)
    {
    struct dlm_ctxt *dlm = astdata;
...
#[no_mangle]
unsafe extern "C" fn dlm_reco_unlock_ast(astdata: *mut c_void, st: enum dlm_status) {
    static void dlm_reco_unlock_ast(void *astdata, enum dlm_status st)
    {
...
#[no_mangle]
unsafe extern "C" fn dlm_pick_recovery_master(dlm: *mut dlm_ctxt) -> c_int {
    static int dlm_pick_recovery_master(struct dlm_ctxt *dlm)
    {
    enum dlm_status ret;
...
#[no_mangle]
unsafe extern "C" fn dlm_send_begin_reco_message(dlm: *mut dlm_ctxt, dead_node: u8) -> c_int {
    static int dlm_send_begin_reco_message(struct dlm_ctxt *dlm, u8 dead_node)
    {
...
pub const DLM_FINALIZE_STAGE2: c_uint = 0x01;
#[no_mangle]
unsafe extern "C" fn dlm_send_finalize_reco_message(dlm: *mut dlm_ctxt) -> c_int {
    static int dlm_send_finalize_reco_message(struct dlm_ctxt *dlm)
    {
    let mut ret: c_int = 0;
