...
//! Source: fs/ocfs2/quota_global.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ocfs2_global_disk2memdqb(dquot: *mut dquot, dp: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_global_mem2diskdqb(dp: *mut c_void, dquot: *mut dquot) {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_global_is_id(dp: *mut c_void, dquot: *mut dquot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_validate_quota_block(sb: *mut super_block, bh: *mut buffer_head) -> c_int {
...
// enough credits)
    ...
    let mut offset: c_int = off & (sb.s_blocksize - 1);
    let mut blk: sector_t = off >> sb.s_blocksize_bits;
    let mut err: c_int = 0, new = 0, ja_type;
...
// Space is already allocated in ocfs2_acquire_dquot()
    ...
    err = ocfs2_extent_map_get_blocks(gqinode, blk, &pblock, &pcount, core::ptr::null_mut());
    if (err) {
    mlog_errno(err);
    goto out;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_lock_global_qf(oinfo: *mut ocfs2_mem_dqinfo, ex: c_int) -> c_int {
...
// does a similar job as ocfs2_unlock_global_qf
    ...
    spin_lock(&dq_data_lock);
    if (!--oinfo.dqi_gqi_count)
    oinfo.dqi_gqi_bh = core::ptr::null_mut();
    spin_unlock(&dq_data_lock);
    return status;
    }
#[no_mangle]
pub unsafe extern "C" fn ocfs2_unlock_global_qf(oinfo: *mut ocfs2_mem_dqinfo, ex: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_global_read_info(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ocfs2_global_write_info(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_global_write_info(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_global_qinit_alloc(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_calc_global_qinit_credits(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __ocfs2_sync_dquot(dquot: *mut dquot, freeing: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ocfs2_sync_dquot_helper(dquot: *mut dquot, type: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qsync_work_fn(work: *mut work_struct) {
    static void qsync_work_fn(struct work_struct *work)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ocfs2_write_dquot(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_calc_qdel_credits(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocfs2_drop_dquot_refs(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ocfs2_release_dquot(dquot: *mut dquot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ocfs2_acquire_dquot(dquot: *mut dquot) -> c_int {
    static int ocfs2_acquire_dquot(struct dquot *dquot)
    {
    let mut status: c_int = 0, err;
    let mut ex: c_int = 0;
    struct super_block *sb = dquot.dq_sb;
    struct ocfs2_super *osb = OCFS2_SB(sb);
    let mut type: c_int = dquot.dq_id.type;
    ...
    let mut need_alloc: c_int = ocfs2_global_qinit_alloc(sb, type);
    handle_t *handle;
...
//
    ...
    status = ocfs2_extend_no_holes(gqinode, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ocfs2_get_next_id(sb: *mut super_block, qid: *mut kqid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_mark_dquot_dirty(dquot: *mut dquot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_write_info(sb: *mut super_block, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocfs2_destroy_dquot(dquot: *mut dquot) {
