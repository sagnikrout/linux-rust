...
#[no_mangle]
pub unsafe extern "C" fn mode_to_o2dlm(mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flags_to_o2dlm(flags: u32) -> c_int {
    static int flags_to_o2dlm(u32 flags)
    {
    let mut o2dlm_flags: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn dlm_status_to_errno(status: enum dlm_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn o2dlm_lock_ast_wrapper(astarg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn o2dlm_blocking_ast_wrapper(astarg: *mut c_void, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn o2dlm_unlock_ast_wrapper(astarg: *mut c_void, status: enum dlm_status) {
    static void o2dlm_unlock_ast_wrapper(void *astarg, enum dlm_status status)
    {
    struct ocfs2_dlm_lksb *lksb = astarg;
    let mut error: c_int = dlm_status_to_errno(status);
//
...
//
    ...
    let mut o2dlm_mode: c_int = mode_to_o2dlm(mode);
    let mut o2dlm_flags: c_int = flags_to_o2dlm(flags);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn o2cb_dlm_lock_status(lksb: *mut ocfs2_dlm_lksb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn o2cb_dlm_lvb_valid(lksb: *mut ocfs2_dlm_lksb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn o2cb_dump_lksb(lksb: *mut ocfs2_dlm_lksb) {
...
//
#[no_mangle]
unsafe extern "C" fn o2cb_cluster_check() -> c_int {
...
//
pub const O2CB_MAP_STABILIZE_COUNT: c_int = 60;
...
//
#[no_mangle]
unsafe extern "C" fn o2dlm_eviction_cb(node_num: c_int, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn o2cb_cluster_connect(conn: *mut ocfs2_cluster_connection) -> c_int {
    ...
    BUG_ON(conn.cc_proto == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn o2cb_cluster_disconnect(conn: *mut ocfs2_cluster_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn o2cb_stack_init() -> int __init {
    static int __init o2cb_stack_init(void)
    {
    return ocfs2_stack_glue_register(&o2cb_stack);
    }
#[no_mangle]
unsafe extern "C" fn o2cb_stack_exit() -> void __exit {
