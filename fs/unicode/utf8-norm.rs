...
#[no_mangle]
pub unsafe extern "C" fn utf8version_is_supported(um: *const unicode_map, version: c_uint) -> c_int {
    int utf8version_is_supported(const struct unicode_map *um, unsigned int version)
    {
    let mut i: c_int = um.tables.utf8agetab_size - 1;
