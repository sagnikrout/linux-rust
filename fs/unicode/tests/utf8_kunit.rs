...
//! Source: fs/unicode/tests/utf8_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_utf8_nfdi(test: *mut kunit) {
    ...
    let mut len: c_int = strlen(nfdi_test_data[i].str);
    let mut nlen: c_int = strlen(nfdi_test_data[i].dec);
    let mut j: c_int = 0;
    unsigned char c;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn check_utf8_nfdicf(test: *mut kunit) {
    ...
    let mut len: c_int = strlen(nfdicf_test_data[i].str);
    let mut nlen: c_int = strlen(nfdicf_test_data[i].ncf);
    let mut j: c_int = 0;
    int ret;
    unsigned char c;
...
#[no_mangle]
unsafe extern "C" fn check_utf8_comparisons(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn check_supported_versions(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn init_test_ucd(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exit_test_ucd(test: *mut kunit) {
