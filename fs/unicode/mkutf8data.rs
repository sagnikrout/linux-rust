...
//! Source: fs/unicode/mkutf8data.c
#![no_std]
...
pub const BITNUM: c_uint = 0x07;
pub const NEXTBYTE: c_uint = 0x08;
pub const OFFLEN: c_uint = 0x30;
pub const OFFLEN_SHIFT: c_int = 4;
pub const RIGHTPATH: c_uint = 0x40;
pub const TRIENODE: c_uint = 0x80;
pub const RIGHTNODE: c_uint = 0x40;
pub const LEFTNODE: c_uint = 0x80;
//
// utf8leaf_t
//
...
//
pub const UTF8_2_BITS: c_uint = 0xC0;
pub const UTF8_3_BITS: c_uint = 0xE0;
pub const UTF8_4_BITS: c_uint = 0xF0;
pub const UTF8_N_BITS: c_uint = 0x80;
pub const UTF8_2_MASK: c_uint = 0xE0;
pub const UTF8_3_MASK: c_uint = 0xF0;
pub const UTF8_4_MASK: c_uint = 0xF8;
pub const UTF8_N_MASK: c_uint = 0xC0;
pub const UTF8_V_MASK: c_uint = 0x3F;
pub const UTF8_V_SHIFT: c_int = 6;
#[no_mangle]
unsafe extern "C" fn utf8encode(str: *mut c_char, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn utf8decode(str: *const c_char) -> c_uint {
    static unsigned int utf8decode(const char *str)
    {
    const unsigned char *s = (const unsigned char*)str;
    let mut unichar: c_uint = 0;
    if (*s < 0x80) {
    unichar = *s;
...
#[no_mangle]
unsafe extern "C" fn utf32valid(unichar: c_uint) -> c_int {
...
pub struct tree {
    ...
    pub maxage: c_uint,
    pub next: *mut tree,
    pub ): *mut *mut *mut int (leaf_equal)(void , void,
    pub int): *mut *mut *mut void (leaf_print)(void ,,
    pub ): *mut *mut int (leaf_mark)(void,
    pub ): *mut *mut int (leaf_size)(void,
    pub ): *mut *mut *mut *mut int (leaf_index)(struct tree , void,
    pub ): *mut *mut *mut *mut unsigned char (leaf_emit)(void , unsigned char,
    pub leafindex: [c_int; 0x110000],
    pub index: c_int,
}
...
pub struct node {
    ...
    pub bitnum: c_uchar,
    pub nextbyte: c_uchar,
    pub leftnode: c_uchar,
    pub rightnode: c_uchar,
    pub keybits: c_uint,
    pub keymask: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn tree_walk(tree: *mut tree) {
...
//
    ...
    node.left = node.right = core::ptr::null_mut();
    node.parent = parent;
    node.leftnode = NODE;
    node.rightnode = NODE;
    node.keybits = 0;
...
//
#[no_mangle]
unsafe extern "C" fn insert(tree: *mut tree, key: *mut c_char, keylen: c_int, leaf: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn prune(tree: *mut tree) {
    ...
    goto advance;
    leftleaf = core::ptr::null_mut();
    while (!leftleaf) {
    assert(left.left || left.right);
    if (left.leftnode == LEAF)
    leftleaf = left.left;
#[no_mangle]
pub unsafe extern "C" fn if(LEAF: left->rightnode ==) -> else {
    else if (left.rightnode == LEAF)
    leftleaf = left.right;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: left->left) -> else {
    else if (left.left)
    left = left.left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: left->right) -> else {
    else if (left.right)
    left = left.right;
    else
    assert(0);
    }
    rightleaf = core::ptr::null_mut();
    while (!rightleaf) {
    assert(right.left || right.right);
    if (right.leftnode == LEAF)
    rightleaf = right.left;
#[no_mangle]
pub unsafe extern "C" fn if(LEAF: right->rightnode ==) -> else {
    else if (right.rightnode == LEAF)
    rightleaf = right.right;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: right->left) -> else {
    else if (right.left)
    right = right.left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: right->right) -> else {
    else if (right.right)
    right = right.right;
    else
    assert(0);
...
//
    ...
    parent.left = left;
#[no_mangle]
pub unsafe extern "C" fn if(node: parent->right ==) -> else {
    else if (parent.right == node)
    parent.right = left;
    else
    assert(0);
...
//
#[no_mangle]
unsafe extern "C" fn mark_nodes(tree: *mut tree) {
...
//
#[no_mangle]
unsafe extern "C" fn index_nodes(tree: *mut tree, index: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mark_subtree(node: *mut node) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn size_nodes(tree: *mut tree) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn emit(tree: *mut tree, data: *mut c_uchar) {
    ...
    offlen = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0xffff: node->offset <=) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct unicode_data {
    pub code: c_uint,
    pub ccc: c_int,
    pub gen: c_int,
    pub correction: c_int,
    pub utf32nfdi: *mut c_uint,
    pub utf32nfdicf: *mut c_uint,
    pub utf8nfdi: *mut c_char,
    pub utf8nfdicf: *mut c_char,
}
...
#[no_mangle]
unsafe extern "C" fn nfdi_equal(l: *mut c_void, r: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfdicf_equal(l: *mut c_void, r: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfdi_print(l: *mut c_void, indent: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: leaf->utf8nfdi) -> else {
    else if (leaf.utf8nfdi)
    printf(" nfdi \"%s\"", (const char*)leaf.utf8nfdi);
    printf("\n");
    }
#[no_mangle]
unsafe extern "C" fn nfdicf_print(l: *mut c_void, indent: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(HANGUL: leaf->utf8nfdi && leaf->utf8nfdi[0] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nfdi_mark(l: *mut c_void) -> c_int {
    static int nfdi_mark(void *l)
    {
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn nfdicf_mark(l: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn correction_mark(l: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfdi_size(l: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfdicf_size(l: *mut c_void) -> c_int {
    ...
    size += 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: leaf->utf8nfdicf) -> else {
...
#[no_mangle]
unsafe extern "C" fn utf8_create(data: *mut unicode_data) {
...
#[no_mangle]
unsafe extern "C" fn trees_populate() {
...
#[no_mangle]
unsafe extern "C" fn trees_reduce() {
...
#[no_mangle]
unsafe extern "C" fn verify(tree: *mut tree) {
...
#[no_mangle]
unsafe extern "C" fn trees_verify() {
...
#[no_mangle]
unsafe extern "C" fn open_fail(name: *const c_char, error: c_int) {
...
#[no_mangle]
unsafe extern "C" fn file_fail(filename: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn line_fail(filename: *const c_char, line: *const c_char) {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn print_utf32(utf32str: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn print_utf32nfdi(unichar: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn print_utf32nfdicf(unichar: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ignore_compatibility_form(type: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfdicf_init() {
...
#[no_mangle]
unsafe extern "C" fn ignore_init() {
...
#[no_mangle]
unsafe extern "C" fn corrections_init() {
...
//
#[no_mangle]
unsafe extern "C" fn hangul_decompose() {
    static void hangul_decompose(void)
    {
    let mut sb: c_uint = 0xAC00;
    let mut lb: c_uint = 0x1100;
    let mut vb: c_uint = 0x1161;
    let mut tb: c_uint = 0x11a7;
// unsigned int lc = 19;
    let mut vc: c_uint = 21;
    let mut tc: c_uint = 28;
    let mut nc: c_uint = (vc * tc);
...
// Hangul
    ...
    let mut si: c_uint = unichar - sb;
    let mut li: c_uint = si / nc;
    let mut vi: c_uint = (si % nc) / tc;
    let mut ti: c_uint = si % tc;
    i = 0;
    mapping[i++] = lb + li;
    mapping[i++] = vb + vi;
    if (ti)
...
#[no_mangle]
unsafe extern "C" fn nfdi_decompose() {
...
#[no_mangle]
unsafe extern "C" fn nfdicf_decompose() {
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8clen(s: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8agemax(tree: *mut tree, s: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8agemin(tree: *mut tree, s: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8nagemax(tree: *mut tree, s: *const c_char, len: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8nagemin(tree: *mut tree, s: *const c_char, len: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8len(tree: *mut tree, s: *const c_char) -> isize {
    ...
    ret += utf8clen(s);
#[no_mangle]
pub unsafe extern "C" fn if(DECOMPOSE: LEAF_CCC(leaf) ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8nlen(tree: *mut tree, s: *const c_char, len: usize) -> isize {
...
//
    ...
    u8c.tree = tree;
    u8c.s = s;
    u8c.p = core::ptr::null_mut();
    u8c.ss = core::ptr::null_mut();
    u8c.sp = core::ptr::null_mut();
    u8c.len = len;
    u8c.slen = 0;
    u8c.ccc = STOPPER;
    u8c.nccc = STOPPER;
...
//
#[no_mangle]
pub unsafe extern "C" fn utf8cursor(u8c: *mut utf8cursor, tree: *mut tree, s: *const c_char) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn normalize_line(tree: *mut tree) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn normalization_test() {
