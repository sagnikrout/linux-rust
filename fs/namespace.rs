...
// Maximum number of mounts in a mount namespace
    let mut __read_mostly: static unsigned int sysctl_mount_max = 100000;
...
#[no_mangle]
unsafe extern "C" fn set_mhash_entries(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_mphash_entries(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn initramfs_options_setup(str: *mut c_char) -> int __init {
...
// Don't allow confusion with old 32bit mount ID
    ...
    let mut mnt_id_ctr: static u64 = MNT_UNIQUE_ID_OFFSET;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mount_kattr {
    pub attr_set: c_uint,
    pub attr_clr: c_uint,
    pub propagation: c_uint,
    pub lookup_flags: c_uint,
    pub kflags: enum mount_kattr_flags_t,
...
#[no_mangle]
unsafe extern "C" fn mnt_ns_release(ns: *mut mnt_namespace) {
...
#[no_mangle]
unsafe extern "C" fn mnt_ns_release_rcu(rcu: *mut rcu_head) {
    static void mnt_ns_release_rcu(struct rcu_head *rcu)
    {
    mnt_ns_release(container_of(rcu, struct mnt_namespace, ns.ns_rcu));
    }
#[no_mangle]
unsafe extern "C" fn mnt_ns_tree_remove(ns: *mut mnt_namespace) {
...
#[no_mangle]
pub unsafe extern "C" fn lock_mount_hash() {
    static inline void lock_mount_hash(void)
    {
    write_seqlock(&mount_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn unlock_mount_hash() {
    ...
    {
    let mut tmp: c_ulong = ((unsigned long)mnt / L1_CACHE_BYTES);
    ...
    {
    let mut tmp: c_ulong = ((unsigned long)dentry / L1_CACHE_BYTES);
    tmp = tmp + (tmp >> mp_hash_shift);
    return &mountpoint_hashtable[tmp & mp_hash_mask];
    }
#[no_mangle]
unsafe extern "C" fn mnt_alloc_id(mnt: *mut mount) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mnt_free_id(mnt: *mut mount) {
...
//
#[no_mangle]
unsafe extern "C" fn mnt_alloc_group_id(mnt: *mut mount) -> c_int {
    static int mnt_alloc_group_id(struct mount *mnt)
    {
    let mut res: c_int = ida_alloc_min(&mnt_group_ida, 1, GFP_KERNEL);
    if (res < 0)
    return res;
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_release_group_id(mnt: *mut mount) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_add_count(mnt: *mut mount, n: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_get_count(mnt: *mut mount) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __mnt_is_readonly(mnt: *const vfsmount) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mnt_inc_writers(mnt: *mut mount) {
...
#[no_mangle]
pub unsafe extern "C" fn mnt_dec_writers(mnt: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn mnt_get_writers(mnt: *mut mount) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mnt_is_readonly(mnt: *const vfsmount) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_get_write_access(m: *mut vfsmount) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_want_write(m: *mut vfsmount) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_get_write_access_file(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_want_write_file(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_put_write_access(mnt: *mut vfsmount) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_drop_write(mnt: *mut vfsmount) {
...
#[no_mangle]
pub unsafe extern "C" fn mnt_put_write_access_file(file: *mut file) {
...
#[no_mangle]
pub unsafe extern "C" fn mnt_drop_write_file(file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_hold_writers(mnt: *mut mount) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_unhold_writers(mnt: *mut mount) {
...
#[no_mangle]
pub unsafe extern "C" fn mnt_del_instance(m: *mut mount) {
...
#[no_mangle]
pub unsafe extern "C" fn mnt_add_instance(m: *mut mount, s: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn mnt_make_readonly(mnt: *mut mount) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sb_prepare_remount_readonly(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_vfsmnt(mnt: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn delayed_free_vfsmnt(head: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn __legitimize_mnt(bastard: *mut vfsmount, seq: unsigned) -> c_int {
    int __legitimize_mnt(struct vfsmount *bastard, unsigned seq)
    {
    struct mount *mnt;
    if (read_seqretry(&mount_lock, seq))
    return 1;
    if (bastard == core::ptr::null_mut())
    return 0;
...
// call under rcu_read_lock
#[no_mangle]
unsafe extern "C" fn legitimize_mnt(bastard: *mut vfsmount, seq: unsigned) -> bool {
    static bool legitimize_mnt(struct vfsmount *bastard, unsigned seq)
    {
    let mut res: c_int = __legitimize_mnt(bastard, seq);
    if (likely(!res))
    return true;
    if (unlikely(res < 0)) {
    rcu_read_unlock();
...
//
    ...
    m = child_mnt ? &child_mnt.mnt : core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn __is_local_mountpoint(dentry: *const dentry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lookup_mountpoint(dentry: *mut dentry, m: *mut pinned_mountpoint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_mountpoint(dentry: *mut dentry, m: *mut pinned_mountpoint) -> c_int {
    static int get_mountpoint(struct dentry *dentry, struct pinned_mountpoint *m)
    {
    struct mountpoint *mp __free(kfree) = core::ptr::null_mut();
    bool found;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn maybe_free_mountpoint(mp: *mut mountpoint, list: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn unpin_mountpoint(m: *mut pinned_mountpoint) {
...
#[no_mangle]
pub unsafe extern "C" fn check_mnt(mnt: *const mount) -> c_int {
    static inline int check_mnt(const struct mount *mnt)
    {
    return mnt.mnt_ns == current.nsproxy.mnt_ns;
    }
#[no_mangle]
pub unsafe extern "C" fn check_anonymous_mnt(mnt: *mut mount) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn touch_mnt_namespace(ns: *mut mnt_namespace) {
...
//
#[no_mangle]
unsafe extern "C" fn __touch_mnt_namespace(ns: *mut mnt_namespace) {
...
//
#[no_mangle]
unsafe extern "C" fn umount_mnt(mnt: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn make_visible(mnt: *mut mount) {
...
#[no_mangle]
pub unsafe extern "C" fn mnt_change_mountpoint(parent: *mut mount, mp: *mut mountpoint, mnt: *mut mount) {
    ...
    {
    return node ? rb_entry(node, struct mount, mnt_node) : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mnt_add_to_ns(ns: *mut mnt_namespace, mnt: *mut mount) {
    static void mnt_add_to_ns(struct mnt_namespace *ns, struct mount *mnt)
    {
    struct rb_node **link = &ns.mounts.rb_node;
    struct rb_node *parent = core::ptr::null_mut();
    let mut mnt_first_node: bool = true, mnt_last_node = true;
...
//
#[no_mangle]
unsafe extern "C" fn commit_tree(mnt: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn setup_mnt(m: *mut mount, root: *mut dentry) {
...
//
    ...
    {
    let mut err: c_int = vfs_get_tree(fc);
    if (!err) {
...
#[no_mangle]
unsafe extern "C" fn cleanup_mnt(mnt: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn __cleanup_mnt(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn delayed_mntput(unused: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mntput_no_expire_slowpath(mnt: *mut mount) -> void noinline {
...
#[no_mangle]
unsafe extern "C" fn mntput_no_expire(mnt: *mut mount) {
...
#[no_mangle]
pub unsafe extern "C" fn mntput(mnt: *mut vfsmount) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_make_shortterm(mnt: *mut vfsmount) {
    void mnt_make_shortterm(struct vfsmount *mnt)
    {
    if (mnt)
    WRITE_ONCE(real_mount(mnt).mnt_ns, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn path_is_mountpoint(path: *const path) -> bool {
...
//
    ...
    struct mount *ret = core::ptr::null_mut();
    while (node) {
...
#[no_mangle]
unsafe extern "C" fn m_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn may_umount_tree(m: *mut vfsmount) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn may_umount(mnt: *mut vfsmount) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mnt_notify(p: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn notify_mnt_list() {
...
#[no_mangle]
unsafe extern "C" fn need_notify_mnt_list() -> bool {
...
#[no_mangle]
unsafe extern "C" fn namespace_unlock() {
    static void namespace_unlock(void)
    {
...
#[no_mangle]
pub unsafe extern "C" fn namespace_lock() {
    static inline void namespace_lock(void)
    {
...
#[no_mangle]
unsafe extern "C" fn disconnect_mount(mnt: *mut mount, how: enum umount_tree_flags) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn umount_tree(mnt: *mut mount, how: enum umount_tree_flags) {
...
// Add propagated mounts to the tmp_list
    ...
    WRITE_ONCE(p.mnt_ns, core::ptr::null_mut());
    if (how & UMOUNT_SYNC)
...
#[no_mangle]
unsafe extern "C" fn do_umount_root(sb: *mut super_block) -> c_int {
    ...
    ret = parse_monolithic_mount_data(fc, core::ptr::null_mut());
    if (!ret)
...
#[no_mangle]
unsafe extern "C" fn do_umount(mnt: *mut mount, flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __detach_mounts(dentry: *mut dentry) {
    void __detach_mounts(struct dentry *dentry)
    {
    let mut mp: pinned_mountpoint = {};
    struct mount *mnt;
...
//
#[no_mangle]
pub unsafe extern "C" fn may_mount() -> bool {
    bool may_mount(void)
    {
    return ns_capable(current.nsproxy.mnt_ns.user_ns, CAP_SYS_ADMIN);
    }
#[no_mangle]
unsafe extern "C" fn warn_mandlock() {
...
#[no_mangle]
unsafe extern "C" fn can_umount(path: *const path, flags: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn path_umount(path: *const path, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksys_umount(name: *mut char __user, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_mnt_ns_file(dentry: *mut dentry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mnt_ns_loop(dentry: *mut dentry) -> bool {
...
// to_free = *res = p;
    ...
    struct mount *child;
    struct path *res = prealloc, *to_free = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn drop_collected_paths(paths: *const path, prealloc: *const path) {
...
#[no_mangle]
pub unsafe extern "C" fn dissolve_on_fput(mnt: *mut vfsmount) {
...
#[no_mangle]
unsafe extern "C" fn __has_locked_children(mnt: *mut mount, dentry: *mut dentry) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn has_locked_children(mnt: *mut mount, dentry: *mut dentry) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn check_for_nsfs_mounts(subtree: *mut mount) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lock_mnt_tree(mnt: *mut mount) {
    static void lock_mnt_tree(struct mount *mnt)
    {
    struct mount *p;
    for (p = mnt; p; p = next_mnt(p, mnt)) {
    let mut flags: c_int = p.mnt.mnt_flags;
...
#[no_mangle]
unsafe extern "C" fn cleanup_group_ids(mnt: *mut mount, end: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn invent_group_ids(mnt: *mut mount, recurse: bool) -> c_int {
    static int invent_group_ids(struct mount *mnt, bool recurse)
    {
    struct mount *p;
    for (p = mnt; p; p = recurse ? next_mnt(p, mnt) : core::ptr::null_mut()) {
    if (!p.mnt_group_id) {
    let mut err: c_int = mnt_alloc_group_id(p);
    if (err) {
...
#[no_mangle]
pub unsafe extern "C" fn count_mounts(ns: *mut mnt_namespace, mnt: *mut mount) -> c_int {
    int count_mounts(struct mnt_namespace *ns, struct mount *mnt)
    {
    let mut max: c_uint = READ_ONCE(sysctl_mount_max);
    let mut mounts: c_uint = 0;
    struct mount *p;
    if (ns.nr_mounts >= max)
    return -ENOSPC;
    max -= ns.nr_mounts;
...
//
    ...
    let mut root: pinned_mountpoint = {};
    struct mountpoint *shorter = core::ptr::null_mut();
    struct mount *child, *p;
    struct mount *top;
    struct hlist_node *n;
    let mut err: c_int = 0;
    let mut moving: bool = mnt_has_parent(source_mnt);
//
...
//
    ...
    unlock_mount_hash();
    cleanup_group_ids(source_mnt, core::ptr::null_mut());
    out:
    ns.pending_mounts = 0;
    read_seqlock_excl(&mount_lock);
    unpin_mountpoint(&root);
...
#[no_mangle]
pub unsafe extern "C" fn if(!is_mounted(path->mnt)): unlikely(cant_mount(dentry) ||) -> else {
    else if (unlikely(cant_mount(dentry) || !is_mounted(path.mnt)))
    err = -ENOENT;		// not to be mounted on
#[no_mangle]
pub unsafe extern "C" fn if(!m->overmount: beneath && &m->mnt == path->mnt &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn __unlock_mount(m: *mut pinned_mountpoint) {
...
#[no_mangle]
pub unsafe extern "C" fn unlock_mount(m: *mut pinned_mountpoint) {
...
#[no_mangle]
unsafe extern "C" fn graft_tree(mnt: *mut mount, mp: *const pinned_mountpoint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn may_change_propagation(m: *const mount) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flags_to_propagation_type(ms_flags: c_int) -> c_int {
    static int flags_to_propagation_type(int ms_flags)
    {
    let mut type: c_int = ms_flags & ~(MS_REC | MS_SILENT);
...
//
#[no_mangle]
unsafe extern "C" fn do_change_type(path: *const path, ms_flags: c_int) -> c_int {
    static int do_change_type(const struct path *path, int ms_flags)
    {
    struct mount *m;
    struct mount *mnt = real_mount(path.mnt);
    let mut recurse: c_int = ms_flags & MS_REC;
    int type;
    int err;
    if (!path_mounted(path))
    return -EINVAL;
    ...
    for (m = mnt; m; m = (recurse ? next_mnt(m, mnt) : core::ptr::null_mut()))
...
//
#[no_mangle]
pub unsafe extern "C" fn may_copy_tree(path: *const path) -> bool {
...
//
    ...
    struct mount *mnt = core::ptr::null_mut();
    int err;
...
//
    ...
    struct path to_path;
    struct mount *mnt;
    let mut copy_flags: c_uint = 0;
    let mut locked: bool = false, recurse = flags & MOUNT_COPY_RECURSIVE;
...
//
    ...
    let mut lookup_flags: c_int = LOOKUP_AUTOMOUNT | LOOKUP_FOLLOW;
...
//
    ...
    ret = filename_lookup(dfd, name, lookup_flags, &path, core::ptr::null_mut());
    if (unlikely(ret))
    return ERR_PTR(ret);
    if (flags & OPEN_TREE_NAMESPACE)
...
//
#[no_mangle]
unsafe extern "C" fn can_change_locked_flags(mnt: *mut mount, mnt_flags: c_uint) -> bool {
    static bool can_change_locked_flags(struct mount *mnt, unsigned int mnt_flags)
    {
    let mut fl: c_uint = mnt.mnt.mnt_flags;
...
#[no_mangle]
unsafe extern "C" fn change_mount_ro_state(mnt: *mut mount, mnt_flags: c_uint) -> c_int {
    static int change_mount_ro_state(struct mount *mnt, unsigned int mnt_flags)
    {
    let mut readonly_request: bool = (mnt_flags & MNT_READONLY);
...
#[no_mangle]
unsafe extern "C" fn set_mount_attributes(mnt: *mut mount, mnt_flags: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn do_reconfigure_mnt(path: *const path, mnt_flags: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tree_contains_unbindable(mnt: *mut mount) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_group(from_path: *const path, to_path: *const path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn path_overmounted(path: *const path) -> bool {
    static inline bool path_overmounted(const struct path *path)
    {
    let mut seq: unsigned = read_seqbegin(&mount_lock);
    bool no_child;
    rcu_read_lock();
...
//
#[no_mangle]
pub unsafe extern "C" fn may_use_mount(mnt: *mut mount) -> bool {
...
//
    ...
    struct mount *old = real_mount(old_path.mnt);
    int err;
    let mut beneath: bool = flags & MNT_TREE_BENEATH;
...
#[no_mangle]
unsafe extern "C" fn do_move_mount_old(path: *const path, old_name: *const c_char) -> c_int {
...
//
    ...
    struct fs_context *fc;
    const char *subtype = core::ptr::null_mut();
    let mut err: c_int = 0;
    if (!fstype)
    return -EINVAL;
...
// Assert that inode_lock() locked the correct inode.
    ...
    err = -ENOENT;
#[no_mangle]
pub unsafe extern "C" fn if(path_overmounted(path): !copy_mount &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn finish_automount(__m: *mut vfsmount, path: *const path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mnt_set_expiry(mnt: *mut vfsmount, expiry_list: *mut list_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mark_mounts_for_expiry(mounts: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn select_submounts(parent: *mut mount, graveyard: *mut list_head) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn shrink_submounts(mnt: *mut mount) {
    static void shrink_submounts(struct mount *mnt)
    {
    LIST_HEAD(graveyard);
    struct mount *m;
...
//
    ...
    {
    return data ? strndup_user(data, PATH_MAX) : core::ptr::null_mut();
    }
//
...
//
    ...
    {
    let mut mnt_flags: c_uint = 0, sb_flags;
    int ret;
// Discard magic
...
#[no_mangle]
unsafe extern "C" fn dec_mnt_namespaces(ucounts: *mut ucounts) {
    static void dec_mnt_namespaces(struct ucounts *ucounts)
    {
    dec_ucount(ucounts, UCOUNT_MNT_NAMESPACES);
    }
#[no_mangle]
unsafe extern "C" fn free_mnt_ns(ns: *mut mnt_namespace) {
...
#[no_mangle]
unsafe extern "C" fn attr_flags_to_mnt_flags(attr_flags: u64) -> c_uint {
    static unsigned int attr_flags_to_mnt_flags(u64 attr_flags)
    {
    let mut mnt_flags: c_uint = 0;
...
//
    ...
    let mut mflags: enum mnt_tree_flags_t = 0;
    let mut ret: c_int = 0;
    if (!may_mount())
    return -EPERM;
    ...
    ret = filename_lookup(to_dfd, to_name, lflags, &to_path, core::ptr::null_mut());
    if (ret)
    return ret;
    }
    uflags = 0;
    ...
    lflags |= LOOKUP_AUTOMOUNT;
    ret = filename_lookup(from_dfd, from_name, lflags, &from_path, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn path_is_under(path1: *const path, path2: *const path) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn path_pivot_root(new: *mut path, old: *mut path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn recalc_flags(kattr: *mut mount_kattr, mnt: *mut mount) -> c_uint {
    static unsigned int recalc_flags(struct mount_kattr *kattr, struct mount *mnt)
    {
    let mut flags: c_uint = mnt.mnt.mnt_flags;
// flags to clear
...
#[no_mangle]
unsafe extern "C" fn can_idmap_mount(kattr: *const mount_kattr, mnt: *mut mount) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mount_setattr_prepare(kattr: *mut mount_kattr, mnt: *mut mount) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_idmap_mount(kattr: *const mount_kattr, mnt: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn mount_setattr_commit(kattr: *mut mount_kattr, mnt: *mut mount) {
...
#[no_mangle]
unsafe extern "C" fn do_mount_setattr(path: *const path, kattr: *mut mount_kattr) -> c_int {
...
//
    ...
    if (kattr.propagation) {
    if (err)
    cleanup_group_ids(mnt, core::ptr::null_mut());
    namespace_unlock();
    }
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn finish_mount_kattr(kattr: *mut mount_kattr) {
    static void finish_mount_kattr(struct mount_kattr *kattr)
    {
    if (kattr.mnt_userns) {
    put_user_ns(kattr.mnt_userns);
    kattr.mnt_userns = core::ptr::null_mut();
    }
    if (kattr.mnt_idmap)
...
// Don't bother walking through the mounts if this is a nop.
    ...
    struct path target;
    struct mount_kattr kattr;
    let mut lookup_flags: c_uint = LOOKUP_AUTOMOUNT | LOOKUP_FOLLOW;
    ...
    err = filename_lookup(dfd, name, kattr.lookup_flags, &target, core::ptr::null_mut());
    if (!err) {
...
#[no_mangle]
pub unsafe extern "C" fn show_path(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kstatmount {
    pub buf: *mut statmount __user,
    pub bufsize: usize,
...
#[no_mangle]
unsafe extern "C" fn mnt_to_attr_flags(mnt: *mut vfsmount) -> u64 {
    static u64 mnt_to_attr_flags(struct vfsmount *mnt)
    {
    let mut mnt_flags: c_uint = READ_ONCE(mnt.mnt_flags);
    let mut attr_flags: u64 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(MNT_RELATIME: mnt_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mnt_to_propagation_flags(m: *mut mount) -> u64 {
    static u64 mnt_to_propagation_flags(struct mount *m)
    {
    let mut propagation: u64 = 0;
    if (IS_MNT_SHARED(m))
...
#[no_mangle]
pub unsafe extern "C" fn vfsmount_to_propagation_flags(mnt: *mut vfsmount) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn statmount_sb_basic(s: *mut kstatmount) {
...
#[no_mangle]
unsafe extern "C" fn statmount_mnt_basic(s: *mut kstatmount) {
...
#[no_mangle]
unsafe extern "C" fn statmount_propagate_from(s: *mut kstatmount) {
...
#[no_mangle]
unsafe extern "C" fn statmount_mnt_root(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
    static int statmount_mnt_root(struct kstatmount *s, struct seq_file *seq)
    {
    int ret;
    let mut start: usize = seq.count;
...
#[no_mangle]
unsafe extern "C" fn statmount_mnt_point(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
    ...
    let mut err: return = = SEQ_SKIP ? 0 : err;
    }
#[no_mangle]
unsafe extern "C" fn statmount_fs_type(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn statmount_fs_subtype(s: *mut kstatmount, seq: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn statmount_sb_source(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn statmount_mnt_ns_id(s: *mut kstatmount, ns: *mut mnt_namespace) {
...
#[no_mangle]
unsafe extern "C" fn statmount_mnt_opts(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn statmount_opt_process(seq: *mut seq_file, start: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn statmount_opt_array(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn statmount_opt_sec_array(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn statmount_mnt_uidmap(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn statmount_mnt_gidmap(s: *mut kstatmount, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn statmount_string(s: *mut kstatmount, flag: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_statmount_to_user(s: *mut kstatmount) -> c_int {
    static int copy_statmount_to_user(struct kstatmount *s)
    {
    struct statmount *sm = &s.sm;
    struct seq_file *seq = &s.seq;
    char __user *str = ((char __user *)s.buf) + sizeof(*sm);
    let mut copysize: usize = min_t(size_t, s.bufsize, sizeof(*sm));
...
#[no_mangle]
unsafe extern "C" fn grab_requested_root(ns: *mut mnt_namespace, root: *mut path) -> c_int {
...
// locks: namespace_shared
    ...
    int err;
    if (mnt_file) {
    WARN_ON_ONCE(ns != core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn retry_statmount(ret: c_long, seq_size: *mut usize) -> bool {
...
//
    ...
    unsigned int, flags)
    {
    struct mnt_namespace *ns __free(mnt_ns_release) = core::ptr::null_mut();
    struct kstatmount *ks __free(kfree) = core::ptr::null_mut();
    struct file *mnt_file __free(fput) = core::ptr::null_mut();
    struct mnt_id_req kreq;
// We currently support retrieval of 3 strings.
    let mut seq_size: usize = 3 * PATH_MAX;
    int ret;
    if (flags & ~STATMOUNT_BY_FD)
    return -EINVAL;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct klistmount {
    pub last_mnt_id: u64,
    pub mnt_parent_id: u64,
    pub kmnt_ids: *mut u64,
    pub nr_mnt_ids: u32,
...
// locks: namespace_shared
#[no_mangle]
unsafe extern "C" fn do_listmount(kls: *mut klistmount, reverse: bool) -> isize {
    static ssize_t do_listmount(struct klistmount *kls, bool reverse)
    {
    struct mnt_namespace *ns = kls.ns;
    let mut mnt_parent_id: u64 = kls.mnt_parent_id;
    let mut last_mnt_id: u64 = kls.last_mnt_id;
    u64 *mnt_ids = kls.kmnt_ids;
    let mut nr_mnt_ids: usize = kls.nr_mnt_ids;
    struct path orig;
...
#[no_mangle]
unsafe extern "C" fn __free_klistmount_free(kls: *const klistmount) {
    ...
    size_t nr_mnt_ids)
    {
    let mut last_mnt_id: u64 = kreq.param;
    struct mnt_namespace *ns;
// The first valid unique mount id is MNT_UNIQUE_ID_OFFSET + 1.
    ...
    let mut maxcount: usize = 1000000;
    struct mnt_id_req kreq;
    ssize_t ret;
...
#[no_mangle]
unsafe extern "C" fn init_mount_tree() -> void __init {
...
//
    nullfs_mnt = vfs_kern_mount(&nullfs_fs_type, 0, "nullfs", core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mnt_init() -> void __init {
    void __init mnt_init(void)
    {
    int err;
    mnt_cache = kmem_cache_create("mnt_cache", sizeof(struct mount),
    0, SLAB_HWCACHE_ALIGN|SLAB_PANIC|SLAB_ACCOUNT, core::ptr::null_mut());
    ...
    __func__, err);
    fs_kobj = kobject_create_and_add("fs", core::ptr::null_mut());
    if (!fs_kobj)
...
#[no_mangle]
pub unsafe extern "C" fn put_mnt_ns(ns: *mut mnt_namespace) {
    ...
    {
    struct vfsmount *mnt;
    mnt = vfs_kern_mount(type, SB_KERNMOUNT, type.name, core::ptr::null_mut());
    if (!IS_ERR(mnt)) {
//
...
#[no_mangle]
pub unsafe extern "C" fn kern_unmount(mnt: *mut vfsmount) {
...
#[no_mangle]
pub unsafe extern "C" fn kern_unmount_array(mnt[]: *mut vfsmount, num: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn our_mnt(mnt: *mut vfsmount) -> bool {
    bool our_mnt(struct vfsmount *mnt)
    {
    return check_mnt(real_mount(mnt));
    }
#[no_mangle]
pub unsafe extern "C" fn current_chrooted() -> bool {
...
// Find the namespace root
    ...
    int *new_mnt_flags)
    {
    let mut new_flags: c_int = *new_mnt_flags;
    struct mount *mnt;
...
#[no_mangle]
unsafe extern "C" fn mount_too_revealing(sb: *const super_block, new_mnt_flags: *mut c_int) -> bool {
    static bool mount_too_revealing(const struct super_block *sb, int *new_mnt_flags)
    {
    let mut required_iflags: c_ulong = SB_I_NOEXEC | SB_I_NODEV;
    struct mnt_namespace *ns = current.nsproxy.mnt_ns;
...
#[no_mangle]
pub unsafe extern "C" fn mnt_may_suid(mnt: *mut vfsmount) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mntns_put(ns: *mut ns_common) {
    static void mntns_put(struct ns_common *ns)
    {
    put_mnt_ns(to_mnt_ns(ns));
    }
#[no_mangle]
unsafe extern "C" fn mntns_install(nsset: *mut nsset, ns: *mut ns_common) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_fs_namespace_sysctls() -> int __init {
