...
#[no_mangle]
unsafe extern "C" fn bad_file_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bad_inode_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bad_inode_rmdir(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn make_bad_inode(inode: *mut inode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_bad_inode(inode: *mut inode) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn iget_failed(inode: *mut inode) {
