...
//! Source: fs/btrfs/tests/free-space-tests.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn test_extents(cache: *mut btrfs_block_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_bitmaps(cache: *mut btrfs_block_group, sectorsize: u32) -> c_int {
...
// This is the high grade jackassery
    ...
    u32 sectorsize)
    {
    let mut bitmap_offset: u64 = (u64)(BITS_PER_BITMAP * sectorsize);
    int ret;
...
// Used by test_steal_space_from_bitmap_to_extent().
#[no_mangle]
unsafe extern "C" fn check_cache_empty(cache: *mut btrfs_block_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_bytes_index(cache: *mut btrfs_block_group, sectorsize: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn btrfs_test_free_space_cache(sectorsize: u32, nodesize: u32) -> c_int {
