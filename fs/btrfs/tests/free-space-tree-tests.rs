...
//! Source: fs/btrfs/tests/free-space-tree-tests.c
#![no_std]
...
pub struct free_space_extent {
    ...
    let mut prev_bit: c_int = 0, bit;
    let mut extent_start: u64 = 0, offset, end;
...
// Flip it to the other format and check that for good measure.
    ...
    struct btrfs_block_group *cache = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn btrfs_test_free_space_tree(sectorsize: u32, nodesize: u32) -> c_int {
