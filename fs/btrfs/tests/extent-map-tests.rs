...
//! Source: fs/btrfs/tests/extent-map-tests.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn free_extent_map_tree(inode: *mut btrfs_inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_case_1(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
    static int test_case_1(struct btrfs_fs_info *fs_info, struct btrfs_inode *inode)
    {
    struct extent_map_tree *em_tree = &inode.extent_tree;
    struct extent_map *em;
    let mut start: u64 = 0;
    let mut len: u64 = SZ_8K;
    int ret;
    int ret2;
...
//
#[no_mangle]
unsafe extern "C" fn test_case_2(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_case_3(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_case_4(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_range(em_tree: *mut extent_map_tree, index: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_case_5(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_case_6(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_case_7(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_case_8(fs_info: *mut btrfs_fs_info, inode: *mut btrfs_inode) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rmap_test_vector {
    pub raid_type: u64,
    pub physical_start: u64,
    pub data_stripe_size: u64,
    pub num_data_stripes: u64,
    pub num_stripes: u64,
// Assume we won't have more than 5 physical stripes
    pub data_stripe_phys_start: [u64; 5],
    pub expected_mapped_addr: bool,
// Physical to logical addresses
    pub mapped_logical: [u64; 5],
}
...
#[no_mangle]
pub unsafe extern "C" fn btrfs_test_extent_map() -> c_int {
