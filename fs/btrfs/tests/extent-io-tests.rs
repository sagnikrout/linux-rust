...
//! Source: fs/btrfs/tests/extent-io-tests.c
#![no_std]
...
pub const STATE_FLAG_STR_LEN: c_int = 256;
...
#[no_mangle]
unsafe extern "C" fn extent_flag_to_str(state: *const extent_state, dest: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn dump_extent_io_tree(tree: *const extent_io_tree) {
...
#[no_mangle]
unsafe extern "C" fn test_find_delalloc(sectorsize: u32, nodesize: u32) -> c_int {
    ...
    struct page *page;
    struct page *locked_page = core::ptr::null_mut();
// In this test we need at least 2 file extents at its maximum size
    let mut max_bytes: u64 = BTRFS_MAX_EXTENT_SIZE;
    let mut total_dirty: u64 = 2 * max_bytes;
...
// at this point
//
    btrfs_extent_io_tree_init(core::ptr::null_mut(), tmp, IO_TREE_SELFTEST);
//
...
// |---  search  ---|
//
    btrfs_set_extent_bit(tmp, 0, sectorsize - 1, EXTENT_DELALLOC, core::ptr::null_mut());
    start = 0;
    ...
    btrfs_unlock_extent(tmp, start, end, core::ptr::null_mut());
...
//
    ...
    btrfs_set_extent_bit(tmp, sectorsize, max_bytes - 1, EXTENT_DELALLOC, core::ptr::null_mut());
    start = test_start;
    end = start + PAGE_SIZE - 1;
    found = find_lock_delalloc_range(inode, page_folio(locked_page), &start,
    &end);
...
//
    btrfs_set_extent_bit(tmp, max_bytes, total_dirty - 1, EXTENT_DELALLOC, core::ptr::null_mut());
    start = test_start;
    end = start + PAGE_SIZE - 1;
    found = find_lock_delalloc_range(inode, page_folio(locked_page), &start,
    &end);
...
//
    ...
    btrfs_clear_extent_bit(tmp, 0, total_dirty - 1, (unsigned)-1, core::ptr::null_mut());
    out:
    if (locked_page)
    put_page(locked_page);
...
#[no_mangle]
unsafe extern "C" fn check_eb_bitmap(bitmap: *mut c_ulong, eb: *mut extent_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __test_eb_bitmaps(bitmap: *mut c_ulong, eb: *mut extent_buffer) -> c_int {
    static int __test_eb_bitmaps(unsigned long *bitmap, struct extent_buffer *eb)
    {
    unsigned long i, j;
    let mut byte_len: c_ulong = eb.len;
    u32 x;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn test_eb_bitmaps(sectorsize: u32, nodesize: u32) -> c_int {
    static int test_eb_bitmaps(u32 sectorsize, u32 nodesize)
    {
    struct btrfs_fs_info *fs_info;
    unsigned long AUTO_KFREE(bitmap);
    struct extent_buffer *eb = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn test_find_first_clear_extent_bit() -> c_int {
    ...
    btrfs_extent_io_tree_init(core::ptr::null_mut(), &tree, IO_TREE_SELFTEST);
...
//
    ...
    CHUNK_TRIMMED | CHUNK_ALLOCATED, core::ptr::null_mut());
...
//
    btrfs_set_extent_bit(&tree, SZ_64M, SZ_64M + SZ_8M - 1, CHUNK_ALLOCATED, core::ptr::null_mut());
...
//
    ...
    btrfs_clear_extent_bit(&tree, 0, (u64)-1, CHUNK_TRIMMED | CHUNK_ALLOCATED, core::ptr::null_mut());
    return ret;
    }
...
//
#[no_mangle]
unsafe extern "C" fn init_eb_and_memory(eb: *mut extent_buffer, memory: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn test_eb_mem_ops(sectorsize: u32, nodesize: u32) -> c_int {
    static int test_eb_mem_ops(u32 sectorsize, u32 nodesize)
    {
    struct btrfs_fs_info *fs_info;
    struct extent_buffer *eb = core::ptr::null_mut();
    void *memory = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn btrfs_test_extent_io(sectorsize: u32, nodesize: u32) -> c_int {
