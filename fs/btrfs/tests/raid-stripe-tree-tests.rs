...
//! Source: fs/btrfs/tests/raid-stripe-tree-tests.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn test_punch_hole_3extents(trans: *mut btrfs_trans_handle) -> c_int {
    static int test_punch_hole_3extents(struct btrfs_trans_handle *trans)
    {
    struct btrfs_fs_info *fs_info = trans.fs_info;
    struct btrfs_io_context *bioc;
    let mut io_stripe: btrfs_io_stripe = { 0 };
    let mut map_type: u64 = RST_TEST_RAID1_TYPE;
    let mut logical1: u64 = SZ_1M;
    let mut len1: u64 = SZ_1M;
    let mut logical2: u64 = logical1 + len1;
    let mut len2: u64 = SZ_1M;
    let mut logical3: u64 = logical2 + len2;
    let mut len3: u64 = SZ_1M;
    let mut hole_start: u64 = logical1 + SZ_256K;
    let mut hole_len: u64 = SZ_2M;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn test_delete_two_extents(trans: *mut btrfs_trans_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_punch_hole(trans: *mut btrfs_trans_handle) -> c_int {
    ...
    let mut map_type: u64 = RST_TEST_RAID1_TYPE;
    let mut logical1: u64 = SZ_1M;
    let mut hole_start: u64 = logical1 + SZ_32K;
    let mut hole_len: u64 = SZ_64K;
    let mut logical2: u64 = hole_start + hole_len;
    let mut len: u64 = SZ_1M;
    let mut len1: u64 = SZ_32K;
    let mut len2: u64 = len - len1 - hole_len;
    int ret;
    bioc = alloc_btrfs_io_context(fs_info, logical1, RST_TEST_NUM_DEVICES);
    if (!bioc) {
    test_std_err(TEST_ALLOC_IO_CONTEXT);
...
//
#[no_mangle]
unsafe extern "C" fn test_front_delete_prev_item(trans: *mut btrfs_trans_handle) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_front_delete(trans: *mut btrfs_trans_handle) -> c_int {
    ...
    let mut io_stripe: btrfs_io_stripe = { 0 };
    let mut map_type: u64 = RST_TEST_RAID1_TYPE;
    let mut logical: u64 = SZ_1M;
    let mut len: u64 = SZ_64K;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn test_tail_delete(trans: *mut btrfs_trans_handle) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_create_update_delete(trans: *mut btrfs_trans_handle) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_simple_create_delete(trans: *mut btrfs_trans_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_test(test: test_func_t, sectorsize: u32, nodesize: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn btrfs_test_raid_stripe_tree(sectorsize: u32, nodesize: u32) -> c_int {
