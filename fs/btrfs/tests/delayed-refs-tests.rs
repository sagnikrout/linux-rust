...
//! Source: fs/btrfs/tests/delayed-refs-tests.c
#![no_std]
...
pub const FAKE_ROOT_OBJECTID: c_int = 256;
pub const FAKE_BYTENR: c_int = 0;
pub const FAKE_LEVEL: c_int = 1;
pub const FAKE_INO: c_int = 256;
pub const FAKE_FILE_OFFSET: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ref_head_check {
    pub bytenr: u64,
    pub num_bytes: u64,
    pub ref_mod: c_int,
    pub total_ref_mod: c_int,
    pub must_insert: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ref_node_check {
    pub bytenr: u64,
    pub num_bytes: u64,
    pub ref_mod: c_int,
    pub action: enum btrfs_delayed_ref_action,
    pub type: u8,
    pub parent: u64,
    pub root: u64,
    pub owner: u64,
...
#[no_mangle]
unsafe extern "C" fn ref_type_from_disk_ref_type(type: u8) -> enum btrfs_ref_type {
    ...
    if (ref.type == BTRFS_REF_METADATA)
    ret = btrfs_add_delayed_tree_ref(trans, &ref, core::ptr::null_mut());
    else
...
//
#[no_mangle]
unsafe extern "C" fn simple_tests(trans: *mut btrfs_trans_handle) -> c_int {
...
//
    ...
    {
    struct btrfs_fs_info *fs_info = trans.fs_info;
    struct btrfs_delayed_ref_head *head = core::ptr::null_mut();
    struct btrfs_delayed_ref_node *node;
    struct btrfs_ref ref = {
    .type = type,
    .action = BTRFS_ADD_DELAYED_REF,
...
//
#[no_mangle]
unsafe extern "C" fn select_delayed_refs_test(trans: *mut btrfs_trans_handle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn btrfs_test_delayed_refs(sectorsize: u32, nodesize: u32) -> c_int {
