...
#[no_mangle]
pub unsafe extern "C" fn zlib_free_workspace(ws: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn need_special_buffer(fs_info: *mut btrfs_fs_info) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn zlib_compress_bio(ws: *mut list_head, cb: *mut compressed_bio) -> c_int {
...
//
    ...
    let mut bytes_left: c_ulong = len - workspace.strm.total_in;
    let mut copy_length: c_uint = min(bytes_left, workspace.buf_size);
//
...
// Queue the remaining part of the folio.
    ...
    let mut cur_len: u32 = workspace.strm.total_out - bio.bi_iter.bi_size;
...
#[no_mangle]
pub unsafe extern "C" fn zlib_decompress_bio(ws: *mut list_head, cb: *mut compressed_bio) -> c_int {
