...
#[no_mangle]
pub unsafe extern "C" fn kc_unxlate_dev_mem_ptr(phys: phys_addr_t, virt: *mut c_void) {
    ...
    let mut kcore_need_update: static int = 1;
//
...
#[no_mangle]
pub unsafe extern "C" fn register_mem_pfn_is_ram(pfn): *mut *mut int (fn)(unsigned long) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pfn_is_ram(pfn: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_kcore_size() {
...
//
#[no_mangle]
unsafe extern "C" fn kcore_ram_list(head: *mut list_head) -> c_int {
...
// calculate vmemmap's address from given system ram pfn and register it
    ...
    {
    let mut pfn: c_ulong = __pa(ent.addr) >> PAGE_SHIFT;
    let mut nr_pages: c_ulong = ent.size >> PAGE_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn kcore_ram_list(list: *mut list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcore_update_ram() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_kcore_iter(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    ...
    let mut page_offline_frozen: usize = 1;
    struct kcore_list *m;
    size_t tsz;
    unsigned long start;
    let mut buflen: usize = iov_iter_count(iter);
    let mut orig_buflen: usize = buflen;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(KCORE_TEXT: m->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn open_kcore(inode: *mut inode, filp: *mut file) -> c_int {
    static int open_kcore(struct inode *inode, struct file *filp)
    {
    let mut ret: c_int = security_locked_down(LOCKDOWN_KCORE);
...
#[no_mangle]
unsafe extern "C" fn release_kcore(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn proc_kcore_text_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn add_modules_range() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn proc_kcore_init() -> int __init {
    static int __init proc_kcore_init(void)
    {
    proc_root_kcore = proc_create("kcore", S_IRUSR, core::ptr::null_mut(), &kcore_proc_ops);
    if (!proc_root_kcore) {
