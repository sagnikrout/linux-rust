...
//
#[no_mangle]
unsafe extern "C" fn hold_task_mempolicy(priv: *mut proc_maps_private) {
...
#[no_mangle]
unsafe extern "C" fn release_task_mempolicy(priv: *mut proc_maps_private) {
...
#[no_mangle]
pub unsafe extern "C" fn lock_ctx_mm(lock_ctx: *mut proc_maps_locking_ctx) -> c_int {
    static inline int lock_ctx_mm(struct proc_maps_locking_ctx *lock_ctx)
    {
    let mut ret: c_int = mmap_read_lock_killable(lock_ctx.mm);
    if (!ret)
    lock_ctx.mmap_locked = true;
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn unlock_ctx_mm(lock_ctx: *mut proc_maps_locking_ctx) {
...
#[no_mangle]
unsafe extern "C" fn reset_lock_ctx(lock_ctx: *mut proc_maps_locking_ctx) {
    static void reset_lock_ctx(struct proc_maps_locking_ctx *lock_ctx)
    {
    lock_ctx.locked_vma = core::ptr::null_mut();
    lock_ctx.mmap_locked = false;
    }
#[no_mangle]
unsafe extern "C" fn unlock_ctx_vma(lock_ctx: *mut proc_maps_locking_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn unlock_vma_range(lock_ctx: *mut proc_maps_locking_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn drop_rcu(priv: *mut proc_maps_private) {
...
#[no_mangle]
pub unsafe extern "C" fn reacquire_rcu(priv: *mut proc_maps_private) {
...
unsafe extern "C" fn m_stop(m: *mut seq_file, v: *mut c_void) {
    ...
    let mut err: c_int = PTR_ERR(priv.lock_ctx.mm);
...
#[no_mangle]
unsafe extern "C" fn proc_map_release(inode: *mut inode, file: *mut file) -> c_int {
    ...
    const char **name_fmt)
    {
    struct anon_vma_name *anon_name = vma.vm_mm ? anon_vma_name(vma) : core::ptr::null_mut();
// name = NULL;
// path = NULL;
// name_fmt = NULL;
//
...
// name = anon_name->name;
    ...
    seq_put_hex_ll(m, core::ptr::null_mut(), start, 8);
    ...
    let mut flags: vm_flags_t = vma.vm_flags;
    let mut ino: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn show_map(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn query_vma_setup(lock_ctx: *mut proc_maps_locking_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn query_vma_teardown(lock_ctx: *mut proc_maps_locking_ctx) {
...
#[no_mangle]
unsafe extern "C" fn do_procmap_query(mm: *mut mm_struct, uarg: *mut void __user) -> c_int {
    static int do_procmap_query(struct mm_struct *mm, void __user *uarg)
    {
    let mut lock_ctx: proc_maps_locking_ctx = { .mm = mm };
    struct procmap_query karg;
    struct vm_area_struct *vma;
    struct file *vm_file = core::ptr::null_mut();
    const char *name = core::ptr::null_mut();
    char build_id_buf[BUILD_ID_SIZE_MAX], *name_buf = core::ptr::null_mut();
    __u64 usize;
    int err;
...
// either both buffer address and size are set, or both should be zero
    ...
    let mut name_buf_sz: usize = min_t(size_t, PATH_MAX, karg.vma_name_size);
    const struct path *path;
    const char *name_fmt;
    let mut name_sz: usize = 0;
    get_vma_name(vma, &path, &name, &name_fmt);
...
#[no_mangle]
unsafe extern "C" fn procfs_procmap_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
pub const PSS_SHIFT: c_int = 12;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mem_size_stats {
    pub resident: c_ulong,
    pub shared_clean: c_ulong,
    pub shared_dirty: c_ulong,
    pub private_clean: c_ulong,
    pub private_dirty: c_ulong,
    pub referenced: c_ulong,
    pub anonymous: c_ulong,
    pub lazyfree: c_ulong,
    pub anonymous_thp: c_ulong,
    pub shmem_thp: c_ulong,
    pub file_thp: c_ulong,
    pub swap: c_ulong,
    pub shared_hugetlb: c_ulong,
    pub private_hugetlb: c_ulong,
    pub ksm: c_ulong,
    pub pss: u64,
    pub pss_anon: u64,
    pub pss_file: u64,
    ...
    mss.pss_anon += pss;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: folio_test_swapbacked(folio)) -> else {
    ...
    let mut size: c_ulong = nr * PAGE_SIZE;
    bool exclusive;
    int mapcount;
//
...
//
    for (i = 0; i < nr; i++, page++) {
    let mut pss: c_ulong = PAGE_SIZE << PSS_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn smaps_pte_hole_lookup(addr: c_ulong, walk: *mut mm_walk) {
...
// depth is not used
    ...
    struct mem_size_stats *mss = walk.private;
    struct vm_area_struct *vma = walk.vma;
    let mut locked: bool = !!(vma.vm_flags & VM_LOCKED);
    struct page *page = core::ptr::null_mut();
    let mut present: bool = false, young = false, dirty = false;
    ...
    if (mapcount >= 2) {
    let mut pss_delta: u64 = (u64)PAGE_SIZE << PSS_SHIFT;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: folio_is_zone_device(folio)) -> else {
...
#[no_mangle]
unsafe extern "C" fn show_smap_vma_flags(m: *mut seq_file, vma: *mut vm_area_struct) {
...
//
    let mut shmem_swapped: c_ulong = shmem_swap_usage(vma);
...
#[no_mangle]
unsafe extern "C" fn show_smap(m: *mut seq_file, v: *mut c_void) -> c_int {
    static int show_smap(struct seq_file *m, void *v)
    {
    struct proc_maps_private *priv = m.private;
    struct vm_area_struct *vma = v;
    let mut mss: mem_size_stats = {};
...
#[no_mangle]
unsafe extern "C" fn show_smaps_rollup(m: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    struct mm_struct *mm = priv.lock_ctx.mm;
    struct vm_area_struct *vma;
    let mut vma_start: c_ulong = 0, last_vma_end = 0;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn pid_smaps_open(inode: *mut inode, file: *mut file) -> c_int {
    static int pid_smaps_open(struct inode *inode, struct file *file)
    {
    return do_maps_open(inode, file, &proc_pid_smaps_op);
    }
#[no_mangle]
unsafe extern "C" fn smaps_rollup_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smaps_rollup_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clear_refs_private {
    pub type: enum clear_refs_types,
}

#[no_mangle]
pub unsafe extern "C" fn pte_is_pinned(vma: *mut vm_area_struct, addr: c_ulong, pte: pte_t) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pagemapread {
    pub /: *mut *mut int pos, len; / units: PM_ENTRY_BYTES, not bytes,
    pub buffer: *mut pagemap_entry_t,
    pub show_pfn: bool,
}

pub const PM_PFRAME_BITS: c_int = 55;

pub const PM_END_OF_BUFFER: c_int = 1;
#[no_mangle]
pub unsafe extern "C" fn make_pme(frame: u64, flags: u64) -> pagemap_entry_t {
    static inline pagemap_entry_t make_pme(u64 frame, u64 flags)
    {
    return (pagemap_entry_t) { .pme = (frame & PM_PFRAME_MASK) | flags };
    }
#[no_mangle]
unsafe extern "C" fn add_to_pagemap(pme: *mut pagemap_entry_t, pm: *mut pagemapread) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __folio_page_mapped_exclusively(folio: *mut folio, page: *mut page) -> bool {
    ...
    let mut pme: pagemap_entry_t = make_pme(0, 0);
...
//
    ...
    {
    let mut idx: c_uint = (addr & ~PMD_MASK) >> PAGE_SHIFT;
    let mut flags: u64 = 0, frame = 0;
    let mut pmd: pmd_t = *pmdp;
    struct page *page = core::ptr::null_mut();
    struct folio *folio = core::ptr::null_mut();
    let mut err: c_int = 0;
    if (vma.vm_flags & VM_SOFTDIRTY)
    ...
    frame++;
#[no_mangle]
pub unsafe extern "C" fn if(PM_SWAP: flags &) -> else {
...
// This function walks within one hugetlb entry in the single call
    ...
    let mut pme: pagemap_entry_t = make_pme(frame, flags);
    err = add_to_pagemap(&pme, pm);
    if (err)
    break;
...
#[no_mangle]
unsafe extern "C" fn pagemap_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pagemap_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pagemap_scan_private {
    pub arg: pm_scan_arg,
    pub cur_vma_category: unsigned long masks_of_interest,,
    pub vec_buf: *mut page_region,
    pub found_pages: unsigned long vec_buf_len, vec_buf_index,,
    pub vec_out: *mut page_region __user,
}
...
//
    ...
    {
    let mut categories: c_ulong = PAGE_IS_HUGE;
    if (pmd_none(pmd))
    return categories;
    if (pmd_present(pmd)) {
    struct page *page;
...
//
    ...
    const struct pagemap_scan_private *p)
    {
    let mut required: c_ulong = p.arg.category_mask & PAGE_IS_WPALLOWED;
    categories ^= p.arg.category_inverted;
    ...
    struct vm_area_struct *vma = walk.vma;
    let mut vma_category: c_ulong = 0;
...
//
    ...
    let mut n_too_much: usize = total_pages - p.arg.max_pages;
...
// Fast path for performing exclusive WP
    ...
    for (addr = start; addr < end; pte++, addr += PAGE_SIZE) {
    let mut next: c_ulong = addr + PAGE_SIZE;
    let mut ptent: pte_t = ptep_get(pte);
    if ((pte_present(ptent) && pte_uffd(ptent)) ||
    pte_swp_uffd_any(ptent))
    continue;
...
//
    ...
    let mut psize: c_ulong = huge_page_size(h);
...
#[no_mangle]
unsafe extern "C" fn pagemap_scan_init_bounce_buffer(p: *mut pagemap_scan_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pagemap_scan_flush_buffer(p: *mut pagemap_scan_private) -> c_long {
    static long pagemap_scan_flush_buffer(struct pagemap_scan_private *p)
    {
    const struct page_region *buf = p.vec_buf;
    let mut n: c_long = p.vec_buf_index;
    if (!p.vec_buf)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn do_pagemap_scan(mm: *mut mm_struct, uarg: c_ulong) -> c_long {
    static long do_pagemap_scan(struct mm_struct *mm, unsigned long uarg)
    {
    let mut p: pagemap_scan_private = {0};
    unsigned long walk_start;
    let mut n_ranges_out: usize = 0;
    int ret;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct numa_maps {
    pub pages: c_ulong,
    pub anon: c_ulong,
    pub active: c_ulong,
    pub writeback: c_ulong,
    pub mapcount_max: c_ulong,
    pub dirty: c_ulong,
    pub swapcache: c_ulong,
    pub node: [c_ulong; MAX_NUMNODES],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct numa_maps_private {
    pub proc_maps: proc_maps_private,
    pub md: numa_maps,
}
...
//
#[no_mangle]
unsafe extern "C" fn show_numa_map(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pid_numa_maps_open(inode: *mut inode, file: *mut file) -> c_int {
