...
#[no_mangle]
pub unsafe extern "C" fn proc_sys_poll_notify(poll: *mut ctl_table_poll) {
...
#[no_mangle]
unsafe extern "C" fn sysctl_print_dir(dir: *mut ctl_dir) {
...
#[no_mangle]
unsafe extern "C" fn namecmp(name1: *const c_char, len1: c_int, name2: *const c_char, len2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn insert_entry(head: *mut ctl_table_header, entry: *const ctl_table) -> c_int {
    ...
    let mut namelen: c_int = strlen(name);
    while (*p) {
...
#[no_mangle]
unsafe extern "C" fn erase_entry(head: *mut ctl_table_header, entry: *const ctl_table) {
    ...
    head.count = 1;
    head.nreg = 1;
    head.unregistering = core::ptr::null_mut();
    head.root = root;
    head.set = set;
    head.parent = core::ptr::null_mut();
    head.node = node;
...
#[no_mangle]
unsafe extern "C" fn erase_header(head: *mut ctl_table_header) {
...
#[no_mangle]
unsafe extern "C" fn insert_header(dir: *mut ctl_dir, header: *mut ctl_table_header) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn use_table(p: *mut ctl_table_header) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unuse_table(p: *mut ctl_table_header) {
...
#[no_mangle]
unsafe extern "C" fn proc_sys_invalidate_dcache(head: *mut ctl_table_header) {
    static void proc_sys_invalidate_dcache(struct ctl_table_header *head)
    {
    proc_invalidate_siblings_dcache(&head.inodes, &sysctl_lock);
    }
#[no_mangle]
unsafe extern "C" fn start_unregistering(p: *mut ctl_table_header) {
...
#[no_mangle]
unsafe extern "C" fn sysctl_head_finish(head: *mut ctl_table_header) {
...
// phead = head;
    ...
    {
    struct ctl_table_header *head = core::ptr::null_mut();
    const struct ctl_table *entry = core::ptr::null_mut();
    struct ctl_node *ctl_node;
    spin_lock(&sysctl_lock);
...
#[no_mangle]
unsafe extern "C" fn next_entry(phead: *mut ctl_table_header, pentry: *const ctl_table) {
...
//
#[no_mangle]
unsafe extern "C" fn test_perm(mode: c_int, op: c_int) -> c_int {
    static int test_perm(int mode, int op)
    {
    if (uid_eq(current_euid(), GLOBAL_ROOT_UID))
    mode >>= 6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: in_egroup_p(GLOBAL_ROOT_GID)) -> else {
...
#[no_mangle]
unsafe extern "C" fn sysctl_perm(head: *mut ctl_table_header, table: *const ctl_table, op: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn proc_sys_evict_inode(inode: *mut inode, head: *mut ctl_table_header) {
    ...
    struct ctl_table_header *h = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn proc_sys_read(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    static ssize_t proc_sys_read(struct kiocb *iocb, struct iov_iter *iter)
    {
    return proc_sys_call_handler(iocb, iter, 0);
    }
#[no_mangle]
unsafe extern "C" fn proc_sys_write(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    static ssize_t proc_sys_write(struct kiocb *iocb, struct iov_iter *iter)
    {
    return proc_sys_call_handler(iocb, iter, 1);
    }
#[no_mangle]
unsafe extern "C" fn proc_sys_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_sys_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn proc_sys_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_sys_delete(dentry: *const dentry) -> c_int {
    static int proc_sys_delete(const struct dentry *dentry)
    {
    return !!PROC_I(d_inode(dentry)).sysctl.unregistering;
    }
#[no_mangle]
unsafe extern "C" fn sysctl_is_seen(p: *mut ctl_table_header) -> c_int {
    ...
    res = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !set->is_seen) -> else {
    else if (!set.is_seen)
    res = 1;
    else
    res = set.is_seen(set);
...
//
    ...
    struct ctl_dir *subdir, *new = core::ptr::null_mut();
    int err;
    spin_lock(&sysctl_lock);
...
#[no_mangle]
unsafe extern "C" fn sysctl_err(path: *const c_char, table: *const ctl_table, fmt: *mut c_char, ...) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysctl_check_table_array(path: *const c_char, table: *const ctl_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysctl_check_table(path: *const c_char, header: *mut ctl_table_header) -> c_int {
    ...
    link = link_table;
    list_for_each_table_entry(entry, head) {
    let mut len: c_int = strlen(entry.procname) + 1;
...
#[no_mangle]
unsafe extern "C" fn insert_links(head: *mut ctl_table_header) -> c_int {
    static int insert_links(struct ctl_table_header *head)
    {
...
#[no_mangle]
unsafe extern "C" fn put_links(header: *mut ctl_table_header) {
    static void put_links(struct ctl_table_header *header)
    {
    struct ctl_table_set *root_set = &sysctl_table_root.default_set;
...
#[no_mangle]
unsafe extern "C" fn drop_sysctl_table(header: *mut ctl_table_header) {
    static void drop_sysctl_table(struct ctl_table_header *header)
    {
    struct ctl_dir *parent = header.parent;
    if (--header.nreg)
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_sysctl_table(header: *mut *mut ctl_table_header) {
    ...
    set.is_seen = is_seen;
    init_header(&set.dir.header, root, set, core::ptr::null_mut(), root_table, 1);
    }
#[no_mangle]
pub unsafe extern "C" fn retire_sysctl_set(set: *mut ctl_table_set) {
    void retire_sysctl_set(struct ctl_table_set *set)
    {
    WARN_ON(!RB_EMPTY_ROOT(&set.dir.root));
    }
#[no_mangle]
pub unsafe extern "C" fn proc_sys_init() -> int __init {
    int __init proc_sys_init(void)
    {
    struct proc_dir_entry *proc_sys_root;
    proc_sys_root = proc_mkdir("sys", core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sysctl_alias {
    pub kernel_param: *const c_char,
    pub sysctl_param: *const c_char,
}
...
//
    ...
    for (alias = &sysctl_aliases[0]; alias.kernel_param != core::ptr::null_mut(); alias++) {
...
#[no_mangle]
pub unsafe extern "C" fn sysctl_is_alias(param: *mut c_char) -> bool {
    bool sysctl_is_alias(char *param)
    {
    const char *alias = sysctl_find_alias(param);
    return alias != core::ptr::null_mut();
    }
...
// proc_mnt = kern_mount(proc_fs_type);
    ...
    param, val);
#[no_mangle]
pub unsafe extern "C" fn if(-EACCES: err ==) -> else {
    else if (err == -EACCES)
    ...
    err = filp_close(file, core::ptr::null_mut());
    if (err)
...
#[no_mangle]
pub unsafe extern "C" fn do_sysctl_args() {
    void do_sysctl_args(void)
    {
    char *command_line;
    struct vfsmount *proc_mnt = core::ptr::null_mut();
    command_line = kstrdup(saved_command_line, GFP_KERNEL);
    if (!command_line)
    panic("%s: Failed to allocate copy of command line\n", __func__);
    parse_args("Setting sysctl args", command_line,
    core::ptr::null_mut(), 0, -1, -1, &proc_mnt, process_sysctl_arg);
    if (proc_mnt)
