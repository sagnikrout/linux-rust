...
#[no_mangle]
unsafe extern "C" fn seq_open_net(inode: *mut inode, file: *mut file) -> c_int {
    static int seq_open_net(struct inode *inode, struct file *file)
    {
    let mut state_size: c_uint = PDE(inode).state_size;
...
#[no_mangle]
unsafe extern "C" fn seq_file_net_put_net(seq: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn seq_release_net(ino: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_iter_init_seq_net(priv_data: *mut c_void, aux: *mut bpf_iter_aux_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn single_open_net(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn single_release_net(ino: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_tgid_net_readdir(file: *mut file, ctx: *mut dir_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_net_ns_init(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn proc_net_ns_exit(net: *mut net) -> __net_exit void {
...
#[no_mangle]
pub unsafe extern "C" fn proc_net_init() -> int __init {
    int __init proc_net_init(void)
    {
    proc_symlink("net", core::ptr::null_mut(), "self/net");
