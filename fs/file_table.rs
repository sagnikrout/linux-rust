...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct backing_file {
    pub file: file,
    union {
    pub user_path: path,
    pub bf_freeptr: freeptr_t,
}
...
#[no_mangle]
pub unsafe extern "C" fn backing_file_set_user_path(f: *mut file, path: *const path) {
...
#[no_mangle]
pub unsafe extern "C" fn backing_file_set_security(f: *mut file, security: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn backing_file_free(ff: *mut backing_file) {
...
//
#[no_mangle]
unsafe extern "C" fn get_nr_files() -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_max_files() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn init_fs_stat_sysctls() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_file(f: *mut file, flags: c_int, cred: *const cred) -> c_int {
...
//
    ...
    backing_file_set_security(&ff.file, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn __fput(file: *mut file) {
...
//
    ...
    if (unlikely(S_ISCHR(inode.i_mode) && inode.i_cdev != core::ptr::null_mut() &&
    !(mode & FMODE_PATH))) {
...
#[no_mangle]
unsafe extern "C" fn delayed_fput(unused: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ____fput(work: *mut callback_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn flush_delayed_fput() {
    void flush_delayed_fput(void)
    {
    delayed_fput(core::ptr::null_mut());
    flush_delayed_work(&delayed_fput_work);
    }
    EXPORT_SYMBOL_GPL(flush_delayed_fput);
#[no_mangle]
unsafe extern "C" fn __fput_deferred(file: *mut file) {
...
#[no_mangle]
pub unsafe extern "C" fn fput(file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __fput_sync(file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fput_close_sync(file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fput_close(file: *mut file) {
...
#[no_mangle]
pub unsafe extern "C" fn files_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn files_maxfiles_init() -> void __init {
    void __init files_maxfiles_init(void)
    {
    unsigned long n;
    let mut nr_pages: c_ulong = totalram_pages();
    let mut memreserve: c_ulong = (nr_pages - nr_free_pages()) * 3/2;
