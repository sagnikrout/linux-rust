...
//
#[no_mangle]
pub unsafe extern "C" fn fileattr_fill_xflags(fa: *mut file_kattr, xflags: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fileattr_fill_flags(fa: *mut file_kattr, flags: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfs_fileattr_get(dentry: *mut dentry, fa: *mut file_kattr) -> c_int {
    ...
    {
    let mut mask: __u32 = FS_XFLAGS_MASK;
...
//
#[no_mangle]
pub unsafe extern "C" fn copy_fsxattr_to_user(fa: *const file_kattr, ufa: *mut fsxattr __user) -> c_int {
    ...
    {
    let mut mask: __u64 = FS_XFLAGS_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn ioctl_getflags(file: *mut file, argp: *mut unsigned int __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ioctl_setflags(file: *mut file, argp: *mut unsigned int __user) -> c_int {
    int ioctl_setflags(struct file *file, unsigned int __user *argp)
    {
    struct mnt_idmap *idmap = file_mnt_idmap(file);
    struct dentry *dentry = file.f_path.dentry;
    let mut fa: file_kattr = {};
    unsigned int flags;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn ioctl_fsgetxattr(file: *mut file, argp: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ioctl_fssetxattr(file: *mut file, argp: *mut void __user) -> c_int {
    ...
    sizeof(struct file_attr), core::ptr::null_mut());
    return error;
    }
