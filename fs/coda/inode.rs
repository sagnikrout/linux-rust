...
#[no_mangle]
unsafe extern "C" fn coda_free_inode(inode: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn coda_init_inodecache() -> int __init {
    ...
    init_once);
    if (coda_inode_cachep == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn coda_destroy_inodecache() {
...
#[no_mangle]
unsafe extern "C" fn coda_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_set_idx(fc: *mut fs_context, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn coda_parse_monolithic(fc: *mut fs_context, _data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_put_super(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn coda_evict_inode(inode: *mut inode) {
    ...
    {
    let mut err: c_int = coda_revalidate_inode(d_inode(path.dentry));
    if (!err)
...
#[no_mangle]
unsafe extern "C" fn coda_statfs(dentry: *mut dentry, buf: *mut kstatfs) -> c_int {
    static int coda_statfs(struct dentry *dentry, struct kstatfs *buf)
    {
    int error;
...
#[no_mangle]
unsafe extern "C" fn coda_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn coda_init_fs_context(fc: *mut fs_context) -> c_int {
