...
// the upcalls
#[no_mangle]
pub unsafe extern "C" fn venus_rootfid(sb: *mut super_block, fidp: *mut CodaFid) -> c_int {
...
// ((char *)inp + offset + length) = '\0';
    ...
    union inputArgs *inp;
    union outputArgs *outp;
    let mut error: c_int = 0, insize, outsize, offset;
...
#[no_mangle]
pub unsafe extern "C" fn venus_fsync(sb: *mut super_block, fid: *mut CodaFid) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn venus_access(sb: *mut super_block, fid: *mut CodaFid, mask: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn venus_statfs(dentry: *mut dentry, sfs: *mut kstatfs) -> c_int {
    ...
    finalizer ? core::ptr::null_mut() : &outsize, inp);
//
...
//
#[no_mangle]
unsafe extern "C" fn coda_block_signals(old: *mut sigset_t) {
...
#[no_mangle]
unsafe extern "C" fn coda_unblock_signals(old: *mut sigset_t) {
...
//
    ...
    let mut timeout: c_ulong = jiffies + coda_timeout * HZ;
    sigset_t old;
    int blocked;
...
//
    ...
    struct upc_req *req = core::ptr::null_mut(), *sig_req;
    int error;
    mutex_lock(&vcp.vc_mutex);
    if (!vcp.vc_inuse) {
...
// CODA_REPLACE -- replace one CodaFid with another throughout the name cache
    ...
    struct CodaFid *fid = core::ptr::null_mut(), *newfid;
