...
#[no_mangle]
unsafe extern "C" fn coda_return_EIO() -> c_int {
...
// access routines: lookup, readlink, permission
    ...
    let mut length: usize = entry.d_name.len;
    struct inode *inode;
...
#[no_mangle]
pub unsafe extern "C" fn coda_dir_update_mtime(dir: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn coda_dir_inc_nlink(dir: *mut inode) {
...
#[no_mangle]
pub unsafe extern "C" fn coda_dir_drop_nlink(dir: *mut inode) {
...
// creation routines: create, mknod, mkdir, link, symlink
    ...
    let mut length: c_int = de.d_name.len;
    struct inode *inode;
...
// invalidate the directory cnode's attributes
    ...
    struct coda_vattr attrs;
    const char *name = de.d_name.name;
    let mut len: c_int = de.d_name.len;
    int error;
    struct CodaFid newfid;
...
// try to make de an entry in dir_inodde linked to source_de
    ...
    let mut name: *const c_char = de.d_name.name;
    let mut len: c_int = de.d_name.len;
    int error;
...
#[no_mangle]
unsafe extern "C" fn coda_unlink(dir: *mut inode, de: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_rmdir(dir: *mut inode, de: *mut dentry) -> c_int {
...
// rename
    ...
    let mut old_length: c_int = old_dentry.d_name.len;
    let mut new_length: c_int = new_dentry.d_name.len;
    int error;
    if (flags)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn CDT2DT(cdt: c_uchar) -> c_uint {
...
// support routines
#[no_mangle]
unsafe extern "C" fn coda_venus_readdir(coda_file: *mut file, ctx: *mut dir_context) -> c_int {
    ...
    let mut vdir_size: c_ulong = offsetof(struct venus_dirent, d_name);
    unsigned int type;
    struct qstr name;
    ino_t ino;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn coda_readdir(coda_file: *mut file, ctx: *mut dir_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn coda_dentry_delete(dentry: *const *const dentry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn coda_revalidate_inode(inode: *mut inode) -> c_int {
