...
#[no_mangle]
unsafe extern "C" fn is_present(path: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_dir(path: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_same(file1: *const c_char, file2: *const c_char) -> bool {
    ...
    goto close2;
    map1 = mmap(core::ptr::null_mut(), st1.st_size, PROT_READ, MAP_PRIVATE, fd1, 0);
    if (map1 == MAP_FAILED)
    goto close2;
    map2 = mmap(core::ptr::null_mut(), st2.st_size, PROT_READ, MAP_PRIVATE, fd2, 0);
    if (map2 == MAP_FAILED)
    goto close2;
...
//
#[no_mangle]
unsafe extern "C" fn make_parent_dir(path: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn conf_touch_dep(name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn conf_warning(fmt: *const c_char, ...) {
    static void conf_warning(const char *fmt, ...)
    __attribute__ ((format (printf, 1, 2)));
#[no_mangle]
unsafe extern "C" fn conf_message(fmt: *const c_char, ...) {
    static void conf_message(const char *fmt, ...)
    __attribute__ ((format (printf, 1, 2)));
    static const char *conf_filename;
    static int conf_lineno, conf_warnings;
#[no_mangle]
pub unsafe extern "C" fn conf_errors() -> bool {
...
#[no_mangle]
unsafe extern "C" fn conf_default_message_callback(s: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn conf_set_message_callback(s): *const *const void (fn)(char) {
...
#[no_mangle]
unsafe extern "C" fn conf_changed_input_warning(s: *const c_char) {
    static void conf_changed_input_warning(const char *s)
    {
    fputs(s, stderr);
    }
#[no_mangle]
unsafe extern "C" fn conf_warn_changed_input_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn sym_user_value_changed(sym: *mut symbol) -> bool {
...
#[no_mangle]
unsafe extern "C" fn conf_clear_written_flags() {
...
#[no_mangle]
unsafe extern "C" fn conf_set_sym_val(sym: *mut symbol, def: c_int, def_flags: c_int, p: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn getline_stripped(lineptr: *mut c_char, n: *mut usize, stream: *mut FILE) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn conf_read_simple(name: *const c_char, def: c_int) -> c_int {
    int conf_read_simple(const char *name, int def)
    {
    FILE *in = core::ptr::null_mut();
    char   *line = core::ptr::null_mut();
    let mut line_asize: usize = 0;
    char *p, *val;
    struct symbol *sym;
    int def_flags;
...
// fall through
    default:
    sym.def[def].val = core::ptr::null_mut();
    sym.def[def].tri = no;
    }
    }
    if (def == S_DEF_USER) {
...
#[no_mangle]
pub unsafe extern "C" fn conf_read(name: *const c_char) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct comment_style {
    pub decoration: *const c_char,
    pub prefix: *const c_char,
    pub postfix: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn conf_write_heading(fp: *mut FILE, cs: *const comment_style) {
...
// The returned pointer must be freed on the caller side
    ...
    {
    const char *val;
    char *escaped = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn print_symbol_for_dotconfig(fp: *mut FILE, sym: *mut symbol) {
    static void print_symbol_for_dotconfig(FILE *fp, struct symbol *sym)
    {
    __print_symbol(fp, sym, OUTPUT_N_AS_UNSET, true);
    }
#[no_mangle]
unsafe extern "C" fn print_symbol_for_autoconf(fp: *mut FILE, sym: *mut symbol) {
    static void print_symbol_for_autoconf(FILE *fp, struct symbol *sym)
    {
    __print_symbol(fp, sym, OUTPUT_N_NONE, false);
    }
#[no_mangle]
pub unsafe extern "C" fn print_symbol_for_listconfig(sym: *mut symbol) {
    void print_symbol_for_listconfig(struct symbol *sym)
    {
    __print_symbol(stdout, sym, OUTPUT_N, true);
    }
#[no_mangle]
unsafe extern "C" fn print_symbol_for_c(fp: *mut FILE, sym: *mut symbol) {
...
#[no_mangle]
unsafe extern "C" fn print_symbol_for_rustccfg(fp: *mut FILE, sym: *mut symbol) {
    static void print_symbol_for_rustccfg(FILE *fp, struct symbol *sym)
    {
    const char *val;
    const char *val_prefix = "";
    char *val_prefixed = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn conf_write_defconfig(filename: *const c_char) -> c_int {
    ...
    struct gstr gs;
    FILE *out;
    let mut warn_changed_input: bool = conf_warn_changed_input_enabled();
    let mut changed_input_found: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn conf_write(name: *const c_char) -> c_int {
    ...
    char *env;
    struct gstr gs;
    let mut need_newline: bool = false;
    let mut warn_changed_input: bool = conf_warn_changed_input_enabled();
    let mut changed_input_found: bool = false;
    if (!name)
    name = conf_get_configname();
...
#[no_mangle]
unsafe extern "C" fn conf_write_autoconf_cmd(autoconf_name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn conf_touch_deps() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn conf_write_autoconf(overwrite: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn conf_set_changed(val: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn conf_get_changed() -> bool {
    bool conf_get_changed(void)
    {
    return conf_changed;
    }
#[no_mangle]
pub unsafe extern "C" fn conf_set_changed_callback((*fn)(bool): *mut c_void) {
