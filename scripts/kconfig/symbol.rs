...
#[no_mangle]
pub unsafe extern "C" fn sym_get_type(sym: *const symbol) -> enum symbol_type {
    enum symbol_type sym_get_type(const struct symbol *sym)
    {
    let mut type: enum symbol_type = sym.type;
...
//
    ...
    {
    struct menu *menu = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn sym_get_range_val(sym: *mut symbol, base: c_int) -> c_longlong {
    ...
    return strtoll(sym.curr.val, core::ptr::null_mut(), base);
    }
#[no_mangle]
unsafe extern "C" fn sym_validate_range(sym: *mut symbol) {
    ...
    if (!prop)
    return;
    val = strtoll(sym.curr.val, core::ptr::null_mut(), base);
...
#[no_mangle]
unsafe extern "C" fn sym_set_changed(sym: *mut symbol) {
...
#[no_mangle]
unsafe extern "C" fn sym_set_all_changed() {
...
#[no_mangle]
unsafe extern "C" fn sym_calc_visibility(sym: *mut symbol) {
...
//
    ...
    {
    struct symbol *res = core::ptr::null_mut();
    struct symbol *sym;
    struct menu *menu;
...
#[no_mangle]
unsafe extern "C" fn sym_warn_unmet_dep(sym: *const symbol) {
    static void sym_warn_unmet_dep(const struct symbol *sym)
    {
    let mut gs: gstr = str_new();
    str_printf(&gs,
...
#[no_mangle]
pub unsafe extern "C" fn sym_dep_errors() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sym_calc_value(sym: *mut symbol) {
...
#[no_mangle]
pub unsafe extern "C" fn sym_clear_all_valid() {
...
#[no_mangle]
pub unsafe extern "C" fn sym_tristate_within_range(sym: *const symbol, val: tristate) -> bool {
    bool sym_tristate_within_range(const struct symbol *sym, tristate val)
    {
    let mut type: c_int = sym_get_type(sym);
    if (sym.visible == no)
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn sym_set_tristate_value(sym: *mut symbol, val: tristate) -> bool {
    bool sym_set_tristate_value(struct symbol *sym, tristate val)
    {
    let mut oldval: tristate = sym_get_tristate_value(sym);
...
//
#[no_mangle]
pub unsafe extern "C" fn choice_set_value(choice: *mut menu, sym: *mut symbol) {
...
#[no_mangle]
pub unsafe extern "C" fn sym_toggle_tristate_value(sym: *mut symbol) -> tristate {
...
#[no_mangle]
pub unsafe extern "C" fn sym_string_valid(sym: *mut symbol, str: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sym_string_within_range(sym: *mut symbol, str: *const c_char) -> bool {
    ...
    if (!prop)
    return true;
    val = strtoll(str, core::ptr::null_mut(), 10);
    ...
    if (!prop)
    return true;
    val = strtoll(str, core::ptr::null_mut(), 16);
...
#[no_mangle]
pub unsafe extern "C" fn sym_set_string_value(sym: *mut symbol, newval: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sym_is_changeable(sym: *const symbol) -> bool {
    bool sym_is_changeable(const struct symbol *sym)
    {
    return !sym_is_choice(sym) && sym.visible > sym.rev_dep.tri;
    }
#[no_mangle]
pub unsafe extern "C" fn sym_is_choice_value(sym: *const symbol) -> bool {
    ...
    {
    struct symbol *symbol = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn sym_rel_comp(sym1: *const c_void, sym2: *const c_void) -> c_int {
...
// As a fallback, sort symbols alphabetically
    ...
    {
    struct symbol *sym, **sym_arr = core::ptr::null_mut();
    struct sym_match *sym_match_arr = core::ptr::null_mut();
    int i, cnt, size;
    regex_t re;
    regmatch_t match[1];
    cnt = size = 0;
...
#[no_mangle]
unsafe extern "C" fn dep_stack_insert(stack: *mut dep_stack, sym: *mut symbol) {
...
#[no_mangle]
unsafe extern "C" fn dep_stack_remove() {
    static void dep_stack_remove(void)
    {
    check_top = check_top.prev;
    if (check_top)
    check_top.next = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn sym_check_print_recursive(last_sym: *mut symbol) {
    ...
    for (stack = check_top; stack != core::ptr::null_mut(); stack = stack.prev)
