...
//! Source: scripts/dtc/fdtoverlay.c
#![no_std]
...
pub const BUF_INCREMENT: c_int = 65536;
// Usage related data.
    ...
    {"input",            required_argument, core::ptr::null_mut(), 'i'},
...
pub unsafe extern "C" fn main(argc: c_int, argv[]: *mut c_char) -> c_int {
    ...
    {
    int opt, i;
    char *input_filename = core::ptr::null_mut();
    char *output_filename = core::ptr::null_mut();
