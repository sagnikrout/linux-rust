...
pub struct check {
    ...
    pub error: bool warn,,
    pub status: enum checkstatus,
    pub inprogress: bool,
    pub num_prereqs: c_int,
    pub prereq: *mut check,
}
    ...
    struct srcpos *pos = core::ptr::null_mut();
    char *file_str;
    ...
    pos = prop.srcpos;
#[no_mangle]
pub unsafe extern "C" fn if(node->srcpos: node &&) -> else {
    ...
    (c).status = FAILED;					\
    check_msg((c), dti, node, core::ptr::null_mut(), __VA_ARGS__);		\
    } while (0)
...
#[no_mangle]
unsafe extern "C" fn check_nodes_props(c: *mut check, dti: *mut dt_info, node: *mut node) {
...
#[no_mangle]
unsafe extern "C" fn is_multiple_of(multiple: c_int, divisor: c_int) -> bool {
    static bool is_multiple_of(int multiple, int divisor)
    {
    if (divisor == 0)
    let mut multiple: return = = 0;
    else
    return (multiple % divisor) == 0;
    }
#[no_mangle]
unsafe extern "C" fn run_check(c: *mut check, dti: *mut dt_info) -> bool {
    ...
    c.status = PREREQ;
    check_msg(c, dti, core::ptr::null_mut(), core::ptr::null_mut(), "Failed prerequisite '%s'",
    c.prereq[i].name);
    }
    }
    if (c.status != UNCHECKED)
...
// A check which always fails, for testing purposes only
    ...
    CHECK(always_fail, check_always_fail, core::ptr::null_mut());
...
//
    ...
    ERROR(duplicate_node_names, check_duplicate_node_names, core::ptr::null_mut());
    ...
    ERROR(duplicate_property_names, check_duplicate_property_names, core::ptr::null_mut());

    static void check_node_name_chars(struct check *c, struct dt_info *dti,
    struct node *node)
    {
    let mut n: usize = strspn(node.name, c.data);
    ...
    ERROR(node_name_format, check_node_name_format, core::ptr::null_mut(), &node_name_chars);
    static void check_node_name_not_empty(struct check *c, struct dt_info *dti,
    struct node *node)
    {
    if (node.basenamelen == 0 && node.parent != core::ptr::null_mut())
    FAIL(c, dti, node, "Empty node name");
    }
    ERROR(node_name_not_empty, check_node_name_not_empty, core::ptr::null_mut(), &node_name_chars);
    ...
    core::ptr::null_mut(), &node_name_chars);
...
// HACK: Overlay fragments are a special case
    ...
    WARNING(unit_address_vs_reg, check_unit_address_vs_reg, core::ptr::null_mut());
    static void check_property_name_chars(struct check *c, struct dt_info *dti,
    struct node *node)
    {
    struct property *prop;
    for_each_property(node, prop) {
    let mut n: usize = strspn(prop.name, c.data);
    ...
    let mut n: usize = strspn(name, c.data);
    if (n == strlen(prop.name))
    continue;
...
//
    ...
    {
    struct node *dt = dti.dt;
    struct node *othernode = core::ptr::null_mut();
    struct property *otherprop = core::ptr::null_mut();
    struct marker *othermark = core::ptr::null_mut();
    ...
    check_duplicate_label(c, dti, l.label, node, core::ptr::null_mut(), core::ptr::null_mut());
    for_each_property(node, prop) {
    struct marker *m = prop.val.markers;
    for_each_label(prop.labels, l)
    check_duplicate_label(c, dti, l.label, node, prop, core::ptr::null_mut());
    for_each_marker_of_type(m, LABEL)
    check_duplicate_label(c, dti, m.ref, node, prop, m);
    }
    }
    ERROR(duplicate_label, check_duplicate_label_node, core::ptr::null_mut());
...
// No valid phandles; nothing further to check
    ...
    ERROR(explicit_phandles, check_explicit_phandles, core::ptr::null_mut());
    static void check_name_properties(struct check *c, struct dt_info *dti,
    struct node *node)
    {
    struct property **pp, *prop = core::ptr::null_mut();
...
// pp = prop->next;
    ...
    ERROR(name_properties, check_name_properties, core::ptr::null_mut(), &name_is_string);
//
...
// ((fdt32_t *)(prop->val.val + m->offset)) = cpu_to_fdt32(phandle);
    ...
    ERROR(phandle_references, fixup_phandle_references, core::ptr::null_mut(),
    ...
    ERROR(path_references, fixup_path_references, core::ptr::null_mut(), &duplicate_node_names);
    ...
    ERROR(omit_unused_nodes, fixup_omit_unused_nodes, core::ptr::null_mut(), &phandle_references, &path_references);
//
// Semantic checks
//
    ...
    WARNING(names_is_string_list, check_names_is_string_list, core::ptr::null_mut());
...
// This check does not work for overlays with external paths
    ...
    WARNING(alias_paths, check_alias_paths, core::ptr::null_mut());
    ...
    WARNING(addr_size_cells, fixup_addr_size_cells, core::ptr::null_mut(),
    ...
    WARNING(reg_format, check_reg_format, core::ptr::null_mut(), &addr_size_cells);
...
#[no_mangle]
unsafe extern "C" fn check_pci_bridge(c: *mut check, dti: *mut dt_info, node: *mut node) {
    ...
    WARNING(pci_bridge, check_pci_bridge, core::ptr::null_mut(),
    &device_type_is_string, &addr_size_cells);
#[no_mangle]
unsafe extern "C" fn check_pci_device_bus_num(c: *mut check, dti: *mut dt_info, node: *mut node) {
    ...
    WARNING(pci_device_bus_num, check_pci_device_bus_num, core::ptr::null_mut(), &reg_format, &pci_bridge);
#[no_mangle]
unsafe extern "C" fn check_pci_device_reg(c: *mut check, dti: *mut dt_info, node: *mut node) {
    ...
    WARNING(pci_device_reg, check_pci_device_reg, core::ptr::null_mut(), &reg_format, &pci_bridge);
    static const struct bus_type simple_bus = {
    .name = "simple-bus",
    };
#[no_mangle]
unsafe extern "C" fn node_is_compatible(node: *mut node, compat: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_simple_bus_bridge(c: *mut check, dti: *mut dt_info, node: *mut node) {
    static void check_simple_bus_bridge(struct check *c, struct dt_info *dti, struct node *node)
    {
    if (node_is_compatible(node, "simple-bus"))
    node.bus = &simple_bus;
    }
    WARNING(simple_bus_bridge, check_simple_bus_bridge, core::ptr::null_mut(),
    &addr_size_cells, &compatible_is_string_list);
#[no_mangle]
unsafe extern "C" fn check_simple_bus_reg(c: *mut check, dti: *mut dt_info, node: *mut node) {
    ...
    unsigned int size;
    let mut reg: u64 = 0;
    cell_t *cells = core::ptr::null_mut();
...
// skip of child address
    ...
    WARNING(simple_bus_reg, check_simple_bus_reg, core::ptr::null_mut(), &reg_format, &simple_bus_bridge);
    static const struct bus_type i2c_bus = {
    .name = "i2c-bus",
    };
#[no_mangle]
unsafe extern "C" fn check_i2c_bus_bridge(c: *mut check, dti: *mut dt_info, node: *mut node) {
    ...
    WARNING(i2c_bus_bridge, check_i2c_bus_bridge, core::ptr::null_mut(), &addr_size_cells);

#[no_mangle]
unsafe extern "C" fn check_i2c_bus_reg(c: *mut check, dti: *mut dt_info, node: *mut node) {
...
// Ignore I2C_OWN_SLAVE_ADDRESS
    ...
    WARNING(i2c_bus_reg, check_i2c_bus_reg, core::ptr::null_mut(), &reg_format, &i2c_bus_bridge);
    static const struct bus_type spi_bus = {
    .name = "spi-bus",
    };
#[no_mangle]
unsafe extern "C" fn check_spi_bus_bridge(c: *mut check, dti: *mut dt_info, node: *mut node) {
    static void check_spi_bus_bridge(struct check *c, struct dt_info *dti, struct node *node)
    {
    let mut spi_addr_cells: c_int = 1;
...
// Try to detect SPI buses which don't have proper node name
    ...
    WARNING(spi_bus_bridge, check_spi_bus_bridge, core::ptr::null_mut(), &addr_size_cells);
#[no_mangle]
unsafe extern "C" fn check_spi_bus_reg(c: *mut check, dti: *mut dt_info, node: *mut node) {
    ...
    WARNING(spi_bus_reg, check_spi_bus_reg, core::ptr::null_mut(), &reg_format, &spi_bus_bridge);
...
// skip over 0x for next test
    ...
    WARNING(unit_address_format, check_unit_address_format, core::ptr::null_mut(),
...
//
    ...
    WARNING(avoid_default_addr_size, check_avoid_default_addr_size, core::ptr::null_mut(),
    &addr_size_cells);
...
//
    ...
    WARNING(avoid_unnecessary_addr_size, check_avoid_unnecessary_addr_size, core::ptr::null_mut(), &avoid_default_addr_size);
#[no_mangle]
unsafe extern "C" fn node_is_disabled(node: *mut node) -> bool {
    ...
    WARNING(unique_unit_address, check_unique_unit_address, core::ptr::null_mut(), &avoid_default_addr_size);
    ...
    core::ptr::null_mut(), false, false, &avoid_default_addr_size);
    ...
    check_obsolete_chosen_interrupt_controller, core::ptr::null_mut());
    ...
    WARNING(chosen_node_is_root, check_chosen_node_is_root, core::ptr::null_mut());
    ...
    WARNING(chosen_node_bootargs, check_chosen_node_bootargs, core::ptr::null_mut());
    ...
    WARNING(chosen_node_stdout_path, check_chosen_node_stdout_path, core::ptr::null_mut());
#[repr(C)]
#[derive(Copy, Clone)]
pub struct provider {
...
#[no_mangle]
unsafe extern "C" fn prop_is_gpio(prop: *mut property) -> bool {
...
// Skip GPIO hog nodes which have 'gpios' property
    ...
    WARNING(gpios_property, check_gpios_property, core::ptr::null_mut(), &phandle_references);
    ...
    CHECK(deprecated_gpio_property, check_deprecated_gpio_property, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn node_is_interrupt_provider(node: *mut node) -> bool {
    ...
    {
    struct property *prop;
    let mut irq_provider: bool = node_is_interrupt_provider(node);
    ...
    WARNING(interrupt_provider, check_interrupt_provider, core::ptr::null_mut(), &interrupts_extended_is_cell);
...
// Give up if this is an overlay with external references
    ...
    WARNING(interrupt_map, check_interrupt_map, core::ptr::null_mut(), &phandle_references, &addr_size_cells, &interrupt_provider);
    static void check_interrupts_property(struct check *c,
    struct dt_info *dti,
    struct node *node)
    {
    struct node *root = dti.dt;
    struct node *irq_node = core::ptr::null_mut(), *parent = node;
    struct property *irq_prop, *prop = core::ptr::null_mut();
...
// The parent of 'port' nodes can be either 'ports' or a device
    ...
    WARNING(graph_nodes, check_graph_nodes, core::ptr::null_mut());
...
// skip checks below for overlays
    ...
    WARNING(graph_port, check_graph_port, core::ptr::null_mut(), &graph_nodes);
...
// skip checks below for overlays
    ...
    WARNING(graph_endpoint, check_graph_endpoint, core::ptr::null_mut(), &graph_nodes);
...
#[no_mangle]
unsafe extern "C" fn enable_warning_error(c: *mut check, warn: bool, error: bool) {
...
#[no_mangle]
unsafe extern "C" fn disable_warning_error(c: *mut check, warn: bool, error: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn parse_checks_option(warn: bool, error: bool, arg: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn process_checks(force: bool, dti: *mut dt_info) {
