...
//! Source: scripts/dtc/libfdt/libfdt.h
#![no_std]
...
pub const FDT_FIRST_SUPPORTED_VERSION: c_uint = 0x02;
pub const FDT_LAST_COMPATIBLE_VERSION: c_uint = 0x10;
pub const FDT_LAST_SUPPORTED_VERSION: c_uint = 0x11;
// Error codes: informative error codes
pub const FDT_ERR_NOTFOUND: c_int = 1;
// FDT_ERR_NOTFOUND: The requested node or property does not exist
pub const FDT_ERR_EXISTS: c_int = 2;
// FDT_ERR_EXISTS: Attempted to create a node or property which
// already exists
pub const FDT_ERR_NOSPACE: c_int = 3;
...
// absolute path)
pub const FDT_ERR_BADPHANDLE: c_int = 6;
// FDT_ERR_BADPHANDLE: Function was passed an invalid phandle.
// This can be caused either by an invalid phandle property
// length, or the phandle value was either 0 or -1, which are
// not permitted.
pub const FDT_ERR_BADSTATE: c_int = 7;
// FDT_ERR_BADSTATE: Function was passed an incomplete device
// tree created by the sequential-write functions, which is
// not sufficiently complete for the requested operation.
// Error codes: codes for bad device tree blobs
pub const FDT_ERR_TRUNCATED: c_int = 8;
...
// tree magic number.
pub const FDT_ERR_BADVERSION: c_int = 10;
...
pub const FDT_ERR_BADLAYOUT: c_int = 12;
...
pub const FDT_ERR_BADNCELLS: c_int = 14;
// FDT_ERR_BADNCELLS: Device tree has a #address-cells, #size-cells
// or similar property with a bad format or value
pub const FDT_ERR_BADVALUE: c_int = 15;
// FDT_ERR_BADVALUE: Device tree has a property with an unexpected
// value. For example: a property expected to contain a string list
// is not NUL-terminated within the length of its value.
pub const FDT_ERR_BADOVERLAY: c_int = 16;
// FDT_ERR_BADOVERLAY: The device tree overlay, while
// correctly structured, cannot be applied due to some
// unexpected or missing value, property or node.
pub const FDT_ERR_NOPHANDLES: c_int = 17;
// FDT_ERR_NOPHANDLES: The device tree doesn't have any
// phandle available anymore without causing an overflow
pub const FDT_ERR_BADFLAGS: c_int = 18;
// FDT_ERR_BADFLAGS: The function was passed a flags field that
// contains invalid flags or an invalid combination of flags.
pub const FDT_ERR_ALIGNMENT: c_int = 19;
// FDT_ERR_ALIGNMENT: The device tree base address is not 8-byte
// aligned.
pub const FDT_ERR_MAX: c_int = 19;
// constants
pub const FDT_MAX_PHANDLE: c_uint = 0xfffffffe;
...
//
extern "C" {
    pub fn fdt_subnode_offset(fdt: *const c_void, parentoffset: c_int, name: *const c_char) -> c_int;
}
//
...
//
extern "C" {
    pub fn fdt_get_path(fdt: *const c_void, nodeoffset: c_int, buf: *mut c_char, buflen: c_int) -> c_int;
}
//
...
// values aren't used.
//
pub const FDT_MAX_NCELLS: c_int = 4;
//
...
//
extern "C" {
    pub fn fdt_setprop_inplace(_arg: fdt, _arg: nodeoffset, _arg: name, _arg: &tmp, _arg: sizeof(tmp)) -> return;
}
//
...
//
extern "C" {
    pub fn fdt_setprop_inplace_u32(_arg: fdt, _arg: nodeoffset, _arg: name, _arg: val) -> return;
}
//
...
pub const FDT_CREATE_FLAG_NO_NAME_DEDUP: c_uint = 0x1;
...
extern "C" {
    pub fn fdt_property(_arg: fdt, _arg: name, _arg: &tmp, _arg: sizeof(tmp)) -> return;
}
extern "C" {
    pub fn fdt_property(_arg: fdt, _arg: name, _arg: &tmp, _arg: sizeof(tmp)) -> return;
}
...
extern "C" {
    pub fn fdt_property_u32(_arg: fdt, _arg: name, _arg: val) -> return;
}
...
//
extern "C" {
    pub fn fdt_property_placeholder(fdt: *mut c_void, name: *const c_char, len: c_int, valp: *mut c_void) -> c_int;
}
...
//
extern "C" {
    pub fn fdt_finish(fdt: *mut c_void) -> c_int;
}
//
...
//
extern "C" {
    pub fn fdt_setprop(_arg: fdt, _arg: nodeoffset, _arg: name, _arg: &tmp, _arg: sizeof(tmp)) -> return;
}
//
...
//
extern "C" {
    pub fn fdt_setprop_u32(_arg: fdt, _arg: nodeoffset, _arg: name, _arg: val) -> return;
}
//
...
//
extern "C" {
    pub fn fdt_appendprop(_arg: fdt, _arg: nodeoffset, _arg: name, _arg: &tmp, _arg: sizeof(tmp)) -> return;
}
//
...
//
extern "C" {
    pub fn fdt_appendprop_u32(_arg: fdt, _arg: nodeoffset, _arg: name, _arg: val) -> return;
}
//
