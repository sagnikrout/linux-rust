...
//! Source: scripts/dtc/libfdt/fdt_overlay.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn overlay_get_target_phandle(fdto: *const c_void, fragment: c_int) -> u32 {
    ...
    {
    uint32_t phandle;
    const char *path = core::ptr::null_mut();
    let mut path_len: c_int = 0, ret;
...
//
#[no_mangle]
unsafe extern "C" fn overlay_adjust_local_phandles(fdto: *mut c_void, delta: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn overlay_update_local_references(fdto: *mut c_void, delta: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn overlay_fixup_phandles(fdt: *mut c_void, fdto: *mut c_void) -> c_int {
...
//
    ...
    fdt_for_each_subnode(fixup_child, fdto, fixup_node) {
    const char *fixup_child_name = fdt_get_name(fdto, fixup_child, core::ptr::null_mut());
    int tree_child;
...
//
    ...
    const char *name = fdt_get_name(fdto, fdtochild, core::ptr::null_mut());
    int fdtchild;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn overlay_prevent_phandle_overwrite(fdt: *mut c_void, fdto: *mut c_void) -> c_int {
    ...
    if (overlay < 0)
    return overlay;
    target = fdt_overlay_target_offset(fdt, fdto, fragment, core::ptr::null_mut());
...
//
    continue;
#[no_mangle]
pub unsafe extern "C" fn if(0: target <) -> else {
    else if (target < 0)
    return target;
...
//
    ...
    const char *name = fdt_get_name(fdto, subnode, core::ptr::null_mut());
    int nnode;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn overlay_merge(fdt: *mut c_void, fdto: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_path_len(fdt: *const c_void, nodeoffset: c_int) -> c_int {
    static int get_path_len(const void *fdt, int nodeoffset)
    {
    let mut len: c_int = 0, namelen;
    const char *name;
    FDT_RO_PROBE(fdt);
    for (;;) {
...
//
#[no_mangle]
unsafe extern "C" fn overlay_symbol_update(fdt: *mut c_void, fdto: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fdt_overlay_apply(fdt: *mut c_void, fdto: *mut c_void) -> c_int {
