...
//! Source: scripts/genksyms/keywords.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_reserved_word(str: *const register char, len: register unsigned int) -> c_int {
