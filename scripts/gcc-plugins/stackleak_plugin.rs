...
//! Source: scripts/gcc-plugins/stackleak_plugin.c
#![no_std]
...
//
    ...
    let mut track_frame_size: static int = -1;
    let mut build_for_x86: static bool = false;
    static const char track_function[] = "__sanitizer_cov_stack_depth";
    let mut disable: static bool = false;
...
#[no_mangle]
unsafe extern "C" fn add_stack_tracking_gcall(gsi: *mut gimple_stmt_iterator, after: bool) {
...
#[no_mangle]
unsafe extern "C" fn is_alloca(stmt: gimple) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_stack_tracking_gasm(gsi: *mut gimple_stmt_iterator, after: bool) {
    static void add_stack_tracking_gasm(gimple_stmt_iterator *gsi, bool after)
    {
    gasm *asm_call = core::ptr::null_mut();
    tree sp_decl, input;
    vec<tree, va_gc> *inputs = core::ptr::null_mut();
...
//
    ...
    inputs, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn add_stack_tracking(gsi: *mut gimple_stmt_iterator, after: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn stackleak_instrument_execute() -> c_uint {
    static unsigned int stackleak_instrument_execute(void)
    {
    basic_block bb, entry_bb;
    let mut prologue_instrumented: bool = false, is_leaf = true;
    let mut gsi: gimple_stmt_iterator = { 0 };
//
...
#[no_mangle]
unsafe extern "C" fn large_stack_frame() -> bool {
...
#[no_mangle]
unsafe extern "C" fn remove_stack_tracking_gcall() {
...
#[no_mangle]
unsafe extern "C" fn remove_stack_tracking_gasm() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn stackleak_cleanup_execute() -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn string_equal(node: tree, string: *const c_char, length: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stackleak_gate() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn stackleak_instrument_gate() -> bool {
...
#[no_mangle]
unsafe extern "C" fn stackleak_cleanup_gate() -> bool {
...
// Give the information about the plugin
    register_callback(plugin_name, PLUGIN_INFO, core::ptr::null_mut(),
    &stackleak_plugin_info);
// Register to be called before processing a translation unit
    register_callback(plugin_name, PLUGIN_START_UNIT,
    &stackleak_start_unit, core::ptr::null_mut());
// Register an extra GCC garbage collector (GGC) root table
    register_callback(plugin_name, PLUGIN_REGISTER_GGC_ROOTS, core::ptr::null_mut(),
...
//
    register_callback(plugin_name, PLUGIN_PASS_MANAGER_SETUP, core::ptr::null_mut(),
