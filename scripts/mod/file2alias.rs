...
//! Source: scripts/mod/file2alias.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn __attribute__((printf: (format, _arg: 3, _arg: 4))) {
...
// Determine required size.
    va_start(ap, fmt);
    n = vsnprintf(core::ptr::null_mut(), 0, fmt, ap);
    va_end(ap);
    if (n < 0) {
...
// avoid duplication
    ...
    new.builtin_modname = core::ptr::null_mut();
...
pub struct devtable {
    ...
    pub id_size: c_ulong,
    pub symval): *mut *mut *mut void (do_entry)(struct module mod, void,
}
...
#[no_mangle]
pub unsafe extern "C" fn add_uuid(str: *mut c_char, uuid: uuid_le) {
...
#[no_mangle]
pub unsafe extern "C" fn add_guid(str: *mut c_char, guid: guid_t) {
...
#[no_mangle]
pub unsafe extern "C" fn if(max: range_lo > 0 || range_hi <) -> else {
...
#[no_mangle]
unsafe extern "C" fn do_usb_entry_multi(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_of_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_hid_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_ieee1394_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_pci_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_ccw_entry(mod: *mut module, symval: *mut c_void) {
...
// looks like: "ap:tN"
#[no_mangle]
unsafe extern "C" fn do_ap_entry(mod: *mut module, symval: *mut c_void) {
...
// looks like: "css:tN"
#[no_mangle]
unsafe extern "C" fn do_css_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_serio_entry(mod: *mut module, symval: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn do_acpi_entry(mod: *mut module, symval: *mut c_void) {
...
// looks like: "pnp:dD"
#[no_mangle]
unsafe extern "C" fn do_pnp_device_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_pnp_card_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_pcmcia_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_vio_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __attribute__(_arg: (format(printf, _arg: 3, _arg: 4))) {
    static void __attribute__((format(printf, 3, 4)))
    alias_append(char *alias, size_t size, const char *fmt, ...)
    {
    let mut len: usize = strlen(alias);
    va_list args;
    int n;
    if (len >= size)
...
#[no_mangle]
unsafe extern "C" fn do_input_entry(mod: *mut module, symval: *mut c_void) {
    static void do_input_entry(struct module *mod, void *symval)
    {
    char alias[256] = {};
    let mut sizeof_alias: usize = sizeof(alias);
...
#[no_mangle]
unsafe extern "C" fn do_eisa_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_parisc_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_sdio_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_ssb_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_bcma_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_virtio_entry(mod: *mut module, symval: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn do_vmbus_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: rpmsg:S
#[no_mangle]
unsafe extern "C" fn do_rpmsg_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: i2c:S
#[no_mangle]
unsafe extern "C" fn do_i2c_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_i3c_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_slim_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: spi:S
#[no_mangle]
unsafe extern "C" fn do_spi_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dmi_ascii_filter(d: *mut c_char, avail: usize, s: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn do_dmi_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_platform_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_mdio_entry(mod: *mut module, symval: *mut c_void) {
    ...
    id[i] = '?';
#[no_mangle]
pub unsafe extern "C" fn if(1: (phy_id >> (31-i)) &) -> else {
...
// Looks like: zorro:iN.
#[no_mangle]
unsafe extern "C" fn do_zorro_entry(mod: *mut module, symval: *mut c_void) {
...
// looks like: "pnp:dD"
#[no_mangle]
unsafe extern "C" fn do_isapnp_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_ipack_entry(mod: *mut module, symval: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn do_amba_entry(mod: *mut module, symval: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn do_mips_cdmm_entry(mod: *mut module, symval: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn do_x86cpu_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_cpu_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: mcb:16zN
#[no_mangle]
unsafe extern "C" fn do_mcb_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_mei_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_rio_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_ulpi_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_hda_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_sdw_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_fsl_mc_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_tbsvc_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_typec_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: tee:uuid
#[no_mangle]
unsafe extern "C" fn do_tee_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: wmi:guid
#[no_mangle]
unsafe extern "C" fn do_wmi_entry(mod: *mut module, symval: *mut c_void) {
...
// guid_string, mod->name);
    ...
    let mut value: c_char = (*guid_string)[i];
...
// Looks like: mhi:S
#[no_mangle]
unsafe extern "C" fn do_mhi_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: mhi_ep:S
#[no_mangle]
unsafe extern "C" fn do_mhi_ep_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_ishtp_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_auxiliary_entry(mod: *mut module, symval: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn do_ssam_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: dfl:tNfN
#[no_mangle]
unsafe extern "C" fn do_dfl_entry(mod: *mut module, symval: *mut c_void) {
...
// Looks like: cdx:vNdN
#[no_mangle]
unsafe extern "C" fn do_cdx_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_vchiq_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_coreboot_entry(mod: *mut module, symval: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sym_is(name: *const c_char, namelen: unsigned, symbol: *const c_char) -> bool {
...
// Verify the last entry is a terminator
    ...
    if (*(uint8_t *)(symval + i)) {
    error("%s: %s[] is not terminated with a core::ptr::null_mut() entry\n",
    mod.name, name);
    return;
    }
    }
