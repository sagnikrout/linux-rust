...
//! Source: scripts/gendwarfksyms/dwarf.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn is_kabi_prefix(name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn process_linebreak(cache: *mut die, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_ref_die_attr(die: *mut Dwarf_Die, id: c_uint, value: *mut Dwarf_Die) -> bool {
...
#[no_mangle]
unsafe extern "C" fn match_export_symbol(state: *mut state, die: *mut Dwarf_Die) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_definition_private(die: *mut Dwarf_Die) -> bool {
...
//
    ...
    if (res >= 0)
    return !!res;
    if (!dwarf_cu_die(die.cu, &cudie, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut()))
    error("dwarf_cu_die failed: '%s'", dwarf_errmsg(-1));
    if (dwarf_getsrcfiles(&cudie, &files, core::ptr::null_mut()))
    error("dwarf_getsrcfiles failed: '%s'", dwarf_errmsg(-1));
    s = dwarf_filesrc(files, filenum, core::ptr::null_mut(), core::ptr::null_mut());
    if (!s)
...
#[no_mangle]
unsafe extern "C" fn is_kabi_definition(cache: *mut die, die: *mut Dwarf_Die) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn process(cache: *mut die, s: *const c_char) {
...
pub const MAX_FMT_BUFFER_SIZE: c_int = 128;
#[no_mangle]
unsafe extern "C" fn process_fmt(cache: *mut die, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn update_fqn(cache: *mut die, die: *mut Dwarf_Die) {
...
#[no_mangle]
unsafe extern "C" fn process_fqn(cache: *mut die, die: *mut Dwarf_Die) {
...
#[no_mangle]
unsafe extern "C" fn process_byte_size_attr(cache: *mut die, die: *mut Dwarf_Die) {
...
#[no_mangle]
pub unsafe extern "C" fn match_all(die: *mut Dwarf_Die) -> bool {
...
#[no_mangle]
unsafe extern "C" fn process_list_comma(state: *mut state, cache: *mut die) {
...
// Comma-separated with DW_AT_type
    ...
    state.kabi.orig_name = core::ptr::null_mut();
    }
...
// Container types with DW_AT_type
    ...
    Dwarf_Die *die)
    {
    let mut count: Dwarf_Word = 0;
    if (get_udata_attr(die, DW_AT_count, &count))
    process_fmt(cache, "[%" PRIu64 "]", count);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: get_udata_attr(die, _arg: DW_AT_upper_bound, _arg: &count)) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_kabi_status(die: *mut Dwarf_Die, suffix: *const c_char) -> c_int {
...
//
    ...
    state, core::ptr::null_mut(), &type, check_struct_member_kabi_status,
    match_member_type));
...
//
    ...
    res = checkp(process_die_container(&state, core::ptr::null_mut(), die,
...
#[no_mangle]
unsafe extern "C" fn is_kabi_ignored(die: *mut Dwarf_Die) -> bool {
    ...
    checkp(get_union_kabi_status(&type, core::ptr::null_mut(), core::ptr::null_mut())) == KABI_IGNORED;
    }
...
//
    ...
    df.data.str);
    process(core::ptr::null_mut(), df.data.str);
    break;
    case FRAGMENT_LINEBREAK:
    process_linebreak(core::ptr::null_mut(), df.data.linebreak);
    break;
    case FRAGMENT_DIE:
    ...
    check(process_type(state, core::ptr::null_mut(), &child));
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn state_init(state: *mut state) {
    static void state_init(struct state *state)
    {
    state.expand.expand = true;
    state.expand.current_fqn = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn is_expanded_type(tag: c_int) -> bool {
    ...
    break;
#[no_mangle]
unsafe extern "C" fn process_type(state: *mut state, parent: *mut die, die: *mut Dwarf_Die) -> c_int {
    static int process_type(struct state *state, struct die *parent, Dwarf_Die *die)
    {
    let mut want_state: enum die_state = DIE_COMPLETE;
    struct die *cache;
    struct expansion_state saved;
    let mut tag: c_int = dwarf_tag(die);
...
//
    ...
    return core::ptr::null_mut(); /* We already processed a symbol for this DIE */
...
#[no_mangle]
unsafe extern "C" fn process_subprogram(state: *mut state, die: *mut Dwarf_Die) {
...
#[no_mangle]
unsafe extern "C" fn process_variable(state: *mut state, die: *mut Dwarf_Die) {
    static void process_variable(struct state *state, Dwarf_Die *die)
    {
    process_symbol(state, die, __process_variable);
    }
#[no_mangle]
unsafe extern "C" fn save_symbol_ptr(state: *mut state) {
...
// Possible containers of exported symbols
    ...
    core::ptr::null_mut(), cache, die, process_exported_symbols, match_all));
...
#[no_mangle]
pub unsafe extern "C" fn if(DW_TAG_subprogram: tag ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn process_symbol_ptr(sym: *mut symbol, arg: *mut c_void) {
...
// Move ownership of fqn to die_map.
    ...
    check(process_die_container(&state, core::ptr::null_mut(), die, resolve_fqns,
    match_all));
    free(prefix);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn process_cu(cudie: *mut Dwarf_Die) {
    void process_cu(Dwarf_Die *cudie)
    {
    check(process_die_container(core::ptr::null_mut(), core::ptr::null_mut(), cudie, resolve_fqns,
    match_all));
    check(process_die_container(core::ptr::null_mut(), core::ptr::null_mut(), cudie, process_exported_symbols,
    match_all));
