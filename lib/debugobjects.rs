...
pub const ODEBUG_HASH_BITS: c_int = 14;

// Must be power of two
pub const ODEBUG_BATCH_SIZE: c_int = 16;
...
#[derive(Copy, Clone)]
pub struct obj_pool {
    pub objects: hlist_head,
    pub cnt: c_uint,
    pub min_cnt: c_uint,
    pub max_cnt: c_uint,
    pub stats: pool_stats,
...
#[no_mangle]
unsafe extern "C" fn enable_object_debug(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn disable_object_debug(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pool_count(pool: *mut obj_pool) -> __always_inline unsigned int {
    static __always_inline unsigned int pool_count(struct obj_pool *pool)
    {
    return READ_ONCE(pool.cnt);
    }
#[no_mangle]
unsafe extern "C" fn pool_should_refill(pool: *mut obj_pool) -> __always_inline bool {
    static __always_inline bool pool_should_refill(struct obj_pool *pool)
    {
    return pool_count(pool) < pool.min_cnt;
    }
#[no_mangle]
unsafe extern "C" fn pool_must_refill(pool: *mut obj_pool) -> __always_inline bool {
    static __always_inline bool pool_must_refill(struct obj_pool *pool)
    {
    return pool_count(pool) < pool.min_cnt / 2;
    }
#[no_mangle]
unsafe extern "C" fn pool_move_batch(dst: *mut obj_pool, src: *mut obj_pool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pool_push_batch(dst: *mut obj_pool, head: *mut hlist_head) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pool_pop_batch(head: *mut hlist_head, src: *mut obj_pool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pcpu_refill_stats() {
...
#[no_mangle]
unsafe extern "C" fn pcpu_free(obj: *mut debug_obj) {
...
#[no_mangle]
unsafe extern "C" fn free_object_list(head: *mut hlist_head) {
...
#[no_mangle]
unsafe extern "C" fn fill_pool_from_freelist() {
...
#[no_mangle]
unsafe extern "C" fn kmem_alloc_batch(head: *mut hlist_head, cache: *mut kmem_cache, gfp: gfp_t) -> bool {
    static bool kmem_alloc_batch(struct hlist_head *head, struct kmem_cache *cache, gfp_t gfp)
    {
    struct hlist_node *last = core::ptr::null_mut();
    struct debug_obj *obj;
...
//
    ...
    let mut gfp: gfp_t = __GFP_HIGH | __GFP_NOWARN;
    HLIST_HEAD(head);
//
...
#[no_mangle]
unsafe extern "C" fn free_obj_work(work: *mut work_struct) {
    static void free_obj_work(struct work_struct *work)
    {
    static unsigned long last_use_avg;
    unsigned long cur_used, last_used, delta;
    let mut max_free: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn __free_object(obj: *mut debug_obj) {
...
//
#[no_mangle]
unsafe extern "C" fn free_object(obj: *mut debug_obj) {
...
#[no_mangle]
unsafe extern "C" fn put_objects(list: *mut hlist_head) {
...
#[no_mangle]
unsafe extern "C" fn object_cpu_offline(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_objects_oom() {
...
#[no_mangle]
unsafe extern "C" fn debug_print_object(obj: *mut debug_obj, msg: *mut c_char) {
...
//
    ...
    descr.debug_hint(obj.object) : core::ptr::null_mut();
    limit++;
...
#[no_mangle]
unsafe extern "C" fn debug_object_is_on_stack(addr: *mut c_void, onstack: c_int) {
    ...
    let mut state: enum debug_obj_state = ODEBUG_STATE_NONE;
    if (likely(obj))
    return obj;
//
...
#[no_mangle]
pub unsafe extern "C" fn debug_objects_is_pi_blocked_on() -> bool {
    static inline bool debug_objects_is_pi_blocked_on(void)
    {

    return current.pi_blocked_on != core::ptr::null_mut();

    return false;

    }
#[no_mangle]
pub unsafe extern "C" fn can_fill_pool() -> bool {
...
#[no_mangle]
unsafe extern "C" fn debug_objects_fill_pool() {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_object_init_on_stack(addr: *mut c_void, descr: *const debug_obj_descr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_object_activate(addr: *mut c_void, descr: *const debug_obj_descr) -> c_int {
    int debug_object_activate(void *addr, const struct debug_obj_descr *descr)
    {
    let mut o: debug_obj = { .object = addr, .state = ODEBUG_STATE_NOTAVAILABLE, .descr = descr };
    struct debug_bucket *db;
    struct debug_obj *obj;
    unsigned long flags;
    if (!debug_objects_enabled)
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_object_deactivate(addr: *mut c_void, descr: *const debug_obj_descr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_object_destroy(addr: *mut c_void, descr: *const debug_obj_descr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_object_free(addr: *mut c_void, descr: *const debug_obj_descr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_object_assert_init(addr: *mut c_void, descr: *const debug_obj_descr) {
...
#[no_mangle]
unsafe extern "C" fn __debug_check_no_obj_freed(address: *const c_void, size: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn debug_check_no_obj_freed(address: *const c_void, size: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn debug_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_objects_init_debugfs() -> int __init {
    static int __init debug_objects_init_debugfs(void)
    {
    struct dentry *dbgdir;
    if (!debug_objects_enabled)
    return 0;
    dbgdir = debugfs_create_dir("debug_objects", core::ptr::null_mut());
    debugfs_create_file("stats", 0444, dbgdir, core::ptr::null_mut(), &debug_stats_fops);
    return 0;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct self_test {
    pub dummy1: [c_ulong; 6],
    pub static_init: c_int,
    pub dummy2: [c_ulong; 3],
}

    static __initconst const struct debug_obj_descr descr_type_test;
#[no_mangle]
unsafe extern "C" fn is_static_object(addr: *mut c_void) -> __noipa bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_init(addr: *mut c_void, state: enum debug_obj_state) -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_activate(addr: *mut c_void, state: enum debug_obj_state) -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_destroy(addr: *mut c_void, state: enum debug_obj_state) -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_free(addr: *mut c_void, state: enum debug_obj_state) -> bool __init {
    ...
    let mut obj: static __initdata struct self_test = { .static_init = 0 };
#[no_mangle]
unsafe extern "C" fn debug_objects_selftest() -> bool __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_objects_early_init() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn debug_objects_replace_static_objects(cache: *mut kmem_cache) -> bool __init {
...
// Disconnect the boot pool.
    pool_boot.first = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_objects_mem_init() -> void __init {
    ...
    SLAB_DEBUG_OBJECTS | SLAB_NOLEAKTRACE, core::ptr::null_mut());
...
// Everything worked. Expose the cache
    ...
    cpuhp_setup_state_nocalls(CPUHP_DEBUG_OBJ_DEAD, "object:offline", core::ptr::null_mut(),
    object_cpu_offline);
