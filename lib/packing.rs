...
//
#[no_mangle]
unsafe extern "C" fn calculate_box_addr(box: usize, len: usize, quirks: u8) -> usize {
...
//
    let mut plogical_first_u8: c_int = startbit / BITS_PER_BYTE;
    let mut plogical_last_u8: c_int = endbit / BITS_PER_BYTE;
    let mut value_width: c_int = startbit - endbit + 1;
    int box;
