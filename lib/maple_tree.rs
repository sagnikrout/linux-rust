...
pub const MA_ROOT_PARENT: c_int = 1;
//
// Maple state flags
// * MA_STATE_PREALLOC		- Preallocated nodes, WARN_ON allocation
//
pub const MA_STATE_PREALLOC: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn mt_free_bulk(size: usize, nodes: *mut void __rcu) {
    static inline void mt_free_bulk(size_t size, void __rcu **nodes)
    {
    kmem_cache_free_bulk(maple_node_cache, size, (void **)nodes);
    }
#[no_mangle]
unsafe extern "C" fn mt_return_sheaf(sheaf: *mut slab_sheaf) {
...
//
#[no_mangle]
unsafe extern "C" fn ma_free_rcu(node: *mut maple_node) {
...
#[no_mangle]
unsafe extern "C" fn mt_set_height(mt: *mut maple_tree, height: c_uchar) {
    static void mt_set_height(struct maple_tree *mt, unsigned char height)
    {
    let mut new_flags: c_uint = mt.ma_flags;
...
#[no_mangle]
unsafe extern "C" fn mas_mt_height(mas: *mut ma_state) -> c_uint {
    static unsigned int mas_mt_height(struct ma_state *mas)
    {
    return mt_height(mas.tree);
    }
#[no_mangle]
pub unsafe extern "C" fn mt_attr(mt: *mut maple_tree) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ma_is_dense(type: enum maple_type) -> __always_inline bool {
    static __always_inline bool ma_is_dense(const enum maple_type type)
    {
    return type < maple_leaf_64;
    }
#[no_mangle]
unsafe extern "C" fn ma_is_leaf(type: enum maple_type) -> __always_inline bool {
    static __always_inline bool ma_is_leaf(const enum maple_type type)
    {
    return type < maple_range_64;
    }
#[no_mangle]
unsafe extern "C" fn mte_is_leaf(entry: *const maple_enode) -> __always_inline bool {
...
//
#[no_mangle]
unsafe extern "C" fn mt_is_reserved(entry: *const c_void) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn mas_set_err(mas: *mut ma_state, err: c_long) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn mas_is_ptr(mas: *const ma_state) -> __always_inline bool {
    static __always_inline bool mas_is_ptr(const struct ma_state *mas)
    {
    return mas.status == ma_root;
    }
#[no_mangle]
unsafe extern "C" fn mas_is_start(mas: *const ma_state) -> __always_inline bool {
    static __always_inline bool mas_is_start(const struct ma_state *mas)
    {
    return mas.status == ma_start;
    }
#[no_mangle]
unsafe extern "C" fn mas_is_none(mas: *const ma_state) -> __always_inline bool {
    static __always_inline bool mas_is_none(const struct ma_state *mas)
    {
    return mas.status == ma_none;
    }
#[no_mangle]
unsafe extern "C" fn mas_is_paused(mas: *const ma_state) -> __always_inline bool {
    static __always_inline bool mas_is_paused(const struct ma_state *mas)
    {
    return mas.status == ma_pause;
    }
#[no_mangle]
unsafe extern "C" fn mas_is_overflow(mas: *mut ma_state) -> __always_inline bool {
    static __always_inline bool mas_is_overflow(struct ma_state *mas)
    {
    return mas.status == ma_overflow;
    }
#[no_mangle]
pub unsafe extern "C" fn mas_is_underflow(mas: *mut ma_state) -> bool {
    static inline bool mas_is_underflow(struct ma_state *mas)
    {
    return mas.status == ma_underflow;
    }
#[no_mangle]
pub unsafe extern "C" fn mas_make_walkable(mas: *mut ma_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mte_set_node_dead(mn: *mut maple_enode) {
...
pub const MAPLE_ROOT_NODE: c_uint = 0x02;
// maple_type stored bit 3-6
pub const MAPLE_ENODE_TYPE_SHIFT: c_uint = 0x03;
// Bit 2 means a NULL somewhere below
pub const MAPLE_ENODE_NULL: c_uint = 0x04;
...
#[no_mangle]
pub unsafe extern "C" fn mte_has_null(node: *const maple_enode) -> bool __maybe_unused {
    static inline bool __maybe_unused mte_has_null(const struct maple_enode *node)
    {
    return (unsigned long)node & MAPLE_ENODE_NULL;
    }
#[no_mangle]
unsafe extern "C" fn ma_is_root(node: *mut maple_node) -> __always_inline bool {
    static __always_inline bool ma_is_root(struct maple_node *node)
    {
    return ((unsigned long)node.parent & MA_ROOT_PARENT);
    }
#[no_mangle]
unsafe extern "C" fn mte_is_root(node: *const maple_enode) -> __always_inline bool {
    static __always_inline bool mte_is_root(const struct maple_enode *node)
    {
    return ma_is_root(mte_to_node(node));
    }
#[no_mangle]
unsafe extern "C" fn mt_is_alloc(mt: *mut maple_tree) -> __always_inline bool {
...
//
pub const MAPLE_PARENT_ROOT: c_uint = 0x01;
pub const MAPLE_PARENT_SLOT_SHIFT: c_uint = 0x03;
pub const MAPLE_PARENT_SLOT_MASK: c_uint = 0xF8;
pub const MAPLE_PARENT_16B_SLOT_SHIFT: c_uint = 0x02;
pub const MAPLE_PARENT_16B_SLOT_MASK: c_uint = 0xFC;
pub const MAPLE_PARENT_RANGE64: c_uint = 0x06;
pub const MAPLE_PARENT_RANGE32: c_uint = 0x02;
pub const MAPLE_PARENT_NOT_RANGE16: c_uint = 0x02;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn mte_parent_shift(parent: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn mte_parent_slot_mask(parent: c_ulong) -> c_ulong {
...
//
    static inline
#[no_mangle]
pub unsafe extern "C" fn mas_parent_type(mas: *mut ma_state, enode: *mut maple_enode) -> enum maple_type {
...
#[no_mangle]
pub unsafe extern "C" fn mte_parent_slot(enode: *const maple_enode) -> c_uint {
    unsigned int mte_parent_slot(const struct maple_enode *enode)
    {
    let mut val: c_ulong = (unsigned long)mte_to_node(enode).parent;
...
//
#[no_mangle]
unsafe extern "C" fn ma_dead_node(node: *const maple_node) -> __always_inline bool {
...
//
#[no_mangle]
unsafe extern "C" fn mte_dead_node(enode: *const maple_enode) -> __always_inline bool {
...
//
    ...
    let mut type: enum maple_type = mte_node_type(mn);
...
#[no_mangle]
pub unsafe extern "C" fn mt_write_locked(mt: *const maple_tree) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt_locked(mt: *const maple_tree) -> __always_inline bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ma_meta_gap(mn: *mut maple_node) -> c_uchar {
...
//
    ...
    unsigned long shift;
    unsigned long type;
    let mut p_type: enum maple_type = mte_node_type(parent);
    unsigned char i;
    ...
    val &= ~MAPLE_NODE_MASK;
    for (i = 0; i < count; i++) {
    let mut pval: c_ulong = val | ((start_slot + i) << shift) | type;
...
//
    ...
    mte_to_mat(dead_enode).next = core::ptr::null_mut();
    if (!mat.tail) {
...
//
#[no_mangle]
unsafe extern "C" fn mas_mat_destroy(mas: *mut ma_state, mat: *mut ma_topiary) {
    static void mas_mat_destroy(struct ma_state *mas, struct ma_topiary *mat)
    {
    struct maple_enode *next;
    struct maple_node *node;
    let mut in_rcu: bool = mt_in_rcu(mas.tree);
    while (mat.head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_descend(mas: *mut ma_state) {
...
//
#[no_mangle]
unsafe extern "C" fn mas_ascend(mas: *mut ma_state) -> c_int {
    ...
    unsigned long *pivots;
    let mut set_max: bool = false, set_min = false;
    a_node = mas_mn(mas);
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_alloc_nodes(mas: *mut ma_state, gfp: gfp_t) {
...
#[no_mangle]
pub unsafe extern "C" fn mas_empty_nodes(mas: *mut ma_state) {
    static inline void mas_empty_nodes(struct ma_state *mas)
    {
    mas.node_request = 0;
    if (mas.sheaf) {
    mt_return_sheaf(mas.sheaf);
    mas.sheaf = core::ptr::null_mut();
    }
    if (mas.alloc) {
    kfree(mas.alloc);
    mas.alloc = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_free(mas: *mut ma_state, used: *mut maple_enode) {
...
#[no_mangle]
unsafe extern "C" fn mas_lock_check(mas: *mut ma_state) {
...
#[no_mangle]
unsafe extern "C" fn mas_init_lock_check(mas: *mut ma_state) {
...
#[no_mangle]
unsafe extern "C" fn mas_may_init_lock_check(mas: *mut ma_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_data_end(mas: *mut ma_state) -> c_uchar {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn wr_mas_setup(wr_mas: *mut ma_wr_state, mas: *mut ma_state) {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn wr_mas_ascend(wr_mas: *mut ma_wr_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_leaf_max_gap(mas: *mut ma_state) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_max_gap(mas: *mut ma_state) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_update_gap(mas: *mut ma_state) {
...
//
    ...
    {
    let mut type: enum maple_type = mte_node_type(parent);
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_find_child(mas: *mut ma_state, child: *mut ma_state) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_prev_sibling(mas: *mut ma_state) -> bool {
    static inline bool mas_prev_sibling(struct ma_state *mas)
    {
    let mut p_slot: c_uint = mte_parent_slot(mas.node);
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_next_sibling(mas: *mut ma_state) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wr_node_walk(wr_mas: *mut ma_wr_state) {
...
#[no_mangle]
pub unsafe extern "C" fn rebalance_sib(parent: *mut ma_state, sib: *mut ma_state) {
...
// Prioritize move right to pull data left
    ...
    {
    let mut l_tmp: ma_state = *l_wr_mas.mas;
    let mut r_tmp: ma_state = *r_wr_mas.mas;
    let mut depth: c_uchar = 0;
    do {
    mas_ascend(&r_tmp);
    mas_ascend(&l_tmp);
    depth++;
...
//
    ...
    unsigned char end)
    {
    let mut max_end: c_uchar = mt_slots[mt];
    unsigned char size;
    unsigned long *gaps;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: end <= max_end -) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wmb_replace(mas: *mut ma_state, cp: *mut maple_copy) {
...
//
    static inline
#[no_mangle]
pub unsafe extern "C" fn dst_setup(cp: *mut maple_copy, mas: *mut ma_state, mt: enum maple_type) {
...
#[no_mangle]
pub unsafe extern "C" fn init_cp_src(cp: *mut maple_copy) {
...
// Copy left 0 - offset
    ...
    let mut off: c_uchar = l_wr_mas.mas.offset - 1;
...
// Copy right either from offset or offset + 1 pending on r_max
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn cp_data_write(cp: *mut maple_copy, mas: *mut ma_state) {
...
//
    ...
    {
    unsigned char d;
    let mut slot_min: c_ulong = min;
    for (d = 0; d < cp.d_count; d++) {
    struct maple_node *mn = cp.dst[d].node;
    let mut mt: enum maple_type = cp.dst[d].mt;
    let mut slot_max: c_ulong = cp.dst[d].max;
//
...
#[no_mangle]
pub unsafe extern "C" fn cp_is_new_root(cp: *mut maple_copy, mas: *mut ma_state) -> bool {
    static inline bool cp_is_new_root(struct maple_copy *cp, struct ma_state *mas)
    {
    if (cp.min || cp.max != ULONG_MAX)
    return false;
    if (cp.d_count != 1) {
    let mut mt: enum maple_type = maple_arange_64;
    if (!mt_is_alloc(mas.tree))
    mt = maple_range_64;
    cp.data = cp.d_count;
    cp.s_count = 0;
...
// Converged and has a single destination
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn copy_tree_location(src: *const ma_state, dst: *mut ma_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_root_expand(mas: *mut ma_state, entry: *mut c_void) {
    static inline void mas_root_expand(struct ma_state *mas, void *entry)
    {
    void *contents = mas_root_locked(mas);
    let mut type: enum maple_type = maple_leaf_64;
    struct maple_node *node;
    void __rcu **slots;
    unsigned long *pivots;
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_store_root(mas: *mut ma_state, entry: *mut c_void) {
    static inline void mas_store_root(struct ma_state *mas, void *entry)
    {
    if (!entry) {
    if (!mas.index)
    rcu_assign_pointer(mas.tree.ma_root, core::ptr::null_mut());
    } else if (likely((mas.last != 0) || (mas.index != 0)))
    mas_root_expand(mas, entry);
#[no_mangle]
pub unsafe extern "C" fn if(2: ((unsigned long) (entry) & 3) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mas_is_span_wr(wr_mas: *mut ma_wr_state) -> bool {
    static bool mas_is_span_wr(struct ma_wr_state *wr_mas)
    {
    let mut max: c_ulong = wr_mas.r_max;
    let mut last: c_ulong = wr_mas.mas.last;
    let mut type: enum maple_type = wr_mas.type;
...
#[no_mangle]
pub unsafe extern "C" fn mas_wr_walk_descend(wr_mas: *mut ma_wr_state) {
...
#[no_mangle]
pub unsafe extern "C" fn mas_wr_walk_traverse(wr_mas: *mut ma_wr_state) {
...
//
#[no_mangle]
unsafe extern "C" fn mas_wr_walk(wr_mas: *mut ma_wr_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mas_wr_walk_index(wr_mas: *mut ma_wr_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_new_root(mas: *mut ma_state, entry: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn mas_wr_spanning_store(wr_mas: *mut ma_wr_state) {
...
// Left and Right side of spanning store
    MA_STATE(r_mas, core::ptr::null_mut(), 0, 0);
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wr_node_store(wr_mas: *mut ma_wr_state) {
...
// Copy to the end of node if necessary.
    ...
    let mut clear_from: c_uchar = new_end + 1;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wr_slot_store(wr_mas: *mut ma_wr_state) {
    static inline void mas_wr_slot_store(struct ma_wr_state *wr_mas)
    {
    struct ma_state *mas = wr_mas.mas;
    let mut offset: c_uchar = mas.offset;
    void __rcu **slots = wr_mas.slots;
    let mut gap: bool = false;
    gap |= !wr_mas.content;
...
#[no_mangle]
pub unsafe extern "C" fn mas_wr_extend_null(wr_mas: *mut ma_wr_state) {
...
#[no_mangle]
pub unsafe extern "C" fn mas_wr_end_piv(wr_mas: *mut ma_wr_state) {
...
#[no_mangle]
pub unsafe extern "C" fn mas_wr_new_end(wr_mas: *mut ma_wr_state) -> c_uchar {
    static inline unsigned char mas_wr_new_end(struct ma_wr_state *wr_mas)
    {
    struct ma_state *mas = wr_mas.mas;
    let mut new_end: c_uchar = mas.end + 2;
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wr_append(wr_mas: *mut ma_wr_state) {
    static inline void mas_wr_append(struct ma_wr_state *wr_mas)
    {
    struct ma_state *mas = wr_mas.mas;
    void __rcu **slots;
    let mut end: c_uchar = mas.end;
    let mut new_end: c_uchar = mas_wr_new_end(wr_mas);
...
//
#[no_mangle]
unsafe extern "C" fn mas_wr_split(wr_mas: *mut ma_wr_state) {
...
//
#[no_mangle]
unsafe extern "C" fn mas_wr_rebalance(wr_mas: *mut ma_wr_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wr_store_entry(wr_mas: *mut ma_wr_state) {
...
#[no_mangle]
pub unsafe extern "C" fn mas_wr_prealloc_setup(wr_mas: *mut ma_wr_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_prealloc_calc(wr_mas: *mut ma_wr_state, entry: *mut c_void) {
    static inline void mas_prealloc_calc(struct ma_wr_state *wr_mas, void *entry)
    {
    struct ma_state *mas = wr_mas.mas;
    let mut height: c_uchar = mas_mt_height(mas);
    let mut ret: c_int = height * 3 + 1;
    let mut delta: c_uchar = height - wr_mas.vacant_height;
    switch (mas.store_type) {
    case wr_exact_fit:
    case wr_append:
    case wr_slot_store:
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wr_store_type(wr_mas: *mut ma_wr_state) -> enum store_type {
...
// Potential spanning rebalance collapsing a node
    ...
    return wr_append;
#[no_mangle]
pub unsafe extern "C" fn if(one_slot: mas->end == new_end &&) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_wr_preallocate(wr_mas: *mut ma_wr_state, entry: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mas_rewalk(mas: *mut ma_state, index: c_ulong) -> __always_inline void {
...
//
#[no_mangle]
unsafe extern "C" fn mas_prev_node(mas: *mut ma_state, min: c_ulong) -> c_int {
...
//
    ...
    unsigned long *pivots;
    struct maple_node *node;
    let mut save_point: c_ulong = mas.index;
    retry:
    node = mas_mn(mas);
    type = mte_node_type(mas.node);
    pivots = ma_pivots(node, type);
...
//
    ...
    enum maple_type type;
    struct maple_node *node;
    let mut save_point: c_ulong = mas.last;
    void *entry;
    retry:
    node = mas_mn(mas);
    type = mte_node_type(mas.node);
...
//
    ...
    {
    let mut type: enum maple_type = mte_node_type(mas.node);
    struct maple_node *node = mas_mn(mas);
    unsigned long *pivots, *gaps;
    void __rcu **slots;
    let mut gap: c_ulong = 0;
    unsigned long max, min;
    unsigned char offset;
...
// Skip out of bounds.
    ...
    gap = gaps[offset];
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mas_slot(mas, _arg: slots, _arg: offset)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mas_anode_descend(mas: *mut ma_state, size: c_ulong) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mas_rewind_node(mas: *mut ma_state) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_skip_node(mas: *mut ma_state) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_awalk(mas: *mut ma_state, size: c_ulong) {
    static inline void mas_awalk(struct ma_state *mas, unsigned long size)
    {
    struct maple_enode *last = core::ptr::null_mut();
//
// There are 4 options:
// go to child (descend)
...
//
    ...
    mas_start(mas);
#[no_mangle]
pub unsafe extern "C" fn if(2: mas->offset >=) -> else {
    else if (mas.offset >= 2)
    mas.offset -= 2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mas_skip_node(mas)) -> else {
...
//
    ...
    mas_start(mas);
#[no_mangle]
pub unsafe extern "C" fn if((!mas_rewind_node(mas)): (mas->offset < 2) &&) -> else {
...
//
    ...
    void __rcu **slots = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mt_free_walk(head: *mut rcu_head) {
    static void mt_free_walk(struct rcu_head *head)
    {
    void __rcu **slots;
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_store_gfp(mas: *mut ma_state, entry: *mut c_void, gfp: gfp_t) -> c_int {
    int mas_store_gfp(struct ma_state *mas, void *entry, gfp_t gfp)
    {
    let mut index: c_ulong = mas.index;
    let mut last: c_ulong = mas.last;
    MA_WR_STATE(wr_mas, mas, entry);
    let mut ret: c_int = 0;
    mas_may_init_lock_check(mas);
    retry:
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_store_prealloc(mas: *mut ma_state, entry: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_preallocate(mas: *mut ma_state, entry: *mut c_void, gfp: gfp_t) -> c_int {
    ...
    if (mas_is_err(mas)) {
    let mut ret: c_int = xa_err(mas.node);
    mas.node_request = 0;
    mas_destroy(mas);
    mas_reset(mas);
    return ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_destroy(mas: *mut ma_state) {
...
#[no_mangle]
unsafe extern "C" fn mas_may_activate(mas: *mut ma_state) {
    ...
    void **entry)
    {
    let mut was_none: bool = mas_is_none(mas);
...
#[no_mangle]
unsafe extern "C" fn mas_prev_setup(mas: *mut ma_state, min: c_ulong, entry: *mut c_void) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_pause(mas: *mut ma_state) {
...
//
#[no_mangle]
unsafe extern "C" fn mas_find_setup(mas: *mut ma_state, max: c_ulong, entry: *mut c_void) -> __always_inline bool {
...
//
    ...
    void *entry;
    let mut index: c_ulong = mas.index;
    MA_WR_STATE(wr_mas, mas, core::ptr::null_mut());
//
...
// Must reset to ensure spanning writes of last slot are detected
    mas_reset(mas);
    mas_wr_preallocate(&wr_mas, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn mas_nomem(mas: *mut ma_state, gfp: gfp_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn maple_tree_init() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn mas_dup_free(mas: *mut ma_state) {
...
//
    ...
    {
    struct maple_node *node;
    struct maple_pnode *parent = core::ptr::null_mut();
    struct maple_enode *root;
    enum maple_type type;
...
//
#[no_mangle]
pub unsafe extern "C" fn __mt_dup(mt: *mut maple_tree, new: *mut maple_tree, gfp: gfp_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mtree_dup(mt: *mut maple_tree, new: *mut maple_tree, gfp: gfp_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __mt_destroy(mt: *mut maple_tree) {
    void __mt_destroy(struct maple_tree *mt)
    {
    void *root = mt_root_locked(mt);
    rcu_assign_pointer(mt.ma_root, core::ptr::null_mut());
    if (xa_is_node(root))
...
//
#[no_mangle]
pub unsafe extern "C" fn mtree_destroy(mt: *mut maple_tree) {
...
#[no_mangle]
pub unsafe extern "C" fn mt_set_non_kernel(val: c_uint) {
    ...
    void (*callback)(void *));
#[no_mangle]
pub unsafe extern "C" fn mt_set_callback(): *mut *mut void (callback)(void) {
...
#[no_mangle]
pub unsafe extern "C" fn mt_set_private(private: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mt_get_alloc_size() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn mt_zero_nr_tallocated() {
...
#[no_mangle]
pub unsafe extern "C" fn mt_nr_tallocated() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn mt_nr_allocated() -> c_uint {
    unsigned int mt_nr_allocated(void)
    {
    return kmem_cache_nr_allocated(maple_node_cache);
    }
#[no_mangle]
pub unsafe extern "C" fn mt_cache_shrink() {
...
#[no_mangle]
unsafe extern "C" fn mas_dfs_postorder(mas: *mut ma_state, max: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: xa_is_zero(entry)) -> else {
    else if (xa_is_zero(entry))
    pr_cont("zero (%ld)\n", xa_to_internal(entry));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mt_is_reserved(entry)) -> else {
    ...
    let mut leaf: bool = mte_is_leaf(entry);
    let mut first: c_ulong = min;
    int i;
    pr_cont(" contents: ");
    ...
    let mut last: c_ulong = max;
    if (i < (MAPLE_RANGE64_SLOTS - 1))
    last = node.pivot[i];
#[no_mangle]
pub unsafe extern "C" fn if(mt_node_max(entry): !node->slot[i] && max !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: node->slot[i]) -> else {
    else if (node.slot[i])
...
pub unsafe extern "C" fn if(_arg: !node->slot[i]) -> else {
    ...
    let mut type: c_uint = mte_node_type(entry);
    unsigned int i;
    mt_dump_range(min, max, depth, format);
    pr_cont("node " PTR_FMT " depth %d type %d parent " PTR_FMT, node,
    depth, type, node ? node.parent : core::ptr::null_mut());
    switch (type) {
    case maple_dense:
    pr_cont("\n");
...
#[no_mangle]
pub unsafe extern "C" fn mt_dump(mt: *const maple_tree, format: enum mt_dump_format) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: entry) -> else {
    else if (entry)
...
//
#[no_mangle]
unsafe extern "C" fn mas_validate_gaps(mas: *mut ma_state) {
    static void mas_validate_gaps(struct ma_state *mas)
    {
    struct maple_enode *mte = mas.node;
    struct maple_node *p_mn, *node = mte_to_node(mte);
    let mut mt: enum maple_type = mte_node_type(mas.node);
    let mut gap: c_ulong = 0, max_gap = 0;
    unsigned long p_end, p_start = mas.min;
    unsigned char p_slot, offset;
    unsigned long *gaps = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mas_validate_parent_slot(mas: *mut ma_state) {
...
#[no_mangle]
unsafe extern "C" fn mas_validate_child_slot(mas: *mut ma_state) {
...
//
#[no_mangle]
unsafe extern "C" fn mas_validate_limits(mas: *mut ma_state) {
    static void mas_validate_limits(struct ma_state *mas)
    {
    int i;
    let mut prev_piv: c_ulong = 0;
    let mut type: enum maple_type = mte_node_type(mas.node);
    void __rcu **slots = ma_slots(mte_to_node(mas.node), type);
...
#[no_mangle]
unsafe extern "C" fn mt_validate_nulls(mt: *mut maple_tree) {
    static void mt_validate_nulls(struct maple_tree *mt)
    {
    void *entry, *last = (void *)1;
    let mut offset: c_uchar = 0;
    void __rcu **slots;
    MA_STATE(mas, mt, 0, 0);
    mas_start(&mas);
    if (mas_is_none(&mas) || (mas_is_ptr(&mas)))
...
//
#[no_mangle]
pub unsafe extern "C" fn mt_validate(mt: *mut maple_tree) {
...
#[no_mangle]
pub unsafe extern "C" fn mas_dump(mas: *const ma_state) {
...
#[no_mangle]
pub unsafe extern "C" fn mas_wr_dump(wr_mas: *const ma_wr_state) {
