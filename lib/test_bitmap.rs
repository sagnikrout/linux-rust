...
#[no_mangle]
unsafe extern "C" fn test_zero_clear() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_find_nth_bit() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_fill_set() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_copy() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_region() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_replace() -> void __init {
    static void __init test_replace(void)
    {
    let mut nbits: c_uint = 64;
    let mut nlongs: c_uint = DIV_ROUND_UP(nbits, BITS_PER_LONG);
    DECLARE_BITMAP(bmap, 1024);
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_sg() -> void __init {
...
pub const PARSE_TIME: c_uint = 0x1;
pub const NO_LEN: c_uint = 0x2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct test_bitmap_parselist {
    pub errno: c_int,
    pub in: *const c_char,
    pub expected: *const c_ulong,
    pub nbits: c_int,
    pub flags: c_int,
}
    ...
    {0, "0-2047:128/256", core::ptr::null_mut(), 2048, PARSE_TIME},
    {0, "",				&exp1[12 * step], 8, 0},
    {0, "\n",			&exp1[12 * step], 8, 0},
    {0, ",,  ,,  , ,  ,",		&exp1[12 * step], 8, 0},
    {0, " ,  ,,  , ,   ",		&exp1[12 * step], 8, 0},
    ...
    {0,	  "ALL:1/2",		&exp1[4 * step], 32, 0},
    {-EINVAL, "al", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "alll", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "-1",	core::ptr::null_mut(), 8, 0},
    {-EINVAL, "-0",	core::ptr::null_mut(), 8, 0},
    {-EINVAL, "10-1", core::ptr::null_mut(), 8, 0},
    {-ERANGE, "8-8", core::ptr::null_mut(), 8, 0},
    {-ERANGE, "0-31", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "0-31:", core::ptr::null_mut(), 32, 0},
    {-EINVAL, "0-31:0", core::ptr::null_mut(), 32, 0},
    {-EINVAL, "0-31:0/", core::ptr::null_mut(), 32, 0},
    {-EINVAL, "0-31:0/0", core::ptr::null_mut(), 32, 0},
    {-EINVAL, "0-31:1/0", core::ptr::null_mut(), 32, 0},
    {-EINVAL, "0-31:10/1", core::ptr::null_mut(), 32, 0},
    {-EOVERFLOW, "0-98765432123456789:10/1", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "a-31", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "0-a1", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "a-31:10/1", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "0-31:a/1", core::ptr::null_mut(), 8, 0},
    {-EINVAL, "0-\n", core::ptr::null_mut(), 8, 0},
    };
#[no_mangle]
unsafe extern "C" fn test_bitmap_parselist() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_printlist() -> void __init {
    ...
    {0, " , badf00d,deadbeef,1,0 , ",	&parse_test2[2 * 2 * step], 124, 0},
    {0, " , badf00d, ,, ,,deadbeef,1,0 , ",	&parse_test2[2 * 2 * step], 124, 0},
    {-EINVAL,    "goodfood,deadbeef,1,0",	core::ptr::null_mut(), 128, 0},
    {-EOVERFLOW, "3,0",			core::ptr::null_mut(), 33, 0},
    {-EOVERFLOW, "123badf00d,deadbeef,1,0",	core::ptr::null_mut(), 128, 0},
    {-EOVERFLOW, "badf00d,deadbeef,1,0",	core::ptr::null_mut(), 90, 0},
    {-EOVERFLOW, "fbadf00d,deadbeef,1,0",	core::ptr::null_mut(), 95, 0},
    {-EOVERFLOW, "badf00d,deadbeef,1,0",	core::ptr::null_mut(), 100, 0},

    };
#[no_mangle]
unsafe extern "C" fn test_bitmap_parse() -> void __init {
    ...
    let mut test: test_bitmap_parselist = parse_tests[i];
    let mut len: usize = test.flags & NO_LEN ? UINT_MAX : strlen(test.in);
    time = ktime_get();
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_arr32() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_arr64() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_mem_optimisations() -> void noinline __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_set_clump8() -> void __init {
    static void __init test_for_each_set_clump8(void)
    {
pub const CLUMP_EXP_NUMBITS: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn test_for_each_set_bit_wrap() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_set_bit() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_set_bit_from() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_weight() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_clear_bit() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_clear_bit_from() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_set_bitrange() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_clear_bitrange() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_set_bitrange_from() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_for_each_clear_bitrange_from() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct test_bitmap_cut {
    pub first: c_uint,
    pub cut: c_uint,
    pub nbits: c_uint,
    pub in: [c_ulong; 4],
    pub expected: [c_ulong; 4],
}
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_cut() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct test_bitmap_print {
    pub bitmap: *const c_ulong,
    pub nbits: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_print_buf() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn test_bitmap_const_eval() -> void __init {
    static void __init test_bitmap_const_eval(void)
    {
    DECLARE_BITMAP(bitmap, BITS_PER_LONG);
    let mut initvar: c_ulong = BIT(2);
    let mut bitopvar: c_ulong = 0;
    let mut var: c_ulong = 0;
    int res;
//
...
//
#[no_mangle]
unsafe extern "C" fn test_bitmap_write_helper(pattern: *const c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_read_write() -> void __init {
    static void __init test_bitmap_read_write(void)
    {
    unsigned char *pattern[3] = {"", "all:1/2", "all"};
    DECLARE_BITMAP(bitmap, TEST_BIT_LEN);
    let mut zero_bits: c_ulong = 0, bits_per_long = BITS_PER_LONG;
    unsigned long val;
    int i, pi;
//
...
//
    bitmap_write(core::ptr::null_mut(), 0, 0, READ_ONCE(zero_bits));
// Return value of bitmap_read() is undefined here.
    bitmap_read(core::ptr::null_mut(), 0, READ_ONCE(zero_bits));
//
// Reading/writing more than BITS_PER_LONG bits should not crash the
// kernel. READ_ONCE() prevents constant folding.
//
    bitmap_write(core::ptr::null_mut(), 0, 0, READ_ONCE(bits_per_long) + 1);
// Return value of bitmap_read() is undefined here.
    bitmap_read(core::ptr::null_mut(), 0, READ_ONCE(bits_per_long) + 1);
//
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_read_perf() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_bitmap_write_perf() -> void __init {
    static void __init test_bitmap_write_perf(void)
    {
    DECLARE_BITMAP(bitmap, TEST_BIT_LEN);
    unsigned int cnt, nbits, i;
    let mut val: c_ulong = 0xfeedface;
    ktime_t time;
    bitmap_zero(bitmap, TEST_BIT_LEN);
    time = ktime_get();
    for (cnt = 0; cnt < 5; cnt++) {
...
//
#[no_mangle]
unsafe extern "C" fn test_zero_nbits() -> void __init {
    static void __init test_zero_nbits(void)
    {
    static volatile __always_used unsigned long ret __initdata;
    bitmap_clear(core::ptr::null_mut(), 0, 0);
    bitmap_complement(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_copy(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_copy_clear_tail(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_fill(core::ptr::null_mut(), 0);
    bitmap_from_arr32(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_from_arr64(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_or(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_set(core::ptr::null_mut(), 0, 0);
    bitmap_shift_left(core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    bitmap_shift_right(core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    bitmap_to_arr32(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_to_arr64(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_write(core::ptr::null_mut(), 0, 0, 0);
    bitmap_xor(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    bitmap_zero(core::ptr::null_mut(), 0);
    ret = bitmap_and(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = bitmap_empty(core::ptr::null_mut(), 0);
    ret = bitmap_equal(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = bitmap_full(core::ptr::null_mut(), 0);
    ret = bitmap_or_equal(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = bitmap_read(core::ptr::null_mut(), 0, 0);
    ret = bitmap_subset(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = bitmap_weight(core::ptr::null_mut(), 0);
    ret = bitmap_weight_and(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = bitmap_weight_andnot(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = bitmap_weight_from(core::ptr::null_mut(), 0, 0);
    ret = bitmap_weighted_or(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = find_first_and_and_bit(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = find_first_and_bit(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = find_first_andnot_bit(core::ptr::null_mut(), core::ptr::null_mut(), 0);
    ret = find_first_bit(core::ptr::null_mut(), 0);
    ret = find_first_zero_bit(core::ptr::null_mut(), 0);
    ret = find_last_bit(core::ptr::null_mut(), 0);
    ret = find_next_and_bit(core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    ret = find_next_andnot_bit(core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    ret = find_next_bit(core::ptr::null_mut(), 0, 0);
    ret = find_next_clump8(core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    ret = find_next_zero_bit(core::ptr::null_mut(), 0, 0);
    ret = find_nth_and_bit(core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    ret = find_nth_bit(core::ptr::null_mut(), 0, 0);
    ret = find_random_bit(core::ptr::null_mut(), 0);
    }
