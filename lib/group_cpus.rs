...
#[no_mangle]
unsafe extern "C" fn free_node_to_cpumask(masks: *mut cpumask_var_t) {
...
#[no_mangle]
unsafe extern "C" fn build_node_to_cpumask(masks: *mut cpumask_var_t) {
...
#[no_mangle]
unsafe extern "C" fn ncpus_cmp_func(l: *const c_void, r: *const c_void) -> c_int {
...
// Get the cpus on this cluster.
    ...
    let mut last_grp: c_uint = numgrps;
    let mut curgrp: c_uint = startgrp;
    let mut nodemsk: nodemask_t = NODE_MASK_NONE;
    struct node_groups *node_groups;
...
//
    ...
    {
    let mut curgrp: c_uint = 0, nr_present = 0, nr_others = 0;
    cpumask_var_t *node_to_cpumask;
