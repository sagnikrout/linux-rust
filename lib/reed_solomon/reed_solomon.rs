...
//! Source: lib/reed_solomon/reed_solomon.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn free_rs(rs: *mut rs_control) {
...
//
    ...
    {
    return init_rs_internal(symsize, gfpoly, core::ptr::null_mut(), fcr, prim, nroots, gfp);
    }
