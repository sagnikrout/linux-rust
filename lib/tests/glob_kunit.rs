...
#[no_mangle]
unsafe extern "C" fn glob_case_to_desc(t: *const glob_test_case, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn glob_test_match(test: *mut kunit) {
