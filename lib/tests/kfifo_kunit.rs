...
//! Source: lib/tests/kfifo_kunit.c
#![no_std]
...
pub const KFIFO_SIZE: c_int = 32;
pub const N_ELEMENTS: c_int = 5;
#[no_mangle]
unsafe extern "C" fn kfifo_test_reset_should_clear_the_fifo(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_define_should_define_an_empty_fifo(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_len_should_ret_n_of_stored_elements(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_put_should_insert_and_get_should_pop(test: *mut kunit) {
    static void kfifo_test_put_should_insert_and_get_should_pop(struct kunit *test)
    {
    let mut out_data: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_in_should_insert_multiple_elements(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_out_should_pop_multiple_elements(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_dec_init_should_define_an_empty_fifo(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_define_should_equal_declare_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_alloc_should_initiliaze_a_ptr_fifo(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kfifo_test_peek_should_not_remove_elements(test: *mut kunit) {
