...
#[no_mangle]
unsafe extern "C" fn uuid_test_guid_valid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn uuid_test_uuid_valid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn uuid_test_guid_invalid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn uuid_test_uuid_invalid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn uuid_test_uuid_gen(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn uuid_test_guid_gen(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn uuid_test_generate_random_uuid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn uuid_test_generate_random_guid(test: *mut kunit) {
