...
//! Source: lib/tests/scanf_kunit.c
#![no_std]
...
pub const BUF_SIZE: c_int = 1024;
    ...
    va_list ap);
#[no_mangle]
unsafe extern "C" fn __scanf(_arg: 7, _arg: 9) {
...
#[no_mangle]
unsafe extern "C" fn numbers_simple(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn next_test_random(max_bits: u32) -> u32 {
    static u32 next_test_random(u32 max_bits)
    {
    let mut n_bits: u32 = hweight32(prandom_u32_state(&rnd_state)) % (max_bits + 1);
    return prandom_u32_state(&rnd_state) & GENMASK(n_bits, 0);
    }
#[no_mangle]
unsafe extern "C" fn next_test_random_ull() -> c_ulonglong {
    static unsigned long long next_test_random_ull(void)
    {
    let mut rand1: u32 = prandom_u32_state(&rnd_state);
    let mut n_bits: u32 = (hweight32(rand1) * 3) % 64;
    let mut val: u64 = (u64)prandom_u32_state(&rnd_state) * rand1;
...
//
pub const NEGATIVES_PATTERN: c_uint = 0x3246	/* 00110010 01000110 */;
...
//
#[no_mangle]
unsafe extern "C" fn __printf(_arg: 4, _arg: 5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_ll(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_l(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_d(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_h(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_hh(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_ll(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_l(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_d(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_h(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_hh(test: *mut kunit, delim: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_typemax(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_val_ll(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_val_l(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_val_d(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_val_h(test: *mut kunit, delim: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_val_hh(test: *mut kunit, delim: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn numbers_list_field_width_val_width(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn numbers_slice(test: *mut kunit) {
    static void numbers_slice(struct kunit *test)
    {
    const char *delim = "";
    KUNIT_ASSERT_PTR_EQ(test, test.param_value, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn numbers_prefix_overflow(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_simple_strtoull(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_simple_strtoll(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_simple_strtoul(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_simple_strtol(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn scanf_suite_init(suite: *mut kunit_suite) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scanf_suite_exit(suite: *mut kunit_suite) {
