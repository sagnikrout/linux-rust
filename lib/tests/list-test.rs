...
#[no_mangle]
unsafe extern "C" fn list_test_list_init(test: *mut kunit) {
    static void list_test_list_init(struct kunit *test)
    {
// Test the different ways of initialising a list.
    let mut list1: list_head = LIST_HEAD_INIT(list1);
...
#[no_mangle]
unsafe extern "C" fn list_test_list_add(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_add_tail(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_del(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_replace(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_replace_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_swap(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_del_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_del_init_careful(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_move(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_move_tail(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_bulk_move_tail(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_is_head(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_is_first(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_is_last(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_empty(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_empty_careful(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_rotate_left(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_rotate_to_front(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_is_singular(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_cut_position(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_cut_before(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_splice(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_splice_tail(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_splice_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_splice_tail_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_entry_is_head(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_first_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_last_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_first_entry_or_null(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_next_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_prev_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_for_each(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_for_each_prev(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_for_each_safe(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_for_each_prev_safe(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_for_each_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn list_test_list_for_each_entry_reverse(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_init(test: *mut kunit) {
    static void hlist_test_init(struct kunit *test)
    {
// Test the different ways of initialising a list.
    let mut list1: hlist_head = HLIST_HEAD_INIT;
...
#[no_mangle]
unsafe extern "C" fn hlist_test_unhashed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_unhashed_lockless(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_del(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_del_init(test: *mut kunit) {
...
// a is now initialised
    KUNIT_EXPECT_PTR_EQ(test, a.next, core::ptr::null_mut());
    KUNIT_EXPECT_PTR_EQ(test, a.pprev, core::ptr::null_mut());
    }
// Tests all three hlist_add_* functions
#[no_mangle]
unsafe extern "C" fn hlist_test_add(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_fake(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_is_singular_node(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_empty(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_move_list(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_entry_safe(test: *mut kunit) {
    ...
    struct hlist_test_struct, list));
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(),
    hlist_entry_safe((struct hlist_node *)core::ptr::null_mut(),
    struct hlist_test_struct, list));
    }
#[no_mangle]
unsafe extern "C" fn hlist_test_for_each(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_for_each_safe(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_for_each_entry(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_for_each_entry_continue(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_for_each_entry_from(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn hlist_test_for_each_entry_safe(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn check_node(node_ptr: *mut klist_node) {
...
#[no_mangle]
unsafe extern "C" fn check_delete_node(node_ptr: *mut klist_node) {
...
#[no_mangle]
unsafe extern "C" fn klist_test_add_tail(test: *mut kunit) {
    ...
    struct klist_iter i;
    node_count = 0;
    klist_init(&mylist, &check_node, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn klist_test_add_head(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn klist_test_add_behind(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn klist_test_add_before(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn klist_test_del_refcount_greater_than_zero(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn klist_test_del_refcount_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn klist_test_remove(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn klist_test_node_attached(test: *mut kunit) {
    static void klist_test_node_attached(struct kunit *test)
    {
    let mut a: klist_node = {};
    struct klist mylist;
    klist_init(&mylist, core::ptr::null_mut(), core::ptr::null_mut());
