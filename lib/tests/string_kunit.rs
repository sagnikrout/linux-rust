...
//! Source: lib/tests/string_kunit.c
#![no_std]
...
pub const STRCMP_LARGE_BUF_LEN: c_int = 2048;
pub const STRCMP_CHANGE_POINT: c_int = 1337;

pub const STRING_TEST_MAX_LEN: c_int = 128;
pub const STRING_TEST_MAX_OFFSET: c_int = 16;
pub const STRING_BENCH_SEED: c_int = 888;

#[no_mangle]
unsafe extern "C" fn string_test_memset16(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_memset32(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_memset64(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strlen(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strnlen(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strchr(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strrchr(test: *mut kunit) {
    ...
    s = buf + buf_size - 1 - offset - len;
    s[len] = '\0';
    KUNIT_EXPECT_PTR_EQ(test, strrchr(s, 'Z'), core::ptr::null_mut());
    if (len > 0)
    KUNIT_EXPECT_PTR_EQ(test, strrchr(s, 'A'), s + len - 1);
    else
    KUNIT_EXPECT_PTR_EQ(test, strrchr(s, 'A'), core::ptr::null_mut());
    s[len] = 'A';
    }
    }
    vfree(buf);
...
#[no_mangle]
unsafe extern "C" fn string_test_strnchr(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NULL(test, result);
    result = strnchr(core::ptr::null_mut(), 0, '\0');
    KUNIT_ASSERT_NULL(test, result);
    }
#[no_mangle]
unsafe extern "C" fn string_test_strspn(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn strcmp_fill_buffers(fill1: c_char, fill2: c_char) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strcmp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strcmp_long_strings(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strncmp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strncmp_long_strings(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strcasecmp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strcasecmp_long_strings(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strncasecmp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strncasecmp_long_strings(test: *mut kunit) {
...
//
    ...
    char buf[6];
    int index, i;
    let mut POISON: c_char = 'z';
    KUNIT_ASSERT_TRUE_MSG(test, src != core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn string_test_strscpy(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strcat(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strncat(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strlcat(test: *mut kunit) {
    static void string_test_strlcat(struct kunit *test)
    {
    char dest[8] = "";
    let mut len: c_int = sizeof(dest) + unconst;
// Destination is terminated.
    KUNIT_EXPECT_EQ(test, strlen(dest), 0);
...
#[no_mangle]
unsafe extern "C" fn string_test_strtomem(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_memtostr(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_test_strends(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn fill_random_string(buf: *mut c_char, len: usize) {
