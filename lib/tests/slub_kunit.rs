...
//
    ...
    (flags | SLAB_NO_USER_FLAGS), core::ptr::null_mut());
    s.flags |= SLAB_SKIP_KFENCE;
    return s;
    }
#[no_mangle]
unsafe extern "C" fn test_clobber_zone(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_next_pointer(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_first_word(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_clobber_50th_byte(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_clobber_redzone_free(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_kmalloc_redzone_access(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct test_kfree_rcu_struct {
    union {
    pub rcu: rcu_head,
    pub kvrcu: kvfree_rcu_head,
}

    };
#[no_mangle]
unsafe extern "C" fn test_kfree_rcu(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cache_destroy_work {
    pub work: work_struct,
    pub s: *mut kmem_cache,
}

#[no_mangle]
unsafe extern "C" fn cache_destroy_workfn(w: *mut work_struct) {
...
pub const KMEM_CACHE_DESTROY_NR: c_int = 10;
#[no_mangle]
unsafe extern "C" fn test_kfree_rcu_wq_destroy(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_leak_destroy(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_krealloc_redzone_zeroing(test: *mut kunit) {
...
pub const NR_ITERATIONS: c_int = 1000;
pub const NR_OBJECTS: c_int = 1000;
    static struct test_kfree_rcu_struct *objects[NR_OBJECTS];
#[repr(C)]
#[derive(Copy, Clone)]
pub struct test_nolock_context {
    pub test: *mut kunit,
    pub callback_count: c_int,
    pub alloc_ok: c_int,
...
#[no_mangle]
unsafe extern "C" fn test_kmalloc_and_friends() {
    static void test_kmalloc_and_friends(void)
    {
    int i, j;
    let mut can_use_kfree_rcu: bool = !IS_BUILTIN(CONFIG_SLUB_KUNIT_TEST);
    for (i = 0; i < NR_ITERATIONS; i++) {
    for (j = 0; j < NR_OBJECTS; j++) {
    let mut gfp: gfp_t = (i & 1) ? GFP_KERNEL : GFP_KERNEL_ACCOUNT;
...
#[no_mangle]
unsafe extern "C" fn test_nolock(ctx: *mut test_nolock_context) {
...
#[no_mangle]
unsafe extern "C" fn enable_perf_events(ctx: *mut test_nolock_context) -> bool {
...
#[no_mangle]
unsafe extern "C" fn disable_perf_events(ctx: *mut test_nolock_context) {
...
#[no_mangle]
unsafe extern "C" fn test_kmalloc_nolock_and_friends_perf(test: *mut kunit) {
    static void test_kmalloc_nolock_and_friends_perf(struct kunit *test)
    {
    let mut ctx: test_nolock_context = { .test = test };
...
#[no_mangle]
unsafe extern "C" fn slab_kprobe_pre_handler(p: *mut kprobe, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_slab_kprobes(ctx: *mut test_nolock_context) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unregister_slab_kprobes(ctx: *mut test_nolock_context) {
...
#[no_mangle]
unsafe extern "C" fn test_kmalloc_nolock_and_friends_kprobe(test: *mut kunit) {
...
unsafe extern "C" fn test_init(test: *mut kunit) -> c_int {
    ...
    {
    slab_errors = 0;
    kunit_add_named_resource(test, core::ptr::null_mut(), core::ptr::null_mut(), &resource,
