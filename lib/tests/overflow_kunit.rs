...
//! Source: lib/tests/overflow_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bump_counter() {
    static void bump_counter(void)
    {
    global_counter++;
    }
#[no_mangle]
unsafe extern "C" fn get_index() -> c_int {
    static int get_index(void)
    {
    let mut index: volatile int = 0;
    bump_counter();
    return index;
    }
...
#[no_mangle]
unsafe extern "C" fn shift_sane_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn shift_overflow_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn shift_truncate_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn shift_nonsense_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn overflow_allocation_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn overflow_size_helpers_test(test: *mut kunit) {
...
// Make sure struct_size() can be used in a constant expression.
    ...
    let mut count: c_int = 0;
    int var;
    let mut unconst: volatile int = 0;
...
#[no_mangle]
unsafe extern "C" fn overflows_type_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn same_type_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn castable_to_type_test(test: *mut kunit) {
...
pub struct foo {
    pub a: c_int,
    pub counter: u32,
    pub __counted_by(counter): s16 array[],
}
...
#[no_mangle]
unsafe extern "C" fn DEFINE_FLEX_test(test: *mut kunit) {
...
// Using _RAW_ on a __counted_by struct will initialize "counter" to zero
    ...
    let mut array_size_override: c_int = 0;
