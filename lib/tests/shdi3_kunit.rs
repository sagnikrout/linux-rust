...
//! Source: lib/tests/shdi3_kunit.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct shdi3_test_entry {
    pub input: c_longlong,
    pub shift: c_int,
...
#[no_mangle]
unsafe extern "C" fn shdi3_test_ashldi3(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn shdi3_test_ashrdi3(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn shdi3_test_lshrdi3(test: *mut kunit) {
