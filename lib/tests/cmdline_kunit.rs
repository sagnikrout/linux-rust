...
//! Source: lib/tests/cmdline_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cmdline_do_one_test(test: *mut kunit, in: *const c_char, rc: c_int, offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cmdline_test_noint(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cmdline_test_lead_int(test: *mut kunit) {
    ...
    do {
    const char *str = cmdline_test_strings[i];
    let mut rc: c_int = cmdline_test_values[i];
    int offset;
...
#[no_mangle]
unsafe extern "C" fn cmdline_test_tail_int(test: *mut kunit) {
...
// When "" or "-" the result will be valid integer
    let mut rc: c_int = strcmp(str, "") ? (strcmp(str, "-") ? 0 : 1) : 1;
    int offset;
...
//
    ...
    KUNIT_EXPECT_PTR_EQ_MSG(test, p, core::ptr::null_mut(), "in test %u at %td out of bound", n, p - r);
    }
#[no_mangle]
unsafe extern "C" fn cmdline_test_range(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cmdline_test_next_arg_quoted_value(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cmdline_test_next_arg_bare_quote_regression(test: *mut kunit) {
...
// This hits the i == 0 quoted-token case fixed by 9847f21225c4.
    ...
    KUNIT_EXPECT_PTR_EQ(test, val, core::ptr::null_mut());
    KUNIT_EXPECT_STREQ(test, next, "");
    }
#[no_mangle]
unsafe extern "C" fn cmdline_test_next_arg_mixed_tokens(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmdline_test_memparse_entry {
    pub input: *const c_char,
    pub unrecognized: *const c_char,
    pub result: c_ulonglong,
}
...
#[no_mangle]
unsafe extern "C" fn cmdline_test_memparse(test: *mut kunit) {
