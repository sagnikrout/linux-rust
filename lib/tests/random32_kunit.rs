...
//! Source: lib/tests/random32_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn prandom_state_test_seed(state: *mut rnd_state, seed: u32) {
...
#[no_mangle]
unsafe extern "C" fn test_prandom_seed_boundary(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_prandom_taus113(test: *mut kunit) {
