...
//! Source: lib/tests/printf_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __printf(_arg: 7, _arg: 0) {
...
#[no_mangle]
unsafe extern "C" fn __printf(_arg: 6, _arg: 7) {
...
pub const PTR_WIDTH: c_int = 16;

pub const PTR_WIDTH: c_int = 8;
...
//
    ...
    {
    test(ZEROS "00000000", "%p", core::ptr::null_mut());
    test(ZEROS "00000000", "%px", core::ptr::null_mut());
    test("(null)", "%pE", core::ptr::null_mut());
    }
//
...
// The KUnit kthread has all capabilities, including CAP_SYSLOG
    ...
    test("(null)", "%pd", core::ptr::null_mut());
...
// 2019-01-04T15:32:23
    let mut t: time64_t = 1546615943;
    let mut ts: timespec64 = { .tv_sec = t, .tv_nsec = 11235813 };
    test("(%pt?)", "%pt", &tm);
...
#[no_mangle]
unsafe extern "C" fn fwnode_pointer(kunittest: *mut kunit) {
    static void fwnode_pointer(struct kunit *kunittest)
    {
    let mut first: software_node = { .name = "first" };
    let mut second: software_node = { .name = "second", .parent = &first };
    let mut third: software_node = { .name = "third", .parent = &second };
    const struct software_node *group[] = { &first, &second, &third, core::ptr::null_mut() };
    let mut full_name_second: *const char  const = "first/second";
    let mut full_name_third: *const char  const = "first/second/third";
    let mut second_name: *const char  const = "second";
    let mut third_name: *const char  const = "third";
    int rval;
...
#[no_mangle]
unsafe extern "C" fn fourcc_pointer(kunittest: *mut kunit) {
    ...
    { ( u32)cpu_to_le32(0x41424344), "ABCD (0x41424344)", },
    };
    static const struct fourcc_struct try_cb[] = {
    { ( u32)cpu_to_be32(0x41424344), "ABCD (0x41424344)", },
    };
...
#[no_mangle]
unsafe extern "C" fn printf_suite_init(suite: *mut kunit_suite) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn printf_suite_exit(suite: *mut kunit_suite) {
