...
//! Source: lib/tests/kunit_iov_iter.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pattern(x: c_ulong) -> u8 {
    static inline u8 pattern(unsigned long x)
    {
    return (u8)x + (u8)(x >> 8) + (u8)(x >> 16);
    }
#[no_mangle]
unsafe extern "C" fn iov_kunit_unmap(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_to_kvec(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_from_kvec(test: *mut kunit) -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bvec_test_range {
    pub to: int page, from,,
}
    ...
    {
    struct page *can_merge = core::ptr::null_mut(), *page;
    let mut size: usize = 0;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_to_bvec(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_from_bvec(test: *mut kunit) -> void __init {
...
// Build the expected image in the main buffer.
    ...
    memset(buffer, 0, bufsize);
    for (pr = bvec_test_ranges; pr.from >= 0; pr++) {
    let mut patt: usize = pr.page * PAGE_SIZE;
    for (j = pr.from; j < pr.to; j++) {
...
#[no_mangle]
unsafe extern "C" fn iov_kunit_destroy_folioq(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_to_folioq(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_from_folioq(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iov_kunit_destroy_xarray(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_to_xarray(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_copy_from_xarray(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_extract_pages_kvec(test: *mut kunit) -> void __init {
    ...
    from = pr.from;
    do {
    let mut offset0: usize = LONG_MAX;
    ...
    for (i = 0; i < ARRAY_SIZE(pagelist); i++) {
    struct page *p;
    let mut part: isize = min_t(ssize_t, len, PAGE_SIZE - offset0);
    int ix;
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_extract_pages_bvec(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_extract_pages_folioq(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn iov_kunit_extract_pages_xarray(test: *mut kunit) -> void __init {
...
pub struct iov_kunit_iter_to_sg_data {
    ...
    pub scratch: *mut *mut u8 buffer,,
    pub ubuf: *mut u8 __user,
    pub pages: *mut page,
    pub npages: usize,
}
    ...
    data.sgt.sgl = sg;
    data.buffer = core::ptr::null_mut();
    data.ubuf = core::ptr::null_mut();
    if (user) {
    uaddr = kunit_vm_mmap(test, core::ptr::null_mut(), 0, bufsize,
    ...
    struct iov_kunit_iter_to_sg_data *data)
    {
    let mut tail: static size_t = 16 * PAGE_SIZE;
    size_t i;
...
#[no_mangle]
unsafe extern "C" fn iov_kunit_iter_to_sg_kvec(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iov_kunit_iter_to_sg_bvec(test: *mut kunit) -> void __init {
    static void __init iov_kunit_iter_to_sg_bvec(struct kunit *test)
    {
    struct iov_kunit_iter_to_sg_data data;
    struct page *p, *can_merge = core::ptr::null_mut();
    size_t i, k, bufsize;
    struct bio_vec *bvec;
    struct iov_iter iter;
    bufsize = 0x200000;
...
#[no_mangle]
unsafe extern "C" fn iov_kunit_iter_to_sg_folioq(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iov_kunit_iter_to_sg_xarray(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iov_kunit_iter_to_sg_ubuf(test: *mut kunit) -> void __init {
