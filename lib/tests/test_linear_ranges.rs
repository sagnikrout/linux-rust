...
//! Source: lib/tests/test_linear_ranges.c
#![no_std]
...
//
pub const RANGE1_MIN: c_int = 10;
pub const RANGE1_MIN_SEL: c_int = 2;
pub const RANGE1_STEP: c_int = 10;
// 2, 3, 4, 5, 6
...
pub const RANGE2_MIN: c_int = 100;
pub const RANGE2_MIN_SEL: c_int = 7;
pub const RANGE2_STEP: c_int = 50;
// 7, 8, 9, 10
...
#[no_mangle]
unsafe extern "C" fn range_test_get_value(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn range_test_get_selector_high(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn range_test_get_value_amount(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn range_test_get_selector_low(test: *mut kunit) {
