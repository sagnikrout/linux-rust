...
//
#[no_mangle]
pub unsafe extern "C" fn rcuref_get_slowpath(ref: *mut rcuref_t) -> bool {
    bool rcuref_get_slowpath(rcuref_t *ref)
    {
    let mut cnt: c_uint = atomic_read(&ref.refcnt);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn rcuref_put_slowpath(ref: *mut rcuref_t, cnt: c_uint) -> bool {
