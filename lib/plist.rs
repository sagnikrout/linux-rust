...
#[no_mangle]
unsafe extern "C" fn plist_check_list(top: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn plist_check_head(head: *mut plist_head) {
...
pub unsafe extern "C" fn plist_add(node: *mut plist_node, head: *mut plist_head) {
    ...
    {
    struct plist_node *first, *iter, *prev = core::ptr::null_mut(), *last, *reverse_iter;
...
#[no_mangle]
unsafe extern "C" fn plist_test_check(nr_expect: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn plist_test_requeue(node: *mut plist_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn plist_test() -> int  __init {
    static int  __init plist_test(void)
    {
    let mut nr_expect: c_int = 0, i, loop;
    let mut r: c_uint = local_clock();
