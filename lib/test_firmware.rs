...
pub const TEST_FIRMWARE_NUM_REQS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct test_batched_req {
    pub idx: u8,
    pub rc: c_int,
    pub sent: bool,
    pub fw: *const firmware,
    pub name: *const c_char,
    pub fw_buf: *const c_char,
...
pub struct test_config {
    ...
    pub partial: bool,
    pub sync_direct: bool,
    pub send_uevent: bool,
    pub num_requests: u8,
    pub read_fw_idx: u8,
    pub upload_name: *mut c_char,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct upload_inject_err {
    pub prog: *const c_char,
    pub err_code: enum fw_upload_err,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct test_firmware_upload {
    pub name: *mut c_char,
    pub node: list_head,
    pub buf: *mut c_char,
    pub size: usize,
    pub cancel_request: bool,
    pub inject: upload_inject_err,
...
#[no_mangle]
unsafe extern "C" fn __test_release_all_firmware() {
    ...
    req.fw_buf = core::ptr::null_mut();
    }
    release_firmware(req.fw);
    req.fw = core::ptr::null_mut();
    }
    }
    vfree(test_fw_config.reqs);
    test_fw_config.reqs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn test_release_all_firmware() {
...
#[no_mangle]
unsafe extern "C" fn __test_firmware_config_free() {
    static void __test_firmware_config_free(void)
    {
    __test_release_all_firmware();
    kfree_const(test_fw_config.name);
    test_fw_config.name = core::ptr::null_mut();
    }
//
...
#[no_mangle]
unsafe extern "C" fn __test_firmware_config_init() -> c_int {
    ...
    test_fw_config.reqs = core::ptr::null_mut();
    test_fw_config.upload_name = core::ptr::null_mut();
    return 0;
    out:
...
#[no_mangle]
unsafe extern "C" fn test_dev_config_show_bool(buf: *mut c_char, val: bool) -> isize {
...
#[no_mangle]
unsafe extern "C" fn test_dev_config_show_size_t(buf: *mut c_char, val: usize) -> isize {
    static ssize_t test_dev_config_show_size_t(char *buf, size_t val)
    {
    return snprintf(buf, PAGE_SIZE, "%zu\n", val);
    }
#[no_mangle]
unsafe extern "C" fn test_dev_config_show_int(buf: *mut c_char, val: c_int) -> isize {
    static ssize_t test_dev_config_show_int(char *buf, int val)
    {
    return snprintf(buf, PAGE_SIZE, "%d\n", val);
    }
#[no_mangle]
unsafe extern "C" fn __test_dev_config_update_u8(buf: *const c_char, size: usize, cfg: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_dev_config_update_u8(buf: *const c_char, size: usize, cfg: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_dev_config_show_u8(buf: *mut c_char, val: u8) -> isize {
    ...
    if (test_fw_config.reqs)
    __test_release_all_firmware();
    test_firmware = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn trigger_async_request_cb(fw: *const firmware, context: *mut c_void) {
    ...
    core::ptr::null_mut(), trigger_async_request_cb);
    if (rc) {
...
// Free 'name' ASAP, to test for race conditions
    ...
    dev, GFP_KERNEL, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn test_fw_run_batch_request(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn trigger_batched_cb(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn upload_release(tst: *mut test_firmware_upload) {
...
#[no_mangle]
unsafe extern "C" fn upload_release_all() {
...
//
    ...
    let mut ret: enum fw_upload_err = FW_UPLOAD_ERR_NONE;
...
//
    ...
    tst.inject.prog = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn test_fw_upload_complete(fwl: *mut fw_upload) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn test_fw_upload_cancel(fwl: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn test_fw_cleanup(fwl: *mut fw_upload) {
    ...
    char *buf)
    {
    struct test_firmware_upload *tst = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_firmware_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_firmware_exit() -> void __exit {
