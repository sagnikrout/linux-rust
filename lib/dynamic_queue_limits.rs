...
//! Source: lib/dynamic_queue_limits.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dql_check_stall(dql: *mut dql, stall_thrs: c_ushort) {
...
#[no_mangle]
pub unsafe extern "C" fn dql_completed(dql: *mut dql, count: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn dql_reset(dql: *mut dql) {
...
#[no_mangle]
pub unsafe extern "C" fn dql_init(dql: *mut dql, hold_time: c_uint) {
