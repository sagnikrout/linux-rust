...
pub struct objagg_hints {
    pub node_ht: rhashtable,
    pub ht_params: rhashtable_params,
    pub node_list: list_head,
    pub node_count: c_uint,
    pub root_count: c_uint,
    pub refcount: c_uint,
    pub ops: *const objagg_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct objagg_hints_node {
    pub /: *mut *mut rhash_head ht_node; / member of objagg_hints->node_ht,
    pub /: *mut *mut list_head list; / member of objagg_hints->node_list,
    pub parent: *mut objagg_hints_node,
    pub root_id: c_uint,
...
pub struct objagg {
    pub ops: *const objagg_ops,
    pub priv: *mut c_void,
    pub obj_ht: rhashtable,
    pub ht_params: rhashtable_params,
    pub obj_list: list_head,
    pub obj_count: c_uint,
    pub root_ida: ida,
    pub hints: *mut objagg_hints,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct objagg_obj {
    pub /: *mut *mut rhash_head ht_node; / member of objagg->obj_ht,
    pub /: *mut *mut list_head list; / member of objagg->obj_list,
    pub this: *mut *mut *mut objagg_obj parent; / if the object is nested,,
// holds pointer to parent, otherwise NULL
//
    union {
    pub /: *mut *mut *mut void delta_priv; / user delta private,
    pub /: *mut *mut *mut void root_priv; / user root private,
}
...
#[no_mangle]
unsafe extern "C" fn objagg_obj_ref_inc(objagg_obj: *mut objagg_obj) -> c_uint {
    static unsigned int objagg_obj_ref_inc(struct objagg_obj *objagg_obj)
    {
    return ++objagg_obj.refcount;
    }
#[no_mangle]
unsafe extern "C" fn objagg_obj_ref_dec(objagg_obj: *mut objagg_obj) -> c_uint {
    static unsigned int objagg_obj_ref_dec(struct objagg_obj *objagg_obj)
    {
    return --objagg_obj.refcount;
    }
#[no_mangle]
unsafe extern "C" fn objagg_obj_stats_inc(objagg_obj: *mut objagg_obj) {
...
#[no_mangle]
unsafe extern "C" fn objagg_obj_stats_dec(objagg_obj: *mut objagg_obj) {
...
#[no_mangle]
unsafe extern "C" fn objagg_obj_is_root(objagg_obj: *const objagg_obj) -> bool {
...
// If aggregation is not possible, make the object a root.
    return objagg_obj_root_create(objagg, objagg_obj, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn objagg_obj_put(objagg: *mut objagg, objagg_obj: *mut objagg_obj) {
...
//
#[no_mangle]
pub unsafe extern "C" fn objagg_destroy(objagg: *mut objagg) {
...
#[no_mangle]
unsafe extern "C" fn objagg_stats_info_sort_cmp_func(a: *const c_void, b: *const c_void) -> c_int {
...
//
    ...
    objagg_stats_info_sort_cmp_func, core::ptr::null_mut());
    return objagg_stats;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn objagg_stats_put(objagg_stats: *const objagg_stats) {
    ...
    {
    let mut user_count: c_uint = objagg_obj.stats.user_count;
    struct objagg_hints_node *hnode;
    int err;
...
#[no_mangle]
unsafe extern "C" fn objagg_hints_flush(objagg_hints: *mut objagg_hints) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct objagg_tmp_node {
    pub objagg_obj: *mut objagg_obj,
    pub crossed_out: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct objagg_tmp_graph {
    pub nodes: *mut objagg_tmp_node,
    pub nodes_count: c_ulong,
    pub edges: *mut c_ulong,
}
    ...
    let mut weight: c_uint = node.objagg_obj.stats.user_count;
    int j;
...
#[no_mangle]
unsafe extern "C" fn objagg_tmp_graph_node_max_weight(graph: *mut objagg_tmp_graph) -> c_int {
    static int objagg_tmp_graph_node_max_weight(struct objagg_tmp_graph *graph)
    {
    struct objagg_tmp_node *node;
    let mut max_weight: c_uint = 0;
    unsigned int weight;
    let mut max_index: c_int = -1;
    int i;
    ...
    {
    let mut nodes_count: c_uint = objagg.obj_count;
...
#[no_mangle]
unsafe extern "C" fn objagg_tmp_graph_destroy(graph: *mut objagg_tmp_graph) {
...
//
#[no_mangle]
pub unsafe extern "C" fn objagg_hints_put(objagg_hints: *mut objagg_hints) {
