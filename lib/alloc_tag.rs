...
#[no_mangle]
pub unsafe extern "C" fn alloc_tag_add_early_pfn(pfn: c_ulong, gfp_flags: gfp_t) {
...
unsafe extern "C" fn alloc_tag_init() -> int __init {
    ...
    if (!proc_create_seq_private(ALLOCINFO_FILE_NAME, 0400, core::ptr::null_mut(), &allocinfo_seq_op,
    sizeof(struct allocinfo_private), core::ptr::null_mut())) {
