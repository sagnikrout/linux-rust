...
//! Source: lib/find_bit_benchmark.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn test_find_first_bit(bitmap: *const c_void, len: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_find_next_bit(bitmap: *const c_void, len: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_find_next_zero_bit(bitmap: *const c_void, len: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_find_last_bit(bitmap: *const c_void, len: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_find_nth_bit(bitmap: *const c_ulong, len: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn find_bit_test() -> int __init {
    static int __init find_bit_test(void)
    {
    let mut nbits: c_ulong = BITMAP_LEN / SPARSE;
