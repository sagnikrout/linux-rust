...
pub const MAX_SUBTESTS: c_int = 3;
pub const MAX_TESTRUNS: c_int = 1000;
pub const MAX_DATA: c_int = 128;
pub const MAX_INSNS: c_int = 512;
pub const MAX_K: c_uint = 0xffffFFFF;
// Few constants used to init test 'skb'
pub const SKB_TYPE: c_int = 3;
pub const SKB_MARK: c_uint = 0x1234aaaa;
pub const SKB_HASH: c_uint = 0x1234aaab;
pub const SKB_QUEUE_MAP: c_int = 123;
pub const SKB_VLAN_TCI: c_uint = 0xffff;
pub const SKB_VLAN_PRESENT: c_int = 1;
pub const SKB_DEV_IFINDEX: c_int = 577;
pub const SKB_DEV_TYPE: c_int = 588;
...
pub struct bpf_test {
    ...
    struct {
    pub insns: *mut c_void,
    pub len: c_uint,
    pub ptr: },
    pub u: },
    pub aux: __u8,
    pub data: [__u8; MAX_DATA],
    struct {
    pub data_size: c_int,
    pub result: __u32,
    pub test: [}; MAX_SUBTESTS],
    pub self): *mut *mut int (fill_helper)(struct bpf_test,
    pub /: *mut *mut int expected_errcode; / used when FLAG_EXPECTED_FAIL is set in the aux,
    pub frag_data: [__u8; MAX_DATA],
    pub /: *mut *mut int stack_depth; / for eBPF only, since tests don't call verifier,
    pub /: *mut *mut int nr_testruns; / Custom run count, defaults to MAX_TESTRUNS if 0,
}

// Large test cases need separate allocation and fill handler.
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns1(self: *mut bpf_test) -> c_int {
    static int bpf_fill_maxinsns1(struct bpf_test *self)
    {
    let mut len: c_uint = BPF_MAXINSNS;
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns2(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns3(self: *mut bpf_test) -> c_int {
    ...
    for (i = 0; i < len - 1; i++) {
    let mut k: __u32 = prandom_u32_state(&rnd);
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns4(self: *mut bpf_test) -> c_int {
    static int bpf_fill_maxinsns4(struct bpf_test *self)
    {
    let mut len: c_uint = BPF_MAXINSNS + 1;
    struct sock_filter *insn;
    int i;
    insn = kmalloc_objs(*insn, len);
    if (!insn)
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns5(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns6(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns7(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns8(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns9(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns10(self: *mut bpf_test) -> c_int {
    static int bpf_fill_maxinsns10(struct bpf_test *self)
    {
    let mut len: c_uint = BPF_MAXINSNS, hlen = len - 2;
    struct bpf_insn *insn;
    int i;
    insn = kmalloc_objs(*insn, len);
    if (!insn)
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns11(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns12(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_maxinsns13(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_ja(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_ld_abs_get_processor_id(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_stxdw(self: *mut bpf_test, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_stxw(self: *mut bpf_test) -> c_int {
    static int bpf_fill_stxw(struct bpf_test *self)
    {
    return __bpf_fill_stxdw(self, BPF_W);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_stxdw(self: *mut bpf_test) -> c_int {
    static int bpf_fill_stxdw(struct bpf_test *self)
    {
    return __bpf_fill_stxdw(self, BPF_DW);
    }
#[no_mangle]
unsafe extern "C" fn __bpf_ld_imm64(insns[2]: bpf_insn, reg: u8, imm64: i64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __bpf_fill_max_jmp(self: *mut bpf_test, jmp: c_int, imm: c_int, alu32: bool) -> c_int {
    static int __bpf_fill_max_jmp(struct bpf_test *self, int jmp, int imm, bool alu32)
    {
    struct bpf_insn *insns;
    let mut len: c_int = S16_MAX + 5;
    int i;
    ...
    let mut op: c_int = ops[(i >> 1) % ARRAY_SIZE(ops)];
    if ((i & 1) || alu32)
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_taken_32(self: *mut bpf_test) -> c_int {
    static int bpf_fill_max_jmp_taken_32(struct bpf_test *self)
    {
    return __bpf_fill_max_jmp(self, BPF_JEQ, 1, true);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_taken(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_not_taken_32(self: *mut bpf_test) -> c_int {
    static int bpf_fill_max_jmp_not_taken_32(struct bpf_test *self)
    {
    return __bpf_fill_max_jmp(self, BPF_JEQ, 0, true);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_not_taken(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_always_taken_32(self: *mut bpf_test) -> c_int {
    static int bpf_fill_max_jmp_always_taken_32(struct bpf_test *self)
    {
    return __bpf_fill_max_jmp(self, BPF_JGE, 0, true);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_always_taken(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_never_taken_32(self: *mut bpf_test) -> c_int {
    static int bpf_fill_max_jmp_never_taken_32(struct bpf_test *self)
    {
    return __bpf_fill_max_jmp(self, BPF_JLT, 0, true);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_max_jmp_never_taken(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_alu_result(res: *mut u64, v1: u64, v2: u64, op: u8, flags: u32) -> bool {
    static bool __bpf_alu_result(u64 *res, u64 v1, u64 v2, u8 op, u32 flags)
    {
    let mut is_signed: bool = flags & F_SIGNED;
...
// Test an ALU shift operation for all valid shift values
    ...
    let mut bits: c_int = (flags & F_ALU32) ? 32 : 64;
    let mut len: c_int = (2 + 7 * bits) * ARRAY_SIZE(regs) + 3;
    struct bpf_insn *insn;
    int imm, k;
    let mut i: c_int = 0;
    insn = kmalloc_objs(*insn, len);
...
//
#[no_mangle]
pub unsafe extern "C" fn value(msb: c_int, delta: c_int, sign: c_int) -> i64 {
...
// Compute the maximum number of insns and allocate the buffer
    len = extra + count * (*emit)(self, arg, core::ptr::null_mut(), 0, 0);
...
// 3     (1 << MSB) + [-1, 0, 1]
//
pub const PATTERN_BLOCK1: c_int = 1;
pub const PATTERN_BLOCK2: c_int = 5;
// Number of test runs for a pattern test
pub const NR_PATTERN_RUNS: c_int = 1;
//
...
//
    ...
    {
    int *a = arg;
    let mut op: c_int = a[0];
    let mut flags: u32 = a[1];
    let mut off: i16 = (flags & F_SIGNED) ? 1 : 0;
    let mut i: c_int = 0;
    u64 res;
    if (!insns)
    return 7;
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_alu64_imm(self: *mut bpf_test, op: c_int, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_alu32_imm(self: *mut bpf_test, op: c_int, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_alu64_reg(self: *mut bpf_test, op: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_alu32_reg(self: *mut bpf_test, op: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu64_sdiv_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_alu64_sdiv_imm(struct bpf_test *self)
    {
    return __bpf_fill_alu64_imm(self, BPF_DIV, F_SIGNED);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu64_smod_imm(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu32_sdiv_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_alu32_sdiv_imm(struct bpf_test *self)
    {
    return __bpf_fill_alu32_imm(self, BPF_DIV, F_SIGNED);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu32_smod_imm(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu64_sdiv_imm_regs(self: *mut bpf_test) -> c_int {
    static int bpf_fill_alu64_sdiv_imm_regs(struct bpf_test *self)
    {
    return __bpf_fill_alu_imm_regs(self, BPF_DIV, F_SIGNED);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu64_smod_imm_regs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu32_sdiv_imm_regs(self: *mut bpf_test) -> c_int {
    static int bpf_fill_alu32_sdiv_imm_regs(struct bpf_test *self)
    {
    return __bpf_fill_alu_imm_regs(self, BPF_DIV, F_ALU32 | F_SIGNED);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_alu32_smod_imm_regs(self: *mut bpf_test) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __bpf_fill_alu_reg_pairs(self: *mut bpf_test, op: u8, alu32: bool) -> c_int {
    static int __bpf_fill_alu_reg_pairs(struct bpf_test *self, u8 op, bool alu32)
    {
    let mut len: c_int = 2 + 10 * 10 * 12;
...
// Check all combinations of operand registers
    for (rd = R0; rd <= R9; rd++) {
    for (rs = R0; rs <= R9; rs++) {
    let mut val: u64 = rd == rs ? same : res;
    i += __bpf_ld_imm64(&insns[i], rd, dst);
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_atomic64(self: *mut bpf_test, op: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_atomic32(self: *mut bpf_test, op: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __bpf_fill_atomic_reg_pairs(self: *mut bpf_test, width: u8, op: u8) -> c_int {
    static int __bpf_fill_atomic_reg_pairs(struct bpf_test *self, u8 width, u8 op)
    {
    struct bpf_insn *insn;
    let mut len: c_int = 2 + 34 * 10 * 10;
    u64 mem, upd, res;
    int rd, rs, i = 0;
    insn = kmalloc_objs(*insn, len);
    if (!insn)
...
#[no_mangle]
pub unsafe extern "C" fn if(rs: R0 == rd || R0 ==) -> else {
    else if (R0 == rd || R0 == rs)
...
#[no_mangle]
pub unsafe extern "C" fn if(BPF_CMPXCHG: op ==) -> else {
    else if (op == BPF_CMPXCHG)
    src = upd; /* Expect value to be preserved */
#[no_mangle]
pub unsafe extern "C" fn if(BPF_FETCH: op &) -> else {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic64_and_fetch_reg_pairs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic64_or_fetch_reg_pairs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic64_xor_fetch_reg_pairs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic64_xchg_reg_pairs(self: *mut bpf_test) -> c_int {
    static int bpf_fill_atomic64_xchg_reg_pairs(struct bpf_test *self)
    {
    return __bpf_fill_atomic_reg_pairs(self, BPF_DW, BPF_XCHG);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic64_cmpxchg_reg_pairs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic32_and_fetch_reg_pairs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic32_or_fetch_reg_pairs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic32_xor_fetch_reg_pairs(self: *mut bpf_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic32_xchg_reg_pairs(self: *mut bpf_test) -> c_int {
    static int bpf_fill_atomic32_xchg_reg_pairs(struct bpf_test *self)
    {
    return __bpf_fill_atomic_reg_pairs(self, BPF_W, BPF_XCHG);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_atomic32_cmpxchg_reg_pairs(self: *mut bpf_test) -> c_int {
...
unsafe extern "C" fn bpf_fill_ld_imm64_magn(self: *mut bpf_test) -> c_int {
    ...
    let mut imm: i64 = sign * ((1LL << bit) + adj);
// Perform operation
...
//
#[no_mangle]
unsafe extern "C" fn __bpf_match_jmp_cond(v1: i64, v2: i64, op: u8) -> bool {
    ...
    let mut op: c_int = *(int *)arg;
    if (insns) {
    let mut match: bool = __bpf_match_jmp_cond(dst, (s32)imm, op);
    let mut i: c_int = 0;
    ...
    let mut op: c_int = *(int *)arg;
    if (insns) {
    let mut match: bool = __bpf_match_jmp_cond((s32)dst, (s32)imm, op);
    let mut i: c_int = 0;
    i += __bpf_ld_imm64(&insns[i], R1, dst);
    ...
    let mut op: c_int = *(int *)arg;
    if (insns) {
    let mut match: bool = __bpf_match_jmp_cond(dst, src, op);
    let mut i: c_int = 0;
    i += __bpf_ld_imm64(&insns[i], R1, dst);
    i += __bpf_ld_imm64(&insns[i], R2, src);
    ...
    let mut op: c_int = *(int *)arg;
    if (insns) {
    let mut match: bool = __bpf_match_jmp_cond((s32)dst, (s32)src, op);
    let mut i: c_int = 0;
    i += __bpf_ld_imm64(&insns[i], R1, dst);
    i += __bpf_ld_imm64(&insns[i], R2, src);
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_jmp_imm(self: *mut bpf_test, op: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_jmp32_imm(self: *mut bpf_test, op: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_jmp_reg(self: *mut bpf_test, op: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bpf_fill_jmp32_reg(self: *mut bpf_test, op: c_int) -> c_int {
...
pub const NR_STAGGERED_JMP_RUNS: c_int = 10;
    static int __bpf_fill_staggered_jumps(struct bpf_test *self,
    const struct bpf_insn *jmp,
    u64 r1, u64 r2)
    {
    let mut size: c_int = self.test[0].result - 1;
    let mut len: c_int = 4 + 3 * (size + 1);
    struct bpf_insn *insns;
    int off, ind;
    insns = kmalloc_objs(*insns, len);
    if (!insns)
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_ja(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_ja(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JA, 0, 0, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0, 0);
    }
// 64-bit immediate jumps
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jeq_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jeq_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JEQ, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jne_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jne_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JNE, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 4321, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jset_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jset_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JSET, R1, 0x82, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x86, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jgt_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jgt_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JGT, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x80000000, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jge_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jge_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JGE, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jlt_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jlt_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JLT, R1, 0x80000000, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jle_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jle_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JLE, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsgt_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsgt_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JSGT, R1, -2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsge_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsge_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JSGE, R1, -2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jslt_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jslt_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JSLT, R1, -1, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsle_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsle_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_IMM(BPF_JSLE, R1, -1, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, 0);
    }
// 64-bit register jumps
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jeq_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jeq_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JEQ, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jne_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jne_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JNE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 4321, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jset_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jset_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JSET, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x86, 0x82);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jgt_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jgt_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JGT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x80000000, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jge_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jge_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JGE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jlt_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jlt_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JLT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0x80000000);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jle_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jle_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JLE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsgt_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsgt_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JSGT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, -2);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsge_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsge_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JSGE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, -2);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jslt_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jslt_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JSLT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, -1);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsle_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsle_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP_REG(BPF_JSLE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, -1);
    }
// 32-bit immediate jumps
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jeq32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jeq32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JEQ, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jne32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jne32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JNE, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 4321, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jset32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jset32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JSET, R1, 0x82, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x86, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jgt32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jgt32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JGT, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x80000000, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jge32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jge32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JGE, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jlt32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jlt32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JLT, R1, 0x80000000, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jle32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jle32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JLE, R1, 1234, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsgt32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsgt32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JSGT, R1, -2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsge32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsge32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JSGE, R1, -2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jslt32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jslt32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JSLT, R1, -1, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, 0);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsle32_imm(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsle32_imm(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_IMM(BPF_JSLE, R1, -1, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, 0);
    }
// 32-bit register jumps
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jeq32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jeq32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JEQ, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jne32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jne32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JNE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 4321, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jset32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jset32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JSET, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x86, 0x82);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jgt32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jgt32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JGT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 0x80000000, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jge32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jge32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JGE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jlt32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jlt32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JLT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 0x80000000);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jle32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jle32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JLE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, 1234, 1234);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsgt32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsgt32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JSGT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, -2);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsge32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsge32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JSGE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, -2);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jslt32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jslt32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JSLT, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -2, -1);
    }
#[no_mangle]
unsafe extern "C" fn bpf_fill_staggered_jsle32_reg(self: *mut bpf_test) -> c_int {
    static int bpf_fill_staggered_jsle32_reg(struct bpf_test *self)
    {
    let mut jmp: bpf_insn = BPF_JMP32_REG(BPF_JSLE, R1, R2, 0);
    return __bpf_fill_staggered_jumps(self, &jmp, -1, -1);
    }
...
#[no_mangle]
unsafe extern "C" fn release_test_data(test: *const bpf_test, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn filter_length(which: c_int) -> c_int {
    ...
    {
    let mut test_type: __u8 = tests[which].aux & TEST_TYPE_MASK;
    let mut flen: c_uint = filter_length(which);
...
#[no_mangle]
unsafe extern "C" fn release_filter(fp: *mut bpf_prog, which: c_int) {
...
#[no_mangle]
unsafe extern "C" fn run_one(fp: *const bpf_prog, test: *mut bpf_test) -> c_int {
    static int run_one(const struct bpf_prog *fp, struct bpf_test *test)
    {
    let mut err_cnt: c_int = 0, i, runs = MAX_TESTRUNS;
    if (test.nr_testruns)
...
//
    ...
    let mut res: i32 = test.test[i].result;
    pr_cont("ret %d != %d (%#x != %#x)",
    ret, res, ret, res);
    err_cnt++;
    }
    ...
    let mut test_id: static int = -1;
    module_param(test_id, int, 0);
    static int test_range[2] = { 0, INT_MAX };
    module_param_array(test_range, int, core::ptr::null_mut(), 0);
#[no_mangle]
unsafe extern "C" fn exclude_test(test_id: c_int) -> bool {
    ...
    {
    let mut headroom: u32 = NET_SKB_PAD + NET_IP_ALIGN + ETH_HLEN;
...
// adjust skb[0]'s len
    ...
    {
    let mut alloc_size: c_uint = 2000;
    let mut headroom: c_uint = 102, doffset = 72, data_size = 1308;
    struct sk_buff *skb[2];
    int i;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct skb_segment_test {
    pub descr: *const c_char,
    pub (*build_skb)(void): *mut sk_buff,
...
#[no_mangle]
unsafe extern "C" fn test_skb_segment_single(test: *const skb_segment_test) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn test_skb_segment() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn test_bpf() -> __init int {
    static __init int test_bpf(void)
    {
    int i, err_cnt = 0, pass_cnt = 0;
    let mut jit_cnt: c_int = 0, run_cnt = 0;
    ...
    tests[i].u.ptr.insns = core::ptr::null_mut();
    }
    if (fp == core::ptr::null_mut()) {
    if (err == 0) {
    pass_cnt++;
...
//
pub const TAIL_CALL_MARKER: c_uint = 0x7a11ca11;
// Special offset to indicate a NULL call target
pub const TAIL_CALL_NULL: c_uint = 0x7fff;
// Special offset to indicate an out-of-range index
pub const TAIL_CALL_INVALID: c_uint = 0x7ffe;
...
//
    ...
    {
    "Tail call error path, core::ptr::null_mut() target",
    .insns = {
    BPF_LDX_MEM(BPF_W, R2, R1, 0),
    BPF_ALU64_IMM(BPF_ADD, R2, 1),
    BPF_STX_MEM(BPF_W, R1, R2, 0),
...
#[no_mangle]
unsafe extern "C" fn destroy_tail_call_tests(progs: *mut bpf_array) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn prepare_tail_call_tests(pprogs: *mut bpf_array) -> __init int {
    static __init int prepare_tail_call_tests(struct bpf_array **pprogs)
    {
    let mut ntests: c_int = ARRAY_SIZE(tail_call_tests);
...
// Relocate runtime tail call offsets and addresses
    ...
    insn.imm = ntests;
#[no_mangle]
pub unsafe extern "C" fn if(TAIL_CALL_INVALID: insn->off ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn test_tail_calls(progs: *mut bpf_array) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn find_test_index(test_name: *const c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn prepare_test_range() -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(test_suite, _arg: "test_tail_calls")) -> else {
    else if (!strcmp(test_suite, "test_tail_calls"))
    valid_range = ARRAY_SIZE(tail_call_tests);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(test_suite, _arg: "test_skb_segment")) -> else {
...
//
    let mut idx: c_int = find_test_index(test_name);
    if (idx < 0) {
...
#[no_mangle]
unsafe extern "C" fn test_bpf_init() -> int __init {
    static int __init test_bpf_init(void)
    {
    struct bpf_array *progs = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn test_bpf_exit() -> void __exit {
