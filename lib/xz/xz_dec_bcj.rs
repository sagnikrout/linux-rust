...
//
#[no_mangle]
pub unsafe extern "C" fn bcj_x86_test_msbyte(b: u8) -> c_int {
    static inline int bcj_x86_test_msbyte(uint8_t b)
    {
    let mut b: return = = 0x00 || b == 0xFF;
    }
#[no_mangle]
unsafe extern "C" fn bcj_x86(s: *mut xz_dec_bcj, buf: *mut u8, size: usize) -> usize {
    ...
    size_t i;
    let mut prev_pos: usize = (size_t)-1;
    let mut prev_mask: u32 = s.x86_prev_mask;
    uint32_t src;
    uint32_t dest;
    uint32_t j;
    uint8_t b;
...
#[no_mangle]
unsafe extern "C" fn bcj_powerpc(s: *mut xz_dec_bcj, buf: *mut u8, size: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bcj_arm(s: *mut xz_dec_bcj, buf: *mut u8, size: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bcj_armthumb(s: *mut xz_dec_bcj, buf: *mut u8, size: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bcj_sparc(s: *mut xz_dec_bcj, buf: *mut u8, size: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bcj_arm64(s: *mut xz_dec_bcj, buf: *mut u8, size: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bcj_riscv(s: *mut xz_dec_bcj, buf: *mut u8, size: usize) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn bcj_flush(s: *mut xz_dec_bcj, b: *mut xz_buf) {
...
#[no_mangle]
pub unsafe extern "C" fn xz_dec_bcj_reset(s: *mut xz_dec_bcj, id: u8) -> enum xz_ret {
