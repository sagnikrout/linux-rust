...
//
    static uint32_t crc;
#[no_mangle]
unsafe extern "C" fn xz_dec_test_open(i: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xz_dec_test_release(i: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xz_dec_test_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xz_dec_test_exit() -> void __exit {
