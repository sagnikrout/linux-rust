...
//
#[no_mangle]
pub unsafe extern "C" fn sg_nents(sg: *mut scatterlist) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_nents_for_len(sg: *mut scatterlist, len: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_nents_for_dma(sgl: *mut scatterlist, sglen: c_uint, len: usize) -> c_int {
...
//
    ...
    {
    struct scatterlist *sg, *ret = core::ptr::null_mut();
    unsigned int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_init_one(sg: *mut scatterlist, buf: *const c_void, buflen: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sg_kfree(sg: *mut scatterlist, nents: c_uint) {
...
//
    ...
    let mut curr_max_ents: unsigned = nents_first_chunk ?: max_ents;
    if (unlikely(!table.sgl))
    return;
    sgl = table.sgl;
    while (num_ents) {
    let mut alloc_size: c_uint = num_ents;
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_alloc_table(table: *mut sg_table, nents: c_uint, gfp_mask: gfp_t) -> c_int {
    int sg_alloc_table(struct sg_table *table, unsigned int nents, gfp_t gfp_mask)
    {
    int ret;
    ret = __sg_alloc_table(table, nents, SG_MAX_SINGLE_ALLOC,
    core::ptr::null_mut(), 0, gfp_mask, sg_kmalloc);
    if (unlikely(ret))
    sg_free_table(table);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn pages_are_mergeable(a: *mut page, b: *mut page) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn sgl_free_n_order(sgl: *mut scatterlist, nents: c_int, order: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sgl_free_order(sgl: *mut scatterlist, order: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sg_page_count(sg: *mut scatterlist) -> c_int {
    static int sg_page_count(struct scatterlist *sg)
    {
    return PAGE_ALIGN(sg.offset + sg.length) >> PAGE_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn __sg_page_iter_next(piter: *mut sg_page_iter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sg_dma_page_count(sg: *mut scatterlist) -> c_int {
    static int sg_dma_page_count(struct scatterlist *sg)
    {
    return PAGE_ALIGN(sg.offset + sg_dma_len(sg)) >> PAGE_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn __sg_page_iter_dma_next(dma_iter: *mut sg_dma_page_iter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sg_miter_get_next_page(miter: *mut sg_mapping_iter) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_miter_skip(miter: *mut sg_mapping_iter, offset: off_t) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_miter_next(miter: *mut sg_mapping_iter) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(SG_MITER_LOCAL: miter->__flags &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_miter_stop(miter: *mut sg_mapping_iter) {
...
// drop resources from the last iteration
    ...
    kunmap(miter.page);
    miter.page = core::ptr::null_mut();
    miter.addr = core::ptr::null_mut();
    miter.length = 0;
    miter.consumed = 0;
    }
    }
...
//
    ...
    let mut sg_flags: c_uint = SG_MITER_LOCAL;
    if (to_buffer)
...
//
    ...
    let mut offset: c_uint = 0;
    struct sg_mapping_iter miter;
    let mut sg_flags: c_uint = SG_MITER_LOCAL | SG_MITER_TO_SG;
    sg_miter_start(&miter, sgl, nents, sg_flags);
    if (!sg_miter_skip(&miter, skip))
    return false;
    while (offset < buflen && sg_miter_next(&miter)) {
...
// We decant the page list into the tail of the scatterlist
    ...
    let mut seg: usize = min_t(size_t, PAGE_SIZE - off, len);
// pages++ = NULL;
...
//
    ...
    if (offset < fsize) {
    let mut part: usize = umin(maxsize - ret, fsize - offset);
...
//
    ...
    struct folio *folio;
    let mut start: loff_t = iter.xarray_start + iter.iov_offset;
    let mut index: pgoff_t = start / PAGE_SIZE;
    let mut ret: isize = 0;
    size_t offset, len;
