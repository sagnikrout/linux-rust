...
//
#[no_mangle]
pub unsafe extern "C" fn rb_set_black(rb: *mut rb_node) {
...
//
    ...
    void (*augment_rotate)(struct rb_node *old, struct rb_node *new))
    {
    struct rb_node *node = core::ptr::null_mut(), *sibling, *tmp1, *tmp2;
    while (true) {
//
// Loop invariants:
...
#[no_mangle]
pub unsafe extern "C" fn rb_erase_linked(node: *mut rb_node_linked, root: *mut rb_root_linked) -> bool {
