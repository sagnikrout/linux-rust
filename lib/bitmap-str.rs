...
#[no_mangle]
unsafe extern "C" fn bitmap_set_region(r: *const region, bitmap: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn bitmap_check_region(r: *const region) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn end_of_str(c: c_char) -> bool {
    static inline bool end_of_str(char c)
    {
    let mut c: return = = '\0' || c == '\n';
    }
#[no_mangle]
pub unsafe extern "C" fn __end_of_region(c: c_char) -> bool {
    static inline bool __end_of_region(char c)
    {
    return isspace(c) || c == ',';
    }
#[no_mangle]
pub unsafe extern "C" fn end_of_region(c: c_char) -> bool {
...
//
    ...
    str++;
    return end_of_str(*str) ? core::ptr::null_mut() : str;
    }
    ...
    {
    let mut lastbit: c_uint = r.nbits - 1;
...
//
    ...
    let mut chunks: c_int = BITS_TO_U32(nmaskbits);
