...
pub const MTREE_ALLOC_MAX: c_uint = 0x2000000000000Ul;
// Macro flag: #define CONFIG_MAPLE_SEARCH
...
#[no_mangle]
unsafe extern "C" fn mtree_erase_index(mt: *mut maple_tree, index: c_ulong) -> void __init {
    ...
    {
    let mut result: c_ulong = expected + 1;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn not_empty(node: *mut maple_node) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn check_lb_not_empty(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init check_lb_not_empty(struct maple_tree *mt)
    {
    unsigned long i, j;
    let mut huge: c_ulong = 4000UL * 1000 * 1000;
    i = huge;
    while (i > 4096) {
...
#[no_mangle]
unsafe extern "C" fn check_lower_bound_split(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_upper_bound_split(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_mid_split(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init check_mid_split(struct maple_tree *mt)
    {
    let mut huge: c_ulong = 8000UL * 1000 * 1000;
    check_insert(mt, huge, (void *) huge);
    check_insert(mt, 0, xa_mk_value(0));
    check_lb_not_empty(mt);
    }
#[no_mangle]
unsafe extern "C" fn check_rev_find(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_find(mt: *mut maple_tree) -> noinline void __init {
    ...
    unsigned long max;
    unsigned long top;
    let mut last: c_ulong = 0, index = 0;
    void *entry, *entry2;
    MA_STATE(mas, mt, 0, 0);
// Insert 0.
...
// Insert ULONG_MAX
    ...
    MT_BUG_ON(mt, entry != XA_ZERO_ENTRY);
#[no_mangle]
pub unsafe extern "C" fn if(top: val ==) -> else {
    else if (val == top)
    MT_BUG_ON(mt, entry != xa_mk_value(LONG_MAX));
    else
    MT_BUG_ON(mt, xa_mk_value(val) != entry);
...
#[no_mangle]
unsafe extern "C" fn check_find_2(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_alloc_rev_range(mt: *mut maple_tree) -> noinline void __init {
...
// Single space test.
    ...
    let mut req_range_count: c_int = ARRAY_SIZE(req_range);
    let mut min: c_ulong = 0;
    MA_STATE(mas, mt, 0, 0);
    mtree_store_range(mt, MTREE_ALLOC_MAX, ULONG_MAX, XA_ZERO_ENTRY,
    GFP_KERNEL);
pub const DEBUG_REV_RANGE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn check_alloc_range(mt: *mut maple_tree) -> noinline void __init {
...
// Test a single entry
    ...
    int i, range_count = ARRAY_SIZE(range);
    let mut req_range_count: c_int = ARRAY_SIZE(req_range);
    let mut min: c_ulong = 0x565234af2000;
    MA_STATE(mas, mt, 0, 0);
    mtree_store_range(mt, MTREE_ALLOC_MAX, ULONG_MAX, XA_ZERO_ENTRY,
    GFP_KERNEL);
    for (i = 0; i < range_count; i += 2) {
pub const DEBUG_ALLOC_RANGE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn check_ranges(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_next_entry(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init check_next_entry(struct maple_tree *mt)
    {
    void *entry = core::ptr::null_mut();
    let mut limit: c_ulong = 30, i = 0;
    MA_STATE(mas, mt, i, i);
    MT_BUG_ON(mt, !mtree_empty(mt));
...
#[no_mangle]
unsafe extern "C" fn check_prev_entry(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init check_prev_entry(struct maple_tree *mt)
    {
    let mut index: c_ulong = 16;
    void *value;
    int i;
...
#[no_mangle]
unsafe extern "C" fn check_store_null(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_root_expand(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_deficient_node(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_gap_combining(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init check_gap_combining(struct maple_tree *mt)
    {
    struct maple_enode *mn1, *mn2;
    void *entry;
    let mut singletons: c_ulong = 100;
...
#[no_mangle]
unsafe extern "C" fn check_node_overwrite(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn bench_slot_store(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn bench_node_store(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn bench_awalk(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn bench_walk(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn bench_load(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn bench_mt_for_each(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init bench_mt_for_each(struct maple_tree *mt)
    {
    int i, count = 1000000;
    let mut max: c_ulong = 2500, index = 0;
    void *entry;
    for (i = 0; i < max; i += 5)
...
#[no_mangle]
unsafe extern "C" fn bench_mas_for_each(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init bench_mas_for_each(struct maple_tree *mt)
    {
    int i, count = 1000000;
    let mut max: c_ulong = 2500;
    void *entry;
    MA_STATE(mas, mt, 0, 0);
    for (i = 0; i < max; i += 5) {
    let mut gap: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn bench_mas_prev(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_forking() -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_iteration(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_mas_store_gfp(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn bench_forking() -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn next_prev_test(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_spanning_relatives(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_fuzzer(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_bnode_min_spanning(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_empty_area_window(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn check_empty_area_fill(mt: *mut maple_tree) -> noinline void __init {
    static noinline void __init check_empty_area_fill(struct maple_tree *mt)
    {
    let mut max: c_ulong = 0x25D78000;
    unsigned long size;
    int loop, shift;
    MA_STATE(mas, mt, 0, 0);
    mt_set_non_kernel(99999);
...
//
#[no_mangle]
unsafe extern "C" fn check_state_handling(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn alloc_cyclic_testing(mt: *mut maple_tree) -> noinline void __init {
...
#[no_mangle]
unsafe extern "C" fn maple_tree_seed() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn maple_tree_harvest() -> void __exit {
