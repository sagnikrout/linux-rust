...
//! Source: lib/kunit/kunit-example-test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn example_simple_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_test_init(test: *mut kunit) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn example_test_exit(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_test_init_suite(suite: *mut kunit_suite) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn example_test_exit_suite(suite: *mut kunit_suite) {
...
//
#[no_mangle]
unsafe extern "C" fn example_skip_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_mark_skipped_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_all_expect_macros_test(test: *mut kunit) {
...
// Pointer assertions
    ...
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_PTR_NE(test, test, core::ptr::null_mut());
    KUNIT_EXPECT_NULL(test, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn add_one(i: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subtract_one(i: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn example_static_stub_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_static_stub_using_fn_ptr_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn example_param_get_desc(p: *const example_param, desc: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn example_params_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_priv_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_slow_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_resource_init(res: *mut kunit_resource, context: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn example_resource_free(res: *mut kunit_resource) {
...
//
#[no_mangle]
unsafe extern "C" fn example_param_array_get_desc(test: *mut kunit, p: *const c_void, desc: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn example_param_init(test: *mut kunit) -> c_int {
    static int example_param_init(struct kunit *test)
    {
    int ctx = 3; /* Data to be stored. */
    let mut arr_size: usize = ARRAY_SIZE(example_params_array);
//
...
//
#[no_mangle]
unsafe extern "C" fn example_params_test_with_init(test: *mut kunit) {
...
// parameterized test context.
//
    res = kunit_find_resource(test.parent, example_resource_alloc_match, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn example_param_dynamic_arr_get_desc(test: *mut kunit, p: *const c_void, desc: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn example_param_init_dynamic_arr(test: *mut kunit) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn example_param_exit_dynamic_arr(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn example_params_test_with_init_dynamic_arr(test: *mut kunit) {
...
//
    ...
    example_param_init, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn init_add(x: c_int, y: c_int) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn example_init_test(test: *mut kunit) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn example_skip_suite_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn example_skip_suite_init(suite: *mut kunit_suite) -> c_int {
