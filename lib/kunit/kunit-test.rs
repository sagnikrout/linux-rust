...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kunit_try_catch_test_context {
    pub try_catch: *mut kunit_try_catch,
    pub function_called: bool,
}

#[no_mangle]
unsafe extern "C" fn kunit_test_successful_try(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_no_catch(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_try_catch_successful_try_no_catch(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_unsuccessful_try(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_catch(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_try_catch_unsuccessful_try_does_catch(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_try_catch_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_null_dereference(data: *mut c_void) {
    static void kunit_test_null_dereference(void *data)
    {
    struct kunit *test = data;
    int *null = core::ptr::null_mut();
// null = 0;
    KUNIT_FAIL(test, "This line should never be reached\n");
    }
#[no_mangle]
unsafe extern "C" fn kunit_test_fault_null_dereference(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kunit_test_resource_context {
    pub test: kunit,
    pub is_resource_initialized: bool,
    pub allocate_order: [c_int; 2],
    pub free_order: [c_int; 4],
}

#[no_mangle]
unsafe extern "C" fn fake_resource_init(res: *mut kunit_resource, context: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fake_resource_free(res: *mut kunit_resource) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_init_resources(test: *mut kunit) {
    static void kunit_resource_test_init_resources(struct kunit *test)
    {
    struct kunit_test_resource_context *ctx = test.priv;
    kunit_init_test(&ctx.test, "testing_test_init_test", core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, list_empty(&ctx.test.resources));
    }
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_alloc_resource(test: *mut kunit) {
    static void kunit_resource_test_alloc_resource(struct kunit *test)
    {
    struct kunit_test_resource_context *ctx = test.priv;
    struct kunit_resource *res;
    let mut free: kunit_resource_free_t = fake_resource_free;
...
//
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_destroy_resource(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_remove_resource(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_cleanup_resources(test: *mut kunit) {
    ...
    key)
#[no_mangle]
unsafe extern "C" fn fake_resource_2_init(res: *mut kunit_resource, context: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fake_resource_2_free(res: *mut kunit_resource) {
...
#[no_mangle]
unsafe extern "C" fn fake_resource_1_init(res: *mut kunit_resource, context: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fake_resource_1_free(res: *mut kunit_resource) {
...
//
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_proper_free_ordering(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_static(test: *mut kunit) {
    static void kunit_resource_test_static(struct kunit *test)
    {
    struct kunit_test_resource_context ctx;
    struct kunit_resource res;
    KUNIT_EXPECT_EQ(test, kunit_add_resource(test, core::ptr::null_mut(), core::ptr::null_mut(), &res, &ctx),
    0);
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_named(test: *mut kunit) {
    static void kunit_resource_test_named(struct kunit *test)
    {
    struct kunit_resource res1, res2, *found = core::ptr::null_mut();
    struct kunit_test_resource_context ctx;
    KUNIT_EXPECT_EQ(test,
    kunit_add_named_resource(test, core::ptr::null_mut(), core::ptr::null_mut(), &res1,
    "resource_1", &ctx),
    0);
    ...
    -EEXIST);
    KUNIT_EXPECT_EQ(test,
    kunit_add_named_resource(test, core::ptr::null_mut(), core::ptr::null_mut(), &res2,
    "resource_2", &ctx),
    0);
...
#[no_mangle]
unsafe extern "C" fn increment_int(ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_action(test: *mut kunit) {
    static void kunit_resource_test_action(struct kunit *test)
    {
    let mut num_actions: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_remove_action(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_release_action(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn action_order_1(ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn action_order_2(ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_action_ordering(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_init(test: *mut kunit) -> c_int {
    static int kunit_resource_test_init(struct kunit *test)
    {
    struct kunit_test_resource_context *ctx = kzalloc_obj(*ctx);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, ctx);
    test.priv = ctx;
    kunit_init_test(&ctx.test, "test_test_context", core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn kunit_resource_test_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_log_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_log_newline_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_status_set_failure_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_status_mark_skipped_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_current_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_current_fail_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_dev_action(priv: *mut c_void) {
    static void test_dev_action(void *priv)
    {
// (long *)priv = 1;
    }
#[no_mangle]
unsafe extern "C" fn kunit_device_test(test: *mut kunit) {
    static void kunit_device_test(struct kunit *test)
    {
    struct device *test_device;
    let mut action_was_run: c_long = 0;
...
#[no_mangle]
unsafe extern "C" fn kunit_device_cleanup_test(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct driver_test_state {
    pub driver_device_probed: bool,
    pub driver_device_removed: bool,
    pub action_was_run: c_long,
}

#[no_mangle]
unsafe extern "C" fn driver_probe_hook(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn driver_remove_hook(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kunit_device_driver_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_stub_test(test: *mut kunit) {
    static void kunit_stub_test(struct kunit *test)
    {
    struct kunit fake_test;
    let mut fake_real_fn_addr: c_ulong = 0x1234;
    let mut fake_replacement_addr: c_ulong = 0x5678;
    struct kunit_resource *res;
    struct {
    void *real_fn_addr;
    void *replacement_addr;
    } *stub_ctx;
    kunit_init_test(&fake_test, "kunit_stub_fake_test", core::ptr::null_mut());
    ...
    __kunit_activate_static_stub(&fake_test, (void *)fake_real_fn_addr, core::ptr::null_mut());
    KUNIT_ASSERT_EQ(test, fake_test.status, KUNIT_SUCCESS);
    KUNIT_ASSERT_EQ(test, list_count_nodes(&fake_test.resources), 0);
    }
