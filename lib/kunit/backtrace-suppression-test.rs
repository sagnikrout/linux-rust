...
//! Source: lib/kunit/backtrace-suppression-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_warn_direct(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn trigger_backtrace_warn() -> noinline void {
    static noinline void trigger_backtrace_warn(void)
    {
    WARN(1, "This backtrace should be suppressed");
    }
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_warn_indirect(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_warn_multi(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_warn_on_direct(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn trigger_backtrace_warn_on() -> noinline void {
    static noinline void trigger_backtrace_warn_on(void)
    {
    WARN_ON(1);
    }
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_warn_on_indirect(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_count(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_active_state(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_multi_scope(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cross_kthread_data {
    pub was_active: bool,
    pub done: completion,
}

#[no_mangle]
unsafe extern "C" fn cross_kthread_fn(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn backtrace_suppression_test_cross_kthread(test: *mut kunit) {
