...
//
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 3, file: *const 4) __kunit_fail_current_test_impl(char, line: c_int, fmt: *const c_char, ...) {
...
// kunit_err() only accepts literals, so evaluate the args first.
    va_start(args, fmt);
    len = vsnprintf(core::ptr::null_mut(), 0, fmt, args) + 1;
    va_end(args);
...
//
    ...
    let mut enable_param: static bool = true;
...
//
    let mut kunit_base_timeout: static unsigned long = CONFIG_KUNIT_DEFAULT_TIMEOUT;
...
// 2 - enabled
//
    let mut kunit_stats_enabled: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn kunit_should_print_stats(stats: *mut kunit_result_stats) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kunit_log_append(log: *mut string_stream, fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn kunit_suite_num_test_cases(suite: *mut kunit_suite) -> usize {
...
#[no_mangle]
unsafe extern "C" fn kunit_print_suite_start(suite: *mut kunit_suite) {
...
#[no_mangle]
pub unsafe extern "C" fn kunit_suite_has_succeeded(suite: *mut kunit_suite) -> enum kunit_status {
    enum kunit_status kunit_suite_has_succeeded(struct kunit_suite *suite)
    {
    const struct kunit_case *test_case;
    let mut status: enum kunit_status = KUNIT_SKIPPED;
...
#[no_mangle]
pub unsafe extern "C" fn if(KUNIT_SUCCESS: test_case->status ==) -> else {
    ...
    let mut kunit_suite_counter: static size_t = 1;
#[no_mangle]
unsafe extern "C" fn kunit_print_suite_end(suite: *mut kunit_suite) {
    static void kunit_print_suite_end(struct kunit_suite *suite)
    {
    kunit_print_ok_not_ok(core::ptr::null_mut(), KUNIT_LEVEL_SUITE,
...
#[no_mangle]
pub unsafe extern "C" fn __kunit_abort(test: *mut kunit) -> void __noreturn {
...
#[no_mangle]
unsafe extern "C" fn kunit_init_params(test: *mut kunit) {
    static void kunit_init_params(struct kunit *test)
    {
    test.params_array.params = core::ptr::null_mut();
    test.params_array.get_description = core::ptr::null_mut();
    test.params_array.num_params = 0;
    test.params_array.elem_size = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn kunit_init_test(test: *mut kunit, name: *const c_char, log: *mut string_stream) {
...
pub const KUNIT_SPEED_WARNING_MULTIPLIER: c_int = 2;
// Slow tests are defined as taking more than 1s
pub const KUNIT_SPEED_SLOW_THRESHOLD_S: c_int = 1;
    ...
    let mut speed: enum kunit_speed = test_case.attr.speed;
...
//
#[no_mangle]
unsafe extern "C" fn kunit_timeout_mult(speed: enum kunit_speed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_timeout(suite: *mut kunit_suite, test_case: *mut kunit_case) -> c_ulong {
    static unsigned long kunit_test_timeout(struct kunit_suite *suite, struct kunit_case *test_case)
    {
    let mut mult: c_int = 1;
//
...
#[no_mangle]
unsafe extern "C" fn kunit_case_internal_cleanup(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kunit_try_catch_context {
    pub test: *mut kunit,
    pub suite: *mut kunit_suite,
    pub test_case: *mut kunit_case,
}

#[no_mangle]
unsafe extern "C" fn kunit_try_run_case(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_try_run_case_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_catch_run_case_cleanup(data: *mut c_void) {
    static void kunit_catch_run_case_cleanup(void *data)
    {
    struct kunit_try_catch_context *ctx = data;
    struct kunit *test = ctx.test;
    let mut try_exit_code: c_int = kunit_try_catch_get_result(&test.try_catch);
...
#[no_mangle]
unsafe extern "C" fn kunit_catch_run_case(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn if(KUNIT_SUCCESS: test_case->status != KUNIT_FAILURE && test->status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn kunit_init_parent_param_test(test_case: *mut kunit_case, test: *mut kunit) {
    static void kunit_init_parent_param_test(struct kunit_case *test_case, struct kunit *test)
    {
    if (test_case.param_init) {
    let mut err: c_int = test_case.param_init(test);
    if (err) {
...
// TODO: Make generate_params try-catch
    curr_param = test_case.generate_params(test, core::ptr::null_mut(), param_desc);
    ...
    kunit_init_test(&param_test, test_case.name, core::ptr::null_mut());
...
// TODO: Put this kunit_cleanup into a try-catch.
    ...
    struct kunit_result_stats *total_stats)
    {
    let mut test: kunit = { .param_value = core::ptr::null_mut(), .param_index = 0 };
    let mut param_stats: kunit_result_stats = { 0 };
...
#[no_mangle]
pub unsafe extern "C" fn kunit_run_tests(suite: *mut kunit_suite) -> c_int {
    int kunit_run_tests(struct kunit_suite *suite)
    {
    struct kunit_case *test_case;
    let mut suite_stats: kunit_result_stats = { 0 };
    let mut total_stats: kunit_result_stats = { 0 };
...
#[no_mangle]
unsafe extern "C" fn kunit_init_suite(suite: *mut kunit_suite) {
...
#[no_mangle]
pub unsafe extern "C" fn kunit_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn kunit_exit_suite(suite: *mut kunit_suite) {
    static void kunit_exit_suite(struct kunit_suite *suite)
    {
    kunit_debugfs_destroy_suite(suite);
    }
#[no_mangle]
pub unsafe extern "C" fn __kunit_test_suites_exit(suites: *mut kunit_suite, num_suites: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kunit_module_init(mod: *mut module) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(action, _arg: "list")) -> else {
    else if (!strcmp(action, "list"))
    kunit_exec_list_tests(&filtered_set, false);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(action, _arg: "list_attr")) -> else {
...
#[no_mangle]
unsafe extern "C" fn kunit_module_exit(mod: *mut module) {
...
#[no_mangle]
pub unsafe extern "C" fn kunit_kfree(test: *mut kunit, ptr: *const c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn kunit_kfree_const(test: *mut kunit, x: *const c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn kunit_cleanup(test: *mut kunit) {
...
//
    ...
    current.kunit_test = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(kunit_cleanup);
#[no_mangle]
unsafe extern "C" fn kunit_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kunit_exit() -> void __exit {
