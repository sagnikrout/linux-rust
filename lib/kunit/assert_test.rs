...
//! Source: lib/kunit/assert_test.c
#![no_std]
...
pub const TEST_PTR_EXPECTED_BUF_SIZE: c_int = 32;
pub const HEXDUMP_TEST_BUF_LEN: c_int = 5;

#[no_mangle]
unsafe extern "C" fn kunit_test_is_literal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_is_str_literal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_assert_prologue(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_assert_print_msg(test: *mut kunit) {
    ...
    "Abacaba", -123, 234U);
    verify_assert_print_msg(test, stream, "", core::ptr::null_mut());
    }
//
...
//
    ...
    va_list checks;
    char *cur_substr_exp;
    let mut message: va_format = { core::ptr::null_mut(), core::ptr::null_mut() };
...
#[no_mangle]
unsafe extern "C" fn kunit_test_unary_assert_format(test: *mut kunit) {
    static void kunit_test_unary_assert_format(struct kunit *test)
    {
    struct string_stream *stream;
    let mut assert: kunit_assert = {};
...
#[no_mangle]
unsafe extern "C" fn kunit_test_ptr_not_err_assert_format(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_binary_assert_format(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_binary_ptr_assert_format(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_binary_str_assert_format(test: *mut kunit) {
    ...
    0x12, 0xba, 0x01 };
#[no_mangle]
unsafe extern "C" fn kunit_test_assert_hexdump(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_test_mem_assert_format(test: *mut kunit) {
...
// The right value is NULL, the left value is not NULL
    ...
    mem_assert.right_value = core::ptr::null_mut();
    validate_assert(kunit_mem_assert_format, test, &mem_assert.assert,
