...
//! Source: lib/kunit/string-stream-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn string_stream_managed_init_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_unmanaged_init_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_destroy_stub(stream: *mut string_stream) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_managed_free_test(test: *mut kunit) {
    static void string_stream_managed_free_test(struct kunit *test)
    {
    struct string_stream_test_priv *priv = test.priv;
    priv.expected_free_stream = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn string_stream_resource_free_test(test: *mut kunit) {
    ...
    kunit_init_test(fake_test, "string_stream_fake_test", core::ptr::null_mut());
    fake_test.priv = priv;
//
...
//
#[no_mangle]
unsafe extern "C" fn string_stream_line_add_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_variable_length_line_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_append_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_append_auto_newline_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_append_empty_string_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_no_auto_newline_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_auto_newline_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn string_stream_performance_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn string_stream_test_init(test: *mut kunit) -> c_int {
