...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kunit_platform_device_alloc_params {
...
#[no_mangle]
unsafe extern "C" fn kunit_platform_device_add_exit(res: *mut kunit_resource) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kunit_platform_device_probe_nb {
    pub x: *mut completion,
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn kunit_platform_device_probe_nb_remove(nb: *mut c_void) {
