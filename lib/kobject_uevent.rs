...
pub unsafe extern "C" fn kobject_synth_uevent(kobj: *mut kobject, buf: *const c_char, count: usize) -> c_int {
    ...
    {
    char *no_uuid_envp[] = { "SYNTH_UUID=0", core::ptr::null_mut() };
    enum kobject_action action;
    const char *action_args;
    struct kobj_uevent_env *env;
    const char *msg = core::ptr::null_mut(), *devpath;
    int r;
...
#[no_mangle]
unsafe extern "C" fn kobj_usermode_filter(kobj: *mut kobject) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_uevent_argv(env: *mut kobj_uevent_env, subsystem: *const c_char) -> c_int {
    static int init_uevent_argv(struct kobj_uevent_env *env, const char *subsystem)
    {
    let mut buffer_size: c_int = sizeof(env.buf) - env.buflen;
    int len;
    ...
    env.argv[2] = core::ptr::null_mut();
    env.buflen += len + 1;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cleanup_uevent_env(info: *mut subprocess_info) {
...
// ENOBUFS should be handled in userspace
    ...
    if (ksobj.parent != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn zap_modalias_env(env: *mut kobj_uevent_env) {
...
// call uevent_helper, usually only enabled during early boot
    ...
    env.envp, GFP_KERNEL,
    core::ptr::null_mut(), cleanup_uevent_env, env);
    if (info) {
    retval = call_usermodehelper_exec(info, UMH_NO_WAIT);
    env = core::ptr::null_mut();	/* freed by cleanup_uevent_env */
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn kobject_uevent(kobj: *mut kobject, action: enum kobject_action) -> c_int {
    int kobject_uevent(struct kobject *kobj, enum kobject_action action)
    {
    return kobject_uevent_env(kobj, action, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn add_uevent_var(env: *mut kobj_uevent_env, format: *const c_char, ...) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uevent_net_rcv(skb: *mut sk_buff) {
    static void uevent_net_rcv(struct sk_buff *skb)
    {
    netlink_rcv_skb(skb, &uevent_net_rcv_skb);
    }
#[no_mangle]
unsafe extern "C" fn uevent_net_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uevent_net_exit(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn kobject_uevent_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_uevent_helper_sysctl() -> int __init {
