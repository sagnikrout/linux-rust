...
//
    ...
    {
    let mut expected_size: usize = offset + length;
...
//
#[no_mangle]
unsafe extern "C" fn pldm_parse_header(data: *mut pldmfw_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pldm_parse_records(data: *mut pldmfw_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pldm_parse_components(data: *mut pldmfw_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pldm_verify_header_crc(data: *mut pldmfw_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pldmfw_free_priv(data: *mut pldmfw_priv) {
    ...
    record.component_bitmap = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn pldm_parse_image(data: *mut pldmfw_priv) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pldm_pci_record_id {
    pub vendor: c_int,
    pub device: c_int,
    pub subsystem_vendor: c_int,
    pub subsystem_device: c_int,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn pldmfw_op_pci_match_record(context: *mut pldmfw, record: *mut pldmfw_record) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pldm_find_matching_record(data: *mut pldmfw_priv) -> c_int {
...
//
    ...
    let mut index: u8 = component.index, transfer_flag = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pldm_flash_components(data: *mut pldmfw_priv) -> c_int {
    ...
    int err;
    list_for_each_entry(component, &data.components, entry) {
    let mut index: u8 = component.index;
// Skip components which are not intended for this device
    if (!test_bit(index, bitmap))
    continue;
...
//
#[no_mangle]
unsafe extern "C" fn pldm_finalize_update(data: *mut pldmfw_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pldmfw_flash_image(context: *mut pldmfw, fw: *const firmware) -> c_int {
