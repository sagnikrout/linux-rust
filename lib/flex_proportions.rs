...
#[no_mangle]
pub unsafe extern "C" fn fprop_global_init(p: *mut fprop_global, gfp: gfp_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fprop_global_destroy(p: *mut fprop_global) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fprop_new_period(p: *mut fprop_global, periods: c_int) -> bool {
    bool fprop_new_period(struct fprop_global *p, int periods)
    {
    let mut events: i64 = percpu_counter_sum(&p.events);
    unsigned long flags;
//
...
#[no_mangle]
pub unsafe extern "C" fn fprop_local_init_percpu(pl: *mut fprop_local_percpu, gfp: gfp_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fprop_local_destroy_percpu(pl: *mut fprop_local_percpu) {
    ...
    {
    let mut period: c_uint = p.period;
    unsigned long flags;
...
// Aging zeroed our fraction?
    ...
    let mut val: i64 = percpu_counter_read(&pl.events);
