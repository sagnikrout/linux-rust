...
//! Source: lib/raid/raid6/loongarch/loongarch_simd.c
#![no_std]
...
pub const NSIZE: c_int = 16;
#[no_mangle]
unsafe extern "C" fn raid6_lsx_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
pub const NSIZE: c_int = 32;
#[no_mangle]
unsafe extern "C" fn raid6_lasx_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
