...
//! Source: lib/raid/raid6/x86/sse1.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn raid6_sse11_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn raid6_sse12_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
