...
//! Source: lib/raid/raid6/x86/sse2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn raid6_sse21_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn raid6_sse22_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn raid6_sse24_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
