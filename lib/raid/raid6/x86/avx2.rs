...
//! Source: lib/raid/raid6/x86/avx2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn raid6_avx21_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn raid6_avx22_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn raid6_avx24_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
