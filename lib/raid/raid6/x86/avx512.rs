...
//! Source: lib/raid/raid6/x86/avx512.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn raid6_avx5121_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn raid6_avx5122_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn raid6_avx5124_gen_syndrome(disks: c_int, bytes: usize, ptrs: *mut c_void) {
