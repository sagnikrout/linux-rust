...
//
    ...
    let mut __initdata: static bool __stack_depot_early_init_requested = IS_ENABLED(CONFIG_STACKDEPOT_ALWAYS_INIT);
    static bool __stack_depot_early_init_passed __initdata;
// Use one hash table bucket per 16 KB of memory.
pub const STACK_HASH_TABLE_SCALE: c_int = 14;
// Limit the number of buckets between 4K and 1M.
pub const STACK_BUCKET_NUMBER_ORDER_MIN: c_int = 12;
pub const STACK_BUCKET_NUMBER_ORDER_MAX: c_int = 20;
// Initial seed for jhash2.
pub const STACK_HASH_SEED: c_uint = 0x9747b28c;
...
#[no_mangle]
unsafe extern "C" fn disable_stack_depot(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_max_pools(str: *mut c_char) -> int __init {
    static int __init parse_max_pools(char *str)
    {
    let mut limit: c_longlong = (1LL << (DEPOT_POOL_INDEX_BITS)) - 1;
...
#[no_mangle]
pub unsafe extern "C" fn stack_depot_request_early_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_stack_table(entries: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn stack_depot_early_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn stack_depot_init() -> c_int {
...
//
    ...
    let mut scale: c_int = STACK_HASH_TABLE_SCALE;
...
//
#[no_mangle]
unsafe extern "C" fn depot_init_pool(prealloc: *mut c_void) -> bool {
...
// prealloc = NULL;
    ...
    if (!new_pool)
    return false; /* new_pool and *prealloc are core::ptr::null_mut() */
...
//
    ...
    WRITE_ONCE(new_pool, core::ptr::null_mut());
    else
...
#[no_mangle]
unsafe extern "C" fn depot_keep_new_pool(prealloc: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn depot_stack_record_size(s: *mut stack_record, nr_entries: c_uint) -> usize {
    static inline size_t depot_stack_record_size(struct stack_record *s, unsigned int nr_entries)
    {
    let mut used: usize = flex_array_size(s, entries, nr_entries);
    let mut unused: usize = sizeof(s.entries) - used;
...
// Allocates a new stack in a stack depot pool.
    ...
    __must_hold(&pool_lock)
    {
    struct stack_record *stack = core::ptr::null_mut();
    size_t record_size;
    lockdep_assert_held(&pool_lock);
...
//
    ...
    {
    let mut pools_num_cached: c_int = READ_ONCE(pools_num);
    let mut parts: union handle_parts = { .handle = handle };
    void *pool;
    let mut pool_index: u32 = parts.pool_index_plus_1 - 1;
    let mut offset: usize = parts.offset << DEPOT_STACK_ALIGN;
    struct stack_record *stack;
...
#[no_mangle]
unsafe extern "C" fn depot_free_stack(stack: *mut stack_record) {
...
#[no_mangle]
pub unsafe extern "C" fn hash_stack(entries: *mut c_ulong, size: c_uint) -> u32 {
...
// Finds a stack in a bucket of the hash table.
    ...
    {
    struct stack_record *stack, *ret = core::ptr::null_mut();
//
...
//
    ...
    struct stack_record *found = core::ptr::null_mut();
    let mut handle: depot_stack_handle_t = 0;
    struct page *page = core::ptr::null_mut();
    void *prealloc = core::ptr::null_mut();
    let mut allow_spin: bool = gfpflags_allow_spinning(alloc_flags);
    let mut can_alloc: bool = (depot_flags & STACK_DEPOT_FLAG_CAN_ALLOC) && allow_spin;
    unsigned long flags;
    u32 hash;
...
#[no_mangle]
pub unsafe extern "C" fn stack_depot_put(handle: depot_stack_handle_t) {
...
#[no_mangle]
pub unsafe extern "C" fn stack_depot_print(stack: depot_stack_handle_t) {
...
#[no_mangle]
pub unsafe extern "C" fn stack_depot_get_extra_bits(handle: depot_stack_handle_t) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn depot_debugfs_init() -> c_int {
    static int depot_debugfs_init(void)
    {
    struct dentry *dir;
    if (stack_depot_disabled)
    return 0;
    dir = debugfs_create_dir("stackdepot", core::ptr::null_mut());
    debugfs_create_file("stats", 0444, dir, core::ptr::null_mut(), &stats_fops);
    return 0;
    }
