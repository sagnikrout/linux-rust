...
//
#[no_mangle]
pub unsafe extern "C" fn linear_range_values_in_range(r: *const linear_range) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn linear_range_get_max_value(r: *const linear_range) -> c_uint {
