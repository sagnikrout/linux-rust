...
//! Source: lib/zstd/zstd_compress_module.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn zstd_min_clevel() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_max_clevel() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_default_clevel() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_compress_bound(src_size: usize) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_cctx_set_param(cctx: *mut zstd_cctx, param: ZSTD_cParameter, value: c_int) -> usize {
...
pub unsafe extern "C" fn zstd_cctx_workspace_bound_with_ext_seq_prod(compress_params: *const zstd_compression_parameters) -> usize {
    ...
    ZSTD_CCtxParams_registerSequenceProducer(&cctx_params, core::ptr::null_mut(), dummy_external_sequence_producer);
...
#[no_mangle]
pub unsafe extern "C" fn zstd_free_cctx(cctx: *mut zstd_cctx) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_free_cdict(cdict: *mut zstd_cdict) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_cstream_workspace_bound(cparams: *const zstd_compression_parameters) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_flush_stream(cstream: *mut zstd_cstream, output: *mut zstd_out_buffer) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn zstd_end_stream(cstream: *mut zstd_cstream, output: *mut zstd_out_buffer) -> usize {
