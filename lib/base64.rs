...
//
#[no_mangle]
pub unsafe extern "C" fn base64_encode(src: *const u8, srclen: c_int, dst: *mut c_char, padding: bool, variant: enum base64_variant) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn base64_decode(src: *const c_char, srclen: c_int, dst: *mut u8, padding: bool, variant: enum base64_variant) -> c_int {
