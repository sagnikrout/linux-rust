...
#[no_mangle]
unsafe extern "C" fn Proc_3(Ptr_Ref_Par: *mut Rec_Pointer) {
...
#[no_mangle]
unsafe extern "C" fn Proc_1(Ptr_Val_Par: Rec_Pointer) {
    static void Proc_1(Rec_Pointer Ptr_Val_Par)
//
// executed once
    {
    let mut Next_Record: Rec_Pointer = Ptr_Val_Par.Ptr_Comp;
// == Ptr_Glob_Next
...
#[no_mangle]
unsafe extern "C" fn Proc_2(Int_Par_Ref: *mut One_Fifty) {
...
#[no_mangle]
pub unsafe extern "C" fn dhry(n: c_int) -> c_int {
    int dhry(int n)
//
