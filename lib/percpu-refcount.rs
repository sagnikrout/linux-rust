...
//
    ...
    data.confirm_switch = core::ptr::null_mut();
    data.ref = ref;
    ref.data = data;
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn __percpu_ref_exit(ref: *mut percpu_ref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_ref_exit(ref: *mut percpu_ref) {
    ...
    ref.data = core::ptr::null_mut();
    spin_unlock_irqrestore(&percpu_ref_switch_lock, flags);
    kfree(data);
    }
    EXPORT_SYMBOL_GPL(percpu_ref_exit);
#[no_mangle]
unsafe extern "C" fn percpu_ref_call_confirm_rcu(rcu: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn percpu_ref_switch_to_atomic_rcu(rcu: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn percpu_ref_noop_confirm_switch(ref: *mut percpu_ref) {
...
#[no_mangle]
unsafe extern "C" fn __percpu_ref_switch_to_percpu(ref: *mut percpu_ref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_ref_switch_to_atomic_sync(ref: *mut percpu_ref) {
    void percpu_ref_switch_to_atomic_sync(struct percpu_ref *ref)
    {
    percpu_ref_switch_to_atomic(ref, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_ref_switch_to_percpu(ref: *mut percpu_ref) {
    void percpu_ref_switch_to_percpu(struct percpu_ref *ref)
    {
    unsigned long flags;
    spin_lock_irqsave(&percpu_ref_switch_lock, flags);
    ref.data.force_atomic = false;
    __percpu_ref_switch_mode(ref, core::ptr::null_mut());
    spin_unlock_irqrestore(&percpu_ref_switch_lock, flags);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_ref_is_zero(ref: *mut percpu_ref) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_ref_reinit(ref: *mut percpu_ref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_ref_resurrect(ref: *mut percpu_ref) {
