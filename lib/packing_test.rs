...
#[no_mangle]
unsafe extern "C" fn packing_test_pack(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn packing_test_unpack(test: *mut kunit) {
...
pub const PACKED_BUF_SIZE: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn packing_test_pack_fields(test: *mut kunit) {
