...
pub unsafe extern "C" fn textsearch_register(ops: *mut ts_ops) -> c_int {
    ...
    struct ts_ops *o;
    if (ops.name == core::ptr::null_mut() || ops.find == core::ptr::null_mut() || ops.init == core::ptr::null_mut() ||
    ops.get_pattern == core::ptr::null_mut() || ops.get_pattern_len == core::ptr::null_mut())
    return -EINVAL;
...
//
    if (ops == core::ptr::null_mut() && flags & TS_AUTOLOAD) {
