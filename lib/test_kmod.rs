...
pub const TEST_START_NUM_THREADS: c_int = 50;

    let mut force_init_test: static bool = false;
...
pub struct test_config {
    pub test_driver: *mut c_char,
    pub test_fs: *mut c_char,
    pub num_threads: c_uint,
    pub test_case: enum kmod_test_case,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kmod_test_device_info {
    pub ret_sync: c_int,
    pub fs_sync: *mut file_system_type,
    pub task_sync: *mut task_struct,
    pub thread_idx: c_uint,
    pub test_dev: *mut kmod_test_device,
    pub need_mod_put: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kmod_test_device {
    pub dev_idx: c_int,
    pub config: test_config,
    pub misc_dev: miscdevice,
    pub dev: *mut device,
    pub config_mutex: mutex,
    pub trigger_mutex: mutex,
    pub thread_mutex: mutex,
    pub done: c_uint,
    pub test_is_oom: bool,
    pub kthreads_done: completion,
    pub list: list_head,
    pub info: *mut kmod_test_device_info,
}
...
#[no_mangle]
unsafe extern "C" fn test_kmod_put_module(info: *mut kmod_test_device_info) {
...
#[no_mangle]
unsafe extern "C" fn run_request(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tally_work_test(info: *mut kmod_test_device_info) -> c_int {
    static int tally_work_test(struct kmod_test_device_info *info)
    {
    struct kmod_test_device *test_dev = info.test_dev;
    struct test_config *config = &test_dev.config;
    let mut err_ret: c_int = 0;
    switch (config.test_case) {
    case TEST_KMOD_DRIVER:
//
...
//
#[no_mangle]
unsafe extern "C" fn tally_up_work(test_dev: *mut kmod_test_device) {
...
#[no_mangle]
unsafe extern "C" fn try_one_request(test_dev: *mut kmod_test_device, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_dev_kmod_stop_tests(test_dev: *mut kmod_test_device) {
...
//
#[no_mangle]
unsafe extern "C" fn try_requests(test_dev: *mut kmod_test_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_test_driver(test_dev: *mut kmod_test_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_test_fs_type(test_dev: *mut kmod_test_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __trigger_config_run(test_dev: *mut kmod_test_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn trigger_config_run(test_dev: *mut kmod_test_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __kstrncpy(dst: *mut c_char, name: *const c_char, count: usize, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __kmod_config_free(config: *mut test_config) {
    static void __kmod_config_free(struct test_config *config)
    {
    if (!config)
    return;
    kfree_const(config.test_driver);
    config.test_driver = core::ptr::null_mut();
    kfree_const(config.test_fs);
    config.test_fs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn kmod_config_free(test_dev: *mut kmod_test_device) {
...
#[no_mangle]
unsafe extern "C" fn free_test_dev_info(test_dev: *mut kmod_test_device) {
    static void free_test_dev_info(struct kmod_test_device *test_dev)
    {
    vfree(test_dev.info);
    test_dev.info = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn kmod_config_sync_info(test_dev: *mut kmod_test_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmod_init_test_thread_limit() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn kmod_config_init(test_dev: *mut kmod_test_device) -> c_int {
    ...
    err_out_free:
    vfree(test_dev);
    test_dev = core::ptr::null_mut();
    err_out:
    return core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn free_test_dev_kmod(test_dev: *mut kmod_test_device) {
    static void free_test_dev_kmod(struct kmod_test_device *test_dev)
    {
    if (test_dev) {
    kfree_const(test_dev.misc_dev.name);
    test_dev.misc_dev.name = core::ptr::null_mut();
    free_test_dev_info(test_dev);
    kmod_config_free(test_dev);
    vfree(test_dev);
    test_dev = core::ptr::null_mut();
    ...
    {
    struct kmod_test_device *test_dev = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn test_kmod_init() -> int __init {
...
//
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn unregister_test_dev_kmod(test_dev: *mut kmod_test_device) {
...
#[no_mangle]
unsafe extern "C" fn test_kmod_exit() -> void __exit {
