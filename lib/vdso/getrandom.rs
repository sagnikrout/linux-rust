...
#[no_mangle]
unsafe extern "C" fn memcpy_and_zero_src(dst: *mut c_void, src: *mut c_void, len: usize) {
...
//
    ...
    {
    let mut ret: isize = min_t(size_t, INT_MAX & PAGE_MASK /* = MAX_RW_COUNT */, len);
