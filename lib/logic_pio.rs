...
//
#[no_mangle]
pub unsafe extern "C" fn logic_pio_register_range(new_range: *mut logic_pio_hwaddr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn logic_pio_unregister_range(range: *mut logic_pio_hwaddr) {
...
//
    ...
    {
    struct logic_pio_hwaddr *range, *found_range = core::ptr::null_mut();
    rcu_read_lock();
...
//
#[no_mangle]
pub unsafe extern "C" fn logic_pio_to_hwaddr(pio: c_ulong) -> resource_size_t {
...
#[no_mangle]
pub unsafe extern "C" fn logic_pio_trans_cpuaddr(addr: resource_size_t) -> c_ulong {
