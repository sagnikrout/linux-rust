...
//
#[no_mangle]
pub unsafe extern "C" fn lc_try_lock(lc: *mut lru_cache) -> c_int {
...
//
    ...
    {
    struct hlist_head *slot = core::ptr::null_mut();
    struct lc_element **element = core::ptr::null_mut();
    struct lru_cache *lc;
    struct lc_element *e;
    let mut cache_obj_size: unsigned = kmem_cache_size(cache);
    unsigned i;
...
#[no_mangle]
unsafe extern "C" fn lc_free_by_index(lc: *mut lru_cache, i: unsigned) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lc_destroy(lc: *mut lru_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lc_reset(lc: *mut lru_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lc_seq_printf_stats(seq: *mut seq_file, lc: *mut lru_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lc_is_used(lc: *mut lru_cache, enr: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn lc_del(lc: *mut lru_cache, e: *mut lc_element) {
    ...
    n = lc.free.next;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !list_empty(&lc->lru)) -> else {
...
#[no_mangle]
unsafe extern "C" fn lc_unused_element_available(lc: *mut lru_cache) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lc_committed(lc: *mut lru_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lc_put(lc: *mut lru_cache, e: *mut lc_element) -> c_uint {
...
//
    ...
    BUG_ON(lc.lc_element[i] == core::ptr::null_mut());
...
//
    ...
    {
    let mut nr_elements: c_uint = lc.nr_elements;
    struct lc_element *e;
    int i;
