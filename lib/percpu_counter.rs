...
#[no_mangle]
unsafe extern "C" fn percpu_counter_fixup_free(addr: *mut c_void, state: enum debug_obj_state) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn debug_percpu_counter_activate(fbc: *mut percpu_counter) {
...
#[no_mangle]
pub unsafe extern "C" fn debug_percpu_counter_deactivate(fbc: *mut percpu_counter) {
...
#[no_mangle]
pub unsafe extern "C" fn percpu_counter_set(fbc: *mut percpu_counter, amount: i64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_counter_add_batch(fbc: *mut percpu_counter, amount: i64, batch: i32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn percpu_counter_sync(fbc: *mut percpu_counter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __percpu_counter_sum(fbc: *mut percpu_counter) -> i64 {
    ...
    if (!counters) {
    fbc[0].counters = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
pub unsafe extern "C" fn percpu_counter_destroy_many(fbc: *mut percpu_counter, nr_counters: u32) {
    ...
    for (i = 0; i < nr_counters; i++)
    fbc[i].counters = core::ptr::null_mut();
    }
    EXPORT_SYMBOL(percpu_counter_destroy_many);
    let mut __read_mostly: int percpu_counter_batch = 32;
    EXPORT_SYMBOL(percpu_counter_batch);
#[no_mangle]
unsafe extern "C" fn compute_batch_value(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn percpu_counter_cpu_dead(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __percpu_counter_compare(fbc: *mut percpu_counter, rhs: i64, batch: i32) -> c_int {
...
// Need to use precise count
    ...
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(rhs: count <) -> else {
    else if (count < rhs)
    return -1;
    else
    return 0;
...
#[no_mangle]
unsafe extern "C" fn percpu_counter_startup() -> int __init {
    static int __init percpu_counter_startup(void)
    {
    int ret;
    ret = cpuhp_setup_state(CPUHP_AP_ONLINE_DYN, "lib/percpu_cnt:online",
    compute_batch_value, core::ptr::null_mut());
    WARN_ON(ret < 0);
    ret = cpuhp_setup_state_nocalls(CPUHP_PERCPU_CNT_DEAD,
    "lib/percpu_cnt:dead", core::ptr::null_mut(),
