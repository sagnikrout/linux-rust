...
//
    ...
    if (!root)
    return 0;
    return assoc_array_subtree_iterate(root, core::ptr::null_mut(), iterator, iterator_data);
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct assoc_array_walk_result {
    struct {
    pub /: *mut *mut *mut assoc_array_node node; / Node in which leaf might be found,
    pub level: c_int,
    pub slot: c_int,
    pub terminal_node: },
    struct {
    pub shortcut: *mut assoc_array_shortcut,
    pub level: c_int,
    pub sc_level: c_int,
    pub sc_segments: c_ulong,
    pub dissimilarity: c_ulong,
    pub wrong_shortcut: },
}
...
// Trim segments that are beyond the shortcut
    let mut shift: c_int = shortcut.skip_to_level & ASSOC_ARRAY_KEY_CHUNK_MASK;
...
//
    ...
    struct assoc_array_shortcut *shortcut;
    struct assoc_array_node *node;
    struct assoc_array_ptr *cursor, *parent = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn assoc_array_insert_in_empty_tree(edit: *mut assoc_array_edit) -> bool {
...
// Metadata pointers cannot change slot
    ...
    new_n0.slots[i] = core::ptr::null_mut();
    BUG_ON(new_n0.slots[slot] != core::ptr::null_mut());
...
// Filter the leaf pointers between the new nodes
    ...
    do {
    free_slot++;
    } while (new_n0.slots[free_slot] != core::ptr::null_mut());
    ...
    edit.set[0].ptr = &edit.array.root;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: assoc_array_ptr_is_node(ptr)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn assoc_array_insert_set_object(edit: *mut assoc_array_edit, object: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct assoc_array_delete_collapse_context {
    pub node: *mut assoc_array_node,
    pub skip_leaf: *const c_void,
    pub slot: c_int,
}
...
//
    ...
    edit.set[0].to = core::ptr::null_mut();
    edit.adjust_count_on = node;
...
//
    ...
    edit.set[1].to = core::ptr::null_mut();
    edit.adjust_count_on = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn assoc_array_rcu_cleanup(head: *mut rcu_head) {
    ...
    n.back_pointer = core::ptr::null_mut();
    } else {
    struct assoc_array_shortcut *s =
    assoc_array_ptr_to_shortcut(edit.excised_subtree);
    s.back_pointer = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn assoc_array_apply_edit(edit: *mut assoc_array_edit) {
...
// edit->set[i].ptr = edit->set[i].to;
    if (edit.array.root == core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn assoc_array_cancel_edit(edit: *mut assoc_array_edit) {
...
//
    ...
    edit.excised_subtree = array.root;
    new_root = new_parent = core::ptr::null_mut();
    new_ptr_pp = &new_root;
    cursor = array.root;
    descend:
...
//
    ...
    nr_free++;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: assoc_array_ptr_is_leaf(ptr)) -> else {
...
//
    BUG_ON(s);
    new_n.slots[slot] = core::ptr::null_mut();
    nr_free++;
    if (slot < next_slot)
    next_slot = slot;
    for (i = 0; i < ASSOC_ARRAY_FAN_OUT; i++) {
...
// Excise this node if it is singly occupied by a shortcut
    ...
    kfree(new_n);
    if (!new_parent) {
    new_s.back_pointer = core::ptr::null_mut();
    new_s.parent_slot = 0;
    new_root = ptr;
    goto gc_complete;
    }
