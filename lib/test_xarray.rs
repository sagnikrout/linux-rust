...
#[no_mangle]
unsafe extern "C" fn xa_insert_index(xa: *mut xarray, index: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn xa_alloc_index(xa: *mut xarray, index: c_ulong, gfp: gfp_t) {
...
#[no_mangle]
unsafe extern "C" fn xa_erase_index(xa: *mut xarray, index: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn check_xa_err(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xas_retry(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xa_load(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xa_mark_1(xa: *mut xarray, index: c_ulong) -> noinline void {
    static noinline void check_xa_mark_1(struct xarray *xa, unsigned long index)
    {
    unsigned int order;
    let mut max_order: c_uint = IS_ENABLED(CONFIG_XARRAY_MULTI) ? 8 : 1;
...
//
    ...
    let mut base: c_ulong = round_down(index, 1UL << order);
    let mut next: c_ulong = base + (1UL << order);
    unsigned long i;
...
#[no_mangle]
unsafe extern "C" fn check_xa_mark_2(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xa_mark_3(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xa_mark(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xa_shrink(xa: *mut xarray) -> noinline void {
    static noinline void check_xa_shrink(struct xarray *xa)
    {
    XA_STATE(xas, xa, 1);
    struct xa_node *node;
    unsigned int order;
    let mut max_order: c_uint = IS_ENABLED(CONFIG_XARRAY_MULTI) ? 15 : 1;
    XA_BUG_ON(xa, !xa_empty(xa));
...
//
    ...
    let mut max: c_ulong = (1UL << order) - 1;
...
#[no_mangle]
unsafe extern "C" fn check_insert(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_cmpxchg(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_cmpxchg_order(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_reserve(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xas_erase(xa: *mut xarray) -> noinline void {
    ...
    let mut min: c_ulong = index & ~((1UL << order) - 1);
    let mut max: c_ulong = min + (1UL << order);
...
#[no_mangle]
unsafe extern "C" fn check_multi_store(xa: *mut xarray) -> noinline void {
    static noinline void check_multi_store(struct xarray *xa)
    {

    unsigned long i, j, k;
    let mut max_order: c_uint = (sizeof(long) == 4) ? 30 : 60;
...
// mimics page cache __filemap_add_folio()
    ...
    {
    XA_STATE(xas, xa, index);
    let mut nrpages: c_uint = 1UL << order;
...
// mimics page cache filemap_get_entry()
    ...
    XA_STATE(xas, xa, index);
    void *p;
    let mut loops: static unsigned int = 0;
    rcu_read_lock();
    repeat:
    xas_reset(&xas);
    p = xas_load(&xas);
...
//
    ...
    let mut some_val: static unsigned long = 0xdeadbeef;
    let mut some_val_2: static unsigned long = 0xdeaddead;
...
#[no_mangle]
unsafe extern "C" fn check_multi_store_advanced(xa: *mut xarray) -> noinline void {
    static noinline void check_multi_store_advanced(struct xarray *xa)
    {

    let mut max_order: c_uint = IS_ENABLED(CONFIG_XARRAY_MULTI) ? 20 : 1;
    let mut end: c_ulong = ULONG_MAX/2;
    unsigned long pos, i;
//
...
#[no_mangle]
unsafe extern "C" fn check_xa_alloc_1(xa: *mut xarray, base: c_uint) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xa_alloc_2(xa: *mut xarray, base: c_uint) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xa_alloc_3(xa: *mut xarray, base: c_uint) -> noinline void {
    static noinline void check_xa_alloc_3(struct xarray *xa, unsigned int base)
    {
    let mut limit: xa_limit = XA_LIMIT(1, 0x3fff);
    let mut next: u32 = 0;
    unsigned int i, id;
    unsigned long index;
    void *entry;
...
#[no_mangle]
unsafe extern "C" fn check_xa_alloc() -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_store_iter(xa: *mut xarray) -> noinline void {
    static noinline void check_store_iter(struct xarray *xa)
    {
    unsigned int i, j;
    let mut max_order: c_uint = IS_ENABLED(CONFIG_XARRAY_MULTI) ? 20 : 1;
    for (i = 0; i < max_order; i++) {
    let mut min: c_uint = 1 << i;
    let mut max: c_uint = (2 << i) - 1;
...
#[no_mangle]
unsafe extern "C" fn check_multi_find_1(xa: *mut xarray, order: unsigned) -> noinline void {
    static noinline void check_multi_find_1(struct xarray *xa, unsigned order)
    {

    let mut multi: c_ulong = 3 << order;
    let mut next: c_ulong = 4 << order;
    unsigned long index;
...
#[no_mangle]
unsafe extern "C" fn check_multi_find_2(xa: *mut xarray) -> noinline void {
    static noinline void check_multi_find_2(struct xarray *xa)
    {
    let mut max_order: c_uint = IS_ENABLED(CONFIG_XARRAY_MULTI) ? 10 : 1;
    unsigned int i, j;
    void *entry;
    for (i = 0; i < max_order; i++) {
    let mut index: c_ulong = 1UL << i;
    for (j = 0; j < index; j++) {
...
#[no_mangle]
unsafe extern "C" fn check_multi_find_3(xa: *mut xarray) -> noinline void {
    static noinline void check_multi_find_3(struct xarray *xa)
    {
    unsigned int order;
    for (order = 5; order < order_limit; order++) {
    let mut index: c_ulong = 1UL << (order - 5);
    XA_BUG_ON(xa, !xa_empty(xa));
...
#[no_mangle]
unsafe extern "C" fn check_find_1(xa: *mut xarray) -> noinline void {
...
//
    ...
    for (k = 0; k < 100; k++) {
    let mut index: c_ulong = k;
    void *entry = xa_find(xa, &index, ULONG_MAX,
    XA_PRESENT);
    if (k <= j)
    XA_BUG_ON(xa, index != j);
#[no_mangle]
pub unsafe extern "C" fn if(i: k <=) -> else {
    else if (k <= i)
...
#[no_mangle]
unsafe extern "C" fn check_find_2(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_find_3(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_find_4(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_find(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn xa_find_entry(xa: *mut xarray, item: *mut c_void) -> noinline unsigned long {
    static noinline unsigned long xa_find_entry(struct xarray *xa, void *item)
    {
    XA_STATE(xas, xa, 0);
    let mut checked: c_uint = 0;
    void *entry;
    rcu_read_lock();
    xas_for_each(&xas, entry, ULONG_MAX) {
...
#[no_mangle]
unsafe extern "C" fn check_find_entry(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_pause(xa: *mut xarray) -> noinline void {
    static noinline void check_pause(struct xarray *xa)
    {
    XA_STATE(xas, xa, 0);
    void *entry;
    int order;
    let mut index: c_ulong = 1;
    let mut count: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn check_move_tiny(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_move_max(xa: *mut xarray) -> noinline void {
    ...
    XA_BUG_ON(xa, xas_find(&xas, ULONG_MAX) != core::ptr::null_mut());
    rcu_read_unlock();
    xas_set(&xas, 0);
    rcu_read_lock();
    XA_BUG_ON(xa, xas_find(&xas, ULONG_MAX) != xa_mk_index(ULONG_MAX));
...
#[no_mangle]
unsafe extern "C" fn check_move_small(xa: *mut xarray, idx: c_ulong) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_move(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_create_range_2(xa: *mut xarray, order: unsigned) -> noinline void {
    static noinline void check_create_range_2(struct xarray *xa, unsigned order)
    {
    unsigned long i;
    let mut nr: c_ulong = 1UL << order;
...
#[no_mangle]
unsafe extern "C" fn check_create_range_3() -> noinline void {
    ...
    {
    XA_STATE_ORDER(xas, xa, index, order);
    let mut base: c_ulong = xas.xa_index;
    let mut i: c_ulong = 0;
    xa_store_index(xa, index, GFP_KERNEL);
    do {
    xas_lock(&xas);
...
#[no_mangle]
unsafe extern "C" fn check_create_range(xa: *mut xarray) -> noinline void {
    static noinline void check_create_range(struct xarray *xa)
    {
    unsigned int order;
    let mut max_order: c_uint = IS_ENABLED(CONFIG_XARRAY_MULTI) ? 12 : 1;
    for (order = 0; order < max_order; order++) {
...
#[no_mangle]
unsafe extern "C" fn check_store_range(xa: *mut xarray) -> noinline void {
    ...
    xas_unlock(&xas);
    for (i = 0; i < (1 << order); i++) {
    let mut val: c_uint = index + (i & ~((1 << new_order) - 1));
...
#[no_mangle]
unsafe extern "C" fn check_split(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_align_1(xa: *mut xarray, name: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn check_align_2(xa: *mut xarray, name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn check_align(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn test_update_node(node: *mut xa_node) {
...
#[no_mangle]
unsafe extern "C" fn shadow_remove(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_workingset(xa: *mut xarray, index: c_ulong) -> noinline void {
...
//
#[no_mangle]
unsafe extern "C" fn check_account(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_get_order(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xas_get_order(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_xas_conflict_get_order(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn check_destroy(xa: *mut xarray) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn xarray_checks() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xarray_exit() {
