...
//! Source: lib/crypto/mpi/mpi-mul.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mpi_mul(w: MPI, u: MPI, v: MPI) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpi_mulm(w: MPI, u: MPI, v: MPI, m: MPI) -> c_int {
