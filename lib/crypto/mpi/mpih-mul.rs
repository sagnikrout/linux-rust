...
//! Source: lib/crypto/mpi/mpih-mul.c
#![no_std]
...
//
    let mut hsize: mpi_size_t = size >> 1;
    mpi_limb_t cy;
    int negflg;
...
#[no_mangle]
pub unsafe extern "C" fn mpih_sqr_n_basecase(prodp: mpi_ptr_t, up: mpi_ptr_t, size: mpi_size_t) {
...
#[no_mangle]
pub unsafe extern "C" fn mpihelp_release_karatsuba_ctx(ctx: *mut karatsuba_ctx) {
...
//
    ...
    {
    let mut prod_endp: mpi_ptr_t = prodp + usize + vsize - 1;
    mpi_limb_t cy;
    struct karatsuba_ctx ctx;
