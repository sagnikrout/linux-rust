...
extern "C" {
    pub fn DEFINE_STATIC_KEY_FALSE(_arg: have_cpacf_aes128) -> static __ro_after_init;
}
extern "C" {
    pub fn DEFINE_STATIC_KEY_FALSE(_arg: have_cpacf_aes192) -> static __ro_after_init;
}
extern "C" {
    pub fn DEFINE_STATIC_KEY_FALSE(_arg: have_cpacf_aes256) -> static __ro_after_init;
}
//
