...
#[no_mangle]
pub unsafe extern "C" fn LOAD_OP(I: c_int, W: *mut u32, input: *const u8) {
    static inline void LOAD_OP(int I, u32 *W, const u8 *input)
    {
    W[I] = get_unaligned_be32((__u32 *)input + I);
    }
#[no_mangle]
pub unsafe extern "C" fn BLEND_OP(I: c_int, W: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn __sha256_update(ctx: *mut __sha256_ctx, data: *const u8, len: usize) {
    void __sha256_update(struct __sha256_ctx *ctx, const u8 *data, size_t len)
    {
    let mut partial: usize = ctx.bytecount % SHA256_BLOCK_SIZE;
    ctx.bytecount += len;
    if (partial + len >= SHA256_BLOCK_SIZE) {
    size_t nblocks;
    if (partial) {
    let mut l: usize = SHA256_BLOCK_SIZE - partial;
...
#[no_mangle]
pub unsafe extern "C" fn sha224_final(ctx: *mut sha224_ctx, out[SHA224_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sha256_final(ctx: *mut sha256_ctx, out[SHA256_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sha224(data: *const u8, len: usize, out[SHA224_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sha256(data: *const u8, len: usize, out[SHA256_DIGEST_SIZE]: u8) {
...
#[no_mangle]
unsafe extern "C" fn sha256_finup_2x_is_optimized_arch() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sha256_finup_2x_is_optimized() -> bool {
...
#[no_mangle]
unsafe extern "C" fn sha256_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sha256_mod_exit() -> void __exit {
