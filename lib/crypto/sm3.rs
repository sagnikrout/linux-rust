...
#[no_mangle]
pub unsafe extern "C" fn sm3_init(ctx: *mut sm3_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn sm3_update(ctx: *mut sm3_ctx, data: *const u8, len: usize) {
    void sm3_update(struct sm3_ctx *ctx, const u8 *data, size_t len)
    {
    let mut partial: usize = ctx.bytecount % SM3_BLOCK_SIZE;
    ctx.bytecount += len;
    if (partial + len >= SM3_BLOCK_SIZE) {
    size_t nblocks;
    if (partial) {
    let mut l: usize = SM3_BLOCK_SIZE - partial;
...
#[no_mangle]
unsafe extern "C" fn __sm3_final(ctx: *mut sm3_ctx, out[SM3_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sm3_final(ctx: *mut sm3_ctx, out[SM3_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sm3(data: *const u8, len: usize, out[SM3_DIGEST_SIZE]: u8) {
...
#[no_mangle]
unsafe extern "C" fn sm3_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sm3_mod_exit() -> void __exit {
