...
pub const SHA3_KECCAK_ROUNDS: c_int = 24;
...
//
#[no_mangle]
unsafe extern "C" fn sha3_keccakf_one_round_generic(st[25]: u64, round: c_int) -> SHA3_INLINE void {
...
#[no_mangle]
unsafe extern "C" fn sha3_keccakf_generic(state: *mut sha3_state) {
...
#[no_mangle]
pub unsafe extern "C" fn __sha3_update(ctx: *mut __sha3_ctx, in: *const u8, in_len: usize) {
    void __sha3_update(struct __sha3_ctx *ctx, const u8 *in, size_t in_len)
    {
    let mut block_size: usize = ctx.block_size;
    let mut absorb_offset: usize = ctx.absorb_offset;
// Warn if squeezing has already begun.
    ...
    let mut nblocks: usize = in_len / block_size;
...
#[no_mangle]
pub unsafe extern "C" fn sha3_final(sha3_ctx: *mut sha3_ctx, out: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn shake_squeeze(shake_ctx: *mut shake_ctx, out: *mut u8, out_len: usize) {
    void shake_squeeze(struct shake_ctx *shake_ctx, u8 *out, size_t out_len)
    {
    struct __sha3_ctx *ctx = &shake_ctx.ctx;
    let mut block_size: usize = ctx.block_size;
    let mut squeeze_offset: usize = ctx.squeeze_offset;
...
//
    ...
    let mut copy: usize = min(out_len, block_size - squeeze_offset);
...
#[no_mangle]
pub unsafe extern "C" fn sha3_224(in: *const u8, in_len: usize, out[SHA3_224_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sha3_256(in: *const u8, in_len: usize, out[SHA3_256_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sha3_384(in: *const u8, in_len: usize, out[SHA3_384_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sha3_512(in: *const u8, in_len: usize, out[SHA3_512_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn shake128(in: *const u8, in_len: usize, out: *mut u8, out_len: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn shake256(in: *const u8, in_len: usize, out: *mut u8, out_len: usize) {
...
#[no_mangle]
unsafe extern "C" fn sha3_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sha3_mod_exit() -> void __exit {
