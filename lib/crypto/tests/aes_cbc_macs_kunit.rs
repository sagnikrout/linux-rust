...
//! Source: lib/crypto/tests/aes_cbc_macs_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aes_cmac_init_withtestkey(ctx: *mut aes_cmac_ctx) {
...
#[no_mangle]
unsafe extern "C" fn aes_cbc_macs_suite_init(suite: *mut kunit_suite) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_aes_cmac_rfc4493(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_aes_xcbcmac_rfc3566(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_aes_cbcmac_rfc3610(test: *mut kunit) {
...
//
    ...
    let mut unpadded_data_len: usize = 52;
