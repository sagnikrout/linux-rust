...
//! Source: lib/crypto/tests/chacha20poly1305_kunit.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct chacha20poly1305_testvec {
    pub key: *const *const *const *const *const u8 input, output, assoc, nonce,,
    pub nlen: size_t ilen, alen,,
    pub failure: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(12: nonce_len ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn test_chacha20poly1305(test: *mut kunit) {
