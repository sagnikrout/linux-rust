...
//! Source: lib/crypto/tests/blake2s_kunit.c
#![no_std]
...
//
    ...
    {
    blake2s(core::ptr::null_mut(), 0, data, len, out, BLAKE2S_HASH_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn blake2s_init_default(ctx: *mut blake2s_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn test_blake2s_all_key_and_hash_lens(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_blake2s_with_guarded_key_buf(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_blake2s_with_guarded_out_buf(test: *mut kunit) {
    ...
    blake2s(core::ptr::null_mut(), 0, data, data_len, hash, out_len);
    blake2s(core::ptr::null_mut(), 0, data, data_len, guarded_hash, out_len);
