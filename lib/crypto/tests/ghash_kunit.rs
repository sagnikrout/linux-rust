...
//! Source: lib/crypto/tests/ghash_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ghash_init_withtestkey(ctx: *mut ghash_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn test_ghash_allones_key_and_message(test: *mut kunit) {
...
pub const MAX_LEN_FOR_KEY_CHECK: c_int = 1024;
//
...
//
    ...
    for (int i = 0; i < 100; i++) {
    let mut len: usize = rand_length(MAX_LEN_FOR_KEY_CHECK);
...
#[no_mangle]
unsafe extern "C" fn test_ghash_with_guarded_key(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_ghash_with_minimally_aligned_key(test: *mut kunit) {
    static void test_ghash_with_minimally_aligned_key(struct kunit *test)
    {
    u8 raw_key[GHASH_BLOCK_SIZE];
    struct ghash_key key;
    let mut align: usize = __alignof__(struct ghash_key);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ghash_irq_test_state {
    pub expected_key: ghash_key,
    pub raw_key: [u8; GHASH_BLOCK_SIZE],
}

#[no_mangle]
unsafe extern "C" fn ghash_irq_test_func(state_: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn test_ghash_preparekey_in_irqs(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ghash_suite_init(suite: *mut kunit_suite) -> c_int {
