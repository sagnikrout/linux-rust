...
//! Source: lib/crypto/tests/poly1305_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn poly1305_init_withtestkey(ctx: *mut poly1305_desc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn poly1305_suite_init(suite: *mut kunit_suite) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_poly1305_allones_keys_and_message(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_poly1305_reduction_edge_cases(test: *mut kunit) {
