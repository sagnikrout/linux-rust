...
//! Source: lib/crypto/tests/curve25519_kunit.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct curve25519_test_vector {
    pub private: [u8; CURVE25519_KEY_SIZE],
    pub public: [u8; CURVE25519_KEY_SIZE],
    pub result: [u8; CURVE25519_KEY_SIZE],
    pub valid: bool,
}
...
#[no_mangle]
unsafe extern "C" fn test_curve25519(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_curve25519_basepoint(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn benchmark_curve25519(test: *mut kunit) {
    ...
    let mut warmup_niter: usize = 5000;
    let mut benchmark_niter: usize = 1024;
    u8 out[CURVE25519_KEY_SIZE];
