...
//! Source: lib/crypto/tests/aes_ccm_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_aes_ccm_test_vectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_aes_ccm_nist_sp800_38c_example4(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn test_aes_ccm_data_len_too_large(test: *mut kunit) {
...
// clang-format on
    ...
    let mut nonce_len: usize = lens[i].nonce_len;
    let mut max_data_len: u64 = lens[i].max_data_len;
...
// data_len > max_data_len should be rejected.
    ...
    err = aes_ccm_encrypt(core::ptr::null_mut(), core::ptr::null_mut(), max_data_len + 1,
    core::ptr::null_mut(), core::ptr::null_mut(), 0, nonce, nonce_len,
    key);
    KUNIT_ASSERT_EQ_MSG(
    test, -EOVERFLOW, err,
    "data_len=%llu wasn't rejected with -EOVERFLOW with nonce_len=%zu (aes_ccm_encrypt)",
    max_data_len + 1, nonce_len);
    err = aes_ccm_decrypt(core::ptr::null_mut(), core::ptr::null_mut(), max_data_len + 1,
    core::ptr::null_mut(), core::ptr::null_mut(), 0, nonce, nonce_len,
    key);
    KUNIT_ASSERT_EQ_MSG(
    test, -EOVERFLOW, err,
