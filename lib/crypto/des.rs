...
//
#[no_mangle]
unsafe extern "C" fn des_ekey(pe: *mut u32, k: *const u8) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn des_expand_key(ctx: *mut des_ctx, key: *const u8, keylen: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dkey(pe: *mut u32, k: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn des_encrypt(ctx: *const des_ctx, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn des_decrypt(ctx: *const des_ctx, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn des3_ede_encrypt(dctx: *const des3_ede_ctx, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn des3_ede_decrypt(dctx: *const des3_ede_ctx, dst: *mut u8, src: *const u8) {
