...
#[no_mangle]
unsafe extern "C" fn aes_prefetch(mem: *const c_void, len: usize) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn mul_by_x(w: u32) -> u32 {
    static u32 mul_by_x(u32 w)
    {
    let mut x: u32 = w & 0x7f7f7f7f;
    let mut y: u32 = w & 0x80808080;
// multiply by polynomial 'x' (0b10) in GF(2^8)
    return (x << 1) ^ (y >> 7) * 0x1b;
    }
#[no_mangle]
unsafe extern "C" fn mul_by_x2(w: u32) -> u32 {
    static u32 mul_by_x2(u32 w)
    {
    let mut x: u32 = w & 0x3f3f3f3f;
    let mut y: u32 = w & 0x80808080;
    let mut z: u32 = w & 0x40404040;
// multiply by polynomial 'x^2' (0b100) in GF(2^8)
    return (x << 2) ^ (y >> 7) * 0x36 ^ (z >> 6) * 0x1b;
    }
#[no_mangle]
unsafe extern "C" fn mix_columns(x: u32) -> u32 {
...
// | 0x3 0x1 0x1 0x2 |   | x[3] |
//
    let mut y: u32 = mul_by_x(x) ^ ror32(x, 16);
    return y ^ ror32(x ^ y, 8);
    }
#[no_mangle]
unsafe extern "C" fn inv_mix_columns(x: u32) -> u32 {
...
//
    let mut y: u32 = mul_by_x2(x);
    return mix_columns(x ^ y ^ ror32(y, 16));
    }
#[no_mangle]
unsafe extern "C" fn subw(in: u32) -> u32 {
    ...
    {
    let mut kwords: u32 = key_len / sizeof(u32);
    u32 rc, i, j;
    for (i = 0; i < kwords; i++)
...
#[no_mangle]
unsafe extern "C" fn enc_quarterround(w[4]: u32, i: c_int, rk: u32) -> __always_inline u32 {
...
#[no_mangle]
unsafe extern "C" fn enclast_quarterround(w[4]: u32, i: c_int, rk: u32) -> __always_inline u32 {
...
//
    ...
    do {
    let mut w0: u32 = enc_quarterround(w, 0, *rkp++);
    let mut w1: u32 = enc_quarterround(w, 1, *rkp++);
    let mut w2: u32 = enc_quarterround(w, 2, *rkp++);
    let mut w3: u32 = enc_quarterround(w, 3, *rkp++);
    w[0] = w0;
    w[1] = w1;
    w[2] = w2;
    w[3] = w3;
...
#[no_mangle]
unsafe extern "C" fn dec_quarterround(w[4]: u32, i: c_int, rk: u32) -> __always_inline u32 {
...
#[no_mangle]
unsafe extern "C" fn declast_quarterround(w[4]: u32, i: c_int, rk: u32) -> __always_inline u32 {
    ...
    do {
    let mut w0: u32 = dec_quarterround(w, 0, *rkp++);
    let mut w1: u32 = dec_quarterround(w, 1, *rkp++);
    let mut w2: u32 = dec_quarterround(w, 2, *rkp++);
    let mut w3: u32 = dec_quarterround(w, 3, *rkp++);
    w[0] = w0;
    w[1] = w1;
    w[2] = w2;
    w[3] = w3;
...
// No arch-specific implementation of AES is available.  Use generic code.
    ...
    {
    aes_expandkey_generic(k.rndkeys, inv_k ? inv_k.inv_rndkeys : core::ptr::null_mut(),
    in_key, key_len);
    }
...
#[no_mangle]
pub unsafe extern "C" fn aes_preparekey(key: *mut aes_key, in_key: *const u8, key_len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aes_prepareenckey(key: *mut aes_enckey, in_key: *const u8, key_len: usize) -> c_int {
    int aes_prepareenckey(struct aes_enckey *key, const u8 *in_key, size_t key_len)
    {
    return __aes_preparekey(key, core::ptr::null_mut(), in_key, key_len);
    }
...
#[no_mangle]
unsafe extern "C" fn aes_fips_test() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn aes_cmac_update(ctx: *mut aes_cmac_ctx, data: *const u8, data_len: usize) {
    void aes_cmac_update(struct aes_cmac_ctx *ctx, const u8 *data, size_t data_len)
    {
    let mut enc_before: bool = false;
    size_t nblocks;
    if (ctx.partial_len) {
// XOR data into a pending block.
    let mut l: usize = min(data_len, AES_BLOCK_SIZE - ctx.partial_len);
...
#[no_mangle]
pub unsafe extern "C" fn aes_cmac_final(ctx: *mut aes_cmac_ctx, out[AES_BLOCK_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn aes_cbcmac_final(ctx: *mut aes_cbcmac_ctx, out[AES_BLOCK_SIZE]: u8) {
...
#[no_mangle]
unsafe extern "C" fn aes_cmac_fips_test() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn aes_cmac_fips_test() {
...
#[no_mangle]
pub unsafe extern "C" fn aes_ecb_encrypt(dst: *mut u8, src: *const u8, len: usize, key: aes_encrypt_arg) {
...
#[no_mangle]
unsafe extern "C" fn aes_ecb_fips_test() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn aes_ecb_fips_test() {
...
// Offset to P[n] and C[n] (last plaintext and ciphertext block)
    let mut pn_offset: usize = round_down(len - 1, AES_BLOCK_SIZE);
// Length of P[n] and C[n], 1 <= pn_len <= AES_BLOCK_SIZE
    let mut pn_len: usize = len - pn_offset;
...
#[no_mangle]
unsafe extern "C" fn aes_cbc_fips_test() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn aes_cbc_cts_fips_test() -> void __init {
    static void __init aes_cbc_cts_fips_test(void)
    {
    struct aes_key key;
    u8 iv[AES_BLOCK_SIZE];
    let mut data_len: usize = 2 * AES_BLOCK_SIZE;
...
#[no_mangle]
pub unsafe extern "C" fn aes_cbc_fips_test() {
    static inline void aes_cbc_fips_test(void)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn aes_cbc_cts_fips_test() {
...
#[no_mangle]
unsafe extern "C" fn inc_be128_ctr(ctr[AES_BLOCK_SIZE]: u8) -> __always_inline void {
...
// Counter is incremented even with just a partial block.
    ...
    {
    let mut iv0: __le64 = get_unaligned((const __le64 *)&iv[0]);
    __le64 aes_input[2];
    u8 keystream[AES_BLOCK_SIZE] __aligned(__alignof__(long));
...
#[no_mangle]
unsafe extern "C" fn aes_ctr_fips_test() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn aes_ctr_fips_test() {
...
// enc= */ false);
    ...
    let mut nocts_len: usize = round_down(len, AES_BLOCK_SIZE);
...
// Encrypt the last full block again.
    ...
    {
    size_t partial_len = len % AES_BLOCK_SIZE; /* Length of partial block */
    let mut nocts_len: usize = round_down(len, AES_BLOCK_SIZE) - AES_BLOCK_SIZE;
    union {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !cont) -> else {
    else if (!cont)
...
#[no_mangle]
unsafe extern "C" fn aes_xts_fips_test() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn aes_xts_fips_test() {
...
#[no_mangle]
pub unsafe extern "C" fn aes_gcm_auth_update(ctx: *mut aes_gcm_ctx, ad: *const u8, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn ghash_pad(ghash: *mut ghash_ctx, len: u64) -> __always_inline void {
...
#[no_mangle]
pub unsafe extern "C" fn aes_gcm_encrypt_final(ctx: *mut aes_gcm_ctx, authtag: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn aes_gcm_decrypt_final(ctx: *mut aes_gcm_ctx, authtag: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aes_gcm_fips_test() -> void __init {
    static void __init aes_gcm_fips_test(void)
    {
    let mut data_len: usize = sizeof(fips_test_data);
...
#[no_mangle]
pub unsafe extern "C" fn aes_gcm_fips_test() {
...
#[no_mangle]
pub unsafe extern "C" fn aes_ccm_auth_update(ctx: *mut aes_ccm_ctx, ad: *const u8, len: usize) {
    void aes_ccm_auth_update(struct aes_ccm_ctx *ctx, const u8 *ad, size_t len)
    {
    let mut partial_len: usize = ctx.partial_len;
    let mut enc_before: bool = false;
    size_t nblocks;
...
//
    ...
    if (partial_len) {
    let mut n: usize = min(len, AES_BLOCK_SIZE - partial_len);
...
#[no_mangle]
pub unsafe extern "C" fn aes_ccm_encrypt_final(ctx: *mut aes_ccm_ctx, authtag: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn aes_ccm_decrypt_final(ctx: *mut aes_ccm_ctx, authtag: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aes_ccm_fips_test() -> void __init {
    static void __init aes_ccm_fips_test(void)
    {
    let mut data_len: usize = sizeof(fips_test_data);
    let mut nonce_len: usize = 13;
    u8 buf[sizeof(fips_test_data) + AES_BLOCK_SIZE];
...
#[no_mangle]
pub unsafe extern "C" fn aes_ccm_fips_test() {
