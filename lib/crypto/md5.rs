...
#[no_mangle]
pub unsafe extern "C" fn md5_init(ctx: *mut md5_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn md5_update(ctx: *mut md5_ctx, data: *const u8, len: usize) {
    void md5_update(struct md5_ctx *ctx, const u8 *data, size_t len)
    {
    let mut partial: usize = ctx.bytecount % MD5_BLOCK_SIZE;
    ctx.bytecount += len;
    if (partial + len >= MD5_BLOCK_SIZE) {
    size_t nblocks;
    if (partial) {
    let mut l: usize = MD5_BLOCK_SIZE - partial;
...
#[no_mangle]
unsafe extern "C" fn __md5_final(ctx: *mut md5_ctx, out[MD5_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn md5_final(ctx: *mut md5_ctx, out[MD5_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn md5(data: *const u8, len: usize, out[MD5_DIGEST_SIZE]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn hmac_md5_init(ctx: *mut hmac_md5_ctx, key: *const hmac_md5_key) {
...
#[no_mangle]
pub unsafe extern "C" fn hmac_md5_final(ctx: *mut hmac_md5_ctx, out[MD5_DIGEST_SIZE]: u8) {
