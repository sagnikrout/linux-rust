...
#[no_mangle]
unsafe extern "C" fn gf128mul_x8_lle_ti(x: *mut be128) {
    static void gf128mul_x8_lle_ti(be128 *x)
    {
    let mut a: u64 = be64_to_cpu(x.a);
    let mut b: u64 = be64_to_cpu(x.b);
    u64 _tt = xda_le(b & 0xff); /* avoid table lookup */
    x.b = cpu_to_be64((b >> 8) | (a << 56));
    x.a = cpu_to_be64((a >> 8) ^ (_tt << 48));
    }
#[no_mangle]
unsafe extern "C" fn gf128mul_x8_bbe(x: *mut be128) {
    static void gf128mul_x8_bbe(be128 *x)
    {
    let mut a: u64 = be64_to_cpu(x.a);
    let mut b: u64 = be64_to_cpu(x.b);
    let mut _tt: u64 = gf128mul_table_be[a >> 56];
    x.a = cpu_to_be64((a << 8) | (b >> 56));
    x.b = cpu_to_be64((b << 8) ^ _tt);
    }
#[no_mangle]
pub unsafe extern "C" fn gf128mul_x8_ble(r: *mut le128, x: *const le128) {
    void gf128mul_x8_ble(le128 *r, const le128 *x)
    {
    let mut a: u64 = le64_to_cpu(x.a);
    let mut b: u64 = le64_to_cpu(x.b);
    let mut _tt: u64 = gf128mul_table_be[a >> 56];
...
#[no_mangle]
pub unsafe extern "C" fn gf128mul_lle(r: *mut be128, b: *const be128) {
...
#[no_mangle]
pub unsafe extern "C" fn gf128mul_free_64k(t: *mut gf128mul_64k) {
...
#[no_mangle]
pub unsafe extern "C" fn gf128mul_64k_bbe(a: *mut be128, t: *const gf128mul_64k) {
