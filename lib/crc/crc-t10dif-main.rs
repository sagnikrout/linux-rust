...
//! Source: lib/crc/crc-t10dif-main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn crc_t10dif_update(crc: u16, p: *const u8, len: usize) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn crc_t10dif_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn crc_t10dif_mod_exit() -> void __exit {
