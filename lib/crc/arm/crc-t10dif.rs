...
//! Source: lib/crc/arm/crc-t10dif.h
#![no_std]
...
extern "C" {
    pub fn crc_t10dif_pmull64(init_crc: u16, buf: *const u8, len: usize) -> asmlinkage u16;
}
extern "C" {
    pub fn crc_t10dif_pmull64(_arg: crc, _arg: data, _arg: length) -> return;
}
extern "C" {
