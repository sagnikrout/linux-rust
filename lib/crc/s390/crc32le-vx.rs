...
//! Source: lib/crc/s390/crc32le-vx.c
#![no_std]
...
pub const CONST_PERM_LE2BE: c_int = 9;
pub const CONST_R2R1: c_int = 10;
pub const CONST_R4R3: c_int = 11;
pub const CONST_R5: c_int = 12;
pub const CONST_RU_POLY: c_int = 13;
pub const CONST_CRC_POLY: c_int = 14;
//
...
//
#[no_mangle]
unsafe extern "C" fn crc32_le_vgfm_generic(crc: u32, buf: *const c_uchar, size: usize, constants: *mut c_ulong) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn crc32_le_vgfm_16(crc: u32, buf: *const c_uchar, size: usize) -> u32 {
    u32 crc32_le_vgfm_16(u32 crc, unsigned char const *buf, size_t size)
    {
    return crc32_le_vgfm_generic(crc, buf, size, &constants_CRC_32_LE[0]);
    }
#[no_mangle]
pub unsafe extern "C" fn crc32c_le_vgfm_16(crc: u32, buf: *const c_uchar, size: usize) -> u32 {
