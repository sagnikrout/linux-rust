...
//! Source: lib/crc/s390/crc32be-vx.c
#![no_std]
...
pub const CONST_R1R2: c_int = 9;
pub const CONST_R3R4: c_int = 10;
pub const CONST_R5: c_int = 11;
pub const CONST_R6: c_int = 12;
...
//
#[no_mangle]
pub unsafe extern "C" fn crc32_be_vgfm_16(crc: u32, buf: *const c_uchar, size: usize) -> u32 {
