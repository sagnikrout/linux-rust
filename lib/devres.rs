...
#[no_mangle]
pub unsafe extern "C" fn devm_ioremap_release(dev: *mut device, res: *mut c_void) {
    void devm_ioremap_release(struct device *dev, void *res)
    {
    iounmap(*(void __iomem **)res);
    }
#[no_mangle]
unsafe extern "C" fn devm_ioremap_match(dev: *mut device, res: *mut c_void, match_data: *mut c_void) -> c_int {
    ...
    {
    void __iomem **ptr, *addr = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_iounmap(dev: *mut device, addr: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn devm_ioport_map_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_ioport_unmap(dev: *mut device, addr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn devm_arch_phys_ac_add_release(dev: *mut device, res: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arch_io_reserve_memtype_wc_devres {
    pub start: resource_size_t,
    pub size: resource_size_t,
}

#[no_mangle]
unsafe extern "C" fn devm_arch_io_free_memtype_wc_release(dev: *mut device, res: *mut c_void) {
