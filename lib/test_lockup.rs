...
//
    ...
    let mut iterations: static unsigned int = 1;
    ...
    let mut lock_wait_threshold: static unsigned long = ULONG_MAX;
    ...
    let mut alloc_pages_gfp: static gfp_t = GFP_KERNEL;
    ...
    let mut alloc_pages_failed: static atomic_t = ATOMIC_INIT(0);
    let mut max_lock_wait: static atomic64_t = ATOMIC64_INIT(0);
    static struct task_struct *main_task;
    static int master_cpu;
#[no_mangle]
unsafe extern "C" fn test_lock(master: bool, verbose: bool) {
    ...
    if (measure_lock_wait) {
    let mut cur_wait: i64 = local_clock() - wait_start;
    let mut max_wait: i64 = atomic64_read(&max_lock_wait);
    do {
...
#[no_mangle]
unsafe extern "C" fn test_unlock(master: bool, verbose: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_alloc_pages(pages: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn test_free_pages(pages: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn test_wait(secs: c_uint, nsecs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn test_lockup(master: bool) {
    static void test_lockup(bool master)
    {
    let mut lockup_start: u64 = local_clock();
...
#[no_mangle]
unsafe extern "C" fn test_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn test_kernel_ptr(addr: c_ulong, size: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_lockup_init() -> int __init {
    static int __init test_lockup_init(void)
    {
    let mut test_start: u64 = local_clock();
    main_task = current;
    switch (state[0]) {
    case 'S':
