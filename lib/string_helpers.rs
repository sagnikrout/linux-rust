...
//
    ...
    char *buf, int len)
    {
    let mut units_base: enum string_size_units = units & STRING_UNITS_MASK;
    ...
    let mut i: c_int = 0, j;
    let mut remainder: u32 = 0, sf_cap;
    char tmp[12];
    const char *unit;
    tmp[0] = '\0';
    if (blk_size == 0)
...
#[no_mangle]
pub unsafe extern "C" fn parse_int_array(buf: *const c_char, count: usize, array: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn parse_int_array_user(from: *const char __user, count: usize, array: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unescape_space(src: *mut c_char, dst: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unescape_octal(src: *mut c_char, dst: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unescape_hex(src: *mut c_char, dst: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unescape_special(src: *mut c_char, dst: *mut c_char) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn string_unescape(src: *mut c_char, dst: *mut c_char, size: usize, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn escape_passthrough(c: c_uchar, dst: *mut c_char, end: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn escape_space(c: c_uchar, dst: *mut c_char, end: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn escape_special(c: c_uchar, dst: *mut c_char, end: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn escape_null(c: c_uchar, dst: *mut c_char, end: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn escape_octal(c: c_uchar, dst: *mut c_char, end: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn escape_hex(c: c_uchar, dst: *mut c_char, end: *mut c_char) -> bool {
...
//
    ...
    char *p = dst;
    char *end = p + osz;
    let mut is_dict: bool = only && *only;
    let mut is_append: bool = flags & ESCAPE_APPEND;
    while (isz--) {
    let mut c: c_uchar = *src++;
    let mut in_dict: bool = is_dict && strchr(only, c);
//
...
//
    ...
    size_t slen, dlen;
    char *dst;
    let mut flags: c_int = ESCAPE_HEX;
    const char esc[] = "\f\n\r\t\v\a\e\\\"";
    if (!src)
    return core::ptr::null_mut();
    slen = strlen(src);
    dlen = string_escape_mem(src, slen, core::ptr::null_mut(), 0, flags, esc);
...
//
#[no_mangle]
pub unsafe extern "C" fn kfree_strarray(array: *mut c_char, n: usize) {
...
#[derive(Copy, Clone)]
pub struct strarray {
    pub __counted_by_ptr(n): *mut *mut *mut char array,
    pub n: usize,
}

#[no_mangle]
unsafe extern "C" fn devm_kfree_strarray(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sysfs_streq(s1: *const c_char, s2: *const c_char) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn match_string(array: *const *const c_char, n: usize, string: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __sysfs_match_string(array: *const *const c_char, n: usize, str: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __fortify_report(reason: u8, avail: usize, size: usize) {
    void __fortify_report(const u8 reason, const size_t avail, const size_t size)
    {
    let mut func: u8 = FORTIFY_REASON_FUNC(reason);
    let mut write: bool = FORTIFY_REASON_DIR(reason);
    const char *name;
...
#[no_mangle]
pub unsafe extern "C" fn __fortify_panic(reason: u8, avail: usize, size: usize) {
