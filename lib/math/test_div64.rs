...
pub const TEST_DIV64_N_ITER: c_int = 1024;
...
pub const TEST_DIV64_DIVISOR_0: c_uint = 0x00000009;
pub const TEST_DIV64_DIVISOR_1: c_uint = 0x0000007c;
pub const TEST_DIV64_DIVISOR_2: c_uint = 0x00000204;
pub const TEST_DIV64_DIVISOR_3: c_uint = 0x0000cb5b;
pub const TEST_DIV64_DIVISOR_4: c_uint = 0x00010000;
pub const TEST_DIV64_DIVISOR_5: c_uint = 0x0008a880;
pub const TEST_DIV64_DIVISOR_6: c_uint = 0x003fd3ae;
pub const TEST_DIV64_DIVISOR_7: c_uint = 0x0b658fac;
pub const TEST_DIV64_DIVISOR_8: c_uint = 0x80000001;
pub const TEST_DIV64_DIVISOR_9: c_uint = 0xdc08b349;
pub const TEST_DIV64_DIVISOR_A: c_uint = 0xfffffffe;
pub const TEST_DIV64_DIVISOR_B: c_uint = 0xffffffff;
...
#[no_mangle]
pub unsafe extern "C" fn test_div64_verify(quotient: u64, remainder: u32, i: c_int, j: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn test_div64() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn test_div64_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_div64_exit() -> void __exit {
