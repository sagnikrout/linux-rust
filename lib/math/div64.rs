...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(n: *mut (weak)) __div64_32(uint64_t, base: u32) -> u32 {
    uint32_t __attribute__((weak)) __div64_32(uint64_t *n, uint32_t base)
    {
    let mut rem: u64 = *n;
    let mut b: u64 = base;
    uint64_t res, d = 1;
    let mut high: u32 = rem >> 32;
...
#[no_mangle]
pub unsafe extern "C" fn mul_u64_u64_add_u64(p_lo: *mut u64, a: u64, b: u64, c: u64) -> u64 {
    static inline u64 mul_u64_u64_add_u64(u64 *p_lo, u64 a, u64 b, u64 c)
    {
// native 64x64=128 bits multiplication
    let mut prod: u128 = (u128)a * b + c;
// p_lo = prod;
    return prod >> 64;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mul_u64_long_add_u64(p_lo: *mut u64, a: u64, b: u32, c: u64) -> u32 {
    static inline u32 mul_u64_long_add_u64(u64 *p_lo, u64 a, u32 b, u64 c)
    {
    let mut n_lo: u64 = mul_add(a, b, c);
    let mut n_med: u64 = mul_add(a >> 32, b, c >> 32);
