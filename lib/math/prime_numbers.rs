...
//! Source: lib/math/prime_numbers.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn with_primes(ctx: *mut c_void, fn: primes_fn) {
...
#[no_mangle]
pub unsafe extern "C" fn slow_is_prime_number(x: c_ulong) -> bool {
    bool slow_is_prime_number(unsigned long x)
    {
    let mut y: c_ulong = int_sqrt(x);
    while (y > 1) {
    if ((x % y) == 0)
    break;
    y--;
...
#[no_mangle]
unsafe extern "C" fn slow_next_prime_number(x: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn expand_to_next_prime(x: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn free_primes() {
...
//
#[no_mangle]
pub unsafe extern "C" fn next_prime_number(x: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_prime_number(x: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn primes_exit() -> void __exit {
