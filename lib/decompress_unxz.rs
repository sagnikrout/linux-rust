...
//
pub const XZ_INTERNAL_CRC32: c_int = 1;
//
...
#[no_mangle]
unsafe extern "C" fn memeq(a: *const c_void, b: *const c_void, size: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn memzero(buf: *mut c_void, size: usize) {
...
pub const XZ_IOBUF_SIZE: c_int = 4096;
//
...
//
    ...
    struct xz_dec *s;
    enum xz_ret ret;
    let mut must_free_in: bool = false;

    xz_crc32_init();

    if (in_used != core::ptr::null_mut())
// in_used = 0;
    ...
    do {
    if (b.in_pos == b.in_size && fill != core::ptr::null_mut()) {
    if (in_used != core::ptr::null_mut())
// in_used += b.in_pos;
    b.in_pos = 0;
...
//
    ...
    ret = xz_dec_run(s, &b);
    if (flush != core::ptr::null_mut() && (b.out_pos == b.out_size
