...
#[no_mangle]
unsafe extern "C" fn zs_stat_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn zs_stat_exit() -> void __exit {
...
unsafe extern "C" fn zs_stats_size_show(s: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    let mut total_objs: c_ulong = 0, total_used_objs = 0, total_pages = 0;
    let mut total_freeable: c_ulong = 0;
...
unsafe extern "C" fn remove_zspage(class: *mut size_class, zspage: *mut zspage) {
    ...
    {
    let mut fullness: c_int = zspage.fullness;
...
//
    ...
    struct zpdesc *prev_zpdesc = core::ptr::null_mut();
    let mut nr_zpdescs: c_int = class.pages_per_zspage;
//
...
pub unsafe extern "C" fn zs_free(pool: *mut zs_pool, handle: c_ulong) {
    ...
    struct size_class *class;
    int fullness;
    struct zspage *zspage_to_free = core::ptr::null_mut();
...
unsafe extern "C" fn zs_can_compact(class: *mut size_class) -> c_ulong {
    ...
    let mut obj_allocated: c_ulong = class_stat_read(class, ZS_OBJS_ALLOCATED);
    let mut obj_used: c_ulong = class_stat_read(class, ZS_OBJS_INUSE);
    ...
    struct size_class *class)
    {
    struct zspage *src_zspage = core::ptr::null_mut();
    struct zspage *dst_zspage = core::ptr::null_mut();
    let mut pages_freed: c_ulong = 0;
//
...
//
    ...
    int i;
    struct size_class *class;
    let mut pages_to_free: c_ulong = 0;
    struct zs_pool *pool = shrinker.private_data;
    for (i = ZS_SIZE_CLASSES - 1; i >= 0; i--) {
    class = pool.size_class[i];
    if (class.index != i)
...
//
    ...
    int i;
    struct zs_pool *pool;
    struct size_class *prev_class = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn zs_init_caches() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn zs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn zs_exit() -> void __exit {
