...
//
#[no_mangle]
pub unsafe extern "C" fn copy_from_user_nofault(dst: *mut c_void, src: *const c_void , size: usize) -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn copy_to_user_nofault(dst: *mut c_void , src: *const c_void, size: usize) -> c_long {
pub static mut ret: c_long = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn strncpy_from_user_nofault(dst: *mut c_char, unsafe_addr: *mut c_void, count: c_long) -> c_long {
    let mut ret = 0;
    if (unlikely(count <= 0)) {
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn strnlen_user_nofault(unsafe_addr: *const c_void , count: c_long) -> c_long {
    let mut ret = 0;
    pagefault_disable();
