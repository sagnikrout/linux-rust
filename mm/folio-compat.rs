...
#[no_mangle]
pub unsafe extern "C" fn redirty_page_for_writepage(wbc: *mut writeback_control, page: *mut page) -> bool {
    return folio_redirty_for_writepage(wbc, page_folio(page));
    }
    EXPORT_SYMBOL(redirty_page_for_writepage);
#[no_mangle]
pub unsafe extern "C" fn add_to_page_cache_lru(page: *mut page, mapping: *mut address_space, index: pgoff_t, gfp: gfp_t) -> c_int {
    return filemap_add_folio(mapping, page_folio(page), index, gfp);
    }
    EXPORT_SYMBOL(add_to_page_cache_lru);
    noinline
#[no_mangle]
pub unsafe extern "C" fn pagecache_get_page(mapping: *mut address_space, index: pgoff_t, fgp_flags: fgf_t, gfp: gfp_t) -> *mut c_void {
