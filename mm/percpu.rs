...
//
pub const PCPU_SLOT_BASE_SHIFT: c_int = 5;
// chunks in slots below this are subject to being sidelined on failed alloc
pub const PCPU_SLOT_FAIL_THRESHOLD: c_int = 3;
pub const PCPU_EMPTY_POP_PAGES_LOW: c_int = 2;
pub const PCPU_EMPTY_POP_PAGES_HIGH: c_int = 4;
...
// first chunk is free to use
    chunk.obj_exts = core::ptr::null_mut();
...
//
    ...
    pcpu_memcg_post_alloc_hook(objcg, core::ptr::null_mut(), 0, size);
    return core::ptr::null_mut();
    }
    }
...
// Macro flag: #define BUILD_EMBED_FIRST_CHUNK

// build pcpu_page_first_chunk() iff needed by the arch config

// Macro flag: #define BUILD_PAGE_FIRST_CHUNK
