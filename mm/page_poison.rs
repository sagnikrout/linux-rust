...
// SPDX-License-Identifier: GPL-2.0
    ...
    let mut _page_poisoning_enabled_early = 0;
    EXPORT_SYMBOL(_page_poisoning_enabled_early);
pub static mut _page_poisoning_enabled: usize = 0;
    EXPORT_SYMBOL(_page_poisoning_enabled);
#[no_mangle]
unsafe extern "C" fn early_page_poison_param(buf: *mut c_char) -> c_int {
