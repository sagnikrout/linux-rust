...
//
    ...
    {
    phys_addr_t ret;
    let mut flags: enum memblock_flags = choose_memblock_flags();
    again:
...
#[no_mangle]
unsafe extern "C" fn memblock_remove_region(type: *mut memblock_type, r: c_ulong) -> void __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_discard() -> void __init {
...
//
    ...
    let mut use_slab: c_int = slab_is_available();
    int *in_slab;
...
//
    ...
    let mut obase: phys_addr_t = base;
    let mut end: phys_addr_t = base + memblock_cap_size(base, &size);
...
//
    ...
    let mut rbase: phys_addr_t = rgn.base;
    let mut rend: phys_addr_t = rbase + rgn.size;
    if (rbase >= end)
    break;
    if (rend <= base)
    continue;
...
//
    ...
    int nid, enum memblock_flags flags)
    {
    let mut end: phys_addr_t = base + size - 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_add(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
#[no_mangle]
pub unsafe extern "C" fn memblock_remove(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_free(ptr: *mut c_void, size: usize) -> void __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_phys_free(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
#[no_mangle]
pub unsafe extern "C" fn memblock_physmem_add(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_mark_hotplug(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_clear_hotplug(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_mark_mirror(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_mark_nomap(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_clear_nomap(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_reserved_mark_noinit(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_reserved_mark_kern(base: phys_addr_t, size: phys_addr_t) -> int __init_memblock {
...
pub unsafe extern "C" fn memblock_clear_kho_scratch(base: phys_addr_t, size: phys_addr_t) -> __init int {
    ...
    int nid, int flags)
    {
    let mut m_nid: c_int = memblock_get_region_node(m);
...
//
    ...
    {
    let mut idx_a: c_int = *idx & 0xffffffff;
    let mut idx_b: c_int = *idx >> 32;
    for (; idx_a < type_a.cnt; idx_a++) {
    struct memblock_region *m = &type_a.regions[idx_a];
    let mut m_start: phys_addr_t = m.base;
    let mut m_end: phys_addr_t = m.base + m.size;
    let mut m_nid: c_int = memblock_get_region_node(m);
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_alloc_hugetlb(size: phys_addr_t, nid: c_int, exact_nid: bool) -> *mut void  __init {
...
pub unsafe extern "C" fn memblock_reserved_hugetlb_size(limit: phys_addr_t, nid: c_int) -> phys_addr_t __init_memblock {
    ...
    {
    struct memblock_region *r;
    let mut total: phys_addr_t = 0;
    for_each_reserved_mem_region(r) {
    let mut size: phys_addr_t = r.size;
    if (r.base > limit)
    break;
...
pub unsafe extern "C" fn memblock_end_of_DRAM() -> phys_addr_t __init_memblock {
    ...
    {
    let mut idx: c_int = memblock.memory.cnt - 1;
...
unsafe extern "C" fn __find_max_addr(limit: phys_addr_t) -> phys_addr_t __init_memblock {
    ...
    {
    let mut max_addr: phys_addr_t = PHYS_ADDR_MAX;
    struct memblock_region *r;
//
...
#[no_mangle]
pub unsafe extern "C" fn memblock_enforce_memory_limit(limit: phys_addr_t) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn memblock_cap_memory_range(base: phys_addr_t, size: phys_addr_t) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn memblock_mem_limit_remove_map(limit: phys_addr_t) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn memblock_search(type: *mut memblock_type, addr: phys_addr_t) -> int __init_memblock {
    static int __init_memblock memblock_search(struct memblock_type *type, phys_addr_t addr)
    {
    let mut left: c_uint = 0, right = type.cnt;
    do {
    let mut mid: c_uint = (right + left) / 2;
...
pub unsafe extern "C" fn memblock_is_map_memory(addr: phys_addr_t) -> bool __init_memblock {
    ...
    {
    let mut i: c_int = memblock_search(&memblock.memory, addr);
    if (i == -1)
    return false;
    ...
    {
    struct memblock_type *type = &memblock.memory;
    let mut mid: c_int = memblock_search(type, PFN_PHYS(pfn));
    if (mid == -1)
    return NUMA_NO_NODE;
...
pub unsafe extern "C" fn memblock_is_region_memory(base: phys_addr_t, size: phys_addr_t) -> bool __init_memblock {
    ...
    {
    let mut idx: c_int = memblock_search(&memblock.memory, base);
    let mut end: phys_addr_t = base + memblock_cap_size(base, &size);
    if (idx == -1)
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn memblock_trim_memory(align: phys_addr_t) -> void __init_memblock {
...
#[no_mangle]
pub unsafe extern "C" fn memblock_set_current_limit(limit: phys_addr_t) -> void __init_memblock {
...
#[no_mangle]
unsafe extern "C" fn memblock_dump(type: *mut memblock_type) -> void __init_memblock {
...
#[no_mangle]
unsafe extern "C" fn __memblock_dump_all() -> void __init_memblock {
...
#[no_mangle]
pub unsafe extern "C" fn memblock_dump_all() -> void __init_memblock {
...
#[no_mangle]
pub unsafe extern "C" fn memblock_allow_resize() -> void __init {
    void __init memblock_allow_resize(void)
    {
    memblock_can_resize = 1;
    }
#[no_mangle]
unsafe extern "C" fn early_memblock(p: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn free_memmap(start_pfn: c_ulong, end_pfn: c_ulong) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn free_unused_memmap() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __free_pages_memory(start: c_ulong, end: c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn memmap_init_reserved_pages() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn reset_node_managed_pages(pgdat: *mut pg_data_t) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn reset_all_zones_managed_pages() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn memblock_free_all() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn reserved_mem_preserve() -> int __init {
    static int __init reserved_mem_preserve(void)
    {
    let mut nr_preserved: c_uint = 0;
    int err;
    for (unsigned int i = 0; i < reserved_mem_count; i++, nr_preserved++) {
    struct reserve_mem_table *map = &reserved_mem_table[i];
    struct page *page = phys_to_page(map.start);
    let mut nr_pages: c_uint = map.size >> PAGE_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn prepare_kho_fdt() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn reserve_mem_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn reserve_mem_kho_retrieve_fdt() -> *mut void __init {
...
//
#[no_mangle]
unsafe extern "C" fn reserve_mem(p: *mut c_char) -> int __init {
...
unsafe extern "C" fn memblock_debug_show(m: *mut seq_file, private: *mut c_void) -> c_int {
    ...
    int i, j, nid;
    let mut count: c_uint = ARRAY_SIZE(flagname);
    phys_addr_t end;
    for (i = 0; i < type.cnt; i++) {
    reg = &type.regions[i];
...
#[no_mangle]
unsafe extern "C" fn memblock_init_debugfs() -> int __init {
