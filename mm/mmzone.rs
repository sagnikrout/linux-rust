...
#[no_mangle]
pub unsafe extern "C" fn first_online_pgdat() -> *mut c_void {
    return NODE_DATA(first_online_node);
    }
#[no_mangle]
pub unsafe extern "C" fn next_online_pgdat(pgdat: *mut pglist_data) -> *mut c_void {
...
//
#[no_mangle]
pub unsafe extern "C" fn next_zone(zone: *mut zone) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn zref_in_nodemask(zref: *mut zoneref, nodes: *mut nodemask_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __next_zones_zonelist(z: *mut zoneref, highest_zoneidx: zone_type, nodes: *mut nodemask_t) -> *mut c_void {
//
