...
unsafe extern "C" fn check_stack_object(obj: *const c_void, len: c_ulong) -> noinline int {
    ...
    {
    let mut stack: *const void  const = task_stack_page(current);
    let mut stackend: *const void  const = stack + THREAD_SIZE;
    int ret;
...
// Returns true if any portion of [ptr,ptr+n) over laps with [low,high).
    ...
    {
    let mut check_low: c_ulong = ptr;
    let mut check_high: c_ulong = check_low + n;
...
// Is this address range in the kernel text area?
    ...
    {
    let mut textlow: c_ulong = (unsigned long)_stext;
    let mut texthigh: c_ulong = (unsigned long)_etext;
...
#[no_mangle]
unsafe extern "C" fn parse_hardened_usercopy(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_hardened_usercopy() -> int __init {
