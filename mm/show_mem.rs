...
pub unsafe extern "C" fn si_meminfo_node(val: *mut sysinfo, nid: c_int) {
    ...
    let mut managed_pages: c_ulong = 0;
    let mut managed_highpages: c_ulong = 0;
    let mut free_highpages: c_ulong = 0;
...
//
    ...
    int max_zone_idx)
    {
    let mut total: c_ulong = 0, reserved = 0, highmem = 0;
    struct zone *zone;
    printk("Mem-Info:\n");
