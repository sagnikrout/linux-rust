...
//
    ...
    vma.vm_file,
    vma.vm_ops ? vma.vm_ops.fault : core::ptr::null_mut(),
    vma.vm_file ? vma.vm_file.f_op.mmap : core::ptr::null_mut(),
    vma.vm_file ? vma.vm_file.f_op.mmap_prepare : core::ptr::null_mut(),
    mapping ? mapping.a_ops.read_folio : core::ptr::null_mut());
    dump_stack();
...
//
    ...
    (vmf.address & PAGE_MASK) + PAGE_SIZE, core::ptr::null_mut());
    mmu_notifier_invalidate_range_start(&range);
...
// ksm created a completely new copy
    ...
    folio_put_swap(swapcache, core::ptr::null_mut());
...
//
    ...
    rmap_flags);
    folio_put_swap(folio, nr_pages == 1 ? page : core::ptr::null_mut());
    }
    VM_BUG_ON(!folio_test_anon(folio) ||
...
//
    ...
    vmf.prealloc_pte = core::ptr::null_mut();
    }
#[no_mangle]
...
//
pub const FOLIO_ZERO_LOCALITY_RADIUS: c_int = 2;
//
