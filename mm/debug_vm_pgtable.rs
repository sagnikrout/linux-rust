...
#[no_mangle]
unsafe extern "C" fn pte_basic_tests(args: *mut pgtable_debug_args, idx: c_int) -> void __init {
    static void __init pte_basic_tests(struct pgtable_debug_args *args, int idx)
    {
    let mut prot: pgprot_t = vm_get_page_prot(idx);
    let mut pte: pte_t = pfn_pte(args.fixed_pte_pfn, prot);
    let mut val: c_ulong = idx, *ptr = &val;
...
#[no_mangle]
unsafe extern "C" fn pte_advanced_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmd_basic_tests(args: *mut pgtable_debug_args, idx: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmd_advanced_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init pmd_advanced_tests(struct pgtable_debug_args *args)
    {
    struct page *page;
    pmd_t pmd;
    let mut vaddr: c_ulong = args.vaddr;
    if (!has_transparent_hugepage())
    return;
...
#[no_mangle]
unsafe extern "C" fn pmd_leaf_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pud_basic_tests(args: *mut pgtable_debug_args, idx: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pud_advanced_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pud_leaf_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmd_huge_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pud_huge_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn p4d_basic_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pgd_basic_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pud_clear_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init pud_clear_tests(struct pgtable_debug_args *args)
    {
    let mut pud: pud_t = pudp_get(args.pudp);
    if (mm_pmd_folded(args.mm))
    return;
...
#[no_mangle]
unsafe extern "C" fn pud_populate_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn p4d_clear_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init p4d_clear_tests(struct pgtable_debug_args *args)
    {
    let mut p4d: p4d_t = p4dp_get(args.p4dp);
...
#[no_mangle]
unsafe extern "C" fn p4d_populate_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pgd_clear_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init pgd_clear_tests(struct pgtable_debug_args *args)
    {
    let mut pgd: pgd_t = pgdp_get(args.pgdp);
...
#[no_mangle]
unsafe extern "C" fn pgd_populate_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pte_clear_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init pte_clear_tests(struct pgtable_debug_args *args)
    {
    struct page *page;
    let mut pte: pte_t = pfn_pte(args.pte_pfn, args.page_prot);
    page = (args.pte_pfn != ULONG_MAX) ? pfn_to_page(args.pte_pfn) : core::ptr::null_mut();
    if (!page)
    return;
//
...
#[no_mangle]
unsafe extern "C" fn pmd_clear_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init pmd_clear_tests(struct pgtable_debug_args *args)
    {
    let mut pmd: pmd_t = pmdp_get(args.pmdp);
...
#[no_mangle]
unsafe extern "C" fn pmd_populate_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pte_special_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init pte_special_tests(struct pgtable_debug_args *args)
    {
    let mut pte: pte_t = pfn_pte(args.fixed_pte_pfn, args.page_prot);
...
#[no_mangle]
unsafe extern "C" fn pte_protnone_tests(args: *mut pgtable_debug_args) -> void __init {
    static void __init pte_protnone_tests(struct pgtable_debug_args *args)
    {
    let mut pte: pte_t = pfn_pte(args.fixed_pte_pfn, args.page_prot_none);
...
#[no_mangle]
unsafe extern "C" fn pmd_protnone_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pte_soft_dirty_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pte_swap_soft_dirty_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmd_soft_dirty_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmd_leaf_soft_dirty_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pte_swap_exclusive_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pte_swap_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmd_softleaf_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn swap_migration_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hugetlb_basic_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmd_thp_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pud_thp_tests(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn destroy_args(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_fixed_pfns(args: *mut pgtable_debug_args) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_args(args: *mut pgtable_debug_args) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn debug_vm_pgtable() -> int __init {
