...
pub static mut kasan_flag_stacktrace: usize = 0;
// Non-zero, as initial pointer values are 0.

pub static mut kasan_stack_ring: usize = 0;
// kasan.stacktrace=off/on
#[no_mangle]
unsafe extern "C" fn early_kasan_flag_stacktrace(arg: *mut c_char) -> c_int {
    if (!arg) {
    return -EINVAL;
    }
    if (!strcmp(arg, "off")) {
...
#[no_mangle]
unsafe extern "C" fn early_kasan_flag_stack_ring_size(arg: *mut c_char) -> c_int {
    if (!arg) {
    return -EINVAL;
    }
...
#[no_mangle]
pub unsafe extern "C" fn kasan_init_tags()  {
...
#[no_mangle]
pub unsafe extern "C" fn save_stack_info(cache: *mut kmem_cache, object: *mut c_void, gfp_flags: gfp_t, is_free: bool) {
    let mut flags = 0;
