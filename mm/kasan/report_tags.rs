...
extern "C" { pub static mut stack_ring: usize; }
    static const char *get_common_bug_type(kasan_report_info *info)
    {
//
...
pub static mut alloc_found: bool = false;
