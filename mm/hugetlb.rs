...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hugetlb_cmdline {
    pub val: *mut c_char,
    pub val): *mut *mut int (setup)(char,
}
...
//
    vma_lock.vma = core::ptr::null_mut();
...
//
    ...
    nrg.reservation_counter = core::ptr::null_mut();
    nrg.css = core::ptr::null_mut();
    }
...
unsafe extern "C" fn get_vma_private_data(vma: *mut vm_area_struct) -> c_ulong {
    ...
    resv_map.css = core::ptr::null_mut();
    } else {
...
//
    resv_map_set_hugetlb_cgroup_uncharge_info(resv_map, core::ptr::null_mut(), core::ptr::null_mut());
...
//
    ...
    folio_change_private(folio, core::ptr::null_mut());
//
...
pub unsafe extern "C" fn init_new_hugetlb_folio(folio: *mut folio) {
    ...
    INIT_LIST_HEAD(&folio.lru);
    hugetlb_set_folio_subpool(folio, core::ptr::null_mut());
    set_hugetlb_cgroup(folio, core::ptr::null_mut());
    set_hugetlb_cgroup_rsvd(folio, core::ptr::null_mut());
    }
//
