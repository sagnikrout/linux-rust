...
//
    let mut vmpressure_win: c_ulong = SWAP_CLUSTER_MAX * 16;
//
...
//
    let mut vmpressure_level_med: static unsigned int = 60;
    let mut vmpressure_level_critical: static unsigned int = 95;
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn if(vmpressure_level_med: pressure >=) -> else {
    ...
    {
    let mut scale: c_ulong = scanned + reclaimed;
    let mut pressure: c_ulong = 0;
//
