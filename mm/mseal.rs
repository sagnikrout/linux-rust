...
pub static mut prev_end: c_ulong = 0;
...
// We know there are no gaps so this will be non-NULL.
    ...
    for_each_vma_range(vmi, vma, end) {
pub static mut curr_start: c_ulong = 0;
pub static mut curr_end: c_ulong = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn sys_mseal(start: usize, len: usize, flags: usize) -> c_long {
    let mut len_aligned = 0;
    let mut end = 0;
