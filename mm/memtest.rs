...
#[no_mangle]
unsafe extern "C" fn reserve_bad_mem(pattern: u64, start_bad: phys_addr_t, end_bad: phys_addr_t)  {
...
#[no_mangle]
unsafe extern "C" fn memtest(pattern: u64, start_phys: phys_addr_t, size: phys_addr_t)  {
    let mut p = core::ptr::null_mut();
    let mut start = core::ptr::null_mut();
    let mut end = core::ptr::null_mut();
    phys_addr_t start_bad, last_bad;
    let mut start_phys_aligned;
pub static mut incr: usize = 0;
...
#[no_mangle]
unsafe extern "C" fn do_one_pass(pattern: u64, start: phys_addr_t, end: phys_addr_t)  {
    let mut i = 0;
...
#[no_mangle]
unsafe extern "C" fn parse_memtest(arg: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn early_memtest(start: phys_addr_t, end: phys_addr_t)  {
    let mut i = 0;
...
pub unsafe extern "C" fn memtest_report_meminfo(m: *mut seq_file) {
    let mut early_memtest_bad_size_kb = 0;
