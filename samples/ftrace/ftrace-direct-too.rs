...
//! Source: samples/ftrace/ftrace-direct-too.c
#![no_std]
...
pub const STACK_FRAME_SIZE: c_int = 64;
pub const STACK_FRAME_ARG1: c_int = 32;
pub const STACK_FRAME_ARG2: c_int = 40;
pub const STACK_FRAME_ARG3: c_int = 48;
pub const STACK_FRAME_ARG4: c_int = 56;

pub const STACK_FRAME_SIZE: c_int = 32;
pub const STACK_FRAME_ARG1: c_int = 16;
pub const STACK_FRAME_ARG2: c_int = 20;
pub const STACK_FRAME_ARG3: c_int = 24;
pub const STACK_FRAME_ARG4: c_int = 28;
