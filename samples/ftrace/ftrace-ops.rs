...
//! Source: samples/ftrace/ftrace-ops.c
#![no_std]
...
//
    let mut nr_function_calls: static unsigned int = 100000;
...
//
    let mut nr_ops_relevant: static unsigned int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn tracee_relevant() -> noinline void {
...
//
#[no_mangle]
unsafe extern "C" fn tracee_irrelevant() -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn ops_destroy(ops: *mut sample_ops, nr: c_int) {
    ...
    let mut tracer_relevant: static ftrace_func_t = ops_func_nop;
    let mut tracer_irrelevant: static ftrace_func_t = ops_func_nop;
#[no_mangle]
unsafe extern "C" fn ftrace_ops_sample_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ftrace_ops_sample_exit() -> void __exit {
