...
//! Source: samples/v4l/v4l2-pci-skeleton.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn skeleton_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_FIELD_TOP: skel->field ==) -> else {
...
unsafe extern "C" fn buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut size: c_ulong = skel.format.sizeimage;
...
#[no_mangle]
unsafe extern "C" fn skeleton_s_std(file: *mut file, priv: *mut c_void, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skeleton_g_std(file: *mut file, priv: *mut c_void, std: *mut v4l2_std_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn skeleton_querystd(file: *mut file, priv: *mut c_void, std: *mut v4l2_std_id) -> c_int {
...
// S_DV_TIMINGS is not supported on the S-Video input
    ...
    return -ENODATA;
// Quick sanity check
    if (!v4l2_valid_dv_timings(timings, &skel_timings_cap, core::ptr::null_mut(), core::ptr::null_mut()))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn skeleton_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skeleton_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn skeleton_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skeleton_remove(pdev: *mut pci_dev) {
