...
//! Source: samples/configfs/configfs_sample.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn childless_showme_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn childless_storeme_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn childless_description_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn simple_child_storeme_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn simple_child_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn simple_children_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn configfs_example_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn configfs_example_exit() -> void __exit {
