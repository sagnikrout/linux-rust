...
//! Source: samples/kprobes/kretprobe_example.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ret_handler(ri: *mut kretprobe_instance, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kretprobe_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kretprobe_exit() -> void __exit {
