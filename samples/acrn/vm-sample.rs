...
//! Source: samples/acrn/vm-sample.c
#![no_std]
...
//
    ...
    __u16 vmid;
    int hsm_fd;
    let mut is_running: c_int = 1;
#[no_mangle]
pub unsafe extern "C" fn vm_exit(sig: c_int) {
...
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    {
    int vcpu_id, ret;
    let mut create_vm: acrn_vm_creation = {0};
    let mut ram_map: acrn_vm_memmap = {0};
...
// run vm
    ...
    ret = ioctl(hsm_fd, ACRN_IOCTL_DESTROY_VM, core::ptr::null_mut());
    printf("Destroy VM! [%d]\n", ret);
    close(hsm_fd);
    free(guest_memory);
    return 0;
