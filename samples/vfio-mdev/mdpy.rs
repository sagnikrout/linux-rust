...
//! Source: samples/vfio-mdev/mdpy.c
#![no_std]
...
pub const MDPY_CONFIG_SPACE_SIZE: c_uint = 0xff;

pub const MDPY_DISPLAY_REGION: c_int = 16;
...
pub struct mdev_state {
    ...
    pub type: *const mdpy_type,
    pub memsize: u32,
    pub memblk: *mut c_void,
}

#[no_mangle]
unsafe extern "C" fn mdpy_create_config_space(mdev_state: *mut mdev_state) {
...
#[no_mangle]
unsafe extern "C" fn mdpy_reset(mdev_state: *mut mdev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdpy_init_dev(vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdpy_probe(mdev: *mut mdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdpy_release_dev(vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn mdpy_remove(mdev: *mut mdev_device) {
...
#[no_mangle]
unsafe extern "C" fn mdpy_mmap(vdev: *mut vfio_device, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdpy_get_irq_info(irq_info: *mut vfio_irq_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdpy_get_device_info(dev_info: *mut vfio_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdpy_show_description(mtype: *mut mdev_type, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdpy_device_release(dev: *mut device) {
    static void mdpy_device_release(struct device *dev)
    {
// nothing
    }
#[no_mangle]
unsafe extern "C" fn mdpy_dev_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mdpy_dev_exit() -> void __exit {
    static void __exit mdpy_dev_exit(void)
    {
    mdpy_dev.bus = core::ptr::null_mut();
