...
//! Source: samples/vfio-mdev/mtty.c
#![no_std]
...
pub const MTTY_STRING_LEN: c_int = 16;
pub const MTTY_CONFIG_SPACE_SIZE: c_uint = 0xff;
pub const MTTY_IO_BAR_SIZE: c_uint = 0x8;
pub const MTTY_MMIO_BAR_SIZE: c_uint = 0x100000;

pub const MAX_FIFO_SIZE: c_int = 16;

pub const MTTY_VFIO_PCI_OFFSET_SHIFT: c_int = 40;

    ((u64)(index) << MTTY_VFIO_PCI_OFFSET_SHIFT)

    (((u64)(1) << MTTY_VFIO_PCI_OFFSET_SHIFT) - 1)
pub const MAX_MTTYS: c_int = 24;
//
// Global Structures
//
...
pub struct serial_port {
    pub /: *mut *mut u8 uart_reg[8]; / 8 registers,
    pub /: *mut *mut rxtx rxtx; / loop back buffer,
    pub dlab: bool,
    pub overrun: bool,
    pub divisor: u16,
    pub /: *mut *mut u8 fcr; / FIFO control register,
    pub max_fifo_size: u8,
    pub /: *mut *mut u8 intr_trigger_level; / interrupt trigger level,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtty_data {
    pub magic: u64,
pub const MTTY_MAGIC: c_uint = 0x7e9d09898c3e2c4e /* Nothing clever, just random */;
    pub major_ver: u32,
pub const MTTY_MAJOR_VER: c_int = 1;
    pub minor_ver: u32,
pub const MTTY_MINOR_VER: c_int = 0;
    pub nr_ports: u32,
    pub flags: u32,
    pub ports: [serial_port; 2],
}

    struct mdev_state;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtty_migration_file {
    pub filp: *mut file,
    pub lock: mutex,
    pub mdev_state: *mut mdev_state,
    pub data: mtty_data,
    pub filled_size: isize,
    pub disabled:1: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mdev_state {
    pub vdev: vfio_device,
    pub intx_evtfd: *mut eventfd_ctx,
    pub msi_evtfd: *mut eventfd_ctx,
    pub irq_index: c_int,
    pub vconfig: *mut u8,
    pub ops_lock: mutex,
    pub mdev: *mut mdev_device,
    pub region_info: [mdev_region_info; VFIO_PCI_NUM_REGIONS],
    pub bar_mask: [u32; VFIO_PCI_NUM_REGIONS],
    pub next: list_head,
    pub s: [serial_port; 2],
    pub rxtx_lock: mutex,
    pub dev_info: vfio_device_info,
    pub nr_ports: c_int,
    pub state: enum vfio_device_mig_state,
    pub state_mutex: mutex,
    pub reset_mutex: mutex,
    pub saving_migf: *mut mtty_migration_file,
    pub resuming_migf: *mut mtty_migration_file,
    ...
    let mut mdev_avail_ports: static atomic_t = ATOMIC_INIT(MAX_MTTYS);
...
// Helper functions
#[no_mangle]
unsafe extern "C" fn dump_buffer(buf: *mut u8, count: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtty_create_config_space(mdev_state: *mut mdev_state) {
...
//
    ...
    bar_index = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0x14: offset ==) -> else {
    else if (offset == 0x14)
    bar_index = 1;
...
// buf = mdev_state->s[index].uart_reg[offset] & 0x0f;
    ...
    case UART_IIR:
    {
    let mut ier: u8 = mdev_state.s[index].uart_reg[UART_IER];
// buf = 0;
    mutex_lock(&mdev_state.rxtx_lock);
...
#[no_mangle]
unsafe extern "C" fn mdev_read_base(mdev_state: *mut mdev_state) {
...
#[no_mangle]
unsafe extern "C" fn mtty_data_size(mdev_state: *mut mdev_state) -> usize {
...
#[no_mangle]
unsafe extern "C" fn mtty_disable_file(migf: *mut mtty_migration_file) {
...
#[no_mangle]
unsafe extern "C" fn mtty_disable_files(mdev_state: *mut mdev_state) {
    ...
    mdev_state.saving_migf = core::ptr::null_mut();
    }
    if (mdev_state.resuming_migf) {
    mtty_disable_file(mdev_state.resuming_migf);
    fput(mdev_state.resuming_migf.filp);
    mdev_state.resuming_migf = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn mtty_state_mutex_unlock(mdev_state: *mut mdev_state) {
...
#[no_mangle]
unsafe extern "C" fn mtty_release_migf(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtty_save_state(mdev_state: *mut mdev_state) {
...
#[no_mangle]
unsafe extern "C" fn mtty_load_state(mdev_state: *mut mdev_state) -> c_int {
...
// magic and version already tested by resume write fn
    ...
    {
    struct mtty_migration_file *migf = mdev_state.saving_migf;
    struct mtty_migration_file *ret = core::ptr::null_mut();
    if (migf) {
    ...
    migf, O_RDONLY);
    if (IS_ERR(migf.filp)) {
    let mut rc: c_int = PTR_ERR(migf.filp);
    kfree(migf);
    return ERR_PTR(rc);
    }
...
// pos += len;
    ...
    {
    let mut cur: enum vfio_device_mig_state = mdev_state.state;
...
// vfio_mig_get_next_state() does not use arcs other than the above
    ...
    struct file *ret = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtty_log_stop(vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtty_init_dev(vdev: *mut vfio_device) -> c_int {
    ...
    let mut avail_ports: c_int = atomic_read(&mdev_avail_ports);
    int ret;
    do {
...
#[no_mangle]
unsafe extern "C" fn mtty_probe(mdev: *mut mdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtty_release_dev(vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn mtty_remove(mdev: *mut mdev_device) {
...
#[no_mangle]
unsafe extern "C" fn mtty_reset(mdev_state: *mut mdev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtty_disable_intx(mdev_state: *mut mdev_state) {
    static void mtty_disable_intx(struct mdev_state *mdev_state)
    {
    if (mdev_state.intx_evtfd) {
    eventfd_ctx_put(mdev_state.intx_evtfd);
    mdev_state.intx_evtfd = core::ptr::null_mut();
    mdev_state.intx_mask = false;
    mdev_state.irq_index = -1;
    }
    }
#[no_mangle]
unsafe extern "C" fn mtty_disable_msi(mdev_state: *mut mdev_state) {
    static void mtty_disable_msi(struct mdev_state *mdev_state)
    {
    if (mdev_state.msi_evtfd) {
    eventfd_ctx_put(mdev_state.msi_evtfd);
    mdev_state.msi_evtfd = core::ptr::null_mut();
    mdev_state.irq_index = -1;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn mtty_get_irq_info(irq_info: *mut vfio_irq_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtty_get_device_info(dev_info: *mut vfio_device_info) -> c_int {
    ...
    u8 *data = core::ptr::null_mut(), *ptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtty_get_available(mtype: *mut mdev_type) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtty_close(vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn mtty_device_release(dev: *mut device) {
    static void mtty_device_release(struct device *dev)
    {
    dev_dbg(dev, "mtty: released\n");
    }
#[no_mangle]
unsafe extern "C" fn mtty_dev_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mtty_dev_exit() -> void __exit {
    static void __exit mtty_dev_exit(void)
    {
    mtty_dev.dev.bus = core::ptr::null_mut();
