...
//! Source: samples/vfio-mdev/mbochs.c
#![no_std]
...
pub const VBE_DISPI_INDEX_COUNT: c_uint = 0xb;
...
pub const MBOCHS_CONFIG_SPACE_SIZE: c_uint = 0xff;
    ...
    let mut max_mbytes: static int = 256;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mbochs_dmabuf {
    pub mode: mbochs_mode,
    pub id: u32,
    pub pages: *mut page,
...
pub struct mdev_state {
    ...
    pub vconfig: *mut u8,
    pub bar_mask: [u64; 3],
    pub memory_bar_mask: u32,
    pub ops_lock: mutex,
    pub mdev: *mut mdev_device,
    pub type: *const mbochs_type,
    pub vbe: [u16; VBE_DISPI_INDEX_COUNT],
    pub memsize: u64,
    pub pages: *mut page,
    pub pagecount: pgoff_t,
    pub edid_regs: vfio_region_gfx_edid,
    pub edid_blob: [u8; 0x400],
    ...
    pgoff_t pgoff);
#[no_mangle]
unsafe extern "C" fn mbochs_create_config_space(mdev_state: *mut mdev_state) {
    ...
    {
    struct device *dev = mdev_dev(mdev_state.mdev);
    let mut index: c_int = (offset - PCI_BASE_ADDRESS_0) / 0x04;
    u32 cfg_addr;
    switch (offset) {
...
#[no_mangle]
unsafe extern "C" fn mbochs_reset(mdev_state: *mut mdev_state) -> c_int {
    static int mbochs_reset(struct mdev_state *mdev_state)
    {
    let mut size64k: u32 = mdev_state.memsize / (64 * 1024);
    int i;
...
#[no_mangle]
unsafe extern "C" fn mbochs_init_dev(vdev: *mut vfio_device) -> c_int {
    ...
    let mut avail_mbytes: c_int = atomic_read(&mbochs_avail_mbytes);
...
#[no_mangle]
unsafe extern "C" fn mbochs_probe(mdev: *mut mdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbochs_release_dev(vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn mbochs_remove(mdev: *mut mdev_device) {
...
#[no_mangle]
unsafe extern "C" fn mbochs_put_pages(mdev_state: *mut mdev_state) {
    ...
    mdev_state.pages[i] = core::ptr::null_mut();
    count++;
    }
    dev_dbg(dev, "%s: %d pages released\n", __func__, count);
    }
#[no_mangle]
unsafe extern "C" fn mbochs_region_vm_fault(vmf: *mut vm_fault) -> vm_fault_t {
    static vm_fault_t mbochs_region_vm_fault(struct vm_fault *vmf)
    {
    struct vm_area_struct *vma = vmf.vma;
    struct mdev_state *mdev_state = vma.vm_private_data;
    let mut page_offset: pgoff_t = (vmf.address - vma.vm_start) >> PAGE_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn mbochs_mmap(vdev: *mut vfio_device, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbochs_dmabuf_vm_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn mbochs_mmap_dmabuf(buf: *mut dma_buf, vma: *mut vm_area_struct) -> c_int {
    ...
    {
    struct device *dev = mdev_dev(dmabuf.mdev_state.mdev);
    let mut fourcc: u32 = dmabuf.mode.drm_format;
...
#[no_mangle]
unsafe extern "C" fn mbochs_release_dmabuf(buf: *mut dma_buf) {
...
#[no_mangle]
unsafe extern "C" fn mbochs_dmabuf_export(dmabuf: *mut mbochs_dmabuf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbochs_get_irq_info(irq_info: *mut vfio_irq_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbochs_get_device_info(dev_info: *mut vfio_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbochs_get_gfx_dmabuf(mdev_state: *mut mdev_state, id: u32) -> c_int {
    ...
    {
    let mut plane: vfio_device_gfx_plane_info = {};
...
#[no_mangle]
unsafe extern "C" fn mbochs_close_device(vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn mbochs_show_description(mtype: *mut mdev_type, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mbochs_get_available(mtype: *mut mdev_type) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mbochs_device_release(dev: *mut device) {
    static void mbochs_device_release(struct device *dev)
    {
// nothing
    }
#[no_mangle]
unsafe extern "C" fn mbochs_dev_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mbochs_dev_exit() -> void __exit {
    static void __exit mbochs_dev_exit(void)
    {
    mbochs_dev.bus = core::ptr::null_mut();
