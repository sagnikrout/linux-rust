...
//! Source: samples/vfio-mdev/mdpy-fb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mdpy_fb_destroy(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn mdpy_fb_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mdpy_fb_init() -> int __init {
