...
//! Source: samples/seccomp/user-trap.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn send_fd(sock: c_int, fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn recv_fd(sock: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn user_trap_syscall(nr: c_int, flags: c_uint) -> c_int {
...
//
    ...
    if (mount(source, target, core::ptr::null_mut(), req.data.args[3], core::ptr::null_mut()) < 0) {
    ret = -1;
    perror("actual mount");
    goto out;
    }
...
pub unsafe extern "C" fn main() -> c_int {
    ...
    let mut worker: pid_t = 0 , tracer = 0;
...
//
    if (mount("/dev/sda", "/tmp/foo", core::ptr::null_mut(), 0, core::ptr::null_mut()) != -1) {
...
//
    if (mount("/tmp/foo", "/tmp/foo", core::ptr::null_mut(), MS_BIND, core::ptr::null_mut()) < 0) {
    perror("mount");
    exit(1);
    }
    exit(0);
