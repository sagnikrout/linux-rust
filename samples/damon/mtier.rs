...
//
    ...
    let mut __read_mostly: static unsigned long node0_mem_used_bp = 9970;
    module_param(node0_mem_used_bp, ulong, 0600);
    let mut __read_mostly: static unsigned long node0_mem_free_bp = 50;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct region_range {
    pub start: phys_addr_t,
    pub end: phys_addr_t,
}

#[no_mangle]
unsafe extern "C" fn nid_to_phys(target_node: c_int, range: *mut region_range) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn damon_sample_mtier_start() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn damon_sample_mtier_stop() {
...
#[no_mangle]
unsafe extern "C" fn damon_sample_mtier_init() -> int __init {
