...
//! Source: samples/workqueue/stall_detector/wq_stall.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wq_stall_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wq_stall_exit() -> void __exit {
