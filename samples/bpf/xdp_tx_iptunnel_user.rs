...
//! Source: samples/bpf/xdp_tx_iptunnel_user.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn poll_stats(kill_after_s: c_uint) {
    static void poll_stats(unsigned int kill_after_s)
    {
    let mut nr_protos: c_uint = 256;
...
#[no_mangle]
unsafe extern "C" fn parse_ipstr(ipstr: *const c_char, addr: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_ports(port_str: *const c_char, min_port: *mut c_int, max_port: *mut c_int) -> c_int {
    ...
    tmp_max_port = strtol(end, core::ptr::null_mut(), 10);
