...
//! Source: samples/bpf/sampleip_user.c
#![no_std]
...
pub const DEFAULT_FREQ: c_int = 99;
pub const DEFAULT_SECS: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn sampling_end(links[]: *mut bpf_link) {
...
#[no_mangle]
unsafe extern "C" fn count_cmp(p1: *const c_void, p2: *const c_void) -> c_int {
    static int count_cmp(const void *p1, const void *p2)
    {
    return ((struct ipcount *)p1).count - ((struct ipcount *)p2).count;
    }
#[no_mangle]
unsafe extern "C" fn print_ip_map(fd: c_int) {
