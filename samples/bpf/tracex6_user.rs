...
//! Source: samples/bpf/tracex6_user.c
#![no_std]
...
pub const SAMPLE_PERIOD: c_uint = 0x7fffffffffffffffULL;
// counters, values, values2
    static int map_fd[3];
#[no_mangle]
unsafe extern "C" fn check_on_cpu(cpu: c_int, attr: *mut perf_event_attr) {
...
// Trigger the kprobe
    bpf_map_get_next_key(map_fd[1], &cpu, core::ptr::null_mut());
// Check the value
