...
//! Source: samples/uhid/uhid-example.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn uhid_write(fd: c_int, ev: *const uhid_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_output(ev: *mut uhid_event) {
...
#[no_mangle]
unsafe extern "C" fn event(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_event(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyboard(fd: c_int) -> c_int {
