...
pub static mut msg_max_limit_min: int = 0;
pub static mut msg_max_limit_max: int = 0;
pub static mut msg_maxsize_limit_min: int = 0;
pub static mut msg_maxsize_limit_max: int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn mq_set_ownership(head: *mut ctl_table_header, uid: *mut kuid_t, gid: *mut kgid_t) {
    let mut ns = container_of!(head.set, ipc_namespace, mq_set);
