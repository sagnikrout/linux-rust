...
unsafe extern "C" fn newque(ns: *mut ipc_namespace, params: *mut ipc_params) -> c_int {
    ...
    let mut msgflg: c_int = params.flg;
...
pub unsafe extern "C" fn ss_del(mss: *mut msg_sender) {
    ...
    struct task_struct *stop_tsk = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn if(mss->tsk: stop_tsk ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !msg_fits_inqueue(msq, _arg: mss->msgsz)) -> else {
    if (!stop_tsk)
    stop_tsk = mss.tsk;
...
#[no_mangle]
unsafe extern "C" fn ksys_msgctl(msqid: c_int, cmd: c_int, buf: *mut msqid_ds __user, version: c_int) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn ksys_old_msgctl(msqid: c_int, cmd: c_int, buf: *mut msqid_ds __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn compat_ksys_msgctl(msqid: c_int, cmd: c_int, uptr: *mut void __user, version: c_int) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn compat_ksys_old_msgctl(msqid: c_int, cmd: c_int, uptr: *mut void __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn testmsg(msg: *mut msg_msg, type: c_long, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_msg_fill(dest: *mut void __user, msg: *mut msg_msg, bufsz: usize) -> c_long {
...
pub unsafe extern "C" fn free_copy(copy: *mut msg_msg) {
    ...
    {
    struct msg_msg *msg, *found = core::ptr::null_mut();
...
// msgtyp = msg->m_type - 1;
    ...
    struct msg_queue *msq;
    struct ipc_namespace *ns;
    struct msg_msg *msg, *copy = core::ptr::null_mut();
    DEFINE_WAKE_Q(wake_q);
    ns = current.nsproxy.ipc_ns;
...
#[no_mangle]
unsafe extern "C" fn compat_do_msg_fill(dest: *mut void __user, msg: *mut msg_msg, bufsz: usize) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn msg_init() -> void __init {
