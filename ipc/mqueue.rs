...
pub const DIRENT_SIZE: c_int = 20;
pub const FILENT_SIZE: c_int = 80;
pub const SEND: c_int = 0;
pub const RECV: c_int = 1;
pub const STATE_NONE: c_int = 0;
pub const STATE_READY: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct posix_msg_tree_node {
    pub rb_node: rb_node,
...
pub struct mqueue_inode_info {
    ...
    pub msg_tree: rb_root,
    pub msg_tree_rightmost: *mut rb_node,
    pub node_cache: *mut posix_msg_tree_node,
    pub attr: mq_attr,
    pub notify: sigevent,
...
// mqueue specific info
    ...
    info.qsize = 0;
    info.ucounts = core::ptr::null_mut();	/* set when all is ok */
