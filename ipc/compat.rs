...
#[no_mangle]
pub unsafe extern "C" fn get_compat_ipc64_perm(to: *mut ipc64_perm, from: *mut compat_ipc64_perm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_compat_ipc_perm(to: *mut ipc64_perm, from: *mut compat_ipc_perm) -> c_int {
pub static mut v: usize = 0;
    if (copy_from_user(&v, from, sizeof!(v))) {
    return -EFAULT;
    }
