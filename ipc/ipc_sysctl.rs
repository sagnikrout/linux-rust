...
#[no_mangle]
pub unsafe extern "C" fn proc_ipc_dointvec_minmax_orphans(table: *mut ctl_table, write: c_int, buffer: *mut c_void, lenp: *mut size_t, ppos: *mut loff_t) -> c_int {
    let mut ns = container_of!(table.data, ipc_namespace, shm_rmid_forced);
    let mut err = 0;
...
#[no_mangle]
pub unsafe extern "C" fn proc_ipc_auto_msgmni(table: *mut ctl_table, write: c_int, buffer: *mut c_void, lenp: *mut size_t, ppos: *mut loff_t) -> c_int {
pub static mut ipc_table: usize = 0;
pub static mut dummy: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn proc_ipc_sem_dointvec(table: *mut ctl_table, write: c_int, buffer: *mut c_void, lenp: *mut size_t, ppos: *mut loff_t) -> c_int {
    let mut ns = container_of!(table.data, ipc_namespace, sem_ctls);
    let mut ret = 0;
    let mut semmni = 0;
...
pub static mut ipc_mni: c_int = 0;
pub static mut ipc_mni_shift: c_int = 0;
pub static mut ipc_min_cycle: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ipc_set_ownership(head: *mut ctl_table_header, uid: *mut kuid_t, gid: *mut kgid_t) {
    let mut ns = container_of!(head.set, ipc_namespace, ipc_set);
pub static mut ns_root_uid: kuid_t = 0;
pub static mut ns_root_gid: kgid_t = 0;
...
pub static mut tbl: *mut c_void = core::ptr::null_mut();
    ...
    if (tbl) {
    let mut i = 0;
    while (i < ARRAY_SIZE!(ipc_sysctls)) {
...
#[no_mangle]
unsafe extern "C" fn ipc_sysctl_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc_mni_extend(str: *mut c_char) -> c_int {
