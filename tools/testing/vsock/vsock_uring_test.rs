...
//! Source: tools/testing/vsock/vsock_uring_test.c
#![no_std]
...
pub const RING_ENTRIES_NUM: c_int = 4;
pub const VSOCK_TEST_DATA_MAX_IOV: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vsock_io_uring_test {
// Number of valid elements in 'vecs'.
    pub vecs_cnt: c_int,
    pub vecs: [iovec; VSOCK_TEST_DATA_MAX_IOV],
}
...
// All elements have page aligned base and size.
    ...
    .vecs_cnt = 3,
    {
    { core::ptr::null_mut(), PAGE_SIZE },
    { core::ptr::null_mut(), 2 * PAGE_SIZE },
    { core::ptr::null_mut(), 3 * PAGE_SIZE },
    }
    },
