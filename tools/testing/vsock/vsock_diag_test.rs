...
//! Source: tools/testing/vsock/vsock_diag_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vsock_stat {
    pub list: list_head,
    pub msg: vsock_diag_msg,
}
...
#[no_mangle]
unsafe extern "C" fn print_vsock_addr(fp: *mut FILE, cid: c_uint, port: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn print_vsock_stat(fp: *mut FILE, st: *mut vsock_stat) {
...
#[no_mangle]
unsafe extern "C" fn print_vsock_stats(fp: *mut FILE, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn check_no_sockets(head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn check_num_sockets(head: *mut list_head, expected: c_int) {
...
#[no_mangle]
unsafe extern "C" fn check_socket_state(st: *mut vsock_stat, state: __u8) {
...
#[no_mangle]
unsafe extern "C" fn send_req(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn recv_resp(fd: c_int, buf: *mut c_void, len: usize) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn read_vsock_stat(sockets: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn free_sock_stat(sockets: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn test_no_sockets(opts: *const test_opts) {
...
unsafe extern "C" fn test_connect_server(opts: *const test_opts) {
    ...
    LIST_HEAD(sockets);
    int client_fd;
    client_fd = vsock_stream_accept(VMADDR_CID_ANY, opts.peer_port, core::ptr::null_mut());
    if (client_fd < 0) {
    perror("accept");
    exit(EXIT_FAILURE);
    }
