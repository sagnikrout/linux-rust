...
//! Source: tools/testing/vsock/vsock_test.c
#![no_std]
...
pub const CONTROL_CONTINUE: c_int = 1;
pub const CONTROL_DONE: c_int = 0;
#[no_mangle]
unsafe extern "C" fn test_stream_connection_reset(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_bind_only_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_bind_only_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_client_close_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_client_close_server(opts: *const test_opts) {
    static void test_stream_client_close_server(const struct test_opts *opts)
    {
    int fd;
    fd = vsock_stream_accept(VMADDR_CID_ANY, opts.peer_port, core::ptr::null_mut());
    if (fd < 0) {
    perror("accept");
    exit(EXIT_FAILURE);
    }
...
#[no_mangle]
unsafe extern "C" fn test_stream_server_close_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_server_close_server(opts: *const test_opts) {
...
//
pub const MULTICONN_NFDS: c_int = 100;
#[no_mangle]
unsafe extern "C" fn test_stream_multiconn_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_multiconn_server(opts: *const test_opts) {
    static void test_stream_multiconn_server(const struct test_opts *opts)
    {
    int fds[MULTICONN_NFDS];
    int i;
    for (i = 0; i < MULTICONN_NFDS; i++) {
    fds[i] = vsock_stream_accept(VMADDR_CID_ANY, opts.peer_port, core::ptr::null_mut());
    if (fds[i] < 0) {
    perror("accept");
    exit(EXIT_FAILURE);
    }
...
pub const MSG_PEEK_BUF_LEN: c_int = 64;
    ...
    int fd;
    if (seqpacket)
    fd = vsock_seqpacket_accept(VMADDR_CID_ANY, opts.peer_port, core::ptr::null_mut());
    else
    fd = vsock_stream_accept(VMADDR_CID_ANY, opts.peer_port, core::ptr::null_mut());
    if (fd < 0) {
    perror("accept");
...
#[no_mangle]
unsafe extern "C" fn test_stream_msg_peek_client(opts: *const test_opts) {
    static void test_stream_msg_peek_client(const struct test_opts *opts)
    {
    return test_msg_peek_client(opts, false);
    }
#[no_mangle]
unsafe extern "C" fn test_stream_msg_peek_server(opts: *const test_opts) {
    static void test_stream_msg_peek_server(const struct test_opts *opts)
    {
    return test_msg_peek_server(opts, false);
    }
#[no_mangle]
unsafe extern "C" fn test_stream_peek_after_recv_server(opts: *const test_opts) {
...
pub const MAX_MSG_PAGES: c_int = 4;
#[no_mangle]
unsafe extern "C" fn test_seqpacket_msg_bounds_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_msg_bounds_server(opts: *const test_opts) {
...
pub const MESSAGE_TRUNC_SZ: c_int = 32;
#[no_mangle]
unsafe extern "C" fn test_seqpacket_msg_trunc_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_msg_trunc_server(opts: *const test_opts) {
    ...
    msg.msg_iov = &iov;
    msg.msg_iovlen = 1;
    let mut ret: isize = recvmsg(fd, &msg, MSG_TRUNC);
...
pub const RCVTIMEO_TIMEOUT_SEC: c_int = 1;

#[no_mangle]
unsafe extern "C" fn test_seqpacket_timeout_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_timeout_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_bigmsg_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_bigmsg_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_invalid_rec_buffer_client(opts: *const test_opts) {
    static void test_seqpacket_invalid_rec_buffer_client(const struct test_opts *opts)
    {
    int fd;
    unsigned char *buf1;
    unsigned char *buf2;
    let mut buf_size: c_int = getpagesize() * 3;
    fd = vsock_seqpacket_connect(opts.peer_cid, opts.peer_port);
    if (fd < 0) {
    perror("connect");
    exit(EXIT_FAILURE);
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_invalid_rec_buffer_server(opts: *const test_opts) {
    ...
    let mut buf_size: c_int = page_size * 3;
    ssize_t res;
    let mut prot: c_int = PROT_READ | PROT_WRITE;
...
// Setup first buffer.
    broken_buf = mmap(core::ptr::null_mut(), buf_size, prot, flags, -1, 0);
...
// Unmap "hole" in buffer.
    ...
    valid_buf = mmap(core::ptr::null_mut(), buf_size, prot, flags, -1, 0);
...
pub const RCVLOWAT_BUF_SIZE: c_int = 128;
#[no_mangle]
unsafe extern "C" fn test_stream_poll_rcvlowat_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_poll_rcvlowat_client(opts: *const test_opts) {
    static void test_stream_poll_rcvlowat_client(const struct test_opts *opts)
    {
    let mut lowat_val: c_int = RCVLOWAT_BUF_SIZE;
...
pub const INV_BUF_TEST_DATA_LEN: c_int = 512;
#[no_mangle]
unsafe extern "C" fn test_inv_buf_client(opts: *const test_opts, stream: bool) {
...
// Use invalid buffer here.
    recv_buf(fd, core::ptr::null_mut(), sizeof(data), 0, -EFAULT);
    if (stream) {
...
#[no_mangle]
unsafe extern "C" fn test_inv_buf_server(opts: *const test_opts, stream: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_virtio_skb_merge_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_virtio_skb_merge_server(opts: *const test_opts) {
    static void test_stream_virtio_skb_merge_server(const struct test_opts *opts)
    {
    let mut read: usize = 0, to_read;
...
#[no_mangle]
unsafe extern "C" fn test_seqpacket_msg_peek_client(opts: *const test_opts) {
    static void test_seqpacket_msg_peek_client(const struct test_opts *opts)
    {
    return test_msg_peek_client(opts, true);
    }
#[no_mangle]
unsafe extern "C" fn test_seqpacket_msg_peek_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn sigpipe(signo: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_check_sigpipe(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_shutwr_client(opts: *const test_opts) {
    ...
    sigaction(SIGPIPE, &act, core::ptr::null_mut());
    fd = vsock_stream_connect(opts.peer_cid, opts.peer_port);
    if (fd < 0) {
    perror("connect");
    exit(EXIT_FAILURE);
...
#[no_mangle]
unsafe extern "C" fn test_stream_shutwr_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_shutrd_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_shutrd_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_double_bind_connect_server(opts: *const test_opts) {
    static void test_double_bind_connect_server(const struct test_opts *opts)
    {
    int listen_fd, client_fd, i;
    struct sockaddr_vm sa_client;
    let mut socklen_client: socklen_t = sizeof(sa_client);
...
#[no_mangle]
unsafe extern "C" fn test_double_bind_connect_client(opts: *const test_opts) {
...
pub const MSG_BUF_IOCTL_LEN: c_int = 64;
#[no_mangle]
unsafe extern "C" fn test_unsent_bytes_server(opts: *const test_opts, type: c_int) {
    static void test_unsent_bytes_server(const struct test_opts *opts, int type)
    {
    unsigned char buf[MSG_BUF_IOCTL_LEN];
    int client_fd;
    client_fd = vsock_accept(VMADDR_CID_ANY, opts.peer_port, core::ptr::null_mut(), type);
    if (client_fd < 0) {
    perror("accept");
    exit(EXIT_FAILURE);
    }
...
#[no_mangle]
unsafe extern "C" fn test_unsent_bytes_client(opts: *const test_opts, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_unread_bytes_server(opts: *const test_opts, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_unread_bytes_client(opts: *const test_opts, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_unsent_bytes_client(opts: *const test_opts) {
    static void test_stream_unsent_bytes_client(const struct test_opts *opts)
    {
    test_unsent_bytes_client(opts, SOCK_STREAM);
    }
#[no_mangle]
unsafe extern "C" fn test_stream_unsent_bytes_server(opts: *const test_opts) {
    static void test_stream_unsent_bytes_server(const struct test_opts *opts)
    {
    test_unsent_bytes_server(opts, SOCK_STREAM);
    }
#[no_mangle]
unsafe extern "C" fn test_seqpacket_unsent_bytes_client(opts: *const test_opts) {
    static void test_seqpacket_unsent_bytes_client(const struct test_opts *opts)
    {
    test_unsent_bytes_client(opts, SOCK_SEQPACKET);
    }
#[no_mangle]
unsafe extern "C" fn test_seqpacket_unsent_bytes_server(opts: *const test_opts) {
    static void test_seqpacket_unsent_bytes_server(const struct test_opts *opts)
    {
    test_unsent_bytes_server(opts, SOCK_SEQPACKET);
    }
#[no_mangle]
unsafe extern "C" fn test_stream_unread_bytes_client(opts: *const test_opts) {
    static void test_stream_unread_bytes_client(const struct test_opts *opts)
    {
    test_unread_bytes_client(opts, SOCK_STREAM);
    }
#[no_mangle]
unsafe extern "C" fn test_stream_unread_bytes_server(opts: *const test_opts) {
    static void test_stream_unread_bytes_server(const struct test_opts *opts)
    {
    test_unread_bytes_server(opts, SOCK_STREAM);
    }
#[no_mangle]
unsafe extern "C" fn test_seqpacket_unread_bytes_client(opts: *const test_opts) {
    static void test_seqpacket_unread_bytes_client(const struct test_opts *opts)
    {
    test_unread_bytes_client(opts, SOCK_SEQPACKET);
    }
#[no_mangle]
unsafe extern "C" fn test_seqpacket_unread_bytes_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_rcvlowat_def_cred_upd_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_cred_upd_on_low_rx_bytes(opts: *const test_opts) {
    static void test_stream_cred_upd_on_low_rx_bytes(const struct test_opts *opts)
    {
    test_stream_credit_update_test(opts, true);
    }
#[no_mangle]
unsafe extern "C" fn test_stream_cred_upd_on_set_rcvlowat(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_leak_acceptq_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_leak_acceptq_server(opts: *const test_opts) {
...
// Test for a memory leak. User is expected to run kmemleak scan, see README.
#[no_mangle]
unsafe extern "C" fn test_stream_msgzcopy_leak_errq_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_msgzcopy_leak_errq_server(opts: *const test_opts) {
...
// Test for a memory leak. User is expected to run kmemleak scan, see README.
#[no_mangle]
unsafe extern "C" fn test_stream_msgzcopy_leak_zcskb_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_msgzcopy_leak_zcskb_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_transport_uaf(cid: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn test_stream_transport_uaf_client(opts: *const test_opts) {
...
#[no_mangle]
pub unsafe extern "C" fn if(TRANSPORT_VIRTIO: tr ==) -> else {
    else if (tr == TRANSPORT_VIRTIO)
    fprintf(stderr, "Setup unsupported: sole virtio transport\n");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tested) -> else {
    else if (!tested)
    fprintf(stderr, "No transports tested\n");
    }
#[no_mangle]
unsafe extern "C" fn test_stream_connect_retry_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_connect_retry_server(opts: *const test_opts) {
    ...
    int ret;
    ret = pthread_setcanceltype(PTHREAD_CANCEL_ASYNCHRONOUS, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn test_transport_change_signal_handler(signal: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_transport_change_client(opts: *const test_opts) {
...
//
    ...
    ret = pthread_create(&thread_id, core::ptr::null_mut(), test_stream_transport_change_thread, &pid);
    if (ret) {
    ...
    let mut send_control: bool = false;
    int s;
...
//
    ...
    ret = pthread_join(thread_id, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_transport_change_server(opts: *const test_opts) {
    static void test_stream_transport_change_server(const struct test_opts *opts)
    {
    let mut s: c_int = vsock_stream_listen(VMADDR_CID_ANY, opts.peer_port);
...
//
    while (true) {
    let mut client: c_int = accept(s, core::ptr::null_mut(), core::ptr::null_mut());
    if (client < 0) {
    if (errno == EAGAIN)
    break;
    perror("accept");
...
#[no_mangle]
unsafe extern "C" fn test_stream_linger_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_linger_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_nolinger_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_nolinger_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_accepted_setsockopt_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_accepted_setsockopt_server(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_tx_credit_bounds_client(opts: *const test_opts) {
    ...
    control_expectln("SRVREADY");
    for (;;) {
    let mut sent: isize = send(fd, buf, sizeof(buf), 0);
    if (sent == 0) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_tx_credit_bounds_server(opts: *const test_opts) {
...
// connection is reset.
//
pub const COLLAPSE_PKT_MIN: c_int = 129;
pub const COLLAPSE_PKT_MAX: c_int = 512;

#[no_mangle]
unsafe extern "C" fn test_stream_collapse_client(opts: *const test_opts) {
...
#[no_mangle]
unsafe extern "C" fn test_stream_collapse_server(opts: *const test_opts) {
...
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    {
    const char *control_host = core::ptr::null_mut();
    const char *control_port = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(optarg, 0: "server") ==) -> else {
