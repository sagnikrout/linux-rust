...
//! Source: tools/testing/cxl/test/cxl_translate.c
#![no_std]
...
pub const MAX_TABLE_ENTRIES: c_int = 128;
pub const MAX_ENTRY_LEN: c_int = 128;
// Expected number of parameters in each test vector
pub const EXPECTED_PARAMS: c_int = 7;
// Module parameters for test vectors
    static char *table[MAX_TABLE_ENTRIES];
    static int table_num;
// Interleave Arithmetic
pub const MODULO_MATH: c_int = 0;
pub const XOR_MATH: c_int = 1;
//
...
//
    ...
    let mut nr_maps: static int = ARRAY_SIZE(xormaps);
...
//
#[no_mangle]
unsafe extern "C" fn to_dpa(hpa_offset: u64, r_eiw: u8, r_eig: u16, hb_ways: u8, math: u8) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn to_pos(hpa_offset: u64, r_eiw: u8, r_eig: u16, hb_ways: u8, math: u8) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn setup_xor_mapping() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_random_params() -> c_int {
    ...
    let mut iterations: c_int = 10000;
    let mut failures: c_int = 0;
    for (i = 0; i < iterations; i++) {
// Generate valid random parameters for eiw, eig, pos, dpa
    let mut eiw: u8 = valid_eiws[get_random_u32() % ARRAY_SIZE(valid_eiws)];
    let mut eig: u16 = valid_eigs[get_random_u32() % ARRAY_SIZE(valid_eigs)];
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct param_test {
    pub eiw: u8,
    pub eig: u16,
    pub pos: c_int,
    pub /: *mut *mut bool expect; / true: expect pass, false: expect fail,
...
#[no_mangle]
unsafe extern "C" fn test_cxl_validate_translation_params() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_translate_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cxl_translate_exit() -> void __exit {
