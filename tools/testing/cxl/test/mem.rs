...
//! Source: tools/testing/cxl/test/mem.c
#![no_std]
...
pub const FW_SLOTS: c_int = 3;

pub const MOCK_INJECT_DEV_MAX: c_int = 8;
pub const MOCK_INJECT_TEST_MAX: c_int = 128;
    let mut poison_inject_dev_max: static unsigned int = MOCK_INJECT_DEV_MAX;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_mbox_health_info {
    pub health_status: u8,
    pub media_status: u8,
    pub ext_status: u8,
    pub life_used: u8,
    pub temperature: __le16,
    pub dirty_shutdowns: __le32,
    pub volatile_errors: __le32,
    pub pmem_errors: __le32,
    pub __packed: },
    static struct {
    pub gsl: cxl_mbox_get_supported_logs,
    pub entry: cxl_gsl_entry,
    } mock_gsl_payload = {
    .gsl = {
...
pub const PASS_TRY_LIMIT: c_int = 3;
pub const CXL_TEST_EVENT_CNT_MAX: c_int = 15;
// Set a number of events to return at a time for simulation.
pub const CXL_TEST_EVENT_RET_MAX: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mock_event_log {
    pub clear_idx: u16,
    pub cur_idx: u16,
    pub nr_events: u16,
    pub nr_overflow: u16,
    pub overflow_reset: u16,
    pub events: [*mut cxl_event_record_raw; CXL_TEST_EVENT_CNT_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mock_event_store {
    pub mock_logs: [mock_event_log; CXL_EVENT_TYPE_MAX],
    pub ev_status: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vendor_test_feat {
    pub data: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_mockmem_data {
    pub lsa: *mut c_void,
    pub fw: *mut c_void,
    pub fw_slot: c_int,
    pub fw_staged: c_int,
    ...
    pub user_pass: [u8; NVDIMM_PASSPHRASE_LEN],
    pub master_pass: [u8; NVDIMM_PASSPHRASE_LEN],
    pub user_limit: c_int,
    pub master_limit: c_int,
    pub mes: mock_event_store,
    pub mds: *mut cxl_memdev_state,
    pub event_buf: [u8; SZ_4K],
    pub timestamp: u64,
    pub sanitize_timeout: c_ulong,
    pub test_feat: vendor_test_feat,
...
#[no_mangle]
unsafe extern "C" fn event_reset_log(log: *mut mock_event_log) {
...
#[no_mangle]
unsafe extern "C" fn event_get_clear_handle(log: *mut mock_event_log) -> u16 {
...
// Handle can never be 0 use 1 based indexing for handle
#[no_mangle]
unsafe extern "C" fn event_get_cur_event_handle(log: *mut mock_event_log) -> __le16 {
    static __le16 event_get_cur_event_handle(struct mock_event_log *log)
    {
    let mut cur_handle: u16 = log.cur_idx + 1;
    return cpu_to_le16(cur_handle);
    }
#[no_mangle]
unsafe extern "C" fn event_log_empty(log: *mut mock_event_log) -> bool {
...
// logs are being read.
//
    let mut event_counter: static atomic_t = ATOMIC_INIT(0);
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn cxl_mock_event_trigger(dev: *mut device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_test_gen_media {
    pub id: uuid_t,
    pub rec: cxl_event_gen_media,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_test_dram {
    pub id: uuid_t,
    pub rec: cxl_event_dram,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_test_mem_module {
    pub id: uuid_t,
    pub rec: cxl_event_mem_module,
    pub __packed: },
...
#[no_mangle]
unsafe extern "C" fn cxl_mock_add_event_logs(mes: *mut mock_event_store) {
...
unsafe extern "C" fn mock_get_log(mds: *mut cxl_memdev_state, cmd: *mut cxl_mbox_cmd) -> c_int {
    ...
    let mut uuid: uuid_t = DEFINE_CXL_CEL_UUID;
...
#[no_mangle]
unsafe extern "C" fn master_plimit_check(mdata: *mut cxl_mockmem_data) {
...
#[no_mangle]
unsafe extern "C" fn user_plimit_check(mdata: *mut cxl_mockmem_data) {
...
// Always return count, even when zero
    ...
    struct cxl_mbox_poison_out *po;
    let mut offset: u64 = le64_to_cpu(pi.offset);
    let mut length: u64 = le64_to_cpu(pi.length);
    int nr_records;
...
#[no_mangle]
unsafe extern "C" fn mock_poison_dev_max_injected(cxlds: *mut cxl_dev_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mock_poison_add(cxlds: *mut cxl_dev_state, dpa: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mock_poison_found(cxlds: *mut cxl_dev_state, dpa: u64) -> bool {
    ...
    let mut dpa: u64 = le64_to_cpu(pi.address);
...
#[no_mangle]
unsafe extern "C" fn mock_poison_del(cxlds: *mut cxl_dev_state, dpa: u64) -> bool {
    static bool mock_poison_del(struct cxl_dev_state *cxlds, u64 dpa)
    {
    for (int i = 0; i < MOCK_INJECT_TEST_MAX; i++) {
    if (mock_poison_list[i].cxlds == cxlds &&
    mock_poison_list[i].dpa == dpa) {
    mock_poison_list[i].cxlds = core::ptr::null_mut();
    return true;
    }
    }
    return false;
...
#[no_mangle]
unsafe extern "C" fn mock_poison_list_empty() -> bool {
...
#[no_mangle]
unsafe extern "C" fn poison_inject_max_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
    ...
    0xff, 0xff, 0xff)
#[no_mangle]
unsafe extern "C" fn fill_feature_vendor_test(feat: *mut cxl_feat_entry) {
...
pub const MAX_CXL_TEST_FEATS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn label_area_release(lsa: *mut c_void) {
    static void label_area_release(void *lsa)
    {
    vfree(lsa);
    }
#[no_mangle]
unsafe extern "C" fn fw_buf_release(buf: *mut c_void) {
    static void fw_buf_release(void *buf)
    {
    vfree(buf);
    }
#[no_mangle]
unsafe extern "C" fn is_rcd(pdev: *mut platform_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_mock_mailbox_create(cxlds: *mut cxl_dev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_mock_test_feat_init(mdata: *mut cxl_mockmem_data) {
...
unsafe extern "C" fn cxl_mock_mem_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut range_info: cxl_dpa_info = { 0 };
    u64 serial;
    int rc;
