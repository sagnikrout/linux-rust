...
//! Source: tools/testing/shared/linux.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    int test_verbose;
#[no_mangle]
pub unsafe extern "C" fn kmem_cache_set_callback(cachep: *mut kmem_cache, ): *mut *mut void (callback)(void) {
...
pub unsafe extern "C" fn kmem_cache_zero_nr_tallocated(cachep: *mut kmem_cache) {
    ...
    cachep.ctor(p);
#[no_mangle]
pub unsafe extern "C" fn if(__GFP_ZERO: gfp &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn kmem_cache_free_bulk(cachep: *mut kmem_cache, size: usize, list: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn kmem_cache_shrink(cachep: *mut kmem_cache) {
...
pub unsafe extern "C" fn if(__GFP_ZERO: gfp &) -> else {
    ...
    pthread_mutex_init(&ret.lock, core::ptr::null_mut());
    ret.size = size;
    ...
    ret.nr_allocated = 0;
    ret.nr_tallocated = 0;
    ret.objs = core::ptr::null_mut();
    ret.ctor = args.ctor;
    ret.non_kernel = 0;
    ret.exec_callback = false;
    ret.callback = core::ptr::null_mut();
    ret.private = core::ptr::null_mut();
    return ret;
    }
    struct slab_sheaf *
...
// sheafp = sheaf;
    ...
    sheaf.objects[sheaf.size] = core::ptr::null_mut();
    return obj;
    }
//
...
//
    test_cache = kmem_cache_create("test_cache", 256, 0, SLAB_PANIC, core::ptr::null_mut());
    for (i = 0; i < 5; i++)
...
// Aligned caches will immediately free
    test_cache2 = kmem_cache_create("test_cache2", 128, 128, SLAB_PANIC, core::ptr::null_mut());
