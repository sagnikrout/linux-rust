...
//! Source: tools/testing/vma/tests/merge.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn expand_existing(vmg: *mut vma_merge_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_simple_merge() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_simple_modify() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_simple_expand() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_simple_shrink() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __test_merge_new(is_sticky: bool, a_is_sticky: bool, b_is_sticky: bool, c_is_sticky: bool) -> bool {
...
// AAAAA*DDD  CC
//
    vma_d.vm_ops = core::ptr::null_mut(); /* This would otherwise degrade the merge. */
...
#[no_mangle]
unsafe extern "C" fn test_merge_new() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_vma_merge_special_flags() -> bool {
...
//
    ...
    for (i = 0; i < ARRAY_SIZE(special_flags); i++) {
    let mut special_flag: vma_flag_t = special_flags[i];
...
#[no_mangle]
unsafe extern "C" fn test_vma_merge_with_close() -> bool {
...
// also fail.
//
    ASSERT_EQ(merge_existing(&vmg), core::ptr::null_mut());
    ASSERT_EQ(vmg.state, VMA_MERGE_NOMERGE);
    ASSERT_EQ(cleanup_mm(&mm, &vmi), 2);
//
...
#[no_mangle]
unsafe extern "C" fn test_vma_merge_new_with_close() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __test_merge_existing(prev_is_sticky: bool, middle_is_sticky: bool, next_is_sticky: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_merge_existing() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_anon_vma_non_mergeable() -> bool {
    ...
    let mut dummy_anon_vma_chain_1: anon_vma_chain = {};
    let mut dummy_anon_vma_chain_2: anon_vma_chain = {};
...
//
    vmg_set_range_anon_vma(&vmg, 0x3000, 0x7000, 3, vma_flags, core::ptr::null_mut());
    vmg.prev = vma_prev;
    vmg.middle = vma;
...
#[no_mangle]
unsafe extern "C" fn test_dup_anon_vma() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_vmi_prealloc_fail() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_merge_extend() -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_expand_only_mode() -> bool {
...
#[no_mangle]
unsafe extern "C" fn run_merge_tests(num_tests: *mut c_int, num_fail: *mut c_int) {
