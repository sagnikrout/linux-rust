...
//! Source: tools/testing/radix-tree/regression1.c
#![no_std]
...
pub struct page {
    ...
    p.count = 1;
    p.index = index;
    pthread_mutex_init(&p.lock, core::ptr::null_mut());
    return p;
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn page_free(p: *mut page) {
...
// Regression #1
    ...
    nr_threads = 2;
    pthread_barrier_init(&worker_barrier, core::ptr::null_mut(), nr_threads);
    threads = malloc(nr_threads * sizeof(*threads));
    for (i = 0; i < nr_threads; i++) {
    arg = i;
    if (pthread_create(&threads[i], core::ptr::null_mut(), regression1_fn, (void *)arg)) {
