...
//! Source: tools/testing/selftests/ublk/null.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ublk_null_tgt_init(ctx: *const dev_ctx, dev: *mut ublk_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: zc) -> else {
    else if (zc)
