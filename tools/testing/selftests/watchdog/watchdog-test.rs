...
//! Source: tools/testing/selftests/watchdog/watchdog-test.c
#![no_std]
...
pub const DEFAULT_PING_RATE: c_int = 1;
    int fd;
    let mut v: c_char = 'V';
    static const char sopts[] = "bdehp:st:Tn:NLf:i";
    static const struct option lopts[] = {
    {"bootstatus",          no_argument, core::ptr::null_mut(), 'b'},
    {"disable",             no_argument, core::ptr::null_mut(), 'd'},
    {"enable",              no_argument, core::ptr::null_mut(), 'e'},
    {"help",                no_argument, core::ptr::null_mut(), 'h'},
    {"pingrate",      required_argument, core::ptr::null_mut(), 'p'},
    {"status",              no_argument, core::ptr::null_mut(), 's'},
    {"timeout",       required_argument, core::ptr::null_mut(), 't'},
    {"gettimeout",          no_argument, core::ptr::null_mut(), 'T'},
    {"pretimeout",    required_argument, core::ptr::null_mut(), 'n'},
    {"getpretimeout",       no_argument, core::ptr::null_mut(), 'N'},
    {"gettimeleft",		no_argument, core::ptr::null_mut(), 'L'},
    {"file",          required_argument, core::ptr::null_mut(), 'f'},
    {"info",		no_argument, core::ptr::null_mut(), 'i'},
    {core::ptr::null_mut(),                  no_argument, core::ptr::null_mut(), 0x0}
    };
//
...
//
#[no_mangle]
unsafe extern "C" fn term(sig: c_int) {
    static void term(int sig)
    {
    let mut ret: c_int = write(fd, &v, 1);
    close(fd);
    if (ret < 0)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wdiof_status {
    pub flag: c_int,
    pub status_str: *const c_char,
}

pub const WDIOF_NUM_STATUS: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn print_status(flags: c_int) {
...
pub const WDIOF_NUM_BOOTSTATUS: c_int = 7;
...
#[no_mangle]
unsafe extern "C" fn print_boot_status(flags: c_int) {
...
pub unsafe extern "C" fn main(argc: c_int, argv[]: *mut c_char) -> c_int {
    ...
    {
    int flags;
    let mut ping_rate: c_uint = DEFAULT_PING_RATE;
    int ret;
    int c;
    ...
    while ((c = getopt_long(argc, argv, sopts, lopts, core::ptr::null_mut())) != -1) {
    if (c == 'f')
    file = optarg;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(EACCES: errno ==) -> else {
...
//
    ...
    break;
    case 'p':
    ping_rate = strtoul(optarg, core::ptr::null_mut(), 0);
    if (!ping_rate)
    ...
    break;
    case 't':
    flags = strtoul(optarg, core::ptr::null_mut(), 0);
