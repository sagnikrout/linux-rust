...
//! Source: tools/testing/selftests/alloc_tag/allocinfo_ioctl_test.c
#![no_std]
...
pub const VEC_MAX_ENTRIES: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct allocinfo_tag_data_vec {
    pub tag: [allocinfo_tag_data; VEC_MAX_ENTRIES],
    pub count: __u64,
}

#[no_mangle]
pub unsafe extern "C" fn __allocinfo_get_content_id(dev_fd: c_int, params: *mut allocinfo_content_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __allocinfo_get_at(dev_fd: c_int, params: *mut allocinfo_get_at) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __allocinfo_get_next(dev_fd: c_int, params: *mut allocinfo_tag_data) -> c_int {
...
unsafe extern "C" fn allocinfo_copy_str(dest: *mut c_char, src: *const c_char) {
    ...
    __u64 start_pos)
    {
    let mut fd: c_int = open(ALLOCINFO_PROC, O_RDONLY);
    if (fd < 0) {
...
#[no_mangle]
unsafe extern "C" fn run_filter_test(filter: *const allocinfo_filter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_filename_filter() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_function_filter() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_size_filter() -> c_int {
    ...
    struct allocinfo_tag_data *found_tag = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_lineno_filter() -> c_int {
