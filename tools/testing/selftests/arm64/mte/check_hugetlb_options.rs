...
//! Source: tools/testing/selftests/arm64/mte/check_hugetlb_options.c
#![no_std]
...
pub const TAG_CHECK_ON: c_int = 0;
pub const TAG_CHECK_OFF: c_int = 1;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn is_hugetlb_allocated() -> bool {
...
#[no_mangle]
unsafe extern "C" fn allocate_hugetlb() {
    static void allocate_hugetlb()
    {
    write_sysfs("/proc/sys/vm/nr_hugepages", 2);
    }
#[no_mangle]
unsafe extern "C" fn free_hugetlb() {
...
#[no_mangle]
unsafe extern "C" fn check_mte_memory(ptr: *mut c_char, size: c_int, mode: c_int, tag_check: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_hugetlb_memory_mapping(mem_type: c_int, mode: c_int, mapping: c_int, tag_check: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_clear_prot_mte_flag(mem_type: c_int, mode: c_int, mapping: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_child_hugetlb_memory_mapping(mem_type: c_int, mode: c_int, mapping: c_int) -> c_int {
...
// Check if MTE supports hugetlb mappings
    map_size = default_huge_page_size();
    map_ptr = mmap(core::ptr::null_mut(), map_size, PROT_READ | PROT_MTE,
