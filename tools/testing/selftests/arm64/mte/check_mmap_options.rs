...
//! Source: tools/testing/selftests/arm64/mte/check_mmap_options.c
#![no_std]
...
pub const ATAG_CHECK_ON: c_int = 1;
pub const ATAG_CHECK_OFF: c_int = 0;
pub const TEST_NAME_MAX: c_int = 256;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct check_mmap_testcase {
    pub check_type: c_int,
    pub mem_type: c_int,
    pub mte_sync: c_int,
    pub mapping: c_int,
    pub tag_check: c_int,
    pub atag_check: c_int,
    pub tag_op: c_int,
    pub enable_tco: bool,
}

pub const TAG_OP_ALL: c_int = 0;
pub const TAG_OP_STONLY: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn check_clear_prot_mte_flag(mem_type: c_int, mode: c_int, mapping: c_int, atag_check: c_int) -> c_int {
