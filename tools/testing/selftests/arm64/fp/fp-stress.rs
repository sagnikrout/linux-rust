...
//! Source: tools/testing/selftests/arm64/fp/fp-stress.c
#![no_std]
...
pub const MAX_VLS: c_int = 16;
pub const SIGNAL_INTERVAL_MS: c_int = 25;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct child_data {
    pub output: *mut *mut char name,,
    pub pid: pid_t,
    pub stdout: c_int,
...
#[no_mangle]
unsafe extern "C" fn num_processors() -> c_int {
    static int num_processors(void)
    {
    let mut nproc: c_long = sysconf(_SC_NPROCESSORS_CONF);
    if (nproc < 0) {
...
#[no_mangle]
unsafe extern "C" fn child_start(child: *mut child_data, program: *const c_char) {
...
//
    ...
    close(3);
    ret = execl(program, program, core::ptr::null_mut());
...
//
    ...
    child.output = core::ptr::null_mut();
    child.exited = false;
...
#[no_mangle]
unsafe extern "C" fn child_output_read(child: *mut child_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn child_tickle(child: *mut child_data) {
...
#[no_mangle]
unsafe extern "C" fn child_stop(child: *mut child_data) {
...
#[no_mangle]
unsafe extern "C" fn child_cleanup(child: *mut child_data) {
...
#[no_mangle]
unsafe extern "C" fn handle_child_signal(sig: c_int, info: *mut siginfo_t, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn start_fpsimd(child: *mut child_data, cpu: c_int, copy: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_kernel(child: *mut child_data, cpu: c_int, copy: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_sve(child: *mut child_data, vl: c_int, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_ssve(child: *mut child_data, vl: c_int, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_za(child: *mut child_data, vl: c_int, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_zt(child: *mut child_data, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn probe_vls(vls[]: c_int, vl_count: *mut c_int, set_vl: c_int) {
...
#[no_mangle]
unsafe extern "C" fn drain_output(flush: bool) {
    ...
    { "timeout",	required_argument, core::ptr::null_mut(), 't' },
    { }
    };
#[no_mangle]
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    bool have_sme2;
    struct sigaction sa;
    while ((c = getopt_long(argc, argv, "t:", options, core::ptr::null_mut())) != -1) {
    switch (c) {
    case 't':
...
// Get signal handers ready before we start any children
    ...
    ret = sigaction(SIGINT, &sa, core::ptr::null_mut());
    if (ret < 0)
    ...
    ret = sigaction(SIGCHLD, &sa, core::ptr::null_mut());
    if (ret < 0)
