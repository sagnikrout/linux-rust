...
//! Source: tools/testing/selftests/arm64/fp/vec-syscfg.c
#![no_std]
...
pub struct vec_data {
    ...
    pub hwcap: c_ulong,
    pub rdvl_binary: *const c_char,
    pub (*rdvl)(void): *mut c_int,
    pub prctl_get: c_int,
    pub prctl_set: c_int,
    pub default_vl_file: *const c_char,
    pub default_vl: c_int,
    pub min_vl: c_int,
    pub max_vl: c_int,
}

pub const VEC_SVE: c_int = 0;
pub const VEC_SME: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn vec_type_supported(data: *mut vec_data) -> bool {
    static bool vec_type_supported(struct vec_data *data)
    {
    return getauxval(data.hwcap_type) & data.hwcap;
    }
#[no_mangle]
unsafe extern "C" fn stdio_read_integer(f: *mut FILE, what: *const c_char, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_child_rdvl(data: *mut vec_data) -> c_int {
...
// exec() a new binary which puts the VL on stdout
    ret = execl(data.rdvl_binary, data.rdvl_binary, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn file_read_integer(name: *const c_char, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn file_write_integer(name: *const c_char, val: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn proc_read_default(data: *mut vec_data) {
...
#[no_mangle]
unsafe extern "C" fn proc_write_min(data: *mut vec_data) {
...
#[no_mangle]
unsafe extern "C" fn proc_write_max(data: *mut vec_data) {
...
#[no_mangle]
unsafe extern "C" fn prctl_get(data: *mut vec_data) {
...
#[no_mangle]
unsafe extern "C" fn prctl_set_same(data: *mut vec_data) {
    static void prctl_set_same(struct vec_data *data)
    {
    let mut cur_vl: c_int = data.rdvl();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn prctl_set(data: *mut vec_data) {
...
#[no_mangle]
unsafe extern "C" fn prctl_set_no_child(data: *mut vec_data) {
...
// If we didn't request it a new VL shouldn't affect the child
#[no_mangle]
unsafe extern "C" fn prctl_set_for_child(data: *mut vec_data) {
...
#[no_mangle]
unsafe extern "C" fn prctl_set_onexec(data: *mut vec_data) {
...
#[no_mangle]
unsafe extern "C" fn prctl_set_all_vqs(data: *mut vec_data) {
...
#[no_mangle]
pub unsafe extern "C" fn smstart() {
    static inline void smstart(void)
    {
    asm volatile("msr S0_3_C4_C7_3, xzr");
    }
#[no_mangle]
pub unsafe extern "C" fn smstart_sm() {
    static inline void smstart_sm(void)
    {
    asm volatile("msr S0_3_C4_C3_3, xzr");
    }
#[no_mangle]
pub unsafe extern "C" fn smstop() {
...
//
#[no_mangle]
unsafe extern "C" fn change_sve_with_za() {
