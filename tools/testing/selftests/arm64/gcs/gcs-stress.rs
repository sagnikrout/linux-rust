...
//! Source: tools/testing/selftests/arm64/gcs/gcs-stress.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn start_thread(child: *mut child_data, id: c_int) {
...
//
    ...
    ret);
    close(3);
    ret = execl("gcs-stress-thread", "gcs-stress-thread", core::ptr::null_mut());
