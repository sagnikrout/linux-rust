...
//! Source: tools/testing/selftests/timers/freq-step.c
#![no_std]
...
pub const SAMPLES: c_int = 100;
pub const SAMPLE_READINGS: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn diff_timespec(ts1: *mut timespec, ts2: *mut timespec) -> double {
    static double diff_timespec(struct timespec *ts1, struct timespec *ts2)
    {
    return ts1.tv_sec - ts2.tv_sec + (ts1.tv_nsec - ts2.tv_nsec) / 1e9;
    }
#[no_mangle]
unsafe extern "C" fn get_sample(sample: *mut sample) -> double {
...
#[no_mangle]
unsafe extern "C" fn reset_ntp_error() {
...
#[no_mangle]
unsafe extern "C" fn set_frequency(freq: double) {
...
#[no_mangle]
unsafe extern "C" fn run_test(calibration: c_int, freq_base: double, freq_step: double) -> c_int {
