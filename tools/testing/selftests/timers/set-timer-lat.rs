...
//! Source: tools/testing/selftests/timers/set-timer-lat.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn describe_timer(flags: c_int, interval: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn setup_timer(clock_id: c_int, flags: c_int, interval: c_int, tm1: *mut timer_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn check_timer_latency(flags: c_int, interval: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn check_alarmcount(flags: c_int, interval: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_timer(clock_id: c_int, flags: c_int) -> c_int {
    int do_timer(int clock_id, int flags)
    {
    timer_t tm1;
    let mut interval: c_int = TIMER_SECS;
    int err;
    err = setup_timer(clock_id, flags, interval, &tm1);
// Unsupported case - return 0 to not fail the test
    if (err)
    let mut err: return = = 1 ? 0 : err;
    while (alarmcount < 5)
    sleep(1);
    timer_delete(tm1);
...
#[no_mangle]
pub unsafe extern "C" fn do_timer_oneshot(clock_id: c_int, flags: c_int) -> c_int {
...
// Unsupported case - return 0 to not fail the test
    ...
    timeout.tv_sec = 5;
    do {
    err = select(0, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), &timeout);
...
pub unsafe extern "C" fn main() -> c_int {
    ...
    let mut ret: c_int = 0;
    let mut max_clocks: c_int = CLOCK_TAI + 1;
