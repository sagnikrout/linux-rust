...
//! Source: tools/testing/selftests/timers/valid-adjtimex.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn clock_adjtime(id: clockid_t, tx: *mut timex) -> c_int {
...
pub const NUM_FREQ_VALID: c_int = 32;
pub const NUM_FREQ_OUTOFRANGE: c_int = 4;
pub const NUM_FREQ_INVALID: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn validate_freq() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_offset(offset: c_longlong, use_nano: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_bad_offset(sec: c_long, usec: c_long, use_nano: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn validate_set_offset() -> c_int {
