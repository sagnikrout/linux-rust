...
//! Source: tools/testing/selftests/vDSO/vdso_test_chacha.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cpu_has_capabilities() -> bool {
...
#[no_mangle]
unsafe extern "C" fn rol32(word: u32, shift: c_uint) -> u32 {
    static uint32_t rol32(uint32_t word, unsigned int shift)
    {
    return (word << (shift & 31)) | (word >> ((-shift) & 31));
    }
#[no_mangle]
unsafe extern "C" fn reference_chacha20_blocks(dst_bytes: *mut u8, key: *const u32, counter: *mut u32, nblocks: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn __arch_chacha20_blocks_nostack(dst_bytes: *mut u8, key: *const u32, counter: *mut u32, nblocks: usize) -> void __weak {
