...
//! Source: tools/testing/selftests/pidfd/pidfd_getfd_test.c
#![no_std]
...
//
pub const UNKNOWN_FD: c_int = 111;
pub const UID_NOBODY: c_int = 65535;
...
#[no_mangle]
unsafe extern "C" fn __child(sk: c_int, memfd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn child(sk: c_int) -> c_int {
