...
//! Source: tools/testing/selftests/pidfd/pidfd_fdinfo_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn error_report(err: *mut error, test_name: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn error_check(err: *mut error, test_name: *const c_char) -> c_int {
...
pub const CHILD_STACK_SIZE: c_int = 8192;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct child {
    pub stack: *mut c_char,
    pub pid: pid_t,
    pub fd: c_int,
}
    ...
    struct error *err)
    {
    let mut flags: static int = CLONE_PIDFD | CLONE_NEWPID | CLONE_NEWNS | SIGCHLD;
    struct child ret;
    if (!(flags & CLONE_NEWUSER) && geteuid() != 0)
    flags |= CLONE_NEWUSER;
    ret.stack = mmap(core::ptr::null_mut(), CHILD_STACK_SIZE, PROT_READ | PROT_WRITE,
...
#[no_mangle]
pub unsafe extern "C" fn child_close(child: *mut child) {
    static inline void child_close(struct child *child)
    {
    close(child.fd);
    }
#[no_mangle]
pub unsafe extern "C" fn child_join(child: *mut child, err: *mut error) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn child_join_close(child: *mut child, err: *mut error) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn child_fdinfo_nspid_test(args: *mut c_void) -> c_int {
...
//
    r = mount(core::ptr::null_mut(), "/", core::ptr::null_mut(), MS_REC | MS_PRIVATE, 0);
    if (r < 0) {
    ksft_print_msg("Failed to remount / private\n");
    return PIDFD_ERROR;
    }
    (void)umount2("/proc", MNT_DETACH);
    r = mount("proc", "/proc", "proc", 0, core::ptr::null_mut());
    if (r < 0) {
...
#[no_mangle]
unsafe extern "C" fn test_pidfd_fdinfo_nspid() {
...
// Create a new child in a new pid and mount namespace
    a = clone_newns(child_fdinfo_nspid_test, core::ptr::null_mut(), &err);
...
#[no_mangle]
unsafe extern "C" fn test_pidfd_dead_fdinfo() {
