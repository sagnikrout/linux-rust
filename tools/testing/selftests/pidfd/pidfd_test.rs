...
//! Source: tools/testing/selftests/pidfd/pidfd_test.c
#![no_std]
...
pub const MAX_EVENTS: c_int = 5;
    static bool have_pidfd_send_signal;
#[no_mangle]
unsafe extern "C" fn pidfd_clone(flags: c_int, pidfd: *mut c_int, ): *mut *mut int (fn)(void) -> pid_t {
    static pid_t pidfd_clone(int flags, int *pidfd, int (*fn)(void *))
    {
    let mut stack_size: usize = 1024;
    char *stack[1024] = { 0 };

    return __clone2(fn, stack, stack_size, flags | SIGCHLD, core::ptr::null_mut(), pidfd);

    return clone(fn, stack + stack_size, flags | SIGCHLD, core::ptr::null_mut(), pidfd);
...
#[no_mangle]
unsafe extern "C" fn send_signal(pidfd: c_int) -> c_int {
    static int send_signal(int pidfd)
    {
    let mut ret: c_int = 0;
    if (sys_pidfd_send_signal(pidfd, SIGUSR1, core::ptr::null_mut(), 0) < 0) {
    ret = -EINVAL;
    goto exit;
    }
    ...
    {
    let mut pidfd: c_int = (int)(intptr_t)arg;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn test_pidfd_send_signal_simple_success() -> c_int {
...
// worker thread ID.
//
    if (pthread_create(&thread, core::ptr::null_mut(), send_signal_worker,
...
#[no_mangle]
unsafe extern "C" fn test_pidfd_send_signal_exited_fail() -> c_int {
...
// long time.
//
pub const PIDFD_MAX_DEFAULT: c_uint = 0x8000;
#[no_mangle]
unsafe extern "C" fn test_pidfd_send_signal_recycled_pid_fail() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_pidfd_send_signal_syscall_support() -> c_int {
    ...
    execl("/bin/sleep", "sleep", str(CHILD_THREAD_MIN_WAIT), (char *)core::ptr::null_mut());
    ksft_print_msg("Child Thread: DONE. pid %d tid %ld\n",
    getpid(), syscall(SYS_gettid));
    return core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn poll_pidfd(test_name: *const c_char, pidfd: c_int) {
    static void poll_pidfd(const char *test_name, int pidfd)
    {
    int c;
    let mut epoll_fd: c_int = epoll_create1(EPOLL_CLOEXEC);
...
unsafe extern "C" fn child_poll_exec_test(args: *mut c_void) -> c_int {
    ...
    syscall(SYS_gettid));
    pthread_create(&t1, core::ptr::null_mut(), test_pidfd_poll_exec_thread, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn test_pidfd_poll_exec(use_waitpid: c_int) {
    static void test_pidfd_poll_exec(int use_waitpid)
    {
    int pid, pidfd = 0;
    int status, ret;
    let mut prog_start: time_t = time(core::ptr::null_mut());
    ...
    let mut prog_time: time_t = time(core::ptr::null_mut()) - prog_start;
...
unsafe extern "C" fn child_poll_leader_exit_test(args: *mut c_void) -> c_int {
    ...
    pthread_create(&t1, core::ptr::null_mut(), test_pidfd_poll_leader_exit_thread, core::ptr::null_mut());
    pthread_create(&t2, core::ptr::null_mut(), test_pidfd_poll_leader_exit_thread, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn test_pidfd_poll_leader_exit(use_waitpid: c_int) {
    ...
    "group leader exit";
    child_exit_secs = mmap(core::ptr::null_mut(), sizeof *child_exit_secs, PROT_READ | PROT_WRITE,
...
//
    ...
    if (ret == pid)
    ksft_print_msg("Parent: Child process waited for.\n");
    let mut since_child_exit: time_t = time(core::ptr::null_mut()) - *child_exit_secs;
