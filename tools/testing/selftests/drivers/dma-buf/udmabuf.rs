...
//! Source: tools/testing/selftests/drivers/dma-buf/udmabuf.c
#![no_std]
...
pub const NUM_PAGES: c_int = 4;
pub const NUM_ENTRIES: c_int = 4;

    static unsigned int page_size;
#[no_mangle]
unsafe extern "C" fn create_memfd_with_seals(size: off64_t, hpage: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_udmabuf_list(devfd: c_int, memfd: c_int, memfd_size: off64_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_to_memfd(addr: *mut c_void, size: off64_t, chr: c_char) {
...
// ((char *)addr + (i * page_size)) = chr;
    ...
    {
    void *addr;
    addr = mmap(core::ptr::null_mut(), size, PROT_READ|PROT_WRITE, MAP_SHARED, fd, 0);
    if (addr == MAP_FAILED) {
...
#[no_mangle]
unsafe extern "C" fn compare_chunks(addr1: *mut c_void, addr2: *mut c_void, memfd_size: off64_t) -> c_int {
    static int compare_chunks(void *addr1, void *addr2, off64_t memfd_size)
    {
    off64_t off;
    let mut i: c_int = 0, j, k = 0, ret = 0;
    char char1, char2;
    while (i < NUM_ENTRIES) {
