...
//! Source: tools/testing/selftests/livepatch/test_modules/test_klp_mod_target.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_klp_mod_target_show(m: *mut seq_file, v: *mut c_void) -> noinline int {
...
unsafe extern "C" fn test_klp_mod_target_init() -> c_int {
    ...
    {
    pr_info("%s\n", __func__);
    pde = proc_create_single("test_klp_mod_target", 0, core::ptr::null_mut(),
