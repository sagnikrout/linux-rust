...
//! Source: tools/testing/selftests/livepatch/test_modules/test_klp_atomic_replace.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn livepatch_meminfo_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
