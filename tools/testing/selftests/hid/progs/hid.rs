...
//! Source: tools/testing/selftests/hid/progs/hid.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_first_event, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __hid_subprog_first_event(hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_subprog_first_event, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_second_event, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_change_report_id, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
...
// data needs to come at offset 0 so we can use it in calls
    ...
    pub retval: c_int,
    pub size: usize,
    pub type: enum hid_report_type,
    pub request_type: __u8,
}

    SEC("syscall")
#[no_mangle]
pub unsafe extern "C" fn hid_user_raw_request(args: *mut hid_hw_request_syscall_args) -> c_int {
    int hid_user_raw_request(struct hid_hw_request_syscall_args *args)
    {
    struct hid_bpf_ctx *ctx;
    let mut size: usize = args.size;
    int i, ret = 0;
    ...
    SEC("syscall")
#[no_mangle]
pub unsafe extern "C" fn hid_user_output_report(args: *mut hid_hw_request_syscall_args) -> c_int {
    ...
    SEC("syscall")
#[no_mangle]
pub unsafe extern "C" fn hid_user_input_report(args: *mut hid_hw_request_syscall_args) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_rdesc_fixup, hid_ctx: *mut hid_bpf_ctx) -> c_int {
...
// Change Usage Vendor globally
    ...
    SEC("?struct_ops.s/hid_rdesc_fixup")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_rdesc_fixup_get_data_overflow, hid_ctx: *mut hid_bpf_ctx) -> c_int {
    ...
    SEC("?struct_ops.s/hid_rdesc_fixup")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_rdesc_fixup_change_uniq_name_phys, hid_ctx: *mut hid_bpf_ctx) -> c_int {
...
// hid_bpf relies on a phys being a rand % 1024
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_test_insert1, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
...
// we need to be run first
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_test_insert2, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
...
// after insert0 and before insert2
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_test_insert3, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hidraw_open, inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_test_hidraw_output_report, hctx: *mut hid_bpf_ctx, source: __u64) -> c_int {
...
// check if the incoming request comes from our hidraw operation
    ...
    SEC("?struct_ops.s/hid_hw_output_report")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_test_infinite_loop_output_report, hctx: *mut hid_bpf_ctx, source: __u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wq_cb_sleepable(map: *mut c_void, key: *mut c_int, work: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_inject_input_report_callback(key: *mut c_int) -> c_int {
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_test_multiply_events_wq, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
    ...
    let mut hid: c_int = hid_ctx.hid.id;
    int ret;
    if (!data)
    return 0; /* EPERM check */
    if (data[0] != 1)
    ...
    SEC("?struct_ops/hid_device_event")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_test_multiply_events, hid_ctx: *mut hid_bpf_ctx, type: enum hid_report_type) -> c_int {
