...
//! Source: tools/testing/selftests/hid/hid_bpf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn detach_bpf(self: *mut *mut FIXTURE_DATA(hid_bpf)) {
...
pub struct test_program {
    ...
    load_programs(core::ptr::null_mut(), 0, false, _metadata, self, variant)
...
#[no_mangle]
pub unsafe extern "C" fn FIXTURE_VARIANT(variant: *mut *mut hid_bpf)) -> const {
...
//
    ...
    {
    let mut rpt_desc: hidraw_report_descriptor = {0};
    const struct test_program progs[] = {
