...
//! Source: tools/testing/selftests/hid/hidraw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn close_hidraw(self: *mut *mut FIXTURE_DATA(hidraw)) {
...
// call the revoke ioctl
    err = ioctl(self.hidraw_fd, HIDIOCREVOKE, core::ptr::null_mut());
