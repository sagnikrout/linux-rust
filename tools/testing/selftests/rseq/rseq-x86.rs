...
//! Source: tools/testing/selftests/rseq/rseq-x86.h
#![no_std]
...
//
pub const RSEQ_SIG: c_uint = 0x53053053;
//
...
pub const RSEQ_CPU_ID_OFFSET: c_int = 4;
pub const RSEQ_CS_OFFSET: c_int = 8;
pub const RSEQ_MM_CID_OFFSET: c_int = 24;
