...
//! Source: tools/testing/selftests/net/netfilter/conntrack_dump_flush.c
#![no_std]
...
pub const TEST_ZONE_ID: c_int = 123;
pub const NF_CT_DEFAULT_ZONE_ID: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn build_cta_proto(nlh: *mut nlmsghdr) -> c_int {
    ...
    ret = mnl_cb_run(buf, ret, nlh.nlmsg_seq, portid, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret < 0) {
    if (errno == EEXIST) {
...
//
    ...
    nlh.nlmsg_seq = time(core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn count_entries(nlh: *const nlmsghdr, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn conntrack_count_zone(sock: *mut mnl_socket, zone: u16) -> c_int {
    ...
    count_entries, core::ptr::null_mut());
    if (ret <= MNL_CB_STOP)
    break;
    ret = mnl_socket_recvfrom(sock, buf, MNL_SOCKET_BUFFER_SIZE);
    }
...
#[no_mangle]
unsafe extern "C" fn conntrack_flush_zone(sock: *mut mnl_socket, zone: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(EOPNOTSUPP: ret < 0 && errno ==) -> else {
