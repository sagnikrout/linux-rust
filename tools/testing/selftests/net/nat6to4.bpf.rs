...
//! Source: tools/testing/selftests/net/nat6to4.bpf.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn sched_cls_ingress6_nat_6_prog(skb: *mut __sk_buff) -> c_int {
    int sched_cls_ingress6_nat_6_prog(struct __sk_buff *skb)
    {
    let mut l2_header_size: c_int = sizeof(struct ethhdr);
    void *data = (void *)(long)skb.data;
    const void *data_end = (void *)(long)skb.data_end;
    const struct ethhdr * const eth = data;  // used iff is_ethernet
    let mut ip6: *const ipv6hdr  const = (void *)(eth + 1);
...
#[no_mangle]
pub unsafe extern "C" fn sched_cls_egress4_snat4_prog(skb: *mut __sk_buff) -> c_int {
    ...
    const void *data_end = (void *)(long)skb.data_end;
    const struct ethhdr *const eth = data;  // used iff is_ethernet
    let mut ip4: *const iphdr const = (void *)(eth + 1);
