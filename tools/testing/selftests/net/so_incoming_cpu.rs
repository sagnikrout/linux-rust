...
//! Source: tools/testing/selftests/net/so_incoming_cpu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn setup_netns(_metadata: *mut __test_metadata) {
...
pub const NR_CLIENT_PER_SERVER_DEFAULT: c_int = 32;
    ...
    ASSERT_NE(self.servers, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn set_so_incoming_cpu(_metadata: *mut __test_metadata, fd: c_int, cpu: c_int) {
...
//
    ...
    FIXTURE_DATA(so_incoming_cpu) *self,
#[no_mangle]
pub unsafe extern "C" fn FIXTURE_VARIANT(variant: *mut so_incoming_cpu)) -> const {
    const FIXTURE_VARIANT(so_incoming_cpu) *variant)
    {
    int i, ret;
    for (i = 0; i < nr_server; i++) {
