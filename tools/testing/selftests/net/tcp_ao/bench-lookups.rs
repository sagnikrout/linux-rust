...
//! Source: tools/testing/selftests/net/tcp_ao/bench-lookups.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gen_test_ips(ips: *mut union tcp_addr, ips_nr: usize, use_rand: bool) {
    ...
    for (i = 0; i < ips_nr; i++) {
    let mut r: usize = (size_t)random() | 0x1;
...
#[no_mangle]
unsafe extern "C" fn test_add_routes(ips: *mut union tcp_addr, ips_nr: usize) {
...
#[no_mangle]
unsafe extern "C" fn server_apply_keys(lsk: c_int, ips: *mut union tcp_addr, ips_nr: usize) {
...
#[no_mangle]
unsafe extern "C" fn delete_mkt(sk: c_int, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn add_back_mkt(sk: c_int, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bench_connect_srv(lsk: c_int, ips: *mut union tcp_addr, ips_nr: usize) {
...
#[no_mangle]
unsafe extern "C" fn test_print_stats(desc: *const c_char, nr: usize, bs: *mut bench_stats) {
...
#[no_mangle]
unsafe extern "C" fn connect_client(sk: c_int, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn client_addr_setup(sk: c_int, taddr: union tcp_addr) {
