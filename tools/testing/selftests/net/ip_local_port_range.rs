...
//! Source: tools/testing/selftests/net/ip_local_port_range.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pack_port_range(lo: __u16, hi: __u16) -> __u32 {
    static __u32 pack_port_range(__u16 lo, __u16 hi)
    {
    return (hi << 16) | (lo << 0);
    }
#[no_mangle]
unsafe extern "C" fn unpack_port_range(range: __u32, lo: *mut __u16, hi: *mut __u16) {
...
#[no_mangle]
unsafe extern "C" fn get_so_domain(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bind_to_loopback_any_port(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_sock_port(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ip_local_port_range(fd: c_int, range: *mut __u32) -> c_int {
