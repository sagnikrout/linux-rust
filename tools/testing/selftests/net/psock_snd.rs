...
//! Source: tools/testing/selftests/net/psock_snd.c
#![no_std]
...
// Macro flag: #define _GNU_SOURCE
    ...
    let mut cfg_mtu: static int = 1500;
    let mut cfg_payload_len: static int = DATA_LEN;
    let mut cfg_truncate_len: static int = INT_MAX;
    let mut cfg_port: static uint16_t = 8000;
// test sending up to max mtu + 1

    static char tbuf[TEST_SZ], rbuf[TEST_SZ];
#[no_mangle]
unsafe extern "C" fn add_csum_hword(start: *const u16, num_u16: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn build_vnet_header(header: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_eth_header(header: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_ipv4_header(header: *mut c_void, payload_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_udp_header(header: *mut c_void, payload_len: c_int) -> c_int {
    static int build_udp_header(void *header, int payload_len)
    {
    let mut alen: c_int = sizeof(uint32_t);
...
#[no_mangle]
unsafe extern "C" fn build_packet(payload_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_bind_proto(fd: c_int, proto: u16) {
...
#[no_mangle]
unsafe extern "C" fn do_bind(fd: c_int) {
    static void do_bind(int fd)
    {
    do_bind_proto(fd, ETH_P_IP);
    }
#[no_mangle]
unsafe extern "C" fn do_send(fd: c_int, buf: *mut c_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_tx() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_aux_data(cmsg: *mut cmsghdr, expected_len: c_int) {
...
// expected_pkttype < 0 skips the sll_pkttype check.
    ...
    let mut aux: bool = is_psock && cfg_aux_data;
    let mut saddr: sockaddr_ll = {};
    struct iovec iov = {
    .iov_base = rbuf,
    .iov_len = sizeof(rbuf),
    };
...
#[no_mangle]
unsafe extern "C" fn setup_sniffer() -> c_int {
...
unsafe extern "C" fn parse_opts(argc: c_int, argv: *mut c_char) {
    ...
    break;
    case 't':
    cfg_truncate_len = strtoul(optarg, core::ptr::null_mut(), 0);
    break;
    case 'v':
    cfg_use_vnet = true;
    break;
...
#[no_mangle]
unsafe extern "C" fn check_packet_stats(fd: c_int, expected_packets: c_uint) {
    static void check_packet_stats(int fd, unsigned int expected_packets)
    {
    let mut st: tpacket_stats = {};
    let mut len: socklen_t = sizeof(st);
...
#[no_mangle]
unsafe extern "C" fn set_ignore_outgoing(fd: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn check_ignore_outgoing_range(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_ignore_outgoing(fds: c_int) {
