...
//! Source: tools/testing/selftests/net/lib/xdp_metadata.bpf.c
#![no_std]
...
//
    ...
    SEC("xdp")
#[no_mangle]
pub unsafe extern "C" fn xdp_rss_hash(ctx: *mut xdp_md) -> c_int {
    int xdp_rss_hash(struct xdp_md *ctx)
    {
    void *data_end = (void *)(long)ctx.data_end;
    void *data = (void *)(long)ctx.data;
    let mut rss_type: enum xdp_rss_hash_type = 0;
    struct ethhdr *eth = data;
    let mut l4_proto: __u8 = 0;
    let mut hash: __u32 = 0;
    __u32 key, val;
    void *l4 = core::ptr::null_mut();
    __u32 *cnt;
    int ret;
...
//
    ...
    let mut dest: __u16 = get_dest_port(l4, data_end, l4_proto);
