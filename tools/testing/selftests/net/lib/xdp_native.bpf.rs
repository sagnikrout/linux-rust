...
//! Source: tools/testing/selftests/net/lib/xdp_native.bpf.c
#![no_std]
...
pub const MAX_ADJST_OFFSET: c_int = 256;
pub const MAX_PAYLOAD_LEN: c_int = 5000;
pub const MAX_HDR_LEN: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn min(a: __u32, b: __u32) -> __u32 {
    static __u32 min(__u32 a, __u32 b)
    {
    return a < b ? a : b;
    }
#[no_mangle]
unsafe extern "C" fn record_stats(ctx: *mut xdp_md, stat_type: __u32) {
    ...
    {
    struct udphdr *udph = core::ptr::null_mut();
    void *data, *data_end;
    struct ethhdr *eth;
    int err;
...
#[no_mangle]
unsafe extern "C" fn xdp_mode_pass(ctx: *mut xdp_md, port: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xdp_mode_drop_handler(ctx: *mut xdp_md, port: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn swap_machdr(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn xdp_mode_tx_handler(ctx: *mut xdp_md, port: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csum_fold_udp_helper(csum: __u32) -> __always_inline __u16 {
...
#[no_mangle]
unsafe extern "C" fn xdp_adjst_tail_grow_data(ctx: *mut xdp_md, offset: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xdp_adjst_tail(ctx: *mut xdp_md, port: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xdp_head_adjst(ctx: *mut xdp_md, port: __u16) -> c_int {
    static int xdp_head_adjst(struct xdp_md *ctx, __u16 port)
    {
    struct udphdr *udph_ptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xdp_prog_common(ctx: *mut xdp_md) -> c_int {
...
// Default action is to simple pass
    ...
    SEC("xdp")
#[no_mangle]
pub unsafe extern "C" fn xdp_prog(ctx: *mut xdp_md) -> c_int {
    ...
    SEC("xdp.frags")
#[no_mangle]
pub unsafe extern "C" fn xdp_prog_frags(ctx: *mut xdp_md) -> c_int {
