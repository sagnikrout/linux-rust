...
//! Source: tools/testing/selftests/net/bind_wildcard.c
#![no_std]
...
// Copyright Amazon.com Inc. or its affiliates.
    ...
    let mut in4addr_any: static __u32 = INADDR_ANY;
    let mut in4addr_loopback: static __u32 = INADDR_LOOPBACK;
