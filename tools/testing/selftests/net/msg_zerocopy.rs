...
//! Source: tools/testing/selftests/net/msg_zerocopy.c
#![no_std]
...
pub const MSG_ZEROCOPY: c_uint = 0x4000000;
    ...
    let mut cfg_expect_zerocopy: static int = -1;
    let mut cfg_family: static int = PF_UNSPEC;
    let mut cfg_ifindex: static int = 1;
    static int  cfg_payload_len;
    let mut cfg_port: static int = 8000;
    static bool cfg_rx;
    let mut cfg_runtime_ms: static int = 4200;
    static int  cfg_verbose;
    let mut cfg_waittime_ms: static int = 500;
    let mut cfg_notification_limit: static int = 32;
...
#[no_mangle]
unsafe extern "C" fn get_ip_csum(start: *const u16, num_words: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn do_setcpu(cpu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cfg_verbose) -> else {
    else if (cfg_verbose)
...
#[no_mangle]
unsafe extern "C" fn do_poll(fd: c_int, events: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_accept(fd: c_int) -> c_int {
    static int do_accept(int fd)
    {
    let mut fda: c_int = fd;
    fd = accept(fda, core::ptr::null_mut(), core::ptr::null_mut());
    if (fd == -1)
...
#[no_mangle]
unsafe extern "C" fn add_zcopy_cookie(msg: *mut msghdr, cookie: u32) {
    static void add_zcopy_cookie(struct msghdr *msg, uint32_t cookie)
    {
    struct cmsghdr *cm;
    if (!msg.msg_control)
    error(1, errno, "core::ptr::null_mut() cookie");
...
#[no_mangle]
unsafe extern "C" fn do_sendmsg(fd: c_int, msg: *mut msghdr, do_zerocopy: bool, domain: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_sendmsg_corked(fd: c_int, msg: *mut msghdr) {
...
#[no_mangle]
unsafe extern "C" fn setup_iph(iph: *mut iphdr, payload_len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_ip6h(ip6h: *mut ipv6hdr, payload_len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_process_zerocopy_cookies(ck: *mut rds_zcopy_cookies) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn do_recvmsg_completion(fd: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_recv_completion(fd: c_int, domain: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_recv_completions(fd: c_int, domain: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_recv_remaining_completions(fd: c_int, domain: c_int) {
    static void do_recv_remaining_completions(int fd, int domain)
    {
    let mut tstop: i64 = gettimeofday_ms() + cfg_waittime_ms;
...
unsafe extern "C" fn do_tx(domain: c_int, type: c_int, protocol: c_int) {
    ...
    if (domain == PF_PACKET) {
    let mut proto: u16 = cfg_family == PF_INET ? ETH_P_IP : ETH_P_IPV6;
...
#[no_mangle]
unsafe extern "C" fn do_setup_rx(domain: c_int, type: c_int, protocol: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_flush_datagram(fd: c_int, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_rx(domain: c_int, type: c_int, protocol: c_int) {
    static void do_rx(int domain, int type, int protocol)
    {
    let mut cfg_receiver_wait_ms: c_int = 400;
    uint64_t tstop;
    int fd;
...
unsafe extern "C" fn parse_opts(argc: c_int, argv: *mut c_char) {
    ...
    break;
    case 'C':
    cfg_cpu = strtol(optarg, core::ptr::null_mut(), 0);
    break;
    case 'D':
    daddr = optarg;
    break;
    ...
    break;
    case 'l':
    cfg_notification_limit = strtoul(optarg, core::ptr::null_mut(), 0);
    break;
    case 'm':
    cfg_cork_mixed = true;
    break;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(cfg_test, _arg: "packet_dgram")) -> else {
    else if (!strcmp(cfg_test, "packet_dgram"))
    do_test(PF_PACKET, SOCK_DGRAM, 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(cfg_test, _arg: "raw")) -> else {
    else if (!strcmp(cfg_test, "raw"))
    do_test(cfg_family, SOCK_RAW, IPPROTO_EGP);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(cfg_test, _arg: "raw_hdrincl")) -> else {
    else if (!strcmp(cfg_test, "raw_hdrincl"))
    do_test(cfg_family, SOCK_RAW, IPPROTO_RAW);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(cfg_test, _arg: "tcp")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(cfg_test, _arg: "rds")) -> else {
