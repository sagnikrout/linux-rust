...
//! Source: tools/testing/selftests/net/psock_fanout.c
#![no_std]
...
pub const RING_NUM_FRAMES: c_int = 20;
    static uint32_t cfg_max_num_members;
#[no_mangle]
unsafe extern "C" fn loopback_set_up_down(state_up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sock_fanout_open(typeflags: u16, group_id: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sock_fanout_set_cbpf(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sock_fanout_getopts(fd: c_int, typeflags: *mut u16, group_id: *mut u16) {
    static void sock_fanout_getopts(int fd, uint16_t *typeflags, uint16_t *group_id)
    {
    int sockopt;
    let mut sockopt_len: socklen_t = sizeof(sockopt);
...
#[no_mangle]
unsafe extern "C" fn sock_fanout_set_ebpf(fd: c_int) {
    static void sock_fanout_set_ebpf(int fd)
    {
    static char log_buf[65536];
    let mut len_off: c_int = __builtin_offsetof(struct __sk_buff, len);
...
#[no_mangle]
unsafe extern "C" fn sock_fanout_read_ring(fd: c_int, ring: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sock_fanout_read(fds[]: c_int, rings[]: *mut c_char, expect[]: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_unbound_fanout() {
...
#[no_mangle]
unsafe extern "C" fn test_control_single() {
...
#[no_mangle]
unsafe extern "C" fn test_control_group(toggle: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_control_group_max_num_members() {
...
#[no_mangle]
unsafe extern "C" fn test_unique_fanout_group_ids() {
    ...
    char *rings[2];
    let mut type: u8 = typeflags & 0xFF;
...
#[no_mangle]
pub unsafe extern "C" fn if(PACKET_FANOUT_EBPF: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_cpuaffinity(cpuid: c_int) -> c_int {
...
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    let mut port_off: c_int = 2, tries = 20, ret;
    test_unbound_fanout();
    test_control_single();
