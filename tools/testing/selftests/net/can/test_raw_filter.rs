...
//! Source: tools/testing/selftests/net/can/test_raw_filter.c
#![no_std]
...
pub const ID: c_uint = 0x123;
    char CANIF[IFNAMSIZ];
#[no_mangle]
unsafe extern "C" fn send_can_frames(sock: c_int, testcase: c_int) -> c_int {
...
//
    ...
    ret = select(self.sock + 1, &rdfs, core::ptr::null_mut(), core::ptr::null_mut(), &tv);
    ASSERT_GE(ret, 0)
