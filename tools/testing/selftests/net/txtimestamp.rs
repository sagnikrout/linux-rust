...
//! Source: tools/testing/selftests/net/txtimestamp.c
#![no_std]
...
// command line parameters
    let mut cfg_proto: static int = SOCK_STREAM;
    let mut cfg_ipproto: static int = IPPROTO_TCP;
    let mut cfg_num_pkts: static int = 4;
    let mut do_ipv4: static int = 1;
    let mut do_ipv6: static int = 1;
    let mut cfg_payload_len: static int = 10;
    let mut cfg_poll_timeout: static int = 100;
    static int cfg_delay_snd;
    static int cfg_delay_ack;
    let mut cfg_delay_tolerance_usec: static int = 500;
    static bool cfg_show_payload;
    static bool cfg_do_pktinfo;
    static bool cfg_busy_poll;
    let mut cfg_sleep_usec: static int = 50 * 1000;
    ...
    let mut dest_port: static uint16_t = 9000;
    ...
    let mut saved_tskey: static int = -1;
    let mut saved_tskey_type: static int = -1;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn timespec_to_us64(ts: *mut timespec) -> i64 {
    static int64_t timespec_to_us64(struct timespec *ts)
    {
    return ts.tv_sec * USEC_PER_SEC + ts.tv_nsec / NSEC_PER_USEC;
    }
#[no_mangle]
unsafe extern "C" fn init_timing_event(te: *mut timing_event) {
    ...
    {
    let mut ts_delta: i64 = timespec_to_ns64(t_end) - timespec_to_ns64(t_start);
    te.count++;
    if (ts_delta < te.min)
    te.min = ts_delta;
    if (ts_delta > te.max)
...
#[no_mangle]
pub unsafe extern "C" fn if(tstype: saved_tskey_type !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn validate_timestamp(cur: *mut timespec, min_delay: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __print_ts_delta_formatted(ts_delta: i64) {
...
#[no_mangle]
unsafe extern "C" fn record_timestamp_usr() {
    ...
    {
    const char *tsname = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn print_timing_event(name: *mut c_char, te: *mut timing_event) {
...
#[no_mangle]
unsafe extern "C" fn print_payload(data: *mut c_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn print_pktinfo(family: c_int, ifindex: c_int, saddr: *mut c_void, daddr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __epoll(epfd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __poll(fd: c_int) {
...
unsafe extern "C" fn __recv_errmsg_cmsg(msg: *mut msghdr, payload_len: c_int) {
    ...
    core::ptr::null_mut(), &info6.ipi6_addr);
    } else
...
#[no_mangle]
unsafe extern "C" fn recv_errmsg(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_udp_csum(udph: *const udphdr, alen: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn fill_header_ipv4(p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fill_header_ipv6(p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fill_header_udp(p: *mut c_void, is_ipv4: bool) {
...
#[no_mangle]
unsafe extern "C" fn do_test(family: c_int, report_opt: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn __attribute__(filepath: *const (noreturn)) usage(char) {
...
#[no_mangle]
unsafe extern "C" fn parse_opt(argc: c_int, argv: *mut c_char) {
    static void parse_opt(int argc, char **argv)
    {
    let mut proto_count: c_int = 0;
    int c;
    ...
    break;
    case 'c':
    cfg_num_pkts = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 'C':
    cfg_use_cmsg = true;
    break;
    ...
    break;
    case 'l':
    cfg_payload_len = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 'L':
    cfg_do_listen = true;
    break;
    ...
    break;
    case 'o':
    ts_opt_id = strtoul(optarg, core::ptr::null_mut(), 10);
    cfg_use_cmsg_opt_id = true;
    break;
    case 'p':
    dest_port = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 'P':
    proto_count++;
    ...
    break;
    case 'S':
    cfg_sleep_usec = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 't':
    cfg_delay_tolerance_usec = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 'u':
    proto_count++;
    cfg_proto = SOCK_DGRAM;
    ...
    break;
    case 'v':
    cfg_delay_snd = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 'V':
    cfg_delay_ack = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 'x':
...
#[no_mangle]
unsafe extern "C" fn resolve_hostname(hostname: *const c_char) {
    static void resolve_hostname(const char *hostname)
    {
    let mut hints: addrinfo = { .ai_family = do_ipv4 ? AF_INET : AF_INET6 };
    struct addrinfo *addrs, *cur;
    let mut have_ipv4: c_int = 0, have_ipv6 = 0;
    retry:
    if (getaddrinfo(hostname, core::ptr::null_mut(), &hints, &addrs))
...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: !have_ipv6 && cur->ai_family ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn do_listen(family: c_int, addr: *mut c_void, alen: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_main(family: c_int) {
    ...
    const char *sock_names[] = { core::ptr::null_mut(), "TCP", "UDP", "RAW" };
#[no_mangle]
