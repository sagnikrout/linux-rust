...
pub const NUM_PKT: c_int = 100;
    static bool	cfg_cache_trash;
    let mut cfg_cpu: static int = -1;
    let mut cfg_connected: static int = true;
    let mut cfg_family: static int = PF_UNSPEC;
    static uint16_t	cfg_mss;
    let mut cfg_payload_len: static int = (1472 * 42);
    let mut cfg_port: static int = 8000;
    let mut cfg_runtime_ms: static int = -1;
    static bool	cfg_poll;
    let mut cfg_poll_loop_timeout_ms: static int = 2000;
    static bool	cfg_segment;
    static bool	cfg_sendmmsg;
    static bool	cfg_tcp;
    let mut cfg_tx_ts: static uint32_t = SOF_TIMESTAMPING_TX_SOFTWARE;
...
#[no_mangle]
unsafe extern "C" fn set_cpu(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flush_cmsg(cmsg: *mut cmsghdr) {
...
#[no_mangle]
unsafe extern "C" fn flush_errqueue_recv(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn flush_errqueue_retry(fd: c_int, num_sends: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn send_tcp(fd: c_int, data: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_udp(fd: c_int, data: *mut c_char) -> c_int {
    ...
    cfg_connected ? core::ptr::null_mut() : (void *)&cfg_dst_addr,
...
#[no_mangle]
unsafe extern "C" fn send_ts_cmsg(cm: *mut cmsghdr) {
...
#[no_mangle]
unsafe extern "C" fn send_udp_segment_cmsg(cm: *mut cmsghdr) {
...
#[no_mangle]
unsafe extern "C" fn send_udp_segment(fd: c_int, data: *mut c_char) -> c_int {
...
unsafe extern "C" fn parse_opts(argc: c_int, argv: *mut c_char) {
    ...
    break;
    case 'l':
    cfg_runtime_ms = strtoul(optarg, core::ptr::null_mut(), 10) * 1000;
    break;
    case 'L':
    cfg_poll_loop_timeout_ms = strtoul(optarg, core::ptr::null_mut(), 10) * 1000;
    break;
    case 'm':
    cfg_sendmmsg = true;
    break;
    case 'M':
    cfg_msg_nr = strtoul(optarg, core::ptr::null_mut(), 10);
    break;
    case 'p':
    ...
    break;
    case 'S':
    cfg_gso_size = strtoul(optarg, core::ptr::null_mut(), 0);
    cfg_segment = true;
    break;
    case 'H':
...
#[no_mangle]
unsafe extern "C" fn set_tx_timestamping(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn print_audit_report(num_msgs: c_ulong, num_sends: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_report(num_msgs: c_ulong, num_sends: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cfg_segment) -> else {
    else if (cfg_segment)
    num_sends += send_udp_segment(fd, buf[i]);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cfg_sendmmsg) -> else {
