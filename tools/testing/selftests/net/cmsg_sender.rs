...
//! Source: tools/testing/selftests/net/cmsg_sender.c
#![no_std]
...
pub struct options {
    ...
    pub proto: c_uint,
    pub sock: },
    pub mark: option_cmsg_u32,
    pub priority: option_cmsg_u32,
    struct {
    pub ena: bool,
    pub delay: c_uint,
    pub txtime: },
    ...
    pub ts: },
    struct {
    pub dontfrag: option_cmsg_u32,
    pub tclass: option_cmsg_u32,
    pub hlimit: option_cmsg_u32,
    pub exthdr: option_cmsg_u32,
    pub cmsg: },
    } opt = {
    .size = 13,
    .num_pkt = 1,
...
#[no_mangle]
unsafe extern "C" fn __attribute__(bin: *const (noreturn)) cs_usage(char) {
...
#[no_mangle]
unsafe extern "C" fn cs_parse_args(argc: c_int, argv[]: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn ca_set_sockopts(fd: c_int) {
...
pub unsafe extern "C" fn main(argc: c_int, argv[]: *mut c_char) -> c_int {
    ...
    let mut hdr: udphdr = { 1, 2, htons(opt.size), 0 };
    ...
    if (opt.msg_more) {
    err = write(fd, core::ptr::null_mut(), 0);
    if (err < 0) {
