...
//! Source: tools/testing/selftests/net/ioam6_parser.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn str2id(tname: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_addr_equal(a1: *const in6_addr, a2: *const in6_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_u32(val: *mut __u32, arg: *const c_char, base: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_u16(val: *mut __u16, arg: *const c_char, base: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_u8(val: *mut __u8, arg: *const c_char, base: c_int) -> c_int {
