...
//! Source: tools/testing/selftests/net/reuseport_bpf_numa.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn is_cpuless_node(node_id: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn send_from_node(node_id: c_int, family: c_int, proto: c_int) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn receive_on_node(rcv_fd: *mut c_int, len: c_int, epfd: c_int, node_id: c_int, proto: c_int) {
