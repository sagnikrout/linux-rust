...
//! Source: tools/testing/selftests/net/nettest.c
#![no_std]
...
pub const DEFAULT_PORT: c_int = 12345;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sock_args {
// local address
    pub local_addr_str: *const c_char,
    pub client_local_addr_str: *const c_char,
    union {
    pub in: in_addr,
    pub in6: in6_addr,
    pub local_addr: },
// remote address
    pub remote_addr_str: *const c_char,
    union {
    pub in: in_addr,
    pub in6: in6_addr,
    pub remote_addr: },
    pub /: *mut *mut int scope_id; / remote scope; v6 send only,
    pub /: *mut *mut in_addr grp; / multicast group,
    ...
    client_dontroute:1,
    pub port: c_ushort,
    pub /: *mut *mut int type; / DGRAM, STREAM, RAW,
    pub protocol: c_int,
    pub /: *mut *mut int version; / AF_INET/AF_INET6,
    pub use_setsockopt: c_int,
    pub use_freebind: c_int,
    pub use_cmsg: c_int,
    pub dsfield: u8,
    pub dev: *const c_char,
    pub server_dev: *const c_char,
    pub ifindex: c_int,
    pub clientns: *const c_char,
    pub serverns: *const c_char,
    pub password: *const c_char,
    pub client_pw: *const c_char,
// prefix for MD5 password
    pub md5_prefix_str: *const c_char,
    union {
    pub v4: sockaddr_in,
    pub v6: sockaddr_in6,
    pub md5_prefix: },
    pub prefix_len: c_uint,
// 0: default, -1: force off, +1: force on
    pub bind_key_ifindex: c_int,
// expected addresses and device index for connection
    pub expected_dev: *const c_char,
    pub expected_server_dev: *const c_char,
    pub expected_ifindex: c_int,
// local address
    pub expected_laddr_str: *const c_char,
    union {
    pub in: in_addr,
    pub in6: in6_addr,
    pub expected_laddr: },
// remote address
    pub expected_raddr_str: *const c_char,
    union {
    pub in: in_addr,
    pub in6: in6_addr,
    pub expected_raddr: },
...
// use send() and connect() instead of sendto
    pub datagram_connect: c_int,
}

    static int server_mode;
    let mut prog_timeout: static unsigned int = 5;
    static unsigned int interactive;
    let mut iter: static int = 1;
    static char *msg = "Hello world!";
    static int msglen;
    static int quiet;
    let mut try_broadcast: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn log_msg(format: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn log_error(format: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn log_err_errno(fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn log_address(desc: *const c_char, sa: *mut sockaddr) {
...
#[no_mangle]
unsafe extern "C" fn switch_ns(ns: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcp_md5sig(sd: c_int, addr: *mut c_void, alen: socklen_t, args: *mut sock_args) -> c_int {
    static int tcp_md5sig(int sd, void *addr, socklen_t alen, struct sock_args *args)
    {
    let mut keylen: c_int = strlen(args.password);
    let mut md5sig: tcp_md5sig = {};
    let mut opt: c_int = TCP_MD5SIG;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn tcp_md5_remote(sd: c_int, args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ifidx(ifname: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bind_to_device(sd: c_int, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_bind_to_device(sd: c_int, name: *mut c_char, len: usize) -> c_int {
    static int get_bind_to_device(int sd, char *name, size_t len)
    {
    int rc;
    let mut optlen: socklen_t = len;
    name[0] = '\0';
...
#[no_mangle]
unsafe extern "C" fn check_device(sd: c_int, args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_pktinfo_v4(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_recvpktinfo_v6(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_recverr_v4(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_recverr_v6(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_unicast_if(sd: c_int, ifindex: c_int, version: c_int) -> c_int {
    static int set_unicast_if(int sd, int ifindex, int version)
    {
    let mut opt: c_int = IP_UNICAST_IF;
    let mut level: c_int = SOL_IP;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn set_multicast_if(sd: c_int, ifindex: c_int) -> c_int {
    static int set_multicast_if(int sd, int ifindex)
    {
    let mut mreq: ip_mreqn = { .imr_ifindex = ifindex };
    int rc;
...
#[no_mangle]
unsafe extern "C" fn set_membership(sd: c_int, grp: u32, addr: u32, ifindex: c_int) -> c_int {
    static int set_membership(int sd, uint32_t grp, uint32_t addr, int ifindex)
    {
    let mut if_addr: u32 = addr;
...
#[no_mangle]
unsafe extern "C" fn set_freebind(sd: c_int, version: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_broadcast(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_reuseport(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_reuseaddr(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_dsfield(sd: c_int, version: c_int, dsfield: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_dontroute(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn str_to_uint(str: *const c_char, min: c_int, max: c_int, value: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn resolve_devices(args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_sockstat(sd: c_int, args: *mut sock_args) -> c_int {
    static int show_sockstat(int sd, struct sock_args *args)
    {
    struct sockaddr_in6 local_addr, remote_addr;
    let mut alen: socklen_t = sizeof(local_addr);
    struct sockaddr *sa;
    const char *desc;
    let mut rc: c_int = 0;
    ...
    {
    let mut pfx_len_max: c_int = args.version == AF_INET6 ? 128 : 32;
    let mut family: c_int = args.version;
    char *str, *dev, *sep;
    struct in6_addr *in6;
    struct in_addr  *in;
    const char *desc;
...
#[no_mangle]
unsafe extern "C" fn validate_addresses(args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_index_from_cmsg(m: *mut msghdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_msg_no_cmsg(sd: c_int, addr: *mut c_void, alen: socklen_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_msg(sd: c_int, addr: *mut c_void, alen: socklen_t, args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn socket_read_stream(sd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn socket_read(sd: c_int, args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stdin_to_socket(sd: c_int, type: c_int, addr: *mut c_void, alen: socklen_t) -> c_int {
    static int stdin_to_socket(int sd, int type, void *addr, socklen_t alen)
    {
    char buf[1024];
    int len;
    if (fgets(buf, sizeof(buf), stdin) == core::ptr::null_mut())
    return 0;
    len = strlen(buf);
    if (type == SOCK_STREAM) {
    if (write(sd, buf, len) < 0) {
...
#[no_mangle]
unsafe extern "C" fn set_recv_attr(sd: c_int, version: c_int) {
    ...
    {
    let mut timeout: timeval = { .tv_sec = prog_timeout }, *ptval = core::ptr::null_mut();
    fd_set rfds;
    int nfds;
    int rc;
    if (args.type != SOCK_STREAM)
...
// client sends first message
    ...
    rc = select(nfds, &rfds, core::ptr::null_mut(), core::ptr::null_mut(), ptval);
    if (rc < 0) {
    if (errno == EINTR)
    continue;
    rc = 1;
...
#[no_mangle]
unsafe extern "C" fn msock_init(args: *mut sock_args, server: c_int) -> c_int {
    static int msock_init(struct sock_args *args, int server)
    {
    let mut if_addr: u32 = htonl(INADDR_ANY);
...
#[no_mangle]
unsafe extern "C" fn msock_server(args: *mut sock_args) -> c_int {
    static int msock_server(struct sock_args *args)
    {
    return msock_init(args, 1);
    }
#[no_mangle]
unsafe extern "C" fn msock_client(args: *mut sock_args) -> c_int {
    static int msock_client(struct sock_args *args)
    {
    return msock_init(args, 0);
    }
#[no_mangle]
unsafe extern "C" fn bind_socket(sd: c_int, args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn config_xfrm_policy(sd: c_int, args: *mut sock_args) -> c_int {
    static int config_xfrm_policy(int sd, struct sock_args *args)
    {
    let mut policy: xfrm_userpolicy_info = {};
    let mut type: c_int = UDP_ENCAP_ESPINUDP;
    let mut xfrm_af: c_int = IP_XFRM_POLICY;
    let mut level: c_int = SOL_IP;
...
#[no_mangle]
unsafe extern "C" fn lsock_init(args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc_write(fd: c_int, message: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_server(args: *mut sock_args, ipc_fd: c_int) -> c_int {
...
// ipc_fd = -1 if no parent process to signal
    ...
    FD_ZERO(&rfds);
    FD_SET(lsd, &rfds);
    rc = select(lsd+1, &rfds, core::ptr::null_mut(), core::ptr::null_mut(), ptval);
    if (rc == 0) {
    rc = 2;
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn wait_for_connect(sd: c_int) -> c_int {
    static int wait_for_connect(int sd)
    {
    let mut _tv: timeval = { .tv_sec = prog_timeout }, *tv = core::ptr::null_mut();
    fd_set wfd;
    let mut val: c_int = 0, sz = sizeof(val);
    int rc;
    FD_ZERO(&wfd);
    FD_SET(sd, &wfd);
    if (prog_timeout)
    tv = &_tv;
    rc = select(FD_SETSIZE, core::ptr::null_mut(), &wfd, core::ptr::null_mut(), tv);
    if (rc == 0) {
...
#[no_mangle]
unsafe extern "C" fn connectsock(addr: *mut c_void, alen: socklen_t, args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_client(args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc_child(fd: c_int, args: *mut sock_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipc_parent(cpid: c_int, fd: c_int, args: *mut sock_args) -> c_int {
...
pub const OPT_FORCE_BIND_KEY_IFINDEX: c_int = 1001;
pub const OPT_NO_BIND_KEY_IFINDEX: c_int = 1002;
pub const OPT_CLIENT_DONTROUTE: c_int = 1003;
pub const OPT_SERVER_DONTROUTE: c_int = 1004;
...
#[no_mangle]
unsafe extern "C" fn print_usage(prog: *mut c_char) {
...
// process input args
//
    while ((rc = getopt_long(argc, argv, GETOPT_STR, long_opts, core::ptr::null_mut())) != -1) {
    switch (rc) {
    case 'B':
    both_mode = 1;
    break;
