...
//! Source: tools/testing/selftests/net/af_unix/scm_rights.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn FIXTURE_VARIANT(variant: *mut scm_rights)) -> const {
    const FIXTURE_VARIANT(scm_rights) *variant)
    {
    let mut sockets: c_int = -1, len, ret;
    char *line = core::ptr::null_mut();
    size_t unused;
    FILE *f;
    f = fopen("/proc/net/protocols", "r");
    ASSERT_NE(core::ptr::null_mut(), f);
