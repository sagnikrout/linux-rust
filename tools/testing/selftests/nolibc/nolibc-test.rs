...
//! Source: tools/testing/selftests/nolibc/nolibc-test.c
#![no_std]
...
// Macro flag: #define _LARGEFILE64_SOURCE
...
// will be used by constructor tests
    ...
    let mut is_le: static int = __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__;
...
pub const _syscall(...): c_int = 0;

// definition of a series of tests
#[repr(C)]
#[derive(Copy, Clone)]
pub struct test {
    pub /: *const *const *const char name; / test name,
    pub /: *mut *mut *mut int (func)(int min, int max); / handler,
}
...
#[no_mangle]
unsafe extern "C" fn result(llen: c_int, r: enum RESULT) {
    ...
    msg = "  [OK]";
#[no_mangle]
pub unsafe extern "C" fn if(SKIPPED: r ==) -> else {
    else if (r == SKIPPED)
    msg = "[SKIPPED]";
    else
    msg = " [FAIL]";
...
#[no_mangle]
pub unsafe extern "C" fn expect_zr(expr: c_int, llen: c_int) -> c_int {
    int expect_zr(int expr, int llen)
    {
    let mut ret: c_int = !(expr == 0);
    llen += printf(" = %d ", expr);
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_nz(expr: c_int, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_eq(expr: u64, llen: c_int, val: u64) -> c_int {
    int expect_eq(uint64_t expr, int llen, uint64_t val)
    {
    let mut ret: c_int = !(expr == val);
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ne(expr: c_int, llen: c_int, val: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ge(expr: c_int, llen: c_int, val: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_gt(expr: c_int, llen: c_int, val: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_le(expr: c_int, llen: c_int, val: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_lt(expr: c_int, llen: c_int, val: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_syszr(expr: c_int, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_syseq(expr: c_int, llen: c_int, val: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_sysne(expr: c_int, llen: c_int, val: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_syserr2(expr: c_int, expret: c_int, experr1: c_int, experr2: c_int, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrzr(expr: *const c_void, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrnz(expr: *const c_void, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptreq(expr: *const c_void, llen: c_int, cmp: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrne(expr: *const c_void, llen: c_int, cmp: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrge(expr: *const c_void, llen: c_int, cmp: *const c_void) -> c_int {
    int expect_ptrge(const void *expr, int llen, const void *cmp)
    {
    let mut ret: c_int = !(expr >= cmp);
    llen += printf(" = <%p> ", expr);
    result(llen, ret ? FAIL : OK);
    return ret;
    }
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrgt(expr: *const c_void, llen: c_int, cmp: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrle(expr: *const c_void, llen: c_int, cmp: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrlt(expr: *const c_void, llen: c_int, cmp: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_ptrerr2(expr: *const c_void, expret: *const c_void, experr1: c_int, experr2: c_int, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_strzr(expr: *const c_char, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_strnz(expr: *const c_char, llen: c_int) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_streq(expr: *const c_char, llen: c_int, cmp: *const c_char) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_strne(expr: *const c_char, llen: c_int, cmp: *const c_char) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_str_buf_eq(expr: usize, buf: *const c_char, val: usize, llen: c_int, cmp: *const c_char) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (unused)) -> static {
    static __attribute__((unused))
#[no_mangle]
pub unsafe extern "C" fn expect_strtox(llen: c_int, func: enum strtox_func, input: *const c_char, base: c_int, expected: intmax_t, expected_chars: c_int, expected_errno: c_int) -> c_int {
...
unsafe extern "C" fn constructor1() {
    ...
    __attribute__((constructor))
#[no_mangle]
unsafe extern "C" fn constructor2(argc: c_int, argv: *mut c_char, envp: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn test_program_invocation_name() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn run_startup(min: c_int, max: c_int) -> c_int {
    int run_startup(int min, int max)
    {
    int test;
    let mut ret: c_int = 0;
// kernel at least passes HOME and TERM, shell passes more
    let mut env_total: c_int = 2;
...
// differ from nolibc, both glibc and musl have no global _auxv
    ...
    let mut proc: bool = access("/proc", R_OK) == 0;
...
//
    ...
    CASE_TEST(argv0_str);        EXPECT_STRNZ(1, argv0 > brk ? argv0 : core::ptr::null_mut()); break;
...
#[no_mangle]
pub unsafe extern "C" fn test_getdents64(dir: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_dirent() -> c_int {
    static int test_dirent(void)
    {
    let mut comm: c_int = 0, cmdline = 0;
    ...
    comm++;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(dirent.d_name, 0: "cmdline") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn test_getcwd() -> c_int {
...
// Get the cwd via syscall
    if (getcwd(cwd_syscall, sizeof(cwd_syscall)) == core::ptr::null_mut())
    return __LINE__;
...
//
    if (is_nolibc) {
    errno = 0;
    if (getcwd(core::ptr::null_mut(), 0) != core::ptr::null_mut() || !errno)
    return __LINE__;
    }
...
//
    errno = 0;
    if (getcwd(cwd_syscall, 0) != core::ptr::null_mut() || !errno)
    return __LINE__;
...
//
    errno = 0;
    if (getcwd(cwd_syscall, 1) != core::ptr::null_mut() || !errno)
    return __LINE__;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn test_getrandom() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_getpagesize() -> c_int {
    int test_getpagesize(void)
    {
    let mut x: c_int = getpagesize();
    int c;
    if (x < 0)
    return x;
...
#[no_mangle]
pub unsafe extern "C" fn test_file_stream() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_file_stream_wsr() -> c_int {
    int test_file_stream_wsr(void)
    {
    const char dataout[] = "foo";
    let mut datasz: usize = sizeof(dataout);
    char datain[datasz];
    int fd, r;
    FILE *f;
...
#[no_mangle]
pub unsafe extern "C" fn test_fork(type: enum fork_type) -> c_int {
...
// flush the printf buffer to avoid child flush it
    ...
    let mut pid: return = = -1 || !WIFEXITED(status) || WEXITSTATUS(status) != 123;
    }
    }
#[no_mangle]
pub unsafe extern "C" fn test_ftruncate() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_stat_timestamps() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_timer() -> c_int {
    int test_timer(void)
    {
    ...
    ret = timer_settime(timer, 0, &timerspec, core::ptr::null_mut());
    if (ret)
    goto err;
    timerspec = (struct itimerspec) {
    .it_value.tv_sec = -1,
...
#[no_mangle]
pub unsafe extern "C" fn test_timerfd() -> c_int {
    ...
    ret = timerfd_settime(timer, 0, &timerspec, core::ptr::null_mut());
    if (ret)
    goto err;
    timerspec = (struct itimerspec) {
    .it_value.tv_sec = -1,
...
#[no_mangle]
pub unsafe extern "C" fn test_uname() -> c_int {
    int test_uname(void)
    {
    struct utsname buf;
...
#[no_mangle]
pub unsafe extern "C" fn test_mmap_munmap() -> c_int {
...
// find a right file to mmap, existed and accessible
    for (i = 0; files[i] != core::ptr::null_mut(); i++) {
...
// file size of the special /dev/zero is 0, let's assign one manually
    ...
    mem = mmap(core::ptr::null_mut(), mem_length, PROT_READ, MAP_SHARED, fd, pa_offset);
    if (mem == MAP_FAILED) {
    ret = 1;
    goto end;
    }
...
#[no_mangle]
pub unsafe extern "C" fn test_pipe() -> c_int {
    int test_pipe(void)
    {
    let mut msg: *const char const = "hello, nolibc";
    int pipefd[2];
    char buf[32];
    size_t len;
    if (pipe(pipefd) == -1)
...
#[no_mangle]
pub unsafe extern "C" fn test_rlimit() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_openat() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_open_mode() -> c_int {
    int test_open_mode(void)
    {
    let mut mode: mode_t = 0444;
    struct stat stat_buf;
    int fd, ret;
...
#[no_mangle]
pub unsafe extern "C" fn test_nolibc_enosys() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_namespace() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_large_file() -> c_int {
    int test_large_file(void)
    {
    let mut large_seek: off_t = ((off_t)UINT32_MAX) + 100;
...
//
#[no_mangle]
pub unsafe extern "C" fn run_syscall(min: c_int, max: c_int) -> c_int {
...
//
    ...
    CASE_TEST(clock_nanosleep);   ts.tv_nsec = -1; EXPECT_EQ(1, EINVAL, clock_nanosleep(CLOCK_REALTIME, 0, &ts, core::ptr::null_mut())); break;
    ...
    CASE_TEST(execve_root);       EXPECT_SYSER(1, execve("/", (char*[]){ [0] = (char []){"/"}, [1] = core::ptr::null_mut() }, core::ptr::null_mut()), -1, EACCES); break;
    ...
    CASE_TEST(gettimeofday_tv);   EXPECT_SYSZR(1, gettimeofday(&tv, core::ptr::null_mut())); break;
    ...
    CASE_TEST(mmap_bad);          EXPECT_PTRER(1, mmap(core::ptr::null_mut(), 0, PROT_READ, MAP_PRIVATE, 0, 0), MAP_FAILED, EINVAL); break;
    CASE_TEST(munmap_bad);        EXPECT_SYSER(1, munmap(core::ptr::null_mut(), 0), -1, EINVAL); break;
    CASE_TEST(mmap_munmap_good);  EXPECT_SYSZR(1, test_mmap_munmap()); break;
    CASE_TEST(nanosleep);         ts.tv_nsec = -1; EXPECT_SYSER(1, nanosleep(&ts, core::ptr::null_mut()), -1, EINVAL); break;
    ...
    CASE_TEST(poll_null);         EXPECT_SYSZR(1, poll(core::ptr::null_mut(), 0, 0)); break;
    CASE_TEST(poll_stdout);       EXPECT_SYSNE(1, ({ struct pollfd fds = { 1, POLLOUT, 0}; poll(&fds, 1, 0); }), -1); break;
    CASE_TEST(poll_fault);        EXPECT_SYSER(1, poll(core::ptr::null_mut(), 1, 0), -1, EFAULT); break;
    CASE_TEST(prctl);             EXPECT_SYSER(1, prctl(PR_SET_NAME, (unsigned long)core::ptr::null_mut(), 0, 0, 0), -1, EFAULT); break;
    CASE_TEST(read_badf);         EXPECT_SYSER(1, read(-1, &tmp, 1), -1, EBADF); break;
    CASE_TEST(rlimit);            EXPECT_SYSZR(1, test_rlimit()); break;
    CASE_TEST(rmdir_blah);        EXPECT_SYSER(1, rmdir("/blah"), -1, ENOENT); break;
    CASE_TEST(sched_yield);       EXPECT_SYSZR(1, sched_yield()); break;
    CASE_TEST(select_null);       EXPECT_SYSZR(1, ({ struct timeval tv = { 0 }; select(0, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), &tv); })); break;
    CASE_TEST(select_stdout);     EXPECT_SYSNE(1, ({ fd_set fds; FD_ZERO(&fds); FD_SET(1, &fds); select(2, core::ptr::null_mut(), &fds, core::ptr::null_mut(), core::ptr::null_mut()); }), -1); break;
    CASE_TEST(select_fault);      EXPECT_SYSER(1, select(1, (void *)1, core::ptr::null_mut(), core::ptr::null_mut(), 0), -1, EFAULT); break;
    CASE_TEST(stat_blah);         EXPECT_SYSER(1, stat("/proc/self/blah", &stat_buf), -1, ENOENT); break;
    CASE_TEST(stat_fault);        EXPECT_SYSER(1, stat(core::ptr::null_mut(), &stat_buf), -1, EFAULT); break;
    ...
    CASE_TEST(uname_fault);       EXPECT_SYSER(1, uname(core::ptr::null_mut()), -1, EFAULT); break;
    ...
    CASE_TEST(readv_zero);        EXPECT_SYSZR(1, readv(0, core::ptr::null_mut(), 0)); break;
    CASE_TEST(writev_badf);       EXPECT_SYSER(1, writev(-1, &iov_one, 1), -1, EBADF); break;
    CASE_TEST(writev_zero);       EXPECT_SYSZR(1, writev(1, core::ptr::null_mut(), 0)); break;
    CASE_TEST(ptrace);            tmp = ptrace(PTRACE_CONT, getpid(), core::ptr::null_mut(), core::ptr::null_mut()); EXPECT_SYSER(tmp != -1 && errno != ENOSYS, tmp, -1, EFAULT); break;
    CASE_TEST(syscall_noargs);    EXPECT_SYSEQ(1, syscall(__NR_getpid), getpid()); break;
    CASE_TEST(syscall_args);      EXPECT_SYSER(1, syscall(__NR_statx, 0, core::ptr::null_mut(), 0, 0, core::ptr::null_mut()), -1, EFAULT); break;
    CASE_TEST(_syscall_noargs);   EXPECT_SYSEQ(is_nolibc, _syscall(__NR_getpid), getpid()); break;
    CASE_TEST(_syscall_args);     EXPECT_SYSEQ(is_nolibc, _syscall(__NR_statx, 0, core::ptr::null_mut(), 0, 0, core::ptr::null_mut()), -EFAULT); break;
...
#[no_mangle]
pub unsafe extern "C" fn test_alloca() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_difftime() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_time_types() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_malloc() -> c_int {
    int test_malloc(void)
    {
    size_t sz_array1, sz_array2, sz_array3;
    int *array1, *array2, *array3;
    let mut pagesize: c_int = getpagesize();
    size_t idx;
    if (pagesize < 0)
    return 1;
...
#[no_mangle]
pub unsafe extern "C" fn run_stdlib(min: c_int, max: c_int) -> c_int {
...
//
    ...
    CASE_TEST(strstr_foobar_baz);  EXPECT_PTREQ(1, strstr("foobar", "baz"), core::ptr::null_mut()); break;
...
pub const VFPRINTF_LEN: c_int = 25;
#[no_mangle]
unsafe extern "C" fn expect_vfprintf(llen: c_int, expected: *const c_char, fmt: *const c_char, ...) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_scanf() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_printf_error() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_asprintf() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smash_stack() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(_arg: (unused))) -> int max {
    int max __attribute__((unused)))
    {
    pid_t pid;
    let mut llen: c_int = 0, status;
    let mut rlimit: rlimit = { 0, 0 };
...
#[no_mangle]
pub unsafe extern "C" fn prepare() -> c_int {
    int prepare(void)
    {
    struct stat stat_buf;
...
#[no_mangle]
unsafe extern "C" fn is_setting_valid(test: *mut c_char) -> c_int {
...
// support :val: :min-max: :min-: :-max:
    ...
    max = min;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: *mut dash) -> else {
    else if (*dash)
    max = atoi(dash);
    value = colon;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: syscall(__NR_ioperm, _arg: 0x501, _arg: 1, 0: 1) ==) -> else {
