...
//! Source: tools/testing/selftests/filesystems/openat2/resolve_test.c
#![no_std]
...
//
    ...
    self.rootfd = -1;
    self.hardcoded_fd = -1;
    self.hardcoded_fdpath = core::ptr::null_mut();
    self.procselfexe = core::ptr::null_mut();
...
// All attempts to cross the dirfd will be scoped-to-root.
    ...
    .out.path = core::ptr::null_mut(),		.pass = true },
