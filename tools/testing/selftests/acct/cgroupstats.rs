...
//! Source: tools/testing/selftests/acct/cgroupstats.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn recv_cgroupstats_response(fd: c_int, stats: *mut cgroupstats) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_cgroup_v1() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_cgroup_v1() {
