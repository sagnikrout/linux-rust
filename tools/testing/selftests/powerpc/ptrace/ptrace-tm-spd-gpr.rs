...
//! Source: tools/testing/selftests/powerpc/ptrace/ptrace-tm-spd-gpr.c
#![no_std]
...
// Tracer and Tracee Shared Data
    int shm_id;
    int *cptr, *pptr;
    let mut a: double = FPR_1;
    let mut b: double = FPR_2;
    let mut c: double = FPR_3;
    let mut d: double = FPR_4;
...
#[no_mangle]
pub unsafe extern "C" fn trace_tm_spd_gpr(child: pid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptrace_tm_spd_gpr() -> c_int {
