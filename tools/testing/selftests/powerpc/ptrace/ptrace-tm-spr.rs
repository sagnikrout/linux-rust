...
//! Source: tools/testing/selftests/powerpc/ptrace/ptrace-tm-spr.c
#![no_std]
...
pub struct shared {
    ...
    int shm_id1;
    int *cptr1, *pptr1;
pub const TM_KVM_SCHED: c_uint = 0xe0000001ac000001;
#[no_mangle]
...
pub unsafe extern "C" fn tm_spr() {
    ...
    int ret;
    cptr = (struct shared *)shmat(shm_id, core::ptr::null_mut(), 0);
    cptr1 = (int *)shmat(shm_id1, core::ptr::null_mut(), 0);
    trans:
    cptr1[0] = 0;
    asm __volatile__(
    "1: ;"
...
pub unsafe extern "C" fn ptrace_tm_spr() -> c_int {
    ...
    tm_spr();
    if (pid) {
    pptr = (struct shared *)shmat(shm_id, core::ptr::null_mut(), 0);
    pptr1 = (int *)shmat(shm_id1, core::ptr::null_mut(), 0);
    while (!pptr1[0])
    asm volatile("" : : : "memory");
    ...
    shmctl(shm_id1, IPC_RMID, core::ptr::null_mut());
    return TEST_FAIL;
    }
    shmdt((void *)pptr);
    shmdt((void *)pptr1);
