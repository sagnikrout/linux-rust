...
//! Source: tools/testing/selftests/powerpc/ptrace/ptrace-tm-gpr.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn trace_tm_gpr(child: pid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptrace_tm_gpr() -> c_int {
