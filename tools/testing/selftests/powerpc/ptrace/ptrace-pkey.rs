...
//! Source: tools/testing/selftests/powerpc/ptrace/ptrace-pkey.c
#![no_std]
...
// AMR value that ptrace should refuse to write to the child.
    pub invalid_amr: c_ulong,
// IAMR value the parent expects to read from the child.
    pub expected_iamr: c_ulong,
// UAMOR value the parent expects to read from the child.
    pub expected_uamor: c_ulong,
//
// IAMR and UAMOR values that ptrace should refuse to write to the child
// (even though they're valid ones) because userspace doesn't have
// access to those registers.
//
    pub invalid_iamr: c_ulong,
    pub invalid_uamor: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn ptrace_pkey() -> c_int {
