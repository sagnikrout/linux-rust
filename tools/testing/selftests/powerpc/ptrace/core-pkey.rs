...
//! Source: tools/testing/selftests/powerpc/ptrace/core-pkey.c
#![no_std]
...
//
    sys_pkey_free(pkey3);
    info.core_time = time(core::ptr::null_mut());
// Crash.
    ptr = 0;
// ptr = 1;
// Shouldn't get here.
...
// Construct array of core file names to try.
    ...
    core = mmap(core::ptr::null_mut(), core_size, PROT_READ, MAP_PRIVATE, fd, 0);
    if (core == (void *) -1) {
...
#[no_mangle]
unsafe extern "C" fn setup_core_pattern(core_pattern_: *mut c_char, changed_: *mut bool) -> c_int {
...
unsafe extern "C" fn core_pkey() -> c_int {
    ...
    info = shmat(shm_id, core::ptr::null_mut(), 0);
