...
//! Source: tools/testing/selftests/powerpc/tm/tm-signal-context-chk-vsx.c
#![no_std]
...
//
    rc = tm_signal_self_context_load(pid, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), vsxs);
    FAIL_IF(rc != pid);
    i++;
    }
    return (broken);
