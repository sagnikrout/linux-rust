...
//! Source: tools/testing/selftests/powerpc/tm/tm-trap.c
#![no_std]
...
// Second trap event
#[no_mangle]
pub unsafe extern "C" fn if(1: trap_event ==) -> else {
//
...
#[no_mangle]
pub unsafe extern "C" fn usr1_signal_handler(signo: c_int, si: *mut siginfo_t, not_used: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn tm_trap_test() -> c_int {
...
// Figure out the machine endianness
    ...
    pr_error(rc, "fflush()");
// Launch ping()
    rc = pthread_create(&t0_ping, &attr, ping, core::ptr::null_mut());
    if (rc)
    pr_error(rc, "pthread_create()");
    exit_from_pong = 0;
// Launch pong()
    rc = pthread_create(&t1_pong, &attr, pong, core::ptr::null_mut());
    if (rc)
    pr_error(rc, "pthread_create()");
