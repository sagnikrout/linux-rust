...
//! Source: tools/testing/selftests/powerpc/tm/tm-signal-context-chk-gpr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tm_signal_context_chk_gpr() -> c_int {
...
//
    rc = tm_signal_self_context_load(pid, gprs, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    FAIL_IF(rc != pid);
    i++;
    }
    return broken;
