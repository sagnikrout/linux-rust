...
//! Source: tools/testing/selftests/powerpc/pmu/ebb/instruction_count_test.c
#![no_std]
...
//
    ...
    let mut counters_frozen: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn determine_overhead(event: *mut event) -> u64 {
