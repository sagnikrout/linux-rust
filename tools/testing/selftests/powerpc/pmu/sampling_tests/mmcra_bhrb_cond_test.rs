...
//! Source: tools/testing/selftests/powerpc/pmu/sampling_tests/mmcra_bhrb_cond_test.c
#![no_std]
...
pub const IFM_COND_BRANCH: c_uint = 0x3;
//
// A perf sampling test for mmcra
// field: ifm for bhrb cond call.
//
#[no_mangle]
unsafe extern "C" fn mmcra_bhrb_cond_test() -> c_int {
