...
//! Source: tools/testing/selftests/powerpc/pmu/count_stcx_fail.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn setup_event(e: *mut event, config: u64, type: c_int, name: *mut c_char) {
...
pub const PM_MRK_STCX_FAIL: c_uint = 0x03e158;
pub const PM_STCX_FAIL: c_uint = 0x01e058;
#[no_mangle]
