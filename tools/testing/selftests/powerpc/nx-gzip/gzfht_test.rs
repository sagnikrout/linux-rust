...
//! Source: tools/testing/selftests/powerpc/nx-gzip/gzfht_test.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn gzip_header_blank(buf: *mut c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn append_sync_flush(buf: *mut c_char, tebc: c_int, final: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_bfinal(buf: *mut c_void, bfinal: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn compress_file(argc: c_int, argv: *mut c_char, handle: *mut c_void) -> c_int {
    ...
    let mut lzcounts: c_int = 0;
    int cc;
    int num_hdr_bytes;
    struct nx_gzip_crb_cpb_t *cmdp;
    let mut pagelen: u32 = 65536;
...
// Generous output buffer for header/trailer
    outlen = 2 * inlen + 1024;
    assert(core::ptr::null_mut() != (outbuf = (char *)malloc(outlen)));
...
// Append crc32 and ISIZE to the end
    ...
    if (inbuf != core::ptr::null_mut())
    free(inbuf);
    if (outbuf != core::ptr::null_mut())
    free(outbuf);
    return 0;
    }
#[no_mangle]
