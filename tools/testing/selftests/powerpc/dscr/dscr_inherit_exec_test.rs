...
//! Source: tools/testing/selftests/powerpc/dscr/dscr_inherit_exec_test.c
#![no_std]
...
//
    ...
    static char *prog;
#[no_mangle]
unsafe extern "C" fn do_exec(parent_dscr: c_ulong) {
...
pub unsafe extern "C" fn dscr_inherit_exec() -> c_int {
    ...
    execlp(prog, prog, "exec", dscr_str, core::ptr::null_mut());
    exit(1);
    }
    }
    return 0;
