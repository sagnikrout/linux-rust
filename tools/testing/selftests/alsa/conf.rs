...
//! Source: tools/testing/selftests/alsa/conf.c
#![no_std]
...
// Macro flag: #define LIB_HAS_LOAD_STRING
...
#[no_mangle]
unsafe extern "C" fn dump_config_tree(top: *mut snd_config_t) {
...
#[no_mangle]
unsafe extern "C" fn sysfs_match(sysfs_root: *const c_char, config: *mut snd_config_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn assign_card_config(card: c_int, sysfs_card_root: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn assign_card_configs() {
...
#[no_mangle]
unsafe extern "C" fn match_config(filename: *const c_char) -> bool {
...
pub unsafe extern "C" fn conf_load() {
    ...
    for (j = 0; j < n; j++) {
    let mut sl: usize = strlen(fn) + strlen(namelist[j].d_name) + 2;
...
#[no_mangle]
pub unsafe extern "C" fn conf_get_count(root: *mut snd_config_t, key1: *const c_char, key2: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn conf_get_long(root: *mut snd_config_t, key1: *const c_char, key2: *const c_char, def: c_long) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn conf_get_bool(root: *mut snd_config_t, key1: *const c_char, key2: *const c_char, def: c_int) -> c_int {
...
pub unsafe extern "C" fn if(0: ret <) -> else {
    ...
    sprintf(buf, "%i", index);
    array[index] = conf_get_string(cfg, buf, core::ptr::null_mut(), def);
    }
    }
    }
