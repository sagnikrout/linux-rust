...
//! Source: tools/testing/selftests/alsa/test-pcmtest-driver.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn read_patterns() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_test_results(debug_name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_sec_buf_len(rate: c_uint, channels: c_ulong, format: snd_pcm_format_t) -> usize {
...
// Test capture in the non-interleaved access mode. The are buffers for each recorded channel
    ...
    snd_pcm_t *handle;
    let mut params: pcmtest_test_params = self.params;
    char **chan_samples;
    size_t i, j, read_res;
