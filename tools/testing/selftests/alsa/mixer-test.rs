...
//! Source: tools/testing/selftests/alsa/mixer-test.c
#![no_std]
...
pub const TESTS_PER_CONTROL: c_int = 7;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct card_data {
    ...
    pub pollfd: pollfd,
    pub num_ctls: c_int,
    pub ctls: *mut snd_ctl_elem_list_t,
...
pub struct ctl_data {
    ...
    pub id: *mut snd_ctl_elem_id_t,
    pub info: *mut snd_ctl_elem_info_t,
    pub def_val: *mut snd_ctl_elem_value_t,
    pub elem: c_int,
    pub event_missing: c_int,
    pub event_spurious: c_int,
    pub card: *mut card_data,
    pub next: *mut ctl_data,
}
...
#[no_mangle]
unsafe extern "C" fn find_controls() {
...
//
#[no_mangle]
unsafe extern "C" fn wait_for_event(ctl: *mut ctl_data, timeout: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctl_value_valid(ctl: *mut ctl_data, val: *mut snd_ctl_elem_value_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn test_ctl_get_value(ctl: *mut ctl_data) {
...
#[no_mangle]
unsafe extern "C" fn strend(haystack: *const c_char, needle: *const c_char) -> bool {
    static bool strend(const char *haystack, const char *needle)
    {
    let mut haystack_len: usize = strlen(haystack);
    let mut needle_len: usize = strlen(needle);
    if (needle_len > haystack_len)
    return false;
    return strcmp(haystack + haystack_len - needle_len, needle) == 0;
    }
#[no_mangle]
unsafe extern "C" fn test_ctl_name(ctl: *mut ctl_data) {
    static void test_ctl_name(struct ctl_data *ctl)
    {
    let mut name_ok: bool = true;
...
//
    let mut is_volatile: bool = snd_ctl_elem_info_is_volatile(ctl.info);
...
//
#[no_mangle]
unsafe extern "C" fn test_ctl_write_default(ctl: *mut ctl_data) {
...
// No idea what the default was for unreadable controls
    ...
    err = write_and_verify(ctl, ctl.def_val, core::ptr::null_mut());
    ksft_test_result(err >= 0, "write_default.%s.%d\n",
    ctl.card.card_name, ctl.elem);
    }
#[no_mangle]
unsafe extern "C" fn test_ctl_write_valid_boolean(ctl: *mut ctl_data) -> bool {
    ...
    err = write_and_verify(ctl, val, core::ptr::null_mut());
    if (err != 0)
    fail = true;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_valid_integer(ctl: *mut ctl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_valid_integer64(ctl: *mut ctl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_valid_enumerated(ctl: *mut ctl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_valid(ctl: *mut ctl_data) {
...
// Restore the default value to minimise disruption
    write_and_verify(ctl, ctl.def_val, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_invalid_boolean(ctl: *mut ctl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_invalid_integer(ctl: *mut ctl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_invalid_integer64(ctl: *mut ctl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_invalid_enumerated(ctl: *mut ctl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_write_invalid(ctl: *mut ctl_data) {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_event_missing(ctl: *mut ctl_data) {
...
#[no_mangle]
unsafe extern "C" fn test_ctl_event_spurious(ctl: *mut ctl_data) {
...
pub unsafe extern "C" fn main() -> c_int {
    ...
    for (ctl = ctl_list; ctl != core::ptr::null_mut(); ctl = ctl.next) {
//
