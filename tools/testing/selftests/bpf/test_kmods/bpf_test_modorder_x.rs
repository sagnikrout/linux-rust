...
//! Source: tools/testing/selftests/bpf/test_kmods/bpf_test_modorder_x.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn bpf_test_modorder_retx() -> __bpf_kfunc int {
...
#[no_mangle]
unsafe extern "C" fn bpf_test_modorder_x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bpf_test_modorder_x_exit() -> void __exit {
