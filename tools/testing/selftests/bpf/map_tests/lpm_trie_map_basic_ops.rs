...
//! Source: tools/testing/selftests/bpf/map_tests/lpm_trie_map_basic_ops.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tlpm_node {
    pub next: *mut tlpm_node,
    pub n_bits: usize,
    pub key: [u8; ],
}
...
#[no_mangle]
unsafe extern "C" fn tlpm_clear(list: *mut tlpm_node) {
...
// free all entries in @list
    ...
    size_t n_bits)
    {
    struct tlpm_node *best = core::ptr::null_mut();
    size_t i;
...
#[no_mangle]
unsafe extern "C" fn test_lpm_basic() {
    static void test_lpm_basic(void)
    {
    struct tlpm_node *list = core::ptr::null_mut(), *t1, *t2;
...
#[no_mangle]
unsafe extern "C" fn test_lpm_order() {
    static void test_lpm_order(void)
    {
    struct tlpm_node *t1, *t2, *l1 = core::ptr::null_mut(), *l2 = core::ptr::null_mut();
    size_t i, j;
...
#[no_mangle]
unsafe extern "C" fn test_lpm_map(keysize: c_int) {
    static void test_lpm_map(int keysize)
    {
    LIBBPF_OPTS(bpf_map_create_opts, opts, .map_flags = BPF_F_NO_PREALLOC);
    volatile size_t n_matches, n_matches_after_delete;
    size_t i, j, n_nodes, n_lookups;
    struct tlpm_node *t, *list = core::ptr::null_mut();
...
//
    ...
    map = bpf_map_create(BPF_MAP_TYPE_LPM_TRIE, core::ptr::null_mut(),
    sizeof(*key) + keysize,
    keysize + 1,
    4096,
    &opts);
...
#[no_mangle]
unsafe extern "C" fn test_lpm_ipaddr() {
    ...
    map_fd_ipv4 = bpf_map_create(BPF_MAP_TYPE_LPM_TRIE, core::ptr::null_mut(),
    key_size_ipv4, sizeof(value),
    100, &opts);
    assert(map_fd_ipv4 >= 0);
    map_fd_ipv6 = bpf_map_create(BPF_MAP_TYPE_LPM_TRIE, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn test_lpm_delete() {
    ...
    key = alloca(key_size);
    map_fd = bpf_map_create(BPF_MAP_TYPE_LPM_TRIE, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn test_lpm_get_next_key() {
    ...
    map_fd = bpf_map_create(BPF_MAP_TYPE_LPM_TRIE, core::ptr::null_mut(), key_size, sizeof(value), 100, &opts);
    assert(map_fd >= 0);
// empty tree. get_next_key should return ENOENT
    assert(bpf_map_get_next_key(map_fd, core::ptr::null_mut(), key_p) == -ENOENT);
// get and verify the first key, get the second one should fail.
    key_p.prefixlen = 16;
    inet_pton(AF_INET, "192.168.0.0", key_p.data);
    assert(bpf_map_update_elem(map_fd, key_p, &value, 0) == 0);
    memset(key_p, 0, key_size);
    assert(bpf_map_get_next_key(map_fd, core::ptr::null_mut(), key_p) == 0);
...
pub const MAX_TEST_KEYS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpm_mt_test_info {
    pub /: *mut *mut int cmd; / 0: update, 1: delete, 2: lookup, 3: get_next_key,
    pub iter: c_int,
    pub map_fd: c_int,
    struct {
    pub prefixlen: __u32,
    pub data: __u32,
    pub key: [}; MAX_TEST_KEYS],
}
...
#[no_mangle]
unsafe extern "C" fn setup_lpm_mt_test_info(info: *mut lpm_mt_test_info, map_fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_lpm_multi_thread() {
...
// create a trie
    ...
    map_fd = bpf_map_create(BPF_MAP_TYPE_LPM_TRIE, core::ptr::null_mut(), key_size, value_size, 100, &opts);
// create 4 threads to test update, delete, lookup and get_next_key
    ...
    info[i].cmd = i;
    assert(pthread_create(&thread_id[i], core::ptr::null_mut(), &lpm_test_command, &info[i]) == 0);
    }
    for (i = 0; i < 4; i++)
...
#[no_mangle]
unsafe extern "C" fn lpm_trie_create(key_size: c_uint, value_size: c_uint, max_entries: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_lpm_trie_update_flags() {
...
#[no_mangle]
unsafe extern "C" fn test_lpm_trie_update_full_map() {
...
//
#[no_mangle]
unsafe extern "C" fn test_lpm_trie_iterate_strs() {
...
//
#[no_mangle]
unsafe extern "C" fn test_lpm_trie_iterate_ints() {
...
//
    ...
    err = bpf_map_get_next_key(fd, cur, &next_key);
    CHECK(err != -ENOENT, "more element", "error %d\n", err);
    err = bpf_map_get_next_key(fd, core::ptr::null_mut(), &next_key);
