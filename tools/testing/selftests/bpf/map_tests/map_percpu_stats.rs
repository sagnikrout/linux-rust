...
//! Source: tools/testing/selftests/bpf/map_tests/map_percpu_stats.c
#![no_std]
...
pub const MAX_ENTRIES_HASH_OF_MAPS: c_int = 64;
pub const N_THREADS: c_int = 8;
pub const MAX_MAP_KEY_SIZE: c_int = 4;
pub const PCPU_MIN_UNIT_SIZE: c_int = 32768;
#[no_mangle]
unsafe extern "C" fn map_info(map_fd: c_int, info: *mut bpf_map_info) {
...
#[no_mangle]
unsafe extern "C" fn map_count_elements(type: __u32, map_fd: c_int) -> __u32 {
...
#[no_mangle]
unsafe extern "C" fn delete_and_lookup_batch(map_fd: c_int, keys: *mut c_void, count: __u32) {
    static void delete_and_lookup_batch(int map_fd, void *keys, __u32 count)
    {
    static __u8 values[(8 << 10) * MAX_ENTRIES];
    void *in_batch = core::ptr::null_mut(), *out_batch;
    let mut save_count: __u32 = count;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn delete_all_elements(type: __u32, map_fd: c_int, batch: bool) {
...
#[no_mangle]
unsafe extern "C" fn is_lru(map_type: __u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_percpu(map_type: __u32) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct upsert_opts {
    pub map_type: __u32,
    pub map_fd: c_int,
    pub n: __u32,
    pub retry_for_nomem: bool,
}

#[no_mangle]
unsafe extern "C" fn create_small_hash() -> c_int {
    static int create_small_hash(void)
    {
    int map_fd;
    map_fd = bpf_map_create(BPF_MAP_TYPE_HASH, "small", 4, 4, 4, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn upsert_elements(opts: *mut upsert_opts) {
    ...
    ret = pthread_create(&i[threads], core::ptr::null_mut(), patch_map_thread, opts);
    CHECK(ret != 0, "pthread_create", "error: %s\n", strerror(ret));
    }
    for (i = 0; i < ARRAY_SIZE(threads); i++) {
    ret = pthread_join(i[threads], core::ptr::null_mut());
    CHECK(ret != 0, "pthread_join", "error: %s\n", strerror(ret));
    }
    }
#[no_mangle]
unsafe extern "C" fn read_cur_elements(iter_fd: c_int) -> __u32 {
    ...
    buf[n] = '\0';
    errno = 0;
    ret = (__u32)strtol(buf, core::ptr::null_mut(), 10);
    CHECK(errno != 0, "strtol", "error: %s\n", strerror(errno));
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn get_cur_elements(map_id: c_int) -> __u32 {
    ...
    CHECK(skel == core::ptr::null_mut(), "map_percpu_stats__open", "error: %s", strerror(errno));
...
#[no_mangle]
unsafe extern "C" fn __test(map_fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn map_create(type: __u32, name: *const c_char, map_opts: *mut bpf_map_create_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_hash() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_percpu_hash() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_hash_prealloc() -> c_int {
    static int create_hash_prealloc(void)
    {
    return map_create(BPF_MAP_TYPE_HASH, "hash", core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn create_percpu_hash_prealloc() -> c_int {
    static int create_percpu_hash_prealloc(void)
    {
    return map_create(BPF_MAP_TYPE_PERCPU_HASH, "percpu_hash_prealloc", core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn create_lru_hash(type: __u32, map_flags: __u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_hash_of_maps() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_hash() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_percpu_hash() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_hash_prealloc() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_percpu_hash_prealloc() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_lru_hash() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_lru_hash_no_common() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_percpu_lru_hash() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_percpu_lru_hash_no_common() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_hash_of_maps() {
...
#[no_mangle]
unsafe extern "C" fn map_percpu_stats_map_value_size() {
    static void map_percpu_stats_map_value_size(void)
    {
    int fd;
    let mut value_sz: c_int = PCPU_MIN_UNIT_SIZE + 1;
    let mut opts: bpf_map_create_opts = { .sz = sizeof(opts) };
    enum bpf_map_type map_types[] = { BPF_MAP_TYPE_PERCPU_ARRAY,
    BPF_MAP_TYPE_PERCPU_HASH,
    BPF_MAP_TYPE_LRU_PERCPU_HASH };
    for (int i = 0; i < ARRAY_SIZE(map_types); i++) {
    fd = bpf_map_create(map_types[i], core::ptr::null_mut(), sizeof(__u32), value_sz, 1, &opts);
