...
//! Source: tools/testing/selftests/bpf/xdp_synproxy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cleanup(sig: c_int) -> void noreturn {
    ...
    err = bpf_xdp_attach(ifindex, -1, 0, core::ptr::null_mut());
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn usage(progname: *const c_char) -> noreturn void {
...
#[no_mangle]
unsafe extern "C" fn parse_arg_ul(progname: *const c_char, arg: *const c_char, limit: c_ulong) -> c_ulong {
    ...
    { "prog", required_argument, core::ptr::null_mut(), 'x' },
    { "mss4", required_argument, core::ptr::null_mut(), 4 },
    { "mss6", required_argument, core::ptr::null_mut(), 6 },
    { "wscale", required_argument, core::ptr::null_mut(), 'w' },
    { "ttl", required_argument, core::ptr::null_mut(), 't' },
    { "ports", required_argument, core::ptr::null_mut(), 'p' },
    { "single", no_argument, core::ptr::null_mut(), 's' },
    { "tc", no_argument, core::ptr::null_mut(), 'c' },
...
// tc = false;
    while (true) {
    int opt;
    opt = getopt_long(argc, argv, "", long_options, core::ptr::null_mut());
    if (opt == -1)
    break;
    switch (opt) {
    case 'h':
...
#[no_mangle]
unsafe extern "C" fn syncookie_attach(argv0: *const c_char, ifindex: c_uint, tc: bool) -> c_int {
    ...
    obj = bpf_object__open_file(xdp_filename, core::ptr::null_mut());
    ...
    XDP_FLAGS_UPDATE_IF_NOEXIST, core::ptr::null_mut());
    if (err < 0) {
    fprintf(stderr, "Error: bpf_set_link_xdp_fd: %s\n",
    strerror(-err));
    goto fail;
...
#[no_mangle]
unsafe extern "C" fn syncookie_open_bpf_maps(prog_id: __u32, values_map_fd: *mut c_int, ports_map_fd: *mut c_int) -> c_int {
