...
//! Source: tools/testing/selftests/bpf/test_lru_map.c
#![no_std]
...
unsafe extern "C" fn create_map(map_type: c_int, map_flags: c_int, size: c_uint) -> c_int {
    ...
    mfd = bpf_map_create(BPF_MAP_TYPE_ARRAY, core::ptr::null_mut(), sizeof(int), sizeof(__u64), 1, core::ptr::null_mut());
    if (mfd < 0)
    return -1;
    insns[0].imm = mfd;
    pfd = bpf_prog_load(BPF_PROG_TYPE_SCHED_CLS, core::ptr::null_mut(), "GPL", insns, ARRAY_SIZE(insns), core::ptr::null_mut());
    if (pfd < 0) {
    close(mfd);
    return -1;
    }
...
#[no_mangle]
unsafe extern "C" fn map_subset(map0: c_int, map1: c_int) -> c_int {
    static int map_subset(int map0, int map1)
    {
    let mut next_key: c_ulonglong = 0;
...
#[no_mangle]
unsafe extern "C" fn map_equal(lru_map: c_int, expected: c_int) -> c_int {
    static int map_equal(int lru_map, int expected)
    {
    return map_subset(lru_map, expected) && map_subset(expected, lru_map);
    }
#[no_mangle]
unsafe extern "C" fn sched_next_online(pid: c_int, next_to_try: *mut c_int) -> c_int {
    static int sched_next_online(int pid, int *next_to_try)
    {
    cpu_set_t cpuset;
    let mut next: c_int = *next_to_try;
    let mut ret: c_int = -1;
    while (next < nr_cpus) {
    CPU_ZERO(&cpuset);
    CPU_SET(next, &cpuset);
...
#[no_mangle]
unsafe extern "C" fn __tgt_size(map_size: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn __map_size(tgt_free: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn test_lru_sanity0(map_type: c_int, map_flags: c_int) {
    static void test_lru_sanity0(int map_type, int map_flags)
    {
    unsigned long long key, value[nr_cpus];
    int lru_map_fd, expected_map_fd;
    let mut next_cpu: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn test_lru_sanity1(map_type: c_int, map_flags: c_int, tgt_free: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn test_lru_sanity2(map_type: c_int, map_flags: c_int, tgt_free: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn test_lru_sanity3(map_type: c_int, map_flags: c_int, tgt_free: c_uint) {
...
// Test deletion
#[no_mangle]
unsafe extern "C" fn test_lru_sanity4(map_type: c_int, map_flags: c_int, tgt_free: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn do_test_lru_sanity5(last_key: c_ulonglong, map_fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_lru_sanity5(map_type: c_int, map_flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_lru_sanity6(map_type: c_int, map_flags: c_int, tgt_free: c_int) {
    static void test_lru_sanity6(int map_type, int map_flags, int tgt_free)
    {
    int lru_map_fd, expected_map_fd;
    unsigned long long key, value[nr_cpus];
    let mut map_size: c_uint = tgt_free * 2;
    let mut next_cpu: c_int = 0;
    if (!(map_flags & BPF_F_NO_COMMON_LRU))
    return;
    printf("%s (map_type:%d map_flags:0x%X): ", __func__, map_type,
...
//
#[no_mangle]
unsafe extern "C" fn test_lru_sanity7(map_type: c_int, map_flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn test_lru_sanity8(map_type: c_int, map_flags: c_int) {
