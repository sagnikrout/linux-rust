...
//! Source: tools/testing/selftests/bpf/progs/struct_ops_kptr_return_fail__wrong_type.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __msg((trusted_ptr_or_null_)": "At program exit the register R0 is not a known value) -> __failure {
