...
//! Source: tools/testing/selftests/bpf/progs/verifier_sock.c
#![no_std]
...
pub struct val {
    ...
    SEC("cgroup/skb")
    __description("skb.sk: no core::ptr::null_mut() check")
#[no_mangle]
pub unsafe extern "C" fn __msg('sock_common_or_null'": "invalid mem access) -> __failure {
    __failure __msg("invalid mem access 'sock_common_or_null'")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn skb_sk_no_null_check() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn sk_family_non_fullsock_field_1() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(access": "invalid sock_common) -> __failure {
    __failure __msg("invalid sock_common access")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn sk_sk_type_fullsock_field_1() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(expected=sock_common": "type=sock_common_or_null) -> __failure {
    __failure __msg("type=sock_common_or_null expected=sock_common")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn sk_no_skb_sk_check_1() -> __naked void {
    ...
    SEC("cgroup/skb")
    __description("sk_fullsock(skb.sk): no core::ptr::null_mut() check on ret")
#[no_mangle]
pub unsafe extern "C" fn __msg('sock_or_null'": "invalid mem access) -> __failure {
    __failure __msg("invalid mem access 'sock_or_null'")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn no_null_check_on_ret_1() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_sk_type_fullsock_field_2() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_family_non_fullsock_field_2() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_sk_state_narrow_load() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn port_word_load_backward_compatibility() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_dst_port_half_load() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(access": "invalid sock) -> __failure {
    __failure __msg("invalid sock access")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn dst_port_half_load_invalid_1() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_dst_port_byte_load() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid sock) -> __failure {
    ...
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn dst_port_byte_load_invalid() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid sock) -> __failure {
    ...
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn dst_port_half_load_invalid_2() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn dst_ip6_load_2nd_byte() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_sk_type_narrow_load() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_sk_protocol_narrow_load() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid sock) -> __failure {
    ...
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn skb_sk_beyond_last_field_1() -> __naked void {
...
pub unsafe extern "C" fn __msg(expected=sock_common": "type=sock_common_or_null) -> __failure {
    ...
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn sk_no_skb_sk_check_2() -> __naked void {
    ...
    SEC("cgroup/skb")
    __description("bpf_tcp_sock(skb.sk): no core::ptr::null_mut() check on ret")
#[no_mangle]
pub unsafe extern "C" fn __msg('tcp_sock_or_null'": "invalid mem access) -> __failure {
    __failure __msg("invalid mem access 'tcp_sock_or_null'")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn no_null_check_on_ret_2() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn skb_sk_tp_snd_cwnd_1() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn skb_sk_tp_bytes_acked() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(access": "invalid tcp_sock) -> __failure {
    __failure __msg("invalid tcp_sock access")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn skb_sk_beyond_last_field_2() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn skb_sk_tp_snd_cwnd_2() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_sk_release_skb_sk() -> __naked void {
...
pub unsafe extern "C" fn __msg(R1": "release helper bpf_sk_release expects referenced PTR_TO_BTF_ID passed to) -> __failure {
    __failure __msg("release helper bpf_sk_release expects referenced PTR_TO_BTF_ID passed to R1")
#[no_mangle]
pub unsafe extern "C" fn bpf_sk_fullsock_skb_sk() -> __naked void {
...
pub unsafe extern "C" fn __msg(R1": "release helper bpf_sk_release expects referenced PTR_TO_BTF_ID passed to) -> __failure {
    __failure __msg("release helper bpf_sk_release expects referenced PTR_TO_BTF_ID passed to R1")
#[no_mangle]
pub unsafe extern "C" fn bpf_tcp_sock_skb_sk() -> __naked void {
    ...
    SEC("tc")
    __description("sk_storage_get(map, skb.sk, core::ptr::null_mut(), 0): value == core::ptr::null_mut()")
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_null_0_value_null() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(expected=fp": "R3 type=scalar) -> __failure {
    __failure __msg("R3 type=scalar expected=fp")
#[no_mangle]
pub unsafe extern "C" fn sk_1_1_value_1() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_value_1_stack_value() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(bpf_map_lookup_elem": "cannot pass map_type 24 into func) -> __failure {
    __failure __msg("cannot pass map_type 24 into func bpf_map_lookup_elem")
#[no_mangle]
pub unsafe extern "C" fn map_lookup_elem_smap_key() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn xskmap_key_xs_queue_id() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(alloc_insn=6": "Unreleased reference id=2) -> __failure {
    __failure __msg("Unreleased reference id=2 alloc_insn=6")
#[no_mangle]
pub unsafe extern "C" fn map_lookup_elem_sockmap_key() -> __naked void {
...
pub unsafe extern "C" fn __msg(alloc_insn=6": "Unreleased reference id=2) -> __failure {
    __failure __msg("Unreleased reference id=2 alloc_insn=6")
#[no_mangle]
pub unsafe extern "C" fn map_lookup_elem_sockhash_key() -> __naked void {
...
// (u32*)(r10 - 4) = r1;				\
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn field_bpf_sk_release_sk_1() -> __naked void {
...
// (u32*)(r10 - 4) = r1;				\
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn field_bpf_sk_release_sk_2() -> __naked void {
...
// (u32*)(r10 - 4) = r1;				\
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn ctx_reuseport_array_key_flags() -> __naked void {
...
// (u32*)(r10 - 4) = r2;				\
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn reuseport_ctx_sockmap_key_flags() -> __naked void {
...
// (u32*)(r10 - 4) = r2;				\
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn reuseport_ctx_sockhash_key_flags() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn of_bpf_skc_to_helpers() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(size=2": "invalid bpf_context access off=28) -> __failure {
    __failure __msg("invalid bpf_context access off=28 size=2")
#[no_mangle]
pub unsafe extern "C" fn post_bind4_read_src_ip6() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(size=2": "invalid bpf_context access off=16) -> __failure {
    __failure __msg("invalid bpf_context access off=16 size=2")
#[no_mangle]
pub unsafe extern "C" fn post_bind4_read_mark() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(size=2": "invalid bpf_context access off=24) -> __failure {
    __failure __msg("invalid bpf_context access off=24 size=2")
#[no_mangle]
pub unsafe extern "C" fn post_bind6_read_src_ip4() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(size=2": "invalid bpf_context access off=44) -> __failure {
    __failure __msg("invalid bpf_context access off=44 size=2")
#[no_mangle]
pub unsafe extern "C" fn sock_create_read_src_port() -> __naked void {
    ...
    __noinline
#[no_mangle]
pub unsafe extern "C" fn skb_pull_data2(sk: *mut __sk_buff, len: __u32) -> c_long {
    ...
    __noinline
#[no_mangle]
pub unsafe extern "C" fn skb_pull_data1(sk: *mut __sk_buff, len: __u32) -> c_long {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    __failure __msg("invalid mem access")
#[no_mangle]
pub unsafe extern "C" fn invalidate_pkt_pointers_from_global_func(sk: *mut __sk_buff) -> c_int {
...
// p = 42; /* this is unsafe
    ...
    __noinline
#[no_mangle]
pub unsafe extern "C" fn xdp_pull_data2(x: *mut xdp_md, len: __u32) -> c_long {
    ...
    __noinline
#[no_mangle]
pub unsafe extern "C" fn xdp_pull_data1(x: *mut xdp_md, len: __u32) -> c_long {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    __failure __msg("invalid mem access")
#[no_mangle]
pub unsafe extern "C" fn invalidate_xdp_pkt_pointers_from_global_func(x: *mut xdp_md) -> c_int {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    __failure __msg("invalid mem access")
#[no_mangle]
pub unsafe extern "C" fn invalidate_xdp_pkt_pointers(x: *mut xdp_md) -> c_int {
...
// p = 42; /* this is unsafe
    ...
    __noinline
#[no_mangle]
pub unsafe extern "C" fn tail_call(sk: *mut __sk_buff) -> c_int {
    ...
    static __noinline
#[no_mangle]
pub unsafe extern "C" fn static_tail_call(sk: *mut __sk_buff) -> c_int {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    __failure __msg("invalid mem access")
#[no_mangle]
pub unsafe extern "C" fn invalidate_pkt_pointers_by_global_tail_call(sk: *mut __sk_buff) -> c_int {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    __failure __msg("invalid mem access")
#[no_mangle]
pub unsafe extern "C" fn invalidate_pkt_pointers_by_static_tail_call(sk: *mut __sk_buff) -> c_int {
...
// Direct tail calls do not invalidate packet pointers.
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn invalidate_pkt_pointers_by_tail_call(sk: *mut __sk_buff) -> c_int {
