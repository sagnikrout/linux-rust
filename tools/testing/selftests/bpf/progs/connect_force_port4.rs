...
//! Source: tools/testing/selftests/bpf/progs/connect_force_port4.c
#![no_std]
...
pub struct svc_addr {
    ...
    SEC("cgroup/connect4")
#[no_mangle]
pub unsafe extern "C" fn connect4(ctx: *mut bpf_sock_addr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn getsockname4(ctx: *mut bpf_sock_addr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn getpeername4(ctx: *mut bpf_sock_addr) -> c_int {
