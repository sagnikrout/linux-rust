...
//! Source: tools/testing/selftests/bpf/progs/freplace_unreliable_prog.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn replace_btf_unreliable_kprobe(ctx: *mut bpf_user_pt_regs_t) -> c_int {
