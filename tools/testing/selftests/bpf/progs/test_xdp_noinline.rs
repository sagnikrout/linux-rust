...
//! Source: tools/testing/selftests/bpf/progs/test_xdp_noinline.c
#![no_std]
...
pub const JHASH_INITVAL: c_uint = 0xdeadbeef;
    ...
    static __noinline
#[no_mangle]
pub unsafe extern "C" fn jhash(key: *const c_void, length: u32, initval: u32) -> u32 {
    ...
    __noinline
#[no_mangle]
pub unsafe extern "C" fn __jhash_nwords(a: u32, b: u32, c: u32, initval: u32) -> u32 {
...
#[derive(Copy, Clone)]
pub struct eth_hdr {
    pub eth_dest: [c_uchar; 6],
    pub eth_source: [c_uchar; 6],
    pub eth_proto: c_ushort,
}

#[no_mangle]
unsafe extern "C" fn calc_offset(is_ipv6: bool, is_icmp: bool) -> __noinline __u64 {
    static __noinline __u64 calc_offset(bool is_ipv6, bool is_icmp)
    {
    let mut off: __u64 = sizeof(struct eth_hdr);
    if (is_ipv6) {
...
pub unsafe extern "C" fn __attribute__(_arg: (noinline)) -> static {
    ...
    {
    let mut is_icmp: bool = !((pckt.flags & (1 << 0)) == 0);
    let mut off: __u64 = calc_offset(is_ipv6, is_icmp);
    struct udphdr *udp;
    udp = data + off;
    if (udp + 1 > data_end)
    return false;
...
pub unsafe extern "C" fn __attribute__(_arg: (noinline)) -> static {
    ...
    struct real_definition *dst, __u32 pkt_bytes)
    {
    let mut ip_suffix: __u32 = bpf_ntohs(pckt.flow.port16[0]);
    struct eth_hdr *new_eth;
    struct eth_hdr *old_eth;
    __u16 *next_iph_u16;
    struct iphdr *iph;
...
pub unsafe extern "C" fn __attribute__(_arg: (noinline)) -> static {
    static __attribute__ ((noinline))
#[no_mangle]
pub unsafe extern "C" fn swap_mac_and_send(data: *mut c_void, data_end: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (noinline)) -> static {
    static __attribute__ ((noinline))
#[no_mangle]
pub unsafe extern "C" fn send_icmp_reply(data: *mut c_void, data_end: *mut c_void) -> c_int {
    int send_icmp_reply(void *data, void *data_end)
    {
    struct icmphdr *icmp_hdr;
    __u16 *next_iph_u16;
    let mut tmp_addr: __u32 = 0;
    struct iphdr *iph;
    let mut csum: __u32 = 0;
    let mut off: __u64 = 0;
...
pub unsafe extern "C" fn __attribute__(_arg: (noinline)) -> static {
    static __attribute__ ((noinline))
#[no_mangle]
pub unsafe extern "C" fn send_icmp6_reply(data: *mut c_void, data_end: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __attribute__(_arg: (noinline)) -> static {
    ...
    {
    let mut new_dst_lru: real_pos_lru = { };
    let mut hash_16bytes: bool = is_ipv6;
...
// real = bpf_map_lookup_elem(&reals, &key);
    ...
    let mut conn_rate_key: __u32 = 512 + 2;
...
// pkt_bytes = bpf_ntohs(iph->tot_len);
    ...
    {
    struct real_definition *dst = core::ptr::null_mut();
    let mut pckt: packet_description = { };
    let mut vip: vip_definition = { };
    struct lb_stats *data_stats;
    void *lru_map = &lru_cache;
    struct vip_meta *vip_info;
    let mut lru_stats_key: __u32 = 513;
    let mut mac_addr_pos: __u32 = 0;
    let mut stats_key: __u32 = 512;
...
// (u32 *)data = dst->dst;
    ...
    SEC("xdp")
#[no_mangle]
pub unsafe extern "C" fn balancer_ingress_v4(ctx: *mut xdp_md) -> c_int {
    ...
    SEC("xdp")
#[no_mangle]
pub unsafe extern "C" fn balancer_ingress_v6(ctx: *mut xdp_md) -> c_int {
