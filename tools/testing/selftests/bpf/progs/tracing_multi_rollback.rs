...
//! Source: tools/testing/selftests/bpf/progs/tracing_multi_rollback.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: extra) -> c_int {
    int BPF_PROG(extra)
    {
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: filler) -> c_int {
    int BPF_PROG(filler)
    {
    return 0;
    }
