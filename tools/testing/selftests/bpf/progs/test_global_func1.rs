...
//! Source: tools/testing/selftests/bpf/progs/test_global_func1.c
#![no_std]
...
pub unsafe extern "C" fn f3(val: c_int, skb: *mut __sk_buff, var: c_int) -> c_int {
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn __msg(is": "combined stack size of 3 calls) -> __failure {
    __failure __msg("combined stack size of 3 calls is")
#[no_mangle]
pub unsafe extern "C" fn global_func1(skb: *mut __sk_buff) -> c_int {
