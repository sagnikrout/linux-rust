...
//! Source: tools/testing/selftests/bpf/progs/cgroup_getset_retval_getsockopt.c
#![no_std]
...
//
    ...
    let mut ctx_retval_value: __u32 = 0;
    let mut page_size: __u32 = 0;
...
// optval larger than PAGE_SIZE use kernel's buffer.
    ...
    SEC("cgroup/getsockopt")
#[no_mangle]
pub unsafe extern "C" fn clear_retval(ctx: *mut bpf_sockopt) -> c_int {
