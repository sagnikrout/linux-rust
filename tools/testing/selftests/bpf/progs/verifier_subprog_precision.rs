...
//! Source: tools/testing/selftests/bpf/progs/verifier_subprog_precision.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn identity_subprog() -> c_ulong {
...
// the simplest *static* 64-bit identity function
    ...
    __noinline __used
#[no_mangle]
pub unsafe extern "C" fn global_identity_subprog(x: __u64) -> c_ulong {
...
// the simplest *global* 64-bit identity function
    ...
    __naked __noinline __used
#[no_mangle]
unsafe extern "C" fn callback_subprog() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn subprog_result_precise() -> __naked int {
...
//
    ...
    __naked __noinline __used
#[no_mangle]
unsafe extern "C" fn fp_leaking_subprog() -> c_ulong {
    ...
    __naked __noinline __used
#[no_mangle]
unsafe extern "C" fn sneaky_fp_leaking_subprog() -> c_ulong {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("7: R0=scalar")
#[no_mangle]
pub unsafe extern "C" fn fp_precise_subprog_result() -> __naked int {
...
//
    ...
    __msg("7: R0=scalar")
#[no_mangle]
pub unsafe extern "C" fn sneaky_fp_precise_subprog_result() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn global_subprog_result_precise() -> __naked int {
...
//
    ...
    __naked __noinline __used
#[no_mangle]
unsafe extern "C" fn loop_callback_bad() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn callback_precise_return_fail() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn callback_result_precise() -> __naked int {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("mark_precise: frame0: regs=r6 stack= before 2: (b7) r6 = 3")
#[no_mangle]
pub unsafe extern "C" fn parent_callee_saved_reg_precise() -> __naked int {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("mark_precise: frame0: regs=r6 stack= before 2: (b7) r6 = 3")
#[no_mangle]
pub unsafe extern "C" fn parent_callee_saved_reg_precise_global() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn parent_callee_saved_reg_precise_with_callback() -> __naked int {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("mark_precise: frame0: regs=r6 stack= before 2: (b7) r6 = 3")
#[no_mangle]
pub unsafe extern "C" fn parent_stack_slot_precise() -> __naked int {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("mark_precise: frame0: regs=r6 stack= before 2: (b7) r6 = 3")
#[no_mangle]
pub unsafe extern "C" fn parent_stack_slot_precise_global() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn parent_stack_slot_precise_with_callback() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn subprog_arg_precise() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn subprog_spill_into_parent_stack_slot_precise() -> __naked int {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("mark_precise: frame0: regs=r6 stack= before 2: (b7) r6 = 1")
#[no_mangle]
pub unsafe extern "C" fn stack_slot_aliases_precision() -> __naked int {
...
//
    ...
    __naked __noinline __used
#[no_mangle]
unsafe extern "C" fn identity_tail_call() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn subprog_result_tail_call() -> __naked int {
