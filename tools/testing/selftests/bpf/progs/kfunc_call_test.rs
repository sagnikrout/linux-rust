...
//! Source: tools/testing/selftests/bpf/progs/kfunc_call_test.c
#![no_std]
...
//
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn kfunc_call_test5_asm() -> __naked int {
...
pub unsafe extern "C" fn kfunc_call_test_pass(skb: *mut __sk_buff) -> c_int {
    ...
    {
    let mut p1: prog_test_pass1 = {};
    let mut p2: prog_test_pass2 = {};
    let mut a: c_short = 0;
    let mut b: __u64 = 0;
    let mut c: c_long = 0;
    let mut d: c_char = 0;
...
#[derive(Copy, Clone)]
pub struct ctx_val {
    pub ctx: *mut bpf_testmod_ctx __kptr,
}
