...
//! Source: tools/testing/selftests/bpf/progs/verifier_bpf_fastcall.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn simple() -> __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn canary_arm64_riscv64() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn canary_zero_spills() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_reg_in_pattern1() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_reg_in_pattern2() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_reg_in_pattern3() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_base_in_pattern() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_insn_in_pattern() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_off_in_pattern1() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_off_in_pattern2() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn wrong_size_in_pattern() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn partial_pattern() -> __naked void {
...
// patched, spills for -24, -32 removed
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn min_stack_offset() -> __naked void {
...
// this call would be patched
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bad_fixed_read() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bad_fixed_write() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bad_varying_read() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bad_varying_write() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bad_write_in_subprog() -> __naked void {
    ...
    __used
#[no_mangle]
pub unsafe extern "C" fn bad_write_in_subprog_aux() -> __naked static void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bad_helper_write() -> __naked void {
...
// subprogram, patched
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn invalidate_one_subprog() -> __naked void {
    ...
    __used
#[no_mangle]
pub unsafe extern "C" fn invalidate_one_subprog_aux() -> __naked static void {
...
// subprogram
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn subprogs_use_independent_offsets() -> __naked void {
    ...
    __used
#[no_mangle]
pub unsafe extern "C" fn subprogs_use_independent_offsets_aux() -> __naked static void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn helper_call_does_not_prevent_bpf_fastcall() -> __naked void {
...
// may_goto expansion ends
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn may_goto_interaction_x86_64() -> __naked void {
...
// may_goto expansion ends
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn may_goto_interaction() -> __naked void {
...
// just touch some stack at -8
    ...
    __used
#[no_mangle]
pub unsafe extern "C" fn dummy_loop_callback() -> __naked static void {
...
// dummy_loop_callback
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bpf_loop_interaction1() -> __naked int {
...
// ... part of the inlined bpf_loop
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bpf_loop_interaction2() -> __naked int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cumulative_stack_depth() -> __naked int {
    ...
    __used
#[no_mangle]
pub unsafe extern "C" fn cumulative_stack_depth_subprog() -> __naked static void {
...
// bpf_cast_to_kern_ctx is replaced by a single assignment
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn kfunc_bpf_cast_to_kern_ctx() -> __naked void {
