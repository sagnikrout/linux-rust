...
//! Source: tools/testing/selftests/bpf/progs/iters.c
#![no_std]
...
// Copyright (c) 2023 Meta Platforms, Inc. and affiliates.
    ...
    SEC("?raw_tp")
#[no_mangle]
pub unsafe extern "C" fn __msg(allowed": "math between map_value pointer and register with unbounded min value is not) -> __failure {
    __failure __msg("math between map_value pointer and register with unbounded min value is not allowed")
#[no_mangle]
pub unsafe extern "C" fn iter_err_unsafe_c_loop(ctx: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iter_err_unsafe_asm_loop(ctx: *const c_void) -> c_int {
...
// bpf_iter_num_destroy(&it) is inlined to a nop
    ...
    __xlated("exit")
#[no_mangle]
pub unsafe extern "C" fn iter_num_new_inlined() -> int __naked {
...
// non-constant end so the range checks are kept
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_while_loop(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_while_loop_auto_cleanup(ctx: *const c_void) -> c_int {
...
// (!) no explicit bpf_iter_num_destroy()
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_for_loop(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_bpf_for_each_macro(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_bpf_for_macro(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_pragma_unroll_loop(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_manual_unroll_loop(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_multiple_sequential_loops(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_limit_cond_break_loop(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_obfuscate_counter(ctx: *const c_void) -> c_int {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_search_loop(ctx: *const c_void) -> c_int {
    int iter_search_loop(const void *ctx)
    {
    struct bpf_iter_num it;
    int *v, *elem = core::ptr::null_mut();
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_array_fill(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_nested_iters(ctx: *const c_void) -> c_int {
...
// calculate sums
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_nested_deeply_iters(ctx: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fill_inner_dimension(row: c_int) -> __noinline void {
...
#[no_mangle]
unsafe extern "C" fn sum_inner_dimension(row: c_int) -> __noinline int {
    static __noinline int sum_inner_dimension(int row)
    {
    let mut sum: c_int = 0, col;
    bpf_for(col, 0, ARRAY_SIZE(arr2d[0])) {
    sum += arr2d[row][col];
    arr2d_row_sums[row] += arr2d[row][col];
    arr2d_col_sums[col] += arr2d[row][col];
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_subprog_iters(ctx: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iter_err_too_permissive1(ctx: *const c_void) -> c_int {
    int iter_err_too_permissive1(const void *ctx)
    {
    int *map_val = core::ptr::null_mut();
    let mut key: c_int = 0;
    MY_PID_GUARD();
...
#[no_mangle]
pub unsafe extern "C" fn iter_err_too_permissive2(ctx: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __msg('map_value_or_null'": "invalid mem access) -> __failure {
    __failure __msg("invalid mem access 'map_value_or_null'")
#[no_mangle]
pub unsafe extern "C" fn iter_err_too_permissive3(ctx: *const c_void) -> c_int {
...
// map_val = 123;
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_tricky_but_fine(ctx: *const c_void) -> c_int {
...
// map_val = 123;
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_stack_array_loop(ctx: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fill(it: *mut bpf_iter_num, arr: *mut c_int, n: __u32, mul: c_int) -> __noinline void {
...
#[no_mangle]
unsafe extern "C" fn sum(it: *mut bpf_iter_num, arr: *mut c_int, n: __u32) -> __noinline int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_pass_iter_ptr_to_subprog(ctx: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn delayed_read_mark() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn delayed_precision_mark() -> __naked int {
...
#[no_mangle]
pub unsafe extern "C" fn loop_state_deps1() -> __naked int {
...
//
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn loop_state_deps2() -> __naked int {
...
// second inner loop
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn loop_state_deps3() -> __naked int {
...
// iterate
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn triple_continue() -> __naked int {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn widen_spill() -> __naked int {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn checkpoint_states_deletion() -> __naked int {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_arr_with_actual_elem_count(ctx: *const c_void) -> c_int {
...
// no rechecking of i against ARRAY_SIZE(loop_data.n)
    ...
    __u64 global;
#[no_mangle]
unsafe extern "C" fn nest_2(str: *mut c_char) -> __noinline bool {
...
#[no_mangle]
unsafe extern "C" fn nest_1(n: c_int) -> __noinline bool {
...
// case 0: allocate stack, case 1: no allocate stack
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn iter_subprog_check_stacksafe(ctx: *const c_void) -> c_int {
    ...
    SEC("raw_tp")
#[no_mangle]
pub unsafe extern "C" fn __msg(stack": "R1 expected pointer to an iterator on) -> __failure {
    __failure __msg("R1 expected pointer to an iterator on stack")
#[no_mangle]
pub unsafe extern "C" fn iter_new_bad_arg(ctx: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __msg(stack": "R1 expected pointer to an iterator on) -> __failure {
    __failure __msg("R1 expected pointer to an iterator on stack")
#[no_mangle]
pub unsafe extern "C" fn iter_next_bad_arg(ctx: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __msg(stack": "R1 expected pointer to an iterator on) -> __failure {
    __failure __msg("R1 expected pointer to an iterator on stack")
#[no_mangle]
pub unsafe extern "C" fn iter_destroy_bad_arg(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn clean_live_states(ctx: *const c_void) -> c_int {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn __msg(8": "misaligned stack access off -31+0 size) -> __failure {
    __failure __msg("misaligned stack access off -31+0 size 8")
#[no_mangle]
pub unsafe extern "C" fn absent_mark_in_the_middle_state() -> __naked int {
...
pub unsafe extern "C" fn __msg(8": "misaligned stack access off -31+0 size) -> __failure {
    __failure __msg("misaligned stack access off -31+0 size 8")
#[no_mangle]
pub unsafe extern "C" fn absent_mark_in_the_middle_state2() -> __naked int {
...
pub unsafe extern "C" fn __msg(8": "misaligned stack access off -31+0 size) -> __failure {
    __failure __msg("misaligned stack access off -31+0 size 8")
#[no_mangle]
pub unsafe extern "C" fn absent_mark_in_the_middle_state3() -> __naked int {
...
// return
    ...
    __used __naked
#[no_mangle]
unsafe extern "C" fn loop1() -> c_int {
...
//
    ...
    __used __naked
#[no_mangle]
unsafe extern "C" fn loop1_wrapper() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn absent_mark_in_the_middle_state4() -> __naked void {
...
unsafe extern "C" fn loop_cb4() {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn stack_misc_vs_scalar_in_a_loop() -> __naked int {
