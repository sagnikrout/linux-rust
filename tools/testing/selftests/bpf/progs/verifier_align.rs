...
//! Source: tools/testing/selftests/bpf/progs/verifier_align.c
#![no_std]
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("4: {{.*}} R3=32")
#[no_mangle]
pub unsafe extern "C" fn mov() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("10: {{.*}}R4=2")
#[no_mangle]
pub unsafe extern "C" fn shift() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("5: {{.*}}R4=14")
#[no_mangle]
pub unsafe extern "C" fn addsub() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("3: {{.*}}R3=56")
#[no_mangle]
pub unsafe extern "C" fn mul() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn unknown_shift() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn unknown_mul() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn packet_const_offset() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn packet_variable_offset() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn packet_variable_offset_2() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn dubious_pointer_arithmetic() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn variable_subtraction() -> __naked void {
...
//
    __msg("20: {{.*}} R5={{[^)]*}}var_off=(0x2; 0x7fc)")
#[no_mangle]
pub unsafe extern "C" fn pointer_variable_subtraction() -> __naked void {
