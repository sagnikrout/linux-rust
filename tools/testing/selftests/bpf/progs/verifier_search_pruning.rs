...
//! Source: tools/testing/selftests/bpf/progs/verifier_search_pruning.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __msg_unpriv(value": "R0 leaks addr as return) -> __success __failure_unpriv {
    __success __failure_unpriv __msg_unpriv("R0 leaks addr as return value")
    __retval(POINTER_VALUE)
#[no_mangle]
pub unsafe extern "C" fn state_equality_check_way_1() -> __naked void {
...
pub unsafe extern "C" fn __msg_unpriv(value": "R0 leaks addr as return) -> __success __failure_unpriv {
    ...
    __retval(POINTER_VALUE)
#[no_mangle]
pub unsafe extern "C" fn state_equality_check_way_2() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn liveness_pruning_and_write_screening() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn varlen_map_value_access_pruning() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg('scalar'": "R6 invalid mem access) -> __failure {
    __failure __msg("R6 invalid mem access 'scalar'")
#[no_mangle]
pub unsafe extern "C" fn should_be_verified_nop_operation() -> __naked void {
...
// in privileged mode reads from uninitialized stack locations are permitted
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn be_verified_invalid_stack_access() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn tracking_for_u32_spill_fill() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn for_u32_spills_u64_fill() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg_unpriv(__retval(0: "") __log_level(1)) -> __success_unpriv {
    __success_unpriv __msg_unpriv("") __log_level(1) __retval(0)
#[no_mangle]
pub unsafe extern "C" fn allocated_stack() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn and_register_parent_chain_bug() -> __naked void {
...
//
    SEC("kprobe")
#[no_mangle]
pub unsafe extern "C" fn __log_level(_arg: 4) -> __failure {
    __failure __log_level(4)
    __msg("BPF program is too large.")
#[no_mangle]
pub unsafe extern "C" fn short_loop1() -> __naked void {
