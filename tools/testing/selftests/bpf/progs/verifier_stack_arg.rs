...
//! Source: tools/testing/selftests/bpf/progs/verifier_stack_arg.c
#![no_std]
...
// Copyright (c) 2026 Meta Platforms, Inc. and affiliates.
    ...
    __noinline __used
#[no_mangle]
unsafe extern "C" fn subprog_6args(a: c_int, b: c_int, c: c_int, d: c_int, e: c_int, f: c_int) -> c_int {
    ...
    __noinline __used
#[no_mangle]
unsafe extern "C" fn subprog_7args(a: c_int, b: c_int, c: c_int, d: c_int, e: c_int, f: c_int, g: c_int) -> c_int {
    ...
    __noinline __used
#[no_mangle]
unsafe extern "C" fn subprog_deref_arg6(a: c_long, b: c_long, c: c_long, d: c_long, e: c_long, f: *mut c_long) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: 21) -> __success {
    __success __retval(21)
#[no_mangle]
pub unsafe extern "C" fn stack_arg_6args() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: 90) -> __success {
    __success __retval(90)
#[no_mangle]
pub unsafe extern "C" fn stack_arg_two_subprogs() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_read_uninitialized() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_gap_at_minus8() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_pruning_type_mismatch() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_release_ref() -> __naked void {
...
// Call subprog that dereferences arg6 — should fail
    ...
    __msg("callee expects 6 args, stack arg1 is not initialized")
#[no_mangle]
pub unsafe extern "C" fn stack_arg_stale_pkt_ptr() -> __naked void {
...
// Call subprog that dereferences arg6 — should fail
    ...
    __msg("R{{[0-9]}} invalid mem access 'scalar'")
#[no_mangle]
pub unsafe extern "C" fn stack_arg_null_propagation_fail() -> __naked void {
...
//
    ...
    __msg("callee expects 7 args, stack arg1 is not initialized")
#[no_mangle]
pub unsafe extern "C" fn stack_arg_missing_store_one_branch() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_shared_store() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_write_beyond_max() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_write_unused_slot() -> __naked void {
...
// Write to offset -40, unused for the callee
    ...
    __msg("callee expects 7 args, stack arg1 is not initialized")
#[no_mangle]
pub unsafe extern "C" fn stack_arg_sequential_calls() -> __naked void {
