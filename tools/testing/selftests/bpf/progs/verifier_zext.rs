...
//! Source: tools/testing/selftests/bpf/progs/verifier_zext.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn zext_lost_across_checkpoint() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("w1 = w0{{ +}}; zext")
#[no_mangle]
pub unsafe extern "C" fn zext_alu32_hi_used() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __not_msg("; zext")
#[no_mangle]
pub unsafe extern "C" fn no_zext_alu32_hi_unused() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn no_zext_mov64() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn zext_narrow_load_hi_used() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn zext_atomic_fetch32_hi_used() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn zext_cmpxchg32_hi_used() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("w6 = 32{{ +}}; zext")
#[no_mangle]
pub unsafe extern "C" fn zext_cfg_hi_used_one_branch() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __not_msg("w1 = 1{{.*}}; zext")
#[no_mangle]
pub unsafe extern "C" fn no_zext_other_reg_hi_used() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn zext_ld_abs_hi_used() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("w2 = 1{{ +}}; zext")
#[no_mangle]
pub unsafe extern "C" fn helper_param_read_as_64bit() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn subprog_reads_arg_as_64bit() -> __used __naked int {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("w1 = w0{{ +}}; zext")
#[no_mangle]
pub unsafe extern "C" fn subprog_param_read_as_64bit() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("w4 = 1{{ +}}; zext")
#[no_mangle]
pub unsafe extern "C" fn kfunc_param_read_per_btf() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __not_msg("; zext")
#[no_mangle]
pub unsafe extern "C" fn alu32_and_32bit_conditional() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("w1 = w0{{ +}}; zext")
#[no_mangle]
pub unsafe extern "C" fn alu32_and_64bit_conditional() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __not_msg("; zext")
#[no_mangle]
pub unsafe extern "C" fn alu64_and_conditionals() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn arena_ptr() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __xlated("9: w4 = w4")
#[no_mangle]
pub unsafe extern "C" fn probe_mem() -> __naked void {
