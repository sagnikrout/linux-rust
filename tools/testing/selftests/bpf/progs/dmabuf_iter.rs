...
//! Source: tools/testing/selftests/bpf/progs/dmabuf_iter.c
#![no_std]
...
pub const DMA_BUF_NAME_LEN: c_int = 32;
...
//
#[no_mangle]
unsafe extern "C" fn sanitize_string(src: *mut c_char, size: usize) {
...
// Name strings can be provided by userspace
    ...
    SEC("syscall")
#[no_mangle]
pub unsafe extern "C" fn iter_dmabuf_for_each(ctx: *const c_void) -> c_int {
