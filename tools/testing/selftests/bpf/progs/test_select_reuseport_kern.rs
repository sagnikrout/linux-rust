...
//! Source: tools/testing/selftests/bpf/progs/test_select_reuseport_kern.c
#![no_std]
...
// Copyright (c) 2018 Facebook
    ...
    SEC("sk_reuseport")
#[no_mangle]
pub unsafe extern "C" fn _select_by_skb_data(reuse_md: *mut sk_reuseport_md) -> c_int {
    int _select_by_skb_data(struct sk_reuseport_md *reuse_md)
    {
    __u32 linum, index = 0, flags = 0, index_zero = 0;
    __u32 *result_cnt;
    let mut data_check: data_check = {};
