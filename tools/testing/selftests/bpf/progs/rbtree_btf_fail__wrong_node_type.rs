...
//! Source: tools/testing/selftests/bpf/progs/rbtree_btf_fail__wrong_node_type.c
#![no_std]
...
pub struct node_data {
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn rbtree_api_add__wrong_node_type(ctx: *mut c_void) -> c_long {
