...
//! Source: tools/testing/selftests/bpf/progs/verifier_ref_tracking.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct bpf_key {
    pub __ksym: *mut *mut extern void bpf_key_put(struct bpf_key key),
    pub __ksym: *mut *mut extern struct bpf_key bpf_lookup_system_key(__u64 id),
    pub __ksym: *mut *mut extern struct bpf_key bpf_lookup_user_key(__s32 serial, __u64 flags),
...
pub struct test_val {
    ...
    __auxiliary
#[no_mangle]
pub unsafe extern "C" fn dummy_prog_42_tc() -> __naked void {
    ...
    __auxiliary
#[no_mangle]
pub unsafe extern "C" fn dummy_prog_24_tc() -> __naked void {
    ...
    __auxiliary
#[no_mangle]
pub unsafe extern "C" fn dummy_prog_loop1_tc() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_leak_potential_reference() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn potential_reference_to_sock_common_1() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn leak_potential_reference_on_stack() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn potential_reference_on_stack_2() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_zero_potential_reference() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn potential_reference_to_sock_common_2() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn copy_and_zero_potential_references() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn acquire_release_user_key_reference() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn acquire_release_system_key_reference() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn user_key_reference_without_check() -> __naked void {
...
pub unsafe extern "C" fn __msg(R1": "Possibly NULL pointer passed to trusted) -> __failure {
    __failure __msg("Possibly core::ptr::null_mut() pointer passed to trusted R1")
#[no_mangle]
pub unsafe extern "C" fn system_key_reference_without_check() -> __naked void {
    ...
    SEC("lsm.s/bpf")
    __description("reference tracking: release with core::ptr::null_mut() key pointer")
#[no_mangle]
pub unsafe extern "C" fn __msg(R1": "Possibly NULL pointer passed to trusted) -> __failure {
    __failure __msg("Possibly core::ptr::null_mut() pointer passed to trusted R1")
#[no_mangle]
pub unsafe extern "C" fn release_with_null_key_pointer() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn potential_reference_to_user_key() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn potential_reference_to_system_key() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(expected=sock": "type=sock_or_null) -> __failure {
    __failure __msg("type=sock_or_null expected=sock")
#[no_mangle]
pub unsafe extern "C" fn tracking_release_reference_without_check() -> __naked void {
    __naked void tracking_release_reference_without_check(void)
    {
    asm volatile (
    BPF_SK_LOOKUP(bpf_sk_lookup_tcp)
    "	/* reference in r0 may be core::ptr::null_mut() */		\
    r1 = r0;					\
    r2 = 0;						\
    call %[bpf_sk_release];				\
    exit;						\
...
#[no_mangle]
pub unsafe extern "C" fn __msg(expected=sock": "type=sock_common_or_null) -> __failure {
    __failure __msg("type=sock_common_or_null expected=sock")
#[no_mangle]
pub unsafe extern "C" fn to_sock_common_without_check() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_release_reference() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn release_reference_to_sock_common() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_release_reference_2() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(expected=sock": "type=scalar) -> __failure {
    __failure __msg("type=scalar expected=sock")
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_release_reference_twice() -> __naked void {
...
pub unsafe extern "C" fn __msg(expected=sock": "type=scalar) -> __failure {
    __failure __msg("type=scalar expected=sock")
#[no_mangle]
pub unsafe extern "C" fn release_reference_twice_inside_branch() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn check_free_in_one_subbranch() -> __naked void {
...
// Leak reference in R0 */			\
    exit;						\
    l1_%=:	if r0 == 0 goto l2_%=;		/* sk core::ptr::null_mut()? */	\
    r1 = r0;					\
    call %[bpf_sk_release];				\
    l2_%=:	exit;						\
    "	:
...
#[no_mangle]
pub unsafe extern "C" fn check_free_in_both_subbranches() -> __naked void {
...
// if (offsetof(skb, mark) > data_len) exit; */	\
    ...
    "	BPF_SK_LOOKUP(bpf_sk_lookup_tcp)
    "	if r6 == 0 goto l1_%=;		/* mark == 0? */\
    if r0 == 0 goto l2_%=;		/* sk core::ptr::null_mut()? */	\
    r1 = r0;					\
    call %[bpf_sk_release];				\
    l2_%=:	exit;						\
    l1_%=:	if r0 == 0 goto l3_%=;		/* sk core::ptr::null_mut()? */	\
    r1 = r0;					\
    call %[bpf_sk_release];				\
    l3_%=:	exit;						\
    "	:
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn call_free_reference_in_subprog() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn call_free_reference_in_subprog__1() {
...
pub unsafe extern "C" fn __msg(expected=sock": "type=scalar) -> __failure {
    __failure __msg("type=scalar expected=sock")
#[no_mangle]
pub unsafe extern "C" fn reference_in_subprog_and_outside() -> __naked void {
...
unsafe extern "C" fn __attribute__(_arg: (used)) -> __naked __noinline {
    static __naked __noinline __attribute__((used))
#[no_mangle]
pub unsafe extern "C" fn reference_in_subprog_and_outside__1() {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn alloc_leak_reference_in_subprog() -> __naked void {
...
unsafe extern "C" fn __attribute__(_arg: (used)) -> __naked __noinline {
    static __naked __noinline __attribute__((used))
#[no_mangle]
pub unsafe extern "C" fn alloc_leak_reference_in_subprog__1() {
...
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: POINTER_VALUE) -> __success {
    __success __retval(POINTER_VALUE)
#[no_mangle]
pub unsafe extern "C" fn alloc_in_subprog_release_outside() -> __naked void {
...
unsafe extern "C" fn __attribute__(_arg: (used)) -> __naked __noinline {
    static __naked __noinline __attribute__((used))
#[no_mangle]
pub unsafe extern "C" fn alloc_in_subprog_release_outside__1() {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn ptr_leak_into_caller_stack() -> __naked void {
...
unsafe extern "C" fn __attribute__(_arg: (used)) -> __naked __noinline {
    static __naked __noinline __attribute__((used))
#[no_mangle]
pub unsafe extern "C" fn ptr_leak_into_caller_stack__1() {
...
unsafe extern "C" fn __attribute__(_arg: (used)) -> __naked __noinline {
    static __naked __noinline __attribute__((used))
#[no_mangle]
pub unsafe extern "C" fn ptr_leak_into_caller_stack__2() {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn ptr_spill_into_caller_stack() -> __naked void {
...
unsafe extern "C" fn __attribute__(_arg: (used)) -> __naked __noinline {
    static __naked __noinline __attribute__((used))
#[no_mangle]
pub unsafe extern "C" fn ptr_spill_into_caller_stack__1() {
...
unsafe extern "C" fn __attribute__(_arg: (used)) -> __naked __noinline {
    static __naked __noinline __attribute__((used))
#[no_mangle]
pub unsafe extern "C" fn ptr_spill_into_caller_stack__2() {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_allow_ld_abs() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(leak": "BPF_LD_[ABS|IND] would lead to reference) -> __failure {
    __failure __msg("BPF_LD_[ABS|IND] would lead to reference leak")
#[no_mangle]
pub unsafe extern "C" fn ld_abs_while_holding_reference() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_allow_ld_ind() -> __naked void {
...
pub unsafe extern "C" fn __msg(leak": "BPF_LD_[ABS|IND] would lead to reference) -> __failure {
    __failure __msg("BPF_LD_[ABS|IND] would lead to reference leak")
#[no_mangle]
pub unsafe extern "C" fn ld_ind_while_holding_reference() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn check_reference_or_tail_call() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn release_reference_then_tail_call() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn possible_reference_over_tail_call() -> __naked void {
...
pub unsafe extern "C" fn __msg(leak": "tail_call would lead to reference) -> __failure {
    __failure __msg("tail_call would lead to reference leak")
#[no_mangle]
pub unsafe extern "C" fn checked_reference_over_tail_call() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(prohibited": "R1 pointer arithmetic on sock_or_null) -> __failure {
    __failure __msg("R1 pointer arithmetic on sock_or_null prohibited")
#[no_mangle]
pub unsafe extern "C" fn and_release_sock_or_null() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(prohibited": "R1 pointer arithmetic on sock) -> __failure {
    __failure __msg("R1 pointer arithmetic on sock prohibited")
#[no_mangle]
pub unsafe extern "C" fn tracking_mangle_and_release_sock() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_access_member() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(sock": "cannot write into) -> __failure {
    __failure __msg("cannot write into sock")
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_write_to_member() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(size=8": "invalid sock access off=0) -> __failure {
    __failure __msg("invalid sock access off=0 size=8")
#[no_mangle]
pub unsafe extern "C" fn _64_bit_access_of_member() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(_arg: "!read_ok") -> __failure {
    __failure __msg("!read_ok")
#[no_mangle]
pub unsafe extern "C" fn reference_tracking_access_after_release() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn tracking_direct_access_for_lookup() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    ...
    __flag(BPF_F_ANY_ALIGNMENT)
#[no_mangle]
pub unsafe extern "C" fn bpf_tcp_sock_after_release() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    ...
    __flag(BPF_F_ANY_ALIGNMENT)
#[no_mangle]
pub unsafe extern "C" fn bpf_sk_fullsock_after_release() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    ...
    __flag(BPF_F_ANY_ALIGNMENT)
#[no_mangle]
pub unsafe extern "C" fn sk_fullsock_tp_after_release() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    ...
    __flag(BPF_F_ANY_ALIGNMENT)
#[no_mangle]
pub unsafe extern "C" fn after_bpf_sk_release_tp() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn after_bpf_sk_release_sk() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(R1": "release helper bpf_sk_release expects referenced PTR_TO_BTF_ID passed to) -> __failure {
    __failure __msg("release helper bpf_sk_release expects referenced PTR_TO_BTF_ID passed to R1")
#[no_mangle]
pub unsafe extern "C" fn bpf_sk_release_listen_sk() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    __failure __msg("invalid mem access")
#[no_mangle]
pub unsafe extern "C" fn and_bpf_tcp_sock_sk() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn tracking_valid_pointer_null_comparison() -> __naked void {
...
pub unsafe extern "C" fn __msg(reference": "Unreleased) -> __failure {
    __failure __msg("Unreleased reference")
#[no_mangle]
pub unsafe extern "C" fn tracking_valid_pointer_value_comparison() -> __naked void {
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn sk_release_btf_tcp_sock() -> __naked void {
...
pub unsafe extern "C" fn __msg(access": "invalid mem) -> __failure {
    __failure __msg("invalid mem access")
#[no_mangle]
pub unsafe extern "C" fn to_tcp_sock_after_release() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg_unpriv(!read_ok": "R8) -> __success __failure_unpriv {
    __success __failure_unpriv __msg_unpriv("R8 !read_ok")
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn to_leak_released_ptr_reg() -> __naked void {
