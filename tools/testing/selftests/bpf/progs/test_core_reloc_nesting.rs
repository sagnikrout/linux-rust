...
//! Source: tools/testing/selftests/bpf/progs/test_core_reloc_nesting.c
#![no_std]
...
pub struct core_reloc_nesting {
    ...
    pub a: },
    struct {
    pub b: union core_reloc_nesting_subunion,
    pub b: },
}

    SEC("raw_tracepoint/sys_enter")
#[no_mangle]
pub unsafe extern "C" fn test_core_nesting(ctx: *mut c_void) -> c_int {
