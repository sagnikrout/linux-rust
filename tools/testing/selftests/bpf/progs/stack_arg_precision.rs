...
//! Source: tools/testing/selftests/bpf/progs/stack_arg_precision.c
#![no_std]
...
//
    SEC("?tc")
#[no_mangle]
pub unsafe extern "C" fn __btf_kfunc_gen(ctx: *mut __sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subprog_call_mem_kfunc(a: c_long, b: c_long, c: c_long, d: c_long, e: c_long, size: c_long) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn stack_arg_precision_bpf2bpf() -> __naked void {
