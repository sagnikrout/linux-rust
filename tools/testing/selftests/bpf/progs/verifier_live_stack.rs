...
//! Source: tools/testing/selftests/bpf/progs/verifier_live_stack.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn simple_read_simple_write() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn read_write_join() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn must_write_not_same_slot() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn must_write_not_same_type() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn caller_stack_write() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn write_first_param() -> __used __naked void {
    ...
    __msg("8: (95) exit")
#[no_mangle]
pub unsafe extern "C" fn caller_stack_read() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn read_first_param() -> __used __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn arg_track_join_convergence() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn arg_track_join_convergence_subprog() -> __used __naked void {
...
//
    __msg("12: safe")
#[no_mangle]
pub unsafe extern "C" fn caller_stack_pruning() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn read_first_param2() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn caller_stack_pruning_callback() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn loop_cb() -> __used __naked void {
...
//
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn syzbot_postorder_bug1() -> __naked void {
    ...
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __msg(size=8": "invalid read from stack R2 off=-1024) -> __failure {
    __failure __msg("invalid read from stack R2 off=-1024 size=8")
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn caller_stack_write_tail_call() -> __naked unsigned long {
...
#[no_mangle]
unsafe extern "C" fn write_tail_call() -> __used __naked unsigned long {
...
#[no_mangle]
pub unsafe extern "C" fn subprog_precise_stack_access() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn precise_read_two() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn subprog_multilevel_conservative() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn forward_to_inner() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn inner_callee() -> __used __naked void {
...
//
    ...
    __msg(" 8: {{.*}} (b7)")
#[no_mangle]
pub unsafe extern "C" fn callee_consumed_caller_stack() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn consume_and_call_inner() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn do_nothing2() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_zero_to_misc_unsound_array_lookup() -> __naked void {
...
pub unsafe extern "C" fn __msg('map_value_or_null'": "R0 invalid mem access) -> __failure {
    __failure __msg("R0 invalid mem access 'map_value_or_null'")
#[no_mangle]
pub unsafe extern "C" fn subprog_stack_zero_to_misc_unsound() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn maybe_clobber_key() -> __used __naked void {
...
//
    ...
    __msg("6: safe")
#[no_mangle]
pub unsafe extern "C" fn spill_reload_inflates_stack_liveness() -> __naked void {
...
//
#[no_mangle]
unsafe extern "C" fn modifier2() -> __used __naked void {
...
//
#[no_mangle]
unsafe extern "C" fn spill_reload_reader2() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn kfunc_iter_stack_liveness() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn spill_ptr_liveness_type_confusion() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn four_byte_write_kills_slot() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn dead_half_spi_write() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn four_byte_read_upper_half() -> __naked void {
...
//
    ...
    __msg("2: (61) r0 = *(u32 *)(r10 -4)        ; use: fp0-4h")
#[no_mangle]
pub unsafe extern "C" fn two_byte_write_no_kill() -> __naked void {
...
//
    ...
    __msg("2: (61) r0 = *(u32 *)(r10 -4)        ; use: fp0-4h")
#[no_mangle]
pub unsafe extern "C" fn one_byte_write_no_kill() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn high_stack_second_bitmask_word() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn two_four_byte_writes_kill_full_spi() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn both_branches_kill_slot() -> __naked void {
...
pub unsafe extern "C" fn __msg('map_value_or_null'": "R0 invalid mem access) -> __failure {
    __failure __msg("R0 invalid mem access 'map_value_or_null'")
#[no_mangle]
pub unsafe extern "C" fn half_spi_clean_preserves_stack_zero() -> __naked void {
...
//
    ...
    __msg("6: safe")
#[no_mangle]
pub unsafe extern "C" fn dead_spill_at_merge_enables_pruning() -> __naked void {
...
//
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn __msg('scalar'": "R1 invalid mem access) -> __failure {
    __failure __msg("R1 invalid mem access 'scalar'")
#[no_mangle]
pub unsafe extern "C" fn fp_add_loses_precision_kills_liveness() -> __naked void {
...
pub unsafe extern "C" fn __msg('scalar'": "R1 invalid mem access) -> __failure {
    __failure __msg("R1 invalid mem access 'scalar'")
#[no_mangle]
pub unsafe extern "C" fn fp_spill_loses_precision_kills_liveness() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn conditional_stx_in_subprog() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn cond_writer() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn multiple_callsites_different_offsets() -> __naked void {
...
// At call to outer_forwarder: main's fp-32 (slots 6,7) should be live
    __msg("6: (85) call pc+{{.*}}                   ; use: fp0-32")
#[no_mangle]
pub unsafe extern "C" fn nested_fp_passthrough() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn outer_forwarder() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn inner_reader() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn callee_must_write_before_read() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn write_then_read() -> __used __naked void {
...
// Both calls have fp-8 live due to context-insensitive parent_live
    ...
    __msg("7: (85) call pc+{{.*}}                   ; use: fp0-8")
#[no_mangle]
pub unsafe extern "C" fn return_site_liveness_bleeding() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn callback_conditional_read_beyond_ctx() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn cb_cond_read() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn callback_write_before_read_kills() -> __naked void {
...
//
#[no_mangle]
unsafe extern "C" fn cb_write_read() -> __used __naked void {
...
//
    ...
    __msg("9: (85) call bpf_loop#181            ; use: fp0-16")
#[no_mangle]
pub unsafe extern "C" fn callback_conditional_write_preserves() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn cb_cond_write_read() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn callback_two_calls_different_ctx() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn cb_read_ctx() -> __used __naked void {
...
pub unsafe extern "C" fn __msg('scalar'": "R0 invalid mem access) -> __failure {
    __failure __msg("R0 invalid mem access 'scalar'")
#[no_mangle]
pub unsafe extern "C" fn transitive_parent_stack_read_unsound() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn mid_fwd() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn grandchild_deref() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn two_fp_clear_stack_threshold() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn mid_two_fp_threshold() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn inner_nop_fptest() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn one_fp_clear_stack_threshold() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn mid_one_fp_threshold() -> __used __naked void {
...
pub unsafe extern "C" fn __msg('map_value_or_null'": "R0 invalid mem access) -> __failure {
    __failure __msg("R0 invalid mem access 'map_value_or_null'")
#[no_mangle]
pub unsafe extern "C" fn helper_parent_stack_read_unsound() -> __naked void {
...
//
#[no_mangle]
unsafe extern "C" fn fwd_parent_key_to_helper() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn helper_arg_fallback_keeps_scanning() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn helper_snprintf_parent_after_local_fallback() -> __used __naked void {
...
pub unsafe extern "C" fn __msg('scalar'": "R0 invalid mem access) -> __failure {
    __failure __msg("R0 invalid mem access 'scalar'")
#[no_mangle]
pub unsafe extern "C" fn propagate_callee_ancestor_chain() -> __naked void {
...
//
#[no_mangle]
unsafe extern "C" fn mid_seq_touch() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn nop_callee() -> __used __naked void {
...
// Reads main's fp-8 through forwarded pointer, dereferences result
#[no_mangle]
unsafe extern "C" fn deref_ancestor() -> __used __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn spilled_fp_cross_frame_deref() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn mid_fwd_spilled_ptr() -> __used __naked void {
...
//
#[no_mangle]
unsafe extern "C" fn load_ptr_deref_grandchild() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn test_merge_nonlocal_live() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn merge_wrapper_a() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn merge_wrapper_b() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn merge_shared_mid() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn merge_leaf_read() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_loop_two_callbacks() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn dyn_wrapper_a() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn dyn_wrapper_b() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn mid_dynamic_cb() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn dyn_cb_a() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn dyn_cb_b() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_or_non_stack_write() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn shared_instance_must_write_overwrite() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn forwarding_rw() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn write_first_read_second() -> __used __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn stale_must_write_cross_callsite() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn fwd_to_stale_wr() -> __used __naked void {
...
#[no_mangle]
unsafe extern "C" fn stale_wr_leaf() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn load_acquire_dont_clear_dst() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn imprecise_fill_loses_cross_frame() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn imprecise_fill_cross_frame() -> __used __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn spill_join_with_multi_off() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn spill_join_with_imprecise_off() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn st_imm_join_with_multi_off() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn st_imm_join_with_single_off() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn st_imm_join_with_imprecise_off() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn imprecise_dst_spill_join() -> __naked void {
...
#[no_mangle]
unsafe extern "C" fn imprecise_dst_spill_join_sub() -> __used __naked void {
