...
//! Source: tools/testing/selftests/bpf/progs/linked_vars1.c
#![no_std]
...
// this weak extern will be strict due to the other file's strong extern
    ...
    int input_bss1;
    let mut input_data1: c_int = 1;
    let mut input_rodata1: volatile int = 11;
    int input_bss_weak __weak;
// these two definitions should win
    let mut __weak: int input_data_weak = 10;
    let mut __weak: volatile int input_rodata_weak = 100;
    ...
    long output_sink1;
#[no_mangle]
unsafe extern "C" fn get_bss_res() -> __noinline int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: handler1) -> c_int {
