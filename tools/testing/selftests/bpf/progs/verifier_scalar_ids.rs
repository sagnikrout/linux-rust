...
//! Source: tools/testing/selftests/bpf/progs/verifier_scalar_ids.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn linked_regs_bpf_k() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn linked_regs_bpf_x_src() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("frame0: regs=r0,r1,r2,r3 stack= before 4: (b7) r3 = 7")
#[no_mangle]
pub unsafe extern "C" fn linked_regs_bpf_x_dst() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn linked_regs_broken_link() -> __naked void {
...
// Parent state
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn precision_many_frames() -> __naked void {
...
// main frame
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn precision_stack() -> __naked void {
...
// ... skip some insns ...
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn precision_two_ids() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn linked_regs_too_many_regs() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __failure {
    ...
    __msg("div by zero")
#[no_mangle]
pub unsafe extern "C" fn linked_regs_broken_link_2() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __msg("frame0: regs=r1 stack= before 2: (bf) r1 = r0")
#[no_mangle]
pub unsafe extern "C" fn cjmp_no_linked_regs_trigger() -> __naked void {
...
//
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __msg(value": "register with unbounded min) -> __failure {
    __failure __msg("register with unbounded min value")
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn check_ids_in_regsafe() -> __naked void {
...
pub unsafe extern "C" fn __msg(value": "register with unbounded min) -> __failure {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn check_ids_in_regsafe_2() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn no_scalar_id_for_const() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn no_scalar_id_for_const32() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn ignore_unique_scalar_ids_cur() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn ignore_unique_scalar_ids_old() -> __naked void {
...
//
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn two_nil_old_ids_one_cur_id() -> __naked void {
...
//
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn two_old_ids_one_cur_id() -> __naked void {
...
//
    ...
    __xlated("exit")
#[no_mangle]
pub unsafe extern "C" fn linked_regs_and_subreg_def() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn ldsx_fill_scalar_id_not_shared() -> __naked void {
