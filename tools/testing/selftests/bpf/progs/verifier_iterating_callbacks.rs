...
//! Source: tools/testing/selftests/bpf/progs/verifier_iterating_callbacks.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn unsafe_on_2nd_iter_cb(idx: __u32, ctx: *mut buf_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unsafe_on_2nd_iter(unused: *mut c_void) -> c_int {
    int unsafe_on_2nd_iter(void *unused)
    {
    char buf[4];
    let mut loop_ctx: buf_context = { .buf = buf };
    bpf_loop(100, unsafe_on_2nd_iter_cb, &loop_ctx, 0);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn unsafe_on_zero_iter_cb(idx: __u32, ctx: *mut num_context) -> c_int {
    ...
    SEC("?raw_tp")
#[no_mangle]
pub unsafe extern "C" fn __msg(value: "invalid access to map, size=1": value_size=2 off=32) -> __failure {
    __failure __msg("invalid access to map value, value_size=2 off=32 size=1")
#[no_mangle]
pub unsafe extern "C" fn unsafe_on_zero_iter(unused: *mut c_void) -> c_int {
    int unsafe_on_zero_iter(void *unused)
    {
    let mut loop_ctx: num_context = { .i = 32 };
    bpf_loop(100, unsafe_on_zero_iter_cb, &loop_ctx, 0);
    return choice_arr[loop_ctx.i];
    }
#[no_mangle]
unsafe extern "C" fn widening_cb(idx: __u32, ctx: *mut num_context) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn widening(unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loop_detection_cb(idx: __u32, ctx: *mut num_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn loop_detection(unused: *mut c_void) -> c_int {
    int loop_detection(void *unused)
    {
    let mut loop_ctx: num_context = { .i = 0 };
    bpf_loop(100, loop_detection_cb, &loop_ctx, 0);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn oob_state_machine(ctx: *mut num_context) -> __always_inline __u64 {
...
#[no_mangle]
unsafe extern "C" fn for_each_map_elem_cb(map: *mut bpf_map, key: *mut __u32, val: *mut __u64, data: *mut c_void) -> __u64 {
...
pub unsafe extern "C" fn __msg(value: "invalid access to map, size=1": value_size=2 off=32) -> __failure {
    __failure __msg("invalid access to map value, value_size=2 off=32 size=1")
#[no_mangle]
pub unsafe extern "C" fn unsafe_for_each_map_elem(unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ringbuf_drain_cb(dynptr: *mut bpf_dynptr, data: *mut c_void) -> __u64 {
...
pub unsafe extern "C" fn __msg(value: "invalid access to map, size=1": value_size=2 off=32) -> __failure {
    __failure __msg("invalid access to map value, value_size=2 off=32 size=1")
#[no_mangle]
pub unsafe extern "C" fn unsafe_ringbuf_drain(unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_vma_cb(task: *mut task_struct, vma: *mut vm_area_struct, data: *mut c_void) -> __u64 {
...
pub unsafe extern "C" fn __msg(value: "invalid access to map, size=1": value_size=2 off=32) -> __failure {
    __failure __msg("invalid access to map value, value_size=2 off=32 size=1")
#[no_mangle]
pub unsafe extern "C" fn unsafe_find_vma(unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iter_limit_cb(idx: __u32, ctx: *mut num_context) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn bpf_loop_iter_limit_ok(unused: *mut c_void) -> c_int {
    int bpf_loop_iter_limit_ok(void *unused)
    {
    let mut ctx: num_context = { .i = 0 };
    bpf_loop(1, iter_limit_cb, &ctx, 0);
    return choice_arr[ctx.i];
    }
    SEC("?raw_tp")
#[no_mangle]
pub unsafe extern "C" fn __msg(value: "invalid access to map, size=1": value_size=2 off=2) -> __failure {
    __failure __msg("invalid access to map value, value_size=2 off=2 size=1")
#[no_mangle]
pub unsafe extern "C" fn bpf_loop_iter_limit_overflow(unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iter_limit_level2a_cb(idx: __u32, ctx: *mut num_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iter_limit_level2b_cb(idx: __u32, ctx: *mut num_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iter_limit_level1_cb(idx: __u32, ctx: *mut num_context) -> c_int {
...
//
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: 111111) -> __success {
    __success __retval(111111)
#[no_mangle]
pub unsafe extern "C" fn bpf_loop_iter_limit_nested(unused: *mut c_void) -> c_int {
    int bpf_loop_iter_limit_nested(void *unused)
    {
    let mut ctx1: num_context = { .i = 0 };
    let mut ctx2: num_context = { .i = 0 };
    __u64 a, b, c;
...
#[no_mangle]
unsafe extern "C" fn iter_limit_bug_cb() -> __naked void {
...
//
    ...
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __msg(2": "infinite loop detected at insn) -> __failure {
    __failure __msg("infinite loop detected at insn 2")
#[no_mangle]
pub unsafe extern "C" fn jgt_imm64_and_may_goto() -> __naked void {
    ...
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __msg(1": "infinite loop detected at insn) -> __failure {
    __failure __msg("infinite loop detected at insn 1")
#[no_mangle]
pub unsafe extern "C" fn may_goto_self() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn may_goto_neg_off() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn iter_limit_bug(skb: *mut __sk_buff) -> c_int {
    int iter_limit_bug(struct __sk_buff *skb)
    {
    let mut ctx: iter_limit_bug_ctx = { 7, 7, 7 };
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn ja_and_may_goto() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn ja_and_may_goto2() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn jlt_and_may_goto() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn gotol_and_may_goto() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn ja_and_may_goto_subprog() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn subprog_with_may_goto() {
...
pub const ARR_SZ: c_int = 1000000;
    int zero;
    char arr[ARR_SZ];
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: 0xd495cdc0) -> __success {
    __success __retval(0xd495cdc0)
#[no_mangle]
pub unsafe extern "C" fn cond_break1(ctx: *const c_void) -> c_int {
    ...
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: 999000000) -> __success {
    __success __retval(999000000)
#[no_mangle]
pub unsafe extern "C" fn cond_break2(ctx: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loop() -> __noinline int {
    ...
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __retval(_arg: 0x6a5a2920) -> __success {
    __success __retval(0x6a5a2920)
#[no_mangle]
pub unsafe extern "C" fn cond_break3(ctx: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cond_break4(ctx: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn static_subprog() -> __noinline int {
...
pub unsafe extern "C" fn __retval(_arg: 1) -> __success {
    __success __retval(1)
#[no_mangle]
pub unsafe extern "C" fn cond_break5(ctx: *const c_void) -> c_int {
    int cond_break5(const void *ctx)
    {
    let mut cnt1: c_int = zero, cnt2;
    for (;;) {
    cond_break;
    cnt1++;
    }
...
pub const ARR2_SZ: c_int = 1000;
    SEC(".data.arr2")
    char arr2[ARR2_SZ];
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __flag(_arg: BPF_F_TEST_STATE_FREQ) -> __success {
    __success __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn loop_inside_iter(ctx: *const c_void) -> c_int {
...
pub unsafe extern "C" fn __flag(_arg: BPF_F_TEST_STATE_FREQ) -> __success {
    __success __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn loop_inside_iter_signed(ctx: *const c_void) -> c_int {
    ...
    let mut limit: volatile int = ARR2_SZ;
    SEC("socket")
#[no_mangle]
pub unsafe extern "C" fn __flag(_arg: BPF_F_TEST_STATE_FREQ) -> __success {
    __success __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn loop_inside_iter_volatile_limit(ctx: *const c_void) -> c_int {
...
pub const ARR_LONG_SZ: c_int = 1000;
    SEC(".data.arr_long")
    long arr_long[ARR_LONG_SZ];
    SEC("socket")
    __success
#[no_mangle]
pub unsafe extern "C" fn test1(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn test2(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn test3(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn test4(ctx: *const c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn check_add_const() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn check_add_const_3regs() -> __naked void {
    ...
    __msg("invalid access to map value, value_size=10 off=10 size=1")
#[no_mangle]
pub unsafe extern "C" fn check_add_const_3regs_2if() -> __naked void {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn check_add_const_regsafe_off() -> __naked void {
