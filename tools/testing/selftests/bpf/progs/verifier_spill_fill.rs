...
//! Source: tools/testing/selftests/bpf/progs/verifier_spill_fill.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn check_valid_spill_fill() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn valid_spill_fill_skb_mark() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success __success_unpriv {
    __success __success_unpriv __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_fill_ptr_to_mem() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(prohibited": "R0 pointer arithmetic on ringbuf_mem_or_null) -> __failure {
    __failure __msg("R0 pointer arithmetic on ringbuf_mem_or_null prohibited")
    __failure_unpriv
#[no_mangle]
pub unsafe extern "C" fn with_invalid_reg_offset_0() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn check_corrupted_spill_fill() -> __naked void {
...
pub unsafe extern "C" fn __msg_unpriv(spilled": "attempt to corrupt) -> __success __failure_unpriv {
    ...
    __retval(POINTER_VALUE)
#[no_mangle]
pub unsafe extern "C" fn check_corrupted_spill_fill_lsb() -> __naked void {
...
pub unsafe extern "C" fn __msg_unpriv(spilled": "attempt to corrupt) -> __success __failure_unpriv {
    ...
    __retval(POINTER_VALUE)
#[no_mangle]
pub unsafe extern "C" fn check_corrupted_spill_fill_msb() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn scalar_offset_to_skb_data_1() -> __naked void {
...
// in privileged mode reads from uninitialized stack locations are permitted
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn uninit_u32_from_the_stack() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn u16_offset_to_skb_data() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(allowed": "math between pkt pointer and register with unbounded min value is not) -> __failure {
    __failure __msg("math between pkt pointer and register with unbounded min value is not allowed")
#[no_mangle]
pub unsafe extern "C" fn u64_offset_to_skb_data() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn _6_offset_to_skb_data() -> __naked void {
...
pub unsafe extern "C" fn __msg(packet": "invalid access to) -> __failure {
    __failure __msg("invalid access to packet")
#[no_mangle]
pub unsafe extern "C" fn addr_offset_to_skb_data() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn scalar_offset_to_skb_data_2() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn and_then_at_fp_8() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(allowed": "math between ctx pointer and 4294967295 is not) -> __failure {
    __failure __msg("math between ctx pointer and 4294967295 is not allowed")
#[no_mangle]
pub unsafe extern "C" fn spill_32bit_of_64bit_fail() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(disallowed": "dereference of modified ctx ptr R6 off=65535) -> __failure {
    __failure __msg("dereference of modified ctx ptr R6 off=65535 disallowed")
#[no_mangle]
pub unsafe extern "C" fn spill_16bit_of_32bit_fail() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn spill_subregs_preserve_stack_zero() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn partial_stack_load_preserves_zeros() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn partial_stack_load_preserves_partial_zeros() -> __naked void {
...
// load single U32 from non-aligned stack zero slot
    ...
    __msg("R2=0")
#[no_mangle]
pub unsafe extern "C" fn stack_load_preserves_mixed_zero_and_zero_spill() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_load_preserves_const_precision() -> __naked void {
...
// validate load from fp-16, which was initialized using BPF_STX_MEM
    ...
    __msg("14: R1=map_value(map=.data.two_byte_,ks=4,vs=2,imm=1) R2=1")
#[no_mangle]
pub unsafe extern "C" fn stack_load_preserves_const_precision_subreg() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_32bit_range_track() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_64bit_of_64bit_ok() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_32bit_of_32bit_ok() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_16bit_of_16bit_ok() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_8bit_of_8bit_ok() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_unbounded() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn fill_32bit_after_spill_64bit() -> __naked void {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn fill_32bit_after_spill_64bit_preserve_id() -> __naked void {
...
pub unsafe extern "C" fn __msg(allowed": "math between ctx pointer and 4294967295 is not) -> __failure {
    __failure __msg("math between ctx pointer and 4294967295 is not allowed")
#[no_mangle]
pub unsafe extern "C" fn fill_32bit_after_spill_64bit_clear_id() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn old_imprecise_scalar_vs_cur_stack_misc() -> __naked void {
...
//
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_precise_scalar_vs_cur_stack_misc() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_stack_misc_vs_cur_scalar() -> __naked void {
...
//
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_stack_misc_vs_cur_ctx_ptr() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg_unpriv(8": "invalid read from stack off -8+1 size) -> __failure_unpriv {
    __failure_unpriv __msg_unpriv("invalid read from stack off -8+1 size 8")
#[no_mangle]
pub unsafe extern "C" fn stack_noperfmon_reject_invalid_read() -> __naked void {
...
// (u8 *)(r6 + 0) = r2;				\
    ...
    __success_unpriv
#[no_mangle]
pub unsafe extern "C" fn stack_noperfmon_spill_32bit_onto_64bit_slot() -> __naked void {
...
pub unsafe extern "C" fn __log_level(_arg: 2) -> __success {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_imprecise_scalar32_vs_cur_stack_misc() -> __naked void {
...
// read fp-8, should be considered safe on second visit
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn var_off_write_over_scalar_spill() -> __naked void {
...
//
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn partial_fill_from_cleaned_pointer_spill() -> __naked void {
...
// check valid spill/fill, ptr to tp buffer
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn spill_fill_ptr_to_tp_buffer() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn spill_fill_dynptr_subprog(dptr: *mut bpf_dynptr) -> __noinline int {
