...
//! Source: tools/testing/selftests/bpf/progs/for_each_hash_map_elem.c
#![no_std]
...
pub struct callback_ctx {
    ...
    let mut cpu: __u32 = 0;
    let mut percpu_called: __u32 = 0;
    let mut percpu_key: __u32 = 0;
    let mut percpu_val: __u64 = 0;
    let mut percpu_output: c_int = 0;
    static __u64
    ...
    let mut hashmap_output: c_int = 0;
    let mut hashmap_elems: c_int = 0;
    let mut percpu_map_elems: c_int = 0;
    SEC("tc")
#[no_mangle]
