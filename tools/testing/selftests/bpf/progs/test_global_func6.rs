...
//! Source: tools/testing/selftests/bpf/progs/test_global_func6.c
#![no_std]
...
pub unsafe extern "C" fn f3(val: c_int, skb: *mut __sk_buff) -> c_int {
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn __msg(R2": "modified ctx ptr) -> __failure {
    __failure __msg("modified ctx ptr R2")
#[no_mangle]
pub unsafe extern "C" fn global_func6(skb: *mut __sk_buff) -> c_int {
