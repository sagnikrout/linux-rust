...
//! Source: tools/testing/selftests/bpf/progs/nested_acquire.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_nested_acquire_nonzero, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_nested_acquire_zero, sk: *mut sock, skb: *mut sk_buff) -> c_int {
