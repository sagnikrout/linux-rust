...
//! Source: tools/testing/selftests/bpf/progs/verifier_var_off.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn variable_offset_ctx_access() -> __naked void {
...
// dereference it */				\
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_read_priv_vs_unpriv() -> __naked void {
...
// dereference it for a stack read */		\
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_read_var_off_preserves_spilled_zero() -> __naked void {
...
// (u8*)(r1 + 0) = r3;			\
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_read_var_off_preserves_spilled_zero_across_slots() -> __naked void {
...
// (u8*)(r1 + 0) = r3;			\
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_read_var_off_preserves_partial_spilled_zero() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn stack_read_var_off_partial_spill_with_misc_data() -> __naked void {
...
// (u8*)(r1 + 0) = 0;			\
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn __msg_unpriv(!root": "R2 variable stack access prohibited for) -> __failure_unpriv {
    __failure_unpriv __msg_unpriv("R2 variable stack access prohibited for !root")
#[no_mangle]
pub unsafe extern "C" fn variable_offset_stack_read_uninitialized() -> __naked void {
...
//
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_write_priv_vs_unpriv() -> __naked void {
...
//
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_write_followed_by_read() -> __naked void {
...
//
    __msg_unpriv("R2 variable stack access prohibited for !root")
#[no_mangle]
pub unsafe extern "C" fn stack_write_clobbers_spilled_regs() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(R4": "invalid unbounded variable-offset write to stack) -> __failure {
    __failure __msg("invalid unbounded variable-offset write to stack R4")
#[no_mangle]
pub unsafe extern "C" fn variable_offset_stack_access_unbounded() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(R2": "invalid variable-offset read from stack) -> __failure {
    __failure __msg("invalid variable-offset read from stack R2")
#[no_mangle]
pub unsafe extern "C" fn access_max_out_of_bound() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(R1": "invalid variable-offset write to stack) -> __failure {
    __failure __msg("invalid variable-offset write to stack R1")
#[no_mangle]
pub unsafe extern "C" fn zero_sized_access_max_out_of_bound() -> __naked void {
...
pub unsafe extern "C" fn __msg(R2": "invalid variable-offset read from stack) -> __failure {
    __failure __msg("invalid variable-offset read from stack R2")
#[no_mangle]
pub unsafe extern "C" fn access_min_out_of_bound() -> __naked void {
...
pub unsafe extern "C" fn __msg_unpriv(!root": "R2 variable stack access prohibited for) -> __failure_unpriv {
    __failure_unpriv __msg_unpriv("R2 variable stack access prohibited for !root")
#[no_mangle]
pub unsafe extern "C" fn access_min_off_min_initialized() -> __naked void {
...
// Dereference it indirectly. */		\
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn stack_access_priv_vs_unpriv() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn variable_offset_stack_access_ok() -> __naked void {
