...
//! Source: tools/testing/selftests/bpf/progs/test_xdp_dynptr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn count_tx(protocol: __u32) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn get_dport(trans_data: *mut c_void, protocol: __u8) -> __always_inline int {
...
#[no_mangle]
unsafe extern "C" fn handle_ipv4(xdp: *mut xdp_md, xdp_ptr: *mut bpf_dynptr) -> __always_inline int {
...
#[no_mangle]
unsafe extern "C" fn handle_ipv6(xdp: *mut xdp_md, xdp_ptr: *mut bpf_dynptr) -> __always_inline int {
...
// It only does v6-in-v6
    ...
    SEC("xdp")
#[no_mangle]
pub unsafe extern "C" fn _xdp_tx_iptunnel(xdp: *mut xdp_md) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(bpf_htons(ETH_P_IPV6): h_proto ==) -> else {
