...
//! Source: tools/testing/selftests/bpf/progs/test_l4lb.c
#![no_std]
...
pub struct eth_hdr {
    ...
    bool is_ipv6)
    {
    let mut hash: __u32 = get_packet_hash(pckt, is_ipv6) % RING_SIZE;
    let mut key: __u32 = RING_SIZE * vip_info.vip_num + hash;
    __u32 *real_pos;
