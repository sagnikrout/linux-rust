...
//! Source: tools/testing/selftests/bpf/progs/mem_rdonly_untrusted.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn btf_id_to_ptr_mem(ctx: *mut c_void) -> c_int {
...
//
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn ldx_is_ok_bad_addr(ctx: *mut c_void) -> c_int {
    ...
    __retval(1)
#[no_mangle]
pub unsafe extern "C" fn ldx_is_ok_good_addr(ctx: *mut c_void) -> c_int {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn offset_not_tracked(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stx_not_ok(ctx: *mut c_void) -> c_int {
...
// p = 1;
    ...
    __msg("cannot write into rdonly_untrusted_mem")
#[no_mangle]
pub unsafe extern "C" fn atomic_not_ok(ctx: *mut c_void) -> c_int {
    ...
    __msg("cannot write into rdonly_untrusted_mem")
#[no_mangle]
pub unsafe extern "C" fn atomic_rmw_not_ok(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kfunc_param_not_ok(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn helper_param_not_ok(ctx: *mut c_void) -> c_int {
...
//
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn mixed_mem_type(ctx: *mut c_void) -> c_int {
...
// Try to avoid compiler hoisting load to if branches by using __noinline func.
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn mixed_mem_untrusted_btf_id_type(ctx: *mut c_void) -> c_int {
...
//
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn mixed_mem_btf_id_type(ctx: *mut c_void) -> c_int {
...
//
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn mixed_rdonly_mem_btf_id_type(ctx: *mut c_void) -> c_int {
...
//
    ...
    __retval(0)
#[no_mangle]
pub unsafe extern "C" fn mixed_mem_mem_type(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mixed_map_value_mem_type(ctx: *mut c_void) -> c_int {
...
//
    ...
    __msg("same insn cannot be used with different pointers")
#[no_mangle]
pub unsafe extern "C" fn mixed_stack_mem_type(ctx: *mut c_void) -> c_int {
...
//
    ...
    __always_inline
#[no_mangle]
unsafe extern "C" fn combine(p: *mut c_void) -> u64 {
    ...
    __retval(0x88442211)
#[no_mangle]
pub unsafe extern "C" fn diff_size_access(ctx: *mut c_void) -> c_int {
    ...
    __retval(0x99553322)
#[no_mangle]
pub unsafe extern "C" fn misaligned_access(ctx: *mut c_void) -> c_int {
    int misaligned_access(void *ctx)
    {
    return combine(bpf_rdonly_cast(&global, 0) + 1);
    }
#[no_mangle]
pub unsafe extern "C" fn return_one() -> __weak int {
    ...
    __retval(1)
#[no_mangle]
pub unsafe extern "C" fn null_check(ctx: *mut c_void) -> c_int {
...
//
    ...
    __retval(1)
#[no_mangle]
pub unsafe extern "C" fn ldx_is_ok_commuted_addr(ctx: *mut c_void) -> c_int {
