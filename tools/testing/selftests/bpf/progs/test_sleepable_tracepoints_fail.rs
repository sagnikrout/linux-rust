...
//! Source: tools/testing/selftests/bpf/progs/test_sleepable_tracepoints_fail.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __msg(tracepoint": "Sleepable program cannot attach to non-faultable) -> __failure {
