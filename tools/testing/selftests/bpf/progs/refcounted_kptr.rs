...
//! Source: tools/testing/selftests/bpf/progs/refcounted_kptr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn less(node_a: *mut bpf_rb_node, node_b: *const bpf_rb_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn less_a(a: *mut bpf_rb_node, b: *const bpf_rb_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __read_from_unstash(idx: c_int) -> c_long {
    static long __read_from_unstash(int idx)
    {
    struct node_data *n = core::ptr::null_mut();
    struct map_value *mapval;
...
#[no_mangle]
pub unsafe extern "C" fn list_empty_test(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_is_edge_test1(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_is_edge_test2(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_is_edge_test3(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_del_test1(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_del_test2(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_del_test3(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_add_test1(ctx: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_add_test2(ctx: *mut c_void) -> c_int {
...
pub struct uninit_head_val {
    ...
    pub l): bpf_list_head head __contains(node_data,,
}
...
pub unsafe extern "C" fn __retval(_arg: 0) -> __success {
    __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn list_push_back_uninit_head(ctx: *mut c_void) -> c_int {
    int list_push_back_uninit_head(void *ctx)
    {
    struct uninit_head_val *st;
    struct node_data *node;
    let mut ret: c_int = -1, key = 0;
    ...
    SEC("?tc")
#[no_mangle]
pub unsafe extern "C" fn __msg(bpf_list_head": "bpf_spin_lock at off=32 must be held for) -> __failure {
    __failure __msg("bpf_spin_lock at off=32 must be held for bpf_list_head")
#[no_mangle]
pub unsafe extern "C" fn list_del_without_lock_fail(ctx: *mut c_void) -> c_long {
...
pub unsafe extern "C" fn __msg(bpf_list_head": "bpf_spin_lock at off=32 must be held for) -> __failure {
    __failure __msg("bpf_spin_lock at off=32 must be held for bpf_list_head")
#[no_mangle]
pub unsafe extern "C" fn list_add_without_lock_fail(ctx: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn __stash_map_empty_xchg(n: *mut node_data, idx: c_int) -> c_long {
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn rbtree_wrong_owner_remove_fail_a1(ctx: *mut c_void) -> c_long {
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn rbtree_wrong_owner_remove_fail_b(ctx: *mut c_void) -> c_long {
    ...
    if (!mapval)
    return 1;
    n = bpf_kptr_xchg(&mapval.node, core::ptr::null_mut());
    if (!n)
    return 2;
    bpf_spin_lock(&block);
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn rbtree_wrong_owner_remove_fail_a2(ctx: *mut c_void) -> c_long {
    ...
    if (!mapval)
    return 1;
    m = bpf_kptr_xchg(&mapval.node, core::ptr::null_mut());
    if (!m)
    return 2;
    bpf_spin_lock(&lock);
...
#[no_mangle]
unsafe extern "C" fn probe_read_refcount() -> c_int {
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn percpu_hash_refcount_leak(ctx: *mut c_void) -> c_int {
    ...
    SEC("syscall")
#[no_mangle]
pub unsafe extern "C" fn clear_percpu_hash_kptr(ctx: *mut c_void) -> c_int {
    ...
    if (!v)
    return 0;
    n = bpf_kptr_xchg(&v.node, core::ptr::null_mut());
    if (!n)
    return 0;
    bpf_obj_drop(n);
    return probe_read_refcount();
    ...
    SEC("tc")
#[no_mangle]
pub unsafe extern "C" fn check_percpu_hash_refcount(ctx: *mut c_void) -> c_int {
