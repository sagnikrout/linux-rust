...
//! Source: tools/testing/selftests/bpf/progs/nested_trust_failure.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __msg(be": "R2 must) -> __failure {
    __failure __msg("R2 must be")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_invalid_nested_user_cpus, task: *mut task_struct, clone_flags: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(expected=ptr_: "R2 type=untrusted_ptr_, _arg: trusted_ptr_, _arg: rcu_ptr_") -> __failure {
    __failure __msg("R2 type=untrusted_ptr_ expected=ptr_, trusted_ptr_, rcu_ptr_")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_invalid_skb_field, sk: *mut sock, skb: *mut sk_buff) -> c_int {
