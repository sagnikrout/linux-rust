...
//! Source: tools/testing/selftests/bpf/progs/cpumask_success.c
#![no_std]
...
pub struct kptr_nested_pair {
    pub mask_1: *mut *mut bpf_cpumask __kptr,
    pub mask_2: *mut *mut bpf_cpumask __kptr,
}
...
pub struct kptr_nested_deep_array_1_2 {
    pub dummy: c_int,
    pub mask: [*mut *mut bpf_cpumask __kptr; CPUMASK_KPTR_FIELDS_MAX],
}
...
#[no_mangle]
unsafe extern "C" fn is_test_task() -> bool {
    static bool is_test_task(void)
    {
    let mut cur_pid: c_int = bpf_get_current_pid_tgid() >> 32;
    let mut pid: return = = cur_pid;
    }
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_alloc_free_cpumask, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_set_clear_cpu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_setall_clear_cpu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_first_firstzero_cpu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_firstand_nocpu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_test_and_set_clear, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_and_or_xor, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_intersects_subset, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_copy_any_anyand, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_insert_leave, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_insert_remove_release, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_global_mask_rcu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_global_mask_array_one_rcu, task: *mut task_struct, clone_flags: u64) -> c_int {
...
// [<mask 0>, <mask 1>]
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_global_mask_array_rcu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_global_mask_array_l2_rcu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_global_mask_nested_rcu, task: *mut task_struct, clone_flags: u64) -> c_int {
...
//
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_global_mask_nested_deep_rcu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_global_mask_nested_deep_array_rcu, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    _global_mask_array_rcu(&global_mask_nested_deep_array_1.d_1.d_2.mask[i], core::ptr::null_mut());
    for (i = 0; i < CPUMASK_KPTR_FIELDS_MAX; i++)
    _global_mask_array_rcu(&global_mask_nested_deep_array_2.d_1.d_2[i].mask, core::ptr::null_mut());
    for (i = 0; i < CPUMASK_KPTR_FIELDS_MAX; i++)
    _global_mask_array_rcu(&global_mask_nested_deep_array_3.d_1[i].d_2.mask, core::ptr::null_mut());
    return 0;
    }
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_cpumask_weight, task: *mut task_struct, clone_flags: u64) -> c_int {
...
//
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_refcount_null_tracking, task: *mut task_struct, clone_flags: u64) -> c_int {
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_populate_reject_small_mask, task: *mut task_struct, clone_flags: u64) -> c_int {
...
// Add an extra word for the test_populate_reject_unaligned test.
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_populate_reject_unaligned, task: *mut task_struct, clone_flags: u64) -> c_int {
...
// Misalign the source array by a byte.
    ...
    SEC("tp_btf/task_newtask")
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test_populate, task: *mut task_struct, clone_flags: u64) -> c_int {
