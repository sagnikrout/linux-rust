...
//! Source: tools/testing/selftests/bpf/progs/test_sysctl_loop2.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(ctx: *mut (noinline)) int is_tcp_mem(struct bpf_sysctl) -> static {
