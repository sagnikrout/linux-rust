...
//! Source: tools/testing/selftests/bpf/progs/verifier_linked_scalars.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn scalars() -> __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn sync_linked_regs_preserves_id() -> __naked void {
...
// Never executed */					\
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_neg() -> __naked void {
...
// Same test but using BPF_SUB instead of BPF_ADD with negative immediate
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_neg_sub() -> __naked void {
...
// alu32 with negative offset
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_neg_alu32_add() -> __naked void {
...
// alu32 with negative offset using SUB
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_neg_alu32_sub() -> __naked void {
...
// Positive offset: r1 = r0 + 4, then if r1 >= 6, r0 >= 2, so r0 != 0
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_pos() -> __naked void {
...
// SUB with negative immediate: r1 -= -4 is equivalent to r1 += 4
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_sub_neg_imm() -> __naked void {
...
// Double ADD clears the ID (can't accumulate offsets)
    ...
    __msg("div by zero")
#[no_mangle]
pub unsafe extern "C" fn scalars_double_add() -> __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_sync_delta_overflow() -> __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_sync_delta_overflow_large_range() -> __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_alu32_big_offset() -> __naked void {
    ...
    __msg("div by zero")
#[no_mangle]
pub unsafe extern "C" fn scalars_alu32_basic() -> __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_alu32_wrap() -> __naked void {
...
//
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn scalars_alu32_zext_linked_reg() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn scalars_alu32_alu64_cross_type() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn scalars_alu32_alu64_regsafe_pruning() -> __naked void {
...
pub unsafe extern "C" fn alu32_negative_offset() {
    ...
    let mut offset: volatile int = bpf_get_prandom_u32();
    let mut off: c_int = offset;
    if (off >= 5 && off < 10)
    path[off - 5] = '.';
...
pub unsafe extern "C" fn dummy_calls() {
    ...
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn spurious_precision_marks(ctx: *mut c_void) -> c_int {
...
//
    ...
    __msg("div by zero")
#[no_mangle]
pub unsafe extern "C" fn scalars_self_add_clears_id() -> __naked void {
...
// Same as above but with alu32 such that w6 += w6 also clears id.
    ...
    __msg("div by zero")
#[no_mangle]
pub unsafe extern "C" fn scalars_self_add_alu32_clears_id() -> __naked void {
...
//
    ...
    __msg("div by zero")
#[no_mangle]
pub unsafe extern "C" fn scalars_stale_delta_from_cleared_id() -> __naked void {
...
// Same as above but with alu32.
    ...
    __msg("div by zero")
#[no_mangle]
pub unsafe extern "C" fn scalars_stale_delta_from_cleared_id_alu32() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg(variable-offset": "invalid) -> __failure {
    __failure __msg("invalid variable-offset")
    __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn add_const_base_id_pruning() -> __naked void {
