...
//! Source: tools/testing/selftests/bpf/progs/fexit_test.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test2, a: c_int, b: __u64, ret: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test3, a: c_char, b: c_int, c: __u64, ret: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test4, a: *mut c_void, b: c_char, c: c_int, d: __u64, ret: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test5, a: __u64, b: *mut c_void, c: c_short, d: c_int, e: __u64, ret: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: test6, a: __u64, b: *mut c_void, c: c_short, d: c_int, e: *mut c_void, f: __u64, ret: c_int) -> c_int {
