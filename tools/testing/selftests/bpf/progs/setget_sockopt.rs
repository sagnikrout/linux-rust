...
//! Source: tools/testing/selftests/bpf/progs/setget_sockopt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sk_is_tcp(sk: *mut sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bpf_test_socket_sockopt(i: __u32, lc: *mut loop_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_test_ip_sockopt(i: __u32, lc: *mut loop_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_test_ipv6_sockopt(i: __u32, lc: *mut loop_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_test_tcp_sockopt(i: __u32, lc: *mut loop_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_test_sockopt(ctx: *mut c_void, sk: *mut sock) -> c_int {
    static int bpf_test_sockopt(void *ctx, struct sock *sk)
    {
    let mut lc: loop_ctx = { .ctx = ctx, .sk = sk, };
    __u16 family, proto;
    int n;
    family = sk.sk_family;
...
#[no_mangle]
unsafe extern "C" fn binddev_test(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_tcp_maxseg(ctx: *mut c_void, sk: *mut sock) -> c_int {
    static int test_tcp_maxseg(void *ctx, struct sock *sk)
    {
    let mut val: c_int = 1314, tmp;
...
#[no_mangle]
unsafe extern "C" fn test_tcp_saved_syn(ctx: *mut c_void, sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_v4mapped_v6_ip_tos(skops: *mut bpf_sock_ops) {
    static void test_v4mapped_v6_ip_tos(struct bpf_sock_ops *skops)
    {
    let mut tos: c_int = v4mapped_v6_ip_tos_val;
