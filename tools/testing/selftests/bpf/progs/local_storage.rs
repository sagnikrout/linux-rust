...
//! Source: tools/testing/selftests/bpf/progs/local_storage.c
#![no_std]
...
pub const DUMMY_STORAGE_VALUE: c_uint = 0xdeadbeef;
    let mut monitored_pid: __u32 = 0;
    let mut inode_storage_result: c_int = -1;
    let mut sk_storage_result: c_int = -1;
    let mut task_storage_result: c_int = -1;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: unlink_hook, dir: *mut inode, victim: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: exec, bprm: *mut linux_binprm) {
