...
//! Source: tools/testing/selftests/bpf/progs/verifier_cgroup_inv_retcode.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __msg([0: "smin=0 smax=4294967295 should have been in, _arg: 1]") -> __failure {
...
pub unsafe extern "C" fn with_invalid_return_code_test1() -> __naked void {
    ...
    __success
#[no_mangle]
pub unsafe extern "C" fn with_invalid_return_code_test2() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg([0: "smin=0 smax=3 should have been in, _arg: 1]") -> __failure {
    __failure __msg("smin=0 smax=3 should have been in [0, 1]")
#[no_mangle]
pub unsafe extern "C" fn with_invalid_return_code_test3() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg([0: "smin=2 smax=2 should have been in, _arg: 1]") -> __failure {
    __failure __msg("smin=2 smax=2 should have been in [0, 1]")
#[no_mangle]
pub unsafe extern "C" fn with_invalid_return_code_test5() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg((ctx)": "R0 is not a known value) -> __failure {
    __failure __msg("R0 is not a known value (ctx)")
#[no_mangle]
pub unsafe extern "C" fn with_invalid_return_code_test6() -> __naked void {
...
#[no_mangle]
pub unsafe extern "C" fn __msg([0: "R0 has unknown scalar value should have been in, _arg: 1]") -> __failure {
    __failure __msg("R0 has unknown scalar value should have been in [0, 1]")
#[no_mangle]
pub unsafe extern "C" fn with_invalid_return_code_test7() -> __naked void {
