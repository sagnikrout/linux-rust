...
//! Source: tools/testing/selftests/bpf/uprobe_multi.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(uprobe(void: (weak))) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bench() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(build_id_resident: (weak)) trigger_uprobe(bool) -> c_int {
    int __attribute__((weak)) trigger_uprobe(bool build_id_resident)
    {
    let mut page_sz: c_int = sysconf(_SC_PAGESIZE);
    void *addr;
    unsigned char vec[1];
