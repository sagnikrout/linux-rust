...
//! Source: tools/testing/selftests/bpf/prog_tests/usdt.c
#![no_std]
...
pub const _SDT_HAS_SEMAPHORES: c_int = 1;
    ...
    let mut idx: static volatile int = 2;
    let mut bla: static volatile __u64 = 0xFEDCBA9876543210ULL;
...
#[no_mangle]
unsafe extern "C" fn trigger_func(x: c_int) -> void __always_inline {
    let mut y: c_long = 42;
...
#[no_mangle]
unsafe extern "C" fn trigger_sib_spec() {
...
#[no_mangle]
unsafe extern "C" fn subtest_basic_usdt(optimized: bool) {
    ...
    int err, i, called;
    let mut expected_cookie: __u64 = 0xcafedeadbeeffeed;
...
#[no_mangle]
unsafe extern "C" fn subtest_optimized_attach() {
...
//
    ...
    0 /*self*/, "/proc/self/exe",
    "optimized_attach", "usdt_1", core::ptr::null_mut());
...
//
    skel.links.usdt_executed = bpf_program__attach_usdt(skel.progs.usdt_executed,
    0 /*self*/, "/proc/self/exe",
    "optimized_attach", "usdt_2", core::ptr::null_mut());
    if (!ASSERT_OK_PTR(skel.links.usdt_executed, "bpf_program__attach_usdt"))
    goto cleanup;
    usdt_2();
    usdt_2();
...
//
#[no_mangle]
unsafe extern "C" fn subtest_optimized_red_zone() {
    ...
    "optimized_attach", "usdt_red_zone", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn f100(x: c_int) -> void __always_inline {
    static void __always_inline f100(int x)
    {
    STAP_PROBE1(test, usdt_100, x);
    }
#[no_mangle]
pub unsafe extern "C" fn trigger_100_usdts() -> __weak void {
...
//
#[no_mangle]
unsafe extern "C" fn f300(x: c_int) -> void __always_inline {
    static void __always_inline f300(int x)
    {
    STAP_PROBE1(test, usdt_300, x);
    }
#[no_mangle]
pub unsafe extern "C" fn trigger_300_usdts() -> __weak void {
...
#[no_mangle]
unsafe extern "C" fn f400(__attribute__((unused)): int x) -> void __always_inline {
...
//
#[no_mangle]
pub unsafe extern "C" fn trigger_400_usdts() -> __weak void {
...
#[no_mangle]
unsafe extern "C" fn subtest_multispec_usdt() {
...
//
    ...
    "/proc/self/exe",
    "test", "usdt_100", core::ptr::null_mut());
...
// we'll reuse usdt_100 BPF program for usdt_300 test
    ...
    "test", "usdt_300", core::ptr::null_mut());
    err = -errno;
...
//
    skel.links.usdt_100 = bpf_program__attach_usdt(skel.progs.usdt_100, -1,
    "/proc/self/exe",
    "test", "usdt_400", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn subtest_urandom_usdt(auto_attach: bool) {
    ...
    "urand", "read_without_sema", core::ptr::null_mut());
    ...
    urand_pid, "./urandom_read",
    "urand", "read_with_sema", core::ptr::null_mut());
    ...
    "urandlib", "read_without_sema", core::ptr::null_mut());
    ...
    urand_pid, "./liburandom_read.so",
    "urandlib", "read_with_sema", core::ptr::null_mut());
