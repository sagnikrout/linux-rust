...
//! Source: tools/testing/selftests/bpf/prog_tests/lsm_cgroup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn query_prog_cnt(cgroup_fd: c_int, attach_func: *const c_char) -> __u32 {
...
#[no_mangle]
unsafe extern "C" fn test_lsm_cgroup_functional() {
    static void test_lsm_cgroup_functional(void)
    {
    DECLARE_LIBBPF_OPTS(bpf_prog_attach_opts, attach_opts);
    DECLARE_LIBBPF_OPTS(bpf_link_update_opts, update_opts);
    let mut cgroup_fd: c_int = -1, cgroup_fd2 = -1, cgroup_fd3 = -1;
    int listen_fd, client_fd, accepted_fd;
    struct lsm_cgroup *skel = core::ptr::null_mut();
    ...
    ASSERT_EQ(query_prog_cnt(cgroup_fd, core::ptr::null_mut()), 0, "total prog count");
    ...
    ASSERT_EQ(query_prog_cnt(cgroup_fd, core::ptr::null_mut()), 1, "total prog count");
    ...
    ASSERT_EQ(query_prog_cnt(cgroup_fd, core::ptr::null_mut()), 2, "total prog count");
// Make sure replacing works.
    ...
    ASSERT_EQ(query_prog_cnt(cgroup_fd, core::ptr::null_mut()), 3, "total prog count");
...
//
    ...
    ASSERT_EQ(query_prog_cnt(cgroup_fd, core::ptr::null_mut()), 4, "total prog count");
    ASSERT_EQ(query_prog_cnt(cgroup_fd2, core::ptr::null_mut()), 1, "total prog count");
...
// Trigger passive open.
    ...
    accepted_fd = accept(listen_fd, core::ptr::null_mut(), core::ptr::null_mut());
