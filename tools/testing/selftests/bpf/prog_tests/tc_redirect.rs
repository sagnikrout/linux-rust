...
//! Source: tools/testing/selftests/bpf/prog_tests/tc_redirect.c
#![no_std]
...
pub const IP4_PORT: c_int = 9004;

pub const IP6_PORT: c_int = 9006;

pub const IFADDR_STR_LEN: c_int = 18;

pub const TIMEOUT_MILLIS: c_int = 10000;

    fprintf(stderr, "(%s:%d: errno: %s) " MSG "\n", \
    __FILE__, __LINE__, strerror(errno), ##__VA_ARGS__)
    static const char * const namespaces[] = {NS_SRC, NS_FWD, NS_DST, core::ptr::null_mut()};
    static struct netns_obj *netns_objs[3];
#[no_mangle]
unsafe extern "C" fn write_file(path: *const c_char, newval: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netns_setup_namespaces(verb: *const c_char) -> c_int {
...
// ns_obj = netns_new(*ns, false);
    ...
    if (!ASSERT_OK_PTR(*ns_obj, "netns_obj is core::ptr::null_mut()"))
    return -1;
    netns_free(*ns_obj);
// ns_obj = NULL;
    }
...
#[no_mangle]
unsafe extern "C" fn netns_setup_namespaces_nofail(verb: *const c_char) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netns_setup_result {
    pub dev_mode: enum dev_mode,
    pub ifindex_src: c_int,
    pub ifindex_src_fwd: c_int,
    pub ifindex_dst: c_int,
    pub ifindex_dst_fwd: c_int,
}

#[no_mangle]
unsafe extern "C" fn get_ifaddr(name: *const c_char, ifaddr: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_netkit(mode: c_int, prim: *mut c_char, peer: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netns_setup_links_and_routes(result: *mut netns_setup_result) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qdisc_clsact_create(qdisc_hook: *mut bpf_tc_hook, ifindex: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_tcp(family: c_int, addr: *const c_char, port: __u16) {
    static void test_tcp(int family, const char *addr, __u16 port)
    {
    let mut listen_fd: c_int = -1, accept_fd = -1, client_fd = -1;
...
#[no_mangle]
unsafe extern "C" fn test_ping(family: c_int, addr: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_connectivity() {
...
#[no_mangle]
unsafe extern "C" fn set_forwarding(enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __rcv_tstamp(fd: c_int, expected: *const c_char, s: usize, tstamp: *mut __u64) -> c_int {
    static int __rcv_tstamp(int fd, const char *expected, size_t s, __u64 *tstamp)
    {
    let mut pkt_ts: timespec = {};
...
#[no_mangle]
unsafe extern "C" fn rcv_tstamp(fd: c_int, expected: *const c_char, s: usize) {
    static void rcv_tstamp(int fd, const char *expected, size_t s)
    {
    __rcv_tstamp(fd, expected, s, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn wait_netstamp_needed_key() -> c_int {
    static int wait_netstamp_needed_key(void)
    {
    let mut opt: c_int = 1, srv_fd = -1, cli_fd = -1, nretries = 0, err, n;
    char buf[] = "testing testing";
    struct nstoken *nstoken;
...
#[no_mangle]
unsafe extern "C" fn snd_tstamp(fd: c_int, b: *mut c_char, s: usize) {
    static void snd_tstamp(int fd, char *b, size_t s)
    {
    let mut opt: sock_txtime = { .clockid = CLOCK_TAI };
...
#[no_mangle]
unsafe extern "C" fn test_inet_dtime(family: c_int, type: c_int, addr: *const c_char, port: __u16) {
    static void test_inet_dtime(int family, int type, const char *addr, __u16 port)
    {
    let mut opt: c_int = 1, accept_fd = -1, client_fd = -1, listen_fd, err;
    char buf[] = "testing testing";
    struct nstoken *nstoken;
    nstoken = open_netns(NS_DST);
    if (!ASSERT_OK_PTR(nstoken, "setns dst"))
...
#[no_mangle]
unsafe extern "C" fn test_tcp_clear_dtime(skel: *mut test_tc_dtime) {
...
#[no_mangle]
unsafe extern "C" fn test_tcp_dtime(skel: *mut test_tc_dtime, family: c_int, bpf_fwd: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_udp_dtime(skel: *mut test_tc_dtime, family: c_int, bpf_fwd: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_redirect_dtime(setup_result: *mut netns_setup_result) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_redirect_neigh_fib(setup_result: *mut netns_setup_result) {
    static void test_tc_redirect_neigh_fib(struct netns_setup_result *setup_result)
    {
    struct nstoken *nstoken = core::ptr::null_mut();
    struct test_tc_neigh_fib *skel = core::ptr::null_mut();
    nstoken = open_netns(NS_FWD);
    if (!ASSERT_OK_PTR(nstoken, "setns fwd"))
    return;
...
#[no_mangle]
unsafe extern "C" fn test_tc_redirect_neigh(setup_result: *mut netns_setup_result) {
    static void test_tc_redirect_neigh(struct netns_setup_result *setup_result)
    {
    struct nstoken *nstoken = core::ptr::null_mut();
    struct test_tc_neigh *skel = core::ptr::null_mut();
    int err;
    nstoken = open_netns(NS_FWD);
    if (!ASSERT_OK_PTR(nstoken, "setns fwd"))
    return;
...
#[no_mangle]
unsafe extern "C" fn test_tc_redirect_peer(setup_result: *mut netns_setup_result) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_redirect_peer_ing(setup_result: *mut netns_setup_result) {
...
#[no_mangle]
unsafe extern "C" fn tun_open(name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_relay_loop(src_fd: c_int, target_fd: c_int) -> c_int {
    ...
    if (select(1 + MAX(src_fd, target_fd), &rfds, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut()) < 0) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_redirect_peer_l3(setup_result: *mut netns_setup_result) {
    static void test_tc_redirect_peer_l3(struct netns_setup_result *setup_result)
    {
    LIBBPF_OPTS(bpf_tc_hook, qdisc_tun_fwd);
    LIBBPF_OPTS(bpf_tc_hook, qdisc_dst_fwd);
    struct test_tc_peer *skel = core::ptr::null_mut();
    struct nstoken *nstoken = core::ptr::null_mut();
    int err;
    let mut tunnel_pid: c_int = -1;
...
// Setup route and neigh tables
    ...
    waitpid(tunnel_pid, core::ptr::null_mut(), 0);
    }
    if (src_fd >= 0)
    close(src_fd);
    if (target_fd >= 0)
...
//
    err = pthread_create(&test_thread, core::ptr::null_mut(), &test_tc_redirect_run_tests, core::ptr::null_mut());
