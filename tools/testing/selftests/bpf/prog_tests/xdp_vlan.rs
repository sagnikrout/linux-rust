...
//! Source: tools/testing/selftests/bpf/prog_tests/xdp_vlan.c
#![no_std]
...
pub const NS_MAX_SIZE: c_int = 32;

pub const VLAN_ID: c_int = 4011;
#[no_mangle]
unsafe extern "C" fn setup_network(ns1: *mut c_char, ns2: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_network(ns1: *const c_char, ns2: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn xdp_vlan(xdp: *mut bpf_program, tc: *mut bpf_program, flags: u32) {
    ...
    goto cleanup;
    ret = bpf_xdp_attach(interface, bpf_program__fd(xdp), flags, core::ptr::null_mut());
...
// Now the namespaces can reach each-other, test with pings
    ...
    detach_xdp:
    bpf_xdp_detach(interface, flags, core::ptr::null_mut());
    cleanup:
    close_netns(nstoken);
