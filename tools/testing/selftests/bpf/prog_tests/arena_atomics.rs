...
//! Source: tools/testing/selftests/bpf/prog_tests/arena_atomics.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_add(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_sub(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_and(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_or(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_xor(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_cmpxchg(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_xchg(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_uaf(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_load_acquire(skel: *mut arena_atomics) {
...
#[no_mangle]
unsafe extern "C" fn test_store_release(skel: *mut arena_atomics) {
