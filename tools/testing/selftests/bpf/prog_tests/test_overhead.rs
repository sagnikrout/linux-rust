...
//! Source: tools/testing/selftests/bpf/prog_tests/test_overhead.c
#![no_std]
...
pub const MAX_CNT: c_int = 100000;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn test_task_rename(prog: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_run(prog: *const c_char) {
    static void test_run(const char *prog)
    {
    test_task_rename(prog);
    }
#[no_mangle]
unsafe extern "C" fn setaffinity() {
...
pub unsafe extern "C" fn test_test_overhead() {
    ...
    return;
    obj = bpf_object__open_file("./test_overhead.bpf.o", core::ptr::null_mut());
