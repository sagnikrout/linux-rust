...
//! Source: tools/testing/selftests/bpf/prog_tests/atomics.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_add(skel: *mut atomics_lskel) {
...
#[no_mangle]
unsafe extern "C" fn test_sub(skel: *mut atomics_lskel) {
...
#[no_mangle]
unsafe extern "C" fn test_and(skel: *mut atomics_lskel) {
...
#[no_mangle]
unsafe extern "C" fn test_or(skel: *mut atomics_lskel) {
...
#[no_mangle]
unsafe extern "C" fn test_xor(skel: *mut atomics_lskel) {
...
#[no_mangle]
unsafe extern "C" fn test_cmpxchg(skel: *mut atomics_lskel) {
...
#[no_mangle]
unsafe extern "C" fn test_xchg(skel: *mut atomics_lskel) {
