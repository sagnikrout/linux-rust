...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_distill.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn test_distilled_base() {
    static void test_distilled_base(void)
    {
    struct btf *btf1 = core::ptr::null_mut(), *btf2 = core::ptr::null_mut(), *btf3 = core::ptr::null_mut(), *btf4 = core::ptr::null_mut();
    btf1 = btf__new_empty();
...
//
#[no_mangle]
unsafe extern "C" fn test_distilled_base_multi() {
...
//
#[no_mangle]
unsafe extern "C" fn test_distilled_base_missing_err() {
    static void test_distilled_base_missing_err(void)
    {
    struct btf *btf1 = core::ptr::null_mut(), *btf2 = core::ptr::null_mut(), *btf3 = core::ptr::null_mut(), *btf4 = core::ptr::null_mut(), *btf5 = core::ptr::null_mut();
    btf1 = btf__new_empty();
    if (!ASSERT_OK_PTR(btf1, "empty_main_btf"))
    return;
    btf__add_int(btf1, "int", 4, BTF_INT_SIGNED);   /* [1] int */
...
//
#[no_mangle]
unsafe extern "C" fn test_distilled_base_multi_err() {
...
//
#[no_mangle]
unsafe extern "C" fn test_distilled_base_multi_err2() {
...
//
#[no_mangle]
unsafe extern "C" fn test_distilled_base_vmlinux() {
    static void test_distilled_base_vmlinux(void)
    {
    struct btf *split_btf = core::ptr::null_mut(), *vmlinux_btf = btf__load_vmlinux_btf();
    struct btf *split_dist = core::ptr::null_mut(), *base_dist = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_distilled_endianness() {
    static void test_distilled_endianness(void)
    {
    struct btf *base = core::ptr::null_mut(), *split = core::ptr::null_mut(), *new_base = core::ptr::null_mut(), *new_split = core::ptr::null_mut();
    struct btf *new_base1 = core::ptr::null_mut(), *new_split1 = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn test_distilled_base_embedded_err() {
