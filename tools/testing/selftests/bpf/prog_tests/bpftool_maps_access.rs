...
//! Source: tools/testing/selftests/bpf/prog_tests/bpftool_maps_access.c
#![no_std]
...
pub const MAP_NAME_MAX_LEN: c_int = 64;
pub const PATH_MAX_LEN: c_int = 128;
    enum map_protection {
    PROTECTED,
    UNPROTECTED
    };
...
pub struct test_desc {
    pub name: *mut c_char,
    pub protection: enum map_protection,
    pub map: *mut bpf_map,
    pub map_name: *mut c_char,
    pub pinned: bool,
    pub pin_path: [c_char; PATH_MAX_LEN],
    pub write_must_fail: bool,
}
...
#[no_mangle]
unsafe extern "C" fn general_cleanup(skel: *mut security_bpf_map) {
...
#[no_mangle]
unsafe extern "C" fn test_setup(skel: *mut security_bpf_map, desc: *mut test_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_cleanup(desc: *mut test_desc) {
    static void test_cleanup(struct test_desc *desc)
    {
    if (desc.pinned)
    bpf_map__unpin(desc.map, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn lookup_map_value(map_handle: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_map_btf_data(map_handle: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_map_value(map_handle: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_map_value(map_handle: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iterate_on_map_values(map_handle: *mut c_char, iter_pin_path: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_inner_map() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_outer_map() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_pinned_map(map_name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn add_outer_map_entry(key: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_basic_access(desc: *mut test_desc) {
...
#[no_mangle]
unsafe extern "C" fn test_create_nested_maps() {
...
#[no_mangle]
unsafe extern "C" fn test_btf_list() {
    ...
    let mut tests_count: static size_t = ARRAY_SIZE(tests);
#[no_mangle]
