...
//! Source: tools/testing/selftests/bpf/prog_tests/bpf_insn_array.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn map_create(map_type: __u32, max_entries: __u32) -> c_int {
    static int map_create(__u32 map_type, __u32 max_entries)
    {
    const char *map_name = "insn_array";
    let mut key_size: __u32 = 4;
    let mut value_size: __u32 = sizeof(struct bpf_insn_array_value);
    return bpf_map_create(map_type, map_name, key_size, value_size, max_entries, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn prog_load(insns: *mut bpf_insn, insn_cnt: __u32, fd_array: *mut c_int, fd_array_cnt: __u32) -> c_int {
    static int prog_load(struct bpf_insn *insns, __u32 insn_cnt, int *fd_array, __u32 fd_array_cnt)
    {
    LIBBPF_OPTS(bpf_prog_load_opts, opts);
    opts.fd_array = fd_array;
    opts.fd_array_cnt = fd_array_cnt;
    return bpf_prog_load(BPF_PROG_TYPE_XDP, core::ptr::null_mut(), "GPL", insns, insn_cnt, &opts);
    }
#[no_mangle]
unsafe extern "C" fn __check_success(insns: *mut bpf_insn, insn_cnt: __u32, map_in: *mut __u32, map_out: *mut __u32) {
    ...
    let mut prog_fd: c_int = -1, map_fd, i;
...
//
#[no_mangle]
unsafe extern "C" fn check_one_to_one_mapping() {
...
//
#[no_mangle]
unsafe extern "C" fn check_simple() {
...
//
#[no_mangle]
unsafe extern "C" fn check_deletions() {
...
//
#[no_mangle]
unsafe extern "C" fn check_deletions_with_functions() {
...
//
#[no_mangle]
unsafe extern "C" fn check_out_of_bounds_index() {
...
//
#[no_mangle]
unsafe extern "C" fn check_mid_insn_index() {
...
#[no_mangle]
unsafe extern "C" fn check_incorrect_index() {
...
#[no_mangle]
unsafe extern "C" fn set_bpf_jit_harden(level: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_blindness() {
    ...
    let mut prog_fd: c_int = -1, map_fd;
    let mut val: bpf_insn_array_value = {};
...
#[no_mangle]
unsafe extern "C" fn check_load_unfrozen_map() {
...
#[no_mangle]
unsafe extern "C" fn check_no_map_reuse() {
    ...
    let mut prog_fd: c_int = -1, map_fd, extra_fd = -1;
    let mut val: bpf_insn_array_value = {};
    int i;
    map_fd = map_create(BPF_MAP_TYPE_INSN_ARRAY, ARRAY_SIZE(insns));
    if (!ASSERT_GE(map_fd, 0, "map_create"))
...
// correctness: check that prog is still loadable without fd_array
    extra_fd = prog_load(insns, ARRAY_SIZE(insns), core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn check_bpf_no_lookup() {
    ...
    if (!ASSERT_EQ(bpf_map_freeze(map_fd), 0, "bpf_map_freeze"))
    goto cleanup;
    prog_fd = prog_load(insns, ARRAY_SIZE(insns), core::ptr::null_mut(), 0);
    if (!ASSERT_EQ(prog_fd, -EINVAL, "program should have been rejected (prog_fd != -EINVAL)"))
    goto cleanup;
...
#[no_mangle]
unsafe extern "C" fn check_bpf_side() {
    static void check_bpf_side(void)
    {
    check_bpf_no_lookup();
    }
#[no_mangle]
unsafe extern "C" fn __test_bpf_insn_array() {
...
#[no_mangle]
pub unsafe extern "C" fn test_bpf_insn_array() {
