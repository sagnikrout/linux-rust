...
//! Source: tools/testing/selftests/bpf/prog_tests/bpf_qdisc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn do_test(qdisc: *mut c_char) {
    ...
    .handle = 0x8000000,
    .qdisc = qdisc);
    let mut srv_fd: c_int = -1, cli_fd = -1;
    int err;
    err = bpf_tc_hook_create(&hook);
    if (!ASSERT_OK(err, "attach qdisc"))
    return;
    srv_fd = start_server(AF_INET6, SOCK_STREAM, core::ptr::null_mut(), 0, 0);
...
#[no_mangle]
unsafe extern "C" fn test_qdisc_attach_to_mq() {
...
#[no_mangle]
unsafe extern "C" fn test_qdisc_attach_to_non_root() {
...
#[no_mangle]
unsafe extern "C" fn test_incompl_ops() {
...
#[no_mangle]
unsafe extern "C" fn get_default_qdisc(qdisc_name: *mut c_char) -> c_int {
    ...
    fclose(f);
    let mut num: return = = 1 ? 0 : -EFAULT;
    }
#[no_mangle]
unsafe extern "C" fn test_default_qdisc_attach_to_mq() {
