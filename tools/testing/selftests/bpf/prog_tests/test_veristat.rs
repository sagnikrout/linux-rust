...
//! Source: tools/testing/selftests/bpf/prog_tests/test_veristat.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct fixture {
    pub tmpfile: [c_char; 80],
    pub fd: c_int,
    pub output: *mut c_char,
    pub sz: usize,
    pub veristat: [c_char; 80],
}
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: access("../veristat", 0: F_OK) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn read_output(fix: *mut fixture) {
    static void read_output(struct fixture *fix)
    {
    let mut len: isize = pread(fix.fd, fix.output, fix.sz - 1, 0);
    fix.output[len < 0 ? 0 : len] = 0;
    ASSERT_GE(len, 0, "pread");
    }
#[no_mangle]
unsafe extern "C" fn teardown_fixture(fix: *mut fixture) {
...
#[no_mangle]
unsafe extern "C" fn test_set_global_vars_succeeds() {
...
#[no_mangle]
unsafe extern "C" fn test_set_global_vars_from_file_succeeds() {
...
#[no_mangle]
unsafe extern "C" fn test_set_global_vars_out_of_range() {
...
#[no_mangle]
unsafe extern "C" fn test_unsupported_ptr_array_type() {
...
#[no_mangle]
unsafe extern "C" fn test_array_out_of_bounds() {
...
#[no_mangle]
unsafe extern "C" fn test_array_index_not_found() {
...
#[no_mangle]
unsafe extern "C" fn test_array_index_for_non_array() {
...
#[no_mangle]
unsafe extern "C" fn test_no_array_index_for_array() {
...
#[no_mangle]
unsafe extern "C" fn test_name_filters() {
