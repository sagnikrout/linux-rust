...
//! Source: tools/testing/selftests/bpf/prog_tests/section_names.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sec_name_test {
    pub sec_name: [c_char; 32],
    struct {
    pub rc: c_int,
    pub prog_type: enum bpf_prog_type,
    pub expected_attach_type: enum bpf_attach_type,
    pub expected_load: },
    struct {
    pub rc: c_int,
...
#[no_mangle]
unsafe extern "C" fn test_prog_type_by_name(test: *const sec_name_test) {
...
#[no_mangle]
unsafe extern "C" fn test_attach_type_by_name(test: *const sec_name_test) {
