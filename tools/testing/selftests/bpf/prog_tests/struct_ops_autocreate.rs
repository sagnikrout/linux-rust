...
//! Source: tools/testing/selftests/bpf/prog_tests/struct_ops_autocreate.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cant_load_full_object() {
...
#[no_mangle]
unsafe extern "C" fn check_test_1_link(skel: *mut struct_ops_autocreate, map: *mut bpf_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_load_partial_object() {
...
#[no_mangle]
unsafe extern "C" fn optional_maps() {
...
//
#[no_mangle]
unsafe extern "C" fn autoload_and_shadow_vars() {
    static void autoload_and_shadow_vars(void)
    {
    struct struct_ops_autocreate2 *skel = core::ptr::null_mut();
