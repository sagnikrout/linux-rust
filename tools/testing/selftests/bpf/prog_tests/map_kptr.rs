...
//! Source: tools/testing/selftests/bpf/prog_tests/map_kptr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_map_kptr_success(test_run: bool) {
...
#[no_mangle]
unsafe extern "C" fn kern_sync_rcu_tasks_trace(rcu: *mut rcu_tasks_trace_gp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_for_map_release() {
...
#[no_mangle]
unsafe extern "C" fn test_map_update_kptr(test: enum map_update_kptr_case) {
