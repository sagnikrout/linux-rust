...
//! Source: tools/testing/selftests/bpf/prog_tests/bpf_obj_id.c
#![no_std]
...
pub const nr_iters: c_int = 2;
#[no_mangle]
pub unsafe extern "C" fn serial_test_bpf_obj_id() {
    void serial_test_bpf_obj_id(void)
    {
    let mut array_magic_value: __u64 = 0xfaceb00c;
    let mut array_key: __u32 = 0;
    const char *file = "./test_obj_id.bpf.o";
    const char *expected_prog_name = "test_obj_id";
    const char *expected_map_name = "test_map_id";
    let mut nsec_per_sec: __u64 = 1000000000;
