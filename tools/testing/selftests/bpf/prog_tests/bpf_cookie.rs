...
//! Source: tools/testing/selftests/bpf/prog_tests/bpf_cookie.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kprobe_subtest(skel: *mut test_bpf_cookie) {
    static void kprobe_subtest(struct test_bpf_cookie *skel)
    {
    DECLARE_LIBBPF_OPTS(bpf_kprobe_opts, opts);
    struct bpf_link *link1 = core::ptr::null_mut(), *link2 = core::ptr::null_mut();
    struct bpf_link *retlink1 = core::ptr::null_mut(), *retlink2 = core::ptr::null_mut();
// attach two kprobes
    opts.bpf_cookie = 0x1;
    opts.retprobe = false;
...
#[no_mangle]
unsafe extern "C" fn kprobe_multi_test_run(skel: *mut kprobe_multi) {
...
#[no_mangle]
unsafe extern "C" fn kprobe_multi_link_api_subtest() {
...
#[no_mangle]
unsafe extern "C" fn kprobe_multi_attach_api_subtest() {
...
#[no_mangle]
unsafe extern "C" fn uprobe_multi_test_run(skel: *mut uprobe_multi) {
...
#[no_mangle]
unsafe extern "C" fn uprobe_multi_attach_api_subtest() {
...
#[no_mangle]
unsafe extern "C" fn uprobe_subtest(skel: *mut test_bpf_cookie) {
...
#[no_mangle]
unsafe extern "C" fn tp_subtest(skel: *mut test_bpf_cookie) {
    static void tp_subtest(struct test_bpf_cookie *skel)
    {
    DECLARE_LIBBPF_OPTS(bpf_tracepoint_opts, opts);
    struct bpf_link *link1 = core::ptr::null_mut(), *link2 = core::ptr::null_mut(), *link3 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn burn_cpu(loops: c_long) {
...
#[no_mangle]
unsafe extern "C" fn pe_subtest(skel: *mut test_bpf_cookie) {
...
#[no_mangle]
unsafe extern "C" fn verify_tracing_link_info(fd: c_int, cookie: u64) -> c_int {
    static int verify_tracing_link_info(int fd, u64 cookie)
    {
    struct bpf_link_info info;
    int err;
    let mut len: u32 = sizeof(info);
...
#[no_mangle]
unsafe extern "C" fn tracing_subtest(skel: *mut test_bpf_cookie) {
    static void tracing_subtest(struct test_bpf_cookie *skel)
    {
    __u64 cookie;
    int prog_fd, err;
    let mut fentry_fd: c_int = -1, fexit_fd = -1, fmod_ret_fd = -1;
...
#[no_mangle]
unsafe extern "C" fn lsm_subtest(skel: *mut test_bpf_cookie) {
...
#[no_mangle]
unsafe extern "C" fn tp_btf_subtest(skel: *mut test_bpf_cookie) {
...
#[no_mangle]
unsafe extern "C" fn verify_raw_tp_link_info(fd: c_int, cookie: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_tp_subtest(skel: *mut test_bpf_cookie) {
