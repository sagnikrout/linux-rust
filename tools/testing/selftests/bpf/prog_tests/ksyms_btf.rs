...
//! Source: tools/testing/selftests/bpf/prog_tests/ksyms_btf.c
#![no_std]
...
unsafe extern "C" fn test_basic() {
    ...
    struct test_ksyms_btf *skel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_null_check() {
...
#[no_mangle]
unsafe extern "C" fn test_weak_syms() {
...
#[no_mangle]
unsafe extern "C" fn test_weak_syms_lskel() {
...
#[no_mangle]
unsafe extern "C" fn test_write_check(test_handler1: bool) {
