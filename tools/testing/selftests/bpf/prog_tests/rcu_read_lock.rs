...
//! Source: tools/testing/selftests/bpf/prog_tests/rcu_read_lock.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_success() {
...
#[no_mangle]
unsafe extern "C" fn test_rcuptr_acquire() {
...
#[no_mangle]
unsafe extern "C" fn test_inproper_region() {
...
#[no_mangle]
unsafe extern "C" fn test_rcuptr_misuse() {
