...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_permute.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn permute_base_check(btf: *mut btf) {
...
#[no_mangle]
unsafe extern "C" fn test_permute_base() {
...
// }
    ...
    permute_ids[5] = 6; /* [5] . [6] */
    permute_ids[6] = 2; /* [6] . [2] */
    err = btf__permute(btf, permute_ids, ARRAY_SIZE(permute_ids), core::ptr::null_mut());
...
// id_map_cnt is invalid
    ...
    permute_ids[5] = 6; /* [5] . [6] */
    permute_ids[6] = 2; /* [6] . [2] */
    err = btf__permute(btf, permute_ids, ARRAY_SIZE(permute_ids) - 1, core::ptr::null_mut());
    if (!ASSERT_ERR(err, "btf__permute_base"))
    goto done;
// BTF is not modified
    permute_base_check(btf);
...
#[no_mangle]
unsafe extern "C" fn permute_split_check(btf: *mut btf) {
...
#[no_mangle]
unsafe extern "C" fn test_permute_split() {
    static void test_permute_split(void)
    {
    struct btf *split_btf = core::ptr::null_mut(), *base_btf = core::ptr::null_mut();
    __u32 permute_ids[4];
    int err, start_id;
...
// }
    ...
    err = btf__permute(split_btf, permute_ids, ARRAY_SIZE(permute_ids), core::ptr::null_mut());
...
//
    ...
    err = btf__permute(split_btf, permute_ids, ARRAY_SIZE(permute_ids) - 1, core::ptr::null_mut());
