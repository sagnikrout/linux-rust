...
//! Source: tools/testing/selftests/bpf/prog_tests/select_reuseport.c
#![no_std]
...
pub const MIN_TCPHDR_LEN: c_int = 20;
pub const UDPHDR_LEN: c_int = 8;

pub const REUSEPORT_ARRAY_SIZE: c_int = 32;
    static int result_map, tmp_index_ovr_map, linum_map, data_check_map;
    static __u32 expected_results[NR_RESULTS];
    static int sk_fds[REUSEPORT_ARRAY_SIZE];
    let mut reuseport_array: static int = -1, outer_map = -1;
...
#[no_mangle]
unsafe extern "C" fn create_maps(inner_type: enum bpf_map_type) -> c_int {
...
// Creating reuseport_array
    ...
    sizeof(__u32), sizeof(__u32), REUSEPORT_ARRAY_SIZE, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn prepare_bpf_obj() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ss_init_loopback(sa: *mut sockaddr_storage, family: sa_family_t) {
...
#[no_mangle]
unsafe extern "C" fn ss_init_inany(sa: *mut sockaddr_storage, family: sa_family_t) {
...
#[no_mangle]
unsafe extern "C" fn read_int_sysctl(sysctl: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_int_sysctl(sysctl: *const c_char, v: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_fastopen() -> c_int {
...
unsafe extern "C" fn get_linum() -> c_long {
    ...
    int cli_fd)
    {
    let mut expected: data_check = {}, result;
...
unsafe extern "C" fn check_results() {
    ...
    if (type == SOCK_STREAM) {
    let mut new_fd: c_int = accept(srv_fd, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn test_err_inner_map(type: c_int, family: sa_family_t) {
...
#[no_mangle]
unsafe extern "C" fn test_err_skb_data(type: c_int, family: sa_family_t) {
    static void test_err_skb_data(int type, sa_family_t family)
    {
    expected_results[DROP_ERR_SKB_DATA]++;
    do_test(type, family, core::ptr::null_mut(), DROP_ERR_SKB_DATA);
    }
#[no_mangle]
unsafe extern "C" fn test_err_sk_select_port(type: c_int, family: sa_family_t) {
...
#[no_mangle]
unsafe extern "C" fn test_pass(type: c_int, family: sa_family_t) {
...
#[no_mangle]
unsafe extern "C" fn test_syncookie(type: c_int, family: sa_family_t) {
...
#[no_mangle]
unsafe extern "C" fn test_pass_on_err(type: c_int, family: sa_family_t) {
...
#[no_mangle]
unsafe extern "C" fn test_detach_bpf(type: c_int, family: sa_family_t) {
    static void test_detach_bpf(int type, sa_family_t family)
    {

    let mut nr_run_before: __u32 = 0, nr_run_after = 0, tmp, i;
    struct epoll_event ev;
    int cli_fd, err, nev;
    let mut cmd: cmd = {};
    let mut optvalue: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn prepare_sk_fds(type: c_int, family: sa_family_t, inany: bool) {
    static void prepare_sk_fds(int type, sa_family_t family, bool inany)
    {
    let mut first: c_int = REUSEPORT_ARRAY_SIZE - 1;
    int i, err, optval = 1;
    struct epoll_event ev;
    socklen_t addrlen;
    if (inany)
...
//
    ...
    "sk_fds[%d] err:%d errno:%d\n", i, err, errno);
    if (i == first) {
    let mut addrlen: socklen_t = sizeof(srv_sa);
...
#[no_mangle]
unsafe extern "C" fn cleanup_per_test(no_inner_map: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_config(sotype: c_int, family: sa_family_t, inany: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn test_map_type(mt: enum bpf_map_type) {
