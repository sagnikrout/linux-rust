...
//! Source: tools/testing/selftests/bpf/prog_tests/exceptions.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_exceptions_failure() {
    static void test_exceptions_failure(void)
    {
    RUN_TESTS(exceptions_fail);
    }
#[no_mangle]
unsafe extern "C" fn test_exceptions_success() {
    ...
    struct exceptions_ext *eskel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_exceptions_assertions() {
