...
//! Source: tools/testing/selftests/bpf/prog_tests/cgroup1_hierarchy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bpf_cgroup1(skel: *mut test_cgroup1_hierarchy) {
...
#[no_mangle]
unsafe extern "C" fn bpf_cgroup1_sleepable(skel: *mut test_cgroup1_hierarchy) {
...
#[no_mangle]
unsafe extern "C" fn bpf_cgroup1_invalid_id(skel: *mut test_cgroup1_hierarchy) {
