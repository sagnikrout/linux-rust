...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_tag.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_btf_decl_tag() {
...
#[no_mangle]
unsafe extern "C" fn test_btf_type_tag() {
...
#[no_mangle]
unsafe extern "C" fn test_btf_type_tag_mod_user(load_test_user1: bool) {
    static void test_btf_type_tag_mod_user(bool load_test_user1)
    {
    struct btf *vmlinux_btf = core::ptr::null_mut(), *module_btf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_btf_type_tag_vmlinux_user() {
    static void test_btf_type_tag_vmlinux_user(void)
    {
    struct btf_type_tag_user *skel;
    struct btf *vmlinux_btf = core::ptr::null_mut();
    int err;
    if (load_btfs(&vmlinux_btf, core::ptr::null_mut(), /*needs_vmlinux_tag=*/true))
    return;
    skel = btf_type_tag_user__open();
    if (!ASSERT_OK_PTR(skel, "btf_type_tag_user"))
    goto cleanup;
...
#[no_mangle]
unsafe extern "C" fn test_btf_type_tag_mod_percpu(load_test_percpu1: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_btf_type_tag_vmlinux_percpu(load_test: bool) {
