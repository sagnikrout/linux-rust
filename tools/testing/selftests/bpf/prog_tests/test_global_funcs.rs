...
//! Source: tools/testing/selftests/bpf/prog_tests/test_global_funcs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_ctx_arg_type(btf: *const btf, p: *const btf_param) {
...
#[no_mangle]
unsafe extern "C" fn subtest_ctx_arg_rewrite() {
    static void subtest_ctx_arg_rewrite(void)
    {
    struct test_global_func_ctx_args *skel = core::ptr::null_mut();
    ...
    int err, fd, i;
    struct btf *kern_btf = core::ptr::null_mut();
