...
//! Source: tools/testing/selftests/bpf/prog_tests/send_signal.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sigusr1_siginfo_handler(s: c_int, i: *mut siginfo_t, v: *mut c_void) {
...
// install signal handler and notify parent
    ...
    ASSERT_NEQ(sigaction(SIGUSR1, &sa, core::ptr::null_mut()), -1, "sigaction");
    } else {
...
#[no_mangle]
unsafe extern "C" fn test_send_signal_tracepoint(signal_thread: bool, remote: bool) {
    static void test_send_signal_tracepoint(bool signal_thread, bool remote)
    {
    test_send_signal_common(core::ptr::null_mut(), signal_thread, remote);
    }
#[no_mangle]
unsafe extern "C" fn test_send_signal_perf(signal_thread: bool, remote: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_send_signal_nmi(signal_thread: bool, remote: bool) {
