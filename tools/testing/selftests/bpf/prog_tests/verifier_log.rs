...
//! Source: tools/testing/selftests/bpf/prog_tests/verifier_log.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_prog_load(prog_fd: c_int, expect_err: bool, tag: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn load_prog(opts: *mut bpf_prog_load_opts, expect_load_error: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verif_log_subtest(name: *const c_char, expect_load_error: bool, log_level: c_int) {
...
// (FIXED, NULL) get actual log size
    opts.log_buf = core::ptr::null_mut();
    opts.log_level = log_level | 8; /* BPF_LOG_FIXED */
    opts.log_size = 0;
    opts.log_true_size = 0;
    res = load_prog(&opts, expect_load_error);
...
#[no_mangle]
unsafe extern "C" fn load_btf(opts: *mut bpf_btf_load_opts, expect_err: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verif_btf_log_subtest(bad_btf: bool) {
