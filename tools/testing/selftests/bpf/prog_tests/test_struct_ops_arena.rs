...
//! Source: tools/testing/selftests/bpf/prog_tests/test_struct_ops_arena.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn arena_arg_fail() {
...
#[no_mangle]
unsafe extern "C" fn arena_arg_attach_one(target_fd: c_int, prog_name: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn arena_arg_attach() {
