...
//! Source: tools/testing/selftests/bpf/prog_tests/fill_link_info.c
#![no_std]
...
// uprobe attach point
#[no_mangle]
unsafe extern "C" fn uprobe_func() -> noinline void {
    static noinline void uprobe_func(void)
    {
    asm volatile ("");
    }
pub const PERF_EVENT_COOKIE: c_uint = 0xdeadbeef;
    static int verify_perf_link_info(int fd, enum bpf_perf_event_type type, long addr,
    ssize_t offset, ssize_t entry_offset)
    {
    let mut ref_ctr_offset: isize = entry_offset /* ref_ctr_offset for uprobes */;
...
#[no_mangle]
unsafe extern "C" fn kprobe_fill_invalid_user_buffer(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tp_fill_link_info(skel: *mut test_fill_link_info) {
...
#[no_mangle]
unsafe extern "C" fn test_event_fill_link_info(skel: *mut test_fill_link_info) {
...
#[no_mangle]
unsafe extern "C" fn verify_kmulti_link_info(fd: c_int, retprobe: bool, has_cookies: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verify_kmulti_invalid_user_buffer(fd: c_int) {
...
// cookies && !count
    info.kprobe_multi.count = 0;
    info.kprobe_multi.addrs = ptr_to_u64(core::ptr::null_mut());
    info.kprobe_multi.cookies = ptr_to_u64(cookies);
    err = bpf_link_get_info_by_fd(fd, &info, &len);
...
unsafe extern "C" fn symbols_cmp_r(a: *const c_void, b: *const c_void) -> c_int {
    ...
    opts.cookies = cookies ? kmulti_cookies : core::ptr::null_mut();
    opts.cnt = KMULTI_CNT;
    opts.retprobe = retprobe;
    link = bpf_program__attach_kprobe_multi_opts(skel.progs.kmulti_run, core::ptr::null_mut(), &opts);
...
unsafe extern "C" fn tmulti_target_cmp(a: *const c_void, b: *const c_void) -> c_int {
    ...
    let mut len: __u32 = sizeof(prog_info);
    struct btf *btf;
    int err, i;
    __s32 id;
...
//
    ...
    {
    let mut attach_type: enum bpf_attach_type = bpf_program__expected_attach_type(prog);
...
#[no_mangle]
unsafe extern "C" fn verify_tracing_multi_invalid_user_buffer(fd: c_int, targets: *const tmulti_target) {
...
// Invalid addrs pointer -> EFAULT
    ...
    link = bpf_program__attach_tracing_multi(skel.progs.tmulti_run, core::ptr::null_mut(), &opts);
...
#[no_mangle]
pub unsafe extern "C" fn uprobe_link_info_func_1() -> noinline void {
...
#[no_mangle]
pub unsafe extern "C" fn uprobe_link_info_func_2() -> noinline void {
...
#[no_mangle]
pub unsafe extern "C" fn uprobe_link_info_func_3() -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn verify_umulti_invalid_user_buffer(fd: c_int) {
...
// offsets has wrong pointer
    ...
    __u64 *offsets = core::ptr::null_mut(), *ref_ctr_offsets;
    struct bpf_link *link;
    int link_fd, err;
