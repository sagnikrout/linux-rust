...
//! Source: tools/testing/selftests/bpf/prog_tests/cg_storage_multi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn assert_storage_noexist(map: *mut bpf_map, key: *const c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn connect_send(cgroup_path: *const c_char) -> bool {
    static bool connect_send(const char *cgroup_path)
    {
    let mut server_fd: c_int = -1, client_fd = -1;
...
#[no_mangle]
unsafe extern "C" fn test_egress_only(parent_cgroup_fd: c_int, child_cgroup_fd: c_int) {
    ...
    struct bpf_link *parent_link = core::ptr::null_mut(), *child_link = core::ptr::null_mut();
    bool err;
...
#[no_mangle]
unsafe extern "C" fn test_isolated(parent_cgroup_fd: c_int, child_cgroup_fd: c_int) {
    static void test_isolated(int parent_cgroup_fd, int child_cgroup_fd)
    {
    struct cg_storage_multi_isolated *obj;
    struct cgroup_value expected_cgroup_value;
    struct bpf_cgroup_storage_key key;
    struct bpf_link *parent_egress1_link = core::ptr::null_mut(), *parent_egress2_link = core::ptr::null_mut();
    struct bpf_link *child_egress1_link = core::ptr::null_mut(), *child_egress2_link = core::ptr::null_mut();
    struct bpf_link *parent_ingress_link = core::ptr::null_mut(), *child_ingress_link = core::ptr::null_mut();
    bool err;
...
#[no_mangle]
unsafe extern "C" fn test_shared(parent_cgroup_fd: c_int, child_cgroup_fd: c_int) {
...
pub unsafe extern "C" fn serial_test_cg_storage_multi() {
    ...
    {
    let mut parent_cgroup_fd: c_int = -1, child_cgroup_fd = -1;
