...
//! Source: tools/testing/selftests/bpf/prog_tests/sock_fields.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn create_netns() -> bool {
...
#[no_mangle]
unsafe extern "C" fn print_sk(sk: *const bpf_sock, prefix: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn print_tp(tp: *const bpf_tcp_sock, prefix: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn check_sk_pkt_out_cnt(accept_fd: c_int, cli_fd: c_int) {
    static void check_sk_pkt_out_cnt(int accept_fd, int cli_fd)
    {
    let mut pkt_out_cnt: bpf_spinlock_cnt = {}, pkt_out_cnt10 = {};
    int err;
    pkt_out_cnt.cnt = ~0;
    pkt_out_cnt10.cnt = ~0;
...
#[no_mangle]
unsafe extern "C" fn init_sk_storage(sk_fd: c_int, pkt_out_cnt: __u32) -> c_int {
    static int init_sk_storage(int sk_fd, __u32 pkt_out_cnt)
    {
    let mut scnt: bpf_spinlock_cnt = {};
    int err;
...
unsafe extern "C" fn test() {
    ...
    {
    let mut listen_fd: c_int = -1, cli_fd = -1, accept_fd = -1, err, i;
    let mut addrlen: socklen_t = sizeof(struct sockaddr_in6);
    char buf[DATA_LEN];
// Prepare listen_fd
...
pub unsafe extern "C" fn serial_test_sock_fields() {
    ...
    {
    let mut parent_cg_fd: c_int = -1, child_cg_fd = -1;
