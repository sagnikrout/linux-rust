...
//! Source: tools/testing/selftests/bpf/prog_tests/map_kptr_race.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_map_id(map_fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_refs(skel: *mut map_kptr_race) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_htab_leak() {
...
#[no_mangle]
unsafe extern "C" fn test_percpu_htab_leak() {
...
#[no_mangle]
unsafe extern "C" fn test_sk_ls_leak() {
    static void test_sk_ls_leak(void)
    {
    struct map_kptr_race *skel, *watcher;
    let mut listen_fd: c_int = -1, client_fd = -1, map_id;
    skel = map_kptr_race__open_and_load();
    if (!ASSERT_OK_PTR(skel, "open_and_load"))
    return;
