...
//! Source: tools/testing/selftests/bpf/prog_tests/iters.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn subtest_num_iters() {
...
#[no_mangle]
unsafe extern "C" fn subtest_testmod_seq_iters() {
...
#[no_mangle]
unsafe extern "C" fn subtest_task_vma_iters() {
...
pub const thread_num: c_int = 2;
#[no_mangle]
unsafe extern "C" fn subtest_task_iters() {
    static void subtest_task_iters(void)
    {
    struct iters_task *skel = core::ptr::null_mut();
    ...
    ASSERT_OK(pthread_create(&thread_ids[i], core::ptr::null_mut(), &do_nothing_wait, core::ptr::null_mut()),
    "pthread_create");
    syscall(SYS_getpgid);
...
#[no_mangle]
unsafe extern "C" fn subtest_css_task_iters() {
    static void subtest_css_task_iters(void)
    {
    struct iters_css_task *skel = core::ptr::null_mut();
    int err, cg_fd, cg_id;
...
#[no_mangle]
unsafe extern "C" fn subtest_css_iters() {
    static void subtest_css_iters(void)
    {
    struct iters_css *skel = core::ptr::null_mut();
    struct {
    const char *path;
    int fd;
    } cgs[] = {
