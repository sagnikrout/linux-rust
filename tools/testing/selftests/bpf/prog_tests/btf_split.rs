...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_split.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn btf_raw_write(btf: *mut btf, file: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn __test_btf_split(multi: bool) {
    ...
    let mut multisplit_btf_sz: isize = 0, split_btf_sz = 0, base_btf_sz = 0;
    struct btf_dump *d = core::ptr::null_mut();
    const struct btf_type *t, *ot;
    struct btf *btf1 = core::ptr::null_mut(), *btf2 = core::ptr::null_mut(), *btf3 = core::ptr::null_mut();
    struct btf *btf4 = core::ptr::null_mut(), *btf5 = core::ptr::null_mut(), *btf6 = core::ptr::null_mut();
    int str_off, i, err;
    btf1 = btf__new_empty();
...
// BTF-to-C dump of split BTF
    ...
    return;
    d = btf_dump__new(btf3, btf_dump_printf, dump_buf_file, core::ptr::null_mut());
...
// write base, split BTFs to files and ensure parsing succeeds
    ...
    if (split_btf_sz < 0)
    goto cleanup;
    btf4 = btf__parse(base_btf_file, core::ptr::null_mut());
