...
//! Source: tools/testing/selftests/bpf/prog_tests/tcp_hdr_options.c
#![no_std]
...
// Macro flag: #define _GNU_SOURCE
    ...
    let mut exp_active_hdr_stg: static struct hdr_stg = { .active = true, };
...
pub struct sk_fds {
    pub srv_fd: c_int,
    pub passive_fd: c_int,
    pub active_fd: c_int,
    pub passive_lport: c_int,
    pub active_lport: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn print_hdr_stg(hdr_stg: *const hdr_stg, prefix: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn sk_fds_close(sk_fds: *mut sk_fds) {
...
#[no_mangle]
unsafe extern "C" fn sk_fds_shutdown(sk_fds: *mut sk_fds) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sk_fds_connect(sk_fds: *mut sk_fds, fast_open: bool) -> c_int {
    ...
    sk_fds.passive_fd = accept(sk_fds.srv_fd, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn check_error_linum(sk_fds: *const sk_fds) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_hdr_and_close_fds(sk_fds: *mut sk_fds) {
...
unsafe extern "C" fn reset_test() {
    ...
    {
    let mut optsize: usize = sizeof(struct bpf_test_option);
    int lport, err;
    ...
    err = bpf_map_get_next_key(lport_linum_map_fd, core::ptr::null_mut(), &lport);
    while (!err) {
