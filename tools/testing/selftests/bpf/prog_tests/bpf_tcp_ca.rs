...
//! Source: tools/testing/selftests/bpf/prog_tests/bpf_tcp_ca.c
#![no_std]
...
// Copyright (c) 2019 Facebook
    ...
    let mut total_bytes: static unsigned int = 10 * 1024 * 1024;
    let mut expected_stg: static int = 0xeB9F;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cb_opts {
    pub cc: *const c_char,
...
#[no_mangle]
unsafe extern "C" fn settcpca(fd: c_int, tcp_ca: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_test(opts: *const network_helper_opts) {
    static void do_test(const struct network_helper_opts *opts)
    {
    let mut lfd: c_int = -1, fd = -1;
    if (!start_test(core::ptr::null_mut(), opts, opts, &lfd, &fd))
    goto done;
...
unsafe extern "C" fn test_dctcp() {
    ...
    let mut lfd: c_int = -1, fd = -1, tmp_stg, err;
    ...
    if (!start_test(core::ptr::null_mut(), &opts, &cli_opts, &lfd, &fd))
    goto done;
...
#[no_mangle]
unsafe extern "C" fn test_dctcp_autoattach_map() {
...
// struct_ops is auto-attached
    ...
    if (!log_buf)
    goto out;
    if (err_str && strstr(log_buf, err_str) != core::ptr::null_mut())
    found = true;
    out:
...
#[no_mangle]
unsafe extern "C" fn test_invalid_license() {
...
#[no_mangle]
unsafe extern "C" fn test_dctcp_fallback() {
    ...
    char srv_cc[16];
    let mut cc_len: socklen_t = sizeof(srv_cc);
...
#[no_mangle]
unsafe extern "C" fn test_rel_setsockopt() {
...
#[no_mangle]
unsafe extern "C" fn test_write_sk_pacing() {
...
#[no_mangle]
unsafe extern "C" fn test_incompl_cong_ops() {
...
#[no_mangle]
unsafe extern "C" fn test_unsupp_cong_op() {
...
#[no_mangle]
unsafe extern "C" fn test_update_ca() {
...
#[no_mangle]
unsafe extern "C" fn test_update_wrong() {
...
#[no_mangle]
unsafe extern "C" fn test_mixed_links() {
...
#[no_mangle]
unsafe extern "C" fn test_multi_links() {
...
#[no_mangle]
unsafe extern "C" fn test_link_replace() {
...
#[no_mangle]
unsafe extern "C" fn test_tcp_ca_kfunc() {
...
#[no_mangle]
unsafe extern "C" fn test_untrusted_btf_write() {
...
#[no_mangle]
unsafe extern "C" fn test_cc_cubic() {
