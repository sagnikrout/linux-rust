...
//! Source: tools/testing/selftests/bpf/prog_tests/token.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn sys_fspick(dfd: c_int, path: *const c_char, flags: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drop_priv_caps(old_caps: *mut __u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_priv_caps(old_caps: __u64) -> c_int {
    static int restore_priv_caps(__u64 old_caps)
    {
    return cap_enable_effective(old_caps, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn set_delegate_mask(fs_fd: c_int, key: *const c_char, mask: __u64, mask_str: *const c_char) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bpffs_opts {
    pub cmds: __u64,
    pub maps: __u64,
    pub progs: __u64,
    pub attachs: __u64,
    pub cmds_str: *const c_char,
    pub maps_str: *const c_char,
    pub progs_str: *const c_char,
    pub attachs_str: *const c_char,
}

#[no_mangle]
unsafe extern "C" fn create_bpffs_fd() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn materialize_bpffs_fd(fs_fd: c_int, opts: *mut bpffs_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sendfd(sockfd: c_int, fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn recvfd(sockfd: c_int, fd: *mut c_int) -> c_int {
...
unsafe extern "C" fn child(sock_fd: c_int, opts: *mut bpffs_opts, callback: child_callback_fn) {
    ...
    {
    let mut mnt_fd: c_int = -1, fs_fd = -1, err = 0, bpffs_fd = -1, token_fd = -1;
    struct token_lsm *lsm_skel = core::ptr::null_mut();
    char one;
...
// setup mountns to allow creating BPF FS (fsopen("bpf")) from unpriv process
    ...
    goto cleanup;
    err = sys_mount(core::ptr::null_mut(), "/", core::ptr::null_mut(), MS_REC | MS_PRIVATE, 0);
...
// ensure unprivileged child cannot set delegation options
    err = set_delegate_mask(fs_fd, "delegate_cmds", 0x1, core::ptr::null_mut());
    ASSERT_EQ(err, -EPERM, "delegate_cmd_eperm");
    err = set_delegate_mask(fs_fd, "delegate_maps", 0x1, core::ptr::null_mut());
    ASSERT_EQ(err, -EPERM, "delegate_maps_eperm");
    err = set_delegate_mask(fs_fd, "delegate_progs", 0x1, core::ptr::null_mut());
    ASSERT_EQ(err, -EPERM, "delegate_progs_eperm");
    err = set_delegate_mask(fs_fd, "delegate_attachs", 0x1, core::ptr::null_mut());
...
// create BPF token FD and pass it to parent for some extra checks
    token_fd = bpf_token_create(bpffs_fd, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn parent(child_pid: c_int, bpffs_opts: *mut bpffs_opts, sock_fd: c_int) {
    static void parent(int child_pid, struct bpffs_opts *bpffs_opts, int sock_fd)
    {
    let mut fs_fd: c_int = -1, token_fd = -1, err;
...
#[no_mangle]
unsafe extern "C" fn userns_map_create(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
// create BPF token from BPF FS mount
    token_fd = bpf_token_create(mnt_fd, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn userns_btf_load(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userns_prog_load(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_map(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_freplace_prog(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
    static int userns_obj_priv_freplace_prog(int mnt_fd, struct token_lsm *lsm_skel)
    {
    struct priv_freplace_prog *fr_skel = core::ptr::null_mut();
    struct priv_prog *skel = core::ptr::null_mut();
    int err, tgt_fd;
...
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_freplace_prog_fail(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn validate_struct_ops_load(mnt_fd: c_int, expect_success: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_btf_fail(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_btf_success(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_implicit_token(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_implicit_token_envvar(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kallsyms_has_bpf_func(ksyms: *mut ksyms, func_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn userns_obj_priv_prog_kallsyms(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userns_bpf_token_info(mnt_fd: c_int, lsm_skel: *mut token_lsm) -> c_int {
    static int userns_bpf_token_info(int mnt_fd, struct token_lsm *lsm_skel)
    {
    int err, token_fd = -1;
    struct bpf_token_info info;
    let mut len: u32 = sizeof(struct bpf_token_info);
// create BPF token from BPF FS mount
    token_fd = bpf_token_create(mnt_fd, core::ptr::null_mut());
    if (!ASSERT_GT(token_fd, 0, "token_create")) {
    err = -EINVAL;
...
// allow BTF loading
    ...
    sysctl_set_or_fail("/proc/sys/kernel/perf_event_paranoid", core::ptr::null_mut(), perf_paranoid_orig);
    if (kptr_restrict_orig[0])
    sysctl_set_or_fail("/proc/sys/kernel/kptr_restrict", core::ptr::null_mut(), kptr_restrict_orig);
    }
    }
