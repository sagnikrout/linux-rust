...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_kind.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_btf_kind_encoding() {
...
#[no_mangle]
unsafe extern "C" fn write_raw_btf(raw_btf: *mut c_void, raw_size: usize, file: *mut c_char) -> c_int {
    static int write_raw_btf(void *raw_btf, size_t raw_size, char *file)
    {
    let mut fd: c_int = mkstemp(file);
    ssize_t n;
...
//
#[no_mangle]
pub unsafe extern "C" fn test_btf_kind_decoding() {
    ...
    struct btf *btf = core::ptr::null_mut(), *new_btf = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn test_btf_kind() {
