...
//! Source: tools/testing/selftests/bpf/prog_tests/xdp_adjust_tail.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_xdp_adjust_tail_shrink() {
...
#[no_mangle]
unsafe extern "C" fn test_xdp_adjust_tail_grow(is_64k_pagesize: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_xdp_adjust_tail_grow2() {
...
#[no_mangle]
unsafe extern "C" fn test_xdp_adjust_frags_tail_shrink() {
...
#[no_mangle]
unsafe extern "C" fn test_xdp_adjust_frags_tail_grow_4k() {
...
#[no_mangle]
unsafe extern "C" fn test_xdp_adjust_frags_tail_grow_64k() {
