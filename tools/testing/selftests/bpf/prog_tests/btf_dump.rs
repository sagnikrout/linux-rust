...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_dump.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn btf_dump_all_types(btf: *const btf, ctx: *mut c_void) -> c_int {
    static int btf_dump_all_types(const struct btf *btf, void *ctx)
    {
    let mut type_cnt: usize = btf__type_cnt(btf);
    struct btf_dump *d;
    let mut err: c_int = 0, id;
    d = btf_dump__new(btf, btf_dump_printf, ctx, core::ptr::null_mut());
...
//
    ...
    f = fdopen(fd, "w");
    if (CHECK(f == core::ptr::null_mut(), "open_tmp",  "failed to open file: %s(%d)\n",
...
pub struct test_ctx {
    pub btf: *mut btf,
    pub d: *mut btf_dump,
    pub dump_buf: *mut c_char,
    pub dump_buf_sz: usize,
    pub dump_buf_file: *mut FILE,
}

#[no_mangle]
unsafe extern "C" fn test_ctx__free(t: *mut test_ctx) {
...
#[no_mangle]
unsafe extern "C" fn test_ctx__init(t: *mut test_ctx) -> c_int {
    ...
    goto err_out;
    t.d = btf_dump__new(t.btf, btf_dump_printf, t.dump_buf_file, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn test_btf_dump_incremental() {
...
//
    ...
    id = btf__add_enum(btf, core::ptr::null_mut(), 4);
...
#[no_mangle]
unsafe extern "C" fn test_btf_dump_type_tags() {
...
// overflow test; pass typesize < expected type size, ensure E2BIG returned
    ...
    let mut i: unsigned __int128 = 0xffffffffffffffff;
...
// simple int
    TEST_BTF_DUMP_DATA_C(btf, d, core::ptr::null_mut(), str, int, BTF_F_COMPACT, 1234);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int, BTF_F_COMPACT | BTF_F_NONAME,
    "1234", 1234);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int, 0, "(int)1234", 1234);
// zero value should be printed at toplevel
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int, BTF_F_COMPACT, "(int)0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int, BTF_F_COMPACT | BTF_F_NONAME,
    "0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int, BTF_F_COMPACT | BTF_F_ZERO,
    "(int)0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int,
    BTF_F_COMPACT | BTF_F_NONAME | BTF_F_ZERO,
    "0", 0);
    TEST_BTF_DUMP_DATA_C(btf, d, core::ptr::null_mut(), str, int, BTF_F_COMPACT, -4567);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int, BTF_F_COMPACT | BTF_F_NONAME,
    "-4567", -4567);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, int, 0, "(int)-4567", -4567);
    TEST_BTF_DUMP_DATA_OVER(btf, d, core::ptr::null_mut(), str, int, sizeof(int)-1, "", 1);
...
//
    ...
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, unsigned __int128, BTF_F_COMPACT,
    "(unsigned __int128)0xffffffffffffffff",
    0xffffffffffffffff);
    ASSERT_OK(btf_dump_data(btf, d, "unsigned __int128", core::ptr::null_mut(), 0, &i, 16, str,
    ...
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, __int128 unsigned, BTF_F_COMPACT,
    "(__int128 unsigned)0xffffffffffffffff",
    0xffffffffffffffff);
    ASSERT_OK(btf_dump_data(btf, d, "__int128 unsigned", core::ptr::null_mut(), 0, &i, 16, str,
    ...
    char *str)
    {
    let mut t1: float = 1.234567;
    let mut t2: float = -1.234567;
    let mut t3: float = 0.0;
    let mut t4: double = 5.678912;
    let mut t5: double = -5.678912;
    let mut t6: double = 0.0;
    let mut t7: long double = 9.876543;
    let mut t8: long double = -9.876543;
    let mut t9: long double = 0.0;
...
//
    ...
    ASSERT_OK(btf_dump_data(btf, d, "test_float", core::ptr::null_mut(), 0, &t1, 4, str,
    "(test_float)1.234567"), "dump float");
    ASSERT_OK(btf_dump_data(btf, d, "test_float", core::ptr::null_mut(), 0, &t2, 4, str,
    "(test_float)-1.234567"), "dump float");
    ASSERT_OK(btf_dump_data(btf, d, "test_float", core::ptr::null_mut(), 0, &t3, 4, str,
    "(test_float)0.000000"), "dump float");
    ASSERT_GT(btf__add_float(btf, "test_double", 8), 0, "add_double");
    ASSERT_OK(btf_dump_data(btf, d, "test_double", core::ptr::null_mut(), 0, &t4, 8, str,
    "(test_double)5.678912"), "dump double");
    ASSERT_OK(btf_dump_data(btf, d, "test_double", core::ptr::null_mut(), 0, &t5, 8, str,
    "(test_double)-5.678912"), "dump double");
    ASSERT_OK(btf_dump_data(btf, d, "test_double", core::ptr::null_mut(), 0, &t6, 8, str,
    "(test_double)0.000000"), "dump double");
    ASSERT_GT(btf__add_float(btf, "test_long_double", 16), 0, "add long double");
    ASSERT_OK(btf_dump_data(btf, d, "test_long_double", core::ptr::null_mut(), 0, &t7, 16,
    str, "(test_long_double)9.876543"),
    "dump long_double");
    ASSERT_OK(btf_dump_data(btf, d, "test_long_double", core::ptr::null_mut(), 0, &t8, 16,
    str, "(test_long_double)-9.876543"),
    "dump long_double");
    ASSERT_OK(btf_dump_data(btf, d, "test_long_double", core::ptr::null_mut(), 0, &t9, 16,
    ...
    {
// simple char
    TEST_BTF_DUMP_DATA_C(btf, d, core::ptr::null_mut(), str, char, BTF_F_COMPACT, 100);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, char, BTF_F_COMPACT | BTF_F_NONAME,
    "100", 100);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, char, 0, "(char)100", 100);
// zero value should be printed at toplevel
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, char, BTF_F_COMPACT,
    "(char)0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, char, BTF_F_COMPACT | BTF_F_NONAME,
    "0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, char, BTF_F_COMPACT | BTF_F_ZERO,
    "(char)0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, char, BTF_F_COMPACT | BTF_F_NONAME | BTF_F_ZERO,
    "0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, char, 0, "(char)0", 0);
    TEST_BTF_DUMP_DATA_OVER(btf, d, core::ptr::null_mut(), str, char, sizeof(char)-1, "", 100);
    }
    static void test_btf_dump_typedef_data(struct btf *btf, struct btf_dump *d,
    char *str)
    {
// simple typedef
    TEST_BTF_DUMP_DATA_C(btf, d, core::ptr::null_mut(), str, uint64_t, BTF_F_COMPACT, 100);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, u64, BTF_F_COMPACT | BTF_F_NONAME,
    "1", 1);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, u64, 0, "(u64)1", 1);
// zero value should be printed at toplevel
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, u64, BTF_F_COMPACT, "(u64)0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, u64, BTF_F_COMPACT | BTF_F_NONAME,
    "0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, u64, BTF_F_COMPACT | BTF_F_ZERO,
    "(u64)0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, u64,
    BTF_F_COMPACT | BTF_F_NONAME | BTF_F_ZERO,
    "0", 0);
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, u64, 0, "(u64)0", 0);
// typedef struct
    TEST_BTF_DUMP_DATA_C(btf, d, core::ptr::null_mut(), str, atomic_t, BTF_F_COMPACT,
    {.counter = (int)1,});
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t, BTF_F_COMPACT | BTF_F_NONAME,
    "{1,}", { .counter = 1 });
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t, 0,
    "(atomic_t){\n"
    "	.counter = (int)1,\n"
    "}",
    {.counter = 1,});
// typedef with 0 value should be printed at toplevel
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t, BTF_F_COMPACT, "(atomic_t){}",
    {.counter = 0,});
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t, BTF_F_COMPACT | BTF_F_NONAME,
    "{}", {.counter = 0,});
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t, 0,
    ...
    "}",
    {.counter = 0,});
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t, BTF_F_COMPACT | BTF_F_ZERO,
    "(atomic_t){.counter = (int)0,}",
    {.counter = 0,});
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t,
    BTF_F_COMPACT | BTF_F_NONAME | BTF_F_ZERO,
    "{0,}", {.counter = 0,});
    TEST_BTF_DUMP_DATA(btf, d, core::ptr::null_mut(), str, atomic_t, BTF_F_ZERO,
    "(atomic_t){\n"
    "	.counter = (int)0,\n"
    "}",
    { .counter = 0,});
// overflow should show type but not value since it overflows
    TEST_BTF_DUMP_DATA_OVER(btf, d, core::ptr::null_mut(), str, atomic_t, sizeof(atomic_t)-1,
    "(atomic_t){\n", { .counter = 1});
    }
...
// struct with enum bitfield
    ...
    ASSERT_NEQ(strstr(str, "FS_CONTEXT_FOR_MOUNT"), core::ptr::null_mut(),
...
//
    ...
    TEST_BTF_DUMP_VAR(btf, d, core::ptr::null_mut(), str, "cpu_number", int, BTF_F_COMPACT,
    "int cpu_number = (int)100", 100);

    TEST_BTF_DUMP_VAR(btf, d, core::ptr::null_mut(), str, "bpf_bprintf_nest_level", int, BTF_F_COMPACT,
    "static int bpf_bprintf_nest_level = (int)2", 2);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_dump_string_ctx {
    pub btf: *mut btf,
    pub d: *mut btf_dump,
    pub str: *mut c_char,
    pub opts: *mut btf_dump_type_data_opts,
    pub array_id: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn btf_dump_strings(ctx: *mut btf_dump_string_ctx) {
...
#[no_mangle]
unsafe extern "C" fn test_btf_dump_string_data() {
    ...
    if (test_ctx__init(&t))
    return;
    d = btf_dump__new(t.btf, btf_dump_snprintf, str, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn test_btf_dump_datasec_data(str: *mut c_char) {
    static void test_btf_dump_datasec_data(char *str)
    {
    struct btf *btf;
    char license[4] = "GPL";
    struct btf_dump *d;
    btf = btf__parse("xdp_dummy.bpf.o", core::ptr::null_mut());
    if (!ASSERT_OK_PTR(btf, "xdp_dummy.bpf.o BTF not found"))
    return;
    d = btf_dump__new(btf, btf_dump_snprintf, str, core::ptr::null_mut());
    if (!ASSERT_OK_PTR(d, "could not create BTF dump"))
    goto out;
