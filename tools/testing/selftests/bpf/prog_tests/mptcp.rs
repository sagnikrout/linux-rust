...
//! Source: tools/testing/selftests/bpf/prog_tests/mptcp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn verify_tsk(map_fd: c_int, client_fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_msk_ca_name(ca_name[]: c_char) {
...
#[no_mangle]
unsafe extern "C" fn verify_msk(map_fd: c_int, client_fd: c_int, token: __u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_test(cgroup_fd: c_int, server_fd: c_int, is_mptcp: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_base() {
    static void test_base(void)
    {
    struct netns_obj *netns = core::ptr::null_mut();
...
// without MPTCP
    ...
    with_mptcp:
// with MPTCP
    server_fd = start_mptcp_server(AF_INET, core::ptr::null_mut(), 0, 0);
...
#[no_mangle]
unsafe extern "C" fn verify_mptcpify(server_fd: c_int, client_fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_mptcpify(cgroup_fd: c_int, type: c_int) -> c_int {
    ...
    goto out;
// without MPTCP
    server_fd = start_server(AF_INET, type, core::ptr::null_mut(), 0, 0);
    if (!ASSERT_GE(server_fd, 0, "start_server")) {
    err = -EIO;
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn test_mptcpify() {
...
#[no_mangle]
unsafe extern "C" fn endpoint_init(flags: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_for_new_subflows(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn run_subflow() {
...
#[no_mangle]
unsafe extern "C" fn test_subflow() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_with_mptcp_fallback(skel: *mut mptcp_sockmap) {
    static void test_sockmap_with_mptcp_fallback(struct mptcp_sockmap *skel)
    {
    let mut listen_fd: c_int = -1, client_fd1 = -1, client_fd2 = -1;
    let mut server_fd1: c_int = -1, server_fd2 = -1, sent, recvd;
    char snd[9] = "123456789";
    char rcv[10];
// start server with MPTCP enabled
    listen_fd = start_mptcp_server(AF_INET, core::ptr::null_mut(), 0, 0);
    if (!ASSERT_OK_FD(listen_fd, "sockmap-fb:start_mptcp_server"))
    return;
    skel.bss.trace_port = ntohs(get_socket_local_port(listen_fd));
    skel.bss.sk_index = 0;
// create client without MPTCP enabled
    client_fd1 = connect_to_fd_opts(listen_fd, core::ptr::null_mut());
    if (!ASSERT_OK_FD(client_fd1, "sockmap-fb:connect_to_fd"))
    goto end;
    server_fd1 = accept(listen_fd, core::ptr::null_mut(), 0);
    skel.bss.sk_index = 1;
    client_fd2 = connect_to_fd_opts(listen_fd, core::ptr::null_mut());
    if (!ASSERT_OK_FD(client_fd2, "sockmap-fb:connect_to_fd"))
    goto end;
    server_fd2 = accept(listen_fd, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_reject_mptcp(skel: *mut mptcp_sockmap) {
    static void test_sockmap_reject_mptcp(struct mptcp_sockmap *skel)
    {
    let mut listen_fd: c_int = -1, server_fd = -1, client_fd1 = -1;
    int err, zero = 0;
// start server with MPTCP enabled
    listen_fd = start_mptcp_server(AF_INET, core::ptr::null_mut(), 0, 0);
...
// bpf_sock_map_update() called from sockops should reject MPTCP sk
    ...
    goto end;
    server_fd = accept(listen_fd, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn test_mptcp_sockmap() {
