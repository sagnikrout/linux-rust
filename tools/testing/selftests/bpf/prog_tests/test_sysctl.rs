...
//! Source: tools/testing/selftests/bpf/prog_tests/test_sysctl.c
#![no_std]
...
pub const FIXUP_SYSCTL_VALUE: c_int = 0;
    char bpf_log_buf[BPF_LOG_BUF_SIZE];
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sysctl_test {
    pub descr: *const c_char,
    pub fixup_value_insn: usize,
    pub insns: [bpf_insn; MAX_INSNS],
    pub prog_file: *const c_char,
    pub attach_type: enum bpf_attach_type,
    pub sysctl: *const c_char,
    pub open_flags: c_int,
    pub seek: c_int,
    pub newval: *const c_char,
    pub oldval: *const c_char,
    enum {
    LOAD_REJECT,
    ATTACH_REJECT,
    OP_EPERM,
...
unsafe extern "C" fn probe_prog_length(fp: *const bpf_insn) -> usize {
    ...
    ret = bpf_prog_load(BPF_PROG_TYPE_CGROUP_SYSCTL, core::ptr::null_mut(), "GPL", prog, insn_cnt, &opts);
...
#[no_mangle]
unsafe extern "C" fn load_sysctl_prog_file(test: *mut sysctl_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn load_sysctl_prog(test: *mut sysctl_test, sysctl_path: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_test_case(cgfd: c_int, test: *mut sysctl_test) -> c_int {
    static int run_test_case(int cgfd, struct sysctl_test *test)
    {
    let mut atype: enum bpf_attach_type = test.attach_type;
...
#[no_mangle]
unsafe extern "C" fn run_tests(cgfd: c_int) -> c_int {
