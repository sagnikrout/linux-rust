...
//! Source: tools/testing/selftests/bpf/prog_tests/attach_probe.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn trigger_func2() -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn trigger_func3() -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn trigger_func4() -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn test_attach_probe_manual(attach_mode: enum probe_attach_mode) {
...
#[no_mangle]
unsafe extern "C" fn test_attach_kprobe_by_addr(attach_mode: enum probe_attach_mode) {
...
#[no_mangle]
unsafe extern "C" fn test_attach_kprobe_legacy_by_addr_reject() {
...
//
#[no_mangle]
unsafe extern "C" fn test_attach_probe_dup_sym(attach_mode: enum probe_attach_mode) {
...
#[no_mangle]
unsafe extern "C" fn test_attach_uprobe_long_event_name() {
...
#[no_mangle]
unsafe extern "C" fn test_attach_kprobe_long_event_name() {
...
// attach kprobe/kretprobe long event name testings
#[no_mangle]
unsafe extern "C" fn test_attach_kprobe_write_ctx() {
...
#[no_mangle]
unsafe extern "C" fn test_freplace_kprobe_write_ctx() {
    static void test_freplace_kprobe_write_ctx(void)
    {
    struct bpf_program *prog_kprobe, *prog_ext, *prog_fentry;
    struct kprobe_write_ctx *skel_kprobe, *skel_ext = core::ptr::null_mut();
    struct bpf_link *link_kprobe = core::ptr::null_mut(), *link_ext = core::ptr::null_mut();
    int err, prog_fd;
    LIBBPF_OPTS(bpf_kprobe_opts, kprobe_opts);
...
#[no_mangle]
unsafe extern "C" fn test_attach_probe_auto(skel: *mut test_attach_probe) {
...
#[no_mangle]
unsafe extern "C" fn test_uprobe_lib(skel: *mut test_attach_probe) {
...
#[no_mangle]
unsafe extern "C" fn test_uprobe_ref_ctr(skel: *mut test_attach_probe) {
...
#[no_mangle]
unsafe extern "C" fn test_kprobe_sleepable() {
...
#[no_mangle]
unsafe extern "C" fn test_uprobe_sleepable(skel: *mut test_attach_probe) {
