...
//! Source: tools/testing/selftests/bpf/prog_tests/log_fixup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bad_core_relo(log_buf_size: usize, trunc_type: enum trunc_type) {
...
#[no_mangle]
unsafe extern "C" fn bad_core_relo_subprog() {
...
#[no_mangle]
unsafe extern "C" fn missing_map() {
...
#[no_mangle]
unsafe extern "C" fn missing_kfunc() {
