...
//! Source: tools/testing/selftests/bpf/prog_tests/test_tunnel.c
#![no_std]
...
pub const IP4_ADDR1_HEX_VETH1: c_uint = 0xac1001c8;
pub const IP4_ADDR2_HEX_VETH1: c_uint = 0xac100114;
pub const IP6_ADDR1_HEX_VETH1: c_uint = 0x22;
pub const IP6_ADDR2_HEX_VETH1: c_uint = 0xbb;

pub const XFRM_SPI_IN_TO_OUT: c_uint = 0x1;
pub const XFRM_SPI_OUT_TO_IN: c_uint = 0x2;

#[no_mangle]
unsafe extern "C" fn config_device() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_vxlan_tunnel() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_vxlan_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn add_ip6vxlan_tunnel() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_ip6vxlan_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn set_ipip_encap(ipproto: *const c_char, type: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_ipv4_addr(dev0: *const c_char, dev1: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_ipip_tunnel(encap: enum ipip_encap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_ipip_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn add_xfrm_tunnel() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_xfrm_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn delete_tunnel(dev0: *const c_char, dev1: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn set_ipv6_addr(dev0: *const c_char, dev1: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_vxlan_tunnel() {
    static void test_vxlan_tunnel(void)
    {
    struct test_tunnel_kern *skel = core::ptr::null_mut();
    struct nstoken *nstoken;
...
#[no_mangle]
unsafe extern "C" fn test_ip6vxlan_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn test_ipip_tunnel(encap: enum ipip_encap) {
...
#[no_mangle]
unsafe extern "C" fn test_xfrm_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn test_gre_tunnel(test: enum gre_test) {
...
#[no_mangle]
unsafe extern "C" fn test_ip6gre_tunnel(test: enum ip6gre_test) {
...
#[no_mangle]
unsafe extern "C" fn test_erspan_tunnel(test: enum erspan_test) {
...
#[no_mangle]
unsafe extern "C" fn test_ip6erspan_tunnel(test: enum erspan_test) {
...
#[no_mangle]
unsafe extern "C" fn test_geneve_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn test_ip6geneve_tunnel() {
...
#[no_mangle]
unsafe extern "C" fn test_ip6tnl_tunnel(test: enum ip6tnl_test) {
...
//
    err = pthread_create(&test_thread, core::ptr::null_mut(), &test_tunnel_run_tests, core::ptr::null_mut());
