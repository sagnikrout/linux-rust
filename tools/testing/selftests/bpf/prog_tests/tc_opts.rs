...
//! Source: tools/testing/selftests/bpf/prog_tests/tc_opts.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_before_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_after_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_revision_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_replace_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_invalid_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_prepend_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_append_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_dev_cleanup_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_mixed_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_demixed_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_detach_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_detach_before_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_detach_after_target(target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_delete_empty(target: c_int, chain_tc_old: bool) {
...
#[no_mangle]
unsafe extern "C" fn generate_dummy_prog() -> c_int {
    ...
    let mut prog_insn_cnt: usize = ARRAY_SIZE(prog_insns);
    LIBBPF_OPTS(bpf_prog_load_opts, opts);
    let mut log_buf_sz: usize = 256;
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_max_target(target: c_int, flags: c_int, relative: bool) {
    static void test_tc_opts_max_target(int target, int flags, bool relative)
    {
    int err, ifindex, i, prog_fd, last_fd = -1;
    LIBBPF_OPTS(bpf_prog_attach_opts, opta);
    let mut max_progs: c_int = 63;
    ASSERT_OK(system("ip link add dev tcx_opts1 type veth peer name tcx_opts2"), "add veth");
    ifindex = if_nametoindex("tcx_opts1");
    ASSERT_NEQ(ifindex, 0, "non_zero_ifindex");
    assert_mprog_count_ifindex(ifindex, target, 0);
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_query_target(target: c_int) {
    static void test_tc_opts_query_target(int target)
    {
    let mut attr_size: usize = offsetofend(union bpf_attr, query);
    LIBBPF_OPTS(bpf_prog_attach_opts, opta);
    LIBBPF_OPTS(bpf_prog_detach_opts, optd);
    LIBBPF_OPTS(bpf_prog_query_opts, optq);
    __u32 fd1, fd2, fd3, fd4, id1, id2, id3, id4;
...
#[no_mangle]
unsafe extern "C" fn test_tc_opts_query_attach_target(target: c_int) {
