...
//! Source: tools/testing/selftests/bpf/prog_tests/arg_parsing.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_test_filter_set(set: *mut test_filter_set) {
...
#[no_mangle]
unsafe extern "C" fn free_test_filter_set(set: *mut test_filter_set) {
...
#[no_mangle]
unsafe extern "C" fn test_parse_test_list() {
...
#[no_mangle]
unsafe extern "C" fn test_parse_test_list_file() {
    ...
    return;
    fp = fdopen(fd, "w");
    if (!ASSERT_NEQ(fp, core::ptr::null_mut(), "fdopen tmp")) {
    close(fd);
    goto out_remove;
    }
    fprintf(fp, "# comment\n");
