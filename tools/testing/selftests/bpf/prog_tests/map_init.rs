...
//! Source: tools/testing/selftests/bpf/prog_tests/map_init.c
#![no_std]
...
pub const TEST_VALUE: c_uint = 0x1234;
pub const FILL_VALUE: c_uint = 0xdeadbeef;
    static int nr_cpus;
    static int duration;
...
#[no_mangle]
unsafe extern "C" fn map_populate(map_fd: c_int, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_values_one_cpu(value: *mut pcpu_map_value_t, expected: map_value_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_pcpu_map_init() {
...
//
#[no_mangle]
unsafe extern "C" fn test_pcpu_lru_map_init() {
...
#[no_mangle]
pub unsafe extern "C" fn test_map_init() {
    ...
    {
    let mut key_size: c_int = 4, value_size = 4, max_entries = 1;
    char log_buf[128];
    int fd;
...
#[no_mangle]
unsafe extern "C" fn test_map_create_array(opts: *mut bpf_map_create_opts, exp_msg: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_vmlinux_value_type_id_struct_ops() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_vmlinux_value_type_id_kv_type_id() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_value_type_id() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_map_extra() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_numa_node() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_map_type() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_token_fd() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_map_name() {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_btf_fd() {
...
#[no_mangle]
unsafe extern "C" fn test_excl_prog_hash_size_1() {
...
#[no_mangle]
unsafe extern "C" fn test_excl_prog_hash_size_2() {
...
#[no_mangle]
unsafe extern "C" fn test_common_attr_padding() {
    static void test_common_attr_padding(void)
    {
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bpf_common_attr_fake {
    pub log_true_size)]: __u8 attrs[offsetofend(struct bpf_common_attr,,
    pub pad: __u32,
    } attr_common = {
    .pad = 1,
}
...
#[no_mangle]
pub unsafe extern "C" fn test_map_create_failure() {
