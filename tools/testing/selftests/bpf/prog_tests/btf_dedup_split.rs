...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_dedup_split.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_split_simple() {
...
pub struct s2 {
    ...
    \n\
    typedef int t1___2;\n\n", "c_dump");
    err = btf__dedup(btf2, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn test_split_fwd_resolve() {
    struct btf *btf1, *btf2;
    int err;
    btf1 = btf__new_empty();
    if (!ASSERT_OK_PTR(btf1, "empty_main_btf"))
...
#[no_mangle]
unsafe extern "C" fn test_split_struct_duped() {
    struct btf *btf1, *btf2;
    int err;
    btf1 = btf__new_empty();
    if (!ASSERT_OK_PTR(btf1, "empty_main_btf"))
...
#[no_mangle]
unsafe extern "C" fn btf_add_dup_struct_in_cu(btf: *mut btf, start_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_split_dup_struct_in_cu() {
    static void test_split_dup_struct_in_cu()
    {
    struct btf *btf1, *btf2 = core::ptr::null_mut();
    int err;
// generate the base data..
    ...
    "\t'f2' type_id=1 bits_offset=32");
// ..dedup them...
    err = btf__dedup(btf1, core::ptr::null_mut());
    if (!ASSERT_OK(err, "btf_dedup"))
    goto cleanup;
    VALIDATE_RAW_BTF(
    btf1,
...
#[no_mangle]
unsafe extern "C" fn test_split_module() {
    static void test_split_module(void)
    {
    struct btf *vmlinux_btf, *btf1 = core::ptr::null_mut();
    int i, nr_base_types;
