...
//! Source: tools/testing/selftests/bpf/prog_tests/cgroup_iter.c
#![no_std]
...
pub const ROOT: c_int = 0;
pub const PARENT: c_int = 1;
pub const CHILD1: c_int = 2;
pub const CHILD2: c_int = 3;
pub const NUM_CGROUPS: c_int = 4;
...
// Invalid cgroup.
#[no_mangle]
unsafe extern "C" fn test_invalid_cgroup(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_cgroup_spec(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_walk_preorder(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_walk_postorder(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_walk_ancestors_up(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_early_termination(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_walk_self_only(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_walk_children(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_walk_dead_self_only(skel: *mut cgroup_iter) {
...
#[no_mangle]
unsafe extern "C" fn test_walk_self_only_css_task() {
...
pub unsafe extern "C" fn test_cgroup_iter() {
    ...
    {
    struct cgroup_iter *skel = core::ptr::null_mut();
