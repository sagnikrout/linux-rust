...
//! Source: tools/testing/selftests/bpf/prog_tests/bpf_gotox.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __test_run(prog: *mut bpf_program, ctx_in: *mut c_void, ctx_size_in: usize) {
...
#[no_mangle]
unsafe extern "C" fn __subtest(skel: *mut bpf_gotox, ): *mut *mut void (check)(struct bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_one_map_two_jumps(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_one_switch(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_one_switch_non_zero_sec_off(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_two_switches(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_big_jump_table(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_one_jump_two_maps(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_static_global(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_nonstatic_global(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_other_sec(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_static_global_other_sec(skel: *mut bpf_gotox) {
...
#[no_mangle]
unsafe extern "C" fn check_nonstatic_global_other_sec(skel: *mut bpf_gotox) {
...
//
#[no_mangle]
unsafe extern "C" fn create_jt_map(max_entries: __u32) -> c_int {
    static int create_jt_map(__u32 max_entries)
    {
    const char *map_name = "jt";
    let mut key_size: __u32 = 4;
    let mut value_size: __u32 = sizeof(struct bpf_insn_array_value);
    return bpf_map_create(BPF_MAP_TYPE_INSN_ARRAY, map_name,
    key_size, value_size, max_entries, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn prog_load(insns: *mut bpf_insn, insn_cnt: __u32) -> c_int {
    static int prog_load(struct bpf_insn *insns, __u32 insn_cnt)
    {
    return bpf_prog_load(BPF_PROG_TYPE_RAW_TRACEPOINT, core::ptr::null_mut(), "GPL", insns, insn_cnt, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn __check_ldimm64_off_prog_load(max_entries: __u32, off: __u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_ldimm64_off_load(__always_unused: *mut *mut bpf_gotox skel) {
    ...
    let mut max_entries: __u32 = ARRAY_SIZE(values);
...
//
#[no_mangle]
unsafe extern "C" fn check_ldimm64_off_gotox(__always_unused: *mut *mut bpf_gotox skel) {
...
#[no_mangle]
unsafe extern "C" fn check_ldimm64_off_gotox_llvm(skel: *mut bpf_gotox) {
...
pub unsafe extern "C" fn test_bpf_gotox() {
    ...
    if (!ASSERT_NEQ(skel, core::ptr::null_mut(), "bpf_gotox__open"))
    return;
