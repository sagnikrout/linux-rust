...
//! Source: tools/testing/selftests/bpf/prog_tests/fib_lookup.c
#![no_std]
...
pub const MARK_NO_POLICY: c_int = 33;
pub const MARK: c_int = 42;

pub const VLAN_ID: c_int = 100;

pub const VLAN_ID_DOWN: c_int = 102;

pub const VLAN_VID_UNUSED: c_int = 999;

pub const VRF_VLAN_ID: c_int = 101;

pub const TBID_VLAN_ID: c_int = 50;

pub const QINQ_AD_VLAN_ID: c_int = 200;
pub const QINQ_INNER_VLAN_ID: c_int = 300;

pub const BOND_VLAN_ID: c_int = 500;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fib_lookup_test {
    pub desc: *const c_char,
    pub daddr: *const c_char,
    pub expected_ret: c_int,
    pub expected_src: *const c_char,
    pub expected_dst: *const c_char,
...
//
    ...
    pub vlan_id: __u16,
    pub check_vlan: bool,
    pub /: *const *const *const char expected_dev; / expected params->ifindex after lookup,
    pub /: *const *const *const char iif; / override the default veth1 input device,
    pub /: *mut *mut __u16 tot_len; / triggers the in-lookup mtu check when set,
    pub /: *mut *mut __u16 expected_mtu; / expected mtu_result (union with tot_len),
}
...
#[no_mangle]
unsafe extern "C" fn mac_str(b: *mut c_char, mac: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn assert_ip_address(family: c_int, addr: *mut c_void, expected_str: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn assert_src_ip(params: *mut bpf_fib_lookup, expected: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn assert_dst_ip(params: *mut bpf_fib_lookup, expected: *const c_char) {
...
pub unsafe extern "C" fn test_fib_lookup_vlan_netns() {
    ...
    struct nstoken *nstoken = core::ptr::null_mut();
    let mut skb: __sk_buff = { };
    struct fib_lookup *skel = core::ptr::null_mut();
...
pub const REDIRECT_NPKTS: c_int = 1000;
...
pub unsafe extern "C" fn test_fib_lookup_vlan_redirect() {
    ...
    struct nstoken *nstoken = core::ptr::null_mut();
    struct fib_lookup *skel = core::ptr::null_mut();
    let mut xdp_attached: bool = false;
...
//
    ...
    XDP_FLAGS_DRV_MODE, core::ptr::null_mut());
...
//
    ...
    fail:
    if (xdp_attached)
    bpf_xdp_detach(veth2_idx, XDP_FLAGS_DRV_MODE, core::ptr::null_mut());
    if (nstoken)
    close_netns(nstoken);
