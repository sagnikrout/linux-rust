...
//! Source: tools/testing/selftests/bpf/prog_tests/stacktrace_ips.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_stacktrace_ips(fd: c_int, key: __u32, cnt: c_int, ...) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_stacktrace_ips_kprobe_multi(retprobe: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_stacktrace_ips_raw_tp() {
    static void test_stacktrace_ips_raw_tp(void)
    {
    let mut info_len: __u32 = sizeof(struct bpf_prog_info);
    LIBBPF_OPTS(bpf_test_run_opts, topts);
...
#[no_mangle]
unsafe extern "C" fn test_stacktrace_ips_kprobe(retprobe: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_stacktrace_ips_trampoline(retprobe: bool) {
...
#[no_mangle]
unsafe extern "C" fn __test_stacktrace_ips() {
