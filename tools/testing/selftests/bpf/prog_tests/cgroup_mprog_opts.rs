...
//! Source: tools/testing/selftests/bpf/prog_tests/cgroup_mprog_opts.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn assert_mprog_count(cg: c_int, atype: c_int, expected: c_int) {
    static void assert_mprog_count(int cg, int atype, int expected)
    {
    let mut count: __u32 = 0, attach_flags = 0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn test_prog_attach_detach(atype: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_link_attach_detach(atype: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_preorder_prog_attach_detach(atype: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_preorder_link_attach_detach(atype: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_invalid_attach_detach(atype: c_int) {
