...
//! Source: tools/testing/selftests/bpf/prog_tests/xdp_context_test_run.c
#![no_std]
...
pub const TEST_PAYLOAD_LEN: c_int = 32;
...
pub unsafe extern "C" fn test_xdp_context_test_run() {
    ...
    {
    struct test_xdp_context_test_run *skel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn send_test_packet(ifindex: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_test_packet(tap_fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_test_packet_udp(tap_fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dump_err_stream(prog: *const bpf_program) {
...
pub unsafe extern "C" fn test_xdp_context_veth() {
    ...
    struct netns_obj *rx_ns = core::ptr::null_mut(), *tx_ns = core::ptr::null_mut();
    struct bpf_program *tc_prog, *xdp_prog;
    struct test_xdp_meta *skel = core::ptr::null_mut();
...
// Setup TAP interface
    ...
    if (!ASSERT_GE(tap_ifindex, 0, "if_nametoindex"))
    goto close;
    ret = bpf_xdp_attach(tap_ifindex, bpf_program__fd(xdp_prog), 0, core::ptr::null_mut());
    if (!ASSERT_GE(ret, 0, "bpf_xdp_attach"))
    goto close;
...
//
    ...
    LIBBPF_OPTS(bpf_tc_opts, tc_opts, .handle = 1, .priority = 1);
    struct bpf_program *lwt_prog = core::ptr::null_mut();
    struct netns_obj *ns = core::ptr::null_mut();
    const char *encap;
