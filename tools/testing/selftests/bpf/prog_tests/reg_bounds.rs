...
//! Source: tools/testing/selftests/bpf/prog_tests/reg_bounds.c
#![no_std]
...
pub struct strbuf {
    ...
    __printf(2, 3)
#[no_mangle]
pub unsafe extern "C" fn snappendf(s: *mut strbuf, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn min_t(t: enum num_t, x: u64, y: u64) -> __always_inline u64 {
...
#[no_mangle]
unsafe extern "C" fn max_t(t: enum num_t, x: u64, y: u64) -> __always_inline u64 {
...
#[no_mangle]
unsafe extern "C" fn cast_t(t: enum num_t, x: u64) -> __always_inline u64 {
...
#[no_mangle]
unsafe extern "C" fn t_is_32(t: enum num_t) -> enum num_t {
...
#[no_mangle]
unsafe extern "C" fn t_signed(t: enum num_t) -> enum num_t {
...
#[no_mangle]
unsafe extern "C" fn t_unsigned(t: enum num_t) -> enum num_t {
...
#[no_mangle]
unsafe extern "C" fn num_is_small(t: enum num_t, x: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn snprintf_num(t: enum num_t, sb: *mut strbuf, x: u64) {
    static void snprintf_num(enum num_t t, struct strbuf *sb, u64 x)
    {
    let mut is_small: bool = num_is_small(t, x);
    if (is_small) {
    switch (t) {
...
#[no_mangle]
pub unsafe extern "C" fn if(256: x >= U64_MAX -) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(256: (u32)x >= U32_MAX -) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(256: (s64)x >= S64_MAX -) -> else {
    else if ((s64)x >= S64_MAX - 256)
    return snappendf(sb, "S64_MAX-%lld", S64_MAX - (s64)x);
#[no_mangle]
pub unsafe extern "C" fn if(S64_MIN: (s64)x ==) -> else {
    else if ((s64)x == S64_MIN)
    return snappendf(sb, "S64_MIN");
#[no_mangle]
pub unsafe extern "C" fn if(256: (s64)x <= S64_MIN +) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(256: (s32)x >= S32_MAX -) -> else {
    else if ((s32)x >= S32_MAX - 256)
    return snappendf(sb, "S32_MAX-%d", S32_MAX - (s32)x);
#[no_mangle]
pub unsafe extern "C" fn if(S32_MIN: (s32)x ==) -> else {
    else if ((s32)x == S32_MIN)
    return snappendf(sb, "S32_MIN");
#[no_mangle]
pub unsafe extern "C" fn if(256: (s32)x <= S32_MIN +) -> else {
...
#[no_mangle]
unsafe extern "C" fn snprintf_range(t: enum num_t, sb: *mut strbuf, x: range) {
...
#[no_mangle]
unsafe extern "C" fn print_range(t: enum num_t, x: range, sfx: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn unkn_subreg(t: enum num_t) -> range {
...
#[no_mangle]
unsafe extern "C" fn range(t: enum num_t, a: u64, b: u64) -> range {
...
#[no_mangle]
unsafe extern "C" fn range_eq(x: range, y: range) -> bool {
    static bool range_eq(struct range x, struct range y)
    {
    return x.a == y.a && x.b == y.b;
    }
#[no_mangle]
unsafe extern "C" fn range_cast_to_s32(x: range) -> range {
    static struct range range_cast_to_s32(struct range x)
    {
    let mut a: u64 = x.a, b = x.b;
...
#[no_mangle]
unsafe extern "C" fn range_cast_u64(to_t: enum num_t, x: range) -> range {
    static struct range range_cast_u64(enum num_t to_t, struct range x)
    {
    let mut a: u64 = (u64)x.a, b = (u64)x.b;
    switch (to_t) {
    case U64:
    return x;
    case U32:
...
#[no_mangle]
unsafe extern "C" fn range_cast_s64(to_t: enum num_t, x: range) -> range {
    static struct range range_cast_s64(enum num_t to_t, struct range x)
    {
    let mut a: i64 = (s64)x.a, b = (s64)x.b;
    switch (to_t) {
    case U64:
...
#[no_mangle]
unsafe extern "C" fn range_cast_u32(to_t: enum num_t, x: range) -> range {
    static struct range range_cast_u32(enum num_t to_t, struct range x)
    {
    let mut a: u32 = (u32)x.a, b = (u32)x.b;
    switch (to_t) {
    case U64:
    case S64:
...
#[no_mangle]
unsafe extern "C" fn range_cast_s32(to_t: enum num_t, x: range) -> range {
    static struct range range_cast_s32(enum num_t to_t, struct range x)
    {
    let mut a: i32 = (s32)x.a, b = (s32)x.b;
    switch (to_t) {
    case U64:
    case U32:
    case S64:
...
//
#[no_mangle]
unsafe extern "C" fn range_cast(from_t: enum num_t, to_t: enum num_t, from: range) -> range {
...
#[no_mangle]
unsafe extern "C" fn is_valid_num(t: enum num_t, x: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_valid_range(t: enum num_t, x: range) -> bool {
...
#[no_mangle]
unsafe extern "C" fn range_intersection(t: enum num_t, old: range, new: range) -> range {
...
//
#[no_mangle]
unsafe extern "C" fn range_union(t: enum num_t, x: range, y: range) -> range {
...
#[no_mangle]
unsafe extern "C" fn u64_range_contains(v: u64, base: u64, len: u64) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn u32_range_contains(v: u32, base: u32, len: u32) -> __always_inline bool {
    ...
    struct range *out /* 64 */)
    {
    let mut b_len: u64 = (u32)(b.b - b.a);
    let mut a_len: u64 = a.b - a.a;
    u64 lo, hi;
...
#[no_mangle]
unsafe extern "C" fn range_refine(x_t: enum num_t, x: range, y_t: enum num_t, y: range) -> range {
...
#[no_mangle]
unsafe extern "C" fn complement_op(op: enum op) -> enum op {
...
//
#[no_mangle]
unsafe extern "C" fn range_canbe_op(t: enum num_t, x: range, y: range, op: enum op) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn range_always_op(t: enum num_t, x: range, y: range, op: enum op) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn range_never_op(t: enum num_t, x: range, y: range, op: enum op) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn range_branch_taken_op(t: enum num_t, x: range, y: range, op: enum op) -> c_int {
...
pub struct reg_state {
    pub /: *mut *mut range r[4]; / indexed by enum num_t: U64, U32, S64, S32,
    pub valid: bool,
}

#[no_mangle]
unsafe extern "C" fn print_reg_state(r: *mut reg_state, sfx: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn reg_state_refine(r: *mut reg_state, t: enum num_t, x: range, ctx: *const c_char) {
    static void reg_state_refine(struct reg_state *r, enum num_t t, struct range x, const char *ctx)
    {
    enum num_t d_t, s_t;
    struct range old;
    let mut keep_going: bool = false;
    again:
...
#[no_mangle]
unsafe extern "C" fn reg_state_set_const(rs: *mut reg_state, t: enum num_t, val: u64) {
...
// OP_EQ and OP_NE are sign-agnostic
    let mut tu: enum num_t = t_unsigned(t);
    let mut ts: enum num_t = t_signed(t);
    int br_u, br_s, br;
...
//
    ...
    let mut cur_pos: c_int = 0, exit_pos, fd, op_code;
...
//
#[no_mangle]
unsafe extern "C" fn parse_reg_state(s: *const c_char, reg: *mut reg_state) -> c_int {
...
//
    q = p;
    while ((q = strstr(q, buf)) != core::ptr::null_mut()) {
...
// For a pair of signed/unsigned t1/t2 checks if r1/r2 intersect in two intervals.
    ...
    {
    let mut lo: u64 = cast_t(t1, r2.a);
    let mut hi: u64 = cast_t(t1, r2.b);
// does r2 wrap in t1's domain: [0, hi] ∪ [lo, MAX]?
    return lo > hi && r1.a <= hi && r1.b >= lo;
    }
#[no_mangle]
unsafe extern "C" fn reg_state_needs_two_arcs(s: *mut reg_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn assert_reg_state_eq(r: *mut reg_state, e: *mut reg_state, ctx: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn print_verifier_log(buf: *const c_char) {
...
//
    ...
    let mut D: u64 = y.b;
    struct reg_state rc;
    let mut rev_op: enum op = complement_op(op);
    enum num_t t;
...
//
    let mut z: range = t_is_32(init_t) ? unkn_subreg(t) : unkn[t];
    fr1.r[t] = fr2.r[t] = tr1.r[t] = tr2.r[t] = z;
    }
// step 1: r1 >= A, r2 >= C
    reg_state_set_const(&rc, init_t, A);
    reg_state_cond(init_t, fr1, &rc, OP_GE, fr1, core::ptr::null_mut(), "r1>=A");
    reg_state_set_const(&rc, init_t, C);
    reg_state_cond(init_t, fr2, &rc, OP_GE, fr2, core::ptr::null_mut(), "r2>=C");
// tr1 = *fr1;
// tr2 = *fr2;
    if (env.verbosity >= VERBOSE_VERY) {
...
// step 2: r1 <= B, r2 <= D
    ...
    reg_state_cond(init_t, fr1, &rc, OP_LE, fr1, core::ptr::null_mut(), "r1<=B");
    reg_state_set_const(&rc, init_t, D);
    reg_state_cond(init_t, fr2, &rc, OP_LE, fr2, core::ptr::null_mut(), "r2<=D");
// tr1 = *fr1;
// tr2 = *fr2;
    if (env.verbosity >= VERBOSE_VERY) {
...
#[derive(Copy, Clone)]
pub struct ctx {
    pub subrange_cnt: int val_cnt, subval_cnt, range_cnt,,
    pub ARRAY_SIZE(lower_seeds)]: *mut *mut u64 uvals[ARRAY_SIZE(upper_seeds),
    pub ARRAY_SIZE(lower_seeds)]: *mut *mut s64 svals[ARRAY_SIZE(upper_seeds),
    pub usubvals: [u32; ARRAY_SIZE(lower_seeds)],
    pub ssubvals: [i32; ARRAY_SIZE(lower_seeds)],
    pub sranges: *mut *mut range uranges,,
    pub ssubranges: *mut *mut range usubranges,,
    pub cur_failure_cnt: int max_failure_cnt,,
    pub case_cnt: int total_case_cnt,,
    pub rand_case_cnt: c_int,
    pub rand_seed: unsigned,
    pub start_ns: __u64,
    pub progress_ctx: [c_char; 64],
}

#[no_mangle]
unsafe extern "C" fn cleanup_ctx(ctx: *mut ctx) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct subtest_case {
    pub init_t: enum num_t,
    pub cond_t: enum num_t,
    pub x: range,
    pub y: range,
    pub op: enum op,
}
...
#[no_mangle]
unsafe extern "C" fn subtest_case_str(sb: *mut strbuf, t: *mut subtest_case, use_op: bool) {
...
//
    ...
    let mut log_sz: usize = sizeof(log_buf);
...
//
    ...
    let mut progress: double = (ctx.case_cnt + 0.0) / ctx.total_case_cnt;
    let mut elapsed_ns: u64 = get_time_ns() - ctx.start_ns;
    let mut remain_ns: double = elapsed_ns / progress * (1 - progress);
...
//
#[no_mangle]
unsafe extern "C" fn u64_cmp(p1: *const c_void, p2: *const c_void) -> c_int {
    static int u64_cmp(const void *p1, const void *p2)
    {
    let mut x1: u64 = *(const u64 *)p1, x2 = *(const u64 *)p2;
    return x1 != x2 ? (x1 < x2 ? -1 : 1) : 0;
    }
#[no_mangle]
unsafe extern "C" fn u32_cmp(p1: *const c_void, p2: *const c_void) -> c_int {
    static int u32_cmp(const void *p1, const void *p2)
    {
    let mut x1: u32 = *(const u32 *)p1, x2 = *(const u32 *)p2;
    return x1 != x2 ? (x1 < x2 ? -1 : 1) : 0;
    }
#[no_mangle]
unsafe extern "C" fn s64_cmp(p1: *const c_void, p2: *const c_void) -> c_int {
    static int s64_cmp(const void *p1, const void *p2)
    {
    let mut x1: i64 = *(const s64 *)p1, x2 = *(const s64 *)p2;
    return x1 != x2 ? (x1 < x2 ? -1 : 1) : 0;
    }
#[no_mangle]
unsafe extern "C" fn s32_cmp(p1: *const c_void, p2: *const c_void) -> c_int {
    static int s32_cmp(const void *p1, const void *p2)
    {
    let mut x1: i32 = *(const s32 *)p1, x2 = *(const s32 *)p2;
    return x1 != x2 ? (x1 < x2 ? -1 : 1) : 0;
    }
// Generate valid unique constants from seeds, both signed and unsigned
#[no_mangle]
unsafe extern "C" fn gen_vals(ctx: *mut ctx) {
...
#[no_mangle]
unsafe extern "C" fn gen_ranges(ctx: *mut ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_env_vars(ctx: *mut ctx) -> c_int {
    static int parse_env_vars(struct ctx *ctx)
    {
    const char *s;
    if ((s = getenv("REG_BOUNDS_MAX_FAILURE_CNT"))) {
    errno = 0;
    ctx.max_failure_cnt = strtol(s, core::ptr::null_mut(), 10);
    ...
    errno = 0;
    ctx.rand_case_cnt = strtol(s, core::ptr::null_mut(), 10);
    ...
    errno = 0;
    ctx.rand_seed = strtoul(s, core::ptr::null_mut(), 10);
    if (errno) {
...
#[no_mangle]
unsafe extern "C" fn prepare_gen_tests(ctx: *mut ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn validate_gen_range_vs_const_64(init_t: enum num_t, cond_t: enum num_t) {
...
#[no_mangle]
unsafe extern "C" fn validate_gen_range_vs_const_32(init_t: enum num_t, cond_t: enum num_t) {
...
#[no_mangle]
unsafe extern "C" fn validate_gen_range_vs_range(init_t: enum num_t, cond_t: enum num_t) {
...
pub const DEFAULT_RAND_CASE_CNT: c_int = 100;

#[no_mangle]
unsafe extern "C" fn rand_u64() -> u64 {
    static u64 rand_u64()
    {
...
#[no_mangle]
unsafe extern "C" fn rand_const(t: enum num_t) -> u64 {
    static u64 rand_const(enum num_t t)
    {
    return cast_t(t, rand_u64());
    }
#[no_mangle]
unsafe extern "C" fn rand_range(t: enum num_t) -> range {
    static struct range rand_range(enum num_t t)
    {
    let mut x: u64 = rand_const(t), y = rand_const(t);
    return range(t, min_t(t, x, y), max_t(t, x, y));
    }
#[no_mangle]
unsafe extern "C" fn validate_rand_ranges(init_t: enum num_t, cond_t: enum num_t, const_range: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn test_reg_bounds_crafted() {
