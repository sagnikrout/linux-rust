...
//! Source: tools/testing/selftests/bpf/prog_tests/stack_arg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn run_subtest(prog: *mut bpf_program, expected: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_global_many() {
...
#[no_mangle]
unsafe extern "C" fn test_async_cb_many() {
...
#[no_mangle]
unsafe extern "C" fn test_bpf2bpf() {
