...
//! Source: tools/testing/selftests/bpf/prog_tests/linked_list.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_linked_list_fail_prog(prog_name: *const c_char, err_msg: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn clear_fields(prog: *mut bpf_program) {
...
#[no_mangle]
unsafe extern "C" fn test_linked_list_success(mode: c_int, leave_in_map: bool) {
...
pub const SPIN_LOCK: c_int = 2;
pub const LIST_HEAD: c_int = 3;
pub const LIST_NODE: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn list_and_rb_node_same_struct(refcount_field: bool) {
