...
//! Source: tools/testing/selftests/bpf/prog_tests/map_excl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_map_excl_allowed() {
...
#[no_mangle]
unsafe extern "C" fn test_map_excl_denied() {
...
#[no_mangle]
unsafe extern "C" fn test_map_excl_no_map_in_map() {
    ...
    tmpl_fd = bpf_map_create(BPF_MAP_TYPE_ARRAY, "tmpl", 4, 4, 1, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn test_map_excl_no_map_iter() {
    ...
    struct bpf_iter_bpf_array_map *skel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_map_excl_create_validation() {
    ...
    o.excl_prog_hash = core::ptr::null_mut();
    o.excl_prog_hash_size = SHA256_DIGEST_SIZE;
    fd = bpf_map_create(BPF_MAP_TYPE_ARRAY, "excl", 4, 4, 1, &o);
    if (fd >= 0)
    close(fd);
    ASSERT_EQ(fd, -EINVAL, "reject size with core::ptr::null_mut() hash pointer");
    }
#[no_mangle]
