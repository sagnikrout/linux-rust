...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_field_iter.c
#![no_std]
...
// }
    ...
    let mut str_idx: c_int = 0, id_idx = 0;
...
// ensure no more strings are expected
    ASSERT_EQ(fields[id].strs[str_idx], core::ptr::null_mut(), "field_str_cnt");
