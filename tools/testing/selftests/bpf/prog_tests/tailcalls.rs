...
//! Source: tools/testing/selftests/bpf/prog_tests/tailcalls.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_1() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_2() {
    ...
    bool test_fexit)
    {
    struct bpf_object *obj = core::ptr::null_mut(), *fentry_obj = core::ptr::null_mut(), *fexit_obj = core::ptr::null_mut();
    struct bpf_link *fentry_link = core::ptr::null_mut(), *fexit_link = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_3() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_6() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_4() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_5() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_1() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_2() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_3() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_4(noise: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_6() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_fentry() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_fexit() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_fentry_fexit() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_fentry_entry() {
    static void test_tailcall_bpf2bpf_fentry_entry(void)
    {
    struct bpf_object *tgt_obj = core::ptr::null_mut(), *fentry_obj = core::ptr::null_mut();
    int err, map_fd, prog_fd, data_fd, i, val;
    struct bpf_map *prog_array, *data_map;
    struct bpf_link *fentry_link = core::ptr::null_mut();
    struct bpf_program *prog;
    char buff[128] = {};
    LIBBPF_OPTS(bpf_test_run_opts, topts,
    .data_in = buff,
    ...
    {
    let mut zero: __u32 = 0, prog1_fd, prog2_fd, map_fd;
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_poke() {
    ...
    goto out;
    err = pthread_create(&thread, core::ptr::null_mut(), poke_update, call);
    ...
    poke_thread_exit = 1;
    ASSERT_OK(pthread_join(thread, core::ptr::null_mut()), "pthread_join");
    out:
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_hierarchy_1() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_hierarchy_fentry() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_hierarchy_fexit() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_hierarchy_fentry_fexit() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_hierarchy_fentry_entry() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_hierarchy_2() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_hierarchy_3() {
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_freplace() {
    static void test_tailcall_freplace(void)
    {
    struct tailcall_freplace *freplace_skel = core::ptr::null_mut();
    struct bpf_link *freplace_link = core::ptr::null_mut();
    struct bpf_program *freplace_prog;
    struct tc_bpf2bpf *tc_skel = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_freplace() {
...
// OK to attach then detach freplace prog.
    ...
    freplace_link = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_tailcall_failure() {
    static void test_tailcall_failure()
    {
    RUN_TESTS(tailcall_fail);
    }
#[no_mangle]
unsafe extern "C" fn test_tailcall_cgrp_storage() {
    static void test_tailcall_cgrp_storage(void)
    {
    struct tailcall_cgrp_storage_owner *owner_skel = core::ptr::null_mut();
    struct tailcall_cgrp_storage *skel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_tailcall_cgrp_storage_diff_storage() {
...
#[no_mangle]
unsafe extern "C" fn test_tailcall_cgrp_storage_no_storage() {
    static void test_tailcall_cgrp_storage_no_storage(void)
    {
    struct tailcall_cgrp_storage_owner *owner_skel = core::ptr::null_mut();
    struct tailcall_cgrp_storage_no_storage *skel = core::ptr::null_mut();
    int err, prog_array_fd;
    owner_skel = tailcall_cgrp_storage_owner__open_and_load();
    if (!ASSERT_OK_PTR(owner_skel, "owner_open_and_load"))
    return;
...
#[no_mangle]
unsafe extern "C" fn test_tailcall_cgrp_storage_no_storage_leaf() {
...
#[no_mangle]
unsafe extern "C" fn test_tailcall_cgrp_storage_no_storage_bridge() {
    static void test_tailcall_cgrp_storage_no_storage_bridge(void)
    {
    struct tailcall_cgrp_storage_owner *owner_skel = core::ptr::null_mut();
    struct tailcall_cgrp_storage_no_storage *bridge_skel = core::ptr::null_mut();
    struct tailcall_cgrp_storage *callee_skel = core::ptr::null_mut();
    int err, key = 0, prog_array_fd, prog_fd, storage_map_fd;
    owner_skel = tailcall_cgrp_storage_owner__open_and_load();
    if (!ASSERT_OK_PTR(owner_skel, "owner_open_and_load"))
    return;
...
#[no_mangle]
pub unsafe extern "C" fn uprobe_sleepable_trigger() -> noinline void {
    noinline void uprobe_sleepable_trigger(void)
    {
    asm volatile ("");
    }
#[no_mangle]
unsafe extern "C" fn test_tailcall_sleepable() {
...
#[no_mangle]
unsafe extern "C" fn test_tailcall_callback() {
    static void test_tailcall_callback(void)
    {
    RUN_TESTS(tailcall_callback);
    }
#[no_mangle]
unsafe extern "C" fn test_tailcall_bpf2bpf_fexit_links() {
    static void test_tailcall_bpf2bpf_fexit_links(void)
    {
    struct tailcall_bpf2bpf_fexit *skel1 = core::ptr::null_mut(), *skel2 = core::ptr::null_mut();
