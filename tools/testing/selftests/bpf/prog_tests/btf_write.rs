...
//! Source: tools/testing/selftests/bpf/prog_tests/btf_write.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gen_btf(btf: *mut btf) {
...
// NULL name
    id = btf__add_int(btf, core::ptr::null_mut(), 4, 0);
...
#[no_mangle]
unsafe extern "C" fn test_btf_add() {
...
#[no_mangle]
unsafe extern "C" fn test_btf_add_btf() {
    static void test_btf_add_btf()
    {
    struct btf *btf1 = core::ptr::null_mut(), *btf2 = core::ptr::null_mut();
    int id;
    btf1 = btf__new_empty();
...
#[no_mangle]
unsafe extern "C" fn test_btf_add_btf_split() {
    static void test_btf_add_btf_split()
    {
    struct btf *base = core::ptr::null_mut(), *split1 = core::ptr::null_mut(), *split2 = core::ptr::null_mut();
    struct btf *combined = core::ptr::null_mut();
    int id, err;
...
//
    err = btf__dedup(combined, core::ptr::null_mut());
