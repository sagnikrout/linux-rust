...
//! Source: tools/testing/selftests/bpf/prog_tests/btf.c
#![no_std]
...
pub const MAX_SUBPROGS: c_int = 16;
    let mut duration: static int = 0;
    static bool always_log;

pub const NAME_TBD: c_uint = 0xdeadb33f;

pub const MAX_NR_RAW_U32: c_int = 1024;
pub const BTF_LOG_BUF_SIZE: c_int = 65535;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_raw_test {
    pub descr: *const c_char,
    pub str_sec: *const c_char,
    pub map_name: *const c_char,
    pub err_str: *const c_char,
    pub raw_types: [__u32; MAX_NR_RAW_U32],
    pub str_sec_size: __u32,
    ...
    pub btf_load_err: bool,
    pub map_create_err: bool,
    pub ordered_map: bool,
    pub lossless_map: bool,
    pub percpu_map: bool,
    pub hdr_len_delta: c_int,
    pub type_off_delta: c_int,
    pub str_off_delta: c_int,
    pub str_len_delta: c_int,
    pub mapv_kind: enum pprint_mapv_kind_t,
}
...
//
    ...
    {
    return start < end - 1 ? start + 1 : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn get_raw_sec_size(raw_types: *const __u32) -> c_int {
    ...
    const char **strs_idx = core::ptr::null_mut(), **tmp_strs_idx;
    let mut strs_cap: c_int = 0, strs_cnt = 0, next_str_idx = 0;
    unsigned int size_needed, offset;
    struct btf_header *ret_hdr;
    int i, type_sec_size, err = 0;
    uint32_t *ret_types;
    void *raw_btf = core::ptr::null_mut();
...
// Copy type section
    ...
    let mut idx: c_int = GET_NAME_NTH_IDX(raw_types[i]);
...
// btf_size = size_needed;
    if (ret_next_str)
// ret_next_str =
    next_str_idx < strs_cnt ? strs_idx[next_str_idx] : core::ptr::null_mut();
    done:
    free(strs_idx);
    if (err) {
    free(raw_btf);
...
#[no_mangle]
unsafe extern "C" fn load_raw_btf(raw_data: *const c_void, raw_size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_test_raw(test_num: c_uint) {
    static void do_test_raw(unsigned int test_num)
    {
    struct btf_raw_test *test = &raw_tests[test_num - 1];
    LIBBPF_OPTS(bpf_map_create_opts, opts);
    let mut map_fd: c_int = -1, btf_fd = -1;
    ...
    test.str_sec,
    test.str_sec_size,
    &raw_btf_size, core::ptr::null_mut());
    if (!raw_btf)
    return;
    hdr = raw_btf;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_get_info_test {
    pub descr: *const c_char,
    pub str_sec: *const c_char,
    pub raw_types: [__u32; MAX_NR_RAW_U32],
    pub str_sec_size: __u32,
    pub btf_size_delta: c_int,
    pub test_num): *mut *mut int (special_test)(unsigned int,
}
...
#[no_mangle]
unsafe extern "C" fn test_big_btf_info(test_num: c_uint) -> c_int {
    static int test_big_btf_info(unsigned int test_num)
    {
    const struct btf_get_info_test *test = &get_info_tests[test_num - 1];
    uint8_t *raw_btf = core::ptr::null_mut(), *user_btf = core::ptr::null_mut();
    unsigned int raw_btf_size;
    struct {
...
#[no_mangle]
unsafe extern "C" fn test_btf_id(test_num: c_uint) -> c_int {
    static int test_btf_id(unsigned int test_num)
    {
    const struct btf_get_info_test *test = &get_info_tests[test_num - 1];
    LIBBPF_OPTS(bpf_map_create_opts, opts);
    uint8_t *raw_btf = core::ptr::null_mut(), *user_btf[2] = {};
...
#[no_mangle]
unsafe extern "C" fn do_test_get_info(test_num: c_uint) {
    static void do_test_get_info(unsigned int test_num)
    {
    const struct btf_get_info_test *test = &get_info_tests[test_num - 1];
    unsigned int raw_btf_size, user_btf_size, expected_nbytes;
    uint8_t *raw_btf = core::ptr::null_mut(), *user_btf = core::ptr::null_mut();
    let mut info: bpf_btf_info = {};
    let mut btf_fd: c_int = -1, err, ret;
    uint32_t info_len;
    if (!test__start_subtest(test.descr))
    return;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_file_test {
    pub file: *const c_char,
    pub btf_kv_notfound: bool,
}
...
#[no_mangle]
unsafe extern "C" fn do_test_file(test_num: c_uint) {
    ...
    let mut has_btf_ext: bool = false;
    struct btf *btf = core::ptr::null_mut();
    void *func_info = core::ptr::null_mut();
    struct bpf_map *map;
    int i, err, prog_fd;
    ...
    btf__free(btf);
    has_btf_ext = btf_ext != core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pprint_mapv_int128 {
    pub si128a: __int128,
    pub si128b: __int128,
    pub bits3:3: unsigned __int128,
    pub bits80:80: unsigned __int128,
    pub ui128: unsigned __int128,
}
...
#[no_mangle]
unsafe extern "C" fn get_pprint_mapv_size(mapv_kind: enum pprint_mapv_kind_t) -> usize {
    ...
    int cpu, void *mapv)
    {
    let mut nexpected_line: isize = -1;
    if (mapv_kind == PPRINT_MAPV_KIND_BASIC) {
    struct pprint_mapv *v = mapv;
...
#[no_mangle]
unsafe extern "C" fn do_test_pprint(test_num: c_int) {
    static void do_test_pprint(int test_num)
    {
    const struct btf_raw_test *test = &pprint_test_template[test_num];
    let mut mapv_kind: enum pprint_mapv_kind_t = test.mapv_kind;
    LIBBPF_OPTS(bpf_map_create_opts, opts);
    ...
    FILE *pin_file = core::ptr::null_mut();
    char pin_path[255];
    let mut line_len: usize = 0;
    char *line = core::ptr::null_mut();
    void *mapv = core::ptr::null_mut();
    uint8_t *raw_btf;
    ssize_t nread;
    if (!test__start_subtest(test.descr))
    return;
...
#[no_mangle]
unsafe extern "C" fn test_pprint() {
...
#[no_mangle]
unsafe extern "C" fn probe_prog_length(fp: *const bpf_insn) -> usize {
    ...
    __u32 *new_u32 = core::ptr::null_mut();
    if (raw_u32_size == -1)
...
// reset info to only retrieve func_info related data
    ...
    __u64 *jited_linfo = core::ptr::null_mut(), *jited_ksyms = core::ptr::null_mut();
    __u32 rec_size, jited_rec_size, jited_cnt;
    struct bpf_line_info *linfo = core::ptr::null_mut();
    __u32 cur_func_len, ksyms_found;
    let mut info: bpf_prog_info = {};
    __u32 *jited_func_lens = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn do_test_info_raw(test_num: c_uint) {
    static void do_test_info_raw(unsigned int test_num)
    {
    const struct prog_info_raw_test *test = &info_raw_tests[test_num - 1];
    unsigned int raw_btf_size, linfo_str_off, linfo_size = 0;
    let mut btf_fd: c_int = -1, prog_fd = -1, err = 0;
    void *raw_btf, *patched_linfo = core::ptr::null_mut();
    const char *ret_next_str;
    let mut attr: union bpf_attr = {};
    if (!test__start_subtest(test.descr))
    return;
    raw_btf = btf_raw_create(&hdr_tmpl, test.raw_types,
    test.str_sec, test.str_sec_size,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_dedup_test {
    pub descr: *const c_char,
    pub input: btf_raw_data,
    pub expect: btf_raw_data,
...
#[no_mangle]
unsafe extern "C" fn btf_type_size(t: *const btf_type) -> c_int {
    static int btf_type_size(const struct btf_type *t)
    {
    let mut base_size: c_int = sizeof(struct btf_type);
    let mut vlen: __u32 = BTF_INFO_VLEN(t.info);
    let mut kind: __u16 = BTF_INFO_KIND(t.info);
    switch (kind) {
    case BTF_KIND_FWD:
    case BTF_KIND_CONST:
...
#[no_mangle]
unsafe extern "C" fn dump_btf_strings(strs: *const c_char, len: __u32) {
...
#[no_mangle]
pub unsafe extern "C" fn test_btf() {
    void test_btf(void)
    {
    int i;
