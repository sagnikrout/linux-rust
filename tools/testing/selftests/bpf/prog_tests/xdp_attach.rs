...
#[no_mangle]
unsafe extern "C" fn test_xdp_attach(file: *const c_char) {
    static void test_xdp_attach(const char *file)
    {
    let mut duration: __u32 = 0, id1, id2, id0 = 0, len;
...
#[no_mangle]
unsafe extern "C" fn on_xdp_errmsg(ctx: *mut c_void, cpu: c_int, data: *mut c_void, size: __u32) {
...
#[no_mangle]
unsafe extern "C" fn test_xdp_attach_fail(file: *const c_char) {
    static void test_xdp_attach_fail(const char *file)
    {
    struct test_xdp_attach_fail *skel = core::ptr::null_mut();
...
// set up perf buffer
    ...
    on_xdp_errmsg, core::ptr::null_mut(), &errmsg, core::ptr::null_mut());
