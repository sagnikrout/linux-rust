...
//! Source: tools/testing/selftests/bpf/prog_tests/migrate_reuseport.c
#![no_std]
...
pub const NR_SERVERS: c_int = 5;

// fastopenq->max_qlen and sk->sk_max_ack_backlog

pub const MSGLEN: c_int = 12;
...
#[no_mangle]
unsafe extern "C" fn init_fds(fds[]: __s64, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn close_fds(fds[]: __s64, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn setup_fastopen(buf: *mut c_char, size: c_int, saved_len: *mut c_int, restore: bool) -> c_int {
    static int setup_fastopen(char *buf, int size, int *saved_len, bool restore)
    {
    let mut err: c_int = 0, fd, len;
...
#[no_mangle]
unsafe extern "C" fn pass_ack(test_case: *mut migrate_reuseport_test_case) -> c_int {
    ...
    return -1;
    test_case.link = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn start_clients(test_case: *mut migrate_reuseport_test_case) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn migrate_dance(test_case: *mut migrate_reuseport_test_case) -> c_int {
    static int migrate_dance(struct migrate_reuseport_test_case *test_case)
    {
    struct epoll_event ev = {
    .events = EPOLLIN,
    };
    let mut epoll: c_int = -1, nfds;
    int i, err;
