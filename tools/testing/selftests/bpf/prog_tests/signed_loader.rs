...
//! Source: tools/testing/selftests/bpf/prog_tests/signed_loader.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn close_loader_ctx_fds(ctx: *mut c_void, nr_maps: c_int, nr_progs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn run_setup(cmd: *const c_char, dir: *const c_char) -> c_int {
    ...
    key, key, data_tmpl, core::ptr::null_mut());
    exit(1);
    }
    if (waitpid(pid, &status, 0) < 0 ||
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gen_loader_fixture {
    pub skel: *mut test_signed_loader,
    pub gopts: gen_loader_opts,
    ...
    pub nr_maps: c_int,
    pub nr_progs: c_int,
    pub excl: [__u8; SHA256_DIGEST_LENGTH],
}

#[no_mangle]
unsafe extern "C" fn gen_loader_fixture_init(f: *mut gen_loader_fixture) -> c_int {
    static int gen_loader_fixture_init(struct gen_loader_fixture *f)
    {
    LIBBPF_OPTS(gen_loader_opts, gopts, .gen_hash = true);
    let mut nr_maps: c_int = 0, nr_progs = 0;
...
#[no_mangle]
unsafe extern "C" fn gen_loader_fixture_fini(f: *mut gen_loader_fixture) {
...
#[no_mangle]
unsafe extern "C" fn metadata_match() {
    ...
    f.data_sz, f.excl, sizeof(f.excl), core::ptr::null_mut(), 0,
    f.ctx, f.ctx_sz, &ran);
...
#[no_mangle]
unsafe extern "C" fn signature_enforced() {
...
#[no_mangle]
unsafe extern "C" fn signed_nonexcl_fd_array_rejected() {
...
#[no_mangle]
unsafe extern "C" fn signed_unfrozen_fd_array_rejected() {
...
#[no_mangle]
unsafe extern "C" fn signed_nonarray_fd_array_rejected() {
...
#[no_mangle]
unsafe extern "C" fn signed_btf_fd_array_rejected() {
    static void signed_btf_fd_array_rejected(void)
    {
    char dir_tmpl[] = "/tmp/signed_loader_btfXXXXXX", *dir = core::ptr::null_mut();
    let mut sig_sz: __u32 = 8192;
    let mut map_fd: c_int = -1, prog_fd = -1;
    unsigned char *buf = core::ptr::null_mut();
    struct gen_loader_fixture f;
    let mut have_fixture: bool = false;
...
#[no_mangle]
unsafe extern "C" fn signature_failure_logs() {
...
#[no_mangle]
unsafe extern "C" fn signature_too_large() {
...
#[no_mangle]
unsafe extern "C" fn signature_zero_size() {
...
#[no_mangle]
unsafe extern "C" fn signature_bad_keyring() {
...
//
pub const GATING_BOGUS_MAX: c_uint = 0x4000;
#[no_mangle]
unsafe extern "C" fn metadata_ctx_max_entries_ignored() {
    static void metadata_ctx_max_entries_ignored(void)
    {
    LIBBPF_OPTS(gen_loader_opts, gopts, .gen_hash = true);
    struct test_signed_loader_map *skel;
    __u8 excl[SHA256_DIGEST_LENGTH];
    let mut nr_maps: c_int = 0, nr_progs = 0, i, checked = 0, r;
    struct bpf_program *p;
    struct bpf_map *m;
    ...
    excl, sizeof(excl), core::ptr::null_mut(), 0, ctx, ctx_sz, &ran);
...
//
pub const DATA_MAGIC: c_uint = 0x5eed1234abad1deaULL;
#[no_mangle]
unsafe extern "C" fn metadata_ctx_initial_value_ignored() {
    ...
    let mut nr_maps: c_int = 0, nr_progs = 0, i, found = 0, r;
    struct bpf_program *p;
    struct bpf_map *m;
    struct bpf_map_desc *md;
    unsigned char *blob;
    ...
    for (i = 0; i < nr_maps; i++) {
    struct bpf_map_info info;
    let mut ilen: __u32 = sizeof(info), key = 0;
    __u8 value[64] = {};
    __u64 got;
    let mut fd: c_int = md[i].map_fd;
    if (fd <= 0)
...
//
#[no_mangle]
unsafe extern "C" fn signature_authenticates_insns() {
    static void signature_authenticates_insns(void)
    {
    LIBBPF_OPTS(gen_loader_opts, gopts, .gen_hash = true);
    char dir_tmpl[] = "/tmp/signed_loaderXXXXXX", *dir;
    struct test_signed_loader *skel = core::ptr::null_mut();
    __u8 excl[SHA256_DIGEST_LENGTH], sig[8192];
    let mut sig_sz: __u32 = sizeof(sig), insns_sz, data_sz, ctx_sz;
    unsigned char *insns = core::ptr::null_mut(), *tampered = core::ptr::null_mut(), *blob = core::ptr::null_mut();
    unsigned char *signbuf = core::ptr::null_mut();
    let mut nr_maps: c_int = 0, nr_progs = 0, r;
    struct bpf_program *p;
    struct bpf_map *m;
...
#[no_mangle]
unsafe extern "C" fn signature_authenticates_metadata() {
    ...
    __u8 excl[SHA256_DIGEST_LENGTH], sig[8192];
    let mut sig_sz: __u32 = sizeof(sig), insns_sz, data_sz, ctx_sz;
    unsigned char *insns = core::ptr::null_mut(), *blob = core::ptr::null_mut();
    unsigned char *signbuf = core::ptr::null_mut();
    let mut nr_maps: c_int = 0, nr_progs = 0, r;
    struct bpf_program *p;
    struct bpf_map *m;
...
#[no_mangle]
unsafe extern "C" fn make_excl_map(flags: __u32, value_size: __u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hash_requires_frozen() {
...
#[no_mangle]
unsafe extern "C" fn no_update_after_freeze() {
...
#[no_mangle]
unsafe extern "C" fn freeze_writable_mmap() {
    ...
    return;
    w = mmap(core::ptr::null_mut(), 4096, PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0);
...
#[no_mangle]
unsafe extern "C" fn no_writable_mmap_frozen() {
...
#[no_mangle]
unsafe extern "C" fn map_hash_matches_libbpf() {
...
//
    ...
    val[i] = i * 7 + 1;
    fd = bpf_map_create(BPF_MAP_TYPE_ARRAY, "h", 4, sizeof(val), 1, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn map_hash_multi_element() {
    static void map_hash_multi_element(void)
    {
    let mut nr: __u32 = 8, value_size = 64;
...
//
    fd = bpf_map_create(BPF_MAP_TYPE_ARRAY, "h", 4, value_size, nr, core::ptr::null_mut());
    if (!ASSERT_OK_FD(fd, "array_map"))
    return;
...
#[no_mangle]
unsafe extern "C" fn map_hash_bad_size() {
...
#[no_mangle]
unsafe extern "C" fn map_hash_unsupported_type() {
...
// Only arrays implement map_get_hash; a hash map must be refused.
    fd = bpf_map_create(BPF_MAP_TYPE_HASH, "h", 4, 8, 4, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn setup_meta_map(f: *const gen_loader_fixture) -> c_int {
    static int setup_meta_map(const struct gen_loader_fixture *f)
    {
    LIBBPF_OPTS(bpf_map_create_opts, mopts,
...
#[no_mangle]
unsafe extern "C" fn lsm_signature_verdict() {
    static void lsm_signature_verdict(void)
    {
    char dir_tmpl[] = "/tmp/signed_loader_lsmXXXXXX", *dir = core::ptr::null_mut();
    struct test_signed_loader_lsm *lsm = core::ptr::null_mut();
    let mut sig_sz: __u32 = 8192, msig_sz = 8192;
    let mut map_fd: c_int = -1, prog_fd = -1;
    let mut have_fixture: bool = false;
    struct gen_loader_fixture f;
    unsigned char *buf;
    ...
    goto out;
    lsm.bss.seen = 0;
    prog_fd = load_loader(f.gopts.insns, f.gopts.insns_sz, map_fd, core::ptr::null_mut(), 0, 0, 0);
    close(map_fd);
    map_fd = -1;
...
//
    ...
    let mut sig_sz: __u32 = 8192, key = 0;
    unsigned char *buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn loadtime_verify(obj: *mut bpf_object, expect_maps: c_int) {
    static void loadtime_verify(struct bpf_object *obj, int expect_maps)
    {
    LIBBPF_OPTS(gen_loader_opts, gopts, .gen_hash = true);
    char dir_tmpl[] = "/tmp/signed_loader_ltXXXXXX", *dir = core::ptr::null_mut();
    let mut nr_maps: c_int = 0, nr_progs = 0, load_ret = 0, r;
    __u8 excl[SHA256_DIGEST_LENGTH];
    struct bpf_prog_desc *pd;
    struct bpf_map_desc *md;
    unsigned char *blob = core::ptr::null_mut();
    struct bpf_program *p;
    struct bpf_map *m;
    __u32 ctx_sz, data_sz;
    void *ctx = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn loadtime_no_map() {
...
#[no_mangle]
unsafe extern "C" fn loadtime_with_map() {
...
//
#[no_mangle]
unsafe extern "C" fn signed_no_fd_array() {
...
//
#[no_mangle]
unsafe extern "C" fn signed_map_by_fd_rejected() {
    ...
    map_fd = bpf_map_create(BPF_MAP_TYPE_ARRAY, "sig_mapfd", 4, 4, 1, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn signed_sparse_fd_array_rejected() {
    ...
    __u8 sig[8192];
    int map_fd, prog_fd, err;
    map_fd = bpf_map_create(BPF_MAP_TYPE_ARRAY, "sig_sparse", 4, 4, 1, core::ptr::null_mut());
    if (!ASSERT_GE(map_fd, 0, "map_create"))
    return;
    syscall(__NR_request_key, "keyring", "_uid.0", core::ptr::null_mut(),
    KEY_SPEC_SESSION_KEYRING);
...
#[no_mangle]
unsafe extern "C" fn signed_module_kfunc_rejected() {
