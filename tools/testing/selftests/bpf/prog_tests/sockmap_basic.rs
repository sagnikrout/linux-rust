...
//! Source: tools/testing/selftests/bpf/prog_tests/sockmap_basic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn connected_socket_v4() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compare_cookies(src: *mut bpf_map, dst: *mut bpf_map) {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_create_update_free(map_type: enum bpf_map_type) {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_vsock_delete_on_close() {
    static void test_sockmap_vsock_delete_on_close(void)
    {
    int map, c, p, err, zero = 0;
    map = bpf_map_create(BPF_MAP_TYPE_SOCKMAP, core::ptr::null_mut(), sizeof(int),
...
#[no_mangle]
unsafe extern "C" fn test_skmsg_helpers(map_type: enum bpf_map_type) {
...
#[no_mangle]
unsafe extern "C" fn test_skmsg_helpers_with_link(map_type: enum bpf_map_type) {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_invalid_update() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_copy(map_type: enum bpf_map_type) {
    ...
    __s64 *sock_fd = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_attach_with_link() {
...
#[no_mangle]
unsafe extern "C" fn query_prog_id(prog_fd: c_int) -> __u32 {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_progs_query(attach_type: enum bpf_attach_type) {
...
pub const MAX_EVENTS: c_int = 10;
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_shutdown() {
...
#[no_mangle]
unsafe extern "C" fn do_test_sockmap_skb_verdict_fionread(sotype: c_int, pass_prog: bool) {
    static void do_test_sockmap_skb_verdict_fionread(int sotype, bool pass_prog)
    {
    int err, map, verdict, c0 = -1, c1 = -1, p0 = -1, p1 = -1;
    int expected, zero = 0, sent, recvd, avail;
    struct test_sockmap_pass_prog *pass = core::ptr::null_mut();
    struct test_sockmap_drop_prog *drop = core::ptr::null_mut();
    char buf[256] = "0123456789";
    let mut split_len: c_int = sizeof(buf) / 2;
    if (pass_prog) {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_fionread(pass_prog: bool) {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_change_tail() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_msg_verdict_pop_data() {
    static void test_sockmap_msg_verdict_pop_data(void)
    {
    struct test_sockmap_msg_pop_data *skel;
    int err, map, verdict;
    let mut c1: c_int = -1, p1 = -1, sent;
    let mut zero: c_int = 0;
    char *buf;
    let mut len: usize = 32 * 1024;
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_peek_helper(map: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_peek() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_peek_with_link() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_unconnected_unix() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_many_socket() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_many_maps() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_same_sock() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_skb_verdict_vsock_poll() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_vsock_unconnected() {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_zc() {
    static void test_sockmap_zc(void)
    {
    int map, err, sent, recvd, zero = 0, one = 1, on = 1;
    char buf[10] = "0123456789", rcv[11], addr[100];
    struct test_sockmap_pass_prog *skel = core::ptr::null_mut();
    let mut c0: c_int = -1, p0 = -1, c1 = -1, p1 = -1;
    struct tcp_zerocopy_receive zc;
    let mut zc_len: socklen_t = sizeof(zc);
    struct bpf_program *prog;
    skel = test_sockmap_pass_prog__open_and_load();
    if (!ASSERT_OK_PTR(skel, "open_and_load"))
    return;
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_copied_seq(strp: bool) {
...
#[no_mangle]
unsafe extern "C" fn wait_for_fionread(fd: c_int, expected: c_int, timeout_ms: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_sockmap_multi_channels(sotype: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn test_sockmap_no_verdict_fionread() {
    static void test_sockmap_no_verdict_fionread(void)
    {
    int err, map, zero = 0, sent, avail;
    let mut c0: c_int = -1, c1 = -1, p0 = -1, p1 = -1;
    struct test_sockmap_pass_prog *skel;
    char buf[256] = "0123456789";
    skel = test_sockmap_pass_prog__open_and_load();
    if (!ASSERT_OK_PTR(skel, "open_and_load"))
