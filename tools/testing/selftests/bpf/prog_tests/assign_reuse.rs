...
//! Source: tools/testing/selftests/bpf/prog_tests/assign_reuse.c
#![no_std]
...
pub const PORT: c_int = 4443;
#[no_mangle]
unsafe extern "C" fn attach_reuseport(sock_fd: c_int, prog_fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cookie(fd: c_int) -> __u64 {
...
#[no_mangle]
unsafe extern "C" fn echo_test_tcp(fd_sv: c_int) -> c_int {
    static int echo_test_tcp(int fd_sv)
    {
    char buff[1] = {};
    let mut fd_cl: c_int = -1, fd_sv_cl = -1;
    fd_cl = connect_to_fd(fd_sv, 100);
    if (fd_cl < 0)
    return errno;
...
#[no_mangle]
pub unsafe extern "C" fn run_assign_reuse(family: c_int, sotype: c_int, ip: *const c_char, port: __u16) {
    ...
    if (!ASSERT_NEQ(fd_sv, core::ptr::null_mut(), "start_reuseport_server"))
    goto cleanup;
