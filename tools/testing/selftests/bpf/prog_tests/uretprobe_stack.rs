...
//! Source: tools/testing/selftests/bpf/prog_tests/uretprobe_stack.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn target_4() -> __weak int {
...
#[no_mangle]
pub unsafe extern "C" fn target_3() -> __weak int {
...
#[no_mangle]
pub unsafe extern "C" fn target_2() -> __weak int {
...
#[no_mangle]
pub unsafe extern "C" fn target_1(depth: c_int) -> __weak int {
...
#[no_mangle]
unsafe extern "C" fn validate_stack(ips: *mut __u64, stack_len: c_int, cnt: c_int, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn test_uretprobe_stack() -> __weak void {
