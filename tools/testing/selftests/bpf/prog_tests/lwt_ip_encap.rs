...
//! Source: tools/testing/selftests/bpf/prog_tests/lwt_ip_encap.c
#![no_std]
...
pub const NETNS_NAME_SIZE: c_int = 32;
...
//
#[no_mangle]
unsafe extern "C" fn create_ns(name: *mut c_char, name_sz: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_top_addr(ns1: *const c_char, ns2: *const c_char, ns3: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_bottom_addr(ns1: *const c_char, ns2: *const c_char, ns3: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configure_vrf(ns1: *const c_char, ns2: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configure_ns1(ns1: *const c_char, vrf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configure_ns2(ns2: *const c_char, vrf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configure_ns3(ns3: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_network(ns1: *mut c_char, ns2: *mut c_char, ns3: *mut c_char, vrf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_routes_to_gredev(ns1: *const c_char, ns2: *const c_char, vrf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_unreachable_routes_to_gredev(ns1: *const c_char, ns2: *const c_char, vrf: *const c_char) -> c_int {
...
pub const GSO_SIZE: c_int = 5000;
pub const GSO_TCP_PORT: c_int = 9000;
// This tests the fix from commit ea0371f78799 ("net: fix GSO in bpf_lwt_push_ip_encap")
#[no_mangle]
unsafe extern "C" fn test_gso_fix(ns1: *const c_char, ns3: *const c_char, family: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_ping_ok(ns1: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_ping_fails(ns1: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lwt_ip_encap(ipv4_encap: bool, egress: bool, vrf: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn setup_vxlan_routes(ns3: *const c_char, ns1: *const c_char, ns2: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lwt_ip_encap_vxlan(ipv4_encap: bool) {
    ...
    struct test_lwt_ip_encap *skel = core::ptr::null_mut();
    int thdr_offset, err;
    if (!ASSERT_OK(create_ns(ns1, NETNS_NAME_SIZE), "create ns1"))
    goto out;
    if (!ASSERT_OK(create_ns(ns2, NETNS_NAME_SIZE), "create ns2"))
