...
//! Source: tools/testing/selftests/bpf/libarena/selftests/test_parallel_spmc.bpf.c
#![no_std]
...
pub const TEST_SPMC_THREADS: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn spmc_tests_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn spmc_common_init(total: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_common_fini() -> c_int {
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn spmc_quiesce_on_owner(epoch: u64) -> c_int {
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn spmc_quiesce_on_stealer(epoch: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_update_stats(val: u64, owner: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_validate_owner_empty() -> c_int {
...
// Change a 0 return value into -EINVAL.
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn spmc_validate_all_seen() -> c_int {
...
//
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn spmc_singleval_tryconsume(expected: u64, steal: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_singleval_owner() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_singleval_stealer() -> c_int {
...
//
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn spmc_wait_for_stealers_to_start(target: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_resize_owner() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_resize_stealer() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_wait_for_round_steals(target: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_burst_owner() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmc_burst_stealer() -> c_int {
