...
//! Source: tools/testing/selftests/bpf/libarena/src/rbtree.bpf.c
#![no_std]
...
//
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_destroy(rbtree: *mut rbtree __arena) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rbnode_dir(node: *mut rbnode __arena) -> c_int {
...
// Put the node below the new root.
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_find(rbtree: *mut rbtree __arena, key: u64, value: *mut u64) -> c_int {
...
// value = node->value;
    ...
    {
    struct rbnode __arena *rbnode = core::ptr::null_mut();
...
//
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_node_free(rbnode: *mut rbnode __arena) {
...
//
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_insert(rbtree: *mut rbtree __arena, key: u64, value: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rb_least(rbtree: *mut rbtree __arena, key: *mut u64, value: *mut u64) -> __weak int {
...
#[no_mangle]
pub unsafe extern "C" fn rbnode_has_red_children(node: *mut rbnode __arena) -> bool {
    ...
    let mut free: bool = (rbtree.alloc == RB_ALLOC);
...
// Check that we're _actually_ the root.
    ...
    dir = rbnode_dir(node);
    parent.child[dir] = core::ptr::null_mut();
    is_red = node.is_red;
    if (free)
    rb_node_free(node);
...
//
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_remove(rbtree: *mut rbtree __arena, key: u64) -> c_int {
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_pop(rbtree: *mut rbtree __arena, key: *mut u64, value: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rbnode_print(depth: usize, rbn: *mut rbnode __arena) {
...
// next = 0;
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_print_pop_up(rbnodep: *mut rbnode __arena, depthp: *mut u8, (*stack)[RB_MAXLVL_PRINT]: *mut enum rb_print_state, state: *mut enum rb_print_state) -> c_int {
...
// depthp = depth;
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_print(rbtree: *mut rbtree __arena) -> c_int {
...
// Otherwise, go as far up as possible.
    ...
    __weak
#[no_mangle]
pub unsafe extern "C" fn rb_integrity_check(rbtree: *mut rbtree __arena) -> c_int {
    int rb_integrity_check(struct rbtree __arena *rbtree)
    {
    enum rb_print_state stack[RB_MAXLVL_PRINT];
    struct rbnode __arena *rbnode = rbtree.root;
...
// Even with can_loop, the verifier doesn't like infinite loops.
    ...
    } else if (rbnode.parent && rbnode.parent.child[1 - rbnode_dir(rbnode)] == core::ptr::null_mut()) {
