...
//! Source: tools/testing/selftests/futex/functional/futex_wait.c
#![no_std]
...
pub const timeout_ns: c_int = 30000000;
...
// Testing a private futex
    ...
    ASSERT_EQ(pthread_create(&waiter, core::ptr::null_mut(), waiterfn, args), 0)
...
// Testing an anon page shared memory
    ...
    shared_data = shmat(shm_id, core::ptr::null_mut(), 0);
...
// Testing a file backed shared memory
    ...
    shm = mmap(core::ptr::null_mut(), sizeof(f_private), PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0);
    if (shm == MAP_FAILED) {
    free(args);
    close(fd);
