...
//! Source: tools/testing/selftests/futex/functional/futex_numa_mpol.c
#![no_std]
...
pub const FUTEX2_MPOL: c_uint = 0x08;
    ...
    ret = futex2_wait(args.futex_ptr, 0, args.flags, core::ptr::null_mut(), 0);
    args.result = ret;
    return core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn create_max_threads(_metadata: *mut __test_metadata, futex_ptr: *mut c_void) {
    ...
    ret = pthread_create(&threads[i], core::ptr::null_mut(), thread_lock_fn, &thread_args[i]);
    ASSERT_EQ(ret, 0)
...
unsafe extern "C" fn join_max_threads(_metadata: *mut __test_metadata) {
    ...
    {
    int to_wake, ret, i;
    pthread_barrier_init(&barrier_main, core::ptr::null_mut(), MAX_THREADS + 1);
...
#[no_mangle]
unsafe extern "C" fn test_futex(_metadata: *mut __test_metadata, futex_ptr: *mut c_void, err_value: c_int) {
    ...
    futex_ptr = mmap(core::ptr::null_mut(), mem_size * 2, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, 0, 0);
