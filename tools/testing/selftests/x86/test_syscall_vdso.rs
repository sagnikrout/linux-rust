...
//! Source: tools/testing/selftests/x86/test_syscall_vdso.c
#![no_std]
...
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char, envp: *mut c_char) -> c_int {
    ...
    long syscall_addr;
#[no_mangle]
pub unsafe extern "C" fn get_syscall(envp: *mut c_char) -> c_long {
...
#[derive(Copy, Clone)]
pub struct regs64 {
    pub rdx: uint64_t rax, rbx, rcx,,
    pub rsp: uint64_t rsi, rdi, rbp,,
    pub r11: uint64_t r8, r9, r10,,
    pub r15: uint64_t r12, r13, r14,,
}
...
#[no_mangle]
pub unsafe extern "C" fn print_regs64() {
...
#[no_mangle]
pub unsafe extern "C" fn check_regs64() -> c_int {
    int check_regs64(void)
    {
    let mut err: c_int = 0;
    let mut num: c_int = 8;
    uint64_t *r64 = &regs64.r8;
    let mut expected: u64 = 0x7f7f7f7f7f7f7f7fULL;
    if (!kernel_is_64bit)
    return 0;
    do {
    if (*r64 == expected++)
...
#[no_mangle]
pub unsafe extern "C" fn prep_args() {
    void prep_args()
    {
    nfds = 42;
    FD_ZERO(&rfds);
...
#[no_mangle]
unsafe extern "C" fn print_flags(name: *const c_char, r: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn run_syscall() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn run_syscall_twice() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptrace_me() {
    void ptrace_me()
    {
    pid_t pid;
