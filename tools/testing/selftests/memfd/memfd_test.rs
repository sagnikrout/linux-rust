...
//! Source: tools/testing/selftests/memfd/memfd_test.c
#![no_std]
...
pub const F_SEAL_EXEC: c_uint = 0x0020;
...
//
pub const SEM_KEY: c_uint = 0xdeadbeef;
//
...
#[no_mangle]
unsafe extern "C" fn fd2name(fd: c_int, buf: *mut c_char, bufsize: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn sysctl_assert_write(val: *const c_char) {
    static void sysctl_assert_write(const char *val)
    {
    let mut fd: c_int = open("/proc/sys/vm/memfd_noexec", O_WRONLY | O_CLOEXEC);
    if (fd < 0) {
...
#[no_mangle]
unsafe extern "C" fn sysctl_fail_write(val: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn sysctl_assert_equal(val: *const c_char) {
    static void sysctl_assert_equal(const char *val)
    {
    char *p, buf[128] = {};
    let mut fd: c_int = open("/proc/sys/vm/memfd_noexec", O_RDONLY | O_CLOEXEC);
    if (fd < 0) {
    printf("open sysctl failed: %m\n");
    abort();
    }
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_reopen_fd(fd_in: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_new(name: *const c_char, flags: c_uint) {
    ...
    name ? name : "core::ptr::null_mut()", flags);
    close(r);
    abort();
    }
    }
#[no_mangle]
unsafe extern "C" fn mfd_assert_get_seals(fd: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_has_seals(fd: c_int, seals: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_add_seals(fd: c_int, seals: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_add_seals(fd: c_int, seals: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_size(fd: c_int, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_dup(fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_open(fd: c_int, flags: c_int, mode: mode_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_open(fd: c_int, flags: c_int, mode: mode_t) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_read(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_read_shared(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_fork_private_write(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_write(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_write(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_shrink(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_shrink(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_grow(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_grow(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_grow_write(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_grow_write(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_mode(fd: c_int, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_assert_chmod(fd: c_int, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mfd_fail_chmod(fd: c_int, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn idle_thread_fn(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spawn_thread(flags: c_uint, ): *mut *mut int (fn)(void, arg: *mut c_void) -> pid_t {
...
#[no_mangle]
unsafe extern "C" fn join_thread(pid: pid_t) {
...
#[no_mangle]
unsafe extern "C" fn spawn_idle_thread(flags: c_uint) -> pid_t {
    static pid_t spawn_idle_thread(unsigned int flags)
    {
    return spawn_thread(flags, idle_thread_fn, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn join_idle_thread(pid: pid_t) {
...
//
#[no_mangle]
unsafe extern "C" fn test_create() {
    ...
    printf("%s CREATE\n", memfd_str);
// test NULL name
    mfd_fail_new(core::ptr::null_mut(), 0);
...
//
#[no_mangle]
unsafe extern "C" fn test_seal_write() {
...
//
#[no_mangle]
unsafe extern "C" fn test_seal_future_write() {
...
#[no_mangle]
unsafe extern "C" fn test_seal_write_map_read_shared() {
...
//
#[no_mangle]
unsafe extern "C" fn test_seal_shrink() {
...
//
#[no_mangle]
unsafe extern "C" fn test_seal_grow() {
...
//
#[no_mangle]
unsafe extern "C" fn test_seal_resize() {
...
//
#[no_mangle]
unsafe extern "C" fn test_exec_seal() {
...
//
#[no_mangle]
unsafe extern "C" fn test_exec_no_seal() {
...
//
#[no_mangle]
unsafe extern "C" fn test_noexec_seal() {
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_sysctl0() {
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_set_sysctl0() {
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_sysctl1() {
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_set_sysctl1() {
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_sysctl2() {
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_set_sysctl2() {
...
#[no_mangle]
unsafe extern "C" fn sysctl_simple_child(arg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_sysctl_simple() {
    static void test_sysctl_simple(void)
    {
    let mut pid: c_int = spawn_thread(CLONE_NEWPID, sysctl_simple_child, core::ptr::null_mut());
    join_thread(pid);
    }
#[no_mangle]
unsafe extern "C" fn sysctl_nested(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysctl_nested_wait(arg: *mut c_void) -> c_int {
    static int sysctl_nested_wait(void *arg)
    {
    let mut sem: c_int = semget(SEM_KEY, 1, 0600);
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_sysctl1_failset() {
...
#[no_mangle]
unsafe extern "C" fn test_sysctl_sysctl2_failset() {
...
#[no_mangle]
unsafe extern "C" fn sysctl_nested_child(arg: *mut c_void) -> c_int {
...
// A further nested pidns works the same.
    pid = spawn_thread(CLONE_NEWPID, sysctl_simple_child, core::ptr::null_mut());
    join_thread(pid);
...
//
#[no_mangle]
unsafe extern "C" fn test_sysctl_nested() {
    static void test_sysctl_nested(void)
    {
    let mut pid: c_int = spawn_thread(CLONE_NEWPID, sysctl_nested_child, core::ptr::null_mut());
    join_thread(pid);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn test_share_dup(banner: *mut c_char, b_suffix: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn test_share_mmap(banner: *mut c_char, b_suffix: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn test_share_open(banner: *mut c_char, b_suffix: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn test_share_fork(banner: *mut c_char, b_suffix: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn pid_ns_supported() -> bool {
