...
//! Source: tools/testing/selftests/namespaces/nsid_test.c
#![no_std]
...
//
    ...
    waitpid(self.grandchild_pid, core::ptr::null_mut(), 0);
    }
    if (self.child_pid > 0) {
    kill(self.child_pid, SIGKILL);
    waitpid(self.child_pid, core::ptr::null_mut(), 0);
    }
    }
...
// Verify we can get the same ID again
    ...
    {
    let mut parent_mnt_ns_id: __u64 = 0;
    let mut child_mnt_ns_id: __u64 = 0;
...
// Verify we can get the same ID again
    ...
    {
    let mut parent_cgroup_ns_id: __u64 = 0;
    let mut child_cgroup_ns_id: __u64 = 0;
...
// Verify we can get the same ID again
    ...
    {
    let mut parent_ipc_ns_id: __u64 = 0;
    let mut child_ipc_ns_id: __u64 = 0;
...
// Verify we can get the same ID again
    ...
    {
    let mut parent_uts_ns_id: __u64 = 0;
    let mut child_uts_ns_id: __u64 = 0;
...
// Verify we can get the same ID again
    ...
    {
    let mut parent_user_ns_id: __u64 = 0;
    let mut child_user_ns_id: __u64 = 0;
