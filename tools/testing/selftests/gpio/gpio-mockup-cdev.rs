...
//! Source: tools/testing/selftests/gpio/gpio-mockup-cdev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_value_v2(lfd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_value_v1(lfd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_signal() -> c_int {
