...
//! Source: tools/testing/selftests/resctrl/resctrl_tests.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn detect_vendor() -> c_uint {
    static unsigned int detect_vendor(void)
    {
    static unsigned int vendor_id;
    static bool initialized;
    char *s = core::ptr::null_mut();
    FILE *inf;
    char *res;
    if (initialized)
    return vendor_id;
...
#[no_mangle]
pub unsafe extern "C" fn if(!strcmp(s: s &&, AuthenticAMD\n"): ":) -> else {
    else if (s && !strcmp(s, ": AuthenticAMD\n"))
    vendor_id = ARCH_AMD;
#[no_mangle]
pub unsafe extern "C" fn if(!strcmp(s: s &&, HygonGenuine\n"): ":) -> else {
...
#[no_mangle]
unsafe extern "C" fn test_prepare(test: *const resctrl_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_cleanup(test: *const resctrl_test) {
...
#[no_mangle]
unsafe extern "C" fn test_vendor_specific_check(test: *const resctrl_test) -> bool {
...
#[no_mangle]
unsafe extern "C" fn run_single_test(test: *const resctrl_test, uparams: *const user_params) {
...
//
    ...
    {
    struct fill_buf_param *fill_param = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn init_user_params(uparams: *mut user_params) {
...
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    {
    struct fill_buf_param *fill_param = core::ptr::null_mut();
    let mut tests: c_int = ARRAY_SIZE(resctrl_tests);
    let mut test_param_seen: bool = false;
...
// Extract benchmark command from command line.
    ...
    uparams.benchmark_cmd[i] = core::ptr::null_mut();
    goto last_arg;
    case 't':
    token = strtok(optarg, ",");
    if (!test_param_seen) {
