...
//! Source: tools/testing/selftests/resctrl/resctrlfs.c
#![no_std]
...
//
    ...
    int snc_unreliable;
#[no_mangle]
unsafe extern "C" fn find_resctrl_mount(buffer: *mut c_char) -> c_int {
    ...
    if (!fs)
    continue;
    mntpoint = strtok(core::ptr::null_mut(), " \t");
    if (!mntpoint)
    continue;
    fs = strtok(core::ptr::null_mut(), " \t");
    if (!fs)
    continue;
...
pub unsafe extern "C" fn mount_resctrlfs() -> c_int {
    ...
    {
    int ret;
    ret = find_resctrl_mount(core::ptr::null_mut());
    if (ret != -ENOENT)
    return -1;
    ksft_print_msg("Mounting resctrl to \"%s\"\n", RESCTRL_PATH);
    ret = mount("resctrl", RESCTRL_PATH, "resctrl", 0, core::ptr::null_mut());
    if (ret)
    ksft_perror("mount");
    return ret;
    }
...
//
#[no_mangle]
unsafe extern "C" fn get_cache_level(cache_type: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_resource_cache_level(resource: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_domain_id(resource: *const c_char, cpu_no: c_int, domain_id: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn count_sys_bitmap_bits(name: *mut c_char) -> c_uint {
    static unsigned int count_sys_bitmap_bits(char *name)
    {
    FILE *fp = fopen(name, "r");
    let mut count: c_int = 0, c;
    if (!fp)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn cpus_offline_empty() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_cache_size(cpu_no: c_int, cache_type: *const c_char, cache_size: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if('K': cache_str[i] ==) -> else {
    else if (cache_str[i] == 'K')
// cache_size = *cache_size * 1024;
#[no_mangle]
pub unsafe extern "C" fn if('M': cache_str[i] ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn get_bit_mask(filename: *const c_char, mask: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn create_bit_mask(start: c_uint, len: c_uint) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn count_contiguous_bits(val: c_ulong, start: *mut c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn get_shareable_mask(cache_type: *const c_char, shareable_mask: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn taskset_benchmark(bm_pid: pid_t, cpu_no: c_int, old_affinity: *mut cpu_set_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn create_grp(grp_name: *const c_char, grp: *mut c_char, parent_grp: *const c_char) -> c_int {
...
// Check if requested grp exists or not
    ...
    if (dp) {
    while ((ep = readdir(dp)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn write_pid_to_tasks(tasks: *mut c_char, pid: pid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn write_bm_pid_to_resctrl(bm_pid: pid_t, ctrlgrp: *const c_char, mongrp: *const c_char) -> c_int {
...
pub unsafe extern "C" fn check_resctrlfs_support() -> bool {
    ...
    find_resctrl_mount(core::ptr::null_mut()) ? "not" : "is");
    return ret;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_mon_feature_exists(resource: *const c_char, feature: *const c_char) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn resource_info_file_exists(resource: *const c_char, file: *const c_char) -> bool {
...
pub unsafe extern "C" fn filter_dmesg() -> c_int {
    ...
    execlp("dmesg", "dmesg", core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn count_bits(n: c_ulong) -> c_uint {
