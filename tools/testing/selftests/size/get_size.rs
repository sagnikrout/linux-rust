...
//! Source: tools/testing/selftests/size/get_size.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn print(s: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_num(num: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_k_value(s: *const c_char, num: c_ulong, units: c_ulong) -> c_int {
