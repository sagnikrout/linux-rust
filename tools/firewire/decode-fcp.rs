...
//! Source: tools/firewire/decode-fcp.c
#![no_std]
...
pub const CSR_FCP_COMMAND: c_uint = 0xfffff0000b00ull;
pub const CSR_FCP_RESPONSE: c_uint = 0xfffff0000d00ull;
...
pub struct avc_field {
    pub /: *const *const *const char name; / Short name for field.,
    pub /: *mut *mut int offset; / Location of field, specified in bits;,
// negative means from end of packet.
    pub /: *mut *mut int width; / Width of field, 0 means use data_length.,
...
pub struct avc_frame {
    pub operand0:8: u32,
    pub opcode:8: u32,
    pub subunit_id:3: u32,
    pub subunit_type:5: u32,
    pub ctype:4: u32,
    pub cts:4: u32,
}
    ...
    if (info.name == core::ptr::null_mut()) {
    ...
    for (i = 0; info.fields[i].name != core::ptr::null_mut(); i++)
