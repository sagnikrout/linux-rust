...
//! Source: tools/verification/rv/src/rv.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn stop_rv(sig: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn rv_list(argc: c_int, argv: *mut c_char) {
    ...
    char *container = core::ptr::null_mut();
    if (argc == 2) {
...
//
#[no_mangle]
unsafe extern "C" fn rv_mon(argc: c_int, argv: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn usage(exit_val: c_int, fmt: *const c_char, ...) {
