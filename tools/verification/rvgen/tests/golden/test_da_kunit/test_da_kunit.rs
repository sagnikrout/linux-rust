...
//! Source: tools/verification/rvgen/tests/golden/test_da_kunit/test_da_kunit.h
#![no_std]
...
pub struct automaton_test_da_kunit {
    pub state_names: [*mut c_char; state_max_test_da_kunit],
    pub event_names: [*mut c_char; event_max_test_da_kunit],
    pub function: [c_uchar; state_max_test_da_kunit][event_max_test_da_kunit],
    pub initial_state: c_uchar,
    pub final_states: [bool; state_max_test_da_kunit],
}
