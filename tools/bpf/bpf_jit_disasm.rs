...
//! Source: tools/bpf/bpf_jit_disasm.c
#![no_std]
...
pub const CMD_ACTION_SIZE_BUFFER: c_int = 10;
pub const CMD_ACTION_READ_ALL: c_int = 3;
#[no_mangle]
unsafe extern "C" fn get_exec_path(tpath: *mut c_char, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn get_asm_insns(image: *mut u8, len: usize, opcodes: c_int) {
    ...
    bfdf = bfd_openr(tpath, core::ptr::null_mut());
    assert(bfdf);
    ...
    int ret, len;
    char *buff;
    len = klogctl(CMD_ACTION_SIZE_BUFFER, core::ptr::null_mut(), 0);
    if (len < 0)
...
#[no_mangle]
unsafe extern "C" fn put_log_buff(buff: *mut c_char) {
    ...
    while ((ptr = strtok(tmp, "\n")) != core::ptr::null_mut() && ulen < proglen) {
...
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    char *kbuff, *file = core::ptr::null_mut();
    char *ofile = core::ptr::null_mut();
    int ofd;
    ssize_t nr;
    uint8_t *pos;
    uint8_t *image = core::ptr::null_mut();
