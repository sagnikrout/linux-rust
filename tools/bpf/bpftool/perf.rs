...
//! Source: tools/bpf/bpftool/perf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn has_perf_query_support() -> bool {
...
//
    ...
    close(fd);
    out:
    let mut perf_query_supported: return = = 1;
    }
...
#[no_mangle]
unsafe extern "C" fn show_proc() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_perf(argc: c_int, argv: *mut c_char) -> c_int {
