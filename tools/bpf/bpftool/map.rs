...
//! Source: tools/bpf/bpftool/map.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn map_is_per_cpu(type: __u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn map_is_map_of_maps(type: __u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn map_is_map_of_progs(type: __u32) -> bool {
    static bool map_is_map_of_progs(__u32 type)
    {
    let mut type: return = = BPF_MAP_TYPE_PROG_ARRAY;
    }
#[no_mangle]
unsafe extern "C" fn map_type_from_str(type: *const c_char) -> c_int {
...
// (unsigned int *)value);
    ...
    {
    let mut msg_size: c_int = strlen(error_msg);
...
#[no_mangle]
unsafe extern "C" fn fill_per_cpu_value(info: *mut bpf_map_info, value: *mut c_void) {
    ...
    if (!argv)
    return -1;
    return parse_elem(argv, info, core::ptr::null_mut(), value, key_size, value_size,
...
// value_fd = fd;
    ...
    return parse_elem(argv, info, key, core::ptr::null_mut(), key_size, value_size,
    flags, core::ptr::null_mut(), open_flags);
...
// flags = BPF_ANY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: *mut is_prefix(argv, _arg: "noexist")) -> else {
    else if (is_prefix(*argv, "noexist"))
// flags = BPF_NOEXIST;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: *mut is_prefix(argv, _arg: "exist")) -> else {
    else if (is_prefix(*argv, "exist"))
// flags = BPF_EXIST;
    return parse_elem(argv + 1, info, key, value, key_size,
    value_size, core::ptr::null_mut(), value_fd, open_flags);
    }
    p_err("expected key or value, got: %s", *argv);
    return -1;
    }
#[no_mangle]
unsafe extern "C" fn show_map_header_json(info: *mut bpf_map_info, wtr: *mut json_writer_t) {
...
#[no_mangle]
unsafe extern "C" fn show_map_close_json(fd: c_int, info: *mut bpf_map_info) -> c_int {
    ...
    if (owner_prog_type) {
    let mut prog_type: c_uint = atoi(owner_prog_type);
...
#[no_mangle]
unsafe extern "C" fn show_map_header_plain(info: *mut bpf_map_info) {
...
#[no_mangle]
unsafe extern "C" fn show_map_close_plain(fd: c_int, info: *mut bpf_map_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn maps_have_btf(fds: *mut c_int, nb_fds: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_btf_vmlinux() {
...
#[no_mangle]
unsafe extern "C" fn get_map_kv_btf(info: *const bpf_map_info, btf: *mut btf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_map_kv_btf(btf: *mut btf) {
...
unsafe extern "C" fn do_dump(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    {
    json_writer_t *wtr = core::ptr::null_mut(), *btf_wtr = core::ptr::null_mut();
    let mut info: bpf_map_info = {};
    int nb_fds, i = 0;
    let mut len: __u32 = sizeof(info);
    int *fds = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn alloc_key_value(info: *mut bpf_map_info, key: *mut c_void, value: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_update(argc: c_int, argv: *mut c_char) -> c_int {
    static int do_update(int argc, char **argv)
    {
    let mut info: bpf_map_info = {};
    let mut len: __u32 = sizeof(info);
    __u32 *value_fd = core::ptr::null_mut();
    let mut flags: __u32 = BPF_ANY;
    void *key, *value;
    int fd, err;
    if (argc < 2)
    usage();
...
#[no_mangle]
unsafe extern "C" fn do_lookup(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    if (err)
    goto exit_free;
    err = parse_elem(argv, &info, key, core::ptr::null_mut(), info.key_size, 0, core::ptr::null_mut(), core::ptr::null_mut(),
    BPF_F_RDONLY);
    if (err)
    goto exit_free;
...
#[no_mangle]
unsafe extern "C" fn do_getnext(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    if (argc) {
    err = parse_elem(argv, &info, key, core::ptr::null_mut(), info.key_size, 0, core::ptr::null_mut(),
    core::ptr::null_mut(), BPF_F_RDONLY);
    if (err)
    goto exit_free;
    } else {
    free(key);
...
#[no_mangle]
unsafe extern "C" fn do_delete(argc: c_int, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn map_parse_read_only_fd(argc: *mut c_int, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_create(argc: c_int, argv: *mut c_char) -> c_int {
    static int do_create(int argc, char **argv)
    {
    LIBBPF_OPTS(bpf_map_create_opts, attr);
    let mut map_type: enum bpf_map_type = BPF_MAP_TYPE_UNSPEC;
    let mut key_size: __u32 = 0, value_size = 0, max_entries = 0;
    const char *map_name = core::ptr::null_mut();
    const char *pinfile;
    let mut err: c_int = -1, fd;
    if (!REQ_ARGS(7))
    return -1;
    pinfile = GET_ARG();
    while (argc) {
...
#[no_mangle]
unsafe extern "C" fn do_pop_dequeue(argc: c_int, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_freeze(argc: c_int, argv: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_map(argc: c_int, argv: *mut c_char) -> c_int {
