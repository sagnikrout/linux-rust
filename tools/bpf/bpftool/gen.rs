...
//! Source: tools/bpf/bpftool/gen.c
#![no_std]
...
pub const MAX_OBJ_NAME_LEN: c_int = 64;
#[no_mangle]
unsafe extern "C" fn sanitize_identifier(name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn str_has_prefix(str: *const c_char, prefix: *const c_char) -> bool {
    static bool str_has_prefix(const char *str, const char *prefix)
    {
    return strncmp(str, prefix, strlen(prefix)) == 0;
    }
#[no_mangle]
unsafe extern "C" fn str_has_suffix(str: *const c_char, suffix: *const c_char) -> bool {
    ...
    t = skip_mods_and_typedefs(btf, id, core::ptr::null_mut());
    if (!btf_is_ptr(t))
    return core::ptr::null_mut();
    t = skip_mods_and_typedefs(btf, t.type, res_id);
    return btf_is_func_proto(t) ? t : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn get_obj_name(name: *mut c_char, file: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn get_header_guard(guard: *mut c_char, obj_name: *const c_char, suffix: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn get_map_ident(map: *const bpf_map, buf: *mut c_char, buf_sz: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_datasec_ident(sec_name: *const c_char, buf: *mut c_char, buf_sz: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn codegen_btf_dump_printf(ctx: *mut c_void, fmt: *const c_char, args: va_list) {
    ...
    let mut need_off: c_int = sec_var.offset, align_off, align;
    let mut var_type_id: __u32 = var.type;
...
//
    ...
    {
    let mut n: c_int = btf__type_cnt(btf), i;
    char sec_ident[256];
    for (i = 1; i < n; i++) {
...
#[no_mangle]
unsafe extern "C" fn is_skel_data(map: *const bpf_map, buf: *mut c_char, sz: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_mmapable_map(map: *const bpf_map, buf: *mut c_char, sz: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn codegen_datasecs(obj: *mut bpf_object, obj_name: *const c_char) -> c_int {
    ...
    char map_ident[256];
    let mut err: c_int = 0;
    d = btf_dump__new(btf, codegen_btf_dump_printf, core::ptr::null_mut(), core::ptr::null_mut());
    if (!d)
    return -errno;
...
#[no_mangle]
unsafe extern "C" fn codegen_subskel_datasecs(obj: *mut bpf_object, obj_name: *const c_char) -> c_int {
    ...
    let mut strip_mods: bool = false, needs_typeof = false;
...
//
    var = skip_mods_and_typedefs(btf, var.type, core::ptr::null_mut());
    printf("\t\t");
...
#[no_mangle]
unsafe extern "C" fn codegen(template: *const c_char, ...) {
    static void codegen(const char *template, ...)
    {
    const char *src, *end;
    let mut skip_tabs: c_int = 0, n;
    char *s, *dst;
    va_list args;
    char c;
    n = strlen(template);
...
#[no_mangle]
unsafe extern "C" fn print_hex(data: *const c_char, data_sz: c_int) {
    static void print_hex(const char *data, int data_sz)
    {
    int i, len;
    for (i = 0, len = 0; i < data_sz; i++) {
    let mut w: c_int = data[i] ? 4 : 2;
    len += w;
    if (len > 78) {
    printf("\\\n");
    len = w;
...
#[no_mangle]
unsafe extern "C" fn bpf_map_mmap_sz(map: *const bpf_map) -> usize {
    static size_t bpf_map_mmap_sz(const struct bpf_map *map)
    {
    let mut page_sz: c_long = sysconf(_SC_PAGE_SIZE);
    size_t map_sz;
...
#[no_mangle]
unsafe extern "C" fn codegen_asserts(obj: *mut bpf_object, obj_name: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn codegen_attach_detach(obj: *mut bpf_object, obj_name: *const c_char) {
    ...
    printf("\tint fd = skel_raw_tracepoint_open(core::ptr::null_mut(), prog_fd);\n");
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn codegen_destroy(obj: *mut bpf_object, obj_name: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn gen_trace(obj: *mut bpf_object, obj_name: *const c_char, header_guard: *const c_char) -> c_int {
    static int gen_trace(struct bpf_object *obj, const char *obj_name, const char *header_guard)
    {
    DECLARE_LIBBPF_OPTS(gen_loader_opts, opts);
    let mut sopts: bpf_load_and_run_opts = {};
...
// finish generating 'struct skel'
    ...
    bpf_object__for_each_map(map, obj) {
    const void *mmap_data = core::ptr::null_mut();
...
// programs */				    \n\
    ...
    struct btf_dump *d = core::ptr::null_mut();
...
// scalar type
    ...
    break;
    case BTF_KIND_PTR:
    if (resolve_func_ptr(btf, m.type, core::ptr::null_mut())) {
// Function pointer
...
#[no_mangle]
unsafe extern "C" fn gen_st_ops_shadow(obj_name: *const c_char, btf: *mut btf, obj: *mut bpf_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen_st_ops_shadow_init(btf: *mut btf, obj: *mut bpf_object) {
...
//
    ...
    bpf_map__initial_value(obj.maps.%1$s, core::ptr::null_mut());\n\
    \n\
    ", ident);
    }
    }
#[no_mangle]
unsafe extern "C" fn do_skeleton(argc: c_int, argv: *mut c_char) -> c_int {
    static int do_skeleton(int argc, char **argv)
    {
    char header_guard[MAX_OBJ_NAME_LEN + sizeof("__SKEL_H__")];
    let mut map_cnt: usize = 0, prog_cnt = 0, attach_map_cnt = 0, file_sz, mmap_sz;
    ...
    obj_data = mmap(core::ptr::null_mut(), mmap_sz, PROT_READ, MAP_PRIVATE, fd, 0);
    if (obj_data == MAP_FAILED) {
    obj_data = core::ptr::null_mut();
...
// THIS FILE IS AUTOGENERATED BY BPFTOOL! */		    \n\
    ...
    %1$s__open(void)					    \n\
    {							    \n\
    return %1$s__open_opts(core::ptr::null_mut());			    \n\
    }							    \n\
    \n\
    static inline int					    \n\
...
//
#[no_mangle]
unsafe extern "C" fn do_subskeleton(argc: c_int, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_object(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    output_file = GET_ARG();
    linker = bpf_linker__new(output_file, core::ptr::null_mut());
    if (!linker) {
    ...
    while (argc) {
    file = GET_ARG();
    err = bpf_linker__add_file(linker, file, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn btf_save_raw(btf: *const btf, path: *const c_char) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btfgen_info {
    pub src_btf: *mut btf,
    pub /: *mut *mut *mut btf marked_btf; / btf structure used to mark used types,
}

#[no_mangle]
unsafe extern "C" fn btfgen_hash_fn(key: c_long, ctx: *mut c_void) -> usize {
    static size_t btfgen_hash_fn(long key, void *ctx)
    {
    return key;
    }
#[no_mangle]
unsafe extern "C" fn btfgen_equal_fn(k1: c_long, k2: c_long, ctx: *mut c_void) -> bool {
    static bool btfgen_equal_fn(long k1, long k2, void *ctx)
    {
    let mut k1: return = = k2;
    }
#[no_mangle]
unsafe extern "C" fn btfgen_free_info(info: *mut btfgen_info) {
    ...
    if (!info)
    return core::ptr::null_mut();
    info.src_btf = btf__parse(targ_btf_path, core::ptr::null_mut());
    if (!info.src_btf) {
    err = -errno;
    p_err("failed parsing '%s' BTF file: %s", targ_btf_path, strerror(errno));
    goto err_out;
    }
    info.marked_btf = btf__parse(targ_btf_path, core::ptr::null_mut());
    if (!info.marked_btf) {
    err = -errno;
    p_err("failed parsing '%s' BTF file: %s", targ_btf_path, strerror(errno));
    goto err_out;
...
#[no_mangle]
unsafe extern "C" fn btfgen_mark_member(info: *mut btfgen_info, type_id: c_int, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn btfgen_record_field_relo(info: *mut btfgen_info, targ_spec: *mut bpf_core_spec) -> c_int {
    ...
    struct btf_array *array;
    let mut type_id: c_uint = targ_spec.root_type_id;
    int idx, err;
// mark root type
...
//
#[no_mangle]
unsafe extern "C" fn btfgen_mark_type_match(info: *mut btfgen_info, type_id: __u32, behind_ptr: bool) -> c_int {
...
// mark type on cloned BTF as used
    ...
    let mut vlen: __u32 = btf_vlen(btf_type);
    if (behind_ptr)
    break;
    for (i = 0; i < vlen; i++, m++) {
// mark member
...
//
#[no_mangle]
unsafe extern "C" fn btfgen_record_type_match_relo(info: *mut btfgen_info, targ_spec: *mut bpf_core_spec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btfgen_record_type_relo(info: *mut btfgen_info, targ_spec: *mut bpf_core_spec) -> c_int {
    static int btfgen_record_type_relo(struct btfgen_info *info, struct bpf_core_spec *targ_spec)
    {
    return btfgen_mark_type(info, targ_spec.root_type_id, true);
    }
#[no_mangle]
unsafe extern "C" fn btfgen_record_enumval_relo(info: *mut btfgen_info, targ_spec: *mut bpf_core_spec) -> c_int {
    static int btfgen_record_enumval_relo(struct btfgen_info *info, struct bpf_core_spec *targ_spec)
    {
    return btfgen_mark_type(info, targ_spec.root_type_id, false);
    }
#[no_mangle]
unsafe extern "C" fn btfgen_record_reloc(info: *mut btfgen_info, res: *mut bpf_core_spec) -> c_int {
    ...
    struct bpf_core_cand_list *cands = core::ptr::null_mut();
    let mut local_cand: bpf_core_cand = {};
...
#[no_mangle]
unsafe extern "C" fn btfgen_record_obj(info: *mut btfgen_info, obj_path: *const c_char) -> c_int {
    ...
    struct hashmap *cand_cache = core::ptr::null_mut();
    struct btf_ext *btf_ext = core::ptr::null_mut();
    ...
    cand_cache = hashmap__new(btfgen_hash_fn, btfgen_equal_fn, core::ptr::null_mut());
    ...
    let mut targ_res: bpf_core_relo_res = {};
    struct bpf_core_cand_list *cands = core::ptr::null_mut();
...
// Generate BTF from relocation information previously recorded
    ...
    {
    struct btf *btf_new = core::ptr::null_mut();
    unsigned int *ids = core::ptr::null_mut();
    let mut n: c_uint = btf__type_cnt(info.marked_btf);
    let mut err: c_int = 0;
    __u32 i;
...
//
#[no_mangle]
unsafe extern "C" fn minimize_btf(src_btf: *const c_char, dst_btf: *const c_char, objspaths[]: *const c_char) -> c_int {
    ...
    for (i = 0; objspaths[i] != core::ptr::null_mut(); i++) {
...
#[no_mangle]
unsafe extern "C" fn do_min_core_btf(argc: c_int, argv: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_gen(argc: c_int, argv: *mut c_char) -> c_int {
