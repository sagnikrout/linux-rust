...
//! Source: tools/bpf/bpftool/struct_ops.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_map_info_type_id() -> __s32 {
...
#[no_mangle]
unsafe extern "C" fn cmd_retval(res: *const res, must_have_one_map: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(!res.nr_errs: !wtr && json_output &&) -> else {
...
//
    ...
    res.nr_errs++;
#[no_mangle]
pub unsafe extern "C" fn if(json_output: !wtr &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !is_prefix(search_type, _arg: "name")) -> else {
...
unsafe extern "C" fn do_show(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    {
    const char *search_type = core::ptr::null_mut(), *search_term = core::ptr::null_mut();
    struct res res;
    if (argc && argc != 2)
    usage();
    if (argc == 2) {
...
#[no_mangle]
unsafe extern "C" fn do_unregister(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    __do_unregister, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn do_register(argc: c_int, argv: *mut c_char) -> c_int {
    static int do_register(int argc, char **argv)
    {
    LIBBPF_OPTS(bpf_object_open_opts, open_opts);
    let mut link_info_len: __u32 = sizeof(struct bpf_link_info);
    let mut link_info: bpf_link_info = {};
    let mut info: bpf_map_info = {};
    let mut info_len: __u32 = sizeof(info);
    let mut nr_errs: c_int = 0, nr_maps = 0;
    const char *linkdir = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn do_struct_ops(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    map_info_type = core::ptr::null_mut();
