...
//! Source: tools/bpf/bpftool/feature.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn grep(buffer: *const c_char, pattern: *const c_char) -> bool {
    static bool grep(const char *buffer, const char *pattern)
    {
    return !!strstr(buffer, pattern);
    }
#[no_mangle]
unsafe extern "C" fn check_procfs() -> bool {
...
#[no_mangle]
unsafe extern "C" fn uppercase(str: *mut c_char, len: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: define_prefix) -> else {
...
#[no_mangle]
unsafe extern "C" fn print_end_section() {
...
// Probing functions
#[no_mangle]
unsafe extern "C" fn get_vendor_id(ifindex: c_int) -> c_int {
    ...
    return -1;
    buf[len] = '\0';
    return strtol(buf, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn read_procfs(path: *const c_char) -> c_long {
    static long read_procfs(const char *path)
    {
    char *endptr, *line = core::ptr::null_mut();
    let mut len: usize = 0;
    FILE *fd;
    long res;
    fd = fopen(path, "r");
...
#[no_mangle]
unsafe extern "C" fn probe_unprivileged_disabled() {
...
#[no_mangle]
unsafe extern "C" fn probe_jit_enable() {
...
#[no_mangle]
unsafe extern "C" fn probe_jit_harden() {
...
#[no_mangle]
unsafe extern "C" fn probe_jit_kallsyms() {
...
#[no_mangle]
unsafe extern "C" fn probe_jit_limit() {
...
#[no_mangle]
unsafe extern "C" fn probe_kernel_image_config(define_prefix: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn probe_bpf_syscall(define_prefix: *const c_char) -> bool {
    static bool probe_bpf_syscall(const char *define_prefix)
    {
    bool res;
    bpf_prog_load(BPF_PROG_TYPE_UNSPEC, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0, core::ptr::null_mut());
    res = (errno != ENOSYS);
    ...
    int fd;
    errno = 0;
    fd = bpf_prog_load(prog_type, core::ptr::null_mut(), "GPL", insns, insns_cnt, &opts);
    if (fd >= 0)
    close(fd);
    return fd >= 0 && errno != EINVAL && errno != EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn probe_prog_type_ifindex(prog_type: enum bpf_prog_type, ifindex: __u32) -> bool {
...
// nfp returns -EINVAL on exit(0) with TC offload
    ...
    res = libbpf_probe_bpf_prog_type(prog_type, core::ptr::null_mut()) > 0;
    }
...
#[no_mangle]
unsafe extern "C" fn probe_map_type_ifindex(map_type: enum bpf_map_type, ifindex: __u32) -> bool {
    ...
    max_entries = 1;
    fd = bpf_map_create(map_type, core::ptr::null_mut(), key_size, value_size, max_entries,
    &opts);
    if (fd >= 0)
    close(fd);
    return fd >= 0;
    ...
    res = libbpf_probe_bpf_map_type(map_type, core::ptr::null_mut()) > 0;
    }
...
//
    ...
    res = libbpf_probe_bpf_helper(prog_type, id, core::ptr::null_mut()) > 0;
...
pub unsafe extern "C" fn if(_arg: !define_prefix) -> else {
    ...
    int fd;
    errno = 0;
    fd = bpf_prog_load(BPF_PROG_TYPE_SOCKET_FILTER, core::ptr::null_mut(), "GPL",
    insns, len, &opts);
    res = fd >= 0 || !errno;
    if (fd >= 0)
    close(fd);
...
//
#[no_mangle]
unsafe extern "C" fn probe_large_insn_limit(define_prefix: *const c_char, ifindex: __u32) {
...
#[no_mangle]
unsafe extern "C" fn section_syscall_config(define_prefix: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn section_map_types(define_prefix: *const c_char, ifindex: __u32) {
...
#[no_mangle]
unsafe extern "C" fn section_misc(define_prefix: *const c_char, ifindex: __u32) {
...
#[no_mangle]
unsafe extern "C" fn handle_perms() -> c_int {
    ...
    let mut cap_sys_admin_only: bool = true;
    ...
    let mut cap: cap_value_t = bpf_caps[i].cap;
...
#[no_mangle]
unsafe extern "C" fn do_probe(argc: c_int, argv: *mut c_char) -> c_int {
    static int do_probe(int argc, char **argv)
    {
    let mut target: enum probe_component = COMPONENT_UNSPEC;
    const char *define_prefix = core::ptr::null_mut();
...
//
    ...
    return -1;
    if (json_output) {
    define_prefix = core::ptr::null_mut();
    jsonw_start_object(json_wtr);
    }
...
#[no_mangle]
unsafe extern "C" fn do_list_builtins(argc: c_int, argv: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_feature(argc: c_int, argv: *mut c_char) -> c_int {
