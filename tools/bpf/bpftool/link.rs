...
//! Source: tools/bpf/bpftool/link.c
#![no_std]
...
pub const PERF_HW_CACHE_LEN: c_int = 128;
    ...
    const char *event_str = core::ptr::null_mut();			\
    \
...
#[no_mangle]
unsafe extern "C" fn link_parse_fd(argc: *mut c_int, argv: *mut c_char) -> c_int {
    ...
    path = **argv;
    NEXT_ARGP();
    return open_obj_pinned_any(path, BPF_OBJ_LINK, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn show_link_attach_type_json(attach_type: __u32, wtr: *mut json_writer_t) {
...
#[no_mangle]
unsafe extern "C" fn show_link_ifindex_json(ifindex: __u32, wtr: *mut json_writer_t) {
...
#[no_mangle]
unsafe extern "C" fn is_iter_map_target(target_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_iter_cgroup_target(target_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_iter_task_target(target_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn show_iter_json(info: *mut bpf_link_info, wtr: *mut json_writer_t) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_iter_task_target(target_name)) -> else {
    if (info.iter.task.tid)
    jsonw_uint_field(wtr, "tid", info.iter.task.tid);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: info->iter.task.pid) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn netfilter_dump_json(info: *const bpf_link_info, wtr: *mut json_writer_t) {
...
#[no_mangle]
unsafe extern "C" fn get_prog_info(prog_id: c_int, info: *mut bpf_prog_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_x86_ibt_enabled() -> bool {
    ...
    bool ret;
    if (read_kernel_config(options, ARRAY_SIZE(options), values, core::ptr::null_mut()))
    return false;
    ret = !!values[0];
    free(values[0]);
    return ret;
...
// Print null if it is vmlinux
    ...
    {
    let mut is_ibt_enabled: bool = is_x86_ibt_enabled(), show_symbol;
    __u64 *addrs, *cookies;
    __u32 i, *ids;
    if (!dd.sym_count)
    kernel_syms_load(&dd);
    ...
    struct kernel_sym *sym;
    let mut addr: __u64 = addrs[i];
    sym = show_symbol ? find_kernel_sym_by_addr(addr, is_ibt_enabled) : core::ptr::null_mut();
    ...
    {
    let mut config: __u64 = info.perf_event.event.config;
    let mut type: __u32 = info.perf_event.event.type;
...
#[no_mangle]
unsafe extern "C" fn show_link_close_json(fd: c_int, info: *mut bpf_link_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_link_header_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_link_attach_type_plain(attach_type: __u32) {
...
#[no_mangle]
unsafe extern "C" fn show_iter_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
pub unsafe extern "C" fn netfilter_dump_plain(info: *const bpf_link_info) {
    void netfilter_dump_plain(const struct bpf_link_info *info)
    {
    const char *hookname = core::ptr::null_mut(), *pfname = core::ptr::null_mut();
    let mut hook: c_uint = info.netfilter.hooknum;
    let mut pf: c_uint = info.netfilter.pf;
...
#[no_mangle]
unsafe extern "C" fn show_kprobe_multi_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_uprobe_multi_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_tracing_multi_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_perf_event_kprobe_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_perf_event_uprobe_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_perf_event_tracepoint_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_perf_event_event_plain(info: *mut bpf_link_info) {
...
#[no_mangle]
unsafe extern "C" fn show_link_close_plain(fd: c_int, info: *mut bpf_link_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_show_link(fd: c_int) -> c_int {
    static int do_show_link(int fd)
    {
    __u64 *ref_ctr_offsets = core::ptr::null_mut(), *offsets = core::ptr::null_mut(), *cookies = core::ptr::null_mut();
    __u32 *ids = core::ptr::null_mut();
    struct bpf_link_info info;
    let mut len: __u32 = sizeof(info);
    char path_buf[PATH_MAX];
    __u64 *addrs = core::ptr::null_mut();
    char buf[PATH_MAX];
    int count;
    int err;
    memset(&info, 0, sizeof(info));
...
unsafe extern "C" fn do_show(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    let mut errno: return = = ENOENT ? 0 : -1;
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn do_link(argc: c_int, argv: *mut c_char) -> c_int {
