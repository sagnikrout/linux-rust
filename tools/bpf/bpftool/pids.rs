...
//! Source: tools/bpf/bpftool/pids.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn build_obj_refs_table(map: *mut hashmap, type: enum bpf_obj_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_ref(map: *mut hashmap, e: *mut pid_iter_entry) {
...
#[no_mangle]
unsafe extern "C" fn __printf(_arg: 2, _arg: 0) -> c_int {
