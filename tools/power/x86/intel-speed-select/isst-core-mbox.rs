...
//! Source: tools/power/x86/intel-speed-select/isst-core-mbox.c
#![no_std]
...
//
    ...
    let mut mbox_retries: static int = 3;
pub const MAX_TRL_LEVELS_EMR: c_int = 5;
#[no_mangle]
unsafe extern "C" fn mbox_get_disp_freq_multiplier() -> c_int {
    static int mbox_get_disp_freq_multiplier(void)
    {
    return DISP_FREQ_MULTIPLIER;
    }
#[no_mangle]
unsafe extern "C" fn mbox_get_trl_max_levels() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_update_platform_param(param: enum isst_platform_param, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mbox_is_punit_valid(id: *mut isst_id) -> c_int {
...
// value = io_regs.io_reg[0].value;
    ...
    const char *pathname = "/dev/isst_interface";
    int fd, retry;
    let mut mbox_cmds: isst_if_mbox_cmds = { 0 };
    debug_printf(
...
#[no_mangle]
unsafe extern "C" fn mbox_read_pm_config(id: *mut isst_id, cp_state: *mut c_int, cp_cap: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_get_config_levels(id: *mut isst_id, pkg_dev: *mut isst_pkg_ctdp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _set_uncore_min_max(id: *mut isst_id, max: c_int, freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_get_get_trl(id: *mut isst_id, level: c_int, avx_level: c_int, trl: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_get_get_trls(id: *mut isst_id, level: c_int, ctdp_level: *mut isst_pkg_ctdp_level_info) -> c_int {
    static int mbox_get_get_trls(struct isst_id *id, int level, struct isst_pkg_ctdp_level_info *ctdp_level)
    {
    let mut trl_max_levels: c_int = isst_get_trl_max_levels();
    int i, ret;
...
#[no_mangle]
unsafe extern "C" fn mbox_get_trl_bucket_info(id: *mut isst_id, level: c_int, buckets_info: *mut c_ulonglong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_set_tdp_level(id: *mut isst_id, tdp_level: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_get_pbf_info(id: *mut isst_id, level: c_int, pbf_info: *mut isst_pbf_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_set_pbf_fact_status(id: *mut isst_id, pbf: c_int, enable: c_int) -> c_int {
    static int mbox_set_pbf_fact_status(struct isst_id *id, int pbf, int enable)
    {
    struct isst_pkg_ctdp pkg_dev;
    struct isst_pkg_ctdp_level_info ctdp_level;
    int current_level;
    let mut req: c_uint = 0, resp;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mbox_get_fact_info(id: *mut isst_id, level: c_int, fact_bucket: c_int, fact_info: *mut isst_fact_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_get_clos_information(id: *mut isst_id, enable: *mut c_int, type: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _write_pm_config(id: *mut isst_id, cp_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_pm_qos_config(id: *mut isst_id, enable_clos: c_int, priority_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_pm_get_clos(id: *mut isst_id, clos: c_int, clos_config: *mut isst_clos_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_set_clos(id: *mut isst_id, clos: c_int, clos_config: *mut isst_clos_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_clos_get_assoc_status(id: *mut isst_id, clos_id: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_clos_associate(id: *mut isst_id, clos_id: c_int) -> c_int {
