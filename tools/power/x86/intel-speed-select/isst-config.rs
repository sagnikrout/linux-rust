...
//! Source: tools/power/x86/intel-speed-select/isst-config.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct process_cmd_struct {
    pub feature: *mut c_char,
    pub command: *mut c_char,
    pub arg): *mut *mut void (process_fn)(int,
    pub arg: c_int,
}

    static const char *version_str = "v1.26";
    let mut supported_api_ver: static int = 3;
...
pub const MAX_CPUS_IN_ONE_REQ: c_int = 512;
    ...
    let mut tdp_level: static int = 0xFF;
    let mut fact_bucket: static int = 0xFF;
    let mut fact_avx: static int = 0xFF;
...
// clos related
    let mut current_clos: static int = -1;
    let mut clos_epp: static int = -1;
    let mut clos_prop_prio: static int = -1;
    let mut clos_min: static int = -1;
    let mut clos_max: static int = -1;
    let mut clos_desired: static int = -1;
...
pub struct _cpu_map {
    ...
    pub pkg_id: c_ushort,
    pub die_id: c_ushort,
    pub punit_id: c_ushort,
    pub punit_cpu: c_ushort,
    pub punit_cpu_core: c_ushort,
    pub initialized: c_ushort,
}
...
#[no_mangle]
unsafe extern "C" fn check_privilege() {
...
#[no_mangle]
pub unsafe extern "C" fn is_debug_enabled() -> c_int {
    int is_debug_enabled(void)
    {
    return debug_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn debug_printf(format: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn is_dmr_plus_platform() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_cpu_model() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn api_version() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_int_file(fatal: c_int, fmt: *const c_char, ...) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn out_format_is_json() -> c_int {
    int out_format_is_json(void)
    {
    return out_format_json;
    }
#[no_mangle]
unsafe extern "C" fn get_stored_topology_info(cpu: c_int, core_id: *mut c_int, pkg_id: *mut c_int, die_id: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn store_cpu_topology() {
...
#[no_mangle]
unsafe extern "C" fn get_physical_package_id(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_physical_core_id(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_physical_die_id(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_physical_punit_id(cpu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_topo_max_cpus() -> c_int {
    int get_topo_max_cpus(void)
    {
    return topo_max_cpus;
    }
#[no_mangle]
unsafe extern "C" fn is_cpu_online(cpu: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn force_all_cpus_online() {
...
#[no_mangle]
unsafe extern "C" fn set_max_cpu_num() {
...
#[no_mangle]
pub unsafe extern "C" fn alloc_cpu_set(cpu_set: *mut cpu_set_t) -> usize {
    size_t alloc_cpu_set(cpu_set_t **cpu_set)
    {
    cpu_set_t *_cpu_set;
    size_t size;
    _cpu_set = CPU_ALLOC((topo_max_cpus + 1));
    if (_cpu_set == core::ptr::null_mut())
    err(3, "CPU_ALLOC");
...
#[no_mangle]
unsafe extern "C" fn update_punit_cpu_info(physical_cpu: __u32, cpu_map: *mut _cpu_map) {
...
#[no_mangle]
unsafe extern "C" fn create_cpu_map() {
...
#[no_mangle]
pub unsafe extern "C" fn use_cgroupv2() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isolate_cpus(id: *mut isst_id, mask_size: c_int, cpu_mask: *mut cpu_set_t, level: c_int, cpu_0_only: c_int) -> c_int {
    ...
    let mut str_len: c_int = sizeof(str);
    DIR *dir;
...
#[no_mangle]
unsafe extern "C" fn cpu_0_workaround(isolate: c_int) -> c_int {
    static int cpu_0_workaround(int isolate)
    {
    int fd, fd1, len, ret;
    cpu_set_t cpu_mask;
...
#[no_mangle]
unsafe extern "C" fn isst_fill_platform_info() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_isst_status(id: *mut isst_id, arg1: *mut c_void, arg2: *mut c_void, arg3: *mut c_void, arg4: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn isst_print_extended_platform_info() {
    static void isst_print_extended_platform_info(void)
    {
    int cp_state, cp_cap;
    struct isst_id id;
    let mut mask: c_int = 0, max_level = 0;
    id.cpu = -1;
    for_each_online_power_domain_in_set(get_isst_status, core::ptr::null_mut(), &id, &mask, &max_level);
    if (mask & BIT(0)) {
...
#[no_mangle]
unsafe extern "C" fn isst_print_platform_information() {
...
// (unsigned int *)arg4,
    ...
    _get_tdp_level("get-config-levels", levels, levels, "Max TDP level", core::ptr::null_mut(), core::ptr::null_mut());
    _get_tdp_level("get-config-version", levels, version, "TDP version", core::ptr::null_mut(), core::ptr::null_mut());
    ...
    "Current TDP Level", core::ptr::null_mut(), core::ptr::null_mut());
    _get_tdp_level("get-lock-status", levels, locked, "TDP lock status", "unlocked", "locked");
    struct isst_pkg_ctdp clx_n_pkg_dev;
#[no_mangle]
unsafe extern "C" fn clx_n_get_base_ratio() -> c_int {
    static int clx_n_get_base_ratio(void)
    {
    FILE *fp;
    char *begin, *end, *line = core::ptr::null_mut();
    char number[5];
    let mut value: float = 0;
    let mut n: usize = 0;
    fp = fopen("/proc/cpuinfo", "r");
    if (!fp)
    err(-1, "cannot open /proc/cpuinfo\n");
...
#[no_mangle]
unsafe extern "C" fn clx_n_config(id: *mut isst_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dump_isst_config(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(fn, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    else
    for_each_online_power_domain_in_set(fn, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    isst_ctdp_display_information_end(outf);
    }
...
#[no_mangle]
unsafe extern "C" fn set_tdp_level(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(set_tdp_level_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    else
    for_each_online_power_domain_in_set(set_tdp_level_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    isst_ctdp_display_information_end(outf);
    }
...
#[no_mangle]
unsafe extern "C" fn dump_pbf_config(arg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_clos_param(id: *mut isst_id, clos: c_int, epp: c_int, wt: c_int, min: c_int, max: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cpufreq_scaling_min_max(cpu: c_int, max: c_int, freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn no_turbo() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adjust_scaling_max_from_base_freq(cpu: c_int) {
    static void adjust_scaling_max_from_base_freq(int cpu)
    {
...
#[no_mangle]
unsafe extern "C" fn adjust_scaling_min_from_base_freq(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_clx_pbf_cpufreq_scaling_min_max(id: *mut isst_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cpufreq_scaling_min_max_from_cpuinfo(cpu: c_int, cpuinfo_max: c_int, scaling_max: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_scaling_min_to_cpuinfo_max(id: *mut isst_id) {
...
#[no_mangle]
unsafe extern "C" fn set_scaling_min_to_cpuinfo_min(id: *mut isst_id) {
...
#[no_mangle]
unsafe extern "C" fn set_scaling_max_to_cpuinfo_max(id: *mut isst_id) {
...
#[no_mangle]
unsafe extern "C" fn set_pbf_core_power(id: *mut isst_id) -> c_int {
...
unsafe extern "C" fn set_pbf_enable(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(set_pbf_for_cpu, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut(), &enable);
    else
    for_each_online_power_domain_in_set(set_pbf_for_cpu, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut(), &enable);
    isst_ctdp_display_information_end(outf);
    }
...
#[no_mangle]
unsafe extern "C" fn dump_fact_config(arg: c_int) {
    ...
    for_each_online_power_domain_in_set(dump_fact_config_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    isst_ctdp_display_information_end(outf);
    }
...
unsafe extern "C" fn set_fact_enable(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(set_fact_for_cpu, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut(), &enable);
    else
    for_each_online_power_domain_in_set(set_fact_for_cpu, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut(), &enable);
...
unsafe extern "C" fn set_clos_enable(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(enable_clos_qos_config, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), &enable);
    else
    for_each_online_power_domain_in_set(enable_clos_qos_config, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), &enable);
    isst_ctdp_display_information_end(outf);
    }
...
#[no_mangle]
unsafe extern "C" fn dump_clos_config(arg: c_int) {
    ...
    for_each_online_power_domain_in_set(dump_clos_config_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    isst_ctdp_display_information_end(outf);
    }
...
#[no_mangle]
unsafe extern "C" fn dump_clos_info(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(get_clos_info_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    else
    for_each_online_power_domain_in_set(get_clos_info_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    isst_ctdp_display_information_end(outf);
    }
...
#[no_mangle]
unsafe extern "C" fn set_clos_config(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(set_clos_config_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    else
    for_each_online_power_domain_in_set(set_clos_config_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    isst_ctdp_display_information_end(outf);
    }
...
#[no_mangle]
unsafe extern "C" fn set_clos_assoc(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(set_clos_assoc_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    else {
...
#[no_mangle]
unsafe extern "C" fn get_clos_assoc(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    for_each_online_target_cpu_in_set(get_clos_assoc_for_cpu, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    isst_ctdp_display_information_end(outf);
    }
#[no_mangle]
unsafe extern "C" fn set_turbo_mode_for_cpu(id: *mut isst_id, status: c_int) {
...
unsafe extern "C" fn process_trl(arg: c_int) {
    ...
    isst_ctdp_display_information_start(outf);
    if (max_target_cpus)
    for_each_online_target_cpu_in_set(get_set_trl, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), &arg);
    else
    for_each_online_power_domain_in_set(get_set_trl, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), &arg);
    isst_ctdp_display_information_end(outf);
    }
...
pub unsafe extern "C" fn parse_cpu_command(optarg: *mut c_char) {
    ...
    next += 1;
#[no_mangle]
pub unsafe extern "C" fn if('\0': *mut *mut next !=) -> else {
    else if (*next != '\0')
    goto error;
    }
    if (invalid_count) {
...
#[no_mangle]
unsafe extern "C" fn check_optarg(option: *mut c_char, hex: c_int) {
...
#[no_mangle]
unsafe extern "C" fn parse_cmd_args(argc: c_int, start: c_int, argv: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn turbo_mode_help() {
...
#[no_mangle]
unsafe extern "C" fn core_power_help() {
...
pub struct process_cmd_help_struct {
    pub feature: *mut c_char,
    pub (*process_fn)(void): *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn cmdline(argc: c_int, argv: *mut c_char) {
    ...
    int ret;
    let mut oob_mode: c_int = 0;
    let mut poll_interval: c_int = -1;
    let mut no_daemon: c_int = 0;
    let mut mbox_delay: c_int = 0, mbox_retries = 3;
    static struct option long_options[] = {
