...
//! Source: tools/power/x86/intel-speed-select/isst-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn isst_update_platform_param(param: enum isst_platform_param, value: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn isst_read_pm_config(id: *mut isst_id, cp_state: *mut c_int, cp_cap: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_ctdp_levels(id: *mut isst_id, pkg_dev: *mut isst_pkg_ctdp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_get_trl(id: *mut isst_id, level: c_int, avx_level: c_int, trl: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_get_trls(id: *mut isst_id, level: c_int, ctdp_level: *mut isst_pkg_ctdp_level_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_trl_bucket_info(id: *mut isst_id, level: c_int, buckets_info: *mut c_ulonglong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_pbf_info(id: *mut isst_id, level: c_int, pbf_info: *mut isst_pbf_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_set_pbf_fact_status(id: *mut isst_id, pbf: c_int, enable: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_fact_info(id: *mut isst_id, level: c_int, fact_bucket: c_int, fact_info: *mut isst_fact_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_set_trl(id: *mut isst_id, trl: c_ulonglong) -> c_int {
...
pub const MSR_TRL_FREQ_MULTIPLIER: c_int = 100;
#[no_mangle]
pub unsafe extern "C" fn isst_set_trl_from_current_tdp(id: *mut isst_id, trl: c_ulonglong) -> c_int {
    ...
    msr_trl = 0;
    for (i = 0; i < 8; ++i) {
    let mut _trl: c_ulonglong = trl[i];
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_process_ctdp_complete(id: *mut isst_id, pkg_dev: *mut isst_pkg_ctdp) {
...
#[no_mangle]
pub unsafe extern "C" fn isst_get_process_ctdp(id: *mut isst_id, tdp_level: c_int, pkg_dev: *mut isst_pkg_ctdp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_clos_get_clos_information(id: *mut isst_id, enable: *mut c_int, type: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_pm_qos_config(id: *mut isst_id, enable_clos: c_int, priority_type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_pm_get_clos(id: *mut isst_id, clos: c_int, clos_config: *mut isst_clos_config) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isst_set_clos(id: *mut isst_id, clos: c_int, clos_config: *mut isst_clos_config) -> c_int {
