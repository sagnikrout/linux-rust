...
//! Source: tools/power/x86/intel-speed-select/isst-core-tpmi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tpmi_update_platform_param(param: enum isst_platform_param, value: c_int) {
...
pub const FEATURE_ENABLE_WAIT_US: c_int = 1000;
pub const FEATURE_ENABLE_RETRIES: c_int = 5;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn tpmi_get_clos_information(id: *mut isst_id, enable: *mut c_int, type: *mut c_int) -> c_int {
...
// type = info.priority_type;
    ...
    {
    struct isst_core_power info;
    let mut cp_state: c_int = 0, cp_cap = 0;
