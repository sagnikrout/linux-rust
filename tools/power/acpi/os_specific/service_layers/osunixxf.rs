...
//! Source: tools/power/acpi/os_specific/service_layers/osunixxf.c
#![no_std]
...
pub const ACPI_VPRINTF_BUFFER_SIZE: c_int = 512;

// Terminal support for acpi_exec only

    struct termios original_term_attributes;
    let mut term_attributes_were_set: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn os_enter_line_edit_mode() {
    static void os_enter_line_edit_mode(void)
    {
...
#[no_mangle]
unsafe extern "C" fn os_exit_line_edit_mode() {
    static void os_exit_line_edit_mode(void)
    {
...
// Macro flag: #define os_enter_line_edit_mode()
// Macro flag: #define os_exit_line_edit_mode()
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_enter_sleep(sleep_state: u8, rega_value: u32, regb_value: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_printf(fmt: *const c_char, ...) -> void ACPI_INTERNAL_VAR_XFACE {
...
//
    ...
    {
    let mut semaphore_count: static int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_create_lock(out_handle: *mut *mut acpi_spinlock) -> acpi_status {
...
// This timer has sufficient resolution for user-space application code
    gettimeofday(&time, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_read_port(address: acpi_io_address, value: *mut u32, width: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_write_port(address: acpi_io_address, value: u32, width: u32) -> acpi_status {
...
//
    ...
    int ret;
    ret =
    pthread_create(&thread, core::ptr::null_mut(), (PTHREAD_CALLBACK) function, context);
    if (ret) {
