...
//! Source: tools/power/acpi/tools/acpidump/apfiles.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ap_is_existing_file(pathname: *mut c_char) -> c_int {
    static int ap_is_existing_file(char *pathname)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn ap_write_to_binary_file(table: *mut acpi_table_header, instance: u32) -> c_int {
...
//
    ...
    u32 *out_file_size)
    {
    struct acpi_table_header *buffer = core::ptr::null_mut();
    ACPI_FILE file;
    u32 file_size;
    acpi_size actual;
