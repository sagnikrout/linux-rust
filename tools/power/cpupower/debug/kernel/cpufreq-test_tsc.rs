...
//! Source: tools/power/cpupower/debug/kernel/cpufreq-test_tsc.c
#![no_std]
...
//
    ...
    let mut pm_tmr_ioport: static int = 0;
// helper function to safely read acpi pm timesource
#[no_mangle]
unsafe extern "C" fn read_pmtmr() -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_test_tsc() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_none() -> void __exit {
