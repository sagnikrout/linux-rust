...
//! Source: tools/power/cpupower/utils/helpers/amd.c
#![no_std]
...
pub const MSR_AMD_PSTATE_STATUS: c_uint = 0xc0010063;
pub const MSR_AMD_PSTATE: c_uint = 0xc0010064;
pub const MSR_AMD_PSTATE_LIMIT: c_uint = 0xc0010061;
    union core_pstate {
// pre fam 17h:
    struct {
    unsigned fid:6;
...
#[no_mangle]
unsafe extern "C" fn get_did(pstate: union core_pstate) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_cof(pstate: union core_pstate) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pci_get_num_boost_states(active: *mut c_int, states: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pstate_boost_init(cpu: c_uint, support: *mut c_int, active: *mut c_int) {
