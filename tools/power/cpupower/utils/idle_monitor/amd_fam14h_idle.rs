...
//! Source: tools/power/cpupower/utils/idle_monitor/amd_fam14h_idle.c
#![no_std]
...
pub const PCI_NON_PC0_OFFSET: c_uint = 0xb0;
pub const PCI_PC1_OFFSET: c_uint = 0xb4;
pub const PCI_PC6_OFFSET: c_uint = 0xb8;
pub const PCI_MONITOR_ENABLE_REG: c_uint = 0xe0;
pub const PCI_NON_PC0_ENABLE_BIT: c_int = 0;
pub const PCI_PC1_ENABLE_BIT: c_int = 1;
pub const PCI_PC6_ENABLE_BIT: c_int = 2;
pub const PCI_NBP1_STAT_OFFSET: c_uint = 0x98;
pub const PCI_NBP1_ACTIVE_BIT: c_int = 2;
pub const PCI_NBP1_ENTERED_BIT: c_int = 1;
pub const PCI_NBP1_CAP_OFFSET: c_uint = 0x90;
pub const PCI_NBP1_CAPABLE_BIT: c_int = 31;
...
unsafe extern "C" fn is_nbp1_capable() -> c_int {
    ...
    MONITOR_NAME_LEN - 1);
#[no_mangle]
pub unsafe extern "C" fn if(0x12: cpupower_cpu_info.family ==) -> else {
...
// We need PCI device: Slot 18, Func 6, compare with BKDG
    ...
    if (amd_fam14h_pci_dev == core::ptr::null_mut() || pci_acc == core::ptr::null_mut())
    return core::ptr::null_mut();
    if (!is_nbp1_capable())
