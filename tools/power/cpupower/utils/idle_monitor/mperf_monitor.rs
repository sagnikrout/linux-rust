...
//! Source: tools/power/cpupower/utils/idle_monitor/mperf_monitor.c
#![no_std]
...
pub const MSR_APERF: c_uint = 0xE8;
pub const MSR_MPERF: c_uint = 0xE7;

pub const RDPRU_ECX_MPERF: c_int = 0;
pub const RDPRU_ECX_APERF: c_int = 1;
