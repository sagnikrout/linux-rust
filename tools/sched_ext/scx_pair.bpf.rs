...
//! Source: tools/sched_ext/scx_pair.bpf.c
#![no_std]
...
// !0 for veristat, set during init
    let mut nr_cpu_ids: volatile u32 = 1;
...
pub struct cgrp_q {
    ...
    pub MAX_QUEUED): __uint(max_entries,,
    pub u32): __type(value,,
}
...
// statistics
    ...
    UEI_DEFINE(uei);
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: pair_enqueue, p: *mut task_struct, enq_flags: u64) {
...
#[no_mangle]
unsafe extern "C" fn lookup_pairc_and_mask(cpu: i32, pairc: *mut pair_ctx, mask: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pair_task_is_highpri(p: *mut task_struct) -> bool {
...
#[no_mangle]
unsafe extern "C" fn try_dispatch(cpu: i32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: pair_dispatch, cpu: i32, prev: *mut task_struct) {
    ...
    {
    int ret;
    let mut cpu: i32 = bpf_get_smp_processor_id();
    u32 in_pair_mask;
    struct pair_ctx *pairc;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: pair_cgroup_init, cgrp: *mut cgroup) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: pair_cgroup_exit, cgrp: *mut cgroup) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: pair_exit, ei: *mut scx_exit_info) {
