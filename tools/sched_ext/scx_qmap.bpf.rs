...
//! Source: tools/sched_ext/scx_qmap.bpf.c
#![no_std]
...
// Per-queue locks. Each in its own .data section as bpf_res_spin_lock requires.
    ...
    default: return core::ptr::null_mut();
    }
    }
//
...
#[derive(Copy, Clone)]
pub struct task_ctx {
    pub /: *mut *mut *mut task_ctx __arena next_free; / only valid on free list,
    pub /: *mut *mut *mut task_ctx __arena q_next; / queue link, NULL if tail,
    pub /: *mut *mut *mut task_ctx __arena q_prev; / queue link, NULL if head,
    pub /: *mut *mut *mut qmap_fifo __arena fifo; / queue we're on, NULL if not queued,
    pub tid: u64,
    pub /: *mut *mut s32 pid; / for dump only,
    pub /: *mut *mut bool force_local; / Dispatch directly to local_dsq,
    pub highpri: bool,
    pub core_sched_seq: u64,
    pub /: *mut *mut scx_cmask cpus_allowed; / per-task affinity in cid space,
}
...
#[no_mangle]
unsafe extern "C" fn qmap_spin_lock(lock: *mut bpf_res_spin_lock) -> c_int {
...
//
pub const IDLE_PICK_RETRIES: c_int = 16;
    static s32 pick_direct_dispatch_cid(struct task_struct *p, s32 prev_cid,
    task_ctx_t *taskc)
    {
    let mut nr_cids: u32 = scx_bpf_nr_cids();
    s32 cid;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn qmap_fifo_enqueue(fifo: *mut qmap_fifo __arena, taskc: *mut task_ctx_t) {
...
#[no_mangle]
unsafe extern "C" fn qmap_fifo_remove(taskc: *mut task_ctx_t) {
...
//
#[no_mangle]
unsafe extern "C" fn needs_immed(cid: i32) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn first_unavail_cid() -> i32 {
    static s32 first_unavail_cid(void)
    {
    let mut nr_cids: i32 = qa.nr_cids, c;
...
#[no_mangle]
unsafe extern "C" fn weight_to_idx(weight: u32) -> c_int {
...
// Coarsely map the compound weight to a FIFO.
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(50: weight <=) -> else {
    else if (weight <= 50)
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(200: weight <) -> else {
    else if (weight < 200)
    return 2;
#[no_mangle]
pub unsafe extern "C" fn if(400: weight <) -> else {
    else if (weight < 400)
    return 3;
    else
    return 4;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_enqueue, p: *mut task_struct, enq_flags: u64) {
    void BPF_STRUCT_OPS(qmap_enqueue, struct task_struct *p, u64 enq_flags)
    {
    static u32 user_cnt, kernel_cnt;
    task_ctx_t *taskc;
    let mut idx: c_int = weight_to_idx(p.scx.weight);
    s32 cid;
    if (enq_flags & SCX_ENQ_REENQ) {
    let mut reason: u64 = p.scx.flags & SCX_TASK_REENQ_REASON_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn if(SCX_TASK_REENQ_IMMED: reason ==) -> else {
...
//
    ...
    let mut c: i32 = cmask_next_set_wrap(&taskc.cpus_allowed, 0);
...
//
    ...
    static u32 inj_cnt;
    if (!(++inj_cnt % 64)) {
    let mut bad: i32 = first_unavail_cid();
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_dequeue, p: *mut task_struct, deq_flags: u64) {
...
#[no_mangle]
unsafe extern "C" fn update_core_sched_head_seq(p: *mut task_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn scan_shared_dsq(from_timer: bool) -> bool {
    static bool scan_shared_dsq(bool from_timer)
    {
    struct task_struct *p;
    let mut this_cid: i32 = scx_bpf_this_cid();
    let mut nr_cids: u32 = scx_bpf_nr_cids();
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_dispatch, cid: i32, prev: *mut task_struct) {
    void BPF_STRUCT_OPS(qmap_dispatch, s32 cid, struct task_struct *prev)
    {
    struct task_struct *p;
    struct cpu_ctx __arena *cpuc;
    task_ctx_t *taskc;
    let mut batch: u32 = dsp_batch ?: 1;
    s32 owner, i;
...
// route to the live rr holder (0 = self, runs below)
    let mut pos: i32 = qa.part.rr_pos;
    ...
    let mut cgid: u64 = qa.sub_sched_ctxs[owner].cgroup_id;
    if (cgid) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_tick, p: *mut task_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn task_qdist(p: *mut task_struct, taskc: *mut task_ctx_t) -> i64 {
...
// pop a slab entry off the free list
    ...
    bpf_rcu_read_unlock();
    v = bpf_task_storage_get(&task_ctx_stor, p, core::ptr::null_mut(),
...
// push back to the free list
    ...
    struct task_ctx_stor_val *v;
    task_ctx_t *taskc;
    v = bpf_task_storage_get(&task_ctx_stor, p, core::ptr::null_mut(), 0);
    if (!v || !v.taskc)
    return;
    taskc = v.taskc;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_dump, dctx: *mut scx_dump_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_dump_cid, dctx: *mut scx_dump_ctx, cid: i32, idle: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_dump_task, dctx: *mut scx_dump_ctx, p: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_cpuctl_init, cgrp: *mut cgroup, args: *mut scx_cgroup_init_args) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_cpuctl_set_weight, cgrp: *mut cgroup, weight: u32) {
    void BPF_STRUCT_OPS(qmap_cpuctl_set_weight, struct cgroup *cgrp, u32 weight)
    {
    let mut cgid: u64 = cgrp.kn.id;
    s32 i;
    QMAP_TOUCH_ARENA();
    if (print_msgs)
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_update_idle, cid: i32, idle: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn monitor_cpuperf() {
    static void monitor_cpuperf(void)
    {
    let mut nr_online: u32 = scx_bpf_nr_online_cids();
    let mut cap_sum: u64 = 0, cur_sum = 0, cur_min = SCX_CPUPERF_ONE, cur_max = 0;
    let mut target_sum: u64 = 0, target_min = SCX_CPUPERF_ONE, target_max = 0;
    s32 cid;
    QMAP_TOUCH_ARENA();
    bpf_for(cid, 0, nr_online) {
    struct cpu_ctx __arena *cpuc = &qa.cpu_ctxs[cid];
    let mut cap: u32 = scx_bpf_cidperf_cap(cid);
    let mut cur: u32 = scx_bpf_cidperf_cur(cid);
    u32 target;
...
//
#[no_mangle]
unsafe extern "C" fn dump_shared_dsq() {
...
#[no_mangle]
unsafe extern "C" fn monitor_timerfn(map: *mut c_void, key: *mut c_int, timer: *mut bpf_timer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lowpri_timerfn(map: *mut c_void, key: *mut c_int, timer: *mut bpf_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn part_try_start() -> bool {
...
pub struct participant {
    pub /: *mut *mut s32 slot; / child slot, or CID_SELF,
    pub /: *mut *mut u32 weight; / cpu.weight,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn place_one(cid: i32, n: i32, total_excl: i32) -> __noinline int {
    __noinline int place_one(s32 cid, s32 n, s32 total_excl)
    {
    let mut owner: i32 = CID_SELF, i, s;
...
//
#[no_mangle]
pub unsafe extern "C" fn compute_partition() -> __noinline void {
    __noinline void compute_partition(void)
    {
    let mut nr_cids: i32 = qa.nr_cids;
...
//
    ...
    bpf_for(i, 0, MAX_SUB_SCHEDS) {
    let mut cgid: u64 = cgid_snap[i];
    let mut w: i32 = w_snap[i];
...
//
#[no_mangle]
unsafe extern "C" fn account_alloc() -> __noinline void {
    static __noinline void account_alloc(void)
    {
    let mut now: u64 = bpf_ktime_get_ns();
    let mut rr_owner: i32 = CID_SELF;
    let mut nr_cids: i32 = qa.nr_cids;
    u64 delta;
    s32 cid, i;
...
// resolve the live shared-pool holder to an owner id
    ...
    let mut pos: u32 = qa.part.rr_pos;
    let mut cgid: u64 = pos < MAX_PARTS ? qa.part.rr_slots[pos] : 0;
    if (cgid) {
    rr_owner = CID_NONE;
    bpf_for(i, 0, MAX_SUB_SCHEDS)
    if (qa.sub_sched_ctxs[i].cgroup_id == cgid)
    ...
    bpf_for(cid, 0, nr_cids) {
    let mut owner: i32 = qa.part.cid_owner[cid];
    if (owner == CID_SHARED)
    owner = rr_owner;
    if (owner >= 0 && owner < MAX_SUB_SCHEDS)
    qa.alloc_ns[owner] += delta;
#[no_mangle]
pub unsafe extern "C" fn if(CID_SELF: owner ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn apply_partition() -> __noinline void {
    __noinline void apply_partition(void)
    {
    let mut nr_cids: i32 = qa.nr_cids;
    let mut nr_shared: i32 = qa.part.nr_shared;
    s32 i, cid;
    if (nr_cids < 0 || nr_cids > SCX_QMAP_MAX_CPUS ||
...
//
    ...
    let mut cgid: u64 = ssc.cgroup_id;
    if (!cgid)
    continue;
    ...
    SCX_CAP_ENQ_IMMED | SCX_CAP_PERF,
    &qa.to_grant_cids.mask, core::ptr::null_mut());
    }
// the current holder of the shared pool gets ENQ_IMMED on all of it
    ...
    SCX_CAP_ENQ_IMMED | SCX_CAP_PERF,
    &qa.rr_cids.mask, core::ptr::null_mut());
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn redistribute() {
    static void redistribute(void)
    {
    s32 i;
...
//
    SEC("syscall")
#[no_mangle]
pub unsafe extern "C" fn flush_alloc(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn round_robin_timerfn(map: *mut c_void, key: *mut c_int, timer: *mut bpf_timer) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS_SLEEPABLE(_arg: qmap_init_cids) -> i32 {
    s32 BPF_STRUCT_OPS_SLEEPABLE(qmap_init_cids)
    {
    let mut nr_cpu_ids: u32 = scx_bpf_nr_cpu_ids();
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS_SLEEPABLE(_arg: qmap_init) -> i32 {
...
//
    ...
    slab = bpf_arena_alloc_pages(&arena, core::ptr::null_mut(), nr_pages, NUMA_NO_NODE, 0);
    if (!slab) {
    ...
    (task_ctx_t *)(slab + (i + 1) * TASK_CTX_STRIDE) : core::ptr::null_mut();
    cur.next_free = next;
    }
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_exit, ei: *mut scx_exit_info) {
...
//
#[no_mangle]
unsafe extern "C" fn cgrp_cur_weight(cgid: u64) -> u32 {
    ...
    let mut w: u32 = BPF_CORE_READ(tg, scx.weight);
    if (w)
    weight = w;
    }
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_sub_attach, args: *mut scx_sub_attach_args) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_sub_detach, args: *mut scx_sub_detach_args) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_sub_caps_updated, cmask: *const scx_cmask, caps: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: qmap_sub_ecaps_updated, cid: i32, before: u64, after: u64) {
