...
//! Source: tools/sched_ext/scx_flatcg.bpf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn stat_inc(idx: enum fcg_stat_idx) {
    static void stat_inc(enum fcg_stat_idx idx)
    {
    let mut idx_v: u32 = idx;
...
// gets inc'd on weight tree changes to expire the cached hweights
    let mut hweight_gen: u64 = 1;
#[no_mangle]
unsafe extern "C" fn div_round_up(dividend: u64, divisor: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn cgrp_refresh_hweight(cgrp: *mut cgroup, cgc: *mut fcg_cgrp_ctx) {
...
#[no_mangle]
unsafe extern "C" fn cgrp_cap_budget(cgv_node: *mut cgv_node, cgc: *mut fcg_cgrp_ctx) {
...
#[no_mangle]
unsafe extern "C" fn cgrp_enqueued(cgrp: *mut cgroup, cgc: *mut fcg_cgrp_ctx) {
...
// NULL if the node is already on the rbtree
    cgv_node = bpf_kptr_xchg(&stash.node, core::ptr::null_mut());
    if (!cgv_node) {
...
#[no_mangle]
unsafe extern "C" fn set_bypassed_at(p: *mut task_struct, taskc: *mut fcg_task_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_select_cpu, p: *mut task_struct, prev_cpu: i32, wake_flags: u64) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_enqueue, p: *mut task_struct, enq_flags: u64) {
...
//
    ...
    let mut tvtime: u64 = p.scx.dsq_vtime;
//
...
//
#[no_mangle]
unsafe extern "C" fn update_active_weight_sums(cgrp: *mut cgroup, runnable: bool) {
...
// propagate upwards
    ...
    let mut level: c_int = cgrp.level - idx;
    struct fcg_cgrp_ctx *cgc, *pcgc = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_runnable, p: *mut task_struct, enq_flags: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_running, p: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_stopping, p: *mut task_struct, runnable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_quiescent, p: *mut task_struct, deq_flags: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_cgroup_set_weight, cgrp: *mut cgroup, weight: u32) {
...
#[no_mangle]
unsafe extern "C" fn try_pick_next_cgroup(cgidp: *mut u64) -> bool {
...
//
    ...
    if (cgv_node) {
    scx_bpf_error("unexpected !core::ptr::null_mut() cgv_node stash");
    goto out_free;
    }
    }
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_dispatch, cpu: i32, prev: *mut task_struct) {
    void BPF_STRUCT_OPS(fcg_dispatch, s32 cpu, struct task_struct *prev)
    {
    struct fcg_cpu_ctx *cpuc;
    struct fcg_cgrp_ctx *cgc;
    struct cgroup *cgrp;
    let mut now: u64 = scx_bpf_now();
    let mut picked_next: bool = false;
    cpuc = find_cpu_ctx();
    if (!cpuc)
    return;
    if (!cpuc.cur_cgid)
...
//
    let mut delta: i64 = now - cpuc.cur_at - cgrp_slice_ns;
    bpf_spin_lock(&cgv_tree_lock);
...
//
    ...
    struct fcg_cgrp_ctx *cgc;
    struct cgv_node *cgv_node;
    let mut empty_stash: cgv_node_stash = {}, *stash;
    let mut cgid: u64 = cgrp.kn.id;
    int ret;
//
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_cgroup_exit, cgrp: *mut cgroup) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS_SLEEPABLE(_arg: fcg_init) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: fcg_exit, ei: *mut scx_exit_info) {
