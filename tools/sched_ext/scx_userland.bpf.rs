...
//! Source: tools/sched_ext/scx_userland.bpf.c
#![no_std]
...
//
pub const MAX_ENQUEUED_TASKS: c_int = 4096;
    char _license[] SEC("license") = "GPL";
    const volatile s32 usersched_pid;
// !0 for veristat, set during init
    let mut num_possible_cpus: volatile u32 = 64;
...
#[derive(Copy, Clone)]
pub struct task_ctx {
    pub /: *mut *mut bool force_local; / Dispatch directly to local DSQ,
}
...
//
#[no_mangle]
unsafe extern "C" fn set_usersched_needed() {
...
//
#[no_mangle]
unsafe extern "C" fn test_and_clear_usersched_needed() -> bool {
    static bool test_and_clear_usersched_needed(void)
    {
    return __sync_fetch_and_and(&usersched_needed, 0) == 1;
    }
#[no_mangle]
unsafe extern "C" fn is_usersched_task(p: *const task_struct) -> bool {
    static bool is_usersched_task(const struct task_struct *p)
    {
    return p.pid == usersched_pid;
    }
#[no_mangle]
unsafe extern "C" fn keep_in_kernel(p: *const task_struct) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dispatch_user_scheduler() {
...
#[no_mangle]
unsafe extern "C" fn enqueue_task_in_user_space(p: *mut task_struct, enq_flags: u64) {
    static void enqueue_task_in_user_space(struct task_struct *p, u64 enq_flags)
    {
    let mut task: scx_userland_enqueued_task = {};
    task.pid = p.pid;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: userland_enqueue, p: *mut task_struct, enq_flags: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: userland_dispatch, cpu: i32, prev: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: userland_update_idle, cpu: i32, idle: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: userland_init) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: userland_exit, ei: *mut scx_exit_info) {
