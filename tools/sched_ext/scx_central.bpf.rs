...
//! Source: tools/sched_ext/scx_central.bpf.c
#![no_std]
...
//
    ...
    let mut timer_pinned: bool = true;
    bool timer_started;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: central_enqueue, p: *mut task_struct, enq_flags: u64) {
    void BPF_STRUCT_OPS(central_enqueue, struct task_struct *p, u64 enq_flags)
    {
    let mut pid: i32 = p.pid;
...
#[no_mangle]
unsafe extern "C" fn dispatch_to_cpu(cpu: i32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn start_central_timer() {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: central_dispatch, cpu: i32, prev: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: central_running, p: *mut task_struct) {
    void BPF_STRUCT_OPS(central_running, struct task_struct *p)
    {
    let mut cpu: i32 = scx_bpf_task_cpu(p);
    u64 *started_at = ARRAY_ELEM_PTR(cpu_started_at, cpu, nr_cpu_ids);
    if (started_at)
// started_at = scx_bpf_now() ?: 1;	/* 0 indicates idle
    }
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: central_stopping, p: *mut task_struct, runnable: bool) {
...
#[no_mangle]
unsafe extern "C" fn central_timerfn(map: *mut c_void, key: *mut c_int, timer: *mut bpf_timer) -> c_int {
    ...
    let mut cpu: i32 = (nr_timers + i) % nr_cpu_ids;
    u64 *started_at;
    if (cpu == central_cpu)
    continue;
...
// and there's something pending
    ...
    ;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nr_to_kick) -> else {
    else if (nr_to_kick)
    nr_to_kick--;
    else
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS_SLEEPABLE(_arg: central_init) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: central_exit, ei: *mut scx_exit_info) {
