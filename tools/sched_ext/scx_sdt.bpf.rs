...
//! Source: tools/sched_ext/scx_sdt.bpf.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn scx_arena_subprog_init() -> __hidden void {
...
// If the chunk is spent, get a new one.
    ...
    slab = bpf_arena_alloc_pages(&arena, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn pool_set_size(pool: *mut sdt_pool, data_size: __u64, nr_pages: __u64) -> c_int {
...
//
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn set_idx_state(desc: *mut sdt_desc_t, pos: __u64, state: bool) -> c_int {
    ...
    static __noinline
#[no_mangle]
pub unsafe extern "C" fn mark_nodes_avail(lv_desc[SDT_TASK_LEVELS]: *mut sdt_desc_t, lv_pos[SDT_TASK_LEVELS]: __u64) -> c_int {
...
//
    __hidden
#[no_mangle]
pub unsafe extern "C" fn scx_alloc_free_idx(alloc: *mut scx_allocator, idx: __u64) -> c_int {
    int scx_alloc_free_idx(struct scx_allocator *alloc, __u64 idx)
    {
    let mut mask: __u64 = (1 << SDT_TASK_ENTS_PER_PAGE_SHIFT) - 1;
...
// To appease the verifier.
    ...
    lv_desc[level] = core::ptr::null_mut();
    lv_pos[level] = 0;
    }
...
// Zero out one word at a time.
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn ffs(word: __u64) -> c_int {
    int ffs(__u64 word)
    {
...
// find the first empty slot
    __hidden
#[no_mangle]
pub unsafe extern "C" fn chunk_find_empty(desc: *mut sdt_desc_t __arg_arena) -> __u64 {
...
//
#[no_mangle]
unsafe extern "C" fn desc_find_empty(desc: *mut sdt_desc_t, idxp: *mut __u64) -> *mut sdt_desc_t {
...
// idxp = idx;
    ...
    {
    struct sdt_data __arena *data = core::ptr::null_mut();
    struct sdt_chunk __arena *chunk;
    sdt_desc_t *desc;
    __u64 idx, pos;
    if (!alloc)
...
// We unlock if we encounter an error in the function.
    ...
    if (unlikely(desc == core::ptr::null_mut())) {
    bpf_spin_unlock(&alloc_lock);
    return core::ptr::null_mut();
    }
    chunk = desc.chunk;
...
pub struct scx_task_map_val {
    pub tid: union sdt_id,
    pub tptr: __u64,
    pub data: *mut sdt_data __arena,
}
    ...
    __hidden
#[no_mangle]
pub unsafe extern "C" fn scx_task_init(data_size: __u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: sdt_select_cpu, p: *mut task_struct, prev_cpu: i32, wake_flags: u64) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: sdt_enqueue, p: *mut task_struct, enq_flags: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: sdt_dispatch, cpu: i32, prev: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS_SLEEPABLE(_arg: sdt_init) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_STRUCT_OPS(_arg: sdt_exit, ei: *mut scx_exit_info) {
