...
//! Source: tools/accounting/procacct.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn print_procacct(t: *mut taskstats) {
...
#[no_mangle]
pub unsafe extern "C" fn handle_aggr(mother: c_int, na: *mut nlattr, fd: c_int) {
    void handle_aggr(int mother, struct nlattr *na, int fd)
    {
    let mut aggr_len: c_int = NLA_PAYLOAD(na.nla_len);
...
pub unsafe extern "C" fn main(argc: c_int, argv[]: *mut c_char) -> c_int {
    ...
    let mut mother: c_int = na.nla_type;
    PRINTF("mother=%i\n", mother);
    switch (na.nla_type) {
