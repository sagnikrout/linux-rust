...
//! Source: tools/accounting/getdelays.c
#![no_std]
...
pub const MAX_MSG_SIZE: c_int = 2048;
// Maximum number of cpus expected to be specified in a cpumask
pub const MAX_CPUS: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
...
//
#[no_mangle]
unsafe extern "C" fn create_nl_socket(protocol: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn recv_taskstats_msg(sd: c_int, msg: *mut msgtemplate) -> c_int {
...
// Use thread-safe localtime_r
    if (localtime_r(&time_sec, &tm_info) == core::ptr::null_mut())
    return "N/A";
...
#[no_mangle]
unsafe extern "C" fn print_delayacct(t: *mut taskstats) {
...
#[no_mangle]
unsafe extern "C" fn task_context_switch_counts(t: *mut taskstats) {
...
#[no_mangle]
unsafe extern "C" fn print_cgroupstats(c: *mut cgroupstats) {
...
#[no_mangle]
unsafe extern "C" fn print_ioacct(t: *mut taskstats) {
...
pub unsafe extern "C" fn main(argc: c_int, argv[]: *mut c_char) -> c_int {
    ...
    char *logfile = core::ptr::null_mut();
    let mut loop: c_int = 0;
    let mut containerset: c_int = 0;
    char *containerpath = core::ptr::null_mut();
    let mut cfd: c_int = 0;
...
// Block SIGCHLD for sigwait() later
    ...
    sigprocmask(SIG_BLOCK, &sigset, core::ptr::null_mut());
// fork/exec a child
    tid = fork();
    if (tid < 0)
    err(1, "Fork failed\n");
