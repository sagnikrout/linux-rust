...
// -------------------------------------------------------------------------
pub const TEST_CASES: c_int = 30;
// FIXME make these public somewhere; usbdevfs.h?
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbtest_param {
// inputs
    pub /: *mut *mut unsigned test_num; / 0..(TEST_CASES-1),
    pub iterations: unsigned,
    pub length: unsigned,
    pub vary: unsigned,
    pub sglen: unsigned,
// outputs
...
#[derive(Copy, Clone)]
pub struct testdev {
    pub next: *mut testdev,
    pub name: *mut c_char,
    pub thread: pthread_t,
    pub speed: enum usb_device_speed,
    pub 8: unsigned ifnum :,
    pub 1: unsigned forever :,
    pub test: c_int,
    pub param: usbtest_param,
}

    static struct testdev		*testdevs;
#[no_mangle]
unsafe extern "C" fn testdev_ffs_ifnum(fd: *mut FILE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn testdev_ifnum(fd: *mut FILE) -> c_int {
...
unsafe extern "C" fn find_testdev(name: *const c_char, sb: *const stat, flag: c_int) -> c_int {
    ...
    status  =  ioctl(fd, USBDEVFS_GET_SPEED, core::ptr::null_mut());
    if (status < 0)
...
#[no_mangle]
unsafe extern "C" fn parse_num(num: *mut unsigned, str: *const c_char) -> c_int {
...
pub unsafe extern "C" fn main(argc: c_int, argv: *mut c_char) -> c_int {
    ...
    struct testdev		*entry;
    char			*device;
    const char		*usb_dir = core::ptr::null_mut();
    let mut all: c_int = 0, forever = 0, not = 0;
