...
//! Source: tools/perf/builtin-record.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thread_mask {
    pub maps: mmap_cpu_mask,
    pub affinity: mmap_cpu_mask,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct record_thread {
    pub tid: pid_t,
    pub mask: *mut thread_mask,
    struct {
    pub msg: [c_int; 2],
    pub ack: [c_int; 2],
    pub pipes: },
    ...
    pub nr_mmaps: c_int,
    pub maps: *mut mmap,
    pub overwrite_maps: *mut mmap,
    pub rec: *mut record,
    pub samples: c_ulonglong,
    pub waking: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pollfd_index_map {
    pub evlist_pollfd_index: c_int,
    pub thread_pollfd_index: c_int,
}
...
pub struct record {
    ...
    pub bytes_written: u64,
    pub thread_bytes_written: u64,
    pub data: perf_data,
    pub itr: *mut auxtrace_record,
    ...
    pub latency: bool,
    pub switch_output_event_set: bool,
    pub no_buildid: bool,
    pub no_buildid_set: bool,
    pub no_buildid_cache: bool,
    pub no_buildid_cache_set: bool,
    pub buildid_all: bool,
    pub buildid_mmap: bool,
    pub buildid_mmap_set: bool,
    pub timestamp_filename: bool,
    pub timestamp_boundary: bool,
    pub off_cpu: bool,
    pub filter_action: *const c_char,
    pub uid_str: *const c_char,
    pub switch_output: switch_output,
    pub samples: c_ulonglong,
    pub /: *mut *mut unsigned long output_max_size; / = 0: unlimited,
    pub debuginfod: perf_debuginfod,
    pub nr_threads: c_int,
    pub thread_masks: *mut thread_mask,
    pub thread_data: *mut record_thread,
    pub index_map: *mut pollfd_index_map,
    pub index_map_sz: usize,
    pub index_map_cnt: usize,
}
...
#[no_mangle]
unsafe extern "C" fn record__threads_enabled(rec: *mut record) -> c_int {
    static int record__threads_enabled(struct record *rec)
    {
    return rec.opts.threads_spec;
    }
#[no_mangle]
unsafe extern "C" fn switch_output_signal(rec: *mut record) -> bool {
...
#[no_mangle]
unsafe extern "C" fn switch_output_size(rec: *mut record) -> bool {
...
#[no_mangle]
unsafe extern "C" fn switch_output_time(rec: *mut record) -> bool {
...
#[no_mangle]
unsafe extern "C" fn record__bytes_written(rec: *mut record) -> u64 {
    static u64 record__bytes_written(struct record *rec)
    {
    return rec.bytes_written + rec.thread_bytes_written;
    }
#[no_mangle]
unsafe extern "C" fn record__output_max_size_exceeded(rec: *mut record) -> bool {
...
#[no_mangle]
unsafe extern "C" fn record__aio_complete(md: *mut mmap, cblock: *mut aiocb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__aio_sync(md: *mut mmap, sync_all: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__aio_pushfn(map: *mut mmap, to: *mut c_void, buf: *mut c_void, size: usize) -> c_int {
...
//
    ...
    ssize_t compressed = zstd_compress(aio.rec.session, core::ptr::null_mut(), aio.data + aio.size,
...
#[no_mangle]
unsafe extern "C" fn record__aio_push(rec: *mut record, map: *mut mmap, off: *mut off_t) -> c_int {
    static int record__aio_push(struct record *rec, struct mmap *map, off_t *off)
    {
    int ret, idx;
    let mut trace_fd: c_int = perf_data__fd(rec.session.data);
    let mut aio: record_aio = { .rec = rec, .size = 0 };
//
...
#[no_mangle]
unsafe extern "C" fn record__aio_get_pos(trace_fd: c_int) -> off_t {
    static off_t record__aio_get_pos(int trace_fd)
    {
    return lseek(trace_fd, 0, SEEK_CUR);
    }
#[no_mangle]
unsafe extern "C" fn record__aio_set_pos(trace_fd: c_int, pos: off_t) {
    static void record__aio_set_pos(int trace_fd, off_t pos)
    {
    lseek(trace_fd, pos, SEEK_SET);
    }
#[no_mangle]
unsafe extern "C" fn record__aio_mmap_read_sync(rec: *mut record) {
    ...
    let mut nr_cblocks_default: static int = 1;
    let mut nr_cblocks_max: static int = 4;
    ...
    if (str)
    opts.nr_cblocks = strtol(str, core::ptr::null_mut(), 0);
    if (!opts.nr_cblocks)
    ...
    let mut nr_cblocks_max: static int = 0;
...
#[no_mangle]
unsafe extern "C" fn record__aio_get_pos(__maybe_unused: int trace_fd) -> off_t {
    static off_t record__aio_get_pos(int trace_fd __maybe_unused)
    {
    return -1;
    }
#[no_mangle]
unsafe extern "C" fn record__aio_set_pos(__maybe_unused: int trace_fd, __maybe_unused: off_t pos) {
    static void record__aio_set_pos(int trace_fd __maybe_unused, off_t pos __maybe_unused)
    {
    }
#[no_mangle]
unsafe extern "C" fn record__aio_mmap_read_sync(__maybe_unused: *mut *mut record rec) {
    static void record__aio_mmap_read_sync(struct record *rec __maybe_unused)
    {
    }

#[no_mangle]
unsafe extern "C" fn record__aio_enabled(rec: *mut record) -> c_int {
    static int record__aio_enabled(struct record *rec)
    {
...
pub const MMAP_FLUSH_DEFAULT: c_int = 1;
    ...
    opts.mmap_flush = strtol(str, core::ptr::null_mut(), 0);
    }
    if (!opts.mmap_flush)
    ...
    let mut comp_level_default: static unsigned int = 1;
#[no_mangle]
unsafe extern "C" fn record__parse_comp_level(opt: *const option, str: *const c_char, unset: c_int) -> c_int {
    ...
    if (str)
    opts.comp_level = strtol(str, core::ptr::null_mut(), 0);
    if (!opts.comp_level)
    ...
    let mut comp_level_max: static unsigned int = 22;
#[no_mangle]
unsafe extern "C" fn record__comp_enabled(rec: *mut record) -> c_int {
    static int record__comp_enabled(struct record *rec)
    {
    ...
    return record__write(rec, core::ptr::null_mut(), event, event.header.size);
    }
...
#[no_mangle]
unsafe extern "C" fn record__pushfn(map: *mut mmap, to: *mut c_void, bf: *mut c_void, size: usize) -> c_int {
    ...
    let mut signr: static volatile sig_atomic_t = -1;
    static volatile sig_atomic_t child_finished;

    let mut done_fd: static volatile sig_atomic_t = -1;

#[no_mangle]
unsafe extern "C" fn sig_handler(sig: c_int) {
    ...
    if (done_fd >= 0) {
    let mut tmp: u64 = 1;
    let mut orig_errno: c_int = errno;
//
...
#[no_mangle]
unsafe extern "C" fn record__sig_exit() {
    ...
    off_t file_offset;
    let mut fd: c_int = perf_data__fd(data);
    int err;
...
#[no_mangle]
unsafe extern "C" fn record__auxtrace_read_snapshot_all(rec: *mut record) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__read_auxtrace_snapshot(rec: *mut record, on_exit: bool) {
...
#[no_mangle]
unsafe extern "C" fn record__auxtrace_snapshot_exit(rec: *mut record) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__auxtrace_init(rec: *mut record) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__config_text_poke(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__config_off_cpu(rec: *mut record) -> c_int {
    static int record__config_off_cpu(struct record *rec)
    {
    return off_cpu_prepare(rec.evlist, &rec.opts.target, &rec.opts);
    }
#[no_mangle]
unsafe extern "C" fn record__tracking_system_wide(rec: *mut record) -> bool {
...
#[no_mangle]
unsafe extern "C" fn record__config_tracking_events(rec: *mut record) -> c_int {
    static int record__config_tracking_events(struct record *rec)
    {
    struct record_opts *opts = &rec.opts;
    struct evlist *evlist = rec.evlist;
    let mut system_wide: bool = false;
    struct evsel *evsel;
//
...
#[no_mangle]
unsafe extern "C" fn record__kcore_readable(machine: *mut machine) -> bool {
...
#[no_mangle]
unsafe extern "C" fn record__kcore_copy(machine: *mut machine, data: *mut perf_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__thread_data_init_pipes(thread_data: *mut record_thread) {
...
#[no_mangle]
unsafe extern "C" fn record__thread_data_open_pipes(thread_data: *mut record_thread) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__thread_data_close_pipes(thread_data: *mut record_thread) {
...
#[no_mangle]
unsafe extern "C" fn evlist__per_thread(evlist: *mut evlist) -> bool {
    static bool evlist__per_thread(struct evlist *evlist)
    {
    return cpu_map__is_dummy(evlist__core(evlist).user_requested_cpus);
    }
#[no_mangle]
unsafe extern "C" fn record__thread_data_init_maps(thread_data: *mut record_thread, evlist: *mut evlist) -> c_int {
    ...
    let mut per_thread: bool = evlist__per_thread(evlist);
    if (per_thread)
...
#[no_mangle]
unsafe extern "C" fn record__thread_data_init_pollfd(thread_data: *mut record_thread, evlist: *mut evlist) -> c_int {
    ...
    map = thread_data.maps ? thread_data.maps[tm] : core::ptr::null_mut();
    overwrite_map = thread_data.overwrite_maps ?
    thread_data.overwrite_maps[tm] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn record__free_thread_data(rec: *mut record) {
    static void record__free_thread_data(struct record *rec)
    {
    int t;
    struct record_thread *thread_data = rec.thread_data;
    if (thread_data == core::ptr::null_mut())
    return;
    ...
    {
    let mut x: usize = rec.index_map_cnt;
    if (realloc_array_as_needed(rec.index_map, rec.index_map_sz, x, core::ptr::null_mut()))
    return -ENOMEM;
    ...
    let mut e_pos: c_int = rec.index_map[i].evlist_pollfd_index;
    let mut t_pos: c_int = rec.index_map[i].thread_pollfd_index;
...
#[no_mangle]
unsafe extern "C" fn record__alloc_thread_data(rec: *mut record, evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__mmap(rec: *mut record) -> c_int {
    static int record__mmap(struct record *rec)
    {
    return record__mmap_evlist(rec, rec.evlist);
    }
#[no_mangle]
unsafe extern "C" fn record__open(rec: *mut record) -> c_int {
    ...
    let mut removed_tracking: bool = false;
...
//
    ...
    let mut report_error: bool = true;
...
//
    ...
    struct evsel *tmp;
    let mut idx: c_int = 0;
    let mut evlist_empty: bool = true;
...
#[no_mangle]
unsafe extern "C" fn set_timestamp_boundary(rec: *mut record, sample_time: u64) {
...
#[no_mangle]
unsafe extern "C" fn process_buildids(rec: *mut record) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_event__synthesize_guest_os(machine: *mut machine, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn record__adjust_affinity(rec: *mut record, map: *mut mmap) {
...
//
    ...
    let mut size: usize = sizeof(*event);
    if (data_size) {
    size_t padding;
...
//
    ...
    {
    let mut bytes_written: u64 = rec.bytes_written;
    int i;
    let mut rc: c_int = 0;
    int nr_mmaps;
    struct mmap **maps;
    let mut trace_fd: c_int = perf_data__fd(&rec.data);
    let mut off: off_t = 0;
    if (!evlist)
    return 0;
...
//
    ...
    rc = record__write(rec, core::ptr::null_mut(), &finished_round_event, sizeof(finished_round_event));
    if (overwrite)
...
#[no_mangle]
unsafe extern "C" fn record__mmap_read_all(rec: *mut record, synch: bool) -> c_int {
    ...
    {
    let mut msg: enum thread_msg = THREAD_MSG__READY;
    ...
    for (;;) {
    let mut hits: c_ulonglong = thread.samples;
...
//
    ...
    record__thread_munmap_filtered, core::ptr::null_mut()) == 0)
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn record__init_features(rec: *mut record) {
...
#[no_mangle]
unsafe extern "C" fn record__synthesize_workload(rec: *mut record, tail: bool) -> c_int {
    static int record__synthesize_workload(struct record *rec, bool tail)
    {
    int err;
    struct perf_thread_map *thread_map;
    let mut needs_mmap: bool = rec.opts.synth & PERF_SYNTH_MMAP;
    if (rec.opts.tail_synthesize != tail)
    return 0;
    thread_map = thread_map__new_by_tid(evlist__workload_pid(rec.evlist));
    if (thread_map == core::ptr::null_mut())
    return -1;
...
#[no_mangle]
unsafe extern "C" fn write_finished_init(rec: *mut record, tail: bool) -> c_int {
    static int write_finished_init(struct record *rec, bool tail)
    {
    if (rec.opts.tail_synthesize != tail)
    return 0;
    return record__write(rec, core::ptr::null_mut(), &finished_init_event, sizeof(finished_init_event));
    }
    ...
    {
    struct perf_data *data = &rec.data;
    char *new_filename = core::ptr::null_mut();
    int fd, err;
// Same Size:      "2015122520103046"
    ...
    let mut n: c_int = rec.switch_output.cur_file + 1;
...
//
    ...
    record__write(rec, core::ptr::null_mut(), lost, lost.header.size);
    perf_sample__exit(&sample);
    }
#[no_mangle]
unsafe extern "C" fn record__read_lost_samples(rec: *mut record) {
...
// there was an error during record__open
    if (session.evlist == core::ptr::null_mut())
    return;
    evlist__for_each_entry(session.evlist, evsel) {
    struct xyarray *xy = evsel.core.sample_id;
    u64 lost_count;
    if (xy == core::ptr::null_mut() || evsel.core.fd == core::ptr::null_mut())
    continue;
...
#[no_mangle]
unsafe extern "C" fn record__synthesize(rec: *mut record, tail: bool) -> c_int {
    static int record__synthesize(struct record *rec, bool tail)
    {
    struct perf_session *session = rec.session;
    ...
    let mut err: c_int = 0;
    let mut f: event_op = process_synthesized_event;
    if (rec.opts.tail_synthesize != tail)
    return 0;
    if (data.is_pipe) {
...
// Synthesize id_index before auxtrace_info
    ...
    process_synthesized_event, core::ptr::null_mut());
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn record__synthesize_final_bpf_metadata(__maybe_unused: *mut *mut record rec) {
...
#[no_mangle]
unsafe extern "C" fn record__process_signal_event(__maybe_unused: *mut *mut union perf_event event, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__setup_sb_evlist(rec: *mut record) -> c_int {
    static int record__setup_sb_evlist(struct record *rec)
    {
    struct record_opts *opts = &rec.opts;
    if (rec.sb_evlist != core::ptr::null_mut()) {
//
...
//
    ...
    rec.sb_evlist = core::ptr::null_mut();
    return -1;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn record__init_clock(rec: *mut record) -> c_int {
    ...
    if (gettimeofday(&ref_tod, core::ptr::null_mut()) != 0) {
...
#[no_mangle]
unsafe extern "C" fn hit_auxtrace_snapshot_trigger(rec: *mut record) {
...
#[no_mangle]
unsafe extern "C" fn record__terminate_thread(thread_data: *mut record_thread) -> c_int {
    static int record__terminate_thread(struct record_thread *thread_data)
    {
    int err;
    let mut ack: enum thread_msg = THREAD_MSG__UNDEFINED;
    let mut tid: pid_t = thread_data.tid;
    close(thread_data.pipes.msg[1]);
    thread_data.pipes.msg[1] = -1;
...
#[no_mangle]
unsafe extern "C" fn record__start_threads(rec: *mut record) -> c_int {
    ...
    let mut msg: enum thread_msg = THREAD_MSG__UNDEFINED;
    ...
    if (sigprocmask(SIG_SETMASK, &mask, core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn record__stop_threads(rec: *mut record) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__waking(rec: *mut record) -> c_ulong {
    static unsigned long record__waking(struct record *rec)
    {
    int t;
    let mut waking: c_ulong = 0;
    struct record_thread *thread_data = rec.thread_data;
    for (t = 0; t < rec.nr_threads; t++)
...
#[no_mangle]
unsafe extern "C" fn __cmd_record(rec: *mut record, argc: c_int, argv: *const c_char) -> c_int {
    ...
    let mut disabled: bool = false, draining = false;
    int fd;
    let mut ratio: float = 0;
    let mut cmd: enum evlist_ctl_cmd = EVLIST_CTL_CMD_UNSUPPORTED;
    struct perf_env *env;
...
// mmap read already failed — retrying would just fail again
    ...
    status = err;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: WIFEXITED(exit_status)) -> else {
    else if (WIFEXITED(exit_status))
    status = WEXITSTATUS(exit_status);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: WIFSIGNALED(exit_status)) -> else {
...
#[no_mangle]
unsafe extern "C" fn perf_record_config(var: *const c_char, value: *const c_char, cb: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(value, _arg: "no-cache")) -> else {
    else if (!strcmp(value, "no-cache"))
    rec.no_buildid_cache = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(value, _arg: "skip")) -> else {
    else if (!strcmp(value, "skip"))
    rec.no_buildid = rec.no_buildid_cache = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(value, _arg: "mmap")) -> else {
    else if (!strcmp(value, "mmap"))
    rec.buildid_mmap = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(value, _arg: "no-mmap")) -> else {
    ...
    rec.opts.nr_cblocks = strtol(value, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn record__parse_event_enable_time(opt: *const option, str: *const c_char, unset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__parse_affinity(opt: *const option, str: *const c_char, unset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(str, _arg: "cpu")) -> else {
    else if (!strcasecmp(str, "cpu"))
    opts.affinity = PERF_AFFINITY_CPU;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn record__mmap_cpu_mask_alloc(mask: *mut mmap_cpu_mask, nr_bits: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__mmap_cpu_mask_free(mask: *mut mmap_cpu_mask) {
    static void record__mmap_cpu_mask_free(struct mmap_cpu_mask *mask)
    {
    bitmap_free(mask.bits);
    mask.bits = core::ptr::null_mut();
    mask.nbits = 0;
    }
#[no_mangle]
unsafe extern "C" fn record__thread_mask_alloc(mask: *mut thread_mask, nr_bits: c_int) -> c_int {
    static int record__thread_mask_alloc(struct thread_mask *mask, int nr_bits)
    {
    int ret;
    ret = record__mmap_cpu_mask_alloc(&mask.maps, nr_bits);
    if (ret) {
    mask.affinity.bits = core::ptr::null_mut();
    return ret;
    }
    ret = record__mmap_cpu_mask_alloc(&mask.affinity, nr_bits);
    if (ret) {
    record__mmap_cpu_mask_free(&mask.maps);
    mask.maps.bits = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn record__thread_mask_free(mask: *mut thread_mask) {
...
#[no_mangle]
unsafe extern "C" fn record__parse_threads(opt: *const option, str: *const c_char, unset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn switch_output_size_warn(rec: *mut record) {
    static void switch_output_size_warn(struct record *rec)
    {
    let mut wakeup_size: u64 = evlist__mmap_size(rec.opts.mmap_pages);
...
#[no_mangle]
unsafe extern "C" fn switch_output_setup(rec: *mut record) -> c_int {
...
//
    ...
    core::ptr::null_mut(), "don't record events from perf itself",
    exclude_perf),
    ...
    OPT_CALLBACK_NOOPT('g', core::ptr::null_mut(), &record.opts,
    core::ptr::null_mut(), "enables call-graph recording" ,
    ...
    OPT_CALLBACK_OPTARG('I', "intr-regs", &record.opts.sample_intr_regs, core::ptr::null_mut(), "any register",
    "sample selected machine registers on interrupt,"
    " use '-I?' to list register names", parse_intr_regs),
    OPT_CALLBACK_OPTARG(0, "user-regs", &record.opts.sample_user_regs, core::ptr::null_mut(), "any register",
    ...
    "system"),
    OPT_CALLBACK_OPTARG(0, "threads", &record.opts, core::ptr::null_mut(), "spec",
...
#[no_mangle]
unsafe extern "C" fn record__mmap_cpu_mask_init(mask: *mut mmap_cpu_mask, cpus: *mut perf_cpu_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__mmap_cpu_mask_init_spec(mask: *mut mmap_cpu_mask, mask_spec: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__free_thread_masks(rec: *mut record, nr_threads: c_int) {
...
#[no_mangle]
unsafe extern "C" fn record__alloc_thread_masks(rec: *mut record, nr_threads: c_int, nr_bits: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__init_thread_cpu_masks(rec: *mut record, cpus: *mut perf_cpu_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__init_thread_core_masks(rec: *mut record, cpus: *mut perf_cpu_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__init_thread_package_masks(rec: *mut record, cpus: *mut perf_cpu_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__init_thread_numa_masks(rec: *mut record, cpus: *mut perf_cpu_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__init_thread_user_masks(rec: *mut record, cpus: *mut perf_cpu_map) -> c_int {
    static int record__init_thread_user_masks(struct record *rec, struct perf_cpu_map *cpus)
    {
    int t, ret;
    u32 s, nr_spec = 0;
    char **maps_spec = core::ptr::null_mut(), **affinity_spec = core::ptr::null_mut(), **tmp_spec;
    char *user_spec, *spec, *spec_ptr, *mask, *mask_ptr, *dup_mask = core::ptr::null_mut();
    for (t = 0, user_spec = (char *)rec.opts.threads_user_spec; ; t++, user_spec = core::ptr::null_mut()) {
    spec = strtok_r(user_spec, ":", &spec_ptr);
    if (spec == core::ptr::null_mut())
    break;
    pr_debug2("threads_spec[%d]: %s\n", t, spec);
    mask = strtok_r(spec, "/", &mask_ptr);
    if (mask == core::ptr::null_mut())
    break;
    ...
    mask = strtok_r(core::ptr::null_mut(), "/", &mask_ptr);
    if (mask == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn record__init_thread_default_masks(rec: *mut record, cpus: *mut perf_cpu_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn record__init_thread_masks(rec: *mut record) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cmd_record(argc: c_int, argv: *const c_char) -> c_int {
...
// Disable eager loading of kernel symbols that adds overhead to perf record.
    ...
    if (rec.evlist == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(rec->filter_action, _arg: "unpin")) -> else {
...
//
    ...
    if (rec.uid_str) {
    let mut uid: uid_t = parse_uid(rec.uid_str);
    if (uid == UINT_MAX) {
...
// Enable ignoring missing threads when -p option is defined.
    ...
    if (rec.opts.target.pid != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn snapshot_sig_handler(__maybe_unused: int sig) {
...
#[no_mangle]
unsafe extern "C" fn alarm_sig_handler(__maybe_unused: int sig) {
