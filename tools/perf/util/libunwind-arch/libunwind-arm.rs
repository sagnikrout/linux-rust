...
//! Source: tools/perf/util/libunwind-arch/libunwind-arm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__flush_access_arm(__maybe_unused: *mut *mut maps maps) {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__finish_access_arm(__maybe_unused: *mut *mut maps maps) {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__unwind_step_arm(__maybe_unused: *mut *mut unwind_info ui) -> c_int {
