...
//! Source: tools/perf/util/libunwind-arch/libunwind-mips.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __get_perf_regnum_for_unw_regnum_mips(__maybe_unused: int unw_regnum) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__flush_access_mips(__maybe_unused: *mut *mut maps maps) {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__finish_access_mips(__maybe_unused: *mut *mut maps maps) {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__unwind_step_mips(__maybe_unused: *mut *mut unwind_info ui) -> c_int {
