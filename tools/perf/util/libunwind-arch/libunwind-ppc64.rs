...
//! Source: tools/perf/util/libunwind-arch/libunwind-ppc64.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __get_perf_regnum_for_unw_regnum_ppc64(__maybe_unused: int unw_regnum) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__flush_access_ppc64(__maybe_unused: *mut *mut maps maps) {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__finish_access_ppc64(__maybe_unused: *mut *mut maps maps) {
...
#[no_mangle]
pub unsafe extern "C" fn __libunwind_arch__unwind_step_ppc64(__maybe_unused: *mut *mut unwind_info ui) -> c_int {
