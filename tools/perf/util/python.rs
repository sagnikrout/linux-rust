...
//! Source: tools/perf/util/python.c
#![no_std]
...
unsafe extern "C" fn pyrf_event__delete(pevent: *mut pyrf_event) {
    ...
    PyVarObject_HEAD_INIT(core::ptr::null_mut(), 0)
    ...
    if (!(pevent.event.header.misc & PERF_RECORD_MISC_MMAP_BUILD_ID))
    Py_RETURN_NONE;
    let mut size: c_int = pevent.event.mmap2.build_id_size;
    if (size > 20)
    size = 20;
...
#[no_mangle]
unsafe extern "C" fn is_tracepoint(pevent: *const pyrf_event) -> bool {
    ...
    PyObject *ret = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(TEP_FIELD_IS_SIGNED: field->flags &) -> else {
    ...
    Py_DECREF(obj);
    return field ? tracepoint_field(pevent, field) : core::ptr::null_mut();
    }
...
unsafe extern "C" fn pyrf_sample_event__resolve_al(pevent: *mut pyrf_event) -> c_int {
    ...
    {
    struct evsel *evsel = pevent.sample.evsel;
    struct evlist *evlist = evsel ? evsel.evlist : core::ptr::null_mut();
    struct perf_session *session = evlist ? evlist__session(evlist) : core::ptr::null_mut();
    if (pevent.al_resolved)
    return 0;
    if (!session)
    return -1;
    ...
    {
    struct pyrf_event *pevent = (void *)self;
    let mut addr: u64 = pevent.sample.ip;
    ...
    result = Py_BuildValue("(sIs#)", core::ptr::null_mut(), 0, core::ptr::null_mut(), (Py_ssize_t)0);
    }
    return result;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_callchain_node {
    PyObject_HEAD
    pub ip: u64,
    pub map: *mut map,
    pub sym: *mut symbol,
...
#[no_mangle]
unsafe extern "C" fn pyrf_callchain_node__delete(pnode: *mut pyrf_callchain_node) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_callchain_frame {
    pub ip: u64,
    pub map: *mut map,
    pub sym: *mut symbol,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_callchain {
    PyObject_HEAD
    pub frames: *mut pyrf_callchain_frame,
    pub nr_frames: u64,
}
...
#[no_mangle]
unsafe extern "C" fn pyrf_callchain__length(obj: *mut PyObject) -> Py_ssize_t {
...
#[no_mangle]
unsafe extern "C" fn pyrf_branch_entry__delete(pentry: *mut pyrf_branch_entry) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_branch_stack {
    PyObject_HEAD
    pub entries: *mut branch_entry,
    pub nr: u64,
}

#[no_mangle]
unsafe extern "C" fn pyrf_branch_stack__delete(pstack: *mut pyrf_branch_stack) {
...
#[no_mangle]
unsafe extern "C" fn pyrf_branch_stack__length(obj: *mut PyObject) -> Py_ssize_t {
    ...
    {
    PyObject *obj = core::ptr::null_mut();
...
unsafe extern "C" fn pyrf_event__setup_types() -> c_int {
    ...
    bool needs_swap;
    if (!machine)
    machine = session ? &session.machines.host : core::ptr::null_mut();
    if (event.header.type >= ARRAY_SIZE(pyrf_event__type) ||
    pyrf_event__type[event.header.type] == core::ptr::null_mut()) {
    ...
    let mut copy_size: usize = event.header.size;
...
// Copy the event for memory safety and initialize variables.
    ...
    pevent.callchain = core::ptr::null_mut();
    pevent.brstack = core::ptr::null_mut();
...
// Parse the sample again so that pointers are within the copied event.
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), PERF_MAX_STACK_DEPTH) == 0) {
...
pub struct pyrf_cpu_map {
    ...
    {
    static char *kwlist[] = { "cpustr", core::ptr::null_mut() };
    char *cpustr = core::ptr::null_mut();
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|s",
    kwlist, &cpustr))
    return -1;
    pcpus.cpus = perf_cpu_map__new(cpustr);
    if (pcpus.cpus == core::ptr::null_mut())
    return -1;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pyrf_cpu_map__delete(pcpus: *mut pyrf_cpu_map) {
...
#[no_mangle]
unsafe extern "C" fn pyrf_cpu_map__length(obj: *mut PyObject) -> Py_ssize_t {
...
#[no_mangle]
unsafe extern "C" fn pyrf_cpu_map__setup_types() -> c_int {
...
pub struct pyrf_thread_map {
    ...
    PyObject *args, PyObject *kwargs)
    {
    static char *kwlist[] = { "pid", "tid", core::ptr::null_mut() };
    let mut pid: c_int = -1, tid = -1;
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|ii",
    kwlist, &pid, &tid))
    return -1;
    pthreads.threads = thread_map__new(pid, tid);
    if (pthreads.threads == core::ptr::null_mut())
    return -1;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pyrf_thread_map__delete(pthreads: *mut pyrf_thread_map) {
...
#[no_mangle]
unsafe extern "C" fn pyrf_thread_map__length(obj: *mut PyObject) -> Py_ssize_t {
...
#[no_mangle]
unsafe extern "C" fn pyrf_thread_map__setup_types() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_pmu__delete(ppmu: *mut pyrf_pmu) {
...
#[no_mangle]
unsafe extern "C" fn add_to_dict(dict: *mut PyObject, key: *const c_char, value: *const c_char) -> bool {
...
unsafe extern "C" fn pyrf_pmu__events_cb(state: *mut c_void, info: *mut pmu_event_info) -> c_int {
    ...
    !add_to_dict(dict, "deprecated", info.deprecated ? "deprecated" : core::ptr::null_mut()) ||
...
#[no_mangle]
unsafe extern "C" fn pyrf_pmu__setup_types() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_pmu_iterator {
    PyObject_HEAD
    pub pmu: *mut perf_pmu,
}

#[no_mangle]
unsafe extern "C" fn pyrf_pmu_iterator__dealloc(self: *mut pyrf_pmu_iterator) {
    ...
    itr.pmu = perf_pmus__scan(/*pmu=*/core::ptr::null_mut());
    return (PyObject *) itr;
    }
...
#[no_mangle]
unsafe extern "C" fn pyrf_pmu_iterator__setup_types() -> c_int {
...
// Calling the class creates an instance of the iterator.
    return PyObject_CallObject((PyObject *) &pyrf_pmu_iterator__type, /*args=*/core::ptr::null_mut());
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_counts_values {
    PyObject_HEAD
    pub values: perf_counts_values,
}

    static const char pyrf_counts_values__doc[] = PyDoc_STR("perf counts values object.");
#[no_mangle]
unsafe extern "C" fn pyrf_counts_values__delete(pcounts_values: *mut pyrf_counts_values) {
    ...
    {
    Py_ssize_t size;
    PyObject *item = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pyrf_counts_values__setup_types() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__delete(pevsel: *mut pyrf_evsel) {
    ...
    PyObject *pcpus = core::ptr::null_mut(), *pthreads = core::ptr::null_mut();
    let mut group: c_int = 0, inherit = 0;
    static char *kwlist[] = { "cpus", "threads", "group", "inherit", core::ptr::null_mut() };
    CHECK_INITIALIZED(evsel, "evsel");
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|OOii", kwlist,
    &pcpus, &pthreads, &group, &inherit))
    return core::ptr::null_mut();
    if (pthreads != core::ptr::null_mut() && pthreads != Py_None) {
    ...
    if (pcpus != core::ptr::null_mut() && pcpus != Py_None) {
...
//
#[no_mangle]
unsafe extern "C" fn evsel__ensure_counts(evsel: *mut evsel) -> c_int {
    static int evsel__ensure_counts(struct evsel *evsel)
    {
    int nthreads, ncpus;
    if (evsel.counts != core::ptr::null_mut())
    return 0;
    ...
    if (evsel.prev_raw_counts == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
    ...
    {
    struct evsel *evsel = pevsel.evsel;
    let mut cpu: c_int = 0, cpu_idx, thread = 0, thread_idx;
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__set_tracking(self: *mut PyObject, val: *mut PyObject, __maybe_unused: *mut *mut void closure) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__set_attr_config(self: *mut PyObject, val: *mut PyObject, __maybe_unused: *mut *mut void closure) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__set_attr_read_format(self: *mut PyObject, val: *mut PyObject, __maybe_unused: *mut *mut void closure) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__set_attr_sample_period(self: *mut PyObject, val: *mut PyObject, __maybe_unused: *mut *mut void closure) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__set_attr_sample_type(self: *mut PyObject, val: *mut PyObject, __maybe_unused: *mut *mut void closure) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__set_attr_type(self: *mut PyObject, val: *mut PyObject, __maybe_unused: *mut *mut void closure) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__set_attr_wakeup_events(self: *mut PyObject, val: *mut PyObject, __maybe_unused: *mut *mut void closure) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__setattro(pevsel: *mut pyrf_evsel, attr_name: *mut PyObject, value: *mut PyObject) -> c_int {
    ...
    if (pevsel)
    pevsel.evsel = core::ptr::null_mut();
    return (PyObject *)pevsel;
    }
#[no_mangle]
unsafe extern "C" fn pyrf_evsel__setup_types() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evlist__delete(pevlist: *mut pyrf_evlist) {
...
// Update the value in cur->counts.
    ...
    let mut ret: c_int = expr__add_ref(pctx, &metric_refs[i]);
    if (ret)
    return ret;
    }
    return 0;
    ...
    const char *metric;
    struct rb_node *node;
    struct metric_expr *mexp = core::ptr::null_mut();
    struct expr_parse_ctx *pctx;
    let mut result: double = 0;
    struct evsel *metric_evsel = core::ptr::null_mut();
    CHECK_INITIALIZED(pevlist.evlist, "evlist");
    if (!PyArg_ParseTuple(args, "sii", &metric, &cpu, &thread))
    return core::ptr::null_mut();
    for (node = rb_first_cached(&evlist__metric_events(pevlist.evlist).entries);
    mexp == core::ptr::null_mut() && node;
    node = rb_next(node)) {
    struct metric_event *me = container_of(node, struct metric_event, nd);
    struct list_head *pos;
    list_for_each(pos, &me.head) {
    ...
    continue;
    if (e.metric_events[0] == core::ptr::null_mut())
    continue;
    ...
    static char *kwlist[] = { "pages", "overwrite", core::ptr::null_mut() };
    let mut pages: c_int = 128, overwrite = false;
    CHECK_INITIALIZED(pevlist.evlist, "evlist");
    ...
    {
    struct evlist *evlist;
    static char *kwlist[] = { "timeout", core::ptr::null_mut() };
    let mut timeout: c_int = -1, n;
    CHECK_INITIALIZED(pevlist.evlist, "evlist");
    evlist = pevlist.evlist;
    ...
    struct evsel *evsel;
    let mut sample_id_all: c_int = 1, cpu;
    static char *kwlist[] = { "cpu", "sample_id_all", core::ptr::null_mut() };
    struct mmap *md;
    PyObject *pyevent;
    int err;
    CHECK_INITIALIZED(pevlist.evlist, "evlist");
...
// Unknown evsel.
    ...
    pyevent = pyrf_event__new(event, evsel, evlist__session(evlist), /*machine=*/core::ptr::null_mut());
    perf_mmap__consume(&md.core);
    if (pyevent == core::ptr::null_mut())
    return PyErr_Occurred() ? core::ptr::null_mut() : PyErr_NoMemory();
    return pyevent;
    }
...
#[no_mangle]
unsafe extern "C" fn pyrf_evlist__length(obj: *mut PyObject) -> Py_ssize_t {
...
#[no_mangle]
unsafe extern "C" fn pyrf_evlist__setattro(pevlist: *mut pyrf_evlist, attr_name: *mut PyObject, value: *mut PyObject) -> c_int {
    ...
    if (pevlist)
    pevlist.evlist = core::ptr::null_mut();
    return (PyObject *)pevlist;
    }
#[no_mangle]
unsafe extern "C" fn pyrf_evlist__setup_types() -> c_int {
...
pub struct perf_constant {
    ...
    PyObject *args, PyObject *kwargs)
    {
    static char *kwlist[] = { "sys", "name", core::ptr::null_mut() };
    char *sys  = core::ptr::null_mut();
    ...
    ((struct pyrf_thread_map *)pthreads).threads : core::ptr::null_mut();
    cpus = (pcpus && pcpus != Py_None) ?
    ((struct pyrf_cpu_map *)pcpus).cpus : core::ptr::null_mut();
    ...
    {
    const char *input, *pmu = core::ptr::null_mut();
    struct evlist *evlist = evlist__new();
    PyObject *result;
    PyObject *pcpus = core::ptr::null_mut(), *pthreads = core::ptr::null_mut();
    struct perf_cpu_map *cpus;
...
// hardware_aware_grouping=*/ false);
    ...
    return core::ptr::null_mut();
    while (mg) {
    PyObject *val = core::ptr::null_mut();
    const char *sep = strchr(mg, ';');
    let mut len: usize = sep ? (size_t)(sep - mg) : strlen(mg);
    if (len > 0) {
    ...
    mg = sep ? sep + 1 : core::ptr::null_mut();
    }
    return groups;
    }
    ...
    PyObject *dict = PyDict_New();
    PyObject *key = dict ? PyUnicode_FromString("MetricGroup") : core::ptr::null_mut();
    PyObject *value = key ? pyrf__metrics_groups(pm) : core::ptr::null_mut();
...
unsafe extern "C" fn pyrf_data__init(pdata: *mut pyrf_data, args: *mut PyObject, kwargs: *mut PyObject) -> c_int {
    ...
    {
    static char *kwlist[] = { "path", "fd", core::ptr::null_mut() };
    ...
    path = "-";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(path, 0: "-") !=) -> else {
    PyErr_SetString(PyExc_ValueError,
...
#[no_mangle]
unsafe extern "C" fn pyrf_data__delete(pdata: *mut pyrf_data) {
...
#[no_mangle]
unsafe extern "C" fn pyrf_data__setup_types() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_thread {
    PyObject_HEAD
    pub thread: *mut thread,
}

#[no_mangle]
unsafe extern "C" fn pyrf_thread__delete(pthread: *mut pyrf_thread) {
...
#[no_mangle]
unsafe extern "C" fn pyrf_thread__setup_types() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pyrf_session {
    PyObject_HEAD
    pub session: *mut perf_session,
    pub tool: perf_tool,
    pub pdata: *mut pyrf_data,
    pub sample: *mut PyObject,
    pub stat: *mut PyObject,
}
    ...
    PyObject *pyevent = pyrf_event__new(event, /*evsel=*/core::ptr::null_mut(), psession.session,
// machine=*/NULL);
...
// machine=*/NULL);
    ...
    if (pyevent == core::ptr::null_mut())
    return -ENOMEM;
    ret = PyObject_CallFunction(psession.stat, "Oz", pyevent, core::ptr::null_mut());
    if (!ret) {
    Py_DECREF(pyevent);
    return -1;
    }
    ...
    {
    struct pyrf_data *pdata;
    PyObject *sample = core::ptr::null_mut(), *stat = core::ptr::null_mut();
    static char *kwlist[] = { "data", "sample", "stat", core::ptr::null_mut() };
    ...
    if (!psession)
    return core::ptr::null_mut();
    psession.session = core::ptr::null_mut();
    psession.sample = core::ptr::null_mut();
    psession.stat = core::ptr::null_mut();
    psession.pdata = core::ptr::null_mut();
    Py_INCREF(pdata);
...
#[no_mangle]
unsafe extern "C" fn pyrf_session__delete(psession: *mut pyrf_session) {
...
#[no_mangle]
unsafe extern "C" fn pyrf_session__setup_types() -> c_int {
    ...
    const char *name;
    int id;
    let mut elf_machine: c_int = EM_HOST;
    static char *kwlist[] = { "id", "elf_machine", core::ptr::null_mut() };
    ...
    int id;
    let mut elf_machine: c_int = EM_HOST;
    static char *kwlist[] = { "name", "elf_machine", core::ptr::null_mut() };
...
#[no_mangle]
pub unsafe extern "C" fn PyInit_perf() -> PyMODINIT_FUNC {
    PyMODINIT_FUNC PyInit_perf(void)
    {
    PyObject *obj;
    int i;
...
// The page_size is placed in util object.
    ...
    if (dict == core::ptr::null_mut())
    goto error;
    for (i = 0; perf__constants[i].name != core::ptr::null_mut(); i++) {
