...
//! Source: tools/perf/util/bpf_ftrace.c
#![no_std]
...
pub unsafe extern "C" fn perf_ftrace__latency_prepare_bpf(ftrace: *mut perf_ftrace) -> c_int {
    ...
    struct filter_entry *func = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn perf_ftrace__latency_start_bpf(__maybe_unused: *mut *mut perf_ftrace ftrace) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn perf_ftrace__latency_stop_bpf(__maybe_unused: *mut *mut perf_ftrace ftrace) -> c_int {
    ...
    u32 idx;
    u64 *hist;
    let mut ncpus: c_int = cpu__max_cpu().cpu;
    fd = bpf_map__fd(skel.maps.latency);
    hist = calloc(ncpus, sizeof(*hist));
    if (hist == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn perf_ftrace__latency_cleanup_bpf(__maybe_unused: *mut *mut perf_ftrace ftrace) -> c_int {
