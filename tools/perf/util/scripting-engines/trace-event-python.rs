...
//! Source: tools/perf/util/scripting-engines/trace-event-python.c
#![no_std]
...
pub const N_COMMON_FIELDS: c_int = 7;
    static char *cur_field_name;
    static int zero_flag_atom;

pub const MAX_FIELDS: c_int = 64;
...
pub struct tables {
    pub dbe: db_export,
    pub evsel_handler: *mut PyObject,
    pub machine_handler: *mut PyObject,
    pub thread_handler: *mut PyObject,
    pub comm_handler: *mut PyObject,
    pub comm_thread_handler: *mut PyObject,
    pub dso_handler: *mut PyObject,
    pub symbol_handler: *mut PyObject,
    pub branch_type_handler: *mut PyObject,
    pub sample_handler: *mut PyObject,
    pub call_path_handler: *mut PyObject,
    pub call_return_handler: *mut PyObject,
    pub synth_handler: *mut PyObject,
    pub context_switch_handler: *mut PyObject,
    pub db_export_mode: bool,
}

    static struct tables tables_global;
    static void handler_call_die(const char *handler_name) __noreturn;
#[no_mangle]
unsafe extern "C" fn handler_call_die(handler_name: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn pydict_set_item_string_decref(dict: *mut PyObject, key: *const c_char, val: *mut PyObject) {
...
#[no_mangle]
unsafe extern "C" fn call_object(handler: *mut PyObject, args: *mut PyObject, die_msg: *const c_char) {
    static void call_object(PyObject *handler, PyObject *args, const char *die_msg)
    {
    PyObject *retval;
    retval = PyObject_CallObject(handler, args);
    if (retval == core::ptr::null_mut())
    handler_call_die(die_msg);
    Py_DECREF(retval);
    }
#[no_mangle]
unsafe extern "C" fn try_call_object(handler_name: *const c_char, args: *mut PyObject) {
...
#[no_mangle]
unsafe extern "C" fn get_argument_count(handler: *mut PyObject) -> c_int {
    ...
    define_field(TEP_PRINT_SYMBOL, ev_name, cur_field_name, core::ptr::null_mut());
...
// we should warn...
    ...
    {
    let mut is_array: bool = field.flags & TEP_FIELD_IS_ARRAY;
    PyObject *obj = core::ptr::null_mut(), *list = core::ptr::null_mut();
    ...
    struct dso *dso = map ? map__dso(map) : core::ptr::null_mut();
    if (dso) {
...
#[no_mangle]
unsafe extern "C" fn get_offset(sym: *mut symbol, al: *mut addr_location) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn get_br_mspred(flags: *mut branch_flags, bf: *mut c_char, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_sample_read_in_dict(dict_sample: *mut PyObject, sample: *mut perf_sample) {
    static void set_sample_read_in_dict(PyObject *dict_sample, struct perf_sample *sample)
    {
    let mut read_format: u64 = sample.evsel.core.attr.read_format;
    PyObject *values;
    unsigned int i;
...
pub const MAX_REG_SIZE: c_int = 128;
    ...
    let mut size: c_int = (__sw_hweight64(attr.sample_regs_intr) * MAX_REG_SIZE) + 1;
    char *bf = core::ptr::null_mut();
    if (sample.intr_regs) {
    bf = malloc(size);
    if (!bf)
    return -1;
...
#[no_mangle]
unsafe extern "C" fn set_sample_flags(dict: *mut PyObject, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn python_process_sample_flags(sample: *mut perf_sample, dict_sample: *mut PyObject) {
    ...
    let mut e_machine: u16 = EM_HOST;
    let mut e_flags: u32 = EF_HOST;
...
// Instructions per cycle (IPC)
    ...
    if (al.thread)
    e_machine = thread__e_machine(al.thread, /*machine=*/core::ptr::null_mut(), &e_flags);
    ...
    PyObject *handler, *context, *t, *obj = core::ptr::null_mut(), *callchain;
    PyObject *dict = core::ptr::null_mut(), *all_entries_dict = core::ptr::null_mut();
    ...
    let mut nsecs: c_ulonglong = sample.time;
    ...
    context = _PyCapsule_New(scripting_context, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tuple_set_s64(t: *mut PyObject, pos: c_uint, val: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuple_set_u64(t: *mut PyObject, pos: c_uint, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuple_set_u32(t: *mut PyObject, pos: c_uint, val: u32) -> c_int {
    static int tuple_set_u32(PyObject *t, unsigned int pos, u32 val)
    {
    return PyTuple_SetItem(t, pos, PyLong_FromUnsignedLong(val));
    }
#[no_mangle]
unsafe extern "C" fn tuple_set_s32(t: *mut PyObject, pos: c_uint, val: i32) -> c_int {
    static int tuple_set_s32(PyObject *t, unsigned int pos, s32 val)
    {
    return PyTuple_SetItem(t, pos, _PyLong_FromLong(val));
    }
#[no_mangle]
unsafe extern "C" fn tuple_set_bool(t: *mut PyObject, pos: c_uint, val: bool) -> c_int {
    static int tuple_set_bool(PyObject *t, unsigned int pos, bool val)
    {
    return PyTuple_SetItem(t, pos, PyBool_FromLong(val));
    }
#[no_mangle]
unsafe extern "C" fn tuple_set_string(t: *mut PyObject, pos: c_uint, s: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn python_export_synth(dbe: *mut db_export, es: *mut export_sample) {
...
unsafe extern "C" fn python_export_call_path(dbe: *mut db_export, cp: *mut call_path) -> c_int {
    ...
    {
    struct tables *tables = container_of(dbe, struct tables, dbe);
    let mut comm_db_id: u64 = cr.comm ? cr.comm.db_id : 0;
    PyObject *t;
    t = tuple_new(14);
...
// Reserve for future process_hw/sw/raw APIs
    ...
    let mut out_preempt: bool = out && (event.header.misc & PERF_RECORD_MISC_SWITCH_OUT_PREEMPT);
    let mut np_pid: pid_t = -1, np_tid = -1;
    PyObject *handler, *t;
    handler = get_handler(handler_name);
    if (!handler)
    return;
    ...
    let mut cpumode: u8 = e.header.misc & PERF_RECORD_MISC_CPUMODE_MASK;
    const char *handler_name = "auxtrace_error";
    let mut tm: c_ulonglong = e.time;
    const char *msg = e.msg;
    let mut machine_pid: i32 = 0, vcpu = 0;
...
#[no_mangle]
unsafe extern "C" fn perf_script_context_init() -> c_int {
    ...
    if (!dict)
    return -1;
    perf_script_context = _PyCapsule_New(scripting_context, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn run_start_sub() -> c_int {
    static int run_start_sub(void)
    {
    main_module = PyImport_AddModule("__main__");
    if (main_module == core::ptr::null_mut())
    return -1;
    Py_INCREF(main_module);
    main_dict = PyModule_GetDict(main_module);
    if (main_dict == core::ptr::null_mut())
    goto error;
    Py_INCREF(main_dict);
    if (perf_script_context_init())
    goto error;
    try_call_object("trace_begin", core::ptr::null_mut());
    return 0;
    error:
...
#[no_mangle]
unsafe extern "C" fn set_table_handlers(tables: *mut tables) {
    ...
    let mut export_calls: bool = false;
    let mut export_callchains: bool = false;
    int ret;
    ...
    return;
// handle export calls
    tables.dbe.crp = core::ptr::null_mut();
...
// handle export callchains
    tables.dbe.cpr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn _free_command_line(command_line: *mut wchar_t, num: c_int) {
...
//
    ...
    if (!command_line)
    return -1;
    command_line[0] = Py_DecodeLocale(script, core::ptr::null_mut());
    for (i = 1; i < argc + 1; i++)
    command_line[i] = Py_DecodeLocale(argv[i - 1], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn python_flush_script() -> c_int {
...
unsafe extern "C" fn python_stop_script() -> c_int {
    ...
    {
    struct tables *tables = &tables_global;
    try_call_object("trace_end", core::ptr::null_mut());
...
unsafe extern "C" fn python_generate_script(pevent: *mut tep_handle, outfile: *const c_char) -> c_int {
    ...
    struct tep_event *event = core::ptr::null_mut();
    struct tep_format_field *f;
    char fname[PATH_MAX];
    FILE *ofp;
    sprintf(fname, "%s.py", outfile);
    ofp = fopen(fname, "w");
    if (ofp == core::ptr::null_mut()) {
    ...
    fprintf(ofp, "%%s");
#[no_mangle]
pub unsafe extern "C" fn if(TEP_FIELD_IS_SIGNED: f->flags &) -> else {
