...
//! Source: tools/perf/util/scripting-engines/trace-event-perl.c
#![no_std]
...
// Macro flag: #define HAS_BOOL
    ...
    void xs_init(pTHX);
#[no_mangle]
pub unsafe extern "C" fn xs_init(_arg: pTHX) {
    void xs_init(pTHX)
    {
...
// we should warn...
    ...
    sample, core::ptr::null_mut(), core::ptr::null_mut(), scripting_max_stack) != 0) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: get_cv("main::trace_unhandled", _arg: 0)) -> else {
    XPUSHs(sv_2mortal(newSVpv(handler, 0)));
    XPUSHs(sv_2mortal(newSViv(PTR2IV(scripting_context))));
    XPUSHs(sv_2mortal(newSVuv(cpu)));
...
#[no_mangle]
unsafe extern "C" fn perl_process_event_generic(event: *mut union perf_event, sample: *mut perf_sample) {
...
#[no_mangle]
unsafe extern "C" fn run_start_sub() {
