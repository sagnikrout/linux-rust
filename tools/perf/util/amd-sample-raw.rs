...
//! Source: tools/perf/util/amd-sample-raw.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn fetch_ctl_depends_on_phy_addr_valid() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pr_ibs_fetch_ctl(reg: union ibs_fetch_ctl) {
    ...
    const char *ic_miss_str = core::ptr::null_mut();
    const char *l1tlb_pgsz_str = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pr_ic_ibs_extd_ctl(fetch_ctl: union ibs_fetch_ctl, reg: union ic_ibs_extd_ctl) {
...
#[no_mangle]
unsafe extern "C" fn pr_ibs_op_ctl(reg: union ibs_op_ctl) {
...
#[no_mangle]
unsafe extern "C" fn pr_ibs_op_data(reg: union ibs_op_data) {
...
#[no_mangle]
unsafe extern "C" fn pr_ibs_op_data2_extended(reg: union ibs_op_data2) {
...
// 13 to 31 are reserved. Avoid printing them.
    ...
    let mut data_src: c_int = (reg.data_src_hi << 3) | reg.data_src_lo;
...
#[no_mangle]
unsafe extern "C" fn pr_ibs_op_data2_default(reg: union ibs_op_data2) {
...
#[no_mangle]
unsafe extern "C" fn pr_ibs_op_data2(reg: union ibs_op_data2) {
...
#[no_mangle]
unsafe extern "C" fn pr_ibs_op_data3(reg: union ibs_op_data3) {
...
//
    ...
    let mut idx: c_int = (reg.dc_l1tlb_hit_1g << 1) | reg.dc_l1tlb_hit_2m;
...
//
#[no_mangle]
unsafe extern "C" fn amd_dump_ibs_op(sample: *mut perf_sample) {
...
//
#[no_mangle]
unsafe extern "C" fn amd_dump_ibs_fetch(sample: *mut perf_sample) {
...
//
#[no_mangle]
unsafe extern "C" fn is_valid_ibs_fetch_sample(sample: *mut perf_sample) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_valid_ibs_op_sample(sample: *mut perf_sample) -> bool {
...
#[no_mangle]
unsafe extern "C" fn parse_cpuid(env: *mut perf_env) {
...
pub unsafe extern "C" fn evlist__has_amd_ibs(evlist: *mut evlist) -> bool {
    ...
    ibs_op_type = type;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstarts(name, _arg: "ibs_fetch")) -> else {
