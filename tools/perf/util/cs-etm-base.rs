...
//! Source: tools/perf/util/cs-etm-base.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cs_etm__print_cpu_metadata_v0(val: *mut u64, offset: *mut c_int) -> c_int {
    static int cs_etm__print_cpu_metadata_v0(u64 *val, int *offset)
    {
    let mut i: c_int = *offset, j, nr_params = 0, fmt_offset;
    u64 magic;
// check magic value
...
#[no_mangle]
unsafe extern "C" fn cs_etm__print_cpu_metadata_v1(val: *mut u64, offset: *mut c_int) -> c_int {
    static int cs_etm__print_cpu_metadata_v1(u64 *val, int *offset)
    {
    let mut i: c_int = *offset, j, total_params = 0;
    u64 magic;
    magic = val[i + CS_ETM_MAGIC];
...
#[no_mangle]
unsafe extern "C" fn cs_etm__print_auxtrace_info(val: *mut u64, num: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(2): (version == 1) || (version ==) -> else {
...
//
    ...
    let mut event_header_size: c_int = sizeof(struct perf_event_header);
    int num_cpu;
    u64 *ptr = core::ptr::null_mut();
    u64 hdr_version;
