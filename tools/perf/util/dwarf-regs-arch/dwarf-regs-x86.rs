...
//! Source: tools/perf/util/dwarf-regs-arch/dwarf-regs-x86.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwarf_regs_idx {
    pub name: *const c_char,
    pub dwarf_regnum: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn get_regnum(entries: *const dwarf_regs_idx, num_entries: usize, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __get_dwarf_regnum_for_perf_regnum_i386(perf_regnum: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __get_dwarf_regnum_for_perf_regnum_x86_64(perf_regnum: c_int) -> c_int {
