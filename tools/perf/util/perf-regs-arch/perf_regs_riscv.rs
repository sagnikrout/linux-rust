...
//! Source: tools/perf/util/perf-regs-arch/perf_regs_riscv.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn __perf_sdt_arg_parse_op_riscv(old_op: *mut c_char, new_op: *mut c_char) -> c_int {
...
//
    if (strchr(old_op, '(') == core::ptr::null_mut() &&
    ((*old_op >= '0' && *old_op <= '9') ||
...
//
    prefix = (rm[1].rm_so == -1) ? '+' : '-';
    new_len = 5;	/* sign ( % ) core::ptr::null_mut() */
...
#[no_mangle]
pub unsafe extern "C" fn __perf_reg_mask_riscv(__maybe_unused: bool intr) -> u64 {
