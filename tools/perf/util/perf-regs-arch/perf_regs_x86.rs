...
//! Source: tools/perf/util/perf-regs-arch/perf_regs_x86.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdt_name_reg {
    pub sdt_name: *const c_char,
    pub uprobe_name: *const c_char,
}
...
//
pub const SDT_REG_NAME_SIZE: c_int = 6;
//
...
//
#[no_mangle]
unsafe extern "C" fn sdt_rename_register(sdt_reg: *mut c_char, sdt_len: c_int, uprobe_reg: *mut c_char) {
    static void sdt_rename_register(char *sdt_reg, int sdt_len, char *uprobe_reg)
    {
    let mut i: c_int = 0;
    for (i = 0; sdt_reg_tbl[i].sdt_name != core::ptr::null_mut(); i++) {
...
#[no_mangle]
pub unsafe extern "C" fn __perf_sdt_arg_parse_op_x86(old_op: *mut c_char, new_op: *mut c_char) -> c_int {
    int __perf_sdt_arg_parse_op_x86(char *old_op, char **new_op)
    {
    char new_reg[SDT_REG_NAME_SIZE] = {0};
    let mut new_len: c_int = 0, ret;
//
// rm[0]:  +/-NUM(REG)
// rm[1]:  +/-
// rm[2]:  NUM
...
#[no_mangle]
pub unsafe extern "C" fn if(rm[2].rm_eo: rm[2].rm_so !=) -> else {
...
//
    ...
    let mut type: __u64 = PERF_TYPE_RAW;
//
...
#[no_mangle]
pub unsafe extern "C" fn __perf_reg_ip_x86() -> u64 {
    uint64_t __perf_reg_ip_x86(void)
    {
    return PERF_REG_X86_IP;
    }
#[no_mangle]
pub unsafe extern "C" fn __perf_reg_sp_x86() -> u64 {
