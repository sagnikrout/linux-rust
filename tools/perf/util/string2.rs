...
//! Source: tools/perf/util/string2.h
#![no_std]
...
extern "C" {
    pub fn perf_atoll(str: *const c_char) -> i64;
}
extern "C" {
...
extern "C" {
    pub fn asprintf_expr_inout_ints(_arg: var, _arg: true, _arg: nints, _arg: ints) -> return;
}
extern "C" {
    pub fn asprintf_expr_inout_ints(_arg: var, _arg: false, _arg: nints, _arg: ints) -> return;
}
extern "C" {
