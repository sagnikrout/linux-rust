...
//! Source: tools/perf/builtin-check.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    static const char * const check_subcommands[] = { "feature", core::ptr::null_mut() };
    static struct option check_options[] = {
    OPT_BOOLEAN('q', "quiet", &quiet, "do not show any warnings or messages"),
    OPT_END()
    };
    static struct option check_feature_options[] = { OPT_PARENT(check_options) };
    static const char *check_usage[] = { core::ptr::null_mut(), core::ptr::null_mut() };
...
// this should remain at end, to know the array end
    FEATURE_STATUS(core::ptr::null_mut(), _)
    };
#[no_mangle]
unsafe extern "C" fn on_off_print(status: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn has_support(feature: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn subcommand_feature(argc: c_int, argv: *const c_char) -> c_int {
...
// feature_list is a non-const copy of 'argv[0]'
    ...
    feature_name = strtok(core::ptr::null_mut(), ",");
    }
    free(feature_list);
    return !feature_enabled;
    }
#[no_mangle]
pub unsafe extern "C" fn cmd_check(argc: c_int, argv: *const c_char) -> c_int {
