...
//! Source: tools/perf/trace/beauty/renameat.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn renameat2__scnprintf_flags(flags: c_ulong, bf: *mut c_char, size: usize, show_prefix: bool) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn syscall_arg__scnprintf_renameat2_flags(bf: *mut c_char, size: usize, arg: *mut syscall_arg) -> usize {
