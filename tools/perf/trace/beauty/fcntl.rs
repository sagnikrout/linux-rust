...
//! Source: tools/perf/trace/beauty/fcntl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fcntl__scnprintf_getfd(val: c_ulong, bf: *mut c_char, size: usize, show_prefix: bool) -> usize {
...
#[no_mangle]
unsafe extern "C" fn syscall_arg__scnprintf_fcntl_getfd(bf: *mut c_char, size: usize, arg: *mut syscall_arg) -> usize {
...
#[no_mangle]
unsafe extern "C" fn fcntl__scnprintf_getlease(val: c_ulong, bf: *mut c_char, size: usize, show_prefix: bool) -> usize {
...
#[no_mangle]
unsafe extern "C" fn syscall_arg__scnprintf_fcntl_getlease(bf: *mut c_char, size: usize, arg: *mut syscall_arg) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn syscall_arg__scnprintf_fcntl_cmd(bf: *mut c_char, size: usize, arg: *mut syscall_arg) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn syscall_arg__scnprintf_fcntl_arg(bf: *mut c_char, size: usize, arg: *mut syscall_arg) -> usize {
    size_t syscall_arg__scnprintf_fcntl_arg(char *bf, size_t size, struct syscall_arg *arg)
    {
    let mut show_prefix: bool = arg.show_string_prefix;
    let mut cmd: c_int = syscall_arg__val(arg, 1);
    if (cmd == F_DUPFD)
