...
//! Source: tools/perf/trace/beauty/include/uapi/linux/fs.h
#![no_std]
...
pub const LBMD_PI_CSUM_NONE: c_int = 0;
pub const LBMD_PI_CSUM_IP: c_int = 1;
pub const LBMD_PI_CSUM_CRC16_T10DIF: c_int = 2;
pub const LBMD_PI_CSUM_CRC64_NVME: c_int = 4;
// sizeof first published struct
pub const LBMD_SIZE_VER0: c_int = 16;
//
...
pub struct file_attr {
    pub /: *mut *mut __u64 fa_xflags; / xflags field value (get/set),
    pub (get/set)*/: *mut *mut __u32 fa_extsize; / extsize field value,
    pub /: *mut *mut __u32 fa_nextents; / nextents field value (get),
    pub /: *mut *mut __u32 fa_projid; / project identifier (get/set),
    pub /: *mut *mut __u32 fa_cowextsize; / CoW extsize field value (get/set),
}

pub const FILE_ATTR_SIZE_VER0: c_int = 24;
...
pub const FS_XFLAG_VERITY: c_uint = 0x00020000	/* fs-verity enabled */;
//
...
//
pub const FS_XFLAG_CASEFOLD: c_uint = 0x00040000	/* case-insensitive lookups */;
pub const FS_XFLAG_CASENONPRESERVING: c_uint = 0x00080000	/* case not preserved */;
...
//
pub const FS_CASEFOLD_FL: c_uint = 0x40000000;
...
//
pub const FS_SHUTDOWN_FLAGS_DEFAULT: c_uint = 0x0;
pub const FS_SHUTDOWN_FLAGS_LOGFLUSH: c_uint = 0x1	/* flush log but not data*/;
pub const FS_SHUTDOWN_FLAGS_NOLOGFLUSH: c_uint = 0x2	/* don't flush log nor data */;
