...
//! Source: tools/perf/trace/beauty/move_mount.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn move_mount__scnprintf_flags(flags: c_ulong, bf: *mut c_char, size: usize, show_prefix: bool) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn syscall_arg__scnprintf_move_mount_flags(bf: *mut c_char, size: usize, arg: *mut syscall_arg) -> usize {
