...
//! Source: tools/perf/tests/parse-events.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_evlist(test: *const c_char, line: c_int, cond: bool, evlist: *mut evlist) -> bool {
    ...
    return TEST_FAIL
#[no_mangle]
unsafe extern "C" fn check_evsel(test: *const c_char, line: c_int, cond: bool, evsel: *mut evsel) -> bool {
    static bool check_evsel(const char *test, int line, bool cond, struct evsel *evsel)
    {
    let mut details: perf_attr_details = { .verbose = true, };
    if (cond)
    return true;
    ...
    return TEST_FAIL
#[no_mangle]
unsafe extern "C" fn num_core_entries(evlist: *mut evlist) -> c_int {
...
//
    struct perf_pmu *core_pmu = core::ptr::null_mut();
    struct evsel *evsel;
    evlist__for_each_entry(evlist, evsel) {
    if (!evsel.pmu.is_core)
    continue;
    if (core_pmu != evsel.pmu && core_pmu != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn test_hw_config(evsel: *const evsel, expected_config: __u64) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_s390_create_vm_valid() -> bool {
...
unsafe extern "C" fn test__checkevent_raw(evlist: *mut evlist) -> c_int {
    ...
    {
    struct evsel *evsel;
    let mut raw_type_match: bool = false;
    TEST_ASSERT_EVLIST("wrong number of entries", 0 != evlist__nr_entries(evlist), evlist);
    evlist__for_each_entry(evlist, evsel) {
    let mut __maybe_unused: *mut perf_pmu pmu = core::ptr::null_mut();
    let mut type_matched: bool = false;
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_r(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_w(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_rw(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_raw_modifier(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_numeric_modifier(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_modifier(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_x_modifier(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_r_modifier(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_w_modifier(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_rw_modifier(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_modifier_name(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_x_modifier_name(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_r_modifier_name(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_w_modifier_name(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_rw_modifier_name(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_list(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_pmu_name(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_pmu_partial_time_callgraph(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_pmu_events(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_pmu_events_mix(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__group1(evlist: *mut evlist) -> c_int {
    static int test__group1(struct evlist *evlist)
    {
    struct evsel *evsel = core::ptr::null_mut(), *leader;
    TEST_ASSERT_EVLIST("wrong number of entries",
...
#[no_mangle]
unsafe extern "C" fn test__group2(evlist: *mut evlist) -> c_int {
    static int test__group2(struct evlist *evlist)
    {
    struct evsel *evsel, *leader = core::ptr::null_mut();
    TEST_ASSERT_EVLIST("wrong number of entries",
...
#[no_mangle]
unsafe extern "C" fn test__group3(__maybe_unused: *mut *mut evlist evlist) -> c_int {
    static int test__group3(struct evlist *evlist __maybe_unused)
    {
    struct evsel *evsel, *group1_leader = core::ptr::null_mut(), *group2_leader = core::ptr::null_mut();
    TEST_ASSERT_EVLIST("wrong number of entries",
...
#[no_mangle]
unsafe extern "C" fn test__group4(__maybe_unused: *mut *mut evlist evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__group5(__maybe_unused: *mut *mut evlist evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__group_gh1(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__group_gh2(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__group_gh3(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__group_gh4(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__leader_sample1(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__leader_sample2(__maybe_unused: *mut *mut evlist evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__pinned_group(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__exclusive_group(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_len(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__checkevent_breakpoint_len_w(evlist: *mut evlist) -> c_int {
...
unsafe extern "C" fn test__acr_valid() -> bool {
    ...
    while ((pmu = perf_pmus__scan_core(pmu)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn test__ratio_to_prev(evlist: *mut evlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn count_tracepoints() -> c_int {
...
pub struct terms_test {
    ...
    pub terms): *mut *mut int (check)(struct parse_events_terms,
}
...
unsafe extern "C" fn test_event(e: *const evlist_test) -> c_int {
    ...
    ret = __parse_events(evlist, e.name, /*pmu_filter=*/core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn test_event_fake_pmu(str: *const c_char) -> c_int {
    ...
    return -ENOMEM;
    parse_events_error__init(&err);
    ret = __parse_events(evlist, str, /*pmu_filter=*/core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn test__events2(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_term(t: *const terms_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_terms(terms: *const terms_test, cnt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__terms2(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
    static int test__terms2(struct test_suite *test __maybe_unused, int subtest __maybe_unused)
    {
    return test_terms(test__terms, ARRAY_SIZE(test__terms));
    }
#[no_mangle]
unsafe extern "C" fn test__pmu_events(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
    ...
    let mut e: evlist_test = { .name = core::ptr::null_mut(), };
    char name[2 * NAME_MAX + 1 + 12 + 3];
    int test_ret;
    let mut is_event_parameterized: bool = 0;
...
#[no_mangle]
unsafe extern "C" fn test__pmu_events2(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_alias(event: *mut c_char, alias: *mut c_char) -> bool {
...
// alias = strdup(buf);
    closedir(dir);
    if (*event == core::ptr::null_mut() || *alias == core::ptr::null_mut()) {
    free(*event);
    free(*alias);
    return false;
    }
...
#[no_mangle]
unsafe extern "C" fn test__pmu_events_alias(event: *mut c_char, alias: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__alias(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
    ...
    let mut test_ret: c_int = test_event_fake_pmu(&events[i][0]);
    if (test_ret != TEST_OK) {
