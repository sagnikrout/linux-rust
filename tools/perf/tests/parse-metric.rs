...
//! Source: tools/perf/tests/parse-metric.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn find_value(name: *const c_char, values: *mut value) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn load_runtime_stat(evlist: *mut evlist, vals: *mut value) {
...
#[no_mangle]
unsafe extern "C" fn compute_single(evlist: *mut evlist, name: *const c_char) -> double {
...
#[no_mangle]
unsafe extern "C" fn compute_metric(name: *const c_char, vals: *mut value, ratio: *mut double) -> c_int {
    static int compute_metric(const char *name, struct value *vals, double *ratio)
    {
    return __compute_metric(name, vals, name, ratio, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn test_ipc() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_frontend() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_cache_miss_cycles() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn test_dcache_l2() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_recursion_fail() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_memory_bandwidth() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_metric_group() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__parse_metric(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
