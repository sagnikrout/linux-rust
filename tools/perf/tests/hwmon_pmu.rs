...
//! Source: tools/perf/tests/hwmon_pmu.c
#![no_std]
...
// Simulated hwmon items.
    ...
    let mut hwmon_dirfd: c_int = -1, test_dirfd = -1, file;
    struct perf_pmu *hwm = core::ptr::null_mut();
    ssize_t len;
...
#[no_mangle]
unsafe extern "C" fn do_test(i: usize, with_pmu: bool, with_alias: bool) -> c_int {
