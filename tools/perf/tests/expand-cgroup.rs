...
//! Source: tools/perf/tests/expand-cgroup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_expand_events(evlist: *mut evlist) -> c_int {
    ...
    let mut nr_cgrps: c_int = ARRAY_SIZE(cgrp_name);
    char **ev_name;
    struct evsel *evsel;
    ...
    if (ev_name[i] == core::ptr::null_mut()) {
    pr_debug("memory allocation failure\n");
    goto out;
    }
    i++;
...
#[no_mangle]
unsafe extern "C" fn expand_default_events() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn expand_group_events() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn expand_libpfm_events() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn expand_metric_events() -> c_int {
