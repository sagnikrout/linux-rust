...
//! Source: tools/perf/tests/perf-time-to-tsc.c
#![no_std]
...
pub const TSC_IS_SUPPORTED: c_int = 1;

pub const TSC_IS_SUPPORTED: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn test__perf_time_to_tsc(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
    ...
    let mut err: c_int = TEST_FAIL, ret, i;
