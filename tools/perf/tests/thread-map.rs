...
//! Source: tools/perf/tests/thread-map.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test__thread_map(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__thread_map_synthesize(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
...
// test map on current pid
    ...
    !perf_event__synthesize_thread_map2(core::ptr::null_mut(), threads, process_event, core::ptr::null_mut()));
    perf_thread_map__put(threads);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn test__thread_map_remove(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
    ...
    threads = thread_map__new_str(str, /*tid=*/core::ptr::null_mut(), /*all_threads=*/false);
    free(str);
