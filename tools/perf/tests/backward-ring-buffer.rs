...
//! Source: tools/perf/tests/backward-ring-buffer.c
#![no_std]
...
pub const NR_ITERS: c_int = 111;
#[no_mangle]
unsafe extern "C" fn testcase() {
...
#[no_mangle]
unsafe extern "C" fn test__backward_ring_buffer(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
    static int test__backward_ring_buffer(struct test_suite *test __maybe_unused, int subtest __maybe_unused)
    {
    let mut ret: c_int = TEST_SKIP, err, sample_count = 0, comm_count = 0;
