...
//! Source: tools/perf/tests/cpumap.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test__cpu_map_synthesize(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
...
// This one is better stored in a mask.
    ...
    !perf_event__synthesize_cpu_map(core::ptr::null_mut(), cpus, process_event_mask, core::ptr::null_mut()));
    perf_cpu_map__put(cpus);
// This one is better stored in cpu values.
    cpus = perf_cpu_map__new("1,256");
    TEST_ASSERT_VAL("failed to synthesize map",
    !perf_event__synthesize_cpu_map(core::ptr::null_mut(), cpus, process_event_cpus, core::ptr::null_mut()));
    perf_cpu_map__put(cpus);
// This one is better stored as a range.
    cpus = perf_cpu_map__new("1-256");
    TEST_ASSERT_VAL("failed to synthesize map",
    !perf_event__synthesize_cpu_map(core::ptr::null_mut(), cpus, process_event_range_cpus, core::ptr::null_mut()));
    perf_cpu_map__put(cpus);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cpu_map_print(str: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__cpu_map_print(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test__cpu_map_equal(__maybe_unused: *mut *mut test_suite test, __maybe_unused: int subtest) -> c_int {
