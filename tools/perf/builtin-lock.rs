...
//! Source: tools/perf/builtin-lock.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    static bool use_bpf;
    let mut bpf_map_entries: static unsigned long = MAX_ENTRIES;
    let mut max_stack_depth: static int = CONTENTION_STACK_DEPTH;
    let mut stack_skip: static int = CONTENTION_STACK_SKIP;
    let mut print_nr_entries: static int = INT_MAX / 2;
    static const char *output_name = core::ptr::null_mut();
    static FILE *lock_output;
    static struct lock_filter filters;
    static struct lock_delay *delays;
    static int nr_delays;
    let mut aggr_mode: static enum lock_aggr_mode = LOCK_AGGR_ADDR;
    ...
    return st;
#[no_mangle]
pub unsafe extern "C" fn if(st->tid: tid <) -> else {
    else if (tid < st.tid)
    node = node.rb_left;
    else
    node = node.rb_right;
...
#[no_mangle]
unsafe extern "C" fn thread_stat_insert(new: *mut thread_stat) {
    ...
    rb = &(*rb).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(p->tid: new->tid >) -> else {
    ...
    st.tid = tid;
    INIT_LIST_HEAD(&st.seq_list);
    rb_link_node(&st.rb, core::ptr::null_mut(), &thread_stats.rb_node);
...
// build simple key function one is bigger than two
    ...
    struct lock_stat *two)
    {
    let mut s1: u64 = one.wait_time_min;
    let mut s2: u64 = two.wait_time_min;
    if (s1 == ULLONG_MAX)
    s1 = 0;
    if (s2 == ULLONG_MAX)
    s2 = 0;
...
// key: a pointer to function to compare two lock stats for sorting
    pub lock_stat*): *mut *mut *mut int (key)(struct lock_stat, struct,
// print: a pointer to function to print a given lock stats
    pub lock_stat*): *mut *mut *mut void (print)(struct lock_key, struct,
// list: list entry to link this
    pub list: list_head,
}

#[no_mangle]
unsafe extern "C" fn lock_stat_key_print_time(nsec: c_ulonglong, len: c_int) {
...
// for CSV output
    ...
    struct lock_stat *ls)
    {
    let mut wait_time: u64 = ls.wait_time_min;
...
#[no_mangle]
unsafe extern "C" fn select_key(contention: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_output_field(contention: bool, name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_output_field(contention: bool, str: *const c_char) -> c_int {
...
// no output field given: use all of them
    ...
    orig = tmp = strdup(str);
    if (orig == core::ptr::null_mut())
    return -ENOMEM;
    while ((tok = strsep(&tmp, ",")) != core::ptr::null_mut()){
...
#[no_mangle]
unsafe extern "C" fn combine_lock_stats(st: *mut lock_stat) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct trace_lock_handler {
// it's used on CONFIG_LOCKDEP
    pub sample): *mut *mut int (acquire_event)(struct perf_sample,
// it's used on CONFIG_LOCKDEP && CONFIG_LOCK_STAT
    pub sample): *mut *mut int (acquired_event)(struct perf_sample,
// it's used on CONFIG_LOCKDEP && CONFIG_LOCK_STAT
    pub sample): *mut *mut int (contended_event)(struct perf_sample,
// it's used on CONFIG_LOCKDEP
    pub sample): *mut *mut int (release_event)(struct perf_sample,
// it's used when CONFIG_LOCKDEP is off
    pub sample): *mut *mut int (contention_begin_event)(struct perf_sample,
// it's used when CONFIG_LOCKDEP is off
    pub sample): *mut *mut int (contention_end_event)(struct perf_sample,
}
...
#[no_mangle]
unsafe extern "C" fn get_key_by_aggr_mode_simple(key: *mut u64, addr: u64, tid: u32) -> c_int {
...
unsafe extern "C" fn report_lock_acquire_event(sample: *mut perf_sample) -> c_int {
    ...
    let mut addr: u64 = perf_sample__intval(sample, "lockdep_addr");
    let mut flag: c_int = perf_sample__intval(sample, "flags");
    u64 key;
    int ret;
...
// broken lock sequence
    ...
    {
    u64 offset;
    if (map == core::ptr::null_mut() || sym == core::ptr::null_mut()) {
    buf[0] = '\0';
    return 0;
    }
...
// use caller function name from the callchain
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), max_stack_depth);
    if (ret != 0) {
    thread__put(thread);
    return -1;
    }
...
#[no_mangle]
unsafe extern "C" fn callchain_id(sample: *mut perf_sample) -> u64 {
    static u64 callchain_id(struct perf_sample *sample)
    {
    struct callchain_cursor *cursor;
    struct machine *machine = &session.machines.host;
...
unsafe extern "C" fn report_lock_contention_begin_event(sample: *mut perf_sample) -> c_int {
    ...
    struct thread_stat *ts;
    struct lock_seq_stat *seq;
    let mut addr: u64 = perf_sample__intval(sample, "lock_addr");
    let mut flags: c_uint = perf_sample__intval(sample, "flags");
    u64 key;
    int i, ret;
...
// convert (kernel) symbols to addresses
    ...
    if (ls.callstack == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn evsel__process_lock_acquire(sample: *mut perf_sample) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evsel__process_lock_acquired(sample: *mut perf_sample) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evsel__process_lock_contended(sample: *mut perf_sample) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evsel__process_lock_release(sample: *mut perf_sample) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evsel__process_contention_begin(sample: *mut perf_sample) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn evsel__process_contention_end(sample: *mut perf_sample) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_bad_events(bad: c_int, total: c_int) {
...
#[no_mangle]
unsafe extern "C" fn print_result() {
...
#[no_mangle]
unsafe extern "C" fn dump_threads() {
...
#[no_mangle]
unsafe extern "C" fn combine_result() {
...
#[no_mangle]
unsafe extern "C" fn lock_filter_finish() {
...
#[no_mangle]
unsafe extern "C" fn sort_contention_result() {
    static void sort_contention_result(void)
    {
    sort_result();
    }
#[no_mangle]
unsafe extern "C" fn print_header_stdio() {
...
#[no_mangle]
unsafe extern "C" fn print_header_csv(sep: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn print_lock_stat_stdio(con: *mut lock_contention, st: *mut lock_stat) {
...
#[no_mangle]
unsafe extern "C" fn print_lock_stat(con: *mut lock_contention, st: *mut lock_stat) {
...
#[no_mangle]
unsafe extern "C" fn print_footer_stdio(total: c_int, bad: c_int, fails: *mut lock_contention_fails) {
    static void print_footer_stdio(int total, int bad, struct lock_contention_fails *fails)
    {
// Output for debug, this have to be removed
    let mut broken: c_int = fails.task + fails.stack + fails.time + fails.data;
    if (!use_bpf)
    print_bad_events(bad, total);
    if (quiet || total == 0 || (broken == 0 && verbose <= 0))
    return;
...
#[no_mangle]
unsafe extern "C" fn print_footer(total: c_int, bad: c_int, fails: *mut lock_contention_fails) {
...
#[no_mangle]
unsafe extern "C" fn print_contention_result(con: *mut lock_contention) {
...
// some entries are collected but hidden by the callstack filter
    ...
    static bool force;
#[no_mangle]
unsafe extern "C" fn __cmd_report(display_info: bool) -> c_int {
...
unsafe extern "C" fn sighandler(__maybe_unused: int sig) {
    ...
    parse_options_usage(usage, options, "lock-cgroup", 0);
    parse_options_usage(core::ptr::null_mut(), options, "threads", 0);
    return -1;
    }
    if (symbol_conf.field_sep) {
...
#[no_mangle]
unsafe extern "C" fn __cmd_contention(argc: c_int, argv: *const c_char) -> c_int {
    ...
    session = __perf_session__new(use_bpf ? core::ptr::null_mut() : &data, &eops,
// trace_event_repipe=*/false, &host_env);
    ...
    if (con.evlist == core::ptr::null_mut()) {
    err = -ENOMEM;
    goto out_delete;
    }
...
// do not align output in CSV format
    ...
    while (!done) {
    if (argc && waitpid(evlist__workload_pid(con.evlist), core::ptr::null_mut(), WNOHANG) > 0)
    break;
    sleep(1);
    }
...
unsafe extern "C" fn __cmd_record(argc: c_int, argv: *const c_char) -> c_int {
    ...
    let mut nr_callgraph_args: c_uint = 0;
    const char **rec_argv;
    let mut has_lock_stat: bool = true;
...
#[no_mangle]
unsafe extern "C" fn add_lock_type(flags: c_uint) -> bool {
    ...
    return -1;
    for (tok = strtok_r(s, ", ", &tmp); tok; tok = strtok_r(core::ptr::null_mut(), ", ", &tmp)) {
    let mut found: bool = false;
...
#[no_mangle]
unsafe extern "C" fn add_lock_addr(addr: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_lock_sym(name: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_lock_slab(name: *mut c_char) -> bool {
...
//
    ...
    if (lock_output == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn add_lock_cgroup(name: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_lock_delay(spec: *mut c_char) -> bool {
...
// at = '\0';
    ...
    duration *= 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(pos, _arg: "us")) -> else {
    else if (!strcmp(pos, "us"))
    duration *= 1000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(pos, _arg: "ms")) -> else {
    else if (!strcmp(pos, "ms"))
    duration *= 1000 * 1000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: *mut pos) -> else {
    ...
    if (delays[nr_delays].sym == core::ptr::null_mut()) {
    pr_err("Memory allocation failure\n");
    return false;
    }
...
#[no_mangle]
pub unsafe extern "C" fn cmd_lock(argc: c_int, argv: *const c_char) -> c_int {
    ...
    OPT_STRING('F', "field", &output_fields, core::ptr::null_mut(),
...
// TODO: type
    ...
    OPT_CALLBACK('Y', "type-filter", core::ptr::null_mut(), "FLAGS",
    "Filter specific type of locks", parse_lock_type),
    OPT_CALLBACK('L', "lock-filter", core::ptr::null_mut(), "ADDRS/NAMES",
    "Filter specific address/symbol of locks", parse_lock_addr),
    OPT_CALLBACK('S', "callstack-filter", core::ptr::null_mut(), "NAMES",
    "Filter specific function in the callstack", parse_call_stack),
    OPT_BOOLEAN('o', "lock-owner", &show_lock_owner, "show lock owners instead of waiters"),
    OPT_STRING_NOEMPTY('x', "field-separator", &symbol_conf.field_sep, "separator",
    "print result in CSV format with custom separator"),
    OPT_BOOLEAN(0, "lock-cgroup", &show_lock_cgroups, "show lock stats by cgroup"),
    OPT_CALLBACK('G', "cgroup-filter", core::ptr::null_mut(), "CGROUPS",
    "Filter specific cgroups", parse_cgroup_filter),
    OPT_CALLBACK('J', "inject-delay", core::ptr::null_mut(), "TIME@FUNC",
    ...
    "info", "contention", core::ptr::null_mut() };
