...
//! Source: tools/perf/builtin-buildid-cache.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__kcore_buildid(proc_dir: *const c_char, sbuildid: *mut c_char, sbuildid_size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__kcore_dir(dir: *mut c_char, sz: usize) -> c_int {
    static int build_id_cache__kcore_dir(char *dir, size_t sz)
    {
    return fetch_current_timestamp(dir, sz);
    }
#[no_mangle]
unsafe extern "C" fn same_kallsyms_reloc(from_dir: *const c_char, to_dir: *mut c_char) -> bool {
    static bool same_kallsyms_reloc(const char *from_dir, char *to_dir)
    {
    char from[PATH_MAX];
    char to[PATH_MAX];
    const char *name;
    let mut addr1: u64 = 0, addr2 = 0;
    int i, err = -1;
    scnprintf(from, sizeof(from), "%s/kallsyms", from_dir);
    scnprintf(to, sizeof(to), "%s/kallsyms", to_dir);
    for (i = 0; (name = ref_reloc_sym_names[i]) != core::ptr::null_mut(); i++) {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__add_kcore(filename: *const c_char, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__add_file(filename: *const c_char, nsi: *mut nsinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__remove_file(filename: *const c_char, nsi: *mut nsinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__purge_path(pathname: *const c_char, nsi: *mut nsinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__purge_all() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dso__missing_buildid_cache(dso: *mut dso, __maybe_unused: int parm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__fprintf_missing(session: *mut perf_session, fp: *mut FILE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__update_file(filename: *const c_char, nsi: *mut nsinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_id_cache__show_all() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cmd_buildid_cache(argc: c_int, argv: *const c_char) -> c_int {
    ...
    let mut opts_flag: bool = false;
    let mut purge_all: bool = false;
    char const *add_name_list_str = core::ptr::null_mut(),
// remove_name_list_str = NULL,
// purge_name_list_str = NULL,
// missing_filename = NULL,
// update_name_list_str = NULL,
// kcore_filename = NULL;
    let mut debuginfod: perf_debuginfod = { };
...
// -l is exclusive. It can not be used with other options.
    ...
    if (symbol__init(session ? perf_session__env(session) : core::ptr::null_mut()) < 0)
    goto out;
    setup_pager();
    if (list_files) {
