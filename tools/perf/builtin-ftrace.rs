...
//! Source: tools/perf/builtin-ftrace.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_ftrace_capable() -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_ftrace_supported() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __write_tracing_file(name: *const c_char, val: *const c_char, append: bool) -> c_int {
    static int __write_tracing_file(const char *name, const char *val, bool append)
    {
    char *file;
    int fd, ret = -1;
    let mut size: isize = strlen(val);
...
#[no_mangle]
unsafe extern "C" fn write_tracing_file(name: *const c_char, val: *const c_char) -> c_int {
    static int write_tracing_file(const char *name, const char *val)
    {
    return __write_tracing_file(name, val, false);
    }
#[no_mangle]
unsafe extern "C" fn append_tracing_file(name: *const c_char, val: *const c_char) -> c_int {
    static int append_tracing_file(const char *name, const char *val)
    {
    return __write_tracing_file(name, val, true);
    }
#[no_mangle]
unsafe extern "C" fn read_tracing_file_to_stdout(name: *const c_char) -> c_int {
...
// read contents to stdout
    while (true) {
    let mut n: c_int = read(fd, buf, sizeof(buf));
    if (n == 0)
    break;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn write_tracing_file_int(name: *const c_char, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_tracing_option_file(name: *const c_char, val: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_tracing_options(__maybe_unused: *mut *mut perf_ftrace ftrace) {
...
#[no_mangle]
unsafe extern "C" fn reset_tracing_files(__maybe_unused: *mut *mut perf_ftrace ftrace) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn exit_tracing_instance() {
...
//
#[no_mangle]
unsafe extern "C" fn init_tracing_instance() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_pid(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_cpumask(cpumap: *mut perf_cpu_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_cpu(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_func_stack_trace(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_func_irqinfo(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_tracing_cpu() -> c_int {
    static int reset_tracing_cpu(void)
    {
...
#[no_mangle]
unsafe extern "C" fn __set_tracing_filter(filter_file: *const c_char, funcs: *mut list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_filters(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_tracing_filters() {
    static void reset_tracing_filters(void)
    {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_depth(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_percpu_buffer_size(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_trace_inherit(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_sleep_time(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_funcgraph_args(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_funcgraph_retval(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_funcgraph_retaddr(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_funcgraph_irqs(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_funcgraph_verbose(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_funcgraph_tail(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_thresh(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tracing_options(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn select_tracer(ftrace: *mut perf_ftrace) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: func) -> else {
    else if (func)
...
#[no_mangle]
unsafe extern "C" fn __cmd_ftrace(ftrace: *mut perf_ftrace) -> c_int {
...
// display column headers
    ...
    let mut n: c_int = read(trace_fd, buf, sizeof(buf));
    if (n < 0)
    break;
    if (fwrite(buf, n, 1, stdout) != 1)
    break;
...
// read remaining buffer contents
    ...
    {
    let mut min_latency: c_int = ftrace.min_latency;
    let mut max_latency: c_int = ftrace.max_latency;
    let mut bucket_num: c_uint = ftrace.bucket_num;
    char *p, *q;
    char *unit;
    double num;
    int i;
...
#[no_mangle]
unsafe extern "C" fn display_histogram(ftrace: *mut perf_ftrace, buckets[]: c_int) {
    static void display_histogram(struct perf_ftrace *ftrace, int buckets[])
    {
    let mut min_latency: c_int = ftrace.min_latency;
    let mut use_nsec: bool = ftrace.use_nsec;
    let mut bucket_num: c_uint = ftrace.bucket_num;
    unsigned int i;
    ...
    let mut upper_outlier: c_uint = (bucket_num - 2) * ftrace.bucket_range + min_latency;
    if (upper_outlier > ftrace.max_latency)
    upper_outlier = ftrace.max_latency;
    if (upper_outlier >= 1000) {
    let mut dstart: double = upper_outlier / 1000.0;
...
#[no_mangle]
unsafe extern "C" fn prepare_func_latency(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_func_latency(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_func_latency(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_func_latency(ftrace: *mut perf_ftrace, buckets[]: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_func_latency(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cmd_latency(ftrace: *mut perf_ftrace) -> c_int {
    ...
    break;
    if (pollfd.revents & POLLIN) {
    let mut n: c_int = read(trace_fd, buf, sizeof(buf) - 1);
    if (n < 0)
    break;
...
#[no_mangle]
unsafe extern "C" fn profile_hash(func: c_long, __maybe_unused: *mut *mut void ctx) -> usize {
    static size_t profile_hash(long func, void *ctx __maybe_unused)
    {
    return str_hash((char *)func);
    }
#[no_mangle]
unsafe extern "C" fn profile_equal(func1: c_long, func2: c_long, __maybe_unused: *mut *mut void ctx) -> bool {
    static bool profile_equal(long func1, long func2, void *ctx __maybe_unused)
    {
    return !strcmp((char *)func1, (char *)func2);
    }
#[no_mangle]
unsafe extern "C" fn prepare_func_profile(ftrace: *mut perf_ftrace) -> c_int {
    static int prepare_func_profile(struct perf_ftrace *ftrace)
    {
    ftrace.tracer = "function_graph";
    ftrace.graph_tail = 1;
    ftrace.graph_verbose = 0;
    ftrace.profile_hash = hashmap__new(profile_hash, profile_equal, core::ptr::null_mut());
    if (IS_ERR(ftrace.profile_hash)) {
    let mut err: c_int = PTR_ERR(ftrace.profile_hash);
    ftrace.profile_hash = core::ptr::null_mut();
    return err;
    }
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn parse_func_duration(ftrace: *mut perf_ftrace, line: *mut c_char, len: usize) -> c_int {
...
// p = '\0';
    ...
    let mut profile_sort: static enum perf_ftrace_profile_sort_key = PFP_SORT_TOTAL;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn print_profile_result(ftrace: *mut perf_ftrace) {
...
#[no_mangle]
unsafe extern "C" fn __cmd_profile(ftrace: *mut perf_ftrace) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn list_function_cb(str: *mut c_char, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn delete_filter_func(head: *mut list_head) {
    ...
    return -ENOMEM;
    tmp = s;
    while ((p = strsep(&tmp, ",")) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn parse_sort_key(opt: *const option, str: *const c_char, unset: c_int) -> c_int {
...
// key = PFP_SORT_TOTAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "avg")) -> else {
    else if (!strcmp(str, "avg"))
// key = PFP_SORT_AVG;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "max")) -> else {
    else if (!strcmp(str, "max"))
// key = PFP_SORT_MAX;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "count")) -> else {
    else if (!strcmp(str, "count"))
// key = PFP_SORT_COUNT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "name")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn cmd_ftrace(argc: c_int, argv: *const c_char) -> c_int {
    int cmd_ftrace(int argc, const char **argv)
    {
    int ret;
    int (*cmd_func)(struct perf_ftrace *) = core::ptr::null_mut();
...
// TODO: Add short option -t after -t/--tracer can be removed.
    ...
    OPT_CALLBACK_DEFAULT('F', "funcs", core::ptr::null_mut(), "[FILTER]",
    ...
    let mut subcmd: enum perf_ftrace_subcommand = PERF_FTRACE_NONE;
...
// Make system wide (-a) the default target.
    ...
    parse_options_usage(core::ptr::null_mut(), options, "e", 1);
    ret = -EINVAL;
    goto out_delete_filters;
    }
    if (!list_empty(&ftrace.filters) && !list_empty(&ftrace.event_pair)) {
...
// default max latency should depend on bucket range and num_buckets
    ...
    if (ftrace.evlist == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto out_delete_filters;
    }
