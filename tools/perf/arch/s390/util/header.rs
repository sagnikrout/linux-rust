...
//! Source: tools/perf/arch/s390/util/header.c
#![no_std]
...
pub unsafe extern "C" fn get_cpuid(buffer: *mut c_char, sz: usize, __maybe_unused: perf_cpu cpu) -> c_int {
    ...
    {
    char *cp, *line = core::ptr::null_mut(), *line2;
    char type[8], model[33], version[8], manufacturer[32], authorization[8];
    let mut tpsize: c_int = 0, mdsize = 0, vssize = 0, mfsize = 0, atsize = 0;
    int read;
