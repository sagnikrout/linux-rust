...
//! Source: tools/perf/arch/arm64/util/hisi-ptt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_ptt_recording {
    pub itr: auxtrace_record,
    pub hisi_ptt_pmu: *mut perf_pmu,
...
// Validate auxtrace_mmap_pages
    ...
    container_of(itr, struct hisi_ptt_recording, itr);
    struct perf_pmu *hisi_ptt_pmu = pttr.hisi_ptt_pmu;
    struct evsel *evsel, *hisi_ptt_evsel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hisi_ptt_reference(__maybe_unused: *mut *mut auxtrace_record itr) -> u64 {
