...
//! Source: tools/perf/arch/arm64/util/arm-spe.c
#![no_std]
...
pub const ARM_SPE_CPU_MAGIC: c_uint = 0x1010101010101010ULL;
...
pub struct arm_spe_recording {
    ...
    pub wrapped: *mut bool,
}

// Iterate config list to detect if the "freq" parameter is set
#[no_mangle]
unsafe extern "C" fn arm_spe_is_set_freq(evsel: *mut evsel) -> bool {
...
// Read CPU MIDR
    ...
    if (!cpuid)
    return -ENOMEM;
    val = strtol(cpuid, core::ptr::null_mut(), 16);
...
unsafe extern "C" fn arm_spe_alloc_wrapped_array(ptr: *mut arm_spe_recording, idx: c_int) -> c_int {
    ...
    {
    bool *wrapped;
    let mut cnt: c_int = ptr.wrapped_cnt, new_cnt, i;
//
...
//
    ...
    u64 i, watermark;
    u64 *buf = (u64 *)buffer;
    let mut buf_size: usize = buffer_size;
//
...
#[no_mangle]
unsafe extern "C" fn arm_spe_reference(__maybe_unused: *mut *mut auxtrace_record itr) -> u64 {
