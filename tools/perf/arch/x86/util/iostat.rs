...
//! Source: tools/perf/arch/x86/util/iostat.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iostat_metrics_count() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_root_ports_list_free(list: *mut iio_root_ports_list) {
...
#[no_mangle]
unsafe extern "C" fn iio_mapping(pmu_idx: u8, list: *const *const iio_root_ports_list) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_pmu_count() -> u8 {
...
#[no_mangle]
unsafe extern "C" fn iio_root_ports_scan(list: *mut iio_root_ports_list) -> c_int {
    ...
    let mut pmu_count: u8 = iio_pmu_count();
    if (!pmu_count) {
...
#[no_mangle]
unsafe extern "C" fn iio_root_port_parse_str(domain: *mut u32, bus: *mut u8, str: *mut c_char) -> c_int {
...
//
    ...
    ret = regexec(&regex, str, 0, core::ptr::null_mut(), 0);
    ...
    const char *filter)
    {
    char *tok, *tmp, *filter_copy = core::ptr::null_mut();
    struct iio_root_port *rp;
    u32 domain;
    u8 bus;
    let mut ret: c_int = -ENOMEM;
    ...
    if (rp) {
    (*list).rps[rp.idx] = core::ptr::null_mut();
...
// list = tmp_list;
    ...
    let mut len_template: c_int = strlen(iostat_cmd_template) + 1;
    struct evsel *evsel = core::ptr::null_mut();
    let mut metrics_count: c_int = iostat_metrics_count();
...
#[no_mangle]
pub unsafe extern "C" fn iostat_prepare(evlist_ptr: *mut evlist, config: *mut perf_stat_config) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "list")) -> else {
...
pub unsafe extern "C" fn iostat_list(evlist: *mut evlist, config: *mut perf_stat_config) {
    ...
    {
    struct evsel *evsel;
    struct iio_root_port *rp = core::ptr::null_mut();
...
pub unsafe extern "C" fn if(_arg: config->interval) -> else {
    ...
    {
    void *perf_device = core::ptr::null_mut();
