...
//! Source: tools/perf/arch/x86/tests/amd-ibs-period.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dummy_workload_1(count: c_ulong) -> c_int {
    ...
    func = mmap(core::ptr::null_mut(), page_size, PROT_READ | PROT_WRITE | PROT_EXEC,
    ...
    count = 100000;
#[no_mangle]
pub unsafe extern "C" fn if(10000000: count >) -> else {
...
#[no_mangle]
unsafe extern "C" fn dummy_workload_2(perf: *mut c_char) {
    ...
    cmd = strbuf_detach(&sb, core::ptr::null_mut());
    ret = system(cmd);
    free(cmd);
    }
#[no_mangle]
unsafe extern "C" fn sched_affine(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb_read(rb: *mut perf_event_mmap_page, dest: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb_skip(rb: *mut perf_event_mmap_page, size: usize) {
    static void rb_skip(struct perf_event_mmap_page *rb, size_t size)
    {
    let mut data_head: usize = rb.data_head;
    rmb();
...
#[no_mangle]
unsafe extern "C" fn period_equal(exp_period: c_ulong, act_period: c_ulong) -> c_int {
    static int period_equal(unsigned long exp_period, unsigned long act_period)
    {
    let mut exp_period: return = = act_period ? 0 : -1;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn period_higher(min_period: c_ulong, act_period: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ibs_config_test(ibs_type: c_int, config: *mut ibs_configs, nr_samples: *mut c_int) -> c_int {
...
// CPU0, All processes
    ...
    if (fd <= -1)
    return -1;
    rb = mmap(core::ptr::null_mut(), PERF_MMAP_TOTAL_SIZE, PROT_READ | PROT_WRITE,
    MAP_SHARED, fd, 0);
    if (rb == MAP_FAILED) {
    pr_debug("mmap() failed. [%m]\n");
    return -1;
...
#[no_mangle]
unsafe extern "C" fn ibs_config_test() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibs_period {
// Input
    pub freq: c_int,
    pub sample_freq: c_ulong,
// Output
    pub ret: c_int,
    pub period: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn ibs_period_constraint_test() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ibs_ioctl_test(ibs_type: c_int, ibs_ioctl: *mut ibs_ioctl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ibs_ioctl_test() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ibs_freq_neg_test() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibs_l3missonly {
// Input
    pub freq: c_int,
    pub sample_freq: c_ulong,
// Expected output
    pub ret: c_int,
    pub min_period: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn ibs_l3missonly_test(perf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_perf_event_max_sample_rate() -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn kernel_v6_15_or_newer() -> bool {
    ...
    endptr++;
    minor = strtol(endptr, core::ptr::null_mut(), 10);
