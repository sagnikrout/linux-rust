...
//! Source: tools/perf/ui/browsers/c2c-function.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c2c_function_browser {
    pub hb: hist_browser,
    pub browser): *mut *mut unsigned int (orig_refresh)(struct ui_browser,
...
#[no_mangle]
unsafe extern "C" fn c2c_function_browser__delete(browser: *mut c2c_function_browser) {
...
#[no_mangle]
pub unsafe extern "C" fn perf_c2c__browse_function_view(args: *mut c2c_function_view_args) -> c_int {
