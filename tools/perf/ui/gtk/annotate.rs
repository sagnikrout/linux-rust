...
//! Source: tools/perf/ui/gtk/annotate.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    {
    let mut start: u64 = map__rip_2objdump(ms.map, ms.sym.start);
    strcpy(buf, "");
    if (dl.al.offset == (s64) -1)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn perf_gtk__get_line(buf: *mut c_char, size: usize, dl: *mut disasm_line) -> c_int {
