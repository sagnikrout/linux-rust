...
//! Source: tools/perf/builtin-probe.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn parse_probe_event(str: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn params_add_filter(str: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_target(ptr: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_probe_event_argv(argc: c_int, argv: *const c_char) -> c_int {
...
// Bind up rest arguments
    ...
    params.uprobes = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(opt->long_name, _arg: "module")) -> else {
...
// Expand given path to absolute path, except for modulename
    ...
    if (str) {
    errno = 0;
    ns_pid = (pid_t)strtol(str, core::ptr::null_mut(), 10);
    if (errno != 0) {
    ret = -errno;
...
#[no_mangle]
unsafe extern "C" fn init_params() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_params() {
...
#[no_mangle]
unsafe extern "C" fn pr_err_with_code(msg: *const c_char, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn perf_add_probe_events(pevs: *mut perf_probe_event, npevs: c_int) -> c_int {
    static int perf_add_probe_events(struct perf_probe_event *pevs, int npevs)
    {
    int ret;
    int i, k;
    const char *event = core::ptr::null_mut(), *group = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn del_perf_probe_caches(filter: *mut strfilter) -> c_int {
    ...
    cache = probe_cache__new(nd.s, core::ptr::null_mut());
    if (!cache)
    continue;
...
#[no_mangle]
unsafe extern "C" fn perf_del_probe_events(filter: *mut strfilter) -> c_int {
    static int perf_del_probe_events(struct strfilter *filter)
    {
    int ret, ret2, ufd = -1, kfd = -1;
    char *str = strfilter__string(filter);
    struct strlist *klist = core::ptr::null_mut(), *ulist = core::ptr::null_mut();
    struct str_node *ent;
    if (!str)
    return -EINVAL;
...
// Get current event names
    ...
    if (ret < 0)
    goto out;
    klist = strlist__new(core::ptr::null_mut(), core::ptr::null_mut());
    ulist = strlist__new(core::ptr::null_mut(), core::ptr::null_mut());
    if (!klist || !ulist) {
    ret = -ENOMEM;
    goto out;
    }
    ...
    OPT_CALLBACK_DEFAULT('l', "list", core::ptr::null_mut(), "[GROUP:]EVENT",
    "list up probe events",
    opt_set_filter_with_command, DEFAULT_LIST_FILTER),
    OPT_CALLBACK('d', "del", core::ptr::null_mut(), "[GROUP:]EVENT", "delete a probe event.",
    opt_set_filter_with_command),
    OPT_CALLBACK('a', "add", core::ptr::null_mut(), PROBEDEF_STR,
    ...
    opt_add_probe_event),
    OPT_CALLBACK('D', "definition", core::ptr::null_mut(), PROBEDEF_STR,
    "Show trace event definition of given traceevent for k/uprobe_events.",
    opt_add_probe_event),
    OPT_BOOLEAN('f', "force", &probe_conf.force_add, "forcibly add events"
    " with existing name"),
    OPT_CALLBACK('L', "line", core::ptr::null_mut(),
    "FUNC[:RLN[+NUM|-RLN2]]|SRC:ALN[+NUM|-ALN2]",
    "Show source code lines.", opt_show_lines),
    OPT_CALLBACK('V', "vars", core::ptr::null_mut(),
    ...
    OPT_CALLBACK('\0', "filter", core::ptr::null_mut(),
    "[!]FILTER", "Set a filter (with --vars/funcs only)\n"
    "\t\t\t(default: \"" DEFAULT_VAR_FILTER "\" for --vars,\n"
    "\t\t\t \"" DEFAULT_FUNC_FILTER "\" for --funcs)",
    opt_set_filter),
    OPT_CALLBACK('x', "exec", core::ptr::null_mut(), "executable|path",
    "target executable name or path", opt_set_target),
    OPT_CALLBACK('m', "module", core::ptr::null_mut(), "modname|path",
    ...
    OPT_CALLBACK(0, "target-ns", core::ptr::null_mut(), "pid",
...
//
    ...
    parse_options_usage(core::ptr::null_mut(), options, "x", true);
    return -EINVAL;
    }
...
#[no_mangle]
pub unsafe extern "C" fn cmd_probe(argc: c_int, argv: *const c_char) -> c_int {
