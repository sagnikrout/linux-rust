...
//! Source: tools/perf/builtin-bench.c
#![no_std]
...
pub struct bench {
    ...
    { "all",	"Run all NUMA benchmarks",			core::ptr::null_mut()			},
    ...
    { "all",	"Run all scheduler benchmarks",		core::ptr::null_mut()			},
    { core::ptr::null_mut(),		core::ptr::null_mut(),						core::ptr::null_mut()			}
    };
    ...
    { "all",	"Run all syscall benchmarks",			core::ptr::null_mut()			},
    { core::ptr::null_mut(),		core::ptr::null_mut(),						core::ptr::null_mut()			},
    };
    ...
    { "all",	"Run all memory access benchmarks",		core::ptr::null_mut()			},
    { core::ptr::null_mut(),		core::ptr::null_mut(),						core::ptr::null_mut()			}
    };
...
// pi-futexes
    ...
    { "all",	"Run all futex benchmarks",			core::ptr::null_mut()			},
    { core::ptr::null_mut(),		core::ptr::null_mut(),						core::ptr::null_mut()			}
    };
    ...
    { "all", "Run all breakpoint benchmarks", core::ptr::null_mut()},
    { core::ptr::null_mut(),	core::ptr::null_mut(), core::ptr::null_mut() },
    };
...
pub struct collection {
    ...
    { "all",	"All benchmarks",				core::ptr::null_mut()			},
    { core::ptr::null_mut(),		core::ptr::null_mut(),						core::ptr::null_mut()			}
    };
...
#[no_mangle]
unsafe extern "C" fn dump_benchmarks(coll: *const collection) {
...
// Output/formatting style, exported to benchmark modules:
    let mut bench_format: c_int = BENCH_FORMAT_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn bench_str2int(str: *const c_char) -> c_int {
    ...
    return BENCH_FORMAT_DEFAULT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: BENCH_FORMAT_SIMPLE_STR)) -> else {
...
#[no_mangle]
unsafe extern "C" fn run_collection(coll: *const collection) {
...
#[no_mangle]
unsafe extern "C" fn run_all_collections() {
...
#[no_mangle]
pub unsafe extern "C" fn cmd_bench(argc: c_int, argv: *const c_char) -> c_int {
