...
//! Source: tools/perf/bench/synthesize.c
#![no_std]
...
//
    ...
    let mut min_threads: static unsigned int = 1;
    let mut max_threads: static unsigned int = UINT_MAX;
    let mut single_iterations: static unsigned int = 10000;
    let mut multi_iterations: static unsigned int = 10;
    static bool run_st;
    static bool run_mt;
    ...
    {
    let mut nr_threads_synthesize: c_uint = 1;
...
#[no_mangle]
unsafe extern "C" fn run_single_threaded() -> c_int {
    ...
    session = __perf_session__new(/*data=*/core::ptr::null_mut(), /*tool=*/core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn run_multi_threaded() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bench_synthesize(argc: c_int, argv: *const c_char) -> c_int {
