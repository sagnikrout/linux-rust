...
//! Source: tools/perf/builtin-top.c
#![no_std]
...
pub const HEADER_LINE_NR: c_int = 5;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn winch_sig(__maybe_unused: int sig) {
...
//
    ...
    err = symbol__annotate(&he.ms, evsel, core::ptr::null_mut());
    if (err == 0) {
...
unsafe extern "C" fn ui__warn_map_erange(map: *mut map, sym: *mut symbol, ip: u64) {
    ...
    struct symbol *sym = he.ms.sym;
    let mut err: c_int = 0;
    if (sym == core::ptr::null_mut() || (use_browser == 0 &&
    (top.sym_filter_entry == core::ptr::null_mut() ||
...
// Non-group events are considered as leader
    ...
    evlist__for_each_entry(evlist, pos) {
    evsel__output_resort(pos, core::ptr::null_mut());
    }
    }
#[no_mangle]
unsafe extern "C" fn perf_top__print_sym_table(top: *mut perf_top) {
    ...
    let mut win_width: c_int = top.winsize.ws_col - 1;
...
// p = 0;
    ...
    tmp = strtoul(buf, core::ptr::null_mut(), 10);
// target = tmp;
    out_free:
    free(buf);
    }
...
unsafe extern "C" fn perf_top__prompt_symbol(top: *mut perf_top, msg: *const c_char) {
    ...
    {
    char *buf = core::ptr::null_mut(), *p;
    struct hist_entry *syme = top.sym_filter_entry, *n, *found = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn perf_top__handle_keypress(top: *mut perf_top, c: c_int) -> bool {
    static bool perf_top__handle_keypress(struct perf_top *top, int c)
    {
    let mut ret: bool = true;
    if (!perf_top__key_mapped(top, c)) {
    let mut stdin_poll: pollfd = { .fd = 0, .events = POLLIN };
    struct termios save;
...
unsafe extern "C" fn perf_top__sort_new_samples(arg: *mut c_void) {
    ...
    if (evlist__selected(t.evlist) != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn display_sig(__maybe_unused: int sig) {
...
// total_cycles=*/NULL);
    ...
    if (!seen)
    seen = intlist__new(core::ptr::null_mut());
    ...
    if (al.sym == core::ptr::null_mut() && al.map != core::ptr::null_mut()) {
...
//
    ...
    !symbol__is_idle(al.sym, al.map ? map__dso(al.map) : core::ptr::null_mut(), machine.env)) {
...
unsafe extern "C" fn perf_top__mmap_read_idx(top: *mut perf_top, idx: c_int) {
    ...
    if (ret && ret != -1)
    break;
    ret = ordered_events__queue(top.qe.in, event, last_timestamp, 0, core::ptr::null_mut());
    if (ret)
    break;
...
unsafe extern "C" fn perf_top__mmap_read(top: *mut perf_top) {
    ...
    {
    let mut overwrite: bool = top.record_opts.overwrite;
    struct evlist *evlist = top.evlist;
    int i;
    if (overwrite)
...
unsafe extern "C" fn should_drop(qevent: *mut ordered_event, top: *mut perf_top) -> c_int {
    ...
    assert(evsel != core::ptr::null_mut());
    if (event.header.type == PERF_RECORD_SAMPLE) {
...
//
    ...
    ret = -1;
    if (pthread_create(&thread_process, core::ptr::null_mut(), process_thread, top)) {
    ui__error("Could not create process thread.\n");
    return ret;
    }
    if (pthread_create(&thread, core::ptr::null_mut(), (use_browser > 0 ? display_thread_tui :
    display_thread), top)) {
...
// Wait for a minimal set of events before starting the snapshot
    ...
    out_join_thread:
    cond_signal(&top.qe.cond);
    pthread_join(thread_process, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn perf_top_config(var: *const c_char, value: *const c_char, __maybe_unused: *mut *mut void cb) -> c_int {
    ...
    top.min_percent = strtof(arg, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn cmd_top(argc: c_int, argv: *const c_char) -> c_int {
...
//
    ...
    OPT_CALLBACK_NOOPT('g', core::ptr::null_mut(), &callchain_param,
    core::ptr::null_mut(), "enables call-graph recording and display",
    &callchain_opt),
    ...
    let mut status: c_int = hists__init();
    ...
    if (top.evlist == core::ptr::null_mut())
    return -ENOMEM;
...
// disable incompatible options
    ...
    parse_options_usage(core::ptr::null_mut(), options, "hierarchy", 0);
    goto out_put_evlist;
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: top.use_tui) -> else {
    else if (top.use_tui)
    use_browser = 1;

    setup_browser(false);
    top.session = __perf_session__new(/*data=*/core::ptr::null_mut(), /*tool=*/core::ptr::null_mut(),
// trace_event_repipe=*/false,
    &host_env);
    if (IS_ERR(top.session)) {
    status = PTR_ERR(top.session);
    top.session = core::ptr::null_mut();
    goto out_put_evlist;
    }
    ...
    if (field_order)
    parse_options_usage(sort_order ? core::ptr::null_mut() : top_usage,
    options, "fields", 0);
    goto out_put_evlist;
    }
    if (top.uid_str) {
    let mut uid: uid_t = parse_uid(top.uid_str);
    if (uid == UINT_MAX) {
    ...
    status = symbol__init(core::ptr::null_mut());
    if (status < 0)
    goto out_put_evlist;
    ...
    if (top.sb_evlist == core::ptr::null_mut()) {
    ...
    top.sb_evlist = core::ptr::null_mut();
    goto out_put_evlist;
    }
    }
