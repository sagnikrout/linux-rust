...
//! Source: tools/perf/builtin-diff.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct diff_hpp_fmt {
    pub fmt: perf_hpp_fmt,
    pub idx: c_int,
    pub header: *mut c_char,
    pub header_width: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct data__file {
    pub session: *mut perf_session,
    pub data: perf_data,
    pub idx: c_int,
    pub hists: *mut hists,
    pub evlist_streams: *mut evlist_streams,
    pub fmt: [diff_hpp_fmt; PERF_HPP_DIFF__MAX_INDEX],
}
    ...
    let mut sort_compute: static unsigned int = 1;
    ...
    let mut compute: static int = COMPUTE_DELTA_ABS;
...
pub const MAX_COL_WIDTH: c_int = 70;
...
#[no_mangle]
unsafe extern "C" fn setup_compute_opt_wdiff(opt: *const c_char) -> c_int {
    ...
    if (!*++w2_str)
    goto out;
    compute_wdiff_w1 = strtol(w1_str, core::ptr::null_mut(), 10);
    compute_wdiff_w2 = strtol(w2_str, core::ptr::null_mut(), 10);
...
#[no_mangle]
unsafe extern "C" fn setup_compute_opt(opt: *const c_char) -> c_int {
...
// cp = COMPUTE_DELTA;
    ...
    option = strchr(str, ':');
    if (option) {
    let mut len: unsigned = option++ - str;
//
...
#[no_mangle]
unsafe extern "C" fn period_percent(he: *mut hist_entry, period: u64) -> double {
    static double period_percent(struct hist_entry *he, u64 period)
    {
    let mut total: u64 = hists__total_period(he.hists);
    return (period * 100.0) / total;
    }
#[no_mangle]
unsafe extern "C" fn compute_delta(he: *mut hist_entry, pair: *mut hist_entry) -> double {
    static double compute_delta(struct hist_entry *he, struct hist_entry *pair)
    {
    let mut old_percent: double = period_percent(he, he.stat.period);
    let mut new_percent: double = period_percent(pair, pair.stat.period);
    pair.diff.period_ratio_delta = new_percent - old_percent;
    pair.diff.computed = true;
    return pair.diff.period_ratio_delta;
    }
#[no_mangle]
unsafe extern "C" fn compute_ratio(he: *mut hist_entry, pair: *mut hist_entry) -> double {
    static double compute_ratio(struct hist_entry *he, struct hist_entry *pair)
    {
    let mut old_period: double = he.stat.period ?: 1;
    let mut new_period: double = pair.stat.period;
    pair.diff.computed = true;
    pair.diff.period_ratio = new_period / old_period;
    return pair.diff.period_ratio;
    }
#[no_mangle]
unsafe extern "C" fn compute_wdiff(he: *mut hist_entry, pair: *mut hist_entry) -> i64 {
    static s64 compute_wdiff(struct hist_entry *he, struct hist_entry *pair)
    {
    let mut old_period: u64 = he.stat.period;
    let mut new_period: u64 = pair.stat.period;
    pair.diff.computed = true;
    ...
    {
    let mut he_total: u64 = he.hists.stats.total_period;
    let mut pair_total: u64 = pair.hists.stats.total_period;
    ...
    char *buf, size_t size)
    {
    let mut old_period: double = he.stat.period;
    let mut new_period: double = pair.stat.period;
...
#[no_mangle]
unsafe extern "C" fn block_hist_free(he: *mut c_void) {
    ...
    switch (compute) {
    case COMPUTE_CYCLES:
    if (!hists__add_entry_ops(hists, &block_hist_ops, &al, core::ptr::null_mut(),
...
// nonany_branch_mode=*/false, /*total_cycles=*/NULL);
    ...
    break;
    default:
    if (!hists__add_entry(hists, &al, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), sample,
    true)) {
    pr_warning("problem incrementing symbol period, "
    "skipping event\n");
    goto out;
...
#[no_mangle]
unsafe extern "C" fn evlist__collapse_resort(evlist: *mut evlist) {
...
#[no_mangle]
unsafe extern "C" fn hists__baseline_only(hists: *mut hists) {
    ...
    {
    let mut pairs_left: bool = hist_entry__has_pairs(left);
    let mut pairs_right: bool = hist_entry__has_pairs(right);
    s64 l, r;
...
#[no_mangle]
unsafe extern "C" fn init_block_hist(bh: *mut block_hist) {
...
#[no_mangle]
unsafe extern "C" fn init_spark_values(svals: *mut c_ulong, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hists__precompute(hists: *mut hists) {
    ...
    bh = container_of(he, struct block_hist, he);
    init_block_hist(bh);
    block_info__process_sym(he, bh, core::ptr::null_mut(), 0, 0);
    }
    ...
    block_info__process_sym(pair, pair_bh, core::ptr::null_mut(), 0, 0);
    bh = container_of(he, struct block_hist, he);
...
#[no_mangle]
unsafe extern "C" fn cmp_doubles(l: double, r: double) -> i64 {
    static int64_t cmp_doubles(double l, double r)
    {
    if (l > r)
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(r: l <) -> else {
    else if (l < r)
    return 1;
    else
    return 0;
    ...
    case COMPUTE_DELTA:
    {
    let mut l: double = left.diff.period_ratio_delta;
    let mut r: double = right.diff.period_ratio_delta;
    return cmp_doubles(l, r);
    }
    case COMPUTE_DELTA_ABS:
    {
    let mut l: double = fabs(left.diff.period_ratio_delta);
    let mut r: double = fabs(right.diff.period_ratio_delta);
    return cmp_doubles(l, r);
    }
    case COMPUTE_RATIO:
    {
    let mut l: double = left.diff.period_ratio;
    let mut r: double = right.diff.period_ratio;
    return cmp_doubles(l, r);
    }
    case COMPUTE_WEIGHTED_DIFF:
    {
    let mut l: i64 = left.diff.wdiff;
    let mut r: i64 = right.diff.wdiff;
    return r - l;
    }
    default:
    BUG_ON(1);
...
#[no_mangle]
unsafe extern "C" fn hists__process(hists: *mut hists) {
...
#[no_mangle]
unsafe extern "C" fn data__fprintf() {
...
#[no_mangle]
unsafe extern "C" fn data_process() {
...
#[no_mangle]
unsafe extern "C" fn data__free(d: *mut data__file) {
...
#[no_mangle]
unsafe extern "C" fn abstime_str_dup(pstr: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_absolute_time(d: *mut data__file, pstr: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_percent_time(d: *mut data__file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pdiff.time_str) -> else {
    else if (pdiff.time_str)
    ret = parse_percent_time(d);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn check_file_brstack() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cmd_diff() -> c_int {
    ...
    OPT_CALLBACK(0, "percentage", core::ptr::null_mut(), "relative|absolute",
...
#[no_mangle]
unsafe extern "C" fn baseline_percent(he: *mut hist_entry) -> double {
    ...
    let mut percent: double = baseline_percent(he);
    char pfmt[20] = " ";
    if (!he.dummy) {
...
#[no_mangle]
unsafe extern "C" fn hpp__entry_baseline(he: *mut hist_entry, buf: *mut c_char, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn all_zero(vals: *mut c_ulong, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_cycles_spark(bf: *mut c_char, size: c_int, svals: *mut c_ulong, n: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_header(d: *mut data__file, dfmt: *mut diff_hpp_fmt) {
    static void init_header(struct data__file *d, struct diff_hpp_fmt *dfmt)
    {
pub const MAX_HEADER_NAME: c_int = 100;
    char buf_indent[MAX_HEADER_NAME];
    char buf[MAX_HEADER_NAME];
    const char *header = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn data__hpp_register(d: *mut data__file, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ui_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn data_init(argc: c_int, argv: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cmd_diff(argc: c_int, argv: *const c_char) -> c_int {
    ...
    perf_config(diff__config, core::ptr::null_mut());
    ...
    if (setup_sorting(/*evlist=*/core::ptr::null_mut(), perf_session__env(data__files[0].session)) < 0)
    usage_with_options(diff_usage, options);
    setup_pager();
    sort__setup_elide(core::ptr::null_mut());
    return __cmd_diff();
    }
