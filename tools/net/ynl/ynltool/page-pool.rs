...
//! Source: tools/net/ynl/ynltool/page-pool.c
#![no_std]
...
pub struct pp_stat {
    ...
    struct {
    pub cnt: c_uint,
    pub bytes: size_t refs,,
    pub live: [}; 2],
    pub recycle_cache: size_t alloc_slow, alloc_fast, recycle_ring,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pp_stats_array {
    pub max: unsigned int i,,
    pub s: *mut pp_stat,
}
...
//
#[no_mangle]
unsafe extern "C" fn print_json_recycling_stats(s: *mut pp_stat) {
...
#[no_mangle]
unsafe extern "C" fn print_plain_recycling_stats(s: *mut pp_stat) {
...
#[no_mangle]
unsafe extern "C" fn print_json_stats(a: *mut pp_stats_array) {
...
#[no_mangle]
unsafe extern "C" fn print_plain_stats(a: *mut pp_stats_array) {
...
#[no_mangle]
unsafe extern "C" fn do_stats(argc: c_int, argv: *mut c_char) -> c_int {
    static int do_stats(int argc, char **argv)
    {
    let mut pp_stat_req: netdev_page_pool_stats_get_req_dump = {};
    struct netdev_page_pool_stats_get_list *pp_stats;
    let mut pp_req: netdev_page_pool_get_req_dump = {};
    struct netdev_page_pool_get_list *pools;
    enum {
    GROUP_BY_DEVICE,
    GROUP_BY_POOL,
    } group_by = GROUP_BY_DEVICE;
    let mut zombies_only: bool = false;
    let mut a: pp_stats_array = {};
...
#[no_mangle]
pub unsafe extern "C" fn do_page_pool(argc: c_int, argv: *mut c_char) -> c_int {
