...
//! Source: tools/net/ynl/tests/netdev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn veth_create(ys_link: *mut ynl_sock) -> c_int {
    ...
    ASSERT_NE(core::ptr::null_mut(), dev) {
    ...
    self.ys_link = ynl_sock_create(&ynl_rt_link_family, core::ptr::null_mut());
    ASSERT_NE(core::ptr::null_mut(), self.ys_link)
