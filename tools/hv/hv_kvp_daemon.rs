...
//! Source: tools/hv/hv_kvp_daemon.c
#![no_std]
...
pub const MAX_FILE_NAME: c_int = 100;
pub const ENTRIES_PER_BLOCK: c_int = 50;
//
// Change this entry if the number of addresses increases in future
//
pub const MAX_IP_ENTRIES: c_int = 64;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvp_record {
    pub key: [c_char; HV_KVP_EXCHANGE_MAX_KEY_SIZE],
    pub value: [c_char; HV_KVP_EXCHANGE_MAX_VALUE_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvp_file_state {
    pub fd: c_int,
    pub num_blocks: c_int,
    pub records: *mut kvp_record,
    pub num_records: c_int,
    pub fname: [c_char; MAX_FILE_NAME],
}

    static struct kvp_file_state kvp_file_info[KVP_POOL_COUNT];
#[no_mangle]
unsafe extern "C" fn kvp_acquire_lock(pool: c_int) {
    static void kvp_acquire_lock(int pool)
    {
    let mut fl: flock = {F_WRLCK, SEEK_SET, 0, 0, 0};
    fl.l_pid = getpid();
...
#[no_mangle]
unsafe extern "C" fn kvp_release_lock(pool: c_int) {
    static void kvp_release_lock(int pool)
    {
    let mut fl: flock = {F_UNLCK, SEEK_SET, 0, 0, 0};
    fl.l_pid = getpid();
...
#[no_mangle]
unsafe extern "C" fn kvp_update_file(pool: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kvp_dump_initial_pools(pool: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kvp_update_mem_state(pool: c_int) {
    ...
    let mut num_blocks: c_int = kvp_file_info[pool].num_blocks;
    let mut alloc_unit: c_int = sizeof(struct kvp_record) * ENTRIES_PER_BLOCK;
    kvp_acquire_lock(pool);
...
#[no_mangle]
unsafe extern "C" fn kvp_file_init() -> c_int {
    ...
    if (kvp_file_info[i].records == core::ptr::null_mut())
    return 1;
...
#[no_mangle]
unsafe extern "C" fn kvp_key_delete(pool: c_int, key: *const __u8, key_size: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvp_get_os_info() {
...
//
    ...
    FILE    *file;
    char    *p, *x;
    char    *if_name = core::ptr::null_mut();
    char    buf[256];
...
//
    ...
    unsigned int i;
    char *mac_addr = core::ptr::null_mut();
...
//
    ...
    while ((p = fgets(buf, sizeof(buf), file)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn kvp_verify_ip_address(address_string: *const c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvp_extract_routes(line: *const c_char, output: *mut c_void, remaining: *mut usize) {
...
#[no_mangle]
unsafe extern "C" fn kvp_get_gateway(buffer: *mut c_void, buffer_len: usize) {
    ...
    let mut alloc_size: usize = 0, remaining = buffer_len - 1;
    ssize_t num_chars;
...
#[no_mangle]
unsafe extern "C" fn hweight32(w: *mut c_uint) -> c_uint {
...
// offset += strlen(str) + 1;
    ...
    char *buffer;
    struct hv_kvp_ipaddr_value *ip_buffer = core::ptr::null_mut();
...
//
    ...
    curp = ifap;
    while (curp != core::ptr::null_mut()) {
    if (curp.ifa_addr == core::ptr::null_mut()) {
    curp = curp.ifa_next;
    continue;
    }
    if ((if_name != core::ptr::null_mut()) &&
...
//
#[no_mangle]
unsafe extern "C" fn kvp_mac_to_ip(kvp_ip_val: *mut hv_kvp_ipaddr_value) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn expand_ipv6(addr: *mut c_char, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_ipv4(addr: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvp_write_file(f: *mut FILE, s1: *mut c_char, s2: *mut c_char, s3: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_ip_string(f: *mut FILE, ip_string: *mut c_char, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_version_check(input_addr: *const c_char) -> c_int {
    ...
    return IPV4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: inet_pton(AF_INET6, _arg: input_addr, _arg: &addr)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn kvp_subnet_to_plen(subnet_addr_str: *mut c_char) -> c_int {
...
//
    ...
    let mut ip_offset: c_int = 0, error = 0, ip_ver;
    char *param_name;
    if (type == DNS)
    param_name = "dns";
#[no_mangle]
pub unsafe extern "C" fn if(GATEWAY: type ==) -> else {
...
//
    ...
    let mut error: c_int = 0, i = 0;
    let mut ip_offset: c_int = 0, subnet_offset = 0;
    int plen, ip_ver;
    memset(addr, 0, sizeof(addr));
...
#[no_mangle]
pub unsafe extern "C" fn if(IPV6: ip_ver == IPV6 && ip_sec ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn kvp_set_ip_info(if_name: *mut c_char, new_val: *mut hv_kvp_ipaddr_value) -> c_int {
    static int kvp_set_ip_info(char *if_name, struct hv_kvp_ipaddr_value *new_val)
    {
    let mut error: c_int = 0, ip_ver;
...
//
    ...
    error = getaddrinfo(buffer, core::ptr::null_mut(), &hints, &info);
    if (error != 0) {
...
#[no_mangle]
pub unsafe extern "C" fn print_usage(argv[]: *mut c_char) {
...
pub unsafe extern "C" fn main(argc: c_int, argv[]: *mut c_char) -> c_int {
    ...
    let mut daemonize: c_int = 1, long_index = 0, opt;
...
//
    ...
    kvp_get_ip_info(AF_INET, core::ptr::null_mut(), KVP_OP_ENUMERATE,
    key_value, HV_KVP_EXCHANGE_MAX_VALUE_SIZE);
    strcpy(key_name, "NetworkAddressIPv4");
    break;
    case NetworkAddressIPv6:
    kvp_get_ip_info(AF_INET6, core::ptr::null_mut(), KVP_OP_ENUMERATE,
    key_value, HV_KVP_EXCHANGE_MAX_VALUE_SIZE);
