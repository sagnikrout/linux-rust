...
//! Source: tools/hv/hv_fcopy_uio_daemon.c
#![no_std]
...
pub const WIN8_SRV_MAJOR: c_int = 1;
pub const WIN8_SRV_MINOR: c_int = 1;

    "/sys/bus/vmbus/devices/eb765408-105f-49b6-b4aa-c123b64d17d4/" #subdir

pub const FCOPY_VER_COUNT: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn get_ring_buffer_size() -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hv_fcopy_create_file(file_name: *mut c_char, path_name: *mut c_char, flags: __u32) -> c_int {
...
// create if required.
//
    while ((q = strchr(p, '/')) != core::ptr::null_mut()) {
    if (q == p) {
    p++;
    continue;
    }
...
#[no_mangle]
unsafe extern "C" fn hv_copy_data(cpmsg: *mut hv_do_fcopy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_copy_finished() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_usage(argv[]: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn wcstoutf8(dest: *mut c_char, src: *const __u16, dest_size: usize) {
...
#[no_mangle]
unsafe extern "C" fn hv_fcopy_start(smsg_in: *mut hv_start_fcopy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_fcopy_send_data(fcopy_msg: *mut hv_fcopy_hdr, recvlen: c_int) -> c_int {
    static int hv_fcopy_send_data(struct hv_fcopy_hdr *fcopy_msg, int recvlen)
    {
    let mut operation: c_int = fcopy_msg.operation;
//
...
#[no_mangle]
unsafe extern "C" fn fcopy_pkt_process(txbr: *mut vmbus_br) -> c_int {
    ...
    core::ptr::null_mut(), &fcopy_srv_version)) {
...
#[no_mangle]
unsafe extern "C" fn fcopy_get_first_folder(path: *mut c_char, chan_no: *mut c_char) {
...
pub unsafe extern "C" fn main(argc: c_int, argv[]: *mut c_char) -> c_int {
    ...
    {
    let mut fcopy_fd: c_int = -1, tmp = 1;
    let mut daemonize: c_int = 1, long_index = 0, opt, ret = -EINVAL;
