...
// Move to the subfunction:
    ...
    __fake; __fake = core::ptr::null_mut())					\
...
#[no_mangle]
pub unsafe extern "C" fn insn_jump_table_size(insn: *mut instruction) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn is_jump_table_jump(insn: *mut instruction) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_sibling_call(insn: *mut instruction) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_rust_noreturn(func: *const symbol) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dead_end_function(file: *mut objtool_file, func: *mut symbol) -> bool {
    static bool dead_end_function(struct objtool_file *file, struct symbol *func)
    {
    return __dead_end_function(file, func, 0);
    }
#[no_mangle]
unsafe extern "C" fn init_cfi_state(cfi: *mut cfi_state) {
...
#[no_mangle]
pub unsafe extern "C" fn cficmp(cfi1: *mut cfi_state, cfi2: *mut cfi_state) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cfi_key(cfi: *mut cfi_state) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfi_hash_add(cfi: *mut cfi_state) {
    ...
    cfi_hash = mmap(core::ptr::null_mut(), sizeof(struct hlist_head) << cfi_bits,
    PROT_READ|PROT_WRITE,
    MAP_PRIVATE|MAP_ANON, -1, 0);
    if (cfi_hash == (void *)-1L) {
    ERROR_GLIBC("mmap fail cfi_hash");
    cfi_hash = core::ptr::null_mut();
    }  else if (opts.stats) {
    printf("cfi_bits: %d\n", cfi_bits);
    }
    return cfi_hash;
...
//
#[no_mangle]
unsafe extern "C" fn decode_instructions(file: *mut objtool_file) -> c_int {
    ...
    struct instruction *insns = core::ptr::null_mut();
...
//
    ...
    { .name = "pv_ops", },
    { .name = "pv_ops_lock", },
    { .name = core::ptr::null_mut(), .idx_off = -1 }
    };
//
// Get index offset for a pv_ops* array.
//
#[no_mangle]
pub unsafe extern "C" fn pv_ops_idx_off(symname: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_pv_ops(file: *mut objtool_file, pv_ops_idx: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_pv_ops(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_livepatch_module(file: *mut objtool_file) -> bool {
...
#[no_mangle]
unsafe extern "C" fn create_static_call_sections(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_retpoline_sites_sections(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_return_sites_sections(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_ibt_endbr_seal_sections(file: *mut objtool_file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn grow_cfi_symbols(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_cfi_sections(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_mcount_loc_sections(file: *mut objtool_file) -> c_int {
    static int create_mcount_loc_sections(struct objtool_file *file)
    {
    let mut addr_size: usize = elf_addr_size(file.elf);
    struct instruction *insn;
    struct section *sec;
    int idx;
...
#[no_mangle]
unsafe extern "C" fn create_direct_call_sections(file: *mut objtool_file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_ignores(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_uaccess_safe(file: *mut objtool_file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_is_retpoline(sym: *mut symbol) -> __weak bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_is_rethunk(sym: *mut symbol) -> __weak bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_is_embedded_insn(sym: *mut symbol) -> __weak bool {
...
#[no_mangle]
unsafe extern "C" fn remove_insn_ops(insn: *mut instruction) {
    ...
    insn.stack_ops = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn add_retpoline_call(file: *mut objtool_file, insn: *mut instruction) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_return_call(file: *mut objtool_file, insn: *mut instruction, add: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn add_jump_destinations(file: *mut objtool_file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_call_destinations(file: *mut objtool_file) -> c_int {
...
//
    ...
    {
    struct instruction *last_new_insn = core::ptr::null_mut(), *insn, *nop = core::ptr::null_mut();
    struct alt_group *orig_alt_group, *new_alt_group;
    unsigned long dest_off;
    orig_alt_group = orig_insn.alt_group;
    if (!orig_alt_group) {
    struct instruction *last_orig_insn = core::ptr::null_mut();
    ...
    orig_alt_group.orig_group = core::ptr::null_mut();
    orig_alt_group.first_insn = orig_insn;
    orig_alt_group.last_insn = last_orig_insn;
    orig_alt_group.nop = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn add_special_section_alts(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arch_jump_table_sym_offset(reloc: *mut reloc, table: *mut reloc) -> __weak unsigned long {
    __weak unsigned long arch_jump_table_sym_offset(struct reloc *reloc, struct reloc *table)
    {
    return reloc.sym.offset + reloc_addend(reloc);
    }
#[no_mangle]
unsafe extern "C" fn add_jump_table(file: *mut objtool_file, insn: *mut instruction) -> c_int {
    static int add_jump_table(struct objtool_file *file, struct instruction *insn)
    {
    let mut table_size: c_ulong = insn_jump_table_size(insn);
...
//
    ...
    struct symbol *func)
    {
    struct instruction *insn, *last = core::ptr::null_mut();
    func_for_each_insn(file, func, insn) {
    if (!last)
    last = insn;
//
...
//
#[no_mangle]
unsafe extern "C" fn add_jump_table_alts(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_func_state(state: *mut cfi_state) {
...
#[no_mangle]
unsafe extern "C" fn read_unwind_hints(file: *mut objtool_file) -> c_int {
    static int read_unwind_hints(struct objtool_file *file)
    {
    let mut cfi: cfi_state = init_cfi;
    struct section *sec;
...
#[no_mangle]
unsafe extern "C" fn __annotate_early(file: *mut objtool_file, type: c_int, insn: *mut instruction) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __annotate_ifc(file: *mut objtool_file, type: c_int, insn: *mut instruction) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __annotate_late(file: *mut objtool_file, type: c_int, insn: *mut instruction) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is_profiling_func(name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn classify_symbols(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mark_rodata(file: *mut objtool_file) {
...
#[no_mangle]
unsafe extern "C" fn mark_holes(file: *mut objtool_file) {
    static void mark_holes(struct objtool_file *file)
    {
    struct instruction *insn;
    let mut in_hole: bool = false;
    if (!opts.link)
    return;
//
...
#[no_mangle]
unsafe extern "C" fn validate_branch_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn alts_needed() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn decode_file(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_special_call(insn: *mut instruction) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_modified_stack_frame(insn: *mut instruction, state: *mut insn_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_valid_stack_frame(state: *mut insn_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn save_reg(cfi: *mut cfi_state, reg: c_uchar, base: c_int, offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn restore_reg(cfi: *mut cfi_state, reg: c_uchar) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CFI_SP: op->src.reg == CFI_SP && cfa->base ==) -> else {
//
// mov %rsp, %reg
//
...
#[no_mangle]
pub unsafe extern "C" fn if(cfa->base: op->dest.reg ==) -> else {
// mov %reg, %rsp
    if (cfa.base == CFI_SP &&
...
#[no_mangle]
pub unsafe extern "C" fn if(CFI_CFA: cfi->vals[op->src.reg].base ==) -> else {
//
...
//
#[no_mangle]
unsafe extern "C" fn propagate_alt_cfi(file: *mut objtool_file, insn: *mut instruction) -> c_int {
    ...
    {
    let mut __maybe_unused: insn_state prev_state = *state;
    struct stack_op *op;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn insn_cfi_match(insn: *mut instruction, cfi2: *mut cfi_state) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn func_uaccess_safe(func: *mut symbol) -> bool {
    ...
    reloc = insn_reloc(core::ptr::null_mut(), insn);
...
#[no_mangle]
unsafe extern "C" fn pv_call_dest(file: *mut objtool_file, insn: *mut instruction) -> bool {
...
#[no_mangle]
unsafe extern "C" fn validate_return(func: *mut symbol, insn: *mut instruction, state: *mut insn_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skip_alt_group(insn: *mut instruction) -> bool {
    static bool skip_alt_group(struct instruction *insn)
    {
    struct instruction *alt_insn = insn.alts ? insn.alts.insn : core::ptr::null_mut();
    if (!insn.alt_group)
    return false;
...
// Don't override ASM_{CLAC,STAC}_UNSAFE
    ...
    bool *dead_end)
    {
    let mut __maybe_unused: *mut char alt_name = core::ptr::null_mut();
    struct alternative *alt;
    u8 visited;
    int ret;
//
...
//
    ...
    struct instruction *insn, struct insn_state *state)
    {
    struct instruction *next_insn, *prev_insn = core::ptr::null_mut();
    bool dead_end;
    int ret;
    if (func && func.ignore)
    return 0;
...
// Ignore KCFI type preambles, which always fall through
    ...
    TRACE_INSN(insn, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn validate_unwind_hints(file: *mut objtool_file, sec: *mut section) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn validate_unret(file: *mut objtool_file, insn: *mut instruction) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn validate_unrets(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_retpoline(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_kasan_insn(insn: *mut instruction) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_ubsan_insn(insn: *mut instruction) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ignore_unreachable_insn(file: *mut objtool_file, insn: *mut instruction) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn create_prefix_symbol(file: *mut objtool_file, func: *mut symbol) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_prefix_symbols(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_section(file: *mut objtool_file, sec: *mut section) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_noinstr_sections(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_functions(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mark_endbr_used(insn: *mut instruction) {
...
#[no_mangle]
unsafe extern "C" fn noendbr_range(file: *mut objtool_file, insn: *mut instruction) -> bool {
...
#[no_mangle]
unsafe extern "C" fn validate_ibt_insn(file: *mut objtool_file, insn: *mut instruction) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn validate_ibt(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_sls(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_reachable_instructions(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arch_absolute_reloc(elf: *mut elf, reloc: *mut reloc) -> __weak bool {
    __weak bool arch_absolute_reloc(struct elf *elf, struct reloc *reloc)
    {
    let mut type: c_uint = reloc_type(reloc);
    let mut sz: usize = elf_addr_size(elf);
    return (sz == 8) ? (type == R_ABS64) : (type == R_ABS32);
    }
#[no_mangle]
unsafe extern "C" fn check_abs_references(file: *mut objtool_file) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct insn_chunk {
    pub addr: *mut c_void,
    pub next: *mut insn_chunk,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn free_insns(file: *mut objtool_file) {
    void free_insns(struct objtool_file *file)
    {
    struct instruction *insn;
    struct insn_chunk *chunks = core::ptr::null_mut(), *chunk;
    for_each_insn(file, insn) {
    if (!insn.idx) {
...
#[no_mangle]
pub unsafe extern "C" fn check(file: *mut objtool_file) -> c_int {
    int check(struct objtool_file *file)
    {
    struct disas_context *disas_ctx = core::ptr::null_mut();
    let mut ret: c_int = 0, warnings = 0;
//
...
//
    ...
    w += validate_unwind_hints(file, core::ptr::null_mut());
    if (!w)
...
//
    ...
    objtool_disas_ctx = core::ptr::null_mut();
    }
    free_insns(file);
    if (!ret && !warnings)
    return 0;
