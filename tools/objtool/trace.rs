...
pub const CFI_REG_NAME_MAXLEN: c_int = 16;
//
...
//
    ...
    trace_cfi_reg_val(core::ptr::null_mut(), reg, prev.base, prev.offset,		\
    next.base, next.offset)

    trace_cfi_reg_ref(core::ptr::null_mut(), reg, prev.base, prev.offset,		\
    next.base, next.offset)
