...
//
pub const DISAS_RESULT_SIZE: c_int = 1024;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct disas_context {
    pub file: *mut objtool_file,
    pub insn: *mut instruction,
    pub alt_applied: bool,
    pub result: [c_char; DISAS_RESULT_SIZE],
    pub disassembler: disassembler_ftype,
...
//
pub const DISAS_ALT_MAX: c_int = 5;
//
// Maximum number of instructions per alternative
//
pub const DISAS_ALT_INSN_MAX: c_int = 50;
//
// Information to disassemble an alternative
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct disas_alt {
    pub /: *mut *mut *mut instruction orig_insn; / original instruction,
    pub /: *mut *mut *mut alternative alt; / alternative or NULL if default code,
    pub /: *mut *mut *mut char name; / name for this alternative,
    pub /: *mut *mut int width; / formatting width,
    struct {
    pub /: *mut *mut *mut char str; / instruction string,
    pub /: *mut *mut int offset; / instruction offset,
    pub /: *mut *mut int nops; / number of nops,
    pub /: *mut *mut } insn[DISAS_ALT_INSN_MAX]; / alternative instructions,
    pub /: *mut *mut int insn_idx; / index of the next instruction to print,
}

pub const ALT_FLAGS_SHIFT: c_int = 16;

#[no_mangle]
unsafe extern "C" fn alt_feature(ft_flags: c_uint) -> c_int {
    static int alt_feature(unsigned int ft_flags)
    {
    return (ft_flags & ALT_FEATURE_MASK);
    }
#[no_mangle]
unsafe extern "C" fn alt_flags(ft_flags: c_uint) -> c_int {
...
//
    ...
    va_end(ap);
    let mut rv: return = = -1 ? core::ptr::null_mut() : str;
    }
#[no_mangle]
unsafe extern "C" fn sprint_name(str: *mut c_char, name: *const c_char, offset: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disas_fprintf(stream: *mut c_void, fmt: *const c_char, ...) -> c_int {
...
pub const DISAS_INSN_OFFSET_SPACE: c_int = 10;
pub const DISAS_INSN_SPACE: c_int = 60;
...
//
    ...
    bool alt_applied)
    {
    let mut disasm: disassembler_ftype = dctx.disassembler;
...
#[no_mangle]
pub unsafe extern "C" fn disas_insn(dctx: *mut disas_context, insn: *mut instruction) -> usize {
...
#[no_mangle]
unsafe extern "C" fn disas_alt_jump(dalt: *mut disas_alt) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn disas_alt_extable(dalt: *mut disas_alt) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn disas_alt_group(dctx: *mut disas_context, dalt: *mut disas_alt) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn disas_alt_default(dctx: *mut disas_context, dalt: *mut disas_alt) -> c_int {
...
//
    disas_print_info(stdout, orig_insn, -2, core::ptr::null_mut());
...
//
    ...
    int len;
    orig_insn = dalts[0].orig_insn;
    len = disas_print(stdout, orig_insn.sec, orig_insn.offset, 0, core::ptr::null_mut());
    printf("%s\n", alt_name);
//
...
//
    ...
    dalt.insn[j].str = core::ptr::null_mut();
...
//
    ...
    struct instruction *last_insn = core::ptr::null_mut();
    struct alternative *alt;
    struct disas_alt *dalt;
    let mut insn_count: c_int = 0;
    let mut alt_count: c_int = 0;
    char *alt_name;
    int count;
    int i, j;
    int err;
...
//
    err = disas_alt_init(&dalts[0], orig_insn, core::ptr::null_mut());
    if (err) {
...
//
#[no_mangle]
unsafe extern "C" fn disas_func(dctx: *mut disas_context, func: *mut symbol) {
...
pub unsafe extern "C" fn disas_funcs(dctx: *mut disas_context) {
    ...
    {
    let mut disas_all: bool = !strcmp(opts.disas, "*");
    struct section *sec;
    struct symbol *sym;
