...
//! Source: tools/objtool/arch/loongarch/decode.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_loongarch(elf: *const elf) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_jump_table_sym_offset(reloc: *mut reloc, table: *mut reloc) -> c_ulong {
