...
//! Source: tools/objtool/arch/x86/special.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_alt_ignore_new_reloc(sec: *mut section, offset: c_ulong) -> bool {
...
//
    ...
    for (;;) {
    let mut len: c_uint = max(iter.orig_len, alt.orig_len);
...
// table_size = 0;
    ...
    cpu_feature_names[feature_number] : core::ptr::null_mut();
    }
