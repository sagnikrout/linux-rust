...
//! Source: tools/objtool/arch/x86/decode.c
#![no_std]
...
pub const CONFIG_64BIT: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn is_x86_64(elf: *const elf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phys_to_virt(pa: c_ulong) -> c_ulong {
...
pub unsafe extern "C" fn arch_insn_adjusted_addend(insn: *mut instruction, reloc: *mut reloc) -> i64 {
    ...
    {
    let mut addend: i64 = reloc_addend(reloc);
...
//
    ...
    return -1; \
#[no_mangle]
pub unsafe extern "C" fn for(op: *mut *mut ops_list =, NULL: ops_list = &op->next; op; op =) -> else {
    else for (*ops_list = op, ops_list = &op.next; op; op = core::ptr::null_mut())
//
...
#[no_mangle]
unsafe extern "C" fn has_notrack_prefix(insn: *mut insn) -> bool {
    ...
    struct stack_op *op = core::ptr::null_mut();
    struct symbol *sym;
    u64 imm;
...
// eretu/erets
    ...
    insn.type = INSN_CLAC;
#[no_mangle]
pub unsafe extern "C" fn if(0xcb: modrm ==) -> else {
    else if (modrm == 0xcb)
    insn.type = INSN_STAC;
    break;
    }
...
pub const BYTE_RET: c_uint = 0xC3;
...
#[no_mangle]
pub unsafe extern "C" fn arch_is_retpoline(sym: *mut symbol) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_is_rethunk(sym: *mut symbol) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_is_embedded_insn(sym: *mut symbol) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_absolute_reloc(elf: *mut elf, reloc: *mut reloc) -> bool {
