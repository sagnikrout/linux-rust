...
//! Source: tools/objtool/klp-post-link.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fix_klp_relocs(elf: *mut elf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cmd_klp_post_link(argc: c_int, argv: *const c_char) -> c_int {
