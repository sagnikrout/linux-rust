...
//! Source: tools/objtool/klp-checksum.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn checksum_debug_init(file: *mut objtool_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn checksum_update_object(file: *mut objtool_file, sym: *mut symbol) {
    ...
    let mut sym_offset: c_ulong = reloc_offset(reloc) - sym.offset;
...
pub unsafe extern "C" fn create_sym_checksum_section(file: *mut objtool_file) -> c_int {
    ...
    let mut entsize: usize = sizeof(struct sym_checksum);
...
#[no_mangle]
pub unsafe extern "C" fn cmd_klp_checksum(argc: c_int, argv: *const c_char) -> c_int {
