...
//! Source: tools/arch/x86/lib/insn.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_init(insn: *mut insn, kaddr: *const c_void, buf_len: c_int, x86_64: c_int) {
...
#[no_mangle]
unsafe extern "C" fn insn_get_emulate_prefix(insn: *mut insn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_prefixes(insn: *mut insn) -> c_int {
...
// Decode VEX/XOP prefix
    ...
    let mut b2: insn_byte_t = peek_nbyte_next(insn_byte_t, insn, 1);
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_opcode(insn: *mut insn) -> c_int {
...
// map 1 is escape 0x0f
    let mut esc_attr: insn_attr_t = inat_get_opcode_attribute(0x0f);
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_modrm(insn: *mut insn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_rip_relative(insn: *mut insn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_sib(insn: *mut insn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_displacement(insn: *mut insn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __get_moffset(insn: *mut insn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __get_immv32(insn: *mut insn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __get_immv(insn: *mut insn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __get_immptr(insn: *mut insn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_immediate(insn: *mut insn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_length(insn: *mut insn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn insn_complete(insn: *mut insn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_decode(insn: *mut insn, kaddr: *const c_void, buf_len: c_int, m: enum insn_mode) -> c_int {
