...
//! Source: tools/arch/parisc/include/uapi/asm/mman.h
#![no_std]
...
pub const MAP_FIXED: c_uint = 0x04;
pub const MAP_GROWSDOWN: c_uint = 0x8000;
pub const MAP_HUGETLB: c_uint = 0x80000;
pub const MAP_LOCKED: c_uint = 0x2000;
pub const MAP_NONBLOCK: c_uint = 0x20000;
pub const MAP_NORESERVE: c_uint = 0x4000;
