...
//! Source: tools/arch/mips/include/uapi/asm/mman.h
#![no_std]
...
pub const PROT_EXEC: c_uint = 0x04;
pub const PROT_GROWSDOWN: c_uint = 0x01000000;
pub const PROT_GROWSUP: c_uint = 0x02000000;
pub const PROT_NONE: c_uint = 0x00;
pub const PROT_READ: c_uint = 0x01;
pub const PROT_SEM: c_uint = 0x10;
pub const PROT_WRITE: c_uint = 0x02;
