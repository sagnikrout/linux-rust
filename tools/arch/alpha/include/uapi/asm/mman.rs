...
//! Source: tools/arch/alpha/include/uapi/asm/mman.h
#![no_std]
...
pub const MAP_ANONYMOUS: c_uint = 0x10;
pub const MAP_DENYWRITE: c_uint = 0x02000;
pub const MAP_EXECUTABLE: c_uint = 0x04000;
pub const MAP_FILE: c_int = 0;
pub const MAP_FIXED: c_uint = 0x100;
pub const MAP_GROWSDOWN: c_uint = 0x01000;
pub const MAP_HUGETLB: c_uint = 0x100000;
pub const MAP_LOCKED: c_uint = 0x08000;
pub const MAP_NONBLOCK: c_uint = 0x40000;
pub const MAP_NORESERVE: c_uint = 0x10000;
pub const MAP_POPULATE: c_uint = 0x20000;
pub const MAP_STACK: c_uint = 0x80000;
