...
//! Source: tools/lib/perf/tests/test-evlist.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_mmap_thread() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_mmap_cpus() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_stat_multiplexing() -> c_int {
    static int test_stat_multiplexing(void)
    {
    let mut expected_counts: perf_counts_values = { .val = 0 };
    ...
    int err, i, nonzero = 0;
    unsigned long count;
    let mut max: c_longlong = 0, min = 0, avg = 0;
    let mut error: double = 0.0;
    let mut scaled: i8 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn test_evlist(argc: c_int, argv: *mut c_char) -> c_int {
