...
//! Source: tools/lib/thermal/events.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn handle_thermal_event(n: *mut nl_msg, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thermal_events_ops_init(ops: *mut thermal_events_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn thermal_events_handle(th: *mut thermal_handler, arg: *mut c_void) -> thermal_error_t {
