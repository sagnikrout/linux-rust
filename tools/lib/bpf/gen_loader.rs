...
//! Source: tools/lib/bpf/gen_loader.c
#![no_std]
...
pub const MAX_USED_MAPS: c_int = 64;
pub const MAX_USED_PROGS: c_int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loader_stack {
    pub btf_fd: __u32,
    pub inner_map_fd: __u32,
    pub prog_fd: [__u32; MAX_USED_PROGS],
}

    (__s16)(-sizeof(struct loader_stack) + offsetof(struct loader_stack, field))

#[no_mangle]
unsafe extern "C" fn blob_fd_array_off(gen: *mut bpf_gen, index: c_int) -> c_int {
    static int blob_fd_array_off(struct bpf_gen *gen, int index)
    {
    return gen.fd_array + index * sizeof(int);
    }
#[no_mangle]
unsafe extern "C" fn realloc_insn_buf(gen: *mut bpf_gen, size: __u32) -> c_int {
    static int realloc_insn_buf(struct bpf_gen *gen, __u32 size)
    {
    let mut off: usize = gen.insn_cur - gen.insn_start;
    void *insn_start;
    if (gen.error)
    return gen.error;
    ...
    gen.error = -ENOMEM;
    free(gen.insn_start);
    gen.insn_start = core::ptr::null_mut();
    gen.insn_cur = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn realloc_data_buf(gen: *mut bpf_gen, size: __u32) -> c_int {
    static int realloc_data_buf(struct bpf_gen *gen, __u32 size)
    {
    let mut off: usize = gen.data_cur - gen.data_start;
    void *data_start;
    if (gen.error)
    return gen.error;
    if (size > INT32_MAX || off + size > INT32_MAX) {
    ...
    gen.error = -ENOMEM;
    free(gen.data_start);
    gen.data_start = core::ptr::null_mut();
    gen.data_cur = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn emit(gen: *mut bpf_gen, insn: bpf_insn) {
...
#[no_mangle]
unsafe extern "C" fn emit2(gen: *mut bpf_gen, insn1: bpf_insn, insn2: bpf_insn) {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_gen__init(gen: *mut bpf_gen, log_level: c_int, nr_progs: c_int, nr_maps: c_int) {
    void bpf_gen__init(struct bpf_gen *gen, int log_level, int nr_progs, int nr_maps)
    {
    let mut stack_sz: usize = sizeof(struct loader_stack), nr_progs_sz;
    int i;
    gen.fd_array = add_data(gen, core::ptr::null_mut(), MAX_FD_ARRAY_SZ * sizeof(int));
...
#[no_mangle]
unsafe extern "C" fn add_data(gen: *mut bpf_gen, data: *const c_void, size: __u32) -> c_int {
    static int add_data(struct bpf_gen *gen, const void *data, __u32 size)
    {
    let mut zero: __u64 = 0;
    __u32 size8;
    void *prev;
    if (size > INT32_MAX) {
    gen.error = -ERANGE;
...
//
#[no_mangle]
unsafe extern "C" fn add_map_fd(gen: *mut bpf_gen) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_kfunc_btf_fd(gen: *mut bpf_gen) -> c_int {
    static int add_kfunc_btf_fd(struct bpf_gen *gen)
    {
    int cur;
    if (gen.nr_fd_array == MAX_KFUNC_DESCS) {
    cur = add_data(gen, core::ptr::null_mut(), sizeof(int));
    return (cur - gen.fd_array) / sizeof(int);
    }
    return MAX_USED_MAPS + gen.nr_fd_array++;
    }
#[no_mangle]
unsafe extern "C" fn insn_bytes_to_bpf_size(sz: __u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emit_rel_store(gen: *mut bpf_gen, off: c_int, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn move_blob2blob(gen: *mut bpf_gen, off: c_int, size: c_int, blob_off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn move_blob2ctx(gen: *mut bpf_gen, ctx_off: c_int, size: c_int, blob_off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn move_stack2blob(gen: *mut bpf_gen, off: c_int, size: c_int, stack_off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn move_stack2ctx(gen: *mut bpf_gen, ctx_off: c_int, size: c_int, stack_off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_sys_bpf(gen: *mut bpf_gen, cmd: c_int, attr: c_int, attr_size: c_int) {
...
#[no_mangle]
unsafe extern "C" fn is_simm16(value: __s64) -> bool {
    static bool is_simm16(__s64 value)
    {
    let mut value: return = = (__s64)(__s16)value;
    }
#[no_mangle]
unsafe extern "C" fn emit_check_err(gen: *mut bpf_gen) {
    static void emit_check_err(struct bpf_gen *gen)
    {
    let mut off: __s64 = -(gen.insn_cur - gen.insn_start - gen.cleanup_label) / 8 - 1;
...
#[no_mangle]
unsafe extern "C" fn debug_regs(gen: *mut bpf_gen, reg1: c_int, reg2: c_int, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn debug_ret(gen: *mut bpf_gen, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn __emit_sys_close(gen: *mut bpf_gen) {
...
#[no_mangle]
unsafe extern "C" fn emit_sys_close_stack(gen: *mut bpf_gen, stack_off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_sys_close_blob(gen: *mut bpf_gen, blob_off: c_int) {
    static void emit_sys_close_blob(struct bpf_gen *gen, int blob_off)
    {
    emit2(gen, BPF_LD_IMM64_RAW_FULL(BPF_REG_0, BPF_PSEUDO_MAP_IDX_VALUE,
    0, 0, 0, blob_off));
...
#[no_mangle]
pub unsafe extern "C" fn bpf_gen__finish(gen: *mut bpf_gen, nr_progs: c_int, nr_maps: c_int) -> c_int {
...
// use target endianness for embedded loader
    ...
    let mut insn_cnt: c_int = opts.insns_sz / sizeof(struct bpf_insn);
...
//
    ...
    __u32 btf_raw_size)
    {
    let mut attr_size: c_int = offsetofend(union bpf_attr, btf_log_level);
...
// remember btf_fd in the stack, if successful
    ...
    {
    let mut attr_size: c_int = offsetofend(union bpf_attr, map_extra);
    let mut close_inner_map_fd: bool = false;
...
#[no_mangle]
unsafe extern "C" fn emit_find_attach_target(gen: *mut bpf_gen) {
...
//
#[no_mangle]
unsafe extern "C" fn emit_bpf_find_by_name_kind(gen: *mut bpf_gen, relo: *mut ksym_relo_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn emit_bpf_kallsyms_lookup_name(gen: *mut bpf_gen, relo: *mut ksym_relo_desc) {
    ...
    name_off = add_data(gen, relo.name, len);
    res_off = add_data(gen, core::ptr::null_mut(), 8); /* res is u64 */
    emit2(gen, BPF_LD_IMM64_RAW_FULL(BPF_REG_1, BPF_PSEUDO_MAP_IDX_VALUE,
    0, 0, 0, name_off));
    emit(gen, BPF_MOV64_IMM(BPF_REG_2, len));
    emit(gen, BPF_MOV64_IMM(BPF_REG_3, 0));
...
//
#[no_mangle]
unsafe extern "C" fn emit_relo_kfunc_btf(gen: *mut bpf_gen, relo: *mut ksym_relo_desc, insn: c_int) {
...
#[no_mangle]
unsafe extern "C" fn src_reg_mask(gen: *mut bpf_gen) -> __u32 {
...
//
#[no_mangle]
unsafe extern "C" fn emit_relo_ksym_btf(gen: *mut bpf_gen, relo: *mut ksym_relo_desc, insn: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_relo(gen: *mut bpf_gen, relo: *mut ksym_relo_desc, insns: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_relos(gen: *mut bpf_gen, insns: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cleanup_core_relo(gen: *mut bpf_gen) {
    ...
    free(gen.core_relos);
    gen.core_relo_cnt = 0;
    gen.core_relos = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cleanup_relos(gen: *mut bpf_gen, insns: c_int) {
...
// close fd recorded in insn[insn_idx + 1].imm
    ...
    free(gen.ksyms);
    gen.nr_ksyms = 0;
    gen.ksyms = core::ptr::null_mut();
    }
    if (gen.relo_cnt) {
    free(gen.relos);
    gen.relo_cnt = 0;
    gen.relos = core::ptr::null_mut();
    }
...
// Convert func, line, and core relo info blobs to target endianness
    ...
    let mut attr_size: c_int = offsetofend(union bpf_attr, core_relo_rec_size);
    union bpf_attr attr;
    memset(&attr, 0, attr_size);
...
// remember prog_fd in the stack, if successful
    ...
    {
    let mut attr_size: c_int = offsetofend(union bpf_attr, flags);
...
pub unsafe extern "C" fn bpf_gen__map_freeze(gen: *mut bpf_gen, map_idx: c_int) {
    ...
    {
    let mut attr_size: c_int = offsetofend(union bpf_attr, map_fd);
    int map_freeze_attr;
    union bpf_attr attr;
    memset(&attr, 0, attr_size);
