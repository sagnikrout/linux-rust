...
pub const USDT_NOTE_TYPE: c_int = 3;
...
pub struct usdt_arg_spec {
    ...
    pub 8: enum usdt_arg_type arg_type:,
    pub 12: __u16 idx_reg_off:,
    pub 4: __u16 scale_bitshift:,
    pub /: *mut *mut __u8 __reserved: 8; / keep reg_off offset stable,
...
pub const USDT_MAX_ARG_CNT: c_int = 12;
...
pub struct usdt_manager {
    ...
    pub free_spec_cnt: usize,
    pub next_free_spec_id: usize,
...
#[no_mangle]
unsafe extern "C" fn sanity_check_usdt_elf(elf: *mut Elf, path: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_elf_sec_by_name(elf: *mut Elf, sec_name: *const c_char, shdr: *mut GElf_Shdr, scn: *mut Elf_Scn) -> c_int {
...
// check if ELF is corrupted and avoid calling elf_strptr if yes
    if (!elf_rawdata(elf_getscn(elf, shstrndx), core::ptr::null_mut()))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn parse_elf_segs(elf: *mut Elf, path: *const c_char, segs: *mut elf_seg, seg_cnt: *mut usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_vma_segs(pid: c_int, lib_path: *const c_char, segs: *mut elf_seg, seg_cnt: *mut usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn has_nop_combo(fd: c_int, off: c_long) -> bool {
...
unsafe extern "C" fn has_nop_combo(fd: c_int, off: c_long) -> bool {
    ...
    struct elf_seg *segs = core::ptr::null_mut(), *vma_segs = core::ptr::null_mut();
    struct usdt_target *targets = core::ptr::null_mut(), *target;
    Elf *elf = elf_fd.elf;
...
//
    ...
    struct elf_seg *seg = core::ptr::null_mut();
    void *tmp;
...
// if there were no free spec IDs yet, just transfer our IDs
    ...
    usdt_link.spec_ids = core::ptr::null_mut();
    } else {
// otherwise concat IDs
    let mut new_cnt: usize = man.free_spec_cnt + usdt_link.spec_cnt;
    int *new_free_ids;
...
#[no_mangle]
unsafe extern "C" fn specs_hash_fn(key: c_long, ctx: *mut c_void) -> usize {
    static size_t specs_hash_fn(long key, void *ctx)
    {
    return str_hash((char *)key);
    }
#[no_mangle]
unsafe extern "C" fn specs_equal_fn(key1: c_long, key2: c_long, ctx: *mut c_void) -> bool {
...
// is_new = true;
    ...
    __u64 usdt_cookie)
    {
    unsigned long *offsets = core::ptr::null_mut(), *ref_ctr_offsets = core::ptr::null_mut();
    int i, err, spec_map_fd, ip_map_fd;
    LIBBPF_OPTS(bpf_uprobe_opts, opts);
    struct hashmap *specs_hash = core::ptr::null_mut();
    struct bpf_link_usdt *link = core::ptr::null_mut();
    struct usdt_target *targets = core::ptr::null_mut();
    __u64 *cookies = core::ptr::null_mut();
...
//
    ...
    specs_hash = hashmap__new(specs_hash_fn, specs_equal_fn, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn parse_usdt_spec(spec: *mut usdt_spec, note: *const usdt_note, usdt_cookie: __u64) -> c_int {
    static int parse_usdt_spec(struct usdt_spec *spec, const struct usdt_note *note, __u64 usdt_cookie)
    {
...
#[no_mangle]
unsafe extern "C" fn calc_pt_regs_off(reg_name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_usdt_arg(arg_str: *const c_char, arg_num: c_int, arg: *mut usdt_arg_spec, arg_sz: *mut c_int) -> c_int {
    static int parse_usdt_arg(const char *arg_str, int arg_num, struct usdt_arg_spec *arg, int *arg_sz)
    {
