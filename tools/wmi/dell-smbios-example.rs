...
//! Source: tools/wmi/dell-smbios-example.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn show_buffer(buffer: *mut dell_wmi_smbios_buffer) {
...
#[no_mangle]
unsafe extern "C" fn run_wmi_smbios_cmd(buffer: *mut dell_wmi_smbios_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_token(token: __u16, location: *mut __u16, value: *mut __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn query_token(token: __u16, buffer: *mut dell_wmi_smbios_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn query_buffer_size(buffer_size: *mut __u64) -> c_int {
