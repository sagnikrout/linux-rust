...
//! Source: tools/tracing/rtla/src/timerlat_hist.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn timerlat_hist_bpf_pull_data(tool: *mut osnoise_tool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn timerlat_hist_header(tool: *mut osnoise_tool) {
...
#[no_mangle]
unsafe extern "C" fn timerlat_hist_bpf_main_loop(tool: *mut osnoise_tool) -> c_int {
