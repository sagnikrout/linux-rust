...
pub struct dyn_event_operations {
    ...
    pub ev): *mut *mut *mut int (show)(seq_file m, dyn_event,
    pub ev): *mut *mut bool (is_busy)(dyn_event,
    pub ev): *mut *mut int (free)(dyn_event,
    pub ev): *const *const *const int argc, char argv, dyn_event,
}
