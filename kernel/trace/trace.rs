...
pub struct array_buffer {
    ...
    pub data: *mut trace_array_cpu __percpu,
    pub time_start: u64,
    pub cpu: c_int,
}
...
//
extern "C" {
    pub fn bool(tr: *mut *mut cond_update_fn_t)(struct trace_array, cond_data: *mut c_void) -> typedef;
}
...
// The below is for memory mapped ring buffer
    ...
    pub /: *mut *mut *mut void scratch; / pointer in persistent memory,
    pub scratch_size: c_int,
    pub buffer_disabled: c_int,
    pub filtered_pids: *mut trace_pid_list __rcu,
    pub filtered_no_pids: *mut trace_pid_list __rcu,
//
...
pub struct tracer {
    ...
    pub tr): *mut *mut int (init)(struct trace_array,
    pub tr): *mut *mut void (reset)(struct trace_array,
    pub tr): *mut *mut void (start)(struct trace_array,
    pub tr): *mut *mut void (stop)(struct trace_array,
    pub tr): *mut *mut int (update_thresh)(struct trace_array,
    pub iter): *mut *mut void (open)(struct trace_iterator,
    pub iter): *mut *mut void (pipe_open)(struct trace_iterator,
    pub iter): *mut *mut void (close)(struct trace_iterator,
    pub iter): *mut *mut void (pipe_close)(struct trace_iterator,
    pub ppos): *mut size_t cnt, loff_t,
    pub flags): c_uint,

    pub tr): *mut trace_array,

    pub m): *mut *mut void (print_header)(struct seq_file,
    pub iter): *mut *mut print_line_t (print_line)(struct trace_iterator,
...
extern "C" {
    pub fn disable_tracing_selftest(reason: *const c_char) -> void __init;
}
//
...
pub struct trace_user_buf_info {
    pub tbuf: *mut trace_user_buf __percpu,
    pub size: usize,
    pub ref: c_int,
}
...
pub struct event_trigger_data {
    ...
    pub data): *mut *mut void (private_data_free)(struct event_trigger_data,
}
...
pub struct event_command {
    ...
    pub file): *mut trace_event_file,
    pub file): *mut trace_event_file,
    pub file): *mut *mut void (unreg_all)(struct trace_event_file,
    pub file): *mut trace_event_file,
    pub rbe): *mut ring_buffer_event,
    pub rbe): *mut ring_buffer_event,
    pub data): *mut *mut int (init)(struct event_trigger_data,
    pub data): *mut *mut void (free)(struct event_trigger_data,
