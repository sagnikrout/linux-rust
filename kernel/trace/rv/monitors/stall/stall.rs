...
//! Source: kernel/trace/rv/monitors/stall/stall.h
#![no_std]
...
pub struct automaton_stall {
    pub state_names: [*mut c_char; state_max_stall],
    pub event_names: [*mut c_char; event_max_stall],
    pub env_names: [*mut c_char; env_max_stall],
    pub function: [c_uchar; state_max_stall][event_max_stall],
    pub initial_state: c_uchar,
    pub final_states: [bool; state_max_stall],
}