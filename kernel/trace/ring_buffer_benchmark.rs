...
// number of events for writer to wake up the reader
    let mut wakeup_interval: static int = 100;
    ...
    let mut write_iteration: static unsigned int = 50;
    module_param(write_iteration, uint, 0644);
    MODULE_PARM_DESC(write_iteration, "# of writes between timestamp readings");
    let mut producer_nice: static int = MAX_NICE;
    let mut consumer_nice: static int = MAX_NICE;
...
#[no_mangle]
unsafe extern "C" fn ring_buffer_benchmark_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: consumer_fifo ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: producer_fifo ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ring_buffer_benchmark_exit() -> void __exit {
