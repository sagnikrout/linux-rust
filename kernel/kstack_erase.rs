...
//
    ...
    {
    let mut ret: c_int = 0;
    let mut state: c_int = !static_branch_unlikely(&stack_erasing_bypass);
    let mut prev_state: c_int = state;
    let mut table_copy: ctl_table = *table;
...
#[no_mangle]
unsafe extern "C" fn stackleak_sysctls_init() -> int __init {
...
pub unsafe extern "C" fn __sanitizer_cov_stack_depth() -> void __used __no_caller_saved_registers noinstr {
    ...
    {
    let mut sp: c_ulong = current_stack_pointer;
//
