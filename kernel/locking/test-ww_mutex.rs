...
unsafe extern "C" fn __test_mutex(class: *mut ww_class, flags: c_uint) -> c_int {
    ...
    let mut timeout: c_ulong = jiffies + TIMEOUT;
    ret = 0;
    do {
...
unsafe extern "C" fn stress_inorder_work(work: *mut work_struct) {
    ...
    let mut nlocks: c_int = stress.nlocks;
...
#[no_mangle]
unsafe extern "C" fn test_ww_mutex_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_ww_mutex_exit() -> void __exit {
