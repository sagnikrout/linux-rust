...
#[no_mangle]
pub unsafe extern "C" fn debug_mutex_add_waiter(lock: *mut mutex, waiter: *mut mutex_waiter, task: *mut task_struct) {
    lockdep_assert_held(&lock.wait_lock);
// Current thread can't be already blocked (since it's executing!)
    DEBUG_LOCKS_WARN_ON(get_task_blocked_on(task));
    }
#[no_mangle]
pub unsafe extern "C" fn debug_mutex_remove_waiter(lock: *mut mutex, waiter: *mut mutex_waiter, task: *mut task_struct) {
    let mut blocked_on = get_task_blocked_on(task);
