...
//
    ...
    static int __sched
    __ww_rt_mutex_lock(ww_mutex *lock, ww_acquire_ctx *ww_ctx,
...
//
    ...
    int __sched
    ww_mutex_lock(ww_mutex *lock, ww_acquire_ctx *ctx)
    {
    return __ww_rt_mutex_lock(lock, ctx, TASK_UNINTERRUPTIBLE, _RET_IP_);
    }
    EXPORT_SYMBOL(ww_mutex_lock);
    int __sched
    ww_mutex_lock_interruptible(ww_mutex *lock, ww_acquire_ctx *ctx)
    {
...
pub unsafe extern "C" fn ww_mutex_unlock(lock: *mut ww_mutex) -> void __sched {
    void __sched ww_mutex_unlock(ww_mutex *lock)
