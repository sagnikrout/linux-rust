...
pub const RWSEM_READER_SHIFT: c_int = 8;
...
// however unlikely.
//
pub const MAX_READERS_WAKEUP: c_uint = 0x100;
    static inline
#[no_mangle]
...
// Macro flag: #define RT_MUTEX_BUILD_MUTEX
    ...
    __rt_mutex_slowlock_locked(rtm, core::ptr::null_mut(), state, wq)
...
// context here.
//
    __rwsem_set_reader_owned(sem, core::ptr::null_mut());
    }
