...
pub static mut uts_ns_cache: *mut c_void = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn inc_uts_namespaces(ns: *mut user_namespace) -> *mut c_void {
...
//
#[no_mangle]
pub unsafe extern "C" fn clone_uts_ns(user_ns: *mut user_namespace, old_ns: *mut uts_namespace) -> *mut c_void {
...
//
#[no_mangle]
pub unsafe extern "C" fn copy_utsname(flags: u64, user_ns: *mut user_namespace, old_ns: *mut uts_namespace) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn utsns_get(task: *mut task_struct) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn utsns_owner(ns: *mut ns_common) -> *mut c_void {
    return to_uts_ns(ns).user_ns;
    }
pub static mut proc_ns_operations: usize = 0;
#[no_mangle]
pub unsafe extern "C" fn uts_ns_init()  {
    uts_ns_cache = kmem_cache_create_usercopy(
    "uts_namespace", sizeof!(uts_namespace), 0,
    SLAB_PANIC|SLAB_ACCOUNT,
    offsetof(uts_namespace, name),
    sizeof_field(uts_namespace, name),
    core::ptr::null_mut());
