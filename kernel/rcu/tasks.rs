...
extern "C" {
    pub fn void(rtp: *mut *mut rcu_tasks_gp_func_t)(rcu_tasks) -> typedef;
}
extern "C" {
    pub fn void(hop: *mut *mut pregp_func_t)(list_head) -> typedef;
}
extern "C" {
    pub fn void(t: *mut *mut pertask_func_t)(task_struct, hop: *mut list_head) -> typedef;
}
extern "C" {
    pub fn void(hop: *mut *mut postscan_func_t)(list_head) -> typedef;
}
extern "C" {
    pub fn void(hop: *mut *mut holdouts_func_t)(list_head, ndrpt: bool, frptp: *mut bool) -> typedef;
}
extern "C" {
    pub fn void(rtp: *mut *mut postgp_func_t)(rcu_tasks) -> typedef;
}
//
