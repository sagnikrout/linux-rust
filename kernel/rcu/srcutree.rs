...
//
pub const SRCU_SIZING_NONE: c_int = 0;
pub const SRCU_SIZING_INIT: c_int = 1;
pub const SRCU_SIZING_TORTURE: c_int = 2;
...
pub const SRCU_SNP_INIT_SEQ: c_uint = 0x2;
//
...
// Root node, special case.
    snp.srcu_parent = core::ptr::null_mut();
    continue;
    }
// Non-root node.
...
// We are on the job!  Extract and invoke ready callbacks.
    ...
    for (; rhp != core::ptr::null_mut(); rhp = rcu_cblist_dequeue(&ready_cbs)) {
...
// Called after cleanup_srcu_struct(), perhaps.
    pr_cont(" No per-CPU srcu_data structures (.sda == core::ptr::null_mut()).\n");
    } else {
