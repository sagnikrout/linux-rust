...
#[no_mangle]
unsafe extern "C" fn irq_affinity_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_irq_default_affinity() -> void __init {
...
unsafe extern "C" fn free_masks(desc: *mut irq_desc) {
    ...
    let mut __read_mostly: unsigned int total_nr_irqs = NR_IRQS;
//
...
unsafe extern "C" fn per_cpu_count_show(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *mut c_char) -> isize {
    ...
    let mut c: c_uint = irq_desc_kstat_cpu(desc, cpu);
...
#[no_mangle]
unsafe extern "C" fn irq_sysfs_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn early_irq_init() -> int __init {
...
unsafe extern "C" fn demux_redirect_remote(desc: *mut irq_desc) -> bool {
    ...
    let mut target_cpu: c_uint = READ_ONCE(desc.redirect.target_cpu);
