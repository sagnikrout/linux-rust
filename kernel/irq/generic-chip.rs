...
#[no_mangle]
unsafe extern "C" fn irq_readl_be(addr: *mut void __iomem) -> u32 {
    static u32 irq_readl_be(void __iomem *addr)
    {
    return ioread32be(addr);
    }
#[no_mangle]
unsafe extern "C" fn irq_writel_be(val: u32, addr: *mut void __iomem) {
...
pub unsafe extern "C" fn irq_unmap_generic_chip(d: *mut irq_domain, virq: c_uint) {
    ...
    struct irq_data *data = irq_domain_get_irq_data(d, virq);
    struct irq_domain_chip_generic *dgc = d.gc;
    let mut hw_irq: c_uint = data.hwirq;
    struct irq_chip_generic *gc;
    int irq_idx;
...
#[no_mangle]
unsafe extern "C" fn irq_gc_init_ops() -> int __init {
