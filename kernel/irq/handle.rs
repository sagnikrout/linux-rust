...
#[no_mangle]
unsafe extern "C" fn irqhandler_duration_check_setup(arg: *mut c_char) -> int __init {
    ...
    {
    let mut delta_ns: u64 = local_clock() - ts_start;
...
pub unsafe extern "C" fn __handle_irq_event_percpu(desc: *mut irq_desc) -> irqreturn_t {
    ...
    let mut irq: c_uint = desc.irq_data.irq;
...
//
    ...
    let mut ts_start: u64 = local_clock();
