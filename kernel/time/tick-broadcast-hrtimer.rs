...
//! Source: kernel/time/tick-broadcast-hrtimer.c
#![no_std]
...
pub static mut bctimer: usize = 0;
#[no_mangle]
unsafe extern "C" fn bc_shutdown(evt: *mut clock_event_device) -> c_int {
//
...
pub static mut clock_event_device: usize = 0;
#[no_mangle]
unsafe extern "C" fn bc_handler(t: *mut hrtimer) -> enum hrtimer_restart {
