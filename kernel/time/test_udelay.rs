...
pub static mut udelay_test_lock: usize = 0;
    static int udelay_test_usecs;
pub static mut udelay_test_iterations: int = 0;
#[no_mangle]
...
pub static mut allowed_error_ns: c_int = 0;
    while (i < iters) {
    s64 kt1, kt2;
...
#[no_mangle]
pub unsafe extern "C" fn udelay_test_write(file: *mut file, buf: *mut c_char, count: size_t, pos: *mut loff_t) -> ssize_t {
    char lbuf[32];
    let mut ret = 0;
    let mut usecs = 0;
    let mut iters = 0;
...
#[no_mangle]
unsafe extern "C" fn udelay_test_init() -> c_int {
    mutex_lock(&udelay_test_lock);
...
#[no_mangle]
unsafe extern "C" fn udelay_test_exit()  {
    mutex_lock(&udelay_test_lock);
