...
pub const SHIFT_500PPM: c_int = 11;
pub const SHIFT_4000PPM: c_int = 8;
// Number of attempts to read the watchdog
pub const WATCHDOG_FREQ_RETRIES: c_int = 3;
...
//
    kthread_run(clocksource_watchdog_kthread, core::ptr::null_mut(), "kwatchdog");
    }
#[no_mangle]
...
// Ensure that the sequence is in a separate cache line
    pub ____cacheline_aligned: atomic_t seq,
