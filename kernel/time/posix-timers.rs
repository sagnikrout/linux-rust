...
// Returns the clock value in the root time namespace.
    ...
    pub tx): *const *const int (clock_adj)(clockid_t which_clock, __kernel_timex,
    pub timer): *mut *mut int (timer_create)(k_itimer,
// fn ptr field
    pub old_setting): *mut itimerspec64,
    pub timr): *mut *mut int (timer_del)(k_itimer,
    pub cur_setting): *mut itimerspec64,
    pub timr): *mut *mut bool (timer_rearm)(k_itimer,
    pub now): *mut *mut *mut s64 (timer_forward)(k_itimer timr, ktime_t,
    pub now): *mut *mut *mut ktime_t (timer_remaining)(k_itimer timr, ktime_t,
    pub timr): *mut *mut int (timer_try_to_cancel)(k_itimer,
    pub sigev_none): bool absolute, bool,
    pub timr): *mut *mut c_void (timer_wait_running)(k_itimer,
}
