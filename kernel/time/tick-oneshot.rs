...
//
#[no_mangle]
pub unsafe extern "C" fn tick_setup_oneshot(newdev: *mut clock_event_device, next_event: ktime_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tick_switch_to_oneshot(): *mut *mut c_void (handler)(clock_event_device) -> c_int {
#[no_mangle]
#[no_mangle]
// duplicate fn: tick_switch_to_oneshot
pub unsafe extern "C" fn tick_switch_to_oneshot_dup() -> c_int {
