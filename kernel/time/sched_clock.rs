...
#[no_mangle]
pub unsafe extern "C" fn generic_sched_clock_init() -> void __init {
...
unsafe extern "C" fn suspended_sched_clock_read() -> u64 notrace {
    ...
    {
    let mut seq: c_uint = read_seqcount_latch(&cd.seq);
...
#[no_mangle]
unsafe extern "C" fn sched_clock_syscore_init() -> int __init {
