...
// Handle spurious interrupts gracefully
    ...
    let mut next: ktime_t = ktime_add_ns(dev.next_event, TICK_NSEC);
...
//
#[no_mangle]
pub unsafe extern "C" fn tick_broadcast_control(mode: enum tick_broadcast_mode) {
...
#[no_mangle]
pub unsafe extern "C" fn __tick_broadcast_oneshot_control(state: enum tick_broadcast_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tick_broadcast_init() -> void __init {
