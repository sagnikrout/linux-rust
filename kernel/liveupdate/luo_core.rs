...
#[no_mangle]
unsafe extern "C" fn early_liveupdate_param(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn luo_early_startup() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn liveupdate_early_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn luo_state_setup() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn luo_late_startup() -> int __init {
...
pub struct luo_ioctl_op {
    ...
    pub ucmd): *mut *mut int (execute)(struct luo_ucmd,
}
...
#[no_mangle]
unsafe extern "C" fn liveupdate_ioctl_init() -> int __init {
