...
pub static mut unloaded_tainted_modules: usize = 0;
extern "C" { pub static mut mod_debugfs_root: usize; }
#[no_mangle]
pub unsafe extern "C" fn try_add_tainted_module(mod: *mut module) -> c_int {
pub static mut mod_taint: *mut c_void = core::ptr::null_mut();
    if (!mod.taints) {
// goto;
    }
...
pub static mut mod_taint: *mut c_void = core::ptr::null_mut();
    ...
    printk("Unloaded tainted modules:");
...
#[no_mangle]
pub unsafe extern "C" fn unloaded_tainted_modules_seq_start(m: *mut seq_file, rcu: *mut loff_tpos)
    __acquires() -> *mut c_void {
    rcu_read_lock();
    return seq_list_start_rcu(&unloaded_tainted_modules, *pos);
    }
#[no_mangle]
pub unsafe extern "C" fn unloaded_tainted_modules_seq_next(m: *mut seq_file, p: *mut c_void, pos: *mut loff_t) -> *mut c_void {
...
pub static mut mod_taint: *mut c_void = core::ptr::null_mut();
    char buf[MODULE_FLAGS_BUF_SIZE];
    let mut l = 0;
    mod_taint = list_entry(p, mod_unload_taint, list);
    l = module_flags_taint!(mod_taint.taints, buf);
    buf[l++] = '\0';
...
#[no_mangle]
unsafe extern "C" fn unloaded_tainted_modules_init() -> c_int {
