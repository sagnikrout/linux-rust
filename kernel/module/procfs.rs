...
pub static mut printed_something: c_int = 0;
...
#[no_mangle]
#[no_mangle]
// duplicate fn: print_unload_info
pub unsafe extern "C" fn print_unload_info_dup(m: *mut seq_file, mod: *mut module) {
...
#[no_mangle]
pub unsafe extern "C" fn m_start(m: *mut seq_file, pos: *mut loff_t) -> *mut c_void {
    mutex_lock(&module_mutex);
    return seq_list_start(&modules, *pos);
    }
#[no_mangle]
pub unsafe extern "C" fn m_next(m: *mut seq_file, p: *mut c_void, pos: *mut loff_t) -> *mut c_void {
...
unsafe extern "C" fn m_show(m: *mut seq_file, p: *mut c_void) -> c_int {
    let mut mod = list_entry(p, module, list);
...
pub static mut err: c_int = 0;
    ...
    m.private = kallsyms_show_value(file.f_cred) ? core::ptr::null_mut() : 8ul;
    }
    return err;
    }
pub static mut proc_ops: usize = 0;
#[no_mangle]
unsafe extern "C" fn proc_modules_init() -> c_int {
