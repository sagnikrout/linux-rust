...
pub const NUM_SAMPLE_PERIODS: c_int = 5;
    ...
    let mut watchdog_user_enabled: int __read_mostly = 1;
    let mut watchdog_hardlockup_user_enabled: static int __read_mostly = WATCHDOG_HARDLOCKUP_DEFAULT;
    let mut watchdog_softlockup_user_enabled: static int __read_mostly = 1;
    let mut watchdog_thresh: int __read_mostly = 10;
...
//
    let mut watchdog_hardlockup_miss_thresh: int __read_mostly = 1;
...
//
    ...
    let mut hardlockup_count_attr: static struct kobj_attribute = __ATTR_RO(hardlockup_count);
#[no_mangle]
...
//
#[no_mangle]
pub unsafe extern "C" fn hardlockup_detector_disable() -> void __init {
    void __init hardlockup_detector_disable(void)
    {
    watchdog_hardlockup_user_enabled = 0;
    }
#[no_mangle]
unsafe extern "C" fn hardlockup_panic_setup(str: *mut c_char) -> int __init {
    ...
    hardlockup_panic = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(str, _arg: "nopanic", _arg: 7)) -> else {
    else if (!strncmp(str, "nopanic", 7))
    hardlockup_panic = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(str, _arg: "0", _arg: 1)) -> else {
    else if (!strncmp(str, "0", 1))
    watchdog_hardlockup_user_enabled = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(str, _arg: "1", _arg: 1)) -> else {
    else if (!strncmp(str, "1", 1))
    watchdog_hardlockup_user_enabled = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(str, _arg: "r", _arg: 1)) -> else {
...
unsafe extern "C" fn watchdog_hardlockup_update_reset(cpu: c_uint) {
    ...
    {
    let mut hrint: c_int = atomic_read(&per_cpu(hrtimer_interrupts, cpu));
//
...
// Global variables, exported for sysctl
    ...
    let mut softlockup_count_attr: static struct kobj_attribute = __ATTR_RO(softlockup_count);
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn softlockup_panic_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nowatchdog_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nosoftlockup_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn watchdog_thresh_setup(str: *mut c_char) -> int __init {
...
unsafe extern "C" fn update_cpustat() {
    ...
    let mut tail: u8 = __this_cpu_read(cpustat_tail);
    let mut sample_period_16: u16 = get_16bit_precision(sample_period);
...
unsafe extern "C" fn print_cpustat() {
    ...
    int i, group;
    let mut tail: u8 = __this_cpu_read(cpustat_tail);
    let mut sample_period_msecond: u64 = sample_period;
...
unsafe extern "C" fn tabulate_irq_count(irq_counts: *mut irq_counts, irq: c_int, counts: u32, rank: c_int) {
    ...
    {
    int i;
    let mut new_count: irq_counts = {irq, counts};
    for (i = 0; i < rank; i++) {
...
unsafe extern "C" fn need_counting_irqs() -> bool {
    ...
    {
    u8 util;
    let mut tail: c_int = __this_cpu_read(cpustat_tail);
...
#[no_mangle]
unsafe extern "C" fn watchdog_sysctl_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn lockup_detector_delay_init(work: *mut work_struct) -> void __init {
    static void __init lockup_detector_delay_init(struct work_struct *work)
    {
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn lockup_detector_retry_init() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn lockup_detector_check() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn lockup_detector_init() -> void __init {
