...
pub struct callchain_cpus_entries {
    ...
    let mut __read_mostly: int sysctl_perf_event_max_stack = PERF_MAX_STACK_DEPTH;
    let mut __read_mostly: int sysctl_perf_event_max_contexts_per_stack = PERF_MAX_CONTEXTS_PER_STACK;
    let mut six_hundred_forty_kb: static int = 640 * 1024;
#[no_mangle]
...
//
    ...
    let mut new_value: c_int = *value, ret;
...
#[no_mangle]
unsafe extern "C" fn init_callchain_sysctls() -> int __init {
