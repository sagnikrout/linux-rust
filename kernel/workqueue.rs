...
pub const BH_WORKER_RESTARTS: c_int = 10;
//
...
//
    ...
    pub rcu: rcu_head,
    pub WORK_STRUCT_PWQ_SHIFT): } __aligned(1 <<,
//
...
//
pub const WCI_MAX_ENTS: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wci_ent {
    pub func: work_func_t,
    pub cnt: core::sync::atomic::AtomicI64,
...
unsafe extern "C" fn manage_workers(worker: *mut worker) -> bool {
    ...
    pool.manager = core::ptr::null_mut();
    pool.flags &= ~POOL_MANAGER_ACTIVE;
...
// we're done with it, release
    ...
    worker.current_work = core::ptr::null_mut();
    worker.current_func = core::ptr::null_mut();
    worker.current_pwq = core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wq_drain_dead_softirq_work {
...
//
    ...
    check_flush_dependency(wq, core::ptr::null_mut(), false);
...
unsafe extern "C" fn free_node_nr_active(nna_ar: *mut wq_node_nr_active) {
    ...
    nna_ar[nr_node_ids] = core::ptr::null_mut();
    }
#[no_mangle]
...
//
    ...
    RCU_INIT_POINTER(*unbound_pwq_slot(wq, cpu), core::ptr::null_mut());
    }
    put_pwq_unlocked(unbound_pwq(wq, -1));
    RCU_INIT_POINTER(*unbound_pwq_slot(wq, -1), core::ptr::null_mut());
    rcu_read_unlock();
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pr_cont_work_struct {
    pub comma: bool,
    pub func: work_func_t,
    pub ctr: c_long,
}
