...
// Don't bother with already dead threads
    ...
    if (unlikely(sighand == core::ptr::null_mut())) {
//
...
//
    ...
    current.last_siginfo = core::ptr::null_mut();
...
pub unsafe extern "C" fn __save_altstack(uss: *mut stack_t __user, sp: c_ulong) -> c_int {
    ...
    ret = do_sigaltstack(uss_ptr ? &uss : core::ptr::null_mut(), &uoss,
