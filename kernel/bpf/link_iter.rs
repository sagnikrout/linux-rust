...
#[no_mangle]
pub unsafe extern "C" fn bpf_link_seq_start(seq: *mut seq_file, pos: *mut loff_t) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_link_seq_next(seq: *mut seq_file, v: *mut c_void, pos: *mut loff_t) -> *mut c_void {
    let mut info = seq.private;
    ++*pos;
    ++info.link_id;
    bpf_link_put(v);
...
pub struct bpf_iter__bpf_link {
    ...
    pub link): *mut *mut __bpf_md_ptr(bpf_link ,,
}

    DEFINE_BPF_ITER_FUNC(bpf_link, bpf_iter_meta *meta, bpf_link *link)
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn bpf_link_iter_init() -> c_int {
