...
#[no_mangle]
unsafe extern "C" fn bpf_verifier_log_attr_valid(log_level: u32, log_buf: *mut char __user, log_size: u32) -> bool {
...
// add_len includes terminal \0, so no need for +1.
    let mut len: u64 = log.end_pos + add_len;
...
#[no_mangle]
pub unsafe extern "C" fn if(log->len_max: len >) -> else {
    ...
    let mut newline: bool = n > 0 && log.kbuf[n - 1] == '\n';
...
// we split log->kbuf into two equal parts for both ends of array
    let mut n: c_int = sizeof(log.kbuf) / 2, nn;
