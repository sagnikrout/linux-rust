...
//
    ...
    pub netns_type: enum netns_bpf_attach_type,
}

// Protects updates to netns_bpf
    DEFINE_MUTEX(netns_bpf_mutex);
#[no_mangle]
unsafe extern "C" fn netns_bpf_attach_type_unneed(type: enum netns_bpf_attach_type) {
...
#[no_mangle]
unsafe extern "C" fn netns_bpf_attach_type_need(type: enum netns_bpf_attach_type) {
...
#[no_mangle]
unsafe extern "C" fn link_count(net: *mut net, type: enum netns_bpf_attach_type) -> c_int {
...
unsafe extern "C" fn bpf_netns_link_release(link: *mut bpf_link) {
    ...
    let mut type: enum netns_bpf_attach_type = net_link.netns_type;
...
#[no_mangle]
pub unsafe extern "C" fn netns_bpf_prog_detach(attr: *const union bpf_attr, ptype: enum bpf_prog_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netns_bpf_max_progs(type: enum netns_bpf_attach_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netns_bpf_init() -> int __init {
