...
#[no_mangle]
pub unsafe extern "C" fn bpf_prog_seq_start(seq: *mut seq_file, pos: *mut loff_t) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_prog_seq_next(seq: *mut seq_file, v: *mut c_void, pos: *mut loff_t) -> *mut c_void {
    let mut info = seq.private;
    ++*pos;
    ++info.prog_id;
    bpf_prog_put(v);
...
pub struct bpf_iter__bpf_prog {
    ...
    pub prog): *mut *mut __bpf_md_ptr(bpf_prog ,,
}

    DEFINE_BPF_ITER_FUNC(bpf_prog, bpf_iter_meta *meta, bpf_prog *prog)
#[no_mangle]
unsafe extern "C" fn __bpf_prog_seq_show(seq: *mut seq_file, v: *mut c_void, in_stop: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_prog_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    return __bpf_prog_seq_show(seq, v, false);
    }
#[no_mangle]
unsafe extern "C" fn bpf_prog_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    if (!v) {
...
#[no_mangle]
unsafe extern "C" fn bpf_prog_iter_init() -> c_int {
