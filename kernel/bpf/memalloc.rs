...
// count of objects in free_llist
    ...
    pub ctx): *mut *mut *mut void (dtor)(void obj, void,
...
unsafe extern "C" fn alloc_bulk(c: *mut bpf_mem_cache, cnt: c_int, node: c_int, atomic: bool) {
    ...
    {
    struct mem_cgroup *memcg = core::ptr::null_mut(), *old_memcg;
    gfp_t gfp;
    void *obj;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn if(c->high_watermark: cnt >) -> else {
...
unsafe extern "C" fn drain_mem_cache(c: *mut bpf_mem_cache) {
    ...
    {
    let mut percpu: bool = !!c.percpu_size;
...
//
    ...
    {
    struct llist_node *llnode = core::ptr::null_mut();
    unsigned long flags;
    let mut cnt: c_int = 0;
