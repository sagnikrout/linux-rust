...
pub struct btf_verifier_env {
    ...
    pub log_type_id: u32,
    pub top_stack: u32,
    pub phase: enum verifier_phase,
    pub resolve_mode: enum resolve_mode,
}
...
pub struct btf_show {
    pub flags: u64,
    pub /: *mut *mut *mut void target; / target of show operation (seq file, buffer),
    pub args): *const *const *const *const __printf(2, 0) void (showfn)(struct btf_show show, char fmt, va_list,
    pub btf: *const btf,
// below are used during iteration
    struct {
    pub depth: u8,
    pub depth_to_show: u8,
    pub depth_check: u8,
    u8 array_member:1,
    pub array_encoding: u16,
    pub type_id: u32,
    pub /: *mut *mut int status; / non-zero for error,
    pub type: *const btf_type,
    pub member: *const btf_member,
    pub /: *mut *mut char name[BTF_SHOW_NAME_SIZE]; / space for member name/type,
    pub state: },
    struct {
    pub size: u32,
    pub head: *mut c_void,
    pub data: *mut c_void,
    pub safe: [u8; BTF_SHOW_OBJ_SAFE_SIZE],
    pub obj: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_kind_operations {
    s32 (*check_meta)(struct btf_verifier_env *env,
    const struct btf_type *t,
    pub meta_left): u32,
    int (*resolve)(struct btf_verifier_env *env,
    pub v): *const resolve_vertex,
    int (*check_member)(struct btf_verifier_env *env,
    const struct btf_type *struct_type,
    const struct btf_member *member,
    pub member_type): *const btf_type,
    ...
    const struct btf_type *t);
#[no_mangle]
unsafe extern "C" fn btf_type_is_modifier(t: *const btf_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btf_start_id(btf: *const btf) -> c_int {
    static int btf_start_id(const struct btf *btf)
    {
    return btf.start_id + (btf.base_btf ? 0 : 1);
    }
#[no_mangle]
pub unsafe extern "C" fn btf_type_is_void(t: *const btf_type) -> bool {
    bool btf_type_is_void(const struct btf_type *t)
    {
    let mut t: return = = &btf_void;
    }
#[no_mangle]
unsafe extern "C" fn btf_type_is_datasec(t: *const btf_type) -> bool {
    static bool btf_type_is_datasec(const struct btf_type *t)
    {
    return BTF_INFO_KIND(t.info) == BTF_KIND_DATASEC;
    }
#[no_mangle]
unsafe extern "C" fn btf_type_is_decl_tag(t: *const btf_type) -> bool {
    static bool btf_type_is_decl_tag(const struct btf_type *t)
    {
    return BTF_INFO_KIND(t.info) == BTF_KIND_DECL_TAG;
    }
#[no_mangle]
unsafe extern "C" fn btf_type_nosize(t: *const btf_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btf_type_nosize_or_null(t: *const btf_type) -> bool {
    static bool btf_type_nosize_or_null(const struct btf_type *t)
    {
    return !t || btf_type_nosize(t);
    }
#[no_mangle]
unsafe extern "C" fn btf_type_is_decl_tag_target(t: *const btf_type) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn btf_is_vmlinux(btf: *const btf) -> bool {
    bool btf_is_vmlinux(const struct btf *btf)
    {
    return btf.kernel_btf && !btf.base_btf;
    }
#[no_mangle]
pub unsafe extern "C" fn btf_nr_types(btf: *const btf) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn btf_check_sorted(btf: *mut btf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn btf_named_start_id(btf: *const btf, own: bool) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn btf_find_by_name_kind_bsearch(btf: *const btf, name: *const c_char) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn btf_find_by_name_kind(btf: *const btf, name: *const c_char, kind: u8) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_find_btf_id(name: *const c_char, kind: u32, btf_p: *mut btf) -> i32 {
...
// res_id = id;
    ...
    {
    const struct btf_type *t;
    t = btf_type_skip_modifiers(btf, id, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn btf_type_is_resolve_source_only(t: *const btf_type) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn btf_type_needs_resolve(t: *const btf_type) -> bool {
...
// t->size can be used
#[no_mangle]
unsafe extern "C" fn btf_type_has_size(t: *const btf_type) -> bool {
    ...
    return "(none)";
#[no_mangle]
pub unsafe extern "C" fn if(BTF_INT_SIGNED: encoding ==) -> else {
    else if (encoding == BTF_INT_SIGNED)
    return "SIGNED";
#[no_mangle]
pub unsafe extern "C" fn if(BTF_INT_CHAR: encoding ==) -> else {
    else if (encoding == BTF_INT_CHAR)
    return "CHAR";
#[no_mangle]
pub unsafe extern "C" fn if(BTF_INT_BOOL: encoding ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn btf_type_int(t: *const btf_type) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn btf_name_offset_valid(btf: *const btf, offset: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __btf_name_char_ok(c: c_char, first: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btf_name_valid_identifier(btf: *const btf, offset: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btf_name_valid_section(btf: *const btf, offset: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __btf_type_int_is_regular(t: *const btf_type, expected_size: usize) -> bool {
    static bool __btf_type_int_is_regular(const struct btf_type *t, size_t expected_size)
    {
    let mut int_data: u32 = btf_type_int(t);
    let mut nr_bits: u8 = BTF_INT_BITS(int_data);
    let mut nr_bytes: u8 = BITS_ROUNDUP_BYTES(nr_bits);
...
#[no_mangle]
unsafe extern "C" fn btf_type_int_is_regular(t: *const btf_type) -> bool {
    static bool btf_type_int_is_regular(const struct btf_type *t)
    {
    return __btf_type_int_is_regular(t, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn btf_type_is_i32(t: *const btf_type) -> bool {
    bool btf_type_is_i32(const struct btf_type *t)
    {
    return btf_type_is_int(t) && __btf_type_int_is_regular(t, 4);
    }
#[no_mangle]
pub unsafe extern "C" fn btf_type_is_i64(t: *const btf_type) -> bool {
    bool btf_type_is_i64(const struct btf_type *t)
    {
    return btf_type_is_int(t) && __btf_type_int_is_regular(t, 8);
    }
#[no_mangle]
pub unsafe extern "C" fn btf_type_is_primitive(t: *const btf_type) -> bool {
...
//
    ...
    u8 nr_bits;
    id = m.type;
    t = btf_type_id_size(btf, &id, core::ptr::null_mut());
    if (!t || !btf_type_is_int(t))
    return false;
    int_data = btf_type_int(t);
    nr_bits = BTF_INT_BITS(int_data);
    if (btf_type_kflag(s)) {
    let mut bitfield_size: u32 = BTF_MEMBER_BITFIELD_SIZE(m.offset);
    let mut bit_offset: u32 = BTF_MEMBER_BIT_OFFSET(m.offset);
...
pub const BTF_SHOW_MAX_ITER: c_int = 10;
...
// BTF_MAX_ITER pointer suffixes "*"
    ...
    const char *name = core::ptr::null_mut(), *prefix = "", *parens = "";
    const struct btf_member *m = show.state.member;
    const struct btf_type *t;
    const struct btf_array *array;
    let mut id: u32 = show.state.type_id;
    const char *member = core::ptr::null_mut();
    let mut show_member: bool = false;
    let mut kinds: u64 = 0;
    int i;
    show.state.name[0] = '\0';
//
...
#[no_mangle]
unsafe extern "C" fn btf_show_obj_size_left(show: *mut btf_show, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btf_show_obj_is_safe(show: *mut btf_show, data: *mut c_void, size: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btf_show_end_type(show: *mut btf_show) {
    static void btf_show_end_type(struct btf_show *show)
    {
    show.state.type = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn btf_show_start_array_member(show: *mut btf_show) {
    static void btf_show_start_array_member(struct btf_show *show)
    {
    show.state.array_member = 1;
    btf_show_start_member(show, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn btf_show_end_member(show: *mut btf_show) {
    static void btf_show_end_member(struct btf_show *show)
    {
    show.state.member = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn btf_show_end_array_member(show: *mut btf_show) {
...
#[no_mangle]
unsafe extern "C" fn btf_show_end_array_type(show: *mut btf_show) {
...
#[no_mangle]
unsafe extern "C" fn btf_show_end_struct_type(show: *mut btf_show) {
...
//
    ...
    btf_verifier_log_type(env, struct_type, core::ptr::null_mut());
    ...
    return;
    if (env.phase != CHECK_META)
    btf_verifier_log_type(env, datasec_type, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn btf_add_type(env: *mut btf_verifier_env, t: *mut btf_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btf_alloc_id(btf: *mut btf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btf_free_id(btf: *mut btf) {
...
#[no_mangle]
unsafe extern "C" fn btf_free_kfunc_set_tab(btf: *mut btf) {
    ...
    kfree(tab.sets[hook]);
    kfree(tab);
    btf.kfunc_set_tab = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn btf_free_dtor_kfunc_tab(btf: *mut btf) {
    ...
    return;
    kfree(tab);
    btf.dtor_kfunc_tab = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn btf_struct_metas_free(tab: *mut btf_struct_metas) {
...
#[no_mangle]
unsafe extern "C" fn btf_free_struct_meta_tab(btf: *mut btf) {
    static void btf_free_struct_meta_tab(struct btf *btf)
    {
    struct btf_struct_metas *tab = btf.struct_meta_tab;
    btf_struct_metas_free(tab);
    btf.struct_meta_tab = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn btf_free_struct_ops_tab(btf: *mut btf) {
    ...
    kfree(tab);
    btf.struct_ops_tab = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn btf_free(btf: *mut btf) {
...
#[no_mangle]
unsafe extern "C" fn btf_free_rcu(rcu: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn btf_get(btf: *mut btf) {
    void btf_get(struct btf *btf)
    {
    refcount_inc(&btf.refcnt);
    }
#[no_mangle]
pub unsafe extern "C" fn btf_put(btf: *mut btf) {
...
#[no_mangle]
pub unsafe extern "C" fn btf_set_base_btf(btf: *mut btf, base_btf: *const btf) {
...
#[no_mangle]
unsafe extern "C" fn env_resolve_init(env: *mut btf_verifier_env) -> c_int {
    static int env_resolve_init(struct btf_verifier_env *env)
    {
    struct btf *btf = env.btf;
    let mut nr_types: u32 = btf.nr_types;
    u32 *resolved_sizes = core::ptr::null_mut();
    u32 *resolved_ids = core::ptr::null_mut();
    u8 *visit_states = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn btf_verifier_env_free(env: *mut btf_verifier_env) {
...
#[no_mangle]
pub unsafe extern "C" fn if(btf_type_is_array(t): btf_type_is_struct(t) ||) -> else {
    ...
    u32 resolved_size)
    {
    let mut type_id: u32 = env.stack[--(env.top_stack)].type_id;
    struct btf *btf = env.btf;
    ...
    {
    return env.top_stack ? &env.stack[env.top_stack - 1] : core::ptr::null_mut();
    }
...
//
    ...
    {
    const struct btf_type *array_type = core::ptr::null_mut();
    const struct btf_array *array = core::ptr::null_mut();
...
// type_id = id;
    ...
    u32 *type_size)
    {
    return __btf_resolve_size(btf, type, type_size, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn btf_resolved_type_id(btf: *const btf, type_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn btf_resolved_type_size(btf: *const btf, type_id: u32) -> u32 {
    ...
    let mut size_type_id: u32 = *type_id;
    let mut size: u32 = 0;
    ...
    return core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: btf_type_has_size(size_type)) -> else {
    else if (btf_type_has_size(size_type))
    size = size_type.size;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: btf_type_is_array(size_type)) -> else {
    else if (btf_type_is_array(size_type))
    size = btf_resolved_type_size(btf, size_type_id);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: btf_type_is_ptr(size_type)) -> else {
    else if (btf_type_is_ptr(size_type))
    size = sizeof(void *);
    else
    return core::ptr::null_mut();
...
//
    ...
    const struct btf_type *member_type)
    {
    let mut int_data: u32 = btf_type_int(member_type);
    let mut struct_bits_off: u32 = member.offset;
    let mut struct_size: u32 = struct_type.size;
    u32 nr_copy_bits;
    u32 bytes_offset;
...
//
    ...
    const struct btf_type *t)
    {
    let mut int_data: c_int = btf_type_int(t);
...
#[no_mangle]
unsafe extern "C" fn btf_int128_print(show: *mut btf_show, data: *mut c_void) {
...
//
    ...
    {
    let mut int_data: u32 = btf_type_int(t);
    let mut encoding: u8 = BTF_INT_ENCODING(int_data);
    let mut sign: bool = encoding & BTF_INT_SIGNED;
    let mut nr_bits: u8 = BTF_INT_BITS(int_data);
    void *safe_data;
...
// (char *)safe_data);
    ...
    let mut resolved_type_id: u32 = member.type;
    struct btf_member resolved_member;
    struct btf *btf = env.btf;
    resolved_type = btf_type_id_size(btf, &resolved_type_id, core::ptr::null_mut());
    if (!resolved_type) {
    btf_verifier_log_member(env, struct_type, member,
    "Invalid member");
    return -EINVAL;
...
//
    ...
    const struct btf_type *next_type;
    let mut next_type_id: u32 = t.type;
    struct btf *btf = env.btf;
...
// pretty print).
//
    if (!btf_type_id_size(btf, &next_type_id, core::ptr::null_mut())) {
...
// fwd type must have a valid name
    ...
    let mut meta_needed: u32 = sizeof(*array);
    if (meta_left < meta_needed) {
    btf_verifier_log_basic(env, t,
    "meta_left:%u meta_needed:%u",
    meta_left, meta_needed);
...
// Check array->index_type
    ...
    index_type = btf_type_id_size(btf, &index_type_id, core::ptr::null_mut());
...
// Check array->type
    ...
    elem_type_id = array.type;
    elem_type = btf_type_skip_modifiers(btf, elem_type_id, core::ptr::null_mut());
    if (elem_type && btf_type_has_size(elem_type))
    elem_size = elem_type.size;
    if (elem_type && btf_type_is_int(elem_type)) {
    let mut int_type: u32 = btf_type_int(elem_type);
...
//
    ...
    u32 meta_left)
    {
    let mut is_union: bool = BTF_INFO_KIND(t.info) == BTF_KIND_UNION;
    const struct btf_member *member;
    u32 meta_needed, last_offset;
    struct btf *btf = env.btf;
    let mut struct_size: u32 = t.size;
    u32 offset;
    u32 i;
...
//
    ...
    btf_verifier_log_member(env, t, member, core::ptr::null_mut());
    last_offset = offset;
    }
    return meta_needed;
    }
...
//
    ...
    let mut member_type_id: u32 = member.type;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_field_info {
    pub type: enum btf_field_type,
    pub off: u32,
    union {
    struct {
    pub type_id: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btf_type_tag_walk_ctx {
    pub /: *const *const *const btf_type t; / Input/Output,
    pub /: *mut *mut u32 id; / Output,
    pub /: *mut *mut u32 res; / Output,
}
...
// We only support a single tag.
    ...
    struct btf_type_tag_walk_ctx ctx;
    let mut type: enum btf_field_type = 0;
    int err;
    u32 res_id;
...
// Only pointer to struct is allowed
    ...
    {
    let mut len: c_int = strlen(tag_key);
    int i, n;
    ...
    {
    const char *value = core::ptr::null_mut();
    const struct btf_type *t;
    int len, id;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: btf_type_is_datasec(t)) -> else {
...
unsafe extern "C" fn btf_field_cmp(_a: *const c_void, _b: *const c_void, priv: *const c_void) -> c_int {
    ...
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(b->offset: a->offset >) -> else {
    ...
    let mut next_off: u32 = 0, field_type_size;
...
//
    ...
    let mut int_bitsize: u32 = sizeof(int) * BITS_PER_BYTE;
    struct_bits_off = BTF_MEMBER_BIT_OFFSET(member.offset);
    nr_bits = BTF_MEMBER_BITFIELD_SIZE(member.offset);
    if (!nr_bits) {
    if (BITS_PER_BYTE_MASKED(struct_bits_off)) {
...
// enum member must have a valid name
    ...
    u32 meta_left)
    {
    let mut meta_needed: u32 = btf_type_vlen(t) * sizeof(struct btf_param);
    if (meta_left < meta_needed) {
    btf_verifier_log_basic(env, t,
    "meta_left:%u meta_needed:%u",
    meta_left, meta_needed);
    ...
    let mut nr_args: u32 = btf_type_vlen(t), i;
...
//
    ...
    let mut meta_needed: u32 = sizeof(*var);
    if (meta_left < meta_needed) {
    btf_verifier_log_basic(env, t,
    "meta_left:%u meta_needed:%u",
    meta_left, meta_needed);
...
unsafe extern "C" fn btf_var_log(env: *mut btf_verifier_env, t: *const btf_type) {
    ...
    {
    const struct btf_var_secinfo *vsi;
    let mut last_vsi_end_off: u64 = 0, sum = 0;
    u32 i, meta_needed;
...
// A var cannot be in type void
    ...
    let mut var_type_id: u32 = vsi.type, type_id, type_size = 0;
...
//
    ...
    let mut meta_needed: u32 = sizeof(*tag);
    s32 component_idx;
    const char *value;
    if (meta_left < meta_needed) {
    btf_verifier_log_basic(env, t,
...
// Check func return type which could be "void" (t->type == 0)
    if (t.type) {
    let mut ret_type_id: u32 = t.type;
...
// Last func arg type_id could be 0 if it is a vararg
    ...
    u32 meta_left)
    {
    let mut saved_meta_left: u32 = meta_left;
    s32 var_meta_size;
...
unsafe extern "C" fn btf_check_all_metas(env: *mut btf_verifier_env) -> c_int {
    ...
    const struct btf_array *array = btf_type_array(t);
    const struct btf_type *elem_type;
    let mut elem_type_id: u32 = array.type;
    u32 elem_size;
    elem_type = btf_type_id_size(btf, &elem_type_id, &elem_size);
    ...
    const struct btf_type *t, u32 type_id)
    {
    let mut save_log_type_id: u32 = env.log_type_id;
    const struct resolve_vertex *v;
    let mut err: c_int = 0;
    env.resolve_mode = RESOLVE_TBD;
...
unsafe extern "C" fn btf_sec_info_cmp(a: *const c_void, b: *const c_void) -> c_int {
    ...
    let mut nr_secs: u32 = ARRAY_SIZE(btf_sec_info_offset);
    const struct btf_header *hdr;
    const struct btf *btf;
    btf = env.btf;
    hdr = &btf.hdr;
...
// Populate the secs from hdr
    ...
    sort(secs, nr_secs,
    sizeof(struct btf_sec_info), btf_sec_info_cmp, core::ptr::null_mut());
...
// Ensure the unsupported header fields are zero
    ...
    {
    struct btf_struct_metas *tab = core::ptr::null_mut();
...
// The record cannot be unset, treat it as an error if so
    ...
    const struct btf_type *t;
    let mut chain_limit: c_int = 32;
    let mut cur_id: u32 = i;
    t = btf_type_by_id(btf, i);
    if (!t)
    return -EINVAL;
    if (!btf_type_is_modifier(t))
...
// Move to next type
    ...
    {
    let mut btf_data: bpfptr_t = make_bpfptr(attr.btf, uattr.is_kernel);
    struct btf_struct_metas *struct_meta_tab;
    struct btf_verifier_env *env = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn find_kern_ctx_type_id(prog_type: enum bpf_prog_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_kern_ctx_btf_id(log: *mut bpf_verifier_log, prog_type: enum bpf_prog_type) -> c_int {
...
pub unsafe extern "C" fn btf_relocate_id(btf: *const btf, id: __u32) -> __u32 {
    ...
    {
    struct btf *btf = core::ptr::null_mut(), *vmlinux_btf, *base_btf = core::ptr::null_mut();
    struct btf_verifier_env *env = core::ptr::null_mut();
    struct bpf_verifier_log *log;
    let mut err: c_int = 0;
...
unsafe extern "C" fn prog_args_trusted(prog: *const bpf_prog) -> bool {
    ...
    {
    let mut atype: enum bpf_attach_type = prog.expected_attach_type;
    switch (prog.type) {
    case BPF_PROG_TYPE_TRACING:
    let mut atype: return = = BPF_TRACE_RAW_TP || atype == BPF_TRACE_ITER;
    case BPF_PROG_TYPE_LSM:
...
// snd_firewire_lib
    ...
    struct btf_type_tag_walk_ctx ctx;
    const struct btf_param *args;
    let mut ptr_err_raw_tp: bool = false;
    u32 nr_args, arg;
    int i, ret;
    if (off % 8) {
...
// adjust offset we're looking for
    ...
    let mut tmp_flag: enum bpf_type_flag = 0;
    let mut ctx: btf_type_tag_walk_ctx = { .t = mtype };
...
//
    ...
    let mut offset: u32 = field.offset;
...
unsafe extern "C" fn __get_type_fmodel_flags(t: *const btf_type) -> u8 {
    ...
    const struct btf_type *t)
    {
    let mut flags: u8 = __get_type_fmodel_flags(t);
    if (btf_param_match_suffix(btf, arg, "__arena__nullable"))
    flags |= BTF_FMODEL_ARENA_ARG | BTF_FMODEL_NULLABLE_ARG;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: btf_param_match_suffix(btf, _arg: arg, _arg: "__arena")) -> else {
    else if (btf_param_match_suffix(btf, arg, "__arena"))
    flags |= BTF_FMODEL_ARENA_ARG;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: btf_param_match_suffix(btf, _arg: arg, _arg: "__nullable")) -> else {
...
// skip PTR and modifiers
    ...
    {
    let mut id: c_int = btf_named_start_id(btf, false) - 1;
...
pub unsafe extern "C" fn btf_prepare_func_args(env: *mut bpf_verifier_env, subprog: c_int) -> c_int {
    ...
    {
    let mut is_global: bool = subprog_aux(env, subprog).linkage == BTF_FUNC_GLOBAL;
...
#[no_mangle]
unsafe extern "C" fn btf_module_init() -> int __init {
    ...
    {
    struct module *res = core::ptr::null_mut();
...
pub unsafe extern "C" fn btf_check_iter_arg(btf: *mut btf, func: *const btf_type, arg_idx: c_int) -> c_int {
    ...
    {
    let mut flags: u32 = func_flags & (KF_ITER_NEW | KF_ITER_NEXT | KF_ITER_DESTROY);
...
//
    ...
    sfx = "new";
#[no_mangle]
pub unsafe extern "C" fn if(KF_ITER_NEXT: flags &) -> else {
...
// Kernel Function (kfunc) BTF ID set registration API
    ...
    let mut vmlinux_set: bool = !btf_is_module(btf);
    let mut add_filter: bool = !!kset.filter;
...
#[no_mangle]
unsafe extern "C" fn bpf_prog_type_to_kfunc_hook(prog_type: enum bpf_prog_type) -> c_int {
...
pub unsafe extern "C" fn btf_kfunc_check_flag(btf: *const btf, kfunc_btf_id: u32, flag: u32) -> c_int {
    ...
    res = is_set;
#[no_mangle]
pub unsafe extern "C" fn if(is_set: res !=) -> else {
    else if (res != is_set)
    return -EINVAL;
    }
    return res;
...
//
    ...
    {
    let mut need_cands: bool = relo.kind != BPF_CORE_TYPE_ID_LOCAL;
    let mut cands: bpf_core_cand_list = {};
...
// If we match on both type and name, the field is considered trusted.
    ...
    let mut pattern_len: usize = sizeof(NOCAST_ALIAS_SUFFIX) - sizeof(char);
...
pub unsafe extern "C" fn __register_bpf_struct_ops(st_ops: *mut bpf_struct_ops) -> c_int {
    ...
    const char *suffix)
    {
    let mut suffix_len: c_int = strlen(suffix), len;
