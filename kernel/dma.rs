...
#[no_mangle]
#[no_mangle]
// duplicate fn: request_dma
pub unsafe extern "C" fn request_dma_dup(dmanr: c_uint, device_id: *const c_char) -> c_int {
    return -EINVAL;
    }
#[no_mangle]
#[no_mangle]
// duplicate fn: free_dma
pub unsafe extern "C" fn free_dma_dup(dmanr: c_uint) {
    }
