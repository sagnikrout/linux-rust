...
// keep last
    ...
    let mut hibernation_mode: static int = HIBERNATION_SHUTDOWN;
    bool freezer_test_done;
    static const struct platform_hibernation_ops *hibernation_ops;
    let mut hibernate_atomic: static atomic_t = ATOMIC_INIT(1);
...
pub unsafe extern "C" fn pm_hibernation_mode_is_suspend() -> bool {
    ...
    {
    let mut hibernation_mode: return = = HIBERNATION_SUSPEND;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(HIBERNATION_PLATFORM: hibernation_mode ==) -> else {
...
pub unsafe extern "C" fn hibernate() -> c_int {
    int hibernate(void)
    {
    let mut snapshot_test: bool = false;
    unsigned int sleep_flags;
    int error;
...
#[no_mangle]
unsafe extern "C" fn find_resume_device() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn software_resume_initcall() -> int __init {
...
//
    ...
    let mut error: c_int = find_resume_device();
    if (error)
    return error;
    }
...
// Convert the last space to a newline if needed.
    ...
    {
    let mut mode: c_int = HIBERNATION_INVALID;
    unsigned int sleep_flags;
...
#[no_mangle]
unsafe extern "C" fn pm_disk_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn resume_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn resume_offset_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hibernate_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn noresume_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn resumewait_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn resumedelay_setup(str: *mut c_char) -> int __init {
    static int __init resumedelay_setup(char *str)
    {
    let mut rc: c_int = kstrtouint(str, 0, &resume_delay);
    if (rc)
    pr_warn("resumedelay: bad option string '%s'\n", str);
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn nohibernate_setup(str: *mut c_char) -> int __init {
