...
pub const TEST_SUSPEND_SECONDS: c_int = 10;
    ...
    let mut test_repeat_count_max: static u32 = 1;
...
pub unsafe extern "C" fn suspend_test_finish(label: *const c_char) {
    ...
    {
    let mut nj: c_long = jiffies - suspend_test_start_time;
    unsigned msec;
...
//
#[no_mangle]
unsafe extern "C" fn test_wakealarm(rtc: *mut rtc_device, state: suspend_state_t) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn has_wakealarm(dev: *mut device, data: *const c_void) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn setup_test_suspend(value: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_suspend() -> int __init {
