...
unsafe extern "C" fn pi_show(s: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    let mut level: c_int = LOGLEVEL_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn pi_setup_module_notifier() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pi_init() -> int __init {
    static int __init pi_init(void)
    {
    struct dentry *dfs_root = debugfs_create_dir("printk", core::ptr::null_mut());
