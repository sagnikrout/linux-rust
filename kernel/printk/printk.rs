...
//
pub const MAX_LOG_TAKE_PART: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devkmsg_user {
    pub seq: core::sync::atomic::AtomicI64,
    pub rs: ratelimit_state,
    pub lock: mutex,
    pub pbufs: printk_buffers,
}
...
// Keep lockdep happy.
    ...
    console_owner = core::ptr::null_mut();
    raw_spin_unlock(&console_owner_lock);
    if (!waiter) {
    spin_release(&console_owner_dep_map, _THIS_IP_);
    return 0;
...
//
pub const PRINTK_MAX_RECURSION: c_int = 3;
//
...
//
    } while (prb_read_valid(prb, next_seq, core::ptr::null_mut()) && console_trylock());
    }
//
...
//
    ...
    if (prb_read_valid(prb, printk_seq, core::ptr::null_mut())) {
    ret = true;
    break;
    }
    }
...
//
    ...
    printk_legacy_kthread = core::ptr::null_mut();
    }
//
