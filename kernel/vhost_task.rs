...
pub struct vhost_task {
    ...
    pub data): *mut *mut c_void (handle_sigkill)(void,
    pub data: *mut c_void,
...
//
#[no_mangle]
pub unsafe extern "C" fn vhost_task_create(arg: *mut c_void, name: *mut c_char) -> *mut c_void {
pub static mut kernel_clone_args: usize = 0;
pub static mut vtsk: *mut c_void = core::ptr::null_mut();
