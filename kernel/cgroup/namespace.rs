...
// cgroup namespaces
#[no_mangle]
pub unsafe extern "C" fn inc_cgroup_namespaces(ns: *mut user_namespace) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn alloc_cgroup_ns() -> *mut c_void {
    struct cgroup_namespace *new_ns __free(kfree) = core::ptr::null_mut();
    let mut ret = 0;
    new_ns = kzalloc_obj(cgroup_namespace, GFP_KERNEL_ACCOUNT);
    if (!new_ns) {
...
#[no_mangle]
pub unsafe extern "C" fn copy_cgroup_ns(flags: u64, user_ns: *mut user_namespace, old_ns: *mut cgroup_namespace) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn cgroupns_get(task: *mut task_struct) -> *mut c_void {
...
#[no_mangle]
pub unsafe extern "C" fn cgroupns_owner(ns: *mut ns_common) -> *mut c_void {
