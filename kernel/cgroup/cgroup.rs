...
// rebind
    RCU_INIT_POINTER(scgrp.subsys[ssid], core::ptr::null_mut());
...
pub unsafe extern "C" fn cgroup_migrate_finish(mgctx: *mut cgroup_mgctx) {
    ...
    mg_src_preload_node) {
    cset.mg_src_cgrp = core::ptr::null_mut();
    cset.mg_dst_cgrp = core::ptr::null_mut();
    cset.mg_dst_cset = core::ptr::null_mut();
...
//
    ...
    src_cset.mg_src_cgrp = core::ptr::null_mut();
    src_cset.mg_dst_cgrp = core::ptr::null_mut();
