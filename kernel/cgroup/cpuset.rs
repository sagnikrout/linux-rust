...
//
pub const PRS_MEMBER: c_int = 0;
pub const PRS_ROOT: c_int = 1;
pub const PRS_ISOLATED: c_int = 2;
...
//
    ...
    rcu_read_unlock();
    remote_cpus_update(cp, core::ptr::null_mut(), tmp.new_cpus, tmp);
    rcu_read_lock();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpuset_migrate_mm_work {
...
// We're done rebinding vmas to this cpuset's new mems_allowed.
    cpuset_being_rebound = core::ptr::null_mut();
    }
//
...
//
    ...
    err = update_parent_effective_cpumask(cs, cmd, core::ptr::null_mut(), &tmpmask);
    } else {
