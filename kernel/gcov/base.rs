...
//
    ...
    let mut gcov_events_enabled = 0;
pub static mut gcov_lock: usize = 0;
//
...
#[no_mangle]
pub unsafe extern "C" fn gcov_module_notifier(nb: *mut notifier_block, event: c_ulong, data: *mut c_void) -> c_int {
    let mut mod = data;
    let mut info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gcov_init() -> c_int {
