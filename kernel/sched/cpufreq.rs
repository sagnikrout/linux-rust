...
pub static mut struct update_util_data  *: usize = 0;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_add_update_util_hook(cpu: c_int, data: *mut update_util_data, data: *mut *mut c_void (func)( update_util_data, time: u64) {
