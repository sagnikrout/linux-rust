...
//
// Macro flag: #define INSTANTIATE_EXPORTED_MIGRATE_DISABLE
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct migration_arg {
    pub task: *mut task_struct,
    pub dest_cpu: c_int,
    pub pending: *mut set_affinity_pending,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct set_affinity_pending {
    pub refs: refcount_t,
    pub stop_pending: c_uint,
    pub done: completion,
    pub stop_work: cpu_stop_work,
    pub arg: migration_arg,
}
...
//
    dst.user_cpus_ptr = core::ptr::null_mut();
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct migration_swap_arg {
    pub dst_task: *mut *mut task_src_task,,
    pub dst_cpu: int src_cpu,,
}
...
// Even if schedstat is disabled, there should not be garbage
    ...
    p.capture_control = core::ptr::null_mut();
...
unsafe extern "C" fn zap_balance_callbacks(rq: *mut rq) {
    ...
    rq.balance_callback = found ? &balance_push_callback : core::ptr::null_mut();
    }
#[no_mangle]
...
//
    ...
    __balance_callbacks(rq, core::ptr::null_mut());
...
// accounting goes to the donor task
    ...
    rq_lock(rq, &rf);
    donor = rq.donor;
    psi_account_irqtime(rq, donor, core::ptr::null_mut());
    update_rq_clock(rq);
...
pub const TICK_SCHED_REMOTE_OFFLINE: c_int = 0;
pub const TICK_SCHED_REMOTE_OFFLINING: c_int = 1;
pub const TICK_SCHED_REMOTE_RUNNING: c_int = 2;
//
...
pub const SM_PREEMPT: c_int = 1;
pub const SM_RTLOCK_WAIT: c_int = 2;
//
...
pub unsafe extern "C" fn sched_show_task(p: *mut task_struct) {
    ...
    show_stack(p, core::ptr::null_mut(), KERN_INFO);
    put_task_stack(p);
    }
...
// Make sure the linker didn't screw up
    ...
    init_cfs_bandwidth(&root_task_group.cfs_bandwidth, core::ptr::null_mut());
...
//
    init_tg_cfs_entry(&root_task_group, &rq.cfs, core::ptr::null_mut(), i, core::ptr::null_mut());
...
//
    ...
    init_tg_rt_entry(&root_task_group, &rq.rt, core::ptr::null_mut(), i, core::ptr::null_mut());

    rq.next_class = &idle_sched_class;
    rq.sd = core::ptr::null_mut();
    rq.rd = core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uclamp_request {
pub const UCLAMP_PERCENT_SHIFT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfs_schedulable_data {
    pub tg: *mut task_group,
    pub quota: u64 period,,
}
