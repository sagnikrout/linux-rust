...
//! Source: kernel/sched/ext/internal.h
#![no_std]
...
//
    pub args): *mut scx_cgroup_init_args,
//
...
// migration.
//
    pub to): *mut *mut cgroup from, cgroup,
//
...
//
    pub burst_us): u64 period_us, u64 quota_us, u64,
//
...
//
    pub SCX_EV_SELECT_CPU_FALLBACK: i64,
//
// When dispatching to a local DSQ, the CPU may have gone offline in
// the meantime. In this case, the task is bounced to the global DSQ.
//
    pub SCX_EV_DISPATCH_LOCAL_DSQ_OFFLINE: i64,
//
// If SCX_OPS_ENQ_LAST is not set, the number of times that a task
// continued to run because there were no other tasks on the CPU.
//
    pub SCX_EV_DISPATCH_KEEP_LAST: i64,
//
// If SCX_OPS_ENQ_EXITING is not set, the number of times that a task
// is dispatched to a local DSQ when exiting.
//
    pub SCX_EV_ENQ_SKIP_EXITING: i64,
//
// If SCX_OPS_ENQ_MIGRATION_DISABLED is not set, the number of times a
// migration disabled task skips ops.enqueue() and is dispatched to its
// local DSQ.
//
    pub SCX_EV_ENQ_SKIP_MIGRATION_DISABLED: i64,
//
...
//
    pub SCX_EV_SUB_FORCED_ADMIT: i64,
//
...
//
    pub SCX_EV_SUB_PREEMPT_DENIED: i64,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scx_caps_updated {
    pub lock: raw_spinlock_t,
    pub caps: u64,
    pub cmask_arena_out: *mut scx_cmask,
    pub node_in_flight: list_head,
// Kernel-side accumulator. Access as &cu->cmask.
    pub _bits: [u64; SCX_CMASK_NR_WORDS(SCX_CID_SHARD_MAX_CPUS)],
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum scx_pick_idle_cpu_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scx_task_iter {
    pub cursor: sched_ext_entity,
    pub locked_task: *mut task_struct,
    pub rq: *mut rq,
    pub rf: rq_flags,
    pub cnt: u32,
    pub list_locked: bool,

    pub cgrp: *mut cgroup,
    pub css_pos: *mut cgroup_subsys_state,
    pub css_iter: css_task_iter,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scx_enable_cmd {
    pub work: kthread_work,
    pub ops: *mut sched_ext_ops,
    pub ops_cid: *mut sched_ext_ops_cid,
}

// string formatting from BPF
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scx_bstr_buf {
    pub data: [u64; MAX_BPRINTF_VARARGS],
    pub line: [c_char; SCX_EXIT_MSG_LEN],
}
...
//
extern "C" {
    pub fn scx_kfunc_context_filter(prog: *const bpf_prog, kfunc_id: u32) -> c_int;
}
extern "C" {
    pub fn scx_cpu_valid(sch: *mut scx_sched, cpu: i32, where: *const c_char) -> bool;
}
extern "C" {
    pub fn scx_get_task_state(p: *const task_struct) -> u32;
}
extern "C" {
    pub fn scx_set_task_state(p: *mut task_struct, state: u32);
}
extern "C" {
    pub fn scx_task_iter_start(iter: *mut scx_task_iter, cgrp: *mut cgroup);
}
extern "C" {
    pub fn scx_task_iter_unlock(iter: *mut scx_task_iter);
}
extern "C" {
    pub fn scx_task_iter_stop(iter: *mut scx_task_iter);
}
extern "C" {
    pub fn scx_set_task_slice(p: *mut task_struct, slice: u64) -> bool;
}
extern "C" {
    pub fn scx_task_slice_ended(rq: *mut rq, p: *mut task_struct);
}
extern "C" {
    pub fn scx_task_unlink_from_dsq(p: *mut task_struct, dsq: *mut scx_dispatch_q);
}
extern "C" {
    pub fn scx_dispatch_dequeue(rq: *mut rq, p: *mut task_struct);
}
extern "C" {
    pub fn scx_consume_global_dsq(sch: *mut scx_sched, rq: *mut rq) -> bool;
}
extern "C" {
    pub fn scx_rq_online(rq: *mut rq) -> bool;
}
extern "C" {
    pub fn scx_flush_dispatch_buf(sch: *mut scx_sched, rq: *mut rq);
}
extern "C" {
    pub fn scx_init_dsq(dsq: *mut scx_dispatch_q, dsq_id: u64, sch: *mut scx_sched) -> i32;
}
extern "C" {
    pub fn scx_kick_cpu(sch: *mut scx_sched, cpu: i32, flags: u64);
}
extern "C" {
    pub fn __scx_bpf_now(rq: *mut rq) -> u64;
}
extern "C" {
    pub fn scx_enable_task(sch: *mut scx_sched, p: *mut task_struct);
}
extern "C" {
    pub fn __scx_disable_and_exit_task(sch: *mut scx_sched, p: *mut task_struct);
}
extern "C" {
    pub fn scx_sub_init_cancel_task(sch: *mut scx_sched, p: *mut task_struct);
}
extern "C" {
    pub fn scx_disable_and_exit_task(sch: *mut scx_sched, p: *mut task_struct);
}

extern "C" {
    pub fn scx_cgroup_lock();
}
extern "C" {
    pub fn scx_cgroup_unlock();
}

extern "C" {
    pub fn scx_set_cmask_scratch_alloc(sch: *mut scx_sched) -> i32;
}
extern "C" {
    pub fn scx_disable_bypass_dsp(sch: *mut scx_sched);
}
extern "C" {
    pub fn scx_bypass(sch: *mut scx_sched, bypass: bool);
}
extern "C" {
    pub fn scx_link_sched(sch: *mut scx_sched) -> i32;
}
extern "C" {
    pub fn scx_unlink_sched(sch: *mut scx_sched);
}
extern "C" {
    pub fn scx_disable_dump(sch: *mut scx_sched);
}
extern "C" {
    pub fn scx_log_sched_disable(sch: *mut scx_sched);
}
extern "C" {
    pub fn scx_flush_disable_work(sch: *mut scx_sched);
}
extern "C" {
    pub fn scx_validate_ops(sch: *mut scx_sched, ops: *const sched_ext_ops) -> c_int;
}
extern "C" {
    pub fn scx_sched_sysfs_add(sch: *mut scx_sched) -> c_int;
}
extern "C" {
    pub fn scx_is_descendant(sch: *mut scx_sched, ancestor: *mut scx_sched) -> bool;
}
...
//
extern "C" {
    pub fn rcu_dereference_protected(_arg: scx_root, _arg: true) -> return;
}
//
...
//
extern "C" {
    pub fn unlikely(_arg: atomic_read(&sch->bypass_dsp_enable_depth)) -> return;
}
//
...
//
extern "C" {
    pub fn __this_cpu_read(_arg: scx_locked_rq_state) -> return;
}
//
...
//
extern "C" {
    pub fn static_branch_unlikely(_arg: &__scx_has_subs) -> return;
}
//
...
//
extern "C" {
    pub fn rcu_dereference_all(_arg: p->scx.sched) -> return;
}
//
