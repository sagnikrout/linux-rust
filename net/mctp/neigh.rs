...
#[no_mangle]
unsafe extern "C" fn __mctp_neigh_free(rcu: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_neigh_remove_dev(mdev: *mut mctp_dev) {
...
#[no_mangle]
unsafe extern "C" fn mctp_rtm_getneigh(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_neigh_lookup(mdev: *mut mctp_dev, eid: mctp_eid_t, ret_hwaddr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_neigh_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn mctp_neigh_net_exit(net: *mut net) -> void __net_exit {
...
// net namespace implementation
    ...
    {THIS_MODULE, PF_MCTP, RTM_NEWNEIGH, mctp_rtm_newneigh, core::ptr::null_mut(), 0},
    {THIS_MODULE, PF_MCTP, RTM_DELNEIGH, mctp_rtm_delneigh, core::ptr::null_mut(), 0},
    {THIS_MODULE, PF_MCTP, RTM_GETNEIGH, core::ptr::null_mut(), mctp_rtm_getneigh, 0},
    };
#[no_mangle]
pub unsafe extern "C" fn mctp_neigh_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_neigh_exit() {
