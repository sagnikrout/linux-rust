...
#[no_mangle]
unsafe extern "C" fn mctp_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_sockaddr_is_ok(addr: *const sockaddr_mctp) -> bool {
    static bool mctp_sockaddr_is_ok(const struct sockaddr_mctp *addr)
    {
    return !addr.__smctp_pad0 && !addr.__smctp_pad1;
    }
#[no_mangle]
unsafe extern "C" fn mctp_sockaddr_ext_is_ok(addr: *const sockaddr_mctp_ext) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mctp_bind(sock: *mut socket, addr: *mut sockaddr_unsized, addrlen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_sendmsg(sock: *mut socket, msg: *mut msghdr, len: usize) -> c_int {
...
// compat, using defaults for new fields
    ...
    {
    struct net *net = sock_net(&msk.sk);
    struct mctp_sk_key *key = core::ptr::null_mut();
    struct mctp_ioc_tag_ctl2 ctl;
    unsigned long flags;
    u8 tag;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn mctp_ioctl(sock: *mut socket, cmd: c_uint, arg: c_ulong) -> c_int {
    static int mctp_ioctl(struct socket *sock, unsigned int cmd, unsigned long arg)
    {
    struct mctp_sock *msk = container_of(sock.sk, struct mctp_sock, sk);
    let mut tagv2: bool = false;
    switch (cmd) {
...
#[no_mangle]
unsafe extern "C" fn mctp_sk_expire_keys(timer: *mut timer_list) {
    static void mctp_sk_expire_keys(struct timer_list *timer)
    {
    ...
    struct mctp_sk_key *key;
    struct hlist_node *tmp;
    let mut next_expiry_valid: bool = false;
    spin_lock_irqsave(&net.mctp.keys_lock, flags);
    hlist_for_each_entry_safe(key, tmp, &msk.keys, sklist) {
...
#[no_mangle]
unsafe extern "C" fn mctp_sk_init(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_sk_close(sk: *mut sock, timeout: c_long) {
    static void mctp_sk_close(struct sock *sk, long timeout)
    {
    sk_common_release(sk);
    }
#[no_mangle]
unsafe extern "C" fn mctp_sk_hash(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_sk_unhash(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn mctp_sk_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn mctp_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn mctp_exit() -> __exit void {
