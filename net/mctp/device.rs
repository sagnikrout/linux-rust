...
#[no_mangle]
unsafe extern "C" fn mctp_addrinfo_size() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_dump_addrinfo(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
// Filter by ifindex if a header is provided
    ...
    {
    let mut portid: u32 = NETLINK_CB(req_skb).portid;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tb[IFA_ADDRESS]) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_dev_hold(mdev: *mut mctp_dev) {
    void mctp_dev_hold(struct mctp_dev *mdev)
    {
    refcount_inc(&mdev.refs);
    }
#[no_mangle]
pub unsafe extern "C" fn mctp_dev_put(mdev: *mut mctp_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_dev_release_key(dev: *mut mctp_dev, key: *mut mctp_sk_key) {
    ...
    key.dev = core::ptr::null_mut();
    mctp_dev_put(dev);
    }
#[no_mangle]
pub unsafe extern "C" fn mctp_dev_set_key(dev: *mut mctp_dev, key: *mut mctp_sk_key) {
...
#[no_mangle]
unsafe extern "C" fn mctp_known(dev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mctp_unregister(dev: *mut net_device) {
    ...
    if (!mdev)
    return;
    RCU_INIT_POINTER(mdev.dev.mctp_ptr, core::ptr::null_mut());
    mctp_route_remove_dev(mdev);
    mctp_neigh_remove_dev(mdev);
    mctp_dev_put(mdev);
    }
#[no_mangle]
unsafe extern "C" fn mctp_register(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_unregister_netdev(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_device_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_device_exit() -> void __exit {
