...
//! Source: net/mctp/test/route-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mctp_test_fragment(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mctp_frag_test_to_desc(t: *const mctp_frag_test, desc: *mut c_char) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_rx_input_test {
    pub hdr: mctp_hdr,
    pub input: bool,
}

#[no_mangle]
unsafe extern "C" fn mctp_test_rx_input(test: *mut kunit) {
    ...
    mctp_pkttype_receive(skb, dev.ndev, &mctp_packet_type, core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_route_input_sk_test {
    pub hdr: mctp_hdr,
    pub type: u8,
    pub deliver: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_sk(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_sk_reasm(test: *mut kunit) {
...
pub struct mctp_route_input_sk_keys_test {
    pub name: *const c_char,
    pub key_peer_addr: mctp_eid_t,
    pub key_local_addr: mctp_eid_t,
    pub key_tag: u8,
    pub hdr: mctp_hdr,
    pub deliver: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_sk_keys(test: *mut kunit) {
...
// (potentially) receive message
    ...
    KUNIT_EXPECT_PTR_EQ(test, skb2, core::ptr::null_mut());
    if (skb2)
    skb_free_datagram(sock.sk, skb2);
    mctp_key_unref(key);
    __mctp_route_test_fini(test, dev, &dst, sock);
...
pub struct test_net {
    ...
    struct test_net *t)
    {
    let mut hdr: mctp_hdr = RX_HDR(1, 9, 8, FL_S | FL_E | FL_T(1) | FL_TO);
    t.msg.data = t.netid;
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_multiple_nets_bind(test: *mut kunit) {
...
// (unsigned int *)skb_pull(rx_skb2, sizeof(t2.msg.data)),
    ...
    struct test_net *t)
    {
    let mut hdr: mctp_hdr = RX_HDR(1, 9, 8, FL_S | FL_E | FL_T(1));
    struct mctp_sock *msk;
    struct netns_mctp *mns;
    unsigned long flags;
    t.msg.data = t.netid;
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_multiple_nets_key(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_sk_fail_single(test: *mut kunit) {
    static void mctp_test_route_input_sk_fail_single(struct kunit *test)
    {
    let mut hdr: mctp_hdr = RX_HDR(1, 10, 8, FL_S | FL_E | FL_TO);
    struct mctp_test_dev *dev;
    struct mctp_dst dst;
    struct socket *sock;
    struct sk_buff *skb;
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_sk_fail_frag(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_cloned_frag(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_route_input_null_eid(test: *mut kunit) {
    static void mctp_test_route_input_null_eid(struct kunit *test)
    {
    let mut hdr: mctp_hdr = RX_HDR(1, 10, 0, FL_S | FL_E | FL_TO);
    let mut addr: sockaddr_mctp = { 0 };
    ...
    mctp_pkttype_receive(skb_pkt, dev.ndev, &mctp_packet_type, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mctp_test_packet_flow(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_fragment_flow(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_output_key_create(test: *mut kunit) {
    static void mctp_test_route_output_key_create(struct kunit *test)
    {
    let mut dst_eid: u8 = 26, src_eid = 15;
    let mut netid: c_uint = 50;
    struct mctp_test_dev *dev;
    struct mctp_sk_key *key;
    struct netns_mctp *mns;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_extaddr_input(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_gw_loop(test: *mut kunit) {
...
// working away from the local stack
    pub dst: unsigned int dev, neigh, gw,,
    pub exp: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_gw_mtu(test: *mut kunit) {
...
pub const MCTP_TEST_LLADDR_LEN: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_test_llhdr {
    pub magic: c_uint,
    pub src: [c_uchar; MCTP_TEST_LLADDR_LEN],
    pub dst: [c_uchar; MCTP_TEST_LLADDR_LEN],
}

    let mut mctp_test_llhdr_magic: static unsigned int = 0x5c78339c;
...
//
#[no_mangle]
unsafe extern "C" fn mctp_test_route_gw_output(test: *mut kunit) {
    ...
    let mut neigh: mctp_neigh = { 0 };
    struct mctp_test_llhdr *ll_hdr;
    let mut dst: mctp_dst = { 0 };
    let mut hdr: mctp_hdr = { 0 };
    struct mctp_test_dev *dev;
    struct sk_buff *skb;
    unsigned char *buf;
    int i, rc;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_bind_lookup_test {
...
// unbound smctp_type
    { .hdr = LK(20, 10),  .ty = 3, .net = 1, .expect = core::ptr::null_mut() },
// smctp_network tests
...
#[no_mangle]
unsafe extern "C" fn mctp_test_bind_lookup(test: *mut kunit) {
    ...
    struct sk_buff *skb_pkt = core::ptr::null_mut(), *skb_sock = core::ptr::null_mut();
    struct socket *sock_ty0, *sock_expect = core::ptr::null_mut();
    struct mctp_test_dev *dev;
    struct mctp_dst dst;
    int rc;
    rx = test.param_value;
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_output_direct_no_eids(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_output_gw_no_eids(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mctp_test_route_output_extaddr_no_eids(test: *mut kunit) {
    ...
    rc = mctp_dst_from_extaddr(&dst, net, dev.ndev.ifindex, 0, core::ptr::null_mut());
    KUNIT_ASSERT_EQ(test, rc, 0);
