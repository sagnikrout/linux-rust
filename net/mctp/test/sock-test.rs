...
//! Source: net/mctp/test/sock-test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_test_sock_local_output_config {
    pub dev: *mut mctp_test_dev,
    pub halen: usize,
    pub haddr: [u8; MAX_ADDR_LEN],
    pub invoked: bool,
    pub rc: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn mctp_test_sock_sendmsg_extaddr(test: *mut kunit) {
    ...
    let mut cfg: mctp_test_sock_local_output_config = { 0 };
    u8 haddr[] = { 0xaa, 0x01 };
    u8 buf[4] = { 0, 1, 2, 3 };
    struct mctp_test_route *rt;
...
#[no_mangle]
unsafe extern "C" fn mctp_test_sock_recvmsg_extaddr(test: *mut kunit) {
    static void mctp_test_sock_recvmsg_extaddr(struct kunit *test)
    {
    let mut recv_addr: sockaddr_mctp_ext = { 0 };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_bind_pair_test {
    pub bind1: *const mctp_test_bind_setup,
    pub bind2: *const mctp_test_bind_setup,
    pub error: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn mctp_bind_pair_desc(t: *const mctp_bind_pair_test, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn mctp_test_bind_invalid(test: *mut kunit) {
...
// bind() fails if the bind() vs connect() networks mismatch.
    ...
    {
    struct socket *sock1 = core::ptr::null_mut(), *sock2 = core::ptr::null_mut(), *sock3 = core::ptr::null_mut();
    int bind_errno;
...
#[no_mangle]
unsafe extern "C" fn mctp_test_bind_conflicts(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mctp_test_assumptions(test: *mut kunit) {
