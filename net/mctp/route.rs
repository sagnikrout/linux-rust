...
//
    ...
    let mut mctp_message_maxlen: static unsigned int = 64 * 1024;
    let mut mctp_key_lifetime: static unsigned long = 6 * CONFIG_HZ;
    static void mctp_flow_prepare_output(struct sk_buff *skb, struct mctp_dev *dev);
// route output callbacks
#[no_mangle]
unsafe extern "C" fn mctp_dst_discard(dst: *mut mctp_dst, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_key_unref(key: *mut mctp_sk_key) {
...
#[no_mangle]
unsafe extern "C" fn mctp_key_add(key: *mut mctp_sk_key, msk: *mut mctp_sock) -> c_int {
...
//
    ...
    skb = key.reasm_head;
    key.reasm_head = core::ptr::null_mut();
    if (!key.manual_alloc) {
    key.reasm_dead = true;
    key.valid = false;
    mctp_dev_release_key(key.dev, key);
...
#[no_mangle]
unsafe extern "C" fn mctp_skb_set_flow(skb: *mut sk_buff, key: *mut mctp_sk_key) {
...
#[no_mangle]
unsafe extern "C" fn mctp_flow_prepare_output(skb: *mut sk_buff, dev: *mut mctp_dev) {
    static void mctp_flow_prepare_output(struct sk_buff *skb, struct mctp_dev *dev)
    {
    struct mctp_sk_key *key;
    struct mctp_flow *flow;
...
#[no_mangle]
unsafe extern "C" fn mctp_frag_queue(key: *mut mctp_sk_key, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_dst_input(dst: *mut mctp_dst, skb: *mut sk_buff) -> c_int {
    static int mctp_dst_input(struct mctp_dst *dst, struct sk_buff *skb)
    {
    struct mctp_sk_key *key, *any_key = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mctp_dst_output(dst: *mut mctp_dst, skb: *mut sk_buff) -> c_int {
...
// route alloc/release
#[no_mangle]
unsafe extern "C" fn mctp_route_release(rt: *mut mctp_route) {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_default_net(net: *mut net) -> c_uint {
    unsigned int mctp_default_net(struct net *net)
    {
    return READ_ONCE(net.mctp.default_net);
    }
#[no_mangle]
pub unsafe extern "C" fn mctp_default_net_set(net: *mut net, index: c_uint) -> c_int {
...
// routing lookups
#[no_mangle]
unsafe extern "C" fn mctp_route_netid(rt: *mut mctp_route) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mctp_dev_saddr(dev: *mut mctp_dev) -> mctp_eid_t {
    static mctp_eid_t mctp_dev_saddr(struct mctp_dev *dev)
    {
    let mut addr: mctp_eid_t = MCTP_ADDR_NULL;
    unsigned long flags;
...
#[no_mangle]
pub unsafe extern "C" fn mctp_dst_release(dst: *mut mctp_dst) {
...
// populates *dst on successful lookup, if set
    ...
    {
    let mut max_depth: c_uint = 32;
    unsigned int depth, mtu = 0;
    let mut rc: c_int = -EHOSTUNREACH;
    rcu_read_lock();
...
// cannot do gateway-ed routes without a src
    ...
    {
    let mut hlen: c_uint = sizeof(struct mctp_hdr);
...
//
#[no_mangle]
unsafe extern "C" fn mctp_route_add(net: *mut net, rt: *mut mctp_route) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_route_add_local(mdev: *mut mctp_dev, addr: mctp_eid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_route_remove_local(mdev: *mut mctp_dev, addr: mctp_eid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_route_remove_dev(mdev: *mut mctp_dev) {
...
//
    ...
    {
    struct mctp_fq_addr *gateway = core::ptr::null_mut();
    let mut ifindex: c_uint = 0;
...
//
    ...
    rta_metrics_policy, core::ptr::null_mut());
    if (rc < 0) {
    ...
    let mut type: c_uchar = RTN_UNSPEC;
    mctp_eid_t daddr_start;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn mctp_dump_rtinfo(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_routes_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn mctp_routes_net_exit(net: *mut net) -> void __net_exit {
    ...
    {THIS_MODULE, PF_MCTP, RTM_NEWROUTE, mctp_newroute, core::ptr::null_mut(), 0},
    {THIS_MODULE, PF_MCTP, RTM_DELROUTE, mctp_delroute, core::ptr::null_mut(), 0},
    {THIS_MODULE, PF_MCTP, RTM_GETROUTE, core::ptr::null_mut(), mctp_dump_rtinfo, 0},
    };
#[no_mangle]
pub unsafe extern "C" fn mctp_routes_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mctp_routes_exit() {
