...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devlink_trap_policer_item {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devlink_trap_group_item {
    pub group: *const devlink_trap_group,
    pub policer_item: *mut devlink_trap_policer_item,
    pub list: list_head,
    pub stats: *mut devlink_stats __percpu,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devlink_trap_item {
    pub trap: *const devlink_trap,
    pub group_item: *mut devlink_trap_group_item,
    pub list: list_head,
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_trap_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_trap_get_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_trap_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_trap_group_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// p_modified = true;
    ...
    policer = policer_item ? policer_item.policer : core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_trap_group_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_trap_generic_verify(trap: *const devlink_trap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_trap_driver_verify(trap: *const devlink_trap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_trap_verify(trap: *const devlink_trap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_trap_group_verify(group: *const devlink_trap_group) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_trap_groups_notify_register(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_trap_groups_notify_unregister(devlink: *mut devlink) {
    ...
    struct devlink_trap_item *trap_item)
    {
    let mut group_id: u16 = trap_item.trap.init_group_id;
    struct devlink_trap_group_item *group_item;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_traps_notify_register(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_traps_notify_unregister(devlink: *mut devlink) {
...
//
    ...
    let mut metadata: devlink_trap_metadata = {};
...
//
    ...
    struct devlink_trap_group_item *group_item)
    {
    let mut policer_id: u32 = group_item.group.init_policer_id;
    struct devlink_trap_policer_item *policer_item;
    if (policer_id == 0)
    return 0;
    policer_item = devlink_trap_policer_item_lookup(devlink, policer_id);
...
#[no_mangle]
pub unsafe extern "C" fn devlink_trap_policers_notify_register(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_trap_policers_notify_unregister(devlink: *mut devlink) {
