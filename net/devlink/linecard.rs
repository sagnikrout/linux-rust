...
pub struct devlink_linecard {
    ...
    pub priv: *mut c_void,
    pub state: enum devlink_linecard_state,
    pub /: *mut *mut mutex state_lock; / Protects state,
...
#[no_mangle]
pub unsafe extern "C" fn devlink_linecard_index(linecard: *mut devlink_linecard) -> c_uint {
    ...
    let mut linecard_index: u32 = nla_get_u32(attrs[DEVLINK_ATTR_LINECARD_INDEX]);
...
#[no_mangle]
pub unsafe extern "C" fn devlink_linecards_notify_register(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_linecards_notify_unregister(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_linecard_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
    ...
    linecard.type = core::ptr::null_mut();
    devlink_linecard_notify(linecard, DEVLINK_CMD_LINECARD_NEW);
    mutex_unlock(&linecard.state_lock);
    }
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_linecard_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_linecard_types_init(linecard: *mut devlink_linecard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_linecard_types_fini(linecard: *mut devlink_linecard) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devl_linecard_destroy(linecard: *mut devlink_linecard) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_linecard_provision_clear(linecard: *mut devlink_linecard) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_linecard_provision_fail(linecard: *mut devlink_linecard) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_linecard_activate(linecard: *mut devlink_linecard) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_linecard_deactivate(linecard: *mut devlink_linecard) {
