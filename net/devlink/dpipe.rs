...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_dpipe_table_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int devlink_nl_dpipe_table_get_doit(struct sk_buff *skb, struct genl_info *info)
    {
    struct devlink *devlink = devlink_nl_ctx(info).devlink;
    const char *table_name =  core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn devlink_dpipe_entry_ctx_prepare(dump_ctx: *mut devlink_dpipe_dump_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_dpipe_entry_ctx_close(dump_ctx: *mut devlink_dpipe_dump_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_dpipe_entry_clear(entry: *mut devlink_dpipe_entry) {
    ...
    struct nlmsghdr *nlh;
    int err;
    dump_ctx.skb = core::ptr::null_mut();
    dump_ctx.cmd = cmd;
    dump_ctx.info = info;
...
//
#[no_mangle]
pub unsafe extern "C" fn devl_dpipe_headers_unregister(devlink: *mut devlink) {
    void devl_dpipe_headers_unregister(struct devlink *devlink)
    {
    lockdep_assert_held(&devlink.lock);
    devlink.dpipe_headers = core::ptr::null_mut();
    }
