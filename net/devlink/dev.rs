...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devlink_reload_combination {
    pub action: enum devlink_reload_action,
    pub limit: enum devlink_reload_limit,
}
...
#[no_mangle]
unsafe extern "C" fn devlink_nl_nested_fill(msg: *mut sk_buff, devlink: *mut devlink) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_notify(devlink: *mut devlink, cmd: enum devlink_command) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_get_dumpit(msg: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_rel_notify_cb(devlink: *mut devlink, obj_index: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_notify_register(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_notify_unregister(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_is_reload_failed(devlink: *const devlink) -> bool {
    ...
    {
    let mut actions: c_ulong = actions_performed;
    int stat_idx;
    int action;
...
#[no_mangle]
unsafe extern "C" fn devlink_reload_reinit_sanity_check(devlink: *mut devlink) {
    ...
    WARN_ON(devlink_rates_check(devlink, core::ptr::null_mut(), core::ptr::null_mut()));
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_reload_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int devlink_nl_reload_doit(struct sk_buff *skb, struct genl_info *info)
    {
    struct devlink *devlink = devlink_nl_ctx(info).devlink;
    enum devlink_reload_action action;
    enum devlink_reload_limit limit;
    struct net *dest_net = core::ptr::null_mut();
    u32 actions_performed;
    int err;
    err = devlink_resources_validate(devlink, core::ptr::null_mut(), info);
    if (err) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_reload_actions_valid(ops: *const devlink_ops) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_eswitch_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_eswitch_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_info_serial_number_put(req: *mut devlink_info_req, sn: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_info_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_info_get_dumpit(msg: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_flash_update_begin_notify(devlink: *mut devlink) {
    static void devlink_flash_update_begin_notify(struct devlink *devlink)
    {
    let mut params: devlink_flash_notify = {};
    __devlink_flash_update_notify(devlink,
    DEVLINK_CMD_FLASH_UPDATE,
    &params);
    }
#[no_mangle]
unsafe extern "C" fn devlink_flash_update_end_notify(devlink: *mut devlink) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devlink_flash_component_lookup_ctx {
    pub lookup_name: *const c_char,
    pub lookup_name_found: bool,
}
    ...
    {
    let mut lookup_ctx: devlink_flash_component_lookup_ctx = {};
    let mut req: devlink_info_req = {};
    const char *component;
    int ret;
    if (!nla_component)
    ...
    ret = devlink.ops.info_get(devlink, &req, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_flash_update_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int devlink_nl_flash_update_doit(struct sk_buff *skb, struct genl_info *info)
    {
    struct nlattr *nla_overwrite_mask, *nla_file_name;
    let mut params: devlink_flash_update_params = {};
    struct devlink *devlink = devlink_nl_ctx(info).devlink;
    ...
    return;
    req.msg = msg;
    err = devlink.ops.info_get(devlink, &req, core::ptr::null_mut());
    if (err)
    goto free_msg;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_compat_flash_update(devlink: *mut devlink, file_name: *const c_char) -> c_int {
    ...
    goto out_unlock;
    devlink_flash_update_begin_notify(devlink);
    ret = devlink.ops.flash_update(devlink, &params, core::ptr::null_mut());
    devlink_flash_update_end_notify(devlink);
    release_firmware(params.fw);
    out_unlock:
    devl_unlock(devlink);
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_selftests_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_selftests_run_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
