...
#[no_mangle]
unsafe extern "C" fn devlink_sb_pool_count(devlink_sb: *mut devlink_sb) -> u16 {
    ...
    let mut sb_index: u32 = nla_get_u32(attrs[DEVLINK_ATTR_SB_INDEX]);
    struct devlink_sb *devlink_sb;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_sb_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_sb_get_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_sb_pool_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    u32 portid, u32 seq, int flags)
    {
    let mut pool_count: u16 = devlink_sb_pool_count(devlink_sb);
    u16 pool_index;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_sb_pool_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_sb_occ_snapshot_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devl_sb_unregister(devlink: *mut devlink, sb_index: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_sb_unregister(devlink: *mut devlink, sb_index: c_uint) {
