...
#[no_mangle]
unsafe extern "C" fn devlink_param_generic_verify(param: *const devlink_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_param_driver_verify(param: *const devlink_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_params_notify_register(devlink: *mut devlink) {
    void devlink_params_notify_register(struct devlink *devlink)
    {
    devlink_params_notify(devlink, DEVLINK_CMD_PARAM_NEW);
    }
#[no_mangle]
pub unsafe extern "C" fn devlink_params_notify_unregister(devlink: *mut devlink) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_param_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_param_verify(param: *const devlink_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_params_driverinit_load_new(devlink: *mut devlink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devl_param_value_changed(devlink: *mut devlink, param_id: u32) {
