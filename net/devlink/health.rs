...
pub struct devlink_fmsg {
    ...
    pub /: *mut *mut int err; / first error encountered on some devlink_fmsg_XXX() call,
    pub data: *mut *mut bool putting_binary; / This flag forces enclosing of binary,
...
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_free(fmsg: *mut devlink_fmsg) {
...
pub struct devlink_health_reporter {
    pub list: list_head,
    pub priv: *mut c_void,
    pub ops: *const devlink_health_reporter_ops,
    pub devlink: *mut devlink,
    pub devlink_port: *mut devlink_port,
    pub dump_fmsg: *mut devlink_fmsg,
...
//
    ...
    struct devlink_health_reporter *reporter;
    let mut port_index_end: c_ulong = ULONG_MAX;
    struct nlattr **attrs = info.attrs;
    let mut port_index_start: c_ulong = 0;
...
//
    ...
    return;
    devlink_fmsg_free(reporter.dump_fmsg);
    reporter.dump_fmsg = core::ptr::null_mut();
    }
...
// store current dump of current error, for later analysis
    devlink_health_do_dump(reporter, priv_ctx, core::ptr::null_mut());
    devl_unlock(devlink);
    }
    if (!reporter.auto_recover)
    return 0;
    devl_lock(devlink);
    ret = devlink_health_reporter_recover(reporter, priv_ctx, core::ptr::null_mut());
    devl_unlock(devlink);
    return ret;
    }
    ...
    if (!reporter)
    return -EINVAL;
    return devlink_health_reporter_recover(reporter, core::ptr::null_mut(), info.extack);
    }
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_err_if_binary(fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_nest_common(fmsg: *mut devlink_fmsg, attrtype: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_obj_nest_start(fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_nest_end(fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_obj_nest_end(fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_put_name(fmsg: *mut devlink_fmsg, name: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_pair_nest_start(fmsg: *mut devlink_fmsg, name: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_pair_nest_end(fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_arr_pair_nest_end(fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_binary_pair_nest_end(fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_bool_put(fmsg: *mut devlink_fmsg, value: bool) {
...
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_u8_put(fmsg: *mut devlink_fmsg, value: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_u32_put(fmsg: *mut devlink_fmsg, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn devlink_fmsg_u64_put(fmsg: *mut devlink_fmsg, value: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_string_put(fmsg: *mut devlink_fmsg, value: *const c_char) {
    ...
    {
    let mut attrtype: c_int = DEVLINK_ATTR_FMSG_OBJ_VALUE_DATA;
    u8 tmp;
    switch (msg.nla_type) {
...
// start = ++i;
    ...
    last = true;
#[no_mangle]
pub unsafe extern "C" fn if(index: err != -EMSGSIZE || tmp_index ==) -> else {
    ...
    if (!state.idx) {
    err = devlink_health_do_dump(reporter, core::ptr::null_mut(), cb.extack);
    if (err)
    goto unlock;
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_fmsg_dump_skb(fmsg: *mut devlink_fmsg, skb: *const sk_buff) {
    ...
    devlink_fmsg_put(fmsg, "csum", ( u32)skb.csum);
