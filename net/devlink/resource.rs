...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devlink_resource {
    pub name: *const c_char,
    pub id: u64,
    pub size: u64,
    pub size_new: u64,
    pub size_valid: bool,
    pub parent: *mut devlink_resource,
    pub size_params: devlink_resource_size_params,
    pub list: list_head,
    pub resource_list: list_head,
    pub occ_get: *mut devlink_resource_occ_get_t,
    pub occ_get_priv: *mut c_void,
}
    ...
    {
    struct devlink_resource *child_resource;
    let mut size_valid: bool = true;
    let mut parts_size: u64 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_resource_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    resource = devlink_resource_find(devlink, core::ptr::null_mut(), resource_id);
    if (!resource)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_resource_dump_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    struct devlink_port *devlink_port;
    struct nlattr *scope_attr = core::ptr::null_mut();
    ...
    err = devlink_resource_dump_fill_one(skb, devlink, core::ptr::null_mut(),
    cb, flags, &state.idx);
    if (err)
    return err;
    state.idx = 0;
...
// Check in case port was removed between dump callbacks.
    ...
    resource = __devlink_resource_find(resource_list_head, core::ptr::null_mut(),
    resource_id);
    if (resource)
    return -EEXIST;
...
#[no_mangle]
unsafe extern "C" fn devlink_resource_unregister(resource: *mut devlink_resource) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devl_resources_unregister(devlink: *mut devlink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_resources_unregister(devlink: *mut devlink) {
...
//
    ...
    return;
    WARN_ON(!resource.occ_get);
    resource.occ_get = core::ptr::null_mut();
    resource.occ_get_priv = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn devl_port_resources_unregister(devlink_port: *mut devlink_port) {
