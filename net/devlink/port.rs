...
//
    ...
    let mut port_index: u32 = nla_get_u32(attrs[DEVLINK_ATTR_PORT_INDEX]);
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_handle_fill(msg: *mut sk_buff, devlink_port: *mut devlink_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_handle_size(devlink_port: *mut devlink_port) -> usize {
...
// msg_updated = true;
    ...
    let mut msg_updated: bool = false;
    int err;
    ...
    if (!msg)
    return;
    err = devlink_nl_port_fill(msg, devlink_port, cmd, 0, 0, 0, core::ptr::null_mut());
    if (err) {
    nlmsg_free(msg);
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn devlink_ports_notify_register(devlink: *mut devlink) {
    void devlink_ports_notify_register(struct devlink *devlink)
    {
    devlink_ports_notify(devlink, DEVLINK_CMD_PORT_NEW);
    }
#[no_mangle]
pub unsafe extern "C" fn devlink_ports_notify_unregister(devlink: *mut devlink) {
    void devlink_ports_notify_unregister(struct devlink *devlink)
    {
    devlink_ports_notify(devlink, DEVLINK_CMD_PORT_DEL);
    }
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_get_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_split_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_unsplit_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_new_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int devlink_nl_port_new_doit(struct sk_buff *skb, struct genl_info *info)
    {
    struct netlink_ext_ack *extack = info.extack;
    let mut new_attrs: devlink_port_new_attrs = {};
    struct devlink *devlink = devlink_nl_ctx(info).devlink;
    struct devlink_port *devlink_port;
    struct sk_buff *msg;
    int err;
...
// Port index of the new port being created by driver.
    ...
    err = devlink_nl_port_fill(msg, devlink_port, DEVLINK_CMD_PORT_NEW,
    info.snd_portid, info.snd_seq, 0, core::ptr::null_mut());
    if (WARN_ON_ONCE(err))
    ...
    nlmsg_free(msg);
    err_out_port_del:
    devlink_port.ops.port_del(devlink, devlink_port, core::ptr::null_mut());
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_port_del_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devlink_port_type_warn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn devlink_port_type_should_warn(devlink_port: *mut devlink_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn devlink_port_type_warn_schedule(devlink_port: *mut devlink_port) {
...
#[no_mangle]
unsafe extern "C" fn devlink_port_type_warn_cancel(devlink_port: *mut devlink_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_port_fini(devlink_port: *mut devlink_port) {
    ...
    let mut devlink_port_dummy_ops: static struct devlink_port_ops = {};
//
...
//
#[no_mangle]
pub unsafe extern "C" fn devl_port_unregister(devlink_port: *mut devlink_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_port_unregister(devlink_port: *mut devlink_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_port_type_eth_set(devlink_port: *mut devlink_port) {
    void devlink_port_type_eth_set(struct devlink_port *devlink_port)
    {
    devl_warn(devlink_port.devlink,
    "devlink port type for port %d set to Ethernet without a software interface reference, device type not supported by the kernel?\n",
    devlink_port.index);
    __devlink_port_type_set(devlink_port, DEVLINK_PORT_TYPE_ETH, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_port_type_clear(devlink_port: *mut devlink_port) {
    ...
    devlink_port.index);
    __devlink_port_type_set(devlink_port, DEVLINK_PORT_TYPE_NOTSET, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn devlink_port_rel_notify_cb(devlink: *mut devlink, port_index: u32) {
