...
pub struct devlink_region {
    ...
    pub list: list_head,
    union {
    pub ops: *const devlink_region_ops,
    pub port_ops: *const devlink_port_region_ops,
}
...
#[no_mangle]
pub unsafe extern "C" fn devlink_regions_notify_register(devlink: *mut devlink) {
    void devlink_regions_notify_register(struct devlink *devlink)
    {
    struct devlink_region *region;
    list_for_each_entry(region, &devlink.region_list, list)
    devlink_nl_region_notify(region, core::ptr::null_mut(), DEVLINK_CMD_REGION_NEW);
    }
#[no_mangle]
pub unsafe extern "C" fn devlink_regions_notify_unregister(devlink: *mut devlink) {
    void devlink_regions_notify_unregister(struct devlink *devlink)
    {
    struct devlink_region *region;
    list_for_each_entry_reverse(region, &devlink.region_list, list)
    devlink_nl_region_notify(region, core::ptr::null_mut(), DEVLINK_CMD_REGION_DEL);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn __devlink_snapshot_id_increment(devlink: *mut devlink, id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __devlink_snapshot_id_decrement(devlink: *mut devlink, id: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn __devlink_snapshot_id_insert(devlink: *mut devlink, id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __devlink_region_snapshot_id_get(devlink: *mut devlink, id: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_region_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    struct devlink_port *port = core::ptr::null_mut();
    struct devlink_region *region;
    const char *region_name;
    struct sk_buff *msg;
    unsigned int index;
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_region_del_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devlink_nl_region_new_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
pub const DEVLINK_REGION_READ_CHUNK_SIZE: c_int = 256;
    ...
    {
    let mut curr_offset: u64 = start_offset;
    let mut err: c_int = 0;
    u8 *data;
...
//
#[no_mangle]
pub unsafe extern "C" fn devl_region_destroy(region: *mut devlink_region) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_region_destroy(region: *mut devlink_region) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_region_snapshot_id_get(devlink: *mut devlink, id: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devlink_region_snapshot_id_put(devlink: *mut devlink, id: u32) {
