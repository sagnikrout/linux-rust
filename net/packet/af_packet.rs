...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct packet_mreq_max {
    pub mr_ifindex: c_int,
    pub mr_type: c_ushort,
    pub mr_alen: c_ushort,
    pub mr_address: [c_uchar; MAX_ADDR_LEN],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct packet_skb_cb {
    union {
    pub pkt: sockaddr_pkt,
    union {
...
//
    ...
    {
    struct sk_buff *next, *head = core::ptr::null_mut(), *tail;
    int rc;
    rcu_read_lock();
    for (; skb != core::ptr::null_mut(); skb = next) {
    next = skb.next;
...
#[no_mangle]
unsafe extern "C" fn packet_xmit(po: *const packet_sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn packet_cached_dev_reset(po: *mut packet_sock) {
    static void packet_cached_dev_reset(struct packet_sock *po)
    {
    RCU_INIT_POINTER(po.cached_dev, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn packet_pick_tx_queue(skb: *mut sk_buff) -> u16 {
    static u16 packet_pick_tx_queue(struct sk_buff *skb)
    {
    ...
    queue_index = ops.ndo_select_queue(dev, skb, core::ptr::null_mut());
    queue_index = netdev_cap_txqueue(dev, queue_index);
    } else {
    queue_index = netdev_pick_tx(dev, skb, core::ptr::null_mut());
    }
    return queue_index;
    }
...
//
#[no_mangle]
unsafe extern "C" fn __register_prot_hook(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn register_prot_hook(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn __unregister_prot_hook(sk: *mut sock, sync: bool) {
...
#[no_mangle]
unsafe extern "C" fn unregister_prot_hook(sk: *mut sock, sync: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn pgv_to_page(addr: *mut c_void) -> *mut page  __pure {
...
#[no_mangle]
unsafe extern "C" fn __packet_set_status(po: *mut packet_sock, frame: *mut c_void, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __packet_get_status(po: *const packet_sock, frame: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vlan_get_tci(skb: *const sk_buff, dev: *mut net_device) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_vlan_dev(dev)) -> else {
...
#[no_mangle]
unsafe extern "C" fn vlan_get_protocol_dgram(skb: *const sk_buff) -> __be16 {
...
//
#[no_mangle]
unsafe extern "C" fn prb_retire_rx_blk_timer_expired(t: *mut hrtimer) -> enum hrtimer_restart {
...
//
    ...
    {
    let mut status: __u32 = TP_STATUS_USER | stat;
...
#[no_mangle]
unsafe extern "C" fn prb_thaw_queue(pkc: *mut tpacket_kbdq_core) {
...
#[no_mangle]
unsafe extern "C" fn prb_curr_blk_in_use(pbd: *mut tpacket_block_desc) -> c_int {
    static int prb_curr_blk_in_use(struct tpacket_block_desc *pbd)
    {
    return TP_STATUS_USER & BLOCK_STATUS(pbd);
    }
#[no_mangle]
unsafe extern "C" fn prb_queue_frozen(pkc: *mut tpacket_kbdq_core) -> c_int {
    static int prb_queue_frozen(struct tpacket_kbdq_core *pkc)
    {
    return pkc.reset_pending_on_curr_blk;
    }
#[no_mangle]
unsafe extern "C" fn prb_clear_blk_fill_status(rb: *mut packet_ring_buffer) {
...
#[no_mangle]
unsafe extern "C" fn prb_previous_blk_num(rb: *mut packet_ring_buffer) -> c_int {
...
// Assumes caller has held the rx_queue.lock
    ...
    int status)
    {
    let mut previous: c_uint = prb_previous_blk_num(rb);
    ...
    int status)
    {
    let mut previous: c_uint = rb.head ? rb.head - 1 : rb.frame_max;
    return packet_lookup_frame(po, rb, previous, status);
    }
#[no_mangle]
unsafe extern "C" fn packet_increment_head(buff: *mut packet_ring_buffer) {
    static void packet_increment_head(struct packet_ring_buffer *buff)
    {
    buff.head = buff.head != buff.frame_max ? buff.head+1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn packet_inc_pending(rb: *mut packet_ring_buffer) {
    static void packet_inc_pending(struct packet_ring_buffer *rb)
    {
    this_cpu_inc(*rb.pending_refcnt);
    }
#[no_mangle]
unsafe extern "C" fn packet_dec_pending(rb: *mut packet_ring_buffer) {
    static void packet_dec_pending(struct packet_ring_buffer *rb)
    {
    this_cpu_dec(*rb.pending_refcnt);
    }
#[no_mangle]
unsafe extern "C" fn packet_read_pending(rb: *const packet_ring_buffer) -> c_uint {
    static unsigned int packet_read_pending(const struct packet_ring_buffer *rb)
    {
    let mut refcnt: c_uint = 0;
    int cpu;
// We don't use pending refcount in rx_ring.
    if (rb.pending_refcnt == core::ptr::null_mut())
    return 0;
...
#[no_mangle]
unsafe extern "C" fn packet_alloc_pending(po: *mut packet_sock) -> c_int {
    static int packet_alloc_pending(struct packet_sock *po)
    {
    po.rx_ring.pending_refcnt = core::ptr::null_mut();
    po.tx_ring.pending_refcnt = alloc_percpu(unsigned int);
    if (unlikely(po.tx_ring.pending_refcnt == core::ptr::null_mut()))
    return -ENOBUFS;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn packet_free_pending(po: *mut packet_sock) {
    static void packet_free_pending(struct packet_sock *po)
    {
    free_percpu(po.tx_ring.pending_refcnt);
    }
pub const ROOM_POW_OFF: c_int = 2;
pub const ROOM_NONE: c_uint = 0x0;
pub const ROOM_LOW: c_uint = 0x1;
pub const ROOM_NORMAL: c_uint = 0x2;
#[no_mangle]
unsafe extern "C" fn __tpacket_has_room(po: *const packet_sock, pow_off: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __tpacket_v3_has_room(po: *const packet_sock, pow_off: c_int) -> bool {
    ...
    let mut ret: c_int = ROOM_NONE;
    if (po.prot_hook.func != tpacket_rcv) {
    let mut rcvbuf: c_int = READ_ONCE(sk.sk_rcvbuf);
    int avail = rcvbuf - atomic_read(&sk.sk_rmem_alloc)
    - (skb ? skb.truesize : 0);
    if (avail > (rcvbuf >> ROOM_POW_OFF))
    return ROOM_NORMAL;
#[no_mangle]
pub unsafe extern "C" fn if(0: avail >) -> else {
    else if (avail > 0)
    return ROOM_LOW;
    else
    return ROOM_NONE;
    ...
    ret = ROOM_NORMAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: __tpacket_v3_has_room(po, _arg: 0)) -> else {
    ...
    ret = ROOM_NORMAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: __tpacket_has_room(po, _arg: 0)) -> else {
...
#[no_mangle]
unsafe extern "C" fn packet_rcv_has_room(po: *mut packet_sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __packet_rcv_try_clear_pressure(po: *mut packet_sock) {
    static void __packet_rcv_try_clear_pressure(struct packet_sock *po)
    {
    if (packet_sock_flag(po, PACKET_SOCK_PRESSURE) &&
    __packet_rcv_has_room(po, core::ptr::null_mut()) == ROOM_NORMAL)
    packet_sock_flag_set(po, PACKET_SOCK_PRESSURE, false);
    }
#[no_mangle]
unsafe extern "C" fn packet_rcv_try_clear_pressure(po: *mut packet_sock) {
...
#[no_mangle]
unsafe extern "C" fn packet_sock_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn fanout_flow_is_huge(po: *mut packet_sock, skb: *mut sk_buff) -> bool {
...
// Avoid dirtying the cache line if possible
    ...
    unsigned int num)
    {
    let mut val: c_uint = atomic_inc_return(&f.rr_cur);
    return val % num;
    }
    ...
    unsigned int num)
    {
    struct packet_sock *po, *po_next, *po_skip = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fanout_has_flag(f: *mut packet_fanout, flag: u16) -> bool {
    ...
    let mut num: c_uint = READ_ONCE(f.num_members);
...
#[no_mangle]
unsafe extern "C" fn __fanout_link(sk: *mut sock, po: *mut packet_sock) {
    static void __fanout_link(struct sock *sk, struct packet_sock *po)
    {
...
#[no_mangle]
unsafe extern "C" fn __fanout_unlink(sk: *mut sock, po: *mut packet_sock) {
    static void __fanout_unlink(struct sock *sk, struct packet_sock *po)
    {
    struct packet_fanout *f = po.fanout;
    int i;
...
#[no_mangle]
unsafe extern "C" fn match_fanout_group(ptype: *mut packet_type, sk: *mut sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fanout_init_data(f: *mut packet_fanout) {
    ...
    case PACKET_FANOUT_CBPF:
    case PACKET_FANOUT_EBPF:
    RCU_INIT_POINTER(f.bpf_prog, core::ptr::null_mut());
    break;
    }
    }
#[no_mangle]
unsafe extern "C" fn __fanout_set_data_bpf(f: *mut packet_fanout, new: *mut bpf_prog) {
    ...
    if (ret)
    return ret;
    ret = bpf_prog_create_from_user(&new, &fprog, core::ptr::null_mut(), false);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn fanout_release_data(f: *mut packet_fanout) {
    static void fanout_release_data(struct packet_fanout *f)
    {
    switch (f.type) {
    case PACKET_FANOUT_CBPF:
    case PACKET_FANOUT_EBPF:
    __fanout_set_data_bpf(f, core::ptr::null_mut());
    }
    }
#[no_mangle]
unsafe extern "C" fn __fanout_id_is_free(sk: *mut sock, candidate_id: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fanout_find_new_id(sk: *mut sock, new_id: *mut u16) -> bool {
    static bool fanout_find_new_id(struct sock *sk, u16 *new_id)
    {
    let mut id: u16 = fanout_next_id;
    do {
...
#[no_mangle]
unsafe extern "C" fn fanout_add(sk: *mut sock, args: *mut fanout_args) -> c_int {
    static int fanout_add(struct sock *sk, struct fanout_args *args)
    {
    struct packet_rollover *rollover = core::ptr::null_mut();
    struct packet_sock *po = pkt_sk(sk);
    let mut type_flags: u16 = args.type_flags;
    struct packet_fanout *f, *match;
    let mut type: u8 = type_flags & 0xff;
    let mut flags: u8 = type_flags >> 8;
    let mut id: u16 = args.id;
    int err;
    switch (type) {
    case PACKET_FANOUT_ROLLOVER:
...
#[no_mangle]
unsafe extern "C" fn packet_parse_headers(skb: *mut sk_buff, sock: *mut socket) {
...
// Keep the allocation-time header length across retry.
    ...
    goto out_unlock;
    if (!skb) {
    let mut reserved: usize = LL_RESERVED_SPACE_EX(dev, hard_header_len);
    let mut tlen: c_int = dev.needed_tailroom;
    let mut hhlen: c_uint = dev.header_ops ? hard_header_len : 0;
    rcu_read_unlock();
...
// Try to align data part correctly
    ...
    {
    let mut vnet_hdr: virtio_net_hdr_mrg_rxbuf = { .num_buffers = 0 };
    if (*len < vnet_hdr_sz)
    return -EINVAL;
// len -= vnet_hdr_sz;
...
//
    ...
    struct packet_type *pt, struct net_device *orig_dev)
    {
    let mut drop_reason: enum skb_drop_reason = SKB_CONSUMED;
...
//
    ...
    skb_push(skb, skb.data - skb_mac_header(skb));
#[no_mangle]
pub unsafe extern "C" fn if(PACKET_OUTGOING: skb->pkt_type ==) -> else {
...
// drop conntrack reference
    ...
    let mut skb_len: c_int = skb.len;
    unsigned int snaplen, res;
    let mut status: c_ulong = TP_STATUS_USER;
    unsigned short macoff, hdrlen;
    unsigned int netoff;
    struct sk_buff *copy_skb = core::ptr::null_mut();
    struct timespec64 ts;
    __u32 ts_status;
    let mut slot_id: c_uint = 0;
...
// If we are flooded, just give up
    ...
    let mut maclen: c_uint = skb_network_offset(skb);
...
#[no_mangle]
unsafe extern "C" fn tpacket_destruct_skb(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn __packet_snd_vnet_parse(vnet_hdr: *mut virtio_net_hdr, len: usize) -> c_int {
...
// move iter to point to the start of mac header
    ...
    core::ptr::null_mut(), tp_len);
    if (unlikely(err < 0))
    return -EINVAL;
    } else if (copylen) {
    let mut hdrlen: c_int = min_t(int, copylen, tp_len);
...
#[no_mangle]
unsafe extern "C" fn tpacket_snd(po: *mut packet_sock, msg: *mut msghdr) -> c_int {
    static int tpacket_snd(struct packet_sock *po, struct msghdr *msg)
    {
    struct sk_buff *skb = core::ptr::null_mut();
    struct net_device *dev;
    struct virtio_net_hdr vnet_hdr;
    let mut has_vnet_hdr: bool = false;
    struct sockcm_cookie sockc;
    __be16 proto;
    int err, reserve = 0;
    void *ph;
    DECLARE_SOCKADDR(struct sockaddr_ll *, saddr, msg.msg_name);
    let mut need_wait: bool = !(msg.msg_flags & MSG_DONTWAIT);
    let mut vnet_hdr_sz: c_int = READ_ONCE(po.vnet_hdr_sz);
    unsigned char *addr = core::ptr::null_mut();
    int tp_len, size_max;
    void *data;
    let mut len_sum: c_int = 0;
    let mut status: c_int = TP_STATUS_AVAILABLE;
...
//
    ...
    if (likely(saddr == core::ptr::null_mut())) {
    ...
    if (unlikely(ph == core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn packet_snd(sock: *mut socket, msg: *mut msghdr, len: usize) -> c_int {
    ...
    int err, reserve = 0;
    struct sockcm_cookie sockc;
    let mut vnet_hdr: virtio_net_hdr = { 0 };
...
//
    ...
    err = -EINVAL;
    if (sock.type == SOCK_DGRAM) {
    offset = dev_hard_header(skb, dev, ntohs(proto), addr, core::ptr::null_mut(), len);
...
#[no_mangle]
unsafe extern "C" fn packet_sendmsg(sock: *mut socket, msg: *mut msghdr, len: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn packet_release(sock: *mut socket) -> c_int {
    ...
    po.prot_hook.dev = core::ptr::null_mut();
    }
    spin_unlock(&po.bind_lock);
...
#[no_mangle]
unsafe extern "C" fn packet_bind(sock: *mut socket, uaddr: *mut sockaddr_unsized, addr_len: c_int) -> c_int {
...
//
    ...
    return -EINVAL;
    return packet_do_bind(sk, core::ptr::null_mut(), sll.sll_ifindex, sll.sll_protocol);
    }
...
//
    ...
    struct sock *sk;
    struct packet_sock *po;
    __be16 proto = ( __be16)protocol; /* weird, but documented */
    int err;
...
//
    ...
    struct sk_buff *skb;
    int copied, err;
    let mut vnet_hdr_len: c_int = READ_ONCE(pkt_sk(sk).vnet_hdr_sz);
    let mut origlen: c_uint = 0;
    err = -EINVAL;
...
// Let __fortify_memcpy_chk() know the actual buffer size.
    ...
    while ((ml = *mlp) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn packet_mc_add(sk: *mut sock, mreq: *mut packet_mreq_max) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn packet_mc_drop(sk: *mut sock, mreq: *mut packet_mreq_max) -> c_int {
    static int packet_mc_drop(struct sock *sk, struct packet_mreq_max *mreq)
    {
    struct packet_mclist *ml, **mlp;
    rtnl_lock();
    for (mlp = &pkt_sk(sk).mclist; (ml = *mlp) != core::ptr::null_mut(); mlp = &ml.next) {
    if (ml.ifindex == mreq.mr_ifindex &&
    ml.type == mreq.mr_type &&
    ml.alen == mreq.mr_alen &&
    memcmp(ml.addr, mreq.mr_address, ml.alen) == 0) {
...
#[no_mangle]
unsafe extern "C" fn packet_flush_mclist(sk: *mut sock) {
    static void packet_flush_mclist(struct sock *sk)
    {
    struct packet_sock *po = pkt_sk(sk);
    struct packet_mclist *ml;
    ...
    return;
    rtnl_lock();
    while ((ml = po.mclist) != core::ptr::null_mut()) {
    struct net_device *dev;
    po.mclist = ml.next;
    dev = __dev_get_by_index(sock_net(sk), ml.ifindex);
    if (dev != core::ptr::null_mut())
...
// packet_dev_mc might grab instance locks so can't run under rcu
    ...
    case SIOCOUTQ:
    {
    let mut amount: c_int = sk_wmem_alloc_get(sk);
    ...
    struct sock *sk = sock.sk;
    struct packet_sock *po = pkt_sk(sk);
    let mut mask: __poll_t = datagram_poll(file, sock, wait);
    spin_lock_bh(&sk.sk_receive_queue.lock);
    if (po.rx_ring.pg_vec) {
...
//
#[no_mangle]
unsafe extern "C" fn packet_mm_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn packet_mm_close(vma: *mut vm_area_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct packet_pg_vec {
    pub deferred: *mut packet_pg_vec_free,
    pub order: c_uint,
    pub len: c_uint,
    pub __counted_by(len): pgv pg_vec[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct packet_pg_vec_free {
    pub work: delayed_work,
    pub sk: *mut sock,
    pub vec: *mut packet_pg_vec,
}
    ...
    order);
    pg_vec[i].buffer = core::ptr::null_mut();
    }
    }
    kfree(vec.deferred);
    kfree(vec);
...
#[no_mangle]
unsafe extern "C" fn packet_free_pg_vec_work(work: *mut work_struct) {
...
// complete and utter failure
    ...
    {
    let mut block_nr: c_uint = req.tp_block_nr;
    struct packet_pg_vec *vec;
    struct pgv *pg_vec;
    int i;
    ...
    pg_vec = core::ptr::null_mut();
    goto out;
    }
    static int packet_set_ring(struct sock *sk, union tpacket_req_u *req_u,
    int closing, int tx_ring)
    {
    struct pgv *pg_vec = core::ptr::null_mut();
    struct packet_sock *po = pkt_sk(sk);
    unsigned long *rx_owner_map = core::ptr::null_mut();
...
// PAGE_SIZE;
    ...
    start = vma.vm_start;
    for (rb = &po.rx_ring; rb <= &po.tx_ring; rb++) {
    if (rb.pg_vec == core::ptr::null_mut())
    continue;
...
#[no_mangle]
unsafe extern "C" fn packet_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn packet_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn packet_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn packet_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn packet_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn packet_init() -> int __init {
