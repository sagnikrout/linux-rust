...
// TX states
pub const NCI_UART_SENDING: c_int = 1;
pub const NCI_UART_TX_WAKEUP: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn nci_uart_queue_empty(nu: *mut nci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_uart_tx_wakeup(nu: *mut nci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_uart_set_driver(tty: *mut tty_struct, driver: c_uint) -> c_int {
    static int nci_uart_set_driver(struct tty_struct *tty, unsigned int driver)
    {
    struct nci_uart *nu = core::ptr::null_mut();
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn nci_uart_tty_open(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_uart_send(nu: *mut nci_uart, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nci_uart_register(nu: *mut nci_uart) -> c_int {
...
// Remove this driver from the driver list
    nci_uart_drivers[nu.driver] = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(nci_uart_unregister);
#[no_mangle]
pub unsafe extern "C" fn nci_uart_set_config(nu: *mut nci_uart, baudrate: c_int, flow_ctrl: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nci_uart_init() -> int __init {
    static int __init nci_uart_init(void)
    {
    return tty_register_ldisc(&nci_uart_ldisc);
    }
#[no_mangle]
unsafe extern "C" fn nci_uart_exit() -> void __exit {
