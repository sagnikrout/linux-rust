...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct core_conn_create_data {
    pub length: c_int,
    pub cmd: *mut nci_core_conn_create_cmd,
}
...
// ---- NCI requests ----
#[no_mangle]
pub unsafe extern "C" fn nci_req_complete(ndev: *mut nci_dev, result: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nci_req_cancel(ndev: *mut nci_dev, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nci_reset_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn nci_init_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn nci_init_complete_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nci_set_config_param {
    pub id: __u8,
    pub len: usize,
    pub val: *const __u8,
}
...
#[no_mangle]
unsafe extern "C" fn nci_set_config_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nci_rf_discover_param {
    pub im_protocols: __u32,
    pub tm_protocols: __u32,
}

#[no_mangle]
unsafe extern "C" fn nci_rf_discover_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nci_rf_discover_select_param {
    pub rf_discovery_id: __u8,
    pub rf_protocol: __u8,
}

#[no_mangle]
unsafe extern "C" fn nci_rf_discover_select_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn nci_rf_deactivate_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nci_cmd_param {
    pub opcode: __u16,
    pub len: usize,
    pub payload: *const __u8,
}

#[no_mangle]
unsafe extern "C" fn nci_generic_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nci_prop_cmd(ndev: *mut nci_dev, oid: __u8, len: usize, payload: *const __u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nci_core_reset(ndev: *mut nci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nci_core_init(ndev: *mut nci_dev) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nci_loopback_data {
    pub conn_id: u8,
    pub data: *mut sk_buff,
}

#[no_mangle]
unsafe extern "C" fn nci_send_data_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn nci_nfcc_loopback_cb(context: *mut c_void, skb: *mut sk_buff, err: c_int) {
    ...
    NCI_DESTINATION_NFCC_LOOPBACK, core::ptr::null_mut());
    if (conn_id < 0) {
...
#[no_mangle]
unsafe extern "C" fn nci_open_device(ndev: *mut nci_dev) -> c_int {
    ...
    const void *opt = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nci_close_device(ndev: *mut nci_dev) -> c_int {
...
//
    ...
    nci_data_exchange_complete(ndev, core::ptr::null_mut(),
    ndev.cur_conn_id,
    -ENODEV);
    mutex_unlock(&ndev.req_lock);
    return 0;
...
// Flush cmd and tx wq
    ...
    timer_delete_sync(&ndev.data_timer);
    if (test_bit(NCI_DATA_EXCHANGE, &ndev.flags))
    nci_data_exchange_complete(ndev, core::ptr::null_mut(), ndev.cur_conn_id,
    -ENODEV);
...
#[no_mangle]
unsafe extern "C" fn nci_cmd_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn nci_data_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn nci_dev_up(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_dev_down(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nci_set_config(ndev: *mut nci_dev, id: __u8, len: usize, val: *const __u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_nfcee_discover_req(ndev: *mut nci_dev, opt: *const c_void) {
    static void nci_nfcee_discover_req(struct nci_dev *ndev, const void *opt)
    {
    struct nci_nfcee_discover_cmd cmd;
    let mut action: __u8 = (unsigned long)opt;
    cmd.discovery_action = action;
    nci_send_cmd(ndev, NCI_OP_NFCEE_DISCOVER_CMD, 1, &cmd);
    }
#[no_mangle]
pub unsafe extern "C" fn nci_nfcee_discover(ndev: *mut nci_dev, action: u8) -> c_int {
    int nci_nfcee_discover(struct nci_dev *ndev, u8 action)
    {
    let mut opt: c_ulong = action;
    return __nci_request(ndev, nci_nfcee_discover_req, (void *)opt,
    msecs_to_jiffies(NCI_CMD_TIMEOUT));
    }
    EXPORT_SYMBOL(nci_nfcee_discover);
#[no_mangle]
unsafe extern "C" fn nci_nfcee_mode_set_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nci_nfcee_mode_set(ndev: *mut nci_dev, nfcee_id: u8, nfcee_mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_core_conn_create_req(ndev: *mut nci_dev, opt: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn nci_core_conn_close_req(ndev: *mut nci_dev, opt: *const c_void) {
    static void nci_core_conn_close_req(struct nci_dev *ndev, const void *opt)
    {
    let mut conn_id: __u8 = (unsigned long)opt;
    nci_send_cmd(ndev, NCI_OP_CORE_CONN_CLOSE_CMD, 1, &conn_id);
    }
#[no_mangle]
pub unsafe extern "C" fn nci_core_conn_close(ndev: *mut nci_dev, conn_id: u8) -> c_int {
    int nci_core_conn_close(struct nci_dev *ndev, u8 conn_id)
    {
    let mut opt: c_ulong = conn_id;
    ndev.cur_conn_id = conn_id;
...
#[no_mangle]
unsafe extern "C" fn nci_set_target_ats(target: *mut nfc_target, ndev: *mut nci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nci_set_local_general_bytes(nfc_dev: *mut nfc_dev) -> c_int {
    ...
    if ((param.val == core::ptr::null_mut()) || (param.len == 0))
    return 0;
...
#[no_mangle]
unsafe extern "C" fn nci_set_listen_parameters(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_stop_poll(nfc_dev: *mut nfc_dev) {
    ...
    const struct nfc_target *nci_target = core::ptr::null_mut();
    int i;
    let mut rc: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(NFC_PROTO_MIFARE: protocol ==) -> else {
    else if (protocol == NFC_PROTO_MIFARE)
    param.rf_protocol = NCI_RF_PROTOCOL_T2T;
#[no_mangle]
pub unsafe extern "C" fn if(NFC_PROTO_FELICA: protocol ==) -> else {
    ...
    {
    struct nci_dev *ndev = nfc_get_drvdata(nfc_dev);
    let mut nci_mode: c_ulong = NCI_DEACTIVATE_TYPE_IDLE_MODE;
    if (!ndev.target_active_prot) {
...
#[no_mangle]
unsafe extern "C" fn nci_dep_link_down(nfc_dev: *mut nfc_dev) -> c_int {
    static int nci_dep_link_down(struct nfc_dev *nfc_dev)
    {
    struct nci_dev *ndev = nfc_get_drvdata(nfc_dev);
    int rc;
    if (nfc_dev.rf_mode == NFC_RF_INITIATOR) {
    nci_deactivate_target(nfc_dev, core::ptr::null_mut(), NCI_DEACTIVATE_TYPE_IDLE_MODE);
    } else {
...
#[no_mangle]
unsafe extern "C" fn nci_tm_send(nfc_dev: *mut nfc_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_enable_se(nfc_dev: *mut nfc_dev, se_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_disable_se(nfc_dev: *mut nfc_dev, se_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_discover_se(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_fw_download(nfc_dev: *mut nfc_dev, firmware_name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nci_free_device(ndev: *mut nci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nci_register_device(ndev: *mut nci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nci_unregister_device(ndev: *mut nci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nci_recv_frame(ndev: *mut nci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nci_send_frame(ndev: *mut nci_dev, skb: *mut sk_buff) -> c_int {
...
// Send NCI command
#[no_mangle]
pub unsafe extern "C" fn nci_send_cmd(ndev: *mut nci_dev, opcode: __u16, plen: __u8, payload: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nci_valid_size(skb: *mut sk_buff) -> bool {
    static bool nci_valid_size(struct sk_buff *skb)
    {
    BUILD_BUG_ON(NCI_CTRL_HDR_SIZE != NCI_DATA_HDR_SIZE);
    let mut hdr_size: c_uint = NCI_CTRL_HDR_SIZE;
    if (skb.len < hdr_size ||
...
#[no_mangle]
unsafe extern "C" fn nci_tx_work(work: *mut work_struct) {
    static void nci_tx_work(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn nci_rx_work(work: *mut work_struct) {
    static void nci_rx_work(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn nci_cmd_work(work: *mut work_struct) {
    static void nci_cmd_work(struct work_struct *work)
    {
