...
#[no_mangle]
unsafe extern "C" fn nci_core_init_rsp_packet(ndev: *mut nci_dev, skb: *const sk_buff) {
...
// If target was active, complete the request only in deactivate_ntf
    ...
    {
    let mut status: __u8 = skb.data[0];
    struct nci_conn_info *conn_info = core::ptr::null_mut();
...
//
    ...
    ndev.rf_conn_info = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nci_rsp_packet(ndev: *mut nci_dev, skb: *mut sk_buff) {
    void nci_rsp_packet(struct nci_dev *ndev, struct sk_buff *skb)
    {
    let mut rsp_opcode: __u16 = nci_opcode(skb.data);
