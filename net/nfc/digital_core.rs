...
pub const DIGITAL_POLL_INTERVAL: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct digital_cmd {
    ...
    pub cmd_cb: nfc_digital_cmd_complete_t,
...
#[no_mangle]
pub unsafe extern "C" fn digital_switch_rf(ddev: *mut nfc_digital_dev, on: bool) {
    static inline void digital_switch_rf(struct nfc_digital_dev *ddev, bool on)
    {
    ddev.ops.switch_rf(ddev, on);
    }
#[no_mangle]
pub unsafe extern "C" fn digital_abort_cmd(ddev: *mut nfc_digital_dev) {
    static inline void digital_abort_cmd(struct nfc_digital_dev *ddev)
    {
    ddev.ops.abort_cmd(ddev);
    }
#[no_mangle]
unsafe extern "C" fn digital_wq_cmd_complete(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn digital_wq_cmd(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn digital_in_configure_hw(ddev: *mut nfc_digital_dev, type: c_int, param: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn digital_tg_configure_hw(ddev: *mut nfc_digital_dev, type: c_int, param: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn digital_tg_listen_mdaa(ddev: *mut nfc_digital_dev, rf_tech: u8) -> c_int {
    ...
    rc = digital_send_cmd(ddev, DIGITAL_CMD_TG_LISTEN_MDAA, core::ptr::null_mut(), params,
    500, digital_tg_recv_atr_req, core::ptr::null_mut());
    if (rc)
    kfree(params);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn digital_tg_listen_md(ddev: *mut nfc_digital_dev, rf_tech: u8) -> c_int {
    static int digital_tg_listen_md(struct nfc_digital_dev *ddev, u8 rf_tech)
    {
    return digital_send_cmd(ddev, DIGITAL_CMD_TG_LISTEN_MD, core::ptr::null_mut(), core::ptr::null_mut(), 500,
    digital_tg_recv_md_req, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn digital_poll_next_tech(ddev: *mut nfc_digital_dev) {
...
#[no_mangle]
unsafe extern "C" fn digital_wq_poll(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn digital_stop_poll(nfc_dev: *mut nfc_dev) {
...
#[no_mangle]
unsafe extern "C" fn digital_dev_up(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn digital_dev_down(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn digital_dep_link_down(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn digital_tg_send(dev: *mut nfc_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_digital_free_device(ddev: *mut nfc_digital_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_digital_register_device(ddev: *mut nfc_digital_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_digital_unregister_device(ddev: *mut nfc_digital_dev) {
