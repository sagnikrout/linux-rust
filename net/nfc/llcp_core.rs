...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_sock_link(l: *mut llcp_sock_list, sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_sock_unlink(l: *mut llcp_sock_list, sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_socket_remote_param_init(sock: *mut nfc_llcp_sock) {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_socket_purge(sock: *mut nfc_llcp_sock) {
...
#[no_mangle]
unsafe extern "C" fn local_cleanup(local: *mut nfc_llcp_local) {
    ...
    local.rx_pending = core::ptr::null_mut();
    timer_delete_sync(&local.sdreq_timer);
    cancel_work_sync(&local.sdreq_timeout_work);
    nfc_llcp_free_sdp_tlv_list(&local.pending_sdreqs);
    }
#[no_mangle]
unsafe extern "C" fn local_release(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_local_put(local: *mut nfc_llcp_local) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_sock_put(sock: *mut nfc_llcp_sock) {
    static void nfc_llcp_sock_put(struct nfc_llcp_sock *sock)
    {
    sock_put(&sock.sk);
    }
#[no_mangle]
unsafe extern "C" fn nfc_llcp_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_symm_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_sdreq_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_sdreq_timer(t: *mut timer_list) {
    ...
    {
    struct nfc_llcp_local *local;
    struct nfc_llcp_local *res = core::ptr::null_mut();
    ...
    static char *wks[] = {
    core::ptr::null_mut(),
    core::ptr::null_mut(), /* SDP */
    "urn:nfc:sn:ip",
    "urn:nfc:sn:obex",
    "urn:nfc:sn:snep",
    };
#[no_mangle]
unsafe extern "C" fn nfc_llcp_wks_sap(service_name: *const c_char, service_name_len: usize) -> c_int {
    static int nfc_llcp_wks_sap(const char *service_name, size_t service_name_len)
    {
    int sap, num_wks;
    pr_debug("%s\n", service_name);
    if (service_name == core::ptr::null_mut())
    return -EINVAL;
    num_wks = ARRAY_SIZE(wks);
    for (sap = 0; sap < num_wks; sap++) {
    if (wks[sap] == core::ptr::null_mut())
    continue;
    ...
    struct nfc_llcp_sock *llcp_sock, *tmp_sock;
    pr_debug("sn %zd %p\n", sn_len, sn);
    if (sn == core::ptr::null_mut() || sn_len == 0)
    return core::ptr::null_mut();
    read_lock(&local.sockets.lock);
    llcp_sock = core::ptr::null_mut();
    sk_for_each(sk, &local.sockets.head) {
    ...
    continue;
    if (tmp_sock.service_name == core::ptr::null_mut() ||
    ...
    if (sock.service_name != core::ptr::null_mut() && sock.service_name_len > 0) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_get_local_ssap(local: *mut nfc_llcp_local) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_put_ssap(local: *mut nfc_llcp_local, ssap: u8) {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_reserve_sdp_ssap(local: *mut nfc_llcp_local) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_build_gb(local: *mut nfc_llcp_local) -> c_int {
    static int nfc_llcp_build_gb(struct nfc_llcp_local *local)
    {
    u8 *gb_cur, version, version_length;
    u8 lto_length, wks_length, miux_length;
    const u8 *version_tlv = core::ptr::null_mut(), *lto_tlv = core::ptr::null_mut(),
// wks_tlv = NULL, *miux_tlv = NULL;
    let mut wks: __be16 = cpu_to_be16(local.local_wks);
    let mut gb_len: u8 = 0;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_set_remote_gb(dev: *mut nfc_dev, gb: *const u8, gb_len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_dsap(pdu: *const sk_buff) -> u8 {
    static u8 nfc_llcp_dsap(const struct sk_buff *pdu)
    {
    return (pdu.data[0] & 0xfc) >> 2;
    }
#[no_mangle]
unsafe extern "C" fn nfc_llcp_ptype(pdu: *const sk_buff) -> u8 {
    static u8 nfc_llcp_ptype(const struct sk_buff *pdu)
    {
    return ((pdu.data[0] & 0x03) << 2) | ((pdu.data[1] & 0xc0) >> 6);
    }
#[no_mangle]
unsafe extern "C" fn nfc_llcp_ssap(pdu: *const sk_buff) -> u8 {
    static u8 nfc_llcp_ssap(const struct sk_buff *pdu)
    {
    return pdu.data[1] & 0x3f;
    }
#[no_mangle]
unsafe extern "C" fn nfc_llcp_ns(pdu: *const sk_buff) -> u8 {
    static u8 nfc_llcp_ns(const struct sk_buff *pdu)
    {
    return pdu.data[2] >> 4;
    }
#[no_mangle]
unsafe extern "C" fn nfc_llcp_nr(pdu: *const sk_buff) -> u8 {
    static u8 nfc_llcp_nr(const struct sk_buff *pdu)
    {
    return pdu.data[2] & 0xf;
    }
#[no_mangle]
unsafe extern "C" fn nfc_llcp_set_nrns(sock: *mut nfc_llcp_sock, pdu: *mut sk_buff) {
    ...
    {
    struct sk_buff *skb_copy = core::ptr::null_mut(), *nskb;
    struct sock *sk;
    u8 *data;
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_tx_work(work: *mut work_struct) {
    ...
    sk = skb.sk;
    llcp_sock = nfc_llcp_sock(sk);
    if (llcp_sock == core::ptr::null_mut() && nfc_llcp_ptype(skb) == LLCP_PDU_I) {
    kfree_skb(skb);
    ...
    let mut ptype: u8 = nfc_llcp_ptype(skb);
    int ret;
...
// We're looking for a bound socket, not a client one
    ...
    if (llcp_sock == core::ptr::null_mut() || llcp_sock.sk.sk_type != SOCK_DGRAM)
    return;
...
//
    ...
    if (sock == core::ptr::null_mut() || sock.sk.sk_state != LLCP_LISTEN) {
    ...
    let mut ssap: u8 = nfc_llcp_reserve_sdp_ssap(local);
    ...
    new_sk = nfc_llcp_sock_alloc(core::ptr::null_mut(), parent.sk_type, GFP_ATOMIC, 0);
    if (new_sk == core::ptr::null_mut()) {
    reason = LLCP_DM_REJ;
    release_sock(&sock.sk);
    sock_put(&sock.sk);
    goto fail;
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_queue_i_frames(sock: *mut nfc_llcp_sock) -> c_int {
    int nfc_llcp_queue_i_frames(struct nfc_llcp_sock *sock)
    {
    let mut nr_frames: c_int = 0;
    struct nfc_llcp_local *local = sock.local;
...
// Update N(S)/N(R)
    ...
    if (llcp_sock == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn if(LLCP_PDU_RNR: ptype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_recv_agf(local: *mut nfc_llcp_local, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_rx_skb(local: *mut nfc_llcp_local, skb: *mut sk_buff) {
    static void nfc_llcp_rx_skb(struct nfc_llcp_local *local, struct sk_buff *skb)
    {
    u8 dsap, ssap, ptype;
    ptype = nfc_llcp_ptype(skb);
...
#[no_mangle]
unsafe extern "C" fn nfc_llcp_rx_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __nfc_llcp_recv(local: *mut nfc_llcp_local, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_recv(data: *mut c_void, skb: *mut sk_buff, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_data_received(dev: *mut nfc_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_mac_is_down(dev: *mut nfc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_register_device(ndev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_unregister_device(dev: *mut nfc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_init() -> int __init {
    int __init nfc_llcp_init(void)
    {
    return nfc_llcp_sock_init();
    }
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_exit() {
