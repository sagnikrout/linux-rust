...
#[no_mangle]
unsafe extern "C" fn nfc_sock_link(l: *mut nfc_sock_list, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn nfc_sock_unlink(l: *mut nfc_sock_list, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn rawsock_write_queue_purge(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn rawsock_report_error(sk: *mut sock, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rawsock_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rawsock_add_header(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rawsock_tx_work(work: *mut work_struct) {
    static void rawsock_tx_work(struct work_struct *work)
    {
    struct sock *sk = to_rawsock_sk(work);
    struct nfc_dev *dev = nfc_rawsock(sk).dev;
    let mut target_idx: u32 = nfc_rawsock(sk).target_idx;
    struct sk_buff *skb;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn rawsock_sendmsg(sock: *mut socket, msg: *mut msghdr, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rawsock_destruct(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn rawsock_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn rawsock_exit() {
