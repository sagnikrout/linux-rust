...
#[no_mangle]
unsafe extern "C" fn nfc_genl_dump_targets_done(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_targets_found(dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_target_lost(dev: *mut nfc_dev, target_idx: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_tm_activated(dev: *mut nfc_dev, protocol: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_tm_deactivated(dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_setup_device_added(dev: *mut nfc_dev, msg: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_device_added(dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_device_removed(dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_llc_send_sdres(dev: *mut nfc_dev, sdres_list: *mut hlist_head) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_se_added(dev: *mut nfc_dev, se_idx: u32, type: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_se_removed(dev: *mut nfc_dev, se_idx: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_se_connectivity(dev: *mut nfc_dev, se_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_dump_devices_done(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_dep_link_down_event(dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_get_device(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_dev_up(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_dev_down(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_start_poll(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int nfc_genl_start_poll(struct sk_buff *skb, struct genl_info *info)
    {
    struct nfc_dev *dev;
    int rc;
    u32 idx;
    let mut im_protocols: u32 = 0, tm_protocols = 0;
    pr_debug("Poll start\n");
    if (!info.attrs[NFC_ATTR_DEVICE_INDEX] ||
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: info->attrs[NFC_ATTR_PROTOCOLS]) -> else {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_stop_poll(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_activate_target(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_dep_link_up(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_dep_link_down(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_llc_get_params(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int nfc_genl_llc_get_params(struct sk_buff *skb, struct genl_info *info)
    {
    struct nfc_dev *dev;
    struct nfc_llcp_local *local;
    let mut rc: c_int = 0;
    struct sk_buff *msg = core::ptr::null_mut();
    u32 idx;
    if (!info.attrs[NFC_ATTR_DEVICE_INDEX])
    return -EINVAL;
    idx = nla_get_u32(info.attrs[NFC_ATTR_DEVICE_INDEX]);
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_llc_set_params(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_llc_sdreq(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_fw_download(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_enable_se(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_disable_se(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_dump_ses_done(cb: *mut netlink_callback) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct se_io_ctx {
    pub dev_idx: u32,
    pub se_idx: u32,
}

#[no_mangle]
unsafe extern "C" fn se_io_cb(context: *mut c_void, apdu: *mut u8, apdu_len: usize, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nfc_genl_se_io(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    dev.cur_cmd_info = core::ptr::null_mut();
    goto put_dev;
    }
    err = -EOPNOTSUPP;
    put_dev:
...
#[no_mangle]
pub unsafe extern "C" fn nfc_vendor_cmd_reply(skb: *mut sk_buff) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct urelease_work {
    pub w: work_struct,
    pub portid: u32,
}

#[no_mangle]
unsafe extern "C" fn nfc_urelease_event_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_data_init(genl_data: *mut nfc_genl_data) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_data_exit(genl_data: *mut nfc_genl_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfc_genl_exit() {
