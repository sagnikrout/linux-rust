...
#[no_mangle]
unsafe extern "C" fn sock_wait_state(sk: *mut sock, state: c_int, timeo: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llcp_sock_bind(sock: *mut socket, addr: *mut sockaddr_unsized, alen: c_int) -> c_int {
...
// This is going to be a listening socket, dsap must be 0
    ...
    llcp_sock.service_name = core::ptr::null_mut();
    sock_llcp_put_local:
    nfc_llcp_local_put(llcp_sock.local);
    llcp_sock.local = core::ptr::null_mut();
    llcp_sock.dev = core::ptr::null_mut();
    put_dev:
    nfc_put_device(dev);
    error:
    release_sock(sk);
...
#[no_mangle]
unsafe extern "C" fn llcp_sock_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_accept_unlink(sk: *mut sock) {
    ...
    llcp_sock.parent = core::ptr::null_mut();
    sock_put(sk);
    }
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_accept_enqueue(parent: *mut sock, sk: *mut sock) {
...
// Wait for an incoming connection.
    ...
    if (llcp_sock == core::ptr::null_mut() || llcp_sock.dev == core::ptr::null_mut())
    return -EBADFD;
...
#[no_mangle]
pub unsafe extern "C" fn llcp_accept_poll(parent: *mut sock) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn llcp_sock_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(LLCP_CONNECTING: sk->sk_state ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn llcp_sock_destruct(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_sock_free(sock: *mut nfc_llcp_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_sock_init() -> int __init {
    int __init nfc_llcp_sock_init(void)
    {
    return nfc_proto_register(&llcp_nfc_proto);
    }
#[no_mangle]
pub unsafe extern "C" fn nfc_llcp_sock_exit() {
