...
//
#[no_mangle]
unsafe extern "C" fn nfc_hci_execute_cb(context: *mut c_void, skb: *mut sk_buff, err: c_int) {
    ...
    hcp_ew.result_skb = core::ptr::null_mut();
...
// skb = hcp_ew.result_skb;
    ...
    param, param_len, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    }
...
// tmp = idx;
    ...
    tmp, param_len + 1, core::ptr::null_mut());
    kfree(tmp);
    return r;
    }
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_open_pipe(hdev: *mut nfc_hci_dev, pipe: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_close_pipe(hdev: *mut nfc_hci_dev, pipe: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_delete_pipe(hdev: *mut nfc_hci_dev, pipe: u8) -> c_int {
    static int nfc_hci_delete_pipe(struct nfc_hci_dev *hdev, u8 pipe)
    {
    return nfc_hci_execute_cmd(hdev, NFC_HCI_ADMIN_PIPE,
    NFC_HCI_ADM_DELETE_PIPE, &pipe, 1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn nfc_hci_clear_all_pipes(hdev: *mut nfc_hci_dev) -> c_int {
    static int nfc_hci_clear_all_pipes(struct nfc_hci_dev *hdev)
    {
    u8 param[2];
    let mut param_len: usize = 2;
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_disconnect_gate(hdev: *mut nfc_hci_dev, gate: u8) -> c_int {
    int nfc_hci_disconnect_gate(struct nfc_hci_dev *hdev, u8 gate)
    {
    int r;
    let mut pipe: u8 = hdev.gate2pipe[gate];
    if (pipe == NFC_HCI_INVALID_PIPE)
    return -EADDRNOTAVAIL;
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_disconnect_all_gates(hdev: *mut nfc_hci_dev) -> c_int {
    ...
    u8 pipe)
    {
    let mut pipe_created: bool = false;
    int r;
