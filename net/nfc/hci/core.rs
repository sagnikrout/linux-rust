...
pub const HCI_CMDS_HEADROOM: c_int = 1;
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_result_to_errno(result: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_reset_pipes(hdev: *mut nfc_hci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_reset_pipes_per_host(hdev: *mut nfc_hci_dev, host: u8) {
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_msg_tx_work(work: *mut work_struct) {
    ...
    hdev.cmd_pending_msg = core::ptr::null_mut();
    } else {
    goto exit;
    }
    }
    ...
    while ((skb = skb_dequeue(&msg.msg_frags)) != core::ptr::null_mut()) {
    r = nfc_llc_xmit_from_hci(hdev.llc, skb);
    if (r < 0) {
    kfree_skb(skb);
    skb_queue_purge(&msg.msg_frags);
    if (msg.cb)
    msg.cb(msg.cb_context, core::ptr::null_mut(), r);
    kfree(msg);
    break;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_msg_rx_work(work: *mut work_struct) {
    ...
    u8 type;
    u8 instruction;
    while ((skb = skb_dequeue(&hdev.msg_rx_queue)) != core::ptr::null_mut()) {
    pipe = skb.data[0];
    ...
    {
    mutex_lock(&hdev.msg_tx_mutex);
    if (hdev.cmd_pending_msg == core::ptr::null_mut()) {
    kfree_skb(skb);
    goto exit;
    }
    ...
    struct sk_buff *skb)
    {
    let mut status: u8 = NFC_HCI_ANY_OK;
...
//
    ...
    status, core::ptr::null_mut(), 0, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    kfree_skb(skb);
    }
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_sak_to_protocol(sak: u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_target_discovered(hdev: *mut nfc_hci_dev, gate: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_cmd_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn hci_dev_session_init(hdev: *mut nfc_hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_dev_version(hdev: *mut nfc_hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_dev_up(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_dev_down(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_stop_poll(nfc_dev: *mut nfc_dev) {
...
#[no_mangle]
unsafe extern "C" fn hci_dep_link_down(nfc_dev: *mut nfc_dev) -> c_int {
...
pub const HCI_CB_TYPE_TRANSCEIVE: c_int = 1;
#[no_mangle]
unsafe extern "C" fn hci_transceive_cb(context: *mut c_void, skb: *mut sk_buff, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hci_tm_send(nfc_dev: *mut nfc_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_discover_se(nfc_dev: *mut nfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_enable_se(nfc_dev: *mut nfc_dev, se_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_disable_se(nfc_dev: *mut nfc_dev, se_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_failure(hdev: *mut nfc_hci_dev, err: c_int) {
    ...
    __nfc_hci_cmd_completion(hdev, err, core::ptr::null_mut());
    exit:
    mutex_unlock(&hdev.msg_tx_mutex);
    }
#[no_mangle]
unsafe extern "C" fn nfc_hci_llc_failure(hdev: *mut nfc_hci_dev, err: c_int) {
    static void nfc_hci_llc_failure(struct nfc_hci_dev *hdev, int err)
    {
    nfc_hci_failure(hdev, err);
    }
#[no_mangle]
unsafe extern "C" fn nfc_hci_recv_from_llc(hdev: *mut nfc_hci_dev, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn hci_fw_download(nfc_dev: *mut nfc_dev, firmware_name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_free_device(hdev: *mut nfc_hci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_register_device(hdev: *mut nfc_hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_unregister_device(hdev: *mut nfc_hci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_set_clientdata(hdev: *mut nfc_hci_dev, clientdata: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_driver_failure(hdev: *mut nfc_hci_dev, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nfc_hci_recv_frame(hdev: *mut nfc_hci_dev, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn nfc_hci_init() -> int __init {
    static int __init nfc_hci_init(void)
    {
    return nfc_llc_init();
    }
#[no_mangle]
unsafe extern "C" fn nfc_hci_exit() -> void __exit {
