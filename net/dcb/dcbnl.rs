...
#[no_mangle]
unsafe extern "C" fn dcbnl_app_attr_type_get(selector: u8) -> enum ieee_attrs_app {
...
#[no_mangle]
unsafe extern "C" fn dcbnl_app_attr_type_validate(type: enum ieee_attrs_app) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dcbnl_app_selector_validate(type: enum ieee_attrs_app, selector: u8) -> bool {
...
// if (!tb[DCB_ATTR_STATE] || !netdev->dcbnl_ops->getstate)
    ...
    tb[DCB_ATTR_PFC_CFG],
    dcbnl_pfc_up_nest, core::ptr::null_mut());
    if (ret)
    return ret;
    ...
    tb[DCB_ATTR_NUMTCS],
    dcbnl_numtcs_nest, core::ptr::null_mut());
    if (ret)
    return ret;
...
// either by eth type or by socket number
    ...
    dcbnl_tc_param_nest, core::ptr::null_mut());
    if (ret)
    goto err_pg;
...
// Tx
    ...
    struct dcb_app *table = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dcbnl_getapptrust(netdev: *mut net_device, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcbnl_ieee_fill(skb: *mut sk_buff, netdev: *mut net_device) -> c_int {
...
// get peer info if available
    ...
    let mut i: c_int = dir ? DCB_ATTR_CEE_TX_PG : DCB_ATTR_CEE_RX_PG;
...
#[no_mangle]
unsafe extern "C" fn dcbnl_cee_fill(skb: *mut sk_buff, netdev: *mut net_device) -> c_int {
...
// End nlmsg and notify broadcast listeners
    nlmsg_end(skb, nlh);
    rtnl_notify(skb, net, 0, RTNLGRP_DCB, core::ptr::null_mut(), GFP_KERNEL);
    }
    return err;
    }
...
//
    ...
    tb[DCB_ATTR_IEEE],
    dcbnl_ieee_policy, core::ptr::null_mut());
    if (err)
    return err;
    ...
    rem) {
    let mut type: enum ieee_attrs_app = nla_type(attr);
    u8 selector;
    int i;
    if (!dcbnl_app_attr_type_validate(type) ||
    nla_len(attr) != 1 ||
...
// DCBX configuration
    ...
    tb[DCB_ATTR_FEATCFG],
    dcbnl_featcfg_nest, core::ptr::null_mut());
    if (ret)
    return ret;
...
// function to fill message contents
    ...
    struct nlmsghdr *reply_nlh = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn dcb_getapp(dev: *mut net_device, app: *mut dcb_app) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn dcb_setapp(dev: *mut net_device, new: *mut dcb_app) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dcb_ieee_getapp_mask(dev: *mut net_device, app: *mut dcb_app) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn dcb_getrewr(dev: *mut net_device, app: *mut dcb_app) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn dcb_setrewr(dev: *mut net_device, new: *mut dcb_app) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dcb_delrewr(dev: *mut net_device, del: *mut dcb_app) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dcb_ieee_setapp(dev: *mut net_device, new: *mut dcb_app) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dcb_ieee_delapp(dev: *mut net_device, del: *mut dcb_app) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dcb_ieee_getapp_default_prio_mask(dev: *const net_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn dcbnl_flush_dev(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn dcbnl_init() -> int __init {
