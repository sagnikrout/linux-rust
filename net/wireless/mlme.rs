...
// update current_bss etc., consumes the bss reference
    ...
    let mut reason_code: u16 = le16_to_cpu(mgmt.u.deauth.reason_code);
    let mut from_ap: bool = !ether_addr_equal(mgmt.sa, wdev.netdev.dev_addr);
    nl80211_send_deauth(rdev, wdev.netdev, buf, len, reconnect, GFP_KERNEL);
    if (!wdev.connected || !ether_addr_equal(wdev.u.client.connected_addr, bssid))
    return;
    __cfg80211_disconnected(wdev.netdev, core::ptr::null_mut(), 0, reason_code, from_ap);
    ...
    struct ieee80211_mgmt *mgmt = (struct ieee80211_mgmt *)buf;
    const u8 *bssid = mgmt.bssid;
    let mut reason_code: u16 = le16_to_cpu(mgmt.u.disassoc.reason_code);
    let mut from_ap: bool = !ether_addr_equal(mgmt.sa, wdev.netdev.dev_addr);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ieee80211_is_deauth(fc)) -> else {
    else if (ieee80211_is_deauth(fc))
...
// driver should have reported the disassoc
    ...
    cfg80211_mlme_deauth(rdev, dev, bssid, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn cfg80211_mgmt_registrations_update(wdev: *mut wireless_dev) {
    static void cfg80211_mgmt_registrations_update(struct wireless_dev *wdev)
    {
    struct cfg80211_registered_device *rdev = wiphy_to_rdev(wdev.wiphy);
    struct wireless_dev *tmp;
    struct cfg80211_mgmt_registration *reg;
    let mut upd: mgmt_frame_regs = {};
    ...
    let mut mask: u32 = BIT(le16_to_cpu(reg.frame_type) >> 4);
    let mut mcast_mask: u32 = 0;
    if (reg.multicast_rx)
    mcast_mask = mask;
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_mgmt_registrations_update_wk(wk: *mut work_struct) {
    ...
    let mut err: c_int = 0;
    u16 mgmt_type;
    let mut update_multicast: bool = false;
...
//
    ...
    let mut mlen: c_int = min(match_len, reg.match_len);
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_mlme_unregister_socket(wdev: *mut wireless_dev, nlportid: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_mlme_purge_registrations(wdev: *mut wireless_dev) {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_allowed_address(wdev: *mut wireless_dev, addr: *const u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sched_dfs_chan_update(rdev: *mut cfg80211_registered_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_dfs_channels_update_work(work: *mut work_struct) {
    ...
    struct wiphy *wiphy;
    let mut check_again: bool = false;
...
//
    ...
    nl80211_radar_notify(rdev, chandef, NL80211_RADAR_DETECTED, core::ptr::null_mut(), gfp);
    ...
    netdev = wdev ? wdev.netdev : core::ptr::null_mut();
    nl80211_radar_notify(rdev, chandef, event, netdev, GFP_KERNEL);
    }
#[no_mangle]
pub unsafe extern "C" fn cfg80211_background_cac_done_wk(work: *mut work_struct) {
    ...
    guard(wiphy)(&rdev.wiphy);
    rdev_set_radar_background(rdev, core::ptr::null_mut());
    __cfg80211_background_cac_event(rdev, rdev.background_radar_wdev,
    &rdev.background_radar_chandef,
    NL80211_RADAR_CAC_FINISHED);
    rdev.background_radar_wdev = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn cfg80211_background_cac_abort_wk(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_background_cac_abort(wiphy: *mut wiphy) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_stop_radar_detection(wdev: *mut wireless_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_stop_background_radar_detection(wdev: *mut wireless_dev) {
