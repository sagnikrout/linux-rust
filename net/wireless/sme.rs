...
pub struct cfg80211_conn {
    pub params: cfg80211_connect_params,
// these are sub-states of the _CONNECTING sme_state
    ...
    pub state: },
    pub prev_bssid: [u8 bssid[ETH_ALEN],; ETH_ALEN],
    pub ie: *const u8,
    pub ie_len: usize,
    pub prev_bssid_valid: bool auto_auth,,
}

#[no_mangle]
unsafe extern "C" fn cfg80211_sme_free(wdev: *mut wireless_dev) {
    ...
    kfree(wdev.conn.ie);
    kfree(wdev.conn);
    wdev.conn = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cfg80211_conn_scan(wdev: *mut wireless_dev) -> c_int {
    ...
    return -ENOMEM;
    if (wdev.conn.params.channel) {
    let mut band: enum nl80211_band = wdev.conn.params.channel.band;
    ...
    let mut auth_req: cfg80211_auth_request = {};
    let mut req: cfg80211_assoc_request = {};
    int err;
    lockdep_assert_wiphy(wdev.wiphy);
    if (!wdev.conn)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_conn_work(work: *mut work_struct) {
    void cfg80211_conn_work(struct work_struct *work)
    {
    struct cfg80211_registered_device *rdev =
    container_of(work, struct cfg80211_registered_device, conn_work);
    struct wireless_dev *wdev;
    u8 bssid_buf[ETH_ALEN], *bssid = core::ptr::null_mut();
    enum nl80211_timeout_reason treason;
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_scan_done(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_rx_auth(wdev: *mut wireless_dev, buf: *const u8, len: usize) {
    void cfg80211_sme_rx_auth(struct wireless_dev *wdev, const u8 *buf, size_t len)
    {
    struct wiphy *wiphy = wdev.wiphy;
    struct cfg80211_registered_device *rdev = wiphy_to_rdev(wiphy);
    struct ieee80211_mgmt *mgmt = (struct ieee80211_mgmt *)buf;
    let mut status_code: u16 = le16_to_cpu(mgmt.u.auth.status_code);
    lockdep_assert_wiphy(wdev.wiphy);
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_rx_assoc_resp(wdev: *mut wireless_dev, status: u16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_deauth(wdev: *mut wireless_dev) {
    void cfg80211_sme_deauth(struct wireless_dev *wdev)
    {
    cfg80211_sme_free(wdev);
    }
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_auth_timeout(wdev: *mut wireless_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_disassoc(wdev: *mut wireless_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_assoc_timeout(wdev: *mut wireless_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sme_abandon_assoc(wdev: *mut wireless_dev) {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_wdev_release_bsses(wdev: *mut wireless_dev) {
    ...
    wdev.links[link].client.current_bss = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn cfg80211_wdev_release_link_bsses(wdev: *mut wireless_dev, link_mask: u16) {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_sme_disconnect(wdev: *mut wireless_dev, reason: u16) -> c_int {
...
// wdev->conn->params.bssid must be set if > SCANNING
    ...
    wdev.conn.params.bssid,
    core::ptr::null_mut(), 0, reason, false);
    out:
    cfg80211_sme_free(wdev);
    return err;
    }
...
//
#[no_mangle]
unsafe extern "C" fn cfg80211_is_all_idle() -> bool {
    static bool cfg80211_is_all_idle(void)
    {
    struct cfg80211_registered_device *rdev;
    struct wireless_dev *wdev;
    let mut is_all_idle: bool = true;
//
...
#[no_mangle]
unsafe extern "C" fn disconnect_work(work: *mut work_struct) {
...
// This method must consume bss one way or another
    ...
    {
    struct wireless_dev *wdev = dev.ieee80211_ptr;
    const struct element *country_elem = core::ptr::null_mut();
    ...
    let mut bss_not_found: bool = false;
    lockdep_assert_wiphy(wdev.wiphy);
...
// don't do extra lookups for failures
    ...
    continue;
    cr.links[link].bss =
    cfg80211_get_bss(wdev.wiphy, core::ptr::null_mut(),
    cr.links[link].bssid,
    wdev.u.client.ssid,
...
// don't require bss pointer for failed links
    ...
    struct cfg80211_bss *found = core::ptr::null_mut(), *tmp = *bss;
    found = cfg80211_get_bss(wdev.wiphy, core::ptr::null_mut(),
    (*bss).bssid,
    wdev.u.client.ssid,
    wdev.u.client.ssid_len,
    wdev.conn_bss_type,
...
// Consumes bss object(s) one way or another
    ...
    unsigned long flags;
    u8 *next;
    let mut link_info_size: usize = 0;
    unsigned int link;
...
// Consumes bss object one way or another
    ...
    memcpy(wdev.wext.prev_bssid, connected_addr, ETH_ALEN);
    wdev.wext.prev_bssid_valid = true;
    wireless_send_event(wdev.netdev, SIOCGIWAP, &wrqu, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !rdev->ops->disconnect) -> else {
    else if (!rdev.ops.disconnect)
    cfg80211_mlme_down(rdev, dev);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: wdev->u.client.ssid_len) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn cfg80211_autodisconnect_wk(wiphy: *mut wiphy, work: *mut wiphy_work) {
