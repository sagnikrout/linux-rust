...
//! Source: net/wireless/wext-sme.c
#![no_std]
...
//
    ...
    const u8 *prev_bssid = core::ptr::null_mut();
    int err, i;
    ASSERT_RTNL();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: wdev->wext.connect.channel) -> else {
...
// call only for station!
    ...
    struct wireless_dev *wdev = dev.ieee80211_ptr;
    struct cfg80211_registered_device *rdev = wiphy_to_rdev(wdev.wiphy);
    let mut ie_len: c_int = data.length;
    u8 *ie = extra;
