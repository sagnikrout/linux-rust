...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_mandatory_rates(sband: *mut ieee80211_supported_band) -> u32 {
    u32 ieee80211_mandatory_rates(struct ieee80211_supported_band *sband)
    {
    struct ieee80211_rate *bitrates;
    let mut mandatory_rates: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_channel_to_freq_khz(chan: c_int, band: enum nl80211_band) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(14: chan <) -> else {
    else if (chan < 14)
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_freq_khz_to_channel(freq: u32) -> c_int {
...
// see 802.11 17.3.8.3.2 and Annex J
    ...
    return 14;
#[no_mangle]
pub unsafe extern "C" fn if(2484: freq <) -> else {
    else if (freq < 2484)
    return (freq - 2407) / 5;
#[no_mangle]
pub unsafe extern "C" fn if(4980: freq >= 4910 && freq <=) -> else {
    else if (freq >= 4910 && freq <= 4980)
    return (freq - 4000) / 5;
#[no_mangle]
pub unsafe extern "C" fn if(5925: freq <) -> else {
    else if (freq < 5925)
    return (freq - 5000) / 5;
#[no_mangle]
pub unsafe extern "C" fn if(5935: freq ==) -> else {
    else if (freq == 5935)
    return 2;
...
// see 802.11ax D6.1 27.3.22.2
    return (freq - 5950) / 5;
#[no_mangle]
pub unsafe extern "C" fn if(70200: freq >= 58320 && freq <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_mandatory_flags_band(sband: *mut ieee80211_supported_band) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_set_bitrate_flags(wiphy: *mut wiphy) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_supported_cipher_suite(wiphy: *mut wiphy, cipher: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_igtk_cipher_supported(wiphy: *mut wiphy) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_hdrlen(fc: __le16) -> unsigned int __attribute_const__ {
    unsigned int __attribute_const__ ieee80211_hdrlen(__le16 fc)
    {
    let mut hdrlen: c_uint = 24;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_get_hdrlen_from_skb(skb: *const sk_buff) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn __ieee80211_get_mesh_hdrlen(flags: u8) -> c_uint {
    static unsigned int __ieee80211_get_mesh_hdrlen(u8 flags)
    {
    let mut ae: c_int = flags & MESH_FLAGS_AE;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_get_mesh_hdrlen(meshhdr: *mut ieee80211s_hdr) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_get_8023_tunnel_proto(hdr: *const c_void, proto: *mut __be16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_strip_8023_mesh_hdr(skb: *mut sk_buff) -> c_int {
    ...
    hdrlen += ETH_ALEN + 2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !pskb_may_pull(skb, _arg: hdrlen)) -> else {
...
// remove RFC1042 or Bridge-Tunnel encapsulation
    ...
    let mut head_size: c_int = skb.len - skb.data_len;
    int cur_len;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_is_valid_amsdu(skb: *mut sk_buff, mesh_hdr: u8) -> bool {
    bool ieee80211_is_valid_amsdu(struct sk_buff *skb, u8 mesh_hdr)
    {
    let mut offset: c_int = 0, subframe_len, padding;
    for (offset = 0; offset < skb.len; offset += subframe_len + padding) {
    let mut remaining: c_int = skb.len - offset;
    struct {
    __be16 len;
    u8 mesh_flags;
    } hdr;
...
// Mesh case with non-empty address extension field
    ...
    u8 mesh_control)
    {
    let mut hlen: c_uint = ALIGN(extra_headroom, 4);
    struct sk_buff *frame = core::ptr::null_mut();
    let mut offset: c_int = 0;
    struct {
    struct ethhdr eth;
    uint8_t flags;
    } hdr;
    let mut reuse_frag: bool = skb.head_frag && !skb_has_frag_list(skb);
    let mut reuse_skb: bool = false;
    let mut last: bool = false;
    let mut copy_len: c_int = sizeof(hdr.eth);
    if (iftype == NL80211_IFTYPE_MESH_POINT)
    copy_len = sizeof(hdr);
    while (!last) {
    let mut remaining: c_int = skb.len - offset;
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_upload_connect_keys(wdev: *mut wireless_dev) {
    ...
    continue;
    if (rdev_add_key(rdev, wdev, -1, i, false, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_process_wdev_events(wdev: *mut wireless_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_process_rdev_events(rdev: *mut cfg80211_registered_device) {
    ...
    {
    int err;
    let mut otype: enum nl80211_iftype = dev.ieee80211_ptr.iftype;
    lockdep_assert_held(&rdev.wiphy.mtx);
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_ht(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: modulation ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_dmg(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_extended_sc_dmg(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_edmg(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_vht(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_he(rate: *mut rate_info) -> u32 {
    static u32 cfg80211_calculate_bitrate_he(struct rate_info *rate)
    {
pub const SCALE: c_int = 6144;
    u32 mcs_divisors[14] = {
    102399, /* 16.666666... */
    51201, /*  8.333333... */
    34134, /*  5.555555... */
...
#[no_mangle]
unsafe extern "C" fn _cfg80211_calculate_bitrate_eht_uhr(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_eht(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_uhr(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cfg80211_calculate_bitrate_s1g(rate: *mut rate_info) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_calculate_bitrate(rate: *mut rate_info) -> u32 {
    ...
    {
    u8 *out = buf;
    let mut attr_remaining: u16 = 0;
    let mut desired_attr: bool = false;
    let mut desired_len: u16 = 0;
    while (len > 0) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_id_in_list(ids: *const u8, n_ids: c_int, id: u8, id_ext: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn skip_ie(ies: *const u8, ielen: usize, pos: usize) -> usize {
    static size_t skip_ie(const u8 *ies, size_t ielen, size_t pos)
    {
// we assume a validly formed IEs buffer
    let mut len: u8 = ies[pos + 1];
    pos += 2 + len;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_fragment_element(skb: *mut sk_buff, len_pos: *mut u8, frag_id: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(5745: control_freq >=) -> else {
    else if (control_freq >= 5745)
    offset = control_freq - 5745;
#[no_mangle]
pub unsafe extern "C" fn if(5180: control_freq >=) -> else {
...
// 320-1 or 320-2 channelization is unknown
    ...
    {
    u8 vht_opclass;
    let mut freq: u32 = chandef.center_freq1;
...
#[no_mangle]
unsafe extern "C" fn cfg80211_wdev_bi(wdev: *mut wireless_dev) -> c_int {
...
//
    ...
    void *data)
    {
    const struct wiphy_radio *radio = core::ptr::null_mut();
    const struct ieee80211_iface_combination *c, *cs;
    const struct ieee80211_regdomain *regdom;
    let mut region: enum nl80211_dfs_regions = 0;
    int i, j, n, iftype;
    let mut num_interfaces: c_int = 0;
    let mut used_iftypes: u32 = 0;
    u32 beacon_int_gcd;
    bool beacon_int_different;
...
// mask = 0;
    for (i = 0; i < n_rates; i++) {
    let mut rate: c_int = (rates[i] & 0x7f) * 5;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_get_num_supported_channels(wiphy: *mut wiphy) -> c_uint {
    unsigned int ieee80211_get_num_supported_channels(struct wiphy *wiphy)
    {
    enum nl80211_band band;
    let mut n_channels: c_uint = 0;
    for (band = 0; band < NUM_NL80211_BANDS; band++)
    if (wiphy.bands[band])
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_free_nan_func(f: *mut cfg80211_nan_func) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sinfo_alloc_tid_stats(sinfo: *mut station_info, gfp: gfp_t) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iapp_layer2_update {
    pub /: *mut *mut u8 da[ETH_ALEN]; / broadcast,
    pub /: *mut *mut u8 sa[ETH_ALEN]; / STA addr,
    pub /: *mut *mut __be16 len; / 6,
    pub /: *mut *mut u8 dsap; / 0,
    pub /: *mut *mut u8 ssap; / 0,
    pub control: u8,
    pub xid_info: [u8; 3],
    pub __packed: },
#[no_mangle]
pub unsafe extern "C" fn cfg80211_send_layer2_update(dev: *mut net_device, addr: *const u8) {
    void cfg80211_send_layer2_update(struct net_device *dev, const u8 *addr)
    {
    pub msg: *mut iapp_layer2_update,
    pub skb: *mut sk_buff,
// Send Level 2 Update Frame to update forwarding tables in layer 2
// bridge devices
    pub dev_alloc_skb(sizeof(*msg)): *mut skb =,
    if (!skb)
    pub sizeof(*msg)): *mut msg = skb_put(skb,,
// 802.2 Type 1 Logical Link Control (LLC) Exchange Identifier (XID)
// Update response frame; IEEE Std 802.2-1998, 5.4.1.2.1
    pub addr): ether_addr_copy(msg->sa,,
    pub htons(6): msg->len =,
    pub 0: msg->dsap =,
    pub /: *mut *mut msg->ssap = 0x01; / NULL LSAP, CR Bit: Response,
    pub lsb.1111F101.: *mut *mut msg->control = 0xaf; / XID response,
// F=0 (no poll command; unsolicited frame)
    pub /: *mut *mut msg->xid_info[0] = 0x81; / XID format identifier,
    pub /: *mut *mut msg->xid_info[1] = 1; / LLC types/classes: Type 1 LLC,
    pub /: *mut *mut msg->xid_info[2] = 0; / XID sender's receive window size (RW),
    pub dev: skb->dev =,
    ...
    {
    pub le16_to_cpu(cap->supp_mcs.rx_mcs_map): u16 map =,
    pub ext_nss_bw: c_int,
    pub supp_width: c_int,
    pub mcs_encoding: int i,,
    if (map == 0xffff)
    pub 0: return,
    ...
    pub 0: mcs_encoding =,
#[no_mangle]
pub unsafe extern "C" fn if(8: mcs ==) -> else {
    else if (mcs == 8)
    pub 1: mcs_encoding =,
    else
    pub 2: mcs_encoding =,
...
// find max_vht_nss for the given MCS
    pub {: for (i = 7; i >= 0; i--),
    pub 3: *mut *mut int supp = (map >> (2  i)) &,
    if (supp == 3)
...
//
    ...
    ext_nss_bw == 3)
    pub max_vht_nss: *mut *mut return 2,
    case IEEE80211_VHT_CHANWIDTH_160MHZ:
    if (supp_width == 0 &&
    (ext_nss_bw == 1 || ext_nss_bw == 2))
    pub 2: return max_vht_nss /,
    if (supp_width == 0 &&
    ext_nss_bw == 3)
    pub 4: *mut *mut return (3  max_vht_nss) /,
    if (supp_width == 1 &&
    ext_nss_bw == 3)
    pub max_vht_nss: *mut *mut return 2,
    case IEEE80211_VHT_CHANWIDTH_80P80MHZ:
    if (supp_width == 0 && ext_nss_bw == 1)
    pub /: *mut *mut return 0; / not possible,
    if (supp_width == 0 &&
    ext_nss_bw == 2)
    pub 2: return max_vht_nss /,
    if (supp_width == 0 &&
...
// not covered or invalid combination received
    ...
    {
    pub NL80211_IFTYPE_AP_VLAN: bool is_vlan = iftype ==,
    switch (check_swif) {
    case 0:
    if (is_vlan && is_4addr)
    pub WIPHY_FLAG_4ADDR_AP: return wiphy->flags &,
    pub BIT(iftype): return wiphy->interface_modes &,
    case 1:
    if (!(wiphy.software_iftypes & BIT(iftype)) && is_vlan)
    pub WIPHY_FLAG_4ADDR_AP: return wiphy->flags &,
    pub BIT(iftype): return wiphy->software_iftypes &,
    default:
    }
    pub false: return,
    }
#[no_mangle]
pub unsafe extern "C" fn cfg80211_remove_link(wdev: *mut wireless_dev, link_id: c_uint) {
    void cfg80211_remove_link(struct wireless_dev *wdev, unsigned int link_id)
    {
    pub wiphy_to_rdev(wdev->wiphy): *mut *mut cfg80211_registered_device rdev =,
    switch (wdev.iftype) {
    case NL80211_IFTYPE_AP:
    case NL80211_IFTYPE_P2P_GO:
    pub true): cfg80211_stop_ap(rdev, wdev->netdev, link_id,,
    default:
// per-link not relevant
    }
    pub link_id): rdev_del_intf_link(rdev, wdev,,
    pub ~BIT(link_id): wdev->valid_links &=,
    }
#[no_mangle]
pub unsafe extern "C" fn cfg80211_remove_links(wdev: *mut wireless_dev) {
...
//
    ...
    pub link_id): cfg80211_remove_link(wdev,,
    }
    }
    int cfg80211_remove_virtual_intf(struct cfg80211_registered_device *rdev,
    struct wireless_dev *wdev)
    {
    pub wdev): return rdev_del_virtual_intf(rdev,,
    }
    const struct wiphy_iftype_ext_capab *
    cfg80211_get_iftype_ext_capa(struct wiphy *wiphy, enum nl80211_iftype type)
    {
    pub i: c_int,
    pub {: for (i = 0; i < wiphy->num_iftype_ext_capab; i++),
    if (wiphy.iftype_ext_capab[i].iftype == type)
    pub &wiphy->iftype_ext_capab[i]: return,
    }
    pub NULL: return,
    }
    ...
    u32 freq, u32 width)
    {
    pub r: *const wiphy_radio_freq_range,
    pub i: c_int,
    pub {: for (i = 0; i < radio->n_freq_range; i++),
    pub &radio->freq_range[i]: r =,
    ...
    {
    pub width: u32 freq,,
    pub ieee80211_chandef_to_khz(chandef): freq =,
    pub MHZ_TO_KHZ(cfg80211_chandef_get_width(chandef)): width =,
    if (!ieee80211_radio_freq_range_valid(radio, freq, width))
    pub false: return,
    pub MHZ_TO_KHZ(chandef->center_freq2): freq =,
    ...
    struct ieee80211_channel *chan)
    {
    pub wdev->wiphy: *mut *mut wiphy wiphy =,
    pub radio: *const wiphy_radio,
    pub chandef: cfg80211_chan_def,
    pub radio_mask: u32,
    pub i: c_int,
    pub wdev->radio_mask: radio_mask =,
    if (!wiphy.n_radio || radio_mask == BIT(wiphy.n_radio) - 1)
    pub true: return,
    pub NL80211_CHAN_HT20): cfg80211_chandef_create(&chandef, chan,,
    pub {: for (i = 0; i < wiphy->n_radio; i++),
    if (!(radio_mask & BIT(i)))
    pub &wiphy->radio[i]: radio =,
