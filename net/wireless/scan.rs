...
//
    let mut bss_entries_limit: static int = 1000;
    module_param(bss_entries_limit, int, 0644);
    MODULE_PARM_DESC(bss_entries_limit,
    "limit to number of scan BSS entries (per wiphy, default 1000)");

#[no_mangle]
unsafe extern "C" fn bss_free(bss: *mut cfg80211_internal_bss) {
...
// Processed if one was included in the parent
    ...
    {
    const struct element *ssid_elem;
    struct cfg80211_bss *bss = core::ptr::null_mut();
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn cfg80211_bss_expire_oldest(rdev: *mut cfg80211_registered_device) -> bool {
    static bool cfg80211_bss_expire_oldest(struct cfg80211_registered_device *rdev)
    {
    struct cfg80211_internal_bss *bss, *oldest = core::ptr::null_mut();
    bool ret;
    lockdep_assert_held(&rdev.bss_lock);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct colocated_ap_data {
    pub ssid_elem: *const element,
...
// Don't add duplicate BSSIDs on the same channel.
    ...
    {
    let mut data: colocated_ap_data = {};
    int ret;
    ...
    {
    int i;
    let mut n_channels: u32 = request.n_channels;
...
// wildcard ssid in the scan request
    ...
    let mut need_scan_psc: bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_scan(rdev: *mut cfg80211_registered_device) -> c_int {
    int cfg80211_scan(struct cfg80211_registered_device *rdev)
    {
    struct cfg80211_scan_request_int *request;
    struct cfg80211_scan_request_int *rdev_req = rdev.scan_req;
    let mut n_channels: u32 = 0, idx, i;
    int err;
...
// request = *rdev_req;
    ...
    rdev.scan_msg = core::ptr::null_mut();
    return;
    }
...
// flush entries from previous scans
    ...
    wireless_send_event(wdev.netdev, SIOCGIWSCAN, &wrqu, core::ptr::null_mut());
    }

    dev_put(wdev.netdev);
    kfree(rdev.int_scan_req);
    rdev.int_scan_req = core::ptr::null_mut();
    kfree(rdev.scan_req);
    rdev.scan_req = core::ptr::null_mut();
    if (!send_message)
    rdev.scan_msg = msg;
    else
...
#[no_mangle]
pub unsafe extern "C" fn __cfg80211_scan_done(wiphy: *mut wiphy, wk: *mut wiphy_work) {
    ...
    let mut old_info: cfg80211_scan_info = intreq.info;
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sched_scan_results_wk(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sched_scan_results(wiphy: *mut wiphy, reqid: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sched_scan_stopped_locked(wiphy: *mut wiphy, reqid: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_sched_scan_stopped(wiphy: *mut wiphy, reqid: u64) {
    ...
    lockdep_assert_held(&rdev.wiphy.mtx);
    if (!driver_initiated) {
    let mut err: c_int = rdev_sched_scan_stop(rdev, req.dev, req.reqid);
    if (err)
    return err;
    }
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_bss_expire(rdev: *mut cfg80211_registered_device) {
    void cfg80211_bss_expire(struct cfg80211_registered_device *rdev)
    {
    __cfg80211_bss_expire(rdev, jiffies - IEEE80211_SCAN_RESULT_EXPIRE);
    }
#[no_mangle]
pub unsafe extern "C" fn cfg80211_bss_flush(wiphy: *mut wiphy) {
    ...
    let mut match_len: c_int = (oui_type < 0) ? 3 : sizeof(match);
...
//
    ...
    const u8 *ie1 = core::ptr::null_mut();
    const u8 *ie2 = core::ptr::null_mut();
    int i, r;
...
// Returned bss is reference counted and must be cleaned up appropriately.
    ...
    {
    struct cfg80211_registered_device *rdev = wiphy_to_rdev(wiphy);
    struct cfg80211_internal_bss *bss, *res = core::ptr::null_mut();
    let mut expired: bool = false, unusable = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unusable) -> else {
    else if (unusable)
    NL_SET_ERR_MSG(extack,
    "BSS cannot be used for the requested operation");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: expired) -> else {
    else if (expired)
    NL_SET_ERR_MSG(extack,
...
// Returned bss is reference counted and must be cleaned up appropriately.
    ...
    {
    struct cfg80211_internal_bss *found = core::ptr::null_mut();
    struct cfg80211_bss_ies *ies;
...
// we'll set this later if it was non-NULL
    new.pub.transmitted_bss = core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfg80211_inform_single_bss_data {
    pub drv_data: *mut cfg80211_inform_bss,
    pub ftype: enum cfg80211_bss_frame_type,
    ...
    pub ie: *const u8,
    pub ielen: usize,
    pub bss_source: enum bss_source_type,
// Set if reporting bss_source != BSS_SOURCE_DIRECT
    pub source_bss: *mut cfg80211_bss,
    pub max_bssid_indicator: u8,
    pub bssid_index: u8,
    pub use_for: u8,
    pub cannot_use_reasons: u64,
}
...
// Returned bss is reference counted and must be cleaned up appropriately.
    ...
    struct cfg80211_bss_ies *ies;
    struct ieee80211_channel *channel;
    let mut tmp: cfg80211_internal_bss = {}, *res;
    int bss_type;
    bool signal_valid;
    unsigned long ts;
    if (WARN_ON(!wiphy))
...
// sub_elem = next_sub;
    ...
    {
    let mut copied_len: usize = sub_elem.datalen;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfg80211_mle {
    pub mle: *mut ieee80211_multi_link_elem,
    struct ieee80211_mle_per_sta_profile
// sta_prof[IEEE80211_MLD_MAX_NUM_LINKS];
    pub sta_prof_len: [isize; IEEE80211_MLD_MAX_NUM_LINKS],
    pub data: [u8; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tbtt_info_iter_data {
    pub ap_info: *const ieee80211_neighbor_ap_info,
    pub param_ch_count: u8,
    pub use_for: u32,
    pub link_id: u8 mld_id,,
    pub non_tx: bool,
}
...
// Copy the data
    ...
    struct element *reporter_rnr = core::ptr::null_mut();
    struct ieee80211_multi_link_elem *ml_elem;
    struct cfg80211_mle *mle;
    const struct element *ssid_elem;
    const u8 *ssid = core::ptr::null_mut();
    let mut ssid_len: usize = 0;
    u16 control;
    u8 ml_common_len;
    u8 *new_ie = core::ptr::null_mut();
    struct cfg80211_bss *bss;
    u8 mld_id, reporter_link_id, bss_change_count;
    let mut seen_links: u16 = 0;
    u8 i;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ext) -> else {
    else if (ext)
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_ref_bss(wiphy: *mut wiphy, pub: *mut cfg80211_bss) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_put_bss(wiphy: *mut wiphy, pub: *mut cfg80211_bss) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_unlink_bss(wiphy: *mut wiphy, pub: *mut cfg80211_bss) {
    ...
    struct cfg80211_internal_bss *new = core::ptr::null_mut();
    struct cfg80211_internal_bss *bss;
    struct cfg80211_bss *nontrans_bss;
...
// to save time, update IEs for transmitting bss only
    ...
    new.pub.proberesp_ies = core::ptr::null_mut();
    new.pub.beacon_ies = core::ptr::null_mut();
    list_for_each_entry_safe(nontrans_bss, tmp,
    ...
    struct cfg80211_registered_device *rdev;
    struct wiphy *wiphy;
    struct iw_scan_req *wreq = core::ptr::null_mut();
...
//
    if (wreq && wreq.num_channels) {
    int k;
    let mut wiphy_freq: c_int = wiphy.bands[band].channels[j].center_freq;
...
// translate "Scan for SSID" request
    ...
    creq.req.ssids = core::ptr::null_mut();
    creq.req.n_ssids = 0;
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(WLAN_CAPABILITY_ESS: bss->pub.capability &) -> else {
