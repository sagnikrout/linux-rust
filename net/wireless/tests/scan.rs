...
//! Source: net/wireless/tests/scan.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_gen_new_ie(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_gen_new_ie_malformed(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inform_bss {
    pub test: *mut kunit,
    pub inform_bss_count: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn test_inform_bss_ssid_only(test: *mut kunit) {
    ...
    let mut tsf: u64 = 0x1000000000000000ULL;
    let mut beacon_int: c_int = 100;
    let mut capability: u16 = 0x1234;
...
// Check we can look up the BSS - by SSID
    other = cfg80211_get_bss(wiphy, core::ptr::null_mut(), core::ptr::null_mut(), "TEST", 4,
    IEEE80211_BSS_TYPE_ANY,
    IEEE80211_PRIVACY_ANY);
    KUNIT_EXPECT_PTR_EQ(test, bss, other);
    cfg80211_put_bss(wiphy, other);
// Check we can look up the BSS - by BSSID
    other = cfg80211_get_bss(wiphy, core::ptr::null_mut(), bssid, core::ptr::null_mut(), 0,
    IEEE80211_BSS_TYPE_ANY,
    IEEE80211_PRIVACY_ANY);
    KUNIT_EXPECT_PTR_EQ(test, bss, other);
    cfg80211_put_bss(wiphy, other);
...
#[no_mangle]
unsafe extern "C" fn test_get_bss_miss_reason(test: *mut kunit) {
...
// Fresh usable entry: found, no message is set
    found = __cfg80211_get_bss(wiphy, core::ptr::null_mut(), bssid, core::ptr::null_mut(), 0,
    IEEE80211_BSS_TYPE_ANY,
    IEEE80211_PRIVACY_ANY,
...
// No entry at all for this BSSID
    found = __cfg80211_get_bss(wiphy, core::ptr::null_mut(), other_bssid, core::ptr::null_mut(), 0,
    IEEE80211_BSS_TYPE_ANY,
    IEEE80211_PRIVACY_ANY,
    NL80211_BSS_USE_FOR_NORMAL, &extack);
...
//
    ...
    bss2.use_for = 0;
    extack._msg = core::ptr::null_mut();
    found = __cfg80211_get_bss(wiphy, core::ptr::null_mut(), core::ptr::null_mut(), "TEST", 4,
    IEEE80211_BSS_TYPE_ANY,
    IEEE80211_PRIVACY_ANY,
    NL80211_BSS_USE_FOR_NORMAL, &extack);
    KUNIT_EXPECT_NULL(test, found);
...
#[no_mangle]
unsafe extern "C" fn test_inform_bss_ml_sta(test: *mut kunit) {
...
// Building the frame
    ...
    let mut rnr_len: usize = params.nstr ? sizeof(rnr_nstr) : sizeof(rnr_normal);
...
// Check link_bss
    link_bss = __cfg80211_get_bss(wiphy, core::ptr::null_mut(), sta_prof.bssid, core::ptr::null_mut(), 0,
    IEEE80211_BSS_TYPE_ANY,
    IEEE80211_PRIVACY_ANY,
    0, core::ptr::null_mut());
...
// Test wiphy does not set WIPHY_FLAG_SUPPORTS_NSTR_NONPRIMARY
    ...
    cfg80211_get_bss(wiphy, core::ptr::null_mut(), sta_prof.bssid,
    core::ptr::null_mut(), 0,
    IEEE80211_BSS_TYPE_ANY,
    IEEE80211_PRIVACY_ANY));
    } else {
...
#[no_mangle]
unsafe extern "C" fn test_cfg80211_parse_colocated_ap(test: *mut kunit) {
