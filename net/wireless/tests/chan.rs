...
//! Source: net/wireless/tests/chan.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_chandef_compat(test: *mut kunit) {
    ...
    let mut c1: cfg80211_chan_def = params.c1;
// tests with identical ones
    ...
    expect = params.compat ? &params.c2 : core::ptr::null_mut();
