...
#[no_mangle]
pub unsafe extern "C" fn if(!out->ftm.trigger_based: !out->ftm.non_trigger_based &&) -> else {
    ...
    let mut have_measurement_type: bool = false;
    struct nlattr *treq;
    int err, rem;
// no validation needed - was already done via nested policy
...
// no validation needed - was already done via nested policy
    ...
    tb[NL80211_PMSR_PEER_ATTR_REQ], core::ptr::null_mut(),
    core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn nl80211_pmsr_start(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// An error return leaves the request owned by this path.
    ...
    struct cfg80211_pmsr_request *tmp, *prev, *to_free = core::ptr::null_mut();
    struct sk_buff *msg;
    void *hdr;
...
#[no_mangle]
unsafe extern "C" fn cfg80211_pmsr_process_abort(wdev: *mut wireless_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_pmsr_free_wk(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_pmsr_wdev_down(wdev: *mut wireless_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cfg80211_release_pmsr(wdev: *mut wireless_dev, portid: u32) {
