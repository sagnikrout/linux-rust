...
#[no_mangle]
pub unsafe extern "C" fn aalg_entries() -> c_int {
    static inline int aalg_entries(void)
    {
    return ARRAY_SIZE(aalg_list);
    }
#[no_mangle]
pub unsafe extern "C" fn ealg_entries() -> c_int {
    static inline int ealg_entries(void)
    {
    return ARRAY_SIZE(ealg_list);
    }
#[no_mangle]
pub unsafe extern "C" fn calg_entries() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xfrm_algo_list {
    pub mask): *const *const *const int (find)(char name, u32 type, u32,
    pub algs: *mut xfrm_algo_desc,
    pub entries: c_int,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn xfrm_probe_algs() {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_count_pfkey_auth_supported() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_count_pfkey_enc_supported() -> c_int {
