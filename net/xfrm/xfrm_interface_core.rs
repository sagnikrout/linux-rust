...
//! Source: net/xfrm/xfrm_interface_core.c
#![no_std]
...
pub const XFRMI_HASH_BITS: c_int = 8;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xfrmi_net {
// lists for storing interfaces in use
    pub xfrmi: [*mut xfrm_if __rcu; XFRMI_HASH_SIZE],
    pub collect_md_xfrmi: *mut xfrm_if __rcu,
}
...
#[no_mangle]
unsafe extern "C" fn xfrmi_destroy_state(lwt: *mut lwtunnel_state) {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_encap_cmp(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_hash(if_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_link(xfrmn: *mut xfrmi_net, xi: *mut xfrm_if) {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_dev_free(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_create(net: *mut net, dev: *mut net_device) -> c_int {
    ...
    (xi = rtnl_dereference(*xip)) != core::ptr::null_mut();
    xip = &xi.next)
...
#[no_mangle]
unsafe extern "C" fn xfrmi_dev_uninit(dev: *mut net_device) {
    static void xfrmi_dev_uninit(struct net_device *dev)
    {
    struct xfrm_if *xi = netdev_priv(dev);
    struct xfrmi_net *xfrmn = net_generic(xi.net, xfrmi_net_id);
    if (xi.p.collect_md)
    RCU_INIT_POINTER(xfrmn.collect_md_xfrmi, core::ptr::null_mut());
    else
    xfrmi_unlink(xfrmn, xi);
    }
#[no_mangle]
unsafe extern "C" fn xfrmi_scrub_packet(skb: *mut sk_buff, xnet: bool) {
    ...
    !xfrm_policy_check(core::ptr::null_mut(), XFRM_POLICY_IN, skb, family))
    goto discard;
...
#[no_mangle]
unsafe extern "C" fn xfrmi4_rcv(skb: *mut sk_buff) -> c_int {
    static int xfrmi4_rcv(struct sk_buff *skb)
    {
    return xfrmi_input(skb, ip_hdr(skb).protocol, 0, 0, AF_INET);
    }
#[no_mangle]
unsafe extern "C" fn xfrmi6_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi4_input(skb: *mut sk_buff, nexthdr: c_int, spi: __be32, encap_type: c_int) -> c_int {
    static int xfrmi4_input(struct sk_buff *skb, int nexthdr, __be32 spi, int encap_type)
    {
    return xfrmi_input(skb, nexthdr, spi, encap_type, AF_INET);
    }
#[no_mangle]
unsafe extern "C" fn xfrmi6_input(skb: *mut sk_buff, nexthdr: c_int, spi: __be32, encap_type: c_int) -> c_int {
    static int xfrmi6_input(struct sk_buff *skb, int nexthdr, __be32 spi, int encap_type)
    {
    return xfrmi_input(skb, nexthdr, spi, encap_type, AF_INET6);
    }
#[no_mangle]
unsafe extern "C" fn xfrmi_rcv_cb(skb: *mut sk_buff, err: c_int) -> c_int {
    ...
    if (!xfrm_policy_check(core::ptr::null_mut(), XFRM_POLICY_IN, skb,
    inner_mode.family))
    return -EPERM;
    }
    ...
    skb_dst_set(skb, dst);
    md_info.dst_orig = core::ptr::null_mut();
    dst_release(tmp_dst);
    }
    } else {
    if_id = xi.p.if_id;
    ...
    dst_hold(dst);
    dst = xfrm_lookup_with_ifid(xi.net, dst, fl, core::ptr::null_mut(), 0, if_id);
    if (IS_ERR(dst)) {
    err = PTR_ERR(dst);
...
#[no_mangle]
unsafe extern "C" fn xfrmi_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn xfrmi4_err(skb: *mut sk_buff, info: u32) -> c_int {
    ...
    struct net *net = dev_net(skb.dev);
    let mut protocol: c_int = iph.nexthdr;
    struct ip_comp_hdr *ipch;
    struct ip_esp_hdr *esph;
    struct ip_auth_hdr *ah;
    struct xfrm_state *x;
...
#[no_mangle]
unsafe extern "C" fn xfrmi_change(xi: *mut xfrm_if, p: *const xfrm_if_parms) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_update(xi: *mut xfrm_if, p: *mut xfrm_if_parms) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_get_iflink(dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_dev_setup(dev: *mut net_device) {
    static void xfrmi_dev_setup(struct net_device *dev)
    {
    ...
    NETIF_F_HW_CSUM)
#[no_mangle]
unsafe extern "C" fn xfrmi_dev_init(dev: *mut net_device) -> c_int {
    static int xfrmi_dev_init(struct net_device *dev)
    {
    struct xfrm_if *xi = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn xfrmi_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
    ...
    (xi = rtnl_net_dereference(net, *xip)) != core::ptr::null_mut();
    xip = &xi.next)
...
#[no_mangle]
unsafe extern "C" fn xfrmi6_rcv_tunnel(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi4_rcv_tunnel(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrmi4_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xfrmi4_fini() {
...
#[no_mangle]
unsafe extern "C" fn xfrmi6_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xfrmi6_fini() {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xfrmi_fini() -> void __exit {
