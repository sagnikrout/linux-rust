...
#[no_mangle]
unsafe extern "C" fn xfrm_skb_check_space(skb: *mut sk_buff) -> c_int {
    static int xfrm_skb_check_space(struct sk_buff *skb)
    {
    struct dst_entry *dst = skb_dst(skb);
    int nhead = dst.header_len + LL_RESERVED_SPACE(dst.dev)
    - skb_headroom(skb);
    let mut ntail: c_int = dst.dev.needed_tailroom - skb_tailroom(skb);
    if (nhead <= 0) {
    if (ntail <= 0)
    return 0;
    nhead = 0;
...
//
#[no_mangle]
unsafe extern "C" fn xfrm4_transport_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    static int xfrm4_transport_output(struct xfrm_state *x, struct sk_buff *skb)
    {
    struct iphdr *iph = ip_hdr(skb);
    let mut ihl: c_int = iph.ihl * 4;
...
#[no_mangle]
unsafe extern "C" fn mip6_rthdr_offset(skb: *mut sk_buff, nexthdr: *mut u8, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_hdr_offset(x: *mut xfrm_state, skb: *mut sk_buff, prevhdr: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm6_transport_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm6_ro_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm4_beet_encap_add(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm4_tunnel_encap_add(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    static int xfrm4_tunnel_encap_add(struct xfrm_state *x, struct sk_buff *skb)
    {
    let mut small_ipv6: bool = (skb.protocol == htons(ETH_P_IPV6)) && (skb.len <= IPV6_MIN_MTU);
    struct dst_entry *dst = skb_dst(skb);
    struct iphdr *top_iph;
    int flags;
    if (!skb.inner_protocol) {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_tunnel_encap_add(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_beet_encap_add(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm4_prepare_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_prepare_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm_outer_mode_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pktgen_xfrm_outer_mode_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm_output_one(skb: *mut sk_buff, err: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_output_resume(sk: *mut sock, skb: *mut sk_buff, err: c_int) -> c_int {
    ...
    core::ptr::null_mut(), skb_dst(skb).dev, xfrm_output2);
    if (unlikely(err != 1))
    goto out;
    }
    if (err == -EINPROGRESS)
...
#[no_mangle]
unsafe extern "C" fn xfrm_output2(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int xfrm_output2(struct net *net, struct sock *sk, struct sk_buff *skb)
    {
    return xfrm_output_resume(sk, skb, 1);
    }
#[no_mangle]
unsafe extern "C" fn xfrm_output_gso(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm_get_inner_ipproto(skb: *mut sk_buff, x: *mut xfrm_state) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_output(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm4_tunnel_check_size(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm4_extract_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm6_tunnel_check_size(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_extract_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm_inner_extract_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    static int xfrm_inner_extract_output(struct xfrm_state *x, struct sk_buff *skb)
    {
    switch (skb.protocol) {
    case htons(ETH_P_IP):
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_local_error(skb: *mut sk_buff, mtu: c_int) {
