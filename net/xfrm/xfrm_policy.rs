...
pub const XFRM_MAX_QUEUE_LEN: c_int = 100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xfrm_flo {
...
pub const INEXACT_PREFIXLEN_IPV4: c_int = 16;
pub const INEXACT_PREFIXLEN_IPV6: c_int = 48;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct xfrm_pol_inexact_candidates {
    pub res: [*mut hlist_head; XFRM_POL_CAND_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xfrm_flow_keys {
    ...
    pub gre: flow_dissector_key_keyid,
}
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_pol_hold_rcu(policy: *mut xfrm_policy) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn make_jiffies(secs: c_long) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn xfrm_policy_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_policy_destroy_rcu(head: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_destroy(policy: *mut xfrm_policy) {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm_policy_kill(policy: *mut xfrm_policy) {
...
// XXX: Flush state cache
    ...
    let mut __read_mostly: static unsigned int xfrm_policy_hashmax = 1 * 1024 * 1024;
#[no_mangle]
pub unsafe extern "C" fn idx_hash(net: *mut net, index: u32) -> c_uint {
...
// sbits = 0;
    ...
    unsigned short family, int dir)
    {
    let mut hmask: c_uint = net.xfrm.policy_bydst[dir].hmask;
    unsigned int hash;
    u8 dbits;
    u8 sbits;
    ...
    int dir)
    {
    struct hlist_node *tmp, *entry0 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xfrm_new_hash_mask(old_hmask: c_uint) -> c_ulong {
    static unsigned long xfrm_new_hash_mask(unsigned int old_hmask)
    {
    return ((old_hmask + 1) << 1) - 1;
    }
#[no_mangle]
unsafe extern "C" fn xfrm_bydst_resize(net: *mut net, dir: c_int) {
    static void xfrm_bydst_resize(struct net *net, int dir)
    {
    let mut hmask: c_uint = net.xfrm.policy_bydst[dir].hmask;
    let mut nhashmask: c_uint = xfrm_new_hash_mask(hmask);
    let mut nsize: c_uint = (nhashmask + 1) * sizeof(struct hlist_head);
...
#[no_mangle]
unsafe extern "C" fn xfrm_byidx_resize(net: *mut net) {
    static void xfrm_byidx_resize(struct net *net)
    {
    let mut hmask: c_uint = net.xfrm.policy_idx_hmask;
    let mut nhashmask: c_uint = xfrm_new_hash_mask(hmask);
    let mut nsize: c_uint = (nhashmask + 1) * sizeof(struct hlist_head);
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_bydst_should_resize(net: *mut net, dir: c_int, total: *mut c_int) -> c_int {
    static inline int xfrm_bydst_should_resize(struct net *net, int dir, int *total)
    {
    let mut cnt: c_uint = READ_ONCE(net.xfrm.policy_count[dir]);
    let mut hmask: c_uint = net.xfrm.policy_bydst[dir].hmask;
    if (total)
// total += cnt;
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_byidx_should_resize(net: *mut net, total: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_spd_getinfo(net: *mut net, si: *mut xfrmk_spdinfo) {
...
//
    ...
    kfree(bin);
    return IS_ERR(prev) ? core::ptr::null_mut() : prev;
    }
    ...
    delta = -1;
#[no_mangle]
pub unsafe extern "C" fn if(mb: ma >) -> else {
    else if (ma > mb)
    delta = 1;
    break;
    case AF_INET6:
...
pub unsafe extern "C" fn if(mb: ma >) -> else {
    ...
    struct hlist_node *newpos = core::ptr::null_mut();
...
// we should not have another subtree here
    ...
    let mut same_prefixlen: bool = node.prefixlen == n.prefixlen;
...
//
    while ((rnode = rb_first(&v.root)) != core::ptr::null_mut()) {
    ...
    {
    struct xfrm_pol_inexact_node *cached = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xfrm_policy_inexact_gc_tree(r: *mut rb_root, rm: bool) {
...
#[no_mangle]
unsafe extern "C" fn __xfrm_policy_inexact_prune_bin(b: *mut xfrm_pol_inexact_bin, net_exit: bool) {
...
#[no_mangle]
unsafe extern "C" fn __xfrm_policy_inexact_flush(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_policy_is_dead_or_sk(policy: *const xfrm_policy) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xfrm_hash_rebuild(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_hash_rebuild(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_gen_index(net: *mut net, dir: c_int, index: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn selector_cmp(s1: *mut xfrm_selector, s2: *mut xfrm_selector) -> c_int {
    static inline int selector_cmp(struct xfrm_selector *s1, struct xfrm_selector *s2)
    {
    u32 *p1 = (u32 *) s1;
    u32 *p2 = (u32 *) s2;
    let mut len: c_int = sizeof(struct xfrm_selector) / sizeof(u32);
    int i;
    for (i = 0; i < len; i++) {
    if (p1[i] != p2[i])
    return 1;
...
#[no_mangle]
unsafe extern "C" fn xfrm_pol_bin_key(data: *const c_void, len: u32, seed: u32) -> u32 {
    static u32 xfrm_pol_bin_key(const void *data, u32 len, u32 seed)
    {
    const struct xfrm_pol_inexact_key *k = data;
    let mut a: u32 = k.type << 24 | k.dir << 16 | k.family;
    return jhash_3words(a, k.if_id, net_hash_mix(read_pnet(&k.net)),
    seed);
    }
#[no_mangle]
unsafe extern "C" fn xfrm_pol_bin_obj(data: *const c_void, len: u32, seed: u32) -> u32 {
    ...
    bool excl)
    {
    struct xfrm_policy *pol, *newpos = core::ptr::null_mut(), *delpol = core::ptr::null_mut();
    hlist_for_each_entry(pol, chain, bydst) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_insert(dir: c_int, policy: *mut xfrm_policy, excl: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: xfrm_bydst_should_resize(net, _arg: dir, _arg: NULL)) -> else {
    else if (xfrm_bydst_should_resize(net, dir, core::ptr::null_mut()))
    ...
    {
    struct xfrm_pol_inexact_bin *bin = core::ptr::null_mut();
    struct xfrm_policy *pol, *ret = core::ptr::null_mut();
    struct hlist_head *chain;
// err = 0;
    spin_lock_bh(&net.xfrm.xfrm_policy_lock);
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_flush(net: *mut net, type: u8, task_valid: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_walk_init(walk: *mut xfrm_policy_walk, type: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_walk_done(walk: *mut xfrm_policy_walk, net: *mut net) {
...
//
    ...
    u8 type, u16 family, u32 if_id)
    {
    let mut priority: u32 = prefer ? prefer.priority : ~0u;
    struct xfrm_policy *pol;
    if (!chain)
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xfrm_gen_pos_slow(net: *mut net) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xfrm_gen_pos(net: *mut net) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __xfrm_policy_link(pol: *mut xfrm_policy, dir: c_int) {
    static void __xfrm_policy_link(struct xfrm_policy *pol, int dir)
    {
    struct net *net = xp_net(pol);
    switch (dir) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_sk_policy_link(pol: *mut xfrm_policy, dir: c_int) {
    static void xfrm_sk_policy_link(struct xfrm_policy *pol, int dir)
    {
    __xfrm_policy_link(pol, XFRM_POLICY_MAX + dir);
    }
#[no_mangle]
unsafe extern "C" fn xfrm_sk_policy_unlink(pol: *mut xfrm_policy, dir: c_int) {
    static void xfrm_sk_policy_unlink(struct xfrm_policy *pol, int dir)
    {
    __xfrm_policy_unlink(pol, XFRM_POLICY_MAX + dir);
    }
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_delete(pol: *mut xfrm_policy, dir: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_sk_policy_insert(sk: *mut sock, dir: c_int, pol: *mut xfrm_policy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __xfrm_sk_clone_policy(sk: *mut sock, osk: *const sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm_get_dscp(fl: *const flowi, family: c_int) -> dscp_t {
    ...
    xdst = dst_alloc(dst_ops, core::ptr::null_mut(), DST_OBSOLETE_NONE, 0);
    if (likely(xdst)) {
...
//
    ...
    struct net_device *dev;
    struct xfrm_dst *xdst_prev = core::ptr::null_mut();
    struct xfrm_dst *xdst0 = core::ptr::null_mut();
    let mut i: c_int = 0;
    int err;
    let mut header_len: c_int = 0;
    let mut nfheader_len: c_int = 0;
    let mut trailer_len: c_int = 0;
    let mut family: c_int = policy.selector.family;
...
#[no_mangle]
unsafe extern "C" fn xfrm_policy_queue_process(t: *mut timer_list) {
    static void xfrm_policy_queue_process(struct timer_list *t)
    {
    struct sk_buff *skb;
    struct sock *sk;
...
#[no_mangle]
unsafe extern "C" fn xdst_queue_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    let mut num_pols: c_int = 0, num_xfrms = 0, err;
    struct xfrm_dst *xdst;
...
// previous cache entry
    ...
    goto error;
    goto make_dummy_bundle;
    } else if (xdst == core::ptr::null_mut()) {
    num_xfrms = 0;
    goto make_dummy_bundle;
    }
    return xdst;
...
//
    ...
    let mut family: u16 = dst_orig.ops.family;
    let mut dir: u8 = XFRM_POLICY_OUT;
    int i, err, num_pols, num_xfrms = 0, drop_pols = 0;
    dst = core::ptr::null_mut();
    xdst = core::ptr::null_mut();
    route = core::ptr::null_mut();
...
// To accelerate a bit...
    ...
    dst = &xdst.u.dst;
    if (route == core::ptr::null_mut() && num_xfrms > 0) {
...
//
    ...
    core::ptr::null_mut(), 0, 0, 0, FLOW_DISSECTOR_F_STOP_AT_ENCAP);
    switch (family) {
    case AF_INET:
...
#[no_mangle]
pub unsafe extern "C" fn secpath_has_nontransport(sp: *const sec_path, k: c_int, idxp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icmp_err_packet(fl: *const flowi, family: c_ushort) -> bool {
    ...
    return dst;
    dst_hold(dst);
    dst2 = xfrm_lookup(net, dst, &fl1, core::ptr::null_mut(), (XFRM_LOOKUP_QUEUE | XFRM_LOOKUP_ICMP));
    if (IS_ERR(dst2))
    return dst;
    if (dst2.xfrm) {
    dst_release(dst);
    ...
    struct xfrm_policy *pol;
    struct xfrm_policy *pols[XFRM_POLICY_TYPE_MAX];
    let mut npols: c_int = 0;
    int xfrm_nr;
    int pi;
    int reverse;
    struct flowi fl;
    let mut xerr_idx: c_int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn __xfrm_route_forward(skb: *mut sk_buff, family: c_ushort) -> c_int {
...
//
    ...
    dst = xfrm_lookup(net, dst, &fl, core::ptr::null_mut(), XFRM_LOOKUP_QUEUE);
    if (IS_ERR(dst)) {
    res = 0;
    dst = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn stale_bundle(dst: *mut dst_entry) -> c_int {
    static int stale_bundle(struct dst_entry *dst)
    {
    return !xfrm_bundle_ok((struct xfrm_dst *)dst);
    }
#[no_mangle]
pub unsafe extern "C" fn xfrm_dst_ifdown(dst: *mut dst_entry, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_link_failure(skb: *mut sk_buff) {
    static void xfrm_link_failure(struct sk_buff *skb)
    {
// Impossible. Such dst must be popped before reaches point of failure.
    }
#[no_mangle]
unsafe extern "C" fn xfrm_negative_advice(sk: *mut sock, dst: *mut dst_entry) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_init_pmtu(bundle: *mut xfrm_dst, nr: c_int) {
    static void xfrm_init_pmtu(struct xfrm_dst **bundle, int nr)
    {
    while (nr--) {
...
//
#[no_mangle]
unsafe extern "C" fn xfrm_bundle_ok(first: *mut xfrm_dst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm_default_advmss(dst: *const dst_entry) -> c_uint {
    static unsigned int xfrm_default_advmss(const struct dst_entry *dst)
    {
    return dst_metric_advmss(xfrm_dst_path(dst));
    }
#[no_mangle]
unsafe extern "C" fn xfrm_mtu(dst: *const dst_entry) -> c_uint {
    ...
    daddr = xfrm.coaddr;
#[no_mangle]
pub unsafe extern "C" fn if(XFRM_TYPE_LOCAL_COADDR): !(xfrm->type->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn xfrm_confirm_neigh(dst: *const dst_entry, daddr: *const c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_register_afinfo(afinfo: *const xfrm_policy_afinfo, family: c_int) -> c_int {
    ...
    if (unlikely(xfrm_policy_afinfo[family] != core::ptr::null_mut()))
    err = -EEXIST;
    else {
    struct dst_ops *dst_ops = afinfo.dst_ops;
    if (likely(dst_ops.kmem_cachep == core::ptr::null_mut()))
    dst_ops.kmem_cachep = xfrm_dst_cache;
    if (likely(dst_ops.check == core::ptr::null_mut()))
    dst_ops.check = xfrm_dst_check;
    if (likely(dst_ops.default_advmss == core::ptr::null_mut()))
    dst_ops.default_advmss = xfrm_default_advmss;
    if (likely(dst_ops.mtu == core::ptr::null_mut()))
    dst_ops.mtu = xfrm_mtu;
    if (likely(dst_ops.negative_advice == core::ptr::null_mut()))
    dst_ops.negative_advice = xfrm_negative_advice;
    if (likely(dst_ops.link_failure == core::ptr::null_mut()))
    dst_ops.link_failure = xfrm_link_failure;
    if (likely(dst_ops.neigh_lookup == core::ptr::null_mut()))
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_policy_unregister_afinfo(afinfo: *const xfrm_policy_afinfo) {
    ...
    continue;
    RCU_INIT_POINTER(xfrm_policy_afinfo[i], core::ptr::null_mut());
    break;
    }
    synchronize_rcu();
    dst_ops.kmem_cachep = core::ptr::null_mut();
    dst_ops.check = core::ptr::null_mut();
    dst_ops.negative_advice = core::ptr::null_mut();
    dst_ops.link_failure = core::ptr::null_mut();
    }
    EXPORT_SYMBOL(xfrm_policy_unregister_afinfo);
#[no_mangle]
pub unsafe extern "C" fn xfrm_if_register_cb(ifcb: *const xfrm_if_cb) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_if_unregister_cb() {
    void xfrm_if_unregister_cb(void)
    {
    RCU_INIT_POINTER(xfrm_if_cb, core::ptr::null_mut());
    synchronize_rcu();
    }
    EXPORT_SYMBOL(xfrm_if_unregister_cb);

#[no_mangle]
unsafe extern "C" fn xfrm_statistics_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn xfrm_statistics_fini(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_policy_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn xfrm_net_pre_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn xfrm_policy_fini(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn xfrm_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_audit_policy_add(xp: *mut xfrm_policy, result: c_int, task_valid: bool) {
...
#[no_mangle]
unsafe extern "C" fn migrate_tmpl_match(m: *const xfrm_migrate, t: *const xfrm_tmpl) -> c_int {
