...
#[no_mangle]
pub unsafe extern "C" fn xfrm_replay_seqhi(x: *mut xfrm_state, net_seq: __be32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_replay_notify(x: *mut xfrm_state, event: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __xfrm_replay_overflow(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_replay_advance(x: *mut xfrm_state, net_seq: __be32) {
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_overflow_bmp(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    ...
    u32 pos;
    let mut seq: u32 = ntohl(net_seq);
    let mut diff: u32 = replay_esn.seq - seq;
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_advance_bmp(x: *mut xfrm_state, net_seq: __be32) {
    static void xfrm_replay_advance_bmp(struct xfrm_state *x, __be32 net_seq)
    {
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_notify_bmp(x: *mut xfrm_state, event: c_int) {
    static void xfrm_replay_notify_bmp(struct xfrm_state *x, int event)
    {
    struct km_event c;
    struct xfrm_replay_state_esn *replay_esn = x.replay_esn;
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_notify_esn(x: *mut xfrm_state, event: c_int) {
    static void xfrm_replay_notify_esn(struct xfrm_state *x, int event)
    {
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_overflow_esn(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    ...
    u32 pos;
    let mut seq: u32 = ntohl(net_seq);
    let mut wsize: u32 = replay_esn.replay_window;
    let mut top: u32 = replay_esn.seq;
    let mut bottom: u32 = top - wsize + 1;
    if (!wsize)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_advance_esn(x: *mut xfrm_state, net_seq: __be32) {
    static void xfrm_replay_advance_esn(struct xfrm_state *x, __be32 net_seq)
    {
    unsigned int bitnr, nr, i;
    int wrap;
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_overflow_offload(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    static int xfrm_replay_overflow_offload(struct xfrm_state *x, struct sk_buff *skb)
    {
    let mut err: c_int = 0;
    struct net *net = xs_net(x);
    struct xfrm_offload *xo = xfrm_offload(skb);
    let mut oseq: __u32 = x.replay.oseq;
    if (!xo)
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_overflow_offload_bmp(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    ...
    struct xfrm_replay_state_esn *replay_esn = x.replay_esn;
    struct net *net = xs_net(x);
    let mut oseq: __u32 = replay_esn.oseq;
    if (!xo)
...
#[no_mangle]
unsafe extern "C" fn xfrm_replay_overflow_offload_esn(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    ...
    struct net *net = xs_net(x);
    let mut oseq: __u32 = replay_esn.oseq;
    let mut oseq_hi: __u32 = replay_esn.oseq_hi;
    if (!xo)
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_replay_overflow(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm_init_replay(x: *mut xfrm_state, extack: *mut netlink_ext_ack) -> c_int {
