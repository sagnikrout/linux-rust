...
#[no_mangle]
unsafe extern "C" fn handle_esp(skb: *mut sk_buff, sk: *mut sock) {
...
unsafe extern "C" fn espintcp_rcv(strp: *mut strparser, skb: *mut sk_buff) {
    ...
    let mut len: c_int = rxm.full_len - 2;
    u32 nonesp_marker;
    int err;
// keepalive packet?
    if (unlikely(len == 1)) {
...
#[no_mangle]
unsafe extern "C" fn espintcp_parse(strp: *mut strparser, skb: *mut sk_buff) -> c_int {
    ...
    copied = skb.len;
#[no_mangle]
pub unsafe extern "C" fn if(skb->len: copied <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn espintcp_queue_out(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
// espintcp length field is 2B and length includes the length field's size
    ...
    let mut more: bool = flags & MSG_MORE;
...
#[no_mangle]
unsafe extern "C" fn espintcp_push_msgs(sk: *mut sock, flags: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn espintcp_push_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn espintcp_sendmsg(sk: *mut sock, msg: *mut msghdr, size: usize) -> c_int {
    ...
    let mut pfx_iov: kvec = {};
    let mut msglen: usize = size + 2;
    char buf[2] = {0};
    int err, end;
...
#[no_mangle]
unsafe extern "C" fn espintcp_data_ready(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn espintcp_tx_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn espintcp_write_space(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn espintcp_destruct(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_is_ulp_esp(sk: *mut sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn espintcp_init_sk(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn espintcp_release(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn espintcp_close(sk: *mut sock, timeout: c_long) {
...
#[no_mangle]
pub unsafe extern "C" fn espintcp_init() -> void __init {
