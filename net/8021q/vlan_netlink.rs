...
//! Source: net/8021q/vlan_netlink.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn vlan_validate_qos_map(attr: *mut nlattr) -> c_int {
    static inline int vlan_validate_qos_map(struct nlattr *attr)
    {
    if (!attr)
    return 0;
    return nla_validate_nested_deprecated(attr, IFLA_VLAN_QOS_MAX,
    vlan_map_policy, core::ptr::null_mut());
    }
    ...
    dev.mtu = max_mtu;
#[no_mangle]
pub unsafe extern "C" fn if(max_mtu: dev->mtu >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn vlan_qos_map_size(n: c_uint) -> usize {
...
#[no_mangle]
unsafe extern "C" fn vlan_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn vlan_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
    ...
    let mut vlan_qos: u16 = READ_ONCE(pm.vlan_qos);
    m.from = pm.priority;
...
#[no_mangle]
pub unsafe extern "C" fn vlan_netlink_init() -> int __init {
    int __init vlan_netlink_init(void)
    {
    return rtnl_link_register(&vlan_link_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn vlan_netlink_fini() -> void __exit {
