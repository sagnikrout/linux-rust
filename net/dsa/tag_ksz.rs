...
pub const KSZ_PTP_TAG_LEN: c_int = 4;
pub const KSZ_EGRESS_TAG_LEN: c_int = 1;
pub const KSZ_INGRESS_TAG_LEN: c_int = 1;
pub const KSZ_HWTS_EN: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_tagger_private {
    pub /: *mut *mut ksz_tagger_data data; / Must be first,
    pub state: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn ksz_hwtstamp_set_state(ds: *mut dsa_switch, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn ksz_disconnect(ds: *mut dsa_switch) {
...
#[no_mangle]
unsafe extern "C" fn ksz_connect(ds: *mut dsa_switch) -> c_int {
...
//
pub const KSZ9477_INGRESS_TAG_LEN: c_int = 2;
pub const KSZ9477_PTP_TAG_LEN: c_int = 4;

#[no_mangle]
unsafe extern "C" fn ksz_rcv_timestamp(skb: *mut sk_buff, tag: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_xmit_timestamp(dp: *mut dsa_port, skb: *mut sk_buff) {
...
// tag |= override_mask;
    ...
    let mut prio: u8 = netdev_txq_to_tc(dev, queue_mapping);
    struct dsa_port *dp = dsa_user_to_port(dev);
    struct ethhdr *hdr;
    __be16 *tag;
    u16 val;
...
// tag = cpu_to_be16(val);
    ...
    {
    let mut len: c_uint = KSZ_EGRESS_TAG_LEN;
    unsigned int port;
    u8 *tag;
...
//
pub const LAN937X_EGRESS_TAG_LEN: c_int = 2;

pub const LAN937X_TAIL_TAG_PORT_MASK: c_int = 7;
