...
//! Source: net/bpf/bpf_dummy_struct_ops.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dummy_ops_test_ret_function(state: *mut bpf_dummy_ops_state, ...) -> c_int {
...
pub struct bpf_dummy_ops_test_args {
    pub args: [u64; MAX_BPF_FUNC_ARGS],
...
#[no_mangle]
unsafe extern "C" fn dummy_ops_copy_args(args: *mut bpf_dummy_ops_test_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_ops_call_op(image: *mut c_void, args: *mut bpf_dummy_ops_test_args) -> c_int {
    static int dummy_ops_call_op(void *image, struct bpf_dummy_ops_test_args *args)
    {
    let mut test: dummy_ops_test_ret_fn = (void *)image + cfi_get_offset();
    struct bpf_dummy_ops_state *state = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn check_test_run_args(prog: *mut bpf_prog, args: *mut bpf_dummy_ops_test_args) -> c_int {
...
//
    t = btf_type_skip_modifiers(bpf_dummy_ops_btf, param.type, core::ptr::null_mut());
    ...
    struct bpf_dummy_ops_test_args *args;
    struct bpf_tramp_nodes *tnodes = core::ptr::null_mut();
    struct bpf_tramp_link *link = core::ptr::null_mut();
    void *image = core::ptr::null_mut();
    unsigned int op_idx;
    let mut image_off: u32 = 0;
    int prog_ret;
    s32 type_id;
    int err;
...
#[no_mangle]
unsafe extern "C" fn bpf_dummy_init(btf: *mut btf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_dummy_reg(kdata: *mut c_void, link: *mut bpf_link) -> c_int {
    static int bpf_dummy_reg(void *kdata, struct bpf_link *link)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn bpf_dummy_unreg(kdata: *mut c_void, link: *mut bpf_link) {
    static void bpf_dummy_unreg(void *kdata, struct bpf_link *link)
    {
    }
#[no_mangle]
unsafe extern "C" fn bpf_dummy_ops__test_1(cb__nullable: *mut bpf_dummy_ops_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_dummy_test_sleepable(cb: *mut bpf_dummy_ops_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_dummy_struct_ops_init() -> int __init {
