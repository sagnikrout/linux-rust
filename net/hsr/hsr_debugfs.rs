...
#[no_mangle]
pub unsafe extern "C" fn hsr_debugfs_rename(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hsr_debugfs_init(priv: *mut hsr_priv, hsr_dev: *mut net_device) {
    ...
    priv.node_tbl_root = core::ptr::null_mut();
    return;
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn hsr_debugfs_create_root() {
    void hsr_debugfs_create_root(void)
    {
    hsr_debugfs_root_dir = debugfs_create_dir("hsr", core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn hsr_debugfs_remove_root() {
