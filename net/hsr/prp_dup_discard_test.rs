...
//! Source: net/hsr/prp_dup_discard_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prp_test_data {
    pub port: hsr_port,
    pub port_rcv: hsr_port,
    pub frame: hsr_frame_info,
    pub node: hsr_node,
}
...
#[no_mangle]
unsafe extern "C" fn prp_dup_discard_forward(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn prp_dup_discard_drop_duplicate(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn prp_dup_discard_entry_timeout(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn prp_dup_discard_out_of_sequence(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn prp_dup_discard_lan_b_late(test: *mut kunit) {
