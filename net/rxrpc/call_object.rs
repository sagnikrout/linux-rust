...
//! Source: net/rxrpc/call_object.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rxrpc_poke_call(call: *mut rxrpc_call, what: enum rxrpc_call_poke_trace) {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_call_timer_expired(t: *mut timer_list) {
...
//
    ...
    p = p.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(call->user_call_ID: user_call_ID >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_start_call_timer(call: *mut rxrpc_call) {
    void rxrpc_start_call_timer(struct rxrpc_call *call)
    {
    if (call.hard_timo) {
    let mut delay: ktime_t = ms_to_ktime(call.hard_timo * 1000);
...
//
    ...
    return down_interruptible(limiter) < 0 ? core::ptr::null_mut() : limiter;
    }
//
// Release a call slot.
//
#[no_mangle]
unsafe extern "C" fn rxrpc_put_call_slot(call: *mut rxrpc_call) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_connect_call(call: *mut rxrpc_call, gfp: gfp_t) -> c_int {
    ...
    if (ret < 0)
    goto error;
    trace_rxrpc_client(core::ptr::null_mut(), -1, rxrpc_client_queue_new_call);
...
// Publish the call, even though it is incompletely set up as yet
    ...
    pp = &(*pp).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(xcall->user_call_ID: p->user_call_ID >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_see_call(call: *mut rxrpc_call, why: enum rxrpc_call_trace) {
    void rxrpc_see_call(struct rxrpc_call *call, enum rxrpc_call_trace why)
    {
    if (call) {
    let mut r: c_int = refcount_read(&call.ref);
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_get_call(call: *mut rxrpc_call, why: enum rxrpc_call_trace) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_cleanup_tx_buffers(call: *mut rxrpc_call) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_cleanup_rx_buffers(call: *mut rxrpc_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_release_call(rx: *mut rxrpc_sock, call: *mut rxrpc_call) {
    void rxrpc_release_call(struct rxrpc_sock *rx, struct rxrpc_call *call)
    {
    struct rxrpc_connection *conn = call.conn;
    let mut putu: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_release_calls_on_socket(rx: *mut rxrpc_sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_put_call(call: *mut rxrpc_call, why: enum rxrpc_call_trace) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_rcu_free_call(rcu: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_cleanup_call(call: *mut rxrpc_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_destroy_all_calls(rxnet: *mut rxrpc_net) {
    void rxrpc_destroy_all_calls(struct rxrpc_net *rxnet)
    {
    struct rxrpc_call *call;
    _enter("");
    if (!list_empty(&rxnet.calls)) {
    let mut shown: c_int = 0;
    spin_lock(&rxnet.call_lock);
