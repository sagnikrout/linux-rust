...
#[no_mangle]
unsafe extern "C" fn rxrpc_call_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_call_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_connection_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_connection_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_bundle_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_bundle_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_peer_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    let mut shift: c_uint = 32 - HASH_BITS(rxnet.peer_hash);
    void *p;
    rcu_read_lock();
    if (*_pos >= UINT_MAX)
...
#[no_mangle]
unsafe extern "C" fn rxrpc_peer_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_local_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_local_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_stats_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_stats_clear(file: *mut file, buf: *mut c_char, size: usize) -> c_int {
