...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_writable(sk: *mut sock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_write_space(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_bind(sock: *mut socket, saddr: *mut sockaddr_unsized, len: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_listen(sock: *mut socket, backlog: c_int) -> c_int {
    ...
    ASSERT(rx.local != core::ptr::null_mut());
    max = READ_ONCE(rxrpc_max_backlog);
    ret = -EINVAL;
    if (backlog == INT_MAX)
    backlog = max;
#[no_mangle]
pub unsafe extern "C" fn if(max: backlog < 0 || backlog >) -> else {
...
//
    ...
    {
    return peer ? rxrpc_get_peer(peer, rxrpc_peer_get_application) : core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_kernel_put_peer(peer: *mut rxrpc_peer) {
...
//
    ...
    key = core::ptr::null_mut(); /* a no-security key */
    memset(&p, 0, sizeof(p));
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_kernel_shutdown_call(sock: *mut socket, call: *mut rxrpc_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_kernel_put_call(sock: *mut socket, call: *mut rxrpc_call) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_sendmsg(sock: *mut socket, m: *mut msghdr, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rxrpc_sock_set_min_security_level(sk: *mut sock, val: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_shutdown(sock: *mut socket, flags: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_purge_oob_queue(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_sock_destructor(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_release_sock(sk: *mut sock) -> c_int {
...
//
    ...
    rx.local.service = core::ptr::null_mut();
...
// try to flush out this socket
    ...
    rx.local = core::ptr::null_mut();
    key_put(rx.key);
    rx.key = core::ptr::null_mut();
    key_put(rx.securities);
    rx.securities = core::ptr::null_mut();
    sock_put(sk);
    _leave(" = 0");
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_release(sock: *mut socket) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn af_rxrpc_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn af_rxrpc_exit() -> void __exit {
