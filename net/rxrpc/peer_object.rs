...
//! Source: net/rxrpc/peer_object.c
#![no_std]
...
//
    ...
    case AF_INET:
    hash_key += (u16 )srx.transport.sin.sin_port;
...
//
    ...
    switch (srx.transport.family) {
    case AF_INET:
    return ((u16 )peer.srx.transport.sin.sin_port -
    ...
    case AF_INET6:
    return ((u16 )peer.srx.transport.sin6.sin6_port -
...
//
    ...
    {
    struct rxrpc_peer *peer;
    let mut hash_key: c_ulong = rxrpc_peer_hash_key(local, srx);
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_assess_MTU_size(local: *mut rxrpc_local, peer: *mut rxrpc_peer) {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_free_peer(peer: *mut rxrpc_peer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_new_incoming_peer(local: *mut rxrpc_local, peer: *mut rxrpc_peer) {
...
//
    ...
    if (!candidate) {
    _leave(" = core::ptr::null_mut() [nomem]");
    return core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn __rxrpc_put_peer(peer: *mut rxrpc_peer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_put_peer(peer: *mut rxrpc_peer, why: enum rxrpc_peer_trace) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_destroy_all_peers(rxnet: *mut rxrpc_net) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_kernel_get_srtt(peer: *const rxrpc_peer) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_kernel_set_peer_data(peer: *mut rxrpc_peer, app_data: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_kernel_get_peer_data(peer: *const rxrpc_peer) -> c_ulong {
