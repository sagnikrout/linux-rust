...
//! Source: net/rxrpc/conn_object.c
#![no_std]
...
//
    let mut rxrpc_connection_expiry: unsigned int __read_mostly = 10 * 60;
    let mut rxrpc_closed_conn_expiry: unsigned int __read_mostly = 10;
    static void rxrpc_clean_up_connection(struct work_struct *work);
    static void rxrpc_set_service_reap_timer(struct rxrpc_net *rxnet,
    unsigned long reap_at);
#[no_mangle]
pub unsafe extern "C" fn rxrpc_poke_conn(conn: *mut rxrpc_connection, why: enum rxrpc_conn_trace) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_queue_conn(conn: *mut rxrpc_connection, why: enum rxrpc_conn_trace) {
...
//
    ...
    {
    if (conn) {
    let mut r: c_int = refcount_read(&conn.ref);
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_rcu_free_connection(rcu: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_service_connection_reaper(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_destroy_all_connections(rxnet: *mut rxrpc_net) {
