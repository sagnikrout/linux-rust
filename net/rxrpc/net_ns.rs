...
#[no_mangle]
unsafe extern "C" fn rxrpc_service_conn_reap_timeout(timer: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_peer_keepalive_timeout(timer: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_init_net(net: *mut net) -> __net_init int {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_exit_net(net: *mut net) -> __net_exit void {
