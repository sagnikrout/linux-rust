...
//! Source: net/rxrpc/conn_service.c
#![no_std]
...
//
    ...
    struct sk_buff *skb)
    {
    struct rxrpc_connection *conn = core::ptr::null_mut();
    struct rxrpc_conn_proto k;
    struct rxrpc_skb_priv *sp = rxrpc_skb(skb);
    struct rb_node *p;
    let mut seq: c_uint = 1;
...
#[no_mangle]
pub unsafe extern "C" fn if(k.index_key: conn->proto.index_key >) -> else {
...
//
    ...
    {
    struct rxrpc_connection *cursor = core::ptr::null_mut();
    let mut k: rxrpc_conn_proto = conn.proto;
    ...
    pp = &(*pp).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(k.index_key: cursor->proto.index_key >) -> else {
