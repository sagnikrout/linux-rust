...
#[no_mangle]
unsafe extern "C" fn rxgk_free(gk: *mut rxgk_context) {
...
#[no_mangle]
pub unsafe extern "C" fn rxgk_put(gk: *mut rxgk_context) {
...
//
    ...
    let mut L: c_uint = krb5.key_bytes;
    __be32 *info;
    u8 *buffer;
    int ret;
    _enter("");
...
//
    ...
    struct krb5_buffer TK;
    let mut service: bool = rxrpc_conn_is_service(conn);
    int ret;
    u8 *buffer;
