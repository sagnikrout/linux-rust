...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_vet_description_s(desc: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_preparse_s(prep: *mut key_preparsed_payload) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_describe_s(key: *const key, m: *mut seq_file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_server_keyring(rx: *mut rxrpc_sock, optval: sockptr_t, optlen: c_int) -> c_int {
    ...
    key = request_key(&key_type_keyring, description, core::ptr::null_mut());
    if (IS_ERR(key)) {
    kfree(description);
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_sock_set_security_keyring(sk: *mut sock, keyring: *mut key) -> c_int {
    ...
    ret = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(RXRPC_UNBOUND: rx->sk.sk_state !=) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_sock_set_manage_response(sk: *mut sock, set: bool) -> c_int {
