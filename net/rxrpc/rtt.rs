...
#[no_mangle]
unsafe extern "C" fn rxrpc_rto_min_us(call: *mut rxrpc_call) -> u32 {
    static u32 rxrpc_rto_min_us(struct rxrpc_call *call)
    {
    return 200;
    }
#[no_mangle]
unsafe extern "C" fn __rxrpc_set_rto(call: *const rxrpc_call) -> u32 {
    static u32 __rxrpc_set_rto(const struct rxrpc_call *call)
    {
    return (call.srtt_us >> 3) + call.rttvar_us;
    }
#[no_mangle]
unsafe extern "C" fn rxrpc_bound_rto(rto: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_rtt_estimator(call: *mut rxrpc_call, sample_rtt_us: c_long) {
    static void rxrpc_rtt_estimator(struct rxrpc_call *call, long sample_rtt_us)
    {
    long m = sample_rtt_us; /* RTT */
    let mut srtt: u32 = call.srtt_us;
...
//
#[no_mangle]
unsafe extern "C" fn rxrpc_set_rto(call: *mut rxrpc_call) {
...
#[no_mangle]
unsafe extern "C" fn rxrpc_update_rtt_min(call: *mut rxrpc_call, resp_time: ktime_t, rtt_us: c_long) {
...
// Window size 5mins in approx usec (ipv4.sysctl_tcp_min_rtt_wlen)
    let mut wlen_us: u32 = 5ULL * NSEC_PER_SEC / 1024;
    minmax_running_min(&call.min_rtt, wlen_us, resp_time / 1024,
    (u32)rtt_us ? : jiffies_to_usecs(1));
    }
#[no_mangle]
unsafe extern "C" fn rxrpc_ack_update_rtt(call: *mut rxrpc_call, resp_time: ktime_t, rtt_us: c_long) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxrpc_get_rto_backoff(call: *mut rxrpc_call, retrans: bool) -> ktime_t {
    ktime_t rxrpc_get_rto_backoff(struct rxrpc_call *call, bool retrans)
    {
    u64 timo_us;
    let mut backoff: u32 = READ_ONCE(call.backoff);
    timo_us = call.rto_us;
    timo_us <<= backoff;
...
#[no_mangle]
pub unsafe extern "C" fn rxrpc_call_init_rtt(call: *mut rxrpc_call) {
