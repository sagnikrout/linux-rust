...
//! Source: net/mpls/mpls_iptunnel.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mpls_encap_size(en: *mut mpls_iptunnel_encap) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mpls_xmit(skb: *mut sk_buff) -> c_int {
    ...
    struct rt6_info *rt6 = core::ptr::null_mut();
...
// determine number of labels
    ...
    &n_labels, core::ptr::null_mut(), extack))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn mpls_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpls_encap_cmp(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpls_iptunnel_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mpls_iptunnel_exit() -> void __exit {
