...
#[no_mangle]
pub unsafe extern "C" fn smc_nl_dump_hs_limitation(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smc_nl_enable_hs_limitation(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smc_nl_disable_hs_limitation(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smc_set_keepalive(sk: *mut sock, val: c_int) {
...
// child must not inherit smc or its ops
    if (child) {
    rcu_assign_sk_user_data(child, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn smc_hs_congested(sk: *const sock) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn smc_hash_sk(sk: *mut sock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smc_unhash_sk(sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn smc_release_cb(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_fback_restore_callbacks(smc: *mut smc_sock) {
    static void smc_fback_restore_callbacks(struct smc_sock *smc)
    {
    struct sock *clcsk = smc.clcsock.sk;
    write_lock_bh(&clcsk.sk_callback_lock);
    rcu_assign_sk_user_data(clcsk, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn smc_restore_fallback_changes(smc: *mut smc_sock) {
    static void smc_restore_fallback_changes(struct smc_sock *smc)
    {
    if (smc.clcsock.file) { /* non-accepted sockets have no file yet */
    smc.clcsock.file.private_data = smc.sk.sk_socket;
    smc.clcsock.file = core::ptr::null_mut();
    smc_fback_restore_callbacks(smc);
    }
    }
#[no_mangle]
unsafe extern "C" fn __smc_release(smc: *mut smc_sock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smc_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smc_destruct(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn smc_sk_init(net: *mut net, sk: *mut sock, protocol: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smc_copy_sock_settings_to_clc(smc: *mut smc_sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_copy_sock_settings_to_smc(smc: *mut smc_sock) {
...
#[no_mangle]
unsafe extern "C" fn smcr_clnt_conf_first_link(smc: *mut smc_sock) -> c_int {
...
//
    qentry = smc_llc_wait(link.lgr, core::ptr::null_mut(), 2 * SMC_LLC_WAIT_TIME,
    SMC_LLC_CONFIRM_LINK);
    if (!qentry) {
    struct smc_clc_msg_decline dclc;
    rc = smc_clc_wait_msg(smc, &dclc, sizeof(dclc),
    SMC_CLC_DECLINE, CLC_WAIT_TIME_SHORT);
    let mut rc: return = = -EAGAIN ? SMC_CLC_DECL_TIMEOUT_CL : rc;
    }
...
// optional 2nd link, receive ADD LINK request from server
    qentry = smc_llc_wait(link.lgr, core::ptr::null_mut(), SMC_LLC_WAIT_TIME,
    SMC_LLC_ADD_LINK);
    if (!qentry) {
    struct smc_clc_msg_decline dclc;
    rc = smc_clc_wait_msg(smc, &dclc, sizeof(dclc),
...
#[no_mangle]
unsafe extern "C" fn smc_isascii(hostname: *mut c_char) -> bool {
    ...
    struct smc_clc_msg_accept_confirm *clc)
    {
    let mut bufsize: c_int = smc_uncompress_bufsize(clc.r0.rmbe_size);
    ...
    struct smc_clc_msg_accept_confirm *clc)
    {
    let mut bufsize: c_int = smc_uncompress_bufsize(clc.d0.dmbe_size);
...
#[no_mangle]
unsafe extern "C" fn smc_stat_fallback(smc: *mut smc_sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_fback_wakeup_waitqueue(smc: *mut smc_sock, key: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn if(EPOLLERR: flags &) -> else {
...
// sk_error_report
    ...
    {
    let mut mark: smc_mark_woken = { .woken = false };
    struct socket_wq *wq;
...
#[no_mangle]
unsafe extern "C" fn smc_fback_state_change(clcsk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_fback_data_ready(clcsk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_fback_write_space(clcsk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_fback_error_report(clcsk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_fback_replace_callbacks(smc: *mut smc_sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_switch_to_fallback(smc: *mut smc_sock, reason_code: c_int) -> c_int {
    ...
    smc.sk.sk_socket.wq.fasync_list = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn smc_connect_fallback(smc: *mut smc_sock, reason_code: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smc_conn_abort(smc: *mut smc_sock, local_first: c_int) {
    static void smc_conn_abort(struct smc_sock *smc, int local_first)
    {
    struct smc_connection *conn = &smc.conn;
    struct smc_link_group *lgr = conn.lgr;
    let mut lgr_valid: bool = false;
...
#[no_mangle]
unsafe extern "C" fn smc_find_rdma_device(smc: *mut smc_sock, ini: *mut smc_init_info) -> c_int {
...
// called for connect and listen
#[no_mangle]
unsafe extern "C" fn smc_find_ism_device(smc: *mut smc_sock, ini: *mut smc_init_info) -> c_int {
...
// is chid unique for the ism devices that are already determined?
    ...
    int cnt)
    {
    let mut i: c_int = (!ini.ism_dev[0]) ? 1 : 0;
    for (; i < cnt; i++)
...
//
    ...
    struct smc_init_info *ini)
    {
    let mut rc: c_int = SMC_CLC_DECL_NOSMCDDEV;
    struct smcd_dev *smcd;
    let mut i: c_int = 1, entry = 1;
    bool is_emulated;
    u16 chid;
...
#[no_mangle]
unsafe extern "C" fn smc_connect_ism_vlan_setup(ini: *mut smc_init_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smc_connect_ism_vlan_cleanup(ini: *mut smc_init_info) -> c_int {
...
// receive SMC Accept CLC message
    ...
    {
    struct smc_init_info *alt_ini = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __smc_connect(smc: *mut smc_sock) -> c_int {
    static int __smc_connect(struct smc_sock *smc)
    {
    let mut version: u8 = smc_ism_is_v2_capable() ? SMC_V2 : SMC_V1;
    struct smc_clc_msg_accept_confirm *aclc;
    struct smc_init_info *ini = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn smc_connect_work(work: *mut work_struct) {
    static void smc_connect_work(struct work_struct *work)
    {
    struct smc_sock *smc = container_of(work, struct smc_sock,
    connect_work);
    let mut timeo: c_long = READ_ONCE(smc.sk.sk_sndtimeo);
    let mut rc: c_int = 0;
    if (!timeo)
...
#[no_mangle]
unsafe extern "C" fn smc_clcsock_accept(lsmc: *mut smc_sock, new_smc: *mut smc_sock) -> c_int {
    static int smc_clcsock_accept(struct smc_sock *lsmc, struct smc_sock **new_smc)
    {
    struct socket *new_clcsock = core::ptr::null_mut();
    struct sock *lsk = &lsmc.sk;
    struct sock *new_sk;
    let mut rc: c_int = -EINVAL;
    release_sock(lsk);
    new_sk = smc_sock_alloc(sock_net(lsk), core::ptr::null_mut(), lsk.sk_protocol);
    if (!new_sk) {
    rc = -ENOMEM;
    lsk.sk_err = ENOMEM;
// new_smc = NULL;
...
//
#[no_mangle]
unsafe extern "C" fn smc_accept_enqueue(parent: *mut sock, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_accept_unlink(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn smc_close_non_accepted(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn smcr_serv_conf_first_link(smc: *mut smc_sock) -> c_int {
...
// initial contact - try to establish second link
    smc_llc_srv_add_link(link, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn smc_listen_out(new_smc: *mut smc_sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_listen_out_connected(new_smc: *mut smc_sock) {
...
#[no_mangle]
unsafe extern "C" fn smc_listen_out_err(new_smc: *mut smc_sock) {
...
// listen worker: version checking
    ...
    let mut rc: c_int = SMC_CLC_DECL_PEERNOSMC;
...
#[no_mangle]
unsafe extern "C" fn smc_init_info_store_rc(rc: u32, ini: *mut smc_init_info) {
...
// no V2 ISM device could be initialized
    ...
    not_found:
    ini.smcd_version &= ~SMC_V2;
    ini.ism_dev[0] = core::ptr::null_mut();
    ini.is_smcd = false;
    }
...
#[no_mangle]
unsafe extern "C" fn smc_listen_rdma_reg(new_smc: *mut smc_sock, local_first: bool) -> c_int {
...
// reg sendbufs if they were vzalloced
    ...
    smc_v2_ext = smc_get_clc_v2_ext(pclc);
    if (!smc_v2_ext ||
    !smc_clc_match_eid(ini.negotiated_eid, smc_v2_ext, core::ptr::null_mut(), core::ptr::null_mut()))
    goto not_found;
// prepare RDMA check
    ...
    not_found:
    ini.smcr_version &= ~SMC_V2;
    ini.smcrv2.ib_dev_v2 = core::ptr::null_mut();
    ini.check_smcrv2 = false;
    }
...
#[no_mangle]
unsafe extern "C" fn smc_listen_work(work: *mut work_struct) {
    ...
    struct smc_clc_msg_proposal *pclc;
    struct smc_init_info *ini = core::ptr::null_mut();
    let mut proposal_version: u8 = SMC_V1;
    u8 accept_version;
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn smc_tcp_listen_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn smc_clcsock_data_ready(listen_clcsock: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn smc_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
// save original ops
    ...
    &smc.clcsk_data_ready);
    rcu_assign_sk_user_data(smc.clcsock.sk, core::ptr::null_mut());
    write_unlock_bh(&smc.clcsock.sk.sk_callback_lock);
    goto out;
    }
...
// wait till data arrives on the socket
    ...
    sk_wait_data(clcsk, &timeo, core::ptr::null_mut());
    release_sock(clcsk);
...
#[no_mangle]
pub unsafe extern "C" fn smc_sendmsg(sock: *mut socket, msg: *mut msghdr, len: usize) -> c_int {
...
// socket was connected before, no more data to read
    ...
    msg.msg_namelen = 0;
    rc = smc_rx_recvmsg(smc, msg, core::ptr::null_mut(), len, flags);
...
#[no_mangle]
unsafe extern "C" fn smc_accept_poll(parent: *mut sock) -> __poll_t {
...
#[no_mangle]
pub unsafe extern "C" fn smc_shutdown(sock: *mut socket, how: c_int) -> c_int {
    int smc_shutdown(struct socket *sock, int how)
    {
    struct sock *sk = sock.sk;
    let mut do_shutdown: bool = true;
    struct smc_sock *smc;
    let mut rc: c_int = -EINVAL;
    int old_state;
    let mut rc1: c_int = 0;
...
// pre-fetch user data outside the lock
    ...
    return -EOPNOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(SOL_SMC: level ==) -> else {
...
// socket was connected before, no more data to read
    ...
    rc = smc_rx_recvmsg(smc, core::ptr::null_mut(), pipe, len, flags);
    }
    out:
    release_sock(sk);
    return rc;
...
#[no_mangle]
pub unsafe extern "C" fn smc_create_clcsk(net: *mut net, sk: *mut sock, family: c_int) -> c_int {
...
//
    ...
    int kern)
    {
    let mut family: c_int = (protocol == SMCPROTO_SMC6) ? PF_INET6 : PF_INET;
    struct sock *sk;
    int rc;
    rc = -ESOCKTNOSUPPORT;
...
#[no_mangle]
unsafe extern "C" fn smc_net_init(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn smc_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn smc_net_stat_init(net: *mut net) -> __net_init int {
    static __net_init int smc_net_stat_init(struct net *net)
    {
    return smc_stats_init(net);
    }
#[no_mangle]
unsafe extern "C" fn smc_net_stat_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn smc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn smc_exit() -> void __exit {
