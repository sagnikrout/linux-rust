...
#[no_mangle]
unsafe extern "C" fn smc_diag_msg_common_fill(r: *mut smc_diag_msg, sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn if(smc->conn.lgr->is_smcd: smc_conn_lgr_valid(&smc->conn) &&) -> else {
...
// (u8 *)&conn->local_rx_ctrl.conn_state_flags,
    ...
    let mut snum: c_int = cb_ctx.pos[p_type];
    struct nlattr *bc = core::ptr::null_mut();
    struct hlist_head *head;
    let mut rc: c_int = 0, num = 0;
    struct sock *sk;
...
#[no_mangle]
unsafe extern "C" fn smc_diag_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smc_diag_handler_dump(skb: *mut sk_buff, h: *mut nlmsghdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smc_diag_init() -> int __init {
    static int __init smc_diag_init(void)
    {
    return sock_diag_register(&smc_diag_handler);
    }
#[no_mangle]
unsafe extern "C" fn smc_diag_exit() -> void __exit {
