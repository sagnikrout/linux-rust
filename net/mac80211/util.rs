...
// privid for wiphys to determine whether they belong to us or not
    let mut mac80211_wiphy_privid: *const void const = &mac80211_wiphy_privid;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_tx_set_protected(tx: *mut ieee80211_tx_data) {
...
#[no_mangle]
unsafe extern "C" fn __ieee80211_wake_txqs(sdata: *mut ieee80211_sub_if_data, ac: c_int) {
    static void __ieee80211_wake_txqs(struct ieee80211_sub_if_data *sdata, int ac)
    {
    struct ieee80211_local *local = sdata.local;
    struct ieee80211_vif *vif = &sdata.vif;
    struct fq *fq = &local.fq;
    struct ps_data *ps = core::ptr::null_mut();
    struct txq_info *txqi = core::ptr::null_mut();
    struct sta_info *sta;
    int i;
    local_bh_disable();
    spin_lock(&fq.lock);
...
// txq and txq_mgmt are mutually exclusive
    ...
    {
    struct ieee80211_sub_if_data *sdata;
    let mut n_acs: c_int = IEEE80211_NUM_ACS;
    int i;
    rcu_read_lock();
    ...
    let mut ac_queue: c_int = sdata.vif.hw_queue[ac];
    if (ac_queue == i ||
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_wake_txqs(t: *mut tasklet_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_wake_queue(hw: *mut ieee80211_hw, queue: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_stop_queue(hw: *mut ieee80211_hw, queue: c_int) {
    ...
    let mut queue: c_int = info.hw_queue;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_stop_queues(hw: *mut ieee80211_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_queue_stopped(hw: *mut ieee80211_hw, queue: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_wake_queues(hw: *mut ieee80211_hw) {
...
//
    ...
    {
    struct ieee80211_sub_if_data *sdata;
    let mut active_only: bool = iter_flags & IEEE80211_IFACE_ITER_ACTIVE;
    list_for_each_entry_rcu(sdata, &local.interfaces, list,
    ...
    {
    let mut active_only: bool = iter_flags & IEEE80211_IFACE_ITER_ACTIVE;
    struct ieee80211_sub_if_data *sdata = core::ptr::null_mut(), *monitor;
    struct ieee80211_local *local = hw_to_local(hw);
...
//
#[no_mangle]
unsafe extern "C" fn ieee80211_can_queue_work(local: *mut ieee80211_local) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_queue_work(hw: *mut ieee80211_hw, work: *mut work_struct) {
...
// never happens but let's not leave undefined
    ...
    qparam.txop = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: use_11b) -> else {
    else if (use_11b)
    qparam.txop = 6016/32;
    else
    qparam.txop = 3008/32;
...
pub unsafe extern "C" fn if(_arg: use_11b) -> else {
    ...
    let mut multi_link: bool = ieee80211_vif_is_mld(&sdata.vif);
    struct {
    u8 id;
    u8 len;
    u8 ext_id;
...
// offset = noffset;
    ...
    err = ieee80211_put_he_cap(skb, sdata, sband, core::ptr::null_mut());
    if (err)
    return err;
    }
    if (cfg80211_any_usable_channels(local.hw.wiphy, BIT(sband.band),
    ...
    err = ieee80211_put_eht_cap(skb, sdata, sband, core::ptr::null_mut());
    if (err)
    return err;
    }
...
//
    ...
    u32 flags)
    {
    let mut custom_ie_offset: usize = 0;
    int i, err;
...
//
    ...
    chandef.chan = core::ptr::null_mut();
    else
    chandef.chan = chan;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: elems->ext_supp_rates) -> else {
    ...
    let mut brate: c_int = sband.bitrates[j].bitrate;
    if (brate == own_rate) {
    supp_rates |= BIT(j);
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_stop_device(local: *mut ieee80211_local, suspend: bool) {
    ...
    wiphy_work_flush(local.hw.wiphy, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ieee80211_handle_reconfig_failure(local: *mut ieee80211_local) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_reconfig_stations(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_reconfig_nan(sdata: *mut ieee80211_sub_if_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_reconfig(local: *mut ieee80211_local) -> c_int {
    ...
    struct sta_info *sta;
    int res, i;
    let mut reconfig_due_to_wowlan: bool = false;
    struct ieee80211_sub_if_data *sched_scan_sdata;
    struct cfg80211_sched_scan_request *sched_scan_req;
    let mut sched_scan_stopped: bool = false;
    let mut suspended: bool = local.suspended;
    let mut in_reconfig: bool = false;
    lockdep_assert_wiphy(local.hw.wiphy);
...
// in HW restart it exists already
    ...
    if (WARN_ON(res)) {
    RCU_INIT_POINTER(local.monitor_sdata, core::ptr::null_mut());
    synchronize_net();
    kfree(sdata);
    }
    }
...
//
    ...
    sched_scan_req)) {
    RCU_INIT_POINTER(local.sched_scan_sdata, core::ptr::null_mut());
    RCU_INIT_POINTER(local.sched_scan_req, core::ptr::null_mut());
...
// Passing NULL means an interface is picked for configuration
    ...
    ieee80211_add_virtual_monitor(local, core::ptr::null_mut());
    if (!suspended)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_reconfig_disconnect(vif: *mut ieee80211_vif, flag: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_hw_restart_disconnect(vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_resume_disconnect(vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ie_split_vendor(ies: *const u8, ielen: usize, offset: usize) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ie_len_he_cap(sdata: *mut ieee80211_sub_if_data) -> u8 {
...
// len = skb_tail_pointer(skb) - len - 1;
    ...
    struct ieee80211_supported_band *sband;
    let mut available_channels: bool = false;
    let mut flags: u32 = 0;
    int i;
...
// don't require special VHT peer rates
    ...
    u32 he_oper_params;
    let mut ie_len: u8 = 1 + sizeof(struct ieee80211_he_operation);
...
// center_freq1
//
    ieee80211_chandef_downgrade(&he_chandef, core::ptr::null_mut());
    he_6ghz_op.ccfs0 =
    ieee80211_frequency_to_channel(he_chandef.center_freq1);
    fallthrough;
    case NL80211_CHAN_WIDTH_160:
...
//
    ...
    let mut eht_oper_len: u8 = offsetof(struct ieee80211_eht_operation, optional);
    u8 eht_oper_info_len =
    offsetof(struct ieee80211_eht_operation_info, optional);
    let mut chan_width: u8 = 0;
// pos++ = WLAN_EID_EXTENSION;
...
// TODO: eht_oper_info->optional
    ...
    struct cfg80211_chan_def *chandef)
    {
    let mut new: cfg80211_chan_def = *chandef;
    int cf0, cf1;
    int ccfs0, ccfs1, ccfs2;
    int ccf0, ccf1;
    u32 vht_cap;
    let mut support_80_80: bool = false;
    let mut support_160: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ave_rssi(vif: *mut ieee80211_vif, link_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_mcs_to_chains(mcs: *const ieee80211_mcs_info) -> u8 {
...
//
    ...
    let mut _ignored: ieee80211_conn_settings = {};
...
//
    ...
    {
    let mut hdr_len: c_int = IEEE80211_MIN_ACTION_SIZE(chan_switch);
    struct sk_buff *skb;
    struct ieee80211_mgmt *mgmt;
    struct ieee80211_local *local = sdata.local;
    int freq;
...
// pos++ |= csa_settings->block_tx ?
    ...
    {
    let mut end: i32 = data.desc[i].start + data.desc[i].duration - (tsf + 1);
    int skip;
    if (end > 0)
    return false;
// One shot NOA
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_update_p2p_noa(data: *mut ieee80211_noa_data, tsf: u32) {
    void ieee80211_update_p2p_noa(struct ieee80211_noa_data *data, u32 tsf)
    {
    let mut next_offset: u32 = BIT(31) - 1;
    int i;
    data.absent = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_recalc_dtim(sdata: *mut ieee80211_sub_if_data, tsf: u64) {
    void ieee80211_recalc_dtim(struct ieee80211_sub_if_data *sdata, u64 tsf)
    {
    let mut dtim_count: u64 = 0;
    let mut beacon_int: u32 = sdata.vif.bss_conf.beacon_int * 1024;
    let mut dtim_period: u8 = sdata.vif.bss_conf.dtim_period;
    struct ps_data *ps;
    u8 bcns_from_dtim;
...
//
#[no_mangle]
pub unsafe extern "C" fn ieee80211_recalc_sb_count(sdata: *mut ieee80211_sub_if_data, tsf: u64) {
    void ieee80211_recalc_sb_count(struct ieee80211_sub_if_data *sdata, u64 tsf)
    {
    u32 sb_idx;
    struct ps_data *ps = &sdata.bss.ps;
    let mut lb_period: u8 = sdata.vif.bss_conf.s1g_long_beacon_period;
    let mut beacon_int: u32 = sdata.vif.bss_conf.beacon_int * 1024;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_get_radio_mask(wiphy: *mut wiphy, dev: *mut net_device) -> u32 {
    ...
    let mut shared: bool = data.chanmode == IEEE80211_CHANCTX_SHARED;
    struct ieee80211_local *local = sdata.local;
    let mut iftype: enum nl80211_iftype = sdata.wdev.iftype;
    struct iface_combination_params params = {
...
// Always allow software iftypes
    ...
    shared ? chandef : core::ptr::null_mut(),
    sdata,
    data.chanctx_filter,
    data.filter_data);
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_max_num_channels(local: *mut ieee80211_local, radio_idx: c_int) -> c_int {
    int ieee80211_max_num_channels(struct ieee80211_local *local, int radio_idx)
    {
    let mut max_num_different_channels: u32 = 1;
    int err;
    struct iface_combination_params params = {
    .radio_idx = radio_idx,
    };
    lockdep_assert_wiphy(local.hw.wiphy);
    ieee80211_fill_ifcomb_params(local, &params, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
...
// override the capability info
    ...
    let mut mask: u8 = ifmgd.s1g_capa_mask.capab_info[i];
...
// then MCS and NSS set
    ...
    let mut mask: u8 = ifmgd.s1g_capa_mask.supp_mcs_nss[i];
...
// buf++ = qosinfo; /* U-APSD no in use
    ...
    let mut frag_cnt: u32 = 0, frag_bytes = 0;
    struct sk_buff *skb;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_encode_usf(listen_interval: c_int) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ie_len_eht_cap(sdata: *mut ieee80211_sub_if_data) -> u8 {
    ...
    let mut for_ap: bool = sdata.vif.type == NL80211_IFTYPE_AP;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_clear_tpe(tpe: *mut ieee80211_parsed_tpe) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_vif_nan_started(vif: *mut ieee80211_vif) -> bool {
