...
//! Source: net/mac80211/mesh_sync.c
#![no_std]
...
//
pub const TOFFSET_MINIMUM_ADJUSTMENT: c_int = 10;
// This is not in the standard. It is a margin added to the
// Toffset setpoint to mitigate TSF overcorrection
// introduced by TSF adjustment latency.
//
pub const TOFFSET_SET_MARGIN: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sync_method {
    pub method: u8,
    pub ops: ieee80211_mesh_sync_ops,
}
...
//
#[no_mangle]
unsafe extern "C" fn mesh_peer_tbtt_adjusting(cfg: *const ieee80211_meshconf_ie) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_sync_adjust_tsf(sdata: *mut ieee80211_sub_if_data) {
    void mesh_sync_adjust_tsf(struct ieee80211_sub_if_data *sdata)
    {
    struct ieee80211_local *local = sdata.local;
    struct ieee80211_if_mesh *ifmsh = &sdata.u.mesh;
// sdata->vif.bss_conf.beacon_int in 1024us units, 0.04%
    let mut beacon_int_fraction: u64 = sdata.vif.bss_conf.beacon_int * 1024 / 2500;
    u64 tsf;
    u64 tsfdelta;
...
// Timing offset calculation (see 13.13.2.2.2)
    ...
    let mut t_clockdrift: i64 = sta.mesh.t_offset_setpoint - sta.mesh.t_offset;
    msync_dbg(sdata,
