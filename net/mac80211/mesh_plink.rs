...
//! Source: net/mac80211/mesh_plink.c
#![no_std]
...
// We only need a valid sta if user configured a minimum rssi_threshold.
    ...
    struct sta_info *sta)
    {
    let mut rssi_threshold: i32 = sdata.u.mesh.mshcfg.rssi_threshold;
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_plink_fsm_restart(sta: *mut sta_info) {
...
//
#[no_mangle]
unsafe extern "C" fn mesh_set_short_slot_time(sdata: *mut ieee80211_sub_if_data) -> u64 {
    static u64 mesh_set_short_slot_time(struct ieee80211_sub_if_data *sdata)
    {
    struct ieee80211_local *local = sdata.local;
    struct ieee80211_supported_band *sband;
    struct sta_info *sta;
    let mut erp_rates: u32 = 0;
    let mut changed: u64 = 0;
    int i;
    let mut short_slot: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn mesh_set_ht_prot_mode(sdata: *mut ieee80211_sub_if_data) -> u64 {
    static u64 mesh_set_ht_prot_mode(struct ieee80211_sub_if_data *sdata)
    {
    struct ieee80211_local *local = sdata.local;
    struct sta_info *sta;
    u16 ht_opmode;
    let mut non_ht_sta: bool = false, ht20_sta = false;
    ...
    {
    let mut hdr_len: c_int = IEEE80211_MIN_ACTION_SIZE(self_prot);
    struct ieee80211_local *local = sdata.local;
    struct sk_buff *skb;
    struct ieee80211_tx_info *info;
    struct ieee80211_mgmt *mgmt;
    let mut include_plid: bool = false;
    let mut peering_proto: u16 = 0;
    u8 *pos, ie_len = 4;
...
//
#[no_mangle]
unsafe extern "C" fn __mesh_plink_deactivate(sta: *mut sta_info) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_plink_deactivate(sta: *mut sta_info) -> u64 {
...
// make sure no readers can access nexthop sta from here on
    ...
    if (!sband)
    return;
    rates = ieee80211_sta_get_rates(sdata, elems, sband.band, core::ptr::null_mut());
    spin_lock_bh(&sta.mesh.plink_lock);
...
// rates and capabilities don't change during peering
    ...
    &sband.vht_cap,
    elems.vht_cap_elem, core::ptr::null_mut(),
    &sta.deflink);
...
#[no_mangle]
unsafe extern "C" fn mesh_allocate_aid(sdata: *mut ieee80211_sub_if_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_plink_timer(t: *mut timer_list) {
    ...
    let mut action: enum ieee80211_self_protected_actioncode = 0;
//
...
#[no_mangle]
pub unsafe extern "C" fn mesh_plink_timer_set(sta: *mut sta_info, timeout: u32) {
...
#[no_mangle]
unsafe extern "C" fn mesh_get_new_llid(sdata: *mut ieee80211_sub_if_data) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_plink_open(sta: *mut sta_info) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_plink_block(sta: *mut sta_info) -> u64 {
...
//
    ...
    u16 llid, u16 plid)
    {
    let mut event: enum plink_event = PLINK_UNDEFINED;
    let mut ie_len: u8 = elems.peering_len;
    bool matches_local;
...
//
    event = CLS_ACPT;
#[no_mangle]
pub unsafe extern "C" fn if(plid: sta->mesh->plid !=) -> else {
    else if (sta.mesh.plid != plid)
    event = CLS_IGNR;
#[no_mangle]
pub unsafe extern "C" fn if(llid: ie_len == 8 && sta->mesh->llid !=) -> else {
...
// allocate sta entry if necessary and update info
    ...
    mesh_plink_frame_tx(sdata, core::ptr::null_mut(), WLAN_SP_MESH_PEERING_CLOSE,
    mgmt.sa, 0, plid,
