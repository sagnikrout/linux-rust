...
#[no_mangle]
unsafe extern "C" fn is_uapsd_supported(elems: *mut ieee802_11_elems) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inform_bss_update_data {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ieee80211_hw_check(&local->hw, _arg: SIGNAL_DBM)) -> else {
    else if (ieee80211_hw_check(&local.hw, SIGNAL_DBM))
    bss_meta.signal = rx_status.signal * 100;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ieee80211_hw_check(&local->hw, _arg: SIGNAL_UNSPEC)) -> else {
    ...
    struct ieee80211_bss_conf *link_conf = core::ptr::null_mut();
...
//
    ...
    let mut link_id: i8 = rx_status.link_id;
    link_conf =
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_scan_rx(local: *mut ieee80211_local, skb: *mut sk_buff) {
...
//
    ...
    let mut scan_req_flags: u32 = 0, sched_scan_req_flags = 0;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_prepare_scan_chandef(chandef: *mut cfg80211_chan_def) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_prep_hw_scan(sdata: *mut ieee80211_sub_if_data) -> bool {
    static bool ieee80211_prep_hw_scan(struct ieee80211_sub_if_data *sdata)
    {
    struct ieee80211_local *local = sdata.local;
    struct cfg80211_scan_request *req;
    struct cfg80211_chan_def chandef;
    let mut bands_used: u8 = 0;
    int i, ielen;
    u32 *n_chans;
    let mut flags: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn __ieee80211_scan_completed(hw: *mut ieee80211_hw, aborted: bool) {
    static void __ieee80211_scan_completed(struct ieee80211_hw *hw, bool aborted)
    {
    struct ieee80211_local *local = hw_to_local(hw);
    let mut hw_scan: bool = test_bit(SCAN_HW_SCANNING, &local.scanning);
    let mut was_scanning: bool = local.scanning;
    struct cfg80211_scan_request *scan_req;
    struct ieee80211_sub_if_data *scan_sdata;
...
//
    ...
    local.hw_scan_req = core::ptr::null_mut();
    scan_req = rcu_dereference_protected(local.scan_req,
    lockdep_is_held(&local.hw.wiphy.mtx));
    RCU_INIT_POINTER(local.scan_req, core::ptr::null_mut());
    RCU_INIT_POINTER(local.scan_sdata, core::ptr::null_mut());
    local.scanning = 0;
    local.scan_chandef.chan = core::ptr::null_mut();
    synchronize_rcu();
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_run_deferred_scan(local: *mut ieee80211_local) {
    ...
    struct ieee80211_sub_if_data *sdata;
    struct cfg80211_scan_request *scan_req;
    let mut band: enum nl80211_band = local.hw.conf.chandef.chan.band;
    let mut flags: u32 = 0, tx_flags;
    scan_req = rcu_dereference_protected(local.scan_req,
    lockdep_is_held(&local.hw.wiphy.mtx));
...
// next_delay = msecs_to_jiffies(scan_req->duration) >
    ...
    {
    struct ieee80211_local *local = sdata.local;
    let mut hw_scan: bool = local.ops.hw_scan;
    int rc;
    lockdep_assert_wiphy(local.hw.wiphy);
    if (local.scan_req)
    return -EBUSY;
...
// Do normal software scan
    ...
    local.scanning = 0;
    ieee80211_recalc_idle(local);
    local.scan_req = core::ptr::null_mut();
    RCU_INIT_POINTER(local.scan_sdata, core::ptr::null_mut());
    }
    if (hw_scan && rc == 1) {
//
...
//
    ...
    unsigned long *next_delay)
    {
    let mut associated: bool = false;
    let mut tx_empty: bool = true;
    bool bad_latency;
    struct ieee80211_sub_if_data *sdata;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_scan_work(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_scan_cancel(local: *mut ieee80211_local) {
...
// and clean up
    ...
    {
    struct ieee80211_local *local = sdata.local;
    let mut sched_scan_ies: ieee80211_scan_ies = {};
    struct cfg80211_chan_def chandef;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_request_sched_scan_stop(local: *mut ieee80211_local) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_sched_scan_results(hw: *mut ieee80211_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_sched_scan_end(local: *mut ieee80211_local) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_sched_scan_stopped(hw: *mut ieee80211_hw) {
