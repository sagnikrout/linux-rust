...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_configure_filter(local: *mut ieee80211_local) {
    void ieee80211_configure_filter(struct ieee80211_local *local)
    {
    u64 mc;
    unsigned int changed_flags;
    let mut new_flags: c_uint = 0;
...
// be a bit nasty
    ...
    struct cfg80211_chan_def *oper = core::ptr::null_mut();
    let mut smps_mode: enum ieee80211_smps_mode = IEEE80211_SMPS_STATIC;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: ctx->rx_chains_dynamic >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_hw_conf_chan(local: *mut ieee80211_local) -> c_int {
    ...
    list);
    return _ieee80211_hw_conf_chan(local, ctx ? &ctx.conf : core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn ieee80211_hw_conf_init(local: *mut ieee80211_local) {
    ...
    ctx ? &ctx.conf : core::ptr::null_mut());
    }
    ...
    _ieee80211_hw_conf_chan(local, core::ptr::null_mut());
    }
    ...
    let mut ch: u64 = changed & BSS_CHANGED_VIF_CFG_FLAGS;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_reset_erp_info(sdata: *mut ieee80211_sub_if_data) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_handle_queued_frames(local: *mut ieee80211_local) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_tasklet_handler(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_restart_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_restart_hw(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_init_cipher_suites(local: *mut ieee80211_local) -> c_int {
    static int ieee80211_init_cipher_suites(struct ieee80211_local *local)
    {
    let mut have_mfp: bool = ieee80211_hw_check(&local.hw, MFP_CAPABLE);
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_register_hw(hw: *mut ieee80211_hw) -> c_int {
    ...
    let mut dflt_chandef: cfg80211_chan_def = {};
...
// add one default STA interface if supported
    ...
    let mut params: vif_params = {0};
    result = ieee80211_if_add(local, "wlan%d", NET_NAME_ENUM, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_unregister_hw(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_free_ack_frame(id: c_int, p: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_free_hw(hw: *mut ieee80211_hw) {
    ...
    ieee80211_free_ack_frame, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ieee80211_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_exit() -> void __exit {
