...
//! Source: net/mac80211/mesh_hwmp.c
#![no_std]
...
pub const TEST_FRAME_LEN: c_int = 8192;
pub const MAX_METRIC: c_uint = 0xffffffff;
pub const ARITH_SHIFT: c_int = 8;
pub const LINK_FAIL_THRESH: c_int = 95;
pub const MAX_PREQ_QUEUE_LEN: c_int = 64;
    static void mesh_queue_preq(struct mesh_path *, u8);
// HWMP IE processing macros

pub const MAX_SANE_SN_DELTA: c_int = 32;
#[no_mangle]
pub unsafe extern "C" fn SN_DELTA(x: u32, y: u32) -> u32 {
    ...
    {
    let mut hdr_len: c_int = IEEE80211_MIN_ACTION_SIZE(mesh_action);
...
// This should be adjusted for each device
    let mut device_constant: c_int = 1 << ARITH_SHIFT;
    let mut test_frame_len: c_int = TEST_FRAME_LEN << ARITH_SHIFT;
    let mut s_unit: c_int = 1 << ARITH_SHIFT;
    int rate, err;
...
#[no_mangle]
unsafe extern "C" fn is_metric_better(x: u32, y: u32) -> bool {
...
//
    ...
    let mut flush_mpath: bool = false;
...
// init it at a low value - 0 start is tricky
    ...
    struct mesh_path *mpath = core::ptr::null_mut();
...
// addressed PREQs destined for root mesh STA
    ...
    orig_sn, 0, core::ptr::null_mut(), 0, broadcast_addr,
...
//
#[no_mangle]
unsafe extern "C" fn mesh_queue_preq(mpath: *mut mesh_path, flags: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: time_before(jiffies, _arg: ifmsh->last_preq)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_start_discovery(sdata: *mut ieee80211_sub_if_data) {
...
//
    ...
    struct ieee80211_tx_info *info = IEEE80211_SKB_CB(skb);
    struct mesh_path *mpath;
    struct sk_buff *skb_to_free = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mesh_path_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_path_tx_root_frame(sdata: *mut ieee80211_sub_if_data) {
    void mesh_path_tx_root_frame(struct ieee80211_sub_if_data *sdata)
    {
    struct ieee80211_if_mesh *ifmsh = &sdata.u.mesh;
    let mut interval: u32 = ifmsh.mshcfg.dot11MeshHWMPRannInterval;
    ...
    ++ifmsh.sn, 0, core::ptr::null_mut(), 0, broadcast_addr,
