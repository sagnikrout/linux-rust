...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_s1g_sta_rate_init(sta: *mut sta_info) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_s1g_is_twt_setup(skb: *mut sk_buff) -> bool {
    ...
    {
    let mut len: c_int = IEEE80211_MIN_ACTION_SIZE(s1g) + 3 + twt.length;
