...
#[no_mangle]
unsafe extern "C" fn ieee80211_he_mcs_disable(he_mcs: *mut __le16) {
...
#[no_mangle]
pub unsafe extern "C" fn if(peer_tx: own_rx <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(peer_rx: own_tx <) -> else {
...
// Check if there are (optional) PPE Thresholds
    ...
    he_6ghz_capa : core::ptr::null_mut(),
    link_sta);
    }
    void
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_finalize_rx_omi_bw(pub_link_sta: *mut ieee80211_link_sta) {
