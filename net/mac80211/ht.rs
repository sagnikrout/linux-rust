...
//
    ...
    u16 flag)
    {
    let mut le_flag: __le16 = cpu_to_le16(flag);
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ba_session_work(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
// could there be a race?
    ...
    let mut status_link_id: u8 = link_id < 0 ? 0 : link_id;
