...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_send_bar(vif: *mut ieee80211_vif, ra: *mut u8, tid: u16, ssn: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn __acquires(_arg: agg_queue) {
    static void __acquires(agg_queue)
    ieee80211_stop_queue_agg(struct ieee80211_sub_if_data *sdata, int tid)
    {
    let mut queue: c_int = sdata.vif.hw_queue[ieee80211_ac_from_tid(tid)];
...
#[no_mangle]
unsafe extern "C" fn __releases(_arg: agg_queue) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_remove_tid_tx(sta: *mut sta_info, tid: c_int) {
...
// future packets must not find the tid_tx struct any more
    ieee80211_assign_tid_tx(sta, tid, core::ptr::null_mut());
...
// free struct pending for start, if present
    ...
    kfree(tid_tx);
    sta.ampdu_mlme.tid_start_tx[tid] = core::ptr::null_mut();
    tid_tx = rcu_dereference_protected_tid_tx(sta, tid);
    if (!tid_tx) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_tx_ba_session_handle_start(sta: *mut sta_info, tid: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sta_tx_agg_session_timer_expired(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_stop_tx_ba_session(pubsta: *mut ieee80211_sta, tid: u16) -> c_int {
...
// already in progress stopping it
    ...
    {
    struct ieee80211_sub_if_data *sdata = sta.sdata;
    let mut ndp: bool = ndp = tid_tx.ndp;
    let mut send_delba: bool = false;
    let mut start_txq: bool = false;
