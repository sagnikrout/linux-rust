...
// TLVs until the mac header
    ...
    if (!skb)
    return;
    ieee80211_queue_skb_to_iface(sdata, -1, core::ptr::null_mut(), skb);
    }
//
...
//
    ...
    let mut channel_flags: u16 = 0;
    let mut tlvs_len: u32 = 0;
    int mpdulen, chain;
    let mut chains: c_ulong = status.chains;
    let mut vht: ieee80211_radiotap_vht = {};
    let mut he: ieee80211_radiotap_he = {};
    let mut he_mu: ieee80211_radiotap_he_mu = {};
    let mut lsig: ieee80211_radiotap_lsig = {};
    if (status.flag & RX_FLAG_RADIOTAP_VHT) {
...
// pos = 0;
    ...
    shift = 1;
#[no_mangle]
pub unsafe extern "C" fn if(RATE_INFO_BW_5: status->bw ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(RX_ENC_LEGACY: status->encoding !=) -> else {
    else if (status.encoding != RX_ENC_LEGACY)
    channel_flags |= IEEE80211_CHAN_DYN | IEEE80211_CHAN_2GHZ;
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_RATE_ERP_G: rate && rate->flags &) -> else {
    else if (rate && rate.flags & IEEE80211_RATE_ERP_G)
    channel_flags |= IEEE80211_CHAN_OFDM | IEEE80211_CHAN_2GHZ;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rate) -> else {
    else if (rate)
...
// pos++ = 0;
    ...
    if (status.encoding == RX_ENC_VHT) {
    let mut fill: u16 = local.hw.radiotap_vht_details;
...
//
    ...
    {
    struct ieee80211_rx_status *status = IEEE80211_SKB_RXCB(origskb);
    struct ieee80211_sub_if_data *sdata, *prev_sdata = core::ptr::null_mut();
    struct sk_buff *skb, *monskb = core::ptr::null_mut();
    let mut present_fcs_len: c_int = 0;
    let mut rtap_space: c_uint = 0;
    struct ieee80211_sub_if_data *monitor_sdata =
    rcu_dereference(local.monitor_sdata);
    let mut only_monitor: bool = false;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_parse_qos(rx: *mut ieee80211_rx_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ieee80211_verify_alignment(rx: *mut ieee80211_rx_data) {
...
// rx handlers
#[no_mangle]
unsafe extern "C" fn ieee80211_is_unicast_robust_mgmt_frame(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_is_multicast_robust_mgmt_frame(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_get_mmie_keyidx(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_get_keyid(skb: *mut sk_buff) -> c_int {
    static int ieee80211_get_keyid(struct sk_buff *skb)
    {
    struct ieee80211_hdr *hdr = (struct ieee80211_hdr *)skb.data;
    let mut fc: __le16 = hdr.frame_control;
    let mut hdrlen: c_int = ieee80211_hdrlen(fc);
    u8 keyid;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_rx_mesh_check(rx: *mut ieee80211_rx_data) -> ieee80211_rx_result {
...
//
    ...
    struct ieee80211_hdr *hdr = (struct ieee80211_hdr *) skb.data;
    struct ieee80211_rx_status *status = IEEE80211_SKB_RXCB(skb);
    let mut mpdu_seq_num: u16 = ieee80211_get_sn(hdr);
...
// if this mpdu is fragmented - terminate rx aggregation session
    ...
    ieee80211_queue_skb_to_iface(rx.sdata, rx.link_id, core::ptr::null_mut(), skb);
    return;
    }
//
...
//
    ...
    let mut sn: u16 = ieee80211_get_sn(hdr);
...
#[no_mangle]
unsafe extern "C" fn sta_ps_start(sta: *mut sta_info) {
...
#[no_mangle]
unsafe extern "C" fn sta_ps_end(sta: *mut sta_info) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_sta_ps_transition(pubsta: *mut ieee80211_sta, start: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_sta_pspoll(pubsta: *mut ieee80211_sta) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_sta_uapsd_trigger(pubsta: *mut ieee80211_sta, tid: u8) {
...
// count as an dropped frame.
    ...
    let mut tid: u8 = ieee80211_get_tid(hdr);
...
//
    ...
    let mut signal: c_int = status.chain_signal[i];
...
//
    ...
    {
    struct ieee80211_key *key = core::ptr::null_mut();
    int idx2;
...
//
    ...
    struct ieee80211_hdr *hdr = (struct ieee80211_hdr *)skb.data;
    int keyidx;
    let mut result: ieee80211_rx_result = RX_DROP_U_DECRYPT_FAIL;
    struct ieee80211_key *sta_ptk = core::ptr::null_mut();
    struct ieee80211_key *ptk_idx = core::ptr::null_mut();
    let mut mmie_keyidx: c_int = -1;
    __le16 fc;
    if (ieee80211_is_ext(hdr.frame_control))
    return RX_CONTINUE;
//
...
//
// start without a key
    rx.key = core::ptr::null_mut();
    fc = hdr.frame_control;
    if (rx.sta) {
    let mut keyid: c_int = rx.sta.ptk_idx;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_init_frag_cache(cache: *mut ieee80211_fragment_cache) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_destroy_frag_cache(cache: *mut ieee80211_fragment_cache) {
...
#[no_mangle]
unsafe extern "C" fn requires_sequential_pn(rx: *mut ieee80211_rx_data, fc: __le16) -> bool {
...
// This is the first fragment of a new frame.
    ...
    let mut queue: c_int = rx.security_idx;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_802_1x_port_control(rx: *mut ieee80211_rx_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_drop_unencrypted(rx: *mut ieee80211_rx_data, fc: __le16) -> c_int {
...
// Drop unencrypted frames if key is set.
    ...
    let mut fc: __le16 = mgmt.frame_control;
//
// Pass through unencrypted frames if the hardware has
// decrypted them already.
//
...
//
    ...
    struct ieee80211_sub_if_data *sdata = rx.sdata;
    struct ieee80211_hdr *hdr = (struct ieee80211_hdr *)rx.skb.data;
    let mut check_port_control: bool = false;
    struct ethhdr *ehdr;
    int ret;
// port_control = false;
    if (ieee80211_has_a4(hdr.frame_control) &&
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !ether_addr_equal(hdr->addr1, _arg: sdata->vif.addr)) -> else {
...
// port_control = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: check_port_control) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ieee80211_frame_allowed(rx: *mut ieee80211_rx_data, fc: __le16) -> bool {
...
//
    ...
    return ieee80211_is_our_addr(rx.sdata, ehdr.h_dest, core::ptr::null_mut()) ||
    ...
    struct ieee80211_rx_status *status = IEEE80211_SKB_RXCB(skb);
    let mut noencrypt: bool = !(status.flag & RX_FLAG_DECRYPTED);
...
//
    ...
    u8 *data = skb.data;
    let mut len: usize = skb_headlen(skb);
    skb.data -= align;
...
#[no_mangle]
pub unsafe extern "C" fn if(MESH_FLAGS_AE): !(mesh_hdr->flags &) -> else {
    ...
    struct ieee80211_if_mesh *ifmsh = &sdata.u.mesh;
    struct ieee80211_local *local = sdata.local;
    let mut fc: u16 = IEEE80211_FTYPE_DATA | IEEE80211_STYPE_QOS_DATA;
    struct ieee80211_hdr hdr = {
...
#[no_mangle]
pub unsafe extern "C" fn if(MESH_FLAGS_AE_A5_A6: (mesh_hdr->flags & MESH_FLAGS_AE) ==) -> else {
...
// Frame has reached destination.  Don't forward
    ...
    hdrlen = ieee80211_hdrlen(hdr.frame_control);
    if (multicast) {
    let mut extra_head: c_int = sizeof(struct ieee80211_hdr) - sizeof(*eth);
...
// update power mode indication when forwarding
    ieee80211_mps_set_frame_flags(sdata, core::ptr::null_mut(), fwd_hdr);
...
// unable to resolve next hop
    ...
    check_da = core::ptr::null_mut();
    check_sa = core::ptr::null_mut();
...
// verify action & smps_control/chanwidth are present
    ...
    let mut sta_opmode: sta_opmode_info = {};
    if (sdata.vif.type != NL80211_IFTYPE_AP &&
    sdata.vif.type != NL80211_IFTYPE_AP_VLAN)
    goto handled;
...
// if no change do nothing
    ...
    let mut chanwidth: u8 = mgmt.u.action.ht_notify_cw.chanwidth;
...
#[no_mangle]
pub unsafe extern "C" fn if(NL80211_IFTYPE_MESH_POINT: sdata->vif.type ==) -> else {
...
// process only for ibss and mesh
    ...
    kfree_skb_reason(rx.skb, ( u32)res);
    }
...
#[no_mangle]
unsafe extern "C" fn ieee80211_invoke_rx_handlers(rx: *mut ieee80211_rx_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ieee80211_release_reorder_timeout(sta: *mut sta_info, tid: c_int) {
...
// update bitmap
    ...
    let mut index: c_int = (ssn + i) % tid_agg_rx.buf_size;
    tid_agg_rx.reorder_buf_filtered &= ~BIT_ULL(index);
...
// main receive path
#[no_mangle]
pub unsafe extern "C" fn ieee80211_bssid_match(raddr: *const u8, addr: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_accept_frame(rx: *mut ieee80211_rx_data) -> bool {
...
// reject invalid/our STA address
    ...
    &rx.link_id);
    if (!is_broadcast_ether_addr(bssid) &&
    !ieee80211_is_our_addr(sdata, bssid, core::ptr::null_mut())) {
//
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_check_fast_rx(sta: *mut sta_info) {
    ...
    }, *old, *new = core::ptr::null_mut();
    u32 offload_flags;
    let mut set_offload: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_clear_fast_rx(sta: *mut sta_info) {
    void ieee80211_clear_fast_rx(struct sta_info *sta)
    {
    struct ieee80211_fast_rx *old;
    spin_lock_bh(&sta.lock);
    old = rcu_dereference_protected(sta.fast_rx, true);
    RCU_INIT_POINTER(sta.fast_rx, core::ptr::null_mut());
    spin_unlock_bh(&sta.lock);
    if (old)
    kfree_rcu(old, rcu_head);
    }
#[no_mangle]
pub unsafe extern "C" fn __ieee80211_check_fast_rx_iface(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_check_fast_rx_iface(sdata: *mut ieee80211_sub_if_data) {
...
//
    ...
    struct sk_buff *xmit_skb = core::ptr::null_mut();
...
// deliver to local stack
    ...
    struct ieee80211_rx_status *status = IEEE80211_SKB_RXCB(skb);
    ieee80211_rx_result res;
    let mut orig_len: c_int = skb.len;
    let mut hdrlen: c_int = ieee80211_hdrlen(hdr.frame_control);
    let mut snap_offs: c_int = hdrlen;
    struct {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ether_addr_equal(link->conf->addr, _arg: hdr->addr3)) -> else {
...
//
    ...
    let mut link_id: c_int = -1;
    if (ieee80211_is_s1g_beacon(hdr.frame_control)) {
    if (!ieee80211_rx_data_set_sta(rx, core::ptr::null_mut(), -1))
    return false;
...
//
    ...
    {
    struct ieee80211_local *local = hw_to_local(hw);
    struct ieee80211_rate *rate = core::ptr::null_mut();
    struct ieee80211_supported_band *sband;
    struct ieee80211_rx_status *status = IEEE80211_SKB_RXCB(skb);
    struct ieee80211_hdr *hdr = (struct ieee80211_hdr *)skb.data;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_rx_irqsafe(hw: *mut ieee80211_hw, skb: *mut sk_buff) {
