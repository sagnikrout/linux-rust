...
//! Source: net/mac80211/tests/elems.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mle_defrag(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mesh_preq_parse(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mesh_prep_parse(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mesh_perr_parse(test: *mut kunit) {
