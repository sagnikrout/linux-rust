...
//! Source: net/mac80211/tests/mfp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn accept_mfp(test: *mut kunit) {
    ...
    .sta = params.sta ? &sta : core::ptr::null_mut(),
    };
...
// A3/BSSID doesn't matter here
    ...
    let mut reason: __le16 = cpu_to_le16(WLAN_REASON_UNSPECIFIED);
    skb_put_data(rx.skb, &reason, sizeof(reason));
    }
    break;
    }
    KUNIT_EXPECT_EQ(test,
    ( u32)ieee80211_drop_unencrypted_mgmt(&rx),
    ( u32)params.result);
    }
