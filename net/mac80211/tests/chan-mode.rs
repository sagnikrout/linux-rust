...
//! Source: net/mac80211/tests/chan-mode.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_determine_chan_mode(test: *mut kunit) {
...
// EHT Operation
    ...
    let mut ap_chandef: cfg80211_chan_def = {};
...
// To force EHT downgrade to HE on punctured 80 MHz downgraded to 40 MHz
    ...
    core::ptr::null_mut(), 0, &chanreq, &ap_chandef,
    userspace_selectors);
    rcu_read_unlock();
