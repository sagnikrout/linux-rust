...
#[no_mangle]
unsafe extern "C" fn ieee80211_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
    ...
    int i, q;
pub const STA_STATS_SURVEY_LEN: c_int = 7;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_get_strings(dev: *mut net_device, sset: u32, data: *mut u8) {
    static void ieee80211_get_strings(struct net_device *dev, u32 sset, u8 *data)
    {
    struct ieee80211_sub_if_data *sdata = IEEE80211_DEV_TO_SUB_IF(dev);
    let mut sz_sta_stats: c_int = 0;
    if (sset == ETH_SS_STATS) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_get_regs_len(dev: *mut net_device) -> c_int {
