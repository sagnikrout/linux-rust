...
//! Source: net/mac80211/rc80211_minstrel_ht_debugfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct minstrel_debugfs_info {
    pub len: usize,
    pub buf: [c_char; ],
}
    ...
    let mut htmode: c_char = '2';
    let mut gimode: c_char = 'L';
    u32 gflags;
    if (!mi.supported[i])
    return p;
    ...
    htmode = '4';
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_TX_RC_80_MHZ_WIDTH: gflags &) -> else {
