...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_tdls_peer_del_work(wiphy: *mut wiphy, wk: *mut wiphy_work) {
    ...
    let mut vht: bool = sband && sband.vht_cap.vht_supported;
...
// pos++ = (vht && wider_band) ? WLAN_EXT_CAPA8_TDLS_WIDE_BW_ENABLED : 0;
    ...
    u16 spacing)
    {
    let mut subband_cnt: u8 = 0, ch_cnt = 0;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_tdls_add_bss_coex_ie(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_ac_from_wmm(ac: c_int) -> enum ieee80211_ac_numbers {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_wmm_aci_aifsn(aifsn: c_int, acm: bool, aci: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_wmm_ecw(cw_min: u16, cw_max: u16) -> u8 {
...
// IEEE802.11ac-2013 Table E-4
    ...
    let mut uc: cfg80211_chan_def = sta.tdls_chandef;
...
// proceed to downgrade the chandef until usable or the same as AP BW
    ...
    sdata.wdev.iftype)))
    ieee80211_chandef_downgrade(&uc, core::ptr::null_mut());
...
//
    ...
    let mut offset: usize = 0, noffset;
    u8 *pos;
    sband = ieee80211_get_link_sband(link);
...
// build the HE-cap from sband
    ...
    action_code == WLAN_TDLS_SETUP_RESPONSE ||
    action_code == WLAN_PUB_ACTION_TDLS_DISCOVER_RES) {
    ieee80211_put_he_cap(skb, sdata, sband, core::ptr::null_mut());
...
// build the EHT-cap from sband
    ...
    action_code == WLAN_TDLS_SETUP_RESPONSE ||
    action_code == WLAN_PUB_ACTION_TDLS_DISCOVER_RES)
    ieee80211_put_eht_cap(skb, sdata, sband, core::ptr::null_mut());
...
// no special handling
    ...
    peer_capability,
    initiator, extra_ies,
    extra_ies_len, 0, core::ptr::null_mut());
    break;
    default:
    ret = -EOPNOTSUPP;
    break;
...
#[no_mangle]
unsafe extern "C" fn iee80211_tdls_have_ht_peers(sdata: *mut ieee80211_sub_if_data) -> c_int {
...
// flush a potentially queued teardown packet
    ...
    iee80211_tdls_recalc_ht_protection(sdata, core::ptr::null_mut());
    iee80211_tdls_recalc_chanctx(sdata, core::ptr::null_mut());
    if (ret)
    return ret;
    break;
    default:
...
//
    ...
    let mut extra_ies_len: c_int = 2 + sizeof(struct ieee80211_ch_switch_timing);
    u8 *pos = extra_ies;
    struct sk_buff *skb;
    let mut link_id: c_int = sta.sta.valid_links ? ffs(sta.sta.valid_links) - 1 : 0;
//
...
// initial timing are always zero in the template
    ...
    0, 0, !sta.sta.tdls_initiator,
    extra_ies, sizeof(extra_ies), 0, core::ptr::null_mut());
    if (!skb)
    return core::ptr::null_mut();
    skb = ieee80211_build_data_template(sdata, skb, 0);
    if (IS_ERR(skb)) {
...
// ch_sw_tm_ie_offset = tm_ie - skb->data;
    ...
    let mut baselen: c_int = offsetof(typeof(*tf), u.chan_switch_resp.variable);
    let mut params: ieee80211_tdls_ch_sw_params = {};
    int ret;
    lockdep_assert_wiphy(local.hw.wiphy);
...
// validate the initiator is set correctly
    ...
    struct ieee80211_tdls_data *tf = (void *)skb.data;
    struct ieee80211_rx_status *rx_status = IEEE80211_SKB_RXCB(skb);
    let mut baselen: c_int = offsetof(typeof(*tf), u.chan_switch_req.variable);
    let mut params: ieee80211_tdls_ch_sw_params = {};
    let mut ret: c_int = 0;
    lockdep_assert_wiphy(local.hw.wiphy);
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_teardown_tdls_peers(link: *mut ieee80211_link_data) {
