...
pub struct ieee80211_chanctx_user_iter {
    ...
    pub nan_channel_next_idx: c_int,
    pub iftype: enum nl80211_iftype,
    pub done: bool reserved, radar_required,,
    enum {
...
// NAN channels don't reserve channel context
    ...
    continue;
    iter.nan_channel = core::ptr::null_mut();
    iter.link = core::ptr::null_mut();
    iter.iftype = iter.sdata.vif.type;
    iter.chanreq = core::ptr::null_mut();
    iter.per_link = CHANCTX_ITER_POS_ASSIGNED;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_num_chanctx(local: *mut ieee80211_local, radio_idx: c_int) -> c_int {
    ...
    {
    let mut __maybe_unused: *mut ieee80211_local local = link.sdata.local;
    ...
    {
    let mut _a: ieee80211_chan_req = *a, _b = *b;
...
//
    if (!_a.require_npca) {
    _a.oper.npca_chan = core::ptr::null_mut();
    _a.oper.npca_punctured = 0;
    }
    if (!_b.require_npca) {
    _b.oper.npca_chan = core::ptr::null_mut();
...
// tmp = *ret;
    ...
    struct ieee80211_chan_req *tmp)
    {
    return _ieee80211_chanctx_compatible(local, core::ptr::null_mut(), ctx, req, tmp);
    }
    static const struct ieee80211_chan_req *
    ...
    let mut link_id: c_int = link.link_id;
...
//
    ...
    let mut max_bw: enum nl80211_chan_width = NL80211_CHAN_WIDTH_20_NOHT;
    struct sta_info *sta;
...
// downgrade chandef up to max_bw
    ...
    ieee80211_chandef_downgrade(&min_def, core::ptr::null_mut());
...
// check is BW wider
    ...
    struct ieee80211_chanctx *ctx)
    {
    _ieee80211_recalc_chanctx_min_def(local, ctx, core::ptr::null_mut(), false);
    }
    static void
...
// enable NPCA on the link that requested it
    ...
    const struct ieee80211_chan_req *chanreq)
    {
    _ieee80211_change_chanctx(local, ctx, old_ctx, chanreq, core::ptr::null_mut());
    }
...
//
    ...
    __ieee80211_recalc_chanctx_min_def(local, ctx, core::ptr::null_mut(), false);
    return ctx;
    }
...
//
    ...
    const struct ieee80211_chan_req *compat = core::ptr::null_mut();
    struct ieee80211_chanctx_user_iter iter;
    struct ieee80211_chan_req tmp;
    struct sta_info *sta;
    lockdep_assert_wiphy(local.hw.wiphy);
...
// TDLS peers can sometimes affect the chandef width
    ...
    let mut tdls_chanreq: ieee80211_chan_req = {};
    struct ieee80211_link_data *link;
    int tdls_link_id;
    if (!sta.uploaded ||
...
// note this always fills and returns &tmp if compat
    ...
    struct ieee80211_chanctx_conf *conf;
    struct ieee80211_chanctx *curr_ctx = core::ptr::null_mut();
    bool new_idle;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_link_unreserve_chanctx(link: *mut ieee80211_link_data) {
    ...
    if (WARN_ON(!ctx))
    return;
    link.reserved_chanctx = core::ptr::null_mut();
    ...
    ctx.replace_ctx.replace_ctx = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ieee80211_chsw_switch_ctxs(local: *mut ieee80211_local) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_vif_use_reserved_switch(local: *mut ieee80211_local) -> c_int {
    static int ieee80211_vif_use_reserved_switch(struct ieee80211_local *local)
    {
    struct ieee80211_chanctx *ctx, *ctx_tmp, *old_ctx;
    int err, n_assigned, n_reserved, n_ready;
    let mut n_ctx: c_int = 0, n_vifs_switch = 0, n_vifs_assign = 0, n_vifs_ctxless = 0;
    lockdep_assert_wiphy(local.hw.wiphy);
//
...
// update station rate control and min width before switch
    ...
    _ieee80211_recalc_chanctx_min_def(local, ctx, core::ptr::null_mut(), true);
    }
//
...
//
    ...
    continue;
    iter.link.reserved_chanctx = core::ptr::null_mut();
...
//
    ...
    struct ieee80211_chanctx_conf *conf;
    struct ieee80211_chanctx *ctx;
    let mut use_reserved_switch: bool = false;
    lockdep_assert_wiphy(local.hw.wiphy);
    conf = rcu_dereference_protected(link_conf.chanctx_conf,
    lockdep_is_held(&local.hw.wiphy.mtx));
    if (!conf)
    ...
    ieee80211_assign_link_chanctx(link, core::ptr::null_mut(), false);
...
// reused_ctx = false;
    ...
    void *filter_data)
    {
    let mut ctx: return = = filter_data;
    }
    static int
...
// Find an evacuation candidate...
    evac_chan = ieee80211_nan_find_evac_chan(local, nan_sdata, core::ptr::null_mut());
...
// That shouldn't happen, we checked before!
    ...
    struct ieee80211_local *local = sdata.local;
    struct ieee80211_chanctx *ctx;
    let mut radar_detect_width: u8 = 0;
    let mut reused_ctx: bool = false;
    int ret;
    lockdep_assert_wiphy(local.hw.wiphy);
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_link_use_reserved_context(link: *mut ieee80211_link_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_link_release_channel(link: *mut ieee80211_link_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_link_vlan_copy_chanctx(link: *mut ieee80211_link_data) {
