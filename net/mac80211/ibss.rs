...
pub const IEEE80211_IBSS_MAX_STA_ENTRIES: c_int = 128;
    ...
    let mut rates_n: c_int = 0, i, ri;
    struct ieee80211_mgmt *mgmt;
    u8 *pos;
    struct ieee80211_supported_band *sband;
    let mut rates: u32 = 0, rates_added = 0;
...
// pos++ = min_t(int, 8, rates_n);
    ...
    let mut rate: c_int = DIV_ROUND_UP(sband.bitrates[ri].bitrate, 5);
    let mut basic: u8 = 0;
    if (!(rates & BIT(ri)))
    continue;
...
// add VHT capability and information IEs
    ...
    struct beacon_data *presp;
    let mut bss_meta: cfg80211_inform_bss = {};
    bool have_higher_than_11mbit;
    bool radar_required;
    int err;
...
// if merging, indicate to driver that we leave the old IBSS
    ...
    RCU_INIT_POINTER(ifibss.presp, core::ptr::null_mut());
    if (presp)
...
// check again for downgraded chandef
    ...
    &have_higher_than_11mbit, core::ptr::null_mut());
    if (!presp)
    return;
...
// cf. IEEE 802.11 9.2.12
    ...
    u32 basic_rates;
    int i, j;
    let mut beacon_int: u16 = cbss.beacon_interval;
...
// fall back to 20 MHz for unsupported modes
    ...
    let mut rate: c_int = bss.supp_rates[i] & 0x7f;
    let mut is_basic: bool = !!(bss.supp_rates[i] & 0x80);
    ...
    struct cfg80211_bss *cbss;
    const struct cfg80211_bss_ies *ies;
    let mut capability: u16 = WLAN_CAPABILITY_IBSS;
    u64 tsf;
    lockdep_assert_wiphy(sdata.local.hw.wiphy);
    if (ifibss.privacy)
    ...
    core::ptr::null_mut(), csa_settings);
    if (!presp)
    return -ENOMEM;
    rcu_assign_pointer(ifibss.presp, presp);
    if (old_presp)
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ibss_finish_csa(sdata: *mut ieee80211_sub_if_data, changed: *mut u64) -> c_int {
...
// generate the beacon
    return ieee80211_ibss_csa_beacon(sdata, core::ptr::null_mut(), changed);
    }
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ibss_stop(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_sta_active_ibss(sdata: *mut ieee80211_sub_if_data) -> c_int {
    ...
    let mut last_active: c_ulong = ieee80211_sta_last_active(sta, -1);
    if (sta.sdata == sdata &&
...
#[no_mangle]
unsafe extern "C" fn ieee80211_ibss_disconnect(sdata: *mut ieee80211_sub_if_data) {
...
// remove beacon
    presp = sdata_dereference(ifibss.presp, sdata);
    RCU_INIT_POINTER(sdata.u.ibss.presp, core::ptr::null_mut());
    if (presp)
    kfree_rcu(presp, rcu_head);
...
#[no_mangle]
unsafe extern "C" fn ieee80211_ibss_csa_mark_radar(sdata: *mut ieee80211_sub_if_data) {
...
//
    ieee80211_send_auth(sdata, 2, WLAN_AUTH_OPEN, 0, core::ptr::null_mut(), 0,
    mgmt.sa, sdata.u.ibss.bssid, core::ptr::null_mut(), 0, 0, 0);
    }
    ...
    {
    struct sta_info *sta;
    let mut band: enum nl80211_band = rx_status.band;
    struct ieee80211_local *local = sdata.local;
    struct ieee80211_supported_band *sband;
    let mut rates_updated: bool = false;
    let mut supp_rates: u32 = 0;
...
// we both use HT
    ...
    struct cfg80211_chan_def chandef;
    let mut bw: enum ieee80211_sta_rx_bandwidth = sta.sta.deflink.bandwidth;
...
// we both use VHT
    ...
    let mut cap: ieee80211_sta_vht_cap = sta.sta.deflink.vht_cap;
    u32 vht_cap_info =
    ...
    let mut rx_nss: u8 = sta.sta.deflink.rx_nss;
    ieee80211_sta_init_nss_bw_capa(&sta.deflink,
    &sdata.deflink.conf.chanreq.oper);
    rate_control_rate_init(&sta.deflink);
...
//
    ...
    supp_rates = ieee80211_sta_get_rates(sdata, elems, band, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ieee80211_ibss_sta_expire(sdata: *mut ieee80211_sub_if_data) {
    static void ieee80211_ibss_sta_expire(struct ieee80211_sub_if_data *sdata)
    {
    struct ieee80211_if_ibss *ifibss = &sdata.u.ibss;
    struct ieee80211_local *local = sdata.local;
    struct sta_info *sta, *tmp;
    let mut exp_time: c_ulong = IEEE80211_IBSS_INACTIVITY_LIMIT;
    let mut exp_rsn: c_ulong = IEEE80211_IBSS_RSN_INACTIVITY_LIMIT;
    lockdep_assert_wiphy(local.hw.wiphy);
...
//
#[no_mangle]
unsafe extern "C" fn ieee80211_sta_merge_ibss(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_sta_create_ibss(sdata: *mut ieee80211_sub_if_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ieee80211_sta_find_ibss(sdata: *mut ieee80211_sub_if_data) {
    ...
    struct cfg80211_bss *cbss;
    struct ieee80211_channel *chan = core::ptr::null_mut();
    const u8 *bssid = core::ptr::null_mut();
    int active_ibss;
    lockdep_assert_wiphy(sdata.local.hw.wiphy);
...
// Selected IBSS not found in current scan results - try to scan
    ...
    ieee80211_request_ibss_scan(sdata, ifibss.ssid,
    ifibss.ssid_len, core::ptr::null_mut(), 0);
    }
    } else {
    let mut interval: c_int = IEEE80211_SCAN_INTERVAL;
...
//
    ...
    len - baselen, type, core::ptr::null_mut());
    if (elems) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ibss_work(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_ibss_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ibss_setup_sdata(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ibss_notify_scan_completed(local: *mut ieee80211_local) {
    ...
    struct ieee80211_local *local = sdata.local;
    let mut radar_detect_width: c_int = 0;
    int ret;
    lockdep_assert_wiphy(local.hw.wiphy);
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ibss_leave(sdata: *mut ieee80211_sub_if_data) -> c_int {
...
// remove beacon
    ...
    sdata.u.ibss.ie = core::ptr::null_mut();
