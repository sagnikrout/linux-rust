...
//
    ...
    {
    let mut len: c_int = IEEE80211_MIN_ACTION_SIZE(eml_omn);
...
// Copy optional fields from the received notification frame
    ...
    {
    let mut len: c_int = IEEE80211_MIN_ACTION_SIZE(eml_omn);
    let mut type: enum nl80211_iftype = ieee80211_vif_type_p2p(&sdata.vif);
    struct ieee80211_rx_status *status = IEEE80211_SKB_RXCB(skb);
    const struct wiphy_iftype_ext_capab *ift_ext_capa;
    struct ieee80211_mgmt *mgmt = (void *)skb.data;
    struct ieee80211_local *local = sdata.local;
    let mut control: u8 = mgmt.u.action.eml_omn.control;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_uhr_disable_dbe_all_stas(link: *mut ieee80211_link_data) {
