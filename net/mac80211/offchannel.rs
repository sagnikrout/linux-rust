...
//! Source: net/mac80211/offchannel.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ieee80211_offchannel_ps_enable(sdata: *mut ieee80211_sub_if_data) {
    static void ieee80211_offchannel_ps_enable(struct ieee80211_sub_if_data *sdata)
    {
    struct ieee80211_local *local = sdata.local;
    struct ieee80211_if_managed *ifmgd = &sdata.u.mgd;
    let mut offchannel_ps_enabled: bool = false;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_offchannel_ps_disable(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: local->hw.conf.dynamic_ps_timeout >) -> else {
//
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_offchannel_stop_vifs(local: *mut ieee80211_local) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_offchannel_return(local: *mut ieee80211_local) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_roc_notify_destroy(roc: *mut ieee80211_roc_work) {
...
// was never transmitted
    ...
    let mut remaining_dur_min: c_long = LONG_MAX;
    lockdep_assert_wiphy(local.hw.wiphy);
...
//
    ...
    unsigned long now)
    {
    let mut dur: c_long = ieee80211_end_finished_rocs(local, now);
    if (dur == LONG_MAX)
    return false;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_hw_roc_start(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_ready_on_channel(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn _ieee80211_start_next_roc(local: *mut ieee80211_local) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_start_next_roc(local: *mut ieee80211_local) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_reconfig_roc(local: *mut ieee80211_local) {
...
#[no_mangle]
unsafe extern "C" fn __ieee80211_roc_work(local: *mut ieee80211_local) {
...
// careful - roc pointer became invalid during recalc
    if (!on_channel) {
    ieee80211_flush_queues(local, core::ptr::null_mut(), false);
    local.tmp_channel = core::ptr::null_mut();
    ieee80211_hw_conf_chan(local);
...
#[no_mangle]
unsafe extern "C" fn ieee80211_roc_work(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_hw_roc_done(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_remain_on_channel_expired(hw: *mut ieee80211_hw) {
...
//
    ...
    {
    struct ieee80211_roc_work *roc, *tmp;
    let mut queued: bool = false, combine_started = true;
...
//
    let mut now: c_ulong = jiffies;
    let mut elapsed: u32 = jiffies_to_msecs(now - tmp.start_time);
    struct wiphy *wiphy = local.hw.wiphy;
    let mut max_roc: u32 = wiphy.max_remain_on_channel_duration;
...
//
    ...
    duration, &cookie, core::ptr::null_mut(),
    IEEE80211_ROC_TYPE_NORMAL);
    }
    static int ieee80211_cancel_roc(struct ieee80211_local *local,
    u64 cookie, bool mgmt_tx)
    {
    struct ieee80211_roc_work *roc, *tmp, *found = core::ptr::null_mut();
    int ret;
    lockdep_assert_wiphy(local.hw.wiphy);
    if (!cookie)
    return -ENOENT;
    ...
    continue;
#[no_mangle]
pub unsafe extern "C" fn if(cookie: mgmt_tx && roc->mgmt_tx_cookie !=) -> else {
...
// go through work struct to return to the operating channel
    ...
    let mut need_offchan: bool = false;
    let mut mlo_sta: bool = false;
...
//
    ...
    chanctx_conf = core::ptr::null_mut();
    }
    if (chanctx_conf) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_roc_setup(local: *mut ieee80211_local) {
