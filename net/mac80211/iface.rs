...
#[no_mangle]
pub unsafe extern "C" fn __ieee80211_recalc_txpower(link: *mut ieee80211_link_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __ieee80211_idle_off(local: *mut ieee80211_local) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __ieee80211_idle_on(local: *mut ieee80211_local) -> u32 {
    ...
    let mut led_trig_start: c_uint = 0, led_trig_stop = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_idle_off(local: *mut ieee80211_local) -> u32 {
    u32 ieee80211_idle_off(struct ieee80211_local *local)
    {
    return __ieee80211_recalc_idle(local, true);
    }
#[no_mangle]
pub unsafe extern "C" fn ieee80211_recalc_idle(local: *mut ieee80211_local) {
    void ieee80211_recalc_idle(struct ieee80211_local *local)
    {
    let mut change: u32 = __ieee80211_recalc_idle(local, false);
    if (change)
...
#[no_mangle]
unsafe extern "C" fn ieee80211_can_powered_addr_change(sdata: *mut ieee80211_sub_if_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_change_mac(dev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn identical_mac_addr_allowed(type1: c_int, type2: c_int) -> c_int {
...
//
    ...
    return ieee80211_check_combinations(sdata, core::ptr::null_mut(), 0, 0, -1);
    }
    static int ieee80211_check_queues(struct ieee80211_sub_if_data *sdata,
    enum nl80211_iftype iftype)
    {
    let mut n_queues: c_int = sdata.local.hw.queues;
    int i;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_do_stop(sdata: *mut ieee80211_sub_if_data, going_down: bool) {
...
// remove all packets in parent bc_buf pointing to this dev
    ...
    RCU_INIT_POINTER(sdata.vif.bss_conf.chanctx_conf, core::ptr::null_mut());
...
//
    ...
    RCU_INIT_POINTER(sdata.u.nan_data.nmi, core::ptr::null_mut());
    fallthrough;
    default:
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_stop_mbssid(sdata: *mut ieee80211_sub_if_data) {
...
//
    ...
    if (!tx_link)
    continue;
    RCU_INIT_POINTER(tx_link.conf.tx_bss_conf, core::ptr::null_mut());
    }
...
//
    ...
    continue;
    RCU_INIT_POINTER(link.conf.tx_bss_conf, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ieee80211_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_set_multicast_list(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ieee80211_teardown_sdata(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_uninit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_iftype_supports_hdr_offload(iftype: enum nl80211_iftype) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_set_sdata_offload_flags(sdata: *mut ieee80211_sub_if_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_set_vif_encap_ops(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_recalc_sdata_offload(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_recalc_offload(local: *mut ieee80211_local) {
    ...
    {
    struct ieee80211_local *local = sdata.local;
    let mut flags: u32 = sdata.u.mntr.flags;
...
#[no_mangle]
unsafe extern "C" fn ieee80211_set_default_queues(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_NUM_ACS: local->hw.queues >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_del_virtual_monitor(local: *mut ieee80211_local) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ieee80211_do_open(wdev: *mut wireless_dev, coming_up: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hw_reconf_flags) -> else {
...
#[no_mangle]
unsafe extern "C" fn ieee80211_if_setup(dev: *mut net_device) {
...
//
    sta = sta_info_get_bss(sdata, mgmt.sa);
    if (sta) {
    let mut tid: u16 = ieee80211_get_tid(hdr);
...
#[no_mangle]
unsafe extern "C" fn ieee80211_iface_work(wiphy: *mut wiphy, work: *mut wiphy_work) {
    static void ieee80211_iface_work(struct wiphy *wiphy, struct wiphy_work *work)
    {
    struct ieee80211_sub_if_data *sdata =
...
// need to do this after the switch so vif.type is correct
    ...
    struct ieee80211_local *local = sdata.local;
    int ret, err;
    let mut internal_type: enum nl80211_iftype = type;
    let mut p2p: bool = false;
    ASSERT_RTNL();
...
//
    ...
    ieee80211_txq_init(sdata, core::ptr::null_mut(), txqi,
    IEEE80211_NUM_TIDS);
    }
    } else {
    int size = ALIGN(sizeof(*sdata) + local.hw.vif_data_size,
...
// don't use IEEE80211_DEV_TO_SUB_IF -- it checks too much
    ...
    ieee80211_txq_init(sdata, core::ptr::null_mut(), txqi, 0);
    }
    sdata.dev = ndev;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_if_remove(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_sdata_stop(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_remove_interfaces(local: *mut ieee80211_local) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_iface_init() -> c_int {
    int ieee80211_iface_init(void)
    {
    return register_netdevice_notifier(&mac80211_netdev_notifier);
    }
#[no_mangle]
pub unsafe extern "C" fn ieee80211_iface_exit() {
    void ieee80211_iface_exit(void)
    {
    unregister_netdevice_notifier(&mac80211_netdev_notifier);
    }
#[no_mangle]
pub unsafe extern "C" fn ieee80211_vif_inc_num_mcast(sdata: *mut ieee80211_sub_if_data) {
    void ieee80211_vif_inc_num_mcast(struct ieee80211_sub_if_data *sdata)
    {
    if (sdata.vif.type == NL80211_IFTYPE_AP)
    atomic_inc(&sdata.u.ap.num_mcast_sta);
#[no_mangle]
pub unsafe extern "C" fn if(NL80211_IFTYPE_AP_VLAN: sdata->vif.type ==) -> else {
    else if (sdata.vif.type == NL80211_IFTYPE_AP_VLAN)
    atomic_inc(&sdata.u.vlan.num_mcast_sta);
    }
#[no_mangle]
pub unsafe extern "C" fn ieee80211_vif_dec_num_mcast(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_vif_block_queues_csa(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee80211_vif_unblock_queues_csa(sdata: *mut ieee80211_sub_if_data) {
