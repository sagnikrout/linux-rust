...
//! Source: net/mac80211/mesh_pathtbl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mesh_table_hash(addr: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __mesh_fast_tx_entry_free(ptr: *mut c_void, tblptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mesh_fast_tx_deinit(sdata: *mut ieee80211_sub_if_data) {
    static void mesh_fast_tx_deinit(struct ieee80211_sub_if_data *sdata)
    {
    struct mesh_tx_cache *cache;
    cache = &sdata.u.mesh.tx_cache;
    rhashtable_free_and_destroy(&cache.rht,
    __mesh_fast_tx_entry_free, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn mesh_fast_tx_init(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn mpath_expired(mpath: *mut mesh_path) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mesh_path_rht_free(ptr: *mut c_void, tblptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mesh_table_init(tbl: *mut mesh_table) {
...
#[no_mangle]
unsafe extern "C" fn mesh_table_free(tbl: *mut mesh_table) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_add_gate(mpath: *mut mesh_path) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mesh_gate_del(tbl: *mut mesh_table, mpath: *mut mesh_path) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_gate_num(sdata: *mut ieee80211_sub_if_data) -> c_int {
    ...
    mesh_path_refresh(sdata, entry.mpath, core::ptr::null_mut());
    if (entry.mppath)
    ...
    let mut build: ieee80211_mesh_fast_tx = {};
...
#[no_mangle]
pub unsafe extern "C" fn mesh_fast_tx_gc(sdata: *mut ieee80211_sub_if_data) {
    void mesh_fast_tx_gc(struct ieee80211_sub_if_data *sdata)
    {
    let mut timeout: c_ulong = msecs_to_jiffies(MESH_FAST_TX_CACHE_TIMEOUT);
...
#[no_mangle]
pub unsafe extern "C" fn mesh_fast_tx_flush_mpath(mpath: *mut mesh_path) {
    ...
    {
    struct mesh_tx_cache *cache = &sdata.u.mesh.tx_cache;
    let mut key: ieee80211_mesh_fast_tx_key = {};
    struct ieee80211_mesh_fast_tx *entry;
    int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_plink_broken(sta: *mut sta_info) {
...
#[no_mangle]
unsafe extern "C" fn __mesh_path_del(tbl: *mut mesh_table, mpath: *mut mesh_path) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_flush_by_nexthop(sta: *mut sta_info) {
...
#[no_mangle]
unsafe extern "C" fn table_flush_by_iface(tbl: *mut mesh_table) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_flush_by_iface(sdata: *mut ieee80211_sub_if_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_del(sdata: *mut ieee80211_sub_if_data, addr: *const u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_tx_pending(mpath: *mut mesh_path) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_send_to_gates(mpath: *mut mesh_path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_flush_pending(mpath: *mut mesh_path) {
    ...
    struct sk_buff *skb;
    while ((skb = skb_dequeue(&mpath.frame_queue)) != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn mesh_path_fix_nexthop(mpath: *mut mesh_path, next_hop: *mut sta_info) {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_pathtbl_init(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_path_expire(sdata: *mut ieee80211_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn mesh_pathtbl_unregister(sdata: *mut ieee80211_sub_if_data) {
