...
#[no_mangle]
pub unsafe extern "C" fn tls_strp_abort_strp(strp: *mut tls_strparser, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tls_strp_anchor_free(strp: *mut tls_strparser) {
    static void tls_strp_anchor_free(struct tls_strparser *strp)
    {
    struct skb_shared_info *shinfo = skb_shinfo(strp.anchor);
    DEBUG_NET_WARN_ON_ONCE(atomic_read(&shinfo.dataref) != 1);
    if (!strp.copy_mode)
    shinfo.frag_list = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn tls_strp_msg_cow(ctx: *mut tls_sw_context_rx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tls_strp_msg_hold(strp: *mut tls_strparser, dst: *mut sk_buff_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tls_strp_flush_anchor_copy(strp: *mut tls_strparser) {
    ...
    size_t in_len)
    {
    let mut nfrag: c_uint = skb.len / PAGE_SIZE;
    size_t len, chunk;
    skb_frag_t *frag;
    int sz;
...
#[no_mangle]
unsafe extern "C" fn tls_strp_read_copyin(strp: *mut tls_strparser) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tls_strp_read_copy(strp: *mut tls_strparser, qshort: bool) -> c_int {
...
// If we don't know the length go max plus page for cipher overhead
    ...
    unsigned int len)
    {
    let mut remaining: c_uint = strp.stm.offset + len;
...
#[no_mangle]
unsafe extern "C" fn tls_strp_load_anchor_with_queue(strp: *mut tls_strparser, len: c_int) {
...
// Bestow the state onto the anchor
    ...
    strp.anchor.destructor = core::ptr::null_mut();
    strp.stm.offset = offset;
    }
#[no_mangle]
pub unsafe extern "C" fn tls_strp_msg_load(strp: *mut tls_strparser, force_refresh: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tls_strp_read_sock(strp: *mut tls_strparser) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tls_strp_check_rcv(strp: *mut tls_strparser, announce: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(strp->msg_ready: announce &&) -> else {
    else if (announce && strp.msg_ready)
    tls_rx_msg_maybe_announce(strp);
    }
// Lower sock lock held
#[no_mangle]
pub unsafe extern "C" fn tls_strp_data_ready(strp: *mut tls_strparser) {
...
#[no_mangle]
unsafe extern "C" fn tls_strp_work(w: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tls_strp_msg_consume(strp: *mut tls_strparser) {
...
#[no_mangle]
pub unsafe extern "C" fn tls_strp_stop(strp: *mut tls_strparser) {
    void tls_strp_stop(struct tls_strparser *strp)
    {
    strp.stopped = 1;
    }
#[no_mangle]
pub unsafe extern "C" fn tls_strp_init(strp: *mut tls_strparser, sk: *mut sock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tls_strp_done(strp: *mut tls_strparser) {
...
#[no_mangle]
pub unsafe extern "C" fn __tls_strp_done(strp: *mut tls_strparser) {
    void __tls_strp_done(struct tls_strparser *strp)
    {
    tls_strp_anchor_free(strp);
    }
#[no_mangle]
pub unsafe extern "C" fn tls_strp_dev_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn tls_strp_dev_exit() {
