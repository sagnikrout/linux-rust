...
pub const OSD_OPREPLY_FRONT_LEN: c_int = 512;
...
#[no_mangle]
pub unsafe extern "C" fn rwsem_is_wrlocked(sem: *mut rw_semaphore) -> bool {
    static inline bool rwsem_is_wrlocked(struct rw_semaphore *sem)
    {
    let mut wrlocked: bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn verify_osdc_locked(osdc: *mut ceph_osd_client) {
    static inline void verify_osdc_locked(struct ceph_osd_client *osdc)
    {
    WARN_ON(!rwsem_is_locked(&osdc.lock));
    }
#[no_mangle]
pub unsafe extern "C" fn verify_osdc_wrlocked(osdc: *mut ceph_osd_client) {
    static inline void verify_osdc_wrlocked(struct ceph_osd_client *osdc)
    {
    WARN_ON(!rwsem_is_wrlocked(&osdc.lock));
    }
#[no_mangle]
pub unsafe extern "C" fn verify_osd_locked(osd: *mut ceph_osd) {
...
#[no_mangle]
pub unsafe extern "C" fn verify_lreq_locked(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn ceph_osd_data_init(osd_data: *mut ceph_osd_data) {
...
#[no_mangle]
unsafe extern "C" fn ceph_osd_data_length(osd_data: *mut ceph_osd_data) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ceph_osd_data_release(osd_data: *mut ceph_osd_data) {
...
//
#[no_mangle]
unsafe extern "C" fn target_init(t: *mut ceph_osd_request_target) {
...
#[no_mangle]
unsafe extern "C" fn target_destroy(t: *mut ceph_osd_request_target) {
...
//
#[no_mangle]
unsafe extern "C" fn request_release_checks(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn ceph_osdc_release_request(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CEPH_OSD_SLAB_OPS: req->r_num_ops <=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_get_request(req: *mut ceph_osd_request) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_put_request(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn request_init(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn ceph_oloc_encoding_size(oloc: *const ceph_object_locator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd_req_opcode_valid(opcode: u16) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_alloc_messages(req: *mut ceph_osd_request, gfp: gfp_t) -> c_int {
...
//
    ...
    struct ceph_osd_data *osd_data)
    {
    let mut length: u64 = ceph_osd_data_length(osd_data);
...
//
    ...
    {
    struct ceph_osd_request *req;
    let mut objnum: u64 = 0;
    let mut objoff: u64 = 0;
    let mut objlen: u64 = 0;
    int r;
    BUG_ON(opcode != CEPH_OSD_OP_READ && opcode != CEPH_OSD_OP_WRITE &&
...
// calculate max write size
    ...
    let mut object_size: u32 = layout.object_size;
    let mut object_base: u32 = off - objoff;
...
#[no_mangle]
pub unsafe extern "C" fn __ceph_alloc_sparse_ext_map(op: *mut ceph_osd_req_op, cnt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd_homeless(osd: *mut ceph_osd) -> bool {
    static bool osd_homeless(struct ceph_osd *osd)
    {
    return osd.o_osd == CEPH_HOMELESS_OSD;
    }
#[no_mangle]
unsafe extern "C" fn osd_registered(osd: *mut ceph_osd) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn osd_init(osd: *mut ceph_osd) {
...
#[no_mangle]
unsafe extern "C" fn ceph_init_sparse_read(sr: *mut ceph_sparse_read) {
...
#[no_mangle]
unsafe extern "C" fn osd_cleanup(osd: *mut ceph_osd) {
...
#[no_mangle]
unsafe extern "C" fn put_osd(osd: *mut ceph_osd) {
...
#[no_mangle]
unsafe extern "C" fn __move_osd_to_lru(osd: *mut ceph_osd) {
...
#[no_mangle]
unsafe extern "C" fn maybe_move_osd_to_lru(osd: *mut ceph_osd) {
...
#[no_mangle]
unsafe extern "C" fn __remove_osd_from_lru(osd: *mut ceph_osd) {
...
//
#[no_mangle]
unsafe extern "C" fn close_osd(osd: *mut ceph_osd) {
...
//
#[no_mangle]
unsafe extern "C" fn reopen_osd(osd: *mut ceph_osd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn link_request(osd: *mut ceph_osd, req: *mut ceph_osd_request) {
    static void link_request(struct ceph_osd *osd, struct ceph_osd_request *req)
    {
...
#[no_mangle]
unsafe extern "C" fn unlink_request(osd: *mut ceph_osd, req: *mut ceph_osd_request) {
    static void unlink_request(struct ceph_osd *osd, struct ceph_osd_request *req)
    {
    verify_osd_locked(osd);
...
#[no_mangle]
unsafe extern "C" fn __pool_full(pi: *mut ceph_pg_pool_info) -> bool {
    static bool __pool_full(struct ceph_pg_pool_info *pi)
    {
    return pi.flags & CEPH_POOL_FLAG_FULL;
    }
#[no_mangle]
unsafe extern "C" fn have_pool_full(osdc: *mut ceph_osd_client) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pool_full(osdc: *mut ceph_osd_client, pool_id: i64) -> bool {
...
//
    ...
    struct ceph_pg_pool_info *pi)
    {
    let mut pauserd: bool = ceph_osdmap_flag(osdc, CEPH_OSDMAP_PAUSERD);
...
#[no_mangle]
unsafe extern "C" fn pick_random_replica(acting: *const ceph_osds) -> c_int {
    static int pick_random_replica(const struct ceph_osds *acting)
    {
    let mut i: c_int = get_random_u32_below(acting.size);
...
//
    ...
    let mut is_read: bool = t.flags & CEPH_OSD_FLAG_READ;
    let mut is_write: bool = t.flags & CEPH_OSD_FLAG_WRITE;
    let mut force_resend: bool = false;
    let mut unpaused: bool = false;
    let mut legacy_change: bool = false;
    let mut split: bool = false;
    let mut sort_bitwise: bool = ceph_osdmap_flag(osdc, CEPH_OSDMAP_SORTBITWISE);
...
#[no_mangle]
unsafe extern "C" fn free_spg_mapping(spg: *mut ceph_spg_mapping) {
...
#[no_mangle]
unsafe extern "C" fn hoid_get_bitwise_key(hoid: *const ceph_hobject_id) -> u64 {
...
// pkey_len = hoid->oid_len;
    ...
    ret = -1;
#[no_mangle]
pub unsafe extern "C" fn if(name2_len: name1_len >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn decode_hoid(p: *mut c_void, end: *mut c_void, hoid: *mut ceph_hobject_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hoid_encoding_size(hoid: *const ceph_hobject_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn encode_hoid(p: *mut c_void, end: *mut c_void, hoid: *const ceph_hobject_id) {
...
#[no_mangle]
unsafe extern "C" fn free_hoid(hoid: *mut ceph_hobject_id) {
...
#[no_mangle]
unsafe extern "C" fn free_backoff(backoff: *mut ceph_osd_backoff) {
...
#[no_mangle]
unsafe extern "C" fn clear_backoffs(osd: *mut ceph_osd) {
    static void clear_backoffs(struct ceph_osd *osd)
    {
...
#[no_mangle]
unsafe extern "C" fn should_plug_request(req: *mut ceph_osd_request) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn setup_request_data(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn encode_pgid(p: *mut c_void, pgid: *const ceph_pg) {
...
#[no_mangle]
unsafe extern "C" fn encode_spgid(p: *mut c_void, spgid: *const ceph_spg) {
    ...
    let mut end: *mut void const = p + msg.front_alloc_len;
...
#[no_mangle]
unsafe extern "C" fn encode_request_finish(msg: *mut ceph_msg) {
    static void encode_request_finish(struct ceph_msg *msg)
    {
    void *p = msg.front.iov_base;
    let mut partial_end: *mut void const = p + msg.front.iov_len;
    let mut end: *mut void const = p + msg.front_alloc_len;
...
//
#[no_mangle]
unsafe extern "C" fn send_request(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn maybe_request_map(osdc: *mut ceph_osd_client) {
...
#[no_mangle]
unsafe extern "C" fn __submit_request(req: *mut ceph_osd_request, wrlocked: bool) {
...
#[no_mangle]
unsafe extern "C" fn account_request(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn submit_request(req: *mut ceph_osd_request, wrlocked: bool) {
...
#[no_mangle]
unsafe extern "C" fn finish_request(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn __complete_request(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn complete_request_workfn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn complete_request(req: *mut ceph_osd_request, err: c_int) {
    static void complete_request(struct ceph_osd_request *req, int err)
    {
...
#[no_mangle]
unsafe extern "C" fn cancel_map_check(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn cancel_request(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn abort_request(req: *mut ceph_osd_request, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn abort_fn(req: *mut ceph_osd_request, arg: *mut c_void) -> c_int {
    static int abort_fn(struct ceph_osd_request *req, void *arg)
    {
    let mut err: c_int = *(int *)arg;
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_abort_requests(osdc: *mut ceph_osd_client, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_clear_abort_err(osdc: *mut ceph_osd_client) {
...
#[no_mangle]
unsafe extern "C" fn update_epoch_barrier(osdc: *mut ceph_osd_client, eb: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_update_epoch_barrier(osdc: *mut ceph_osd_client, eb: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn abort_on_full_fn(req: *mut ceph_osd_request, arg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceph_osdc_abort_on_full(osdc: *mut ceph_osd_client) {
    static void ceph_osdc_abort_on_full(struct ceph_osd_client *osdc)
    {
    let mut victims: bool = false;
    if (ceph_test_opt(osdc.client, ABORT_ON_FULL) &&
    (ceph_osdmap_flag(osdc, CEPH_OSDMAP_FULL) || have_pool_full(osdc)))
    for_each_request(osdc, abort_on_full_fn, &victims);
    }
#[no_mangle]
unsafe extern "C" fn check_pool_dne(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn send_map_check(req: *mut ceph_osd_request) {
    static void send_map_check(struct ceph_osd_request *req)
    {
    struct ceph_osd_client *osdc = req.r_osdc;
    struct ceph_osd_request *lookup_req;
...
//
#[no_mangle]
unsafe extern "C" fn linger_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn linger_put(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn __linger_registered(lreq: *mut ceph_osd_linger_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn linger_registered(lreq: *mut ceph_osd_linger_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn linger_register(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn linger_unregister(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn cancel_linger_request(req: *mut ceph_osd_request) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct linger_work {
    pub work: work_struct,
    pub lreq: *mut ceph_osd_linger_request,
    pub pending_item: list_head,
    pub queued_stamp: c_ulong,
    union {
    struct {
    pub notify_id: u64,
    pub notifier_id: u64,
    pub /: *mut *mut *mut void payload; / points into @msg front,
    pub payload_len: usize,
    pub /: *mut *mut *mut ceph_msg msg; / for ceph_msg_put(),
    pub notify: },
    struct {
    pub err: c_int,
    pub error: },
...
#[no_mangle]
unsafe extern "C" fn lwork_free(lwork: *mut linger_work) {
...
#[no_mangle]
unsafe extern "C" fn lwork_queue(lwork: *mut linger_work) {
...
#[no_mangle]
unsafe extern "C" fn do_watch_notify(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn do_watch_error(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn queue_watch_error(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn linger_commit_cb(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn normalize_watch_error(err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn linger_reconnect_cb(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn send_linger(lreq: *mut ceph_osd_linger_request) {
    ...
    req = ceph_osdc_alloc_request(osdc, core::ptr::null_mut(), 1, true, GFP_NOIO);
    BUG_ON(!req);
...
#[no_mangle]
unsafe extern "C" fn linger_ping_cb(req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn send_linger_ping(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn linger_submit(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn cancel_linger_map_check(lreq: *mut ceph_osd_linger_request) {
...
//
#[no_mangle]
unsafe extern "C" fn __linger_cancel(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn linger_cancel(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn check_linger_pool_dne(lreq: *mut ceph_osd_linger_request) {
...
#[no_mangle]
unsafe extern "C" fn linger_map_check_cb(greq: *mut ceph_mon_generic_request) {
    static void linger_map_check_cb(struct ceph_mon_generic_request *greq)
    {
    struct ceph_osd_client *osdc = &greq.monc.client.osdc;
    struct ceph_osd_linger_request *lreq;
    let mut linger_id: u64 = greq.private_data;
    WARN_ON(greq.result || !greq.u.newest);
    down_write(&osdc.lock);
...
#[no_mangle]
unsafe extern "C" fn send_linger_map_check(lreq: *mut ceph_osd_linger_request) {
    static void send_linger_map_check(struct ceph_osd_linger_request *lreq)
    {
    struct ceph_osd_client *osdc = lreq.osdc;
    struct ceph_osd_linger_request *lookup_lreq;
...
#[no_mangle]
unsafe extern "C" fn linger_reg_commit_wait(lreq: *mut ceph_osd_linger_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_timeout(work: *mut work_struct) {
    static void handle_timeout(struct work_struct *work)
    {
    struct ceph_osd_client *osdc =
    container_of(work, struct ceph_osd_client, timeout_work.work);
    struct ceph_options *opts = osdc.client.options;
    let mut cutoff: c_ulong = jiffies - opts.osd_keepalive_timeout;
    let mut expiry_cutoff: c_ulong = jiffies - opts.osd_request_timeout;
    LIST_HEAD(slow_osds);
    struct rb_node *n, *p;
    dout("%s osdc %p\n", __func__, osdc);
    down_write(&osdc.lock);
...
#[no_mangle]
unsafe extern "C" fn handle_osds_timeout(work: *mut work_struct) {
    static void handle_osds_timeout(struct work_struct *work)
    {
    struct ceph_osd_client *osdc =
    container_of(work, struct ceph_osd_client,
    osds_timeout_work.work);
    let mut delay: c_ulong = osdc.client.options.osd_idle_ttl / 4;
...
// redirect changes namespace
    ...
    if (struct_v >= 6) {
    let mut hash: i64 = ceph_decode_64(p);
    if (hash != -1) {
...
pub struct MOSDOpReply {
    ...
    pub epoch: u32,
    pub num_ops: c_int,
    pub outdata_len: [u32; CEPH_OSD_MAX_OPS],
    pub rval: [i32; CEPH_OSD_MAX_OPS],
    pub retry_attempt: c_int,
    pub replay_version: ceph_eversion,
    pub user_version: u64,
    pub redirect: ceph_request_redirect,
}

#[no_mangle]
unsafe extern "C" fn decode_MOSDOpReply(msg: *const ceph_msg, m: *mut MOSDOpReply) -> c_int {
    static int decode_MOSDOpReply(const struct ceph_msg *msg, struct MOSDOpReply *m)
    {
    void *p = msg.front.iov_base;
    let mut end: *mut void const = p + msg.front.iov_len;
    let mut version: u16 = le16_to_cpu(msg.hdr.version);
...
//
#[no_mangle]
unsafe extern "C" fn handle_reply(osd: *mut ceph_osd, msg: *mut ceph_msg) {
    static void handle_reply(struct ceph_osd *osd, struct ceph_msg *msg)
    {
    struct ceph_osd_client *osdc = osd.o_osdc;
    struct ceph_osd_request *req;
    struct MOSDOpReply m;
    let mut tid: u64 = le64_to_cpu(msg.hdr.tid);
    let mut data_len: u32 = 0;
    int ret;
    int i;
    ...
    m.redirect.oloc.pool_ns = core::ptr::null_mut();
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn set_pool_was_full(osdc: *mut ceph_osd_client) {
...
#[no_mangle]
unsafe extern "C" fn pool_cleared_full(osdc: *mut ceph_osd_client, pool_id: i64) -> bool {
...
//
    ...
    struct rb_node *n;
    let mut skipped_map: bool = false;
    bool was_full;
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_handle_map(osdc: *mut ceph_osd_client, msg: *mut ceph_msg) {
    ...
    let mut need_resend: rb_root = RB_ROOT;
    LIST_HEAD(need_resend_linger);
    let mut handled_incremental: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn kick_osd_requests(osd: *mut ceph_osd) {
...
//
#[no_mangle]
unsafe extern "C" fn osd_fault(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn decode_MOSDBackoff(msg: *const ceph_msg, m: *mut MOSDBackoff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_backoff_block(osd: *mut ceph_osd, m: *mut MOSDBackoff) {
    ...
    m.begin = core::ptr::null_mut(); /* backoff now owns this */
    backoff.end = m.end;
    m.end = core::ptr::null_mut();   /* ditto */
...
#[no_mangle]
unsafe extern "C" fn handle_backoff(osd: *mut ceph_osd, msg: *mut ceph_msg) {
...
// CEPH_WATCH_EVENT_NOTIFY_COMPLETE
    ...
    msg.num_data_items ? &msg.data[0] : core::ptr::null_mut();
    if (data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_cancel_request(req: *mut ceph_osd_request) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_sync(osdc: *mut ceph_osd_client) {
    void ceph_osdc_sync(struct ceph_osd_client *osdc)
    {
    struct rb_node *n, *p;
    let mut last_tid: u64 = atomic64_read(&osdc.last_tid);
    again:
    down_read(&osdc.lock);
    for (n = rb_first(&osdc.osds); n; n = rb_next(n)) {
    struct ceph_osd *osd = rb_entry(n, struct ceph_osd, o_node);
...
//
    ...
    struct ceph_osd_request *req;
    int ret;
    req = ceph_osdc_alloc_request(osdc, core::ptr::null_mut(), 1, false, GFP_NOIO);
    if (!req)
    return -ENOMEM;
...
// for notify_id
    ...
    lreq.notify_id_pages = core::ptr::null_mut();
    goto out_put_lreq;
    }
...
#[no_mangle]
unsafe extern "C" fn decode_watcher(p: *mut c_void, end: *mut c_void, item: *mut ceph_watch_item) -> c_int {
...
//
    ...
    let mut end: *mut void const = p + req.r_ops[0].outdata_len;
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_flush_notifies(osdc: *mut ceph_osd_client) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_maybe_request_map(osdc: *mut ceph_osd_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_reopen_osds(osdc: *mut ceph_osd_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_init(osdc: *mut ceph_osd_client, client: *mut ceph_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_stop(osdc: *mut ceph_osd_client) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_setup() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdc_cleanup() {
    void ceph_osdc_cleanup(void)
    {
    BUG_ON(!ceph_osd_request_cache);
    kmem_cache_destroy(ceph_osd_request_cache);
    ceph_osd_request_cache = core::ptr::null_mut();
    }
//
// handle incoming message
//
#[no_mangle]
unsafe extern "C" fn osd_dispatch(con: *mut ceph_connection, msg: *mut ceph_msg) {
    static void osd_dispatch(struct ceph_connection *con, struct ceph_msg *msg)
    {
    struct ceph_osd *osd = con.private;
    struct ceph_osd_client *osdc = osd.o_osdc;
    let mut type: c_int = le16_to_cpu(msg.hdr.type);
    switch (type) {
...
#[no_mangle]
unsafe extern "C" fn sparse_data_requested(req: *mut ceph_osd_request) -> u64 {
...
//
    ...
    struct ceph_osd *osd = con.private;
    struct ceph_osd_client *osdc = osd.o_osdc;
    struct ceph_msg *m = core::ptr::null_mut();
    struct ceph_osd_request *req;
    let mut front_len: c_int = le32_to_cpu(hdr.front_len);
    let mut data_len: c_int = le32_to_cpu(hdr.data_len);
    let mut tid: u64 = le64_to_cpu(hdr.tid);
    u64 srlen;
    down_read(&osdc.lock);
    if (!osd_registered(osd)) {
...
// skip = 1;
    ...
    {
    struct ceph_msg *m;
    let mut type: c_int = le16_to_cpu(hdr.type);
    let mut front_len: u32 = le32_to_cpu(hdr.front_len);
    let mut data_len: u32 = le32_to_cpu(hdr.data_len);
...
#[no_mangle]
unsafe extern "C" fn osd_put_con(con: *mut ceph_connection) {
...
//
    ...
    force_new, proto, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    return ERR_PTR(ret);
    return auth;
    }
...
#[no_mangle]
unsafe extern "C" fn osd_verify_authorizer_reply(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd_invalidate_authorizer(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd_reencode_message(msg: *mut ceph_msg) {
...
#[no_mangle]
unsafe extern "C" fn osd_sign_message(msg: *mut ceph_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd_check_message_signature(msg: *mut ceph_msg) -> c_int {
...
// hand back buffer we took earlier
    ...
    sr.sr_extent = core::ptr::null_mut();
...
// hand off request's sparse extent map buffer
    ...
    op.extent.sparse_ext = core::ptr::null_mut();
    spin_unlock(&o.o_requests_lock);
    return 1;
    }

#[no_mangle]
pub unsafe extern "C" fn convert_extent_map(sr: *mut ceph_sparse_read) {
    ...
    ext.off = le64_to_cpu(( __le64)ext.off);
    ext.len = le64_to_cpu(( __le64)ext.len);
    }
    }
...
#[no_mangle]
unsafe extern "C" fn sparse_extent_map_valid(sr: *mut ceph_sparse_read) -> bool {
...
// Convert sr_count to host-endian
    count = le32_to_cpu(( __le32)sr.sr_count);
    sr.sr_count = count;
...
// Convert sr_datalen to host-endian
    sr.sr_datalen = le32_to_cpu(( __le32)sr.sr_datalen);
    for (i = 0; i < count; i++)
