...
//! Source: net/ceph/messenger_v2.c
#![no_std]
...
pub const FRAME_LATE_STATUS_ABORTED: c_uint = 0x1;
pub const FRAME_LATE_STATUS_COMPLETE: c_uint = 0xe;
pub const FRAME_LATE_STATUS_ABORTED_MASK: c_uint = 0xf;
...
#[no_mangle]
unsafe extern "C" fn do_recvmsg(sock: *mut socket, it: *mut iov_iter) -> c_int {
    static int do_recvmsg(struct socket *sock, struct iov_iter *it)
    {
    let mut msg: msghdr = { .msg_flags = CEPH_MSG_FLAGS };
    int ret;
    msg.msg_iter = *it;
...
//
#[no_mangle]
unsafe extern "C" fn ceph_tcp_recv(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_sendmsg(sock: *mut socket, it: *mut iov_iter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_try_sendpage(sock: *mut socket, it: *mut iov_iter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceph_tcp_send(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_in_kvec(con: *mut ceph_connection, buf: *mut c_void, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn reset_in_kvecs(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn set_in_bvec(con: *mut ceph_connection, bv: *const bio_vec) {
...
#[no_mangle]
unsafe extern "C" fn set_in_skip(con: *mut ceph_connection, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn add_out_kvec(con: *mut ceph_connection, buf: *mut c_void, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn reset_out_kvecs(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn set_out_bvec_zero(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn out_zero_add(con: *mut ceph_connection, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn free_conn_bufs(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn add_in_sign_kvec(con: *mut ceph_connection, buf: *mut c_void, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn clear_in_sign_kvecs(con: *mut ceph_connection) {
    static void clear_in_sign_kvecs(struct ceph_connection *con)
    {
    con.v2.in_sign_kvec_cnt = 0;
    }
#[no_mangle]
unsafe extern "C" fn add_out_sign_kvec(con: *mut ceph_connection, buf: *mut c_void, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn head_onwire_len(ctrl_len: c_int, secure: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tail_onwire_len(msg: *const ceph_msg, secure: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn calc_segment_count(lens: *const c_int, len_cnt: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn encode_preamble(desc: *const ceph_frame_desc, p: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn decode_preamble(p: *mut c_void, desc: *mut ceph_frame_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn encode_epilogue_plain(con: *mut ceph_connection, aborted: bool) {
...
#[no_mangle]
unsafe extern "C" fn encode_epilogue_secure(con: *mut ceph_connection, aborted: bool) {
...
#[no_mangle]
unsafe extern "C" fn verify_control_crc(con: *mut ceph_connection) -> c_int {
    static int verify_control_crc(struct ceph_connection *con)
    {
    let mut ctrl_len: c_int = con.v2.in_desc.fd_lens[0];
    u32 crc, expected_crc;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: data_len(con->in_msg)) -> else {
    ...
    con.v2.gcm_tfm = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gcm_inc_nonce(nonce: *mut ceph_gcm_nonce) {
...
#[no_mangle]
unsafe extern "C" fn calc_sg_cnt(buf: *mut c_void, buf_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_sg_cnt_cursor(cursor: *mut ceph_msg_data_cursor) -> c_int {
    static int calc_sg_cnt_cursor(struct ceph_msg_data_cursor *cursor)
    {
    let mut data_len: c_int = cursor.total_resid;
    struct bio_vec bv;
    int sg_cnt;
    if (!data_len)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn init_sgs(sg: *mut scatterlist, buf: *mut c_void, buf_len: c_int, pad: *mut u8) {
...
//
    ...
    {
    let mut idx: c_int = dpos >> PAGE_SHIFT;
    let mut off: c_int = offset_in_page(dpos);
    let mut resid: c_int = dlen;
    do {
    let mut len: c_int = min(resid, (int)PAGE_SIZE - off);
...
// sg = sg_next(*sg);
    ...
    let mut dlen: c_int = data_len(msg);
    int sg_cnt;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn decrypt_preamble(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decrypt_control_remainder(con: *mut ceph_connection) -> c_int {
    static int decrypt_control_remainder(struct ceph_connection *con)
    {
    let mut ctrl_len: c_int = con.v2.in_desc.fd_lens[0];
    let mut rem_len: c_int = ctrl_len - CEPH_PREAMBLE_INLINE_LEN;
    let mut pt_len: c_int = padding_len(rem_len) + CEPH_GCM_TAG_LEN;
...
// Process sparse read data that lives in a buffer
    ...
    do {
    let mut idx: c_int = spos >> PAGE_SHIFT;
    let mut soff: c_int = offset_in_page(spos);
    struct page *spage = con.v2.in_enc_pages[idx];
    let mut len: c_int = min_t(int, ret, PAGE_SIZE - soff);
    if (buf) {
...
#[no_mangle]
unsafe extern "C" fn decrypt_tail(con: *mut ceph_connection) -> c_int {
    static int decrypt_tail(struct ceph_connection *con)
    {
    let mut enc_sgt: sg_table = {};
    let mut sgt: sg_table = {};
    struct page **pages = core::ptr::null_mut();
    let mut sparse: bool = !!con.in_msg.sparse_read_total;
    let mut dpos: c_int = 0;
    int tail_len;
    int ret;
    ...
    con.v2.in_enc_pages = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn prepare_banner(con: *mut ceph_connection) -> c_int {
    static int prepare_banner(struct ceph_connection *con)
    {
    let mut buf_len: c_int = CEPH_BANNER_V2_LEN + 2 + 8 + 8;
    void *buf, *p;
...
//
    ...
    bool to_be_signed)
    {
    let mut base_len: c_int = CEPH_PREAMBLE_LEN + ctrl_len + CEPH_CRC_LEN;
...
// control remainder padding?
    ...
    {
    let mut total_len: c_int = ctrl_len + extdata_len;
...
// partially inlined, inline buffer is full
    ...
    void *base, int ctrl_len)
    {
    return __prepare_control(con, tag, base, ctrl_len, core::ptr::null_mut(), 0, false);
    }
#[no_mangle]
unsafe extern "C" fn prepare_hello(con: *mut ceph_connection) -> c_int {
    ...
    core::ptr::null_mut(), 0, true);
    }
// so that head_onwire_len(AUTH_BUF_LEN, false) is 512

#[no_mangle]
unsafe extern "C" fn prepare_auth_request(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_auth_signature(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_client_ident(con: *mut ceph_connection) -> c_int {
    ...
    let mut global_id: u64 = ceph_client_gid(client);
    void *buf, *p;
    int ctrl_len;
...
#[no_mangle]
unsafe extern "C" fn prepare_session_reconnect(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_keepalive2(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_ack(con: *mut ceph_connection) -> c_int {
...
//
    ...
    sizeof(struct ceph_msg_header2), core::ptr::null_mut(), 0, false);
...
//
    ...
    &con.v2.out_epil, core::ptr::null_mut(), 0, false);
    if (ret)
    goto out;
...
#[no_mangle]
unsafe extern "C" fn prepare_message(con: *mut ceph_connection, msg: *mut ceph_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_banner_prefix(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_preamble(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_control(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_control_remainder(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_data(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_data_cont(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn prepare_sparse_read_cont(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_sparse_read_data(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_tail_plain(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_enc_page(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn prepare_read_tail_secure(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __finish_skip(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn prepare_skip_message(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn process_banner_prefix(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_banner_payload(con: *mut ceph_connection) -> c_int {
    ...
    let mut feat: u64 = CEPH_MSGR2_SUPPORTED_FEATURES;
    let mut req_feat: u64 = CEPH_MSGR2_REQUIRED_FEATURES;
...
#[no_mangle]
unsafe extern "C" fn process_hello(con: *mut ceph_connection, p: *mut c_void, end: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn process_auth_done(con: *mut ceph_connection, p: *mut c_void, end: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_ack(con: *mut ceph_connection, p: *mut c_void, end: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_control(con: *mut ceph_connection, p: *mut c_void, end: *mut c_void) -> c_int {
    static int process_control(struct ceph_connection *con, void *p, void *end)
    {
    let mut tag: c_int = con.v2.in_desc.fd_tag;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn process_message(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __handle_control(con: *mut ceph_connection, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_preamble(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_control(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_control_remainder(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_epilogue(con: *mut ceph_connection) -> c_int {
...
// just late_status
    ret = decode_epilogue(con.v2.in_buf, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn finish_skip(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn populate_in_iter(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_v2_try_read(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_data(con: *mut ceph_connection, msg: *mut ceph_msg) {
...
#[no_mangle]
unsafe extern "C" fn queue_data_cont(con: *mut ceph_connection, msg: *mut ceph_msg) {
...
#[no_mangle]
unsafe extern "C" fn queue_enc_page(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn queue_zeros(con: *mut ceph_connection, msg: *mut ceph_msg) {
...
#[no_mangle]
unsafe extern "C" fn finish_message(con: *mut ceph_connection) {
...
// we end up here both plain and secure modes
    ...
    con.v2.out_enc_pages = core::ptr::null_mut();
    con.v2.out_enc_page_cnt = 0;
    }
// message may have been revoked
    if (con.out_msg) {
    ceph_msg_put(con.out_msg);
    con.out_msg = core::ptr::null_mut();
    }
    con.v2.out_state = OUT_S_GET_NEXT;
    }
#[no_mangle]
unsafe extern "C" fn populate_out_iter(con: *mut ceph_connection) -> c_int {
    ...
    } else if ((msg = ceph_con_get_out_msg(con)) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_v2_try_write(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crc32c_zeros(crc: u32, zero_len: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_v2_revoke(con: *mut ceph_connection, msg: *mut ceph_msg) {
...
#[no_mangle]
unsafe extern "C" fn revoke_at_prepare_read_data(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn revoke_at_prepare_read_data_cont(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn revoke_at_prepare_read_enc_page(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn revoke_at_prepare_sparse_data(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn revoke_at_handle_epilogue(con: *mut ceph_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_v2_revoke_incoming(con: *mut ceph_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_v2_opened(con: *mut ceph_connection) -> bool {
    bool ceph_con_v2_opened(struct ceph_connection *con)
    {
    return con.v2.peer_global_seq;
    }
#[no_mangle]
pub unsafe extern "C" fn ceph_con_v2_reset_session(con: *mut ceph_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_v2_reset_protocol(con: *mut ceph_connection) {
    ...
    con.v2.gcm_req = core::ptr::null_mut();
    }
    if (con.v2.gcm_tfm) {
