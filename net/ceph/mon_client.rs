...
//
    ...
    {
    struct ceph_monmap *monmap = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_monmap_contains(m: *mut ceph_monmap, addr: *mut ceph_entity_addr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __send_prepared_auth_request(monc: *mut ceph_mon_client, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn __close_session(monc: *mut ceph_mon_client) {
...
//
#[no_mangle]
unsafe extern "C" fn pick_new_mon(monc: *mut ceph_mon_client) {
    static void pick_new_mon(struct ceph_mon_client *monc)
    {
    let mut old_mon: c_int = monc.cur_mon;
    BUG_ON(monc.monmap.num_mon < 1);
    if (monc.monmap.num_mon == 1) {
    monc.cur_mon = 0;
    } else {
    let mut max: c_int = monc.monmap.num_mon;
    let mut o: c_int = -1;
    int n;
    if (monc.cur_mon >= 0) {
...
//
#[no_mangle]
unsafe extern "C" fn __open_session(monc: *mut ceph_mon_client) {
...
#[no_mangle]
unsafe extern "C" fn reopen_session(monc: *mut ceph_mon_client) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_monc_reopen_session(monc: *mut ceph_mon_client) {
...
#[no_mangle]
unsafe extern "C" fn un_backoff(monc: *mut ceph_mon_client) {
...
//
#[no_mangle]
unsafe extern "C" fn __schedule_delayed(monc: *mut ceph_mon_client) {
...
//
#[no_mangle]
unsafe extern "C" fn __send_subscribe(monc: *mut ceph_mon_client) {
...
//
    ...
    {
    let mut start: __le64 = cpu_to_le64(epoch);
    let mut flags: u8 = !continuous ? CEPH_SUBSCRIBE_ONETIME : 0;
...
#[no_mangle]
pub unsafe extern "C" fn ceph_monc_got_map(monc: *mut ceph_mon_client, sub: c_int, epoch: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_monc_renew_subs(monc: *mut ceph_mon_client) {
...
//
    ...
    {
    let mut started: c_ulong = jiffies;
    long ret;
    mutex_lock(&monc.mutex);
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_monc_open_session(monc: *mut ceph_mon_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_generic_request(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn put_generic_request(req: *mut ceph_mon_generic_request) {
...
#[no_mangle]
unsafe extern "C" fn get_generic_request(req: *mut ceph_mon_generic_request) {
...
#[no_mangle]
unsafe extern "C" fn register_generic_request(req: *mut ceph_mon_generic_request) {
...
#[no_mangle]
unsafe extern "C" fn __finish_generic_request(req: *mut ceph_mon_generic_request) {
...
#[no_mangle]
unsafe extern "C" fn finish_generic_request(req: *mut ceph_mon_generic_request) {
...
#[no_mangle]
unsafe extern "C" fn complete_generic_request(req: *mut ceph_mon_generic_request) {
...
#[no_mangle]
unsafe extern "C" fn cancel_generic_request(req: *mut ceph_mon_generic_request) {
...
#[no_mangle]
unsafe extern "C" fn wait_generic_request(req: *mut ceph_mon_generic_request) -> c_int {
...
// fill out request
    ...
    let mut end: *mut void const = p + req.request.front_alloc_len;
...
//
    ...
    struct ceph_mon_generic_request *req;
    int ret;
    req = __ceph_monc_get_version(monc, what, core::ptr::null_mut(), 0);
    if (IS_ERR(req))
    return PTR_ERR(req);
    ret = wait_generic_request(req);
    if (!ret)
...
pub unsafe extern "C" fn __printf(_arg: 2, _arg: 3) -> static {
    static __printf(2, 3)
#[no_mangle]
pub unsafe extern "C" fn do_mon_command(monc: *mut ceph_mon_client, fmt: *const c_char, ...) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __resend_generic_request(monc: *mut ceph_mon_client) {
...
//
#[no_mangle]
unsafe extern "C" fn delayed_work(work: *mut work_struct) {
    ...
    let mut is_auth: c_int = ceph_auth_is_authenticated(monc.auth);
    dout("%s is_authed %d\n", __func__, is_auth);
...
#[no_mangle]
pub unsafe extern "C" fn ceph_monc_init(monc: *mut ceph_mon_client, cl: *mut ceph_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_monc_stop(monc: *mut ceph_mon_client) {
...
#[no_mangle]
unsafe extern "C" fn finish_hunting(monc: *mut ceph_mon_client) {
...
#[no_mangle]
unsafe extern "C" fn __validate_auth(monc: *mut ceph_mon_client) -> c_int {
    static int __validate_auth(struct ceph_mon_client *monc)
    {
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn ceph_monc_validate_auth(monc: *mut ceph_mon_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mon_dispatch(con: *mut ceph_connection, msg: *mut ceph_msg) {
...
//
    ...
    if (!m)
    return core::ptr::null_mut();	/* ENOMEM--return skip == 0 */
    break;
    }
    if (!m) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_fault(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn mon_put_con(con: *mut ceph_connection) {
