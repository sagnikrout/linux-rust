...
//
#[no_mangle]
pub unsafe extern "C" fn libceph_compatible(data: *mut c_void) -> bool {
    ...
    module_param_cb(supported_features, &param_ops_supported_features, core::ptr::null_mut(),
    0444);
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_check_fsid(client: *mut ceph_client, fsid: *mut ceph_fsid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn strcmp_null(s1: *const c_char, s2: *const c_char) -> c_int {
    ...
    let mut ofs: c_int = offsetof(struct ceph_options, mon_addr);
    int i;
    int ret;
//
...
#[no_mangle]
pub unsafe extern "C" fn ceph_parse_fsid(str: *const c_char, fsid: *mut ceph_fsid) -> c_int {
...
// string args above
    ...
    __fsparam	(core::ptr::null_mut(), "cephx_require_signatures", Opt_cephx_require_signatures,
...
#[no_mangle]
pub unsafe extern "C" fn ceph_destroy_options(opt: *mut ceph_options) {
...
// get secret from key store
    ...
    ukey = request_key(&key_type_ceph, name, core::ptr::null_mut());
    if (IS_ERR(ukey)) {
...
// pass through, err is 0
    ...
    {
    let mut log: p_log = {.prefix = "libceph", .log = l};
    int ret;
// ip1[:port1][<delim>ip2[:port2]...]
    ...
    &opt.my_addr, 1, core::ptr::null_mut(), ',');
    if (err) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_client_gid(client: *mut ceph_client) -> u64 {
...
//
    ...
    {
    struct ceph_client *client;
    struct ceph_entity_addr *myaddr = core::ptr::null_mut();
    int err;
    ...
    client.auth_err = 0;
    client.extra_mon_dispatch = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ceph_destroy_client(client: *mut ceph_client) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_reset_client_addr(client: *mut ceph_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __ceph_open_session(client: *mut ceph_client) -> c_int {
    int __ceph_open_session(struct ceph_client *client)
    {
    DEFINE_WAIT_FUNC(wait, woken_wake_function);
    let mut timeout: c_long = ceph_timeout_jiffies(client.options.mount_timeout);
...
#[no_mangle]
pub unsafe extern "C" fn ceph_open_session(client: *mut ceph_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_ceph_lib() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_ceph_lib() -> void __exit {
