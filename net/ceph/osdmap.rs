...
pub unsafe extern "C" fn __printf(_arg: 2, _arg: 3) -> static {
    static __printf(2, 3)
#[no_mangle]
pub unsafe extern "C" fn osdmap_info(map: *const ceph_osdmap, fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CEPH_OSD_EXISTS: state &) -> else {
    else if (state & CEPH_OSD_EXISTS)
    snprintf(str, len, "exists");
#[no_mangle]
pub unsafe extern "C" fn if(CEPH_OSD_UP: state &) -> else {
...
// maps
#[no_mangle]
unsafe extern "C" fn calc_bits_of(t: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn calc_pg_masks(pi: *mut ceph_pg_pool_info) {
...
//
    ...
    if (b.item_weights == core::ptr::null_mut())
    return -ENOMEM;
    b.sum_weights = kcalloc(b.h.size, sizeof(u32), GFP_NOFS);
    if (b.sum_weights == core::ptr::null_mut())
    return -ENOMEM;
    ...
    if (b.node_weights == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn free_crush_name(cn: *mut crush_name_node) {
...
#[no_mangle]
unsafe extern "C" fn decode_crush_names(p: *mut c_void, end: *mut c_void, root: *mut rb_root) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn clear_crush_names(root: *mut rb_root) {
...
#[no_mangle]
unsafe extern "C" fn free_choose_arg_map(arg_map: *mut crush_choose_arg_map) {
    ...
    node);
#[no_mangle]
pub unsafe extern "C" fn clear_choose_args(c: *mut crush_map) {
...
//
#[no_mangle]
unsafe extern "C" fn decode_choose_arg(p: *mut c_void, end: *mut c_void, arg: *mut crush_choose_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_choose_args(p: *mut c_void, end: *mut c_void, c: *mut crush_map) -> c_int {
    static int decode_choose_args(void **p, void *end, struct crush_map *c)
    {
    struct crush_choose_arg_map *arg_map = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn crush_finalize(c: *mut crush_map) {
...
// set tunables to default values
    ...
    if (c.buckets == core::ptr::null_mut())
    goto badmem;
    c.rules = kzalloc_objs(*c.rules, c.max_rules, GFP_NOFS);
    if (c.rules == core::ptr::null_mut())
    goto badmem;
// buckets
...
#[no_mangle]
pub unsafe extern "C" fn ceph_pg_compare(lhs: *const ceph_pg, rhs: *const ceph_pg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_spg_compare(lhs: *const ceph_spg, rhs: *const ceph_spg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_pg_mapping(pg: *mut ceph_pg_mapping) {
...
//
    ...
    return pi ? pi.name : core::ptr::null_mut();
    }
    EXPORT_SYMBOL(ceph_pg_pool_name_by_id);
#[no_mangle]
pub unsafe extern "C" fn ceph_pg_poolid_by_name(map: *mut ceph_osdmap, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_pg_pool_flags(map: *mut ceph_osdmap, id: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __remove_pg_pool(root: *mut rb_root, pi: *mut ceph_pg_pool_info) {
...
#[no_mangle]
unsafe extern "C" fn decode_pool(p: *mut c_void, end: *mut c_void, pi: *mut ceph_pg_pool_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_pool_names(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_workspace(work: *mut crush_work) {
...
#[no_mangle]
unsafe extern "C" fn init_workspace_manager(wsm: *mut workspace_manager) {
...
#[no_mangle]
unsafe extern "C" fn cleanup_workspace_manager(wsm: *mut workspace_manager) {
...
//
    ...
    {
    struct crush_work *work;
    let mut cpus: c_int = num_online_cpus();
    again:
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osdmap_destroy(map: *mut ceph_osdmap) {
...
//
#[no_mangle]
unsafe extern "C" fn osdmap_set_max_osd(map: *mut ceph_osdmap, max: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osdmap_set_crush(map: *mut ceph_osdmap, crush: *mut crush_map) -> c_int {
...
pub const OSDMAP_WRAPPER_COMPAT_VER: c_int = 7;
pub const OSDMAP_CLIENT_DATA_COMPAT_VER: c_int = 1;
//
...
#[no_mangle]
unsafe extern "C" fn decode_pools(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
    static int decode_pools(void **p, void *end, struct ceph_osdmap *map)
    {
    return __decode_pools(p, end, map, false);
    }
#[no_mangle]
unsafe extern "C" fn decode_new_pools(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
    ...
    return core::ptr::null_mut();	/* new_pg_temp: [] to remove */
...
#[no_mangle]
unsafe extern "C" fn decode_pg_temp(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_new_pg_temp(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
    ...
    return core::ptr::null_mut();	/* new_primary_temp: -1 to remove */
...
#[no_mangle]
unsafe extern "C" fn decode_primary_temp(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_get_primary_affinity(map: *mut ceph_osdmap, osd: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn set_primary_affinity(map: *mut ceph_osdmap, osd: c_int, aff: u32) -> c_int {
    ...
    if (len == 0) {
    kvfree(map.osd_primary_affinity);
    map.osd_primary_affinity = core::ptr::null_mut();
    return 0;
    }
    if (len != map.max_osd)
    goto e_inval;
...
#[no_mangle]
unsafe extern "C" fn decode_pg_upmap(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_new_pg_upmap(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decode_old_pg_upmap(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
    static int decode_old_pg_upmap(void **p, void *end, struct ceph_osdmap *map)
    {
    return decode_pg_mapping(p, end, &map.pg_upmap, core::ptr::null_mut(), true);
    }
...
#[no_mangle]
unsafe extern "C" fn decode_pg_upmap_items(p: *mut c_void, end: *mut c_void, map: *mut ceph_osdmap) -> c_int {
    ...
    struct ceph_osdmap *map)
    {
    return decode_pg_mapping(p, end, &map.pg_upmap_items, core::ptr::null_mut(), true);
    }
//
// decode a full map.
//
...
// p = end;
    ...
    dest.pool_ns = core::ptr::null_mut();
    }
    EXPORT_SYMBOL(ceph_oloc_copy);
#[no_mangle]
pub unsafe extern "C" fn ceph_oloc_destroy(oloc: *mut ceph_object_locator) {
...
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 2, _arg: 0) -> static {
    static __printf(2, 0)
#[no_mangle]
pub unsafe extern "C" fn oid_printf_vargs(oid: *mut ceph_object_id, fmt: *const c_char, ap: va_list) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_oid_printf(oid: *mut ceph_object_id, fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_oid_destroy(oid: *mut ceph_object_id) {
...
#[no_mangle]
unsafe extern "C" fn osds_valid(set: *const ceph_osds) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_osds_copy(dest: *mut ceph_osds, src: *const ceph_osds) {
    ...
    u32 new_pg_num)
    {
    let mut old_bits: c_int = calc_bits_of(old_pg_num);
    let mut old_mask: c_int = (1 << old_bits) - 1;
    int n;
    WARN_ON(pgid.seed >= old_pg_num);
    if (new_pg_num <= old_pg_num)
    return false;
    for (n = 1; ; n++) {
    let mut next_bit: c_int = n << (old_bits - 1);
    let mut s: u32 = next_bit | pgid.seed;
...
#[no_mangle]
unsafe extern "C" fn calc_pg_rank(osd: c_int, acting: *const ceph_osds) -> c_int {
...
//
    ...
    char stack_buf[256];
    char *buf = stack_buf;
    let mut nsl: c_int = oloc.pool_ns.len;
    let mut total: usize = nsl + 1 + oid.name_len;
...
//
    ...
    arg_map ? arg_map.args : core::ptr::null_mut());
...
//
    ...
    u32 *ppps)
    {
    let mut pps: u32 = raw_pg_to_pps(pi, raw_pgid);
    int ruleno;
    int len;
    ceph_osds_init(raw);
    if (ppps)
...
// make sure targets aren't marked out
    ...
    let mut osd: c_int = pg.pg_upmap.osds[i];
...
//
    ...
    let mut from: c_int = pg.pg_upmap_items.from_to[i][0];
    let mut to: c_int = pg.pg_upmap_items.from_to[i][1];
    let mut pos: c_int = -1;
    let mut exists: bool = false;
// make sure replacement doesn't already appear
    for (j = 0; j < raw.size; j++) {
    let mut osd: c_int = raw.osds[j];
    if (osd == to) {
    exists = true;
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn free_crush_loc(loc: *mut crush_loc_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_parse_crush_location(crush_location: *mut c_char, locs: *mut rb_root) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_compare_crush_locs(locs1: *mut rb_root, locs2: *mut rb_root) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_clear_crush_locs(locs: *mut rb_root) {
...
//
#[no_mangle]
unsafe extern "C" fn is_valid_crush_name(name: *const c_char) -> bool {
