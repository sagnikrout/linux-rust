...
//
    ...
    {
    let mut stripes_per_object: u32 = l.object_size / l.stripe_unit;
...
#[no_mangle]
pub unsafe extern "C" fn ceph_get_num_objects(l: *mut ceph_file_layout, size: u64) -> u64 {
    u64 ceph_get_num_objects(struct ceph_file_layout *l, u64 size)
    {
    let mut period: u64 = (u64)l.stripe_count * l.object_size;
    let mut num_periods: u64 = DIV64_U64_ROUND_UP(size, period);
    u64 remainder_bytes;
    let mut remainder_objs: u64 = 0;
