...
#[no_mangle]
unsafe extern "C" fn con_flag_valid(con_flag: c_ulong) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_flag_clear(con: *mut ceph_connection, con_flag: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_flag_set(con: *mut ceph_connection, con_flag: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_flag_test(con: *mut ceph_connection, con_flag: c_ulong) -> bool {
...
//
    ...
    let mut addr_str_seq: static atomic_t = ATOMIC_INIT(0);
...
#[no_mangle]
pub unsafe extern "C" fn ceph_encode_my_addr(msgr: *mut ceph_messenger) {
...
#[no_mangle]
unsafe extern "C" fn ceph_msgr_slab_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceph_msgr_slab_exit() {
    static void ceph_msgr_slab_exit(void)
    {
    BUG_ON(!ceph_msg_cache);
    kmem_cache_destroy(ceph_msg_cache);
    ceph_msg_cache = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn _ceph_msgr_exit() {
    static void _ceph_msgr_exit(void)
    {
    if (ceph_msgr_wq) {
    destroy_workqueue(ceph_msgr_wq);
    ceph_msgr_wq = core::ptr::null_mut();
    }
    BUG_ON(!ceph_zero_page);
    put_page(ceph_zero_page);
    ceph_zero_page = core::ptr::null_mut();
    ceph_msgr_slab_exit();
    }
#[no_mangle]
pub unsafe extern "C" fn ceph_msgr_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_msgr_exit() {
    void ceph_msgr_exit(void)
    {
    BUG_ON(ceph_msgr_wq == core::ptr::null_mut());
    _ceph_msgr_exit();
    }
#[no_mangle]
pub unsafe extern "C" fn ceph_msgr_flush() {
...
#[no_mangle]
unsafe extern "C" fn con_sock_state_init(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn con_sock_state_connecting(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn con_sock_state_connected(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn con_sock_state_closing(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn con_sock_state_closed(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn ceph_sock_data_ready(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn ceph_sock_write_space(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn ceph_sock_state_change(sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_tcp_connect(con: *mut ceph_connection) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_close_socket(con: *mut ceph_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceph_con_reset_protocol(con: *mut ceph_connection) {
    ...
    con.bounce_page = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn ceph_msg_remove(msg: *mut ceph_msg) {
...
#[no_mangle]
unsafe extern "C" fn ceph_msg_remove_list(head: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_con_reset_session(con: *mut ceph_connection) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_close(con: *mut ceph_connection) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_opened(con: *mut ceph_connection) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_get_global_seq(msgr: *mut ceph_messenger, gt: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_discard_sent(con: *mut ceph_connection, ack_seq: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_discard_requeued(con: *mut ceph_connection, reconnect_seq: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn __ceph_msg_data_cursor_init(cursor: *mut ceph_msg_data_cursor) {
    static void __ceph_msg_data_cursor_init(struct ceph_msg_data_cursor *cursor)
    {
    let mut length: usize = cursor.total_resid;
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_msg_data_advance(cursor: *mut ceph_msg_data_cursor, bytes: usize) {
    ...
    char *kaddr;
    kaddr = kmap(page);
    BUG_ON(kaddr == core::ptr::null_mut());
    crc = crc32c(crc, kaddr + page_offset, length);
    kunmap(page);
    return crc;
    }
#[no_mangle]
pub unsafe extern "C" fn ceph_addr_is_blank(addr: *const ceph_entity_addr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_addr_port(addr: *const ceph_entity_addr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_addr_set_port(addr: *mut ceph_entity_addr, p: c_int) {
...
//
    ...
    char *colon_p, *ip_addr = core::ptr::null_mut();
    int ip_len, ret;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(colon_p: !delim_p &&) -> else {
...
// do dns_resolve upcall
    ...
    core::ptr::null_mut(), name, end - name, core::ptr::null_mut(), &ip_addr, core::ptr::null_mut(), false);
    if (ip_len > 0)
    ret = ceph_pton(ip_addr, ip_len, addr, -1, core::ptr::null_mut());
    else
    ret = -ESRCH;
    kfree(ip_addr);
// ipend = end;
...
//
    ...
    let mut cur_delim: c_char = delim;
    const char *ipend;
    int port;
    if (*p == '[') {
    cur_delim = ']';
...
// port?
    ...
    port = CEPH_MON_PORT;
#[no_mangle]
pub unsafe extern "C" fn if(65535: port >) -> else {
    else if (port > 65535)
    goto bad;
    } else {
    port = CEPH_MON_PORT;
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_process_message(con: *mut ceph_connection) {
...
//
#[no_mangle]
unsafe extern "C" fn queue_con_delay(con: *mut ceph_connection, delay: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_con(con: *mut ceph_connection) {
    static void queue_con(struct ceph_connection *con)
    {
    (void) queue_con_delay(con, 0);
    }
#[no_mangle]
unsafe extern "C" fn cancel_con(con: *mut ceph_connection) {
    static void cancel_con(struct ceph_connection *con)
    {
...
#[no_mangle]
unsafe extern "C" fn con_sock_closed(con: *mut ceph_connection) -> bool {
...
#[no_mangle]
unsafe extern "C" fn con_backoff(con: *mut ceph_connection) -> bool {
...
#[no_mangle]
unsafe extern "C" fn con_fault_finish(con: *mut ceph_connection) {
...
//
#[no_mangle]
unsafe extern "C" fn ceph_con_workfn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn con_fault(con: *mut ceph_connection) {
    static void con_fault(struct ceph_connection *con)
    {
    ...
    con.error_msg = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ceph_messenger_reset_nonce(msgr: *mut ceph_messenger) {
    void ceph_messenger_reset_nonce(struct ceph_messenger *msgr)
    {
    let mut nonce: u32 = le32_to_cpu(msgr.inst.addr.nonce) + 1000000;
...
#[no_mangle]
pub unsafe extern "C" fn ceph_messenger_fini(msgr: *mut ceph_messenger) {
    void ceph_messenger_fini(struct ceph_messenger *msgr)
    {
    put_net(read_pnet(&msgr.net));
    }
#[no_mangle]
unsafe extern "C" fn msg_con_set(msg: *mut ceph_msg, con: *mut ceph_connection) {
    static void msg_con_set(struct ceph_msg *msg, struct ceph_connection *con)
    {
    if (msg.con)
    msg.con.ops.put(msg.con);
    msg.con = con ? con.ops.get(con) : core::ptr::null_mut();
    BUG_ON(msg.con != con);
    }
#[no_mangle]
unsafe extern "C" fn clear_standby(con: *mut ceph_connection) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_send(con: *mut ceph_connection, msg: *mut ceph_msg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_msg_revoke(msg: *mut ceph_msg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_msg_revoke_incoming(msg: *mut ceph_msg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_con_keepalive(con: *mut ceph_connection) {
...
#[no_mangle]
unsafe extern "C" fn ceph_msg_data_destroy(data: *mut ceph_msg_data) {
    static void ceph_msg_data_destroy(struct ceph_msg_data *data)
    {
    if (data.type == CEPH_MSG_DATA_PAGES && data.own_pages) {
    let mut num_pages: c_int = calc_pages_for(data.alignment, data.length);
...
// front
    ...
    if (m.front.iov_base == core::ptr::null_mut()) {
    dout("ceph_msg_new can't allocate %d bytes\n",
    front_len);
    goto out2;
    }
    } else {
    m.front.iov_base = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn ceph_alloc_middle(con: *mut ceph_connection, msg: *mut ceph_msg) -> c_int {
    static int ceph_alloc_middle(struct ceph_connection *con, struct ceph_msg *msg)
    {
    let mut type: c_int = le16_to_cpu(msg.hdr.type);
    let mut middle_len: c_int = le32_to_cpu(msg.hdr.middle_len);
...
//
    ...
    {
    let mut middle_len: c_int = le32_to_cpu(hdr.middle_len);
    struct ceph_msg *msg;
    let mut ret: c_int = 0;
    BUG_ON(con.in_msg != core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ceph_msg_free(m: *mut ceph_msg) {
...
#[no_mangle]
unsafe extern "C" fn ceph_msg_release(kref: *mut kref) {
    ...
    msg_con_set(m, core::ptr::null_mut());
// drop middle, data, if any
    if (m.middle) {
    ceph_buffer_put(m.middle);
    m.middle = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn ceph_msg_put(msg: *mut ceph_msg) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_msg_dump(msg: *mut ceph_msg) {
