...
#[no_mangle]
unsafe extern "C" fn init_protocol(ac: *mut ceph_auth_client, proto: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_set_global_id(ac: *mut ceph_auth_client, global_id: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_destroy(ac: *mut ceph_auth_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_reset(ac: *mut ceph_auth_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_entity_name_encode(name: *const c_char, p: *mut c_void, end: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_build_hello(ac: *mut ceph_auth_client, buf: *mut c_void, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_is_authenticated(ac: *mut ceph_auth_client) -> c_int {
    ...
    auth.authorizer = core::ptr::null_mut();
    }
    if (!auth.authorizer)
    ret = ac.ops.create_authorizer(ac, peer_type, auth);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ac->ops->update_authorizer) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_destroy_authorizer(a: *mut ceph_authorizer) {
...
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_invalidate_authorizer(ac: *mut ceph_auth_client, peer_type: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn contains(arr: *const c_int, cnt: c_int, val: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn encode_con_modes(p: *mut c_void, end: *mut c_void, pref_mode: c_int, fallb_mode: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ceph_auth_get_request(ac: *mut ceph_auth_client, buf: *mut c_void, buf_len: c_int) -> c_int {
    int ceph_auth_get_request(struct ceph_auth_client *ac, void *buf, int buf_len)
    {
    let mut proto: c_int = ac.key ? CEPH_AUTH_CEPHX : CEPH_AUTH_NONE;
    void *end = buf + buf_len;
    void *lenp;
    void *p;
    int ret;
