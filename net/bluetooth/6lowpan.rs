...
//! Source: net/bluetooth/6lowpan.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lowpan_peer {
    pub list: list_head,
    pub rcu: rcu_head,
    pub chan: *mut l2cap_chan,
// peer addresses in various formats
    pub lladdr: [c_uchar; ETH_ALEN],
    pub peer_addr: in6_addr,
    pub LOWPAN_PEER_MAXBITS): DECLARE_BITMAP(flags,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lowpan_btle_dev {
    pub list: list_head,
    pub hdev: *mut hci_dev,
    pub netdev: *mut net_device,
    pub peers: list_head,
    pub /: *mut *mut atomic_t peer_count; / number of items in peers list,
    pub delete_netdev: work_struct,
    pub notify_peers: delayed_work,
}
    ...
    let mut count: c_int = atomic_read(&dev.peer_count);
...
// use the neighbour cache for matching addresses assigned by SLAAC
    ...
    struct lowpan_peer *peer = core::ptr::null_mut();
    rcu_read_lock();
    ...
    {
    struct lowpan_btle_dev *entry;
    struct lowpan_btle_dev *dev = core::ptr::null_mut();
    rcu_read_lock();
    list_for_each_entry_rcu(entry, &bt_6lowpan_devices, list) {
...
#[no_mangle]
unsafe extern "C" fn give_skb_to_upper(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chan_recv_cb(chan: *mut l2cap_chan, skb: *mut sk_buff) -> c_int {
    ...
    lowpan_cb(skb).chan = core::ptr::null_mut();
...
// peer_addr_type = peer->chan->dst_type;
    ...
    err = dev_hard_header(skb, netdev, ETH_P_IPV6, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    if (err < 0)
    return err;
    return status;
    }
...
//
    ...
    err = l2cap_chan_send(chan, &msg, skb.len, core::ptr::null_mut());
    if (err > 0) {
...
#[no_mangle]
unsafe extern "C" fn send_mcast_pkt(skb: *mut sk_buff, netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn bt_dev_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netdev_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ifup(netdev: *mut net_device) {
    static void ifup(struct net_device *netdev)
    {
    int err;
    rtnl_lock();
    err = dev_open(netdev, core::ptr::null_mut());
    if (err < 0)
    BT_INFO("iface %s cannot be opened (%d)", netdev.name, err);
    rtnl_unlock();
    }
#[no_mangle]
unsafe extern "C" fn ifdown(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn do_notify_peers(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn is_bt_6lowpan(hcon: *mut hci_conn) -> bool {
...
#[no_mangle]
unsafe extern "C" fn setup_netdev(chan: *mut l2cap_chan, dev: *mut lowpan_btle_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn chan_ready_cb(chan: *mut l2cap_chan) {
    static inline void chan_ready_cb(struct l2cap_chan *chan)
    {
    struct lowpan_btle_dev *dev;
    let mut new_netdev: bool = false;
    dev = lookup_dev(chan.conn);
...
#[no_mangle]
unsafe extern "C" fn unregister_dev(dev: *mut lowpan_btle_dev) {
...
#[no_mangle]
unsafe extern "C" fn delete_netdev(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn chan_close_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn chan_state_change_cb(chan: *mut l2cap_chan, state: c_int, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn chan_suspend_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn chan_resume_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn chan_get_sndtimeo_cb(chan: *mut l2cap_chan) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn bt_6lowpan_connect(addr: *mut bdaddr_t, dst_type: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt_6lowpan_disconnect(conn: *mut l2cap_conn, dst_type: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disconnect_all_peers() {
...
#[no_mangle]
unsafe extern "C" fn do_enable_set(flag: bool) {
...
#[no_mangle]
unsafe extern "C" fn lowpan_enable_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_enable_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = enable_6lowpan;
    ...
    {
    char buf[32];
    let mut buf_size: usize = min(count, sizeof(buf) - 1);
    int ret;
    bdaddr_t addr;
    u8 addr_type;
    struct l2cap_conn *conn = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lowpan_control_show(f: *mut seq_file, ptr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_control_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disconnect_devices() {
...
#[no_mangle]
unsafe extern "C" fn bt_6lowpan_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bt_6lowpan_exit() -> void __exit {
