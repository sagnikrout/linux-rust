...
pub const MGMT_VERSION: c_int = 1;
pub const MGMT_REVISION: c_int = 23;
...
#[no_mangle]
unsafe extern "C" fn mgmt_errno_status(err: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mgmt_status(err: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mgmt_event_skb(skb: *mut sk_buff, skip_sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn le_addr_type(mgmt_addr_type: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_fill_version_info(ver: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn is_configured(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_missing_options(hdev: *mut hci_dev) -> __le32 {
...
#[no_mangle]
unsafe extern "C" fn new_options(hdev: *mut hci_dev, skip: *mut sock) -> c_int {
    static int new_options(struct hci_dev *hdev, struct sock *skip)
    {
    let mut options: __le32 = get_missing_options(hdev);
    return mgmt_limited_event(MGMT_EV_NEW_CONFIG_OPTIONS, hdev, &options,
    sizeof(options), HCI_MGMT_OPTION_EVENTS, skip);
    }
#[no_mangle]
unsafe extern "C" fn send_options_rsp(sk: *mut sock, opcode: u16, hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_supported_phys(hdev: *mut hci_dev) -> u32 {
    static u32 get_supported_phys(struct hci_dev *hdev)
    {
    let mut supported_phys: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn get_selected_phys(hdev: *mut hci_dev) -> u32 {
    static u32 get_selected_phys(struct hci_dev *hdev)
    {
    let mut selected_phys: u32 = 0;
    if (lmp_bredr_capable(hdev)) {
...
#[no_mangle]
unsafe extern "C" fn get_configurable_phys(hdev: *mut hci_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_supported_settings(hdev: *mut hci_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_current_settings(hdev: *mut hci_dev) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_get_adv_discov_flags(hdev: *mut hci_dev) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x02: cp->val ==) -> else {
    else if (cp.val == 0x02)
    ...
    return LE_AD_LIMITED;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hci_dev_test_flag(hdev, _arg: HCI_DISCOVERABLE)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_get_connectable(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn service_cache_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn service_cache_off(work: *mut work_struct) {
    ...
    return;
    hci_cmd_sync_queue(hdev, service_cache_sync, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rpa_expired_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpa_expired(work: *mut work_struct) {
    ...
    if (!hci_dev_test_flag(hdev, HCI_ADVERTISING))
    return;
    hci_cmd_sync_queue(hdev, rpa_expired_sync, core::ptr::null_mut(), core::ptr::null_mut());
    }
    static int set_discoverable_sync(struct hci_dev *hdev, void *data);
#[no_mangle]
unsafe extern "C" fn discov_off(work: *mut work_struct) {
...
//
    ...
    hci_cmd_sync_queue(hdev, set_discoverable_sync, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    {
    let mut handle: u8 = mesh_tx.handle;
    if (!silent)
    mgmt_event(MGMT_EV_MESH_PACKET_CMPLT, hdev, &handle,
    sizeof(handle), core::ptr::null_mut());
    mgmt_mesh_remove(mesh_tx);
    }
#[no_mangle]
unsafe extern "C" fn mesh_send_done_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    mesh_tx = mgmt_mesh_next(hdev, core::ptr::null_mut());
    if (mesh_tx)
...
#[no_mangle]
unsafe extern "C" fn mesh_next(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
    static void mesh_next(struct hci_dev *hdev, void *data, int err)
    {
    struct mgmt_mesh_tx *mesh_tx = mgmt_mesh_next(hdev, core::ptr::null_mut());
    if (!mesh_tx)
    return;
...
#[no_mangle]
unsafe extern "C" fn mesh_send_done(work: *mut work_struct) {
    ...
    return;
    hci_cmd_sync_queue(hdev, mesh_send_done_sync, core::ptr::null_mut(), mesh_next);
    }
#[no_mangle]
unsafe extern "C" fn mgmt_init_hdev(sk: *mut sock, hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn append_eir_data_to_buf(hdev: *mut hci_dev, eir: *mut u8) -> u16 {
    static u16 append_eir_data_to_buf(struct hci_dev *hdev, u8 *eir)
    {
    let mut eir_len: u16 = 0;
    size_t name_len;
    if (hci_dev_test_flag(hdev, HCI_BREDR_ENABLED))
...
#[no_mangle]
unsafe extern "C" fn ext_info_changed(hdev: *mut hci_dev, skip: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_settings_rsp(sk: *mut sock, opcode: u16, hdev: *mut hci_dev) -> c_int {
    static int send_settings_rsp(struct sock *sk, u16 opcode, struct hci_dev *hdev)
    {
    let mut settings: __le32 = cpu_to_le32(get_current_settings(hdev));
    return mgmt_cmd_complete(sk, hdev.id, opcode, 0, &settings,
    sizeof(settings));
    }
#[no_mangle]
pub unsafe extern "C" fn mgmt_advertising_added(sk: *mut sock, hdev: *mut hci_dev, instance: u8) {
...
#[no_mangle]
unsafe extern "C" fn restart_le_actions(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn new_settings(hdev: *mut hci_dev, skip: *mut sock) -> c_int {
    static int new_settings(struct hci_dev *hdev, struct sock *skip)
    {
    let mut ev: __le32 = cpu_to_le32(get_current_settings(hdev));
    return mgmt_limited_event(MGMT_EV_NEW_SETTINGS, hdev, &ev,
    sizeof(ev), HCI_MGMT_SETTING_EVENTS, skip);
    }
#[no_mangle]
unsafe extern "C" fn mgmt_set_powered_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_powered_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_new_settings(hdev: *mut hci_dev) -> c_int {
    int mgmt_new_settings(struct hci_dev *hdev)
    {
    return new_settings(hdev, core::ptr::null_mut());
    }
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn settings_rsp(cmd: *mut mgmt_pending_cmd, data: *mut c_void) {
    static void settings_rsp(struct mgmt_pending_cmd *cmd, void *data)
    {
    struct cmd_lookup *match = data;
    send_settings_rsp(cmd.sk, cmd.opcode, match.hdev);
    if (match.sk == core::ptr::null_mut()) {
    match.sk = cmd.sk;
    sock_hold(match.sk);
    }
    }
#[no_mangle]
unsafe extern "C" fn cmd_status_rsp(cmd: *mut mgmt_pending_cmd, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cmd_complete_rsp(cmd: *mut mgmt_pending_cmd, data: *mut c_void) {
...
// removed/freed.
//
    hci_cmd_sync_dequeue(match.hdev, core::ptr::null_mut(), cmd, core::ptr::null_mut());
    if (cmd.cmd_complete) {
...
#[no_mangle]
unsafe extern "C" fn generic_cmd_complete(cmd: *mut mgmt_pending_cmd, status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addr_cmd_complete(cmd: *mut mgmt_pending_cmd, status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mgmt_bredr_support(hdev: *mut hci_dev) -> u8 {
    static u8 mgmt_bredr_support(struct hci_dev *hdev)
    {
    if (!lmp_bredr_capable(hdev))
    return MGMT_STATUS_NOT_SUPPORTED;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !hci_dev_test_flag(hdev, _arg: HCI_BREDR_ENABLED)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mgmt_le_support(hdev: *mut hci_dev) -> u8 {
    static u8 mgmt_le_support(struct hci_dev *hdev)
    {
    if (!lmp_le_capable(hdev))
    return MGMT_STATUS_NOT_SUPPORTED;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !hci_dev_test_flag(hdev, _arg: HCI_LE_ENABLED)) -> else {
...
// Make sure cmd still outstanding.
    ...
    hci_dev_lock(hdev);
    if (err) {
    let mut mgmt_err: u8 = mgmt_status(err);
    ...
    if (hci_dev_test_flag(hdev, HCI_DISCOVERABLE) &&
    hdev.discov_timeout > 0) {
    let mut to: c_int = secs_to_jiffies(hdev.discov_timeout);
...
#[no_mangle]
unsafe extern "C" fn set_discoverable_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int set_discoverable_sync(struct hci_dev *hdev, void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn set_connectable_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_ssp_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
    static void set_ssp_complete(struct hci_dev *hdev, void *data, int err)
    {
    let mut match: cmd_lookup = { core::ptr::null_mut(), hdev };
    struct mgmt_pending_cmd *cmd = data;
    struct mgmt_mode *cp;
    u8 enable;
    bool changed;
// Make sure cmd still outstanding.
    ...
    HCI_SSP_ENABLED)) {
    new_settings(hdev, core::ptr::null_mut());
    }
    mgmt_cmd_status(cmd.sk, cmd.hdev.id, cmd.opcode, mgmt_err);
    mgmt_pending_free(cmd);
    return;
...
#[no_mangle]
unsafe extern "C" fn set_ssp_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_ssp(sk: *mut sock, hdev: *mut hci_dev, data: *mut c_void, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_hs(sk: *mut sock, hdev: *mut hci_dev, data: *mut c_void, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_le_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
    static void set_le_complete(struct hci_dev *hdev, void *data, int err)
    {
    struct mgmt_pending_cmd *cmd = data;
    let mut match: cmd_lookup = { core::ptr::null_mut(), hdev };
    let mut status: u8 = mgmt_status(err);
    bt_dev_dbg(hdev, "err %d", err);
...
#[no_mangle]
unsafe extern "C" fn set_le_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    mutex_unlock(&hdev.mgmt_pending_lock);
    if (!val) {
    hci_clear_adv_instance_sync(hdev, core::ptr::null_mut(), 0x00, true);
...
#[no_mangle]
unsafe extern "C" fn set_mesh_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
    ...
    mgmt_cmd_complete(sk, hdev.id, MGMT_OP_SET_MESH_RECEIVER, 0, core::ptr::null_mut(), 0);
    done:
    mgmt_pending_free(cmd);
    }
#[no_mangle]
unsafe extern "C" fn set_mesh_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_mesh(sk: *mut sock, hdev: *mut hci_dev, data: *mut c_void, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mesh_send_start_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
    static void mesh_send_start_complete(struct hci_dev *hdev, void *data, int err)
    {
...
#[no_mangle]
unsafe extern "C" fn mesh_send_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int mesh_send_sync(struct hci_dev *hdev, void *data)
    {
    struct mgmt_mesh_tx *mesh_tx = data;
    struct mgmt_cp_mesh_send *send = (void *)mesh_tx.param;
    struct adv_info *adv, *next_instance;
    let mut instance: u8 = hdev.le_num_of_adv_sets + 1;
...
#[no_mangle]
unsafe extern "C" fn send_count(mesh_tx: *mut mgmt_mesh_tx, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn send_cancel(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_cancel_destroy(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mesh_send(sk: *mut sock, hdev: *mut hci_dev, data: *mut c_void, len: u16) -> c_int {
    ...
    err = -ENOMEM;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !sending) -> else {
    else if (!sending)
    err = hci_cmd_sync_queue(hdev, mesh_send_sync, mesh_tx,
    mesh_send_start_complete);
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn set_le(sk: *mut sock, hdev: *mut hci_dev, data: *mut c_void, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_hci_cmd_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_hci_cmd_sync_destroy(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pending_eir_or_class(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_uuid_size(uuid: *const u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mgmt_class_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn add_uuid_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_uuid(sk: *mut sock, hdev: *mut hci_dev, data: *mut c_void, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_service_cache(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn remove_uuid_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_class_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    continue;
    hci_add_link_key(hdev, core::ptr::null_mut(), &key.addr.bdaddr, key.val,
    key.type, key.pin_len, core::ptr::null_mut());
    }
    mgmt_cmd_complete(sk, hdev.id, MGMT_OP_LOAD_LINK_KEYS, 0, core::ptr::null_mut(), 0);
    hci_dev_unlock(hdev);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn unpair_device_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn unpair_device_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disconnect_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn disconnect_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn link_to_bdaddr(link_type: u8, addr_type: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn pairing_complete(cmd: *mut mgmt_pending_cmd, status: u8) -> c_int {
...
// So we don't get further callbacks for this connection
    conn.connect_cfm_cb = core::ptr::null_mut();
    conn.security_cfm_cb = core::ptr::null_mut();
    conn.disconn_cfm_cb = core::ptr::null_mut();
    hci_conn_drop(conn);
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_smp_complete(conn: *mut hci_conn, complete: bool) {
    void mgmt_smp_complete(struct hci_conn *conn, bool complete)
    {
    let mut status: u8 = complete ? MGMT_STATUS_SUCCESS : MGMT_STATUS_FAILED;
    struct mgmt_pending_cmd *cmd;
...
#[no_mangle]
unsafe extern "C" fn pairing_complete_cb(conn: *mut hci_conn, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn le_pairing_complete_cb(conn: *mut hci_conn, status: u8) {
    ...
    let mut addr_type: u8 = le_addr_type(cp.addr.type);
    struct hci_conn_params *p;
...
#[no_mangle]
pub unsafe extern "C" fn if(-EOPNOTSUPP: PTR_ERR(conn) ==) -> else {
    else if (PTR_ERR(conn) == -EOPNOTSUPP)
    status = MGMT_STATUS_NOT_SUPPORTED;
#[no_mangle]
pub unsafe extern "C" fn if(-ECONNREFUSED: PTR_ERR(conn) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn adv_expire_sync(hdev: *mut hci_dev, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn name_changed_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int name_changed_sync(struct hci_dev *hdev, void *data)
    {
    return adv_expire_sync(hdev, MGMT_ADV_FLAG_LOCAL_NAME);
    }
#[no_mangle]
unsafe extern "C" fn set_name_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
    ...
    cp, sizeof(*cp));
    if (hci_dev_test_flag(hdev, HCI_LE_ADV))
    hci_cmd_sync_queue(hdev, name_changed_sync, core::ptr::null_mut(), core::ptr::null_mut());
    }
    mgmt_pending_free(cmd);
    }
#[no_mangle]
unsafe extern "C" fn set_name_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appearance_changed_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    if (hci_dev_test_flag(hdev, HCI_LE_ADV))
    hci_cmd_sync_queue(hdev, appearance_changed_sync, core::ptr::null_mut(),
    core::ptr::null_mut());
    ext_info_changed(hdev, sk);
    }
    err = mgmt_cmd_complete(sk, hdev.id, MGMT_OP_SET_APPEARANCE, 0, core::ptr::null_mut(),
    0);
    hci_dev_unlock(hdev);
    return err;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_phy_configuration_changed(hdev: *mut hci_dev, skip: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_default_phy_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ERR(skb)) -> else {
    else if (IS_ERR(skb))
...
#[no_mangle]
unsafe extern "C" fn set_default_phy_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    let mut pkt_type: u16 = (HCI_DH1 | HCI_DM1);
    let mut changed: bool = false;
    int err;
    bt_dev_dbg(hdev, "sock %p", sk);
    ...
    u16 len)
    {
    let mut err: c_int = MGMT_STATUS_SUCCESS;
...
// The zero key uuid is special. Multiple exp features are set through it.
    ...
    if (!hdev) {
    let mut changed: bool = bt_dbg_get();
    bt_dbg_set(false);
    if (changed)
    exp_feature_changed(core::ptr::null_mut(), ZERO_KEY, false, sk);
    }
...
// end with a null feature
    EXP_FEAT(core::ptr::null_mut(), core::ptr::null_mut())
    };
    ...
    let mut status: u8 = MGMT_STATUS_INVALID_PARAMS;
...
#[no_mangle]
unsafe extern "C" fn is_connected(hdev: *mut hci_dev, addr: *mut bdaddr_t, type: u8) -> bool {
...
//
    ...
    let mut status: u8 = MGMT_STATUS_INVALID_PARAMS;
    u32 supported_flags;
    let mut current_flags: u32 = __le32_to_cpu(cp.current_flags);
...
//
    ...
    void *data, u16 len)
    {
    struct adv_monitor *monitor = core::ptr::null_mut();
    struct mgmt_rp_read_adv_monitor_features *rp = core::ptr::null_mut();
    int handle, err;
    let mut rp_size: usize = 0;
    let mut supported: __u32 = 0;
    let mut enabled: __u32 = 0;
    let mut num_handles: __u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn mgmt_add_adv_patterns_monitor_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    {
    let mut offset: u8 = 0, length = 0;
    struct adv_pattern *p = core::ptr::null_mut();
    int i;
    ...
    struct adv_monitor *m = core::ptr::null_mut();
    let mut status: u8 = MGMT_STATUS_SUCCESS;
    let mut expected_size: usize = sizeof(*cp);
    BT_DBG("request for %s", hdev.name);
    if (len <= sizeof(*cp)) {
    ...
    parse_adv_monitor_rssi(m, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mgmt_remove_adv_monitor_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int mgmt_remove_adv_monitor_sync(struct hci_dev *hdev, void *data)
    {
    struct mgmt_pending_cmd *cmd = data;
    struct mgmt_cp_remove_adv_monitor *cp = cmd.param;
    let mut handle: u16 = __le16_to_cpu(cp.monitor_handle);
    if (!handle)
    ...
    let mut rp_size: usize = sizeof(mgmt_rp);
    struct mgmt_pending_cmd *cmd = data;
...
#[no_mangle]
unsafe extern "C" fn read_local_oob_data_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    cmd = mgmt_pending_new(sk, MGMT_OP_READ_LOCAL_OOB_DATA, hdev, core::ptr::null_mut(), 0);
    if (!cmd)
    err = -ENOMEM;
    else
    ...
    cp.rand, core::ptr::null_mut(), core::ptr::null_mut());
    if (err < 0)
    status = MGMT_STATUS_FAILED;
    else
    status = MGMT_STATUS_SUCCESS;
...
//
    ...
    rand192 = core::ptr::null_mut();
    hash192 = core::ptr::null_mut();
    } else {
...
//
    ...
    rand256 = core::ptr::null_mut();
    hash256 = core::ptr::null_mut();
    } else {
    rand256 = cp.rand256;
    hash256 = cp.hash256;
    }
...
#[no_mangle]
unsafe extern "C" fn start_discovery_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_discovery_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    struct mgmt_pending_cmd *cmd;
    let mut max_uuid_count: u16 = ((U16_MAX - sizeof(*cp)) / 16);
    u16 uuid_count, expected_len;
    u8 (*uuids)[16] = core::ptr::null_mut();
    u8 status;
    int err;
    bt_dev_dbg(hdev, "sock %p", sk);
    hci_dev_lock(hdev);
...
#[no_mangle]
unsafe extern "C" fn stop_discovery_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn stop_discovery_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_device_id_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    core::ptr::null_mut(), 0);
    hci_cmd_sync_queue(hdev, set_device_id_sync, core::ptr::null_mut(), core::ptr::null_mut());
    hci_dev_unlock(hdev);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn enable_advertising_instance(hdev: *mut hci_dev, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_advertising_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_adv_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fast_connectable_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn write_fast_connectable_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_bredr_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_bredr_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_bredr(sk: *mut sock, hdev: *mut hci_dev, data: *mut c_void, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_secure_conn_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_secure_conn_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int set_secure_conn_sync(struct hci_dev *hdev, void *data)
    {
    struct mgmt_pending_cmd *cmd = data;
    struct mgmt_mode *cp = cmd.param;
    let mut val: u8 = !!cp.val;
// Force write of val
    hci_dev_set_flag(hdev, HCI_SC_ENABLED);
    ...
    hci_dev_test_flag(hdev, HCI_SSP_ENABLED)) {
    let mut mode: u8 = (cp.val == 0x02) ? 0x01 : 0x00;
...
#[no_mangle]
unsafe extern "C" fn irk_is_valid(irk: *mut mgmt_irk_info) -> bool {
...
// Two most significant bits shall be set
    ...
    hci_dev_set_flag(hdev, HCI_RPA_RESOLVING);
    err = mgmt_cmd_complete(sk, hdev.id, MGMT_OP_LOAD_IRKS, 0, core::ptr::null_mut(), 0);
    hci_dev_unlock(hdev);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn ltk_is_valid(key: *mut mgmt_ltk_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_conn_info_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_conn_info_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_clock_info_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_clock_info_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_device_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
    ...
    cp.action);
    device_flags_changed(core::ptr::null_mut(), hdev, &cp.addr.bdaddr,
...
#[no_mangle]
unsafe extern "C" fn add_device_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x01: cp->action ==) -> else {
...
//
    ...
    supported_flags = hdev.conn_flags;
    device_flags_changed(core::ptr::null_mut(), hdev, &cp.addr.bdaddr, cp.addr.type,
    supported_flags, current_flags);
    err = mgmt_cmd_complete(sk, hdev.id, MGMT_OP_ADD_DEVICE,
...
#[no_mangle]
unsafe extern "C" fn remove_device_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    hci_cmd_sync_queue(hdev, remove_device_sync, core::ptr::null_mut(), core::ptr::null_mut());
    complete:
...
#[no_mangle]
unsafe extern "C" fn conn_update_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int conn_update_sync(struct hci_dev *hdev, void *data)
    {
    struct hci_conn *conn = data;
    struct hci_conn_params *params;
    let mut local: hci_conn_params = {};
    hci_dev_lock(hdev);
...
#[no_mangle]
unsafe extern "C" fn conn_update_sync_destroy(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
pub unsafe extern "C" fn if(_arg: IS_ERR(skb)) -> else {
    ...
    eir_len = 0;
    h192 = core::ptr::null_mut();
    r192 = core::ptr::null_mut();
    h256 = core::ptr::null_mut();
    r256 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn get_supported_adv_flags(hdev: *mut hci_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn calculate_name_len(hdev: *mut hci_dev) -> u8 {
    ...
    bool is_adv_data)
    {
    let mut max_len: u8 = max_adv_len(hdev);
    if (is_adv_data) {
...
#[no_mangle]
unsafe extern "C" fn flags_managed(adv_flags: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tx_power_managed(adv_flags: u32) -> bool {
    static bool tx_power_managed(u32 adv_flags)
    {
    return adv_flags & MGMT_ADV_FLAG_TX_POWER;
    }
#[no_mangle]
unsafe extern "C" fn name_managed(adv_flags: u32) -> bool {
    static bool name_managed(u32 adv_flags)
    {
    return adv_flags & MGMT_ADV_FLAG_LOCAL_NAME;
    }
#[no_mangle]
unsafe extern "C" fn appearance_managed(adv_flags: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn requested_adv_flags_are_valid(hdev: *mut hci_dev, adv_flags: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv_busy(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_advertising_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn add_advertising_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    let mut schedule_instance: u8 = 0;
    struct adv_info *adv, *next_instance;
    int err;
    struct mgmt_pending_cmd *cmd;
    bt_dev_dbg(hdev, "sock %p", sk);
...
#[no_mangle]
unsafe extern "C" fn add_ext_adv_params_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    ...
    struct mgmt_rp_add_ext_adv_params rp;
    struct mgmt_pending_cmd *cmd = core::ptr::null_mut();
    struct adv_info *adv;
...
// Create advertising instance with no advertising or response data
    adv = hci_add_adv_instance(hdev, cp.instance, flags, 0, core::ptr::null_mut(), 0, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn add_ext_adv_data_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn add_ext_adv_data_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_advertising_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    { core::ptr::null_mut() }, /* 0x0000 (no command) */
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_index_added(hdev: *mut hci_dev) {
    ...
    return;
    if (hci_dev_test_flag(hdev, HCI_UNCONFIGURED)) {
    mgmt_index_event(MGMT_EV_UNCONF_INDEX_ADDED, hdev, core::ptr::null_mut(), 0,
    HCI_MGMT_UNCONF_INDEX_EVENTS);
    ev.type = 0x01;
    } else {
    mgmt_index_event(MGMT_EV_INDEX_ADDED, hdev, core::ptr::null_mut(), 0,
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_index_removed(hdev: *mut hci_dev) {
    void mgmt_index_removed(struct hci_dev *hdev)
    {
    struct mgmt_ev_ext_index ev;
    let mut match: cmd_lookup = { core::ptr::null_mut(), hdev, MGMT_STATUS_INVALID_INDEX };
    if (hci_test_quirk(hdev, HCI_QUIRK_RAW_DEVICE))
    return;
    mgmt_pending_foreach(0, hdev, true, cmd_complete_rsp, &match);
    if (hci_dev_test_flag(hdev, HCI_UNCONFIGURED)) {
    mgmt_index_event(MGMT_EV_UNCONF_INDEX_REMOVED, hdev, core::ptr::null_mut(), 0,
    HCI_MGMT_UNCONF_INDEX_EVENTS);
    ev.type = 0x01;
    } else {
    mgmt_index_event(MGMT_EV_INDEX_REMOVED, hdev, core::ptr::null_mut(), 0,
    HCI_MGMT_INDEX_EVENTS);
    ev.type = 0x00;
    }
    ev.bus = hdev.bus;
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_power_on(hdev: *mut hci_dev, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn __mgmt_power_off(hdev: *mut hci_dev) {
...
//
    ...
    HCI_MGMT_DEV_CLASS_EVENTS, core::ptr::null_mut());
    ext_info_changed(hdev, core::ptr::null_mut());
    }
    new_settings(hdev, match.sk);
    if (match.sk)
    sock_put(match.sk);
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_set_powered_failed(hdev: *mut hci_dev, err: c_int) {
    ...
    mgmt_event(MGMT_EV_NEW_LINK_KEY, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn mgmt_ltk_type(ltk: *mut smp_ltk) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_new_ltk(hdev: *mut hci_dev, key: *mut smp_ltk, persistent: bool) {
...
//
    ...
    mgmt_event(MGMT_EV_NEW_LONG_TERM_KEY, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn mgmt_new_irk(hdev: *mut hci_dev, irk: *mut smp_irk, persistent: bool) {
    ...
    mgmt_event(MGMT_EV_NEW_IRK, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
...
//
    ...
    mgmt_event(MGMT_EV_NEW_CSRK, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
    ...
    mgmt_event(MGMT_EV_NEW_CONN_PARAM, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
...
//
    ...
    ev.eir_len = cpu_to_le16(eir_len);
    mgmt_event_skb(skb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn unpair_device_rsp(cmd: *mut mgmt_pending_cmd, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_powering_down(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hci_to_mgmt_reason(err: u8) -> u8 {
...
// Report disconnects due to suspend
    ...
    {
    let mut bdaddr_type: u8 = link_to_bdaddr(link_type, addr_type);
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_connect_failed(hdev: *mut hci_dev, conn: *mut hci_conn, status: u8) {
    ...
    mgmt_event(MGMT_EV_CONNECT_FAILED, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn mgmt_pin_code_request(hdev: *mut hci_dev, bdaddr: *mut bdaddr_t, secure: u8) {
    ...
    ev.secure = secure;
    mgmt_event(MGMT_EV_PIN_CODE_REQUEST, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
    ...
    ev.entered = entered;
    return mgmt_event(MGMT_EV_PASSKEY_NOTIFY, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn mgmt_auth_failed(conn: *mut hci_conn, hci_status: u8) {
    void mgmt_auth_failed(struct hci_conn *conn, u8 hci_status)
    {
    struct mgmt_ev_auth_failed ev;
    struct mgmt_pending_cmd *cmd;
    let mut status: u8 = mgmt_status(hci_status);
    bacpy(&ev.addr.bdaddr, &conn.dst);
    ev.addr.type = link_to_bdaddr(conn.type, conn.dst_type);
    ev.status = status;
    cmd = remove_pairing(conn);
    mgmt_event(MGMT_EV_AUTH_FAILED, conn.hdev, &ev, sizeof(ev),
    cmd ? cmd.sk : core::ptr::null_mut());
    if (cmd) {
    cmd.cmd_complete(cmd, status);
    mgmt_pending_free(cmd);
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_auth_enable_complete(hdev: *mut hci_dev, status: u8) {
    void mgmt_auth_enable_complete(struct hci_dev *hdev, u8 status)
    {
    let mut match: cmd_lookup = { core::ptr::null_mut(), hdev };
    bool changed;
    if (status) {
    let mut mgmt_err: u8 = mgmt_status(status);
...
#[no_mangle]
unsafe extern "C" fn sk_lookup(cmd: *mut mgmt_pending_cmd, data: *mut c_void) {
    ...
    u8 status)
    {
    let mut match: cmd_lookup = { core::ptr::null_mut(), hdev, mgmt_status(status) };
    ...
    3, HCI_MGMT_DEV_CLASS_EVENTS, core::ptr::null_mut());
    ext_info_changed(hdev, core::ptr::null_mut());
    }
    if (match.sk)
    sock_put(match.sk);
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_set_local_name_complete(hdev: *mut hci_dev, name: *mut u8, status: u8) {
...
//
    ...
    HCI_MGMT_LOCAL_NAME_EVENTS, cmd ? cmd.sk : core::ptr::null_mut());
    ext_info_changed(hdev, cmd ? cmd.sk : core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn has_uuid(uuid: *mut u8, uuid_count: u16, (*uuids)[16]: *mut u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn eir_has_uuids(eir: *mut u8, eir_len: u16, uuid_count: u16, (*uuids)[16]: *mut u8) -> bool {
    static bool eir_has_uuids(u8 *eir, u16 eir_len, u16 uuid_count, u8 (*uuids)[16])
    {
    let mut parsed: u16 = 0;
    while (parsed < eir_len) {
    let mut field_len: u8 = eir[0];
    u8 uuid[16];
    int i;
    if (field_len == 0)
    break;
...
// Append scan response data to event
    ...
    let mut report_device: bool = hci_discovery_active(hdev);
...
//
    ...
    report_device = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !hci_is_adv_monitoring(hdev)) -> else {
...
// Check for limited discoverable bit
    ...
    u8 *flags = eir_get_data(eir, eir_len, EIR_FLAGS, core::ptr::null_mut());
...
// Copy EIR or advertising data into event
    skb_put_data(skb, eir, eir_len);
    if (dev_class && !eir_get_data(eir, eir_len, EIR_CLASS_OF_DEV, core::ptr::null_mut())) {
    u8 eir_cod[5];
...
// Append scan response data to event
    skb_put_data(skb, scan_rsp, scan_rsp_len);
    ev.eir_len = cpu_to_le16(eir_len + scan_rsp_len);
    mgmt_adv_monitor_device_found(hdev, bdaddr, report_device, skb, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_discovering(hdev: *mut hci_dev, discovering: u8) {
    ...
    mgmt_event(MGMT_EV_DISCOVERING, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn mgmt_suspending(hdev: *mut hci_dev, state: u8) {
    void mgmt_suspending(struct hci_dev *hdev, u8 state)
    {
    struct mgmt_ev_controller_suspend ev;
    ev.suspend_state = state;
    mgmt_event(MGMT_EV_CONTROLLER_SUSPEND, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
    ...
    mgmt_event(MGMT_EV_CONTROLLER_RESUME, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgmt_init() -> c_int {
    int mgmt_init(void)
    {
    ...
    mgmt_event(MGMT_EV_CONN_SUBRATE, hdev, &ev, sizeof(ev), core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn mgmt_exit() {
    void mgmt_exit(void)
    {
    hci_mgmt_chan_unregister(&chan);
    }
#[no_mangle]
pub unsafe extern "C" fn mgmt_cleanup(sk: *mut sock) {
