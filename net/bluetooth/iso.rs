...
pub struct iso_conn {
    ...
    pub __ISO_CONN_NUM_FLAGS): DECLARE_BITMAP(flags,,
...
pub const EIR_SERVICE_DATA_LENGTH: c_int = 4;

pub const EIR_BAA_SERVICE_UUID: c_uint = 0x1851;
...
#[no_mangle]
unsafe extern "C" fn iso_conn_free(ref: *mut kref) {
...
// Check we are not racing with iso_conn_add
    ...
    conn.hcon.iso_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iso_conn_put(conn: *mut iso_conn) {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_timeout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_set_timer(sk: *mut sock, timeout: c_long) {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_clear_timer(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_disable_timer(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iso_chan_del(sk: *mut sock, err: c_int) {
    static void iso_chan_del(struct sock *sk, int err)
    {
    struct iso_conn *conn;
    struct sock *parent;
    conn = iso_pi(sk).conn;
    iso_pi(sk).conn = core::ptr::null_mut();
    BT_DBG("sk %p, conn %p, err %d", sk, conn, err);
    if (conn) {
    iso_conn_lock(conn);
    conn.sk = core::ptr::null_mut();
    iso_conn_unlock(conn);
    iso_conn_put(conn);
    }
...
#[no_mangle]
unsafe extern "C" fn iso_conn_del(hcon: *mut hci_conn, err: c_int) {
...
// No sk access to conn->hcon any more (lock_sock + hdev->lock)
    spin_lock(&hcon.proto_lock);
    iso_conn_lock(conn);
    conn.hcon = core::ptr::null_mut();
    hcon.iso_data = core::ptr::null_mut();
    iso_conn_unlock(conn);
    spin_unlock(&hcon.proto_lock);
    iso_conn_put(conn);
    }
...
#[no_mangle]
pub unsafe extern "C" fn le_addr_type(bdaddr_type: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn iso_connect_bis(sk: *mut sock) -> c_int {
...
// Update SID if it was not set
    ...
    err = iso_chan_add(conn, sk, core::ptr::null_mut());
    iso_conn_put(conn);
    if (err)
    goto unlock;
...
#[no_mangle]
unsafe extern "C" fn iso_connect_cis(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iso_recv_frame(conn: *mut iso_conn, skb: *mut sk_buff) {
...
//
    ...
    iso_sock_match_t match, void *data)
    {
    struct sock *sk = core::ptr::null_mut(), *sk1 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iso_sock_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_cleanup_listen(parent: *mut sock) {
    static void iso_sock_cleanup_listen(struct sock *parent)
    {
    struct sock *sk;
    BT_DBG("parent %p", parent);
// Close not yet accepted channels
    while ((sk = bt_accept_dequeue(parent, core::ptr::null_mut()))) {
    iso_sock_close(sk);
    iso_sock_kill(sk);
...
//
#[no_mangle]
unsafe extern "C" fn iso_sock_kill(sk: *mut sock) {
    static void iso_sock_kill(struct sock *sk)
    {
    iso_sock_disable_timer(sk);
    lock_sock(sk);
...
// Sock is dead, so set conn->sk to NULL to avoid possible UAF
    ...
    iso_pi(sk).conn.sk = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iso_sock_disconn(sk: *mut sock) {
    static void iso_sock_disconn(struct sock *sk)
    {
    struct sock *bis_sk;
...
#[no_mangle]
unsafe extern "C" fn __iso_sock_close(sk: *mut sock) {
...
// Must be called on unlocked socket.
#[no_mangle]
unsafe extern "C" fn iso_sock_close(sk: *mut sock) {
    static void iso_sock_close(struct sock *sk)
    {
    iso_sock_disable_timer(sk);
    lock_sock(sk);
...
#[no_mangle]
unsafe extern "C" fn iso_sock_init(sk: *mut sock, parent: *mut sock) {
...
// Set address type as public as default src address is BDADDR_ANY
    ...
    if (!sk)
    return -ENOMEM;
    iso_sock_init(sk, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn iso_listen_bis(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iso_listen_cis(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
//
    ...
    struct sockaddr_iso *sa = (struct sockaddr_iso *)addr;
    struct sock *sk = sock.sk;
    let mut len: c_int = sizeof(struct sockaddr_iso);
    ...
    iso_pi(sk).conn.hcon : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iso_conn_defer_accept(conn: *mut hci_conn) {
...
#[no_mangle]
unsafe extern "C" fn iso_conn_big_sync(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_io_qos(qos: *mut bt_iso_io_qos) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_ucast_qos(qos: *mut bt_iso_qos) -> bool {
    static bool check_ucast_qos(struct bt_iso_qos *qos)
    {
...
#[no_mangle]
unsafe extern "C" fn check_bcast_qos(qos: *mut bt_iso_qos) -> bool {
    static bool check_bcast_qos(struct bt_iso_qos *qos)
    {
    ...
    struct sock *sk = sock.sk;
    let mut err: c_int = 0;
    let mut qos: bt_iso_qos = default_qos;
    u32 opt;
    BT_DBG("sk %p", sk);
    lock_sock(sk);
    switch (optname) {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_shutdown(sock: *mut socket, how: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iso_sock_ready(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iso_match_big(sk: *mut sock, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iso_match_big_hcon(sk: *mut sock, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iso_match_pa_sync_flag(sk: *mut sock, data: *mut c_void) -> bool {
    static bool iso_match_pa_sync_flag(struct sock *sk, void *data)
    {
    return test_bit(BT_SK_PA_SYNC, &iso_pi(sk).flags);
    }
#[no_mangle]
unsafe extern "C" fn iso_match_dst(sk: *mut sock, data: *mut c_void) -> bool {
    static bool iso_match_dst(struct sock *sk, void *data)
    {
    return !bacmp(&iso_pi(sk).dst, (bdaddr_t *)data);
    }
#[no_mangle]
unsafe extern "C" fn iso_conn_ready(conn: *mut iso_conn) {
    static void iso_conn_ready(struct iso_conn *conn)
    {
    struct sock *parent = core::ptr::null_mut();
    struct sock *sk;
    struct hci_ev_le_big_sync_established *ev = core::ptr::null_mut();
    struct hci_ev_le_pa_sync_established *ev2 = core::ptr::null_mut();
    struct hci_ev_le_per_adv_report *ev3 = core::ptr::null_mut();
    struct hci_conn *hcon;
    struct hci_dev *hdev;
    BT_DBG("conn %p", conn);
    iso_conn_lock(conn);
...
// The listener may have been closed concurrently.
    ...
    sk = iso_sock_alloc(sock_net(parent), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn iso_match_sid(sk: *mut sock, data: *mut c_void) -> bool {
    static bool iso_match_sid(struct sock *sk, void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn iso_match_sid_past(sk: *mut sock, data: *mut c_void) -> bool {
    static bool iso_match_sid_past(struct sock *sk, void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn iso_match_sync_handle(sk: *mut sock, data: *mut c_void) -> bool {
    static bool iso_match_sync_handle(struct sock *sk, void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn iso_match_sync_handle_pa_report(sk: *mut sock, data: *mut c_void) -> bool {
    static bool iso_match_sync_handle_pa_report(struct sock *sk, void *data)
    {
...
#[no_mangle]
pub unsafe extern "C" fn iso_connect_ind(hdev: *mut hci_dev, bdaddr: *mut bdaddr_t, flags: *mut __u8) -> c_int {
...
// Try to get PA sync socket, if it exists
    ...
    struct hci_conn *hcon;
    lock_sock(sk);
    hcon = iso_pi(sk).conn ? iso_pi(sk).conn.hcon : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iso_connect_cfm(hcon: *mut hci_conn, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn iso_disconn_cfm(hcon: *mut hci_conn, reason: __u8) {
...
#[no_mangle]
pub unsafe extern "C" fn iso_recv(hdev: *mut hci_dev, handle: u16, skb: *mut sk_buff, flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iso_debugfs_show(f: *mut seq_file, p: *mut c_void) -> c_int {
    ...
    static bool inited;
#[no_mangle]
pub unsafe extern "C" fn iso_inited() -> bool {
    bool iso_inited(void)
    {
    return inited;
    }
#[no_mangle]
pub unsafe extern "C" fn iso_init() -> c_int {
    int iso_init(void)
    {
    int err;
    ...
    err = bt_procfs_init(&init_net, "iso", &iso_sk_list, core::ptr::null_mut());
    if (err < 0) {
    ...
    core::ptr::null_mut(), &iso_debugfs_fops);
    inited = true;
    return 0;
    error:
...
#[no_mangle]
pub unsafe extern "C" fn iso_exit() -> c_int {
    int iso_exit(void)
    {
    if (!inited)
    return -EALREADY;
