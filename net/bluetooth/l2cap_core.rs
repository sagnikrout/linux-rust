...
//! Source: net/bluetooth/l2cap_core.c
#![no_std]
...
pub const LE_FLOWCTL_MAX_CREDITS: c_int = 65535;
    bool disable_ertm;
    let mut enable_ecred: bool = IS_ENABLED(CONFIG_BT_LE_L2CAP_ECRED);
    let mut l2cap_feat_mask: static u32 = L2CAP_FEAT_FIXED_CHAN | L2CAP_FEAT_UCD;
...
#[no_mangle]
pub unsafe extern "C" fn bdaddr_type(link_type: u8, bdaddr_type: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn bdaddr_src_type(hcon: *mut hci_conn) -> u8 {
    static inline u8 bdaddr_src_type(struct hci_conn *hcon)
    {
    return bdaddr_type(hcon.type, hcon.src_type);
    }
#[no_mangle]
pub unsafe extern "C" fn bdaddr_dst_type(hcon: *mut hci_conn) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_add_psm(chan: *mut l2cap_chan, src: *mut bdaddr_t, psm: __le16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_add_scid(chan: *mut l2cap_chan, scid: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_alloc_cid(conn: *mut l2cap_conn) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn l2cap_state_change(chan: *mut l2cap_chan, state: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_set_err(chan: *mut l2cap_chan, err: c_int) {
    static inline void l2cap_chan_set_err(struct l2cap_chan *chan, int err)
    {
    chan.ops.state_change(chan, chan.state, err);
    }
#[no_mangle]
unsafe extern "C" fn __set_retrans_timer(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn __set_monitor_timer(chan: *mut l2cap_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn l2cap_seq_list_init(seq_list: *mut l2cap_seq_list, size: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_seq_list_free(seq_list: *mut l2cap_seq_list) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_seq_list_pop(seq_list: *mut l2cap_seq_list) -> u16 {
    static inline u16 l2cap_seq_list_pop(struct l2cap_seq_list *seq_list)
    {
    let mut seq: u16 = seq_list.head;
    let mut mask: u16 = seq_list.mask;
...
#[no_mangle]
unsafe extern "C" fn l2cap_seq_list_clear(seq_list: *mut l2cap_seq_list) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_seq_list_append(seq_list: *mut l2cap_seq_list, seq: u16) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_timeout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_destroy(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_hold(c: *mut l2cap_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_put(c: *mut l2cap_chan) {
...
//
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_set_defaults(chan: *mut l2cap_chan, pchan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_le_rx_credits(chan: *mut l2cap_chan) -> __u16 {
    static __u16 l2cap_le_rx_credits(struct l2cap_chan *chan)
    {
    let mut sdu_len: usize = chan.sdu ? chan.sdu.len : 0;
    if (chan.mps == 0)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn l2cap_le_flowctl_init(chan: *mut l2cap_chan, tx_credits: u16) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_ecred_init(chan: *mut l2cap_chan, tx_credits: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn __l2cap_chan_add(conn: *mut l2cap_conn, chan: *mut l2cap_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_add(conn: *mut l2cap_conn, chan: *mut l2cap_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_del(chan: *mut l2cap_chan, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_conn_update_id_addr(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_le_connect_reject(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_ecred_connect_reject(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_connect_reject(chan: *mut l2cap_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_close(chan: *mut l2cap_chan, reason: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(LE_LINK: conn->hcon->type ==) -> else {
    switch (chan.mode) {
    case L2CAP_MODE_LE_FLOWCTL:
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_get_auth_type(chan: *mut l2cap_chan) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_check_security(chan: *mut l2cap_chan, initiator: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_get_ident(conn: *mut l2cap_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_do_send(chan: *mut l2cap_chan, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn __unpack_enhanced_control(enh: u16, control: *mut l2cap_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn __unpack_extended_control(ext: u32, control: *mut l2cap_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn __pack_extended_control(control: *mut l2cap_ctrl) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __pack_enhanced_control(control: *mut l2cap_ctrl) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn __ertm_hdr_size(chan: *mut l2cap_chan) -> c_uint {
    ...
    struct sk_buff *skb;
    struct l2cap_hdr *lh;
    let mut hlen: c_int = __ertm_hdr_size(chan);
    ...
    if (chan.fcs == L2CAP_FCS_CRC16) {
    let mut fcs: u16 = crc16(0, (u8 *)skb.data, skb.len);
...
#[no_mangle]
pub unsafe extern "C" fn if(L2CAP_SUPER_RNR: control->super ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn l2cap_send_rr_or_rnr(chan: *mut l2cap_chan, poll: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn __l2cap_no_conn_pending(chan: *mut l2cap_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_send_conn_req(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_ready(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_le_connect(chan: *mut l2cap_chan) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct l2cap_ecred_conn_data {
    struct {
    pub req: l2cap_ecred_conn_req_hdr,
    pub scid: [__le16; L2CAP_ECRED_CONN_SCID_MAX],
    pub pdu: } __packed,
...
#[no_mangle]
unsafe extern "C" fn l2cap_ecred_defer_connect(chan: *mut l2cap_chan, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_ecred_connect(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_le_start(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_start_connection(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_request_info(conn: *mut l2cap_conn) {
...
//
    let mut min_key_size: c_int = hcon.hdev.min_enc_key_size;
...
#[no_mangle]
unsafe extern "C" fn l2cap_do_start(chan: *mut l2cap_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_mode_supported(mode: __u8, feat_mask: __u32) -> c_int {
    static inline int l2cap_mode_supported(__u8 mode, __u32 feat_mask)
    {
    let mut local_feat_mask: u32 = l2cap_feat_mask;
    if (!disable_ertm)
...
#[no_mangle]
unsafe extern "C" fn l2cap_send_disconn_req(chan: *mut l2cap_chan, err: c_int) {
    static void l2cap_send_disconn_req(struct l2cap_chan *chan, int err)
    {
    struct l2cap_conn *conn = chan.conn;
...
// ---- L2CAP connections ----
#[no_mangle]
unsafe extern "C" fn l2cap_conn_start(conn: *mut l2cap_conn) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_le_conn_ready(conn: *mut l2cap_conn) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_conn_ready(conn: *mut l2cap_conn) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_conn_unreliable(conn: *mut l2cap_conn, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_info_timeout(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn l2cap_register_user(conn: *mut l2cap_conn, user: *mut l2cap_user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_unregister_user(conn: *mut l2cap_conn, user: *mut l2cap_user) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_unregister_all_users(conn: *mut l2cap_conn) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_conn_del(hcon: *mut hci_conn, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_conn_free(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_conn_put(conn: *mut l2cap_conn) {
...
//
    ...
    u8 link_type)
    {
    struct l2cap_chan *c, *tmp, *c1 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn l2cap_monitor_timeout(work: *mut work_struct) {
    static void l2cap_monitor_timeout(struct work_struct *work)
    {
    struct l2cap_chan *chan = container_of(work, struct l2cap_chan,
    monitor_timer.work);
...
#[no_mangle]
unsafe extern "C" fn l2cap_retrans_timeout(work: *mut work_struct) {
    static void l2cap_retrans_timeout(struct work_struct *work)
    {
    struct l2cap_chan *chan = container_of(work, struct l2cap_chan,
    retrans_timer.work);
...
#[no_mangle]
unsafe extern "C" fn l2cap_ertm_send(chan: *mut l2cap_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_ertm_resend(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_send_ack(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_le_flowctl_send(chan: *mut l2cap_chan) {
    ...
    size_t len)
    {
    struct sock *sk = skb ? skb.sk : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn l2cap_send_srej(chan: *mut l2cap_chan, txseq: u16) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_send_srej_tail(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_send_srej_list(chan: *mut l2cap_chan, txseq: u16) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_process_reqseq(chan: *mut l2cap_chan, reqseq: u16) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_abort_rx_srej_sent(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_raw_recv(conn: *mut l2cap_conn, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_add_conf_opt(ptr: *mut c_void, type: u8, len: u8, val: c_ulong, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_add_opt_efs(ptr: *mut c_void, chan: *mut l2cap_chan, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_ack_timeout(work: *mut work_struct) {
    static void l2cap_ack_timeout(struct work_struct *work)
    {
    struct l2cap_chan *chan = container_of(work, struct l2cap_chan,
    ack_timer.work);
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_ertm_init(chan: *mut l2cap_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_select_mode(mode: __u8, remote_feat_mask: __u16) -> __u8 {
...
#[no_mangle]
pub unsafe extern "C" fn __l2cap_ews_supported(conn: *mut l2cap_conn) -> bool {
    static inline bool __l2cap_ews_supported(struct l2cap_conn *conn)
    {
    return (conn.feat_mask & L2CAP_FEAT_EXT_WINDOW);
    }
#[no_mangle]
pub unsafe extern "C" fn __l2cap_efs_supported(conn: *mut l2cap_conn) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_txwin_setup(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_mtu_auto(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_build_conf_req(chan: *mut l2cap_chan, data: *mut c_void, data_size: usize) -> c_int {
    static int l2cap_build_conf_req(struct l2cap_chan *chan, void *data, size_t data_size)
    {
    struct l2cap_conf_req *req = data;
    let mut rfc: l2cap_conf_rfc = { .mode = chan.mode };
    void *ptr = req.data;
...
#[no_mangle]
unsafe extern "C" fn l2cap_parse_conf_req(chan: *mut l2cap_chan, data: *mut c_void, data_size: usize) -> c_int {
    ...
    let mut len: c_int = chan.conf_len;
    int type, hint, olen;
    unsigned long val;
    let mut rfc: l2cap_conf_rfc = { .mode = L2CAP_MODE_BASIC };
    struct l2cap_conf_efs efs;
    let mut remote_efs: u8 = 0;
    let mut mtu: u16 = 0;
    let mut result: u16 = L2CAP_CONF_SUCCESS;
    u16 size;
    BT_DBG("chan %p", chan);
    while (len >= L2CAP_CONF_OPT_SIZE) {
    let mut ret: c_int = l2cap_get_conf_opt(&req, req_end, &type, &olen, &val);
    if (ret < 0)
    break;
    len -= ret;
...
// Send PENDING Conf Rsp
    ...
    while (len >= L2CAP_CONF_OPT_SIZE) {
    let mut ret: c_int = l2cap_get_conf_opt(&rsp, rsp_end, &type, &olen, &val);
    if (ret < 0)
    break;
    len -= ret;
    switch (type) {
...
#[no_mangle]
pub unsafe extern "C" fn __l2cap_le_connect_rsp_defer(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_ecred_list_defer(chan: *mut l2cap_chan, data: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct l2cap_ecred_rsp_data {
    struct {
    pub rsp: l2cap_ecred_conn_rsp_hdr,
    pub scid: [__le16; L2CAP_ECRED_MAX_CID],
    pub pdu: } __packed,
    pub count: c_int,
}

#[no_mangle]
unsafe extern "C" fn l2cap_ecred_rsp_defer(chan: *mut l2cap_chan, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn __l2cap_ecred_conn_rsp_defer(chan: *mut l2cap_chan) {
    void __l2cap_ecred_conn_rsp_defer(struct l2cap_chan *chan)
    {
    struct l2cap_conn *conn = chan.conn;
    struct l2cap_ecred_rsp_data data;
    let mut id: u16 = chan.ident;
...
#[no_mangle]
pub unsafe extern "C" fn __l2cap_connect_rsp_defer(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_conf_rfc_get(chan: *mut l2cap_chan, rsp: *mut c_void, len: c_int) {
...
//
    let mut txwin_ext: u16 = chan.ack_win;
    struct l2cap_conf_rfc rfc = {
    .mode = chan.mode,
...
//
    ...
    struct l2cap_conn_rsp rsp;
    struct l2cap_chan *chan = core::ptr::null_mut(), *pchan = core::ptr::null_mut();
    int result, status = L2CAP_CS_NO_INFO;
    let mut dcid: u16 = 0, scid = __le16_to_cpu(req.scid);
    let mut psm: __le16 = req.psm;
...
#[no_mangle]
pub unsafe extern "C" fn set_default_fcs(chan: *mut l2cap_chan) {
...
//
    ...
    chan.fcs = L2CAP_FCS_NONE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !test_bit(CONF_RECV_NO_FCS, _arg: &chan->conf_state)) -> else {
...
// Send rsp for BR/EDR channel
    ...
    struct l2cap_chan *chan;
    let mut len: c_int = cmd_len - sizeof(*rsp);
    let mut err: c_int = 0;
    if (cmd_len < sizeof(*rsp))
    return -EPROTO;
    scid   = __le16_to_cpu(rsp.scid);
...
// throw out any old stored conf requests
    ...
    u8 buf[8];
    let mut feat_mask: u32 = l2cap_feat_mask;
...
#[no_mangle]
unsafe extern "C" fn l2cap_put_ident(conn: *mut l2cap_conn, code: u8, id: u8) {
...
//
    ...
    let mut scid: u16 = __le16_to_cpu(req.scid[i]);
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_sig_send_rej(conn: *mut l2cap_conn, ident: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_sig_send_mtu_rej(conn: *mut l2cap_conn, ident: u8) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_check_fcs(chan: *mut l2cap_chan, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_send_i_or_rr_or_rnr(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_resegment(chan: *mut l2cap_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_busy(chan: *mut l2cap_chan, busy: c_int) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_rx_queued_iframes(chan: *mut l2cap_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_classify_txseq(chan: *mut l2cap_chan, txseq: u16) -> u8 {
...
//
    ...
    {
    let mut err: c_int = 0;
    let mut txseq: u16 = control.txseq;
    let mut skb_in_use: bool = false;
    BT_DBG("chan %p, control %p, skb %p, event %d", chan, control, skb,
    event);
    switch (event) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_finish_move(chan: *mut l2cap_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __valid_reqseq(chan: *mut l2cap_chan, reqseq: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn l2cap_data_rcv(chan: *mut l2cap_chan, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_le_send_credits(chan: *mut l2cap_chan) {
    static void l2cap_chan_le_send_credits(struct l2cap_chan *chan)
    {
    struct l2cap_conn *conn = chan.conn;
    struct l2cap_le_credits pkt;
    let mut return_credits: u16 = l2cap_le_rx_credits(chan);
    int ident;
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_rx_avail(chan: *mut l2cap_chan, rx_avail: isize) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_ecred_recv(chan: *mut l2cap_chan, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_ecred_data_rcv(chan: *mut l2cap_chan, skb: *mut sk_buff) -> c_int {
...
// Detect if remote is not able to use the selected MPS
    ...
    let mut mps_len: u16 = skb.len + L2CAP_SDULEN_SIZE;
...
#[no_mangle]
unsafe extern "C" fn l2cap_recv_frame(conn: *mut l2cap_conn, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn process_pending_rx(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn is_valid_psm(psm: u16, dst_type: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn l2cap_chan_by_pid(chan: *mut l2cap_chan, data: *mut c_void) {
...
//
    ...
    let mut auth_type: u8 = l2cap_get_auth_type(chan);
...
#[no_mangle]
unsafe extern "C" fn l2cap_ecred_reconfigure(chan: *mut l2cap_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_chan_reconfigure(chan: *mut l2cap_chan, mtu: __u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_connect_ind(hdev: *mut hci_dev, bdaddr: *mut bdaddr_t) -> c_int {
    int l2cap_connect_ind(struct hci_dev *hdev, bdaddr_t *bdaddr)
    {
    let mut exact: c_int = 0, lm1 = 0, lm2 = 0;
    struct l2cap_chan *c;
...
//
    ...
    struct hci_conn *hcon)
    {
    let mut src_type: u8 = bdaddr_src_type(hcon);
    read_lock(&chan_list_lock);
    if (c)
...
#[no_mangle]
unsafe extern "C" fn l2cap_connect_cfm(hcon: *mut hci_conn, status: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_disconn_ind(hcon: *mut hci_conn) -> c_int {
    int l2cap_disconn_ind(struct hci_conn *hcon)
    {
    struct l2cap_conn *conn;
    let mut ret: c_int = HCI_ERROR_REMOTE_USER_TERM;
    BT_DBG("hcon %p", hcon);
    spin_lock(&hcon.proto_lock);
...
#[no_mangle]
unsafe extern "C" fn l2cap_disconn_cfm(hcon: *mut hci_conn, reason: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_check_encryption(chan: *mut l2cap_chan, encrypt: u8) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_security_cfm(hcon: *mut hci_conn, status: u8, encrypt: u8) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_recv_len(conn: *mut l2cap_conn, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_recv_reset(conn: *mut l2cap_conn) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_debugfs_show(f: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_exit() {
