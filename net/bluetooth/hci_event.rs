...
//! Source: net/bluetooth/hci_event.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hci_cc_reset(hdev: *mut hci_dev, data: *mut c_void, skb: *mut sk_buff) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !rp->status) -> else {
    else if (!rp.status)
...
//
    ...
    let mut min: u16 = le16_to_cpu(rp.grps[i].min);
...
//
    ...
    struct adv_info *adv = core::ptr::null_mut(), *n;
    struct hci_ev_status *rp = data;
    bt_dev_dbg(hdev, "status 0x%2.2x", rp.status);
    if (rp.status)
    return rp.status;
    ...
    adv.enabled = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !set->handle) -> else {
    else if (!set.handle)
...
#[no_mangle]
unsafe extern "C" fn has_pending_adv_report(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn clear_pending_adv_report(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn le_set_scan_enable_complete(hdev: *mut hci_dev, enable: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_inquiry(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_create_conn(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_add_sco(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_auth_requested(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_set_conn_encrypt(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_resolve_next_name(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_remote_name_req(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_read_remote_features(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_read_remote_ext_features(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_setup_sync_conn(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_enhanced_setup_sync_conn(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_sniff_mode(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_exit_sniff_mode(hdev: *mut hci_dev, status: __u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_disconnect(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn ev_bdaddr_type(hdev: *mut hci_dev, type: u8, resolved: *mut bool) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_le_create_conn(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_le_ext_create_conn(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_le_set_phy(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_le_read_remote_features(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_le_start_enc(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_switch_role(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_read_enc_key_size(hdev: *mut hci_dev, conn: *mut hci_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_reject_conn(hdev: *mut hci_dev, bdaddr: *mut bdaddr_t) {
    ...
    let mut mask: c_int = hdev.link_mode;
...
#[no_mangle]
pub unsafe extern "C" fn handle_cmd_cnt_and_timer(hdev: *mut hci_dev, ncmd: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_unbound_cis_failed(hdev: *mut hci_dev, cig: u8, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_le_create_big(hdev: *mut hci_dev, status: u8) {
    static void hci_cs_le_create_big(struct hci_dev *hdev, u8 status)
    {
    bt_dev_dbg(hdev, "status 0x%2.2x", status);
    }
#[no_mangle]
unsafe extern "C" fn hci_cs_le_read_all_remote_features(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn hci_cs_le_create_cis(hdev: *mut hci_dev, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn conn_set_key(conn: *mut hci_conn, key_type: u8, pin_len: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn eir_get_length(eir: *mut u8, eir_len: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn hci_get_auth_req(conn: *mut hci_conn) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn bredr_oob_data_present(conn: *mut hci_conn) -> u8 {
...
//
    ...
    let mut delay: c_int = msecs_to_jiffies(hdev.auto_accept_delay);
...
//
    ...
    let mut handle: u16 = le16_to_cpu(ev.handle);
    struct hci_conn *conn;
...
#[no_mangle]
unsafe extern "C" fn hci_le_pa_term_sync(hdev: *mut hci_dev, handle: __le16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ext_evt_type_to_legacy(hdev: *mut hci_dev, evt_type: u16) -> u8 {
    static u8 ext_evt_type_to_legacy(struct hci_dev *hdev, u16 evt_type)
    {
    let mut pdu_type: u16 = evt_type & ~LE_EXT_ADV_DATA_STATUS_MASK;
    if (!pdu_type)
...
#[no_mangle]
unsafe extern "C" fn le_phy_qos(phy: u8) -> u8 {
    ...
    let mut pending: bool = false;
    let mut handle: u16 = __le16_to_cpu(ev.handle);
...
#[no_mangle]
unsafe extern "C" fn hci_le_reject_cis(hdev: *mut hci_dev, handle: __le16) {
...
#[no_mangle]
unsafe extern "C" fn hci_le_accept_cis(hdev: *mut hci_dev, handle: __le16) {
...
#[no_mangle]
unsafe extern "C" fn hci_iso_term_big_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    let mut handle: u16 = le16_to_cpu(ev.bis[i]);
    __le32 interval;
...
#[no_mangle]
unsafe extern "C" fn hci_vendor_evt(hdev: *mut hci_dev, data: *mut c_void, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn hci_event_packet(hdev: *mut hci_dev, skb: *mut sk_buff) {
    void hci_event_packet(struct hci_dev *hdev, struct sk_buff *skb)
    {
    struct hci_event_hdr *hdr = (void *) skb.data;
    let mut req_complete: hci_req_complete_t = core::ptr::null_mut();
    let mut req_complete_skb: hci_req_complete_skb_t = core::ptr::null_mut();
    struct sk_buff *orig_skb = core::ptr::null_mut();
    let mut status: u8 = 0, event, req_evt = 0;
    let mut opcode: u16 = HCI_OP_NOP;
