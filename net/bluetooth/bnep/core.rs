...
//! Source: net/bluetooth/bnep/core.c
#![no_std]
...
//
    ...
    let mut compress_src: static bool = true;
    let mut compress_dst: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn __bnep_link_session(s: *mut bnep_session) {
    static void __bnep_link_session(struct bnep_session *s)
    {
    list_add(&s.list, &bnep_session_list);
    }
#[no_mangle]
unsafe extern "C" fn __bnep_unlink_session(s: *mut bnep_session) {
    static void __bnep_unlink_session(struct bnep_session *s)
    {
    list_del(&s.list);
    }
#[no_mangle]
unsafe extern "C" fn bnep_send(s: *mut bnep_session, data: *mut c_void, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnep_send_rsp(s: *mut bnep_session, ctrl: u8, resp: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnep_set_default_proto_filter(s: *mut bnep_session) {
...
#[no_mangle]
unsafe extern "C" fn bnep_ctrl_set_netfilter(s: *mut bnep_session, data: *mut __be16, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnep_ctrl_set_mcfilter(s: *mut bnep_session, data: *mut u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnep_rx_control(s: *mut bnep_session, data: *mut c_void, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnep_rx_extension(s: *mut bnep_session, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnep_rx_frame(s: *mut bnep_session, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnep_tx_frame(s: *mut bnep_session, skb: *mut sk_buff) -> c_int {
    static int bnep_tx_frame(struct bnep_session *s, struct sk_buff *skb)
    {
    struct ethhdr *eh = (void *) skb.data;
    struct socket *sock = s.sock;
    struct kvec iv[3];
    let mut len: c_int = 0, il = 0;
    let mut type: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn bnep_session(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnep_add_connection(req: *mut bnep_connadd_req, sock: *mut socket) -> c_int {
    int bnep_add_connection(struct bnep_connadd_req *req, struct socket *sock)
    {
    let mut valid_flags: u32 = BIT(BNEP_SETUP_RESPONSE);
...
#[no_mangle]
pub unsafe extern "C" fn bnep_del_connection(req: *mut bnep_conndel_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bnep_copy_ci(ci: *mut bnep_conninfo, s: *mut bnep_session) {
...
#[no_mangle]
pub unsafe extern "C" fn bnep_get_connlist(req: *mut bnep_connlist_req) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnep_get_conninfo(ci: *mut bnep_conninfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnep_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bnep_exit() -> void __exit {
