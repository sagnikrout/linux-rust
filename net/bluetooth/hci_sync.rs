...
//! Source: net/bluetooth/hci_sync.c
#![no_std]
...
// Free the request command so it is not used as response
    ...
    hdev.req_skb = core::ptr::null_mut();
    if (skb) {
...
// Drop sk reference if set
    ...
    {
    let mut len: c_int = HCI_COMMAND_HDR_SIZE + plen;
...
#[no_mangle]
unsafe extern "C" fn hci_req_sync_run(req: *mut hci_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_request_init(req: *mut hci_request, hdev: *mut hci_dev) {
...
// This function requires the caller holds hdev->req_lock.
    ...
    hdev.req_result = 0;
    skb = hdev.req_rsp;
    hdev.req_rsp = core::ptr::null_mut();
...
// This function requires the caller holds hdev->req_lock.
    ...
    {
    return __hci_cmd_sync_sk(hdev, opcode, plen, param, 0, timeout, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn hci_cmd_sync_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hci_cmd_sync_cancel_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn scan_disable_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int scan_disable_sync(struct hci_dev *hdev, void *data)
    {
    return hci_scan_disable_sync(hdev);
    }
#[no_mangle]
unsafe extern "C" fn interleaved_inquiry_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int interleaved_inquiry_sync(struct hci_dev *hdev, void *data)
    {
    return hci_inquiry_sync(hdev, DISCOV_INTERLEAVED_INQUIRY_LEN, 0);
    }
#[no_mangle]
unsafe extern "C" fn le_scan_disable(work: *mut work_struct) {
    ...
    goto _return;
    status = hci_cmd_sync_queue(hdev, scan_disable_sync, core::ptr::null_mut(), core::ptr::null_mut());
    if (status) {
...
//
    ...
    status = hci_cmd_sync_queue(hdev, interleaved_inquiry_sync, core::ptr::null_mut(), core::ptr::null_mut());
    if (status) {
    ...
    u8 filter_dup);
#[no_mangle]
unsafe extern "C" fn reenable_adv_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reenable_adv(work: *mut work_struct) {
    ...
    bt_dev_dbg(hdev, "");
    hci_dev_lock(hdev);
    status = hci_cmd_sync_queue(hdev, reenable_adv_sync, core::ptr::null_mut(), core::ptr::null_mut());
    if (status)
    bt_dev_err(hdev, "failed to reenable ADV: %d", status);
    hci_dev_unlock(hdev);
    }
#[no_mangle]
unsafe extern "C" fn cancel_adv_timeout(hdev: *mut hci_dev) {
...
//
    ...
    {
    struct adv_info *adv_instance, *n, *next_instance = core::ptr::null_mut();
    int err;
    u8 rem_inst;
...
// Don't advertise a removed instance.
    ...
    next_instance = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn adv_timeout_expire_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int adv_timeout_expire_sync(struct hci_dev *hdev, void *data)
    {
    let mut instance: u8 = *(u8 *)data;
    hci_clear_adv_instance_sync(hdev, core::ptr::null_mut(), instance, false);
...
#[no_mangle]
unsafe extern "C" fn adv_timeout_expire(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn is_interleave_scanning(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn interleave_scan_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hci_cmd_sync_init(hdev: *mut hci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn hci_cmd_sync_clear(hdev: *mut hci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn hci_cmd_sync_cancel(hdev: *mut hci_dev, err: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hci_cmd_sync_cancel_sync(hdev: *mut hci_dev, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn hci_update_eir_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_service_classes(hdev: *mut hci_dev) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn hci_update_class_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_advertising_allowed(hdev: *mut hci_dev, connectable: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv_use_rpa(hdev: *mut hci_dev, flags: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hci_set_random_addr_sync(hdev: *mut hci_dev, rpa: *mut bdaddr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_disable_ext_adv_legacy_instance_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_disable_ext_adv_instance_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
    ...
    u8 data[sizeof(*cp) + sizeof(*set) * 1];
    u8 size;
    struct adv_info *adv = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hci_set_ext_adv_data_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_set_adv_data_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_update_adv_data_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_setup_ext_adv_instance_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_set_ext_scan_rsp_data_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __hci_set_scan_rsp_data_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_update_scan_rsp_data_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_enable_ext_advertising_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
//
    if (adv && adv.timeout) {
    let mut duration: u16 = adv.timeout * MSEC_PER_SEC;
// Time = N * 10 ms
...
#[no_mangle]
pub unsafe extern "C" fn hci_start_ext_adv_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_disable_per_advertising_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_set_per_adv_data_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_enable_per_advertising_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_adv_bcast_annoucement(hdev: *mut hci_dev, adv: *mut adv_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_start_adv_sync(hdev: *mut hci_dev, instance: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_enable_advertising_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_advertising_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int enable_advertising_sync(struct hci_dev *hdev, void *data)
    {
    return hci_enable_advertising_sync(hdev);
    }
#[no_mangle]
pub unsafe extern "C" fn hci_enable_advertising(hdev: *mut hci_dev) -> c_int {
    int hci_enable_advertising(struct hci_dev *hdev)
    {
    if (!hci_dev_test_flag(hdev, HCI_ADVERTISING) &&
    list_empty(&hdev.adv_instances))
    return 0;
    return hci_cmd_sync_queue(hdev, enable_advertising_sync, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_terminate_big_sync(hdev: *mut hci_dev, handle: u8, reason: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_clear_adv_sets_sync(hdev: *mut hci_dev, sk: *mut sock) -> c_int {
...
// Disable instance 0x00 to disable all instances
    ...
    0, core::ptr::null_mut(), 0, HCI_CMD_TIMEOUT, sk);
    }
#[no_mangle]
unsafe extern "C" fn hci_clear_adv_sync(hdev: *mut hci_dev, sk: *mut sock, force: bool) -> c_int {
...
// Cleanup non-ext instances
    ...
    let mut instance: u8 = adv.instance;
    int err;
...
//
    ...
    u8 instance, bool force)
    {
    struct adv_info *next = core::ptr::null_mut();
    int err;
// Cancel any timeout concerning the removed instance(s).
    if (!instance || hdev.cur_adv_instance == instance)
    cancel_adv_timeout(hdev);
...
#[no_mangle]
pub unsafe extern "C" fn hci_read_rssi_sync(hdev: *mut hci_dev, handle: __le16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_read_clock_sync(hdev: *mut hci_dev, cp: *mut hci_cp_read_clock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_read_tx_power_sync(hdev: *mut hci_dev, handle: __le16, type: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_disable_advertising_sync(hdev: *mut hci_dev) -> c_int {
    int hci_disable_advertising_sync(struct hci_dev *hdev)
    {
    let mut enable: u8 = 0x00;
...
#[no_mangle]
unsafe extern "C" fn hci_le_set_addr_resolution_enable_sync(hdev: *mut hci_dev, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_scan_disable_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_scan_disable_sync(struct hci_dev *hdev)
    {
    int err;
...
#[no_mangle]
unsafe extern "C" fn scan_use_rpa(hdev: *mut hci_dev) -> bool {
    static bool scan_use_rpa(struct hci_dev *hdev)
    {
    return hci_dev_test_flag(hdev, HCI_PRIVACY);
    }
#[no_mangle]
unsafe extern "C" fn hci_start_interleave_scan(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cancel_interleave_scan(hdev: *mut hci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn hci_update_interleaved_scan_sync(hdev: *mut hci_dev) -> bool {
...
//
    ...
    let mut is_interleaving: bool = is_interleave_scanning(hdev);
...
#[no_mangle]
unsafe extern "C" fn hci_pause_advertising_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_resume_advertising_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_pause_addr_resolution(hdev: *mut hci_dev) -> c_int {
...
// Return if address resolution is disabled and RPA is not used.
    ...
    return __hci_cmd_sync_sk(hdev, opcode, 0, core::ptr::null_mut(), 0, HCI_CMD_TIMEOUT, sk);
    }
...
#[no_mangle]
unsafe extern "C" fn hci_le_clear_accept_list_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_le_clear_accept_list_sync(struct hci_dev *hdev)
    {
    if (!(hdev.commands[26] & 0x80))
    return 0;
    return __hci_cmd_sync_status(hdev, HCI_OP_LE_CLEAR_ACCEPT_LIST, 0, core::ptr::null_mut(),
    HCI_CMD_TIMEOUT);
    }
...
//
#[no_mangle]
unsafe extern "C" fn hci_update_accept_list_sync(hdev: *mut hci_dev) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn hci_passive_scan_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_passive_scan_sync(struct hci_dev *hdev)
    {
    u8 own_addr_type;
    u8 filter_policy;
    u16 window, interval;
    let mut filter_dups: u8 = LE_SCAN_FILTER_DUP_ENABLE;
    int err;
    if (hdev.scanning_paused) {
    bt_dev_dbg(hdev, "Scanning is paused for suspend");
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn hci_update_passive_scan_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_scan_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int update_scan_sync(struct hci_dev *hdev, void *data)
    {
    return hci_update_scan_sync(hdev);
    }
#[no_mangle]
pub unsafe extern "C" fn hci_update_scan(hdev: *mut hci_dev) -> c_int {
    int hci_update_scan(struct hci_dev *hdev)
    {
    return hci_cmd_sync_queue(hdev, update_scan_sync, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn update_passive_scan_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int update_passive_scan_sync(struct hci_dev *hdev, void *data)
    {
    return hci_update_passive_scan_sync(hdev);
    }
#[no_mangle]
pub unsafe extern "C" fn hci_update_passive_scan(hdev: *mut hci_dev) -> c_int {
...
// Only queue if it would have any effect
    ...
    hci_dev_test_flag(hdev, HCI_UNREGISTER))
    return 0;
    err = hci_cmd_sync_queue_once(hdev, update_passive_scan_sync, core::ptr::null_mut(),
    core::ptr::null_mut());
    return (err == -EEXIST) ? 0 : err;
    }
#[no_mangle]
pub unsafe extern "C" fn hci_write_sc_support_sync(hdev: *mut hci_dev, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_write_ssp_mode_sync(hdev: *mut hci_dev, mode: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_write_le_host_supported_sync(hdev: *mut hci_dev, le: u8, simul: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_powered_update_adv_sync(hdev: *mut hci_dev) -> c_int {
...
//
    if (!hci_dev_test_flag(hdev, HCI_LL_RPA_RESOLUTION)) {
    hci_le_add_resolve_list_sync(hdev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hci_write_auth_enable_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_write_fast_connectable_sync(hdev: *mut hci_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disconnected_accept_list_entries(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hci_write_scan_enable_sync(hdev: *mut hci_dev, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_update_scan_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_update_name_sync(hdev: *mut hci_dev, name: *const u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hci_powered_update_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_dev_get_bd_addr_from_property(hdev: *mut hci_dev) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hci_init_stage {
    pub hdev): *mut *mut int (func)(struct hci_dev,
}
...
// Read Local Version
#[no_mangle]
unsafe extern "C" fn hci_read_local_version_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_read_local_version_sync(struct hci_dev *hdev)
    {
    return __hci_cmd_sync_status(hdev, HCI_OP_READ_LOCAL_VERSION,
    0, core::ptr::null_mut(), HCI_CMD_TIMEOUT);
    }
// Read BD Address
#[no_mangle]
unsafe extern "C" fn hci_read_bd_addr_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_reset_sync(hdev: *mut hci_dev) -> c_int {
    int hci_reset_sync(struct hci_dev *hdev)
    {
    set_bit(HCI_RESET, &hdev.flags);
    return __hci_cmd_sync_status(hdev, HCI_OP_RESET, 0, core::ptr::null_mut(),
    HCI_CMD_TIMEOUT);
    }
// Send a raw HCI reset for use by vendor drivers
#[no_mangle]
pub unsafe extern "C" fn __hci_reset_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_init0_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_unconf_init_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_local_features_sync(hdev: *mut hci_dev) -> c_int {
...
// Read Local Commands
#[no_mangle]
unsafe extern "C" fn hci_read_local_cmds_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_init1_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_buffer_size_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_dev_class_sync(hdev: *mut hci_dev) -> c_int {
...
// Read Local Name
#[no_mangle]
unsafe extern "C" fn hci_read_local_name_sync(hdev: *mut hci_dev) -> c_int {
...
// Read Voice Setting
#[no_mangle]
unsafe extern "C" fn hci_read_voice_setting_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_num_supported_iac_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_current_iac_lap_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_clear_event_filter_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_write_ca_timeout_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_write_ca_timeout_sync(struct hci_dev *hdev)
    {
    let mut param: __le16 = cpu_to_le16(0x7d00);
    return __hci_cmd_sync_status(hdev, HCI_OP_WRITE_CA_TIMEOUT,
    sizeof(param), &param, HCI_CMD_TIMEOUT);
    }
// Enable SCO flow control if supported
#[no_mangle]
unsafe extern "C" fn hci_write_sync_flowctl_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_write_ssp_mode_1_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_write_eir_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_write_inquiry_mode_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_inq_rsp_tx_power_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_local_ext_features_sync(hdev: *mut hci_dev, page: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_local_ext_features_1_sync(hdev: *mut hci_dev) -> c_int {
...
// Read LE Buffer Size
#[no_mangle]
unsafe extern "C" fn hci_le_read_buffer_size_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_local_features_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_supported_states_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_init2_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_set_event_mask_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_stored_link_key_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_setup_link_policy_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_setup_link_policy_sync(struct hci_dev *hdev)
    {
    struct hci_cp_write_def_link_policy cp;
    let mut link_policy: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn hci_read_page_scan_activity_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_def_err_data_reporting_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_page_scan_type_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_local_ext_features_all_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_set_event_mask_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_adv_tx_power_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_tx_power_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_accept_list_size_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_resolv_list_size_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_clear_resolv_list_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_le_clear_resolv_list_sync(struct hci_dev *hdev)
    {
    if (!(hdev.commands[34] & 0x20))
    return 0;
    return __hci_cmd_sync_status(hdev, HCI_OP_LE_CLEAR_RESOLV_LIST, 0, core::ptr::null_mut(),
    HCI_CMD_TIMEOUT);
    }
// Set RPA timeout
#[no_mangle]
unsafe extern "C" fn hci_le_set_rpa_timeout_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_le_set_rpa_timeout_sync(struct hci_dev *hdev)
    {
    let mut timeout: __le16 = cpu_to_le16(hdev.rpa_timeout);
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_max_data_len_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_le_read_max_data_len_sync(struct hci_dev *hdev)
    {
    if (!(hdev.le_features[0] & HCI_LE_DATA_LEN_EXT))
    return 0;
    return __hci_cmd_sync_status(hdev, HCI_OP_LE_READ_MAX_DATA_LEN, 0, core::ptr::null_mut(),
    HCI_CMD_TIMEOUT);
    }
// Read LE Suggested Default Data Length
#[no_mangle]
unsafe extern "C" fn hci_le_read_def_data_len_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_le_read_def_data_len_sync(struct hci_dev *hdev)
    {
    if (!(hdev.le_features[0] & HCI_LE_DATA_LEN_EXT))
    return 0;
    return __hci_cmd_sync_status(hdev, HCI_OP_LE_READ_DEF_DATA_LEN, 0, core::ptr::null_mut(),
    HCI_CMD_TIMEOUT);
    }
// Read LE Number of Supported Advertising Sets
#[no_mangle]
unsafe extern "C" fn hci_le_read_num_support_adv_sets_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_set_le_support_sync(hdev: *mut hci_dev) -> c_int {
...
// LE Set Host Feature
#[no_mangle]
unsafe extern "C" fn hci_le_set_host_feature_sync(hdev: *mut hci_dev, bit: u16, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_conn_interval_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_set_def_rate_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_le_set_host_features_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_init3_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_delete_stored_link_key_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_set_event_mask_page_2_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_local_codecs_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_read_local_codecs_sync(struct hci_dev *hdev)
    {
    if (hdev.commands[45] & 0x04)
    hci_read_supported_codecs_v2(hdev);
#[no_mangle]
pub unsafe extern "C" fn if(0x20: hdev->commands[29] &) -> else {
...
#[no_mangle]
unsafe extern "C" fn hci_read_local_pairing_opts_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_get_mws_transport_config_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_read_sync_train_params_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_write_sc_support_1_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_write_sc_support_1_sync(struct hci_dev *hdev)
    {
    let mut support: u8 = 0x01;
    if (!hci_dev_test_flag(hdev, HCI_SSP_ENABLED) ||
...
//
#[no_mangle]
unsafe extern "C" fn hci_set_err_data_report_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_set_err_data_report_sync(struct hci_dev *hdev)
    {
    struct hci_cp_write_def_err_data_reporting cp;
    let mut enabled: bool = hci_dev_test_flag(hdev, HCI_WIDEBAND_SPEECH_ENABLED);
...
#[no_mangle]
unsafe extern "C" fn hci_le_set_write_def_data_len_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_le_set_default_phy_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_init4_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_init_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_dev_setup_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_dev_init_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_dev_open_sync(hdev: *mut hci_dev) -> c_int {
...
//
    ...
    hdev.sent_cmd = core::ptr::null_mut();
    }
    if (hdev.req_skb) {
    kfree_skb(hdev.req_skb);
    hdev.req_skb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hci_pend_le_actions_clear(hdev: *mut hci_dev) {
    ...
    hci_conn_put(p.conn);
    p.conn = core::ptr::null_mut();
    }
    }
    BT_DBG("All LE pending actions cleared");
    }
#[no_mangle]
unsafe extern "C" fn hci_dev_shutdown(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_dev_close_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_power_on_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_remote_name_cancel_sync(hdev: *mut hci_dev, addr: *mut bdaddr_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_stop_discovery_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_abort_conn_sync(hdev: *mut hci_dev, conn: *mut hci_conn, reason: u8) -> c_int {
    int hci_abort_conn_sync(struct hci_dev *hdev, struct hci_conn *conn, u8 reason)
    {
    let mut err: c_int = 0;
    let mut handle: u16 = conn.handle;
...
#[no_mangle]
unsafe extern "C" fn hci_disconnect_all_sync(hdev: *mut hci_dev, reason: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hci_power_off_sync(hdev: *mut hci_dev) -> c_int {
...
// If controller is already down there is nothing to do
    ...
    err = hci_clear_adv_sync(hdev, core::ptr::null_mut(), false);
    if (err)
    goto out;
...
#[no_mangle]
pub unsafe extern "C" fn hci_set_powered_sync(hdev: *mut hci_dev, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_write_iac_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_update_discoverable_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_discoverable_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int update_discoverable_sync(struct hci_dev *hdev, void *data)
    {
    return hci_update_discoverable_sync(hdev);
    }
#[no_mangle]
pub unsafe extern "C" fn hci_update_discoverable(hdev: *mut hci_dev) -> c_int {
...
// Only queue if it would have any effect
    ...
    return hci_cmd_sync_queue(hdev, update_discoverable_sync, core::ptr::null_mut(),
    core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn hci_update_connectable_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_inquiry_sync(hdev: *mut hci_dev, length: u8, num_rsp: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_active_scan_sync(hdev: *mut hci_dev, interval: u16) -> c_int {
    static int hci_active_scan_sync(struct hci_dev *hdev, uint16_t interval)
    {
    u8 own_addr_type;
// Accept list is not used for discovery
    let mut filter_policy: u8 = 0x00;
// Default is to enable duplicates filter
    let mut filter_dup: u8 = LE_SCAN_FILTER_DUP_ENABLE;
    int err;
    bt_dev_dbg(hdev, "");
...
#[no_mangle]
unsafe extern "C" fn hci_start_interleaved_discovery_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_start_discovery_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_suspend_monitor_sync(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hci_pause_discovery_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_pause_discovery_sync(struct hci_dev *hdev)
    {
    let mut old_state: c_int = hdev.discovery.state;
    int err;
...
#[no_mangle]
unsafe extern "C" fn hci_update_event_filter_sync(hdev: *mut hci_dev) -> c_int {
    static int hci_update_event_filter_sync(struct hci_dev *hdev)
    {
    struct bdaddr_list_with_flags *b;
    bdaddr_t *accept_list;
    size_t i, num_entries = 0;
    let mut scan: u8 = SCAN_DISABLED;
    let mut scanning: bool = test_bit(HCI_PSCAN, &hdev.flags);
    int err;
    if (!hci_dev_test_flag(hdev, HCI_BREDR_ENABLED))
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(scanning: !scan &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn hci_pause_scan_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hci_suspend_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_resume_discovery_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_resume_monitor_sync(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hci_resume_scan_sync(hdev: *mut hci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hci_resume_sync(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn conn_use_rpa(conn: *mut hci_conn) -> bool {
...
//
    err = hci_get_random_address(hdev, false, conn_use_rpa(conn), core::ptr::null_mut(),
    &own_addr_type, &random_addr);
    if (err)
    return err;
    memset(&cp, 0, sizeof(cp));
...
//
    err = hci_remove_ext_adv_instance_sync(hdev, cp.handle, core::ptr::null_mut());
    if (err)
    return err;
...
//
    ...
    conn.conn_timeout, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn hci_le_create_conn_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_create_cis_sync(hdev: *mut hci_dev) -> c_int {
    int hci_le_create_cis_sync(struct hci_dev *hdev)
    {
    DEFINE_FLEX(struct hci_cp_le_create_cis, cmd, cis, num_cis, 0x1f);
    let mut aux_num_cis: usize = 0;
    struct hci_conn *conn;
    let mut timeout: u16 = 0;
    let mut cig: u8 = BT_ISO_QOS_CIG_UNSET;
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_remove_cig_sync(hdev: *mut hci_dev, handle: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_big_terminate_sync(hdev: *mut hci_dev, handle: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_pa_terminate_sync(hdev: *mut hci_dev, handle: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _update_adv_data_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int _update_adv_data_sync(struct hci_dev *hdev, void *data)
    {
    let mut instance: u8 = PTR_UINT(data);
    return hci_update_adv_data_sync(hdev, instance);
    }
#[no_mangle]
pub unsafe extern "C" fn hci_update_adv_data(hdev: *mut hci_dev, instance: u8) -> c_int {
    int hci_update_adv_data(struct hci_dev *hdev, u8 instance)
    {
    return hci_cmd_sync_queue(hdev, _update_adv_data_sync,
    UINT_PTR(instance), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn hci_acl_create_conn_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    core::ptr::null_mut(), HCI_CMD_TIMEOUT);
    if (err)
...
#[no_mangle]
pub unsafe extern "C" fn hci_connect_acl_sync(hdev: *mut hci_dev, conn: *mut hci_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_le_conn_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn hci_connect_le_sync(hdev: *mut hci_dev, conn: *mut hci_conn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_cancel_connect_sync(hdev: *mut hci_dev, conn: *mut hci_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_conn_rate_request_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_conn_rate_request(hdev: *mut hci_dev, conn: *mut hci_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_pa_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
// Wait for HCI_EV_LE_PAST_RECEIVED event
    return __hci_cmd_sync_status_sk(hdev, HCI_OP_NOP, 0, core::ptr::null_mut(),
    HCI_EV_LE_PAST_RECEIVED,
    conn.conn_timeout, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn hci_le_pa_create_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    if (le) {
    struct hci_conn_params *params;
    let mut flags: hci_conn_flags_t = 0;
    let mut le_handle: u16 = le.handle;
...
//
    if (conn.sid == HCI_SID_INVALID) {
    err = __hci_cmd_sync_status_sk(hdev, HCI_OP_NOP, 0, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn hci_connect_pa_sync(hdev: *mut hci_dev, conn: *mut hci_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_big_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hci_le_big_create_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_connect_big_sync(hdev: *mut hci_dev, conn: *mut hci_conn) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct past_data {
    pub conn: *mut hci_conn,
    pub le: *mut hci_conn,
}

#[no_mangle]
unsafe extern "C" fn past_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hci_le_past_set_info_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hci_le_past_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_past_sync(conn: *mut hci_conn, le: *mut hci_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn le_read_features_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hci_le_read_remote_features_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_read_remote_features(conn: *mut hci_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkt_type_changed(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hci_change_conn_ptype_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_acl_change_pkt_type(conn: *mut hci_conn, pkt_type: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn le_phy_update_complete(hdev: *mut hci_dev, data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hci_le_set_phy_sync(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hci_le_set_phy(conn: *mut hci_conn, tx_phys: u8, rx_phys: u8) -> c_int {
