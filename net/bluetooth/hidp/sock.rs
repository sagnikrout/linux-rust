...
//! Source: net/bluetooth/hidp/sock.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hidp_sock_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_hidp_sock_ioctl(sock: *mut socket, cmd: c_uint, argp: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidp_sock_ioctl(sock: *mut socket, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_hidp_connadd_req {
...
#[no_mangle]
unsafe extern "C" fn hidp_sock_compat_ioctl(sock: *mut socket, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hidp_init_sockets() -> int __init {
    ...
    err = bt_procfs_init(&init_net, "hidp", &hidp_sk_list, core::ptr::null_mut());
    if (err < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn hidp_cleanup_sockets() -> void __exit {
