...
//! Source: net/bluetooth/l2cap_sock.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_is_socket(sock: *mut socket) -> bool {
...
#[no_mangle]
unsafe extern "C" fn l2cap_validate_bredr_psm(psm: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_validate_le_psm(psm: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_bind(sock: *mut socket, addr: *mut sockaddr_unsized, alen: c_int) -> c_int {
...
// We only allow ATT user space socket
    ...
    if (la.l2_psm) {
    let mut psm: __u16 = __le16_to_cpu(la.l2_psm);
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_get_mode(chan: *mut l2cap_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_valid_mtu(chan: *mut l2cap_chan, mtu: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn l2cap_set_mode(chan: *mut l2cap_chan, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_publish_rx_avail(chan: *mut l2cap_chan) {
    static void l2cap_publish_rx_avail(struct l2cap_chan *chan)
    {
    struct sock *sk = chan.data;
    let mut avail: isize = sk.sk_rcvbuf - atomic_read(&sk.sk_rmem_alloc);
...
//
#[no_mangle]
unsafe extern "C" fn l2cap_sock_put_chan(sk: *mut sock) {
    ...
    l2cap_pi(sk).chan = core::ptr::null_mut();
    l2cap_chan_put(chan);
    }
...
//
#[no_mangle]
unsafe extern "C" fn l2cap_sock_kill(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn __l2cap_wait_ack(sk: *mut sock, chan: *mut l2cap_chan) -> c_int {
    static int __l2cap_wait_ack(struct sock *sk, struct l2cap_chan *chan)
    {
    DECLARE_WAITQUEUE(wait, current);
    let mut err: c_int = 0;
    let mut timeo: c_int = L2CAP_WAIT_ACK_POLL_PERIOD;
// Timeout to prevent infinite loop
    let mut timeout: c_ulong = jiffies + L2CAP_WAIT_ACK_TIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_shutdown(sock: *mut socket, how: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_cleanup_listen(parent: *mut sock) {
    static void l2cap_sock_cleanup_listen(struct sock *parent)
    {
    struct sock *sk;
...
// Check for backlog size
    ...
    sk = l2cap_sock_alloc(sock_net(parent), core::ptr::null_mut(), BTPROTO_L2CAP,
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_recv_cb(chan: *mut l2cap_chan, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_close_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_teardown_cb(chan: *mut l2cap_chan, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_ready_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_defer_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_resume_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_set_shutdown_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_get_sndtimeo_cb(chan: *mut l2cap_chan) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_suspend_cb(chan: *mut l2cap_chan) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_filter(chan: *mut l2cap_chan, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn l2cap_sock_init(sk: *mut sock, parent: *mut sock) {
    static void l2cap_sock_init(struct sock *sk, struct sock *parent)
    {
    struct l2cap_chan *chan = l2cap_pi(sk).chan;
    BT_DBG("sk %p", sk);
...
// The sock takes ownership of the caller's reference on chan.
    ...
    l2cap_sock_init(sk, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_init_sockets() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn l2cap_cleanup_sockets() {
