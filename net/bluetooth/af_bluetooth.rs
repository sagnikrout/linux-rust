...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_reclassify_lock(sk: *mut sock, proto: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_register(proto: c_int, ops: *const net_proto_family) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_unregister(proto: c_int) {
    void bt_sock_unregister(int proto)
    {
    if (proto < 0 || proto >= BT_MAX_PROTO)
    return;
    write_lock(&bt_proto_lock);
    bt_proto[proto] = core::ptr::null_mut();
    write_unlock(&bt_proto_lock);
    }
...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_link(l: *mut bt_sock_list, sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_unlink(l: *mut bt_sock_list, sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_linked(l: *mut bt_sock_list, s: *mut sock) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bt_accept_enqueue(parent: *mut sock, sk: *mut sock, bh: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bt_accept_unlink(sk: *mut sock) {
    ...
    bt_sk(sk).parent = core::ptr::null_mut();
    sock_put(sk);
    }
    ...
    struct sock *next = core::ptr::null_mut();
...
//
    ...
    restart:
    for (sk = bt_accept_get(parent, core::ptr::null_mut()); sk; sk = next) {
...
// FIXME: Is this check still needed
    ...
    let mut pkt_status: u8 = hci_skb_pkt_status(skb);
    put_cmsg(msg, SOL_BLUETOOTH, BT_SCM_PKT_STATUS,
    sizeof(pkt_status), &pkt_status);
    }
    if (test_bit(BT_SK_PKT_SEQNUM, &bt_sk(sk).flags)) {
    let mut pkt_seqnum: u16 = hci_skb_pkt_seqnum(skb);
...
#[no_mangle]
unsafe extern "C" fn bt_sock_data_wait(sk: *mut sock, timeo: c_long) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn bt_accept_poll(parent: *mut sock) -> __poll_t {
    ...
    let mut ts_info: kernel_ethtool_ts_info = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bt_dev_ioctl(sock: *mut socket, cmd: c_uint, arg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_ioctl(sock: *mut socket, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bt_sock_wait_state(sk: *mut sock, state: c_int, timeo: c_ulong) -> c_int {
...
// This function expects the sk lock to be held when called
#[no_mangle]
pub unsafe extern "C" fn bt_sock_wait_ready(sk: *mut sock, msg_flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bt_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bt_procfs_cleanup(net: *mut net, name: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn bt_init() -> int __init {
    ...
    if (err < 0)
    return err;
    bt_debugfs = debugfs_create_dir("bluetooth", core::ptr::null_mut());
    bt_leds_init();
    err = bt_sysfs_init();
    if (err < 0)
    goto cleanup_led;
...
#[no_mangle]
unsafe extern "C" fn bt_exit() -> void __exit {
