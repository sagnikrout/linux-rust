...
//! Source: net/bluetooth/rfcomm/tty.c
#![no_std]
...
pub const RFCOMM_TTY_MINOR: c_int = 0;
...
pub struct rfcomm_dev {
    ...
    pub flags: c_ulong,
    pub err: c_int,
    pub /: *mut *mut unsigned long status; / don't export to userspace,
    pub src: bdaddr_t,
    pub dst: bdaddr_t,
    pub channel: u8,
    pub modem_status: c_uint,
    pub dlc: *mut rfcomm_dlc,
    pub tty_dev: *mut device,
    pub wmem_alloc: core::sync::atomic::AtomicI32,
...
// ---- Device functions ----
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_destruct(port: *mut tty_port) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_activate(port: *mut tty_port, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_carrier_raised(port: *mut tty_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_shutdown(port: *mut tty_port) {
    static void rfcomm_dev_shutdown(struct tty_port *port)
    {
    struct rfcomm_dev *dev = container_of(port, struct rfcomm_dev, port);
    if (dev.tty_dev.parent)
    device_move(dev.tty_dev, core::ptr::null_mut(), DPM_ORDER_DEV_LAST);
// close the dlc
...
#[no_mangle]
unsafe extern "C" fn rfcomm_reparent_device(dev: *mut rfcomm_dev) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_add(req: *mut rfcomm_dev_req, dlc: *mut rfcomm_dlc) -> c_int {
...
// ---- Send buffer ----
#[no_mangle]
pub unsafe extern "C" fn rfcomm_room(dev: *mut rfcomm_dev) -> c_uint {
    static inline unsigned int rfcomm_room(struct rfcomm_dev *dev)
    {
    struct rfcomm_dlc *dlc = dev.dlc;
// Limit the outstanding number of packets not yet sent to 40
    let mut pending: c_int = 40 - atomic_read(&dev.wmem_alloc);
    return max(0, pending) * dlc.mtu;
    }
#[no_mangle]
unsafe extern "C" fn rfcomm_wfree(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_set_owner_w(skb: *mut sk_buff, dev: *mut rfcomm_dev) {
...
#[no_mangle]
unsafe extern "C" fn __rfcomm_create_dev(sk: *mut sock, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __rfcomm_release_dev(arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_create_dev(sk: *mut sock, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_release_dev(arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_get_dev_list(arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_get_dev_info(arg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rfcomm_dev_ioctl(sk: *mut sock, cmd: c_uint, arg: *mut void __user) -> c_int {
...
// ---- DLC callbacks ----
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_data_ready(dlc: *mut rfcomm_dlc, skb: *mut sk_buff) {
    static void rfcomm_dev_data_ready(struct rfcomm_dlc *dlc, struct sk_buff *skb)
    {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_state_change(dlc: *mut rfcomm_dlc, err: c_int) {
    static void rfcomm_dev_state_change(struct rfcomm_dlc *dlc, int err)
    {
    struct rfcomm_dev *dev = dlc.owner;
    if (!dev)
...
#[no_mangle]
unsafe extern "C" fn rfcomm_dev_modem_status(dlc: *mut rfcomm_dlc, v24_sig: u8) {
    static void rfcomm_dev_modem_status(struct rfcomm_dlc *dlc, u8 v24_sig)
    {
    struct rfcomm_dev *dev = dlc.owner;
    if (!dev)
...
// ---- TTY functions ----
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_copy_pending(dev: *mut rfcomm_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_cleanup(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_install(driver: *mut tty_driver, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_close(tty: *mut tty_struct, filp: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_ioctl(tty: *mut tty_struct, cmd: c_uint, arg: c_ulong) -> c_int {
    ...
    let mut old_baud_rate: c_int = tty_termios_baud_rate(old);
    let mut new_baud_rate: c_int = tty_termios_baud_rate(new);
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_throttle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_unthrottle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_flush_buffer(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_send_xchar(tty: *mut tty_struct, ch: u8) {
    static void rfcomm_tty_send_xchar(struct tty_struct *tty, u8 ch)
    {
    BT_DBG("tty %p ch %c", tty, ch);
    }
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_wait_until_sent(tty: *mut tty_struct, timeout: c_int) {
    static void rfcomm_tty_wait_until_sent(struct tty_struct *tty, int timeout)
    {
    BT_DBG("tty %p timeout %d", tty, timeout);
    }
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_hangup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfcomm_tty_tiocmset(tty: *mut tty_struct, set: c_uint, clear: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rfcomm_init_ttys() -> int __init {
