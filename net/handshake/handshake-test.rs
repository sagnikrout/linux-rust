...
//! Source: net/handshake/handshake-test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct handshake_req_alloc_test_param {
    pub desc: *const c_char,
    pub proto: *mut handshake_proto,
    pub gfp: gfp_t,
    ...
    {
    .desc			= "handshake_req_alloc core::ptr::null_mut() proto",
...
// Act
    result = handshake_req_submit(sock, core::ptr::null_mut(), GFP_KERNEL);
// Assert
...
// Act
    result = handshake_req_submit(core::ptr::null_mut(), req, GFP_KERNEL);
// Assert
    KUNIT_EXPECT_EQ(test, result, -EINVAL);
...
#[no_mangle]
unsafe extern "C" fn handshake_req_cancel_test2(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn handshake_req_cancel_test3(test: *mut kunit) {
...
// Pretend to complete this request
    handshake_complete(next, -ETIMEDOUT, core::ptr::null_mut());
    KUNIT_EXPECT_EQ(test, file_count(filp), fcount_before);
// Act
    result = handshake_req_cancel(sock.sk);
// Assert
...
#[no_mangle]
unsafe extern "C" fn test_destroy_func(req: *mut handshake_req) {
...
// Assert
    ...
    {
    .name			= "req_submit core::ptr::null_mut() req arg",
    .run_case		= handshake_req_submit_test1,
    },
    {
    .name			= "req_submit core::ptr::null_mut() sock arg",
    .run_case		= handshake_req_submit_test2,
    },
    {
    .name			= "req_submit core::ptr::null_mut() sock.file",
