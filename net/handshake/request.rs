...
//! Source: net/handshake/request.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn handshake_req_hash_init() -> c_int {
    int handshake_req_hash_init(void)
    {
    return rhashtable_init(&handshake_rhashtbl, &handshake_rhash_params);
    }
#[no_mangle]
pub unsafe extern "C" fn handshake_req_hash_destroy() {
...
#[no_mangle]
unsafe extern "C" fn handshake_req_hash_add(req: *mut handshake_req) -> bool {
...
#[no_mangle]
unsafe extern "C" fn handshake_req_destroy(req: *mut handshake_req) {
...
#[no_mangle]
unsafe extern "C" fn handshake_sk_destruct(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn remove_pending(hn: *mut handshake_net, req: *mut handshake_req) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn handshake_req_cancel(sk: *mut sock) -> bool {
