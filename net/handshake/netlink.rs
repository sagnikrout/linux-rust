...
//! Source: net/handshake/netlink.c
#![no_std]
...
pub unsafe extern "C" fn handshake_nl_accept_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    struct handshake_req *req = core::ptr::null_mut();
    int class, err;
    err = -EOPNOTSUPP;
    if (!hn)
    goto out_status;
    ...
    out_complete:
    if (req)
    handshake_complete(req, -EIO, core::ptr::null_mut());
    out_status:
    trace_handshake_cmd_accept_err(net, req, core::ptr::null_mut(), err);
    return err;
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn handshake_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn handshake_net_exit(net: *mut net) -> void __net_exit {
...
//
    ...
    handshake_complete(req, -ETIMEDOUT, core::ptr::null_mut());
    fput(file);
    }
    }
...
//
    ...
    net_generic(net, handshake_net_id) : core::ptr::null_mut();
    }
    EXPORT_SYMBOL_IF_KUNIT(handshake_pernet);
#[no_mangle]
unsafe extern "C" fn handshake_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn handshake_exit() -> void __exit {
