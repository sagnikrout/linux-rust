...
#[no_mangle]
pub unsafe extern "C" fn sock_map_get_from_fd(attr: *const union bpf_attr, prog: *mut bpf_prog) -> c_int {
    ...
    ret = sock_map_prog_update(map, prog, core::ptr::null_mut(), core::ptr::null_mut(), attr.attach_type);
    mutex_unlock(&sockmap_mutex);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn sock_map_prog_detach(attr: *const union bpf_attr, ptype: enum bpf_prog_type) -> c_int {
    ...
    mutex_lock(&sockmap_mutex);
    ret = sock_map_prog_update(map, core::ptr::null_mut(), prog, core::ptr::null_mut(), attr.attach_type);
    mutex_unlock(&sockmap_mutex);
    put_prog:
    bpf_prog_put(prog);
    return ret;
...
#[no_mangle]
unsafe extern "C" fn sock_map_sk_acquire(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_sk_release(sk: *mut sock) {
    ...
    {
    let mut strp_stop: bool = false, verdict_stop = false;
...
#[no_mangle]
unsafe extern "C" fn sock_map_unref(sk: *mut sock, link_raw: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_init_proto(sk: *mut sock, psock: *mut sk_psock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sock_map_link(map: *mut bpf_map, sk: *mut sock) -> c_int {
    static int sock_map_link(struct bpf_map *map, struct sock *sk)
    {
    struct sk_psock_progs *progs = sock_map_progs(map);
    struct bpf_prog *stream_verdict = core::ptr::null_mut();
    struct bpf_prog *stream_parser = core::ptr::null_mut();
    struct bpf_prog *skb_verdict = core::ptr::null_mut();
    struct bpf_prog *msg_parser = core::ptr::null_mut();
    struct sk_psock *psock;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sock_map_free(map: *mut bpf_map) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_release_progs(map: *mut bpf_map) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_delete_elem(map: *mut bpf_map, key: *mut c_void) -> c_long {
    ...
    return -EINVAL;
    psk = &stab.sks[i];
    return __sock_map_delete(stab, core::ptr::null_mut(), psk);
    }
#[no_mangle]
unsafe extern "C" fn sock_map_get_next_key(map: *mut bpf_map, key: *mut c_void, next: *mut c_void) -> c_int {
    static int sock_map_get_next_key(struct bpf_map *map, void *key, void *next)
    {
    struct bpf_stab *stab = container_of(map, struct bpf_stab, map);
    let mut i: u32 = key ? *(u32 *)key : U32_MAX;
    u32 *key_next = next;
...
#[no_mangle]
unsafe extern "C" fn sock_map_op_okay(ops: *const bpf_sock_ops_kern) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sock_map_redirect_allowed(sk: *const sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sock_map_sk_is_suitable(sk: *const sock) -> bool {
    static bool sock_map_sk_is_suitable(const struct sock *sk)
    {
    return !!sk.sk_prot.psock_update_sk_prot;
    }
#[no_mangle]
unsafe extern "C" fn sock_map_sk_state_allowed(sk: *const sock) -> bool {
    ...
    ret = -EOPNOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(BPF_MAP_TYPE_SOCKMAP: map->map_type ==) -> else {
...
pub struct bpf_iter__sockmap {
    ...
    pub sk): *mut *mut __bpf_md_ptr(struct sock ,,
}
...
#[no_mangle]
unsafe extern "C" fn sock_map_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int sock_map_seq_show(struct seq_file *seq, void *v)
    __must_hold(rcu)
    {
    struct sock_map_seq_info *info = seq.private;
    let mut ctx: bpf_iter__sockmap = {};
...
#[no_mangle]
unsafe extern "C" fn sock_map_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    static void sock_map_seq_stop(struct seq_file *seq, void *v)
    __releases(rcu)
    {
    if (!v)
    (void)sock_map_seq_show(seq, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sock_map_fini_seq_private(priv_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_mem_usage(map: *const bpf_map) -> u64 {
    static u64 sock_map_mem_usage(const struct bpf_map *map)
    {
    let mut usage: u64 = sizeof(struct bpf_stab);
...
pub struct bpf_shtab {
    pub map: bpf_map,
    pub buckets: *mut bpf_shtab_bucket,
    pub buckets_num: u32,
    pub elem_size: u32,
    pub progs: sk_psock_progs,
...
#[no_mangle]
pub unsafe extern "C" fn sock_hash_bucket_hash(key: *const c_void, len: u32) -> u32 {
    ...
    let mut key_size: u32 = map.key_size, hash;
    ...
    return elem ? elem.sk : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn sock_hash_delete_elem(map: *mut bpf_map, key: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn sock_hash_free(map: *mut bpf_map) {
...
#[no_mangle]
unsafe extern "C" fn sock_hash_release_progs(map: *mut bpf_map) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sock_hash_seq_info {
    pub map: *mut bpf_map,
    pub htab: *mut bpf_shtab,
    pub bucket_id: u32,
}
...
// pairs with sock_hash_seq_stop
    rcu_read_lock();
    return sock_hash_seq_find_next(info, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn sock_hash_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sock_hash_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    static void sock_hash_seq_stop(struct seq_file *seq, void *v)
    __releases(rcu)
    {
    if (!v)
    (void)sock_hash_seq_show(seq, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sock_hash_fini_seq_private(priv_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sock_hash_mem_usage(map: *const bpf_map) -> u64 {
    static u64 sock_hash_mem_usage(const struct bpf_map *map)
    {
    struct bpf_shtab *htab = container_of(map, struct bpf_shtab, map);
    let mut usage: u64 = sizeof(*htab);
...
// plink = link;
    ...
    let mut prog_cnt: u32 = 0, flags = 0;
    struct bpf_prog **pprog;
    struct bpf_prog *prog;
    struct bpf_map *map;
    let mut id: u32 = 0;
    ...
    return PTR_ERR(map);
    rcu_read_lock();
    ret = sock_map_prog_link_lookup(map, &pprog, core::ptr::null_mut(), attr.query.attach_type);
    if (ret)
    goto end;
    prog = *pprog;
    prog_cnt = !prog ? 0 : 1;
...
#[no_mangle]
unsafe extern "C" fn sock_map_unlink(sk: *mut sock, link: *mut sk_psock_link) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_remove_links(sk: *mut sock, psock: *mut sk_psock) {
...
#[no_mangle]
pub unsafe extern "C" fn sock_map_unhash(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn sock_map_destroy(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn sock_map_close(sk: *mut sock, timeout: c_long) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sockmap_link {
    pub link: bpf_link,
    pub map: *mut bpf_map,
}

#[no_mangle]
unsafe extern "C" fn sock_map_link_release(link: *mut bpf_link) {
    ...
    if (!sockmap_link.map)
    goto out;
    WARN_ON_ONCE(sock_map_prog_update(sockmap_link.map, core::ptr::null_mut(), link.prog, link,
    link.attach_type));
    bpf_map_put_with_uref(sockmap_link.map);
    sockmap_link.map = core::ptr::null_mut();
    out:
    mutex_unlock(&sockmap_mutex);
    }
#[no_mangle]
unsafe extern "C" fn sock_map_link_detach(link: *mut bpf_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sock_map_link_dealloc(link: *mut bpf_link) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_link_get_map_id(sockmap_link: *const sockmap_link) -> u32 {
    ...
    {
    const struct sockmap_link *sockmap_link = container_of(link, struct sockmap_link, link);
    let mut map_id: u32 = sock_map_link_get_map_id(sockmap_link);
...
#[no_mangle]
pub unsafe extern "C" fn sock_map_link_create(attr: *const union bpf_attr, prog: *mut bpf_prog) -> c_int {
    ...
    mutex_lock(&sockmap_mutex);
    ret = sock_map_prog_update(map, prog, core::ptr::null_mut(), &sockmap_link.link, attach_type);
    mutex_unlock(&sockmap_mutex);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn sock_map_iter_detach_target(aux: *mut bpf_iter_aux_info) {
...
#[no_mangle]
unsafe extern "C" fn bpf_sockmap_iter_init() -> int __init {
