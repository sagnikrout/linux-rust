...
pub const MAX_GRO_SKBS: c_int = 8;
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_add_offload(po: *mut packet_offload) {
...
//
#[no_mangle]
unsafe extern "C" fn __dev_remove_offload(po: *mut packet_offload) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_remove_offload(po: *mut packet_offload) {
...
#[no_mangle]
pub unsafe extern "C" fn skb_gro_receive(p: *mut sk_buff, skb: *mut sk_buff) -> c_int {
    int skb_gro_receive(struct sk_buff *p, struct sk_buff *skb)
    {
    struct skb_shared_info *pinfo, *skbinfo = skb_shinfo(skb);
    let mut offset: c_uint = skb_gro_offset(skb);
    let mut headlen: c_uint = skb_headlen(skb);
    let mut len: c_uint = skb_gro_len(skb);
...
//
    ...
    skb_frag_t *frag;
    skb_frag_t *frag2;
    let mut i: c_int = skbinfo.nr_frags;
    let mut nr_frags: c_int = pinfo.nr_frags + i;
...
// all fragments truesize : remove (head size + sk_buff)
    ...
    let mut nr_frags: c_int = pinfo.nr_frags;
    skb_frag_t *frag = pinfo.frags + nr_frags;
    struct page *page = virt_to_head_page(skb.head);
    let mut first_size: c_uint = headlen - offset;
...
// sk ownership - if any - completely transferred to the aggregated packet
    ...
    if (offset > headlen) {
    let mut eat: c_uint = offset - headlen;
...
#[no_mangle]
pub unsafe extern "C" fn skb_gro_receive_list(p: *mut sk_buff, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gro_complete(gro: *mut gro_node, skb: *mut sk_buff) {
    static void gro_complete(struct gro_node *gro, struct sk_buff *skb)
    {
    struct list_head *head = &net_hotdata.offload_base;
    struct packet_offload *ptype;
    let mut type: __be16 = skb.protocol;
...
#[no_mangle]
unsafe extern "C" fn __gro_flush_chain(gro: *mut gro_node, index: u32, flush_old: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __gro_flush(gro: *mut gro_node, flush_old: bool) {
    void __gro_flush(struct gro_node *gro, bool flush_old)
    {
    let mut bitmask: c_ulong = gro.bitmask;
    ...
    {
    let mut maclen: c_uint = skb.dev.hard_header_len;
    let mut hash: u32 = skb_get_hash_raw(skb);
    struct sk_buff *p;
    ...
    skb_mac_header(skb));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !diffs) -> else {
    else if (!diffs)
...
#[no_mangle]
pub unsafe extern "C" fn skb_gro_reset_offset(skb: *mut sk_buff, nhoff: u32) {
...
#[no_mangle]
unsafe extern "C" fn gro_pull_from_frag0(skb: *mut sk_buff, grow: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gro_try_pull_from_frag0(skb: *mut sk_buff) {
    static void gro_try_pull_from_frag0(struct sk_buff *skb)
    {
    let mut grow: c_int = skb_gro_offset(skb) - skb_headlen(skb);
    if (grow > 0)
    gro_pull_from_frag0(skb, grow);
    }
#[no_mangle]
unsafe extern "C" fn gro_flush_oldest(gro: *mut gro_node, head: *mut list_head) {
...
//
    ...
    struct sk_buff *skb)
    {
    let mut bucket: u32 = skb_get_hash_raw(skb) & (GRO_HASH_BUCKETS - 1);
    struct list_head *head = &net_hotdata.offload_base;
...
#[no_mangle]
pub unsafe extern "C" fn if(SKB_FCLONE_UNAVAILABLE: skb->fclone !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn gro_receive_skb(gro: *mut gro_node, skb: *mut sk_buff) -> gro_result_t {
...
#[no_mangle]
unsafe extern "C" fn napi_reuse_skb(napi: *mut napi_struct, skb: *mut sk_buff) {
...
//
    ...
    let mut hlen: c_uint = sizeof(*eth);
...
#[no_mangle]
pub unsafe extern "C" fn napi_gro_frags(napi: *mut napi_struct) -> gro_result_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn __skb_gro_checksum_complete(skb: *mut sk_buff) -> __sum16 {
...
#[no_mangle]
pub unsafe extern "C" fn gro_init(gro: *mut gro_node) {
...
#[no_mangle]
pub unsafe extern "C" fn gro_cleanup(gro: *mut gro_node) {
