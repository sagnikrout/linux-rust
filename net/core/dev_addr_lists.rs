...
//! Source: net/core/dev_addr_lists.c
#![no_std]
...
//
    ...
    {
    struct rb_node **ins_point = &list.tree.rb_node, *parent = core::ptr::null_mut();
...
// check if addr is already used as global
    ...
    let mut diff: c_int = memcmp(addr, ha.addr, addr_len);
    if (diff == 0 && addr_type)
    diff = memcmp(&addr_type, &ha.type, sizeof(addr_type));
    if (diff < 0)
    node = node.rb_left;
...
#[no_mangle]
pub unsafe extern "C" fn __hw_addr_flush(list: *mut netdev_hw_addr_list) {
...
#[no_mangle]
pub unsafe extern "C" fn __hw_addr_init(list: *mut netdev_hw_addr_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_addr_check(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_addr_flush(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_addr_init(dev: *mut net_device) -> c_int {
...
//
    ...
    int err;
    ASSERT_RTNL();
    err = netif_pre_changeaddr_notify(dev, addr, core::ptr::null_mut());
    if (err)
    return err;
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_add_excl(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_add(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_del(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_sync(to: *mut net_device, from: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_sync_multiple(to: *mut net_device, from: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_unsync(to: *mut net_device, from: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_flush(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_uc_init(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_add_excl(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_add(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_add_global(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_del(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_del_global(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_sync(to: *mut net_device, from: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_sync_multiple(to: *mut net_device, from: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_unsync(to: *mut net_device, from: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_flush(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_mc_init(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn netif_uc_promisc_update(dev: *mut net_device) -> c_int {
...
pub const NETIF_RX_MODE_RETRY_MAX: c_int = 4;
#[no_mangle]
pub unsafe extern "C" fn netif_rx_mode_schedule_retry(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn netif_rx_mode_cancel_retry(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn netif_rx_mode_run(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netif_rx_mode_queue(dev: *mut net_device) {
    static void netif_rx_mode_queue(struct net_device *dev)
    {
    __netdev_work_core_sched(dev, NETDEV_WORK_RX_MODE);
    }
#[no_mangle]
unsafe extern "C" fn netif_rx_mode_retry(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn netif_rx_mode_init(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __dev_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dev_set_rx_mode(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn netif_rx_mode_sync(dev: *mut net_device) {
