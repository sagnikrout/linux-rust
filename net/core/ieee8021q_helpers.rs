...
//! Source: net/core/ieee8021q_helpers.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ieee8021q_tt_to_tc(tt: enum ieee8021q_traffic_type, num_queues: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ietf_dscp_to_ieee8021q_tt(dscp: u8) -> c_int {
