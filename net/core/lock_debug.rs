...
// Copyright Amazon.com Inc. or its affiliates.
    ...
    let mut cmd: enum netdev_cmd = event;
...
#[no_mangle]
unsafe extern "C" fn rtnl_net_debug_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn rtnl_net_debug_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn rtnl_net_debug_init() -> int __init {
