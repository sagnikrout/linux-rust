...
pub const GSO_TEST_SIZE: c_int = 1000;
#[no_mangle]
unsafe extern "C" fn __init_skb(skb: *mut sk_buff) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gso_test_case {
    pub id: enum gso_test_nr,
    pub name: *const c_char,
// input
    pub linear_len: c_uint,
    pub nr_frags: c_uint,
    pub frags: *const c_uint,
    pub nr_frag_skbs: c_uint,
    pub frag_skbs: *const c_uint,
// output as expected
    pub nr_segs: c_uint,
    pub segs: *const c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn gso_test_case_to_desc(t: *mut gso_test_case, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn gso_test_func(test: *mut kunit) {
    static void gso_test_func(struct kunit *test)
    {
    let mut shinfo_size: c_int = SKB_DATA_ALIGN(sizeof(struct skb_shared_info));
    ...
    if (tcase.frag_skbs) {
    let mut total_size: c_uint = 0, total_true_size = 0;
    struct sk_buff *frag_skb, *prev = core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_tunnel_flags_test {
    pub name: *const c_char,
    pub src_bits: *const u16,
    pub exp_bits: *const u16,
    pub src_num: u8,
    pub exp_num: u8,
    pub exp_val: __be16,
    pub exp_comp: bool,
...
#[no_mangle]
unsafe extern "C" fn ip_tunnel_flags_test_run(test: *mut kunit) {
    ...
    KUNIT_ASSERT_EQ(test, ( u16)t.exp_val,
    ( u16)ip_tunnel_flags_to_be16(src));
