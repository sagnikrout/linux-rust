...
//! Source: net/core/netdev_rx_queue.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0-or-later
    ...
    WRITE_ONCE(rxq_src.lease, core::ptr::null_mut());
    WRITE_ONCE(rxq_dst.lease, core::ptr::null_mut());
    netdev_put(rxq_src.dev, &rxq_src.lease_tracker);
    }
#[no_mangle]
pub unsafe extern "C" fn netif_rxq_is_leased(dev: *mut net_device, rxq_idx: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn netif_is_queue_leasee(dev: *const net_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn netif_rxq_has_unreadable_mp(dev: *mut net_device, rxq_idx: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn netif_rxq_has_mp(dev: *mut net_device, rxq_idx: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn netdev_rx_queue_restart(dev: *mut net_device, rxq_idx: c_uint) -> c_int {
...
//
    ...
    {
    let mut rxq_idx: c_uint = get_netdev_rx_queue_index(phys_rxq);
    let mut p: pp_memory_provider_params = phys_rxq.mp_params;
    if (!p.mp_ops)
    return;
