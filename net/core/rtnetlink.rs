...
pub const RTNL_SLAVE_MAX_TYPE: c_int = 45;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_lock_interruptible() -> c_int {
...
pub unsafe extern "C" fn __rtnl_unlock() {
    ...
    defer_kfree_skb_list = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn refcount_dec_and_rtnl_lock(r: *mut refcount_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn lockdep_rtnl_is_held() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn __rtnl_net_lock(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn __rtnl_net_unlock(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_lock(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_unlock(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_trylock(net: *mut net) -> c_int {
    int rtnl_net_trylock(struct net *net)
    {
    let mut ret: c_int = rtnl_trylock();
    if (ret)
    __rtnl_net_lock(net);
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_lock_killable(net: *mut net) -> c_int {
    int rtnl_net_lock_killable(struct net *net)
    {
    let mut ret: c_int = rtnl_lock_killable();
    if (!ret)
    __rtnl_net_lock(net);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn rtnl_net_cmp_locks(net_a: *const net, net_b: *const net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_lock_cmp_fn(a: *const lockdep_map, b: *const lockdep_map) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_is_locked(net: *mut net) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn lockdep_rtnl_net_is_held(net: *mut net) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_queue_work(net: *mut net) {
    void rtnl_net_queue_work(struct net *net)
    {
    queue_work(rtnl_net_wq, &net.rtnl_work);
    }
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_flush_workqueue() {
    void rtnl_net_flush_workqueue(void)
    {
    flush_workqueue(rtnl_net_wq);
    }
#[no_mangle]
pub unsafe extern "C" fn rtnl_net_work_func(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn rtnl_nets_add(rtnl_nets: *mut rtnl_nets, net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn rtnl_nets_lock(rtnl_nets: *mut rtnl_nets) {
...
#[no_mangle]
unsafe extern "C" fn rtnl_nets_unlock(rtnl_nets: *mut rtnl_nets) {
...
pub unsafe extern "C" fn rtm_msgindex(msgtype: c_int) -> c_int {
    ...
    {
    let mut msgindex: c_int = msgtype - RTM_BASE;
//
...
//
#[no_mangle]
unsafe extern "C" fn rtnl_unregister(protocol: c_int, msgtype: c_int) -> c_int {
    ...
    link = rcu_replace_pointer_rtnl(tab[msgindex], core::ptr::null_mut());
    rtnl_unlock();
    kfree_rcu(link, rcu);
    return 0;
    }
...
pub unsafe extern "C" fn rtnl_unregister_all(protocol: c_int) {
    ...
    BUG_ON(protocol < 0 || protocol > RTNL_FAMILY_MAX);
    rtnl_lock();
    tab = rcu_replace_pointer_rtnl(rtnl_msg_handlers[protocol], core::ptr::null_mut());
    if (!tab) {
    rtnl_unlock();
    return;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn __rtnl_register_many(handlers: *const rtnl_msg_handler, n: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __rtnl_unregister_many(handlers: *const rtnl_msg_handler, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rtnl_link_ops_put(ops: *mut rtnl_link_ops, srcu_index: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn rtnl_lock_unregistering_all() {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtnl_link_unregister(ops: *mut rtnl_link_ops) {
...
#[no_mangle]
unsafe extern "C" fn rtnl_link_get_slave_info_data_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_link_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_af_put(ops: *mut rtnl_af_ops, srcu_index: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtnl_af_register(ops: *mut rtnl_af_ops) -> c_int {
    int rtnl_af_register(struct rtnl_af_ops *ops)
    {
    let mut err: c_int = init_srcu_struct(&ops.srcu);
    if (err)
    return err;
...
//
#[no_mangle]
pub unsafe extern "C" fn rtnl_af_unregister(ops: *mut rtnl_af_ops) {
...
#[no_mangle]
unsafe extern "C" fn rtnl_have_link_slave_info(dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtnl_link_fill(skb: *mut sk_buff, dev: *const net_device) -> c_int {
    static int rtnl_link_fill(struct sk_buff *skb, const struct net_device *dev)
    {
    struct nlattr *linkinfo;
    let mut err: c_int = -EMSGSIZE;
    linkinfo = nla_nest_start_noflag(skb, IFLA_LINKINFO);
    if (linkinfo == core::ptr::null_mut())
    goto out;
...
#[no_mangle]
pub unsafe extern "C" fn rtnetlink_send(skb: *mut sk_buff, net: *mut net, pid: u32, group: c_uint, echo: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_unicast(skb: *mut sk_buff, net: *mut net, pid: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_set_sk_err(net: *mut net, group: u32, error: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn rtnetlink_put_metrics(skb: *mut sk_buff, metrics: *mut u32) -> c_int {
...
// nothing is dumped for dst_default_metrics, so just skip the loop
    ...
    let mut user_features: u32 = metrics[i] & RTAX_FEATURE_MASK;
    if (!user_features)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn netif_set_operstate(dev: *mut net_device, newstate: c_int) {
    void netif_set_operstate(struct net_device *dev, int newstate)
    {
    let mut old: c_uint = READ_ONCE(dev.operstate);
    do {
    if (old == newstate)
    return;
...
#[no_mangle]
unsafe extern "C" fn set_operstate(dev: *mut net_device, transition: c_uchar) {
    static void set_operstate(struct net_device *dev, unsigned char transition)
    {
    let mut operstate: c_uchar = READ_ONCE(dev.operstate);
    switch (transition) {
    case IF_OPER_UP:
...
#[no_mangle]
unsafe extern "C" fn rtnl_dev_get_flags(dev: *const net_device) -> c_uint {
    ...
    {
    let mut flags: c_uint = ifm.ifi_flags;
...
//
#[no_mangle]
unsafe extern "C" fn rtnl_vfinfo_cap(num_vfs: c_int, ext_filter_mask: u32) -> c_int {
...
// All VF info
    ...
    ext_filter_mask);
    let mut size: usize = nla_total_size(0);
    size += num_vfs *
    (nla_total_size(0) +
...
// IFLA_VF_STATS_TX_DROPPED
    ...
    let mut vf_ports_size: usize = nla_total_size(sizeof(struct nlattr));
...
#[no_mangle]
unsafe extern "C" fn rtnl_xdp_size() -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_prop_list_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_proto_down_size(dev: *const net_device) -> usize {
    static size_t rtnl_proto_down_size(const struct net_device *dev)
    {
    let mut size: usize = nla_total_size(1);
// Assume dev->proto_down_reason is not zero.
    size += nla_total_size(0) + nla_total_size(4);
    return size;
    }
#[no_mangle]
unsafe extern "C" fn rtnl_devlink_port_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_dpll_pin_size() -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_dev_parent_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_vf_ports_fill(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtnl_port_self_fill(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtnl_phys_port_id_fill(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtnl_phys_port_name_fill(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtnl_phys_switch_id_fill(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtnl_xdp_prog_skb(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtnl_xdp_prog_drv(dev: *mut net_device) -> u32 {
    static u32 rtnl_xdp_prog_drv(struct net_device *dev)
    {
    return dev_xdp_prog_id(dev, XDP_MODE_DRV);
    }
#[no_mangle]
unsafe extern "C" fn rtnl_xdp_prog_hw(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtnl_xdp_fill(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtnl_get_event(event: c_ulong) -> u32 {
    static u32 rtnl_get_event(unsigned long event)
    {
    let mut rtnl_event_type: u32 = IFLA_EVENT_NONE;
    switch (event) {
    case NETDEV_REBOOT:
...
#[no_mangle]
unsafe extern "C" fn put_master_ifindex(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
    ...
    bool force)
    {
    let mut iflink: c_int = dev_get_iflink(dev);
    ...
    {
    let mut put_iflink: bool = false;
    if (dev.rtnl_link_ops && dev.rtnl_link_ops.get_link_net) {
    struct net *link_net = dev.rtnl_link_ops.get_link_net(dev);
    if (!net_eq(dev_net(dev), link_net)) {
    let mut id: c_int = peernet2id_alloc(src_net, link_net, gfp);
...
//
    ...
    struct rtnl_link_ops *ops = core::ptr::null_mut();
    if (nla_parse_nested_deprecated(linfo, IFLA_INFO_MAX, nla, ifla_info_policy, core::ptr::null_mut()) < 0)
...
#[no_mangle]
unsafe extern "C" fn link_master_filtered(dev: *mut net_device, master_idx: c_int) -> bool {
...
//
    ...
    res = !!master;
#[no_mangle]
pub unsafe extern "C" fn if(master_idx: !master || master->ifindex !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtnl_dump_ifinfo(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int rtnl_dump_ifinfo(struct sk_buff *skb, struct netlink_callback *cb)
    {
    struct netlink_ext_ack *extack = cb.extack;
    struct rtnl_link_ops *kind_ops = core::ptr::null_mut();
    ...
    let mut ext_filter_mask: u32 = 0;
    struct net_device *dev;
    int ops_srcu_index;
    let mut master_idx: c_int = 0;
    let mut netnsid: c_int = -1;
    bool need_rtnl;
    int err, i;
...
// new attributes should only be added with strict checking
    ...
    ext_filter_mask, 0, core::ptr::null_mut(), 0,
    netnsid, GFP_KERNEL);
    if (err < 0)
    break;
    }
    ...
    {
    struct net *net = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tb[IFLA_NET_NS_FD]) -> else {
...
//
    ...
    err = -EOPNOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: af_ops->validate_link_af) -> else {
...
#[no_mangle]
unsafe extern "C" fn handle_vf_guid(dev: *mut net_device, ivt: *mut ifla_vf_guid, guid_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_setvfinfo(dev: *mut net_device, tb: *mut nlattr) -> c_int {
...
pub const DO_SETLINK_MODIFIED: c_uint = 0x01;
// notify flag means notify + modified.
pub const DO_SETLINK_NOTIFY: c_uint = 0x03;
    ...
    const char *pat = ifname[0] ? ifname : core::ptr::null_mut();
    int new_ifindex;
...
//
    ...
    if (tb[IFLA_TXQLEN]) {
    let mut value: c_uint = nla_get_u32(tb[IFLA_TXQLEN]);
    ...
    if (tb[IFLA_GSO_MAX_SIZE]) {
    let mut max_size: u32 = nla_get_u32(tb[IFLA_GSO_MAX_SIZE]);
    ...
    if (tb[IFLA_GSO_MAX_SEGS]) {
    let mut max_segs: u32 = nla_get_u32(tb[IFLA_GSO_MAX_SEGS]);
    ...
    if (tb[IFLA_GRO_MAX_SIZE]) {
    let mut gro_max_size: u32 = nla_get_u32(tb[IFLA_GRO_MAX_SIZE]);
    ...
    if (tb[IFLA_GSO_IPV4_MAX_SIZE]) {
    let mut max_size: u32 = nla_get_u32(tb[IFLA_GSO_IPV4_MAX_SIZE]);
    ...
    if (tb[IFLA_GRO_IPV4_MAX_SIZE]) {
    let mut gro_max_size: u32 = nla_get_u32(tb[IFLA_GRO_IPV4_MAX_SIZE]);
    ...
    if (tb[IFLA_LINKMODE]) {
    let mut value: c_uchar = nla_get_u8(tb[IFLA_LINKMODE]);
    ...
    err = nla_parse_nested_deprecated(port, IFLA_PORT_MAX,
    tb[IFLA_PORT_SELF],
    ifla_port_policy, core::ptr::null_mut());
    if (err < 0)
    goto errout;
    err = -EOPNOTSUPP;
    if (ops.ndo_set_vf_port)
    ...
    tb[IFLA_XDP],
    ifla_xdp_policy, core::ptr::null_mut());
    if (err < 0)
    goto errout;
    ...
    nla_strscpy(ifname, tb[IFLA_IFNAME], IFNAMSIZ);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tb[IFLA_ALT_IFNAME]) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(tb[IFLA_ALT_IFNAME]: tb[IFLA_IFNAME] ||) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtnl_group_dellink(net: *const net, group: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_delete_link(dev: *mut net_device, portid: u32, nlh: *const nlmsghdr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(tb[IFLA_ALT_IFNAME]: ifm->ifi_index > 0 || tb[IFLA_IFNAME] ||) -> else {
    else if (ifm.ifi_index > 0 || tb[IFLA_IFNAME] || tb[IFLA_ALT_IFNAME])
    err = -ENODEV;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tb[IFLA_GROUP]) -> else {
    ...
    {
    struct net_device *dev;
    let mut num_tx_queues: c_uint = 1;
    let mut num_rx_queues: c_uint = 1;
    int err;
    if (tb[IFLA_NUM_TX_QUEUES])
    num_tx_queues = nla_get_u32(tb[IFLA_NUM_TX_QUEUES]);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ops->get_num_tx_queues) -> else {
    else if (ops.get_num_tx_queues)
    num_tx_queues = ops.get_num_tx_queues();
    if (tb[IFLA_NUM_RX_QUEUES])
    num_rx_queues = nla_get_u32(tb[IFLA_NUM_RX_QUEUES]);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ops->get_num_rx_queues) -> else {
    ...
    if (tb[IFLA_MTU]) {
    let mut mtu: u32 = nla_get_u32(tb[IFLA_MTU]);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtnl_newlink_tbs {
    pub 1]: *mut *mut nlattr tb[IFLA_MAX +,
    pub 1]: *mut *mut nlattr linkinfo[IFLA_INFO_MAX +,
    pub 1]: *mut *mut nlattr attr[RTNL_MAX_TYPE +,
    pub 1]: *mut *mut nlattr slave_attr[RTNL_SLAVE_MAX_TYPE +,
}
    ...
    struct netlink_ext_ack *extack)
    {
    let mut linkinfo: *mut *mut nlattr  const = tbs.linkinfo;
    let mut tb: *mut *mut nlattr  const = tbs.tb;
    ...
    const struct rtnl_link_ops *m_ops = core::ptr::null_mut();
    struct nlattr **slave_data = core::ptr::null_mut();
    struct net_device *master_dev;
    ...
    struct netlink_ext_ack *extack)
    {
    let mut name_assign_type: c_uchar = NET_NAME_USER;
    ...
    return ERR_PTR(err);
    if (ops.validate) {
    err = ops.validate(tb, core::ptr::null_mut(), extack);
    if (err < 0)
    return ERR_PTR(err);
    }
    attrs = tb;
...
//
    ...
    struct netlink_ext_ack *extack)
    {
    struct net *tgt_net, *link_net = core::ptr::null_mut(), *peer_net = core::ptr::null_mut();
    struct nlattr **tb, **linkinfo, **data = core::ptr::null_mut();
    struct rtnl_link_ops *ops = core::ptr::null_mut();
    struct rtnl_newlink_tbs *tbs;
    struct rtnl_nets rtnl_nets;
    int ops_srcu_index;
    ...
    tb[IFLA_LINKINFO],
    ifla_info_policy, core::ptr::null_mut());
    if (ret < 0)
    goto free;
    } else {
    ...
    let mut id: c_int = nla_get_s32(tb[IFLA_LINK_NETNSID]);
...
//
    ...
    0, core::ptr::null_mut(), 0, netnsid, GFP_KERNEL);
    unlock:
    if (need_rtnl)
    rtnl_unlock();
    if (err < 0) {
...
pub unsafe extern "C" fn if(tb[IFLA_ALT_IFNAME]: tb[IFLA_IFNAME] ||) -> else {
    ...
    {
    struct net *net = sock_net(skb.sk);
    let mut min_ifinfo_dump_size: usize = 0;
    let mut ext_filter_mask: u32 = 0;
    struct net_device *dev;
    struct nlattr *nla;
    int hdrlen, rem;
...
#[no_mangle]
unsafe extern "C" fn rtnl_dump_all(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int rtnl_dump_all(struct sk_buff *skb, struct netlink_callback *cb)
    {
    int idx;
    let mut s_idx: c_int = cb.family;
    let mut type: c_int = cb.nlh.nlmsg_type - RTM_BASE;
    let mut ret: c_int = 0;
    if (s_idx == 0)
    s_idx = 1;
...
// -EMSGSIZE implies BUG in if_nlmsg_size()
    ...
    core::ptr::null_mut(), 0, portid, nlh);
    }
    void rtmsg_ifinfo_newnet(int type, struct net_device *dev, unsigned int change,
    gfp_t flags, int *new_nsid, int new_ifindex)
    {
    rtmsg_ifinfo_event(type, dev, change, rtnl_get_event(0), flags,
    new_nsid, new_ifindex, 0, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_fdb_nlmsg_size(dev: *const net_device) -> usize {
    ...
    rtnl_notify(skb, net, 0, RTNLGRP_NEIGH, core::ptr::null_mut(), GFP_ATOMIC);
    return;
    errout:
...
// p_vid = vid;
    ...
    u16 vid;
    int err;
    err = nlmsg_parse_deprecated(nlh, sizeof(*ndm), tb, NDA_MAX, core::ptr::null_mut(),
    extack);
    if (err < 0)
    return err;
    ndm = nlmsg_data(nlh);
...
pub unsafe extern "C" fn if(_arg: is_multicast_ether_addr(addr)) -> else {
    ...
    struct netlink_ext_ack *extack)
    {
    let mut del_bulk: bool = !!(nlh.nlmsg_flags & NLM_F_BULK);
    struct net *net = sock_net(skb.sk);
    const struct net_device_ops *ops;
    struct ndmsg *ndm;
    struct nlattr *tb[NDA_MAX+1];
    struct net_device *dev;
    __u8 *addr = core::ptr::null_mut();
    int err;
    u16 vid;
    if (!del_bulk) {
    err = nlmsg_parse_deprecated(nlh, sizeof(*ndm), tb, NDA_MAX,
    core::ptr::null_mut(), extack);
    } else {
// For bulk delete, the drivers will parse the message with
// policy.
//
    err = nlmsg_parse(nlh, sizeof(*ndm), tb, NDA_MAX, core::ptr::null_mut(), extack);
    }
    if (err < 0)
    return err;
    ndm = nlmsg_data(nlh);
...
//
    ...
    NDA_MAX, core::ptr::null_mut(), extack);
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn rtnl_fdb_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int rtnl_fdb_dump(struct sk_buff *skb, struct netlink_callback *cb)
    {
    const struct net_device_ops *ops = core::ptr::null_mut(), *cops = core::ptr::null_mut();
    struct ndo_fdb_dump_context *ctx = (void *)cb.ctx;
    struct net_device *dev, *br_dev = core::ptr::null_mut();
    struct net *net = sock_net(skb.sk);
    let mut brport_idx: c_int = 0;
    let mut br_idx: c_int = 0;
    let mut fidx: c_int = 0;
    int err;
    ...
    err = dev.netdev_ops.ndo_fdb_dump(skb, cb, dev, core::ptr::null_mut(),
    &fidx);
    else
    err = ndo_dflt_fdb_dump(skb, cb, dev, core::ptr::null_mut(), &fidx);
    if (err == -EMSGSIZE)
    break;
    cops = core::ptr::null_mut();
...
// addr = nla_data(tb[i]);
    ...
    struct netlink_ext_ack *extack)
    {
    struct net_device *dev = core::ptr::null_mut(), *br_dev = core::ptr::null_mut();
    const struct net_device_ops *ops = core::ptr::null_mut();
    struct net *net = sock_net(in_skb.sk);
    struct nlattr *tb[NDA_MAX + 1];
    struct sk_buff *skb;
    let mut brport_idx: c_int = 0;
    let mut ndm_flags: u8 = 0;
    let mut br_idx: c_int = 0;
    u8 *addr = core::ptr::null_mut();
    let mut vid: u16 = 0;
    int err;
    ...
    let mut operstate: u8 = netif_running(dev) ? dev.operstate : IF_OPER_DOWN;
    struct net_device *br_dev = netdev_master_upper_dev_get(dev);
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rtnl_bridge_getlink(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    ...
    struct net_device *dev;
    let mut idx: c_int = 0;
    let mut portid: u32 = NETLINK_CB(cb.skb).portid;
    let mut seq: u32 = nlh.nlmsg_seq;
...
#[no_mangle]
pub unsafe extern "C" fn bridge_nlmsg_size() -> usize {
...
#[no_mangle]
unsafe extern "C" fn rtnl_bridge_notify(dev: *mut net_device) -> c_int {
...
//
    if (!skb.len)
    goto errout;
    rtnl_notify(skb, net, 0, RTNLGRP_LINK, core::ptr::null_mut(), GFP_ATOMIC);
    return 0;
    errout:
    WARN_ON(err == -EMSGSIZE);
    kfree_skb(skb);
    ...
    struct ifinfomsg *ifm;
    struct net_device *dev;
    struct nlattr *br_spec, *attr, *br_flags_attr = core::ptr::null_mut();
...
//
    ...
    struct ifinfomsg *ifm;
    struct net_device *dev;
    struct nlattr *br_spec, *attr = core::ptr::null_mut();
    int rem, err = -EOPNOTSUPP;
    let mut flags: u16 = 0;
    let mut have_flags: bool = false;
    if (nlmsg_len(nlh) < sizeof(*ifm))
    return -EINVAL;
    ifm = nlmsg_data(nlh);
    if (ifm.ifi_family != AF_BRIDGE)
...
#[no_mangle]
unsafe extern "C" fn stats_attr_valid(mask: c_uint, attrid: c_int, idxattr: c_int) -> bool {
    ...
    struct sk_buff *skb)
    {
    let mut size: c_uint = rtnl_offload_xstats_get_size_ndo(dev, attr_id);
    struct nlattr *attr = core::ptr::null_mut();
    void *attr_data;
    int err;
    if (!size)
    return -ENODATA;
    ...
    {
    let mut enabled: bool = netdev_offload_xstats_enabled(dev, type);
    return enabled ? sizeof(struct rtnl_hw_stats64) : 0;
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtnl_offload_xstats_request_used {
    pub request: bool,
    pub used: bool,
}
    ...
    struct netlink_ext_ack *extack)
    {
    let mut t_l3: enum netdev_offload_xstats_type = NETDEV_OFFLOAD_XSTATS_TYPE_L3;
    struct rtnl_offload_xstats_request_used ru_l3;
    struct nlattr *nest;
    int err;
    err = rtnl_offload_xstats_get_stats(dev, t_l3, &ru_l3, core::ptr::null_mut(), extack);
    if (err)
    return err;
    ...
    {
    let mut t_l3: enum netdev_offload_xstats_type = NETDEV_OFFLOAD_XSTATS_TYPE_L3;
    let mut attr_id_hw_s_info: c_int = IFLA_OFFLOAD_XSTATS_HW_S_INFO;
    let mut attr_id_l3_stats: c_int = IFLA_OFFLOAD_XSTATS_L3_STATS;
    let mut attr_id_cpu_hit: c_int = IFLA_OFFLOAD_XSTATS_CPU_HIT;
...
// prividx = attr_id_l3_stats;
    ...
    if (!attr)
    return -EMSGSIZE;
    err = rtnl_offload_xstats_get_stats(dev, t_l3, core::ptr::null_mut(),
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtnl_stats_dump_filters {
// mask[0] filters outer attributes. Then individual nests have their
// filtering mask at the index of the nested attribute.
//
    pub 1]: u32 mask[IFLA_STATS_MAX +,
}
    ...
    struct netlink_ext_ack *extack)
    {
    let mut filter_mask: c_uint = filters.mask[0];
    struct if_stats_msg *ifsm;
    struct nlmsghdr *nlh;
    struct nlattr *attr;
    let mut s_prividx: c_int = *prividx;
    int err;
    ASSERT_RTNL();
...
// idxattr)) {
    const struct rtnl_link_ops *ops = core::ptr::null_mut();
...
// not a multi message or no progress mean a real error
    ...
    const struct rtnl_stats_dump_filters *filters)
    {
    let mut size: usize = NLMSG_ALIGN(sizeof(struct if_stats_msg));
    let mut filter_mask: c_uint = filters.mask[0];
    if (stats_attr_valid(filter_mask, IFLA_STATS_LINK_64, 0))
    size += nla_total_size_64bit(sizeof(struct rtnl_link_stats64));
    if (stats_attr_valid(filter_mask, IFLA_STATS_LINK_XSTATS, 0)) {
    const struct rtnl_link_ops *ops = dev.rtnl_link_ops;
    let mut attr: c_int = IFLA_STATS_LINK_XSTATS;
...
// netdev_master_upper_dev_get can't take const
    ...
    ops = master.rtnl_link_ops;
    if (ops && ops.get_linkxstats_size) {
    let mut attr: c_int = IFLA_STATS_LINK_XSTATS_SLAVE;
    size += nla_total_size(ops.get_linkxstats_size(dev,
    attr));
...
//
    ...
    struct net *net = sock_net(skb.sk);
    struct net_device *dev = core::ptr::null_mut();
    let mut idxattr: c_int = 0, prividx = 0;
    struct if_stats_msg *ifsm;
    struct sk_buff *nskb;
    int err;
...
#[no_mangle]
unsafe extern "C" fn rtnl_stats_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtnl_offload_xstats_notify(dev: *mut net_device) {
    void rtnl_offload_xstats_notify(struct net_device *dev)
    {
    let mut response_filters: rtnl_stats_dump_filters = {};
    struct net *net = dev_net(dev);
    let mut idxattr: c_int = 0, prividx = 0;
    struct sk_buff *skb;
    let mut err: c_int = -ENOBUFS;
    ...
    &response_filters, &idxattr, &prividx, core::ptr::null_mut());
    if (err < 0) {
    kfree_skb(skb);
    goto errout;
    }
    rtnl_notify(skb, net, 0, RTNLGRP_STATS, core::ptr::null_mut(), GFP_KERNEL);
    return;
    errout:
    ...
    let mut req: u8 = nla_get_u8(tb[IFLA_STATS_SET_OFFLOAD_XSTATS_L3_STATS]);
    if (req)
    ...
    notify = true;
#[no_mangle]
pub unsafe extern "C" fn if(-EALREADY: err !=) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtnl_mdb_dump_ctx {
    pub idx: c_long,
}

#[no_mangle]
unsafe extern "C" fn rtnl_mdb_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
//
    ...
    if (NL_REQ_ATTR_CHECK(extack, core::ptr::null_mut(), tb, MDBA_GET_ENTRY)) {
...
// L2 mdb
    ...
    if (NL_REQ_ATTR_CHECK(extack, core::ptr::null_mut(), tb, MDBA_SET_ENTRY)) {
    ...
    {
    struct br_mdb_entry *entry = nla_data(attr);
    let mut zero_entry: br_mdb_entry = {};
    if (nla_len(attr) != sizeof(struct br_mdb_entry)) {
    NL_SET_ERR_MSG_ATTR(extack, attr, "Invalid attribute length");
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn rtnl_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int rtnl_dumpit(struct sk_buff *skb, struct netlink_callback *cb)
    {
    let mut needs_lock: bool = !(cb.flags & RTNL_FLAG_DUMP_UNLOCKED);
    let mut dumpit: rtnl_dumpit_func = cb.data;
    int err;
...
#[no_mangle]
unsafe extern "C" fn rtnetlink_rcv(skb: *mut sk_buff) {
    static void rtnetlink_rcv(struct sk_buff *skb)
    {
    netlink_rcv_skb(skb, &rtnetlink_rcv_msg);
    }
#[no_mangle]
unsafe extern "C" fn rtnetlink_bind(net: *mut net, group: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtnetlink_event(this: *mut notifier_block, event: c_ulong, ptr: *mut c_void) -> c_int {
    ...
    GFP_KERNEL, core::ptr::null_mut(), 0, 0, core::ptr::null_mut());
    break;
    default:
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn rtnetlink_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn rtnetlink_net_exit(net: *mut net) -> void __net_exit {
    static void __net_exit rtnetlink_net_exit(struct net *net)
    {
    netlink_kernel_release(net.rtnl);
    net.rtnl = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn rtnetlink_init() -> void __init {
