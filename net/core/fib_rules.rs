...
#[no_mangle]
unsafe extern "C" fn fib_default_rule_pref(ops: *mut fib_rules_ops) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rules_ops_put(ops: *mut fib_rules_ops) {
...
#[no_mangle]
unsafe extern "C" fn flush_route_cache(ops: *mut fib_rules_ops) {
...
#[no_mangle]
unsafe extern "C" fn __fib_rules_register(ops: *mut fib_rules_ops) -> c_int {
    ...
    return -EINVAL;
    if (ops.match == core::ptr::null_mut() || ops.configure == core::ptr::null_mut() ||
    ops.compare == core::ptr::null_mut() || ops.fill == core::ptr::null_mut() ||
    ops.action == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn fib_rules_cleanup_ops(ops: *mut fib_rules_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn fib_rules_unregister(ops: *mut fib_rules_ops) {
...
#[no_mangle]
unsafe extern "C" fn uid_range_set(range: *mut fib_kuid_range) -> c_int {
    static int uid_range_set(struct fib_kuid_range *range)
    {
    return uid_valid(range.start) && uid_valid(range.end);
    }
#[no_mangle]
unsafe extern "C" fn nla_get_kuid_range(tb: *mut nlattr) -> fib_kuid_range {
...
#[no_mangle]
unsafe extern "C" fn nla_put_uid_range(skb: *mut sk_buff, range: *mut fib_kuid_range) -> c_int {
    ...
    {
    let mut iif_is_l3_master: u8 = READ_ONCE(rule.iif_is_l3_master);
    ...
    const struct flowi *fl)
    {
    let mut oif_is_l3_master: u8 = READ_ONCE(rule.oif_is_l3_master);
...
#[no_mangle]
pub unsafe extern "C" fn fib_rules_seq_read(net: *const net, family: c_int) -> c_uint {
...
// port_mask = nla_get_u16(mask_attr);
    ...
    struct fib_rule *nlrule = core::ptr::null_mut();
...
// Backward jumps are prohibited to avoid endless loops
    ...
    {
    struct fib_rule *rule = core::ptr::null_mut(), *r, *last = core::ptr::null_mut();
    let mut err: c_int = -EINVAL, unresolved = 0;
    struct fib_rules_ops *ops = core::ptr::null_mut();
    struct nlattr *tb[FRA_MAX + 1];
    let mut user_priority: bool = false;
    struct fib_rule_hdr *frh;
    let mut unlock_rtnl: bool = false;
    ...
    if (rcu_dereference_protected(rule.ctarget, 1) == core::ptr::null_mut())
    unresolved = 1;
    list_for_each_entry(r, &ops.rules_list, list) {
    if (r.pref > rule.pref)
    break;
...
//
    ...
    struct netlink_ext_ack *extack, bool rtnl_held)
    {
    struct fib_rule *rule = core::ptr::null_mut(), *nlrule = core::ptr::null_mut();
    struct fib_rules_ops *ops = core::ptr::null_mut();
    struct nlattr *tb[FRA_MAX+1];
    let mut user_priority: bool = false;
    struct fib_rule_hdr *frh;
...
//
    ...
    call_fib_rule_notifiers(net, FIB_EVENT_RULE_DEL, rule, ops, core::ptr::null_mut());
    mutex_unlock(&ops.lock);
    ...
    goto nla_put_failure;
    if (rule.action == FR_ACT_GOTO &&
    rcu_access_pointer(rule.ctarget) == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn fib_nl_dumprule(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn attach_rules(rules: *mut list_head, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn detach_rules(rules: *mut list_head, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fib_rules_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn fib_rules_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn fib_rules_init() -> int __init {
