...
pub struct netdev_nl_dump_ctx {
    ...
    {
    let mut xsk_features: u64 = 0;
    let mut xdp_rx_meta: u64 = 0;
    void *hdr;
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_dev_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_dev_get_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_napi_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_napi_get_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    ...
    {
    let mut irq_suspend_timeout: u64 = 0;
    let mut gro_flush_timeout: u64 = 0;
    let mut threaded: u8 = 0;
    let mut defer: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_napi_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nla_put_napi_id(skb: *mut sk_buff, napi: *const napi_struct) -> c_int {
    ...
    let mut id: i32 = peernet2id_alloc(net, peer_net, GFP_ATOMIC);
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_queue_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_queue_get_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netdev_nl_stats_add(_sum: *mut c_void, _add: *const c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn netdev_stat_put(rsp: *mut sk_buff, attr_id: c_uint, value: u64) -> c_int {
...
// The op was there, but nothing reported, don't bother
    ...
    {
    let mut maxtype: c_int = ARRAY_SIZE(netdev_queue_id_nl_policy) - 1;
    ...
    {
    struct device *dma_dev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_bind_rx_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int netdev_nl_bind_rx_doit(struct sk_buff *skb, struct genl_info *info)
    {
    struct net_devmem_dmabuf_binding *binding;
    let mut niov_shift: c_uint = PAGE_SHIFT;
    ...
    let mut rx_page_size: u32 = nla_get_u32(info.attrs[NETDEV_A_DMABUF_RX_PAGE_SIZE]);
    ...
    err = -ENODEV;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !netdev_need_ops_lock(netdev)) -> else {
    ...
    binding = net_devmem_bind_dmabuf(netdev, core::ptr::null_mut(), dma_dev, DMA_FROM_DEVICE,
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_bind_tx_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    bind_dev != netdev ? netdev : core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_queue_create_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int netdev_nl_queue_create_doit(struct sk_buff *skb, struct genl_info *info)
    {
    let mut qmaxtype: c_int = ARRAY_SIZE(netdev_queue_id_nl_policy) - 1;
    let mut lmaxtype: c_int = ARRAY_SIZE(netdev_lease_nl_policy) - 1;
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_sock_priv_init(priv: *mut netdev_nl_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_sock_priv_destroy(priv: *mut netdev_nl_sock) {
...
#[no_mangle]
unsafe extern "C" fn netdev_genl_init() -> int __init {
