...
//! Source: net/core/sock_reuseport.c
#![no_std]
...
pub const INIT_SOCKS: c_int = 128;
    DEFINE_SPINLOCK(reuseport_lock);
    static DEFINE_IDA(reuseport_ida);
    static int reuseport_resurrect(struct sock *sk, struct sock_reuseport *old_reuse,
    struct sock_reuseport *reuse, bool bind_inany);
#[no_mangle]
pub unsafe extern "C" fn reuseport_has_conns_set(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn __reuseport_get_incoming_cpu(reuse: *mut sock_reuseport) {
...
#[no_mangle]
unsafe extern "C" fn __reuseport_put_incoming_cpu(reuse: *mut sock_reuseport) {
...
#[no_mangle]
unsafe extern "C" fn reuseport_get_incoming_cpu(sk: *mut sock, reuse: *mut sock_reuseport) {
...
#[no_mangle]
unsafe extern "C" fn reuseport_put_incoming_cpu(sk: *mut sock, reuse: *mut sock_reuseport) {
...
#[no_mangle]
pub unsafe extern "C" fn reuseport_update_incoming_cpu(sk: *mut sock, val: c_int) {
...
// reuseport_grow() has detached a closed sk.
    ...
    __reuseport_get_incoming_cpu(reuse);
#[no_mangle]
pub unsafe extern "C" fn if(0: old_sk_incoming_cpu >= 0 && val <) -> else {
...
// paired with smp_rmb() in reuseport_(select|migrate)_sock()
    ...
    struct sock_reuseport *reuse)
    {
    let mut i: c_int = reuseport_sock_index(sk, reuse, false);
    if (i == -1)
    return false;
...
// paired with READ_ONCE() in inet_csk_bind_conflict()
    ...
    struct sock_reuseport *reuse)
    {
    let mut i: c_int = reuseport_sock_index(sk, reuse, true);
    if (i == -1)
    return false;
...
// paired with READ_ONCE() in inet_csk_bind_conflict()
    ...
    RCU_INIT_POINTER(reuse.prog, core::ptr::null_mut());
    return reuse;
    }
#[no_mangle]
pub unsafe extern "C" fn reuseport_alloc(sk: *mut sock, bind_inany: bool) -> c_int {
...
// sk was shutdown()ed before
    ret = reuseport_resurrect(sk, reuse, core::ptr::null_mut(), bind_inany);
    goto out;
    }
...
//
    ...
    RCU_INIT_POINTER(sk.sk_reuseport_cb, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn reuseport_free_rcu(head: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn reuseport_add_sock(sk: *mut sock, sk2: *mut sock, bind_inany: bool) -> c_int {
    int reuseport_add_sock(struct sock *sk, struct sock *sk2, bool bind_inany)
    {
    struct sock_reuseport *old_reuse, *reuse;
    if (!rcu_access_pointer(sk2.sk_reuseport_cb)) {
    let mut err: c_int = reuseport_alloc(sk2, bind_inany);
    if (err)
    return err;
    }
    spin_lock_bh(&reuseport_lock);
...
// sk was shutdown()ed before
    let mut err: c_int = reuseport_resurrect(sk, old_reuse, reuse, reuse.bind_inany);
    spin_unlock_bh(&reuseport_lock);
    return err;
    }
...
#[no_mangle]
pub unsafe extern "C" fn reuseport_detach_sock(sk: *mut sock) {
...
//
    ...
    rcu_assign_pointer(sk.sk_reuseport_cb, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn reuseport_stop_listen_sock(sk: *mut sock) {
...
// Not capable to do migration, detach immediately
    ...
    int hdr_len)
    {
    struct sk_buff *nskb = core::ptr::null_mut();
    u32 index;
    if (skb_shared(skb)) {
...
// temporarily advance data past protocol header
    ...
    {
    struct sock *first_valid_sk = core::ptr::null_mut();
    int i, j;
...
// paired with smp_wmb() in __reuseport_add_sock()
    ...
    sk2 = bpf_run_sk_reuseport(reuse, sk, prog, skb, core::ptr::null_mut(), hash);
    else
...
//
    ...
    {
    struct sock_reuseport *reuse;
    struct sock *nsk = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn reuseport_attach_prog(sk: *mut sock, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn reuseport_detach_prog(sk: *mut sock) -> c_int {
