...
#[no_mangle]
unsafe extern "C" fn ksock_release_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bpf_ksock_has_user_task_context() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_ksock_release(ks: *mut bpf_ksock) -> __bpf_kfunc void {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_ksock_release_dtor(ks: *mut c_void) -> __bpf_kfunc void {
...
#[no_mangle]
unsafe extern "C" fn bpf_ksock_kfunc_filter(prog: *const bpf_prog, kfunc_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_ksock_kfunc_init() -> int __init {
