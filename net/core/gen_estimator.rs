...
//! Source: net/core/gen_estimator.c
#![no_std]
...
pub struct net_rate_estimator {
    ...
    pub ewma_log: u8,
    pub /: *mut *mut u8 intvl_log; / period : (250ms << intvl_log),
    pub seq: seqcount_t,
...
//
#[no_mangle]
pub unsafe extern "C" fn gen_kill_estimator(rate_est: *mut net_rate_estimator __rcu) {
    void gen_kill_estimator(struct net_rate_estimator __rcu **rate_est)
    {
    struct net_rate_estimator *est;
    est = unrcu_pointer(xchg(rate_est, core::ptr::null_mut()));
    if (est) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gen_estimator_active(rate_est: *mut net_rate_estimator __rcu) -> bool {
