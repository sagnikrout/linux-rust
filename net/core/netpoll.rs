...
pub const USEC_PER_POLL: c_int = 50;
//
...
//
    let mut carrier_timeout: static unsigned int = 4;
...
#[no_mangle]
unsafe extern "C" fn netif_local_xmit_active(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn poll_one_napi(napi: *mut napi_struct) {
...
#[no_mangle]
unsafe extern "C" fn poll_napi(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netpoll_owner_active(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __netpoll_send_skb(np: *mut netpoll, skb: *mut sk_buff) -> netdev_tx_t {
    static netdev_tx_t __netpoll_send_skb(struct netpoll *np, struct sk_buff *skb)
    {
    let mut status: netdev_tx_t = NETDEV_TX_BUSY;
    let mut ret: netdev_tx_t = NET_XMIT_DROP;
    struct net_device *dev;
    unsigned long tries;
...
#[no_mangle]
unsafe extern "C" fn __netpoll_cleanup(np: *mut netpoll) {
