...
//
#[no_mangle]
unsafe extern "C" fn failover_slave_register(slave_dev: *mut net_device) -> c_int {
    ...
    err = netdev_master_upper_dev_link(slave_dev, failover_dev, core::ptr::null_mut(),
    &lag_upper_info, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn failover_slave_link_change(slave_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn failover_slave_name_change(slave_dev: *mut net_device) -> c_int {
