...
//! Source: net/core/page_pool_user.c
#![no_std]
...
// Either the provided ifindex doesn't exist or done dumping
    ...
    const struct genl_info *info = genl_info_dump(cb);
    struct nlattr *ifindex_attr = core::ptr::null_mut();
    ...
    goto err_cancel;
    if (pool.mp_ops && pool.mp_ops.nl_fill(pool.mp_priv, rsp, core::ptr::null_mut()))
    goto err_cancel;
    genlmsg_end(rsp, hdr);
    return 0;
    err_cancel:
...
#[no_mangle]
unsafe extern "C" fn netdev_nl_page_pool_event(pool: *const page_pool, cmd: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn netdev_nl_page_pool_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn page_pool_detached(pool: *mut page_pool) {
...
#[no_mangle]
pub unsafe extern "C" fn page_pool_unlist(pool: *mut page_pool) {
...
#[no_mangle]
unsafe extern "C" fn page_pool_unreg_netdev_wipe(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn page_pool_unreg_netdev(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn page_pool_user_init() -> int __init {
