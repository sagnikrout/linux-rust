...
#[no_mangle]
unsafe extern "C" fn bpf_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmit_check_headroom(skb: *mut sk_buff, hroom: c_int) -> c_int {
    static int xmit_check_headroom(struct sk_buff *skb, int hroom)
    {
    if (skb_headroom(skb) < hroom) {
    let mut nhead: c_int = hroom - skb_headroom(skb);
...
unsafe extern "C" fn bpf_lwt_xmit_reroute(skb: *mut sk_buff) -> c_int {
    ...
    let mut oif: c_int = l3mdev ? l3mdev.ifindex : 0;
...
pub unsafe extern "C" fn if(htons(ETH_P_IPV6): skb->protocol ==) -> else {
    ...
    dst = ip6_dst_lookup_flow(net, skb.sk, &fl6, core::ptr::null_mut());
    if (IS_ERR(dst)) {
    err = PTR_ERR(dst);
    goto err;
    }
...
unsafe extern "C" fn bpf_xmit(skb: *mut sk_buff) -> c_int {
    ...
    bpf = bpf_lwt_lwtunnel(dst.lwtstate);
    if (bpf.xmit.prog) {
    let mut hroom: c_int = LL_RESERVED_SPACE(dst.dev);
...
unsafe extern "C" fn bpf_destroy_state(lwt: *mut lwtunnel_state) {
    ...
    let mut headroom: u32 = nla_get_u32(tb[LWT_BPF_XMIT_HEADROOM]);
...
#[no_mangle]
unsafe extern "C" fn bpf_fill_encap_info(skb: *mut sk_buff, lwt: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_lwt_prog_cmp(a: *mut bpf_lwt_prog, b: *mut bpf_lwt_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_encap_cmp(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_gso_encap(skb: *mut sk_buff, ipv4: bool, encap_len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_lwt_push_ip_encap(skb: *mut sk_buff, hdr: *mut c_void, len: u32, ingress: bool) -> c_int {
...
// push the encap headers and fix pointers
    ...
    if (is_udp_tunnel) {
    let mut iph_sz: usize = ipv4 ? iph.ihl * 4 : sizeof(struct ipv6hdr);
...
#[no_mangle]
unsafe extern "C" fn bpf_lwt_init() -> int __init {
