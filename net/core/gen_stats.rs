...
//
    ...
    if (d.tail) {
    let mut ret: c_int = gnet_stats_copy(d, type, core::ptr::null_mut(), 0, padattr);
...
#[no_mangle]
pub unsafe extern "C" fn gnet_stats_basic_sync_init(b: *mut gnet_stats_basic_sync) {
    ...
    {
    let mut t_bytes: u64 = 0, t_packets = 0;
    int i;
