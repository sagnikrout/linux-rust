...
//! Source: net/core/flow_dissector.c
#![no_std]
...
//
    ...
    {
    let mut type: enum netns_bpf_attach_type = NETNS_BPF_FLOW_DISSECTOR;
    if (net == &init_net) {
...
//
    ...
    {
    let mut poff: c_int = proto_ports_offset(ip_proto);
    if (!data) {
    data = skb.data;
...
#[no_mangle]
unsafe extern "C" fn icmp_has_id(type: u8) -> bool {
...
// p_nhoff += sizeof(*hdr);
    ...
    {
    struct flow_dissector_key_ports_range *key_ports_range = core::ptr::null_mut();
    struct flow_dissector_key_ports *key_ports = core::ptr::null_mut();
    __be32 ports;
...
// __skb_flow_dissect
//
pub const MAX_FLOW_DISSECT_HDRS: c_int = 15;
#[no_mangle]
unsafe extern "C" fn skb_flow_dissect_allowed(num_hdrs: *mut c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_pppoe_ses_hdr_valid(hdr: *const pppoe_hdr) -> bool {
...
//
    ...
    let mut dissector_vlan: enum flow_dissector_key_id = FLOW_DISSECTOR_KEY_MAX;
    let mut mpls_el: bool = false;
    let mut mpls_lse: c_int = 0;
    let mut num_hdrs: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: skb->sk) -> else {
    else if (skb.sk)
    net = sock_net(skb.sk);
    }
    }
...
//
    ...
    ip6_flowlabel(iph)) {
    let mut flow_label: __be32 = ip6_flowlabel(iph);
    if (dissector_uses_key(flow_dissector,
    FLOW_DISSECTOR_KEY_FLOW_LABEL)) {
    key_tags = skb_flow_dissector_target(flow_dissector,
    FLOW_DISSECTOR_KEY_FLOW_LABEL,
    ...
    const struct vlan_hdr *vlan = core::ptr::null_mut();
    struct vlan_hdr _vlan;
    let mut saved_vlan_tpid: __be16 = proto;
...
#[no_mangle]
unsafe extern "C" fn __flow_hash_secret_init() -> __always_inline void {
...
#[no_mangle]
pub unsafe extern "C" fn flow_keys_hash_length(flow: *const flow_keys) -> usize {
    static inline size_t flow_keys_hash_length(const struct flow_keys *flow)
    {
    let mut diff: usize = FLOW_KEYS_HASH_OFFSET + sizeof(flow.addrs);
...
#[no_mangle]
pub unsafe extern "C" fn flow_get_u32_src(flow: *const flow_keys) -> __be32 {
...
#[no_mangle]
pub unsafe extern "C" fn flow_get_u32_dst(flow: *const flow_keys) -> __be32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn __flow_hash_consistentify(keys: *mut flow_keys) {
    static inline void __flow_hash_consistentify(struct flow_keys *keys)
    {
    int addr_diff, i;
    switch (keys.control.addr_type) {
    case FLOW_DISSECTOR_KEY_IPV4_ADDRS:
    if (( u32)keys.addrs.v4addrs.dst <
    ( u32)keys.addrs.v4addrs.src)
    swap(keys.addrs.v4addrs.src, keys.addrs.v4addrs.dst);
    if (( u16)keys.ports.dst <
    ( u16)keys.ports.src) {
...
#[no_mangle]
pub unsafe extern "C" fn flow_hash_from_keys(keys: *mut flow_keys) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _flow_keys_digest_data {
    pub n_proto: __be16,
    pub ip_proto: u8,
    pub padding: u8,
    pub ports: __be32,
...
#[no_mangle]
pub unsafe extern "C" fn __skb_get_hash_symmetric_net(net: *const net, skb: *const sk_buff) -> u32 {
    ...
    &keys, core::ptr::null_mut(), 0, 0, 0, 0);
    return __flow_hash_from_keys(&keys, &hashrnd);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn __skb_get_hash_net(net: *const net, skb: *mut sk_buff) {
    ...
    {
    let mut poff: u32 = keys.control.thoff;
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_get_poff(skb: *const sk_buff) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn __get_hash_from_flowi6(fl6: *const flowi6, keys: *mut flow_keys) -> __u32 {
    ...
    keys.tags.flow_label = ( u32)flowi6_get_flowlabel(fl6);
...
#[no_mangle]
unsafe extern "C" fn init_default_flow_dissectors() -> int __init {
