...
//
#[no_mangle]
unsafe extern "C" fn dev_ifname(net: *mut net, ifr: *mut ifreq) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_ifconf(net: *mut net, uifc: *mut ifconf __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dev_getifmap(dev: *mut net_device, ifr: *mut ifreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netif_setifmap(dev: *mut net_device, ifr: *mut ifreq) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dev_ifsioc_locked(net: *mut net, ifr: *mut ifreq, cmd: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn net_hwtstamp_validate(cfg: *const kernel_hwtstamp_config) -> c_int {
    int net_hwtstamp_validate(const struct kernel_hwtstamp_config *cfg)
    {
    enum hwtstamp_tx_types tx_type;
    enum hwtstamp_rx_filters rx_filter;
    let mut tx_type_valid: c_int = 0;
    let mut rx_filter_valid: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn dev_get_hwtstamp(dev: *mut net_device, ifr: *mut ifreq) -> c_int {
    static int dev_get_hwtstamp(struct net_device *dev, struct ifreq *ifr)
    {
    const struct net_device_ops *ops = dev.netdev_ops;
    let mut kernel_cfg: kernel_hwtstamp_config = {};
...
//
    ...
    {
    const struct net_device_ops *ops = dev.netdev_ops;
    let mut old_cfg: kernel_hwtstamp_config = {};
    struct hwtstamp_provider *hwprov;
    ...
    if (err) {
    if (changed)
    ops.ndo_hwtstamp_set(dev, &old_cfg, core::ptr::null_mut());
    return err;
    }
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn dev_set_hwtstamp(dev: *mut net_device, ifr: *mut ifreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dev_siocwandev(dev: *mut net_device, ifs: *mut if_settings) -> c_int {
...
//
    ...
    return dev_change_flags(dev, ifr.ifr_flags, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_load(net: *mut net, name: *const c_char) {
