...
//
#[no_mangle]
pub unsafe extern "C" fn drop_reasons_unregister_subsys(subsys: enum skb_drop_reason_subsys) {
    ...
    "invalid subsystem %d\n", subsys))
    return;
    RCU_INIT_POINTER(drop_reasons_by_subsys[subsys], core::ptr::null_mut());
    synchronize_rcu();
    }
...
//
    ...
    skb.dev ? skb.dev.name : "<core::ptr::null_mut()>");
    BUG();
    }
#[no_mangle]
unsafe extern "C" fn skb_over_panic(skb: *mut sk_buff, sz: c_uint, addr: *mut c_void) {
    static void skb_over_panic(struct sk_buff *skb, unsigned int sz, void *addr)
    {
    skb_panic(skb, sz, addr, __func__);
    }
#[no_mangle]
unsafe extern "C" fn skb_under_panic(skb: *mut sk_buff, sz: c_uint, addr: *mut c_void) {
    static void skb_under_panic(struct sk_buff *skb, unsigned int sz, void *addr)
    {
    skb_panic(skb, sz, addr, __func__);
    }
pub const NAPI_SKB_CACHE_SIZE: c_int = 128;
pub const NAPI_SKB_CACHE_BULK: c_int = 32;
pub const NAPI_SKB_CACHE_FREE: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct napi_alloc_cache {
    pub bh_lock: local_lock_t,
    pub page: page_frag_cache,
    pub skb_count: c_uint,
    pub skb_cache: [*mut c_void; NAPI_SKB_CACHE_SIZE],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn skbuff_clear(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn napi_skb_cache_get_bulk(skbs: *mut c_void, n: u32) -> u32 {
...
//
    ...
    {
    let mut gfp_mask: gfp_t = GFP_ATOMIC | __GFP_NOWARN;
...
#[no_mangle]
unsafe extern "C" fn skb_drop_list(listp: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn skb_drop_fraglist(skb: *mut sk_buff) {
    static inline void skb_drop_fraglist(struct sk_buff *skb)
    {
    skb_drop_list(&skb_shinfo(skb).frag_list);
    }
#[no_mangle]
unsafe extern "C" fn skb_clone_fraglist(skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn napi_pp_put_page(netmem: netmem_ref) -> bool {
...
#[no_mangle]
unsafe extern "C" fn skb_pp_recycle(skb: *mut sk_buff, data: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn skb_pp_frag_ref(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skb_kfree_head(head: *mut c_void) {
    static void skb_kfree_head(void *head)
    {
    kfree(head);
    }
#[no_mangle]
unsafe extern "C" fn skb_free_head(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn skb_release_data(skb: *mut sk_buff, reason: enum skb_drop_reason) {
    ...
    goto exit;
    if (skb_zcopy(skb)) {
    let mut skip_unref: bool = shinfo.flags & SKBFL_MANAGED_FRAG_REFS;
...
//
#[no_mangle]
unsafe extern "C" fn kfree_skbmem(skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn skb_release_head_state(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn skb_release_all(skb: *mut sk_buff, reason: enum skb_drop_reason) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __kfree_skb(skb: *mut sk_buff) {
...
pub const KFREE_SKB_BULK_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct skb_free_array {
    pub skb_count: c_uint,
    pub skb_array: [*mut c_void; KFREE_SKB_BULK_SIZE],
}
...
// if SKB is a clone, don't handle this case
    ...
    if (__sk_skb_reason_drop(core::ptr::null_mut(), segs, reason)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_dump(level: *const c_char, skb: *const sk_buff, full_pkt: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_tx_error(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn consume_skb(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __consume_stateless_skb(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn napi_skb_cache_put(skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn __napi_kfree_skb(skb: *mut sk_buff, reason: enum skb_drop_reason) {
...
#[no_mangle]
pub unsafe extern "C" fn napi_skb_free_stolen_head(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn napi_consume_skb(skb: *mut sk_buff, budget: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __copy_skb_header(new: *mut sk_buff, old: *const sk_buff) {
...
//
    ...
    n.next = n.prev = core::ptr::null_mut();
    n.sk = core::ptr::null_mut();
    ...
    C(pfmemalloc);
    C(pp_recycle);
    n.destructor = core::ptr::null_mut();
    C(tail);
    C(end);
    C(head);
    C(head_frag);
...
#[no_mangle]
pub unsafe extern "C" fn mm_account_pinned_pages(mmp: *mut mmpin, size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mm_unaccount_pinned_pages(mmp: *mut mmpin) {
    ...
    uarg = (void *)skb.cb;
    uarg.mmp.user = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn skb_zerocopy_notify_extend(skb: *mut sk_buff, lo: u32, len: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __msg_zerocopy_callback(uarg: *mut ubuf_info_msgzc) {
...
#[no_mangle]
pub unsafe extern "C" fn msg_zerocopy_put_abort(uarg: *mut ubuf_info, have_uref: bool) {
    ...
    if (have_uref)
    msg_zerocopy_complete(core::ptr::null_mut(), uarg, true);
    }
...
// Streams do not free skb on error. Reset to prev state.
    ...
    skb_zcopy_set(skb, uarg, core::ptr::null_mut());
    return skb.len - orig_len;
    }
    EXPORT_SYMBOL_GPL(skb_zerocopy_iter_stream);
#[no_mangle]
pub unsafe extern "C" fn __skb_zcopy_downgrade_managed(skb: *mut sk_buff) {
...
// !gfp_mask callers are verified to !skb_zcopy(nskb)
    ...
    skb_zcopy_set(nskb, skb_uarg(orig), core::ptr::null_mut());
    }
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_copy_ubufs(skb: *mut sk_buff, gfp_mask: gfp_t) -> c_int {
    int skb_copy_ubufs(struct sk_buff *skb, gfp_t gfp_mask)
    {
    let mut num_frags: c_int = skb_shinfo(skb).nr_frags;
    struct page *page, *head = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn skb_headers_offset_update(skb: *mut sk_buff, off: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn skb_copy_header(new: *mut sk_buff, old: *const sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn skb_alloc_rx_flag(skb: *const sk_buff) -> c_int {
...
//
    ...
    {
    let mut size: c_uint = skb_headlen(skb) + headroom;
    let mut flags: c_int = skb_alloc_rx_flag(skb) | (fclone ? SKB_ALLOC_FCLONE : 0);
...
//
    ...
    gfp_t gfp_mask)
    {
    let mut osize: c_uint = skb_end_offset(skb);
    let mut size: c_uint = osize + nhead + ntail;
    long off;
    u8 *data;
    int i;
    BUG_ON(nhead < 0);
    ...
    if (skb_pfmemalloc(skb))
    gfp_mask |= __GFP_MEMALLOC;
    data = kmalloc_reserve(&size, gfp_mask, NUMA_NO_NODE, core::ptr::null_mut());
    if (!data)
    goto nodata;
...
// Make private copy of skb with writable head and some headroom
    ...
    {
    struct sk_buff *skb2;
    let mut delta: c_int = headroom - skb_headroom(skb);
    if (delta <= 0)
...
#[no_mangle]
pub unsafe extern "C" fn __skb_unclone_keeptruesize(skb: *mut sk_buff, pri: gfp_t) -> c_int {
...
//
    ...
    {
    let mut delta: c_int = headroom - skb_headroom(skb);
    let mut osize: c_int = skb_end_offset(skb);
    struct sock *sk = skb.sk;
...
//
#[no_mangle]
pub unsafe extern "C" fn __skb_pad(skb: *mut sk_buff, pad: c_int, free_on_error: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_trim(skb: *mut sk_buff, len: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ___pskb_trim(skb: *mut sk_buff, len: c_uint) -> c_int {
    int ___pskb_trim(struct sk_buff *skb, unsigned int len)
    {
    struct sk_buff **fragp;
    struct sk_buff *frag;
    let mut offset: c_int = skb_headlen(skb);
    ...
    goto drop_pages;
    for (; i < nfrags; i++) {
    let mut end: c_int = offset + skb_frag_size(&skb_shinfo(skb).frags[i]);
    if (end < len) {
    offset = end;
    continue;
    }
    ...
    fragp = &frag.next) {
    let mut end: c_int = offset + frag.len;
    if (skb_shared(frag)) {
...
#[no_mangle]
unsafe extern "C" fn pskb_trim_rcsum_complete(skb: *mut sk_buff, len: c_uint) -> c_int {
    static int pskb_trim_rcsum_complete(struct sk_buff *skb, unsigned int len)
    {
    let mut delta: c_int = skb.len - len;
    if (skb_frags_readable(skb)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pskb_trim_rcsum_slow(skb: *mut sk_buff, len: c_uint) -> c_int {
    ...
    let mut hdlen: c_int = (len > skb_headlen(skb)) ? skb_headlen(skb) : len;
    let mut offset: c_int = skb_checksum_start_offset(skb) + skb.csum_offset;
...
// Estimate size of pulled pages.
    eat = delta;
    for (i = 0; i < skb_shinfo(skb).nr_frags; i++) {
    let mut size: c_int = skb_frag_size(&skb_shinfo(skb).frags[i]);
    if (size >= eat)
    goto pull_pages;
    eat -= size;
    }
...
//
    ...
    struct sk_buff *clone = core::ptr::null_mut();
    struct sk_buff *insp = core::ptr::null_mut();
    do {
    if (list.len <= eat) {
// Eaten as whole.
    eat -= list.len;
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_copy_bits(skb: *const sk_buff, offset: c_int, to: *mut c_void, len: c_int) -> c_int {
    int skb_copy_bits(const struct sk_buff *skb, int offset, void *to, int len)
    {
    let mut start: c_int = skb_headlen(skb);
...
//
#[no_mangle]
unsafe extern "C" fn sock_spd_release(spd: *mut splice_pipe_desc, i: c_uint) {
...
// off = 0;
    do {
    let mut flen: c_uint = min(*len, plen);
...
#[no_mangle]
unsafe extern "C" fn sendmsg_locked(sk: *mut sock, msg: *mut msghdr) -> c_int {
    static int sendmsg_locked(struct sock *sk, struct msghdr *msg)
    {
    struct socket *sock = sk.sk_socket;
    let mut size: usize = msg_data_left(msg);
    if (!sock)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn sendmsg_unlocked(sk: *mut sock, msg: *mut msghdr) -> c_int {
    ...
    {
    let mut more_hint: c_int = sk_is_tcp(sk) ? MSG_MORE : 0;
    let mut orig_len: c_uint = len;
...
// Process any frag lists
    ...
    return orig_len - len;
    error:
    let mut orig_len: return = = len ? ret : orig_len - len;
    }
...
#[no_mangle]
pub unsafe extern "C" fn skb_send_sock(sk: *mut sock, skb: *mut sk_buff, offset: c_int, len: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_store_bits(skb: *mut sk_buff, offset: c_int, from: *const c_void, len: c_int) -> c_int {
...
// Checksum skb data.
#[no_mangle]
pub unsafe extern "C" fn skb_checksum(skb: *const sk_buff, offset: c_int, len: c_int, csum: __wsum) -> __wsum {
...
#[no_mangle]
pub unsafe extern "C" fn skb_crc32c(skb: *const sk_buff, offset: c_int, len: c_int, crc: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn __skb_checksum_complete_head(skb: *mut sk_buff, len: c_int) -> __sum16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn __skb_checksum_complete(skb: *mut sk_buff) -> __sum16 {
...
#[no_mangle]
pub unsafe extern "C" fn skb_copy_and_csum_dev(skb: *const sk_buff, to: *mut u8) {
    ...
    skb.len - csstart);
    if (skb.ip_summed == CHECKSUM_PARTIAL) {
    let mut csstuff: c_long = csstart + skb.csum_offset;
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_rbtree_purge(root: *mut rb_root) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn skb_errqueue_purge(list: *mut sk_buff_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_queue_head(list: *mut sk_buff_head, newsk: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_queue_tail(list: *mut sk_buff_head, newsk: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_unlink(skb: *mut sk_buff, list: *mut sk_buff_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_append(old: *mut sk_buff, newsk: *mut sk_buff, list: *mut sk_buff_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_split(skb: *mut sk_buff, skb1: *mut sk_buff, len: u32) {
    void skb_split(struct sk_buff *skb, struct sk_buff *skb1, const u32 len)
    {
    let mut pos: c_int = skb_headlen(skb);
    let mut zc_flags: c_int = SKBFL_SHARED_FRAG | SKBFL_PURE_ZEROCOPY;
    skb_zcopy_downgrade_managed(skb);
...
//
#[no_mangle]
unsafe extern "C" fn skb_prepare_for_shift(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_shift(tgt: *mut sk_buff, skb: *mut sk_buff, shiftlen: c_int) -> c_int {
...
//
    ...
    st.frag_data = core::ptr::null_mut();
    st.frag_off = 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_abort_seq_read(st: *mut skb_seq_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_copy_seq_read(st: *mut skb_seq_state, offset: c_int, to: *mut c_void, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skb_ts_finish(conf: *mut ts_config, state: *mut ts_state) {
...
//
    ...
    {
    let mut patlen: c_uint = config.ops.get_pattern_len(config);
    struct ts_state state;
    unsigned int ret;
    ...
    {
    let mut i: c_int = skb_shinfo(skb).nr_frags;
...
#[no_mangle]
pub unsafe extern "C" fn skb_head_frag_to_page_desc(frag_skb: *mut sk_buff) -> skb_frag_t {
    ...
    let mut tnl_hlen: c_uint = skb_tnl_header_len(skb);
    let mut delta_len: c_uint = 0;
    struct sk_buff *tail = core::ptr::null_mut();
...
//
    ...
    let mut mss: c_uint = skb_shinfo(head_skb).gso_size;
    let mut gso_by_frags: bool = mss == GSO_BY_FRAGS;
    let mut doffset: c_uint = head_skb.data - skb_mac_header(head_skb);
    let mut offset: c_uint = doffset;
    let mut tnl_hlen: c_uint = skb_tnl_header_len(head_skb);
    let mut partial_segs: c_uint = 0;
    unsigned int headroom;
    let mut len: c_uint = head_skb.len;
...
//
    ...
    proto = skb_network_protocol(head_skb, core::ptr::null_mut());
    if (unlikely(!proto))
...
//
    ...
    if (partial_segs) {
    struct sk_buff *iter;
    let mut type: c_int = skb_shinfo(head_skb).gso_type;
    let mut gso_size: c_ushort = skb_shinfo(head_skb).gso_size;
...
#[no_mangle]
pub unsafe extern "C" fn if(segs: tail !=) -> else {
    else if (tail != segs)
...
pub const SKB_EXT_ALIGN_VALUE: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn skb_ext_total_length() -> __always_inline __no_profile unsigned int {
    static __always_inline __no_profile unsigned int skb_ext_total_length(void)
    {
    let mut l: c_uint = SKB_EXT_CHUNKSIZEOF(struct skb_ext);
    int i;
...
#[no_mangle]
unsafe extern "C" fn skb_extensions_init() -> noinline void __init __no_profile {
...
pub const FLAG_SKB_NO_MERGE: c_int = 0;

#[no_mangle]
pub unsafe extern "C" fn skb_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_to_sgvec(skb: *mut sk_buff, sg: *mut scatterlist, offset: c_int, len: c_int) -> c_int {
    int skb_to_sgvec(struct sk_buff *skb, struct scatterlist *sg, int offset, int len)
    {
    let mut nsg: c_int = __skb_to_sgvec(skb, sg, offset, len, 0);
    if (nsg <= 0)
    return nsg;
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_cow_data(skb: *mut sk_buff, tailbits: c_int, trailer: *mut sk_buff) -> c_int {
...
// Misery. We are in troubles, going to mincer fragments...
    ...
    copyflag = 0;
    while ((skb1 = *skb_p) != core::ptr::null_mut()) {
    let mut ntail: c_int = 0;
...
// If the skb is the last, worry about trailer.
    if (skb1.next == core::ptr::null_mut() && tailbits) {
...
// Fuck, we are miserable poor guys...
    ...
    ntail,
    GFP_ATOMIC);
    if (unlikely(skb2 == core::ptr::null_mut()))
    return -ENOMEM;
    if (skb1.sk)
...
#[no_mangle]
pub unsafe extern "C" fn sock_rmem_free(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn skb_set_err_queue(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_queue_err_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_icmp_err_skb(skb: *const sk_buff) -> bool {
    ...
    struct sk_buff *skb, *skb_next = core::ptr::null_mut();
    let mut icmp_next: bool = false;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn skb_may_tx_timestamp(sk: *mut sock, tsonly: bool) -> bool {
...
// skb_hwtstamps(skb) = *hwtstamps;
    ...
    struct skb_shared_hwtstamps *hwtstamps)
    {
    return __skb_tstamp_tx(orig_skb, core::ptr::null_mut(), hwtstamps, orig_skb.sk,
    SCM_TSTAMP_SND);
    }
    EXPORT_SYMBOL_GPL(skb_tstamp_tx);

#[no_mangle]
pub unsafe extern "C" fn skb_complete_wifi_ack(skb: *mut sk_buff, acked: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_partial_csum_set(skb: *mut sk_buff, start: u16, off: u16) -> bool {
    bool skb_partial_csum_set(struct sk_buff *skb, u16 start, u16 off)
    {
    let mut csum_end: u32 = (u32)start + (u32)off + sizeof(__sum16);
    let mut csum_start: u32 = skb_headroom(skb) + (u32)start;
...
//
    if (max > skb.len)
    max = skb.len;
    if (__pskb_pull_tail(skb, max - skb_headlen(skb)) == core::ptr::null_mut())
    return -ENOMEM;
    if (skb_headlen(skb) < len)
    return -EPROTO;
    return 0;
...
//
pub const MAX_IP_HDR_LEN: c_int = 128;
#[no_mangle]
unsafe extern "C" fn skb_checksum_setup_ipv4(skb: *mut sk_buff, recalculate: bool) -> c_int {
...
//
pub const MAX_IPV6_HDR_LEN: c_int = 256;

    (type *)(skb_network_header(skb) + (off))
#[no_mangle]
unsafe extern "C" fn skb_checksum_setup_ipv6(skb: *mut sk_buff, recalculate: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_checksum_setup(skb: *mut sk_buff, recalculate: bool) -> c_int {
...
//
    ...
    let mut len: c_uint = skb_transport_offset(skb) + transport_len;
    int ret;
    if (skb.len < len)
    return core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(len: skb->len ==) -> else {
    else if (skb.len == len)
    return skb;
...
#[no_mangle]
pub unsafe extern "C" fn __skb_warn_lro_forwarding(skb: *const sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn kfree_skb_partial(skb: *mut sk_buff, head_stolen: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_scrub_packet(skb: *mut sk_buff, xnet: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn skb_ensure_writable(skb: *mut sk_buff, write_len: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn skb_ensure_writable_head_tail(skb: *mut sk_buff, dev: *mut net_device) -> c_int {
    int skb_ensure_writable_head_tail(struct sk_buff *skb, struct net_device *dev)
    {
    let mut needed_headroom: c_int = dev.needed_headroom;
    let mut needed_tailroom: c_int = dev.needed_tailroom;
...
//
#[no_mangle]
pub unsafe extern "C" fn __skb_vlan_pop(skb: *mut sk_buff, vlan_tci: *mut u16) -> c_int {
    int __skb_vlan_pop(struct sk_buff *skb, u16 *vlan_tci)
    {
    let mut offset: c_int = skb.data - skb_mac_header(skb);
    int err;
    if (WARN_ONCE(offset,
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_vlan_pop(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_vlan_push(skb: *mut sk_buff, vlan_proto: __be16, vlan_tci: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_eth_pop(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_mpls_update_lse(skb: *mut sk_buff, mpls_lse: __be32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_mpls_dec_ttl(skb: *mut sk_buff) -> c_int {
...
// carve out the first off bytes from skb when off < headlen
    ...
    {
    int i;
    let mut size: c_uint = skb_end_offset(skb);
    let mut new_hlen: c_int = headlen - off;
    u8 *data;
    if (skb_pfmemalloc(skb))
    gfp_mask |= __GFP_MEMALLOC;
    data = kmalloc_reserve(&size, gfp_mask, NUMA_NO_NODE, core::ptr::null_mut());
...
//
    ...
    for (i = 0; i < nfrags; i++) {
    let mut fsize: c_int = skb_frag_size(&skb_shinfo(skb).frags[i]);
    if (pos + fsize > off) {
...
#[no_mangle]
unsafe extern "C" fn pskb_carve(skb: *mut sk_buff, len: u32, gfp: gfp_t) -> c_int {
    static int pskb_carve(struct sk_buff *skb, const u32 len, gfp_t gfp)
    {
    let mut headlen: c_int = skb_headlen(skb);
    if (len < headlen)
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_condense(skb: *mut sk_buff) {
...
//
    ...
    {
    struct skb_ext *new, *old = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn skb_ext_put_sp(sp: *mut sec_path) {
...
#[no_mangle]
unsafe extern "C" fn skb_ext_put_mctp(flow: *mut mctp_flow) {
...
#[no_mangle]
pub unsafe extern "C" fn __skb_ext_del(skb: *mut sk_buff, id: enum skb_ext_id) {
    void __skb_ext_del(struct sk_buff *skb, enum skb_ext_id id)
    {
    struct skb_ext *ext = skb.extensions;
    skb.active_extensions &= ~(1 << id);
    if (skb.active_extensions == 0) {
    skb.extensions = core::ptr::null_mut();
    __skb_ext_put(ext);
...
#[no_mangle]
pub unsafe extern "C" fn __skb_ext_put(ext: *mut skb_ext) {
...
#[no_mangle]
unsafe extern "C" fn kfree_skb_napi_cache(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn skb_attempt_defer_free(skb: *mut sk_buff) {
...
//
    ...
    ssize_t maxsize)
    {
    let mut frag_limit: usize = READ_ONCE(net_hotdata.sysctl_max_skb_frags);
    struct page *pages[8], **ppages = pages;
    let mut spliced: isize = 0, ret = 0;
    unsigned int i;
    while (iter.count > 0) {
...
// We might be able to coalesce without increasing nr_frags
    ...
    let mut part: usize = min_t(size_t, PAGE_SIZE - off, len);
    ret = -EIO;
    ...
    {
    __wsum *csum = priv2;
    let mut next: __wsum = csum_partial_copy_nocheck(iter_from, to + progress, len);
...
#[no_mangle]
pub unsafe extern "C" fn __get_netmem(netmem: netmem_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn __put_netmem(netmem: netmem_ref) {
    ...
    int mac_offset)
    {
    let mut vlan_depth: c_uint = skb.mac_len, parse_depth = VLAN_MAX_DEPTH;
