...
pub const REG_STATE_NEW: c_uint = 0x0;
pub const REG_STATE_REGISTERED: c_uint = 0x1;
pub const REG_STATE_UNREGISTERED: c_uint = 0x2;
pub const REG_STATE_UNUSED: c_uint = 0x3;
    static DEFINE_IDA(mem_id_pool);
    static DEFINE_MUTEX(mem_id_lock);
pub const MEM_ID_MAX: c_uint = 0xFFFE;
pub const MEM_ID_MIN: c_int = 1;
    let mut mem_id_next: static int = MEM_ID_MIN;
    static bool mem_id_init; /* false */
    static struct rhashtable *mem_id_ht;
#[no_mangle]
unsafe extern "C" fn xdp_mem_id_hashfn(data: *const c_void, len: u32, seed: u32) -> u32 {
...
// Use cyclic increasing ID as direct hash key
    ...
    let mut mem_id: u32 = *(u32 *)arg.key;
...
#[no_mangle]
unsafe extern "C" fn __xdp_mem_allocator_rcu_free(rcu: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn mem_xa_remove(xa: *mut xdp_mem_allocator) {
...
#[no_mangle]
unsafe extern "C" fn mem_allocator_disconnect(allocator: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn xdp_unreg_mem_model(mem: *mut xdp_mem_info) {
    void xdp_unreg_mem_model(struct xdp_mem_info *mem)
    {
    struct xdp_mem_allocator *xa;
    let mut type: c_int = mem.type;
    let mut id: c_int = mem.id;
...
#[no_mangle]
pub unsafe extern "C" fn xdp_rxq_info_unreg_mem_model(xdp_rxq: *mut xdp_rxq_info) {
...
// Simplify driver cleanup code paths, allow unreg "unused"
    ...
    xdp_rxq.dev = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(xdp_rxq_info_unreg);
#[no_mangle]
unsafe extern "C" fn xdp_rxq_info_init(xdp_rxq: *mut xdp_rxq_info) {
...
#[no_mangle]
pub unsafe extern "C" fn xdp_rxq_info_is_reg(xdp_rxq: *mut xdp_rxq_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __mem_id_init_hash_table() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __mem_id_cyclic_get(gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __is_supported_mem_type(type: enum xdp_mem_type) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn xdp_reg_page_pool(pool: *mut page_pool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xdp_unreg_page_pool(pool: *const page_pool) {
...
#[no_mangle]
pub unsafe extern "C" fn xdp_return_frame(xdpf: *mut xdp_frame) {
    ...
    out:
    __xdp_return(virt_to_netmem(xdpf.data), xdpf.mem_type, false, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(xdp_return_frame);
#[no_mangle]
pub unsafe extern "C" fn xdp_return_frame_rx_napi(xdpf: *mut xdp_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xdp_return_frag(netmem: netmem_ref, xdp: *const xdp_buff) {
    void xdp_return_frag(netmem_ref netmem, const struct xdp_buff *xdp)
    {
    __xdp_return(netmem, xdp.rxq.mem.type, true, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(xdp_return_frag);
#[no_mangle]
pub unsafe extern "C" fn xdp_return_buff(xdp: *mut xdp_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn xdp_warn(msg: *const c_char, func: *const c_char, line: c_int) {
...
//
    ...
    {
    const struct xdp_rxq_info *rxq = xdp.rxq;
    let mut len: u32 = xdp.data_end - xdp.data_meta;
    let mut truesize: u32 = xdp.frame_sz;
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_xdp_metadata_rx_timestamp(ctx: *const xdp_md, timestamp: *mut u64) -> __bpf_kfunc int {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_xdp_metadata_kfunc_id(id: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_dev_bound_kfunc_id(btf_id: u32) -> bool {
    bool bpf_dev_bound_kfunc_id(u32 btf_id)
    {
    return btf_id_set8_contains(&xdp_metadata_kfunc_ids, btf_id);
    }
#[no_mangle]
unsafe extern "C" fn xdp_metadata_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn xdp_set_features_flag_locked(dev: *mut net_device, val: xdp_features_t) {
...
#[no_mangle]
pub unsafe extern "C" fn xdp_set_features_flag(dev: *mut net_device, val: xdp_features_t) {
    ...
    bool support_sg)
    {
    let mut val: xdp_features_t = (dev.xdp_features | NETDEV_XDP_ACT_NDO_XMIT);
    if (support_sg)
...
#[no_mangle]
pub unsafe extern "C" fn xdp_features_set_redirect_target(dev: *mut net_device, support_sg: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn xdp_features_clear_redirect_target_locked(dev: *mut net_device) {
    void xdp_features_clear_redirect_target_locked(struct net_device *dev)
    {
    let mut val: xdp_features_t = dev.xdp_features;
    val &= ~(NETDEV_XDP_ACT_NDO_XMIT | NETDEV_XDP_ACT_NDO_XMIT_SG);
    xdp_set_features_flag_locked(dev, val);
    }
    EXPORT_SYMBOL_GPL(xdp_features_clear_redirect_target_locked);
#[no_mangle]
pub unsafe extern "C" fn xdp_features_clear_redirect_target(dev: *mut net_device) {
