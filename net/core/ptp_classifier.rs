...
//! Source: net/core/ptp_classifier.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ptp_classify_raw(skb: *const sk_buff) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_msg_is_sync(skb: *mut sk_buff, type: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_classifier_init() -> void __init {
