...
//! Source: net/core/drop_monitor.c
#![no_std]
...
// netlink alerts
//
    let mut trace_state: static int = TRACE_OFF;
...
pub const NET_DM_MAX_HW_TRAP_NAME_LEN: c_int = 40;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct net_dm_hw_entry {
    pub trap_name: [c_char; NET_DM_MAX_HW_TRAP_NAME_LEN],
    pub count: u32,
}
...
pub struct net_dm_hw_entries {
    pub num_entries: u32,
    pub entries: [net_dm_hw_entry; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct per_cpu_dm_data {
    pub and: *mut *mut raw_spinlock_t lock; / Protects 'skb', 'hw_entries',
// 'send_timer'
//
    union {
    pub skb: *mut sk_buff,
    pub hw_entries: *mut net_dm_hw_entries,
}
...
pub struct dm_hw_stat_delta {
    ...
    let mut dm_hit_limit: static int = 64;
    let mut dm_delay: static int = 1;
    let mut dm_hw_check_delta: static unsigned long = 2*HZ;
    let mut net_dm_alert_mode: static enum net_dm_alert_mode = NET_DM_ALERT_MODE_SUMMARY;
    static u32 net_dm_trunc_len;
    let mut net_dm_queue_len: static u32 = 1000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct net_dm_alert_ops {
    void (*kfree_skb_probe)(void *ignore, struct sk_buff *skb,
    void *location,
    enum skb_drop_reason reason,
    pub rx_sk): *const sock,
    void (*napi_poll_probe)(void *ignore, struct napi_struct *napi,
    pub budget): int work, int,
    pub work): *mut *mut void (work_item_func)(struct work_struct,
    pub work): *mut *mut void (hw_work_item_func)(struct work_struct,
    void (*hw_trap_probe)(void *ignore, const struct devlink *devlink,
    struct sk_buff *skb,
    pub metadata): *const devlink_trap_metadata,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct net_dm_skb_cb {
    union {
    pub hw_metadata: *mut devlink_trap_metadata,
    pub pc: *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn send_dm_alert(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn sched_send_work(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn trace_drop_common(skb: *mut sk_buff, location: *mut c_void) {
...
//
    ...
    trace_drop_common(core::ptr::null_mut(), core::ptr::null_mut());
...
//
    ...
    const struct net_dm_hw_entries *hw_entries)
    {
    let mut anc_hdr: net_dm_alert_msg = { 0 };
    void *hdr;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_summary_work(work: *mut work_struct) {
    ...
    const struct sock *rx_sk)
    {
    let mut tstamp: ktime_t = ktime_get_real();
    struct per_cpu_dm_data *data;
...
#[no_mangle]
unsafe extern "C" fn net_dm_in_port_size() -> usize {
...
pub const NET_DM_MAX_SYMBOL_LEN: c_int = 40;
pub const NET_DM_MAX_REASON_LEN: c_int = 50;
#[no_mangle]
unsafe extern "C" fn net_dm_packet_report_size(payload_len: usize) -> usize {
...
// NET_DM_ATTR_PAYLOAD
    ...
    const struct drop_reason_list *list = core::ptr::null_mut();
    ...
    goto nla_put_failure;
    rc = net_dm_packet_report_in_port_put(msg, skb.skb_iif, core::ptr::null_mut());
    if (rc)
    goto nla_put_failure;
...
#[no_mangle]
unsafe extern "C" fn net_dm_packet_report(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_packet_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_packet_report(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_packet_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_probe_register(ops: *const net_dm_alert_ops) -> c_int {
    static int net_dm_hw_probe_register(const struct net_dm_alert_ops *ops)
    {
    return register_trace_devlink_trap_report(ops.hw_trap_probe, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn net_dm_hw_probe_unregister(ops: *const net_dm_alert_ops) {
    static void net_dm_hw_probe_unregister(const struct net_dm_alert_ops *ops)
    {
    unregister_trace_devlink_trap_report(ops.hw_trap_probe, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_monitor_start(extack: *mut netlink_ext_ack) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_monitor_stop(extack: *mut netlink_ext_ack) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_trace_on_set(extack: *mut netlink_ext_ack) -> c_int {
...
//
    ...
    rc = register_trace_kfree_skb(ops.kfree_skb_probe, core::ptr::null_mut());
    if (rc) {
    NL_SET_ERR_MSG_MOD(extack, "Failed to connect probe to kfree_skb() tracepoint");
    goto err_module_put;
    }
    rc = register_trace_napi_poll(ops.napi_poll_probe, core::ptr::null_mut());
    if (rc) {
    ...
    unregister_trace_kfree_skb(ops.kfree_skb_probe, core::ptr::null_mut());
    err_module_put:
    for_each_possible_cpu(cpu) {
    struct per_cpu_dm_data *data = &per_cpu(dm_cpu_data, cpu);
    struct sk_buff *skb;
...
#[no_mangle]
unsafe extern "C" fn net_dm_trace_off_set() {
    static void net_dm_trace_off_set(void)
    {
    const struct net_dm_alert_ops *ops;
    int cpu;
    ops = net_dm_alert_ops_arr[net_dm_alert_mode];
    unregister_trace_napi_poll(ops.napi_poll_probe, core::ptr::null_mut());
    unregister_trace_kfree_skb(ops.kfree_skb_probe, core::ptr::null_mut());
    tracepoint_synchronize_unregister();
...
#[no_mangle]
unsafe extern "C" fn set_all_monitor_traces(state: c_int, extack: *mut netlink_ext_ack) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_is_monitoring() -> bool {
    static bool net_dm_is_monitoring(void)
    {
    let mut trace_state: return = = TRACE_ON || monitor_hw;
    }
...
#[no_mangle]
unsafe extern "C" fn net_dm_alert_mode_set(info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_trunc_len_set(info: *mut genl_info) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_queue_len_set(info: *mut genl_info) {
    ...
    struct genl_info *info)
    {
    let mut set_sw: bool = !!info.attrs[NET_DM_ATTR_SW_DROPS];
    let mut set_hw: bool = !!info.attrs[NET_DM_ATTR_HW_DROPS];
    struct netlink_ext_ack *extack = info.extack;
...
#[no_mangle]
unsafe extern "C" fn net_dm_config_fill(msg: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_cmd_config_get(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_stats_read(stats: *mut net_dm_stats) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_stats_put(msg: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_stats_read(stats: *mut net_dm_stats) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_stats_put(msg: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_stats_fill(msg: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_dm_cmd_stats_get(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    if (stat) {
    rcu_assign_pointer(dev.dm_private, core::ptr::null_mut());
    kfree_rcu(stat, rcu);
    }
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn __net_dm_cpu_data_init(data: *mut per_cpu_dm_data) {
...
#[no_mangle]
unsafe extern "C" fn __net_dm_cpu_data_fini(data: *mut per_cpu_dm_data) {
    static void __net_dm_cpu_data_fini(struct per_cpu_dm_data *data)
    {
    WARN_ON(!skb_queue_empty(&data.drop_queue));
    }
#[no_mangle]
unsafe extern "C" fn net_dm_cpu_data_init(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_cpu_data_fini(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_cpu_data_init(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn net_dm_hw_cpu_data_fini(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn init_net_drop_monitor() -> int __init {
