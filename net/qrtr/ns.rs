...
// increased.
//
pub const QRTR_NS_MAX_NODES: c_int = 512;
pub const QRTR_NS_MAX_SERVERS: c_int = 256;
pub const QRTR_NS_MAX_LOOKUPS: c_int = 128;
...
// If node didn't exist, allocate and insert it to the tree
    ...
    {
    let mut ifilter: c_uint = f.ifilter;
...
#[no_mangle]
unsafe extern "C" fn announce_servers(sq: *mut sockaddr_qrtr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn server_del(node: *mut qrtr_node, port: c_uint, bcast: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ctrl_cmd_hello(sq: *mut sockaddr_qrtr) -> c_int {
    static int ctrl_cmd_hello(struct sockaddr_qrtr *sq)
    {
    return announce_servers(sq);
    }
#[no_mangle]
unsafe extern "C" fn ctrl_cmd_bye(from: *mut sockaddr_qrtr) -> c_int {
...
// Empty notification, to indicate end of listing
    lookup_notify(from, core::ptr::null_mut(), true);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn qrtr_ns_worker(work: *mut work_struct) {
    static void qrtr_ns_worker(struct work_struct *work)
    {
    const struct qrtr_ctrl_pkt *pkt;
    let mut recv_buf_size: usize = 4096;
    struct sockaddr_qrtr sq;
    let mut msg: msghdr = { };
    unsigned int cmd;
    ssize_t msglen;
...
#[no_mangle]
unsafe extern "C" fn qrtr_ns_data_ready(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn qrtr_ns_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qrtr_ns_remove() {
