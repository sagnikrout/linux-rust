...
// Send data over MHI
#[no_mangle]
unsafe extern "C" fn qcom_mhi_qrtr_send(ep: *mut qrtr_endpoint, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_mhi_qrtr_queue_dl_buffers(mhi_dev: *mut mhi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_mhi_qrtr_pm_suspend_late(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qcom_mhi_qrtr_pm_resume_early(dev: *mut device) -> int __maybe_unused {
