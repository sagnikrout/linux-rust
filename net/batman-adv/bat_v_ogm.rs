...
//! Source: net/batman-adv/bat_v_ogm.h
#![no_std]
...
extern "C" {
    pub fn batadv_v_ogm_init(bat_priv: *mut batadv_priv) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn batadv_v_ogm_iface_enable(hard_iface: *mut batadv_hard_iface) -> c_int;
}
extern "C" {
