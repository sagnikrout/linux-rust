...
//! Source: net/l2tp/l2tp_netlink.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_noop(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_tunnel_create_get_addr(attrs: *mut nlattr, cfg: *mut l2tp_tunnel_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_tunnel_create(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_tunnel_delete(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_tunnel_modify(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn l2tp_nl_tunnel_send_addr(skb: *mut sk_buff, tunnel: *mut l2tp_tunnel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_tunnel_get(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct l2tp_nl_cb_data {
    pub tkey: c_ulong,
    pub skey: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_tunnel_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int l2tp_nl_cmd_tunnel_dump(struct sk_buff *skb, struct netlink_callback *cb)
    {
    struct l2tp_nl_cb_data *cbd = (void *)&cb.ctx[0];
    let mut key: c_ulong = cbd.tkey;
    struct l2tp_tunnel *tunnel;
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_session_create(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// L2TPv2 only accepts PPP pseudo-wires
    ...
    let mut len: u16 = nla_len(info.attrs[L2TP_ATTR_COOKIE]);
    if (len > 8) {
    ret = -EINVAL;
    goto out_tunnel;
    }
    ...
    let mut len: u16 = nla_len(info.attrs[L2TP_ATTR_PEER_COOKIE]);
    if (len > 8) {
    ret = -EINVAL;
    goto out_tunnel;
    }
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_session_delete(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_session_modify(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_session_get(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cmd_session_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int l2tp_nl_cmd_session_dump(struct sk_buff *skb, struct netlink_callback *cb)
    {
    struct l2tp_nl_cb_data *cbd = (void *)&cb.ctx[0];
    struct net *net = sock_net(skb.sk);
    struct l2tp_session *session;
    struct l2tp_tunnel *tunnel = core::ptr::null_mut();
    let mut tkey: c_ulong = cbd.tkey;
    let mut skey: c_ulong = cbd.skey;
    for (;;) {
    if (!tunnel) {
...
#[no_mangle]
pub unsafe extern "C" fn l2tp_nl_register_ops(pw_type: enum l2tp_pwtype, ops: *const l2tp_nl_cmd_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn l2tp_nl_unregister_ops(pw_type: enum l2tp_pwtype) {
    void l2tp_nl_unregister_ops(enum l2tp_pwtype pw_type)
    {
    if (pw_type < __L2TP_PWTYPE_MAX) {
    genl_lock();
    l2tp_nl_cmd_ops[pw_type] = core::ptr::null_mut();
    genl_unlock();
    }
    }
    EXPORT_SYMBOL_GPL(l2tp_nl_unregister_ops);
#[no_mangle]
unsafe extern "C" fn l2tp_nl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn l2tp_nl_cleanup() {
