...
pub const PPPOL2TP_HEADER_OVERHEAD: c_int = 40;
// Number of bytes to build transmit L2TP headers.
// Unfortunately the size is different depending on whether sequence numbers
// are enabled.
//
pub const PPPOL2TP_L2TP_HDR_SIZE_SEQ: c_int = 10;
pub const PPPOL2TP_L2TP_HDR_SIZE_NOSEQ: c_int = 6;
...
pub struct pppol2tp_session {
    pub /: *mut *mut int owner; / pid that opened the socket,
    pub /: *mut *mut mutex sk_lock; / Protects .sk,
    pub /: *mut *mut *mut sock __rcu sk; / Pointer to the session PPPoX socket,
    pub /: *mut *mut *mut sock __sk; / Copy of .sk, for cleanup,
}
...
//
    ...
    len = skb.len;
#[no_mangle]
pub unsafe extern "C" fn if(skb->len: len <) -> else {
    else if (len < skb.len)
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_recv(session: *mut l2tp_session, skb: *mut sk_buff, data_len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pppol2tp_xmit(chan: *mut ppp_channel, skb: *mut sk_buff) -> c_int {
    static int pppol2tp_xmit(struct ppp_channel *chan, struct sk_buff *skb)
    {
...
//
#[no_mangle]
unsafe extern "C" fn pppol2tp_session_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_session_close(session: *mut l2tp_session) {
    ...
    RCU_INIT_POINTER(ps.sk, core::ptr::null_mut());
    mutex_unlock(&ps.sk_lock);
    if (ps.__sk) {
// detach socket
    rcu_assign_sk_user_data(ps.__sk, core::ptr::null_mut());
    sock_put(ps.__sk);
...
//
#[no_mangle]
unsafe extern "C" fn pppol2tp_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_backlog_recv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pppol2tp_create(net: *mut net, sock: *mut socket, kern: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_show(m: *mut seq_file, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_session_init(session: *mut l2tp_session) {
...
//
#[no_mangle]
unsafe extern "C" fn pppol2tp_tunnel_mtu(tunnel: *const l2tp_tunnel) -> c_int {
...
//
    ...
    struct sock *sk = sock.sk;
    struct pppox_sock *po = pppox_sk(sk);
    struct l2tp_session *session = core::ptr::null_mut();
    struct l2tp_connect_info info;
    struct l2tp_tunnel *tunnel;
    struct pppol2tp_session *ps;
    let mut cfg: l2tp_session_cfg = { 0, };
    let mut drop_refcnt: bool = false;
    let mut new_session: bool = false;
    let mut new_tunnel: bool = false;
    int error;
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_next_tunnel(net: *mut net, pd: *mut pppol2tp_seq_data) {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_next_session(net: *mut net, pd: *mut pppol2tp_seq_data) {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_seq_stop(p: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_seq_tunnel_show(m: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_seq_session_show(m: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_seq_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_proc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_proc_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pppol2tp_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pppol2tp_exit() -> void __exit {
