...
//
#[no_mangle]
unsafe extern "C" fn l2tp_ip_recv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_hash(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_unhash(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_open(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_close(sk: *mut sock, timeout: c_long) {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_destroy_sock(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_disconnect(sk: *mut sock, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_backlog_recv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn l2tp_ip_sendmsg(sk: *mut sock, msg: *mut msghdr, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip_exit() -> void __exit {
