...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct l2tp_ip6_net {
    pub l2tp_ip6_lock: rwlock_t,
    pub l2tp_ip6_table: hlist_head,
    pub l2tp_ip6_bind_table: hlist_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct l2tp_ip6_sock {
...
//
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_recv(skb: *mut sk_buff) -> c_int {
...
// Ok, this is a data packet. Lookup the session.
    session = l2tp_v3_session_get(net, core::ptr::null_mut(), session_id);
    if (!session)
    goto discard;
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_hash(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_unhash(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_open(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_close(sk: *mut sock, timeout: c_long) {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_destroy_sock(sk: *mut sock) {
...
//
    ...
    rcu_read_unlock();
    write_lock_bh(&pn.l2tp_ip6_lock);
    if (__l2tp_ip6_bind_lookup(net, &addr.l2tp_addr, core::ptr::null_mut(), bound_dev_if,
    addr.l2tp_conn_id)) {
    write_unlock_bh(&pn.l2tp_ip6_lock);
    err = -EADDRINUSE;
    goto out_unlock;
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_disconnect(sk: *mut sock, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_backlog_recv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_push_pending_frames(sk: *mut sock) -> c_int {
    static int l2tp_ip6_push_pending_frames(struct sock *sk)
    {
    struct sk_buff *skb;
    __be32 *transhdr = core::ptr::null_mut();
    let mut err: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_sendmsg(sk: *mut sock, msg: *mut msghdr, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn l2tp_ip6_exit() -> void __exit {
