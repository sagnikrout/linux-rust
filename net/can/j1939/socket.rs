...
//
#[no_mangle]
pub unsafe extern "C" fn j1939_prio(sk_priority: u32) -> priority_t {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_to_sk_priority(prio: priority_t) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_pgn_is_valid(pgn: pgn_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_pgn_is_clean_pdu(pgn: pgn_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_sock_pending_add(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn j1939_sock_pending_get(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_jsk_add(priv: *mut j1939_priv, jsk: *mut j1939_sock) {
...
#[no_mangle]
unsafe extern "C" fn j1939_jsk_del(priv: *mut j1939_priv, jsk: *mut j1939_sock) {
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_queue_session(session: *mut j1939_session) -> bool {
    ...
    {
    struct j1939_session *session = core::ptr::null_mut();
    spin_lock_bh(&jsk.sk_session_queue_lock);
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_queue_activate_next_locked(session: *mut j1939_session) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_sk_queue_activate_next(session: *mut j1939_session) {
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_recv_one(jsk: *mut j1939_sock, oskb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_sk_recv_match(priv: *mut j1939_priv, skcb: *mut j1939_sk_buff_cb) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_sk_recv(priv: *mut j1939_priv, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_sock_destruct(sk: *mut sock) {
...
//
    ...
    jsk.priv = core::ptr::null_mut();
    }
// call generic CAN sock destruct
    can_sock_destruct(sk);
    }
#[no_mangle]
unsafe extern "C" fn j1939_sk_init(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_sanity_check(addr: *mut sockaddr_can, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_bind(sock: *mut socket, uaddr: *mut sockaddr_unsized, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_release(sock: *mut socket) -> c_int {
    ...
    struct j1939_filter *filters = core::ptr::null_mut(), *ofilters;
...
//
    ...
    ret = -EFAULT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: put_user(len, _arg: optlen)) -> else {
    else if (put_user(len, optlen))
    ret = -EFAULT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: copy_to_user(optval, _arg: val, _arg: len)) -> else {
    ...
    sizeof(((struct can_frame *)core::ptr::null_mut()).data),
...
#[no_mangle]
unsafe extern "C" fn j1939_sk_opt_stats_get_size(type: enum j1939_sk_errqueue_type) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_sk_send_loop_abort(sk: *mut sock, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_sk_netdev_event_netdown(priv: *mut j1939_priv) {
    void j1939_sk_netdev_event_netdown(struct j1939_priv *priv)
    {
    struct j1939_sock *jsk;
    let mut error_code: c_int = ENETDOWN;
    read_lock_bh(&priv.j1939_socks_lock);
    list_for_each_entry(jsk, &priv.j1939_socks, list) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_sk_netdev_event_unregister(priv: *mut j1939_priv) {
    void j1939_sk_netdev_event_unregister(struct j1939_priv *priv)
    {
    struct sock *sk;
    struct j1939_sock *jsk;
    let mut wait_rcu: bool = false;
