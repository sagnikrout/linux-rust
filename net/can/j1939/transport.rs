...
//! Source: net/can/j1939/transport.c
#![no_std]
...
pub const J1939_XTP_TX_RETRY_LIMIT: c_int = 100;
pub const J1939_ETP_PGN_CTL: c_uint = 0xc800;
pub const J1939_ETP_PGN_DAT: c_uint = 0xc700;
pub const J1939_TP_PGN_CTL: c_uint = 0xec00;
pub const J1939_TP_PGN_DAT: c_uint = 0xeb00;
pub const J1939_TP_CMD_RTS: c_uint = 0x10;
pub const J1939_TP_CMD_CTS: c_uint = 0x11;
pub const J1939_TP_CMD_EOMA: c_uint = 0x13;
pub const J1939_TP_CMD_BAM: c_uint = 0x20;
pub const J1939_TP_CMD_ABORT: c_uint = 0xff;
pub const J1939_ETP_CMD_RTS: c_uint = 0x14;
pub const J1939_ETP_CMD_CTS: c_uint = 0x15;
pub const J1939_ETP_CMD_DPO: c_uint = 0x16;
pub const J1939_ETP_CMD_EOMA: c_uint = 0x17;
pub const J1939_ETP_CMD_ABORT: c_uint = 0xff;
...
//
    ...
    let mut j1939_tp_block: static unsigned int = 255;
    static unsigned int j1939_tp_packet_delay;
    let mut j1939_tp_padding: static unsigned int = 1;
// helpers
...
#[no_mangle]
unsafe extern "C" fn __j1939_session_drop(session: *mut j1939_session) {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_destroy(session: *mut j1939_session) {
    ...
    while ((skb = skb_dequeue(&session.skb_queue)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn __j1939_session_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_session_put(session: *mut j1939_session) {
    void j1939_session_put(struct j1939_session *session)
    {
    kref_put(&session.kref, __j1939_session_release);
    }
#[no_mangle]
unsafe extern "C" fn j1939_session_txtimer_cancel(session: *mut j1939_session) {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_rxtimer_cancel(session: *mut j1939_session) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_session_timers_cancel(session: *mut j1939_session) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_cb_is_broadcast(skcb: *const j1939_sk_buff_cb) -> bool {
    static inline bool j1939_cb_is_broadcast(const struct j1939_sk_buff_cb *skcb)
    {
    return (!skcb.addr.dst_name && (skcb.addr.da == 0xff));
    }
#[no_mangle]
unsafe extern "C" fn j1939_session_skb_drop_old(session: *mut j1939_session) {
...
#[no_mangle]
unsafe extern "C" fn j1939_address_is_local(priv: *mut j1939_priv, addr: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn j1939_tp_im_receiver(skcb: *const j1939_sk_buff_cb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_tp_im_transmitter(skcb: *const j1939_sk_buff_cb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_tp_im_involved(skcb: *const j1939_sk_buff_cb, swap: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_tp_im_involved_anydir(skcb: *mut j1939_sk_buff_cb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_xtp_ctl_to_pgn(dat: *const u8) -> pgn_t {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_tp_ctl_to_size(dat: *const u8) -> c_uint {
    static inline unsigned int j1939_tp_ctl_to_size(const u8 *dat)
    {
    return (dat[2] << 8) + (dat[1] << 0);
    }
#[no_mangle]
pub unsafe extern "C" fn j1939_etp_ctl_to_packet(dat: *const u8) -> c_uint {
    static inline unsigned int j1939_etp_ctl_to_packet(const u8 *dat)
    {
    return (dat[4] << 16) | (dat[3] << 8) | (dat[2] << 0);
    }
#[no_mangle]
pub unsafe extern "C" fn j1939_etp_ctl_to_size(dat: *const u8) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn j1939_skbcb_swap(skcb: *mut j1939_sk_buff_cb) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_tp_schedule_txtimer(session: *mut j1939_session, msec: c_int) {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_tx_rts(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_tx_dpo(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_tx_dat(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_xtp_txnext_transmiter(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_tx_cts(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_tx_eoma(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_xtp_txnext_receiver(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_simple_txnext(session: *mut j1939_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_deactivate_locked(session: *mut j1939_session) -> bool {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_deactivate(session: *mut j1939_session) -> bool {
...
#[no_mangle]
unsafe extern "C" fn j1939_tp_txtimer(hrtimer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn j1939_session_completed(session: *mut j1939_session) {
...
#[no_mangle]
unsafe extern "C" fn j1939_tp_rxtimer(hrtimer: *mut hrtimer) -> enum hrtimer_restart {
...
//
    ...
    let mut pgn: pgn_t = j1939_xtp_ctl_to_pgn(skb.data);
    struct j1939_priv *priv = session.priv;
    let mut abort: enum j1939_xtp_abort = J1939_XTP_NO_ABORT;
    let mut cmd: u8 = skb.data[0];
...
// transmitted without problems
    ...
    {
    let mut err: enum j1939_xtp_abort = J1939_XTP_ABORT_FAULT;
    unsigned int pkt;
    const u8 *dat;
    dat = skb.data;
    if (j1939_xtp_rx_cmd_bad_pgn(session, skb))
    ...
    goto out_session_cancel;
#[no_mangle]
pub unsafe extern "C" fn if(/: *mut *mut dat[1] > session->pkt.block / 0xff for etp) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_session_activate(session: *mut j1939_session) -> c_int {
    int j1939_session_activate(struct j1939_session *session)
    {
    struct j1939_priv *priv = session.priv;
    struct j1939_session *active = core::ptr::null_mut();
    let mut ret: c_int = 0;
    j1939_session_list_lock(priv);
    if (session.skcb.addr.type != J1939_SIMPLE)
    ...
    {
    let mut abort: enum j1939_xtp_abort = J1939_XTP_NO_ABORT;
    let mut skcb: j1939_sk_buff_cb = *j1939_skb_to_cb(skb);
    struct j1939_session *session;
    const u8 *dat;
    int len, ret;
    pgn_t pgn;
...
#[no_mangle]
pub unsafe extern "C" fn if(priv->tp_max_packet_size: len >) -> else {
    else if (len > priv.tp_max_packet_size)
    abort = J1939_XTP_ABORT_RESOURCE;
#[no_mangle]
pub unsafe extern "C" fn if(J1939_MAX_TP_PACKET_SIZE: len <=) -> else {
...
pub unsafe extern "C" fn if(priv->tp_max_packet_size: len >) -> else {
    ...
    abort = J1939_XTP_ABORT_RESOURCE;
#[no_mangle]
pub unsafe extern "C" fn if(J1939_MIN_TP_PACKET_SIZE: len <) -> else {
...
// transmitted without problems
    ...
    struct sk_buff *skb)
    {
    let mut abort: enum j1939_xtp_abort = J1939_XTP_ABORT_FAULT;
    struct j1939_priv *priv = session.priv;
    struct j1939_sk_buff_cb *skcb, *se_skcb;
    struct sk_buff *se_skb = core::ptr::null_mut();
    const u8 *dat;
    u8 *tpdat;
    int offset;
    int nbytes;
    let mut final: bool = false;
    let mut remain: bool = false;
    let mut do_cts_eoma: bool = false;
    int packet;
    skcb = j1939_skb_to_cb(skb);
    dat = skb.data;
    if (skb.len != 8) {
...
#[no_mangle]
unsafe extern "C" fn j1939_xtp_rx_dat(priv: *mut j1939_priv, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn if(J1939_MAX_TP_PACKET_SIZE: size >) -> else {
...
#[no_mangle]
unsafe extern "C" fn j1939_tp_cmd_recv(priv: *mut j1939_priv, skb: *mut sk_buff) {
    static void j1939_tp_cmd_recv(struct j1939_priv *priv, struct sk_buff *skb)
    {
    struct j1939_sk_buff_cb *skcb = j1939_skb_to_cb(skb);
    let mut extd: c_int = J1939_TP;
    let mut cmd: u8 = skb.data[0];
    switch (cmd) {
    case J1939_ETP_CMD_RTS:
    extd = J1939_ETP;
...
#[no_mangle]
pub unsafe extern "C" fn j1939_tp_recv(priv: *mut j1939_priv, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_simple_recv(priv: *mut j1939_priv, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_cancel_active_session(priv: *mut j1939_priv, sk: *mut sock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_tp_init(priv: *mut j1939_priv) {
