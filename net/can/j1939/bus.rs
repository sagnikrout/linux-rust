...
#[no_mangle]
unsafe extern "C" fn __j1939_ecu_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ecu_put(ecu: *mut j1939_ecu) {
    void j1939_ecu_put(struct j1939_ecu *ecu)
    {
    kref_put(&ecu.kref, __j1939_ecu_release);
    }
#[no_mangle]
unsafe extern "C" fn j1939_ecu_get(ecu: *mut j1939_ecu) {
    static void j1939_ecu_get(struct j1939_ecu *ecu)
    {
    kref_get(&ecu.kref);
    }
#[no_mangle]
unsafe extern "C" fn j1939_ecu_is_mapped_locked(ecu: *mut j1939_ecu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn j1939_ecu_map_locked(ecu: *mut j1939_ecu) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ecu_unmap_locked(ecu: *mut j1939_ecu) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ecu_unmap(ecu: *mut j1939_ecu) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ecu_unmap_all(priv: *mut j1939_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ecu_timer_start(ecu: *mut j1939_ecu) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ecu_timer_cancel(ecu: *mut j1939_ecu) {
...
#[no_mangle]
unsafe extern "C" fn j1939_ecu_timer_handler(hrtimer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_name_to_addr(priv: *mut j1939_priv, name: name_t) -> u8 {
    u8 j1939_name_to_addr(struct j1939_priv *priv, name_t name)
    {
    struct j1939_ecu *ecu;
    let mut addr: c_int = J1939_IDLE_ADDR;
    if (!name)
...
//
#[no_mangle]
pub unsafe extern "C" fn j1939_local_ecu_get(priv: *mut j1939_priv, name: name_t, sa: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_local_ecu_put(priv: *mut j1939_priv, name: name_t, sa: u8) {
