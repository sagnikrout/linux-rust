...
//! Source: net/can/j1939/address-claim.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn j1939_skb_to_name(skb: *const sk_buff) -> name_t {
    static inline name_t j1939_skb_to_name(const struct sk_buff *skb)
    {
    return le64_to_cpup((__le64 *)skb.data);
    }
#[no_mangle]
pub unsafe extern "C" fn j1939_ac_msg_is_request(skb: *mut sk_buff) -> bool {
    ...
    let mut req_pgn: return = = J1939_PGN_ADDRESS_CLAIMED;
    }
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ac_fixup(priv: *mut j1939_priv, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j1939_ac_process(priv: *mut j1939_priv, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_ac_recv(priv: *mut j1939_priv, skb: *mut sk_buff) {
