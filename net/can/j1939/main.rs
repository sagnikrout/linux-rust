...
// lowest layer
#[no_mangle]
unsafe extern "C" fn j1939_can_recv(iskb: *mut sk_buff, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_priv_put(priv: *mut j1939_priv) {
    void j1939_priv_put(struct j1939_priv *priv)
    {
    kref_put(&priv.kref, __j1939_priv_release);
    }
#[no_mangle]
pub unsafe extern "C" fn j1939_priv_get(priv: *mut j1939_priv) {
    void j1939_priv_get(struct j1939_priv *priv)
    {
    kref_get(&priv.kref);
    }
#[no_mangle]
unsafe extern "C" fn j1939_can_rx_register(priv: *mut j1939_priv) -> c_int {
    ...
    j1939_can_recv, priv, "j1939", core::ptr::null_mut());
    if (ret < 0) {
    j1939_priv_put(priv);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn j1939_can_rx_unregister(priv: *mut j1939_priv) {
...
unsafe extern "C" fn __j1939_rx_release(kref: *mut kref) {
    ...
    j1939_priv_set(priv.ndev, core::ptr::null_mut());
...
//
    ...
    return priv;
    out_priv_put:
    j1939_priv_set(ndev, core::ptr::null_mut());
    mutex_unlock(&j1939_netdev_lock);
    netdev_put(ndev, &priv.dev_tracker);
    kfree(priv);
    return ERR_PTR(ret);
...
#[no_mangle]
pub unsafe extern "C" fn j1939_netdev_stop(priv: *mut j1939_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn j1939_send_one(priv: *mut j1939_priv, skb: *mut sk_buff) -> c_int {
...
// make it a full can frame again
    ...
    switch (msg) {
    case NETDEV_DOWN:
    j1939_cancel_active_session(priv, core::ptr::null_mut());
...
// MODULE interface
#[no_mangle]
unsafe extern "C" fn j1939_module_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn j1939_module_exit() -> __exit void {
