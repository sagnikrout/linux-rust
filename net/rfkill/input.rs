...
pub const RFKILL_OPS_DELAY: c_int = 200;
...
#[no_mangle]
unsafe extern "C" fn __rfkill_handle_global_op(op: enum rfkill_sched_op) {
...
#[no_mangle]
unsafe extern "C" fn rfkill_op_handler(work: *mut work_struct) {
    ...
    let mut op: enum rfkill_sched_op = rfkill_op;
...
#[no_mangle]
unsafe extern "C" fn rfkill_ratelimit(last: c_ulong) -> c_ulong {
    static unsigned long rfkill_ratelimit(const unsigned long last)
    {
    let mut delay: c_ulong = msecs_to_jiffies(RFKILL_OPS_DELAY);
    return time_after(jiffies, last + delay) ? 0 : delay;
    }
#[no_mangle]
unsafe extern "C" fn rfkill_schedule_ratelimited() {
...
#[no_mangle]
unsafe extern "C" fn rfkill_schedule_global_op(op: enum rfkill_sched_op) {
...
#[no_mangle]
unsafe extern "C" fn rfkill_schedule_toggle(type: enum rfkill_type) {
...
#[no_mangle]
unsafe extern "C" fn rfkill_schedule_evsw_rfkillall(state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rfkill_start(handle: *mut input_handle) {
...
#[no_mangle]
unsafe extern "C" fn rfkill_disconnect(handle: *mut input_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn rfkill_handler_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn rfkill_handler_exit() -> void __exit {
