...
//
    ...
    let mut padding_bytes: static int = 26;
#[no_mangle]
pub unsafe extern "C" fn ncsi_calculate_checksum(data: *mut c_uchar, len: c_int) -> u32 {
...
// skb allocated with enough to load the payload */);
    ...
    { NCSI_PKT_CMD_PLDM,   0, core::ptr::null_mut()                     },
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_xmit_cmd(nca: *mut ncsi_cmd_arg) -> c_int {
    int ncsi_xmit_cmd(struct ncsi_cmd_arg *nca)
    {
    struct ncsi_cmd_handler *nch = core::ptr::null_mut();
    struct ncsi_request *nr;
    unsigned char type;
    struct ethhdr *eh;
    int i, ret;
