...
#[no_mangle]
pub unsafe extern "C" fn ncsi_channel_has_link(channel: *mut ncsi_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ncsi_report_link(ndp: *mut ncsi_dev_priv, force_down: bool) {
...
#[no_mangle]
unsafe extern "C" fn ncsi_channel_monitor(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_start_channel_monitor(nc: *mut ncsi_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_stop_channel_monitor(nc: *mut ncsi_channel) {
...
#[no_mangle]
unsafe extern "C" fn ncsi_remove_channel(nc: *mut ncsi_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_remove_package(np: *mut ncsi_package) {
...
// Remove and free package
    ...
    c = p ? ncsi_find_channel(p, NCSI_CHANNEL_INDEX(id)) : core::ptr::null_mut();
    if (np)
// np = p;
    if (nc)
// nc = c;
...
//
    ...
    {
    struct ncsi_request *nr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_free_request(nr: *mut ncsi_request) {
    ...
    cmd = nr.cmd;
    rsp = nr.rsp;
    nr.cmd = core::ptr::null_mut();
    nr.rsp = core::ptr::null_mut();
    nr.used = false;
...
#[no_mangle]
unsafe extern "C" fn ncsi_request_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn ncsi_suspend_channel(ndp: *mut ncsi_dev_priv) {
...
//
    ...
    {
    struct ncsi_channel_vlan_filter *ncf;
    struct vlan_vid *vlan = core::ptr::null_mut();
    unsigned long flags;
    int i, index;
    void *bitmap;
    u16 vid;
...
#[no_mangle]
unsafe extern "C" fn ncsi_oem_keep_phy_intel(nca: *mut ncsi_cmd_arg) -> c_int {
...
// (unsigned int *)data = ntohl(( __be32)NCSI_OEM_MFR_INTEL_ID);
...
#[no_mangle]
unsafe extern "C" fn ncsi_oem_gma_handler_bcm(nca: *mut ncsi_cmd_arg) -> c_int {
...
// (unsigned int *)data = ntohl(( __be32)NCSI_OEM_MFR_BCM_ID);
...
#[no_mangle]
unsafe extern "C" fn ncsi_oem_gma_handler_mlx(nca: *mut ncsi_cmd_arg) -> c_int {
    ...
    memset(&u, 0, sizeof(u));
    u.data_u32[0] = ntohl(( __be32)NCSI_OEM_MFR_MLX_ID);
...
#[no_mangle]
unsafe extern "C" fn ncsi_oem_smaf_mlx(nca: *mut ncsi_cmd_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_oem_gma_handler_intel(nca: *mut ncsi_cmd_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_gma_handler(nca: *mut ncsi_cmd_arg, mf_id: c_uint) -> c_int {
    static int ncsi_gma_handler(struct ncsi_cmd_arg *nca, unsigned int mf_id)
    {
    struct ncsi_oem_gma_handler *nch = core::ptr::null_mut();
    int i;
...
#[no_mangle]
unsafe extern "C" fn ncsi_configure_channel(ndp: *mut ncsi_dev_priv) {
    static void ncsi_configure_channel(struct ncsi_dev_priv *ndp)
    {
    struct ncsi_package *np = ndp.active_package;
    struct ncsi_channel *nc = ndp.active_channel;
    struct ncsi_channel *hot_nc = core::ptr::null_mut();
    struct ncsi_dev *nd = &ndp.ndev;
...
// Clear initial state
    ...
    rtnl_lock();
    ret = dev_set_mac_address(dev, &ndp.pending_mac, core::ptr::null_mut());
    rtnl_unlock();
    if (ret < 0)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ncsi_channel_is_tx(ndp, _arg: nc)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ncsi_choose_active_channel(ndp: *mut ncsi_dev_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_check_hwa(ndp: *mut ncsi_dev_priv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ncsi_probe_channel(ndp: *mut ncsi_dev_priv) {
...
// Clear initial state Retrieve version, capability or link status
    ...
    nca.type = NCSI_PKT_CMD_CIS;
#[no_mangle]
pub unsafe extern "C" fn if(ncsi_dev_state_probe_gvi: nd->state ==) -> else {
    else if (nd.state == ncsi_dev_state_probe_gvi)
    nca.type = NCSI_PKT_CMD_GVI;
#[no_mangle]
pub unsafe extern "C" fn if(ncsi_dev_state_probe_gc: nd->state ==) -> else {
...
// Probe next package after receiving response
    ndp.package_probe_id++;
    nd.state = ncsi_dev_state_probe_package;
    ndp.active_package = core::ptr::null_mut();
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn ncsi_dev_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_process_next_channel(ndp: *mut ncsi_dev_priv) -> c_int {
    ...
    return 0;
    out:
    ndp.active_channel = core::ptr::null_mut();
    ndp.active_package = core::ptr::null_mut();
    if (ndp.flags & NCSI_DEV_RESHUFFLE) {
    ndp.flags &= ~NCSI_DEV_RESHUFFLE;
...
#[no_mangle]
unsafe extern "C" fn ncsi_kick_channels(ndp: *mut ncsi_dev_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_vlan_rx_add_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
    int ncsi_vlan_rx_add_vid(struct net_device *dev, __be16 proto, u16 vid)
    {
    struct ncsi_dev_priv *ndp;
    let mut n_vids: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_vlan_rx_kill_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_start_dev(nd: *mut ncsi_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_stop_dev(nd: *mut ncsi_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_reset_dev(nd: *mut ncsi_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ncsi_unregister_dev(nd: *mut ncsi_dev) {
