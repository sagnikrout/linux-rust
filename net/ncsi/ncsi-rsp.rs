...
//
#[no_mangle]
unsafe extern "C" fn decode_bcd_u8(x: u8) -> u8 {
    static u8 decode_bcd_u8(u8 x)
    {
    let mut lo: c_int = x & 0xF;
    let mut hi: c_int = x >> 4;
    lo = lo < 0xA ? lo : 0;
    hi = hi < 0xA ? hi : 0;
    return lo + hi * 10;
    }
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_cis(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_sp(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_dp(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_ec(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_dc(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_rc(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_ecnt(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_dcnt(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_ae(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_sl(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gls(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_svf(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_ev(nr: *mut ncsi_request) -> c_int {
...
// Update to VLAN mode
    ...
    ncm.enable = 1;
    ncm.data[0] = ntohl(( __be32)cmd.mode);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_dv(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_sma(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_ebf(nr: *mut ncsi_request) -> c_int {
...
// Find the package and channel
    rsp = (struct ncsi_rsp_pkt *)skb_network_header(nr.rsp);
    ncsi_find_package_and_channel(ndp, rsp.rsp.common.channel, core::ptr::null_mut(), &nc);
    if (!nc)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_dbf(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_egmf(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_dgmf(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_snfc(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_oem_gma(nr: *mut ncsi_request, mfr_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(NCSI_OEM_MFR_MLX_ID: mfr_id ==) -> else {
    else if (mfr_id == NCSI_OEM_MFR_MLX_ID)
    mac_addr_off = MLX_MAC_ADDR_OFFSET;
#[no_mangle]
pub unsafe extern "C" fn if(NCSI_OEM_MFR_INTEL_ID: mfr_id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_oem_mlx(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_oem_bcm(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_oem_intel(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_oem(nr: *mut ncsi_request) -> c_int {
    static int ncsi_rsp_handler_oem(struct ncsi_request *nr)
    {
    struct ncsi_rsp_oem_handler *nrh = core::ptr::null_mut();
    struct ncsi_rsp_oem_pkt *rsp;
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gvi(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gc(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gp(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gcps(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gns(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gnpts(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gps(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gpuuid(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_pldm(nr: *mut ncsi_request) -> c_int {
    static int ncsi_rsp_handler_pldm(struct ncsi_request *nr)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_netlink(nr: *mut ncsi_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncsi_rsp_handler_gmcma(nr: *mut ncsi_request) -> c_int {
    ...
    {
    struct ncsi_rsp_handler *nrh = core::ptr::null_mut();
    struct ncsi_dev *nd;
...
// Find the NCSI device
    ...
    ndp = nd ? TO_NCSI_DEV_PRIV(nd) : core::ptr::null_mut();
    if (!ndp) {
    ret = -ENODEV;
    goto err_free_skb;
    }
