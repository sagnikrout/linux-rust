...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_ntop(sap: *const sockaddr, buf: *mut c_char, buflen: usize) -> usize {
    ...
    if (in4_pton(buf, buflen, addr, '\0', core::ptr::null_mut()) == 0)
    return 0;
...
//
    ...
    buf[uaddr_len] = '\0';
    c = strrchr(buf, '.');
    if (unlikely(c == core::ptr::null_mut()))
    return 0;
