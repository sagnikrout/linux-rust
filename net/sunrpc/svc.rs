...
pub struct svc_pool_map {
    pub /: *mut *mut int count; / How many svc_servs use us,
    pub npools: c_uint,
    pub /: *mut *mut *mut unsigned int pool_to; / maps pool id to node,
    pub /: *mut *mut *mut unsigned int to_pool; / maps node to pool id,
}
...
pub unsafe extern "C" fn sunrpc_set_pool_mode(val: *const c_char) -> c_int {
    ...
    {
    let mut idx: c_int = sysfs_match_string(pool_mode_names, val);
    return idx < 0 ? idx : 0;
    }
...
//
    ...
    {
    let mut maxpools: c_uint = nr_node_ids;
    let mut pidx: c_uint = 0;
    unsigned int node;
    int err;
...
//
    ...
    m.to_pool = core::ptr::null_mut();
    kfree(m.pool_to);
    m.pool_to = core::ptr::null_mut();
    m.npools = 0;
    }
    mutex_unlock(&svc_pool_map_mutex);
    }
#[no_mangle]
unsafe extern "C" fn svc_pool_map_get_node(pidx: c_uint) -> c_int {
...
//
    ...
    {
    struct svc_pool_map *m = &svc_pool_map;
    let mut node: c_uint = m.pool_to[pidx];
//
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_serv_nrpools(serv: *const svc_serv) -> c_uint {
...
//
    ...
    {
    let mut nrpools: c_uint = svc_serv_nrpools(serv);
    struct svc_pool_map *m = &svc_pool_map;
    unsigned int pidx, i;
    if (nrpools <= 1)
...
#[no_mangle]
unsafe extern "C" fn svc_rpcb_setup(serv: *mut svc_serv, net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svc_rpcb_cleanup(serv: *mut svc_serv, net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn svc_uses_rpcbind(serv: *mut svc_serv) -> c_int {
    ...
    if (progp.pg_vers[i] == core::ptr::null_mut())
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn svc_bind(serv: *mut svc_serv, net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_pool_init_counters(pool: *mut svc_pool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_pool_destroy_counters(pool: *mut svc_pool) {
...
//
    ...
    timer_setup(&serv.sv_temptimer, core::ptr::null_mut(), 0);
...
//
    ...
    {
    return __svc_create(prog, 1, core::ptr::null_mut(), bufsize, 1, threadfn);
    }
...
//
    ...
    {
    struct svc_serv *serv;
    let mut npools: c_uint = svc_pool_map_get();
    if (!npools)
    return core::ptr::null_mut();
...
// +1 for a NULL sentinel at rq_page_end (see svc_rqst_replace_page)
    ...
    rqstp.rq_pages = core::ptr::null_mut();
    return false;
    }
...
#[no_mangle]
unsafe extern "C" fn svc_rqst_free_rcu(head: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_pool_wake_idle_thread(pool: *mut svc_pool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_new_thread(serv: *mut svc_serv, pool: *mut svc_pool) -> c_int {
...
//
    ...
    delta = max_threads;
#[no_mangle]
pub unsafe extern "C" fn if(min_threads: pool->sp_nrthreads <) -> else {
...
//
    ...
    {
    let mut nrpools: c_uint = svc_serv_nrpools(serv);
    let mut base: c_uint = nrservs / nrpools;
    let mut remain: c_uint = nrservs % nrpools;
    int i, err = 0;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_serv_maxthreads(serv: *const svc_serv) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_rqst_replace_page(rqstp: *mut svc_rqst, page: *mut page) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_rqst_release_pages(rqstp: *mut svc_rqst) {
...
//
    ...
    const unsigned short port)
    {
    let mut error: c_int = -EAFNOSUPPORT;
    switch (family) {
    case PF_INET:
...
//
    ...
    {
    int error;
    error = rpcb_v4_register(net, program, version, core::ptr::null_mut(), "");
//
// User space didn't support rpcbind v4, so retry this
...
//
#[no_mangle]
unsafe extern "C" fn svc_unregister(serv: *const svc_serv, net: *mut net) {
    static void svc_unregister(const struct svc_serv *serv, struct net *net)
    {
...
pub unsafe extern "C" fn __printf(_arg: 2, _arg: 3) -> static {
    static __printf(2, 3)
#[no_mangle]
pub unsafe extern "C" fn svc_printk(rqstp: *mut svc_rqst, fmt: *const c_char, ...) {
    ...
    {
    const struct svc_version *versp = core::ptr::null_mut();	/* compiler food */
    const struct svc_procedure *procp = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_stat_alloc_counts(statp: *mut svc_stat) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_stat_free_counts(statp: *mut svc_stat) {
    ...
    statp.vs_count = core::ptr::null_mut();
    }
...
//
    ...
    struct svc_program	*progp = core::ptr::null_mut();
    const struct svc_procedure *procp = core::ptr::null_mut();
    struct svc_serv		*serv = rqstp.rq_server;
...
// Reset the accept_stat for the RPC
    rqstp.rq_accept_statp = core::ptr::null_mut();
...
// Call the function that processes the request.
    ...
    if (procp.pc_encode == core::ptr::null_mut())
    goto dropit;
    sendit:
...
//
#[no_mangle]
unsafe extern "C" fn svc_drop(rqstp: *mut svc_rqst) {
    static void svc_drop(struct svc_rqst *rqstp)
    {
    trace_svc_drop(rqstp);
    }
#[no_mangle]
unsafe extern "C" fn svc_release_rqst(rqstp: *mut svc_rqst) {
...
//
    rqstp.rq_procinfo = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_process(rqstp: *mut svc_rqst) {
...
//
    ...
    rqstp.rq_res.tail[0].iov_base = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_process_bc(req: *mut rpc_rqst, rqstp: *mut svc_rqst) {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_max_payload(rqstp: *const svc_rqst) -> u32 {
    u32 svc_max_payload(const struct svc_rqst *rqstp)
    {
    let mut max: u32 = rqstp.rq_xprt.xpt_class.xcl_max_payload;
