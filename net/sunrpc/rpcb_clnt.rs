...
pub struct rpcbind_args {
    pub r_xprt: *mut *mut rpc_xprt,
    pub r_prog: u32,
    pub r_vers: u32,
    pub r_prot: u32,
    pub r_port: c_ushort,
    pub r_netid: *const *const c_char,
    pub r_addr: *const *const c_char,
    pub r_owner: *const *const c_char,
    pub r_status: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn rpcb_wake_rpcbind_waiters(xprt: *mut rpc_xprt, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rpcb_get_local(net: *mut net) -> c_int {
...
pub unsafe extern "C" fn rpcb_put_local(net: *mut net) {
    ...
    if (sn.rpcb_users) {
    if (--sn.rpcb_users == 0) {
    sn.rpcb_local_clnt = core::ptr::null_mut();
    sn.rpcb_local_clnt4 = core::ptr::null_mut();
    }
...
//
    ...
    if (IS_ERR(clnt4))
    clnt4 = core::ptr::null_mut();
    rpcb_set_local(net, clnt, clnt4, true);
    out:
    return result;
    }
#[no_mangle]
unsafe extern "C" fn rpcb_create_local_abstract(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpcb_create_local_unix(net: *mut net) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rpcb_create_local_net(net: *mut net) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpcb_create_local(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpcb_register_call(sn: *mut sunrpc_net, clnt: *mut rpc_clnt, msg: *mut rpc_message, is_set: bool) -> c_int {
    static int rpcb_register_call(struct sunrpc_net *sn, struct rpc_clnt *clnt, struct rpc_message *msg, bool is_set)
    {
    let mut flags: c_int = RPC_TASK_NOCONNECT;
    int error, result = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn rpcb_register(net: *mut net, prog: u32, vers: u32, prot: c_int, port: c_ushort) -> c_int {
...
//
    ...
    let mut port: c_ushort = ntohs(sin.sin_port);
    let mut is_set: bool = false;
    int result;
...
//
    ...
    struct rpcbind_args *map = msg.rpc_argp;
    let mut port: c_ushort = ntohs(sin6.sin6_port);
    let mut is_set: bool = false;
    int result;
    map.r_addr = rpc_sockaddr2uaddr(sap, GFP_KERNEL);
    if (!map.r_addr)
...
//
    ...
    struct sunrpc_net *sn = net_generic(net, sunrpc_net_id);
    if (sn.rpcb_local_clnt4 == core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn rpcb_getport_async(task: *mut rpc_task) {
...
// some other task is already attempting to bind the port
    ...
    core::ptr::null_mut(), jiffies + xprt.bind_timeout);
...
//
#[no_mangle]
unsafe extern "C" fn rpcb_getport_done(child: *mut rpc_task, data: *mut c_void) {
