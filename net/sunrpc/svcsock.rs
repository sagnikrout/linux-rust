...
#[no_mangle]
unsafe extern "C" fn svc_reclassify_socket(sock: *mut socket) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_tcp_release_ctxt(xprt: *mut svc_xprt, ctxt: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_udp_release_ctxt(xprt: *mut svc_xprt, ctxt: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn svc_set_cmsg_data(rqstp: *mut svc_rqst, cmh: *mut cmsghdr) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_one_sock_name(svsk: *mut svc_sock, buf: *mut c_char, remaining: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_flush_bvec(bvec: *const bio_vec, size: usize, seek: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_sock_setbufsize(svsk: *mut svc_sock, nreqs: c_uint) {
    static void svc_sock_setbufsize(struct svc_sock *svsk, unsigned int nreqs)
    {
    let mut max_mesg: c_uint = svsk.sk_xprt.xpt_server.sv_max_mesg;
    struct socket *sock = svsk.sk_sock;
...
#[no_mangle]
unsafe extern "C" fn svc_sock_secure_port(rqstp: *mut svc_rqst) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_data_ready(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_write_space(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn svc_tcp_has_wspace(xprt: *mut svc_xprt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_tcp_kill_temp_xprt(xprt: *mut svc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_tcp_handshake_done(data: *mut c_void, status: c_int, peerid: key_serial_t) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_tcp_handshake(xprt: *mut svc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_udp_recvfrom(rqstp: *mut svc_rqst) -> c_int {
...
//
    ...
    clear_bit(XPT_DATA, &svsk.sk_xprt.xpt_flags);
    err = kernel_recvmsg(svsk.sk_sock, &msg, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn svc_udp_sendto(rqstp: *mut svc_rqst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_udp_has_wspace(xprt: *mut svc_xprt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_udp_kill_temp_xprt(xprt: *mut svc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn svc_udp_init(svsk: *mut svc_sock, serv: *mut svc_serv) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_tcp_listen_data_ready(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_tcp_state_change(sk: *mut sock) {
...
//
    ...
    if (IS_ERR(sock_alloc_file(newsock, O_NONBLOCK, core::ptr::null_mut())))
    return core::ptr::null_mut();
    set_bit(XPT_CONN, &svsk.sk_xprt.xpt_flags);
...
//
    ...
    {
    let mut len: usize = svsk.sk_datalen;
    unsigned int i, npages;
    if (!len)
    return 0;
    npages = (len + PAGE_SIZE - 1) >> PAGE_SHIFT;
    for (i = 0; i < npages; i++) {
    if (rqstp.rq_pages[i] != core::ptr::null_mut())
    svc_rqst_page_release(rqstp, rqstp.rq_pages[i]);
    BUG_ON(svsk.sk_pages[i] == core::ptr::null_mut());
    rqstp.rq_pages[i] = svsk.sk_pages[i];
    svsk.sk_pages[i] = core::ptr::null_mut();
    }
    rqstp.rq_arg.head[0].iov_base = page_address(rqstp.rq_pages[0]);
    return len;
    }
#[no_mangle]
unsafe extern "C" fn svc_tcp_save_pages(svsk: *mut svc_sock, rqstp: *mut svc_rqst) {
    ...
    rqstp.rq_pages[i] = core::ptr::null_mut();
    }
    rqstp.rq_pages_nfree = npages;
    }
#[no_mangle]
unsafe extern "C" fn svc_tcp_clear_pages(svsk: *mut svc_sock) {
    ...
    npages = (len + PAGE_SIZE - 1) >> PAGE_SHIFT;
    for (i = 0; i < npages; i++) {
    if (svsk.sk_pages[i] == core::ptr::null_mut()) {
    WARN_ON_ONCE(1);
    continue;
    }
...
#[no_mangle]
unsafe extern "C" fn receive_cb_reply(svsk: *mut svc_sock, rqstp: *mut svc_rqst) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn svc_tcp_sendto(rqstp: *mut svc_rqst) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svc_init_xprt_sock() {
...
#[no_mangle]
pub unsafe extern "C" fn svc_cleanup_xprt_sock() {
...
#[no_mangle]
unsafe extern "C" fn svc_tcp_init(svsk: *mut svc_sock, serv: *mut svc_serv) {
...
#[no_mangle]
pub unsafe extern "C" fn svc_sock_update_bufs(serv: *mut svc_serv) {
...
#[no_mangle]
unsafe extern "C" fn svc_sock_sendpages(serv: *mut svc_serv, sock: *mut socket, flags: c_int) -> c_int {
...
//
    ...
    struct svc_sock	*svsk;
    struct sock	*inet;
    let mut pmap_register: c_int = !(flags & SVC_SOCK_ANONYMOUS);
    int		sendpages;
    unsigned long	pages;
...
//
    ...
    struct svc_sock *svsk = core::ptr::null_mut();
    struct sockaddr_storage addr;
    struct sockaddr *sin = (struct sockaddr *)&addr;
    int salen;
    if (!so)
...
//
#[no_mangle]
unsafe extern "C" fn svc_sock_detach(xprt: *mut svc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_tcp_sock_detach(xprt: *mut svc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_sock_free(xprt: *mut svc_xprt) {
