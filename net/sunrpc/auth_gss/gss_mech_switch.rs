...
//! Source: net/sunrpc/auth_gss/gss_mech_switch.c
#![no_std]
...
//
    ...
    status = -ENOMEM;
    if (pf.auth_domain_name == core::ptr::null_mut())
    goto out;
...
//
#[no_mangle]
pub unsafe extern "C" fn gss_mech_register(gm: *mut gss_api_mech) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gss_mech_unregister(gm: *mut gss_api_mech) {
    ...
    {
    struct gss_api_mech	*pos, *gm = core::ptr::null_mut();
    rcu_read_lock();
...
#[no_mangle]
pub unsafe extern "C" fn gss_mech_get_by_name(name: *const c_char) -> *mut gss_api_mech {
    ...
    {
    struct gss_api_mech *gm = core::ptr::null_mut(), *pos;
    rcu_read_lock();
    list_for_each_entry_rcu(pos, &registered_mechs, gm_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gss_mech_info2flavor(info: *mut rpcsec_gss_info) -> rpc_authflavor_t {
    rpc_authflavor_t gss_mech_info2flavor(struct rpcsec_gss_info *info)
    {
    rpc_authflavor_t pseudoflavor;
    struct gss_api_mech *gm;
    gm = gss_mech_get_by_OID(&info.oid);
    if (gm == core::ptr::null_mut())
    return RPC_AUTH_MAXFLAVOR;
