...
//! Source: net/sunrpc/auth_gss/gss_krb5_mech.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gss_krb5_prepare_enctype_priority_list() {
...
// unsigned 32-bit time overflows in year 2106
    ...
    if (unlikely(ctx.mech_used.data == core::ptr::null_mut())) {
    p = ERR_PTR(-ENOMEM);
    goto out_err;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn gss_krb5_errno_to_status(err: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn init_kerberos_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cleanup_kerberos_module() -> void __exit {
