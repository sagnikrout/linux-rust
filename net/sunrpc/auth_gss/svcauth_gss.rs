...
//! Source: net/sunrpc/auth_gss/svcauth_gss.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gss_svc_data {
// decoded gss client cred:
    pub clcred: rpc_gss_wire_cred,
    pub gsd_databody_offset: u32,
    pub rsci: *mut rsc,
// for temporary results
    pub gsd_seq_num: __be32,
    pub gsd_scratch: [u8; GSS_SCRATCH_SIZE],
}
...
//
#[no_mangle]
unsafe extern "C" fn netobj_equal(a: *mut xdr_netobj, b: *mut xdr_netobj) -> c_int {
    static int netobj_equal(struct xdr_netobj *a, struct xdr_netobj *b)
    {
    return a.len == b.len && 0 == memcmp(a.data, b.data, a.len);
    }
pub const RSI_HASHBITS: c_int = 6;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rsi {
    pub h: cache_head,
    pub in_token: xdr_netobj in_handle,,
    pub out_token: xdr_netobj out_handle,,
    pub minor_status: int major_status,,
...
#[no_mangle]
unsafe extern "C" fn rsi_free(rsii: *mut rsi) {
...
#[no_mangle]
unsafe extern "C" fn rsi_free_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn rsi_put(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn rsi_hash(item: *mut rsi) -> c_int {
    static inline int rsi_hash(struct rsi *item)
    {
#[no_mangle]
pub unsafe extern "C" fn hash_mem(_arg: item->in_handle.data, _arg: item->in_handle.len, _arg: RSI_HASHBITS) -> return {
    return hash_mem(item.in_handle.data, item.in_handle.len, RSI_HASHBITS)
    ^ hash_mem(item.in_token.data, item.in_token.len, RSI_HASHBITS);
    }
#[no_mangle]
unsafe extern "C" fn rsi_match(a: *mut cache_head, b: *mut cache_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dup_to_netobj(dst: *mut xdr_netobj, src: *mut c_char, len: c_int) -> c_int {
    static int dup_to_netobj(struct xdr_netobj *dst, char *src, int len)
    {
    dst.len = len;
    dst.data = (len ? kmemdup(src, len, GFP_KERNEL) : core::ptr::null_mut());
    if (len && !dst.data)
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn dup_netobj(dst: *mut xdr_netobj, src: *mut xdr_netobj) -> c_int {
    static inline int dup_netobj(struct xdr_netobj *dst, struct xdr_netobj *src)
    {
    return dup_to_netobj(dst, src.data, src.len);
    }
#[no_mangle]
unsafe extern "C" fn rsi_init(cnew: *mut cache_head, citem: *mut cache_head) {
    static void rsi_init(struct cache_head *cnew, struct cache_head *citem)
    {
    struct rsi *new = container_of(cnew, struct rsi, h);
    struct rsi *item = container_of(citem, struct rsi, h);
    new.out_handle.data = core::ptr::null_mut();
    new.out_handle.len = 0;
    new.out_token.data = core::ptr::null_mut();
    new.out_token.len = 0;
    ...
    item.in_handle.data = core::ptr::null_mut();
    new.in_token.data = item.in_token.data;
    item.in_token.data = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn update_rsi(cnew: *mut cache_head, citem: *mut cache_head) {
    ...
    item.out_handle.data = core::ptr::null_mut();
    new.out_token.data = item.out_token.data;
    item.out_token.data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rsi_upcall(cd: *mut cache_detail, h: *mut cache_head) -> c_int {
...
// context token expiry major minor context token
    ...
    char *ep;
    int len;
    struct rsi rsii, *rsip = core::ptr::null_mut();
    time64_t expiry;
...
// out_token
    ...
    let mut hash: c_int = rsi_hash(item);
    ...
    {
    struct cache_head *ch;
    let mut hash: c_int = rsi_hash(new);
...
//
pub const RSC_HASHBITS: c_int = 10;

pub const GSS_SEQ_WIN: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gss_svc_seq_data {
// highest seq number seen so far:
    pub sd_max: u32,
// for i such that sd_max-GSS_SEQ_WIN < i <= sd_max, the i-th bit of
// sd_win is nonzero iff sequence number i has been seen already:
    pub sd_win: [c_ulong; GSS_SEQ_WIN/BITS_PER_LONG],
    pub sd_lock: spinlock_t,
}
...
pub struct rsc {
    pub h: cache_head,
    pub handle: xdr_netobj,
    pub cred: svc_cred,
    pub seqdata: gss_svc_seq_data,
    pub mechctx: *mut gss_ctx,
    pub rcu_head: rcu_head,
}
...
#[no_mangle]
unsafe extern "C" fn rsc_free(rsci: *mut rsc) {
...
#[no_mangle]
unsafe extern "C" fn rsc_free_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn rsc_put(ref: *mut kref) {
    ...
    tmp.handle.data = core::ptr::null_mut();
    new.mechctx = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rsc_upcall(cd: *mut cache_detail, h: *mut cache_head) -> c_int {
...
// contexthandle expiry [ uid gid N <n gids> mechname ...mechdata... ]
    ...
    int id;
    int len, rv;
    struct rsc rsci, *rscp = core::ptr::null_mut();
    time64_t expiry;
    let mut status: c_int = -EINVAL;
    struct gss_api_mech *gm = core::ptr::null_mut();
...
// number of additional gid's
    ...
    if (rsci.cred.cr_group_info == core::ptr::null_mut())
    goto out;
// gid's
    status = -EINVAL;
    for (i=0; i<N; i++) {
...
// get client name
    ...
    {
    struct cache_head *ch;
    let mut hash: c_int = rsc_hash(item);
    ch = sunrpc_cache_lookup_rcu(cd, &item.h, hash);
    if (ch)
    ...
    {
    struct cache_head *ch;
    let mut hash: c_int = rsc_hash(new);
    ch = sunrpc_cache_update(cd, &new.h,
    &old.h, hash);
    if (ch)
    return container_of(ch, struct rsc, h);
    ...
    if (!found)
    return core::ptr::null_mut();
    if (cache_check(cd, &found.h, core::ptr::null_mut()))
    return core::ptr::null_mut();
    return found;
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn svcauth_gss_flavor(dom: *mut auth_domain) -> u32 {
...
//
    ...
    if (rqstp.rq_gssclient == core::ptr::null_mut())
    return SVC_DENIED;
...
// major_status = GSS_S_NO_CONTEXT;
    ...
    return rc;
    null_verifier:
    return xdr_stream_encode_opaque_auth(xdr, RPC_AUTH_NULL, core::ptr::null_mut(), 0) > 0;
    }
#[no_mangle]
unsafe extern "C" fn gss_free_in_token_pages(in_token: *mut gssp_in_token) {
    ...
    in_token.pages = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn set_gss_proxy(net: *mut net, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn use_gss_proxy(net: *mut net) -> bool {
...
#[no_mangle]
unsafe extern "C" fn create_use_gss_proxy_proc_entry(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_use_gss_proxy_proc_entry(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn create_krb5_enctypes_proc_entry(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_krb5_enctypes_proc_entry(net: *mut net) {
...
//
    ...
    __be32		*rpcstart;
    struct rpc_gss_wire_cred *gc;
    struct rsc	*rsci = core::ptr::null_mut();
    int		ret;
    struct sunrpc_net *sn = net_generic(SVC_NET(rqstp), sunrpc_net_id);
    ...
    svcdata.rsci = core::ptr::null_mut();
    gc = &svcdata.clcred;
    rqstp.rq_auth_stat = rpc_autherr_badcred;
...
//
#[no_mangle]
unsafe extern "C" fn svcauth_gss_wrap_integ(rqstp: *mut svc_rqst) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn svcauth_gss_wrap_priv(rqstp: *mut svc_rqst) -> c_int {
...
//
    ...
    rqstp.rq_gssclient = core::ptr::null_mut();
    if (rqstp.rq_cred.cr_group_info)
    put_group_info(rqstp.rq_cred.cr_group_info);
    rqstp.rq_cred.cr_group_info = core::ptr::null_mut();
    if (gsd && gsd.rsci) {
    cache_put(&gsd.rsci.h, sn.rsc_cache);
    gsd.rsci = core::ptr::null_mut();
    }
    return stat;
    }
    static void
...
#[no_mangle]
unsafe extern "C" fn svcauth_gss_pseudoflavor(rqstp: *mut svc_rqst) -> rpc_authflavor_t {
...
#[no_mangle]
unsafe extern "C" fn rsi_cache_create_net(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsi_cache_destroy_net(net: *mut net) {
    static void rsi_cache_destroy_net(struct net *net)
    {
    struct sunrpc_net *sn = net_generic(net, sunrpc_net_id);
    struct cache_detail *cd = sn.rsi_cache;
    sn.rsi_cache = core::ptr::null_mut();
    cache_purge(cd);
    cache_unregister_net(cd, net);
    cache_destroy_net(cd, net);
    }
#[no_mangle]
unsafe extern "C" fn rsc_cache_create_net(net: *mut net) -> c_int {
