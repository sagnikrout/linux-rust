...
//! Source: net/sunrpc/xprtrdma/backchannel.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_rdma_bc_setup(xprt: *mut rpc_xprt, reqs: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_rdma_bc_maxpayload(xprt: *mut rpc_xprt) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_rdma_bc_max_slots(xprt: *mut rpc_xprt) -> c_uint {
    unsigned int xprt_rdma_bc_max_slots(struct rpc_xprt *xprt)
    {
    return RPCRDMA_BACKWARD_WRS >> 1;
    }
#[no_mangle]
unsafe extern "C" fn rpcrdma_bc_marshal_reply(rqst: *mut rpc_rqst) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_rdma_bc_send_reply(rqst: *mut rpc_rqst) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_rdma_bc_destroy(xprt: *mut rpc_xprt, reqs: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_rdma_bc_free_rqst(rqst: *mut rpc_rqst) {
