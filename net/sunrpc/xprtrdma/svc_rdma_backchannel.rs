...
//! Source: net/sunrpc/xprtrdma/svc_rdma_backchannel.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(r_xprt->rx_buf.rb_bc_max_requests: credits >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn xprt_rdma_bc_send_request(rqst: *mut rpc_rqst) -> c_int {
