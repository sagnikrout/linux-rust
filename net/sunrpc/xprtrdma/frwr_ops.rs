...
//! Source: net/sunrpc/xprtrdma/frwr_ops.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn frwr_mr_unmap(mr: *mut rpcrdma_mr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_mr_release(mr: *mut rpcrdma_mr) {
...
#[no_mangle]
unsafe extern "C" fn frwr_mr_put(mr: *mut rpcrdma_mr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_reset(req: *mut rpcrdma_req) {
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_mr_init(r_xprt: *mut rpcrdma_xprt, mr: *mut rpcrdma_mr) -> c_int {
    int frwr_mr_init(struct rpcrdma_xprt *r_xprt, struct rpcrdma_mr *mr)
    {
    struct rpcrdma_ep *ep = r_xprt.rx_ep;
    let mut depth: c_uint = ep.re_max_fr_depth;
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_query_device(ep: *mut rpcrdma_ep, device: *const ib_device) -> c_int {
...
//
    ...
    let mut sg_gaps: bool = ep.re_mrtype == IB_MR_TYPE_SG_GAPS;
    let mut max_depth: c_uint = ep.re_max_fr_depth;
...
// Tail kvec
    ...
    ibmr = mr.mr_ibmr;
    n = ib_map_mr_sg(ibmr, mr.mr_sg, dma_nents, core::ptr::null_mut(), PAGE_SIZE);
    if (n != dma_nents)
    goto out_mapmr_err;
...
//
#[no_mangle]
unsafe extern "C" fn frwr_wc_fastreg(cq: *mut ib_cq, wc: *mut ib_wc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_send(r_xprt: *mut rpcrdma_xprt, req: *mut rpcrdma_req) -> c_int {
    ...
    ret = ib_post_send(ep.re_id.qp, post_wr, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_reminv(rep: *mut rpcrdma_rep, mrs: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn frwr_mr_done(wc: *mut ib_wc, mr: *mut rpcrdma_mr) {
...
//
#[no_mangle]
unsafe extern "C" fn frwr_wc_localinv(cq: *mut ib_cq, wc: *mut ib_wc) {
...
//
#[no_mangle]
unsafe extern "C" fn frwr_wc_localinv_wake(cq: *mut ib_cq, wc: *mut ib_wc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_unmap_sync(r_xprt: *mut rpcrdma_xprt, req: *mut rpcrdma_req) {
...
//
    ...
    last.sg_list = core::ptr::null_mut();
    last.num_sge = 0;
...
//
#[no_mangle]
unsafe extern "C" fn frwr_wc_localinv_done(cq: *mut ib_cq, wc: *mut ib_wc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_unmap_async(r_xprt: *mut rpcrdma_xprt, req: *mut rpcrdma_req) {
...
// unless re_id->qp is a valid pointer.
//
    rc = ib_post_send(ep.re_id.qp, first, core::ptr::null_mut());
    if (!rc)
    return;
// On error, the MRs get destroyed once the QP has drained.
    trace_xprtrdma_post_linv_err(req, rc);
...
//
#[no_mangle]
pub unsafe extern "C" fn frwr_wp_create(r_xprt: *mut rpcrdma_xprt) -> c_int {
    ...
    mr.mr_device = ep.re_id.device;
    ibmr = mr.mr_ibmr;
    if (ib_map_mr_sg(ibmr, mr.mr_sg, dma_nents, core::ptr::null_mut(),
    PAGE_SIZE) != dma_nents) {
    ret = -EIO;
    goto out_unmap;
    }
// IOVA is not tagged with an XID; the write-pad is not RPC-specific.
    ...
    trace_xprtrdma_mr_fastreg(mr);
    mr.mr_cqe.done = frwr_wc_fastreg;
    mr.mr_regwr.wr.next = core::ptr::null_mut();
    mr.mr_regwr.wr.wr_cqe = &mr.mr_cqe;
    mr.mr_regwr.wr.num_sge = 0;
    mr.mr_regwr.wr.opcode = IB_WR_REG_MR;
    mr.mr_regwr.wr.send_flags = 0;
    ret = ib_post_send(ep.re_id.qp, &mr.mr_regwr.wr, core::ptr::null_mut());
    if (!ret)
    return 0;
    out_unmap:
    frwr_mr_unmap(mr);
    out_mr:
    ep.re_write_pad_mr = core::ptr::null_mut();
