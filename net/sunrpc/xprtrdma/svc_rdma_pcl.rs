...
//! Source: net/sunrpc/xprtrdma/svc_rdma_pcl.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn pcl_free(pcl: *mut svc_rdma_pcl) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcl_alloc_call(rctxt: *mut svc_rdma_recv_ctxt, p: *mut __be32) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcl_alloc_read(rctxt: *mut svc_rdma_recv_ctxt, p: *mut __be32) -> bool {
