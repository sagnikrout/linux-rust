...
//
    let mut svc_conn_age_period: static int = 6*60;
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_reg_xprt_class(xcl: *mut svc_xprt_class) -> c_int {
    int svc_reg_xprt_class(struct svc_xprt_class *xcl)
    {
    struct svc_xprt_class *cl;
    let mut res: c_int = -EEXIST;
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_print_xprts(buf: *mut c_char, maxlen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_xprt_free(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn svc_xprt_put(xprt: *mut svc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn svc_xprt_slots_in_range(xprt: *mut svc_xprt) -> bool {
    static bool svc_xprt_slots_in_range(struct svc_xprt *xprt)
    {
    let mut limit: c_uint = svc_rpc_per_connection_limit;
    let mut nrqsts: c_int = atomic_read(&xprt.xpt_nr_rqsts);
    let mut limit: return = = 0 || (nrqsts >= 0 && nrqsts < limit);
    }
#[no_mangle]
unsafe extern "C" fn svc_xprt_reserve_slot(rqstp: *mut svc_rqst, xprt: *mut svc_xprt) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn svc_xprt_resource_released(xprt: *mut svc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn svc_xprt_release_slot(rqstp: *mut svc_rqst) {
...
#[no_mangle]
unsafe extern "C" fn svc_xprt_ready(xprt: *mut svc_xprt) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_xprt_enqueue(xprt: *mut svc_xprt) {
...
//
    ...
    {
    struct svc_xprt	*xprt = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_reserve(rqstp: *mut svc_rqst, space: c_int) {
...
#[no_mangle]
unsafe extern "C" fn free_deferred(xprt: *mut svc_xprt, dr: *mut svc_deferred_req) {
...
#[no_mangle]
unsafe extern "C" fn svc_xprt_release(rqstp: *mut svc_rqst) {
    static void svc_xprt_release(struct svc_rqst *rqstp)
    {
    struct svc_xprt	*xprt = rqstp.rq_xprt;
    xprt.xpt_ops.xpo_release_ctxt(xprt, rqstp.rq_xprt_ctxt);
    rqstp.rq_xprt_ctxt = core::ptr::null_mut();
    free_deferred(xprt, rqstp.rq_deferred);
    rqstp.rq_deferred = core::ptr::null_mut();
...
//
    ...
    rqstp.rq_xprt = core::ptr::null_mut();
    svc_xprt_put(xprt);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_wake_up(serv: *mut svc_serv) {
...
#[no_mangle]
pub unsafe extern "C" fn svc_port_is_privileged(sin: *mut sockaddr) -> c_int {
    int svc_port_is_privileged(struct sockaddr *sin)
    {
    switch (sin.sa_family) {
    case AF_INET:
#[no_mangle]
pub unsafe extern "C" fn ntohs()sin)->sin_port: *mut ((struct sockaddr_in) -> return {
    return ntohs(((struct sockaddr_in *)sin).sin_port)
    < PROT_SOCK;
    case AF_INET6:
#[no_mangle]
pub unsafe extern "C" fn ntohs()sin)->sin6_port: *mut ((struct sockaddr_in6) -> return {
...
//
#[no_mangle]
unsafe extern "C" fn svc_check_conn_limits(serv: *mut svc_serv) {
    static void svc_check_conn_limits(struct svc_serv *serv)
    {
    if (serv.sv_tmpcnt > XPT_MAX_TMP_CONN) {
    struct svc_xprt *xprt = core::ptr::null_mut(), *xprti;
    spin_lock_bh(&serv.sv_lock);
...
#[no_mangle]
unsafe extern "C" fn svc_alloc_arg(rqstp: *mut svc_rqst) -> bool {
...
//
    rqstp.rq_page_end[0] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn svc_add_new_temp_xprt(serv: *mut svc_serv, newxpt: *mut svc_xprt) {
    ...
    serv.sv_tmpcnt++;
    if (serv.sv_temptimer.function == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn svc_handle_xprt(rqstp: *mut svc_rqst, xprt: *mut svc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn svc_thread_wake_next(rqstp: *mut svc_rqst) {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_recv(rqstp: *mut svc_rqst, timeo: c_long) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_send(rqstp: *mut svc_rqst) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_age_temp_xprts(t: *mut timer_list) {
    static void svc_age_temp_xprts(struct timer_list *t)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_age_temp_xprts_now(serv: *mut svc_serv, server_addr: *mut sockaddr) {
...
#[no_mangle]
unsafe extern "C" fn call_xpt_users(xprt: *mut svc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_delete_xprt(xprt: *mut svc_xprt) {
    static void svc_delete_xprt(struct svc_xprt *xprt)
    {
...
//
    ...
    serv.sv_tmpcnt--;
    spin_unlock_bh(&serv.sv_lock);
    while ((dr = svc_deferred_dequeue(xprt)) != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_xprt_close(xprt: *mut svc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn svc_close_list(serv: *mut svc_serv, xprt_list: *mut list_head, net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_clean_up_xprts(serv: *mut svc_serv, net: *mut net) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_revisit(dreq: *mut cache_deferred_req, too_many: c_int) {
...
//
    ...
    return core::ptr::null_mut(); /* if more than a page, give up FIXME */
    if (rqstp.rq_deferred) {
...
//
#[no_mangle]
unsafe extern "C" fn svc_deferred_recv(rqstp: *mut svc_rqst) -> noinline int {
...
// Save off transport header len in case we get deferred again
    ...
    dr.xprt_ctxt = core::ptr::null_mut();
    svc_xprt_received(rqstp.rq_xprt);
    return dr.argslen << 2;
    }
    static struct svc_deferred_req *svc_deferred_dequeue(struct svc_xprt *xprt)
    {
    struct svc_deferred_req *dr = core::ptr::null_mut();
...
//
    ...
    {
    struct svc_xprt *xprt;
    struct svc_xprt *found = core::ptr::null_mut();
    spin_lock_bh(&serv.sv_lock);
...
// Sanity check the args
    if (serv == core::ptr::null_mut() || xcl_name == core::ptr::null_mut())
    return found;
    spin_lock_bh(&serv.sv_lock);
    list_for_each_entry(xprt, &serv.sv_permsocks, xpt_list) {
    if (xprt.xpt_net != net)
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_xprt_names(serv: *mut svc_serv, buf: *mut c_char, buflen: c_int) -> c_int {
...
// ----------------------------------------------------------------------------
    ...
    {
    let mut pidx: c_uint = (unsigned int)*pos;
    ...
    if (!si.serv)
    return core::ptr::null_mut();
    return pidx > svc_serv_nrpools(si.serv) ? core::ptr::null_mut()
    ...
    let mut pidx: c_uint = (pool - &serv.sv_pools[0]);
...
#[no_mangle]
unsafe extern "C" fn svc_pool_stats_stop(m: *mut seq_file, p: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn svc_pool_stats_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svc_pool_stats_open(info: *mut svc_info, file: *mut file) -> c_int {
