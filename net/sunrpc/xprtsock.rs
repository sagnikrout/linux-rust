...
// xprtsock tunables
//
    let mut xprt_udp_slot_table_entries: static unsigned int = RPC_DEF_SLOT_TABLE;
    let mut xprt_tcp_slot_table_entries: static unsigned int = RPC_MIN_SLOT_TABLE;
    let mut xprt_max_tcp_slot_table_entries: static unsigned int = RPC_MAX_SLOT_TABLE;
    let mut xprt_min_resvport: static unsigned int = RPC_DEF_MIN_RESVPORT;
    let mut xprt_max_resvport: static unsigned int = RPC_DEF_MAX_RESVPORT;

    let mut __read_mostly: static unsigned int xs_tcp_fin_timeout = XS_TCP_LINGER_TO;
//
...
//
    let mut min_slot_table_size: static unsigned int = RPC_MIN_SLOT_TABLE;
    let mut max_slot_table_size: static unsigned int = RPC_MAX_SLOT_TABLE;
    let mut max_tcp_slot_table_limit: static unsigned int = RPC_MAX_SLOT_TABLE_LIMIT;
    let mut xprt_min_resvport_limit: static unsigned int = RPC_MIN_RESVPORT;
    let mut xprt_max_resvport_limit: static unsigned int = RPC_MAX_RESVPORT;
...
#[no_mangle]
unsafe extern "C" fn xs_pktdump(msg: *mut c_char, packet: *mut u32, count: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn xs_pktdump(msg: *mut c_char, packet: *mut u32, count: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xs_format_common_peer_addresses(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_format_common_peer_ports(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_update_peer_port(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_free_peer_addresses(xprt: *mut rpc_xprt) {
    ...
    {
    let mut content_type: u8 = tls_get_record_type(sock.sk, cmsg);
...
#[no_mangle]
unsafe extern "C" fn xs_poll_socket(transport: *mut sock_xprt) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn xs_poll_socket_readable(transport: *mut sock_xprt) -> bool {
    static bool xs_poll_socket_readable(struct sock_xprt *transport)
    {
    let mut events: __poll_t = xs_poll_socket(transport);
    return (events & (EPOLLIN | EPOLLRDNORM)) && !(events & EPOLLRDHUP);
    }
#[no_mangle]
unsafe extern "C" fn xs_poll_check_readable(transport: *mut sock_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_stream_data_receive(transport: *mut sock_xprt) {
    static void xs_stream_data_receive(struct sock_xprt *transport)
    {
    let mut read: usize = 0;
    let mut ret: isize = 0;
    mutex_lock(&transport.recv_mutex);
    if (transport.sock == core::ptr::null_mut())
    goto out;
    for (;;) {
...
#[no_mangle]
unsafe extern "C" fn xs_stream_data_receive_workfn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_nospace(req: *mut rpc_rqst, transport: *mut sock_xprt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xs_sock_nospace(req: *mut rpc_rqst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xs_stream_nospace(req: *mut rpc_rqst, vm_wait: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xs_stream_prepare_request(req: *mut rpc_rqst, buf: *mut xdr_buf) -> c_int {
    static int xs_stream_prepare_request(struct rpc_rqst *req, struct xdr_buf *buf)
    {
    return xdr_alloc_bvec(buf, rpc_task_gfp_mask());
    }
#[no_mangle]
unsafe extern "C" fn xs_stream_abort_send_request(req: *mut rpc_rqst) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_local_send_request(req: *mut rpc_rqst) -> c_int {
    ...
    let mut rm: rpc_fraghdr = xs_stream_record_marker(xdr);
    let mut msglen: c_uint = rm ? req.rq_slen + sizeof(rm) : req.rq_slen;
    struct msghdr msg = {
...
//
#[no_mangle]
unsafe extern "C" fn xs_udp_send_request(req: *mut rpc_rqst) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_send_request(req: *mut rpc_rqst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xs_save_old_callbacks(transport: *mut sock_xprt, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn xs_restore_old_callbacks(transport: *mut sock_xprt, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn xs_sock_reset_state_flags(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_run_error_worker(transport: *mut sock_xprt, nr: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xs_sock_reset_connection_flags(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_error_report(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn xs_reset_transport(transport: *mut sock_xprt) {
...
//
    ...
    mutex_lock(&transport.recv_mutex);
    lock_sock(sk);
    transport.inet = core::ptr::null_mut();
    transport.sock = core::ptr::null_mut();
    transport.file = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn xs_close(xprt: *mut rpc_xprt) {
    static void xs_close(struct rpc_xprt *xprt)
    {
    struct sock_xprt *transport = container_of(xprt, struct sock_xprt, xprt);
...
#[no_mangle]
unsafe extern "C" fn xs_inject_disconnect(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_xprt_free(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_destroy(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_udp_data_receive(transport: *mut sock_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_udp_data_receive_workfn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_data_ready(sk: *mut sock) {
    static void xs_data_ready(struct sock *sk)
    {
    struct rpc_xprt *xprt;
    trace_sk_data_ready(sk);
    xprt = xprt_from_sock(sk);
    if (xprt != core::ptr::null_mut()) {
    struct sock_xprt *transport = container_of(xprt,
    struct sock_xprt, xprt);
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_force_close(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_tcp_bc_maxpayload(xprt: *mut rpc_xprt) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn xs_local_state_change(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_state_change(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn xs_write_space(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_udp_write_space(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_write_space(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn xs_udp_do_set_buffer_size(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_udp_set_buffer_size(xprt: *mut rpc_xprt, sndsize: usize, rcvsize: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_udp_timer(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
#[no_mangle]
unsafe extern "C" fn xs_get_random_port() -> c_int {
    static int xs_get_random_port(void)
    {
    let mut min: c_ushort = xprt_min_resvport, max = xprt_max_resvport;
...
#[no_mangle]
unsafe extern "C" fn xs_sock_getport(sock: *mut socket) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn xs_set_port(xprt: *mut rpc_xprt, port: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn xs_reset_srcport(transport: *mut sock_xprt) {
    static void xs_reset_srcport(struct sock_xprt *transport)
    {
    transport.srcport = 0;
    }
#[no_mangle]
unsafe extern "C" fn xs_set_srcport(transport: *mut sock_xprt, sock: *mut socket) {
    static void xs_set_srcport(struct sock_xprt *transport, struct socket *sock)
    {
...
#[no_mangle]
unsafe extern "C" fn xs_get_srcport(transport: *mut sock_xprt) -> c_int {
    static int xs_get_srcport(struct sock_xprt *transport)
    {
    let mut port: c_int = transport.srcport;
    if (port == 0 && transport.xprt.resvport)
    port = xs_get_random_port();
    return port;
    }
#[no_mangle]
unsafe extern "C" fn xs_sock_srcport(xprt: *mut rpc_xprt) -> c_ushort {
    static unsigned short xs_sock_srcport(struct rpc_xprt *xprt)
    {
    struct sock_xprt *sock = container_of(xprt, struct sock_xprt, xprt);
    let mut ret: c_ushort = 0;
...
#[no_mangle]
unsafe extern "C" fn xs_sock_srcaddr(xprt: *mut rpc_xprt, buf: *mut c_char, buflen: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xs_next_srcport(transport: *mut sock_xprt, port: c_ushort) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn xs_bind(transport: *mut sock_xprt, sock: *mut socket) -> c_int {
    static int xs_bind(struct sock_xprt *transport, struct socket *sock)
    {
    struct sockaddr_storage myaddr;
    int err, nloop = 0;
    let mut port: c_int = xs_get_srcport(transport);
    unsigned short last;
//
...
//
#[no_mangle]
unsafe extern "C" fn xs_local_rpcbind(task: *mut rpc_task) {
    static void xs_local_rpcbind(struct rpc_task *task)
    {
    xprt_set_bound(task.tk_xprt);
    }
#[no_mangle]
unsafe extern "C" fn xs_local_set_port(xprt: *mut rpc_xprt, port: c_ushort) {
...
#[no_mangle]
pub unsafe extern "C" fn xs_reclassify_socketu(sock: *mut socket) {
...
#[no_mangle]
pub unsafe extern "C" fn xs_reclassify_socket4(sock: *mut socket) {
...
#[no_mangle]
pub unsafe extern "C" fn xs_reclassify_socket6(sock: *mut socket) {
...
#[no_mangle]
pub unsafe extern "C" fn xs_reclassify_socket(family: c_int, sock: *mut socket) {
...
#[no_mangle]
unsafe extern "C" fn xs_dummy_setup_socket(work: *mut work_struct) {
    ...
    filp = sock_alloc_file(sock, O_NONBLOCK, core::ptr::null_mut());
    if (IS_ERR(filp))
...
//
#[no_mangle]
unsafe extern "C" fn xs_local_setup_socket(transport: *mut sock_xprt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xs_local_connect(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_set_memalloc(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_udp_finish_connecting(xprt: *mut rpc_xprt, sock: *mut socket) {
...
#[no_mangle]
unsafe extern "C" fn xs_udp_setup_socket(work: *mut work_struct) {
    ...
    let mut pflags: c_uint = current.flags;
    if (atomic_read(&xprt.swapper))
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_shutdown(xprt: *mut rpc_xprt) {
    static void xs_tcp_shutdown(struct rpc_xprt *xprt)
    {
    struct sock_xprt *transport = container_of(xprt, struct sock_xprt, xprt);
    struct socket *sock = transport.sock;
    let mut skst: c_int = transport.inet ? transport.inet.sk_state : TCP_CLOSE;
...
#[no_mangle]
unsafe extern "C" fn xs_tcp_finish_connecting(xprt: *mut rpc_xprt, sock: *mut socket) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_setup_socket(work: *mut work_struct) {
...
// Reset lower_transport before shutting down its clnt
    ...
    lower_transport.inet = core::ptr::null_mut();
    lower_transport.sock = core::ptr::null_mut();
    lower_transport.file = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn xs_tls_handshake_done(data: *mut c_void, status: c_int, peerid: key_serial_t) {
...
#[no_mangle]
unsafe extern "C" fn xs_tls_handshake_sync(lower_xprt: *mut rpc_xprt, xprtsec: *mut xprtsec_parms) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_tls_setup_socket(work: *mut work_struct) {
...
// XPRT_LOCKED was never acquired.
    ...
    if (status)
    goto out_close;
    xprt_release_write(lower_xprt, core::ptr::null_mut());
...
//
    ...
    out_unlock:
    current_restore_flags(pflags, PF_MEMALLOC);
    upper_transport.clnt = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn xs_connect(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
#[no_mangle]
unsafe extern "C" fn xs_wake_disconnect(transport: *mut sock_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_wake_write(transport: *mut sock_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_wake_error(transport: *mut sock_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_wake_pending(transport: *mut sock_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_error_handle(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_local_print_stats(xprt: *mut rpc_xprt, seq: *mut seq_file) {
    static void xs_local_print_stats(struct rpc_xprt *xprt, struct seq_file *seq)
    {
    let mut idle_time: c_long = 0;
    if (xprt_connected(xprt))
...
//
#[no_mangle]
unsafe extern "C" fn xs_udp_print_stats(xprt: *mut rpc_xprt, seq: *mut seq_file) {
...
//
#[no_mangle]
unsafe extern "C" fn xs_tcp_print_stats(xprt: *mut rpc_xprt, seq: *mut seq_file) {
...
//
#[no_mangle]
unsafe extern "C" fn bc_malloc(task: *mut rpc_task) -> c_int {
    static int bc_malloc(struct rpc_task *task)
    {
    struct rpc_rqst *rqst = task.tk_rqstp;
    let mut size: usize = rqst.rq_callsize;
    struct page *page;
...
//
#[no_mangle]
unsafe extern "C" fn bc_free(task: *mut rpc_task) {
...
#[no_mangle]
unsafe extern "C" fn bc_sendto(req: *mut rpc_rqst) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bc_send_request(req: *mut rpc_rqst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bc_close(xprt: *mut rpc_xprt) {
    static void bc_close(struct rpc_xprt *xprt)
    {
    xprt_disconnect_done(xprt);
    }
#[no_mangle]
unsafe extern "C" fn bc_destroy(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn xs_init_anyaddr(family: c_int, sap: *mut sockaddr) -> c_int {
...
//
    ...
    struct sock_xprt *transport;
    struct rpc_xprt *ret;
    let mut max_slot_table_size: c_uint = xprt_max_tcp_slot_table_entries;
...
//
    ...
    if (try_module_get(THIS_MODULE))
    return xprt;
    args.bc_xprt.xpt_bc_xprt = core::ptr::null_mut();
    args.bc_xprt.xpt_bc_xps = core::ptr::null_mut();
    xprt_put(xprt);
    ret = ERR_PTR(-EINVAL);
    out_err:
    xs_xprt_free(xprt);
...
//
#[no_mangle]
pub unsafe extern "C" fn init_socket_xprt() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cleanup_socket_xprt() {
...
#[no_mangle]
unsafe extern "C" fn param_set_portnr(val: *const c_char, kp: *const kernel_param) -> c_int {
