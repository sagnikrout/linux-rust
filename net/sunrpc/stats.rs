...
//
#[no_mangle]
unsafe extern "C" fn rpc_proc_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpc_proc_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn svc_seq_show(seq: *mut seq_file, statp: *const svc_stat) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_free_iostats(stats: *mut rpc_iostats) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_count_iostats(task: *const rpc_task, stats: *mut rpc_iostats) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: op ==) -> else {
    else if (op == 0)
    seq_printf(seq, "\t        core::ptr::null_mut(): ");
    else
    seq_printf(seq, "\t%12u: ", op);
    }
#[no_mangle]
unsafe extern "C" fn _add_rpc_iostats(a: *mut rpc_iostats, b: *mut rpc_iostats) {
...
#[no_mangle]
unsafe extern "C" fn do_print_stats(clnt: *mut rpc_clnt, xprt: *mut rpc_xprt, seqv: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_clnt_show_stats(seq: *mut seq_file, clnt: *mut rpc_clnt) {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_proc_init(net: *mut net) -> c_int {
    ...
    if (sn.proc_net_rpc == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn rpc_proc_exit(net: *mut net) {
