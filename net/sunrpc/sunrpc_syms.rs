...
//! Source: net/sunrpc/sunrpc_syms.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sunrpc_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn sunrpc_exit_net(net: *mut net) -> __net_exit void {
    ...
    init_sunrpc(void)
    {
    let mut err: c_int = rpc_init_mempool();
    if (err)
    goto out;
