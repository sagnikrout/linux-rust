...
#[no_mangle]
unsafe extern "C" fn rpc_register_client(clnt: *mut rpc_clnt) {
...
#[no_mangle]
unsafe extern "C" fn rpc_unregister_client(clnt: *mut rpc_clnt) {
...
#[no_mangle]
unsafe extern "C" fn __rpc_clnt_remove_pipedir(clnt: *mut rpc_clnt) {
    static void __rpc_clnt_remove_pipedir(struct rpc_clnt *clnt)
    {
    if (clnt.pipefs_sb) {
    rpc_remove_client_dir(clnt);
    clnt.pipefs_sb = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn rpc_clnt_remove_pipedir(clnt: *mut rpc_clnt) {
    ...
    if (clnt.cl_program.pipe_dir_name != core::ptr::null_mut()) {
    let mut err: c_int = rpc_setup_pipedir_sb(pipefs_sb, clnt);
    if (err && err != -ENOENT)
    return err;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rpc_clnt_skip_event(clnt: *mut rpc_clnt, event: c_ulong) -> c_int {
    ...
    if (clnt.cl_pipedir_objects.pdh_dentry != core::ptr::null_mut())
    return 1;
...
#[no_mangle]
pub unsafe extern "C" fn rpc_clients_notifier_register() -> c_int {
    int rpc_clients_notifier_register(void)
    {
    return rpc_pipefs_notifier_register(&rpc_clients_block);
    }
#[no_mangle]
pub unsafe extern "C" fn rpc_clients_notifier_unregister() {
...
#[no_mangle]
unsafe extern "C" fn rpc_clnt_set_nodename(clnt: *mut rpc_clnt, nodename: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_cleanup_clids() {
    void rpc_cleanup_clids(void)
    {
    ida_destroy(&rpc_clids);
    }
#[no_mangle]
unsafe extern "C" fn rpc_alloc_clid(clnt: *mut rpc_clnt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpc_free_clid(clnt: *mut rpc_clnt) {
    ...
    struct rpc_clnt *clnt = core::ptr::null_mut();
    const struct rpc_timeout *timeout;
    ...
    err = -ENOMEM;
    if (clnt.cl_metrics == core::ptr::null_mut())
    goto out_no_stats;
    clnt.cl_program  = program;
    INIT_LIST_HEAD(&clnt.cl_tasks);
    spin_lock_init(&clnt.cl_lock);
    timeout = xprt.timeout;
    if (args.timeout != core::ptr::null_mut()) {
...
// save the nodename
    ...
    clnt = rpc_new_client(args, xps, xprt, core::ptr::null_mut());
    if (IS_ERR(clnt))
    return clnt;
    if (!(args.flags & RPC_CLNT_CREATE_NOPING)) {
    let mut err: c_int = rpc_ping(clnt);
    if (err != 0) {
    rpc_shutdown_client(clnt);
    return ERR_PTR(err);
    }
    } else if (args.flags & RPC_CLNT_CREATE_CONNECTED) {
    let mut err: c_int = rpc_ping_noreply(clnt);
    if (err != 0) {
    rpc_shutdown_client(clnt);
    return ERR_PTR(err);
    }
...
//
    if (xprtargs.servername == core::ptr::null_mut()) {
...
//
    ...
    if (rpc_clnt_add_xprt(clnt, &xprtargs, core::ptr::null_mut(), core::ptr::null_mut()) < 0)
    break;
    }
    return clnt;
    }
...
//
    ...
    rcu_read_unlock();
    if (xprt == core::ptr::null_mut() || xps == core::ptr::null_mut()) {
    xprt_put(xprt);
    xprt_switch_put(xps);
    goto out_err;
    }
...
// client and server.
//
    err = rpc_client_register(clnt, pseudoflavor, core::ptr::null_mut());
    if (err)
    goto out_revert;
    synchronize_rcu();
    if (parent != clnt)
    ...
    rpc_client_register(clnt, pseudoflavor, core::ptr::null_mut());
    xprt_switch_put(xps);
    xprt_put(xprt);
...
#[no_mangle]
pub unsafe extern "C" fn func(xpi: *mut rpc_xprt_iter, xps): *mut rpc_xprt_switch) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rpc_clnt_xprt_iter_init(clnt: *mut rpc_clnt, xpi: *mut rpc_xprt_iter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_killall_tasks(clnt: *mut rpc_clnt) {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_clnt_disconnect(clnt: *mut rpc_clnt) {
    void rpc_clnt_disconnect(struct rpc_clnt *clnt)
    {
    rpc_clnt_iterate_for_each_xprt(clnt, rpc_clnt_disconnect_xprt, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_shutdown_client(clnt: *mut rpc_clnt) {
...
//
#[no_mangle]
unsafe extern "C" fn rpc_free_client_work(work: *mut work_struct) {
...
//
    ...
    {
    struct rpc_clnt *parent = core::ptr::null_mut();
    trace_rpc_clnt_release(clnt);
    if (clnt.cl_parent != clnt)
    parent = clnt.cl_parent;
    rpc_unregister_client(clnt);
    rpc_free_iostats(clnt.cl_metrics);
    clnt.cl_metrics = core::ptr::null_mut();
...
//
    if (clnt.cl_auth != core::ptr::null_mut()) {
    rpcauth_release(clnt.cl_auth);
    clnt.cl_auth = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_hold_client(clnt: *mut rpc_clnt) {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_task_release_transport(task: *mut rpc_task) {
    void rpc_task_release_transport(struct rpc_task *task)
    {
    struct rpc_xprt *xprt = task.tk_xprt;
    if (xprt) {
    task.tk_xprt = core::ptr::null_mut();
    if (task.tk_client)
...
#[no_mangle]
pub unsafe extern "C" fn rpc_task_release_client(task: *mut rpc_task) {
    void rpc_task_release_client(struct rpc_task *task)
    {
    struct rpc_clnt *clnt = task.tk_client;
    rpc_task_release_transport(task);
    if (clnt != core::ptr::null_mut()) {
// Remove from client task list
    spin_lock(&clnt.cl_lock);
    list_del(&task.tk_task);
    spin_unlock(&clnt.cl_lock);
    task.tk_client = core::ptr::null_mut();
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rpc_task_set_transport(task: *mut rpc_task, clnt: *mut rpc_clnt) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rpc_task_set_client(task: *mut rpc_task, clnt: *mut rpc_clnt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_call_sync(clnt: *mut rpc_clnt, msg: *const rpc_message, flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_peeraddr(clnt: *mut rpc_clnt, buf: *mut sockaddr, bufsize: usize) -> usize {
...
//
    ...
    struct rpc_xprt *xprt;
    xprt = rcu_dereference(clnt.cl_xprt);
    if (xprt.address_strings[format] != core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn rpc_anyaddr(family: c_int, buf: *mut sockaddr, buflen: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_localaddr(clnt: *mut rpc_clnt, buf: *mut sockaddr, buflen: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_max_payload(clnt: *mut rpc_clnt) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_max_bc_payload(clnt: *mut rpc_clnt) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_num_bc_slots(clnt: *mut rpc_clnt) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_force_rebind(clnt: *mut rpc_clnt) {
...
//
    ...
    {
    struct rpc_clnt	*clnt = task.tk_client;
    let mut idx: c_int = task.tk_msg.rpc_proc.p_statidx;
...
//
    ...
    {
    let mut status: c_int = task.tk_status;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !xprt_connected(task->tk_xprt)) -> else {
...
// possibly garbled cred/verf?
    ...
    {
    return rpc_call_null_helper(clnt, core::ptr::null_mut(), cred, flags, core::ptr::null_mut(), core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(rpc_call_null);
#[no_mangle]
unsafe extern "C" fn rpc_ping(clnt: *mut rpc_clnt) -> c_int {
    static int rpc_ping(struct rpc_clnt *clnt)
    {
    struct rpc_task	*task;
    int status;
    ...
    task = rpc_call_null_helper(clnt, core::ptr::null_mut(), core::ptr::null_mut(), 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(task))
    return PTR_ERR(task);
    status = task.tk_status;
    rpc_put_task(task);
...
#[no_mangle]
unsafe extern "C" fn rpc_ping_noreply(clnt: *mut rpc_clnt) -> c_int {
    static int rpc_ping_noreply(struct rpc_clnt *clnt)
    {
    struct rpc_message msg = {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpc_cb_add_xprt_calldata {
    pub xps: *mut rpc_xprt_switch,
    pub xprt: *mut rpc_xprt,
}

#[no_mangle]
unsafe extern "C" fn rpc_cb_add_xprt_done(task: *mut rpc_task, calldata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rpc_cb_add_xprt_release(calldata: *mut c_void) {
...
//
    ...
    struct rpc_task *task;
    let mut max_connect: c_int = clnt.cl_max_connect;
    if (in_max_connect)
    ...
    task = rpc_call_null_helper(clnt, xprt, core::ptr::null_mut(), RPC_TASK_ASYNC,
    ...
    {
    struct rpc_task *task;
    let mut status: c_int = -EADDRINUSE;
// Test the connection
    task = rpc_call_null_helper(clnt, xprt, core::ptr::null_mut(), 0, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(task))
    return PTR_ERR(task);
    status = task.tk_status;
    rpc_put_task(task);
...
//
    ...
    let mut ret: c_int = 0, ident;
    rcu_read_lock();
    xps = xprt_switch_get(rcu_dereference(clnt.cl_xpi.xpi_xpswitch));
    xprt = xprt_iter_xprt(&clnt.cl_xpi);
    if (xps == core::ptr::null_mut() || xprt == core::ptr::null_mut()) {
    rcu_read_unlock();
    xprt_switch_put(xps);
    return -EAGAIN;
    }
    ...
    if (xprt.ops.set_connect_timeout != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn rpc_clnt_manage_trunked_xprts(clnt: *mut rpc_clnt) {
    void rpc_clnt_manage_trunked_xprts(struct rpc_clnt *clnt)
    {
    rpc_clnt_iterate_for_each_xprt(clnt, rpc_xprt_offline, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(rpc_clnt_manage_trunked_xprts);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct connect_timeout_data {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_clnt_xprt_set_online(clnt: *mut rpc_clnt, xprt: *mut rpc_xprt) {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_clnt_xprt_switch_add_xprt(clnt: *mut rpc_clnt, xprt: *mut rpc_xprt) {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_clnt_xprt_switch_remove_xprt(clnt: *mut rpc_clnt, xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn rpc_show_header(clnt: *mut rpc_clnt) {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_show_tasks(net: *mut net) {
    ...
    rpc_clnt_swap_activate_callback, core::ptr::null_mut());
    return 0;
    }
    ...
    rpc_clnt_iterate_for_each_xprt(clnt,
    rpc_clnt_swap_deactivate_callback, core::ptr::null_mut());
    }
