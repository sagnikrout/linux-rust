...
//
    ...
    return 0;
    if (acred.cred.group_info != core::ptr::null_mut())
    groups = acred.cred.group_info.ngroups;
    if (groups > UNX_NGROUPS)
    groups = UNX_NGROUPS;
    if (cred.cr_cred.group_info == core::ptr::null_mut())
    let mut groups: return = = 0;
...
#[no_mangle]
pub unsafe extern "C" fn rpc_init_authunix() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn rpc_destroy_authunix() {
