...
#[no_mangle]
unsafe extern "C" fn cache_init(h: *mut cache_head, detail: *mut cache_detail) {
    static void cache_init(struct cache_head *h, struct cache_detail *detail)
    {
    let mut now: time64_t = seconds_since_boot();
...
// Must be called under cd->hash_lock
    ...
    int hash)
    {
    struct cache_head *new, *tmp, *freeme = core::ptr::null_mut();
    struct hlist_head *head = &detail.hash_table[hash];
    new = detail.alloc();
    if (!new)
    return core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cache_is_valid(h: *mut cache_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn try_to_negate_entry(detail: *mut cache_detail, h: *mut cache_head) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sunrpc_init_cache_detail(cd: *mut cache_detail) {
...
#[no_mangle]
pub unsafe extern "C" fn sunrpc_destroy_cache_detail(cd: *mut cache_detail) {
    ...
    current_detail = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn cache_clean() -> c_int {
...
// find a suitable table if we don't already have one
    while (current_detail == core::ptr::null_mut() ||
...
// find a cleanable entry in the bucket and clean it, or set to next bucket
    ...
    struct cache_head *ch = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn do_cache_clean(work: *mut work_struct) {
    static void do_cache_clean(struct work_struct *work)
    {
    int delay;
    if (list_empty(&cache_list))
...
#[no_mangle]
pub unsafe extern "C" fn cache_purge(detail: *mut cache_detail) {
...
#[no_mangle]
unsafe extern "C" fn __unhash_deferred_req(dreq: *mut cache_deferred_req) {
...
#[no_mangle]
unsafe extern "C" fn __hash_deferred_req(dreq: *mut cache_deferred_req, item: *mut cache_head) {
    static void __hash_deferred_req(struct cache_deferred_req *dreq, struct cache_head *item)
    {
    let mut hash: c_int = DFR_HASH(item);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thread_deferred_req {
    pub handle: cache_deferred_req,
    pub completion: completion,
}

#[no_mangle]
unsafe extern "C" fn cache_restart_thread(dreq: *mut cache_deferred_req, too_many: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cache_wait_req(req: *mut cache_req, item: *mut cache_head) {
...
#[no_mangle]
unsafe extern "C" fn cache_limit_defers() {
    static void cache_limit_defers(void)
    {
// Make sure we haven't exceed the limit of allowed deferred
// requests.
//
    struct cache_deferred_req *discard = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cache_defer_immediately() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cache_defer_req(req: *mut cache_req, item: *mut cache_head) -> bool {
    static bool cache_defer_req(struct cache_req *req, struct cache_head *item)
    {
...
#[no_mangle]
unsafe extern "C" fn cache_revisit_request(item: *mut cache_head) {
    static void cache_revisit_request(struct cache_head *item)
    {
    struct cache_deferred_req *dreq;
    struct hlist_node *tmp;
...
#[no_mangle]
pub unsafe extern "C" fn cache_clean_deferred(owner: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cache_reader {
    pub list: list_head,
    pub /: *mut *mut int offset; / if non-0, we have a refcnt on next request,
    pub next_seqno: u64,
}
...
//
    ...
    struct cache_detail *cd)
    {
    struct cache_reader *rp = core::ptr::null_mut();
    ...
    struct cache_reader *rp = filp.private_data;
    if (rp) {
    struct cache_request *rq = core::ptr::null_mut();
    spin_lock(&cd.queue_lock);
    if (rp.offset) {
...
#[no_mangle]
unsafe extern "C" fn cache_dequeue(detail: *mut cache_detail, ch: *mut cache_head) {
    static void cache_dequeue(struct cache_detail *detail, struct cache_head *ch)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn qword_add(bpp: *mut c_char, lp: *mut c_int, str: *mut c_char) {
    void qword_add(char **bpp, int *lp, char *str)
    {
    char *bp = *bpp;
    let mut len: c_int = *lp;
    int ret;
    if (len < 0) return;
...
#[no_mangle]
pub unsafe extern "C" fn qword_addhex(bpp: *mut c_char, lp: *mut c_int, buf: *mut c_char, blen: c_int) {
...
#[no_mangle]
unsafe extern "C" fn warn_no_listener(detail: *mut cache_detail) {
...
#[no_mangle]
unsafe extern "C" fn cache_listeners_exist(detail: *mut cache_detail) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn cache_do_upcall(detail: *mut cache_detail, h: *mut cache_head) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sunrpc_cache_upcall(detail: *mut cache_detail, h: *mut cache_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qword_get(bpp: *mut c_char, dest: *mut c_char, bufsize: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cache_seq_stop_rcu(m: *mut seq_file, p: *mut c_void) {
...
unsafe extern "C" fn c_show(m: *mut seq_file, p: *mut c_void) -> c_int {
    ...
    struct cache_detail *cd = m.private;
    if (p == SEQ_START_TOKEN)
    return cd.cache_show(m, cd, core::ptr::null_mut());
    ifdebug(CACHE)
    seq_printf(m, "# expiry=%lld refcnt=%d flags=%lx\n",
    convert_to_wallclock(cp.expiry_time),
    kref_read(&cp.ref), cp.flags);
    if (cache_check_rcu(cd, cp, core::ptr::null_mut()))
    seq_puts(m, "# ");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cache_is_expired(cd, _arg: cp)) -> else {
    ...
    struct cache_detail *cd)
    {
    let mut ret: c_int = seq_release(inode, file);
    module_put(cd.owner);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn cache_poll_procfs(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn cache_open_procfs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cache_release_procfs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn content_open_procfs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn content_release_procfs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn open_flush_procfs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_flush_procfs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_cache_proc_entries(cd: *mut cache_detail) {
    static void remove_cache_proc_entries(struct cache_detail *cd)
    {
    if (cd.procfs) {
    proc_remove(cd.procfs);
    cd.procfs = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn create_cache_proc_entries(cd: *mut cache_detail, net: *mut net) -> c_int {
    ...
    if (cd.procfs == core::ptr::null_mut())
    goto out_nomem;
...
#[no_mangle]
pub unsafe extern "C" fn cache_initialize() -> void __init {
    void __init cache_initialize(void)
    {
    INIT_DEFERRABLE_WORK(&cache_cleaner, do_cache_clean);
    }
#[no_mangle]
pub unsafe extern "C" fn cache_register_net(cd: *mut cache_detail, net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cache_unregister_net(cd: *mut cache_detail, net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn cache_destroy_net(cd: *mut cache_detail, net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn cache_poll_pipefs(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn cache_open_pipefs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cache_release_pipefs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn content_open_pipefs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn content_release_pipefs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn open_flush_pipefs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_flush_pipefs(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sunrpc_cache_unregister_pipefs(cd: *mut cache_detail) {
    void sunrpc_cache_unregister_pipefs(struct cache_detail *cd)
    {
    if (cd.pipefs) {
    rpc_remove_cache_dir(cd.pipefs);
    cd.pipefs = core::ptr::null_mut();
    }
    }
    EXPORT_SYMBOL_GPL(sunrpc_cache_unregister_pipefs);
#[no_mangle]
pub unsafe extern "C" fn sunrpc_cache_unhash(cd: *mut cache_detail, h: *mut cache_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sunrpc_cache_requests_count(cd: *mut cache_detail) -> c_int {
