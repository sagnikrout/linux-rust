...
#[no_mangle]
unsafe extern "C" fn xprt_request_timeout(req: *const rpc_rqst) -> c_ulong {
    static unsigned long xprt_request_timeout(const struct rpc_rqst *req)
    {
    let mut timeout: c_ulong = jiffies + req.rq_timeout;
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_register_transport(transport: *mut xprt_class) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_unregister_transport(transport: *mut xprt_class) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_find_transport_ident(netid: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xprt_clear_locked(xprt: *mut rpc_xprt) {
    static void xprt_clear_locked(struct rpc_xprt *xprt)
    {
    xprt.snd_task = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_reserve_xprt(xprt: *mut rpc_xprt, task: *mut rpc_task) -> c_int {
    ...
    rpc_sleep_on_timeout(&xprt.sending, task, core::ptr::null_mut(),
    xprt_request_timeout(req));
    else
    rpc_sleep_on(&xprt.sending, task, core::ptr::null_mut());
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_reserve_xprt_cong(xprt: *mut rpc_xprt, task: *mut rpc_task) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_lock_write(xprt: *mut rpc_xprt, task: *mut rpc_task) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __xprt_lock_write_func(task: *mut rpc_task, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __xprt_lock_write_next(xprt: *mut rpc_xprt) {
...
#[no_mangle]
unsafe extern "C" fn __xprt_lock_write_next_cong(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_release_xprt(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_release_xprt_cong(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_release_write(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_release_rqst_cong(task: *mut rpc_task) {
...
#[no_mangle]
unsafe extern "C" fn xprt_clear_congestion_window_wait_locked(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_adjust_cwnd(xprt: *mut rpc_xprt, task: *mut rpc_task, result: c_int) {
    void xprt_adjust_cwnd(struct rpc_xprt *xprt, struct rpc_task *task, int result)
    {
    struct rpc_rqst *req = task.tk_rqstp;
    let mut cwnd: c_ulong = xprt.cwnd;
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_wake_pending_tasks(xprt: *mut rpc_xprt, status: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_wait_for_buffer_space(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_write_space(xprt: *mut rpc_xprt) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xprt_abs_ktime_to_jiffies(abstime: ktime_t) -> c_ulong {
    static unsigned long xprt_abs_ktime_to_jiffies(ktime_t abstime)
    {
    let mut delta: i64 = ktime_to_ns(ktime_get() - abstime);
    ...
    {
    let mut majortimeo: c_ulong = req.rq_timeout;
...
#[no_mangle]
unsafe extern "C" fn xprt_reset_minortimeo(req: *mut rpc_rqst) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_adjust_timeout(req: *mut rpc_rqst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xprt_autoclose(work: *mut work_struct) {
    ...
    xprt.ops.close(xprt);
    xprt_release_write(xprt, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_disconnect_done(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
unsafe extern "C" fn xprt_schedule_autoclose_locked(xprt: *mut rpc_xprt) {
    ...
    queue_work(xprtiod_workqueue, &xprt.task_cleanup);
#[no_mangle]
pub unsafe extern "C" fn if(!test_bit(XPRT_SND_IS_COOKIE: xprt->snd_task &&, _arg: &xprt->state)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_force_disconnect(xprt: *mut rpc_xprt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_conditional_disconnect(xprt: *mut rpc_xprt, cookie: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xprt_inject_disconnect(xprt: *mut rpc_xprt) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_inject_disconnect(xprt: *mut rpc_xprt) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_unlock_connect(xprt: *mut rpc_xprt, cookie: *mut c_void) {
    ...
    xprt.ops.release_xprt(xprt, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_connect(task: *mut rpc_task) {
    ...
    rpc_sleep_on_timeout(&xprt.pending, task, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_reconnect_delay(xprt: *const rpc_xprt) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_reconnect_backoff(xprt: *mut rpc_xprt, init_to: c_ulong) {
    ...
    struct rb_node *n = core::ptr::null_mut();
    struct rpc_rqst *req;
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_pin_rqst(req: *mut rpc_rqst) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_unpin_rqst(req: *mut rpc_rqst) {
...
#[no_mangle]
unsafe extern "C" fn xprt_wait_on_pinned_rqst(req: *mut rpc_rqst) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_update_rtt(task: *mut rpc_task) {
    void xprt_update_rtt(struct rpc_task *task)
    {
    struct rpc_rqst *req = task.tk_rqstp;
    struct rpc_rtt *rtt = task.tk_client.cl_rtt;
    let mut timer: c_uint = task.tk_msg.rpc_proc.p_timer;
    let mut m: c_long = usecs_to_jiffies(ktime_to_us(req.rq_rtt));
    if (timer) {
    if (req.rq_ntrans == 1)
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_complete_rqst(task: *mut rpc_task, copied: c_int) {
    ...
    req.rq_private_buf.bvec = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xprt_timer(task: *mut rpc_task) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_wait_for_reply_request_def(task: *mut rpc_task) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_wait_for_reply_request_rtt(task: *mut rpc_task) {
    void xprt_wait_for_reply_request_rtt(struct rpc_task *task)
    {
    let mut timer: c_int = task.tk_msg.rpc_proc.p_timer;
    struct rpc_clnt *clnt = task.tk_client;
    struct rpc_rtt *rtt = clnt.cl_rtt;
    struct rpc_rqst *req = task.tk_rqstp;
    let mut max_timeout: c_ulong = clnt.cl_timeout.to_maxval;
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_request_wait_receive(task: *mut rpc_task) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_prepare_transmit(task: *mut rpc_task) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_end_transmit(task: *mut rpc_task) {
...
//
    ...
    let mut is_retrans: c_int = RPC_WAS_SENT(task);
    int status;
    if (test_bit(XPRT_CLOSE_WAIT, &xprt.state))
    return -ENOTCONN;
...
#[no_mangle]
unsafe extern "C" fn xprt_complete_request_init(task: *mut rpc_task) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_add_backlog(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
#[no_mangle]
unsafe extern "C" fn __xprt_set_rq(task: *mut rpc_task, data: *mut c_void) -> bool {
    static bool __xprt_set_rq(struct rpc_task *task, void *data)
    {
    struct rpc_rqst *req = data;
    if (task.tk_rqstp == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_wake_up_backlog(xprt: *mut rpc_xprt, req: *mut rpc_rqst) -> bool {
    bool xprt_wake_up_backlog(struct rpc_xprt *xprt, struct rpc_rqst *req)
    {
    if (rpc_wake_up_first(&xprt.backlog, __xprt_set_rq, req) == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn xprt_throttle_congested(xprt: *mut rpc_xprt, task: *mut rpc_task) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xprt_dynamic_free_slot(xprt: *mut rpc_xprt, req: *mut rpc_rqst) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_alloc_slot(xprt: *mut rpc_xprt, task: *mut rpc_task) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_free_slot(xprt: *mut rpc_xprt, req: *mut rpc_rqst) {
...
#[no_mangle]
unsafe extern "C" fn xprt_free_all_slots(xprt: *mut rpc_xprt) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_cleanup_ids() {
    void xprt_cleanup_ids(void)
    {
    ida_destroy(&rpc_xprt_ids);
    }
#[no_mangle]
unsafe extern "C" fn xprt_alloc_id(xprt: *mut rpc_xprt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xprt_free_id(xprt: *mut rpc_xprt) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_free(xprt: *mut rpc_xprt) {
    ...
    req.rq_task	= task;
    req.rq_xprt    = xprt;
    req.rq_buffer  = core::ptr::null_mut();
    ...
    req.rq_snd_buf.bvec = core::ptr::null_mut();
    req.rq_rcv_buf.bvec = core::ptr::null_mut();
    req.rq_release_snd_buf = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_reserve(task: *mut rpc_task) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_retry_reserve(task: *mut rpc_task) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_release(task: *mut rpc_task) {
    ...
    if (req.rq_cred != core::ptr::null_mut())
    put_rpccred(req.rq_cred);
    if (req.rq_release_snd_buf)
    req.rq_release_snd_buf(req);
    task.tk_rqstp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xprt_init(xprt: *mut rpc_xprt, net: *mut net) {
    static void xprt_init(struct rpc_xprt *xprt, struct net *net)
    {
    kref_init(&xprt.kref);
...
//
    ...
    timer_setup(&xprt.timer, core::ptr::null_mut(), 0);
    if (strlen(args.servername) > RPC_MAXNETNAMELEN) {
    xprt_destroy(xprt);
    return ERR_PTR(-EINVAL);
    }
    xprt.servername = kstrdup(args.servername, GFP_KERNEL);
    if (xprt.servername == core::ptr::null_mut()) {
    xprt_destroy(xprt);
...
#[no_mangle]
unsafe extern "C" fn xprt_destroy_cb(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn xprt_destroy(xprt: *mut rpc_xprt) {
    static void xprt_destroy(struct rpc_xprt *xprt)
    {
//
...
#[no_mangle]
unsafe extern "C" fn xprt_destroy_kref(kref: *mut kref) {
...
//
    ...
    {
    if (xprt != core::ptr::null_mut() && kref_get_unless_zero(&xprt.kref))
    return xprt;
    return core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn xprt_put(xprt: *mut rpc_xprt) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_set_offline_locked(xprt: *mut rpc_xprt, xps: *mut rpc_xprt_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_set_online_locked(xprt: *mut rpc_xprt, xps: *mut rpc_xprt_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn xprt_delete_locked(xprt: *mut rpc_xprt, xps: *mut rpc_xprt_switch) {
