...
pub const MPTCP_PM_CMD_GRP_OFFSET: c_int = 0;
pub const MPTCP_PM_EV_GRP_OFFSET: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn mptcp_pm_family_to_addr(family: c_int) -> c_int {
...
// no validation needed - was already done via nested policy
    ...
    let mut val: i32 = nla_get_s32(tb[MPTCP_PM_ADDR_ATTR_IF_IDX]);
    entry.ifindex = val;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_get_addr_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mptcp_pm_dump_addr(msg: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mptcp_pm_set_flags(info: *mut genl_info) -> c_int {
    static int mptcp_pm_set_flags(struct genl_info *info)
    {
    let mut loc: mptcp_pm_addr_entry = { .addr = { .family = AF_UNSPEC }, };
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_set_flags_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int mptcp_pm_nl_set_flags_doit(struct sk_buff *skb, struct genl_info *info)
    {
    return mptcp_pm_set_flags(info);
    }
#[no_mangle]
unsafe extern "C" fn mptcp_nl_mcast_send(net: *mut net, nlskb: *mut sk_buff, gfp: gfp_t) {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_userspace_pm_active(msk: *const mptcp_sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mptcp_event_add_subflow(skb: *mut sk_buff, ssk: *const sock) -> c_int {
    ...
    const struct sock *ssk)
    {
    let mut err: c_int = nla_put_u32(skb, MPTCP_ATTR_TOKEN, READ_ONCE(msk.token));
    let mut flags: u16 = 0;
    if (err)
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_event_addr_removed(msk: *const mptcp_sock, id: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_init() -> void __init {
