...
pub const MIN_INFO_OPTLEN_SIZE: c_int = 16;
pub const MIN_FULL_INFO_OPTLEN_SIZE: c_int = 40;
...
#[no_mangle]
unsafe extern "C" fn sockopt_seq_reset(sk: *const sock) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sockopt_seq_inc(msk: *mut mptcp_sock) {
    static void sockopt_seq_inc(struct mptcp_sock *msk)
    {
    let mut seq: u32 = (msk.setsockopt_seq + 1) & 0x00ffffff;
...
#[no_mangle]
unsafe extern "C" fn __mptcp_subflow_set_rcvbuf(ssk: *mut sock, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_sol_socket_sync_intval(msk: *mut mptcp_sock, optname: c_int, val: c_int) {
    ...
    let mut slow: bool = lock_sock_fast(ssk);
    switch (optname) {
    case SO_DEBUG:
...
#[no_mangle]
unsafe extern "C" fn mptcp_sol_socket_intval(msk: *mut mptcp_sock, optname: c_int, val: c_int) -> c_int {
    static int mptcp_sol_socket_intval(struct mptcp_sock *msk, int optname, int val)
    {
    let mut optval: sockptr_t = KERNEL_SOCKPTR(&val);
    struct sock *sk = (struct sock *)msk;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mptcp_so_incoming_cpu(msk: *mut mptcp_sock, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_setsockopt_sol_socket_tstamp(msk: *mut mptcp_sock, optname: c_int, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SO_REUSEADDR: optname ==) -> else {
    else if (optname == SO_REUSEADDR)
    sk.sk_reuse = ssk.sk_reuse;
#[no_mangle]
pub unsafe extern "C" fn if(SO_BINDTODEVICE: optname ==) -> else {
    else if (optname == SO_BINDTODEVICE)
    sk.sk_bound_dev_if = ssk.sk_bound_dev_if;
#[no_mangle]
pub unsafe extern "C" fn if(SO_BINDTOIFINDEX: optname ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mptcp_supported_sockopt(level: c_int, optname: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __mptcp_setsockopt_sol_tcp_cork(msk: *mut mptcp_sock, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mptcp_setsockopt_sol_tcp_nodelay(msk: *mut mptcp_sock, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_diag_fill_info(msk: *mut mptcp_sock, info: *mut mptcp_info) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_getsockopt_info(msk: *mut mptcp_sock, optval: *mut char __user, optlen: *mut int __user) -> c_int {
...
// When used only to check if a fallback to TCP happened.
    ...
    int __user *optlen)
    {
    let mut copylen: u32 = min_t(u32, sfd.size_subflow_data, sizeof(*sfd));
    if (copied)
...
// size_subflow_data is u32, but len is signed
    ...
    struct mptcp_subflow_context *subflow;
    struct sock *sk = (struct sock *)msk;
    let mut sfcount: c_uint = 0, copied = 0;
...
#[no_mangle]
unsafe extern "C" fn mptcp_get_sub_addrs(sk: *const sock, a: *mut mptcp_subflow_addrs) {
    ...
    int __user *optlen)
    {
    let mut sfcount: c_uint = 0, copylen = 0;
    struct mptcp_subflow_context *subflow;
    struct sock *sk = (struct sock *)msk;
...
#[no_mangle]
unsafe extern "C" fn sync_socket_options(msk: *mut mptcp_sock, ssk: *mut sock) {
    static void sync_socket_options(struct mptcp_sock *msk, struct sock *ssk)
    {
    let mut tx_rx_locks: static unsigned int = SOCK_RCVBUF_LOCK | SOCK_SNDBUF_LOCK;
    struct sock *sk = (struct sock *)msk;
    bool keep_open;
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_sockopt_sync_locked(msk: *mut mptcp_sock, ssk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mptcp_set_rcvlowat(sk: *mut sock, val: c_int) -> c_int {
