...
#[no_mangle]
unsafe extern "C" fn mptcp_token_test_msk_basic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_token_test_accept(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_token_test_destroyed(test: *mut kunit) {
