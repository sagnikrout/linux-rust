...
// protects pernet updates
    ...
    pub next_id: u8,
    pub 1): DECLARE_BITMAP(id_bitmap, MPTCP_PM_MAX_ADDR_ID +,
}

pub const MPTCP_PM_ADDR_MAX: c_int = 8;
pub const MPTCP_PM_SUBFLOWS_MAX: c_int = 64;
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_get_endp_signal_max(msk: *const mptcp_sock) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_get_endp_subflow_max(msk: *const mptcp_sock) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_get_endp_laminar_max(msk: *const mptcp_sock) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_get_endp_fullmesh_max(msk: *const mptcp_sock) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_get_limit_add_addr_accepted(msk: *const mptcp_sock) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_get_limit_extra_subflows(msk: *const mptcp_sock) -> u8 {
...
//
    ...
    {
    let mut deny_id0: bool = READ_ONCE(msk.pm.remote_deny_join_id0);
    let mut remote: mptcp_addr_info = { 0 };
...
// addrs = remote;
    ...
    int addrs_size)
    {
    let mut limit_extra_subflows: u8 = mptcp_pm_get_limit_extra_subflows(msk);
    let mut deny_id0: bool = READ_ONCE(msk.pm.remote_deny_join_id0);
...
#[no_mangle]
unsafe extern "C" fn mptcp_mpc_endpoint_setup(msk: *mut mptcp_sock) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_pm_create_subflow_or_signal_addr(msk: *mut mptcp_sock) {
    static void mptcp_pm_create_subflow_or_signal_addr(struct mptcp_sock *msk)
    {
    let mut limit_extra_subflows: u8 = mptcp_pm_get_limit_extra_subflows(msk);
    struct pm_nl_pernet *pernet = pm_nl_get_pernet_from_msk(msk);
    let mut endp_subflow_max: u8 = mptcp_pm_get_endp_subflow_max(msk);
    let mut endp_signal_max: u8 = mptcp_pm_get_endp_signal_max(msk);
    struct sock *sk = (struct sock *)msk;
    let mut signal_and_subflow: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !select_local_address(pernet, _arg: msk, _arg: &local)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mptcp_pm_nl_fully_established(msk: *mut mptcp_sock) {
    static void mptcp_pm_nl_fully_established(struct mptcp_sock *msk)
    {
    mptcp_pm_create_subflow_or_signal_addr(msk);
    }
#[no_mangle]
unsafe extern "C" fn mptcp_pm_nl_subflow_established(msk: *mut mptcp_sock) {
...
//
    ...
    {
    let mut c_flag_case: bool = remote.id && mptcp_pm_add_addr_c_flag_case(msk);
...
#[no_mangle]
unsafe extern "C" fn mptcp_pm_nl_add_addr_received(msk: *mut mptcp_sock) {
    static void mptcp_pm_nl_add_addr_received(struct mptcp_sock *msk)
    {
    let mut limit_add_addr_accepted: u8 = mptcp_pm_get_limit_add_addr_accepted(msk);
    let mut limit_extra_subflows: u8 = mptcp_pm_get_limit_extra_subflows(msk);
    struct mptcp_pm_local locals[MPTCP_PM_ADDR_MAX];
    struct sock *sk = (struct sock *)msk;
    struct mptcp_addr_info remote;
    let mut sf_created: bool = false;
    int i, nr;
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_rm_addr(msk: *mut mptcp_sock, rm_id: u8) {
...
#[no_mangle]
unsafe extern "C" fn address_use_port(entry: *mut mptcp_pm_addr_entry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __mptcp_pm_release_addr_entry(entry: *mut mptcp_pm_addr_entry) {
    ...
    bool replace)
    {
    struct mptcp_pm_addr_entry *cur, *del_entry = core::ptr::null_mut();
...
// just replaced an existing entry, free it
    ...
    struct mptcp_pm_addr_entry *entry)
    {
    let mut is_ipv6: bool = entry.addr.family == AF_INET6;
    let mut addrlen: c_int = sizeof(struct sockaddr_in);
    struct sockaddr_storage addr;
    struct sock *newsk, *ssk;
    let mut backlog: c_int = 1024;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: ssk->sk_family ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_is_backup(msk: *mut mptcp_sock, skc: *mut mptcp_addr_info) -> bool {
    ...
    let mut s_slot: c_long = 0, s_num = 0;
    while ((msk = mptcp_token_iter_next(net, &s_slot, &s_num)) != core::ptr::null_mut()) {
    struct sock *sk = (struct sock *)msk;
    struct mptcp_addr_info mpc_addr;
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_add_addr_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mark_subflow_endp_available(msk: *mut mptcp_sock, id: u8) {
...
// If it was marked as used, and not ID 0, decrement local_addr_used
    ...
    let mut list: mptcp_rm_list = { .nr = 1 };
    let mut s_slot: c_long = 0, s_num = 0;
    struct mptcp_sock *msk;
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_del_addr_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// Reset counters: maybe some subflows have been removed before
    ...
    if (!mptcp_pm_is_userspace(msk)) {
    lock_sock(sk);
    mptcp_pm_flush_addrs_and_subflows(msk, rm_list, core::ptr::null_mut());
    release_sock(sk);
    }
    sock_put(sk);
    cond_resched();
...
// caller must ensure the RCU grace period is already elapsed
#[no_mangle]
unsafe extern "C" fn __flush_addrs(list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn __reset_counters(pernet: *mut pm_nl_pernet) {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_flush_addrs_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_limit(info: *mut genl_info, id: c_int, limit: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_set_limits_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_get_limits_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    u8 changed)
    {
    let mut is_subflow: u8 = !!(local.flags & MPTCP_PM_ADDR_FLAG_SUBFLOW);
    let mut bkup: u8 = !!(local.flags & MPTCP_PM_ADDR_FLAG_BACKUP);
    let mut s_slot: c_long = 0, s_num = 0;
    struct mptcp_sock *msk;
    ...
    mptcp_pm_mp_prio_send_ack(msk, &local.addr, core::ptr::null_mut(), bkup);
...
// local = *entry;
    ...
    let mut addr_max: u8 = pernet.endp_fullmesh_max;
    if (entry.flags & MPTCP_PM_ADDR_FLAG_FULLMESH)
    addr_max++;
    else
    addr_max--;
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_nl_check_work_pending(msk: *mut mptcp_sock) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn __mptcp_pm_kernel_worker(msk: *mut mptcp_sock) {
...
#[no_mangle]
unsafe extern "C" fn pm_nl_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn pm_nl_exit_net(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_pm_kernel_register() -> void __init {
