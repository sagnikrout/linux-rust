...
//
    ...
    struct mptcp_sock *msk = core::ptr::null_mut();
    struct sk_buff *rep;
...
pub struct mptcp_diag_ctx {
    ...
    &diag_ctx.s_num)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_diag_init() -> int __init {
    static int __init mptcp_diag_init(void)
    {
    return inet_diag_register(&mptcp_diag_handler);
    }
#[no_mangle]
unsafe extern "C" fn mptcp_diag_exit() -> void __exit {
