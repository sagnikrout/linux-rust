...
#[no_mangle]
unsafe extern "C" fn subflow_req_destructor(req: *mut request_sock) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_can_accept_new_subflow(msk: *const mptcp_sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn subflow_req_create_thmac(subflow_req: *mut mptcp_subflow_request_sock) {
...
#[no_mangle]
unsafe extern "C" fn subflow_init_req(req: *mut request_sock, sk_listener: *const sock) {
    ...
    subflow_req.msk = core::ptr::null_mut();
    mptcp_token_init_request(req);
    }
#[no_mangle]
unsafe extern "C" fn subflow_use_different_sport(msk: *mut mptcp_sock, sk: *const sock) -> bool {
    static bool subflow_use_different_sport(struct mptcp_sock *msk, const struct sock *sk)
    {
    return inet_sk(sk).inet_sport != inet_sk((struct sock *)msk).inet_sport;
    }
#[no_mangle]
unsafe extern "C" fn subflow_add_reset_reason(skb: *mut sk_buff, reason: u8) {
...
#[no_mangle]
unsafe extern "C" fn subflow_reset_req_endp(req: *mut request_sock, skb: *mut sk_buff) -> c_int {
...
//
    ...
    subflow_req.mp_capable = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0: retries-- >) -> else {
    else if (retries-- > 0)
    goto again;
    else
    SUBFLOW_REQ_INC_STATS(req, MPTCP_MIB_TOKENFALLBACKINIT);
...
#[no_mangle]
unsafe extern "C" fn mptcp_get_rst_reason(skb: *const sk_buff) -> enum sk_rst_reason {
...
#[no_mangle]
unsafe extern "C" fn subflow_thmac_valid(subflow: *mut mptcp_subflow_context) -> bool {
    ...
    let mut thmac: return = = subflow.thmac;
    }
#[no_mangle]
pub unsafe extern "C" fn mptcp_subflow_reset(ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn subflow_use_different_dport(msk: *mut mptcp_sock, sk: *const sock) -> bool {
    static bool subflow_use_different_dport(struct mptcp_sock *msk, const struct sock *sk)
    {
    return inet_sk(sk).inet_dport != inet_sk((struct sock *)msk).inet_dport;
    }
#[no_mangle]
pub unsafe extern "C" fn __mptcp_sync_state(sk: *mut sock, state: c_int) {
...
//
    ...
    mptcp_crypto_key_sha(subflow.remote_key, core::ptr::null_mut(), &subflow.iasn);
    subflow.iasn++;
// for fallback's sake
...
#[no_mangle]
unsafe extern "C" fn subflow_finish_connect(sk: *mut sock, skb: *const sk_buff) {
...
// It looks like MPTCP is blocked, while TCP is not
    ...
    fallback:
    mptcp_propagate_state(parent, sk, subflow, core::ptr::null_mut());
    }
    return;
    do_reset:
...
#[no_mangle]
unsafe extern "C" fn subflow_set_local_id(subflow: *mut mptcp_subflow_context, local_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn subflow_chk_local_id(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subflow_rebuild_header(sk: *mut sock) -> c_int {
    static int subflow_rebuild_header(struct sock *sk)
    {
    let mut err: c_int = subflow_chk_local_id(sk);
    if (unlikely(err < 0))
    return err;
...
#[no_mangle]
unsafe extern "C" fn subflow_v6_rebuild_header(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subflow_v4_conn_request(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subflow_v4_req_destructor(req: *mut request_sock) {
...
#[no_mangle]
unsafe extern "C" fn subflow_v6_conn_request(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    __IP6_INC_STATS(sock_net(sk), core::ptr::null_mut(), IPSTATS_MIB_INHDRERRORS);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn subflow_v6_req_destructor(req: *mut request_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: ops->family ==) -> else {
...
// validate hmac received in third ACK
    ...
    rcu_assign_pointer(icsk.icsk_ulp_data, core::ptr::null_mut());
    tcp_sk(sk).is_mptcp = 0;
    mptcp_subflow_ops_undo_override(sk);
    }
#[no_mangle]
pub unsafe extern "C" fn mptcp_subflow_drop_ctx(ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn dbg_bad_map(subflow: *mut mptcp_subflow_context, ssn: u32) {
...
#[no_mangle]
unsafe extern "C" fn skb_is_fully_mapped(ssk: *mut sock, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn validate_mapping(ssk: *mut sock, skb: *mut sk_buff) -> bool {
    static bool validate_mapping(struct sock *ssk, struct sk_buff *skb)
    {
    struct mptcp_subflow_context *subflow = mptcp_subflow_ctx(ssk);
    let mut ssn: u32 = tcp_sk(ssk).copied_seq - subflow.ssn_offset;
...
//
    ...
    {
    struct mptcp_subflow_context *subflow = mptcp_subflow_ctx(ssk);
    let mut csum_reqd: bool = READ_ONCE(msk.csum_enabled);
...
//
    ...
    {
    struct mptcp_subflow_context *subflow = mptcp_subflow_ctx(ssk);
    let mut fin: bool = TCP_SKB_CB(skb).tcp_flags & TCPHDR_FIN;
...
#[no_mangle]
unsafe extern "C" fn subflow_is_done(sk: *const sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn subflow_sched_work_if_closed(msk: *mut mptcp_sock, ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_subflow_fail(msk: *mut mptcp_sock, ssk: *mut sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn subflow_check_data_avail(ssk: *mut sock) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_subflow_data_available(sk: *mut sock) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mptcp_space(ssk: *const sock, space: *mut c_int, full_space: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn subflow_error_report(ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn subflow_data_ready(sk: *mut sock) {
    static void subflow_data_ready(struct sock *sk)
    {
    struct mptcp_subflow_context *subflow = mptcp_subflow_ctx(sk);
    let mut state: u16 = 1 << inet_sk_state_load(sk);
    struct sock *parent = subflow.conn;
    struct mptcp_sock *msk;
...
#[no_mangle]
unsafe extern "C" fn subflow_write_space(ssk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn mptcpv6_handle_mapped(sk: *mut sock, mapped: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ipv6_addr_v4mapped(&info->addr6)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: addr->ss_family ==) -> else {
    ...
    struct mptcp_sock *msk = mptcp_sk(sk);
    struct mptcp_subflow_context *subflow;
    let mut local_id: c_int = local.addr.id;
    struct sockaddr_storage addr;
    let mut remote_id: c_int = remote.id;
...
// if 'IPADDRANY', the ID will be set later, after the routing
    ...
    mptcp_crypto_key_sha(subflow.remote_key, &remote_token, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn __mptcp_inherit_memcg(sk: *mut sock, ssk: *mut sock, gfp: gfp_t) {
...
#[no_mangle]
pub unsafe extern "C" fn __mptcp_inherit_cgrp_data(sk: *mut sock, ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_attach_cgroup(parent: *mut sock, child: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_subflow_ops_override(ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn mptcp_subflow_ops_undo_override(ssk: *mut sock) {
    static void mptcp_subflow_ops_undo_override(struct sock *ssk)
    {
...
#[no_mangle]
unsafe extern "C" fn __subflow_state_change(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn subflow_state_change(sk: *mut sock) {
...
//
    ...
    mptcp_data_ready(parent, sk);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unlikely(sk->sk_err)) -> else {
    else if (unlikely(sk.sk_err))
    subflow_error_report(sk);
    subflow_sched_work_if_closed(mptcp_sk(parent), sk);
    }
#[no_mangle]
pub unsafe extern "C" fn mptcp_subflow_queue_clean(listener_sk: *mut sock, listener_ssk: *mut sock) {
...
//
    ...
    queue.rskq_accept_head = core::ptr::null_mut();
    queue.rskq_accept_tail = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn subflow_ulp_init(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subflow_ulp_release(ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn tcp_release_cb_override(ssk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn tcp_abort_override(ssk: *mut sock, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subflow_ops_init(subflow_ops: *mut request_sock_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_subflow_init() -> void __init {
...
// Disable sockmap processing for subflows
    tcp_prot_override.psock_update_sk_prot = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mptcp_subflow_v6_init() -> void __init {
...
// Disable sockmap processing for subflows
    tcpv6_prot_override.psock_update_sk_prot = core::ptr::null_mut();
