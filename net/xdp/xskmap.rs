...
#[no_mangle]
unsafe extern "C" fn xsk_map_node_free(node: *mut xsk_map_node) {
...
#[no_mangle]
unsafe extern "C" fn xsk_map_sock_add(xs: *mut xdp_sock, node: *mut xsk_map_node) {
...
#[no_mangle]
unsafe extern "C" fn xsk_map_mem_usage(map: *const bpf_map) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn xsk_map_free(map: *mut bpf_map) {
...
#[no_mangle]
unsafe extern "C" fn xsk_map_get_next_key(map: *mut bpf_map, key: *mut c_void, next_key: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xsk_map_gen_lookup(map: *mut bpf_map, insn_buf: *mut bpf_insn) -> c_int {
    static int xsk_map_gen_lookup(struct bpf_map *map, struct bpf_insn *insn_buf)
    {
    let mut ret: c_int = BPF_REG_0, mp = BPF_REG_1, index = BPF_REG_2;
...
//
    ...
    let mut i: u32 = *(u32 *)key, fd = *(u32 *)value;
    struct xsk_map_node *node;
    struct socket *sock;
    int err;
...
#[no_mangle]
unsafe extern "C" fn xsk_map_delete_elem(map: *mut bpf_map, key: *mut c_void) -> c_long {
    ...
    old_xs = unrcu_pointer(xchg(map_entry, core::ptr::null_mut()));
    if (old_xs)
    xsk_map_sock_delete(old_xs, map_entry);
    spin_unlock_bh(&m.lock);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn xsk_map_redirect(map: *mut bpf_map, index: u64, flags: u64) -> c_long {
    ...
    rcu_assign_pointer(*map_entry, core::ptr::null_mut());
