...
pub const NET_SHAPER_SCOPE_SHIFT: c_int = 26;
...
#[no_mangle]
unsafe extern "C" fn net_shaper_list_len(info: *mut genl_info, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_shaper_handle_size() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_shaper_group_reply_size() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_shaper_ctx_cleanup(ctx: *mut net_shaper_nl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn net_shaper_ctx_cleanup_unlock(ctx: *mut net_shaper_nl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn net_shaper_handle_to_index(handle: *const net_shaper_handle) -> u32 {
    ...
    const struct net_shaper_handle *handle)
    {
    let mut index: u32 = net_shaper_handle_to_index(handle);
...
//
    ...
    let mut id_allocated: bool = false;
    int ret, index;
    if (!hierarchy)
    return -ENOMEM;
...
// Allocated a new id, if needed.
    ...
    ret = xa_alloc(&hierarchy.shapers, &index, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn net_shaper_rollback(binding: *mut net_shaper_binding) {
...
//
    ...
    struct nlattr *bad = core::ptr::null_mut();
...
// The shaper handle is the only mandatory attribute.
    if (NL_REQ_ATTR_CHECK(info.extack, core::ptr::null_mut(), tb, NET_SHAPER_A_HANDLE))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn net_shaper_generic_pre(info: *mut genl_info, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_shaper_generic_post(info: *mut genl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_pre_dumpit(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_post_dumpit(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_cap_pre_dumpit(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_cap_post_dumpit(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// Reject duplicates
    ...
    struct netlink_ext_ack *extack)
    {
    let mut parent: net_shaper_handle = leaves[0].parent;
    int i;
    ...
    struct net_shaper *parent = core::ptr::null_mut();
    let mut new_node: bool = false;
    int i, ret;
    if (node.handle.scope == NET_SHAPER_SCOPE_NODE) {
    struct net_shaper *cur = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_delete_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_group_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    let mut old_nodes_count: c_int = 0;
    struct sk_buff *msg;
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_nl_cap_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn net_shaper_flush(binding: *mut net_shaper_binding) {
...
#[no_mangle]
pub unsafe extern "C" fn net_shaper_flush_netdev(dev: *mut net_device) {
...
// The recursion on parent does the full job.
    ...
    shaper = net_shaper_lookup(&binding, &parent_handle);
    if (shaper && !--shaper.leaves)
    __net_shaper_delete(&binding, shaper, core::ptr::null_mut());
    }
    }
#[no_mangle]
unsafe extern "C" fn shaper_init() -> int __init {
