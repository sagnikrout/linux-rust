...
#[no_mangle]
unsafe extern "C" fn report_csk_error(csk: *mut sock, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn kcm_rcv_ready(kcm: *mut kcm_sock) {
...
//
    ...
    psock.ready_rx_msg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn kcm_rfree(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn kcm_queue_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int kcm_queue_rcv_skb(struct sock *sk, struct sk_buff *skb)
    {
...
//
#[no_mangle]
unsafe extern "C" fn requeue_rx_msgs(mux: *mut kcm_mux, head: *mut sk_buff_head) {
...
#[no_mangle]
unsafe extern "C" fn kcm_done_work(w: *mut work_struct) {
...
// Lower sock held
    ...
    return;
    spin_lock_bh(&mux.rx_lock);
    psock.rx_kcm = core::ptr::null_mut();
// paired with lockless reads in kcm_rfree()
    WRITE_ONCE(kcm.rx_psock, core::ptr::null_mut());
...
// Lower sock lock held
#[no_mangle]
unsafe extern "C" fn psock_data_ready(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn kcm_rcv_strparser(strp: *mut strparser, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn kcm_parse_func_strparser(strp: *mut strparser, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcm_read_sock_done(strp: *mut strparser, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psock_state_change(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn psock_write_space(sk: *mut sock) {
...
// mux lock held
#[no_mangle]
unsafe extern "C" fn psock_now_avail(psock: *mut kcm_psock) {
...
// kcm sock is locked.
#[no_mangle]
unsafe extern "C" fn unreserve_psock(kcm: *mut kcm_sock) {
    static void unreserve_psock(struct kcm_sock *kcm)
    {
    struct kcm_psock *psock;
    struct kcm_mux *mux = kcm.mux;
    ...
    WARN_ON(kcm.tx_wait);
    kcm.tx_psock = core::ptr::null_mut();
    psock.tx_kcm = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn kcm_report_tx_retry(kcm: *mut kcm_sock) {
...
//
#[no_mangle]
unsafe extern "C" fn kcm_write_msgs(kcm: *mut kcm_sock) -> c_int {
    static int kcm_write_msgs(struct kcm_sock *kcm)
    {
    let mut total_sent: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn kcm_tx_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn kcm_push(kcm: *mut kcm_sock) {
...
#[no_mangle]
unsafe extern "C" fn kcm_sendmsg(sock: *mut socket, msg: *mut msghdr, len: usize) -> c_int {
    static int kcm_sendmsg(struct socket *sock, struct msghdr *msg, size_t len)
    {
    struct sock *sk = sock.sk;
    struct kcm_sock *kcm = kcm_sk(sk);
    struct sk_buff *skb = core::ptr::null_mut(), *head = core::ptr::null_mut(), *frag_prev = core::ptr::null_mut();
    size_t copy, copied = 0;
    let mut timeo: c_long = sock_sndtimeo(sk, msg.msg_flags & MSG_DONTWAIT);
    int eor = (sock.type == SOCK_DGRAM) ?
    !(msg.msg_flags & MSG_MORE) : !!(msg.msg_flags & MSG_EOR);
    let mut err: c_int = -EPIPE;
...
// Update the skb.
    ...
    if (eor) {
    let mut not_busy: bool = skb_queue_empty(&sk.sk_write_queue);
    if (head) {
// Message complete, queue it on send buffer
    __skb_queue_tail(&sk.sk_write_queue, head);
    kcm.seq_skb = core::ptr::null_mut();
...
//
    ...
    if (head == frag_prev)
    skb_shinfo(head).frag_list = core::ptr::null_mut();
    else
    frag_prev.next = core::ptr::null_mut();
    kfree_skb(skb);
...
#[no_mangle]
unsafe extern "C" fn kcm_splice_eof(sock: *mut socket) {
...
// kcm sock lock held
#[no_mangle]
unsafe extern "C" fn kcm_recv_disable(kcm: *mut kcm_sock) {
...
// kcm sock lock held
#[no_mangle]
unsafe extern "C" fn kcm_recv_enable(kcm: *mut kcm_sock) {
...
#[no_mangle]
unsafe extern "C" fn init_kcm_sock(kcm: *mut kcm_sock, mux: *mut kcm_mux) {
...
// Add to mux's kcm sockets list
    ...
    struct kcm_mux *mux = kcm.mux;
    struct sock *csk;
    struct kcm_psock *psock = core::ptr::null_mut(), *tpsock;
    struct list_head *head;
    let mut index: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn kcm_attach_ioctl(sock: *mut socket, info: *mut kcm_attach) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcm_unattach(psock: *mut kcm_psock) {
...
//
    write_lock_bh(&csk.sk_callback_lock);
    csk.sk_user_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn kcm_unattach_ioctl(sock: *mut socket, info: *mut kcm_unattach) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcm_ioctl(sock: *mut socket, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_mux(mux: *mut kcm_mux) {
...
#[no_mangle]
unsafe extern "C" fn kcm_done(kcm: *mut kcm_sock) {
    static void kcm_done(struct kcm_sock *kcm)
    {
    struct kcm_mux *mux = kcm.mux;
    struct sock *sk = &kcm.sk;
...
//
#[no_mangle]
unsafe extern "C" fn kcm_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcm_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn kcm_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn kcm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kcm_exit() -> void __exit {
