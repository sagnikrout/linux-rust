...
pub const P9_RDMA_SEND_SGE: c_int = 4;
pub const P9_RDMA_RECV_SGE: c_int = 4;
pub const P9_RDMA_IRD: c_int = 0;
pub const P9_RDMA_ORD: c_int = 0;
...
pub struct p9_trans_rdma {
    ...
    pub excess_rc: core::sync::atomic::AtomicI32,
...
#[no_mangle]
unsafe extern "C" fn p9_rdma_show_options(m: *mut seq_file, clnt: *mut p9_client) -> c_int {
    ...
    err = p9_parse_header(&c.rc, core::ptr::null_mut(), core::ptr::null_mut(), &tag, 1);
    if (err)
    goto err_out;
...
#[no_mangle]
unsafe extern "C" fn rdma_destroy_trans(rdma: *mut p9_trans_rdma) {
    ...
    wr.sg_list = &sge;
    wr.num_sge = 1;
    ret = ib_post_recv(rdma.qp, &wr, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn rdma_request(client: *mut p9_client, req: *mut p9_req_t) -> c_int {
    ...
    let mut err: c_int = 0;
    unsigned long flags;
    struct p9_rdma_context *c = core::ptr::null_mut();
    struct p9_rdma_context *rpl_context = core::ptr::null_mut();
...
//
    ...
    err = ib_post_send(rdma.qp, &wr, core::ptr::null_mut());
    if (err)
    goto dma_unmap;
// Success
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rdma_close(client: *mut p9_client) {
...
#[no_mangle]
unsafe extern "C" fn rdma_cancel(client: *mut p9_client, req: *mut p9_req_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rdma_cancelled(client: *mut p9_client, req: *mut p9_req_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p9_rdma_bind_privport(rdma: *mut p9_trans_rdma) -> c_int {
...
//
    ...
    let mut opts: p9_rdma_opts = ctx.rdma_opts;
    int err;
    struct p9_trans_rdma *rdma;
...
// Resolve the server's address
    ...
    err = rdma_resolve_addr(rdma.cm_id, core::ptr::null_mut(),
...
// Request a connection
    ...
    conn_param.private_data = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn p9_trans_rdma_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn p9_trans_rdma_exit() -> void __exit {
