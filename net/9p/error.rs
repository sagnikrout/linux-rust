...
pub const ERRHASH_BITS: c_int = 5;
...
//
#[no_mangle]
pub unsafe extern "C" fn p9_error_init() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn p9_errstr2errno(errstr: *mut c_char, len: c_int) -> c_int {
