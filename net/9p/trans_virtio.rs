...
pub const VIRTQUEUE_NUM: c_int = 128;
// a single mutex to manage channel initialization and attachment
    static DEFINE_MUTEX(virtio_9p_lock);
    static DECLARE_WAIT_QUEUE_HEAD(vp_wq);
    let mut vp_pinned: static atomic_t = ATOMIC_INIT(0);
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_chan {
    pub inuse: bool,
    pub lock: spinlock_t,
    pub client: *mut p9_client,
    pub vdev: *mut virtio_device,
    pub vq: *mut virtqueue,
    pub ring_bufs_avail: c_int,
    pub vc_wq: *mut wait_queue_head_t,
// This is global limit. Since we don't have a global structure,
// will be placing it in each channel.
//
    pub p9_max_pages: c_ulong,
// Scatterlist: can be too big for stack.
    pub sg: [scatterlist; VIRTQUEUE_NUM],
//
...
#[no_mangle]
unsafe extern "C" fn rest_of_page(data: *mut c_void) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn p9_virtio_close(client: *mut p9_client) {
...
unsafe extern "C" fn req_done(vq: *mut virtqueue) {
    ...
    while ((req = virtqueue_get_buf(chan.vq, &len)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn p9_virtio_cancel(client: *mut p9_client, req: *mut p9_req_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p9_virtio_cancelled(client: *mut p9_client, req: *mut p9_req_t) -> c_int {
...
//
    ...
    unsigned long flags;
    let mut in_nr_pages: c_int = 0, out_nr_pages = 0;
    struct page **in_pages = core::ptr::null_mut(), **out_pages = core::ptr::null_mut();
    struct virtio_chan *chan = client.trans;
    struct scatterlist *sgs[4];
    let mut offs: usize = 0;
    let mut need_drop: c_int = 0;
    let mut kicked: c_int = 0;
    ...
    if (n != outlen) {
    let mut v: __le32 = cpu_to_le32(n);
...
// reply won't come
    ...
    static DEVICE_ATTR(mount_tag, 0444, p9_mount_tag_show, core::ptr::null_mut());
//
...
//
#[no_mangle]
unsafe extern "C" fn p9_virtio_probe(vdev: *mut virtio_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn p9_virtio_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn p9_virtio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn p9_virtio_cleanup() -> void __exit {
