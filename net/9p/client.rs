...
//
#[no_mangle]
pub unsafe extern "C" fn p9_is_proto_dotl(clnt: *mut p9_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_is_proto_dotu(clnt: *mut p9_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_show_client_options(m: *mut seq_file, clnt: *mut p9_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn safe_errno(err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apply_client_options(clnt: *mut p9_client, fc: *mut fs_context) -> c_int {
    ...
    ctx.client_opts.trans_mod = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn p9_fcall_fini(fc: *mut p9_fcall) {
...
//
#[no_mangle]
unsafe extern "C" fn p9_tag_remove(c: *mut p9_client, r: *mut p9_req_t) {
    static void p9_tag_remove(struct p9_client *c, struct p9_req_t *r)
    {
    unsigned long flags;
    let mut tag: u16 = r.tc.tag;
...
#[no_mangle]
pub unsafe extern "C" fn p9_req_put(c: *mut p9_client, r: *mut p9_req_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn p9_tag_cleanup(c: *mut p9_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn p9_client_cb(c: *mut p9_client, req: *mut p9_req_t, status: c_int) {
...
//
    ...
    s16 r_tag;
    s32 r_size;
    let mut offset: c_int = pdu.offset;
    int err;
    pdu.offset = 0;
...
//
#[no_mangle]
unsafe extern "C" fn p9_check_errors(c: *mut p9_client, req: *mut p9_req_t) -> c_int {
    static int p9_check_errors(struct p9_client *c, struct p9_req_t *req)
    {
    s8 type;
    int err;
    int ecode;
    err = p9_parse_header(&req.rc, core::ptr::null_mut(), &type, core::ptr::null_mut(), 0);
...
//
#[no_mangle]
unsafe extern "C" fn p9_client_flush(c: *mut p9_client, oldreq: *mut p9_req_t) -> c_int {
    static int p9_client_flush(struct p9_client *c, struct p9_req_t *oldreq)
    {
    struct p9_req_t *req;
    s16 oldtag;
    int err;
    err = p9_parse_header(&oldreq.tc, core::ptr::null_mut(), core::ptr::null_mut(), &oldtag, 1);
    if (err)
    return err;
...
//
    ...
    let mut rsize: c_uint = c.trans_mod.pooled_rbuffers ? c.msize : 0;
    va_start(ap, fmt);
...
#[no_mangle]
unsafe extern "C" fn p9_fid_destroy(fid: *mut p9_fid) {
...
#[no_mangle]
pub unsafe extern "C" fn do_trace_9p_fid_get(fid: *mut p9_fid) {
...
#[no_mangle]
pub unsafe extern "C" fn do_trace_9p_fid_put(fid: *mut p9_fid) {
...
#[no_mangle]
unsafe extern "C" fn p9_client_version(c: *mut p9_client) -> c_int {
    static int p9_client_version(struct p9_client *c)
    {
    int err;
    struct p9_req_t *req;
    char *version = core::ptr::null_mut();
    int msize;
    ...
    if (!clnt)
    return ERR_PTR(-ENOMEM);
    clnt.trans_mod = core::ptr::null_mut();
    clnt.trans = core::ptr::null_mut();
    clnt.fcall_cache = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_destroy(clnt: *mut p9_client) {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_disconnect(clnt: *mut p9_client) {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_begin_disconnect(clnt: *mut p9_client) {
    ...
    oldfid.fid, fid.fid, nwname, wnames ? wnames[0] : core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_open(fid: *mut p9_fid, mode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_link(dfid: *mut p9_fid, oldfid: *mut p9_fid, newname: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_fsync(fid: *mut p9_fid, datasync: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_clunk(fid: *mut p9_fid) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_remove(fid: *mut p9_fid) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_unlinkat(dfid: *mut p9_fid, name: *const c_char, flags: c_int) -> c_int {
...
// err = 0;
    ...
    struct p9_req_t *req;
    let mut count: c_int = iov_iter_count(to);
    u32 rsize, received;
    let mut non_zc: bool = false;
    char *dataptr;
// err = 0;
...
//
    req = p9_client_zc_rpc(clnt, P9_TREAD, to, core::ptr::null_mut(), rsize,
    0, 11, "dqd", fid.fid,
    offset, rsize);
    } else {
    non_zc = true;
...
// err = -EIO;
    ...
    if (non_zc) {
    let mut n: c_int = copy_to_iter(dataptr, received, to);
    if (n != received) {
// err = -EFAULT;
    p9_req_put(clnt, req);
    return n;
...
// Don't bother zerocopy for small IO (< 1024)
    if (clnt.trans_mod.zc_request && rsize > 1024) {
    req = p9_client_zc_rpc(clnt, P9_TWRITE, core::ptr::null_mut(), from, 0,
...
// err = -EIO;
    ...
    struct p9_client *clnt = fid.clnt;
    struct p9_req_t *req;
    let mut start: c_ulonglong = subreq.start + subreq.transferred;
...
// Don't bother zerocopy for small IO (< 1024)
    ...
    req = p9_client_zc_rpc(clnt, P9_TWRITE, core::ptr::null_mut(), &subreq.io_iter,
...
#[no_mangle]
unsafe extern "C" fn p9_client_statsize(wst: *mut p9_wstat, proto_version: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_wstat(fid: *mut p9_fid, wst: *mut p9_wstat) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_setattr(fid: *mut p9_fid, p9attr: *mut p9_iattr_dotl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_statfs(fid: *mut p9_fid, sb: *mut p9_rstatfs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_readdir(fid: *mut p9_fid, data: *mut c_char, count: u32, offset: u64) -> c_int {
    ...
    struct p9_req_t *req;
    char *dataptr;
    let mut kv: kvec = {.iov_base = data, .iov_len = count};
    struct iov_iter to;
...
// PDU Header(7) + IO Size (4)
//
    req = p9_client_zc_rpc(clnt, P9_TREADDIR, &to, core::ptr::null_mut(), rsize, 0,
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_lock_dotl(fid: *mut p9_fid, flock: *mut p9_flock, status: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_getlock_dotl(fid: *mut p9_fid, glock: *mut p9_getlock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_readlink(fid: *mut p9_fid, target: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn p9_client_exit() -> void __exit {
