...
// SPDX-License-Identifier: GPL-2.0-only
    ...
    {
    struct psp_dev *psd = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn psp_dev_tx_key_del(psd: *mut psp_dev, pas: *mut psp_assoc) {
...
#[no_mangle]
unsafe extern "C" fn psp_assoc_free(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn psp_assoc_free_queue(head: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psp_assoc_put(pas: *mut psp_assoc) {
...
#[no_mangle]
pub unsafe extern "C" fn psp_sk_assoc_free(sk: *mut sock) {
    void psp_sk_assoc_free(struct sock *sk)
    {
    struct psp_assoc *pas = rcu_dereference_protected(sk.psp_assoc, 1);
    rcu_assign_pointer(sk.psp_assoc, core::ptr::null_mut());
    psp_assoc_put(pas);
    }
...
#[no_mangle]
unsafe extern "C" fn psp_sock_recv_queue_check(sk: *mut sock, pas: *mut psp_assoc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_assocs_key_rotated(psd: *mut psp_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn psp_twsk_init(tw: *mut inet_timewait_sock, sk: *const sock) {
...
#[no_mangle]
pub unsafe extern "C" fn psp_twsk_assoc_free(tw: *mut inet_timewait_sock) {
    void psp_twsk_assoc_free(struct inet_timewait_sock *tw)
    {
    struct psp_assoc *pas = rcu_dereference_protected(tw.psp_assoc, 1);
    rcu_assign_pointer(tw.psp_assoc, core::ptr::null_mut());
    psp_assoc_put(pas);
    }
#[no_mangle]
pub unsafe extern "C" fn psp_reply_set_decrypted(sk: *const sock, skb: *mut sk_buff) {
