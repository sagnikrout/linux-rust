...
#[no_mangle]
unsafe extern "C" fn psp_nl_reply_send(rsp: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_has_assoc_dev_in_ns(psd: *mut psp_dev, net: *mut net) -> bool {
...
// Primary device - dump assoc list
    err = psp_nl_fill_assoc_dev_list(psd, rsp, cur_net, core::ptr::null_mut());
    if (err)
    goto err_cancel_msg;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_notify_dev(psd: *mut psp_dev, cmd: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_dev_get_doit(req: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_dev_get_dumpit(rsp: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_dev_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_key_rotate_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_dev_assoc_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// Check if device is already associated with a PSP device
    if (unrcu_pointer(cmpxchg(&assoc_dev.psp_dev, core::ptr::null_mut(),
    RCU_INITIALIZER(psd)))) {
    NL_SET_ERR_MSG(info.extack,
...
//
    ...
    return psp_nl_reply_send(rsp, info);
    err_clean_ptr:
    rcu_assign_pointer(assoc_dev.psp_dev, core::ptr::null_mut());
    err_put_dev:
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_dev_disassoc_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    int psp_nl_dev_disassoc_doit(struct sk_buff *skb, struct genl_info *info)
    {
    struct psp_assoc_dev *entry, *found = core::ptr::null_mut();
    struct psp_dev *psd = info.user_ptr[0];
    struct sk_buff *rsp;
    u32 assoc_ifindex;
    struct net *net;
...
// Remove from the association list
    ...
    psd.assoc_dev_cnt--;
    rcu_assign_pointer(found.assoc_dev.psp_dev, core::ptr::null_mut());
...
//
    ...
    {
    let mut key_sz: c_int = psp_key_size(version);
    void *nest;
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_rx_assoc_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_tx_assoc_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    const struct genl_info *info)
    {
    let mut required_cnt: c_uint = sizeof(struct psp_dev_stats) / sizeof(u64);
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_get_stats_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psp_nl_get_stats_dumpit(rsp: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
