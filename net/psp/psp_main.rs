...
//
#[no_mangle]
pub unsafe extern "C" fn psp_dev_check_access(psd: *mut psp_dev, net: *mut net, admin: bool) -> c_int {
...
//
    xa_store(&psp_devs, psd.id, core::ptr::null_mut(), GFP_KERNEL);
    mutex_unlock(&psp_devs_lock);
    ...
    rcu_assign_pointer(entry.assoc_dev.psp_dev, core::ptr::null_mut());
    netdev_put(entry.assoc_dev, &entry.dev_tracker);
    kfree(entry);
    }
    psd.assoc_dev_cnt = 0;
    rcu_assign_pointer(psd.main_netdev.psp_dev, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn psp_key_size(version: u32) -> c_uint {
...
//
    ...
    u8 ver, __be16 sport)
    {
    let mut network_len: u32 = skb_network_header_len(skb);
    let mut ethr_len: u32 = skb_mac_header_len(skb);
    let mut bufflen: u32 = ethr_len + network_len;
...
//
#[no_mangle]
pub unsafe extern "C" fn psp_dev_rcv(skb: *mut sk_buff, dev_id: u16, generation: u8, strip_icv: bool) -> c_int {
    int psp_dev_rcv(struct sk_buff *skb, u16 dev_id, u8 generation, bool strip_icv)
    {
    let mut l2_hlen: c_int = 0, l3_hlen, encap, psp_hlen;
...
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_IPV6): proto ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn psp_dev_disassoc_one(psd: *mut psp_dev, dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psp_attach_netdev_notifier() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psp_init() -> int __init {
