...
//! Source: net/netfilter/nf_conntrack_irc.c
#![no_std]
...
//
    ...
    let mut max_dcc_channels: static unsigned int = 8;
    let mut __read_mostly: static unsigned int dcc_timeout = 300;
...
pub const MAX_SEARCH_SIZE: c_int = 4095;
...
// dcc_ip can be the internal OR external (NAT'ed) IP
    ...
    tuple.src.l3num,
    core::ptr::null_mut(), &tuple.dst.u3,
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_irc_init() -> int __init {
    ...
    &irc_exp_policy,
    0, help, core::ptr::null_mut(), THIS_MODULE);
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_irc_fini() -> void __exit {
