...
//! Source: net/netfilter/nf_log_syslog.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nf_log_allowed(net: *const net) -> bool {
    static bool nf_log_allowed(const struct net *net)
    {
    return net_eq(net, &init_net) || sysctl_nf_log_all_netns;
    }
#[no_mangle]
unsafe extern "C" fn nf_log_dump_vlan(m: *mut nf_log_buf, skb: *const sk_buff) {
...
// Max length: 11 "URGP=65535 "
    ...
    let mut optsize: c_uint = th.doff * 4 - sizeof(struct tcphdr);
...
#[no_mangle]
unsafe extern "C" fn nf_log_syslog_net_init(net: *mut net) -> int __net_init {
    static int __net_init nf_log_syslog_net_init(struct net *net)
    {
    let mut ret: c_int = nf_log_set(net, NFPROTO_IPV4, &nf_ip_logger);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn nf_log_syslog_net_pre_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn nf_log_syslog_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nf_log_syslog_exit() -> void __exit {
