...
//! Source: net/netfilter/xt_recent.c
#![no_std]
...
//
    ...
    let mut __read_mostly: static unsigned int ip_list_tot = 100;
    static unsigned int ip_list_hash_size __read_mostly;
    let mut __read_mostly: static unsigned int ip_list_perms = 0644;
...
pub const XT_RECENT_MAX_NSTAMPS: c_int = 65536;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct recent_table {
    ...
    pub mask: union nf_inet_addr,
    pub refcnt: c_uint,
    pub entries: c_uint,
    pub nstamps_max_mask: u_int16_t,
    pub lru_list: list_head,
    pub iphash: [list_head; ],
}
...
#[no_mangle]
pub unsafe extern "C" fn recent_entry_hash4(addr: *const union nf_inet_addr) -> c_uint {
    static inline unsigned int recent_entry_hash4(const union nf_inet_addr *addr)
    {
    return jhash_1word(( u32)addr.ip, hash_rnd) &
    (ip_list_hash_size - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn recent_entry_hash6(addr: *const union nf_inet_addr) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn recent_entry_remove(t: *mut recent_table, e: *mut recent_entry) {
...
//
    ...
    {
    struct recent_entry *e;
    let mut nstamps_max: c_uint = t.nstamps_max_mask;
...
#[no_mangle]
unsafe extern "C" fn recent_entry_update(t: *mut recent_table, e: *mut recent_entry) {
...
#[no_mangle]
unsafe extern "C" fn recent_table_flush(t: *mut recent_table) {
    ...
    struct recent_table *t;
    struct recent_entry *e;
    let mut addr: union nf_inet_addr = {}, addr_mask;
    u_int8_t ttl;
...
// use TTL as seen before forwarding
    if (xt_out(par) != core::ptr::null_mut() &&
    ...
    ret = !ret;
#[no_mangle]
pub unsafe extern "C" fn if(XT_RECENT_REMOVE: info->check_set &) -> else {
    recent_entry_remove(t, e);
    ret = !ret;
    } else if (info.check_set & (XT_RECENT_CHECK | XT_RECENT_UPDATE)) {
    let mut time: c_ulong = jiffies - info.seconds * HZ;
...
#[no_mangle]
unsafe extern "C" fn recent_table_free(addr: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: info->hit_count) -> else {
...
#[no_mangle]
unsafe extern "C" fn recent_mt_check_v0(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn recent_mt_check_v1(par: *const xt_mtchk_param) -> c_int {
    static int recent_mt_check_v1(const struct xt_mtchk_param *par)
    {
    return recent_mt_check(par, par.matchinfo);
    }
#[no_mangle]
unsafe extern "C" fn recent_mt_destroy(par: *const xt_mtdtor_param) {
    ...
    if (recent_net.xt_recent != core::ptr::null_mut())
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct recent_iter_state {
    pub table: *const recent_table,
    pub bucket: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn recent_seq_stop(s: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn recent_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn recent_seq_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    const char *c = buf;
    let mut addr: union nf_inet_addr = {};
    u_int16_t family;
    bool add, succ;
    if (size == 0)
    return 0;
...
// Strict protocol!
    ...
    ++c;
    --size;
    if (strnchr(c, size, ':') != core::ptr::null_mut()) {
    family = NFPROTO_IPV6;
...
#[no_mangle]
unsafe extern "C" fn recent_proc_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn recent_proc_net_exit(net: *mut net) -> void __net_exit {
...
//
    ...
    list_for_each_entry(t, &recent_net.tables, list)
    remove_proc_entry(t.name, recent_net.xt_recent);
    recent_net.xt_recent = core::ptr::null_mut();
    spin_unlock_bh(&recent_lock);
    remove_proc_entry("xt_recent", net.proc_net);
    }

#[no_mangle]
pub unsafe extern "C" fn recent_proc_net_init(net: *mut net) -> c_int {
    static inline int recent_proc_net_init(struct net *net)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn recent_proc_net_exit(net: *mut net) {
    static inline void recent_proc_net_exit(struct net *net)
    {
    }

#[no_mangle]
unsafe extern "C" fn recent_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn recent_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn recent_mt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn recent_mt_exit() -> void __exit {
