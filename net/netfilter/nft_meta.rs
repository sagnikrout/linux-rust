...
//! Source: net/netfilter/nft_meta.c
#![no_std]
...
pub const NFT_META_SECS_PER_MINUTE: c_int = 60;
pub const NFT_META_SECS_PER_HOUR: c_int = 3600;
pub const NFT_META_SECS_PER_DAY: c_int = 86400;
pub const NFT_META_DAYS_PER_WEEK: c_int = 7;
#[no_mangle]
unsafe extern "C" fn nft_meta_weekday() -> u8 {
...
#[no_mangle]
unsafe extern "C" fn nft_meta_hour(secs: time64_t) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nft_meta_store_ifindex(dest: *mut u32, dev: *const net_device) {
    static void nft_meta_store_ifindex(u32 *dest, const struct net_device *dev)
    {
// dest = dev ? dev->ifindex : 0;
    }
#[no_mangle]
unsafe extern "C" fn nft_meta_store_ifname(dest: *mut u32, dev: *const net_device) {
    static void nft_meta_store_ifname(u32 *dest, const struct net_device *dev)
    {
    strscpy_pad((char *)dest, dev ? dev.name : "", IFNAMSIZ);
    }
#[no_mangle]
unsafe extern "C" fn nft_meta_store_iftype(dest: *mut u32, dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nft_meta_store_ifgroup(dest: *mut u32, dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nft_meta_get_eval_sdif(pkt: *const nft_pktinfo) -> noinline u32 {
    ...
    {
    let mut sdif: u32 = nft_meta_get_eval_sdif(pkt);
    const struct net_device *dev;
    dev = sdif ? dev_get_by_index_rcu(nft_net(pkt), sdif) : core::ptr::null_mut();
    nft_meta_store_ifname(dest, dev);
    }
#[no_mangle]
unsafe extern "C" fn nft_meta_pktinfo_may_update(pkt: *mut nft_pktinfo) {
...
// dest = skb->len;
    ...
    nft_reg_store16(dest, ( u16)pkt.ethertype);
    break;
...
#[no_mangle]
unsafe extern "C" fn nft_meta_get_validate_sdif(ctx: *const nft_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_meta_get_validate_xfrm(ctx: *const nft_ctx) -> c_int {
    ...
    const struct nlattr * const tb[])
    {
    if (tb[NFTA_META_KEY] == core::ptr::null_mut())
    ...
    switch (priv.key) {
    case NFT_META_PROTOCOL:
    nft_reg_store16(dest, ( u16)tun_ctx.llproto);
    break;
    case NFT_META_L4PROTO:
...
#[no_mangle]
unsafe extern "C" fn nft_secmark_compute_secid(priv: *mut nft_secmark) -> c_int {
    static int nft_secmark_compute_secid(struct nft_secmark *priv)
    {
    let mut tmp_secid: u32 = 0;
    int err;
    ...
    int err;
    if (tb[NFTA_SECMARK_CTX] == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn nft_secmark_obj_destroy(ctx: *const nft_ctx, obj: *mut nft_object) {
