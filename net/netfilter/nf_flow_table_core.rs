...
//! Source: net/netfilter/nf_flow_table_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn flow_offload_dst_cookie(flow_tuple: *mut flow_offload_tuple) -> u32 {
    ...
    route.tuple[dir].dst = core::ptr::null_mut();
    return dst;
    }
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_has_expired(flow: *const flow_offload) -> bool {
    static inline bool nf_flow_has_expired(const struct flow_offload *flow)
    {
    return nf_flow_timeout_delta(flow.timeout) <= 0;
    }
#[no_mangle]
unsafe extern "C" fn flow_offload_fixup_tcp(ct: *mut nf_conn, tcp_state: u8) {
...
#[no_mangle]
unsafe extern "C" fn flow_offload_fixup_ct(flow: *mut flow_offload) {
    static void flow_offload_fixup_ct(struct flow_offload *flow)
    {
    struct nf_conn *ct = flow.ct;
    struct net *net = nf_ct_net(ct);
    let mut l4num: c_int = nf_ct_protonum(ct);
    bool expired, closing = false;
    let mut offload_timeout: u32 = 0;
    s32 timeout;
...
#[no_mangle]
unsafe extern "C" fn flow_offload_route_release(flow: *mut flow_offload) {
...
#[no_mangle]
pub unsafe extern "C" fn flow_offload_free(flow: *mut flow_offload) {
...
#[no_mangle]
unsafe extern "C" fn flow_offload_hash(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn flow_offload_hash_obj(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn flow_offload_get_timeout(flow: *mut flow_offload) -> c_ulong {
    unsigned long flow_offload_get_timeout(struct flow_offload *flow)
    {
    let mut timeout: c_ulong = NF_FLOW_TIMEOUT;
    struct net *net = nf_ct_net(flow.ct);
    let mut l4num: c_int = nf_ct_protonum(flow.ct);
    if (l4num == IPPROTO_TCP) {
...
#[no_mangle]
pub unsafe extern "C" fn flow_offload_add(flow_table: *mut nf_flowtable, flow: *mut flow_offload) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn flow_offload_teardown(flow: *mut flow_offload) {
...
//
#[no_mangle]
unsafe extern "C" fn nf_flow_table_tcp_timeout(ct: *const nf_conn) -> u32 {
    static u32 nf_flow_table_tcp_timeout(const struct nf_conn *ct)
    {
    let mut state: u8 = READ_ONCE(ct.proto.tcp.state);
    switch (state) {
...
//
#[no_mangle]
unsafe extern "C" fn nf_flow_table_extend_ct_timeout(ct: *mut nf_conn) {
    static void nf_flow_table_extend_ct_timeout(struct nf_conn *ct)
    {
    let mut min_timeout: static s32 = 5 * 60 * HZ;
    let mut ct_timeout: u32 = READ_ONCE(ct.timeout);
    s32 expires;
...
// load ct->status after refcount increase
    ...
    let mut l4proto: u8 = nf_ct_protonum(ct);
    let mut new_timeout: u32 = 1;
    switch (l4proto) {
    case IPPROTO_UDP:
...
//
    ...
    struct flow_offload *flow, void *data)
    {
    let mut teardown: bool = test_bit(NF_FLOW_TEARDOWN, &flow.flags);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(NF_FLOW_HW_DEAD, _arg: &flow->flags)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_gc_run(flow_table: *mut nf_flowtable) {
    void nf_flow_table_gc_run(struct nf_flowtable *flow_table)
    {
    nf_flow_table_iterate(flow_table, nf_flow_offload_gc_step, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn nf_flow_offload_work_gc(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_init(flowtable: *mut nf_flowtable) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_cleanup(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_free(flow_table: *mut nf_flowtable) {
...
// ... no more pending work after this stage ...
    nf_flow_table_iterate(flow_table, nf_flow_table_do_cleanup, core::ptr::null_mut());
    nf_flow_table_gc_run(flow_table);
...
#[no_mangle]
unsafe extern "C" fn nf_flow_table_init_net(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_flow_table_fini_net(net: *mut net) {
    static void nf_flow_table_fini_net(struct net *net)
    {
    free_percpu(net.ft.stat);
    }
#[no_mangle]
unsafe extern "C" fn nf_flow_table_pernet_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_flow_table_pernet_exit(net_exit_list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn nf_flow_table_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nf_flow_table_module_exit() -> void __exit {
