...
//! Source: net/netfilter/nf_tables_offload.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_offload_ethertype {
    pub value: __be16,
    pub mask: __be16,
}
    ...
    struct nft_flow_rule *flow;
    let mut num_actions: c_int = 0, err;
...
#[no_mangle]
pub unsafe extern "C" fn nft_flow_rule_destroy(flow: *mut nft_flow_rule) {
...
#[no_mangle]
unsafe extern "C" fn nft_chain_offload_priority(basechain: *const nft_base_chain) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nft_chain_offload_support(basechain: *const nft_base_chain) -> bool {
    ...
    int err;
    err = nft_flow_offload_cmd(chain, rule, core::ptr::null_mut(), FLOW_CLS_STATS,
    &cls_flow);
    if (err < 0)
    return err;
    ...
    nft_flow_cls_offload_setup(&cls_flow, basechain, rule, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn nft_indr_block_cleanup(block_cb: *mut flow_block_cb) {
    ...
    err = flow_indr_dev_setup_offload(dev, core::ptr::null_mut(), TC_SETUP_BLOCK, basechain, &bo,
...
// Only default policy to accept is supported for now.
    ...
    return -EOPNOTSUPP;
    return nft_flow_block_chain(basechain, core::ptr::null_mut(), cmd);
    }
    ...
    continue;
    err = nft_flow_offload_chain(nft_trans_chain(trans), core::ptr::null_mut(),
    FLOW_BLOCK_UNBIND);
    break;
    ...
    core::ptr::null_mut(), FLOW_CLS_DESTROY);
    break;
...
#[no_mangle]
pub unsafe extern "C" fn nft_flow_rule_offload_commit(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nft_offload_init() -> c_int {
    int nft_offload_init(void)
    {
    return register_netdevice_notifier(&nft_offload_netdev_notifier);
    }
#[no_mangle]
pub unsafe extern "C" fn nft_offload_exit() {
