...
pub struct ct_iter_state {
    ...
    pub htable_size: c_uint,
    pub skip_elems: c_uint,
    pub bucket: c_uint,
    pub time_now: u_int64_t,
}
...
#[no_mangle]
unsafe extern "C" fn ct_seq_stop(s: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ct_show_secctx(s: *mut seq_file, ct: *const nf_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn ct_show_secctx(s: *mut seq_file, ct: *const nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn ct_show_delta_time(s: *mut seq_file, ct: *const nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn l3proto_name(proto: u16) -> *const c_char {
...
#[no_mangle]
unsafe extern "C" fn l4proto_name(proto: u16) -> *const c_char {
...
#[no_mangle]
unsafe extern "C" fn ct_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(IPS_OFFLOAD_BIT, _arg: &ct->status)) -> else {
    else if (test_bit(IPS_OFFLOAD_BIT, &ct.status))
    seq_puts(s, "[OFFLOAD] ");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(IPS_ASSURED_BIT, _arg: &ct->status)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ct_cpu_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    static void ct_cpu_seq_stop(struct seq_file *seq, void *v)
    {
    }
#[no_mangle]
unsafe extern "C" fn ct_cpu_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_standalone_init_proc(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_standalone_fini_proc(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_count(net: *const net) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_standalone_init_sysctl(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_standalone_fini_sysctl(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_fini_net(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_pernet_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_pernet_exit(net_exit_list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_standalone_init() -> int __init {
    static int __init nf_conntrack_standalone_init(void)
    {
    let mut ret: c_int = nf_conntrack_init_start();
    if (ret < 0)
    goto out_start;
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_standalone_fini() -> void __exit {
