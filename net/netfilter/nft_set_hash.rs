...
//! Source: net/netfilter/nft_set_hash.c
#![no_std]
...
pub const NFT_RHASH_ELEMENT_HINT: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_rhash {
    pub ht: rhashtable,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_rhash_elem {
    pub priv: nft_elem_priv,
    pub node: rhash_head,
    pub walk_node: llist_node,
    pub wq_gc_seq: u32,
    pub ext: nft_set_ext,
}
...
#[no_mangle]
pub unsafe extern "C" fn nft_rhash_key(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nft_rhash_obj(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nft_rhash_gc(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nft_rhash_gc_init(set: *const nft_set) {
    ...
    {
    struct nft_rhash *priv = nft_set_priv(set);
    let mut params: rhashtable_params = nft_rhash_params;
    int err;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_rhash_ctx {
    pub ctx: nft_ctx,
    pub set: *const nft_set,
}

#[no_mangle]
unsafe extern "C" fn nft_rhash_elem_destroy(ptr: *mut c_void, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nft_hash_buckets(size: u32) -> u32 {
    static u32 nft_hash_buckets(u32 size)
    {
    let mut val: u64 = div_u64((u64)size * 4, 3);
