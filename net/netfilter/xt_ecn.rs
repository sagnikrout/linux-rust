...
#[no_mangle]
unsafe extern "C" fn match_tcp(skb: *const sk_buff, par: *mut xt_action_param) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ecn_mt_check4(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecn_mt_check6(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecn_mt_init() -> int __init {
    static int __init ecn_mt_init(void)
    {
    return xt_register_matches(ecn_mt_reg, ARRAY_SIZE(ecn_mt_reg));
    }
#[no_mangle]
unsafe extern "C" fn ecn_mt_exit() -> void __exit {
