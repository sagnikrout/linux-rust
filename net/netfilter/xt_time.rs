...
//! Source: net/netfilter/xt_time.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct xtm {
    pub /: *mut *mut u_int8_t month; / (1-12),
    pub /: *mut *mut u_int8_t monthday; / (1-31),
    pub /: *mut *mut u_int8_t weekday; / (1-7),
    pub /: *mut *mut u_int8_t hour; / (0-23),
    pub /: *mut *mut u_int8_t minute; / (0-59),
    pub /: *mut *mut u_int8_t second; / (0-59),
    pub dse: c_uint,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn localtime_1(r: *mut xtm, time: time64_t) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn localtime_2(r: *mut xtm, time: time64_t) {
...
#[no_mangle]
unsafe extern "C" fn localtime_3(r: *mut xtm, time: time64_t) {
...
#[no_mangle]
unsafe extern "C" fn time_mt_check(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn time_mt_init() -> int __init {
    static int __init time_mt_init(void)
    {
    let mut minutes: c_int = sys_tz.tz_minuteswest;
...
#[no_mangle]
unsafe extern "C" fn time_mt_exit() -> void __exit {
