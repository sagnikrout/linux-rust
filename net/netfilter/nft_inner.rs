...
//! Source: net/netfilter/nft_inner.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_inner_tun_ctx_locked {
    pub ctx: nft_inner_tun_ctx,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct __nft_expr {
    pub ops: *const nft_expr_ops,
    union {
    pub payload: nft_payload,
    pub meta: nft_meta,
    pub __attribute__((aligned(__alignof__(u64)))): },
}
...
pub struct nft_inner {
    ...
    let mut fh_flags: c_int = IP6_FH_F_AUTH;
...
// this_cpu_tun_ctx = *tun_ctx;
    ...
    let mut tun_ctx: nft_inner_tun_ctx = {};
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(expr_info.ops->type->name, _arg: "meta")) -> else {
