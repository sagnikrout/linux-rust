...
//! Source: net/netfilter/nft_osf.c
#![no_std]
...
pub struct nft_osf {
    ...
    if (nla_put_u32(skb, NFTA_OSF_FLAGS, ntohl(( __be32)priv.flags)))
    goto nla_put_failure;
...
#[no_mangle]
unsafe extern "C" fn nft_osf_module_init() -> int __init {
    static int __init nft_osf_module_init(void)
    {
    return nft_register_expr(&nft_osf_type);
    }
#[no_mangle]
unsafe extern "C" fn nft_osf_module_exit() -> void __exit {
