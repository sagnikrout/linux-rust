...
//! Source: net/netfilter/nf_nat_helper.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enlarge_skb(skb: *mut sk_buff, extra: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nf_nat_exp_find_port(exp: *mut nf_conntrack_expect, port: u16) -> u16 {
    u16 nf_nat_exp_find_port(struct nf_conntrack_expect *exp, u16 port)
    {
    let mut max_attempts: static unsigned int = 128;
    int range, attempts_left;
    let mut min: u16 = port;
