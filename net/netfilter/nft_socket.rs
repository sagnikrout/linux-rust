...
//! Source: net/netfilter/nft_socket.c
#![no_std]
...
pub struct nft_socket {
    pub key:8: enum nft_socket_keys,
    pub /: *mut *mut u8 level; / cgroupv2 level to extract,
    pub /: *mut *mut u8 level_user; / cgroupv2 level provided by userspace,
    pub len: u8,
    union {
    pub dreg: u8,
}
...
#[no_mangle]
unsafe extern "C" fn nft_socket_cgroup_subtree_level() -> noinline int {
...
#[no_mangle]
unsafe extern "C" fn nft_socket_module_init() -> int __init {
    static int __init nft_socket_module_init(void)
    {
    return nft_register_expr(&nft_socket_type);
    }
#[no_mangle]
unsafe extern "C" fn nft_socket_module_exit() -> void __exit {
