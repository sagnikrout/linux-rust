...
//! Source: net/netfilter/nf_conntrack_pptp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn exp_gre(ct: *mut nf_conn, callid: __be16, peer_callid: __be16) -> c_int {
    ...
    if (exp_orig == core::ptr::null_mut())
    goto out;
    exp_reply = nf_ct_expect_alloc(ct);
    if (exp_reply == core::ptr::null_mut())
    goto out_put_orig;
...
// track caller id inside control connection, call expect_related
    ...
    let mut tcplen: c_uint = skb.len - protoff;
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_pptp_init() -> int __init {
    static int __init nf_conntrack_pptp_init(void)
    {
    NF_CT_HELPER_BUILD_BUG_ON(sizeof(struct nf_ct_pptp_master));
    nf_ct_helper_init(&pptp, AF_INET, IPPROTO_TCP,
    "pptp",
    &pptp_exp_policy, 0, conntrack_pptp_help, core::ptr::null_mut(), THIS_MODULE);
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_pptp_fini() -> void __exit {
