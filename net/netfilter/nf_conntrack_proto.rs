...
//! Source: net/netfilter/nf_conntrack_proto.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    core::ptr::null_mut(), "nf_ct_proto_%d: %pV ", protonum, &vaf);
    va_end(args);
    }
...
// We only do TCP and SCTP at the moment: is there a better way?
    ...
    {
    let mut tuple: nf_conntrack_tuple = { .src.l3num = NFPROTO_IPV6 };
...
#[no_mangle]
unsafe extern "C" fn nf_ct_tcp_fixup(ct: *mut nf_conn, _nfproto: *mut c_void) -> c_int {
    static int nf_ct_tcp_fixup(struct nf_conn *ct, void *_nfproto)
    {
    let mut nfproto: u8 = (unsigned long)_nfproto;
...
#[no_mangle]
unsafe extern "C" fn nf_ct_netns_do_get(net: *mut net, nfproto: u8) -> c_int {
    static int nf_ct_netns_do_get(struct net *net, u8 nfproto)
    {
    struct nf_conntrack_net *cnet = nf_ct_pernet(net);
    let mut fixup_needed: bool = false, retry = true;
    let mut err: c_int = 0;
    retry:
...
#[no_mangle]
unsafe extern "C" fn nf_ct_netns_do_put(net: *mut net, nfproto: u8) {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_netns_inet_get(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_netns_get(net: *mut net, nfproto: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_netns_put(net: *mut net, nfproto: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_bridge_register(info: *mut nf_ct_bridge_info) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_bridge_unregister(info: *mut nf_ct_bridge_info) {
    void nf_ct_bridge_unregister(struct nf_ct_bridge_info *info)
    {
    WARN_ON(!nf_ct_bridge_info);
    mutex_lock(&nf_ct_proto_mutex);
    nf_ct_bridge_info = core::ptr::null_mut();
    mutex_unlock(&nf_ct_proto_mutex);
    }
    EXPORT_SYMBOL_GPL(nf_ct_bridge_unregister);
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_proto_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_proto_fini() {
