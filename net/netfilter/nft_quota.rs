...
//! Source: net/netfilter/nft_quota.c
#![no_std]
...
pub struct nft_quota {
    pub quota: core::sync::atomic::AtomicI64,
    pub flags: c_ulong,
    pub consumed: *mut core::sync::atomic::AtomicI64,
}
    ...
    bool *report)
    {
    let mut consumed: u64 = atomic64_add_return(skb.len, priv.consumed);
    let mut quota: u64 = atomic64_read(&priv.quota);
    if (report)
// report = consumed >= quota;
    return consumed > quota;
    }
#[no_mangle]
pub unsafe extern "C" fn nft_quota_invert(priv: *mut nft_quota) -> bool {
    ...
    {
    if (nft_overquota(priv, pkt.skb, core::ptr::null_mut()) ^ nft_quota_invert(priv))
...
#[no_mangle]
unsafe extern "C" fn nft_quota_clone(dst: *mut nft_expr, src: *const nft_expr, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_quota_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nft_quota_module_exit() -> void __exit {
