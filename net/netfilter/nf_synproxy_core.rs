...
//! Source: net/netfilter/nf_synproxy_core.c
#![no_std]
...
//
    ...
    {
    let mut length: c_int = (th.doff * 4) - sizeof(*th);
    u8 buf[40], *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn if(NF_SYNPROXY_OPT_SACK_PERM: opts->options &) -> else {
    ...
    let mut options: u8 = opts.options;
...
#[no_mangle]
unsafe extern "C" fn synproxy_cpu_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    static void synproxy_cpu_seq_stop(struct seq_file *seq, void *v)
    {
    return;
    }
#[no_mangle]
unsafe extern "C" fn synproxy_cpu_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn synproxy_proc_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn synproxy_proc_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn synproxy_net_init(net: *mut net) -> int __net_init {
    ...
    if (snet.stats == core::ptr::null_mut())
    goto err2;
...
#[no_mangle]
unsafe extern "C" fn synproxy_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn synproxy_core_init() -> int __init {
    static int __init synproxy_core_init(void)
    {
    return register_pernet_subsys(&synproxy_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn synproxy_core_exit() -> void __exit {
    ...
    struct tcphdr *nth;
    unsigned int tcp_hdr_size;
    let mut mss: u16 = opts.mss_encode;
    iph = ip_hdr(skb);
...
//
    ...
    nth.urg_ptr	= 0;
    synproxy_build_options(nth, opts);
    synproxy_send_tcp(net, skb, nskb, core::ptr::null_mut(), 0, niph, nth, tcp_hdr_size);
    }
    static void
...
#[no_mangle]
pub unsafe extern "C" fn nf_synproxy_ipv4_init(snet: *mut synproxy_net, net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_synproxy_ipv4_fini(snet: *mut synproxy_net, net: *mut net) {
...
//
    ...
    nth.urg_ptr	= 0;
    synproxy_build_options(nth, opts);
    synproxy_send_tcp_ipv6(net, skb, nskb, core::ptr::null_mut(), 0, niph, nth,
    tcp_hdr_size);
    }
    static void
