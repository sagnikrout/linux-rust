...
// Inner loop runs over "&", "<<", ">>" and "@" operands
    for (i = 1; i < nnums; ++i) {
    let mut number: u_int32_t = ct.location[i].number;
...
#[no_mangle]
unsafe extern "C" fn u32_mt_checkentry(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn u32_mt_init() -> int __init {
    static int __init u32_mt_init(void)
    {
    return xt_register_match(&xt_u32_mt_reg);
    }
#[no_mangle]
unsafe extern "C" fn u32_mt_exit() -> void __exit {
