...
//! Source: net/netfilter/nf_conntrack_proto_sctp.c
#![no_std]
...
pub const SCTP_FLAG_HEARTBEAT_VTAG_FAILED: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn sctp_print_conntrack(s: *mut seq_file, ct: *mut nf_conn) {
...
// Returns verdict for packet, or -NF_ACCEPT for invalid.
    ...
    const struct sctp_chunkhdr *sch;
    struct sctp_chunkhdr _sch;
    let mut log_invalid: bool = false;
    u_int32_t offset, count;
    unsigned int *timeouts;
    unsigned long map[256 / sizeof(unsigned long)] = { 0 };
    let mut ignore: bool = false;
    let mut invalid_type: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn sctp_can_early_drop(ct: *const nf_conn) -> bool {
    ...
    NLA_ALIGN(NLA_HDRLEN + 4))
#[no_mangle]
unsafe extern "C" fn nlattr_to_sctp(cda[]: *mut nlattr, ct: *mut nf_conn) -> c_int {
...
// updates may not contain the internal protocol info, skip parsing
    ...
    sctp_nla_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_sctp_init_net(net: *mut net) {
