...
//! Source: net/netfilter/nf_conntrack_expect.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_expectation_gc(master_help: *mut nf_conn_help) {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_expect_dst_hash(n: *const net, tuple: *const nf_conntrack_tuple) -> c_uint {
    ...
    combined.dport = ( __u16)tuple.dst.u.all;
...
// global list then returned.
    ...
    {
    struct nf_conntrack_net *cnet = nf_ct_pernet(net);
    struct nf_conntrack_expect *i, *exp = core::ptr::null_mut();
    struct hlist_node *next;
    unsigned int h;
    lockdep_nfct_expect_lock_held();
    if (!cnet.expect_count)
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_remove_expectations(ct: *mut nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_expect_free_rcu(head: *mut rcu_head) {
...
pub unsafe extern "C" fn nf_ct_expect_put(exp: *mut nf_conntrack_expect) {
    ...
    struct net *net = nf_ct_exp_net(exp);
    let mut h: c_uint = nf_ct_expect_dst_hash(net, &exp.tuple);
    ...
    {
    struct nf_conntrack_expect *exp, *last = core::ptr::null_mut();
    struct hlist_node *next;
    hlist_for_each_entry_safe(exp, next, &master_help.expectations, lnode) {
    if (nf_ct_exp_is_expired(exp)) {
    nf_ct_unlink_expect(exp);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ct_expect_iter_state {
...
#[no_mangle]
unsafe extern "C" fn exp_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn exp_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exp_proc_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exp_proc_remove(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_expect_pernet_init(net: *mut net) -> c_int {
    int nf_conntrack_expect_pernet_init(struct net *net)
    {
    return exp_proc_init(net);
    }
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_expect_pernet_fini(net: *mut net) {
    void nf_conntrack_expect_pernet_fini(struct net *net)
    {
    exp_proc_remove(net);
    }
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_expect_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_expect_fini() {
