...
//! Source: net/netfilter/xt_connlimit.c
#![no_std]
...
//
    ...
    ( __u32)iph.daddr : ( __u32)iph.saddr;
    key[0] &= ( __u32)info.mask.ip;
    key[1] = zone.id;
    }
...
#[no_mangle]
unsafe extern "C" fn connlimit_mt_check(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn connlimit_mt_init() -> int __init {
    static int __init connlimit_mt_init(void)
    {
    return xt_register_matches(connlimit_mt_reg, ARRAY_SIZE(connlimit_mt_reg));
    }
#[no_mangle]
unsafe extern "C" fn connlimit_mt_exit() -> void __exit {
