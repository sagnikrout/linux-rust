...
//! Source: net/netfilter/xt_conntrack.c
#![no_std]
...
pub unsafe extern "C" fn if(IP_CT_UNTRACKED: ctinfo ==) -> else {
    ...
    let mut expires: c_ulong = nf_ct_expires(ct) / HZ;
...
#[no_mangle]
unsafe extern "C" fn conntrack_mt_check(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn conntrack_mt_destroy(par: *const xt_mtdtor_param) {
...
#[no_mangle]
unsafe extern "C" fn conntrack_mt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn conntrack_mt_exit() -> void __exit {
