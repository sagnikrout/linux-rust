...
//! Source: net/netfilter/nf_conntrack_proto_icmp.c
#![no_std]
...
//
    ...
    let mut nf_ct_icmp_timeout: static unsigned int = 30*HZ;
...
#[no_mangle]
unsafe extern "C" fn icmp_nlattr_tuple_size() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_icmp_init_net(net: *mut net) {
