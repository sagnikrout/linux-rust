...
pub const NFT_SET_MAX_ANONLEN: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn nft_validate_state_update(table: *mut nft_table, new_validate_state: u8) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_list_del(trans: *mut nft_trans) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_destroy(trans: *mut nft_trans) {
...
#[no_mangle]
unsafe extern "C" fn nft_set_trans_bind(ctx: *const nft_ctx, set: *mut nft_set) {
    static void nft_set_trans_bind(const struct nft_ctx *ctx, struct nft_set *set)
    {
    return __nft_set_trans_bind(ctx, set, true);
    }
#[no_mangle]
unsafe extern "C" fn nft_set_trans_unbind(ctx: *const nft_ctx, set: *mut nft_set) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_bind_chain(ctx: *const nft_ctx, chain: *mut nft_chain) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_unbind_chain(ctx: *const nft_ctx, chain: *mut nft_chain) {
...
#[no_mangle]
unsafe extern "C" fn nft_netdev_hook_free_ops(hook: *mut nft_hook) {
...
#[no_mangle]
unsafe extern "C" fn nft_netdev_hook_free(hook: *mut nft_hook) {
...
#[no_mangle]
unsafe extern "C" fn __nft_netdev_hook_free_rcu(rcu: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn nft_netdev_hook_free_rcu(hook: *mut nft_hook) {
    static void nft_netdev_hook_free_rcu(struct nft_hook *hook)
    {
    call_rcu(&hook.rcu, __nft_netdev_hook_free_rcu);
    }
#[no_mangle]
unsafe extern "C" fn nft_netdev_hook_unlink_free_rcu(hook: *mut nft_hook) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_hook_destroy(trans_hook: *mut nft_trans_hook) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_collapse_set_elem_allowed(a: *const nft_trans_elem, b: *const nft_trans_elem) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_commit_list_add_tail(net: *mut net, trans: *mut nft_trans) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_commit_list_add_elem(net: *mut net, trans: *mut nft_trans) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_table_add(ctx: *mut nft_ctx, msg_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_deltable(ctx: *mut nft_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_delchain(ctx: *mut nft_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nft_rule_expr_activate(ctx: *const nft_ctx, rule: *mut nft_rule) {
...
// You cannot delete the same rule twice
    ...
    if (trans == core::ptr::null_mut())
    return core::ptr::null_mut();
    if (msg_type == NFT_MSG_NEWRULE && ctx.nla[NFTA_RULE_ID] != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn nft_delrule(ctx: *mut nft_ctx, rule: *mut nft_rule) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_delrule_by_chain(ctx: *mut nft_ctx) -> c_int {
    ...
    struct nft_set *set)
    {
    return __nft_trans_set_add(ctx, msg_type, set, core::ptr::null_mut());
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_set_elem_catchall {
    pub list: list_head,
    pub rcu: rcu_head,
    pub elem: *mut nft_elem_priv,
}
...
//
#[no_mangle]
unsafe extern "C" fn nft_map_deactivate(ctx: *const nft_ctx, set: *mut nft_set) {
...
#[no_mangle]
unsafe extern "C" fn nft_delset(ctx: *const nft_ctx, set: *mut nft_set) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_delobj(ctx: *mut nft_ctx, obj: *mut nft_object) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_alloc_handle(table: *mut nft_table) -> u64 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_module_request {
    pub list: list_head,
    pub module: [c_char; MODULE_NAME_LEN],
    pub done: bool,
}
...
#[no_mangle]
unsafe extern "C" fn lockdep_nfnl_nft_mutex_not_held() {
...
#[no_mangle]
unsafe extern "C" fn nft_base_seq_be16(net: *const net) -> __be16 {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_table_notify(ctx: *const nft_ctx, event: c_int) {
    ...
    struct nftables_pernet *nft_net;
    const struct nft_table *table;
    let mut idx: c_uint = 0, s_idx = cb.args[0];
    struct net *net = sock_net(skb.sk);
    let mut family: c_int = nfmsg.nfgen_family;
    rcu_read_lock();
    nft_net = nft_pernet(net);
...
// called with rcu_read_lock held
    ...
    let mut genmask: u8 = nft_genmask_cur(info.net);
    let mut family: u8 = info.nfmsg.nfgen_family;
    const struct nft_table *table;
...
#[no_mangle]
unsafe extern "C" fn nft_table_disable(net: *mut net, table: *mut nft_table, cnt: u32) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_table_enable(net: *mut net, table: *mut nft_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_table_disable(net: *mut net, table: *mut nft_table) {
...
#[no_mangle]
unsafe extern "C" fn nft_table_pending_update(ctx: *const nft_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_updtable(ctx: *mut nft_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_chain_hash(data: *const c_void, len: u32, seed: u32) -> u32 {
    static u32 nft_chain_hash(const void *data, u32 len, u32 seed)
    {
...
#[no_mangle]
unsafe extern "C" fn nft_chain_hash_obj(data: *const c_void, len: u32, seed: u32) -> u32 {
    static u32 nft_chain_hash_obj(const void *data, u32 len, u32 seed)
    {
...
#[no_mangle]
unsafe extern "C" fn nft_objname_hash(data: *const c_void, len: u32, seed: u32) -> u32 {
    static u32 nft_objname_hash(const void *data, u32 len, u32 seed)
    {
...
#[no_mangle]
unsafe extern "C" fn nft_objname_hash_obj(data: *const c_void, len: u32, seed: u32) -> u32 {
    static u32 nft_objname_hash_obj(const void *data, u32 len, u32 seed)
    {
...
#[no_mangle]
unsafe extern "C" fn nft_supported_family(family: u8) -> bool {
    ...
    struct netlink_ext_ack *extack = info.extack;
    let mut genmask: u8 = nft_genmask_next(info.net);
    let mut family: u8 = info.nfmsg.nfgen_family;
    struct net *net = info.net;
    ...
    return -EOPNOTSUPP;
    nft_ctx_init(&ctx, net, skb, info.nlh, family, table, core::ptr::null_mut(), nla);
    ...
    if (table.name == core::ptr::null_mut())
    goto err_strdup;
    if (nla[NFTA_TABLE_USERDATA]) {
    table.udata = nla_memdup(nla[NFTA_TABLE_USERDATA], GFP_KERNEL_ACCOUNT);
    if (table.udata == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn nft_flush_table(ctx: *mut nft_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_flush(ctx: *mut nft_ctx, family: c_int) -> c_int {
    ...
    struct nft_table *table;
    struct nft_ctx ctx;
    nft_ctx_init(&ctx, net, skb, info.nlh, 0, core::ptr::null_mut(), core::ptr::null_mut(), nla);
    if (family == AF_UNSPEC ||
...
#[no_mangle]
unsafe extern "C" fn nf_tables_table_destroy(table: *mut nft_table) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_register_chain_type(ctype: *const nft_chain_type) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_unregister_chain_type(ctype: *const nft_chain_type) {
    void nft_unregister_chain_type(const struct nft_chain_type *ctype)
    {
    nfnl_lock(NFNL_SUBSYS_NFTABLES);
    chain_type[ctype.family][ctype.type] = core::ptr::null_mut();
    nfnl_unlock(NFNL_SUBSYS_NFTABLES);
    }
...
#[no_mangle]
unsafe extern "C" fn lockdep_commit_lock_is_held(net: *const net) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nft_dump_stats(skb: *mut sk_buff, stats: *mut nft_stats __percpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hook_is_prefix(hook: *mut nft_hook) -> bool {
    static bool hook_is_prefix(struct nft_hook *hook)
    {
    return strlen(hook.ifname) >= hook.ifnamelen;
    }
#[no_mangle]
unsafe extern "C" fn nft_nla_put_hook_dev(skb: *mut sk_buff, hook: *mut nft_hook) -> c_int {
    static int nft_nla_put_hook_dev(struct sk_buff *skb, struct nft_hook *hook)
    {
    let mut attr: c_int = hook_is_prefix(hook) ? NFTA_DEVICE_PREFIX : NFTA_DEVICE_NAME;
    return nla_put_string(skb, attr, hook.ifname);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_hook_dump_ctx {
    pub first: *mut nft_hook,
    pub n: c_int,
}
    ...
    let mut dump_hook_ctx: nft_hook_dump_ctx = {};
    ...
    NLM_F_MULTI,
    table.family, table,
    chain, core::ptr::null_mut(), core::ptr::null_mut()) < 0)
    goto done;
    nl_dump_check_consistent(cb, nlmsg_hdr(skb));
    cont:
    idx++;
...
// called with rcu_read_lock held
    ...
    0, family, table, chain, core::ptr::null_mut(), core::ptr::null_mut());
    if (err < 0)
...
#[no_mangle]
unsafe extern "C" fn nft_chain_stats_replace(trans: *mut nft_trans_chain) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_chain_free_chain_rules(chain: *mut nft_chain) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_chain_destroy(chain: *mut nft_chain) {
...
pub struct nft_chain_hook {
    ...
    nla[NFTA_CHAIN_HOOK],
    nft_hook_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    if (!basechain) {
...
#[no_mangle]
unsafe extern "C" fn nft_chain_release_hook(hook: *mut nft_chain_hook) {
...
#[no_mangle]
unsafe extern "C" fn nft_last_rule(chain: *const nft_chain, ptr: *const c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_chain_add(table: *mut nft_table, chain: *mut nft_chain) -> c_int {
    ...
    struct nft_stats __percpu *stats = core::ptr::null_mut();
    let mut hook: nft_chain_hook = {};
    if (table.flags & __NFT_TABLE_F_UPDATE)
    return -EINVAL;
    if (flags & NFT_CHAIN_BINDING)
    return -EOPNOTSUPP;
    err = nft_chain_parse_hook(net, core::ptr::null_mut(), nla, &hook, family, flags,
    extack);
    if (err < 0)
    return err;
    basechain = kzalloc_obj(*basechain, GFP_KERNEL_ACCOUNT);
    if (basechain == core::ptr::null_mut()) {
    ...
    if (chain.udata == core::ptr::null_mut()) {
    err = -ENOMEM;
    goto err_destroy_chain;
    }
...
// This must be LAST to ensure no packets are walking over this chain.
    ...
    {
    const struct nlattr * const *nla = ctx.nla;
    struct nft_base_chain *basechain = core::ptr::null_mut();
    struct nft_table *table = ctx.table;
...
// hook.list is on stack, no need for list_del_rcu()
    ...
    {
    struct nftables_pernet *nft_net = nft_pernet(net);
    let mut id: u32 = ntohl(nla_get_be32(nla));
    struct nft_trans *trans;
    list_for_each_entry(trans, &nft_net.commit_list, list) {
    if (trans.msg_type == NFT_MSG_NEWCHAIN &&
    ...
    let mut genmask: u8 = nft_genmask_next(info.net);
    let mut family: u8 = info.nfmsg.nfgen_family;
    struct nft_chain *chain = core::ptr::null_mut();
    struct net *net = info.net;
    const struct nlattr *attr;
    struct nft_table *table;
    let mut policy: u8 = NF_ACCEPT;
    struct nft_ctx ctx;
    ...
    if (chain == core::ptr::null_mut() &&
    nla[NFTA_CHAIN_HOOK] == core::ptr::null_mut()) {
    NL_SET_BAD_ATTR(extack, nla[NFTA_CHAIN_POLICY]);
    return -EOPNOTSUPP;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: chain) -> else {
    else if (chain)
    flags = chain.flags;
...
#[no_mangle]
unsafe extern "C" fn nft_trans_delhook_abort(del_list: *mut list_head) {
    ...
    const struct nlattr * const *nla = ctx.nla;
    let mut chain_hook: nft_chain_hook = {};
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_register_expr(type: *mut nft_expr_type) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_unregister_expr(type: *mut nft_expr_type) {
    ...
    struct nlattr *nla)
    {
    const struct nft_expr_type *type, *candidate = core::ptr::null_mut();
    list_for_each_entry_rcu(type, &nf_tables_expressions, list) {
    if (!nla_strcmp(nla, type.name)) {
    if (!type.family && !candidate)
    candidate = type;
#[no_mangle]
pub unsafe extern "C" fn if(family: type->family ==) -> else {
    ...
    if (type != core::ptr::null_mut() && try_module_get(type.owner)) {
    rcu_read_unlock();
    return type;
    }
    rcu_read_unlock();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_expr_info {
    pub ops: *const nft_expr_ops,
    pub attr: *const nlattr,
    pub 1]: *mut *mut nlattr tb[NFT_EXPR_MAXATTR +,
}
    ...
    nft_expr_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    tb[NFTA_EXPR_DATA],
    type.policy, core::ptr::null_mut());
    if (err < 0)
    goto err1;
    } else
    memset(info.tb, 0, sizeof(info.tb[0]) * (type.maxattr + 1));
    if (type.select_ops != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_expr_clone(dst: *mut nft_expr, src: *mut nft_expr, gfp: gfp_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nft_expr_destroy(ctx: *const nft_ctx, expr: *mut nft_expr) {
...
// FIXME: this sucks
    ...
    struct nlattr *list;
    let mut type: u16 = nfnl_msg_type(NFNL_SUBSYS_NFTABLES, event);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_rule_dump_ctx {
    pub s_idx: c_uint,
    pub table: *mut c_char,
    pub chain: *mut c_char,
    pub reset: bool,
}
    ...
    let mut entries: c_uint = 0;
    let mut ret: c_int = 0;
    u64 handle;
    prule = core::ptr::null_mut();
    list_for_each_entry_rcu(rule, &chain.rules, list) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_rules_start(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_rules_done(cb: *mut netlink_callback) -> c_int {
...
// Caller must hold rcu read lock or transaction mutex
    ...
    const struct nlattr * const nla[])
    {
    let mut portid: u32 = NETLINK_CB(skb).portid;
    struct net *net = info.net;
    struct sk_buff *skb2;
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_rule_destroy(ctx: *const nft_ctx, rule: *mut nft_rule) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_rule_release(ctx: *const nft_ctx, rule: *mut nft_rule) {
...
#[no_mangle]
unsafe extern "C" fn nft_chain_vstate_update(ctx: *const nft_ctx, chain: *mut nft_chain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_chain_validate(ctx: *const nft_ctx, chain: *mut nft_chain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_table_validate(net: *mut net, table: *const nft_table) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nft_set_catchall_validate(ctx: *const nft_ctx, set: *mut nft_set) -> c_int {
    ...
    const struct nft_chain *chain,
    const struct nlattr *nla);
pub const NFT_RULE_MAXEXPRS: c_int = 128;
    ...
    let mut genmask: u8 = nft_genmask_next(info.net);
    struct nft_rule *rule, *old_rule = core::ptr::null_mut();
    struct nft_expr_info *expr_info = core::ptr::null_mut();
    let mut family: u8 = info.nfmsg.nfgen_family;
    struct nft_flow_rule *flow = core::ptr::null_mut();
    struct net *net = info.net;
...
// Check for overflow of dlen field
    ...
    expr_info[i].ops = core::ptr::null_mut();
    expr = nft_expr_next(expr);
    }
    if (chain.flags & NFT_CHAIN_HW_OFFLOAD) {
...
//
    ...
    NFT_SET_EVAL)
#[no_mangle]
unsafe extern "C" fn nft_set_ops_candidate(type: *const nft_set_type, flags: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nf_msecs_to_jiffies64(nla: *const nlattr, result: *mut u64) -> c_int {
    int nf_msecs_to_jiffies64(const struct nlattr *nla, u64 *result)
    {
    let mut ms: u64 = be64_to_cpu(nla_get_be64(nla));
    let mut max: u64 = (u64)(~((u64)0));
...
#[no_mangle]
pub unsafe extern "C" fn nf_jiffies64_to_msecs(input: u64) -> __be64 {
...
#[no_mangle]
unsafe extern "C" fn nft_set_userspace_size(ops: *const nft_set_ops, size: u32) -> u32 {
...
//
    ...
    {
    let mut timeout: u64 = READ_ONCE(set.timeout);
    let mut gc_int: u32 = READ_ONCE(set.gc_int);
    let mut portid: u32 = ctx.portid;
    struct nlmsghdr *nlh;
    struct nlattr *nest;
    let mut seq: u32 = ctx.seq;
    int i;
    nlh = nfnl_msg_put(skb, portid, seq,
    nfnl_msg_type(NFNL_SUBSYS_NFTABLES, event),
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_sets(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_sets_start(cb: *mut netlink_callback) -> c_int {
    static int nf_tables_dump_sets_start(struct netlink_callback *cb)
    {
    struct nft_ctx *ctx_dump = core::ptr::null_mut();
    ctx_dump = kmemdup(cb.data, sizeof(*ctx_dump), GFP_ATOMIC);
    if (ctx_dump == core::ptr::null_mut())
    return -ENOMEM;
    cb.data = ctx_dump;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_sets_done(cb: *mut netlink_callback) -> c_int {
...
// called with rcu_read_lock held
    ...
    let mut genmask: u8 = nft_genmask_cur(info.net);
    let mut family: u8 = info.nfmsg.nfgen_family;
    struct nft_table *table = core::ptr::null_mut();
    struct net *net = info.net;
    const struct nft_set *set;
    struct sk_buff *skb2;
    struct nft_ctx ctx;
...
// Only accept unspec with dump
    ...
    nft_concat_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    nft_set_desc_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    if (da[NFTA_SET_DESC_SIZE] != core::ptr::null_mut())
    ...
    struct nft_ctx ctx;
    size_t alloc_size;
    let mut num_exprs: c_int = 0;
    char *name;
    int err, i;
    u16 udlen;
    u32 flags;
    u64 size;
    if (nla[NFTA_SET_TABLE] == core::ptr::null_mut() ||
    nla[NFTA_SET_NAME] == core::ptr::null_mut() ||
    nla[NFTA_SET_KEY_LEN] == core::ptr::null_mut() ||
    nla[NFTA_SET_ID] == core::ptr::null_mut())
    return -EINVAL;
    memset(&desc, 0, sizeof(desc));
    desc.ktype = NFT_DATA_VALUE;
    if (nla[NFTA_SET_KEY_TYPE] != core::ptr::null_mut()) {
    ...
    return -EINVAL;
    flags = 0;
    if (nla[NFTA_SET_FLAGS] != core::ptr::null_mut()) {
...
// Only one of these operations is supported
    ...
    desc.dtype = 0;
    if (nla[NFTA_SET_DATA_TYPE] != core::ptr::null_mut()) {
    ...
    if (nla[NFTA_SET_DATA_LEN] == core::ptr::null_mut())
    return -EINVAL;
    ...
    return -EINVAL;
    if (nla[NFTA_SET_OBJ_TYPE] != core::ptr::null_mut()) {
    ...
    desc.timeout = 0;
    if (nla[NFTA_SET_TIMEOUT] != core::ptr::null_mut()) {
    ...
    desc.gc_int = 0;
    if (nla[NFTA_SET_GC_INTERVAL] != core::ptr::null_mut()) {
    if (!(flags & NFT_SET_TIMEOUT))
    return -EINVAL;
    if (flags & NFT_SET_ANONYMOUS)
    return -EOPNOTSUPP;
    ...
    if (nla[NFTA_SET_POLICY] != core::ptr::null_mut()) {
    ...
    if (nla[NFTA_SET_DESC] != core::ptr::null_mut()) {
    ...
    size = 0;
    if (ops.privsize != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn nft_set_put(set: *mut nft_set) {
...
#[no_mangle]
unsafe extern "C" fn nft_set_destroy(ctx: *const nft_ctx, set: *mut nft_set) {
...
#[no_mangle]
unsafe extern "C" fn nft_map_activate(ctx: *const nft_ctx, set: *mut nft_set) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_activate_set(ctx: *const nft_ctx, set: *mut nft_set) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_destroy_set(ctx: *const nft_ctx, set: *mut nft_set) {
...
//
    ...
    let mut timeout: u64 = READ_ONCE(nft_set_ext_timeout(ext).timeout);
    let mut set_timeout: u64 = READ_ONCE(set.timeout);
    let mut msecs: __be64 = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_set_dump_args {
    pub cb: *const netlink_callback,
    pub iter: nft_set_iter,
    pub skb: *mut sk_buff,
    pub reset: bool,
}
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_set(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_set_start(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_set_done(cb: *mut netlink_callback) -> c_int {
...
// flags & NFT_SET_ELEM_INTERVAL_END)
    ...
    nft_set_elem_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    info.nlh, family, table, core::ptr::null_mut(), nla);
    dump_ctx.set = set;
...
#[no_mangle]
unsafe extern "C" fn nft_set_ext_check(tmpl: *const nft_set_ext_tmpl, id: u8, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_set_elem_destroy(ctx: *const nft_ctx, te: *mut nft_trans_elem) {
...
//
    ...
    let mut len: u32 = sizeof(struct nft_set_elem_expr);
    struct nft_expr *expr;
    int i, err;
    if (num_exprs == 0)
    return 0;
    ...
    expr_array[i] = core::ptr::null_mut();
    }
    return 0;
    err_elem_expr_setup:
    for (; i < num_exprs; i++) {
...
#[no_mangle]
unsafe extern "C" fn nft_setelem_catchall_destroy(catchall: *mut nft_set_elem_catchall) {
...
#[no_mangle]
unsafe extern "C" fn nft_set_maxsize(set: *const nft_set) -> u32 {
    ...
    struct nlattr *nla[NFTA_SET_ELEM_MAX + 1];
    let mut genmask: u8 = nft_genmask_next(ctx.net);
    let mut flags: u32 = 0, size = 0, num_exprs = 0;
    struct nft_set_ext_tmpl tmpl;
    struct nft_set_ext *ext, *ext2;
    struct nft_set_elem elem;
    struct nft_set_binding *binding;
    struct nft_elem_priv *elem_priv;
    struct nft_object *obj = core::ptr::null_mut();
    let mut override_exprs: bool = false;
    struct nft_userdata *udata;
    struct nft_data_desc desc;
    enum nft_registers dreg;
    struct nft_trans *trans;
    let mut set_full: bool = false;
    u64 expiration;
    u64 timeout;
    int err, i;
    u8 ulen;
    ...
    if (set.flags & NFT_SET_MAP) {
    if (nla[NFTA_SET_ELEM_DATA] == core::ptr::null_mut() &&
    !(flags & NFT_SET_ELEM_INTERVAL_END))
    return -EINVAL;
    } else {
    if (nla[NFTA_SET_ELEM_DATA] != core::ptr::null_mut())
    ...
    return -EINVAL;
    timeout = 0;
    if (nla[NFTA_SET_ELEM_TIMEOUT] != core::ptr::null_mut()) {
    if (!(set.flags & NFT_SET_TIMEOUT))
    return -EINVAL;
    ...
    expiration = 0;
    if (nla[NFTA_SET_ELEM_EXPIRATION] != core::ptr::null_mut()) {
    if (!(set.flags & NFT_SET_TIMEOUT))
    return -EINVAL;
    if (timeout == 0)
    return -EOPNOTSUPP;
    ...
    if (nla[NFTA_SET_ELEM_OBJREF] != core::ptr::null_mut()) {
...
//
    ulen = 0;
    if (nla[NFTA_SET_ELEM_USERDATA] != core::ptr::null_mut()) {
...
// nft_set_ext_obj(ext) = obj;
    ...
    goto err_elem_free;
    if (!(flags & NFT_SET_ELEM_CATCHALL)) {
    let mut max: c_uint = nft_set_maxsize(set), nelems;
...
// nft_set_ext_obj(ext) != *nft_set_ext_obj(ext2)))
    goto err_element_clash;
#[no_mangle]
pub unsafe extern "C" fn if(NLM_F_EXCL): !(nlmsg_flags &) -> else {
    err = 0;
    if (nft_set_ext_exists(ext2, NFT_SET_EXT_TIMEOUT)) {
    let mut update: nft_elem_update = { };
...
//
    ...
    struct nft_ctx ctx;
    int rem, err;
    if (nla[NFTA_SET_ELEM_LIST_ELEMENTS] == core::ptr::null_mut())
    return -EINVAL;
    table = nft_table_lookup(net, nla[NFTA_SET_ELEM_LIST_TABLE], family,
    genmask, NETLINK_CB(skb).portid);
    if (IS_ERR(table)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_data_hold(data: *const nft_data, type: enum nft_data_types) {
...
//
    ...
    te.elems[i].update = core::ptr::null_mut();
// Update request, so do not release this element
    te.elems[i].priv = core::ptr::null_mut();
    continue;
    }
...
// Called from abort path to undo DELSETELEM/DESTROYSETELEM.
    ...
    err = -ENOMEM;
    elem.priv = nft_set_elem_init(set, &tmpl, elem.key.val.data,
    elem.key_end.val.data, core::ptr::null_mut(), 0, 0,
    GFP_KERNEL_ACCOUNT);
    if (IS_ERR(elem.priv)) {
    err = PTR_ERR(elem.priv);
    goto fail_elem_key_end;
...
#[no_mangle]
unsafe extern "C" fn nft_set_flush(ctx: *mut nft_ctx, set: *mut nft_set, genmask: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_register_obj(obj_type: *mut nft_object_type) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_unregister_obj(obj_type: *mut nft_object_type) {
    ...
    u8 genmask)
    {
    let mut k: nft_object_hash_key = { .table = table };
...
// type->owner reference is put when transaction object is released.
    ...
    if (obj.udata == core::ptr::null_mut())
    goto err_userdata;
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_obj(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_obj_start(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_obj_done(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_obj_destroy(ctx: *const nft_ctx, obj: *mut nft_object) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_register_flowtable_type(type: *mut nf_flowtable_type) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_unregister_flowtable_type(type: *mut nf_flowtable_type) {
...
pub struct nft_flowtable_hook {
    ...
    nft_flowtable_hook_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    if (add) {
...
#[no_mangle]
unsafe extern "C" fn nft_hooks_destroy(hook_list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn nft_flowtable_hook_release(flowtable_hook: *mut nft_flowtable_hook) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_flowtable_filter {
    pub table: *mut c_char,
}
    ...
    NLM_F_MULTI | NLM_F_APPEND,
    table.family,
    flowtable, core::ptr::null_mut(), core::ptr::null_mut()) < 0)
    goto done;
    nl_dump_check_consistent(cb, nlmsg_hdr(skb));
    cont:
    idx++;
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_flowtable_start(cb: *mut netlink_callback) -> c_int {
    static int nf_tables_dump_flowtable_start(struct netlink_callback *cb)
    {
    const struct nlattr * const *nla = cb.data;
    struct nft_flowtable_filter *filter = core::ptr::null_mut();
    if (nla[NFTA_FLOWTABLE_TABLE]) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_dump_flowtable_done(cb: *mut netlink_callback) -> c_int {
...
// called with rcu_read_lock held
    ...
    flowtable, core::ptr::null_mut(), core::ptr::null_mut());
    if (err < 0)
...
#[no_mangle]
unsafe extern "C" fn nf_tables_flowtable_destroy(flowtable: *mut nft_flowtable) {
    ...
    let mut event: c_int = nfnl_msg_type(NFNL_SUBSYS_NFTABLES, NFT_MSG_NEWGEN);
...
#[no_mangle]
unsafe extern "C" fn nf_tables_validate(net: *mut net) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nft_chain_commit_drop_policy(trans: *mut nft_trans_chain) {
...
#[no_mangle]
unsafe extern "C" fn nft_chain_commit_update(trans: *mut nft_trans_chain) {
...
#[no_mangle]
unsafe extern "C" fn nft_commit_release(trans: *mut nft_trans) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_trans_destroy_work(w: *mut work_struct) {
    static void nf_tables_trans_destroy_work(struct work_struct *w)
    {
...
#[no_mangle]
pub unsafe extern "C" fn nf_tables_trans_destroy_flush_work(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_chain_prepare(net: *mut net, chain: *mut nft_chain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_chain_prepare_cancel(net: *mut net) {
    ...
    kvfree(chain.blob_next);
    chain.blob_next = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn __nf_tables_commit_chain_free_rules(h: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_chain_free_rules_old(blob: *mut nft_rule_blob) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_chain(net: *mut net, chain: *mut nft_chain) {
...
// No changes to this chain?
    if (chain.blob_next == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn nft_obj_del(table: *mut nft_table, obj: *mut nft_object) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_chain_del(chain: *mut nft_chain) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_trans_gc_destroy(trans: *mut nft_trans_gc) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_gc_trans_free(rcu: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_gc_work_done(trans: *mut nft_trans_gc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nft_trans_gc_work(work: *mut work_struct) {
    static void nft_trans_gc_work(struct work_struct *work)
    {
...
#[no_mangle]
pub unsafe extern "C" fn nft_trans_gc_elem_add(trans: *mut nft_trans_gc, priv: *mut c_void) {
    void nft_trans_gc_elem_add(struct nft_trans_gc *trans, void *priv)
    {
    trans.priv[trans.count++] = priv;
    }
#[no_mangle]
unsafe extern "C" fn nft_trans_gc_queue_work(trans: *mut nft_trans_gc) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_trans_gc_queue_async_done(trans: *mut nft_trans_gc) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_trans_gc_queue_sync_done(trans: *mut nft_trans_gc) {
    ...
    {
    struct nft_set_elem_catchall *catchall, *next;
    let mut tstamp: u64 = nft_net_tstamp(gc.net);
    const struct nft_set *set = gc.set;
    struct nft_elem_priv *elem_priv;
    struct nft_set_ext *ext;
...
#[no_mangle]
unsafe extern "C" fn nf_tables_module_autoload_cleanup(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_release(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nft_commit_notify(net: *mut net, portid: u32) {
    static void nft_commit_notify(struct net *net, u32 portid)
    {
    struct nftables_pernet *nft_net = nft_pernet(net);
    struct sk_buff *batch_skb = core::ptr::null_mut(), *nskb, *skb;
    unsigned char *data;
    int len;
...
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_audit_free(adl: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_audit_entrycount(trans: *const nft_trans) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_commit_audit_log(adl: *mut list_head, generation: u32) {
...
#[no_mangle]
unsafe extern "C" fn nft_gc_seq_begin(nft_net: *mut nftables_pernet) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nft_gc_seq_end(nft_net: *mut nftables_pernet, gc_seq: c_uint) {
    static void nft_gc_seq_end(struct nftables_pernet *nft_net, unsigned int gc_seq)
    {
    WRITE_ONCE(nft_net.gc_seq, ++gc_seq);
    }
#[no_mangle]
unsafe extern "C" fn nf_tables_commit(net: *mut net, skb: *mut sk_buff) -> c_int {
    ...
    nft_ctx_init(&ctx, net, skb, nlh, NFPROTO_UNSPEC, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
...
// step 3. Start new generation, rules_gen_X now in use.
    ...
    &nft_trans_chain_hooks(trans), core::ptr::null_mut());
...
// trans destroyed after rcu grace period
    ...
    nf_tables_chain_notify(&ctx, NFT_MSG_NEWCHAIN, core::ptr::null_mut(), core::ptr::null_mut());
    nft_trans_destroy(trans);
    }
    break;
    case NFT_MSG_DELCHAIN:
    case NFT_MSG_DESTROYCHAIN:
    if (nft_trans_chain_update(trans)) {
    nf_tables_chain_notify(&ctx, NFT_MSG_DELCHAIN, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn nf_tables_module_autoload(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_abort_release(trans: *mut nft_trans) {
...
#[no_mangle]
unsafe extern "C" fn nft_set_abort_update(nft_net: *mut nftables_pernet) {
...
#[no_mangle]
unsafe extern "C" fn __nf_tables_abort(net: *mut net, action: enum nfnl_abort_action) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_valid_genid(net: *mut net, genid: u32) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_parse_u32_check(attr: *const nlattr, max: c_int, dest: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_parse_register(attr: *const nlattr, preg: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_dump_register(skb: *mut sk_buff, attr: c_uint, reg: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_validate_register_load(reg: enum nft_registers, len: c_uint) -> c_int {
...
// sreg = reg;
    ...
    {
    let mut registers: c_uint = DIV_ROUND_UP(len, NFT_REG32_SIZE);
...
// dreg = reg;
    ...
    nft_verdict_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn nft_verdict_uninit(data: *const nft_data) {
...
#[no_mangle]
pub unsafe extern "C" fn nft_verdict_dump(skb: *mut sk_buff, type: c_int, v: *const nft_verdict) -> c_int {
...
//
    ...
    nft_data_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    } else if (tb[NFTA_DATA_VERDICT] && ctx != core::ptr::null_mut()) {
    if (desc.type != NFT_DATA_VERDICT)
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn nft_data_release(data: *const nft_data, type: enum nft_data_types) {
...
#[no_mangle]
unsafe extern "C" fn __nft_release_hook(net: *mut net, table: *mut nft_table) {
...
#[no_mangle]
unsafe extern "C" fn __nft_release_hooks(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn __nft_release_table(net: *mut net, table: *mut nft_table) {
...
#[no_mangle]
unsafe extern "C" fn __nft_release_tables(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_pre_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_exit_batch(net_exit_list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nf_tables_module_exit() -> void __exit {
