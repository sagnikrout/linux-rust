...
//! Source: net/netfilter/nfnetlink.c
#![no_std]
...
pub const NFNL_MAX_ATTR_COUNT: c_int = 32;
...
#[no_mangle]
pub unsafe extern "C" fn nfnl_lock(subsys_id: __u8) {
...
#[no_mangle]
pub unsafe extern "C" fn nfnl_unlock(subsys_id: __u8) {
...
#[no_mangle]
pub unsafe extern "C" fn lockdep_nfnl_is_held(subsys_id: u8) -> bool {
...
pub unsafe extern "C" fn nfnetlink_subsys_unregister(n: *const nfnetlink_subsystem) -> c_int {
    ...
    {
    nfnl_lock(n.subsys_id);
    table[n.subsys_id].subsys = core::ptr::null_mut();
    nfnl_unlock(n.subsys_id);
    synchronize_rcu();
    return 0;
    }
    ...
    {
    let mut subsys_id: u8 = NFNL_SUBSYS_ID(type);
    ...
    {
    let mut cb_id: u8 = NFNL_MSG_TYPE(type);
    if (cb_id >= ss.cb_count)
    return core::ptr::null_mut();
    return &ss.cb[cb_id];
    }
#[no_mangle]
pub unsafe extern "C" fn nfnetlink_has_listeners(net: *mut net, group: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfnetlink_set_err(net: *mut net, portid: u32, group: u32, error: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfnetlink_unicast(skb: *mut sk_buff, net: *mut net, portid: u32) -> c_int {
...
// All the messages must at least contain nfgenmsg
    ...
    {
    let mut min_len: c_int = nlmsg_total_size(sizeof(struct nfgenmsg));
    struct nfnl_net *nfnlnet = nfnl_pernet(net);
    let mut cb_id: u8 = NFNL_MSG_TYPE(nlh.nlmsg_type);
    struct nlattr *cda[NFNL_MAX_ATTR_COUNT + 1];
    struct nlattr *attr = (void *)nlh + min_len;
    let mut attrlen: c_int = nlh.nlmsg_len - min_len;
    let mut subsys_id: __u8 = NFNL_SUBSYS_ID(type);
...
#[no_mangle]
unsafe extern "C" fn nfnl_err_del(nfnl_err: *mut nfnl_err) {
...
#[no_mangle]
unsafe extern "C" fn nfnl_err_reset(err_list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn nfnl_err_deliver(err_list: *mut list_head, skb: *mut sk_buff) {
    ...
    int err;
    if (subsys_id >= NFNL_SUBSYS_COUNT)
    return netlink_ack(skb, nlh, -EINVAL, core::ptr::null_mut());
    replay:
    status = 0;
    replay_abort:
    ...
    nlh = onlh;
    if (!skb)
    return netlink_ack(oskb, nlh, -ENOMEM, core::ptr::null_mut());
    nfnl_lock(subsys_id);
    ...
    {
    nfnl_unlock(subsys_id);
    netlink_ack(oskb, nlh, -EOPNOTSUPP, core::ptr::null_mut());
    ...
    module_put(ss.owner);
    nfnl_unlock(subsys_id);
    netlink_ack(oskb, nlh, -ERESTART, core::ptr::null_mut());
    return consume_skb(skb);
    }
    nfnl_unlock(subsys_id);
...
//
    ...
    netlink_ack(oskb, nlmsg_hdr(oskb), err, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_rcv_skb_batch(skb: *mut sk_buff, nlh: *mut nlmsghdr) {
    ...
    nfnl_batch_policy, core::ptr::null_mut());
    if (err < 0) {
...
// Work around old nft using host byte order
    if (nfgenmsg.res_id == ( __be16)NFNL_SUBSYS_NFTABLES)
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_rcv(skb: *mut sk_buff) {
    ...
    netlink_ack(skb, nlh, -EPERM, core::ptr::null_mut());
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_bind_event(net: *mut net, group: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_bind(net: *mut net, group: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_unbind(net: *mut net, group: c_int) {
...
// ctnetlink_has_listener is u8
    ...
    let mut v: u8 = READ_ONCE(nf_ctnetlink_has_listener);
    v &= ~group_bit;
// read concurrently without nfnl_grp_active_lock held.
    WRITE_ONCE(nf_ctnetlink_has_listener, v);
    }
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_net_exit_batch(net_exit_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nfnetlink_exit() -> void __exit {
