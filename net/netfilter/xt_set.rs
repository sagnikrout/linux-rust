...
#[no_mangle]
unsafe extern "C" fn xt_set_init() -> int __init {
    static int __init xt_set_init(void)
    {
    let mut ret: c_int = xt_register_matches(set_matches, ARRAY_SIZE(set_matches));
    if (!ret) {
...
#[no_mangle]
unsafe extern "C" fn xt_set_fini() -> void __exit {
