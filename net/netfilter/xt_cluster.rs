...
//! Source: net/netfilter/xt_cluster.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_orig_ipv4_src(ct: *const nf_conn) -> u32 {
    static inline u32 nf_ct_orig_ipv4_src(const struct nf_conn *ct)
    {
    return ( u32)ct.tuplehash[IP_CT_DIR_ORIGINAL].tuple.src.u3.ip;
    }
    static inline const u32 *nf_ct_orig_ipv6_src(const struct nf_conn *ct)
    {
    return ( u32 *)ct.tuplehash[IP_CT_DIR_ORIGINAL].tuple.src.u3.ip6;
    }
...
#[no_mangle]
unsafe extern "C" fn xt_cluster_mt_checkentry(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xt_cluster_mt_destroy(par: *const xt_mtdtor_param) {
...
#[no_mangle]
unsafe extern "C" fn xt_cluster_mt_init() -> int __init {
    static int __init xt_cluster_mt_init(void)
    {
    return xt_register_matches(xt_cluster_match, ARRAY_SIZE(xt_cluster_match));
    }
#[no_mangle]
unsafe extern "C" fn xt_cluster_mt_fini() -> void __exit {
