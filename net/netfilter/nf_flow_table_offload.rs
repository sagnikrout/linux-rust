...
//! Source: net/netfilter/nf_flow_table_offload.c
#![no_std]
...
pub const NF_FLOW_RULE_ACTION_MAX: c_int = 24;
    static struct workqueue_struct *nf_flow_offload_add_wq;
    static struct workqueue_struct *nf_flow_offload_del_wq;
    static struct workqueue_struct *nf_flow_offload_stats_wq;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct flow_offload_work {
    pub list: list_head,
    pub cmd: enum flow_cls_command,
    pub flowtable: *mut nf_flowtable,
    pub flow: *mut flow_offload,
    ...
    let mut mask: u32 = ~htonl(0xffffffff);
    __be32 addr;
    u32 offset;
    if (!entry)
    return -E2BIG;
...
#[no_mangle]
unsafe extern "C" fn flow_offload_l4proto(flow: *const flow_offload) -> c_int {
    static int flow_offload_l4proto(const struct flow_offload *flow)
    {
    let mut protonum: u8 = flow.tuplehash[FLOW_OFFLOAD_DIR_ORIGINAL].tuple.l4proto;
    let mut type: u8 = 0;
    switch (protonum) {
    case IPPROTO_TCP:
...
#[no_mangle]
unsafe extern "C" fn __nf_flow_offload_destroy(flow_rule: *mut nf_flow_rule) {
...
#[no_mangle]
unsafe extern "C" fn nf_flow_offload_destroy(flow_rule[]: *mut nf_flow_rule) {
    ...
    {
    let mut cls_flow: flow_cls_offload = {};
    let mut extack: netlink_ext_ack = {};
    struct flow_block_cb *block_cb;
    let mut proto: __be16 = ETH_P_ALL;
    int err, i = 0;
    ...
    FLOW_CLS_REPLACE, core::ptr::null_mut(),
    &offload.flowtable.flow_block.cb_list);
    }
    static void flow_offload_tuple_del(struct flow_offload_work *offload,
    enum flow_offload_tuple_dir dir)
    {
    nf_flow_offload_tuple(offload.flowtable, offload.flow, core::ptr::null_mut(), dir,
    offload.flowtable.priority,
    FLOW_CLS_DESTROY, core::ptr::null_mut(),
    &offload.flowtable.flow_block.cb_list);
    }
...
#[no_mangle]
unsafe extern "C" fn flow_offload_work_add(offload: *mut flow_offload_work) {
...
#[no_mangle]
unsafe extern "C" fn flow_offload_work_del(offload: *mut flow_offload_work) {
...
#[no_mangle]
unsafe extern "C" fn flow_offload_work_stats(offload: *mut flow_offload_work) {
...
#[no_mangle]
unsafe extern "C" fn flow_offload_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn flow_offload_queue_work(offload: *mut flow_offload_work) {
...
#[no_mangle]
unsafe extern "C" fn nf_flow_offload_unsupported(flow: *mut flow_offload) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_offload_flush_cleanup(flowtable: *mut nf_flowtable) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_offload_flush(flowtable: *mut nf_flowtable) {
...
#[no_mangle]
unsafe extern "C" fn nf_flow_table_indr_cleanup(block_cb: *mut flow_block_cb) {
    ...
    extack);
    return flow_indr_dev_setup_offload(dev, core::ptr::null_mut(), TC_SETUP_FT, flowtable, bo,
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_offload_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_flow_table_offload_exit() {
