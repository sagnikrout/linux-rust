...
//! Source: net/netfilter/nf_nat_irc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nf_nat_irc_fini() -> void __exit {
    static void __exit nf_nat_irc_fini(void)
    {
    nf_nat_helper_unregister(&nat_helper_irc);
    RCU_INIT_POINTER(nf_nat_irc_hook, core::ptr::null_mut());
    synchronize_rcu();
    }
#[no_mangle]
unsafe extern "C" fn nf_nat_irc_init() -> int __init {
    static int __init nf_nat_irc_init(void)
    {
    BUG_ON(nf_nat_irc_hook != core::ptr::null_mut());
