...
//! Source: net/netfilter/nf_conntrack_amanda.c
#![no_std]
...
//
    ...
    let mut __read_mostly: static unsigned int master_timeout = 300;
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_amanda_fini() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_amanda_init() -> int __init {
    ...
    HELPER_NAME,
    &amanda_exp_policy, 0, amanda_help, core::ptr::null_mut(), THIS_MODULE);
