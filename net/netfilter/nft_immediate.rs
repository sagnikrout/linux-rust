...
//! Source: net/netfilter/nft_immediate.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nft_reg_to_type(nla: *const nlattr) -> enum nft_data_types {
    ...
    int err;
    if (tb[NFTA_IMMEDIATE_DREG] == core::ptr::null_mut() ||
    tb[NFTA_IMMEDIATE_DATA] == core::ptr::null_mut())
    return -EINVAL;
