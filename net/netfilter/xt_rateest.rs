...
//
    ...
    let mut sample: gnet_stats_rate_est64 = {0};
...
#[no_mangle]
unsafe extern "C" fn xt_rateest_mt_checkentry(par: *const xt_mtchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xt_rateest_mt_init() -> int __init {
    static int __init xt_rateest_mt_init(void)
    {
    return xt_register_match(&xt_rateest_mt_reg);
    }
#[no_mangle]
unsafe extern "C" fn xt_rateest_mt_fini() -> void __exit {
