...
//! Source: net/netfilter/xt_HMARK.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hmark_tuple {
    pub src: __be32,
    pub dst: __be32,
    pub uports: union hmark_ports,
    pub proto: u8,
}

#[no_mangle]
pub unsafe extern "C" fn hmark_addr6_mask(addr32: *const __be32, mask: *const __be32) -> __be32 {
...
// the cluster is composed of big and little endian systems.
    ...
    {
    u32 hash;
    let mut src: u32 = ntohl(t.src);
    let mut dst: u32 = ntohl(t.dst);
    if (dst < src)
    swap(src, dst);
...
#[no_mangle]
unsafe extern "C" fn get_inner6_hdr(skb: *const sk_buff, offset: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_inner_hdr(skb: *const sk_buff, iphsz: c_int, nhoff: *mut c_int) -> c_int {
...
// Not enough header?
    ...
    if (icmph == core::ptr::null_mut() || icmph.type > NR_ICMP_TYPES)
    return 0;
// Error message?
...
#[no_mangle]
unsafe extern "C" fn hmark_tg_check(par: *const xt_tgchk_param) -> c_int {
