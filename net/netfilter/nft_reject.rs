...
//! Source: net/netfilter/nft_reject.c
#![no_std]
...
//
    ...
    int icmp_code;
    if (tb[NFTA_REJECT_TYPE] == core::ptr::null_mut())
    return -EINVAL;
    priv.type = ntohl(nla_get_be32(tb[NFTA_REJECT_TYPE]));
    switch (priv.type) {
    case NFT_REJECT_ICMP_UNREACH:
    case NFT_REJECT_ICMPX_UNREACH:
    if (tb[NFTA_REJECT_ICMP_CODE] == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn nft_reject_icmp_code(code: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nft_reject_icmpv6_code(code: u8) -> c_int {
