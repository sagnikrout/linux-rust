...
//! Source: net/netfilter/nf_flow_table_xdp.c
#![no_std]
...
//
    ...
    head);
    return ft_elem ? ft_elem.ft : core::ptr::null_mut();
    }
    }
    ...
    {
    struct flow_offload_xdp *iter, *elem = core::ptr::null_mut();
    let mut key: c_ulong = (unsigned long)dev;
    struct flow_offload_xdp_ft *ft_elem;
