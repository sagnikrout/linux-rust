...
//! Source: net/netfilter/nft_queue.c
#![no_std]
...
pub struct nft_queue {
    ...
    let mut queue: u32 = priv.queuenum;
    u32 ret;
...
#[no_mangle]
unsafe extern "C" fn nft_queue_module_init() -> int __init {
    static int __init nft_queue_module_init(void)
    {
    return nft_register_expr(&nft_queue_type);
    }
#[no_mangle]
unsafe extern "C" fn nft_queue_module_exit() -> void __exit {
