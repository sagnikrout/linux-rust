...
//
pub const GC_SCAN_INITIAL_COUNT: c_int = 100;

    static struct conntrack_gc_work conntrack_gc_work;
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_lock(__acquires(lock: *mut *mut spinlock_t lock)) {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_double_unlock(h1: c_uint, h2: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_all_lock() {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_all_unlock() {
...
#[no_mangle]
unsafe extern "C" fn scale_hash(hash: u32) -> u32 {
...
// Check bogus IP headers
    ...
    u8 *protonum)
    {
    let mut protoff: c_int = -1;
    let mut extoff: c_uint = nhoff + sizeof(struct ipv6hdr);
    __be16 frag_off;
    u8 nexthdr;
...
//
#[no_mangle]
pub unsafe extern "C" fn nf_ct_get_id(ct: *const nf_conn) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_get_id(nfct: *const nf_conntrack) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_tmpl_free(tmpl: *mut nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn destroy_gre_conntrack(ct: *mut nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn warn_on_keymap_list_leak(net: *const net) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_destroy(nfct: *mut nf_conntrack) {
...
#[no_mangle]
unsafe extern "C" fn __nf_ct_delete_from_lists(ct: *mut nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_delete_from_lists(ct: *mut nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_add_to_ecache_list(ct: *mut nf_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_delete(ct: *mut nf_conn, portid: u32, report: c_int) -> bool {
    ...
    if (tstamp) {
    let mut timeout: i32 = READ_ONCE(ct.timeout) - nfct_time_stamp;
...
#[no_mangle]
unsafe extern "C" fn nf_ct_gc_expired(ct: *mut nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn __nf_conntrack_insert_prepare(ct: *mut nf_conn) {
...
//
#[no_mangle]
unsafe extern "C" fn nf_ct_resolve_clash_harder(skb: *mut sk_buff, repl_idx: u32) -> c_int {
...
// Confirm a connection given skb; places it in hash table
    ...
    {
    let mut chainlen: c_uint = 0, sequence, max_chainlen;
    const struct nf_conntrack_zone *zone;
    unsigned int hash, reply_hash;
    struct nf_conntrack_tuple_hash *h;
    struct nf_conn *ct;
...
pub const NF_CT_EVICTION_RANGE: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn early_drop(net: *mut net, hash: c_uint) -> noinline int {
...
#[no_mangle]
unsafe extern "C" fn gc_worker_skip_ct(ct: *const nf_conn) -> bool {
    static bool gc_worker_skip_ct(const struct nf_conn *ct)
    {
    return !nf_ct_is_confirmed(ct) || nf_ct_is_dying(ct);
    }
#[no_mangle]
unsafe extern "C" fn gc_worker_can_early_drop(ct: *const nf_conn) -> bool {
    static bool gc_worker_can_early_drop(const struct nf_conn *ct)
    {
    const struct nf_conntrack_l4proto *l4proto;
    let mut protonum: u8 = nf_ct_protonum(ct);
...
#[no_mangle]
unsafe extern "C" fn nf_ct_help_gc(ct: *mut nf_conn) {
...
#[no_mangle]
unsafe extern "C" fn gc_worker(work: *mut work_struct) {
    static void gc_worker(struct work_struct *work)
    {
    unsigned int i, hashsz, nf_conntrack_max95 = 0;
    u32 end_time, start_time = nfct_time_stamp;
    struct conntrack_gc_work *gc_work;
    let mut expired_count: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn conntrack_gc_work_init(gc_work: *mut conntrack_gc_work) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_free(ct: *mut nf_conn) {
...
// look for tuple match
    ...
    rid = nf_ct_zone_id(zone, IP_CT_DIR_REPLY);
    if (zone_id != rid) {
    let mut tmp: u32 = hash_conntrack_raw(&tuple, rid, state.net);
...
// It exists; we have (non-exclusive) reference.
    ...
    let mut status: c_ulong = READ_ONCE(ct.status);
// Once we've had two way comms, always ESTABLISHED.
    if (likely(status & IPS_SEEN_REPLY))
    ctinfo = IP_CT_ESTABLISHED;
#[no_mangle]
pub unsafe extern "C" fn if(IPS_EXPECTED: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_ICMPV6: state->pf == NFPROTO_IPV6 && protonum ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_port_nlattr_tuple_size() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_attach(nskb: *mut sk_buff, skb: *const sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_update(net: *mut net, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kill_all(i: *mut nf_conn, data: *mut c_void) -> c_int {
    static int kill_all(struct nf_conn *i, void *data)
    {
    return 1;
    }
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_cleanup_start() {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_cleanup_end() {
...
//
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_cleanup_net(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_cleanup_net_list(net_exit_list: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_hash_resize(hashsize: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_set_hashsize(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_init_start() -> c_int {
    int nf_conntrack_init_start(void)
    {
    let mut nr_pages: c_ulong = totalram_pages();
    let mut max_factor: c_int = 8;
...
#[no_mangle]
pub unsafe extern "C" fn if(PAGE_SIZE): *mut *mut *mut nr_pages > (1024  1024  1024 /) -> else {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_set_closing(nfct: *mut nf_conntrack) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_init_end() {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_init_net(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __nf_ct_change_timeout(ct: *mut nf_conn, timeout: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __nf_ct_change_status(ct: *mut nf_conn, on: c_ulong, off: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn if(bit): off & (1 <<) -> else {
    else if (off & (1 << bit))
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_change_status_common(ct: *mut nf_conn, status: c_uint) -> c_int {
