...
//! Source: net/netfilter/nf_conntrack_bpf.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_ct_release(nfct: *mut nf_conn) -> __bpf_kfunc void {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_ct_set_timeout(nfct: *mut nf_conn___init, timeout: u32) -> __bpf_kfunc void {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_ct_change_timeout(nfct: *mut nf_conn, timeout: u32) -> __bpf_kfunc int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_ct_set_status(nfct: *const nf_conn___init, status: u32) -> __bpf_kfunc int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_ct_change_status(nfct: *mut nf_conn, status: u32) -> __bpf_kfunc int {
...
#[no_mangle]
pub unsafe extern "C" fn register_nf_conntrack_bpf() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cleanup_nf_conntrack_bpf() {
    void cleanup_nf_conntrack_bpf(void)
    {
    mutex_lock(&nf_conn_btf_access_lock);
    nfct_btf_struct_access = core::ptr::null_mut();
    mutex_unlock(&nf_conn_btf_access_lock);
    }
