...
//! Source: net/netfilter/nfnetlink_cttimeout.c
#![no_std]
...
pub struct ctnl_timeout {
    pub head: list_head,
    pub free_head: list_head,
    pub rcu_head: rcu_head,
    pub name: [c_char; CTNL_TIMEOUT_NAME_MAX],
    pub timeout: *mut nf_ct_timeout,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfct_timeout_pernet {
    pub nfct_timeout_list: list_head,
    pub nfct_timeout_freelist: list_head,
}
    ...
    __u8 l4num;
    const struct nf_conntrack_l4proto *l4proto;
    struct ctnl_timeout *timeout, *matching = core::ptr::null_mut();
    char *name;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ctnl_timeout_del(net: *mut net, timeout: *mut ctnl_timeout) {
...
// This protocol is not supported, skip.
    ...
    ret = ctnl_timeout_parse_policy(core::ptr::null_mut(), l4proto, info.net,
    cda[CTA_TIMEOUT_DATA]);
    if (ret < 0)
    goto err;
    return 0;
    ...
    {
    const struct nf_conntrack_l4proto *l4proto;
    unsigned int *timeouts = core::ptr::null_mut();
    struct sk_buff *skb2;
    __u16 l3num;
    __u8 l4num;
    int ret;
    ...
    err:
    return matching ? matching.timeout : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ctnl_timeout_put(timeout: *mut nf_ct_timeout) {
...
#[no_mangle]
unsafe extern "C" fn cttimeout_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn cttimeout_net_pre_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn cttimeout_net_exit(net: *mut net) -> void __net_exit {
    ...
    return;
    nf_ct_untimeout(net, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cttimeout_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cttimeout_exit() -> void __exit {
    static void __exit cttimeout_exit(void)
    {
    nfnetlink_subsys_unregister(&cttimeout_subsys);
    unregister_pernet_subsys(&cttimeout_ops);
    RCU_INIT_POINTER(nf_ct_timeout_hook, core::ptr::null_mut());
    synchronize_net();
    }
