...
//! Source: net/netfilter/ipset/ip_set_hash_ip.c
#![no_std]
...
pub const HOST_MASK: c_int = 32;
    ...
    let mut ip: u32 = 0, ip_to = 0, hosts, i = 0;
    let mut ret: c_int = 0;
