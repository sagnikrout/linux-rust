...
//! Source: net/netfilter/ipset/ip_set_hash_ipportnet.c
#![no_std]
...
//
// Macro flag: #define IP_SET_HASH_WITH_NETS_PACKED
// Macro flag: #define IP_SET_HASH_WITH_PROTO
// Macro flag: #define IP_SET_HASH_WITH_NETS
// IPv4 variant
// Member elements
#[repr(C)]
#[derive(Copy, Clone)]
...
// Common functions
    ...
    {
    let mut flags: u32 = data.nomatch ? IPSET_FLAG_NOMATCH : 0;
...
pub const HOST_MASK: c_int = 32;
    ...
    let mut adtfn: ipset_adtfn = set.variant.adt[adt];
    let mut e: hash_ipportnet4_elem = { .cidr = HOST_MASK - 1 };
    let mut ext: ip_set_ext = IP_SET_INIT_UEXT(set);
    let mut ip: u32 = 0, ip_to = 0, p = 0, port, port_to;
    let mut ip2_from: u32 = 0, ip2_to = 0, ip2, i = 0;
    let mut with_ports: bool = false;
    u8 cidr;
    int ret;
...
// lineno = nla_get_u32(tb[IPSET_ATTR_LINENO]);
    ...
    let mut cadt_flags: u32 = ip_set_get_h32(tb[IPSET_ATTR_CADT_FLAGS]);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hash_ipportnet6_elem {
    pub ip: union nf_inet_addr,
    pub ip2: union nf_inet_addr,
    pub port: __be16,
    pub cidr:7: u8,
    pub nomatch:1: u8,
    pub proto: u8,
...
// Macro flag: #define IP_SET_EMIT_CREATE
    ...
    const struct hash_ipportnet6 *h = set.data;
    let mut adtfn: ipset_adtfn = set.variant.adt[adt];
    let mut e: hash_ipportnet6_elem = { .cidr = HOST_MASK - 1 };
    let mut ext: ip_set_ext = IP_SET_INIT_UEXT(set);
    u32 port, port_to;
    let mut with_ports: bool = false;
    u8 cidr;
