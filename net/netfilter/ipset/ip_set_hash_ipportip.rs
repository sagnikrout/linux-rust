...
//! Source: net/netfilter/ipset/ip_set_hash_ipportip.c
#![no_std]
...
pub const HOST_MASK: c_int = 32;
    ...
    let mut e: hash_ipportip4_elem = { .ip = 0 };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hash_ipportip6_elem {
...
// Macro flag: #define IP_SET_EMIT_CREATE
    ...
    {
    let mut adtfn: ipset_adtfn = set.variant.adt[adt];
    let mut e: hash_ipportip6_elem = { .ip = { .all = { 0 } } };
    let mut ext: ip_set_ext = IP_SET_INIT_KEXT(skb, opt, set);
