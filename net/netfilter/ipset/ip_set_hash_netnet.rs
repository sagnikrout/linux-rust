...
//! Source: net/netfilter/ipset/ip_set_hash_netnet.c
#![no_std]
...
// Macro flag: #define IP_SET_HASH_WITH_NETMASK
// Macro flag: #define IP_SET_HASH_WITH_BITMASK
...
pub const HOST_MASK: c_int = 32;
    ...
    let mut ip2: u32 = 0, ip2_from = 0, ip2_to = 0, i = 0;
    int ret;
