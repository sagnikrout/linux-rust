...
//! Source: net/netfilter/ipset/ip_set_bitmap_port.c
#![no_std]
...
pub struct bitmap_port {
    ...
    pub /: *mut *mut u16 first_port; / host byte order, included in range,
    pub /: *mut *mut u16 last_port; / host byte order, included in range,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bitmap_port_adt_elem {
    pub id: u16,
}
