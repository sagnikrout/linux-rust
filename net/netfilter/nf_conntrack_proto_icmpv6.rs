...
//! Source: net/netfilter/nf_conntrack_proto_icmpv6.c
#![no_std]
...
//
    ...
    let mut nf_ct_icmpv6_timeout: static unsigned int = 30*HZ;
...
// Add 1; spaces filled with 0.
    ...
    {
    let mut type: c_int = orig.dst.u.icmp.type - 128;
...
// Returns verdict for packet, or -1 for invalid.
    ...
    let mut type: c_int = ct.tuplehash[0].tuple.dst.u.icmp.type - 128;
...
// Do not immediately delete the connection after the first
    ...
    const struct nf_hook_state *state)
    {
    let mut hl: u8 = ipv6_hdr(skb).hop_limit;
...
#[no_mangle]
unsafe extern "C" fn icmpv6_nlattr_tuple_size() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nf_conntrack_icmpv6_init_net(net: *mut net) {
