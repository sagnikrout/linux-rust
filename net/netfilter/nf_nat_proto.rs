...
//! Source: net/netfilter/nf_nat_proto.c
#![no_std]
...
// check = ~csum_ipv6_magic(&ipv6h->saddr, &ipv6h->daddr,
    ...
    let mut manip: enum nf_nat_manip_type = HOOK2MANIP(hooknum);
    let mut hdrlen: c_uint = ip_hdrlen(skb);
    struct nf_conntrack_tuple target;
...
// Change outer to look like the reply to an incoming packet
    ...
    {
    unsigned int ret;
    let mut daddr: __be32 = ip_hdr(skb).daddr;
...
#[no_mangle]
unsafe extern "C" fn nf_xfrm_me_harder(net: *mut net, skb: *mut sk_buff, family: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_nat_inet_port_was_mangled(skb: *const sk_buff, sport: __be16) -> bool {
    ...
    const struct nf_hook_state *state)
    {
    let mut saddr: __be32 = ip_hdr(skb).saddr;
    struct sock *sk = skb.sk;
    unsigned int ret;
    ret = nf_nat_ipv4_fn(priv, skb, state);
...
#[no_mangle]
pub unsafe extern "C" fn nf_nat_ipv4_register_fn(net: *mut net, ops: *const nf_hook_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_nat_ipv4_unregister_fn(net: *mut net, ops: *const nf_hook_ops) {
...
//
    ...
    const struct nf_hook_state *state)
    {
    let mut saddr: in6_addr = ipv6_hdr(skb).saddr;
    struct sock *sk = skb.sk;
    unsigned int ret;
...
// see nf_nat_ipv4_local_in
    ...
    let mut daddr: in6_addr = ipv6_hdr(skb).daddr;
    ret = nf_nat_ipv6_fn(priv, skb, state);
...
#[no_mangle]
pub unsafe extern "C" fn nf_nat_ipv6_register_fn(net: *mut net, ops: *const nf_hook_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_nat_ipv6_unregister_fn(net: *mut net, ops: *const nf_hook_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_nat_inet_register_fn(net: *mut net, ops: *const nf_hook_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_nat_inet_unregister_fn(net: *mut net, ops: *const nf_hook_ops) {
