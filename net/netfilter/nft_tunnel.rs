...
//! Source: net/netfilter/nft_tunnel.c
#![no_std]
...
pub struct nft_tunnel {
    pub key:8: enum nft_tunnel_keys,
    pub dreg: u8,
    pub mode:8: enum nft_tunnel_mode,
    pub len: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_tunnel_opts {
    union {
    pub vxlan: vxlan_metadata,
    pub erspan: erspan_metadata,
    pub data: [u8; IP_TUNNEL_OPTS_MAX],
    pub u: },
    pub len: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nft_tunnel_obj {
    pub md: *mut metadata_dst,
    pub opts: nft_tunnel_opts,
}
    ...
    nft_tunnel_ip_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    nft_tunnel_ip6_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    nft_tunnel_opts_vxlan_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    nft_tunnel_opts_geneve_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
    ...
    nft_tunnel_opts_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn nft_tunnel_ip_dump(skb: *mut sk_buff, info: *mut ip_tunnel_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_tunnel_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nft_tunnel_module_exit() -> void __exit {
