...
//! Source: net/netfilter/ipvs/ip_vs_twos.c
#![no_std]
...
//
    ...
    {
    struct ip_vs_dest *dest, *choice1 = core::ptr::null_mut(), *choice2 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ip_vs_twos_init() -> int __init {
    static int __init ip_vs_twos_init(void)
    {
    return register_ip_vs_scheduler(&ip_vs_twos_scheduler);
    }
#[no_mangle]
unsafe extern "C" fn ip_vs_twos_cleanup() -> void __exit {
