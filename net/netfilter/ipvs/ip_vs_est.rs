...
//! Source: net/netfilter/ipvs/ip_vs_est.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn work(_arg: est_reload_work) -> by {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_chain_estimation(chain: *mut hlist_head) {
    ...
    let mut kconns: u64 = 0, kinpkts = 0, koutpkts = 0;
    let mut kinbytes: u64 = 0, koutbytes = 0;
    unsigned int start;
    int i;
...
#[no_mangle]
unsafe extern "C" fn ip_vs_tick_estimation(kd: *mut ip_vs_est_kt_data, row: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_estimation_kthread(data: *mut c_void) -> c_int {
    static int ip_vs_estimation_kthread(void *data)
    {
    struct ip_vs_est_kt_data *kd = data;
    struct netns_ipvs *ipvs = kd.ipvs;
    let mut row: c_int = kd.est_row;
    unsigned long now;
    let mut id: c_int = kd.id;
    long gap;
    if (id > 0) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_est_reload_start(ipvs: *mut netns_ipvs, restart: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_est_kthread_stop(kd: *mut ip_vs_est_kt_data) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_est_add_kthread(ipvs: *mut netns_ipvs) -> c_int {
    static int ip_vs_est_add_kthread(struct netns_ipvs *ipvs)
    {
    struct ip_vs_est_kt_data *kd = core::ptr::null_mut();
    let mut id: c_int = ipvs.est_kt_count;
    let mut ret: c_int = -ENOMEM;
    void *arr = core::ptr::null_mut();
    int i;
...
#[no_mangle]
unsafe extern "C" fn ip_vs_est_update_ktid(ipvs: *mut netns_ipvs) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_start_estimator(ipvs: *mut netns_ipvs, stats: *mut ip_vs_stats) -> c_int {
    int ip_vs_start_estimator(struct netns_ipvs *ipvs, struct ip_vs_stats *stats)
    {
    struct ip_vs_est_kt_data *kd = ipvs.est_kt_count > 0 ?
    ipvs.est_kt_arr[0] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ip_vs_est_kthread_destroy(kd: *mut ip_vs_est_kt_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_stop_estimator(ipvs: *mut netns_ipvs, stats: *mut ip_vs_stats) {
    void ip_vs_stop_estimator(struct netns_ipvs *ipvs, struct ip_vs_stats *stats)
    {
    struct ip_vs_estimator *est = &stats.est;
    struct ip_vs_est_tick_data *td;
    struct ip_vs_est_kt_data *kd;
    let mut ktid: c_int = est.ktid;
    let mut row: c_int = est.ktrow;
    let mut cid: c_int = est.ktcid;
...
// In est_temp_list ?
    ...
    if (!kd.tick_len[row]) {
    RCU_INIT_POINTER(kd.ticks[row], core::ptr::null_mut());
...
// This kt slot can become available just now, prefer it
    ...
    ipvs.est_kt_arr[ktid] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ip_vs_est_drain_temp_list(ipvs: *mut netns_ipvs) {
    static void ip_vs_est_drain_temp_list(struct netns_ipvs *ipvs)
    {
    struct ip_vs_estimator *est;
    while (1) {
    let mut max: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn ip_vs_est_calc_limits(ipvs: *mut netns_ipvs, chain_max: *mut c_int) -> c_int {
    ...
    struct ip_vs_stats *s;
    let mut cache_factor: c_int = 4;
    int i, loops, ntest;
    let mut min_est: i32 = 0;
    ktime_t t1, t2;
    let mut max: c_int = 8;
    let mut ret: c_int = 1;
    s64 diff;
    ...
    kd = ipvs.est_kt_arr[0];
    mutex_unlock(&ipvs.est_mutex);
    s = kd ? kd.calc_stats : core::ptr::null_mut();
    if (!s)
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_est_calc_phase(ipvs: *mut netns_ipvs) {
    static void ip_vs_est_calc_phase(struct netns_ipvs *ipvs)
    {
    let mut genid: c_int = atomic_read(&ipvs.est_genid);
    struct ip_vs_est_tick_data *td;
    struct ip_vs_est_kt_data *kd;
    struct ip_vs_estimator *est;
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_zero_estimator(stats: *mut ip_vs_stats) {
...
// Get decoded rates
#[no_mangle]
pub unsafe extern "C" fn ip_vs_read_estimator(dst: *mut ip_vs_kstats, stats: *mut ip_vs_stats) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_estimator_net_init(ipvs: *mut netns_ipvs) -> int __net_init {
    int __net_init ip_vs_estimator_net_init(struct netns_ipvs *ipvs)
    {
    INIT_HLIST_HEAD(&ipvs.est_temp_list);
    ipvs.est_kt_arr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_estimator_net_cleanup(ipvs: *mut netns_ipvs) -> void __net_exit {
