...
//! Source: net/netfilter/ipvs/ip_vs_conn.c
#![no_std]
...
pub const CONFIG_IP_VS_TAB_BITS: c_int = 12;

//
// Connection hash size. Default is what was selected at compile time.
//
    let mut ip_vs_conn_tab_bits: static int = CONFIG_IP_VS_TAB_BITS;
...
//
    ...
    {
    let mut a: u64 = (u32)proto << 16 | ( u32)port;
    u64 d;

    if (af == AF_INET6) {
    let mut b: u64 = (u64)addr.all[0] << 32 | addr.all[1];
    let mut c: u64 = (u64)addr.all[2] << 32 | addr.all[3];
    a |= (u64)laddr.all[2] << 32 ^ ( u32)lport;
    c ^= laddr.all[1];
    ...
    a |= (u64)addr.all[0] << 32;
    d = (u64)laddr.all[0] << 32 | ( u32)lport;
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_hash(cp: *mut ip_vs_conn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_unlink(cp: *mut ip_vs_conn) -> bool {
...
// HIT
    ...
    if (!cp) {
    struct netns_ipvs *ipvs = p.ipvs;
    let mut af_id: c_int = ip_vs_af_index(p.af);
    if (atomic_read(&ipvs.no_cport_conns[af_id])) {
    let mut cport_zero_p: ip_vs_conn_param = *p;
...
//
#[no_mangle]
unsafe extern "C" fn __ip_vs_conn_put_timer(cp: *mut ip_vs_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_put(cp: *mut ip_vs_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_fill_cport(cp: *mut ip_vs_conn, cport: __be16) {
    void ip_vs_conn_fill_cport(struct ip_vs_conn *cp, __be16 cport)
    {
    struct hlist_bl_head *head, *head2, *head_new;
    let mut use2: bool = ip_vs_conn_use_hash2(cp);
    struct netns_ipvs *ipvs = cp.ipvs;
    let mut af_id: c_int = ip_vs_af_index(cp.af);
    let mut hash_r: u32 = 0, hash_key_r = 0;
    struct ip_vs_rht *t, *tp, *t2;
    struct ip_vs_conn_hnode *hn;
    u32 hash_key, hash_key_new;
    struct ip_vs_conn_param p;
    let mut by_me: bool = false;
    int ntbl;
    int dir;
    restart:
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_change_fwd_mask(cp: *mut ip_vs_conn, new_flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_default_load_factor(ipvs: *mut netns_ipvs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn conn_resize_work_handler(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_bind_xmit(cp: *mut ip_vs_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_bind_xmit_v6(cp: *mut ip_vs_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_try_bind_dest(cp: *mut ip_vs_conn) {
...
// Update its packet transmitter
    cp.packet_xmit = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_unbind_dest(cp: *mut ip_vs_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_check_template(ct: *mut ip_vs_conn, cdest: *mut ip_vs_dest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_rcu_free(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_del(cp: *mut ip_vs_conn) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_del_put(cp: *mut ip_vs_conn) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_expire(t: *mut timer_list) {
    static void ip_vs_conn_expire(struct timer_list *t)
    {
...
// does anybody control me?
    if (ct) {
    let mut has_ref: bool = !cp.timeout && __ip_vs_conn_get(ct);
...
// Increment conn_count up to conn_max
    let mut count: c_int = atomic_read(&ipvs.conn_count);
    let mut max: c_int = sysctl_conn_max(ipvs);
    do {
    if (count >= max)
    return core::ptr::null_mut();
...
// proto should only be IPPROTO_IP if p->vaddr is a fwmark
    ...
    cp.pe = core::ptr::null_mut();
    cp.pe_data = core::ptr::null_mut();
    cp.pe_data_len = 0;
    }
...
//
    ...
    cp.control = core::ptr::null_mut();
    atomic_set(&cp.n_control, 0);
    atomic_set(&cp.in_pkts, 0);
    cp.packet_xmit = core::ptr::null_mut();
    cp.app = core::ptr::null_mut();
    cp.app_data = core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_vs_iter_state {
    pub p: seq_net_private,
    pub t: *mut ip_vs_rht,
    pub gen: c_int,
    pub bucket: u32,
    pub skip_elems: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_sync_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn todrop_entry(cp: *mut ip_vs_conn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_ops_mode(cp: *mut ip_vs_conn) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_random_dropentry(ipvs: *mut netns_ipvs) {
...
//
    ...
    let mut hash: c_uint = (r + idx) & t.mask;
...
#[no_mangle]
unsafe extern "C" fn ip_vs_conn_flush(ipvs: *mut netns_ipvs) {
...
//
    t = rcu_dereference_protected(ipvs.conn_tab, 1);
    rcu_assign_pointer(ipvs.conn_tab, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_expire_nodest_conn_flush(ipvs: *mut netns_ipvs) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_net_init(ipvs: *mut netns_ipvs) -> int __net_init {
    ...
    RCU_INIT_POINTER(ipvs.conn_tab, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_net_cleanup(ipvs: *mut netns_ipvs) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_init() -> int __init {
    int __init ip_vs_conn_init(void)
    {
    let mut min: c_int = IP_VS_CONN_TAB_MIN_BITS;
    let mut max: c_int = IP_VS_CONN_TAB_MAX_BITS;
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_conn_cleanup() {
