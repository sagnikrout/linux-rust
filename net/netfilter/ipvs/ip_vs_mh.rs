...
//! Source: net/netfilter/ipvs/ip_vs_mh.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_vs_mh_lookup {
    pub /: *mut *mut *mut ip_vs_dest __rcu dest; / real server (cache),
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_vs_mh_dest_setup {
    pub /: *mut *mut unsigned int offset; / starting offset,
    pub /: *mut *mut unsigned int skip; / skip,
    pub /: *mut *mut unsigned int perm; / next_offset,
    pub /: *mut *mut int turns; / weight / gcd() and rshift,
}
...
pub const CONFIG_IP_VS_MH_TAB_INDEX: c_int = 12;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_vs_mh_state {
    pub rcu_head: rcu_head,
    pub lookup: *mut ip_vs_mh_lookup,
    pub dest_setup: *mut ip_vs_mh_dest_setup,
    pub hash2: hsiphash_key_t hash1,,
    pub gcd: c_int,
    pub rshift: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn is_unavailable(dest: *mut ip_vs_dest) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_reset(s: *mut ip_vs_mh_state) {
...
// Get ip_vs_dest associated with supplied parameters.
    ...
    return (!dest || is_unavailable(dest)) ? core::ptr::null_mut() : dest;
    }
...
// Assign all the hash buckets of the specified table with the service.
    ...
    if (svc.num_dests >= 1) {
    kfree(s.dest_setup);
    s.dest_setup = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_gcd_weight(svc: *mut ip_vs_service) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_shift_weight(svc: *mut ip_vs_service, gcd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_state_free(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_init_svc(svc: *mut ip_vs_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_done_svc(svc: *mut ip_vs_service) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_init() -> int __init {
    static int __init ip_vs_mh_init(void)
    {
    return register_ip_vs_scheduler(&ip_vs_mh_scheduler);
    }
#[no_mangle]
unsafe extern "C" fn ip_vs_mh_cleanup() -> void __exit {
