...
//! Source: net/netfilter/ipvs/ip_vs_ftp.c
#![no_std]
...
//
    let mut ports_count: static unsigned int = 1;
...
//
    ...
    .bind_conn =	core::ptr::null_mut(),
    .unbind_conn =	core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn __ip_vs_ftp_init(net: *mut net) -> int __net_init {
...
//
#[no_mangle]
unsafe extern "C" fn __ip_vs_ftp_exit(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_ftp_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_ftp_exit() -> void __exit {
