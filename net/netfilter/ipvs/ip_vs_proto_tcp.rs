...
//! Source: net/netfilter/ipvs/ip_vs_proto_tcp.c
#![no_std]
...
// NF_ACCEPT
    ...
    {
    struct tcphdr *tcph;
    let mut tcphoff: c_uint = iph.len;
...
pub const TCP_DIR_INPUT: c_int = 0;
pub const TCP_DIR_OUTPUT: c_int = 4;
pub const TCP_DIR_INPUT_ONLY: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcp_states_t {
    pub next_state: [c_int; IP_VS_TCP_S_LAST],
}

#[no_mangle]
unsafe extern "C" fn tcp_state_name(state: c_int) -> *const c_char {
...
#[no_mangle]
unsafe extern "C" fn tcp_state_active(state: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcp_timeout_change(pd: *mut ip_vs_proto_data, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_state_idx(th: *mut tcphdr) -> c_int {
    ...
    {
    int state_idx;
    let mut new_state: c_int = IP_VS_TCP_S_CLOSE;
    let mut state_off: c_int = tcp_state_off[direction];
//
...
#[no_mangle]
pub unsafe extern "C" fn tcp_app_hashkey(port: __be16) -> __u16 {
    static inline __u16 tcp_app_hashkey(__be16 port)
    {
    return ((( u16)port >> TCP_APP_TAB_BITS) ^ ( u16)port)
    & TCP_APP_TAB_MASK;
    }
#[no_mangle]
unsafe extern "C" fn tcp_register_app(ipvs: *mut netns_ipvs, inc: *mut ip_vs_app) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_tcp_conn_listen(cp: *mut ip_vs_conn) {
...
//
#[no_mangle]
unsafe extern "C" fn __ip_vs_tcp_init(ipvs: *mut netns_ipvs, pd: *mut ip_vs_proto_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ip_vs_tcp_exit(ipvs: *mut netns_ipvs, pd: *mut ip_vs_proto_data) {
