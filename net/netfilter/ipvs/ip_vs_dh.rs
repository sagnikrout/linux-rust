...
//! Source: net/netfilter/ipvs/ip_vs_dh.c
#![no_std]
...
pub const CONFIG_IP_VS_DH_TAB_BITS: c_int = 8;
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_dh_hashkey(af: c_int, addr: *const union nf_inet_addr) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_dh_flush(s: *mut ip_vs_dh_state) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_dh_init_svc(svc: *mut ip_vs_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_dh_done_svc(svc: *mut ip_vs_service) {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_overloaded(dest: *mut ip_vs_dest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_dh_init() -> int __init {
    static int __init ip_vs_dh_init(void)
    {
    return register_ip_vs_scheduler(&ip_vs_dh_scheduler);
    }
#[no_mangle]
unsafe extern "C" fn ip_vs_dh_cleanup() -> void __exit {
