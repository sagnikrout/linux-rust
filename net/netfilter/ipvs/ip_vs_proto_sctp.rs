...
//! Source: net/netfilter/ipvs/ip_vs_proto_sctp.c
#![no_std]
...
// NF_ACCEPT
    ...
    let mut sctphoff: c_uint = iph.len;
...
//
    ...
    let mut clen: c_int = ntohs(sch.length);
...
#[no_mangle]
pub unsafe extern "C" fn sctp_app_hashkey(port: __be16) -> __u16 {
    static inline __u16 sctp_app_hashkey(__be16 port)
    {
    return ((( u16)port >> SCTP_APP_TAB_BITS) ^ ( u16)port)
    & SCTP_APP_TAB_MASK;
    }
#[no_mangle]
unsafe extern "C" fn sctp_register_app(ipvs: *mut netns_ipvs, inc: *mut ip_vs_app) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_unregister_app(ipvs: *mut netns_ipvs, inc: *mut ip_vs_app) {
...
#[no_mangle]
unsafe extern "C" fn sctp_app_conn_bind(cp: *mut ip_vs_conn) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __ip_vs_sctp_init(ipvs: *mut netns_ipvs, pd: *mut ip_vs_proto_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ip_vs_sctp_exit(ipvs: *mut netns_ipvs, pd: *mut ip_vs_proto_data) {
