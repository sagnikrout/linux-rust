...
//! Source: net/netfilter/ipvs/ip_vs_ctl.c
#![no_std]
...
// sysctl variables
    ...
    let mut sysctl_ip_vs_debug_level: static int = 0;
#[no_mangle]
pub unsafe extern "C" fn ip_vs_get_debug_level() -> c_int {
...
// Taken from rt6_fill_node() in net/ipv6/route.c, is there a better way?
    ...
    struct dst_entry *dst = ip6_route_output(net, core::ptr::null_mut(), &fl6);
    bool is_local;
...
//
#[no_mangle]
unsafe extern "C" fn update_defense_level(ipvs: *mut netns_ipvs) {
...
//
#[no_mangle]
unsafe extern "C" fn expire_nodest_conn_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn defense_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn est_reload_work_handler(work: *mut work_struct) {
    static void est_reload_work_handler(struct work_struct *work)
    {
    struct netns_ipvs *ipvs =
    container_of(work, struct netns_ipvs, est_reload_work.work);
    let mut genid_done: c_int = atomic_read(&ipvs.est_genid_done);
...
#[no_mangle]
unsafe extern "C" fn get_conn_tab_size(ipvs: *mut netns_ipvs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_svc_hash(svc: *mut ip_vs_service) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_svc_unhash(svc: *mut ip_vs_service) -> c_int {
...
// Find service, called under RCU lock
    ...
    const union nf_inet_addr *vaddr, __be16 vport)
    {
    struct ip_vs_service *svc = core::ptr::null_mut();
    let mut af_id: c_int = ip_vs_af_index(af);
//
...
#[no_mangle]
unsafe extern "C" fn ip_vs_get_num_services(ipvs: *mut netns_ipvs) -> c_int {
    static int ip_vs_get_num_services(struct netns_ipvs *ipvs)
    {
    let mut ns: c_int = 0, ni = IP_VS_AF_MAX;
    while (--ni >= 0)
...
#[no_mangle]
unsafe extern "C" fn ip_vs_svc_default_load_factor(ipvs: *mut netns_ipvs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_resize_work_handler(work: *mut work_struct) {
    static void svc_resize_work_handler(struct work_struct *work)
    {
    struct hlist_bl_head *head, *head2;
    struct ip_vs_rht *t_free = core::ptr::null_mut();
    let mut resched_score: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn ip_vs_service_free(svc: *mut ip_vs_service) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_service_rcu_free(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn __ip_vs_svc_put(svc: *mut ip_vs_service) {
...
//
    ...
    __be16 port)
    {
    let mut porth: c_uint = ntohs(port);
...
#[no_mangle]
unsafe extern "C" fn ip_vs_rs_hash(ipvs: *mut netns_ipvs, dest: *mut ip_vs_dest) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_rs_unhash(dest: *mut ip_vs_dest) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_dest_dst_rcu_free(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn __ip_vs_dst_cache_reset(dest: *mut ip_vs_dest) {
    static void __ip_vs_dst_cache_reset(struct ip_vs_dest *dest)
    {
    struct ip_vs_dest_dst *old;
    old = rcu_dereference_protected(dest.dest_dst, 1);
    if (old) {
    RCU_INIT_POINTER(dest.dest_dst, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ip_vs_dest_rcu_free(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_dest_free(dest: *mut ip_vs_dest) {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_trash_cleanup(ipvs: *mut netns_ipvs) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_stats_rcu_free(head: *mut rcu_head) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_stats_init_alloc(s: *mut ip_vs_stats) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_stats_release(stats: *mut ip_vs_stats) {
    void ip_vs_stats_release(struct ip_vs_stats *stats)
    {
    free_percpu(stats.cpustats);
    }
#[no_mangle]
pub unsafe extern "C" fn ip_vs_stats_free(stats: *mut ip_vs_stats) {
...
//
#[no_mangle]
unsafe extern "C" fn __ip_vs_dest_update_overload(dest: *mut ip_vs_dest, mode: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_dest_update_overload(dest: *mut ip_vs_dest, mode: c_int) {
...
//
    ...
    let mut dport: __be16 = udest.port;
    int ret;
    if (udest.weight < 0) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_dest_trash_expire(t: *mut timer_list) {
...
//
    ...
    {
    struct ip_vs_scheduler *sched = core::ptr::null_mut();
    struct ip_vs_rht *tc_new = core::ptr::null_mut();
    struct ip_vs_rht *t, *t_new = core::ptr::null_mut();
    let mut af_id: c_int = ip_vs_af_index(u.af);
    struct ip_vs_service *svc = core::ptr::null_mut();
    struct ip_vs_pe *pe = core::ptr::null_mut();
    let mut ret_hooks: c_int = -1;
    let mut ret: c_int = 0;
    bool grow;
...
// Lookup the scheduler by 'u->sched_name'
    ...
    if (u.af == AF_INET6) {
    let mut plen: __u32 = ( __u32) u.netmask;
    if (plen < 1 || plen > 128) {
    ret = -EINVAL;
    goto out_err;
    }
...
// The old table can be freed, protect it with RCU
    ...
    t = rcu_dereference(ipvs.svc_table);
    if (!t) {
    let mut lfactor: c_int = sysctl_svc_lfactor(ipvs);
    let mut new_size: c_int = ip_vs_svc_desired_size(ipvs, core::ptr::null_mut(), lfactor);
    rcu_read_unlock();
    t_new = ip_vs_svc_table_alloc(ipvs, new_size, lfactor);
    if (!t_new) {
    ret = -ENOMEM;
...
// Even the currently attached new table may need to grow
    ...
    let mut lfactor: c_int = sysctl_conn_lfactor(ipvs);
    let mut new_size: c_int = ip_vs_conn_desired_size(ipvs, core::ptr::null_mut(), lfactor);
...
// Add table for first time
    ...
    rcu_assign_pointer(ipvs.svc_table, t_new);
    t_new = core::ptr::null_mut();
    }
    if (tc_new) {
    rcu_assign_pointer(ipvs.conn_tab, tc_new);
    tc_new = core::ptr::null_mut();
    }
// Update the virtual service counters
    if (svc.port == FTPPORT)
    atomic_inc(&ipvs.ftpsvc_counter[af_id]);
#[no_mangle]
pub unsafe extern "C" fn if(!svc->fwmark: !svc->port &&) -> else {
...
//
    ...
    {
    struct ip_vs_scheduler *sched = core::ptr::null_mut(), *old_sched;
    struct ip_vs_pe *pe = core::ptr::null_mut(), *old_pe = core::ptr::null_mut();
    let mut ret: c_int = 0;
    bool new_pe_conn_out, old_pe_conn_out;
    struct netns_ipvs *ipvs = svc.ipvs;
    let mut af_id: c_int = ip_vs_af_index(svc.af);
//
// Lookup the scheduler, by 'u->sched_name'
//
    if (strcmp(u.sched_name, "none")) {
...
//
#[no_mangle]
unsafe extern "C" fn __ip_vs_del_service(svc: *mut ip_vs_service, cleanup: bool) {
    static void __ip_vs_del_service(struct ip_vs_service *svc, bool cleanup)
    {
    struct ip_vs_dest *dest, *nxt;
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_unlink_service(svc: *mut ip_vs_service, cleanup: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_del_service(svc: *mut ip_vs_service) -> c_int {
...
// Stop the resizer and drop the tables
    ...
    t = rcu_dereference_protected(ipvs.svc_table, 1);
    if (t) {
    rcu_assign_pointer(ipvs.svc_table, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_flush(ipvs: *mut netns_ipvs, cleanup: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_vs_service_nets_cleanup(net_list: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_zero_service(svc: *mut ip_vs_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_zero_all(ipvs: *mut netns_ipvs) -> c_int {
...
//
    let mut unset: c_int = INT_MIN;
    let mut val: c_int = write ? unset : READ_ONCE(*valp);
    int rc;
    ...
    let mut priv: bool = capable(CAP_NET_ADMIN);
    int max;
    mutex_lock(&ipvs.service_mutex);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_vs_iter {
    pub it*/: *mut *mut seq_net_private p; / Do not move this, netns depends upon,
    pub t: *mut ip_vs_rht,
    pub bucket: u32,
}
...
#[no_mangle]
unsafe extern "C" fn ip_vs_info_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_info_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_stats_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_stats_percpu_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_status_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_set_timeout(ipvs: *mut netns_ipvs, u: *mut ip_vs_timeout_user) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_vs_svcdest_user {
    pub s: ip_vs_service_user,
    pub d: ip_vs_dest_user,
}
...
// Lookup the exact service by <protocol, addr, port> or fwmark
    ...
    && (svc == core::ptr::null_mut() || svc.protocol != usvc.protocol)) {
    ret = -ESRCH;
    goto out_unlock;
    }
    switch (cmd) {
...
// Only expose IPv4 entries to old interface
    ...
    {
    struct ip_vs_service *svc;
    let mut addr: union nf_inet_addr = { .ip = get.addr };
    let mut ret: c_int = 0;
    rcu_read_lock();
    if (get.fwmark)
...
#[no_mangle]
unsafe extern "C" fn ip_vs_is_af_valid(af: c_int) -> bool {
...
// Parse mandatory identifying service fields first
    ...
    nla_parse_nested_deprecated(attrs, IPVS_SVC_ATTR_MAX, nla, ip_vs_svc_policy, core::ptr::null_mut()))
    return -EINVAL;
...
// set new flags from userland
    ...
    usvc.pe_name = nla_pe ? nla_data(nla_pe) : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_fill_dest(skb: *mut sk_buff, dest: *mut ip_vs_dest) -> c_int {
...
// Parse mandatory identifying destination fields first
    if (nla == core::ptr::null_mut() ||
    nla_parse_nested_deprecated(attrs, IPVS_DEST_ATTR_MAX, nla, ip_vs_dest_policy, core::ptr::null_mut()))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_new_daemon(ipvs: *mut netns_ipvs, attrs: *mut nlattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_del_daemon(ipvs: *mut netns_ipvs, attrs: *mut nlattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_set_config(ipvs: *mut netns_ipvs, attrs: *mut nlattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_set_daemon(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int ip_vs_genl_set_daemon(struct sk_buff *skb, struct genl_info *info)
    {
    let mut ret: c_int = -EINVAL, cmd;
    struct net *net = sock_net(skb.sk);
    struct netns_ipvs *ipvs = net_ipvs(net);
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_set_cmd(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int ip_vs_genl_set_cmd(struct sk_buff *skb, struct genl_info *info)
    {
    let mut need_full_svc: bool = false, need_full_dest = false;
    struct ip_vs_service *svc = core::ptr::null_mut();
    struct ip_vs_service_user_kern usvc;
    struct ip_vs_dest_user_kern udest;
    let mut ret: c_int = 0, cmd;
    struct net *net = sock_net(skb.sk);
    struct netns_ipvs *ipvs = net_ipvs(net);
    cmd = info.genlhdr.cmd;
    mutex_lock(&ipvs.service_mutex);
...
// Unless we're adding a new service, the service must already exist
    if ((cmd != IPVS_CMD_NEW_SERVICE) && (svc == core::ptr::null_mut())) {
    ret = -ESRCH;
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_get_cmd(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IPVS_CMD_GET_INFO: cmd ==) -> else {
    else if (cmd == IPVS_CMD_GET_INFO)
    reply_cmd = IPVS_CMD_SET_INFO;
#[no_mangle]
pub unsafe extern "C" fn if(IPVS_CMD_GET_CONFIG: cmd ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_register() -> int __init {
    static int __init ip_vs_genl_register(void)
    {
    return genl_register_family(&ip_vs_genl_family);
    }
#[no_mangle]
unsafe extern "C" fn ip_vs_genl_unregister() {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_control_net_init_sysctl(ipvs: *mut netns_ipvs) -> int __net_init {
    static int __net_init ip_vs_control_net_init_sysctl(struct netns_ipvs *ipvs)
    {
    struct net *net = ipvs.net;
    struct ctl_table *tbl;
    int idx, ret;
    let mut ctl_table_size: usize = ARRAY_SIZE(vs_vars);
    let mut unpriv: bool = net.user_ns != &init_user_ns;
    atomic_set(&ipvs.dropentry, 0);
...
#[no_mangle]
unsafe extern "C" fn ip_vs_control_net_cleanup_sysctl(ipvs: *mut netns_ipvs) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_control_net_init(ipvs: *mut netns_ipvs) -> int __net_init {
...
// Initialize service_mutex, svc_table per netns
    ...
    RCU_INIT_POINTER(ipvs.svc_table, core::ptr::null_mut());
// Initialize rs_table
...
// procfs stats
    ...
    ip_vs_stats_show, core::ptr::null_mut()))
    goto err_stats;
    if (!proc_create_net_single("ip_vs_stats_percpu", 0,
    ipvs.net.proc_net,
    ip_vs_stats_percpu_show, core::ptr::null_mut()))
    goto err_percpu;
    if (!proc_create_net_single("ip_vs_status", 0440, ipvs.net.proc_net,
    ip_vs_status_show, core::ptr::null_mut()))
    goto err_status;
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_control_net_cleanup(ipvs: *mut netns_ipvs) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_register_nl_ioctl() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_unregister_nl_ioctl() {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_control_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ip_vs_control_cleanup() {
