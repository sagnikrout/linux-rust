...
//! Source: net/netfilter/ipvs/ip_vs_sh.c
#![no_std]
...
pub const CONFIG_IP_VS_SH_TAB_BITS: c_int = 8;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip_vs_sh_state {
    pub rcu_head: rcu_head,
    pub buckets: [ip_vs_sh_bucket; IP_VS_SH_TAB_SIZE],
}
...
//
    ...
    {
    let mut hash: c_uint = ip_vs_sh_hashkey(svc.af, addr, port, 0);
...
//
    ...
    ip_vs_dest_put(dest);
    if (empty)
    RCU_INIT_POINTER(b.dest, core::ptr::null_mut());
    else {
...
//
#[no_mangle]
unsafe extern "C" fn ip_vs_sh_flush(s: *mut ip_vs_sh_state) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_sh_init_svc(svc: *mut ip_vs_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_sh_done_svc(svc: *mut ip_vs_service) {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_sh_init() -> int __init {
    static int __init ip_vs_sh_init(void)
    {
    return register_ip_vs_scheduler(&ip_vs_sh_scheduler);
    }
#[no_mangle]
unsafe extern "C" fn ip_vs_sh_cleanup() -> void __exit {
