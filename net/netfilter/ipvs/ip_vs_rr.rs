...
//! Source: net/netfilter/ipvs/ip_vs_rr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ip_vs_rr_init_svc(svc: *mut ip_vs_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_vs_rr_del_dest(svc: *mut ip_vs_service, dest: *mut ip_vs_dest) -> c_int {
...
//
    ...
    .add_dest =		core::ptr::null_mut(),
    .del_dest =		ip_vs_rr_del_dest,
    .schedule =		ip_vs_rr_schedule,
    };
#[no_mangle]
unsafe extern "C" fn ip_vs_rr_init() -> int __init {
    static int __init ip_vs_rr_init(void)
    {
    return register_ip_vs_scheduler(&ip_vs_rr_scheduler);
    }
#[no_mangle]
unsafe extern "C" fn ip_vs_rr_cleanup() -> void __exit {
