...
//! Source: net/netfilter/nf_bpf_link.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bpf_nf_link {
    pub link: bpf_link,
    pub hook_ops: nf_hook_ops,
    pub ns_tracker: netns_tracker,
    pub net: *mut net,
    pub dead: u32,
    pub defrag_hook: *const nf_defrag_hook,
}
...
#[no_mangle]
unsafe extern "C" fn bpf_nf_enable_defrag(link: *mut bpf_nf_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_nf_disable_defrag(link: *mut bpf_nf_link) {
...
#[no_mangle]
unsafe extern "C" fn bpf_nf_link_detach(link: *mut bpf_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_nf_check_pf_and_hooks(attr: *const union bpf_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(NF_IP_PRI_LAST: prio ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_nf_link_attach(attr: *const union bpf_attr, prog: *mut bpf_prog) -> c_int {
    ...
    link.net = net;
    link.dead = false;
    link.defrag_hook = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nf_ptr_to_btf_id(info: *mut bpf_insn_access_aux, name: *const c_char) -> bool {
