...
//! Source: net/netfilter/nft_synproxy.c
#![no_std]
...
pub struct nft_synproxy {
    ...
    {
    let mut info: nf_synproxy_info = READ_ONCE(priv.info);
...
// ACK from client
    ...
    struct sk_buff *skb = pkt.skb;
    let mut thoff: c_int = nft_thoff(pkt);
    const struct tcphdr *tcp;
    struct tcphdr _tcph;
...
#[no_mangle]
unsafe extern "C" fn nft_synproxy_do_destroy(ctx: *const nft_ctx) {
...
#[no_mangle]
unsafe extern "C" fn nft_synproxy_do_dump(skb: *mut sk_buff, priv: *mut nft_synproxy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nft_synproxy_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nft_synproxy_module_exit() -> void __exit {
