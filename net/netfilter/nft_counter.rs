...
//! Source: net/netfilter/nft_counter.c
#![no_std]
...
pub struct nft_counter_percpu_priv {
    pub counter: *mut nft_counter __percpu,
}
...
// control plane only: sync fetch+reset
    ...
    if (cpu_stats == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn nft_counter_do_destroy(priv: *mut nft_counter_percpu_priv) {
...
#[no_mangle]
unsafe extern "C" fn nft_counter_clone(dst: *mut nft_expr, src: *const nft_expr, gfp: gfp_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nft_counter_init_seqcount() {
