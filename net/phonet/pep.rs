...
//
pub const CREDITS_MAX: c_int = 10;
pub const CREDITS_THR: c_int = 7;
...
// Get the next TLV sub-block.
    ...
    let mut buflen: c_int = *plen;
    ph = skb_header_pointer(skb, 0, 2, &h);
    if (ph == core::ptr::null_mut() || ph.sb_len < 2 || !pskb_may_pull(skb, ph.sb_len))
...
// plen = ph->sb_len;
    ...
    ph.error_code = code;
    return pn_skb_send(sk, skb, core::ptr::null_mut());
    }
pub const PAD: c_uint = 0x00;
...
#[no_mangle]
unsafe extern "C" fn pipe_handler_send_created_ind(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pep_accept_conn(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pipe_snd_status(sk: *mut sock, type: u8, status: u8, priority: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pipe_grant_credits(sk: *mut sock, priority: gfp_t) {
...
#[no_mangle]
unsafe extern "C" fn pipe_rcv_status(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pipe_rcv_created(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int pipe_rcv_created(struct sock *sk, struct sk_buff *skb)
    {
    struct pep_sock *pn = pep_sk(sk);
    struct pnpipehdr *hdr = pnp_hdr(skb);
    let mut n_sb: u8 = hdr.data0;
...
#[no_mangle]
unsafe extern "C" fn pipe_do_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    pep_reply(sk, skb, PN_PIPE_NO_ERROR, core::ptr::null_mut(), 0, GFP_ATOMIC);
...
#[no_mangle]
unsafe extern "C" fn pipe_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn pipe_negotiate_fc(fcs: *const u8, n: c_uint) -> u8 {
    static u8 pipe_negotiate_fc(const u8 *fcs, unsigned int n)
    {
    unsigned int i;
    let mut final_fc: u8 = PN_NO_FLOW_CONTROL;
    for (i = 0; i < n; i++) {
    let mut fc: u8 = fcs[i];
...
#[no_mangle]
unsafe extern "C" fn pep_connresp_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pep_enableresp_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    core::ptr::null_mut(), 0, GFP_ATOMIC);
    }
#[no_mangle]
unsafe extern "C" fn pipe_start_flow_control(sk: *mut sock) {
...
// Socket lock must be held.
#[no_mangle]
unsafe extern "C" fn pipe_handler_do_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
// Listening sock must be locked
    ...
    {
    struct sock *sknode;
    let mut dobj: u16 = pn_sockaddr_get_object(dst);
...
//
#[no_mangle]
unsafe extern "C" fn pep_do_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pipe_do_remove(sk: *mut sock) -> c_int {
    static int pipe_do_remove(struct sock *sk)
    {
    struct pep_sock *pn = pep_sk(sk);
    struct pnpipehdr *ph;
    struct sk_buff *skb;
    skb = pep_alloc_skb(sk, core::ptr::null_mut(), 0, GFP_KERNEL);
    if (!skb)
    return -ENOMEM;
    ph = pnp_hdr(skb);
    ph.utid = 0;
...
#[no_mangle]
unsafe extern "C" fn pep_sock_close(sk: *mut sock, timeout: c_long) {
...
// Create a new to-be-accepted sock
    ...
    sock_init_data(core::ptr::null_mut(), newsk);
...
#[no_mangle]
unsafe extern "C" fn pep_sock_enable(sk: *mut sock, addr: *mut sockaddr, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pep_first_packet_length(sk: *mut sock) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pep_ioctl(sk: *mut sock, cmd: c_int, karg: *mut c_int) -> c_int {
...
// karg = pep_first_packet_length(sk);
    ...
    ret =  -EBUSY;
#[no_mangle]
pub unsafe extern "C" fn if(TCP_ESTABLISHED: sk->sk_state ==) -> else {
    else if (sk.sk_state == TCP_ESTABLISHED)
    ret = -EISCONN;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !pn->pn_sk.sobject) -> else {
    else if (!pn.pn_sk.sobject)
    ret = -EADDRNOTAVAIL;
    else
    ret = pep_sock_enable(sk, core::ptr::null_mut(), 0);
    release_sock(sk);
    break;
    }
    return ret;
...
#[no_mangle]
unsafe extern "C" fn pep_init(sk: *mut sock) -> c_int {
    static int pep_init(struct sock *sk)
    {
    struct pep_sock *pn = pep_sk(sk);
    sk.sk_destruct = pipe_destruct;
    INIT_HLIST_HEAD(&pn.hlist);
    pn.listener = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn do_pep_getsockopt(sk: *mut sock, optname: c_int, opt: *mut sockopt_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pipe_skb_send(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    ph.pipe_handle = pn.pipe_handle;
    err = pn_skb_send(sk, skb, core::ptr::null_mut());
    if (err && pn_flow_safe(pn.tx_fc))
    atomic_inc(&pn.tx_credits);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn pep_sendmsg(sk: *mut sock, msg: *mut msghdr, len: usize) -> c_int {
    static int pep_sendmsg(struct sock *sk, struct msghdr *msg, size_t len)
    {
    struct pep_sock *pn = pep_sk(sk);
    struct sk_buff *skb;
    long timeo;
    let mut flags: c_int = msg.msg_flags;
    int err, done;
    if (len > USHRT_MAX)
    return -EMSGSIZE;
...
#[no_mangle]
pub unsafe extern "C" fn pep_writeable(sk: *mut sock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pep_write(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pep_sock_unhash(sk: *mut sock) {
    static void pep_sock_unhash(struct sock *sk)
    {
    struct pep_sock *pn = pep_sk(sk);
    struct sock *skparent = core::ptr::null_mut();
    lock_sock(sk);
    if (pn.listener != core::ptr::null_mut()) {
