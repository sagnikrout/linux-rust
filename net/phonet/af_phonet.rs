...
#[no_mangle]
pub unsafe extern "C" fn phonet_proto_put(pp: *const phonet_protocol) {
...
// Broadcast sending is not implemented
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), skb.len);
    if (err < 0) {
    err = -EHOSTUNREACH;
    goto drop;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: phonet_address_lookup(net, 0: daddr) ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn can_respond(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_obj_unreachable(rskb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_reset_indications(rskb: *mut sk_buff) -> c_int {
...
// Some drivers (e.g. TUN) do not allocate HW header space
    ...
    goto out_dev;
    if (dev_hard_header(skb, out_dev, ETH_P_PHONET, core::ptr::null_mut(), core::ptr::null_mut(),
    skb.len) < 0)
    goto out_dev;
    dev_queue_xmit(skb);
    dev_put(out_dev);
    ...
    RCU_INIT_POINTER(proto_tab[protocol], core::ptr::null_mut());
    mutex_unlock(&proto_tab_lock);
    synchronize_rcu();
...
// Module registration
#[no_mangle]
unsafe extern "C" fn phonet_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn phonet_exit() -> void __exit {
