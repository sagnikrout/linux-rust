...
//
    ...
    let mut __read_mostly: static unsigned int mrp_join_time = 200;
    module_param(mrp_join_time, uint, 0644);
    MODULE_PARM_DESC(mrp_join_time, "Join time in ms (default 200ms)");
    let mut __read_mostly: static unsigned int mrp_periodic_time = 1000;
...
#[no_mangle]
unsafe extern "C" fn mrp_attrvalue_inc(value: *mut c_void, len: u8) {
...
pub unsafe extern "C" fn if(0: d <) -> else {
    ...
    const void *value, u8 len, u8 type)
    {
    struct rb_node *parent = core::ptr::null_mut(), **p = &app.mad.rb_node;
    struct mrp_attr *attr;
    int d;
    while (*p) {
    parent = *p;
...
#[no_mangle]
unsafe extern "C" fn mrp_attr_destroy(app: *mut mrp_applicant, attr: *mut mrp_attr) {
...
#[no_mangle]
unsafe extern "C" fn mrp_attr_destroy_all(app: *mut mrp_applicant) {
    static void mrp_attr_destroy_all(struct mrp_applicant *app)
    {
    struct rb_node *node, *next;
    struct mrp_attr *attr;
    for (node = rb_first(&app.mad);
    next = node ? rb_next(node) : core::ptr::null_mut(), node != core::ptr::null_mut();
    node = next) {
...
#[no_mangle]
unsafe extern "C" fn mrp_pdu_init(app: *mut mrp_applicant) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mrp_pdu_append_end_mark(app: *mut mrp_applicant) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mrp_pdu_queue(app: *mut mrp_applicant) {
    ...
    app.pdu = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mrp_queue_xmit(app: *mut mrp_applicant) {
    ...
    return -1;
    mrp_cb(app.pdu).mh = core::ptr::null_mut();
    mrp_cb(app.pdu).vah = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mrp_mad_event(app: *mut mrp_applicant, event: enum mrp_event) {
...
#[no_mangle]
unsafe extern "C" fn mrp_join_timer_arm(app: *mut mrp_applicant) {
...
#[no_mangle]
unsafe extern "C" fn mrp_join_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mrp_periodic_timer_arm(app: *mut mrp_applicant) {
...
#[no_mangle]
unsafe extern "C" fn mrp_periodic_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mrp_pdu_parse_end_mark(skb: *mut sk_buff, offset: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mrp_init_port(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mrp_release_port(dev: *mut net_device) {
    ...
    RCU_INIT_POINTER(dev.mrp_port, core::ptr::null_mut());
    kfree_rcu(port, rcu);
    }
#[no_mangle]
pub unsafe extern "C" fn mrp_init_applicant(dev: *mut net_device, appl: *mut mrp_application) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mrp_uninit_applicant(dev: *mut net_device, appl: *mut mrp_application) {
    ...
    port.applicants[appl.type]);
    ASSERT_RTNL();
    RCU_INIT_POINTER(port.applicants[appl.type], core::ptr::null_mut());
    spin_lock_bh(&app.lock);
    app.active = false;
    spin_unlock_bh(&app.lock);
...
#[no_mangle]
pub unsafe extern "C" fn mrp_register_application(appl: *mut mrp_application) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mrp_unregister_application(appl: *mut mrp_application) {
