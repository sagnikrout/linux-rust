...
//
    ...
    let mut __read_mostly: static unsigned int garp_join_time = 200;
...
pub unsafe extern "C" fn if(0: d <) -> else {
    ...
    const void *data, u8 len, u8 type)
    {
    struct rb_node *parent = core::ptr::null_mut(), **p = &app.gid.rb_node;
    struct garp_attr *attr;
    int d;
    while (*p) {
    parent = *p;
...
#[no_mangle]
unsafe extern "C" fn garp_attr_destroy(app: *mut garp_applicant, attr: *mut garp_attr) {
...
#[no_mangle]
unsafe extern "C" fn garp_attr_destroy_all(app: *mut garp_applicant) {
...
#[no_mangle]
unsafe extern "C" fn garp_pdu_init(app: *mut garp_applicant) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garp_pdu_append_end_mark(app: *mut garp_applicant) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garp_pdu_queue(app: *mut garp_applicant) {
...
#[no_mangle]
unsafe extern "C" fn garp_queue_xmit(app: *mut garp_applicant) {
...
#[no_mangle]
unsafe extern "C" fn garp_pdu_append_msg(app: *mut garp_applicant, attrtype: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garp_gid_event(app: *mut garp_applicant, event: enum garp_event) {
...
#[no_mangle]
unsafe extern "C" fn garp_join_timer_arm(app: *mut garp_applicant) {
...
#[no_mangle]
unsafe extern "C" fn garp_join_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn garp_pdu_parse_end_mark(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garp_pdu_parse_msg(app: *mut garp_applicant, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garp_init_port(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garp_release_port(dev: *mut net_device) {
    ...
    RCU_INIT_POINTER(dev.garp_port, core::ptr::null_mut());
    kfree_rcu(port, rcu);
    }
#[no_mangle]
pub unsafe extern "C" fn garp_init_applicant(dev: *mut net_device, appl: *mut garp_application) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn garp_uninit_applicant(dev: *mut net_device, appl: *mut garp_application) {
...
#[no_mangle]
pub unsafe extern "C" fn garp_register_application(appl: *mut garp_application) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn garp_unregister_application(appl: *mut garp_application) {
