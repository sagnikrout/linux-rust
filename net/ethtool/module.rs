...
// MODULE_SET
    ...
    {
    let mut power: ethtool_module_power_mode_params = {};
...
#[no_mangle]
unsafe extern "C" fn module_flash_fw_work_list_del(list: *mut list_head) {
...
pub const MODULE_EEPROM_PHYS_ID_PAGE: c_int = 0;
pub const MODULE_EEPROM_PHYS_ID_I2C_ADDR: c_uint = 0x50;
...
pub unsafe extern "C" fn ethnl_module_fw_flash_sock_destroy(sk_priv: *mut ethnl_sock_priv) {
    ...
    struct sk_buff *skb, struct genl_info *info)
    {
    let mut params: ethtool_module_fw_flash_params = {};
...
// MODULE_FW_FLASH_NTF
    ...
    params, core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
    }
    void
    ...
    params, core::ptr::null_mut(), core::ptr::null_mut(), done, total);
    }
