...
pub struct tsinfo_reply_data {
    ...
    ret = ethnl_bitset32_size(&ts_info.so_timestamping, core::ptr::null_mut(),
    ...
    if (ts_info.tx_types) {
    ret = ethnl_bitset32_size(&ts_info.tx_types, core::ptr::null_mut(),
    __HWTSTAMP_TX_CNT,
    ...
    ret = ethnl_bitset32_size(&ts_info.rx_filters, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn tsinfo_put_stat(skb: *mut sk_buff, val: u64, attrtype: u16) -> c_int {
    ...
    &ts_info.so_timestamping, core::ptr::null_mut(),
    __SOF_TIMESTAMPING_CNT,
    sof_timestamping_names, compact);
    if (ret < 0)
    return ret;
    ...
    &ts_info.tx_types, core::ptr::null_mut(),
    __HWTSTAMP_TX_CNT,
    ts_tx_type_names, compact);
    if (ret < 0)
    return ret;
    ...
    &ts_info.rx_filters, core::ptr::null_mut(),
    __HWTSTAMP_FILTER_CNT,
    ts_rx_filter_names, compact);
    if (ret < 0)
    return ret;
...
pub struct ethnl_tsinfo_dump_ctx {
    ...
    pub pos_phcqualifier: enum hwtstamp_provider_qualifier,
}
    ...
    if (ret < 0)
    return ret;
    reply_data.base.dev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_tsinfo_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_tsinfo_start(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_tsinfo_done(cb: *mut netlink_callback) -> c_int {
