...
#[no_mangle]
unsafe extern "C" fn pse_cleanup_data(reply_base: *mut ethnl_reply_data) {
...
// These values are already validated by the ethnl_pse_set_policy
    if (tb[ETHTOOL_A_PODL_PSE_ADMIN_CONTROL] ||
    tb[ETHTOOL_A_C33_PSE_ADMIN_CONTROL]) {
    let mut config: pse_control_config = {};
    if (tb[ETHTOOL_A_PODL_PSE_ADMIN_CONTROL])
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_pse_send_ntf(netdev: *mut net_device, notifs: c_ulong) {
