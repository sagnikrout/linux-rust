...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ethtool_devlink_compat {
    pub devlink: *mut devlink,
    union {
    pub efl: ethtool_flash,
    pub info: ethtool_drvinfo,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ethtool_op_get_link(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_features(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_set_features(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    static int ethtool_set_features(struct net_device *dev, void __user *useraddr)
    {
    struct ethtool_sfeatures cmd;
    struct ethtool_set_features_block features[ETHTOOL_DEV_FEATURE_WORDS];
    let mut wanted: netdev_features_t = 0, valid = 0;
    int i, ret = 0;
...
#[no_mangle]
unsafe extern "C" fn __ethtool_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ETH_SS_RSS_HASH_FUNCS: stringset ==) -> else {
    else if (stringset == ETH_SS_RSS_HASH_FUNCS)
    memcpy(data, rss_hash_func_strings,
    sizeof(rss_hash_func_strings));
#[no_mangle]
pub unsafe extern "C" fn if(ETH_SS_TUNABLES: stringset ==) -> else {
    else if (stringset == ETH_SS_TUNABLES)
    memcpy(data, tunable_strings, sizeof(tunable_strings));
#[no_mangle]
pub unsafe extern "C" fn if(ETH_SS_PHY_TUNABLES: stringset ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(ETH_SS_LINK_MODES: stringset ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_feature_mask(eth_cmd: u32) -> netdev_features_t {
...
// feature masks of legacy discrete ethtool ops
    ...
    {
    let mut mask: netdev_features_t = ethtool_get_feature_mask(ethcmd);
    ...
    NETIF_F_RXHASH)
#[no_mangle]
unsafe extern "C" fn __ethtool_get_flags(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __ethtool_set_flags(dev: *mut net_device, data: u32) -> c_int {
    static int __ethtool_set_flags(struct net_device *dev, u32 data)
    {
    let mut features: netdev_features_t = 0, changed;
...
// Given two link masks, AND them together and save the result in dst.
    ...
    {
    let mut size: c_uint = BITS_TO_LONGS(__ETHTOOL_LINK_MODE_MASK_NBITS);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ethtool_link_usettings {
    pub base: ethtool_link_settings,
    struct {
    pub supported: [__u32; __ETHTOOL_LINK_MODE_MASK_NU32],
    pub advertising: [__u32; __ETHTOOL_LINK_MODE_MASK_NU32],
    pub lp_advertising: [__u32; __ETHTOOL_LINK_MODE_MASK_NU32],
    pub link_modes: },
}
...
#[no_mangle]
pub unsafe extern "C" fn ethtool_virtdev_validate_cmd(cmd: *const ethtool_link_ksettings) -> bool {
    bool ethtool_virtdev_validate_cmd(const struct ethtool_link_ksettings *cmd)
    {
    let mut base2: ethtool_link_settings = {};
...
// Update device ethtool_link_settings.
    ...
    void __user *useraddr)
    {
    let mut link_ksettings: ethtool_link_ksettings = {};
    int err;
    netdev_assert_locked_ops_compat(dev);
...
//
#[no_mangle]
unsafe extern "C" fn ethtool_get_settings(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ethtool_set_settings(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
//
    ...
    if (ops.get_regs_len) {
    let mut ret: c_int = ops.get_regs_len(dev);
    if (ret > 0)
    ...
    u32 *info_buf = core::ptr::null_mut();
...
//
    ...
    size_t size)
    {
    let mut crxnfc: compat_ethtool_rxnfc = {};
...
#[no_mangle]
unsafe extern "C" fn flow_type_hashable(flow_type: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn flow_type_v6(flow_type: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ethtool_check_xfrm_rxfh(input_xfrm: u32, rxfh: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_check_flow_types(dev: *mut net_device, input_xfrm: u32) -> c_int {
    ...
    {
    const struct ethtool_ops *ops = dev.ethtool_ops;
    let mut fields: ethtool_rxfh_fields = {};
    struct ethtool_rxnfc info;
    let mut info_size: usize = sizeof(info);
    int rc;
    ...
    if (ops.get_rxfh) {
    let mut rxfh: ethtool_rxfh_param = {};
    ...
    rc = ops.set_rxfh_fields(dev, &fields, core::ptr::null_mut());
    exit_unlock:
    ...
    return ethtool_rxnfc_copy_to_user(useraddr, &info, info_size, core::ptr::null_mut());
    }
...
//
    ...
    ethtool_rxnfc_copy_to_user(useraddr, &info, info_size, core::ptr::null_mut()))
    return -EFAULT;
    return 0;
    }
    ...
    const struct ethtool_ops *ops = dev.ethtool_ops;
    struct ethtool_rxnfc info;
    void *rule_buf = core::ptr::null_mut();
    size_t info_size;
    int ret;
    if (!ops.get_rxnfc)
    return -EOPNOTSUPP;
...
#[no_mangle]
pub unsafe extern "C" fn netdev_rss_key_fill(buffer: *mut c_void, len: usize) {
...
//
    ...
    let mut user_size: return = = 0 ? 0 : -EINVAL;
    ...
    {
    const struct ethtool_ops *ops = dev.ethtool_ops;
    let mut rxfh_dev: ethtool_rxfh_param = {};
    struct netlink_ext_ack *extack = core::ptr::null_mut();
    int num_rx_rings;
    u32 user_size, i;
    int ret;
    let mut ringidx_offset: u32 = offsetof(struct ethtool_rxfh_indir, ring_index[0]);
...
// Most drivers don't handle rss_context, check it's 0 as well
    ...
    void __user *useraddr)
    {
    let mut rss_cfg_offset: u32 = offsetof(struct ethtool_rxfh, rss_config[0]);
    const struct ethtool_ops *ops = dev.ethtool_ops;
    let mut dev_indir_size: u32 = 0, dev_key_size = 0, i;
    let mut user_indir_len: u32 = 0, indir_bytes = 0;
    let mut rxfh_dev: ethtool_rxfh_param = {};
    struct ethtool_rxfh_context *ctx = core::ptr::null_mut();
    struct netlink_ext_ack *extack = core::ptr::null_mut();
    struct ethtool_rxfh rxfh;
...
// indicate whether rxfh was set to default
    ...
    dev.ethtool.rss_indir_user_size = 0;
#[no_mangle]
pub unsafe extern "C" fn if(ETH_RXFH_INDIR_NO_CHANGE: rxfh.indir_size !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_regs(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_reset(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_wol(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_set_wol(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_eee(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_set_eee(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_link(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
    static int ethtool_get_link(struct net_device *dev, char __user *useraddr)
    {
    let mut edata: ethtool_value = { .cmd = ETHTOOL_GLINK };
    let mut link: c_int = __ethtool_get_link(dev);
    if (link < 0)
    return link;
    edata.data = link;
    if (copy_to_user(useraddr, &edata, sizeof(edata)))
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_eeprom(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_set_eeprom(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
// Check for exceeding total eeprom len
    ...
    void __user *useraddr)
    {
    let mut coalesce: ethtool_coalesce = { .cmd = ETHTOOL_GCOALESCE };
    let mut kernel_coalesce: kernel_ethtool_coalesce = {};
    int ret;
    ...
    {
    let mut supported_params: u32 = dev.ethtool_ops.supported_coalesce_params;
    let mut nonzero_params: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_ringparam(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    static int ethtool_get_ringparam(struct net_device *dev, void __user *useraddr)
    {
    let mut ringparam: ethtool_ringparam = { .cmd = ETHTOOL_GRINGPARAM };
    let mut kernel_ringparam: kernel_ethtool_ringparam = {};
    if (!dev.ethtool_ops.get_ringparam)
    return -EOPNOTSUPP;
    dev.ethtool_ops.get_ringparam(dev, &ringparam,
    &kernel_ringparam, core::ptr::null_mut());
    if (copy_to_user(useraddr, &ringparam, sizeof(ringparam)))
    return -EFAULT;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ethtool_set_ringparam(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    ...
    return -EFAULT;
    ethtool_ringparam_get_cfg(dev, &max, &kernel_ringparam, core::ptr::null_mut());
// ensure new ring parameters are within the maximums
    ...
    void __user *useraddr)
    {
    let mut channels: ethtool_channels = { .cmd = ETHTOOL_GCHANNELS };
...
// ensure there is at least one RX and one TX channel
    ...
    return -EINVAL;
    ret = ethtool_check_max_channel(dev, channels, core::ptr::null_mut());
    if (ret)
    return ret;
// Disabling channels, query busy queues (AF_XDP, queue leasing)
    ...
    if (netdev_queue_busy(dev, i, NETDEV_QUEUE_TYPE_RX, core::ptr::null_mut()))
    return -EINVAL;
    }
    for (i = channels.combined_count + channels.tx_count;
    i < curr.combined_count + curr.tx_count; i++) {
    if (netdev_queue_busy(dev, i, NETDEV_QUEUE_TYPE_TX, core::ptr::null_mut()))
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_pauseparam(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    static int ethtool_get_pauseparam(struct net_device *dev, void __user *useraddr)
    {
    let mut pauseparam: ethtool_pauseparam = { .cmd = ETHTOOL_GPAUSEPARAM };
...
#[no_mangle]
unsafe extern "C" fn ethtool_set_pauseparam(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_self_test(dev: *mut net_device, useraddr: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_strings(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ethtool_puts(data: *mut u8, str: *const c_char) {
...
// Driver expects to be called at twice the frequency in rc
    let mut n: c_int = rc * 2, interval = HZ / n;
    let mut count: u64 = mul_u32_u32(n, id.data);
    let mut i: u64 = 0;
    do {
    if (has_rtnl_lock)
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_stats(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_vzalloc_stats_array(n_stats: c_int, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_phy_stats(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    static int ethtool_get_phy_stats(struct net_device *dev, void __user *useraddr)
    {
    struct phy_device *phydev = dev.phydev;
    struct ethtool_stats stats;
    u64 *data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_perm_addr(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    ...
    {
    let mut edata: ethtool_value = { .cmd = cmd };
    if (!actor)
    return -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_ts_info(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    static int ethtool_get_ts_info(struct net_device *dev, void __user *useraddr)
    {
    struct kernel_ethtool_ts_info kernel_info;
    let mut info: ethtool_ts_info = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn ethtool_tunable_valid(tuna: *const ethtool_tunable) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_tunable(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_set_tunable(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    ...
    int i, ret = 0;
    int n_queue;
    struct ethtool_coalesce *backup = core::ptr::null_mut(), *tmp = core::ptr::null_mut();
    DECLARE_BITMAP(queue_mask, MAX_NUM_QUEUE);
...
#[no_mangle]
unsafe extern "C" fn ethtool_phy_tunable_valid(tuna: *const ethtool_tunable) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_phy_tunable(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_phy_tunable(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethtool_get_fecparam(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
    static int ethtool_get_fecparam(struct net_device *dev, void __user *useraddr)
    {
    let mut fecparam: ethtool_fecparam = { .cmd = ETHTOOL_GFECPARAM };
    int rc;
...
#[no_mangle]
unsafe extern "C" fn ethtool_set_fecparam(dev: *mut net_device, useraddr: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ethtool_cmd_changes_features(ethcmd: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn dev_ethtool(net: *mut net, ifr: *mut ifreq, useraddr: *mut void __user) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ethtool_rx_flow_key {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ethtool_rx_flow_match {
    pub dissector: flow_dissector,
    pub key: ethtool_rx_flow_key,
    pub mask: ethtool_rx_flow_key,
}
...
#[no_mangle]
pub unsafe extern "C" fn ethtool_rx_flow_rule_destroy(flow: *mut ethtool_rx_flow_rule) {
