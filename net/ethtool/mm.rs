...
#[no_mangle]
unsafe extern "C" fn mm_put_stat(skb: *mut sk_buff, val: u64, attrtype: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ethnl_set_mm(req_info: *mut ethnl_req_info, info: *mut genl_info) -> c_int {
    static int ethnl_set_mm(struct ethnl_req_info *req_info, struct genl_info *info)
    {
    struct netlink_ext_ack *extack = info.extack;
    struct net_device *dev = req_info.dev;
    let mut state: ethtool_mm_state = {};
    struct nlattr **tb = info.attrs;
    let mut cfg: ethtool_mm_cfg = {};
...
//
#[no_mangle]
pub unsafe extern "C" fn __ethtool_dev_mm_supported(dev: *mut net_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ethtool_dev_mm_supported(dev: *mut net_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ethtool_mmsv_verify_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn ethtool_mmsv_verify_timer_arm(mmsv: *mut ethtool_mmsv) {
...
#[no_mangle]
unsafe extern "C" fn ethtool_mmsv_apply(mmsv: *mut ethtool_mmsv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ethtool_mmsv_stop(mmsv: *mut ethtool_mmsv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ethtool_mmsv_link_state_handle(mmsv: *mut ethtool_mmsv, up: bool) {
...
#[no_mangle]
unsafe extern "C" fn ethtool_mmsv_is_tx_active(mmsv: *mut ethtool_mmsv) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ethtool_mmsv_set_mm(mmsv: *mut ethtool_mmsv, cfg: *mut ethtool_mm_cfg) {
