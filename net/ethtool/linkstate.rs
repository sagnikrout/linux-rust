...
//! Source: net/ethtool/linkstate.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn linkstate_get_sqi(phydev: *mut phy_device) -> c_int {
    ...
    ret = -EOPNOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !phydev->link) -> else {
    else if (!phydev.link)
    ret = -ENETDOWN;
    else
...
#[no_mangle]
unsafe extern "C" fn linkstate_get_sqi_max(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn linkstate_sqi_critical_error(sqi: c_int) -> bool {
    static bool linkstate_sqi_critical_error(int sqi)
    {
    return sqi < 0 && sqi != -EOPNOTSUPP && sqi != -ENETDOWN;
    }
#[no_mangle]
unsafe extern "C" fn linkstate_sqi_valid(data: *mut linkstate_reply_data) -> bool {
