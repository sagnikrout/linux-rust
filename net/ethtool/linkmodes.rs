...
//! Source: net/ethtool/linkmodes.c
#![no_std]
...
pub struct linkmodes_reply_data {
    ...
    core::ptr::null_mut(), __ETHTOOL_LINK_MODE_MASK_NBITS,
    link_mode_names, compact);
    if (ret < 0)
    return ret;
    len += ret;
...
#[no_mangle]
unsafe extern "C" fn ethnl_validate_master_slave_cfg(cfg: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ethnl_check_linkmodes(info: *mut genl_info, tb: *mut nlattr) -> c_int {
