...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pause_reply_data {
    pub base: ethnl_reply_data,
    pub pauseparam: ethtool_pauseparam,
    pub pausestat: ethtool_pause_stats,
}
    ...
    {
    let mut pad: u16 = ETHTOOL_A_PAUSE_STAT_PAD;
    struct nlattr *nest;
...
// PAUSE_SET
    ...
    let mut params: ethtool_pauseparam = {};
