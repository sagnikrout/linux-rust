...
#[no_mangle]
unsafe extern "C" fn attr_to_mask(attr_type: c_uint) -> u32 {
...
//
    ...
    let mut supported: u32 = data.supported_params;
...
//
    ...
    struct netlink_ext_ack *extack)
    {
    let mut len_irq_moder: c_int = ARRAY_SIZE(coalesce_irq_moderation_policy);
...
//
    ...
    let mut coalesce: ethtool_coalesce = {};
    let mut mod_mode: bool = false, mod = false;
    struct nlattr **tb = info.attrs;
    int ret;
