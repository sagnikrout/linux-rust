...
// CHANNELS_SET
    ...
    let mut mod: bool = false, mod_combined = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(channels.max_tx: channels.tx_count >) -> else {
    else if (channels.tx_count > channels.max_tx)
    err_attr = ETHTOOL_A_CHANNELS_TX_COUNT;
#[no_mangle]
pub unsafe extern "C" fn if(channels.max_other: channels.other_count >) -> else {
    else if (channels.other_count > channels.max_other)
    err_attr = ETHTOOL_A_CHANNELS_OTHER_COUNT;
#[no_mangle]
pub unsafe extern "C" fn if(channels.max_combined: channels.combined_count >) -> else {
...
// ensure there is at least one RX and one TX channel
    ...
    err_attr = ETHTOOL_A_CHANNELS_RX_COUNT;
#[no_mangle]
pub unsafe extern "C" fn if(!channels.tx_count: !channels.combined_count &&) -> else {
