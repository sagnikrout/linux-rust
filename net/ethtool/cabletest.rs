...
//! Source: net/ethtool/cabletest.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ethnl_cable_test_started(phydev: *mut phy_device, cmd: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_act_cable_test(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_cable_test_alloc(phydev: *mut phy_device, cmd: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_cable_test_free(phydev: *mut phy_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_cable_test_finished(phydev: *mut phy_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_act_cable_test_tdr(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ethnl_cable_test_pulse(phydev: *mut phy_device, mV: u16) -> c_int {
