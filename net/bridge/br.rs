...
//
#[no_mangle]
unsafe extern "C" fn br_device_event(unused: *mut notifier_block, event: c_ulong, ptr: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_boolopt_get(br: *const net_bridge, opt: enum br_boolopt_id) -> c_int {
...
// shouldn't be called with unsupported options
    ...
    struct netlink_ext_ack *extack)
    {
    let mut bitmap: c_ulong = bm.optmask;
    let mut err: c_int = 0;
    int opt_id;
    ...
    let mut on: bool = !!(bm.optval & BIT(opt_id));
...
#[no_mangle]
pub unsafe extern "C" fn br_opt_toggle(br: *mut net_bridge, opt: enum net_bridge_opts, on: bool) {
    void br_opt_toggle(struct net_bridge *br, enum net_bridge_opts opt, bool on)
    {
    let mut cur: bool = !!br_opt_get(br, opt);
...
#[no_mangle]
unsafe extern "C" fn br_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn br_deinit() -> void __exit {
