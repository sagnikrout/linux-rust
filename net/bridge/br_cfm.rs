...
#[no_mangle]
unsafe extern "C" fn interval_to_us(interval: enum br_cfm_ccm_interval) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn interval_to_pdu(interval: enum br_cfm_ccm_interval) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pdu_to_interval(value: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ccm_rx_timer_start(peer_mep: *mut br_cfm_peer_mep) {
...
#[no_mangle]
unsafe extern "C" fn br_cfm_notify(event: c_int, port: *const net_bridge_port) {
    static void br_cfm_notify(int event, const struct net_bridge_port *port)
    {
    let mut filter: u32 = RTEXT_FILTER_CFM_STATUS;
    br_info_notify(event, port.br, core::ptr::null_mut(), filter);
    }
#[no_mangle]
unsafe extern "C" fn cc_peer_enable(peer_mep: *mut br_cfm_peer_mep) {
...
#[no_mangle]
unsafe extern "C" fn cc_peer_disable(peer_mep: *mut br_cfm_peer_mep) {
...
#[no_mangle]
unsafe extern "C" fn ccm_frame_tx(skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn ccm_tx_work_expired(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ccm_rx_work_expired(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn br_cfm_frame_rx(port: *mut net_bridge_port, skb: *mut sk_buff) -> c_int {
...
// Empty and free peer MEP list
    ...
    RCU_INIT_POINTER(mep.b_port, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn br_cfm_mep_count(br: *mut net_bridge, count: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_cfm_peer_mep_count(br: *mut net_bridge, count: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_cfm_created(br: *mut net_bridge) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_cfm_port_del(br: *mut net_bridge, port: *mut net_bridge_port) {
