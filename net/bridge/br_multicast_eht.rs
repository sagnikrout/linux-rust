...
//! Source: net/bridge/br_multicast_eht.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __eht_destroy_host(eht_host: *mut net_bridge_group_eht_host) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_destroy_eht_set_entry(gc: *mut net_bridge_mcast_gc) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_destroy_eht_set(gc: *mut net_bridge_mcast_gc) {
...
#[no_mangle]
unsafe extern "C" fn __eht_del_set_entry(set_h: *mut net_bridge_group_eht_set_entry) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_del_eht_set(eht_set: *mut net_bridge_group_eht_set) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_eht_clean_sets(pg: *mut net_bridge_port_group) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_eht_set_entry_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_eht_set_expired(t: *mut timer_list) {
    ...
    {
    struct rb_node **link = &pg.eht_host_tree.rb_node, *parent = core::ptr::null_mut();
    struct net_bridge_group_eht_host *eht_host;
    while (*link) {
    struct net_bridge_group_eht_host *this;
    int result;
...
pub unsafe extern "C" fn if(0: result >) -> else {
    ...
    bool allow_zero_src)
    {
    struct rb_node **link = &eht_set.entry_tree.rb_node, *parent = core::ptr::null_mut();
    struct net_bridge_group_eht_set_entry *set_h;
    while (*link) {
    struct net_bridge_group_eht_set_entry *this;
    int result;
...
//
    ...
    union net_bridge_eht_addr *src_addr)
    {
    struct rb_node **link = &pg.eht_set_tree.rb_node, *parent = core::ptr::null_mut();
    struct net_bridge_group_eht_set *eht_set;
    while (*link) {
    struct net_bridge_group_eht_set *this;
    int result;
...
pub unsafe extern "C" fn if(0: result >) -> else {
    ...
    struct net_bridge_group_eht_set_entry *set_h;
    struct net_bridge_group_eht_set *eht_set;
    let mut set_deleted: bool = false;
...
// flush_entries is true when changing mode
    ...
    bool to_report)
    {
    let mut changed: bool = false, flush_entries = to_report;
    union net_bridge_eht_addr eht_src_addr;
...
//
    ...
    int grec_type)
    {
    let mut changed: bool = false, to_report = false;
    switch (grec_type) {
...
// true means an entry was deleted
    ...
    int grec_type)
    {
    let mut eht_enabled: bool = !!(pg.key.port.flags & BR_MULTICAST_FAST_LEAVE);
