...
//! Source: net/bridge/br_multicast.c
#![no_std]
...
//
    ...
    {
    struct net_bridge_mcast_port *pmctx = core::ptr::null_mut();
    struct net_bridge_vlan *vlan;
...
#[no_mangle]
unsafe extern "C" fn br_multicast_star_g_host_state(star_mp: *mut net_bridge_mdb_entry) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_sg_del_exclude_ports(sgmp: *mut net_bridge_mdb_entry) {
...
//
    for (pp = &sgmp.ports;
    (p = mlock_dereference(*pp, sgmp.br)) != core::ptr::null_mut();
    pp = &p.next)
...
#[no_mangle]
unsafe extern "C" fn br_multicast_fwd_src_add(src: *mut net_bridge_group_src) {
...
// the kernel is now responsible for removing this S,G
    ...
    return;
    for (pp = &mp.ports;
    (p = mlock_dereference(*pp, src.br)) != core::ptr::null_mut();
    pp = &p.next) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_fwd_src_handle(src: *mut net_bridge_group_src) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_destroy_mdb_entry(gc: *mut net_bridge_mcast_gc) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_del_mdb_entry(mp: *mut net_bridge_mdb_entry) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_group_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_destroy_group_src(gc: *mut net_bridge_mcast_gc) {
...
#[no_mangle]
pub unsafe extern "C" fn __br_multicast_del_group_src(src: *mut net_bridge_group_src) {
    ...
    const char *what)
    {
    let mut max: u32 = READ_ONCE(pmctx.mdb_max_entries);
    let mut n: u32 = READ_ONCE(pmctx.mdb_n_entries);
...
#[no_mangle]
unsafe extern "C" fn br_multicast_port_ngroups_dec_one(pmctx: *mut net_bridge_mcast_port) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_port_ngroups_dec(port: *mut net_bridge_port, vid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_ngroups_get(pmctx: *const net_bridge_mcast_port) -> u32 {
    u32 br_multicast_ngroups_get(const struct net_bridge_mcast_port *pmctx)
    {
    return READ_ONCE(pmctx.mdb_n_entries);
    }
#[no_mangle]
pub unsafe extern "C" fn br_multicast_ngroups_set_max(pmctx: *mut net_bridge_mcast_port, max: u32) {
    void br_multicast_ngroups_set_max(struct net_bridge_mcast_port *pmctx, u32 max)
    {
    WRITE_ONCE(pmctx.mdb_max_entries, max);
    }
#[no_mangle]
pub unsafe extern "C" fn br_multicast_ngroups_get_max(pmctx: *const net_bridge_mcast_port) -> u32 {
    u32 br_multicast_ngroups_get_max(const struct net_bridge_mcast_port *pmctx)
    {
    return READ_ONCE(pmctx.mdb_max_entries);
    }
#[no_mangle]
unsafe extern "C" fn br_multicast_destroy_port_group(gc: *mut net_bridge_mcast_gc) {
...
//
    ...
    return;
    for (pp = &mp.ports;
    (p = mlock_dereference(*pp, br)) != core::ptr::null_mut();
    pp = &p.next) {
    if (p != pg)
    continue;
...
#[no_mangle]
unsafe extern "C" fn br_multicast_port_group_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_gc(head: *mut hlist_head) {
    ...
    struct sk_buff *skb)
    {
    struct net_bridge_vlan *vlan = core::ptr::null_mut();
    if (pmctx && br_multicast_port_ctx_is_vlan(pmctx))
    vlan = pmctx.vlan;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: br_multicast_ctx_is_vlan(brmctx)) -> else {
    ...
    bool *need_rexmit)
    {
    struct net_bridge_port *p = pg ? pg.key.port : core::ptr::null_mut();
    struct net_bridge_group_src *ent;
    size_t pkt_size, igmp_hdr_size;
    let mut now: c_ulong = jiffies;
    struct igmpv3_query *ihv3;
    unsigned long lmqt, mrt;
    void *csum_start = core::ptr::null_mut();
    __sum16 *csum = core::ptr::null_mut();
    struct sk_buff *skb;
    struct igmphdr *ih;
    struct ethhdr *eth;
    struct iphdr *iph;
    let mut lmqt_srcs: u16 = 0;
...
// csum = csum_ipv6_magic(&ip6h->saddr, &ip6h->daddr, mld_hdr_size,
    ...
    br_mc_disabled_update(br.dev, false, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn br_multicast_group_src_expired(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_del_port_group(p: *mut net_bridge_port_group) {
    void br_multicast_del_port_group(struct net_bridge_port_group *p)
    {
    struct net_bridge_port *port = p.key.port;
    let mut vid: __u16 = p.key.addr.vid;
    ...
    if (notify)
    br_mdb_notify(mp.br.dev, mp, core::ptr::null_mut(), RTM_NEWMDB);
    }
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_host_leave(mp: *mut net_bridge_mdb_entry, notify: bool) {
    ...
    br_multicast_star_g_host_state(mp);
    if (notify)
    br_mdb_notify(mp.br.dev, mp, core::ptr::null_mut(), RTM_DELMDB);
    }
    static struct net_bridge_port_group *
    __br_multicast_add_group(struct net_bridge_mcast *brmctx,
    struct net_bridge_mcast_port *pmctx,
    ...
    {
    struct net_bridge_port_group __rcu **pp;
    struct net_bridge_port_group *p = core::ptr::null_mut();
    struct net_bridge_mdb_entry *mp;
    let mut now: c_ulong = jiffies;
    ...
    for (pp = &mp.ports;
    (p = mlock_dereference(*pp, brmctx.br)) != core::ptr::null_mut();
    pp = &p.next) {
    ...
    filter_mode, RTPROT_KERNEL, core::ptr::null_mut());
    if (unlikely(!p)) {
    p = ERR_PTR(-ENOMEM);
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn br_multicast_rport_del(rlist: *mut hlist_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_rport_del(pmctx: *mut net_bridge_mcast_port) -> bool {
    static bool br_ip4_multicast_rport_del(struct net_bridge_mcast_port *pmctx)
    {
    return br_multicast_rport_del(&pmctx.ip4_rlist);
    }
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_rport_del(pmctx: *mut net_bridge_mcast_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_router_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_router_expired(t: *mut timer_list) {
    ...
    switchdev_port_attr_set(p.dev, &attr, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_local_router_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_local_router_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_querier_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_querier_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_query_delay_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_query_type(skb: *const sk_buff) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_port_query_queue_work(work: *mut work_struct) {
    ...
    let mut query_type: u8 = br_multicast_query_type(skb);
    local_bh_disable();
    ...
    core::ptr::null_mut(), skb, core::ptr::null_mut(), skb.dev, br_dev_queue_push_xmit);
    local_bh_enable();
    }
    }
#[no_mangle]
unsafe extern "C" fn br_multicast_query_queue_work(work: *mut work_struct) {
    ...
    let mut query_type: u8 = br_multicast_query_type(skb);
    local_bh_disable();
    br_multicast_count(brmctx.br, core::ptr::null_mut(), skb, query_type,
    BR_MCAST_DIR_RX);
    netif_rx(skb);
    local_bh_enable();
    }
    }
pub const BR_MULTICAST_QUERY_QUEUE_LEN_MAX: c_int = 1000;
    ...
    {
    struct bridge_mcast_other_query *other_query = core::ptr::null_mut();
    struct bridge_mcast_querier *querier;
    struct br_ip br_group;
    unsigned long time;
    if (!br_multicast_ctx_should_use(brmctx, pmctx) ||
...
// we're about to select ourselves as querier
    ...
    let mut zeroip: br_ip = {};
    br_multicast_update_querier(brmctx, querier, 0, &zeroip);
    }
    __br_multicast_send_query(brmctx, pmctx, core::ptr::null_mut(), core::ptr::null_mut(), &br_group, false,
    0, core::ptr::null_mut());
    time = jiffies;
...
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_port_query_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_port_query_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_port_group_rexmit(t: *mut timer_list) {
    static void br_multicast_port_group_rexmit(struct timer_list *t)
    {
    ...
    struct net_bridge_mcast_port *pmctx;
    struct net_bridge_mcast *brmctx;
    let mut need_rexmit: bool = false;
    spin_lock(&br.multicast_lock);
    ...
    &pg.key.addr, false, 1, core::ptr::null_mut());
    }
    __br_multicast_send_query(brmctx, pmctx, pg, &pg.key.addr,
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_port_ctx_deinit(pmctx: *mut net_bridge_mcast_port) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_add_port(port: *mut net_bridge_port) -> c_int {
    int br_multicast_add_port(struct net_bridge_port *port)
    {
    int err;
    port.multicast_eht_hosts_limit = BR_MCAST_DEFAULT_EHT_HOSTS_LIMIT;
    br_multicast_port_ctx_init(port, core::ptr::null_mut(), &port.multicast_ctx);
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_del_port(port: *mut net_bridge_port) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_enable(query: *mut bridge_mcast_own_query) {
...
#[no_mangle]
unsafe extern "C" fn __br_multicast_enable_port_ctx(pmctx: *mut net_bridge_mcast_port) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_enable_port_ctx(pmctx: *mut net_bridge_mcast_port) {
...
#[no_mangle]
unsafe extern "C" fn __br_multicast_disable_port_ctx(pmctx: *mut net_bridge_mcast_port) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_disable_port_ctx(pmctx: *mut net_bridge_mcast_port) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_toggle_port(port: *mut net_bridge_port, on: bool) {
...
// iterate each vlan, toggle vlan multicast context
    ...
    struct net_bridge_mcast_port *pmctx =
    &vlan.port_mcast_ctx;
    let mut state: u8 = br_vlan_get_state(vlan);
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_enable_port(port: *mut net_bridge_port) {
    void br_multicast_enable_port(struct net_bridge_port *port)
    {
    br_multicast_toggle_port(port, true);
    }
#[no_mangle]
pub unsafe extern "C" fn br_multicast_disable_port(port: *mut net_bridge_port) {
    void br_multicast_disable_port(struct net_bridge_port *port)
    {
    br_multicast_toggle_port(port, false);
    }
#[no_mangle]
unsafe extern "C" fn __grp_src_delete_marked(pg: *mut net_bridge_port_group) -> c_int {
    ...
    {
    struct bridge_mcast_other_query *other_query = core::ptr::null_mut();
    let mut lmqc: u32 = brmctx.multicast_last_member_count;
    ...
    return;
    __br_multicast_send_query(brmctx, pmctx, pg, &pg.key.addr,
    &pg.key.addr, true, 1, core::ptr::null_mut());
    ...
    {
    struct bridge_mcast_other_query *other_query = core::ptr::null_mut();
    let mut now: c_ulong = jiffies, lmi;
    if (!netif_running(brmctx.br.dev) ||
    !br_opt_get(brmctx.br, BROPT_MULTICAST_ENABLED))
    return;
    if (pg.key.addr.proto == htons(ETH_P_IP))
    ...
    __br_multicast_send_query(brmctx, pmctx, pg, &pg.key.addr,
    &pg.key.addr, false, 0, core::ptr::null_mut());
    if (!timer_pending(&pg.rexmit_timer) ||
    time_after(pg.rexmit_timer.expires, lmi))
    mod_timer(&pg.rexmit_timer, lmi);
    }
...
//
    ...
    const unsigned char *src)
    {
    let mut __maybe_unused: *mut net_bridge br = mp.br;
    struct net_bridge_port_group *pg;
    ...
    u16 vid)
    {
    let mut igmpv2: bool = brmctx.multicast_igmp_version == 2;
...
// reload grec and host addr
    ...
    u16 vid)
    {
    let mut mldv1: bool = brmctx.multicast_mld_version == 1;
    struct net_bridge_mdb_entry *mdst;
    struct net_bridge_port_group *pg;
    ...
    struct br_ip *saddr)
    {
    let mut port_ifidx: c_int = pmctx ? pmctx.port.dev.ifindex : 0;
    ...
    {
    let mut port_ifidx: c_int = READ_ONCE(querier.port_ifidx);
    struct net_bridge_port *p;
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_querier_state_size() -> usize {
...
// protected by rtnl or rcu
    ...
    int nest_attr)
    {
    let mut querier: bridge_mcast_querier = {};
    struct net_bridge_port *p;
    struct nlattr *nest;
    ...
    struct hlist_head *mc_router_list)
    {
    struct hlist_node *slot = core::ptr::null_mut();
    struct net_bridge_port *p;
    struct hlist_node *rlist;
...
//
    ...
    struct hlist_node *rlist = core::ptr::null_mut();
    if (pmctx) {
    ...
    const struct in6_addr *group = core::ptr::null_mut();
    ...
    goto out;
    if (brmctx.multicast_querier) {
    __br_multicast_send_query(brmctx, pmctx, core::ptr::null_mut(), core::ptr::null_mut(), &mp.addr,
    false, 0, core::ptr::null_mut());
    time = jiffies + brmctx.multicast_last_member_count *
    brmctx.multicast_last_member_interval;
    mod_timer(&own_query.timer, time);
    for (p = mlock_dereference(mp.ports, brmctx.br);
    p != core::ptr::null_mut() && pmctx != core::ptr::null_mut();
    ...
    u16 vid)
    {
    struct net_bridge_port *p = pmctx ? pmctx.port : core::ptr::null_mut();
    const unsigned char *src;
    struct igmphdr *ih;
    int err;
...
// pmctx = &vlan->port_mcast_ctx;
    ...
    if (query.startup_sent < brmctx.multicast_startup_query_count)
    query.startup_sent++;
    br_multicast_send_query(brmctx, core::ptr::null_mut(), query);
    out:
    spin_unlock(&brmctx.br.multicast_lock);
    }
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_query_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_query_expired(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_gc_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_ctx_deinit(brmctx: *mut net_bridge_mcast) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_init(br: *mut net_bridge) {
    void br_multicast_init(struct net_bridge *br)
    {
    br.hash_max = BR_MULTICAST_DEFAULT_HASH_MAX;
    br_multicast_ctx_init(br, core::ptr::null_mut(), &br.multicast_ctx);
...
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_join_snoopers(br: *mut net_bridge) {
...
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_join_snoopers(br: *mut net_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn br_ip6_multicast_join_snoopers(br: *mut net_bridge) {
    static inline void br_ip6_multicast_join_snoopers(struct net_bridge *br)
    {
    }

#[no_mangle]
pub unsafe extern "C" fn br_multicast_join_snoopers(br: *mut net_bridge) {
...
#[no_mangle]
unsafe extern "C" fn br_ip4_multicast_leave_snoopers(br: *mut net_bridge) {
...
#[no_mangle]
unsafe extern "C" fn br_ip6_multicast_leave_snoopers(br: *mut net_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn br_ip6_multicast_leave_snoopers(br: *mut net_bridge) {
    static inline void br_ip6_multicast_leave_snoopers(struct net_bridge *br)
    {
    }

#[no_mangle]
pub unsafe extern "C" fn br_multicast_leave_snoopers(br: *mut net_bridge) {
...
#[no_mangle]
unsafe extern "C" fn __br_multicast_open(brmctx: *mut net_bridge_mcast) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_open(br: *mut net_bridge) {
...
#[no_mangle]
unsafe extern "C" fn __br_multicast_stop(brmctx: *mut net_bridge_mcast) {
    static void __br_multicast_stop(struct net_bridge_mcast *brmctx)
    {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_update_vlan_mcast_ctx(v: *mut net_bridge_vlan, state: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_toggle_one_vlan(vlan: *mut net_bridge_vlan, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_toggle_vlan(vlan: *mut net_bridge_vlan, on: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_toggle_global_vlan(vlan: *mut net_bridge_vlan, on: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_stop(br: *mut net_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_dev_del(br: *mut net_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_set_router(brmctx: *mut net_bridge_mcast, val: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_set_vlan_router(v: *mut net_bridge_vlan, mcast_router: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_enable_all_ports(br: *mut net_bridge) {
...
#[no_mangle]
unsafe extern "C" fn br_multicast_disable_all_ports(br: *mut net_bridge) {
    ...
    struct netlink_ext_ack *extack)
    {
    let mut change_snoopers: bool = false;
    let mut err: c_int = 0;
    spin_lock_bh(&br.multicast_lock);
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_enabled(dev: *const net_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_router(dev: *const net_device) -> bool {
    bool br_multicast_router(const struct net_device *dev)
    {
    struct net_bridge *br = netdev_priv(dev);
    bool is_router;
    spin_lock_bh(&br.multicast_lock);
    is_router = br_multicast_is_router(&br.multicast_ctx, core::ptr::null_mut());
    spin_unlock_bh(&br.multicast_lock);
    return is_router;
    }
    EXPORT_SYMBOL_GPL(br_multicast_router);
#[no_mangle]
pub unsafe extern "C" fn br_multicast_set_querier(brmctx: *mut net_bridge_mcast, val: c_ulong) -> c_int {
...
// Currently we support version 1 and 2
    ...
    unsigned long val)
    {
    let mut intvl_jiffies: c_ulong = clock_t_to_jiffies(val);
...
//
#[no_mangle]
pub unsafe extern "C" fn br_multicast_has_querier_anywhere(dev: *mut net_device, proto: c_int) -> bool {
    ...
    ret = br_multicast_querier_exists(&br.multicast_ctx, &eth, core::ptr::null_mut());
    unlock:
    rcu_read_unlock();
    return ret;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn br_multicast_has_querier_adjacent(dev: *mut net_device, proto: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_multicast_has_router_adjacent(dev: *mut net_device, proto: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_init_stats(br: *mut net_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_multicast_uninit_stats(br: *mut net_bridge) {
...
#[no_mangle]
unsafe extern "C" fn mcast_stats_add_dir(dst: *mut u64, src: *mut u64) -> noinline_for_stack void {
...
#[no_mangle]
pub unsafe extern "C" fn br_mdb_hash_init(br: *mut net_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_mdb_hash_fini(br: *mut net_bridge) {
