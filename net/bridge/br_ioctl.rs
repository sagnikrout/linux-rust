...
#[no_mangle]
unsafe extern "C" fn get_bridge_ifindices(net: *mut net, indices: *mut c_int, num: c_int) -> c_int {
...
// called with RTNL
#[no_mangle]
unsafe extern "C" fn get_port_ifindices(br: *mut net_bridge, ifindices: *mut c_int, num: c_int) {
...
// called with RTNL
#[no_mangle]
unsafe extern "C" fn add_del_if(br: *mut net_bridge, ifindex: c_int, isadd: c_int) -> c_int {
    ...
    return -EINVAL;
    if (isadd)
    ret = br_add_if(br, dev, core::ptr::null_mut());
    else
    ret = br_del_if(br, dev);
    return ret;
    }
pub const BR_UARGS_MAX: c_int = 4;
...
//
    ...
    rcu_read_lock();
    if ((pt = br_get_port(br, args[2])) == core::ptr::null_mut()) {
    rcu_read_unlock();
    return -EINVAL;
    }
    ...
    if (!ns_capable(dev_net(dev).user_ns, CAP_NET_ADMIN))
    return -EPERM;
    ret = br_stp_set_enabled(br, args[1], core::ptr::null_mut());
    break;
    ...
    if ((p = br_get_port(br, args[1])) == core::ptr::null_mut())
    ret = -EINVAL;
    else
...
#[no_mangle]
unsafe extern "C" fn old_deviceless(net: *mut net, data: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_ioctl_stub(net: *mut net, cmd: c_uint, uarg: *mut void __user) -> c_int {
