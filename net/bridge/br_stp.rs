...
#[no_mangle]
pub unsafe extern "C" fn br_set_state(p: *mut net_bridge_port, state: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn br_port_get_stp_state(dev: *const net_device) -> u8 {
...
pub unsafe extern "C" fn if(0: t >) -> else {
    ...
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(rp->designated_port: p->designated_port >) -> else {
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_root_selection(br: *mut net_bridge) {
    static void br_root_selection(struct net_bridge *br)
    {
    struct net_bridge_port *p;
    let mut root_port: u16 = 0;
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_become_root_bridge(br: *mut net_bridge) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_transmit_config(p: *mut net_bridge_port) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_transmit_tcn(br: *mut net_bridge) {
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_should_become_designated_port(p: *const net_bridge_port) -> c_int {
    ...
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(p_designated_cost: br->root_path_cost >) -> else {
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_designated_port_selection(br: *mut net_bridge) {
...
pub unsafe extern "C" fn if(0: t >) -> else {
    ...
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(p_designated_cost: bpdu->root_path_cost >) -> else {
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_topology_change_acknowledged(br: *mut net_bridge) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_topology_change_detection(br: *mut net_bridge) {
    void br_topology_change_detection(struct net_bridge *br)
    {
    let mut isroot: c_int = br_is_root_bridge(br);
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_config_bpdu_generation(br: *mut net_bridge) {
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_reply(p: *mut net_bridge_port) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_configuration_update(br: *mut net_bridge) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_become_designated_port(p: *mut net_bridge_port) {
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_make_blocking(p: *mut net_bridge_port) {
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_make_forwarding(p: *mut net_bridge_port) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_port_state_selection(br: *mut net_bridge) {
    void br_port_state_selection(struct net_bridge *br)
    {
    struct net_bridge_port *p;
    let mut liveports: c_uint = 0;
    list_for_each_entry(p, &br.port_list, list) {
    if (p.state == BR_STATE_DISABLED)
    continue;
...
// called under bridge lock
#[no_mangle]
unsafe extern "C" fn br_topology_change_acknowledge(p: *mut net_bridge_port) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_received_tcn_bpdu(p: *mut net_bridge_port) {
...
#[no_mangle]
pub unsafe extern "C" fn br_set_hello_time(br: *mut net_bridge, val: c_ulong) -> c_int {
    int br_set_hello_time(struct net_bridge *br, unsigned long val)
    {
    let mut t: c_ulong = clock_t_to_jiffies(val);
...
#[no_mangle]
pub unsafe extern "C" fn br_set_max_age(br: *mut net_bridge, val: c_ulong) -> c_int {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn __set_ageing_time(dev: *mut net_device, t: c_ulong) -> c_int {
    ...
    int err;
    err = switchdev_port_attr_set(dev, &attr, core::ptr::null_mut());
    if (err && err != -EOPNOTSUPP)
    return err;
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn br_set_ageing_time(br: *mut net_bridge, ageing_time: clock_t) -> c_int {
    int br_set_ageing_time(struct net_bridge *br, clock_t ageing_time)
    {
    let mut t: c_ulong = clock_t_to_jiffies(ageing_time);
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn br_get_ageing_time(br_dev: *const net_device) -> clock_t {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn __br_set_topology_change(br: *mut net_bridge, val: c_uchar) {
...
#[no_mangle]
pub unsafe extern "C" fn __br_set_forward_delay(br: *mut net_bridge, t: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn br_set_forward_delay(br: *mut net_bridge, val: c_ulong) -> c_int {
    int br_set_forward_delay(struct net_bridge *br, unsigned long val)
    {
    let mut t: c_ulong = clock_t_to_jiffies(val);
    let mut err: c_int = -ERANGE;
    spin_lock_bh(&br.lock);
