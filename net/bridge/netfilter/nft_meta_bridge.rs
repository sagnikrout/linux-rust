...
//! Source: net/bridge/netfilter/nft_meta_bridge.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nft_meta_bridge_module_init() -> int __init {
    static int __init nft_meta_bridge_module_init(void)
    {
    return nft_register_expr(&nft_meta_bridge_type);
    }
#[no_mangle]
unsafe extern "C" fn nft_meta_bridge_module_exit() -> void __exit {
