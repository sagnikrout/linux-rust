...
//! Source: net/bridge/netfilter/nf_conntrack_bridge.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nf_ct_br_ip_check(skb: *const sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_br_ipv6_check(skb: *const sk_buff) -> c_int {
    ...
    const struct nf_hook_state *state)
    {
    let mut bridge_state: nf_hook_state = *state;
    enum ip_conntrack_info ctinfo;
    struct nf_conn *ct;
    u32 len;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: skb_vlan_tag_present(skb)) -> else {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_l3proto_bridge_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nf_conntrack_l3proto_bridge_fini() -> void __exit {
