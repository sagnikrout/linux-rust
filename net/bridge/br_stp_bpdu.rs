...
//! Source: net/bridge/br_stp_bpdu.c
#![no_std]
...
pub const STP_HZ: c_int = 256;
    ...
    dev_net(p.dev), core::ptr::null_mut(), skb, core::ptr::null_mut(), skb.dev,
    br_send_bpdu_finish);
    }
#[no_mangle]
pub unsafe extern "C" fn br_set_ticks(dest: *mut c_uchar, j: c_int) {
    static inline void br_set_ticks(unsigned char *dest, int j)
    {
    let mut ticks: c_ulong = (STP_HZ * j)/ HZ;
    put_unaligned_be16(ticks, dest);
    }
#[no_mangle]
pub unsafe extern "C" fn br_get_ticks(src: *const c_uchar) -> c_int {
    static inline int br_get_ticks(const unsigned char *src)
    {
    let mut ticks: c_ulong = get_unaligned_be16(src);
    return DIV_ROUND_UP(ticks * HZ, STP_HZ);
    }
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_send_config_bpdu(p: *mut net_bridge_port, bpdu: *mut br_config_bpdu) {
...
// called under bridge lock
#[no_mangle]
pub unsafe extern "C" fn br_send_tcn_bpdu(p: *mut net_bridge_port) {
