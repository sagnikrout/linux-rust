...
//! Source: net/bridge/br_mrp_netlink.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn br_mrp_fill_info(skb: *mut sk_buff, br: *mut net_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_mrp_ring_port_open(dev: *mut net_device, loc: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_mrp_in_port_open(dev: *mut net_device, loc: u8) -> c_int {
