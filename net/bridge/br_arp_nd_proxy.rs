...
//! Source: net/bridge/br_arp_nd_proxy.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn br_recalculate_neigh_suppress_enabled(br: *mut net_bridge) {
    void br_recalculate_neigh_suppress_enabled(struct net_bridge *br)
    {
    struct net_bridge_port *p;
    let mut neigh_suppress: bool = false;
...
#[no_mangle]
unsafe extern "C" fn br_is_local_ip(dev: *mut net_device, ip: __be32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn br_is_local_ip6(dev: *mut net_device, addr: *mut in6_addr) -> bool {
...
// check if ip is configured on upper dev
    ...
    {
    struct net_device *dev = br.dev;
    struct net_device *vlandev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn br_is_neigh_suppress_enabled(p: *const net_bridge_port, vid: u16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn br_is_neigh_forward_grat_enabled(p: *const net_bridge_port, vid: u16) -> bool {
