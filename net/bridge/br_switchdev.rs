...
//! Source: net/bridge/br_switchdev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn br_switchdev_frame_uses_tx_fwd_offload(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn br_switchdev_frame_set_offload_fwd_mark(skb: *mut sk_buff) {
...
//
    ...
    return;
    br_switchdev_fdb_populate(br, &item, fdb, core::ptr::null_mut());
    switch (type) {
    case RTM_DELNEIGH:
    call_switchdev_notifiers(SWITCHDEV_FDB_DEL_TO_DEVICE,
    item.info.dev, &item.info, core::ptr::null_mut());
    break;
    case RTM_NEWNEIGH:
...
#[no_mangle]
pub unsafe extern "C" fn br_switchdev_port_vlan_del(dev: *mut net_device, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbp_switchdev_hwdom_set(joining: *mut net_bridge_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbp_switchdev_hwdom_put(leaving: *mut net_bridge_port) {
...
#[no_mangle]
unsafe extern "C" fn nbp_switchdev_del(p: *mut net_bridge_port) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct br_switchdev_mdb_complete_info {
    pub port: *mut net_bridge_port,
    pub ip: br_ip,
}

#[no_mangle]
unsafe extern "C" fn br_switchdev_mdb_complete(dev: *mut net_device, err: c_int, priv: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_IPV6): mp->addr.proto ==) -> else {
    ...
    switch (type) {
    case RTM_NEWMDB:
    switchdev_port_obj_add(lower_dev, &mdb.obj, core::ptr::null_mut());
    break;
    case RTM_DELMDB:
...
//
    ...
    if (switchdev_port_obj_add(pg.key.port.dev, &mdb.obj, core::ptr::null_mut()))
    kfree(complete_info);
    break;
    case RTM_DELMDB:
...
// -EOPNOTSUPP not propagated from MDB replay.
    ...
    br_switchdev_mdb_replay(br_dev, dev, ctx, false, blocking_nb, core::ptr::null_mut());
    br_switchdev_vlan_replay(br_dev, ctx, false, blocking_nb, core::ptr::null_mut());
