...
#[no_mangle]
unsafe extern "C" fn __vlan_delete_pvid(vg: *mut net_bridge_vlan_group, vid: u16) {
...
#[no_mangle]
unsafe extern "C" fn __vlan_flags_would_change(v: *mut net_bridge_vlan, flags: u16) -> bool {
    static bool __vlan_flags_would_change(struct net_bridge_vlan *v, u16 flags)
    {
    return __vlan_flags_update(v, flags, false);
    }
#[no_mangle]
unsafe extern "C" fn __vlan_flags_commit(v: *mut net_bridge_vlan, flags: u16) {
...
#[no_mangle]
unsafe extern "C" fn __vlan_add_list(v: *mut net_bridge_vlan) {
...
#[no_mangle]
unsafe extern "C" fn __vlan_del_list(v: *mut net_bridge_vlan) {
...
//
    ...
    let mut err: return = = -EOPNOTSUPP ? 0 : err;
    }
...
#[no_mangle]
unsafe extern "C" fn br_master_vlan_rcu_free(rcu: *mut rcu_head) {
    ...
    free_percpu(v.stats);
    v.stats = core::ptr::null_mut();
    kfree(v);
    }
#[no_mangle]
unsafe extern "C" fn br_vlan_put_master(masterv: *mut net_bridge_vlan) {
...
#[no_mangle]
unsafe extern "C" fn nbp_vlan_rcu_free(rcu: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn br_vlan_init_state(v: *mut net_bridge_vlan) {
...
//
    ...
    struct netlink_ext_ack *extack)
    {
    struct net_bridge_vlan *masterv = core::ptr::null_mut();
    struct net_bridge_port *p = core::ptr::null_mut();
    struct net_bridge_vlan_group *vg;
...
// need to work on the master vlan too
    ...
    goto out_filt;
    if (changed)
    br_vlan_notify(br, core::ptr::null_mut(), v.vid, 0,
    RTM_NEWVLAN);
    }
...
#[no_mangle]
unsafe extern "C" fn __vlan_del(v: *mut net_bridge_vlan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __vlan_group_free(vg: *mut net_bridge_vlan_group) {
...
// Untagged frame
    ...
    if (!*vid) {
    let mut pvid: u16 = br_get_pvid(vg);
...
// Called under RCU
#[no_mangle]
pub unsafe extern "C" fn br_should_learn(p: *mut net_bridge_port, skb: *mut sk_buff, vid: *mut u16) -> bool {
...
// vid = br_get_pvid(vg);
    ...
    struct netlink_ext_ack *extack)
    {
    let mut becomes_brentry: bool = false;
    let mut would_change: bool = false;
    int err;
...
// It was only kept for port vlans, now make it real
    err = br_fdb_add_local(br, core::ptr::null_mut(), br.dev.dev_addr, vlan.vid);
    if (err) {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_vlan_delete(br: *mut net_bridge, vid: u16) -> c_int {
    ...
    return -ENOENT;
    br_fdb_find_delete_local(br, core::ptr::null_mut(), br.dev.dev_addr, vid);
    br_fdb_delete_by_port(br, core::ptr::null_mut(), vid, 0);
    vlan_tunnel_info_del(vg, v);
    return __vlan_del(v);
    }
#[no_mangle]
pub unsafe extern "C" fn br_vlan_flush(br: *mut net_bridge) {
    void br_vlan_flush(struct net_bridge *br)
    {
    struct net_bridge_vlan_group *vg;
    ASSERT_RTNL();
    vg = br_vlan_group(br);
    __vlan_flush(br, core::ptr::null_mut(), vg);
    RCU_INIT_POINTER(br.vlgrp, core::ptr::null_mut());
    synchronize_net();
...
// Must be protected by RTNL.
#[no_mangle]
unsafe extern "C" fn recalculate_group_addr(br: *mut net_bridge) {
...
// Must be protected by RTNL.
#[no_mangle]
pub unsafe extern "C" fn br_recalculate_fwd_mask(br: *mut net_bridge) {
    ...
    br_multicast_toggle_vlan_snooping(br, false, core::ptr::null_mut());
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn br_vlan_enabled(dev: *const net_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn br_vlan_get_proto(dev: *const net_device, p_proto: *mut u16) -> c_int {
...
// p_proto = ntohs(br->vlan_proto);
    ...
    struct net_bridge_vlan *vlan;
    struct net_bridge_vlan_group *vg;
    let mut oldproto: __be16 = br.vlan_proto;
...
// Delete VLANs for the old proto from the device filter.
    ...
    switchdev_port_attr_set(br.dev, &attr, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn br_vlan_set_stats(br: *mut net_bridge, val: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_vlan_set_stats_per_port(br: *mut net_bridge, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vlan_default_pvid(vg: *mut net_bridge_vlan_group, vid: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn br_vlan_disable_default_pvid(br: *mut net_bridge) {
    static void br_vlan_disable_default_pvid(struct net_bridge *br)
    {
    struct net_bridge_port *p;
    let mut pvid: u16 = br.default_pvid;
// Disable default_pvid on all ports where it is still
// configured.
//
    if (vlan_default_pvid(br_vlan_group(br), pvid)) {
    if (!br_vlan_delete(br, pvid))
    br_vlan_notify(br, core::ptr::null_mut(), pvid, 0, RTM_DELVLAN);
    }
    list_for_each_entry(p, &br.port_list, list) {
...
//
    ...
    br_vlan_notify(br, core::ptr::null_mut(), old_pvid, 0, RTM_DELVLAN);
    br_vlan_notify(br, core::ptr::null_mut(), pvid, 0, RTM_NEWVLAN);
    __set_bit(0, changed);
    }
    list_for_each_entry(p, &br.port_list, list) {
// Update default_pvid config only if we do not conflict with
...
//
    ...
    BRIDGE_VLAN_INFO_BRENTRY,
    &vlchange, core::ptr::null_mut());
    br_vlan_notify(br, core::ptr::null_mut(), old_pvid, 0, RTM_NEWVLAN);
    }
...
#[no_mangle]
pub unsafe extern "C" fn br_vlan_init(br: *mut net_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nbp_vlan_init(p: *mut net_bridge_port, extack: *mut netlink_ext_ack) -> c_int {
    ...
    return ret;
    err_vlan_add:
    RCU_INIT_POINTER(p.vlgrp, core::ptr::null_mut());
    synchronize_rcu();
    vlan_tunnel_deinit(vg);
    err_tunnel_init:
    rhashtable_destroy(&vg.vlan_hash);
...
// changed = false;
    ...
    if (vlan) {
    let mut would_change: bool = __vlan_flags_would_change(vlan, flags);
    if (would_change) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nbp_vlan_delete(port: *mut net_bridge_port, vid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nbp_vlan_flush(port: *mut net_bridge_port) {
    ...
    RCU_INIT_POINTER(port.vlgrp, core::ptr::null_mut());
    synchronize_net();
    __vlan_group_free(vg);
    }
...
#[no_mangle]
pub unsafe extern "C" fn br_vlan_get_pvid(dev: *const net_device, p_pvid: *mut u16) -> c_int {
    ...
    vg = nbp_vlan_group(p);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: netif_is_bridge_master(dev)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn br_vlan_get_pvid_rcu(dev: *const net_device, p_pvid: *mut u16) -> c_int {
...
// p_pvid = br_get_pvid(vg);
    ...
    {
    struct net_bridge_vlan_group *vg;
    let mut idx: c_int = ctx.num_vlans - 1;
    u16 vid;
    ...
    path.bridge.vlan_mode = DEV_PATH_BR_VLAN_KEEP;
#[no_mangle]
pub unsafe extern "C" fn if(BR_VLFLAG_TAGGING_BY_SWITCHDEV: v->priv_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn br_vlan_is_bind_vlan_dev(dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn br_vlan_has_upper_bind_vlan_dev(dev: *mut net_device) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct br_vlan_bind_walk_data {
    pub vid: u16,
    pub result: *mut net_device,
}
...
#[no_mangle]
unsafe extern "C" fn br_vlan_is_dev_up(dev: *const net_device) -> bool {
    ...
    {
    let mut vid: u16 = vlan_dev_priv(vlan_dev).vlan_id;
    struct net_bridge_vlan_group *vg;
    struct net_bridge_port *p;
    let mut has_carrier: bool = false;
...
#[no_mangle]
unsafe extern "C" fn br_vlan_set_all_vlan_dev_state(p: *mut net_bridge_port) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct br_vlan_link_state_walk_data {
...
// Must be protected by RTNL.
#[no_mangle]
unsafe extern "C" fn nbp_vlan_set_vlan_dev_state(p: *mut net_bridge_port, vid: u16) {
    static void nbp_vlan_set_vlan_dev_state(struct net_bridge_port *p, u16 vid)
    {
    struct net_device *vlan_dev;
...
// Must be protected by RTNL.
#[no_mangle]
pub unsafe extern "C" fn br_vlan_bridge_event(dev: *mut net_device, event: c_ulong, ptr: *mut c_void) -> c_int {
    int br_vlan_bridge_event(struct net_device *dev, unsigned long event, void *ptr)
    {
    struct netdev_notifier_changeupper_info *info;
    struct net_bridge *br = netdev_priv(dev);
    let mut vlcmd: c_int = 0, ret = 0;
    ...
    BRIDGE_VLAN_INFO_PVID |
    BRIDGE_VLAN_INFO_UNTAGGED |
    BRIDGE_VLAN_INFO_BRENTRY, &changed, core::ptr::null_mut());
    vlcmd = RTM_NEWVLAN;
    break;
    ...
    if (changed)
    br_vlan_notify(br, core::ptr::null_mut(), br.default_pvid, 0, vlcmd);
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(netif_carrier_ok(br_dev): !bridge_binding &&) -> else {
    else if (!bridge_binding && netif_carrier_ok(br_dev))
    netif_carrier_on(vlan_dev);
    }
// Must be protected by RTNL.
#[no_mangle]
pub unsafe extern "C" fn br_vlan_port_event(p: *mut net_bridge_port, event: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn rtnl_vlan_nlmsg_size() -> usize {
    static size_t rtnl_vlan_nlmsg_size(void)
    {
#[no_mangle]
pub unsafe extern "C" fn NLMSG_ALIGN(br_vlan_msg): sizeof(struct) -> return {
    ...
    {
    struct net_bridge_vlan_group *vg;
    struct net_bridge_vlan *v = core::ptr::null_mut();
...
// need to find the vlan due to flags/options
    ...
    goto out_err;
    nlmsg_end(skb, nlh);
    rtnl_notify(skb, net, 0, RTNLGRP_BRVLAN, core::ptr::null_mut(), GFP_KERNEL);
    return;
    out_err:
...
// check if v_curr can enter a range ending in range_end
    ...
    u32 dump_flags)
    {
    struct net_bridge_vlan *v, *range_start = core::ptr::null_mut(), *range_end = core::ptr::null_mut();
    let mut dump_global: bool = !!(dump_flags & BRIDGE_VLANDB_DUMPF_GLOBAL);
    let mut dump_stats: bool = !!(dump_flags & BRIDGE_VLANDB_DUMPF_STATS);
    struct net_bridge_vlan_group *vg;
    let mut idx: c_int = 0, s_idx = cb.args[1];
    struct nlmsghdr *nlh = core::ptr::null_mut();
    struct net_bridge_port *p;
    struct br_vlan_msg *bvm;
    struct net_bridge *br;
    let mut err: c_int = 0;
...
// advance number of filled vlans
    ...
    let mut vlan_flags: u16 = br_vlan_flags(range_start, pvid);
...
#[no_mangle]
unsafe extern "C" fn br_vlan_rtm_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int br_vlan_rtm_dump(struct sk_buff *skb, struct netlink_callback *cb)
    {
    struct nlattr *dtb[BRIDGE_VLANDB_DUMP_MAX + 1];
    let mut idx: c_int = 0, err = 0, s_idx = cb.args[0];
    struct net *net = sock_net(skb.sk);
    struct br_vlan_msg *bvm;
    struct net_device *dev;
    let mut dump_flags: u32 = 0;
...
// if the dump completed without an error we return 0 here
    ...
    {
    struct bridge_vlan_info *vinfo, vrange_end, *vinfo_last = core::ptr::null_mut();
    struct nlattr *tb[BRIDGE_VLANDB_ENTRY_MAX + 1];
    let mut changed: bool = false, skip_processing = false;
    struct net_bridge_vlan_group *vg;
    struct net_bridge_port *p = core::ptr::null_mut();
    let mut err: c_int = 0, cmdmap = 0;
    struct net_bridge *br;
    if (netif_is_bridge_master(dev)) {
    br = netdev_priv(dev);
    vg = br_vlan_group(br);
...
// this should validate the header and check for remaining bytes
    err = nlmsg_parse(nlh, sizeof(*bvm), core::ptr::null_mut(), BRIDGE_VLANDB_MAX, core::ptr::null_mut(),
    extack);
    if (err < 0)
    return err;
    bvm = nlmsg_data(nlh);
    ...
    {THIS_MODULE, PF_BRIDGE, RTM_NEWVLAN, br_vlan_rtm_process, core::ptr::null_mut(), 0},
    {THIS_MODULE, PF_BRIDGE, RTM_DELVLAN, br_vlan_rtm_process, core::ptr::null_mut(), 0},
    {THIS_MODULE, PF_BRIDGE, RTM_GETVLAN, core::ptr::null_mut(), br_vlan_rtm_dump, 0},
    };
#[no_mangle]
pub unsafe extern "C" fn br_vlan_rtnl_init() -> c_int {
    int br_vlan_rtnl_init(void)
    {
    return rtnl_register_many(br_vlan_rtnl_msg_handlers);
    }
#[no_mangle]
pub unsafe extern "C" fn br_vlan_rtnl_uninit() {
