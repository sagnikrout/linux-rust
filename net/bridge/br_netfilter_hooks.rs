...
//! Source: net/bridge/br_netfilter_hooks.c
#![no_std]
...
// default value is 1
    pub call_iptables: c_int,
    pub call_ip6tables: c_int,
    pub call_arptables: c_int,
// default value is 0
    pub filter_vlan_tagged: c_int,
    pub filter_pppoe_tagged: c_int,
    pub pass_vlan_indev: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn vlan_proto(skb: *const sk_buff) -> __be16 {
    static inline __be16 vlan_proto(const struct sk_buff *skb)
    {
    if (skb_vlan_tag_present(skb))
    return skb.protocol;
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_8021Q): skb->protocol ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn is_vlan_ip(skb: *const sk_buff, net: *const net) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_vlan_arp(skb: *const sk_buff, net: *const net) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pppoe_proto(skb: *const sk_buff) -> __be16 {
...
#[no_mangle]
pub unsafe extern "C" fn is_pppoe_ip(skb: *const sk_buff, net: *const net) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brnf_frag_data {
    pub bh_lock: local_lock_t,
    pub mac: [c_char; NF_BRIDGE_MAX_MAC_HEADER_LENGTH],
    pub encap_size: u8,
    pub size: u8,
    pub vlan_tci: u16,
...
#[no_mangle]
unsafe extern "C" fn nf_bridge_info_free(skb: *mut sk_buff) {
    ...
    return port ? port.br.dev : core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn nf_bridge_encap_header_len(skb: *const sk_buff) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nf_bridge_pull_encap_header(skb: *mut sk_buff) {
    static inline void nf_bridge_pull_encap_header(struct sk_buff *skb)
    {
    let mut len: c_uint = nf_bridge_encap_header_len(skb);
    skb_pull(skb, len);
    skb.network_header += len;
    }
#[no_mangle]
pub unsafe extern "C" fn nf_bridge_pull_encap_header_rcsum(skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn br_validate_ipv4(net: *mut net, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nf_bridge_update_protocol(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_nf_pre_routing_finish_bridge(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn br_nf_pre_routing_finish(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    nf_bridge_update_protocol(skb);
    nf_bridge_push_encap_header(skb);
    br_nf_hook_thresh(NF_BR_PRE_ROUTING, net, sk, skb, skb.dev, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_PPP_SES): skb->protocol ==) -> else {
...
// address to be able to detect DNAT afterwards.
    ...
    let mut len: __u32 = nf_bridge_encap_header_len(skb);
...
//
    ...
    const struct nf_hook_state *state)
    {
    let mut promisc: bool = BR_INPUT_SKB_CB(skb).promisc;
...
// PF_BRIDGE/FORWARD
#[no_mangle]
unsafe extern "C" fn br_nf_forward_finish(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
// different physoutdevs.
    ...
    NF_HOOK(pf, NF_INET_FORWARD, state.net, core::ptr::null_mut(), skb,
...
#[no_mangle]
unsafe extern "C" fn br_nf_push_frag_xmit(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    {
    let mut mtu: c_uint = ip_skb_dst_mtu(sk, skb);
...
#[no_mangle]
unsafe extern "C" fn nf_bridge_mtu_reduction(skb: *const sk_buff) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn br_nf_dev_queue_xmit(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn br_nf_pre_routing_finish_bridge_slow(skb: *mut sk_buff) {
    ...
    ETH_HLEN - ETH_ALEN);
    skb.dev = br_indev;
    nf_bridge.physoutdev = core::ptr::null_mut();
    br_handle_frame_finish(dev_net(skb.dev), core::ptr::null_mut(), skb);
    }
#[no_mangle]
unsafe extern "C" fn br_nf_dev_xmit(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_netfilter_sysctl_default(brnf: *mut brnf_net) {
...
#[no_mangle]
unsafe extern "C" fn br_netfilter_sysctl_init_net(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brnf_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn brnf_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn br_netfilter_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn br_netfilter_fini() -> void __exit {
    static void __exit br_netfilter_fini(void)
    {
    RCU_INIT_POINTER(nf_br_ops, core::ptr::null_mut());
