...
//! Source: net/bridge/br_forward.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn br_dev_queue_push_xmit(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_forward_finish(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
// redirect to backup link if the destination port is down
    ...
    struct sk_buff *skb, bool local_orig)
    {
    let mut igmp_type: u8 = br_multicast_igmp_type(skb);
    int err;
...
// called under rcu_read_lock
    ...
    u16 vid)
    {
    let mut reason: enum skb_drop_reason = SKB_DROP_REASON_NO_TX_TARGET;
    struct net_bridge_port *prev = core::ptr::null_mut();
...
// called with rcu_read_lock
    ...
    let mut allow_mode_include: bool = true;
    ...
    lport = p ? p.key.port : core::ptr::null_mut();
