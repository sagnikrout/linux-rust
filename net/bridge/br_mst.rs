...
#[no_mangle]
pub unsafe extern "C" fn br_mst_enabled(dev: *const net_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn br_mst_uninit(br: *mut net_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn br_mst_get_info(dev: *const net_device, msti: u16, vids: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn br_mst_get_state(dev: *const net_device, msti: u16, state: *mut u8) -> c_int {
    int br_mst_get_state(const struct net_device *dev, u16 msti, u8 *state)
    {
    const struct net_bridge_port *p = core::ptr::null_mut();
    const struct net_bridge_vlan_group *vg;
    const struct net_bridge_vlan *v;
    ASSERT_RTNL();
...
#[no_mangle]
unsafe extern "C" fn br_mst_vlan_sync_state(pv: *mut net_bridge_vlan, msti: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn br_mst_vlan_set_msti(mv: *mut net_bridge_vlan, msti: u16) -> c_int {
    ...
    if (mv.msti == msti)
    return 0;
    err = switchdev_port_attr_set(mv.br.dev, &attr, core::ptr::null_mut());
    if (err && err != -EOPNOTSUPP)
    return err;
    mv.msti = msti;
...
#[no_mangle]
pub unsafe extern "C" fn br_mst_vlan_init_state(v: *mut net_bridge_vlan) {
...
#[no_mangle]
pub unsafe extern "C" fn br_mst_info_size(vg: *const net_bridge_vlan_group) -> usize {
