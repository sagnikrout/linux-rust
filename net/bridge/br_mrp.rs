...
// SPDX-License-Identifier: GPL-2.0-or-later
    ...
    u32 ifindex)
    {
    struct net_bridge_port *res = core::ptr::null_mut();
    struct net_bridge_port *port;
    ...
    {
    struct br_mrp *res = core::ptr::null_mut();
    struct br_mrp *mrp;
...
#[no_mangle]
unsafe extern "C" fn br_mrp_unique_ifindex(br: *mut net_bridge, ifindex: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn br_mrp_next_seq(mrp: *mut br_mrp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn br_mrp_skb_common(skb: *mut sk_buff, mrp: *mut br_mrp) {
    ...
    {
    struct br_mrp_ring_test_hdr *hdr = core::ptr::null_mut();
...
//
    ...
    struct br_mrp_sub_option1_hdr *sub_opt = core::ptr::null_mut();
    struct br_mrp_tlv_hdr *sub_tlv = core::ptr::null_mut();
    struct br_mrp_oui_hdr *oui = core::ptr::null_mut();
    u8 length;
...
// 32 bit alligment shall be ensured therefore add 2 bytes
    ...
    enum br_mrp_port_role_type port_role)
    {
    struct br_mrp_in_test_hdr *hdr = core::ptr::null_mut();
    struct sk_buff *skb = core::ptr::null_mut();
    if (!p)
    return core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn br_mrp_test_work_expired(work: *mut work_struct) {
    static void br_mrp_test_work_expired(struct work_struct *work)
    {
    struct delayed_work *del_work = to_delayed_work(work);
    struct br_mrp *mrp = container_of(del_work, struct br_mrp, test_work);
    struct net_bridge_port *p;
    let mut notify_open: bool = false;
    struct sk_buff *skb;
...
//
#[no_mangle]
unsafe extern "C" fn br_mrp_in_test_work_expired(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn br_mrp_del_impl(br: *mut net_bridge, mrp: *mut br_mrp) {
...
// Reset the ports
    ...
    rcu_assign_pointer(mrp.p_port, core::ptr::null_mut());
    }
    p = rtnl_dereference(mrp.s_port);
    if (p) {
    spin_lock_bh(&br.lock);
    ...
    spin_unlock_bh(&br.lock);
    br_mrp_port_switchdev_set_state(p, state);
    rcu_assign_pointer(mrp.s_port, core::ptr::null_mut());
    }
    p = rtnl_dereference(mrp.i_port);
    if (p) {
    spin_lock_bh(&br.lock);
    ...
    spin_unlock_bh(&br.lock);
    br_mrp_port_switchdev_set_state(p, state);
    rcu_assign_pointer(mrp.i_port, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn br_mrp_add(br: *mut net_bridge, instance: *mut br_mrp_instance) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_mrp_port_del(br: *mut net_bridge, p: *mut net_bridge_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_mrp_del(br: *mut net_bridge, instance: *mut br_mrp_instance) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_mrp_set_in_state(br: *mut net_bridge, state: *mut br_mrp_in_state) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn br_mrp_set_in_role(br: *mut net_bridge, role: *mut br_mrp_in_role) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn br_mrp_ring_frame(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn br_mrp_in_frame(skb: *mut sk_buff) -> bool {
...
// Determine if the test hdr has a better priority than the node
    ...
    {
    let mut prio: u16 = be16_to_cpu(hdr.prio);
    if (prio < mrp.prio ||
    (prio == mrp.prio &&
...
//
#[no_mangle]
unsafe extern "C" fn br_mrp_get_frame_type(skb: *mut sk_buff) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn br_mrp_mrm_behaviour(mrp: *mut br_mrp) -> bool {
...
#[no_mangle]
unsafe extern "C" fn br_mrp_mrc_behaviour(mrp: *mut br_mrp) -> bool {
...
//
    ...
    {
    struct net_bridge_port *p_port, *s_port, *i_port = core::ptr::null_mut();
    struct net_bridge_port *p_dst, *s_dst, *i_dst = core::ptr::null_mut();
    struct net_bridge *br;
    struct br_mrp *mrp;
...
//
    ...
    let mut in_type: u8 = br_mrp_get_frame_type(skb);
...
//
    ...
    p_dst = core::ptr::null_mut();
    s_dst = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn br_mrp_process(p: *mut net_bridge_port, skb: *mut sk_buff) -> c_int {
    static int br_mrp_process(struct net_bridge_port *p, struct sk_buff *skb)
    {
...
#[no_mangle]
pub unsafe extern "C" fn br_mrp_enabled(br: *mut net_bridge) -> bool {
