...
//! Source: net/sched/sch_ingress.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingress_sched_data {
    pub block: *mut tcf_block,
    pub block_info: tcf_block_ext_info,
    pub miniqp: mini_Qdisc_pair,
}
...
#[no_mangle]
unsafe extern "C" fn ingress_find(sch: *mut Qdisc, classid: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn ingress_unbind_filter(sch: *mut Qdisc, cl: c_ulong) {
    static void ingress_unbind_filter(struct Qdisc *sch, unsigned long cl)
    {
    }
#[no_mangle]
unsafe extern "C" fn ingress_walk(sch: *mut Qdisc, walker: *mut qdisc_walker) {
...
#[no_mangle]
unsafe extern "C" fn clsact_chain_head_change(tp_head: *mut tcf_proto, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ingress_ingress_block_set(sch: *mut Qdisc, block_index: u32) {
...
#[no_mangle]
unsafe extern "C" fn ingress_ingress_block_get(sch: *mut Qdisc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ingress_destroy(sch: *mut Qdisc) {
    ...
    tcx_entry_update(dev, core::ptr::null_mut(), true);
...
#[no_mangle]
unsafe extern "C" fn ingress_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clsact_sched_data {
    pub ingress_block: *mut tcf_block,
    pub egress_block: *mut tcf_block,
    pub ingress_block_info: tcf_block_ext_info,
    pub egress_block_info: tcf_block_ext_info,
    pub miniqp_ingress: mini_Qdisc_pair,
    pub miniqp_egress: mini_Qdisc_pair,
}

#[no_mangle]
unsafe extern "C" fn clsact_find(sch: *mut Qdisc, classid: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn clsact_ingress_block_set(sch: *mut Qdisc, block_index: u32) {
...
#[no_mangle]
unsafe extern "C" fn clsact_egress_block_set(sch: *mut Qdisc, block_index: u32) {
...
#[no_mangle]
unsafe extern "C" fn clsact_ingress_block_get(sch: *mut Qdisc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn clsact_egress_block_get(sch: *mut Qdisc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn clsact_destroy(sch: *mut Qdisc) {
    ...
    tcx_entry_update(dev, core::ptr::null_mut(), false);
...
#[no_mangle]
unsafe extern "C" fn ingress_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ingress_module_exit() -> void __exit {
