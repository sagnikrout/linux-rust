...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cbs_sched_data {
    pub offload: bool,
    pub queue: c_int,
    pub /: *mut *mut atomic64_t port_rate; / in bytes/s,
    pub /: *mut *mut s64 last; / timestamp in ns,
    pub /: *mut *mut s64 credits; / in bytes,
    pub /: *mut *mut s32 locredit; / in bytes,
    pub /: *mut *mut s32 hicredit; / in bytes,
    pub /: *mut *mut s64 sendslope; / in bytes/s,
    pub /: *mut *mut s64 idleslope; / in bytes/s,
    pub watchdog: qdisc_watchdog,
    int (*enqueue)(struct sk_buff *skb, struct Qdisc *sch,
    pub to_free): *mut sk_buff,
    pub sch): *mut *mut *mut sk_buff (dequeue)(Qdisc,
    pub qdisc: *mut Qdisc,
    pub cbs_list: list_head,
}
...
#[no_mangle]
unsafe extern "C" fn timediff_to_credits(timediff: i64, slope: i64) -> i64 {
    static s64 timediff_to_credits(s64 timediff, s64 slope)
    {
    return div64_s64(timediff * slope, NSEC_PER_SEC);
    }
#[no_mangle]
unsafe extern "C" fn delay_from_credits(credits: i64, slope: i64) -> i64 {
...
#[no_mangle]
unsafe extern "C" fn credits_from_len(len: c_uint, slope: i64, port_rate: i64) -> i64 {
...
#[no_mangle]
unsafe extern "C" fn cbs_reset(sch: *mut Qdisc) {
...
// Nothing to do if we couldn't create the underlying qdisc
    ...
    {
    let mut cbs: tc_cbs_qopt_offload = { };
...
#[no_mangle]
unsafe extern "C" fn cbs_set_port_rate(dev: *mut net_device, q: *mut cbs_sched_data) {
...
#[no_mangle]
unsafe extern "C" fn cbs_destroy(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn cbs_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
    static int cbs_dump(struct Qdisc *sch, struct sk_buff *skb)
    {
    struct cbs_sched_data *q = qdisc_priv(sch);
    let mut opt: tc_cbs_qopt = { };
    struct nlattr *nest;
...
#[no_mangle]
unsafe extern "C" fn cbs_find(sch: *mut Qdisc, classid: u32) -> c_ulong {
    static unsigned long cbs_find(struct Qdisc *sch, u32 classid)
    {
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn cbs_walk(sch: *mut Qdisc, walker: *mut qdisc_walker) {
...
#[no_mangle]
unsafe extern "C" fn cbs_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cbs_module_exit() -> void __exit {
