...
pub const ACT_BPF_NAME_LEN: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcf_bpf_cfg {
...
#[no_mangle]
unsafe extern "C" fn tcf_bpf_is_ebpf(prog: *const tcf_bpf) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcf_bpf_init_from_ops(tb: *mut nlattr, cfg: *mut tcf_bpf_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_bpf_init_from_efd(tb: *mut nlattr, cfg: *mut tcf_bpf_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_bpf_cfg_cleanup(cfg: *const tcf_bpf_cfg) {
...
//
    ...
    act_bpf_policy, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn tcf_bpf_get_fill_size(act: *const tc_action) -> usize {
    static size_t tcf_bpf_get_fill_size(const struct tc_action *act)
    {
    struct tcf_bpf *prog = to_bpf(act);
    let mut size: usize = nla_total_size(sizeof(struct tc_act_bpf));
...
#[no_mangle]
unsafe extern "C" fn bpf_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn bpf_exit_net(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn bpf_init_module() -> int __init {
    static int __init bpf_init_module(void)
    {
    return tcf_register_action(&act_bpf_ops, &bpf_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn bpf_cleanup_module() -> void __exit {
