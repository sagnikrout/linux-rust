...
//
    ...
    {
    struct multiq_sched_data *q = qdisc_priv(sch);
    let mut curband: c_uint = q.curband;
    struct Qdisc *qdisc;
    struct sk_buff *skb;
    int band;
    for (band = 0; band < q.bands; band++) {
...
#[no_mangle]
unsafe extern "C" fn multiq_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn multiq_find(sch: *mut Qdisc, classid: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn multiq_unbind(q: *mut Qdisc, cl: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn multiq_walk(sch: *mut Qdisc, arg: *mut qdisc_walker) {
...
#[no_mangle]
unsafe extern "C" fn multiq_module_init() -> int __init {
    static int __init multiq_module_init(void)
    {
    return register_qdisc(&multiq_qdisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn multiq_module_exit() -> void __exit {
