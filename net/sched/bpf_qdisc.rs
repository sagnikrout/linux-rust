...
#[no_mangle]
unsafe extern "C" fn bpf_qdisc_init(btf: *mut btf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_skb_get_hash(skb: *mut sk_buff) -> __bpf_kfunc u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_kfree_skb(skb: *mut sk_buff) -> __bpf_kfunc void {
    __bpf_kfunc void bpf_kfree_skb(struct sk_buff *skb)
    {
    kfree_skb(skb);
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_kfree_skb_dtor(skb: *mut c_void) -> __bpf_kfunc void {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_qdisc_watchdog_schedule(sch: *mut Qdisc, expire: u64, delta_ns: u64) -> __bpf_kfunc void {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_qdisc_reset_destroy_epilogue(sch: *mut Qdisc) -> __bpf_kfunc void {
...
//
#[no_mangle]
pub unsafe extern "C" fn bpf_qdisc_bstats_update(sch: *mut Qdisc, skb: *const sk_buff) -> __bpf_kfunc void {
...
#[no_mangle]
unsafe extern "C" fn bpf_qdisc_kfunc_filter(prog: *const bpf_prog, kfunc_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_qdisc_reg(kdata: *mut c_void, link: *mut bpf_link) -> c_int {
    static int bpf_qdisc_reg(void *kdata, struct bpf_link *link)
    {
    return register_qdisc(kdata);
    }
#[no_mangle]
unsafe extern "C" fn bpf_qdisc_unreg(kdata: *mut c_void, link: *mut bpf_link) {
    static void bpf_qdisc_unreg(void *kdata, struct bpf_link *link)
    {
    return unregister_qdisc(kdata);
    }
#[no_mangle]
unsafe extern "C" fn bpf_qdisc_validate(kdata: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn Qdisc_ops__reset(sch: *mut Qdisc) {
    static void Qdisc_ops__reset(struct Qdisc *sch)
    {
    }
#[no_mangle]
unsafe extern "C" fn Qdisc_ops__destroy(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn bpf_qdisc_kfunc_init() -> int __init {
