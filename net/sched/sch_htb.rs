...
pub const HTB_VER: c_uint = 0x30011		/* major must be matched with number supplied by TC as version */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct htb_class {
    pub common: Qdisc_class_common,
    pub rate: psched_ratecfg,
    pub ceil: psched_ratecfg,
    pub /: *mut *mut s64 buffer, cbuffer;/ token bucket depth/rate,
    pub /: *mut *mut s64 mbuffer; / max wait time,
    pub /: *mut *mut u32 prio; / these two are used only by leaves...,
    pub /: *mut *mut int quantum; / but stored for parent-to-leaf return,
    pub /: *mut *mut *mut tcf_proto __rcu filter_list; / class attached filters,
    pub block: *mut tcf_block,
    pub /: *mut *mut int level; / our level (see above),
    pub children: c_uint,
    pub /: *mut *mut *mut htb_class parent; / parent class,
    pub rate_est: *mut net_rate_estimator __rcu,
//
// Written often fields
//
    pub bstats: gnet_stats_basic_sync,
    pub bstats_bias: gnet_stats_basic_sync,
    pub xstats_lends: u32,
    pub xstats_borrows: u32,
// token bucket parameters
    pub /: *mut *mut s64 tokens, ctokens;/ current number of tokens,
    pub /: *mut *mut s64 t_c; / checkpoint time,
    union {
#[repr(C)]
#[derive(Copy, Clone)]
pub struct htb_class_leaf {
    pub deficit: [c_int; TC_HTB_MAXDEPTH],
    pub q: *mut Qdisc,
    pub offload_queue: *mut netdev_queue,
    pub leaf: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct htb_class_inner {
    pub clprio: [htb_prio; TC_HTB_NUMPRIO],
    pub inner: },
}
...
pub struct htb_level {
    pub wait_pq: rb_root,
    pub hprio: [htb_prio; TC_HTB_NUMPRIO],
}
...
pub struct htb_sched {
    ...
    pub /: *mut *mut int defcls; / class where unclassified flows go to,
    pub /: *mut *mut int rate2quantum; / quant = rate / rate2quantum,
// filters for qdisc itself
    pub filter_list: *mut tcf_proto __rcu,
    pub block: *mut tcf_block,
pub const HTB_WARN_TOOMANYEVENTS: c_uint = 0x1;
    pub /: *mut *mut unsigned int warned; / only one warning,
    pub direct_qlen: c_int,
    pub work: work_struct,
// non shaped skbs; let them go directly thru
    pub direct_queue: qdisc_skb_head,
    pub direct_pkts: u32,
    pub overlimits: u32,
    pub watchdog: qdisc_watchdog,
    pub /: *mut *mut s64 now; / cached dequeue time,
// time of nearest event per level (row)
    pub near_ev_cache: [i64; TC_HTB_MAXDEPTH],
    pub row_mask: [c_int; TC_HTB_MAXDEPTH],
    pub hlevel: [htb_level; TC_HTB_MAXDEPTH],
    pub direct_qdiscs: *mut Qdisc,
    pub num_direct_qdiscs: c_uint,
    pub offload: bool,
}
...
#[no_mangle]
unsafe extern "C" fn htb_search(sch: *mut Qdisc, handle: u32) -> c_ulong {
...
//
    ...
    {
    struct rb_node **p = &root.rb_node, *parent = core::ptr::null_mut();
    while (*p) {
    struct htb_class *c;
    parent = *p;
...
//
    ...
    {
    struct rb_node **p = &q.hlevel[cl.level].wait_pq.rb_node, *parent = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn htb_next_rb_node(n: *mut rb_node) {
...
#[no_mangle]
unsafe extern "C" fn htb_safe_rb_erase(rb: *mut rb_node, root: *mut rb_root) {
...
//
#[no_mangle]
unsafe extern "C" fn htb_activate_prios(q: *mut htb_sched, cl: *mut htb_class) {
...
//
#[no_mangle]
unsafe extern "C" fn htb_deactivate_prios(q: *mut htb_sched, cl: *mut htb_class) {
...
//
    ...
    p.inner.clprio[prio].ptr = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn htb_lowater(cl: *const htb_class) -> i64 {
...
#[no_mangle]
pub unsafe extern "C" fn htb_hiwater(cl: *const htb_class) -> i64 {
...
//
    ...
    {
    let mut new_mode: enum htb_cmode = htb_class_mode(cl, diff);
...
//
#[no_mangle]
pub unsafe extern "C" fn htb_activate(q: *mut htb_sched, cl: *mut htb_class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn htb_deactivate(q: *mut htb_sched, cl: *mut htb_class) {
...
#[no_mangle]
pub unsafe extern "C" fn htb_accnt_tokens(cl: *mut htb_class, bytes: c_int, diff: i64) {
    static inline void htb_accnt_tokens(struct htb_class *cl, int bytes, s64 diff)
    {
    let mut toks: i64 = diff + cl.tokens;
    if (toks > cl.buffer)
    toks = cl.buffer;
...
#[no_mangle]
pub unsafe extern "C" fn htb_accnt_ctokens(cl: *mut htb_class, bytes: c_int, diff: i64) {
    static inline void htb_accnt_ctokens(struct htb_class *cl, int bytes, s64 diff)
    {
    let mut toks: i64 = diff + cl.ctokens;
    if (toks > cl.cbuffer)
    toks = cl.cbuffer;
...
//
    ...
    {
    let mut bytes: c_int = qdisc_pkt_len(skb);
...
// too soon
//
    let mut stop_at: c_ulong = start + 2;
...
//
    ...
    u32 id)
    {
    struct rb_node *r = core::ptr::null_mut();
    while (n) {
    struct htb_class *cl =
...
// common case optimization - skip event handler quickly
    int m;
    let mut event: i64 = q.near_ev_cache[level];
    if (q.now >= event) {
...
#[no_mangle]
unsafe extern "C" fn htb_reset(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn htb_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn htb_offload(dev: *mut net_device, opt: *mut tc_htb_qopt_offload) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn htb_attach_offload(sch: *mut Qdisc) {
    ...
    struct netdev_queue *dev_queue = netdev_get_tx_queue(dev, ntx);
    struct Qdisc *old = dev_graft_qdisc(dev_queue, core::ptr::null_mut());
    qdisc_put(old);
    }
    kfree(q.direct_qdiscs);
    q.direct_qdiscs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn htb_attach_software(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn htb_attach(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn htb_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
...
//
    ...
    gnet_stats_copy_queue(d, core::ptr::null_mut(), &qs, qlen) < 0)
    return -1;
    ...
    if (dev.flags & IFF_UP)
    dev_deactivate(dev, false);
    qdisc = dev_graft_qdisc(queue_old, core::ptr::null_mut());
...
// old = qdisc_replace(sch, new, &cl->leaf.q);
    ...
    {
    struct htb_class *cl = (struct htb_class *)arg;
    return !cl.level ? cl.leaf.q : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn htb_qlen_notify(sch: *mut Qdisc, arg: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn htb_parent_last_child(cl: *mut htb_class) -> c_int {
...
//
    if (!destroying) {
    old = htb_graft_helper(dev_queue, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn htb_destroy_class(sch: *mut Qdisc, cl: *mut htb_class) {
...
#[no_mangle]
unsafe extern "C" fn htb_destroy(sch: *mut Qdisc) {
...
//
    ...
    cl.parent.children--;
    if (last_child)
    htb_parent_to_leaf(sch, cl, core::ptr::null_mut());
    htb_destroy_class(sch, cl);
    }
    }
    } while (changed);
    ...
    struct htb_sched *q = qdisc_priv(sch);
    struct htb_class *cl = (struct htb_class *)arg;
    struct Qdisc *new_q = core::ptr::null_mut();
    let mut last_child: c_int = 0;
    int err;
...
// delete from hash and active; remainder in destroy_class
    ...
    struct nlattr *tb[TCA_HTB_MAX + 1];
    struct Qdisc *parent_qdisc = core::ptr::null_mut();
    struct netdev_queue *dev_queue;
...
// extract all subattrs from opt attr
    ...
    goto failure;
    err = -EINVAL;
    if (tb[TCA_HTB_PARMS] == core::ptr::null_mut())
    goto failure;
    parent = parentid == TC_H_ROOT ? core::ptr::null_mut() : htb_find(parentid, sch);
...
// Assign a dev_queue to this classid.
    ...
    old_q = htb_graft_helper(dev_queue, core::ptr::null_mut());
...
//
    if (!cl.level) {
    let mut quantum: u64 = cl.rate.rate_bytes_ps;
...
#[no_mangle]
unsafe extern "C" fn htb_unbind_filter(sch: *mut Qdisc, arg: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn htb_walk(sch: *mut Qdisc, arg: *mut qdisc_walker) {
...
#[no_mangle]
unsafe extern "C" fn htb_module_init() -> int __init {
    static int __init htb_module_init(void)
    {
    return register_qdisc(&htb_qdisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn htb_module_exit() -> void __exit {
