...
// add skb to flow queue (tail add)
    ...
    int ret;
    let mut memory_limited: u8 = false;
    let mut enqueue: u8 = false;
    u32 pkt_len;
    u32 idx;
...
// force a pass through old_flows to prevent starvation
    ...
    let mut limit: u32 = nla_get_u32(tb[TCA_FQ_PIE_LIMIT]);
...
// target is in us
    let mut target: u32 = nla_get_u32(tb[TCA_FQ_PIE_TARGET]);
...
#[no_mangle]
unsafe extern "C" fn fq_pie_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn fq_pie_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fq_pie_dump_stats(sch: *mut Qdisc, d: *mut gnet_dump) -> c_int {
    static int fq_pie_dump_stats(struct Qdisc *sch, struct gnet_dump *d)
    {
    struct fq_pie_sched_data *q = qdisc_priv(sch);
    let mut st: tc_fq_pie_xstats = { 0 };
...
#[no_mangle]
unsafe extern "C" fn fq_pie_reset(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn fq_pie_destroy(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn fq_pie_module_init() -> int __init {
    static int __init fq_pie_module_init(void)
    {
    return register_qdisc(&fq_pie_qdisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn fq_pie_module_exit() -> void __exit {
