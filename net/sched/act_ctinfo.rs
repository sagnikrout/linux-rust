...
//
    ...
    {
    const struct nf_conntrack_tuple_hash *thash = core::ptr::null_mut();
    ...
    let mut dscpmask: u32 = 0, dscpstatemask, index;
...
#[no_mangle]
unsafe extern "C" fn tcf_ctinfo_cleanup(a: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn tcf_ctinfo_get_fill_size(act: *const tc_action) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ctinfo_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn ctinfo_exit_net(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ctinfo_init_module() -> int __init {
    static int __init ctinfo_init_module(void)
    {
    return tcf_register_action(&act_ctinfo_ops, &ctinfo_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn ctinfo_cleanup_module() -> void __exit {
