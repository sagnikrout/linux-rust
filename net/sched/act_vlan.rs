...
// put updated tci as hwaccel tag
    ...
    let mut push_prio_exists: bool = false;
    struct tcf_vlan_params *p;
    struct tc_vlan *parm;
    struct tcf_vlan *v;
    int action;
...
#[no_mangle]
unsafe extern "C" fn tcf_vlan_cleanup(a: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn tcf_vlan_get_fill_size(act: *const tc_action) -> usize {
    static size_t tcf_vlan_get_fill_size(const struct tc_action *act)
    {
#[no_mangle]
pub unsafe extern "C" fn nla_total_size(tc_vlan): sizeof(struct) -> return {
...
#[no_mangle]
unsafe extern "C" fn vlan_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn vlan_exit_net(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn vlan_init_module() -> int __init {
    static int __init vlan_init_module(void)
    {
    return tcf_register_action(&act_vlan_ops, &vlan_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn vlan_cleanup_module() -> void __exit {
