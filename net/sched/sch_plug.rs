...
#[no_mangle]
unsafe extern "C" fn plug_module_init() -> int __init {
    static int __init plug_module_init(void)
    {
    return register_qdisc(&plug_qdisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn plug_module_exit() -> void __exit {
