...
// XXX: I am sure we can come up with more efficient swapping
    ...
    skbmod_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn tcf_skbmod_cleanup(a: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn skbmod_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn skbmod_exit_net(net_list: *mut list_head) -> void __net_exit {
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn skbmod_init_module() -> int __init {
    static int __init skbmod_init_module(void)
    {
    return tcf_register_action(&act_skbmod_ops, &skbmod_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn skbmod_cleanup_module() -> void __exit {
