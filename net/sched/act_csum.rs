...
//
    ...
    if (err < 0)
    return err;
    if (tb[TCA_CSUM_PARMS] == core::ptr::null_mut())
    return -EINVAL;
...
//
    ...
    unsigned int jhl)
    {
    let mut ntkoff: c_int = skb_network_offset(skb);
    let mut hl: c_int = ihl + jhl;
...
#[no_mangle]
pub unsafe extern "C" fn if(ihl): *mut *mut (ul >= sizeof(udph)) && (ul <= ipl -) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcf_csum_ipv4(skb: *mut sk_buff, update_flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_csum_ipv6(skb: *mut sk_buff, update_flags: u32) -> c_int {
    ...
    let mut orig_vlan_tag_present: bool = false;
    let mut vlan_hdr_count: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn tcf_csum_cleanup(a: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn tcf_csum_get_fill_size(act: *const tc_action) -> usize {
...
#[no_mangle]
unsafe extern "C" fn csum_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn csum_exit_net(net_list: *mut list_head) -> void __net_exit {
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn csum_init_module() -> int __init {
    static int __init csum_init_module(void)
    {
    return tcf_register_action(&act_csum_ops, &csum_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn csum_cleanup_module() -> void __exit {
