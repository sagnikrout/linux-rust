...
//
    ...
    ---dequeue
    dequeue usually returns a skb to send. It is allowed to return core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn register_qdisc(qops: *mut Qdisc_ops) -> c_int {
    int register_qdisc(struct Qdisc_ops *qops)
    {
    struct Qdisc_ops *q, **qp;
    let mut rc: c_int = -EEXIST;
    write_lock(&qdisc_mod_lock);
    for (qp = &qdisc_base; (q = *qp) != core::ptr::null_mut(); qp = &q.next)
    if (!strcmp(qops.id, q.id))
    goto out;
    if (qops.enqueue == core::ptr::null_mut())
    qops.enqueue = noop_qdisc_ops.enqueue;
    if (qops.peek == core::ptr::null_mut()) {
    if (qops.dequeue == core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn unregister_qdisc(qops: *mut Qdisc_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_get_default(name: *mut c_char, len: usize) {
    ...
    {
    struct Qdisc_ops *q = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_set_default(name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch_default_qdisc() -> int __init {
...
//
    ...
    struct Qdisc *q;
    if (!qdisc_dev(root))
    return (root.handle == handle ? root : core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_hash_add(q: *mut Qdisc, invisible: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_hash_del(q: *mut Qdisc) {
...
//
#[no_mangle]
unsafe extern "C" fn __detect_linklayer(r: *mut tc_ratespec, rtab: *mut __u32) -> __u8 {
    static __u8 __detect_linklayer(struct tc_ratespec *r, __u32 *rtab)
    {
    let mut low: c_int = roundup(r.mpu, 48);
    let mut high: c_int = roundup(low+1, 48);
    let mut cell_low: c_int = low >> r.cell_log;
    let mut cell_high: c_int = (high >> r.cell_log) - 1;
// rtab is too inaccurate at rates > 100Mbit/s
    ...
    if (tab == core::ptr::null_mut() || r.rate == 0 ||
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_put_rtab(tab: *mut qdisc_rate_table) {
...
// rtabp = rtab->next;
    ...
    let mut tsize: c_uint = 0;
    u16 *tab = core::ptr::null_mut();
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_put_stab(tab: *mut qdisc_size_table) {
...
#[no_mangle]
unsafe extern "C" fn qdisc_dump_stab(skb: *mut sk_buff, stab: *mut qdisc_size_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qdisc_watchdog(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_watchdog_init(wd: *mut qdisc_watchdog, qdisc: *mut Qdisc) {
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_watchdog_cancel(wd: *mut qdisc_watchdog) {
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_class_hash_grow(sch: *mut Qdisc, clhash: *mut Qdisc_class_hash) {
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_class_hash_init(clhash: *mut Qdisc_class_hash) -> c_int {
    int qdisc_class_hash_init(struct Qdisc_class_hash *clhash)
    {
    let mut size: c_uint = 4;
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_class_hash_destroy(clhash: *mut Qdisc_class_hash) {
...
//
#[no_mangle]
unsafe extern "C" fn qdisc_alloc_handle(dev: *mut net_device) -> u32 {
    static u32 qdisc_alloc_handle(struct net_device *dev)
    {
    let mut i: c_int = 0x8000;
    let mut autohandle: static u32 = TC_H_MAKE(0x80000000U, 0);
    do {
...
#[no_mangle]
pub unsafe extern "C" fn qdisc_tree_reduce_backlog(sch: *mut Qdisc, n: c_int, len: c_int) {
...
//
    ...
    qdisc_offload_graft_helper(dev, core::ptr::null_mut(), new, old,
    ...
    struct netlink_ext_ack *extack)
    {
    struct gnet_stats_basic_sync __percpu *cpu_bstats = core::ptr::null_mut();
    struct gnet_stats_queue __percpu *cpu_qstats = core::ptr::null_mut();
    struct tcmsg *tcm;
    struct nlmsghdr  *nlh;
    ...
    if (!skb)
    return -ENOBUFS;
    if (!tc_qdisc_dump_ignore(q, false, core::ptr::null_mut())) {
    ...
    if (!skb)
    return -ENOBUFS;
    if (old && !tc_qdisc_dump_ignore(old, false, core::ptr::null_mut())) {
    if (tc_fill_qdisc(skb, old, clid, portid, n.nlmsg_seq,
    0, RTM_DELQDISC, extack) < 0)
    goto err_out;
    }
    if (new && !tc_qdisc_dump_ignore(new, false, core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn qdisc_clear_nolock(sch: *mut Qdisc) {
    ...
    sch.cpu_bstats = core::ptr::null_mut();
    sch.cpu_qstats = core::ptr::null_mut();
...
//
    ...
    old = dev_graft_qdisc(dev_queue, core::ptr::null_mut());
...
// errp = err;
    ...
    struct netlink_ext_ack *extack)
    {
    struct qdisc_size_table *ostab, *stab = core::ptr::null_mut();
    let mut err: c_int = 0;
    if (tca[TCA_OPTIONS]) {
    if (!sch.ops.change) {
...
#[no_mangle]
unsafe extern "C" fn check_loop(q: *mut Qdisc, p: *mut Qdisc, depth: c_int) -> c_int {
    static int check_loop(struct Qdisc *q, struct Qdisc *p, int depth)
    {
    struct check_loop_arg	arg;
    if (q.ops.cl_ops == core::ptr::null_mut())
    return 0;
...
//
    ...
    struct Qdisc *p = core::ptr::null_mut();
    u32 clid;
    int err;
    clid = tcm.tcm_parent;
    if (clid) {
    ...
    err = qdisc_graft(dev, p, skb, n, clid, core::ptr::null_mut(), q, extack);
    if (err != 0)
    return err;
    } else {
    qdisc_get_notify(net, skb, n, clid, q, core::ptr::null_mut());
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn req_create_or_replace(n: *mut nlmsghdr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn req_create_exclusive(n: *mut nlmsghdr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn req_change(n: *mut nlmsghdr) -> bool {
...
//
    ...
    goto create_n_graft;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: req_change(n)) -> else {
...
// Change qdisc parameters
    ...
    if (err == 0)
    qdisc_notify(sock_net(skb.sk), skb, n, clid, core::ptr::null_mut(), q, extack);
    return err;
    create_n_graft:
...
pub unsafe extern "C" fn if(_arg: p) -> else {
    ...
    return err;
    graft:
    err = qdisc_graft(dev, p, skb, n, clid, q, core::ptr::null_mut(), extack);
    if (err) {
    if (q)
    qdisc_put(q);
    return err;
...
#[no_mangle]
unsafe extern "C" fn request_qdisc_module(kind: *mut nlattr) {
...
//
    ...
    let mut ret: c_int = 0, q_idx = *q_idx_p;
    const struct tcmsg *tcm;
    struct Qdisc *q;
    int b;
    if (!root)
    ...
    RTM_NEWQDISC, core::ptr::null_mut());
    if (ret < 0)
    goto out;
    q_idx++;
    }
...
#[no_mangle]
unsafe extern "C" fn tc_dump_qdisc(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_node_bind(tp: *mut tcf_proto, n: *mut c_void, arg: *mut tcf_walker) -> c_int {
...
pub struct tc_bind_class_args {
    ...
    {
    const struct Qdisc_class_ops *cops = q.ops.cl_ops;
    let mut args: tc_bind_class_args = {};
    if (!cops.tcf_block)
    return;
    args.portid = portid;
    args.clid = clid;
...
// Step 1. Determine qdisc handle X:0
    ...
    qid = TC_H_MAJ(clid);
    if (portid != TC_H_ROOT) {
    let mut qid1: u32 = TC_H_MAJ(portid);
    if (qid && qid1) {
...
pub struct qdisc_dump_args {
    ...
    RTM_NEWTCLASS, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn tc_dump_tclass(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psched_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psched_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn psched_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn pktsched_init() -> int __init {
