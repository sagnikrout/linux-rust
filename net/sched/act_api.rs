...
#[no_mangle]
pub unsafe extern "C" fn tcf_dev_queue_xmit(skb: *mut sk_buff, skb): *mut *mut int (xmit)(struct sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_free_cookie_rcu(p: *mut rcu_head) {
    ...
    {
    let mut opcode: c_int = TC_ACT_EXT_OPCODE(action), ret = -EINVAL;
    u32 chain_index;
    if (!opcode)
    ret = action > TC_ACT_VALUE_MAX ? -EINVAL : 0;
#[no_mangle]
pub unsafe extern "C" fn if(TC_ACT_UNSPEC: opcode <= TC_ACT_EXT_OPCODE_MAX || action ==) -> else {
    ...
    "can't goto core::ptr::null_mut() proto/chain");
    goto end;
    }
...
#[no_mangle]
unsafe extern "C" fn free_tcf(p: *mut tc_action) {
    ...
    tcf_set_action_cookie(&p.user_cookie, core::ptr::null_mut());
    if (chain)
...
#[no_mangle]
unsafe extern "C" fn tcf_offload_act_num_actions_single(act: *mut tc_action) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tc_act_skip_hw(flags: u32) -> bool {
    static bool tc_act_skip_hw(u32 flags)
    {
    return (flags & TCA_ACT_FLAGS_SKIP_HW) ? true : false;
    }
#[no_mangle]
unsafe extern "C" fn tc_act_skip_sw(flags: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tc_act_flags_valid(flags: u32) -> bool {
    ...
    spin_lock_bh(&act.tcfa_lock);
    err = act.ops.offload_act_setup(act, fl_action, core::ptr::null_mut(),
    false, extack);
    spin_unlock_bh(&act.tcfa_lock);
    return err;
    }
    ...
    {
    int err;
    err = flow_indr_dev_setup_offload(core::ptr::null_mut(), core::ptr::null_mut(), TC_SETUP_ACT,
    fl_act, core::ptr::null_mut(), core::ptr::null_mut());
    if (err < 0)
    return err;
    if (hw_count)
// hw_count = err;
    ...
    {
    int err;
    err = cb(core::ptr::null_mut(), core::ptr::null_mut(), cb_priv, TC_SETUP_ACT, core::ptr::null_mut(), fl_act, core::ptr::null_mut());
    if (err < 0)
    return err;
    if (hw_count)
// hw_count = 1;
    ...
    void *cb_priv)
    {
    let mut skip_sw: bool = tc_act_skip_sw(action.tcfa_flags);
    struct tc_action *actions[TCA_ACT_MAX_PRIO] = {
    [0] = action,
    };
    struct flow_offload_action *fl_action;
    let mut in_hw_count: u32 = 0;
    int num, err = 0;
...
// offload the tc action after it is inserted
    ...
    struct netlink_ext_ack *extack)
    {
    return tcf_action_offload_add_ex(action, extack, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn tcf_action_update_hw_stats(action: *mut tc_action) -> c_int {
    int tcf_action_update_hw_stats(struct tc_action *action)
    {
    let mut fl_act: flow_offload_action = {};
    int err;
    err = offload_action_init(&fl_act, action, FLOW_ACT_STATS, core::ptr::null_mut());
    if (err)
    return err;
    err = tcf_action_offload_cmd(&fl_act, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (!err) {
    preempt_disable();
    ...
    return 0;
    err = offload_action_init(&fl_act, action, FLOW_ACT_DESTROY, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn tcf_action_offload_del(action: *mut tc_action) -> c_int {
    static int tcf_action_offload_del(struct tc_action *action)
    {
    return tcf_action_offload_del_ex(action, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tcf_action_cleanup(p: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn __tcf_action_put(p: *mut tc_action, bind: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __tcf_idr_release(p: *mut tc_action, bind: bool, strict: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcf_idr_release(a: *mut tc_action, bind: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_action_shared_attrs_size(act: *const tc_action) -> usize {
    static size_t tcf_action_shared_attrs_size(const struct tc_action *act)
    {
    struct tc_cookie *user_cookie;
    let mut cookie_len: u32 = 0;
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn tcf_action_full_attrs_size(sz: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn tcf_action_fill_size(act: *const tc_action) -> usize {
    static size_t tcf_action_fill_size(const struct tc_action *act)
    {
    let mut sz: usize = tcf_action_shared_attrs_size(act);
    ...
    {
    let mut err: c_int = 0, index = -1, s_i = 0, n_i = 0;
    let mut act_flags: u32 = cb.args[2];
    let mut jiffy_since: c_ulong = cb.args[3];
    struct nlattr *nest;
    struct idr *idr = &idrinfo.action_idr;
    struct tc_action *p;
    let mut id: c_ulong = 1;
    unsigned long tmp;
...
#[no_mangle]
unsafe extern "C" fn tcf_idr_release_unsafe(p: *mut tc_action) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcf_idr_search(tn: *mut tc_action_net, a: *mut tc_action, index: u32) -> c_int {
    ...
    p = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: p) -> else {
    else if (p)
...
#[no_mangle]
unsafe extern "C" fn tcf_idr_delete_index(idrinfo: *mut tcf_idrinfo, index: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcf_idr_cleanup(tn: *mut tc_action_net, index: u32) {
...
//
    ...
    {
    struct idr *idr = &idrinfo.action_idr;
    let mut mutex_taken: bool = false;
    struct tc_action *p;
    let mut id: c_ulong = 1;
    unsigned long tmp;
    int ret;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc_act_pernet_id {
    pub list: list_head,
    pub id: c_uint,
}

#[no_mangle]
unsafe extern "C" fn tcf_pernet_add_id_list(id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_pernet_del_id_list(id: c_uint) {
...
// lookup by name
    ...
    {
    struct tc_action_ops *a, *res = core::ptr::null_mut();
    if (kind) {
...
pub const TCA_ACT_MAX_PRIO_MASK: c_uint = 0x1FF;
    int tcf_action_exec(struct sk_buff *skb, struct tc_action **actions,
    int nr_actions, struct tcf_result *res)
    {
    let mut jmp_prgcnt: u32 = 0;
    u32 jmp_ttl = TCA_ACT_MAX_PRIO; /*matches actions per filter */
    int i;
    let mut ret: c_int = TC_ACT_OK;
...
#[no_mangle]
pub unsafe extern "C" fn tcf_action_destroy(actions[]: *mut tc_action, bind: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_action_put(p: *mut tc_action) -> c_int {
    static int tcf_action_put(struct tc_action *p)
    {
    return __tcf_action_put(p, false);
    }
#[no_mangle]
unsafe extern "C" fn tcf_action_put_many(actions[]: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn tca_put_bound_many(actions[]: *mut tc_action, init_res[]: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tcf_action_hw_stats_get(hw_stats_attr: *mut nlattr) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn tcf_idr_insert_many(actions[]: *mut tc_action, init_res[]: c_int) {
...
// Replace ERR_PTR(-EBUSY) allocated by tcf_idr_check_alloc
    ...
    struct netlink_ext_ack *extack)
    {
    let mut police: bool = flags & TCA_ACT_FLAGS_POLICE;
    ...
    if (a_o == core::ptr::null_mut()) {

    let mut rtnl_held: bool = !(flags & TCA_ACT_FLAGS_NO_RTNL);
    if (rtnl_held)
    rtnl_unlock();
...
//
    ...
    {
    let mut police: bool = flags & TCA_ACT_FLAGS_POLICE;
    let mut userflags: nla_bitfield32 = { 0, 0 };
    struct tc_cookie *user_cookie = core::ptr::null_mut();
    let mut hw_stats: u8 = TCA_ACT_HW_STATS_ANY;
    struct nlattr *tb[TCA_ACT_MAX + 1];
    struct tc_action *a;
    int err;
...
#[no_mangle]
unsafe extern "C" fn tc_act_bind(flags: u32) -> bool {
...
// Returns numbers of initialized actions or negative error.
    ...
    int err;
    int i;
    err = nla_parse_nested_deprecated(tb, TCA_ACT_MAX_PRIO + 1, nla, core::ptr::null_mut(),
    extack);
    if (err < 0)
    return err;
...
// Start from index 0
    ...
    let mut skip_sw: bool = tc_skip_sw(fl_flags);
    let mut skip_hw: bool = tc_skip_hw(fl_flags);
...
// attr_size = tcf_action_full_attrs_size(sz);
    ...
    int compat_mode)
    {
    let mut qstats: gnet_stats_queue = {0};
    struct gnet_dump d;
    let mut err: c_int = 0;
...
//
    ...
    goto err_out;
    err = -EINVAL;
    if (tb[TCA_ACT_INDEX] == core::ptr::null_mut() ||
...
#[no_mangle]
unsafe extern "C" fn tcf_action_delete(net: *mut net, actions[]: *mut tc_action) -> c_int {
...
//
    ...
    let mut act_index: u32 = a.tcfa_index;
    actions[i] = core::ptr::null_mut();
    if (tcf_action_put(a)) {
...
// now do the delete
    ...
    if (tca_get_fill(skb, actions, 0, 0, 0, RTM_DELACTION, 0, 1, core::ptr::null_mut()) <= 0) {
    kfree_skb(skb);
    return ERR_PTR(-EINVAL);
    }
    return skb;
...
#[no_mangle]
unsafe extern "C" fn tcf_reoffload_del_notify(net: *mut net, action: *mut tc_action) -> c_int {
...
//
    ...
    continue;
    if (add) {
    tcf_action_offload_add_ex(p, core::ptr::null_mut(), cb,
    cb_priv);
    continue;
    }
...
// now do the delete
    ...
    struct tc_action *actions[TCA_ACT_MAX_PRIO] = {};
    ret = nla_parse_nested_deprecated(tb, TCA_ACT_MAX_PRIO, nla, core::ptr::null_mut(),
    extack);
    if (ret < 0)
    return ret;
    ...
    ret = tcf_action_init(net, core::ptr::null_mut(), nla, core::ptr::null_mut(), actions, init_res,
...
// only put bound actions
    ...
    TCA_ROOT_MAX, core::ptr::null_mut(), extack);
    if (ret < 0)
    return ret;
    if (tca[TCA_ACT_TAB] == core::ptr::null_mut()) {
...
//
    ...
    struct nlattr *kind;
    tb1 = nla[TCA_ACT_TAB];
    if (tb1 == core::ptr::null_mut())
    return core::ptr::null_mut();
    if (nla_parse_deprecated(tb, TCA_ACT_MAX_PRIO, nla_data(tb1), NLMSG_ALIGN(nla_len(tb1)), core::ptr::null_mut(), core::ptr::null_mut()) < 0)
    return core::ptr::null_mut();
    if (tb[1] == core::ptr::null_mut())
    return core::ptr::null_mut();
    if (nla_parse_nested_deprecated(tb2, TCA_ACT_MAX, tb[1], tcf_action_policy, core::ptr::null_mut()) < 0)
    return core::ptr::null_mut();
    kind = tb2[TCA_ACT_KIND];
    return kind;
    }
#[no_mangle]
unsafe extern "C" fn tc_dump_action(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    ...
    struct nlattr *count_attr = core::ptr::null_mut();
    let mut jiffy_since: c_ulong = 0;
    struct nlattr *kind = core::ptr::null_mut();
    struct nla_bitfield32 bf;
    let mut msecs_since: u32 = 0;
    ...
    if (nest == core::ptr::null_mut())
    goto out_module_put;
    ret = __tcf_generic_walker(net, skb, cb, RTM_GETACTION, a_o, core::ptr::null_mut());
    if (ret < 0)
    goto out_module_put;
    if (ret > 0) {
    nla_nest_end(skb, nest);
...
#[no_mangle]
unsafe extern "C" fn tc_action_init() -> int __init {
