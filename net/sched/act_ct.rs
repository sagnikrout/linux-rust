...
pub struct tcf_ct_flow_table {
    pub /: *mut *mut rhash_head node; / In zones tables,
    pub rwork: rcu_work,
    ...
    {
    let mut i: c_int = flow_action.num_entries++;
...
//
    ...
    struct flow_action *action)
    {
    let mut target_src: __be16 = target.src.u.tcp.port;
    let mut target_dst: __be16 = target.dst.u.tcp.port;
    ...
    struct flow_action *action)
    {
    let mut target_src: __be16 = target.src.u.udp.port;
    let mut target_dst: __be16 = target.dst.u.udp.port;
...
// aligns with the CT reference on the SKB nf_ct_set
    ...
    let mut num_entries: c_int = action.num_entries;
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_is_outdated(flow: *const flow_offload) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_nf_get(ft: *mut nf_flowtable) {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_nf_put(ft: *mut nf_flowtable) {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_table_get(net: *mut net, params: *mut tcf_ct_params) -> c_int {
    static int tcf_ct_flow_table_get(struct net *net, struct tcf_ct_params *params)
    {
    let mut key: zones_ht_key = { .net = net, .zone = params.zone };
    struct tcf_ct_flow_table *ct_ft;
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_table_get_ref(ct_ft: *mut tcf_ct_flow_table) {
    static void tcf_ct_flow_table_get_ref(struct tcf_ct_flow_table *ct_ft)
    {
    refcount_inc(&ct_ft.ref);
    }
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_table_cleanup_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_table_put(ct_ft: *mut tcf_ct_flow_table) {
    static void tcf_ct_flow_table_put(struct tcf_ct_flow_table *ct_ft)
    {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_ct_ext_ifidx_update(entry: *mut flow_offload) {
    ...
    enum ip_conntrack_info ctinfo)
    {
    let mut tcp: bool = false, bidirectional = true;
    switch (nf_ct_protonum(ct)) {
    case IPPROTO_TCP:
    if ((ctinfo != IP_CT_ESTABLISHED &&
    ctinfo != IP_CT_ESTABLISHED_REPLY) ||
...
// tcph = (void *)(skb_network_header(skb) + thoff);
    ...
    enum ip_conntrack_info ctinfo;
    struct tcphdr *tcph = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(NF_FLOW_HW_ESTABLISHED, _arg: &flow->flags)) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_tables_init() -> c_int {
    static int tcf_ct_flow_tables_init(void)
    {
    return rhashtable_init(&zones_ht, &zones_params);
    }
#[no_mangle]
unsafe extern "C" fn tcf_ct_flow_tables_uninit() {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc_ct_action_net {
    pub /: *mut *mut tc_action_net tn; / Must be first,
}
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_skb_nf_family(skb: *mut sk_buff) -> u8 {
    static u8 tcf_ct_skb_nf_family(struct sk_buff *skb)
    {
    let mut family: u8 = NFPROTO_UNSPEC;
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_ipv4_is_fragment(skb: *mut sk_buff, frag: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_ipv6_is_fragment(skb: *mut sk_buff, frag: *mut bool) -> c_int {
    static int tcf_ct_ipv6_is_fragment(struct sk_buff *skb, bool *frag)
    {
    let mut flags: c_uint = 0, len, payload_ofs = 0;
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_params_free(params: *mut tcf_ct_params) {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_params_free_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_act_set_mark(ct: *mut nf_conn, mark: u32, mask: u32) {
    ...
    let mut labels_sz: usize = sizeof_field(struct tcf_ct_params, labels);
    ...
    struct nf_conn *tmpl = core::ptr::null_mut();
    struct nf_hook_state state;
    bool cached, commit, clear;
    int nh_ofs, err, retval;
    struct tcf_ct_params *p;
    let mut add_helper: bool = false;
    let mut skb_is_ours: bool = false;
    let mut skip_add: bool = false;
    let mut defrag: bool = false;
    struct nf_conn *ct;
    u8 family;
...
//
    ...
    let mut put_labels: bool = false;
    struct nf_conn *tmpl;
    char *name;
    p.zone = NF_CT_DEFAULT_ZONE_ID;
    tcf_ct_set_key_val(tb,
    &p.ct_action, TCA_CT_ACTION,
    core::ptr::null_mut(), TCA_CT_UNSPEC,
    sizeof(p.ct_action));
    ...
    if (tb[TCA_CT_LABELS]) {
    let mut n_bits: c_uint = sizeof_field(struct tcf_ct_params, labels) * 8;
    ...
    struct tcf_ct_params *params = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_cleanup(a: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_dump_nat(skb: *mut sk_buff, p: *const tcf_ct_params) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcf_ct_get_fill_size(act: *const tc_action) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ct_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn ct_exit_net(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ct_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ct_cleanup_module() -> void __exit {
