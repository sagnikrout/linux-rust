...
//! Source: net/sched/cls_matchall.c
#![no_std]
...
pub struct cls_mall_head {
    ...
    pub pf: *mut tc_matchall_pcnt __percpu,
    pub rwork: rcu_work,
    pub deleting: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mall_init(tp: *mut tcf_proto) -> c_int {
    static int mall_init(struct tcf_proto *tp)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn __mall_destroy(head: *mut cls_mall_head) {
...
#[no_mangle]
unsafe extern "C" fn mall_destroy_work(work: *mut work_struct) {
    ...
    {
    let mut cls_mall: tc_cls_matchall_offload = {};
    ...
    let mut cls_mall: tc_cls_matchall_offload = {};
    struct tcf_block *block = tp.chain.block;
    let mut skip_sw: bool = tc_skip_sw(head.flags);
    int err;
    ...
    tca[TCA_OPTIONS], mall_policy, core::ptr::null_mut());
    if (err < 0)
    return err;
...
// last = true;
    ...
    let mut cls_mall: tc_cls_matchall_offload = {};
    struct tcf_block *block = tp.chain.block;
    tc_cls_common_offload_init(&cls_mall.common, tp, head.flags, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cls_mall_init() -> int __init {
    static int __init cls_mall_init(void)
    {
    return register_tcf_proto_ops(&cls_mall_ops);
    }
#[no_mangle]
unsafe extern "C" fn cls_mall_exit() -> void __exit {
