...
#[no_mangle]
unsafe extern "C" fn cl_is_active(cl: *mut drr_class) -> bool {
    ...
    if (tca[TCA_RATE]) {
    err = gen_replace_estimator(&cl.bstats, core::ptr::null_mut(), &cl.rate_est,
...
#[no_mangle]
unsafe extern "C" fn drr_destroy_class(sch: *mut Qdisc, cl: *mut drr_class) {
...
#[no_mangle]
unsafe extern "C" fn drr_search_class(sch: *mut Qdisc, classid: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn drr_unbind_tcf(sch: *mut Qdisc, arg: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn drr_qlen_notify(csh: *mut Qdisc, arg: c_ulong) {
    ...
    {
    struct drr_class *cl = (struct drr_class *)arg;
    let mut qlen: __u32 = qdisc_qlen_sum(cl.qdisc);
...
#[no_mangle]
unsafe extern "C" fn drr_walk(sch: *mut Qdisc, arg: *mut qdisc_walker) {
...
#[no_mangle]
unsafe extern "C" fn drr_reset_qdisc(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn drr_destroy_qdisc(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn drr_init() -> int __init {
    static int __init drr_init(void)
    {
    return register_qdisc(&drr_qdisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn drr_exit() -> void __exit {
