...
pub const ACT_MPLS_TTL_DEFAULT: c_int = 255;
...
//
    ...
    new_lse = tcf_mpls_get_lse(core::ptr::null_mut(), p, !eth_p_mpls(skb_protocol(skb, true)));
    ...
    new_lse = tcf_mpls_get_lse(core::ptr::null_mut(), p, mac_len ||
...
#[no_mangle]
unsafe extern "C" fn tcf_mpls_cleanup(a: *mut tc_action) {
...
#[no_mangle]
unsafe extern "C" fn mpls_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn mpls_exit_net(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn mpls_init_module() -> int __init {
    static int __init mpls_init_module(void)
    {
    return tcf_register_action(&act_mpls_ops, &mpls_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn mpls_cleanup_module() -> void __exit {
