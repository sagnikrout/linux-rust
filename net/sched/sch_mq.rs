...
#[no_mangle]
unsafe extern "C" fn mq_offload(sch: *mut Qdisc, cmd: enum tc_mq_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mq_offload_stats(sch: *mut Qdisc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mq_destroy_common(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn mq_destroy(sch: *mut Qdisc) {
...
// pre-allocate qdiscs, attachment can't fail
    ...
    {
    int ret;
    ret = mq_init_common(sch, opt, extack, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn mq_attach(sch: *mut Qdisc) {
...
#[no_mangle]
pub unsafe extern "C" fn mq_dump_common(sch: *mut Qdisc, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn mq_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mq_find(sch: *mut Qdisc, classid: u32) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn mq_walk(sch: *mut Qdisc, arg: *mut qdisc_walker) {
