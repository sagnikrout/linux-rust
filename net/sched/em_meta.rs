...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meta_value {
    pub hdr: tcf_meta_val,
    pub val: c_ulong,
    pub len: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meta_match {
    pub lvalue: meta_value,
    pub rvalue: meta_value,
}

#[no_mangle]
pub unsafe extern "C" fn meta_id(v: *mut meta_value) -> c_int {
    static inline int meta_id(struct meta_value *v)
    {
    return TCF_META_ID(v.hdr.kind);
    }
#[no_mangle]
pub unsafe extern "C" fn meta_type(v: *mut meta_value) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fixed_loadavg(load: c_int) -> c_ulong {
    static inline unsigned long fixed_loadavg(int load)
    {
    let mut rnd_load: c_int = load + (FIXED_1/200);
    let mut rnd_frac: c_int = ((rnd_load & (FIXED_1-1)) * 100) >> FSHIFT;
...
//
#[no_mangle]
pub unsafe extern "C" fn int_dev(dev: *mut net_device, dst: *mut meta_obj) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn var_dev(dev: *mut net_device, dst: *mut meta_obj) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !__vlan_get_tag(skb, _arg: &tag)) -> else {
...
//
    ...
    {
    if (unlikely(skb_dst(skb) == core::ptr::null_mut()))
// err = -1;
    else
    ...
    {
    if (unlikely(skb_rtable(skb) == core::ptr::null_mut()))
// err = -1;
    else
...
//
    ...
    (unlikely(skb.sk == core::ptr::null_mut()))
...
// err = -1;
    ...
    dst.value = ( int) sk.sk_allocation;
    }
...
pub struct meta_ops {
    ...
    pub ): *mut *mut *mut meta_value , meta_obj , int,
}
...
//
#[no_mangle]
unsafe extern "C" fn meta_var_compare(a: *mut meta_obj, b: *mut meta_obj) -> c_int {
    static int meta_var_compare(struct meta_obj *a, struct meta_obj *b)
    {
    let mut r: c_int = a.len - b.len;
    if (r == 0)
    r = memcmp((void *) a.value, (void *) b.value, a.len);
    return r;
    }
#[no_mangle]
unsafe extern "C" fn meta_var_change(dst: *mut meta_value, nla: *mut nlattr) -> c_int {
    static int meta_var_change(struct meta_value *dst, struct nlattr *nla)
    {
    let mut len: c_int = nla_len(nla);
...
#[no_mangle]
unsafe extern "C" fn meta_var_destroy(v: *mut meta_value) {
    ...
    struct meta_obj *dst)
    {
    let mut shift: c_int = v.hdr.shift;
    if (shift && shift < dst.len)
    dst.len -= shift;
    }
#[no_mangle]
unsafe extern "C" fn meta_var_dump(skb: *mut sk_buff, v: *mut meta_value, tlv: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn meta_int_compare(a: *mut meta_obj, b: *mut meta_obj) -> c_int {
...
// more logical.
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(b->value: a->value <) -> else {
...
#[no_mangle]
unsafe extern "C" fn meta_int_change(dst: *mut meta_value, nla: *mut nlattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meta_int_dump(skb: *mut sk_buff, v: *mut meta_value, tlv: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meta_type_ops {
    pub ): *mut *mut void (destroy)(struct meta_value,
    pub ): *mut *mut *mut int (compare)(struct meta_obj , struct meta_obj,
    pub ): *mut *mut *mut int (change)(struct meta_value , struct nlattr,
    pub ): *mut *mut *mut void (apply_extras)(struct meta_value , struct meta_obj,
    pub int): *mut *mut *mut *mut int (dump)(struct sk_buff , struct meta_value ,,
}
...
#[no_mangle]
unsafe extern "C" fn meta_delete(meta: *mut meta_match) {
...
#[no_mangle]
pub unsafe extern "C" fn meta_change_data(dst: *mut meta_value, nla: *mut nlattr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn meta_is_supported(val: *mut meta_value) -> c_int {
    ...
    struct meta_match *meta = core::ptr::null_mut();
    err = nla_parse_deprecated(tb, TCA_EM_META_MAX, data, len,
    meta_policy, core::ptr::null_mut());
    if (err < 0)
    goto errout;
    err = -EINVAL;
    if (tb[TCA_EM_META_HDR] == core::ptr::null_mut())
    goto errout;
...
#[no_mangle]
unsafe extern "C" fn em_meta_destroy(m: *mut tcf_ematch) {
...
#[no_mangle]
unsafe extern "C" fn em_meta_dump(skb: *mut sk_buff, em: *mut tcf_ematch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_em_meta() -> int __init {
    static int __init init_em_meta(void)
    {
    return tcf_em_register(&em_meta_ops);
    }
#[no_mangle]
unsafe extern "C" fn exit_em_meta() -> void __exit {
