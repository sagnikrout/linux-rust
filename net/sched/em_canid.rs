...
pub const EM_CAN_RULES_MAX: c_int = 500;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct canid_match {
// For each SFF CAN ID (11 bit) there is one record in this bitfield
    pub CAN_SFF_ID_BITS)): DECLARE_BITMAP(match_sff, (1 <<,
    pub rules_count: c_int,
    pub sff_rules_count: c_int,
    pub eff_rules_count: c_int,
//
...
//
#[no_mangle]
unsafe extern "C" fn em_canid_get_id(skb: *mut sk_buff) -> canid_t {
...
#[no_mangle]
unsafe extern "C" fn em_canid_destroy(m: *mut tcf_ematch) {
...
#[no_mangle]
unsafe extern "C" fn em_canid_dump(skb: *mut sk_buff, m: *mut tcf_ematch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_em_canid() -> int __init {
    static int __init init_em_canid(void)
    {
    return tcf_em_register(&em_canid_ops);
    }
#[no_mangle]
unsafe extern "C" fn exit_em_canid() -> void __exit {
