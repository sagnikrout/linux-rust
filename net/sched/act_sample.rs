...
//
    ...
    sample_policy, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn tcf_sample_cleanup(a: *mut tc_action) {
...
// last reference to action, no need to lock
    ...
    RCU_INIT_POINTER(s.psample_group, core::ptr::null_mut());
    if (psample_group)
    psample_group_put(psample_group);
    }
#[no_mangle]
unsafe extern "C" fn tcf_sample_dev_ok_push(dev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcf_psample_group_put(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tcf_sample_get_fill_size(act: *const tc_action) -> usize {
...
#[no_mangle]
unsafe extern "C" fn sample_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn sample_exit_net(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn sample_init_module() -> int __init {
    static int __init sample_init_module(void)
    {
    return tcf_register_action(&act_sample_ops, &sample_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn sample_cleanup_module() -> void __exit {
