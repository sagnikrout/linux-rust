...
#[no_mangle]
pub unsafe extern "C" fn P(MTU: peak rate) and depth M (equal to link) -> one with rate {
...
// Parameters
    pub /: *mut *mut u32 limit; / Maximal length of backlog: bytes,
    pub max_size: u32,
    pub /: *mut *mut s64 buffer; / Token bucket depth/rate: MUST BE >= MTU/B,
    pub mtu: i64,
    pub rate: psched_ratecfg,
    pub peak: psched_ratecfg,
// Variables
    pub /: *mut *mut s64 tokens; / Current number of B tokens,
    pub /: *mut *mut s64 ptokens; / Current number of P tokens,
    pub /: *mut *mut s64 t_c; / Time check-point,
    pub /: *mut *mut *mut Qdisc qdisc; / Inner qdisc, default - bfifo queue,
...
//
    let mut len: u64 = time_in_ns * r.rate_bytes_ps;
...
#[no_mangle]
unsafe extern "C" fn tbf_offload_destroy(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn tbf_offload_dump(sch: *mut Qdisc) -> c_int {
...
//
    ...
    let mut len: c_uint = 0, prev_len = qdisc_pkt_len(skb), seg_len;
    int ret, nb;
...
#[no_mangle]
unsafe extern "C" fn tbf_peak_present(q: *const tbf_sched_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tbf_reset(sch: *mut Qdisc) {
    ...
    struct Qdisc *child = core::ptr::null_mut();
    struct Qdisc *old = core::ptr::null_mut();
    struct psched_ratecfg rate;
    struct psched_ratecfg peak;
    u64 max_size;
    s64 buffer, mtu;
    let mut rate64: u64 = 0, prate64 = 0;
    err = nla_parse_nested_deprecated(tb, TCA_TBF_MAX, opt, tbf_policy,
    core::ptr::null_mut());
    if (err < 0)
    return err;
    err = -EINVAL;
    if (tb[TCA_TBF_PARMS] == core::ptr::null_mut())
    goto done;
    ...
    let mut pburst: u32 = nla_get_u32(tb[TCA_TBF_PBURST]);
...
#[no_mangle]
unsafe extern "C" fn tbf_destroy(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn tbf_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbf_find(sch: *mut Qdisc, classid: u32) -> c_ulong {
    static unsigned long tbf_find(struct Qdisc *sch, u32 classid)
    {
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn tbf_walk(sch: *mut Qdisc, walker: *mut qdisc_walker) {
...
#[no_mangle]
unsafe extern "C" fn tbf_module_init() -> int __init {
    static int __init tbf_module_init(void)
    {
    return register_qdisc(&tbf_qdisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn tbf_module_exit() -> void __exit {
