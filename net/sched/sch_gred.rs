...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gred_sched_data {
    pub /: *mut *mut u32 limit; / HARD maximal queue length,
    pub /: *mut *mut u32 DP; / the drop parameters,
    pub /: *mut *mut u32 red_flags; / virtualQ version of red_flags,
    pub far*/: *mut *mut u64 bytesin; / bytes seen on virtualQ so,
    pub far*/: *mut *mut u32 packetsin; / packets seen on virtualQ so,
    pub /: *mut *mut u32 backlog; / bytes on the virtualQ,
    pub /: *mut *mut u8 prio; / the prio of this vq,
    pub parms: red_parms,
    pub vars: red_vars,
    pub stats: red_stats,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gred_sched {
    pub tab: [*mut gred_sched_data; MAX_DPs],
    pub flags: c_ulong,
    pub red_flags: u32,
    pub DPs: u32,
    pub def: u32,
    pub wred_set: red_vars,
    pub opt: *mut tc_gred_qopt_offload,
}

#[no_mangle]
pub unsafe extern "C" fn gred_wred_mode(table: *mut gred_sched) -> c_int {
    static inline int gred_wred_mode(struct gred_sched *table)
    {
    return test_bit(GRED_WRED_MODE, &table.flags);
    }
#[no_mangle]
pub unsafe extern "C" fn gred_enable_wred_mode(table: *mut gred_sched) {
    static inline void gred_enable_wred_mode(struct gred_sched *table)
    {
    __set_bit(GRED_WRED_MODE, &table.flags);
    }
#[no_mangle]
pub unsafe extern "C" fn gred_disable_wred_mode(table: *mut gred_sched) {
    static inline void gred_disable_wred_mode(struct gred_sched *table)
    {
    __clear_bit(GRED_WRED_MODE, &table.flags);
    }
#[no_mangle]
pub unsafe extern "C" fn gred_rio_mode(table: *mut gred_sched) -> c_int {
    static inline int gred_rio_mode(struct gred_sched *table)
    {
    return test_bit(GRED_RIO_MODE, &table.flags);
    }
#[no_mangle]
pub unsafe extern "C" fn gred_enable_rio_mode(table: *mut gred_sched) {
    static inline void gred_enable_rio_mode(struct gred_sched *table)
    {
    __set_bit(GRED_RIO_MODE, &table.flags);
    }
#[no_mangle]
pub unsafe extern "C" fn gred_disable_rio_mode(table: *mut gred_sched) {
    static inline void gred_disable_rio_mode(struct gred_sched *table)
    {
    __clear_bit(GRED_RIO_MODE, &table.flags);
    }
#[no_mangle]
pub unsafe extern "C" fn gred_wred_mode_check(sch: *mut Qdisc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tc_index_to_dp(skb: *mut sk_buff) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn gred_use_ecn(q: *mut gred_sched_data) -> c_int {
    static int gred_use_ecn(struct gred_sched_data *q)
    {
    return q.red_flags & TC_RED_ECN;
    }
#[no_mangle]
unsafe extern "C" fn gred_use_harddrop(q: *mut gred_sched_data) -> c_int {
    static int gred_use_harddrop(struct gred_sched_data *q)
    {
    return q.red_flags & TC_RED_HARDDROP;
    }
#[no_mangle]
unsafe extern "C" fn gred_per_vq_red_flags_used(table: *mut gred_sched) -> bool {
...
// Local per-vq flags couldn't have been set unless global are 0
    ...
    {
    struct gred_sched_data *q = core::ptr::null_mut();
    struct gred_sched *t = qdisc_priv(sch);
    let mut qavg: c_ulong = 0;
    let mut dp: u16 = tc_index_to_dp(skb);
    if (dp >= t.DPs || (q = t.tab[dp]) == core::ptr::null_mut()) {
    dp = t.def;
    q = t.tab[dp];
    if (!q) {
...
#[no_mangle]
unsafe extern "C" fn gred_reset(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn gred_offload(sch: *mut Qdisc, command: enum tc_gred_command) {
...
#[no_mangle]
unsafe extern "C" fn gred_offload_dump_stats(sch: *mut Qdisc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gred_destroy_vq(q: *mut gred_sched_data) {
...
#[no_mangle]
unsafe extern "C" fn gred_vq_apply(table: *mut gred_sched, entry: *const nlattr) {
...
unsafe extern "C" fn gred_vqs_apply(table: *mut gred_sched, vqs: *mut nlattr) {
    ...
    if (tb[TCA_GRED_VQ_FLAGS]) {
    let mut red_flags: u32 = nla_get_u32(tb[TCA_GRED_VQ_FLAGS]);
    ...
    if (err < 0)
    return err;
    if (tb[TCA_GRED_PARMS] == core::ptr::null_mut() && tb[TCA_GRED_STAB] == core::ptr::null_mut()) {
    if (tb[TCA_GRED_LIMIT] != core::ptr::null_mut())
    sch.limit = nla_get_u32(tb[TCA_GRED_LIMIT]);
    return gred_change_table_def(sch, tb[TCA_GRED_DPS], extack);
    }
    if (tb[TCA_GRED_PARMS] == core::ptr::null_mut() ||
    tb[TCA_GRED_STAB] == core::ptr::null_mut() ||
    tb[TCA_GRED_LIMIT] != core::ptr::null_mut()) {
    ...
    if (ctl.prio == 0) {
    let mut def_prio: c_int = GRED_DEF_PRIO;
...
#[no_mangle]
unsafe extern "C" fn gred_dump(sch: *mut Qdisc, skb: *mut sk_buff) -> c_int {
    static int gred_dump(struct Qdisc *sch, struct sk_buff *skb)
    {
    struct gred_sched *table = qdisc_priv(sch);
    struct nlattr *parms, *vqs, *opts = core::ptr::null_mut();
    int i;
    u32 max_p[MAX_DPs];
    struct tc_gred_sopt sopt = {
    .DPs	= table.DPs,
...
#[no_mangle]
unsafe extern "C" fn gred_destroy(sch: *mut Qdisc) {
...
#[no_mangle]
unsafe extern "C" fn gred_module_init() -> int __init {
    static int __init gred_module_init(void)
    {
    return register_qdisc(&gred_qdisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn gred_module_exit() -> void __exit {
