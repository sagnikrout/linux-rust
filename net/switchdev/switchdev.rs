...
//! Source: net/switchdev/switchdev.c
#![no_std]
...
pub struct switchdev_deferred_item {
    ...
    pub func: *mut switchdev_deferred_func_t,
    pub data: [c_ulong; ],
}
...
#[no_mangle]
unsafe extern "C" fn switchdev_deferred_process_work(work: *mut work_struct) {
    ...
    int err;
    err = switchdev_port_attr_set_now(dev, attr, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn switchdev_obj_size(obj: *const switchdev_obj) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn register_switchdev_notifier(nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_switchdev_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn register_switchdev_blocking_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_switchdev_blocking_notifier(nb: *mut notifier_block) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct switchdev_nested_priv {
    pub dev): *const *const bool (check_cb)(struct net_device,
    bool (*foreign_dev_check_cb)(const struct net_device *dev,
    pub foreign_dev): *const net_device,
