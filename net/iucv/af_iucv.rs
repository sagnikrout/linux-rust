...
#[no_mangle]
pub unsafe extern "C" fn high_nmcpy(dst: *mut c_uchar, src: *mut c_char) {
    static inline void high_nmcpy(unsigned char *dst, char *src)
    {
    memcpy(dst, src, 8);
    }
#[no_mangle]
pub unsafe extern "C" fn low_nmcpy(dst: *mut c_uchar, src: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iucv_msg_length(msg: *mut iucv_message) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn iucv_sock_in_state(sk: *mut sock, state: c_int, state2: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iucv_below_msglim(sk: *mut sock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iucv_sock_wake_msglim(sk: *mut sock) {
...
//
    ...
    dev_hard_header(skb, skb.dev, ETH_P_AF_IUCV, core::ptr::null_mut(), core::ptr::null_mut(), skb.len);
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_destruct(sk: *mut sock) {
...
// Cleanup Listen
#[no_mangle]
unsafe extern "C" fn iucv_sock_cleanup_listen(parent: *mut sock) {
    static void iucv_sock_cleanup_listen(struct sock *parent)
    {
    struct sock *sk;
// Close non-accepted connections
    while ((sk = iucv_accept_dequeue(parent, core::ptr::null_mut()))) {
    iucv_sock_close(sk);
    iucv_sock_kill(sk);
    }
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_link(l: *mut iucv_sock_list, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_unlink(l: *mut iucv_sock_list, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_kill(sk: *mut sock) {
    static void iucv_sock_kill(struct sock *sk)
    {
...
#[no_mangle]
unsafe extern "C" fn iucv_sever_path(sk: *mut sock, with_user_data: c_int) {
...
// Whoever resets the path pointer, must sever and free it.
    if (xchg(&iucv.path, core::ptr::null_mut())) {
    if (with_user_data) {
    ...
    pr_iucv.path_sever(path, core::ptr::null_mut());
    iucv_path_free(path);
//
...
#[no_mangle]
unsafe extern "C" fn iucv_send_ctrl(sk: *mut sock, flags: u8) -> c_int {
...
// controlling flags should be sent anyway
    ...
    err = afiucv_hs_send(core::ptr::null_mut(), sk, skb, flags);
    }
    if (shutdown)
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_close(sk: *mut sock) {
    static void iucv_sock_close(struct sock *sk)
    {
    struct iucv_sock *iucv = iucv_sk(sk);
    unsigned long timeo;
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_init(sk: *mut sock, parent: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iucv_accept_enqueue(parent: *mut sock, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn iucv_accept_unlink(sk: *mut sock) {
    ...
    iucv_sk(sk).parent = core::ptr::null_mut();
    sock_put(sk);
    }
    static struct sock *iucv_accept_dequeue(struct sock *parent,
    struct socket *newsock)
...
#[no_mangle]
unsafe extern "C" fn __iucv_auto_name(iucv: *mut iucv_sock) {
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_autobind(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afiucv_path_connect(sock: *mut socket, addr: *mut sockaddr_unsized) -> c_int {
...
// Create path.
    ...
    sa.siucv_user_id, core::ptr::null_mut(), user_data,
    sk);
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
//
    ...
    struct sock *sk = sock.sk;
    struct iucv_sock *iucv = iucv_sk(sk);
    let mut headroom: usize = 0;
    size_t linear;
    struct sk_buff *skb;
    let mut txmsg: iucv_message = {0};
    struct cmsghdr *cmsg;
    int cmsg_done;
    long timeo;
    char user_id[9];
    char appl_id[9];
    int err;
    let mut noblock: c_int = msg.msg_flags & MSG_DONTWAIT;
    err = sock_error(sk);
    if (err)
    return err;
...
// IUCV_IPRMDATA path flag is set... sever path
    if (err == 0x15) {
    pr_iucv.path_sever(iucv.path, core::ptr::null_mut());
    atomic_dec(&iucv.skbs_in_xmit);
    skb_unlink(skb, &iucv.send_skb_q);
    err = -EPIPE;
    goto fail;
...
// check for special IPRM messages (e.g. iucv_sock_shutdown)
    ...
    IUCV_IPBUFLST,
    (void *)iba, len, core::ptr::null_mut());
    } else {
    rc = pr_iucv.message_receive(path, msg,
    msg.flags & IUCV_IPRMDATA,
    skb.data, len, core::ptr::null_mut());
    }
    if (rc) {
    kfree_skb(skb);
    return;
...
//
#[no_mangle]
unsafe extern "C" fn iucv_process_message_q(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn iucv_accept_poll(parent: *mut sock) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_shutdown(sock: *mut socket, how: c_int) -> c_int {
    ...
    if ((iucv.transport == AF_IUCV_TRANS_IUCV) &&
    iucv.path) {
    err = pr_iucv.path_quiesce(iucv.path, core::ptr::null_mut());
    if (err)
    err = -ENOTCONN;
// skb_queue_purge(&sk->sk_receive_queue);
    }
...
#[no_mangle]
unsafe extern "C" fn iucv_sock_release(sock: *mut socket) -> c_int {
...
// getsockopt and setsockopt
    ...
    break;
    case SO_MSGLIMIT:
    val = (iucv.path != core::ptr::null_mut()) ? iucv.path.msglim	/* connected */
...
// Create the new socket
    nsk = iucv_sock_alloc(core::ptr::null_mut(), sk.sk_protocol, GFP_ATOMIC, 0);
    if (!nsk) {
    err = pr_iucv.path_sever(path, user_data);
    iucv_path_free(path);
    goto fail;
...
#[no_mangle]
unsafe extern "C" fn iucv_callback_connack(path: *mut iucv_path, ipuser[16]: u8) {
...
#[no_mangle]
unsafe extern "C" fn iucv_callback_rx(path: *mut iucv_path, msg: *mut iucv_message) {
    ...
    {
    struct sock *sk = path.private;
    struct sk_buff *this = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iucv_callback_connrej(path: *mut iucv_path, ipuser[16]: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn iucv_callback_shutdown(path: *mut iucv_path, ipuser[16]: u8) {
...
#[no_mangle]
unsafe extern "C" fn afiucv_swap_src_dest(skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn afiucv_hs_callback_syn(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afiucv_hs_callback_synack(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afiucv_hs_callback_synfin(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afiucv_hs_callback_fin(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afiucv_hs_callback_win(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn afiucv_hs_callback_rx(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
    ...
    let mut err: c_int = NET_RX_SUCCESS;
    char nullstring[8];
...
//
#[no_mangle]
unsafe extern "C" fn afiucv_hs_callback_txnotify(sk: *mut sock, n: enum iucv_tx_notify) {
...
// currently, proto ops can handle both sk types
    ...
    if (!sk)
    return -ENOMEM;
    iucv_sock_init(sk, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn afiucv_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn afiucv_exit() -> void __exit {
