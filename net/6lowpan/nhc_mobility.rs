...
//! Source: net/6lowpan/nhc_mobility.c
#![no_std]
...
pub const LOWPAN_NHC_MOBILITY_ID_0: c_uint = 0xe8;
pub const LOWPAN_NHC_MOBILITY_MASK_0: c_uint = 0xfe;
    LOWPAN_NHC(nhc_mobility, "RFC6282 Mobility", NEXTHDR_MOBILITY, 0,
    LOWPAN_NHC_MOBILITY_ID_0, LOWPAN_NHC_MOBILITY_MASK_0, core::ptr::null_mut(), core::ptr::null_mut());
