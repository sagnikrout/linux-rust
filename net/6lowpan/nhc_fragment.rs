...
//! Source: net/6lowpan/nhc_fragment.c
#![no_std]
...
pub const LOWPAN_NHC_FRAGMENT_ID_0: c_uint = 0xe4;
pub const LOWPAN_NHC_FRAGMENT_MASK_0: c_uint = 0xfe;
    LOWPAN_NHC(nhc_fragment, "RFC6282 Fragment", NEXTHDR_FRAGMENT, 0,
    LOWPAN_NHC_FRAGMENT_ID_0, LOWPAN_NHC_FRAGMENT_MASK_0, core::ptr::null_mut(), core::ptr::null_mut());
