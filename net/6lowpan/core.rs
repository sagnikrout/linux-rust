...
#[no_mangle]
pub unsafe extern "C" fn lowpan_unregister_netdevice(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_unregister_netdev(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_ifid_802154_6lowpan(eui: *mut u8, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lowpan_module_exit() -> void __exit {
