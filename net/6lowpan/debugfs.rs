...
pub const LOWPAN_DEBUGFS_CTX_PFX_NUM_ARGS: c_int = 8;
    static struct dentry *lowpan_debugfs;
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_flag_active_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_flag_active_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_flag_c_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_flag_c_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_plen_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_plen_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_pfx_show(file: *mut seq_file, offset: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_ctx_pfx_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    struct lowpan_iphc_ctx_table *t =
    container_of(ctx, struct lowpan_iphc_ctx_table, table[ctx.id]);
    let mut status: c_int = count, n, i;
    unsigned int addr[8];
...
#[no_mangle]
unsafe extern "C" fn lowpan_context_show(file: *mut seq_file, offset: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lowpan_short_addr_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = le16_to_cpu(wdev->short_addr);
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(lowpan_short_addr_fops, lowpan_short_addr_get, core::ptr::null_mut(),
    "0x%04llx\n");
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_dev_debugfs_init(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_dev_debugfs_exit(dev: *mut net_device) {
    void lowpan_dev_debugfs_exit(struct net_device *dev)
    {
    debugfs_remove_recursive(lowpan_dev(dev).iface_debugfs);
    }
#[no_mangle]
pub unsafe extern "C" fn lowpan_debugfs_init() -> void __init {
    void __init lowpan_debugfs_init(void)
    {
    lowpan_debugfs = debugfs_create_dir("6lowpan", core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn lowpan_debugfs_exit() {
