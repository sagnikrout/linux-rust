...
//! Source: net/6lowpan/nhc_ghc_ext_frag.c
#![no_std]
...
pub const LOWPAN_GHC_EXT_FRAG_ID_0: c_uint = 0xb4;
pub const LOWPAN_GHC_EXT_FRAG_MASK_0: c_uint = 0xfe;
    LOWPAN_NHC(ghc_ext_frag, "RFC7400 Fragmentation Extension Header",
    NEXTHDR_FRAGMENT, 0, LOWPAN_GHC_EXT_FRAG_ID_0,
    LOWPAN_GHC_EXT_FRAG_MASK_0, core::ptr::null_mut(), core::ptr::null_mut());
