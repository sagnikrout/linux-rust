...
//! Source: net/6lowpan/nhc_routing.c
#![no_std]
...
pub const LOWPAN_NHC_ROUTING_ID_0: c_uint = 0xe2;
pub const LOWPAN_NHC_ROUTING_MASK_0: c_uint = 0xfe;
    LOWPAN_NHC(nhc_routing, "RFC6282 Routing", NEXTHDR_ROUTING, 0,
    LOWPAN_NHC_ROUTING_ID_0, LOWPAN_NHC_ROUTING_MASK_0, core::ptr::null_mut(), core::ptr::null_mut());
