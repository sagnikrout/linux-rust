...
#[no_mangle]
unsafe extern "C" fn gen_cookie_auth_key(key: *mut hmac_sha256_key) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_endpoint_free(ep: *mut sctp_endpoint) {
...
#[no_mangle]
unsafe extern "C" fn sctp_endpoint_destroy_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn sctp_endpoint_destroy(ep: *mut sctp_endpoint) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_endpoint_hold(ep: *mut sctp_endpoint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_endpoint_put(ep: *mut sctp_endpoint) {
...
// Is this the endpoint we are looking for?
    ...
    int dif, int sdif)
    {
    let mut bound_dev_if: c_int = READ_ONCE(ep.base.sk.sk_bound_dev_if);
    struct sctp_endpoint *retval = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn sctp_endpoint_bh_rcv(work: *mut work_struct) {
    static void sctp_endpoint_bh_rcv(struct work_struct *work)
    {
    struct sctp_endpoint *ep =
...
// COOKIE-ECHO chunk.
//
    if (core::ptr::null_mut() == chunk.asoc) {
