...
#[no_mangle]
pub unsafe extern "C" fn sctp_rcv_checksum(net: *mut net, skb: *mut sk_buff) -> c_int {
    static inline int sctp_rcv_checksum(struct net *net, struct sk_buff *skb)
    {
    struct sctphdr *sh = sctp_hdr(skb);
    let mut cmp: __le32 = sh.checksum;
    let mut val: __le32 = sctp_compute_cksum(skb, 0);
    if (val != cmp) {
// CRC failure, dump it.
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_rcv(skb: *mut sk_buff) -> c_int {
    int sctp_rcv(struct sk_buff *skb)
    {
    struct sock *sk;
    struct sctp_association *asoc;
    struct sctp_endpoint *ep = core::ptr::null_mut();
    ...
    let mut is_gso: bool = skb_is_gso(skb) && skb_is_gso_sctp(skb);
    int dif, sdif;
...
// address."
//
    if (!af.addr_valid(&src, core::ptr::null_mut(), skb) ||
    !af.addr_valid(&dest, core::ptr::null_mut(), skb))
    goto discard_it;
...
//
    ...
    skb = core::ptr::null_mut(); /* sctp_chunk_free already freed the skb */
    goto discard_release;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_backlog_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int sctp_backlog_rcv(struct sock *sk, struct sk_buff *skb)
    {
    struct sctp_chunk *chunk = SCTP_INPUT_CB(skb).chunk;
    struct sctp_inq *inqueue = &chunk.rcvr.inqueue;
    struct sctp_transport *t = chunk.transport;
    struct sctp_ep_common *rcvr = core::ptr::null_mut();
    let mut backloged: c_int = 0;
    rcvr = chunk.rcvr;
...
#[no_mangle]
pub unsafe extern "C" fn if(rcvr->type: SCTP_EP_TYPE_SOCKET ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sctp_add_backlog(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int sctp_add_backlog(struct sock *sk, struct sk_buff *skb)
    {
    struct sctp_chunk *chunk = SCTP_INPUT_CB(skb).chunk;
    struct sctp_transport *t = chunk.transport;
...
// Common lookup code for icmp/icmpv6 error handler.
    ...
    struct sctp_association *asoc;
    struct sctp_transport *transport = core::ptr::null_mut();
    let mut vtag: __u32 = ntohl(sctphdr.vtag);
...
#[no_mangle]
pub unsafe extern "C" fn sctp_err_finish(sk: *mut sock, t: *mut sctp_transport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_v4_err(skb: *mut sk_buff, info: __u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_udp_v4_err(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_rcv_ootb(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sctp_hash_endpoint(ep: *mut sctp_endpoint) -> c_int {
    ...
    if (sk.sk_reuseport) {
    let mut any: bool = sctp_is_ep_boundall(sk);
...
#[no_mangle]
pub unsafe extern "C" fn sctp_hash_endpoint(ep: *mut sctp_endpoint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sctp_unhash_endpoint(ep: *mut sctp_endpoint) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_unhash_endpoint(ep: *mut sctp_endpoint) {
    ...
    addr = ( __u32)paddr.v4.sin_addr.s_addr;
    return  jhash_3words(addr, (( __u32)paddr.v4.sin_port) << 16 |
    ( __u32)lport, net_hash_mix(net), seed);
    }
// Look up an endpoint.
    static struct sctp_endpoint *__sctp_rcv_lookup_endpoint(
    struct net *net, struct sk_buff *skb,
    ...
    sk = ep.base.sk;
    if (sk.sk_reuseport) {
    let mut phash: __u32 = sctp_hashfn(net, lport, paddr, 0);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sctp_hash_cmp_arg {
    pub paddr: *const union sctp_addr,
    pub net: *const net,
    pub lport: __be16,
}
...
#[no_mangle]
pub unsafe extern "C" fn sctp_hash_obj(data: *const c_void, len: u32, seed: u32) -> __u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_hash_key(data: *const c_void, len: u32, seed: u32) -> __u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_hashtable_init() -> c_int {
    int sctp_transport_hashtable_init(void)
    {
    return rhltable_init(&sctp_transport_hashtable, &sctp_hash_params);
    }
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_hashtable_destroy() {
    void sctp_transport_hashtable_destroy(void)
    {
    rhltable_destroy(&sctp_transport_hashtable);
    }
#[no_mangle]
pub unsafe extern "C" fn sctp_hash_transport(t: *mut sctp_transport) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_unhash_transport(t: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_sk_bound_dev_eq(net: *mut net, bound_dev_if: c_int, dif: c_int, sdif: c_int) -> bool {
    bool sctp_sk_bound_dev_eq(struct net *net, int bound_dev_if, int dif, int sdif)
    {
    let mut l3mdev_accept: bool = true;
...
//
    ...
    struct sctp_association *asoc = core::ptr::null_mut();
    struct sctp_chunkhdr *ch;
    let mut have_auth: c_int = 0;
    let mut chunk_num: c_uint = 1;
    __u8 *ch_end;
