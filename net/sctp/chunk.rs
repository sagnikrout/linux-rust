...
#[no_mangle]
unsafe extern "C" fn sctp_datamsg_init(msg: *mut sctp_datamsg) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_datamsg_free(msg: *mut sctp_datamsg) {
...
#[no_mangle]
unsafe extern "C" fn sctp_datamsg_destroy(msg: *mut sctp_datamsg) {
...
// Hold a reference.
#[no_mangle]
unsafe extern "C" fn sctp_datamsg_hold(msg: *mut sctp_datamsg) {
...
// Release a reference.
#[no_mangle]
pub unsafe extern "C" fn sctp_datamsg_put(msg: *mut sctp_datamsg) {
...
#[no_mangle]
unsafe extern "C" fn sctp_datamsg_assign(msg: *mut sctp_datamsg, chunk: *mut sctp_chunk) {
...
//
    ...
    let mut msg_len: usize = iov_iter_count(from);
    struct sctp_shared_key *shkey = core::ptr::null_mut();
    struct list_head *pos, *temp;
    struct sctp_chunk *chunk;
    struct sctp_datamsg *msg;
    int err;
...
// Create chunks for all DATA chunks.
    ...
    let mut frag: u8 = SCTP_DATA_MIDDLE_FRAG;
...
#[no_mangle]
pub unsafe extern "C" fn sctp_chunk_abandoned(chunk: *mut sctp_chunk) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_chunk_fail(chunk: *mut sctp_chunk, error: c_int) {
