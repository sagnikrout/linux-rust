...
#[no_mangle]
unsafe extern "C" fn sctp_hmac_supported(hmac_id: __u16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_key_put(key: *mut sctp_auth_bytes) {
...
#[no_mangle]
unsafe extern "C" fn sctp_auth_shkey_destroy(sh_key: *mut sctp_shared_key) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_shkey_release(sh_key: *mut sctp_shared_key) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_shkey_hold(sh_key: *mut sctp_shared_key) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_destroy_keys(keys: *mut list_head) {
...
//
    ...
    struct sctp_auth_bytes	*first_vector,
// last_vector;
    struct sctp_auth_bytes	*secret = core::ptr::null_mut();
    int	cmp;
...
#[no_mangle]
unsafe extern "C" fn sctp_auth_chunk_id_forbidden(chunk_id: __u8) -> bool {
...
//
    ...
    sizeof(hmacs.hmac_ids[0]);
    for (i = 0; i < n_hmacs; i++) {
    let mut hmac_id: u16 = ntohs(hmacs.hmac_ids[i]);
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_asoc_init_active_key(asoc: *mut sctp_association, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sctp_auth_find_hmacid(hmacs: *mut __be16, n_elts: c_int, hmac_id: __be16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sctp_auth_cid(chunk: enum sctp_cid, param: *mut sctp_chunks_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_send_cid(chunk: enum sctp_cid, asoc: *const sctp_association) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_recv_cid(chunk: enum sctp_cid, asoc: *const sctp_association) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_ep_add_chunkid(ep: *mut sctp_endpoint, chunk_id: __u8) -> c_int {
...
// The key identifier MUST correst to an existing key
    ...
    return -EINVAL;
    if (asoc) {
    let mut active_key_id: __u16 = asoc.active_key_id;
...
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_init(ep: *mut sctp_endpoint, gfp: gfp_t) -> c_int {
...
// Free all allocations
    ...
    ep.auth_hmacs_list = core::ptr::null_mut();
    ep.auth_chunk_list = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
pub unsafe extern "C" fn sctp_auth_free(ep: *mut sctp_endpoint) {
