...
pub unsafe extern "C" fn sctp_ulpevent_is_notification(event: *const sctp_ulpevent) -> c_int {
    ...
    {
    let mut MSG_NOTIFICATION: return = = (event.msg_flags & MSG_NOTIFICATION);
    }
...
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpevent_release_owner(event: *mut sctp_ulpevent) {
...
// Pull off any padding.
    let mut len: c_int = ntohs(chunk.chunk_hdr.length);
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpevent_get_notification_type(event: *const sctp_ulpevent) -> __u16 {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_ulpevent_release_data(event: *mut sctp_ulpevent) {
    static void sctp_ulpevent_release_data(struct sctp_ulpevent *event)
    {
    struct sk_buff *skb, *frag;
    unsigned int	len;
...
#[no_mangle]
unsafe extern "C" fn sctp_ulpevent_release_frag_data(event: *mut sctp_ulpevent) {
    static void sctp_ulpevent_release_frag_data(struct sctp_ulpevent *event)
    {
    struct sk_buff *skb, *frag;
    skb = sctp_event2skb(event);
