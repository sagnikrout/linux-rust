...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_bind_addr_init(bp: *mut sctp_bind_addr, port: __u16) {
...
#[no_mangle]
unsafe extern "C" fn sctp_bind_addr_clean(bp: *mut sctp_bind_addr) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_bind_addr_free(bp: *mut sctp_bind_addr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_del_bind_addr(bp: *mut sctp_bind_addr, del_addr: *mut union sctp_addr) -> c_int {
...
//
    ...
    sp = bp_sp;
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: sctp_opt2sk(addr_sp)->sk_family ==) -> else {
...
// Copy out addresses from the global local address list.
    ...
    {
    let mut error: c_int = 0;
    if (sctp_is_any(core::ptr::null_mut(), addr)) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_is_any(sk: *mut sock, addr: *const union sctp_addr) -> c_int {
    int sctp_is_any(struct sock *sk, const union sctp_addr *addr)
    {
    let mut fam: c_ushort = 0;
    struct sctp_af *af;
...
// Is 'addr' valid for 'scope'?
    ...
    {
    let mut addr_scope: enum sctp_scope = sctp_scope(addr);
...
#[no_mangle]
pub unsafe extern "C" fn sctp_is_ep_boundall(sk: *mut sock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_scope(addr: *const union sctp_addr) -> enum sctp_scope {
