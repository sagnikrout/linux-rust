...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_cacc_skip_3_2(primary: *mut sctp_transport, tsn: __u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_outq_init(asoc: *mut sctp_association, q: *mut sctp_outq) {
...
//
#[no_mangle]
unsafe extern "C" fn __sctp_outq_teardown(q: *mut sctp_outq) {
...
// Throw away unacknowledged chunks.
    ...
    transports) {
    while ((lchunk = sctp_list_dequeue(&transport.transmitted)) != core::ptr::null_mut()) {
...
// Throw away any leftover data chunks.
    while ((chunk = sctp_outq_dequeue_data(q)) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_outq_teardown(q: *mut sctp_outq) {
...
// Free the outqueue structure and any related pending chunks.
#[no_mangle]
pub unsafe extern "C" fn sctp_outq_free(q: *mut sctp_outq) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_outq_tail(q: *mut sctp_outq, chunk: *mut sctp_chunk, gfp: gfp_t) {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_insert_list(head: *mut list_head, new: *mut list_head) {
...
// clear out_curr if all frag chunks are pruned
    ...
    asoc.stream.out_curr = core::ptr::null_mut();
    msg_len -= chk.skb.truesize + sizeof(struct sctp_chunk);
    sctp_chunk_free(chk);
    if (msg_len <= 0)
    break;
...
#[no_mangle]
pub unsafe extern "C" fn sctp_outq_uncork(q: *mut sctp_outq, gfp: gfp_t) {
    ...
    let mut sport: __u16 = asoc.base.bind_addr.port;
    let mut dport: __u16 = asoc.peer.port;
    let mut vtag: __u32 = asoc.peer.i.init_tag;
...
#[no_mangle]
unsafe extern "C" fn sctp_outq_flush_ctrl(ctx: *mut sctp_flush_ctx) {
...
// Finally, transmit new packets.
    while ((chunk = sctp_outq_dequeue_data(ctx.q)) != core::ptr::null_mut()) {
    let mut sid: __u32 = ntohs(chunk.subh.data_hdr.stream);
    let mut stream_state: __u8 = SCTP_SO(&ctx.asoc.stream, sid).state;
// Has this chunk expired?
    ...
    chunk.skb ? chunk.skb.head : core::ptr::null_mut(), chunk.skb ?
...
#[no_mangle]
unsafe extern "C" fn sctp_outq_flush_transports(ctx: *mut sctp_flush_ctx) {
    ...
    let mut error: c_int = 0;
    while ((ltransport = sctp_list_dequeue(&ctx.transport_list)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_outq_flush(q: *mut sctp_outq, rtx_timeout: c_int, gfp: gfp_t) {
    static void sctp_outq_flush(struct sctp_outq *q, int rtx_timeout, gfp_t gfp)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_outq_sack(q: *mut sctp_outq, chunk: *mut sctp_chunk) -> c_int {
    int sctp_outq_sack(struct sctp_outq *q, struct sctp_chunk *chunk)
    {
    struct sctp_association *asoc = q.asoc;
    struct sctp_sackhdr *sack = chunk.subh.sack_hdr;
    struct sctp_transport *transport;
    struct sctp_chunk *tchunk = core::ptr::null_mut();
    ...
    let mut count_of_newacks: c_int = 0;
    int gap_ack_blocks;
    let mut accum_moved: u8 = 0;
...
//
    sctp_check_transmitted(q, &q.retransmit, core::ptr::null_mut(), core::ptr::null_mut(), sack, &highest_new_tsn);
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_outq_is_empty(q: *const sctp_outq) -> c_int {
...
//
    ...
    __u32 sack_ctsn;
    __u32 rtt;
    let mut restart_timer: __u8 = 0;
    let mut bytes_acked: c_int = 0;
    let mut migrate_bytes: c_int = 0;
    let mut forward_progress: bool = false;
    sack_ctsn = ntohl(sack.cum_tsn_ack);
    INIT_LIST_HEAD(&tlist);
// The while loop will skip empty transmitted queues.
    while (core::ptr::null_mut() != (lchunk = sctp_list_dequeue(transmitted_queue))) {
    tchunk = list_entry(lchunk, struct sctp_chunk,
    transmitted_list);
...
// Mark chunks as missing and consequently may get retransmitted.
    ...
    struct sctp_chunk *chunk;
    __u32 tsn;
    let mut do_fast_retransmit: c_char = 0;
    struct sctp_association *asoc = q.asoc;
    struct sctp_transport *primary = asoc.peer.primary_path;
...
#[no_mangle]
unsafe extern "C" fn sctp_acked(sack: *mut sctp_sackhdr, tsn: __u32) -> c_int {
    static int sctp_acked(struct sctp_sackhdr *sack, __u32 tsn)
    {
    let mut ctsn: __u32 = ntohl(sack.cum_tsn_ack);
    union sctp_sack_variable *frags;
...
#[no_mangle]
pub unsafe extern "C" fn sctp_generate_fwdtsn(q: *mut sctp_outq, ctsn: __u32) {
    void sctp_generate_fwdtsn(struct sctp_outq *q, __u32 ctsn)
    {
    struct sctp_association *asoc = q.asoc;
    struct sctp_chunk *ftsn_chunk = core::ptr::null_mut();
    struct sctp_fwdtsn_skip ftsn_skip_arr[10];
    let mut nskips: c_int = 0;
