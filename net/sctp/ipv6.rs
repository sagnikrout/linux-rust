...
#[no_mangle]
pub unsafe extern "C" fn sctp_udp_v6_err(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_xmit(skb: *mut sk_buff, t: *mut sctp_transport) -> c_int {
    ...
    local_bh_disable();
    udp_tunnel6_xmit_skb(dst, sk, skb, core::ptr::null_mut(), &fl6.saddr, &fl6.daddr,
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: asoc) -> else {
    else if (asoc)
...
// Make a copy of all potential local addresses.
    ...
    rcu_read_lock();
    if ((in6_dev = __in6_dev_get(dev)) == core::ptr::null_mut()) {
    rcu_read_unlock();
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_copy_ip_options(sk: *mut sock, newsk: *mut sock) {
    static void sctp_v6_copy_ip_options(struct sock *sk, struct sock *newsk)
    {
    struct ipv6_pinfo *newnp, *np = inet6_sk(sk);
    struct ipv6_txoptions *opt;
    inet_sk(newsk).inet_opt = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_ip_options_len(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_from_sk(addr: *mut union sctp_addr, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_to_sk_saddr(addr: *mut union sctp_addr, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_to_sk_daddr(addr: *mut union sctp_addr, sk: *mut sock) {
...
//
    ...
    union sctp_addr_param *param)
    {
    let mut length: c_int = sizeof(struct sctp_ipv6addr_param);
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_inaddr_any(addr: *mut union sctp_addr, port: __be16) {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_is_any(addr: *const union sctp_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_available(addr: *mut union sctp_addr, sp: *mut sctp_sock) -> c_int {
...
//
    ...
    {
    let mut ret: c_int = ipv6_addr_type(&addr.v6.sin6_addr);
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_scope(addr: *mut union sctp_addr) -> enum sctp_scope {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_v6_addr_to_user(sp: *mut sctp_sock, addr: *mut union sctp_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_skb_iif(skb: *const sk_buff) -> c_int {
    static int sctp_v6_skb_iif(const struct sk_buff *skb)
    {
    return inet6_iif(skb);
    }
#[no_mangle]
unsafe extern "C" fn sctp_v6_skb_sdif(skb: *const sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v6_is_ce(skb: *const sk_buff) -> c_int {
    static int sctp_v6_is_ce(const struct sk_buff *skb)
    {
    return *((__u32 *)(ipv6_hdr(skb))) & ( __u32)htonl(1 << 20);
    }
// Dump the v6 addr to the seq file.
#[no_mangle]
unsafe extern "C" fn sctp_v6_seq_dump_addr(seq: *mut seq_file, addr: *mut union sctp_addr) {
    static void sctp_v6_seq_dump_addr(struct seq_file *seq, union sctp_addr *addr)
    {
    seq_printf(seq, "%pI6 ", &addr.v6.sin6_addr);
    }
#[no_mangle]
unsafe extern "C" fn sctp_v6_ecn_capable(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn sctp_inet6_af_supported(family: sa_family_t, sp: *mut sctp_sock) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_inet6_bind_verify(opt: *mut sctp_sock, addr: *mut union sctp_addr) -> c_int {
...
// ASSERT: address family has already been verified.
    ...
    let mut type: c_int = ipv6_addr_type(&addr.v6.sin6_addr);
    struct net_device *dev;
...
//
#[no_mangle]
unsafe extern "C" fn sctp_inet6_send_verify(opt: *mut sctp_sock, addr: *mut union sctp_addr) -> c_int {
    static int sctp_inet6_send_verify(struct sctp_sock *opt, union sctp_addr *addr)
    {
    struct sctp_af *af = core::ptr::null_mut();
// ASSERT: address family has already been verified.
    if (addr.sa.sa_family != AF_INET6)
    af = sctp_get_af_specific(addr.sa.sa_family);
    else {
...
#[no_mangle]
unsafe extern "C" fn sctp6_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_v6_pf_init() {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_v6_pf_exit() {
...
// Initialize IPv6 support and register with socket layer.
#[no_mangle]
pub unsafe extern "C" fn sctp_v6_protosw_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_v6_protosw_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_v6_add_protocol() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_v6_del_protocol() {
