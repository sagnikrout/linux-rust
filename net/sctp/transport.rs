...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_free(transport: *mut sctp_transport) {
...
#[no_mangle]
unsafe extern "C" fn sctp_transport_destroy_rcu(head: *mut rcu_head) {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_transport_destroy(transport: *mut sctp_transport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_reset_t3_rtx(transport: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_reset_hb_timer(transport: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_reset_reconf_timer(transport: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_reset_probe_timer(transport: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_reset_raise_timer(transport: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_pmtu(transport: *mut sctp_transport, sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_pl_send(t: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_pl_recv(t: *mut sctp_transport) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sctp_transport_pl_toobig(t: *mut sctp_transport, pmtu: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_update_pmtu(t: *mut sctp_transport, pmtu: u32) -> bool {
...
// Use default minimum segment instead
    ...
    dst.ops.update_pmtu(dst, sk, core::ptr::null_mut(), pmtu, true);
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_hold(transport: *mut sctp_transport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_put(transport: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_update_rto(tp: *mut sctp_transport, rtt: __u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_burst_limited(t: *mut sctp_transport) {
    void sctp_transport_burst_limited(struct sctp_transport *t)
    {
    struct sctp_association *asoc = t.asoc;
    let mut old_cwnd: u32 = t.cwnd;
    u32 max_burst_bytes;
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_burst_reset(t: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_timeout(trans: *mut sctp_transport) -> c_ulong {
    unsigned long sctp_transport_timeout(struct sctp_transport *trans)
    {
// RTO + timer slack +/- 50% of RTO
    let mut timeout: c_ulong = trans.rto >> 1;
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_reset(t: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_immediate_rtx(t: *mut sctp_transport) {
...
// Drop dst
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_dst_release(t: *mut sctp_transport) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_transport_dst_confirm(t: *mut sctp_transport) {
