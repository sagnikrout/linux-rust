...
#[no_mangle]
pub unsafe extern "C" fn sctp_inq_init(queue: *mut sctp_inq) {
    void sctp_inq_init(struct sctp_inq *queue)
    {
    INIT_LIST_HEAD(&queue.in_chunk_list);
    queue.in_progress = core::ptr::null_mut();
// Create a task for delivering data.
    INIT_WORK(&queue.immediate, core::ptr::null_mut());
    }
// Properly release the chunk which is being worked on.
#[no_mangle]
pub unsafe extern "C" fn sctp_inq_chunk_free(chunk: *mut sctp_chunk) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_inq_free(queue: *mut sctp_inq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_inq_push(q: *mut sctp_inq, chunk: *mut sctp_chunk) {
...
// Peek at the next chunk on the inqeue.
    ...
    struct sctp_chunkhdr *ch = core::ptr::null_mut();
...
//
    ...
    chunk = queue.in_progress = core::ptr::null_mut();
    } else {
...
// head_cb = SCTP_INPUT_CB(chunk->head_skb);
    ...
    chunk.subh.v = core::ptr::null_mut(); /* Subheader is no longer valid.  */
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_inq_set_th_handler(q: *mut sctp_inq, callback: work_func_t) {
