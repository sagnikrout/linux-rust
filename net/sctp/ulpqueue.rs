...
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpq_init(ulpq: *mut sctp_ulpq, asoc: *mut sctp_association) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpq_flush(ulpq: *mut sctp_ulpq) {
    void sctp_ulpq_flush(struct sctp_ulpq *ulpq)
    {
    struct sk_buff *skb;
    struct sctp_ulpevent *event;
    while ((skb = __skb_dequeue(&ulpq.lobby)) != core::ptr::null_mut()) {
    event = sctp_skb2event(skb);
    sctp_ulpevent_free(event);
    }
    while ((skb = __skb_dequeue(&ulpq.reasm)) != core::ptr::null_mut()) {
    event = sctp_skb2event(skb);
    sctp_ulpevent_free(event);
    }
    while ((skb = __skb_dequeue(&ulpq.reasm_uo)) != core::ptr::null_mut()) {
    event = sctp_skb2event(skb);
    sctp_ulpevent_free(event);
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpq_free(ulpq: *mut sctp_ulpq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_clear_pd(sk: *mut sock, asoc: *mut sctp_association) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_ulpq_set_pd(ulpq: *mut sctp_ulpq) {
...
#[no_mangle]
unsafe extern "C" fn sctp_ulpq_clear_pd(ulpq: *mut sctp_ulpq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpq_tail_event(ulpq: *mut sctp_ulpq, skb_list: *mut sk_buff_head) -> c_int {
...
//
    ...
    {
    struct sk_buff *pos;
    struct sk_buff *new = core::ptr::null_mut();
    struct sctp_ulpevent *event;
...
//
    ...
    if (!new)
    return core::ptr::null_mut();	/* try again later */
...
//
    ...
    struct sk_buff *pos;
    struct sctp_ulpevent *cevent;
    struct sk_buff *first_frag = core::ptr::null_mut();
    __u32 ctsn, next_tsn;
    struct sctp_ulpevent *retval = core::ptr::null_mut();
    struct sk_buff *pd_first = core::ptr::null_mut();
    struct sk_buff *pd_last = core::ptr::null_mut();
    let mut pd_len: usize = 0;
...
//
    ...
    pd_first = core::ptr::null_mut();
    pd_last = core::ptr::null_mut();
    pd_len = 0;
    }
    first_frag = pos;
    next_tsn = ctsn + 1;
...
//
    ...
    last_frag = first_frag = core::ptr::null_mut();
    ...
    first_frag = pos;
#[no_mangle]
pub unsafe extern "C" fn if(next_tsn: ctsn !=) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpq_reasm_flushtsn(ulpq: *mut sctp_ulpq, fwd_tsn: __u32) {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_ulpq_reasm_drain(ulpq: *mut sctp_ulpq) {
    static void sctp_ulpq_reasm_drain(struct sctp_ulpq *ulpq)
    {
    struct sctp_ulpevent *event = core::ptr::null_mut();
    if (skb_queue_empty(&ulpq.reasm))
    return;
    while ((event = sctp_ulpq_retrieve_reassembled(ulpq)) != core::ptr::null_mut()) {
    struct sk_buff_head temp;
    skb_queue_head_init(&temp);
    __skb_queue_tail(&temp, sctp_event2skb(event));
// Do ordering if needed.
...
//
#[no_mangle]
unsafe extern "C" fn sctp_ulpq_reap_ordered(ulpq: *mut sctp_ulpq, sid: __u16) {
...
//
    if (event == core::ptr::null_mut() && pos != (struct sk_buff *)lobby) {
    cevent = (struct sctp_ulpevent *) pos.cb;
    csid = cevent.stream;
    cssn = cevent.ssn;
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpq_skip(ulpq: *mut sctp_ulpq, sid: __u16, ssn: __u16) {
...
//
    ...
    __u16 needed)
    {
    let mut freed: __u16 = 0;
    __u32 tsn, last_tsn;
    struct sk_buff *skb, *flist, *last;
    struct sctp_ulpevent *event;
    struct sctp_tsnmap *tsnmap;
    tsnmap = &ulpq.asoc.peer.tsn_map;
    while ((skb = skb_peek_tail(list)) != core::ptr::null_mut()) {
    event = sctp_skb2event(skb);
    tsn = event.tsn;
...
#[no_mangle]
unsafe extern "C" fn sctp_ulpq_renege_order(ulpq: *mut sctp_ulpq, needed: __u16) -> __u16 {
...
#[no_mangle]
unsafe extern "C" fn sctp_ulpq_renege_frags(ulpq: *mut sctp_ulpq, needed: __u16) -> __u16 {
...
// If able to free enough room, accept this chunk.
    ...
    freed >= needed) {
    let mut retval: c_int = sctp_ulpq_tail_data(ulpq, chunk, gfp);
//
...
#[no_mangle]
pub unsafe extern "C" fn if(1: retval ==) -> else {
    else if (retval == 1)
    sctp_ulpq_reasm_drain(ulpq);
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_ulpq_abort_pd(ulpq: *mut sctp_ulpq, gfp: gfp_t) {
    void sctp_ulpq_abort_pd(struct sctp_ulpq *ulpq, gfp_t gfp)
    {
    struct sctp_ulpevent *ev = core::ptr::null_mut();
    struct sctp_sock *sp;
    struct sock *sk;
    if (!ulpq.pd_mode)
    return;
