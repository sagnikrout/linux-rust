...
//! Source: net/sctp/sm_sideeffect.c
#![no_std]
...
// Restart the SACK timer.
    ...
    let mut old_a_rwnd: __u32 = asoc.a_rwnd;
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_generate_t3_rtx_event(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sctp_generate_t1_cookie_event(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sctp_generate_t1_init_event(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sctp_generate_t2_shutdown_event(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sctp_generate_t4_rto_event(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sctp_generate_t5_shutdown_guard_event(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sctp_generate_autoclose_event(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_generate_heartbeat_event(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sctp_generate_proto_unreach_event(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_generate_reconf_event(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_generate_probe_event(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sctp_generate_sack_event(t: *mut timer_list) {
...
// Worker routine to handle INIT command failure.
    ...
    (__u16)error, 0, 0, core::ptr::null_mut(),
    GFP_ATOMIC);
    if (event)
...
// Helper function to handle the reception of an HEARTBEAT ACK.
    ...
    let mut was_unconfirmed: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn sctp_cmd_del_non_primary(asoc: *mut sctp_association) {
...
#[no_mangle]
unsafe extern "C" fn sctp_cmd_set_sk_err(asoc: *mut sctp_association, error: c_int) {
...
// This is the side-effect interpreter.
    ...
    struct sctp_chunk *chunk = core::ptr::null_mut(), *new_obj;
