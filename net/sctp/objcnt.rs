...
//
#[no_mangle]
unsafe extern "C" fn sctp_objcnt_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    {
    return (*pos >= ARRAY_SIZE(sctp_dbg_objcnt)) ? core::ptr::null_mut() : (void *)pos;
    }
#[no_mangle]
unsafe extern "C" fn sctp_objcnt_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_dbg_objcnt_init(net: *mut net) {
