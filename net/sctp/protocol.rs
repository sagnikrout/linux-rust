...
//
    ...
    rcu_read_lock();
    if ((in_dev = __in_dev_get_rcu(dev)) == core::ptr::null_mut()) {
    rcu_read_unlock();
    return;
    }
...
//
#[no_mangle]
unsafe extern "C" fn sctp_get_local_addr_list(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn sctp_free_local_addr_list(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_copy_ip_options(sk: *mut sock, newsk: *mut sock) {
    static void sctp_v4_copy_ip_options(struct sock *sk, struct sock *newsk)
    {
    struct inet_sock *newinet, *inet = inet_sk(sk);
    struct ip_options_rcu *inet_opt, *newopt = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_ip_options_len(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_from_sk(addr: *mut union sctp_addr, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_to_sk_saddr(addr: *mut union sctp_addr, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_to_sk_daddr(addr: *mut union sctp_addr, sk: *mut sock) {
...
//
    ...
    union sctp_addr_param *param)
    {
    let mut length: c_int = sizeof(struct sctp_ipv4addr_param);
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_inaddr_any(addr: *mut union sctp_addr, port: __be16) {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_is_any(addr: *const union sctp_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_available(addr: *mut union sctp_addr, sp: *mut sctp_sock) -> c_int {
    static int sctp_v4_available(union sctp_addr *addr, struct sctp_sock *sp)
    {
    struct sock *sk = &sp.inet.sk;
    struct net *net = sock_net(sk);
    let mut tb_id: c_int = RT_TABLE_LOCAL;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn sctp_v4_scope(addr: *mut union sctp_addr) -> enum sctp_scope {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_skb_iif(skb: *const sk_buff) -> c_int {
    static int sctp_v4_skb_iif(const struct sk_buff *skb)
    {
    return inet_iif(skb);
    }
#[no_mangle]
unsafe extern "C" fn sctp_v4_skb_sdif(skb: *const sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_is_ce(skb: *const sk_buff) -> c_int {
    static int sctp_v4_is_ce(const struct sk_buff *skb)
    {
    return INET_ECN_is_ce(ip_hdr(skb).tos);
    }
#[no_mangle]
unsafe extern "C" fn sctp_v4_addr_to_user(sp: *mut sctp_sock, addr: *mut union sctp_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_seq_dump_addr(seq: *mut seq_file, addr: *mut union sctp_addr) {
    static void sctp_v4_seq_dump_addr(struct seq_file *seq, union sctp_addr *addr)
    {
    seq_printf(seq, "%pI4 ", &addr.v4.sin_addr);
    }
#[no_mangle]
unsafe extern "C" fn sctp_v4_ecn_capable(sk: *mut sock) {
    static void sctp_v4_ecn_capable(struct sock *sk)
    {
    INET_ECN_xmit(sk);
    }
#[no_mangle]
unsafe extern "C" fn sctp_addr_wq_timeout_handler(t: *mut timer_list) {
...
// Note. we currently don't handle link local IPv6 addressees
    ...
    if (ipv6_chk_addr(net, in6, core::ptr::null_mut(), 0) == 0 &&
...
#[no_mangle]
unsafe extern "C" fn sctp_free_addr_wq(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_addr_wq_mgmt(net: *mut net, addr: *mut sctp_sockaddr_entry, cmd: c_int) {
...
//
    ...
    struct sctp_sockaddr_entry *addr = core::ptr::null_mut();
    struct sctp_sockaddr_entry *temp;
...
//
#[no_mangle]
unsafe extern "C" fn sctp_ctl_sock_init(net: *mut net) -> c_int {
    static int sctp_ctl_sock_init(struct net *net)
    {
    int err;
    let mut family: sa_family_t = PF_INET;
...
#[no_mangle]
unsafe extern "C" fn sctp_udp_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_udp_sock_start(net: *mut net) -> c_int {
    ...
    net.sctp.udp4_sock = core::ptr::null_mut();
    return err;
    }
    tuncfg.encap_type = 1;
    tuncfg.encap_rcv = sctp_udp_rcv;
...
#[no_mangle]
pub unsafe extern "C" fn sctp_udp_sock_stop(net: *mut net) {
    ...
    net.sctp.udp6_sock = core::ptr::null_mut();
    }
    }
// Register address family specific functions.
#[no_mangle]
pub unsafe extern "C" fn sctp_register_af(af: *mut sctp_af) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_inet_msgname(msgname: *mut c_char, addr_len: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn sctp_inet_skb_msgname(skb: *mut sk_buff, msgname: *mut c_char, len: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn sctp_inet_af_supported(family: sa_family_t, sp: *mut sctp_sock) -> c_int {
    static int sctp_inet_af_supported(sa_family_t family, struct sctp_sock *sp)
    {
// PF_INET only supports AF_INET addresses.
    let mut AF_INET: return = = family;
    }
...
//
#[no_mangle]
unsafe extern "C" fn sctp_inet_bind_verify(opt: *mut sctp_sock, addr: *mut union sctp_addr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sctp_inet_send_verify(opt: *mut sctp_sock, addr: *mut union sctp_addr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_v4_xmit(skb: *mut sk_buff, t: *mut sctp_transport) -> c_int {
    ...
    struct inet_sock *inet = inet_sk(sk);
    let mut dscp: __u8 = READ_ONCE(inet.tos);
    let mut df: __be16 = 0;
...
#[no_mangle]
unsafe extern "C" fn sctp4_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sctp_register_pf(pf: *mut sctp_pf, family: sa_family_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn init_sctp_mibs(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cleanup_sctp_mibs(net: *mut net) {
    static inline void cleanup_sctp_mibs(struct net *net)
    {
    free_percpu(net.sctp.sctp_statistics);
    }
#[no_mangle]
unsafe extern "C" fn sctp_v4_pf_init() {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_pf_exit() {
    static void sctp_v4_pf_exit(void)
    {
    list_del(&sctp_af_inet.list);
    }
#[no_mangle]
unsafe extern "C" fn sctp_v4_protosw_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_protosw_exit() {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_add_protocol() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sctp_v4_del_protocol() {
...
#[no_mangle]
unsafe extern "C" fn sctp_defaults_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn sctp_defaults_exit(net: *mut net) -> void __net_exit {
...
// Free the local address list
    ...
    net.sctp.proc_net_sctp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sctp_ctrlsock_init(net: *mut net) -> int __net_init {
...
// Initialize the control inode/socket for handling OOTB packets.
    ...
    net.sctp.ctl_sock = core::ptr::null_mut();
    }
    return status;
    }
#[no_mangle]
unsafe extern "C" fn sctp_ctrlsock_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn sctp_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn sctp_exit() -> __exit void {
