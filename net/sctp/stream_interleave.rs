...
//! Source: net/sctp/stream_interleave.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sctp_chunk_assign_mid(chunk: *mut sctp_chunk) {
    static void sctp_chunk_assign_mid(struct sctp_chunk *chunk)
    {
    struct sctp_stream *stream;
    struct sctp_chunk *lchunk;
    let mut cfsn: __u32 = 0;
    __u16 sid;
    if (chunk.has_mid)
    return;
...
#[no_mangle]
unsafe extern "C" fn sctp_validate_data(chunk: *mut sctp_chunk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sctp_validate_idata(chunk: *mut sctp_chunk) -> bool {
    ...
    struct sk_buff *last_frag = core::ptr::null_mut();
    struct sctp_ulpevent *retval;
    struct sctp_stream_in *sin;
    struct sk_buff *pos;
    let mut next_fsn: __u32 = 0;
    let mut is_last: c_int = 0;
    ...
    struct sk_buff *pos, *first_frag = core::ptr::null_mut();
    ...
    struct sctp_stream_in *sin;
    let mut next_fsn: __u32 = 0;
    let mut pd_point: __u32 = 0;
    let mut pd_len: __u32 = 0;
    let mut mid: __u32 = 0;
    sin = sctp_stream_in(&ulpq.asoc.stream, event.stream);
    skb_queue_walk(&ulpq.reasm, pos) {
    struct sctp_ulpevent *cevent = sctp_skb2event(pos);
    ...
    let mut sid: __u16 = event.stream;
    ...
    {
    struct sctp_stream_in *csin, *sin = core::ptr::null_mut();
    struct sk_buff *first_frag = core::ptr::null_mut();
    struct sk_buff *last_frag = core::ptr::null_mut();
    struct sctp_ulpevent *retval;
    struct sk_buff *pos;
...
#[no_mangle]
unsafe extern "C" fn sctp_intl_start_pd(ulpq: *mut sctp_ulpq, gfp: gfp_t) {
...
#[no_mangle]
unsafe extern "C" fn sctp_intl_reap_ordered(ulpq: *mut sctp_ulpq, sid: __u16) {
    static void sctp_intl_reap_ordered(struct sctp_ulpq *ulpq, __u16 sid)
    {
    struct sctp_stream *stream = &ulpq.asoc.stream;
    struct sctp_ulpevent *cevent, *event = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sctp_intl_abort_pd(ulpq: *mut sctp_ulpq, gfp: gfp_t) {
...
pub const SCTP_FTSN_U_BIT: c_uint = 0x1;
#[no_mangle]
unsafe extern "C" fn sctp_generate_iftsn(q: *mut sctp_outq, ctsn: __u32) {
    ...
    let mut nskips: c_int = 0, skip_pos;
    ...
    let mut sid: __be16 = chunk.subh.idata_hdr.stream;
    let mut mid: __be32 = chunk.subh.idata_hdr.mid;
...
#[no_mangle]
unsafe extern "C" fn sctp_validate_fwdtsn(chunk: *mut sctp_chunk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sctp_validate_iftsn(chunk: *mut sctp_chunk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sctp_report_fwdtsn(ulpq: *mut sctp_ulpq, ftsn: __u32) {
...
#[no_mangle]
unsafe extern "C" fn sctp_intl_reasm_flushtsn(ulpq: *mut sctp_ulpq, ftsn: __u32) {
...
#[no_mangle]
unsafe extern "C" fn sctp_report_iftsn(ulpq: *mut sctp_ulpq, ftsn: __u32) {
...
#[no_mangle]
unsafe extern "C" fn sctp_handle_fwdtsn(ulpq: *mut sctp_ulpq, chunk: *mut sctp_chunk) {
...
#[no_mangle]
unsafe extern "C" fn sctp_handle_iftsn(ulpq: *mut sctp_ulpq, chunk: *mut sctp_chunk) {
...
#[no_mangle]
unsafe extern "C" fn do_ulpq_tail_event(ulpq: *mut sctp_ulpq, event: *mut sctp_ulpevent) -> c_int {
