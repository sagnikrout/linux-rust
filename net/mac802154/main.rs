...
#[no_mangle]
unsafe extern "C" fn ieee802154_tasklet_handler(t: *mut tasklet_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x7FE: BIT(channel) &) -> else {
    else if (BIT(channel) & 0x7FE)
// 915 MHz BPSK	802.15.4-2003: 40 ksym/s
    duration = 25 * NSEC_PER_USEC;
#[no_mangle]
pub unsafe extern "C" fn if(0x7FFF800: BIT(channel) &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_free_hw(hw: *mut ieee802154_hw) {
...
#[no_mangle]
unsafe extern "C" fn ieee802154_setup_wpan_phy_pib(wpan_phy: *mut wpan_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_register_hw(hw: *mut ieee802154_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_unregister_hw(hw: *mut ieee802154_hw) {
...
#[no_mangle]
unsafe extern "C" fn ieee802154_init() -> int __init {
    static int __init ieee802154_init(void)
    {
    return ieee802154_iface_init();
    }
#[no_mangle]
unsafe extern "C" fn ieee802154_exit() -> void __exit {
