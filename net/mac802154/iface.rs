...
#[no_mangle]
pub unsafe extern "C" fn mac802154_wpan_update_llsec(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac802154_wpan_mac_addr(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee802154_setup_hw(sdata: *mut ieee802154_sub_if_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac802154_slave_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac802154_wpan_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac802154_slave_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IEEE802154_SCF_KEY_HW_INDEX: params.out_key.mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mac802154_wpan_free(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ieee802154_if_setup(dev: *mut net_device) {
...
// defaults per 802.15.4-2011
    ...
    struct ieee802154_sub_if_data *sdata = core::ptr::null_mut();
    int ret;
    ASSERT_RTNL();
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_if_remove(sdata: *mut ieee802154_sub_if_data) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_remove_interfaces(local: *mut ieee802154_local) {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_iface_init() -> c_int {
    int ieee802154_iface_init(void)
    {
    return register_netdevice_notifier(&mac802154_netdev_notifier);
    }
#[no_mangle]
pub unsafe extern "C" fn ieee802154_iface_exit() {
