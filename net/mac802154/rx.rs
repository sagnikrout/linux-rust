...
#[no_mangle]
unsafe extern "C" fn ieee802154_deliver_skb(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mac802154_rx_beacon_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mac802154_should_answer_beacon_req(local: *mut ieee802154_local) -> bool {
    ...
    return false;
    let mut interval: return = = IEEE802154_ACTIVE_SCAN_DURATION;
    }
#[no_mangle]
pub unsafe extern "C" fn mac802154_rx_mac_cmd_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !wpan_dev->parent) -> else {
...
// We are not the PAN coordinator, just relaying
    ...
    skb.pkt_type = PACKET_OTHERHOST;
#[no_mangle]
pub unsafe extern "C" fn if(wpan_dev->extended_addr: mac_cb(skb)->dest.extended_addr ==) -> else {
    ...
    skb.pkt_type = PACKET_OTHERHOST;
#[no_mangle]
pub unsafe extern "C" fn if(sshort: mac_cb(skb)->dest.short_addr ==) -> else {
...
//
    ...
    let mut hw: u64 = swab64(( u64)addr.extended_addr);
    ...
    key = swab64(( u64)hdr.sec.extended_src);
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_rx(local: *mut ieee802154_local, skb: *mut sk_buff) {
