...
//! Source: net/ieee802154/nl-phy.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(_arg: uint32_t), _arg: buf)) -> *mut pages {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_list_phy(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee802154_dump_phy_iter(phy: *mut wpan_phy, _data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_dump_phy(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_add_iface(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    let mut type: c_int = __IEEE802154_DEV_INVALID;
...
//
    rtnl_lock();
    rc = dev_set_mac_address(dev, &addr, core::ptr::null_mut());
    rtnl_unlock();
    if (rc)
    goto dev_unregister;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_del_iface(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
