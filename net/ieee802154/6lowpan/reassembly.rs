...
//! Source: net/ieee802154/6lowpan/reassembly.c
#![no_std]
...
//
    ...
    int *refs);
#[no_mangle]
unsafe extern "C" fn lowpan_frag_init(q: *mut inet_frag_queue, a: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn lowpan_frag_expire(t: *mut timer_list) {
    static void lowpan_frag_expire(struct timer_list *t)
    {
    struct inet_frag_queue *frag = timer_container_of(frag, t, timer);
    struct frag_queue *fq;
    let mut refs: c_int = 1;
    ...
    let mut key: frag_lowpan_compare_key = {};
...
// Some bits beyond end -> corruption.
    ...
    fq.q.meat == fq.q.len) {
    int res;
    let mut orefdst: c_ulong = skb._skb_refdst;
    skb._skb_refdst = 0UL;
...
#[no_mangle]
unsafe extern "C" fn lowpan_frag_rx_h_iphc(skb: *mut sk_buff) -> lowpan_rx_result {
...
#[no_mangle]
unsafe extern "C" fn lowpan_invoke_frag_rx_handlers(skb: *mut sk_buff) -> c_int {
...
pub const LOWPAN_FRAG_DGRAM_SIZE_HIGH_MASK: c_uint = 0x07;
pub const LOWPAN_FRAG_DGRAM_SIZE_HIGH_SHIFT: c_int = 8;
    static int lowpan_get_cb(struct sk_buff *skb, u8 frag_type,
    struct lowpan_802154_cb *cb)
    {
    bool fail;
    let mut high: u8 = 0, low = 0;
    let mut d_tag: __be16 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_frag_rcv(skb: *mut sk_buff, frag_type: u8) -> c_int {
    int lowpan_frag_rcv(struct sk_buff *skb, u8 frag_type)
    {
    struct lowpan_frag_queue *fq;
    struct net *net = dev_net(skb.dev);
    struct lowpan_802154_cb *cb = lowpan_802154_cb(skb);
    let mut hdr: ieee802154_hdr = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn lowpan_frags_ns_sysctl_register(net: *mut net) -> int __net_init {
    ...
    struct netns_ieee802154_lowpan *ieee802154_lowpan =
    net_ieee802154_lowpan(net);
    let mut table_size: usize = ARRAY_SIZE(lowpan_frags_ns_ctl_table);
...
#[no_mangle]
unsafe extern "C" fn lowpan_frags_ns_sysctl_unregister(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn lowpan_frags_sysctl_register() -> int __init {
    static int __init lowpan_frags_sysctl_register(void)
    {
    lowpan_ctl_header = register_net_sysctl(&init_net,
    "net/ieee802154/6lowpan",
    lowpan_frags_ctl_table);
    let mut lowpan_ctl_header: return = = core::ptr::null_mut() ? -ENOMEM : 0;
    }
#[no_mangle]
unsafe extern "C" fn lowpan_frags_sysctl_unregister() {
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_frags_ns_sysctl_register(net: *mut net) -> c_int {
    static inline int lowpan_frags_ns_sysctl_register(struct net *net)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn lowpan_frags_ns_sysctl_unregister(net: *mut net) {
    static inline void lowpan_frags_ns_sysctl_unregister(struct net *net)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn lowpan_frags_sysctl_register() -> int __init {
    static inline int __init lowpan_frags_sysctl_register(void)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn lowpan_frags_sysctl_unregister() {
    static inline void lowpan_frags_sysctl_unregister(void)
    {
    }

#[no_mangle]
unsafe extern "C" fn lowpan_frags_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn lowpan_frags_pre_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn lowpan_frags_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn lowpan_key_hashfn(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lowpan_obj_hashfn(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lowpan_obj_cmpfn(arg: *mut rhashtable_compare_arg, ptr: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_net_frag_init() -> int __init {
    int __init lowpan_net_frag_init(void)
    {
    int ret;
    lowpan_frags.constructor = lowpan_frag_init;
    lowpan_frags.destructor = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_net_frag_exit() {
