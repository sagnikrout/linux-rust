...
//! Source: net/ieee802154/6lowpan/tx.c
#![no_std]
...
pub const LOWPAN_FRAG1_HEAD_SIZE: c_uint = 0x4;
pub const LOWPAN_FRAGN_HEAD_SIZE: c_uint = 0x5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lowpan_addr_info {
    pub daddr: ieee802154_addr,
    pub saddr: ieee802154_addr,
}
...
//
    ...
    struct lowpan_802154_neigh *llneigh = core::ptr::null_mut();
...
// intra-pan communication
    ...
    let mut short_addr: __le16 = cpu_to_le16(IEEE802154_ADDR_SHORT_UNSPEC);
...
#[no_mangle]
pub unsafe extern "C" fn lowpan_xmit(skb: *mut sk_buff, ldev: *mut net_device) -> netdev_tx_t {
