...
//! Source: net/ieee802154/nl-mac.c
#![no_std]
...
//
    ...
    int padattr)
    {
    return nla_put_u64_64bit(msg, type, swab64(( u64)hwaddr),
    padattr);
    }
#[no_mangle]
unsafe extern "C" fn nla_get_hwaddr(nla: *const nlattr) -> __le64 {
    static __le64 nla_get_hwaddr(const struct nlattr *nla)
    {
    return ieee802154_devaddr_from_raw(nla_data(nla));
    }
#[no_mangle]
unsafe extern "C" fn nla_put_shortaddr(msg: *mut sk_buff, type: c_int, addr: __le16) -> c_int {
    static int nla_put_shortaddr(struct sk_buff *msg, int type, __le16 addr)
    {
    return nla_put_u16(msg, type, le16_to_cpu(addr));
    }
#[no_mangle]
unsafe extern "C" fn nla_get_shortaddr(nla: *const nlattr) -> __le16 {
    static __le16 nla_get_shortaddr(const struct nlattr *nla)
    {
    return cpu_to_le16(nla_get_u16(nla));
    }
#[no_mangle]
unsafe extern "C" fn ieee802154_nl_start_confirm(dev: *mut net_device, status: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_associate_req(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_associate_resp(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_disassociate_req(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ieee802154_start_req(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_scan_req(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_list_iface(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_dump_iface(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_set_macparams(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    {
    let mut source: u32 = nla_get_u32(info.attrs[IEEE802154_ATTR_LLSEC_KEY_SOURCE_SHORT]);
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_getparams(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_setparams(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    let mut fc: u32 = nla_get_u32(info.attrs[IEEE802154_ATTR_LLSEC_FRAME_COUNTER]);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct llsec_dump_data {
    pub skb: *mut sk_buff,
    pub s_idx2: int s_idx,,
    pub portid: c_int,
    pub nlmsg_seq: c_int,
    pub dev: *mut net_device,
    pub ops: *mut ieee802154_mlme_ops,
    ...
    let mut idx: c_int = 0;
    let mut first_dev: c_int = cb.args[0];
    int rc;
    for_each_netdev(net, dev) {
...
#[no_mangle]
unsafe extern "C" fn llsec_add_key(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_add_key(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_remove_key(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_del_key(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_iter_keys(data: *mut llsec_dump_data) -> c_int {
    static int llsec_iter_keys(struct llsec_dump_data *data)
    {
    struct ieee802154_llsec_key_entry *pos;
    let mut rc: c_int = 0, idx = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_dump_keys(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_add_dev(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_add_dev(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_del_dev(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_del_dev(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_iter_devs(data: *mut llsec_dump_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_dump_devs(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    int ieee802154_llsec_dump_devs(struct sk_buff *skb, struct netlink_callback *cb)
    {
    return ieee802154_llsec_dump_table(skb, cb, llsec_iter_devs);
    }
#[no_mangle]
unsafe extern "C" fn llsec_add_devkey(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_add_devkey(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_del_devkey(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_del_devkey(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_iter_devkeys(data: *mut llsec_dump_data) -> c_int {
    static int llsec_iter_devkeys(struct llsec_dump_data *data)
    {
    struct ieee802154_llsec_device *dpos;
    struct ieee802154_llsec_device_key *kpos;
    let mut idx: c_int = 0, idx2;
...
#[no_mangle]
unsafe extern "C" fn llsec_add_seclevel(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_add_seclevel(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_del_seclevel(dev: *mut net_device, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ieee802154_llsec_del_seclevel(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llsec_iter_seclevels(data: *mut llsec_dump_data) -> c_int {
