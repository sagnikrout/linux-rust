...
//! Source: net/ieee802154/socket.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ieee802154_sock_release(sock: *mut socket) -> c_int {
    ...
    if (get_user_ifreq(&ifr, core::ptr::null_mut(), arg))
    return -EFAULT;
...
#[no_mangle]
unsafe extern "C" fn raw_hash(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_unhash(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn raw_bind(sk: *mut sock, _uaddr: *mut sockaddr_unsized, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_disconnect(sk: *mut sock, flags: c_int) -> c_int {
    static int raw_disconnect(struct sock *sk, int flags)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn raw_sendmsg(sk: *mut sock, msg: *mut msghdr, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee802154_raw_deliver(dev: *mut net_device, skb: *mut sk_buff) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dgram_sock {
    pub sk: sock,
    pub src_addr: ieee802154_addr,
    pub dst_addr: ieee802154_addr,
    pub bound:1: c_uint,
    pub connected:1: c_uint,
    pub want_ack:1: c_uint,
    pub want_lqi:1: c_uint,
    pub secen:1: c_uint,
    pub secen_override:1: c_uint,
    pub seclevel:3: c_uint,
    pub seclevel_override:1: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn dgram_hash(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dgram_unhash(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn dgram_init(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dgram_close(sk: *mut sock, timeout: c_long) {
    static void dgram_close(struct sock *sk, long timeout)
    {
    sk_common_release(sk);
    }
#[no_mangle]
unsafe extern "C" fn dgram_bind(sk: *mut sock, uaddr: *mut sockaddr_unsized, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dgram_ioctl(sk: *mut sock, cmd: c_int, karg: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dgram_disconnect(sk: *mut sock, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dgram_sendmsg(sk: *mut sock, msg: *mut msghdr, size: usize) -> c_int {
    ...
    ro.bound ? &ro.src_addr : core::ptr::null_mut(), size);
    if (err < 0)
    goto out_skb;
    err = memcpy_from_msg(skb_put(skb, size), msg, size);
    if (err < 0)
...
#[no_mangle]
unsafe extern "C" fn dgram_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ieee802154_dgram_deliver(dev: *mut net_device, skb: *mut sk_buff) -> c_int {
    static int ieee802154_dgram_deliver(struct net_device *dev, struct sk_buff *skb)
    {
    struct sock *sk, *prev = core::ptr::null_mut();
    let mut ret: c_int = NET_RX_SUCCESS;
    __le16 pan_id, short_addr;
    __le64 hw_addr;
...
#[no_mangle]
unsafe extern "C" fn do_dgram_getsockopt(sk: *mut sock, optname: c_int, opt: *mut sockopt_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ro->secen) -> else {
    else if (ro.secen)
...
#[no_mangle]
unsafe extern "C" fn ieee802154_sock_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn af_ieee802154_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn af_ieee802154_remove() -> void __exit {
