...
// Bleech...
    ...
    (struct compat_cmsghdr __user *)core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn put_cmsg_compat(kmsg: *mut msghdr, level: c_int, type: c_int, len: c_int, data: *mut c_void) -> c_int {
    ...
    int cmlen;
    if (cm == core::ptr::null_mut() || kmsg.msg_controllen < sizeof(*cm)) {
    ...
    let mut count: c_int = type == SO_TIMESTAMPNS_OLD ? 1 : 3;
    int i;
...
#[no_mangle]
unsafe extern "C" fn scm_max_fds_compat(msg: *mut msghdr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn scm_detach_fds_compat(msg: *mut msghdr, scm: *mut scm_cookie, notrunc: bool) {
    ...
    let mut fdmax: c_int = min_t(int, scm_max_fds_compat(msg), scm.fp.count);
    ...
    if (i > 0) {
    let mut cmlen: c_int = CMSG_COMPAT_LEN(i * sizeof(int));
...
// Argument list sizes for compat_sys_socketcall
    ...
    {
    return __compat_sys_recvfrom(fd, buf, len, flags, core::ptr::null_mut(), core::ptr::null_mut());
    }
    ...
    flags | MSG_CMSG_COMPAT, timeout, core::ptr::null_mut());
    }
    ...
    {
    return __sys_recvmmsg(fd, (struct mmsghdr __user *)mmsg, vlen,
    flags | MSG_CMSG_COMPAT, core::ptr::null_mut(), timeout);
    }
    ...
    break;
    case SYS_SEND:
    ret = __sys_sendto(a0, compat_ptr(a1), a[2], a[3], core::ptr::null_mut(), 0);
    break;
    case SYS_SENDTO:
    ...
    a[3] | MSG_CMSG_COMPAT, core::ptr::null_mut(),
    compat_ptr(a[4]));
    break;
    case SYS_ACCEPT4:
