...
#[no_mangle]
unsafe extern "C" fn sock_show_fdinfo(m: *mut seq_file, f: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn move_addr_to_kernel(uaddr: *mut void __user, ulen: c_int, kaddr: *mut sockaddr_storage) -> c_int {
...
pub struct sockfs_inode {
    ...
    si.socket.wq.fasync_list = core::ptr::null_mut();
    si.socket.wq.flags = 0;
    si.socket.state = SS_UNCONNECTED;
    si.socket.flags = 0;
    si.socket.ops = core::ptr::null_mut();
    si.socket.sk = core::ptr::null_mut();
    si.socket.file = core::ptr::null_mut();
    return &si.vfs_inode;
    }
#[no_mangle]
unsafe extern "C" fn sock_evict_inode(inode: *mut inode) {
    static void sock_evict_inode(struct inode *inode)
    {
    struct sockfs_inode *si = SOCKFS_I(inode);
    simple_xattrs_free(&sockfs_xa_cache, &si.xattrs, core::ptr::null_mut());
    clear_inode(inode);
    }
#[no_mangle]
unsafe extern "C" fn sock_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn init_inodecache() {
    ...
    SLAB_ACCOUNT),
    init_once);
    BUG_ON(sock_inode_cachep == core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_read_xattr(sock: *mut socket, name: *const c_char, value: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sockfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sock_map_fd(sock: *mut socket, flags: c_int) -> c_int {
    static int sock_map_fd(struct socket *sock, int flags)
    {
    struct file *newfile;
    let mut fd: c_int = get_unused_fd_flags(flags);
    if (unlikely(fd < 0)) {
    sock_release(sock);
    return fd;
    }
    newfile = sock_alloc_file(sock, flags, core::ptr::null_mut());
    if (!IS_ERR(newfile)) {
...
// err = -ENOTSOCK;
    ...
    {
    let mut err: c_int = simple_setattr(&nop_mnt_idmap, dentry, iattr);
...
#[no_mangle]
unsafe extern "C" fn __sock_release(sock: *mut socket, inode: *mut inode) {
    ...
    WRITE_ONCE(sock.file, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_release(sock: *mut socket) {
    void sock_release(struct socket *sock)
    {
    __sock_release(sock, core::ptr::null_mut());
    }
    EXPORT_SYMBOL(sock_release);
#[no_mangle]
pub unsafe extern "C" fn __sock_tx_timestamp(tsflags: __u32, tx_flags: *mut __u8) {
    void __sock_tx_timestamp(__u32 tsflags, __u8 *tx_flags)
    {
    let mut flags: u8 = *tx_flags;
...
#[no_mangle]
pub unsafe extern "C" fn sock_sendmsg_nosec(sock: *mut socket, msg: *mut msghdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sock_sendmsg(sock: *mut socket, msg: *mut msghdr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_sendmsg(sock: *mut socket, msg: *mut msghdr) -> c_int {
    int sock_sendmsg(struct socket *sock, struct msghdr *msg)
    {
    struct sockaddr_storage *save_addr = (struct sockaddr_storage *)msg.msg_name;
    struct sockaddr_storage address;
    let mut save_len: c_int = msg.msg_namelen;
    int ret;
    if (msg.msg_name) {
...
#[no_mangle]
unsafe extern "C" fn skb_is_err_queue(skb: *const sk_buff) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn skb_is_swtx_tstamp(skb: *const sk_buff, false_tstamp: c_int) -> bool {
    static bool skb_is_swtx_tstamp(const struct sk_buff *skb, int false_tstamp)
    {
    return skb.tstamp && !false_tstamp && skb_is_err_queue(skb);
    }
#[no_mangle]
unsafe extern "C" fn get_timestamp(sk: *mut sock, skb: *mut sk_buff, if_index: *mut c_int) -> ktime_t {
    static ktime_t get_timestamp(struct sock *sk, struct sk_buff *skb, int *if_index)
    {
    let mut cycles: bool = READ_ONCE(sk.sk_tsflags) & SOF_TIMESTAMPING_BIND_PHC;
...
#[no_mangle]
pub unsafe extern "C" fn skb_has_tx_timestamp(skb: *mut sk_buff, sk: *const sock) -> bool {
...
//
    ...
    struct sk_buff *skb)
    {
    let mut need_software_tstamp: c_int = sock_flag(sk, SOCK_RCVTSTAMP);
...
// We must use a bounce buffer for CONFIG_HARDENED_USERCOPY=y
    ...
    let mut priority: __u32 = skb.priority;
    ...
    size_t, int));
#[no_mangle]
unsafe extern "C" fn call_trace_sock_recv_length(sk: *mut sock, ret: c_int, flags: c_int) -> noinline void {
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_recvmsg(sock: *mut socket, msg: *mut msghdr, flags: c_int) -> c_int {
    int sock_recvmsg(struct socket *sock, struct msghdr *msg, int flags)
    {
    let mut err: c_int = security_socket_recvmsg(sock, msg, msg_data_left(msg), flags);
...
#[no_mangle]
unsafe extern "C" fn sock_splice_eof(file: *mut file) {
    static void sock_splice_eof(struct file *file)
    {
    struct socket *sock = file.private_data;
    const struct proto_ops *ops;
...
#[no_mangle]
unsafe extern "C" fn sock_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    static ssize_t sock_read_iter(struct kiocb *iocb, struct iov_iter *to)
    {
    struct file *file = iocb.ki_filp;
    struct socket *sock = file.private_data;
    let mut msg: msghdr = {.msg_iter = *to};
    ssize_t res;
...
#[no_mangle]
unsafe extern "C" fn sock_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
    static ssize_t sock_write_iter(struct kiocb *iocb, struct iov_iter *from)
    {
    struct file *file = iocb.ki_filp;
    struct socket *sock = file.private_data;
    let mut msg: msghdr = {.msg_iter = *from};
    ssize_t res;
    if (iocb.ki_pos != 0)
    return -ESPIPE;
    if (file.f_flags & O_NONBLOCK || (iocb.ki_flags & IOCB_NOWAIT))
...
#[no_mangle]
pub unsafe extern "C" fn br_ioctl_call(net: *mut net, cmd: c_uint, uarg: *mut void __user) -> c_int {
    int br_ioctl_call(struct net *net, unsigned int cmd, void __user *uarg)
    {
    let mut err: c_int = -ENOPKG;
    if (!br_ioctl_hook)
...
#[no_mangle]
pub unsafe extern "C" fn vlan_ioctl_set(: *mut *mut int (hook) (struct net, ): *mut void __user) {
...
//
#[no_mangle]
unsafe extern "C" fn sock_ioctl(file: *mut file, cmd: unsigned, arg: c_ulong) -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_create_lite(family: c_int, type: c_int, protocol: c_int, res: *mut socket) -> c_int {
    int sock_create_lite(int family, int type, int protocol, struct socket **res)
    {
    int err;
    struct socket *sock = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sock_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
    static __poll_t sock_poll(struct file *file, poll_table *wait)
    {
    struct socket *sock = file.private_data;
    const struct proto_ops *ops = READ_ONCE(sock.ops);
    let mut events: __poll_t = poll_requested_events(wait), flag = 0;
    if (!ops.poll)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn sock_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int sock_mmap(struct file *file, struct vm_area_struct *vma)
    {
    struct socket *sock = file.private_data;
...
#[no_mangle]
unsafe extern "C" fn sock_close(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sock_fasync(fd: c_int, filp: *mut file, on: c_int) -> c_int {
    static int sock_fasync(int fd, struct file *filp, int on)
    {
...
#[no_mangle]
pub unsafe extern "C" fn sock_wake_async(wq: *mut socket_wq, how: c_int, band: c_int) -> c_int {
...
//
    if (rcu_access_pointer(net_families[family]) == core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_create(family: c_int, type: c_int, protocol: c_int, res: *mut socket) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_create_kern(net: *mut net, family: c_int, type: c_int, protocol: c_int, res: *mut socket) -> c_int {
...
// Check the SOCK_* constants for consistency.
    ...
    return sock_alloc_file(sock, flags, core::ptr::null_mut());
    }
...
//
    __bpf_hook_start();
#[no_mangle]
pub unsafe extern "C" fn update_socket_protocol(family: c_int, type: c_int, protocol: c_int) -> __weak noinline int {
    ...
    __bpf_hook_end();
#[no_mangle]
pub unsafe extern "C" fn __sys_socket(family: c_int, type: c_int, protocol: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __sys_socketpair(family: c_int, type: c_int, protocol: c_int, usockvec: *mut int __user) -> c_int {
...
//
    ...
    newfile1 = sock_alloc_file(sock1, flags, core::ptr::null_mut());
    if (IS_ERR(newfile1)) {
    err = PTR_ERR(newfile1);
    sock_release(sock2);
    goto out;
    }
    newfile2 = sock_alloc_file(sock2, flags, core::ptr::null_mut());
    if (IS_ERR(newfile2)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __sys_bind(fd: c_int, umyaddr: *mut sockaddr __user, addrlen: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __sys_listen_socket(sock: *mut socket, backlog: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __sys_listen(fd: c_int, backlog: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __sys_connect(fd: c_int, uservaddr: *mut sockaddr __user, addrlen: c_int) -> c_int {
...
//
    ...
    msg.msg_namelen = 0;
    msg.msg_ubuf = core::ptr::null_mut();
    if (addr) {
...
//
    ...
    unsigned int, flags)
    {
    return __sys_sendto(fd, buff, len, flags, core::ptr::null_mut(), 0);
    }
//
...
// Save some cycles and don't copy the address if not needed
    .msg_name = addr ? (struct sockaddr *)&address : core::ptr::null_mut(),
    };
    struct socket *sock;
    int err, err2;
    ...
    if (err >= 0 && addr != core::ptr::null_mut()) {
...
//
    ...
    unsigned int, flags)
    {
    return __sys_recvfrom(fd, ubuf, size, flags, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn sock_use_custom_sol_socket(sock: *const socket) -> bool {
    ...
    {
    const struct proto_ops *ops;
    char *kernel_optval = core::ptr::null_mut();
    int err;
    if (optlen < 0)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unlikely(!ops->setsockopt)) -> else {
...
//
    ...
    int optlen)
    {
    let mut optval: sockptr_t = USER_SOCKPTR(user_optval);
...
//
    ...
    {
    let mut __maybe_unused: int max_optlen = 0;
    const struct proto_ops *ops;
    struct kvec kvec;
    sockopt_t opt;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn __sys_shutdown_sock(sock: *mut socket, how: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __sys_shutdown(fd: c_int, how: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct used_address {
    pub name: sockaddr_storage,
    pub name_len: c_uint,
}
...
//
    ...
    err = get_compat_msghdr(msg, msg_compat, core::ptr::null_mut(), iov);
    } else {
    err = copy_msghdr_from_user(msg, umsg, core::ptr::null_mut(), iov);
    }
    if (err < 0)
    return err;
    return 0;
...
//
    ...
    unsigned int flags)
    {
    return ____sys_sendmsg(sock, msg, flags, core::ptr::null_mut(), 0);
    }
    ...
    if (unlikely(!sock))
    return -ENOTSOCK;
    return ___sys_sendmsg(sock, msg, &msg_sys, flags, core::ptr::null_mut(), 0);
    }
...
//
    ...
    return do_recvmmsg(fd, mmsg, vlen, flags, core::ptr::null_mut());
    ...
    if (flags & MSG_CMSG_COMPAT)
    return -EINVAL;
    return __sys_recvmmsg(fd, mmsg, vlen, flags, timeout, core::ptr::null_mut());
    }
    ...
    if (flags & MSG_CMSG_COMPAT)
    return -EINVAL;
    return __sys_recvmmsg(fd, mmsg, vlen, flags, core::ptr::null_mut(), timeout);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_register(ops: *const net_proto_family) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sock_unregister(family: c_int) {
    void sock_unregister(int family)
    {
    BUG_ON(family < 0 || family >= NPROTO);
    spin_lock(&net_family_lock);
    RCU_INIT_POINTER(net_families[family], core::ptr::null_mut());
    spin_unlock(&net_family_lock);
    synchronize_rcu();
...
#[no_mangle]
pub unsafe extern "C" fn sock_is_registered(family: c_int) -> bool {
    bool sock_is_registered(int family)
    {
    return family < NPROTO && rcu_access_pointer(net_families[family]);
    }
#[no_mangle]
unsafe extern "C" fn sock_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn socket_seq_show(seq: *mut seq_file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_user_ifreq(ifr: *mut ifreq, ifrdata: *mut void __user, arg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn put_user_ifreq(ifr: *mut ifreq, arg: *mut void __user) -> c_int {
    int put_user_ifreq(struct ifreq *ifr, void __user *arg)
    {
    let mut size: usize = sizeof(*ifr);
    if (in_compat_syscall())
...
#[no_mangle]
unsafe extern "C" fn compat_siocwandev(net: *mut net, uifr32: *mut compat_ifreq __user) -> c_int {
    ...
    void __user *saved;
    int err;
    if (get_user_ifreq(&ifr, core::ptr::null_mut(), uifr32))
    return -EFAULT;
    if (get_user(uptr32, &uifr32.ifr_settings.ifs_ifsu))
    return -EFAULT;
    saved = ifr.ifr_settings.ifs_ifsu.raw_hdlc;
    ifr.ifr_settings.ifs_ifsu.raw_hdlc = compat_ptr(uptr32);
    err = dev_ioctl(net, SIOCWANDEV, &ifr, core::ptr::null_mut(), core::ptr::null_mut());
    if (!err) {
...
// Handle ioctls that use ifreq::ifr_data and just need struct ifreq converted
    ...
    return -EFAULT;
    ifreq.ifr_data = data;
    return dev_ioctl(net, cmd, &ifreq, data, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_bind(sock: *mut socket, addr: *mut sockaddr_unsized, addrlen: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_accept(sock: *mut socket, newsock: *mut socket, flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_getsockname(sock: *mut socket, addr: *mut sockaddr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_getpeername(sock: *mut socket, addr: *mut sockaddr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_sock_shutdown(sock: *mut socket, how: enum sock_shutdown_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_sock_ip_overhead(sk: *mut sock) -> u32 {
    ...
    struct ipv6_txoptions *optv6 = core::ptr::null_mut();
