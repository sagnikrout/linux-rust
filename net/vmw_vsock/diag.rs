...
#[no_mangle]
unsafe extern "C" fn vsock_diag_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_diag_handler_dump(skb: *mut sk_buff, h: *mut nlmsghdr) -> c_int {
    static int vsock_diag_handler_dump(struct sk_buff *skb, struct nlmsghdr *h)
    {
    let mut hdrlen: c_int = sizeof(struct vsock_diag_req);
...
#[no_mangle]
unsafe extern "C" fn vsock_diag_init() -> int __init {
    static int __init vsock_diag_init(void)
    {
    return sock_diag_register(&vsock_diag_handler);
    }
#[no_mangle]
unsafe extern "C" fn vsock_diag_exit() -> void __exit {
