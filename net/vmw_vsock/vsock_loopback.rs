...
//! Source: net/vmw_vsock/vsock_loopback.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vsock_loopback {
    pub workqueue: *mut workqueue_struct,
    pub pkt_queue: sk_buff_head,
    pub pkt_work: work_struct,
}

    static struct vsock_loopback the_vsock_loopback;
#[no_mangle]
unsafe extern "C" fn vsock_loopback_get_local_cid() -> u32 {
    static u32 vsock_loopback_get_local_cid(void)
    {
    return VMADDR_CID_LOCAL;
    }
#[no_mangle]
unsafe extern "C" fn vsock_loopback_send_pkt(skb: *mut sk_buff, net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_loopback_cancel_pkt(vsk: *mut vsock_sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_loopback_msgzerocopy_allow() -> bool {
...
#[no_mangle]
unsafe extern "C" fn vsock_loopback_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn vsock_loopback_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vsock_loopback_exit() -> void __exit {
