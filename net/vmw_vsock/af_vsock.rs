...
//! Source: net/vmw_vsock/af_vsock.c
#![no_std]
...
//
pub const VSOCK_NET_MODE_STR_MAX: c_int = 8;
...
pub const VSOCK_DEFAULT_BUFFER_MIN_SIZE: c_int = 128;
...
//
pub const MAX_PORT_RETRIES: c_int = 24;
...
#[no_mangle]
unsafe extern "C" fn vsock_auto_bind(vsk: *mut vsock_sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_init_tables() {
...
#[no_mangle]
unsafe extern "C" fn __vsock_remove_bound(vsk: *mut vsock_sock) {
...
#[no_mangle]
unsafe extern "C" fn __vsock_remove_connected(vsk: *mut vsock_sock) {
...
#[no_mangle]
unsafe extern "C" fn vsock_insert_unbound(vsk: *mut vsock_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_insert_connected(vsk: *mut vsock_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_remove_bound(vsk: *mut vsock_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_remove_connected(vsk: *mut vsock_sock) {
...
//
    ...
    {
    return vsock_find_bound_socket_net(addr, core::ptr::null_mut());
    }
...
//
    ...
    struct sockaddr_vm *dst)
    {
    return vsock_find_connected_socket_net(src, dst, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn vsock_remove_sock(vsk: *mut vsock_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_add_pending(listener: *mut sock, pending: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_remove_pending(listener: *mut sock, pending: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_pending_to_accept(listener: *mut sock, pending: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_enqueue_accept(listener: *mut sock, connected: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn vsock_use_local_transport(remote_cid: c_uint) -> bool {
    ...
    return true;
    if (transport_g2h) {
    let mut remote_cid: return = = transport_g2h.get_local_cid();
    } else {
    let mut remote_cid: return = = VMADDR_CID_HOST;
    }
    }
#[no_mangle]
unsafe extern "C" fn vsock_deassign_transport(vsk: *mut vsock_sock) {
    ...
    vsk.transport = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn vsock_assign_transport(vsk: *mut vsock_sock, psk: *mut vsock_sock) -> c_int {
    int vsock_assign_transport(struct vsock_sock *vsk, struct vsock_sock *psk)
    {
    const struct vsock_transport *new_transport;
    struct sock *sk = sk_vsock(vsk);
    let mut remote_cid: c_uint = vsk.remote_addr.svm_cid;
    __u8 remote_flags;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn vsock_registered_transport_cid(transport: *const vsock_transport) -> u32 {
    static u32 vsock_registered_transport_cid(const struct vsock_transport **transport)
    {
    let mut cid: u32 = VMADDR_CID_ANY;
    mutex_lock(&vsock_register_mutex);
    if (*transport)
...
#[no_mangle]
pub unsafe extern "C" fn vsock_find_cid(cid: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vsock_is_accept_queue_empty(sk: *mut sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vsock_is_pending(sk: *mut sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vsock_send_shutdown(sk: *mut sock, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_pending_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __vsock_bind(sk: *mut sock, addr: *mut sockaddr_vm) -> c_int {
    static int __vsock_bind(struct sock *sk, struct sockaddr_vm *addr)
    {
    struct vsock_sock *vsk = vsock_sk(sk);
    int retval;
...
//
    ...
    vsk.listener = core::ptr::null_mut();
    ...
    psk = parent ? vsock_sk(parent) : core::ptr::null_mut();
    if (parent) {
...
#[no_mangle]
unsafe extern "C" fn sock_type_connectible(type: u16) -> bool {
    static bool sock_type_connectible(u16 type)
    {
    return (type == SOCK_STREAM) || (type == SOCK_SEQPACKET);
    }
#[no_mangle]
unsafe extern "C" fn __vsock_release(sk: *mut sock, level: c_int) {
    static void __vsock_release(struct sock *sk, int level)
    {
    struct vsock_sock *vsk;
    struct sock *pending;
    vsk = vsock_sk(sk);
    pending = core::ptr::null_mut();	/* Compiler warning. */
...
//
    ...
    vsk.transport.release(vsk);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sock_type_connectible(sk->sk_type)) -> else {
...
// Clean up any sockets that never were accepted.
    while ((pending = vsock_dequeue_accept(sk)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn vsock_sk_destruct(sk: *mut sock) {
    static void vsock_sk_destruct(struct sock *sk)
    {
    struct vsock_sock *vsk = vsock_sk(sk);
...
#[no_mangle]
unsafe extern "C" fn vsock_queue_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int vsock_queue_rcv_skb(struct sock *sk, struct sk_buff *skb)
    {
    int err;
    ...
    {
    return __vsock_create(sock_net(parent), core::ptr::null_mut(), parent, GFP_KERNEL,
    parent.sk_type, 0);
    }
    EXPORT_SYMBOL_GPL(vsock_create_connected);
#[no_mangle]
pub unsafe extern "C" fn vsock_stream_has_data(vsk: *mut vsock_sock) -> i64 {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_connectible_has_data(vsk: *mut vsock_sock) -> i64 {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_stream_has_space(vsk: *mut vsock_sock) -> i64 {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_data_ready(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn vsock_close(sk: *mut sock, timeout: c_long) {
    static void vsock_close(struct sock *sk, long timeout)
    {
    }
#[no_mangle]
unsafe extern "C" fn vsock_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_linger(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn vsock_shutdown(sock: *mut socket, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_poll_shutdown(sk: *mut sock, peer_shutdown: u32) -> __poll_t {
...
// Signify that there has been an error on this socket.
    ...
    let mut peer_shutdown: u32 = READ_ONCE(vsk.peer_shutdown);
...
// If there is something in the queue then we can read.
    ...
    !(sk.sk_shutdown & RCV_SHUTDOWN)) {
    let mut data_ready_now: bool = false;
...
// Connected sockets that can produce data can be written.
    ...
    if (!(sk.sk_shutdown & SEND_SHUTDOWN)) {
    let mut space_avail_now: bool = false;
...
#[no_mangle]
unsafe extern "C" fn vsock_read_skb(sk: *mut sock, read_actor: skb_read_actor_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_transport_cancel_pkt(vsk: *mut vsock_sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsock_connect_timeout(work: *mut work_struct) {
    static void vsock_connect_timeout(struct work_struct *work)
    {
    struct sock *sk;
    struct vsock_sock *vsk;
...
// Set the remote address that we are connecting to.
    ...
    err = vsock_assign_transport(vsk, core::ptr::null_mut());
    if (err)
    goto out;
    transport = vsk.transport;
...
//
    ...
    while ((connected = vsock_dequeue_accept(listener)) == core::ptr::null_mut() &&
    timeout != 0) {
...
#[no_mangle]
unsafe extern "C" fn vsock_listen(sock: *mut socket, backlog: c_int) -> c_int {
...
//
    ...
    let mut lv: c_int = sizeof(v.val64);
    int len;
    if (level != AF_VSOCK)
    return -ENOPROTOOPT;
    len = opt.optlen;
...
//
    ...
    err = -sk.sk_err;
#[no_mangle]
pub unsafe extern "C" fn if(RCV_SHUTDOWN: sk->sk_shutdown &) -> else {
    ...
    transport = vsk.transport;
    timeout = sock_rcvtimeo(sk, flags & MSG_DONTWAIT);
    err = vsock_connectible_wait_data(sk, &wait, timeout, core::ptr::null_mut(), 0);
    if (err <= 0)
    goto out;
...
#[no_mangle]
unsafe extern "C" fn vsock_set_rcvlowat(sk: *mut sock, val: c_int) -> c_int {
    ...
    sock.state = SS_UNCONNECTED;
    sk = __vsock_create(net, sock, core::ptr::null_mut(), GFP_KERNEL, 0, kern);
    if (!sk)
    return -ENOMEM;
    vsk = vsock_sk(sk);
    if (sock.type == SOCK_DGRAM) {
    ret = vsock_assign_transport(vsk, core::ptr::null_mut());
    if (ret < 0) {
    sock.sk = core::ptr::null_mut();
    sock_put(sk);
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(data, _arg: VSOCK_NET_MODE_STR_LOCAL, _arg: sizeof(data))) -> else {
...
// new_mode = VSOCK_NET_MODE_LOCAL;
    ...
    vsock_net_mode(net), core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn vsock_sysctl_register(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn vsock_sysctl_unregister(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn vsock_net_init(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn vsock_sysctl_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn vsock_sysctl_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn vsock_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vsock_exit() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn vsock_core_register(t: *const vsock_transport, features: c_int) -> c_int {
    int vsock_core_register(const struct vsock_transport *t, int features)
    {
    const struct vsock_transport *t_h2g, *t_g2h, *t_dgram, *t_local;
    let mut err: c_int = mutex_lock_interruptible(&vsock_register_mutex);
    if (err)
    return err;
    t_h2g = transport_h2g;
    t_g2h = transport_g2h;
...
#[no_mangle]
pub unsafe extern "C" fn vsock_core_unregister(t: *const vsock_transport) {
    void vsock_core_unregister(const struct vsock_transport *t)
    {
    mutex_lock(&vsock_register_mutex);
    if (transport_h2g == t)
    transport_h2g = core::ptr::null_mut();
    if (transport_g2h == t)
    transport_g2h = core::ptr::null_mut();
    if (transport_dgram == t)
    transport_dgram = core::ptr::null_mut();
    if (transport_local == t)
    transport_local = core::ptr::null_mut();
    mutex_unlock(&vsock_register_mutex);
    }
