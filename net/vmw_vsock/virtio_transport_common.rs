...
//! Source: net/vmw_vsock/virtio_transport_common.c
#![no_std]
...
// Check that transport can send data in zerocopy mode.
    ...
    let mut pages_to_send: c_int = iov_iter_npages(iov_iter, MAX_SKB_FRAGS);
// +1 is for packet header.
    ...
    if (zcopy)
    return __zerocopy_sg_from_iter(msg, core::ptr::null_mut(), skb,
    &msg.msg_iter, len, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_deliver_tap_pkt(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_get_type(sk: *mut sock) -> u16 {
...
//
    ...
    struct virtio_vsock_pkt_info *info)
    {
    let mut max_skb_len: u32 = VIRTIO_VSOCK_MAX_PKT_BUF_SIZE;
    u32 src_cid, src_port, dst_cid, dst_port;
    const struct virtio_transport *t_ops;
    struct iov_iter_state msg_iter_state;
    struct virtio_vsock_sock *vvs;
    struct ubuf_info *uarg = core::ptr::null_mut();
    let mut pkt_len: u32 = info.pkt_len;
    let mut can_zcopy: bool = false;
    let mut have_uref: bool = false;
    u32 rest_len;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_can_collapse(skb: *mut sk_buff) -> bool {
...
//
    ...
    {
    let mut target: c_uint = skb.len - VIRTIO_VSOCK_SKB_CB(skb).offset;
    while ((skb = skb_peek_next(skb, queue)) &&
    virtio_transport_can_collapse(skb)) {
    let mut len: c_uint = skb.len - VIRTIO_VSOCK_SKB_CB(skb).offset;
...
//
    ...
    u32 min_to_free)
    {
    struct sk_buff *skb, *next_skb, *new_skb = core::ptr::null_mut();
    struct sk_buff_head new_queue;
    let mut saved: u32 = 0;
    __skb_queue_head_init(&new_queue);
    skb_queue_walk_safe(&vvs.rx_queue, skb, next_skb) {
    struct virtio_vsock_hdr *hdr = virtio_vsock_hdr(skb);
    let mut src_off: u32 = VIRTIO_VSOCK_SKB_CB(skb).offset;
    let mut src_len: u32 = skb.len - src_off;
    bool keep;
...
//
    ...
    u32 len)
    {
    let mut skb_overhead: u64 = (skb_queue_len(&vvs.rx_queue) + 1) * SKB_TRUESIZE(0);
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_inc_tx_pkt(vvs: *mut virtio_vsock_sock, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_consume_skb_sent(skb: *mut sk_buff, consume: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_get_credit(vvs: *mut virtio_vsock_sock, credit: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_put_credit(vvs: *mut virtio_vsock_sock, credit: u32) {
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_send_credit_update(vsk: *mut vsock_sock) -> c_int {
...
//
    ...
    {
    struct virtio_vsock_sock *vvs = vsk.trans;
    let mut dequeued_len: c_int = 0;
    let mut user_buf_len: usize = msg_data_left(msg);
    let mut msg_ready: bool = false;
    struct sk_buff *skb;
    spin_lock_bh(&vvs.rx_lock);
    if (vvs.msg_count == 0) {
    spin_unlock_bh(&vvs.rx_lock);
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_tx_buf_size(vvs: *mut virtio_vsock_sock) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_stream_has_data(vsk: *mut vsock_sock) -> i64 {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_seqpacket_has_data(vsk: *mut vsock_sock) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_has_space(vvs: *mut virtio_vsock_sock) -> i64 {
    static s64 virtio_transport_has_space(struct virtio_vsock_sock *vvs)
    {
    s64 bytes;
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_stream_has_space(vsk: *mut vsock_sock) -> i64 {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_notify_buffer_size(vsk: *mut vsock_sock, val: *mut u64) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: free_space ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_stream_rcvhiwat(vsk: *mut vsock_sock) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_stream_is_active(vsk: *mut vsock_sock) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_dgram_allow(vsk: *mut vsock_sock, cid: u32, port: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_connect(vsk: *mut vsock_sock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_shutdown(vsk: *mut vsock_sock, mode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_destruct(vsk: *mut vsock_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_unsent_bytes(vsk: *mut vsock_sock) -> isize {
...
// Send RST only if the original pkt is not a RST pkt
    ...
    if (!t)
    return -ENOTCONN;
    reply = virtio_transport_alloc_skb(&info, 0, false, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_remove_sock(vsk: *mut vsock_sock) {
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_close_timeout(work: *mut work_struct) {
    ...
    (void)virtio_transport_reset(vsk, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_close(vsk: *mut vsock_sock) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_release(vsk: *mut vsock_sock) {
    void virtio_transport_release(struct vsock_sock *vsk)
    {
    struct sock *sk = &vsk.sk;
    let mut remove_sock: bool = true;
...
#[no_mangle]
unsafe extern "C" fn virtio_transport_valid_type(type: u16) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_purge_skbs(vsk: *mut c_void, queue: *mut sk_buff_head) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_read_skb(vsk: *mut vsock_sock, recv_actor: skb_read_actor_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_transport_notify_set_rcvlowat(vsk: *mut vsock_sock, val: c_int) -> c_int {
