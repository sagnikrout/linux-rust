...
//! Source: net/ipv6/xfrm6_policy.c
#![no_std]
...
//
    ...
    fl6.uli = params.uli;
    dst = ip6_route_output(params.net, core::ptr::null_mut(), &fl6);
    err = dst.error;
    if (dst.error) {
    dst_release(dst);
    dst = ERR_PTR(err);
...
#[no_mangle]
unsafe extern "C" fn xfrm6_dst_destroy(dst: *mut dst_entry) {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_dst_ifdown(dst: *mut dst_entry, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_policy_init() -> int __init {
    static int __init xfrm6_policy_init(void)
    {
    return xfrm_policy_register_afinfo(&xfrm6_policy_afinfo, AF_INET6);
    }
#[no_mangle]
unsafe extern "C" fn xfrm6_policy_fini() {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_net_sysctl_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_net_sysctl_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm6_net_sysctl_init(net: *mut net) -> c_int {
    static inline int xfrm6_net_sysctl_init(struct net *net)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn xfrm6_net_sysctl_exit(net: *mut net) {
    static inline void xfrm6_net_sysctl_exit(struct net *net)
    {
    }

#[no_mangle]
unsafe extern "C" fn xfrm6_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm6_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm6_fini() {
