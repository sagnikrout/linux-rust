...
//
    ...
    {
    let mut offset: c_int = sk.sk_prot.ipv6_pinfo_offset;
...
//
    ...
    inet.mc_ttl	= 1;
    inet.mc_index	= 0;
    RCU_INIT_POINTER(inet.mc_list, core::ptr::null_mut());
    inet.rcv_tos	= 0;
...
#[no_mangle]
pub unsafe extern "C" fn inet6_bind_sk(sk: *mut sock, uaddr: *mut sockaddr_unsized, addr_len: c_int) -> c_int {
...
// bind for INET6 API
#[no_mangle]
pub unsafe extern "C" fn inet6_bind(sock: *mut socket, uaddr: *mut sockaddr_unsized, addr_len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_cleanup_sock(sk: *mut sock) {
...
// Release rx options
    skb = xchg(&np.pktoptions, core::ptr::null_mut());
    kfree_skb(skb);
    skb = xchg(&np.rxpmtu, core::ptr::null_mut());
    kfree_skb(skb);
// Free flowlabels
    fl6_free_socklist(sk);
// Free tx options
    opt = unrcu_pointer(xchg(&np.opt, core::ptr::null_mut()));
    if (opt) {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_ioctl(sock: *mut socket, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_compat_ioctl(sock: *mut socket, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_sendmsg(sock: *mut socket, msg: *mut msghdr, size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_register_protosw(p: *mut inet_protosw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_sk_rebuild_header(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_packet_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipv6_packet_cleanup() {
    static void ipv6_packet_cleanup(void)
    {
    dev_remove_pack(&ipv6_packet_type);
    }
#[no_mangle]
unsafe extern "C" fn ipv6_init_mibs(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipv6_cleanup_mibs(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn inet6_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn inet6_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn inet6_init() -> int __init {
