...
pub struct fib6_rule {
    ...
    pub /: *mut *mut u8 dscp_full:1; / DSCP or TOS selector,
}

#[no_mangle]
unsafe extern "C" fn fib6_rule_matchall(rule: *const fib_rule) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_rules_seq_read(net: *const net) -> c_uint {
...
//
    ...
    struct fib6_table *table;
    struct net *net = rule.fr_net;
    let mut lookup: pol_lookup_t = arg.lookup_ptr;
    let mut err: c_int = 0;
    u32 tb_id;
    switch (rule.action) {
    case FR_ACT_TO_TBL:
...
//
    ...
    if (NL_REQ_ATTR_CHECK(extack, core::ptr::null_mut(), tb, FRA_FLOWLABEL) ||
    NL_REQ_ATTR_CHECK(extack, core::ptr::null_mut(), tb, FRA_FLOWLABEL_MASK))
    return -EINVAL;
    ...
    if (fib6_new_table(net, rule.table) == core::ptr::null_mut()) {
    err = -ENOBUFS;
    goto errout;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn fib6_rule_delete(rule: *mut fib_rule) {
...
#[no_mangle]
unsafe extern "C" fn fib6_rule_nlmsg_payload(rule: *mut fib_rule) -> usize {
...
#[no_mangle]
unsafe extern "C" fn fib6_rule_flush_cache(ops: *mut fib_rules_ops) {
...
#[no_mangle]
unsafe extern "C" fn fib6_rules_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn fib6_rules_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_rules_init() -> int __init {
    int __init fib6_rules_init(void)
    {
    return register_pernet_subsys(&fib6_rules_net_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn fib6_rules_cleanup() {
