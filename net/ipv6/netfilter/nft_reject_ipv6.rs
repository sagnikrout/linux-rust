...
//! Source: net/ipv6/netfilter/nft_reject_ipv6.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nft_reject_ipv6_module_init() -> int __init {
    static int __init nft_reject_ipv6_module_init(void)
    {
    return nft_register_expr(&nft_reject_ipv6_type);
    }
#[no_mangle]
unsafe extern "C" fn nft_reject_ipv6_module_exit() -> void __exit {
