...
//! Source: net/ipv6/netfilter/nf_conntrack_reasm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nf_ct_frag6_sysctl_register(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_frags6_sysctl_unregister(net: *mut net) -> void __net_exit {
...
//
    ...
    let mut netoff: c_int = skb_network_offset(skb);
    let mut prev_nhoff: u8 = netoff + offsetof(struct ipv6hdr, nexthdr);
    let mut start: c_int = netoff + sizeof(struct ipv6hdr);
    let mut len: c_int = skb.len - start;
    let mut prevhdr: u8 = NEXTHDR_IPV6;
...
pub unsafe extern "C" fn nf_ct_frag6_gather(net: *mut net, skb: *mut sk_buff, user: u32) -> c_int {
    ...
    {
    let mut savethdr: u16 = skb.transport_header;
    let mut nexthdr: u8 = NEXTHDR_FRAGMENT;
    int fhoff, nhoff, ret;
...
#[no_mangle]
unsafe extern "C" fn nf_ct_net_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_net_pre_exit(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn nf_ct_net_exit(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_frag6_init() -> c_int {
    int nf_ct_frag6_init(void)
    {
    let mut ret: c_int = 0;
    nf_frags.constructor = ip6frag_init;
    nf_frags.destructor = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nf_ct_frag6_cleanup() {
