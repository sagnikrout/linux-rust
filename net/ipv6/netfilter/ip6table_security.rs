...
//! Source: net/ipv6/netfilter/ip6table_security.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ip6table_security_table_init(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip6table_security_net_pre_exit(net: *mut net) -> void __net_exit {
    static void __net_exit ip6table_security_net_pre_exit(struct net *net)
    {
    xt_unregister_table_pre_exit(net, NFPROTO_IPV6, "security");
    }
#[no_mangle]
unsafe extern "C" fn ip6table_security_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ip6table_security_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ip6table_security_fini() -> void __exit {
