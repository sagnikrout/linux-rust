...
//! Source: net/ipv6/netfilter/ip6table_nat.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ip6t_nat_register_lookups(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip6t_nat_unregister_lookups(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn ip6table_nat_net_pre_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ip6table_nat_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ip6table_nat_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ip6table_nat_exit() -> void __exit {
