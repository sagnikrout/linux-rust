...
//! Source: net/ipv6/esp6_offload.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn esp6_nexthdr_esp_offset(ipv6_hdr: *mut ipv6hdr, nhlen: c_int) -> __u16 {
    static __u16 esp6_nexthdr_esp_offset(struct ipv6hdr *ipv6_hdr, int nhlen)
    {
    let mut off: c_int = sizeof(struct ipv6hdr);
...
// ESP or ESPINUDP
    ...
    struct sk_buff *skb)
    {
    let mut offset: c_int = skb_gro_offset(skb);
    struct xfrm_offload *xo;
    struct xfrm_state *x;
    let mut encap_type: c_int = 0;
    __be32 seq;
    __be32 spi;
    int nhoff;
...
#[no_mangle]
unsafe extern "C" fn esp6_gso_encap(x: *mut xfrm_state, skb: *mut sk_buff) {
    static void esp6_gso_encap(struct xfrm_state *x, struct sk_buff *skb)
    {
    struct ip_esp_hdr *esph;
    struct ipv6hdr *iph = ipv6_hdr(skb);
    struct xfrm_offload *xo = xfrm_offload(skb);
    let mut proto: u8 = iph.nexthdr;
...
// skb_mac_header(skb) = IPPROTO_ESP;
    ...
    NETIF_F_SCTP_CRC);
#[no_mangle]
pub unsafe extern "C" fn if(NETIF_F_HW_ESP_TX_CSUM): !(features &) -> else {
...
#[no_mangle]
unsafe extern "C" fn esp6_input_tail(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp6_xmit(x: *mut xfrm_state, skb: *mut sk_buff, features: netdev_features_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp6_offload_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn esp6_offload_exit() -> void __exit {
