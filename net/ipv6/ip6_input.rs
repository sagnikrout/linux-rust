...
#[no_mangle]
unsafe extern "C" fn tcp_v6_early_demux(skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn ip6_rcv_finish(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip6_sublist_rcv_finish(head: *mut list_head) {
    ...
    {
    struct sk_buff *skb, *next, *hint = core::ptr::null_mut();
    struct dst_entry *curr_dst = core::ptr::null_mut();
    LIST_HEAD(sublist);
    list_for_each_entry_safe(skb, next, head, list) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_rcv(skb: *mut sk_buff, dev: *mut net_device, pt: *mut packet_type, orig_dev: *mut net_device) -> c_int {
    ...
    net, core::ptr::null_mut(), skb, dev, core::ptr::null_mut(),
    ip6_rcv_finish);
    }
    static void ip6_sublist_rcv(struct list_head *head, struct net_device *dev,
    struct net *net)
    {
    NF_HOOK_LIST(NFPROTO_IPV6, NF_INET_PRE_ROUTING, net, core::ptr::null_mut(),
    head, dev, core::ptr::null_mut(), ip6_rcv_finish);
...
// Receive a list of IPv6 packets
    ...
    {
    struct net_device *curr_dev = core::ptr::null_mut();
    struct net *curr_net = core::ptr::null_mut();
    struct sk_buff *skb, *next;
    LIST_HEAD(sublist);
    list_for_each_entry_safe(skb, next, head, list) {
...
//
    ...
    bool have_final)
    {
    let mut exthdr_cnt: c_int = IP6CB(skb).flags & IP6SKB_HOPBYHOP ? 1 : 0;
...
#[no_mangle]
unsafe extern "C" fn ip6_input_finish(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
pub unsafe extern "C" fn ip6_input(skb: *mut sk_buff) -> c_int {
    ...
    dev_net_rcu(skb.dev), core::ptr::null_mut(), skb, skb.dev, core::ptr::null_mut(),
    ip6_input_finish);
    rcu_read_unlock();
    return res;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ip6_mc_input(skb: *mut sk_buff) -> c_int {
...
// skb->dev passed may be master dev for vrfs.
    ...
    hdr = ipv6_hdr(skb);
    deliver = ipv6_chk_mcast_addr(dev, &hdr.daddr, core::ptr::null_mut());
