...
#[no_mangle]
unsafe extern "C" fn inet6_sk_rx_dst_set(sk: *mut sock, skb: *const sk_buff) {
...
//
    ...
    struct in6_addr *saddr = core::ptr::null_mut(), *final_p;
...
//
    ...
    let mut exthdrlen: u32 = icsk.icsk_ext_hdr_len;
...
// set the source address
    ...
    dst.ops.update_pmtu(dst, sk, core::ptr::null_mut(), mtu, true);
    dst = inet6_csk_route_socket(sk, fl6);
    return IS_ERR(dst) ? core::ptr::null_mut() : dst;
    }
#[no_mangle]
unsafe extern "C" fn tcp_v6_mtu_reduced(sk: *mut sock) {
...
//
    ...
    u8 tclass;
// First, grab a route.
    if (!dst && (dst = inet6_csk_route_req(sk, core::ptr::null_mut(), fl6, req,
    IPPROTO_TCP)) == core::ptr::null_mut())
    goto done;
...
#[no_mangle]
unsafe extern "C" fn tcp_v6_reqsk_destructor(req: *mut request_sock) {
...
//
    ...
    u32 tw_isn)
    {
    let mut l3_slave: bool = ipv6_l3mdev_skb(TCP_SKB_CB(skb).header.h6.flags);
    struct inet_request_sock *ireq = inet_rsk(req);
...
// So that link locals have meaning
    ...
    return core::ptr::null_mut();
    return inet6_csk_route_req(sk, core::ptr::null_mut(), &fl.u.ip6, req, IPPROTO_TCP);
    }
    ...
    let mut tot_len: c_uint = sizeof(struct tcphdr);
    struct sock *ctl_sk = net.ipv6.tcp_sk;
    const struct tcphdr *th = tcp_hdr(skb);
    let mut mrst: __be32 = 0, *topt;
    struct dst_entry *dst;
    struct sk_buff *buff;
    struct tcphdr *t1;
    struct flowi6 fl6;
...
//
    ...
    fl6.flowi6_uid = sock_net_uid(net, sk && sk_fullsock(sk) ? sk : core::ptr::null_mut());
...
//
    ...
    dst = ip6_dst_lookup_flow(net, sk, &fl6, core::ptr::null_mut()); /*sk's xfrm_policy can be referred*/
    else
    dst = ip6_dst_lookup_flow(net, ctl_sk, &fl6, core::ptr::null_mut());
    if (!IS_ERR(dst)) {
    skb_dst_set(buff, dst);
    ip6_xmit(ctl_sk, buff, &fl6, fl6.flowi6_mark, core::ptr::null_mut(),
    tclass, priority);
    ...
    let mut allocated_traffic_key: bool = false;

    const struct tcp_ao_hdr *aoh;
    let mut key: tcp_key = {};
    let mut seq: u32 = 0, ack_seq = 0;
    let mut label: __be32 = 0;
...
//
    ...
    let mut dif: c_int = tcp_v6_iif_l3_slave(skb);
    let mut sdif: c_int = tcp_v6_sdif(skb);
    int l3index;
//
...
//
    sk1 = inet6_lookup_listener(net, core::ptr::null_mut(), 0, &ipv6h.saddr, th.source,
...
//
    ...
    goto out;
    key.type = TCP_KEY_MD5;
    tcp_v6_md5_hash_skb(newhash, key.md5_key, core::ptr::null_mut(), skb);
    ...
    let mut tclass: u8 = tw.tw_tclass;
    let mut key: tcp_key = {};
...
//
    ...
    let mut l3index: c_int = tcp_v6_sdif(skb) ? tcp_v6_iif_l3_slave(skb) : 0;
...
#[no_mangle]
unsafe extern "C" fn tcp_v6_conn_request(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcp_v6_restore_cb(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn tcp_v6_mapped_child_init(newsk: *mut sock, sk: *const sock) {
    ...
    newnp.pktoptions  = core::ptr::null_mut();
    newnp.opt	   = core::ptr::null_mut();
...
// Clone pktoptions received with SYN, if we own the req
    ...
    ireq.pktopts = core::ptr::null_mut();
    if (newnp.pktoptions)
...
#[no_mangle]
pub unsafe extern "C" fn tcp_v6_do_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int tcp_v6_do_rcv(struct sock *sk, struct sk_buff *skb)
    {
    struct ipv6_pinfo *np = tcp_inet6_sk(sk);
    struct sk_buff *opt_skb = core::ptr::null_mut();
...
//
    ...
    dst, sk.sk_rx_dst_cookie) == core::ptr::null_mut()) {
...
//
    ...
    __kfree_skb(opt_skb);
    opt_skb = xchg(&np.pktoptions, core::ptr::null_mut());
    }
    }
    consume_skb(opt_skb);
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn tcp_v6_rcv(skb: *mut sk_buff) -> INDIRECT_CALLABLE_SCOPE int {
    INDIRECT_CALLABLE_SCOPE int tcp_v6_rcv(struct sk_buff *skb)
    {
    struct net *net = dev_net_rcu(skb.dev);
    enum skb_drop_reason drop_reason;
    enum tcp_tw_status tw_status;
    let mut sdif: c_int = inet6_sdif(skb);
    let mut dif: c_int = inet6_iif(skb);
    const struct tcphdr *th;
...
// min_hopcount can be changed concurrently from do_ipv6_setsockopt()
    ...
    drop_reason = tcp_inbound_hash(sk, core::ptr::null_mut(), skb, &hdr.saddr, &hdr.daddr,
    AF_INET6, dif, sdif);
    if (drop_reason)
    goto discard_and_relse;
    nf_reset_ct(skb);
    ...
    tcp_v6_send_reset(core::ptr::null_mut(), skb, sk_rst_convert_drop_reason(drop_reason));
    }
    discard_it:
...
#[no_mangle]
unsafe extern "C" fn tcp6_destruct_sock(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn tcp_v6_init_sock(sk: *mut sock) -> c_int {
...
// Proc filesystem TCPv6 sock list dumping.
    ...
    {
    let mut ttd: c_long = req.rsk_timer.expires - jiffies;
...
#[no_mangle]
unsafe extern "C" fn get_tcp6_sock(seq: *mut seq_file, sp: *mut sock, i: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tcp6_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcp6_proc_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn tcp6_proc_exit(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn tcpv6_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn tcpv6_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn tcpv6_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn tcpv6_exit() {
