...
//! Source: net/ipv6/seg6_iptunnel.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn seg6_lwt_headroom(tuninfo: *mut seg6_iptunnel_encap) -> usize {
...
#[derive(Copy, Clone)]
pub struct seg6_lwt {
    pub cache_input: dst_cache,
    pub cache_output: dst_cache,
    pub tunsrc: in6_addr,
    pub table: u32,
    pub tuninfo: [seg6_iptunnel_encap; ],
}
...
// Compute flowlabel for outer IPv6 header
    ...
    {
    let mut do_flowlabel: c_int = net.ipv6.sysctl.seg6_flowlabel;
    let mut flowlabel: __be32 = 0;
    u32 hash;
    if (do_flowlabel > 0) {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_do_srh_encap(skb: *mut sk_buff, osrh: *mut ipv6_sr_hdr, proto: c_int) -> c_int {
    int seg6_do_srh_encap(struct sk_buff *skb, struct ipv6_sr_hdr *osrh, int proto)
    {
    return __seg6_do_srh_encap(skb, osrh, proto, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
// encapsulate an IPv6 packet within an outer IPv6 header with reduced SRH
    ...
    struct in6_addr *route_tunsrc)
    {
    let mut first_seg: __u8 = osrh.first_segment;
    struct dst_entry *dst = skb_dst(skb);
    struct net_device *dev = dst_dev(dst);
    struct net *net = dev_net(dev);
    struct ipv6hdr *hdr, *inner_hdr;
    let mut hdrlen: c_int = ipv6_optlen(osrh);
    int red_tlv_offset, tlv_offset;
    struct ipv6_sr_hdr *isrh;
    let mut skip_srh: bool = false;
    __be32 flowlabel;
    int tot_len, err;
    int red_hdrlen;
    int tlvs_len;
...
#[no_mangle]
unsafe extern "C" fn seg6_do_srh(skb: *mut sk_buff, cache_dst: *mut dst_entry) -> c_int {
...
pub unsafe extern "C" fn seg6_do_srh_inline(skb: *mut sk_buff, osrh: *mut ipv6_sr_hdr) -> c_int {
    ...
    {
    return __seg6_do_srh_inline(skb, osrh, core::ptr::null_mut());
    }
...
// cache only if we don't create a dst reference loop
    ...
    dev_net(skb.dev), core::ptr::null_mut(), skb, core::ptr::null_mut(),
    skb_dst_dev(skb), seg6_input_finish);
    return seg6_input_finish(dev_net(skb.dev), core::ptr::null_mut(), skb);
    drop:
    kfree_skb(skb);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn seg6_input_nf(skb: *mut sk_buff) -> c_int {
    ...
    switch (skb.protocol) {
    case htons(ETH_P_IP):
    return NF_HOOK(NFPROTO_IPV4, NF_INET_POST_ROUTING, net, core::ptr::null_mut(),
    skb, core::ptr::null_mut(), dev, seg6_input_core);
    case htons(ETH_P_IPV6):
    return NF_HOOK(NFPROTO_IPV6, NF_INET_POST_ROUTING, net, core::ptr::null_mut(),
    skb, core::ptr::null_mut(), dev, seg6_input_core);
    }
    return -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn seg6_input(skb: *mut sk_buff) -> c_int {
    static int seg6_input(struct sk_buff *skb)
    {
    if (static_branch_unlikely(&nf_hooks_lwtunnel_enabled))
    return seg6_input_nf(skb);
    return seg6_input_core(dev_net(skb.dev), core::ptr::null_mut(), skb);
    }
...
// cache only if we don't create a dst reference loop
    ...
    core::ptr::null_mut(), dst_dev(dst), dst_output);
...
#[no_mangle]
unsafe extern "C" fn seg6_output_nf(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    core::ptr::null_mut(), dev, seg6_output_core);
    case htons(ETH_P_IPV6):
...
#[no_mangle]
unsafe extern "C" fn seg6_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_destroy_state(lwt: *mut lwtunnel_state) {
...
#[no_mangle]
unsafe extern "C" fn seg6_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_encap_cmp(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
    ...
    let mut len: c_int = SEG6_IPTUN_ENCAP_SIZE(a_hdr);
...
#[no_mangle]
pub unsafe extern "C" fn seg6_iptunnel_init() -> int __init {
    int __init seg6_iptunnel_init(void)
    {
    return lwtunnel_encap_add_ops(&seg6_iptun_ops, LWTUNNEL_ENCAP_SEG6);
    }
#[no_mangle]
pub unsafe extern "C" fn seg6_iptunnel_exit() {
