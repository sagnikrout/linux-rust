...
// Parse tlv encoded option header (hop-by-hop or destination)
    ...
    int max_count)
    {
    let mut len: c_int = (skb_transport_header(skb)[1] + 1) << 3;
    const unsigned char *nh = skb_network_header(skb);
    let mut off: c_int = skb_network_header_len(skb);
    let mut disallow_unknowns: bool = false;
    let mut tlv_count: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ipv6_dest_hao(skb: *mut sk_buff, optoff: c_int) -> bool {
    static bool ipv6_dest_hao(struct sk_buff *skb, int optoff)
    {
...
#[no_mangle]
unsafe extern "C" fn ipv6_destopt_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_update_csum(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_srh_rcv(skb: *mut sk_buff, idev: *mut inet6_dev) -> c_int {
    ...
    let mut offset: c_int = (hdr.hdrlen + 1) << 3;
...
#[no_mangle]
unsafe extern "C" fn ipv6_rpl_srh_rcv(skb: *mut sk_buff, idev: *mut inet6_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_rthdr_rcv(skb: *mut sk_buff) -> c_int {
    static int ipv6_rthdr_rcv(struct sk_buff *skb)
    {
    struct inet6_dev *idev = __in6_dev_get(skb.dev);
    struct inet6_skb_parm *opt = IP6CB(skb);
    struct in6_addr *addr = core::ptr::null_mut();
    int n, i;
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_exthdrs_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_exthdrs_exit() {
...
#[no_mangle]
unsafe extern "C" fn ipv6_hop_ra(skb: *mut sk_buff, optoff: c_int) -> bool {
    static bool ipv6_hop_ra(struct sk_buff *skb, int optoff)
    {
    const unsigned char *nh = skb_network_header(skb);
    if (nh[optoff + 1] == 2) {
...
// IOAM
#[no_mangle]
unsafe extern "C" fn ipv6_hop_ioam(skb: *mut sk_buff, optoff: c_int) -> bool {
    static bool ipv6_hop_ioam(struct sk_buff *skb, int optoff)
    {
...
// Jumbo payload
#[no_mangle]
unsafe extern "C" fn ipv6_hop_jumbo(skb: *mut sk_buff, optoff: c_int) -> bool {
    static bool ipv6_hop_jumbo(struct sk_buff *skb, int optoff)
    {
    const unsigned char *nh = skb_network_header(skb);
    SKB_DR(reason);
...
// CALIPSO RFC 5570
#[no_mangle]
unsafe extern "C" fn ipv6_hop_calipso(skb: *mut sk_buff, optoff: c_int) -> bool {
    static bool ipv6_hop_calipso(struct sk_buff *skb, int optoff)
    {
    const unsigned char *nh = skb_network_header(skb);
    if (nh[optoff + 1] < 8)
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_parse_hopopts(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_push_exthdr(skb: *mut sk_buff, proto: u8, type: u8, opt: *mut ipv6_opt_hdr) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_push_frag_opts(skb: *mut sk_buff, opt: *mut ipv6_txoptions, proto: u8) -> u8 {
    ...
    if (opt2) {
    let mut dif: c_long = (char *)opt2 - (char *)opt;
    if (opt2.hopopt)
...
//
    ...
    (opt ? opt.hopopt : core::ptr::null_mut()),
    newopt, newtype, &p);
    ipv6_renew_option(IPV6_RTHDRDSTOPTS, &opt2.dst0opt,
    (opt ? opt.dst0opt : core::ptr::null_mut()),
    newopt, newtype, &p);
    ipv6_renew_option(IPV6_RTHDR,
    (struct ipv6_opt_hdr **)&opt2.srcrt,
    (opt ? (struct ipv6_opt_hdr *)opt.srcrt : core::ptr::null_mut()),
    newopt, newtype, &p);
    ipv6_renew_option(IPV6_DSTOPTS, &opt2.dst1opt,
    (opt ? opt.dst1opt : core::ptr::null_mut()),
    newopt, newtype, &p);
