...
#[no_mangle]
pub unsafe extern "C" fn cookie_v6_init_sequence(skb: *const sk_buff, mssp: *mut __u16) -> __u32 {
...
#[no_mangle]
pub unsafe extern "C" fn __cookie_v6_check(iph: *const ipv6hdr, th: *const tcphdr) -> c_int {
