...
//
pub const IPV6_ADDR_LABEL_DEFAULT: c_uint = 0xffffffffUL;
...
// add a label
    ...
    int replace)
    {
    struct ip6addrlbl_entry *last = core::ptr::null_mut(), *p = core::ptr::null_mut();
    struct hlist_node *n;
    let mut ret: c_int = 0;
...
// remove a label
    ...
    int ifindex)
    {
    struct ip6addrlbl_entry *p = core::ptr::null_mut();
    struct hlist_node *n;
...
// add default label
#[no_mangle]
unsafe extern "C" fn ip6addrlbl_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ip6addrlbl_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_addr_label_init() -> int __init {
    int __init ipv6_addr_label_init(void)
    {
    return register_pernet_subsys(&ipv6_addr_label_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn ipv6_addr_label_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn addrlbl_ifindex_exists(net: *mut net, ifindex: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ip6addrlbl_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int ip6addrlbl_dump(struct sk_buff *skb, struct netlink_callback *cb)
    {
    const struct nlmsghdr *nlh = cb.nlh;
    struct net *net = sock_net(skb.sk);
    struct ip6addrlbl_entry *p;
    let mut idx: c_int = 0, s_idx = cb.args[0];
    let mut err: c_int = 0;
    u32 lseq;
    if (cb.strict_check) {
...
#[no_mangle]
pub unsafe extern "C" fn ip6addrlbl_msgsize() -> c_int {
    static inline int ip6addrlbl_msgsize(void)
    {
#[no_mangle]
pub unsafe extern "C" fn NLMSG_ALIGN(ifaddrlblmsg): sizeof(struct) -> return {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_addr_label_rtnl_register() -> int __init {
