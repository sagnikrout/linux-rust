...
// Label mapping cache
    let mut calipso_cache_enabled: c_int = 1;
    let mut calipso_cache_bucketsize: c_int = 10;
...
//
#[no_mangle]
unsafe extern "C" fn calipso_cache_entry_free(entry: *mut calipso_map_cache_entry) {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_map_cache_hash(key: *const c_uchar, key_len: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_cache_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_cache_invalidate() {
    static void calipso_cache_invalidate(void)
    {
...
//
    ...
    struct calipso_map_cache_entry *prev_entry = core::ptr::null_mut();
    u32 hash;
...
//
    ...
    u32 bkt;
    struct calipso_map_cache_entry *entry = core::ptr::null_mut();
    struct calipso_map_cache_entry *old_entry = core::ptr::null_mut();
    u32 calipso_ptr_len;
...
//
#[no_mangle]
unsafe extern "C" fn calipso_doi_free(doi_def: *mut calipso_doi) {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_doi_free_rcu(entry: *mut rcu_head) {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_doi_remove(doi: u32, audit_info: *mut netlbl_audit) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_doi_putdef(doi_def: *mut calipso_doi) {
    static void calipso_doi_putdef(struct calipso_doi *doi_def)
    {
    if (!doi_def)
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn calipso_validate(skb: *const sk_buff, option: *const c_uchar) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_opt_update(sk: *mut sock, hop: *mut ipv6_opt_hdr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_tlv_len(opt: *mut ipv6_opt_hdr, offset: c_uint) -> c_int {
    static int calipso_tlv_len(struct ipv6_opt_hdr *opt, unsigned int offset)
    {
    unsigned char *tlv = (unsigned char *)opt;
    let mut opt_len: c_uint = ipv6_optlen(opt), tlv_len;
...
//
    ...
    unsigned int *end)
    {
    let mut ret_val: c_int = -ENOENT, tlv_len;
...
//
#[no_mangle]
unsafe extern "C" fn calipso_sock_delattr(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_req_delattr(req: *mut request_sock) {
...
//
#[no_mangle]
unsafe extern "C" fn calipso_skbuff_delattr(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn calipso_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn calipso_exit() {
    void calipso_exit(void)
    {
    netlbl_calipso_ops_register(core::ptr::null_mut());
    calipso_cache_invalidate();
    kfree(calipso_cache);
    }
