...
//! Source: net/ipv6/xfrm6_protocol.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xfrm6_rcv_cb(skb: *mut sk_buff, protocol: u8, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_esp_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_ah_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm6_ipcomp_rcv(skb: *mut sk_buff) -> c_int {
    ...
    lockdep_is_held(&xfrm6_protocol_mutex))) != core::ptr::null_mut();
    pprev = &t.next) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm6_protocol_init() -> int __init {
