...
#[no_mangle]
unsafe extern "C" fn udpv6_destruct_sock(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn udpv6_init_sock(sk: *mut sock) -> c_int {
    ...
    lhash = ( u32)laddr.s6_addr32[3];
    fhash = __ipv6_addr_jhash(faddr, udp_ipv6_hash_secret);
    return __inet6_ehashfn(lhash, lport, fhash, fport,
    udp6_ehash_secret + net_hash_mix(net));
    }
#[no_mangle]
unsafe extern "C" fn udp_v6_get_port(sk: *mut sock, snum: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udp_v6_rehash(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn udp6_hash4(sk: *mut sock) {
...
// rcu_read_lock() must be held
    ...
    dif, sdif, udptable);
    if (result) /* udp6_lib_lookup4 return sk or core::ptr::null_mut() */
    return result;
    }
...
//
    ...
    {
    struct sock *sk;
    sk =  __udp6_lib_lookup(net, saddr, sport, daddr, dport, dif, 0, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn udp6_skb_len(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udpv6_encap_enable() {
...
#[no_mangle]
pub unsafe extern "C" fn if(NDISC_REDIRECT: type ==) -> else {
    ...
    inet6_iif(skb), inet6_sdif(skb), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __udpv6_queue_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udpv6_queue_rcv_one_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udpv6_queue_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udp6_csum_zero_error(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn udp6_sk_rx_dst_set(sk: *mut sock, dst: *mut dst_entry) {
...
#[no_mangle]
unsafe extern "C" fn udp6_csum_init(skb: *mut sk_buff, uh: *mut udphdr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udpv6_rcv(skb: *mut sk_buff) -> INDIRECT_CALLABLE_SCOPE int {
...
#[no_mangle]
pub unsafe extern "C" fn udp_v6_early_demux(skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn udp_v6_flush_pending_frames(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: up->pending) -> else {
    up.len = 0;
...
#[no_mangle]
unsafe extern "C" fn udp_v6_push_pending_frames(sk: *mut sock) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udpv6_sendmsg(sk: *mut sock, msg: *mut msghdr, len: usize) -> c_int {
    int udpv6_sendmsg(struct sock *sk, struct msghdr *msg, size_t len)
    {
    let mut corkreq: c_int = udp_test_bit(CORK, sk) || msg.msg_flags & MSG_MORE;
    DECLARE_SOCKADDR(struct sockaddr_in6 *, sin6, msg.msg_name);
    struct ipv6_txoptions *opt_to_free = core::ptr::null_mut();
    struct in6_addr *daddr, *final_p, final;
    struct ip6_flowlabel *flowlabel = core::ptr::null_mut();
    struct inet_sock *inet = inet_sk(sk);
    struct ipv6_pinfo *np = inet6_sk(sk);
    struct ipv6_txoptions *opt = core::ptr::null_mut();
    struct udp_sock *up = udp_sk(sk);
    struct ipv6_txoptions opt_space;
    let mut addr_len: c_int = msg.msg_namelen;
    struct inet_cork_full cork;
    struct ipcm6_cookie ipc6;
    let mut connected: bool = false;
    struct dst_entry *dst;
    struct flowi6 *fl6;
    let mut ulen: c_int = len;
    int err;
    fl6 = &cork.fl.u.ip6;
...
// destination address check
    ...
    goto do_udp_sendmsg;
    case AF_UNSPEC:
    msg.msg_name = sin6 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn udpv6_splice_eof(sock: *mut socket) {
...
#[no_mangle]
unsafe extern "C" fn udpv6_destroy_sock(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn udp6_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int udp6_seq_show(struct seq_file *seq, void *v)
    {
    if (v == SEQ_START_TOKEN) {
    seq_puts(seq, IPV6_SEQ_DGRAM_HEADER);
    } else {
    let mut bucket: c_int = ((struct udp_iter_state *)seq.private).bucket;
...
#[no_mangle]
pub unsafe extern "C" fn udp6_proc_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn udp6_proc_exit(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn udpv6_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn udpv6_exit() {
