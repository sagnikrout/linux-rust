...
pub const IPV6HDR_BASELEN: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tmp_ext {
...
#[no_mangle]
unsafe extern "C" fn zero_out_mutable_opts(opthdr: *mut ipv6_opt_hdr) -> bool {
    static bool zero_out_mutable_opts(struct ipv6_opt_hdr *opthdr)
    {
    u8 *opt = (u8 *)opthdr;
    let mut len: c_int = ipv6_optlen(opthdr);
    let mut off: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ipv6_rearrange_destopt(iph: *mut ipv6hdr, destopt: *mut ipv6_opt_hdr) {
    static void ipv6_rearrange_destopt(struct ipv6hdr *iph, struct ipv6_opt_hdr *destopt)
    {
    u8 *opt = (u8 *)destopt;
    let mut len: c_int = ipv6_optlen(destopt);
    let mut off: c_int = 0;
    let mut optlen: c_int = 0;
    off += 2;
    len -= 2;
...
//
#[no_mangle]
unsafe extern "C" fn ipv6_rearrange_rthdr(iph: *mut ipv6hdr, rthdr: *mut ipv6_rt_hdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_clear_mutable_options(iph: *mut ipv6hdr, len: c_int, dir: c_int) -> c_int {
    ...
    let mut nexthdr: c_int = iph.nexthdr;
    int err;
    exthdr.iph++;
...
#[no_mangle]
unsafe extern "C" fn ah6_output_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ah6_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ah6_input_done(data: *mut c_void, err: c_int) {
    ...
    let mut ah_hlen: c_int = ipv6_authlen(ah);
    let mut seqhi_len: c_int = 0;
    __be32 *seqhi;
    if (err)
    goto out;
...
#[no_mangle]
unsafe extern "C" fn ah6_input(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ah6_init_state(x: *mut xfrm_state, extack: *mut netlink_ext_ack) -> c_int {
    static int ah6_init_state(struct xfrm_state *x, struct netlink_ext_ack *extack)
    {
    struct ah_data *ahp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ah6_destroy(x: *mut xfrm_state) {
...
#[no_mangle]
unsafe extern "C" fn ah6_rcv_cb(skb: *mut sk_buff, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ah6_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ah6_fini() -> void __exit {
