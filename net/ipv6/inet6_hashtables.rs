...
//! Source: net/ipv6/inet6_hashtables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn inet6_init_ehash_secret() {
...
//
    ...
    a += ( u32)laddr.s6_addr32[0] ^ net_hash_mix(net);
    b += ( u32)laddr.s6_addr32[1];
    c += ( u32)laddr.s6_addr32[2];
    __jhash_mix(a, b, c);
    a += ( u32)laddr.s6_addr32[3];
    b += ( u32)faddr.s6_addr32[0];
    c += ( u32)faddr.s6_addr32[1];
    __jhash_mix(a, b, c);
    a += ( u32)faddr.s6_addr32[2];
    b += ( u32)faddr.s6_addr32[3];
    c += ( u32)fport;
    __jhash_final(a, b, c);
...
#[no_mangle]
unsafe extern "C" fn inet6_sk_port_offset(sk: *const sock) -> u64 {
