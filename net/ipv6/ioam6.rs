...
#[no_mangle]
unsafe extern "C" fn ioam6_ns_release(ns: *mut ioam6_namespace) {
    static void ioam6_ns_release(struct ioam6_namespace *ns)
    {
    kfree_rcu(ns, rcu);
    }
#[no_mangle]
unsafe extern "C" fn ioam6_sc_release(sc: *mut ioam6_schema) {
    static void ioam6_sc_release(struct ioam6_schema *sc)
    {
    kfree_rcu(sc, rcu);
    }
#[no_mangle]
unsafe extern "C" fn ioam6_free_ns(ptr: *mut c_void, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ioam6_free_sc(ptr: *mut c_void, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ioam6_ns_cmpfn(arg: *mut rhashtable_compare_arg, obj: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_sc_cmpfn(arg: *mut rhashtable_compare_arg, obj: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_addns(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_delns(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    goto out_unlock;
    if (sc)
    rcu_assign_pointer(sc.ns, core::ptr::null_mut());
    ioam6_ns_release(ns);
    out_unlock:
    mutex_unlock(&nsdata.lock);
    return err;
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_dumpns_start(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_dumpns_done(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_dumpns(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_addsc(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_delsc(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    goto out_unlock;
    if (ns)
    rcu_assign_pointer(ns.schema, core::ptr::null_mut());
    ioam6_sc_release(sc);
    out_unlock:
    mutex_unlock(&nsdata.lock);
    return err;
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_dumpsc_start(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_dumpsc_done(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_dumpsc(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_genl_ns_set_schema(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    lockdep_is_held(&nsdata.lock));
    if (sc_ref)
    rcu_assign_pointer(sc_ref.ns, core::ptr::null_mut());
    rcu_assign_pointer(ns.schema, sc);
    if (sc) {
    ns_ref = rcu_dereference_protected(sc.ns,
    lockdep_is_held(&nsdata.lock));
    if (ns_ref)
    rcu_assign_pointer(ns_ref.schema, core::ptr::null_mut());
...
pub const IOAM6_GENL_EV_GRP_OFFSET: c_int = 0;
...
pub const IOAM6_MASK_SHORT_FIELDS: c_uint = 0xff1ffc00;
pub const IOAM6_MASK_WIDE_FIELDS: c_uint = 0x00e00000;
#[no_mangle]
pub unsafe extern "C" fn ioam6_trace_compute_nodelen(trace_type: u32) -> u8 {
...
// Note: skb_dst_dev_rcu() can't be NULL at this point.
    ...
    i_skb_dev = skb.dev ? __in6_dev_get(skb.dev) : core::ptr::null_mut();
...
// ingress_if_id and egress_if_id
    ...
    raw16 = ( u16)READ_ONCE(i_skb_dev.cnf.ioam6_id);
// (__be16 *)data = cpu_to_be16(raw16);
    data += sizeof(__be16);
    if ((dev.flags & IFF_LOOPBACK) || !idev)
    raw16 = IOAM6_U16_UNAVAILABLE;
    else
    raw16 = ( u16)READ_ONCE(idev.cnf.ioam6_id);
// (__be16 *)data = cpu_to_be16(raw16);
    data += sizeof(__be16);
    }
// timestamp seconds
...
#[no_mangle]
unsafe extern "C" fn ioam6_net_init(net: *mut net) -> int __net_init {
    ...
    free_nsdata:
    kfree(nsdata);
    net.ipv6.ioam6_data = core::ptr::null_mut();
    goto out;
    }
#[no_mangle]
unsafe extern "C" fn ioam6_net_exit(net: *mut net) -> void __net_exit {
    static void __net_exit ioam6_net_exit(struct net *net)
    {
    struct ioam6_pernet_data *nsdata = ioam6_pernet(net);
    rhashtable_free_and_destroy(&nsdata.namespaces, ioam6_free_ns, core::ptr::null_mut());
    rhashtable_free_and_destroy(&nsdata.schemas, ioam6_free_sc, core::ptr::null_mut());
    kfree(nsdata);
    }
...
#[no_mangle]
pub unsafe extern "C" fn ioam6_init() -> int __init {
    int __init ioam6_init(void)
    {
    let mut err: c_int = register_pernet_subsys(&ioam6_net_ops);
    if (err)
    goto out;
...
#[no_mangle]
pub unsafe extern "C" fn ioam6_exit() {
