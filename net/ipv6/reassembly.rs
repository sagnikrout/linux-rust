...
#[no_mangle]
unsafe extern "C" fn ip6_frag_ecn(ipv6h: *const ipv6hdr) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ipv6_frag_rcv(skb: *mut sk_buff) -> c_int {
    ...
    u8 nexthdr;
    int iif;
    idev = skb.dev ? __in6_dev_stats_get(skb.dev, skb) : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ip6_frags_ns_sysctl_register(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ip6_frags_ns_sysctl_unregister(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ip6_frags_sysctl_register() -> c_int {
    static int ip6_frags_sysctl_register(void)
    {
    ip6_ctl_header = register_net_sysctl(&init_net, "net/ipv6",
    ip6_frags_ctl_table);
    let mut ip6_ctl_header: return = = core::ptr::null_mut() ? -ENOMEM : 0;
    }
#[no_mangle]
unsafe extern "C" fn ip6_frags_sysctl_unregister() {
...
#[no_mangle]
unsafe extern "C" fn ip6_frags_ns_sysctl_register(net: *mut net) -> c_int {
    static int ip6_frags_ns_sysctl_register(struct net *net)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ip6_frags_ns_sysctl_unregister(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_frags_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipv6_frags_pre_exit_net(net: *mut net) -> void __net_exit {
    static void __net_exit ipv6_frags_pre_exit_net(struct net *net)
    {
    fqdir_pre_exit(net.ipv6.fqdir);
    }
#[no_mangle]
unsafe extern "C" fn ipv6_frags_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_frag_init() -> int __init {
    int __init ipv6_frag_init(void)
    {
    int ret;
    ip6_frags.constructor = ip6frag_init;
    ip6_frags.destructor = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_frag_exit() {
