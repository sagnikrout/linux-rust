...
#[no_mangle]
pub unsafe extern "C" fn seg6_validate_srh(srh: *mut ipv6_sr_hdr, len: c_int, reduced: bool) -> bool {
    ...
    int len, srhoff = 0;
    if (ipv6_find_hdr(skb, &srhoff, IPPROTO_ROUTING, core::ptr::null_mut(), &flags) < 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn seg6_icmp_srh(skb: *mut sk_buff, opt: *mut inet6_skb_parm) {
    void seg6_icmp_srh(struct sk_buff *skb, struct inet6_skb_parm *opt)
    {
    let mut network_header: __u16 = skb.network_header;
    struct ipv6_sr_hdr *srh;
...
#[no_mangle]
unsafe extern "C" fn seg6_genl_sethmac(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_genl_set_tunsrc(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_genl_get_tunsrc(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_genl_dumphmac_start(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_genl_dumphmac_done(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_genl_dumphmac(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn seg6_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_init() -> int __init {
