...
#[no_mangle]
unsafe extern "C" fn ila_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ila_input(skb: *mut sk_buff) -> c_int {
...
//
    ...
    p.locator.v64 = ( __be64)nla_get_u64(tb[ILA_ATTR_LOCATOR]);
...
#[no_mangle]
unsafe extern "C" fn ila_destroy_state(lwt: *mut lwtunnel_state) {
    ...
    if (nla_put_u64_64bit(skb, ILA_ATTR_LOCATOR, ( u64)p.locator.v64,
    ILA_ATTR_PAD))
    goto nla_put_failure;
    if (nla_put_u8(skb, ILA_ATTR_CSUM_MODE, ( u8)p.csum_mode))
    goto nla_put_failure;
    if (nla_put_u8(skb, ILA_ATTR_IDENT_TYPE, ( u8)p.ident_type))
    goto nla_put_failure;
...
#[no_mangle]
unsafe extern "C" fn ila_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ila_encap_cmp(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ila_lwt_init() -> c_int {
    int ila_lwt_init(void)
    {
    return lwtunnel_encap_add_ops(&ila_encap_ops, LWTUNNEL_ENCAP_ILA);
    }
#[no_mangle]
pub unsafe extern "C" fn ila_lwt_fini() {
