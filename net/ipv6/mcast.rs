...
// Ensure that we have struct in6_addr aligned on 32bit word.
    ...
    let mut mld2_all_mcr: static struct in6_addr = MLD2_ALL_MCR_INIT;
...
pub const MLD_QRV_DEFAULT: c_int = 2;
// RFC3810, 9.2. Query Interval

// RFC3810, 9.3. Query Response Interval

// RFC3810, 8.1 Query Version Distinctions
pub const MLD_V1_QUERY_LEN: c_int = 24;
pub const MLD_V2_QUERY_LEN_MIN: c_int = 28;
pub const IPV6_MLD_MAX_MSF: c_int = 64;
    let mut __read_mostly: int sysctl_mld_max_msf = IPV6_MLD_MAX_MSF;
    let mut __read_mostly: int sysctl_mld_qrv = MLD_QRV_DEFAULT;
    ...
    mc = mc_dereference(mc.next, idev))
#[no_mangle]
unsafe extern "C" fn unsolicited_report_interval(idev: *mut inet6_dev) -> c_int {
    ...
    if (ifindex == 0) {
    rcu_read_lock();
    rt = rt6_lookup(net, group, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    if (rt) {
...
//
    ...
    mc_lst.sfmode = mode;
    RCU_INIT_POINTER(mc_lst.sflist, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_sock_mc_join(sk: *mut sock, ifindex: c_int, addr: *const in6_addr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __ipv6_sock_mc_drop(sk: *mut sock, mc_lst: *mut ipv6_mc_socklist) {
    ...
    ip6_mc_leave_src(sk, mc_lst, core::ptr::null_mut());
    }
    atomic_sub(sizeof(*mc_lst), &sk.sk_omem_alloc);
    kfree_rcu(mc_lst, rcu);
    }
#[no_mangle]
pub unsafe extern "C" fn ipv6_sock_mc_drop(sk: *mut sock, ifindex: c_int, addr: *const in6_addr) -> c_int {
    ...
    (mc_lst = sock_dereference(*lnk, sk)) != core::ptr::null_mut();
    lnk = &mc_lst.next) {
    if ((ifindex == 0 || mc_lst.ifindex == ifindex) &&
    ipv6_addr_equal(&mc_lst.addr, addr)) {
...
#[no_mangle]
pub unsafe extern "C" fn __ipv6_sock_mc_close(sk: *mut sock) {
    void __ipv6_sock_mc_close(struct sock *sk)
    {
    struct ipv6_pinfo *np = inet6_sk(sk);
    struct ipv6_mc_socklist *mc_lst;
    while ((mc_lst = sock_dereference(np.ipv6_mc_list, sk)) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_sock_mc_close(sk: *mut sock) {
...
// allow mode switches for empty-set filters
    ip6_mc_add_src(idev, group, omode, 0, core::ptr::null_mut(), 0);
    ip6_mc_del_src(idev, group, pmc.sfmode, 0, core::ptr::null_mut(), 0);
    pmc.sfmode = omode;
    }
...
// update the interface list
    ...
    newpsl = core::ptr::null_mut();
    ip6_mc_add_src(idev, group, gsf.gf_fmode, 0, core::ptr::null_mut(), 0);
    }
    psl = sock_dereference(pmc.sflist, sk);
    if (psl) {
...
#[no_mangle]
unsafe extern "C" fn igmp6_group_added(mc: *mut ifmcaddr6) {
...
#[no_mangle]
unsafe extern "C" fn igmp6_group_dropped(mc: *mut ifmcaddr6) {
...
#[no_mangle]
unsafe extern "C" fn mld_add_delrec(idev: *mut inet6_dev, im: *mut ifmcaddr6) {
...
//
    ...
    RCU_INIT_POINTER(im.mca_tomb, core::ptr::null_mut());
    RCU_INIT_POINTER(im.mca_sources, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mld_del_delrec(idev: *mut inet6_dev, im: *mut ifmcaddr6) {
...
#[no_mangle]
unsafe extern "C" fn mld_clear_delrec(idev: *mut inet6_dev) {
    static void mld_clear_delrec(struct inet6_dev *idev)
    {
    struct ifmcaddr6 *pmc, *nextpmc;
    mc_assert_locked(idev);
    pmc = mc_dereference(idev.mc_tomb, idev);
    RCU_INIT_POINTER(idev.mc_tomb, core::ptr::null_mut());
    for (; pmc; pmc = nextpmc) {
...
// clear dead sources, too
    ...
    RCU_INIT_POINTER(pmc.mca_tomb, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mld_clear_query(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn mld_clear_report(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn ma_put(mc: *mut ifmcaddr6) {
...
// mca_stamp should be updated upon changes
    ...
    rtnl_notify(skb, net, 0, RTNLGRP_IPV6_MCADDR, core::ptr::null_mut(), GFP_KERNEL);
    return;
    error:
...
// we need to take a reference on idev
    ...
    ip6_mc_add_src(idev, &mc.mca_addr, mode, 0, core::ptr::null_mut(), 0);
    mutex_unlock(&idev.mc_lock);
    in6_dev_put(idev);
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_dev_mc_inc(dev: *mut net_device, addr: *const in6_addr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __ipv6_dev_mc_dec(idev: *mut inet6_dev, addr: *const in6_addr) -> c_int {
    ...
    let mut new_users: c_int = ma.mca_users - 1;
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_dev_mc_dec(dev: *mut net_device, addr: *const in6_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mld_gq_start_work(idev: *mut inet6_dev) {
    static void mld_gq_start_work(struct inet6_dev *idev)
    {
    let mut tv: c_ulong = get_random_u32_below(idev.mc_maxdelay);
    mc_assert_locked(idev);
...
#[no_mangle]
unsafe extern "C" fn mld_gq_stop_work(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn mld_ifc_start_work(idev: *mut inet6_dev, delay: c_ulong) {
    static void mld_ifc_start_work(struct inet6_dev *idev, unsigned long delay)
    {
    let mut tv: c_ulong = get_random_u32_below(delay);
    mc_assert_locked(idev);
    if (in6_dev_hold_safe(idev)) {
...
#[no_mangle]
unsafe extern "C" fn mld_ifc_stop_work(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn mld_dad_start_work(idev: *mut inet6_dev, delay: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn mld_dad_stop_work(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn mld_query_stop_work(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn mld_report_stop_work(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn igmp6_group_queried(ma: *mut ifmcaddr6, resptime: c_ulong) {
    static void igmp6_group_queried(struct ifmcaddr6 *ma, unsigned long resptime)
    {
    let mut delay: c_ulong = resptime;
...
#[no_mangle]
unsafe extern "C" fn mld_force_mld_version(idev: *const inet6_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mld_in_v2_mode_only(idev: *const inet6_dev) -> bool {
    static bool mld_in_v2_mode_only(const struct inet6_dev *idev)
    {
    return mld_force_mld_version(idev) == 2;
    }
#[no_mangle]
unsafe extern "C" fn mld_in_v1_mode_only(idev: *const inet6_dev) -> bool {
    static bool mld_in_v1_mode_only(const struct inet6_dev *idev)
    {
    return mld_force_mld_version(idev) == 1;
    }
#[no_mangle]
unsafe extern "C" fn mld_in_v1_mode(idev: *const inet6_dev) -> bool {
    static bool mld_in_v1_mode(const struct inet6_dev *idev)
    {
...
#[no_mangle]
unsafe extern "C" fn mld_set_v1_mode(idev: *mut inet6_dev) {
...
//
    let mut min_qrv: c_int = min(MLD_QRV_DEFAULT, sysctl_mld_qrv);
...
#[no_mangle]
pub unsafe extern "C" fn igmp6_event_query(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn __mld_query_work(skb: *mut sk_buff) {
    static void __mld_query_work(struct sk_buff *skb)
    {
    struct mld2_query *mlh2 = core::ptr::null_mut();
    unsigned long max_delay;
    struct inet6_dev *idev;
...
#[no_mangle]
unsafe extern "C" fn mld_query_work(work: *mut work_struct) {
...
// called with rcu_read_lock()
#[no_mangle]
pub unsafe extern "C" fn igmp6_event_report(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn __mld_report_work(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn mld_report_work(work: *mut work_struct) {
...
//
    if (psf.sf_count[MCAST_INCLUDE])
    let mut type: return = = MLD2_MODE_IS_INCLUDE;
...
#[no_mangle]
unsafe extern "C" fn mld_sendpack(skb: *mut sk_buff) {
    ...
    net, net.ipv6.igmp_sk, skb, core::ptr::null_mut(), skb.dev,
    dst_output);
    out:
    if (!err) {
...
#[no_mangle]
unsafe extern "C" fn grec_size(pmc: *mut ifmcaddr6, type: c_int, gdel: c_int, sdel: c_int) -> c_int {
...
// ppgr = pgr;
    ...
    struct net_device *dev = idev.dev;
    struct mld2_grec *pgr = core::ptr::null_mut();
    struct mld2_report *pmr;
    unsigned int mtu;
    mc_assert_locked(idev);
    ...
    goto empty_source;
    pmr = skb ? (struct mld2_report *)skb_transport_header(skb) : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mld_send_report(idev: *mut inet6_dev, pmc: *mut ifmcaddr6) {
...
#[no_mangle]
unsafe extern "C" fn mld_clear_zeros(ppsf: *mut ip6_sf_list __rcu, idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn mld_send_cr(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn igmp6_send(addr: *mut in6_addr, dev: *mut net_device, type: c_int) {
...
//
    ...
    skb_dst_set(skb, dst);
    err = NF_HOOK(NFPROTO_IPV6, NF_INET_LOCAL_OUT,
    net, sk, skb, core::ptr::null_mut(), skb.dev,
    dst_output);
    out:
    if (!err) {
...
#[no_mangle]
unsafe extern "C" fn mld_send_initial_cr(idev: *mut inet6_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_mc_dad_complete(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn mld_dad_work(work: *mut work_struct) {
...
// dpsf = *psf;
    ...
    err = 0;
    for (i = 0; i < sfcount; i++) {
    let mut rv: c_int = ip6_mc_del1_src(pmc, sfmode, &psfsrc[i]);
    changerec |= rv > 0;
    if (!err && rv < 0)
    err = rv;
    }
...
#[no_mangle]
unsafe extern "C" fn sf_markstate(pmc: *mut ifmcaddr6) {
    static void sf_markstate(struct ifmcaddr6 *pmc)
    {
    let mut mca_xcount: c_int = pmc.mca_sfcount[MCAST_EXCLUDE];
    struct ip6_sf_list *psf;
    mc_assert_locked(pmc.idev);
    for_each_psf_mclock(pmc, psf) {
    if (pmc.mca_sfcount[MCAST_EXCLUDE]) {
...
#[no_mangle]
unsafe extern "C" fn sf_setstate(pmc: *mut ifmcaddr6) -> c_int {
    static int sf_setstate(struct ifmcaddr6 *pmc)
    {
    let mut mca_xcount: c_int = pmc.mca_sfcount[MCAST_EXCLUDE];
    struct ip6_sf_list *psf, *dpsf;
    let mut qrv: c_int = pmc.idev.mc_qrv;
    int new_in, rv;
    mc_assert_locked(pmc.idev);
    rv = 0;
    for_each_psf_mclock(pmc, psf) {
    ...
    if (new_in) {
    if (!psf.sf_oldin) {
    struct ip6_sf_list *prev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pmc->mca_sfcount[MCAST_INCLUDE]) -> else {
...
#[no_mangle]
unsafe extern "C" fn ip6_mc_clear_src(pmc: *mut ifmcaddr6) {
    static void ip6_mc_clear_src(struct ifmcaddr6 *pmc)
    {
    ...
    RCU_INIT_POINTER(pmc.mca_sources, core::ptr::null_mut());
    pmc.mca_sfmode = MCAST_EXCLUDE;
...
#[no_mangle]
unsafe extern "C" fn igmp6_join_group(ma: *mut ifmcaddr6) {
    static void igmp6_join_group(struct ifmcaddr6 *ma)
    {
...
// any-source empty exclude case
    err = ip6_mc_del_src(idev, &iml.addr, iml.sfmode, 0, core::ptr::null_mut(), 0);
    } else {
...
#[no_mangle]
unsafe extern "C" fn igmp6_leave_group(ma: *mut ifmcaddr6) {
    static void igmp6_leave_group(struct ifmcaddr6 *ma)
    {
    mc_assert_locked(ma.idev);
...
#[no_mangle]
unsafe extern "C" fn mld_gq_work(work: *mut work_struct) {
    ...
    mc_gq_work);
    mutex_lock(&idev.mc_lock);
    mld_send_report(idev, core::ptr::null_mut());
    idev.mc_gq_running = 0;
    mutex_unlock(&idev.mc_lock);
    in6_dev_put(idev);
    }
#[no_mangle]
unsafe extern "C" fn mld_ifc_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mld_ifc_event(idev: *mut inet6_dev) {
    static void mld_ifc_event(struct inet6_dev *idev)
    {
    mc_assert_locked(idev);
    if (mld_in_v1_mode(idev))
...
#[no_mangle]
unsafe extern "C" fn mld_mca_work(work: *mut work_struct) {
    static void mld_mca_work(struct work_struct *work)
    {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_mc_unmap(idev: *mut inet6_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_mc_remap(idev: *mut inet6_dev) {
...
// Device going down
#[no_mangle]
pub unsafe extern "C" fn ipv6_mc_down(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_mc_reset(idev: *mut inet6_dev) {
...
// Device going up
#[no_mangle]
pub unsafe extern "C" fn ipv6_mc_up(idev: *mut inet6_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_mc_init_dev(idev: *mut inet6_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipv6_mc_destroy_dev(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_mc_rejoin_groups(idev: *mut inet6_dev) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct igmp6_mc_iter_state {
    ...
    {
    struct ifmcaddr6 *im = core::ptr::null_mut();
    ...
    if (im)
    while (pos && (im = igmp6_mc_get_next(seq, im)) != core::ptr::null_mut())
    --pos;
...
#[no_mangle]
unsafe extern "C" fn igmp6_mc_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn igmp6_mc_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int igmp6_mc_seq_show(struct seq_file *seq, void *v)
    {
    struct ifmcaddr6 *im = (struct ifmcaddr6 *)v;
    struct igmp6_mc_iter_state *state = igmp6_mc_seq_private(seq);
    let mut mca_flags: c_uint = READ_ONCE(im.mca_flags);
    let mut delta: c_long = READ_ONCE(im.mca_work.timer.expires) - jiffies;
    seq_printf(seq,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct igmp6_mcf_iter_state {
    pub p: seq_net_private,
    pub dev: *mut net_device,
    pub idev: *mut inet6_dev,
    pub im: *mut ifmcaddr6,
}

    static inline struct ip6_sf_list *igmp6_mcf_get_first(struct seq_file *seq)
    {
    struct ip6_sf_list *psf = core::ptr::null_mut();
    struct ifmcaddr6 *im = core::ptr::null_mut();
    ...
    struct inet6_dev *idev;
    idev = __in6_dev_get(state.dev);
    if (unlikely(idev == core::ptr::null_mut()))
    continue;
    im = rcu_dereference(idev.mc_list);
    if (likely(im)) {
    ...
    if (psf)
    while (pos && (psf = igmp6_mcf_get_next(seq, psf)) != core::ptr::null_mut())
    --pos;
...
#[no_mangle]
unsafe extern "C" fn igmp6_mcf_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn igmp6_mcf_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igmp6_proc_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn igmp6_proc_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn igmp6_proc_init(net: *mut net) -> c_int {
    static inline int igmp6_proc_init(struct net *net)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn igmp6_proc_exit(net: *mut net) {
    static inline void igmp6_proc_exit(struct net *net)
    {
    }

#[no_mangle]
unsafe extern "C" fn igmp6_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn igmp6_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn igmp6_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn igmp6_late_init() -> int __init {
    int __init igmp6_late_init(void)
    {
    return register_netdevice_notifier(&igmp6_netdev_notifier);
    }
#[no_mangle]
pub unsafe extern "C" fn igmp6_cleanup() {
...
#[no_mangle]
pub unsafe extern "C" fn igmp6_late_cleanup() {
