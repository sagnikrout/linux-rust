...
#[no_mangle]
pub unsafe extern "C" fn rt6_uncached_list_add(rt: *mut rt6_info) {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_uncached_list_del(rt: *mut rt6_info) {
...
#[no_mangle]
unsafe extern "C" fn rt6_uncached_list_flush_dev(dev: *mut net_device) {
    ...
    return (const void *) p;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: skb) -> else {
    else if (skb)
    ...
    return IS_ERR(n) ? core::ptr::null_mut() : n;
    }
...
#[no_mangle]
unsafe extern "C" fn ip6_confirm_neigh(dst: *const dst_entry, daddr: *const c_void) {
    static void ip6_confirm_neigh(const struct dst_entry *dst, const void *daddr)
    {
    const struct rt6_info *rt = dst_rt6_info(dst);
    struct net_device *dev = dst_dev(dst);
    daddr = choose_neigh_daddr(rt6_nexthop(rt, &in6addr_any), core::ptr::null_mut(), daddr);
    if (!daddr)
    return;
...
#[no_mangle]
unsafe extern "C" fn rt6_info_init(rt: *mut rt6_info) {
...
#[no_mangle]
unsafe extern "C" fn ip6_dst_destroy(dst: *mut dst_entry) {
    ...
    idev = rt.rt6i_idev;
    if (idev) {
    rt.rt6i_idev = core::ptr::null_mut();
    in6_dev_put(idev);
    }
    from = unrcu_pointer(xchg(&rt.from, core::ptr::null_mut()));
    fib6_info_release(from);
    }
#[no_mangle]
unsafe extern "C" fn ip6_dst_ifdown(dst: *mut dst_entry, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn __rt6_check_expired(rt: *const rt6_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt6_check_expired(rt: *const rt6_info) -> bool {
...
//
    ...
    fl6.mp_hash = rt6_multipath_hash(net, fl6, skb, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __rt6_nh_dev_match(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6_probe_deferred(w: *mut work_struct) {
    ...
    ndisc_send_ns(work.dev, &work.target, &mcaddr, core::ptr::null_mut(), 0);
    netdev_put(work.dev, &work.dev_tracker);
    kfree(work);
    }
#[no_mangle]
unsafe extern "C" fn rt6_probe(fib6_nh: *mut fib6_nh) {
    static void rt6_probe(struct fib6_nh *fib6_nh)
    {
    struct __rt6_probe_work *work = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn rt6_probe(fib6_nh: *mut fib6_nh) {
...
//
#[no_mangle]
unsafe extern "C" fn rt6_check_neigh(fib6_nh: *const fib6_nh) -> enum rt6_nud_state {
    static enum rt6_nud_state rt6_check_neigh(const struct fib6_nh *fib6_nh)
    {
    let mut ret: enum rt6_nud_state = RT6_NUD_FAIL_HARD;
    struct neighbour *neigh;
    rcu_read_lock();
    neigh = __ipv6_neigh_lookup_noref(fib6_nh.fib_nh_dev,
    &fib6_nh.fib_nh_gw6);
    if (neigh) {
    let mut nud_state: u8 = READ_ONCE(neigh.nud_state);
    if (nud_state & NUD_VALID)
    ret = RT6_NUD_SUCCEED;

#[no_mangle]
pub unsafe extern "C" fn if(NUD_FAILED): !(nud_state &) -> else {
    ...
    let mut n: c_int = rt6_check_neigh(nh);
    if (n < 0)
    return n;
    }
    return m;
    ...
    {
    let mut match_do_rr: bool = false;
...
#[no_mangle]
unsafe extern "C" fn rt6_nh_find_match(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
// cont = f6i;
    ...
    {
    let mut metric: u32 = rr_head.fib6_metric;
    struct fib6_info *cont = core::ptr::null_mut();
    let mut mpri: c_int = -1;
    __find_rr_leaf(rr_head, core::ptr::null_mut(), metric, res, &cont,
    oif, strict, do_rr, &mpri);
    __find_rr_leaf(leaf, rr_head, metric, res, &cont,
    oif, strict, do_rr, &mpri);
    if (res.f6i || !cont)
    return;
    __find_rr_leaf(cont, core::ptr::null_mut(), metric, res, core::ptr::null_mut(),
    oif, strict, do_rr, &mpri);
    }
    ...
    let mut do_rr: bool = false;
    int key_plen;
// make sure this function or its helpers sets f6i
    res.f6i = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rt6_is_gw_or_nonexthop(res: *const fib6_result) -> bool {
...
// this function is safe
    ...
    dev, pref);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rt) -> else {
    else if (rt)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !netif_is_l3_master(dev)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ip6_rt_type_to_error(fib6_type: u8) -> c_int {
    static int ip6_rt_type_to_error(u8 fib6_type)
    {
    return fib6_prop[fib6_type];
    }
#[no_mangle]
unsafe extern "C" fn fib6_info_dst_flags(rt: *mut fib6_info) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn ip6_rt_init_dst_reject(rt: *mut rt6_info, fib6_type: u8) {
...
#[no_mangle]
unsafe extern "C" fn ip6_rt_init_dst(rt: *mut rt6_info, res: *const fib6_result) {
...
#[no_mangle]
unsafe extern "C" fn rt6_set_from(rt: *mut rt6_info, from: *mut fib6_info) {
...
#[no_mangle]
unsafe extern "C" fn ip6_rt_copy_init(rt: *mut rt6_info, res: *const fib6_result) {
    ...
    rt.rt6i_idev = dev ? in6_dev_get(dev) : core::ptr::null_mut();
    ...
    sn = FIB6_SUBTREE(pn);
    if (sn && sn != fn)
    fn = fib6_node_lookup(sn, core::ptr::null_mut(), saddr);
    else
    fn = pn;
...
#[no_mangle]
unsafe extern "C" fn ip6_hold_safe(net: *mut net, prt: *mut rt6_info) -> bool {
...
// Search through exception table
    ...
    struct dst_entry *dst;
    let mut flags: c_int = strict ? RT6_LOOKUP_F_IFACE : 0;
    if (saddr) {
...
#[no_mangle]
pub unsafe extern "C" fn ip6_ins_rt(net: *mut net, rt: *mut fib6_info) -> c_int {
    int ip6_ins_rt(struct net *net, struct fib6_info *rt)
    {
    let mut info: nl_info = {	.nl_net = net, };
    return __ip6_ins_rt(rt, &info, core::ptr::null_mut());
    }
...
//
    ...
    {
    struct fib6_info *f6i = res.f6i;
    let mut flags: c_ushort = fib6_info_dst_flags(f6i);
    struct net_device *dev;
...
#[no_mangle]
unsafe extern "C" fn rt6_is_valid(rt6: *const rt6_info) -> bool {
...
// Paired with READ_ONCE() in __fib6_drop_pcpu_from()
    prev = xchg(p, core::ptr::null_mut());
    if (prev) {
    dst_dev_put(&prev.dst);
    dst_release(&prev.dst);
    }
    pcpu_rt = core::ptr::null_mut();
    }
    return pcpu_rt;
    }
    ...
    return core::ptr::null_mut();
    p = this_cpu_ptr(res.nh.rt6i_pcpu);
    prev = cmpxchg(p, core::ptr::null_mut(), pcpu_rt);
    if (unlikely(prev)) {
//
...
//
    ...
    struct fib6_info *from;
    from = unrcu_pointer(xchg(&pcpu_rt.from, core::ptr::null_mut()));
    fib6_info_release(from);
    }
    return pcpu_rt;
    }
...
//
#[no_mangle]
unsafe extern "C" fn rt6_exception_remove_oldest(bucket: *mut rt6_exception_bucket) {
    static void rt6_exception_remove_oldest(struct rt6_exception_bucket *bucket)
    {
    struct rt6_exception *rt6_ex, *oldest = core::ptr::null_mut();
    if (!bucket)
    return;
...
// bucket += hval;
    ...
    let mut matched: bool = ipv6_addr_equal(daddr, &rt6.rt6i_dst.addr);
...
#[no_mangle]
unsafe extern "C" fn fib6_mtu(res: *const fib6_result) -> c_uint {
...
pub const FIB6_EXCEPTION_BUCKET_FLUSHED: c_uint = 0x1UL;
...
// remove bucket flushed bit if set
    if (bucket) {
    let mut p: c_ulong = (unsigned long)bucket;
...
#[no_mangle]
unsafe extern "C" fn fib6_nh_excptn_bucket_flushed(bucket: *mut rt6_exception_bucket) -> bool {
...
// called with rt6_exception_lock held
    ...
    struct rt6_exception_bucket *bucket;
    struct fib6_info *f6i = res.f6i;
    struct in6_addr *src_key = core::ptr::null_mut();
    struct rt6_exception *rt6_ex;
...
#[no_mangle]
unsafe extern "C" fn fib6_nh_flush_exceptions(nh: *mut fib6_nh, from: *mut fib6_info) {
...
#[no_mangle]
unsafe extern "C" fn rt6_nh_flush_exceptions(nh: *mut fib6_nh, arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_flush_exceptions(f6i: *mut fib6_info) {
...
//
    ...
    const struct in6_addr *saddr)
    {
    const struct in6_addr *src_key = core::ptr::null_mut();
    struct rt6_exception_bucket *bucket;
    struct rt6_exception *rt6_ex;
    struct rt6_info *ret = core::ptr::null_mut();
...
//
    ...
    bucket = fib6_nh_get_excptn_bucket(res.nh, core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fib6_nh_excptn_arg {
    pub rt: *mut rt6_info,
    pub plen: c_int,
}

#[no_mangle]
unsafe extern "C" fn rt6_nh_remove_exception_rt(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6_remove_exception_rt(rt: *mut rt6_info) -> c_int {
...
//
    ...
    struct rt6_exception_bucket *bucket;
    struct rt6_exception *rt6_ex;
    bucket = fib6_nh_get_excptn_bucket(nh, core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fib6_nh_match_arg {
    pub dev: *const net_device,
    pub gw: *const in6_addr,
    pub match: *mut fib6_nh,
}

// determine if fib6_nh has given device and gateway
#[no_mangle]
unsafe extern "C" fn fib6_nh_find_match(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6_update_exception_stamp_rt(rt: *mut rt6_info) {
    ...
    {
    let mut dmtu: u32 = dst6_mtu(&rt.dst);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fib6_nh_age_excptn_arg {
    pub gc_args: *mut fib6_gc_args,
    pub now: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn rt6_nh_age_exceptions(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RT6_LOOKUP_F_REACHABLE: strict &) -> else {
// also consider unreachable route
    ...
    {
    let mut res: fib6_result = {};
    struct rt6_info *rt = core::ptr::null_mut();
    bool have_oif_match;
...
//
    rt = ip6_rt_cache_alloc(&res, &fl6.daddr, core::ptr::null_mut());
    if (rt) {
...
// Get a percpu copy
    ...
    bool *p_has_inner)
    {
    let mut hash_fields: u32 = ip6_multipath_hash_fields(net);
...
//
    ...
    hash_keys.ports.src = ( __be16)get_random_u16();
    else
...
// if skb is set it will be used and fl6 can be NULL
    ...
    case 1:
    if (skb) {
    let mut flag: c_uint = FLOW_DISSECTOR_F_STOP_AT_ENCAP;
    struct flow_keys keys;
...
#[no_mangle]
pub unsafe extern "C" fn ip6_route_input(skb: *mut sk_buff) {
    void ip6_route_input(struct sk_buff *skb)
    {
    const struct ipv6hdr *iph = ipv6_hdr(skb);
    struct net *net = dev_net(skb.dev);
    let mut flags: c_int = RT6_LOOKUP_F_HAS_SADDR | RT6_LOOKUP_F_DST_NOREF;
    ...
    struct flow_keys *flkeys = core::ptr::null_mut(), _flkeys;
...
pub unsafe extern "C" fn if(_arg: sk) -> else {
    ...
    return fib6_rule_lookup(net, fl6, core::ptr::null_mut(), flags, ip6_pol_route_output);
    }
...
// For dst cached in uncached_list, refcnt is already taken.
    ...
    struct dst_entry *new = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn fib6_check(f6i: *mut fib6_info, cookie: u32) -> bool {
    static bool fib6_check(struct fib6_info *f6i, u32 cookie)
    {
    let mut rt_cookie: u32 = 0;
    ...
    rt = dst_rt6_info(dst);
    if (rt.sernum)
    return rt6_is_valid(rt) ? dst : core::ptr::null_mut();
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn ip6_link_failure(skb: *mut sk_buff) {
    static void ip6_link_failure(struct sk_buff *skb)
    {
    struct rt6_info *rt;
...
#[no_mangle]
unsafe extern "C" fn rt6_update_expires(rt0: *mut rt6_info, timeout: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rt6_do_update_pmtu(rt: *mut rt6_info, mtu: u32) {
...
#[no_mangle]
unsafe extern "C" fn rt6_cache_allowed_for_pmtu(rt: *const rt6_info) -> bool {
...
//
    ...
    bool confirm_neigh)
    {
    __ip6_rt_update_pmtu(dst, sk, skb ? ipv6_hdr(skb) : core::ptr::null_mut(), mtu,
    confirm_neigh);
    }
    ...
    if (!dst.error)
    __ip6_rt_update_pmtu(dst, core::ptr::null_mut(), iph, ntohl(mtu), true);
    dst_release(dst);
    }
    EXPORT_SYMBOL_GPL(ip6_update_pmtu);
#[no_mangle]
pub unsafe extern "C" fn ip6_sk_update_pmtu(skb: *mut sk_buff, sk: *mut sock, mtu: __be32) {
    void ip6_sk_update_pmtu(struct sk_buff *skb, struct sock *sk, __be32 mtu)
    {
    let mut oif: c_int = sk.sk_bound_dev_if;
    struct dst_entry *dst;
    if (!oif && skb.dev)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fib6_nh_rd_arg {
    pub res: *mut fib6_result,
    pub fl6: *mut flowi6,
    pub gw: *const in6_addr,
    pub ret: *mut rt6_info,
}

#[no_mangle]
unsafe extern "C" fn fib6_nh_redirect_match(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RTF_REJECT: rt->fib6_flags &) -> else {
    ...
    const struct in6_addr *gateway)
    {
    let mut flags: c_int = RT6_LOOKUP_F_HAS_SADDR;
    ...
    rt6_do_redirect(dst, core::ptr::null_mut(), skb);
    dst_release(dst);
    }
    EXPORT_SYMBOL_GPL(ip6_redirect);
#[no_mangle]
pub unsafe extern "C" fn ip6_redirect_no_header(skb: *mut sk_buff, net: *mut net, oif: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ip6_sk_redirect(skb: *mut sk_buff, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn ip6_default_advmss(dst: *const dst_entry) -> c_uint {
    static unsigned int ip6_default_advmss(const struct dst_entry *dst)
    {
    let mut mtu: c_uint = ip6_dst_mtu_configured(dst);
    struct net *net;
...
#[no_mangle]
pub unsafe extern "C" fn ip6_mtu(dst: *const dst_entry) -> INDIRECT_CALLABLE_SCOPE unsigned int {
...
//
    rt6_uncached_list_add(rt);
    dst = xfrm_lookup(net, &rt.dst, flowi6_to_flowi(fl6), core::ptr::null_mut(), 0);
    out:
    return dst;
    }
#[no_mangle]
unsafe extern "C" fn ip6_dst_gc(ops: *mut dst_ops) {
    static void ip6_dst_gc(struct dst_ops *ops)
    {
    struct net *net = container_of(ops, struct net, ipv6.ip6_dst_ops);
    let mut rt_min_interval: c_int = READ_ONCE(net.ipv6.sysctl.ip6_rt_gc_min_interval);
    let mut rt_elasticity: c_int = READ_ONCE(net.ipv6.sysctl.ip6_rt_gc_elasticity);
    let mut rt_gc_timeout: c_int = READ_ONCE(net.ipv6.sysctl.ip6_rt_gc_timeout);
    let mut rt_last_gc: c_ulong = READ_ONCE(net.ipv6.ip6_rt_last_gc);
    unsigned int val;
    int entries;
    ...
    cfg.fc_ifindex != 0, core::ptr::null_mut(), flags);
    return err;
    }
    ...
    struct netlink_ext_ack *extack)
    {
    let mut tbid: u32 = l3mdev_fib_table_rcu(dev) ? : RT_TABLE_MAIN;
    ...
    {
    const struct in6_addr *gw_addr = &cfg.fc_gateway;
    struct net_device *dev = _dev ? *_dev : core::ptr::null_mut();
    let mut flags: c_int = RT6_LOOKUP_F_IFACE;
    let mut res: fib6_result = {};
    let mut err: c_int = -EHOSTUNREACH;
    if (cfg.fc_table) {
...
// idev = in6_dev_get(dev);
    ...
    {
    const struct in6_addr *gw_addr = &cfg.fc_gateway;
    let mut gwa_type: c_int = ipv6_addr_type(gw_addr);
    let mut skip_dev: bool = gwa_type & IPV6_ADDR_LINKLOCAL ? false : true;
    const struct net_device *dev = *_dev;
    let mut need_addr_check: bool = !dev;
...
#[no_mangle]
unsafe extern "C" fn fib6_is_reject(flags: u32, dev: *mut net_device, addr_type: c_int) -> bool {
    ...
    struct inet6_dev *idev = core::ptr::null_mut();
    int err;
    if (!ipv6_mod_enabled()) {
...
// hold loopback dev/idev if we haven't done so.
    ...
    fib6_nh.nh_common.nhc_pcpu_rth_output = core::ptr::null_mut();
    fib6_nh.fib_nh_lws = core::ptr::null_mut();
    netdev_put(dev, dev_tracker);
    }
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn fib6_nh_release(fib6_nh: *mut fib6_nh) {
    void fib6_nh_release(struct fib6_nh *fib6_nh)
    {
    struct rt6_exception_bucket *bucket;
    rcu_read_lock();
    fib6_nh_flush_exceptions(fib6_nh, core::ptr::null_mut());
    bucket = fib6_nh_get_excptn_bucket(fib6_nh, core::ptr::null_mut());
    if (bucket) {
    rcu_assign_pointer(fib6_nh.rt6i_exception_bucket, core::ptr::null_mut());
    kfree(bucket);
    }
    rcu_read_unlock();
...
#[no_mangle]
pub unsafe extern "C" fn fib6_nh_release_dsts(fib6_nh: *mut fib6_nh) {
    ...
    pcpu_rt = xchg(ppcpu_rt, core::ptr::null_mut());
    if (pcpu_rt) {
    dst_dev_put(&pcpu_rt.dst);
    dst_release(&pcpu_rt.dst);
    }
...
#[no_mangle]
pub unsafe extern "C" fn ip6_del_rt(net: *mut net, rt: *mut fib6_info, skip_notify: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ip6_del_rt_siblings(rt: *mut fib6_info, cfg: *mut fib6_config) -> c_int {
...
// prefer to send a single notification with all hops
    ...
    if (skb) {
    let mut seq: u32 = info.nlh ? info.nlh.nlmsg_seq : 0;
    if (rt6_fill_node(net, skb, rt, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), 0, RTM_DELROUTE,
    info.portid, seq, 0,
...
#[no_mangle]
unsafe extern "C" fn __ip6_del_cached_rt(rt: *mut rt6_info, cfg: *mut fib6_config) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fib6_nh_del_cached_rt_arg {
    pub cfg: *mut fib6_config,
    pub f6i: *mut fib6_info,
}

#[no_mangle]
unsafe extern "C" fn fib6_nh_del_cached_rt(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip6_del_cached_rt_nh(cfg: *mut fib6_config, f6i: *mut fib6_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6_do_redirect(dst: *mut dst_entry, sk: *mut sock, skb: *mut sk_buff) {
    static void rt6_do_redirect(struct dst_entry *dst, struct sock *sk, struct sk_buff *skb)
    {
    struct netevent_redirect netevent;
    struct rt6_info *rt, *nrt = core::ptr::null_mut();
    let mut res: fib6_result = {};
...
//
    ...
    res.fib6_flags = res.f6i.fib6_flags;
    res.fib6_type = res.f6i.fib6_type;
    nrt = ip6_rt_cache_alloc(&res, &msg.dest, core::ptr::null_mut());
    if (!nrt)
    goto out;
...
// rt6_insert_exception() will take care of duplicated exceptions
    ...
    struct net_device *dev)
    {
    let mut tb_id: u32 = l3mdev_fib_table(dev) ? : RT6_TABLE_INFO;
    let mut ifindex: c_int = dev.ifindex;
    struct fib6_node *fn;
    struct fib6_info *rt = core::ptr::null_mut();
    struct fib6_table *table;
    table = fib6_get_table(net, tb_id);
    if (!table)
    return core::ptr::null_mut();
    rcu_read_lock();
    fn = fib6_locate(&table.tb6_root, prefix, prefixlen, core::ptr::null_mut(), 0, true);
    if (!fn)
    goto out;
    for_each_fib6_node_rt_rcu(fn) {
// these routes do not use nexthops
    ...
    .fc_type = RTN_UNICAST,
    .fc_nlinfo.portid = 0,
    .fc_nlinfo.nlh = core::ptr::null_mut(),
...
// We should treat it as a default route if prefix length is 0.
    ...
    ip6_route_add(&cfg, GFP_ATOMIC, core::ptr::null_mut());
    ...
    struct net_device *dev)
    {
    let mut tb_id: u32 = l3mdev_fib_table(dev) ? : RT6_TABLE_DFLT;
    struct fib6_info *rt;
    struct fib6_table *table;
    table = fib6_get_table(net, tb_id);
    if (!table)
...
// RA routes do not use nexthops
    ...
    cfg.fc_gateway = *gwaddr;
    if (!ip6_route_add(&cfg, GFP_ATOMIC, core::ptr::null_mut())) {
    struct fib6_table *table;
    ...
    struct inet6_dev *idev = dev ? __in6_dev_get(dev) : core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn rt6_purge_dflt_routers(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_route_ioctl(net: *mut net, cmd: c_uint, rtmsg: *mut in6_rtmsg) -> c_int {
...
// Only do the default setting of fc_metric in route adding
    ...
    err = ip6_route_add(&cfg, GFP_KERNEL, core::ptr::null_mut());
    break;
    case SIOCDELRT:
    err = ip6_route_del(&cfg, core::ptr::null_mut());
    break;
    }
    return err;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ip6_pkt_drop(skb: *mut sk_buff, code: u8, ipstats_mib_noroutes: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip6_pkt_discard(skb: *mut sk_buff) -> c_int {
    static int ip6_pkt_discard(struct sk_buff *skb)
    {
    return ip6_pkt_drop(skb, ICMPV6_NOROUTE, IPSTATS_MIB_INNOROUTES);
    }
#[no_mangle]
unsafe extern "C" fn ip6_pkt_discard_out(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int ip6_pkt_discard_out(struct net *net, struct sock *sk, struct sk_buff *skb)
    {
...
#[no_mangle]
unsafe extern "C" fn ip6_pkt_prohibit(skb: *mut sk_buff) -> c_int {
    static int ip6_pkt_prohibit(struct sk_buff *skb)
    {
    return ip6_pkt_drop(skb, ICMPV6_ADM_PROHIBITED, IPSTATS_MIB_INNOROUTES);
    }
#[no_mangle]
unsafe extern "C" fn ip6_pkt_prohibit_out(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int ip6_pkt_prohibit_out(struct net *net, struct sock *sk, struct sk_buff *skb)
    {
    skb.dev = skb_dst_dev(skb);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arg_dev_net_ip {
    pub net: *mut net,
    pub addr: *mut in6_addr,
}

#[no_mangle]
unsafe extern "C" fn fib6_remove_prefsrc(rt: *mut fib6_info, arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_remove_prefsrc(ifp: *mut inet6_ifaddr) {
...
#[no_mangle]
unsafe extern "C" fn fib6_clean_tohost(rt: *mut fib6_info, arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_clean_tohost(net: *mut net, gateway: *mut in6_addr) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arg_netdev_event {
    pub dev: *const net_device,
    union {
    pub nh_flags: c_uchar,
    pub event: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn rt6_is_dead(rt: *const fib6_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt6_multipath_total_weight(rt: *const fib6_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6_upper_bound_set(rt: *mut fib6_info, weight: *mut c_int, total: c_int) {
    static void rt6_upper_bound_set(struct fib6_info *rt, int *weight, int total)
    {
    let mut upper_bound: c_int = -1;
...
#[no_mangle]
unsafe extern "C" fn rt6_multipath_upper_bound_set(rt: *mut fib6_info, total: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_multipath_rebalance(rt: *mut fib6_info) {
...
#[no_mangle]
unsafe extern "C" fn fib6_ifup(rt: *mut fib6_info, p_arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_sync_up(dev: *mut net_device, nh_flags: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn rt6_multipath_flush(rt: *mut fib6_info) {
...
#[no_mangle]
unsafe extern "C" fn fib6_ifdown(rt: *mut fib6_info, p_arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_sync_down_dev(dev: *mut net_device, event: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_disable_ip(dev: *mut net_device, event: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn fib6_nh_mtu_change(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6_mtu_change_route(f6i: *mut fib6_info, p_arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt6_mtu_change(dev: *mut net_device, mtu: c_uint) {
    ...
    do {
    let mut has_gateway: bool = cfg.fc_flags & RTF_GATEWAY;
    let mut attrlen: c_int = rtnh_attrlen(rtnh);
    if (attrlen > 0) {
    ...
    struct netlink_ext_ack *extack)
    {
    let mut newroute: bool = nlh.nlmsg_type == RTM_NEWROUTE;
...
// cfg = (struct fib6_config){
    ...
    if (tb[RTA_DST]) {
    let mut plen: c_int = (rtm.rtm_dst_len + 7) >> 3;
    if (nla_len(tb[RTA_DST]) < plen)
    goto errout;
    nla_memcpy(&cfg.fc_dst, tb[RTA_DST], plen);
    }
    if (tb[RTA_SRC]) {
    let mut plen: c_int = (rtm.rtm_src_len + 7) >> 3;
    ...
    if (tb[RTA_EXPIRES]) {
    let mut timeout: c_ulong = addrconf_timeout_fixup(nla_get_u32(tb[RTA_EXPIRES]), HZ);
...
#[derive(Copy, Clone)]
pub struct rt6_nh {
    pub fib6_info: *mut fib6_info,
    pub r_cfg: fib6_config,
    pub list: list_head,
}
...
#[no_mangle]
unsafe extern "C" fn ip6_route_mpath_should_notify(rt: *const fib6_info) -> bool {
    static bool ip6_route_mpath_should_notify(const struct fib6_info *rt)
    {
    let mut rt_can_ecmp: bool = rt6_qualify_for_ecmp(rt);
    let mut should_notify: bool = false;
    ...
    struct netlink_ext_ack *extack)
    {
    struct fib6_info *rt_notif = core::ptr::null_mut(), *rt_last = core::ptr::null_mut();
    struct nl_info *info = &cfg.fc_nlinfo;
...
#[no_mangle]
unsafe extern "C" fn rt6_nh_nlmsg_size(nh: *mut fib6_nh, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6_nlmsg_size(f6i: *mut fib6_info) -> usize {
    static size_t rt6_nlmsg_size(struct fib6_info *f6i)
    {
    struct fib6_info *sibling;
    struct fib6_nh *nh;
    ...
    common:
#[no_mangle]
pub unsafe extern "C" fn NLMSG_ALIGN(rtmsg): sizeof(struct) -> return {
    ...
    let mut nh_flags: c_uchar = 0;
    struct nlmsghdr *nlh;
    struct rtmsg *rtm;
    let mut expires: c_long = 0;
    ...
    let mut err: c_int = ip6mr_get_route(net, skb, rtm, portid);
    if (err == 0)
    return 0;
    if (err < 0)
    goto nla_put_failure;
...
#[no_mangle]
unsafe extern "C" fn fib6_info_nh_uses_dev(nh: *mut fib6_nh, arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fib6_nh_exception_dump_walker {
    pub dump: *mut rt6_rtnl_dump_arg,
...
#[no_mangle]
unsafe extern "C" fn rt6_nh_dump_exceptions(nh: *mut fib6_nh, arg: *mut c_void) -> c_int {
...
//
    ...
    &rt6_ex.rt6i.dst, core::ptr::null_mut(), core::ptr::null_mut(), 0,
    RTM_NEWROUTE,
...
#[no_mangle]
pub unsafe extern "C" fn rt6_dump_route(rt: *mut fib6_info, p_arg: *mut c_void, skip: c_uint) -> c_int {
    int rt6_dump_route(struct fib6_info *rt, void *p_arg, unsigned int skip)
    {
    struct rt6_rtnl_dump_arg *arg = (struct rt6_rtnl_dump_arg *) p_arg;
    struct fib_dump_filter *filter = &arg.filter;
    let mut flags: c_uint = NLM_F_MULTI;
...
// success since this is not a prefix route
    ...
    if (rt6_fill_node(net, arg.skb, rt, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    0, RTM_NEWROUTE,
    ...
    flags |= RT6_LOOKUP_F_HAS_SADDR;
    dst = ip6_route_input_lookup(net, dev, &fl6, core::ptr::null_mut(), flags);
    rcu_read_unlock();
    } else {
    fl6.flowi6_oif = oif;
    dst = ip6_route_output(net, core::ptr::null_mut(), &fl6);
    ...
    if (from) {
    if (fibmatch)
    err = rt6_fill_node(net, skb, from, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    iif, RTM_NEWROUTE,
    ...
    if (!skb)
    goto errout;
    err = rt6_fill_node(net, skb, rt, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0,
...
//
    ...
    err = rt6_fill_node(net, skb, f6i, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0, RTM_NEWROUTE, 0,
...
// -EMSGSIZE implies BUG in rt6_nlmsg_size()
    ...
    rtnl_notify(skb, net, 0, RTNLGRP_IPV6_ROUTE, core::ptr::null_mut(), GFP_KERNEL);
    return;
    errout:
    rtnl_set_sk_err(net, RTNLGRP_IPV6_ROUTE, err);
    }
...
#[no_mangle]
unsafe extern "C" fn rt6_stats_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_route_sysctl_init(net: *mut net) -> *mut ctl_table  __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_route_sysctl_table_size(net: *mut net) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ip6_route_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ip6_route_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ip6_route_net_init_late(net: *mut net) -> int __net_init {
    ...
    rt6_stats_seq_show, core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn ip6_route_net_exit_late(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ipv6_inetpeer_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipv6_inetpeer_exit(net: *mut net) -> void __net_exit {
    static void __net_exit ipv6_inetpeer_exit(struct net *net)
    {
    struct inet_peer_base *bp = net.ipv6.peers;
    net.ipv6.peers = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ip6_route_init_special_entries() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_register() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_unregister() {
...
#[no_mangle]
pub unsafe extern "C" fn ip6_route_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ip6_route_cleanup() {
