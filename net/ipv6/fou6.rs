...
#[no_mangle]
unsafe extern "C" fn ip6_tnl_encap_add_fou_ops() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip6_tnl_encap_del_fou_ops() {
...
#[no_mangle]
unsafe extern "C" fn fou6_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fou6_fini() -> void __exit {
