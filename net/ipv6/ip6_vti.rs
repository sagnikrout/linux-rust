...
// lists for storing tunnels in use
    pub tnls_r_l: [*mut ip6_tnl __rcu; IP6_VTI_HASH_SIZE],
...
#[no_mangle]
unsafe extern "C" fn vti6_tnl_create2(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vti6_dev_uninit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn vti6_rcv(skb: *mut sk_buff) -> c_int {
    static int vti6_rcv(struct sk_buff *skb)
    {
    let mut nexthdr: c_int = skb_network_header(skb)[IP6CB(skb).nhoff];
    return vti6_input_proto(skb, nexthdr, 0, 0);
    }
#[no_mangle]
unsafe extern "C" fn vti6_rcv_cb(skb: *mut sk_buff, err: c_int) -> c_int {
...
//
    ...
    dst_hold(dst);
    dst = xfrm_lookup_route(t.net, dst, fl, core::ptr::null_mut(), 0);
    if (IS_ERR(dst)) {
    err = PTR_ERR(dst);
    dst = core::ptr::null_mut();
    goto tx_err_link_failure;
...
#[no_mangle]
unsafe extern "C" fn vti6_link_config(t: *mut ip6_tnl, keep_mtu: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn vti6_dev_setup(dev: *mut net_device) {
    static void vti6_dev_setup(struct net_device *dev)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn vti6_dev_init_gen(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vti6_dev_init(dev: *mut net_device) -> c_int {
    static int vti6_dev_init(struct net_device *dev)
    {
    struct ip6_tnl *t = netdev_priv(dev);
    let mut err: c_int = vti6_dev_init_gen(dev);
    if (err)
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn vti6_fb_tnl_dev_init(dev: *mut net_device) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn vti6_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn vti6_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn vti6_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vti6_exit_rtnl_net(net: *mut net, list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn vti6_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn vti6_rcv_tunnel(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vti6_tunnel_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn vti6_tunnel_cleanup() -> void __exit {
