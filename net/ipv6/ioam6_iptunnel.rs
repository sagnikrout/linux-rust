...
//! Source: net/ipv6/ioam6_iptunnel.c
#![no_std]
...
pub struct ioam6_lwt_encap {
    ...
    pub /: *mut *mut u8 pad[2]; / 2-octet padding for 4n-alignment,
    pub ioamh: ioam6_hdr,
    pub traceh: ioam6_trace_hdr,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ioam6_lwt_freq {
    pub k: u32,
    pub n: u32,
}
...
pub struct ioam6_lwt {
    ...
    pub pkt_cnt: core::sync::atomic::AtomicI32,
    pub mode: u8,
    pub has_tunsrc: bool,
    pub tunsrc: in6_addr,
    pub tundst: in6_addr,
...
#[no_mangle]
unsafe extern "C" fn ioam6_validate_trace_hdr(trace: *mut ioam6_trace_hdr) -> bool {
...
//
    dst_init(&ilwt.null_rt.dst, core::ptr::null_mut(), core::ptr::null_mut(), DST_OBSOLETE_NONE, DST_NOCOUNT);
...
#[no_mangle]
unsafe extern "C" fn ioam6_do_fill(net: *mut net, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_destroy_state(lwt: *mut lwtunnel_state) {
...
#[no_mangle]
unsafe extern "C" fn ioam6_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioam6_encap_cmp(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
