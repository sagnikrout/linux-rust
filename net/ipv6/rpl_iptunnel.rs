...
//! Source: net/ipv6/rpl_iptunnel.c
#![no_std]
...
pub struct rpl_iptunnel_encap {
    pub srh): DECLARE_FLEX_ARRAY(struct ipv6_rpl_sr_hdr,,
}
...
#[no_mangle]
unsafe extern "C" fn rpl_destroy_state(lwt: *mut lwtunnel_state) {
...
#[no_mangle]
unsafe extern "C" fn rpl_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpl_input(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpl_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpl_encap_cmp(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
    ...
    let mut len: c_int = RPL_IPTUNNEL_SRH_SIZE(a_hdr.srh);
...
#[no_mangle]
pub unsafe extern "C" fn rpl_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn rpl_exit() {
    void rpl_exit(void)
    {
