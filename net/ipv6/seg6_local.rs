...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct seg6_local_lwtunnel_ops {
    int (*build_state)(struct seg6_local_lwt *slwt, const void *cfg,
    pub extack): *mut netlink_ext_ack,
    pub slwt): *mut *mut void (destroy_state)(struct seg6_local_lwt,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct seg6_action_desc {
    pub action: c_int,
    pub attrs: c_ulong,
...
// versa.
//
    pub optattrs: c_ulong,
    pub slwt): *mut *mut *mut int (input)(struct sk_buff skb, struct seg6_local_lwt,
    pub static_headroom: c_int,
    pub slwt_ops: seg6_local_lwtunnel_ops,
}
...
// and (iii).
//
pub const SEG6_LOCAL_LCBLOCK_DBITS: c_int = 32;
pub const SEG6_LOCAL_LCNODE_FN_DBITS: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcpu_seg6_local_counters {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct seg6_local_counters {
    pub packets: __u64,
    pub bytes: __u64,
    pub errors: __u64,
}
...
pub struct seg6_local_lwt {
    ...
    pub iif: c_int,
    pub oif: c_int,
    pub bpf: bpf_lwt_prog,

    pub dt_info: seg6_end_dt_info,

    pub flv_info: seg6_flavors_info,
    pub pcpu_counters: *mut pcpu_seg6_local_counters __percpu,
    pub headroom: c_int,
    pub desc: *mut seg6_action_desc,
// unlike the required attrs, we have to track the optional attributes
// that have been effectively parsed.
//
    pub parsed_optattrs: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn decap_and_validate(skb: *mut sk_buff, proto: c_int) -> bool {
    ...
    if (ipv6_find_hdr(skb, &off, proto, core::ptr::null_mut(), core::ptr::null_mut()) < 0)
    return false;
    ...
    let mut iif: c_int = IP6CB(skb).iif;
    memset(IPCB(skb), 0, sizeof(*IPCB(skb)));
    IPCB(skb).iif = iif;
    } else if (proto == IPPROTO_IPV6) {
    let mut l3slave: bool = ipv6_l3mdev_skb(IP6CB(skb).flags);
    let mut iif: c_int = IP6CB(skb).iif;
...
#[no_mangle]
unsafe extern "C" fn advance_nextseg(srh: *mut ipv6_sr_hdr, daddr: *mut in6_addr) {
...
#[no_mangle]
unsafe extern "C" fn seg6_flv_lcblock_octects(finfo: *const seg6_flavors_info) -> __u8 {
    static __u8 seg6_flv_lcblock_octects(const struct seg6_flavors_info *finfo)
    {
    return finfo.lcblock_bits >> 3;
    }
#[no_mangle]
unsafe extern "C" fn seg6_flv_lcnode_func_octects(finfo: *const seg6_flavors_info) -> __u8 {
    ...
    {
    let mut fnc_octects: __u8 = seg6_flv_lcnode_func_octects(finfo);
    let mut blk_octects: __u8 = seg6_flv_lcblock_octects(finfo);
    __u8 arg_octects;
    int i;
...
// advance DA.Argument
    ...
    {
    seg6_lookup_nexthop(skb, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn end_next_csid_core(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_next_csid_enabled(fops: __u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn seg6_flv_supp_ops_by_action(action: c_int, fops: *mut __u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seg6_get_srh_pktinfo(srh: *mut ipv6_sr_hdr) -> enum seg6_local_pktinfo {
...
#[no_mangle]
unsafe extern "C" fn seg6_pop_srh(skb: *mut sk_buff, srhoff: c_int) -> bool {
    static bool seg6_pop_srh(struct sk_buff *skb, int srhoff)
    {
    struct ipv6_sr_hdr *srh;
    struct ipv6hdr *iph;
    __u8 srh_nexthdr;
    let mut thoff: c_int = -1;
    int srhlen;
    int nhlen;
...
//
    ...
    thoff = nhlen;
#[no_mangle]
pub unsafe extern "C" fn if(srhlen: nhlen >= srhoff +) -> else {
...
//
    let mut off: c_uint = sizeof(*iph);
    struct ipv6_opt_hdr *hp, _hdr;
    let mut nexthdr: __u8 = iph.nexthdr;
    for (;;) {
...
//
#[no_mangle]
unsafe extern "C" fn end_flv8986_core(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
unsafe extern "C" fn input_action_end(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
    ...
    {
    const struct seg6_flavors_info *finfo = &slwt.flv_info;
    let mut fops: __u32 = finfo.flv_ops;
    if (!fops)
    return input_action_end_core(skb, slwt);
...
#[no_mangle]
unsafe extern "C" fn input_action_end_x(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
unsafe extern "C" fn input_action_end_t(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
    ...
    goto drop;
    advance_nextseg(srh, &ipv6_hdr(skb).daddr);
    seg6_lookup_nexthop(skb, core::ptr::null_mut(), slwt.table);
    return dst_input(skb);
    drop:
    kfree_skb(skb);
    return -EINVAL;
...
//
    ...
    struct in6_addr *nhaddr = core::ptr::null_mut();
    struct seg6_local_lwt *slwt;
...
//
    ...
    dev_net(skb.dev), core::ptr::null_mut(), skb, skb.dev,
    core::ptr::null_mut(), input_action_end_dx6_finish);
    return input_action_end_dx6_finish(dev_net(skb.dev), core::ptr::null_mut(), skb);
    drop:
    kfree_skb(skb);
    return -EINVAL;
    }
    ...
    dev_net(skb.dev), core::ptr::null_mut(), skb, skb.dev,
    core::ptr::null_mut(), input_action_end_dx4_finish);
    return input_action_end_dx4_finish(dev_net(skb.dev), core::ptr::null_mut(), skb);
    drop:
    kfree_skb(skb);
    return -EINVAL;
    }
...
//
    ...
    {
    let mut vrf_ifindex: c_int = info.vrf_ifindex;
...
// packet has been processed and consumed by the VRF
    ...
    static enum
#[no_mangle]
pub unsafe extern "C" fn seg6_end_dt6_parse_mode(slwt: *mut seg6_local_lwt) -> seg6_end_dt_mode {
    seg6_end_dt_mode seg6_end_dt6_parse_mode(struct seg6_local_lwt *slwt)
    {
    let mut parsed_optattrs: c_ulong = slwt.parsed_optattrs;
    bool legacy, vrfmode;
...
#[no_mangle]
unsafe extern "C" fn seg6_end_dt6_get_mode(slwt: *mut seg6_local_lwt) -> enum seg6_end_dt_mode {
    ...
    struct netlink_ext_ack *extack)
    {
    let mut mode: enum seg6_end_dt_mode = seg6_end_dt6_parse_mode(slwt);
    struct seg6_end_dt_info *info = &slwt.dt_info;
    switch (mode) {
    case DT_LEGACY_MODE:
...
//
    seg6_lookup_any_nexthop(skb, core::ptr::null_mut(), 0, true, 0);
    return dst_input(skb);
    legacy_mode:

    skb_set_transport_header(skb, sizeof(struct ipv6hdr));
    seg6_lookup_any_nexthop(skb, core::ptr::null_mut(), slwt.table, true, 0);
    return dst_input(skb);
    drop:
    kfree_skb(skb);
    return -EINVAL;
    ...
    let mut off: c_uint = 0;
    int nexthdr;
    nexthdr = ipv6_find_hdr(skb, &off, -1, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn input_action_end_b6(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_bpf_has_valid_srh(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn seg6_lwtunnel_counters_enabled(slwt: *mut seg6_local_lwt) -> bool {
...
#[no_mangle]
unsafe extern "C" fn seg6_local_input(skb: *mut sk_buff) -> c_int {
    ...
    dev_net(skb.dev), core::ptr::null_mut(), skb, skb.dev, core::ptr::null_mut(),
    seg6_local_input_core);
    return seg6_local_input_core(dev_net(skb.dev), core::ptr::null_mut(), skb);
    }
...
#[no_mangle]
unsafe extern "C" fn put_nla_srh(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_srh(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
    static int cmp_nla_srh(struct seg6_local_lwt *a, struct seg6_local_lwt *b)
    {
    let mut len: c_int = (a.srh.hdrlen + 1) << 3;
    if (len != ((b.srh.hdrlen + 1) << 3))
    return 1;
    return memcmp(a.srh, b.srh, len);
    }
#[no_mangle]
unsafe extern "C" fn destroy_attr_srh(slwt: *mut seg6_local_lwt) {
...
#[no_mangle]
unsafe extern "C" fn put_nla_table(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_table(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn put_nla_vrftable(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_vrftable(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn put_nla_nh4(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_nh4(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn put_nla_nh6(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_nh6(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn put_nla_iif(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_iif(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn put_nla_oif(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_oif(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
pub const MAX_PROG_NAME: c_int = 256;
    ...
    bpf_prog_policy, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn put_nla_bpf(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_bpf(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_attr_bpf(slwt: *mut seg6_local_lwt) {
    ...
    seg6_local_counters_policy, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn put_nla_counters(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
    static int put_nla_counters(struct sk_buff *skb, struct seg6_local_lwt *slwt)
    {
    let mut counters: seg6_local_counters = { 0, 0, 0 };
    struct nlattr *nest;
    int rc, i;
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_counters(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_attr_counters(slwt: *mut seg6_local_lwt) {
...
//
#[no_mangle]
unsafe extern "C" fn seg6_chk_next_csid_cfg(block_len: __u8, func_len: __u8) -> c_int {
...
//
    ...
    struct netlink_ext_ack *extack)
    {
    let mut func_len: __u8 = SEG6_LOCAL_LCNODE_FN_DBITS;
    let mut block_len: __u8 = SEG6_LOCAL_LCBLOCK_DBITS;
    int rc;
    ...
    let mut action: c_int = slwt.action;
    __u32 fops, supp_fops;
    int rc;
    rc = nla_parse_nested_deprecated(tb, SEG6_LOCAL_FLV_MAX,
    attrs[SEG6_LOCAL_FLAVORS],
    seg6_local_flavors_policy, core::ptr::null_mut());
    if (rc < 0)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn put_nla_flavors(skb: *mut sk_buff, slwt: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_nla_flavors(a: *mut seg6_local_lwt, b: *mut seg6_local_lwt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn encap_size_flavors(slwt: *mut seg6_local_lwt) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct seg6_action_param {
    int (*parse)(struct nlattr **attrs, struct seg6_local_lwt *slwt,
    pub extack): *mut netlink_ext_ack,
    pub slwt): *mut *mut *mut int (put)(struct sk_buff skb, struct seg6_local_lwt,
    pub b): *mut *mut *mut int (cmp)(struct seg6_local_lwt a, struct seg6_local_lwt,
// optional destroy() callback useful for releasing resources which
// have been previously acquired in the corresponding parse()
// function.
//
    pub slwt): *mut *mut void (destroy)(struct seg6_local_lwt,
}
...
//
#[no_mangle]
unsafe extern "C" fn destroy_attrs(slwt: *mut seg6_local_lwt) {
    static void destroy_attrs(struct seg6_local_lwt *slwt)
    {
    let mut attrs: c_ulong = slwt.desc.attrs | slwt.parsed_optattrs;
    ...
    let mut parsed_optattrs: c_ulong = 0;
    struct seg6_action_param *param;
    int err, i;
...
//
#[no_mangle]
unsafe extern "C" fn seg6_local_lwtunnel_destroy_state(slwt: *mut seg6_local_lwt) {
...
#[no_mangle]
unsafe extern "C" fn seg6_local_destroy_state(lwt: *mut lwtunnel_state) {
...
#[no_mangle]
unsafe extern "C" fn seg6_local_get_encap_size(lwt: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_local_init() -> int __init {
