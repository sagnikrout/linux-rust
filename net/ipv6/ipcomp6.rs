...
//
    ...
    struct xfrm_state *t = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ipcomp6_tunnel_attach(x: *mut xfrm_state) -> c_int {
    ...
    struct xfrm_state *t = core::ptr::null_mut();
    __be32 spi;
    let mut mark: u32 = x.mark.m & x.mark.v;
...
#[no_mangle]
unsafe extern "C" fn ipcomp6_rcv_cb(skb: *mut sk_buff, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipcomp6_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipcomp6_fini() -> void __exit {
