...
#[no_mangle]
unsafe extern "C" fn esp_ssg_unref(x: *mut xfrm_state, tmp: *mut c_void, skb: *mut sk_buff, already_unref: bool) {
    static void esp_ssg_unref(struct xfrm_state *x, void *tmp, struct sk_buff *skb, bool already_unref)
    {
    struct crypto_aead *aead = x.data;
    let mut extralen: c_int = 0;
    u8 *iv;
    struct aead_request *req;
...
#[no_mangle]
unsafe extern "C" fn esp_output_tcp_finish(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp_output_tail_tcp(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp_output_encap_csum(skb: *mut sk_buff) {
...
// esp6_output_udp_encap limits len to U16_MAX.
    let mut len: c_int = udp_get_len_short(uh);
    let mut offset: c_uint = skb_transport_offset(skb);
    let mut csum: __wsum = skb_checksum(skb, offset, skb.len - offset, 0);
...
#[no_mangle]
unsafe extern "C" fn esp_output_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esp_restore_header(skb: *mut sk_buff, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn esp_output_restore_header(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn esp_output_done_esn(data: *mut c_void, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn esp6_output_head(x: *mut xfrm_state, skb: *mut sk_buff, esp: *mut esp_info) -> c_int {
    ...
    let mut tailen: c_int = esp.tailen;
    if (x.encap) {
    let mut err: c_int = esp6_output_encap(x, skb, esp);
    if (err < 0)
    return err;
    }
...
#[no_mangle]
pub unsafe extern "C" fn esp6_output_tail(x: *mut xfrm_state, skb: *mut sk_buff, esp: *mut esp_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp6_output(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn esp_remove_trailer(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn esp6_input_done2(skb: *mut sk_buff, err: c_int) -> c_int {
    int esp6_input_done2(struct sk_buff *skb, int err)
    {
    struct xfrm_state *x = xfrm_input_state(skb);
    struct xfrm_offload *xo = xfrm_offload(skb);
    struct crypto_aead *aead = x.data;
    let mut hlen: c_int = sizeof(struct ip_esp_hdr) + crypto_aead_ivsize(aead);
    let mut hdr_len: c_int = skb_network_header_len(skb);
    ...
    let mut offset: c_int = skb_network_offset(skb) + sizeof(*ip6h);
    struct xfrm_encap_tmpl *encap = x.encap;
    let mut nexthdr: u8 = ip6h.nexthdr;
...
#[no_mangle]
unsafe extern "C" fn esp_input_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esp_input_restore_header(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn esp_input_set_header(skb: *mut sk_buff, seqhi: *mut __be32) {
...
#[no_mangle]
unsafe extern "C" fn esp_input_done_esn(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esp6_input(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
    static int esp6_input(struct xfrm_state *x, struct sk_buff *skb)
    {
    struct crypto_aead *aead = x.data;
    struct aead_request *req;
    struct sk_buff *trailer;
    let mut ivlen: c_int = crypto_aead_ivsize(aead);
    let mut elen: c_int = skb.len - sizeof(struct ip_esp_hdr) - ivlen;
    int nfrags;
    int assoclen;
    int seqhilen;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn esp6_destroy(x: *mut xfrm_state) {
...
#[no_mangle]
unsafe extern "C" fn esp_init_aead(x: *mut xfrm_state, extack: *mut netlink_ext_ack) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp6_init_state(x: *mut xfrm_state, extack: *mut netlink_ext_ack) -> c_int {
    static int esp6_init_state(struct xfrm_state *x, struct netlink_ext_ack *extack)
    {
    struct crypto_aead *aead;
    u32 align;
    int err;
    x.data = core::ptr::null_mut();
    if (x.aead) {
...
#[no_mangle]
unsafe extern "C" fn esp6_rcv_cb(skb: *mut sk_buff, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp6_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn esp6_fini() -> void __exit {
