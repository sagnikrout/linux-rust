...
#[no_mangle]
unsafe extern "C" fn sockstat6_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snmp6_seq_show_icmpv6msg(seq: *mut seq_file, smib: *mut atomic_long_t) {
...
#[no_mangle]
unsafe extern "C" fn snmp6_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    core::ptr::null_mut(), snmp6_icmp6_list,
    ARRAY_SIZE(snmp6_icmp6_list));
    snmp6_seq_show_icmpv6msg(seq, net.mib.icmpv6msg_statistics.mibs);
    snmp6_seq_show_item(seq, net.mib.udp_stats_in6,
    core::ptr::null_mut(), snmp6_udp6_list,
    ARRAY_SIZE(snmp6_udp6_list));
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snmp6_dev_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
// Per idev icmp stats do not have ICMP6_MIB_RATELIMITHOST
    snmp6_seq_show_item(seq, core::ptr::null_mut(), idev.stats.icmpv6dev.mibs,
    snmp6_icmp6_list, ARRAY_SIZE(snmp6_icmp6_list) - 1);
    snmp6_seq_show_icmpv6msg(seq, idev.stats.icmpv6msgdev.mibs);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn snmp6_register_dev(idev: *mut inet6_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snmp6_unregister_dev(idev: *mut inet6_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_proc_init_net(net: *mut net) -> int __net_init {
    static int __net_init ipv6_proc_init_net(struct net *net)
    {
    if (!proc_create_net_single("sockstat6", 0444, net.proc_net,
    sockstat6_seq_show, core::ptr::null_mut()))
    return -ENOMEM;
    if (!proc_create_net_single("snmp6", 0444, net.proc_net,
    snmp6_seq_show, core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn ipv6_proc_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_misc_proc_init() -> int __init {
    int __init ipv6_misc_proc_init(void)
    {
    return register_pernet_subsys(&ipv6_proc_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn ipv6_misc_proc_exit() {
