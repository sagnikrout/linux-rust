...
pub unsafe extern "C" fn xfrm6_transport_finish(skb: *mut sk_buff, async: c_int) -> c_int {
    ...
    let mut nhlen: c_int = -skb_network_offset(skb);
...
#[no_mangle]
unsafe extern "C" fn __xfrm6_udp_encap_rcv(sk: *mut sock, skb: *mut sk_buff, pull: bool) -> c_int {
    ...
    struct ipv6hdr *ip6h;
    int len;
    let mut ip6hlen: c_int = sizeof(struct ipv6hdr);
    __u8 *udpdata;
    __be32 *udpdata32;
    u16 encap_type;
...
//
#[no_mangle]
pub unsafe extern "C" fn xfrm6_udp_encap_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm6_rcv_tnl(skb: *mut sk_buff, t: *mut ip6_tnl) -> c_int {
...
pub unsafe extern "C" fn xfrm6_rcv(skb: *mut sk_buff) -> c_int {
    ...
    {
    return xfrm6_rcv_tnl(skb, core::ptr::null_mut());
    }
