...
#[no_mangle]
pub unsafe extern "C" fn cstamp_delta(cstamp: c_ulong) -> u32 {
    static inline u32 cstamp_delta(unsigned long cstamp)
    {
    return (cstamp - INITIAL_JIFFIES) * 100UL / HZ;
    }
#[no_mangle]
pub unsafe extern "C" fn rfc3315_s14_backoff_init(irt: i32) -> i32 {
    static inline s32 rfc3315_s14_backoff_init(s32 irt)
    {
// multiply 'initial retransmission time' by 0.9 .. 1.1
    let mut tmp: u64 = get_random_u32_inclusive(900000, 1100000) * (u64)irt;
    do_div(tmp, 1000000);
    return (s32)tmp;
    }
#[no_mangle]
pub unsafe extern "C" fn rfc3315_s14_backoff_update(rt: i32, mrt: i32) -> i32 {
    static inline s32 rfc3315_s14_backoff_update(s32 rt, s32 mrt)
    {
// multiply 'retransmission timeout' by 1.9 .. 2.1
    let mut tmp: u64 = get_random_u32_inclusive(1900000, 2100000) * (u64)rt;
    do_div(tmp, 1000000);
    if ((s32)tmp > mrt) {
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_sysctl_register(idev: *mut inet6_dev) -> c_int {
    static inline int addrconf_sysctl_register(struct inet6_dev *idev)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn addrconf_sysctl_unregister(idev: *mut inet6_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_link_ready(dev: *const net_device) -> bool {
    static inline bool addrconf_link_ready(const struct net_device *dev)
    {
    return netif_oper_up(dev) && !qdisc_tx_is_noop(dev);
    }
#[no_mangle]
unsafe extern "C" fn addrconf_del_rs_timer(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_del_dad_work(ifp: *mut inet6_ifaddr) {
...
#[no_mangle]
unsafe extern "C" fn snmp6_alloc_dev(idev: *mut inet6_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inet6_netconf_msgsize_devconf(type: c_int) -> c_int {
...
// -EMSGSIZE implies BUG in inet6_netconf_msgsize_devconf()
    ...
    rtnl_notify(skb, net, 0, RTNLGRP_IPV6_NETCONF, core::ptr::null_mut(), GFP_KERNEL);
    return;
    errout:
    ...
    struct inet6_dev *in6_dev = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn inet6_base_seq(net: *const net) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dev_forward_change(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_forward_change(net: *mut net, newf: __s32) {
    ...
    if (idev) {
    let mut changed: c_int = (!idev.cnf.forwarding) ^ (!newf);
...
#[no_mangle]
unsafe extern "C" fn addrconf_fixup_forwarding(table: *const ctl_table, p: *mut c_int, newf: c_int) -> c_int {
    ...
    let mut old_dflt: c_int = net.ipv6.devconf_dflt.forwarding;
...
#[no_mangle]
unsafe extern "C" fn addrconf_linkdown_change(net: *mut net, newf: __s32) {
    ...
    idev = __in6_dev_get_rtnl_net(dev);
    if (idev) {
    let mut changed: c_int = (!idev.cnf.ignore_routes_with_linkdown) ^ (!newf);
...
#[no_mangle]
unsafe extern "C" fn addrconf_fixup_linkdown(table: *const ctl_table, p: *mut c_int, newf: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_ifa_finish_destroy(ifp: *mut inet6_ifaddr) {
    ...
    {
    struct list_head *p;
    let mut ifp_scope: c_int = ipv6_addr_src_scope(&ifp.addr);
//
...
#[no_mangle]
unsafe extern "C" fn inet6_addr_hash(net: *const net, addr: *const in6_addr) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ipv6_add_addr_hash(dev: *mut net_device, ifa: *mut inet6_ifaddr) -> c_int {
    static int ipv6_add_addr_hash(struct net_device *dev, struct inet6_ifaddr *ifa)
    {
    struct net *net = dev_net(dev);
    let mut hash: c_uint = inet6_addr_hash(net, &ifa.addr);
    let mut err: c_int = 0;
...
// On success it returns ifp with increased reference count
    ...
    {
    let mut gfp_flags: gfp_t = can_block ? GFP_KERNEL : GFP_ATOMIC;
    let mut addr_type: c_int = ipv6_addr_type(cfg.pfx);
    struct net *net = dev_net(idev.dev);
    struct inet6_ifaddr *ifa = core::ptr::null_mut();
    struct fib6_info *f6i = core::ptr::null_mut();
    let mut err: c_int = 0;
...
//
    ...
    let mut action: enum cleanup_prefix_rt_t = CLEANUP_PREFIX_RT_DEL;
// expires = jiffies;
    list_for_each_entry(ifa, &idev.addr_list, if_list) {
    if (ifa == ifp)
    continue;
...
#[no_mangle]
unsafe extern "C" fn ipv6_del_addr(ifp: *mut inet6_ifaddr) {
    static void ipv6_del_addr(struct inet6_ifaddr *ifp)
    {
    let mut action: enum cleanup_prefix_rt_t = CLEANUP_PREFIX_RT_NOP;
    struct net *net = dev_net(ifp.idev.dev);
...
#[no_mangle]
unsafe extern "C" fn ipv6_get_regen_advance(idev: *const inet6_dev) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn ipv6_create_tempaddr(ifp: *mut inet6_ifaddr, block: bool) -> c_int {
...
// set in addrconf_prefix_rcv()
    ...
    ift = ipv6_add_addr(idev, &cfg, block, core::ptr::null_mut());
    if (IS_ERR(ift)) {
    in6_ifa_put(ifp);
    in6_dev_put(idev);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipv6_saddr_score {
    pub rule: c_int,
    pub addr_type: c_int,
    pub ifa: *mut inet6_ifaddr,
    pub IPV6_SADDR_RULE_MAX): DECLARE_BITMAP(scorebits,,
    pub scopedist: c_int,
    pub matchlen: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipv6_saddr_dst {
    pub addr: *const in6_addr,
    pub ifindex: c_int,
    pub scope: c_int,
    pub label: c_int,
    pub prefs: c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_saddr_preferred(type: c_int) -> c_int {
...
// Rule 3: Avoid deprecated and optimistic addresses
    let mut avoid: u8 = IFA_F_DEPRECATED;
...
// Rule 4: Prefer home address
    let mut prefhome: c_int = !(dst.prefs & IPV6_PREFER_SRC_COA);
...
// restore our iterator
    ...
    struct net_device *dev;
    int dst_type;
    let mut use_oif_addr: bool = false;
    let mut hiscore_idx: c_int = 0;
    let mut ret: c_int = 0;
    ...
    scores[hiscore_idx].ifa = core::ptr::null_mut();
    rcu_read_lock();
// Candidate Source Address (section 4)
...
#[no_mangle]
unsafe extern "C" fn ipv6_count_addresses(idev: *const inet6_dev) -> c_int {
    static int ipv6_count_addresses(const struct inet6_dev *idev)
    {
...
//
    ...
    {
    let mut hash: c_uint = inet6_addr_hash(net, addr);
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_chk_prefix(addr: *const in6_addr, dev: *mut net_device) -> c_int {
...
//
    ...
    {
    let mut hash: c_uint = inet6_addr_hash(net, addr);
    struct inet6_ifaddr *ifp, *result = core::ptr::null_mut();
    rcu_read_lock();
    hlist_for_each_entry_rcu(ifp, &net.ipv6.inet6_addr_lst[hash], addr_lst) {
    if (ipv6_addr_equal(&ifp.addr, addr)) {
    if (!dev || ifp.idev.dev == dev ||
...
#[no_mangle]
unsafe extern "C" fn addrconf_dad_stop(ifp: *mut inet6_ifaddr, dad_failed: c_int) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_dad_end(ifp: *mut inet6_ifaddr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_dad_failure(skb: *mut sk_buff, ifp: *mut inet6_ifaddr) {
    ...
    let mut retries: c_int = ifp.stable_privacy_retry + 1;
    struct ifa6_config cfg = {
    .pfx = &new_addr,
    .plen = ifp.prefix_len,
    .ifa_flags = ifp.flags,
    ...
    ifp.idev.dev.name);
    ifp2 = ipv6_add_addr(idev, &cfg, false, core::ptr::null_mut());
    if (IS_ERR(ifp2))
    goto lock_errdad;
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_join_solict(dev: *mut net_device, addr: *const in6_addr) {
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_leave_solict(idev: *mut inet6_dev, addr: *const in6_addr) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_join_anycast(ifp: *mut inet6_ifaddr) {
    static void addrconf_join_anycast(struct inet6_ifaddr *ifp)
    {
    struct in6_addr addr;
...
#[no_mangle]
unsafe extern "C" fn addrconf_leave_anycast(ifp: *mut inet6_ifaddr) {
    static void addrconf_leave_anycast(struct inet6_ifaddr *ifp)
    {
    struct in6_addr addr;
    if (ifp.prefix_len >= 127) /* RFC 6164 */
...
#[no_mangle]
unsafe extern "C" fn addrconf_ifid_6lowpan(eui: *mut u8, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addrconf_ifid_ieee1394(eui: *mut u8, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addrconf_ifid_arcnet(eui: *mut u8, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addrconf_ifid_infiniband(eui: *mut u8, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ipv6_isatap_ifid(eui: *mut u8, addr: __be32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addrconf_ifid_sit(eui: *mut u8, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addrconf_ifid_gre(eui: *mut u8, dev: *mut net_device) -> c_int {
    static int addrconf_ifid_gre(u8 *eui, struct net_device *dev)
    {
    return __ipv6_isatap_ifid(eui, *(__be32 *)dev.dev_addr);
    }
#[no_mangle]
unsafe extern "C" fn addrconf_ifid_ip6tnl(eui: *mut u8, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_generate_eui64(eui: *mut u8, dev: *mut net_device) -> c_int {
    static int ipv6_generate_eui64(u8 *eui, struct net_device *dev)
    {
    switch (dev.type) {
    case ARPHRD_ETHER:
...
#[no_mangle]
unsafe extern "C" fn ipv6_inherit_eui64(eui: *mut u8, idev: *mut inet6_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ipv6_gen_rnd_iid(addr: *mut in6_addr) {
    static void ipv6_gen_rnd_iid(struct in6_addr *addr)
    {
    regen:
...
//
    ...
    ip6_route_add(&cfg, gfp_flags, core::ptr::null_mut());
    }
    static struct fib6_info *addrconf_get_prefix_route(const struct in6_addr *pfx,
    int plen,
    const struct net_device *dev,
    ...
    struct fib6_table *table;
    let mut tb_id: u32 = l3mdev_fib_table(dev) ? : RT6_TABLE_PREFIX;
    table = fib6_get_table(dev_net(dev), tb_id);
    if (!table)
    return core::ptr::null_mut();
    rcu_read_lock();
    fn = fib6_locate(&table.tb6_root, pfx, plen, core::ptr::null_mut(), 0, true);
    if (!fn)
    goto out;
...
#[no_mangle]
unsafe extern "C" fn addrconf_add_mroute(dev: *mut net_device) {
    ...
    ip6_route_add(&cfg, GFP_KERNEL, core::ptr::null_mut());
    }
...
// Add default multicast route
    ...
    {
    let mut orig_prefered_lft: u32 = prefered_lft;
    struct inet6_ifaddr *ift;
...
#[no_mangle]
unsafe extern "C" fn is_addr_mode_generate_stable(idev: *mut inet6_dev) -> bool {
    ...
    let mut create: c_int = 0, update_lft = 0;
    if (!ifp && valid_lft) {
    let mut max_addresses: c_int = READ_ONCE(in6_dev.cnf.max_addresses);
    struct ifa6_config cfg = {
    .pfx = addr,
...
//
    ...
    ifp = ipv6_add_addr(in6_dev, &cfg, false, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_prefix_rcv(dev: *mut net_device, opt: *mut u8, len: c_int, sllao: bool) {
    ...
    __u32 prefered_lft;
    int addr_type, err;
    let mut addr_flags: u32 = 0;
    struct inet6_dev *in6_dev;
    struct net *net = dev_net(dev);
    let mut ignore_autoconf: bool = false;
...
// not infinity
    ...
    let mut expires: clock_t = 0;
    let mut flags: c_int = RTF_ADDRCONF | RTF_PREFIX_RT;
    if (addrconf_finite_timeout(rt_expires)) {
// not infinity
    flags |= RTF_EXPIRES;
...
// Try to figure out our local address for this prefix
    ...
    struct in6_addr addr;
    let mut tokenized: bool = false, dev_addr_generated = false;
...
//
    ...
    if (!dev)
    return -ENOBUFS;
    return dev_open(dev, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn addrconf_set_dstaddr(net: *mut net, arg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_add_ifaddr(net: *mut net, arg: *mut void __user) -> c_int {
    ...
    if (dev) {
    netdev_lock_ops(dev);
    err = inet6_addr_add(net, dev, &cfg, 0, 0, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_del_ifaddr(net: *mut net, arg: *mut void __user) -> c_int {
    ...
    ireq.ifr6_prefixlen, core::ptr::null_mut());
    rtnl_net_unlock(net);
    return err;
    }
    ...
    ifp = ipv6_add_addr(idev, &cfg, true, core::ptr::null_mut());
    if (!IS_ERR(ifp)) {
    spin_lock_bh(&ifp.lock);
    ifp.flags &= ~IFA_F_TENTATIVE;
    spin_unlock_bh(&ifp.lock);
...
#[no_mangle]
unsafe extern "C" fn add_v4_addrs(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn init_loopback(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_reserved_interfaceid(address: in6_addr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: net->ipv6.devconf_dflt->stable_secret.initialized) -> else {
...
//
    temp = *address;
    temp.s6_addr32[2] = ( __be32)sha_ctx.state.h[0];
    temp.s6_addr32[3] = ( __be32)sha_ctx.state.h[1];
    spin_unlock_bh(&lock);
...
#[no_mangle]
unsafe extern "C" fn ipv6_gen_mode_random_init(idev: *mut inet6_dev) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_addr_gen(idev: *mut inet6_dev, prefix_route: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: prefix_route) -> else {
...
#[no_mangle]
unsafe extern "C" fn addrconf_dev_config(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_sit_config(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_gre_config(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_init_auto_addrs(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_permanent_addr(net: *mut net, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_type_change(dev: *mut net_device, event: c_ulong) {
    ...
    ipv6_mc_remap(idev);
#[no_mangle]
pub unsafe extern "C" fn if(NETDEV_PRE_TYPE_CHANGE: event ==) -> else {
    else if (event == NETDEV_PRE_TYPE_CHANGE)
    ipv6_mc_unmap(idev);
    }
#[no_mangle]
unsafe extern "C" fn addr_is_local(addr: *const in6_addr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn addrconf_ifdown(dev: *mut net_device, unregister: bool) -> c_int {
    static int addrconf_ifdown(struct net_device *dev, bool unregister)
    {
    let mut event: c_ulong = unregister ? NETDEV_UNREGISTER : NETDEV_DOWN;
    struct net *net = dev_net(dev);
    struct inet6_dev *idev;
    struct inet6_ifaddr *ifa;
    LIST_HEAD(tmp_addr_list);
    let mut keep_addr: bool = false;
    bool was_ready;
    int state, i;
    ASSERT_RTNL();
...
// protected by rtnl_lock
    RCU_INIT_POINTER(dev.ip6_ptr, core::ptr::null_mut());
...
// aggregate the system setting and interface setting
    let mut _keep_addr: c_int = READ_ONCE(net.ipv6.devconf_all.keep_addr_on_down);
    if (!_keep_addr)
...
#[no_mangle]
unsafe extern "C" fn addrconf_rs_timer(t: *mut timer_list) {
    static void addrconf_rs_timer(struct timer_list *t)
    {
...
//
#[no_mangle]
unsafe extern "C" fn addrconf_dad_kick(ifp: *mut inet6_ifaddr) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_dad_begin(ifp: *mut inet6_ifaddr) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_dad_start(ifp: *mut inet6_ifaddr) {
    static void addrconf_dad_start(struct inet6_ifaddr *ifp)
    {
    let mut begin_dad: bool = false;
    spin_lock_bh(&ifp.lock);
    if (ifp.state != INET6_IFADDR_STATE_DEAD) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_dad_work(w: *mut work_struct) {
    static void addrconf_dad_work(struct work_struct *w)
    {
...
#[no_mangle]
unsafe extern "C" fn ipv6_lonely_lladdr(ifp: *mut inet6_ifaddr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn addrconf_dad_run(idev: *mut inet6_dev, restart: bool) {
    static void addrconf_dad_run(struct inet6_dev *idev, bool restart)
    {
    struct inet6_ifaddr *ifp;
    read_lock_bh(&idev.lock);
...
#[no_mangle]
unsafe extern "C" fn if6_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn if6_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn if6_proc_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn if6_proc_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn if6_proc_init() -> int __init {
    int __init if6_proc_init(void)
    {
    return register_pernet_subsys(&if6_proc_net_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn if6_proc_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_chk_home_addr(net: *mut net, addr: *const in6_addr) -> c_int {
    int ipv6_chk_home_addr(struct net *net, const struct in6_addr *addr)
    {
    let mut hash: c_uint = inet6_addr_hash(net, addr);
    struct inet6_ifaddr *ifp = core::ptr::null_mut();
    let mut ret: c_int = 0;
    rcu_read_lock();
    hlist_for_each_entry_rcu(ifp, &net.ipv6.inet6_addr_lst[hash], addr_lst) {
    if (ipv6_addr_equal(&ifp.addr, addr) &&
...
//
#[no_mangle]
unsafe extern "C" fn addrconf_verify_rtnl(net: *mut net) {
    static void addrconf_verify_rtnl(struct net *net)
    {
...
// This is a non-regenerated temporary addr.
    let mut regen_advance: c_ulong = ipv6_get_regen_advance(ifp.idev);
...
#[no_mangle]
unsafe extern "C" fn addrconf_verify_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn addrconf_verify(net: *mut net) {
    static void addrconf_verify(struct net *net)
    {
    ...
    {
    struct in6_addr *pfx = core::ptr::null_mut();
// peer_pfx = NULL;
    if (addr)
    pfx = nla_data(addr);
    if (local) {
...
#[no_mangle]
pub unsafe extern "C" fn rt_scope(ifa_scope: c_int) -> c_int {
    static inline int rt_scope(int ifa_scope)
    {
    if (ifa_scope & IFA_HOST)
    return RT_SCOPE_HOST;
#[no_mangle]
pub unsafe extern "C" fn if(IFA_LINK: ifa_scope &) -> else {
    else if (ifa_scope & IFA_LINK)
    return RT_SCOPE_LINK;
#[no_mangle]
pub unsafe extern "C" fn if(IFA_SITE: ifa_scope &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_ifaddr_msgsize() -> c_int {
    static inline int inet6_ifaddr_msgsize(void)
    {
#[no_mangle]
pub unsafe extern "C" fn NLMSG_ALIGN(ifaddrmsg): sizeof(struct) -> return {
    ...
    let mut tval: c_long = (jiffies - READ_ONCE(ifa.tstamp)) / HZ;
    if (preferred > tval)
    preferred -= tval;
    else
    preferred = 0;
    ...
    struct inet6_fill_args *args)
    {
    let mut ifindex: c_int = ifmca.idev.dev.ifindex;
    let mut scope: u8 = RT_SCOPE_UNIVERSE;
    struct nlmsghdr *nlh;
    ...
    let mut ifindex: c_int = dev ? dev.ifindex : 1;
    let mut scope: u8 = RT_SCOPE_UNIVERSE;
    struct nlmsghdr *nlh;
...
#[no_mangle]
unsafe extern "C" fn inet6_dump_ifaddr(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int inet6_dump_ifaddr(struct sk_buff *skb, struct netlink_callback *cb)
    {
    let mut type: enum addr_type_t = UNICAST_ADDR;
    return inet6_dump_addr(skb, cb, type);
    }
#[no_mangle]
unsafe extern "C" fn inet6_dump_ifmcaddr(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int inet6_dump_ifmcaddr(struct sk_buff *skb, struct netlink_callback *cb)
    {
    let mut type: enum addr_type_t = MULTICAST_ADDR;
    return inet6_dump_addr(skb, cb, type);
    }
#[no_mangle]
unsafe extern "C" fn inet6_dump_ifacaddr(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int inet6_dump_ifacaddr(struct sk_buff *skb, struct netlink_callback *cb)
    {
    let mut type: enum addr_type_t = ANYCAST_ADDR;
    return inet6_dump_addr(skb, cb, type);
    }
    ...
    struct ifaddrmsg *ifm;
    struct nlattr *tb[IFA_MAX+1];
    struct in6_addr *addr = core::ptr::null_mut(), *peer;
    struct net_device *dev = core::ptr::null_mut();
    struct inet6_ifaddr *ifa;
    struct sk_buff *skb;
    int err;
...
#[no_mangle]
unsafe extern "C" fn inet6_ifa_notify(event: c_int, ifa: *mut inet6_ifaddr) {
...
// -EMSGSIZE implies BUG in inet6_ifaddr_msgsize()
    ...
    rtnl_notify(skb, net, 0, RTNLGRP_IPV6_IFADDR, core::ptr::null_mut(), GFP_ATOMIC);
    return;
    errout:
...
#[no_mangle]
pub unsafe extern "C" fn inet6_ifla6_size() -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_if_nlmsg_size() -> usize {
    static inline size_t inet6_if_nlmsg_size(void)
    {
#[no_mangle]
pub unsafe extern "C" fn NLMSG_ALIGN(ifinfomsg): sizeof(struct) -> return {
    ...
    {
    int i;
    let mut pad: c_int = bytes - sizeof(u64) * ICMP6_MIB_MAX;
    BUG_ON(pad < 0);
// Use put_unaligned() because stats may not be aligned for u64.
    ...
    let mut pad: c_int = bytes - sizeof(u64) * IPSTATS_MIB_MAX;
    BUG_ON(pad < 0);
...
#[no_mangle]
unsafe extern "C" fn check_addr_gen_mode(mode: c_int) -> c_int {
    ...
    let mut mode: u8 = nla_get_u8(tb[IFLA_INET6_ADDR_GEN_MODE]);
    ...
    if (!idev)
    return -EAFNOSUPPORT;
    if (nla_parse_nested_deprecated(tb, IFLA_INET6_MAX, nla, core::ptr::null_mut(), core::ptr::null_mut()) < 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn inet6_dump_ifinfo(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inet6_ifinfo_notify(event: c_int, idev: *mut inet6_dev) {
...
// -EMSGSIZE implies BUG in inet6_if_nlmsg_size()
    ...
    rtnl_notify(skb, net, 0, RTNLGRP_IPV6_IFINFO, core::ptr::null_mut(), GFP_ATOMIC);
    return;
    errout:
    rtnl_set_sk_err(net, RTNLGRP_IPV6_IFINFO, err);
    }
#[no_mangle]
pub unsafe extern "C" fn inet6_prefix_nlmsg_size() -> usize {
    static inline size_t inet6_prefix_nlmsg_size(void)
    {
#[no_mangle]
pub unsafe extern "C" fn NLMSG_ALIGN(prefixmsg): sizeof(struct) -> return {
...
// -EMSGSIZE implies BUG in inet6_prefix_nlmsg_size()
    ...
    rtnl_notify(skb, net, 0, RTNLGRP_IPV6_PREFIX, core::ptr::null_mut(), GFP_ATOMIC);
    return;
    errout:
    rtnl_set_sk_err(net, RTNLGRP_IPV6_PREFIX, err);
    }
#[no_mangle]
unsafe extern "C" fn __ipv6_ifa_notify(event: c_int, ifp: *mut inet6_ifaddr) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_ifa_notify(event: c_int, ifp: *mut inet6_ifaddr) {
...
//
    ...
    let mut min_mtu: c_int = IPV6_MIN_MTU;
    struct ctl_table lctl;
    lctl = *ctl;
    lctl.extra1 = &min_mtu;
    lctl.extra2 = idev ? &idev.dev.mtu : core::ptr::null_mut();
    return proc_dointvec_minmax(&lctl, write, buffer, lenp, ppos);
    }
#[no_mangle]
unsafe extern "C" fn dev_disable_change(idev: *mut inet6_dev) {
    ...
    if (idev.cnf.disable_ipv6)
    addrconf_notify(core::ptr::null_mut(), NETDEV_DOWN, &info);
    else
    addrconf_notify(core::ptr::null_mut(), NETDEV_UP, &info);
    }
#[no_mangle]
unsafe extern "C" fn addrconf_disable_change(net: *mut net, newf: __s32) {
    ...
    idev = __in6_dev_get_rtnl_net(dev);
    if (idev) {
    let mut changed: c_int = (!idev.cnf.disable_ipv6) ^ (!newf);
...
#[no_mangle]
unsafe extern "C" fn addrconf_disable_ipv6(table: *const ctl_table, p: *mut c_int, newf: c_int) -> c_int {
...
//
    ...
    if (err || !write)
    goto out;
    if (in6_pton(str, -1, addr.in6_u.u6_addr8, -1, core::ptr::null_mut()) != 1) {
    err = -EIO;
    goto out;
    }
...
//
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn addrconf_set_nopolicy(rt: *mut rt6_info, action: c_int) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn addrconf_disable_policy_idev(idev: *mut inet6_dev, val: c_int) {
...
// host routes only use builtin fib6_nh
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn addrconf_disable_policy(ctl: *const ctl_table, valp: *mut c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addrconf_force_forward_change(net: *mut net, newf: __s32) {
    ...
    idev = __in6_dev_get_rtnl_net(dev);
    if (idev) {
    let mut changed: c_int = (!idev.cnf.force_forwarding) ^ (!newf);
    ...
    {
    struct inet6_dev *idev = ctl.extra1;
    let mut tmp_ctl: ctl_table = *ctl;
    struct net *net = ctl.extra2;
    int *valp = ctl.data;
    let mut new_val: c_int = *valp;
    let mut old_val: c_int = *valp;
    int ret;
    ...
    let mut minus_one: static int = -1;
    let mut two_five_five: static int = 255;
    let mut ioam6_if_id_max: static u32 = U16_MAX;
    ...
    {
    let mut table_size: usize = ARRAY_SIZE(addrconf_sysctl);
    int i, ifindex;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(dev_name, _arg: "default")) -> else {
    ...
    p.sysctl_header = core::ptr::null_mut();
    kfree(table);
    inet6_netconf_notify_devconf(net, RTM_DELNETCONF, 0, ifindex, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn addrconf_sysctl_register(idev: *mut inet6_dev) -> c_int {
    static int addrconf_sysctl_register(struct inet6_dev *idev)
    {
    int err;
...
#[no_mangle]
unsafe extern "C" fn addrconf_sysctl_unregister(idev: *mut inet6_dev) {
    static void addrconf_sysctl_unregister(struct inet6_dev *idev)
    {
...
#[no_mangle]
unsafe extern "C" fn addrconf_init_net(net: *mut net) -> int __net_init {
...
// these will be inherited by all namespaces
    ...
    err = __addrconf_sysctl_register(net, "all", core::ptr::null_mut(), all);
    if (err < 0)
    goto err_reg_all;
    err = __addrconf_sysctl_register(net, "default", core::ptr::null_mut(), dflt);
    if (err < 0)
    goto err_reg_dflt;
    ...
    err_reg_all:
    kfree(dflt);
    net.ipv6.devconf_dflt = core::ptr::null_mut();

    err_alloc_dflt:
    kfree(all);
    net.ipv6.devconf_all = core::ptr::null_mut();
    err_alloc_all:
...
#[no_mangle]
unsafe extern "C" fn addrconf_exit_net(net: *mut net) -> void __net_exit {
...
//
    ...
    kfree(net.ipv6.inet6_addr_lst);
    net.ipv6.inet6_addr_lst = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn addrconf_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn addrconf_cleanup() {
