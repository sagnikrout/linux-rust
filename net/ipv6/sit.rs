...
//
pub const IP6_SIT_HASH_SIZE: c_int = 16;
...
#[derive(Copy, Clone)]
pub struct sit_net {
    pub tunnels_r_l: [*mut ip_tunnel __rcu; IP6_SIT_HASH_SIZE],
    pub tunnels_r: [*mut ip_tunnel __rcu; IP6_SIT_HASH_SIZE],
    pub tunnels_l: [*mut ip_tunnel __rcu; IP6_SIT_HASH_SIZE],
    pub tunnels_wc: [*mut ip_tunnel __rcu; 1],
    pub tunnels: [*mut ip_tunnel __rcu; 4],
...
//
    ...
    int sifindex)
    {
    let mut h0: c_uint = HASH(remote);
    let mut h1: c_uint = HASH(local);
    struct ip_tunnel *t;
    struct sit_net *sitn = net_generic(net, sit_net_id);
    let mut ifindex: c_int = dev ? dev.ifindex : 0;
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_unlink(sitn: *mut sit_net, t: *mut ip_tunnel) {
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_link(sitn: *mut sit_net, t: *mut ip_tunnel) {
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_clone_6rd(dev: *mut net_device, sitn: *mut sit_net) {
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_create(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_get_prl(dev: *mut net_device, a: *mut ip_tunnel_prl __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prl_list_destroy_rcu(head: *mut rcu_head) {
    ...
    for (p = &t.prl;
    (x = rtnl_dereference(*p)) != core::ptr::null_mut();
    p = &x.next) {
    if (x.addr == a.addr) {
// p = x->next;
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_uninit(dev: *mut net_device) {
    static void ipip6_tunnel_uninit(struct net_device *dev)
    {
    struct ip_tunnel *tunnel = netdev_priv(dev);
    struct sit_net *sitn = net_generic(tunnel.net, sit_net_id);
    if (dev == sitn.fb_tunnel_dev) {
    RCU_INIT_POINTER(sitn.tunnels_wc[0], core::ptr::null_mut());
    } else {
    ipip6_tunnel_unlink(sitn, tunnel);
    ipip6_tunnel_del_prl(tunnel, core::ptr::null_mut());
    }
    dst_cache_reset(&tunnel.dst_cache);
    netdev_put(dev, &tunnel.dev_tracker);
    }
#[no_mangle]
unsafe extern "C" fn ipip6_err(skb: *mut sk_buff, info: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipip6_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sit_tunnel_rcv(skb: *mut sk_buff, ipproto: u8) -> c_int {
    ...
    goto drop;
    skb_reset_mac_header(skb);
    return ip_tunnel_rcv(tunnel, skb, tpi, core::ptr::null_mut(), log_ecn_error);
    }
    return 1;
    drop:
    kfree_skb(skb);
...
#[no_mangle]
unsafe extern "C" fn ipip_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mplsip_rcv(skb: *mut sk_buff) -> c_int {
...
// 6to4 v6 addr has 16 bits prefix, 32 v4addr, 16 SLA, ...
    ...
    if (!neigh) {
    net_dbg_ratelimited("nexthop == core::ptr::null_mut()\n");
    return false;
    }
...
//
    ...
    const struct ipv6hdr *iph6 = ipv6_hdr(skb);
    let mut tos: u8 = tunnel.parms.iph.tos;
    let mut df: __be16 = tiph.frag_off;
    struct rtable *rt;		/* Route to the other host */
    struct net_device *tdev;	/* Device to other host */
    unsigned int max_headroom;	/* The extra header space needed */
    let mut dst: __be32 = tiph.daddr;
    int err_count, mtu;
    struct flowi4 fl4;
    u8 ttl;
    let mut protocol: u8 = IPPROTO_IPV6;
...
// ISATAP (RFC4214) - must come before 6to4
    ...
    sock_net_uid(tunnel.net, core::ptr::null_mut()));
    rt = dst_cache_get_ip4(&tunnel.dst_cache, &fl4.saddr);
    if (!rt) {
    rt = ip_route_output_flow(tunnel.net, &fl4, core::ptr::null_mut());
    if (IS_ERR(rt)) {
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_bind_dev(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ipip6_valid_ip_proto(ipproto: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipip6_dev_free(dev: *mut net_device) {
    static void ipip6_dev_free(struct net_device *dev)
    {
    struct ip_tunnel *tunnel = netdev_priv(dev);
    ...
    NETIF_F_HW_CSUM)
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_setup(dev: *mut net_device) {
    static void ipip6_tunnel_setup(struct net_device *dev)
    {
    struct ip_tunnel *tunnel = netdev_priv(dev);
    let mut t_hlen: c_int = tunnel.hlen + sizeof(struct iphdr);
...
#[no_mangle]
unsafe extern "C" fn ipip6_tunnel_init(dev: *mut net_device) -> c_int {
    static int ipip6_tunnel_init(struct net_device *dev)
    {
    struct ip_tunnel *tunnel = netdev_priv(dev);
    int err;
...
#[no_mangle]
unsafe extern "C" fn ipip6_fb_tunnel_init(dev: *mut net_device) -> void __net_init {
...
// This function returns true when 6RD attributes are present in the nl msg
    ...
    if (err < 0)
    unregister_netdevice_queue(dev, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn ipip6_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ipip6_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipip6_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn sit_exit_rtnl_net(net: *mut net, head: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn sit_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn sit_cleanup() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn sit_init() -> int __init {
