...
// icmpv6_notify checks 8 bytes can be pulled, icmp6hdr is 8 bytes
    ...
    ip6_update_pmtu(skb, net, info, skb.dev.ifindex, 0, sock_net_uid(net, core::ptr::null_mut()));
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn icmpv6_xmit_unlock(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn is_ineligible(skb: *const sk_buff) -> bool {
    static bool is_ineligible(const struct sk_buff *skb)
    {
    let mut ptr: c_int = (u8 *)(ipv6_hdr(skb) + 1) - skb.data;
    let mut len: c_int = skb.len - ptr;
    let mut nexthdr: __u8 = ipv6_hdr(skb).nexthdr;
    __be16 frag_off;
    if (len < 0)
    return true;
...
//
    ...
    return false;
#[no_mangle]
pub unsafe extern "C" fn if(ICMPV6_INFOMSG_MASK): *mut *mut !tp || !(tp &) -> else {
...
#[no_mangle]
unsafe extern "C" fn icmpv6_mask_allow(net: *mut net, type: c_int) -> bool {
...
//
    ...
    let mut tmo: c_int = READ_ONCE(net.ipv6.sysctl.icmpv6_time);
    ...
    rcu_read_unlock();
    if (!res)
    __ICMP6_INC_STATS(net, core::ptr::null_mut(), ICMP6_MIB_RATELIMITHOST);
    else
...
//
#[no_mangle]
unsafe extern "C" fn opt_unrec(skb: *mut sk_buff, offset: __u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn icmpv6_getfrag(from: *mut c_void, to: *mut c_char, offset: c_int, len: c_int, odd: c_int, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mip6_addr_swap(skb: *mut sk_buff, opt: *const inet6_skb_parm) {
...
#[no_mangle]
unsafe extern "C" fn icmp6_iif(skb: *const sk_buff) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icmp6_ext_iio_addr6_subobj {
    pub afi: __be16,
    pub reserved: __be16,
    pub addr6: in6_addr,
}
...
#[no_mangle]
unsafe extern "C" fn icmp6_ext_iio_len() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn icmp6_ext_max_len(ext_objs: u8) -> c_uint {
...
//
    ...
    const struct in6_addr *saddr = core::ptr::null_mut();
...
//
    ...
    {
    icmp6_send(skb, ICMPV6_PARAMPROB, code, pos, core::ptr::null_mut(), IP6CB(skb));
...
#[no_mangle]
unsafe extern "C" fn icmpv6_echo_reply(skb: *mut sk_buff) -> enum skb_drop_reason {
    ...
    struct dst_entry *dst;
    struct ipcm6_cookie ipc6;
    let mut mark: u32 = IP6_REPLY_MARK(net, skb.mark);
    SKB_DR(reason);
    bool acast;
    u8 type;
...
//
#[no_mangle]
unsafe extern "C" fn icmpv6_rcv(skb: *mut sk_buff) -> c_int {
    static int icmpv6_rcv(struct sk_buff *skb)
    {
    ...
    if (!xfrm6_policy_check_reverse(core::ptr::null_mut(), XFRM_POLICY_IN,
    skb)) {
    reason = SKB_DROP_REASON_XFRM_POLICY;
    goto drop_no_count;
    }
...
#[no_mangle]
pub unsafe extern "C" fn icmpv6_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn icmpv6_cleanup() {
...
#[no_mangle]
pub unsafe extern "C" fn icmpv6_err_convert(type: u8, code: u8, err: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_icmp_sysctl_init(net: *mut net) -> *mut ctl_table  __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn ipv6_icmp_sysctl_table_size() -> usize {
