...
pub struct fib6_cleaner {
    pub w: fib6_walker,
    pub net: *mut net,
    pub arg): *mut *mut *mut int (func)(struct fib6_info , void,
    pub sernum: c_int,
    pub arg: *mut c_void,
...
#[no_mangle]
unsafe extern "C" fn fib6_walker_link(net: *mut net, w: *mut fib6_walker) {
...
#[no_mangle]
unsafe extern "C" fn fib6_walker_unlink(net: *mut net, w: *mut fib6_walker) {
...
#[no_mangle]
unsafe extern "C" fn fib6_new_sernum(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addr_bit_set(token: *const c_void, fn_bit: c_int) -> __be32 {
...
//
    return ( __be32)(1 << ((~fn_bit ^ BITOP_BE32_SWIZZLE) & 0x1f)) &
    addr[fn_bit >> 5];
    }
    struct fib6_info *fib6_info_alloc(gfp_t gfp_flags, bool with_fib6_nh)
    {
    struct fib6_info *f6i;
    let mut sz: usize = sizeof(*f6i);
    if (with_fib6_nh)
...
#[no_mangle]
unsafe extern "C" fn node_free_immediate(net: *mut net, fn: *mut fib6_node) {
...
#[no_mangle]
unsafe extern "C" fn node_free(net: *mut net, fn: *mut fib6_node) {
...
#[no_mangle]
unsafe extern "C" fn fib6_free_table(table: *mut fib6_table) {
...
#[no_mangle]
unsafe extern "C" fn fib6_link_table(net: *mut net, tb: *mut fib6_table) {
...
#[no_mangle]
unsafe extern "C" fn fib6_tables_init(net: *mut net) -> void __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_tables_seq_read(net: *const net) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn call_fib6_entry_notifiers_replace(net: *mut net, rt: *mut fib6_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fib6_rt_dump(rt: *mut fib6_info, arg: *mut fib6_dump_arg) -> c_int {
    static int fib6_rt_dump(struct fib6_info *rt, struct fib6_dump_arg *arg)
    {
    let mut fib_event: enum fib_event_type = FIB_EVENT_ENTRY_REPLACE;
    unsigned int nsiblings;
    int err;
...
#[no_mangle]
unsafe extern "C" fn fib6_node_dump(w: *mut fib6_walker) -> c_int {
    static int fib6_node_dump(struct fib6_walker *w)
    {
    int err;
    err = fib6_rt_dump(w.leaf, w.args);
    w.leaf = core::ptr::null_mut();
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn fib6_dump_node(w: *mut fib6_walker) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fib6_dump_end(cb: *mut netlink_callback) {
...
#[no_mangle]
unsafe extern "C" fn fib6_dump_done(cb: *mut netlink_callback) -> c_int {
    ...
    let mut sernum: c_int = READ_ONCE(w.root.fn_sernum);
    if (cb.args[5] != sernum) {
...
#[no_mangle]
unsafe extern "C" fn inet6_dump_fib(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_metric_set(f6i: *mut fib6_info, metric: c_int, val: u32) {
...
//
    ...
    struct fib6_node *pn = core::ptr::null_mut();
    struct rt6key *key;
    int	bit;
    let mut dir: __be32 = 0;
// insert node in tree
    fn = root;
    do {
...
// clean up an intermediate node
    ...
    RCU_INIT_POINTER(fn.leaf, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fib6_nh_drop_pcpu_from(nh: *mut fib6_nh, _arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fib6_drop_pcpu_from(f6i: *mut fib6_info) {
...
//
    ...
    struct fib6_info *iter = core::ptr::null_mut();
    struct fib6_info __rcu **ins;
    struct fib6_info __rcu **fallback_ins = core::ptr::null_mut();
    ...
    let mut notify_sibling_rt: bool = false;
...
//
    ...
    iter.fib6_node = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fib6_start_gc(net: *mut net, rt: *mut fib6_info) {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_force_start_gc(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_update_sernum_upto_root(net: *mut net, rt: *mut fib6_info) {
...
//
    ...
    let mut allow_create: c_int = 1;
    let mut replace_required: c_int = 0;
    if (info.nlh) {
...
//
    ...
    lockdep_is_held(&table.tb6_lock));
    if (pn_leaf == rt) {
    pn_leaf = core::ptr::null_mut();
    RCU_INIT_POINTER(pn.leaf, core::ptr::null_mut());
    fib6_info_release(rt);
    }
...
pub struct lookup_args {
    pub /: *mut *mut int offset; / key offset on fib6_info,
    pub /: *const *const *const in6_addr addr; / search key,
}
...
//
    ...
    bool exact_match)
    {
    struct fib6_node *fn, *prev = core::ptr::null_mut();
    for (fn = root; fn ; ) {
    struct fib6_info *leaf = rcu_dereference(fn.leaf);
    struct rt6key *key;
...
//
    ...
    if (src_len) {
    WARN_ON(saddr == core::ptr::null_mut());
    if (fn) {
    struct fib6_node *subtree = FIB6_SUBTREE(fn);
    if (subtree) {
...
// Subtree root (i.e. fn) may have one child
    ...
    RCU_INIT_POINTER(pn.subtree, core::ptr::null_mut());
    nstate = FWS_L;
    } else {
    WARN_ON(fn.fn_flags & RTN_ROOT);
...
#[no_mangle]
pub unsafe extern "C" fn if(fn: pn_l ==) -> else {
    else if (pn_l == fn)
    ...
    {
    struct fib6_info *leaf, *replace_rt = core::ptr::null_mut();
    struct fib6_walker *w;
    struct fib6_info *rt = rcu_dereference_protected(*rtp,
    lockdep_is_held(&table.tb6_lock));
    struct net *net = info.nl_net;
    let mut notify_del: bool = false;
...
// Unlink it
// rtp = rt->fib6_next;
    rt.fib6_node = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: replace_rt) -> else {
    else if (replace_rt)
...
//
#[no_mangle]
unsafe extern "C" fn fib6_walk_continue(w: *mut fib6_walker) -> c_int {
    static int fib6_walk_continue(struct fib6_walker *w)
    {
...
#[no_mangle]
unsafe extern "C" fn fib6_walk(net: *mut net, w: *mut fib6_walker) -> c_int {
    static int fib6_walk(struct net *net, struct fib6_walker *w)
    {
    int res;
    w.state = FWS_INIT;
...
#[no_mangle]
unsafe extern "C" fn fib6_clean_node(w: *mut fib6_walker) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fib6_flush_trees(net: *mut net) {
    static void fib6_flush_trees(struct net *net)
    {
    let mut new_sernum: c_int = fib6_new_sernum(net);
    __fib6_clean_all(net, core::ptr::null_mut(), new_sernum, core::ptr::null_mut(), false);
    }
//
// Garbage collection
//
    ...
    unsigned long now)
    {
    let mut may_expire: bool = rt.fib6_flags & RTF_EXPIRES && rt.expires;
    let mut old_more: c_int = gc_args.more;
    rt6_age_exceptions(rt, gc_args, now);
    if (!may_expire && old_more == gc_args.more)
    fib6_remove_gc_list(rt);
    }
#[no_mangle]
unsafe extern "C" fn fib6_age(rt: *mut fib6_info, gc_args: *mut fib6_gc_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fib6_gc_all(net: *mut net, gc_args: *mut fib6_gc_args) {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_run_gc(expires: c_ulong, net: *mut net, force: bool) {
...
#[no_mangle]
unsafe extern "C" fn fib6_gc_timer_cb(t: *mut timer_list) {
    static void fib6_gc_timer_cb(struct timer_list *t)
    {
...
#[no_mangle]
unsafe extern "C" fn fib6_net_init(net: *mut net) -> int __net_init {
    static int __net_init fib6_net_init(struct net *net)
    {
    let mut size: usize = sizeof(struct hlist_head) * FIB6_TABLE_HASHSZ;
    int err;
...
#[no_mangle]
unsafe extern "C" fn fib6_net_exit(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn fib6_gc_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn ipv6_route_native_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int ipv6_route_native_seq_show(struct seq_file *seq, void *v)
    {
    struct fib6_info *rt = v;
    struct ipv6_route_iter *iter = seq.private;
    struct fib6_nh *fib6_nh = rt.fib6_nh;
    let mut flags: c_uint = rt.fib6_flags;
    ...
    flags, dev ? dev.name : "");
    iter.w.leaf = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ipv6_route_yield(w: *mut fib6_walker) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_route_check_sernum(iter: *mut ipv6_route_iter) {
    static void ipv6_route_check_sernum(struct ipv6_route_iter *iter)
    {
    let mut sernum: c_int = READ_ONCE(iter.w.root.fn_sernum);
    ...
    struct ipv6_route_iter *iter = seq.private;
    rcu_read_lock();
    iter.tbl = ipv6_route_seq_next_table(core::ptr::null_mut(), net);
    iter.skip = *pos;
    if (iter.tbl) {
    let mut p: loff_t = 0;
    ipv6_route_seq_setup_walk(iter, net);
    return ipv6_route_seq_next(seq, core::ptr::null_mut(), &p);
    } else {
    return core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn ipv6_route_iter_active(iter: *mut ipv6_route_iter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipv6_route_native_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_route_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipv6_route_seq_stop(seq: *mut seq_file, v: *mut c_void) {
