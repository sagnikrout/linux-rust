...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: key->family ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcp_diag_get_aux_size(sk: *mut sock, net_admin: bool) -> usize {
...
#[no_mangle]
unsafe extern "C" fn twsk_build_assert() {
    ...
    const struct inet_diag_req_v2 *r)
    {
    let mut net_admin: bool = netlink_net_capable(cb.skb, CAP_NET_ADMIN);
...
// Dump bound but inactive (not listening, connecting, etc.) sockets
    ...
    sk = inet_lookup(net, core::ptr::null_mut(), 0, req.id.idiag_dst[0],
    ...
    sk = inet_lookup(net, core::ptr::null_mut(), 0, req.id.idiag_dst[3],
    req.id.idiag_dport, req.id.idiag_src[3],
    req.id.idiag_sport, req.id.idiag_if);
    else
    sk = inet6_lookup(net, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn tcp_diag_init() -> int __init {
    static int __init tcp_diag_init(void)
    {
    return inet_diag_register(&tcp_diag_handler);
    }
#[no_mangle]
unsafe extern "C" fn tcp_diag_exit() -> void __exit {
