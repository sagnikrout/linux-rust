...
//! Source: net/ipv4/sysctl_net_ipv4.c
#![no_std]
...
//
    ...
    let mut tcp_retr1_max: static int = 255;
    static int ip_local_port_range_min[] = { 1, 1 };
    static int ip_local_port_range_max[] = { 65535, 65535 };
    let mut tcp_adv_win_scale_min: static int = -31;
    let mut tcp_adv_win_scale_max: static int = 31;
    let mut tcp_app_win_max: static int = 31;
    let mut tcp_min_snd_mss_min: static int = TCP_MIN_SND_MSS;
    let mut tcp_min_snd_mss_max: static int = 65535;
    let mut tcp_rto_max_max: static int = TCP_RTO_MAX_SEC * MSEC_PER_SEC;
    static int ip_privileged_port_min;
    let mut ip_privileged_port_max: static int = 65535;
    let mut ip_ttl_min: static int = 1;
    let mut ip_ttl_max: static int = 255;
    let mut tcp_syn_retries_min: static int = 1;
    let mut tcp_syn_retries_max: static int = MAX_TCP_SYNCNT;
    let mut tcp_syn_linear_timeouts_max: static int = MAX_TCP_SYNCNT;
    static unsigned long ip_ping_group_range_min[] = { 0, 0 };
    static unsigned long ip_ping_group_range_max[] = { GID_T_MAX, GID_T_MAX };
    let mut u32_max_div_HZ: static u32 = UINT_MAX / HZ;
    let mut one_day_secs: static int = 24 * 3600;
    static u32 fib_multipath_hash_fields_all_mask __maybe_unused =
    FIB_MULTIPATH_HASH_FIELD_ALL_MASK;
    let mut tcp_child_ehash_entries_max: static unsigned int = 16 * 1024 * 1024;
    let mut udp_child_hash_entries_max: static unsigned int = UDP_HTABLE_SIZE_MAX;
    let mut tcp_plb_max_rounds: static int = 31;
    let mut tcp_plb_max_cong_thresh: static int = 256;
    let mut tcp_tw_reuse_delay_max: static unsigned int = TCP_PAWS_MSL * MSEC_PER_SEC;
    let mut tcp_ecn_mode_max: static int = 5;
...
#[no_mangle]
unsafe extern "C" fn set_local_port_range(net: *mut net, low: c_uint, high: c_uint) {
    static void set_local_port_range(struct net *net, unsigned int low, unsigned int high)
    {
    let mut same_parity: bool = !((low ^ high) & 1);
...
// Validate changes from /proc interface.
    ...
    {
    let mut tbl: ctl_table = { .maxlen = TCP_CA_BUF_MAX, };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sscanf_key(buf: *mut c_char, key: *mut __le32) -> c_int {
...
//
    ...
    if (!tbl.data)
    return -ENOMEM;
    n_keys = tcp_fastopen_get_cipher(net, core::ptr::null_mut(), (u64 *)key);
    if (!n_keys) {
...
// backup_data = '\0';
    ...
    tcp_fastopen_reset_cipher(net, core::ptr::null_mut(), key,
    backup_data ? key + 4 : core::ptr::null_mut());
    }
    bad_key:
    kfree(tbl.data);
    return ret;
    ...
    loff_t *ppos)
    {
    let mut tbl: ctl_table = { .maxlen = TCP_ULP_BUF_MAX, };
    int ret;
    tbl.data = kmalloc(tbl.maxlen, GFP_USER);
    if (!tbl.data)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn proc_fib_multipath_hash_init_rand_seed() {
...
#[no_mangle]
unsafe extern "C" fn proc_fib_multipath_hash_set_seed(net: *mut net, user_seed: u32) {
...
//
    ...
    {
    let mut table_size: usize = ARRAY_SIZE(ipv4_net_table);
...
#[no_mangle]
unsafe extern "C" fn ipv4_sysctl_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn ipv4_sysctl_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn sysctl_ipv4_init() -> __init int {
