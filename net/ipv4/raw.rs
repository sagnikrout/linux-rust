...
//
#[no_mangle]
unsafe extern "C" fn icmp_filter(sk: *const sock, skb: *const sk_buff) -> c_int {
    ...
    return 1;
    if (hdr.type < 32) {
    let mut data: __u32 = raw_sk(sk).filter.data;
...
#[no_mangle]
pub unsafe extern "C" fn raw_local_deliver(skb: *mut sk_buff, protocol: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_err(sk: *mut sock, skb: *mut sk_buff, info: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn raw_icmp_error(skb: *mut sk_buff, protocol: c_int, info: u32) {
...
#[no_mangle]
unsafe extern "C" fn raw_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn raw_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
    ...
    net, sk, skb, core::ptr::null_mut(), rt.dst.dev,
    dst_output);
    if (err > 0)
...
#[no_mangle]
unsafe extern "C" fn raw_probe_proto_opt(rfv: *mut raw_frag_vec, fl4: *mut flowi4) -> c_int {
...
// We only need the first two bytes.
    ...
    if (offset < rfv.hlen) {
    let mut copy: c_int = min(rfv.hlen - offset, len);
...
#[no_mangle]
unsafe extern "C" fn raw_sendmsg(sk: *mut sock, msg: *mut msghdr, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MSG_MORE): !(msg->msg_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn raw_close(sk: *mut sock, timeout: c_long) {
    static void raw_close(struct sock *sk, long timeout)
    {
//
// Raw sockets may have direct kernel references. Kill them.
//
    ip_ra_control(sk, 0, core::ptr::null_mut());
    sk_common_release(sk);
    }
#[no_mangle]
unsafe extern "C" fn raw_destroy(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn raw_sk_init(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_seticmpfilter(sk: *mut sock, optval: sockptr_t, optlen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_geticmpfilter(sk: *mut sock, opt: *mut sockopt_t) -> c_int {
    static int raw_geticmpfilter(struct sock *sk, sockopt_t *opt)
    {
    let mut len: c_int = opt.optlen;
    if (len < 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn do_raw_getsockopt(sk: *mut sock, optname: c_int, opt: *mut sockopt_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_ioctl(sk: *mut sock, cmd: c_int, karg: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compat_raw_ioctl(sk: *mut sock, cmd: c_uint, arg: c_ulong) -> c_int {
...
pub unsafe extern "C" fn raw_abort(sk: *mut sock, err: c_int) -> c_int {
    ...
    if (sk)
    while (pos && (sk = raw_get_next(seq, sk)) != core::ptr::null_mut())
    --pos;
...
#[no_mangle]
pub unsafe extern "C" fn raw_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn raw_sock_seq_show(seq: *mut seq_file, sp: *mut sock, i: c_int) {
...
#[no_mangle]
unsafe extern "C" fn raw_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raw_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn raw_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
pub unsafe extern "C" fn raw_proc_init() -> int __init {
    int __init raw_proc_init(void)
    {
    return register_pernet_subsys(&raw_net_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn raw_proc_exit() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn raw_sysctl_init_net(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn raw_sysctl_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn raw_init() -> void __init {
