...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_plb_check_rehash(sk: *mut sock, plb: *mut tcp_plb_state) {
    void tcp_plb_check_rehash(struct sock *sk, struct tcp_plb_state *plb)
    {
    struct net *net = sock_net(sk);
    u32 max_suspend;
    let mut forced_rehash: bool = false, idle_rehash = false;
    if (!READ_ONCE(net.ipv4.sysctl_tcp_plb_enabled))
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_plb_update_state_upon_rto(sk: *mut sock, plb: *mut tcp_plb_state) {
