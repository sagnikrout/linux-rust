...
pub const DEFAULT_MIN_ADVMSS: c_int = 256;
    ...
    let mut __read_mostly: static int ip_rt_redirect_number = 9;
    let mut __read_mostly: static int ip_rt_redirect_load = HZ / 50;
    let mut __read_mostly: static int ip_rt_redirect_silence = ((HZ / 50) << (9 + 1));
    let mut __read_mostly: static int ip_rt_error_cost = HZ;
    let mut __read_mostly: static int ip_rt_error_burst = 5 * HZ;
    let mut __read_mostly: static int ip_rt_gc_timeout = RT_GC_TIMEOUT;
//
...
#[no_mangle]
unsafe extern "C" fn rt_cache_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    static void rt_cache_seq_stop(struct seq_file *seq, void *v)
    {
    }
#[no_mangle]
unsafe extern "C" fn rt_cache_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt_cpu_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    static void rt_cpu_seq_stop(struct seq_file *seq, void *v)
    {
    }
#[no_mangle]
unsafe extern "C" fn rt_cpu_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt_acct_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_rt_do_proc_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ip_rt_do_proc_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ip_rt_proc_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ip_rt_proc_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt_is_expired(rth: *const rtable) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rt_cache_flush(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn ipv4_confirm_neigh(dst: *const dst_entry, daddr: *const c_void) {
    static void ipv4_confirm_neigh(const struct dst_entry *dst, const void *daddr)
    {
    const struct rtable *rt = container_of(dst, struct rtable, dst);
    ...
    __ipv4_confirm_neigh(dev, *( u32 *)pkey);
    }
...
//
#[no_mangle]
unsafe extern "C" fn ip_idents_reserve(hash: u32, segs: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn __ip_select_ident(net: *mut net, iph: *mut iphdr, segs: c_int) {
...
// Note the following code is not safe, but this is okay.
    ...
    hash = siphash_3u32(( u32)iph.daddr,
    ( u32)iph.saddr,
    iph.protocol,
    &net.ipv4.ip_id_key);
    ...
    int flow_flags)
    {
    let mut scope: __u8 = RT_SCOPE_UNIVERSE;
    if (sk) {
    ...
    let mut oif: c_int = skb.dev.ifindex;
    let mut prot: u8 = iph.protocol;
    let mut mark: u32 = skb.mark;
    let mut tos: __u8 = iph.tos;
    __build_flow_key(net, fl4, sk, iph, oif, tos, prot, mark, 0);
    }
#[no_mangle]
unsafe extern "C" fn build_sk_flow_key(fl4: *mut flowi4, sk: *const sock) {
    static void build_sk_flow_key(struct flowi4 *fl4, const struct sock *sk)
    {
    const struct inet_sock *inet = inet_sk(sk);
    const struct ip_options_rcu *inet_opt;
    let mut daddr: __be32 = inet.inet_daddr;
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn fnhe_flush_routes(fnhe: *mut fib_nh_exception) {
    static void fnhe_flush_routes(struct fib_nh_exception *fnhe)
    {
    struct rtable *rt;
    rt = rcu_dereference(fnhe.fnhe_rth_input);
    if (rt) {
    RCU_INIT_POINTER(fnhe.fnhe_rth_input, core::ptr::null_mut());
    dst_dev_put(&rt.dst);
    dst_release(&rt.dst);
    }
    rt = rcu_dereference(fnhe.fnhe_rth_output);
    if (rt) {
    RCU_INIT_POINTER(fnhe.fnhe_rth_output, core::ptr::null_mut());
    dst_dev_put(&rt.dst);
    dst_release(&rt.dst);
    }
    }
#[no_mangle]
unsafe extern "C" fn fnhe_remove_oldest(hash: *mut fnhe_hash_bucket) {
    static void fnhe_remove_oldest(struct fnhe_hash_bucket *hash)
    {
    struct fib_nh_exception __rcu **fnhe_p, **oldest_p;
    struct fib_nh_exception *fnhe, *oldest = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fnhe_hashfun(daddr: __be32) -> u32 {
    static u32 fnhe_hashfun(__be32 daddr)
    {
    static siphash_aligned_key_t fnhe_hash_key;
    u64 hval;
    net_get_random_once(&fnhe_hash_key, sizeof(fnhe_hash_key));
    hval = siphash_1u32(( u32)daddr, &fnhe_hash_key);
    return hash_64(hval, FNHE_HASH_SHIFT);
    }
#[no_mangle]
unsafe extern "C" fn fill_route_from_fnhe(rt: *mut rtable, fnhe: *mut fib_nh_exception) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnhe_update_pmtu(fnhe: *mut fib_nh_exception, new: u32, orig: u32) {
    ...
    bool kill_route)
    {
    let mut new_gw: __be32 = icmp_hdr(skb).un.gateway;
    let mut old_gw: __be32 = ip_hdr(skb).saddr;
    ...
    n = __ipv4_neigh_lookup(rt.dst.dev, ( u32)new_gw);
    if (!n)
    n = neigh_create(&arp_tbl, &new_gw, rt.dst.dev);
    if (!IS_ERR(n)) {
    if (!(READ_ONCE(n.nud_state) & NUD_VALID)) {
    neigh_event_send(n, core::ptr::null_mut());
    } else {
    ...
    let mut saddr: __be32 = iph.saddr;
...
#[no_mangle]
unsafe extern "C" fn ip_do_redirect(dst: *mut dst_entry, sk: *mut sock, skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_rt_send_redirect(skb: *mut sk_buff) {
...
//
    ...
    let mut gw: __be32 = rt_nexthop(rt, ip_hdr(skb).daddr);
...
#[no_mangle]
unsafe extern "C" fn ip_error(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ip_rt_update_pmtu(rt: *mut rtable, fl4: *mut flowi4, mtu: u32) {
...
// Don't make lookup fail for bridged encapsulations
    ...
    struct flowi4 fl4;
    struct rtable *rt;
    let mut mark: u32 = IP4_REPLY_MARK(net, skb.mark);
    __build_flow_key(net, &fl4, core::ptr::null_mut(), iph, oif, iph.tos, protocol, mark,
    0);
...
#[no_mangle]
unsafe extern "C" fn __ipv4_sk_update_pmtu(skb: *mut sk_buff, sk: *mut sock, mtu: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv4_sk_update_pmtu(skb: *mut sk_buff, sk: *mut sock, mtu: u32) {
    void ipv4_sk_update_pmtu(struct sk_buff *skb, struct sock *sk, u32 mtu)
    {
    const struct iphdr *iph = (const struct iphdr *)skb.data;
    struct flowi4 fl4;
    struct rtable *rt;
    struct dst_entry *odst = core::ptr::null_mut();
    ...
    struct flowi4 fl4;
    struct rtable *rt;
    __build_flow_key(net, &fl4, core::ptr::null_mut(), iph, oif, iph.tos, protocol, 0, 0);
    rt = __ip_route_output_key(net, &fl4);
    if (!IS_ERR(rt)) {
...
#[no_mangle]
pub unsafe extern "C" fn ipv4_sk_redirect(skb: *mut sk_buff, sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn ipv4_send_dest_unreach(skb: *mut sk_buff) {
...
//
    ...
    res = __ip_options_compile(dev_net(dev), &parm.opt, skb, core::ptr::null_mut());
    rcu_read_unlock();
    if (res)
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn ipv4_link_failure(skb: *mut sk_buff) {
    static void ipv4_link_failure(struct sk_buff *skb)
    {
    struct rtable *rt;
...
#[no_mangle]
unsafe extern "C" fn ip_rt_bug(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_rt_get_source(addr: *mut u8, skb: *mut sk_buff, rt: *mut rtable) {
...
#[no_mangle]
unsafe extern "C" fn set_class_tag(rt: *mut rtable, tag: u32) {
...
#[no_mangle]
unsafe extern "C" fn ipv4_default_advmss(dst: *const dst_entry) -> c_uint {
    static unsigned int ipv4_default_advmss(const struct dst_entry *dst)
    {
    let mut header_size: c_uint = sizeof(struct tcphdr) + sizeof(struct iphdr);
    unsigned int advmss;
    struct net *net;
    rcu_read_lock();
    net = dst_dev_net_rcu(dst);
...
#[no_mangle]
pub unsafe extern "C" fn ipv4_mtu(dst: *const dst_entry) -> INDIRECT_CALLABLE_SCOPE unsigned int {
...
#[no_mangle]
unsafe extern "C" fn ip_del_fnhe(nhc: *mut fib_nh_common, daddr: __be32) {
    static void ip_del_fnhe(struct fib_nh_common *nhc, __be32 daddr)
    {
    struct fnhe_hash_bucket *hash;
    struct fib_nh_exception *fnhe, __rcu **fnhe_p;
    let mut hval: u32 = fnhe_hashfun(daddr);
    spin_lock_bh(&fnhe_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_mtu_from_fib_result(res: *mut fib_result, daddr: __be32) -> u32 {
    ...
    struct rtable *orig;
    let mut genid: c_int = fnhe_genid(dev_net(rt.dst.dev));
...
#[no_mangle]
unsafe extern "C" fn rt_cache_route(nhc: *mut fib_nh_common, rt: *mut rtable) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rt_add_uncached_list(rt: *mut rtable) {
...
#[no_mangle]
pub unsafe extern "C" fn rt_del_uncached_list(rt: *mut rtable) {
...
#[no_mangle]
unsafe extern "C" fn ipv4_dst_destroy(dst: *mut dst_entry) {
    static void ipv4_dst_destroy(struct dst_entry *dst)
    {
...
#[no_mangle]
pub unsafe extern "C" fn rt_flush_dev(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rt_cache_valid(rt: *const rtable) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: do_cache) -> else {
    else if (do_cache)
...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: rt->rt_gw_family ==) -> else {
    else if (rt.rt_gw_family == AF_INET6)
...
// called in rcu_read_lock() section
    ...
    let mut flags: c_uint = RTCF_MULTICAST;
    enum skb_drop_reason reason;
    struct rtable *rth;
    let mut itag: u32 = 0;
...
//
    ...
    bool *p_has_inner)
    {
    let mut hash_fields: u32 = READ_ONCE(net.ipv4.sysctl_fib_multipath_hash_fields);
...
// if skb is set it will be used and fl4 can be NULL
    ...
    {
    let mut multipath_hash: u32 = fl4 ? fl4.flowi4_multipath_hash : 0;
    struct flow_keys hash_keys;
    let mut mhash: u32 = 0;
...
// Same as case 0
    ...
    let mut h: c_int = fib_multipath_hash(res.fi.fib_net, core::ptr::null_mut(), skb, hkeys);
    fib_select_multipath(res, h, core::ptr::null_mut());
...
// get device for dst_alloc with local routes
    ...
    const struct fib_result *res)
    {
    struct fib_nh_common *nhc = res.fi ? res.nhc : core::ptr::null_mut();
...
//
    ...
    res.fi = core::ptr::null_mut();
    res.table = core::ptr::null_mut();
...
//
    ...
    fnhe = core::ptr::null_mut();
    do_cache &= fi != core::ptr::null_mut();
    if (fi) {
    struct fib_nh_common *nhc = FIB_RES_NHC(*res);
...
//
    ...
    const struct sk_buff *skb)
    {
    struct net_device *dev_out = core::ptr::null_mut();
    let mut orig_oif: c_int = fl4.flowi4_oif;
    let mut flags: c_uint = 0;
    struct rtable *rth;
    int err;
    if (fl4.saddr) {
...
// RACE: Check return value of inet_select_addr instead.
    ...
    fl4.flowi4_scope);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !fl4->daddr) -> else {
    else if (!fl4.daddr)
    fl4.saddr = inet_select_addr(dev_out, 0,
    RT_SCOPE_HOST);
    }
...
//
    ...
    struct rtable *rt;
    rt = dst_alloc(&ipv4_dst_blackhole_ops, core::ptr::null_mut(), DST_OBSOLETE_DEAD, 0);
    if (rt) {
...
// called with rcu_read_lock held
    ...
    let mut alen: c_int = sizeof(struct in6_addr);
    struct nlattr *nla;
    struct rtvia *via;
    ...
    table_id, 0, core::ptr::null_mut(), skb,
...
//
    ...
    let mut table_id: u32 = RT_TABLE_MAIN;
    let mut sport: __be16 = 0, dport = 0;
    let mut res: fib_result = {};
    let mut ip_proto: u8 = IPPROTO_UDP;
    struct rtable *rt = core::ptr::null_mut();
    struct sk_buff *skb;
    struct rtmsg *rtm;
    let mut fl4: flowi4 = {};
    let mut dst: __be32 = 0;
    let mut src: __be32 = 0;
    dscp_t dscp;
    kuid_t uid;
    u32 iif;
    int err;
...
// reset skb for netlink reply msg
    ...
    let mut slen: u8 = 32 - fri.dst_len;
    if (fa.fa_slen == slen &&
    fa.tb_id == fri.tb_id &&
    fa.fa_dscp == fri.dscp &&
    fa.fa_info == res.fi &&
...
#[no_mangle]
pub unsafe extern "C" fn ip_rt_multicast_event(in_dev: *mut in_device) {
    void ip_rt_multicast_event(struct in_device *in_dev)
    {
    rt_cache_flush(dev_net(in_dev.dev));
    }

    let mut __read_mostly: static int ip_rt_gc_interval = 60 * HZ;
    let mut __read_mostly: static int ip_rt_gc_min_interval = HZ / 2;
    let mut __read_mostly: static int ip_rt_gc_elasticity = 8;
    let mut __read_mostly: static int ip_min_valid_pmtu = IPV4_MIN_MTU;
...
#[no_mangle]
unsafe extern "C" fn sysctl_route_net_init(net: *mut net) -> __net_init int {
    static __net_init int sysctl_route_net_init(struct net *net)
    {
    struct ctl_table *tbl;
    let mut table_size: usize = ARRAY_SIZE(ipv4_route_netns_table);
...
#[no_mangle]
unsafe extern "C" fn sysctl_route_net_exit(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn netns_ip_rt_init(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn rt_genid_init(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn ipv4_inetpeer_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipv4_inetpeer_exit(net: *mut net) -> void __net_exit {
    static void __net_exit ipv4_inetpeer_exit(struct net *net)
    {
    struct inet_peer_base *bp = net.ipv4.peers;
    net.ipv4.peers = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ip_rt_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_static_sysctl_init() -> void __init {
