...
#[no_mangle]
unsafe extern "C" fn fou_recv_pull(skb: *mut sk_buff, fou: *mut fou, len: usize) -> c_int {
...
unsafe extern "C" fn fou_udp_recv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    {
    __be16 *pd = data;
    let mut start: usize = ntohs(pd[0]);
    let mut offset: usize = ntohs(pd[1]);
...
#[no_mangle]
unsafe extern "C" fn gue_control_message(skb: *mut sk_buff, guehdr: *mut guehdr) -> c_int {
...
//
    ...
    let mut flags: __be32 = *(__be32 *)(data + doffset);
...
#[no_mangle]
unsafe extern "C" fn gue_gro_complete(sk: *mut sock, skb: *mut sk_buff, nhoff: c_int) -> c_int {
    static int gue_gro_complete(struct sock *sk, struct sk_buff *skb, int nhoff)
    {
    struct guehdr *guehdr = (struct guehdr *)(skb.data + nhoff);
    const struct net_offload *ops;
    let mut guehlen: c_uint = 0;
    u8 proto;
...
#[no_mangle]
unsafe extern "C" fn fou_cfg_cmp(fou: *mut fou, cfg: *mut fou_cfg) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fou_release(fou: *mut fou) {
    ...
    struct fou *fou = core::ptr::null_mut();
    struct sock *sk;
...
#[no_mangle]
unsafe extern "C" fn fou_destroy(net: *mut net, cfg: *mut fou_cfg) -> c_int {
    ...
    struct fou_cfg *cfg)
    {
    let mut has_local: bool = false, has_peer = false;
    struct nlattr *attr;
    int ifindex;
    __be16 port;
    ...
    let mut family: u8 = nla_get_u8(info.attrs[FOU_ATTR_AF]);
    switch (family) {
    case AF_INET:
    break;
    case AF_INET6:
...
#[no_mangle]
pub unsafe extern "C" fn fou_nl_add_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    if (err)
    return err;
    return fou_create(net, &cfg, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn fou_nl_del_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fou_fill_info(fou: *mut fou, msg: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fou_nl_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fou_nl_get_dumpit(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fou_encap_hlen(e: *mut ip_tunnel_encap) -> usize {
...
#[no_mangle]
unsafe extern "C" fn gue_err_proto_handler(proto: c_int, skb: *mut sk_buff, info: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gue_err(skb: *mut sk_buff, info: u32) -> c_int {
    static int gue_err(struct sk_buff *skb, u32 info)
    {
    let mut transport_offset: c_int = skb_transport_offset(skb);
    struct guehdr *guehdr;
    size_t len, optlen;
    int ret;
    len = sizeof(struct udphdr) + sizeof(struct guehdr);
...
#[no_mangle]
unsafe extern "C" fn ip_tunnel_encap_add_fou_ops() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_tunnel_encap_del_fou_ops() {
...
#[no_mangle]
unsafe extern "C" fn fou_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn fou_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
unsafe extern "C" fn fou_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fou_fini() -> void __exit {
