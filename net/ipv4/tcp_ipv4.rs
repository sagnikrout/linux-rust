...
#[no_mangle]
pub unsafe extern "C" fn tcp_twsk_unique(sk: *mut sock, sktw: *mut sock, twp: *mut c_void) -> c_int {
    int tcp_twsk_unique(struct sock *sk, struct sock *sktw, void *twp)
    {
    let mut reuse: c_int = READ_ONCE(sock_net(sk).ipv4.sysctl_tcp_tw_reuse);
...
//
    if (likely(!tp.repair)) {
    let mut seq: u32 = tcptw.tw_snd_nxt + 65535 + 2;
    if (!seq)
    seq = 1;
...
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_connect(sk: *mut sock, uaddr: *mut sockaddr_unsized, addr_len: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_mtu_reduced(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn do_redirect(skb: *mut sk_buff, sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_req_err(sk: *mut sock, seq: u32, abort: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ld_RTO_revert(sk: *mut sock, seq: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_err(skb: *mut sk_buff, info: u32) -> c_int {
...
//
    ...
    let mut sdif: c_int = tcp_v4_sdif(skb);
    let mut dif: c_int = inet_iif(skb);
    let mut l3index: c_int = sdif ? dif : 0;
    bool allocated_traffic_key;
    struct tcp_ao_key *key;
    char *traffic_key;
    let mut drop: bool = true;
    let mut ao_sne: u32 = 0;
    u8 keyid;
    rcu_read_lock();
...
//
    ...
    const __u8 *md5_hash_location = core::ptr::null_mut();
    const struct tcp_ao_hdr *aoh;
    struct ip_reply_arg arg;

    struct tcp_md5sig_key *key = core::ptr::null_mut();
    unsigned char newhash[16];
    struct sock *sk1 = core::ptr::null_mut();

    let mut transmit_time: u64 = 0;
    struct sock *ctl_sk;
    struct net *net;
    let mut txhash: u32 = 0;
...
//
    sk1 = __inet_lookup_listener(net, core::ptr::null_mut(), 0, ip_hdr(skb).saddr,
...
// Can't co-exist with TCPMD5, hence check rep.opt[0]
    if (rep.opt[0] == 0) {
    let mut mrst: __be32 = mptcp_reset_option(skb);
    if (mrst) {
    rep.opt[0] = mrst;
...
// ECN bits of TW reset are cleared
    ...
    arg.uid = sock_net_uid(net, sk && sk_fullsock(sk) ? sk : core::ptr::null_mut());
    local_bh_disable();
...
// Swap the send and the receive.
    ...
    let mut offset: c_int = (tsecr) ? 3 : 0;
    ...
    arg.tos = tos;
    arg.uid = sock_net_uid(net, sk_fullsock(sk) ? sk : core::ptr::null_mut());
    local_bh_disable();
    local_lock_nested_bh(&ipv4_tcp_sk.bh_lock);
    ctl_sk = this_cpu_read(ipv4_tcp_sk.sock);
    sock_net_set(ctl_sk, net);
...
//
    ...
    u8 tos;
// First, grab a route.
    if (!dst && (dst = inet_csk_route_req(sk, &fl4, req)) == core::ptr::null_mut())
    return -1;
...
//
#[no_mangle]
unsafe extern "C" fn tcp_v4_reqsk_destructor(req: *mut request_sock) {
...
#[no_mangle]
unsafe extern "C" fn better_md5_match(old: *mut tcp_md5sig_key, new: *mut tcp_md5sig_key) -> bool {
...
// Find the Key structure for an address.
    ...
    __be32 mask;
    struct tcp_md5sig_key *best_match = core::ptr::null_mut();
    bool match;
// caller either holds rcu_read_lock() or socket lock
    ...
    const struct tcp_sock *tp = tcp_sk(sk);
    struct tcp_md5sig_key *key;
    let mut size: c_uint = sizeof(struct in_addr);
    const struct tcp_md5sig_info *md5sig;
// caller either holds rcu_read_lock() or socket lock
    md5sig = rcu_dereference_check(tp.md5sig_info,
    lockdep_sock_is_held(sk));
...
#[no_mangle]
unsafe extern "C" fn tcp_md5sig_info_add(sk: *mut sock, gfp: gfp_t) -> c_int {
...
//
    ...
    rcu_assign_pointer(tp.md5sig_info, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn tcp_clear_md5_list(sk: *mut sock) {
    ...
    const union tcp_md5_addr *addr;
    let mut prefixlen: u8 = 32;
    let mut l3index: c_int = 0;
    bool l3flag;
    u8 flags;
...
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_conn_request(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
    ...
    let mut found_dup_sk: bool = false;
...
// own_req = inet_ehash_nolisten(newsk, req_to_sk(req_unhash),
    ...
    ireq.ireq_opt = core::ptr::null_mut();
    } else {
    newinet.inet_opt = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_do_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    dst, 0)) {
    RCU_INIT_POINTER(sk.sk_rx_dst, core::ptr::null_mut());
    dst_release(dst);
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn tcp_add_backlog(sk: *mut sock, skb: *mut sk_buff) -> enum skb_drop_reason {
...
#[no_mangle]
unsafe extern "C" fn tcp_v4_restore_cb(skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_rcv(skb: *mut sk_buff) -> c_int {
...
// min_ttl can be changed concurrently from do_ip_setsockopt()
    ...
    drop_reason = tcp_inbound_hash(sk, core::ptr::null_mut(), skb, &iph.saddr, &iph.daddr,
    AF_INET, dif, sdif);
    if (drop_reason)
    goto discard_and_relse;
    nf_reset_ct(skb);
    ...
    tcp_v4_send_reset(core::ptr::null_mut(), skb, sk_rst_convert_drop_reason(drop_reason));
    }
    discard_it:
...
#[no_mangle]
pub unsafe extern "C" fn inet_sk_rx_dst_set(sk: *mut sock, skb: *const sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn tcp4_destruct_sock(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn tcp_v4_init_sock(sk: *mut sock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcp_release_user_frags(sk: *mut sock) {
    ...
    WARN_ON_ONCE(!napi_pp_put_page(( netmem_ref)netmem));

    }
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_destroy_sock(sk: *mut sock) {
...
// Lockless fast path for the common case of empty buckets
    ...
    struct inet_hashinfo *hinfo = seq_file_net(seq).ipv4.tcp_death_row.hashinfo;
    struct tcp_iter_state *st = seq.private;
    let mut bucket: c_int = st.bucket;
    let mut offset: c_int = st.offset;
    let mut orig_num: c_int = st.num;
    void *rc = core::ptr::null_mut();
    switch (st.state) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    ...
    let mut delta: c_long = req.rsk_timer.expires - jiffies;
...
#[no_mangle]
unsafe extern "C" fn get_tcp4_sock(sk: *mut sock, f: *mut seq_file, i: c_int) {
...
//
    ...
    struct seq_file *f, int i)
    {
    let mut delta: c_long = tw.tw_timer.expires - jiffies;
    __be32 dest, src;
    __u16 destp, srcp;
    dest  = tw.tw_daddr;
    src   = tw.tw_rcv_saddr;
...
pub const TMPSZ: c_int = 150;
#[no_mangle]
unsafe extern "C" fn tcp4_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bpf_tcp_iter_state {
    pub state: tcp_iter_state,
    pub cur_sk: c_uint,
    pub end_sk: c_uint,
    pub max_sk: c_uint,
    pub batch: *mut union bpf_tcp_iter_batch_item,
}
...
pub struct bpf_iter__tcp {
    ...
    pub sk_common): *mut *mut __bpf_md_ptr(struct sock_common ,,
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_tcp_put_batch(iter: *mut bpf_tcp_iter_state) {
...
//
    ...
    let mut find_cookie: c_uint = iter.cur_sk;
    let mut end_cookie: c_uint = iter.end_sk;
    let mut resume_bucket: c_int = st.bucket;
    struct sock *sk;
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_tcp_unlock_bucket(seq: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_tcp_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_tcp_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tcp4_proc_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn tcp4_proc_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn tcp4_proc_init() -> int __init {
    int __init tcp4_proc_init(void)
    {
    return register_pernet_subsys(&tcp4_net_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn tcp4_proc_exit() {
    ...
    .h.hashinfo		= core::ptr::null_mut(),
    .no_autobind		= true,
    .diag_destroy		= tcp_abort,
    };
    EXPORT_SYMBOL(tcp_prot);
#[no_mangle]
unsafe extern "C" fn tcp_sk_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn tcp_set_hashinfo(net: *mut net) -> void __net_init {
...
#[no_mangle]
unsafe extern "C" fn tcp_sk_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn tcp_sk_exit_batch(net_exit_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_init_tcp(priv_data: *mut c_void, aux: *mut bpf_iter_aux_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpf_iter_fini_tcp(priv_data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_init() -> void __init {
