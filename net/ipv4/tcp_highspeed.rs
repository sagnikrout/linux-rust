...
//! Source: net/ipv4/tcp_highspeed.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hstcp_init(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn hstcp_cong_avoid(sk: *mut sock, ack: u32, acked: u32) {
...
#[no_mangle]
unsafe extern "C" fn hstcp_ssthresh(sk: *mut sock) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hstcp_register() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hstcp_unregister() -> void __exit {
