...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipmr_rule {
    pub common: fib_rule,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipmr_result {
...
#[no_mangle]
unsafe extern "C" fn ipmr_rule_match(rule: *mut fib_rule, fl: *mut flowi, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmr_rules_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipmr_rules_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn ipmr_rules_seq_read(net: *const net) -> c_uint {
    static unsigned int ipmr_rules_seq_read(const struct net *net)
    {
    return fib_rules_seq_read(net, RTNL_FAMILY_IPMR);
    }
#[no_mangle]
pub unsafe extern "C" fn ipmr_rule_default(rule: *const fib_rule) -> bool {
    ...
    for (mrt = __ipmr_get_table(net, 0); mrt; mrt = core::ptr::null_mut())
    static int ipmr_fib_lookup(struct net *net, struct flowi4 *flp4,
    struct mr_table **mrt)
    {
...
unsafe extern "C" fn ipmr_rules_exit(net: *mut net) -> void __net_exit {
    ...
    RCU_INIT_POINTER(net.ipv4.mrt, core::ptr::null_mut());
    ipmr_free_table(mrt, dev_kill_list);
    }
    static int ipmr_rules_dump(struct net *net, struct notifier_block *nb,
    struct netlink_ext_ack *extack)
...
#[no_mangle]
unsafe extern "C" fn ipmr_free_table(mrt: *mut mr_table, dev_kill_list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn ipmr_init_vif_indev(dev: *const net_device) -> bool {
    ...
    goto out_unregister;
    if (dev_open(new_dev, core::ptr::null_mut()))
    goto out_unregister;
    dev_hold(new_dev);
...
#[no_mangle]
unsafe extern "C" fn reg_vif_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn ipmr_cache_free_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn ipmr_cache_free(c: *mut mfc_cache) {
...
//
#[no_mangle]
unsafe extern "C" fn ipmr_destroy_unres(mrt: *mut mr_table, c: *mut mfc_cache) {
...
// Fill oifs list. It is called under locked mrt_lock.
    ...
    let mut vifi: c_int = vifc.vifc_vifi;
...
//
    ...
    struct sk_buff *pkt, vifi_t vifi, int assert)
    {
    let mut ihl: c_int = ip_hdrlen(pkt);
...
// Pairs with WRITE_ONCE() in vif_add() and vif_delete()
    let mut vif_num: c_int = READ_ONCE(mrt.mroute_reg_vif_num);
    msg.im_vif = vif_num;
...
// Called under rcu_read_lock()
    ...
    struct mfc_cache *c = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ipmr_mfc_delete(mrt: *mut mr_table, mfc: *mut mfcctl, parent: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mrtsock_destruct(sk: *mut sock) {
...
//
    rtnl_unlock();
    ret = ip_ra_control(sk, 0, core::ptr::null_mut());
    goto out;
    }
    break;
    case MRT_ADD_VIF:
    ...
    ret = vif_delete(mrt, vif.vifc_vifi, 0, core::ptr::null_mut());
    }
    break;
...
#[no_mangle]
pub unsafe extern "C" fn ipmr_sk_ioctl(sk: *mut sock, cmd: c_uint, arg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipmr_ioctl(sk: *mut sock, cmd: c_int, arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_sioc_vif_req {
...
#[no_mangle]
pub unsafe extern "C" fn ipmr_compat_ioctl(sk: *mut sock, cmd: c_uint, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmr_device_event(this: *mut notifier_block, event: c_ulong, ptr: *mut c_void) -> c_int {
    ...
    vif_delete(mrt, ct, 1, core::ptr::null_mut());
    }
    }
    return NOTIFY_DONE;
    }
...
// Processing handlers for ipmr_forward, under rcu_read_lock()
    ...
    rt = ip_route_output_ports(net, &fl4, core::ptr::null_mut(),
    ...
    rt = ip_route_output_ports(net, &fl4, core::ptr::null_mut(), iph.daddr, 0,
    0, 0,
    IPPROTO_IPIP,
    iph.tos & INET_DSCP_MASK, vif.link);
    if (IS_ERR(rt))
...
//
    ...
    net, core::ptr::null_mut(), skb, skb.dev, dst_dev_rcu(&rt.dst),
    ipmr_forward_finish);
    return;
    out_free:
    kfree_skb(skb);
    ...
    if (ipmr_prepare_xmit(net, mrt, skb, vifi))
    goto out_free;
    ip_mc_output(net, core::ptr::null_mut(), skb);
    return;
    out_free:
    kfree_skb(skb);
    }
...
#[no_mangle]
unsafe extern "C" fn ipmr_find_vif(mrt: *const mr_table, dev: *mut net_device) -> c_int {
...
// Called uner rcu_read_lock()
    ...
    {
    let mut true_vifi: c_int = ipmr_find_vif(mrt, dev);
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_mr_input(skb: *mut sk_buff) -> c_int {
    int ip_mr_input(struct sk_buff *skb)
    {
    struct mfc_cache *cache;
    struct net *net = dev_net(skb.dev);
    let mut local: c_int = skb_rtable(skb).rt_flags & RTCF_LOCAL;
    struct mr_table *mrt;
    struct net_device *dev;
...
// already under rcu_read_lock()
    ...
    if (!cache) {
    let mut vif: c_int = ipmr_find_vif(mrt, dev);
    if (vif >= 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn ip_mr_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pim_rcv_v1(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pim_rcv(skb: *mut sk_buff) -> c_int {
    ...
    if (!cache && skb.dev) {
    let mut vif: c_int = ipmr_find_vif(mrt, skb.dev);
    if (vif >= 0)
...
#[no_mangle]
unsafe extern "C" fn mroute_msgsize(unresolved: bool) -> usize {
...
// RTA_MFC_STATS
    ...
    if (err < 0)
    goto errout;
    rtnl_notify(skb, net, 0, RTNLGRP_IPV4_MROUTE, core::ptr::null_mut(), GFP_ATOMIC);
    return;
    errout:
    kfree_skb(skb);
...
#[no_mangle]
unsafe extern "C" fn igmpmsg_netlink_msgsize(payloadlen: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn igmpmsg_netlink_event(mrt: *const mr_table, pkt: *mut sk_buff) {
    static void igmpmsg_netlink_event(const struct mr_table *mrt, struct sk_buff *pkt)
    {
    struct net *net = read_pnet(&mrt.net);
    struct nlmsghdr *nlh;
    ...
    goto nla_put_failure;
    nlmsg_end(skb, nlh);
    rtnl_notify(skb, net, 0, RTNLGRP_IPV4_MROUTE_R, core::ptr::null_mut(), GFP_ATOMIC);
    return;
    nla_put_failure:
    nlmsg_cancel(skb, nlh);
    errout:
...
#[no_mangle]
unsafe extern "C" fn ipmr_rtm_dumproute(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmr_rtm_validate_proto(rtm_protocol: c_uchar) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipmr_nla_get_ttls(nla: *const nlattr, mfcc: *mut mfcctl) -> c_int {
    static int ipmr_nla_get_ttls(const struct nlattr *nla, struct mfcctl *mfcc)
    {
    struct rtnexthop *rtnh = nla_data(nla);
    let mut remaining: c_int = nla_len(nla), vifi = 0;
...
// returns < 0 on error, 0 for ADD_MFC and 1 for ADD_MFC_PROXY
    ...
    let mut tblid: u32 = RT_TABLE_DEFAULT;
    int ret, rem, iif = 0;
    struct mr_table *mrt;
    struct nlattr *attr;
    struct rtmsg *rtm;
...
// takes care of both newroute and delroute
    ...
    struct mr_table *tbl = core::ptr::null_mut();
    struct mfcctl mfcc;
...
#[no_mangle]
unsafe extern "C" fn ipmr_fill_table(mrt: *mut mr_table, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipmr_fill_vif(mrt: *mut mr_table, vifid: u32, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipmr_rtm_dumplink(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int ipmr_rtm_dumplink(struct sk_buff *skb, struct netlink_callback *cb)
    {
    struct net *net = sock_net(skb.sk);
    struct nlmsghdr *nlh = core::ptr::null_mut();
    let mut t: c_uint = 0, s_t;
    let mut e: c_uint = 0, s_e;
    struct mr_table *mrt;
    if (cb.strict_check) {
    let mut err: c_int = ipmr_valid_dumplink(cb.nlh, cb.extack);
    if (err < 0)
    return err;
    }
    s_t = cb.args[0];
...
#[no_mangle]
unsafe extern "C" fn ipmr_vif_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ipmr_vif_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmr_seq_read(net: *const net) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ipmr_notifier_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipmr_notifier_exit(net: *mut net) -> void __net_exit {
    static void __net_exit ipmr_notifier_exit(struct net *net)
    {
    fib_notifier_ops_unregister(net.ipv4.ipmr_notifier_ops);
    net.ipv4.ipmr_notifier_ops = core::ptr::null_mut();
    }
// Setup for IP multicast routing
#[no_mangle]
unsafe extern "C" fn ipmr_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipmr_net_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ip_mr_init() -> int __init {
