...
//! Source: net/ipv4/inet_timewait_sock.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inet_twsk_kill(tw: *mut inet_timewait_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn inet_twsk_free(tw: *mut inet_timewait_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn inet_twsk_put(tw: *mut inet_timewait_sock) {
...
#[no_mangle]
unsafe extern "C" fn inet_twsk_schedule(tw: *mut inet_timewait_sock, timeo: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tw_timer_handler(t: *mut timer_list) {
...
// Give us an identity.
    ...
    tw.tw_validate_xmit_skb = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn __inet_twsk_schedule(tw: *mut inet_timewait_sock, timeo: c_int, rearm: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn inet_twsk_purge(hashinfo: *mut inet_hashinfo) {
    void inet_twsk_purge(struct inet_hashinfo *hashinfo)
    {
    struct inet_ehash_bucket *head = &hashinfo.ehash[0];
    let mut ehash_mask: c_uint = hashinfo.ehash_mask;
