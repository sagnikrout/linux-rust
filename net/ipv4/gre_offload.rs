...
// pcsum = ~csum_fold(( __wsum)htonl(partial_adj));
    } else {
// pcsum = 0;
    }
// (pcsum + 1) = 0;
...
#[no_mangle]
unsafe extern "C" fn gre_gro_complete(skb: *mut sk_buff, nhoff: c_int) -> c_int {
    static int gre_gro_complete(struct sk_buff *skb, int nhoff)
    {
    struct gre_base_hdr *greh = (struct gre_base_hdr *)(skb.data + nhoff);
    struct packet_offload *ptype;
    let mut grehlen: c_uint = sizeof(*greh);
...
#[no_mangle]
unsafe extern "C" fn gre_offload_init() -> int __init {
