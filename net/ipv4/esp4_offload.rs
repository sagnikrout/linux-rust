...
//! Source: net/ipv4/esp4_offload.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn esp4_gso_encap(x: *mut xfrm_state, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn esp_input_tail(x: *mut xfrm_state, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp_xmit(x: *mut xfrm_state, skb: *mut sk_buff, features: netdev_features_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp4_offload_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn esp4_offload_exit() -> void __exit {
