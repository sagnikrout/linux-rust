...
#[no_mangle]
unsafe extern "C" fn ipip_err(skb: *mut sk_buff, info: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipip_tunnel_rcv(skb: *mut sk_buff, ipproto: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipip_tunnel_ioctl_verify_protocol(ipproto: u8) -> bool {
    ...
    NETIF_F_HW_CSUM)
#[no_mangle]
unsafe extern "C" fn ipip_tunnel_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ipip_tunnel_init(dev: *mut net_device) -> c_int {
    static int ipip_tunnel_init(struct net_device *dev)
    {
    struct ip_tunnel *tunnel = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn ipip_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ipip_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipip_init_net(net: *mut net) -> int __net_init {
