...
pub struct tcp_ao_mac_ctx {
    pub algo: enum tcp_ao_algo_id,
    union {
    pub hmac_sha1: hmac_sha1_ctx,
    pub hmac_sha256: hmac_sha256_ctx,
    struct {
    pub key: aes_cmac_key,
    pub ctx: aes_cmac_ctx,
    pub aes_cmac: },
}
...
#[no_mangle]
unsafe extern "C" fn tcp_ao_mac_final(mac_ctx: *mut tcp_ao_mac_ctx, out: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_ignore_icmp(sk: *const sock, family: c_int, type: c_int, code: c_int) -> bool {
    bool tcp_ao_ignore_icmp(const struct sock *sk, int family, int type, int code)
    {
    let mut ignore_icmp: bool = false;
...
//
    ...
    {
    let mut mask: __be32 = inet_make_mask(prefixlen);
    let mut a1: __be32 = addr1.s_addr & mask;
    let mut a2: __be32 = addr2.s_addr & mask;
    if (a1 == a2)
    return 0;
    ...
    let mut addr4: __be32 = addr.a6.s6_addr32[3];
    ...
    let mut prefixlen: u8 = min(prefix, key.prefixlen);
...
#[no_mangle]
unsafe extern "C" fn tcp_ao_link_mkt(ao: *mut tcp_ao_info, mkt: *mut tcp_ao_key) {
...
#[no_mangle]
unsafe extern "C" fn tcp_ao_key_free_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn tcp_ao_info_free_rcu(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn tcp_ao_sk_omem_free(sk: *mut sock, ao: *mut tcp_ao_info) {
    static void tcp_ao_sk_omem_free(struct sock *sk, struct tcp_ao_info *ao)
    {
    let mut total_ao_sk_mem: usize = 0;
    struct tcp_ao_key *key;
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_destroy_sock(sk: *mut sock, twsk: bool) {
    void tcp_ao_destroy_sock(struct sock *sk, bool twsk)
    {
    struct tcp_ao_info *ao;
    if (twsk) {
    ao = rcu_dereference_protected(tcp_twsk(sk).ao_info, 1);
    rcu_assign_pointer(tcp_twsk(sk).ao_info, core::ptr::null_mut());
    } else {
    ao = rcu_dereference_protected(tcp_sk(sk).ao_info, 1);
    rcu_assign_pointer(tcp_sk(sk).ao_info, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_time_wait(tcptw: *mut tcp_timewait_sock, tp: *mut tcp_sock) {
    ...
    tcptw.ao_info = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_compute_sne(next_sne: u32, next_seq: u32, seq: u32) -> u32 {
    u32 tcp_ao_compute_sne(u32 next_sne, u32 next_seq, u32 seq)
    {
    let mut sne: u32 = next_sne;
...
#[no_mangle]
unsafe extern "C" fn tcp_ao_hash_sne(mac_ctx: *mut tcp_ao_mac_ctx, sne: u32) {
    static void tcp_ao_hash_sne(struct tcp_ao_mac_ctx *mac_ctx, u32 sne)
    {
    let mut sne_be32: __be32 = htonl(sne);
...
// zero out tcp-ao hash
    ...
    {
    let mut hash_offset: c_int = ao_hash - (char *)th;
...
//
    ...
    if (tcp_parse_auth_options(th, core::ptr::null_mut(), &aoh) || !aoh)
    return;
...
// Key not found, continue without TCP-AO
    ...
    {
    const struct tcphdr *th = tcp_hdr(skb);
    let mut maclen: u8 = tcp_ao_hdr_maclen(aoh);
    u8 hash_buf[TCP_AO_MAX_MAC_LEN];
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_connect_init(sk: *mut sock) {
...
// pairs with tcp_inbound_ao_hash()
    ...
    ao_info.current_key = core::ptr::null_mut();
    if (key == ao_info.rnext_key)
    ao_info.rnext_key = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_established(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_finish_connect(sk: *mut sock, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn tcp_ao_can_set_current_rnext(sk: *mut sock) -> bool {
...
// Check prefix and trailing 0's in addr
    ...
    let mut addr4: __be32 = addr.s6_addr32[3];
    __be32 mask;
...
// Check that MKT address is consistent with socket
    ...
    let mut daddr4: __be32 = sk.sk_v6_daddr.s6_addr32[3];
...
//
    ...
    WRITE_ONCE(ao_info.current_key, core::ptr::null_mut());
    if (ao_info.rnext_key == key)
    WRITE_ONCE(ao_info.rnext_key, core::ptr::null_mut());
    atomic_sub(tcp_ao_sizeof_key(key), &sk.sk_omem_alloc);
    call_rcu(&key.rcu, tcp_ao_key_free_rcu);
    return 0;
    }
...
//
    ...
    sockptr_t optval, int optlen)
    {
    struct tcp_ao_key *key, *new_current = core::ptr::null_mut(), *new_rnext = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn tcp_ao_required_verify(sk: *mut sock) -> c_int {
    ...
    sockptr_t optval, int optlen)
    {
    struct tcp_ao_key *new_current = core::ptr::null_mut(), *new_rnext = core::ptr::null_mut();
    struct tcp_ao_info *ao_info;
...
#[no_mangle]
pub unsafe extern "C" fn tcp_v4_parse_ao(sk: *mut sock, cmd: c_int, optval: sockptr_t, optlen: c_int) -> c_int {
...
//
    ...
    let mut do_address_matching: bool = true;
    union tcp_ao_addr *addr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_get_mkts(sk: *mut sock, optval: sockptr_t, optlen: sockptr_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_get_sock_info(sk: *mut sock, optval: sockptr_t, optlen: sockptr_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_set_repair(sk: *mut sock, optval: sockptr_t, optlen: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_ao_get_repair(sk: *mut sock, optval: sockptr_t, optlen: sockptr_t) -> c_int {
