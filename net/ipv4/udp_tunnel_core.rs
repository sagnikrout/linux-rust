...
//! Source: net/ipv4/udp_tunnel_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sk_saddr_any(sk: *mut sock) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn udp_tunnel_notify_add_rx_port(sk: *mut sock, type: c_ushort) {
...
#[no_mangle]
pub unsafe extern "C" fn udp_tunnel_notify_del_rx_port(sk: *mut sock, type: c_ushort) {
...
#[no_mangle]
pub unsafe extern "C" fn udp_tunnel_sock_release(sk: *mut sock) {
