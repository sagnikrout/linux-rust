...
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_init(btf: *mut btf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prog_ops_moff(prog: *const bpf_prog) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_reg(kdata: *mut c_void, link: *mut bpf_link) -> c_int {
    static int bpf_tcp_ca_reg(void *kdata, struct bpf_link *link)
    {
    return tcp_register_congestion_control(kdata);
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_unreg(kdata: *mut c_void, link: *mut bpf_link) {
    static void bpf_tcp_ca_unreg(void *kdata, struct bpf_link *link)
    {
    tcp_unregister_congestion_control(kdata);
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_update(kdata: *mut c_void, old_kdata: *mut c_void, link: *mut bpf_link) -> c_int {
    static int bpf_tcp_ca_update(void *kdata, void *old_kdata, struct bpf_link *link)
    {
    return tcp_update_congestion_control(kdata, old_kdata);
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_validate(kdata: *mut c_void) -> c_int {
    static int bpf_tcp_ca_validate(void *kdata)
    {
    return tcp_validate_congestion_control(kdata);
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_ssthresh(sk: *mut sock) -> u32 {
    static u32 bpf_tcp_ca_ssthresh(struct sock *sk)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_cong_avoid(sk: *mut sock, ack: u32, acked: u32) {
    static void bpf_tcp_ca_cong_avoid(struct sock *sk, u32 ack, u32 acked)
    {
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_set_state(sk: *mut sock, new_state: u8) {
    static void bpf_tcp_ca_set_state(struct sock *sk, u8 new_state)
    {
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_cwnd_event(sk: *mut sock, ev: enum tcp_ca_event) {
    static void bpf_tcp_ca_cwnd_event(struct sock *sk, enum tcp_ca_event ev)
    {
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_cwnd_event_tx_start(sk: *mut sock) {
    static void bpf_tcp_ca_cwnd_event_tx_start(struct sock *sk)
    {
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_in_ack_event(sk: *mut sock, flags: u32) {
    static void bpf_tcp_ca_in_ack_event(struct sock *sk, u32 flags)
    {
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_pkts_acked(sk: *mut sock, sample: *const ack_sample) {
    static void bpf_tcp_ca_pkts_acked(struct sock *sk, const struct ack_sample *sample)
    {
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_min_tso_segs(sk: *mut sock) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_undo_cwnd(sk: *mut sock) -> u32 {
    static u32 bpf_tcp_ca_undo_cwnd(struct sock *sk)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_sndbuf_expand(sk: *mut sock) -> u32 {
    static u32 bpf_tcp_ca_sndbuf_expand(struct sock *sk)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn __bpf_tcp_ca_init(sk: *mut sock) {
    static void __bpf_tcp_ca_init(struct sock *sk)
    {
    }
#[no_mangle]
unsafe extern "C" fn __bpf_tcp_ca_release(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn bpf_tcp_ca_kfunc_init() -> int __init {
