...
#[no_mangle]
pub unsafe extern "C" fn __ip_local_out(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_local_out(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    {
    let mut ttl: c_int = READ_ONCE(inet.uc_ttl);
    if (ttl < 0)
...
#[no_mangle]
unsafe extern "C" fn ip_finish_output2(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ip_finish_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_finish_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_mc_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ip_copy_addrs(iph: *mut iphdr, fl4: *const flowi4) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_queue_xmit(sk: *mut sock, skb: *mut sk_buff, fl: *mut flowi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_copy_metadata(to: *mut sk_buff, from: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_fraglist_prepare(skb: *mut sk_buff, iter: *mut ip_fraglist_iter) {
...
// before previous one went down.
    if (iter.frag) {
    let mut first_frag: bool = (iter.offset == 0);
...
//
    while (state.left > 0) {
    let mut first_frag: bool = (state.offset == 0);
...
#[no_mangle]
unsafe extern "C" fn ip_cork_release(cork: *mut inet_cork) {
    static void ip_cork_release(struct inet_cork *cork)
    {
    cork.flags &= ~IPCORK_OPT;
    kfree(cork.opt);
    cork.opt = core::ptr::null_mut();
    dst_release(cork.dst);
    cork.dst = core::ptr::null_mut();
    }
//
...
//
    ...
    struct inet_sock *inet = inet_sk(sk);
    struct net *net = sock_net(sk);
    struct ip_options *opt = core::ptr::null_mut();
    struct rtable *rt = dst_rtable(cork.dst);
    struct iphdr *iph;
    u8 pmtudisc, ttl;
    let mut df: __be16 = 0;
...
// locally.
    ...
    ttl = cork.ttl;
#[no_mangle]
pub unsafe extern "C" fn if(RTN_MULTICAST: rt->rt_type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ip_send_skb(net: *mut net, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_push_pending_frames(sk: *mut sock, fl4: *mut flowi4) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_flush_pending_frames(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn ip_init() -> void __init {
