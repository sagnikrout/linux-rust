...
//
    ...
    err = inet_sk_diag_fill(sk, core::ptr::null_mut(), rep, cb, r, 0,
    ...
    return 0;
    return inet_sk_diag_fill(sk, core::ptr::null_mut(), skb, cb, r, NLM_F_MULTI, net_admin);
    }
...
#[no_mangle]
unsafe extern "C" fn __check_inet_diag_req_raw() -> void __always_unused {
...
#[no_mangle]
unsafe extern "C" fn raw_diag_init() -> int __init {
    static int __init raw_diag_init(void)
    {
    return inet_diag_register(&raw_diag_handler);
    }
#[no_mangle]
unsafe extern "C" fn raw_diag_exit() -> void __exit {
