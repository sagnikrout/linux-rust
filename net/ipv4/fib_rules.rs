...
#[no_mangle]
unsafe extern "C" fn fib4_rule_matchall(rule: *const fib_rule) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fib4_rules_seq_read(net: *const net) -> c_uint {
...
//
    ...
    let mut daddr: __be32 = fl4.daddr;
    let mut saddr: __be32 = fl4.saddr;
...
#[no_mangle]
unsafe extern "C" fn fib4_rule_delete(rule: *mut fib_rule) {
...
#[no_mangle]
unsafe extern "C" fn fib4_rule_nlmsg_payload(rule: *mut fib_rule) -> usize {
...
#[no_mangle]
unsafe extern "C" fn fib4_rule_flush_cache(ops: *mut fib_rules_ops) {
    static void fib4_rule_flush_cache(struct fib_rules_ops *ops)
    {
    rt_cache_flush(ops.fro_net);
    }
#[no_mangle]
unsafe extern "C" fn fib4_rule_need_rtnl(net: *mut net) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fib_default_rules_init(ops: *mut fib_rules_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fib4_rules_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn fib4_rules_exit(net: *mut net) -> void __net_exit {
