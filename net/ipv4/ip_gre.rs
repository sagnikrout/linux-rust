...
#[no_mangle]
unsafe extern "C" fn gre_err(skb: *mut sk_buff, info: u32) {
...
//
    ...
    if (gre_parse_header(skb, &tpi, core::ptr::null_mut(), htons(ETH_P_IP),
    iph.ihl * 4) < 0)
    return;
...
#[no_mangle]
unsafe extern "C" fn is_erspan_type1(gre_hdr_len: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn erspan_fb_xmit(skb: *mut sk_buff, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn gre_fill_metadata_dst(dev: *mut net_device, skb: *mut sk_buff) -> c_int {
    ...
    if (dev.header_ops) {
    let mut pull_len: c_int = tunnel.hlen + sizeof(struct iphdr);
...
#[no_mangle]
unsafe extern "C" fn ipgre_link_update(dev: *mut net_device, set_mtu: bool) {
...
#[no_mangle]
unsafe extern "C" fn ipgre_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipgre_close(dev: *mut net_device) -> c_int {
    ...
    NETIF_F_HW_CSUM)
#[no_mangle]
unsafe extern "C" fn ipgre_tunnel_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn __gre_tunnel_init(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ipgre_tunnel_init(dev: *mut net_device) -> c_int {
    static int ipgre_tunnel_init(struct net_device *dev)
    {
    struct ip_tunnel *tunnel = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn ipgre_init_net(net: *mut net) -> int __net_init {
    static int __net_init ipgre_init_net(struct net *net)
    {
    return ip_tunnel_init_net(net, ipgre_net_id, &ipgre_link_ops, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn gre_tap_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erspan_tunnel_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipgre_tap_setup(dev: *mut net_device) {
    ...
    struct ip_tunnel *t = netdev_priv(dev);
    let mut err: c_int = ip_tunnel_encap_setup(t, &ipencap);
    if (err < 0)
    return err;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn ipgre_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ipgre_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erspan_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erspan_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ipgre_tap_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn erspan_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ipgre_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipgre_fini() -> void __exit {
