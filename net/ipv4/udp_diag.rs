...
//
    ...
    return 0;
    return inet_sk_diag_fill(sk, core::ptr::null_mut(), skb, cb, req, NLM_F_MULTI,
    net_admin);
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: req->sdiag_family ==) -> else {
    ...
    if (!rep)
    goto out;
    err = inet_sk_diag_fill(sk, core::ptr::null_mut(), rep, cb, req, 0,
...
#[no_mangle]
unsafe extern "C" fn udp_diag_init() -> int __init {
    static int __init udp_diag_init(void)
    {
    return inet_diag_register(&udp_diag_handler);
    }
#[no_mangle]
unsafe extern "C" fn udp_diag_exit() -> void __exit {
