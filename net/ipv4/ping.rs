...
#[no_mangle]
pub unsafe extern "C" fn ping_hashfn(net: *const net, num: u32, mask: u32) -> u32 {
    static inline u32 ping_hashfn(const struct net *net, u32 num, u32 mask)
    {
    let mut res: u32 = (num + net_hash_mix(net)) & mask;
    pr_debug("hash(%u) = %u\n", num, res);
    return res;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ping_get_port(sk: *mut sock, ident: c_ushort) -> c_int {
    int ping_get_port(struct sock *sk, unsigned short ident)
    {
    struct net *net = sock_net(sk);
    struct inet_sock *isk, *isk2;
    struct hlist_head *hlist;
    struct sock *sk2 = core::ptr::null_mut();
    isk = inet_sk(sk);
    spin_lock(&ping_table.lock);
    if (ident == 0) {
    let mut result: u16 = net.ipv4.ping_port_rover + 1;
    u32 i;
...
#[no_mangle]
pub unsafe extern "C" fn ping_unhash(sk: *mut sock) {
...
// Called under rcu_read_lock()
    ...
    let mut rcv_saddr: __be32 = READ_ONCE(isk.inet_rcv_saddr);
...
#[no_mangle]
pub unsafe extern "C" fn ping_init_sock(sk: *mut sock) -> c_int {
    int ping_init_sock(struct sock *sk)
    {
    struct net *net = sock_net(sk);
    let mut group: kgid_t = current_egid();
    ...
    let mut gid: kgid_t = group_info.gid[i];
...
#[no_mangle]
pub unsafe extern "C" fn ping_close(sk: *mut sock, timeout: c_long) {
...
#[no_mangle]
unsafe extern "C" fn ping_set_saddr(sk: *mut sock, saddr: *mut sockaddr_unsized) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ping_bind(sk: *mut sock, uaddr: *mut sockaddr_unsized, addr_len: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ping_supported(family: c_int, type: c_int, code: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ping_err(skb: *mut sk_buff, offset: c_int, info: u32) {
...
#[no_mangle]
unsafe extern "C" fn ping_v4_sendmsg(sk: *mut sock, msg: *mut msghdr, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ping_recvmsg(sk: *mut sock, msg: *mut msghdr, len: usize, flags: c_int) -> c_int {
    int ping_recvmsg(struct sock *sk, struct msghdr *msg, size_t len, int flags)
    {
    struct inet_sock *isk = inet_sk(sk);
    let mut family: c_int = sk.sk_family;
    struct sk_buff *skb;
    int copied, err;
...
#[no_mangle]
pub unsafe extern "C" fn ping_queue_rcv_skb(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ping_rcv(skb: *mut sk_buff) -> enum skb_drop_reason {
...
// Push ICMP header back
    ...
    if (sk)
    while (pos && (sk = ping_get_next(seq, sk)) != core::ptr::null_mut())
    --pos;
...
#[no_mangle]
pub unsafe extern "C" fn ping_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ping_v4_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ping_v4_proc_init_net(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn ping_v4_proc_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
pub unsafe extern "C" fn ping_proc_init() -> int __init {
    int __init ping_proc_init(void)
    {
    return register_pernet_subsys(&ping_v4_net_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn ping_proc_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn ping_init() -> void __init {
