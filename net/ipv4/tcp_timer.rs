...
#[no_mangle]
unsafe extern "C" fn tcp_clamp_rto_to_user_timeout(sk: *const sock) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_clamp_probe0_to_user_timeout(sk: *const sock, when: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn tcp_write_err(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn tcp_out_of_resources(sk: *mut sock, do_reset: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tcp_orphan_retries(sk: *mut sock, alive: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcp_mtu_probing(icsk: *mut inet_connection_sock, sk: *mut sock) {
...
//
    ...
    if (likely(timeout == 0)) {
    let mut rto_base: c_uint = TCP_RTO_MIN;
...
#[no_mangle]
unsafe extern "C" fn tcp_write_timeout(sk: *mut sock) -> c_int {
    static int tcp_write_timeout(struct sock *sk)
    {
    struct inet_connection_sock *icsk = inet_csk(sk);
    struct tcp_sock *tp = tcp_sk(sk);
    struct net *net = sock_net(sk);
    let mut expired: bool = false, do_reset;
...
// Black hole detection
    ...
    let mut alive: bool = icsk.icsk_rto < tcp_rto_max(sk);
...
#[no_mangle]
pub unsafe extern "C" fn tcp_delack_timer_handler(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn tcp_delack_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn tcp_probe_timer(sk: *mut sock) {
...
//
    ...
    let mut user_timeout: u32 = READ_ONCE(icsk.icsk_user_timeout);
    if (user_timeout &&
    ...
    if (sock_flag(sk, SOCK_DEAD)) {
    let mut rto_max: c_uint = tcp_rto_max(sk);
    let mut alive: bool = inet_csk_rto_backoff(icsk, rto_max) < rto_max;
...
#[no_mangle]
unsafe extern "C" fn tcp_update_rto_stats(sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn tcp_fastopen_synack_timer(sk: *mut sock, req: *mut request_sock) {
...
//
    ...
    let mut user_timeout: u32 = READ_ONCE(icsk.icsk_user_timeout);
    const struct tcp_sock *tp = tcp_sk(sk);
    let mut timeout: c_int = tcp_rto_max(sk) * 2;
    s32 rcv_delta;
    if (user_timeout) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_retransmit_timer(sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcp_write_timer_handler(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn tcp_write_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_syn_ack_timeout(req: *const request_sock) -> noinline_for_tracing void {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_reset_keepalive_timer(sk: *mut sock, len: c_ulong) {
    void tcp_reset_keepalive_timer(struct sock *sk, unsigned long len)
    {
    sk_reset_timer(sk, &inet_csk(sk).icsk_keepalive_timer, jiffies + len);
    }
#[no_mangle]
unsafe extern "C" fn tcp_delete_keepalive_timer(sk: *mut sock) {
    static void tcp_delete_keepalive_timer(struct sock *sk)
    {
    sk_stop_timer(sk, &inet_csk(sk).icsk_keepalive_timer);
    }
#[no_mangle]
pub unsafe extern "C" fn tcp_set_keepalive(sk: *mut sock, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tcp_keepalive_timer(t: *mut timer_list) {
...
// Try again later.
    ...
    let mut tmo: c_int = tcp_fin_time(sk) - TCP_TIMEWAIT_LEN;
    if (tmo > 0) {
...
#[no_mangle]
unsafe extern "C" fn tcp_compressed_ack_kick(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
pub unsafe extern "C" fn tcp_init_xmit_timers(sk: *mut sock) {
