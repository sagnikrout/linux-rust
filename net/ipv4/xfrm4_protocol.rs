...
//! Source: net/ipv4/xfrm4_protocol.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xfrm4_rcv_cb(skb: *mut sk_buff, protocol: u8, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm4_esp_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm4_esp_err(skb: *mut sk_buff, info: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm4_ah_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm4_ah_err(skb: *mut sk_buff, info: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm4_ipcomp_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xfrm4_ipcomp_err(skb: *mut sk_buff, info: u32) -> c_int {
    ...
    let mut add_netproto: bool = false;
    ...
    lockdep_is_held(&xfrm4_protocol_mutex))) != core::ptr::null_mut();
    pprev = &t.next) {
...
#[no_mangle]
pub unsafe extern "C" fn xfrm4_protocol_init() -> void __init {
