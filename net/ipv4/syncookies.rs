...
//
#[no_mangle]
pub unsafe extern "C" fn cookie_init_timestamp(req: *mut request_sock, now: u64) -> u64 {
...
//
    let mut count: u32 = tcp_cookie_time();
...
#[no_mangle]
pub unsafe extern "C" fn cookie_v4_init_sequence(skb: *const sk_buff, mssp: *mut __u16) -> __u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn __cookie_v4_check(iph: *const iphdr, th: *const tcphdr) -> c_int {
    int __cookie_v4_check(const struct iphdr *iph, const struct tcphdr *th)
    {
    let mut cookie: __u32 = ntohl(th.ack_seq) - 1;
    let mut seq: __u32 = ntohl(th.seq) - 1;
    __u32 mssind;
...
// echoed timestamp, lowest bits contain options
    let mut options: u32 = tcp_opt.rcv_tsecr;
...
// check for timestamp cookie support
    ...
    tcp_parse_options(net, skb, &tcp_opt, 0, core::ptr::null_mut());
