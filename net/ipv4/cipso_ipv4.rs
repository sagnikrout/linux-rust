...
// Label mapping cache
    let mut cipso_v4_cache_enabled: c_int = 1;
    let mut cipso_v4_cache_bucketsize: c_int = 10;
...
// Restricted bitmap (tag #1) flags
    ...
    let mut cipso_v4_rbm_strictvalid: c_int = 1;
//
// Protocol Constants
//
...
//
#[no_mangle]
unsafe extern "C" fn cipso_v4_cache_entry_free(entry: *mut cipso_v4_map_cache_entry) {
...
//
#[no_mangle]
unsafe extern "C" fn cipso_v4_map_cache_hash(key: *const c_uchar, key_len: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn cipso_v4_cache_init() -> int __init {
...
//
    ...
    struct cipso_v4_map_cache_entry *prev_entry = core::ptr::null_mut();
    u32 hash;
...
//
    ...
    {
    let mut bkt_size: c_int = READ_ONCE(cipso_v4_cache_bucketsize);
    let mut ret_val: c_int = -EPERM;
    u32 bkt;
    struct cipso_v4_map_cache_entry *entry = core::ptr::null_mut();
    struct cipso_v4_map_cache_entry *old_entry = core::ptr::null_mut();
    u32 cipso_ptr_len;
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_doi_free(doi_def: *mut cipso_v4_doi) {
...
//
#[no_mangle]
unsafe extern "C" fn cipso_v4_doi_free_rcu(entry: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_doi_remove(doi: u32, audit_info: *mut netlbl_audit) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_doi_putdef(doi_def: *mut cipso_v4_doi) {
...
//
    ...
    void *cb_arg)
    {
    let mut ret_val: c_int = -ENOENT;
    let mut doi_cnt: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn cipso_v4_map_lvl_valid(doi_def: *const cipso_v4_doi, level: u8) -> c_int {
...
//
    ...
    {
    let mut cat: c_int = -1;
    let mut bitmap_len_bits: u32 = bitmap_len * 8;
    u32 cipso_cat_size;
    u32 *cipso_array;
    switch (doi_def.type) {
    case CIPSO_V4_MAP_PASS:
...
//
    ...
    u32 net_cat_len)
    {
    let mut host_spot: c_int = -1;
    let mut net_spot: u32 = CIPSO_V4_INV_CAT;
    let mut net_spot_max: u32 = 0;
    let mut net_clen_bits: u32 = net_cat_len * 8;
    let mut host_cat_size: u32 = 0;
    u32 *host_cat_array = core::ptr::null_mut();
...
//
    ...
    {
    int ret_val;
    let mut net_spot: c_int = -1;
    let mut host_spot: u32 = CIPSO_V4_INV_CAT;
    let mut net_clen_bits: u32 = net_cat_len * 8;
    let mut net_cat_size: u32 = 0;
    u32 *net_cat_array = core::ptr::null_mut();
    if (doi_def.type == CIPSO_V4_MAP_TRANS) {
...
//
    ...
    u16 cat_high;
    u16 cat_low;
    let mut cat_prev: u32 = CIPSO_V4_MAX_REM_CATS + 1;
    u32 iter;
...
//
    ...
    let mut array_cnt: u32 = 0;
    let mut cat_size: u32 = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_validate(skb: *const sk_buff, option: *mut c_uchar) -> c_int {
    int cipso_v4_validate(const struct sk_buff *skb, unsigned char **option)
    {
    unsigned char *opt = *option;
    unsigned char *tag;
    unsigned char opt_iter;
    let mut err_offset: c_uchar = 0;
    u8 opt_len;
    u8 tag_len;
    struct cipso_v4_doi *doi_def = core::ptr::null_mut();
    u32 tag_iter;
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_error(skb: *mut sk_buff, error: c_int, gateway: u32) {
...
//
    ...
    rcu_read_lock();
    res = __ip_options_compile(dev_net(skb.dev), &parm.opt, skb, core::ptr::null_mut());
    rcu_read_unlock();
    if (res)
    return;
    if (gateway)
...
#[no_mangle]
unsafe extern "C" fn cipso_v4_get_actual_opt_len(data: *const c_uchar, len: c_int) -> c_int {
    static int cipso_v4_get_actual_opt_len(const unsigned char *data, int len)
    {
    let mut iter: c_int = 0, optlen = 0;
...
//
    ...
    u32 buf_len;
    u32 opt_len;
    struct ip_options_rcu *old, *opt = core::ptr::null_mut();
...
//
    ...
    u32 buf_len;
    u32 opt_len;
    struct ip_options_rcu *opt = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn cipso_v4_delopt(opt_ptr: *mut ip_options_rcu __rcu) -> c_int {
    static int cipso_v4_delopt(struct ip_options_rcu __rcu **opt_ptr)
    {
    struct ip_options_rcu *opt = rcu_dereference_protected(*opt_ptr, 1);
    let mut hdr_delta: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_sock_delattr(sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_req_delattr(req: *mut request_sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_sock_getattr(sk: *mut sock, secattr: *mut netlbl_lsm_secattr) -> c_int {
    int cipso_v4_sock_getattr(struct sock *sk, struct netlbl_lsm_secattr *secattr)
    {
    struct ip_options_rcu *opt;
    let mut res: c_int = -ENOMSG;
    rcu_read_lock();
...
//
    ...
    let mut buf_len: u32 = CIPSO_V4_OPT_LEN_MAX;
    u32 opt_len;
    int len_delta;
    ret_val = cipso_v4_genopt(buf, buf_len, doi_def, secattr);
    if (ret_val < 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn cipso_v4_skbuff_delattr(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cipso_v4_init() -> int __init {
