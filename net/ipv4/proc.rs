...
//
#[no_mangle]
unsafe extern "C" fn sockstat_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icmpmsg_put(seq: *mut seq_file) {
    static void icmpmsg_put(struct seq_file *seq)
    {
pub const PERLINE: c_int = 16;
    int i, count;
...
#[no_mangle]
unsafe extern "C" fn icmp_put(seq: *mut seq_file) {
...
//
#[no_mangle]
unsafe extern "C" fn snmp_seq_show_ipstats(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int snmp_seq_show_ipstats(struct seq_file *seq, void *v)
    {
    let mut cnt: c_int = ARRAY_SIZE(snmp4_ipstats_list);
...
#[no_mangle]
unsafe extern "C" fn snmp_seq_show_tcp_udp(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int snmp_seq_show_tcp_udp(struct seq_file *seq, void *v)
    {
    let mut udp_cnt: c_int = ARRAY_SIZE(snmp4_udp_list);
    let mut tcp_cnt: c_int = ARRAY_SIZE(snmp4_tcp_list);
...
#[no_mangle]
unsafe extern "C" fn snmp_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn netstat_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int netstat_seq_show(struct seq_file *seq, void *v)
    {
    let mut ip_cnt: c_int = ARRAY_SIZE(snmp4_ipextstats_list);
    let mut tcp_cnt: c_int = ARRAY_SIZE(snmp4_net_list);
    struct net *net = seq.private;
    unsigned long *buff;
    int i;
    seq_puts(seq, "TcpExt:");
...
#[no_mangle]
unsafe extern "C" fn ip_proc_init_net(net: *mut net) -> __net_init int {
    static __net_init int ip_proc_init_net(struct net *net)
    {
    if (!proc_create_net_single("sockstat", 0444, net.proc_net,
    sockstat_seq_show, core::ptr::null_mut()))
    goto out_sockstat;
    if (!proc_create_net_single("netstat", 0444, net.proc_net,
    netstat_seq_show, core::ptr::null_mut()))
    goto out_netstat;
...
#[no_mangle]
unsafe extern "C" fn ip_proc_exit_net(net: *mut net) -> __net_exit void {
...
#[no_mangle]
pub unsafe extern "C" fn ip_misc_proc_init() -> int __init {
