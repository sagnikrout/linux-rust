...
//! Source: net/ipv4/ip_tunnel_core.c
#![no_std]
...
//
    ...
    u16 ipcb_flags)
    {
    let mut pkt_len: c_int = skb.len - skb_inner_network_offset(skb);
...
//
#[no_mangle]
unsafe extern "C" fn iptunnel_pmtud_build_icmp(skb: *mut sk_buff, mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iptunnel_pmtud_check_icmp(skb: *mut sk_buff, mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iptunnel_pmtud_build_icmpv6(skb: *mut sk_buff, mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iptunnel_pmtud_check_icmpv6(skb: *mut sk_buff, mtu: c_int) -> c_int {
    static int iptunnel_pmtud_check_icmpv6(struct sk_buff *skb, int mtu)
    {
    const struct ipv6hdr *ip6h = ipv6_hdr(skb);
    let mut stype: c_int = ipv6_addr_type(&ip6h.saddr);
...
//
    ...
    {
    let mut mtu: u32 = dst_mtu(encap_dst) - headroom;
    ...
    struct netlink_ext_ack *extack)
    {
    return ip_tun_parse_opts(attr, core::ptr::null_mut(), extack);
    }
...
#[no_mangle]
unsafe extern "C" fn ip_tun_destroy_state(lwtstate: *mut lwtunnel_state) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(IP_TUNNEL_VXLAN_OPT_BIT, _arg: tun_info->key.tun_flags)) -> else {
    else if (test_bit(IP_TUNNEL_VXLAN_OPT_BIT, tun_info.key.tun_flags))
    err = ip_tun_fill_encap_opts_vxlan(skb, tun_info);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(IP_TUNNEL_ERSPAN_OPT_BIT, _arg: tun_info->key.tun_flags)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ip_tun_opts_nlsize(info: *mut ip_tunnel_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_tun_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip_tun_cmp_encap(a: *mut lwtunnel_state, b: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip6_tun_encap_nlsize(lwtstate: *mut lwtunnel_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ip_tunnel_core_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn ip_tunnel_need_metadata() {
...
#[no_mangle]
pub unsafe extern "C" fn ip_tunnel_unneed_metadata() {
...
#[no_mangle]
pub unsafe extern "C" fn ip_tunnel_parse_protocol(skb: *const sk_buff) -> __be16 {
    ...
    let mut ip_tunnel_header_ops: header_ops = { .parse_protocol = ip_tunnel_parse_protocol };
