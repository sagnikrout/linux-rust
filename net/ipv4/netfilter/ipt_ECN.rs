...
//! Source: net/ipv4/netfilter/ipt_ECN.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ecn_tg_check(par: *const xt_tgchk_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecn_tg_init() -> int __init {
    static int __init ecn_tg_init(void)
    {
    return xt_register_target(&ecn_tg_reg);
    }
#[no_mangle]
unsafe extern "C" fn ecn_tg_exit() -> void __exit {
