...
//! Source: net/ipv4/netfilter/nf_nat_h323.c
#![no_std]
...
//
    ...
    {
    let mut dir: c_int = CTINFO2DIR(ctinfo);
    let mut nated_port: u_int16_t = ntohs(port);
// Set expectations for NAT
...
//
#[no_mangle]
unsafe extern "C" fn nf_nat_h323_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn nf_nat_h323_fini() -> void __exit {
    static void __exit nf_nat_h323_fini(void)
    {
    RCU_INIT_POINTER(nfct_h323_nat_hook, core::ptr::null_mut());
