...
//! Source: net/ipv4/netfilter/nft_reject_ipv4.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nft_reject_ipv4_module_init() -> int __init {
    static int __init nft_reject_ipv4_module_init(void)
    {
    return nft_register_expr(&nft_reject_ipv4_type);
    }
#[no_mangle]
unsafe extern "C" fn nft_reject_ipv4_module_exit() -> void __exit {
