...
//! Source: net/ipv4/netfilter/nf_nat_pptp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nf_nat_helper_pptp_init() -> int __init {
    static int __init nf_nat_helper_pptp_init(void)
    {
    WARN_ON(nf_nat_pptp_hook != core::ptr::null_mut());
    RCU_INIT_POINTER(nf_nat_pptp_hook, &pptp_hooks);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nf_nat_helper_pptp_fini() -> void __exit {
    static void __exit nf_nat_helper_pptp_fini(void)
    {
    RCU_INIT_POINTER(nf_nat_pptp_hook, core::ptr::null_mut());
    synchronize_rcu();
    }
