...
// Offset table on connection states transition diagram
    ...
    let mut sysctl_llc2_ack_timeout: c_int = LLC2_ACK_TIME * HZ;
    let mut sysctl_llc2_p_timeout: c_int = LLC2_P_TIME * HZ;
    let mut sysctl_llc2_rej_timeout: c_int = LLC2_REJ_TIME * HZ;
    let mut sysctl_llc2_busy_timeout: c_int = LLC2_BUSY_TIME * HZ;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_state_process(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_send_pdu(sk: *mut sock, skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_rtn_pdu(sk: *mut sock, skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_resend_i_pdu_as_cmd(sk: *mut sock, nr: u8, first_p_bit: u8) {
...
//
    llc = llc_sk(sk);
    while ((skb = skb_dequeue(&llc.pdu_unack_q)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_resend_i_pdu_as_rsp(sk: *mut sock, nr: u8, first_f_bit: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_remove_acked_pdus(sk: *mut sock, nr: u8, how_many_unacked: *mut u16) -> c_int {
    int llc_conn_remove_acked_pdus(struct sock *sk, u8 nr, u16 *how_many_unacked)
    {
    int pdu_pos, i;
    struct sk_buff *skb;
    struct llc_pdu_sn *pdu;
    let mut nbr_acked: c_int = 0;
    struct llc_sock *llc = llc_sk(sk);
    let mut q_len: c_int = skb_queue_len(&llc.pdu_unack_q);
    if (!q_len)
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn llc_conn_send_pdus(sk: *mut sock) {
    static void llc_conn_send_pdus(struct sock *sk)
    {
    struct sk_buff *skb;
    while ((skb = skb_dequeue(&sk.sk_write_queue)) != core::ptr::null_mut()) {
    struct llc_pdu_sn *pdu = llc_pdu_sn_hdr(skb);
...
//
#[no_mangle]
unsafe extern "C" fn llc_conn_service(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int llc_conn_service(struct sock *sk, struct sk_buff *skb)
    {
    const struct llc_conn_state_trans *trans;
    struct llc_sock *llc = llc_sk(sk);
...
//
    ...
    let mut rc2: c_int = (*next_action)(sk, skb);
    if (rc2 == 2) {
    rc = rc2;
    break;
    } else if (rc2)
...
//
    ...
    let mut slot: c_int = llc_sk_laddr_hashfn(sap, laddr);
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_data_accept_state(state: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn llc_find_next_offset(state: *mut llc_conn_state, offset: u16) -> u16 __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_build_offset_table() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn llc_find_offset(state: c_int, ev_type: c_int) -> c_int {
    static int llc_find_offset(int state, int ev_type)
    {
    let mut rc: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_sap_add_socket(sap: *mut llc_sap, sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_sap_remove_socket(sap: *mut llc_sap, sk: *mut sock) {
...
//
#[no_mangle]
unsafe extern "C" fn llc_conn_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_handler(sap: *mut llc_sap, skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn llc_backlog_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn llc_sk_init(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn llc_sk_stop_all_timers(sk: *mut sock, sync: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_sk_free(sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_sk_reset(sk: *mut sock) {
    void llc_sk_reset(struct sock *sk)
    {
    struct llc_sock *llc = llc_sk(sk);
    llc_conn_ac_stop_all_timers(sk, core::ptr::null_mut());
    skb_queue_purge(&sk.sk_write_queue);
    skb_queue_purge(&llc.pdu_unack_q);
