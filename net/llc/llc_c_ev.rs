...
//
#[no_mangle]
unsafe extern "C" fn llc_util_ns_inside_rx_window(ns: u8, vr: u8, rw: u8) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn llc_util_nr_inside_tx_window(sk: *mut sock, nr: u8) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_conn_req(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_data_req(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_disc_req(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rst_req(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_local_busy_detected(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_local_busy_cleared(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_bad_pdu(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_rx_bad_pdu(struct sock *sk, struct sk_buff *skb)
    {
    return 1;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_disc_cmd_pbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_dm_rsp_fbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_frmr_rsp_fbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_i_cmd_pbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_i_cmd_pbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    {
    const struct llc_pdu_sn *pdu = llc_pdu_sn_hdr(skb);
    let mut vr: u8 = llc_sk(sk).vR;
    let mut ns: u8 = LLC_I_GET_NS(pdu);
    ...
    struct sk_buff *skb)
    {
    let mut pdu: *const llc_pdu_sn = llc_pdu_sn_hdr(skb);
    let mut vr: u8 = llc_sk(sk).vR;
    let mut ns: u8 = LLC_I_GET_NS(pdu);
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_i_rsp_fbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_i_rsp_fbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_i_rsp_fbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rej_cmd_pbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rej_cmd_pbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rej_rsp_fbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rej_rsp_fbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rej_rsp_fbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rnr_cmd_pbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rnr_cmd_pbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rnr_rsp_fbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rnr_rsp_fbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rr_cmd_pbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rr_cmd_pbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rr_rsp_fbit_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_rr_rsp_fbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_sabme_cmd_pbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_ua_rsp_fbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_xxx_cmd_pbit_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_xxx_cmd_pbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: LLC_PDU_TYPE_IS_U(pdu)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_xxx_rsp_fbit_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rx_any_frame(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_rx_any_frame(struct sock *sk, struct sk_buff *skb)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_p_tmr_exp(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_ack_tmr_exp(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_rej_tmr_exp(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_busy_tmr_exp(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_init_p_f_cycle(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_init_p_f_cycle(struct sock *sk, struct sk_buff *skb)
    {
    return 1;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_tx_buffer_full(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_data_flag_eq_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_data_flag_eq_1(struct sock *sk, struct sk_buff *skb)
    {
    return llc_sk(sk).data_flag != 1;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_data_flag_eq_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_data_flag_eq_0(struct sock *sk, struct sk_buff *skb)
    {
    return llc_sk(sk).data_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_data_flag_eq_2(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_data_flag_eq_2(struct sock *sk, struct sk_buff *skb)
    {
    return llc_sk(sk).data_flag != 2;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_p_flag_eq_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_last_frame_eq_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_last_frame_eq_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_last_frame_eq_0(struct sock *sk, struct sk_buff *skb)
    {
    return skb_queue_len(&llc_sk(sk).pdu_unack_q) + 1 == llc_sk(sk).k;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_p_flag_eq_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_p_flag_eq_0(struct sock *sk, struct sk_buff *skb)
    {
    return llc_sk(sk).p_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_p_flag_eq_f(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_remote_busy_eq_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_remote_busy_eq_0(struct sock *sk, struct sk_buff *skb)
    {
    return llc_sk(sk).remote_busy_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_remote_busy_eq_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_remote_busy_eq_1(struct sock *sk, struct sk_buff *skb)
    {
    return !llc_sk(sk).remote_busy_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_retry_cnt_lt_n2(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_retry_cnt_lt_n2(struct sock *sk, struct sk_buff *skb)
    {
    return !(llc_sk(sk).retry_count < llc_sk(sk).n2);
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_retry_cnt_gte_n2(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_retry_cnt_gte_n2(struct sock *sk, struct sk_buff *skb)
    {
    return !(llc_sk(sk).retry_count >= llc_sk(sk).n2);
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_s_flag_eq_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_s_flag_eq_1(struct sock *sk, struct sk_buff *skb)
    {
    return !llc_sk(sk).s_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_s_flag_eq_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_s_flag_eq_0(struct sock *sk, struct sk_buff *skb)
    {
    return llc_sk(sk).s_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_cause_flag_eq_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_cause_flag_eq_1(struct sock *sk, struct sk_buff *skb)
    {
    return !llc_sk(sk).cause_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_cause_flag_eq_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ev_qlfy_cause_flag_eq_0(struct sock *sk, struct sk_buff *skb)
    {
    return llc_sk(sk).cause_flag;
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_set_status_conn(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_set_status_disc(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_set_status_failed(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_set_status_refuse(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_set_status_conflict(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ev_qlfy_set_status_rst_done(sk: *mut sock, skb: *mut sk_buff) -> c_int {
