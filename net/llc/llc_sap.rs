...
#[no_mangle]
unsafe extern "C" fn llc_mac_header_len(devtype: c_ushort) -> c_int {
...
//
    ...
    {
    let mut hlen: c_int = type == LLC_PDU_TYPE_U ? 3 : 4;
    struct sk_buff *skb;
...
#[no_mangle]
pub unsafe extern "C" fn llc_save_primitive(sk: *mut sock, skb: *mut sk_buff, prim: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_sap_rtn_pdu(sap: *mut llc_sap, skb: *mut sk_buff) {
...
//
    ...
    {
    let mut i: c_int = 0;
    const struct llc_sap_state_trans *rc = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn llc_sap_next_state(sap: *mut llc_sap, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn llc_sap_state_process(sap: *mut llc_sap, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn llc_sap_handler(sap: *mut llc_sap, skb: *mut sk_buff) {
