...
pub const INCORRECT: c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_clear_remote_busy(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_conn_ind(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_conn_confirm(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llc_conn_ac_data_confirm(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_data_ind(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_disc_ind(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_disc_confirm(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_rst_ind(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_rst_confirm(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_disc_cmd_p_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ac_send_disc_cmd_p_set_x(struct sock *sk, struct sk_buff *skb)
    {
    let mut rc: c_int = -ENOBUFS;
    struct llc_sock *llc = llc_sk(sk);
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_dm_rsp_f_set_p(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_dm_rsp_f_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_frmr_rsp_f_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_resend_frmr_rsp_f_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_resend_frmr_rsp_f_set_p(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_i_cmd_p_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llc_conn_ac_send_i_cmd_p_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_i_xxx_x_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_resend_i_xxx_x_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ac_resend_i_xxx_x_set_0(struct sock *sk, struct sk_buff *skb)
    {
    struct llc_pdu_sn *pdu = llc_pdu_sn_hdr(skb);
    let mut nr: u8 = LLC_I_GET_NR(pdu);
    llc_conn_resend_i_pdu_as_cmd(sk, nr, 0);
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_resend_i_rsp_f_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rej_cmd_p_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rej_rsp_f_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rej_xxx_x_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rnr_cmd_p_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rnr_rsp_f_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rnr_xxx_x_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_remote_busy(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_opt_send_rnr_xxx_x_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rr_cmd_p_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rr_rsp_f_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_ack_rsp_f_set_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_rr_xxx_x_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_ack_xxx_x_set_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_set_p_flag(sk: *mut sock, value: u8) {
    void llc_conn_set_p_flag(struct sock *sk, u8 value)
    {
    let mut state_changed: c_int = llc_sk(sk).p_flag && !value;
    llc_sk(sk).p_flag = value;
    if (state_changed)
    sk.sk_state_change(sk);
    }
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_sabme_cmd_p_set_x(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_ua_rsp_f_set_p(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_s_flag_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_s_flag_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_start_p_timer(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_ack_if_needed(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_rst_sendack_flag(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_send_i_as_ack(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn llc_conn_ac_inc_npta_value(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int llc_conn_ac_inc_npta_value(struct sock *sk, struct sk_buff *skb)
    {
    struct llc_sock *llc = llc_sk(sk);
    if (!llc.inc_cntr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_adjust_npta_by_rr(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_adjust_npta_by_rnr(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_dec_tx_win_size(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ac_dec_tx_win_size(struct sock *sk, struct sk_buff *skb)
    {
    struct llc_sock *llc = llc_sk(sk);
    let mut unacked_pdu: u8 = skb_queue_len(&llc.pdu_unack_q);
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_inc_tx_win_size(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_stop_all_timers(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_stop_other_timers(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_start_ack_timer(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_start_rej_timer(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_stop_ack_timer(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_stop_p_timer(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_stop_rej_timer(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_upd_nr_received(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_upd_p_flag(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_data_flag_2(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_data_flag_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_data_flag_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_p_flag_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llc_conn_ac_set_p_flag_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int llc_conn_ac_set_p_flag_1(struct sock *sk, struct sk_buff *skb)
    {
    llc_conn_set_p_flag(sk, 1);
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_remote_busy_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_cause_flag_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_cause_flag_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_retry_cnt_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_inc_retry_cnt_by_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_vr_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_inc_vr_by_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_vs_0(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_set_vs_nr(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn llc_conn_ac_inc_vs_by_1(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int llc_conn_ac_inc_vs_by_1(struct sock *sk, struct sk_buff *skb)
    {
...
#[no_mangle]
unsafe extern "C" fn llc_conn_tmr_common_cb(sk: *mut sock, type: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_pf_cycle_tmr_cb(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_busy_tmr_cb(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ack_tmr_cb(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_rej_tmr_cb(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_rst_vs(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn llc_conn_ac_upd_vs(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    int llc_conn_ac_upd_vs(struct sock *sk, struct sk_buff *skb)
    {
    struct llc_pdu_sn *pdu = llc_pdu_sn_hdr(skb);
    let mut nr: u8 = PDU_SUPV_GET_Nr(pdu);
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_disc(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_conn_reset(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llc_circular_between(a: u8, b: u8, c: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn llc_process_tmr_ev(sk: *mut sock, skb: *mut sk_buff) {
    static void llc_process_tmr_ev(struct sock *sk, struct sk_buff *skb)
    {
