...
//
    ...
    {
    struct llc_sap *sap = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn llc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn llc_exit() -> void __exit {
